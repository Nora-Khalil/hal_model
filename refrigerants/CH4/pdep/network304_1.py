...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(117)', '[CH2]C[CH2](102)'],
    products = ['[CH2]CC[C]=O(369)'],
    transitionState = 'TS4',
