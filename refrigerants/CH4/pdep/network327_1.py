...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.546257,'amu*angstrom^2'), symmetry=1, barrier=(12.5595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.54666,'amu*angstrom^2'), symmetry=1, barrier=(12.5688,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72568,0.0185662,2.77012e-05,-5.97751e-08,2.90341e-11,16665.3,12.6761], Tmin=(100,'K'), Tmax=(846.395,'K')), NASAPolynomial(coeffs=[11.5518,0.00485053,2.39333e-06,-7.61681e-10,6.03933e-14,14168.5,-34.3569], Tmin=(846.395,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(123trioxolane) + radical(CCsJOO)"""),
)
...
"""),
    E0 = (-98.9365,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680],'cm^-1')),
        HinderedRotor(inertia=(0.971454,'amu*angstrom^2'), symmetry=1, barrier=(22.3356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.969057,'amu*angstrom^2'), symmetry=1, barrier=(22.2805,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.647147,0.049948,-5.65945e-05,2.85452e-08,-5.08572e-12,-11757.9,21.9325], Tmin=(100,'K'), Tmax=(1718.65,'K')), NASAPolynomial(coeffs=[15.3984,-0.00194547,4.02407e-06,-9.14159e-10,6.43707e-14,-14234.8,-49.677], Tmin=(1718.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.9365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.85509,'amu*angstrom^2'), symmetry=1, barrier=(19.6602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.855119,'amu*angstrom^2'), symmetry=1, barrier=(19.6609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.855497,'amu*angstrom^2'), symmetry=1, barrier=(19.6696,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93015,0.0435985,-5.03168e-05,2.8606e-08,-6.31892e-12,-11055.3,17.9195], Tmin=(100,'K'), Tmax=(1113.08,'K')), NASAPolynomial(coeffs=[11.5568,0.0090041,-3.69723e-06,6.84001e-10,-4.76218e-14,-13198.3,-29.555], Tmin=(1113.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.5524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), label="""hoo_acetyl""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OCC=O(146)'],
    products = ['HO2(12)', 'CH2CO(27)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(14)', 'CO[O](36)'],
    products = ['[O]OCC=O(146)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.0811035,'m^3/(mol*s)'), n=2.58298, Ea=(350.146,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25906933291314677, var=2.9301042026274278, Tref=1000.0, N=4, data_mean=0.0, correlation='Root_1COCbCdCsCtHNOSSidSis->Cs_N-2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->Cs_Ext-1Cs-R_N-2Br1sCl1sF1sH->F1s',), comment="""Estimated from node Root_1COCbCdCsCtHNOSSidSis->Cs_N-2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->Cs_Ext-1Cs-R_N-2Br1sCl1sF1sH->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['C=COO[O](1423)'],
    products = ['[O]OCC=O(146)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.62709e+20,'s^-1'), n=-1.9758, Ea=(128.508,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(7)', '[O]CC=O(68)'],
    products = ['[O]OCC=O(146)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OCC=O(146)'],
    products = ['[CH]1COOO1(1424)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.12332e+09,'s^-1'), n=0.5388, Ea=(233.58,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra] for rate rule [R5_SS_CO;carbonyl_intra_H;radadd_intra_O]
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC=CO(1425)'],
    products = ['[O]OCC=O(146)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(75.1006,'s^-1'), n=3.11041, Ea=(210.296,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.00848789959541425, var=6.520606768146176, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_3R!H->C',), comment="""Estimated from node Root_3R!H->C"""),
)

reaction(
    label = 'reaction8',
    reactants = ['O2(2)', 'CH2CHO(34)'],
    products = ['[O]OCC=O(146)'],
    transitionState = 'TS8',
