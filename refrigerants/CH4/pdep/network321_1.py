...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(117)', '[O]C[C]=O(276)'],
    products = ['O=[C]CO[C]=O(386)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(117)', '[CH2]O[C]=O(269)'],
    products = ['O=[C]CO[C]=O(386)'],
    transitionState = 'TS3',
