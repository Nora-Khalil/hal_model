...
"""),
    E0 = (-49.6308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,1621.24,1624.55],'cm^-1')),
        HinderedRotor(inertia=(0.298431,'amu*angstrom^2'), symmetry=1, barrier=(6.86152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0247134,'amu*angstrom^2'), symmetry=1, barrier=(0.56821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2979,'amu*angstrom^2'), symmetry=1, barrier=(6.84931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20714,0.0433616,-5.12516e-05,4.45822e-08,-1.70733e-11,-5908.42,22.3048], Tmin=(100,'K'), Tmax=(754.977,'K')), NASAPolynomial(coeffs=[3.75378,0.029952,-1.42474e-05,2.75669e-09,-1.93515e-13,-5993.32,16.2623], Tmin=(754.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.6308,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04314,0.0413771,-3.31797e-05,1.41723e-08,-2.50004e-12,-42496.8,19.3585], Tmin=(100,'K'), Tmax=(1324.49,'K')), NASAPolynomial(coeffs=[9.42881,0.0190721,-7.91898e-06,1.45757e-09,-1.0011e-13,-44453.2,-18.3486], Tmin=(1324.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-353.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCC(=O)O(260)',
    structure = adjacencyList("""1  O u0 p2 c0 {5,S} {11,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {4,S} {5,S} {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3182,0.0338019,-1.57456e-05,2.38744e-09,8.05871e-14,-56345.6,16.7584], Tmin=(100,'K'), Tmax=(1644.51,'K')), NASAPolynomial(coeffs=[10.1001,0.0204141,-8.58765e-06,1.53431e-09,-1.01151e-13,-59654.3,-26.9334], Tmin=(1644.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-469.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.177179,'amu*angstrom^2'), symmetry=1, barrier=(4.0737,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41255,0.0385749,-4.56578e-05,4.05979e-08,-1.59515e-11,-15368.8,19.5866], Tmin=(100,'K'), Tmax=(747.699,'K')), NASAPolynomial(coeffs=[3.51425,0.0275632,-1.32991e-05,2.59136e-09,-1.82682e-13,-15390.5,15.5486], Tmin=(747.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-54.9751,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1599.23],'cm^-1')),
        HinderedRotor(inertia=(0.0886818,'amu*angstrom^2'), symmetry=1, barrier=(2.03897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0834823,'amu*angstrom^2'), symmetry=1, barrier=(1.91942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00245926,'amu*angstrom^2'), symmetry=1, barrier=(27.9226,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.75269,0.0331758,-1.82104e-05,4.67806e-09,-4.94603e-13,-6573.25,21.0253], Tmin=(100,'K'), Tmax=(1885.95,'K')), NASAPolynomial(coeffs=[7.3581,0.023408,-1.04415e-05,1.93187e-09,-1.30572e-13,-8310.38,-4.115], Tmin=(1885.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.9751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO)"""),
)
...
"""),
    E0 = (-49.6308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,306.956,2423.27],'cm^-1')),
        HinderedRotor(inertia=(0.108736,'amu*angstrom^2'), symmetry=1, barrier=(7.26997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00763874,'amu*angstrom^2'), symmetry=1, barrier=(7.26972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108734,'amu*angstrom^2'), symmetry=1, barrier=(7.26996,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20714,0.0433616,-5.12516e-05,4.45822e-08,-1.70733e-11,-5908.42,21.2062], Tmin=(100,'K'), Tmax=(754.977,'K')), NASAPolynomial(coeffs=[3.75378,0.029952,-1.42474e-05,2.75669e-09,-1.93515e-13,-5993.32,15.1636], Tmin=(754.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.6308,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2][CH]C(O)O(800)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {11,S}
2  O u0 p2 c0 {3,S} {10,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90133,0.0424797,-3.54621e-05,1.55799e-08,-2.77088e-12,-8994.03,24.346], Tmin=(100,'K'), Tmax=(1338.34,'K')), NASAPolynomial(coeffs=[10.5364,0.0166713,-6.53628e-06,1.171e-09,-7.93165e-14,-11305.4,-19.8297], Tmin=(1338.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.4339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.476,0.0406117,-5.59964e-05,6.17338e-08,-2.68542e-11,-3460.67,19.7163], Tmin=(100,'K'), Tmax=(802.428,'K')), NASAPolynomial(coeffs=[-0.627425,0.0384742,-1.90863e-05,3.72274e-09,-2.60883e-13,-2395.75,37.5376], Tmin=(802.428,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[CH2]C([O])O(794)'],
    products = ['[CH2]CC([O])O(783)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(8)', '[CH2]CC=O(106)'],
    products = ['[CH2]CC([O])O(783)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(35.8561,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
