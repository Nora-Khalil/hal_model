...
"""),
    ...
    molecularWeight = (70.0467,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.54789,0.00321942,2.38818e-05,-3.43291e-08,1.33545e-11,-12221,7.9478], Tmin=(100,'K'), Tmax=(978.729,'K')), NASAPolynomial(coeffs=[8.00571,0.00209327,-5.8839e-07,1.82603e-10,-1.88187e-14,-13912.3,-17.645], Tmin=(978.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + missing(Cd-COCdH) + group(Cds-CdsOsH) + group(Cds-O2d(Cds-Cds)O2s) + ring(Oxetene)"""),
)

species(
    label = '[CH]=C[C]1OO1(303)',
    structure = adjacencyList("""multiplicity 3
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH]C=C=O(302)'],
    products = ['[CH]=CC([O])=O(262)'],
    transitionState = 'TS2',
