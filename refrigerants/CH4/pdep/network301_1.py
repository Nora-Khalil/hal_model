...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.16523,'amu*angstrom^2'), symmetry=1, barrier=(26.7909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16644,'amu*angstrom^2'), symmetry=1, barrier=(26.8187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16562,'amu*angstrom^2'), symmetry=1, barrier=(26.7999,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42356,0.0375923,1.06352e-05,-6.96197e-08,3.83253e-11,24953.7,16.2143], Tmin=(100,'K'), Tmax=(885.86,'K')), NASAPolynomial(coeffs=[25.1774,-0.0163211,1.15988e-05,-2.36849e-09,1.62517e-13,18652.1,-107.319], Tmin=(885.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.948103,'amu*angstrom^2'), symmetry=1, barrier=(21.7987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.947542,'amu*angstrom^2'), symmetry=1, barrier=(21.7859,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.073571,0.0615118,-7.02915e-05,3.50938e-08,-6.209e-12,5708.45,21.9597], Tmin=(100,'K'), Tmax=(1711.48,'K')), NASAPolynomial(coeffs=[19.457,-0.00421268,4.90916e-06,-1.05351e-09,7.24099e-14,1963.88,-74.1678], Tmin=(1711.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.0407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COCO(366)'],
    products = ['CH2O(19)', 'CH2CO(27)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(132.486,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2OH(32)', 'HCCO(20)'],
    products = ['C#COCO(366)'],
    transitionState = 'TS2',
