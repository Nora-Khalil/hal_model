...
reaction(
    ...
    products = ['OH(8)', 'O=C1OO1(1196)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.2122e+14,'s^-1'), n=-0.378125, Ea=(69.0738,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO;Y_rad_intra;OOH]
