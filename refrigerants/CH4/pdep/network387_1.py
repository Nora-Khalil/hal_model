...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(117)', 'C[C]=C[O](664)'],
    products = ['C[C]=CO[C]=O(657)'],
    transitionState = 'TS2',
