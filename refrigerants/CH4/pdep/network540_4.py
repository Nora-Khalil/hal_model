...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(4214.4,'J/mol'), sigma=(6.62052,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=658.28 K, Pc=32.95 bar (from Joback method)"""),
...
"""),
    E0 = (-206.493,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,1000,393.476,393.481,393.513,1324.27,1324.31,1324.31],'cm^-1')),
        HinderedRotor(inertia=(0.00457321,'amu*angstrom^2'), symmetry=1, barrier=(5.69084,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (62.0248,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3559.51,'J/mol'), sigma=(5.74948,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=555.99 K, Pc=42.5 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.32943,0.00933074,1.65009e-05,-2.99939e-08,1.30388e-11,-24806.1,11.6493], Tmin=(100,'K'), Tmax=(907.46,'K')), NASAPolynomial(coeffs=[7.37252,0.00571377,-1.0001e-06,1.12627e-10,-7.48584e-15,-26124.8,-10.6862], Tmin=(907.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + ring(dioxirane)"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (45.0174,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3011.9,'J/mol'), sigma=(5.14335,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=470.45 K, Pc=50.23 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-1.24639,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,249.711,1238.87,1238.93,1240.14,1241.68],'cm^-1')),
        HinderedRotor(inertia=(0.19065,'amu*angstrom^2'), symmetry=1, barrier=(8.73505,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.37237,0.00999063,6.34057e-06,-1.8177e-08,8.81888e-12,-123.704,12.1835], Tmin=(100,'K'), Tmax=(889.394,'K')), NASAPolynomial(coeffs=[7.15206,0.00344378,-2.45763e-07,-2.66541e-11,2.84702e-15,-1209.42,-7.93228], Tmin=(889.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.24639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + ring(dioxirane) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[O][CH]O(212)'],
    products = ['[O]C([O])O(220)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction5',
    reactants = ['O(7)', 'O=CO(77)'],
    products = ['[O]C([O])O(220)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(73.8232,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00830112,'m^3/(mol*s)'), n=2.85734, Ea=(52.5546,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0719595024542213, var=6.376381657399837, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['O-2(208)', 'O=CO(77)'],
    products = ['OC1OO1(1428)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(4.81575e-05,'m^3/(mol*s)'), n=2.76922, Ea=(37.8393,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [elec_def;mb_carbonyl] for rate rule [o_atom_singlet;mb_carbonyl_HNd]
Euclidian distance = 1.4142135623730951
