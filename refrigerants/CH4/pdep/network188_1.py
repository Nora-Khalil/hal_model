...
"""),
    ...
    molecularWeight = (59.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.12259,0.00630285,5.03349e-05,-7.8278e-08,3.34226e-11,17201.3,12.3655], Tmin=(100,'K'), Tmax=(898.796,'K')), NASAPolynomial(coeffs=[12.1136,0.000527587,2.83265e-06,-6.6096e-10,4.45329e-14,14202.1,-37.7451], Tmin=(898.796,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CC([O])=O(242)'],
    products = ['C[C]1OO1(1226)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(343.511,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_O]
Euclidian distance = 2.449489742783178
family: Intra_R_Add_Endocyclic
Ea raised from 343.4 to 343.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(=O)O(356)'],
    products = ['CC([O])=O(242)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(205000,'s^-1'), n=2.37, Ea=(244.9,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R"""),
)

reaction(
    label = 'reaction5',
    reactants = ['[O][C]=O(213)', 'CH3(18)'],
    products = ['CC([O])=O(242)'],
    transitionState = 'TS5',
