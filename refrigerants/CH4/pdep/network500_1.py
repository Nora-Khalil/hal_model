...
"""),
    ...
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.78091,0.0296041,-3.63454e-05,3.21057e-08,-1.21897e-11,26244.8,12.0088], Tmin=(100,'K'), Tmax=(776.592,'K')), NASAPolynomial(coeffs=[3.80734,0.019989,-9.41339e-06,1.80911e-09,-1.26307e-13,26215.9,8.15675], Tmin=(776.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(oxirene)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CO[O](160)'],
    products = ['[CH]=C(C)O[O](638)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=C(C)O[O](638)'],
    products = ['O(7)', 'CC1=CO1(1011)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.30161e+09,'s^-1'), n=1.08, Ea=(167.703,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2OO;Y_rad_intra;OOJ] for rate rule [R2OO_D;Cd_pri_rad_in;OOJ]
