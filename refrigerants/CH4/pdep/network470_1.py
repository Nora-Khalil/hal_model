...
reaction(
    label = 'reaction1',
    reactants = ['C#CCOC=O(654)'],
    products = ['CO2(15)', 'C=C=C(718)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(14)', 'C#CCO(943)'],
    products = ['C#CCOC=O(654)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(24)', 'C#COC=O(959)'],
    products = ['C#CCOC=O(654)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C=O(121)', '[CH]=C=C(635)'],
    products = ['C#CCOC=O(654)'],
