...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.170948,'amu*angstrom^2'), symmetry=1, barrier=(3.93043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170406,'amu*angstrom^2'), symmetry=1, barrier=(3.91798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169737,'amu*angstrom^2'), symmetry=1, barrier=(3.90259,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48413,0.0622461,-9.34289e-05,8.57589e-08,-3.14988e-11,9683,24.0776], Tmin=(100,'K'), Tmax=(816.758,'K')), NASAPolynomial(coeffs=[4.75903,0.0331717,-1.60923e-05,3.09283e-09,-2.14359e-13,9582.84,11.6027], Tmin=(816.758,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.8115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.110799,'amu*angstrom^2'), symmetry=1, barrier=(2.54749,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28885,0.0426998,-6.44267e-05,6.05677e-08,-2.28061e-11,14353,20.4324], Tmin=(100,'K'), Tmax=(808.627,'K')), NASAPolynomial(coeffs=[4.04147,0.0242245,-1.19658e-05,2.32054e-09,-1.61752e-13,14390.2,14.3316], Tmin=(808.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
"""),
    E0 = (128.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.05859,'amu*angstrom^2'), symmetry=1, barrier=(47.3311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.05949,'amu*angstrom^2'), symmetry=1, barrier=(47.3517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.0518,'amu*angstrom^2'), symmetry=1, barrier=(47.175,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92121,0.0506511,-6.41091e-05,5.75094e-08,-2.21021e-11,-35673.4,20.7866], Tmin=(100,'K'), Tmax=(766.037,'K')), NASAPolynomial(coeffs=[3.75246,0.0336435,-1.62272e-05,3.1511e-09,-2.21289e-13,-35735.5,13.8658], Tmin=(766.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-50.0918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,180,180,1010.92,3403.07],'cm^-1')),
        HinderedRotor(inertia=(0.211894,'amu*angstrom^2'), symmetry=1, barrier=(4.87187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211197,'amu*angstrom^2'), symmetry=1, barrier=(4.85582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211898,'amu*angstrom^2'), symmetry=1, barrier=(4.87196,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80238,0.0547139,-8.26445e-05,7.71678e-08,-2.88313e-11,-5951.72,21.6152], Tmin=(100,'K'), Tmax=(811.276,'K')), NASAPolynomial(coeffs=[4.25879,0.0303431,-1.4917e-05,2.88594e-09,-2.00841e-13,-5946.84,12.7647], Tmin=(811.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.0918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (37.7204,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2175,525,750,770,3400,2100,1354.9],'cm^-1')),
        HinderedRotor(inertia=(0.445003,'amu*angstrom^2'), symmetry=1, barrier=(10.2315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.79248,'amu*angstrom^2'), symmetry=1, barrier=(64.2047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29145,0.0425643,-6.8252e-05,6.13839e-08,-2.11998e-11,4593.49,17.6384], Tmin=(100,'K'), Tmax=(882.682,'K')), NASAPolynomial(coeffs=[5.03888,0.0187162,-8.35621e-06,1.51716e-09,-1.00605e-13,4552.48,7.24164], Tmin=(882.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.7204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCOJ)"""),
)

species(
    label = '[CH]C(C)=C(O)O(865)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {5,S} {11,S}
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.225128,0.0734142,-7.73979e-05,4.12226e-08,-8.4687e-12,-3244.7,22.225], Tmin=(100,'K'), Tmax=(1270.77,'K')), NASAPolynomial(coeffs=[17.6168,0.0150483,-4.22791e-06,5.93381e-10,-3.43909e-14,-7372.39,-64.6964], Tmin=(1270.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.1762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2][C](C)C(=O)O(866)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99345,0.0464207,-3.33543e-05,1.2798e-08,-2.12787e-12,-16222.7,21.244], Tmin=(100,'K'), Tmax=(1324.53,'K')), NASAPolynomial(coeffs=[8.02517,0.0282053,-1.27259e-05,2.41528e-09,-1.68177e-13,-17820.6,-9.55084], Tmin=(1324.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-135.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ(C)CO) + radical(CJC(C)C=O)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.16657,0.0317404,-1.21484e-05,8.37378e-10,1.39038e-13,6984.33,14.0283], Tmin=(100,'K'), Tmax=(2635.6,'K')), NASAPolynomial(coeffs=[37.4395,-0.00348318,-7.94556e-07,1.64341e-10,-5.69601e-15,-15859.5,-188.803], Tmin=(2635.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.4205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH]C(=C)C(O)O(869)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-22.3054,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,350,440,435,1725,2950,3100,1380,975,1025,1650,462.387,462.395,462.406,462.425],'cm^-1')),
        HinderedRotor(inertia=(0.350768,'amu*angstrom^2'), symmetry=1, barrier=(53.2297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.350837,'amu*angstrom^2'), symmetry=1, barrier=(53.23,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.350845,'amu*angstrom^2'), symmetry=1, barrier=(53.2294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.350804,'amu*angstrom^2'), symmetry=1, barrier=(53.2297,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40495,0.0587996,-5.42802e-05,2.8588e-08,-6.39244e-12,-2590.7,23.5212], Tmin=(100,'K'), Tmax=(1050.02,'K')), NASAPolynomial(coeffs=[8.96792,0.029988,-1.31204e-05,2.4546e-09,-1.70143e-13,-4178.91,-13.3347], Tmin=(1050.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.3054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CC([O])O(786)'],
    products = ['[CH]=C(C)C([O])O(827)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(8)', '[CH]=C(C)C=O(674)'],
    products = ['[CH]=C(C)C([O])O(827)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(42.4874,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    ...
    products = ['[CH]=C(C)C([O])O(827)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(21.6583,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CH3(18)', 'C#CC([O])O(804)'],
    products = ['[CH]=C(C)C([O])O(827)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C(=C)C(O)O(869)'],
    products = ['[CH]=C(C)C([O])O(827)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(1.72e-08,'s^-1'), n=5.55, Ea=(102.117,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""From training reaction 340 used for R4H_SSS;C_rad_out_2H;O_H_out
