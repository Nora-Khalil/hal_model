...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH2]C(=C)[O](414)'],
    products = ['C=C([O])C[O](357)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](58)', '[CH2][C]=O(128)'],
    products = ['C=C([O])C[O](357)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(17)', '[O]C[C]=O(276)'],
    products = ['C=C([O])C[O](357)'],
