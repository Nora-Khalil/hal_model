...
"""),
    E0 = (-340.013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,3000,3100,440,815,1455,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8497,0.0639341,-0.00013575,1.47206e-07,-5.70421e-11,-40832.6,22.3026], Tmin=(100,'K'), Tmax=(872.522,'K')), NASAPolynomial(coeffs=[-1.6027,0.038084,-1.96597e-05,3.76004e-09,-2.55132e-13,-38643.7,47.5787], Tmin=(872.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-340.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsOs) + group(Cs-OsHHH) + radical(OCOJ) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (-321.232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,180,1620.53,1620.62,1621,1621.02,1621.11,1621.37],'cm^-1')),
        HinderedRotor(inertia=(0.326536,'amu*angstrom^2'), symmetry=1, barrier=(7.50771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326505,'amu*angstrom^2'), symmetry=1, barrier=(7.507,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0242,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.0627,0.0451013,-0.000134632,1.73003e-07,-7.26636e-11,-38625,15.6013], Tmin=(100,'K'), Tmax=(873.422,'K')), NASAPolynomial(coeffs=[-11.218,0.0459597,-2.52618e-05,4.9179e-09,-3.35751e-13,-33668.5,96.6578], Tmin=(873.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-321.232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsOs) + radical(OCOJ) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-300.486,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,201.619,861.947,990.824,1048.48,1154.37,1281.48,1391.53,1565.58,1694.19],'cm^-1')),
        HinderedRotor(inertia=(0.147132,'amu*angstrom^2'), symmetry=1, barrier=(3.48316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147132,'amu*angstrom^2'), symmetry=1, barrier=(3.48316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147132,'amu*angstrom^2'), symmetry=1, barrier=(3.48316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (92.0508,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.50978,0.0596438,-0.000155479,1.96039e-07,-8.26159e-11,-36112.3,19.6145], Tmin=(100,'K'), Tmax=(865.192,'K')), NASAPolynomial(coeffs=[-12.7184,0.0592174,-3.19408e-05,6.22505e-09,-4.27378e-13,-30826.2,106.197], Tmin=(865.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-300.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsOs) + group(Cs-OsHHH) + radical(OCOJ) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[O]C([O])(O)O(1027)'],
    products = ['[CH2]OC([O])(O)O(1275)'],
    transitionState = 'TS2',
