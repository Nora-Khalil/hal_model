...
reaction(
    ...
    products = ['[CH2][C]=C(781)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(54712.4,'m^3/(mol*s)'), n=1.12504, Ea=(15.2981,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1599324681732481, var=0.7879868354686959, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_N-1COS->O_N-Sp-2CS=1CCSS_Ext-2CS-R_4R!H->C',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_N-1COS->O_N-Sp-2CS=1CCSS_Ext-2CS-R_4R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[CH2][C]=C(781)'],
    products = ['[CH]C=C(1026)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=[C]C(200)'],
    products = ['[CH2][C]=C(781)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(720,'s^-1'), n=2.932, Ea=(129.315,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3Hall;Cd_rad_out_singleH;Cs_H_out_2H] for rate rule [R3HJ;Cd_rad_out_singleH;Cs_H_out_2H]
