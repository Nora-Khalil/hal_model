...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.29541,'amu*angstrom^2'), symmetry=1, barrier=(29.784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2918,'amu*angstrom^2'), symmetry=1, barrier=(29.7011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19391,0.0309401,-7.72843e-06,-1.74813e-08,1.00755e-11,-5592.31,16.0124], Tmin=(100,'K'), Tmax=(977.485,'K')), NASAPolynomial(coeffs=[13.1042,0.00690242,-2.46642e-06,4.9879e-10,-3.95315e-14,-8709.78,-41.411], Tmin=(977.485,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.1032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]O(118)', '[CH]=C[O](171)'],
    products = ['[CH]=CO[CH]O(787)'],
    transitionState = 'TS2',
