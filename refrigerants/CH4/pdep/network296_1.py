...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(117)', '[CH2]O[CH2](60)'],
    products = ['[CH2]OC[C]=O(362)'],
    transitionState = 'TS3',
