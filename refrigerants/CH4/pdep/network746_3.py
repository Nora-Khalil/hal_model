...
"""),
    E0 = (-170.357,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([378.12,850.671,850.672,850.672,850.673,2244.36],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.0088,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3624.97,'J/mol'), sigma=(5.39579,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=566.21 K, Pc=52.36 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    molecularWeight = (60.0088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.69855,-0.00175994,1.24653e-05,-8.28355e-09,1.54632e-12,27162.5,7.88112], Tmin=(100,'K'), Tmax=(1918.48,'K')), NASAPolynomial(coeffs=[4.50402,0.00993407,-5.50394e-06,1.02774e-09,-6.67203e-14,25159.7,3.5322], Tmin=(1918.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(226.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(83.1447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + ring(dioxirane) + radical(OCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[O][C]=O(213)'],
    products = ['[O]O[C]=O(131)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]O[C]=O(131)'],
    products = ['O=C1OO1(1196)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction1',
    reactants = ['O(7)', 'CO2(15)'],
    products = ['[O]O[C]=O(131)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.3615e+08,'m^3/(mol*s)'), n=-0.990129, Ea=(267.046,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05768407177011316, var=24.87296733003861, Tref=1000.0, N=33, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C
Multiplied by reaction path degeneracy 2.0
Ea raised from 264.4 to 267.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['O-2(208)', 'CO2(15)'],
    products = ['O=C1OO1(1196)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C([O])=O(268)'],
    products = ['O=C1OO1(1196)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(6.54e+16,'s^-1'), n=0, Ea=(2.9288,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_SS;Y_rad_out;Ypri_rad_out] for rate rule [R3_SS;O_rad;Opri_rad]
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C([O])=O(268)'],
    products = ['[O][C]1OO1(1197)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.67807e+11,'s^-1'), n=0.551275, Ea=(286.53,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra;radadd_intra_O]
Euclidian distance = 1.7320508075688772
Multiplied by reaction path degeneracy 3.0
family: Intra_R_Add_Endocyclic
Ea raised from 285.7 to 286.5 kJ/mol to match endothermicity of reaction."""),
)
