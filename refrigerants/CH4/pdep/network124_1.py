...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[CH]C=C(181)'],
    products = ['[CH]=CC[CH2](173)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[CH](149)', '[CH2][CH2](81)'],
    products = ['[CH]=CC[CH2](173)'],
    transitionState = 'TS9',
