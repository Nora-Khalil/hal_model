...
"""),
    E0 = (36.6874,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2175,525,750,770,3400,2100,308.123,308.817,308.851],'cm^-1')),
        HinderedRotor(inertia=(0.00176923,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130238,'amu*angstrom^2'), symmetry=1, barrier=(8.77922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266244,'amu*angstrom^2'), symmetry=1, barrier=(17.9569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01021,'amu*angstrom^2'), symmetry=1, barrier=(68.2946,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09133,0.0653352,-9.01458e-05,6.55169e-08,-1.85569e-11,4515.9,22.0145], Tmin=(100,'K'), Tmax=(933.576,'K')), NASAPolynomial(coeffs=[11.4319,0.0170587,-6.19741e-06,1.01261e-09,-6.31557e-14,2758.24,-26.2349], Tmin=(933.576,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.6874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CtOsHH) + group(Cs-OsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(OCJO)"""),
)

species(
    label = 'C=[C]COC[O](1054)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  O u1 p2 c0 {4,S}
3  C u0 p0 c0 {1,S} {6,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.06905,0.0339709,-1.51502e-05,2.23642e-09,-7.08428e-14,11762.9,13.9643], Tmin=(100,'K'), Tmax=(2864.2,'K')), NASAPolynomial(coeffs=[46.2268,-0.0125728,2.76673e-06,-4.30682e-10,3.07464e-14,-17445.1,-242.615], Tmin=(2864.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.1352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = '[CH]=[C]COCO(1057)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  O u0 p2 c0 {4,S} {11,S}
3  C u0 p0 c0 {1,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (166.715,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,3120,650,792.5,1650,294.153,294.749,294.767],'cm^-1')),
        HinderedRotor(inertia=(0.00195163,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260374,'amu*angstrom^2'), symmetry=1, barrier=(16.0393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261499,'amu*angstrom^2'), symmetry=1, barrier=(16.0321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.259589,'amu*angstrom^2'), symmetry=1, barrier=(16.0308,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0644,0.0541599,-3.1858e-05,-8.70829e-09,1.05459e-11,20166.5,25.5812], Tmin=(100,'K'), Tmax=(932.216,'K')), NASAPolynomial(coeffs=[17.7296,0.00908875,-1.8739e-06,2.69959e-10,-2.01135e-14,15910.6,-59.8103], Tmin=(932.216,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]O(118)', 'C=[C]C[O](184)'],
    products = ['C=[C]CO[CH]O(1046)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(148)', '[CH2]O[CH]O(64)'],
    products = ['C=[C]CO[CH]O(1046)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['C=[C]CO[CH]O(1046)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(121.746,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'C=[C]COC=O(1052)'],
    products = ['C=[C]CO[CH]O(1046)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['C=[C]CO[CH]O(1046)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(27.7769,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
