...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC=[C]C(646)'],
    products = ['CH2O(19)', 'C#CC(199)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', 'C[C]=C[O](664)'],
    products = ['[CH2]OC=[C]C(646)'],
    transitionState = 'TS2',
