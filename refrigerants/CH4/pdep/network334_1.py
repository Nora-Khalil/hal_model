...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(148)', '[CH2]C([O])=O(275)'],
    products = ['[CH2]C(=O)O[C]=C(536)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'C=[C]O[C]=O(300)'],
    products = ['[CH2]C(=O)O[C]=C(536)'],
    transitionState = 'TS3',
