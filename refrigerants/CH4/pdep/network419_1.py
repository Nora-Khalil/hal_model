...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.351442,'amu*angstrom^2'), symmetry=1, barrier=(8.08034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.351439,'amu*angstrom^2'), symmetry=1, barrier=(8.08028,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89987,0.0499459,-7.64007e-05,6.37223e-08,-2.10046e-11,15828.1,20.75], Tmin=(100,'K'), Tmax=(834.584,'K')), NASAPolynomial(coeffs=[7.65203,0.017118,-7.9472e-06,1.49147e-09,-1.01706e-13,15051.1,-4.86346], Tmin=(834.584,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.003,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70236,0.0367405,-6.14018e-05,7.04737e-08,-3.0198e-11,11762.3,18.7098], Tmin=(100,'K'), Tmax=(820.036,'K')), NASAPolynomial(coeffs=[-0.946695,0.0335683,-1.72378e-05,3.38308e-09,-2.36773e-13,13065.9,39.8897], Tmin=(820.036,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.4755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([O])O(786)'],
    products = ['O=CO(77)', 'C2H2(22)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH]C=CO(183)'],
    products = ['[CH]=CC([O])O(786)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]O(212)', '[CH]=[CH](149)'],
    products = ['[CH]=CC([O])O(786)'],
