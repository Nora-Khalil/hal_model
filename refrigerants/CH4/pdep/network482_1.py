...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.69398,'amu*angstrom^2'), symmetry=1, barrier=(38.948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.69284,'amu*angstrom^2'), symmetry=1, barrier=(38.9217,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (58.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7804,0.0179249,9.23705e-06,-2.96866e-08,1.36167e-11,-4681.46,13.8245], Tmin=(100,'K'), Tmax=(971.38,'K')), NASAPolynomial(coeffs=[11.8267,0.00248481,-6.01171e-07,1.80918e-10,-1.92711e-14,-7467.97,-34.8528], Tmin=(971.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.3557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(OCJC=O) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (59.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.73076,0.0175104,1.902e-05,-4.15794e-08,1.80496e-11,-23280.5,13.329], Tmin=(100,'K'), Tmax=(963.669,'K')), NASAPolynomial(coeffs=[12.0193,0.00477206,-1.33663e-06,3.02991e-10,-2.77184e-14,-26269.4,-37.3587], Tmin=(963.669,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(OCJC=O)"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]CO(355)'],
    products = ['O=C[CH]O(1392)'],
    transitionState = 'TS8',
