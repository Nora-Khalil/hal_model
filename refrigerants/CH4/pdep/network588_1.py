...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C=C(202)'],
    products = ['C=CCO[O](939)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['C=CCO[O](939)'],
    products = ['HO2(12)', 'C=C=C(718)'],
    transitionState = 'TS4',
