...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'C=C=C(718)'],
    products = ['[CH2]C(=C)O[O](894)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(=C)O[O](894)'],
    products = ['O=O(952)', 'C=C=C(718)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', 'C=[C]O[O](159)'],
    products = ['[CH2]C(=C)O[O](894)'],
    transitionState = 'TS4',
