...
"""),
    E0 = (214.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([180,1426.04,1433.97,1436.36,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.356339,'amu*angstrom^2'), symmetry=1, barrier=(8.19294,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (46.0254,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.47394,0.0203139,-5.53327e-05,6.83497e-08,-2.84753e-11,25851.4,0.678624], Tmin=(100,'K'), Tmax=(859.288,'K')), NASAPolynomial(coeffs=[-0.731508,0.0170135,-9.63702e-06,1.91472e-09,-1.32726e-13,27418.8,25.2442], Tmin=(859.288,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (172.117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,180,1110.3,2348.76,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.126654,'amu*angstrom^2'), symmetry=1, barrier=(2.91203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127798,'amu*angstrom^2'), symmetry=1, barrier=(2.93832,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (74.0354,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.15603,0.0252576,-5.00169e-05,5.79667e-08,-2.42338e-11,20724.8,13.3264], Tmin=(100,'K'), Tmax=(834.499,'K')), NASAPolynomial(coeffs=[0.550043,0.0206306,-1.09303e-05,2.15981e-09,-1.50995e-13,21755.8,28.9986], Tmin=(834.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-O4dc) + group(CsJ2_singlet-CsH) + group(Cds-OdCsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(14)', '[C-]=[O+]O(778)'],
    products = ['[C-]=[O+]OC=O(751)'],
    transitionState = 'TS2',
