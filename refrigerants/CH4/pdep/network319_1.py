...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'O=[C]O[C]=O(290)'],
    products = ['[CH2]C(=O)O[C]=O(384)'],
    transitionState = 'TS3',
