...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH2]C([O])=O(275)'],
    products = ['[O]CC([O])=O(250)'],
    transitionState = 'TS2',
