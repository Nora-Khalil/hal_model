...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(117)', '[CH]C=C(181)'],
    products = ['[CH]=CC[C]=O(377)'],
    transitionState = 'TS3',
