...
"""),
    E0 = (73.5865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,180,2732.83],'cm^-1')),
        HinderedRotor(inertia=(0.335643,'amu*angstrom^2'), symmetry=1, barrier=(7.71708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.33566,'amu*angstrom^2'), symmetry=1, barrier=(7.71748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.335585,'amu*angstrom^2'), symmetry=1, barrier=(7.71576,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68875,0.0593144,-9.31767e-05,9.1344e-08,-3.50266e-11,8925.4,24.4617], Tmin=(100,'K'), Tmax=(827.67,'K')), NASAPolynomial(coeffs=[2.54631,0.0364821,-1.79292e-05,3.45414e-09,-2.3922e-13,9423.54,24.3534], Tmin=(827.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.5865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ) + radical(Cds_S)"""),
)
...
"""),
    E0 = (172.099,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,1685,370,1174.16],'cm^-1')),
        HinderedRotor(inertia=(0.0320826,'amu*angstrom^2'), symmetry=1, barrier=(3.24657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.808042,'amu*angstrom^2'), symmetry=1, barrier=(18.5785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.806231,'amu*angstrom^2'), symmetry=1, barrier=(18.5368,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67831,0.0352977,2.03871e-05,-5.85824e-08,2.66138e-11,-29235.8,17.7972], Tmin=(100,'K'), Tmax=(955.924,'K')), NASAPolynomial(coeffs=[16.765,0.011242,-3.17851e-06,6.12189e-10,-5.0057e-14,-33905.4,-63.6451], Tmin=(955.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.22119,0.0277206,-1.40192e-05,2.99533e-09,-2.38753e-13,-38905.4,14.7094], Tmin=(100,'K'), Tmax=(2977.61,'K')), NASAPolynomial(coeffs=[19.086,0.00640805,-3.28265e-06,5.91443e-10,-3.69202e-14,-48353.1,-79.1394], Tmin=(2977.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-323.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s)"""),
)
...
"""),
    E0 = (-85.7734,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,180,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.237504,'amu*angstrom^2'), symmetry=1, barrier=(5.46069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237236,'amu*angstrom^2'), symmetry=1, barrier=(5.45453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000480707,'amu*angstrom^2'), symmetry=1, barrier=(5.45798,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.43882,0.0405145,-6.56236e-05,6.61958e-08,-2.59491e-11,-10266,18.0494], Tmin=(100,'K'), Tmax=(816.365,'K')), NASAPolynomial(coeffs=[2.7637,0.0252966,-1.26254e-05,2.47034e-09,-1.72873e-13,-9864.95,19.3289], Tmin=(816.365,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-85.7734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-4.46068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2100,2250,500,550,180,1427.68],'cm^-1')),
        HinderedRotor(inertia=(0.232224,'amu*angstrom^2'), symmetry=1, barrier=(5.3393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232455,'amu*angstrom^2'), symmetry=1, barrier=(5.34461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.70564,'amu*angstrom^2'), symmetry=1, barrier=(62.2081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89645,0.0504653,-6.65917e-05,5.55055e-08,-1.85441e-11,-464.763,22.4774], Tmin=(100,'K'), Tmax=(889.061,'K')), NASAPolynomial(coeffs=[5.00789,0.0270251,-1.11148e-05,1.96122e-09,-1.28868e-13,-644.878,9.93081], Tmin=(889.061,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.46068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCOJ)"""),
)

species(
    label = 'C[C]=C[C](O)O(884)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39516,0.0623821,-8.9662e-05,7.59381e-08,-2.60404e-11,6478.7,25.3454], Tmin=(100,'K'), Tmax=(811.076,'K')), NASAPolynomial(coeffs=[7.01003,0.0278104,-1.30001e-05,2.46607e-09,-1.6998e-13,5794.2,0.827833], Tmin=(811.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.1277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_P) + radical(Cds_S)"""),
)
...
"""),
    E0 = (85.7232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1670,1700,300,440,180],'cm^-1')),
        HinderedRotor(inertia=(0.280855,'amu*angstrom^2'), symmetry=1, barrier=(6.45741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.280716,'amu*angstrom^2'), symmetry=1, barrier=(6.45422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.280588,'amu*angstrom^2'), symmetry=1, barrier=(6.45126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.280676,'amu*angstrom^2'), symmetry=1, barrier=(6.45328,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30118,0.0665456,-0.000105113,9.44873e-08,-3.3247e-11,10400.4,24.7742], Tmin=(100,'K'), Tmax=(845.14,'K')), NASAPolynomial(coeffs=[6.14143,0.0294029,-1.39268e-05,2.62898e-09,-1.79504e-13,10090.6,5.24462], Tmin=(845.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.7232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C=C([O])O(888)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30491,0.0499153,-2.59434e-05,-7.81405e-09,8.18434e-12,-11906.8,19.7009], Tmin=(100,'K'), Tmax=(966.611,'K')), NASAPolynomial(coeffs=[15.0586,0.0146768,-4.89787e-06,8.70925e-10,-6.22416e-14,-15578.4,-51.4239], Tmin=(966.611,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.8758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(Allyl_S)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07152,0.0521494,-8.15269e-05,8.86761e-08,-3.70696e-11,7450.63,22.7795], Tmin=(100,'K'), Tmax=(816.985,'K')), NASAPolynomial(coeffs=[-1.05134,0.0435653,-2.19337e-05,4.27977e-09,-2.98974e-13,8757.64,42.0904], Tmin=(816.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.4499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', 'C[C]=C[CH]O(684)'],
    products = ['C[C]=CC([O])O(825)'],
    transitionState = 'TS2',
