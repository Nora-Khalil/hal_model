...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(131)', 'CH2(T)(17)'],
    products = ['[CH2]OO[C]=O(253)'],
    transitionState = 'TS2',
