...
"""),
    E0 = (-164.689,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,1854.71,1855.71],'cm^-1')),
        HinderedRotor(inertia=(0.00132041,'amu*angstrom^2'), symmetry=1, barrier=(3.23559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138707,'amu*angstrom^2'), symmetry=1, barrier=(3.18914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140322,'amu*angstrom^2'), symmetry=1, barrier=(3.22627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59219,0.0475684,-0.000109365,1.33122e-07,-5.61962e-11,-19772.9,19.3418], Tmin=(100,'K'), Tmax=(846.691,'K')), NASAPolynomial(coeffs=[-5.54533,0.0424856,-2.32486e-05,4.59912e-09,-3.20131e-13,-16834.8,66.4598], Tmin=(846.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-164.689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7332,0.00871893,6.87356e-05,-1.01924e-07,4.09263e-11,-50830.3,15.0306], Tmin=(100,'K'), Tmax=(951.093,'K')), NASAPolynomial(coeffs=[15.4529,0.00382603,-1.99859e-07,1.24944e-10,-2.09492e-14,-55448,-57.2532], Tmin=(951.093,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-423.151,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)
...
"""),
    E0 = (-147.314,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2147.84,2148.43,2149.19],'cm^-1')),
        HinderedRotor(inertia=(0.133534,'amu*angstrom^2'), symmetry=1, barrier=(3.07021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133508,'amu*angstrom^2'), symmetry=1, barrier=(3.06961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133186,'amu*angstrom^2'), symmetry=1, barrier=(3.06221,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72928,0.0468932,-0.000115052,1.44499e-07,-6.16272e-11,-17690.3,18.7472], Tmin=(100,'K'), Tmax=(851.466,'K')), NASAPolynomial(coeffs=[-7.77944,0.0460896,-2.52511e-05,4.98581e-09,-3.46187e-13,-14082.1,78.4357], Tmin=(851.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(Cs_P)"""),
)
...
"""),
    E0 = (-125.162,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1794.91,1795.03,1795.1,1795.29],'cm^-1')),
        HinderedRotor(inertia=(0.221739,'amu*angstrom^2'), symmetry=1, barrier=(5.09821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0022299,'amu*angstrom^2'), symmetry=1, barrier=(5.09966,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.24597,0.0433614,-0.000129434,1.82477e-07,-8.20373e-11,-15052.4,15.9827], Tmin=(100,'K'), Tmax=(849.664,'K')), NASAPolynomial(coeffs=[-16.6547,0.0636071,-3.55224e-05,7.06232e-09,-4.92222e-13,-9019.61,124.35], Tmin=(849.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[O]C([O])O(220)'],
    products = ['[CH2]OC([O])O(819)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['COC([O])[O](840)'],
    products = ['[CH2]OC([O])O(819)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(4.6e+09,'s^-1','*|/',2.51189), n=0.75, Ea=(97.0688,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 0 used for R4H_SSS;O_rad_out;Cs_H_out_2H
