...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(117)', '[O]C([O])=O(268)'],
    products = ['[O]C(=O)O[C]=O(265)'],
    transitionState = 'TS2',
