...
"""),
    E0 = (-226.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,180,1119.23,1119.9,1120.35,1120.43],'cm^-1')),
        HinderedRotor(inertia=(0.0314071,'amu*angstrom^2'), symmetry=1, barrier=(3.32212,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
This reaction matched rate rule [Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_N-3BrCO->Br_3CO->O_Ext-2CF-R_N-4R!H->C]
family: R_Recombination"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(14)', 'CH2O(19)'],
    products = ['O=CC=O(122)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.142289,'m^3/(mol*s)'), n=2.26675, Ea=(299.028,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.11077368402443419, var=66.76874779178424, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->H',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]C[C]=O(276)'],
    products = ['O=CC=O(122)'],
    transitionState = 'TS3',
