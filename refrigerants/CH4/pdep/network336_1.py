...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(148)', 'C=[C]O[O](159)'],
    products = ['C=[C]OO[C]=C(538)'],
    transitionState = 'TS2',
