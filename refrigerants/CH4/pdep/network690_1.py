...
"""),
    E0 = (-614.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,467.527,467.53,467.531,467.532],'cm^-1')),
        HinderedRotor(inertia=(0.23687,'amu*angstrom^2'), symmetry=1, barrier=(36.7417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23687,'amu*angstrom^2'), symmetry=1, barrier=(36.7415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23687,'amu*angstrom^2'), symmetry=1, barrier=(36.7415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23687,'amu*angstrom^2'), symmetry=1, barrier=(36.7417,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
...
"""),
    E0 = (-74.4788,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,1367.25,1369.84],'cm^-1')),
        HinderedRotor(inertia=(0.00386169,'amu*angstrom^2'), symmetry=1, barrier=(5.16203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224869,'amu*angstrom^2'), symmetry=1, barrier=(5.17018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00385797,'amu*angstrom^2'), symmetry=1, barrier=(5.1503,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0508,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5703,0.0590916,-0.000156026,2.05962e-07,-9.05049e-11,-8933.14,20.0859], Tmin=(100,'K'), Tmax=(843.425,'K')), NASAPolynomial(coeffs=[-15.0253,0.0676973,-3.82256e-05,7.63978e-09,-5.3459e-13,-3302.99,117.759], Tmin=(843.425,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.4788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(OCOJ)"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (92.0508,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4080.75,'J/mol'), sigma=(6.63473,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=637.40 K, Pc=31.7 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-371.043,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,180,473.674,713.154,713.158,713.21],'cm^-1')),
        HinderedRotor(inertia=(0.0918849,'amu*angstrom^2'), symmetry=1, barrier=(33.163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0918691,'amu*angstrom^2'), symmetry=1, barrier=(33.1627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0918865,'amu*angstrom^2'), symmetry=1, barrier=(33.1634,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.0428,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01765,0.0309676,9.68593e-06,-3.97156e-08,1.82417e-11,-44543.5,20.0598], Tmin=(100,'K'), Tmax=(982.106,'K')), NASAPolynomial(coeffs=[14.7483,0.00941834,-3.6813e-06,7.73782e-10,-6.19991e-14,-48505.4,-48.5681], Tmin=(982.106,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.043,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-OsHHH) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['COOC(=O)O(1278)'],
    products = ['CH2O(19)', 'O=C(O)O(747)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1054.45,'s^-1'), n=2.72887, Ea=(86.478,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', 'O=C(O)OO(1028)'],
