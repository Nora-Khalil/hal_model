...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.248707,'amu*angstrom^2'), symmetry=1, barrier=(5.71826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248786,'amu*angstrom^2'), symmetry=1, barrier=(5.72008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248692,'amu*angstrom^2'), symmetry=1, barrier=(5.71792,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2481,0.0410859,-4.15988e-05,2.81248e-08,-8.40505e-12,18286.1,21.4524], Tmin=(100,'K'), Tmax=(790.435,'K')), NASAPolynomial(coeffs=[5.4752,0.0247549,-1.06073e-05,1.98572e-09,-1.37648e-13,17776,6.6425], Tmin=(790.435,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = 'CC[CH]O[O](1186)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (139.702,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,203.419],'cm^-1')),
        HinderedRotor(inertia=(0.000885138,'amu*angstrom^2'), symmetry=1, barrier=(7.01212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237805,'amu*angstrom^2'), symmetry=1, barrier=(7.01718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238733,'amu*angstrom^2'), symmetry=1, barrier=(7.01477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20784,0.0420296,-4.33792e-05,3.01326e-08,-9.2477e-12,16864.4,19.4406], Tmin=(100,'K'), Tmax=(771.321,'K')), NASAPolynomial(coeffs=[5.43298,0.0253065,-1.08618e-05,2.03087e-09,-1.40557e-13,16366.8,4.71822], Tmin=(771.321,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]CCO[O](1187)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {4,S}
2  O u1 p2 c0 {1,S}
3  C u0 p0 c0 {4,S} {5,S} {6,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.220004,'amu*angstrom^2'), symmetry=1, barrier=(5.05834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220108,'amu*angstrom^2'), symmetry=1, barrier=(5.06073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219984,'amu*angstrom^2'), symmetry=1, barrier=(5.05787,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30677,0.0392486,-3.4247e-05,1.87085e-08,-4.51403e-12,18865.7,20.7231], Tmin=(100,'K'), Tmax=(960.574,'K')), NASAPolynomial(coeffs=[6.03962,0.023704,-9.97256e-06,1.861e-09,-1.29187e-13,18148.6,2.86451], Tmin=(960.574,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(156.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(ROOJ) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03865,0.0408812,-2.67536e-05,9.01766e-09,-1.26357e-12,133.04,21.7174], Tmin=(100,'K'), Tmax=(1602.57,'K')), NASAPolynomial(coeffs=[9.65913,0.0218606,-8.95039e-06,1.61159e-09,-1.08232e-13,-2309.44,-18.6409], Tmin=(1602.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.506212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), label="""QOOH_2""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73075,0.0457841,-3.51689e-05,1.42448e-08,-2.36093e-12,1161.01,22.4746], Tmin=(100,'K'), Tmax=(1415.61,'K')), NASAPolynomial(coeffs=[10.8293,0.0200752,-7.92785e-06,1.41612e-09,-9.53849e-14,-1415.04,-24.5833], Tmin=(1415.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.94627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), label="""QOOH_1""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCO[O](1180)'],
    products = ['O2(2)', '[CH2]CC(93)'],
    transitionState = 'TS1',
...
This reaction matched rate rule [Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H]
family: R_Recombination"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', 'CCO[O](82)'],
    products = ['CCCO[O](1180)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000166864,'m^3/(mol*s)'), n=2.82973, Ea=(155.231,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(7)', 'CCC[O](87)'],
    products = ['CCCO[O](1180)'],
    transitionState = 'TS3',
