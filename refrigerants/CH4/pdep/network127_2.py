...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=CC=C(175)'],
    products = ['[CH]1C=CC1(978)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(T)(17)', '[CH]1C=C1(1136)'],
    products = ['[CH2]C1C=C1(979)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', 'C=C1[CH][CH]1(1254)'],
    products = ['[CH2]C1C=C1(979)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH2]C1[C]=C1(1255)'],
    products = ['[CH2]C1C=C1(979)'],
