...
"""),
    E0 = (-165.833,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180,690.477,690.522,690.557],'cm^-1')),
        HinderedRotor(inertia=(0.11393,'amu*angstrom^2'), symmetry=1, barrier=(2.61948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.771643,'amu*angstrom^2'), symmetry=1, barrier=(17.7416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0524345,'amu*angstrom^2'), symmetry=1, barrier=(17.7415,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70926,0.045298,-4.65253e-05,2.35101e-08,-4.60996e-12,-19858.3,19.6353], Tmin=(100,'K'), Tmax=(1252.37,'K')), NASAPolynomial(coeffs=[12.9423,0.0094199,-3.55255e-06,6.34325e-10,-4.34226e-14,-22671.8,-37.0853], Tmin=(1252.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)
...
"""),
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35261,0.0170207,5.40714e-05,-9.46971e-08,4.08374e-11,-67519.1,17.5191], Tmin=(100,'K'), Tmax=(928.125,'K')), NASAPolynomial(coeffs=[17.9201,-0.000671848,2.82811e-06,-5.42594e-10,2.90199e-14,-72536.5,-67.8859], Tmin=(928.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-562.027,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (-127.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,523.093,523.187,523.328,523.365,523.65],'cm^-1')),
        HinderedRotor(inertia=(0.000614119,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192166,'amu*angstrom^2'), symmetry=1, barrier=(37.3903,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37418,0.0253457,1.24162e-05,-3.50676e-08,1.49554e-11,-15254.3,17.241], Tmin=(100,'K'), Tmax=(1006.63,'K')), NASAPolynomial(coeffs=[11.8157,0.0125472,-5.34663e-06,1.09059e-09,-8.29999e-14,-18407.6,-34.5921], Tmin=(1006.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-127.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]O(118)', '[O]C[O](59)'],
    products = ['[O]CO[CH]O(818)'],
    transitionState = 'TS2',
