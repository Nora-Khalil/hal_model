...
"""),
    E0 = (-33.8306,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,301.189,301.191,301.199],'cm^-1')),
        HinderedRotor(inertia=(0.00185822,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27919,'amu*angstrom^2'), symmetry=1, barrier=(17.9736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27917,'amu*angstrom^2'), symmetry=1, barrier=(17.9735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27919,'amu*angstrom^2'), symmetry=1, barrier=(17.9737,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0872435,0.0711899,-7.90839e-05,4.16015e-08,-8.12923e-12,-3915.25,24.5985], Tmin=(100,'K'), Tmax=(1436.01,'K')), NASAPolynomial(coeffs=[20.0348,0.00538027,3.6074e-07,-2.49197e-10,2.17233e-14,-8587.82,-75.1771], Tmin=(1436.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.8306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(OCJO)"""),
)
...
"""),
    E0 = (88.7885,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,331.754,331.872,331.923],'cm^-1')),
        HinderedRotor(inertia=(0.21205,'amu*angstrom^2'), symmetry=1, barrier=(16.5853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212684,'amu*angstrom^2'), symmetry=1, barrier=(16.5879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212311,'amu*angstrom^2'), symmetry=1, barrier=(16.5845,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38081,0.0571394,-5.9608e-05,3.34032e-08,-7.54393e-12,8279.93,21.6585], Tmin=(100,'K'), Tmax=(1070.91,'K')), NASAPolynomial(coeffs=[11.1631,0.0206006,-8.42814e-06,1.54201e-09,-1.05941e-13,6184.77,-26.2054], Tmin=(1070.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.0554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(OCJO)"""),
)

species(
    label = '[CH2][C]1CC(O)O1(1059)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-177.074,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,180,1623.63],'cm^-1')),
        HinderedRotor(inertia=(0.957182,'amu*angstrom^2'), symmetry=1, barrier=(22.0075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.955938,'amu*angstrom^2'), symmetry=1, barrier=(21.9789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0708666,'amu*angstrom^2'), symmetry=1, barrier=(21.9709,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51765,0.0476256,-3.63003e-05,1.22504e-08,-1.20953e-12,-21201.9,20.043], Tmin=(100,'K'), Tmax=(1175.84,'K')), NASAPolynomial(coeffs=[12.9147,0.0167276,-6.92727e-06,1.29093e-09,-9.0039e-14,-24426.4,-39.1015], Tmin=(1175.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(C=C(O)CJ)"""),
)
...
"""),
    E0 = (4.6072,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,360.457,360.541,360.58,360.632],'cm^-1')),
        HinderedRotor(inertia=(0.00129774,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291264,'amu*angstrom^2'), symmetry=1, barrier=(26.8767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291512,'amu*angstrom^2'), symmetry=1, barrier=(26.8775,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25459,0.0453174,5.84688e-07,-4.39709e-08,2.30304e-11,666.769,21.0941], Tmin=(100,'K'), Tmax=(941.801,'K')), NASAPolynomial(coeffs=[18.6887,0.00904398,-1.80263e-06,3.03805e-10,-2.64315e-14,-4292.3,-70.8633], Tmin=(941.801,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.6072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(OCOJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=C(C)O[CH]O(828)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (54.3489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3120,650,792.5,1650,287.033,287.035],'cm^-1')),
        HinderedRotor(inertia=(0.249389,'amu*angstrom^2'), symmetry=1, barrier=(14.5805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249388,'amu*angstrom^2'), symmetry=1, barrier=(14.5805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249389,'amu*angstrom^2'), symmetry=1, barrier=(14.5805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249388,'amu*angstrom^2'), symmetry=1, barrier=(14.5805,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3657.2,'J/mol'), sigma=(6.15433,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=571.25 K, Pc=35.6 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.348298,0.0706622,-8.03103e-05,4.39495e-08,-9.11122e-12,6676.42,24.0672], Tmin=(100,'K'), Tmax=(1273.33,'K')), NASAPolynomial(coeffs=[18.9289,0.00809325,-1.65505e-06,1.77904e-10,-8.66879e-15,2285.1,-68.7259], Tmin=(1273.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.3489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(OCJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)OCO(860)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.781175,0.0470243,3.03412e-05,-9.50275e-08,4.63477e-11,-1187.66,23.4317], Tmin=(100,'K'), Tmax=(913.155,'K')), NASAPolynomial(coeffs=[25.6764,0.000482386,4.11152e-06,-9.13015e-10,5.77867e-14,-8340.5,-108.682], Tmin=(913.155,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.0229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2][C](C)OC=O(861)',
    structure = adjacencyList("""multiplicity 3
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]O(118)', '[CH2]C(=C)[O](414)'],
    products = ['[CH2]C(=C)O[CH]O(859)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'C=[C]O[CH]O(411)'],
    products = ['[CH2]C(=C)O[CH]O(859)'],
    transitionState = 'TS3',
...
reaction(
    ...
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(6.73316e+11,'s^-1'), n=0.231216, Ea=(110.825,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csHNd]
Euclidian distance = 0
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(2.20566,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
