...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(148)', '[O]C[C]=O(276)'],
    products = ['C=[C]OC[C]=O(539)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(117)', '[CH2]O[C]=C(179)'],
    products = ['C=[C]OC[C]=O(539)'],
    transitionState = 'TS3',
