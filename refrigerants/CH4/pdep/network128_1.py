...
reaction(
    label = 'reaction3',
    reactants = ['C2H2(22)', '[CH]=[CH](149)'],
    products = ['[CH]=CC=[CH](176)'],
    transitionState = 'TS3',
