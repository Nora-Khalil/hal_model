...
"""),
    E0 = (96.1405,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.965449,'amu*angstrom^2'), symmetry=1, barrier=(22.1976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.964528,'amu*angstrom^2'), symmetry=1, barrier=(22.1764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.963993,'amu*angstrom^2'), symmetry=1, barrier=(22.1641,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238218,0.0604661,-7.03369e-05,3.62106e-08,-6.65955e-12,11717.7,22.4687], Tmin=(100,'K'), Tmax=(1622.78,'K')), NASAPolynomial(coeffs=[19.1444,-0.00323516,4.35034e-06,-9.65425e-10,6.79782e-14,7833.09,-70.9586], Tmin=(1622.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.1405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCJO) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-88.8948,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2782.5,750,1395,475,1775,1000,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.848379,'amu*angstrom^2'), symmetry=1, barrier=(19.5059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0300475,'amu*angstrom^2'), symmetry=1, barrier=(12.5207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.849062,'amu*angstrom^2'), symmetry=1, barrier=(19.5216,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78081,0.0471276,-3.7823e-05,1.51569e-08,-2.46951e-12,-10610.6,19.4997], Tmin=(100,'K'), Tmax=(1428.54,'K')), NASAPolynomial(coeffs=[11.5564,0.0197552,-9.08128e-06,1.74369e-09,-1.22145e-13,-13403.5,-31.1484], Tmin=(1428.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.8948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (92.7867,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3120,650,792.5,1650,389.159,391.455,391.826],'cm^-1')),
        HinderedRotor(inertia=(0.177912,'amu*angstrom^2'), symmetry=1, barrier=(19.3678,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180744,'amu*angstrom^2'), symmetry=1, barrier=(19.3775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178815,'amu*angstrom^2'), symmetry=1, barrier=(19.4056,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22212,0.0482355,-1.26601e-05,-2.60104e-08,1.53512e-11,11271.3,21.6173], Tmin=(100,'K'), Tmax=(966.336,'K')), NASAPolynomial(coeffs=[17.3963,0.0119261,-3.86117e-06,7.32283e-10,-5.64268e-14,6714.71,-63.2622], Tmin=(966.336,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.7867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(OCOJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CO[CH]O(787)'],
    products = ['[CH]=C(C)O[CH]O(828)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]O(118)', '[CH]=C(C)[O](325)'],
    products = ['[CH]=C(C)O[CH]O(828)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH]=C(C)O[CH]O(828)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(14.4599,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['CH3(18)', 'C#CO[CH]O(617)'],
    products = ['[CH]=C(C)O[CH]O(828)'],
    transitionState = 'TS9',
