...
species(
    label = '[CH2]C(C)=C[O](677)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
2  C u0 p0 c0 {3,S} {6,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {4,S} {5,D}
4  C u1 p0 c0 {3,S} {9,S} {11,S}
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CC[O](169)'],
    products = ['[CH]=C(C)C[O](645)'],
    transitionState = 'TS2',
