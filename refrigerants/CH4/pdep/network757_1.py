...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(3.8e+17,'s^-1','*|/',2.51189), n=-1.1, Ea=(166.809,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO_SCO;Y_rad_intra;OOH]
