...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(117)', '[CH2]C([O])=O(275)'],
    products = ['[O]C(=O)C[C]=O(383)'],
    transitionState = 'TS3',
