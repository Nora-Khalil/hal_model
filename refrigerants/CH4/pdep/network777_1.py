...
reaction(
    label = 'reaction2',
    reactants = ['CO(14)', 'O=C(O)O(747)'],
    products = ['O=COC(=O)O(758)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction1',
    reactants = ['O=COC(=O)O(758)'],
    products = ['CO2(15)', 'O=CO(77)'],
