...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(268)', '[C]=C(148)'],
    products = ['C=[C]OC([O])=O(382)'],
    transitionState = 'TS2',
