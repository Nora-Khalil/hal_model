...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'C=C=C([O])[O](308)'],
    products = ['[CH2]C(=C)C([O])=O(706)'],
    transitionState = 'TS3',
