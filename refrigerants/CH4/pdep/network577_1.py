...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(O)O(1086)'],
    products = ['HO2(12)', 'O=CO(77)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[O]C(O)O(811)'],
    products = ['[O]OC(O)O(1086)'],
    transitionState = 'TS2',
