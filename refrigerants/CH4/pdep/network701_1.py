...
"""),
    ...
    molecularWeight = (100.03,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50456,0.0698253,-0.000155129,1.58934e-07,-5.90289e-11,26664.9,22.8064], Tmin=(100,'K'), Tmax=(865.74,'K')), NASAPolynomial(coeffs=[3.64683,0.0242253,-1.42635e-05,2.82561e-09,-1.94148e-13,27632,20.5072], Tmin=(865.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + ring(oxirene) + radical(OC=OOJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(268)', '[C]=C=O(1258)'],
    products = ['[O]C(=O)O[C]=C=O(1307)'],
    transitionState = 'TS2',
