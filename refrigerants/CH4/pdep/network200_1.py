...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(268)', 'CH2(T)(17)'],
    products = ['[CH2]OC([O])=O(252)'],
    transitionState = 'TS2',
