...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[O]C([O])=C=O(295)'],
    products = ['[CH2]C(=O)C([O])=O(381)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C]=O(213)', '[CH2][C]=O(128)'],
    products = ['[CH2]C(=O)C([O])=O(381)'],
