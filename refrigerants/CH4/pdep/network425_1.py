...
"""),
    E0 = (-165.219,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,180,2144.82,2145.08],'cm^-1')),
        HinderedRotor(inertia=(0.164199,'amu*angstrom^2'), symmetry=1, barrier=(3.77525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164031,'amu*angstrom^2'), symmetry=1, barrier=(3.77139,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42534,0.0451947,-8.59021e-05,9.42398e-08,-3.78137e-11,-19824.8,21.0512], Tmin=(100,'K'), Tmax=(848.609,'K')), NASAPolynomial(coeffs=[-0.435886,0.0323369,-1.66084e-05,3.2203e-09,-2.22263e-13,-18390.6,39.9743], Tmin=(848.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34774,0.0307995,-1.42111e-05,-2.66943e-09,2.84874e-12,-70757.7,17.268], Tmin=(100,'K'), Tmax=(1080.09,'K')), NASAPolynomial(coeffs=[9.50821,0.014602,-6.04933e-06,1.13944e-09,-8.05097e-14,-72906.5,-20.6155], Tmin=(1080.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-588.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42658,0.0336613,-2.77732e-05,1.1974e-08,-2.12182e-12,-64626.4,18.8422], Tmin=(100,'K'), Tmax=(1319.97,'K')), NASAPolynomial(coeffs=[8.61063,0.0149213,-6.4772e-06,1.21812e-09,-8.4677e-14,-66259,-12.709], Tmin=(1319.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-537.811,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-OdCsH)"""),
)
...
"""),
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83637,0.0561405,-0.000102695,9.82533e-08,-3.52768e-11,-25262.8,21.1628], Tmin=(100,'K'), Tmax=(869.135,'K')), NASAPolynomial(coeffs=[4.79631,0.0228581,-1.13243e-05,2.14157e-09,-1.44833e-13,-25034.8,11.5697], Tmin=(869.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-210.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
"""),
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11701,0.0484529,-8.31379e-05,7.9939e-08,-2.93632e-11,-22270.9,21.9868], Tmin=(100,'K'), Tmax=(850.755,'K')), NASAPolynomial(coeffs=[4.06408,0.0236,-1.16402e-05,2.22272e-09,-1.52217e-13,-22034.1,16.2469], Tmin=(850.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-185.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(Cs_P)"""),
)
...
"""),
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42534,0.0451947,-8.59021e-05,9.42398e-08,-3.78137e-11,-19824.8,20.3581], Tmin=(100,'K'), Tmax=(848.609,'K')), NASAPolynomial(coeffs=[-0.435886,0.0323369,-1.66084e-05,3.2203e-09,-2.22263e-13,-18390.6,39.2812], Tmin=(848.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
"""),
    E0 = (61.1095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180,1219.56],'cm^-1')),
        HinderedRotor(inertia=(0.267667,'amu*angstrom^2'), symmetry=1, barrier=(6.1542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268192,'amu*angstrom^2'), symmetry=1, barrier=(6.16625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.35701,'amu*angstrom^2'), symmetry=1, barrier=(54.1922,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77797,0.0588238,-0.000109185,1.07844e-07,-3.98751e-11,7420.23,19.6677], Tmin=(100,'K'), Tmax=(859.735,'K')), NASAPolynomial(coeffs=[3.55206,0.0274101,-1.39694e-05,2.6778e-09,-1.82874e-13,7971.09,16.3546], Tmin=(859.735,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.1095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[O]C[CH]O(69)'],
    products = ['[O]CC([O])O(817)'],
    transitionState = 'TS2',
