...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(148)', '[CH2]C[O](66)'],
    products = ['[CH2]CO[C]=C(368)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[CH2]O[C]=C(179)'],
    products = ['[CH2]CO[C]=C(368)'],
    transitionState = 'TS3',
