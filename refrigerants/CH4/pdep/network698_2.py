...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.96163,'amu*angstrom^2'), symmetry=1, barrier=(45.1018,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (41.0287,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.22254,0.0203748,-3.96943e-05,3.63104e-08,-1.189e-11,50197.8,8.10631], Tmin=(100,'K'), Tmax=(966.518,'K')), NASAPolynomial(coeffs=[4.70891,0.00503502,-1.62761e-06,2.17546e-10,-1.00799e-14,50339.6,3.20623], Tmin=(966.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo library: FFCM1(-) + radical(Acetyl)"""),
)
...
"""),
    ...
    molecularWeight = (57.0281,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.52779,-0.000281509,4.61216e-05,-6.31252e-08,2.49198e-11,46170.1,13.1119], Tmin=(100,'K'), Tmax=(941.256,'K')), NASAPolynomial(coeffs=[9.63055,0.00104961,5.4929e-07,-7.23329e-11,-1.19974e-15,43813.4,-22.3769], Tmin=(941.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C#CO(816)'],
    products = ['OC1=[C]O1(1382)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.21162e+11,'s^-1'), n=0.569423, Ea=(336.177,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [R3_T;triplebond_intra_Nd;radadd_intra] for rate rule [R3_T;triplebond_intra_Nd;radadd_intra_O]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction5',
    reactants = ['H(6)', '[O]C#C[O](814)'],
    products = ['[O]C#CO(816)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4.42074e+06,'m^3/(mol*s)'), n=0.349925, Ea=(16.5849,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C
Multiplied by reaction path degeneracy 2.0"""),
)
