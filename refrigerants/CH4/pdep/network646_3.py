...
"""),
    ...
    molecularWeight = (44.0094,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.33645,-0.0119176,0.00010679,-1.61426e-07,7.09983e-11,53476.4,6.56669], Tmin=(100,'K'), Tmax=(880.802,'K')), NASAPolynomial(coeffs=[23.4554,-0.0321127,1.99776e-05,-3.98072e-09,2.72001e-13,47171.5,-103.614], Tmin=(880.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(444.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(58.2013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsHH) + ring(dioxirane) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', '[C]1OO1(1137)'],
    products = ['[CH]1OO1(209)'],
    transitionState = 'TS1',
