...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', 'C[C]=C[C]=O(708)'],
    products = ['C[C]=CC([O])=O(655)'],
    transitionState = 'TS2',
