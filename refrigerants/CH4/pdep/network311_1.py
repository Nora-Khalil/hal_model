...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(148)', '[CH]=C[O](171)'],
    products = ['[CH]=CO[C]=C(376)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=[CH](149)', '[CH2][C]=O(128)'],
    products = ['[CH]=CO[C]=C(376)'],
    transitionState = 'TS8',
