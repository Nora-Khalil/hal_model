...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[CH2]C(=C)[O](414)'],
    products = ['[CH2]CC(=C)[O](367)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]=O(128)', '[CH2][CH2](81)'],
    products = ['[CH2]CC(=C)[O](367)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(17)', '[CH2]C[C]=O(143)'],
    products = ['[CH2]CC(=C)[O](367)'],
