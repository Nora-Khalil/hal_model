...
"""),
    E0 = (-334.059,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,180,1089.96,1090.15,1090.18,1090.26,1090.27,1090.35],'cm^-1')),
        HinderedRotor(inertia=(0.203746,'amu*angstrom^2'), symmetry=1, barrier=(4.68453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203683,'amu*angstrom^2'), symmetry=1, barrier=(4.68308,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4738,0.0390503,-6.05766e-05,6.08339e-08,-2.43663e-11,-40128.5,21.6184], Tmin=(100,'K'), Tmax=(792.601,'K')), NASAPolynomial(coeffs=[2.82088,0.0256968,-1.33484e-05,2.64162e-09,-1.86314e-13,-39819,22.3235], Tmin=(792.601,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsOsH) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-139.407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,1855,455,950,378.381],'cm^-1')),
        HinderedRotor(inertia=(0.621164,'amu*angstrom^2'), symmetry=1, barrier=(14.2818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0004897,'amu*angstrom^2'), symmetry=1, barrier=(3.25902,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0354,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.66622,0.0317028,-4.33092e-05,3.49113e-08,-1.16697e-11,-16721,20.1364], Tmin=(100,'K'), Tmax=(741.101,'K')), NASAPolynomial(coeffs=[5.86651,0.0140352,-6.75153e-06,1.30728e-09,-9.16245e-14,-17184.5,5.72877], Tmin=(741.101,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33529,0.0425399,-6.9256e-05,6.93509e-08,-2.75379e-11,1831.57,18.9178], Tmin=(100,'K'), Tmax=(787.448,'K')), NASAPolynomial(coeffs=[3.32895,0.0254022,-1.35802e-05,2.71689e-09,-1.92647e-13,2049.92,16.7415], Tmin=(787.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.7783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + ring(12dioxetane) + radical(CCOJ) + radical(Cs_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.983347,'amu*angstrom^2'), symmetry=1, barrier=(22.6091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.98836,'amu*angstrom^2'), symmetry=1, barrier=(22.7243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.578523,0.0659413,-8.99008e-05,5.37784e-08,-1.17312e-11,-48793.5,19.0527], Tmin=(100,'K'), Tmax=(1286.25,'K')), NASAPolynomial(coeffs=[19.963,-0.00436309,3.77473e-06,-8.31763e-10,6.04245e-14,-52951.1,-76.1229], Tmin=(1286.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-406.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ)"""),
)
...
"""),
    ...
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.578523,0.0659413,-8.99008e-05,5.37784e-08,-1.17312e-11,-48793.5,19.7459], Tmin=(100,'K'), Tmax=(1286.25,'K')), NASAPolynomial(coeffs=[19.963,-0.00436309,3.77473e-06,-8.31763e-10,6.04245e-14,-52951.1,-75.4298], Tmin=(1286.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-406.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ)"""),
)

species(
    label = '[O]C([O])C(=O)O(776)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-316.031,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,180,180,1207.63,1209.94,1209.97,1210.09,1210.11],'cm^-1')),
        HinderedRotor(inertia=(0.167227,'amu*angstrom^2'), symmetry=1, barrier=(3.84489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168273,'amu*angstrom^2'), symmetry=1, barrier=(3.86893,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55871,0.035805,-3.74782e-05,1.68671e-08,1.12624e-12,-37961.8,21.2694], Tmin=(100,'K'), Tmax=(566.949,'K')), NASAPolynomial(coeffs=[5.6819,0.0195081,-9.54222e-06,1.86958e-09,-1.32404e-13,-38408.1,7.16079], Tmin=(566.949,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.031,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsOsH) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(C=OCOJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(7)', '[O]C([O])=CO(281)'],
    products = ['[O]C(=O)C([O])O(753)'],
    transitionState = 'TS3',
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(93.6916,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)
