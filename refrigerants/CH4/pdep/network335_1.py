...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(117)', '[CH2]C(=C)[O](414)'],
    products = ['C=C([O])C[C]=O(537)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CO(27)', '[CH2][C]=O(128)'],
    products = ['C=C([O])C[C]=O(537)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]=O(128)', '[CH2][C]=O(128)'],
    products = ['C=C([O])C[C]=O(537)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(17)', 'O=[C]C[C]=O(467)'],
    products = ['C=C([O])C[C]=O(537)'],
