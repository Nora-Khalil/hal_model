...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', 'C=[C]C[O](184)'],
    products = ['[CH2]OC[C]=C(898)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(148)', '[CH2]O[CH2](60)'],
    products = ['[CH2]OC[C]=C(898)'],
    transitionState = 'TS3',
