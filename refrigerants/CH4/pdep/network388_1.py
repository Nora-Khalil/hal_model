...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CO[C]=O(263)'],
    products = ['[CH]=C(C)O[C]=O(658)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(117)', '[CH]=C(C)[O](325)'],
    products = ['[CH]=C(C)O[C]=O(658)'],
    transitionState = 'TS3',
