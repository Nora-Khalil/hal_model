...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.66843,'amu*angstrom^2'), symmetry=1, barrier=(38.3606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66701,'amu*angstrom^2'), symmetry=1, barrier=(38.3278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66752,'amu*angstrom^2'), symmetry=1, barrier=(38.3397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66803,'amu*angstrom^2'), symmetry=1, barrier=(38.3513,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.834657,0.0566055,-6.33006e-05,3.19821e-08,-5.9936e-12,-21999.7,23.2403], Tmin=(100,'K'), Tmax=(1470.43,'K')), NASAPolynomial(coeffs=[18.7808,0.000903513,5.43189e-07,-1.46981e-10,1.01831e-14,-26533.2,-67.7283], Tmin=(1470.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCJO) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.81669,0.00282096,9.30129e-05,-1.29518e-07,5.08279e-11,-55882.7,18.1354], Tmin=(100,'K'), Tmax=(955.41,'K')), NASAPolynomial(coeffs=[16.8223,0.00319642,-2.26739e-07,1.92349e-10,-2.97429e-14,-61252.3,-62.8902], Tmin=(955.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-465.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-OdCsOs) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47343,0.0080548,9.07778e-05,-1.34271e-07,5.40105e-11,-72953.7,19.5613], Tmin=(100,'K'), Tmax=(951.837,'K')), NASAPolynomial(coeffs=[19.7788,9.89595e-05,1.24715e-06,-7.51686e-11,-1.2553e-14,-79182,-78.485], Tmin=(951.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-607.222,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-O2d)) + group(Cds-OdOsH) + group(Cds-OdOsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.88735,'amu*angstrom^2'), symmetry=1, barrier=(43.3938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88682,'amu*angstrom^2'), symmetry=1, barrier=(43.3817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.8858,'amu*angstrom^2'), symmetry=1, barrier=(43.3583,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87024,0.0323902,1.00797e-05,-4.47118e-08,2.10575e-11,-17412.1,20.2017], Tmin=(100,'K'), Tmax=(973.255,'K')), NASAPolynomial(coeffs=[17.0148,0.00516017,-1.91506e-06,4.67895e-10,-4.26341e-14,-22018.2,-60.9703], Tmin=(973.255,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCOJ) + radical((O)CJOC)"""),
)

species(
    label = '[O][CH]OOC=O(236)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {2,S} {5,S}
2 O u0 p2 c0 {1,S} {6,S}
3 O u1 p2 c0 {5,S}
...
"""),
    E0 = (-153.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,499.246],'cm^-1')),
        HinderedRotor(inertia=(0.270479,'amu*angstrom^2'), symmetry=1, barrier=(47.8905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268745,'amu*angstrom^2'), symmetry=1, barrier=(48.0025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274609,'amu*angstrom^2'), symmetry=1, barrier=(48.0005,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44036,0.0361798,-2.53491e-05,7.79927e-09,-9.47302e-13,-18348.8,19.311], Tmin=(100,'K'), Tmax=(1847.44,'K')), NASAPolynomial(coeffs=[12.1279,0.0152048,-8.31872e-06,1.65368e-09,-1.15665e-13,-21928.2,-33.3717], Tmin=(1847.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(131)', '[CH]O(118)'],
    products = ['O=[C]OO[CH]O(756)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CO2(15)', '[O][CH]O(212)'],
    products = ['O=[C]OO[CH]O(756)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(213.804,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0
Ea raised from 213.3 to 213.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'O=[C]OOC=O(615)'],
    products = ['O=[C]OO[CH]O(756)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(213)', '[O][CH]O(212)'],
    products = ['O=[C]OO[CH]O(756)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.47663e+07,'m^3/(mol*s)'), n=1.31229e-07, Ea=(2.48194,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[O]COO[C]=O(759)'],
    products = ['O=[C]OO[CH]O(756)'],
