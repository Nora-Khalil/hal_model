...
"""),
    E0 = (146.719,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,1855,455,950,240.037,240.047],'cm^-1')),
        HinderedRotor(inertia=(0.0997365,'amu*angstrom^2'), symmetry=1, barrier=(4.07808,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.448586,'amu*angstrom^2'), symmetry=1, barrier=(18.3418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0171813,'amu*angstrom^2'), symmetry=1, barrier=(18.3419,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89904,0.0424688,-3.57286e-05,1.53434e-08,-2.65022e-12,17724.9,22.2101], Tmin=(100,'K'), Tmax=(1377.11,'K')), NASAPolynomial(coeffs=[11.134,0.0156443,-6.51007e-06,1.19838e-09,-8.23078e-14,15181.4,-25.2981], Tmin=(1377.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P) + radical((O)CJOCC)"""),
)
...
"""),
    E0 = (186.879,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1685,370,3120,650,792.5,1650,523.894,1974.02],'cm^-1')),
        HinderedRotor(inertia=(0.0503751,'amu*angstrom^2'), symmetry=1, barrier=(1.15822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5736,'amu*angstrom^2'), symmetry=1, barrier=(36.1803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57361,'amu*angstrom^2'), symmetry=1, barrier=(36.1803,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.58211,0.0351648,-2.15087e-05,6.17112e-09,-7.28087e-13,22523,20.575], Tmin=(100,'K'), Tmax=(1781.98,'K')), NASAPolynomial(coeffs=[8.59702,0.0216631,-1.01434e-05,1.91916e-09,-1.31562e-13,20379.3,-11.9184], Tmin=(1781.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(117)', 'C=[C]C[O](184)'],
    products = ['C=[C]CO[C]=O(737)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(148)', '[CH2]O[C]=O(269)'],
    products = ['C=[C]CO[C]=O(737)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(14)', 'C=[C]C[O](184)'],
    products = ['C=[C]CO[C]=O(737)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(11.7451,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CO2(15)', '[CH2][C]=C(781)'],
    products = ['C=[C]CO[C]=O(737)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(3.64086e-07,'m^3/(mol*s)'), n=3.71185, Ea=(152.93,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[O][C]=O(213)', 'C=C=C(718)'],
    products = ['C=[C]CO[C]=O(737)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.64086e-07,'m^3/(mol*s)'), n=3.71185, Ea=(28.3866,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 4.0"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C]=O(213)', '[CH2][C]=C(781)'],
    products = ['C=[C]CO[C]=O(737)'],
