...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[CH2]C([O])=O(275)'],
    products = ['[CH2]CC([O])=O(256)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(213)', '[CH2][CH2](81)'],
    products = ['[CH2]CC([O])=O(256)'],
