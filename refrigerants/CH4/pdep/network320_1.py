...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(131)', '[C]=C(148)'],
    products = ['C=[C]OO[C]=O(385)'],
    transitionState = 'TS2',
