...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[CH2]O[C]=O(269)'],
    products = ['[CH2]OC([CH2])=O(360)'],
    transitionState = 'TS3',
