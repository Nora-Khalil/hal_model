...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(117)', '[CH]=C[O](171)'],
    products = ['[CH]=CO[C]=O(263)'],
    transitionState = 'TS2',
