...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]CC[O](897)'],
    products = ['CH2O(19)', 'C=C=C(718)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][O](58)', '[CH2][C]=C(781)'],
    products = ['C=[C]CC[O](897)'],
