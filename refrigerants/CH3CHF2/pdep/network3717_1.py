...
"""),
    E0 = (-34.6389,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,242.644,242.645],'cm^-1')),
        HinderedRotor(inertia=(0.299475,'amu*angstrom^2'), symmetry=1, barrier=(12.5121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00286326,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.299476,'amu*angstrom^2'), symmetry=1, barrier=(12.5121,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08141,0.068904,-8.00412e-05,5.24106e-08,-1.42698e-11,-4065.07,24.5786], Tmin=(100,'K'), Tmax=(880.926,'K')), NASAPolynomial(coeffs=[9.55302,0.0304362,-1.45387e-05,2.83847e-09,-2.01318e-13,-5557.6,-15.2178], Tmin=(880.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.6389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-12.26,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,190,488,555,1236,1407,2950,3100,1380,975,1025,1650,1685,370,288.911,289.518,289.944],'cm^-1')),
        HinderedRotor(inertia=(0.00201535,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128873,'amu*angstrom^2'), symmetry=1, barrier=(7.67701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128792,'amu*angstrom^2'), symmetry=1, barrier=(7.676,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50619,0.0613743,-6.36396e-05,3.18443e-08,-1.72388e-12,-1390.87,24.8811], Tmin=(100,'K'), Tmax=(584.157,'K')), NASAPolynomial(coeffs=[6.68832,0.0344628,-1.65499e-05,3.22637e-09,-2.28142e-13,-2142.58,1.41411], Tmin=(584.157,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(=C)C([CH2])(F)F(6583)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {3,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51652,0.0461025,-1.73155e-05,-5.79696e-09,3.96189e-12,-39380.6,18.1528], Tmin=(100,'K'), Tmax=(1172.65,'K')), NASAPolynomial(coeffs=[11.9712,0.0259961,-1.14938e-05,2.2055e-09,-1.5585e-13,-42902,-38.51], Tmin=(1172.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)
...
"""),
    E0 = (-106.377,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,189.609],'cm^-1')),
        HinderedRotor(inertia=(0.972173,'amu*angstrom^2'), symmetry=1, barrier=(22.3542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.330133,'amu*angstrom^2'), symmetry=1, barrier=(7.59042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.05994,'amu*angstrom^2'), symmetry=1, barrier=(70.354,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.918953,0.0699448,-8.72005e-05,5.86023e-08,-1.57634e-11,-12685.2,22.5214], Tmin=(100,'K'), Tmax=(907.8,'K')), NASAPolynomial(coeffs=[11.5386,0.02315,-9.8761e-06,1.8148e-09,-1.24016e-13,-14613.2,-27.6845], Tmin=(907.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    E0 = (-25.3846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,215,315,519,588,595,1205,1248,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.635358,'amu*angstrom^2'), symmetry=1, barrier=(14.6081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0417255,'amu*angstrom^2'), symmetry=1, barrier=(7.7249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.635296,'amu*angstrom^2'), symmetry=1, barrier=(14.6067,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0468,0.0678371,-7.22998e-05,4.14333e-08,-9.74094e-12,-2949.08,24.6265], Tmin=(100,'K'), Tmax=(1017.68,'K')), NASAPolynomial(coeffs=[11.3043,0.0275199,-1.28744e-05,2.5045e-09,-1.77786e-13,-5036.83,-25.0396], Tmin=(1017.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.3846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.46556,'amu*angstrom^2'), symmetry=1, barrier=(10.7042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.464248,'amu*angstrom^2'), symmetry=1, barrier=(10.674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.464049,'amu*angstrom^2'), symmetry=1, barrier=(10.6694,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0305,0.0705781,-8.82816e-05,6.38581e-08,-1.92435e-11,149.228,23.5275], Tmin=(100,'K'), Tmax=(799.73,'K')), NASAPolynomial(coeffs=[8.81521,0.0316404,-1.52467e-05,2.97344e-09,-2.10154e-13,-1095.87,-12.2893], Tmin=(799.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.391133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=[C]C[C](F)CF(11163)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
...
"""),
    E0 = (1.56671,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,2950,3100,1380,975,1025,1650,1685,370,303.741,303.742,303.744],'cm^-1')),
        HinderedRotor(inertia=(0.10335,'amu*angstrom^2'), symmetry=1, barrier=(6.76639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103352,'amu*angstrom^2'), symmetry=1, barrier=(6.76639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.279249,'amu*angstrom^2'), symmetry=1, barrier=(18.2821,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66536,0.0597852,-4.95991e-05,-6.03823e-09,2.9473e-11,264.123,24.4961], Tmin=(100,'K'), Tmax=(513.987,'K')), NASAPolynomial(coeffs=[6.61803,0.0349114,-1.69004e-05,3.29188e-09,-2.32037e-13,-425.558,2.14221], Tmin=(513.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.56671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsCsF1s) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C](F)CC(=C)F(11164)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60359,0.0620864,-5.07681e-05,-1.69159e-08,4.25447e-11,-7606.1,24.4629], Tmin=(100,'K'), Tmax=(501.595,'K')), NASAPolynomial(coeffs=[7.18891,0.0340783,-1.64504e-05,3.18225e-09,-2.22674e-13,-8374.39,-0.702542], Tmin=(501.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.8795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[C]=C(10759)'],
    products = ['CH2CF2(57)', 'C=C=C(6730)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C=[C]CC[C](F)F(10760)'],
    products = ['[CH2]C(F)(F)C[C]=C(10759)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C[C]=C(10759)'],
    products = ['[CH2]C(=C)C([CH2])(F)F(6583)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'C=[C]C[C](F)F(3125)'],
    products = ['[CH2]C(F)(F)C[C]=C(10759)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(395)', '[CH2]C([CH2])(F)F(3089)'],
    products = ['[CH2]C(F)(F)C[C]=C(10759)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=[C]CC(=C)F(10876)'],
    products = ['[CH2]C(F)(F)C[C]=C(10759)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2CF2(57)', '[CH2][C]=C(6957)'],
    products = ['[CH2]C(F)(F)C[C]=C(10759)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C](F)F(2970)', 'C=C=C(6730)'],
    products = ['[CH2]C(F)(F)C[C]=C(10759)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C#CCC([CH2])(F)F(7727)'],
    products = ['[CH2]C(F)(F)C[C]=C(10759)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C](F)F(2970)', '[CH2][C]=C(6957)'],
    products = ['[CH2]C(F)(F)C[C]=C(10759)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C[C]=C(10759)'],
    products = ['[CH2]C(F)(F)[CH]C=C(6591)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=CCC([CH2])(F)F(11161)'],
    products = ['[CH2]C(F)(F)C[C]=C(10759)'],
...
network(
    ...
    isomers = [
        '[CH2]C(F)(F)C[C]=C(10759)',
    ],
    reactants = [
        ('CH2CF2(57)', 'C=C=C(6730)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
