...
"""),
    E0 = (132.64,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,249,734,1109,1255,1358,2983,3011,180,725.136,1020],'cm^-1')),
        HinderedRotor(inertia=(2.44264,'amu*angstrom^2'), symmetry=1, barrier=(56.161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.4397,'amu*angstrom^2'), symmetry=1, barrier=(56.0934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.0702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.93811,0.0273761,-1.34239e-05,2.80436e-09,-2.1942e-13,15987.3,22.1126], Tmin=(100,'K'), Tmax=(3448.81,'K')), NASAPolynomial(coeffs=[5.41241,0.0191608,-7.52574e-06,1.2148e-09,-7.16154e-14,17459.8,11.7214], Tmin=(3448.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsHHH) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(C)F(10071)',
    structure = adjacencyList("""1 F u0 p3 c0 {2,S}
2 C u0 p0 c0 {1,S} {3,S} {4,S} {5,S}
3 C u0 p0 c0 {2,S} {6,S} {7,S} {8,S}
4 C u0 p1 c0 {2,S} {9,S}
5 H u0 p0 c0 {2,S}
6 H u0 p0 c0 {3,S}
7 H u0 p0 c0 {3,S}
8 H u0 p0 c0 {3,S}
...
"""),
    E0 = (131.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([353,444,1253,3145,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1111.21,1387.59,1387.8,1387.93,4000],'cm^-1')),
        HinderedRotor(inertia=(0.954634,'amu*angstrom^2'), symmetry=1, barrier=(21.9489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.371146,'amu*angstrom^2'), symmetry=1, barrier=(8.53337,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.0702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.0342,0.0266125,-1.43361e-05,3.32808e-09,-2.95685e-13,15854.2,11.2907], Tmin=(100,'K'), Tmax=(2516.65,'K')), NASAPolynomial(coeffs=[12.2667,0.0119382,-5.58974e-06,1.01115e-09,-6.55255e-14,11207.3,-41.7716], Tmin=(2516.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(5)', '[CH2]C(=C)F(1340)'],
    products = ['C=C(C)F(497)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction7',
    reactants = ['C[C]CF-2(10070)'],
    products = ['C=C(C)F(497)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(87.9244,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[CH]C(C)F(10071)'],
    products = ['C=C(C)F(497)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.20443e+17,'s^-1'), n=-1.43042, Ea=(12.2626,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH"""),
)

reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'C=C=C(6730)'],
    products = ['C=C(C)F(497)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.43149e-05,'m^3/(mol*s)'), n=3.27904, Ea=(128.868,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-1.6829136876314708, var=127.63224188496864, Tref=1000.0, N=6, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'C#CC(5603)'],
    products = ['C=C(C)F(497)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.56721e+32,'m^3/(mol*s)'), n=-7.40875, Ea=(306.484,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_3COCdCddCtO2d->Ct"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CH2(S)(25)', 'C[C]F(124)'],
    products = ['C=C(C)F(497)'],
