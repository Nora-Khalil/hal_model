...
"""),
    E0 = (-561.69,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,486,617,768,1157,1926,2950,3100,1380,975,1025,1650,356.554,356.927],'cm^-1')),
        HinderedRotor(inertia=(0.198837,'amu*angstrom^2'), symmetry=1, barrier=(18.0619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200006,'amu*angstrom^2'), symmetry=1, barrier=(18.0609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199549,'amu*angstrom^2'), symmetry=1, barrier=(18.0629,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19412,0.053766,-4.87341e-05,2.4939e-08,-5.02177e-12,-27020.8,21.0311], Tmin=(100,'K'), Tmax=(1363.67,'K')), NASAPolynomial(coeffs=[11.1156,0.0192843,-4.88795e-06,6.10816e-10,-3.13901e-14,-29226.5,-28.0778], Tmin=(1363.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCFHO) + ring(Tetrahydrofuran) + radical(C2CsJOH) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C([O])CC(=O)F(3307)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u1 p2 c0 {5,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-211.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,486,617,768,1157,1926,341.398,341.399,2831.99],'cm^-1')),
        HinderedRotor(inertia=(0.104254,'amu*angstrom^2'), symmetry=1, barrier=(8.62276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104255,'amu*angstrom^2'), symmetry=1, barrier=(8.62277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391494,'amu*angstrom^2'), symmetry=1, barrier=(32.3799,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21029,0.0659585,-8.4188e-05,6.16978e-08,-1.86981e-11,-25355.3,25.385], Tmin=(100,'K'), Tmax=(797.924,'K')), NASAPolynomial(coeffs=[8.71693,0.0283291,-1.34518e-05,2.59985e-09,-1.82614e-13,-26553.3,-9.1359], Tmin=(797.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-211.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(COCsFO) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)[CH]C(=O)F(3308)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-242.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,611,648,830,1210,1753,224.817,1448.81],'cm^-1')),
        HinderedRotor(inertia=(0.00332274,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256983,'amu*angstrom^2'), symmetry=1, barrier=(9.24044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256271,'amu*angstrom^2'), symmetry=1, barrier=(9.24513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00331826,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22395,0.0649608,-8.22704e-05,5.8265e-08,-1.68567e-11,-29018.5,28.0236], Tmin=(100,'K'), Tmax=(838.401,'K')), NASAPolynomial(coeffs=[9.47408,0.0255992,-1.18469e-05,2.26615e-09,-1.58369e-13,-30401.8,-10.3242], Tmin=(838.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-242.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(COCsFO) + radical(CCJCO) + radical(CJCO)"""),
)

species(
    label = 'C=C(O)[CH]C([O])F(3309)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.12753,'amu*angstrom^2'), symmetry=1, barrier=(25.9241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12917,'amu*angstrom^2'), symmetry=1, barrier=(25.9619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12531,'amu*angstrom^2'), symmetry=1, barrier=(25.873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.523496,0.0670761,-5.80207e-05,1.59562e-08,1.73086e-12,-32715.9,23.5885], Tmin=(100,'K'), Tmax=(967.572,'K')), NASAPolynomial(coeffs=[19.0806,0.0111479,-3.54403e-06,6.26137e-10,-4.54318e-14,-37280.1,-70.3557], Tmin=(967.572,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(O2sj(Cs-CsF1sH)) + radical(C=CCJCO)"""),
)

species(
    label = 'C=C([O])CC([O])F(3310)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u1 p2 c0 {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    E0 = (-252.239,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,391,562,707,872,1109,1210,1289,3137,350,440,435,1725,2950,3100,1380,975,1025,1650,202.646,202.649,4000],'cm^-1')),
        HinderedRotor(inertia=(0.530239,'amu*angstrom^2'), symmetry=1, barrier=(15.4519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.530219,'amu*angstrom^2'), symmetry=1, barrier=(15.4519,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09584,0.0592739,-5.81267e-05,2.94462e-08,-5.90669e-12,-30228.8,25.837], Tmin=(100,'K'), Tmax=(1212.26,'K')), NASAPolynomial(coeffs=[13.677,0.0177605,-6.75957e-06,1.19735e-09,-8.10126e-14,-33279.2,-37.2816], Tmin=(1212.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(O2sj(Cs-CsF1sH)) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH]=C(O)CC([O])F(3311)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {6,S} {12,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.590138,'amu*angstrom^2'), symmetry=1, barrier=(13.5684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588877,'amu*angstrom^2'), symmetry=1, barrier=(13.5394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588411,'amu*angstrom^2'), symmetry=1, barrier=(13.5287,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.457961,0.0690902,-7.5318e-05,4.00986e-08,-8.18373e-12,-17057.5,27.0292], Tmin=(100,'K'), Tmax=(1234.35,'K')), NASAPolynomial(coeffs=[18.1665,0.0107189,-3.18697e-06,4.94256e-10,-3.14643e-14,-21354.2,-61.8289], Tmin=(1234.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-142.947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(O2sj(Cs-CsF1sH)) + radical(Cds_P)"""),
)

species(
    label = 'C=C([O])C[C](O)F(3312)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {6,S} {12,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (-284.258,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,395,473,707,1436,2950,3100,1380,975,1025,1650,292.38,292.453,292.492],'cm^-1')),
        HinderedRotor(inertia=(0.111493,'amu*angstrom^2'), symmetry=1, barrier=(6.76892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111638,'amu*angstrom^2'), symmetry=1, barrier=(6.7701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111614,'amu*angstrom^2'), symmetry=1, barrier=(6.76899,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.989947,0.0683879,-8.57284e-05,5.70042e-08,-1.511e-11,-34081.8,26.124], Tmin=(100,'K'), Tmax=(921.719,'K')), NASAPolynomial(coeffs=[11.81,0.0214328,-9.31525e-06,1.73654e-09,-1.19886e-13,-36076.5,-25.1946], Tmin=(921.719,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH]=C(O)C[C](O)F(3313)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {12,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.576647,'amu*angstrom^2'), symmetry=1, barrier=(13.2582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.576799,'amu*angstrom^2'), symmetry=1, barrier=(13.2617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.576386,'amu*angstrom^2'), symmetry=1, barrier=(13.2522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.576482,'amu*angstrom^2'), symmetry=1, barrier=(13.2545,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.467597,0.0769151,-9.87261e-05,6.25987e-08,-1.53663e-11,-20915.7,26.8965], Tmin=(100,'K'), Tmax=(1005.92,'K')), NASAPolynomial(coeffs=[16.1264,0.0146482,-5.87485e-06,1.06183e-09,-7.2513e-14,-24066,-48.7406], Tmin=(1005.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cds_P)"""),
)

species(
    label = 'CC(=O)CC(=O)F(3314)',
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93741,0.0491272,-4.15949e-05,2.00644e-08,-4.26244e-12,-69893.5,22.2692], Tmin=(100,'K'), Tmax=(1067.42,'K')), NASAPolynomial(coeffs=[7.22457,0.0293142,-1.37523e-05,2.67493e-09,-1.89626e-13,-71022.2,-3.5832], Tmin=(1067.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(COCsFO)"""),
)

species(
    label = 'C=C(O)C=C(O)F(3315)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {12,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.99682,'amu*angstrom^2'), symmetry=1, barrier=(22.9189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.99829,'amu*angstrom^2'), symmetry=1, barrier=(22.9527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.999277,'amu*angstrom^2'), symmetry=1, barrier=(22.9753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.377916,0.0783139,-8.84845e-05,4.62854e-08,-8.92762e-12,-61643.3,24.2227], Tmin=(100,'K'), Tmax=(1465.83,'K')), NASAPolynomial(coeffs=[22.6908,0.00287371,1.49492e-06,-4.50422e-10,3.46159e-14,-67064.4,-91.3158], Tmin=(1465.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-513.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(CdCFO) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-147.737,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,1855,455,950,285.92],'cm^-1')),
        HinderedRotor(inertia=(0.285249,'amu*angstrom^2'), symmetry=1, barrier=(16.5478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.285249,'amu*angstrom^2'), symmetry=1, barrier=(16.5478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.285249,'amu*angstrom^2'), symmetry=1, barrier=(16.5478,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50645,0.0428304,-1.18557e-05,-2.13742e-08,1.23358e-11,-17668.2,21.4923], Tmin=(100,'K'), Tmax=(999.452,'K')), NASAPolynomial(coeffs=[16.4135,0.0104702,-4.26217e-06,8.91269e-10,-7.00287e-14,-22011.5,-57.239], Tmin=(999.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (-109.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,2950,3100,1380,975,1025,1650,1685,370,545.346,1159.81],'cm^-1')),
        HinderedRotor(inertia=(0.762722,'amu*angstrom^2'), symmetry=1, barrier=(17.5365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.766511,'amu*angstrom^2'), symmetry=1, barrier=(17.6236,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19656,0.0353031,-1.8052e-05,1.73862e-09,5.73802e-13,-13076.1,19.5661], Tmin=(100,'K'), Tmax=(1491.19,'K')), NASAPolynomial(coeffs=[12.5221,0.0168372,-8.76299e-06,1.73732e-09,-1.21992e-13,-17181.9,-37.8158], Tmin=(1491.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-109.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(COCsFO) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-423.885,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,486,617,768,1157,1926,2950,3100,1380,975,1025,1650,540,540.053,540.254],'cm^-1')),
        HinderedRotor(inertia=(0.0643053,'amu*angstrom^2'), symmetry=1, barrier=(13.3052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0643343,'amu*angstrom^2'), symmetry=1, barrier=(13.3067,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46956,0.0471885,-3.05417e-05,5.25027e-09,1.00334e-12,-50883.5,23.2426], Tmin=(100,'K'), Tmax=(1191.56,'K')), NASAPolynomial(coeffs=[14.4229,0.0164687,-7.93767e-06,1.59334e-09,-1.15548e-13,-54876.5,-45.3221], Tmin=(1191.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-423.885,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(COCsFO) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
"""),
    E0 = (-411.722,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,255,533,799,832,1228,374.013],'cm^-1')),
        HinderedRotor(inertia=(0.125657,'amu*angstrom^2'), symmetry=1, barrier=(12.4992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12562,'amu*angstrom^2'), symmetry=1, barrier=(12.4919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125674,'amu*angstrom^2'), symmetry=1, barrier=(12.4983,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.899922,0.0626612,-6.64038e-05,3.21269e-08,-5.16562e-12,-49402.1,23.4921], Tmin=(100,'K'), Tmax=(970.566,'K')), NASAPolynomial(coeffs=[16.0852,0.0110378,-3.55842e-06,5.93886e-10,-4.01343e-14,-52866,-51.9736], Tmin=(970.566,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-411.722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cd-Cd(CO)H) + group(COCFO) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=C(O)CC(=O)F(3319)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-314.594,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,486,617,768,1157,1926,3120,650,792.5,1650,260.648],'cm^-1')),
        HinderedRotor(inertia=(0.387657,'amu*angstrom^2'), symmetry=1, barrier=(18.5393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.381047,'amu*angstrom^2'), symmetry=1, barrier=(18.5391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386968,'amu*angstrom^2'), symmetry=1, barrier=(18.5281,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05169,0.0545338,-3.96851e-05,6.33553e-09,2.42803e-12,-37721.9,23.6374], Tmin=(100,'K'), Tmax=(1074.65,'K')), NASAPolynomial(coeffs=[17.5271,0.0116649,-5.60802e-06,1.17575e-09,-8.91802e-14,-42328.6,-61.9911], Tmin=(1074.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(COCsFO) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.994372,0.0736625,-0.000117075,1.04886e-07,-3.7104e-11,-24250.2,25.8469], Tmin=(100,'K'), Tmax=(822.936,'K')), NASAPolynomial(coeffs=[7.02804,0.0311026,-1.53805e-05,2.96293e-09,-2.05021e-13,-24795.2,0.636158], Tmin=(822.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-202.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsCsOsH) + group(COCsFO) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.938934,'amu*angstrom^2'), symmetry=1, barrier=(21.5879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.945962,'amu*angstrom^2'), symmetry=1, barrier=(21.7495,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(O)[CH]C(=O)F(3308)'],
    products = ['C=C(O)CC(=O)F(2058)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'C=C(O)C[C]=O(3316)'],
    products = ['C=C(O)CC(=O)F(2058)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'C=[C]CC(=O)F(3317)'],
    products = ['C=C(O)CC(=O)F(2058)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=C([O])CC(=O)F(1102)'],
    products = ['C=C(O)CC(=O)F(2058)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CFO(51)', '[CH2]C(=C)O(1060)'],
    products = ['C=C(O)CC(=O)F(2058)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(O)=CC(=O)F(3318)'],
    products = ['C=C(O)CC(=O)F(2058)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH]=C(O)CC(=O)F(3319)'],
    products = ['C=C(O)CC(=O)F(2058)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'C=C(O)C=C=O(1289)'],
    products = ['C=C(O)CC(=O)F(2058)'],
