...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.774315,'amu*angstrom^2'), symmetry=1, barrier=(17.803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.773998,'amu*angstrom^2'), symmetry=1, barrier=(17.7957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.774232,'amu*angstrom^2'), symmetry=1, barrier=(17.8011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0962,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13385,0.0525782,-2.46592e-05,-1.18183e-08,1.00202e-11,-50391.6,21.3608], Tmin=(100,'K'), Tmax=(965.482,'K')), NASAPolynomial(coeffs=[15.9661,0.0155679,-5.12934e-06,9.14896e-10,-6.58397e-14,-54394.7,-55.5742], Tmin=(965.482,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-419.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-94.1188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,878.546,878.556],'cm^-1')),
        HinderedRotor(inertia=(0.570894,'amu*angstrom^2'), symmetry=1, barrier=(13.126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228369,'amu*angstrom^2'), symmetry=1, barrier=(5.25066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.570898,'amu*angstrom^2'), symmetry=1, barrier=(13.1261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0239622,'amu*angstrom^2'), symmetry=1, barrier=(13.126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0962,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24083,0.0579896,-5.29864e-05,2.55716e-08,-4.99359e-12,-11218.3,25.9346], Tmin=(100,'K'), Tmax=(1225.32,'K')), NASAPolynomial(coeffs=[12.2416,0.0220783,-9.02528e-06,1.65366e-09,-1.13688e-13,-13914.2,-29.3734], Tmin=(1225.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.1188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFHH) + radical(CCJCO) + radical(CJCO)"""),
)
...
"""),
    E0 = (-136.876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,334,575,1197,1424,3202,232.861,236.399],'cm^-1')),
        HinderedRotor(inertia=(0.00303614,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169422,'amu*angstrom^2'), symmetry=1, barrier=(6.5549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167752,'amu*angstrom^2'), symmetry=1, barrier=(6.57222,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167384,'amu*angstrom^2'), symmetry=1, barrier=(6.5682,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0962,'amu'),
...
"""),
    E0 = (-447.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,293.382,293.515],'cm^-1')),
        HinderedRotor(inertia=(0.108907,'amu*angstrom^2'), symmetry=1, barrier=(6.66646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108551,'amu*angstrom^2'), symmetry=1, barrier=(6.66702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109417,'amu*angstrom^2'), symmetry=1, barrier=(6.66252,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0962,'amu'),
...
"""),
    E0 = (-25.834,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,273.628],'cm^-1')),
        HinderedRotor(inertia=(0.30341,'amu*angstrom^2'), symmetry=1, barrier=(16.1069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00225384,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303062,'amu*angstrom^2'), symmetry=1, barrier=(16.1089,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69126,0.0396881,-1.99358e-06,-3.19791e-08,1.7015e-11,-3013.83,20.2086], Tmin=(100,'K'), Tmax=(939.358,'K')), NASAPolynomial(coeffs=[14.5593,0.0127291,-3.39422e-06,5.61132e-10,-4.09259e-14,-6659.49,-47.6044], Tmin=(939.358,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.810535,'amu*angstrom^2'), symmetry=1, barrier=(18.6358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.809523,'amu*angstrom^2'), symmetry=1, barrier=(18.6125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.808769,'amu*angstrom^2'), symmetry=1, barrier=(18.5952,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0882,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06063,0.0560955,-4.13032e-05,5.55669e-09,4.10229e-12,-20671.9,22.0267], Tmin=(100,'K'), Tmax=(964.803,'K')), NASAPolynomial(coeffs=[16.2035,0.0127395,-4.09769e-06,7.16663e-10,-5.10149e-14,-24498,-55.1719], Tmin=(964.803,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(O)CCF(3640)',
...
"""),
    ...
    molecularWeight = (90.0962,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3809,0.0619512,-6.94203e-05,4.57726e-08,-1.27783e-11,-6465.54,22.4572], Tmin=(100,'K'), Tmax=(854.366,'K')), NASAPolynomial(coeffs=[8.08665,0.0305576,-1.43059e-05,2.76864e-09,-1.95383e-13,-7611.43,-8.83898], Tmin=(854.366,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.5101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsOsH) + group(CsCsFHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C(O)CF(662)'],
    products = ['C=C(O)CCF(2647)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]CC(=C)O(3638)'],
    products = ['C=C(O)CCF(2647)'],
