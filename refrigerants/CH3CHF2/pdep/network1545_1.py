...
"""),
    E0 = (-626.511,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,222,329,445,522,589,1214,1475,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,359.207],'cm^-1')),
        HinderedRotor(inertia=(0.0404372,'amu*angstrom^2'), symmetry=1, barrier=(12.6041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.548205,'amu*angstrom^2'), symmetry=1, barrier=(12.6043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.548201,'amu*angstrom^2'), symmetry=1, barrier=(12.6042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.548206,'amu*angstrom^2'), symmetry=1, barrier=(12.6043,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.093,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481391,0.0828244,-9.42846e-05,5.922e-08,-1.53975e-11,-75229.8,24.4373], Tmin=(100,'K'), Tmax=(921.373,'K')), NASAPolynomial(coeffs=[11.4062,0.0353964,-1.70719e-05,3.3525e-09,-2.3877e-13,-77243,-27.3739], Tmin=(921.373,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-626.511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.824595,'amu*angstrom^2'), symmetry=1, barrier=(18.9591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.824445,'amu*angstrom^2'), symmetry=1, barrier=(18.9556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.824753,'amu*angstrom^2'), symmetry=1, barrier=(18.9627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.824822,'amu*angstrom^2'), symmetry=1, barrier=(18.9643,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.093,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.523668,0.0796706,-7.95218e-05,4.17967e-08,-9.04152e-12,-74894.4,23.2842], Tmin=(100,'K'), Tmax=(1095.84,'K')), NASAPolynomial(coeffs=[13.2375,0.0332632,-1.59988e-05,3.15183e-09,-2.2526e-13,-77680.9,-39.2162], Tmin=(1095.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-623.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
"""),
    E0 = (-530.658,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,361.492,361.501],'cm^-1')),
        HinderedRotor(inertia=(0.114578,'amu*angstrom^2'), symmetry=1, barrier=(10.625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11458,'amu*angstrom^2'), symmetry=1, barrier=(10.625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114579,'amu*angstrom^2'), symmetry=1, barrier=(10.625,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.095,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08383,0.0670616,-6.4472e-05,3.38851e-08,-7.44746e-12,-63720.9,21.901], Tmin=(100,'K'), Tmax=(1071.72,'K')), NASAPolynomial(coeffs=[10.6466,0.0313707,-1.45188e-05,2.81183e-09,-1.99072e-13,-65770.6,-24.8962], Tmin=(1071.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-530.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.21351,'amu*angstrom^2'), symmetry=1, barrier=(4.90902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213449,'amu*angstrom^2'), symmetry=1, barrier=(4.90761,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00225385,'amu*angstrom^2'), symmetry=1, barrier=(12.2939,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-446.407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,241.216,241.217],'cm^-1')),
        HinderedRotor(inertia=(0.182797,'amu*angstrom^2'), symmetry=1, barrier=(7.54763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182797,'amu*angstrom^2'), symmetry=1, barrier=(7.54764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182799,'amu*angstrom^2'), symmetry=1, barrier=(7.54763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182798,'amu*angstrom^2'), symmetry=1, barrier=(7.54763,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.142609,0.0931848,-0.000145487,1.26625e-07,-4.39271e-11,-53559.5,26.0539], Tmin=(100,'K'), Tmax=(806.176,'K')), NASAPolynomial(coeffs=[9.3003,0.0362183,-1.80419e-05,3.49543e-09,-2.43094e-13,-54661.4,-13.83], Tmin=(806.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJO)"""),
)
...
"""),
    E0 = (-414.922,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,208.013,208.032],'cm^-1')),
        HinderedRotor(inertia=(0.350878,'amu*angstrom^2'), symmetry=1, barrier=(10.775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00389556,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.537217,'amu*angstrom^2'), symmetry=1, barrier=(16.4974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.537293,'amu*angstrom^2'), symmetry=1, barrier=(16.498,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.201203,0.0895588,-0.000119624,8.59478e-08,-2.49526e-11,-49772.2,26.074], Tmin=(100,'K'), Tmax=(838.116,'K')), NASAPolynomial(coeffs=[12.4075,0.0313022,-1.53595e-05,3.01101e-09,-2.13221e-13,-51818.2,-30.6585], Tmin=(838.116,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-414.922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO)"""),
)
...
"""),
    E0 = (-414.445,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,302.498,311.364],'cm^-1')),
        HinderedRotor(inertia=(0.112376,'amu*angstrom^2'), symmetry=1, barrier=(8.11349,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127455,'amu*angstrom^2'), symmetry=1, barrier=(8.13072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143318,'amu*angstrom^2'), symmetry=1, barrier=(13.1229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.347621,'amu*angstrom^2'), symmetry=1, barrier=(23.3765,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.085,'amu'),
...
"""),
    E0 = (-659.487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,348,427,405,1245,1236,1280,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,375,552.5,462.5,1710,180],'cm^-1')),
        HinderedRotor(inertia=(0.00107854,'amu*angstrom^2'), symmetry=1, barrier=(12.2458,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.930743,'amu*angstrom^2'), symmetry=1, barrier=(21.3996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.532915,'amu*angstrom^2'), symmetry=1, barrier=(12.2528,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.174871,'amu*angstrom^2'), symmetry=1, barrier=(4.02063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174659,'amu*angstrom^2'), symmetry=1, barrier=(4.01576,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20201,0.0690118,-0.000101022,9.3174e-08,-3.49954e-11,-32182.7,22.2402], Tmin=(100,'K'), Tmax=(791.861,'K')), NASAPolynomial(coeffs=[4.63096,0.0387754,-1.92807e-05,3.75934e-09,-2.63345e-13,-32320.8,9.0545], Tmin=(791.861,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'C=C(F)C(C)OF(4507)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {4,S}
...
"""),
    E0 = (-263.319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,323,467,575,827,1418,2950,3100,1380,975,1025,1650,180,618.785],'cm^-1')),
        HinderedRotor(inertia=(0.571776,'amu*angstrom^2'), symmetry=1, barrier=(13.1462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.45426,'amu*angstrom^2'), symmetry=1, barrier=(13.1335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0484061,'amu*angstrom^2'), symmetry=1, barrier=(13.1469,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948545,0.0616976,-5.39546e-05,2.37271e-08,-4.16423e-12,-31555.7,24.5707], Tmin=(100,'K'), Tmax=(1362.95,'K')), NASAPolynomial(coeffs=[14.9243,0.0206816,-8.81438e-06,1.6476e-09,-1.14301e-13,-35365.4,-47.182], Tmin=(1362.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(CdCsCdF) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'CC([C]F)OF(3464)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'CC(F)(F)COF(3356)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(499)', 'CC=C(C)F(3465)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(C)OF(3471)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC([O])C(C)(F)F(4502)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(126)', 'C[CH]C(C)(F)F(4503)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'CC(F)(F)[CH]OF(3368)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C[C](OF)C(C)(F)F(4504)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'CC(OF)[C](F)F(4469)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(OF)C(C)(F)F(4505)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'CC(=O)C(C)(F)F(3334)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'CC(F)=C(C)OF(4506)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'C=C(F)C(C)OF(4507)'],
    products = ['CC(OF)C(C)(F)F(4328)'],
