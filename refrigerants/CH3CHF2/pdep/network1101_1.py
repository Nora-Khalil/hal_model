...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[C](F)F(2986)', '[CH]C-2(610)'],
    products = ['C[CH]OC[C](F)F(3036)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]O[CH]C(1805)'],
    products = ['C[CH]OC[C](F)F(3036)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C[CH]OC=C(F)F(3288)'],
    products = ['C[CH]OC[C](F)F(3036)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=COC[C](F)F(3289)'],
    products = ['C[CH]OC[C](F)F(3036)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH2]O[CH]C(1805)'],
    products = ['C[CH]OC[C](F)F(3036)'],
