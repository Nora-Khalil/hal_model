...
"""),
    E0 = (-428.209,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,493,600,700,1144,1293,267.667,267.714,1332.17],'cm^-1')),
        HinderedRotor(inertia=(0.359758,'amu*angstrom^2'), symmetry=1, barrier=(18.2584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150352,'amu*angstrom^2'), symmetry=1, barrier=(7.63575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0207828,'amu*angstrom^2'), symmetry=1, barrier=(26.1762,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0368,0.0636316,-6.75266e-05,3.55889e-08,-7.41459e-12,-51393.6,26.4796], Tmin=(100,'K'), Tmax=(1164.06,'K')), NASAPolynomial(coeffs=[14.4403,0.0175728,-8.17391e-06,1.59617e-09,-1.13923e-13,-54514,-40.2201], Tmin=(1164.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-428.209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFFHO) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=C(O)CJ) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)
...
"""),
    E0 = (-325.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,493,600,700,1144,1293,167,640,1190,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00737061,'amu*angstrom^2'), symmetry=1, barrier=(5.03145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0203521,'amu*angstrom^2'), symmetry=1, barrier=(13.9268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.605885,'amu*angstrom^2'), symmetry=1, barrier=(13.9305,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32221,0.0624625,-6.94162e-05,4.01517e-08,-9.46766e-12,-39106,25.772], Tmin=(100,'K'), Tmax=(1015.73,'K')), NASAPolynomial(coeffs=[11.2161,0.0234994,-1.18762e-05,2.38538e-09,-1.72221e-13,-41115.9,-22.1146], Tmin=(1015.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-325.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFFHO) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(F1s)(F1s)(O2s-Cd)) + radical(Cdj(Cd-CsO2s)(F1s))"""),
)

species(
    label = 'C=C([C]F)OC(F)F(8152)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-421.715,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,180,180,772.021,813.57],'cm^-1')),
        HinderedRotor(inertia=(0.0370706,'amu*angstrom^2'), symmetry=1, barrier=(17.4578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.759484,'amu*angstrom^2'), symmetry=1, barrier=(17.462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.759201,'amu*angstrom^2'), symmetry=1, barrier=(17.4555,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948339,0.0689451,-8.06022e-05,4.71081e-08,-1.09339e-11,-50612.2,23.1316], Tmin=(100,'K'), Tmax=(1045.88,'K')), NASAPolynomial(coeffs=[13.8606,0.0195604,-9.77299e-06,1.95888e-09,-1.41502e-13,-53313.1,-39.7416], Tmin=(1045.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsFFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]=C(CF)O[C](F)F(8153)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-330.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,493,600,700,1144,1293,3120,650,792.5,1650,180,567.233,937.725],'cm^-1')),
        HinderedRotor(inertia=(0.830856,'amu*angstrom^2'), symmetry=1, barrier=(19.103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.830874,'amu*angstrom^2'), symmetry=1, barrier=(19.1034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.830931,'amu*angstrom^2'), symmetry=1, barrier=(19.1047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.927716,0.0658414,-7.03849e-05,3.66862e-08,-7.52465e-12,-39672.9,26.2615], Tmin=(100,'K'), Tmax=(1183.25,'K')), NASAPolynomial(coeffs=[15.4468,0.0167591,-8.1632e-06,1.62898e-09,-1.17635e-13,-43108.8,-46.2274], Tmin=(1183.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-330.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsFFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-Cd)) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)OC(F)(F)F(8154)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.631438,0.0648907,-5.17619e-05,1.40468e-08,9.05434e-13,-59910.2,25.2489], Tmin=(100,'K'), Tmax=(1013.96,'K')), NASAPolynomial(coeffs=[17.1504,0.0170498,-6.61839e-06,1.21677e-09,-8.60274e-14,-64150.7,-59.0661], Tmin=(1013.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-499.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFFFO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18301,0.0694936,-0.000110058,1.0097e-07,-3.69369e-11,-51470.9,24.0892], Tmin=(100,'K'), Tmax=(801.02,'K')), NASAPolynomial(coeffs=[6.07094,0.0323198,-1.65416e-05,3.24416e-09,-2.27263e-13,-51844.4,4.14852], Tmin=(801.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-428.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCsFHH) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(C2CsJOCs) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-430.843,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,350,440,435,1725,194,682,905,1196,1383,3221,363.612,363.612,363.613,363.613,363.613,363.613],'cm^-1')),
        HinderedRotor(inertia=(0.54317,'amu*angstrom^2'), symmetry=1, barrier=(50.9612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.543169,'amu*angstrom^2'), symmetry=1, barrier=(50.9612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.543169,'amu*angstrom^2'), symmetry=1, barrier=(50.9612,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=CF)O[C](F)F(7504)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2927)', '[CH2]C(=O)[CH]F(427)'],
    products = ['[CH2]C(=CF)O[C](F)F(7504)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'FC=[C]O[C](F)F(4987)'],
    products = ['[CH2]C(=CF)O[C](F)F(7504)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=CF)O[C](F)F(7504)'],
    products = ['[CH2][C]1OC(F)(F)C1F(8149)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(CF)O[C](F)F(8153)'],
    products = ['[CH2]C(=CF)O[C](F)F(7504)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]F(230)', 'C=[C]O[C](F)F(3211)'],
    products = ['[CH2]C(=CF)O[C](F)F(7504)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(=CF)O[C](F)F(7504)'],
    products = ['F[CH][C]1CC(F)(F)O1(8155)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF(40)', 'C=[C]O[C](F)F(3211)'],
    products = ['[CH2]C(=CF)O[C](F)F(7504)'],
