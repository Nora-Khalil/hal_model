...
reaction(
    label = 'reaction3',
    reactants = ['O[C]1CC=[C]O1(1374)'],
    products = ['C#COC(=C)O(1256)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH]=C(O)OC#C(1379)'],
    products = ['C#COC(=C)O(1256)'],
