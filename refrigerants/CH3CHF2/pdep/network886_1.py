...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=O)O[C](O)F(2747)'],
    products = ['C=C(O)OC(=O)F(2637)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)O[C]=O(2750)'],
    products = ['C=C(O)OC(=O)F(2637)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(=O)F(168)', 'C=[C]O(137)'],
    products = ['C=C(O)OC(=O)F(2637)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CFO(51)', '[CH2]C(=O)O(1378)'],
    products = ['C=C(O)OC(=O)F(2637)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'C=[C]OC(=O)F(1016)'],
    products = ['C=C(O)OC(=O)F(2637)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(=O)OC(=O)F(2751)'],
    products = ['C=C(O)OC(=O)F(2637)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)OC(=O)F(2752)'],
    products = ['C=C(O)OC(=O)F(2637)'],
