...
"""),
    E0 = (-17.5505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,190,488,555,1236,1407,3120,650,792.5,1650,705.708],'cm^-1')),
        HinderedRotor(inertia=(0.525914,'amu*angstrom^2'), symmetry=1, barrier=(12.0918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.526634,'amu*angstrom^2'), symmetry=1, barrier=(12.1083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0787092,'amu*angstrom^2'), symmetry=1, barrier=(12.1223,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30229,0.0604912,-5.5403e-05,2.71188e-08,-5.50155e-12,-2014.7,24.5831], Tmin=(100,'K'), Tmax=(1159.76,'K')), NASAPolynomial(coeffs=[10.9518,0.0272093,-1.2356e-05,2.37331e-09,-1.67238e-13,-4252.86,-23.4001], Tmin=(1159.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.5505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.828704,0.0756605,-0.00010512,8.53272e-08,-2.86962e-11,-2859.56,23.695], Tmin=(100,'K'), Tmax=(726.118,'K')), NASAPolynomial(coeffs=[8.535,0.032921,-1.62352e-05,3.17511e-09,-2.23764e-13,-3971.11,-10.9649], Tmin=(726.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.679,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cds_P)"""),
)
...
"""),
    E0 = (336.719,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,376.905,377.215,377.226],'cm^-1')),
        HinderedRotor(inertia=(0.510427,'amu*angstrom^2'), symmetry=1, barrier=(51.472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.510854,'amu*angstrom^2'), symmetry=1, barrier=(51.4778,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52506,0.0264751,7.08405e-06,-2.07737e-08,8.00454e-12,40556.1,14.6774], Tmin=(100,'K'), Tmax=(1061.32,'K')), NASAPolynomial(coeffs=[6.48667,0.0249945,-9.83289e-06,1.79345e-09,-1.24009e-13,38957.7,-8.23953], Tmin=(1061.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.989019,0.0585611,-4.54505e-05,1.5276e-08,-1.16917e-12,-40355.6,21.2663], Tmin=(100,'K'), Tmax=(1085.58,'K')), NASAPolynomial(coeffs=[14.2316,0.0205969,-7.95831e-06,1.44164e-09,-9.96111e-14,-43869,-46.6483], Tmin=(1085.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-336.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFF)"""),
)
...
"""),
    E0 = (-89.3954,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.810059,'amu*angstrom^2'), symmetry=1, barrier=(18.6248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.81736,'amu*angstrom^2'), symmetry=1, barrier=(18.7927,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.970241,0.0614417,-5.98796e-05,2.97707e-08,-5.84731e-12,-10638.3,21.7364], Tmin=(100,'K'), Tmax=(1237.71,'K')), NASAPolynomial(coeffs=[14.4943,0.0177351,-6.91087e-06,1.24022e-09,-8.45531e-14,-13986.1,-46.3934], Tmin=(1237.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.3954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFF) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59069,0.0578396,-4.26773e-05,1.78845e-08,-3.42203e-12,-11011.1,22.2547], Tmin=(100,'K'), Tmax=(1131.64,'K')), NASAPolynomial(coeffs=[6.79836,0.0394322,-1.8278e-05,3.5105e-09,-2.46565e-13,-12189.7,-3.51334], Tmin=(1131.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.2381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C(C)=C[C](F)F(6538)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35743,0.0582002,-4.83894e-05,2.11652e-08,-3.8481e-12,-18270,22.4033], Tmin=(100,'K'), Tmax=(1276.73,'K')), NASAPolynomial(coeffs=[11.1444,0.0275377,-1.23649e-05,2.35447e-09,-1.64727e-13,-20769.1,-27.2042], Tmin=(1276.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-152.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Csj(Cd-CdH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]C(=C)C[C](F)F(6539)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.873745,0.0602386,-4.95875e-05,2.03971e-08,-3.33238e-12,-13488.9,25.3144], Tmin=(100,'K'), Tmax=(1465.75,'K')), NASAPolynomial(coeffs=[15.8078,0.0194841,-7.88095e-06,1.42782e-09,-9.69856e-14,-17866.8,-52.4444], Tmin=(1465.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[C](F)F(3016)'],
    products = ['[CH]=C(C)C[C](F)F(6379)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=C(C)C[C](F)F(6379)'],
    products = ['[CH]=C(C)C([CH2])(F)F(6377)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(2927)', '[CH]C(=C)C(6403)'],
    products = ['[CH]=C(C)C[C](F)F(6379)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH]C(=C)C(6403)'],
    products = ['[CH]=C(C)C[C](F)F(6379)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(10.474,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(C)C[C](F)F(6379)'],
    products = ['[CH]C(C)=CC(F)F(6537)'],
