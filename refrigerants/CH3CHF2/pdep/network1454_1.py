...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]=C(F)C#CF(4151)'],
    products = ['[CH]=C(F)C=[C]F(3994)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', '[CH]=C=C=[C]F(4152)'],
    products = ['[CH]=C(F)C=[C]F(3994)'],
    transitionState = 'TS7',
