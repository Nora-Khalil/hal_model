...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'FC1=C(F)[CH]1(5732)'],
    products = ['FC1=CC1(F)F(4640)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC1(F)[C]=C1(5210)'],
    products = ['FC1=CC1(F)F(4640)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC1=[C]C1(F)F(5733)'],
    products = ['FC1=CC1(F)F(4640)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'FC1=C=C1F(5735)'],
    products = ['FC1=CC1(F)F(4640)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1(F)C#C1(5736)'],
    products = ['FC1=CC1(F)F(4640)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[CH]=C=[C]F(5941)'],
    products = ['[CH]C(F)=C(F)F(4042)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]F(2927)', '[CH]=[C]F(1074)'],
    products = ['[CH]C(F)=C(F)F(4042)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'F[C]=C=[C]F(6094)'],
    products = ['F[C]C=C(F)F(4036)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'F[C]=C=C(F)F(6096)'],
    products = ['F[C]C=C(F)F(4036)'],
