...
"""),
    E0 = (-82.3242,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,580,1155,1237,1373,3147,615,860,1140,1343,3152,1685,370,268.121,268.168,268.258,268.259,3106.73],'cm^-1')),
        HinderedRotor(inertia=(0.128554,'amu*angstrom^2'), symmetry=1, barrier=(6.56038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00531128,'amu*angstrom^2'), symmetry=1, barrier=(36.3771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.713207,'amu*angstrom^2'), symmetry=1, barrier=(36.3763,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02367,0.0500488,-4.51472e-05,7.20425e-09,1.38169e-11,-9836.56,24.3918], Tmin=(100,'K'), Tmax=(530.032,'K')), NASAPolynomial(coeffs=[5.98735,0.0297021,-1.46378e-05,2.88082e-09,-2.04615e-13,-10391.1,6.51796], Tmin=(530.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.3242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFHHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(F1s)(O2s-Cs)(H)) + radical(Cdj(Cs-O2sHH)(Cd-F1sH))"""),
)
...
"""),
    E0 = (24.0324,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,580,1155,1237,1373,3147,2175,525,750,770,3400,2100,180,180,2712.45],'cm^-1')),
        HinderedRotor(inertia=(0.643372,'amu*angstrom^2'), symmetry=1, barrier=(14.7924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.60934,'amu*angstrom^2'), symmetry=1, barrier=(59.9939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.61179,'amu*angstrom^2'), symmetry=1, barrier=(60.0502,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70262,0.0544841,-7.77874e-05,6.38665e-08,-2.08622e-11,2969.37,19.9813], Tmin=(100,'K'), Tmax=(863.963,'K')), NASAPolynomial(coeffs=[7.07925,0.0224365,-9.72477e-06,1.76154e-09,-1.17619e-13,2307.35,-3.62629], Tmin=(863.963,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.0324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CtOsHH) + group(CsFHHO) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (-83.5906,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,580,1155,1237,1373,3147,167,640,1190,240.949,241.534,242.017,1289.24],'cm^-1')),
        HinderedRotor(inertia=(0.142923,'amu*angstrom^2'), symmetry=1, barrier=(5.99532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144702,'amu*angstrom^2'), symmetry=1, barrier=(6.01508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141236,'amu*angstrom^2'), symmetry=1, barrier=(5.98067,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33452,0.0653499,-0.000101867,9.14818e-08,-3.26371e-11,-9964.15,25.0292], Tmin=(100,'K'), Tmax=(818.349,'K')), NASAPolynomial(coeffs=[6.28777,0.0294112,-1.44959e-05,2.79335e-09,-1.9355e-13,-10382.1,4.52493], Tmin=(818.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.5906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFHHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(F1s)(O2s-Cs)(H)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (-30.8964,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,548,1085,1183,1302,1466,1520,3060,3119,1685,370,167,640,1190,250.231,250.323,250.375,250.401],'cm^-1')),
        HinderedRotor(inertia=(0.828359,'amu*angstrom^2'), symmetry=1, barrier=(36.8246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00269164,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.43426e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90422,0.050588,-5.5211e-05,3.77811e-08,-1.14242e-11,-3644.53,25.0025], Tmin=(100,'K'), Tmax=(778.308,'K')), NASAPolynomial(coeffs=[6.02177,0.0294265,-1.44272e-05,2.84734e-09,-2.03105e-13,-4285.47,6.16968], Tmin=(778.308,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.8964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFHHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-O2sHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=[C]COC(F)F(7746)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32682,0.0654026,-0.000101792,9.10428e-08,-3.23783e-11,-10507,25.2858], Tmin=(100,'K'), Tmax=(816.898,'K')), NASAPolynomial(coeffs=[6.45318,0.0290301,-1.43086e-05,2.75826e-09,-1.91191e-13,-10968.5,3.89269], Tmin=(816.898,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.1076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)CO[CH]F(7747)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21723,0.0680539,-0.000107362,9.59053e-08,-3.39572e-11,-10990.2,24.8267], Tmin=(100,'K'), Tmax=(817.809,'K')), NASAPolynomial(coeffs=[6.84661,0.0289354,-1.43637e-05,2.77346e-09,-1.92291e-13,-11523.5,1.16891], Tmin=(817.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.1555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFHHO) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Csj(F1s)(O2s-Cs)(H)) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', '[O]C[C]=CF(4122)'],
    products = ['F[CH]OC[C]=CF(7463)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1084)', '[CH2]O[CH]F(325)'],
    products = ['F[CH]OC[C]=CF(7463)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CCO[CH]F(7740)'],
    products = ['F[CH]OC[C]=CF(7463)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[O]C[C]=CF(4122)'],
    products = ['F[CH]OC[C]=CF(7463)'],
