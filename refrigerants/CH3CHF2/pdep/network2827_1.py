...
"""),
    E0 = (-363.644,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42895,0.0588789,-5.3789e-05,2.55662e-08,-5.04405e-12,-43645.7,27.4021], Tmin=(100,'K'), Tmax=(1183.42,'K')), NASAPolynomial(coeffs=[10.9653,0.0266461,-1.2934e-05,2.55128e-09,-1.82162e-13,-45902.9,-20.2115], Tmin=(1183.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-363.644,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-169.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,190,488,555,1236,1407,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.760686,0.0774507,-0.000106465,8.09052e-08,-2.51688e-11,-20286.2,29.3777], Tmin=(100,'K'), Tmax=(780.002,'K')), NASAPolynomial(coeffs=[9.99793,0.0300821,-1.53754e-05,3.05367e-09,-2.17415e-13,-21727.2,-12.8919], Tmin=(780.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsHHH) + radical(CCsJOO) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (127.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.970881,0.0718332,-7.92333e-05,4.79411e-08,-1.20975e-11,-44643.6,27.7894], Tmin=(100,'K'), Tmax=(943.242,'K')), NASAPolynomial(coeffs=[10.3683,0.0319817,-1.5859e-05,3.14926e-09,-2.25703e-13,-46416.4,-16.9985], Tmin=(943.242,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-372.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsHHH) + radical(CCsJOO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OOOC[C](F)F(7096)'],
    products = ['COOOC[C](F)F(7319)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(2927)', '[CH2]OOOC(2555)'],
    products = ['COOOC[C](F)F(7319)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'COOOC=C(F)F(8737)'],
    products = ['COOOC[C](F)F(7319)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CO[O](183)', '[O]C[C](F)F(2986)'],
    products = ['COOOC[C](F)F(7319)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(2.28341,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CH3O(27)', '[O]OC[C](F)F(3041)'],
    products = ['COOOC[C](F)F(7319)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', '[O]OOC[C](F)F(6993)'],
    products = ['COOOC[C](F)F(7319)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'COOO[CH][C](F)F(8738)'],
    products = ['COOOC[C](F)F(7319)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]OOOC[C](F)F(8739)'],
    products = ['COOOC[C](F)F(7319)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'COOOC[C]F-2(5613)'],
    products = ['COOOC[C](F)F(7319)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]OOOC(2555)'],
    products = ['COOOC[C](F)F(7319)'],
