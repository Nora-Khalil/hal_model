...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.69367,'amu*angstrom^2'), symmetry=1, barrier=(38.9407,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.69434,'amu*angstrom^2'), symmetry=1, barrier=(38.9562,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (58.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.78046,0.0179242,9.23976e-06,-2.96902e-08,1.36183e-11,-4681.46,13.8243], Tmin=(100,'K'), Tmax=(971.362,'K')), NASAPolynomial(coeffs=[11.8265,0.00248519,-6.01394e-07,1.80971e-10,-1.92755e-14,-7467.88,-34.8515], Tmin=(971.362,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.3557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(OCJC=O) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (59.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.73075,0.0175106,1.90194e-05,-4.15786e-08,1.80492e-11,-23280.5,13.329], Tmin=(100,'K'), Tmax=(963.673,'K')), NASAPolynomial(coeffs=[12.0193,0.00477198,-1.33658e-06,3.0298e-10,-2.77175e-14,-26269.4,-37.3589], Tmin=(963.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(OCJC=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(7)', 'CH2CO(28)'],
    products = ['O=[C]CO(1939)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]CO(1939)'],
    products = ['O=C[CH]O(6955)'],
    transitionState = 'TS8',
