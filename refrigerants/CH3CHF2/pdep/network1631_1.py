...
"""),
    E0 = (-432.104,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,180,1560.83],'cm^-1')),
        HinderedRotor(inertia=(0.459117,'amu*angstrom^2'), symmetry=1, barrier=(10.556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.461177,'amu*angstrom^2'), symmetry=1, barrier=(10.6034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.75386,'amu*angstrom^2'), symmetry=1, barrier=(40.3246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.75545,'amu*angstrom^2'), symmetry=1, barrier=(40.3613,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0640688,0.0954817,-0.000152783,1.35068e-07,-4.77715e-11,-51837,31.9182], Tmin=(100,'K'), Tmax=(783.18,'K')), NASAPolynomial(coeffs=[9.5058,0.0364949,-1.91913e-05,3.80081e-09,-2.67757e-13,-52985.8,-9.21765], Tmin=(783.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-432.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0301788,0.0958654,-0.000154449,1.34643e-07,-4.65928e-11,-94443.8,30.0816], Tmin=(100,'K'), Tmax=(797.491,'K')), NASAPolynomial(coeffs=[10.3441,0.0335555,-1.73546e-05,3.40587e-09,-2.38344e-13,-95752.5,-15.2345], Tmin=(797.491,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-786.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (11.0464,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,355.796,355.887,2576.25,2576.55],'cm^-1')),
        HinderedRotor(inertia=(0.444581,'amu*angstrom^2'), symmetry=1, barrier=(39.9201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444419,'amu*angstrom^2'), symmetry=1, barrier=(39.9198,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444625,'amu*angstrom^2'), symmetry=1, barrier=(39.9193,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0859211,'amu*angstrom^2'), symmetry=1, barrier=(7.71967,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.819443,0.0764284,-0.000103272,7.88741e-08,-2.49393e-11,1437.19,28.3214], Tmin=(100,'K'), Tmax=(764.749,'K')), NASAPolynomial(coeffs=[9.26841,0.0322357,-1.65902e-05,3.30867e-09,-2.36264e-13,144.934,-10.1738], Tmin=(764.749,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.0464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.044842,0.0750109,-7.60243e-05,3.93526e-08,-7.82281e-12,-69797.7,26.3303], Tmin=(100,'K'), Tmax=(1356.78,'K')), NASAPolynomial(coeffs=[17.8452,0.0161772,-3.95374e-06,4.87562e-10,-2.54035e-14,-74042.9,-62.8215], Tmin=(1356.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(12dioxolane) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-192.36,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,562,600,623,1070,1265,1685,370,180,180,1271.27],'cm^-1')),
        HinderedRotor(inertia=(0.270827,'amu*angstrom^2'), symmetry=1, barrier=(6.22685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26986,'amu*angstrom^2'), symmetry=1, barrier=(6.20461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.270293,'amu*angstrom^2'), symmetry=1, barrier=(6.21456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.28736,'amu*angstrom^2'), symmetry=1, barrier=(52.5909,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.21637,0.0979498,-0.000182256,1.77243e-07,-6.53767e-11,-23013.6,34.4976], Tmin=(100,'K'), Tmax=(838.753,'K')), NASAPolynomial(coeffs=[5.64841,0.0401196,-2.17406e-05,4.2807e-09,-2.97427e-13,-22801.8,15.9406], Tmin=(838.753,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0796826,'amu*angstrom^2'), symmetry=1, barrier=(1.83206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16735,'amu*angstrom^2'), symmetry=1, barrier=(26.8397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.406587,0.0891053,-0.000155623,1.43446e-07,-5.15198e-11,6980.41,28.0792], Tmin=(100,'K'), Tmax=(810.718,'K')), NASAPolynomial(coeffs=[8.5443,0.0316694,-1.73725e-05,3.462e-09,-2.43304e-13,6228.98,-5.9696], Tmin=(810.718,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(57.0436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Ct-CtOs) + group(CtCF) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-439.564,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,180,855.604],'cm^-1')),
        HinderedRotor(inertia=(0.310385,'amu*angstrom^2'), symmetry=1, barrier=(7.13637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77298,'amu*angstrom^2'), symmetry=1, barrier=(40.7642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77329,'amu*angstrom^2'), symmetry=1, barrier=(40.7713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.896772,0.0802243,-8.53604e-05,1.24858e-08,3.32722e-11,-52767.5,28.3933], Tmin=(100,'K'), Tmax=(510.439,'K')), NASAPolynomial(coeffs=[8.86492,0.0378556,-1.98402e-05,3.95235e-09,-2.80589e-13,-53842.5,-7.25138], Tmin=(510.439,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-439.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CCsJOOC)"""),
)

species(
    label = 'FCCOO[C]=C(F)F(4602)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00247779,'amu*angstrom^2'), symmetry=1, barrier=(9.06037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.9904,'amu*angstrom^2'), symmetry=1, barrier=(45.7633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.9836,'amu*angstrom^2'), symmetry=1, barrier=(45.6069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.392561,'amu*angstrom^2'), symmetry=1, barrier=(9.02574,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.377029,0.091253,-0.000154191,1.46755e-07,-5.46615e-11,-46337.1,32.9519], Tmin=(100,'K'), Tmax=(811.254,'K')), NASAPolynomial(coeffs=[5.74166,0.0423961,-2.24266e-05,4.43078e-09,-3.10712e-13,-46470.3,12.737], Tmin=(811.254,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-386.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]COOC=C(F)F(4562)'],
    products = ['O=C[C](F)F(3117)', 'FC1CO1(285)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]COOC=C(F)F(4562)'],
    products = ['O=CC(F)(F)OC[CH]F(4592)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]COOC=C(F)F(4593)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(230)', '[CH2]OOC=C(F)F(4366)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'F[C]COOC=C(F)F(4594)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]COOC=C(F)F(4562)'],
    products = ['FC1COO[CH]C1(F)F(4595)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]OC=C(F)F(3115)', 'CH2CHF(56)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[C]=COOC[CH]F(3715)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C[C](F)F(3117)', '[O]C[CH]F(140)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC=C(F)F(3115)', '[CH2][CH]F(233)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2CH(73)', '[O]OC[CH]F(221)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'F[CH]COO[C]=C(F)F(4599)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]COOC=C(F)F(4562)'],
    products = ['O=C[CH]F(338)', 'O=CC(F)F(1539)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'FC#COOC[CH]F(4600)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF(40)', '[CH2]OOC=C(F)F(4366)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'F[C]COOC=C(F)F-2(4601)'],
    products = ['F[CH]COOC=C(F)F(4562)'],
...
network(
    ...
    isomers = [
        'F[CH]COOC=C(F)F(4562)',
    ],
    reactants = [
        ('O=C[C](F)F(3117)', 'FC1CO1(285)'),
        ('O=C[C](F)F(3117)', '[O]C[CH]F(140)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
