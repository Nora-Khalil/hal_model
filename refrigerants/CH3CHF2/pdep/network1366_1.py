...
"""),
    E0 = (-493.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,487,638,688,1119,1325,1387,3149,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.134339,0.0901931,-9.09423e-05,4.51949e-08,-8.96247e-12,-59228.7,36.1217], Tmin=(100,'K'), Tmax=(1209.65,'K')), NASAPolynomial(coeffs=[18.6204,0.0281752,-1.40374e-05,2.81027e-09,-2.02661e-13,-63765.9,-57.9285], Tmin=(1209.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-493.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJCOOH)"""),
)
...
"""),
    E0 = (-106.528,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,487,638,688,1119,1325,1387,3149,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (155.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11457,0.100214,-0.000108787,5.60276e-08,-1.10593e-11,-12617.8,40.3162], Tmin=(100,'K'), Tmax=(1251.61,'K')), NASAPolynomial(coeffs=[25.8485,0.0140426,-5.51459e-06,1.01943e-09,-7.17631e-14,-19367.2,-95.8163], Tmin=(1251.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2sCF) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(F)OOOOC=CF(4171)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {10,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-184.562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (155.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.577377,0.0880014,-8.48376e-05,3.9078e-08,-6.97419e-12,-22022.3,41.6462], Tmin=(100,'K'), Tmax=(1369.56,'K')), NASAPolynomial(coeffs=[23.6066,0.0173677,-7.47581e-06,1.41987e-09,-9.99815e-14,-28646.5,-82.6329], Tmin=(1369.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsOs) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CJCOOH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.778929,0.0751269,-8.53142e-05,4.94783e-08,-1.16237e-11,-55174.5,30.7009], Tmin=(100,'K'), Tmax=(1021.97,'K')), NASAPolynomial(coeffs=[13.2369,0.0263659,-1.37444e-05,2.79035e-09,-2.02547e-13,-57720.8,-29.6721], Tmin=(1021.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-459.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFHHO) + group(Cds-OdCsH) + radical(CsF1sHO2s)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.066111,0.0898571,-9.48928e-05,4.91606e-08,-1.01392e-11,-31057.9,34.8876], Tmin=(100,'K'), Tmax=(1166.93,'K')), NASAPolynomial(coeffs=[18.3618,0.0266901,-1.36964e-05,2.77312e-09,-2.01242e-13,-35358.8,-56.861], Tmin=(1166.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (155.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.468226,0.0569879,1.16846e-05,-5.93548e-08,2.6603e-11,-58902.1,26.0373], Tmin=(100,'K'), Tmax=(1012.98,'K')), NASAPolynomial(coeffs=[21.087,0.0237475,-1.04349e-05,2.15397e-09,-1.64636e-13,-65551.2,-85.9033], Tmin=(1012.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-490.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(CsCFHO) + group(CsCFHO) + ring(Cyclooctane) + radical(CCsJOCs)"""),
)

species(
    label = '[O]C1CC(F)OOOC1F(4174)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
...
9  C u0 p0 c0 {1,S} {3,S} {8,S} {14,S}
10 C u0 p0 c0 {2,S} {4,S} {7,S} {15,S}
11 H u0 p0 c0 {8,S}
12 H u0 p0 c0 {7,S}
13 H u0 p0 c0 {7,S}
14 H u0 p0 c0 {9,S}
...
"""),
    ...
    molecularWeight = (155.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.303873,0.0235158,0.000184357,-3.03782e-07,1.31589e-10,-59958.1,29.7317], Tmin=(100,'K'), Tmax=(913.978,'K')), NASAPolynomial(coeffs=[46.3525,-0.0273567,2.05912e-05,-3.97742e-09,2.52298e-13,-74668.2,-222.709], Tmin=(913.978,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-500.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCFHO) + ring(Cycloheptane) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(F)OOOC(F)=CO(4175)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-422.746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,326,540,652,719,1357,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (155.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.569522,0.09725,-0.000106558,5.67014e-08,-1.1812e-11,-50677.3,37.9084], Tmin=(100,'K'), Tmax=(1170.01,'K')), NASAPolynomial(coeffs=[21.2758,0.0225655,-1.08087e-05,2.14397e-09,-1.54533e-13,-55789.1,-70.9126], Tmin=(1170.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(CJCOOH)"""),
)
...
"""),
    E0 = (-339.033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0270232,0.0763635,-6.71988e-05,2.64101e-08,-3.43287e-12,-40624,34.0613], Tmin=(100,'K'), Tmax=(1140.54,'K')), NASAPolynomial(coeffs=[20.0491,0.0187697,-8.05812e-06,1.5471e-09,-1.10495e-13,-46012.3,-68.7666], Tmin=(1140.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-339.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-524.239,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,326,540,652,719,1357,2782.5,750,1395,475,1775,1000,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.605624,0.0807726,-8.53374e-05,4.75232e-08,-1.099e-11,-62934.2,33.4063], Tmin=(100,'K'), Tmax=(1022.59,'K')), NASAPolynomial(coeffs=[12.3333,0.0348982,-1.80457e-05,3.65292e-09,-2.64656e-13,-65332.7,-23.4349], Tmin=(1022.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-524.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CdCFO) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)

species(
    label = '[CH2]C(F)OOO[CH]C=O(4179)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {4,S} {7,S}
...
"""),
    E0 = (-126.563,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (136.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.234256,0.0815394,-8.08832e-05,3.98042e-08,-7.82734e-12,-15085.4,34.4316], Tmin=(100,'K'), Tmax=(1219.18,'K')), NASAPolynomial(coeffs=[17.1297,0.0261066,-1.26817e-05,2.51017e-09,-1.7991e-13,-19205.1,-50.4274], Tmin=(1219.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CJCOOH) + radical(OCJC=O)"""),
)

species(
    label = '[CH2][CH]OOOC(F)C=O(4180)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {4,S} {7,S}
...
"""),
    E0 = (-80.5412,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (136.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.374517,0.0832328,-9.03401e-05,5.07312e-08,-1.15688e-11,-9559.15,34.3565], Tmin=(100,'K'), Tmax=(1050.97,'K')), NASAPolynomial(coeffs=[14.2257,0.0305156,-1.51e-05,3.00412e-09,-2.15829e-13,-12470.6,-33.156], Tmin=(1050.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.5412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOO) + radical(CJCOOH)"""),
)
...
"""),
    E0 = (-299.143,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,395,473,707,1436,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0638769,0.0960402,-0.000120891,7.87055e-08,-2.06827e-11,-35837.9,36.6912], Tmin=(100,'K'), Tmax=(921.024,'K')), NASAPolynomial(coeffs=[14.6411,0.0321767,-1.68813e-05,3.42018e-09,-2.47482e-13,-38546.6,-33.042], Tmin=(921.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(F)OOOC(F)[C]=O(4184)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-335.156,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,355,410,600,1181,1341,1420,3056,3000,3100,440,815,1455,1000,1855,455,950,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.314294,0.0995541,-0.000126898,8.14787e-08,-2.07646e-11,-40158.5,36.4578], Tmin=(100,'K'), Tmax=(956.446,'K')), NASAPolynomial(coeffs=[16.8931,0.0275905,-1.40368e-05,2.81211e-09,-2.02455e-13,-43450.1,-45.7916], Tmin=(956.446,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJCOOH) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)
...
"""),
    E0 = (-82.8585,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,2120,512.5,787.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00356414,0.0818002,-8.83395e-05,4.60313e-08,-9.30779e-12,-9816.51,34.6379], Tmin=(100,'K'), Tmax=(1212.21,'K')), NASAPolynomial(coeffs=[19.8903,0.0161786,-7.1384e-06,1.37374e-09,-9.77976e-14,-14637.9,-65.1309], Tmin=(1212.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.8585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + missing(O2d-Cdd) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(CJCOOH)"""),
)

species(
    label = 'C[C](F)OOOC(F)C=O(4186)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-513.106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,2782.5,750,1395,475,1775,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (155.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0856245,0.0923602,-0.000104506,6.20866e-08,-1.51163e-11,-61576.6,34.1574], Tmin=(100,'K'), Tmax=(982.678,'K')), NASAPolynomial(coeffs=[13.9314,0.0360022,-1.8481e-05,3.72659e-09,-2.69415e-13,-64297.8,-32.3986], Tmin=(982.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-513.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'CC(F)OOO[C](F)C=O(4187)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (155.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.411017,0.0811595,-7.38042e-05,3.40025e-08,-6.43484e-12,-68239.7,32.3847], Tmin=(100,'K'), Tmax=(1236.21,'K')), NASAPolynomial(coeffs=[14.8744,0.0343604,-1.7019e-05,3.3793e-09,-2.41907e-13,-71815.6,-40.4599], Tmin=(1236.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-568.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + radical(CsCOF1sO2s)"""),
)

species(
    label = 'CC(F)OOOC(F)[C]=O(4188)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (155.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.192263,0.0961981,-0.000111644,6.63259e-08,-1.58263e-11,-65896,34.0224], Tmin=(100,'K'), Tmax=(1012.88,'K')), NASAPolynomial(coeffs=[16.2328,0.0313362,-1.55925e-05,3.10851e-09,-2.23581e-13,-69223.5,-45.4297], Tmin=(1012.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-549.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = 'O=C[CH]OOOC(F)CF(4189)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (155.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0716423,0.0884204,-8.60804e-05,4.14549e-08,-7.99673e-12,-61755.3,34.8424], Tmin=(100,'K'), Tmax=(1238.36,'K')), NASAPolynomial(coeffs=[18.2515,0.0292352,-1.43904e-05,2.86076e-09,-2.05332e-13,-66293.4,-57.4732], Tmin=(1238.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-514.689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[CH2]C(F)OOOCF(4169)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C[C]F-2(1532)', '[CH2]C(F)OOO(2296)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)OOOC=COF(4170)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)OOOOC=CF(4171)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', 'O=CC(F)OOO[CH]F(3836)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]C(F)OOOC(F)C=O(4172)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)OOOC(F)C=O(3832)'],
    products = ['FC1[CH]OCC(F)OOO1(4173)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(F)OOOC(F)=CO(4175)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C=COOOC(F)C=O(4176)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C(F)OOOC(F)C=O(4178)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C(F)OOO[CH]C=O(4179)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2][CH]OOOC(F)C=O(4180)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C(F)C=O(818)', '[CH2]C(F)O[O](222)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(8.14976e+13,'m^3/(mol*s)'), n=-2.27223, Ea=(21.7211,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H"""),
)

reaction(
    label = 'reaction18',
    reactants = ['O=C[CH]F(338)', '[CH2]C(F)OO[O](476)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]OC(F)C=O(1537)', '[CH2]C([O])F(141)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HCO(15)', '[CH2]C(F)OOO[CH]F(4181)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[CH2]C(F)OOO[C](F)C=O(4182)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', '[CH2][C](F)OOOC(F)C=O(4183)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', '[CH2]C(F)OOOC(F)[C]=O(4184)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', '[CH2]C(F)OOOC=C=O(4185)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C[C](F)OOOC(F)C=O(4186)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(F)OOOC(F)C=O(3832)'],
    products = ['CC(F)OOO[C](F)C=O(4187)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(10500,'s^-1'), n=2.14, Ea=(33.3465,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using an average for rate rule [R6H_SSSSS;C_rad_out_2H;Cs_H_out_noH]
Euclidian distance = 0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(F)OOOC(F)C=O(3832)'],
    products = ['O=C[CH]OOOC(F)CF(4189)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(187.783,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction30',
    reactants = ['O=CC(F)OOO[CH]CF(4190)'],
    products = ['[CH2]C(F)OOOC(F)C=O(3832)'],
...
network(
    ...
    isomers = [
        '[CH2]C(F)OOOC(F)C=O(3832)',
    ],
    reactants = [
        ('[O]OC(F)C=O(1537)', 'FC1CO1(285)'),
        ('[O]OC(F)C=O(1537)', '[CH2]C([O])F(141)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
