...
"""),
    E0 = (76.1148,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([122,584,932,1043,1247,1392,1461,2986,3039,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,395.284,396.013],'cm^-1')),
        HinderedRotor(inertia=(0.194645,'amu*angstrom^2'), symmetry=1, barrier=(21.5408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194756,'amu*angstrom^2'), symmetry=1, barrier=(21.5369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195012,'amu*angstrom^2'), symmetry=1, barrier=(21.5526,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50853,0.0423195,-6.5353e-06,-2.92379e-08,1.59958e-11,9255.47,23.0439], Tmin=(100,'K'), Tmax=(965.732,'K')), NASAPolynomial(coeffs=[16.4709,0.010292,-3.30169e-06,6.3832e-10,-5.02247e-14,4969.13,-55.8488], Tmin=(965.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.1148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COCJ) + radical(Cdj(Cs-F1sHH)(Cd-O2sH))"""),
)
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86997,0.0279171,4.19846e-05,-8.44357e-08,3.69473e-11,-25131.3,16.0959], Tmin=(100,'K'), Tmax=(939.644,'K')), NASAPolynomial(coeffs=[18.1918,0.0064715,-4.61636e-07,8.36472e-11,-1.44088e-14,-30319.3,-72.9152], Tmin=(939.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclobutene)"""),
)
...
"""),
    E0 = (31.5568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([319,1023,1071,1259,1317,1409,3054,3019,3000,3100,440,815,1455,1000,2100,2250,500,550,290.585,290.84,290.932],'cm^-1')),
        HinderedRotor(inertia=(0.463088,'amu*angstrom^2'), symmetry=1, barrier=(27.7924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.464269,'amu*angstrom^2'), symmetry=1, barrier=(27.8087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.463904,'amu*angstrom^2'), symmetry=1, barrier=(27.8134,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48991,0.0463499,-2.72057e-05,-7.30584e-09,8.8886e-12,3893.92,19.1793], Tmin=(100,'K'), Tmax=(933.597,'K')), NASAPolynomial(coeffs=[15.6215,0.00818919,-1.8612e-06,2.80184e-10,-2.05401e-14,279.674,-53.2517], Tmin=(933.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.5568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(Cs-OsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (123.851,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([122,584,932,1043,1247,1392,1461,2986,3039,2750,2800,2850,1350,1500,750,1050,1375,1000,1670,1700,300,440,387.628,387.723],'cm^-1')),
        HinderedRotor(inertia=(0.158416,'amu*angstrom^2'), symmetry=1, barrier=(16.8933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158388,'amu*angstrom^2'), symmetry=1, barrier=(16.8921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15839,'amu*angstrom^2'), symmetry=1, barrier=(16.8921,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55356,0.0466867,-3.32094e-05,8.19675e-09,4.2528e-13,14990,23.5289], Tmin=(100,'K'), Tmax=(1096.23,'K')), NASAPolynomial(coeffs=[12.923,0.0162498,-6.68012e-06,1.25719e-09,-8.88827e-14,11833.4,-35.3947], Tmin=(1096.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cdj(Cs-F1sHH)(Cd-O2sH)) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C=[C]CF(11912)'],
    products = ['[CH2]OC=[C]CF(11801)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC#CCF(11976)'],
    products = ['[CH2]OC=[C]CF(11801)'],
    transitionState = 'TS9',
