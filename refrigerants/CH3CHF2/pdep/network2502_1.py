...
"""),
    E0 = (-452.643,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,203.238,203.239],'cm^-1')),
        HinderedRotor(inertia=(0.222152,'amu*angstrom^2'), symmetry=1, barrier=(6.5116,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222151,'amu*angstrom^2'), symmetry=1, barrier=(6.5116,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22498,'amu*angstrom^2'), symmetry=1, barrier=(35.9061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22498,'amu*angstrom^2'), symmetry=1, barrier=(35.9061,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.222258,0.0905903,-0.00013728,1.15954e-07,-3.98565e-11,-93260.7,29.4432], Tmin=(100,'K'), Tmax=(739.942,'K')), NASAPolynomial(coeffs=[10.1433,0.0343215,-1.78668e-05,3.54856e-09,-2.51389e-13,-94656.7,-14.9443], Tmin=(739.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-776.485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + group(Cds-OdCsH) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.261683,0.0792293,-8.77829e-05,4.93438e-08,-1.03573e-11,-71949.9,24.496], Tmin=(100,'K'), Tmax=(914.226,'K')), NASAPolynomial(coeffs=[15.5201,0.0213026,-7.23349e-06,1.17438e-09,-7.51064e-14,-75109,-49.7674], Tmin=(914.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-599.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(CsCsFHH) + ring(12dioxolane) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'F[C]COOC=CF(3775)'],
    products = ['FC=COOC[C](F)F(6639)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(3025)', '[CH2]OOC=CF(1676)'],
    products = ['FC=COOC[C](F)F(6639)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FC=COOC[C](F)F(6639)'],
    products = ['FC1[CH]OOCC1(F)F(6653)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FC=COOC[C](F)F(6639)'],
    products = ['F[CH]C1OOCC1(F)F(6654)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=COOC[C](F)F(6655)'],
    products = ['FC=COOC[C](F)F(6639)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C[CH]F(338)', '[O]C[C](F)F(3183)'],
    products = ['FC=COOC[C](F)F(6639)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHFCH[Z](71)', '[O]OC[C](F)F(3122)'],
    products = ['FC=COOC[C](F)F(6639)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FC=[C]OOC[C](F)F(6656)'],
    products = ['FC=COOC[C](F)F(6639)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'F[C]=COOC[C](F)F(6657)'],
    products = ['FC=COOC[C](F)F(6639)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FC=COOC[C](F)F(6639)'],
    products = ['O=C[C](F)F(3189)', 'O=CCF(208)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'C#COOC[C](F)F(4402)'],
    products = ['FC=COOC[C](F)F(6639)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'F[C]COOC=CF-2(3783)'],
    products = ['FC=COOC[C](F)F(6639)'],
