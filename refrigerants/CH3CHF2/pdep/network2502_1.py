...
"""),
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49238,0.015609,6.06829e-05,-9.41243e-08,3.82534e-11,-4376.37,13.4608], Tmin=(100,'K'), Tmax=(943.874,'K')), NASAPolynomial(coeffs=[14.1451,0.010772,-2.42172e-06,4.47746e-10,-3.89386e-14,-8560.38,-52.5951], Tmin=(943.874,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.972,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
"""),
    E0 = (202.462,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2100,2250,500,550,180,638.717],'cm^-1')),
        HinderedRotor(inertia=(0.0828839,'amu*angstrom^2'), symmetry=1, barrier=(1.90566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.078562,'amu*angstrom^2'), symmetry=1, barrier=(1.8063,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.6912,0.0310049,-2.70843e-05,2.0946e-08,-7.29328e-12,24395.5,17.517], Tmin=(100,'K'), Tmax=(902.672,'K')), NASAPolynomial(coeffs=[2.49833,0.0263666,-1.02489e-05,1.77093e-09,-1.15601e-13,24654.1,19.6673], Tmin=(902.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtOsHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCOJ)"""),
)

species(
    label = 'C[C]=C[CH]O(6614)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17391,0.0332974,-6.99973e-06,-1.27228e-08,6.68697e-12,20770.5,20.3527], Tmin=(100,'K'), Tmax=(1029.17,'K')), NASAPolynomial(coeffs=[9.64813,0.018904,-7.38264e-06,1.36243e-09,-9.57898e-14,18455.8,-19.6919], Tmin=(1029.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJO) + radical(Cds_S)"""),
)
...
"""),
    E0 = (280.509,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1685,370,180,2871.59],'cm^-1')),
        HinderedRotor(inertia=(0.255946,'amu*angstrom^2'), symmetry=1, barrier=(5.8847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255156,'amu*angstrom^2'), symmetry=1, barrier=(5.86655,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.217699,'amu*angstrom^2'), symmetry=1, barrier=(5.00533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218059,'amu*angstrom^2'), symmetry=1, barrier=(5.01361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217642,'amu*angstrom^2'), symmetry=1, barrier=(5.00402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10242,0.0470018,-6.52793e-05,5.94481e-08,-2.17631e-11,35260.4,20.4841], Tmin=(100,'K'), Tmax=(840.402,'K')), NASAPolynomial(coeffs=[3.61999,0.0287657,-1.30737e-05,2.4418e-09,-1.665e-13,35394.2,15.7404], Tmin=(840.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C=C[O](6618)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
2  C u0 p0 c0 {3,S} {6,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22491,0.0238244,3.87463e-05,-7.22486e-08,3.07685e-11,6964.73,16.6121], Tmin=(100,'K'), Tmax=(942.076,'K')), NASAPolynomial(coeffs=[14.2113,0.0114127,-2.76311e-06,4.85104e-10,-3.92955e-14,2998.68,-49.5632], Tmin=(942.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(57.2609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Allyl_S)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[C]=CC[O](6333)'],
    products = ['CH2O(20)', 'C#CC(5603)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C=C[C]C(6411)'],
    products = ['C[C]=CC[O](6333)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](132)', '[CH]=[C]C(5604)'],
    products = ['C[C]=CC[O](6333)'],
