...
"""),
    E0 = (-48.7777,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,194,682,905,1196,1383,3221,2950,3100,1380,975,1025,1650,1685,370,194.884,194.904],'cm^-1')),
        HinderedRotor(inertia=(0.190942,'amu*angstrom^2'), symmetry=1, barrier=(5.14726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190945,'amu*angstrom^2'), symmetry=1, barrier=(5.14729,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (12.604,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,259,529,569,1128,1321,1390,3140,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,3120,650,792.5,1650,263.983,264.046],'cm^-1')),
        HinderedRotor(inertia=(0.192684,'amu*angstrom^2'), symmetry=1, barrier=(9.53437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.408398,'amu*angstrom^2'), symmetry=1, barrier=(20.2102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272142,'amu*angstrom^2'), symmetry=1, barrier=(13.4599,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11158,0.0674248,-7.3545e-05,4.42653e-08,-1.10452e-11,1616.67,24.8391], Tmin=(100,'K'), Tmax=(957.427,'K')), NASAPolynomial(coeffs=[10.231,0.0293245,-1.38524e-05,2.70014e-09,-1.91678e-13,-129.545,-18.76], Tmin=(957.427,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sCsH)(F1s)(H)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=[C]CC(F)=CF(11391)'],
    products = ['C=[C]CC(F)[CH]F(10797)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#CCC(F)[CH]F(8260)'],
    products = ['C=[C]CC(F)[CH]F(10797)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(202.919,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
