...
"""),
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.77776,0.0145131,5.13622e-05,-8.40707e-08,3.68834e-11,9195.86,14.9557], Tmin=(100,'K'), Tmax=(870.647,'K')), NASAPolynomial(coeffs=[11.0622,0.0102888,3.44173e-07,-3.67538e-10,3.11812e-14,6470.84,-31.2294], Tmin=(870.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.9945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxolane) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C1COO1(5977)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {2,S} {3,S}
2  O u0 p2 c0 {1,S} {4,S}
...
"""),
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26985,0.033292,-1.82969e-05,4.02489e-09,-1.2717e-13,19529.6,15.1975], Tmin=(100,'K'), Tmax=(1399.71,'K')), NASAPolynomial(coeffs=[9.19667,0.0183445,-7.4732e-06,1.34398e-09,-9.0266e-14,17115.7,-22.246], Tmin=(1399.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CJCOOH)"""),
)
...
"""),
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75287,0.0564151,-9.31736e-05,8.61959e-08,-3.07635e-11,20282,18.8283], Tmin=(100,'K'), Tmax=(852.244,'K')), NASAPolynomial(coeffs=[5.26343,0.0251106,-1.19779e-05,2.26575e-09,-1.54551e-13,20222.1,5.61237], Tmin=(852.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71932,0.0552397,-8.46307e-05,7.36655e-08,-2.5388e-11,21398.1,18.879], Tmin=(100,'K'), Tmax=(832.107,'K')), NASAPolynomial(coeffs=[6.68188,0.0228007,-1.06811e-05,2.02179e-09,-1.3869e-13,20869.3,-2.36478], Tmin=(832.107,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C=C(1339)'],
    products = ['C=CCO[O](7245)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(6.13324,'m^3/(mol*s)'), n=1.7252, Ea=(0.203342,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_N-Sp-5R!H-4R!H_Sp-4R!H-2C_N-4R!H-inRing',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_N-Sp-5R!H-4R!H_Sp-4R!H-2C_N-4R!H-inRing
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=CO[O](287)'],
    products = ['C=CCO[O](7245)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(148.66,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C=CC[O](350)'],
    products = ['C=CCO[O](7245)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=CCO[O](7245)'],
    products = ['HO2(11)', 'C=C=C(6745)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.63e+09,'s^-1'), n=1.11, Ea=(178.657,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 15 C3H5O2 <=> C3H4 + HO2 in HO2_Elimination_from_PeroxyRadical/training
...
reaction(
    label = 'reaction12',
    reactants = ['C=CCO[O](7245)'],
    products = ['C=[C]COO(7247)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(274,'s^-1'), n=3.09, Ea=(145.603,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 337 C3H5O2-3 <=> C3H5O2-4 in intra_H_migration/training
This reaction matched rate rule [R4H_SSS_OCs;O_rad_out;Cd_H_out_doubleC]
family: intra_H_migration"""),
)
