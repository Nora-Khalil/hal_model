...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.252426,'amu*angstrom^2'), symmetry=1, barrier=(5.80376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253569,'amu*angstrom^2'), symmetry=1, barrier=(5.83005,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89461,0.0498589,-6.58734e-05,5.32118e-08,-1.78998e-11,-15803.6,20.0976], Tmin=(100,'K'), Tmax=(779.446,'K')), NASAPolynomial(coeffs=[6.43752,0.0239663,-1.10815e-05,2.10278e-09,-1.45555e-13,-16433.5,-0.18484], Tmin=(779.446,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.001,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28491,0.0311665,3.22074e-06,-3.19e-08,1.74229e-11,-17519.4,16.3281], Tmin=(100,'K'), Tmax=(855.77,'K')), NASAPolynomial(coeffs=[10.1851,0.0143972,-2.71813e-06,2.51287e-10,-1.05503e-14,-19609.6,-24.868], Tmin=(855.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxolane) + radical(CsCsCsF1s)"""),
)

species(
    label = '[CH2]C1(F)COO1(1088)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {4,S}
3  O u0 p2 c0 {2,S} {5,S}
...
"""),
    ...
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89206,0.0401586,-2.79403e-05,8.55008e-09,-7.80983e-13,-9433.08,19.7848], Tmin=(100,'K'), Tmax=(1278.37,'K')), NASAPolynomial(coeffs=[11.5382,0.0160747,-6.83732e-06,1.27687e-09,-8.84434e-14,-12397.7,-31.0705], Tmin=(1278.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.1046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cs-Cs(F)-O2s-O2s) + radical(CJCOOH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00829,0.0529565,-9.83843e-05,9.61255e-08,-3.47319e-11,38552.4,18.6661], Tmin=(100,'K'), Tmax=(883.069,'K')), NASAPolynomial(coeffs=[3.68434,0.023439,-1.10018e-05,2.0401e-09,-1.36144e-13,39111.2,15.629], Tmin=(883.069,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(ROOJ) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-14.7058,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,271,519,563,612,1379,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,706.742],'cm^-1')),
        HinderedRotor(inertia=(0.0699435,'amu*angstrom^2'), symmetry=1, barrier=(1.60814,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.154003,'amu*angstrom^2'), symmetry=1, barrier=(3.54082,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8217,0.0527943,-8.1879e-05,7.11912e-08,-2.44158e-11,15259.3,20.9814], Tmin=(100,'K'), Tmax=(839.38,'K')), NASAPolynomial(coeffs=[6.63532,0.0212274,-1.00492e-05,1.89534e-09,-1.2945e-13,14755.1,0.411878], Tmin=(839.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70727,0.0544572,-6.96199e-05,5.08861e-08,-1.54121e-11,-3017.49,20.6442], Tmin=(100,'K'), Tmax=(797.44,'K')), NASAPolynomial(coeffs=[7.87552,0.0235163,-1.14183e-05,2.22813e-09,-1.5739e-13,-4001.23,-7.71776], Tmin=(797.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11834,0.0477805,-4.60669e-05,8.47174e-09,1.39515e-11,31047.9,20.3593], Tmin=(100,'K'), Tmax=(529.466,'K')), NASAPolynomial(coeffs=[6.33299,0.0259972,-1.28469e-05,2.51996e-09,-1.78229e-13,30460.6,1.37483], Tmin=(529.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(257.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sFO) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C(=C)F(1340)'],
    products = ['C=C(F)CO[O](9499)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C(F)CO[O](9499)'],
    products = ['F[C]1COOC1(9593)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]O[O](335)', 'CH2CF(70)'],
    products = ['C=C(F)CO[O](9499)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5.17579e+06,'m^3/(mol*s)'), n=0.00053286, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.2362166361863198e-10, var=0.783633349042906, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Sp-4R!H-2C_Ext-2C-R_5R!H->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Sp-4R!H-2C_Ext-2C-R_5R!H->C"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=C(F)[CH]O[O](9094)'],
    products = ['C=C(F)CO[O](9499)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]=C(F)CO[O](9085)'],
    products = ['C=C(F)CO[O](9499)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(43950,'m^3/(mol*s)'), n=1, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_N-3BrCFINOPSSi->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_N-3BrCFINOPSSi->C"""),
)
