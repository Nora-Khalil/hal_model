...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=C(F)OCO(2329)'],
    products = ['CC(O)OC(=O)F(3859)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)O[C](O)F(4048)'],
    products = ['CC(O)OC(=O)F(3859)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(O)O[C]=O(4049)'],
    products = ['CC(O)OC(=O)F(3859)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'C[CH]OC(=O)F(2503)'],
    products = ['CC(O)OC(=O)F(3859)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'CC([O])OC(=O)F(4050)'],
    products = ['CC(O)OC(=O)F(3859)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'O=C(F)O[CH]O(2481)'],
    products = ['CC(O)OC(=O)F(3859)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C[C](O)OC(=O)F(4051)'],
    products = ['CC(O)OC(=O)F(3859)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(O)OC(=O)F(4052)'],
    products = ['CC(O)OC(=O)F(3859)'],
