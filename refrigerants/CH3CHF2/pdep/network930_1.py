...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CO[C]=O(1243)'],
    products = ['CC([O])O[C]=O(2820)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'O=[C]OC=O(1263)'],
    products = ['CC([O])O[C]=O(2820)'],
