...
reaction(
    label = 'reaction2',
    reactants = ['O=C([CH][CH]F)OF(6226)'],
    products = ['[O]C(=O)C(F)[CH]F(6124)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[O]C([O])=CF(312)'],
    products = ['[O]C(=O)C(F)[CH]F(6124)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C(F)[CH]F(6210)'],
    products = ['[O]C(=O)C(F)[CH]F(6124)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C(F)=CF(4305)'],
    products = ['[O]C(=O)C(F)[CH]F(6124)'],
