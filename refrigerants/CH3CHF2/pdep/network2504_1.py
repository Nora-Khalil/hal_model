...
"""),
    E0 = (245.865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,379.332,379.402],'cm^-1')),
        HinderedRotor(inertia=(0.148601,'amu*angstrom^2'), symmetry=1, barrier=(15.1627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148452,'amu*angstrom^2'), symmetry=1, barrier=(15.1573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148292,'amu*angstrom^2'), symmetry=1, barrier=(15.1622,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8098,0.0386398,-8.29571e-06,-2.25201e-08,1.31144e-11,29658.2,19.4795], Tmin=(100,'K'), Tmax=(943.57,'K')), NASAPolynomial(coeffs=[13.697,0.0118972,-3.37913e-06,5.69383e-10,-4.11307e-14,26362.1,-42.7578], Tmin=(943.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(245.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COCJ) + radical(Cds_S)"""),
)
...
"""),
    E0 = (207.057,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2100,2250,500,550,244.456,244.486],'cm^-1')),
        HinderedRotor(inertia=(0.61841,'amu*angstrom^2'), symmetry=1, barrier=(26.2263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.618234,'amu*angstrom^2'), symmetry=1, barrier=(26.2264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.618522,'amu*angstrom^2'), symmetry=1, barrier=(26.2255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90261,0.035209,6.59727e-07,-3.5862e-08,1.94765e-11,24988.9,16.0502], Tmin=(100,'K'), Tmax=(910.137,'K')), NASAPolynomial(coeffs=[14.9985,0.00672256,-3.0088e-07,-6.52926e-11,4.18085e-15,21401.1,-52.5112], Tmin=(910.137,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CtHHH) + group(Cs-OsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (293.601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1670,1700,300,440,308.732,309.617],'cm^-1')),
        HinderedRotor(inertia=(0.162405,'amu*angstrom^2'), symmetry=1, barrier=(11.0347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162867,'amu*angstrom^2'), symmetry=1, barrier=(11.0402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162594,'amu*angstrom^2'), symmetry=1, barrier=(11.0405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84721,0.043113,-3.54102e-05,1.55809e-08,-2.78528e-12,35393.1,19.9906], Tmin=(100,'K'), Tmax=(1332.46,'K')), NASAPolynomial(coeffs=[10.3882,0.0174736,-6.54724e-06,1.14015e-09,-7.5894e-14,33116.9,-23.6663], Tmin=(1332.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C[C]=C[O](6464)'],
    products = ['[CH2]OC=[C]C(6335)'],
    transitionState = 'TS2',
