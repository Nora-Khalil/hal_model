...
"""),
    E0 = (-318.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,562.883],'cm^-1')),
        HinderedRotor(inertia=(0.169598,'amu*angstrom^2'), symmetry=1, barrier=(3.89939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0611438,'amu*angstrom^2'), symmetry=1, barrier=(13.4317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.584542,'amu*angstrom^2'), symmetry=1, barrier=(13.4398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.947797,0.0702314,-7.74984e-05,4.59216e-08,-1.11165e-11,-38210.5,24.0273], Tmin=(100,'K'), Tmax=(992.287,'K')), NASAPolynomial(coeffs=[11.5539,0.0274779,-1.28707e-05,2.50227e-09,-1.77504e-13,-40315.4,-27.0593], Tmin=(992.287,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-318.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63958,0.0558633,-4.87639e-05,2.38684e-08,-5.06701e-12,-79236.3,20.4349], Tmin=(100,'K'), Tmax=(1078.78,'K')), NASAPolynomial(coeffs=[8.22441,0.0314475,-1.48148e-05,2.88854e-09,-2.05072e-13,-80657,-11.8325], Tmin=(1078.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-659.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs)"""),
)
...
"""),
    E0 = (-443.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([249,341,381,651,928,1217,1251,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,191.627],'cm^-1')),
        HinderedRotor(inertia=(0.196442,'amu*angstrom^2'), symmetry=1, barrier=(5.11884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196441,'amu*angstrom^2'), symmetry=1, barrier=(5.11884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196441,'amu*angstrom^2'), symmetry=1, barrier=(5.11884,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.372422,0.0861719,-0.000132561,1.10371e-07,-3.64483e-11,-44655.9,25.698], Tmin=(100,'K'), Tmax=(817.708,'K')), NASAPolynomial(coeffs=[10.6465,0.028648,-1.37109e-05,2.60803e-09,-1.79379e-13,-46093.2,-20.3157], Tmin=(817.708,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-372.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = '[CH2]C(O)C([CH2])(F)F(3337)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-337.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,215,315,519,588,595,1205,1248,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180],'cm^-1')),
        HinderedRotor(inertia=(0.541054,'amu*angstrom^2'), symmetry=1, barrier=(14.0744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105813,'amu*angstrom^2'), symmetry=1, barrier=(2.43286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.093616,'amu*angstrom^2'), symmetry=1, barrier=(2.15242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227263,'amu*angstrom^2'), symmetry=1, barrier=(13.9863,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.524697,0.0806825,-0.00010758,7.59018e-08,-2.13964e-11,-40454.1,26.3718], Tmin=(100,'K'), Tmax=(866.694,'K')), NASAPolynomial(coeffs=[12.5077,0.0253786,-1.1865e-05,2.27761e-09,-1.59423e-13,-42531.2,-29.7247], Tmin=(866.694,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-337.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'C[C]([O])C(C)(F)F(3338)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u1 p2 c0 {7,S}
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.675365,0.0788943,-0.00011299,9.22991e-08,-3.07597e-11,-42465.8,22.7858], Tmin=(100,'K'), Tmax=(765.719,'K')), NASAPolynomial(coeffs=[9.2856,0.0314423,-1.51884e-05,2.93084e-09,-2.04486e-13,-43711.9,-15.9817], Tmin=(765.719,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.031,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C([O])C(C)(F)F(3339)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (-319.069,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,280.042,280.092],'cm^-1')),
        HinderedRotor(inertia=(0.00215191,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225284,'amu*angstrom^2'), symmetry=1, barrier=(12.5397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225457,'amu*angstrom^2'), symmetry=1, barrier=(12.5401,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.867797,0.0729243,-8.62565e-05,5.53411e-08,-1.44833e-11,-38265.8,23.3157], Tmin=(100,'K'), Tmax=(922.384,'K')), NASAPolynomial(coeffs=[11.219,0.0280351,-1.32563e-05,2.57886e-09,-1.82664e-13,-40175.4,-25.7865], Tmin=(922.384,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-319.069,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2][C](F)C(C)OF(3340)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (2.65437,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,3000,3100,440,815,1455,1000,301.149,2046.24],'cm^-1')),
        HinderedRotor(inertia=(0.147339,'amu*angstrom^2'), symmetry=1, barrier=(9.04056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138063,'amu*angstrom^2'), symmetry=1, barrier=(9.02496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144616,'amu*angstrom^2'), symmetry=1, barrier=(9.03905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.461927,'amu*angstrom^2'), symmetry=1, barrier=(31.5768,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.689957,0.0796113,-0.000119493,1.0275e-07,-3.56083e-11,431.893,27.3273], Tmin=(100,'K'), Tmax=(798.38,'K')), NASAPolynomial(coeffs=[8.24598,0.0332087,-1.62556e-05,3.13723e-09,-2.18167e-13,-502.266,-5.7191], Tmin=(798.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.65437,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(C)[O](3033)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]C(F)(F)C[O](3003)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[CH]C(3284)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'CC([O])[C](F)F(3333)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C](F)F(2970)', 'CH3CHO(36)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[CH2]C(F)(F)C=O(2971)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C(C)=O(3335)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C(C)[O](1836)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2CF2(57)', 'C[CH][O](468)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C](F)F(2970)', 'C[CH][O](468)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C(C)[O](440)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(O)C([CH2])(F)F(3337)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([O])C(C)(F)F(3339)'],
    products = ['[CH2]C(F)(F)C(C)[O](3033)'],
