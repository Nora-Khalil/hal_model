...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C]=C(3112)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C](F)F(3286)'],
    products = ['[CH2]C(F)(F)O[C]=C(3112)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC([CH2])(F)F(3287)'],
    products = ['[CH2]C(F)(F)O[C]=C(3112)'],
    transitionState = 'TS8',
