...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'F[C]C=CF(4009)'],
    products = ['[O]C(F)C=[C]F(3974)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'O=C(F)C=[C]F(4101)'],
    products = ['[O]C(F)C=[C]F(3974)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O]C=C=[C]F(4103)'],
    products = ['[O]C(F)C=[C]F(3974)'],
