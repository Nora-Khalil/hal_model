...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2927)', '[CH2]C[O](339)'],
    products = ['[CH2]CO[C](F)F(4680)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C](F)F(3131)'],
    products = ['[CH2]CO[C](F)F(4680)'],
    transitionState = 'TS3',
