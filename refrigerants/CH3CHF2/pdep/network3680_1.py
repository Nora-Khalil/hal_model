...
"""),
    E0 = (100.819,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,210.951,1324.34],'cm^-1')),
        HinderedRotor(inertia=(0.0156031,'amu*angstrom^2'), symmetry=1, barrier=(19.42,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39846,'amu*angstrom^2'), symmetry=1, barrier=(32.1534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844652,'amu*angstrom^2'), symmetry=1, barrier=(19.4202,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29621,0.0517048,-3.22505e-05,6.05636e-09,1.00212e-12,12229.6,22.343], Tmin=(100,'K'), Tmax=(1118.96,'K')), NASAPolynomial(coeffs=[12.6713,0.0227767,-9.20255e-06,1.69701e-09,-1.17912e-13,8949.26,-37.0965], Tmin=(1118.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-CdHH)(F1s)(H)) + radical(Allyl_P)"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.8737,0.0371815,-1.51157e-05,1.71613e-09,7.18106e-14,20029.6,18.1483], Tmin=(100,'K'), Tmax=(2283.8,'K')), NASAPolynomial(coeffs=[20.3296,0.0160414,-7.42667e-06,1.28024e-09,-7.84573e-14,9596.4,-85.8677], Tmin=(2283.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsHHH) + ring(Cs(C-F)-Cs-Cs) + radical(Tertalkyl) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86313,0.0361764,9.2351e-06,-3.41371e-08,1.43647e-11,25506.1,21.1827], Tmin=(100,'K'), Tmax=(1027.76,'K')), NASAPolynomial(coeffs=[11.2734,0.0244515,-9.99319e-06,1.90833e-09,-1.37328e-13,22256.7,-30.8718], Tmin=(1027.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cs(C)-Cs-Cs(F)) + radical(Neopentyl) + radical(Neopentyl)"""),
)
...
"""),
    E0 = (12.7387,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,280,518,736,852,873,3000,3100,440,815,1455,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,238.737],'cm^-1')),
        HinderedRotor(inertia=(0.66373,'amu*angstrom^2'), symmetry=1, barrier=(26.8179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662809,'amu*angstrom^2'), symmetry=1, barrier=(26.806,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41306,0.047285,-1.98409e-05,-1.03241e-08,7.74726e-12,1633.69,18.0396], Tmin=(100,'K'), Tmax=(1011.56,'K')), NASAPolynomial(coeffs=[13.9899,0.0181035,-7.04281e-06,1.32511e-09,-9.53457e-14,-1962.18,-47.9779], Tmin=(1011.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.7387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Allyl_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.42547,'amu*angstrom^2'), symmetry=1, barrier=(9.78238,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01967,'amu*angstrom^2'), symmetry=1, barrier=(23.4443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0355089,'amu*angstrom^2'), symmetry=1, barrier=(48.1813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08377,0.0556747,-4.3133e-05,1.71208e-08,-2.72639e-12,3184.15,20.8671], Tmin=(100,'K'), Tmax=(1494.28,'K')), NASAPolynomial(coeffs=[14.224,0.0204997,-7.82304e-06,1.36729e-09,-9.07392e-14,-742.866,-47.8046], Tmin=(1494.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.5429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
"""),
    E0 = (114.977,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,353.056,353.066,353.705,353.776],'cm^-1')),
        HinderedRotor(inertia=(0.577671,'amu*angstrom^2'), symmetry=1, barrier=(51.1838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.579094,'amu*angstrom^2'), symmetry=1, barrier=(51.1864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.57723,'amu*angstrom^2'), symmetry=1, barrier=(51.1912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4808,0.0461798,-1.50259e-05,-1.20162e-08,7.33021e-12,5895.71,19.9915], Tmin=(100,'K'), Tmax=(1044.44,'K')), NASAPolynomial(coeffs=[12.3965,0.0233201,-9.40369e-06,1.76224e-09,-1.24838e-13,2582.23,-38.0918], Tmin=(1044.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.1995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)C([CH2])F(6429)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(=C)C([CH2])F(6429)'],
    products = ['[CH2]C1([CH2])CC1F(10871)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(=C)C=C(10882)'],
    products = ['[CH2]C(=C)C([CH2])F(6429)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(=C)C(=C)F(10883)'],
    products = ['[CH2]C(=C)C([CH2])F(6429)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([CH2])=C(C)F(10884)'],
    products = ['[CH2]C(=C)C([CH2])F(6429)'],
