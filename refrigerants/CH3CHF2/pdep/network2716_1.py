...
"""),
    ...
    molecularWeight = (61.0168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.3724,0.00999027,6.34194e-06,-1.81789e-08,8.8198e-12,-123.706,12.1834], Tmin=(100,'K'), Tmax=(889.38,'K')), NASAPolynomial(coeffs=[7.15199,0.00344391,-2.45838e-07,-2.66361e-11,2.84551e-15,-1209.39,-7.93188], Tmin=(889.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.24639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + ring(dioxirane) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=[C]O(165)'],
    products = ['[O]C(=O)O(1596)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=O)O(1596)'],
    products = ['O[C]1OO1(6954)'],
    transitionState = 'TS2',
