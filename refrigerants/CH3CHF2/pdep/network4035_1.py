...
"""),
    E0 = (38.7599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.645758,'amu*angstrom^2'), symmetry=1, barrier=(14.8472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.643978,'amu*angstrom^2'), symmetry=1, barrier=(14.8063,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43689,0.0617064,-9.58874e-05,8.2681e-08,-2.82667e-11,4748.91,17.4827], Tmin=(100,'K'), Tmax=(815.944,'K')), NASAPolynomial(coeffs=[7.81291,0.0229877,-1.09912e-05,2.10898e-09,-1.45985e-13,3956.8,-10.4589], Tmin=(815.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.7599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCdH)(F1s)(H)) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-34.8556,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,194,682,905,1196,1383,3221,518.771,518.968,519.252,519.524],'cm^-1')),
        HinderedRotor(inertia=(0.272635,'amu*angstrom^2'), symmetry=1, barrier=(52.1642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272861,'amu*angstrom^2'), symmetry=1, barrier=(52.1683,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48382,0.0395379,-2.24072e-05,5.97214e-09,-6.57989e-13,-4144.21,17.8821], Tmin=(100,'K'), Tmax=(1831.86,'K')), NASAPolynomial(coeffs=[8.13922,0.027189,-1.22955e-05,2.29223e-09,-1.55784e-13,-6216.21,-12.8254], Tmin=(1831.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.8556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)

species(
    label = 'FCC1=CC(F)C1F(12035)',
...
"""),
    E0 = (-63.8645,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.898998,'amu*angstrom^2'), symmetry=1, barrier=(20.6697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.897044,'amu*angstrom^2'), symmetry=1, barrier=(20.6248,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03191,0.0617593,-6.06177e-05,3.03236e-08,-6.02637e-12,-7571.3,22.1568], Tmin=(100,'K'), Tmax=(1217.5,'K')), NASAPolynomial(coeffs=[14.0481,0.0189955,-7.93114e-06,1.47388e-09,-1.02379e-13,-10740.7,-43.2002], Tmin=(1217.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.8645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-234.035,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,280,518,736,852,873,194,682,905,1196,1383,3221,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.702559,'amu*angstrom^2'), symmetry=1, barrier=(16.1532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.704856,'amu*angstrom^2'), symmetry=1, barrier=(16.206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.94072,0.0720413,-8.59883e-05,5.45305e-08,-1.40994e-11,-28041.8,22.9864], Tmin=(100,'K'), Tmax=(931.746,'K')), NASAPolynomial(coeffs=[11.4225,0.0270445,-1.35519e-05,2.70418e-09,-1.94277e-13,-29995.1,-26.8418], Tmin=(931.746,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cds_P)"""),
)
...
reaction(
    ...
    products = ['CHFCHF[Z](59)', 'C#CCF(3587)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC(F)[CH]F(6248)'],
    products = ['[CH]=C(CF)C(F)[CH]F(8294)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.44768e+28,'m^3/(mol*s)'), n=-6.4458, Ea=(84.8761,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.6591608693425184, var=5.4995193120720405, Tref=1000.0, N=19, data_mean=0.0, correlation='CH',), comment="""Estimated from node CH"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C(F)[CH]F(6250)'],
    products = ['[CH]=C(CF)C(F)[CH]F(8294)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(150.497,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH]F(230)', '[CH]C(=CF)CF(11873)'],
    products = ['[CH]=C(CF)C(F)[CH]F(8294)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(C=CF)CF(11862)'],
    products = ['[CH]=C(CF)C(F)[CH]F(8294)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHFCHF[Z](59)', '[CH]=[C]CF(4166)'],
    products = ['[CH]=C(CF)C(F)[CH]F(8294)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(8.08706e-06,'m^3/(mol*s)'), n=3.0961, Ea=(2.01726,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]=C(CF)C(F)=CF(12036)'],
    products = ['[CH]=C(CF)C(F)[CH]F(8294)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH][CH]F(5595)', 'C#CCF(3587)'],
    products = ['[CH]=C(CF)C(F)[CH]F(8294)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(8.08706e-06,'m^3/(mol*s)'), n=3.0961, Ea=(11.0912,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', 'C#CC(F)[CH]F(6261)'],
    products = ['[CH]=C(CF)C(F)[CH]F(8294)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(19.4304,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction12',
    reactants = ['F[CH][CH]F(5595)', '[CH]=[C]CF(4166)'],
    products = ['[CH]=C(CF)C(F)[CH]F(8294)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH]C(=CF)CF(11873)'],
    products = ['[CH]=C(CF)C(F)[CH]F(8294)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(134.337,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(157.19,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction20',
    reactants = ['[CH]=C(CF)C(F)[CH]F(8294)'],
    products = ['[CH]C(=C)C(F)C(F)F(8293)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.000550858,'s^-1'), n=4.50663, Ea=(189.757,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R"""),
)

network(
    label = 'PDepNetwork #4035',
    isomers = [
        '[CH]=C(CF)C(F)[CH]F(8294)',
    ],
    reactants = [
        ('CHFCHF[Z](59)', 'C#CCF(3587)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
