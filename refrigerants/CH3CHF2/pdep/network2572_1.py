...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.68748,'amu*angstrom^2'), symmetry=1, barrier=(15.8065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.686729,'amu*angstrom^2'), symmetry=1, barrier=(15.7893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.686597,'amu*angstrom^2'), symmetry=1, barrier=(15.7862,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19021,0.0593899,-5.07987e-05,2.36545e-08,-4.53553e-12,60869.8,21.3638], Tmin=(100,'K'), Tmax=(1234.15,'K')), NASAPolynomial(coeffs=[11.4107,0.0262639,-1.05365e-05,1.90531e-09,-1.29772e-13,58347.1,-30.0941], Tmin=(1234.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.819742,'amu*angstrom^2'), symmetry=1, barrier=(18.8475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.82485,'amu*angstrom^2'), symmetry=1, barrier=(18.9649,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87404,0.0412734,-2.6886e-05,5.33491e-09,1.04566e-12,65369.1,18.3088], Tmin=(100,'K'), Tmax=(1040.74,'K')), NASAPolynomial(coeffs=[10.5328,0.017583,-6.56181e-06,1.16866e-09,-8.01112e-14,63047.4,-26.3056], Tmin=(1040.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(542.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'CC1=CC(C)=C1(6712)',
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47744,0.0452975,-6.47799e-06,-2.29705e-08,1.17731e-11,41995.8,15.633], Tmin=(100,'K'), Tmax=(999.664,'K')), NASAPolynomial(coeffs=[12.4994,0.0240987,-9.03598e-06,1.65445e-09,-1.16866e-13,38647.7,-43.2617], Tmin=(999.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(cyclobutadiene_13)"""),
)

species(
    label = 'C=C=CC(=C)C(6401)',
...
"""),
    E0 = (435.166,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,2100,2250,500,550,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.560832,'amu*angstrom^2'), symmetry=1, barrier=(12.8946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.495797,'amu*angstrom^2'), symmetry=1, barrier=(11.3993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.00942,'amu*angstrom^2'), symmetry=1, barrier=(69.1924,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52659,0.0484564,-3.47208e-05,1.38171e-08,-2.28536e-12,52432.4,21.1683], Tmin=(100,'K'), Tmax=(1414.72,'K')), NASAPolynomial(coeffs=[10.3216,0.023589,-8.35432e-06,1.39221e-09,-8.97108e-14,49943.9,-24.3139], Tmin=(1414.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-CtHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(C)C=C[CH2](6715)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {7,S} {8,S} {9,S}
2  C u0 p0 c0 {1,S} {3,S} {6,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.9879,'amu*angstrom^2'), symmetry=1, barrier=(68.6978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.900825,'amu*angstrom^2'), symmetry=1, barrier=(20.7117,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.900431,'amu*angstrom^2'), symmetry=1, barrier=(20.7027,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38098,0.0473381,-7.90566e-06,-2.47052e-08,1.34149e-11,46463.3,21.7629], Tmin=(100,'K'), Tmax=(965.181,'K')), NASAPolynomial(coeffs=[13.0886,0.0230977,-7.96637e-06,1.39956e-09,-9.74562e-14,43072.4,-40.1632], Tmin=(965.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(385.457,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CC=CCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(C)=C=CC(6716)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56254,0.0550059,-3.29444e-05,1.01383e-08,-1.33993e-12,53282.9,20.4329], Tmin=(100,'K'), Tmax=(1595.34,'K')), NASAPolynomial(coeffs=[9.02746,0.0362891,-1.53462e-05,2.78435e-09,-1.87515e-13,50901.1,-19.0679], Tmin=(1595.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2706,0.0549195,-4.79195e-05,2.6016e-08,-5.7212e-12,49979.3,24.9852], Tmin=(100,'K'), Tmax=(1257.64,'K')), NASAPolynomial(coeffs=[8.57627,0.0262134,-7.1572e-06,9.49644e-10,-5.0895e-14,48574.3,-10.2153], Tmin=(1257.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Tert_Propargyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH]C(=C)C=CC(6719)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {7,S} {8,S} {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)C=[C]C(6399)'],
    products = ['C#CC(5603)', 'C#CC(5603)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC=[C]C(6339)'],
    products = ['[CH]=C(C)C=[C]C(6399)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', '[CH]=C(C)C=C=C(6713)'],
    products = ['[CH]=C(C)C=[C]C(6399)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(19)', 'C#CC=[C]C(6458)'],
    products = ['[CH]=C(C)C=[C]C(6399)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]C(5604)', '[CH]=[C]C(5604)'],
    products = ['[CH]=C(C)C=[C]C(6399)'],
    transitionState = 'TS9',
