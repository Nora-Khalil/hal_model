...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.14897,'amu*angstrom^2'), symmetry=1, barrier=(3.42511,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.46142,0.0265335,-1.06561e-05,8.41291e-10,9.8016e-14,28576.8,13.0505], Tmin=(100,'K'), Tmax=(2725.98,'K')), NASAPolynomial(coeffs=[39.6639,-0.0106202,1.80875e-06,-2.55698e-10,1.96559e-14,3996.7,-201.965], Tmin=(2725.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C#CC([O])O(6732)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (151.946,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2100,2250,500,550,241.189,2140.1],'cm^-1')),
        HinderedRotor(inertia=(1.25795,'amu*angstrom^2'), symmetry=1, barrier=(51.9377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00291408,'amu*angstrom^2'), symmetry=1, barrier=(9.47078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25749,'amu*angstrom^2'), symmetry=1, barrier=(51.9392,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95509,0.0499132,-7.18606e-05,6.32418e-08,-2.22598e-11,18343.8,23.3228], Tmin=(100,'K'), Tmax=(843.515,'K')), NASAPolynomial(coeffs=[5.01442,0.0257623,-1.17649e-05,2.19224e-09,-1.49051e-13,18170.8,11.1175], Tmin=(843.515,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCOJ) + radical(Propargyl)"""),
)

species(
    label = '[CH2]C=[C]C(=O)O(6733)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.285737,'amu*angstrom^2'), symmetry=1, barrier=(6.56967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.285379,'amu*angstrom^2'), symmetry=1, barrier=(6.56144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000577807,'amu*angstrom^2'), symmetry=1, barrier=(6.56045,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.56348,0.0353168,-4.0184e-05,2.58984e-08,-7.08181e-12,8689.53,18.131], Tmin=(100,'K'), Tmax=(866.133,'K')), NASAPolynomial(coeffs=[6.47429,0.0172561,-8.90642e-06,1.82434e-09,-1.33215e-13,8012.06,-0.174443], Tmin=(866.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.8452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + radical(Allyl_P) + radical(C=CJC=O)"""),
)

species(
    label = '[CH]=C[CH]C(=O)O(6734)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (5.18769,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,413.774,413.786,413.788,413.794,413.819],'cm^-1')),
        HinderedRotor(inertia=(0.000984608,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.359698,'amu*angstrom^2'), symmetry=1, barrier=(43.7024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.35968,'amu*angstrom^2'), symmetry=1, barrier=(43.7024,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80017,0.0386097,-1.0081e-05,-1.33468e-08,6.68755e-12,711.278,18.4834], Tmin=(100,'K'), Tmax=(1136.57,'K')), NASAPolynomial(coeffs=[13.5832,0.0175354,-9.18374e-06,1.91475e-09,-1.42059e-13,-3284.44,-45.6664], Tmin=(1136.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.18769,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.411894,'amu*angstrom^2'), symmetry=1, barrier=(9.47026,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.412065,'amu*angstrom^2'), symmetry=1, barrier=(9.47419,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40732,0.0592546,-8.44908e-05,6.36931e-08,-1.88481e-11,17695.1,24.5089], Tmin=(100,'K'), Tmax=(877.173,'K')), NASAPolynomial(coeffs=[10.2761,0.0162525,-6.57847e-06,1.15185e-09,-7.53803e-14,16237.7,-16.5544], Tmin=(877.173,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cs_P) + radical(C=C=CJ)"""),
)

species(
    label = 'C=C=C=C(O)O(6738)',
    structure = adjacencyList("""1  O u0 p2 c0 {3,S} {10,S}
2  O u0 p2 c0 {3,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17023,'amu*angstrom^2'), symmetry=1, barrier=(26.9059,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.518301,0.068197,-8.56086e-05,5.00437e-08,-1.09031e-11,-4993.7,18.5241], Tmin=(100,'K'), Tmax=(1248.52,'K')), NASAPolynomial(coeffs=[18.7793,0.00305637,6.25713e-07,-2.59663e-10,2.19993e-14,-9036.32,-71.5566], Tmin=(1248.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.6227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (26.0142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,2100,2250,500,550,180,180,924.263,924.479,924.548],'cm^-1')),
        HinderedRotor(inertia=(0.0968196,'amu*angstrom^2'), symmetry=1, barrier=(2.22607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0970027,'amu*angstrom^2'), symmetry=1, barrier=(2.23028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0969383,'amu*angstrom^2'), symmetry=1, barrier=(2.2288,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0653,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17065,0.0442971,-6.39075e-05,5.5327e-08,-1.91953e-11,3190.74,20.7677], Tmin=(100,'K'), Tmax=(839.162,'K')), NASAPolynomial(coeffs=[5.41264,0.0214375,-9.80767e-06,1.83062e-09,-1.24645e-13,2907.4,7.24919], Tmin=(839.162,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.0142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CtHHH) + group(Cds-O2d(Cds-Cds)O2s) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Propargyl)"""),
)
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3078,0.0414363,-3.40505e-05,1.76967e-08,-4.44493e-12,7792.28,29.0176], Tmin=(100,'K'), Tmax=(873.722,'K')), NASAPolynomial(coeffs=[4.77841,0.0301257,-1.46325e-05,2.88049e-09,-2.05553e-13,7360.55,17.4319], Tmin=(873.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.3119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C=CC(=O)O(6743)',
    structure = adjacencyList("""1  O u0 p2 c0 {4,S} {10,S}
2  O u0 p2 c0 {4,D}
...
"""),
    E0 = (127.485,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,4000,4000,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.000683852,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000683852,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000683852,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3982,0.0430755,-8.05331e-05,8.35597e-08,-3.25895e-11,15382.9,17.862], Tmin=(100,'K'), Tmax=(828.336,'K')), NASAPolynomial(coeffs=[2.69669,0.0235709,-1.25031e-05,2.48168e-09,-1.74029e-13,15953.2,20.2188], Tmin=(828.336,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C#CC(=O)O(6740)'],
    products = ['C=C=CC(=O)O(6330)'],
