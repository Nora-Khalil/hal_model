...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(=[CH])C(6335)'],
    products = ['[CH]=C(C)C(=[CH])C(6395)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(19)', '[CH]=C(C)C#C(6453)'],
    products = ['[CH]=C(C)C(=[CH])C(6395)'],
    transitionState = 'TS4',
