...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=C(C)C[O](6329)'],
    products = ['[CH]=C(C)C(C)[O](6762)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=CC(C)[O](2972)'],
    products = ['[CH]=C(C)C(C)[O](6762)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]=C(C)C(C)=O(6809)'],
    products = ['[CH]=C(C)C(C)[O](6762)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'C#CC(C)[O](3007)'],
    products = ['[CH]=C(C)C(C)[O](6762)'],
