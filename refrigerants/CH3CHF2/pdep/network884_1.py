...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=C(O)CF(1514)'],
    products = ['O=C(O)C(=O)CF(2635)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(O)C(=O)[C]F(2792)'],
    products = ['O=C(O)C(=O)CF(2635)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(=O)C(=O)O(2704)'],
    products = ['O=C(O)C(=O)CF(2635)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'O=[C]C(=O)CF(2802)'],
    products = ['O=C(O)C(=O)CF(2635)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(=O)CF(2803)'],
    products = ['O=C(O)C(=O)CF(2635)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(46)', 'O=[C]C(=O)O(2804)'],
    products = ['O=C(O)C(=O)CF(2635)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)C(=O)[CH]F(2280)'],
    products = ['O=C(O)C(=O)CF(2635)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(165)', 'O=[C]CF(203)'],
    products = ['O=C(O)C(=O)CF(2635)'],
