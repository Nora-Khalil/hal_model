...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17741,0.0536271,-5.01156e-05,2.24474e-08,-3.90115e-12,-39265.8,21.6368], Tmin=(100,'K'), Tmax=(1404.21,'K')), NASAPolynomial(coeffs=[16.1065,0.0111007,-4.68858e-06,8.8049e-10,-6.14978e-14,-43458.5,-55.4557], Tmin=(1404.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-327.378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCddFH) + group(Cds-OdOsH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (-34.1926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,1855,455,950,239,401,1367,383.522,383.56,383.571],'cm^-1')),
        HinderedRotor(inertia=(8.51586e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0958812,'amu*angstrom^2'), symmetry=1, barrier=(10.0093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.626422,'amu*angstrom^2'), symmetry=1, barrier=(65.398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88238,0.0489314,-6.06308e-05,4.125e-08,-1.1384e-11,-4038.24,21.8101], Tmin=(100,'K'), Tmax=(880.094,'K')), NASAPolynomial(coeffs=[8.64652,0.0181876,-8.2304e-06,1.55565e-09,-1.08046e-13,-5228.81,-9.95877], Tmin=(880.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.1926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CtOsHH) + group(Cds-OdOsH) + group(Ct-CtCs) + group(CtCF) + radical((O)CJOCC)"""),
)

species(
    label = 'O=[C]O[CH]C=CF(10660)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-42.0501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,167,640,1190,1855,455,950,276.786,277.05,2516.59],'cm^-1')),
        HinderedRotor(inertia=(0.00221541,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302952,'amu*angstrom^2'), symmetry=1, barrier=(16.5007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.500684,'amu*angstrom^2'), symmetry=1, barrier=(27.1931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79867,0.0500395,-5.25014e-05,2.9345e-08,-6.70454e-12,-4979.51,23.5161], Tmin=(100,'K'), Tmax=(1047.54,'K')), NASAPolynomial(coeffs=[9.72011,0.0197917,-9.18881e-06,1.78036e-09,-1.2612e-13,-6639.12,-15.0682], Tmin=(1047.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.0501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-OdOsH) + radical(Cdj(Cd-CsH)(F1s)) + radical((O)CJOCC)"""),
)

species(
    label = 'O=COC=[C][CH]F(10662)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {6,D}
...
"""),
    E0 = (11.6524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1685,370,167,640,1190,398.016,400.942,401.554],'cm^-1')),
        HinderedRotor(inertia=(0.00102761,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00105165,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0010405,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20538,0.0381786,-2.40811e-05,6.92739e-09,-7.87494e-13,1466.63,24.6796], Tmin=(100,'K'), Tmax=(1986.85,'K')), NASAPolynomial(coeffs=[12.9762,0.0164946,-7.71065e-06,1.4345e-09,-9.63439e-14,-2813.41,-34.6782], Tmin=(1986.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.6524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-OdOsH) + radical(Cdj(Cs-O2sHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=C(F)CO[C]=O(10664)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68646,0.0526714,-5.76915e-05,3.3306e-08,-7.80093e-12,-6005.72,23.2962], Tmin=(100,'K'), Tmax=(1027.13,'K')), NASAPolynomial(coeffs=[10.2288,0.0194046,-9.10922e-06,1.77316e-09,-1.25931e-13,-7760.53,-18.1441], Tmin=(1027.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.6151,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cdj(Cd-CsF1s)(H)) + radical((O)CJOCC)"""),
)

species(
    label = '[CH]=[C]COC(=O)F(10665)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {5,D}
...
"""),
    E0 = (-35.7238,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,482,664,788,1296,1923,1685,370,3120,650,792.5,1650,333.322,341.62,3591.45],'cm^-1')),
        HinderedRotor(inertia=(0.133305,'amu*angstrom^2'), symmetry=1, barrier=(10.5569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433856,'amu*angstrom^2'), symmetry=1, barrier=(36.0017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444245,'amu*angstrom^2'), symmetry=1, barrier=(36.0054,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9062,0.0500783,-5.47495e-05,3.37279e-08,-8.78325e-12,-4224.59,23.7228], Tmin=(100,'K'), Tmax=(910.13,'K')), NASAPolynomial(coeffs=[7.81632,0.0241036,-1.19404e-05,2.37053e-09,-1.69837e-13,-5300.39,-4.23354], Tmin=(910.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.7238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(COFOO) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[O]C[C]=CF(4225)'],
    products = ['O=[C]OC[C]=CF(10144)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1084)', '[CH2]O[C]=O(292)'],
    products = ['O=[C]OC[C]=CF(10144)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C[C]=CF(4225)'],
    products = ['O=[C]OC[C]=CF(10144)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(11.1937,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)
...
reaction(
    ...
    products = ['O=[C]OC[C]=CF(10144)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(168.576,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]OCC#CF(10659)'],
    products = ['O=[C]OC[C]=CF(10144)'],
