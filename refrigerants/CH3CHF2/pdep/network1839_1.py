...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'FOC=C(F)F(4346)'],
    products = ['OC(F)(F)COF(4748)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]CC(O)(F)F(5033)'],
    products = ['OC(F)(F)COF(4748)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(126)', '[CH2]C(O)(F)F(1116)'],
    products = ['OC(F)(F)COF(4748)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)COF(5034)'],
    products = ['OC(F)(F)COF(4748)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(4619)', '[CH2]OF(186)'],
    products = ['OC(F)(F)COF(4748)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]OF(4939)'],
    products = ['OC(F)(F)COF(4748)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)COF(5035)'],
    products = ['OC(F)(F)COF(4748)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CC(O)(F)F(4864)'],
    products = ['OC(F)(F)COF(4748)'],
