...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(4701)', '[CH]F(230)'],
    products = ['[O]C(F)(F)O[CH]F(4757)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[CH]F(873)'],
    products = ['[O]C(F)(F)O[CH]F(4757)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(4701)', 'CHF(40)'],
    products = ['[O]C(F)(F)O[CH]F(4757)'],
    transitionState = 'TS9',
