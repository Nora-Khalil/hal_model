...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.15048,'amu*angstrom^2'), symmetry=1, barrier=(3.45982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.756074,'amu*angstrom^2'), symmetry=1, barrier=(17.3836,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97173,0.0480943,-4.05006e-05,1.80047e-08,-3.41286e-12,-15033.6,23.5426], Tmin=(100,'K'), Tmax=(1198.85,'K')), NASAPolynomial(coeffs=[8.65406,0.0257986,-1.26044e-05,2.49198e-09,-1.77961e-13,-16635.9,-9.90775], Tmin=(1198.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(O2sj(Cs-F1sCdH)) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)
...
"""),
    E0 = (-198.599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,412,602,673,1051,1091,1200,1282,319,1023,1071,1259,1317,1409,3054,3019,2100,2250,500,550,180,2933.37],'cm^-1')),
        HinderedRotor(inertia=(3.19977,'amu*angstrom^2'), symmetry=1, barrier=(73.5689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.651319,'amu*angstrom^2'), symmetry=1, barrier=(73.5078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88417,0.0480659,-5.02085e-05,3.05675e-08,-7.77814e-12,-23811.1,21.6958], Tmin=(100,'K'), Tmax=(940.57,'K')), NASAPolynomial(coeffs=[7.8785,0.0225745,-9.55679e-06,1.75501e-09,-1.20168e-13,-24938.7,-6.85635], Tmin=(940.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-198.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(O2sj(Cs-F1sCtH))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6326,0.0479724,-4.91961e-05,2.49125e-08,-4.92767e-12,17132.9,19.9159], Tmin=(100,'K'), Tmax=(1235.4,'K')), NASAPolynomial(coeffs=[12.9714,0.0112592,-4.6195e-06,8.57266e-10,-5.97484e-14,14331.3,-37.1843], Tmin=(1235.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(C=COJ) + radical(Cds_S)"""),
)

species(
    label = 'OC(F)=C[C]CF(11968)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.943745,0.065201,-7.30629e-05,4.07494e-08,-8.90814e-12,-18066.2,23.1626], Tmin=(100,'K'), Tmax=(1118.53,'K')), NASAPolynomial(coeffs=[14.7429,0.0158528,-6.88371e-06,1.30464e-09,-9.18051e-14,-21153.1,-44.9559], Tmin=(1118.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-151.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCFO) + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (-125.88,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,361,769,965,1078,1132,1246,3247,3010,987.5,1337.5,450,1655,1685,370,228.795,229.28,231.339],'cm^-1')),
        HinderedRotor(inertia=(0.165704,'amu*angstrom^2'), symmetry=1, barrier=(6.16662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309867,'amu*angstrom^2'), symmetry=1, barrier=(11.5146,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65388,0.0565965,-6.9219e-05,5.10559e-08,-1.61163e-11,-15059.9,23.2451], Tmin=(100,'K'), Tmax=(756.911,'K')), NASAPolynomial(coeffs=[6.8764,0.0289978,-1.45264e-05,2.88492e-09,-2.06115e-13,-15850.5,-0.496064], Tmin=(756.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(O2sj(Cs-F1sCdH)) + radical(Cds_S)"""),
)

species(
    label = 'OC(F)[C]=[C]CF(11970)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {11,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.351736,'amu*angstrom^2'), symmetry=1, barrier=(8.08709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.351658,'amu*angstrom^2'), symmetry=1, barrier=(8.08531,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7976,0.0566172,-5.71867e-05,8.29675e-09,2.12224e-11,-13754.6,23.8863], Tmin=(100,'K'), Tmax=(514.956,'K')), NASAPolynomial(coeffs=[7.05002,0.0289445,-1.48153e-05,2.94219e-09,-2.09122e-13,-14469.6,0.342431], Tmin=(514.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = '[O]C(F)=C[CH]CF(11971)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
3  O u1 p2 c0 {7,S}
...
"""),
    E0 = (131.408,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,122,584,932,1043,1247,1392,1461,2986,3039,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,1685,370,779.289,1608.15],'cm^-1')),
        HinderedRotor(inertia=(0.50625,'amu*angstrom^2'), symmetry=1, barrier=(25.9096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.504936,'amu*angstrom^2'), symmetry=1, barrier=(25.9088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.505169,'amu*angstrom^2'), symmetry=1, barrier=(25.9087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3185,0.0512177,-4.11178e-05,1.58567e-08,-2.41e-12,15907.7,26.709], Tmin=(100,'K'), Tmax=(1569.8,'K')), NASAPolynomial(coeffs=[15.4188,0.0152889,-6.78651e-06,1.27679e-09,-8.80662e-14,11480.7,-47.6753], Tmin=(1569.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJO) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = '[O]C=C[C](F)CF(11973)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'F[CH]C=[C]CF(11877)'],
    products = ['[O]C(F)C=[C]CF(11814)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)C=[C]CF(11965)'],
    products = ['[O]C(F)C=[C]CF(11814)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)C#CCF(11966)'],
    products = ['[O]C(F)C=[C]CF(11814)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C=C=[C]CF(11967)'],
    products = ['[O]C(F)C=[C]CF(11814)'],
