...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04059,0.0557182,-5.23039e-05,2.57875e-08,-4.94302e-12,24383,23.7457], Tmin=(100,'K'), Tmax=(1391.45,'K')), NASAPolynomial(coeffs=[13.7993,0.0149772,-4.00422e-06,5.47593e-10,-3.11308e-14,21225.8,-40.6091], Tmin=(1391.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C(C)OJ) + radical(C=C=CJ)"""),
)
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48854,0.0415924,1.17477e-05,-4.93348e-08,2.32732e-11,38576.6,18.158], Tmin=(100,'K'), Tmax=(945.48,'K')), NASAPolynomial(coeffs=[14.9064,0.018749,-5.83022e-06,1.00775e-09,-7.23035e-14,34523.1,-53.8416], Tmin=(945.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + ring(methyleneoxirane) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'CC1=C([O])C[CH]1(6507)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1213,0.0260434,3.93792e-05,-7.2818e-08,3.06589e-11,23318.4,17.2517], Tmin=(100,'K'), Tmax=(947.375,'K')), NASAPolynomial(coeffs=[13.7743,0.0152623,-4.3819e-06,7.83312e-10,-5.97144e-14,19386.3,-47.4366], Tmin=(947.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + ring(Cyclobutene) + radical(C=C(C)OJ) + radical(cyclobutene-allyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.709256,'amu*angstrom^2'), symmetry=1, barrier=(16.3072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08412,'amu*angstrom^2'), symmetry=1, barrier=(24.9261,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.588342,0.0622391,-6.27345e-05,3.16933e-08,-6.05956e-12,31912.3,23.2801], Tmin=(100,'K'), Tmax=(1454.64,'K')), NASAPolynomial(coeffs=[16.323,0.0111508,-1.98846e-06,1.57182e-10,-4.43035e-15,28162,-55.6834], Tmin=(1454.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C(O)CJ) + radical(C=C=CJ)"""),
)
...
"""),
    E0 = (267.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2120,512.5,787.5,397.905,403.793,405.824],'cm^-1')),
        HinderedRotor(inertia=(0.466414,'amu*angstrom^2'), symmetry=1, barrier=(52.0313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.441442,'amu*angstrom^2'), symmetry=1, barrier=(52.1859,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.60797,0.0336788,-1.93865e-05,5.97209e-09,-8.55156e-13,32210,15.5845], Tmin=(100,'K'), Tmax=(1346.14,'K')), NASAPolynomial(coeffs=[4.92927,0.0267811,-1.17004e-05,2.16562e-09,-1.4823e-13,31585.1,3.69561], Tmin=(1346.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + missing(Cdd-CdO2d) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', '[CH]C(C)=C=O(6514)'],
    products = ['[CH]=C(C)C(=C)[O](6343)'],
