...
"""),
    ...
    molecularWeight = (90.0962,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11857,0.0459462,1.03826e-05,-5.71126e-08,2.79947e-11,-49338.2,19.1961], Tmin=(100,'K'), Tmax=(946.372,'K')), NASAPolynomial(coeffs=[19.8064,0.0104646,-2.33564e-06,4.22748e-10,-3.64674e-14,-54823.6,-80.2251], Tmin=(946.372,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-411.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.15203,'amu*angstrom^2'), symmetry=1, barrier=(26.4875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15083,'amu*angstrom^2'), symmetry=1, barrier=(26.4598,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (89.0882,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.99875,0.0517499,-1.43651e-05,-3.02649e-08,1.84622e-11,-23754.9,21.3235], Tmin=(100,'K'), Tmax=(946.36,'K')), NASAPolynomial(coeffs=[19.5647,0.0085667,-1.85357e-06,3.24845e-10,-2.78437e-14,-28849.1,-75.5719], Tmin=(946.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-198.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'C[CH]O[C](C)F(1791)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0978928,'amu*angstrom^2'), symmetry=1, barrier=(2.25075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0984017,'amu*angstrom^2'), symmetry=1, barrier=(2.26245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0987963,'amu*angstrom^2'), symmetry=1, barrier=(2.27152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.836603,'amu*angstrom^2'), symmetry=1, barrier=(19.2351,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0962,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76494,0.0577155,-4.34251e-05,-1.83391e-08,3.90479e-11,-10976,22.1075], Tmin=(100,'K'), Tmax=(502.396,'K')), NASAPolynomial(coeffs=[6.54296,0.0341637,-1.637e-05,3.16864e-09,-2.22329e-13,-11638.9,0.525363], Tmin=(502.396,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH2][CH]OC(C)F(1794)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {3,S} {5,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {7,S}
...
"""),
    E0 = (-107.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,180,831.925],'cm^-1')),
        HinderedRotor(inertia=(0.210033,'amu*angstrom^2'), symmetry=1, barrier=(4.82907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.768387,'amu*angstrom^2'), symmetry=1, barrier=(17.6667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.768341,'amu*angstrom^2'), symmetry=1, barrier=(17.6657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0359541,'amu*angstrom^2'), symmetry=1, barrier=(17.6663,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0962,'amu'),
...
"""),
    E0 = (-101.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,551,1088,1226,1380,1420,1481,3057,3119,3000,3050,390,425,1340,1360,335,370,320.007,320.037,320.173,320.238],'cm^-1')),
        HinderedRotor(inertia=(0.18759,'amu*angstrom^2'), symmetry=1, barrier=(13.6278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187567,'amu*angstrom^2'), symmetry=1, barrier=(13.6285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187499,'amu*angstrom^2'), symmetry=1, barrier=(13.6268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187454,'amu*angstrom^2'), symmetry=1, barrier=(13.6279,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0962,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])F(141)', '[CH]C-2(611)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[CH]F(1787)'],
    products = ['[CH2]C(F)O[CH]C(1704)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)O[CH]C(1790)'],
    products = ['[CH2]C(F)O[CH]C(1704)'],
