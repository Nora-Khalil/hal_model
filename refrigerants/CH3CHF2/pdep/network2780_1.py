...
"""),
    E0 = (43.0062,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1277.5,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(1.82244,'amu*angstrom^2'), symmetry=1, barrier=(41.9016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0124815,'amu*angstrom^2'), symmetry=1, barrier=(7.00115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.708717,'amu*angstrom^2'), symmetry=1, barrier=(16.2948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.23064,'amu*angstrom^2'), symmetry=1, barrier=(51.2869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70867,0.0525565,-6.72452e-05,4.48148e-08,-1.18964e-11,5253.12,18.6335], Tmin=(100,'K'), Tmax=(919.691,'K')), NASAPolynomial(coeffs=[10.1495,0.0158458,-7.37213e-06,1.41505e-09,-9.92984e-14,3700.49,-21.3823], Tmin=(919.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.0062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCJO) + radical(CsJOOC)"""),
)
...
"""),
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61752,0.0293608,-1.72906e-05,4.78393e-09,-5.28722e-13,-25921.6,13.2054], Tmin=(100,'K'), Tmax=(2016.23,'K')), NASAPolynomial(coeffs=[10.1472,0.014423,-6.17775e-06,1.10956e-09,-7.31337e-14,-28958,-28.4013], Tmin=(2016.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(12dioxetane)"""),
)
...
"""),
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.54278,0.0190397,3.43457e-05,-5.84286e-08,2.32214e-11,-45327.6,16.7751], Tmin=(100,'K'), Tmax=(989.94,'K')), NASAPolynomial(coeffs=[11.9226,0.0132263,-5.46566e-06,1.12491e-09,-8.71426e-14,-48757,-36.3236], Tmin=(989.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-377.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-OsHHH) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (-183.811,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000],'cm^-1')),
        HinderedRotor(inertia=(1.96245,'amu*angstrom^2'), symmetry=1, barrier=(45.1207,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49867,0.0192798,3.2612e-05,-5.95294e-08,2.45162e-11,-22041,16.6292], Tmin=(100,'K'), Tmax=(975.863,'K')), NASAPolynomial(coeffs=[13.3608,0.0087269,-3.383e-06,7.3251e-10,-6.03568e-14,-25778.5,-43.7967], Tmin=(975.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.811,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-OsHHH) + group(Cds-OdOsH) + radical(CsJOOC)"""),
)

species(
    label = '[CH2]OOC[O](7174)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {2,S} {4,S}
2 O u0 p2 c0 {1,S} {5,S}
3 O u1 p2 c0 {4,S}
...
"""),
    E0 = (81.444,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,474.656],'cm^-1')),
        HinderedRotor(inertia=(1.71504,'amu*angstrom^2'), symmetry=1, barrier=(39.4321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0797731,'amu*angstrom^2'), symmetry=1, barrier=(39.4284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.07974,'amu*angstrom^2'), symmetry=1, barrier=(39.4339,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05724,0.0362889,-2.08778e-05,1.90944e-09,1.3256e-12,9870.73,18.0692], Tmin=(100,'K'), Tmax=(1182.34,'K')), NASAPolynomial(coeffs=[11.2834,0.0152326,-7.04999e-06,1.3783e-09,-9.84028e-14,6979.12,-30.989], Tmin=(1182.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCOJ) + radical(CsJOOC)"""),
)
...
"""),
    E0 = (76.8073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1660.49],'cm^-1')),
        HinderedRotor(inertia=(0.0051957,'amu*angstrom^2'), symmetry=1, barrier=(10.1902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78943,'amu*angstrom^2'), symmetry=1, barrier=(41.1426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78915,'amu*angstrom^2'), symmetry=1, barrier=(41.1361,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.7703,0.0233068,-8.80267e-06,2.11067e-10,1.78323e-13,9168.66,8.18824], Tmin=(100,'K'), Tmax=(2704.89,'K')), NASAPolynomial(coeffs=[40.3423,-0.013108,2.41346e-06,-3.40621e-10,2.48012e-14,-15997.3,-209.77], Tmin=(2704.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.8073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]O(237)', '[CH2]O[O](335)'],
    products = ['[CH2]OO[CH]O(7116)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]O[CH]O(780)'],
    products = ['[CH2]OO[CH]O(7116)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH2]OO[CH]O(7116)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(153.986,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]OOC=O(7173)'],
    products = ['[CH2]OO[CH]O(7116)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['[CH2]OO[CH]O(7116)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(7.70036,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction10',
    reactants = ['[CH2]OOC[O](7174)'],
    products = ['[CH2]OO[CH]O(7116)'],
