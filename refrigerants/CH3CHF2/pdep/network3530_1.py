...
species(
    label = '[CH2]C1(F)O[CH]C1(F)F(10319)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(10245)'],
    products = ['[CH2]C1(F)O[CH]C1(F)F(10319)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C1(F)[CH]O1(5723)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(10245)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)[C](F)C=O(10320)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(10245)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)(F)C1=CO1(10321)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(10245)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C1(F)[CH]O1(9567)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(10245)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH2]C(F)=C1[CH]O1(9569)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(10245)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(10245)'],
    products = ['FCC(F)(F)[C]1[CH]O1(10323)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(10245)'],
    products = ['[CH2][C](F)C1(F)OC1F(10324)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC[C](F)C1(F)[CH]O1(10325)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(10245)'],
...
network(
    label = 'PDepNetwork #3530',
    isomers = [
        '[CH2]C(F)(F)C1(F)[CH]O1(10245)',
    ],
    reactants = [
