...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', '[O]C[C]=O(690)'],
    products = ['O=[C]CO[CH]F(992)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH2]O[CH]F(325)'],
    products = ['O=[C]CO[CH]F(992)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[CH]F(325)'],
    products = ['O=[C]CO[CH]F(992)'],
    transitionState = 'TS6',
