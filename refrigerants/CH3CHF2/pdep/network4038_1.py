...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.11071,'amu*angstrom^2'), symmetry=1, barrier=(25.5375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11136,'amu*angstrom^2'), symmetry=1, barrier=(25.5523,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.841188,0.0656319,-6.28777e-05,3.08828e-08,-6.04786e-12,32410.6,22.8467], Tmin=(100,'K'), Tmax=(1232.12,'K')), NASAPolynomial(coeffs=[14.5181,0.0212303,-8.82217e-06,1.63461e-09,-1.13278e-13,29040.3,-45.9913], Tmin=(1232.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_P)"""),
)
...
"""),
    E0 = (259.666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2100,2250,500,550,3120,650,792.5,1650,256.435],'cm^-1')),
        HinderedRotor(inertia=(0.42921,'amu*angstrom^2'), symmetry=1, barrier=(19.9996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161332,'amu*angstrom^2'), symmetry=1, barrier=(7.52086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5118,'amu*angstrom^2'), symmetry=1, barrier=(69.9683,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47493,0.0553689,-4.79256e-05,2.34999e-08,-4.85057e-12,31321.7,23.0002], Tmin=(100,'K'), Tmax=(1137.68,'K')), NASAPolynomial(coeffs=[9.36376,0.0276324,-1.13559e-05,2.07054e-09,-1.41573e-13,29526.7,-16.0765], Tmin=(1137.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-CtHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(C=C[CH2])CF(12055)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {4,S} {7,D}
...
"""),
    E0 = (209.957,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,3120,650,792.5,1650,258.975],'cm^-1')),
        HinderedRotor(inertia=(0.501629,'amu*angstrom^2'), symmetry=1, barrier=(23.8739,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.50163,'amu*angstrom^2'), symmetry=1, barrier=(23.8739,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58963,'amu*angstrom^2'), symmetry=1, barrier=(75.6548,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.931278,0.0588734,-3.69123e-05,4.90038e-09,2.60866e-12,25369.9,25.027], Tmin=(100,'K'), Tmax=(1039.11,'K')), NASAPolynomial(coeffs=[14.0926,0.0239318,-9.16822e-06,1.66144e-09,-1.1531e-13,21785.9,-43.0579], Tmin=(1039.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CC=CCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C=CC)CF(12056)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33541,0.0636086,-5.06287e-05,2.41513e-08,-5.30145e-12,32181.1,22.9242], Tmin=(100,'K'), Tmax=(1010.76,'K')), NASAPolynomial(coeffs=[6.58973,0.0428148,-1.97697e-05,3.79743e-09,-2.67091e-13,31118.9,-2.481], Tmin=(1010.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3388.67,'J/mol'), sigma=(5.70503,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=529.30 K, Pc=41.41 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC=[C]C(6339)'],
    products = ['[CH]=C(C=[C]C)CF(8586)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C=[C]C(6382)'],
    products = ['[CH]=C(C=[C]C)CF(8586)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[CH]=C(C=C=C)CF(12053)'],
    products = ['[CH]=C(C=[C]C)CF(8586)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2F(46)', 'C#CC=[C]C(6458)'],
    products = ['[CH]=C(C=[C]C)CF(8586)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]=C(C#CC)CF(12054)'],
    products = ['[CH]=C(C=[C]C)CF(8586)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(C=C[CH2])CF(12055)'],
    products = ['[CH]=C(C=[C]C)CF(8586)'],
