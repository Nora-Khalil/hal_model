...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[O]C([O])=O(1266)'],
    products = ['[O]C(=O)O[C]=O(1947)'],
    transitionState = 'TS2',
