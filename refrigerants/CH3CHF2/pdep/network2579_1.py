...
"""),
    E0 = (242.848,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,1685,370,241.954,242.01],'cm^-1')),
        HinderedRotor(inertia=(0.00286064,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261149,'amu*angstrom^2'), symmetry=1, barrier=(10.9269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263032,'amu*angstrom^2'), symmetry=1, barrier=(10.9273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28711,0.0525351,-3.54933e-05,1.20898e-08,-1.66801e-12,29311.4,25.1871], Tmin=(100,'K'), Tmax=(1678.05,'K')), NASAPolynomial(coeffs=[13.6691,0.0230203,-9.11048e-06,1.60835e-09,-1.06475e-13,25155.9,-40.9581], Tmin=(1678.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(Cds_S)"""),
)
...
"""),
    E0 = (280.509,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,180,2871.59],'cm^-1')),
        HinderedRotor(inertia=(0.255946,'amu*angstrom^2'), symmetry=1, barrier=(5.8847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255156,'amu*angstrom^2'), symmetry=1, barrier=(5.86655,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48962,0.0397768,-5.3377e-05,5.63744e-08,-2.35884e-11,33785.4,19.4796], Tmin=(100,'K'), Tmax=(821.32,'K')), NASAPolynomial(coeffs=[0.0203761,0.0358528,-1.70807e-05,3.26806e-09,-2.26309e-13,34729,34.1813], Tmin=(821.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70393,0.0273991,6.64573e-05,-1.13431e-07,4.72746e-11,-9432.42,18.0223], Tmin=(100,'K'), Tmax=(946.468,'K')), NASAPolynomial(coeffs=[19.0025,0.0126906,-2.78591e-06,5.34451e-10,-4.8146e-14,-15322.6,-78.2998], Tmin=(946.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.2884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'CC=CC(C)=O(6796)',
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12952,0.0418682,-1.80588e-05,2.07976e-09,1.86083e-13,-19479.9,19.9569], Tmin=(100,'K'), Tmax=(1859.77,'K')), NASAPolynomial(coeffs=[14.287,0.0242627,-1.07492e-05,1.92942e-09,-1.25722e-13,-25479.3,-50.2108], Tmin=(1859.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.180184,'amu*angstrom^2'), symmetry=1, barrier=(4.14279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180642,'amu*angstrom^2'), symmetry=1, barrier=(4.1533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180716,'amu*angstrom^2'), symmetry=1, barrier=(4.15501,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.87657,0.0382464,-1.78549e-05,3.12376e-09,-1.58878e-13,9086.21,17.6735], Tmin=(100,'K'), Tmax=(2481.81,'K')), NASAPolynomial(coeffs=[25.0582,0.00981917,-5.09988e-06,8.86516e-10,-5.32877e-14,-4179.35,-114.047], Tmin=(2481.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.3225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + radical(Cds_S)"""),
)
...
"""),
    E0 = (164.801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2100,2250,500,550,422.086,425.623],'cm^-1')),
        HinderedRotor(inertia=(0.0817846,'amu*angstrom^2'), symmetry=1, barrier=(10.5608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150298,'amu*angstrom^2'), symmetry=1, barrier=(19.8417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.546749,'amu*angstrom^2'), symmetry=1, barrier=(72.8627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71106,0.0414679,-2.897e-06,-2.86308e-08,1.54313e-11,19911.6,22.4068], Tmin=(100,'K'), Tmax=(918.819,'K')), NASAPolynomial(coeffs=[11.9035,0.0202071,-5.91779e-06,9.36466e-10,-6.21476e-14,17063.1,-31.2117], Tmin=(918.819,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CC(C)OJ)"""),
)

species(
    label = 'C[C]C=C(C)O(6800)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (224.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,256.142],'cm^-1')),
        HinderedRotor(inertia=(0.00256096,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214702,'amu*angstrom^2'), symmetry=1, barrier=(10.0297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215071,'amu*angstrom^2'), symmetry=1, barrier=(10.0306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21542,'amu*angstrom^2'), symmetry=1, barrier=(10.0284,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30411,0.0580584,-4.95282e-05,2.2834e-08,-4.35384e-12,27048.2,25.935], Tmin=(100,'K'), Tmax=(1233.67,'K')), NASAPolynomial(coeffs=[11.0619,0.0264199,-1.10594e-05,2.04574e-09,-1.41135e-13,24640.6,-23.1899], Tmin=(1233.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CJCO) + radical(Cds_S)"""),
)

species(
    label = 'C[C]=[C]C(C)O(6804)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {14,S}
2  C u0 p0 c0 {1,S} {3,S} {5,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
...
"""),
    E0 = (250.329,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1670,1700,300,440,278.218],'cm^-1')),
        HinderedRotor(inertia=(0.147921,'amu*angstrom^2'), symmetry=1, barrier=(8.13106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147869,'amu*angstrom^2'), symmetry=1, barrier=(8.12806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147378,'amu*angstrom^2'), symmetry=1, barrier=(8.13004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14712,'amu*angstrom^2'), symmetry=1, barrier=(8.12883,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58992,0.0554366,-4.72025e-05,2.31413e-08,-4.91025e-12,30192.4,24.7548], Tmin=(100,'K'), Tmax=(1086.05,'K')), NASAPolynomial(coeffs=[8.16846,0.0312072,-1.37377e-05,2.59891e-09,-1.81517e-13,28763.5,-7.5258], Tmin=(1086.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(250.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C=C(C)[O](6805)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51606,0.0459912,-1.29893e-05,-1.41504e-08,8.32058e-12,1517.59,21.2515], Tmin=(100,'K'), Tmax=(1009.63,'K')), NASAPolynomial(coeffs=[11.5167,0.0249597,-9.36127e-06,1.69066e-09,-1.17616e-13,-1449.26,-31.7837], Tmin=(1009.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.8115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]C([O])C=CC(6806)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {2,S}
2  C u0 p0 c0 {1,S} {4,S} {6,S} {7,S}
3  C u0 p0 c0 {5,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23576,0.0525332,-2.93684e-05,1.95312e-09,2.57797e-12,26157,25.5176], Tmin=(100,'K'), Tmax=(1087.33,'K')), NASAPolynomial(coeffs=[12.793,0.0241196,-9.62576e-06,1.77652e-09,-1.23939e-13,22810,-35.0405], Tmin=(1087.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[C]=CC(C)[O](6744)'],
    products = ['CH3CHO(36)', 'C#CC(5603)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C[C]=CC[O](6333)'],
    products = ['C[C]=CC(C)[O](6744)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(19)', 'C[C]=CC=O(6569)'],
    products = ['C[C]=CC(C)[O](6744)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3CHO(36)', '[CH]=[C]C(5604)'],
    products = ['C[C]=CC(C)[O](6744)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH][O](468)', 'C#CC(5603)'],
    products = ['C[C]=CC(C)[O](6744)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH][O](468)', '[CH]=[C]C(5604)'],
    products = ['C[C]=CC(C)[O](6744)'],
