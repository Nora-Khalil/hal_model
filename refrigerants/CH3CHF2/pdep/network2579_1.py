...
reaction(
    label = 'reaction1',
    reactants = ['C#CCOC=O(6319)'],
    products = ['CO2(14)', 'C=C=C(6745)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C#CCO(7443)'],
    products = ['C#CCOC=O(6319)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COC=O(1553)'],
    products = ['C#CCOC=O(6319)'],
    transitionState = 'TS3',
