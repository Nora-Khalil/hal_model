...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=C(CO)OF(2335)'],
    products = ['CC(O)C(=O)OF(4321)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(142)', 'CC(O)=C=O(4442)'],
    products = ['CC(O)C(=O)OF(4321)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'CC(O)C([O])=O(4451)'],
    products = ['CC(O)C(=O)OF(4321)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC([O])C(=O)OF(4452)'],
    products = ['CC(O)C(=O)OF(4321)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(126)', 'CC(O)[C]=O(4453)'],
    products = ['CC(O)C(=O)OF(4321)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(19)', 'O=C([CH]O)OF(2365)'],
    products = ['CC(O)C(=O)OF(4321)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'C[C](O)C(=O)OF(4454)'],
    products = ['CC(O)C(=O)OF(4321)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH2]C(O)C(=O)OF(4455)'],
    products = ['CC(O)C(=O)OF(4321)'],
