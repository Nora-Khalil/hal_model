...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C=C(4302)'],
    products = ['[C]1=CC1(8085)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]1=CC1(8085)'],
    products = ['[CH]1C=C1(8230)'],
    transitionState = 'TS6',
