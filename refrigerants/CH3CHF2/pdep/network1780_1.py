...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3025)', '[O]C([O])=O(1266)'],
    products = ['[O]C(=O)O[C](F)F(4708)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O=[C]O[C](F)F(3317)'],
    products = ['[O]C(=O)O[C](F)F(4708)'],
    transitionState = 'TS3',
