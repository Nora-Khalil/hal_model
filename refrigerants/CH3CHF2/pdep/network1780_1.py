...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2927)', '[O]C[CH]F(140)'],
    products = ['F[CH]CO[C](F)F(4694)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]O[C](F)F(3131)'],
    products = ['F[CH]CO[C](F)F(4694)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC=CO[C](F)F(4637)'],
    products = ['F[CH]CO[C](F)F(4694)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[CH2]O[C](F)F(3131)'],
    products = ['F[CH]CO[C](F)F(4694)'],
