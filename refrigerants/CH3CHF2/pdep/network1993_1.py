...
"""),
    E0 = (-625.605,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,316,385,515,654,689,1295,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.940223,'amu*angstrom^2'), symmetry=1, barrier=(21.6176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357655,'amu*angstrom^2'), symmetry=1, barrier=(8.2232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.35773,'amu*angstrom^2'), symmetry=1, barrier=(8.22492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52745,'amu*angstrom^2'), symmetry=1, barrier=(35.1192,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-200.914,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,360,370,350,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.112556,'amu*angstrom^2'), symmetry=1, barrier=(2.58788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112582,'amu*angstrom^2'), symmetry=1, barrier=(2.58849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112613,'amu*angstrom^2'), symmetry=1, barrier=(2.58919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.738258,'amu*angstrom^2'), symmetry=1, barrier=(16.974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.138506,0.0928992,-0.000148945,1.28166e-07,-4.34612e-11,-24033,28.7727], Tmin=(100,'K'), Tmax=(820.035,'K')), NASAPolynomial(coeffs=[10.4865,0.03119,-1.55194e-05,2.98934e-09,-2.06631e-13,-25352.4,-16.7945], Tmin=(820.035,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(C2CsJO) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]C(F)([CH]C(F)F)OF(5333)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-425.703,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.237555,'amu*angstrom^2'), symmetry=1, barrier=(5.46185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23709,'amu*angstrom^2'), symmetry=1, barrier=(5.45116,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.934567,'amu*angstrom^2'), symmetry=1, barrier=(21.4875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50446,'amu*angstrom^2'), symmetry=1, barrier=(34.5904,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.16195,0.0993473,-0.000151044,1.21087e-07,-3.88795e-11,-51057.6,29.9509], Tmin=(100,'K'), Tmax=(762.201,'K')), NASAPolynomial(coeffs=[12.8785,0.0309075,-1.63473e-05,3.26649e-09,-2.32263e-13,-53045.3,-29.4198], Tmin=(762.201,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(CCJCO) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)

species(
    label = '[CH2]C(F)(C[C](F)F)OF(5334)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.633759,'amu*angstrom^2'), symmetry=1, barrier=(14.5714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222288,'amu*angstrom^2'), symmetry=1, barrier=(5.11085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220542,'amu*angstrom^2'), symmetry=1, barrier=(5.07069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7726,'amu*angstrom^2'), symmetry=1, barrier=(40.7555,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.43822,0.10911,-0.000189347,1.70814e-07,-5.98633e-11,-50974.6,29.7938], Tmin=(100,'K'), Tmax=(821.209,'K')), NASAPolynomial(coeffs=[10.7776,0.0351275,-1.88659e-05,3.72093e-09,-2.59625e-13,-52164.2,-18.1337], Tmin=(821.209,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(Csj(Cs-F1sO2sCs)(H)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-279.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.19508,'amu*angstrom^2'), symmetry=1, barrier=(27.4772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19415,'amu*angstrom^2'), symmetry=1, barrier=(27.456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19224,'amu*angstrom^2'), symmetry=1, barrier=(27.4118,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.551627,0.0815201,-0.000109856,7.75855e-08,-2.20218e-11,-33517.2,24.2185], Tmin=(100,'K'), Tmax=(857.72,'K')), NASAPolynomial(coeffs=[12.3649,0.0264273,-1.35057e-05,2.69493e-09,-1.92847e-13,-35543.6,-30.9603], Tmin=(857.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-279.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(CJCO)"""),
)
...
"""),
    ...
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.292924,0.0866627,-0.000100929,6.1163e-08,-1.50365e-11,-76430.4,28.0751], Tmin=(100,'K'), Tmax=(979.233,'K')), NASAPolynomial(coeffs=[13.9091,0.0310429,-1.57302e-05,3.15882e-09,-2.27935e-13,-79097.1,-37.3292], Tmin=(979.233,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(CCJCO)"""),
)

species(
    label = 'CC(F)(C[C](F)F)OF(5337)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0523436,0.0971185,-0.000141143,1.12843e-07,-3.67431e-11,-76344.3,28.1735], Tmin=(100,'K'), Tmax=(747.767,'K')), NASAPolynomial(coeffs=[11.3497,0.0361228,-1.87802e-05,3.74527e-09,-2.66663e-13,-78049.4,-23.5198], Tmin=(747.767,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-635.914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O]C(F)(CF)CC(F)F(5338)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(CC(F)F)OF(5306)'],
    products = ['HF(38)', 'CH2CF2(57)', 'CH2CFO(79)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(36.0899,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]C(F)(OF)C(F)F(5318)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000166864,'m^3/(mol*s)'), n=2.82973, Ea=(150.5,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s"""),
)
...
reaction(
    ...
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.00405e-10,'m^3/(mol*s)'), n=4.72997, Ea=(132.132,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', '[CH2]C(F)(CF)OF(1150)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(138.435,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', 'FO[C](F)CC(F)F(3379)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]C(F)(CC(F)F)OF(5331)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(CC(F)F)OF(3078)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)(C[CH]F)OF(1173)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C([O])(F)CC(F)F(1214)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', '[CH2][C](F)CC(F)F(1213)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C](F)OF(1113)', 'CHF2-CH2(64)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(81)', '[CH2]C([CH2])(F)OF(1171)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)([CH]C(F)F)OF(5333)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(F)(C[C](F)F)OF(5334)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', 'C=C([O])CC(F)F(1059)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', '[CH2]C(=CC(F)F)OF(3279)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(252.543,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction21',
    reactants = ['HF(38)', '[CH2]C(F)(C=CF)OF(5335)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)(CC(F)F)OF(5306)'],
    products = ['F2(78)', 'CH2CFO(79)', 'CH2CHF(56)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(260.656,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(F)(CC(F)F)OF(5306)'],
    products = ['CC(F)([CH]C(F)F)OF(5336)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[CH]CC(F)(CF)OF(5340)'],
    products = ['[CH2]C(F)(CC(F)F)OF(5306)'],
