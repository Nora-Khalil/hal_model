...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC1O[C]1F(5838)'],
    products = ['C2HF(58)', 'FC1=CO1(4047)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)C=C[C]F(5841)'],
    products = ['F[C]=CC1O[C]1F(5838)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[C]F(1074)', 'FC1=CO1(4047)'],
    products = ['F[C]=CC1O[C]1F(5838)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]=CC1=C(F)O1(5842)'],
    products = ['F[C]=CC1O[C]1F(5838)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2HF(58)', 'F[C]1[CH]O1(5679)'],
    products = ['F[C]=CC1O[C]1F(5838)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC#CC1O[C]1F(5843)'],
    products = ['F[C]=CC1O[C]1F(5838)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[C]F(1074)', 'F[C]1[CH]O1(5679)'],
    products = ['F[C]=CC1O[C]1F(5838)'],
