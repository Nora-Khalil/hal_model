...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C=C([O])OF(4137)'],
    products = ['[CH]=C(F)C([O])=O(3943)'],
    transitionState = 'TS2',
