...
reaction(
    label = 'reaction2',
    reactants = ['C=[C]CC([O])=O(6750)'],
    products = ['[CH2]C(=C)C([O])=O(6629)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(=C)[C]=O(7143)'],
    products = ['[CH2]C(=C)C([O])=O(6629)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(=C)C([O])=O(6629)'],
    products = ['[CH2]C1([CH2])OC1=O(7192)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C]=O(293)', 'C=C=C(6745)'],
    products = ['[CH2]C(=C)C([O])=O(6629)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(293)', '[CH2][C]=C(7019)'],
    products = ['[CH2]C(=C)C([O])=O(6629)'],
