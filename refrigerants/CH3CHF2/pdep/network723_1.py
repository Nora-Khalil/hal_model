...
reaction(
    label = 'reaction5',
    reactants = ['FO[C]1CC[CH]O1(2123)'],
    products = ['C=COC(=C)OF(2050)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(=O)OC=C(2130)'],
    products = ['C=COC(=C)OF(2050)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=[C]OC(=C)OF(2131)'],
    products = ['C=COC(=C)OF(2050)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)OC=C(2132)'],
    products = ['C=COC(=C)OF(2050)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH]=COC(=C)OF(2133)'],
    products = ['C=COC(=C)OF(2050)'],
