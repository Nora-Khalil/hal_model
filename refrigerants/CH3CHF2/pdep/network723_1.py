...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.724307,'amu*angstrom^2'), symmetry=1, barrier=(18.7745,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54383,0.0589278,-7.42297e-05,5.45618e-08,-1.68528e-11,-101288,22.0192], Tmin=(100,'K'), Tmax=(778.121,'K')), NASAPolynomial(coeffs=[7.6495,0.027539,-1.37166e-05,2.71278e-09,-1.93232e-13,-102238,-5.90501], Tmin=(778.121,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-842.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(COCsFO)"""),
)

species(
    label = '[CH2]C(F)O[C](O)F(2214)',
...
"""),
    E0 = (-471.795,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,3000,3100,440,815,1455,1000,482,586,761,1411,180,180,1036.28],'cm^-1')),
        HinderedRotor(inertia=(0.940259,'amu*angstrom^2'), symmetry=1, barrier=(21.6184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202209,'amu*angstrom^2'), symmetry=1, barrier=(4.64919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.940259,'amu*angstrom^2'), symmetry=1, barrier=(21.6184,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19622,0.0628921,-6.89947e-05,3.83205e-08,-8.51878e-12,-56643.9,25.3931], Tmin=(100,'K'), Tmax=(1085.59,'K')), NASAPolynomial(coeffs=[12.8349,0.0200077,-9.73955e-06,1.93143e-09,-1.38721e-13,-59170.8,-31.7125], Tmin=(1085.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-471.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHOO) + radical(Csj(Cs-F1sO2sH)(H)(H)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = 'C[C](F)O[C](O)F(2215)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-489.971,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,482,586,761,1411,329.489,329.504,329.541],'cm^-1')),
        HinderedRotor(inertia=(0.0930353,'amu*angstrom^2'), symmetry=1, barrier=(7.16949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227964,'amu*angstrom^2'), symmetry=1, barrier=(17.5722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0930149,'amu*angstrom^2'), symmetry=1, barrier=(7.16922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417268,'amu*angstrom^2'), symmetry=1, barrier=(32.1574,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
...
"""),
    E0 = (-421.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,451,553,637,1069,1180,1265,1301,3056,3000,3100,440,815,1455,1000,180,180,2672.41],'cm^-1')),
        HinderedRotor(inertia=(0.500616,'amu*angstrom^2'), symmetry=1, barrier=(11.5102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39247,'amu*angstrom^2'), symmetry=1, barrier=(32.0156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39255,'amu*angstrom^2'), symmetry=1, barrier=(32.0175,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50526,0.0579397,-6.07389e-05,3.377e-08,-7.73427e-12,-50558.8,23.9517], Tmin=(100,'K'), Tmax=(1038.72,'K')), NASAPolynomial(coeffs=[10.3145,0.0240163,-1.17506e-05,2.32852e-09,-1.66904e-13,-52388.8,-18.8823], Tmin=(1038.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'C[C](F)OC([O])F(2217)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.141548,'amu*angstrom^2'), symmetry=1, barrier=(3.25448,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.846614,'amu*angstrom^2'), symmetry=1, barrier=(19.4653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.846557,'amu*angstrom^2'), symmetry=1, barrier=(19.464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.846891,'amu*angstrom^2'), symmetry=1, barrier=(19.4717,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.880479,0.0569117,-6.05407e-05,3.04994e-08,-5.77293e-12,-40290.1,23.6134], Tmin=(100,'K'), Tmax=(1439.37,'K')), NASAPolynomial(coeffs=[17.331,0.00541688,-8.54392e-07,6.53469e-11,-2.45544e-15,-44427.1,-59.6625], Tmin=(1439.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-336.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-337.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,2950,3100,1380,975,1025,1650,580,1155,1237,1373,3147,180,180,742.07],'cm^-1')),
        HinderedRotor(inertia=(0.224203,'amu*angstrom^2'), symmetry=1, barrier=(5.15486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220883,'amu*angstrom^2'), symmetry=1, barrier=(5.07853,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25645,0.0527541,-4.56031e-05,1.56128e-08,-9.14333e-13,-60683.4,22.0764], Tmin=(100,'K'), Tmax=(1054.03,'K')), NASAPolynomial(coeffs=[15.3244,0.011721,-4.78956e-06,9.18376e-10,-6.64858e-14,-64335.3,-49.7889], Tmin=(1054.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-505.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(CdCFO) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sO2sH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.6832,'amu*angstrom^2'), symmetry=1, barrier=(38.7002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68408,'amu*angstrom^2'), symmetry=1, barrier=(38.7202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68308,'amu*angstrom^2'), symmetry=1, barrier=(38.6972,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.861559,0.0783821,-0.000132857,1.23018e-07,-4.42504e-11,-47588,34.1714], Tmin=(100,'K'), Tmax=(830.451,'K')), NASAPolynomial(coeffs=[6.64962,0.0322577,-1.65897e-05,3.22457e-09,-2.23456e-13,-47920.2,11.1107], Tmin=(830.451,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-396.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFHOO) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OC(O)F(2222)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
4  O u0 p2 c0 {5,S} {11,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.930889,0.0735488,-0.000108887,8.72782e-08,-2.83233e-11,-52601.6,22.921], Tmin=(100,'K'), Tmax=(751.478,'K')), NASAPolynomial(coeffs=[9.90603,0.0257812,-1.35513e-05,2.71177e-09,-1.9332e-13,-53950.7,-17.8156], Tmin=(751.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-438.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFHOO) + group(CsCFHO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'C=C(F)OC=O(174)',
    structure = adjacencyList("""1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {6,S}
3 O u0 p2 c0 {6,D}
...
"""),
    E0 = (-479.405,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,180,1342.81],'cm^-1')),
        HinderedRotor(inertia=(0.966487,'amu*angstrom^2'), symmetry=1, barrier=(22.2214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34413,'amu*angstrom^2'), symmetry=1, barrier=(30.9042,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45878,0.0366235,-2.66774e-05,9.26029e-09,-1.32559e-12,-57606.5,16.0594], Tmin=(100,'K'), Tmax=(1543.91,'K')), NASAPolynomial(coeffs=[9.22514,0.0190932,-9.64577e-06,1.90603e-09,-1.34748e-13,-59695.9,-19.5232], Tmin=(1543.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-OdOsH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)O[C](O)F(2214)'],
    products = ['C=C(F)OC(O)F(2063)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[CH]O(1902)'],
    products = ['C=C(F)OC(O)F(2063)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=[C]OC(O)F(2218)'],
    products = ['C=C(F)OC(O)F(2063)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.52887e+10,'m^3/(mol*s)'), n=-0.421056, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.030895812897821735, var=3.1393582276389975, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['O[CH]F(450)', 'CH2CFO(79)'],
    products = ['C=C(F)OC(O)F(2063)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(O)F(1361)', 'CH2CF(70)'],
    products = ['C=C(F)OC(O)F(2063)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'C=C(F)O[CH]F(642)'],
    products = ['C=C(F)OC(O)F(2063)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(F)OC([O])F(1133)'],
    products = ['C=C(F)OC(O)F(2063)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(F)O[C](O)F(2219)'],
    products = ['C=C(F)OC(O)F(2063)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)OC(O)F(2220)'],
    products = ['C=C(F)OC(O)F(2063)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(F)OC=O(174)'],
    products = ['C=C(F)OC(O)F(2063)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(25)', 'OC(F)[O+]=[C-]F(2223)'],
    products = ['C=C(F)OC(O)F(2063)'],
