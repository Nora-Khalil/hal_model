...
"""),
    E0 = (151.939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,540,610,2055,330.193,330.855],'cm^-1')),
        HinderedRotor(inertia=(0.089068,'amu*angstrom^2'), symmetry=1, barrier=(6.91425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0890587,'amu*angstrom^2'), symmetry=1, barrier=(6.9201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266608,'amu*angstrom^2'), symmetry=1, barrier=(20.6919,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33556,0.0636253,-7.67488e-05,5.34589e-08,-1.56263e-11,18365.6,23.0869], Tmin=(100,'K'), Tmax=(820.364,'K')), NASAPolynomial(coeffs=[8.32073,0.0295656,-1.44708e-05,2.84772e-09,-2.02567e-13,17219.5,-9.22924], Tmin=(820.364,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'CC(=O)C(=O)CF(2138)',
...
"""),
    E0 = (-104.482,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2120,512.5,787.5,360.138,363.905],'cm^-1')),
        HinderedRotor(inertia=(0.092401,'amu*angstrom^2'), symmetry=1, barrier=(8.43838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0936344,'amu*angstrom^2'), symmetry=1, barrier=(8.45243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196728,'amu*angstrom^2'), symmetry=1, barrier=(18.4197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20005,0.0642919,-7.45696e-05,4.7498e-08,-1.23301e-11,-12467.8,22.13], Tmin=(100,'K'), Tmax=(931.241,'K')), NASAPolynomial(coeffs=[10.3615,0.0249401,-1.11834e-05,2.12028e-09,-1.47991e-13,-14174.1,-21.4162], Tmin=(931.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsOs) + missing(Cdd-CdO2d)"""),
)

species(
    label = '[CH2]C([O])C(=C)OF(2140)',
...
"""),
    E0 = (231.376,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,408.673,408.836],'cm^-1')),
        HinderedRotor(inertia=(0.00100856,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114088,'amu*angstrom^2'), symmetry=1, barrier=(13.5338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114154,'amu*angstrom^2'), symmetry=1, barrier=(13.5418,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06368,0.0630673,-6.43373e-05,3.33901e-08,-6.90874e-12,27935.1,26.6221], Tmin=(100,'K'), Tmax=(1167.23,'K')), NASAPolynomial(coeffs=[13.6661,0.0198796,-8.837e-06,1.69091e-09,-1.19304e-13,24993.2,-36.1261], Tmin=(1167.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C([O])=C(C)OF(2143)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02972,0.0387132,-2.76231e-05,7.15254e-09,4.9136e-13,8487.86,16.6552], Tmin=(100,'K'), Tmax=(1009.08,'K')), NASAPolynomial(coeffs=[10.1302,0.0152018,-5.45542e-06,9.51876e-10,-6.46432e-14,6415.28,-24.6672], Tmin=(1009.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(69.9486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.890801,'amu*angstrom^2'), symmetry=1, barrier=(20.4813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.891085,'amu*angstrom^2'), symmetry=1, barrier=(20.4878,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37653,0.0632887,-0.000108671,9.48752e-08,-3.25515e-11,3761.23,18.5107], Tmin=(100,'K'), Tmax=(779.554,'K')), NASAPolynomial(coeffs=[9.50125,0.0166654,-9.46512e-06,1.91612e-09,-1.36028e-13,2644.42,-17.7014], Tmin=(779.554,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.5317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-CdsHH) + group(Cds-O2d(Cds-Cds)H) + radical(C=CCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00810705,'amu*angstrom^2'), symmetry=1, barrier=(5.10818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213418,'amu*angstrom^2'), symmetry=1, barrier=(4.9069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607104,'amu*angstrom^2'), symmetry=1, barrier=(13.9585,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36538,0.0633053,-8.81316e-05,7.15108e-08,-2.415e-11,8731.6,22.4102], Tmin=(100,'K'), Tmax=(716.758,'K')), NASAPolynomial(coeffs=[7.69129,0.0280098,-1.42819e-05,2.83631e-09,-2.01787e-13,7824.58,-6.0033], Tmin=(716.758,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.8515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(OF)C(C)=O(2150)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {4,S}
3  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24126,0.0660367,-8.54229e-05,6.41653e-08,-2.01309e-11,18945.2,24.4476], Tmin=(100,'K'), Tmax=(768.474,'K')), NASAPolynomial(coeffs=[8.18947,0.0298704,-1.4829e-05,2.92366e-09,-2.07691e-13,17877.2,-7.24369], Tmin=(768.474,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(156.734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(=O)C(C)=O(2145)'],
    products = ['C=C(OF)C(C)=O(2055)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(126)', 'C=C=C(C)[O](2146)'],
    products = ['C=C(OF)C(C)=O(2055)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'C=C([C]=O)OF(2147)'],
    products = ['C=C(OF)C(C)=O(2055)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=C([O])C(=C)OF(2148)'],
    products = ['C=C(OF)C(C)=O(2055)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)C(C)=O(2149)'],
    products = ['C=C(OF)C(C)=O(2055)'],
