...
"""),
    E0 = (270.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,113,247,382,1207,3490,540,610,2055,3120,650,792.5,1650,344.857],'cm^-1')),
        HinderedRotor(inertia=(0.191177,'amu*angstrom^2'), symmetry=1, barrier=(16.1916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190052,'amu*angstrom^2'), symmetry=1, barrier=(16.1908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.883025,0.064353,-6.14829e-05,3.04831e-08,-6.03001e-12,32619.1,22.5562], Tmin=(100,'K'), Tmax=(1221.81,'K')), NASAPolynomial(coeffs=[14.0888,0.0211195,-8.40547e-06,1.52191e-09,-1.04111e-13,29392.1,-43.7995], Tmin=(1221.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.625226,'amu*angstrom^2'), symmetry=1, barrier=(14.3752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.625788,'amu*angstrom^2'), symmetry=1, barrier=(14.3881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08486,'amu*angstrom^2'), symmetry=1, barrier=(24.9431,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44268,0.0535035,-4.36709e-05,1.93214e-08,-3.53065e-12,56161.7,20.3291], Tmin=(100,'K'), Tmax=(1287.09,'K')), NASAPolynomial(coeffs=[10.8042,0.0244098,-9.7644e-06,1.75893e-09,-1.19369e-13,53751.9,-27.1975], Tmin=(1287.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(466.171,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(C)CC#CF(8509)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
3  C u0 p0 c0 {4,S} {10,S} {11,S} {12,S}
...
"""),
    E0 = (366.405,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2175,525,3120,650,792.5,1650,239,401,1367,328.189],'cm^-1')),
        HinderedRotor(inertia=(0.00155554,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132549,'amu*angstrom^2'), symmetry=1, barrier=(9.98694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12996,'amu*angstrom^2'), symmetry=1, barrier=(10.002,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51633,0.0588094,-5.92203e-05,3.55914e-08,-9.26371e-12,44154.3,22.4022], Tmin=(100,'K'), Tmax=(902.305,'K')), NASAPolynomial(coeffs=[7.52173,0.0321874,-1.49646e-05,2.89373e-09,-2.04406e-13,43070.5,-5.95313], Tmin=(902.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(CtCF) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(C)=CC=CF(8510)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {3,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.17357,'amu*angstrom^2'), symmetry=1, barrier=(49.9747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17553,'amu*angstrom^2'), symmetry=1, barrier=(50.0198,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17623,'amu*angstrom^2'), symmetry=1, barrier=(50.0357,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.650249,0.0651842,-4.52275e-05,1.37501e-08,-9.02381e-13,23909.7,24.5479], Tmin=(100,'K'), Tmax=(1128.77,'K')), NASAPolynomial(coeffs=[13.7832,0.0291798,-1.13812e-05,2.02828e-09,-1.3751e-13,20273.7,-43.3747], Tmin=(1128.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C)CC=[C]F(8511)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
3  C u0 p0 c0 {4,S} {10,S} {11,S} {12,S}
...
"""),
    E0 = (355.118,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,167,640,1190,318.025],'cm^-1')),
        HinderedRotor(inertia=(0.137885,'amu*angstrom^2'), symmetry=1, barrier=(9.89254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138176,'amu*angstrom^2'), symmetry=1, barrier=(9.89236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137709,'amu*angstrom^2'), symmetry=1, barrier=(9.8923,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17838,0.0622861,-5.52684e-05,2.67476e-08,-5.38549e-12,42812.2,25.4587], Tmin=(100,'K'), Tmax=(1168.15,'K')), NASAPolynomial(coeffs=[10.9019,0.0289899,-1.25124e-05,2.34608e-09,-1.63116e-13,40540.5,-22.9627], Tmin=(1168.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_P) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (346.553,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,246,474,533,1155,3115,3125,620,680,785,800,1600,1700,383.784],'cm^-1')),
        HinderedRotor(inertia=(0.0888623,'amu*angstrom^2'), symmetry=1, barrier=(9.24763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0883951,'amu*angstrom^2'), symmetry=1, barrier=(9.25138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0879626,'amu*angstrom^2'), symmetry=1, barrier=(9.27234,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07431,0.0648194,-6.01102e-05,3.02648e-08,-6.3e-12,41785.7,25.2099], Tmin=(100,'K'), Tmax=(1137.18,'K')), NASAPolynomial(coeffs=[11.3346,0.0287287,-1.2504e-05,2.35547e-09,-1.64289e-13,39452.1,-25.6089], Tmin=(1137.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[C]=CF(7412)'],
    products = ['[CH]=C(C)C[C]=CF(8496)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=CF(1084)', '[CH]C(=C)C(6403)'],
    products = ['[CH]=C(C)C[C]=CF(8496)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(C)C=C=CF(8507)'],
    products = ['[CH]=C(C)C[C]=CF(8496)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(C)CC#C(8508)'],
    products = ['[CH]=C(C)C[C]=CF(8496)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH]=C(C)CC#CF(8509)'],
    products = ['[CH]=C(C)C[C]=CF(8496)'],
