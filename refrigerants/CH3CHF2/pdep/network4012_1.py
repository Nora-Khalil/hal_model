...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC([CH2])(F)F(3015)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C([CH2])(F)F(3989)'],
    products = ['[CH]=C(CF)C([CH2])(F)F(7836)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', '[CH]C(CF)=C(F)F(11946)'],
    products = ['[CH]=C(CF)C([CH2])(F)F(7836)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(CF)C(=C)F(11875)'],
    products = ['[CH]=C(CF)C([CH2])(F)F(7836)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2F(46)', 'C#CC([CH2])(F)F(3138)'],
    products = ['[CH]=C(CF)C([CH2])(F)F(7836)'],
