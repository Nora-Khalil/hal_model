...
"""),
    E0 = (146.719,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,1855,455,950,239.529,240.307],'cm^-1')),
        HinderedRotor(inertia=(0.0996615,'amu*angstrom^2'), symmetry=1, barrier=(4.07804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.447995,'amu*angstrom^2'), symmetry=1, barrier=(18.3413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0171819,'amu*angstrom^2'), symmetry=1, barrier=(18.3424,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89904,0.0424687,-3.57286e-05,1.53434e-08,-2.65022e-12,17724.9,22.2101], Tmin=(100,'K'), Tmax=(1377.11,'K')), NASAPolynomial(coeffs=[11.134,0.0156443,-6.51006e-06,1.19838e-09,-8.23077e-14,15181.4,-25.2981], Tmin=(1377.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P) + radical((O)CJOCC)"""),
)
...
"""),
    E0 = (186.879,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1685,370,3120,650,792.5,1650,254.842,1949.31],'cm^-1')),
        HinderedRotor(inertia=(0.0116253,'amu*angstrom^2'), symmetry=1, barrier=(9.39739,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.780761,'amu*angstrom^2'), symmetry=1, barrier=(36.0728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784045,'amu*angstrom^2'), symmetry=1, barrier=(36.0745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', 'C=[C]C[O](726)'],
    products = ['C=[C]CO[C]=O(6822)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', '[CH2]O[C]=O(292)'],
    products = ['C=[C]CO[C]=O(6822)'],
    transitionState = 'TS3',
