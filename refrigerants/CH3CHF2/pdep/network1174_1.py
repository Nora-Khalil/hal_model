...
"""),
    E0 = (-300.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,190,488,555,1236,1407,326.554,326.554,326.554,326.555],'cm^-1')),
        HinderedRotor(inertia=(0.00158085,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152292,'amu*angstrom^2'), symmetry=1, barrier=(11.5243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152293,'amu*angstrom^2'), symmetry=1, barrier=(11.5243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152292,'amu*angstrom^2'), symmetry=1, barrier=(11.5243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.736614,0.0787905,-0.000104263,6.94823e-08,-1.54957e-11,-36065.8,24.7437], Tmin=(100,'K'), Tmax=(636.917,'K')), NASAPolynomial(coeffs=[10.445,0.0291062,-1.38333e-05,2.65153e-09,-1.84489e-13,-37531.4,-19.5111], Tmin=(636.917,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-300.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(CCsJOCs) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.806926,0.061314,-4.61998e-05,1.23578e-08,4.89667e-13,-65173.6,22.685], Tmin=(100,'K'), Tmax=(1055.73,'K')), NASAPolynomial(coeffs=[15.8842,0.0191634,-7.58798e-06,1.41103e-09,-9.9697e-14,-69191.6,-54.8241], Tmin=(1055.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'C=COCC(F)F(3434)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {6,S}
4  C u0 p0 c0 {3,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583211,0.0626769,-3.65187e-05,-8.41644e-09,1.05978e-11,-71529.7,22.6725], Tmin=(100,'K'), Tmax=(960.769,'K')), NASAPolynomial(coeffs=[19.7384,0.012309,-3.75368e-06,6.78234e-10,-5.10985e-14,-76566.5,-76.0308], Tmin=(960.769,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-595.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.959905,'amu*angstrom^2'), symmetry=1, barrier=(22.0701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961835,'amu*angstrom^2'), symmetry=1, barrier=(22.1145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961843,'amu*angstrom^2'), symmetry=1, barrier=(22.1147,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.54936,0.0661576,-5.59615e-05,1.38349e-08,2.45467e-12,-47179.8,23.6318], Tmin=(100,'K'), Tmax=(969.705,'K')), NASAPolynomial(coeffs=[19.2416,0.0106079,-3.37671e-06,6.06318e-10,-4.46743e-14,-51818.4,-71.198], Tmin=(969.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-393.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-269.658,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,190,488,555,1236,1407,339.564,339.564,339.565,2293.17],'cm^-1')),
        HinderedRotor(inertia=(0.110699,'amu*angstrom^2'), symmetry=1, barrier=(9.05759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110699,'amu*angstrom^2'), symmetry=1, barrier=(9.05759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110699,'amu*angstrom^2'), symmetry=1, barrier=(9.05759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.354684,'amu*angstrom^2'), symmetry=1, barrier=(29.0209,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.643096,0.08044,-0.000120657,1.02672e-07,-3.51559e-11,-32317.8,26.2319], Tmin=(100,'K'), Tmax=(800.117,'K')), NASAPolynomial(coeffs=[8.72081,0.0322525,-1.56874e-05,3.01837e-09,-2.0951e-13,-33360.6,-9.37589], Tmin=(800.117,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-269.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(CJCO) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'CCO[CH][C](F)F(3441)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-295.225,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,190,488,555,1236,1407,235.326,235.337,235.37,235.397],'cm^-1')),
        HinderedRotor(inertia=(0.00304358,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292235,'amu*angstrom^2'), symmetry=1, barrier=(11.489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.794926,'amu*angstrom^2'), symmetry=1, barrier=(31.2054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0020617,'amu*angstrom^2'), symmetry=1, barrier=(11.4954,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.65265,0.0806377,-0.000122847,1.05926e-07,-3.64959e-11,-35393.6,26.1778], Tmin=(100,'K'), Tmax=(813.638,'K')), NASAPolynomial(coeffs=[8.36761,0.0326465,-1.58202e-05,3.03133e-09,-2.09586e-13,-36316,-7.40438], Tmin=(813.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-295.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = '[CH2][CH]OCC(F)F(3442)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-291.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,324.188,324.423,324.579,325.191],'cm^-1')),
        HinderedRotor(inertia=(0.00159609,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124183,'amu*angstrom^2'), symmetry=1, barrier=(9.29458,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287639,'amu*angstrom^2'), symmetry=1, barrier=(21.501,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124528,'amu*angstrom^2'), symmetry=1, barrier=(9.29821,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.448419,0.0829835,-0.000116172,8.73652e-08,-2.62956e-11,-34956.2,25.5469], Tmin=(100,'K'), Tmax=(813.067,'K')), NASAPolynomial(coeffs=[11.8646,0.026816,-1.25431e-05,2.39006e-09,-1.65866e-13,-36812.5,-27.1665], Tmin=(813.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-291.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[C](F)F(3183)', '[CH]C-2(611)'],
    products = ['C[CH]OC[C](F)F(3431)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3025)', '[CH2]O[CH]C(1780)'],
    products = ['C[CH]OC[C](F)F(3431)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][C](F)F(3068)', 'CH3CHO(36)'],
    products = ['C[CH]OC[C](F)F(3431)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C[CH]OC=C(F)F(3437)'],
    products = ['C[CH]OC[C](F)F(3431)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=COC[C](F)F(3438)'],
    products = ['C[CH]OC[C](F)F(3431)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C](F)F(3068)', 'C[CH][O](468)'],
    products = ['C[CH]OC[C](F)F(3431)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH2]O[CH]C(1780)'],
    products = ['C[CH]OC[C](F)F(3431)'],
