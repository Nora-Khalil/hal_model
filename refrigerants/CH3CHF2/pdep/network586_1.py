...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=CCOF(1771)'],
    products = ['O=CCCOF(1715)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(126)', '[CH2]CC=O(1632)'],
    products = ['O=CCCOF(1715)'],
