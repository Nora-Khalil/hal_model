...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.738416,'amu*angstrom^2'), symmetry=1, barrier=(16.9776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.740884,'amu*angstrom^2'), symmetry=1, barrier=(17.0344,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91438,0.0405455,-3.02164e-05,8.80767e-09,-6.12268e-14,5921.88,16.6194], Tmin=(100,'K'), Tmax=(1051.94,'K')), NASAPolynomial(coeffs=[11.0404,0.0145277,-5.49953e-06,9.90848e-10,-6.85024e-14,3521.39,-30.1543], Tmin=(1051.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.5748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""propen2peroxy""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75436,0.0209191,8.09423e-05,-1.49786e-07,6.84666e-11,12497.3,17.1552], Tmin=(100,'K'), Tmax=(891.371,'K')), NASAPolynomial(coeffs=[26.9337,-0.015467,1.32611e-05,-2.75181e-09,1.87165e-13,4965.19,-118.496], Tmin=(891.371,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CJCOOH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0992777,'amu*angstrom^2'), symmetry=1, barrier=(14.2689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633317,'amu*angstrom^2'), symmetry=1, barrier=(14.5612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.517676,'amu*angstrom^2'), symmetry=1, barrier=(11.9024,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64032,0.0485017,-4.93524e-05,2.34414e-08,-3.49311e-12,6874.44,17.8338], Tmin=(100,'K'), Tmax=(929.21,'K')), NASAPolynomial(coeffs=[12.2779,0.0113834,-3.43481e-06,5.43131e-10,-3.51374e-14,4523.08,-34.7203], Tmin=(929.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.4251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=C(C)OO(6727)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {2,S} {4,S}
2  O u0 p2 c0 {1,S} {10,S}
3  C u0 p0 c0 {4,S} {6,S} {7,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.548029,'amu*angstrom^2'), symmetry=1, barrier=(12.6003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.547396,'amu*angstrom^2'), symmetry=1, barrier=(12.5857,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70775,0.0502101,-5.82206e-05,3.55219e-08,-8.57401e-12,17474.7,18.0008], Tmin=(100,'K'), Tmax=(1013.72,'K')), NASAPolynomial(coeffs=[10.6888,0.0147737,-5.78781e-06,1.04139e-09,-7.09341e-14,15653.7,-25.4504], Tmin=(1013.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(C)O[O](10701)'],
    products = ['HO2(11)', 'C=C=C(6730)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]C(=C)O[O](6448)'],
    products = ['C=C(C)O[O](10701)'],
    transitionState = 'TS8',
