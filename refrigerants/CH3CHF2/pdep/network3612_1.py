...
reaction(
    label = 'reaction5',
    reactants = ['[O]OCC=CF(9706)'],
    products = ['C=CC(F)O[O](9705)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]O[CH]C=CF(11856)'],
    products = ['[O]OCC=CF(9706)'],
