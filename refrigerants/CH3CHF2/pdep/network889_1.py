...
"""),
    E0 = (-216.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,175,287,726,856,350,440,435,1725,3010,987.5,1337.5,450,1655,196.412,197.01],'cm^-1')),
        HinderedRotor(inertia=(0.673943,'amu*angstrom^2'), symmetry=1, barrier=(18.3866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662067,'amu*angstrom^2'), symmetry=1, barrier=(18.3908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.666535,'amu*angstrom^2'), symmetry=1, barrier=(18.3832,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674075,0.0741975,-0.000111535,7.92955e-08,-2.15156e-11,-25975.5,21.7385], Tmin=(100,'K'), Tmax=(916.09,'K')), NASAPolynomial(coeffs=[15.8002,0.00815166,-3.39348e-06,5.98098e-10,-3.9337e-14,-28746.9,-49.9108], Tmin=(916.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(O2sCF) + group(Cds-CdsCsCs) + group(Cds-CdsOsH)"""),
)

species(
    label = 'OC(=CF)OOF(2671)',
...
"""),
    E0 = (-268.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,277,555,632,350,440,435,1725,194,682,905,1196,1383,3221,260.17,1732.82],'cm^-1')),
        HinderedRotor(inertia=(0.168468,'amu*angstrom^2'), symmetry=1, barrier=(8.07898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168216,'amu*angstrom^2'), symmetry=1, barrier=(8.07975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.709473,'amu*angstrom^2'), symmetry=1, barrier=(34.054,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09043,0.0713716,-0.000125182,1.12103e-07,-3.88059e-11,-32253.4,22.3332], Tmin=(100,'K'), Tmax=(829.185,'K')), NASAPolynomial(coeffs=[8.92136,0.0210038,-1.1288e-05,2.21875e-09,-1.54192e-13,-33119.2,-11.3695], Tmin=(829.185,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2sFO) + group(Cds-CdsCsCs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[O]C([O])C(F)OF(2672)',
...
"""),
    E0 = (-256.421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,261,493,600,1152,1365,1422,3097,1380,1390,370,380,2900,435,180,180,956.125,960.927],'cm^-1')),
        HinderedRotor(inertia=(0.136902,'amu*angstrom^2'), symmetry=1, barrier=(3.14764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14214,'amu*angstrom^2'), symmetry=1, barrier=(3.26808,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52439,0.065837,-0.000125233,1.28047e-07,-4.95041e-11,-30762.2,23.9307], Tmin=(100,'K'), Tmax=(823.319,'K')), NASAPolynomial(coeffs=[3.0567,0.0327697,-1.83059e-05,3.6657e-09,-2.5782e-13,-30146.1,22.11], Tmin=(823.319,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)[C](F)OF(2673)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {6,S} {9,S}
...
"""),
    E0 = (-287.572,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,395,473,707,1436,180,180,1109.39],'cm^-1')),
        HinderedRotor(inertia=(0.269013,'amu*angstrom^2'), symmetry=1, barrier=(6.18514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268931,'amu*angstrom^2'), symmetry=1, barrier=(6.18325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268959,'amu*angstrom^2'), symmetry=1, barrier=(6.18391,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0883,0.0763485,-0.000150352,1.46681e-07,-5.34543e-11,-34493.9,26.1337], Tmin=(100,'K'), Tmax=(852.504,'K')), NASAPolynomial(coeffs=[5.76505,0.026898,-1.4944e-05,2.94174e-09,-2.03158e-13,-34291.7,10.1798], Tmin=(852.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'OC(O)=C(F)OF(2674)',
    structure = adjacencyList("""1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {6,S} {9,S}
...
"""),
    E0 = (-457.283,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,232,360,932,1127,1349,1365,3045,423.794,423.795,423.796,423.797,423.798,423.809,423.816],'cm^-1')),
        HinderedRotor(inertia=(0.000938607,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00093859,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90379,0.0514477,-7.85103e-05,7.27193e-08,-2.80305e-11,-54928.1,19.3182], Tmin=(100,'K'), Tmax=(724.363,'K')), NASAPolynomial(coeffs=[5.44692,0.0262004,-1.44627e-05,2.94457e-09,-2.11757e-13,-55292.3,4.3961], Tmin=(724.363,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OC(F)OF(1729)'],
    products = ['O=C(O)C(F)OF(2640)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OF(142)', 'O=C(O)[C]F(1512)'],
    products = ['O=C(O)C(F)OF(2640)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'O=C=C(F)OF(2669)'],
    products = ['O=C(O)C(F)OF(2640)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(O)[CH]OF(2357)'],
    products = ['O=C(O)C(F)OF(2640)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(=O)O(2675)'],
    products = ['O=C(O)C(F)OF(2640)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', 'O=C(O)[CH]F(1527)'],
    products = ['O=C(O)C(F)OF(2640)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'O=[C]C(F)OF(2086)'],
    products = ['O=C(O)C(F)OF(2640)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(F)OF(2676)'],
    products = ['O=C(O)C(F)OF(2640)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(614)', 'O=[C]O(165)'],
    products = ['O=C(O)C(F)OF(2640)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)[C](F)OF(2677)'],
    products = ['O=C(O)C(F)OF(2640)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(O)C(=O)F(1460)'],
    products = ['O=C(O)C(F)OF(2640)'],
