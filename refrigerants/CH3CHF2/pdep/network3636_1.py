...
"""),
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17635,0.0377558,-2.53395e-05,8.97748e-09,-1.32982e-12,-706.376,18.3263], Tmin=(100,'K'), Tmax=(1527.75,'K')), NASAPolynomial(coeffs=[8.89473,0.0201657,-8.06901e-06,1.44121e-09,-9.65972e-14,-2759.2,-16.9332], Tmin=(1527.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.43338,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (166.273,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,309.431,309.538,1588.88],'cm^-1')),
        HinderedRotor(inertia=(0.594674,'amu*angstrom^2'), symmetry=1, barrier=(40.4294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.59503,'amu*angstrom^2'), symmetry=1, barrier=(40.429,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41377,0.0372982,-2.10076e-05,5.4868e-09,-5.75299e-13,20052,16.5196], Tmin=(100,'K'), Tmax=(2046.52,'K')), NASAPolynomial(coeffs=[10.5295,0.0214357,-9.38112e-06,1.6994e-09,-1.12635e-13,16730.2,-28.446], Tmin=(2046.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CCJCO)"""),
)

species(
    label = 'C=[C]C[CH]O(11255)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (241.79,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,363.329,363.541],'cm^-1')),
        HinderedRotor(inertia=(0.0873158,'amu*angstrom^2'), symmetry=1, barrier=(8.19428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0875144,'amu*angstrom^2'), symmetry=1, barrier=(8.19515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0873376,'amu*angstrom^2'), symmetry=1, barrier=(8.19254,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79472,0.0512702,-6.29758e-05,4.61207e-08,-1.40077e-11,29157.5,20.7245], Tmin=(100,'K'), Tmax=(797.387,'K')), NASAPolynomial(coeffs=[7.39965,0.0231456,-1.0054e-05,1.86187e-09,-1.27451e-13,28263.9,-5.04541], Tmin=(797.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOH) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCC[O](11256)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {6,S} {7,S}
3  C u0 p0 c0 {1,S} {2,S} {8,S} {9,S}
...
"""),
    E0 = (296.452,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,246.738,1525.25],'cm^-1')),
        HinderedRotor(inertia=(0.160036,'amu*angstrom^2'), symmetry=1, barrier=(6.93619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16017,'amu*angstrom^2'), symmetry=1, barrier=(6.93249,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.02091,0.0321044,-1.57854e-05,3.34524e-09,-2.6993e-13,35678.3,17.4878], Tmin=(100,'K'), Tmax=(2745.26,'K')), NASAPolynomial(coeffs=[13.8707,0.0162955,-7.14732e-06,1.24752e-09,-7.88965e-14,29721.3,-45.8131], Tmin=(2745.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83335,0.0466857,-4.03795e-05,1.88142e-08,-3.62092e-12,21536.4,18.2313], Tmin=(100,'K'), Tmax=(1224.2,'K')), NASAPolynomial(coeffs=[9.7116,0.0209434,-8.83722e-06,1.63678e-09,-1.12961e-13,19607.6,-21.3703], Tmin=(1224.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]CCO(11257)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (308.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,3120,650,792.5,1650,284.018],'cm^-1')),
        HinderedRotor(inertia=(0.133365,'amu*angstrom^2'), symmetry=1, barrier=(7.62655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133101,'amu*angstrom^2'), symmetry=1, barrier=(7.6221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133264,'amu*angstrom^2'), symmetry=1, barrier=(7.62208,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02588,0.0455943,-4.6626e-05,2.85542e-08,-7.43458e-12,37183.9,20.7515], Tmin=(100,'K'), Tmax=(912.632,'K')), NASAPolynomial(coeffs=[7.09242,0.023388,-1.01277e-05,1.89254e-09,-1.31055e-13,36259.1,-3.22847], Tmin=(912.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
