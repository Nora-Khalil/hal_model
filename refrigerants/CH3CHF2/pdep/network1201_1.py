...
"""),
    E0 = (-686.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,1380,1390,370,380,2900,435,180,1731.9,1732.29,1732.85],'cm^-1')),
        HinderedRotor(inertia=(0.281794,'amu*angstrom^2'), symmetry=1, barrier=(6.479,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.281961,'amu*angstrom^2'), symmetry=1, barrier=(6.48285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2563,0.0718283,-0.000127624,1.28466e-07,-4.95221e-11,-82475.5,26.4301], Tmin=(100,'K'), Tmax=(822.755,'K')), NASAPolynomial(coeffs=[2.8581,0.0385647,-2.05335e-05,4.05765e-09,-2.84039e-13,-81876.8,24.2549], Tmin=(822.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-686.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFF) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)[CH]C(F)(F)F(3737)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-712.272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,357.431,1784.35,1788.38],'cm^-1')),
        HinderedRotor(inertia=(0.080459,'amu*angstrom^2'), symmetry=1, barrier=(6.91281,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0724229,'amu*angstrom^2'), symmetry=1, barrier=(6.9359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0744686,'amu*angstrom^2'), symmetry=1, barrier=(6.89603,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15308,0.068527,-0.000103429,8.9122e-08,-3.13116e-11,-85569.7,29.1346], Tmin=(100,'K'), Tmax=(756.524,'K')), NASAPolynomial(coeffs=[7.92982,0.0281842,-1.44931e-05,2.8665e-09,-2.02568e-13,-86465.9,-0.81507], Tmin=(756.524,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-712.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFF) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'OC(O)=CC(F)(F)F(3738)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
4  O u0 p2 c0 {8,S} {11,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.738528,'amu*angstrom^2'), symmetry=1, barrier=(16.9802,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.738987,'amu*angstrom^2'), symmetry=1, barrier=(16.9908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.739298,'amu*angstrom^2'), symmetry=1, barrier=(16.9979,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
...
"""),
    E0 = (-704.028,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,1855,455,950,348.238],'cm^-1')),
        HinderedRotor(inertia=(0.0876183,'amu*angstrom^2'), symmetry=1, barrier=(7.56472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0880821,'amu*angstrom^2'), symmetry=1, barrier=(7.56486,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-893.996,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,180,180,180,180,883.638,884.726,885.025],'cm^-1')),
        HinderedRotor(inertia=(0.00593185,'amu*angstrom^2'), symmetry=1, barrier=(3.2944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00594277,'amu*angstrom^2'), symmetry=1, barrier=(3.29093,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43885,0.0642354,-0.000103718,9.94108e-08,-3.7989e-11,-107438,21.8367], Tmin=(100,'K'), Tmax=(789.928,'K')), NASAPolynomial(coeffs=[4.60861,0.0335959,-1.78342e-05,3.54838e-09,-2.50678e-13,-107484,10.1729], Tmin=(789.928,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-893.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCC(F)(F)F(3732)'],
    products = ['O=C(O)CC(F)(F)F(3428)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CO2(14)', 'CC(F)(F)F(3045)'],
    products = ['O=C(O)CC(F)(F)F(3428)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=C=CC(F)(F)F(3733)'],
    products = ['O=C(O)CC(F)(F)F(3428)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)(F)F(3734)', 'CH2CO(28)'],
    products = ['O=C(O)CC(F)(F)F(3428)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(O)[CH]C(F)(F)F(3737)'],
    products = ['O=C(O)CC(F)(F)F(3428)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=C(O)C[C](F)F(1566)'],
    products = ['O=C(O)CC(F)(F)F(3428)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'O=[C]CC(F)(F)F(3739)'],
    products = ['O=C(O)CC(F)(F)F(3428)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)CC(F)(F)F(3740)'],
    products = ['O=C(O)CC(F)(F)F(3428)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF3(45)', '[CH2]C(=O)O(1378)'],
    products = ['O=C(O)CC(F)(F)F(3428)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]O(165)', '[CH2]C(F)(F)F(3044)'],
    products = ['O=C(O)CC(F)(F)F(3428)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O=C(O)[CH]C(F)(F)F(3741)'],
    products = ['O=C(O)CC(F)(F)F(3428)'],
