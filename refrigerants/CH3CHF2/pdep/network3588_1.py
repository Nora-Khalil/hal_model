...
"""),
    E0 = (-57.8961,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([364,474,579,619,655,1345,2950,1000,3000,3100,440,815,1455,1000,180,180,1243.07,1243.1,1243.15],'cm^-1')),
        HinderedRotor(inertia=(0.181408,'amu*angstrom^2'), symmetry=1, barrier=(4.17093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0351393,'amu*angstrom^2'), symmetry=1, barrier=(38.535,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95576,0.0410239,-3.49749e-05,1.4785e-08,-2.49186e-12,-6886.52,18.974], Tmin=(100,'K'), Tmax=(1414.4,'K')), NASAPolynomial(coeffs=[11.6137,0.0137109,-6.00902e-06,1.13221e-09,-7.86819e-14,-9618.55,-30.9683], Tmin=(1414.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.8961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cs-OsHHH) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (313.215,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,3000,3100,440,815,1455,1000,270.513,270.515,270.515,270.516,1040.32,2119.49,2119.49,4000],'cm^-1')),
        HinderedRotor(inertia=(0.472468,'amu*angstrom^2'), symmetry=1, barrier=(24.5337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.472456,'amu*angstrom^2'), symmetry=1, barrier=(24.5337,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04676,0.0470678,-7.47051e-05,6.44595e-08,-2.19401e-11,37737.5,16.5467], Tmin=(100,'K'), Tmax=(823.531,'K')), NASAPolynomial(coeffs=[7.0496,0.0166494,-8.15514e-06,1.56355e-09,-1.07849e-13,37121,-5.35799], Tmin=(823.531,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(oxirene) + radical(C=COCJ)"""),
)
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11504,0.0357767,-2.37449e-05,6.63001e-09,-5.38436e-13,-6897.58,19.6731], Tmin=(100,'K'), Tmax=(1388.39,'K')), NASAPolynomial(coeffs=[11.4761,0.0143414,-6.56551e-06,1.25192e-09,-8.69959e-14,-10030.3,-30.4813], Tmin=(1388.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.9528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-OsHHH) + ring(Cs(O2)-O2s-Cs(F)) + radical(Cs_P) + radical(CsJOCH3)"""),
)

species(
    label = 'FCO[C]1[CH]O1(10676)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41148,0.0481582,-5.1778e-05,2.8471e-08,-5.85241e-12,-8542.65,21.8266], Tmin=(100,'K'), Tmax=(1403.65,'K')), NASAPolynomial(coeffs=[12.0949,0.00909746,-8.28507e-07,-1.00627e-10,1.52638e-14,-10693,-30.3137], Tmin=(1403.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.8654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(CsFHHO) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC1(F)[CH]O1(10624)'],
    products = ['CH2O(20)', 'FC1=CO1(4047)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(13.2963,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C1(F)[CH]O1(5683)'],
    products = ['[CH2]OC1(F)[CH]O1(10624)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2]OC1(F)[CH]O1(10624)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.66944e+13,'m^3/(mol*s)'), n=-2.06969, Ea=(72.0203,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.21909771748945858, var=15.050572460742625, Tref=1000.0, N=2985, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC1=CO1(10675)'],
    products = ['[CH2]OC1(F)[CH]O1(10624)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(12.1904,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OC1(F)[CH]O1(10624)'],
    products = ['FCO[C]1[CH]O1(10676)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(220.942,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #3588',
    isomers = [
        '[CH2]OC1(F)[CH]O1(10624)',
    ],
    reactants = [
