...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56935,0.0444349,-1.25475e-05,-1.53881e-08,9.06767e-12,-16008.4,19.38], Tmin=(100,'K'), Tmax=(1000.7,'K')), NASAPolynomial(coeffs=[12.2687,0.0215494,-8.04537e-06,1.467e-09,-1.03317e-13,-19145.3,-37.2196], Tmin=(1000.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH)"""),
)
...
"""),
    E0 = (116.75,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,334,575,1197,1424,3202,2100,2250,500,550,180,3936.76],'cm^-1')),
        HinderedRotor(inertia=(3.37615,'amu*angstrom^2'), symmetry=1, barrier=(77.6243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.3767,'amu*angstrom^2'), symmetry=1, barrier=(77.6369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.37503,'amu*angstrom^2'), symmetry=1, barrier=(77.5985,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73178,0.0482985,-4.24708e-05,2.25127e-08,-5.01679e-12,14124.8,21.4829], Tmin=(100,'K'), Tmax=(1069.42,'K')), NASAPolynomial(coeffs=[8.17034,0.024216,-8.69195e-06,1.45527e-09,-9.41589e-14,12747.7,-10.0115], Tmin=(1069.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsHH) + group(CsCsFHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Csj(Cs-CtHH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.433463,'amu*angstrom^2'), symmetry=1, barrier=(9.96617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433733,'amu*angstrom^2'), symmetry=1, barrier=(9.97238,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433453,'amu*angstrom^2'), symmetry=1, barrier=(9.96593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08756,0.0489964,-2.70756e-05,-2.42669e-08,3.4123e-11,28241.8,20.7325], Tmin=(100,'K'), Tmax=(503.318,'K')), NASAPolynomial(coeffs=[5.20539,0.0347918,-1.62543e-05,3.13828e-09,-2.2099e-13,27794.1,6.50076], Tmin=(503.318,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C=C[CH]F(6421)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71875,0.0417396,-9.48898e-06,-1.25981e-08,6.26985e-12,5420.16,20.0905], Tmin=(100,'K'), Tmax=(1107.97,'K')), NASAPolynomial(coeffs=[10.747,0.0260232,-1.10608e-05,2.09611e-09,-1.47888e-13,2383.64,-29.0659], Tmin=(1107.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.3242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', 'C=C[C]C(6411)'],
    products = ['C[C]=CC[CH]F(6361)'],
    transitionState = 'TS3',
