...
"""),
    E0 = (-436.283,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,199.928,199.972,495.453],'cm^-1')),
        HinderedRotor(inertia=(0.436229,'amu*angstrom^2'), symmetry=1, barrier=(12.3785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.927334,'amu*angstrom^2'), symmetry=1, barrier=(26.3083,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CH3F(39)', 'F[C]COF(492)'],
    products = ['FCC(F)COF(6853)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)COF(6855)'],
    products = ['FCC(F)COF(6853)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(25)', 'FOCC(F)F(3376)'],
    products = ['FCC(F)COF(6853)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)COF(505)'],
    products = ['FCC(F)COF(6853)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', '[CH2]C(F)CF(961)'],
    products = ['FCC(F)COF(6853)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(186)', 'CH2F-CHF(66)'],
    products = ['FCC(F)COF(6853)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'F[CH]COF(502)'],
    products = ['FCC(F)COF(6853)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FCC(F)[CH]OF(6858)'],
    products = ['FCC(F)COF(6853)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'F[CH]C(F)COF(6859)'],
    products = ['FCC(F)COF(6853)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'C=C(F)COF(3387)'],
    products = ['FCC(F)COF(6853)'],
