...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C=C(O)O(1836)'],
    products = ['C=C(O)OCF(1722)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C=C(O)OF(1731)'],
    products = ['C=C(O)OCF(1722)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]OC(=C)O(1842)'],
    products = ['C=C(O)OCF(1722)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=O)OCF(1843)'],
    products = ['C=C(O)OCF(1722)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C(O)O[CH]F(1844)'],
    products = ['C=C(O)OCF(1722)'],
