...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'O=C[C](F)F(3117)'],
    products = ['[O]OC(F)(F)C=O(4341)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OF(125)', 'O=C[C]F-2(1532)'],
    products = ['[O]OC(F)(F)C=O(4341)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)(F)C=O(4407)'],
    products = ['[O]OC(F)(F)C=O(4341)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]O[C](F)C=O(1584)'],
    products = ['[O]OC(F)(F)C=O(4341)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(2943)', 'HCO(15)'],
    products = ['[O]OC(F)(F)C=O(4341)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(F)(F)[C]=O(4410)'],
    products = ['[O]OC(F)(F)C=O(4341)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O]OC(F)=C=O(3604)'],
    products = ['[O]OC(F)(F)C=O(4341)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(6)', 'FC1(F)[CH]OO1(4288)'],
    products = ['[O]C1OOC1(F)F(4409)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C1OOC1(F)F(4656)'],
    products = ['[O]C1OOC1(F)F(4409)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', '[O]C1OO[C]1F(5215)'],
    products = ['[O]C1OOC1(F)F(4409)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', '[O][C]1OOC1(F)F(4910)'],
    products = ['[O]C1OOC1(F)F(4409)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C1OO[C]1F(5216)'],
    products = ['[O]C1OOC1(F)F(4409)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C1OOC1(F)F(4409)'],
    products = ['O[C]1OOC1(F)F(5217)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F(37)', 'O=COO[C]F(5851)'],
    products = ['O=COO[C](F)F(5214)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[C]F(2927)', '[O]OC=O(539)'],
    products = ['O=COO[C](F)F(5214)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[O][C](F)F(4778)', '[O]C=O(166)'],
    products = ['O=COO[C](F)F(5214)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(5)', 'O=[C]OO[C](F)F(4655)'],
    products = ['O=COO[C](F)F(5214)'],
...
reaction(
    label = 'reaction34',
    reactants = ['F(37)', 'O=CO[O+]=[C-]F(5853)'],
    products = ['O=COO[C](F)F(5214)'],
