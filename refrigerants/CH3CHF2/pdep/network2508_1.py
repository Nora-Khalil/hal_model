...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.50217,'amu*angstrom^2'), symmetry=1, barrier=(34.5378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50459,'amu*angstrom^2'), symmetry=1, barrier=(34.5936,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (65.0931,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35411,0.0280261,6.59314e-06,-3.00906e-08,1.42287e-11,57270.9,16.6206], Tmin=(100,'K'), Tmax=(942.26,'K')), NASAPolynomial(coeffs=[10.3089,0.014648,-4.57103e-06,7.74972e-10,-5.40783e-14,54866.5,-26.0872], Tmin=(942.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(475.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtHHH) + group(Cds-CdsCtH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93024,0.040216,-1.90497e-05,2.9071e-09,1.9569e-13,57973.2,18.3865], Tmin=(100,'K'), Tmax=(1447.49,'K')), NASAPolynomial(coeffs=[9.34157,0.0258183,-1.04332e-05,1.84177e-09,-1.21731e-13,55190.4,-22.311], Tmin=(1447.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23327,0.0315225,1.36839e-06,-2.34455e-08,1.12912e-11,50542,16.7985], Tmin=(100,'K'), Tmax=(960.487,'K')), NASAPolynomial(coeffs=[9.48039,0.0189611,-6.53113e-06,1.13664e-09,-7.83442e-14,48337.1,-22.1033], Tmin=(960.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_S) + radical(C=C=CJ)"""),
)

species(
    label = '[CH2][CH]C#CC(6438)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {4,S} {6,S} {7,S} {8,S}
...
"""),
    E0 = (458.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2100,2250,500,550,180],'cm^-1')),
        HinderedRotor(inertia=(0.00564395,'amu*angstrom^2'), symmetry=1, barrier=(7.0798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.8146,'amu*angstrom^2'), symmetry=1, barrier=(64.7131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0516496,'amu*angstrom^2'), symmetry=1, barrier=(64.7046,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85394,0.0381054,-2.73467e-05,1.19139e-08,-2.09346e-12,55272.8,21.364], Tmin=(100,'K'), Tmax=(1605.93,'K')), NASAPolynomial(coeffs=[7.64729,0.0187318,-4.63339e-06,5.68093e-10,-2.88099e-14,54049.6,-7.3451], Tmin=(1605.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(458.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Sec_Propargyl) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC=[C]C(6339)'],
    products = ['C2H2(23)', 'C#CC(5603)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[CH](264)', '[CH]=[C]C(5604)'],
    products = ['[CH]=CC=[C]C(6339)'],
    transitionState = 'TS9',
