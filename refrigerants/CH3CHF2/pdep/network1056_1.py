...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[O]C[C](F)F(2986)'],
    products = ['O=[C]OC[C](F)F(2998)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]O[C]=O(292)'],
    products = ['O=[C]OC[C](F)F(2998)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C[C](F)F(2986)'],
    products = ['O=[C]OC[C](F)F(2998)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC=C(F)F(3238)'],
    products = ['O=[C]OC[C](F)F(2998)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]O[C]=O(292)'],
    products = ['O=[C]OC[C](F)F(2998)'],
