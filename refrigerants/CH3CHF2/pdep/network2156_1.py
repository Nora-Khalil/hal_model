...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C1O[C]1F(5672)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)C1O[C]1F(5672)'],
    products = ['[O]C1(F)O[C](F)C1F(5711)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)(F)C1(F)[CH]O1(5671)'],
    products = ['[O]C(F)(F)C1O[C]1F(5672)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C1O[C]1F(5712)'],
    products = ['[O]C(F)(F)C1O[C]1F(5672)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)C1O[C]1F(5672)'],
    products = ['OC(F)(F)C1=C(F)O1(5713)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C1=C(F)O1(5715)'],
    products = ['[O]C(F)(F)C1O[C]1F(5672)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C(F)C1O[C]1F(5716)'],
    products = ['[O]C(F)(F)C1O[C]1F(5672)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)[C]1O[C]1F(5717)'],
    products = ['[O]C(F)(F)C1O[C]1F(5672)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)(F)C1O[C]1F(5672)'],
    products = ['OC(F)(F)[C]1O[C]1F(5719)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FO[C](F)C1O[C]1F(5720)'],
    products = ['[O]C(F)(F)C1O[C]1F(5672)'],
