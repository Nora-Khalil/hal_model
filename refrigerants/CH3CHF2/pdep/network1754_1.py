...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(4646)', '[C]=C(395)'],
    products = ['C=[C]OC([O])(F)F(4671)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C=[C]O[C](F)F(3211)'],
    products = ['C=[C]OC([O])(F)F(4671)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(=O)F(1016)'],
    products = ['C=[C]OC([O])(F)F(4671)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC([O])(F)F(4663)'],
    products = ['C=[C]OC([O])(F)F(4671)'],
    transitionState = 'TS8',
