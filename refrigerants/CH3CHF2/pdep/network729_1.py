...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'C=C(O)C(=O)[C]F(2628)'],
    products = ['C=C(O)C(=O)CF(2056)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(O)C(=O)[CH]F(2633)'],
    products = ['C=C(O)C(=O)CF(2056)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction18',
    reactants = ['OH(7)', 'C=C=C([O])CF(2640)'],
    products = ['C=C(O)C(=O)CF(2056)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)CF(2641)'],
    products = ['C=C(O)C(=O)CF(2056)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2F(46)', 'C=C(O)[C]=O(2421)'],
    products = ['C=C(O)C(=O)CF(2056)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'C=C(O)C([O])=CF(2642)'],
    products = ['C=C(O)C(=O)CF(2056)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', '[CH]=C(O)C(=O)CF(2643)'],
    products = ['C=C(O)C(=O)CF(2056)'],
