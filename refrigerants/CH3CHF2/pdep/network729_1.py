...
"""),
    E0 = (-401.229,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,232,360,932,1127,1349,1365,3045,375,552.5,462.5,1710,262,1290,233.844,233.844],'cm^-1')),
        HinderedRotor(inertia=(0.00308224,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200541,'amu*angstrom^2'), symmetry=1, barrier=(7.78037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.661487,'amu*angstrom^2'), symmetry=1, barrier=(25.67,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24122,0.0657715,-0.000106593,8.99001e-08,-2.99157e-11,-48162.3,22.5929], Tmin=(100,'K'), Tmax=(796.288,'K')), NASAPolynomial(coeffs=[9.75354,0.0186635,-9.66379e-06,1.89187e-09,-1.32043e-13,-49380.1,-15.6695], Tmin=(796.288,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-401.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + group(CJ2_singlet-FCO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0957976,'amu*angstrom^2'), symmetry=1, barrier=(2.20258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.099313,'amu*angstrom^2'), symmetry=1, barrier=(2.2834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.19682,'amu*angstrom^2'), symmetry=1, barrier=(50.5091,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38627,0.0657878,-0.000106461,1.02773e-07,-3.94645e-11,-48587.7,23.2413], Tmin=(100,'K'), Tmax=(791.57,'K')), NASAPolynomial(coeffs=[4.3539,0.0350962,-1.85588e-05,3.69174e-09,-2.608e-13,-48565.8,12.7239], Tmin=(791.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-404.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'C=C(OF)C(O)F(2067)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {11,S}
...
"""),
    E0 = (-442.451,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,395,473,707,1436,271.036,271.038,271.038],'cm^-1')),
        HinderedRotor(inertia=(0.172924,'amu*angstrom^2'), symmetry=1, barrier=(9.01446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172923,'amu*angstrom^2'), symmetry=1, barrier=(9.01446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.355527,'amu*angstrom^2'), symmetry=1, barrier=(18.5334,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.894771,0.0737188,-0.000113127,9.3736e-08,-3.10335e-11,-53108,25.2871], Tmin=(100,'K'), Tmax=(785.192,'K')), NASAPolynomial(coeffs=[9.94268,0.0242046,-1.20005e-05,2.32522e-09,-1.61975e-13,-54423.4,-15.5042], Tmin=(785.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-442.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFHH) + radical(CC(C)OJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C([CH]F)C(O)F(2258)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-442.449,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,261,493,600,1152,1365,1422,3097,334,575,1197,1424,3202,361.224,361.404,361.471],'cm^-1')),
        HinderedRotor(inertia=(0.0829952,'amu*angstrom^2'), symmetry=1, barrier=(7.70476,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0831445,'amu*angstrom^2'), symmetry=1, barrier=(7.7045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.307966,'amu*angstrom^2'), symmetry=1, barrier=(28.5539,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06365,0.0716993,-0.000100143,6.96873e-08,-1.65201e-11,-53115.3,24.2365], Tmin=(100,'K'), Tmax=(619.671,'K')), NASAPolynomial(coeffs=[9.80755,0.0254798,-1.30083e-05,2.56613e-09,-1.81256e-13,-54395.3,-15.347], Tmin=(619.671,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-442.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFHH) + radical(CC(C)OJ) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-410.432,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,391,562,707,872,1109,1210,1289,3137,528,1116,1182,1331,1402,1494,3075,3110,286.621,286.631,286.671],'cm^-1')),
        HinderedRotor(inertia=(0.150908,'amu*angstrom^2'), symmetry=1, barrier=(8.79929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244586,'amu*angstrom^2'), symmetry=1, barrier=(14.2624,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42025,0.0594342,-6.63549e-05,3.96144e-08,-9.64429e-12,-49272.9,23.5097], Tmin=(100,'K'), Tmax=(987.705,'K')), NASAPolynomial(coeffs=[10.4573,0.0228365,-1.07756e-05,2.10072e-09,-1.49223e-13,-51058.1,-19.9771], Tmin=(987.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-410.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFHH) + radical(CC(C)OJ) + radical(O2sj(Cs-CsF1sH))"""),
)

species(
    label = '[O]C(F)[C](O)CF(2260)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {7,S} {11,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.378567,'amu*angstrom^2'), symmetry=1, barrier=(8.70399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.378191,'amu*angstrom^2'), symmetry=1, barrier=(8.69535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.378157,'amu*angstrom^2'), symmetry=1, barrier=(8.69458,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868767,0.0750803,-0.000120308,1.02456e-07,-3.41848e-11,-55719.3,25.0954], Tmin=(100,'K'), Tmax=(836.188,'K')), NASAPolynomial(coeffs=[9.56728,0.0239738,-1.15954e-05,2.20137e-09,-1.50656e-13,-56842.1,-13.3286], Tmin=(836.188,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-464.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFHH) + radical(O2sj(Cs-CsF1sH)) + radical(C2CsJOH)"""),
)

species(
    label = 'OC(F)=C(O)CF(2261)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.855903,'amu*angstrom^2'), symmetry=1, barrier=(19.6789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.85687,'amu*angstrom^2'), symmetry=1, barrier=(19.7011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.855461,'amu*angstrom^2'), symmetry=1, barrier=(19.6687,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.977403,0.0669979,-7.89528e-05,4.64732e-08,-1.07813e-11,-87858.4,21.0913], Tmin=(100,'K'), Tmax=(1051.76,'K')), NASAPolynomial(coeffs=[14.0298,0.0173568,-8.15436e-06,1.59622e-09,-1.14015e-13,-90604,-42.5376], Tmin=(1051.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-731.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'OC(=CF)C(O)F(2262)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-739.228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,236,527,855,1015,1182,1348,3236,350,440,435,1725,194,682,905,1196,1383,3221,203.557],'cm^-1')),
        HinderedRotor(inertia=(0.492556,'amu*angstrom^2'), symmetry=1, barrier=(11.338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.531223,'amu*angstrom^2'), symmetry=1, barrier=(15.5547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.96399,'amu*angstrom^2'), symmetry=1, barrier=(28.604,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17628,0.0642969,-7.5201e-05,4.5144e-08,-1.08421e-11,-88808.6,21.1909], Tmin=(100,'K'), Tmax=(1009.39,'K')), NASAPolynomial(coeffs=[12.2884,0.0202618,-9.76246e-06,1.92396e-09,-1.37606e-13,-91051.9,-32.5224], Tmin=(1009.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-739.228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02774,'amu*angstrom^2'), symmetry=1, barrier=(23.6298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03027,'amu*angstrom^2'), symmetry=1, barrier=(23.6879,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.38457,0.060569,-6.52864e-05,3.25289e-08,-5.92091e-12,-52193.8,22.7083], Tmin=(100,'K'), Tmax=(1596.41,'K')), NASAPolynomial(coeffs=[18.5351,0.00223473,1.60447e-06,-4.49412e-10,3.35069e-14,-56350.7,-68.2165], Tmin=(1596.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-435.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ)"""),
)

species(
    label = 'C=C([O])C(O)F(2093)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.580255,'amu*angstrom^2'), symmetry=1, barrier=(13.3412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0614334,'amu*angstrom^2'), symmetry=1, barrier=(15.8585,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61427,0.0508368,-5.33027e-05,2.87489e-08,-6.15611e-12,-52402.5,19.6507], Tmin=(100,'K'), Tmax=(1134.5,'K')), NASAPolynomial(coeffs=[11.6761,0.0153608,-6.39745e-06,1.18587e-09,-8.22792e-14,-54685.6,-30.1616], Tmin=(1134.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-436.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
"""),
    E0 = (-414.739,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,235,1215,1347,1486,3221,375.494,376.627],'cm^-1')),
        HinderedRotor(inertia=(0.314415,'amu*angstrom^2'), symmetry=1, barrier=(31.524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.31323,'amu*angstrom^2'), symmetry=1, barrier=(31.5336,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-616.178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,232,360,932,1127,1349,1365,3045,375,552.5,462.5,1710,235,1215,1347,1486,3221,312.54,312.575],'cm^-1')),
        HinderedRotor(inertia=(0.00172599,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237144,'amu*angstrom^2'), symmetry=1, barrier=(16.4336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.669243,'amu*angstrom^2'), symmetry=1, barrier=(46.3897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63731,0.0548563,-6.2571e-05,3.78939e-08,-9.35258e-12,-74026.4,20.9948], Tmin=(100,'K'), Tmax=(974.646,'K')), NASAPolynomial(coeffs=[9.94812,0.0207475,-1.00756e-05,1.98579e-09,-1.41829e-13,-75646.4,-18.8864], Tmin=(974.646,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-616.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(Csj(CO-CsO2d)(F1s)(H))"""),
)

species(
    label = 'O=CC(=O)CF(2269)',
    structure = adjacencyList("""1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {5,D}
3 O u0 p2 c0 {6,D}
4 C u0 p0 c0 {1,S} {5,S} {7,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0920401,'amu*angstrom^2'), symmetry=1, barrier=(15.8384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70442,'amu*angstrom^2'), symmetry=1, barrier=(39.188,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44319,0.0383989,-3.41159e-05,1.70825e-08,-3.8049e-12,-54041.6,16.9588], Tmin=(100,'K'), Tmax=(1013.13,'K')), NASAPolynomial(coeffs=[6.27353,0.0232759,-1.17252e-05,2.34875e-09,-1.69157e-13,-54817.8,-1.57033], Tmin=(1013.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-449.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'O=C([C]F)CF(2254)'],
    products = ['O=C(CF)C(O)F(2069)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'O=C([C]F)C(O)F(2255)'],
    products = ['O=C(CF)C(O)F(2069)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'C=C([O])C(O)F(2093)'],
    products = ['O=C(CF)C(O)F(2069)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'O=C([CH]F)CF(2264)'],
    products = ['O=C(CF)C(O)F(2069)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(F)C(=O)CF(2265)'],
    products = ['O=C(CF)C(O)F(2069)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(CF)[C](O)F(2266)'],
    products = ['O=C(CF)C(O)F(2069)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2F(46)', 'O=[C]C(O)F(2267)'],
    products = ['O=C(CF)C(O)F(2069)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=C([CH]F)C(O)F(2268)'],
    products = ['O=C(CF)C(O)F(2069)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=CC(=O)CF(2269)'],
    products = ['O=C(CF)C(O)F(2069)'],
