...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C1(F)[CH]O1(5663)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)[C]1[CH]O1(5696)'],
    products = ['[O]C(=O)C1(F)[CH]O1(5663)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C1(F)[CH]O1(5698)'],
    products = ['[O]C(=O)C1(F)[CH]O1(5663)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C1(F)[CH]O1(5663)'],
    products = ['FC1([C]2OO2)[CH]O1(5699)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(=O)C1=CO1(5702)'],
    products = ['[O]C(=O)C1(F)[CH]O1(5663)'],
