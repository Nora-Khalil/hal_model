...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(395)', '[O]C(F)[CH]F(647)'],
    products = ['C=[C]OC(F)[CH]F(5605)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=[C]OC(F)=CF(4073)'],
    products = ['C=[C]OC(F)[CH]F(5605)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#COC(F)[CH]F(5672)'],
    products = ['C=[C]OC(F)[CH]F(5605)'],
