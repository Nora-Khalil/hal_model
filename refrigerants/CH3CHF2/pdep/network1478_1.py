...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CF2CH(73)'],
    products = ['[O]OC=C(F)F(3115)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC=C(F)F(3115)'],
    products = ['FC1(F)[CH]OO1(4288)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[O]O[C]=C(F)F(4290)'],
    products = ['[O]OC=C(F)F(3115)'],
    transitionState = 'TS6',
