...
species(
    label = 'O[CH]C(F)(F)C(F)(F)OF(9739)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.300191,'amu*angstrom^2'), symmetry=1, barrier=(6.90197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.90447,'amu*angstrom^2'), symmetry=1, barrier=(43.7875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.568005,'amu*angstrom^2'), symmetry=1, barrier=(13.0596,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.45964,0.108511,-0.000193135,1.70778e-07,-5.8361e-11,-123810,28.0136], Tmin=(100,'K'), Tmax=(820.393,'K')), NASAPolynomial(coeffs=[13.1571,0.0266084,-1.50244e-05,2.99669e-09,-2.09655e-13,-125522,-31.8024], Tmin=(820.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1030.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'OC([C](F)F)[C](F)OF(9924)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.293688,'amu*angstrom^2'), symmetry=1, barrier=(6.75248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.293703,'amu*angstrom^2'), symmetry=1, barrier=(6.7528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.293724,'amu*angstrom^2'), symmetry=1, barrier=(6.75329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0674042,0.0942739,-0.000160115,1.37153e-07,-4.57606e-11,-103509,30.275], Tmin=(100,'K'), Tmax=(814.772,'K')), NASAPolynomial(coeffs=[12.6529,0.0232749,-1.24452e-05,2.44804e-09,-1.7051e-13,-105255,-25.9879], Tmin=(814.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-861.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = 'FOC(F)(F)[CH][C](F)F(9926)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.297168,'amu*angstrom^2'), symmetry=1, barrier=(6.83248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.29639,'amu*angstrom^2'), symmetry=1, barrier=(6.8146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25279,'amu*angstrom^2'), symmetry=1, barrier=(28.804,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.423219,0.0914651,-0.000175505,1.66961e-07,-5.99609e-11,-83409.1,25.9271], Tmin=(100,'K'), Tmax=(842.215,'K')), NASAPolynomial(coeffs=[8.10373,0.0284174,-1.58939e-05,3.16083e-09,-2.20048e-13,-83760.4,-4.21362], Tmin=(842.215,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-694.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sCsH)(F1s)(F1s)) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.379301,'amu*angstrom^2'), symmetry=1, barrier=(8.72088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.378767,'amu*angstrom^2'), symmetry=1, barrier=(8.7086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.972235,'amu*angstrom^2'), symmetry=1, barrier=(22.3536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379854,'amu*angstrom^2'), symmetry=1, barrier=(8.7336,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.843527,0.120161,-0.000227981,2.05798e-07,-7.01957e-11,-97328.2,32.5494], Tmin=(100,'K'), Tmax=(855.131,'K')), NASAPolynomial(coeffs=[13.7692,0.0251245,-1.44703e-05,2.85297e-09,-1.9611e-13,-98851.7,-29.9571], Tmin=(855.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-810.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(C2CsJOH) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-601.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,617,898,1187,256.063,256.067],'cm^-1')),
...
species(
    label = '[O]C(F)(F)C(O)C(F)(F)F(9932)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    ...
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OC([C](F)F)C(F)(F)OF(9707)'],
    products = ['O[CH]C(F)(F)C(F)(F)OF(9739)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC([C]F)C(F)(F)OF(9921)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(2927)', 'O[CH]C(F)(F)OF(4931)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'FOC(F)(F)C=C(F)F(9922)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FO[C](F)F(4688)', 'OC=C(F)F(4347)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'OC(=C(F)F)C(F)(F)OF(9923)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'OC([C](F)F)[C](F)OF(9924)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)(F)C(O)[C](F)F(9925)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'FOC(F)(F)[CH][C](F)F(9926)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C([C](F)F)C(F)(F)OF(9812)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', 'OC([C](F)F)[C](F)F(9927)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(4688)', 'O[CH][C](F)F(4343)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O[C]([C](F)F)C(F)(F)OF(9928)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'O=C(F)C(O)[C](F)F(9929)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'OC([C](F)F)=C(F)OF(9930)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', 'OC([C]F)C(F)(F)OF-2(9931)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CF2(43)', 'O[CH]C(F)(F)OF(4931)'],
    products = ['OC([C](F)F)C(F)(F)OF(9707)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OC([C](F)F)C(F)(F)OF(9707)'],
    products = ['O[C](C(F)F)C(F)(F)OF(9816)'],
...
reaction(
    label = 'reaction22',
    reactants = ['OC([C](F)F)C(F)(F)OF(9707)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(9713)'],
...
reaction(
    label = 'reaction23',
    reactants = ['OC([C](F)F)C(F)(F)OF(9707)'],
    products = ['[O]C(F)(F)C(O)C(F)(F)F(9932)'],
...
reaction(
    label = 'reaction24',
    reactants = ['OC([C](F)F)C(F)(F)OF(9707)'],
    products = ['OC([C](F)OF)C(F)(F)F(9933)'],
