...
reaction(
    label = 'reaction5',
    reactants = ['OF(142)', 'O=C=C(O)F(2658)'],
    products = ['O=C(OF)C(O)F(2641)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C([CH]O)OF(2365)'],
    products = ['O=C(OF)C(O)F(2641)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(=O)C(O)F(2665)'],
    products = ['O=C(OF)C(O)F(2641)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C(=O)OF(2666)'],
    products = ['O=C(OF)C(O)F(2641)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(126)', 'O=[C]C(O)F(2267)'],
    products = ['O=C(OF)C(O)F(2641)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(OF)[C](O)F(2667)'],
    products = ['O=C(OF)C(O)F(2641)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC(=O)OF(2668)'],
    products = ['O=C(OF)C(O)F(2641)'],
