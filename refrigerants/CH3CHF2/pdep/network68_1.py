...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C=CF(270)'],
    products = ['[CH]=CC([CH2])F(200)'],
    transitionState = 'TS3',
