...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)OO[O](476)'],
    products = ['O2(2)', 'FC1CO1(285)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(F)O[O](222)'],
    products = ['[CH2]C(F)OO[O](476)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OO[CH]F(481)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)OO[O](476)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[O](127)', '[CH2][CH]F(233)'],
    products = ['[CH2]C(F)OO[O](476)'],
