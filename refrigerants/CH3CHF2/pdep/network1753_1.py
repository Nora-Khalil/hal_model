...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56958,0.054151,-7.30189e-05,5.2502e-08,-1.44787e-11,-33134.2,23.1749], Tmin=(100,'K'), Tmax=(1023.63,'K')), NASAPolynomial(coeffs=[9.6381,0.0150097,-4.50752e-06,6.17269e-10,-3.2725e-14,-34387.3,-13.9915], Tmin=(1023.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(CsFFHO) + ring(Ethylene_oxide) + radical(Cs_P) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2][C]1OC(F)(F)O1(4883)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[C](F)F(4670)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[C](F)F(3241)'],
    products = ['[CH2]C(=O)O[C](F)F(4670)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[C](F)F(4670)'],
    products = ['[CH2][C]1OC(F)(F)O1(4883)'],
    transitionState = 'TS6',
