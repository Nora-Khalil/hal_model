...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)C([O])(O)F(7294)'],
    products = ['[O]C(O)C([O])(F)F(7259)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(F)(F)[CH]O(4865)'],
    products = ['[O]C(O)C([O])(F)F(7259)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(O)[C](F)F(4542)'],
    products = ['[O]C(O)C([O])(F)F(7259)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', '[O]C(F)(F)C=O(4407)'],
    products = ['[O]C(O)C([O])(F)F(7259)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C(=O)O(5014)'],
    products = ['[O]C(O)C([O])(F)F(7259)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(O)C(=O)F(7165)'],
    products = ['[O]C(O)C([O])(F)F(7259)'],
