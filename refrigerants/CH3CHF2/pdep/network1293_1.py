...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.219005,'amu*angstrom^2'), symmetry=1, barrier=(5.03536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59871,'amu*angstrom^2'), symmetry=1, barrier=(36.7576,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219549,'amu*angstrom^2'), symmetry=1, barrier=(5.04787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5881,'amu*angstrom^2'), symmetry=1, barrier=(36.5134,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.870932,0.078405,-9.48957e-05,4.93715e-08,-3.91995e-13,-28726.4,28.02], Tmin=(100,'K'), Tmax=(559.985,'K')), NASAPolynomial(coeffs=[8.86155,0.0355736,-1.83258e-05,3.64426e-09,-2.59212e-13,-29844.7,-7.89114], Tmin=(559.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-239.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.573665,0.0819899,-0.000118199,9.78549e-08,-3.3367e-11,-67661.9,27.5279], Tmin=(100,'K'), Tmax=(728.611,'K')), NASAPolynomial(coeffs=[9.09978,0.034071,-1.726e-05,3.40367e-09,-2.4068e-13,-68874.8,-10.7037], Tmin=(728.611,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-563.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (203.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,271.255,272.43,272.518,272.917],'cm^-1')),
        HinderedRotor(inertia=(0.00228804,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0135624,'amu*angstrom^2'), symmetry=1, barrier=(43.9795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0565126,'amu*angstrom^2'), symmetry=1, barrier=(43.9801,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17624,'amu*angstrom^2'), symmetry=1, barrier=(9.27263,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31434,0.0643299,-7.09498e-05,4.39228e-08,-1.14804e-11,24561.1,25.4715], Tmin=(100,'K'), Tmax=(907.356,'K')), NASAPolynomial(coeffs=[8.94731,0.0306803,-1.53211e-05,3.04988e-09,-2.18791e-13,23176,-10.6111], Tmin=(907.356,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.153381,'amu*angstrom^2'), symmetry=1, barrier=(3.52654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.16151,'amu*angstrom^2'), symmetry=1, barrier=(49.6974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4148,0.062743,-6.50604e-05,3.73978e-08,-9.18165e-12,-32006.4,26.2505], Tmin=(100,'K'), Tmax=(953.624,'K')), NASAPolynomial(coeffs=[8.81281,0.0317125,-1.62522e-05,3.27747e-09,-2.36932e-13,-33417.4,-9.08954], Tmin=(953.624,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-266.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[CH]=COOC[CH]F(3712)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {3,S} {4,S}
3  O u0 p2 c0 {2,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.718152,'amu*angstrom^2'), symmetry=1, barrier=(16.5117,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717989,'amu*angstrom^2'), symmetry=1, barrier=(16.508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.82767,'amu*angstrom^2'), symmetry=1, barrier=(42.0218,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717937,'amu*angstrom^2'), symmetry=1, barrier=(16.5068,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.844211,0.073703,-9.30103e-05,6.21798e-08,-1.67687e-11,20843.5,26.9994], Tmin=(100,'K'), Tmax=(900.208,'K')), NASAPolynomial(coeffs=[11.7436,0.0252726,-1.23117e-05,2.41694e-09,-1.71793e-13,18881.2,-24.438], Tmin=(900.208,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-53.2641,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,194,682,905,1196,1383,3221,180,2291.6],'cm^-1')),
        HinderedRotor(inertia=(0.334623,'amu*angstrom^2'), symmetry=1, barrier=(7.69363,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68366,'amu*angstrom^2'), symmetry=1, barrier=(38.7107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68275,'amu*angstrom^2'), symmetry=1, barrier=(38.6898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68055,'amu*angstrom^2'), symmetry=1, barrier=(38.6391,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437679,0.0868005,-0.000140358,1.25282e-07,-4.45198e-11,-6286.07,29.7949], Tmin=(100,'K'), Tmax=(792.961,'K')), NASAPolynomial(coeffs=[8.6491,0.0336588,-1.76629e-05,3.48888e-09,-2.45168e-13,-7219.87,-5.59218], Tmin=(792.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.2641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)

species(
    label = 'F[CH]COO[C]=CF(3714)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-0.731555,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,615,860,1140,1343,3152,1685,370,180,180,553.335],'cm^-1')),
        HinderedRotor(inertia=(1.9685,'amu*angstrom^2'), symmetry=1, barrier=(45.2596,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204536,'amu*angstrom^2'), symmetry=1, barrier=(4.70269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.513752,'amu*angstrom^2'), symmetry=1, barrier=(11.8122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.96978,'amu*angstrom^2'), symmetry=1, barrier=(45.2892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.337543,0.0897387,-0.000148747,1.34169e-07,-4.77766e-11,35.0184,29.2742], Tmin=(100,'K'), Tmax=(802.732,'K')), NASAPolynomial(coeffs=[8.70236,0.0338928,-1.79249e-05,3.54103e-09,-2.48409e-13,-851.568,-6.4007], Tmin=(802.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.731555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = 'F[C]=COOC[CH]F(3715)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.308451,'amu*angstrom^2'), symmetry=1, barrier=(7.0919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308688,'amu*angstrom^2'), symmetry=1, barrier=(7.09734,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.245033,0.0931833,-0.000161242,1.47607e-07,-5.23615e-11,2441.17,30.5539], Tmin=(100,'K'), Tmax=(828.765,'K')), NASAPolynomial(coeffs=[8.53762,0.0334956,-1.7622e-05,3.44836e-09,-2.39546e-13,1741.96,-3.82135], Tmin=(828.765,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.2578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.08313,'amu*angstrom^2'), symmetry=1, barrier=(24.9033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.19174,'amu*angstrom^2'), symmetry=1, barrier=(50.3925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0813287,'amu*angstrom^2'), symmetry=1, barrier=(1.86991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.19119,'amu*angstrom^2'), symmetry=1, barrier=(50.3798,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.779965,0.0776766,-0.000102317,7.94003e-08,-2.59694e-11,-29617.3,27.615], Tmin=(100,'K'), Tmax=(735.795,'K')), NASAPolynomial(coeffs=[8.31367,0.0367219,-1.88276e-05,3.75651e-09,-2.68488e-13,-30726,-6.41953], Tmin=(735.795,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCsJOOC)"""),
)

species(
    label = 'FC=[C]OOCCF(3717)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.420231,'amu*angstrom^2'), symmetry=1, barrier=(9.66193,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.32855,'amu*angstrom^2'), symmetry=1, barrier=(30.5459,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.901328,0.077164,-9.32685e-05,5.38544e-08,-6.19686e-12,-23305.8,26.3449], Tmin=(100,'K'), Tmax=(571.032,'K')), NASAPolynomial(coeffs=[8.32716,0.0370483,-1.91542e-05,3.826e-09,-2.73303e-13,-24347.9,-7.0187], Tmin=(571.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.632,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = 'F[C]=COOCCF(3718)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.31351,'amu*angstrom^2'), symmetry=1, barrier=(30.2002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.43582,'amu*angstrom^2'), symmetry=1, barrier=(10.0204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435604,'amu*angstrom^2'), symmetry=1, barrier=(10.0154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.86993,'amu*angstrom^2'), symmetry=1, barrier=(42.9934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.436353,0.0860953,-0.000131675,1.15001e-07,-4.06841e-11,-20883.7,28.9002], Tmin=(100,'K'), Tmax=(774.915,'K')), NASAPolynomial(coeffs=[8.5276,0.035958,-1.84197e-05,3.62562e-09,-2.55136e-13,-21886.4,-6.45038], Tmin=(774.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]COOC=CF(3662)'],
    products = ['O=C[CH]F(338)', 'FC1CO1(285)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]COOC=CF(3707)'],
    products = ['F[CH]COOC=CF(3662)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(230)', '[CH2]OOC=CF(1676)'],
    products = ['F[CH]COOC=CF(3662)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'F[C]COOC=CF(3708)'],
    products = ['F[CH]COOC=CF(3662)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]OC=CF(337)', 'CH2CHF(56)'],
    products = ['F[CH]COOC=CF(3662)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=COOC[CH]F(3712)'],
    products = ['F[CH]COOC=CF(3662)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C[CH]F(338)', '[O]C[CH]F(140)'],
    products = ['F[CH]COOC=CF(3662)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC=CF(337)', '[CH2][CH]F(233)'],
    products = ['F[CH]COOC=CF(3662)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHFCH[Z](71)', '[O]OC[CH]F(221)'],
    products = ['F[CH]COOC=CF(3662)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'F[CH][CH]OOC=CF(3713)'],
    products = ['F[CH]COOC=CF(3662)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'F[CH]COO[C]=CF(3714)'],
    products = ['F[CH]COOC=CF(3662)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'F[C]=COOC[CH]F(3715)'],
    products = ['F[CH]COOC=CF(3662)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]COOC=CF(3662)'],
    products = ['O=C[CH]F(338)', 'O=CCF(208)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF(40)', '[CH2]OOC=CF(1676)'],
    products = ['F[CH]COOC=CF(3662)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'F[C]COOC=CF-2(3716)'],
    products = ['F[CH]COOC=CF(3662)'],
...
network(
    ...
    reactants = [
        ('O=C[CH]F(338)', 'FC1CO1(285)'),
        ('O=C[CH]F(338)', '[O]C[CH]F(140)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
