...
10 C u0 p0 c0 {6,S} {11,S} {15,S} {16,S}
...
"""),
    E0 = (-855.003,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.668826,0.110026,-0.000137447,8.90039e-08,-2.32612e-11,-102671,36.5051], Tmin=(100,'K'), Tmax=(926.063,'K')), NASAPolynomial(coeffs=[16.2347,0.0370151,-1.91898e-05,3.87287e-09,-2.79737e-13,-105802,-43.7466], Tmin=(926.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-855.003,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-357.039,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.909031,0.0732693,-8.4034e-05,5.26617e-08,-1.36712e-11,-42835,28.6267], Tmin=(100,'K'), Tmax=(921.624,'K')), NASAPolynomial(coeffs=[10.6119,0.0311557,-1.54892e-05,3.07741e-09,-2.2053e-13,-44623.4,-17.3919], Tmin=(921.624,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-357.039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsHHH) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-861.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.122228,0.0952611,-0.000105674,5.97231e-08,-1.36523e-11,-103483,35.1896], Tmin=(100,'K'), Tmax=(1049.68,'K')), NASAPolynomial(coeffs=[16.1491,0.0332569,-1.70702e-05,3.45006e-09,-2.49967e-13,-106899,-44.099], Tmin=(1049.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-861.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'C[C](F)OOOC[C](F)F(8446)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-425.742,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,190,488,555,1236,1407,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (158.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.495177,0.107381,-0.00015365,1.18334e-07,-3.6884e-11,-51050.8,36.4693], Tmin=(100,'K'), Tmax=(781.652,'K')), NASAPolynomial(coeffs=[13.1675,0.0374609,-1.94655e-05,3.88373e-09,-2.76848e-13,-53186.6,-26.0789], Tmin=(781.652,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCsFFH) + radical(CsCsF1sO2s) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
species(
    label = '[CH2]C(F)(F)OOOC[C](F)F(8448)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-641.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,253,525,597,667,842,1178,1324,190,488,555,1236,1407,3000,3100,440,815,1455,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-667.555,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,190,488,555,1236,1407,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (176.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.769064,0.113573,-0.000157325,1.13395e-07,-3.28414e-11,-80124.3,37.0878], Tmin=(100,'K'), Tmax=(840.771,'K')), NASAPolynomial(coeffs=[15.5063,0.0361474,-1.91996e-05,3.87914e-09,-2.79166e-13,-82861.2,-38.6098], Tmin=(840.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-667.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(CCsJOO) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-436.875,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,326,540,652,719,1357,2950,3100,1380,975,1025,1650,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00545006,0.0959806,-0.000134966,1.04234e-07,-3.29178e-11,-52407.5,35.7907], Tmin=(100,'K'), Tmax=(768.848,'K')), NASAPolynomial(coeffs=[11.4083,0.0366519,-1.92095e-05,3.85409e-09,-2.75848e-13,-54160.8,-16.2234], Tmin=(768.848,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-436.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
species(
    label = 'CC(F)(F)OOO[CH]C(F)F(8451)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = '[CH2]C(F)(F)OOOCC(F)F(8452)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-843.507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,253,525,597,667,842,1178,1324,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (177.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.726565,0.109647,-0.000132819,8.18661e-08,-2.0222e-11,-101285,37.8647], Tmin=(100,'K'), Tmax=(980.607,'K')), NASAPolynomial(coeffs=[17.7346,0.0343425,-1.7629e-05,3.55456e-09,-2.57023e-13,-104906,-50.8381], Tmin=(980.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-843.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCFFO) + group(CsCsFFH) + group(Cs-CsHHH) + radical(CJCOOH)"""),
)

species(
    label = 'C[C](F)OOOCC(F)(F)F(8453)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (177.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.588644,0.109196,-0.000140786,9.64501e-08,-2.68614e-11,-103665,35.7797], Tmin=(100,'K'), Tmax=(869.063,'K')), NASAPolynomial(coeffs=[14.5652,0.0394475,-2.03993e-05,4.09909e-09,-2.94856e-13,-106299,-35.2019], Tmin=(869.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-863.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cs-CsHHH) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)OOOC[C](F)F(7323)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'COOOC[C](F)F(7319)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOOOC[C](F)F(8443)', 'C[C]F(124)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'F[C](F)COOOC(F)F(8444)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'CC(F)(F)OOOC[C]F(4195)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(2927)', '[CH2]OOOC(C)(F)F(3829)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'CC(F)(F)OOOC=C(F)F(8445)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)OOOC[C](F)F(8446)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]OC[C](F)F(3041)', 'CC([O])(F)F(1120)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OOC[C](F)F(6993)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C[C](F)F(2986)', 'CC(F)(F)O[O](2988)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(1.63318,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'F[C](F)COOO[C](F)F(8447)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]C(F)(F)OOOC[C](F)F(8448)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'CC(F)(F)OOO[CH][C](F)F(8449)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(F)OOOC[C](F)F(8450)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', 'CC(F)(F)OOOC[C]F-2(4202)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CF2(43)', '[CH2]OOOC(C)(F)F(3829)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC(F)(F)OOOC[C](F)F(7323)'],
    products = ['CC(F)(F)OOO[CH]C(F)F(8451)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)(F)OOOCC(F)F(8452)'],
    products = ['CC(F)(F)OOOC[C](F)F(7323)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(77713,'s^-1'), n=1.57167, Ea=(82.0064,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R7H;C_rad_out_2H;Cs_H_out] for rate rule [R7H;C_rad_out_2H;Cs_H_out_noH]
Euclidian distance = 1.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['CC(F)(F)OOOC[C](F)F(7323)'],
    products = ['C[C](F)OOOCC(F)(F)F(8453)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(193.993,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)
