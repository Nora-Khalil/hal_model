...
"""),
    E0 = (-351.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([162,485,641,721,926,1292,1380,3063,493,600,700,1144,1293,2950,3100,1380,975,1025,1650,1685,370,180,180,1898.7],'cm^-1')),
        HinderedRotor(inertia=(0.516497,'amu*angstrom^2'), symmetry=1, barrier=(11.8753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516773,'amu*angstrom^2'), symmetry=1, barrier=(11.8816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23991,'amu*angstrom^2'), symmetry=1, barrier=(28.508,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.953225,0.0730506,-0.000109556,9.17574e-08,-3.13539e-11,-42134.2,27.214], Tmin=(100,'K'), Tmax=(728.313,'K')), NASAPolynomial(coeffs=[8.99334,0.0278988,-1.45154e-05,2.8868e-09,-2.04823e-13,-43279,-8.84499], Tmin=(728.313,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-351.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsFFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-Cs)) + radical(Cdj(Cs-F1sO2sH)(Cd-HH))"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30633,0.0486953,-2.28842e-05,-6.27206e-09,5.46807e-12,-82875.7,18.4029], Tmin=(100,'K'), Tmax=(1102.27,'K')), NASAPolynomial(coeffs=[15.3459,0.0179812,-8.6219e-06,1.75504e-09,-1.29512e-13,-87200,-56.2724], Tmin=(1102.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-689.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFFO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=C=C(F)OC(F)F(8139)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
4  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.943467,0.0667387,-7.39278e-05,4.06385e-08,-8.82333e-12,-74469.7,22.9509], Tmin=(100,'K'), Tmax=(1119.08,'K')), NASAPolynomial(coeffs=[14.5923,0.0179527,-8.5359e-06,1.68282e-09,-1.20727e-13,-77524.5,-44.4327], Tmin=(1119.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-620.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsFFHO) + group(CdCddFO) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (-405.693,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,493,600,700,1144,1293,2950,3100,1380,975,1025,1650,540,610,2055,379.173,379.644,379.856,381.039],'cm^-1')),
        HinderedRotor(inertia=(0.00115637,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267421,'amu*angstrom^2'), symmetry=1, barrier=(27.9328,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13039,0.0609381,-6.50608e-05,3.35459e-08,-6.78187e-12,-48688.5,24.5531], Tmin=(100,'K'), Tmax=(1202.05,'K')), NASAPolynomial(coeffs=[15.0708,0.0145484,-7.17148e-06,1.43937e-09,-1.04286e-13,-52039.8,-45.2663], Tmin=(1202.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsFFHO) + group(CdCddFO) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)

species(
    label = 'C#CC(F)O[C](F)F(8141)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-427.687,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([242,464,653,889,1056,1342,3790,493,600,700,1144,1293,2175,525,750,770,3400,2100,180,180,701.524],'cm^-1')),
        HinderedRotor(inertia=(2.82293,'amu*angstrom^2'), symmetry=1, barrier=(64.9048,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.82336,'amu*angstrom^2'), symmetry=1, barrier=(64.9145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257837,'amu*angstrom^2'), symmetry=1, barrier=(5.92817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.862784,0.0753605,-0.000122719,1.0498e-07,-3.51021e-11,-51332,23.971], Tmin=(100,'K'), Tmax=(835.629,'K')), NASAPolynomial(coeffs=[9.71498,0.0231856,-1.14689e-05,2.1884e-09,-1.49994e-13,-52469.2,-15.0987], Tmin=(835.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-427.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsFFHO) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.854237,0.0623318,-6.03665e-05,2.81582e-08,-5.12441e-12,-54011.8,26.4794], Tmin=(100,'K'), Tmax=(1336.44,'K')), NASAPolynomial(coeffs=[16.923,0.0142373,-6.38564e-06,1.23033e-09,-8.7149e-14,-58306.8,-55.703], Tmin=(1336.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-450.069,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(CdCFO) + radical(Allyl_P) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)

species(
    label = '[CH]=CC(F)O[C](F)F(8143)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.2154,'amu*angstrom^2'), symmetry=1, barrier=(4.95246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215847,'amu*angstrom^2'), symmetry=1, barrier=(4.96276,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.886859,0.0751716,-0.00011775,1.02768e-07,-3.62173e-11,-41573.5,26.6702], Tmin=(100,'K'), Tmax=(764.027,'K')), NASAPolynomial(coeffs=[8.56503,0.0289659,-1.52407e-05,3.03105e-09,-2.14459e-13,-42571.5,-7.15846], Tmin=(764.027,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-346.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsFFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-Cs)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=C(F)OC(F)F(8144)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.954847,0.0686169,-7.96678e-05,4.68053e-08,-1.09477e-11,-49771.9,24.6611], Tmin=(100,'K'), Tmax=(1037.64,'K')), NASAPolynomial(coeffs=[13.4857,0.0203124,-9.84038e-06,1.94311e-09,-1.3919e-13,-52372.5,-36.2565], Tmin=(1037.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-414.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(CdCFO) + radical(Allyl_P) + radical(Cdj(Cs-HHH)(Cd-F1sO2s))"""),
)

species(
    label = '[CH]=[C]C(F)OC(F)F(8145)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.4742,'amu*angstrom^2'), symmetry=1, barrier=(10.9028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23656,'amu*angstrom^2'), symmetry=1, barrier=(28.4309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.474549,'amu*angstrom^2'), symmetry=1, barrier=(10.9108,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.921939,0.0734627,-0.000103966,7.92163e-08,-2.44331e-11,-37888.6,26.5795], Tmin=(100,'K'), Tmax=(789.569,'K')), NASAPolynomial(coeffs=[10.3437,0.0257303,-1.3283e-05,2.64751e-09,-1.88743e-13,-39376.4,-16.649], Tmin=(789.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-315.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsFFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sO2sH)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=COC(F)(F)F(8146)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.1105,0.0718473,-7.66128e-05,3.77053e-08,-6.88283e-12,-56938.3,27.3718], Tmin=(100,'K'), Tmax=(1533.57,'K')), NASAPolynomial(coeffs=[22.0383,0.00365036,2.89556e-07,-1.58692e-10,1.24087e-14,-62505.6,-84.9568], Tmin=(1533.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-474.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFFFO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'C=C(F)[CH]O[C](F)F(8147)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16284,0.0714319,-0.000118883,1.12702e-07,-4.18093e-11,-55086.9,27.1884], Tmin=(100,'K'), Tmax=(817.631,'K')), NASAPolynomial(coeffs=[5.14261,0.0341084,-1.7657e-05,3.45899e-09,-2.41413e-13,-55140.9,12.4391], Tmin=(817.631,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-458.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFFHO) + group(CdCsCdF) + group(Cds-CdsHH) + radical(C=CCJ(O)C) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]C(F)O[C](F)F(7505)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2927)', 'C=[C]C([O])F(714)'],
    products = ['C=[C]C(F)O[C](F)F(7505)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[CH]O[C](F)F(3152)', '[C]=C(395)'],
    products = ['C=[C]C(F)O[C](F)F(7505)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C=CO[C](F)F(6670)'],
    products = ['C=[C]C(F)O[C](F)F(7505)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C=C(F)O[C](F)F(8140)'],
    products = ['C=[C]C(F)O[C](F)F(7505)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC(F)O[C](F)F(8141)'],
    products = ['C=[C]C(F)O[C](F)F(7505)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', 'C=[C]C([O])F(714)'],
    products = ['C=[C]C(F)O[C](F)F(7505)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]C(F)O[C](F)F(7505)'],
    products = ['[CH2]C=C(F)O[C](F)F(8142)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC(F)O[C](F)F(8143)'],
    products = ['C=[C]C(F)O[C](F)F(7505)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]C(F)O[C](F)F(7505)'],
    products = ['[CH2][C]=C(F)OC(F)F(8144)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]C(F)OC(F)F(8145)'],
    products = ['C=[C]C(F)O[C](F)F(7505)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]C(F)O[C](F)F(7505)'],
    products = ['C=C(F)[CH]O[C](F)F(8147)'],
...
network(
    label = 'PDepNetwork #3017',
    isomers = [
        'C=[C]C(F)O[C](F)F(7505)',
    ],
    reactants = [
        ('CF2O(49)', 'C=C=CF(6101)'),
    ],
