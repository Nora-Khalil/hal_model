...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5826,0.0195898,3.99426e-05,-5.53172e-08,1.87414e-11,-456.739,15.7285], Tmin=(100,'K'), Tmax=(1107.29,'K')), NASAPolynomial(coeffs=[9.07797,0.0277218,-1.38755e-05,2.85495e-09,-2.10693e-13,-3832.17,-25.0164], Tmin=(1107.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.30197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)Cs) + ring(Cyclobutene)"""),
)

species(
    label = 'CC=CC=C=O(6479)',
    structure = adjacencyList("""1  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25023,0.0422183,-2.96347e-05,1.21413e-08,-2.32493e-12,-855.642,18.4018], Tmin=(100,'K'), Tmax=(1109.91,'K')), NASAPolynomial(coeffs=[5.49728,0.0305163,-1.38201e-05,2.64226e-09,-1.85353e-13,-1576.43,2.39802], Tmin=(1109.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.61157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'C=C=CCC=O(6351)',
...
"""),
    E0 = (230.23,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,2120,512.5,787.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.485759,'amu*angstrom^2'), symmetry=1, barrier=(11.1686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.486176,'amu*angstrom^2'), symmetry=1, barrier=(11.1781,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93142,0.050294,-6.72312e-05,5.93413e-08,-2.17216e-11,27760.1,20.0136], Tmin=(100,'K'), Tmax=(801.968,'K')), NASAPolynomial(coeffs=[4.43785,0.0298094,-1.39853e-05,2.66604e-09,-1.84677e-13,27614.8,10.0752], Tmin=(801.968,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(Cds_S)"""),
)
...
"""),
    E0 = (184.519,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2100,2250,500,550,1855,455,950,180],'cm^-1')),
        HinderedRotor(inertia=(0.0135359,'amu*angstrom^2'), symmetry=1, barrier=(5.15867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.793344,'amu*angstrom^2'), symmetry=1, barrier=(18.2405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0614082,'amu*angstrom^2'), symmetry=1, barrier=(23.89,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23282,0.0308115,2.77812e-06,-2.38946e-08,1.08608e-11,22263.3,21.1165], Tmin=(100,'K'), Tmax=(999.414,'K')), NASAPolynomial(coeffs=[9.84627,0.0188931,-7.18005e-06,1.32313e-09,-9.37815e-14,19814.9,-20.2451], Tmin=(999.414,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CtHH) + group(Cs-CtHHH) + group(Cds-OdCsH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCCJ=O)"""),
)

species(
    label = 'C[C]=CC=C[O](6483)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
2  C u0 p0 c0 {6,S} {7,S} {8,S} {9,S}
3  C u0 p0 c0 {4,S} {5,D} {10,S}
...
"""),
    E0 = (182.295,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,1855,455,950,318.098],'cm^-1')),
        HinderedRotor(inertia=(0.00171997,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.315079,'amu*angstrom^2'), symmetry=1, barrier=(21.9945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.31187,'amu*angstrom^2'), symmetry=1, barrier=(22.021,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84067,0.0373103,-1.18254e-06,-2.21772e-08,9.72875e-12,22011.4,22.3283], Tmin=(100,'K'), Tmax=(1088.78,'K')), NASAPolynomial(coeffs=[12.2928,0.021254,-9.84393e-06,1.97423e-09,-1.4453e-13,18411.1,-35.0681], Tmin=(1088.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Allyl_P) + radical(CCCJ=O)"""),
)

species(
    label = 'CC=[C]C[C]=O(6485)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {6,D}
2  C u0 p0 c0 {5,S} {6,S} {7,S} {8,S}
3  C u0 p0 c0 {4,S} {9,S} {10,S} {11,S}
...
"""),
    E0 = (346.519,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,1670,1700,300,440,278.577],'cm^-1')),
        HinderedRotor(inertia=(0.230776,'amu*angstrom^2'), symmetry=1, barrier=(12.7248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00216838,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229393,'amu*angstrom^2'), symmetry=1, barrier=(12.7182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.39125,0.0395101,-2.08292e-05,4.1444e-09,-2.42865e-13,41730.7,20.209], Tmin=(100,'K'), Tmax=(2118.3,'K')), NASAPolynomial(coeffs=[19.5194,0.0137912,-7.30807e-06,1.36533e-09,-8.91085e-14,32988,-78.7889], Tmin=(2118.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C=C[C]=O(6487)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {6,D}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9991,0.0478574,-3.55849e-05,1.33836e-08,-2.13738e-12,19519.3,18.7487], Tmin=(100,'K'), Tmax=(1379.95,'K')), NASAPolynomial(coeffs=[9.08174,0.0273275,-1.32693e-05,2.60282e-09,-1.84293e-13,17564.5,-17.702], Tmin=(1379.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Allyl_S) + radical(C=CCJ=O)"""),
)

species(
    label = '[CH2][C]=CCC=O(6488)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,D}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {6,D} {9,S}
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87596,0.0388414,-9.80349e-06,-9.75701e-09,4.58881e-12,31374.9,21.8669], Tmin=(100,'K'), Tmax=(1218.77,'K')), NASAPolynomial(coeffs=[11.5563,0.023615,-1.14253e-05,2.26799e-09,-1.62456e-13,27786.5,-31.791], Tmin=(1218.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(260.177,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', 'C=C[C]C(6411)'],
    products = ['C[C]=CC[C]=O(6346)'],
    transitionState = 'TS3',
