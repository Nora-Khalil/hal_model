...
"""),
    E0 = (-261.326,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([257,409,1143,1361,2944,249,734,1109,1255,1358,2983,3011,462.061,462.402,462.527,462.539,462.873,463.261,465.885],'cm^-1')),
        HinderedRotor(inertia=(0.000790087,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00079216,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91286,0.0509197,-7.31786e-05,6.61004e-08,-2.48984e-11,-31359.9,28.5592], Tmin=(100,'K'), Tmax=(752.523,'K')), NASAPolynomial(coeffs=[5.11556,0.0276269,-1.42532e-05,2.82761e-09,-2.00478e-13,-31664.4,15.198], Tmin=(752.523,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-261.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)C(F)F-2(6119)',
    structure = adjacencyList("""1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {5,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-258.87,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([353,444,1253,3145,235,523,627,1123,1142,1372,1406,3097,369.934,370.413,370.749,371.085,371.226,1454.67,1765.9],'cm^-1')),
        HinderedRotor(inertia=(0.00123284,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00536834,'amu*angstrom^2'), symmetry=1, barrier=(8.06037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89458,0.0509951,-6.91088e-05,5.38237e-08,-1.75177e-11,-31063.3,17.6127], Tmin=(100,'K'), Tmax=(741.068,'K')), NASAPolynomial(coeffs=[7.12502,0.0227623,-1.19611e-05,2.412e-09,-1.73387e-13,-31838.5,-6.0537], Tmin=(741.068,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['HF(38)', 'F[C]C=CF-2(6117)'],
    products = ['FC=CC(F)F(888)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]C=C(F)F(3936)'],
    products = ['FC=CC(F)F(888)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', '[CH]C(F)F-2(2985)'],
    products = ['FC=CC(F)F(888)'],
