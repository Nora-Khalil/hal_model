...
"""),
    E0 = (161.173,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,493.029,498.697],'cm^-1')),
        HinderedRotor(inertia=(0.124182,'amu*angstrom^2'), symmetry=1, barrier=(21.9139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125159,'amu*angstrom^2'), symmetry=1, barrier=(21.867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00219386,'amu*angstrom^2'), symmetry=1, barrier=(21.9256,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84023,0.0375698,-4.75594e-06,-2.68503e-08,1.49076e-11,19471.6,19.0917], Tmin=(100,'K'), Tmax=(935.944,'K')), NASAPolynomial(coeffs=[13.8335,0.0113782,-2.94999e-06,4.76386e-10,-3.44637e-14,16128.7,-43.8397], Tmin=(935.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]C1([CH2])CO1(11191)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {3,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {5,S}
3  C u0 p0 c0 {1,S} {2,S} {6,S} {7,S}
4  C u1 p0 c0 {2,S} {9,S} {10,S}
5  C u1 p0 c0 {2,S} {8,S} {11,S}
6  H u0 p0 c0 {3,S}
7  H u0 p0 c0 {3,S}
8  H u0 p0 c0 {5,S}
9  H u0 p0 c0 {4,S}
...
"""),
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.867654,0.0644443,-8.34786e-05,5.48812e-08,-1.32592e-11,33291,17.5002], Tmin=(100,'K'), Tmax=(1227.31,'K')), NASAPolynomial(coeffs=[12.5263,0.0113524,-1.42159e-07,-4.07599e-10,4.43032e-14,31566,-36.5028], Tmin=(1227.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(275.826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
"""),
    E0 = (249.353,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,358.406],'cm^-1')),
        HinderedRotor(inertia=(0.00131305,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153083,'amu*angstrom^2'), symmetry=1, barrier=(13.9445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152772,'amu*angstrom^2'), symmetry=1, barrier=(13.9456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80039,0.0405772,-1.83216e-05,-8.46325e-09,7.04278e-12,30076.4,19.6412], Tmin=(100,'K'), Tmax=(978.432,'K')), NASAPolynomial(coeffs=[12.5713,0.0142087,-4.97872e-06,8.97808e-10,-6.38729e-14,27123.1,-36.4085], Tmin=(978.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=COCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)OC(6599)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {3,S}
...
"""),
    E0 = (180.934,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,354.332,354.339,354.342,354.365,354.38],'cm^-1')),
        HinderedRotor(inertia=(0.561953,'amu*angstrom^2'), symmetry=1, barrier=(50.0659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.561869,'amu*angstrom^2'), symmetry=1, barrier=(50.0658,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.561876,'amu*angstrom^2'), symmetry=1, barrier=(50.0656,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76995,0.0389254,9.76936e-07,-2.99841e-08,1.45956e-11,21850.7,17.9709], Tmin=(100,'K'), Tmax=(968.789,'K')), NASAPolynomial(coeffs=[12.1416,0.0201621,-7.22407e-06,1.29459e-09,-9.12773e-14,18712,-37.5648], Tmin=(968.789,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
