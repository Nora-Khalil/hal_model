...
"""),
    E0 = (200.81,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,1685,370,347.976,348.176,348.433],'cm^-1')),
        HinderedRotor(inertia=(0.00138854,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11335,'amu*angstrom^2'), symmetry=1, barrier=(9.74566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113378,'amu*angstrom^2'), symmetry=1, barrier=(9.74375,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73507,0.0536195,-4.8517e-05,2.64549e-08,-6.39094e-12,24230.3,23.0176], Tmin=(100,'K'), Tmax=(953.953,'K')), NASAPolynomial(coeffs=[6.86107,0.0321244,-1.47157e-05,2.83133e-09,-1.99571e-13,23252.3,-1.47034], Tmin=(953.953,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-CsHH)(F1s)(H)) + radical(Cds_S)"""),
)
...
"""),
    E0 = (102.636,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650],'cm^-1')),
        HinderedRotor(inertia=(0.006622,'amu*angstrom^2'), symmetry=1, barrier=(7.69741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1488,'amu*angstrom^2'), symmetry=1, barrier=(26.4133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14901,'amu*angstrom^2'), symmetry=1, barrier=(26.418,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12337,0.0303082,2.15401e-05,-4.30078e-08,1.64941e-11,-11501.6,16.2094], Tmin=(100,'K'), Tmax=(1041.06,'K')), NASAPolynomial(coeffs=[9.81686,0.0269251,-1.13028e-05,2.17729e-09,-1.56837e-13,-14522,-28.0298], Tmin=(1041.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.2702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)

species(
    label = 'C=CCC(=C)F(10874)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66706,0.0430777,-1.35125e-05,-1.05103e-08,6.28117e-12,-14311.4,21.2973], Tmin=(100,'K'), Tmax=(1057.31,'K')), NASAPolynomial(coeffs=[11.174,0.0236732,-9.48043e-06,1.76282e-09,-1.23926e-13,-17247.5,-29.4761], Tmin=(1057.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-119.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C=CC(C)F(6364)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84834,0.0481053,-3.16323e-05,1.03483e-08,-1.40776e-12,-9073.44,18.3364], Tmin=(100,'K'), Tmax=(1615.86,'K')), NASAPolynomial(coeffs=[10.3965,0.0269447,-1.1989e-05,2.24394e-09,-1.53893e-13,-11836,-27.0056], Tmin=(1615.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.0736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (118.093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,344.587,345.214],'cm^-1')),
        HinderedRotor(inertia=(0.106343,'amu*angstrom^2'), symmetry=1, barrier=(9.0163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106955,'amu*angstrom^2'), symmetry=1, barrier=(9.00567,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73336,0.0464931,-3.40191e-05,1.28865e-08,-2.00614e-12,14287.5,21.533], Tmin=(100,'K'), Tmax=(1484.75,'K')), NASAPolynomial(coeffs=[10.9449,0.0216765,-8.94752e-06,1.62902e-09,-1.10613e-13,11552.1,-26.5482], Tmin=(1484.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.795173,'amu*angstrom^2'), symmetry=1, barrier=(18.2826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.797399,'amu*angstrom^2'), symmetry=1, barrier=(18.3338,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88969,0.0498334,-4.10793e-05,1.84614e-08,-3.58489e-12,15801.1,19.9785], Tmin=(100,'K'), Tmax=(1166.09,'K')), NASAPolynomial(coeffs=[8.17709,0.028266,-1.33362e-05,2.6004e-09,-1.84442e-13,14334.8,-11.3207], Tmin=(1166.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sCdH)(H)(H))"""),
)

species(
    label = 'C#CCC([CH2])F(7583)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.221569,'amu*angstrom^2'), symmetry=1, barrier=(5.09431,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47124,'amu*angstrom^2'), symmetry=1, barrier=(33.8266,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47275,0.0562253,-5.80662e-05,3.4107e-08,-8.24755e-12,14553,20.5435], Tmin=(100,'K'), Tmax=(994.665,'K')), NASAPolynomial(coeffs=[9.42765,0.0242347,-9.82224e-06,1.77144e-09,-1.20218e-13,12970.5,-17.7917], Tmin=(994.665,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.190434,'amu*angstrom^2'), symmetry=1, barrier=(4.37844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190464,'amu*angstrom^2'), symmetry=1, barrier=(4.37914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190418,'amu*angstrom^2'), symmetry=1, barrier=(4.37807,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29521,0.0458052,-5.71838e-06,-8.1784e-08,8.55096e-11,21188.1,20.9942], Tmin=(100,'K'), Tmax=(448.667,'K')), NASAPolynomial(coeffs=[5.04303,0.0351752,-1.65424e-05,3.18896e-09,-2.23677e-13,20801.9,8.38443], Tmin=(448.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsCsF1s) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(F)[CH]C=C(6440)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (95.2576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,192.067,1694.53],'cm^-1')),
        HinderedRotor(inertia=(0.387454,'amu*angstrom^2'), symmetry=1, barrier=(10.9586,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12056,'amu*angstrom^2'), symmetry=1, barrier=(29.6774,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.024216,'amu*angstrom^2'), symmetry=1, barrier=(29.7189,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44136,0.0503273,-3.42056e-05,1.15631e-08,-1.58122e-12,11553.7,21.7169], Tmin=(100,'K'), Tmax=(1686.65,'K')), NASAPolynomial(coeffs=[13.3573,0.0220682,-9.07414e-06,1.62971e-09,-1.08888e-13,7534.08,-41.9997], Tmin=(1686.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.2576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[CH]=CCC([CH2])F(10878)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (201.241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,259,529,569,1128,1321,1390,3140,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.0915357,'amu*angstrom^2'), symmetry=1, barrier=(2.10458,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.479461,'amu*angstrom^2'), symmetry=1, barrier=(11.0237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.87699,'amu*angstrom^2'), symmetry=1, barrier=(20.1637,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54739,0.0548287,-4.59646e-05,2.08737e-08,-3.98699e-12,24291.2,22.8329], Tmin=(100,'K'), Tmax=(1213.09,'K')), NASAPolynomial(coeffs=[9.83198,0.0275115,-1.21868e-05,2.3108e-09,-1.61476e-13,22281.2,-18.7359], Tmin=(1213.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sCsH)(H)(H)) + radical(Cds_P)"""),
)

species(
    label = 'C=[C][CH]C(C)F(6444)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70896,0.0484354,-3.20542e-05,1.0644e-08,-1.4577e-12,15282.2,19.8106], Tmin=(100,'K'), Tmax=(1637.38,'K')), NASAPolynomial(coeffs=[11.2266,0.0251845,-1.0754e-05,1.97156e-09,-1.33564e-13,12165.4,-30.7996], Tmin=(1637.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C](F)CC=C(10879)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72459,0.0544474,-5.35911e-05,3.40418e-08,-9.76583e-12,17471.7,23.8193], Tmin=(100,'K'), Tmax=(810.329,'K')), NASAPolynomial(coeffs=[5.84025,0.0341307,-1.59816e-05,3.09899e-09,-2.19144e-13,16804.7,4.82939], Tmin=(810.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[CH]=[C]CC(C)F(10880)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (232.352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,286.14],'cm^-1')),
        HinderedRotor(inertia=(0.188169,'amu*angstrom^2'), symmetry=1, barrier=(10.9299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188165,'amu*angstrom^2'), symmetry=1, barrier=(10.9297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188149,'amu*angstrom^2'), symmetry=1, barrier=(10.93,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65925,0.0544908,-4.81293e-05,2.43016e-08,-5.30098e-12,28027.2,21.507], Tmin=(100,'K'), Tmax=(1059.2,'K')), NASAPolynomial(coeffs=[8.09875,0.0301723,-1.36901e-05,2.62522e-09,-1.84741e-13,26663.1,-9.93022], Tmin=(1059.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(232.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=[C]C[CH]CF(10865)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {4,S} {6,S} {7,S} {8,S}
...
"""),
    E0 = (203.246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,394.808,394.958,395.032],'cm^-1')),
        HinderedRotor(inertia=(0.0810768,'amu*angstrom^2'), symmetry=1, barrier=(8.97709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00108058,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0810523,'amu*angstrom^2'), symmetry=1, barrier=(8.97701,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13343,0.0462347,-3.17232e-05,1.21108e-08,-2.14125e-12,24507.6,22.9938], Tmin=(100,'K'), Tmax=(1176.69,'K')), NASAPolynomial(coeffs=[5.82701,0.033679,-1.57179e-05,3.04293e-09,-2.14699e-13,23638.4,4.57344], Tmin=(1176.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C[C]=C(10123)'],
    products = ['CH2CHF(56)', 'C=C=C(6730)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C=[C]CC[CH]F(10169)'],
    products = ['[CH2]C(F)C[C]=C(10123)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'C=[C]C[CH]F(268)'],
    products = ['[CH2]C(F)C[C]=C(10123)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(395)', '[CH2]C([CH2])F(238)'],
    products = ['[CH2]C(F)C[C]=C(10123)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]F(233)', '[CH2][C]=C(6957)'],
    products = ['[CH2]C(F)C[C]=C(10123)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(5.26262e-11,'m^3/(mol*s)'), n=4.71246, Ea=(6.91073,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C=C[C]=C(6463)'],
    products = ['[CH2]C(F)C[C]=C(10123)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(314.82,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['C=[C]C[C](C)F(10877)'],
    products = ['[CH2]C(F)C[C]=C(10123)'],
