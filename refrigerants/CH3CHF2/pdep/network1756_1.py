...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C=C=O(4666)'],
    products = ['[O]C(F)(F)C[C]=O(4673)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]CC(=O)F(1004)'],
    products = ['[O]C(F)(F)C[C]=O(4673)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=[C][CH]C(=O)F(4848)'],
    products = ['[O]C(F)(F)C[C]=O(4673)'],
