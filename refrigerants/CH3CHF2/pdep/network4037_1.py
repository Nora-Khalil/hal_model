...
"""),
    E0 = (322.053,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([122,584,932,1043,1247,1392,1461,2986,3039,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1670,1700,300,440,180],'cm^-1')),
        HinderedRotor(inertia=(0.61627,'amu*angstrom^2'), symmetry=1, barrier=(14.1693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616886,'amu*angstrom^2'), symmetry=1, barrier=(14.1834,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28884,0.0637513,-6.39418e-05,3.77119e-08,-9.54479e-12,38828.2,23.9489], Tmin=(100,'K'), Tmax=(930.151,'K')), NASAPolynomial(coeffs=[8.27639,0.0337024,-1.54841e-05,2.98112e-09,-2.10142e-13,37528.3,-9.25609], Tmin=(930.151,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(Cds_S) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.979508,0.0584051,-4.1582e-05,1.28521e-08,-8.87996e-13,3088.26,23.0156], Tmin=(100,'K'), Tmax=(1142.64,'K')), NASAPolynomial(coeffs=[13.664,0.0239524,-9.41782e-06,1.70793e-09,-1.17353e-13,-460.133,-42.7136], Tmin=(1142.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.7171,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (262.559,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,113,247,382,1207,3490,1685,370,540,610,2055,371.162,371.714],'cm^-1')),
        HinderedRotor(inertia=(0.130388,'amu*angstrom^2'), symmetry=1, barrier=(12.7659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130625,'amu*angstrom^2'), symmetry=1, barrier=(12.7603,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26445,0.0593159,-5.37588e-05,2.61884e-08,-5.23954e-12,31677.7,22.4633], Tmin=(100,'K'), Tmax=(1185.38,'K')), NASAPolynomial(coeffs=[11.3352,0.0253327,-1.07559e-05,2.00329e-09,-1.38854e-13,29290.2,-27.8351], Tmin=(1185.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)
...
"""),
    E0 = (254.842,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,319,1023,1071,1259,1317,1409,3054,3019,3010,987.5,1337.5,450,1655,1685,370,2100,2250,500,550,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.48337,'amu*angstrom^2'), symmetry=1, barrier=(57.0976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.837308,'amu*angstrom^2'), symmetry=1, barrier=(19.2514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.83795,'amu*angstrom^2'), symmetry=1, barrier=(19.2661,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53247,0.0534885,-4.16652e-05,1.76066e-08,-3.13225e-12,30739.7,23.094], Tmin=(100,'K'), Tmax=(1294.78,'K')), NASAPolynomial(coeffs=[9.92095,0.0275738,-1.16432e-05,2.14878e-09,-1.47616e-13,28567.5,-19.5427], Tmin=(1294.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Cds_S)"""),
)
...
"""),
    E0 = (254.842,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([122,584,932,1043,1247,1392,1461,2986,3039,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,2100,2250,500,550,180],'cm^-1')),
        HinderedRotor(inertia=(1.95316,'amu*angstrom^2'), symmetry=1, barrier=(44.907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844875,'amu*angstrom^2'), symmetry=1, barrier=(19.4253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.845142,'amu*angstrom^2'), symmetry=1, barrier=(19.4315,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53247,0.0534885,-4.16652e-05,1.76066e-08,-3.13225e-12,30739.7,23.094], Tmin=(100,'K'), Tmax=(1294.78,'K')), NASAPolynomial(coeffs=[9.92095,0.0275738,-1.16432e-05,2.14878e-09,-1.47616e-13,28567.5,-19.5427], Tmin=(1294.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-CtHHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Cds_S)"""),
)

species(
    label = 'C[C]=C[CH]C=CF(8553)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.119375,'amu*angstrom^2'), symmetry=1, barrier=(2.74467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0235608,'amu*angstrom^2'), symmetry=1, barrier=(17.3779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200468,'amu*angstrom^2'), symmetry=1, barrier=(76.0186,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41398,0.0477306,-1.30922e-05,-1.49757e-08,8.62533e-12,24215.7,24.9103], Tmin=(100,'K'), Tmax=(1017.41,'K')), NASAPolynomial(coeffs=[11.8608,0.0261435,-9.99351e-06,1.81813e-09,-1.26825e-13,21081.4,-30.6262], Tmin=(1017.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + radical(C=CCJC=C) + radical(Cds_S)"""),
)
...
species(
    label = 'C[C]=C[C]=CCF(12061)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {6,S} {10,S} {11,S} {12,S}
4  C u0 p0 c0 {2,S} {7,D} {13,S}
5  C u0 p0 c0 {6,D} {7,S} {14,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10906,0.0673225,-7.41128e-05,4.91791e-08,-1.38178e-11,34162.7,23.7143], Tmin=(100,'K'), Tmax=(851.117,'K')), NASAPolynomial(coeffs=[8.25776,0.0337251,-1.49e-05,2.79777e-09,-1.93851e-13,32945.9,-9.62155], Tmin=(851.117,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(Cds_S) + radical(C=CJC=C)"""),
)

species(
    label = 'CC=[C]C=[C]CF(12062)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {1,S} {6,S} {11,S} {12,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10906,0.0673225,-7.41128e-05,4.91791e-08,-1.38178e-11,34162.7,23.7143], Tmin=(100,'K'), Tmax=(851.117,'K')), NASAPolynomial(coeffs=[8.25776,0.0337251,-1.49e-05,2.79777e-09,-1.93851e-13,32945.9,-9.62155], Tmin=(851.117,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(Cds_S) + radical(C=CJC=C)"""),
)

species(
    label = 'CC#C[CH][CH]CF(12063)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {6,S} {10,S} {11,S} {12,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32177,0.0589122,-5.5569e-05,3.28374e-08,-8.24423e-12,28424.9,26.533], Tmin=(100,'K'), Tmax=(950.979,'K')), NASAPolynomial(coeffs=[7.96058,0.030989,-1.15265e-05,1.96319e-09,-1.28061e-13,27162.2,-5.16194], Tmin=(950.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(CsCsFHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Cs_S) + radical(Sec_Propargyl)"""),
)

species(
    label = 'C[CH][CH]C#CCF(12064)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {1,S} {6,S} {11,S} {12,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42412,0.0580167,-5.89624e-05,4.01521e-08,-1.15941e-11,30012.3,27.054], Tmin=(100,'K'), Tmax=(932.972,'K')), NASAPolynomial(coeffs=[6.32313,0.032954,-1.21419e-05,2.03299e-09,-1.30185e-13,29274.8,4.70565], Tmin=(932.972,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJC) + radical(Sec_Propargyl)"""),
)

species(
    label = 'CC=C[CH][C]=CF(8558)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {3,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {2,S} {4,D} {11,S}
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'C[C]=CC=C=CF(8549)'],
    products = ['C[C]=CC=[C]CF(11840)'],
    transitionState = 'TS6',
...
reaction(
    ...
    kinetics = Arrhenius(A=(539339,'m^3/(mol*s)'), n=0.286787, Ea=(41.5153,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.211724492539645, var=3.713057222477376, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Sp-2R!H#1R!H_N-Sp-4R!H-3R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Sp-2R!H#1R!H_N-Sp-4R!H-3R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC#CC=[C]CF(12059)'],
    products = ['C[C]=CC=[C]CF(11840)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(130.015,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #4037',
    isomers = [
        'C[C]=CC=[C]CF(11840)',
    ],
    reactants = [
