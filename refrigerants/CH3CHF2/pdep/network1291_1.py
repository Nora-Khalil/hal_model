...
"""),
    E0 = (-259.913,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,2392.5],'cm^-1')),
        HinderedRotor(inertia=(0.394831,'amu*angstrom^2'), symmetry=1, barrier=(9.07794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394622,'amu*angstrom^2'), symmetry=1, barrier=(9.07314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68486,'amu*angstrom^2'), symmetry=1, barrier=(38.7381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68345,'amu*angstrom^2'), symmetry=1, barrier=(38.7059,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.469191,0.0871404,-0.000140567,1.29193e-07,-4.72274e-11,-31142.4,29.3338], Tmin=(100,'K'), Tmax=(798.348,'K')), NASAPolynomial(coeffs=[6.96297,0.03885,-2.02348e-05,3.99073e-09,-2.80277e-13,-31677.2,2.61184], Tmin=(798.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.662266,0.0796985,-0.000111455,8.88419e-08,-2.91479e-11,-70712.8,28.0159], Tmin=(100,'K'), Tmax=(740.151,'K')), NASAPolynomial(coeffs=[9.33966,0.0328009,-1.64072e-05,3.2262e-09,-2.28093e-13,-71997.2,-11.2361], Tmin=(740.151,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-588.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFHH) + group(COCsFO) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (183.237,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,180,180,2333.37],'cm^-1')),
        HinderedRotor(inertia=(1.59322,'amu*angstrom^2'), symmetry=1, barrier=(36.6314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00234854,'amu*angstrom^2'), symmetry=1, barrier=(9.0931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59196,'amu*angstrom^2'), symmetry=1, barrier=(36.6022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0094298,'amu*angstrom^2'), symmetry=1, barrier=(36.623,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66052,0.0608724,-5.16004e-05,-1.26218e-08,3.91657e-11,22113.1,24.2813], Tmin=(100,'K'), Tmax=(495.063,'K')), NASAPolynomial(coeffs=[6.80899,0.0344556,-1.75592e-05,3.48172e-09,-2.47434e-13,21417.3,1.18375], Tmin=(495.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.07598,'amu*angstrom^2'), symmetry=1, barrier=(47.7309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.07829,'amu*angstrom^2'), symmetry=1, barrier=(47.784,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47309,0.0409705,-1.56021e-05,-5.17864e-08,6.10272e-11,-4021.86,18.2363], Tmin=(100,'K'), Tmax=(450.449,'K')), NASAPolynomial(coeffs=[5.0285,0.0295489,-1.5099e-05,3.015e-09,-2.15795e-13,-4366.42,6.6767], Tmin=(450.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.8331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CsJOOC)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.668916,0.0824431,-0.000134819,1.25159e-07,-4.6242e-11,-9900.33,27.2637], Tmin=(100,'K'), Tmax=(790.354,'K')), NASAPolynomial(coeffs=[6.7273,0.0367529,-1.9582e-05,3.89688e-09,-2.751e-13,-10388.6,2.43036], Tmin=(790.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.2393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)

species(
    label = 'F[C]1CC(F)COO1(3699)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11456,0.0528611,-1.41084e-05,-2.73594e-08,1.7365e-11,-47982.4,19.8371], Tmin=(100,'K'), Tmax=(905.48,'K')), NASAPolynomial(coeffs=[15.4301,0.0183537,-4.54098e-06,6.4004e-10,-4.09114e-14,-51752.8,-54.3097], Tmin=(905.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-399.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCFHO) + ring(12dioxane) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C1(F)OOCC1F(3700)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.842312,0.0574329,-1.8791e-05,-2.89906e-08,1.96419e-11,-45333.8,22.3979], Tmin=(100,'K'), Tmax=(897.924,'K')), NASAPolynomial(coeffs=[18.0207,0.014268,-2.41202e-06,2.2484e-10,-1.22249e-14,-49763.6,-66.1171], Tmin=(897.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-377.966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CJCOOH) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (165.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.143335,'amu*angstrom^2'), symmetry=1, barrier=(3.29556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14276,'amu*angstrom^2'), symmetry=1, barrier=(3.28233,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.708302,'amu*angstrom^2'), symmetry=1, barrier=(16.2852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.03438,'amu*angstrom^2'), symmetry=1, barrier=(46.7745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.912617,0.0747179,-0.000114236,1.00038e-07,-3.52629e-11,19953.9,29.464], Tmin=(100,'K'), Tmax=(794.093,'K')), NASAPolynomial(coeffs=[7.64995,0.0317155,-1.58835e-05,3.09238e-09,-2.16034e-13,19169.7,0.313225], Tmin=(794.093,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(165.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(C=CJO)"""),
)
...
"""),
    E0 = (2.53794,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,293,496,537,1218,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.096836,'amu*angstrom^2'), symmetry=1, barrier=(2.22645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0964126,'amu*angstrom^2'), symmetry=1, barrier=(2.21672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.862624,'amu*angstrom^2'), symmetry=1, barrier=(19.8334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.39796,'amu*angstrom^2'), symmetry=1, barrier=(55.1338,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.27866,0.0926573,-0.000160617,1.4855e-07,-5.3383e-11,428.791,30.1296], Tmin=(100,'K'), Tmax=(820.575,'K')), NASAPolynomial(coeffs=[8.06961,0.0348196,-1.85878e-05,3.66572e-09,-2.56049e-13,-181.202,-1.84248], Tmin=(820.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.53794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.610663,'amu*angstrom^2'), symmetry=1, barrier=(14.0404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179504,'amu*angstrom^2'), symmetry=1, barrier=(4.12715,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180041,'amu*angstrom^2'), symmetry=1, barrier=(4.13949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.39115,'amu*angstrom^2'), symmetry=1, barrier=(54.9772,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.83499,0.0774345,-0.000120436,1.09009e-07,-3.98406e-11,-10396.4,28.3627], Tmin=(100,'K'), Tmax=(781.011,'K')), NASAPolynomial(coeffs=[6.84608,0.0354873,-1.84372e-05,3.64582e-09,-2.57039e-13,-10994.9,3.0276], Tmin=(781.011,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.3251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CdCFO) + group(Cds-CdsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-191.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,293,496,537,1218,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.257166,'amu*angstrom^2'), symmetry=1, barrier=(5.91274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257086,'amu*angstrom^2'), symmetry=1, barrier=(5.91091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64352,'amu*angstrom^2'), symmetry=1, barrier=(37.7878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64428,'amu*angstrom^2'), symmetry=1, barrier=(37.8053,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28438,0.0722902,-5.9088e-05,-4.05555e-08,7.60275e-11,-22930.7,25.7464], Tmin=(100,'K'), Tmax=(474.071,'K')), NASAPolynomial(coeffs=[8.11681,0.0371826,-1.93274e-05,3.82915e-09,-2.70485e-13,-23831.9,-4.78795], Tmin=(474.071,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]COOC(=C)F(3697)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(230)', '[CH2]OOC(=C)F(1093)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'C=C(F)OOC[C]F(3698)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C(F)OOC[CH]F(3660)'],
    products = ['[CH2]C1(F)OOCC1F(3700)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.19853e+06,'s^-1'), n=1.20933, Ea=(21.0385,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R6_SSS_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=[C]OOC[CH]F(3701)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CFO(79)', '[O]C[CH]F(140)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(66.4046,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['CH2CF(70)', '[O]OC[CH]F(221)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2][C](F)OOC=CF(3672)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C(F)OOC[CH]F(3702)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C(F)OOC[CH]F(3660)'],
    products = ['O=C[CH]F(338)', 'CC(=O)F(210)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(18.4084,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'C#COOC[CH]F(1689)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF(40)', '[CH2]OOC(=C)F(1093)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'C=C(F)OOC[C]F-2(3703)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(F)OOCCF(3704)'],
    products = ['C=C(F)OOC[CH]F(3660)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(2.01681e+07,'s^-1'), n=1.16907, Ea=(40.0803,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R6H;Cd_rad_out_singleH;XH_out] + [R6H_RSSSR;Y_rad_out;Cs_H_out_1H] for rate rule [R6H_DSSSS;Cd_rad_out_singleH;Cs_H_out_1H]
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(193.937,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)
