...
"""),
    E0 = (-335.721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,2175,525,239,401,1367,355.767,2068.51],'cm^-1')),
        HinderedRotor(inertia=(0.137566,'amu*angstrom^2'), symmetry=1, barrier=(12.3525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137408,'amu*angstrom^2'), symmetry=1, barrier=(12.351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.711321,'amu*angstrom^2'), symmetry=1, barrier=(63.9923,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53495,0.0572887,-6.71421e-05,4.4276e-08,-1.2024e-11,-40291.8,21.9744], Tmin=(100,'K'), Tmax=(887.968,'K')), NASAPolynomial(coeffs=[8.91994,0.024022,-1.09465e-05,2.08583e-09,-1.45805e-13,-41603.3,-12.7765], Tmin=(887.968,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(CsCFHO) + group(Ct-CtCs) + group(CtCF)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.964,'amu*angstrom^2'), symmetry=1, barrier=(68.1482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0324839,'amu*angstrom^2'), symmetry=1, barrier=(0.746868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00193465,'amu*angstrom^2'), symmetry=1, barrier=(10.7873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51786,0.0599651,-9.44116e-05,8.04387e-08,-2.6454e-11,8537.78,21.4051], Tmin=(100,'K'), Tmax=(889.241,'K')), NASAPolynomial(coeffs=[7.50009,0.0212576,-9.21681e-06,1.64765e-09,-1.08155e-13,7940.33,-4.13063], Tmin=(889.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.2865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Ct-CtCs) + group(CtCF) + radical(CCsJOH)"""),
)

species(
    label = '[C]#CCC(O)F(10223)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (101.189,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,2750,2850,1437.5,1250,1305,750,350,2175,525,180,398.34],'cm^-1')),
        HinderedRotor(inertia=(0.149326,'amu*angstrom^2'), symmetry=1, barrier=(3.43329,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56368,0.0545333,-7.05293e-05,5.0111e-08,-1.40815e-11,12257,20.281], Tmin=(100,'K'), Tmax=(929.524,'K')), NASAPolynomial(coeffs=[9.57219,0.0174307,-6.39601e-06,1.05855e-09,-6.69405e-14,10882.2,-17.1567], Tmin=(929.524,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(CsCFHO) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.207723,'amu*angstrom^2'), symmetry=1, barrier=(4.77596,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01096,'amu*angstrom^2'), symmetry=1, barrier=(23.2441,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53747,0.058319,-7.59602e-05,5.44624e-08,-1.59522e-11,-24551.7,21.9107], Tmin=(100,'K'), Tmax=(827.57,'K')), NASAPolynomial(coeffs=[8.94608,0.0225079,-1.10478e-05,2.16779e-09,-1.53664e-13,-25777.9,-12.429], Tmin=(827.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cdj(Cdd-Cd)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.11073,'amu*angstrom^2'), symmetry=1, barrier=(25.5379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11835,'amu*angstrom^2'), symmetry=1, barrier=(25.713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11346,'amu*angstrom^2'), symmetry=1, barrier=(25.6007,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10943,0.0684209,-8.89478e-05,6.11976e-08,-1.70294e-11,-29533.7,21.4982], Tmin=(100,'K'), Tmax=(871.889,'K')), NASAPolynomial(coeffs=[10.8504,0.0237314,-1.20634e-05,2.40961e-09,-1.72774e-13,-31232.3,-24.1611], Tmin=(871.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-246.388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(CdCCF) + group(CdJ2_singlet-Cds)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48838,0.0285271,-1.02211e-05,-3.19713e-09,1.88841e-12,-3913.89,18.3007], Tmin=(100,'K'), Tmax=(1327.9,'K')), NASAPolynomial(coeffs=[9.84972,0.0165921,-8.30555e-06,1.64795e-09,-1.16986e-13,-6771.68,-22.7004], Tmin=(1327.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.0257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CtHH) + group(Cds-OdCsH) + group(Ct-CtCs) + group(CtCF)"""),
)

species(
    label = 'OC=CC#CF(10227)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.23583,'amu*angstrom^2'), symmetry=1, barrier=(28.4141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24012,'amu*angstrom^2'), symmetry=1, barrier=(28.5128,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54656,0.0415521,-1.2834e-05,-2.69577e-08,1.71069e-11,-4452.6,17.8767], Tmin=(100,'K'), Tmax=(929.488,'K')), NASAPolynomial(coeffs=[18.4049,0.000865114,1.40788e-06,-2.93214e-10,1.5847e-14,-8962.87,-69.626], Tmin=(929.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.8509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-CdsCtH) + group(Cds-CdsOsH) + group(Ct-Ct(Cds-Cds)) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OC(F)C#CF(10220)'],
    products = ['OC(F)CC#CF(7469)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'F[C]CC#CF(9057)'],
    products = ['OC(F)CC#CF(7469)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'FC#CC=CF(10221)'],
    products = ['OC(F)CC#CF(7469)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O[CH]CC#CF(10222)'],
    products = ['OC(F)CC#CF(7469)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[C]#CCC(O)F(10223)'],
    products = ['OC(F)CC#CF(7469)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'FC#CC[CH]F(3999)'],
    products = ['OC(F)CC#CF(7469)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['O[CH]F(450)', '[CH2]C#CF(7360)'],
    products = ['OC(F)CC#CF(7469)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[C]#CF(3939)', '[CH2]C(O)F(145)'],
    products = ['OC(F)CC#CF(7469)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'OC(F)C=C=[C]F(10224)'],
    products = ['OC(F)CC#CF(7469)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O[C](F)CC#CF(9059)'],
    products = ['OC(F)CC#CF(7469)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=CCC#CF(10226)'],
    products = ['OC(F)CC#CF(7469)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'OC=CC#CF(10227)'],
    products = ['OC(F)CC#CF(7469)'],
...
network(
    label = 'PDepNetwork #2980',
    isomers = [
        'OC(F)CC#CF(7469)',
    ],
    reactants = [
        ('CHFO(47)', 'C=C=CF(6101)'),
        ('[C]#CF(3939)', '[CH2]C(O)F(145)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
