...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC(F)(F)OF(3365)'],
    products = ['O=CCC(F)(F)OF(4753)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(499)', 'O=CC[C]F(2116)'],
    products = ['O=CCC(F)(F)OF(4753)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(142)', 'O=CC=C(F)F(2991)'],
    products = ['O=CCC(F)(F)OF(4753)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C[CH]C(F)(F)OF(4973)'],
    products = ['O=CCC(F)(F)OF(4753)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=CC[C](F)OF(2123)'],
    products = ['O=CCC(F)(F)OF(4753)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)(F)CC=O(4975)'],
    products = ['O=CCC(F)(F)OF(4753)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(126)', 'O=CC[C](F)F(2964)'],
    products = ['O=CCC(F)(F)OF(4753)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FO[C](F)F(4688)', 'CH2CHO(35)'],
    products = ['O=CCC(F)(F)OF(4753)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', '[CH2]C(F)(F)OF(4811)'],
    products = ['O=CCC(F)(F)OF(4753)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C=CC(F)(F)OF(4976)'],
    products = ['O=CCC(F)(F)OF(4753)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=[C]CC(F)(F)OF(4977)'],
    products = ['O=CCC(F)(F)OF(4753)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'O=CCC(=O)F(1002)'],
    products = ['O=CCC(F)(F)OF(4753)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=CC=C(F)OF(4978)'],
    products = ['O=CCC(F)(F)OF(4753)'],
