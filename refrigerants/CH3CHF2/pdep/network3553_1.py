...
"""),
    E0 = (-773.009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,286.493,286.927,287.146],'cm^-1')),
        HinderedRotor(inertia=(0.157911,'amu*angstrom^2'), symmetry=1, barrier=(9.13962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157897,'amu*angstrom^2'), symmetry=1, barrier=(9.13823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15516,'amu*angstrom^2'), symmetry=1, barrier=(9.13776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.527961,'amu*angstrom^2'), symmetry=1, barrier=(30.849,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-759.524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,259,529,569,1128,1321,1390,3140,375,361,584,565,722,1474,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.551912,'amu*angstrom^2'), symmetry=1, barrier=(12.6896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551994,'amu*angstrom^2'), symmetry=1, barrier=(12.6914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.873686,'amu*angstrom^2'), symmetry=1, barrier=(20.0878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53401,'amu*angstrom^2'), symmetry=1, barrier=(35.2699,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.467756,0.106283,-0.000177171,1.4882e-07,-4.89706e-11,-91196.4,29.287], Tmin=(100,'K'), Tmax=(792.811,'K')), NASAPolynomial(coeffs=[14.5361,0.0251987,-1.35729e-05,2.68561e-09,-1.88115e-13,-93406.2,-38.5474], Tmin=(792.811,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-759.524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.411885,0.0837099,-0.000121019,8.75984e-08,-2.49265e-11,-39626.7,26.8652], Tmin=(100,'K'), Tmax=(863.252,'K')), NASAPolynomial(coeffs=[14.1738,0.0199414,-1.02125e-05,2.02466e-09,-1.4391e-13,-42002.7,-37.5043], Tmin=(863.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-330.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.280093,'amu*angstrom^2'), symmetry=1, barrier=(6.43988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282533,'amu*angstrom^2'), symmetry=1, barrier=(6.49599,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282645,'amu*angstrom^2'), symmetry=1, barrier=(6.49857,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0425148,0.100108,-0.000188999,1.7531e-07,-6.12997e-11,-41213.4,29.0317], Tmin=(100,'K'), Tmax=(858.733,'K')), NASAPolynomial(coeffs=[9.49546,0.0283958,-1.53841e-05,2.98972e-09,-2.04623e-13,-41816.3,-9.19118], Tmin=(858.733,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-343.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFHH) + radical(CsCsF1sO2s) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)

species(
    label = '[O]C(F)(F)C(O)[CH]F(10458)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-647.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,334,575,1197,1424,3202,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.273815,'amu*angstrom^2'), symmetry=1, barrier=(6.29554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273818,'amu*angstrom^2'), symmetry=1, barrier=(6.29561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273818,'amu*angstrom^2'), symmetry=1, barrier=(6.29561,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.360031,0.0888618,-0.000154062,1.36393e-07,-4.66528e-11,-77759.6,27.7153], Tmin=(100,'K'), Tmax=(835.821,'K')), NASAPolynomial(coeffs=[10.4371,0.0255568,-1.33907e-05,2.60611e-09,-1.80044e-13,-78917.4,-15.9428], Tmin=(835.821,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-647.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00860559,'amu*angstrom^2'), symmetry=1, barrier=(3.87375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.613088,'amu*angstrom^2'), symmetry=1, barrier=(14.0961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0311612,'amu*angstrom^2'), symmetry=1, barrier=(14.151,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58773,0.0547405,-6.12157e-05,3.50165e-08,-8.04183e-12,-74577.9,25.4118], Tmin=(100,'K'), Tmax=(1050.88,'K')), NASAPolynomial(coeffs=[11.2435,0.0179877,-8.75584e-06,1.73664e-09,-1.24711e-13,-76607.3,-21.6507], Tmin=(1050.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-620.787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFHH) + group(COCsFO) + radical(CsCsF1sH)"""),
)

species(
    label = 'OC([CH]F)=C(F)OF(10462)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.244333,0.0886937,-0.000130726,9.94867e-08,-3.00659e-11,-127793,28.6054], Tmin=(100,'K'), Tmax=(810.989,'K')), NASAPolynomial(coeffs=[13.1772,0.0249112,-1.27646e-05,2.52618e-09,-1.79001e-13,-129891,-31.0799], Tmin=(810.989,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1063.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OC([CH]F)C(F)(F)OF(10391)'],
    products = ['HF(38)', 'CF2O(49)', 'O=C[CH]F(338)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(27.2864,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(200.523,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OC(F)(OF)C(F)[CH]F(10444)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]C(O)C(F)(F)OF-2(10455)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(230)', 'O[CH]C(F)(F)OF(4931)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'OC([C]F)C(F)(F)OF(9921)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'FC=CC(F)(F)OF(5027)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)(F)C(O)[CH]F(10458)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'F[CH][CH]C(F)(F)OF(6245)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FO[C](F)F(4688)', 'O[CH][CH]F(446)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O[C]([CH]F)C(F)(F)OF(10460)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'O=C(F)C(O)[CH]F(10461)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(81.966,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'OC([CH]F)=C(F)OF(10462)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(194.329,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction20',
    reactants = ['CHF(40)', 'O[CH]C(F)(F)OF(4931)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC([C]F)C(F)(F)OF-2(9931)'],
    products = ['OC([CH]F)C(F)(F)OF(10391)'],
...
reaction(
    label = 'reaction24',
    reactants = ['OC([CH]F)C(F)(F)OF(10391)'],
    products = ['[O]C(F)(F)C(O)C(F)F(10463)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(221.334,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
