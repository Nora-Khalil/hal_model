...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=C(C)O[O](6352)'],
    products = ['HO2(11)', '[CH]=C=C(4302)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CO[O](199)'],
    products = ['[CH]=C(C)O[O](6352)'],
    transitionState = 'TS2',
