...
reaction(
    label = 'reaction27',
    reactants = ['F(37)', 'O=COO[C]F(5416)'],
    products = ['O=COO[C](F)F(5169)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction28',
    reactants = ['F[C]F(3025)', '[O]OC=O(539)'],
    products = ['O=COO[C](F)F(5169)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction29',
    reactants = ['O=COO[C](F)F(5169)'],
    products = ['FC1(F)O[CH]OO1(5417)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction31',
    reactants = ['[O][C](F)F(4846)', '[O]C=O(166)'],
    products = ['O=COO[C](F)F(5169)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction32',
    reactants = ['[O]O[C](F)F(3031)', 'HCO(15)'],
    products = ['O=COO[C](F)F(5169)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction33',
    reactants = ['H(5)', 'O=[C]OO[C](F)F(4710)'],
    products = ['O=COO[C](F)F(5169)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction34',
    reactants = ['F(37)', 'O=CO[O+]=[C-]F(5418)'],
    products = ['O=COO[C](F)F(5169)'],
    transitionState = 'TS9',
