...
"""),
    E0 = (-472.852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.625202,'amu*angstrom^2'), symmetry=1, barrier=(14.3746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15468,'amu*angstrom^2'), symmetry=1, barrier=(3.55641,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154888,'amu*angstrom^2'), symmetry=1, barrier=(3.56119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.19473,'amu*angstrom^2'), symmetry=1, barrier=(50.4611,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.129732,0.0955781,-0.000158962,1.46198e-07,-5.31392e-11,-56741.7,31.2074], Tmin=(100,'K'), Tmax=(798.808,'K')), NASAPolynomial(coeffs=[7.98451,0.0391414,-2.08667e-05,4.14184e-09,-2.91519e-13,-57450.9,-1.50714], Tmin=(798.808,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-472.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.505209,0.0854413,-0.000117115,8.25085e-08,-2.06177e-11,-96319.9,29.2654], Tmin=(100,'K'), Tmax=(617.819,'K')), NASAPolynomial(coeffs=[10.2521,0.0333075,-1.71764e-05,3.41214e-09,-2.42378e-13,-97733.7,-14.7586], Tmin=(617.819,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-801.829,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFFH) + group(COCsFO) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0550764,0.0741141,-7.26929e-05,3.65e-08,-7.06347e-12,-75841.8,24.09], Tmin=(100,'K'), Tmax=(1386.3,'K')), NASAPolynomial(coeffs=[17.851,0.0168697,-4.37344e-06,5.77283e-10,-3.20071e-14,-80209.3,-65.5342], Tmin=(1386.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-631.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCFHO) + ring(12dioxane) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C1(F)OOCC1(F)F(7240)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.395294,0.0806775,-8.39094e-05,4.31773e-08,-8.38199e-12,-73358.8,26.9949], Tmin=(100,'K'), Tmax=(1432.41,'K')), NASAPolynomial(coeffs=[20.286,0.0127301,-2.07979e-06,1.2361e-10,-5.73001e-16,-78237.7,-76.5615], Tmin=(1432.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-611.369,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CJCOOH) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.147213,'amu*angstrom^2'), symmetry=1, barrier=(3.38471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148274,'amu*angstrom^2'), symmetry=1, barrier=(3.40912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.959682,'amu*angstrom^2'), symmetry=1, barrier=(22.065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.33695,'amu*angstrom^2'), symmetry=1, barrier=(53.731,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0602584,0.101088,-0.000178981,1.65505e-07,-5.92687e-11,-25170.6,32.0014], Tmin=(100,'K'), Tmax=(819.556,'K')), NASAPolynomial(coeffs=[9.09064,0.035112,-1.92203e-05,3.81697e-09,-2.67303e-13,-25954.7,-5.95862], Tmin=(819.556,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-210.401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.213942,'amu*angstrom^2'), symmetry=1, barrier=(4.91894,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5696,'amu*angstrom^2'), symmetry=1, barrier=(36.0882,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0136794,0.0971252,-0.000157861,1.41223e-07,-5.04039e-11,-49522.1,30.8993], Tmin=(100,'K'), Tmax=(783.825,'K')), NASAPolynomial(coeffs=[9.35992,0.0372148,-1.98353e-05,3.94624e-09,-2.78556e-13,-50612,-9.52091], Tmin=(783.825,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-412.868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = 'C=[C]OOCC(F)(F)F(7245)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.4388,0.0853969,-0.00012099,9.64049e-08,-3.15631e-11,-58257.9,30.7981], Tmin=(100,'K'), Tmax=(741.705,'K')), NASAPolynomial(coeffs=[9.91388,0.0342958,-1.76406e-05,3.50717e-09,-2.49494e-13,-59663.4,-12.0821], Tmin=(741.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-485.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(F)OOC[C](F)F(7211)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'C=C(F)OOC[C]F(3698)'],
    products = ['C=C(F)OOC[C](F)F(7211)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(2927)', '[CH2]OOC(=C)F(1093)'],
    products = ['C=C(F)OOC[C](F)F(7211)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=C(F)OOC[C](F)F(7211)'],
    products = ['F[C]1CC(F)(F)COO1(7239)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=C(F)OOC[C](F)F(7211)'],
    products = ['[CH2]C1(F)OOCC1(F)F(7240)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=[C]OOC[C](F)F(7241)'],
    products = ['C=C(F)OOC[C](F)F(7211)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2CFO(79)', '[O]C[C](F)F(2986)'],
    products = ['C=C(F)OOC[C](F)F(7211)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(82.0709,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(8.14976e+13,'m^3/(mol*s)'), n=-2.27223, Ea=(2.26681,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H"""),
)

reaction(
    label = 'reaction12',
    reactants = ['CH2CF(70)', '[O]OC[C](F)F(3041)'],
    products = ['C=C(F)OOC[C](F)F(7211)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2][C](F)OOC=C(F)F(4571)'],
    products = ['C=C(F)OOC[C](F)F(7211)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)OOC[C](F)F(7242)'],
    products = ['C=C(F)OOC[C](F)F(7211)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(20.5123,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'C=C(F)OOC[C]F-2(3703)'],
    products = ['C=C(F)OOC[C](F)F(7211)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF2(43)', '[CH2]OOC(=C)F(1093)'],
    products = ['C=C(F)OOC[C](F)F(7211)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=C(F)OOC[C](F)F(7211)'],
    products = ['C=C(F)OO[CH]C(F)F(7243)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C(F)OOCC(F)F(7244)'],
    products = ['C=C(F)OOC[C](F)F(7211)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=C(F)OOC[C](F)F(7211)'],
    products = ['C=[C]OOCC(F)(F)F(7245)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(191.516,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #2803',
    isomers = [
        'C=C(F)OOC[C](F)F(7211)',
    ],
    reactants = [
