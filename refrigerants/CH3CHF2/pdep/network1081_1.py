...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH]C=C(261)'],
    products = ['[CH]=CC[C](F)F(3016)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=CC=C(F)F(3122)'],
    products = ['[CH]=CC[C](F)F(3016)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H2(23)', '[CH2][C](F)F(2970)'],
    products = ['[CH]=CC[C](F)F(3016)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](264)', '[CH2][C](F)F(2970)'],
    products = ['[CH]=CC[C](F)F(3016)'],
