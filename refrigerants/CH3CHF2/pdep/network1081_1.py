...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3025)', '[CH2]C([O])=O(303)'],
    products = ['[O]C(=O)C[C](F)F(3095)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C[C](F)F(3060)'],
    products = ['[O]C(=O)C[C](F)F(3095)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(=O)C=C(F)F(3324)'],
    products = ['[O]C(=O)C[C](F)F(3095)'],
