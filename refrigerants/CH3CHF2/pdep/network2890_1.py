...
"""),
    E0 = (-40.7837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,615,860,1140,1343,3152,1685,370,1855,455,950,394.551,394.551,1887.55,1887.55],'cm^-1')),
        HinderedRotor(inertia=(0.0823893,'amu*angstrom^2'), symmetry=1, barrier=(9.10132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219519,'amu*angstrom^2'), symmetry=1, barrier=(24.2496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219519,'amu*angstrom^2'), symmetry=1, barrier=(24.2496,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80229,0.0440816,-3.6339e-05,1.4917e-08,-2.45133e-12,-4822.61,25.2678], Tmin=(100,'K'), Tmax=(1443.22,'K')), NASAPolynomial(coeffs=[12.0555,0.0156644,-6.80434e-06,1.27421e-09,-8.81213e-14,-7782.18,-27.9598], Tmin=(1443.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.7837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-OdOsH) + radical(Cdj(Cs-O2sHH)(Cd-F1sH)) + radical((O)CJOCC)"""),
)
...
"""),
    E0 = (-130.929,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,113,247,382,1207,3490,540,610,2055,1855,455,950,305.228,305.682,305.939],'cm^-1')),
        HinderedRotor(inertia=(0.521455,'amu*angstrom^2'), symmetry=1, barrier=(34.4302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519943,'amu*angstrom^2'), symmetry=1, barrier=(34.4364,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25025,0.0582045,-6.77624e-05,3.8173e-08,-8.3424e-12,-15646.2,19.9942], Tmin=(100,'K'), Tmax=(1124.14,'K')), NASAPolynomial(coeffs=[14.4612,0.0111959,-5.03576e-06,9.72985e-10,-6.93564e-14,-18616.3,-45.2871], Tmin=(1124.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCddFH) + group(Cds-OdOsH) + group(Cdd-CdsCds) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (65.5729,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,1855,455,950,750,770,3400,2100,418.395,418.502],'cm^-1')),
        HinderedRotor(inertia=(0.10066,'amu*angstrom^2'), symmetry=1, barrier=(12.5093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.793208,'amu*angstrom^2'), symmetry=1, barrier=(98.5432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.793347,'amu*angstrom^2'), symmetry=1, barrier=(98.5424,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0653,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93583,0.0420328,-3.91635e-05,1.69876e-08,-2.1676e-12,7963.95,19.2884], Tmin=(100,'K'), Tmax=(951.381,'K')), NASAPolynomial(coeffs=[10.7529,0.0124025,-4.17743e-06,6.91656e-10,-4.54649e-14,5949.55,-24.5789], Tmin=(951.381,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.5729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CtOsHH) + group(Cds-OdOsH) + group(Ct-CtCs) + group(Ct-CtH) + radical((O)CJOCC)"""),
)
...
"""),
    E0 = (-42.0501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,167,640,1190,1855,455,950,180,504.487,3770.04],'cm^-1')),
        HinderedRotor(inertia=(0.661199,'amu*angstrom^2'), symmetry=1, barrier=(15.2023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.660911,'amu*angstrom^2'), symmetry=1, barrier=(15.1956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0665694,'amu*angstrom^2'), symmetry=1, barrier=(46.159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79867,0.0500395,-5.25014e-05,2.93449e-08,-6.70453e-12,-4979.51,23.5161], Tmin=(100,'K'), Tmax=(1047.54,'K')), NASAPolynomial(coeffs=[9.72011,0.0197917,-9.1888e-06,1.78035e-09,-1.2612e-13,-6639.12,-15.0683], Tmin=(1047.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.0501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-OdOsH) + radical(Cdj(Cd-CsH)(F1s)) + radical((O)CJOCC)"""),
)

species(
    label = 'O=COC=[C][CH]F(8015)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23117,0.0511227,-3.54067e-05,4.18427e-09,2.80104e-12,-15632.4,23.3015], Tmin=(100,'K'), Tmax=(1073.15,'K')), NASAPolynomial(coeffs=[16.4198,0.0122359,-5.83007e-06,1.203e-09,-9.02541e-14,-19913.1,-55.8031], Tmin=(1073.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-O2sH))"""),
)

species(
    label = 'O=COC[C]=[C]F(8016)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    E0 = (11.6524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1685,370,167,640,1190,398.018,400.943,401.554],'cm^-1')),
        ...
        HinderedRotor(inertia=(0.00104051,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20539,0.0381786,-2.40811e-05,6.92737e-09,-7.87489e-13,1466.63,24.6796], Tmin=(100,'K'), Tmax=(1986.9,'K')), NASAPolynomial(coeffs=[12.9763,0.0164945,-7.71055e-06,1.43448e-09,-9.63423e-14,-2813.48,-34.679], Tmin=(1986.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.6524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-OdOsH) + radical(Cdj(Cs-O2sHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=C(F)CO[C]=O(8017)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68645,0.0526715,-5.76917e-05,3.33061e-08,-7.80099e-12,-6005.72,23.2962], Tmin=(100,'K'), Tmax=(1027.11,'K')), NASAPolynomial(coeffs=[10.2287,0.0194047,-9.10924e-06,1.77316e-09,-1.25932e-13,-7760.52,-18.144], Tmin=(1027.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.6151,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cdj(Cd-CsF1s)(H)) + radical((O)CJOCC)"""),
)

species(
    label = '[CH]=[C]COC(=O)F(8018)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {5,D}
...
"""),
    E0 = (-35.7238,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,482,664,788,1296,1923,1685,370,3120,650,792.5,1650,337.297,337.32,3591.44],'cm^-1')),
        HinderedRotor(inertia=(0.132354,'amu*angstrom^2'), symmetry=1, barrier=(10.5569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.436682,'amu*angstrom^2'), symmetry=1, barrier=(35.9565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.443642,'amu*angstrom^2'), symmetry=1, barrier=(36.0503,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9062,0.0500783,-5.47494e-05,3.37278e-08,-8.7832e-12,-4224.59,23.7228], Tmin=(100,'K'), Tmax=(910.138,'K')), NASAPolynomial(coeffs=[7.81632,0.0241036,-1.19404e-05,2.37052e-09,-1.69837e-13,-5300.39,-4.23358], Tmin=(910.138,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.7238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(COFOO) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[O]C[C]=CF(4122)'],
    products = ['O=[C]OC[C]=CF(7386)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC=C=CF(8010)'],
    products = ['O=[C]OC[C]=CF(7386)'],
    transitionState = 'TS9',
