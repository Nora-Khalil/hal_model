...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.304935,'amu*angstrom^2'), symmetry=1, barrier=(7.01106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305186,'amu*angstrom^2'), symmetry=1, barrier=(7.01683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305849,'amu*angstrom^2'), symmetry=1, barrier=(7.03207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.3796,'amu*angstrom^2'), symmetry=1, barrier=(54.7117,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.529421,0.0881366,-0.000154866,1.48657e-07,-5.5228e-11,-41653.6,32.2504], Tmin=(100,'K'), Tmax=(818.548,'K')), NASAPolynomial(coeffs=[5.80843,0.0386578,-2.07986e-05,4.1204e-09,-2.88728e-13,-41724.4,12.6854], Tmin=(818.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-347.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsFHHO) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (141.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.176696,0.0936374,-0.000158476,1.42041e-07,-4.9755e-11,-87712.3,29.0781], Tmin=(100,'K'), Tmax=(817.942,'K')), NASAPolynomial(coeffs=[9.59399,0.031996,-1.68475e-05,3.30696e-09,-2.30529e-13,-88731.4,-11.2749], Tmin=(817.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-730.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFHHO) + group(Cds-OdCsH) + radical(ROOJ)"""),
)
...
"""),
    E0 = (-581.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,548,1085,1183,1302,1466,1520,3060,3119,3025,407.5,1350,352.5,611,648,830,1210,1753,180,976.576],'cm^-1')),
        HinderedRotor(inertia=(2.13002,'amu*angstrom^2'), symmetry=1, barrier=(48.9734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12878,'amu*angstrom^2'), symmetry=1, barrier=(48.9449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13,'amu*angstrom^2'), symmetry=1, barrier=(48.9729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.672706,'amu*angstrom^2'), symmetry=1, barrier=(15.4668,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1975,0.068044,-8.64159e-05,6.20479e-08,-1.86981e-11,-69852.8,25.4109], Tmin=(100,'K'), Tmax=(795.573,'K')), NASAPolynomial(coeffs=[8.59385,0.0308579,-1.63068e-05,3.30086e-09,-2.38232e-13,-71029.7,-8.58103], Tmin=(795.573,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFHHO) + group(COCsFO) + radical(OCJC=O)"""),
)
...
"""),
    ...
    molecularWeight = (141.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09697,0.0711342,-8.80905e-05,6.30553e-08,-1.92496e-11,-46458.7,29.1167], Tmin=(100,'K'), Tmax=(780.468,'K')), NASAPolynomial(coeffs=[8.13785,0.0350506,-1.8744e-05,3.82333e-09,-2.7734e-13,-47557.8,-3.10672], Tmin=(780.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-387.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsFHHO) + ring(Cs-Cs(F)-O2s-O2s) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'FCOO[CH]C1(F)OO1(3846)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (141.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.775429,0.0780483,-0.000102079,7.48582e-08,-2.28589e-11,-51405.6,27.8373], Tmin=(100,'K'), Tmax=(788.285,'K')), NASAPolynomial(coeffs=[9.50076,0.033772,-1.78245e-05,3.60084e-09,-2.59383e-13,-52781.2,-12.1814], Tmin=(788.285,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-428.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFOO) + group(Cs-CsOsHH) + group(CsFHHO) + ring(O2s-O2s-Cs(F)(C)) + radical(CCsJOOC)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.429215,'amu*angstrom^2'), symmetry=1, barrier=(9.86849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.428736,'amu*angstrom^2'), symmetry=1, barrier=(9.85749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.429569,'amu*angstrom^2'), symmetry=1, barrier=(9.87663,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.371721,'amu*angstrom^2'), symmetry=1, barrier=(8.5466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.925343,'amu*angstrom^2'), symmetry=1, barrier=(21.2755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.23317,'amu*angstrom^2'), symmetry=1, barrier=(51.3449,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98781,0.0540047,-4.22709e-05,-3.94427e-08,6.6455e-11,-19494,22.3255], Tmin=(100,'K'), Tmax=(466.695,'K')), NASAPolynomial(coeffs=[7.17516,0.027435,-1.43754e-05,2.84914e-09,-2.00975e-13,-20173,-0.834635], Tmin=(466.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    E0 = (-259.532,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1310,387.5,850,1000,548,1085,1183,1302,1466,1520,3060,3119,293,496,537,1218,1685,370,180,1513.71],'cm^-1')),
        HinderedRotor(inertia=(0.360157,'amu*angstrom^2'), symmetry=1, barrier=(8.28071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.09944,'amu*angstrom^2'), symmetry=1, barrier=(48.2702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00508865,'amu*angstrom^2'), symmetry=1, barrier=(8.28511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.360273,'amu*angstrom^2'), symmetry=1, barrier=(8.2834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.09939,'amu*angstrom^2'), symmetry=1, barrier=(48.2691,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.457818,0.093722,-0.000178036,1.79736e-07,-6.85546e-11,-31102.2,34.8753], Tmin=(100,'K'), Tmax=(829.392,'K')), NASAPolynomial(coeffs=[3.38468,0.0442178,-2.45024e-05,4.88052e-09,-3.41858e-13,-30370.6,28.6401], Tmin=(829.392,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsFHHO) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(C=CJO)"""),
)

species(
    label = 'OOC(F)=COO[CH]F(3853)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  O u0 p2 c0 {4,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.332608,'amu*angstrom^2'), symmetry=1, barrier=(7.6473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334203,'amu*angstrom^2'), symmetry=1, barrier=(7.68399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.05365,'amu*angstrom^2'), symmetry=1, barrier=(47.2175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334938,'amu*angstrom^2'), symmetry=1, barrier=(7.70088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.05331,'amu*angstrom^2'), symmetry=1, barrier=(47.2097,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147852,0.0974181,-0.000175119,1.66873e-07,-6.14218e-11,-35980.9,33.0985], Tmin=(100,'K'), Tmax=(816.103,'K')), NASAPolynomial(coeffs=[7.20797,0.0382414,-2.11875e-05,4.23274e-09,-2.97599e-13,-36315,5.48565], Tmin=(816.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-300.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsFHHO) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsF1sHO2s)"""),
)

species(
    label = '[CH2]OOC=C(F)OOF(3854)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.3529,'amu*angstrom^2'), symmetry=1, barrier=(31.1059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33542,'amu*angstrom^2'), symmetry=1, barrier=(30.704,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.261211,0.0928284,-0.000158038,1.47405e-07,-5.42226e-11,601.024,31.9275], Tmin=(100,'K'), Tmax=(793.123,'K')), NASAPolynomial(coeffs=[7.70958,0.0377495,-2.07456e-05,4.16024e-09,-2.94347e-13,-29.6163,1.19246], Tmin=(793.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.96332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsJOOC)"""),
)

species(
    label = 'FCOOC=[C]OOF(3855)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.115,'amu*angstrom^2'), symmetry=1, barrier=(25.636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11346,'amu*angstrom^2'), symmetry=1, barrier=(25.6005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11566,'amu*angstrom^2'), symmetry=1, barrier=(25.6512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.416777,0.0855915,-0.00012432,9.61864e-08,-3.00038e-11,-577.028,34.4091], Tmin=(100,'K'), Tmax=(782.015,'K')), NASAPolynomial(coeffs=[11.5574,0.0286066,-1.50149e-05,3.00359e-09,-2.14282e-13,-2319.45,-16.5988], Tmin=(782.015,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.81894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(CsFHHO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)=COOCF(3838)'],
    products = ['CHFO(47)', '[O]OC(F)C=O(1537)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]OC(F)=COO(3391)'],
    products = ['[O]OC(F)=COOCF(3838)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]OC(F)=COOF(3842)'],
    products = ['[O]OC(F)=COOCF(3838)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=C(F)[CH]OOCF(3844)'],
    products = ['[O]OC(F)=COOCF(3838)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]OC(F)=COOCF(3838)'],
    products = ['[O]CF(187)', 'FC1=COOO1(3394)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]OC(F)=COOCF(3838)'],
    products = ['FCOO[CH]C1(F)OO1(3846)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]OOC=C(F)O[O](3400)'],
    products = ['[O]OC(F)=COOCF(3838)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]O[C]=COOCF(3847)'],
    products = ['[O]OC(F)=COOCF(3838)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]CF(187)', '[O]O[C](F)C=O(1584)'],
    products = ['[O]OC(F)=COOCF(3838)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2F(46)', '[O]OC=C(F)O[O](3398)'],
    products = ['[O]OC(F)=COOCF(3838)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OCF(376)', '[CH]=C(F)O[O](1081)'],
    products = ['[O]OC(F)=COOCF(3838)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]OC(F)=COO[CH]F(3849)'],
    products = ['[O]OC(F)=COOCF(3838)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]OC(F)=[C]OOCF(3850)'],
    products = ['[O]OC(F)=COOCF(3838)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[O]OC#COOCF(3851)'],
    products = ['[O]OC(F)=COOCF(3838)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]OOC=C(F)OOF(3854)'],
    products = ['[O]OC(F)=COOCF(3838)'],
