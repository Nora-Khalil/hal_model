...
"""),
    E0 = (-57.3487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,1855,455,950,180],'cm^-1')),
        HinderedRotor(inertia=(0.183499,'amu*angstrom^2'), symmetry=1, barrier=(4.21899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.579679,'amu*angstrom^2'), symmetry=1, barrier=(13.328,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31611,0.0403379,-5.93251e-05,5.00178e-08,-1.6628e-11,-6839.99,16.2311], Tmin=(100,'K'), Tmax=(861.127,'K')), NASAPolynomial(coeffs=[6.15015,0.0164176,-7.01388e-06,1.27876e-09,-8.58363e-14,-7273.73,-0.377142], Tmin=(861.127,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.3487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (-220.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.0608858,'amu*angstrom^2'), symmetry=1, barrier=(22.8528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52438,'amu*angstrom^2'), symmetry=1, barrier=(35.0484,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0616,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.87032,0.0199059,1.32482e-05,-3.01776e-08,1.26556e-11,-26573.1,10.6336], Tmin=(10,'K'), Tmax=(926.896,'K')), NASAPolynomial(coeffs=[5.7438,0.0242335,-1.38425e-05,3.75506e-09,-3.93446e-13,-27453.6,-1.13896], Tmin=(926.896,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-220.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""ODC[CH]CF""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CO(13)', 'CH2F-CH2(62)'],
    products = ['O=[C]CCF(1350)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(65100,'m^3/(mol*s)'), n=0.45, Ea=(28.7849,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R->O_N-3BrCClFHINPSSi-inRing_3BrCClFHINPSSi->C_Ext-3C-R_Sp-4R!H-3C_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R->O_N-3BrCClFHINPSSi-inRing_3BrCClFHINPSSi->C_Ext-3C-R_Sp-4R!H-3C_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'CH3CO(34)'],
    products = ['O=[C]CCF(1350)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.39871e-05,'m^3/(mol*s)'), n=3.10993, Ea=(25.2324,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s
...
reaction(
    ...
    products = ['O=[C]CCF(1350)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(145.934,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(=O)CF(1351)'],
    products = ['O=[C]CCF(1350)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C][CH]CF(2700)'],
    products = ['O=[C]CCF(1350)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(2.88633e+07,'m^3/(mol*s)'), n=0.213913, Ea=(1.1681,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=8.197906922440378e-05, var=0.01210657880115639, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]C[CH]F(304)'],
    products = ['O=[C]CCF(1350)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=CC[CH]F(343)'],
    products = ['O=[C]CCF(1350)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(91.367,'s^-1'), n=3.04268, Ea=(155.793,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3H_SS_Cs;C_rad_out_1H;XH_out] for rate rule [R3H_SS_Cs;C_rad_out_1H;CO_H_out]
Euclidian distance = 1.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]CCF(1350)'],
    products = ['[CH2]CC(=O)F(1855)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(207.434,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
