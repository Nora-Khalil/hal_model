...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.89499,'amu*angstrom^2'), symmetry=1, barrier=(43.5695,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06022,0.0235159,3.48138e-05,-7.80705e-08,3.54781e-11,-25689.8,18.2993], Tmin=(100,'K'), Tmax=(937.232,'K')), NASAPolynomial(coeffs=[20.3922,-0.00598487,4.02582e-06,-6.86093e-10,3.62459e-14,-31266.7,-80.373], Tmin=(937.232,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(120.56,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-O2d)) + group(Cds-OdOsH) + group(Cds-OdOsH) + radical((O)CJOC) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[O]O[C]=O(700)'],
    products = ['O=[C]OO[C]=O(1948)'],
    transitionState = 'TS2',
