...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17022,0.0543214,-3.61168e-05,7.4916e-09,1.116e-12,-40173.7,21.8214], Tmin=(100,'K'), Tmax=(1074.94,'K')), NASAPolynomial(coeffs=[13.4461,0.0215818,-8.4892e-06,1.55675e-09,-1.08422e-13,-43560.5,-41.7675], Tmin=(1074.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.672126,'amu*angstrom^2'), symmetry=1, barrier=(15.4535,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35758,0.0563455,-5.19919e-05,2.53117e-08,-5.00267e-12,-11580,21.6215], Tmin=(100,'K'), Tmax=(1207.77,'K')), NASAPolynomial(coeffs=[11.7491,0.0219299,-9.24906e-06,1.7184e-09,-1.19012e-13,-14090.1,-30.4732], Tmin=(1207.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.0847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-98.4594,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,2100,2250,500,550,180,956.435],'cm^-1')),
        HinderedRotor(inertia=(0.347589,'amu*angstrom^2'), symmetry=1, barrier=(7.99175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.52941,'amu*angstrom^2'), symmetry=1, barrier=(104.14,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.50888,'amu*angstrom^2'), symmetry=1, barrier=(103.668,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39369,0.0565294,-5.79329e-05,3.40643e-08,-8.18234e-12,-11747.4,23.4044], Tmin=(100,'K'), Tmax=(1007.41,'K')), NASAPolynomial(coeffs=[9.72162,0.023463,-8.69865e-06,1.4833e-09,-9.70754e-14,-13425.4,-16.8346], Tmin=(1007.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.4594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsHH) + group(CsCsFFH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Csj(Cs-CtHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.369796,'amu*angstrom^2'), symmetry=1, barrier=(8.50235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.369587,'amu*angstrom^2'), symmetry=1, barrier=(8.49753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.369639,'amu*angstrom^2'), symmetry=1, barrier=(8.49873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74024,0.0586703,-4.30116e-05,-2.41004e-08,4.52095e-11,1611.2,22.7956], Tmin=(100,'K'), Tmax=(496.26,'K')), NASAPolynomial(coeffs=[6.67113,0.0344147,-1.65128e-05,3.19408e-09,-2.23825e-13,931.076,0.540064], Tmin=(496.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.7952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C=C[C](F)F(6550)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', 'C=C[C]C(6411)'],
    products = ['C[C]=CC[C](F)F(6378)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C[C]=CC=C(F)F(6543)'],
    products = ['C[C]=CC[C](F)F(6378)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC#CC[C](F)F(6545)'],
    products = ['C[C]=CC[C](F)F(6378)'],
