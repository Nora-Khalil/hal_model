...
reaction(
    label = 'reaction3',
    reactants = ['OOC[C](F)F(3088)'],
    products = ['OH(7)', 'FC1(F)CO1(3185)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'OOC[C]F(3714)'],
    products = ['OOC[C](F)F(3088)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(11)', '[CH2][C](F)F(3068)'],
    products = ['OOC[C](F)F(3088)'],
    transitionState = 'TS6',
