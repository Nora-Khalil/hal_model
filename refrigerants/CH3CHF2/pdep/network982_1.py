...
reaction(
    label = 'reaction2',
    reactants = ['O=C=C(O)OOF(2853)'],
    products = ['O=C(O)C(=O)OF(2847)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'O=[C]C(=O)OF(2695)'],
    products = ['O=C(O)C(=O)OF(2847)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(=O)C(=O)OF(2859)'],
    products = ['O=C(O)C(=O)OF(2847)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(126)', 'O=[C]C(=O)O(2804)'],
    products = ['O=C(O)C(=O)OF(2847)'],
