...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC[C](F)F(3109)'],
    products = ['[CH]=CC([CH2])(F)F(3108)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C=C(F)F(3207)'],
    products = ['[CH]=CC([CH2])(F)F(3108)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H2(23)', '[CH2][C](F)F(3068)'],
    products = ['[CH]=CC([CH2])(F)F(3108)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#CC([CH2])(F)F(3208)'],
    products = ['[CH]=CC([CH2])(F)F(3108)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[CH](264)', '[CH2][C](F)F(3068)'],
    products = ['[CH]=CC([CH2])(F)F(3108)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[CH]=C=C([CH2])F(3209)'],
    products = ['[CH]=CC([CH2])(F)F(3108)'],
