...
reaction(
    label = 'reaction1',
    reactants = ['CH2F(46)', 'CH2CHF(56)'],
    products = ['[CH2]C(F)CF(961)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'CHF2-CH2(64)'],
    products = ['[CH2]C(F)CF(961)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)CF(961)'],
    products = ['F[CH]CCF(771)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'CH2F-CHF(66)'],
    products = ['[CH2]C(F)CF(961)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C([CH2])F(238)'],
    products = ['[CH2]C(F)CF(961)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', '[CH2][CH]F(233)'],
    products = ['[CH2]C(F)CF(961)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(F)[CH]F(252)'],
    products = ['[CH2]C(F)CF(961)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2]C(=C)F(1340)'],
    products = ['[CH2]C(F)CF(961)'],
