...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(395)', '[O]C[C](F)F(2986)'],
    products = ['C=[C]OC[C](F)F(3024)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]O[C]=C(396)'],
    products = ['C=[C]OC[C](F)F(3024)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=[C]OC=C(F)F(3206)'],
    products = ['C=[C]OC[C](F)F(3024)'],
    transitionState = 'TS8',
