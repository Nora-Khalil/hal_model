...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C[CH]F(140)'],
    products = ['[CH2]C(F)C[O](192)'],
    transitionState = 'TS3',
