...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.378928,'amu*angstrom^2'), symmetry=1, barrier=(8.71229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339568,'amu*angstrom^2'), symmetry=1, barrier=(24.0722,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0808,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11223,0.0361484,-2.35637e-05,7.36633e-09,-9.16132e-13,15706.7,16.3589], Tmin=(100,'K'), Tmax=(1862.26,'K')), NASAPolynomial(coeffs=[12.284,0.0143003,-5.96572e-06,1.06651e-09,-7.04156e-14,11918.2,-39.0389], Tmin=(1862.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CJ2_singlet-FC)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.140105,'amu*angstrom^2'), symmetry=1, barrier=(3.22128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144283,'amu*angstrom^2'), symmetry=1, barrier=(3.31735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284689,'amu*angstrom^2'), symmetry=1, barrier=(6.54556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.749465,0.08003,-0.000124315,1.13704e-07,-4.17018e-11,-53367.1,24.9708], Tmin=(100,'K'), Tmax=(797.809,'K')), NASAPolynomial(coeffs=[6.18436,0.0385532,-1.95823e-05,3.83433e-09,-2.68607e-13,-53781.5,2.81603], Tmin=(797.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-444.624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFO)"""),
)

species(
    label = 'CC(COF)=C(F)F(11424)',
...
"""),
    E0 = (-444.381,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,182,240,577,636,1210,1413,245.381,3414.66],'cm^-1')),
        HinderedRotor(inertia=(0.246153,'amu*angstrom^2'), symmetry=1, barrier=(10.4951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245809,'amu*angstrom^2'), symmetry=1, barrier=(10.4931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03677,'amu*angstrom^2'), symmetry=1, barrier=(44.2652,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.946259,0.0724751,-9.06177e-05,6.56664e-08,-1.983e-11,-53341.6,24.6848], Tmin=(100,'K'), Tmax=(798.204,'K')), NASAPolynomial(coeffs=[8.90728,0.0325784,-1.56393e-05,3.04062e-09,-2.14452e-13,-54612.4,-11.9278], Tmin=(798.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-444.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFF)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.752681,'amu*angstrom^2'), symmetry=1, barrier=(17.3056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.752895,'amu*angstrom^2'), symmetry=1, barrier=(17.3105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23833,0.0558431,-4.73672e-05,2.03047e-08,-3.49028e-12,-48626.3,22.4293], Tmin=(100,'K'), Tmax=(1384.83,'K')), NASAPolynomial(coeffs=[13.6756,0.0199189,-8.45558e-06,1.57242e-09,-1.08606e-13,-52071,-41.6227], Tmin=(1384.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sF1sCd))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0040287,'amu*angstrom^2'), symmetry=1, barrier=(11.5185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21878,'amu*angstrom^2'), symmetry=1, barrier=(28.0221,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.590906,0.0811593,-0.000105341,7.42189e-08,-2.13549e-11,-22491.6,24.973], Tmin=(100,'K'), Tmax=(841.209,'K')), NASAPolynomial(coeffs=[11.1752,0.030833,-1.56062e-05,3.10706e-09,-2.22213e-13,-24272.4,-24.2605], Tmin=(841.209,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFFO) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['FOF(499)', 'C=C(C)[C]F(11422)'],
    products = ['C=C(C)C(F)(F)OF(9869)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([CH2])C(F)(F)OF(9907)'],
    products = ['C=C(C)C(F)(F)OF(9869)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(C)=C(F)OF(9876)'],
    products = ['C=C(C)C(F)(F)OF(9869)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(C)C([O])(F)F(11425)'],
    products = ['C=C(C)C(F)(F)OF(9869)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(126)', 'C=C(C)[C](F)F(11426)'],
    products = ['C=C(C)C(F)(F)OF(9869)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FO[C](F)F(4688)', 'C=[C]C(1569)'],
    products = ['C=C(C)C(F)(F)OF(9869)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', 'C=[C]C(F)(F)OF(4958)'],
    products = ['C=C(C)C(F)(F)OF(9869)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=C)C(F)(F)OF(9188)'],
    products = ['C=C(C)C(F)(F)OF(9869)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(C)C(F)(F)OF(9198)'],
    products = ['C=C(C)C(F)(F)OF(9869)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]C(C)C(F)(F)OF-2(11427)'],
    products = ['C=C(C)C(F)(F)OF(9869)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'C=C(C)C(=O)F(6559)'],
    products = ['C=C(C)C(F)(F)OF(9869)'],
