...
"""),
    E0 = (-46.5992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,326,540,652,719,1357,3010,987.5,1337.5,450,1655,196.97,198.014,208.659,2070.53],'cm^-1')),
        HinderedRotor(inertia=(1.2019,'amu*angstrom^2'), symmetry=1, barrier=(30.7204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0100295,'amu*angstrom^2'), symmetry=1, barrier=(30.6315,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.035,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'F[C]C=C(F)F(4036)'],
    products = ['[O]C(F)(F)C=[C]F(4725)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=C(F)C=[C]F(4101)'],
    products = ['[O]C(F)(F)C=[C]F(4725)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)C#CF(4990)'],
    products = ['[O]C(F)(F)C=[C]F(4725)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'O=C(F)[C]=[C]F(4991)'],
    products = ['[O]C(F)(F)C=[C]F(4725)'],
    transitionState = 'TS9',
