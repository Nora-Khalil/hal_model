...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93436,0.0448973,-3.85829e-05,1.70011e-08,-3.06579e-12,-38081.9,19.7707], Tmin=(100,'K'), Tmax=(1299.69,'K')), NASAPolynomial(coeffs=[10.3452,0.0190114,-8.70735e-06,1.67663e-09,-1.18068e-13,-40268.2,-23.0117], Tmin=(1299.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-317.251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-Cdd) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + ring(Cs-Cs(F)-O2s)"""),
)

species(
    label = '[O]C=C(F)C[C]=O(6134)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u1 p2 c0 {6,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-182.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,3010,987.5,1337.5,450,1655,1855,455,950,381.632,381.635],'cm^-1')),
        HinderedRotor(inertia=(0.182028,'amu*angstrom^2'), symmetry=1, barrier=(18.8127,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182032,'amu*angstrom^2'), symmetry=1, barrier=(18.8127,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33019,0.049649,-4.12838e-05,1.55764e-08,-2.26883e-12,-21811.4,24.0687], Tmin=(100,'K'), Tmax=(1654.23,'K')), NASAPolynomial(coeffs=[17.7505,0.00994343,-5.27959e-06,1.06627e-09,-7.5906e-14,-27243.9,-63.4143], Tmin=(1654.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(C=COJ) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (174.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,1855,455,950,469.734,470.074,471.13,471.235,471.589,472.466,473.124],'cm^-1')),
        HinderedRotor(inertia=(0.000765713,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000749531,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0653,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97826,0.0330541,-1.67659e-06,-2.63029e-08,1.30175e-11,21085,19.5513], Tmin=(100,'K'), Tmax=(1010.31,'K')), NASAPolynomial(coeffs=[14.8755,0.00825285,-3.84388e-06,8.54815e-10,-6.88258e-14,17138.7,-49.4356], Tmin=(1010.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-OdCsH) + ring(Cyclopropene) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (-133.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2950,1000,3010,987.5,1337.5,450,1655,2120,512.5,787.5,290.55,290.55,290.55,290.551],'cm^-1')),
        HinderedRotor(inertia=(0.429245,'amu*angstrom^2'), symmetry=1, barrier=(25.7143,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63964,0.0495548,-5.16558e-05,2.64406e-08,-5.31801e-12,-15972.9,21.0325], Tmin=(100,'K'), Tmax=(1208.37,'K')), NASAPolynomial(coeffs=[12.8066,0.0125892,-5.76853e-06,1.12407e-09,-8.02417e-14,-18671.6,-34.9552], Tmin=(1208.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-Cdd) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + ring(Cs-Cs(F)-O2s) + radical(CCsJO)"""),
)
...
"""),
    E0 = (178.713,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,3010,987.5,1337.5,450,1655,1855,455,950,386.952,387.096,387.135,387.19,387.223,387.267,387.387],'cm^-1')),
        HinderedRotor(inertia=(0.222938,'amu*angstrom^2'), symmetry=1, barrier=(23.7074,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20408,0.0494769,-2.45333e-05,-1.52927e-08,1.23609e-11,-14316.8,22.6345], Tmin=(100,'K'), Tmax=(955.424,'K')), NASAPolynomial(coeffs=[18.6088,0.00562681,-1.24554e-06,2.45523e-10,-2.2568e-14,-18967,-67.4704], Tmin=(955.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-119.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cs-Cs(F)-O2s) + radical(C=COJ) + radical(CCsJO)"""),
)

species(
    label = 'O=[C][CH]C1(F)CO1(6139)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13391,0.0417976,-3.58926e-05,1.68229e-08,-3.31752e-12,-8198.49,24.2141], Tmin=(100,'K'), Tmax=(1179.61,'K')), NASAPolynomial(coeffs=[8.32138,0.0208161,-9.21226e-06,1.74426e-09,-1.21818e-13,-9658.24,-6.65889], Tmin=(1179.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.7191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Cs(F)(C)-Cs-O2s) + radical(CCJCO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]C[C]1OC1F(6128)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24357,0.0624563,-8.85857e-05,6.61306e-08,-1.86766e-11,-11950.8,23.1657], Tmin=(100,'K'), Tmax=(1028.34,'K')), NASAPolynomial(coeffs=[9.95116,0.0167738,-4.72062e-06,5.91372e-10,-2.78066e-14,-13117.1,-16.05], Tmin=(1028.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-100.176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(COCsFO) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]CC1(F)[CH]O1(6048)'],
    products = ['FC1=CO1(4185)', 'CH2CO(28)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O=[C]CC1O[C]1F(6049)'],
    products = ['O=[C]CC1(F)[CH]O1(6048)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]CC1(F)[CH]O1(6048)'],
    products = ['C=C([O])C1(F)[CH]O1(6044)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(128)', '[CH2]C1(F)[CH]O1(6083)'],
    products = ['O=[C]CC1(F)[CH]O1(6048)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C1(F)[CH]O1(6083)'],
    products = ['O=[C]CC1(F)[CH]O1(6048)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=[C]CC1=CO1(6135)'],
    products = ['O=[C]CC1(F)[CH]O1(6048)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(33.9499,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction10',
    reactants = ['FC1=CO1(4185)', '[CH2][C]=O(136)'],
    products = ['O=[C]CC1(F)[CH]O1(6048)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(4.62978,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['F[C]1[CH]O1(5587)', 'CH2CO(28)'],
    products = ['O=[C]CC1(F)[CH]O1(6048)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C=CC1(F)[CH]O1(6136)'],
    products = ['O=[C]CC1(F)[CH]O1(6048)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]1[CH]O1(5587)', '[CH2][C]=O(136)'],
    products = ['O=[C]CC1(F)[CH]O1(6048)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=[C]C=C1[CH]O1(6137)'],
    products = ['O=[C]CC1(F)[CH]O1(6048)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]CC1(F)[CH]O1(6048)'],
    products = ['O=C(F)C[C]1[CH]O1(6140)'],
...
network(
    label = 'PDepNetwork #2358',
    isomers = [
        'O=[C]CC1(F)[CH]O1(6048)',
    ],
    reactants = [
        ('FC1=CO1(4185)', 'CH2CO(28)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
