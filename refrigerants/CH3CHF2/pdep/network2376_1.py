...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(2943)', 'O[C]F(5575)'],
    products = ['O[C](F)OO[C](F)F(5955)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[O]O[C](O)F(785)'],
    products = ['O[C](F)OO[C](F)F(5955)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)OO[C](F)F(6017)'],
    products = ['O[C](F)OO[C](F)F(5955)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[C](F)F(2943)', '[OH+]=[C-]F(523)'],
    products = ['O[C](F)OO[C](F)F(5955)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[O]O[C](O)F(785)'],
    products = ['O[C](F)OO[C](F)F(5955)'],
