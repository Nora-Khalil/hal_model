...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'CC(=O)C([O])=O(2693)'],
    products = ['CC(=O)C(=O)OF(2634)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(126)', 'CC(=O)[C]=O(2694)'],
    products = ['CC(=O)C(=O)OF(2634)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'O=[C]C(=O)OF(2695)'],
    products = ['CC(=O)C(=O)OF(2634)'],
