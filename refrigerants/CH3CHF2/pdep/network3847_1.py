...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.849503,'amu*angstrom^2'), symmetry=1, barrier=(19.5318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.850594,'amu*angstrom^2'), symmetry=1, barrier=(19.5568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.851227,'amu*angstrom^2'), symmetry=1, barrier=(19.5714,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19123,0.026445,4.08758e-05,-6.75567e-08,2.66287e-11,53973.4,18.656], Tmin=(100,'K'), Tmax=(972.966,'K')), NASAPolynomial(coeffs=[10.3067,0.0260624,-9.38101e-06,1.7183e-09,-1.23162e-13,50833.1,-28.2965], Tmin=(972.966,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(448.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Allyl_T) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C1=C[C](C)C1(11604)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16724,0.0209979,7.09514e-05,-1.07335e-07,4.27501e-11,43037.6,17.1685], Tmin=(100,'K'), Tmax=(949.181,'K')), NASAPolynomial(coeffs=[13.6985,0.0211852,-6.43503e-06,1.16391e-09,-8.77715e-14,38651.1,-49.4376], Tmin=(949.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Allyl_T) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1([CH2])C=C1C(11594)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (339.57,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2100,2250,500,550,239.046],'cm^-1')),
        HinderedRotor(inertia=(0.0954397,'amu*angstrom^2'), symmetry=1, barrier=(16.3989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471017,'amu*angstrom^2'), symmetry=1, barrier=(81.4853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473023,'amu*angstrom^2'), symmetry=1, barrier=(81.4897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7683,0.0405256,-3.15908e-06,-2.46503e-08,1.27105e-11,40928.9,19.4808], Tmin=(100,'K'), Tmax=(952.761,'K')), NASAPolynomial(coeffs=[10.9567,0.0226643,-7.65113e-06,1.31246e-09,-8.97235e-14,38237.8,-29.3372], Tmin=(952.761,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.57,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-CtHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]C=[C]C(6461)'],
    products = ['[CH2]C(=C)C=[C]C(6717)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)C=[C]C(6717)'],
    products = ['[CH2]C1=C[C](C)C1(11604)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=C)C=[C]C(6717)'],
    products = ['[CH2]C1([CH2])C=C1C(11594)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(=C)C#CC(11606)'],
    products = ['[CH2]C(=C)C=[C]C(6717)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH2])=CC=C(11607)'],
    products = ['[CH2]C(=C)C=[C]C(6717)'],
