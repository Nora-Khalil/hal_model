...
"""),
    E0 = (-27.2325,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,317.893,317.895,317.896],'cm^-1')),
        HinderedRotor(inertia=(0.00166816,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00166817,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157314,'amu*angstrom^2'), symmetry=1, barrier=(11.2813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157316,'amu*angstrom^2'), symmetry=1, barrier=(11.2813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37404,0.0598781,-7.87402e-05,5.57531e-08,-1.57154e-11,-3182.68,20.9194], Tmin=(100,'K'), Tmax=(869.476,'K')), NASAPolynomial(coeffs=[10.3,0.018814,-7.89691e-06,1.43385e-09,-9.6949e-14,-4734.86,-20.8948], Tmin=(869.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.2325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CJCO) + radical(OCJO)"""),
)
...
"""),
    E0 = (-196.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00267512,'amu*angstrom^2'), symmetry=1, barrier=(3.13623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0297288,'amu*angstrom^2'), symmetry=1, barrier=(34.8866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.51744,'amu*angstrom^2'), symmetry=1, barrier=(34.8888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31654,0.0315981,-1.15538e-05,-3.30091e-09,2.26187e-12,-23511.8,18.2117], Tmin=(100,'K'), Tmax=(1210.43,'K')), NASAPolynomial(coeffs=[8.90159,0.0194874,-8.5048e-06,1.60638e-09,-1.12037e-13,-25812.9,-17.7352], Tmin=(1210.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]O(237)', '[CH2]C[O](339)'],
    products = ['[CH2]CO[CH]O(7337)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[CH]O(799)'],
    products = ['[CH2]CO[CH]O(7337)'],
    transitionState = 'TS3',
