...
"""),
    E0 = (19.3742,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1855,455,950,340.008,340.016],'cm^-1')),
        HinderedRotor(inertia=(0.241507,'amu*angstrom^2'), symmetry=1, barrier=(19.8111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45814,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241521,'amu*angstrom^2'), symmetry=1, barrier=(19.8112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01365,0.0357645,-1.23002e-05,-1.331e-08,8.65712e-12,13732.2,20.4361], Tmin=(100,'K'), Tmax=(969.447,'K')), NASAPolynomial(coeffs=[12.3051,0.0118526,-4.00578e-06,7.25071e-10,-5.24715e-14,10865,-33.3909], Tmin=(969.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclopropane) + radical(C2CsJOC(O)H) + radical((O)CJOCC2)"""),
)
...
"""),
    E0 = (34.6935,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,367.092,367.092,367.092,367.092,367.093],'cm^-1')),
        HinderedRotor(inertia=(0.522933,'amu*angstrom^2'), symmetry=1, barrier=(50.0062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.522935,'amu*angstrom^2'), symmetry=1, barrier=(50.0062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.522937,'amu*angstrom^2'), symmetry=1, barrier=(50.0063,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
