...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.832969,'amu*angstrom^2'), symmetry=1, barrier=(19.1516,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.83605,'amu*angstrom^2'), symmetry=1, barrier=(19.2224,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31737,0.0521634,-3.84266e-05,9.64253e-09,9.21017e-13,13529.3,19.482], Tmin=(100,'K'), Tmax=(1012.51,'K')), NASAPolynomial(coeffs=[13.2825,0.0177503,-6.49055e-06,1.1554e-09,-7.98201e-14,10447.3,-41.6458], Tmin=(1012.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_P)"""),
)
...
reaction(
    ...
    products = ['CHFCHF[Z](59)', 'C#CC(5603)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(F)[CH]F(6248)'],
    products = ['[CH]=C(C)C(F)[CH]F(6753)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH]C(C)=CF(6423)'],
    products = ['[CH]=C(C)C(F)[CH]F(6753)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(C)C=CF(6406)'],
    products = ['[CH]=C(C)C(F)[CH]F(6753)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHFCHF[Z](59)', '[CH]=[C]C(5604)'],
    products = ['[CH]=C(C)C(F)[CH]F(6753)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(C)C(F)=CF(6757)'],
    products = ['[CH]=C(C)C(F)[CH]F(6753)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH][CH]F(5595)', 'C#CC(5603)'],
    products = ['[CH]=C(C)C(F)[CH]F(6753)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'C#CC(F)[CH]F(6261)'],
    products = ['[CH]=C(C)C(F)[CH]F(6753)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH][CH]F(5595)', '[CH]=[C]C(5604)'],
    products = ['[CH]=C(C)C(F)[CH]F(6753)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[CH]C(C)=CF(6423)'],
    products = ['[CH]=C(C)C(F)[CH]F(6753)'],
...
network(
    label = 'PDepNetwork #2588',
    isomers = [
        '[CH]=C(C)C(F)[CH]F(6753)',
    ],
    reactants = [
        ('CHFCHF[Z](59)', 'C#CC(5603)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
