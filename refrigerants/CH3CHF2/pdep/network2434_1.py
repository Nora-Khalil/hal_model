...
"""),
    ...
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33178,0.0251765,2.44502e-05,-5.04612e-08,2.13231e-11,46487.5,12.6586], Tmin=(100,'K'), Tmax=(961.155,'K')), NASAPolynomial(coeffs=[11.4492,0.0157151,-5.23375e-06,9.58621e-10,-7.05924e-14,43419.3,-37.8102], Tmin=(961.155,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(385.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(cyclobutadiene_13)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.50272,'amu*angstrom^2'), symmetry=1, barrier=(34.5506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50361,'amu*angstrom^2'), symmetry=1, barrier=(34.5709,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (65.0931,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3541,0.0280262,6.59264e-06,-3.009e-08,1.42284e-11,57270.9,16.6206], Tmin=(100,'K'), Tmax=(942.263,'K')), NASAPolynomial(coeffs=[10.309,0.014648,-4.57099e-06,7.74963e-10,-5.40776e-14,54866.5,-26.0874], Tmin=(942.263,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(475.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtHHH) + group(Cds-CdsCtH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23326,0.0315226,1.36794e-06,-2.34449e-08,1.1291e-11,50542,16.7985], Tmin=(100,'K'), Tmax=(960.49,'K')), NASAPolynomial(coeffs=[9.48042,0.018961,-6.5311e-06,1.13664e-09,-7.83435e-14,48337.1,-22.1035], Tmin=(960.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_S) + radical(C=C=CJ)"""),
)

species(
    label = '[CH2][CH]C#CC(6433)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {4,S} {6,S} {7,S} {8,S}
2  C u1 p0 c0 {3,S} {5,S} {9,S}
...
"""),
    E0 = (458.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2100,2250,500,550,1328.38],'cm^-1')),
        HinderedRotor(inertia=(0.00563466,'amu*angstrom^2'), symmetry=1, barrier=(7.08311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.81199,'amu*angstrom^2'), symmetry=1, barrier=(64.6533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.80894,'amu*angstrom^2'), symmetry=1, barrier=(64.583,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85395,0.0381053,-2.73465e-05,1.19138e-08,-2.09342e-12,55272.8,21.3639], Tmin=(100,'K'), Tmax=(1605.95,'K')), NASAPolynomial(coeffs=[7.64709,0.0187321,-4.63353e-06,5.68123e-10,-2.88121e-14,54049.7,-7.34397], Tmin=(1605.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(458.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Sec_Propargyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C=C[C]=C(6465)',
    structure = adjacencyList("""multiplicity 3
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC=[C]C(6334)'],
    products = ['C2H2(23)', 'C#CC(5436)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]=CC=C=C(6458)'],
    products = ['[CH]=CC=[C]C(6334)'],
    transitionState = 'TS4',
