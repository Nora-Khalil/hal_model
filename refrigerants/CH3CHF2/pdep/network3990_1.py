...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC[CH]F(201)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C[CH]F(3971)'],
    products = ['[CH]=C(CF)C[CH]F(7572)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(230)', '[CH]C(=C)CF(11860)'],
    products = ['[CH]=C(CF)C[CH]F(7572)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]=C(C=CF)CF(11862)'],
    products = ['[CH]=C(CF)C[CH]F(7572)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', 'C#CC[CH]F(266)'],
    products = ['[CH]=C(CF)C[CH]F(7572)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH]C(=C)CF(11860)'],
    products = ['[CH]=C(CF)C[CH]F(7572)'],
