...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])=C=O(1500)'],
    products = ['[O]C(=O)C([O])=O(1946)'],
    transitionState = 'TS2',
