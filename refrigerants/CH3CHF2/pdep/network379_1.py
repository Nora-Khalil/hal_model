...
reaction(
    label = 'reaction12',
    reactants = ['CH2(T)(18)', '[CH2]C([O])=C=O(1317)'],
    products = ['C=C([O])C(=C)[O](1246)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C([O])C(=C)[O](1246)'],
    products = ['[CH2]C1=C([CH2])OO1(1318)'],
