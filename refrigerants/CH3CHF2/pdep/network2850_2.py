...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.12442,0.0207346,-1.96576e-05,1.49099e-08,-5.38104e-12,43859.8,8.50631], Tmin=(100,'K'), Tmax=(756.502,'K')), NASAPolynomial(coeffs=[3.81498,0.0157057,-6.95464e-06,1.30829e-09,-9.06462e-14,43794.7,5.628], Tmin=(756.502,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdJ2_singlet-Cds)"""),
)
...
"""),
    ...
    molecularWeight = (39.0558,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.472,0.0124963,-6.55301e-07,-1.07229e-08,8.00244e-12,61276.1,7.34836], Tmin=(100,'K'), Tmax=(596.288,'K')), NASAPolynomial(coeffs=[4.11418,0.0109709,-3.81716e-06,6.37476e-10,-4.1386e-14,61150.1,4.16746], Tmin=(596.288,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(509.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CH2(S)(25)', 'C2H2(23)'],
    products = ['C#CC(5603)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.63e+07,'cm^3/(mol*s)','*|/',0.25), n=1.475, Ea=(0,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 0 CH2 + C2H2 <=> CH3CCH in 1,2_Insertion_carbene/training
This reaction matched rate rule [CH_Ext-4CbCdCsCt-R_N-4CbCdCsCt->Cs_N-4CbCdCt->Cd]
family: 1,2_Insertion_carbene
Ea raised from -6.9 to 0 kJ/mol."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[CH]=C=C(4167)'],
    products = ['C#CC(5603)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(6.398e+13,'cm^3/(mol*s)'), n=0.102, Ea=(0,'J/mol'), T0=(1,'K'), comment="""Matched reaction 43 C3H3 + H <=> C3H4 in R_Recombination/training
This reaction matched rate rule [Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_N-3C-inRing_Ext-3C-R_4R!H->C_Sp-3C-2C_N-Sp-4C=3C_N-Sp-4C-3C]
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=CC-2(6319)'],
    products = ['C#CC(5603)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.20443e+17,'s^-1'), n=-1.43042, Ea=(39.6395,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'H2CC(24)'],
    products = ['[C]=CC-2(6319)'],
    transitionState = 'TS6',
