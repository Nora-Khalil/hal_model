...
reaction(
    label = 'reaction1',
    reactants = ['CHF2(81)', 'CH2CO(28)'],
    products = ['O=[C]CC(F)F(1563)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C][CH]C(F)F(2961)'],
    products = ['O=[C]CC(F)F(1563)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]C[C](F)F(2962)'],
    products = ['O=[C]CC(F)F(1563)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]CC(F)F(1563)'],
    products = ['O=C(F)C[CH]F(631)'],
