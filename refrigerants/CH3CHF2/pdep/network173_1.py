...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)C[CH]F(632)'],
    products = ['[O]C(F)C[CH]F(621)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C=C[CH]F(633)'],
    products = ['[O]C(F)C[CH]F(621)'],
