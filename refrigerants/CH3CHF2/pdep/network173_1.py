...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', '[O]C[CH]F(140)'],
    products = ['F[CH]CO[CH]F(621)'],
    transitionState = 'TS2',
