...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=[C]OC(O)(F)F(5048)'],
    products = ['O=C(F)OC(O)(F)F(4740)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)F(168)', 'O[C](F)F(4619)'],
    products = ['O=C(F)OC(O)(F)F(4740)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CFO(51)', '[O]C(O)(F)F(4647)'],
    products = ['O=C(F)OC(O)(F)F(4740)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)OC(=O)F(5050)'],
    products = ['O=C(F)OC(O)(F)F(4740)'],
