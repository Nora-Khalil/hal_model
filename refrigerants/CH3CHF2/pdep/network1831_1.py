...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15885,0.0676593,-0.000102347,8.26966e-08,-2.67411e-11,-66292.5,25.3219], Tmin=(100,'K'), Tmax=(757.248,'K')), NASAPolynomial(coeffs=[9.90756,0.0214537,-1.08355e-05,2.14472e-09,-1.51879e-13,-67617.7,-14.4542], Tmin=(757.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-551.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = 'F[CH]C[C](F)OF(4852)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17716,'amu*angstrom^2'), symmetry=1, barrier=(27.0653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23973,'amu*angstrom^2'), symmetry=1, barrier=(5.51186,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238396,'amu*angstrom^2'), symmetry=1, barrier=(5.4812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.805885,0.0785728,-0.00013727,1.23371e-07,-4.27335e-11,-22056.4,24.6684], Tmin=(100,'K'), Tmax=(835.333,'K')), NASAPolynomial(coeffs=[9.13379,0.0238531,-1.23599e-05,2.41241e-09,-1.6712e-13,-22929.9,-10.9111], Tmin=(835.333,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[O][C](F)CC(F)F(3046)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C([O])(F)F(4751)'],
    products = ['[O]C(F)(F)C[CH]F(4753)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C[C](F)F(3037)'],
    products = ['[O]C(F)(F)C[CH]F(4753)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(4846)', 'CH2CHF(56)'],
    products = ['[O]C(F)(F)C[CH]F(4753)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C=CF(4849)'],
    products = ['[O]C(F)(F)C[CH]F(4753)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C[CH]F(632)'],
    products = ['[O]C(F)(F)C[CH]F(4753)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(4846)', '[CH2][CH]F(233)'],
    products = ['[O]C(F)(F)C[CH]F(4753)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)[CH][CH]F(4264)'],
    products = ['[O]C(F)(F)C[CH]F(4753)'],
