...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41204,0.0622059,-6.14292e-05,3.73848e-08,-1.01181e-11,35940.5,27.1263], Tmin=(100,'K'), Tmax=(858.917,'K')), NASAPolynomial(coeffs=[6.7844,0.0371865,-1.77354e-05,3.47071e-09,-2.4681e-13,35017.6,2.02485], Tmin=(858.917,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[CH]=[C]CC=C(C)F(11084)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  C u0 p0 c0 {4,S} {6,S} {8,S} {9,S}
3  C u0 p0 c0 {5,S} {10,S} {11,S} {12,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C[C]=CC[C]=CF(10997)'],
    products = ['C=C=CF(7021)', 'C#CC(5436)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1084)', 'C=C[C]C(6406)'],
    products = ['C[C]=CC[C]=CF(10997)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C=CF(7021)', '[CH]=[C]C(5437)'],
    products = ['C[C]=CC[C]=CF(10997)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C[C]=CC=C=CF(11074)'],
    products = ['C[C]=CC[C]=CF(10997)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C=CC[C]=CF(11008)'],
    products = ['C[C]=CC[C]=CF(10997)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C=[C][CH]F(7022)', 'C#CC(5436)'],
    products = ['C[C]=CC[C]=CF(10997)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC#CC[C]=CF(11075)'],
    products = ['C[C]=CC[C]=CF(10997)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C[C]=CCC#CF(11076)'],
    products = ['C[C]=CC[C]=CF(10997)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=[C][CH]F(7022)', '[CH]=[C]C(5437)'],
    products = ['C[C]=CC[C]=CF(10997)'],
