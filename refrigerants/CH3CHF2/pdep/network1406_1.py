...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC=C(F)F(3187)'],
    products = ['FC1(F)[CH]OO1(4038)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[O]O[C]=C(F)F(4040)'],
    products = ['[O]OC=C(F)F(3187)'],
    transitionState = 'TS6',
