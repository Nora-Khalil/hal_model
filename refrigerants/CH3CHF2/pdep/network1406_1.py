...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'O=C[C]F(1531)'],
    products = ['[CH2]OC=[C]F(3952)'],
    transitionState = 'TS2',
