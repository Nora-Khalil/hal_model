...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.668571,0.067872,-6.24476e-05,3.03817e-08,-5.92832e-12,24436.6,25.498], Tmin=(100,'K'), Tmax=(1236.55,'K')), NASAPolynomial(coeffs=[14.2807,0.0238394,-9.0336e-06,1.58438e-09,-1.06211e-13,21070.2,-43.0629], Tmin=(1236.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_P) + radical(C=C=CJ)"""),
)
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56464,0.040623,1.24159e-05,-4.41984e-08,1.94373e-11,33636.4,21.4345], Tmin=(100,'K'), Tmax=(988.02,'K')), NASAPolynomial(coeffs=[13.2267,0.0240768,-9.02315e-06,1.68337e-09,-1.21443e-13,29835,-42.2627], Tmin=(988.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Allyl_T) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C1=C(CF)[CH]C1(12085)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {5,S} {6,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {4,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51413,0.0397126,2.06769e-05,-5.43705e-08,2.30348e-11,24987,20.5602], Tmin=(100,'K'), Tmax=(995.157,'K')), NASAPolynomial(coeffs=[14.318,0.0239465,-9.36764e-06,1.80364e-09,-1.327e-13,20670.9,-50.0307], Tmin=(995.157,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC([CH2])=C(6453)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C([CH2])=C(6686)'],
    products = ['[CH]=C(CF)C([CH2])=C(11762)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', '[CH]C(=C=C)CF(11896)'],
    products = ['[CH]=C(CF)C([CH2])=C(11762)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(CF)C([CH2])=C(11762)'],
    products = ['[CH2]C1=C(CF)[CH]C1(12085)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CH2F(46)', 'C#CC([CH2])=C(11380)'],
    products = ['[CH]=C(CF)C([CH2])=C(11762)'],
