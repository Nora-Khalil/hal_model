...
"""),
    E0 = (-316.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,322.4,323.05],'cm^-1')),
        HinderedRotor(inertia=(0.00162348,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00162549,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
...
"""),
    E0 = (-254.078,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,234,347,1316,1464,2782.5,750,1395,475,1775,1000],'cm^-1')),
        HinderedRotor(inertia=(0.24683,'amu*angstrom^2'), symmetry=1, barrier=(5.6751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.734909,'amu*angstrom^2'), symmetry=1, barrier=(16.897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0616,'amu'),
...
"""),
    E0 = (-540.319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,352.205],'cm^-1')),
        HinderedRotor(inertia=(0.0531847,'amu*angstrom^2'), symmetry=1, barrier=(4.26253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210203,'amu*angstrom^2'), symmetry=1, barrier=(17.252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.402428,'amu*angstrom^2'), symmetry=1, barrier=(33.1955,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.65254,0.0309104,3.13248e-05,-9.9359e-08,6.1832e-11,-64981.6,11.2364], Tmin=(10,'K'), Tmax=(612.628,'K')), NASAPolynomial(coeffs=[5.6366,0.0356047,-2.33811e-05,7.19614e-09,-8.40063e-13,-65555.9,-0.0663211], Tmin=(612.628,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-540.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""CC(F)(F)[CH]O""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = '[CH2]C(F)(F)CO(3653)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
...
reaction(
    label = 'reaction1',
    reactants = ['CH2O(20)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C[O](3391)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(59.332,'m^3/(mol*s)'), n=1.2975, Ea=(12.6866,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.2890935075667379, var=2.146502499593098, Tref=1000.0, N=39, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CC[O](853)'],
    products = ['CC(F)(F)C[O](3391)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(322.745,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]CF(187)', 'C[C]F(124)'],
    products = ['CC(F)(F)C[O](3391)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(181.777,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', '[O]CC(F)F(1542)'],
    products = ['CC(F)(F)C[O](3391)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(C)(F)F(3101)'],
    products = ['CC(F)(F)C[O](3391)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', '[O]C[C](F)F(3183)'],
    products = ['CC(F)(F)C[O](3391)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](132)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C[O](3391)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C[O](3102)'],
    products = ['CC(F)(F)C[O](3391)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(F)(F)[CH][O](3221)'],
    products = ['CC(F)(F)C[O](3391)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'C=C(F)C[O](351)'],
    products = ['CC(F)(F)C[O](3391)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(10.477,'m^3/(mol*s)'), n=1.29062, Ea=(170.156,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_5R!H->F_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_5R!H->F_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'C[C](F)C=O(7766)'],
    products = ['CC(F)(F)C[O](3391)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(244.096,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction14',
    reactants = ['CC(F)(F)C[O](3391)'],
    products = ['CC(F)(F)[CH]O(9545)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[C](F)COF(503)'],
    products = ['CC(F)(F)C[O](3391)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(98.5687,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
