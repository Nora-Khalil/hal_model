...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC[O](790)'],
    products = ['CC([O])C[O](2283)'],
    transitionState = 'TS2',
