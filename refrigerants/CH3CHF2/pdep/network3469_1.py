...
"""),
    E0 = (141.501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,259,529,569,1128,1321,1390,3140,2750,2850,1437.5,1250,1305,750,350,180,180,1198.09,1198.69,1199.06,1199.61,1199.71,1200.14],'cm^-1')),
        HinderedRotor(inertia=(0.254213,'amu*angstrom^2'), symmetry=1, barrier=(5.84487,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16099,0.0368031,-1.8887e-05,3.79586e-09,-1.67057e-13,17087.9,21.4458], Tmin=(100,'K'), Tmax=(1695.13,'K')), NASAPolynomial(coeffs=[11.5815,0.0198071,-8.47854e-06,1.52375e-09,-1.00578e-13,13142.1,-31.1923], Tmin=(1695.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cs(F)-Cs-Cs) + radical(CCOJ) + radical(Csj(Cs-CsCsH)(Cs-CsF1sH)(H)_ring)"""),
)
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31162,0.0304688,-3.51857e-07,-1.50944e-08,6.10858e-12,-28669.3,18.3967], Tmin=(100,'K'), Tmax=(1132.38,'K')), NASAPolynomial(coeffs=[8.39478,0.0234199,-1.01414e-05,1.92967e-09,-1.35974e-13,-30972.8,-15.7949], Tmin=(1132.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cds-OdCsH) + ring(Cs(F)-Cs-Cs)"""),
)

species(
    label = 'OCC1C=C1F(10018)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {11,S}
3  C u0 p0 c0 {4,S} {5,S} {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08489,0.0421257,-3.07786e-05,1.17789e-08,-1.89693e-12,-10784.7,19.1591], Tmin=(100,'K'), Tmax=(1402.66,'K')), NASAPolynomial(coeffs=[8.93109,0.0226019,-9.8997e-06,1.85528e-09,-1.28196e-13,-12705.3,-16.1863], Tmin=(1402.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.2399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsOsHH) + group(CdCsCdF) + group(Cds-CdsCsH) + ring(Cd-Cd(F)-Cs(C))"""),
)
...
"""),
    E0 = (100.512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,1000,180,180,180,1132.9,1132.93,1133.04,1133.21],'cm^-1')),
        HinderedRotor(inertia=(0.153801,'amu*angstrom^2'), symmetry=1, barrier=(3.53618,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.95276,0.0313202,-1.60711e-05,3.436e-09,-2.73483e-13,12117.9,16.6277], Tmin=(100,'K'), Tmax=(3250.01,'K')), NASAPolynomial(coeffs=[19.9117,0.00763808,-3.84418e-06,6.61913e-10,-3.96305e-14,2578.42,-82.8951], Tmin=(3250.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cd-Cs(F)-Cd) + radical(CCOJ)"""),
)
...
"""),
    E0 = (306.959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,263.582,263.582,263.582,263.582,263.583,1624.88,1624.88,1624.88,1624.88,1624.88],'cm^-1')),
        HinderedRotor(inertia=(0.00242643,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46819,0.0366671,-3.71794e-05,3.00149e-08,-1.14126e-11,36971,14.7126], Tmin=(100,'K'), Tmax=(734.123,'K')), NASAPolynomial(coeffs=[3.57227,0.0277085,-1.28617e-05,2.47127e-09,-1.73273e-13,36888.2,10.2674], Tmin=(734.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CCOJ)"""),
)

species(
    label = '[O]CC1C=C1F(10040)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  O u1 p2 c0 {4,S}
3  C u0 p0 c0 {4,S} {5,S} {6,S} {7,S}
...
"""),
    E0 = (135.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,180,180,1422.48,1423.3,1423.86,1423.9,1424.35],'cm^-1')),
        HinderedRotor(inertia=(0.19886,'amu*angstrom^2'), symmetry=1, barrier=(4.57218,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.2746,0.0304402,-1.46711e-05,2.73023e-09,-1.70323e-13,16303.9,15.6817], Tmin=(100,'K'), Tmax=(2700.92,'K')), NASAPolynomial(coeffs=[25.8072,0.00248008,-2.14757e-06,3.80667e-10,-2.149e-14,2158.86,-119.066], Tmin=(2700.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(CdCsCdF) + ring(Cd-Cd(F)-Cs(C)) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-39.0195,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,259,529,569,1128,1321,1390,3140,2782.5,750,1395,475,1775,1000,180,1237.76,1237.76,1237.77,1237.77,1237.79],'cm^-1')),
        HinderedRotor(inertia=(0.216012,'amu*angstrom^2'), symmetry=1, barrier=(4.96653,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51624,0.0251968,8.16916e-06,-2.39602e-08,9.45862e-12,-4633.22,20.155], Tmin=(100,'K'), Tmax=(1063.72,'K')), NASAPolynomial(coeffs=[8.48644,0.0198845,-8.50693e-06,1.63772e-09,-1.17332e-13,-6872.91,-13.574], Tmin=(1063.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.0195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cds-OdCsH) + ring(Cs(F)-Cs-Cs) + radical(CCJCC=O)"""),
)
...
"""),
    E0 = (459.533,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,358.913,358.913,358.913,358.913,1301.01,1807.59,1807.59,1807.59,1807.59],'cm^-1')),
        HinderedRotor(inertia=(0.581796,'amu*angstrom^2'), symmetry=1, barrier=(53.1835,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.1115,0.0258715,-1.19165e-05,2.13861e-09,-1.18625e-13,55294.8,12.5772], Tmin=(100,'K'), Tmax=(2432.84,'K')), NASAPolynomial(coeffs=[15.9558,0.00890995,-4.02143e-06,6.77434e-10,-4.06402e-14,47815.1,-63.3366], Tmin=(2432.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2485,0.0344642,-1.40139e-05,1.04744e-10,7.82634e-13,16445.1,21.1252], Tmin=(100,'K'), Tmax=(1467.06,'K')), NASAPolynomial(coeffs=[9.45396,0.0225858,-9.81078e-06,1.80384e-09,-1.21927e-13,13495,-19.2474], Tmin=(1467.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsOsHH) + ring(Cs(F)-Cs-Cs) + radical(CCOJ) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring)"""),
)

species(
    label = 'O[CH]C1[CH]C1F(10044)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48052,0.0491613,-4.2179e-05,1.85256e-08,-3.23924e-12,11653.3,22.556], Tmin=(100,'K'), Tmax=(1376.61,'K')), NASAPolynomial(coeffs=[12.849,0.0161279,-6.18465e-06,1.09417e-09,-7.3601e-14,8523.26,-35.9242], Tmin=(1376.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.0933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-CsCsH)(Cs-CsF1sH)(H)_ring) + radical(CCsJOH)"""),
)

species(
    label = '[O][CH]C1CC1F(10045)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u1 p2 c0 {6,S}
3  C u0 p0 c0 {4,S} {5,S} {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.66523,0.0361602,-1.9265e-05,4.5125e-09,-4.10548e-13,10476.6,18.02], Tmin=(100,'K'), Tmax=(2382.23,'K')), NASAPolynomial(coeffs=[12.5561,0.0195524,-8.8076e-06,1.58599e-09,-1.03427e-13,5764.21,-38.2833], Tmin=(2382.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.7724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cs(F)-Cs-Cs) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'OC[C]1[CH]C1F(10046)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {11,S}
3  C u0 p0 c0 {1,S} {5,S} {6,S} {7,S}
...
"""),
    E0 = (145.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,3150,900,1100,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,180,1043.87,1043.91,1043.95,1043.97,1043.97,1043.97],'cm^-1')),
        HinderedRotor(inertia=(0.165266,'amu*angstrom^2'), symmetry=1, barrier=(3.79978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.667201,'amu*angstrom^2'), symmetry=1, barrier=(15.3403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82189,0.0393835,-1.19787e-05,-1.44584e-08,8.8014e-12,17585.8,22.8736], Tmin=(100,'K'), Tmax=(989.787,'K')), NASAPolynomial(coeffs=[12.3041,0.016223,-5.97831e-06,1.09937e-09,-7.85614e-14,14570.2,-32.3406], Tmin=(989.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(145.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring) + radical(Csj(Cs-CsCsH)(Cs-CsF1sH)(H)_ring)"""),
)

species(
    label = 'FOCC1[CH][CH]1(10048)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03855,0.0380553,-2.25648e-05,6.29959e-09,-6.95523e-13,52484.5,23.5151], Tmin=(100,'K'), Tmax=(2077.65,'K')), NASAPolynomial(coeffs=[13.6616,0.0156775,-6.4083e-06,1.11525e-09,-7.16853e-14,47654.9,-41.0581], Tmin=(2077.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(cyclopropane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C1[CH]C1F(8659)'],
    products = ['[O]CC1[CH]C1F(10014)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]CC1=CC1F(10038)'],
    products = ['[O]CC1[CH]C1F(10014)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]CC1C=C1(10039)'],
    products = ['[O]CC1[CH]C1F(10014)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]CC1C=C1F(10040)'],
    products = ['[O]CC1[CH]C1F(10014)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=CC1[CH]C1F(10041)'],
    products = ['[O]CC1[CH]C1F(10014)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C[C]1C=C1(10042)'],
    products = ['[O]CC1[CH]C1F(10014)'],
