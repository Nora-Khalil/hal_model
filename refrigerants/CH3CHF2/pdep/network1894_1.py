...
"""),
    E0 = (-699.71,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([251,367,519,700,855,1175,1303,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,2782.5,750,1395,475,1775,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.657728,0.110597,-0.000151728,1.08548e-07,-3.12005e-11,-83995.2,38.3712], Tmin=(100,'K'), Tmax=(847.189,'K')), NASAPolynomial(coeffs=[15.2769,0.0353614,-1.85186e-05,3.72337e-09,-2.67337e-13,-86695.1,-35.8616], Tmin=(847.189,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-699.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-248.129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,326,540,652,719,1357,334,575,1197,1424,3202,3010,987.5,1337.5,450,1655,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (173.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.952212,0.119276,-0.000192161,1.6657e-07,-5.77056e-11,-29674.6,41.4853], Tmin=(100,'K'), Tmax=(771.494,'K')), NASAPolynomial(coeffs=[12.5561,0.0403892,-2.15774e-05,4.29716e-09,-3.03636e-13,-31495.6,-18.4735], Tmin=(771.494,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)

species(
    label = 'F[CH]COOOOC=C(F)F(5193)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
"""),
    E0 = (-360.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (173.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.347652,0.0986662,-0.000115319,6.80049e-08,-1.5984e-11,-43161.9,41.6408], Tmin=(100,'K'), Tmax=(1031.69,'K')), NASAPolynomial(coeffs=[17.5232,0.0293779,-1.45787e-05,2.90696e-09,-2.09259e-13,-46849.3,-45.1333], Tmin=(1031.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-256.56,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([251,367,519,700,855,1175,1303,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0654299,0.0938631,-0.000112311,6.85127e-08,-1.67554e-11,-30714.2,35.3345], Tmin=(100,'K'), Tmax=(990.079,'K')), NASAPolynomial(coeffs=[15.8284,0.0296533,-1.50349e-05,3.01434e-09,-2.17316e-13,-33861.6,-41.186], Tmin=(990.079,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (173.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.329873,0.0440051,0.000125841,-2.43077e-07,1.10016e-10,-86555.4,32.6348], Tmin=(100,'K'), Tmax=(912.505,'K')), NASAPolynomial(coeffs=[46.1228,-0.0253035,1.89756e-05,-3.69048e-09,2.36323e-13,-100625,-217.861], Tmin=(912.505,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-721.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(CsCFFO) + group(Cs-CsOsHH) + ring(Cycloheptane) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'O=CC(F)(F)OOO[CH][CH]F(5200)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {11,S}
...
species(
    label = 'O=[C]C(F)(F)OOOC[CH]F(5201)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-528.808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,254,363,525,544,658,1137,1402,334,575,1197,1424,3202,1855,455,950,180,180,180,188.042,1591.91,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.150639,'amu*angstrom^2'), symmetry=1, barrier=(3.46348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150639,'amu*angstrom^2'), symmetry=1, barrier=(3.46348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150639,'amu*angstrom^2'), symmetry=1, barrier=(3.46348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150639,'amu*angstrom^2'), symmetry=1, barrier=(3.46348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150639,'amu*angstrom^2'), symmetry=1, barrier=(3.46348,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (172.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.55495,0.142748,-0.000279476,2.60635e-07,-9.01552e-11,-63420.4,40.8764], Tmin=(100,'K'), Tmax=(883.305,'K')), NASAPolynomial(coeffs=[11.3336,0.0370098,-1.94689e-05,3.68012e-09,-2.45395e-13,-63849.2,-9.24314], Tmin=(883.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-528.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(COj(Cs-F1sF1sO2s)(O2d))"""),
)
...
"""),
    E0 = (-254.254,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,197,221,431,657,2120,512.5,787.5,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.233442,0.0936824,-0.000129186,8.10649e-08,-1.19399e-11,-30454.4,35.8654], Tmin=(100,'K'), Tmax=(580.864,'K')), NASAPolynomial(coeffs=[11.4355,0.0335361,-1.7752e-05,3.53793e-09,-2.50832e-13,-32042.5,-14.5604], Tmin=(580.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-254.254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
7  O u0 p2 c0 {11,D}
8  C u0 p0 c0 {4,S} {9,S} {12,S} {13,S}
9  C u0 p0 c0 {1,S} {8,S} {14,S} {15,S}
...
"""),
    ...
    molecularWeight = (173.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.41203,0.136251,-0.000252023,2.30707e-07,-7.95104e-11,-86743.2,39.3946], Tmin=(100,'K'), Tmax=(872.02,'K')), NASAPolynomial(coeffs=[11.5698,0.0390358,-2.00073e-05,3.79477e-09,-2.55705e-13,-87575.2,-13.2458], Tmin=(872.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-722.708,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsH) + radical(COj(Cs-F1sF1sO2s)(O2d))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'F[CH]COOOC(F)F(4193)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C[C]F-2(1532)', 'F[CH]COOOF(4192)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]COOOC(F)=COF(5192)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]COOOOC=C(F)F(5193)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]COOOC(F)(F)C=O(5194)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]F(230)', '[CH2]OOOC(F)(F)C=O(5099)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=CC(F)(F)OOOC[C]F(5195)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['O=CC(F)(F)OOOC[CH]F(5118)'],
    products = ['FC1COOOC(F)(F)[CH]O1(5196)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=CC(F)(F)OOOC[CH]F(5118)'],
    products = ['[O]C1C(F)COOOC1(F)F(5197)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=CC(F)(F)OOOC=CF(5198)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=C[C](F)OOOC[CH]F(5199)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)(F)C=O(4407)', '[O]OC[CH]F(221)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C[C](F)F(3117)', '[O]OOC[CH]F(475)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]OC(F)(F)C=O(4341)', '[O]C[CH]F(140)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HCO(15)', 'F[CH]COOO[C](F)F(4198)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=CC(F)(F)OOO[CH][CH]F(5200)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=[C]C(F)(F)OOOC[CH]F(5201)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=C=C(F)OOOC[CH]F(5202)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', '[CH2]OOOC(F)(F)C=O(5099)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', 'O=CC(F)(F)OOOC[C]F-2(5203)'],
    products = ['O=CC(F)(F)OOOC[CH]F(5118)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O=CC(F)(F)OOOC[CH]F(5118)'],
    products = ['O=CC(F)(F)OOO[CH]CF(5159)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=CC(F)(F)OOOC[CH]F(5118)'],
    products = ['O=[C]C(F)(F)OOOCCF(5204)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(171.839,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)
...
network(
    ...
    isomers = [
        'O=CC(F)(F)OOOC[CH]F(5118)',
    ],
    reactants = [
        ('[O]OC(F)(F)C=O(4341)', 'FC1CO1(285)'),
        ('[O]OC(F)(F)C=O(4341)', '[O]C[CH]F(140)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
