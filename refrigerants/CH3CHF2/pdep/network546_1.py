...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(395)', '[CH2]C[O](339)'],
    products = ['[CH2]CO[C]=C(1679)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=C(396)'],
    products = ['[CH2]CO[C]=C(1679)'],
    transitionState = 'TS3',
