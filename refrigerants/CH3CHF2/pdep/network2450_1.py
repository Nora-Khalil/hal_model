...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', 'F[CH]O[CH]F(639)'],
    products = ['F[CH]OC(F)[CH]F(6140)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]OC(F)=CF(6199)'],
    products = ['F[CH]OC(F)[CH]F(6140)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', 'F[CH]O[CH]F(639)'],
    products = ['F[CH]OC(F)[CH]F(6140)'],
