...
"""),
    E0 = (-233.757,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,3025,407.5,1350,352.5,366.544,366.544,366.544,366.545],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.849519,0.0750351,-0.000120705,1.01055e-07,-3.28884e-11,-28006.5,24.0714], Tmin=(100,'K'), Tmax=(855.351,'K')), NASAPolynomial(coeffs=[10.3141,0.0213367,-9.98498e-06,1.85933e-09,-1.25452e-13,-29280.4,-18.0929], Tmin=(855.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cs-OsOsHH) + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(OCJO)"""),
)
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07761,0.041021,2.81849e-05,-9.03151e-08,4.45623e-11,-60600.1,20.7154], Tmin=(100,'K'), Tmax=(913.054,'K')), NASAPolynomial(coeffs=[26.1447,-0.00749132,7.16996e-06,-1.43546e-09,9.19829e-14,-67732.9,-111.932], Tmin=(913.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-504.913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97145,0.0395183,-2.20288e-05,4.7318e-09,-1.9504e-13,-71659.5,19.7719], Tmin=(100,'K'), Tmax=(1556.36,'K')), NASAPolynomial(coeffs=[12.1748,0.0195316,-8.77676e-06,1.63009e-09,-1.10396e-13,-75590.9,-36.3935], Tmin=(1556.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (-402.553,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,2782.5,750,1395,475,1775,1000,393.09,402.949,1770.8],'cm^-1')),
        HinderedRotor(inertia=(0.324575,'amu*angstrom^2'), symmetry=1, barrier=(35.7174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.330824,'amu*angstrom^2'), symmetry=1, barrier=(35.6967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0514633,'amu*angstrom^2'), symmetry=1, barrier=(5.5791,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37783,0.0399409,-3.00227e-05,1.17884e-08,-2.02533e-12,-48361.4,19.2548], Tmin=(100,'K'), Tmax=(1264.51,'K')), NASAPolynomial(coeffs=[7.11752,0.0249479,-1.22376e-05,2.41182e-09,-1.71523e-13,-49560.1,-4.72375], Tmin=(1264.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-402.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdOsH) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-315.953,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,194,682,905,1196,1383,3221,273.532,273.541,273.562],'cm^-1')),
        HinderedRotor(inertia=(0.373359,'amu*angstrom^2'), symmetry=1, barrier=(19.7753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.367471,'amu*angstrom^2'), symmetry=1, barrier=(19.749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.370889,'amu*angstrom^2'), symmetry=1, barrier=(19.7497,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583119,0.062594,-7.04975e-05,3.68784e-08,-7.18055e-12,-37866.6,22.2816], Tmin=(100,'K'), Tmax=(1415.78,'K')), NASAPolynomial(coeffs=[18.9855,0.00318556,3.02625e-07,-1.60167e-10,1.31175e-14,-42334,-70.2722], Tmin=(1415.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-315.953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(OCJO)"""),
)
...
"""),
    E0 = (-195.319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,334,575,1197,1424,3202,406.063,406.068,406.068,406.069,1892.91],'cm^-1')),
        HinderedRotor(inertia=(0.0443317,'amu*angstrom^2'), symmetry=1, barrier=(5.1873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196345,'amu*angstrom^2'), symmetry=1, barrier=(22.9746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196343,'amu*angstrom^2'), symmetry=1, barrier=(22.9745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78113,0.0518183,-4.97019e-05,2.57134e-08,-5.58309e-12,-23414.1,21.4207], Tmin=(100,'K'), Tmax=(1078.93,'K')), NASAPolynomial(coeffs=[9.11992,0.0246104,-1.18751e-05,2.34015e-09,-1.67176e-13,-24997.7,-14.5422], Tmin=(1078.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-195.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.127901,0.0742793,-9.09027e-05,5.13962e-08,-1.0811e-11,-28953.6,26.3683], Tmin=(100,'K'), Tmax=(1296.24,'K')), NASAPolynomial(coeffs=[20.957,0.00247376,9.03793e-07,-3.02068e-10,2.41289e-14,-33720.9,-77.0844], Tmin=(1296.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-241.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)

species(
    label = '[O][CH]OCCF(7018)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u1 p2 c0 {6,S}
...
"""),
    E0 = (-200.259,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,180,180,180,1485.58,1488.8],'cm^-1')),
        HinderedRotor(inertia=(0.229401,'amu*angstrom^2'), symmetry=1, barrier=(5.27439,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229552,'amu*angstrom^2'), symmetry=1, barrier=(5.27786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.11822,'amu*angstrom^2'), symmetry=1, barrier=(48.702,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54712,0.0657328,-0.000118076,1.21383e-07,-4.71271e-11,-24008.7,21.0697], Tmin=(100,'K'), Tmax=(836.874,'K')), NASAPolynomial(coeffs=[1.45006,0.0386182,-2.00451e-05,3.91234e-09,-2.7156e-13,-23026.7,27.2906], Tmin=(836.874,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)
