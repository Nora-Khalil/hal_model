...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.000258436,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09477,0.0467369,-6.97243e-05,6.41575e-08,-2.49709e-11,51763.4,6.17186], Tmin=(100,'K'), Tmax=(689.344,'K')), NASAPolynomial(coeffs=[5.42908,0.0241117,-1.33606e-05,2.75083e-09,-1.99629e-13,51381.6,-8.10901], Tmin=(689.344,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(CdCsCdF) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + ring(Cs-Cd(F)-Cd)"""),
)
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18794,0.0443486,-4.65846e-05,2.71946e-08,-6.80288e-12,38749.9,15.8964], Tmin=(100,'K'), Tmax=(935.235,'K')), NASAPolynomial(coeffs=[7.25951,0.0226577,-1.17952e-05,2.39563e-09,-1.73854e-13,37801.3,-8.23149], Tmin=(935.235,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + ring(Cd-Cs(F)-Cd)"""),
)
...
"""),
    ...
    molecularWeight = (66.0579,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93935,0.0547666,-0.000111505,1.07391e-07,-3.78457e-11,119229,3.81111], Tmin=(100,'K'), Tmax=(890.286,'K')), NASAPolynomial(coeffs=[5.48434,0.0161882,-8.34271e-06,1.56264e-09,-1.03382e-13,119495,-7.83796], Tmin=(890.286,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(990.783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(Ct-CtCs) + group(Ct-CtCs) + group(CsJ2_singlet-CsH) + ring(Cyclopropyne)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C-]=[O+]C1C=C1F(8596)'],
    products = ['CO(13)', 'FC1=CC1(5834)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.66316e+09,'s^-1'), n=1.02661, Ea=(61.3914,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=3.6261064499336317, var=38.37240951049941, Tref=1000.0, N=4, data_mean=0.0, correlation='Root_1R!H->C_N-2R!H->C',), comment="""Estimated from node Root_1R!H->C_N-2R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[C-]=[O+]C1C=C1F(8596)'],
    products = ['FC1=CC=[O+][C-]1(8871)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(9.25418e+20,'s^-1'), n=-1.9758, Ea=(141.009,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction1',
    reactants = ['[C-]=[O+]C1C=C1F(8596)'],
    products = ['CO(13)', 'FC1C=C1(6880)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.66316e+09,'s^-1'), n=1.02661, Ea=(51.0565,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=3.6261064499336317, var=38.37240951049941, Tref=1000.0, N=4, data_mean=0.0, correlation='Root_1R!H->C_N-2R!H->C',), comment="""Estimated from node Root_1R!H->C_N-2R!H->C"""),
)

reaction(
    label = 'reaction5',
    reactants = ['HF(38)', '[C-]=[O+]C1=C=C1(8873)'],
    products = ['[C-]=[O+]C1C=C1F(8596)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(215.727,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction6',
    reactants = ['HF(38)', '[C-]=[O+]C1C#C1(8874)'],
    products = ['[C-]=[O+]C1C=C1F(8596)'],
    transitionState = 'TS6',
