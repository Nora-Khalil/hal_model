...
"""),
    ...
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29511,0.0384742,3.89322e-05,-8.55104e-08,3.70612e-11,-30527.6,21.1386], Tmin=(100,'K'), Tmax=(961.271,'K')), NASAPolynomial(coeffs=[19.6888,0.0140532,-4.28776e-06,8.66378e-10,-7.17593e-14,-36471.8,-79.3989], Tmin=(961.271,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-254.789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
"""),
    E0 = (19.3593,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.847487,'amu*angstrom^2'), symmetry=1, barrier=(19.4854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217695,'amu*angstrom^2'), symmetry=1, barrier=(19.5029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0487793,'amu*angstrom^2'), symmetry=1, barrier=(19.4736,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08182,0.0617655,-5.54329e-05,2.56391e-08,-4.79809e-12,2435.37,25.06], Tmin=(100,'K'), Tmax=(1270.87,'K')), NASAPolynomial(coeffs=[13.2455,0.0234809,-1.02458e-05,1.93498e-09,-1.35107e-13,-656.298,-36.5381], Tmin=(1270.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.3593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (75.6276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,251.161,251.18,251.417],'cm^-1')),
        HinderedRotor(inertia=(0.454549,'amu*angstrom^2'), symmetry=1, barrier=(20.3885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.454825,'amu*angstrom^2'), symmetry=1, barrier=(20.3887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00266562,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.455517,'amu*angstrom^2'), symmetry=1, barrier=(20.3889,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.444236,0.0751696,-7.67924e-05,3.98876e-08,-8.22043e-12,9226.51,25.6274], Tmin=(100,'K'), Tmax=(1176.24,'K')), NASAPolynomial(coeffs=[15.9385,0.0224792,-9.59931e-06,1.80422e-09,-1.26172e-13,5581.51,-51.6385], Tmin=(1176.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.6276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CO[CH]C(2836)'],
    products = ['[CH]=C(CF)O[CH]C(8950)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)O[CH]C(4209)'],
    products = ['[CH]=C(CF)O[CH]C(8950)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C-2(610)', '[CH]=C([O])CF(2587)'],
    products = ['[CH]=C(CF)O[CH]C(8950)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(CF)OC=C(12046)'],
    products = ['[CH]=C(CF)O[CH]C(8950)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2F(46)', 'C#CO[CH]C(533)'],
    products = ['[CH]=C(CF)O[CH]C(8950)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(CF)OC[CH2](12047)'],
    products = ['[CH]=C(CF)O[CH]C(8950)'],
