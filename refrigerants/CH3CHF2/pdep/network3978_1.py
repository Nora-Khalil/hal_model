...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)C([CH2])=CF(10998)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC([CH2])=CF(10774)'],
    products = ['[CH]=C(C)C([CH2])=CF(10998)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(C)C([CH2])=CF(10998)'],
    products = ['[CH]=C=C([CH2])C(C)F(11058)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', '[CH]C(C)=C=CF(6664)'],
    products = ['[CH]=C(C)C([CH2])=CF(10998)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(C)C([CH2])=CF(10998)'],
    products = ['[CH2]C1=C(C)[CH]C1F(11061)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(C)C([CH2])=CF(10998)'],
    products = ['[CH2]C1([CH]F)C=C1C(11062)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'C#CC([CH2])=CF(10811)'],
    products = ['[CH]=C(C)C([CH2])=CF(10998)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(C)C([CH2])=CF(10998)'],
    products = ['[CH2]C(=C)C([CH2])=CF(11063)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(C)C(C)=[C]F(11064)'],
    products = ['[CH]=C(C)C([CH2])=CF(10998)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(C)C(=[CH])CF(11067)'],
    products = ['[CH]=C(C)C([CH2])=CF(10998)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=C(C)C(F)[C]=C(10999)'],
    products = ['[CH]=C(C)C([CH2])=CF(10998)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]F(230)', '[CH]C(C)=C=C(6454)'],
    products = ['[CH]=C(C)C([CH2])=CF(10998)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C(C)C([CH2])=CF(10998)'],
    products = ['CC1=C([CH]F)C[CH]1(11070)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CHF(40)', '[CH]C(C)=C=C(6454)'],
    products = ['[CH]=C(C)C([CH2])=CF(10998)'],
