...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[CH]C(=O)F(1066)'],
    products = ['[CH]=C(F)O[C]=O(4093)'],
    transitionState = 'TS2',
