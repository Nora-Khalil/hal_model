...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2927)', '[CH]=C[O](133)'],
    products = ['[CH]=CO[C](F)F(4668)'],
    transitionState = 'TS2',
