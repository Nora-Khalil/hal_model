...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(395)', 'C[C]=C[O](6466)'],
    products = ['C=[C]OC=[C]C(6339)'],
    transitionState = 'TS2',
