...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.143735,'amu*angstrom^2'), symmetry=1, barrier=(3.30474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.884059,'amu*angstrom^2'), symmetry=1, barrier=(20.3263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.90268,'amu*angstrom^2'), symmetry=1, barrier=(43.7463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89716,'amu*angstrom^2'), symmetry=1, barrier=(43.6194,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.627944,0.0812749,-9.76685e-05,6.34741e-08,-1.70947e-11,-53876.7,30.1803], Tmin=(100,'K'), Tmax=(888.884,'K')), NASAPolynomial(coeffs=[11.1355,0.0339902,-1.78747e-05,3.62817e-09,-2.62813e-13,-55744.7,-19.2751], Tmin=(888.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-448.915,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CJCOOH)"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.385863,0.086664,-0.000118231,8.7878e-08,-2.66853e-11,-96628.6,28.786], Tmin=(100,'K'), Tmax=(798.572,'K')), NASAPolynomial(coeffs=[11.1371,0.03281,-1.7071e-05,3.42406e-09,-2.45396e-13,-98345.7,-20.6638], Tmin=(798.572,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-804.444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.638528,0.0622505,-2.84196e-05,-1.7748e-08,1.46317e-11,-76838.6,20.7944], Tmin=(100,'K'), Tmax=(922.229,'K')), NASAPolynomial(coeffs=[18.0343,0.0171748,-4.50961e-06,6.82309e-10,-4.59507e-14,-81338.9,-68.7252], Tmin=(922.229,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-639.969,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(CsCsCsFF) + group(CsCFHO) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCsJOOC)"""),
)

species(
    label = 'F[C](F)C1CC(F)OO1(4567)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.640969,0.0625922,-3.12981e-05,-1.51586e-08,1.39871e-11,-71433.5,24.4652], Tmin=(100,'K'), Tmax=(915.991,'K')), NASAPolynomial(coeffs=[18.183,0.0159173,-3.87525e-06,5.53194e-10,-3.64975e-14,-75902.8,-65.4796], Tmin=(915.991,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-595.025,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + ring(12dioxolane) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.111363,'amu*angstrom^2'), symmetry=1, barrier=(2.56044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110639,'amu*angstrom^2'), symmetry=1, barrier=(2.5438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.48727,'amu*angstrom^2'), symmetry=1, barrier=(57.1872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.40434,0.0886158,-0.00014654,1.34923e-07,-4.94358e-11,-25037.2,34.0814], Tmin=(100,'K'), Tmax=(784.96,'K')), NASAPolynomial(coeffs=[7.74916,0.0367712,-1.99196e-05,3.98584e-09,-2.82153e-13,-25746.2,3.25434], Tmin=(784.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.171,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CJCOOH) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.321107,'amu*angstrom^2'), symmetry=1, barrier=(7.38287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321002,'amu*angstrom^2'), symmetry=1, barrier=(7.38047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68585,'amu*angstrom^2'), symmetry=1, barrier=(38.7611,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.968204,0.0795188,-7.91349e-05,-8.38135e-09,5.29382e-11,-56230.2,27.9072], Tmin=(100,'K'), Tmax=(492.769,'K')), NASAPolynomial(coeffs=[8.90608,0.0375605,-1.98317e-05,3.9515e-09,-2.80029e-13,-57285.4,-7.53966], Tmin=(492.769,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-468.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'CC(F)OO[C]=C(F)F(4575)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.141396,'amu*angstrom^2'), symmetry=1, barrier=(3.25096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140786,'amu*angstrom^2'), symmetry=1, barrier=(3.23694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12468,'amu*angstrom^2'), symmetry=1, barrier=(48.8506,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.515877,0.0853534,-0.000131555,1.20255e-07,-4.48935e-11,-50774.2,31.6863], Tmin=(100,'K'), Tmax=(759.677,'K')), NASAPolynomial(coeffs=[6.77852,0.0410759,-2.18114e-05,4.36406e-09,-3.10224e-13,-51399.6,5.34056], Tmin=(759.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-423.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.72138,'amu*angstrom^2'), symmetry=1, barrier=(39.578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.883105,'amu*angstrom^2'), symmetry=1, barrier=(20.3043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.883378,'amu*angstrom^2'), symmetry=1, barrier=(20.3106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72091,'amu*angstrom^2'), symmetry=1, barrier=(39.5672,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.378963,0.0873626,-0.000116929,8.58001e-08,-2.59139e-11,-46263,29.6701], Tmin=(100,'K'), Tmax=(800.095,'K')), NASAPolynomial(coeffs=[10.8872,0.0348263,-1.8433e-05,3.72738e-09,-2.68549e-13,-47944.4,-18.6821], Tmin=(800.095,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-385.679,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)OOC=C(F)F(4563)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)OOC=C(F)F(4563)'],
    products = ['[CH2]C(F)OC(F)(F)C=O(4564)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]OOC=C(F)F(4388)'],
    products = ['[CH2]C(F)OOC=C(F)F(4563)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]C(F)OOC=C(F)F(4565)'],
    products = ['[CH2]C(F)OOC=C(F)F(4563)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)OOC=C(F)F(4563)'],
    products = ['FC1CC(F)(F)[CH]OO1(4566)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)OOC=C(F)F(4563)'],
    products = ['F[C](F)C1CC(F)OO1(4567)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=COOC=C(F)F(4568)'],
    products = ['[CH2]C(F)OOC=C(F)F(4563)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2][CH]OOC=C(F)F(4570)'],
    products = ['[CH2]C(F)OOC=C(F)F(4563)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(F)OOC=[C]F(3674)'],
    products = ['[CH2]C(F)OOC=C(F)F(4563)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C[C](F)F(3117)', '[CH2]C([O])F(141)'],
    products = ['[CH2]C(F)OOC=C(F)F(4563)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]C(F)OO[C]=C(F)F(4572)'],
    products = ['[CH2]C(F)OOC=C(F)F(4563)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', '[CH2]C(F)OOC#CF(4573)'],
    products = ['[CH2]C(F)OOC=C(F)F(4563)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[C](F)OOC=C(F)F(4574)'],
    products = ['[CH2]C(F)OOC=C(F)F(4563)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC(F)OO[C]=C(F)F(4575)'],
    products = ['[CH2]C(F)OOC=C(F)F(4563)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FC[CH]OOC=C(F)F(4576)'],
    products = ['[CH2]C(F)OOC=C(F)F(4563)'],
...
network(
    ...
    isomers = [
        '[CH2]C(F)OOC=C(F)F(4563)',
    ],
    reactants = [
        ('O=C[C](F)F(3117)', 'FC1CO1(285)'),
        ('O=C[C](F)F(3117)', '[CH2]C([O])F(141)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
