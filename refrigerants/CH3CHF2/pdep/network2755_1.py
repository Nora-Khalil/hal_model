...
"""),
    E0 = (-42.7994,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,1685,370,3120,650,792.5,1650,340.665,340.668],'cm^-1')),
        HinderedRotor(inertia=(0.00145265,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117068,'amu*angstrom^2'), symmetry=1, barrier=(9.6408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117069,'amu*angstrom^2'), symmetry=1, barrier=(9.64081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117074,'amu*angstrom^2'), symmetry=1, barrier=(9.64086,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47718,0.058846,-8.17929e-05,5.92887e-08,-1.70778e-11,-5059.73,24.4608], Tmin=(100,'K'), Tmax=(850.136,'K')), NASAPolynomial(coeffs=[10.3412,0.0171421,-8.21368e-06,1.59194e-09,-1.11876e-13,-6566.93,-16.8642], Tmin=(850.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.7994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])O(6999)', '[C]=C(395)'],
    products = ['C=[C]OC([O])O(3643)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['C=[C]OC([O])O(3643)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(15.9,'m^3/(mol*s)'), n=1.84, Ea=(60.5868,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H"""),
)
