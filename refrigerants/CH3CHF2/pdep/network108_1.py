...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CO[O](199)'],
    products = ['O=O(143)', 'C2H2(23)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]=C[O](133)'],
    products = ['[CH]=CO[O](199)'],
    transitionState = 'TS2',
