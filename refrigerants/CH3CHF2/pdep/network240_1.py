...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)[CH]F(647)'],
    products = ['[O]C(F)C([O])F(867)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[O][CH]C(=O)F(880)'],
    products = ['[O]C(F)C([O])F(867)'],
