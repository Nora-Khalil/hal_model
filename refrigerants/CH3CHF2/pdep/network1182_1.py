...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)F(3028)', 'CH2(S)(25)'],
    products = ['CC(F)(F)O[O](3087)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[C](F)F(3031)', 'CH3(19)'],
    products = ['CC(F)(F)O[O](3087)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)O[O](3123)'],
    products = ['CC(F)(F)O[O](3087)'],
    transitionState = 'TS9',
