...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'FOCC(F)F(3376)'],
    products = ['FOC(F)CC(F)F(3359)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]CC(F)OF(767)'],
    products = ['FOC(F)CC(F)F(3359)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(142)', 'FC=CC(F)F(888)'],
    products = ['FOC(F)CC(F)F(3359)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FO[CH]CC(F)F(3377)'],
    products = ['FOC(F)CC(F)F(3359)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]CC(F)OF(775)'],
    products = ['FOC(F)CC(F)F(3359)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)CC(F)F(892)'],
    products = ['FOC(F)CC(F)F(3359)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(126)', 'F[CH]CC(F)F(891)'],
    products = ['FOC(F)CC(F)F(3359)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH]OF(614)', 'CHF2-CH2(64)'],
    products = ['FOC(F)CC(F)F(3359)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF2(81)', '[CH2]C(F)OF(772)'],
    products = ['FOC(F)CC(F)F(3359)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'FOC(F)[CH]C(F)F(3378)'],
    products = ['FOC(F)CC(F)F(3359)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FO[C](F)CC(F)F(3379)'],
    products = ['FOC(F)CC(F)F(3359)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC(F)C[C](F)F(3380)'],
    products = ['FOC(F)CC(F)F(3359)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'FOC=CC(F)F(3381)'],
    products = ['FOC(F)CC(F)F(3359)'],
