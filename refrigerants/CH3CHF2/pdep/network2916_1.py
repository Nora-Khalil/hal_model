...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89144,0.03532,4.72642e-06,-3.28719e-08,1.5275e-11,26116.8,18.209], Tmin=(100,'K'), Tmax=(988.117,'K')), NASAPolynomial(coeffs=[12.9635,0.016526,-6.25322e-06,1.1924e-09,-8.77714e-14,22658.1,-41.5043], Tmin=(988.117,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cs(F)-Cs-Cd-Cd) + radical(Csj(Cs-F1sCdH)(Cd-CdH)(H)_ring) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1([CH]F)C=C1(7767)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.799001,'amu*angstrom^2'), symmetry=1, barrier=(18.3706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.796885,'amu*angstrom^2'), symmetry=1, barrier=(18.322,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33275,0.0550416,-5.58172e-05,2.92949e-08,-6.0807e-12,44384.8,20.0807], Tmin=(100,'K'), Tmax=(1173.95,'K')), NASAPolynomial(coeffs=[12.7433,0.0161629,-6.14103e-06,1.08499e-09,-7.32978e-14,41705.7,-36.7988], Tmin=(1173.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(Cds-CdsHH) + radical(CdCdF1s) + radical(Cds_P)"""),
)

species(
    label = 'C=CC(=C)[C]F(7771)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {3,S} {4,D} {6,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42555,0.0504166,-4.39646e-05,1.92994e-08,-3.35818e-12,30334.8,19.1073], Tmin=(100,'K'), Tmax=(1384.33,'K')), NASAPolynomial(coeffs=[13.4758,0.0155985,-6.23805e-06,1.13142e-09,-7.72419e-14,26998.4,-42.9472], Tmin=(1384.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.972207,'amu*angstrom^2'), symmetry=1, barrier=(22.353,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.970968,'amu*angstrom^2'), symmetry=1, barrier=(22.3245,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15494,0.0475737,-3.7017e-05,-1.00547e-08,2.7552e-11,44698.8,19.4013], Tmin=(100,'K'), Tmax=(502.947,'K')), NASAPolynomial(coeffs=[5.84489,0.0290944,-1.43147e-05,2.81433e-09,-1.99613e-13,44190.2,2.76898], Tmin=(502.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05913,0.029654,2.06686e-05,-4.99249e-08,2.14389e-11,2148.96,13.082], Tmin=(100,'K'), Tmax=(977.683,'K')), NASAPolynomial(coeffs=[13.3932,0.0149868,-5.46929e-06,1.06558e-09,-8.08957e-14,-1582.48,-49.0914], Tmin=(977.683,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.1894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)

species(
    label = 'F[CH]C1=C[CH]C1(7773)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {5,D} {6,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47198,0.018061,5.21058e-05,-7.9736e-08,3.12202e-11,28961.3,17.236], Tmin=(100,'K'), Tmax=(973.737,'K')), NASAPolynomial(coeffs=[12.171,0.0170909,-6.28098e-06,1.23583e-09,-9.46154e-14,25229.6,-38.7608], Tmin=(973.737,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(Csj(Cd-CsCd)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C=C=CF(4052)'],
    products = ['[CH]=CC([CH2])=CF(7410)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=CC([CH2])=CF(7410)'],
    products = ['[CH2]C1([CH]F)C=C1(7767)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC([CH2])=CF(7768)'],
    products = ['[CH]=CC([CH2])=CF(7410)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]F(230)', '[CH]C=C=C(282)'],
    products = ['[CH]=CC([CH2])=CF(7410)'],
