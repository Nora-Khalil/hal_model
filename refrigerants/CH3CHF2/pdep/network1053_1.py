...
"""),
    E0 = (-428.505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([249,341,381,651,928,1217,1251,3000,3100,440,815,1455,1000,180,679.868,679.876,679.883,679.884,679.896],'cm^-1')),
        HinderedRotor(inertia=(0.00934156,'amu*angstrom^2'), symmetry=1, barrier=(3.06425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133266,'amu*angstrom^2'), symmetry=1, barrier=(3.06405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67958,0.0592263,-0.000100774,9.94408e-08,-3.85005e-11,-51461.7,21.3932], Tmin=(100,'K'), Tmax=(796.954,'K')), NASAPolynomial(coeffs=[3.99537,0.0311423,-1.69329e-05,3.3896e-09,-2.39804e-13,-51308.1,14.026], Tmin=(796.954,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-428.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(Csj(Cs-F1sF1sCO)(H)(H))"""),
)
...
"""),
    E0 = (-154.977,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,234,347,1316,1464,3000,3100,440,815,1455,1000,391.9,391.911,391.913,391.916,391.918,1674.29],'cm^-1')),
        HinderedRotor(inertia=(0.401526,'amu*angstrom^2'), symmetry=1, barrier=(43.7654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401538,'amu*angstrom^2'), symmetry=1, barrier=(43.7653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401521,'amu*angstrom^2'), symmetry=1, barrier=(43.7654,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59493,0.0578276,-7.41679e-05,5.11709e-08,-1.44973e-11,-18557.2,21.6382], Tmin=(100,'K'), Tmax=(850.959,'K')), NASAPolynomial(coeffs=[9.10557,0.0225237,-1.19378e-05,2.41852e-09,-1.74682e-13,-19835.4,-13.3843], Tmin=(850.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CsCOCsF1s) + radical(Csj(Cs-F1sCOH)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45141,0.0235815,2.31391e-05,-5.13388e-08,2.31821e-11,-82981.6,18.5749], Tmin=(100,'K'), Tmax=(911.739,'K')), NASAPolynomial(coeffs=[11.4034,0.0117115,-2.41845e-06,3.16149e-10,-2.13972e-14,-85753,-30.0328], Tmin=(911.739,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-690.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCCFF) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + longDistanceInteraction_cyclic(Cs(F)2-CO) + ring(Beta-Propiolactone)"""),
)

species(
    label = '[CH2]C(F)(F)[C]1OO1(3252)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77855,0.0469602,-4.6292e-05,2.27348e-08,-4.43815e-12,-9925.77,22.9292], Tmin=(100,'K'), Tmax=(1234.11,'K')), NASAPolynomial(coeffs=[11.8642,0.0142707,-6.55966e-06,1.27144e-09,-9.02273e-14,-12415.1,-27.8497], Tmin=(1234.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.2056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(O2s-O2s-Cs(C-FF)) + radical(Cs_P) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = '[O][C]1OCC1(F)F(3253)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.38289,0.0316712,-1.70962e-05,3.63448e-09,-2.83076e-13,-29241.1,15.0543], Tmin=(100,'K'), Tmax=(3111.24,'K')), NASAPolynomial(coeffs=[26.5533,0.00188111,-2.73334e-06,5.56761e-10,-3.57627e-14,-43658.4,-123.028], Tmin=(3111.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(CsCsCsFF) + ring(Cs-Cs(F)(F)-Cs(O2)) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C([O])=O(2995)'],
    products = ['CO2(14)', 'CH2CF2(57)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][C](F)C(=O)OF(3250)'],
    products = ['[CH2]C(F)(F)C([O])=O(2995)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C(=O)[C](F)F(3251)'],
    products = ['[CH2]C(F)(F)C([O])=O(2995)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=O(3236)'],
    products = ['[CH2]C(F)(F)C([O])=O(2995)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C([O])=O(2995)'],
    products = ['[CH2]C(F)(F)[C]1OO1(3252)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C([O])=O(318)'],
    products = ['[CH2]C(F)(F)C([O])=O(2995)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CO2(14)', '[CH2][C](F)F(2970)'],
    products = ['[CH2]C(F)(F)C([O])=O(2995)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(293)', '[CH2][C](F)F(2970)'],
    products = ['[CH2]C(F)(F)C([O])=O(2995)'],
