...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.111229,'amu*angstrom^2'), symmetry=1, barrier=(2.55738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.94204,'amu*angstrom^2'), symmetry=1, barrier=(21.6593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (22.8227,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,197.934,197.94],'cm^-1')),
        HinderedRotor(inertia=(0.00229463,'amu*angstrom^2'), symmetry=1, barrier=(26.0534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.421812,'amu*angstrom^2'), symmetry=1, barrier=(11.7276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.501528,'amu*angstrom^2'), symmetry=1, barrier=(13.9445,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0775,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94723,0.0486682,-5.13881e-05,3.19713e-08,-8.48823e-12,2815.84,17.9073], Tmin=(100,'K'), Tmax=(891.816,'K')), NASAPolynomial(coeffs=[7.21515,0.0250405,-1.16475e-05,2.26385e-09,-1.60486e-13,1876.23,-6.90422], Tmin=(891.816,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.8227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO)"""),
)
...
"""),
    E0 = (-294.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,391,562,707,872,1109,1210,1289,3137,180],'cm^-1')),
        HinderedRotor(inertia=(0.240071,'amu*angstrom^2'), symmetry=1, barrier=(5.5197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239369,'amu*angstrom^2'), symmetry=1, barrier=(5.50356,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0775,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.74039,0.0222968,2.48476e-05,-5.60763e-08,2.87858e-11,-35374.5,11.1429], Tmin=(10,'K'), Tmax=(663.246,'K')), NASAPolynomial(coeffs=[2.74464,0.0353893,-2.07908e-05,5.90843e-09,-6.51204e-13,-35398.3,14.3628], Tmin=(663.246,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-294.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""CCC([O])F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-112.574,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,334,575,1197,1424,3202,2366.93],'cm^-1')),
        HinderedRotor(inertia=(0.561172,'amu*angstrom^2'), symmetry=1, barrier=(12.9024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116156,'amu*angstrom^2'), symmetry=1, barrier=(2.67066,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.22891,'amu*angstrom^2'), symmetry=1, barrier=(5.2631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228904,'amu*angstrom^2'), symmetry=1, barrier=(5.26294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2289,'amu*angstrom^2'), symmetry=1, barrier=(5.26286,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60417,0.0595564,-9.15796e-05,8.55571e-08,-3.19714e-11,-22907.4,20.4977], Tmin=(100,'K'), Tmax=(803.256,'K')), NASAPolynomial(coeffs=[4.69183,0.031566,-1.57538e-05,3.07406e-09,-2.15064e-13,-22996.4,8.81117], Tmin=(803.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.90578,0.0240644,-7.06358e-06,-9.81817e-10,5.5582e-13,-24535.9,13.5806], Tmin=(100,'K'), Tmax=(1712.49,'K')), NASAPolynomial(coeffs=[7.69114,0.0189242,-7.84931e-06,1.38272e-09,-8.99052e-14,-27060.2,-14.665], Tmin=(1712.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""propanal""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-478.949,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,486,617,768,1157,1926,180],'cm^-1')),
        HinderedRotor(inertia=(0.167954,'amu*angstrom^2'), symmetry=1, barrier=(3.86159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168306,'amu*angstrom^2'), symmetry=1, barrier=(3.86968,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.58845,0.0351158,-5.91941e-05,8.84687e-08,-5.23071e-11,-57603.5,9.98106], Tmin=(10,'K'), Tmax=(572.049,'K')), NASAPolynomial(coeffs=[2.63231,0.0304313,-1.70961e-05,4.66174e-09,-4.96502e-13,-57308.1,15.6859], Tmin=(572.049,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-478.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""CCC(DO)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCC(F)OF(2648)'],
    products = ['HF(38)', 'CHFO(47)', 'C2H4(30)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(44.7224,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CC(F)OF(494)'],
    products = ['CCC(F)OF(2648)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000166864,'m^3/(mol*s)'), n=2.82973, Ea=(155.261,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OF(142)', 'CC[C]F-2(1048)'],
    products = ['CCC(F)OF(2648)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(46.6153,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[CH2]C(F)OF(772)'],
    products = ['CCC(F)OF(2648)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', 'CCC=O(986)'],
    products = ['CCC(F)OF(2648)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(71.1694,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'CC=COF(506)'],
    products = ['CCC(F)OF(2648)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(232.243,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CCC(=O)F(1604)'],
    products = ['CCC(F)OF(2648)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(487.624,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)
