...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(1266)', '[CH]C-2(610)'],
    products = ['C[CH]OC([O])=O(2819)'],
    transitionState = 'TS2',
