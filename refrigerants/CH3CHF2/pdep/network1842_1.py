...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.82367,'amu*angstrom^2'), symmetry=1, barrier=(41.9298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81973,'amu*angstrom^2'), symmetry=1, barrier=(41.8392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81545,'amu*angstrom^2'), symmetry=1, barrier=(41.7408,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.459141,0.0873388,-0.000147862,1.34393e-07,-4.77363e-11,-38206.1,34.7958], Tmin=(100,'K'), Tmax=(819.05,'K')), NASAPolynomial(coeffs=[8.32863,0.0324139,-1.70685e-05,3.34851e-09,-2.33387e-13,-38942,1.77797], Tmin=(819.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-318.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsFFOO) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]COC(F)(F)OF(4972)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {5,S}
4  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.412444,0.087075,-0.000146165,1.29198e-07,-4.4997e-11,-37179,25.4295], Tmin=(100,'K'), Tmax=(796.483,'K')), NASAPolynomial(coeffs=[10.1055,0.0279361,-1.50921e-05,3.00092e-09,-2.1111e-13,-38391.3,-17.0457], Tmin=(796.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsFFOO) + group(Cs-CsOsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'C=CO[C](F)OF(2111)'],
    products = ['C=COC(F)(F)OF(4751)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C=COC([O])(F)F(4968)'],
    products = ['C=COC(F)(F)OF(4751)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)OF(4900)', 'C2H3(29)'],
    products = ['C=COC(F)(F)OF(4751)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(126)', 'C=CO[C](F)F(4785)'],
    products = ['C=COC(F)(F)OF(4751)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=[C]OC(F)(F)OF(4969)'],
    products = ['C=COC(F)(F)OF(4751)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]=COC(F)(F)OF(4970)'],
    products = ['C=COC(F)(F)OF(4751)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'C=COC(=O)F(1015)'],
    products = ['C=COC(F)(F)OF(4751)'],
