...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C[C]C=C(F)F(6582)'],
    products = ['C[C]=CC([O])(F)F(6387)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'CC#CC([O])(F)F(6718)'],
    products = ['C[C]=CC([O])(F)F(6387)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'C[C]=[C]C(=O)F(6719)'],
    products = ['C[C]=CC([O])(F)F(6387)'],
