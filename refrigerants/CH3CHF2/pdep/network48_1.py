...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]C([O])=O(303)'],
    products = ['[O]C(=O)C[CH]F(178)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C([O])=O(303)'],
    products = ['[O]C(=O)C[CH]F(178)'],
