...
"""),
    E0 = (-293.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,482,586,761,1411,580,1155,1237,1373,3147,180.778,226.488,231.301,2598.82],'cm^-1')),
        HinderedRotor(inertia=(0.208287,'amu*angstrom^2'), symmetry=1, barrier=(7.09818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0302,'amu*angstrom^2'), symmetry=1, barrier=(40.1604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.954119,'amu*angstrom^2'), symmetry=1, barrier=(40.1764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50247,0.0607091,-0.000102646,9.13781e-08,-3.20816e-11,-35198.8,23.6317], Tmin=(100,'K'), Tmax=(784.096,'K')), NASAPolynomial(coeffs=[8.33129,0.0191879,-1.04264e-05,2.09725e-09,-1.48757e-13,-36064.2,-6.34215], Tmin=(784.096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-293.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sO2sO2s) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(4646)', '[CH]F(230)'],
    products = ['[O]C(F)(F)O[CH]F(4697)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(4646)', 'CHF(40)'],
    products = ['[O]C(F)(F)O[CH]F(4697)'],
    transitionState = 'TS9',
