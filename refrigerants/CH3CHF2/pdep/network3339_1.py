...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)C=C[C]F(9058)'],
    products = ['F[C]=CC1O[C]1F(8901)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]=CC1=C(F)O1(9059)'],
    products = ['F[C]=CC1O[C]1F(8901)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC#CC1O[C]1F(9060)'],
    products = ['F[C]=CC1O[C]1F(8901)'],
    transitionState = 'TS9',
