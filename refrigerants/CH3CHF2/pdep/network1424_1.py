...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=C[C]F(3996)'],
    products = ['[CH2]CC=[C]F(3968)'],
    transitionState = 'TS2',
