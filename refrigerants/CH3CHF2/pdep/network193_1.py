...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OO[O](188)'],
    products = ['O=O(143)', 'CH2O(20)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](127)', 'CH2(T)(18)'],
    products = ['[CH2]OO[O](188)'],
    transitionState = 'TS2',
