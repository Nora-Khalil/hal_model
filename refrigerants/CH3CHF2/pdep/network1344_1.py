...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.69315,'amu*angstrom^2'), symmetry=1, barrier=(38.9288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.559186,'amu*angstrom^2'), symmetry=1, barrier=(12.8568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06851,'amu*angstrom^2'), symmetry=1, barrier=(24.5671,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
