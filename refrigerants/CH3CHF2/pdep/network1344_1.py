...
"""),
    E0 = (-570.944,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,326,540,652,719,1357,2950,3100,1380,975,1025,1650,313.613,313.627,313.637],'cm^-1')),
        HinderedRotor(inertia=(0.00171478,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232259,'amu*angstrom^2'), symmetry=1, barrier=(16.2081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232237,'amu*angstrom^2'), symmetry=1, barrier=(16.2082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232313,'amu*angstrom^2'), symmetry=1, barrier=(16.2081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.522986,0.0679444,-6.06035e-05,2.69563e-08,-4.72998e-12,-68536.4,25.7409], Tmin=(100,'K'), Tmax=(1377.38,'K')), NASAPolynomial(coeffs=[17.1921,0.0195368,-7.88694e-06,1.44119e-09,-9.89253e-14,-73128.4,-60.0151], Tmin=(1377.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-570.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31982,0.0632813,-6.4832e-05,3.98897e-08,-1.05973e-11,-78513.1,24.5545], Tmin=(100,'K'), Tmax=(887.303,'K')), NASAPolynomial(coeffs=[7.75553,0.0342683,-1.57843e-05,3.03765e-09,-2.13929e-13,-79655.2,-5.72444], Tmin=(887.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-653.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(COCsFO)"""),
)

species(
    label = '[CH2]C(F)O[C](C)O(3926)',
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.956314,0.0721165,-8.01256e-05,4.97572e-08,-1.29202e-11,-33735.3,27.6438], Tmin=(100,'K'), Tmax=(917.903,'K')), NASAPolynomial(coeffs=[9.96963,0.0328393,-1.59417e-05,3.14176e-09,-2.24246e-13,-35390,-15.0683], Tmin=(917.903,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'C[C](O)O[C](C)F(3924)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.943431,0.0730594,-8.84869e-05,6.25307e-08,-1.85994e-11,-35921.7,27.1067], Tmin=(100,'K'), Tmax=(806.057,'K')), NASAPolynomial(coeffs=[8.69571,0.0345897,-1.68989e-05,3.32294e-09,-2.36216e-13,-37171.5,-8.6223], Tmin=(806.057,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2]C(F)OC(C)[O](4155)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u1 p2 c0 {4,S}
...
"""),
    E0 = (-260.908,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,487,638,688,1119,1325,1387,3149,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,180,1237.86,1238.05],'cm^-1')),
        HinderedRotor(inertia=(0.261676,'amu*angstrom^2'), symmetry=1, barrier=(6.01644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261663,'amu*angstrom^2'), symmetry=1, barrier=(6.01614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261706,'amu*angstrom^2'), symmetry=1, barrier=(6.01714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55246,'amu*angstrom^2'), symmetry=1, barrier=(35.6941,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93752,0.056596,-8.47689e-06,-1.15469e-07,1.27001e-10,-31317.5,24.5159], Tmin=(100,'K'), Tmax=(432.5,'K')), NASAPolynomial(coeffs=[5.6257,0.0413114,-2.07581e-05,4.10375e-09,-2.91361e-13,-31812.6,7.77837], Tmin=(432.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.908,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH2]C(O)OC([CH2])F(3925)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {4,S} {14,S}
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.722568,0.0771077,-9.13626e-05,5.92776e-08,-1.58011e-11,-32964,28.4276], Tmin=(100,'K'), Tmax=(903.072,'K')), NASAPolynomial(coeffs=[11.0918,0.031179,-1.50753e-05,2.96071e-09,-2.10748e-13,-34836.8,-20.5408], Tmin=(903.072,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-275.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'C[C](F)OC(C)[O](4156)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-279.083,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,395,473,707,1436,234.027,234.153,234.173,1716.12],'cm^-1')),
        HinderedRotor(inertia=(0.00394329,'amu*angstrom^2'), symmetry=1, barrier=(8.24216,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211113,'amu*angstrom^2'), symmetry=1, barrier=(8.24138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212209,'amu*angstrom^2'), symmetry=1, barrier=(8.24243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.657209,'amu*angstrom^2'), symmetry=1, barrier=(25.6176,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04483,0.0725476,-0.000102489,9.42145e-08,-3.5984e-11,-33466.8,26.8948], Tmin=(100,'K'), Tmax=(768.644,'K')), NASAPolynomial(coeffs=[4.54103,0.0426962,-2.1485e-05,4.22695e-09,-2.98292e-13,-33660,13.1876], Tmin=(768.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-279.083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2]C(O)O[C](C)F(3923)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {4,S} {14,S}
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.718512,0.0779614,-9.94802e-05,7.18207e-08,-2.14136e-11,-35150.7,27.8578], Tmin=(100,'K'), Tmax=(810.356,'K')), NASAPolynomial(coeffs=[9.85611,0.0328562,-1.59867e-05,3.13039e-09,-2.21722e-13,-36631.6,-14.3041], Tmin=(810.356,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-293.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(CJCO)"""),
)
...
"""),
    E0 = (-145.994,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,282.721,283.818,284.072],'cm^-1')),
        HinderedRotor(inertia=(0.00209287,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.293344,'amu*angstrom^2'), symmetry=1, barrier=(16.7669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292118,'amu*angstrom^2'), symmetry=1, barrier=(16.7698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295399,'amu*angstrom^2'), symmetry=1, barrier=(16.7758,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09172,0.0542423,-3.0889e-05,-4.67936e-09,7.30023e-12,-17445.6,25.4101], Tmin=(100,'K'), Tmax=(974.846,'K')), NASAPolynomial(coeffs=[15.8257,0.0157271,-5.38698e-06,9.69071e-10,-6.93588e-14,-21360.8,-50.6448], Tmin=(974.846,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0199381,'amu*angstrom^2'), symmetry=1, barrier=(17.8337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18548,'amu*angstrom^2'), symmetry=1, barrier=(4.26456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0199438,'amu*angstrom^2'), symmetry=1, barrier=(17.8332,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4725,0.0583692,-4.94137e-05,2.2011e-08,-4.13073e-12,-41434.1,23.1875], Tmin=(100,'K'), Tmax=(1223.42,'K')), NASAPolynomial(coeffs=[10.2881,0.0295463,-1.40745e-05,2.75387e-09,-1.95594e-13,-43591.1,-21.1202], Tmin=(1223.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-345.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-365.697,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,326,540,652,719,1357,2950,3100,1380,975,1025,1650,251.192,251.413,251.487],'cm^-1')),
        HinderedRotor(inertia=(0.00266617,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00266226,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.41168,'amu*angstrom^2'), symmetry=1, barrier=(18.48,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.412198,'amu*angstrom^2'), symmetry=1, barrier=(18.4793,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.742744,0.0666146,-6.42555e-05,3.09771e-08,-5.90048e-12,-43861.8,25.6345], Tmin=(100,'K'), Tmax=(1270.78,'K')), NASAPolynomial(coeffs=[15.8518,0.0190564,-8.11882e-06,1.52714e-09,-1.068e-13,-47701.8,-50.8784], Tmin=(1270.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-365.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(O)OC(=C)F(4160)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-359.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,326,540,652,719,1357,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,504.463,504.489],'cm^-1')),
        HinderedRotor(inertia=(0.0923701,'amu*angstrom^2'), symmetry=1, barrier=(16.6805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.725492,'amu*angstrom^2'), symmetry=1, barrier=(16.6805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.725492,'amu*angstrom^2'), symmetry=1, barrier=(16.6805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0193297,'amu*angstrom^2'), symmetry=1, barrier=(3.49069,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.567594,0.070918,-7.31237e-05,3.75106e-08,-7.55331e-12,-43092.9,26.2082], Tmin=(100,'K'), Tmax=(1210.12,'K')), NASAPolynomial(coeffs=[16.549,0.018092,-7.64316e-06,1.43655e-09,-1.00695e-13,-46960.8,-53.9405], Tmin=(1210.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-359.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CJCO)"""),
)

species(
    label = '[CH]=C(F)OC(C)O(4161)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-308.493,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,293,496,537,1218,3120,650,792.5,1650,313.086,313.09,313.091],'cm^-1')),
        HinderedRotor(inertia=(0.00171971,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247959,'amu*angstrom^2'), symmetry=1, barrier=(17.2478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247949,'amu*angstrom^2'), symmetry=1, barrier=(17.2478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247949,'amu*angstrom^2'), symmetry=1, barrier=(17.2478,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.54926,0.0710126,-7.26578e-05,3.68935e-08,-7.35122e-12,-36974.7,25.7524], Tmin=(100,'K'), Tmax=(1222.56,'K')), NASAPolynomial(coeffs=[16.7451,0.0180216,-7.64023e-06,1.43851e-09,-1.00917e-13,-40934.7,-55.6373], Tmin=(1222.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-308.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.860028,0.0766021,-0.000111647,1.00551e-07,-3.72903e-11,-16364.2,25.6009], Tmin=(100,'K'), Tmax=(769.377,'K')), NASAPolynomial(coeffs=[5.9398,0.0399394,-2.01793e-05,3.97301e-09,-2.80287e-13,-16842.4,4.39775], Tmin=(769.377,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsCs) + group(Cs-CsHHH) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OC(C)O(4163)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {4,S} {14,S}
4  C u0 p0 c0 {2,S} {3,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.999323,0.0722669,-8.26495e-05,5.4333e-08,-1.51515e-11,-29750.5,25.2496], Tmin=(100,'K'), Tmax=(852.645,'K')), NASAPolynomial(coeffs=[8.87363,0.0353259,-1.7661e-05,3.51913e-09,-2.52465e-13,-31093.3,-11.4841], Tmin=(852.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsCFHO) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (-369.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,333.079,936.085,937.294,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.744513,'amu*angstrom^2'), symmetry=1, barrier=(17.1178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.742913,'amu*angstrom^2'), symmetry=1, barrier=(17.081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0279783,'amu*angstrom^2'), symmetry=1, barrier=(17.0916,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93851,0.0438131,-3.4187e-05,1.30416e-08,-2.01123e-12,-44314.3,8.67315], Tmin=(100,'K'), Tmax=(1502.47,'K')), NASAPolynomial(coeffs=[11.5973,0.0180993,-8.51619e-06,1.65145e-09,-1.16037e-13,-47216.8,-41.8573], Tmin=(1502.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-369.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsCs) + group(Cs-CsHHH) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)O[C](C)O(3926)'],
    products = ['C=C(F)OC(C)O(3768)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(O)OC([CH2])F(3925)'],
    products = ['C=C(F)OC(C)O(3768)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(O)O[C](C)F(3923)'],
    products = ['C=C(F)OC(C)O(3768)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C=[C]OC(C)O(4157)'],
    products = ['C=C(F)OC(C)O(3768)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2CF(70)', 'CC([O])O(2922)'],
    products = ['C=C(F)OC(C)O(3768)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'C=C(F)O[CH]C(1815)'],
    products = ['C=C(F)OC(C)O(3768)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=C(F)OC(C)[O](4158)'],
    products = ['C=C(F)OC(C)O(3768)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(19)', 'C=C(F)O[CH]O(1902)'],
    products = ['C=C(F)OC(C)O(3768)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C=C(F)O[C](C)O(4159)'],
    products = ['C=C(F)OC(C)O(3768)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(O)OC(=C)F(4160)'],
    products = ['C=C(F)OC(C)O(3768)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH]=C(F)OC(C)O(4161)'],
    products = ['C=C(F)OC(C)O(3768)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'C#COC(C)O(2321)'],
    products = ['C=C(F)OC(C)O(3768)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(25)', 'CC(O)[O+]=[C-]F(4164)'],
    products = ['C=C(F)OC(C)O(3768)'],
