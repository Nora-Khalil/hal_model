...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]O[CH2](320)'],
    products = ['[CH2]OC[C](F)F(3006)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]OC=C(F)F(3128)'],
    products = ['[CH2]OC[C](F)F(3006)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH2]O[CH2](320)'],
    products = ['[CH2]OC[C](F)F(3006)'],
