...
"""),
    E0 = (321.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,258.07],'cm^-1')),
        HinderedRotor(inertia=(0.628511,'amu*angstrom^2'), symmetry=1, barrier=(29.6911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.627623,'amu*angstrom^2'), symmetry=1, barrier=(29.6898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.627933,'amu*angstrom^2'), symmetry=1, barrier=(29.6907,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02183,0.0516149,-5.40825e-06,-3.69415e-08,1.99251e-11,38816.1,18.3677], Tmin=(100,'K'), Tmax=(948.573,'K')), NASAPolynomial(coeffs=[17.283,0.0172486,-5.15268e-06,8.9287e-10,-6.50157e-14,34192.2,-67.3359], Tmin=(948.573,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
"""),
    E0 = (439.036,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,457.243,457.994],'cm^-1')),
        HinderedRotor(inertia=(0.0694924,'amu*angstrom^2'), symmetry=1, barrier=(1.59777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144542,'amu*angstrom^2'), symmetry=1, barrier=(21.4083,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05208,0.0265089,4.98997e-05,-8.19333e-08,3.26928e-11,22474.5,15.5747], Tmin=(100,'K'), Tmax=(967.192,'K')), NASAPolynomial(coeffs=[12.6742,0.023242,-8.09684e-06,1.51087e-09,-1.1157e-13,18517.9,-45.1486], Tmin=(967.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(12methylenecyclobutane)"""),
)

species(
    label = '[CH2]C(=C)[C]1CC1(11637)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06418,0.0233281,6.58712e-05,-1.03829e-07,4.20103e-11,43234.6,17.8697], Tmin=(100,'K'), Tmax=(945.851,'K')), NASAPolynomial(coeffs=[14.3989,0.0198199,-5.72624e-06,1.02116e-09,-7.75131e-14,38724.8,-52.4566], Tmin=(945.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Allyl_T) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1=C([CH2])CC1(11638)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {4,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73526,0.0312529,4.81532e-05,-8.75533e-08,3.64216e-11,44521.6,18.8106], Tmin=(100,'K'), Tmax=(955.303,'K')), NASAPolynomial(coeffs=[15.6367,0.019425,-6.09923e-06,1.12823e-09,-8.58368e-14,39749.3,-58.6967], Tmin=(955.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(369.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + ring(Cyclobutene) + radical(Allyl_P) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1([CH2])CC1=C(11618)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.966366,'amu*angstrom^2'), symmetry=1, barrier=(22.2187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.965812,'amu*angstrom^2'), symmetry=1, barrier=(22.2059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.966323,'amu*angstrom^2'), symmetry=1, barrier=(22.2177,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.92987,0.0578588,-3.14735e-05,-4.97076e-09,7.41006e-12,50313,20.2063], Tmin=(100,'K'), Tmax=(973.206,'K')), NASAPolynomial(coeffs=[15.3863,0.0202049,-6.98234e-06,1.23112e-09,-8.59811e-14,46468.5,-54.4404], Tmin=(973.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)C(=C)C(6711)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {7,S} {8,S} {9,S}
2  C u0 p0 c0 {1,S} {3,S} {4,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.14462,'amu*angstrom^2'), symmetry=1, barrier=(49.3091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.14335,'amu*angstrom^2'), symmetry=1, barrier=(49.2799,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.14142,'amu*angstrom^2'), symmetry=1, barrier=(49.2354,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.986302,0.0569523,-2.36188e-05,-8.8449e-09,7.31777e-12,46953.6,21.1224], Tmin=(100,'K'), Tmax=(1006.48,'K')), NASAPolynomial(coeffs=[12.9227,0.0289715,-1.09157e-05,1.94829e-09,-1.34051e-13,43565.3,-41.4368], Tmin=(1006.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(389.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)C([CH2])=C(11529)'],
    products = ['C=C=C(6730)', 'C=C=C(6730)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(30.1291,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(=C)C[C]=C(11530)'],
    products = ['[CH2]C(=C)C([CH2])=C(11529)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C(=C)[C]=C(11090)'],
    products = ['[CH2]C(=C)C([CH2])=C(11529)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(=C)C([CH2])=C(11529)'],
    products = ['[CH2]C(=C)[C]1CC1(11637)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(7.36786e+12,'s^-1'), n=-0.105173, Ea=(93.5715,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [R3_D;doublebond_intra;radadd_intra_cs2H] for rate rule [R3_D;doublebond_intra_secDe_2H;radadd_intra_cs2H]
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=C)C([CH2])=C(11529)'],
    products = ['[CH2]C1=C([CH2])CC1(11638)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)C([CH2])=C(11529)'],
    products = ['[CH2]C1([CH2])CC1=C(11618)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.29624e+10,'s^-1'), n=0.736667, Ea=(210.744,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H] for rate rule [R4_S_(Cd)_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 4.0
...
network(
    ...
    isomers = [
        '[CH2]C(=C)C([CH2])=C(11529)',
    ],
    reactants = [
        ('C=C=C(6730)', 'C=C=C(6730)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
