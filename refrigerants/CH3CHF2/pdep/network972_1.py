...
"""),
    E0 = (118.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,288.627,289.143,289.33],'cm^-1')),
        HinderedRotor(inertia=(0.00201969,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00201796,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21799,'amu*angstrom^2'), symmetry=1, barrier=(12.9294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217982,'amu*angstrom^2'), symmetry=1, barrier=(12.9308,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38343,0.0583693,-5.85383e-05,3.29874e-08,-7.67143e-12,14366.5,20.4617], Tmin=(100,'K'), Tmax=(1029.39,'K')), NASAPolynomial(coeffs=[9.84619,0.0254845,-1.0619e-05,1.95304e-09,-1.34302e-13,12624.2,-20.6113], Tmin=(1029.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54654,0.0376687,2.27284e-05,-6.50994e-08,3.02381e-11,-22208,17.4901], Tmin=(100,'K'), Tmax=(933.675,'K')), NASAPolynomial(coeffs=[17.2763,0.0117625,-2.29583e-06,3.53797e-10,-2.90295e-14,-26953.4,-67.0003], Tmin=(933.675,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-185.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (26.0821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,199.241,199.242,199.242],'cm^-1')),
        HinderedRotor(inertia=(0.755728,'amu*angstrom^2'), symmetry=1, barrier=(21.2897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.755744,'amu*angstrom^2'), symmetry=1, barrier=(21.2897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.75576,'amu*angstrom^2'), symmetry=1, barrier=(21.2897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39676,0.042826,3.10269e-06,-4.61219e-08,2.4171e-11,3244.03,18.6617], Tmin=(100,'K'), Tmax=(926.096,'K')), NASAPolynomial(coeffs=[18.0716,0.00801333,-7.79547e-07,5.8094e-11,-7.24027e-15,-1440.11,-69.1195], Tmin=(926.096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.0821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCO)"""),
)
...
"""),
    E0 = (149.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,411.115,3002.8],'cm^-1')),
        HinderedRotor(inertia=(0.0191462,'amu*angstrom^2'), symmetry=1, barrier=(12.4861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.543064,'amu*angstrom^2'), symmetry=1, barrier=(12.4861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152293,'amu*angstrom^2'), symmetry=1, barrier=(3.50151,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48853,'amu*angstrom^2'), symmetry=1, barrier=(34.2242,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60944,0.0555485,-5.52787e-05,3.29955e-08,-8.45226e-12,18101,20.1514], Tmin=(100,'K'), Tmax=(921.74,'K')), NASAPolynomial(coeffs=[7.58643,0.0296105,-1.30682e-05,2.46583e-09,-1.71773e-13,16999.1,-8.19702], Tmin=(921.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]OCC(2903)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {4,S}
2  C u0 p0 c0 {1,S} {3,S} {6,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C-2(610)', '[CH2]C[O](339)'],
    products = ['[CH2]CO[CH]C(2838)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[CH]C(1805)'],
    products = ['[CH2]CO[CH]C(2838)'],
    transitionState = 'TS3',
