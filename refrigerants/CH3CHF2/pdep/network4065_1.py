...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40196,0.0404047,2.38637e-05,-6.3592e-08,2.80462e-11,906.425,19.3944], Tmin=(100,'K'), Tmax=(966.02,'K')), NASAPolynomial(coeffs=[16.5001,0.0188823,-6.37163e-06,1.20304e-09,-9.09049e-14,-3923.38,-62.8237], Tmin=(966.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.63324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=C=CC=CCF(11842)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.77842,0.061404,-4.82751e-05,1.9148e-08,-3.02856e-12,2886.98,23.8882], Tmin=(100,'K'), Tmax=(1508.14,'K')), NASAPolynomial(coeffs=[15.9358,0.0212032,-8.29197e-06,1.474e-09,-9.88448e-14,-1685,-55.4657], Tmin=(1508.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=CCC=C=CF(11690)',
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19555,0.0536931,-3.31373e-05,7.85404e-09,-3.04216e-14,6791.23,25.2684], Tmin=(100,'K'), Tmax=(1222.39,'K')), NASAPolynomial(coeffs=[12.7145,0.0256086,-1.04655e-05,1.91978e-09,-1.31914e-13,3257.24,-35.5531], Tmin=(1222.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.5713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.980867,'amu*angstrom^2'), symmetry=1, barrier=(22.5521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.981636,'amu*angstrom^2'), symmetry=1, barrier=(22.5697,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (293.413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,113,247,382,1207,3490,1685,370,540,610,2055,360.833,360.879,360.937],'cm^-1')),
        HinderedRotor(inertia=(0.00129423,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00129377,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57684,0.0535816,-4.22191e-05,1.77714e-08,-3.14657e-12,35376.2,24.3621], Tmin=(100,'K'), Tmax=(1296,'K')), NASAPolynomial(coeffs=[10.0056,0.0275666,-1.21089e-05,2.28253e-09,-1.58712e-13,33191.5,-18.4871], Tmin=(1296,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)
...
"""),
    E0 = (278.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,319,1023,1071,1259,1317,1409,3054,3019,2950,3100,1380,975,1025,1650,1685,370,2100,2250,500,550,180,180,2713.74],'cm^-1')),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.848128,'amu*angstrom^2'), symmetry=1, barrier=(19.5001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6639,0.0519016,-4.13981e-05,1.89224e-08,-3.72565e-12,33554.2,23.9195], Tmin=(100,'K'), Tmax=(1167.97,'K')), NASAPolynomial(coeffs=[8.31228,0.0291326,-1.21564e-05,2.23155e-09,-1.53028e-13,32001.2,-9.18733], Tmin=(1167.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Cds_S)"""),
)

species(
    label = 'C#CCC=[C]CF(12071)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (284.747,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,122,584,932,1043,1247,1392,1461,2986,3039,3010,987.5,1337.5,450,1655,1685,370,2175,525,750,770,3400,2100,300.029],'cm^-1')),
        HinderedRotor(inertia=(0.11326,'amu*angstrom^2'), symmetry=1, barrier=(7.46141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.372344,'amu*angstrom^2'), symmetry=1, barrier=(24.5493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.358607,'amu*angstrom^2'), symmetry=1, barrier=(22.7489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59641,0.0525251,-3.94248e-05,1.54499e-08,-2.53292e-12,34333.6,23.993], Tmin=(100,'K'), Tmax=(1389.38,'K')), NASAPolynomial(coeffs=[10.4587,0.0270106,-1.18787e-05,2.23239e-09,-1.54584e-13,31871,-21.6766], Tmin=(1389.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = '[CH2]C=CC=[C]CF(12060)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {7,S} {8,S} {9,S}
...
"""),
    E0 = (202.267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([122,584,932,1043,1247,1392,1461,2986,3039,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,1685,370,247.082],'cm^-1')),
        HinderedRotor(inertia=(0.302032,'amu*angstrom^2'), symmetry=1, barrier=(13.3548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588345,'amu*angstrom^2'), symmetry=1, barrier=(26.8828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89791,'amu*angstrom^2'), symmetry=1, barrier=(82.8595,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06368,0.0566661,-3.85496e-05,1.19237e-08,-1.05694e-12,24439.4,25.8342], Tmin=(100,'K'), Tmax=(1207.75,'K')), NASAPolynomial(coeffs=[12.9159,0.0255807,-1.00872e-05,1.81271e-09,-1.23168e-13,20980.8,-36.0493], Tmin=(1207.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(C=CC=CCJ) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]CC=C[CH]F(11693)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31772,0.0565372,-4.05428e-05,1.46922e-08,-2.1893e-12,29724.2,25.85], Tmin=(100,'K'), Tmax=(1531.51,'K')), NASAPolynomial(coeffs=[12.5282,0.0272573,-1.18651e-05,2.20865e-09,-1.51512e-13,26290.4,-33.0128], Tmin=(1531.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(246.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C[C]=CCF(12072)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (352.907,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,212,931,1104,1251,1325,1474,3102,3155,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1670,1700,300,440,352.517,352.52,352.529],'cm^-1')),
        HinderedRotor(inertia=(0.106881,'amu*angstrom^2'), symmetry=1, barrier=(9.42472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106863,'amu*angstrom^2'), symmetry=1, barrier=(9.42469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106895,'amu*angstrom^2'), symmetry=1, barrier=(9.42492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58211,0.0581622,-5.26104e-05,2.92808e-08,-7.37416e-12,42527.8,25.9227], Tmin=(100,'K'), Tmax=(907.534,'K')), NASAPolynomial(coeffs=[6.42164,0.036832,-1.73557e-05,3.38333e-09,-2.40235e-13,41649.4,3.0442], Tmin=(907.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCC=[C]CF(12073)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0273274,'amu*angstrom^2'), symmetry=1, barrier=(14.4261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.496637,'amu*angstrom^2'), symmetry=1, barrier=(11.4187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.629937,'amu*angstrom^2'), symmetry=1, barrier=(14.4835,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30321,0.0551026,-3.83235e-05,1.326e-08,-1.86633e-12,43694.4,28.2913], Tmin=(100,'K'), Tmax=(1627.95,'K')), NASAPolynomial(coeffs=[13.4647,0.0252207,-1.07899e-05,1.98448e-09,-1.34763e-13,39734.8,-36.307], Tmin=(1627.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(362.463,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sHH)(Cd-CsH)) + radical(Cds_P)"""),
)

species(
    label = 'C=CC[C]=[C]CF(12074)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {4,S} {6,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {7,S} {10,S} {11,S}
...
"""),
    E0 = (353.208,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,122,584,932,1043,1247,1392,1461,2986,3039,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1670,1700,300,440,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.700131,'amu*angstrom^2'), symmetry=1, barrier=(16.0974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.966642,'amu*angstrom^2'), symmetry=1, barrier=(22.225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.700256,'amu*angstrom^2'), symmetry=1, barrier=(22.2917,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64684,0.0528186,-3.55681e-05,1.20725e-08,-1.71545e-12,42564.3,27.1134], Tmin=(100,'K'), Tmax=(1550.76,'K')), NASAPolynomial(coeffs=[10.572,0.0297971,-1.33001e-05,2.49954e-09,-1.7217e-13,39796.1,-19.8613], Tmin=(1550.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = 'C=[C]C=C[CH]CF(12065)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.900293,0.0603202,-4.22612e-05,1.11913e-08,2.85633e-13,22551.8,23.2685], Tmin=(100,'K'), Tmax=(1059.11,'K')), NASAPolynomial(coeffs=[13.7289,0.0244568,-9.29573e-06,1.6625e-09,-1.13959e-13,19128.5,-42.6918], Tmin=(1059.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Allyl_S) + radical(C=CJC=C)"""),
)

species(
    label = '[CH]=[C]CC=CCF(12075)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {4,S} {6,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {5,S} {10,S} {11,S}
...
"""),
    E0 = (362.162,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,212,931,1104,1251,1325,1474,3102,3155,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,3120,650,792.5,1650,316.367,316.442],'cm^-1')),
        HinderedRotor(inertia=(0.158779,'amu*angstrom^2'), symmetry=1, barrier=(11.3002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158996,'amu*angstrom^2'), symmetry=1, barrier=(11.3019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158795,'amu*angstrom^2'), symmetry=1, barrier=(11.2993,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54354,0.0572707,-4.59948e-05,2.03229e-08,-3.88615e-12,43643.6,25.9751], Tmin=(100,'K'), Tmax=(1182.73,'K')), NASAPolynomial(coeffs=[8.74695,0.0329083,-1.50968e-05,2.90644e-09,-2.04692e-13,41939.7,-9.98597], Tmin=(1182.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(362.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=CCC=[C][CH]F(11696)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {5,D} {10,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14353,0.0610679,-4.99535e-05,2.15647e-08,-3.84373e-12,27526.1,26.0234], Tmin=(100,'K'), Tmax=(1310.13,'K')), NASAPolynomial(coeffs=[12.0134,0.0278807,-1.19566e-05,2.22981e-09,-1.54221e-13,24677.9,-29.3537], Tmin=(1310.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cd-F1sCd)(H)(H)) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=CCC(=C)F(11728)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0579,0.0598952,-4.70599e-05,1.91353e-08,-3.16906e-12,28201.3,26.045], Tmin=(100,'K'), Tmax=(1417.55,'K')), NASAPolynomial(coeffs=[13.3309,0.0252638,-1.04145e-05,1.9012e-09,-1.29652e-13,24721.8,-37.4474], Tmin=(1417.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(233.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', '[CH2]C=[C]CF(11864)'],
    products = ['C=[C]CC=[C]CF(11854)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=[C]CC=C=CF(11691)'],
    products = ['C=[C]CC=[C]CF(11854)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#CCC=[C]CF(12071)'],
    products = ['C=[C]CC=[C]CF(11854)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=[C]CC=[C]CF(11854)'],
    products = ['[CH2][C]=CCC(=C)F(11728)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(143.943,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
