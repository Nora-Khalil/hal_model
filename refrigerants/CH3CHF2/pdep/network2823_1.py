...
"""),
    E0 = (-664.902,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,990,1113,2750,2850,1437.5,1250,1305,750,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01693,0.0440046,1.40943e-05,-7.07627e-08,3.56114e-11,-79841.9,23.4087], Tmin=(100,'K'), Tmax=(934.866,'K')), NASAPolynomial(coeffs=[25.3359,-0.00497329,4.31074e-06,-7.68744e-10,4.18856e-14,-86795.7,-105.15], Tmin=(934.866,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-664.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-OdOsOs)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83188,0.028882,2.97234e-05,-7.6524e-08,3.61584e-11,-66735.1,20.7889], Tmin=(100,'K'), Tmax=(921.715,'K')), NASAPolynomial(coeffs=[20.7897,-0.00455118,4.65222e-06,-9.02866e-10,5.4907e-14,-72304.4,-80.3801], Tmin=(921.715,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-555.662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-OsOsHH) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54498,0.0413786,-1.05746e-05,-2.21794e-08,1.22675e-11,-52520.1,21.9918], Tmin=(100,'K'), Tmax=(1019.09,'K')), NASAPolynomial(coeffs=[16.9584,0.00907299,-4.52172e-06,1.00817e-09,-8.06064e-14,-57125.7,-59.8433], Tmin=(1019.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-437.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-OdOsOs) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)OCO(7267)'],
    products = ['HF(38)', 'CO2(14)', 'O=CO(1075)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(12.963,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)OF(2343)', 'CH2OH(33)'],
    products = ['O=C(OF)OCO(7267)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]OF(167)', '[O]CO(1591)'],
    products = ['O=C(OF)OCO(7267)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', '[CH2]OC(=O)OF(2344)'],
    products = ['O=C(OF)OCO(7267)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(126)', 'O=[C]OCO(2370)'],
    products = ['O=C(OF)OCO(7267)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(OF)O[CH]O(6076)'],
    products = ['O=C(OF)OCO(7267)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C(OF)OCO(7267)'],
    products = ['O=C(O)OF(2339)', 'CH2O(20)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(186.085,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

network(
    label = 'PDepNetwork #2823',
    isomers = [
        'O=C(OF)OCO(7267)',
    ],
    reactants = [
