...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18273,0.0536685,-3.65441e-05,1.08873e-08,-9.50206e-13,-21966.3,22.2657], Tmin=(100,'K'), Tmax=(1293.87,'K')), NASAPolynomial(coeffs=[13.9911,0.0221755,-9.42909e-06,1.75711e-09,-1.2141e-13,-25959.1,-45.4486], Tmin=(1293.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCCFH) + group(CsCsFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cd-Cs(F)-Cd)"""),
)

species(
    label = 'FC=CC1CC1F(8662)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {5,S} {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79418,0.0368589,1.1566e-05,-3.82429e-08,1.61201e-11,-29512.1,21.6823], Tmin=(100,'K'), Tmax=(1018.6,'K')), NASAPolynomial(coeffs=[11.8839,0.024323,-9.86066e-06,1.88664e-09,-1.36393e-13,-32972.7,-34.0781], Tmin=(1018.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-246.122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(CdCFH) + ring(Cs(F)-Cs-Cs)"""),
)

species(
    label = 'FCCC1C=C1F(8640)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60305,0.0545573,-4.30022e-05,1.80608e-08,-3.22115e-12,-16780.1,18.9837], Tmin=(100,'K'), Tmax=(1273.73,'K')), NASAPolynomial(coeffs=[9.60798,0.0294189,-1.33982e-05,2.56626e-09,-1.79988e-13,-18819.3,-21.5723], Tmin=(1273.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-140.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(CsCsFHH) + group(CdCsCdF) + group(Cds-CdsCsH) + ring(Cs-Cd(F)-Cd)"""),
)
...
"""),
    E0 = (-91.8922,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,334,575,1197,1424,3202,234,589,736,816,1240,3237,258.91,1467.51],'cm^-1')),
        HinderedRotor(inertia=(0.135409,'amu*angstrom^2'), symmetry=1, barrier=(6.44375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.56024,'amu*angstrom^2'), symmetry=1, barrier=(26.6849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560571,'amu*angstrom^2'), symmetry=1, barrier=(26.6852,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
...
"""),
    E0 = (10.1935,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,1000,334,575,1197,1424,3202,180,180,681.362,681.384,681.41,681.44,681.487],'cm^-1')),
        HinderedRotor(inertia=(0.0138914,'amu*angstrom^2'), symmetry=1, barrier=(4.57733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2935,'amu*angstrom^2'), symmetry=1, barrier=(29.7401,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31624,0.0526287,-4.04643e-05,1.53076e-08,-2.31384e-12,1327.8,23.0571], Tmin=(100,'K'), Tmax=(1559.57,'K')), NASAPolynomial(coeffs=[14.386,0.0191064,-8.22171e-06,1.5246e-09,-1.04356e-13,-2748.75,-45.805], Tmin=(1559.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.1935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCCFH) + group(CsCsFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cd-Cs(F)-Cd) + radical(Csj(Cs-CdHH)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72794,0.0511827,-4.43315e-05,2.11432e-08,-4.2547e-12,26609.4,18.1289], Tmin=(100,'K'), Tmax=(1156.4,'K')), NASAPolynomial(coeffs=[9.06675,0.025798,-1.14047e-05,2.1611e-09,-1.5106e-13,24912.1,-18.3432], Tmin=(1156.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = 'F[CH]CC1C=C1F(8665)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {5,S} {6,S} {8,S}
...
"""),
    E0 = (49.0779,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,334,575,1197,1424,3202,180,180,180,180,180,1168.67,1168.87],'cm^-1')),
        HinderedRotor(inertia=(0.00195858,'amu*angstrom^2'), symmetry=1, barrier=(1.89927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0019496,'amu*angstrom^2'), symmetry=1, barrier=(1.88595,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79497,0.0527145,-4.57328e-05,2.2272e-08,-4.74073e-12,5978.58,21.8323], Tmin=(100,'K'), Tmax=(1069.62,'K')), NASAPolynomial(coeffs=[7.73416,0.0305043,-1.45865e-05,2.85961e-09,-2.03569e-13,4708.03,-7.22066], Tmin=(1069.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.0779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(CsCsFHH) + group(CdCsCdF) + group(Cds-CdsCsH) + ring(Cd-Cd(F)-Cs(C)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-20.2096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,259,529,569,1128,1321,1390,3140,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180,470.806,1251.42,1251.46,1251.49,1251.8,1251.98],'cm^-1')),
        HinderedRotor(inertia=(0.175435,'amu*angstrom^2'), symmetry=1, barrier=(4.03359,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.969,0.0461933,-4.0197e-05,2.00105e-08,-4.27083e-12,42474.1,15.5187], Tmin=(100,'K'), Tmax=(1087.97,'K')), NASAPolynomial(coeffs=[7.75398,0.0249245,-1.08735e-05,2.04227e-09,-1.42e-13,41215.4,-12.8782], Tmin=(1087.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Allyl_T) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2795,0.0518492,-3.21493e-05,7.21803e-09,1.51007e-13,6093.31,25.3517], Tmin=(100,'K'), Tmax=(1222.12,'K')), NASAPolynomial(coeffs=[12.9292,0.0237632,-1.00045e-05,1.8626e-09,-1.29071e-13,2495.79,-36.257], Tmin=(1222.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.7936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsFHH) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7529,0.0475317,-2.82125e-05,7.68438e-09,-8.25305e-13,1841.46,25.1133], Tmin=(100,'K'), Tmax=(2099.8,'K')), NASAPolynomial(coeffs=[15.6464,0.0210654,-9.30615e-06,1.68178e-09,-1.10642e-13,-3993.25,-52.2216], Tmin=(2099.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.6293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFHH) + ring(Cs(F)-Cs-Cs) + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = 'FCC[C]1[CH]C1F(8672)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {5,S} {6,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00311,0.0493775,-3.47242e-05,1.3572e-08,-2.44349e-12,5891.95,23.4376], Tmin=(100,'K'), Tmax=(1167.68,'K')), NASAPolynomial(coeffs=[6.1224,0.0352666,-1.65975e-05,3.22293e-09,-2.27778e-13,4929.94,2.9258], Tmin=(1167.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.4298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFHH) + ring(Cs(F)-Cs-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(Cs-CsF1sH)(H)_ring)"""),
)

species(
    label = 'FCCC1[CH][C]1F(8673)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {4,S} {6,S} {7,S} {8,S}
...
"""),
    E0 = (92.7135,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,212,367,445,1450,529.579,529.587,529.604,529.607,529.607,529.618,529.62,529.633],'cm^-1')),
        HinderedRotor(inertia=(0.000600979,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000601002,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30621,0.0489007,-1.64221e-05,-1.38607e-08,8.59012e-12,11256.8,25.206], Tmin=(100,'K'), Tmax=(1032.11,'K')), NASAPolynomial(coeffs=[13.8696,0.0219604,-8.87884e-06,1.68452e-09,-1.20835e-13,7504.99,-41.4144], Tmin=(1032.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.7135,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFHH) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring) + radical(Csj(Cs-CsCsH)(Cs-CsF1sH)(H)_ring)"""),
)

species(
    label = 'FC(F)CC1[CH][CH]1(8674)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {4,S} {6,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60531,0.0461054,-2.50714e-05,4.91206e-09,1.59365e-14,3333.54,26.16], Tmin=(100,'K'), Tmax=(1429.77,'K')), NASAPolynomial(coeffs=[12.1569,0.0243967,-1.0491e-05,1.93449e-09,-1.31522e-13,-482.1,-31.3095], Tmin=(1429.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.9552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFFH) + ring(Cyclopropane) + radical(cyclopropane) + radical(cyclopropane)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]C1[CH]C1F(8659)'],
    products = ['F[CH]CC1[CH]C1F(8639)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]CC1=CC1F(8663)'],
    products = ['F[CH]CC1[CH]C1F(8639)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[CH]CC1C=C1(8664)'],
    products = ['F[CH]CC1[CH]C1F(8639)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH]CC1C=C1F(8665)'],
    products = ['F[CH]CC1[CH]C1F(8639)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FC=CC1[CH]C1F(8667)'],
    products = ['F[CH]CC1[CH]C1F(8639)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'F[CH]C[C]1C=C1(8668)'],
    products = ['F[CH]CC1[CH]C1F(8639)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', '[CH2]C1[CH]C1F(8659)'],
    products = ['F[CH]CC1[CH]C1F(8639)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[CH]CC1[CH]C1F(8639)'],
    products = ['FC(F)CC1[CH][CH]1(8674)'],
