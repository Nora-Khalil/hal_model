...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]C(=O)OF(1447)'],
    products = ['O=C(CO)OF(2335)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C([CH]O)OF(2365)'],
    products = ['O=C(CO)OF(2335)'],
