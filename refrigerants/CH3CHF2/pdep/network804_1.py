...
reaction(
    label = 'reaction2',
    reactants = ['O=C(O)OF(2357)', 'CH2(S)(25)'],
    products = ['COC(=O)OF(2324)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)OF(2361)', 'CH3(19)'],
    products = ['COC(=O)OF(2324)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(=O)OF(2362)'],
    products = ['COC(=O)OF(2324)'],
    transitionState = 'TS9',
