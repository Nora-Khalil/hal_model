...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.528449,'amu*angstrom^2'), symmetry=1, barrier=(12.1501,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.53037,'amu*angstrom^2'), symmetry=1, barrier=(12.1943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.305968,0.0824533,-9.88892e-05,5.84022e-08,-1.35706e-11,-94165,25.7824], Tmin=(100,'K'), Tmax=(1050.02,'K')), NASAPolynomial(coeffs=[16.6245,0.0202879,-1.0082e-05,2.01717e-09,-1.45691e-13,-97591.9,-53.7416], Tmin=(1050.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-784.031,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cs-CsHHH) + radical(CC(C)(O)OJ)"""),
)
...
"""),
    E0 = (-371.741,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,200.427,200.427,200.428],'cm^-1')),
        HinderedRotor(inertia=(0.287488,'amu*angstrom^2'), symmetry=1, barrier=(8.19524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287488,'amu*angstrom^2'), symmetry=1, barrier=(8.19524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.778103,'amu*angstrom^2'), symmetry=1, barrier=(22.1809,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.321125,0.0873691,-0.000140522,1.16969e-07,-3.84779e-11,-44583.8,25.4079], Tmin=(100,'K'), Tmax=(782.548,'K')), NASAPolynomial(coeffs=[12.1119,0.0238098,-1.23831e-05,2.43164e-09,-1.7017e-13,-46328.4,-27.941], Tmin=(782.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CC([O])(F)[C](F)OF(10857)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.27384,'amu*angstrom^2'), symmetry=1, barrier=(6.29611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274603,'amu*angstrom^2'), symmetry=1, barrier=(6.31366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.747777,'amu*angstrom^2'), symmetry=1, barrier=(17.1929,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.410569,0.08695,-0.000146039,1.27989e-07,-4.39113e-11,-41335.5,26.3552], Tmin=(100,'K'), Tmax=(814.169,'K')), NASAPolynomial(coeffs=[10.3682,0.0266639,-1.40318e-05,2.75393e-09,-1.91982e-13,-42580.3,-17.3242], Tmin=(814.169,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-344.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'CC([O])(F)C([O])(F)F(10858)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-643.276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([286,334,437,422,648,895,1187,2750,2800,2850,1350,1500,750,1050,1375,1000,351,323,533,609,664,892,1120,1201,180],'cm^-1')),
        HinderedRotor(inertia=(0.266462,'amu*angstrom^2'), symmetry=1, barrier=(6.12648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266657,'amu*angstrom^2'), symmetry=1, barrier=(6.13096,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.888168,0.0736153,-0.000102511,7.56669e-08,-2.2442e-11,-77260.8,24.5756], Tmin=(100,'K'), Tmax=(822.487,'K')), NASAPolynomial(coeffs=[11.0804,0.0240473,-1.21118e-05,2.39346e-09,-1.69977e-13,-78937.3,-22.6041], Tmin=(822.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-643.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.333209,'amu*angstrom^2'), symmetry=1, barrier=(7.66113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331671,'amu*angstrom^2'), symmetry=1, barrier=(7.62578,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.90552,0.0788383,-0.000145618,1.37895e-07,-4.95442e-11,-59888.1,21.4632], Tmin=(100,'K'), Tmax=(844.204,'K')), NASAPolynomial(coeffs=[6.95138,0.027665,-1.46665e-05,2.87436e-09,-1.99027e-13,-60106.2,-1.9264], Tmin=(844.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-F1sO2sCs)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.00085,'amu*angstrom^2'), symmetry=1, barrier=(23.0116,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54369,0.0585007,-7.67468e-05,5.59674e-08,-1.67591e-11,-74079.1,20.8098], Tmin=(100,'K'), Tmax=(808.441,'K')), NASAPolynomial(coeffs=[8.63147,0.0234304,-1.16741e-05,2.30422e-09,-1.63814e-13,-75225.1,-11.8772], Tmin=(808.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-616.631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(COCsFO) + radical(C=OCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.792269,'amu*angstrom^2'), symmetry=1, barrier=(18.2158,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.789831,'amu*angstrom^2'), symmetry=1, barrier=(18.1598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.789282,'amu*angstrom^2'), symmetry=1, barrier=(18.1471,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.29249,0.0871141,-0.000116181,7.87053e-08,-2.12453e-11,-89199.7,25.7486], Tmin=(100,'K'), Tmax=(902.895,'K')), NASAPolynomial(coeffs=[14.285,0.0251261,-1.32018e-05,2.67059e-09,-1.92848e-13,-91726.5,-40.3282], Tmin=(902.895,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-742.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sF1s))"""),
)

species(
    label = 'C[C](OF)C(F)(F)OF(10863)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-464.117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,253,525,597,667,842,1178,1324,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.322458,'amu*angstrom^2'), symmetry=1, barrier=(7.41394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322186,'amu*angstrom^2'), symmetry=1, barrier=(7.40769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322222,'amu*angstrom^2'), symmetry=1, barrier=(7.40852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26635,'amu*angstrom^2'), symmetry=1, barrier=(29.1158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.199699,0.101502,-0.000172382,1.50332e-07,-5.11682e-11,-55678,28.6343], Tmin=(100,'K'), Tmax=(815.275,'K')), NASAPolynomial(coeffs=[12.0966,0.0286406,-1.52699e-05,3.0044e-09,-2.09473e-13,-57266.5,-25.6227], Tmin=(815.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-464.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(C2CsJO)"""),
)

species(
    label = 'CC(F)(OF)[C](F)OF(10864)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-444.136,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,316,385,515,654,689,1295,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.699001,'amu*angstrom^2'), symmetry=1, barrier=(16.0714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.699072,'amu*angstrom^2'), symmetry=1, barrier=(16.073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.698968,'amu*angstrom^2'), symmetry=1, barrier=(16.0706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7066,'amu*angstrom^2'), symmetry=1, barrier=(39.238,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.223141,0.100866,-0.00016104,1.32661e-07,-4.34251e-11,-53272.7,27.6667], Tmin=(100,'K'), Tmax=(749.853,'K')), NASAPolynomial(coeffs=[13.4346,0.028007,-1.52874e-05,3.07256e-09,-2.1845e-13,-55320.9,-34.2918], Tmin=(749.853,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-444.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC([O])(F)C(F)(F)OF(10850)'],
    products = ['HF(38)', 'CF2O(49)', 'CH2CFO(79)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(14.8686,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CC([O])(F)OF(10854)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(207.076,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CC([O])(F)C(F)(F)OF(10850)'],
    products = ['CC([O])(OF)C(F)(F)F(10855)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C[C](F)C(F)(F)OF(4805)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC([O])(F)[C](F)OF(10857)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC([O])(F)C([O])(F)F(10858)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(126)', 'CC([O])(F)[C](F)F(10859)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(4688)', 'C[C]([O])F(517)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', '[O][C](F)C(F)(F)OF(5032)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'CC([O])(F)C(=O)F(10861)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'CC(=O)[C](F)OF(2085)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(16.1413,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['CC(F)(OF)C([O])(F)F(10862)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C[C](OF)C(F)(F)OF(10863)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CC(F)(OF)[C](F)OF(10864)'],
    products = ['CC([O])(F)C(F)(F)OF(10850)'],
