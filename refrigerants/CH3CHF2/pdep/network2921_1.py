...
"""),
    E0 = (58.0469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,615,860,1140,1343,3152,1685,370,306.537,306.538,306.542,4000],'cm^-1')),
        HinderedRotor(inertia=(0.246663,'amu*angstrom^2'), symmetry=1, barrier=(16.4477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.246664,'amu*angstrom^2'), symmetry=1, barrier=(16.4477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66235,0.0292114,5.89365e-05,-1.14582e-07,5.18508e-11,5512.18,18.8414], Tmin=(100,'K'), Tmax=(900.232,'K')), NASAPolynomial(coeffs=[20.805,0.00320004,3.89452e-06,-9.6363e-10,6.52048e-14,-326.935,-84.7873], Tmin=(900.232,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.9575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1([O])CC1=CF(7841)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u1 p2 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.568069,'amu*angstrom^2'), symmetry=1, barrier=(13.061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.56773,'amu*angstrom^2'), symmetry=1, barrier=(13.0532,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.761715,0.0699029,-8.35699e-05,5.15997e-08,-1.24844e-11,5533.38,22.472], Tmin=(100,'K'), Tmax=(1016.51,'K')), NASAPolynomial(coeffs=[14.0078,0.0177771,-6.64824e-06,1.14947e-09,-7.62386e-14,2840.54,-41.6489], Tmin=(1016.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.0278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCFH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(CdCdF1s)"""),
)

species(
    label = '[CH]=C(O)C([CH2])=CF(7895)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.10403,'amu*angstrom^2'), symmetry=1, barrier=(25.3838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10359,'amu*angstrom^2'), symmetry=1, barrier=(25.3737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10378,'amu*angstrom^2'), symmetry=1, barrier=(25.3781,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.235239,0.0783977,-8.89498e-05,4.74386e-08,-9.42585e-12,6087.61,24.5782], Tmin=(100,'K'), Tmax=(1392.53,'K')), NASAPolynomial(coeffs=[21.8899,0.00522902,2.22551e-07,-2.10448e-10,1.86879e-14,857.842,-86.1418], Tmin=(1392.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.2422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCFH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_P)"""),
)

species(
    label = 'C=C(O)C(=C)[C]F(7896)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    E0 = (37.5112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,325,375,415,465,420,450,1700,1750,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,227.548,229.125,229.247,229.4],'cm^-1')),
        HinderedRotor(inertia=(0.518958,'amu*angstrom^2'), symmetry=1, barrier=(19.1193,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.521294,'amu*angstrom^2'), symmetry=1, barrier=(19.1173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.521614,'amu*angstrom^2'), symmetry=1, barrier=(19.1225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.353875,0.0735887,-8.41589e-05,4.67961e-08,-9.99259e-12,4648.51,22.1908], Tmin=(100,'K'), Tmax=(1159.24,'K')), NASAPolynomial(coeffs=[18.3189,0.0115997,-3.94829e-06,6.67861e-10,-4.46521e-14,483.351,-67.1348], Tmin=(1159.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.5112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]=C([O])C(C)=CF(7897)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u1 p2 c0 {5,S}
3  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.665407,'amu*angstrom^2'), symmetry=1, barrier=(15.299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.666283,'amu*angstrom^2'), symmetry=1, barrier=(15.3192,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.658234,0.0707274,-8.34944e-05,5.01763e-08,-1.17399e-11,4398.16,22.5916], Tmin=(100,'K'), Tmax=(1053.69,'K')), NASAPolynomial(coeffs=[15.0518,0.0160864,-5.70859e-06,9.61087e-10,-6.2929e-14,1364.92,-47.6017], Tmin=(1053.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.5478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCFH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.88641,'amu*angstrom^2'), symmetry=1, barrier=(20.3803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.882751,'amu*angstrom^2'), symmetry=1, barrier=(20.2962,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3347,0.0431493,7.17685e-06,-4.67789e-08,2.24017e-11,-22672.8,14.6025], Tmin=(100,'K'), Tmax=(970.98,'K')), NASAPolynomial(coeffs=[17.6046,0.0134535,-4.61531e-06,9.11304e-10,-7.14568e-14,-27592,-72.4728], Tmin=(970.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(12methylenecyclobutane)"""),
)

species(
    label = '[CH2]C1=C([O])CC1F(7900)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u1 p2 c0 {6,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48994,0.0427809,-1.00052e-06,-3.37281e-08,1.70624e-11,-3292.33,21.2754], Tmin=(100,'K'), Tmax=(968.829,'K')), NASAPolynomial(coeffs=[15.1926,0.0159344,-5.46136e-06,1.01289e-09,-7.49041e-14,-7342.61,-51.5986], Tmin=(968.829,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.2183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + ring(Cs(F)-Cs-Cd-Cd) + radical(C=C(C)OJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1=C([CH]F)CO1(7901)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {3,S} {5,S}
3  C u0 p0 c0 {2,S} {4,S} {8,S} {9,S}
...
"""),
    E0 = (-12.5249,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,1855,455,950,577.946],'cm^-1')),
        HinderedRotor(inertia=(0.0965257,'amu*angstrom^2'), symmetry=1, barrier=(22.8772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137026,'amu*angstrom^2'), symmetry=1, barrier=(3.15049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.096524,'amu*angstrom^2'), symmetry=1, barrier=(22.8773,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.712974,0.0730309,-9.06468e-05,5.85114e-08,-1.48972e-11,18496.3,22.4031], Tmin=(100,'K'), Tmax=(963.418,'K')), NASAPolynomial(coeffs=[13.4598,0.0201078,-8.24811e-06,1.4933e-09,-1.01489e-13,16040.2,-38.6179], Tmin=(963.418,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsCs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(CsCsFHH) + group(Cds-OdCsCs) + ring(cyclopropanone) + radical(CJC(C)2C=O) + radical(CsCsF1sH)"""),
)

species(
    label = 'C=C([C]F)C(C)=O(7905)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {5,D}
...
"""),
    E0 = (25.2365,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,375,552.5,462.5,1710,2950,3100,1380,975,1025,1650,180,180,1583.76,1583.81],'cm^-1')),
        HinderedRotor(inertia=(0.000608593,'amu*angstrom^2'), symmetry=1, barrier=(6.91,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13838,'amu*angstrom^2'), symmetry=1, barrier=(26.1735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13836,'amu*angstrom^2'), symmetry=1, barrier=(26.1732,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68376,0.0568066,-7.52813e-05,6.99668e-08,-2.81465e-11,3113.02,22.3393], Tmin=(100,'K'), Tmax=(723.299,'K')), NASAPolynomial(coeffs=[3.8098,0.0374426,-1.93492e-05,3.87457e-09,-2.77131e-13,3004.44,14.1465], Tmin=(723.299,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.2365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-O2d)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14757,0.0357599,-6.36034e-06,-8.70757e-09,3.34046e-12,-25462.3,17.7538], Tmin=(100,'K'), Tmax=(1365.92,'K')), NASAPolynomial(coeffs=[10.216,0.0270061,-1.30814e-05,2.54494e-09,-1.78158e-13,-29054.1,-28.7671], Tmin=(1365.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-O2d)CsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=C([O])[C]=CF(4080)'],
    products = ['[CH2]C(=CF)C(=C)[O](7415)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([C]=C)=CF(7769)'],
    products = ['[CH2]C(=CF)C(=C)[O](7415)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=CF)C(=C)[O](7415)'],
    products = ['[CH2]C([CH]F)=C1CO1(7891)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(=CF)C(=C)[O](7415)'],
    products = ['[CH2]C1([CH]F)OC1=C(7816)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(O)C([CH2])=CF(7895)'],
    products = ['[CH2]C(=CF)C(=C)[O](7415)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]F(230)', 'C=[C]C(=C)[O](567)'],
    products = ['[CH2]C(=CF)C(=C)[O](7415)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(=CF)C(=C)[O](7415)'],
    products = ['[CH2]C1=C([CH]F)CO1(7901)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(=CF)C(=C)[O](7415)'],
    products = ['[CH2]C1([O])C(=C)C1F(7868)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CHF(40)', 'C=[C]C(=C)[O](567)'],
    products = ['[CH2]C(=CF)C(=C)[O](7415)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(T)(18)', '[CH2]C([C]=O)=CF(7904)'],
    products = ['[CH2]C(=CF)C(=C)[O](7415)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(=CF)C(=C)[O](7415)'],
    products = ['[CH2]C1([CH]F)CC1=O(7752)'],
