...
"""),
    E0 = (-491.223,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180],'cm^-1')),
        HinderedRotor(inertia=(0.315994,'amu*angstrom^2'), symmetry=1, barrier=(7.26533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.716519,'amu*angstrom^2'), symmetry=1, barrier=(16.4742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48018,'amu*angstrom^2'), symmetry=1, barrier=(34.0323,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.466921,0.0846345,-0.000105492,6.98532e-08,-1.89307e-11,-58959.1,29.8871], Tmin=(100,'K'), Tmax=(888.745,'K')), NASAPolynomial(coeffs=[12.1205,0.0321833,-1.69633e-05,3.44367e-09,-2.49366e-13,-61030.5,-24.9597], Tmin=(888.745,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-491.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CJCOOH)"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.546186,0.0827652,-0.000104455,7.11645e-08,-1.99054e-11,-97655.8,27.5588], Tmin=(100,'K'), Tmax=(861.677,'K')), NASAPolynomial(coeffs=[11.3844,0.0324529,-1.68717e-05,3.40213e-09,-2.45297e-13,-99523.6,-23.1156], Tmin=(861.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-812.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
"""),
    E0 = (-435.987,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,493,600,700,1144,1293,180],'cm^-1')),
        HinderedRotor(inertia=(1.96428,'amu*angstrom^2'), symmetry=1, barrier=(45.1626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275438,'amu*angstrom^2'), symmetry=1, barrier=(6.33286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.79685,'amu*angstrom^2'), symmetry=1, barrier=(87.297,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37736,0.0628908,-7.84641e-05,5.25547e-08,-1.44622e-11,-52347.2,25.4651], Tmin=(100,'K'), Tmax=(874.661,'K')), NASAPolynomial(coeffs=[9.7303,0.0246904,-1.29509e-05,2.61956e-09,-1.89226e-13,-53808.4,-13.7142], Tmin=(874.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-435.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    E0 = (-256.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,223,363,546,575,694,1179,1410,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,265.132,265.463,2206.37,2209.33],'cm^-1')),
        HinderedRotor(inertia=(0.28057,'amu*angstrom^2'), symmetry=1, barrier=(14.2878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.70022,'amu*angstrom^2'), symmetry=1, barrier=(34.8703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.706246,'amu*angstrom^2'), symmetry=1, barrier=(34.8398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.691222,'amu*angstrom^2'), symmetry=1, barrier=(34.8492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.443855,0.0854003,-0.000113384,7.90217e-08,-2.23606e-11,-30784.5,28.9783], Tmin=(100,'K'), Tmax=(855.676,'K')), NASAPolynomial(coeffs=[12.3023,0.0299657,-1.62067e-05,3.30957e-09,-2.39983e-13,-32813.9,-26.3836], Tmin=(855.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCJ2_triplet)"""),
)

species(
    label = 'FC1[CH]OOC(F)(F)C1(7219)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70365,0.0603598,-2.31924e-05,-2.39035e-08,1.71887e-11,-77170.8,21.0112], Tmin=(100,'K'), Tmax=(914.317,'K')), NASAPolynomial(coeffs=[18.1354,0.0163288,-3.83297e-06,5.35043e-10,-3.52783e-14,-81705.6,-68.8929], Tmin=(914.317,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-642.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCFFO) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCsJOOC)"""),
)

species(
    label = 'F[CH]C1CC(F)(F)OO1(7220)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0108771,0.0759593,-7.65932e-05,3.92407e-08,-7.73011e-12,-73877.4,26.1958], Tmin=(100,'K'), Tmax=(1358.61,'K')), NASAPolynomial(coeffs=[18.3364,0.016135,-4.13203e-06,5.38273e-10,-2.95453e-14,-78326.8,-65.9696], Tmin=(1358.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-615.539,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCsFHH) + ring(12dioxolane) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.198527,'amu*angstrom^2'), symmetry=1, barrier=(4.56452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199009,'amu*angstrom^2'), symmetry=1, barrier=(4.5756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.19217,'amu*angstrom^2'), symmetry=1, barrier=(50.4023,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61418,0.0614831,-5.6807e-05,4.12924e-09,2.41402e-11,-34448.1,25.5633], Tmin=(100,'K'), Tmax=(506.178,'K')), NASAPolynomial(coeffs=[6.46824,0.0358802,-1.87351e-05,3.77048e-09,-2.70866e-13,-35102.9,3.83614], Tmin=(506.178,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.25108,'amu*angstrom^2'), symmetry=1, barrier=(5.77283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.62699,'amu*angstrom^2'), symmetry=1, barrier=(37.4076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250901,'amu*angstrom^2'), symmetry=1, barrier=(5.7687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.62616,'amu*angstrom^2'), symmetry=1, barrier=(37.3886,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.524241,0.0836178,-0.000128726,1.10519e-07,-3.85505e-11,-7333.97,30.2529], Tmin=(100,'K'), Tmax=(746.633,'K')), NASAPolynomial(coeffs=[9.4098,0.0319689,-1.68348e-05,3.35485e-09,-2.37939e-13,-8548.06,-9.26345], Tmin=(746.633,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.9619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)

species(
    label = '[CH]=COOC([CH2])(F)F(7221)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-79.1293,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.967455,'amu*angstrom^2'), symmetry=1, barrier=(22.2437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.971715,'amu*angstrom^2'), symmetry=1, barrier=(22.3417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.971504,'amu*angstrom^2'), symmetry=1, barrier=(22.3368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.972501,'amu*angstrom^2'), symmetry=1, barrier=(22.3597,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.492379,0.0784647,-9.25259e-05,5.40901e-08,-1.24883e-11,-9391.73,28.7216], Tmin=(100,'K'), Tmax=(1054.44,'K')), NASAPolynomial(coeffs=[15.7504,0.0205852,-1.01913e-05,2.03572e-09,-1.46869e-13,-12609.5,-45.6987], Tmin=(1054.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.1293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCOOH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-252.249,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,615,860,1140,1343,3152,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.298866,'amu*angstrom^2'), symmetry=1, barrier=(6.87152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.875582,'amu*angstrom^2'), symmetry=1, barrier=(20.1314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.879,'amu*angstrom^2'), symmetry=1, barrier=(43.2019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.87719,'amu*angstrom^2'), symmetry=1, barrier=(43.1604,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.185947,0.0917815,-0.000137025,1.0895e-07,-3.50036e-11,-30208.5,30.3012], Tmin=(100,'K'), Tmax=(759.039,'K')), NASAPolynomial(coeffs=[11.7233,0.0309815,-1.68722e-05,3.41976e-09,-2.45541e-13,-31960,-22.179], Tmin=(759.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.249,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CJCOOH) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)
...
"""),
    E0 = (-466.212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,615,860,1140,1343,3152,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.850736,'amu*angstrom^2'), symmetry=1, barrier=(19.5601,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80564,'amu*angstrom^2'), symmetry=1, barrier=(41.5153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80471,'amu*angstrom^2'), symmetry=1, barrier=(41.4939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.354394,'amu*angstrom^2'), symmetry=1, barrier=(8.14822,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.390378,0.0872865,-0.000116977,8.63658e-08,-2.63179e-11,-55949.4,27.5811], Tmin=(100,'K'), Tmax=(792.332,'K')), NASAPolynomial(coeffs=[10.6571,0.0354597,-1.88687e-05,3.82355e-09,-2.75783e-13,-57576.5,-19.561], Tmin=(792.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-466.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = 'CC(F)(F)OOC=[C]F(7226)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-446.223,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(0.463697,'amu*angstrom^2'), symmetry=1, barrier=(10.6613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.463834,'amu*angstrom^2'), symmetry=1, barrier=(10.6645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88603,'amu*angstrom^2'), symmetry=1, barrier=(43.3636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09101,'amu*angstrom^2'), symmetry=1, barrier=(25.0844,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.247084,0.0912478,-0.000130637,9.9671e-08,-2.95872e-11,-53541.2,29.0465], Tmin=(100,'K'), Tmax=(640.394,'K')), NASAPolynomial(coeffs=[10.659,0.0347707,-1.83943e-05,3.68984e-09,-2.63486e-13,-55050.2,-17.9146], Tmin=(640.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)

species(
    label = 'FC=COO[C](F)CF(7227)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-450.087,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.86144,'amu*angstrom^2'), symmetry=1, barrier=(42.7982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.715633,'amu*angstrom^2'), symmetry=1, barrier=(16.4538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.641245,'amu*angstrom^2'), symmetry=1, barrier=(14.7435,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.86088,'amu*angstrom^2'), symmetry=1, barrier=(42.7853,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.287193,0.0895277,-0.000129763,1.05646e-07,-3.54021e-11,-54006.7,30.4271], Tmin=(100,'K'), Tmax=(724.5,'K')), NASAPolynomial(coeffs=[9.96561,0.036093,-1.91327e-05,3.84736e-09,-2.75311e-13,-55409.1,-13.1466], Tmin=(724.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-450.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH]=COOC(F)(F)CF(7228)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-462.036,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,223,363,546,575,694,1179,1410,528,1116,1182,1331,1402,1494,3075,3110,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.16144,'amu*angstrom^2'), symmetry=1, barrier=(26.7037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1619,'amu*angstrom^2'), symmetry=1, barrier=(26.7144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16075,'amu*angstrom^2'), symmetry=1, barrier=(26.6879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16108,'amu*angstrom^2'), symmetry=1, barrier=(26.6956,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.174518,0.0855003,-9.81121e-05,5.58926e-08,-1.2617e-11,-55433.4,29.2734], Tmin=(100,'K'), Tmax=(1075.32,'K')), NASAPolynomial(coeffs=[16.8173,0.0235925,-1.17556e-05,2.35458e-09,-1.70098e-13,-59012.7,-52.2273], Tmin=(1075.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-462.036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)OOC=CF(7214)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)OOC=CF(7214)'],
    products = ['[CH2]C(F)(F)OC(F)C=O(7217)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.62709e+20,'s^-1'), n=-1.9758, Ea=(102.01,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'FC=COO[C](F)F(4713)'],
    products = ['[CH2]C(F)(F)OOC=CF(7214)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]C(F)(F)OOC=CF(7218)'],
    products = ['[CH2]C(F)(F)OOC=CF(7214)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)(F)OOC=CF(7214)'],
    products = ['FC1[CH]OOC(F)(F)C1(7219)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)OOC=CF(7214)'],
    products = ['F[CH]C1CC(F)(F)OO1(7220)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)OOC=CF(3669)'],
    products = ['[CH2]C(F)(F)OOC=CF(7214)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=COOC([CH2])(F)F(7221)'],
    products = ['[CH2]C(F)(F)OOC=CF(7214)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C[CH]F(338)', '[CH2]C([O])(F)F(1114)'],
    products = ['[CH2]C(F)(F)OOC=CF(7214)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(43.054,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['CHFCH[Z](71)', '[CH2]C(F)(F)O[O](3042)'],
    products = ['[CH2]C(F)(F)OOC=CF(7214)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(F)(F)OO[C]=CF(7222)'],
    products = ['[CH2]C(F)(F)OOC=CF(7214)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)OOC=[C]F(7223)'],
    products = ['[CH2]C(F)(F)OOC=CF(7214)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=COOC(F)(F)CF(7228)'],
    products = ['[CH2]C(F)(F)OOC=CF(7214)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(183.914,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #2806',
    isomers = [
        '[CH2]C(F)(F)OOC=CF(7214)',
    ],
    reactants = [
