...
"""),
    E0 = (-165.869,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1277.5,1000,3025,407.5,1350,352.5,580,1155,1237,1373,3147,206.755],'cm^-1')),
        HinderedRotor(inertia=(0.342944,'amu*angstrom^2'), symmetry=1, barrier=(10.4426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.959311,'amu*angstrom^2'), symmetry=1, barrier=(30.0436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.344353,'amu*angstrom^2'), symmetry=1, barrier=(10.444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.9815,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13815,0.0680699,-0.000112069,9.40668e-08,-3.08524e-11,-19851.3,22.8201], Tmin=(100,'K'), Tmax=(819.29,'K')), NASAPolynomial(coeffs=[10.3841,0.0173121,-8.85635e-06,1.7139e-09,-1.18431e-13,-21177.9,-18.7931], Tmin=(819.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsFHHO) + radical(OCJO) + radical(CsF1sHO2s)"""),
)
...
"""),
    ...
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14001,0.0278664,1.77257e-05,-4.53333e-08,1.92695e-11,-71092.5,19.8258], Tmin=(100,'K'), Tmax=(1001.86,'K')), NASAPolynomial(coeffs=[13.922,0.0120527,-5.35076e-06,1.13289e-09,-8.85898e-14,-75020.5,-44.8588], Tmin=(1001.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-591.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsFHHO) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (-127.432,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,580,1155,1237,1373,3147,185.694,1182.89],'cm^-1')),
        HinderedRotor(inertia=(1.44504,'amu*angstrom^2'), symmetry=1, barrier=(35.3866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0419,'amu*angstrom^2'), symmetry=1, barrier=(25.3475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43707,'amu*angstrom^2'), symmetry=1, barrier=(35.3966,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07395,0.0448682,-4.13163e-05,1.9119e-08,-3.65357e-12,-15259.3,20.1489], Tmin=(100,'K'), Tmax=(1216.98,'K')), NASAPolynomial(coeffs=[9.76147,0.0196004,-1.0172e-05,2.05786e-09,-1.48728e-13,-17130.4,-18.4485], Tmin=(1216.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-127.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsFHHO) + radical(OCOJ) + radical(CsF1sHO2s)"""),
)

species(
    label = '[O][CH]OOCF(8004)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {3,S} {5,S}
3 O u0 p2 c0 {2,S} {6,S}
...
"""),
    E0 = (-137.534,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,548,1085,1183,1302,1466,1520,3060,3119,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00191501,'amu*angstrom^2'), symmetry=1, barrier=(3.03646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.23412,'amu*angstrom^2'), symmetry=1, barrier=(51.3668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.22925,'amu*angstrom^2'), symmetry=1, barrier=(51.2548,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79447,0.0597972,-0.000112916,1.18474e-07,-4.67421e-11,-16473.1,20.696], Tmin=(100,'K'), Tmax=(825.785,'K')), NASAPolynomial(coeffs=[1.55271,0.0345027,-1.8896e-05,3.76031e-09,-2.6377e-13,-15530.8,27.2798], Tmin=(825.785,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsFHHO) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[CH]F(283)', '[CH]O(237)'],
    products = ['O[CH]OO[CH]F(7992)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[O]O[CH]O(780)'],
    products = ['O[CH]OO[CH]F(7992)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['O[CH]OO[CH]F(7992)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(243.293,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 242.5 to 243.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['O[CH]OO[CH]F(7992)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(213.451,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 213.2 to 213.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['O[CH]OO[CH]F(7992)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(8.24209,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[O]O[CH]O(780)'],
    products = ['O[CH]OO[CH]F(7992)'],
