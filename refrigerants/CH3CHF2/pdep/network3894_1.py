...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62248,0.038002,2.20878e-05,-5.51343e-08,2.34837e-11,-579.086,18.6645], Tmin=(100,'K'), Tmax=(980.905,'K')), NASAPolynomial(coeffs=[13.6018,0.0236404,-8.69027e-06,1.62817e-09,-1.18661e-13,-4588.4,-47.3553], Tmin=(980.905,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.63252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(CdCFH) + ring(12methylenecyclobutane)"""),
)
...
"""),
    E0 = (284.746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,615,860,1140,1343,3152,1685,370,2175,525,750,770,3400,2100,228.33,228.4,4000],'cm^-1')),
        HinderedRotor(inertia=(0.596438,'amu*angstrom^2'), symmetry=1, barrier=(22.0723,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.14721,'amu*angstrom^2'), symmetry=1, barrier=(79.4362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.14707,'amu*angstrom^2'), symmetry=1, barrier=(79.4316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22047,0.0570023,-4.9093e-05,2.29836e-08,-4.38766e-12,34350.5,25.6784], Tmin=(100,'K'), Tmax=(1250.6,'K')), NASAPolynomial(coeffs=[11.699,0.0234867,-8.89296e-06,1.55359e-09,-1.03665e-13,31729.6,-27.2175], Tmin=(1250.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cds-CdsCsH) + group(CdCFH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cdj(Cs-CsHH)(Cd-F1sH))"""),
)
...
"""),
    E0 = (467.645,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,2175,525,750,770,3400,2100,343.502,343.506],'cm^-1')),
        HinderedRotor(inertia=(0.121138,'amu*angstrom^2'), symmetry=1, barrier=(10.1409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175621,'amu*angstrom^2'), symmetry=1, barrier=(14.7042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.862291,'amu*angstrom^2'), symmetry=1, barrier=(72.2102,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47786,0.0517124,-4.14996e-05,1.8682e-08,-3.48863e-12,56338.6,22.41], Tmin=(100,'K'), Tmax=(1265.16,'K')), NASAPolynomial(coeffs=[10.1555,0.0242768,-8.97159e-06,1.54179e-09,-1.0168e-13,54142.9,-21.4958], Tmin=(1265.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(467.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]CCC#CF(11692)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  C u0 p0 c0 {3,S} {5,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {6,S} {10,S} {11,S}
...
"""),
    E0 = (367.88,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,2175,525,239,401,1367,401.453,401.511,401.698],'cm^-1')),
        HinderedRotor(inertia=(0.0940709,'amu*angstrom^2'), symmetry=1, barrier=(10.7544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0116535,'amu*angstrom^2'), symmetry=1, barrier=(72.3509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0940157,'amu*angstrom^2'), symmetry=1, barrier=(10.7523,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5499,0.0570858,-5.7476e-05,3.57086e-08,-9.6077e-12,44331.1,24.4851], Tmin=(100,'K'), Tmax=(877.787,'K')), NASAPolynomial(coeffs=[7.14592,0.0315848,-1.38983e-05,2.61146e-09,-1.8128e-13,43348.7,-1.78295], Tmin=(877.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(367.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(CtCF) + radical(Cds_S)"""),
)
...
"""),
    E0 = (365.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,615,860,1140,1343,3152,1685,370,3120,650,792.5,1650,180,819.456,820.031],'cm^-1')),
        HinderedRotor(inertia=(0.198015,'amu*angstrom^2'), symmetry=1, barrier=(4.55276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.545193,'amu*angstrom^2'), symmetry=1, barrier=(12.5351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.544928,'amu*angstrom^2'), symmetry=1, barrier=(12.529,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12432,0.0574609,-4.27511e-05,1.62394e-08,-2.50606e-12,44096.3,28.5912], Tmin=(100,'K'), Tmax=(1513.13,'K')), NASAPolynomial(coeffs=[13.6173,0.0244355,-1.00123e-05,1.81514e-09,-1.22876e-13,40315.6,-36.8544], Tmin=(1513.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH) + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cds_P)"""),
)

species(
    label = 'C=[C]CCC=[C]F(11695)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {6,S} {10,S} {11,S}
...
"""),
    E0 = (359.869,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,167,640,1190,307.17,307.713,3674.99],'cm^-1')),
        HinderedRotor(inertia=(0.194059,'amu*angstrom^2'), symmetry=1, barrier=(13.0086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.371205,'amu*angstrom^2'), symmetry=1, barrier=(24.883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193885,'amu*angstrom^2'), symmetry=1, barrier=(12.9984,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39825,0.0584973,-4.81744e-05,2.1837e-08,-4.20438e-12,43374.7,26.2], Tmin=(100,'K'), Tmax=(1197.07,'K')), NASAPolynomial(coeffs=[9.66587,0.0308715,-1.35581e-05,2.55886e-09,-1.78326e-13,41395.3,-15.1738], Tmin=(1197.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (356.847,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,1685,370,3120,650,792.5,1650,277.437,277.708],'cm^-1')),
        HinderedRotor(inertia=(0.00218916,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203986,'amu*angstrom^2'), symmetry=1, barrier=(11.172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20405,'amu*angstrom^2'), symmetry=1, barrier=(11.1713,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29583,0.0597284,-4.97914e-05,2.25153e-08,-4.26896e-12,43015.8,26.479], Tmin=(100,'K'), Tmax=(1225.41,'K')), NASAPolynomial(coeffs=[10.5436,0.0295415,-1.28403e-05,2.41261e-09,-1.67734e-13,40749.4,-20.0162], Tmin=(1225.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=CCC[C]=[C]F(11698)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {6,S} {10,S} {11,S}
...
"""),
    E0 = (368.76,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,167,640,1190,407.241,407.242,407.245],'cm^-1')),
        HinderedRotor(inertia=(0.0881026,'amu*angstrom^2'), symmetry=1, barrier=(10.3687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00101646,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0881033,'amu*angstrom^2'), symmetry=1, barrier=(10.3687,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24786,0.0560273,-4.06032e-05,1.50593e-08,-2.28577e-12,44454.2,28.2327], Tmin=(100,'K'), Tmax=(1522.7,'K')), NASAPolynomial(coeffs=[12.8298,0.0256028,-1.06326e-05,1.93769e-09,-1.3146e-13,40927,-32.5138], Tmin=(1522.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=[C]CCC(=C)F(11699)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {6,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24141,0.0622357,-5.58593e-05,2.76273e-08,-5.7383e-12,41007.3,25.9213], Tmin=(100,'K'), Tmax=(1127.49,'K')), NASAPolynomial(coeffs=[10.2258,0.0303618,-1.34546e-05,2.55414e-09,-1.78798e-13,38981.4,-18.5015], Tmin=(1127.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)CC[C]=C(11700)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {6,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29218,0.0610461,-5.3041e-05,2.53579e-08,-5.11307e-12,42348.3,25.959], Tmin=(100,'K'), Tmax=(1154.51,'K')), NASAPolynomial(coeffs=[10.0557,0.0306834,-1.35921e-05,2.5783e-09,-1.80334e-13,40324.8,-17.579], Tmin=(1154.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(351.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(395)', '[CH2]C[C]=CF(4143)'],
    products = ['C=[C]CC[C]=CF(11682)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=CF(1084)', '[CH2]C[C]=C(1912)'],
    products = ['C=[C]CC[C]=CF(11682)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'C#CCC[C]=C(11612)'],
    products = ['C=[C]CC[C]=CF(11682)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=[C]CCC#CF(11692)'],
    products = ['C=[C]CC[C]=CF(11682)'],
