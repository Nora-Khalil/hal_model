...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.651088,'amu*angstrom^2'), symmetry=1, barrier=(14.9698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.650432,'amu*angstrom^2'), symmetry=1, barrier=(14.9547,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32119,0.0526631,-4.71898e-05,2.41491e-08,-4.95152e-12,24992.9,26.4896], Tmin=(100,'K'), Tmax=(1283.63,'K')), NASAPolynomial(coeffs=[10.6908,0.0203941,-5.89193e-06,8.3638e-10,-4.80391e-14,22840.6,-20.0672], Tmin=(1283.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = '[O]C1=C[C](CF)C1(11937)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u1 p2 c0 {6,S}
...
"""),
    E0 = (-23.0623,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([319,1023,1071,1259,1317,1409,3054,3019,350,440,435,1725,2950,3100,1380,975,1025,1650,2100,2250,500,550,209.765,209.78,210.081],'cm^-1')),
        HinderedRotor(inertia=(1.20192,'amu*angstrom^2'), symmetry=1, barrier=(37.7021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.9445,'amu*angstrom^2'), symmetry=1, barrier=(29.5763,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21756,0.055808,-5.50689e-05,2.82011e-08,-5.69485e-12,-2669.01,22.6897], Tmin=(100,'K'), Tmax=(1209.72,'K')), NASAPolynomial(coeffs=[13.2805,0.0159208,-5.60992e-06,9.44332e-10,-6.19307e-14,-5587.53,-37.8035], Tmin=(1209.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.0623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.940025,0.068047,-8.24263e-05,5.36595e-08,-1.39006e-11,747.3,22.7773], Tmin=(100,'K'), Tmax=(944.838,'K')), NASAPolynomial(coeffs=[11.936,0.0214935,-8.51629e-06,1.50746e-09,-1.00842e-13,-1330.5,-29.6475], Tmin=(944.838,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.30262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(C=CJC=C)"""),
)

species(
    label = 'C=C(O)[C]=[C]CF(11940)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01571,'amu*angstrom^2'), symmetry=1, barrier=(23.3531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01142,'amu*angstrom^2'), symmetry=1, barrier=(23.2545,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.878052,'amu*angstrom^2'), symmetry=1, barrier=(20.1882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.876358,'amu*angstrom^2'), symmetry=1, barrier=(20.1492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.876359,'amu*angstrom^2'), symmetry=1, barrier=(20.1492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.498231,0.0741883,-8.94647e-05,5.33543e-08,-1.23145e-11,18583.2,24.1393], Tmin=(100,'K'), Tmax=(1069.33,'K')), NASAPolynomial(coeffs=[16.5119,0.0142846,-5.43206e-06,9.62951e-10,-6.53964e-14,15158.5,-54.1903], Tmin=(1069.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])C=CCF(11942)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u1 p2 c0 {6,S}
3  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.762158,'amu*angstrom^2'), symmetry=1, barrier=(17.5235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.75925,'amu*angstrom^2'), symmetry=1, barrier=(17.4566,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.920976,0.065334,-7.11935e-05,3.98453e-08,-8.79313e-12,6535.88,23.6495], Tmin=(100,'K'), Tmax=(1107.13,'K')), NASAPolynomial(coeffs=[13.9988,0.0180847,-7.17799e-06,1.29819e-09,-8.88883e-14,3640.09,-40.7745], Tmin=(1107.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.4033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07769,0.0332704,7.67011e-06,-2.55678e-08,9.06529e-12,-21033,18.6033], Tmin=(100,'K'), Tmax=(1212.02,'K')), NASAPolynomial(coeffs=[11.4603,0.0265617,-1.40475e-05,2.89055e-09,-2.10772e-13,-25089,-35.8164], Tmin=(1212.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + ring(Cyclobutene)"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.931881,0.052814,-1.09063e-05,-3.84329e-08,2.30782e-11,4530.45,18.1566], Tmin=(100,'K'), Tmax=(915.674,'K')), NASAPolynomial(coeffs=[20.1721,0.0074913,-9.93481e-08,-1.14396e-10,6.39036e-15,-616.599,-81.8363], Tmin=(915.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.6362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(C2CsJOC(O)) + radical(C=CCJCO)"""),
)

species(
    label = 'CC([O])=C=[C]CF(11945)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u1 p2 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.498358,'amu*angstrom^2'), symmetry=1, barrier=(11.4582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.499456,'amu*angstrom^2'), symmetry=1, barrier=(11.4835,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32616,0.0648177,-7.90178e-05,4.8162e-08,-8.40712e-12,11668.6,23.1456], Tmin=(100,'K'), Tmax=(621.699,'K')), NASAPolynomial(coeffs=[8.61773,0.0276532,-1.28721e-05,2.45604e-09,-1.70844e-13,10573.6,-10.0817], Tmin=(621.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.2645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(C=C(C)OJ) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C=[C]C=[C]CF(11900)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C([O])C#CCF(11938)'],
    products = ['C=C([O])C=[C]CF(11803)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(18)', 'O=[C]C=[C]CF(11943)'],
    products = ['C=C([O])C=[C]CF(11803)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C=C([O])C=[C]CF(11803)'],
    products = ['C=C1[CH][C](CF)O1(11944)'],
