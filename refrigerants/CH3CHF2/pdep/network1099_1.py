...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.235444,'amu*angstrom^2'), symmetry=1, barrier=(5.41333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235397,'amu*angstrom^2'), symmetry=1, barrier=(5.41223,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72322,0.0604478,-0.000108749,1.11357e-07,-4.32734e-11,-32124.4,20.0708], Tmin=(100,'K'), Tmax=(827.276,'K')), NASAPolynomial(coeffs=[2.32592,0.0339005,-1.77631e-05,3.50332e-09,-2.45003e-13,-31415.4,22.1652], Tmin=(827.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-267.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-167.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,190,488,555,1236,1407,3024.69,3035.63],'cm^-1')),
        HinderedRotor(inertia=(0.362896,'amu*angstrom^2'), symmetry=1, barrier=(8.3437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00339209,'amu*angstrom^2'), symmetry=1, barrier=(38.5139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67654,'amu*angstrom^2'), symmetry=1, barrier=(38.547,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0872,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.96627,0.0316571,-1.30367e-05,1.72125e-09,-2.46937e-14,-20191,15.0595], Tmin=(100,'K'), Tmax=(2811.46,'K')), NASAPolynomial(coeffs=[39.1928,-0.00690296,1.36942e-06,-2.32514e-10,1.90086e-14,-44566.7,-199.426], Tmin=(2811.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(RCCJC) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76005,0.038066,7.33511e-06,-3.35014e-08,1.43403e-11,-73896.3,20.1197], Tmin=(100,'K'), Tmax=(1029.17,'K')), NASAPolynomial(coeffs=[11.8761,0.0243613,-1.00206e-05,1.92256e-09,-1.38779e-13,-77335,-35.565], Tmin=(1029.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-615.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(Cs-CsHHH) + ring(Cs-Cs(F)(F)-O2s-Cs)"""),
)
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0059,0.0574816,-4.70794e-05,1.94182e-08,-3.18356e-12,-69901.8,25.9648], Tmin=(100,'K'), Tmax=(1461.82,'K')), NASAPolynomial(coeffs=[15.1348,0.0188209,-7.40926e-06,1.32665e-09,-8.95709e-14,-74032.6,-47.5634], Tmin=(1461.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-582.151,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFF)"""),
)
...
"""),
    E0 = (-467.216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,190,488,555,1236,1407,184.603,2652.78],'cm^-1')),
        HinderedRotor(inertia=(0.380575,'amu*angstrom^2'), symmetry=1, barrier=(9.17329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.383821,'amu*angstrom^2'), symmetry=1, barrier=(9.17298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.380409,'amu*angstrom^2'), symmetry=1, barrier=(9.17151,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14429,0.0700494,-0.000108433,9.72421e-08,-3.45935e-11,-56097.3,22.8709], Tmin=(100,'K'), Tmax=(824.841,'K')), NASAPolynomial(coeffs=[6.29068,0.0320334,-1.5552e-05,2.97772e-09,-2.05529e-13,-56502,1.72647], Tmin=(824.841,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-467.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27772,0.0635227,-6.90327e-05,4.24155e-08,-1.08751e-11,-39194.6,27.3294], Tmin=(100,'K'), Tmax=(931.329,'K')), NASAPolynomial(coeffs=[9.32261,0.0289705,-1.33829e-05,2.58019e-09,-1.8196e-13,-40693.1,-10.9103], Tmin=(931.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(CCJCO) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.971681,0.0715164,-8.92562e-05,6.37858e-08,-1.88702e-11,-38397.7,23.8027], Tmin=(100,'K'), Tmax=(816.165,'K')), NASAPolynomial(coeffs=[9.25815,0.0309066,-1.46245e-05,2.82734e-09,-1.98832e-13,-39750.4,-14.4918], Tmin=(816.165,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-320.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC[C](F)F(3004)'],
    products = ['CC([O])C[C](F)F(3034)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C[CH]C[C](F)F(3273)'],
    products = ['CC([O])C[C](F)F(3034)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(2927)', '[CH2]C(C)[O](1820)'],
    products = ['CC([O])C[C](F)F(3034)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'O=CC[C](F)F(2964)'],
    products = ['CC([O])C[C](F)F(3034)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(=O)C[C](F)F(3328)'],
    products = ['CC([O])C[C](F)F(3034)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'CC([O])C=C(F)F(3329)'],
    products = ['CC([O])C[C](F)F(3034)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C(C)[O](1820)'],
    products = ['CC([O])C[C](F)F(3034)'],
