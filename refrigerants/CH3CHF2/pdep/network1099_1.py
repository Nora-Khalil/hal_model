...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(395)', '[O]C[C](F)F(3183)'],
    products = ['C=[C]OC[C](F)F(3113)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3025)', '[CH2]O[C]=C(396)'],
    products = ['C=[C]OC[C](F)F(3113)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=[C]OC=C(F)F(3277)'],
    products = ['C=[C]OC[C](F)F(3113)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#COC[C](F)F(3278)'],
    products = ['C=[C]OC[C](F)F(3113)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]O[C]=C(396)'],
    products = ['C=[C]OC[C](F)F(3113)'],
