...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2927)', '[O]C([O])F(782)'],
    products = ['[O]C(F)O[C](F)F(4696)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)F(3152)'],
    products = ['[O]C(F)O[C](F)F(4696)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=CO[C](F)F(4657)'],
    products = ['[O]C(F)O[C](F)F(4696)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)O[C](F)F(4859)'],
    products = ['[O]C(F)O[C](F)F(4696)'],
    transitionState = 'TS9',
