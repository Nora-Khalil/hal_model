...
"""),
    E0 = (-186.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,239,401,1367,322.482,2881.06],'cm^-1')),
        HinderedRotor(inertia=(0.160032,'amu*angstrom^2'), symmetry=1, barrier=(11.7968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159898,'amu*angstrom^2'), symmetry=1, barrier=(11.7966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.899087,'amu*angstrom^2'), symmetry=1, barrier=(66.376,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46666,0.0594032,-6.14071e-05,3.8579e-08,-1.04457e-11,-22312.5,21.4913], Tmin=(100,'K'), Tmax=(873.574,'K')), NASAPolynomial(coeffs=[7.43919,0.0320569,-1.44534e-05,2.74797e-09,-1.92058e-13,-23356,-6.51571], Tmin=(873.574,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-186.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(CtCF)"""),
)
...
"""),
    E0 = (-157.216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([233,378,609,1068,1270,1314,3037,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,239,401,1367,1864.35],'cm^-1')),
        HinderedRotor(inertia=(0.508466,'amu*angstrom^2'), symmetry=1, barrier=(11.6906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07447,'amu*angstrom^2'), symmetry=1, barrier=(24.7041,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.84125,0.0133653,0.000152981,-5.10714e-07,5.13935e-10,-18910.1,10.6966], Tmin=(10,'K'), Tmax=(332.801,'K')), NASAPolynomial(coeffs=[3.71367,0.0334881,-2.15022e-05,6.64856e-09,-7.8933e-13,-19004.6,9.62513], Tmin=(332.801,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-157.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), label="""CC(F)C#CF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (220.482,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2175,525,239,401,1367,1387.22,1387.23],'cm^-1')),
        HinderedRotor(inertia=(0.168582,'amu*angstrom^2'), symmetry=1, barrier=(3.87604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168394,'amu*angstrom^2'), symmetry=1, barrier=(3.87172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168448,'amu*angstrom^2'), symmetry=1, barrier=(3.87295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04786,0.0466888,-5.20243e-05,4.29678e-08,-1.53349e-11,26584.5,22.2309], Tmin=(100,'K'), Tmax=(827.063,'K')), NASAPolynomial(coeffs=[3.61754,0.0324187,-1.4031e-05,2.57928e-09,-1.75229e-13,26553.3,16.337], Tmin=(827.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(CtCF) + radical(RCCJC)"""),
)

species(
    label = '[C]#CCC(C)F(10351)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (250.661,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,270.332,270.34],'cm^-1')),
        HinderedRotor(inertia=(0.137977,'amu*angstrom^2'), symmetry=1, barrier=(7.15585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137985,'amu*angstrom^2'), symmetry=1, barrier=(7.15588,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6876,0.0539784,-5.31403e-05,2.48636e-08,-1.47921e-12,30228.1,19.1317], Tmin=(100,'K'), Tmax=(675.253,'K')), NASAPolynomial(coeffs=[7.95051,0.0257342,-1.00703e-05,1.76248e-09,-1.16804e-13,29180.4,-10.1189], Tmin=(675.253,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(250.661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    E0 = (4.22572,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,2175,525,239,401,1367,180,1271.43],'cm^-1')),
        HinderedRotor(inertia=(0.202724,'amu*angstrom^2'), symmetry=1, barrier=(4.66102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202565,'amu*angstrom^2'), symmetry=1, barrier=(4.65737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202689,'amu*angstrom^2'), symmetry=1, barrier=(4.66023,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3268,0.0658335,-9.9111e-05,8.91562e-08,-3.18113e-11,597.704,23.99], Tmin=(100,'K'), Tmax=(837.829,'K')), NASAPolynomial(coeffs=[5.3114,0.0329748,-1.55131e-05,2.92714e-09,-2.00292e-13,415.606,8.3695], Tmin=(837.829,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.22572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(CtCF) + radical(CsCsCsF1s)"""),
)
...
"""),
    E0 = (-42.0806,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,540,610,2055,137,207,812,180],'cm^-1')),
        HinderedRotor(inertia=(0.174684,'amu*angstrom^2'), symmetry=1, barrier=(4.01632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477176,'amu*angstrom^2'), symmetry=1, barrier=(10.9712,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61393,0.057381,-6.22505e-05,4.10836e-08,-1.18125e-11,-4979.51,21.3646], Tmin=(100,'K'), Tmax=(820.202,'K')), NASAPolynomial(coeffs=[6.862,0.0317872,-1.54442e-05,3.0393e-09,-2.16549e-13,-5840.41,-2.9141], Tmin=(820.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.0806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cdj(Cdd-Cd)(F1s))"""),
)

species(
    label = '[CH2]C(F)CC#CF(7584)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    E0 = (20.4827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2175,525,239,401,1367,318.564,1848.52],'cm^-1')),
        HinderedRotor(inertia=(0.100141,'amu*angstrom^2'), symmetry=1, barrier=(7.21136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100143,'amu*angstrom^2'), symmetry=1, barrier=(7.21137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844714,'amu*angstrom^2'), symmetry=1, barrier=(60.8312,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22537,0.0655567,-8.87982e-05,7.16513e-08,-2.37929e-11,2559.1,23.7517], Tmin=(100,'K'), Tmax=(793.323,'K')), NASAPolynomial(coeffs=[7.66194,0.0294247,-1.35257e-05,2.55179e-09,-1.75794e-13,1653.59,-5.08133], Tmin=(793.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.4827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(CtCF) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[C]=C(F)CC(C)F(10354)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
4  C u0 p0 c0 {3,S} {6,S} {9,S} {10,S}
...
"""),
    E0 = (-96.9155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.996481,'amu*angstrom^2'), symmetry=1, barrier=(22.9111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0023,'amu*angstrom^2'), symmetry=1, barrier=(23.0448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.995274,'amu*angstrom^2'), symmetry=1, barrier=(22.8833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03715,0.0705823,-8.33772e-05,5.57174e-08,-1.5547e-11,-11554.3,21.0294], Tmin=(100,'K'), Tmax=(858.658,'K')), NASAPolynomial(coeffs=[9.36895,0.0317686,-1.55721e-05,3.07226e-09,-2.19076e-13,-12985.1,-17.8969], Tmin=(858.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.9155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCCF) + group(CdJ2_singlet-Cds)"""),
)
...
"""),
    E0 = (134.916,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2175,525,239,401,1367,408.157],'cm^-1')),
        HinderedRotor(inertia=(0.745651,'amu*angstrom^2'), symmetry=1, barrier=(17.144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.833011,'amu*angstrom^2'), symmetry=1, barrier=(19.1526,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93011,0.0412125,-2.71671e-05,8.58411e-09,-1.08501e-12,16304.6,18.4616], Tmin=(100,'K'), Tmax=(1814.97,'K')), NASAPolynomial(coeffs=[12.701,0.0174741,-7.54779e-06,1.37744e-09,-9.23133e-14,12394.9,-39.9215], Tmin=(1814.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)CC#CF(7456)'],
    products = ['CH2CHF(56)', 'C=C=CF(6101)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(9.69999e+11,'s^-1'), n=0, Ea=(206.392,'kJ/mol'), T0=(1,'K'), Tmin=(500,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R!H->C_2R!H->C_N-5R!H->O_Ext-5C-R',), comment="""Estimated from node Root_1R!H->C_2R!H->C_N-5R!H->O_Ext-5C-R
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'F[C]CC#CF(9057)'],
    products = ['CC(F)CC#CF(7456)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C[C]F(124)', 'CC#CF(4285)'],
    products = ['CC(F)CC#CF(7456)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.00162e-06,'m^3/(mol*s)'), n=3.38172, Ea=(56.3178,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)
...
reaction(
    ...
    products = ['CC(F)CC#CF(7456)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5.7066e-06,'m^3/(mol*s)'), n=3.19155, Ea=(223.032,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'CC(F)C#CF(10349)'],
    products = ['CC(F)CC#CF(7456)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(148.817,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C[CH]CC#CF(10350)'],
    products = ['CC(F)CC#CF(7456)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[C]#CCC(C)F(10351)'],
    products = ['CC(F)CC#CF(7456)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3-CHF(63)', '[CH2]C#CF(7360)'],
    products = ['CC(F)CC#CF(7456)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(6.89148,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'FC#CC[CH]F(3999)'],
    products = ['CC(F)CC#CF(7456)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C[C](F)CC#CF(10352)'],
    products = ['CC(F)CC#CF(7456)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[C]#CF(3939)', '[CH2]C(C)F(185)'],
    products = ['CC(F)CC#CF(7456)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'CC(F)C=C=[C]F(10353)'],
    products = ['CC(F)CC#CF(7456)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2.88633e+07,'m^3/(mol*s)'), n=0.213913, Ea=(3.55798,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=8.197906922440378e-05, var=0.01210657880115639, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(F)CC#CF(7584)'],
    products = ['CC(F)CC#CF(7456)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC=CC#CF(10355)'],
    products = ['CC(F)CC#CF(7456)'],
