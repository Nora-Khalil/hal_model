...
"""),
    E0 = (-162.425,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.196678,'amu*angstrom^2'), symmetry=1, barrier=(4.52202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196819,'amu*angstrom^2'), symmetry=1, barrier=(4.52525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196533,'amu*angstrom^2'), symmetry=1, barrier=(4.51868,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.0855,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.51116,0.0469014,-9.60786e-05,1.74803e-07,-1.24123e-10,-19535,10.0073], Tmin=(10,'K'), Tmax=(469.275,'K')), NASAPolynomial(coeffs=[2.98198,0.0375266,-2.17291e-05,6.1271e-09,-6.7313e-13,-19332.5,13.7889], Tmin=(469.275,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-162.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), label="""CCCOF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-50.3873,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,553.577,4000],'cm^-1')),
        HinderedRotor(inertia=(0.953817,'amu*angstrom^2'), symmetry=1, barrier=(21.9301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.537924,'amu*angstrom^2'), symmetry=1, barrier=(12.3679,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (59.0871,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48999,0.0272742,1.66448e-06,-1.66151e-08,7.01472e-12,-6000.76,15.8164], Tmin=(100,'K'), Tmax=(1050.44,'K')), NASAPolynomial(coeffs=[7.46145,0.0213307,-8.39404e-06,1.53868e-09,-1.07023e-13,-7761.73,-11.8233], Tmin=(1050.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.3873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""npropoxy""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.162698,'amu*angstrom^2'), symmetry=1, barrier=(3.74075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162703,'amu*angstrom^2'), symmetry=1, barrier=(3.74086,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['CCCOF(2644)'],
    products = ['HF(38)', 'CH2O(20)', 'C2H4(30)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(59.4705,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CCOF(493)'],
    products = ['CCCOF(2644)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000166864,'m^3/(mol*s)'), n=2.82973, Ea=(155.489,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OF(142)', 'C=CC(498)'],
    products = ['CCCOF(2644)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C[CH]COF(500)'],
    products = ['CCCOF(2644)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.88633e+07,'m^3/(mol*s)'), n=0.213913, Ea=(0.161452,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=8.197906922440378e-05, var=0.01210657880115639, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'CC[CH]OF(2754)'],
    products = ['CCCOF(2644)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'CCC=O(986)'],
    products = ['CCCOF(2644)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(454.93,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)
