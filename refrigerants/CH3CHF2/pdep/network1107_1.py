...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[O](3042)'],
    products = ['O=O(143)', 'CH2CF2(57)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(2943)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)O[O](3042)'],
    transitionState = 'TS4',
