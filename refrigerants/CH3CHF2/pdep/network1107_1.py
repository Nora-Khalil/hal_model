...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3025)', '[CH2]C[CH2](937)'],
    products = ['[CH2]CC[C](F)F(3121)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C[C](F)F(3149)'],
    products = ['[CH2]CC[C](F)F(3121)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CF2(57)', '[CH2][CH2](612)'],
    products = ['[CH2]CC[C](F)F(3121)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]CC=C(F)F(3334)'],
    products = ['[CH2]CC[C](F)F(3121)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C](F)F(3068)', 'C2H4(30)'],
    products = ['[CH2]CC[C](F)F(3121)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C](F)F(3068)', '[CH2][CH2](612)'],
    products = ['[CH2]CC[C](F)F(3121)'],
