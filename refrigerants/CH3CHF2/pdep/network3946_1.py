...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3532.32,'J/mol'), sigma=(5.63718,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=551.74 K, Pc=44.74 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CO[C]=O(684)'],
    products = ['[CH]=C(CF)O[C]=O(8044)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)O[C]=O(3945)'],
    products = ['[CH]=C(CF)O[C]=O(8044)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(128)', '[CH]=C([O])CF(2587)'],
    products = ['[CH]=C(CF)O[C]=O(8044)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH]=C([O])CF(2587)'],
    products = ['[CH]=C(CF)O[C]=O(8044)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2F(46)', 'C#CO[C]=O(720)'],
    products = ['[CH]=C(CF)O[C]=O(8044)'],
    transitionState = 'TS9',
