...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', 'F[C]C=CF(4149)'],
    products = ['C=[C]C(F)C=[C]F(10788)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C=CC=[C]F(6687)'],
    products = ['C=[C]C(F)C=[C]F(10788)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=C=C(F)C=[C]F(10851)'],
    products = ['C=[C]C(F)C=[C]F(10788)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=[C]C(F)C#CF(10852)'],
    products = ['C=[C]C(F)C=[C]F(10788)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C#CC(F)C=[C]F(10853)'],
    products = ['C=[C]C(F)C=[C]F(10788)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'C=[C]C=C=[C]F(10854)'],
    products = ['C=[C]C(F)C=[C]F(10788)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=[C]C(F)C=[C]F(10788)'],
    products = ['[CH2]C=C(F)C=[C]F(10855)'],
