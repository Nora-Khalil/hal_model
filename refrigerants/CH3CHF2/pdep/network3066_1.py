...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97685,0.016713,1.6256e-05,-2.58231e-08,8.953e-12,25426.5,24.5299], Tmin=(100,'K'), Tmax=(1095.36,'K')), NASAPolynomial(coeffs=[5.99012,0.0203852,-8.87011e-06,1.70127e-09,-1.20793e-13,23885.9,5.6993], Tmin=(1095.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.061,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CdCFO) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + ring(Cyclopentane)"""),
)

species(
    label = 'FC1=C[OH+][C-]=C1(8877)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.93855,0.0202411,3.07295e-07,-8.47035e-09,2.86723e-12,28386.3,13.6831], Tmin=(100,'K'), Tmax=(1324.2,'K')), NASAPolynomial(coeffs=[6.95932,0.0180574,-8.50344e-06,1.64654e-09,-1.1533e-13,26448.1,-10.1417], Tmin=(1324.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CdCCF) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + ring(Cyclopentane)"""),
)

species(
    label = '[OH2+][C-]=C1C=C1F(8878)',
    structure = adjacencyList("""1 F u0 p3 c0 {4,S}
...
"""),
    E0 = (485.969,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,280,518,736,852,873,2950,1000,180,180,180,180,536.123,4000,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.520128,'amu*angstrom^2'), symmetry=1, barrier=(11.9588,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54676,0.0641396,-0.000125801,1.23347e-07,-4.53681e-11,58527.1,18.5955], Tmin=(100,'K'), Tmax=(841.618,'K')), NASAPolynomial(coeffs=[5.52864,0.0230074,-1.2912e-05,2.5731e-09,-1.79445e-13,58643.4,4.74438], Tmin=(841.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(485.969,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cds-CdsCsCs) + group(CdCCF) + group(Cds-Cds(Cds-Cds)H) + group(CsJ2_singlet-CsH) + ring(methylenecyclopropene)"""),
)
...
"""),
    ...
    molecularWeight = (66.0579,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01008,0.0570757,-0.000123916,1.25465e-07,-4.51786e-11,117975,14.7153], Tmin=(100,'K'), Tmax=(910.833,'K')), NASAPolynomial(coeffs=[2.35319,0.021898,-1.05334e-05,1.89073e-09,-1.20869e-13,119309,20.7592], Tmin=(910.833,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(980.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Ct-CtCs) + group(Ct-CtCs) + group(CsJ2_singlet-CsH) + ring(Cyclopropyne)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[OH2+][C-]=C1C=C1F(8878)'],
    products = ['[OH+]=[C-]C1C=C1F(8597)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', '[OH+]=[C-]C1C#C1(8880)'],
    products = ['[OH+]=[C-]C1C=C1F(8597)'],
    transitionState = 'TS8',
