...
"""),
    E0 = (-377.194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435],'cm^-1')),
        HinderedRotor(inertia=(0.129407,'amu*angstrom^2'), symmetry=1, barrier=(2.97533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129497,'amu*angstrom^2'), symmetry=1, barrier=(2.97738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129559,'amu*angstrom^2'), symmetry=1, barrier=(2.97882,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0321,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26015,0.0479939,-9.57252e-05,9.81019e-08,-3.68808e-11,-45312.7,18.7632], Tmin=(100,'K'), Tmax=(865.061,'K')), NASAPolynomial(coeffs=[2.5734,0.0231349,-1.2027e-05,2.31557e-09,-1.58019e-13,-44490.9,22.3602], Tmin=(865.061,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-377.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-OsOsOsH) + radical(ROOJ)"""),
)
...
"""),
    E0 = (-149.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,492.5,1135,1000,1380,1390,370,380,2900,435,2510.22],'cm^-1')),
...
"""),
    E0 = (-301.801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,1540.49],'cm^-1')),
        HinderedRotor(inertia=(0.0970919,'amu*angstrom^2'), symmetry=1, barrier=(2.23233,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0972056,'amu*angstrom^2'), symmetry=1, barrier=(2.23495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0978003,'amu*angstrom^2'), symmetry=1, barrier=(2.24862,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0321,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.54501,0.0488618,-0.000116208,1.39694e-07,-5.83906e-11,-36262.2,18.1454], Tmin=(100,'K'), Tmax=(846.134,'K')), NASAPolynomial(coeffs=[-4.84875,0.0398935,-2.2447e-05,4.47238e-09,-3.12073e-13,-33438.7,61.8715], Tmin=(846.134,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-301.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-OsOsOsH) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(O)O(8205)'],
    products = ['HO2(11)', 'O=CO(1075)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(O)O(7918)'],
    products = ['[O]OC(O)O(8205)'],
    transitionState = 'TS2',
