...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'O=C=C(F)OF(2753)'],
    products = ['O=C(O)C(F)OF(2728)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(O)[CH]OF(2375)'],
    products = ['O=C(O)C(F)OF(2728)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(=O)O(2759)'],
    products = ['O=C(O)C(F)OF(2728)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'O=[C]C(F)OF(2081)'],
    products = ['O=C(O)C(F)OF(2728)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(F)OF(2760)'],
    products = ['O=C(O)C(F)OF(2728)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(615)', 'O=[C]O(165)'],
    products = ['O=C(O)C(F)OF(2728)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)[C](F)OF(2761)'],
    products = ['O=C(O)C(F)OF(2728)'],
