...
"""),
    E0 = (-732.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,250,417,511,1155,1315,1456,3119,223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,180,180,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.211094,'amu*angstrom^2'), symmetry=1, barrier=(4.85346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65849,'amu*angstrom^2'), symmetry=1, barrier=(38.1321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6586,'amu*angstrom^2'), symmetry=1, barrier=(38.1345,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147916,0.0947098,-0.000160932,1.45781e-07,-5.17029e-11,-88003.4,28.3642], Tmin=(100,'K'), Tmax=(811.425,'K')), NASAPolynomial(coeffs=[9.21707,0.0336899,-1.7975e-05,3.55179e-09,-2.48703e-13,-88938.1,-10.185], Tmin=(811.425,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-732.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + radical(CCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.287489,0.0912026,-0.000153015,1.38349e-07,-4.90849e-11,-88633.6,28.3041], Tmin=(100,'K'), Tmax=(812.034,'K')), NASAPolynomial(coeffs=[8.79116,0.0336341,-1.77089e-05,3.4852e-09,-2.43649e-13,-89497.7,-7.76744], Tmin=(812.034,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-737.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.326827,'amu*angstrom^2'), symmetry=1, barrier=(7.5144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.325824,'amu*angstrom^2'), symmetry=1, barrier=(7.49133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.012877,'amu*angstrom^2'), symmetry=1, barrier=(45.8667,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.544986,0.0892995,-0.000166977,1.61097e-07,-5.8756e-11,-37020.4,27.4363], Tmin=(100,'K'), Tmax=(846.092,'K')), NASAPolynomial(coeffs=[5.97052,0.0346264,-1.85953e-05,3.63927e-09,-2.51576e-13,-36899.6,8.30713], Tmin=(846.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-308.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]CC(F)C([O])(F)F(10403)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-607.315,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,180,180,2109.78],'cm^-1')),
        HinderedRotor(inertia=(0.264693,'amu*angstrom^2'), symmetry=1, barrier=(6.0858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264696,'amu*angstrom^2'), symmetry=1, barrier=(6.08589,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.858762,0.0781111,-0.000132071,1.21808e-07,-4.3809e-11,-72938.7,26.2311], Tmin=(100,'K'), Tmax=(822.657,'K')), NASAPolynomial(coeffs=[7.00761,0.0314212,-1.63205e-05,3.19227e-09,-2.2222e-13,-73382.2,1.22045], Tmin=(822.657,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-607.315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CCOJ) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.164998,'amu*angstrom^2'), symmetry=1, barrier=(3.79364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164968,'amu*angstrom^2'), symmetry=1, barrier=(3.79293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65966,0.060259,-0.000102255,1.00984e-07,-3.87047e-11,-69341.1,22.7582], Tmin=(100,'K'), Tmax=(817.273,'K')), NASAPolynomial(coeffs=[3.46264,0.0326409,-1.70718e-05,3.36079e-09,-2.35213e-13,-69008.1,18.2636], Tmin=(817.273,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-577.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsOsHH) + group(COCsFO) + radical(CCOJ)"""),
)

species(
    label = '[O]CC=C(F)OF(10407)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-157.499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,326,540,652,719,1357,180,1740.95,1741.2],'cm^-1')),
        HinderedRotor(inertia=(0.235508,'amu*angstrom^2'), symmetry=1, barrier=(5.4148,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235211,'amu*angstrom^2'), symmetry=1, barrier=(5.40796,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69722,0.0621422,-0.000113959,1.17557e-07,-4.55412e-11,-18871,23.7782], Tmin=(100,'K'), Tmax=(840.551,'K')), NASAPolynomial(coeffs=[1.52213,0.0358718,-1.87107e-05,3.6505e-09,-2.53021e-13,-17884.1,30.288], Tmin=(840.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFO) + radical(CCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.220598,0.089654,-0.000129172,9.63611e-08,-2.86914e-11,-94055.1,28.8946], Tmin=(100,'K'), Tmax=(821.024,'K')), NASAPolynomial(coeffs=[13.167,0.0265796,-1.39361e-05,2.79031e-09,-1.99357e-13,-96181,-31.0114], Tmin=(821.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-783.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + radical(Csj(Cs-F1sCsH)(O2s-H)(H))"""),
)

species(
    label = 'OC[C](F)C(F)(F)OF(10409)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-768.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,253,525,597,667,842,1178,1324,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.242132,'amu*angstrom^2'), symmetry=1, barrier=(5.56709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24201,'amu*angstrom^2'), symmetry=1, barrier=(5.56429,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24197,'amu*angstrom^2'), symmetry=1, barrier=(5.56337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.882928,'amu*angstrom^2'), symmetry=1, barrier=(20.3003,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.1478,0.101226,-0.000175853,1.5569e-07,-5.3279e-11,-92230,30.5762], Tmin=(100,'K'), Tmax=(833.802,'K')), NASAPolynomial(coeffs=[11.4221,0.0288322,-1.5233e-05,2.97241e-09,-2.05647e-13,-93572.3,-19.6183], Tmin=(833.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-768.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + radical(CsCsCsF1s)"""),
)

species(
    label = '[O]C(F)(F)C(F)COF(10410)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-698.512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,194.965,195.521,195.831],'cm^-1')),
        HinderedRotor(inertia=(0.204553,'amu*angstrom^2'), symmetry=1, barrier=(5.55729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205567,'amu*angstrom^2'), symmetry=1, barrier=(5.56661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.653102,'amu*angstrom^2'), symmetry=1, barrier=(17.6671,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.134945,0.0917124,-0.000140426,1.12511e-07,-3.59028e-11,-83878.7,28.1496], Tmin=(100,'K'), Tmax=(768.517,'K')), NASAPolynomial(coeffs=[12.5893,0.026887,-1.38936e-05,2.74324e-09,-1.93493e-13,-85792.9,-28.6556], Tmin=(768.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-698.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(O2sj(Cs-CsF1sF1s))"""),
)

species(
    label = 'FOC[CH]C(F)(F)OF(10411)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-431.677,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,253,525,597,667,842,1178,1324,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,310.976,310.976,310.976,310.977],'cm^-1')),
        HinderedRotor(inertia=(0.00174319,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134519,'amu*angstrom^2'), symmetry=1, barrier=(9.23137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134519,'amu*angstrom^2'), symmetry=1, barrier=(9.23137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.457542,'amu*angstrom^2'), symmetry=1, barrier=(31.3986,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.222391,0.0894794,-0.000128477,9.49371e-08,-2.79465e-11,-51788.4,29.5579], Tmin=(100,'K'), Tmax=(830.695,'K')), NASAPolynomial(coeffs=[13.439,0.0258403,-1.35665e-05,2.72029e-09,-1.94599e-13,-53984.3,-31.7535], Tmin=(830.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-431.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-CsCsHH) + group(CsCFFO) + group(Cs-CsOsHH) + radical(CCJCO)"""),
)

species(
    label = 'FOCC(F)[C](F)OF(10412)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-399.93,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,259,529,569,1128,1321,1390,3140,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,196.602,198.942,201.852,205.008],'cm^-1')),
        HinderedRotor(inertia=(0.252778,'amu*angstrom^2'), symmetry=1, barrier=(7.13372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22093,'amu*angstrom^2'), symmetry=1, barrier=(7.18329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36814,'amu*angstrom^2'), symmetry=1, barrier=(39.927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.535514,'amu*angstrom^2'), symmetry=1, barrier=(16.3679,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.277566,0.104201,-0.000180577,1.59734e-07,-5.48059e-11,-47956.2,29.7005], Tmin=(100,'K'), Tmax=(825.127,'K')), NASAPolynomial(coeffs=[11.7898,0.0296602,-1.59072e-05,3.12642e-09,-2.17418e-13,-49401.5,-22.8887], Tmin=(825.127,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-399.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC(F)C(F)(F)OF(10396)'],
    products = ['HF(38)', 'CF2O(49)', 'O=C[CH]F(338)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(20.1038,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH3O(27)', 'F[C]C(F)(F)OF(4797)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.00162e-06,'m^3/(mol*s)'), n=3.38172, Ea=(52.2904,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s
...
reaction(
    ...
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(208.353,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['[O]CC(F)C(F)(F)OF(10396)'],
    products = ['[O]CC(OF)C(F)(F)F(10400)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(142)', '[O]CC(F)=C(F)F(9729)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(499)', '[O]CC=C(F)F(3144)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O(6)', '[CH2]C(F)C(F)(F)OF(4806)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C[CH]C(F)(F)OF(4973)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]CC(F)[C](F)OF(10402)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(F)C([O])(F)F(10403)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', '[O]CC(F)[C](F)F(10404)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(4688)', '[O]C[CH]F(140)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][O](132)', 'F[CH]C(F)(F)OF(4804)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C[C](F)C(F)(F)OF(9731)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O][CH]C(F)C(F)(F)OF(10405)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', '[O]CC(F)C(=O)F(10406)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', '[O]CC=C(F)OF(10407)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(4.22285,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(175.537,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction22',
    reactants = ['HF(38)', '[O]C=CC(F)(F)OF(4976)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(312.865,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction23',
    reactants = ['[O]CC(F)C(F)(F)OF(10396)'],
    products = ['O[CH]C(F)C(F)(F)OF(10408)'],
...
reaction(
    label = 'reaction24',
    reactants = ['OC[C](F)C(F)(F)OF(10409)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(F)C(F)COF(10410)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
...
reaction(
    label = 'reaction26',
    reactants = ['FOC[CH]C(F)(F)OF(10411)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(105.23,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction27',
    reactants = ['FOCC(F)[C](F)OF(10412)'],
    products = ['[O]CC(F)C(F)(F)OF(10396)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(71.4213,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #3558',
    isomers = [
        '[O]CC(F)C(F)(F)OF(10396)',
    ],
    reactants = [
