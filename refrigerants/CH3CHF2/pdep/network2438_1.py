...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(=C)[O](540)'],
    products = ['[CH]=C(C)C(=C)[O](6338)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]=O(136)', 'C#CC(5436)'],
    products = ['[CH]=C(C)C(=C)[O](6338)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CO(28)', '[CH]=[C]C(5437)'],
    products = ['[CH]=C(C)C(=C)[O](6338)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]=O(136)', '[CH]=[C]C(5437)'],
    products = ['[CH]=C(C)C(=C)[O](6338)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', '[CH]C(C)=C=O(6516)'],
    products = ['[CH]=C(C)C(=C)[O](6338)'],
