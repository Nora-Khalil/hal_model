...
reaction(
    label = 'reaction2',
    reactants = ['[O]C=C([O])OF(1459)'],
    products = ['[O]C(=O)C([O])F(1413)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C(=O)F(1464)'],
    products = ['[O]C(=O)C([O])F(1413)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O][C]=O(293)', '[O][CH]F(516)'],
    products = ['[O]C(=O)C([O])F(1413)'],
