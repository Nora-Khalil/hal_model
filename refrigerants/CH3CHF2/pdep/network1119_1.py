...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3025)', '[CH2]O[O](335)'],
    products = ['[O]OC[C](F)F(3122)'],
    transitionState = 'TS3',
