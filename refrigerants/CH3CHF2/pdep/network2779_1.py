...
"""),
    E0 = (-164.689,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,1856.3,1857.37],'cm^-1')),
        HinderedRotor(inertia=(0.140286,'amu*angstrom^2'), symmetry=1, barrier=(3.22546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00131309,'amu*angstrom^2'), symmetry=1, barrier=(3.20772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139965,'amu*angstrom^2'), symmetry=1, barrier=(3.21806,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59222,0.0475679,-0.000109364,1.33119e-07,-5.6195e-11,-19772.9,19.3417], Tmin=(100,'K'), Tmax=(846.694,'K')), NASAPolynomial(coeffs=[-5.5454,0.0424857,-2.32487e-05,4.59914e-09,-3.20133e-13,-16834.7,66.4602], Tmin=(846.694,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-164.689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (-147.314,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2147.71,2148.78,2148.94],'cm^-1')),
        HinderedRotor(inertia=(0.133515,'amu*angstrom^2'), symmetry=1, barrier=(3.06978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133199,'amu*angstrom^2'), symmetry=1, barrier=(3.0625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133507,'amu*angstrom^2'), symmetry=1, barrier=(3.06959,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72935,0.0468922,-0.000115048,1.44493e-07,-6.16245e-11,-17690.3,18.7469], Tmin=(100,'K'), Tmax=(851.474,'K')), NASAPolynomial(coeffs=[-7.7796,0.0460899,-2.52512e-05,4.98585e-09,-3.4619e-13,-14082,78.4365], Tmin=(851.474,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(Cs_P)"""),
)
...
"""),
    E0 = (-125.162,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1792.14,1794.82,1795.76,1796.28],'cm^-1')),
        HinderedRotor(inertia=(0.221605,'amu*angstrom^2'), symmetry=1, barrier=(5.09515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00223061,'amu*angstrom^2'), symmetry=1, barrier=(5.10359,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.24597,0.0433613,-0.000129434,1.82476e-07,-8.2037e-11,-15052.4,15.9826], Tmin=(100,'K'), Tmax=(849.665,'K')), NASAPolynomial(coeffs=[-16.6547,0.0636071,-3.55224e-05,7.06232e-09,-4.92222e-13,-9019.6,124.35], Tmin=(849.665,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C([O])O(6999)'],
    products = ['[CH2]OC([O])O(7115)'],
    transitionState = 'TS2',
