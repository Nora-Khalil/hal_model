...
"""),
    E0 = (-47.4856,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,580,1155,1237,1373,3147,220.214,220.237,220.25],'cm^-1')),
        HinderedRotor(inertia=(0.00347445,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.622753,'amu*angstrom^2'), symmetry=1, barrier=(21.4211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.622237,'amu*angstrom^2'), symmetry=1, barrier=(21.4206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.756168,0.0582529,-5.81305e-05,2.81273e-08,-5.14482e-12,-5583.23,22.8571], Tmin=(100,'K'), Tmax=(1496.84,'K')), NASAPolynomial(coeffs=[17.092,0.00829387,-1.74779e-06,2.01395e-10,-1.0694e-14,-9767.33,-60.1834], Tmin=(1496.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.4856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFHHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(Csj(F1s)(O2s-Cd)(H))"""),
)
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13099,0.0445282,-4.05226e-05,2.22107e-08,-5.41064e-12,6727.55,19.1353], Tmin=(100,'K'), Tmax=(944.398,'K')), NASAPolynomial(coeffs=[6.2988,0.0268753,-1.24841e-05,2.41781e-09,-1.71055e-13,5940.34,-0.73354], Tmin=(944.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.4004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsFHHO) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (40.6939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,580,1155,1237,1373,3147,3120,650,792.5,1650,196.662,196.891],'cm^-1')),
        HinderedRotor(inertia=(0.55678,'amu*angstrom^2'), symmetry=1, barrier=(15.4661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551892,'amu*angstrom^2'), symmetry=1, barrier=(15.457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.558736,'amu*angstrom^2'), symmetry=1, barrier=(15.4633,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
