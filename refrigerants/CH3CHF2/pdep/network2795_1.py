...
"""),
    E0 = (-487.056,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,1361.97],'cm^-1')),
        HinderedRotor(inertia=(0.236906,'amu*angstrom^2'), symmetry=1, barrier=(5.44694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236836,'amu*angstrom^2'), symmetry=1, barrier=(5.44531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237,'amu*angstrom^2'), symmetry=1, barrier=(5.44909,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.342293,'amu*angstrom^2'), symmetry=1, barrier=(7.87,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342123,'amu*angstrom^2'), symmetry=1, barrier=(7.86609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.982664,'amu*angstrom^2'), symmetry=1, barrier=(22.5934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.888293,0.0735075,-0.000107332,8.37571e-08,-2.61876e-11,-56454.4,23.6867], Tmin=(100,'K'), Tmax=(782.752,'K')), NASAPolynomial(coeffs=[10.6542,0.0235955,-1.16726e-05,2.27373e-09,-1.59541e-13,-57983.1,-21.0349], Tmin=(782.752,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-470.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80963,0.0392481,-1.14272e-05,-1.207e-08,6.65948e-12,-86629.6,20.5687], Tmin=(100,'K'), Tmax=(1081.59,'K')), NASAPolynomial(coeffs=[12.2875,0.0187628,-8.3475e-06,1.64487e-09,-1.19471e-13,-89964.5,-35.7413], Tmin=(1081.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-720.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Cs-O2s-Cs-Cs(F)(F))"""),
)

species(
    label = 'CC(F)(F)C(=O)O(163)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85657,0.05024,-4.37186e-05,2.01621e-08,-3.94004e-12,-104599,19.3669], Tmin=(100,'K'), Tmax=(1175.08,'K')), NASAPolynomial(coeffs=[9.03313,0.025811,-1.25352e-05,2.47075e-09,-1.76232e-13,-106285,-16.4138], Tmin=(1175.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-870.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.647582,0.0791687,-0.000125327,1.02495e-07,-3.30789e-11,-60924.3,26.5418], Tmin=(100,'K'), Tmax=(784.878,'K')), NASAPolynomial(coeffs=[11.7151,0.020941,-1.05612e-05,2.05318e-09,-1.42977e-13,-62605.5,-23.8138], Tmin=(784.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-507.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'CC(F)(F)[C]([O])O(7155)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {7,S} {11,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04747,0.0744487,-0.000129032,1.2185e-07,-4.45431e-11,-59302.4,25.0203], Tmin=(100,'K'), Tmax=(825.485,'K')), NASAPolynomial(coeffs=[6.03371,0.0313987,-1.64828e-05,3.23568e-09,-2.25511e-13,-59482.1,5.81894], Tmin=(825.485,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-493.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'CC(F)(F)C([O])[O](7156)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34967,0.0712691,-0.000132103,1.36599e-07,-5.32078e-11,-56856.1,23.4131], Tmin=(100,'K'), Tmax=(831.699,'K')), NASAPolynomial(coeffs=[1.54952,0.0401073,-2.14341e-05,4.22915e-09,-2.9521e-13,-55844.8,28.7653], Tmin=(831.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-473.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2][C](F)C(O)OF(7158)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {11,S}
...
"""),
    E0 = (-161.153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,212,367,445,1450,3000,3100,440,815,1455,1000,194.039,2069.43],'cm^-1')),
        HinderedRotor(inertia=(0.0044747,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328786,'amu*angstrom^2'), symmetry=1, barrier=(8.78665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328746,'amu*angstrom^2'), symmetry=1, barrier=(8.78673,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.990456,'amu*angstrom^2'), symmetry=1, barrier=(26.4811,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.714951,0.0813445,-0.000141613,1.28616e-07,-4.50615e-11,-19272.8,28.4956], Tmin=(100,'K'), Tmax=(837.293,'K')), NASAPolynomial(coeffs=[8.42681,0.0273747,-1.42421e-05,2.76946e-09,-1.91398e-13,-19963.8,-3.75492], Tmin=(837.293,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C([O])O(7128)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(O)(F)C([O])F(7153)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C(O)[C](F)F(4542)'],
    products = ['[CH2]C(F)(F)C([O])O(7128)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[CH]O(3148)'],
    products = ['[CH2]C(F)(F)C([O])O(7128)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)C([O])O(7030)'],
    products = ['[CH2]C(F)(F)C([O])O(7128)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2][C](F)C(=O)O(316)'],
    products = ['[CH2]C(F)(F)C([O])O(7128)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(270.739,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C([O])O(7128)'],
    products = ['[CH2]C(F)(F)[C](O)O(7154)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][C](F)C(O)OF(7158)'],
    products = ['[CH2]C(F)(F)C([O])O(7128)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(97.3376,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
