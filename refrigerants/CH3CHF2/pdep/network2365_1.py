...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(1266)', 'O[C]F(5575)'],
    products = ['[O]C(=O)O[C](O)F(2863)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(=O)OC(=O)F(2865)'],
    products = ['[O]C(=O)O[C](O)F(2863)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([O])=O(1266)', '[OH+]=[C-]F(523)'],
    products = ['[O]C(=O)O[C](O)F(2863)'],
