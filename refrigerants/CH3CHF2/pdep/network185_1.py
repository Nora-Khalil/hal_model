...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=CF(270)'],
    products = ['[CH]=CC([O])F(687)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]F(516)', '[CH]=[CH](264)'],
    products = ['[CH]=CC([O])F(687)'],
