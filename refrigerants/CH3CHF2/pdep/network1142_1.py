...
reaction(
    label = 'reaction1',
    reactants = ['CHF2(81)', 'CH2CF2(57)'],
    products = ['F[C](F)CC(F)F(3073)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)C(F)F(3074)'],
    products = ['F[C](F)CC(F)F(3073)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]CC(F)F-2(2946)'],
    products = ['F[C](F)CC(F)F(3073)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(2927)', 'CHF2-CH2(64)'],
    products = ['F[C](F)CC(F)F(3073)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC(F)=CC(F)F(3934)'],
    products = ['F[C](F)CC(F)F(3073)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C[C](F)F(2948)'],
    products = ['F[C](F)CC(F)F(3073)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(81)', '[CH2][C](F)F(2970)'],
    products = ['F[C](F)CC(F)F(3073)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)[CH]C(F)F(3935)'],
    products = ['F[C](F)CC(F)F(3073)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)C[C](F)F(3193)'],
    products = ['F[C](F)CC(F)F(3073)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'F[CH]C=C(F)F(3936)'],
    products = ['F[C](F)CC(F)F(3073)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)CC(F)F(3073)'],
    products = ['F[CH]CC(F)(F)F(3938)'],
