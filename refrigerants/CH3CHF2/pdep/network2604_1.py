...
reaction(
    label = 'reaction2',
    reactants = ['H2(8)', 'CHF(40)'],
    products = ['CH3F(39)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.13948e+06,'cm^3/(mol*s)'), n=1.96174, Ea=(10.3842,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.23287, dn = +|- 0.0275038, dEa = +|- 0.149675 kJ/molMatched reaction 26 CHF_r1 + H2_r23 <=> CF_p123 in 1,2_Insertion_carbene/training
This reaction matched rate rule [HH_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->Br1s_3Cl1sF1sH->F1s]
family: 1,2_Insertion_carbene"""),
)

reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'CH3(19)'],
    products = ['CH3F(39)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction1',
    reactants = ['H(5)', 'CH2F(46)'],
    products = ['CH3F(39)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.03e+21,'cm^3/(mol*s)'), n=-3.38, Ea=(3460,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 271 CH2F + H <=> CH3F in R_Recombination/training
This reaction matched rate rule [Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F]
