...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8538,0.0457859,-2.76095e-05,7.87242e-09,-9.00563e-13,-13607.4,18.8265], Tmin=(100,'K'), Tmax=(1946.49,'K')), NASAPolynomial(coeffs=[13.0757,0.022725,-9.83824e-06,1.78577e-09,-1.1881e-13,-17976,-42.7864], Tmin=(1946.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C=C(F)CC(8222)',
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56723,0.0494029,-3.40408e-05,1.20002e-08,-1.73713e-12,-7955.63,20.0295], Tmin=(100,'K'), Tmax=(1582.03,'K')), NASAPolynomial(coeffs=[11.7094,0.0237596,-9.72724e-06,1.75446e-09,-1.18052e-13,-11164.7,-33.5528], Tmin=(1582.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.9011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00742947,'amu*angstrom^2'), symmetry=1, barrier=(4.15682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502595,'amu*angstrom^2'), symmetry=1, barrier=(11.5556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81104,0.0478098,-3.68854e-05,1.51507e-08,-2.61106e-12,16718,20.9343], Tmin=(100,'K'), Tmax=(1330.67,'K')), NASAPolynomial(coeffs=[9.56752,0.0244939,-1.06027e-05,1.98308e-09,-1.37201e-13,14653.7,-18.7022], Tmin=(1330.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJ)"""),
)

species(
    label = 'C#CC(F)C[CH2](8224)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {1,S} {2,S} {5,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.04173,'amu*angstrom^2'), symmetry=1, barrier=(23.9515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00438536,'amu*angstrom^2'), symmetry=1, barrier=(12.2654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.95337,'amu*angstrom^2'), symmetry=1, barrier=(67.9037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65883,0.0530723,-5.13078e-05,2.86789e-08,-6.75612e-12,15810.2,19.8186], Tmin=(100,'K'), Tmax=(1005.81,'K')), NASAPolynomial(coeffs=[8.42644,0.026158,-1.11691e-05,2.07409e-09,-1.43274e-13,14448.9,-12.8703], Tmin=(1005.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40449,0.0498362,-3.12324e-05,7.1614e-09,2.32225e-13,11609.5,23.3707], Tmin=(100,'K'), Tmax=(1163.8,'K')), NASAPolynomial(coeffs=[11.9266,0.0232641,-9.34733e-06,1.70701e-09,-1.17433e-13,8510.76,-31.7792], Tmin=(1163.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.6997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CC(F)C[CH2](8227)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.132819,'amu*angstrom^2'), symmetry=1, barrier=(3.05378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126425,'amu*angstrom^2'), symmetry=1, barrier=(2.90676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.581976,'amu*angstrom^2'), symmetry=1, barrier=(13.3808,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8498,0.0509355,-3.93879e-05,1.67132e-08,-3.10591e-12,25561.1,21.9156], Tmin=(100,'K'), Tmax=(1197.42,'K')), NASAPolynomial(coeffs=[7.83313,0.0309483,-1.43505e-05,2.77373e-09,-1.95649e-13,24128.2,-8.02862], Tmin=(1197.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=C(F)CC(8228)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {9,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44575,0.0486779,-2.75234e-05,3.52297e-09,1.38788e-12,15983.9,23.0621], Tmin=(100,'K'), Tmax=(1144.28,'K')), NASAPolynomial(coeffs=[11.8185,0.0237488,-9.69734e-06,1.79055e-09,-1.24135e-13,12868.3,-31.6198], Tmin=(1144.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.081,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cdj(Cs-HHH)(Cd-CsF1s))"""),
)

species(
    label = '[CH2][CH]C(F)C=C(8229)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46061,0.0427082,-2.39238e-05,6.02456e-09,-6.06539e-13,19211.8,21.8251], Tmin=(100,'K'), Tmax=(2044.05,'K')), NASAPolynomial(coeffs=[10.2475,0.0274699,-1.27413e-05,2.37736e-09,-1.6046e-13,16028.5,-21.3092], Tmin=(2044.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH]=[C]C(F)CC(8230)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {1,S} {2,S} {5,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.416894,'amu*angstrom^2'), symmetry=1, barrier=(9.5852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417033,'amu*angstrom^2'), symmetry=1, barrier=(9.58841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417266,'amu*angstrom^2'), symmetry=1, barrier=(9.59377,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57403,0.0579354,-6.03667e-05,3.88608e-08,-1.0966e-11,29270.3,22.0356], Tmin=(100,'K'), Tmax=(833.133,'K')), NASAPolynomial(coeffs=[6.7541,0.0330653,-1.55901e-05,3.03113e-09,-2.14606e-13,28407.2,-2.00956], Tmin=(833.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=[C]C(F)C=C(7597)'],
    products = ['[CH2]CC(F)[C]=C(7441)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]CC(F)=C=C(8223)'],
    products = ['[CH2]CC(F)[C]=C(7441)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#CC(F)C[CH2](8224)'],
    products = ['[CH2]CC(F)[C]=C(7441)'],
