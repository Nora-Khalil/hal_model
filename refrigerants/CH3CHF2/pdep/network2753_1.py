...
"""),
    E0 = (-204.983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,350,440,435,1725,2950,3100,1380,975,1025,1650,180,1521.34,4000],'cm^-1')),
        HinderedRotor(inertia=(0.47256,'amu*angstrom^2'), symmetry=1, barrier=(10.8651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.758432,'amu*angstrom^2'), symmetry=1, barrier=(17.4378,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.78021,0.0547588,-5.7064e-05,2.82459e-08,-5.15286e-12,-34881,25.3128], Tmin=(100,'K'), Tmax=(1582.23,'K')), NASAPolynomial(coeffs=[16.3862,0.00467563,4.93935e-07,-2.52095e-10,2.08689e-14,-38488.9,-52.9328], Tmin=(1582.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-291.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
"""),
    E0 = (-120.506,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.932206,'amu*angstrom^2'), symmetry=1, barrier=(21.4333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.930558,'amu*angstrom^2'), symmetry=1, barrier=(21.3954,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44553,0.0549228,-6.51766e-05,3.86823e-08,-8.95086e-12,-55280.4,19.81], Tmin=(100,'K'), Tmax=(1062.23,'K')), NASAPolynomial(coeffs=[12.7607,0.0123144,-5.00912e-06,9.21092e-10,-6.37645e-14,-57684.3,-35.4625], Tmin=(1062.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-460.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-O2d)H) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH)"""),
)

species(
    label = '[O]C(O)[C]1CO1(7082)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82516,0.0524796,-7.66743e-05,6.34996e-08,-1.98534e-11,-6863.14,22.4002], Tmin=(100,'K'), Tmax=(982.583,'K')), NASAPolynomial(coeffs=[5.67024,0.0219659,-7.40626e-06,1.11014e-09,-6.32794e-14,-6901.38,7.568], Tmin=(982.583,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.6791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(C2CsJO)"""),
)

species(
    label = '[O][C]1COC1O(7083)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38385,0.0467947,-4.52539e-05,2.35353e-08,-4.60524e-12,-7357.33,21.6055], Tmin=(100,'K'), Tmax=(1498.39,'K')), NASAPolynomial(coeffs=[10.77,0.0124767,-1.62761e-06,-6.60298e-15,9.7615e-15,-9130.47,-24.0036], Tmin=(1498.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.0323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.100939,0.0724733,-9.43472e-05,5.51843e-08,-1.16728e-11,-33240.8,23.0415], Tmin=(100,'K'), Tmax=(1371.39,'K')), NASAPolynomial(coeffs=[20.5148,-0.00249989,4.53525e-06,-1.08995e-09,8.16045e-14,-37388.8,-76.6004], Tmin=(1371.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C(O)=C([O])O(7085)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {9,S}
2  O u0 p2 c0 {5,S} {10,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0394804,0.0706213,-8.68854e-05,4.79947e-08,-9.59882e-12,-32796,23.1784], Tmin=(100,'K'), Tmax=(1450.18,'K')), NASAPolynomial(coeffs=[21.035,-0.0022995,4.06544e-06,-9.53529e-10,6.98412e-14,-37307.2,-80.475], Tmin=(1450.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=C(O)C([O])O(7086)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-95.6921,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,350,440,435,1725,3120,650,792.5,1650,359.028],'cm^-1')),
        HinderedRotor(inertia=(0.10743,'amu*angstrom^2'), symmetry=1, barrier=(9.78509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107034,'amu*angstrom^2'), symmetry=1, barrier=(9.76582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107016,'amu*angstrom^2'), symmetry=1, barrier=(9.7745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3756,0.0602497,-8.20763e-05,5.75747e-08,-1.59308e-11,-11416.8,23.7765], Tmin=(100,'K'), Tmax=(887.135,'K')), NASAPolynomial(coeffs=[11.182,0.0160324,-7.30992e-06,1.38753e-09,-9.64948e-14,-13156.7,-22.359], Tmin=(887.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.6921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsOsH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = 'C=C(O)C([O])[O](7087)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-117.083,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,350,440,435,1725,2950,3100,1380,975,1025,1650,180,619.964,4000],'cm^-1')),
        HinderedRotor(inertia=(0.231383,'amu*angstrom^2'), symmetry=1, barrier=(5.31994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29138,'amu*angstrom^2'), symmetry=1, barrier=(29.6913,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72666,0.0550991,-8.22728e-05,7.23617e-08,-2.57973e-11,-14004.9,22.2735], Tmin=(100,'K'), Tmax=(790.318,'K')), NASAPolynomial(coeffs=[6.25117,0.0252739,-1.25211e-05,2.43537e-09,-1.70277e-13,-14503.8,2.87844], Tmin=(790.318,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsOsH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH]=C([O])C(O)O(7088)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {8,S}
2  O u0 p2 c0 {4,S} {9,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (-183.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,350,440,435,1725,3120,650,792.5,1650,250.849],'cm^-1')),
        HinderedRotor(inertia=(0.151592,'amu*angstrom^2'), symmetry=1, barrier=(6.74401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149861,'amu*angstrom^2'), symmetry=1, barrier=(6.75974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151105,'amu*angstrom^2'), symmetry=1, barrier=(6.72655,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29845,0.0600627,-8.13563e-05,5.55039e-08,-1.47047e-11,-21984.3,23.9955], Tmin=(100,'K'), Tmax=(932.537,'K')), NASAPolynomial(coeffs=[12.3766,0.0125459,-4.92714e-06,8.66622e-10,-5.76281e-14,-24050.6,-28.6767], Tmin=(932.537,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsOsH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4113,0.021829,3.10435e-05,-5.62437e-08,2.26403e-11,-46737.8,18.6928], Tmin=(100,'K'), Tmax=(991.409,'K')), NASAPolynomial(coeffs=[12.3577,0.0138796,-5.61886e-06,1.15092e-09,-8.8969e-14,-50291.5,-37.1834], Tmin=(991.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97579,0.0487119,-6.44985e-05,5.50918e-08,-1.99841e-11,17895.7,19.5053], Tmin=(100,'K'), Tmax=(750.128,'K')), NASAPolynomial(coeffs=[5.33655,0.0269122,-1.31505e-05,2.56385e-09,-1.80432e-13,17500.6,4.98524], Tmin=(750.128,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(C2CsJOO) + radical(CJCOOH)"""),
)
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.58835,0.0371832,-1.7911e-05,-3.66656e-08,4.55189e-11,-12610,21.5197], Tmin=(100,'K'), Tmax=(476.148,'K')), NASAPolynomial(coeffs=[5.44095,0.02414,-1.12254e-05,2.14342e-09,-1.49109e-13,-13005.5,8.57428], Tmin=(476.148,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(C=OCOJ) + radical(C=OCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C=C([O])C([O])O(7040)'],
    products = ['[O]C=C([O])CO(7079)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.62709e+20,'s^-1'), n=-1.9758, Ea=(189.357,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C([O])=CO(930)'],
...
reaction(
    ...
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.62453e+10,'s^-1'), n=0.5217, Ea=(137.569,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_O]
Euclidian distance = 1.0
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(8.59752,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['C=C(O)C([O])[O](7087)'],
    products = ['C=C([O])C([O])O(7040)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2140.21,'s^-1'), n=2.50856, Ea=(101.808,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R4H_SSS;Y_rad_out;O_H_out] + [R4H_SSS;O_rad_out;XH_out] + [R4H_SS(Cd)S;Y_rad_out;XH_out] for rate rule [R4H_SS(Cd)S;O_rad_out;O_H_out]
Euclidian distance = 1.4142135623730951
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(T)(18)', '[O]C(O)[C]=O(7091)'],
    products = ['C=C([O])C([O])O(7040)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=C([O])C([O])O(7040)'],
    products = ['[CH2][C]1OOC1O(7092)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(1.503e+11,'s^-1'), n=0.221, Ea=(353.204,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_CO;carbonyl_intra;radadd_intra_O]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 352.6 to 353.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction25',
    reactants = ['C=C([O])C([O])O(7040)'],
    products = ['CC([O])=C([O])O(2896)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C=C([O])C([O])O(7040)'],
    products = ['CC(=O)C([O])[O](7093)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(8.6e-09,'s^-1'), n=5.55, Ea=(99.7678,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""From training reaction 340 used for R4H_SSS;C_rad_out_2H;O_H_out
Exact match found for rate rule [R4H_SSS;C_rad_out_2H;O_H_out]
Euclidian distance = 0
family: intra_H_migration
Ea raised from 98.4 to 99.8 kJ/mol to match endothermicity of reaction."""),
)
