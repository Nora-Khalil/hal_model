...
"""),
    E0 = (247.245,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,615,860,1140,1343,3152,1685,370,180.015,979.611,982.647],'cm^-1')),
        HinderedRotor(inertia=(0.315277,'amu*angstrom^2'), symmetry=1, barrier=(7.25862,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326874,'amu*angstrom^2'), symmetry=1, barrier=(13.9371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.679057,'amu*angstrom^2'), symmetry=1, barrier=(29.9966,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.935168,0.0615177,-4.97245e-05,2.08437e-08,-3.53693e-12,29851.8,25.5011], Tmin=(100,'K'), Tmax=(1395.84,'K')), NASAPolynomial(coeffs=[13.9082,0.0243416,-9.77453e-06,1.76332e-09,-1.19594e-13,26230.1,-41.4131], Tmin=(1395.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.25178,'amu*angstrom^2'), symmetry=1, barrier=(102.956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0599559,'amu*angstrom^2'), symmetry=1, barrier=(24.5647,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55516,0.0212336,2.47952e-05,-4.79583e-08,2.00947e-11,32418.8,14.0196], Tmin=(100,'K'), Tmax=(958.921,'K')), NASAPolynomial(coeffs=[10.71,0.0134902,-4.19009e-06,7.65434e-10,-5.71859e-14,29646.9,-31.2789], Tmin=(958.921,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60567,0.0454902,-1.81151e-05,-2.32417e-09,2.3947e-12,39762.3,26.3988], Tmin=(100,'K'), Tmax=(1219.62,'K')), NASAPolynomial(coeffs=[10.2829,0.0287666,-1.19799e-05,2.21155e-09,-1.52205e-13,36773,-20.7648], Tmin=(1219.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(CdCFH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(Cdj(Cs-CsHH)(Cd-F1sH))"""),
)
...
"""),
    E0 = (370.574,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2175,525,750,770,3400,2100,396.288],'cm^-1')),
        HinderedRotor(inertia=(0.204133,'amu*angstrom^2'), symmetry=1, barrier=(22.7308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.906581,'amu*angstrom^2'), symmetry=1, barrier=(101.186,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204603,'amu*angstrom^2'), symmetry=1, barrier=(22.7374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41405,0.0486928,-2.2729e-05,-5.73712e-09,5.87815e-12,44670,19.6162], Tmin=(100,'K'), Tmax=(1006.53,'K')), NASAPolynomial(coeffs=[12.485,0.0217931,-8.12024e-06,1.46282e-09,-1.018e-13,41575.3,-38.1689], Tmin=(1006.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(370.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(=C)CC#CF(11713)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  C u0 p0 c0 {3,S} {6,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {4,S} {5,D}
...
"""),
    E0 = (270.808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2175,525,239,401,1367,254.962,603.044],'cm^-1')),
        HinderedRotor(inertia=(7.30666e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.46497,'amu*angstrom^2'), symmetry=1, barrier=(19.9672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.72754,'amu*angstrom^2'), symmetry=1, barrier=(31.6208,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38941,0.0553427,-4.36075e-05,1.78916e-08,-3.02654e-12,32666.2,22.0267], Tmin=(100,'K'), Tmax=(1372.92,'K')), NASAPolynomial(coeffs=[11.6406,0.0254759,-1.09764e-05,2.0465e-09,-1.41267e-13,29851.4,-30.6785], Tmin=(1372.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(CtCF) + radical(Allyl_P)"""),
)
...
"""),
    E0 = (259.521,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,167,640,1190,183.151,884.497],'cm^-1')),
        HinderedRotor(inertia=(0.292064,'amu*angstrom^2'), symmetry=1, barrier=(6.74849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.759619,'amu*angstrom^2'), symmetry=1, barrier=(17.9641,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0462349,'amu*angstrom^2'), symmetry=1, barrier=(25.5698,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.855463,0.0608779,-4.58421e-05,1.59626e-08,-1.74307e-12,31333.3,25.8051], Tmin=(100,'K'), Tmax=(1160.85,'K')), NASAPolynomial(coeffs=[14.3375,0.023489,-9.24535e-06,1.67351e-09,-1.14748e-13,27592.3,-43.8801], Tmin=(1160.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Allyl_P) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.848702,0.0606696,-3.74238e-05,9.5102e-09,-3.35999e-13,27613.4,26.8645], Tmin=(100,'K'), Tmax=(1223.4,'K')), NASAPolynomial(coeffs=[12.9574,0.0306364,-1.2318e-05,2.21467e-09,-1.50004e-13,23935.5,-36.9173], Tmin=(1223.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C=C(C)C[C]=[C]F(8515)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  C u0 p0 c0 {4,S} {6,S} {8,S} {9,S}
3  C u0 p0 c0 {4,S} {10,S} {11,S} {12,S}
...
"""),
    E0 = (345.864,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,1685,370,167,640,1190,340.539,340.949],'cm^-1')),
        HinderedRotor(inertia=(0.0962083,'amu*angstrom^2'), symmetry=1, barrier=(7.94577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0962746,'amu*angstrom^2'), symmetry=1, barrier=(7.9449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0966302,'amu*angstrom^2'), symmetry=1, barrier=(7.95228,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31515,0.0621259,-5.8653e-05,3.20292e-08,-7.47645e-12,41691.9,25.0464], Tmin=(100,'K'), Tmax=(1004.35,'K')), NASAPolynomial(coeffs=[8.72503,0.0326149,-1.45787e-05,2.77383e-09,-1.9435e-13,40203.5,-10.7342], Tmin=(1004.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(345.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (250.956,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,246,474,533,1155,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,187.712,1218.6],'cm^-1')),
        HinderedRotor(inertia=(0.00835368,'amu*angstrom^2'), symmetry=1, barrier=(8.82918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.990342,'amu*angstrom^2'), symmetry=1, barrier=(23.7079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.929357,'amu*angstrom^2'), symmetry=1, barrier=(23.7477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=CF(1084)', '[CH2]C([CH2])=C(10867)'],
    products = ['[CH2]C(=C)C[C]=CF(8513)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(=C)C[C]=CF(8513)'],
    products = ['[CH2]C1([CH2])CC1=CF(11711)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'C#CCC([CH2])=C(11619)'],
    products = ['[CH2]C(=C)C[C]=CF(8513)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(=C)CC#CF(11713)'],
    products = ['[CH2]C(=C)C[C]=CF(8513)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(=C)CC=[C]F(11715)'],
    products = ['[CH2]C(=C)C[C]=CF(8513)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C(F)CC([CH2])=C(11717)'],
    products = ['[CH2]C(=C)C[C]=CF(8513)'],
