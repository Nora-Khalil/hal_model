...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.256133,'amu*angstrom^2'), symmetry=1, barrier=(5.889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05213,'amu*angstrom^2'), symmetry=1, barrier=(24.1906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256792,'amu*angstrom^2'), symmetry=1, barrier=(5.90416,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.100106,0.0963649,-0.000168438,1.52861e-07,-5.35402e-11,-66764.3,26.5894], Tmin=(100,'K'), Tmax=(831.56,'K')), NASAPolynomial(coeffs=[9.68061,0.0311422,-1.62646e-05,3.18557e-09,-2.21277e-13,-67695.9,-13.8852], Tmin=(831.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(F1s)(H)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.177373,'amu*angstrom^2'), symmetry=1, barrier=(4.07816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177005,'amu*angstrom^2'), symmetry=1, barrier=(4.06969,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.467021,0.0874392,-0.000147835,1.36198e-07,-4.91972e-11,-66936.2,26.9555], Tmin=(100,'K'), Tmax=(806.447,'K')), NASAPolynomial(coeffs=[7.92699,0.0340162,-1.79233e-05,3.55372e-09,-2.49834e-13,-67605.5,-4.119], Tmin=(806.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'CC(F)(F)[C](F)[CH]F(6177)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.377074,0.0924492,-0.000167711,1.60707e-07,-5.88685e-11,-69318.4,26.1685], Tmin=(100,'K'), Tmax=(831.437,'K')), NASAPolynomial(coeffs=[6.51845,0.0366091,-1.95323e-05,3.85636e-09,-2.69036e-13,-69430.8,3.13911], Tmin=(831.437,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-577.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = '[CH2]C(F)(F)[CH]C(F)F(3198)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-517.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,334,575,1197,1424,3202,190.643,190.652,190.662],'cm^-1')),
        HinderedRotor(inertia=(0.75991,'amu*angstrom^2'), symmetry=1, barrier=(19.5984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.759735,'amu*angstrom^2'), symmetry=1, barrier=(19.5985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.759789,'amu*angstrom^2'), symmetry=1, barrier=(19.5985,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.51545,0.0833314,-0.000117087,8.67168e-08,-2.58308e-11,-62140.6,27.1377], Tmin=(100,'K'), Tmax=(817.996,'K')), NASAPolynomial(coeffs=[11.9893,0.0272262,-1.42081e-05,2.87308e-09,-2.06999e-13,-64017.8,-25.9124], Tmin=(817.996,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-517.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
    products = ['F[CH]C(F)C[C](F)F(6150)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]C(F)(F)[CH]F(3104)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)[C](F)F(6175)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]C(F)(F)C=CF(3059)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHFCHF[Z](59)', '[CH2][C](F)F(2970)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)=CF(4316)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C(F)[CH]F(6163)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CF2(57)', 'F[CH][CH]F(5595)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][CH]F(5595)', '[CH2][C](F)F(2970)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH2]C(F)=C[CH]F(3092)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C(F)[CH]F(4044)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C(F)(F)[CH]F(3104)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
    products = ['[CH2]C(F)(F)[C](F)CF(3203)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
    products = ['[CH2]C(F)(F)[CH]C(F)F(3198)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH][CH]C(F)(F)CF(6178)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
    products = ['[CH2][C](F)C(F)C(F)F(6179)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)[C](F)CF(6180)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(6149)'],
