...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', 'C=C[C]C(6406)'],
    products = ['C[C]=CC[CH]F(6356)'],
    transitionState = 'TS3',
