...
reaction(
    label = 'reaction1',
    reactants = ['[O]OO[C]=O(169)'],
    products = ['O=O(143)', 'CO2(14)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](127)', '[C]=O(128)'],
    products = ['[O]OO[C]=O(169)'],
    transitionState = 'TS2',
