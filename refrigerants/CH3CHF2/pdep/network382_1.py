...
"""),
    E0 = (542.634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1670,1700,300,440,180],'cm^-1')),
        HinderedRotor(inertia=(0.150285,'amu*angstrom^2'), symmetry=1, barrier=(3.45536,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24651,0.0434754,-4.27679e-05,1.75408e-08,2.32396e-12,65322.3,26.6208], Tmin=(100,'K'), Tmax=(567.428,'K')), NASAPolynomial(coeffs=[5.79377,0.0251761,-1.21227e-05,2.36572e-09,-1.67388e-13,64811.7,10.5659], Tmin=(567.428,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(542.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.450221,'amu*angstrom^2'), symmetry=1, barrier=(44.3279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92801,'amu*angstrom^2'), symmetry=1, barrier=(44.3287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92793,'amu*angstrom^2'), symmetry=1, barrier=(44.3268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13884,'amu*angstrom^2'), symmetry=1, barrier=(26.1843,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34619,0.0629854,-8.62165e-05,6.45687e-08,-1.96673e-11,66499.4,22.7827], Tmin=(100,'K'), Tmax=(798.219,'K')), NASAPolynomial(coeffs=[9.26571,0.0233008,-1.16441e-05,2.28836e-09,-1.61936e-13,65235.1,-13.6398], Tmin=(798.219,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(552.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOOC) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(395)', 'C=[C]O[O](375)'],
    products = ['C=[C]OO[C]=C(1249)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['C=[C]OO[C]=C(1249)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(443.267,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 437.9 to 443.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'C#COO[C]=C(1287)'],
    products = ['C=[C]OO[C]=C(1249)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['C=[C]OO[C]=C(1249)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.69158e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(222.264,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C
Ea raised from 219.8 to 222.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH]=COO[C]=C(1288)'],
    products = ['C=[C]OO[C]=C(1249)'],
    transitionState = 'TS7',
