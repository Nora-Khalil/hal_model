...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(230)', '[CH2]C(C)[O](1795)'],
    products = ['CC([O])C[CH]F(1703)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(=O)C[CH]F(1798)'],
    products = ['CC([O])C[CH]F(1703)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C(C)[O](1795)'],
    products = ['CC([O])C[CH]F(1703)'],
