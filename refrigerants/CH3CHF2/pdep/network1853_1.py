...
"""),
    E0 = (-563.115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,617,898,1187,184.685],'cm^-1')),
        HinderedRotor(inertia=(0.275244,'amu*angstrom^2'), symmetry=1, barrier=(6.6602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274979,'amu*angstrom^2'), symmetry=1, barrier=(6.66111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.66796,'amu*angstrom^2'), symmetry=1, barrier=(16.1584,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41606,0.0606388,-7.91829e-05,5.46628e-08,-1.51904e-11,-67637.3,21.9749], Tmin=(100,'K'), Tmax=(875.277,'K')), NASAPolynomial(coeffs=[10.249,0.0202718,-1.00036e-05,1.97083e-09,-1.40185e-13,-69183.5,-19.4623], Tmin=(875.277,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-563.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cs-CsCsHH) + group(CJ2_singlet-FCs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OC(F)(F)CF(3494)'],
    products = ['OC(F)(F)CCF(4760)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'OC(F)(F)C[C]F(5187)'],
    products = ['OC(F)(F)CCF(4760)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'CC(O)(F)F(3043)'],
    products = ['OC(F)(F)CCF(4760)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'FCC=C(F)F(4265)'],
    products = ['OC(F)(F)CCF(4760)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]CC(O)(F)F(5246)'],
    products = ['OC(F)(F)CCF(4760)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)CCF(4810)'],
    products = ['OC(F)(F)CCF(4760)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(4619)', 'CH2F-CH2(62)'],
    products = ['OC(F)(F)CCF(4760)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'OC(F)(F)[CH]CF(5164)'],
    products = ['OC(F)(F)CCF(4760)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)(F)C[CH]F(5188)'],
    products = ['OC(F)(F)CCF(4760)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=CC(O)(F)F(4995)'],
    products = ['OC(F)(F)CCF(4760)'],
