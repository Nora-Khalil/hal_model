...
"""),
    E0 = (-4.8349,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1855,455,950,262.074,262.074,262.075],'cm^-1')),
        HinderedRotor(inertia=(0.00245443,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00245452,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.361544,'amu*angstrom^2'), symmetry=1, barrier=(17.621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.361538,'amu*angstrom^2'), symmetry=1, barrier=(17.6211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45154,0.0567119,-5.62564e-05,2.99658e-08,-6.5308e-12,-490.259,22.4708], Tmin=(100,'K'), Tmax=(1096.01,'K')), NASAPolynomial(coeffs=[10.68,0.0230312,-1.01602e-05,1.92659e-09,-1.3494e-13,-2513.11,-22.8968], Tmin=(1096.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.8349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.43864,0.0139232,7.70682e-05,-1.1091e-07,4.31591e-11,-26934.4,18.911], Tmin=(100,'K'), Tmax=(966.427,'K')), NASAPolynomial(coeffs=[14.5229,0.0154472,-5.29329e-06,1.08874e-09,-8.83309e-14,-31677,-51.4284], Tmin=(966.427,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-224.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17601,0.0505572,-1.98663e-05,-2.05195e-08,1.44703e-11,-25484.5,19.4834], Tmin=(100,'K'), Tmax=(935.206,'K')), NASAPolynomial(coeffs=[17.3592,0.0105026,-2.39676e-06,3.71108e-10,-2.77594e-14,-29786.7,-64.3251], Tmin=(935.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35386,0.0415164,1.24045e-05,-5.7292e-08,2.80565e-11,-30209.5,20.3907], Tmin=(100,'K'), Tmax=(938.305,'K')), NASAPolynomial(coeffs=[19.1781,0.00771939,-1.00953e-06,1.56791e-10,-1.71616e-14,-35411.6,-74.3623], Tmin=(938.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.917029,'amu*angstrom^2'), symmetry=1, barrier=(21.0843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.922754,'amu*angstrom^2'), symmetry=1, barrier=(21.2159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.916485,'amu*angstrom^2'), symmetry=1, barrier=(21.0718,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.105994,0.0681407,-7.49638e-05,3.82217e-08,-7.17651e-12,-2117.49,22.8036], Tmin=(100,'K'), Tmax=(1515.96,'K')), NASAPolynomial(coeffs=[20.4211,0.00283538,1.23304e-06,-3.79035e-10,2.89698e-14,-6932.22,-79.2219], Tmin=(1515.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.8964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(CCsJOC(O))"""),
)

species(
    label = 'C=COC[C]=O(2417)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {3,S} {4,S}
2  O u0 p2 c0 {6,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.04898,'amu*angstrom^2'), symmetry=1, barrier=(24.1181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04644,'amu*angstrom^2'), symmetry=1, barrier=(24.0596,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04646,'amu*angstrom^2'), symmetry=1, barrier=(24.0602,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40903,0.0418251,3.07158e-06,-4.60622e-08,2.3936e-11,-11610.3,20.8715], Tmin=(100,'K'), Tmax=(937.282,'K')), NASAPolynomial(coeffs=[18.8887,0.00559287,-3.41825e-07,3.70063e-11,-8.34966e-15,-16572.2,-71.3154], Tmin=(937.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CsCJ=O)"""),
)

species(
    label = 'C[CH]OC=C[O](2418)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {5,S}
2  O u1 p2 c0 {6,S}
3  C u0 p0 c0 {4,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.555232,0.0558094,-4.9324e-06,-5.81065e-08,3.35093e-11,-6942.47,21.7929], Tmin=(100,'K'), Tmax=(909.125,'K')), NASAPolynomial(coeffs=[26.2916,-0.0039963,5.58736e-06,-1.17536e-09,7.70418e-14,-13830,-112.062], Tmin=(909.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.9096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]COC[C]=O(2419)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  O u0 p2 c0 {6,D}
3  C u0 p0 c0 {1,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (26.2982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1855,455,950,361.75,362.075,362.189],'cm^-1')),
        HinderedRotor(inertia=(0.00128671,'amu*angstrom^2'), symmetry=1, barrier=(0.119663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0606516,'amu*angstrom^2'), symmetry=1, barrier=(5.62173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0605088,'amu*angstrom^2'), symmetry=1, barrier=(5.62061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269797,'amu*angstrom^2'), symmetry=1, barrier=(25.0849,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7143,0.0534592,-5.15027e-05,2.80661e-08,-6.51118e-12,3242.6,22.7219], Tmin=(100,'K'), Tmax=(1010.08,'K')), NASAPolynomial(coeffs=[8.31131,0.0273353,-1.27089e-05,2.46228e-09,-1.74272e-13,1909.86,-9.17123], Tmin=(1010.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.2982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJCO) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13394,0.0481727,-5.06567e-06,-4.15547e-08,2.34035e-11,-1457.74,23.3696], Tmin=(100,'K'), Tmax=(924.409,'K')), NASAPolynomial(coeffs=[19.6253,0.00664891,-1.4262e-07,-6.30488e-11,1.06353e-15,-6520.98,-73.2819], Tmin=(924.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.0928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = '[CH2][CH]OCC=O(2421)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {1,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (52.0832,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,395.057,951.729,951.767],'cm^-1')),
        HinderedRotor(inertia=(0.147121,'amu*angstrom^2'), symmetry=1, barrier=(3.38261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.65621,'amu*angstrom^2'), symmetry=1, barrier=(15.0876,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.65614,'amu*angstrom^2'), symmetry=1, barrier=(15.0859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.656145,'amu*angstrom^2'), symmetry=1, barrier=(15.0861,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21773,0.0618904,-6.76771e-05,3.91862e-08,-9.1302e-12,6363.83,23.2661], Tmin=(100,'K'), Tmax=(1038.61,'K')), NASAPolynomial(coeffs=[11.6986,0.0215259,-9.38161e-06,1.76761e-09,-1.23396e-13,4186.71,-27.6952], Tmin=(1038.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.0832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[C]=O(690)', '[CH]C-2(610)'],
    products = ['C[CH]OC[C]=O(2316)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH2]O[CH]C(1805)'],
    products = ['C[CH]OC[C]=O(2316)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[CH2]O[CH]C(1805)'],
    products = ['C[CH]OC[C]=O(2316)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C[CH]OC=C=O(2416)'],
    products = ['C[CH]OC[C]=O(2316)'],
