...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)C([O])O(9444)'],
    products = ['O=CO(1075)', 'C#CC(5436)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC([O])O(8231)'],
    products = ['[CH]=C(C)C([O])O(9444)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(7)', '[CH]=C(C)C=O(6560)'],
    products = ['[CH]=C(C)C([O])O(9444)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=CO(1075)', '[CH]=[C]C(5437)'],
    products = ['[CH]=C(C)C([O])O(9444)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(C)C(=O)O(9562)'],
    products = ['[CH]=C(C)C([O])O(9444)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][CH]O(1357)', 'C#CC(5436)'],
    products = ['[CH]=C(C)C([O])O(9444)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(18.9093,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'C#CC([O])O(8234)'],
    products = ['[CH]=C(C)C([O])O(9444)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][CH]O(1357)', '[CH]=[C]C(5437)'],
    products = ['[CH]=C(C)C([O])O(9444)'],
