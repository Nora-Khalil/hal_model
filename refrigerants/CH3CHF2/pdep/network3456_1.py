...
"""),
    E0 = (-618.973,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,253,525,597,667,842,1178,1324,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,335.57,335.571,335.571,335.571],'cm^-1')),
        HinderedRotor(inertia=(0.0819679,'amu*angstrom^2'), symmetry=1, barrier=(6.54998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0819679,'amu*angstrom^2'), symmetry=1, barrier=(6.54998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21044,'amu*angstrom^2'), symmetry=1, barrier=(16.8159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.28864,'amu*angstrom^2'), symmetry=1, barrier=(23.0648,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
...
"""),
    E0 = (-379.702,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,528,1116,1182,1331,1402,1494,3075,3110,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.148309,0.0900351,-0.000116122,7.69621e-08,-2.04036e-11,-45533.3,28.3619], Tmin=(100,'K'), Tmax=(917.618,'K')), NASAPolynomial(coeffs=[14.4708,0.0276014,-1.40632e-05,2.81378e-09,-2.0216e-13,-48161.8,-39.5043], Tmin=(917.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-379.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFFO) + group(CsCsFHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (-694.167,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,2950,3100,1380,975,1025,1650,265.575,277.279,283.71],'cm^-1')),
        HinderedRotor(inertia=(0.16824,'amu*angstrom^2'), symmetry=1, barrier=(8.47467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155274,'amu*angstrom^2'), symmetry=1, barrier=(8.38597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.534483,'amu*angstrom^2'), symmetry=1, barrier=(27.3736,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3086.37,'J/mol'), sigma=(5.3362,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=482.08 K, Pc=46.09 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.30749,0.0885658,-0.000124295,9.48202e-08,-2.94566e-11,-83362.8,26.0941], Tmin=(100,'K'), Tmax=(782.191,'K')), NASAPolynomial(coeffs=[11.2433,0.0326433,-1.70559e-05,3.42161e-09,-2.44965e-13,-85073.6,-23.9786], Tmin=(782.191,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-694.167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-193.573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,395,473,707,1436,3000,3100,440,815,1455,1000,180,180,3166.62],'cm^-1')),
        HinderedRotor(inertia=(0.561827,'amu*angstrom^2'), symmetry=1, barrier=(12.9175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.11055,'amu*angstrom^2'), symmetry=1, barrier=(48.5258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560698,'amu*angstrom^2'), symmetry=1, barrier=(12.8916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.1118,'amu*angstrom^2'), symmetry=1, barrier=(48.5544,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.304382,0.0871841,-0.000129954,1.05867e-07,-3.44216e-11,-23154.1,29.1582], Tmin=(100,'K'), Tmax=(812.461,'K')), NASAPolynomial(coeffs=[10.9084,0.0296655,-1.39544e-05,2.63694e-09,-1.80962e-13,-24701.8,-18.7191], Tmin=(812.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFHH) + group(Cs-CsHHH) + radical(CsCsF1sO2s) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C(F)(F)OF(9907)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-228.916,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,330.667,330.905],'cm^-1')),
        HinderedRotor(inertia=(0.0863344,'amu*angstrom^2'), symmetry=1, barrier=(6.59107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0849274,'amu*angstrom^2'), symmetry=1, barrier=(6.59125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.893709,'amu*angstrom^2'), symmetry=1, barrier=(69.1163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0197151,'amu*angstrom^2'), symmetry=1, barrier=(69.1312,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.400218,0.0811078,-0.000104573,7.1666e-08,-1.94701e-11,-27404.4,28.3727], Tmin=(100,'K'), Tmax=(902.959,'K')), NASAPolynomial(coeffs=[13.2625,0.0241278,-9.91485e-06,1.77597e-09,-1.19201e-13,-29727.1,-32.3668], Tmin=(902.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CF)C([O])(F)F(9908)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-497.374,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,351,323,533,609,664,892,1120,1201,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.113571,'amu*angstrom^2'), symmetry=1, barrier=(2.61121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113838,'amu*angstrom^2'), symmetry=1, barrier=(2.61737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.768544,'amu*angstrom^2'), symmetry=1, barrier=(17.6703,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.762308,0.0741566,-8.81226e-05,5.68616e-08,-1.48546e-11,-59706.2,27.3458], Tmin=(100,'K'), Tmax=(928.33,'K')), NASAPolynomial(coeffs=[11.6751,0.0271345,-1.21429e-05,2.29698e-09,-1.60047e-13,-61732.3,-24.4904], Tmin=(928.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-497.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFFO) + group(CsCsFHH) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(Isobutyl)"""),
)
...
"""),
    E0 = (-352.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,190,488,555,1236,1407,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.173303,'amu*angstrom^2'), symmetry=1, barrier=(3.98457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173983,'amu*angstrom^2'), symmetry=1, barrier=(4.00021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.565215,'amu*angstrom^2'), symmetry=1, barrier=(12.9954,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.89697,0.0754862,-0.000118955,1.04303e-07,-3.58627e-11,-42239.5,24.602], Tmin=(100,'K'), Tmax=(841.426,'K')), NASAPolynomial(coeffs=[7.81339,0.0295688,-1.38556e-05,2.61652e-09,-1.78876e-13,-42941.9,-4.8289], Tmin=(841.426,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-352.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Isobutyl) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)

species(
    label = '[CH2][CH]CF(1337)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
2 C u0 p0 c0 {1,S} {3,S} {5,S} {6,S}
...
"""),
    E0 = (92.7424,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1500.51],'cm^-1')),
        HinderedRotor(inertia=(0.227272,'amu*angstrom^2'), symmetry=1, barrier=(5.22543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0032711,'amu*angstrom^2'), symmetry=1, barrier=(5.2267,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.0702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.24632,0.0187751,-1.53198e-06,-4.13026e-09,1.19518e-12,11179.5,16.6663], Tmin=(100,'K'), Tmax=(1673.13,'K')), NASAPolynomial(coeffs=[7.42039,0.0173515,-7.92576e-06,1.47357e-09,-9.88108e-14,8585.23,-9.19816], Tmin=(1673.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.7424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(F)(F)OF(4794)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-213.798,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.257228,'amu*angstrom^2'), symmetry=1, barrier=(5.91417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257191,'amu*angstrom^2'), symmetry=1, barrier=(5.91332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0115929,'amu*angstrom^2'), symmetry=1, barrier=(33.5508,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16773,0.0681038,-0.000106914,9.19099e-08,-3.18041e-11,-25617.6,24.7157], Tmin=(100,'K'), Tmax=(751.476,'K')), NASAPolynomial(coeffs=[8.85478,0.0239945,-1.24961e-05,2.49523e-09,-1.77202e-13,-26682.8,-9.57377], Tmin=(751.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-213.798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(Cs-HHH)(H)) + radical(RCCJ)"""),
)

species(
    label = '[CH2][C](CF)C(F)(F)OF(9910)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-470.26,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,3000,3100,440,815,1455,1000,234.563,234.571,2753.75],'cm^-1')),
        HinderedRotor(inertia=(3.06388,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.06412,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.06393,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.480051,'amu*angstrom^2'), symmetry=1, barrier=(18.7411,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.396793,0.0831777,-0.000102074,6.59473e-08,-1.71404e-11,-56432.8,28.4386], Tmin=(100,'K'), Tmax=(934.137,'K')), NASAPolynomial(coeffs=[13.3086,0.0278885,-1.32925e-05,2.5859e-09,-1.83057e-13,-58845.1,-32.9739], Tmin=(934.137,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-470.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFFO) + group(CsCsFHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.289857,'amu*angstrom^2'), symmetry=1, barrier=(6.66438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.28993,'amu*angstrom^2'), symmetry=1, barrier=(6.66606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00098,'amu*angstrom^2'), symmetry=1, barrier=(23.0146,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07494,0.0695573,-9.79914e-05,8.03381e-08,-2.70823e-11,-55848,24.2141], Tmin=(100,'K'), Tmax=(759.644,'K')), NASAPolynomial(coeffs=[8.21695,0.029565,-1.43125e-05,2.76788e-09,-1.93509e-13,-56864.3,-7.82561], Tmin=(759.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-465.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(COCsFO) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C(CF)=C(F)OF(9187)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-293.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,326,540,652,719,1357,3000,3100,440,815,1455,1000,180,839.85],'cm^-1')),
        HinderedRotor(inertia=(0.130611,'amu*angstrom^2'), symmetry=1, barrier=(3.003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129664,'amu*angstrom^2'), symmetry=1, barrier=(2.98123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.25362,'amu*angstrom^2'), symmetry=1, barrier=(51.8151,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26047,0.0697339,-7.70274e-05,2.43948e-08,1.54027e-11,-35165.4,23.5138], Tmin=(100,'K'), Tmax=(531.76,'K')), NASAPolynomial(coeffs=[8.17668,0.0330668,-1.69184e-05,3.34906e-09,-2.37361e-13,-36118.1,-7.52661], Tmin=(531.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-293.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFO) + radical(Allyl_P)"""),
)
...
8  C u0 p0 c0 {1,S} {6,S} {13,S} {14,S}
...
"""),
    E0 = (-587.491,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,442,614,1089,1143,1126,1238,1254,1408,1339,1465,1463,1525,3023,3127,3088,3132,395,473,707,1436,180,180,180.01,180.273],'cm^-1')),
        HinderedRotor(inertia=(0.560182,'amu*angstrom^2'), symmetry=1, barrier=(12.8797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.563346,'amu*angstrom^2'), symmetry=1, barrier=(12.9524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60912,'amu*angstrom^2'), symmetry=1, barrier=(37.0486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.745549,'amu*angstrom^2'), symmetry=1, barrier=(17.1619,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.067446,0.0951298,-0.000134189,1.00148e-07,-2.86992e-11,-70525.3,28.4988], Tmin=(100,'K'), Tmax=(648.462,'K')), NASAPolynomial(coeffs=[11.3093,0.0353649,-1.81027e-05,3.58405e-09,-2.5406e-13,-72184.7,-22.4202], Tmin=(648.462,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-587.491,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFHH) + group(CsCsFHH) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(28.1099,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[CH2]C(CF)OF(9820)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(198.378,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)
...
reaction(
    ...
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(5.59914e-05,'m^3/(mol*s)'), n=3.10993, Ea=(24.9972,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(146.27,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(CF)C(F)(F)OF(9720)'],
    products = ['FC[CH]CC(F)(F)OF(9904)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FCC[CH]C(F)(F)OF(9902)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(18)', 'FC[CH]C(F)(F)OF(4812)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]C(CF)C(F)(F)OF-2(9905)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C([CH2])C(F)(F)OF(9907)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(CF)C([O])(F)F(9908)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(126)', '[CH2]C(CF)[C](F)F(9909)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FO[C](F)F(4688)', '[CH2][CH]CF(1337)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(46)', '[CH2][CH]C(F)(F)OF(4794)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2][C](CF)C(F)(F)OF(9910)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', '[CH2]C(CF)C(=O)F(9911)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(78.9584,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction21',
    reactants = ['HF(38)', '[CH2]C(CF)=C(F)OF(9187)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(203.028,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(227.119,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    label = 'reaction27',
    reactants = ['FCC(CF)[C](F)OF(9913)'],
    products = ['[CH2]C(CF)C(F)(F)OF(9720)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(210.051,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
