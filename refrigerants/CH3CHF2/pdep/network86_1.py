...
reaction(
    label = 'reaction2',
    reactants = ['C#CO(522)', 'C[C]F(124)'],
    products = ['C#COC(C)F(220)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'C#CO[CH]F(534)'],
    products = ['C#COC(C)F(220)'],
    transitionState = 'TS8',
