...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.965172,'amu*angstrom^2'), symmetry=1, barrier=(22.1912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.964998,'amu*angstrom^2'), symmetry=1, barrier=(22.1872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.96471,'amu*angstrom^2'), symmetry=1, barrier=(22.1806,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238228,0.060466,-7.03366e-05,3.62103e-08,-6.65948e-12,11717.7,22.4687], Tmin=(100,'K'), Tmax=(1622.8,'K')), NASAPolynomial(coeffs=[19.144,-0.00323459,4.35005e-06,-9.65365e-10,6.79736e-14,7833.31,-70.9562], Tmin=(1622.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.1405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCJO) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-47.1032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.28881,'amu*angstrom^2'), symmetry=1, barrier=(29.6324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29756,'amu*angstrom^2'), symmetry=1, barrier=(29.8334,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19392,0.0309399,-7.7279e-06,-1.7482e-08,1.00758e-11,-5592.31,16.0123], Tmin=(100,'K'), Tmax=(977.481,'K')), NASAPolynomial(coeffs=[13.1041,0.0069025,-2.46647e-06,4.988e-10,-3.95324e-14,-8709.76,-41.4108], Tmin=(977.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.1032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]O(237)', '[CH]=C[O](133)'],
    products = ['[CH]=CO[CH]O(7335)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH]=CO[CH]O(7335)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(11.4696,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
