...
"""),
    E0 = (-617.243,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,180,180,1805.27],'cm^-1')),
        HinderedRotor(inertia=(0.109972,'amu*angstrom^2'), symmetry=1, barrier=(2.52848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0140146,'amu*angstrom^2'), symmetry=1, barrier=(32.4044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109855,'amu*angstrom^2'), symmetry=1, barrier=(2.52578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40963,'amu*angstrom^2'), symmetry=1, barrier=(32.4102,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77158,0.0552512,-8.37975e-05,8.04288e-08,-3.20051e-11,-74163,23.5649], Tmin=(100,'K'), Tmax=(737.858,'K')), NASAPolynomial(coeffs=[4.43937,0.0316484,-1.72335e-05,3.49837e-09,-2.51213e-13,-74307.9,13.1914], Tmin=(737.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-617.243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2sCF) + group(Cs-OsOsOsH) + group(Cds-OdOsH)"""),
)
...
"""),
    ...
    molecularWeight = (110.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27401,0.0672162,-0.000111851,1.03697e-07,-3.84174e-11,-24536.1,26.0552], Tmin=(100,'K'), Tmax=(770.51,'K')), NASAPolynomial(coeffs=[6.89529,0.0278577,-1.5418e-05,3.11939e-09,-2.22405e-13,-25100.3,2.36145], Tmin=(770.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(Cs_P)"""),
)

species(
    label = 'O[CH]O[C](O)OF(7880)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (110.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.60952,0.0871126,-0.000170197,1.60507e-07,-5.65382e-11,-29140.1,27.7569], Tmin=(100,'K'), Tmax=(864.434,'K')), NASAPolynomial(coeffs=[8.19313,0.0243882,-1.34056e-05,2.60794e-09,-1.78026e-13,-29418.8,-1.7532], Tmin=(864.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(212.019,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsOsHH) + radical(Cs_P) + radical(OCJO)"""),
)

species(
    label = '[O]COC([O])OF(7881)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {6,S} {7,S}
3  O u0 p2 c0 {1,S} {6,S}
...
"""),
    E0 = (-182.611,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,180,1357.94,1358,1358.44,1358.76,1359.15],'cm^-1')),
        HinderedRotor(inertia=(0.308324,'amu*angstrom^2'), symmetry=1, barrier=(7.08898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308239,'amu*angstrom^2'), symmetry=1, barrier=(7.08701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.98608,'amu*angstrom^2'), symmetry=1, barrier=(45.6638,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75387,0.0641475,-0.000127971,1.44044e-07,-5.98511e-11,-21896.6,24.1139], Tmin=(100,'K'), Tmax=(815.433,'K')), NASAPolynomial(coeffs=[-1.84438,0.0451319,-2.55436e-05,5.16051e-09,-3.65443e-13,-20090.7,48.2139], Tmin=(815.433,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[O]C(OF)O[CH]O(7879)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {6,S} {7,S}
3  O u0 p2 c0 {1,S} {6,S}
...
"""),
    ...
    molecularWeight = (110.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13109,0.0835159,-0.000184313,1.98073e-07,-7.67349e-11,-26502.4,25.6684], Tmin=(100,'K'), Tmax=(856.259,'K')), NASAPolynomial(coeffs=[-0.686411,0.0419138,-2.3682e-05,4.6857e-09,-3.24168e-13,-24354.8,44.8779], Tmin=(856.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)
...
"""),
    E0 = (-238.798,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,1975.84,1976.12],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.74669,0.0442557,-0.000111523,1.35662e-07,-5.67044e-11,-28691.8,16.8313], Tmin=(100,'K'), Tmax=(850.282,'K')), NASAPolynomial(coeffs=[-4.86784,0.0364407,-2.07564e-05,4.14029e-09,-2.88505e-13,-25819.5,61.6078], Tmin=(850.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-389.845,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,180,877.738,878.817,879.182],'cm^-1')),
        HinderedRotor(inertia=(0.180592,'amu*angstrom^2'), symmetry=1, barrier=(4.15217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00754508,'amu*angstrom^2'), symmetry=1, barrier=(4.13335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00750248,'amu*angstrom^2'), symmetry=1, barrier=(4.12512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25752,0.0532772,-0.000111531,1.34184e-07,-5.80801e-11,-46839.5,22.2895], Tmin=(100,'K'), Tmax=(814.405,'K')), NASAPolynomial(coeffs=[-4.29752,0.0462561,-2.63689e-05,5.3432e-09,-3.79108e-13,-44471.3,60.5526], Tmin=(814.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cds-OdOsH) + radical(OCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.243893,'amu*angstrom^2'), symmetry=1, barrier=(5.60758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45237,'amu*angstrom^2'), symmetry=1, barrier=(33.3928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00852133,'amu*angstrom^2'), symmetry=1, barrier=(33.3912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00852043,'amu*angstrom^2'), symmetry=1, barrier=(33.3955,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49935,0.0637166,-0.000113998,1.1045e-07,-4.13908e-11,-50528.3,23.1705], Tmin=(100,'K'), Tmax=(811.943,'K')), NASAPolynomial(coeffs=[5.29859,0.0276388,-1.52741e-05,3.05609e-09,-2.15328e-13,-50573,9.15691], Tmin=(811.943,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-420.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2sCF) + group(Cs-OsOsOsH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(O)OC=O(7897)'],
    products = ['O=COC(O)OF(7852)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C=O(166)', 'O[CH]OF(7806)'],
    products = ['O=COC(O)OF(7852)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HCO(15)', '[O]C(O)OF(7898)'],
    products = ['O=COC(O)OF(7852)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'O=CO[CH]OF(2366)'],
    products = ['O=COC(O)OF(7852)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(OF)OC=O(7899)'],
    products = ['O=COC(O)OF(7852)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(126)', 'O=CO[CH]O(7900)'],
    products = ['O=COC(O)OF(7852)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=CO[C](O)OF(7901)'],
    products = ['O=COC(O)OF(7852)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=[C]OC(O)OF(7902)'],
    products = ['O=COC(O)OF(7852)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=COC(=O)O(7847)'],
    products = ['O=COC(O)OF(7852)'],
