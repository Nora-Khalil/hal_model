...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3025)', '[O]O[CH]F(283)'],
    products = ['F[CH]OO[C](F)F(4758)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(3031)', '[CH]F(230)'],
    products = ['F[CH]OO[C](F)F(4758)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[C](F)F(3031)', 'CHF(40)'],
    products = ['F[CH]OO[C](F)F(4758)'],
    transitionState = 'TS9',
