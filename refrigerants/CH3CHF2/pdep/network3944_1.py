...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.045,0.0557245,-5.74333e-05,2.91449e-08,-5.65836e-12,33557.6,24.6827], Tmin=(100,'K'), Tmax=(1358.36,'K')), NASAPolynomial(coeffs=[15.6276,0.00938899,-2.5186e-06,3.5421e-10,-2.10442e-14,29909,-48.9839], Tmin=(1358.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(dioxirane) + radical(Cs_P) + radical(Cds_P)"""),
)

species(
    label = 'O=C1O[CH][C]1CF(11993)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {6,S} {7,S}
3  O u0 p2 c0 {7,D}
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC([O])=O(683)'],
    products = ['[CH]=C(CF)C([O])=O(8076)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C([O])=O(3943)'],
    products = ['[CH]=C(CF)C([O])=O(8076)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH]C(=C=O)CF(11934)'],
    products = ['[CH]=C(CF)C([O])=O(8076)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2F(46)', 'C#CC([O])=O(732)'],
    products = ['[CH]=C(CF)C([O])=O(8076)'],
