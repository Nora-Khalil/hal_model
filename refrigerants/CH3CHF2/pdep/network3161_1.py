...
"""),
    E0 = (-1260.09,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,431,527,613,668,835,1199,1245,1322,180,180,3788.99],'cm^-1')),
        HinderedRotor(inertia=(0.173834,'amu*angstrom^2'), symmetry=1, barrier=(3.99679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173944,'amu*angstrom^2'), symmetry=1, barrier=(3.99932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173892,'amu*angstrom^2'), symmetry=1, barrier=(3.99811,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173895,'amu*angstrom^2'), symmetry=1, barrier=(3.9982,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0658,0.0741725,-0.0001301,1.23435e-07,-4.52467e-11,-151457,26.0562], Tmin=(100,'K'), Tmax=(824.314,'K')), NASAPolynomial(coeffs=[6.03461,0.030872,-1.63873e-05,3.22952e-09,-2.25496e-13,-151625,6.99903], Tmin=(824.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1260.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFFO)"""),
)
...
"""),
    E0 = (-814.928,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,493,600,700,1144,1293,180,2331.8,2331.98],'cm^-1')),
        HinderedRotor(inertia=(0.292343,'amu*angstrom^2'), symmetry=1, barrier=(6.72154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.29225,'amu*angstrom^2'), symmetry=1, barrier=(6.7194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292374,'amu*angstrom^2'), symmetry=1, barrier=(6.72225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.29229,'amu*angstrom^2'), symmetry=1, barrier=(6.72031,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35924,0.0713773,-0.000141567,1.43573e-07,-5.40027e-11,-97930.9,25.529], Tmin=(100,'K'), Tmax=(850.909,'K')), NASAPolynomial(coeffs=[3.1561,0.0319162,-1.73318e-05,3.40243e-09,-2.35236e-13,-97113.9,23.7479], Tmin=(850.909,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-814.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFHO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-1032.69,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,431,527,613,668,835,1199,1245,1322,180,1990.64,1993.34,1994.83],'cm^-1')),
        HinderedRotor(inertia=(0.205307,'amu*angstrom^2'), symmetry=1, barrier=(4.72042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203127,'amu*angstrom^2'), symmetry=1, barrier=(4.67029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20269,'amu*angstrom^2'), symmetry=1, barrier=(4.66025,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60352,0.0715647,-0.000155576,1.7441e-07,-7.03397e-11,-124136,25.2902], Tmin=(100,'K'), Tmax=(842.551,'K')), NASAPolynomial(coeffs=[-2.95214,0.0459287,-2.57919e-05,5.1398e-09,-3.58937e-13,-121691,56.4438], Tmin=(842.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1032.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFFO) + radical(OCOJ)"""),
)

species(
    label = 'O[C](O)OC(F)(F)F(8487)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-1054.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,431,527,613,668,835,1199,1245,1322,360,370,350,180,2344.28,2363.32],'cm^-1')),
        HinderedRotor(inertia=(0.251504,'amu*angstrom^2'), symmetry=1, barrier=(5.78257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253275,'amu*angstrom^2'), symmetry=1, barrier=(5.8233,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250674,'amu*angstrom^2'), symmetry=1, barrier=(5.7635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250793,'amu*angstrom^2'), symmetry=1, barrier=(5.76622,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08968,0.0750595,-0.000141046,1.36211e-07,-4.98203e-11,-126774,26.6584], Tmin=(100,'K'), Tmax=(839.924,'K')), NASAPolynomial(coeffs=[5.91751,0.0284213,-1.55266e-05,3.06477e-09,-2.13027e-13,-126751,9.17445], Tmin=(839.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1054.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFFO) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'OC(O)O[C](F)F(8485)'],
    products = ['OC(O)OC(F)(F)F(8452)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(7)', 'O[CH]OC(F)(F)F(5112)'],
    products = ['OC(O)OC(F)(F)F(8452)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(O)OC(F)(F)F(8486)'],
    products = ['OC(O)OC(F)(F)F(8452)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O[C](O)OC(F)(F)F(8487)'],
    products = ['OC(O)OC(F)(F)F(8452)'],
    transitionState = 'TS8',
