...
reaction(
    label = 'reaction1',
    reactants = ['C[C]=CC=[C]C(6393)'],
    products = ['C#CC(5436)', 'C#CC(5436)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'C=C=CC=[C]C(6738)'],
    products = ['C[C]=CC=[C]C(6393)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C#CC(5436)', '[CH]=[C]C(5437)'],
    products = ['C[C]=CC=[C]C(6393)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]C(5437)', '[CH]=[C]C(5437)'],
    products = ['C[C]=CC=[C]C(6393)'],
    transitionState = 'TS7',
