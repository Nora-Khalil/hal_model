...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40856,0.0502051,-3.43804e-05,1.17851e-08,-1.63155e-12,-7692.2,21.1941], Tmin=(100,'K'), Tmax=(1675.91,'K')), NASAPolynomial(coeffs=[13.477,0.0214006,-8.59939e-06,1.52962e-09,-1.01703e-13,-11737.3,-43.2608], Tmin=(1675.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-64.7786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (103.848,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,623.803,1037.85],'cm^-1')),
        HinderedRotor(inertia=(0.226639,'amu*angstrom^2'), symmetry=1, barrier=(5.21087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13115,'amu*angstrom^2'), symmetry=1, barrier=(26.0074,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48056,0.0474317,-2.28175e-05,-1.83109e-09,3.32017e-12,12587.5,23.4237], Tmin=(100,'K'), Tmax=(1102.02,'K')), NASAPolynomial(coeffs=[11.8486,0.0238209,-9.766e-06,1.81954e-09,-1.27322e-13,9450.85,-31.4666], Tmin=(1102.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-CdHH)(F1s)(H)) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CCC[CH]F(10866)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
...
"""),
    E0 = (210.065,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,3120,650,792.5,1650,308.443,662.894],'cm^-1')),
        HinderedRotor(inertia=(0.114041,'amu*angstrom^2'), symmetry=1, barrier=(2.62202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562668,'amu*angstrom^2'), symmetry=1, barrier=(12.9368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562159,'amu*angstrom^2'), symmetry=1, barrier=(12.9251,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63593,0.0533854,-4.39557e-05,1.98751e-08,-3.8207e-12,25348.8,23.2913], Tmin=(100,'K'), Tmax=(1197.11,'K')), NASAPolynomial(coeffs=[9.1419,0.028305,-1.25294e-05,2.37385e-09,-1.65782e-13,23551.7,-14.271], Tmin=(1197.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-CsHH)(F1s)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=CCCF(6422)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {1,S} {2,S} {9,S} {10,S}
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(395)', '[CH2]C[CH]F(229)'],
    products = ['C=[C]CC[CH]F(10169)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C=CC[CH]F(6415)'],
    products = ['C=[C]CC[CH]F(10169)'],
