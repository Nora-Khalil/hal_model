...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(1266)', '[C]=C(395)'],
    products = ['C=[C]OC([O])=O(1403)'],
    transitionState = 'TS2',
