...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71928,0.0330693,2.72129e-05,-7.13734e-08,3.3391e-11,-30329.7,12.3991], Tmin=(100,'K'), Tmax=(922.365,'K')), NASAPolynomial(coeffs=[18.3641,0.00512583,7.10957e-07,-2.1782e-10,1.04875e-14,-35282.1,-76.7587], Tmin=(922.365,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + ring(2,3-Dihydrofuran) + radical(C=COJ) + radical(C=CCJCO)"""),
)
...
"""),
    E0 = (119.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,259,529,569,1128,1321,1390,3140,1855,455,950,180,1179.09,1179.11,1180.26,1180.26,1374.24],'cm^-1')),
        HinderedRotor(inertia=(0.16746,'amu*angstrom^2'), symmetry=1, barrier=(3.85023,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5828,0.0237842,6.41413e-06,-2.29382e-08,9.5649e-12,14450.3,21.0713], Tmin=(100,'K'), Tmax=(1036.54,'K')), NASAPolynomial(coeffs=[9.04595,0.0158348,-6.6714e-06,1.29296e-09,-9.37108e-14,12197.6,-14.7448], Tmin=(1036.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cds-OdCsH) + ring(Cs(F)-Cs-Cs) + radical(CCJCC=O) + radical(CC(C)CJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90093,0.0293541,3.19435e-05,-7.37352e-08,3.36949e-11,37979.5,22.8891], Tmin=(100,'K'), Tmax=(923.605,'K')), NASAPolynomial(coeffs=[17.491,0.00525677,5.60836e-07,-1.81923e-10,7.79282e-15,33247.7,-61.1107], Tmin=(923.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + ring(Cs(F)-Cs-Cs) + ring(dioxirane) + radical(Csj(Cs-CsCsH)(Cs-CsF1sH)(H)_ring) + radical(Cs_P)"""),
)

species(
    label = '[O][C]1OC2C(F)C12(8861)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u1 p2 c0 {7,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19643,0.0343615,-1.25408e-05,-3.34682e-09,2.0439e-12,6416.71,18.0972], Tmin=(100,'K'), Tmax=(1359.71,'K')), NASAPolynomial(coeffs=[11.1497,0.020103,-1.01377e-05,2.00893e-09,-1.42168e-13,2865.23,-31.9545], Tmin=(1359.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.7766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + polycyclic(s2_3_4_ane) + radical(CCOJ) + radical(Cs_P)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23438,0.0369427,-2.02057e-05,4.12857e-09,-2.01462e-13,7597.96,17.0691], Tmin=(100,'K'), Tmax=(1804.05,'K')), NASAPolynomial(coeffs=[14.4638,0.0160156,-7.951e-06,1.50138e-09,-1.00884e-13,2178.44,-51.9374], Tmin=(1804.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.6313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(CsCsCsFH) + polycyclic(s2_3_3_ane) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.19649,0.0260038,-1.18964e-05,1.44671e-09,2.0629e-14,-1313.96,12.9966], Tmin=(100,'K'), Tmax=(2674.99,'K')), NASAPolynomial(coeffs=[34.8992,-0.00808036,5.84549e-07,-1.10377e-11,2.40192e-15,-21971.1,-173.245], Tmin=(2674.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.6088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)O2s) + ring(Cd-Cs(F)-Cd) + radical(CCOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.65185,0.027354,-9.31419e-06,-1.3847e-09,9.17535e-13,15324.9,16.0787], Tmin=(100,'K'), Tmax=(1526.49,'K')), NASAPolynomial(coeffs=[8.68234,0.0191575,-8.73375e-06,1.62584e-09,-1.10079e-13,12597.6,-18.4682], Tmin=(1526.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)(Cds-Cds)(Cds-Cds)H) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + ring(Cyclopropene) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00635313,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.0573,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.90132,0.0210355,5.8943e-07,-8.89127e-09,2.96236e-12,33666.9,16.0666], Tmin=(100,'K'), Tmax=(1328.43,'K')), NASAPolynomial(coeffs=[6.74001,0.019599,-9.21806e-06,1.76647e-09,-1.22792e-13,31753.9,-6.90472], Tmin=(1328.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)(Cds-Cds)(Cds-Cds)H) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + ring(Cyclopropene) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[O]C(=O)[C]1CC1F(8069)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u1 p2 c0 {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.65709,0.0285462,-3.18879e-06,-7.13966e-09,2.31314e-12,-15144.9,20.2375], Tmin=(100,'K'), Tmax=(1514.84,'K')), NASAPolynomial(coeffs=[8.85067,0.0248714,-1.21053e-05,2.30989e-09,-1.58243e-13,-18476.2,-17.0171], Tmin=(1514.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cds-OdCsOs) + ring(Cs(F)-Cs-Cs) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10753,0.0289295,1.80888e-05,-4.61544e-08,1.9811e-11,23936.4,24.317], Tmin=(100,'K'), Tmax=(987.765,'K')), NASAPolynomial(coeffs=[13.3871,0.0138451,-5.46201e-06,1.09596e-09,-8.38625e-14,20215.6,-37.5162], Tmin=(987.765,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdCsOs) + ring(Cyclopropane) + radical(CCJCC=O) + radical(CCJCC=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(=O)C1[CH]C1F(8602)'],
    products = ['[O]C1=C[CH]C(F)O1(8859)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.87873e+12,'s^-1'), n=0.324012, Ea=(87.7879,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O=[C]C1[CH]C1F(8765)'],
    products = ['[O]C(=O)C1[CH]C1F(8602)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C1[CH]C1F(8602)'],
    products = ['FC1[CH]C1[C]1OO1(8860)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(394.234,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_O]
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C1[CH]C1F(8602)'],
    products = ['[O][C]1OC2C(F)C12(8861)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.46839e+08,'s^-1'), n=0.920995, Ea=(132.154,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_csHCs] for rate rule [R4_S_CO;carbonyl_intra;radadd_intra_csHCs]
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)C1[CH]C1F(8602)'],
    products = ['[O]C1([O])C2C(F)C21(8862)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(6.44049e+09,'s^-1'), n=0.679905, Ea=(142.574,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_csHNd] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_csHNd]
Euclidian distance = 1.4142135623730951
...
reaction(
    ...
    kinetics = Arrhenius(A=(306.062,'m^3/(mol*s)'), n=1.16366, Ea=(14.4837,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C1=CC1F(8864)'],
    products = ['[O]C(=O)C1[CH]C1F(8602)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)C1C=C1(8865)'],
    products = ['[O]C(=O)C1[CH]C1F(8602)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(3.15e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(38.3613,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(5.33888e+13,'m^3/(mol*s)'), n=-2.06969, Ea=(96.6863,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.21909771748945858, var=15.050572460742625, Tref=1000.0, N=2985, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', '[O]C(=O)[C]1C=C1(8867)'],
    products = ['[O]C(=O)C1[CH]C1F(8602)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(562.232,'m^3/(mol*s)'), n=1.03051, Ea=(225.467,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(=O)C1[CH]C1F(8602)'],
    products = ['O=C(O)C1[CH][C]1F(8869)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=C(OF)C1[CH][CH]1(8870)'],
    products = ['[O]C(=O)C1[CH]C1F(8602)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(87.559,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)
