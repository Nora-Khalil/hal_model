...
"""),
    E0 = (-91.5631,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([162,485,641,721,926,1292,1380,3063,2950,3100,1380,975,1025,1650,1685,370,1855,455,950,305.702,305.707],'cm^-1')),
        HinderedRotor(inertia=(0.465226,'amu*angstrom^2'), symmetry=1, barrier=(30.8532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.673532,'amu*angstrom^2'), symmetry=1, barrier=(44.6679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.465224,'amu*angstrom^2'), symmetry=1, barrier=(30.853,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7273,0.0511366,-4.82243e-05,2.324e-08,-4.58364e-12,-10931.7,21.7157], Tmin=(100,'K'), Tmax=(1195.61,'K')), NASAPolynomial(coeffs=[10.8005,0.0207812,-1.01406e-05,2.00463e-09,-1.43342e-13,-13101.3,-23.6784], Tmin=(1195.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.5631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cdj(Cs-F1sO2sH)(Cd-HH)) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94675,0.0497003,-4.71709e-05,2.34687e-08,-4.93882e-12,-38363.6,19.0702], Tmin=(100,'K'), Tmax=(1098.44,'K')), NASAPolynomial(coeffs=[8.86266,0.0245159,-1.27797e-05,2.59594e-09,-1.88278e-13,-39882.9,-14.9443], Tmin=(1098.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-319.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCddFO) + group(Cds-CdsHH) + group(Cds-OdOsH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (-123.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,2950,3100,1380,975,1025,1650,540,610,2055,1855,455,950,258.243,259.343,739.19],'cm^-1')),
        HinderedRotor(inertia=(0.591245,'amu*angstrom^2'), symmetry=1, barrier=(28.1179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.732041,'amu*angstrom^2'), symmetry=1, barrier=(35.3407,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57278,0.0575253,-6.59151e-05,4.0452e-08,-1.02341e-11,-20059.6,19.9772], Tmin=(100,'K'), Tmax=(945.713,'K')), NASAPolynomial(coeffs=[9.62176,0.0234815,-1.19184e-05,2.38805e-09,-1.71949e-13,-21582,-18.4053], Tmin=(945.713,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCFO) + group(Cds-OdOsH) + radical(Allyl_P) + radical((O)CJOC)"""),
)

species(
    label = '[CH]=CC(F)O[C]=O(8034)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-86.9152,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([236,527,855,1015,1182,1348,3236,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,1855,455,950,259.149,259.159],'cm^-1')),
        HinderedRotor(inertia=(0.890636,'amu*angstrom^2'), symmetry=1, barrier=(42.4617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.890677,'amu*angstrom^2'), symmetry=1, barrier=(42.4623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.556967,'amu*angstrom^2'), symmetry=1, barrier=(26.5549,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7836,0.0516928,-5.03981e-05,2.56603e-08,-5.42383e-12,-10376.1,20.74], Tmin=(100,'K'), Tmax=(1111.05,'K')), NASAPolynomial(coeffs=[9.79806,0.0228393,-1.14439e-05,2.28658e-09,-1.64475e-13,-12157,-18.7692], Tmin=(1111.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.9152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P) + radical((O)CJOC)"""),
)

species(
    label = '[CH2][C]=C(F)OC=O(8035)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84576,0.0528052,-5.67747e-05,3.41428e-08,-8.81303e-12,-13660.8,21.1904], Tmin=(100,'K'), Tmax=(908.261,'K')), NASAPolynomial(coeffs=[7.70111,0.0270185,-1.41885e-05,2.88478e-09,-2.0936e-13,-14724.4,-6.49499], Tmin=(908.261,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCFO) + group(Cds-OdOsH) + radical(Allyl_P) + radical(Cdj(Cs-HHH)(Cd-F1sO2s))"""),
)

species(
    label = '[CH]=[C]C(F)OC=O(8036)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {5,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.42299,'amu*angstrom^2'), symmetry=1, barrier=(32.7174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.035889,'amu*angstrom^2'), symmetry=1, barrier=(32.7122,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78748,0.0478032,-3.99303e-05,1.62378e-08,-2.67006e-12,-4840.94,23.2725], Tmin=(100,'K'), Tmax=(1417.66,'K')), NASAPolynomial(coeffs=[12.0448,0.0188614,-9.30743e-06,1.83713e-09,-1.30529e-13,-7749.22,-29.7931], Tmin=(1417.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.9154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cdj(Cs-F1sO2sH)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = 'C=C(F)[CH]O[C]=O(8037)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01706,0.0468306,-4.47272e-05,2.34169e-08,-5.2059e-12,-23737.5,22.4227], Tmin=(100,'K'), Tmax=(1048.6,'K')), NASAPolynomial(coeffs=[8.11661,0.0235636,-1.14447e-05,2.25731e-09,-1.61267e-13,-25016.7,-7.2937], Tmin=(1048.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-197.936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(C=CCJ(O)C) + radical((O)CJOCC)"""),
)

species(
    label = 'C=[C][CH]OC(=O)F(8038)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23387,0.0436175,-4.06934e-05,2.35234e-08,-6.3144e-12,-20613,23.0842], Tmin=(100,'K'), Tmax=(843.297,'K')), NASAPolynomial(coeffs=[5.32003,0.0289788,-1.46547e-05,2.93835e-09,-2.11805e-13,-21133.5,8.72124], Tmin=(843.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(COFOO) + radical(C=CCJ(O)C) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', 'C=[C]C([O])F(714)'],
    products = ['C=[C]C(F)O[C]=O(7385)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]O[CH]F(297)', '[C]=C(395)'],
    products = ['C=[C]C(F)O[C]=O(7385)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C=CO[C]=O(6624)'],
    products = ['C=[C]C(F)O[C]=O(7385)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C=C(F)O[C]=O(8031)'],
    products = ['C=[C]C(F)O[C]=O(7385)'],
