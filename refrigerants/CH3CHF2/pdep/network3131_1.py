...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21839,0.0458794,-4.65218e-05,6.22313e-09,1.79695e-11,-8061.51,18.296], Tmin=(100,'K'), Tmax=(512.891,'K')), NASAPolynomial(coeffs=[6.50208,0.0232706,-1.19837e-05,2.38301e-09,-1.69428e-13,-8642.96,-0.894847], Tmin=(512.891,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.5051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CdCddFO) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (84.4996,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,197,221,431,657,2950,3100,1380,975,1025,1650,540,610,2055,2685.37],'cm^-1')),
        HinderedRotor(inertia=(0.49054,'amu*angstrom^2'), symmetry=1, barrier=(11.2785,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07054,0.048551,-8.234e-05,7.70355e-08,-2.78828e-11,10226.5,19.509], Tmin=(100,'K'), Tmax=(836.629,'K')), NASAPolynomial(coeffs=[5.20277,0.0210747,-1.06645e-05,2.06126e-09,-1.42355e-13,10139.9,7.57118], Tmin=(836.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.4996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CdCddFO) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)

species(
    label = 'C#CC(F)O[O](9088)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {3,S} {4,S}
3 O u1 p2 c0 {2,S}
...
"""),
    E0 = (10.0468,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,242,464,653,889,1056,1342,3790,2175,525,750,770,3400,2100],'cm^-1')),
        HinderedRotor(inertia=(1.87958,'amu*angstrom^2'), symmetry=1, barrier=(43.2153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.87905,'amu*angstrom^2'), symmetry=1, barrier=(43.203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74563,0.0522081,-7.77744e-05,6.08109e-08,-1.86017e-11,1287.04,17.2689], Tmin=(100,'K'), Tmax=(874.153,'K')), NASAPolynomial(coeffs=[9.17837,0.0143221,-6.11513e-06,1.08967e-09,-7.17751e-14,135.61,-16.7433], Tmin=(874.153,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.0468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + group(Ct-CtCs) + group(Ct-CtH) + radical(ROOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.83003,0.0137932,8.29654e-05,-2.87964e-07,2.71438e-10,-11602.8,10.4346], Tmin=(10,'K'), Tmax=(382.418,'K')), NASAPolynomial(coeffs=[4.92546,0.0204108,-1.38922e-05,4.48716e-09,-5.49248e-13,-11818.7,4.47462], Tmin=(382.418,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-96.4631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), label="""CD[C]C(DO)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = '[CH]=[C]C(F)OO(9092)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (181.637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,162,485,641,721,926,1292,1380,3063,1685,370,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(1.20836,'amu*angstrom^2'), symmetry=1, barrier=(27.7825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20509,'amu*angstrom^2'), symmetry=1, barrier=(27.7073,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64228,0.0551855,-6.94597e-05,4.51536e-08,-1.17924e-11,21927.9,20.8598], Tmin=(100,'K'), Tmax=(929.032,'K')), NASAPolynomial(coeffs=[10.3293,0.0177827,-9.06956e-06,1.81788e-09,-1.30818e-13,20313.8,-20.4107], Tmin=(929.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sO2sH)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = 'C=[C][CH]OOF(9093)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (374.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370],'cm^-1')),
        HinderedRotor(inertia=(1.70763,'amu*angstrom^2'), symmetry=1, barrier=(39.2618,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79596,0.0440972,-3.90397e-05,1.68101e-08,-2.86278e-12,45176.6,22.0511], Tmin=(100,'K'), Tmax=(1407.36,'K')), NASAPolynomial(coeffs=[12.7101,0.013077,-5.97765e-06,1.14859e-09,-8.07202e-14,42104.6,-34.333], Tmin=(1407.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sFO) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJO) + radical(Cds_S)"""),
)

species(
    label = 'C=C(F)[CH]O[O](9094)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {3,S} {5,S}
3 O u1 p2 c0 {2,S}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79573,0.0423188,-3.75736e-05,1.65961e-08,-2.8838e-12,-1684.18,21.0546], Tmin=(100,'K'), Tmax=(1394.47,'K')), NASAPolynomial(coeffs=[12.4893,0.0116446,-4.57816e-06,8.21689e-10,-5.57852e-14,-4666.58,-34.0917], Tmin=(1394.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-14.7058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=CCJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]C(F)O[O](7445)'],
    products = ['O=O(143)', 'C=C=CF(6101)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(8.59935,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C=[C]C([O])F(714)'],
    products = ['C=[C]C(F)O[O](7445)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[CH]F(283)', '[C]=C(395)'],
    products = ['C=[C]C(F)O[O](7445)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C=CO[O](6465)'],
    products = ['C=[C]C(F)O[O](7445)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(50.5638,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.6844e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(4.84183,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C][CH]OOF(9093)'],
    products = ['C=[C]C(F)O[O](7445)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(109.509,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction17',
    reactants = ['C=[C]C(F)O[O](7445)'],
    products = ['C=C(F)[CH]O[O](9094)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(5.38157e+14,'s^-1'), n=-0.447076, Ea=(141.12,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.08474952276158404, var=26.08378321593064, Tref=1000.0, N=4, data_mean=0.0, correlation='R2F_Ext-1R!H-R',), comment="""Estimated from node R2F_Ext-1R!H-R"""),
)
