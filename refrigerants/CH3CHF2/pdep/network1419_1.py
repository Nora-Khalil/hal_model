...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH]C(=C)F(4004)'],
    products = ['[CH]=C(F)C[C]=O(3965)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C=C=O(3956)'],
    products = ['[CH]=C(F)C[C]=O(3965)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C[C]=O(4066)'],
    products = ['[CH]=C(F)C[C]=O(3965)'],
