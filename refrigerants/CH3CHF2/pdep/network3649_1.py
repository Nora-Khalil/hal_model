...
"""),
    E0 = (326.683,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,283.39,284.767,2010.79],'cm^-1')),
        HinderedRotor(inertia=(0.00208928,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266998,'amu*angstrom^2'), symmetry=1, barrier=(15.3085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399557,'amu*angstrom^2'), symmetry=1, barrier=(22.926,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62605,0.0499182,-4.29596e-05,2.01762e-08,-3.89528e-12,39378.3,24.69], Tmin=(100,'K'), Tmax=(1228.73,'K')), NASAPolynomial(coeffs=[10.2659,0.0217919,-8.62349e-06,1.54657e-09,-1.04831e-13,37255.1,-18.772], Tmin=(1228.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(C=CJO)"""),
)
...
"""),
    E0 = (449.302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1670,1700,300,440,236.856,236.918,813.763],'cm^-1')),
        HinderedRotor(inertia=(0.00300515,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353759,'amu*angstrom^2'), symmetry=1, barrier=(14.0472,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.57724,0.0314762,-2.41567e-05,1.0473e-08,-1.95412e-12,54089.6,21.7106], Tmin=(100,'K'), Tmax=(1223.61,'K')), NASAPolynomial(coeffs=[6.74787,0.0178427,-7.44381e-06,1.36741e-09,-9.37674e-14,53068.9,0.748007], Tmin=(1223.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57314,0.0400648,3.81839e-06,-4.05038e-08,2.01997e-11,45878.2,22.7808], Tmin=(100,'K'), Tmax=(953.298,'K')), NASAPolynomial(coeffs=[16.117,0.0118367,-3.3714e-06,6.13834e-10,-4.76883e-14,41615,-54.5057], Tmin=(953.298,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C2CsJOC(O)) + radical(C=CJO)"""),
)
...
"""),
    E0 = (334.035,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,647.683],'cm^-1')),
        HinderedRotor(inertia=(0.43328,'amu*angstrom^2'), symmetry=1, barrier=(17.1315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.057555,'amu*angstrom^2'), symmetry=1, barrier=(17.1316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.74512,'amu*angstrom^2'), symmetry=1, barrier=(17.1318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26345,0.0526331,-3.61965e-05,3.56581e-09,4.19315e-12,40280.5,23.2652], Tmin=(100,'K'), Tmax=(958.124,'K')), NASAPolynomial(coeffs=[14.4028,0.0152319,-4.96665e-06,8.48082e-10,-5.84968e-14,36961.6,-43.7431], Tmin=(958.124,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(334.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(C)O[C]=C(6345)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (414.863,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,218.603,219.707],'cm^-1')),
        HinderedRotor(inertia=(0.400787,'amu*angstrom^2'), symmetry=1, barrier=(13.6646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.40145,'amu*angstrom^2'), symmetry=1, barrier=(13.6783,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00303539,'amu*angstrom^2'), symmetry=1, barrier=(22.5468,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83061,0.0499527,-4.57598e-05,2.41742e-08,-5.46699e-12,49972.7,24.3695], Tmin=(100,'K'), Tmax=(1033.02,'K')), NASAPolynomial(coeffs=[7.87861,0.0265339,-1.17541e-05,2.22821e-09,-1.55821e-13,48723.2,-5.00498], Tmin=(1033.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)OC=C(6493)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {3,S}
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37464,0.0484565,-1.57122e-05,-1.40828e-08,8.84427e-12,36028.8,23.5761], Tmin=(100,'K'), Tmax=(1000.82,'K')), NASAPolynomial(coeffs=[12.5705,0.023878,-9.10221e-06,1.64915e-09,-1.15072e-13,32777.7,-35.4931], Tmin=(1000.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C#CO[C]([CH2])C(6494)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {5,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
...
"""),
    E0 = (378.61,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.800684,'amu*angstrom^2'), symmetry=1, barrier=(18.4093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.799462,'amu*angstrom^2'), symmetry=1, barrier=(18.3812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800901,'amu*angstrom^2'), symmetry=1, barrier=(18.4143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.799575,'amu*angstrom^2'), symmetry=1, barrier=(18.3838,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481117,0.0789479,-0.000108823,7.59558e-08,-2.06435e-11,45661.6,21.0657], Tmin=(100,'K'), Tmax=(908.413,'K')), NASAPolynomial(coeffs=[14.48,0.0173048,-7.03207e-06,1.25053e-09,-8.34305e-14,43118.4,-45.1254], Tmin=(908.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C]=C(560)'],
    products = ['[CH2]C(=C)O[C]=C(6492)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]C(=C)O[C]=C(6492)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2.0603e-20,'m^3/(mol*s)'), n=7.37188, Ea=(11.1644,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.4161614592809219, var=2.5944177025948685, Tref=1000.0, N=250, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_N-Sp-2R!H#1R!H_Sp-4R!H-3R_Ext-1R!H-R_N-6R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_N-Sp-2R!H#1R!H_Sp-4R!H-3R_Ext-1R!H-R_N-6R!H-inRing"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(1.98908,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[CH]=COC([CH2])=C(11081)'],
    products = ['[CH2]C(=C)O[C]=C(6492)'],
