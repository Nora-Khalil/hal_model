...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6207,0.0426021,-1.46276e-05,-1.16239e-08,7.0048e-12,-21302.7,15.2304], Tmin=(100,'K'), Tmax=(1071.61,'K')), NASAPolynomial(coeffs=[13.5121,0.0180771,-8.10053e-06,1.61162e-09,-1.18033e-13,-24991.7,-48.2823], Tmin=(1071.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(CdCCF) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=C=C(F)C=CF(8097)',
...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,540,610,2055,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(1.34243,'amu*angstrom^2'), symmetry=1, barrier=(30.8651,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54784,0.061046,-7.70961e-05,3.84981e-08,1.75701e-12,13912.3,19.464], Tmin=(100,'K'), Tmax=(572.381,'K')), NASAPolynomial(coeffs=[8.99103,0.0223906,-1.08067e-05,2.06886e-09,-1.43131e-13,12841.4,-14.2039], Tmin=(572.381,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(CdCFH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cdj(Cd-CdH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.738098,'amu*angstrom^2'), symmetry=1, barrier=(16.9703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49005,'amu*angstrom^2'), symmetry=1, barrier=(34.2591,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46331,0.0637166,-0.000106854,9.93421e-08,-3.57253e-11,22964.4,21.3282], Tmin=(100,'K'), Tmax=(842.705,'K')), NASAPolynomial(coeffs=[5.54915,0.0279008,-1.38721e-05,2.65883e-09,-1.82683e-13,22858.9,5.77533], Tmin=(842.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(CtCF) + radical(Cds_S)"""),
)

species(
    label = 'C#CC(F)C=[C]F(8100)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.50721,'amu*angstrom^2'), symmetry=1, barrier=(34.6537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50532,'amu*angstrom^2'), symmetry=1, barrier=(34.6103,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28274,0.0642864,-9.67579e-05,7.95444e-08,-2.59036e-11,13382.6,20.5281], Tmin=(100,'K'), Tmax=(838.055,'K')), NASAPolynomial(coeffs=[8.84788,0.022034,-1.01347e-05,1.88781e-09,-1.28152e-13,12330.4,-13.3455], Tmin=(838.055,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(CdCFH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72038,0.0487787,-5.58909e-05,3.38717e-08,-8.09858e-12,56309.1,18.7951], Tmin=(100,'K'), Tmax=(1026.44,'K')), NASAPolynomial(coeffs=[10.648,0.0139873,-5.04675e-06,8.47934e-10,-5.51054e-14,54476.4,-24.5082], Tmin=(1026.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(467.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(C=CJC=C) + radical(Cdj(Cdd-Cd)(F1s))"""),
)

species(
    label = '[CH2]C=C(F)C=[C]F(8102)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57625,0.0531203,-4.89248e-05,2.40014e-08,-4.83924e-12,5473.19,21.4142], Tmin=(100,'K'), Tmax=(1174.79,'K')), NASAPolynomial(coeffs=[10.5445,0.0225849,-9.9365e-06,1.8765e-09,-1.30986e-13,3366.03,-23.297], Tmin=(1174.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.7799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCCF) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(C=CC=CCJ) + radical(Cdj(Cd-CdH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.928314,'amu*angstrom^2'), symmetry=1, barrier=(21.3438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.928956,'amu*angstrom^2'), symmetry=1, barrier=(21.3585,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62502,0.0593392,-6.88509e-05,3.40415e-08,8.36596e-13,23127.4,22.1409], Tmin=(100,'K'), Tmax=(562.536,'K')), NASAPolynomial(coeffs=[7.49873,0.028199,-1.41487e-05,2.79136e-09,-1.97907e-13,22298.5,-4.31149], Tmin=(562.536,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_P) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'C=CC(F)[C]=[C]F(8105)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {1,S} {4,S} {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27482,0.0660632,-0.000100376,8.84344e-08,-3.15071e-11,21664.5,23.3239], Tmin=(100,'K'), Tmax=(785.925,'K')), NASAPolynomial(coeffs=[6.98196,0.0290807,-1.46457e-05,2.86517e-09,-2.00903e-13,21012.5,-1.27571], Tmin=(785.925,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', 'F[C]C=CF(4009)'],
    products = ['C=[C]C(F)C=[C]F(7490)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=C=C(F)C=[C]F(8098)'],
    products = ['C=[C]C(F)C=[C]F(7490)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=[C]C(F)C#CF(8099)'],
    products = ['C=[C]C(F)C=[C]F(7490)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C#CC(F)C=[C]F(8100)'],
    products = ['C=[C]C(F)C=[C]F(7490)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'C=[C]C=C=[C]F(8101)'],
    products = ['C=[C]C(F)C=[C]F(7490)'],
