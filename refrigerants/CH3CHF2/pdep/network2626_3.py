...
reaction(
    label = 'reaction19',
    reactants = ['CHF(40)', 'CH2F(46)'],
    products = ['CH2F-CHF(66)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'CH2CHF(56)'],
    products = ['CH2F-CHF(66)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(62.9369,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[CH2][CH]F(233)'],
    products = ['CH2F-CHF(66)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[CH][CH]F(5595)'],
    products = ['CH2F-CHF(66)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.67213e+27,'m^3/(mol*s)'), n=-7.16302, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3351504735852967, var=16.804457517960397, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_N-5CF->C_Sp-4C-2C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_N-5CF->C_Sp-4C-2C
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'F[C]CF(279)'],
    products = ['CH2F-CHF(66)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.75,'m^3/(mol*s)'), n=-0.32, Ea=(6.06212,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_3R->H_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CH2F-CHF(66)'],
    products = ['CHF2-CH2(64)'],
    transitionState = 'TS9',
