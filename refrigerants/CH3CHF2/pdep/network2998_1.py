...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.474138,'amu*angstrom^2'), symmetry=1, barrier=(19.7067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.62675,'amu*angstrom^2'), symmetry=1, barrier=(37.4023,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28236,0.0603307,-6.65278e-05,3.90948e-08,-9.24536e-12,2461.71,22.2115], Tmin=(100,'K'), Tmax=(1024.63,'K')), NASAPolynomial(coeffs=[11.345,0.0210479,-9.02055e-06,1.67856e-09,-1.16228e-13,399.592,-26.58], Tmin=(1024.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.6577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_P) + radical(C=C=CJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.602433,'amu*angstrom^2'), symmetry=1, barrier=(13.8511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.602399,'amu*angstrom^2'), symmetry=1, barrier=(13.8503,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1531,0.065942,-8.28511e-05,5.53644e-08,-1.48852e-11,22851.1,21.2066], Tmin=(100,'K'), Tmax=(904.509,'K')), NASAPolynomial(coeffs=[11.0204,0.0223053,-1.04849e-05,2.02651e-09,-1.42798e-13,21066.1,-25.4072], Tmin=(904.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCCF) + group(CdCFH) + group(Cds-CdsHH) + radical(CdCdF1s) + radical(Cdj(Cd-CdF1s)(H))"""),
)

species(
    label = 'C=C(F)C(=C)[C]F(8187)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52562,0.0570898,-5.77576e-05,3.04952e-08,-6.61579e-12,6859.8,19.32], Tmin=(100,'K'), Tmax=(1092.89,'K')), NASAPolynomial(coeffs=[10.729,0.0234058,-1.15265e-05,2.29446e-09,-1.64896e-13,4848.13,-25.8984], Tmin=(1092.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.3131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]=C=C([CH]F)CF(8188)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27725,0.0635574,-7.95105e-05,5.52686e-08,-1.56846e-11,6299.29,22.2925], Tmin=(100,'K'), Tmax=(854.23,'K')), NASAPolynomial(coeffs=[9.54643,0.0248357,-1.15157e-05,2.20263e-09,-1.53975e-13,4886.55,-16.2985], Tmin=(854.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.5871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CsCdF1sH) + radical(C=C=CJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.848122,'amu*angstrom^2'), symmetry=1, barrier=(19.5,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.851521,'amu*angstrom^2'), symmetry=1, barrier=(19.5781,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19477,0.0648546,-7.71346e-05,4.79173e-08,-1.19973e-11,23668.9,21.6015], Tmin=(100,'K'), Tmax=(966.559,'K')), NASAPolynomial(coeffs=[11.5335,0.0220687,-1.07347e-05,2.11885e-09,-1.51471e-13,21670.4,-27.925], Tmin=(966.559,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(195.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cdj(Cd-CdF1s)(H))"""),
)

species(
    label = '[CH]C(=C)C(F)=CF(8191)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {4,S} {5,D} {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C([CH2])=CF(7486)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=C(F)C([CH2])=CF(7486)'],
    products = ['[CH]=C=C([CH2])C(F)F(8182)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH]C(F)=C=CF(4153)'],
    products = ['[CH]=C(F)C([CH2])=CF(7486)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(F)C([CH2])=CF(7486)'],
    products = ['[CH2]C1=C(F)[CH]C1F(8184)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C#CC([CH2])=CF(7768)'],
    products = ['[CH]=C(F)C([CH2])=CF(7486)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]F(230)', '[CH]C(F)=C=C(4056)'],
    products = ['[CH]=C(F)C([CH2])=CF(7486)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=C(F)C([CH2])=CF(7486)'],
    products = ['F[CH]C1=C(F)[CH]C1(8192)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', '[CH]C(F)=C=C(4056)'],
    products = ['[CH]=C(F)C([CH2])=CF(7486)'],
