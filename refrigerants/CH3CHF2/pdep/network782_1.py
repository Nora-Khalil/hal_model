...
"""),
    E0 = (79.7113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,180,478.756,479.184,481.916],'cm^-1')),
        HinderedRotor(inertia=(0.0149193,'amu*angstrom^2'), symmetry=1, barrier=(2.45449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273965,'amu*angstrom^2'), symmetry=1, barrier=(15.8819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0973758,'amu*angstrom^2'), symmetry=1, barrier=(15.8788,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47255,0.0511821,-4.15164e-05,1.7185e-08,-2.87284e-12,9681.58,24.9085], Tmin=(100,'K'), Tmax=(1413.65,'K')), NASAPolynomial(coeffs=[12.5242,0.0199107,-8.33472e-06,1.53671e-09,-1.05475e-13,6556.94,-32.2353], Tmin=(1413.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.7113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69588,0.0261546,6.55545e-05,-1.16437e-07,4.96077e-11,-23488.7,15.0478], Tmin=(100,'K'), Tmax=(940.903,'K')), NASAPolynomial(coeffs=[21.4398,0.00452986,6.91045e-07,-9.36725e-11,-6.29227e-15,-29962.4,-93.66], Tmin=(940.903,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92788,0.0418917,-2.91009e-05,1.00732e-08,-1.41747e-12,-13191.6,22.0108], Tmin=(100,'K'), Tmax=(1631.98,'K')), NASAPolynomial(coeffs=[11.2787,0.018973,-8.03566e-06,1.4681e-09,-9.92767e-14,-16243.7,-27.6814], Tmin=(1631.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (87.0633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,325.069,325.072,325.072],'cm^-1')),
        HinderedRotor(inertia=(0.251338,'amu*angstrom^2'), symmetry=1, barrier=(18.847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251335,'amu*angstrom^2'), symmetry=1, barrier=(18.847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251346,'amu*angstrom^2'), symmetry=1, barrier=(18.847,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13664,0.0536378,-3.41501e-05,2.91061e-10,5.10249e-12,10582.7,23.3849], Tmin=(100,'K'), Tmax=(996.722,'K')), NASAPolynomial(coeffs=[15.7423,0.0148022,-5.4713e-06,1.01834e-09,-7.36368e-14,6688.62,-51.9595], Tmin=(996.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.0633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2][CH]OC(C)=O(2443)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {5,S}
2  O u0 p2 c0 {4,D}
3  C u0 p0 c0 {4,S} {7,S} {8,S} {9,S}
...
"""),
    E0 = (101.102,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,360.919,360.921],'cm^-1')),
        HinderedRotor(inertia=(0.161217,'amu*angstrom^2'), symmetry=1, barrier=(14.9025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161217,'amu*angstrom^2'), symmetry=1, barrier=(14.9025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161217,'amu*angstrom^2'), symmetry=1, barrier=(14.9025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161217,'amu*angstrom^2'), symmetry=1, barrier=(14.9025,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01636,0.0577853,-4.76254e-05,1.28181e-08,1.32913e-12,12274.2,26.0837], Tmin=(100,'K'), Tmax=(977.735,'K')), NASAPolynomial(coeffs=[16.0716,0.0128843,-4.347e-06,7.68865e-10,-5.43701e-14,8532.42,-50.29], Tmin=(977.735,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=[C]OC[O](855)'],
    products = ['C=[C]OC(C)[O](2313)'],
    transitionState = 'TS2',
