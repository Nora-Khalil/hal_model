...
reaction(
    label = 'reaction2',
    reactants = ['C=C=C(O)COF(2171)'],
    products = ['C=C(O)C(=C)OF(2054)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(O)C([CH2])OF(2174)'],
    products = ['C=C(O)C(=C)OF(2054)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.437e+08,'s^-1'), n=1.045, Ea=(63.4002,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R3radExo;Y_rad;XH_Rrad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(OF)C([CH2])O(2175)'],
    products = ['C=C(O)C(=C)OF(2054)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.437e+08,'s^-1'), n=1.045, Ea=(63.4002,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R3radExo;Y_rad;XH_Rrad]
Euclidian distance = 0
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'C=[C]C(=C)OF(2178)'],
    products = ['C=C(O)C(=C)OF(2054)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(126)', 'C=[C]C(=C)O(2179)'],
    products = ['C=C(O)C(=C)OF(2054)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OF(202)', 'C=[C]O(137)'],
    products = ['C=C(O)C(=C)OF(2054)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH]=C(O)C(=C)OF(2180)'],
    products = ['C=C(O)C(=C)OF(2054)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH]=C(OF)C(=C)O(2181)'],
    products = ['C=C(O)C(=C)OF(2054)'],
