...
"""),
    E0 = (-137.88,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,395,473,707,1436,3000,3100,440,815,1455,1000,275.337,276.858],'cm^-1')),
        HinderedRotor(inertia=(0.136389,'amu*angstrom^2'), symmetry=1, barrier=(7.41386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140467,'amu*angstrom^2'), symmetry=1, barrier=(7.42441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.441292,'amu*angstrom^2'), symmetry=1, barrier=(23.0706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141457,'amu*angstrom^2'), symmetry=1, barrier=(7.41588,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
...
"""),
    E0 = (-105.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,391,562,707,872,1109,1210,1289,3137,3000,3100,440,815,1455,1000,180.031,216.851],'cm^-1')),
        HinderedRotor(inertia=(0.148316,'amu*angstrom^2'), symmetry=1, barrier=(4.80326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208673,'amu*angstrom^2'), symmetry=1, barrier=(4.80007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562893,'amu*angstrom^2'), symmetry=1, barrier=(18.6194,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03617,0.068668,-9.0086e-05,6.19385e-08,-1.70009e-11,-12628.3,24.9477], Tmin=(100,'K'), Tmax=(889.411,'K')), NASAPolynomial(coeffs=[11.5884,0.0212099,-1.00461e-05,1.94279e-09,-1.36743e-13,-14505.4,-24.724], Tmin=(889.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sH)) + radical(CJCO)"""),
)

species(
    label = 'C[C](OF)C([O])F(2092)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03742,0.0714855,-0.000112589,9.73836e-08,-3.32928e-11,-16418.1,24.7192], Tmin=(100,'K'), Tmax=(824.061,'K')), NASAPolynomial(coeffs=[8.32874,0.026406,-1.28991e-05,2.46909e-09,-1.70192e-13,-17290.9,-7.05048], Tmin=(824.061,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sH)) + radical(C2CsJO)"""),
)
...
"""),
    E0 = (-169.328,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,236,527,855,1015,1182,1348,3236,350,440,435,1725,3120,650,792.5,1650,211.21],'cm^-1')),
        HinderedRotor(inertia=(0.168654,'amu*angstrom^2'), symmetry=1, barrier=(5.33785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386042,'amu*angstrom^2'), symmetry=1, barrier=(12.3623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67805,'amu*angstrom^2'), symmetry=1, barrier=(38.5817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17956,0.0681896,-9.94353e-05,7.37153e-08,-2.03621e-11,-20269.6,22.6006], Tmin=(100,'K'), Tmax=(648.584,'K')), NASAPolynomial(coeffs=[9.95414,0.0220908,-1.13614e-05,2.24294e-09,-1.58348e-13,-21576.5,-17.2325], Tmin=(648.584,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(OF)C(O)F(2098)',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=CO)OF(1780)'],
    products = ['C=C(OF)C(O)F(2067)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(OF)C([O])F(2094)'],
    products = ['C=C(OF)C(O)F(2067)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', 'C=[C]C(O)F(2095)'],
    products = ['C=C(OF)C(O)F(2067)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]C(OF)=C(O)F(2096)'],
    products = ['C=C(OF)C(O)F(2067)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)C(O)F(2097)'],
    products = ['C=C(OF)C(O)F(2067)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=C(C=O)OF(2099)'],
    products = ['C=C(OF)C(O)F(2067)'],
