...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)OO[O](7120)'],
    products = ['O2(2)', 'FC1=CO1(4047)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]=C(F)O[O](1081)'],
    products = ['[CH]=C(F)OO[O](7120)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[O](127)', '[CH]=[C]F(1074)'],
    products = ['[CH]=C(F)OO[O](7120)'],
    transitionState = 'TS8',
