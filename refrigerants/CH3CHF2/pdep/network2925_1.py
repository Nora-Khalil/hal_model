...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.992043,'amu*angstrom^2'), symmetry=1, barrier=(22.809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.992734,'amu*angstrom^2'), symmetry=1, barrier=(22.8249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.991267,'amu*angstrom^2'), symmetry=1, barrier=(22.7912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.794682,0.0613429,-4.92654e-05,1.21642e-08,1.68386e-12,21032.1,26.7194], Tmin=(100,'K'), Tmax=(1001.34,'K')), NASAPolynomial(coeffs=[17.3604,0.0134698,-4.96696e-06,9.23899e-10,-6.68688e-14,16797,-57.8044], Tmin=(1001.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sO2sH)(Cd-HH)) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27603,0.0569526,-5.03826e-05,2.2798e-08,-4.16123e-12,-6579.82,23.3826], Tmin=(100,'K'), Tmax=(1303.38,'K')), NASAPolynomial(coeffs=[12.9362,0.0211681,-9.19963e-06,1.73327e-09,-1.20802e-13,-9619.33,-35.9604], Tmin=(1303.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.5428,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCddFO) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (184.201,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,540,610,2055,1685,370,344.698,344.698,344.699,344.699],'cm^-1')),
        HinderedRotor(inertia=(0.00141881,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0014188,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61116,0.0571228,-7.1378e-05,5.38838e-08,-1.72551e-11,22236.1,25.3177], Tmin=(100,'K'), Tmax=(749.821,'K')), NASAPolynomial(coeffs=[7.00556,0.0283464,-1.38127e-05,2.70351e-09,-1.91335e-13,21427.1,0.845939], Tmin=(749.821,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCddFO) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CJO)"""),
)

species(
    label = 'C#CC(F)O[C]=C(7804)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.51157,'amu*angstrom^2'), symmetry=1, barrier=(34.7539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52423,'amu*angstrom^2'), symmetry=1, barrier=(35.045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49761,'amu*angstrom^2'), symmetry=1, barrier=(34.433,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.471607,0.0663356,-7.16408e-05,3.7394e-08,-7.38872e-12,11844.6,24.3159], Tmin=(100,'K'), Tmax=(1360.87,'K')), NASAPolynomial(coeffs=[18.3165,0.00839772,-1.73214e-06,1.84483e-10,-8.86552e-15,7495.74,-65.4071], Tmin=(1360.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.3453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(C=CJO)"""),
)

species(
    label = 'C#COC(F)[C]=C(7805)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {3,S} {6,S}
3  C u0 p0 c0 {1,S} {2,S} {5,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.33808,'amu*angstrom^2'), symmetry=1, barrier=(30.7651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33873,'amu*angstrom^2'), symmetry=1, barrier=(30.7801,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33936,'amu*angstrom^2'), symmetry=1, barrier=(30.7944,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.594096,0.0651225,-5.81751e-05,1.6755e-08,1.25541e-12,17381.5,21.767], Tmin=(100,'K'), Tmax=(983.663,'K')), NASAPolynomial(coeffs=[19.6744,0.00816505,-2.78058e-06,5.34055e-10,-4.10675e-14,12629.7,-75.0435], Tmin=(983.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cdj(Cs-F1sO2sH)(Cd-HH))"""),
)

species(
    label = 'C=[C]O[C](F)C=C(7806)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.861504,0.0603297,-4.96058e-05,1.51752e-08,-1.02027e-13,16554.7,25.9874], Tmin=(100,'K'), Tmax=(1039.51,'K')), NASAPolynomial(coeffs=[16.5839,0.0149301,-5.88329e-06,1.10829e-09,-7.95366e-14,12470.2,-54.3975], Tmin=(1039.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cs_P) + radical(C=CJO)"""),
)

species(
    label = '[CH]=CC(F)O[C]=C(7807)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {3,S} {6,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17512,'amu*angstrom^2'), symmetry=1, barrier=(27.0183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17571,'amu*angstrom^2'), symmetry=1, barrier=(27.0319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17682,'amu*angstrom^2'), symmetry=1, barrier=(27.0575,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.535241,0.0628333,-3.81454e-05,-1.02763e-08,1.23663e-11,21929.8,24.9246], Tmin=(100,'K'), Tmax=(947.299,'K')), NASAPolynomial(coeffs=[21.5369,0.00685274,-1.2809e-06,2.19074e-10,-2.0041e-14,16483.6,-83.0031], Tmin=(947.299,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sO2sH)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = 'C=[C][C](F)OC=C(7809)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {4,S}
3  C u0 p0 c0 {2,S} {5,D} {8,S}
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=[C]OC(F)=C=C(7803)'],
    products = ['C=[C]OC(F)[C]=C(7419)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC(F)O[C]=C(7804)'],
    products = ['C=[C]OC(F)[C]=C(7419)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C#COC(F)[C]=C(7805)'],
    products = ['C=[C]OC(F)[C]=C(7419)'],
