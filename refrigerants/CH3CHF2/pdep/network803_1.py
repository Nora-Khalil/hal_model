...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC(=O)O(2377)'],
    products = ['O=C(O)OCF(2334)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)O(1596)', 'CH2F(46)'],
    products = ['O=C(O)OCF(2334)'],
    transitionState = 'TS8',
