...
"""),
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.96235,0.0103817,6.65272e-05,-9.95697e-08,4.28775e-11,27533.4,15.1467], Tmin=(100,'K'), Tmax=(853.512,'K')), NASAPolynomial(coeffs=[9.48301,0.014101,-2.51864e-07,-3.54813e-10,3.40769e-14,25171.7,-22.5932], Tmin=(853.512,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)
...
"""),
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44671,0.0388099,1.68213e-05,-6.63709e-08,3.33594e-11,7477.77,17.5087], Tmin=(100,'K'), Tmax=(909.845,'K')), NASAPolynomial(coeffs=[20.4722,0.00116955,3.03532e-06,-6.98821e-10,4.52851e-14,2111.63,-82.9446], Tmin=(909.845,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.2744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C([CH2])=C(10867)'],
    products = ['[CH2]C(=C)C[O](6609)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(=C)C=O(11166)'],
    products = ['[CH2]C(=C)C[O](6609)'],
