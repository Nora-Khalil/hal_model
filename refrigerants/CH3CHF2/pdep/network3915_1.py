...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24752,0.0691856,-0.000113629,1.07716e-07,-4.01231e-11,-39908.4,26.1191], Tmin=(100,'K'), Tmax=(813.728,'K')), NASAPolynomial(coeffs=[4.97708,0.0339461,-1.75053e-05,3.4313e-09,-2.39795e-13,-39955.7,12.3342], Tmin=(813.728,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsFFHO) + ring(Cs(F)-Cs-Cs) + radical(C2CsJOCs) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2][C]1OC(F)(F)C1F(10731)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=CF)O[C](F)F(10238)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3025)', '[CH2]C(=O)[CH]F(427)'],
    products = ['[CH2]C(=CF)O[C](F)F(10238)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'FC=[C]O[C](F)F(5048)'],
    products = ['[CH2]C(=CF)O[C](F)F(10238)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(=CF)O[C](F)F(10238)'],
    products = ['F[C](F)O[C]1CC1F(10730)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=CF)O[C](F)F(10238)'],
    products = ['[CH2][C]1OC(F)(F)C1F(10731)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]C(=O)[CH]F(427)'],
    products = ['[CH2]C(=CF)O[C](F)F(10238)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC(=[C]F)O[C](F)F(10733)'],
    products = ['[CH2]C(=CF)O[C](F)F(10238)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=C([C]F)OC(F)F(10734)'],
    products = ['[CH2]C(=CF)O[C](F)F(10238)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(CF)O[C](F)F(10735)'],
    products = ['[CH2]C(=CF)O[C](F)F(10238)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(=CF)O[C](F)F(10238)'],
    products = ['[CH]C(=C)OC(F)(F)F(10736)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]F(230)', 'C=[C]O[C](F)F(3286)'],
    products = ['[CH2]C(=CF)O[C](F)F(10238)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(=CF)O[C](F)F(10238)'],
    products = ['F[CH][C]1CC(F)(F)O1(10737)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF(40)', 'C=[C]O[C](F)F(3286)'],
    products = ['[CH2]C(=CF)O[C](F)F(10238)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C(=CF)OC(F)F(10738)'],
    products = ['[CH2]C(=CF)O[C](F)F(10238)'],
