...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(126)', '[CH2]CC(F)F(975)'],
    products = ['FOCCC(F)F(3355)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OF(186)', 'CHF2-CH2(64)'],
    products = ['FOCCC(F)F(3355)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FOC[CH]C(F)F(3388)'],
    products = ['FOCCC(F)F(3355)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FO[CH]CC(F)F(3377)'],
    products = ['FOCCC(F)F(3355)'],
