...
"""),
    E0 = (-106.922,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,180,180,1526.97,1527.08,1527.12,1527.19],'cm^-1')),
        HinderedRotor(inertia=(0.162535,'amu*angstrom^2'), symmetry=1, barrier=(3.737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162614,'amu*angstrom^2'), symmetry=1, barrier=(3.73882,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-87.0691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,615,860,1140,1343,3152,1685,370,578.113,578.118,578.123,578.124,578.127,578.127,578.128,578.134],'cm^-1')),
        HinderedRotor(inertia=(0.000504372,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000504387,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0728567,'amu*angstrom^2'), symmetry=1, barrier=(15.0125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.944072,'amu*angstrom^2'), symmetry=1, barrier=(21.7061,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11906,0.0445391,-4.47774e-05,2.33035e-08,-5.02491e-12,483.92,17.4653], Tmin=(100,'K'), Tmax=(1090.58,'K')), NASAPolynomial(coeffs=[9.01905,0.0192312,-9.96816e-06,2.02452e-09,-1.46951e-13,-1021.06,-16.4214], Tmin=(1090.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.48227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(CdCFH) + group(Cds-O2d(Cds-Cds)H) + radical(C=C(C=O)CJ) + radical(C=C(C)CJ=O)"""),
)

species(
    label = 'O=C1OCC1=CF(7390)',
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.57709,0.0257612,2.58226e-06,-1.45184e-08,5.2178e-12,-35598.4,20.5932], Tmin=(100,'K'), Tmax=(1208.83,'K')), NASAPolynomial(coeffs=[7.71863,0.0224686,-1.03577e-05,2.00768e-09,-1.41879e-13,-37843.9,-9.33332], Tmin=(1208.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41594,0.0464032,-1.96127e-05,-1.93169e-08,1.43211e-11,20089.1,22.4327], Tmin=(100,'K'), Tmax=(915.025,'K')), NASAPolynomial(coeffs=[16.7154,0.00721615,-7.72129e-07,3.26937e-11,-2.56512e-15,16129.8,-56.3549], Tmin=(915.025,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + ring(dioxirane) + radical(Cs_P) + radical(Allyl_P)"""),
)

species(
    label = 'O=C1OC[C]1[CH]F(8071)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34579,0.0261138,2.21641e-05,-4.98026e-08,2.21791e-11,-20018.9,21.3612], Tmin=(100,'K'), Tmax=(919.904,'K')), NASAPolynomial(coeffs=[10.8072,0.0158196,-4.25845e-06,6.59864e-10,-4.49681e-14,-22696.8,-24.8478], Tmin=(919.904,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(CCJ(C)CO) + radical(CsCsF1sH)"""),
)

species(
    label = '[CH2][C]1C(=O)OC1F(8072)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29036,0.0236143,3.78103e-05,-7.091e-08,3.06463e-11,-22612.5,20.4649], Tmin=(100,'K'), Tmax=(924.105,'K')), NASAPolynomial(coeffs=[13.1337,0.0126203,-2.68479e-06,3.9178e-10,-2.92046e-14,-26151.2,-39.2958], Tmin=(924.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(CCJ(C)CO) + radical(CJC(C)C=O)"""),
)

species(
    label = '[O]C1([O])CC1=CF(8049)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u1 p2 c0 {5,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39819,0.054012,-5.55391e-05,2.45338e-08,-2.3246e-12,10533.4,23.5382], Tmin=(100,'K'), Tmax=(871.919,'K')), NASAPolynomial(coeffs=[13.4107,0.0111547,-2.88621e-06,3.904e-10,-2.26419e-14,7972.9,-35.4394], Tmin=(871.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.7749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(CdCFH) + ring(Cd(Cd-F)-Cs-Cs) + radical(C=CC(C)(O)OJ) + radical(C=CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C1([CH]F)OC1=O(8041)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.640811,0.0843152,-0.000153696,1.38997e-07,-4.71531e-11,-6323.74,20.9295], Tmin=(100,'K'), Tmax=(888.936,'K')), NASAPolynomial(coeffs=[8.71097,0.0240563,-1.16096e-05,2.13489e-09,-1.4075e-13,-6812.43,-11.7328], Tmin=(888.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.5021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsHHH) + group(CsCsFHH) + group(Cds-OdCsOs) + ring(2(co)oxirane) + radical(CJC(C)OC) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (-6.69751,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,167,640,1190,180,180,1933.15,1933.86,1935.61,1936.4],'cm^-1')),
        HinderedRotor(inertia=(0.322691,'amu*angstrom^2'), symmetry=1, barrier=(7.4193,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322319,'amu*angstrom^2'), symmetry=1, barrier=(7.41074,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7538,0.0636893,-0.000126766,1.35941e-07,-5.33713e-11,-738.45,23.0596], Tmin=(100,'K'), Tmax=(849.647,'K')), NASAPolynomial(coeffs=[-0.320936,0.0384481,-2.03981e-05,3.98607e-09,-2.75596e-13,877.747,40.1672], Tmin=(849.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.69751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFH) + radical(CCOJ) + radical(CdCdF1s)"""),
)

species(
    label = 'C=C([C]F)C(=O)O(8074)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-102.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,180,180,1600,1718.64,2823.35,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154891,'amu*angstrom^2'), symmetry=1, barrier=(3.56124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154891,'amu*angstrom^2'), symmetry=1, barrier=(3.56124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154891,'amu*angstrom^2'), symmetry=1, barrier=(3.56124,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53399,0.0639806,-0.000115092,1.13745e-07,-4.30124e-11,-12202.2,23.4382], Tmin=(100,'K'), Tmax=(826.045,'K')), NASAPolynomial(coeffs=[4.0532,0.0307154,-1.64323e-05,3.248e-09,-2.27115e-13,-11899.7,16.1163], Tmin=(826.045,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCFHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]C(=C)C(=O)OF(8075)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (0.112927,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3120,650,792.5,1650,180,180,180,1869.9,1870.5,1870.83],'cm^-1')),
        HinderedRotor(inertia=(0.139918,'amu*angstrom^2'), symmetry=1, barrier=(3.217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139932,'amu*angstrom^2'), symmetry=1, barrier=(3.21732,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72867,0.0634195,-0.000124093,1.32823e-07,-5.25627e-11,82.2981,23.6925], Tmin=(100,'K'), Tmax=(837.681,'K')), NASAPolynomial(coeffs=[0.178288,0.0382424,-2.06691e-05,4.08407e-09,-2.84781e-13,1485.14,37.7206], Tmin=(837.681,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.112927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCFHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4191,0.0275396,4.08133e-06,-1.89637e-08,7.11344e-12,-40475.5,18.0376], Tmin=(100,'K'), Tmax=(1163.42,'K')), NASAPolynomial(coeffs=[9.22925,0.0214147,-1.03128e-05,2.05762e-09,-1.48421e-13,-43230.2,-20.877], Tmin=(1163.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-337.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C([O])=C=CF(4136)'],
    products = ['[CH2]C(=CF)C([O])=O(7381)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([C]=O)=CF(7904)'],
    products = ['[CH2]C(=CF)C([O])=O(7381)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(=CF)C([O])=O(7381)'],
    products = ['[CH2]C1([CH]F)OC1=O(8041)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(9.28489e+09,'s^-1'), n=0.690807, Ea=(57.1839,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra] for rate rule [R4_S_(CO)_D;doublebond_intra;radadd_intra_O]
