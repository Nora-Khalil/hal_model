...
"""),
    E0 = (-1085.55,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,519,593,830,1115,1166,1389,1413,3114,190,488,555,1236,1407,238.162,238.162,238.162,2721.4],'cm^-1')),
        HinderedRotor(inertia=(0.173962,'amu*angstrom^2'), symmetry=1, barrier=(7.00209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173963,'amu*angstrom^2'), symmetry=1, barrier=(7.00209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173963,'amu*angstrom^2'), symmetry=1, barrier=(7.00209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.747687,'amu*angstrom^2'), symmetry=1, barrier=(30.0948,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.256455,0.0925274,-0.000160082,1.45792e-07,-5.15562e-11,-130437,31.5412], Tmin=(100,'K'), Tmax=(823.667,'K')), NASAPolynomial(coeffs=[8.99016,0.0320378,-1.70048e-05,3.34324e-09,-2.32962e-13,-131262,-5.17749], Tmin=(823.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1085.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFHO) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-701.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,90,150,250,247,323,377,431,433,1065,1274,188.794,514.758,873.345,2196.96,4000,4000,4000],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.682496,0.0802035,-0.000131624,1.15281e-07,-4.00188e-11,-84210,27.3332], Tmin=(100,'K'), Tmax=(789.629,'K')), NASAPolynomial(coeffs=[9.61417,0.026664,-1.41624e-05,2.80837e-09,-1.97614e-13,-85362,-12.0099], Tmin=(789.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-701.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(CsFFHO) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-654.424,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,190,488,555,1236,1407,580,1155,1237,1373,3147,269.485,269.499,269.501,2609.98],'cm^-1')),
        HinderedRotor(inertia=(0.592246,'amu*angstrom^2'), symmetry=1, barrier=(30.525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132923,'amu*angstrom^2'), symmetry=1, barrier=(6.8511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132926,'amu*angstrom^2'), symmetry=1, barrier=(6.85108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132927,'amu*angstrom^2'), symmetry=1, barrier=(6.85114,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.577074,0.0865745,-0.000157817,1.47967e-07,-5.29039e-11,-78596.6,29.6929], Tmin=(100,'K'), Tmax=(842.075,'K')), NASAPolynomial(coeffs=[7.56799,0.0302099,-1.61653e-05,3.16463e-09,-2.18989e-13,-78953,2.04234], Tmin=(842.075,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-654.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFHHO) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (-880.305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,519,593,830,1115,1166,1389,1413,3114,360,370,350,190,488,555,1236,1407,186.358,186.358,186.358,1103.38],'cm^-1')),
        HinderedRotor(inertia=(0.193678,'amu*angstrom^2'), symmetry=1, barrier=(4.77311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193678,'amu*angstrom^2'), symmetry=1, barrier=(4.77312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193676,'amu*angstrom^2'), symmetry=1, barrier=(4.77312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193677,'amu*angstrom^2'), symmetry=1, barrier=(4.77313,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.277672,0.0934491,-0.000171167,1.58775e-07,-5.62316e-11,-105753,32.1528], Tmin=(100,'K'), Tmax=(839.463,'K')), NASAPolynomial(coeffs=[8.87875,0.0295768,-1.6138e-05,3.17698e-09,-2.20366e-13,-106391,-3.03377], Tmin=(839.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-880.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFHO) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.16128,'amu*angstrom^2'), symmetry=1, barrier=(3.70814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159335,'amu*angstrom^2'), symmetry=1, barrier=(3.66342,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162515,'amu*angstrom^2'), symmetry=1, barrier=(3.73653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.641511,'amu*angstrom^2'), symmetry=1, barrier=(14.7496,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.855665,0.0750998,-0.000116847,9.8516e-08,-3.3298e-11,-84706.4,28.4074], Tmin=(100,'K'), Tmax=(771.435,'K')), NASAPolynomial(coeffs=[9.72055,0.0254213,-1.30315e-05,2.56073e-09,-1.79846e-13,-85963.6,-11.344], Tmin=(771.435,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-705.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsFFHO) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'O[C](OC(F)F)C(F)F(11456)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1087.93,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,522,611,926,1093,1137,1374,1416,3112,519,593,830,1115,1166,1389,1413,3114,360,370,350,180,180.002,180.711,181.063],'cm^-1')),
        HinderedRotor(inertia=(0.190562,'amu*angstrom^2'), symmetry=1, barrier=(4.45646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192428,'amu*angstrom^2'), symmetry=1, barrier=(4.45539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193253,'amu*angstrom^2'), symmetry=1, barrier=(4.44557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.695991,'amu*angstrom^2'), symmetry=1, barrier=(16.0022,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
...
"""),
    ...
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.203481,0.0913118,-0.000148789,1.2856e-07,-4.41105e-11,-131818,29.3293], Tmin=(100,'K'), Tmax=(781.669,'K')), NASAPolynomial(coeffs=[10.9816,0.0289815,-1.54093e-05,3.05894e-09,-2.15496e-13,-133284,-18.6116], Tmin=(781.669,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1097.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFHHO) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
reaction(
    ...
    products = ['OC(OC(F)F)[C](F)F(10835)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(9.51339,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC([C]F)OC(F)F(11451)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(2927)', 'O[CH]OC(F)F(1849)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)F(615)', 'OC=C(F)F(4347)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(8.683,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'FC(F)=COC(F)F(4815)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'OC(OC(F)F)=C(F)F(11452)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(O[CH]F)[C](F)F(11453)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)F(615)', 'O[CH][C](F)F(4343)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(81)', '[O]C(O)[C](F)F(4542)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'F[C](F)[CH]OC(F)F(4817)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(OC(F)F)[C](F)F(9757)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O[C](OC(F)F)[C](F)F(11454)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'OC(O[C](F)F)[C](F)F(9970)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'OC([C]F)OC(F)F-2(11455)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', 'O[CH]OC(F)F(1849)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(2.62817,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction18',
    reactants = ['O[C](OC(F)F)C(F)F(11456)'],
    products = ['OC(OC(F)F)[C](F)F(10835)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OC(OC(F)F)[C](F)F(10835)'],
    products = ['OC(O[CH]F)C(F)(F)F(11457)'],
...
network(
    label = 'PDepNetwork #3805',
    isomers = [
        'OC(OC(F)F)[C](F)F(10835)',
    ],
    reactants = [
