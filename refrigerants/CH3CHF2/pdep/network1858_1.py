...
"""),
    E0 = (-826.642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,375,486,586,623,710,938,1161,1294,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.246675,'amu*angstrom^2'), symmetry=1, barrier=(5.67155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0693342,'amu*angstrom^2'), symmetry=1, barrier=(22.0865,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)(F)OF(4897)', 'CH2(S)(25)'],
    products = ['FCOC(F)(F)OF(4765)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'FCO[C](F)OF(2030)'],
    products = ['FCOC(F)(F)OF(4765)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(F)(F)OF(4898)'],
    products = ['FCOC(F)(F)OF(4765)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)OCF(4899)'],
    products = ['FCOC(F)(F)OF(4765)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FO[C](F)F(4688)', '[O]CF(187)'],
    products = ['FCOC(F)(F)OF(4765)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)OF(4900)', 'CH2F(46)'],
    products = ['FCOC(F)(F)OF(4765)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(126)', 'FCO[C](F)F(4707)'],
    products = ['FCOC(F)(F)OF(4765)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]OC(F)(F)OF(4901)'],
    products = ['FCOC(F)(F)OF(4765)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FCOC(F)(F)OF(4765)'],
    products = ['F2(78)', 'CF2O(49)', 'CH2O(20)'],
