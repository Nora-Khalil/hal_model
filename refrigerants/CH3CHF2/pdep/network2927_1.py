...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.790127,'amu*angstrom^2'), symmetry=1, barrier=(18.1666,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21307,0.0661323,-9.20383e-05,7.21823e-08,-2.31397e-11,-5758.72,22.3089], Tmin=(100,'K'), Tmax=(758.956,'K')), NASAPolynomial(coeffs=[8.831,0.0259799,-1.26754e-05,2.46486e-09,-1.73136e-13,-6914.97,-12.3415], Tmin=(758.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.6777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCFHH) + group(Cd-CdCs(CCO)) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + missing(Cdd-CdO2d) + radical(CsCdF1sH)"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36733,0.0662779,-7.72053e-05,3.88077e-08,6.54874e-13,-2983.69,22.8385], Tmin=(100,'K'), Tmax=(549.926,'K')), NASAPolynomial(coeffs=[7.49182,0.0330174,-1.72703e-05,3.47273e-09,-2.4907e-13,-3827.96,-4.5981], Tmin=(549.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.5288,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Csj(Cd-CsCd)(F1s)(H)) + radical(C=CCJ=O)"""),
)

species(
    label = 'CC(=[C]F)C[C]=O(7756)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {6,D}
3  C u0 p0 c0 {5,S} {6,S} {8,S} {9,S}
...
"""),
    E0 = (86.4235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,1855,455,950,167,640,1190,458.798],'cm^-1')),
        HinderedRotor(inertia=(0.0704243,'amu*angstrom^2'), symmetry=1, barrier=(10.5232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.070351,'amu*angstrom^2'), symmetry=1, barrier=(10.5213,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0704584,'amu*angstrom^2'), symmetry=1, barrier=(10.5199,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78351,0.052499,-4.29509e-05,1.76277e-08,-3.02787e-12,10470.7,22.5371], Tmin=(100,'K'), Tmax=(1317.58,'K')), NASAPolynomial(coeffs=[10.3288,0.0265566,-1.34166e-05,2.68397e-09,-1.92399e-13,8218.85,-21.0456], Tmin=(1317.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.4235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(CdCFH) + radical(CCCJ=O) + radical(Cdj(Cd-CsCs)(F1s))"""),
)

species(
    label = 'C=C([C]F)CC=O(7757)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {5,D}
...
"""),
    E0 = (62.8798,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2782.5,750,1395,475,1775,1000,2950,3100,1380,975,1025,1650,180,180,820.723,821.274],'cm^-1')),
        HinderedRotor(inertia=(0.234519,'amu*angstrom^2'), symmetry=1, barrier=(5.39205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0402362,'amu*angstrom^2'), symmetry=1, barrier=(19.1471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0402322,'amu*angstrom^2'), symmetry=1, barrier=(19.1278,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9153,0.0476536,-3.09066e-05,8.60869e-09,-9.24442e-13,7635.15,21.172], Tmin=(100,'K'), Tmax=(2124.77,'K')), NASAPolynomial(coeffs=[18.2569,0.0168891,-9.18772e-06,1.79407e-09,-1.22621e-13,690.845,-69.9825], Tmin=(2124.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.8798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30047,0.0516163,-2.67303e-05,2.93654e-09,8.68165e-13,-1761.01,24.1746], Tmin=(100,'K'), Tmax=(1387.9,'K')), NASAPolynomial(coeffs=[14.2115,0.0264804,-1.26135e-05,2.4238e-09,-1.68537e-13,-6507.76,-46.5352], Tmin=(1387.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.5022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(COCsFO) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20539,0.0666239,-9.26653e-05,7.66326e-08,-2.62251e-11,-22652.7,22.5286], Tmin=(100,'K'), Tmax=(758.793,'K')), NASAPolynomial(coeffs=[7.56909,0.0300928,-1.45496e-05,2.81723e-09,-1.97216e-13,-23532.6,-5.84983], Tmin=(758.793,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCFHH) + group(Cd-CdCs(CCO)) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0751,0.0709188,-9.44367e-05,7.17935e-08,-2.28071e-11,-2281.95,22.9695], Tmin=(100,'K'), Tmax=(758.21,'K')), NASAPolynomial(coeffs=[8.53378,0.0315712,-1.65962e-05,3.35342e-09,-2.4153e-13,-3413.04,-10.9501], Tmin=(758.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.7991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Allyl_P) + radical(C=CCJ=O)"""),
)

species(
    label = '[CH]C(=CF)CC=O(7764)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (46.6998,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2782.5,750,1395,475,1775,1000,194,682,905,1196,1383,3221,467.072,467.072,467.072,467.072],'cm^-1')),
        HinderedRotor(inertia=(0.32267,'amu*angstrom^2'), symmetry=1, barrier=(49.952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.32267,'amu*angstrom^2'), symmetry=1, barrier=(49.952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.32267,'amu*angstrom^2'), symmetry=1, barrier=(49.952,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29147,0.0522539,-2.88665e-05,5.16163e-09,1.64555e-13,5720.18,24.14], Tmin=(100,'K'), Tmax=(1466.63,'K')), NASAPolynomial(coeffs=[14.7835,0.0256762,-1.21364e-05,2.30793e-09,-1.58875e-13,663.477,-49.8654], Tmin=(1466.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.6998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(CdCFH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(128)', '[CH2]C([CH2])=CF(7562)'],
    products = ['[CH2]C(=CF)C[C]=O(7421)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['CO(13)', '[CH2]C([CH2])=CF(7562)'],
    products = ['[CH2]C(=CF)C[C]=O(7421)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C([CH]F)C=C=O(7753)'],
    products = ['[CH2]C(=CF)C[C]=O(7421)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]F(230)', 'C=[C]C[C]=O(555)'],
    products = ['[CH2]C(=CF)C[C]=O(7421)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CHF(40)', 'C=[C]C[C]=O(555)'],
    products = ['[CH2]C(=CF)C[C]=O(7421)'],
