...
reaction(
    label = 'reaction4',
    reactants = ['OF(142)', 'F[C]CC(F)F(885)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2(43)', 'CC(O)(F)F(3043)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'OC(F)(F)C[C]F(5187)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'FC(F)=CC(F)F(3934)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)F(617)', 'CH2CF2(57)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[C](F)CC(F)F(894)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)(F)C[CH]F(5188)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'F[C](F)CC(F)F(3073)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(F)(F)CC(F)F(5023)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](F)F(4619)', 'CHF2-CH2(64)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF2(81)', '[CH2]C(O)(F)F(1116)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)(F)[CH]C(F)F(5189)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'OC(F)(F)C[C](F)F(5190)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C(F)CC(F)F(2938)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'OC(F)=CC(F)F(5191)'],
    products = ['OC(F)(F)CC(F)F(4763)'],
