...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[O](685)'],
    products = ['[CH]=CC(C)[O](2835)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[CH](264)', 'C[CH][O](468)'],
    products = ['[CH]=CC(C)[O](2835)'],
