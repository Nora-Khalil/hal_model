...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C=C(O)OF(1757)'],
    products = ['C=C(OF)OC(F)F(3444)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C=C(OF)OF(2070)'],
    products = ['C=C(OF)OC(F)F(3444)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(OF)O[C](F)F(4913)'],
    products = ['C=C(OF)OC(F)F(3444)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(OF)O[CH]F(2074)'],
    products = ['C=C(OF)OC(F)F(3444)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(=O)OC(F)F(2210)'],
    products = ['C=C(OF)OC(F)F(3444)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)F(615)', 'C=[C]OF(202)'],
    products = ['C=C(OF)OC(F)F(3444)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(126)', 'C=[C]OC(F)F(2209)'],
    products = ['C=C(OF)OC(F)F(3444)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(OF)O[C](F)F(4915)'],
    products = ['C=C(OF)OC(F)F(3444)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(OF)OC(F)F(4916)'],
    products = ['C=C(OF)OC(F)F(3444)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C(OF)OC(F)F(3444)'],
    products = ['F2(78)', 'CHFO(47)', 'CH2CO(28)'],
