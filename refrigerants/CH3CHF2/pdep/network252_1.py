...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[CH]F(297)'],
    products = ['[CH2]C(=O)O[CH]F(988)'],
    transitionState = 'TS3',
