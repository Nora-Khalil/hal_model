...
reaction(
    label = 'reaction13',
    reactants = ['C2H(22)', '[O]C([O])CF(2915)'],
    products = ['C#COC([O])CF(1646)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=[C]OC(=O)CF(2916)'],
    products = ['C#COC([O])CF(1646)'],
