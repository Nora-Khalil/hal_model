...
"""),
    E0 = (377.582,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2175,525,3120,650,792.5,1650,239,401,1367],'cm^-1')),
        HinderedRotor(inertia=(0.416044,'amu*angstrom^2'), symmetry=1, barrier=(9.56566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0306965,'amu*angstrom^2'), symmetry=1, barrier=(9.72611,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0835,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13879,0.044262,-4.67232e-05,2.96614e-08,-8.13617e-12,45476.8,17.8805], Tmin=(100,'K'), Tmax=(860.595,'K')), NASAPolynomial(coeffs=[6.51723,0.0239117,-1.12537e-05,2.18522e-09,-1.54606e-13,44723.1,-2.58564], Tmin=(860.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(CtCF) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(C)=C=CF(6664)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90652,0.0483149,-3.48435e-05,1.41231e-08,-2.55292e-12,36705.2,18.9144], Tmin=(100,'K'), Tmax=(1214.55,'K')), NASAPolynomial(coeffs=[7.07203,0.0313031,-1.38337e-05,2.59106e-09,-1.79227e-13,35450.4,-7.01037], Tmin=(1214.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCddFH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C(=C)C=[C]F(6665)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)C=[C]F(6380)'],
    products = ['C2HF(58)', 'C#CC(5436)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC=[C]F(4102)'],
    products = ['[CH]=C(C)C=[C]F(6380)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(C)C#CF(6663)'],
    products = ['[CH]=C(C)C=[C]F(6380)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=[C]F(1074)', '[CH]=[C]C(5437)'],
    products = ['[CH]=C(C)C=[C]F(6380)'],
    transitionState = 'TS8',
