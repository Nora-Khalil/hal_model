...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH2]C([O])F(141)'],
    products = ['[O]C(F)C[C]=O(991)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)C=C=O(1003)'],
    products = ['[O]C(F)C[C]=O(991)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C=C[C]=O(1005)'],
    products = ['[O]C(F)C[C]=O(991)'],
