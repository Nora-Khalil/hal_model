...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]C[C](F)F(3082)'],
    products = ['F[C](F)CC[C](F)F(3077)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C](F)CC=C(F)F(3175)'],
    products = ['F[C](F)CC[C](F)F(3077)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(43)', '[CH2]C[C](F)F(3082)'],
    products = ['F[C](F)CC[C](F)F(3077)'],
    transitionState = 'TS9',
