...
"""),
    E0 = (-150.74,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1855,455,950,180,746.313,746.313],'cm^-1')),
        HinderedRotor(inertia=(0.00981666,'amu*angstrom^2'), symmetry=1, barrier=(3.88011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600297,'amu*angstrom^2'), symmetry=1, barrier=(13.802,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600293,'amu*angstrom^2'), symmetry=1, barrier=(13.8019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600295,'amu*angstrom^2'), symmetry=1, barrier=(13.802,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47664,0.0577621,-7.46356e-05,5.0102e-08,-1.33542e-11,-18040.9,22.8084], Tmin=(100,'K'), Tmax=(917.417,'K')), NASAPolynomial(coeffs=[10.8643,0.0168322,-7.71572e-06,1.47398e-09,-1.03174e-13,-19763.4,-21.6728], Tmin=(917.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(OCJO) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01041,0.0415475,2.57603e-05,-9.42238e-08,4.8411e-11,-44037.4,20.1607], Tmin=(100,'K'), Tmax=(897.876,'K')), NASAPolynomial(coeffs=[28.6015,-0.0157134,1.17344e-05,-2.36813e-09,1.59012e-13,-51638.6,-124.716], Tmin=(897.876,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-367.233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-OsOsHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-319.536,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1855,455,950,1484.82,1668.14],'cm^-1')),
        HinderedRotor(inertia=(0.503587,'amu*angstrom^2'), symmetry=1, barrier=(29.883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.503554,'amu*angstrom^2'), symmetry=1, barrier=(29.8832,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.503586,'amu*angstrom^2'), symmetry=1, barrier=(29.8827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.353,0.0302835,-1.03402e-05,-5.09762e-09,2.93931e-12,-38367.2,20.3365], Tmin=(100,'K'), Tmax=(1198.73,'K')), NASAPolynomial(coeffs=[9.75856,0.0170071,-8.03576e-06,1.57845e-09,-1.12613e-13,-40964.2,-20.1602], Tmin=(1198.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-319.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical(CsCJ=O)"""),
)
...
"""),
    E0 = (-178.273,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2120,512.5,787.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.903446,'amu*angstrom^2'), symmetry=1, barrier=(20.772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.903134,'amu*angstrom^2'), symmetry=1, barrier=(20.7648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.902865,'amu*angstrom^2'), symmetry=1, barrier=(20.7587,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.346568,0.0652574,-8.11189e-05,4.47822e-08,-8.95009e-12,-21296.7,22.3258], Tmin=(100,'K'), Tmax=(1444.76,'K')), NASAPolynomial(coeffs=[20.2524,-0.00326055,3.93757e-06,-8.8878e-10,6.41487e-14,-25649.3,-76.1901], Tmin=(1444.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-OsOsHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(OCJO)"""),
)

species(
    label = '[O]COC[C]=O(7053)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {5,S}
2  O u1 p2 c0 {5,S}
3  O u0 p2 c0 {6,D}
...
"""),
    E0 = (-112.302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1855,455,950,180,803.688,803.707,803.835],'cm^-1')),
        ...
        HinderedRotor(inertia=(0.0541034,'amu*angstrom^2'), symmetry=1, barrier=(24.7935,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78787,0.0418931,-2.94673e-05,8.47487e-09,-5.61694e-13,-13421.6,22.3809], Tmin=(100,'K'), Tmax=(1259.07,'K')), NASAPolynomial(coeffs=[12.5094,0.0154139,-6.95464e-06,1.33777e-09,-9.42864e-14,-16722.4,-34.2011], Tmin=(1259.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-112.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(OCOJ) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C=CO[CH]O(7054)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {5,S}
2  O u0 p2 c0 {5,S} {10,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.703914,0.0538294,-1.33921e-05,-4.98184e-08,3.15697e-11,-26117.4,21.6568], Tmin=(100,'K'), Tmax=(895.333,'K')), NASAPolynomial(coeffs=[26.8923,-0.011352,8.99652e-06,-1.84758e-09,1.25439e-13,-32883.8,-113.39], Tmin=(895.333,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-218.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(OCJO)"""),
)
...
"""),
    ...
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.961598,0.0392422,4.02903e-05,-1.14928e-07,5.72173e-11,-20010.4,24.0711], Tmin=(100,'K'), Tmax=(897.46,'K')), NASAPolynomial(coeffs=[30.9064,-0.0196333,1.40269e-05,-2.81138e-09,1.88591e-13,-28389,-133.891], Tmin=(897.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = '[O][CH]OCC=O(7056)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-78.0127,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,180,729.774,729.847,729.966],'cm^-1')),
        HinderedRotor(inertia=(0.139725,'amu*angstrom^2'), symmetry=1, barrier=(3.21255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139617,'amu*angstrom^2'), symmetry=1, barrier=(3.21007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13975,'amu*angstrom^2'), symmetry=1, barrier=(3.21313,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86161,0.0561158,-9.58762e-05,9.76319e-08,-3.83014e-11,-9314.61,21.2115], Tmin=(100,'K'), Tmax=(819.027,'K')), NASAPolynomial(coeffs=[2.20805,0.0339381,-1.77405e-05,3.49228e-09,-2.4442e-13,-8684.26,23.8039], Tmin=(819.027,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.0127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]O(237)', '[O]C[C]=O(690)'],
    products = ['O=[C]CO[CH]O(7043)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH2]O[CH]O(799)'],
    products = ['O=[C]CO[CH]O(7043)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[CH2]O[CH]O(799)'],
    products = ['O=[C]CO[CH]O(7043)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['O=[C]CO[CH]O(7043)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(104.07,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]COC=O(7051)'],
    products = ['O=[C]CO[CH]O(7043)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(18.1492,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C=CO[CH]O(7052)'],
    products = ['O=[C]CO[CH]O(7043)'],
