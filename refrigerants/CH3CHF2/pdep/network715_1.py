...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57694,0.0498379,-3.44328e-05,1.06413e-08,-1.28362e-12,-17938.1,22.9064], Tmin=(100,'K'), Tmax=(1917.71,'K')), NASAPolynomial(coeffs=[17.3673,0.0169015,-8.67005e-06,1.68502e-09,-1.16026e-13,-23994.2,-63.5543], Tmin=(1917.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'FO[C]1CC[CH]O1(2128)',
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55336,0.0416788,6.88238e-06,-4.98004e-08,2.64736e-11,14702.7,20.4593], Tmin=(100,'K'), Tmax=(883.473,'K')), NASAPolynomial(coeffs=[15.6394,0.012095,-9.41483e-07,-9.02377e-11,1.08619e-14,10879.4,-53.3044], Tmin=(883.473,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Tetrahydrofuran) + radical(Cs_P) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(OF)O[C]=C(2129)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (200.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,400.262,400.306,400.316,400.337],'cm^-1')),
        HinderedRotor(inertia=(0.155981,'amu*angstrom^2'), symmetry=1, barrier=(17.7351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155957,'amu*angstrom^2'), symmetry=1, barrier=(17.7346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15597,'amu*angstrom^2'), symmetry=1, barrier=(17.7347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155941,'amu*angstrom^2'), symmetry=1, barrier=(17.735,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.373679,0.0728071,-8.06307e-05,4.31313e-08,-8.88155e-12,24203.3,28.7941], Tmin=(100,'K'), Tmax=(1198.53,'K')), NASAPolynomial(coeffs=[18.5828,0.0120361,-4.57429e-06,8.26189e-10,-5.72469e-14,19838.5,-62.352], Tmin=(1198.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCO) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]O[C](C)OF(2130)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (193.76,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2950,3100,1380,975,1025,1650,1685,370,425.962,425.962,425.962,425.962],'cm^-1')),
        HinderedRotor(inertia=(0.127534,'amu*angstrom^2'), symmetry=1, barrier=(16.4209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127534,'amu*angstrom^2'), symmetry=1, barrier=(16.4209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127535,'amu*angstrom^2'), symmetry=1, barrier=(16.4209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127534,'amu*angstrom^2'), symmetry=1, barrier=(16.4209,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.547261,0.0685129,-7.17626e-05,3.65705e-08,-7.21122e-12,23434.6,28.2268], Tmin=(100,'K'), Tmax=(1246.65,'K')), NASAPolynomial(coeffs=[17.8087,0.0131281,-5.12251e-06,9.33733e-10,-6.47479e-14,19130.8,-58.855], Tmin=(1246.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C(OF)OC[CH2](2131)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (273.848,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,310.072,310.072,310.072],'cm^-1')),
        HinderedRotor(inertia=(0.00175338,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197704,'amu*angstrom^2'), symmetry=1, barrier=(13.4886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197704,'amu*angstrom^2'), symmetry=1, barrier=(13.4886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.336853,'amu*angstrom^2'), symmetry=1, barrier=(22.9822,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.439306,0.0821472,-0.000116033,8.40942e-08,-2.40014e-11,33061.1,24.7636], Tmin=(100,'K'), Tmax=(861.206,'K')), NASAPolynomial(coeffs=[13.5687,0.0211631,-9.80983e-06,1.8619e-09,-1.29034e-13,30799.7,-36.6156], Tmin=(861.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COC([CH2])OF(2132)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.971558,'amu*angstrom^2'), symmetry=1, barrier=(22.338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.971584,'amu*angstrom^2'), symmetry=1, barrier=(22.3386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.971711,'amu*angstrom^2'), symmetry=1, barrier=(22.3416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.971701,'amu*angstrom^2'), symmetry=1, barrier=(22.3413,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.384752,0.0800936,-8.94057e-05,4.60286e-08,-8.83594e-12,25122.9,28.7958], Tmin=(100,'K'), Tmax=(1423.11,'K')), NASAPolynomial(coeffs=[23.7804,0.00365761,1.33873e-07,-1.20703e-10,9.67704e-15,19107.1,-93.2847], Tmin=(1423.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(OF)O[CH]C(2133)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {1,S} {6,S}
...
"""),
    E0 = (256.186,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,350,440,435,1725,3120,650,792.5,1650,310.057,310.069,310.073],'cm^-1')),
        HinderedRotor(inertia=(0.214449,'amu*angstrom^2'), symmetry=1, barrier=(14.6291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214444,'amu*angstrom^2'), symmetry=1, barrier=(14.6291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214436,'amu*angstrom^2'), symmetry=1, barrier=(14.6291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214428,'amu*angstrom^2'), symmetry=1, barrier=(14.6291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.213969,0.0864831,-0.000123631,8.81782e-08,-2.45122e-11,30945.6,24.4117], Tmin=(100,'K'), Tmax=(887.117,'K')), NASAPolynomial(coeffs=[15.3259,0.0183423,-8.41139e-06,1.58909e-09,-1.09884e-13,28264.4,-46.6841], Tmin=(887.117,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CO[C](C)OF(2134)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (201.112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,205.98,205.981,205.983],'cm^-1')),
        HinderedRotor(inertia=(0.698392,'amu*angstrom^2'), symmetry=1, barrier=(21.0274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.698389,'amu*angstrom^2'), symmetry=1, barrier=(21.0274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.698389,'amu*angstrom^2'), symmetry=1, barrier=(21.0274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.698414,'amu*angstrom^2'), symmetry=1, barrier=(21.0274,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.24171,0.0761144,-8.14548e-05,4.04385e-08,-7.50092e-12,24355.6,28.3414], Tmin=(100,'K'), Tmax=(1477.06,'K')), NASAPolynomial(coeffs=[22.9577,0.00481823,-4.4941e-07,-5.48968e-12,1.57129e-15,18426.2,-89.5033], Tmin=(1477.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cds_P)"""),
)
...
"""),
    E0 = (210.227,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,190.95,190.954,190.971,2111.79],'cm^-1')),
        HinderedRotor(inertia=(0.0115958,'amu*angstrom^2'), symmetry=1, barrier=(36.6959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.510272,'amu*angstrom^2'), symmetry=1, barrier=(13.2037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.510284,'amu*angstrom^2'), symmetry=1, barrier=(13.2037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22523,0.0687247,-0.000111845,1.01731e-07,-3.61429e-11,25377,26.3803], Tmin=(100,'K'), Tmax=(836.736,'K')), NASAPolynomial(coeffs=[6.33069,0.029358,-1.4454e-05,2.7676e-09,-1.90395e-13,25046.3,5.78882], Tmin=(836.736,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2sCF) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C(OF)OC=C(2137)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {1,S} {4,S}
...
"""),
    E0 = (217.579,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,342.203,342.267,343.059],'cm^-1')),
        HinderedRotor(inertia=(0.119804,'amu*angstrom^2'), symmetry=1, barrier=(9.85906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117563,'amu*angstrom^2'), symmetry=1, barrier=(9.86659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348457,'amu*angstrom^2'), symmetry=1, barrier=(28.9159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05273,0.0690265,-9.57136e-05,7.13754e-08,-2.13573e-11,26271.1,24.2837], Tmin=(100,'K'), Tmax=(816.665,'K')), NASAPolynomial(coeffs=[10.4907,0.0228024,-1.08177e-05,2.07704e-09,-1.44909e-13,24729.4,-19.3385], Tmin=(816.665,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2sCF) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COC(=C)OF(2138)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {1,S} {4,S}
...
"""),
    E0 = (217.579,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,342.323,342.323,342.323],'cm^-1')),
        HinderedRotor(inertia=(0.118605,'amu*angstrom^2'), symmetry=1, barrier=(9.86282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118605,'amu*angstrom^2'), symmetry=1, barrier=(9.86282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.347727,'amu*angstrom^2'), symmetry=1, barrier=(28.9159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
...
"""),
    E0 = (283.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,180,180,1613.37,1618.35],'cm^-1')),
        HinderedRotor(inertia=(0.369365,'amu*angstrom^2'), symmetry=1, barrier=(8.49242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.43674,'amu*angstrom^2'), symmetry=1, barrier=(56.0254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.43449,'amu*angstrom^2'), symmetry=1, barrier=(55.9738,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.837612,0.0845434,-0.000156872,1.56965e-07,-5.86599e-11,34149.4,33.9593], Tmin=(100,'K'), Tmax=(859.391,'K')), NASAPolynomial(coeffs=[2.31991,0.0423157,-2.15037e-05,4.11987e-09,-2.81428e-13,35199.2,34.6229], Tmin=(859.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(OF)OC=C(2140)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {1,S} {4,S}
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.282425,0.0725634,-7.21862e-05,3.00422e-08,-3.44872e-12,24180.7,25.4993], Tmin=(100,'K'), Tmax=(1016.96,'K')), NASAPolynomial(coeffs=[20.2202,0.0101772,-3.81837e-06,7.28012e-10,-5.37855e-14,19296.4,-75.101], Tmin=(1016.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(199.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]COC(=C)OF(2141)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {1,S} {5,S}
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694916,0.0791474,-0.000112922,8.33238e-08,-2.33233e-11,32137,22.9633], Tmin=(100,'K'), Tmax=(669.714,'K')), NASAPolynomial(coeffs=[11.0057,0.0260064,-1.28079e-05,2.48788e-09,-1.74212e-13,30566.6,-24.0602], Tmin=(669.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['FO[C]1CC[CH]O1(2128)'],
    products = ['C=COC(=C)OF(2055)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(=O)OC=C(2135)'],
    products = ['C=COC(=C)OF(2055)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(126)', 'C=[C]OC=C(406)'],
    products = ['C=COC(=C)OF(2055)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=[C]OC(=C)OF(2136)'],
    products = ['C=COC(=C)OF(2055)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)OC=C(2137)'],
    products = ['C=COC(=C)OF(2055)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH]=COC(=C)OF(2138)'],
    products = ['C=COC(=C)OF(2055)'],
