...
"""),
    E0 = (-67.4428,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,315.523,315.528,315.531,315.531],'cm^-1')),
        HinderedRotor(inertia=(0.00169307,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0865688,'amu*angstrom^2'), symmetry=1, barrier=(6.11555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0865565,'amu*angstrom^2'), symmetry=1, barrier=(6.11555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00169311,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58401,0.0600473,-5.31188e-05,1.48748e-08,8.49268e-12,-8031.07,23.1877], Tmin=(100,'K'), Tmax=(558.467,'K')), NASAPolynomial(coeffs=[6.12988,0.0371487,-1.75638e-05,3.40748e-09,-2.40551e-13,-8689.47,2.55591], Tmin=(558.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.4428,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs)"""),
)
...
"""),
    E0 = (87.5391,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,309.318,309.371,309.4],'cm^-1')),
        HinderedRotor(inertia=(0.00176094,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189056,'amu*angstrom^2'), symmetry=1, barrier=(12.8424,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189202,'amu*angstrom^2'), symmetry=1, barrier=(12.8423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18913,'amu*angstrom^2'), symmetry=1, barrier=(12.8415,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99159,0.0286693,4.15848e-05,-6.92528e-08,2.64927e-11,-39011.2,17.9804], Tmin=(100,'K'), Tmax=(1016,'K')), NASAPolynomial(coeffs=[12.2561,0.0263174,-1.11332e-05,2.20919e-09,-1.63755e-13,-43061.4,-41.3703], Tmin=(1016,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-325.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.893624,0.0523478,-3.54186e-06,-4.40396e-08,2.37527e-11,-46267.1,22.9925], Tmin=(100,'K'), Tmax=(941.634,'K')), NASAPolynomial(coeffs=[19.8624,0.0117756,-2.63986e-06,4.40799e-10,-3.55714e-14,-51613,-76.7978], Tmin=(941.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-385.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.016,0.0674147,-7.11761e-05,4.12145e-08,-9.77407e-12,-10466.1,24.9969], Tmin=(100,'K'), Tmax=(1012.59,'K')), NASAPolynomial(coeffs=[11.1256,0.0274792,-1.20179e-05,2.26622e-09,-1.5812e-13,-12513.5,-23.9027], Tmin=(1012.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.9015,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]COC(C)[O](4058)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-36.3097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,180,180,963.883],'cm^-1')),
        HinderedRotor(inertia=(0.169027,'amu*angstrom^2'), symmetry=1, barrier=(3.88625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168052,'amu*angstrom^2'), symmetry=1, barrier=(3.86384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168425,'amu*angstrom^2'), symmetry=1, barrier=(3.87241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00586345,'amu*angstrom^2'), symmetry=1, barrier=(3.86366,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36302,0.063727,-8.00557e-05,6.95433e-08,-2.60521e-11,-4277.59,25.1052], Tmin=(100,'K'), Tmax=(757.147,'K')), NASAPolynomial(coeffs=[4.49664,0.0401171,-1.93048e-05,3.74566e-09,-2.6307e-13,-4549.89,12.1944], Tmin=(757.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.3097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = 'CCO[C](C)[O](4059)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {6,S}
2  O u1 p2 c0 {6,S}
3  C u0 p0 c0 {1,S} {4,S} {7,S} {8,S}
...
"""),
    E0 = (-42.6524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,230.573,231.8,1314.64,1314.72],'cm^-1')),
        HinderedRotor(inertia=(0.00314084,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160284,'amu*angstrom^2'), symmetry=1, barrier=(6.05983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160246,'amu*angstrom^2'), symmetry=1, barrier=(6.06229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160115,'amu*angstrom^2'), symmetry=1, barrier=(6.05818,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56471,0.0591403,-7.03938e-05,6.23939e-08,-2.43872e-11,-5047.57,24.4348], Tmin=(100,'K'), Tmax=(749.086,'K')), NASAPolynomial(coeffs=[3.3644,0.0417983,-2.0185e-05,3.93033e-09,-2.76889e-13,-5100.27,17.7203], Tmin=(749.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.6524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(O)O[CH]C(4060)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {5,S}
2  O u0 p2 c0 {3,S} {14,S}
...
"""),
    E0 = (-81.5588,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.790784,0.0722916,-8.1955e-05,5.00685e-08,-1.23434e-11,-9695.09,25.7511], Tmin=(100,'K'), Tmax=(983.136,'K')), NASAPolynomial(coeffs=[12.1869,0.0259261,-1.1215e-05,2.10042e-09,-1.45906e-13,-11935.9,-29.0349], Tmin=(983.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.5588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])OCC(4061)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  O u1 p2 c0 {4,S}
...
"""),
    E0 = (-36.3097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,180,180,964.631],'cm^-1')),
        HinderedRotor(inertia=(0.168769,'amu*angstrom^2'), symmetry=1, barrier=(3.88033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168499,'amu*angstrom^2'), symmetry=1, barrier=(3.87413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168632,'amu*angstrom^2'), symmetry=1, barrier=(3.87719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00586843,'amu*angstrom^2'), symmetry=1, barrier=(3.87813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C[CH]OC[O](2284)'],
    products = ['C[CH]OC(C)[O](3848)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C-2(611)', 'CC([O])[O](2509)'],
    products = ['C[CH]OC(C)[O](3848)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C[CH]O[CH]C(3013)'],
    products = ['C[CH]OC(C)[O](3848)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3335.46,'m^3/(mol*s)'), n=1.126, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_rad/H/CsO;O_birad]
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH][O](468)', 'C[CH][O](468)'],
    products = ['C[CH]OC(C)[O](3848)'],
