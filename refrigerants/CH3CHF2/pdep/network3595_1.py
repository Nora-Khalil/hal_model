...
"""),
    E0 = (64.1979,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,395,473,707,1436,2950,3100,1380,975,1025,1650,1685,370,389.605,389.625,389.628,389.635,389.635,389.639,389.642,389.651],'cm^-1')),
        HinderedRotor(inertia=(0.00111047,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00111051,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42046,0.0451225,-1.67481e-05,-1.93052e-08,1.27319e-11,7824.59,23.1449], Tmin=(100,'K'), Tmax=(966.02,'K')), NASAPolynomial(coeffs=[16.915,0.00851921,-2.69829e-06,5.26426e-10,-4.20466e-14,3545.27,-57.7265], Tmin=(966.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.1979,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cs(O2)-O2s-Cs(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70845,0.0329986,2.27373e-05,-5.97287e-08,2.59938e-11,-35993.7,13.191], Tmin=(100,'K'), Tmax=(991.624,'K')), NASAPolynomial(coeffs=[18.2046,0.00851409,-3.84501e-06,9.13647e-10,-7.79935e-14,-41333.1,-76.6811], Tmin=(991.624,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-300.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(CsCCFO) + group(Cs-CsOsOsH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + polycyclic(s2_3_4_ane)"""),
)

species(
    label = 'C=COC1=C(F)O1(10640)',
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44067,0.0751551,-0.000162054,1.75699e-07,-6.85307e-11,11105.6,22.0605], Tmin=(100,'K'), Tmax=(859.386,'K')), NASAPolynomial(coeffs=[-1.52921,0.0422228,-2.29637e-05,4.49206e-09,-3.09229e-13,13342.6,45.9837], Tmin=(859.386,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(91.722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsCsCs) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(oxirene)"""),
)

species(
    label = 'C=[C]O[CH]C(=O)F(10641)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-72.4172,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,611,648,830,1210,1753,2950,3100,1380,975,1025,1650,1685,370,236.218,236.228,236.23,236.232],'cm^-1')),
        HinderedRotor(inertia=(0.485959,'amu*angstrom^2'), symmetry=1, barrier=(19.2438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.485919,'amu*angstrom^2'), symmetry=1, barrier=(19.2438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.485934,'amu*angstrom^2'), symmetry=1, barrier=(19.2439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.505237,0.0666325,-7.75139e-05,4.17791e-08,-8.46309e-12,-8575.19,26.9657], Tmin=(100,'K'), Tmax=(1300.23,'K')), NASAPolynomial(coeffs=[19.7176,0.00370377,-5.04861e-07,3.23097e-11,-1.34632e-15,-13248,-69.524], Tmin=(1300.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.4172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(COCsFO) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(C=CJO)"""),
)
...
"""),
    E0 = (331.466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,2950,3100,1380,975,1025,1650,1685,370,180,180,180,2161.37,2167.94,2169.48],'cm^-1')),
        HinderedRotor(inertia=(0.262553,'amu*angstrom^2'), symmetry=1, barrier=(6.03661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263081,'amu*angstrom^2'), symmetry=1, barrier=(6.04875,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64855,0.0769387,-0.000189035,2.14618e-07,-8.48075e-11,39926.7,24.4428], Tmin=(100,'K'), Tmax=(870.67,'K')), NASAPolynomial(coeffs=[-5.63567,0.0462895,-2.57758e-05,5.03544e-09,-3.44254e-13,43625.3,72.5317], Tmin=(870.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsCsCs) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(oxirene) + radical(C=CJO) + longDistanceInteraction_cyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'C#COC1O[C]1F(10643)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {4,S} {5,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (33.7802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,395,473,707,1436,2175,525,750,770,3400,2100,410.036,410.083,410.098,410.112,410.113,410.118,410.122],'cm^-1')),
        HinderedRotor(inertia=(0.317864,'amu*angstrom^2'), symmetry=1, barrier=(37.938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.317788,'amu*angstrom^2'), symmetry=1, barrier=(37.9377,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21286,0.0489809,-2.59098e-05,-1.44311e-08,1.22057e-11,4174.37,18.2178], Tmin=(100,'K'), Tmax=(957.864,'K')), NASAPolynomial(coeffs=[19.2841,0.00312272,-4.59776e-07,1.24399e-10,-1.52432e-14,-645.778,-75.277], Tmin=(957.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.7802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Ct-CtOs) + group(Ct-CtH) + ring(Cs(O2)-O2s-Cs(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring)"""),
)
...
"""),
    E0 = (71.5499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,395,473,707,1436,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,440.607,440.711,441.352,441.723,441.896,441.93,442.362],'cm^-1')),
        HinderedRotor(inertia=(0.219436,'amu*angstrom^2'), symmetry=1, barrier=(30.5718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220893,'amu*angstrom^2'), symmetry=1, barrier=(30.5901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14156,0.0468342,-6.34988e-06,-4.09118e-08,2.31155e-11,8723.13,21.4204], Tmin=(100,'K'), Tmax=(938.13,'K')), NASAPolynomial(coeffs=[21.2321,0.00166658,1.1222e-06,-2.09909e-10,7.37942e-15,3171.69,-83.719], Tmin=(938.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.5499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cs(O2)-O2s-Cs(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring) + radical(Cds_P)"""),
)

species(
    label = 'C=CO[C]1O[C]1F(10646)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (86.0884,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,261,493,600,1152,1365,1422,3097,1685,370,3120,650,792.5,1650,180,560.379,668.795,669.001,670.614,671.827,672.515],'cm^-1')),
        HinderedRotor(inertia=(0.0798971,'amu*angstrom^2'), symmetry=1, barrier=(25.5855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0798533,'amu*angstrom^2'), symmetry=1, barrier=(25.5949,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44762,0.0447587,-1.69766e-05,-1.76256e-08,1.1662e-11,10456.1,22.9417], Tmin=(100,'K'), Tmax=(978.461,'K')), NASAPolynomial(coeffs=[16.5131,0.00954183,-3.41645e-06,6.8071e-10,-5.32527e-14,6245.56,-55.8633], Tmin=(978.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.0884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cs(O2)-O2s-Cs(F)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C1O[C]1F(5677)', '[C]=C(395)'],
    products = ['C=[C]OC1O[C]1F(10631)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['C=[C]O[CH]C(=O)F(10641)'],
    products = ['C=[C]OC1O[C]1F(10631)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=[C]OC1=C(F)O1(10642)'],
    products = ['C=[C]OC1O[C]1F(10631)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#COC1O[C]1F(10643)'],
    products = ['C=[C]OC1O[C]1F(10631)'],
    transitionState = 'TS9',
