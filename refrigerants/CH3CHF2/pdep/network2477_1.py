...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)[CH]F(646)', '[CH]C-2(610)'],
    products = ['C[CH]OC(F)[CH]F(6280)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', 'C[CH]O[CH]F(1812)'],
    products = ['C[CH]OC(F)[CH]F(6280)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[CH]OC=CF(1807)'],
    products = ['C[CH]OC(F)[CH]F(6280)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C[CH]OC(F)=CF(6292)'],
    products = ['C[CH]OC(F)[CH]F(6280)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=COC(F)[CH]F(6293)'],
    products = ['C[CH]OC(F)[CH]F(6280)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'C[CH]O[CH]F(1812)'],
    products = ['C[CH]OC(F)[CH]F(6280)'],
