...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.26636,'amu*angstrom^2'), symmetry=1, barrier=(6.12413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267216,'amu*angstrom^2'), symmetry=1, barrier=(6.14383,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.769,0.0381681,-7.94237e-05,9.33867e-08,-3.9018e-11,16863.4,17.0301], Tmin=(100,'K'), Tmax=(840.861,'K')), NASAPolynomial(coeffs=[-1.8443,0.0315668,-1.67235e-05,3.30085e-09,-2.30255e-13,18648.5,44.488], Tmin=(840.861,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9691,0.0380787,-1.70346e-05,-9.43376e-09,7.91963e-12,53881.6,20.8342], Tmin=(100,'K'), Tmax=(928.443,'K')), NASAPolynomial(coeffs=[11.6715,0.0130996,-3.85548e-06,6.17618e-10,-4.15365e-14,51355,-29.1584], Tmin=(928.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(dioxirane) + radical(Cs_P) + radical(Cds_S)"""),
)

species(
    label = 'C[C]1[CH]C(=O)O1(6637)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.80192,0.0152908,4.26139e-05,-6.73161e-08,2.78569e-11,8139.27,21.0066], Tmin=(100,'K'), Tmax=(914.432,'K')), NASAPolynomial(coeffs=[9.44303,0.0148304,-3.52856e-06,5.14774e-10,-3.51853e-14,5729.38,-16.9747], Tmin=(914.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.2297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(C2CsJOC(O)) + radical(CCJCO)"""),
)

species(
    label = 'CC1=CC1([O])[O](6633)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
2  O u1 p2 c0 {3,S}
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02162,0.0499866,-7.45211e-05,7.2555e-08,-2.83946e-11,37517.7,17.278], Tmin=(100,'K'), Tmax=(799.837,'K')), NASAPolynomial(coeffs=[2.94232,0.0321172,-1.61321e-05,3.15259e-09,-2.20886e-13,37794.7,15.6943], Tmin=(799.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = 'C[C]=[C]C(=O)O(6638)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.26757,'amu*angstrom^2'), symmetry=1, barrier=(6.15197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266606,'amu*angstrom^2'), symmetry=1, barrier=(6.12979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000541205,'amu*angstrom^2'), symmetry=1, barrier=(6.14488,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28136,0.0456271,-8.61941e-05,8.72815e-08,-3.32356e-11,19079.9,19.3193], Tmin=(100,'K'), Tmax=(833.7,'K')), NASAPolynomial(coeffs=[3.59392,0.0217379,-1.15613e-05,2.29182e-09,-1.60312e-13,19472.4,16.8922], Tmin=(833.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + radical(Cds_S) + radical(C=CJC=O)"""),
)
...
"""),
    E0 = (95.3122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2100,2250,500,550,180,180,180,1385.34,1385.37,1385.45],'cm^-1')),
        HinderedRotor(inertia=(0.124644,'amu*angstrom^2'), symmetry=1, barrier=(2.86581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124555,'amu*angstrom^2'), symmetry=1, barrier=(2.86376,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0653,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46305,0.0422432,-7.1474e-05,7.34684e-08,-2.79732e-11,11510.7,18.8291], Tmin=(100,'K'), Tmax=(881.685,'K')), NASAPolynomial(coeffs=[0.722789,0.0291039,-1.33348e-05,2.44921e-09,-1.63452e-13,12635.1,31.6421], Tmin=(881.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.3122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CtHHH) + group(Cds-O2d(Cds-Cds)O2s) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80747,0.0485433,-4.79998e-05,2.50285e-08,-5.31158e-12,7739.83,18.3648], Tmin=(100,'K'), Tmax=(1125.96,'K')), NASAPolynomial(coeffs=[10.1616,0.0188652,-8.46299e-06,1.61941e-09,-1.14034e-13,5858.53,-22.9303], Tmin=(1125.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.6983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cdd-CdsCds) + radical(C=COJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C[C]=C[C]=O(6527)'],
    products = ['C[C]=CC([O])=O(6325)'],
    transitionState = 'TS2',
