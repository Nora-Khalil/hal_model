...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.214813,'amu*angstrom^2'), symmetry=1, barrier=(4.93897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.37191,'amu*angstrom^2'), symmetry=1, barrier=(54.5348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44179,'amu*angstrom^2'), symmetry=1, barrier=(33.1496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216138,'amu*angstrom^2'), symmetry=1, barrier=(4.96944,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6048,0.0589854,-7.04655e-05,4.23684e-08,-6.84529e-12,1709.01,23.3092], Tmin=(100,'K'), Tmax=(591.492,'K')), NASAPolynomial(coeffs=[7.35264,0.0284573,-1.42025e-05,2.79861e-09,-1.9853e-13,883.121,-2.63611], Tmin=(591.492,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.5418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFHHO) + radical(CJCOOH) + radical(CsF1sHO2s)"""),
)

species(
    label = 'C[CH]OO[CH]F(2329)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-13.9801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,580,1155,1237,1373,3147,180],'cm^-1')),
        HinderedRotor(inertia=(0.256811,'amu*angstrom^2'), symmetry=1, barrier=(5.90459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0339133,'amu*angstrom^2'), symmetry=1, barrier=(12.0474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.25816,'amu*angstrom^2'), symmetry=1, barrier=(51.9194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.2604,'amu*angstrom^2'), symmetry=1, barrier=(51.9711,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45884,0.061383,-8.70532e-05,7.58003e-08,-2.74181e-11,-1595.18,22.094], Tmin=(100,'K'), Tmax=(761.523,'K')), NASAPolynomial(coeffs=[6.14838,0.0308945,-1.54639e-05,3.03007e-09,-2.13333e-13,-2139.62,1.86215], Tmin=(761.523,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.9801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFHHO) + radical(CCsJOOC) + radical(CsF1sHO2s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.163407,'amu*angstrom^2'), symmetry=1, barrier=(3.75704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13672,'amu*angstrom^2'), symmetry=1, barrier=(49.1273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21414,0.0435099,-4.29996e-05,2.58252e-08,-6.94505e-12,-1962.52,22.6768], Tmin=(100,'K'), Tmax=(859.142,'K')), NASAPolynomial(coeffs=[5.89706,0.0263636,-1.30646e-05,2.59755e-09,-1.86335e-13,-2595.37,5.46787], Tmin=(859.142,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.8218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.10081,'amu*angstrom^2'), symmetry=1, barrier=(25.3097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10156,'amu*angstrom^2'), symmetry=1, barrier=(25.3271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10112,'amu*angstrom^2'), symmetry=1, barrier=(25.317,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68494,0.0483706,-4.4413e-05,2.0411e-08,-3.75131e-12,-1053.57,21.8356], Tmin=(100,'K'), Tmax=(1300.8,'K')), NASAPolynomial(coeffs=[12.1415,0.0162165,-7.33511e-06,1.40846e-09,-9.92316e-14,-3773.95,-31.361], Tmin=(1300.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.46982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = 'C[C-]=[O+]OCF(2566)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6442,0.0621043,-0.000104755,1.05828e-07,-4.08963e-11,-10999.1,31.6885], Tmin=(100,'K'), Tmax=(837.417,'K')), NASAPolynomial(coeffs=[1.6575,0.0381908,-1.91998e-05,3.70754e-09,-2.5625e-13,-10165.1,36.6198], Tmin=(837.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.0741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFHHO) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (51.6164,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,548,1085,1183,1302,1466,1520,3060,3119,270.437,271.692,1703.91,1704.6],'cm^-1')),
        HinderedRotor(inertia=(0.130669,'amu*angstrom^2'), symmetry=1, barrier=(6.66972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128808,'amu*angstrom^2'), symmetry=1, barrier=(6.66106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.32279,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.610532,'amu*angstrom^2'), symmetry=1, barrier=(32.0637,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48816,0.0611203,-8.82602e-05,7.89841e-08,-2.94175e-11,6292.81,21.5955], Tmin=(100,'K'), Tmax=(750.682,'K')), NASAPolynomial(coeffs=[5.719,0.0318655,-1.63944e-05,3.25281e-09,-2.30684e-13,5846.69,3.65688], Tmin=(750.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.6164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsFHHO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C=COO(2290)'],
    products = ['C=COOCF(2331)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C=COOF(2562)'],
    products = ['C=COOCF(2331)'],
    transitionState = 'TS3',
