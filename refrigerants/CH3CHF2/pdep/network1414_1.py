...
reaction(
    label = 'reaction2',
    reactants = ['O=C(O)O(2468)', 'C[C]F(124)'],
    products = ['CC(F)OC(=O)O(3855)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'O=C(O)OCF(2325)'],
    products = ['CC(F)OC(=O)O(3855)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)O[C](O)O(4354)'],
    products = ['CC(F)OC(=O)O(3855)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[CH]OC(=O)O(4355)'],
    products = ['CC(F)OC(=O)O(3855)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'CC(F)O[C]=O(2795)'],
    products = ['CC(F)OC(=O)O(3855)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)OC([O])=O(4356)'],
    products = ['CC(F)OC(=O)O(3855)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'O=C(O)O[CH]F(2489)'],
    products = ['CC(F)OC(=O)O(3855)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C[C](F)OC(=O)O(4357)'],
    products = ['CC(F)OC(=O)O(3855)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)OC(=O)O(4358)'],
    products = ['CC(F)OC(=O)O(3855)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC(F)OC(=O)O(3855)'],
    products = ['O=C(O)O(2468)', 'CH2CHF(56)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=COC(=O)O(2794)'],
    products = ['CC(F)OC(=O)O(3855)'],
