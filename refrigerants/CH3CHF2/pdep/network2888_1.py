...
"""),
    E0 = (-145.623,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,1855,455,950,206.835,1658.61],'cm^-1')),
        HinderedRotor(inertia=(0.545489,'amu*angstrom^2'), symmetry=1, barrier=(16.4724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.00899,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.95892,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3068,0.0641638,-9.20015e-05,7.29196e-08,-2.3517e-11,-17422,21.583], Tmin=(100,'K'), Tmax=(755.41,'K')), NASAPolynomial(coeffs=[8.90564,0.023921,-1.20807e-05,2.37737e-09,-1.67963e-13,-18569.9,-12.9444], Tmin=(755.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-OdOsH) + radical(C=C(O)CJ) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91029,0.0305822,2.50029e-05,-6.20019e-08,2.79376e-11,-52419.4,20.3211], Tmin=(100,'K'), Tmax=(944.654,'K')), NASAPolynomial(coeffs=[16.1576,0.00891326,-1.97619e-06,3.60181e-10,-3.14418e-14,-56836.1,-56.733], Tmin=(944.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-436.582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-OdCsOs) + group(CdCFH) + ring(4-Methylene-2-oxetanone)"""),
)
...
"""),
    E0 = (-43.3376,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,167,640,1190,1855,455,950,180,670.544],'cm^-1')),
        HinderedRotor(inertia=(0.544573,'amu*angstrom^2'), symmetry=1, barrier=(12.5208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88742,'amu*angstrom^2'), symmetry=1, barrier=(43.3956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245457,'amu*angstrom^2'), symmetry=1, barrier=(5.64353,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27361,0.0670326,-0.000109364,9.95816e-08,-3.59707e-11,-5120.98,21.9999], Tmin=(100,'K'), Tmax=(799.053,'K')), NASAPolynomial(coeffs=[6.86538,0.02779,-1.45772e-05,2.87831e-09,-2.02133e-13,-5655.43,-1.47535], Tmin=(799.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.3376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-OdOsH) + radical(Cdj(Cd-CsO2s)(F1s)) + radical((O)CJOC)"""),
)

species(
    label = 'C=C([C]F)OC=O(8043)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-121.176,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,302.942,308.229,312.988,1007.96,1998.42],'cm^-1')),
        HinderedRotor(inertia=(0.392182,'amu*angstrom^2'), symmetry=1, barrier=(24.7993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353618,'amu*angstrom^2'), symmetry=1, barrier=(24.9504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.40324,'amu*angstrom^2'), symmetry=1, barrier=(24.7215,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85246,0.0529784,-5.71724e-05,3.37556e-08,-8.50603e-12,-14501.6,19.6136], Tmin=(100,'K'), Tmax=(929.901,'K')), NASAPolynomial(coeffs=[8.05458,0.0263002,-1.41391e-05,2.90459e-09,-2.11992e-13,-15655.1,-9.85742], Tmin=(929.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]=C(CF)O[C]=O(8044)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.56303,'amu*angstrom^2'), symmetry=1, barrier=(35.9371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.996083,'amu*angstrom^2'), symmetry=1, barrier=(22.9019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00561,'amu*angstrom^2'), symmetry=1, barrier=(23.121,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26973,0.0654283,-9.10893e-05,6.84227e-08,-2.08989e-11,-5704.31,21.1129], Tmin=(100,'K'), Tmax=(795.449,'K')), NASAPolynomial(coeffs=[9.56521,0.0237137,-1.24269e-05,2.49579e-09,-1.7886e-13,-7024.04,-17.0096], Tmin=(795.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.2054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P) + radical((O)CJOC)"""),
)

species(
    label = '[CH]C(=C)OC(=O)F(8045)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28642,0.057581,-5.24953e-05,2.42119e-08,-4.51086e-12,-22500.9,22.6686], Tmin=(100,'K'), Tmax=(1275.7,'K')), NASAPolynomial(coeffs=[12.8881,0.0212037,-9.72232e-06,1.8593e-09,-1.30431e-13,-25461,-36.1279], Tmin=(1275.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(COFOO) + radical(AllylJ2_triplet)"""),
)
...
"""),
    E0 = (-130.304,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,194,682,905,1196,1383,3221,2782.5,750,1395,475,1775,1000,458.846,458.846,458.847,458.847,458.848],'cm^-1')),
        HinderedRotor(inertia=(0.342655,'amu*angstrom^2'), symmetry=1, barrier=(51.1938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342652,'amu*angstrom^2'), symmetry=1, barrier=(51.1938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342655,'amu*angstrom^2'), symmetry=1, barrier=(51.1938,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97984,0.0506024,-4.14685e-05,1.91749e-08,-4.08548e-12,-15604.3,20.9682], Tmin=(100,'K'), Tmax=(1023.55,'K')), NASAPolynomial(coeffs=[6.19047,0.0341473,-1.73537e-05,3.46824e-09,-2.49146e-13,-16466.3,0.556381], Tmin=(1023.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-OdOsH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[CH2]C(=O)[CH]F(427)'],
    products = ['[CH2]C(=CF)O[C]=O(7384)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[C]=CF(4128)'],
    products = ['[CH2]C(=CF)O[C]=O(7384)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C(=O)[CH]F(427)'],
    products = ['[CH2]C(=CF)O[C]=O(7384)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]F(230)', 'C=[C]O[C]=O(721)'],
    products = ['[CH2]C(=CF)O[C]=O(7384)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF(40)', 'C=[C]O[C]=O(721)'],
    products = ['[CH2]C(=CF)O[C]=O(7384)'],
