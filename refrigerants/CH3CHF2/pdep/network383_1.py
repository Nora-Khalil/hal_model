...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(395)', '[O]C[C]=O(690)'],
    products = ['C=[C]OC[C]=O(1250)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH2]O[C]=C(396)'],
    products = ['C=[C]OC[C]=O(1250)'],
    transitionState = 'TS3',
