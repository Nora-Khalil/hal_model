...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)C1OC1F(9450)'],
    products = ['HF(38)', 'CO2(14)', 'FC1=CO1(4185)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'O=CC(=O)OF(2752)'],
    products = ['O=C(OF)C1OC1F(9450)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O-2(457)', 'O=C(C=CF)OF(3539)'],
    products = ['O=C(OF)C1OC1F(9450)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(142)', 'O=C=C1OC1F(9619)'],
    products = ['O=C(OF)C1OC1F(9450)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C([CH]O[CH]F)OF(9622)'],
    products = ['O=C(OF)C1OC1F(9450)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([CH]F)C(=O)OF(5850)'],
    products = ['O=C(OF)C1OC1F(9450)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)[CH]C(=O)OF(9142)'],
    products = ['O=C(OF)C1OC1F(9450)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(OF)C1O[C]1F(9624)'],
    products = ['O=C(OF)C1OC1F(9450)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](OF)C1O[C]1F(9625)'],
    products = ['O=C(OF)C1OC1F(9450)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(OF)C1[CH]O1(9627)'],
    products = ['O=C(OF)C1OC1F(9450)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(=O)C1OC1F(9628)'],
    products = ['O=C(OF)C1OC1F(9450)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(126)', 'O=[C]C1OC1F(9629)'],
    products = ['O=C(OF)C1OC1F(9450)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]OF(167)', 'FC1[CH]O1(458)'],
    products = ['O=C(OF)C1OC1F(9450)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O=C(OF)[C]1OC1F(9630)'],
    products = ['O=C(OF)C1OC1F(9450)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(OF)C1O[C]1F(9631)'],
    products = ['O=C(OF)C1OC1F(9450)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(OF)C1=CO1(9617)'],
    products = ['O=C(OF)C1OC1F(9450)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=C(OF)C1OC1F(9450)'],
    products = ['F2(78)', 'CO2(14)', 'C1=CO1(373)'],
