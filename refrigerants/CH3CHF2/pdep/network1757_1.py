...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2927)', '[O]C[C]=O(690)'],
    products = ['O=[C]CO[C](F)F(4674)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH2]O[C](F)F(3131)'],
    products = ['O=[C]CO[C](F)F(4674)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[C](F)F(3131)'],
    products = ['O=[C]CO[C](F)F(4674)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[C](F)F(4665)'],
    products = ['O=[C]CO[C](F)F(4674)'],
    transitionState = 'TS9',
