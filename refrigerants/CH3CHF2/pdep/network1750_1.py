...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C(F)F(3137)'],
    products = ['[CH]=CC([O])(F)F(4667)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O][C](F)F(4778)', 'C2H2(23)'],
    products = ['[CH]=CC([O])(F)F(4667)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(4778)', '[CH]=[CH](264)'],
    products = ['[CH]=CC([O])(F)F(4667)'],
    transitionState = 'TS8',
