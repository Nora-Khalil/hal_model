...
"""),
    E0 = (-627.713,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.230043,'amu*angstrom^2'), symmetry=1, barrier=(5.28914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229121,'amu*angstrom^2'), symmetry=1, barrier=(5.26794,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(2927)', '[CH2]C[CH]F(229)'],
    products = ['F[CH]CC[C](F)F(3049)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(230)', '[CH2]C[C](F)F(3082)'],
    products = ['F[CH]CC[C](F)F(3049)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]CC=C(F)F(3085)'],
    products = ['F[CH]CC[C](F)F(3049)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC=CC[C](F)F(3058)'],
    products = ['F[CH]CC[C](F)F(3049)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]C[CH]F(229)'],
    products = ['F[CH]CC[C](F)F(3049)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C[C](F)F(3082)'],
    products = ['F[CH]CC[C](F)F(3049)'],
