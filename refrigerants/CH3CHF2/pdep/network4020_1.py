...
"""),
    E0 = (202.082,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,2175,525,3120,650,792.5,1650,239,401,1367,1661.6],'cm^-1')),
        HinderedRotor(inertia=(0.487794,'amu*angstrom^2'), symmetry=1, barrier=(11.2153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.946388,'amu*angstrom^2'), symmetry=1, barrier=(21.7593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87868,0.0529399,-6.17112e-05,3.20773e-08,-8.48055e-13,24375.2,20.4978], Tmin=(100,'K'), Tmax=(564.869,'K')), NASAPolynomial(coeffs=[6.9931,0.0256576,-1.29883e-05,2.57431e-09,-1.83104e-13,23654.9,-2.51684], Tmin=(564.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(CtCF) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C=CF)CF(12003)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54328,0.0586195,-5.87027e-05,3.6172e-08,-9.8815e-12,15608.5,21.8839], Tmin=(100,'K'), Tmax=(853.745,'K')), NASAPolynomial(coeffs=[6.6735,0.0345839,-1.64741e-05,3.19773e-09,-2.26001e-13,14732.5,-2.0554], Tmin=(853.745,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCddFH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC=[C]F(3960)'],
    products = ['[CH]=C(C=[C]F)CF(8200)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C=[C]F(3994)'],
    products = ['[CH]=C(C=[C]F)CF(8200)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2F(46)', 'C#CC=[C]F(3957)'],
    products = ['[CH]=C(C=[C]F)CF(8200)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(C#CF)CF(12002)'],
    products = ['[CH]=C(C=[C]F)CF(8200)'],
    transitionState = 'TS8',
