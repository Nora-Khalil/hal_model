...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3025)', '[CH2]O[CH2](320)'],
    products = ['[CH2]OC[C](F)F(3105)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]OC=C(F)F(3204)'],
    products = ['[CH2]OC[C](F)F(3105)'],
    transitionState = 'TS8',
