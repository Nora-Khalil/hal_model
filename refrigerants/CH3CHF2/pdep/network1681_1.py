...
"""),
    E0 = (-85.8255,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([257,409,1143,1361,2944,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,1027.91,1027.94,1027.94],'cm^-1')),
        HinderedRotor(inertia=(2.44154,'amu*angstrom^2'), symmetry=1, barrier=(56.1358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.44155,'amu*angstrom^2'), symmetry=1, barrier=(56.1361,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.0606,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.77513,0.0325039,-6.32995e-06,-4.61427e-08,4.80458e-11,-10284.1,23.9212], Tmin=(100,'K'), Tmax=(455.14,'K')), NASAPolynomial(coeffs=[4.39541,0.0263708,-1.28347e-05,2.51932e-09,-1.79082e-13,-10515.5,16.4572], Tmin=(455.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-85.8255,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]CC(F)F-2(7354)',
    structure = adjacencyList("""1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {4,S}
3 C u0 p0 c0 {4,S} {5,S} {6,S} {7,S}
...
"""),
    E0 = (-79.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,229.145,229.148,230.162,2690.39],'cm^-1')),
        HinderedRotor(inertia=(0.00137903,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00317145,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.0606,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28522,0.0413372,-4.86191e-05,3.52183e-08,-1.10487e-11,-9535.04,15.3917], Tmin=(100,'K'), Tmax=(758.198,'K')), NASAPolynomial(coeffs=[5.88326,0.022353,-1.10569e-05,2.18688e-09,-1.55991e-13,-10080.6,-0.970349], Tmin=(758.198,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCsFFH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['HF(38)', 'C=C[C]F-2(6103)'],
    products = ['C=CC(F)F(973)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]C=C(F)F(2958)'],
    products = ['C=CC(F)F(973)'],
    transitionState = 'TS8',
