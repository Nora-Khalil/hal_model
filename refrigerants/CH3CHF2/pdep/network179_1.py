...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[CH]=C[O](133)'],
    products = ['[CH]=CO[C]=O(684)'],
    transitionState = 'TS2',
