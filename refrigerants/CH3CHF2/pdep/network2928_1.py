...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81251,0.0528266,-4.94379e-05,2.69197e-08,-6.45222e-12,-23339.7,20.9084], Tmin=(100,'K'), Tmax=(960.376,'K')), NASAPolynomial(coeffs=[7.12232,0.0307111,-1.48959e-05,2.9415e-09,-2.10349e-13,-24359.6,-4.49368], Tmin=(960.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.679,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (16.4425,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,145,326,398,834,1303,2950,3100,1380,975,1025,1650,540,610,2055,1855,455,950,396.337],'cm^-1')),
        HinderedRotor(inertia=(0.127259,'amu*angstrom^2'), symmetry=1, barrier=(14.2407,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1288,'amu*angstrom^2'), symmetry=1, barrier=(14.2374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84264,0.0484333,-3.79332e-05,1.40656e-08,-2.11045e-12,2053.8,21.4372], Tmin=(100,'K'), Tmax=(1522.87,'K')), NASAPolynomial(coeffs=[12.3754,0.0207685,-1.06845e-05,2.1373e-09,-1.52299e-13,-1154.27,-33.8074], Tmin=(1522.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.4425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CdCddCF) + group(Cds-OdCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.926334,'amu*angstrom^2'), symmetry=1, barrier=(21.2982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.922723,'amu*angstrom^2'), symmetry=1, barrier=(21.2152,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14327,0.050144,-2.71481e-05,-6.07714e-08,7.95204e-11,5248.37,20.3486], Tmin=(100,'K'), Tmax=(456.495,'K')), NASAPolynomial(coeffs=[6.47648,0.0292507,-1.46048e-05,2.85358e-09,-2.00161e-13,4674.83,0.892591], Tmin=(456.495,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.1625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + missing(Cdd-CdO2d) + radical(Cds_S)"""),
)

species(
    label = 'C#CC(F)C[C]=O(7645)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {6,D}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.431348,'amu*angstrom^2'), symmetry=1, barrier=(9.91754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.43159,'amu*angstrom^2'), symmetry=1, barrier=(9.92309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.81642,'amu*angstrom^2'), symmetry=1, barrier=(87.7471,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14418,0.0686964,-0.000106508,9.06392e-08,-3.01768e-11,419.379,22.7243], Tmin=(100,'K'), Tmax=(861.607,'K')), NASAPolynomial(coeffs=[8.11138,0.0252264,-1.14622e-05,2.1117e-09,-1.41875e-13,-368.281,-7.4543], Tmin=(861.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.6787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(CsCCFH) + group(Cds-OdCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.23389,'amu*angstrom^2'), symmetry=1, barrier=(28.3696,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0845,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43864,0.0597968,-7.86997e-05,5.54008e-08,-1.56855e-11,39785,19.3972], Tmin=(100,'K'), Tmax=(860.673,'K')), NASAPolynomial(coeffs=[9.97259,0.0201332,-9.56997e-06,1.85128e-09,-1.30193e-13,38316.1,-20.4934], Tmin=(860.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(Cd-Cd(CO)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-O2d(Cds-Cds)H) + radical(C=CJC=C) + radical(C=CCJ=O)"""),
)

species(
    label = '[CH2]C=C(F)C[C]=O(7647)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {7,D}
3  C u0 p0 c0 {4,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14681,0.0598256,-5.63186e-05,2.68798e-08,-5.12916e-12,6927.76,23.7977], Tmin=(100,'K'), Tmax=(1257.84,'K')), NASAPolynomial(coeffs=[13.6951,0.0199214,-8.73219e-06,1.65868e-09,-1.16391e-13,3771,-39.6192], Tmin=(1257.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.7267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(F)C[C]=O(7649)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {6,D}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.378916,'amu*angstrom^2'), symmetry=1, barrier=(8.71202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379336,'amu*angstrom^2'), symmetry=1, barrier=(8.72168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379108,'amu*angstrom^2'), symmetry=1, barrier=(8.71644,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16037,0.0685976,-0.000101814,8.86531e-08,-3.12827e-11,10178.1,25.4518], Tmin=(100,'K'), Tmax=(793.12,'K')), NASAPolynomial(coeffs=[7.03332,0.0308781,-1.51571e-05,2.9357e-09,-2.04762e-13,9501.3,0.0855131], Tmin=(793.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.8248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O) + radical(Cds_P)"""),
)

species(
    label = 'C=CC(F)[CH][C]=O(7650)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {7,D}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6003,0.0561451,-5.77308e-05,3.41633e-08,-8.56503e-12,595.705,23.2427], Tmin=(100,'K'), Tmax=(944.189,'K')), NASAPolynomial(coeffs=[8.26791,0.0278973,-1.2853e-05,2.47535e-09,-1.74501e-13,-663.352,-8.54153], Tmin=(944.189,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.25807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)

species(
    label = 'C=[C][C](F)CC=O(7651)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8822,0.0560473,-3.70925e-05,-4.1232e-08,6.19016e-11,6167.41,22.8732], Tmin=(100,'K'), Tmax=(475.248,'K')), NASAPolynomial(coeffs=[6.62434,0.032781,-1.61991e-05,3.16219e-09,-2.22285e-13,5528.68,1.54503], Tmin=(475.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.7257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CsCdCsF1s) + radical(Cdj(Cs-F1sCsH)(Cd-HH))"""),
)

species(
    label = '[CH]=[C]C(F)CC=O(7652)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.379262,'amu*angstrom^2'), symmetry=1, barrier=(8.71998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379204,'amu*angstrom^2'), symmetry=1, barrier=(8.71864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379361,'amu*angstrom^2'), symmetry=1, barrier=(8.72225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0787,0.0726079,-0.000116529,1.07758e-07,-3.93011e-11,19325.6,25.8266], Tmin=(100,'K'), Tmax=(818.477,'K')), NASAPolynomial(coeffs=[5.73642,0.0341139,-1.71524e-05,3.33036e-09,-2.31563e-13,19090.1,7.50767], Tmin=(818.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(395)', 'O=[C]C[CH]F(304)'],
    products = ['C=[C]C(F)C[C]=O(7422)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(128)', '[CH2]C(F)[C]=C(277)'],
    products = ['C=[C]C(F)C[C]=O(7422)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C(F)[C]=C(277)'],
    products = ['C=[C]C(F)C[C]=O(7422)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C=C(F)C[C]=O(7643)'],
    products = ['C=[C]C(F)C[C]=O(7422)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=[C]C(F)C=C=O(7644)'],
    products = ['C=[C]C(F)C[C]=O(7422)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C#CC(F)C[C]=O(7645)'],
    products = ['C=[C]C(F)C[C]=O(7422)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'C=[C]C=C[C]=O(7646)'],
    products = ['C=[C]C(F)C[C]=O(7422)'],
