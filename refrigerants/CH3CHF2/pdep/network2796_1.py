...
"""),
    E0 = (-483.152,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,213.515,218.723,219.893],'cm^-1')),
        HinderedRotor(inertia=(0.00368399,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00503992,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.460262,'amu*angstrom^2'), symmetry=1, barrier=(10.7961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.64272,'amu*angstrom^2'), symmetry=1, barrier=(20.8144,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.654217,0.0779755,-0.000115539,8.7281e-08,-2.59376e-11,-57993.3,24.6929], Tmin=(100,'K'), Tmax=(827.805,'K')), NASAPolynomial(coeffs=[12.7752,0.0194068,-9.4121e-06,1.81342e-09,-1.26342e-13,-60000.1,-31.4933], Tmin=(827.805,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-483.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(OCJO)"""),
)
...
"""),
    E0 = (-651.949,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00831457,'amu*angstrom^2'), symmetry=1, barrier=(4.76687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73344,'amu*angstrom^2'), symmetry=1, barrier=(39.8551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0694864,'amu*angstrom^2'), symmetry=1, barrier=(39.8483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90121,0.0462998,-3.72121e-05,1.45086e-08,-2.30229e-12,-78336.3,20.8777], Tmin=(100,'K'), Tmax=(1450.59,'K')), NASAPolynomial(coeffs=[11.4812,0.0198832,-9.89576e-06,1.95449e-09,-1.38676e-13,-81115.6,-28.9035], Tmin=(1450.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-651.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
"""),
    E0 = (-444.715,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,180,1055.71,1056.61],'cm^-1')),
        HinderedRotor(inertia=(1.09923,'amu*angstrom^2'), symmetry=1, barrier=(25.2735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.076751,'amu*angstrom^2'), symmetry=1, barrier=(1.76466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09955,'amu*angstrom^2'), symmetry=1, barrier=(25.2809,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
...
"""),
    E0 = (-471.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0261369,'amu*angstrom^2'), symmetry=1, barrier=(44.039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00358421,'amu*angstrom^2'), symmetry=1, barrier=(6.00853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26123,'amu*angstrom^2'), symmetry=1, barrier=(6.0062,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1378,0.0739657,-0.000130584,1.2887e-07,-4.89394e-11,-56656.8,21.9774], Tmin=(100,'K'), Tmax=(821.648,'K')), NASAPolynomial(coeffs=[3.92654,0.0367874,-1.96238e-05,3.87859e-09,-2.715e-13,-56318.4,13.9193], Tmin=(821.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-471.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.682009,0.0799158,-0.000131167,1.13376e-07,-3.84896e-11,-57870.6,26.475], Tmin=(100,'K'), Tmax=(815.35,'K')), NASAPolynomial(coeffs=[9.98833,0.0249046,-1.27509e-05,2.48089e-09,-1.72297e-13,-59077.2,-14.6158], Tmin=(815.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-482.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHOO) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]O(7129)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]O(237)', '[CH2]C([O])(F)F(1114)'],
    products = ['[CH2]C(F)(F)O[CH]O(7129)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O[CH]O[C](F)F(4863)'],
    products = ['[CH2]C(F)(F)O[CH]O(7129)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]C(F)(F)O[CH]O(7129)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(12.0176,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)O[CH]O(7129)'],
    products = ['[CH2][C](F)OC(O)F(7152)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(228.156,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
