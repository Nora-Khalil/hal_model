...
"""),
    E0 = (-158.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,326,540,652,719,1357,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59609,0.0569465,-7.37907e-05,4.65538e-08,-1.16699e-11,-19002.3,20.4814], Tmin=(100,'K'), Tmax=(968.41,'K')), NASAPolynomial(coeffs=[11.7381,0.0150568,-8.90906e-06,1.89013e-09,-1.40185e-13,-20966.7,-28.1228], Tmin=(968.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(CdCFO) + group(Cds-OdOsOs) + group(Cds-CdsHH) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'O[C]1OC=C(F)O1(7755)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (105.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05787,0.0260905,3.0044e-05,-6.62094e-08,2.89902e-11,-49889.2,18.4464], Tmin=(100,'K'), Tmax=(959.685,'K')), NASAPolynomial(coeffs=[17.138,0.00459997,-1.01839e-06,2.80917e-10,-3.03329e-14,-54688.5,-63.6101], Tmin=(959.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-415.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CdCFO) + group(Cds-CdsOsH) + ring(Cyclopentane) + radical(Cs_P) + longDistanceInteraction_cyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[O]C1(O)C=C(F)O1(7756)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (105.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27701,0.0411958,-4.34508e-05,2.70605e-08,-7.26864e-12,-39923.1,19.1278], Tmin=(100,'K'), Tmax=(877.205,'K')), NASAPolynomial(coeffs=[6.49375,0.0219681,-1.05723e-05,2.07357e-09,-1.47563e-13,-40662.9,-0.663073], Tmin=(877.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cds-CdsCsH) + group(CdCFO) + ring(Cs-Cd-Cd(F)-O2s) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-20.5054,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([293,496,537,1218,3120,650,792.5,1650,1855,455,950,185.23,189.634],'cm^-1')),
        HinderedRotor(inertia=(1.26016,'amu*angstrom^2'), symmetry=1, barrier=(31.7436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47463,'amu*angstrom^2'), symmetry=1, barrier=(37.514,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0371,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3303.29,'J/mol'), sigma=(5.24886,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=515.97 K, Pc=51.83 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8757,0.0517285,-7.97773e-05,6.13132e-08,-1.76633e-11,-2394.44,16.9163], Tmin=(100,'K'), Tmax=(639.349,'K')), NASAPolynomial(coeffs=[8.6584,0.015318,-8.48771e-06,1.71589e-09,-1.22463e-13,-3384.88,-13.7354], Tmin=(639.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.5054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cdj(Cd-F1sO2s)(H)) + radical((O)CJOC)"""),
)

species(
    label = '[CH]=C(F)OC([O])=O(7757)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u1 p2 c0 {6,S}
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(F)OC(=O)O(2467)'],
    products = ['[O]C1(O)C=C(F)O1(7756)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5.41e+10,'s^-1'), n=0.21, Ea=(121.905,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_DS;multiplebond_intra;radadd_intra_cdsingleH] for rate rule [R5_DS_CO;carbonylbond_intra_Nd;radadd_intra_cdsingleH]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 119.2 to 121.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C#COC(=O)O(1412)'],
    products = ['[CH]=C(F)OC(=O)O(2467)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)O(1596)', 'C2HF(58)'],
    products = ['[CH]=C(F)OC(=O)O(2467)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(7.1589,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=[C]OC(=O)O(1499)'],
    products = ['[CH]=C(F)OC(=O)O(2467)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]O(165)', '[CH]C(=O)F(6019)'],
    products = ['[CH]=C(F)OC(=O)O(2467)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)O(1596)', '[CH]=[C]F(1074)'],
    products = ['[CH]=C(F)OC(=O)O(2467)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH]=C(F)O[C]=O(4093)'],
    products = ['[CH]=C(F)OC(=O)O(2467)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(F)OC([O])=O(7757)'],
    products = ['[CH]=C(F)OC(=O)O(2467)'],
