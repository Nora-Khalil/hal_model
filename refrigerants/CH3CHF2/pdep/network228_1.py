...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH2]C[O](339)'],
    products = ['[O]CC[C]=O(856)'],
    transitionState = 'TS3',
