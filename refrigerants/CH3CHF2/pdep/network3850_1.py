...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.557246,'amu*angstrom^2'), symmetry=1, barrier=(12.8122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.557973,'amu*angstrom^2'), symmetry=1, barrier=(12.8289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.558262,'amu*angstrom^2'), symmetry=1, barrier=(12.8355,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17674,0.0557947,-4.17343e-05,1.62723e-08,-2.58336e-12,65521.3,24.5274], Tmin=(100,'K'), Tmax=(1478.2,'K')), NASAPolynomial(coeffs=[12.9838,0.023845,-9.31335e-06,1.65044e-09,-1.10441e-13,62030.6,-37.0491], Tmin=(1478.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[C]=C(11496)'],
    products = ['[CH]=C(C)C[C]=C(11525)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(395)', '[CH]C(=C)C(6403)'],
    products = ['[CH]=C(C)C[C]=C(11525)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'C#CC[C]=C(11376)'],
    products = ['[CH]=C(C)C[C]=C(11525)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(C)CC#C(8508)'],
    products = ['[CH]=C(C)C[C]=C(11525)'],
