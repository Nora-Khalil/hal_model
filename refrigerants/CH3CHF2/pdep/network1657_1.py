...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CH4(4)'],
    products = ['CH3CHF2(1)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.000267207,'cm^3/(mol*s)'), n=4.72997, Ea=(129.265,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 3.00906, dn = +|- 0.144732, dEa = +|- 0.787625 kJ/molMatched reaction 47 CF2_r1 + CH4 <=> C2H4F2-3 in 1,2_Insertion_carbene/training
This reaction matched rate rule [CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s]
family: 1,2_Insertion_carbene"""),
)

reaction(
    label = 'reaction1',
    reactants = ['CH2(S)(25)', 'CH2F2(41)'],
    products = ['CH3CHF2(1)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3CHF2(1)'],
    products = ['HF(38)', 'C[C]F(124)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(6.97e+14,'s^-1'), n=0, Ea=(75.6098,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 36 C2H4F2 <=> C2H3F + FH in 1,2_Insertion_carbene/training
This reaction matched rate rule [HY_N-3Br1sCCl1sF1sHI1s->F1s_N-4Br1sCl1sF1sI1s->Br1s_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1s->F1s_4Cl1sF1s->F1s]
family: 1,2_Insertion_carbene
Ea raised from 309.6 to 316.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'CH3F(39)'],
    products = ['CH3CHF2(1)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.96165,'cm^3/(mol*s)'), n=3.30609, Ea=(133.548,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.14157, dn = +|- 0.0173948, dEa = +|- 0.0946619 kJ/molMatched reaction 45 CHF_r1 + CH3F <=> C2H4F2-2 in 1,2_Insertion_carbene/training
This reaction matched rate rule [CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s]
family: 1,2_Insertion_carbene"""),
)

reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'CH3-CHF(63)'],
    products = ['CH3CHF2(1)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF2(81)', 'CH3(19)'],
    products = ['CH3CHF2(1)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(6.35e+08,'cm^3/(mol*s)'), n=0, Ea=(0,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 190 CH3 + CHF2 <=> C2H4F2-2 in R_Recombination/training
This reaction matched rate rule [Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_2CF->C_Ext-1C-R]
family: R_Recombination
Ea raised from -40.2 to 0 kJ/mol."""),
)

reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'CHF2-CH2(64)'],
    products = ['CH3CHF2(1)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.96e+37,'cm^3/(mol*s)'), n=-9.05, Ea=(7160,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 181 C2H3F2-2 + H <=> C2H4F2-2 in R_Recombination/training
This reaction matched rate rule [Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_N-3C-inRing_Ext-3C-R_N-4R!H->C_Sp-3C-2C_Ext-3C-R]
family: R_Recombination"""),
)

reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'CH3-CF2(65)'],
    products = ['CH3CHF2(1)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.11e+40,'cm^3/(mol*s)'), n=-9.59, Ea=(7190,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 182 C2H3F2-3 + H <=> C2H4F2-2 in R_Recombination/training
This reaction matched rate rule [Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Sp-4C-2C_Ext-2C-R]
family: R_Recombination"""),
)
