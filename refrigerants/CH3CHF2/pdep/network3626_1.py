...
"""),
    E0 = (-132.109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2175,525,750,770,3400,2100,180,997.21],'cm^-1')),
        HinderedRotor(inertia=(0.906903,'amu*angstrom^2'), symmetry=1, barrier=(50.5113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108111,'amu*angstrom^2'), symmetry=1, barrier=(76.3177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.31812,'amu*angstrom^2'), symmetry=1, barrier=(76.2901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12543,0.0360047,-1.94595e-05,2.24808e-09,1.05119e-12,-15817.2,18.9767], Tmin=(100,'K'), Tmax=(1134.38,'K')), NASAPolynomial(coeffs=[9.07146,0.0193084,-7.69121e-06,1.39057e-09,-9.50494e-14,-17894.7,-17.6208], Tmin=(1134.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CtOsHH) + group(Cds-OdOsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (412.269,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2175,525,353.811,354.324,356.222,358.835,1593.41],'cm^-1')),
        HinderedRotor(inertia=(0.0013492,'amu*angstrom^2'), symmetry=1, barrier=(0.12001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.755036,'amu*angstrom^2'), symmetry=1, barrier=(67.0334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.769916,'amu*angstrom^2'), symmetry=1, barrier=(66.9894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78564,0.0488115,-5.31928e-05,3.27835e-08,-8.21316e-12,49664.1,20.9525], Tmin=(100,'K'), Tmax=(968.527,'K')), NASAPolynomial(coeffs=[8.93618,0.0192792,-7.4537e-06,1.29911e-09,-8.60984e-14,48279.1,-13.3159], Tmin=(968.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CtOsHH) + group(Cs-OsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(OCOJ) + radical(Acetyl)"""),
)

species(
    label = '[C]#CCO[CH]O(11514)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (373.831,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2175,525,256.221,256.222,256.223,1188.2],'cm^-1')),
        HinderedRotor(inertia=(0.00256784,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19983,'amu*angstrom^2'), symmetry=1, barrier=(9.30937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199829,'amu*angstrom^2'), symmetry=1, barrier=(9.30937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38181,'amu*angstrom^2'), symmetry=1, barrier=(64.3739,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10812,0.0689628,-0.000113078,9.29593e-08,-2.86291e-11,45060.7,22.6957], Tmin=(100,'K'), Tmax=(958.41,'K')), NASAPolynomial(coeffs=[9.82453,0.0165193,-5.85644e-06,8.86782e-10,-5.00081e-14,44127.7,-15.1365], Tmin=(958.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CtOsHH) + group(Cs-OsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(OCJO) + radical(Acetyl)"""),
)
...
"""),
    E0 = (60.663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,180,180,1584.69],'cm^-1')),
        HinderedRotor(inertia=(0.919145,'amu*angstrom^2'), symmetry=1, barrier=(21.1329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.508241,'amu*angstrom^2'), symmetry=1, barrier=(11.6855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.22527,'amu*angstrom^2'), symmetry=1, barrier=(51.1633,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07321,0.0484986,-4.90869e-05,1.60776e-08,7.68816e-12,7359.52,17.8643], Tmin=(100,'K'), Tmax=(543.76,'K')), NASAPolynomial(coeffs=[6.30788,0.0264009,-1.31027e-05,2.57863e-09,-1.82894e-13,6765.15,-1.21631], Tmin=(543.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cd)OsHH) + group(Cds-CdsCsH) + group(Cds-OdOsH) + group(CdJ2_singlet-Cds)"""),
)
