...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[C-]=[O+]C#CF(10505)'],
    products = ['[C-]=[O+]CC#CF(10129)'],
    transitionState = 'TS2',
