...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02885,0.0297167,3.35692e-05,-7.12547e-08,3.22829e-11,17025.7,21.8016], Tmin=(100,'K'), Tmax=(900.16,'K')), NASAPolynomial(coeffs=[13.4974,0.0150522,-2.47996e-06,2.39819e-10,-1.43278e-14,13490.4,-40.4898], Tmin=(900.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Tetrahydrofuran) + radical(CCJCO) + radical(Cs_P)"""),
)
...
"""),
    E0 = (100.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,334.491,334.491,334.491,1463.26],'cm^-1')),
        HinderedRotor(inertia=(0.247811,'amu*angstrom^2'), symmetry=1, barrier=(19.675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.488541,'amu*angstrom^2'), symmetry=1, barrier=(38.7878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.48854,'amu*angstrom^2'), symmetry=1, barrier=(38.7878,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42074,0.0622976,-6.52458e-05,3.84772e-08,-9.70578e-12,12181.5,23.4497], Tmin=(100,'K'), Tmax=(930.711,'K')), NASAPolynomial(coeffs=[8.53005,0.0317429,-1.60012e-05,3.20292e-09,-2.30584e-13,10858.2,-10.3381], Tmin=(930.711,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CCJCO)"""),
)

species(
    label = 'C=[C]CC([O])OF(11577)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (221.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2950,3100,1380,975,1025,1650,1685,370,310.366,310.384,310.401,2315.26],'cm^-1')),
        HinderedRotor(inertia=(0.0870928,'amu*angstrom^2'), symmetry=1, barrier=(5.955,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.087085,'amu*angstrom^2'), symmetry=1, barrier=(5.95532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.388579,'amu*angstrom^2'), symmetry=1, barrier=(26.5662,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22963,0.0677273,-0.000100837,9.10539e-08,-3.35021e-11,26730.4,27.3881], Tmin=(100,'K'), Tmax=(782.635,'K')), NASAPolynomial(coeffs=[5.81835,0.0341914,-1.72367e-05,3.37946e-09,-2.37488e-13,26321,8.34765], Tmin=(782.635,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C[C](O)OF(11578)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (201.016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,2950,3100,1380,975,1025,1650,1685,370,180,632.799,632.807],'cm^-1')),
        HinderedRotor(inertia=(0.0351356,'amu*angstrom^2'), symmetry=1, barrier=(9.98306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0351317,'amu*angstrom^2'), symmetry=1, barrier=(9.98316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120162,'amu*angstrom^2'), symmetry=1, barrier=(9.983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.434198,'amu*angstrom^2'), symmetry=1, barrier=(9.98306,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07856,0.0689198,-8.97283e-05,6.4015e-08,-1.85889e-11,24277.7,27.7725], Tmin=(100,'K'), Tmax=(835.76,'K')), NASAPolynomial(coeffs=[10.064,0.0259156,-1.25465e-05,2.44974e-09,-1.73207e-13,22775.7,-13.9651], Tmin=(835.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCC([O])OF(11579)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {5,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (230.729,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,290.782,290.8,290.874],'cm^-1')),
        HinderedRotor(inertia=(0.134134,'amu*angstrom^2'), symmetry=1, barrier=(8.05047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134107,'amu*angstrom^2'), symmetry=1, barrier=(8.05062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00921561,'amu*angstrom^2'), symmetry=1, barrier=(26.2181,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6069,0.060389,-6.24038e-05,2.1527e-08,9.11464e-12,27828.9,26.037], Tmin=(100,'K'), Tmax=(540.686,'K')), NASAPolynomial(coeffs=[6.89402,0.0325305,-1.63434e-05,3.2361e-09,-2.30313e-13,27092.7,2.25938], Tmin=(540.686,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC[C](O)OF(11580)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (210.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,630.992],'cm^-1')),
        HinderedRotor(inertia=(0.549045,'amu*angstrom^2'), symmetry=1, barrier=(12.6236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153227,'amu*angstrom^2'), symmetry=1, barrier=(12.6227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126229,'amu*angstrom^2'), symmetry=1, barrier=(2.90225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0447316,'amu*angstrom^2'), symmetry=1, barrier=(12.6209,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07775,0.0673944,-8.01124e-05,5.02398e-08,-1.27104e-11,25392.3,27.7032], Tmin=(100,'K'), Tmax=(957.131,'K')), NASAPolynomial(coeffs=[11.616,0.023354,-1.10937e-05,2.16691e-09,-1.53994e-13,23375,-22.6759], Tmin=(957.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cds_P)"""),
)

species(
    label = 'C=CC=C(O)OF(11581)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {6,S}
...
"""),
    E0 = (-114.202,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.854496,'amu*angstrom^2'), symmetry=1, barrier=(19.6465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.855558,'amu*angstrom^2'), symmetry=1, barrier=(19.671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.854259,'amu*angstrom^2'), symmetry=1, barrier=(19.6411,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.463824,0.0721262,-8.28725e-05,4.68713e-08,-1.02137e-11,-13603.1,22.7995], Tmin=(100,'K'), Tmax=(1134.94,'K')), NASAPolynomial(coeffs=[17.331,0.012679,-4.30332e-06,7.19334e-10,-4.74919e-14,-17431.8,-60.7097], Tmin=(1134.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-133.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,542.29,542.306,542.411,542.506,542.55,542.555,542.648],'cm^-1')),
        HinderedRotor(inertia=(0.000573261,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000573101,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55128,0.0269555,8.43026e-06,-1.98824e-08,6.26926e-12,-15954.8,18.3716], Tmin=(100,'K'), Tmax=(1311.84,'K')), NASAPolynomial(coeffs=[8.76298,0.0273589,-1.41494e-05,2.83278e-09,-2.01709e-13,-19249,-19.6264], Tmin=(1311.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66348,0.046703,-3.03761e-05,8.23677e-09,-8.15178e-13,1714.78,22.0483], Tmin=(100,'K'), Tmax=(1843.2,'K')), NASAPolynomial(coeffs=[19.1231,0.0138309,-7.70794e-06,1.51479e-09,-1.03764e-13,-5573.85,-75.1728], Tmin=(1843.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.5244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67035,0.0568323,-5.20519e-05,2.8909e-08,-7.32623e-12,8759.46,31.675], Tmin=(100,'K'), Tmax=(896.24,'K')), NASAPolynomial(coeffs=[6.23367,0.0364664,-1.79674e-05,3.55599e-09,-2.54404e-13,7941.47,10.1594], Tmin=(896.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.1722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]CCC(=O)OF-2(11585)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {6,S}
3  O u0 p2 c0 {6,D}
4  C u0 p0 c0 {5,S} {6,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2326,0.0671897,-9.48677e-05,8.41761e-08,-3.12706e-11,11257,23.1883], Tmin=(100,'K'), Tmax=(750.052,'K')), NASAPolynomial(coeffs=[5.77968,0.0359155,-1.8275e-05,3.61164e-09,-2.55697e-13,10772.5,3.87632], Tmin=(750.052,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.8178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsCsHH) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=CCC(=O)OF(2126)'],
    products = ['HF(38)', 'CO2(14)', 'C=C=C(6730)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(36.1481,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C=CCOF(507)'],
    products = ['C=CCC(=O)OF(2126)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000742267,'m^3/(mol*s)'), n=2.83796, Ea=(201.896,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.2632766423807829, var=145.9379134136138, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OF(142)', 'C=CC=C=O(551)'],
    products = ['C=CCC(=O)OF(2126)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['FO[C]1C[CH]CO1(11575)'],
    products = ['C=CCC(=O)OF(2126)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C[CH]C(=O)OF(9800)'],
    products = ['C=CCC(=O)OF(2126)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=CCC([O])=O(11582)'],
    products = ['C=CCC(=O)OF(2126)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', 'C=CC[C]=O(383)'],
    products = ['C=CCC(=O)OF(2126)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(=O)OF(1447)', 'C2H3(29)'],
    products = ['C=CCC(=O)OF(2126)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(167)', '[CH2]C=C(1339)'],
    products = ['C=CCC(=O)OF(2126)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C=C[CH]C(=O)OF(8809)'],
    products = ['C=CCC(=O)OF(2126)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C=[C]CC(=O)OF(11583)'],
    products = ['C=CCC(=O)OF(2126)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH]=CCC(=O)OF(8841)'],
    products = ['C=CCC(=O)OF(2126)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=CCC(=O)OF(2126)'],
    products = ['C2H2(23)', 'C=C(O)OF(1757)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(7.8901e+09,'s^-1'), n=0.601596, Ea=(319.597,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.07591793873856297, var=4.052420941329839, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_1R!H->C_2R!H->C_5R!H->O',), comment="""Estimated from node Root_1R!H->C_2R!H->C_5R!H->O
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction21',
    reactants = ['C[C]CC(=O)OF(11584)'],
    products = ['C=CCC(=O)OF(2126)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(9.99999e+12,'s^-1'), n=8.2394e-08, Ea=(28.9383,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCH_Ext-3C-R_N-4R!H->Br_N-4CClFINOPSSi->F_N-1C-inRing',), comment="""Estimated from node CCH_Ext-3C-R_N-4R!H->Br_N-4CClFINOPSSi->F_N-1C-inRing
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction22',
    reactants = ['[CH]CCC(=O)OF-2(11585)'],
    products = ['C=CCC(=O)OF(2126)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(2.40886e+17,'s^-1'), n=-1.43042, Ea=(14.4375,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #3860',
    isomers = [
        'C=CCC(=O)OF(2126)',
    ],
    reactants = [
        ('HF(38)', 'CO2(14)', 'C=C=C(6730)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
