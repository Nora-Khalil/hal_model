...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.508446,'amu*angstrom^2'), symmetry=1, barrier=(11.6902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.508093,'amu*angstrom^2'), symmetry=1, barrier=(11.682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.508411,'amu*angstrom^2'), symmetry=1, barrier=(11.6894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66122,0.0601908,-0.000110792,1.04869e-07,-3.7229e-11,50002,19.5551], Tmin=(100,'K'), Tmax=(869.165,'K')), NASAPolynomial(coeffs=[5.67248,0.0219916,-1.08026e-05,2.0471e-09,-1.38575e-13,50050.3,5.05459], Tmin=(869.165,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(415.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_S) + radical(Cds_P)"""),
)
