...
"""),
    E0 = (-40.4343,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,282.38,1330.75,1330.81],'cm^-1')),
        HinderedRotor(inertia=(0.00211452,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181934,'amu*angstrom^2'), symmetry=1, barrier=(10.2934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (62.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.67641,0.0270598,-2.37107e-05,1.05932e-08,-1.88417e-12,-4813.81,14.1538], Tmin=(100,'K'), Tmax=(1348.03,'K')), NASAPolynomial(coeffs=[8.73634,0.00907787,-3.70118e-06,6.97295e-10,-4.88944e-14,-6447.57,-16.8915], Tmin=(1348.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.4343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00665044,'amu*angstrom^2'), symmetry=1, barrier=(5.00795,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (44.0526,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.84769,0.0229973,-1.85068e-05,7.77211e-09,-1.30725e-12,17300.5,13.0245], Tmin=(100,'K'), Tmax=(1418.35,'K')), NASAPolynomial(coeffs=[7.97636,0.00853336,-3.21015e-06,5.8214e-10,-3.99267e-14,15845.7,-13.5107], Tmin=(1418.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: FFCM1(-) + radical(CCsJOH) + radical(CJCO)"""),
)
...
"""),
    E0 = (-256.989,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,282.799],'cm^-1')),
        HinderedRotor(inertia=(0.133175,'amu*angstrom^2'), symmetry=1, barrier=(7.5605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.483712,'amu*angstrom^2'), symmetry=1, barrier=(27.451,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (63.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.8956,0.0100386,0.000110029,-4.16291e-07,4.91137e-10,-30910,9.70487], Tmin=(10,'K'), Tmax=(270.452,'K')), NASAPolynomial(coeffs=[3.45433,0.024661,-1.59723e-05,4.98674e-09,-5.96805e-13,-30915.8,10.7094], Tmin=(270.452,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-256.989,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""O[CH]CF""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'O[CH]F(450)'],
    products = ['[CH2]C(O)F(145)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C=CO(452)'],
    products = ['[CH2]C(O)F(145)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(56.0325,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction1',
    reactants = ['OH(7)', 'CH2CHF(56)'],
    products = ['[CH2]C(O)F(145)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'C=C(O)F(209)'],
    products = ['[CH2]C(O)F(145)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(57.4364,'m^3/(mol*s)'), n=1.76515, Ea=(12.2516,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_N-4R!H->N_N-4CClOS->C_Sp-4ClOS-1CClOOSS_2CS->C',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_N-4R!H->N_N-4CClOS->C_Sp-4ClOS-1CClOOSS_2CS->C"""),
)

reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2][CH]O(453)'],
    products = ['[CH2]C(O)F(145)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'CH2CHO(35)'],
    products = ['[CH2]C(O)F(145)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(171.511,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction11',
    reactants = ['C[C](O)F(455)'],
    products = ['[CH2]C(O)F(145)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[CH]CF(448)'],
    products = ['[CH2]C(O)F(145)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(144.396,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(25)', '[O]CF(187)'],
    products = ['CC([O])F(377)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C[CH]OF(518)'],
    products = ['CC([O])F(377)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(77.1294,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)
