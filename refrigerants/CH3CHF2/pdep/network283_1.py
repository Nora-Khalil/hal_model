...
"""),
    ...
    molecularWeight = (77.0344,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.90476,0.0056642,8.77139e-05,-1.85954e-07,1.14511e-10,-12427.1,9.58973], Tmin=(10,'K'), Tmax=(563.216,'K')), NASAPolynomial(coeffs=[4.47262,0.0232215,-1.65469e-05,5.51979e-09,-6.91924e-13,-12833.5,4.13615], Tmin=(563.216,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-103.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), label="""[CH2]C1(F)OO1""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (8.47454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,293,496,537,1218,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.643333,'amu*angstrom^2'), symmetry=1, barrier=(14.7915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.645767,'amu*angstrom^2'), symmetry=1, barrier=(14.8474,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0344,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.77422,0.0167429,0.00010913,-3.78669e-07,3.40015e-10,1019.07,10.1562], Tmin=(10,'K'), Tmax=(420.372,'K')), NASAPolynomial(coeffs=[7.22093,0.0174456,-1.29132e-05,4.45028e-09,-5.70263e-13,433.306,-7.00577], Tmin=(420.372,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(8.47454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""[CH]DC(F)OO""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (281.78,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,2950,3100,1380,975,1025,1650,1685,370,330.985,331.023],'cm^-1')),
        HinderedRotor(inertia=(0.00153884,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00153812,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0344,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.62053,0.0355306,-5.87789e-05,5.99441e-08,-2.41147e-11,33934.9,18.5677], Tmin=(100,'K'), Tmax=(784.842,'K')), NASAPolynomial(coeffs=[3.20532,0.021718,-1.16774e-05,2.34927e-09,-1.67166e-13,34176.7,18.0135], Tmin=(784.842,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CH2CF(70)'],
    products = ['C=C(F)O[O](288)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C(F)O[O](288)'],
    products = ['F[C]1COO1(740)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C(F)O[O](288)'],
    products = ['[CH2]C1(F)OO1(1080)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.62453e+10,'s^-1'), n=0.5217, Ea=(56.4092,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_O]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'C#CO[O](374)'],
    products = ['C=C(F)O[O](288)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.56721e+32,'m^3/(mol*s)'), n=-7.40875, Ea=(278.105,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_3COCdCddCtO2d->Ct"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(F)OO(1082)'],
    products = ['C=C(F)O[O](288)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C=[C]OOF(1083)'],
    products = ['C=C(F)O[O](288)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(82.1095,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
