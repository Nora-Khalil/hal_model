...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC([O])=O(1241)'],
    products = ['CC([O])C([O])=O(2818)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[O]C(=O)C=O(1273)'],
    products = ['CC([O])C([O])=O(2818)'],
