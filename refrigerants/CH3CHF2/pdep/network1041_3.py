...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2][O](132)'],
    products = ['[O]C[C](F)F(2986)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C[C](F)F(2986)'],
    products = ['FC1(F)CO1(3113)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FC1(F)[CH]O1(4338)'],
    products = ['FC1(F)CO1(3113)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(4778)', 'CH2(T)(18)'],
    products = ['[CH2]C([O])(F)F(1114)'],
