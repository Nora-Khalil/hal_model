...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(O)(F)F(4647)'],
    products = ['[O]OC(O)(F)F(4648)'],
    transitionState = 'TS2',
