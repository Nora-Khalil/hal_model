...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(126)', '[CH2]C(O)F(145)'],
    products = ['OC(F)COF(1726)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]F(450)', '[CH2]OF(186)'],
    products = ['OC(F)COF(1726)'],
