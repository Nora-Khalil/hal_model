...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(OF)O[CH]O(8302)'],
    products = ['O=COC(O)(F)OF(8267)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=CO[C](O)OF(7901)'],
    products = ['O=COC(O)(F)OF(8267)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(O)(F)OC=O(8303)'],
    products = ['O=COC(O)(F)OF(8267)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C=O(166)', 'O[C](F)OF(5946)'],
    products = ['O=COC(O)(F)OF(8267)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HCO(15)', '[O]C(O)(F)OF(8304)'],
    products = ['O=COC(O)(F)OF(8267)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=CO[C](F)OF(2740)'],
    products = ['O=COC(O)(F)OF(8267)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)(OF)OC=O(8305)'],
    products = ['O=COC(O)(F)OF(8267)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(126)', 'O=CO[C](O)F(8204)'],
    products = ['O=COC(O)(F)OF(8267)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=[C]OC(O)(F)OF(8306)'],
    products = ['O=COC(O)(F)OF(8267)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=COC(O)(F)OF(8267)'],
    products = ['O=C(F)OF(8307)', 'O=CO(1075)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=COC(=O)OF(2980)'],
    products = ['O=COC(O)(F)OF(8267)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'O=COC(=O)O(7847)'],
    products = ['O=COC(O)(F)OF(8267)'],
