...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=C=CC(=O)F(3577)'],
    products = ['O=C(O)CC(=O)F(2631)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=[C]CC(=O)O(3586)'],
    products = ['O=C(O)CC(=O)F(2631)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'O=[C]CC(=O)F(1004)'],
    products = ['O=C(O)CC(=O)F(2631)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)CC(=O)F(2010)'],
    products = ['O=C(O)CC(=O)F(2631)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)[CH]C(=O)F(2012)'],
    products = ['O=C(O)CC(=O)F(2631)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C=CC(=O)O(1401)'],
    products = ['O=C(O)CC(=O)F(2631)'],
