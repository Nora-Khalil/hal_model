...
"""),
    E0 = (548.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,425.858,425.862],'cm^-1')),
        HinderedRotor(inertia=(0.0880413,'amu*angstrom^2'), symmetry=1, barrier=(11.3304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.492797,'amu*angstrom^2'), symmetry=1, barrier=(11.3304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0880388,'amu*angstrom^2'), symmetry=1, barrier=(11.3304,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36111,0.0523806,-3.57499e-05,1.25329e-08,-1.79882e-12,66085.4,25.399], Tmin=(100,'K'), Tmax=(1603.9,'K')), NASAPolynomial(coeffs=[12.5015,0.0245975,-9.76655e-06,1.73287e-09,-1.15415e-13,62511.8,-33.6098], Tmin=(1603.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(548.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', '[CH2]C[C]=C(1912)'],
    products = ['C=[C]CC[C]=C(11531)'],
    transitionState = 'TS3',
