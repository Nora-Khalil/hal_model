...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C(F)[C]=C(10785)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', '[CH]C(F)=CF(4157)'],
    products = ['[CH]=C(F)C(F)[C]=C(10785)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)C=C=C(6699)'],
    products = ['[CH]=C(F)C(F)[C]=C(10785)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C(F)=C=C(10873)'],
    products = ['[CH]=C(F)C(F)[C]=C(10785)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CC(F)[C]=C(10802)'],
    products = ['[CH]=C(F)C(F)[C]=C(10785)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(F)C(F)C#C(10874)'],
    products = ['[CH]=C(F)C(F)[C]=C(10785)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH]=C=C[C]=C(7318)'],
    products = ['[CH]=C(F)C(F)[C]=C(10785)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C#CC(F)=[C][CH2](10875)'],
    products = ['[CH]=C(F)C(F)[C]=C(10785)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=CC(F)C(=[CH])F(10877)'],
    products = ['[CH]=C(F)C(F)[C]=C(10785)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(F)C(F)[C]=C(10785)'],
    products = ['[CH2]C(F)=C(F)[C]=C(10523)'],
