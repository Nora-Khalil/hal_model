...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.263918,'amu*angstrom^2'), symmetry=1, barrier=(6.06799,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26012,'amu*angstrom^2'), symmetry=1, barrier=(5.98068,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37216,0.0491293,-0.000106717,1.21335e-07,-4.94339e-11,-4232.24,20.1019], Tmin=(100,'K'), Tmax=(839.953,'K')), NASAPolynomial(coeffs=[-1.33563,0.0332298,-1.83978e-05,3.6734e-09,-2.5723e-13,-2425.62,44.3897], Tmin=(839.953,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.5686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCFHH) + group(Cds-CdsCsH) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.764888,'amu*angstrom^2'), symmetry=1, barrier=(17.5863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.765149,'amu*angstrom^2'), symmetry=1, barrier=(17.5923,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58454,0.0619227,-0.000112714,1.10286e-07,-4.15582e-11,12779,20.5547], Tmin=(100,'K'), Tmax=(811.926,'K')), NASAPolynomial(coeffs=[5.10412,0.0267879,-1.49272e-05,2.99941e-09,-2.11775e-13,12794,7.92018], Tmin=(811.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Cds_S) + radical(C=CCJ=O)"""),
)

species(
    label = 'O=C1C=C(CF)O1(11986)',
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.26008,0.0246902,-1.52534e-05,3.9629e-09,-3.96094e-13,-38359.8,12.5924], Tmin=(100,'K'), Tmax=(2153.91,'K')), NASAPolynomial(coeffs=[9.72738,0.0126799,-6.88938e-06,1.37411e-09,-9.5619e-14,-41145.8,-23.5708], Tmin=(2153.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-319.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CsCFHH) + group(Cds-CdsCsOs) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + ring(Oxetene)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70069,0.0425972,-2.21217e-05,-6.75913e-09,7.03845e-12,32820.8,24.8958], Tmin=(100,'K'), Tmax=(965.163,'K')), NASAPolynomial(coeffs=[13.4121,0.012571,-4.2244e-06,7.49352e-10,-5.33935e-14,29697.9,-35.6561], Tmin=(965.163,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(dioxirane) + radical(Cs_P) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = 'O=C1[CH][C](CF)O1(11996)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29444,0.0287726,9.94304e-06,-3.53826e-08,1.65734e-11,-14556.4,23.7658], Tmin=(100,'K'), Tmax=(929.935,'K')), NASAPolynomial(coeffs=[10.5353,0.0155568,-4.59933e-06,7.50355e-10,-5.15063e-14,-17050.3,-20.5616], Tmin=(929.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(C2CsJOC(O)) + radical(CCJCO)"""),
)

species(
    label = '[O]C1([O])C=C1CF(11994)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u1 p2 c0 {4,S}
3  O u1 p2 c0 {4,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.31753,0.0297876,-1.27272e-05,1.24188e-09,7.84141e-14,15587,12.0142], Tmin=(100,'K'), Tmax=(2675.95,'K')), NASAPolynomial(coeffs=[40.08,-0.00890806,6.88891e-07,-3.89798e-11,5.48143e-15,-8837.96,-205.595], Tmin=(2675.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cd-Cs-Cd(C-F)) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = 'O=C(O)[C]=[C]CF(11997)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {5,S} {10,S}
3  O u0 p2 c0 {5,D}
...
"""),
    E0 = (-17.3125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,122,584,932,1043,1247,1392,1461,2986,3039,1670,1700,300,440,180,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.263921,'amu*angstrom^2'), symmetry=1, barrier=(6.06805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000534094,'amu*angstrom^2'), symmetry=1, barrier=(6.06413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263853,'amu*angstrom^2'), symmetry=1, barrier=(6.0665,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88407,0.0565941,-0.000113512,1.15267e-07,-4.36704e-11,-2015.77,22.3927], Tmin=(100,'K'), Tmax=(833.847,'K')), NASAPolynomial(coeffs=[4.10321,0.0233997,-1.3235e-05,2.6642e-09,-1.87273e-13,-1601.94,16.7905], Tmin=(833.847,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.3125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCFHH) + group(Cds-CdsCsH) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + radical(Cds_S) + radical(C=CJC=O)"""),
)
...
"""),
    E0 = (-61.318,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,113,247,382,1207,3490,540,610,2055,180,180,1670.42,1670.48,1670.63,1670.75,1670.78],'cm^-1')),
        HinderedRotor(inertia=(0.285067,'amu*angstrom^2'), symmetry=1, barrier=(6.55426,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97894,0.0566497,-0.000111229,1.19336e-07,-4.72463e-11,-7313.91,21.7577], Tmin=(100,'K'), Tmax=(839.163,'K')), NASAPolynomial(coeffs=[0.424987,0.0344365,-1.85772e-05,3.66624e-09,-2.55404e-13,-6010.18,35.1962], Tmin=(839.163,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCddFH) + group(Cdd-CdsCds) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-80.1881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([319,1023,1071,1259,1317,1409,3054,3019,2100,2250,500,550,180,180,180,1202.7,1206.21,1206.57,1206.9],'cm^-1')),
        HinderedRotor(inertia=(0.204446,'amu*angstrom^2'), symmetry=1, barrier=(4.70062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20356,'amu*angstrom^2'), symmetry=1, barrier=(4.68025,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06956,0.0531573,-9.856e-05,1.01068e-07,-3.81943e-11,-9585.13,21.8894], Tmin=(100,'K'), Tmax=(872.699,'K')), NASAPolynomial(coeffs=[1.23828,0.0307556,-1.50027e-05,2.82027e-09,-1.90306e-13,-8441.89,31.5054], Tmin=(872.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.1881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCFHH) + group(Cds-O2d(Cds-Cds)O2s) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-207.994,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,454.294,454.449,454.544,454.605,454.69,454.823,454.881],'cm^-1')),
        HinderedRotor(inertia=(0.000816778,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000817443,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02196,0.0408631,-2.11772e-05,2.40059e-09,4.32687e-13,-24942.6,19.0294], Tmin=(100,'K'), Tmax=(1632.36,'K')), NASAPolynomial(coeffs=[15.77,0.0181046,-1.03081e-05,2.06365e-09,-1.43955e-13,-30887.2,-58.4944], Tmin=(1632.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-207.994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(CdCFH) + radical(CCOJ) + radical(C=CCJCO)"""),
)

species(
    label = '[O]C([O])=C=CCF(11999)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u1 p2 c0 {6,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54149,0.0577957,-6.85588e-05,4.31904e-08,-1.10913e-11,-13361.3,20.9785], Tmin=(100,'K'), Tmax=(937.998,'K')), NASAPolynomial(coeffs=[10.0073,0.0216938,-1.08261e-05,2.1576e-09,-1.54935e-13,-14949.5,-19.3224], Tmin=(937.998,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cdd-CdsCds) + radical(C=COJ) + radical(C=COJ)"""),
)

species(
    label = 'O=C(O)[CH][C]=CF(8050)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {10,S}
3  O u0 p2 c0 {5,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62451,0.0485821,-3.64498e-05,1.21138e-08,-1.56937e-12,-23468.1,20.0437], Tmin=(100,'K'), Tmax=(1800.82,'K')), NASAPolynomial(coeffs=[16.9131,0.0146227,-8.16305e-06,1.64197e-09,-1.15604e-13,-28974.5,-62.7085], Tmin=(1800.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-195.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(CdCFH) + radical(C=CCJCO) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C=[C]CF(11797)'],
    products = ['CO2(14)', 'C#CCF(3587)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=[C]C=[C]CF(11943)'],
    products = ['[O]C(=O)C=[C]CF(11797)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(=O)C=[C]CF(11797)'],
    products = ['FC[C]=C[C]1OO1(11995)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(308.327,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_De;radadd_intra_O]
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)C=[C]CF(11797)'],
    products = ['O=C1[CH][C](CF)O1(11996)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C=[C]CF(11797)'],
    products = ['[O]C1([O])C=C1CF(11994)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(3.66e+11,'s^-1'), n=0.412, Ea=(167.585,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_D;multiplebond_intra;radadd_intra_cd_Cs] for rate rule [R4_D_CO;carbonylbond_intra;radadd_intra_cd_Cs]
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(O)[C]=[C]CF(11997)'],
    products = ['[O]C(=O)C=[C]CF(11797)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(205000,'s^-1'), n=2.37, Ea=(211.812,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(124.547,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(76.4753,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

network(
    label = 'PDepNetwork #3943',
    isomers = [
        '[O]C(=O)C=[C]CF(11797)',
    ],
    reactants = [
