...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(1531)', '[CH]C-2(610)'],
    products = ['C[CH]OC=[C]F(4210)'],
    transitionState = 'TS2',
