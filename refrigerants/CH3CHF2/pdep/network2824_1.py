...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.891356,'amu*angstrom^2'), symmetry=1, barrier=(20.494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.887017,'amu*angstrom^2'), symmetry=1, barrier=(20.3943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (46.0254,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21932,0.0287291,-3.48452e-05,1.76641e-08,-3.18325e-12,7241.75,11.1933], Tmin=(100,'K'), Tmax=(1625.77,'K')), NASAPolynomial(coeffs=[12.9435,-0.00488192,2.83225e-06,-5.19693e-10,3.32958e-14,4709.64,-42.8196], Tmin=(1625.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.6035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo library: thermo_DFT_CCSDTF12_BAC + radical(CH2_triplet)"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (47.0334,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3912.79,'J/mol'), sigma=(4.41,'angstroms'), dipoleMoment=(0,'De'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=1.5, comment="""NOx2018"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
