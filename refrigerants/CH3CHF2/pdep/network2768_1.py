...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'OOOC[C]F(2547)'],
    products = ['OOOC[C](F)F(7096)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]OOO(847)'],
    products = ['OOOC[C](F)F(7096)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(11)', '[O]C[C](F)F(2986)'],
    products = ['OOOC[C](F)F(7096)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', '[O]OC[C](F)F(3041)'],
    products = ['OOOC[C](F)F(7096)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]OOC[C](F)F(6993)'],
    products = ['OOOC[C](F)F(7096)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'OOO[CH][C](F)F(4457)'],
    products = ['OOOC[C](F)F(7096)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'OOOC[C]F-2(2548)'],
    products = ['OOOC[C](F)F(7096)'],
