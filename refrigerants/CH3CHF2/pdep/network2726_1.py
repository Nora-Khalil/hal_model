...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)OO[O](6994)'],
    products = ['O2(2)', 'FC1(F)CO1(3113)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(F)(F)O[O](3042)'],
    products = ['[CH2]C(F)(F)OO[O](6994)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OO[C](F)F(4689)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)OO[O](6994)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', '[CH2]C([O])(F)F(1114)'],
    products = ['[CH2]C(F)(F)OO[O](6994)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[O](127)', '[CH2][C](F)F(2970)'],
    products = ['[CH2]C(F)(F)OO[O](6994)'],
    transitionState = 'TS9',
