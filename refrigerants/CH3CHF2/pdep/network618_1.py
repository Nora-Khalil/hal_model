...
"""),
    ...
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22972,0.0383854,-3.32338e-05,1.49073e-08,-2.73888e-12,-53692.7,17.1865], Tmin=(100,'K'), Tmax=(1278.81,'K')), NASAPolynomial(coeffs=[9.2917,0.0162961,-7.32381e-06,1.39995e-09,-9.82667e-14,-55498.8,-18.6202], Tmin=(1278.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsOsHH) + ring(Cs-Cs(F)-O2s-O2s)"""),
)

species(
    label = 'OC1(F)CO1(2527)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.548657,'amu*angstrom^2'), symmetry=1, barrier=(12.6147,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68025,0.0565181,-9.0404e-05,7.99328e-08,-2.78673e-11,-25004.6,19.3961], Tmin=(100,'K'), Tmax=(823.783,'K')), NASAPolynomial(coeffs=[6.88816,0.0220549,-1.09439e-05,2.10707e-09,-1.4565e-13,-25551.4,-2.8299], Tmin=(823.783,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-208.551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFOO) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sO2sCs)) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C([O])(F)OO(1941)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {3,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.431555,'amu*angstrom^2'), symmetry=1, barrier=(9.9223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.14726,'amu*angstrom^2'), symmetry=1, barrier=(49.3698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.94473,'amu*angstrom^2'), symmetry=1, barrier=(21.7212,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54946,0.0599669,-8.57563e-05,6.00336e-08,-1.41386e-11,-17548.5,21.1317], Tmin=(100,'K'), Tmax=(616.492,'K')), NASAPolynomial(coeffs=[9.06641,0.0201092,-1.04683e-05,2.07397e-09,-1.46621e-13,-18644.8,-12.8711], Tmin=(616.492,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFOO) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sO2sCs)) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][C](O)OOF(2528)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {5,S}
3 O u0 p2 c0 {5,S} {9,S}
...
"""),
    ...
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50206,0.0591529,-8.60139e-05,6.48929e-08,-1.95136e-11,15626.8,24.7796], Tmin=(100,'K'), Tmax=(813.787,'K')), NASAPolynomial(coeffs=[10.0042,0.0173621,-8.98309e-06,1.7877e-09,-1.27199e-13,14243,-14.4863], Tmin=(813.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCOOH)"""),
)

species(
    label = '[O]O[C](O)CF(2529)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-216.882,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,202.294],'cm^-1')),
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C([O])(O)F(1642)'],
    products = ['[CH2]C(O)(F)O[O](1940)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]O[C](O)F(785)', 'CH2(T)(18)'],
    products = ['[CH2]C(O)(F)O[O](1940)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH2]C(=O)O[O](206)'],
    products = ['[CH2]C(O)(F)O[O](1940)'],
