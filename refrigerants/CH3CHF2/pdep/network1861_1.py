...
"""),
    E0 = (-954.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,261,493,600,1152,1365,1422,3097,223,363,546,575,694,1179,1410,215.831,1601.78],'cm^-1')),
        HinderedRotor(inertia=(0.399475,'amu*angstrom^2'), symmetry=1, barrier=(13.0146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.49726,'amu*angstrom^2'), symmetry=1, barrier=(16.5259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16771,'amu*angstrom^2'), symmetry=1, barrier=(39.2292,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.350534,'amu*angstrom^2'), symmetry=1, barrier=(8.05947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.350643,'amu*angstrom^2'), symmetry=1, barrier=(8.06197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21908,'amu*angstrom^2'), symmetry=1, barrier=(28.029,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (134.03,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.853326,'amu*angstrom^2'), symmetry=1, barrier=(19.6196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.853309,'amu*angstrom^2'), symmetry=1, barrier=(19.6192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.853298,'amu*angstrom^2'), symmetry=1, barrier=(19.619,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (134.03,'amu'),
...
"""),
    E0 = (-692.905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,261,493,600,1152,1365,1422,3097,351,323,533,609,664,892,1120,1201,180,1738.51],'cm^-1')),
        HinderedRotor(inertia=(0.537232,'amu*angstrom^2'), symmetry=1, barrier=(12.352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25199,'amu*angstrom^2'), symmetry=1, barrier=(28.7858,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)OF(4768)'],
    products = ['HF(38)', 'CF2O(49)', 'CHFO(47)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['OF(142)', 'OC(F)(F)[C]F(4937)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'OC(F)(F)OF(4896)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(142)', 'F[C]C(F)OF(750)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(499)', 'OC(F)=CF(2034)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H2O(3)', 'FOC(F)=C(F)F(4938)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(142)', 'FOC=C(F)F(4346)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)(F)[CH]OF(4939)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[C](F)C(F)OF(2037)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(O)(F)F(4940)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', 'OC(F)(F)[CH]F(4941)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'FOC(F)[C](F)F(3371)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(F)OF(4942)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(614)', 'O[C](F)F(4619)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)(F)[C](F)OF(4943)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', 'O=CC(O)(F)F(4864)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(F)OF(4944)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(F)C(O)(F)F(4869)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)=C(F)OF(4936)'],
    products = ['OC(F)(F)C(F)OF(4768)'],
...
network(
    label = 'PDepNetwork #1861',
    isomers = [
        'OC(F)(F)C(F)OF(4768)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(49)', 'CHFO(47)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
