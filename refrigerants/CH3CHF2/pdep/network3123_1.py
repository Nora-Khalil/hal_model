...
"""),
    E0 = (-354.471,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,194,682,905,1196,1383,3221,201.767,201.968,202.046,202.148,202.248,1698.38],'cm^-1')),
        HinderedRotor(inertia=(0.252273,'amu*angstrom^2'), symmetry=1, barrier=(7.30927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252271,'amu*angstrom^2'), symmetry=1, barrier=(7.30926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.84443e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.11963,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.977188,0.0749911,-0.000120487,1.1183e-07,-4.12112e-11,-42532.4,25.1983], Tmin=(100,'K'), Tmax=(803.19,'K')), NASAPolynomial(coeffs=[5.93051,0.0352661,-1.8179e-05,3.57285e-09,-2.50446e-13,-42842.5,5.41035], Tmin=(803.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.366863,'amu*angstrom^2'), symmetry=1, barrier=(8.4349,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2953,'amu*angstrom^2'), symmetry=1, barrier=(29.7814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.366877,'amu*angstrom^2'), symmetry=1, barrier=(8.43523,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02502,0.0729431,-9.49916e-05,6.3278e-08,-1.39058e-11,-42493.5,23.211], Tmin=(100,'K'), Tmax=(606.817,'K')), NASAPolynomial(coeffs=[8.90455,0.03093,-1.56773e-05,3.09981e-09,-2.19902e-13,-43632.6,-12.3731], Tmin=(606.817,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + missing(O2d-Cdd) + group(CsCFHO) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'COC(=C=CF)OF(8722)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-180.468,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,113,247,382,1207,3490,540,610,2055,383.153,383.822,386.391,392.066],'cm^-1')),
        HinderedRotor(inertia=(0.113537,'amu*angstrom^2'), symmetry=1, barrier=(12.049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00108554,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00713871,'amu*angstrom^2'), symmetry=1, barrier=(26.8907,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.579891,0.0806113,-0.000116821,9.08859e-08,-2.83436e-11,-21587.2,23.7594], Tmin=(100,'K'), Tmax=(784.646,'K')), NASAPolynomial(coeffs=[11.2579,0.0261765,-1.27582e-05,2.46934e-09,-1.72641e-13,-23262.8,-25.166], Tmin=(784.646,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (25.8798,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,167,640,1190,180,180,1354.32],'cm^-1')),
        HinderedRotor(inertia=(0.270906,'amu*angstrom^2'), symmetry=1, barrier=(6.22867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.270815,'amu*angstrom^2'), symmetry=1, barrier=(6.22656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.270722,'amu*angstrom^2'), symmetry=1, barrier=(6.22444,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.568479,0.0869202,-0.000152668,1.44236e-07,-5.23768e-11,3225.13,28.4745], Tmin=(100,'K'), Tmax=(836.29,'K')), NASAPolynomial(coeffs=[6.31564,0.0358164,-1.86495e-05,3.63481e-09,-2.51796e-13,3089.66,6.71249], Tmin=(836.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.8798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(CCOJ) + radical(Cdj(Cd-CsCs)(F1s))"""),
)
...
"""),
    E0 = (-45.981,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,311.321,311.321,311.322,311.322],'cm^-1')),
        HinderedRotor(inertia=(0.124926,'amu*angstrom^2'), symmetry=1, barrier=(8.59208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124926,'amu*angstrom^2'), symmetry=1, barrier=(8.59206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239046,'amu*angstrom^2'), symmetry=1, barrier=(16.4409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00173934,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.107963,0.0938647,-0.000157799,1.36142e-07,-4.55366e-11,-5398,25.2695], Tmin=(100,'K'), Tmax=(840.881,'K')), NASAPolynomial(coeffs=[11.5102,0.0262136,-1.31958e-05,2.52961e-09,-1.73394e-13,-6841.42,-24.944], Tmin=(840.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-263.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,194,682,905,1196,1383,3221,180,180,1361.65,1361.7,1361.72,3349.8],'cm^-1')),
        HinderedRotor(inertia=(0.200162,'amu*angstrom^2'), symmetry=1, barrier=(4.60212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20017,'amu*angstrom^2'), symmetry=1, barrier=(4.60229,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.62777,0.0299814,-1.28071e-05,1.42242e-09,3.16148e-14,-31733.3,11.8212], Tmin=(100,'K'), Tmax=(2845.63,'K')), NASAPolynomial(coeffs=[50.9164,-0.0192487,4.7957e-06,-7.45861e-10,5.02956e-14,-64489.1,-271.168], Tmin=(2845.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFH) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.507352,'amu*angstrom^2'), symmetry=1, barrier=(11.665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.506076,'amu*angstrom^2'), symmetry=1, barrier=(11.6357,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23847,0.0447164,-4.26564e-05,1.43553e-08,5.76634e-12,-18328.3,17.5815], Tmin=(100,'K'), Tmax=(525.486,'K')), NASAPolynomial(coeffs=[5.25275,0.0283763,-1.48664e-05,3.01696e-09,-2.18445e-13,-18736.2,4.11121], Tmin=(525.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-152.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(CdCFH) + group(Cds-O2d(Cds-Cds)H) + radical(C=C(C)CJ=O)"""),
)
...
"""),
    E0 = (-97.8949,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,167,640,1190,257.171,258.005,258.433,261.396,1803.13,1803.95],'cm^-1')),
        HinderedRotor(inertia=(0.133727,'amu*angstrom^2'), symmetry=1, barrier=(6.48966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138812,'amu*angstrom^2'), symmetry=1, barrier=(6.49613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137609,'amu*angstrom^2'), symmetry=1, barrier=(6.48766,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.922826,0.0786981,-0.000140778,1.35167e-07,-4.96956e-11,-11673.9,26.0467], Tmin=(100,'K'), Tmax=(834.28,'K')), NASAPolynomial(coeffs=[5.52363,0.0334368,-1.7683e-05,3.46668e-09,-2.40886e-13,-11634.1,9.52342], Tmin=(834.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.8949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFH) + radical(CdCdF1s)"""),
)

species(
    label = '[CH]C(C)(F)C(=O)OF(8734)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {7,S}
4  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32788,0.0709469,-6.39386e-05,-2.85705e-08,6.66602e-11,-15710.5,21.8438], Tmin=(100,'K'), Tmax=(478.858,'K')), NASAPolynomial(coeffs=[8.35144,0.0342925,-1.80805e-05,3.59239e-09,-2.53824e-13,-16635.6,-9.50453], Tmin=(478.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'CC([C]F)C(=O)OF(8735)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {7,S}
4  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39619,0.0577013,-4.85887e-05,2.08363e-08,-3.68442e-12,-22503.7,25.3069], Tmin=(100,'K'), Tmax=(1311.79,'K')), NASAPolynomial(coeffs=[11.807,0.0259564,-1.22898e-05,2.38905e-09,-1.68812e-13,-25235.1,-27.7449], Tmin=(1311.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25699,0.0427764,-4.08277e-05,2.43347e-08,-6.71168e-12,11599.3,27.322], Tmin=(100,'K'), Tmax=(825.922,'K')), NASAPolynomial(coeffs=[5.2862,0.0281067,-1.41871e-05,2.83242e-09,-2.0354e-13,11098.9,13.287], Tmin=(825.922,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.9524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC(=CF)OF(8720)'],
    products = ['CC(=CF)C(=O)OF(8654)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=C(C=CF)OF(3451)'],
    products = ['CC(=CF)C(=O)OF(8654)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(C)C(=O)OF(8728)'],
    products = ['CC(=CF)C(=O)OF(8654)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC(=CF)C([O])=O(8729)'],
    products = ['CC(=CF)C(=O)OF(8654)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(126)', 'CC([C]=O)=CF(8730)'],
    products = ['CC(=CF)C(=O)OF(8654)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'O=C([C]=CF)OF(8731)'],
    products = ['CC(=CF)C(=O)OF(8654)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(167)', 'C[C]=CF(4287)'],
    products = ['CC(=CF)C(=O)OF(8654)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'CC(=[C]F)C(=O)OF(8733)'],
    products = ['CC(=CF)C(=O)OF(8654)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C(C)(F)C(=O)OF(8734)'],
    products = ['CC(=CF)C(=O)OF(8654)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHF(40)', 'C[C]C(=O)OF(8736)'],
    products = ['CC(=CF)C(=O)OF(8654)'],
