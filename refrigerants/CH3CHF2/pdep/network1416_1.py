...
"""),
    E0 = (-454.339,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,336.374,336.412,336.463,336.585,861.825,1692.6],'cm^-1')),
        HinderedRotor(inertia=(0.349371,'amu*angstrom^2'), symmetry=1, barrier=(28.0594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.058832,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.34897,'amu*angstrom^2'), symmetry=1, barrier=(28.0591,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.890517,0.0727456,-9.84098e-05,7.16355e-08,-2.09599e-11,-16731.3,23.4077], Tmin=(100,'K'), Tmax=(834.118,'K')), NASAPolynomial(coeffs=[10.9587,0.0244609,-1.15739e-05,2.22785e-09,-1.55942e-13,-18410.8,-23.3387], Tmin=(834.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-140.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2sFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'COC(O)=COF(3985)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-67.1346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,1302.46,1302.98],'cm^-1')),
        HinderedRotor(inertia=(0.193049,'amu*angstrom^2'), symmetry=1, barrier=(4.43859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192898,'amu*angstrom^2'), symmetry=1, barrier=(4.4351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193019,'amu*angstrom^2'), symmetry=1, barrier=(4.43789,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24595,0.0708385,-0.00011815,1.16524e-07,-4.47006e-11,-7985.25,26.6609], Tmin=(100,'K'), Tmax=(818.595,'K')), NASAPolynomial(coeffs=[3.12858,0.0395725,-2.0423e-05,4.00351e-09,-2.79673e-13,-7554.13,22.471], Tmin=(818.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.1346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = 'C[C](OF)C([O])O(3987)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-112.735,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,194.764,1543.97,1544],'cm^-1')),
        HinderedRotor(inertia=(0.260154,'amu*angstrom^2'), symmetry=1, barrier=(7.00537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260184,'amu*angstrom^2'), symmetry=1, barrier=(7.00543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260184,'amu*angstrom^2'), symmetry=1, barrier=(7.00544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260228,'amu*angstrom^2'), symmetry=1, barrier=(7.00549,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.891264,0.0795211,-0.000139786,1.3336e-07,-4.86058e-11,-13457.7,28.1888], Tmin=(100,'K'), Tmax=(846.042,'K')), NASAPolynomial(coeffs=[5.23457,0.0348275,-1.77126e-05,3.41669e-09,-2.35101e-13,-13328,13.0709], Tmin=(846.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-112.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJO)"""),
)

species(
    label = '[CH2]C(OF)C([O])O(3988)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {5,S}
3  O u0 p2 c0 {6,S} {12,S}
...
"""),
    E0 = (-81.2507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,292.244,1730.92,1730.96],'cm^-1')),
...
"""),
    E0 = (-101.709,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,360,370,350,3000,3100,440,815,1455,1000,180,654.004],'cm^-1')),
        HinderedRotor(inertia=(0.151095,'amu*angstrom^2'), symmetry=1, barrier=(3.47396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.52532,'amu*angstrom^2'), symmetry=1, barrier=(12.0781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0108227,'amu*angstrom^2'), symmetry=1, barrier=(3.37977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0388198,'amu*angstrom^2'), symmetry=1, barrier=(12.0797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.525085,'amu*angstrom^2'), symmetry=1, barrier=(12.0727,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.529258,0.080621,-0.000117044,8.72769e-08,-2.56403e-11,-12111.7,28.8453], Tmin=(100,'K'), Tmax=(836.907,'K')), NASAPolynomial(coeffs=[13.0431,0.0208104,-9.84281e-06,1.8813e-09,-1.30652e-13,-14206.3,-29.2984], Tmin=(836.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCO)"""),
)

species(
    label = 'CC(OF)=C(O)O(3990)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.659606,'amu*angstrom^2'), symmetry=1, barrier=(15.1656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.659116,'amu*angstrom^2'), symmetry=1, barrier=(15.1544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.659543,'amu*angstrom^2'), symmetry=1, barrier=(15.1642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.659567,'amu*angstrom^2'), symmetry=1, barrier=(15.1648,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
...
"""),
    E0 = (-395.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,964.941,965.474,966.534],'cm^-1')),
        HinderedRotor(inertia=(0.134129,'amu*angstrom^2'), symmetry=1, barrier=(3.08389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00348532,'amu*angstrom^2'), symmetry=1, barrier=(3.097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0457027,'amu*angstrom^2'), symmetry=1, barrier=(30.3081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03764,0.0349681,-5.26947e-06,-1.65799e-08,8.20805e-12,-47448.8,23.3386], Tmin=(100,'K'), Tmax=(1037.69,'K')), NASAPolynomial(coeffs=[10.7836,0.0189728,-7.75928e-06,1.47359e-09,-1.05454e-13,-50217.8,-23.7754], Tmin=(1037.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-395.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(C=OCOJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9312,0.0444598,-2.8951e-05,8.60492e-09,-1.01351e-12,-33442.6,23.2828], Tmin=(100,'K'), Tmax=(1916.87,'K')), NASAPolynomial(coeffs=[14.0165,0.0192407,-9.21618e-06,1.74129e-09,-1.18336e-13,-38075.7,-42.8853], Tmin=(1916.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=C(O)COF(2327)'],
    products = ['CC(OF)C(=O)O(3857)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'CC(=C=O)OF(3983)'],
    products = ['CC(OF)C(=O)O(3857)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3OH(26)', 'O=C=COF(2368)'],
    products = ['CC(OF)C(=O)O(3857)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'CC([O])C(=O)O(3991)'],
    products = ['CC(OF)C(=O)O(3857)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(126)', 'C[CH]C(=O)O(3992)'],
    products = ['CC(OF)C(=O)O(3857)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'CC(OF)C([O])=O(3993)'],
    products = ['CC(OF)C(=O)O(3857)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(19)', 'O=C(O)[CH]OF(2375)'],
    products = ['CC(OF)C(=O)O(3857)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'C[C](OF)C(=O)O(3994)'],
    products = ['CC(OF)C(=O)O(3857)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[CH2]C(OF)C(=O)O(3995)'],
    products = ['CC(OF)C(=O)O(3857)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'CC(=O)C(=O)O(2823)'],
    products = ['CC(OF)C(=O)O(3857)'],
