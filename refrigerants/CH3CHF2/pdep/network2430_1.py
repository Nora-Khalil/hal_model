...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CO[CH2](686)'],
    products = ['[CH]=C(C)O[CH2](6331)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]=C(C)[O](1571)'],
    products = ['[CH]=C(C)O[CH2](6331)'],
    transitionState = 'TS3',
