...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OC(F)(F)CF(3491)'],
    products = ['OC(F)(F)CCF(4828)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'OC(F)(F)C[C]F(5242)'],
    products = ['OC(F)(F)CCF(4828)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'CC(O)(F)F(3124)'],
    products = ['OC(F)(F)CCF(4828)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'FCC=C(F)F(4053)'],
    products = ['OC(F)(F)CCF(4828)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]CC(O)(F)F(5293)'],
    products = ['OC(F)(F)CCF(4828)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)CCF(4773)'],
    products = ['OC(F)(F)CCF(4828)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(4570)', 'CH2F-CH2(62)'],
    products = ['OC(F)(F)CCF(4828)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2F(46)', '[CH2]C(O)(F)F(1116)'],
    products = ['OC(F)(F)CCF(4828)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'OC(F)(F)[CH]CF(5211)'],
    products = ['OC(F)(F)CCF(4828)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)(F)C[CH]F(5243)'],
    products = ['OC(F)(F)CCF(4828)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=CC(O)(F)F(5056)'],
    products = ['OC(F)(F)CCF(4828)'],
