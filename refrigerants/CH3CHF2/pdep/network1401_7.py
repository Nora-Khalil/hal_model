...
"""),
    ...
    molecularWeight = (58.0542,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.03858,0.0235869,-2.18339e-05,1.3563e-08,-3.96868e-12,42680.9,11.7184], Tmin=(100,'K'), Tmax=(778.193,'K')), NASAPolynomial(coeffs=[4.45293,0.0163171,-7.82136e-06,1.55889e-09,-1.12354e-13,42460.7,5.24964], Tmin=(778.193,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CdCdJ2_triplet)"""),
)
