...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C(F)=CF(4016)'],
    products = ['[CH]=C(F)C([CH2])F(3969)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)C=C(4018)'],
    products = ['[CH]=C(F)C([CH2])F(3969)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C(=C)F(3978)'],
    products = ['[CH]=C(F)C([CH2])F(3969)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[CH]=C=C[CH2](275)'],
    products = ['[CH]=C(F)C([CH2])F(3969)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH]=C=C([CH2])F(3139)'],
    products = ['[CH]=C(F)C([CH2])F(3969)'],
