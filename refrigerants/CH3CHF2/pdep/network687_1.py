...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.957235,'amu*angstrom^2'), symmetry=1, barrier=(22.0087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.96161,'amu*angstrom^2'), symmetry=1, barrier=(22.1093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.958752,'amu*angstrom^2'), symmetry=1, barrier=(22.0436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.039,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H2O(3)', 'F[C]C(F)OF(750)'],
    products = ['OC(F)C(F)OF(2027)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'FC=C(F)OF(2033)'],
    products = ['OC(F)C(F)OF(2027)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[CH]C(F)OF(1746)'],
    products = ['OC(F)C(F)OF(2027)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)[CH]OF(1752)'],
    products = ['OC(F)C(F)OF(2027)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)C(O)F(2035)'],
    products = ['OC(F)C(F)OF(2027)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'F[CH]C(F)OF(759)'],
    products = ['OC(F)C(F)OF(2027)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)C(F)OF(2036)'],
    products = ['OC(F)C(F)OF(2027)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(126)', 'OC(F)[CH]F(837)'],
    products = ['OC(F)C(F)OF(2027)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]OF(614)', 'O[CH]F(450)'],
    products = ['OC(F)C(F)OF(2027)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O[C](F)C(F)OF(2037)'],
    products = ['OC(F)C(F)OF(2027)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)[C](F)OF(2038)'],
    products = ['OC(F)C(F)OF(2027)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC(F)OF(2039)'],
    products = ['OC(F)C(F)OF(2027)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(F)C(O)F(878)'],
    products = ['OC(F)C(F)OF(2027)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'OC=C(F)OF(2041)'],
    products = ['OC(F)C(F)OF(2027)'],
