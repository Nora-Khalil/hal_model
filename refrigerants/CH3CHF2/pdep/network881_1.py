...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)O[CH]F(2489)'],
    products = ['O=C(O)OC(F)F(2731)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)F(616)', 'O=[C]O(165)'],
    products = ['O=C(O)OC(F)F(2731)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=[C]OC(F)F(2771)'],
    products = ['O=C(O)OC(F)F(2731)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(F)F(2772)'],
    products = ['O=C(O)OC(F)F(2731)'],
