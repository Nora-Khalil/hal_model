...
reaction(
    label = 'reaction1',
    reactants = ['CHF2(81)', 'C2H2(23)'],
    products = ['[CH]=CC(F)F(2931)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=CC(F)F(2931)'],
    products = ['C=[C]C(F)F(3592)'],
