...
"""),
    E0 = (-3.82382,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,194,682,905,1196,1383,3221,311.179,313.248],'cm^-1')),
        HinderedRotor(inertia=(0.00172689,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.001721,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0017272,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (150.428,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,615,860,1140,1343,3152,1685,370,180,2173.57,2173.91],'cm^-1')),
        HinderedRotor(inertia=(0.40324,'amu*angstrom^2'), symmetry=1, barrier=(9.27128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.403096,'amu*angstrom^2'), symmetry=1, barrier=(9.26796,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3411,0.0429237,-7.48074e-05,7.24379e-08,-2.66163e-11,18145.8,18.1715], Tmin=(100,'K'), Tmax=(852.862,'K')), NASAPolynomial(coeffs=[4.06419,0.0204316,-9.90348e-06,1.89174e-09,-1.29629e-13,18376,13.2055], Tmin=(852.862,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.428,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=COCJ) + radical(Cdj(Cd-F1sH)(O2s-Cs))"""),
)

species(
    label = 'FC=C1CCO1(10163)',
...
"""),
    E0 = (98.4616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,167,640,1190,180,620.568],'cm^-1')),
        HinderedRotor(inertia=(0.416418,'amu*angstrom^2'), symmetry=1, barrier=(9.57427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0132907,'amu*angstrom^2'), symmetry=1, barrier=(3.61553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.01303,'amu*angstrom^2'), symmetry=1, barrier=(3.57868,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91364,0.0477159,-4.31585e-05,2.11697e-08,-4.36109e-12,11915.8,21.2941], Tmin=(100,'K'), Tmax=(1133.05,'K')), NASAPolynomial(coeffs=[8.86098,0.02319,-1.069e-05,2.06605e-09,-1.46033e-13,10341.4,-13.0906], Tmin=(1133.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.4616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=COCJ) + radical(Cdj(Cd-CsO2s)(F1s))"""),
)

species(
    label = 'C=C([C]F)OC(10622)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (25.064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,180,479.153,479.157,479.162,479.164],'cm^-1')),
        HinderedRotor(inertia=(0.0148341,'amu*angstrom^2'), symmetry=1, barrier=(2.41691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.780544,'amu*angstrom^2'), symmetry=1, barrier=(17.9462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11015,'amu*angstrom^2'), symmetry=1, barrier=(17.9463,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54702,0.0512006,-4.60647e-05,2.09677e-08,-3.83108e-12,3105.02,18.4179], Tmin=(100,'K'), Tmax=(1305.58,'K')), NASAPolynomial(coeffs=[12.3696,0.0180428,-7.96906e-06,1.51498e-09,-1.06155e-13,279.091,-36.6803], Tmin=(1305.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]=C(CF)O[CH2](10623)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (93.5938,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,975.611],'cm^-1')),
        HinderedRotor(inertia=(0.0152452,'amu*angstrom^2'), symmetry=1, barrier=(18.0271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784276,'amu*angstrom^2'), symmetry=1, barrier=(18.0321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.78426,'amu*angstrom^2'), symmetry=1, barrier=(18.0317,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40222,0.0523518,-4.79885e-05,2.2035e-08,-4.00995e-12,11354.2,22.2116], Tmin=(100,'K'), Tmax=(1324.7,'K')), NASAPolynomial(coeffs=[13.4846,0.0158687,-6.67783e-06,1.24518e-09,-8.64863e-14,8153.09,-39.4763], Tmin=(1324.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.5938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=COCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)OCF(6535)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80576,0.0504306,-6.07261e-05,4.54741e-08,-1.3434e-11,6533.41,19.1485], Tmin=(100,'K'), Tmax=(999.168,'K')), NASAPolynomial(coeffs=[5.96896,0.024604,-8.20266e-06,1.25412e-09,-7.41258e-14,6158.7,1.35503], Tmin=(999.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.6818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (15.9364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,194,682,905,1196,1383,3221,447.906,447.907,447.907,447.907,447.908],'cm^-1')),
        HinderedRotor(inertia=(0.361021,'amu*angstrom^2'), symmetry=1, barrier=(51.3968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.361021,'amu*angstrom^2'), symmetry=1, barrier=(51.3968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.361022,'amu*angstrom^2'), symmetry=1, barrier=(51.3968,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51019,0.0506418,-3.61398e-05,1.30808e-08,-1.94379e-12,2009.5,20.3692], Tmin=(100,'K'), Tmax=(1545.65,'K')), NASAPolynomial(coeffs=[11.9018,0.0237497,-1.00423e-05,1.82462e-09,-1.23194e-13,-1202.89,-34.2894], Tmin=(1545.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.9364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=CF(4216)'],
    products = ['[CH2]OC([CH2])=CF(10160)'],
    transitionState = 'TS3',
...
reaction(
    ...
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.50867e+09,'s^-1'), n=0.788889, Ea=(81.8106,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH2]OC([CH2])=CF(10160)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(29.5503,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OC([CH2])=CF(10160)'],
    products = ['[CH]C(=C)OCF(6535)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(184.527,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH]F(230)', '[CH2]O[C]=C(396)'],
    products = ['[CH2]OC([CH2])=CF(10160)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF(40)', '[CH2]O[C]=C(396)'],
    products = ['[CH2]OC([CH2])=CF(10160)'],
