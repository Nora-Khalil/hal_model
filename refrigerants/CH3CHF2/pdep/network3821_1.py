...
"""),
    E0 = (-1101.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,351,323,533,609,664,892,1120,1201,181.761,181.969],'cm^-1')),
        HinderedRotor(inertia=(0.300222,'amu*angstrom^2'), symmetry=1, barrier=(7.02817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.298419,'amu*angstrom^2'), symmetry=1, barrier=(7.0282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.298896,'amu*angstrom^2'), symmetry=1, barrier=(7.02995,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.316929,0.0872439,-0.000126111,9.4406e-08,-2.8169e-11,-132298,27.3447], Tmin=(100,'K'), Tmax=(819.779,'K')), NASAPolynomial(coeffs=[12.9579,0.0255691,-1.32703e-05,2.64839e-09,-1.88861e-13,-134371,-31.1296], Tmin=(819.779,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1101.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCFFO) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-713.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,395,473,707,1436,284.618,285.023,1499.42],'cm^-1')),
        HinderedRotor(inertia=(0.122039,'amu*angstrom^2'), symmetry=1, barrier=(7.05776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331968,'amu*angstrom^2'), symmetry=1, barrier=(19.0573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.332011,'amu*angstrom^2'), symmetry=1, barrier=(19.0623,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05591,0.0693568,-8.50454e-05,5.38025e-08,-1.37434e-11,-85734.4,25.7487], Tmin=(100,'K'), Tmax=(945.986,'K')), NASAPolynomial(coeffs=[11.919,0.0234243,-1.2214e-05,2.47672e-09,-1.79492e-13,-87789.7,-26.0562], Tmin=(945.986,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-713.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-CsHH)(F1s)(O2s-H))"""),
)
...
"""),
    E0 = (-841.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,261,441,281,365,497,569,525,693,557,771,857,927,1026,1214,1153,1249,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.217071,'amu*angstrom^2'), symmetry=1, barrier=(4.99089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215408,'amu*angstrom^2'), symmetry=1, barrier=(4.95266,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.469852,0.0840535,-0.000128064,1.01439e-07,-3.20154e-11,-101037,26.6868], Tmin=(100,'K'), Tmax=(776.443,'K')), NASAPolynomial(coeffs=[12.0346,0.0244701,-1.29454e-05,2.58705e-09,-1.83956e-13,-102832,-26.1789], Tmin=(776.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-841.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCFFO) + radical(O2sj(Cs-CsF1sF1s)) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
species(
    label = '[O]C(F)(F)[CH]C(O)(F)F(11430)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1161.11,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,202,304,469,581,520,674,579,755,732,952,1136,1220,1240,1408,3025,407.5,1350,352.5,243.877,243.882],'cm^-1')),
        HinderedRotor(inertia=(0.00283425,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255568,'amu*angstrom^2'), symmetry=1, barrier=(10.788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255612,'amu*angstrom^2'), symmetry=1, barrier=(10.7881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255628,'amu*angstrom^2'), symmetry=1, barrier=(10.788,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.321362,0.0857302,-0.000117662,8.11577e-08,-2.21111e-11,-139521,28.5434], Tmin=(100,'K'), Tmax=(898.554,'K')), NASAPolynomial(coeffs=[14.6294,0.0220368,-1.13362e-05,2.27141e-09,-1.63049e-13,-142092,-38.9544], Tmin=(898.554,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1161.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCFFO) + radical(CCJCO)"""),
)

species(
    label = 'OOC(F)(F)C[C](F)F(11433)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-805.752,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,395,473,707,1436,307.371,307.372,307.372],'cm^-1')),
        HinderedRotor(inertia=(0.362684,'amu*angstrom^2'), symmetry=1, barrier=(24.3155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362685,'amu*angstrom^2'), symmetry=1, barrier=(24.3155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362689,'amu*angstrom^2'), symmetry=1, barrier=(24.3155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124575,'amu*angstrom^2'), symmetry=1, barrier=(8.35193,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
...
"""),
    E0 = (-797.242,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,395,473,707,1436,226.405,230.458,236.725],'cm^-1')),
        HinderedRotor(inertia=(0.21677,'amu*angstrom^2'), symmetry=1, barrier=(8.02075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241374,'amu*angstrom^2'), symmetry=1, barrier=(8.00329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198152,'amu*angstrom^2'), symmetry=1, barrier=(8.02827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.656498,'amu*angstrom^2'), symmetry=1, barrier=(23.7181,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.190151,0.100969,-0.000170979,1.48274e-07,-5.02613e-11,-95743.6,29.3259], Tmin=(100,'K'), Tmax=(809.841,'K')), NASAPolynomial(coeffs=[12.4155,0.0276861,-1.48288e-05,2.92602e-09,-2.04442e-13,-97423.9,-26.5988], Tmin=(809.841,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-797.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCFHO) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', 'OC(F)(F)C[C](F)F(5190)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(F)CC(O)(F)F(4754)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2O(49)', '[CH2]C(O)(F)F(1116)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(82.1697,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)(F)C[C](O)F(5743)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O][C](F)CC(O)(F)F(11428)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', '[O]C(F)(F)C[C](F)F(4719)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)CC([O])(F)F(11429)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C](F)F(4778)', '[CH2]C(O)(F)F(1116)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)[CH]C(O)(F)F(11430)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[O]C(F)(F)CC(=O)F(4702)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(179.53,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[O]C(F)(F)C=C(O)F(11431)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(195.968,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C(F)[CH]C(O)(F)F(5746)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OC(F)(F)[CH]C(O)(F)F(11432)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(11.42,'s^-1'), n=3.021, Ea=(105.562,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""From training reaction 319 used for R3H_SS_Cs;C_rad_out_H/NonDeC;O_H_out
...
reaction(
    label = 'reaction20',
    reactants = ['OOC(F)(F)C[C](F)F(11433)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O[C](F)CC(F)(F)OF(11027)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(82.6005,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction22',
    reactants = ['OC(F)(F)C[C](F)OF(11066)'],
    products = ['[O]C(F)(F)CC(O)(F)F(10851)'],
