...
"""),
    E0 = (-330.808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,205.273,205.366,1639.01,1639.3],'cm^-1')),
        HinderedRotor(inertia=(0.266798,'amu*angstrom^2'), symmetry=1, barrier=(8.0053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267039,'amu*angstrom^2'), symmetry=1, barrier=(8.00575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.968163,'amu*angstrom^2'), symmetry=1, barrier=(28.9671,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56134,0.064461,-6.25968e-05,-1.52007e-08,5.18285e-11,-39710.3,27.3775], Tmin=(100,'K'), Tmax=(484.759,'K')), NASAPolynomial(coeffs=[8.09116,0.0299799,-1.59305e-05,3.17701e-09,-2.24943e-13,-40571.4,-1.74794], Tmin=(484.759,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-330.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = '[O]C(C[C](F)F)OF(3446)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-330.169,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,190,488,555,1236,1407,180,180,981.712,982.787],'cm^-1')),
        HinderedRotor(inertia=(0.241177,'amu*angstrom^2'), symmetry=1, barrier=(5.54514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241283,'amu*angstrom^2'), symmetry=1, barrier=(5.54756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240957,'amu*angstrom^2'), symmetry=1, barrier=(5.54008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.754141,0.0831499,-0.000150759,1.45499e-07,-5.37561e-11,-39604.7,28.9869], Tmin=(100,'K'), Tmax=(829.391,'K')), NASAPolynomial(coeffs=[5.70687,0.0347135,-1.87588e-05,3.707e-09,-2.58723e-13,-39581.8,11.1097], Tmin=(829.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-330.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFH) + radical(CCOJ) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'O[C](C[C](F)F)OF(3447)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-350.628,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,190,488,555,1236,1407,337.228,337.229,2098.58],'cm^-1')),
        HinderedRotor(inertia=(0.101276,'amu*angstrom^2'), symmetry=1, barrier=(8.17295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101276,'amu*angstrom^2'), symmetry=1, barrier=(8.17295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101275,'amu*angstrom^2'), symmetry=1, barrier=(8.17296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288411,'amu*angstrom^2'), symmetry=1, barrier=(23.2749,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.455144,0.086288,-0.000147525,1.3051e-07,-4.49752e-11,-42051.2,29.8896], Tmin=(100,'K'), Tmax=(819.685,'K')), NASAPolynomial(coeffs=[10.1831,0.0260191,-1.38161e-05,2.71563e-09,-1.89202e-13,-43216,-12.4855], Tmin=(819.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-350.628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFH) + radical(Cs_P) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-653.645,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,180,180,180,180,1208.84,1209.12,1209.38],'cm^-1')),
        HinderedRotor(inertia=(0.104494,'amu*angstrom^2'), symmetry=1, barrier=(2.40253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0527171,'amu*angstrom^2'), symmetry=1, barrier=(54.732,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84824,0.0549515,-8.56754e-05,8.59357e-08,-3.44422e-11,-78545.4,20.3104], Tmin=(100,'K'), Tmax=(788.537,'K')), NASAPolynomial(coeffs=[2.52009,0.0356367,-1.86752e-05,3.70846e-09,-2.62088e-13,-78156.8,20.3645], Tmin=(788.537,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-653.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FOCC(F)F(3376)'],
    products = ['O=C(CC(F)F)OF(3426)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'O=C(C[C]F)OF(1440)'],
    products = ['O=C(CC(F)F)OF(3426)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'O=C(CF)OF(1424)'],
    products = ['O=C(CC(F)F)OF(3426)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C([CH]C(F)F)OF(3445)'],
    products = ['O=C(CC(F)F)OF(3426)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(C[CH]F)OF(1449)'],
    products = ['O=C(CC(F)F)OF(3426)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(=O)CC(F)F(1564)'],
    products = ['O=C(CC(F)F)OF(3426)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', 'O=[C]CC(F)F(1563)'],
    products = ['O=C(CC(F)F)OF(3426)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF2(81)', '[CH2]C(=O)OF(1447)'],
    products = ['O=C(CC(F)F)OF(3426)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(167)', 'CHF2-CH2(64)'],
    products = ['O=C(CC(F)F)OF(3426)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=C([CH]C(F)F)OF(3449)'],
    products = ['O=C(CC(F)F)OF(3426)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(C[C](F)F)OF(3450)'],
    products = ['O=C(CC(F)F)OF(3426)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(C=CF)OF(3451)'],
    products = ['O=C(CC(F)F)OF(3426)'],
