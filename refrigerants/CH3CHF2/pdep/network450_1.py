...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(1266)', '[CH]F(230)'],
    products = ['[O]C(=O)O[CH]F(1414)'],
    transitionState = 'TS2',
