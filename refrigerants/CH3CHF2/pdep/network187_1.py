...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[O](206)'],
    products = ['O=O(143)', 'CH2CO(28)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])=O(303)'],
    products = ['[CH2]C(=O)O[O](206)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C]=O(700)', 'CH2(T)(18)'],
    products = ['[CH2]C(=O)O[O](206)'],
    transitionState = 'TS3',
