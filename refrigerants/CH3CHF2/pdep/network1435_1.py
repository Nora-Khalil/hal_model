...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', '[CH]C(=O)F(1066)'],
    products = ['[CH]=C(F)O[CH]F(3975)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CHF(40)', '[CH]C(=O)F(1066)'],
    products = ['[CH]=C(F)O[CH]F(3975)'],
    transitionState = 'TS8',
