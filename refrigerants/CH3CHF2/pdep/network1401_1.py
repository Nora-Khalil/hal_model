...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=COOC(2288)'],
    products = ['C=COOCC(3851)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[CH2]OOC=C(2446)'],
    products = ['C=COOCC(3851)'],
