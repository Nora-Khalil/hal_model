...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3025)', '[CH2]C[O](339)'],
    products = ['[CH2]CO[C](F)F(4738)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C](F)F(3213)'],
    products = ['[CH2]CO[C](F)F(4738)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(4846)', 'C2H4(30)'],
    products = ['[CH2]CO[C](F)F(4738)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(4846)', '[CH2][CH2](612)'],
    products = ['[CH2]CO[C](F)F(4738)'],
    transitionState = 'TS9',
