...
"""),
    ...
    molecularWeight = (123.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.560138,0.08502,-0.000142465,1.29474e-07,-4.58685e-11,-61946.5,26.0976], Tmin=(100,'K'), Tmax=(829.092,'K')), NASAPolynomial(coeffs=[7.79461,0.0328301,-1.67667e-05,3.25276e-09,-2.2525e-13,-62552,-3.86548], Tmin=(829.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-516.008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-OsHHH) + group(Cds-OdCsH) + radical(ROOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0457418,'amu*angstrom^2'), symmetry=1, barrier=(46.5838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.407444,'amu*angstrom^2'), symmetry=1, barrier=(9.36795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.02917,'amu*angstrom^2'), symmetry=1, barrier=(46.6545,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50729,0.0603783,-7.41741e-05,5.51358e-08,-1.76423e-11,-44083.9,22.6895], Tmin=(100,'K'), Tmax=(745.348,'K')), NASAPolynomial(coeffs=[6.88153,0.0315377,-1.61346e-05,3.22464e-09,-2.31101e-13,-44885.1,-1.65879], Tmin=(745.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-367.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsHHH) + group(COCsFO) + radical(OCJC=O)"""),
)
...
"""),
    ...
    molecularWeight = (123.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39139,0.0636715,-7.6677e-05,5.74345e-08,-1.88706e-11,-20689.2,26.449], Tmin=(100,'K'), Tmax=(721.626,'K')), NASAPolynomial(coeffs=[6.43505,0.0357138,-1.85621e-05,3.74482e-09,-2.70019e-13,-21417.1,3.76186], Tmin=(721.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-OsHHH) + ring(Cs-Cs(F)-O2s-O2s) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'COO[CH]C1(F)OO1(2933)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {3,S} {6,S}
3  O u0 p2 c0 {2,S} {6,S}
...
"""),
    ...
    molecularWeight = (123.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08704,0.0703649,-8.9795e-05,6.79221e-08,-2.18073e-11,-25636.9,25.1092], Tmin=(100,'K'), Tmax=(746.792,'K')), NASAPolynomial(coeffs=[7.7958,0.0344372,-1.76429e-05,3.52225e-09,-2.52044e-13,-26639.1,-5.29908], Tmin=(746.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-213.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cs-OsHHH) + ring(O2s-O2s-Cs(F)(C)) + radical(CCsJOOC)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.391879,'amu*angstrom^2'), symmetry=1, barrier=(9.01006,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391569,'amu*angstrom^2'), symmetry=1, barrier=(9.00293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391022,'amu*angstrom^2'), symmetry=1, barrier=(8.99036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524721,'amu*angstrom^2'), symmetry=1, barrier=(12.0644,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23992,0.0661071,-9.97236e-05,8.46365e-08,-2.86896e-11,31993.6,29.2136], Tmin=(100,'K'), Tmax=(818.83,'K')), NASAPolynomial(coeffs=[7.94347,0.0258846,-1.23466e-05,2.34737e-09,-1.61546e-13,31146.4,-0.257031], Tmin=(818.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(265.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.354884,'amu*angstrom^2'), symmetry=1, barrier=(8.15948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3556,'amu*angstrom^2'), symmetry=1, barrier=(8.17594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.25387,'amu*angstrom^2'), symmetry=1, barrier=(51.8209,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71553,0.0561574,-8.52224e-05,7.7861e-08,-2.87572e-11,6299.54,21.5391], Tmin=(100,'K'), Tmax=(791.532,'K')), NASAPolynomial(coeffs=[5.29945,0.0284108,-1.43816e-05,2.81643e-09,-1.97539e-13,6034.01,6.99325], Tmin=(791.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    E0 = (-45.19,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,293,496,537,1218,1685,370,1367.64],'cm^-1')),
        HinderedRotor(inertia=(0.217954,'amu*angstrom^2'), symmetry=1, barrier=(5.0112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21838,'amu*angstrom^2'), symmetry=1, barrier=(5.02098,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217863,'amu*angstrom^2'), symmetry=1, barrier=(5.00909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218321,'amu*angstrom^2'), symmetry=1, barrier=(5.01962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.29847,'amu*angstrom^2'), symmetry=1, barrier=(52.8463,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.846909,0.0850323,-0.000161744,1.66765e-07,-6.44772e-11,-5336.78,31.8749], Tmin=(100,'K'), Tmax=(835.117,'K')), NASAPolynomial(coeffs=[1.56911,0.0450808,-2.4439e-05,4.83054e-09,-3.36936e-13,-4184.88,36.1397], Tmin=(835.117,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-OsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(C=CJO)"""),
)

species(
    label = '[CH2]OOC=C(F)OO(2941)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {3,S} {6,S}
3  O u0 p2 c0 {2,S} {8,S}
...
"""),
    ...
    molecularWeight = (123.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.633634,0.0829987,-0.000134653,1.24262e-07,-4.58707e-11,-10872.8,29.2103], Tmin=(100,'K'), Tmax=(782.557,'K')), NASAPolynomial(coeffs=[7.0068,0.036717,-1.96695e-05,3.92589e-09,-2.77803e-13,-11450.6,2.70747], Tmin=(782.557,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.3373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsJOOC)"""),
)

species(
    label = 'COOC=[C]OOF(2942)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {3,S} {6,S}
3  O u0 p2 c0 {2,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.89493,'amu*angstrom^2'), symmetry=1, barrier=(20.5762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.894405,'amu*angstrom^2'), symmetry=1, barrier=(20.5641,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.737727,0.0778004,-0.000111671,8.87869e-08,-2.87529e-11,25191.3,31.6474], Tmin=(100,'K'), Tmax=(752.014,'K')), NASAPolynomial(coeffs=[9.86632,0.0292435,-1.48148e-05,2.92023e-09,-2.06521e-13,23818.4,-9.79092], Tmin=(752.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]OC(F)=COO(2928)'],
    products = ['COOC=C(F)O[O](2844)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'COO[CH]C(=O)F(2930)'],
    products = ['COOC=C(F)O[O](2844)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['COOC=C(F)O[O](2844)'],
    products = ['CH3O(27)', 'FC1=COOO1(2931)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'COOC=[C]O[O](2934)'],
    products = ['COOC=C(F)O[O](2844)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[O]OC=C(F)O[O](2935)'],
    products = ['COOC=C(F)O[O](2844)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]OOC=C(F)O[O](2937)'],
    products = ['COOC=C(F)O[O](2844)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'COO[C]=C(F)O[O](2938)'],
    products = ['COOC=C(F)O[O](2844)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'COOC#CO[O](2939)'],
    products = ['COOC=C(F)O[O](2844)'],
