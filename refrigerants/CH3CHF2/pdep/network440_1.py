...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH2]C([O])=O(303)'],
    products = ['[O]C(=O)C[C]=O(1404)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C=C=O(1493)'],
    products = ['[O]C(=O)C[C]=O(1404)'],
