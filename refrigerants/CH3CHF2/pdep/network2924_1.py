...
"""),
    E0 = (161.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,2950,3100,1380,975,1025,1650,1685,370,308.526,309.041,1933.97],'cm^-1')),
        HinderedRotor(inertia=(0.144682,'amu*angstrom^2'), symmetry=1, barrier=(9.79438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00369016,'amu*angstrom^2'), symmetry=1, barrier=(9.79312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.714046,'amu*angstrom^2'), symmetry=1, barrier=(48.3126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78601,0.055526,-5.15073e-05,1.04323e-08,1.34569e-11,19519.4,26.3411], Tmin=(100,'K'), Tmax=(546.357,'K')), NASAPolynomial(coeffs=[6.68081,0.0308757,-1.45406e-05,2.79743e-09,-1.95883e-13,18817.6,4.15754], Tmin=(546.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(C=CJO)"""),
)
...
"""),
    E0 = (169.038,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,322.573,323.237],'cm^-1')),
        HinderedRotor(inertia=(0.00161717,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121639,'amu*angstrom^2'), symmetry=1, barrier=(9.0145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.483041,'amu*angstrom^2'), symmetry=1, barrier=(35.6244,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2161,0.0618658,-6.48553e-05,3.61925e-08,-8.18298e-12,20430.3,25.595], Tmin=(100,'K'), Tmax=(1064.77,'K')), NASAPolynomial(coeffs=[11.5625,0.0229976,-1.00994e-05,1.90912e-09,-1.33505e-13,18227,-24.9699], Tmin=(1064.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(Cds_P)"""),
)

species(
    label = 'C=[C]OC(C)=[C]F(7819)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    E0 = (263.971,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,1685,370,167,640,1190,251.901,252.281,1473.37],'cm^-1')),
        HinderedRotor(inertia=(0.121724,'amu*angstrom^2'), symmetry=1, barrier=(5.48369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121976,'amu*angstrom^2'), symmetry=1, barrier=(5.47804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122159,'amu*angstrom^2'), symmetry=1, barrier=(5.47565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43447,0.0633096,-9.3538e-05,8.57736e-08,-3.17498e-11,31834.1,27.8375], Tmin=(100,'K'), Tmax=(806.374,'K')), NASAPolynomial(coeffs=[4.70895,0.0345993,-1.69401e-05,3.27306e-09,-2.27797e-13,31711.4,15.258], Tmin=(806.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cdj(Cd-CsO2s)(F1s))"""),
)

species(
    label = 'C=COC(=C)[C]F(7820)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (259.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,329.332,330.373,332.311],'cm^-1')),
        HinderedRotor(inertia=(0.0698704,'amu*angstrom^2'), symmetry=1, barrier=(5.3714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0678991,'amu*angstrom^2'), symmetry=1, barrier=(5.34796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.359807,'amu*angstrom^2'), symmetry=1, barrier=(28.0031,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39742,0.062136,-7.69812e-05,5.72162e-08,-1.79946e-11,31252.2,27.0671], Tmin=(100,'K'), Tmax=(763.493,'K')), NASAPolynomial(coeffs=[7.44348,0.0304613,-1.47532e-05,2.88171e-09,-2.0378e-13,30328.9,-0.470331], Tmin=(763.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)OC(=C)F(7823)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {4,S}
3  C u0 p0 c0 {2,S} {5,D} {7,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65379,0.0563516,-4.57675e-05,2.19793e-08,-4.83132e-12,13731.5,23.9975], Tmin=(100,'K'), Tmax=(1011.55,'K')), NASAPolynomial(coeffs=[6.46026,0.037345,-1.75828e-05,3.40377e-09,-2.40399e-13,12759.2,0.753953], Tmin=(1011.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C]=CF(4071)'],
    products = ['[CH2]C(=CF)O[C]=C(7418)'],
    transitionState = 'TS3',
