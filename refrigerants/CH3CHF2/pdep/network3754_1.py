...
"""),
    E0 = (-263.212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,493,600,700,1144,1293,180,250.49,778.978],'cm^-1')),
        HinderedRotor(inertia=(0.72226,'amu*angstrom^2'), symmetry=1, barrier=(16.6062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0383004,'amu*angstrom^2'), symmetry=1, barrier=(16.604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0384376,'amu*angstrom^2'), symmetry=1, barrier=(16.6138,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11159,0.0540471,-3.75459e-05,1.19579e-09,5.70829e-12,-31544.5,24.0537], Tmin=(100,'K'), Tmax=(969.673,'K')), NASAPolynomial(coeffs=[16.8957,0.0104605,-3.41796e-06,6.24171e-10,-4.63042e-14,-35617.5,-56.8273], Tmin=(969.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76708,0.0534403,-6.36425e-05,4.66887e-08,-1.4719e-11,-19638.3,22.2984], Tmin=(100,'K'), Tmax=(757.522,'K')), NASAPolynomial(coeffs=[6.55055,0.0281801,-1.36206e-05,2.66338e-09,-1.88635e-13,-20363,0.54962], Tmin=(757.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-163.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsFFHO) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-175.032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,493,600,700,1144,1293,3120,650,792.5,1650,374.618,377.962],'cm^-1')),
        HinderedRotor(inertia=(0.149268,'amu*angstrom^2'), symmetry=1, barrier=(14.3359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142104,'amu*angstrom^2'), symmetry=1, barrier=(14.3134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140043,'amu*angstrom^2'), symmetry=1, barrier=(14.3164,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)O[C](F)F(6645)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C](F)F(3211)'],
    products = ['[CH2]C(=C)O[C](F)F(6645)'],
    transitionState = 'TS3',
...
network(
    label = 'PDepNetwork #3754',
    isomers = [
        '[CH2]C(=C)O[C](F)F(6645)',
    ],
    reactants = [
        ('CF2O(49)', 'C=C=C(6730)'),
    ],
