...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=C(O)OF(2357)'],
    products = ['O=C(O)OC(=O)F(2981)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(=O)O(2999)'],
    products = ['O=C(O)OC(=O)F(2981)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(=O)F(3000)'],
    products = ['O=C(O)OC(=O)F(2981)'],
