...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.810939,'amu*angstrom^2'), symmetry=1, barrier=(18.6451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.810009,'amu*angstrom^2'), symmetry=1, barrier=(18.6237,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.551307,0.0706983,-8.71105e-05,4.80958e-08,-9.38847e-12,-60582.1,21.9792], Tmin=(100,'K'), Tmax=(952.679,'K')), NASAPolynomial(coeffs=[18.8168,0.00507218,-1.20361e-06,1.71205e-10,-1.14787e-14,-64564.4,-67.8911], Tmin=(952.679,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-504.779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(O)OC(F)F(2213)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
4  O u0 p2 c0 {5,S} {11,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03646,0.0723711,-0.000118032,1.05617e-07,-3.73922e-11,-51826,25.6489], Tmin=(100,'K'), Tmax=(803.923,'K')), NASAPolynomial(coeffs=[7.84027,0.0276559,-1.43331e-05,2.81651e-09,-1.97161e-13,-52569,-3.50759], Tmin=(803.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-431.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsFFHO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C=C(O)O(1862)'],
    products = ['C=C(O)OC(F)F(1556)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(O)O[CH]F(1870)'],
    products = ['C=C(O)OC(F)F(1556)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)F(615)', 'C=[C]O(137)'],
    products = ['C=C(O)OC(F)F(1556)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=[C]OC(F)F(2209)'],
    products = ['C=C(O)OC(F)F(1556)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=O)OC(F)F(2210)'],
    products = ['C=C(O)OC(F)F(1556)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C(O)O[C](F)F(2211)'],
    products = ['C=C(O)OC(F)F(1556)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C(O)OC(F)F(2212)'],
    products = ['C=C(O)OC(F)F(1556)'],
