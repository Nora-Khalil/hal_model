...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[CH]O(1865)'],
    products = ['C=C(F)OC(O)F(2058)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'C=C(F)O[CH]F(643)'],
    products = ['C=C(F)OC(O)F(2058)'],
