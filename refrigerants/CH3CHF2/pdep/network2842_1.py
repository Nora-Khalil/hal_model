...
"""),
    E0 = (-49.6308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,1621.47,1624.36],'cm^-1')),
        HinderedRotor(inertia=(0.298394,'amu*angstrom^2'), symmetry=1, barrier=(6.86066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0246552,'amu*angstrom^2'), symmetry=1, barrier=(0.566872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.297961,'amu*angstrom^2'), symmetry=1, barrier=(6.8507,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2072,0.0433608,-5.12479e-05,4.45762e-08,-1.707e-11,-5908.42,22.3046], Tmin=(100,'K'), Tmax=(755.024,'K')), NASAPolynomial(coeffs=[3.7537,0.0299522,-1.42475e-05,2.75671e-09,-1.93517e-13,-5993.29,16.2627], Tmin=(755.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.6308,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.68443,0.0174511,4.59585e-05,-7.7368e-08,3.39753e-11,-35608.5,15.3582], Tmin=(100,'K'), Tmax=(872.727,'K')), NASAPolynomial(coeffs=[10.4131,0.0134606,-1.20756e-06,-6.94774e-11,1.0654e-14,-38154.5,-27.734], Tmin=(872.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Oxetane)"""),
)
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04314,0.0413771,-3.31797e-05,1.41723e-08,-2.50004e-12,-42496.8,19.3585], Tmin=(100,'K'), Tmax=(1324.49,'K')), NASAPolynomial(coeffs=[9.42881,0.0190721,-7.91899e-06,1.45757e-09,-1.0011e-13,-44453.2,-18.3486], Tmin=(1324.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-353.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3182,0.0338019,-1.57456e-05,2.38744e-09,8.05868e-14,-56345.6,16.7584], Tmin=(100,'K'), Tmax=(1644.51,'K')), NASAPolynomial(coeffs=[10.1001,0.0204141,-8.58764e-06,1.53431e-09,-1.01151e-13,-59654.3,-26.9334], Tmin=(1644.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-469.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (-54.9751,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,247.779,1281.39],'cm^-1')),
        HinderedRotor(inertia=(0.000619622,'amu*angstrom^2'), symmetry=1, barrier=(7.03523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0233951,'amu*angstrom^2'), symmetry=1, barrier=(27.1724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171239,'amu*angstrom^2'), symmetry=1, barrier=(7.01493,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.75268,0.0331758,-1.82105e-05,4.67815e-09,-4.94622e-13,-6573.25,21.0253], Tmin=(100,'K'), Tmax=(1885.88,'K')), NASAPolynomial(coeffs=[7.35775,0.0234085,-1.04418e-05,1.93193e-09,-1.30576e-13,-8310.2,-4.11297], Tmin=(1885.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.9751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C[C](O)O(7347)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {11,S}
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98315,0.0455769,-4.44898e-05,2.42713e-08,-5.50873e-12,-8358.2,22.247], Tmin=(100,'K'), Tmax=(1046.67,'K')), NASAPolynomial(coeffs=[8.4516,0.0208567,-9.06262e-06,1.70617e-09,-1.18962e-13,-9712.26,-9.25455], Tmin=(1046.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-70.0896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJ)"""),
)
...
"""),
    E0 = (-49.6308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,308.053,2423.23],'cm^-1')),
        HinderedRotor(inertia=(0.00764039,'amu*angstrom^2'), symmetry=1, barrier=(7.27349,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10932,'amu*angstrom^2'), symmetry=1, barrier=(7.27587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108851,'amu*angstrom^2'), symmetry=1, barrier=(7.26245,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2072,0.0433608,-5.12479e-05,4.45762e-08,-1.707e-11,-5908.42,21.206], Tmin=(100,'K'), Tmax=(755.024,'K')), NASAPolynomial(coeffs=[3.7537,0.0299522,-1.42475e-05,2.75671e-09,-1.93517e-13,-5993.29,15.1641], Tmin=(755.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.6308,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2][CH]C(O)O(7349)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {11,S}
2  O u0 p2 c0 {3,S} {10,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90133,0.0424797,-3.54621e-05,1.55798e-08,-2.77087e-12,-8994.03,24.346], Tmin=(100,'K'), Tmax=(1338.34,'K')), NASAPolynomial(coeffs=[10.5364,0.0166713,-6.53627e-06,1.171e-09,-7.93164e-14,-11305.4,-19.8297], Tmin=(1338.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.4339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47591,0.0406128,-5.6001e-05,6.17409e-08,-2.68578e-11,-3460.67,19.7166], Tmin=(100,'K'), Tmax=(802.407,'K')), NASAPolynomial(coeffs=[-0.627286,0.038474,-1.90861e-05,3.7227e-09,-2.6088e-13,-2395.8,37.5369], Tmin=(802.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([O])O(7336)'],
    products = ['O=CO(1075)', 'C2H4(30)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C([O])O(7019)'],
    products = ['[CH2]CC([O])O(7336)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['O=CO(1075)', '[CH2][CH2](611)'],
    products = ['[CH2]CC([O])O(7336)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]O(1357)', '[CH2][CH2](611)'],
    products = ['[CH2]CC([O])O(7336)'],
