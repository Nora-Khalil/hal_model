...
"""),
    E0 = (-659.682,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,2120,512.5,787.5,224.803,224.826],'cm^-1')),
        HinderedRotor(inertia=(0.191825,'amu*angstrom^2'), symmetry=1, barrier=(6.87664,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191519,'amu*angstrom^2'), symmetry=1, barrier=(6.87656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191728,'amu*angstrom^2'), symmetry=1, barrier=(6.87713,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.591841,0.0843409,-0.000142445,1.28335e-07,-4.45696e-11,-79227.7,25.9617], Tmin=(100,'K'), Tmax=(853.28,'K')), NASAPolynomial(coeffs=[7.96952,0.0308342,-1.51212e-05,2.86887e-09,-1.95456e-13,-79797.9,-4.4244], Tmin=(853.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-659.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)OsHH) + group(CsCFFH) + group(Cds-(Cdd-O2d)CsCs) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'C=C=C(O)OC(F)F(9160)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.960473,'amu*angstrom^2'), symmetry=1, barrier=(22.0832,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961722,'amu*angstrom^2'), symmetry=1, barrier=(22.1119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.958684,'amu*angstrom^2'), symmetry=1, barrier=(22.042,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0229081,0.0828694,-0.000101674,5.95476e-08,-1.33196e-11,-73372.3,24.4968], Tmin=(100,'K'), Tmax=(1109.55,'K')), NASAPolynomial(coeffs=[20.1008,0.0103218,-3.59681e-06,6.18329e-10,-4.18712e-14,-77837.9,-74.6806], Tmin=(1109.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-611.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=C(C([O])[O])C(F)F(9161)',
...
"""),
    E0 = (-335.545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,1380,1390,370,380,2900,435,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,1774.46,1776.95],'cm^-1')),
        HinderedRotor(inertia=(0.124568,'amu*angstrom^2'), symmetry=1, barrier=(2.86406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124938,'amu*angstrom^2'), symmetry=1, barrier=(2.87257,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12469,0.0768811,-0.000139595,1.44105e-07,-5.63435e-11,-40266.5,27.8907], Tmin=(100,'K'), Tmax=(827.847,'K')), NASAPolynomial(coeffs=[1.30671,0.04444,-2.36263e-05,4.66169e-09,-3.25792e-13,-39215.1,33.579], Tmin=(827.847,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-408.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,350,440,435,1725,3000,3100,440,815,1455,1000,182,240,577,636,1210,1413,587.187,588.612],'cm^-1')),
        HinderedRotor(inertia=(0.144724,'amu*angstrom^2'), symmetry=1, barrier=(3.32748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149421,'amu*angstrom^2'), symmetry=1, barrier=(3.43548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0128704,'amu*angstrom^2'), symmetry=1, barrier=(3.32874,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.823285,0.0765151,-0.000115913,1.00232e-07,-3.50343e-11,-49036.1,28.1897], Tmin=(100,'K'), Tmax=(784.614,'K')), NASAPolynomial(coeffs=[8.15473,0.0316654,-1.58833e-05,3.09872e-09,-2.16919e-13,-49956.6,-3.93597], Tmin=(784.614,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-408.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(CCOJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=C(C([O])O)C(F)F(9164)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-314.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,3120,650,792.5,1650,193.162,1468.17],'cm^-1')),
        HinderedRotor(inertia=(0.212711,'amu*angstrom^2'), symmetry=1, barrier=(5.63202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212712,'amu*angstrom^2'), symmetry=1, barrier=(5.63202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212712,'amu*angstrom^2'), symmetry=1, barrier=(5.63203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.706783,0.082897,-0.000142841,1.34519e-07,-4.91032e-11,-37675.6,29.6288], Tmin=(100,'K'), Tmax=(825.35,'K')), NASAPolynomial(coeffs=[6.30714,0.0350742,-1.8341e-05,3.59593e-09,-2.50498e-13,-37895.6,7.95257], Tmin=(825.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.724736,'amu*angstrom^2'), symmetry=1, barrier=(22.4962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.725574,'amu*angstrom^2'), symmetry=1, barrier=(22.5041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.724093,'amu*angstrom^2'), symmetry=1, barrier=(22.5045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.724061,'amu*angstrom^2'), symmetry=1, barrier=(22.4988,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.13478,0.0839553,-9.86728e-05,5.28774e-08,-1.01567e-11,-56329.5,27.4661], Tmin=(100,'K'), Tmax=(984.034,'K')), NASAPolynomial(coeffs=[21.3301,0.00886836,-2.7594e-06,4.61221e-10,-3.18806e-14,-61142.9,-78.7369], Tmin=(984.034,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-469.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Csj(Cd-CsCd)(F1s)(F1s)) + radical(Allyl_P)"""),
)

species(
    label = '[CH]C(=C(O)O)C(F)F(9167)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.10564,'amu*angstrom^2'), symmetry=1, barrier=(48.4128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.10444,'amu*angstrom^2'), symmetry=1, barrier=(48.3852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.10543,'amu*angstrom^2'), symmetry=1, barrier=(48.408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.10489,'amu*angstrom^2'), symmetry=1, barrier=(48.3955,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.153733,0.0892913,-0.000109725,6.71643e-08,-1.59863e-11,-50620.5,26.3514], Tmin=(100,'K'), Tmax=(1035.28,'K')), NASAPolynomial(coeffs=[18.1071,0.0187373,-7.50114e-06,1.33741e-09,-9.04425e-14,-54401.5,-62.3798], Tmin=(1035.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C[C](C([O])=O)C(F)F(9168)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {8,S}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50735,0.0607041,-7.68898e-05,6.89922e-08,-2.72813e-11,-63733.8,24.5332], Tmin=(100,'K'), Tmax=(716.304,'K')), NASAPolynomial(coeffs=[4.04843,0.0401418,-2.04867e-05,4.0783e-09,-2.90937e-13,-63934.3,14.2629], Tmin=(716.304,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-530.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(CsCsFFH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)
...
"""),
    E0 = (-465.448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,180,1696.38,1697.43,1699.76,1700.05],'cm^-1')),
        HinderedRotor(inertia=(0.192532,'amu*angstrom^2'), symmetry=1, barrier=(4.4267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194805,'amu*angstrom^2'), symmetry=1, barrier=(4.47895,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44181,0.0693631,-0.000128862,1.35581e-07,-5.37034e-11,-55901.2,25.4323], Tmin=(100,'K'), Tmax=(825.652,'K')), NASAPolynomial(coeffs=[0.811409,0.0416025,-2.24457e-05,4.45352e-09,-3.12166e-13,-54746.7,34.7134], Tmin=(825.652,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-465.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCFFH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-533.659,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,3000,3100,440,815,1455,1000,182,240,577,636,1210,1413,241.234,241.595,2174.91,2174.95,4000],'cm^-1')),
        HinderedRotor(inertia=(0.770573,'amu*angstrom^2'), symmetry=1, barrier=(31.8492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.769582,'amu*angstrom^2'), symmetry=1, barrier=(31.8499,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00930041,'amu*angstrom^2'), symmetry=1, barrier=(11.1137,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08704,0.0697133,-0.000105133,8.90127e-08,-3.05137e-11,-64084.8,25.1436], Tmin=(100,'K'), Tmax=(770.468,'K')), NASAPolynomial(coeffs=[8.52675,0.026874,-1.35242e-05,2.64602e-09,-1.85685e-13,-65106.1,-7.99692], Tmin=(770.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-533.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFF) + radical(C=C(C=O)CJ)"""),
)
...
"""),
    E0 = (-444.057,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,3120,650,792.5,1650,256.684,256.715,256.722,1528.58,2398.91],'cm^-1')),
        HinderedRotor(inertia=(0.00255671,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122417,'amu*angstrom^2'), symmetry=1, barrier=(5.72819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12243,'amu*angstrom^2'), symmetry=1, barrier=(5.7282,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0244,0.0753726,-0.000132083,1.25961e-07,-4.64474e-11,-53310.3,27.1687], Tmin=(100,'K'), Tmax=(822.008,'K')), NASAPolynomial(coeffs=[5.81024,0.0322396,-1.71622e-05,3.38818e-09,-2.36907e-13,-53426.6,9.09591], Tmin=(822.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-444.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCFFH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(C(=O)O)C(F)F(9173)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {7,S} {12,S}
4  O u0 p2 c0 {7,D}
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C=C(O)C(F)F(664)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(43)', 'C=CC(=O)O(1530)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'C=C([C]F)C(=O)O-2(9158)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'C=C(F)C(=O)O(176)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['C=C(C([O])[O])C(F)F(9161)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([C](F)F)C(=O)O(9162)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(=C(F)F)C([O])O(9163)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(C([O])O)C(F)F(9164)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C([O])=O)C(F)F(9165)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C([C](F)F)=C(O)O(9166)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C(=C(O)O)C(F)F(9167)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[C](C([O])=O)C(F)F(9168)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OH(7)', 'C=C([C]=O)C(F)F(9169)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'C=C(C([O])=O)C(F)F(9170)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CHF2(81)', 'C=[C]C(=O)O(2705)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[CH2]C(C(=O)O)=C(F)F(9171)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=[C]O(165)', 'C=[C]C(F)F(3592)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', '[CH]=C(C(=O)O)C(F)F(9172)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]C(C(=O)O)C(F)F(9173)'],
    products = ['C=C(C(=O)O)C(F)F(8657)'],
