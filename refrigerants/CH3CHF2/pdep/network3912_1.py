...
"""),
    E0 = (321.674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,3150,900,1100,180,180,180,613.483,970.304,970.307,970.371,970.441,970.467,1528.18],'cm^-1')),
        HinderedRotor(inertia=(0.221191,'amu*angstrom^2'), symmetry=1, barrier=(5.08561,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99589,0.0400898,-3.99169e-05,2.01768e-08,-3.99477e-12,21218.2,14.6037], Tmin=(100,'K'), Tmax=(1235.49,'K')), NASAPolynomial(coeffs=[11.2014,0.0102862,-3.73274e-06,6.52063e-10,-4.39734e-14,18943.5,-31.7545], Tmin=(1235.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CJ2_singlet-FO) + ring(cyclopropenone)"""),
)

species(
    label = 'FC1=[O+][C-]C=C1(11780)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5017,0.0269173,-5.40025e-07,-1.38652e-08,5.8215e-12,2160.99,37.5687], Tmin=(100,'K'), Tmax=(1100.93,'K')), NASAPolynomial(coeffs=[8.01325,0.0198174,-8.47695e-06,1.60499e-09,-1.1308e-13,164.135,6.89133], Tmin=(1100.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CsJ2_singlet-CsH) + group(COCFO) + ring(Cyclopentane)"""),
)

species(
    label = '[C-]=[O+]C1=CC1F(11781)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
