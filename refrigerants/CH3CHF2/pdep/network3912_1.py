...
species(
    label = '[CH2][C]1C(F)OC1(F)F(10764)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
species(
    label = '[CH2]C1([CH]F)OC1(F)F(10732)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=CF)C([O])(F)F(10235)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(=CF)C([O])(F)F(10235)'],
    products = ['[CH2]C(=C([O])F)C(F)F(10762)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([CH]F)=C(F)F(10533)'],
    products = ['[CH2]C(=CF)C([O])(F)F(10235)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', '[O]C(F)(F)[C]=CF(5053)'],
    products = ['[CH2]C(=CF)C([O])(F)F(10235)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=CF)C([O])(F)F(10235)'],
    products = ['[O]C(F)(F)[C]1CC1F(10763)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=CF)C([O])(F)F(10235)'],
    products = ['[CH2][C]1C(F)OC1(F)F(10764)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=CF)C([O])(F)F(10235)'],
    products = ['[CH2]C1([CH]F)OC1(F)F(10732)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=CF)C(=O)F(10593)'],
    products = ['[CH2]C(=CF)C([O])(F)F(10235)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC(=[C]F)C([O])(F)F(10765)'],
    products = ['[CH2]C(=CF)C([O])(F)F(10235)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(=CF)C([O])(F)F(10235)'],
    products = ['C=C([C]F)C(O)(F)F-2(10766)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH]F)=C(F)OF(10767)'],
    products = ['[CH2]C(=CF)C([O])(F)F(10235)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(=CF)C([O])(F)F(10235)'],
    products = ['O=C(F)[C]([CH]F)CF(10768)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C(=C)C(F)(F)OF(8256)'],
    products = ['[CH2]C(=CF)C([O])(F)F(10235)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(CF)C([O])(F)F(8297)'],
    products = ['[CH2]C(=CF)C([O])(F)F(10235)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=[C]C(F)C([O])(F)F(10236)'],
    products = ['[CH2]C(=CF)C([O])(F)F(10235)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]F(230)', 'C=[C]C([O])(F)F(4896)'],
    products = ['[CH2]C(=CF)C([O])(F)F(10235)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(=CF)C([O])(F)F(10235)'],
    products = ['C=C1C(F)OC1(F)F(10243)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(=CF)C([O])(F)F(10235)'],
    products = ['F[CH][C]1COC1(F)F(10769)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CHF(40)', 'C=[C]C([O])(F)F(4896)'],
    products = ['[CH2]C(=CF)C([O])(F)F(10235)'],
...
network(
    label = 'PDepNetwork #3912',
    isomers = [
        '[CH2]C(=CF)C([O])(F)F(10235)',
    ],
    reactants = [
        ('CF2O(49)', 'C=C=CF(7021)'),
    ],
