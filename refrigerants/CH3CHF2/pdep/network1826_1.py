...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C([O])(F)F(4735)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[C](F)F(4836)'],
    products = ['[O]C(F)(F)C([O])(F)F(4735)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)F(4870)'],
    products = ['[O]C(F)(F)C([O])(F)F(4735)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F2(78)', '[O][C](F)C(=O)F(4871)'],
    products = ['[O]C(F)(F)C([O])(F)F(4735)'],
    transitionState = 'TS7',
