...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50173,0.0431947,3.0395e-06,-3.14653e-08,1.38775e-11,-1580.36,17.2366], Tmin=(100,'K'), Tmax=(1036.17,'K')), NASAPolynomial(coeffs=[12.6846,0.0264233,-1.08968e-05,2.08869e-09,-1.5044e-13,-5314.96,-43.9498], Tmin=(1036.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.9722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCCFH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(12methylenecyclobutane)"""),
)
...
"""),
    E0 = (276.212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,145,326,398,834,1303,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,540,610,2055,308.388,308.421],'cm^-1')),
        HinderedRotor(inertia=(0.167101,'amu*angstrom^2'), symmetry=1, barrier=(11.2702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166903,'amu*angstrom^2'), symmetry=1, barrier=(11.2689,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47202,0.0576761,-5.17121e-05,2.56149e-08,-5.35814e-12,33309.9,23.5905], Tmin=(100,'K'), Tmax=(1115.32,'K')), NASAPolynomial(coeffs=[9.49235,0.0289122,-1.30275e-05,2.49196e-09,-1.7516e-13,31520.9,-15.9784], Tmin=(1115.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(276.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)
...
"""),
    E0 = (267.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,233,378,609,1068,1270,1314,3037,2950,3100,1380,975,1025,1650,1685,370,2175,525,750,770,3400,2100,259.554,259.57],'cm^-1')),
        HinderedRotor(inertia=(0.248188,'amu*angstrom^2'), symmetry=1, barrier=(11.8667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.317499,'amu*angstrom^2'), symmetry=1, barrier=(15.1782,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36314,'amu*angstrom^2'), symmetry=1, barrier=(65.178,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21913,0.0642537,-7.08511e-05,4.52691e-08,-1.20611e-11,32253.6,22.8069], Tmin=(100,'K'), Tmax=(900.302,'K')), NASAPolynomial(coeffs=[9.03155,0.0295434,-1.302e-05,2.44554e-09,-1.69664e-13,30846.9,-14.063], Tmin=(900.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.63149,'amu*angstrom^2'), symmetry=1, barrier=(37.5112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.1117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.759221,0.0600513,-5.80614e-05,2.91518e-08,-5.61575e-12,65516.4,20.7627], Tmin=(100,'K'), Tmax=(1428.67,'K')), NASAPolynomial(coeffs=[14.7313,0.0143869,-3.24518e-06,3.65938e-10,-1.74449e-14,62192,-49.2912], Tmin=(1428.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJC=C) + radical(C=CJC=C)"""),
)
...
"""),
    E0 = (346.676,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,164,312,561,654,898,1207,1299,3167,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,234.342],'cm^-1')),
        HinderedRotor(inertia=(0.293853,'amu*angstrom^2'), symmetry=1, barrier=(11.4514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.293853,'amu*angstrom^2'), symmetry=1, barrier=(11.4514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.293853,'amu*angstrom^2'), symmetry=1, barrier=(11.4514,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27696,0.0644749,-6.3191e-05,3.56914e-08,-8.66398e-12,41789.8,25.8196], Tmin=(100,'K'), Tmax=(963.99,'K')), NASAPolynomial(coeffs=[8.56633,0.0342285,-1.61273e-05,3.14394e-09,-2.23254e-13,40384.4,-9.08013], Tmin=(963.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC(F)C[C]=C(11724)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {8,S}
3  C u0 p0 c0 {2,S} {6,S} {9,S} {10,S}
...
"""),
    E0 = (348.507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,275.914,275.94],'cm^-1')),
        HinderedRotor(inertia=(0.204316,'amu*angstrom^2'), symmetry=1, barrier=(11.0273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204271,'amu*angstrom^2'), symmetry=1, barrier=(11.0274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204101,'amu*angstrom^2'), symmetry=1, barrier=(11.0268,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40352,0.0620624,-5.82202e-05,3.18221e-08,-7.60393e-12,42005.1,24.9375], Tmin=(100,'K'), Tmax=(967.987,'K')), NASAPolynomial(coeffs=[7.87398,0.0353243,-1.67864e-05,3.2858e-09,-2.33858e-13,40752.5,-6.06816], Tmin=(967.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=C(F)CC=C(11725)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {5,D} {10,S}
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(395)', '[CH2]C(F)[C]=C(277)'],
    products = ['C=[C]CC(F)[C]=C(11681)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(395)', 'C=[C]C[CH]F(268)'],
    products = ['C=[C]CC(F)[C]=C(11681)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=[C]CC(F)=C=C(11720)'],
    products = ['C=[C]CC(F)[C]=C(11681)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#CCC(F)[C]=C(8333)'],
    products = ['C=[C]CC(F)[C]=C(11681)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C#CC(F)C[C]=C(11721)'],
    products = ['C=[C]CC(F)[C]=C(11681)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'C=[C]C=C[C]=C(8354)'],
    products = ['C=[C]CC(F)[C]=C(11681)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=[C]CC(F)[C]=C(11681)'],
    products = ['[CH2]C=C(F)C[C]=C(11722)'],
