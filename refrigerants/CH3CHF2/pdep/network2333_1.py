...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C(F)(F)F(3044)'],
    products = ['[O]OCC(F)(F)F(5925)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]OC(F)(F)F(6044)', 'CH2(S)(25)'],
    products = ['[O]OCC(F)(F)F(5925)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]OC[C](F)F(3041)'],
    products = ['[O]OCC(F)(F)F(5925)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]O[CH]C(F)(F)F(6045)'],
    products = ['[O]OCC(F)(F)F(5925)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', '[O]OC=C(F)F(3115)'],
    products = ['[O]OCC(F)(F)F(5925)'],
    transitionState = 'TS9',
