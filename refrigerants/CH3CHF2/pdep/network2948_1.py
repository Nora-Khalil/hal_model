...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0167605,'amu*angstrom^2'), symmetry=1, barrier=(29.9605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000703357,'amu*angstrom^2'), symmetry=1, barrier=(7.98595,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (42.0797,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.12862,0.0145639,1.31001e-05,-2.16416e-08,7.85929e-12,34974.2,14.113], Tmin=(100,'K'), Tmax=(1043.71,'K')), NASAPolynomial(coeffs=[5.43611,0.0169626,-6.50456e-06,1.20125e-09,-8.43416e-14,33880.2,-0.0513673], Tmin=(1043.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(RCCJ) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78906,0.0397405,-4.44764e-06,-1.95406e-08,9.39889e-12,-12305.7,21.6155], Tmin=(100,'K'), Tmax=(1033.42,'K')), NASAPolynomial(coeffs=[10.8625,0.0239113,-9.4719e-06,1.76364e-09,-1.24624e-13,-15211.1,-27.4407], Tmin=(1033.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-103.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH)"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.606,0.0459216,-2.60873e-05,5.5609e-09,4.41051e-14,-5885.86,21.0515], Tmin=(100,'K'), Tmax=(1286.93,'K')), NASAPolynomial(coeffs=[10.9953,0.0243884,-9.90569e-06,1.79758e-09,-1.22167e-13,-8936.03,-29.0762], Tmin=(1286.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.7003,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (134.801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,615,860,1140,1343,3152,1685,370,374.415,374.676,375.257],'cm^-1')),
        HinderedRotor(inertia=(0.0872521,'amu*angstrom^2'), symmetry=1, barrier=(8.72183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0875946,'amu*angstrom^2'), symmetry=1, barrier=(8.72132,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68044,0.0450644,-3.09652e-05,1.08091e-08,-1.53178e-12,16301.2,22.49], Tmin=(100,'K'), Tmax=(1636.68,'K')), NASAPolynomial(coeffs=[12.0149,0.0198072,-7.81726e-06,1.3803e-09,-9.15435e-14,12918.3,-32.4593], Tmin=(1636.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (155.546,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,113,247,382,1207,3490,540,610,2055,860.323,864.443],'cm^-1')),
        HinderedRotor(inertia=(0.00731703,'amu*angstrom^2'), symmetry=1, barrier=(3.88244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166865,'amu*angstrom^2'), symmetry=1, barrier=(3.83655,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80549,0.0448486,-3.0645e-05,1.06659e-08,-1.52529e-12,18789.4,22.114], Tmin=(100,'K'), Tmax=(1595.44,'K')), NASAPolynomial(coeffs=[10.9744,0.0218607,-9.03232e-06,1.63481e-09,-1.10152e-13,15863.8,-26.4038], Tmin=(1595.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(RCCJ)"""),
)
...
"""),
    E0 = (331.048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,396.174],'cm^-1')),
        HinderedRotor(inertia=(3.62746,'amu*angstrom^2'), symmetry=1, barrier=(83.4025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.813012,'amu*angstrom^2'), symmetry=1, barrier=(18.6927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00932707,'amu*angstrom^2'), symmetry=1, barrier=(83.4034,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.109,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97016,0.0398631,-1.94564e-05,-1.25544e-09,3.24061e-12,39893.1,19.2368], Tmin=(100,'K'), Tmax=(981.438,'K')), NASAPolynomial(coeffs=[8.77953,0.0221972,-7.87269e-06,1.34792e-09,-9.00225e-14,38070.7,-15.9618], Tmin=(981.438,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25709,0.0413578,-2.2367e-05,5.84646e-09,-6.31981e-13,25206.3,24.1099], Tmin=(100,'K'), Tmax=(1907.21,'K')), NASAPolynomial(coeffs=[8.79852,0.0276385,-1.15769e-05,2.0748e-09,-1.37589e-13,22711.2,-11.6722], Tmin=(1907.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(RCCJC) + radical(Cdj(Cs-CsHH)(Cd-F1sH))"""),
)
...
"""),
    E0 = (223.271,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,167,640,1190,201.78,2424.37],'cm^-1')),
        HinderedRotor(inertia=(0.427486,'amu*angstrom^2'), symmetry=1, barrier=(12.3514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00249265,'amu*angstrom^2'), symmetry=1, barrier=(28.3017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.979548,'amu*angstrom^2'), symmetry=1, barrier=(28.3017,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66975,0.0492494,-3.50989e-05,1.31565e-08,-2.05938e-12,26938.6,23.8174], Tmin=(100,'K'), Tmax=(1454.79,'K')), NASAPolynomial(coeffs=[10.3022,0.025514,-1.06258e-05,1.94146e-09,-1.32121e-13,24426.9,-21.0652], Tmin=(1454.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(RCCJ) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'CCC=[C][CH]F(8214)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {9,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6132,0.0451071,-2.07841e-05,-6.19219e-10,2.11611e-12,17093,23.5038], Tmin=(100,'K'), Tmax=(1200.83,'K')), NASAPolynomial(coeffs=[11.1297,0.0252386,-1.07448e-05,2.01215e-09,-1.399e-13,13954.4,-27.7014], Tmin=(1200.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = '[CH2][CH]CC=CF(8215)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17366,0.04332,-2.64965e-05,8.79379e-09,-1.31678e-12,20220.3,24.2471], Tmin=(100,'K'), Tmax=(1370.53,'K')), NASAPolynomial(coeffs=[6.20766,0.0315464,-1.36107e-05,2.52572e-09,-1.73412e-13,19114.6,3.51391], Tmin=(1370.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'CCC[C]=[C]F(8216)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {5,S} {9,S} {10,S}
...
"""),
    E0 = (264.758,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,167,640,1190,341.12,341.122],'cm^-1')),
        HinderedRotor(inertia=(0.00144868,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0767666,'amu*angstrom^2'), symmetry=1, barrier=(6.33913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0767682,'amu*angstrom^2'), symmetry=1, barrier=(6.33913,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69526,0.0477698,-3.19962e-05,1.09675e-08,-1.55474e-12,31928.1,23.9056], Tmin=(100,'K'), Tmax=(1595.18,'K')), NASAPolynomial(coeffs=[10.9609,0.0245356,-1.01483e-05,1.83668e-09,-1.23735e-13,28972,-25.1228], Tmin=(1595.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=[C]CCCF(8217)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {5,S} {9,S} {10,S}
...
"""),
    E0 = (255.8,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,528,1116,1182,1331,1402,1494,3075,3110,1685,370,3120,650,792.5,1650,302.988,302.99],'cm^-1')),
        HinderedRotor(inertia=(0.191483,'amu*angstrom^2'), symmetry=1, barrier=(12.4745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191492,'amu*angstrom^2'), symmetry=1, barrier=(12.4745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191489,'amu*angstrom^2'), symmetry=1, barrier=(12.4745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69593,0.0530073,-4.40763e-05,2.05155e-08,-4.11263e-12,30846.6,22.4115], Tmin=(100,'K'), Tmax=(1142.96,'K')), NASAPolynomial(coeffs=[8.41284,0.0295002,-1.3226e-05,2.52111e-09,-1.76719e-13,29311.2,-10.8912], Tmin=(1142.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)CC[CH2](8218)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {9,S} {10,S}
3  C u0 p0 c0 {2,S} {5,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59072,0.051511,-3.91059e-05,1.57545e-08,-2.64824e-12,25911,23.4774], Tmin=(100,'K'), Tmax=(1368.75,'K')), NASAPolynomial(coeffs=[10.4009,0.0257642,-1.08902e-05,2.01155e-09,-1.38102e-13,23499.2,-21.792], Tmin=(1368.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=CF(1084)', '[CH2]C[CH2](937)'],
    products = ['[CH2]CC[C]=CF(7442)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=[C]CCCF(8217)'],
    products = ['[CH2]CC[C]=CF(7442)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(180.06,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC[C]=CF(7442)'],
    products = ['[CH]=C(F)CC[CH2](8218)'],
