...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(230)', '[CH2]C1O[C]1F(6072)'],
    products = ['F[CH]CC1O[C]1F(6057)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)[CH]C[CH]F(6076)'],
    products = ['F[CH]CC1O[C]1F(6057)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]CC1=C(F)O1(6077)'],
    products = ['F[CH]CC1O[C]1F(6057)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC=CC1O[C]1F(6078)'],
    products = ['F[CH]CC1O[C]1F(6057)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C1O[C]1F(6072)'],
    products = ['F[CH]CC1O[C]1F(6057)'],
