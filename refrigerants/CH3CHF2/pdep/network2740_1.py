...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77919,0.0508301,-5.35484e-05,3.10536e-08,-7.42431e-12,-65557.3,21.1679], Tmin=(100,'K'), Tmax=(1000.61,'K')), NASAPolynomial(coeffs=[9.09025,0.0216036,-9.73532e-06,1.8626e-09,-1.31e-13,-67020.4,-14.1081], Tmin=(1000.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-545.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFH)"""),
)
...
"""),
    E0 = (-238.466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,360,370,350,293.231,293.329,1459.58],'cm^-1')),
        HinderedRotor(inertia=(0.0915651,'amu*angstrom^2'), symmetry=1, barrier=(5.58873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0915399,'amu*angstrom^2'), symmetry=1, barrier=(5.5885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0915564,'amu*angstrom^2'), symmetry=1, barrier=(5.58881,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56809,0.056475,-6.87482e-05,4.56578e-08,-1.23196e-11,-33279.7,25.8427], Tmin=(100,'K'), Tmax=(898.01,'K')), NASAPolynomial(coeffs=[9.49342,0.0211728,-9.78029e-06,1.88058e-09,-1.32209e-13,-34703.1,-11.5398], Tmin=(898.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCJCO) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]C([O])O(7019)'],
    products = ['[O]C(O)C[CH]F(3526)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C([O])O(7019)'],
    products = ['[O]C(O)C[CH]F(3526)'],
