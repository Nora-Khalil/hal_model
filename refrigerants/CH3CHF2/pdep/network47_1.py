...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][CH]C(=O)OF(311)'],
    products = ['[CH2]C(F)C([O])=O(177)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C([O])=CF(312)'],
    products = ['[CH2]C(F)C([O])=O(177)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction16',
    reactants = ['[O][C]=O(293)', '[CH2][CH]F(233)'],
    products = ['[CH2]C(F)C([O])=O(177)'],
