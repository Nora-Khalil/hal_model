...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(614)', 'CH2OH(33)'],
    products = ['OCC(F)OF(1725)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O[CH]C(F)OF(1746)'],
    products = ['OCC(F)OF(1725)'],
