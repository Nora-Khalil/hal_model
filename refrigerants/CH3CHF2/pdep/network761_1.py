...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](778)', '[CH]C-2(611)'],
    products = ['C[CH]OC[O](2284)'],
    transitionState = 'TS2',
