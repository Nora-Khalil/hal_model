...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O[CH]OC(F)(F)F(5051)'],
    products = ['OC(F)OC(F)(F)F(4770)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)O[C](F)F(2045)'],
    products = ['OC(F)OC(F)(F)F(4770)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'F[CH]OC(F)(F)F(5052)'],
    products = ['OC(F)OC(F)(F)F(4770)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)OC(F)(F)F(5053)'],
    products = ['OC(F)OC(F)(F)F(4770)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[C](F)OC(F)(F)F(5054)'],
    products = ['OC(F)OC(F)(F)F(4770)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=COC(F)(F)F(5055)'],
    products = ['OC(F)OC(F)(F)F(4770)'],
