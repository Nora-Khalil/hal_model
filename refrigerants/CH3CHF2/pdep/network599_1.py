...
reaction(
    label = 'reaction1',
    reactants = ['CO(13)', 'CH3-CHF(63)'],
    products = ['CC(F)[C]=O(1435)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CC(F)[C]=O(1435)'],
    products = ['CC(=O)[CH]F(2079)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', 'O=[C][CH]F(1065)'],
    products = ['CC(F)[C]=O(1435)'],
    transitionState = 'TS9',
