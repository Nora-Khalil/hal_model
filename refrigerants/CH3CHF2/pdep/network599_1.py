...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OCO(1845)'],
    products = ['OCOC(F)F(1728)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(615)', 'CH2OH(33)'],
    products = ['OCOC(F)F(1728)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', '[CH2]OC(F)F(1847)'],
    products = ['OCOC(F)F(1728)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[CH]OC(F)F(1849)'],
    products = ['OCOC(F)F(1728)'],
    transitionState = 'TS9',
