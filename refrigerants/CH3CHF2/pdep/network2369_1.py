...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.243162,'amu*angstrom^2'), symmetry=1, barrier=(5.59077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09621,'amu*angstrom^2'), symmetry=1, barrier=(25.2039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242552,'amu*angstrom^2'), symmetry=1, barrier=(5.57675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.21082,'amu*angstrom^2'), symmetry=1, barrier=(50.8311,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.292974,0.0895079,-0.000130173,1.06058e-07,-3.55576e-11,-61384.9,30.4471], Tmin=(100,'K'), Tmax=(724.124,'K')), NASAPolynomial(coeffs=[9.99396,0.0359215,-1.91722e-05,3.86713e-09,-2.77218e-13,-62789.9,-13.2234], Tmin=(724.124,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-511.431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CJCOOH)"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.594769,0.0810471,-0.000100252,6.63497e-08,-1.79594e-11,-100705,28.1842], Tmin=(100,'K'), Tmax=(890.593,'K')), NASAPolynomial(coeffs=[11.749,0.0309498,-1.58751e-05,3.18907e-09,-2.29651e-13,-102692,-24.3361], Tmin=(890.593,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-838.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(COCsFO) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.338796,'amu*angstrom^2'), symmetry=1, barrier=(7.78958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162066,'amu*angstrom^2'), symmetry=1, barrier=(3.72622,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.30988,'amu*angstrom^2'), symmetry=1, barrier=(53.1087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65601,0.0606434,-6.61953e-05,1.22191e-08,2.35303e-11,-54792.4,24.4955], Tmin=(100,'K'), Tmax=(509.994,'K')), NASAPolynomial(coeffs=[7.69528,0.0282676,-1.50648e-05,3.02022e-09,-2.15164e-13,-55603.3,-2.48528], Tmin=(509.994,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-456.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    E0 = (-277.178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,223,363,546,575,694,1179,1410,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,180,180,1571.66],'cm^-1')),
        HinderedRotor(inertia=(0.00267015,'amu*angstrom^2'), symmetry=1, barrier=(4.67775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81494,'amu*angstrom^2'), symmetry=1, barrier=(41.7291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204262,'amu*angstrom^2'), symmetry=1, barrier=(4.69637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81445,'amu*angstrom^2'), symmetry=1, barrier=(41.7178,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.500929,0.0868309,-0.000121457,8.37329e-08,-1.86347e-11,-33220.3,28.7484], Tmin=(100,'K'), Tmax=(588.218,'K')), NASAPolynomial(coeffs=[10.1862,0.0336963,-1.84159e-05,3.73396e-09,-2.67968e-13,-34579.9,-14.7096], Tmin=(588.218,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'F[C]1CCC(F)(F)OO1(6221)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.733925,0.0596453,-2.24124e-05,-2.42504e-08,1.71849e-11,-77810.7,22.3753], Tmin=(100,'K'), Tmax=(916.297,'K')), NASAPolynomial(coeffs=[18.0826,0.0160932,-3.7987e-06,5.36615e-10,-3.57243e-14,-82340.9,-67.1773], Tmin=(916.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-648.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCFHO) + ring(12dioxane) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C1(F)CC(F)(F)OO1(6222)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.393529,0.0664064,-3.39424e-05,-1.7628e-08,1.60137e-11,-78172.8,23.8723], Tmin=(100,'K'), Tmax=(916.08,'K')), NASAPolynomial(coeffs=[20.4853,0.0129359,-2.48507e-06,3.02393e-10,-2.02561e-14,-83291.4,-79.1438], Tmin=(916.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-651.145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(Cs-CsCsHH) + group(CsCFFO) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CJCOOH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.294663,'amu*angstrom^2'), symmetry=1, barrier=(6.77488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.296292,'amu*angstrom^2'), symmetry=1, barrier=(6.81234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70622,'amu*angstrom^2'), symmetry=1, barrier=(39.2294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03863,'amu*angstrom^2'), symmetry=1, barrier=(23.8802,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.816851,0.0760644,-9.98676e-05,7.09818e-08,-2.06109e-11,-10292,30.2931], Tmin=(100,'K'), Tmax=(833.557,'K')), NASAPolynomial(coeffs=[10.6646,0.0288082,-1.48299e-05,2.9703e-09,-2.13059e-13,-11933.7,-15.4237], Tmin=(833.557,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.4812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCOOH) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.250087,'amu*angstrom^2'), symmetry=1, barrier=(5.75,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56927,'amu*angstrom^2'), symmetry=1, barrier=(36.0807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251429,'amu*angstrom^2'), symmetry=1, barrier=(5.78084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57633,'amu*angstrom^2'), symmetry=1, barrier=(36.2429,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00807421,0.0965227,-0.000156499,1.35316e-07,-4.68768e-11,-29809,31.6276], Tmin=(100,'K'), Tmax=(751.036,'K')), NASAPolynomial(coeffs=[11.3362,0.0314548,-1.7258e-05,3.47625e-09,-2.47348e-13,-31381.9,-18.9812], Tmin=(751.036,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CJCOOH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.39964,'amu*angstrom^2'), symmetry=1, barrier=(32.1805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3993,'amu*angstrom^2'), symmetry=1, barrier=(32.1726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39983,'amu*angstrom^2'), symmetry=1, barrier=(32.1849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39973,'amu*angstrom^2'), symmetry=1, barrier=(32.1826,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.58379,0.0808078,-0.000109406,7.5432e-08,-2.07727e-11,-11272.7,25.6094], Tmin=(100,'K'), Tmax=(884.609,'K')), NASAPolynomial(coeffs=[13.1892,0.0238088,-1.27548e-05,2.59295e-09,-1.87551e-13,-13502.9,-33.6591], Tmin=(884.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.7088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsCFFO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJCOOH)"""),
)

species(
    label = '[CH]=C(F)OOC(C)(F)F(6226)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.274361,'amu*angstrom^2'), symmetry=1, barrier=(6.3081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50793,'amu*angstrom^2'), symmetry=1, barrier=(34.6703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274214,'amu*angstrom^2'), symmetry=1, barrier=(6.30473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50766,'amu*angstrom^2'), symmetry=1, barrier=(34.6641,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.174331,0.0922869,-0.00013736,1.13948e-07,-3.87515e-11,-55549,28.9865], Tmin=(100,'K'), Tmax=(715.007,'K')), NASAPolynomial(coeffs=[10.2383,0.0359975,-1.92965e-05,3.89082e-09,-2.78542e-13,-56988.5,-16.1925], Tmin=(715.007,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-462.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = 'C=C(F)OO[C](F)CF(6227)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-469.388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,223,363,546,575,694,1179,1410,528,1116,1182,1331,1402,1494,3075,3110,2950,3100,1380,975,1025,1650,1685,370,205.31,207.385],'cm^-1')),
        HinderedRotor(inertia=(1.2019,'amu*angstrom^2'), symmetry=1, barrier=(36.4683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.443365,'amu*angstrom^2'), symmetry=1, barrier=(13.2156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22065,'amu*angstrom^2'), symmetry=1, barrier=(36.4466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.454599,'amu*angstrom^2'), symmetry=1, barrier=(13.2162,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.548489,0.0824685,-0.000103033,6.93533e-08,-1.91489e-11,-56335.7,30.6707], Tmin=(100,'K'), Tmax=(872.818,'K')), NASAPolynomial(coeffs=[11.5213,0.0321807,-1.66081e-05,3.34025e-09,-2.40562e-13,-58251.1,-20.7741], Tmin=(872.818,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-469.388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
    products = ['CH2CFO(79)', 'FC1(F)CO1(3185)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
    products = ['[CH2]C(F)(F)OCC(=O)F(6219)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=C(F)OO[C](F)F(4766)'],
    products = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]C(F)(F)OOC(=C)F(6220)'],
    products = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
    products = ['F[C]1CCC(F)(F)OO1(6221)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
    products = ['[CH2]C1(F)CC(F)(F)OO1(6222)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)(F)OO[C]=C(6223)'],
    products = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C](F)F(3068)', 'C=C(F)O[O](288)'],
    products = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2CF(70)', '[CH2]C(F)(F)O[O](3123)'],
    products = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)OOC([CH2])(F)F(6224)'],
    products = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C#COOC([CH2])(F)F(6225)'],
    products = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)OOC(C)(F)F(6226)'],
    products = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=C(F)OO[C](F)CF(6227)'],
    products = ['[CH2]C(F)(F)OOC(=C)F(6059)'],
...
network(
    label = 'PDepNetwork #2369',
    isomers = [
        '[CH2]C(F)(F)OOC(=C)F(6059)',
    ],
    reactants = [
        ('CH2CFO(79)', 'FC1(F)CO1(3185)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
