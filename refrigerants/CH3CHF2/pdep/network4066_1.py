...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.597985,'amu*angstrom^2'), symmetry=1, barrier=(13.7489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0570399,'amu*angstrom^2'), symmetry=1, barrier=(13.7486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.597972,'amu*angstrom^2'), symmetry=1, barrier=(13.7485,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17186,0.0622164,-5.3489e-05,2.44124e-08,-4.61708e-12,44408.4,26.1872], Tmin=(100,'K'), Tmax=(1236.66,'K')), NASAPolynomial(coeffs=[11.5768,0.0285615,-1.26675e-05,2.40614e-09,-1.6836e-13,41834.9,-26.2208], Tmin=(1236.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC[C]=C(11496)'],
    products = ['[CH]=C(CF)C[C]=C(11754)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C[C]=C(10768)'],
    products = ['[CH]=C(CF)C[C]=C(11754)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(395)', '[CH]C(=C)CF(11860)'],
    products = ['[CH]=C(CF)C[C]=C(11754)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', 'C#CC[C]=C(11376)'],
    products = ['[CH]=C(CF)C[C]=C(11754)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH]=C(CF)CC#C(12067)'],
    products = ['[CH]=C(CF)C[C]=C(11754)'],
