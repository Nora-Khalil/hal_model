...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)[CH]F(6136)'],
    products = ['O=O(143)', 'CHFCHF[Z](59)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)[CH]F(646)'],
    products = ['[O]OC(F)[CH]F(6136)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[O]O[CH]F(283)'],
    products = ['[O]OC(F)[CH]F(6136)'],
    transitionState = 'TS3',
