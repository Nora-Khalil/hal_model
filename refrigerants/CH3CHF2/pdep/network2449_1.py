...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC=[C]C(6349)'],
    products = ['C2H4(30)', 'C#CC(5436)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=C[C]C(6406)'],
    products = ['[CH2]CC=[C]C(6349)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH2](612)', 'C#CC(5436)'],
    products = ['[CH2]CC=[C]C(6349)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH2](612)', '[CH]=[C]C(5437)'],
    products = ['[CH2]CC=[C]C(6349)'],
