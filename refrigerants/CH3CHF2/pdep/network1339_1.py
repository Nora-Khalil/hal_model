...
"""),
    E0 = (-184.838,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,331.416,331.506,331.869,332.035],'cm^-1')),
        HinderedRotor(inertia=(0.196684,'amu*angstrom^2'), symmetry=1, barrier=(15.3415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197254,'amu*angstrom^2'), symmetry=1, barrier=(15.343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0015359,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196623,'amu*angstrom^2'), symmetry=1, barrier=(15.344,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.774924,0.0721715,-7.53005e-05,4.19728e-08,-9.51405e-12,-22115.7,22.5201], Tmin=(100,'K'), Tmax=(1059.69,'K')), NASAPolynomial(coeffs=[12.5652,0.0276673,-1.23046e-05,2.34131e-09,-1.64315e-13,-24614.5,-35.0446], Tmin=(1059.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72432,0.0551536,-3.78248e-05,1.34247e-08,-2.07747e-12,-43014.3,21.2742], Tmin=(100,'K'), Tmax=(1377.12,'K')), NASAPolynomial(coeffs=[8.38354,0.0358112,-1.67566e-05,3.22556e-09,-2.25945e-13,-44848.4,-12.9837], Tmin=(1377.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-358.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)

species(
    label = 'CCOC(=O)CF(3774)',
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67822,0.0511538,-3.02816e-05,8.40474e-09,-9.37268e-13,-75370.8,23.0322], Tmin=(100,'K'), Tmax=(1970.89,'K')), NASAPolynomial(coeffs=[13.6753,0.0268049,-1.17499e-05,2.13617e-09,-1.4211e-13,-80099.7,-42.9863], Tmin=(1970.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-627.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (54.2372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,356.91,359.589,361.49],'cm^-1')),
        HinderedRotor(inertia=(0.174043,'amu*angstrom^2'), symmetry=1, barrier=(15.8624,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171276,'amu*angstrom^2'), symmetry=1, barrier=(15.8495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17023,'amu*angstrom^2'), symmetry=1, barrier=(15.8571,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75267,0.0394726,-4.32779e-06,-2.60645e-08,1.38948e-11,6613.16,19.8787], Tmin=(100,'K'), Tmax=(956.048,'K')), NASAPolynomial(coeffs=[13.1788,0.0158163,-5.10145e-06,8.95804e-10,-6.3951e-14,3324.71,-40.5041], Tmin=(956.048,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.2372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (9.08983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,350,440,435,1725,2950,3100,1380,975,1025,1650,360.058,360.058,360.058,360.059],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.341435,0.0823235,-0.000104724,6.7825e-08,-1.72942e-11,1223.48,23.5513], Tmin=(100,'K'), Tmax=(961.386,'K')), NASAPolynomial(coeffs=[15.0078,0.0213022,-9.5162e-06,1.80411e-09,-1.2607e-13,-1596.54,-46.6277], Tmin=(961.386,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.08983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]COC(=C)OF(3781)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (26.7515,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,732.885,911.15,911.154],'cm^-1')),
        HinderedRotor(inertia=(0.564072,'amu*angstrom^2'), symmetry=1, barrier=(12.9691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.88192,'amu*angstrom^2'), symmetry=1, barrier=(20.2771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.564071,'amu*angstrom^2'), symmetry=1, barrier=(12.9691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.564063,'amu*angstrom^2'), symmetry=1, barrier=(12.9689,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.58864,0.0777144,-9.60972e-05,6.22952e-08,-1.61136e-11,3338.06,23.8259], Tmin=(100,'K'), Tmax=(942.62,'K')), NASAPolynomial(coeffs=[13.195,0.0242198,-1.09714e-05,2.09048e-09,-1.46354e-13,961.432,-36.2478], Tmin=(942.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.7515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJCO)"""),
)

species(
    label = '[CH]=C(OF)OCC(3782)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {1,S} {6,S}
...
"""),
    E0 = (62.2586,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,271.78,271.781,271.781],'cm^-1')),
        HinderedRotor(inertia=(0.00228225,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302061,'amu*angstrom^2'), symmetry=1, barrier=(15.8328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302059,'amu*angstrom^2'), symmetry=1, barrier=(15.8328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302063,'amu*angstrom^2'), symmetry=1, barrier=(15.8328,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.685268,0.0758226,-9.21613e-05,5.93439e-08,-1.53369e-11,7604.89,23.2492], Tmin=(100,'K'), Tmax=(940.964,'K')), NASAPolynomial(coeffs=[12.5863,0.0252301,-1.15091e-05,2.20071e-09,-1.54391e-13,5365.26,-33.4421], Tmin=(940.964,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.2586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C(OF)OCC(3783)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {1,S} {5,S}
4  C u0 p0 c0 {2,S} {6,S} {8,S} {9,S}
5  C u0 p0 c0 {2,S} {3,S} {7,S} {13,S}
6  C u0 p0 c0 {4,S} {10,S} {11,S} {12,S}
7  C u0 p1 c0 {5,S} {14,S}
8  H u0 p0 c0 {4,S}
9  H u0 p0 c0 {4,S}
10 H u0 p0 c0 {6,S}
11 H u0 p0 c0 {6,S}
...
"""),
    E0 = (112.004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08102,0.0736021,-7.92325e-05,2.92184e-08,1.03915e-11,13566.9,25.021], Tmin=(100,'K'), Tmax=(544.102,'K')), NASAPolynomial(coeffs=[7.99718,0.0371845,-1.86075e-05,3.66879e-09,-2.60109e-13,12600.7,-6.09859], Tmin=(544.102,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(OF)OCC(3763)'],
    products = ['HF(38)', 'CH2CO(28)', 'CH3CHO(36)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(24.599,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C(OC)OF(1721)'],
    products = ['C=C(OF)OCC(3763)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C(O)OF(1757)', 'C2H4(30)'],
    products = ['C=C(OF)OCC(3763)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C(OF)OCC(3763)'],
    products = ['CCCC(=O)OF(3773)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(87.0027,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction5',
    reactants = ['C=C(OF)OCC(3763)'],
    products = ['CCOC(=O)CF(3774)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=O)OCC(3779)'],
    products = ['C=C(OF)OCC(3763)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(=O)OF(1447)', 'C2H5(32)'],
    products = ['C=C(OF)OCC(3763)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(4.41876,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction12',
    reactants = ['C=[C]OF(202)', 'CC[O](853)'],
    products = ['C=C(OF)OCC(3763)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(126)', 'C=[C]OCC(2612)'],
    products = ['C=C(OF)OCC(3763)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', '[CH2]OC(=C)OF(1763)'],
    products = ['C=C(OF)OCC(3763)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=C(OF)O[CH]C(3780)'],
    products = ['C=C(OF)OCC(3763)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]COC(=C)OF(3781)'],
    products = ['C=C(OF)OCC(3763)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)OCC(3782)'],
    products = ['C=C(OF)OCC(3763)'],
