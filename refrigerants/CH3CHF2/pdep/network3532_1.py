...
species(
    label = 'FC(F)[CH]C1(F)[CH]O1(10308)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
species(
    label = 'FC(F)(F)C[C]1[CH]O1(10310)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)CC1(F)[CH]O1(10247)'],
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(2927)', '[CH2]C1(F)[CH]O1(9553)'],
    products = ['F[C](F)CC1(F)[CH]O1(10247)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C=C(F)C[C](F)F(10304)'],
    products = ['F[C](F)CC1(F)[CH]O1(10247)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[C](F)CC1=CO1(10305)'],
    products = ['F[C](F)CC1(F)[CH]O1(10247)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'FC(F)=CC1(F)[CH]O1(10306)'],
    products = ['F[C](F)CC1(F)[CH]O1(10247)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[C](F)C=C1[CH]O1(10307)'],
    products = ['F[C](F)CC1(F)[CH]O1(10247)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]C1(F)[CH]O1(9553)'],
    products = ['F[C](F)CC1(F)[CH]O1(10247)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)CC1(F)[CH]O1(10247)'],
    products = ['FC(F)[CH]C1(F)[CH]O1(10308)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)CC1(F)[CH]O1(10247)'],
    products = ['F[C](F)[CH]C1(F)CO1(10309)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)CC1(F)[CH]O1(10247)'],
    products = ['FC(F)(F)C[C]1[CH]O1(10310)'],
