...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3025)', '[O]C[C](F)F(3183)'],
    products = ['F[C](F)CO[C](F)F(4785)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3025)', '[CH2]O[C](F)F(3213)'],
    products = ['F[C](F)CO[C](F)F(4785)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)OC=C(F)F(4671)'],
    products = ['F[C](F)CO[C](F)F(4785)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH2]O[C](F)F(3213)'],
    products = ['F[C](F)CO[C](F)F(4785)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[O]C[C](F)F(3183)'],
    products = ['F[C](F)CO[C](F)F(4785)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)CO[C](F)F(4785)'],
    products = ['F[C](F)O[CH]C(F)F(4878)'],
