...
"""),
    E0 = (-475.513,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,493,600,700,1144,1293,180,180,1136.42,1138.03],'cm^-1')),
        HinderedRotor(inertia=(0.265101,'amu*angstrom^2'), symmetry=1, barrier=(6.09519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265014,'amu*angstrom^2'), symmetry=1, barrier=(6.0932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265165,'amu*angstrom^2'), symmetry=1, barrier=(6.09666,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39217,0.0646361,-0.000107088,9.94401e-08,-3.64545e-11,-57104.2,25.5349], Tmin=(100,'K'), Tmax=(797.909,'K')), NASAPolynomial(coeffs=[6.37257,0.0274942,-1.43774e-05,2.85606e-09,-2.01423e-13,-57511.4,5.06032], Tmin=(797.909,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-475.513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3025)', '[O]C[CH]F(140)'],
    products = ['F[CH]CO[C](F)F(4754)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]O[C](F)F(3213)'],
    products = ['F[CH]CO[C](F)F(4754)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC=CO[C](F)F(4595)'],
    products = ['F[CH]CO[C](F)F(4754)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[CH2]O[C](F)F(3213)'],
    products = ['F[CH]CO[C](F)F(4754)'],
