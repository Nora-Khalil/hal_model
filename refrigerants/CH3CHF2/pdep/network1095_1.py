...
reaction(
    label = 'reaction3',
    reactants = ['C#COF(1067)', 'C[C]F(124)'],
    products = ['C#COC(C)(F)F(3030)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H(22)', 'CC([O])(F)F(1120)'],
    products = ['C#COC(C)(F)F(3030)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'C#CO[C](F)F(3475)'],
    products = ['C#COC(C)(F)F(3030)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#COC([CH2])(F)F(3010)'],
    products = ['C#COC(C)(F)F(3030)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[C]#COC(C)(F)F(3476)'],
    products = ['C#COC(C)(F)F(3030)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'C#COC(=C)F(1641)'],
    products = ['C#COC(C)(F)F(3030)'],
