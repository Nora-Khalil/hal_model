...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3025)', '[CH]C=C(261)'],
    products = ['[CH]=CC[C](F)F(3109)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=CC=C(F)F(3198)'],
    products = ['[CH]=CC[C](F)F(3109)'],
    transitionState = 'TS7',
