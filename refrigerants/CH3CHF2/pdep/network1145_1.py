...
species(
    label = '[CH2]C(F)(F)C([CH2])(F)F(3075)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.243993,0.0884734,-0.000129914,9.82449e-08,-2.9398e-11,-71587.4,25.4496], Tmin=(100,'K'), Tmax=(820.02,'K')), NASAPolynomial(coeffs=[13.4628,0.0239952,-1.19726e-05,2.36349e-09,-1.67508e-13,-73755.4,-35.7009], Tmin=(820.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'F[C](F)CC[C](F)F(3077)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.828861,0.0765433,-0.000118178,1.02718e-07,-3.56361e-11,-74192.1,27.1806], Tmin=(100,'K'), Tmax=(804.015,'K')), NASAPolynomial(coeffs=[8.30644,0.0302239,-1.47518e-05,2.85478e-09,-1.98745e-13,-75099.8,-5.43051], Tmin=(804.015,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-617.763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[C](F)F(3076)'],
    products = ['CH2CF2(57)', 'CH2CF2(57)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C[C](F)F(3076)'],
    products = ['[CH2]C(F)(F)C([CH2])(F)F(3075)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)CC[C](F)F(3077)'],
    products = ['[CH2]C(F)(F)C[C](F)F(3076)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(2927)', '[CH2]C([CH2])(F)F(3089)'],
    products = ['[CH2]C(F)(F)C[C](F)F(3076)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C[C](F)F(3193)'],
    products = ['[CH2]C(F)(F)C[C](F)F(3076)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CF2(57)', '[CH2][C](F)F(2970)'],
    products = ['[CH2]C(F)(F)C[C](F)F(3076)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C(F)F(3196)'],
    products = ['[CH2]C(F)(F)C[C](F)F(3076)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C[C](F)F(3056)'],
    products = ['[CH2]C(F)(F)C[C](F)F(3076)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C](F)F(2970)', '[CH2][C](F)F(2970)'],
    products = ['[CH2]C(F)(F)C[C](F)F(3076)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(F)=C[C](F)F(3197)'],
    products = ['[CH2]C(F)(F)C[C](F)F(3076)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(43)', '[CH2]C([CH2])(F)F(3089)'],
    products = ['[CH2]C(F)(F)C[C](F)F(3076)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)[CH]C(F)F(3198)'],
    products = ['[CH2]C(F)(F)C[C](F)F(3076)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C[C](F)F(3076)'],
    products = ['[CH2][C](F)CC(F)(F)F(3200)'],
