...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.663834,0.0817614,-0.000106806,7.21365e-08,-1.65788e-11,-44618.1,24.3019], Tmin=(100,'K'), Tmax=(608.569,'K')), NASAPolynomial(coeffs=[9.40682,0.0349819,-1.78443e-05,3.53617e-09,-2.51191e-13,-45880.2,-15.1616], Tmin=(608.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJC(C)C=O)"""),
)
...
"""),
    E0 = (68.2508,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,229.264,3050.24],'cm^-1')),
        HinderedRotor(inertia=(1.11909,'amu*angstrom^2'), symmetry=1, barrier=(40.9059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09368,'amu*angstrom^2'), symmetry=1, barrier=(40.9632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141856,'amu*angstrom^2'), symmetry=1, barrier=(5.29847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149487,'amu*angstrom^2'), symmetry=1, barrier=(5.29507,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.282483,0.0908606,-0.000147741,1.31162e-07,-4.56252e-11,8333.78,26.1246], Tmin=(100,'K'), Tmax=(831.85,'K')), NASAPolynomial(coeffs=[8.67667,0.0344551,-1.71034e-05,3.28351e-09,-2.26225e-13,7492.25,-9.49105], Tmin=(831.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.2508,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(F)=C(OC)OF(9770)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-219.088,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,271,519,563,612,1379,3000,3100,440,815,1455,1000,284.561,284.731,2473.59],'cm^-1')),
        HinderedRotor(inertia=(0.115163,'amu*angstrom^2'), symmetry=1, barrier=(6.62539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115332,'amu*angstrom^2'), symmetry=1, barrier=(6.63143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589653,'amu*angstrom^2'), symmetry=1, barrier=(33.8945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589502,'amu*angstrom^2'), symmetry=1, barrier=(33.8898,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.30417,0.0887077,-0.000136603,1.16998e-07,-4.02781e-11,-26224.3,25.4529], Tmin=(100,'K'), Tmax=(785.048,'K')), NASAPolynomial(coeffs=[9.67922,0.033506,-1.69247e-05,3.30528e-09,-2.31314e-13,-27467.2,-16.0485], Tmin=(785.048,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.827155,0.0760605,-9.77632e-05,6.95221e-08,-2.04149e-11,-16032.5,24.3462], Tmin=(100,'K'), Tmax=(821.213,'K')), NASAPolynomial(coeffs=[10.0101,0.0313354,-1.60762e-05,3.21324e-09,-2.30234e-13,-17540.8,-18.1481], Tmin=(821.213,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-134.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC1(F)CO[C]1OF(9772)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30847,0.0569153,-4.19654e-05,1.48768e-08,-2.12767e-12,-24008.2,25.279], Tmin=(100,'K'), Tmax=(1604.87,'K')), NASAPolynomial(coeffs=[14.4063,0.0242703,-1.14536e-05,2.20223e-09,-1.53282e-13,-28212.3,-44.1064], Tmin=(1604.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCCCF) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cs-O2s-Cs-Cs(F)) + radical(Cs_P)"""),
)

species(
    label = 'CC1(F)CC1([O])OF(9773)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {6,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.666975,0.0625517,-4.1182e-05,4.37069e-09,3.58151e-12,-22891.5,24.1622], Tmin=(100,'K'), Tmax=(1047.06,'K')), NASAPolynomial(coeffs=[17.2393,0.0193074,-7.97701e-06,1.53166e-09,-1.1066e-13,-27461.9,-61.8046], Tmin=(1047.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCCF) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cs-Cs(F)(C)-Cs) + radical(CC(C)(O)OJ)"""),
)
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59351,0.0576281,-5.49807e-05,2.98772e-08,-7.04471e-12,-32.4742,22.8696], Tmin=(100,'K'), Tmax=(982.693,'K')), NASAPolynomial(coeffs=[7.96056,0.0317113,-1.54205e-05,3.03911e-09,-2.16973e-13,-1283.84,-7.73652], Tmin=(982.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.957929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ(C)CO) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C(C)(F)C([O])=O(9776)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u1 p2 c0 {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-280.712,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,180,180,180,1174.13,1174.83],'cm^-1')),
        HinderedRotor(inertia=(0.0408447,'amu*angstrom^2'), symmetry=1, barrier=(2.52398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12129,'amu*angstrom^2'), symmetry=1, barrier=(48.7725,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12224,'amu*angstrom^2'), symmetry=1, barrier=(48.7945,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16826,0.0713827,-0.000113568,1.08912e-07,-4.13725e-11,-33668.8,22.442], Tmin=(100,'K'), Tmax=(807.61,'K')), NASAPolynomial(coeffs=[4.0197,0.0391423,-2.00366e-05,3.92632e-09,-2.74812e-13,-33538.5,12.9527], Tmin=(807.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CJC(C)C=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.826603,'amu*angstrom^2'), symmetry=1, barrier=(19.0052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.827202,'amu*angstrom^2'), symmetry=1, barrier=(19.019,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.050495,0.0963859,-0.000163038,1.44999e-07,-5.0379e-11,-19278.7,26.1174], Tmin=(100,'K'), Tmax=(818.912,'K')), NASAPolynomial(coeffs=[10.2273,0.0315617,-1.66129e-05,3.25699e-09,-2.26805e-13,-20438.7,-17.8523], Tmin=(818.912,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJC(C)C=O) + radical(CJC(C)C=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C)(F)C(=O)OF(9702)'],
...
reaction(
    ...
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['FOF(499)', 'C=C(C)[C]=O(9768)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C)=C(OF)OF(9769)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)=C(OC)OF(9770)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]C(C)(F)C(=O)OF-2(9771)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=C(C)C(=O)OF(9774)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'C=C(F)C(=O)OF(3443)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2][C](C)C(=O)OF(9775)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[CH2]C(C)(F)C([O])=O(9776)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(126)', '[CH2]C(C)(F)[C]=O(9777)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(19)', '[CH2][C](F)C(=O)OF(3250)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]OF(167)', '[CH2][C](C)F(9483)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH2]C([CH2])(F)C(=O)OF(9778)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', '[CH2]C(=C)C(=O)OF(8746)'],
    products = ['[CH2]C(C)(F)C(=O)OF(9702)'],
