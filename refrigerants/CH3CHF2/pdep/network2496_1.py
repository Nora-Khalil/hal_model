...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.92997,'amu*angstrom^2'), symmetry=1, barrier=(44.3738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.93074,'amu*angstrom^2'), symmetry=1, barrier=(44.3915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92942,'amu*angstrom^2'), symmetry=1, barrier=(44.3612,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0653,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89616,0.0408888,-3.20126e-05,1.1255e-08,-1.12591e-12,10788.1,17.641], Tmin=(100,'K'), Tmax=(1111.04,'K')), NASAPolynomial(coeffs=[11.0723,0.0146667,-5.81025e-06,1.05281e-09,-7.24087e-14,8328.49,-29.4876], Tmin=(1111.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.0296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CtHHH) + group(Cds-OdOsH) + group(Ct-CtCs) + group(Ct-CtOs) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (147.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,1670,1700,300,440,344.108,344.304],'cm^-1')),
        HinderedRotor(inertia=(0.113626,'amu*angstrom^2'), symmetry=1, barrier=(9.54293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113246,'amu*angstrom^2'), symmetry=1, barrier=(9.53617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.306573,'amu*angstrom^2'), symmetry=1, barrier=(25.7575,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12706,0.0452618,-4.80895e-05,3.07226e-08,-8.57888e-12,17787.3,21.2727], Tmin=(100,'K'), Tmax=(840.674,'K')), NASAPolynomial(coeffs=[6.32376,0.0252936,-1.24605e-05,2.46831e-09,-1.76587e-13,17081.7,1.7544], Tmin=(840.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = 'C=[C][CH]OC=O(6629)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70526,0.0306757,-1.26678e-05,8.62069e-10,2.82732e-13,6145.05,20.7052], Tmin=(100,'K'), Tmax=(1873.03,'K')), NASAPolynomial(coeffs=[12.4435,0.0175981,-8.37675e-06,1.53508e-09,-1.00784e-13,1142.98,-36.0022], Tmin=(1873.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.7219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(C=CCJ(O)C) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', 'C[C]=C[O](6464)'],
    products = ['C[C]=CO[C]=O(6327)'],
    transitionState = 'TS2',
