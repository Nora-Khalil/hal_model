...
"""),
    ...
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06861,0.0617593,-4.95567e-05,2.05985e-08,-3.51037e-12,-16275.9,26.5688], Tmin=(100,'K'), Tmax=(1370.1,'K')), NASAPolynomial(coeffs=[12.9051,0.027203,-1.17242e-05,2.18997e-09,-1.51417e-13,-19519.3,-34.2624], Tmin=(1370.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (101.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,615,860,1140,1343,3152,113,247,382,1207,3490,1685,370,540,610,2055,481.882,481.92,481.931,1598.5],'cm^-1')),
        HinderedRotor(inertia=(0.0502263,'amu*angstrom^2'), symmetry=1, barrier=(8.27913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.050233,'amu*angstrom^2'), symmetry=1, barrier=(8.27802,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27158,0.0634491,-6.37452e-05,3.58269e-08,-8.46399e-12,12317.7,26.3251], Tmin=(100,'K'), Tmax=(1000.64,'K')), NASAPolynomial(coeffs=[9.56396,0.0303004,-1.40533e-05,2.71982e-09,-1.92404e-13,10658.2,-13.686], Tmin=(1000.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)
...
"""),
    E0 = (184.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,615,860,1140,1343,3152,1685,370,2175,525,239,401,1367,362.052,362.664,362.815,2234.86],'cm^-1')),
        HinderedRotor(inertia=(0.740896,'amu*angstrom^2'), symmetry=1, barrier=(68.9693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0036853,'amu*angstrom^2'), symmetry=1, barrier=(13.0714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140515,'amu*angstrom^2'), symmetry=1, barrier=(13.0735,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33592,0.0618643,-6.32861e-05,3.77001e-08,-9.51822e-12,22341.1,27.5979], Tmin=(100,'K'), Tmax=(939.021,'K')), NASAPolynomial(coeffs=[8.59243,0.0309532,-1.39081e-05,2.64363e-09,-1.84919e-13,20978.3,-6.95398], Tmin=(939.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cds-CdsCsH) + group(CdCFH) + group(Ct-CtCs) + group(CtCF) + radical(Cdj(Cs-CsHH)(Cd-F1sH))"""),
)
...
"""),
    E0 = (176.969,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,615,860,1140,1343,3152,1685,370,167,640,1190,364.597,364.598,364.599,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0633195,'amu*angstrom^2'), symmetry=1, barrier=(5.97302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.337588,'amu*angstrom^2'), symmetry=1, barrier=(31.8451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137488,'amu*angstrom^2'), symmetry=1, barrier=(12.9695,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13957,0.0638011,-5.58102e-05,2.61851e-08,-5.12001e-12,21386.7,29.4732], Tmin=(100,'K'), Tmax=(1195.19,'K')), NASAPolynomial(coeffs=[11.2199,0.0300651,-1.34707e-05,2.56872e-09,-1.80155e-13,18977.1,-20.9559], Tmin=(1195.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.969,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(CdCFH) + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[CH][C]=CCC=CF(8315)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {5,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.968802,0.0621107,-4.78685e-05,1.84407e-08,-2.87682e-12,6707.73,29.4112], Tmin=(100,'K'), Tmax=(1494.98,'K')), NASAPolynomial(coeffs=[14.6125,0.0256053,-1.12403e-05,2.10675e-09,-1.45344e-13,2628.35,-41.8979], Tmin=(1494.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = 'F[C]=[C]CCC=CF(8316)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  C u0 p0 c0 {4,S} {5,S} {9,S} {10,S}
...
"""),
    E0 = (176.969,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,1685,370,167,640,1190,317.786,319.297,320.41],'cm^-1')),
        HinderedRotor(inertia=(0.124555,'amu*angstrom^2'), symmetry=1, barrier=(9.0768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00168358,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00165409,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.108,'amu'),
...
"""),
    ...
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03582,0.0663272,-6.06154e-05,2.96464e-08,-6.00961e-12,20360.1,29.2236], Tmin=(100,'K'), Tmax=(1160.9,'K')), NASAPolynomial(coeffs=[11.6197,0.0298587,-1.34936e-05,2.58543e-09,-1.81931e-13,17902.8,-23.4165], Tmin=(1160.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH) + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = '[CH]=[C]CCC(F)=CF(8318)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {4,S} {5,S} {9,S} {10,S}
...
"""),
    E0 = (173.269,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,323,467,575,827,1418,194,682,905,1196,1383,3221,1685,370,3120,650,792.5,1650,262.159,262.17],'cm^-1')),
        HinderedRotor(inertia=(0.135462,'amu*angstrom^2'), symmetry=1, barrier=(6.60402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135358,'amu*angstrom^2'), symmetry=1, barrier=(6.60404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135392,'amu*angstrom^2'), symmetry=1, barrier=(6.60391,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.801093,0.0752508,-8.81769e-05,5.86501e-08,-1.62012e-11,20950.3,28.2845], Tmin=(100,'K'), Tmax=(869.901,'K')), NASAPolynomial(coeffs=[9.95648,0.0331521,-1.55844e-05,3.01719e-09,-2.1287e-13,19357.5,-14.6089], Tmin=(869.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1084)', '[CH2]C[C]=CF(4143)'],
    products = ['FC=[C]CC[C]=CF(7525)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC=[C]CC=C=CF(8310)'],
    products = ['FC=[C]CC[C]=CF(7525)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CCC[C]=CF(8311)'],
    products = ['FC=[C]CC[C]=CF(7525)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC#CCC[C]=CF(8312)'],
    products = ['FC=[C]CC[C]=CF(7525)'],
    transitionState = 'TS9',
