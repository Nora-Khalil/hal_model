...
"""),
    E0 = (-240.569,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,194,682,905,1196,1383,3221,615,860,1140,1343,3152,1685,370,184.176,187.402,2266.46],'cm^-1')),
        HinderedRotor(inertia=(0.404294,'amu*angstrom^2'), symmetry=1, barrier=(10.2257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.400107,'amu*angstrom^2'), symmetry=1, barrier=(10.2072,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11696,0.06804,-8.40147e-05,5.8019e-08,-1.64999e-11,-28834,25.3828], Tmin=(100,'K'), Tmax=(848.82,'K')), NASAPolynomial(coeffs=[9.586,0.0281306,-1.34887e-05,2.6279e-09,-1.85826e-13,-30271.7,-14.0873], Tmin=(848.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-240.569,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.484759,'amu*angstrom^2'), symmetry=1, barrier=(11.1456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71653,'amu*angstrom^2'), symmetry=1, barrier=(39.4663,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.956824,0.0699007,-8.99611e-05,6.36996e-08,-1.81569e-11,-8118.38,22.827], Tmin=(100,'K'), Tmax=(856.358,'K')), NASAPolynomial(coeffs=[10.6495,0.0246266,-1.06586e-05,1.96313e-09,-1.33912e-13,-9778.46,-22.4316], Tmin=(856.358,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.3889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CtCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'FC#CCC(F)[CH]F(8261)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-168.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,2175,525,239,401,1367,293.288,293.299,1683.1],'cm^-1')),
        HinderedRotor(inertia=(0.159601,'amu*angstrom^2'), symmetry=1, barrier=(9.74335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159605,'amu*angstrom^2'), symmetry=1, barrier=(9.74339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.918844,'amu*angstrom^2'), symmetry=1, barrier=(56.0887,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.672585,0.0797352,-0.00012277,1.04366e-07,-3.52114e-11,-20110.8,26.1629], Tmin=(100,'K'), Tmax=(824.249,'K')), NASAPolynomial(coeffs=[9.11147,0.0294058,-1.41149e-05,2.68324e-09,-1.84374e-13,-21183.4,-10.9866], Tmin=(824.249,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-168.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CtCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtCs) + group(CtCF) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-181.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,615,860,1140,1343,3152,1685,370,310.435,310.438,310.455,2523.6],'cm^-1')),
        HinderedRotor(inertia=(0.154767,'amu*angstrom^2'), symmetry=1, barrier=(10.585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154763,'amu*angstrom^2'), symmetry=1, barrier=(10.5847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.467761,'amu*angstrom^2'), symmetry=1, barrier=(31.9978,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02448,0.0713055,-9.04602e-05,6.84236e-08,-2.18599e-11,-21707.5,29.0505], Tmin=(100,'K'), Tmax=(752.422,'K')), NASAPolynomial(coeffs=[7.95412,0.0344656,-1.70161e-05,3.34875e-09,-2.37704e-13,-22750.3,-2.4097], Tmin=(752.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(CdCFH) + radical(CsCsCsF1s) + radical(Cdj(Cs-CsHH)(Cd-F1sH))"""),
)
...
"""),
    E0 = (-176.165,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,259,529,569,1128,1321,1390,3140,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,167,640,1190,223.06,223.06,223.06],'cm^-1')),
        HinderedRotor(inertia=(0.00338809,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235502,'amu*angstrom^2'), symmetry=1, barrier=(8.31507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.555773,'amu*angstrom^2'), symmetry=1, barrier=(19.6232,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.659531,0.0791671,-0.000104982,7.73852e-08,-2.33255e-11,-21072.6,27.4041], Tmin=(100,'K'), Tmax=(804.921,'K')), NASAPolynomial(coeffs=[10.3646,0.0309398,-1.51117e-05,2.95382e-09,-2.08697e-13,-22635.1,-17.3116], Tmin=(804.921,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(Cs-F1sCsH)(F1s)(H)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.58191,0.0822466,-0.000124062,1.06915e-07,-3.71916e-11,-28245,29.1877], Tmin=(100,'K'), Tmax=(790.569,'K')), NASAPolynomial(coeffs=[8.47463,0.0340323,-1.68712e-05,3.27547e-09,-2.28627e-13,-29234.2,-5.39884], Tmin=(790.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(CdCFH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'F[C]=[C]CC(F)CF(8266)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-121.689,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,1685,370,167,640,1190,385.695,385.696,385.696],'cm^-1')),
        HinderedRotor(inertia=(0.0920131,'amu*angstrom^2'), symmetry=1, barrier=(9.7134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0920144,'amu*angstrom^2'), symmetry=1, barrier=(9.71339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216832,'amu*angstrom^2'), symmetry=1, barrier=(22.8897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07621,0.0687351,-7.41686e-05,4.40103e-08,-1.0874e-11,-14534.2,27.3471], Tmin=(100,'K'), Tmax=(963.403,'K')), NASAPolynomial(coeffs=[10.2638,0.0305875,-1.47717e-05,2.90683e-09,-2.07429e-13,-16304.4,-16.6348], Tmin=(963.403,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'FC=[C]C[CH]C(F)F(7674)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38425,0.0632386,-6.55751e-05,3.96601e-08,-1.04037e-11,-24104.4,28.8316], Tmin=(100,'K'), Tmax=(892.595,'K')), NASAPolynomial(coeffs=[7.83468,0.0343326,-1.69994e-05,3.38005e-09,-2.42467e-13,-25256,-1.55515], Tmin=(892.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cs_S) + radical(Cdj(Cs-CsHH)(Cd-F1sH))"""),
)

species(
    label = '[CH]=[C]CC(F)C(F)F(8267)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-158.098,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,1685,370,3120,650,792.5,1650,251.935,255.287],'cm^-1')),
        HinderedRotor(inertia=(0.239828,'amu*angstrom^2'), symmetry=1, barrier=(11.161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24278,'amu*angstrom^2'), symmetry=1, barrier=(11.1683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.442615,'amu*angstrom^2'), symmetry=1, barrier=(20.1851,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.76188,0.0763465,-9.49947e-05,6.49436e-08,-1.81754e-11,-18902.7,26.929], Tmin=(100,'K'), Tmax=(863.753,'K')), NASAPolynomial(coeffs=[10.7647,0.0300221,-1.45443e-05,2.84769e-09,-2.01993e-13,-20630.6,-19.8636], Tmin=(863.753,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)CC(F)[CH]F(8268)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.544848,0.0818381,-0.00011035,8.16231e-08,-2.45548e-11,-22098.8,27.1925], Tmin=(100,'K'), Tmax=(808.013,'K')), NASAPolynomial(coeffs=[10.9215,0.0304673,-1.49814e-05,2.93437e-09,-2.07475e-13,-23775.6,-20.6565], Tmin=(808.013,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Csj(Cs-F1sCsH)(F1s)(H)) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', 'F[CH]C[C]=CF(4001)'],
    products = ['F[CH]C(F)C[C]=CF(7517)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=CF(1084)', '[CH2]C(F)[CH]F(252)'],
    products = ['F[CH]C(F)C[C]=CF(7517)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=[C]CC=CF(7537)'],
    products = ['F[CH]C(F)C[C]=CF(7517)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC=[C]CC(F)=CF(8258)'],
    products = ['F[CH]C(F)C[C]=CF(7517)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C#CCC(F)[CH]F(8260)'],
    products = ['F[CH]C(F)C[C]=CF(7517)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FC#CCC(F)[CH]F(8261)'],
    products = ['F[CH]C(F)C[C]=CF(7517)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'FC=[C][CH]C=CF(8093)'],
    products = ['F[CH]C(F)C[C]=CF(7517)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', 'F[CH]C[C]=CF(4001)'],
    products = ['F[CH]C(F)C[C]=CF(7517)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=[C]CC(F)C(F)F(8267)'],
    products = ['F[CH]C(F)C[C]=CF(7517)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F[CH]C(F)C[C]=CF(7517)'],
    products = ['[CH]=C(F)CC(F)[CH]F(8268)'],
...
network(
    label = 'PDepNetwork #3029',
    isomers = [
        'F[CH]C(F)C[C]=CF(7517)',
    ],
    reactants = [
