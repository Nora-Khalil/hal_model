...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=C=C[C]F(4244)'],
    products = ['[O]C(=O)C=[C]F(4092)'],
    transitionState = 'TS2',
