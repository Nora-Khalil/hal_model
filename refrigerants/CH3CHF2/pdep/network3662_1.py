...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0218296,'amu*angstrom^2'), symmetry=1, barrier=(20.8981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00482569,'amu*angstrom^2'), symmetry=1, barrier=(4.63078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14288,'amu*angstrom^2'), symmetry=1, barrier=(26.2772,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8404,0.0385415,-1.57427e-06,-2.30778e-08,1.09544e-11,36307.8,19.9608], Tmin=(100,'K'), Tmax=(1006.88,'K')), NASAPolynomial(coeffs=[10.755,0.0232793,-8.85952e-06,1.62369e-09,-1.14274e-13,33491.1,-28.1809], Tmin=(1006.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(Allyl_P)"""),
)
...
"""),
    E0 = (402.786,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0010817,'amu*angstrom^2'), symmetry=1, barrier=(9.38503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0135617,'amu*angstrom^2'), symmetry=1, barrier=(15.8588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34997,'amu*angstrom^2'), symmetry=1, barrier=(31.0385,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78954,0.0426337,-2.45661e-05,6.97987e-09,-8.00793e-13,48528.7,22.5411], Tmin=(100,'K'), Tmax=(1973.17,'K')), NASAPolynomial(coeffs=[12.6483,0.0206211,-7.83233e-06,1.32617e-09,-8.44788e-14,44243.4,-37.2263], Tmin=(1973.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(402.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69524,0.0150132,5.93538e-05,-7.98928e-08,2.92892e-11,14012.3,14.2564], Tmin=(100,'K'), Tmax=(993.368,'K')), NASAPolynomial(coeffs=[8.42296,0.0265669,-1.03656e-05,1.97845e-09,-1.44158e-13,11166.4,-21.9354], Tmin=(993.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40945,0.0278203,1.28883e-05,-2.76674e-08,1.02201e-11,45302.4,19.7557], Tmin=(100,'K'), Tmax=(1070.57,'K')), NASAPolynomial(coeffs=[6.7095,0.0284927,-1.15068e-05,2.12863e-09,-1.48344e-13,43422.5,-5.76274], Tmin=(1070.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2][C]1CCC1(11367)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {6,S} {7,S}
2  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {4,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69827,0.0195563,3.75739e-05,-5.34688e-08,1.95836e-11,44742.7,18.7255], Tmin=(100,'K'), Tmax=(992.884,'K')), NASAPolynomial(coeffs=[5.92215,0.0291192,-1.09418e-05,1.98195e-09,-1.38237e-13,42991,-2.40244], Tmin=(992.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1([CH2])CC1(11368)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {4,S} {5,S}
2  C u0 p0 c0 {1,S} {3,S} {6,S} {7,S}
3  C u0 p0 c0 {1,S} {2,S} {8,S} {9,S}
4  C u1 p0 c0 {1,S} {11,S} {12,S}
5  C u1 p0 c0 {1,S} {10,S} {13,S}
6  H u0 p0 c0 {2,S}
7  H u0 p0 c0 {2,S}
8  H u0 p0 c0 {3,S}
9  H u0 p0 c0 {3,S}
...
species(
    label = '[CH2]C=C([CH2])C(6657)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {6,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {3,D} {4,S}
3  C u0 p0 c0 {2,D} {5,S} {9,S}
4  C u1 p0 c0 {2,S} {10,S} {13,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.135255,'amu*angstrom^2'), symmetry=1, barrier=(3.10978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135253,'amu*angstrom^2'), symmetry=1, barrier=(3.10973,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (315.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,409.969,412.46,414.524,417.546],'cm^-1')),
        HinderedRotor(inertia=(0.430306,'amu*angstrom^2'), symmetry=1, barrier=(51.5175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.432012,'amu*angstrom^2'), symmetry=1, barrier=(51.5042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433063,'amu*angstrom^2'), symmetry=1, barrier=(51.4189,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78354,0.0404359,1.1222e-07,-2.19975e-08,9.51831e-12,37985.6,19.9011], Tmin=(100,'K'), Tmax=(1047.51,'K')), NASAPolynomial(coeffs=[8.84378,0.0313359,-1.24319e-05,2.26278e-09,-1.56305e-13,35526.6,-19.1654], Tmin=(1047.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])=C(6658)'],
    products = ['C2H4(30)', 'C=C=C(6730)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC[C]=C(10724)'],
    products = ['[CH2]CC([CH2])=C(6658)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C([CH2])=C(10867)'],
    products = ['[CH2]CC([CH2])=C(6658)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C[C]=C(1912)'],
    products = ['[CH2]CC([CH2])=C(6658)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H4(30)', '[CH2][C]=C(6957)'],
    products = ['[CH2]CC([CH2])=C(6658)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(=C)C=C(10882)'],
    products = ['[CH2]CC([CH2])=C(6658)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH2](611)', 'C=C=C(6730)'],
    products = ['[CH2]CC([CH2])=C(6658)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH2](611)', '[CH2][C]=C(6957)'],
    products = ['[CH2]CC([CH2])=C(6658)'],
