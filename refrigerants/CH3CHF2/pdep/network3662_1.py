...
"""),
    E0 = (-958.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,259,529,569,1128,1321,1390,3140,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,303.076,303.146,303.149],'cm^-1')),
        HinderedRotor(inertia=(0.136285,'amu*angstrom^2'), symmetry=1, barrier=(8.88788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136291,'amu*angstrom^2'), symmetry=1, barrier=(8.8878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.345905,'amu*angstrom^2'), symmetry=1, barrier=(22.542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136358,'amu*angstrom^2'), symmetry=1, barrier=(8.8887,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.162553,0.0988857,-0.000145031,1.13707e-07,-3.58164e-11,-115166,29.3692], Tmin=(100,'K'), Tmax=(775.977,'K')), NASAPolynomial(coeffs=[12.7416,0.0323692,-1.64545e-05,3.24629e-09,-2.29554e-13,-117169,-29.6133], Tmin=(775.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-958.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.472069,0.0829877,-0.000108564,7.53812e-08,-2.11079e-11,-63455.5,26.2663], Tmin=(100,'K'), Tmax=(868.2,'K')), NASAPolynomial(coeffs=[12.3536,0.028247,-1.39881e-05,2.75954e-09,-1.96398e-13,-65518.7,-29.376], Tmin=(868.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-528.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCFFO) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.116298,0.0924486,-0.000133123,1.01329e-07,-3.09839e-11,-93729.5,27.4625], Tmin=(100,'K'), Tmax=(798.358,'K')), NASAPolynomial(coeffs=[12.6134,0.0298337,-1.54771e-05,3.08755e-09,-2.20087e-13,-95724.9,-30.0145], Tmin=(798.358,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-780.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCCl_triplet)"""),
)

species(
    label = 'OC(F)(F)CC=CF(10070)',
...
"""),
    E0 = (-828.556,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,248.498,248.653],'cm^-1')),
        HinderedRotor(inertia=(0.00272452,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277672,'amu*angstrom^2'), symmetry=1, barrier=(12.1428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276764,'amu*angstrom^2'), symmetry=1, barrier=(12.1438,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948911,0.0687496,-7.12789e-05,3.87596e-08,-8.56693e-12,-99543.7,24.9714], Tmin=(100,'K'), Tmax=(1083.47,'K')), NASAPolynomial(coeffs=[12.5238,0.026017,-1.21181e-05,2.35749e-09,-1.67498e-13,-102052,-31.7985], Tmin=(1083.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-828.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCFH)"""),
)
...
"""),
    E0 = (-1012.13,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,323,467,575,827,1418,194,682,905,1196,1383,3221,275.371,275.595],'cm^-1')),
        HinderedRotor(inertia=(0.13937,'amu*angstrom^2'), symmetry=1, barrier=(7.5114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139335,'amu*angstrom^2'), symmetry=1, barrier=(7.51127,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139293,'amu*angstrom^2'), symmetry=1, barrier=(7.51118,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
...
"""),
    E0 = (-566.615,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,3025,407.5,1350,352.5,334,575,1197,1424,3202,381.091,382.931,387.671],'cm^-1')),
        HinderedRotor(inertia=(0.0783748,'amu*angstrom^2'), symmetry=1, barrier=(8.14734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0776432,'amu*angstrom^2'), symmetry=1, barrier=(8.13486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00303166,'amu*angstrom^2'), symmetry=1, barrier=(8.15924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274728,'amu*angstrom^2'), symmetry=1, barrier=(28.8075,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.495661,0.0833618,-0.00011913,9.41658e-08,-3.02528e-11,-68027.7,29.6396], Tmin=(100,'K'), Tmax=(758.578,'K')), NASAPolynomial(coeffs=[10.4379,0.0309299,-1.54393e-05,3.02813e-09,-2.13589e-13,-69535.9,-15.5778], Tmin=(758.578,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-566.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCsFHH) + radical(Csj(Cs-CsHH)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = 'O[C](F)CC(F)[CH]F(10073)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-537.987,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,259,529,569,1128,1321,1390,3140,395,473,707,1436,334,575,1197,1424,3202,304.792,305.412,305.704],'cm^-1')),
        HinderedRotor(inertia=(0.0784092,'amu*angstrom^2'), symmetry=1, barrier=(5.18988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.40627,'amu*angstrom^2'), symmetry=1, barrier=(27.1662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.41004,'amu*angstrom^2'), symmetry=1, barrier=(27.1665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240798,'amu*angstrom^2'), symmetry=1, barrier=(15.7977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
...
"""),
    E0 = (-698.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,259,529,569,1128,1321,1390,3140,351,323,533,609,664,892,1120,1201,334,575,1197,1424,3202,180.515,236.028,254.244],'cm^-1')),
        HinderedRotor(inertia=(0.197048,'amu*angstrom^2'), symmetry=1, barrier=(6.45963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130975,'amu*angstrom^2'), symmetry=1, barrier=(6.51441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25262,'amu*angstrom^2'), symmetry=1, barrier=(12.3142,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.218101,0.0923755,-0.000131508,9.26799e-08,-2.24295e-11,-83915,28.6227], Tmin=(100,'K'), Tmax=(620.587,'K')), NASAPolynomial(coeffs=[11.7212,0.0314616,-1.62516e-05,3.21588e-09,-2.27351e-13,-85597.5,-23.4376], Tmin=(620.587,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-698.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
species(
    label = 'OC(F)(F)[CH]C(F)[CH]F(10075)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-758.835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,259,529,569,1128,1321,1390,3140,253,525,597,667,842,1178,1324,3025,407.5,1350,352.5,334,575,1197,1424,3202,277.092,277.308,277.433],'cm^-1')),
        HinderedRotor(inertia=(0.141216,'amu*angstrom^2'), symmetry=1, barrier=(7.69928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00219194,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141082,'amu*angstrom^2'), symmetry=1, barrier=(7.70115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.39946,'amu*angstrom^2'), symmetry=1, barrier=(21.7906,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
...
"""),
    E0 = (-770.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,212,367,445,1450,334,575,1197,1424,3202,212.069,212.069,2132.56],'cm^-1')),
        HinderedRotor(inertia=(0.745168,'amu*angstrom^2'), symmetry=1, barrier=(23.7257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334864,'amu*angstrom^2'), symmetry=1, barrier=(10.6906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.336032,'amu*angstrom^2'), symmetry=1, barrier=(10.6909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.33491,'amu*angstrom^2'), symmetry=1, barrier=(10.6908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.39597,0.107209,-0.00018469,1.634e-07,-5.59956e-11,-92474.5,32.198], Tmin=(100,'K'), Tmax=(831.968,'K')), NASAPolynomial(coeffs=[11.6836,0.0315335,-1.65225e-05,3.22037e-09,-2.22878e-13,-93875.4,-20.1965], Tmin=(831.968,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-770.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-CsHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'O=C(F)CC(F)[CH]F(5793)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.161913,'amu*angstrom^2'), symmetry=1, barrier=(3.72269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161252,'amu*angstrom^2'), symmetry=1, barrier=(3.7075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.885376,'amu*angstrom^2'), symmetry=1, barrier=(20.3565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.651528,0.0818186,-0.00013188,1.18021e-07,-4.18482e-11,-81105.5,26.3095], Tmin=(100,'K'), Tmax=(807.312,'K')), NASAPolynomial(coeffs=[7.99306,0.0326381,-1.67093e-05,3.26659e-09,-2.28051e-13,-81873.6,-4.95324], Tmin=(807.312,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-675.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COCsFO) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'OC(F)(F)[CH]C=CF(10077)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01653,'amu*angstrom^2'), symmetry=1, barrier=(23.3721,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7371,'amu*angstrom^2'), symmetry=1, barrier=(39.9394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01527,'amu*angstrom^2'), symmetry=1, barrier=(23.3431,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694654,0.07314,-8.05927e-05,4.46713e-08,-9.85145e-12,-85471.7,23.0821], Tmin=(100,'K'), Tmax=(1098.09,'K')), NASAPolynomial(coeffs=[14.8058,0.0217376,-1.03767e-05,2.04212e-09,-1.46172e-13,-88570.8,-46.3163], Tmin=(1098.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-711.639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCFH) + radical(C=CCJCO)"""),
)

species(
    label = 'OC(F)=CC(F)[CH]F(10078)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.314202,0.0880477,-0.000124544,9.48292e-08,-2.92373e-11,-94394.4,28.5297], Tmin=(100,'K'), Tmax=(789.705,'K')), NASAPolynomial(coeffs=[11.5962,0.0309021,-1.59985e-05,3.19485e-09,-2.28052e-13,-96176.3,-23.2357], Tmin=(789.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-785.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCCFH) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'OC(F)(F)C[C](F)CF(10050)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.140245,0.0944535,-0.000130402,8.84295e-08,-1.94081e-11,-115616,29.7983], Tmin=(100,'K'), Tmax=(613.214,'K')), NASAPolynomial(coeffs=[11.6189,0.0338765,-1.71987e-05,3.38422e-09,-2.38672e-13,-117292,-22.1583], Tmin=(613.214,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-962.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-CsHH)(Cs-F1sHH)(F1s))"""),
)

species(
    label = 'OC(F)(F)[CH]C(F)CF(10046)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-951.092,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,259,529,569,1128,1321,1390,3140,253,525,597,667,842,1178,1324,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,245.239,245.246,245.255],'cm^-1')),
        HinderedRotor(inertia=(0.00280311,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20805,'amu*angstrom^2'), symmetry=1, barrier=(8.87989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.380488,'amu*angstrom^2'), symmetry=1, barrier=(16.2403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.476053,'amu*angstrom^2'), symmetry=1, barrier=(20.3187,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370028,0.0840835,-9.8096e-05,5.97509e-08,-1.47137e-11,-114263,29.4316], Tmin=(100,'K'), Tmax=(980.141,'K')), NASAPolynomial(coeffs=[13.7606,0.0294373,-1.44679e-05,2.87046e-09,-2.05839e-13,-116888,-34.9017], Tmin=(980.141,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-951.092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CCJCO)"""),
)

species(
    label = '[O]C(F)(F)CC(F)CF(9942)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-891.027,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,250,417,511,1155,1315,1456,3119,351,323,533,609,664,892,1120,1201,528,1116,1182,1331,1402,1494,3075,3110,262.655,263.184,265.342],'cm^-1')),
        HinderedRotor(inertia=(0.197056,'amu*angstrom^2'), symmetry=1, barrier=(9.65778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195997,'amu*angstrom^2'), symmetry=1, barrier=(9.66208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328947,'amu*angstrom^2'), symmetry=1, barrier=(16.1725,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.417472,0.0848943,-0.00010366,6.86432e-08,-1.8636e-11,-107042,27.3597], Tmin=(100,'K'), Tmax=(887.698,'K')), NASAPolynomial(coeffs=[11.8427,0.033412,-1.66673e-05,3.31191e-09,-2.37113e-13,-109070,-26.3997], Tmin=(887.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-891.027,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-CsF1sF1s))"""),
)

species(
    label = 'OC(F)(F)C[CH]C(F)F(10080)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.263431,0.0885582,-0.000116507,8.27545e-08,-2.38753e-11,-117294,30.7902], Tmin=(100,'K'), Tmax=(841.111,'K')), NASAPolynomial(coeffs=[12.1005,0.0322669,-1.61215e-05,3.19057e-09,-2.27336e-13,-119285,-24.269], Tmin=(841.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-976.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCsFFH) + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(H))"""),
)

species(
    label = 'O[C](F)CC(F)C(F)F(10081)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-946.531,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,395,473,707,1436,323.221,323.343,323.503],'cm^-1')),
        HinderedRotor(inertia=(0.314504,'amu*angstrom^2'), symmetry=1, barrier=(23.3537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100711,'amu*angstrom^2'), symmetry=1, barrier=(7.47206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.314975,'amu*angstrom^2'), symmetry=1, barrier=(23.3552,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.314781,'amu*angstrom^2'), symmetry=1, barrier=(23.3555,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.445484,0.0826947,-8.96544e-05,5.01334e-08,-1.14261e-11,-113717,28.289], Tmin=(100,'K'), Tmax=(1048.1,'K')), NASAPolynomial(coeffs=[13.9563,0.0311335,-1.58648e-05,3.19969e-09,-2.31558e-13,-116549,-37.528], Tmin=(1048.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-946.531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Csj(Cs-CsHH)(F1s)(O2s-H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OC(F)(F)C(F)[CH]F(5216)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2O(3)', 'F[CH]C(F)C=C(F)F(5648)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]C(F)CC(O)(F)F-2(10068)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]F(230)', 'OC(F)(F)C[CH]F(5243)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'OC(F)(F)CC(F)[C]F(10069)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(F)(F)CC=CF(10070)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'OC(F)(F)CC(F)=CF(10071)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)C[CH][CH]F(10072)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O[C](F)CC(F)[CH]F(10073)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'F[CH]C(F)C[C](F)F(5622)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)CC(F)[CH]F(10074)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH][CH]F(5567)', '[CH2]C(O)(F)F(1116)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[C](F)F(4570)', '[CH2]C(F)[CH]F(252)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)(F)[CH]C(F)[CH]F(10075)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OC(F)(F)C[C](F)[CH]F(10076)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)CC(F)[CH]F(5793)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'OC(F)(F)[CH]C=CF(10077)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'OC(F)=CC(F)[CH]F(10078)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', 'OC(F)(F)C[CH]F(5243)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', 'OC(F)(F)CC(F)[C]F-2(10079)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)(F)CC(F)[CH]F(9772)'],
    products = ['OC(F)(F)C[C](F)CF(10050)'],
...
reaction(
    label = 'reaction26',
    reactants = ['OC(F)(F)[CH]C(F)CF(10046)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C(F)(F)CC(F)CF(9942)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OC(F)(F)CC(F)[CH]F(9772)'],
    products = ['OC(F)(F)C[CH]C(F)F(10080)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O[C](F)CC(F)C(F)F(10081)'],
    products = ['OC(F)(F)CC(F)[CH]F(9772)'],
