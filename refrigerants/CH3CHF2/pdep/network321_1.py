...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'C#COC(=O)F(1620)'],
    products = ['C#COC(C)([O])F(1111)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=[C]OC(C)=O(1308)'],
    products = ['C#COC(C)([O])F(1111)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C2H(22)', 'CC([O])([O])F(1621)'],
    products = ['C#COC(C)([O])F(1111)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[CH]=[C]OC(=O)F(1622)'],
    products = ['C#COC(C)([O])F(1111)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[C]#COC(C)([O])F(1624)'],
    products = ['C#COC(C)([O])F(1111)'],
