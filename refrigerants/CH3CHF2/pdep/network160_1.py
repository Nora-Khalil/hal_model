...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'C=C(C[C]F)OF(597)'],
    products = ['C=C(CCF)OF(575)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]CC(=C)OF(602)'],
    products = ['C=C(CCF)OF(575)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CH2F(46)', '[CH2]C(=C)OF(605)'],
    products = ['C=C(CCF)OF(575)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]OF(202)', 'CH2F-CH2(62)'],
    products = ['C=C(CCF)OF(575)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(=CCF)OF(606)'],
    products = ['C=C(CCF)OF(575)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=C(C[CH]F)OF(607)'],
    products = ['C=C(CCF)OF(575)'],
