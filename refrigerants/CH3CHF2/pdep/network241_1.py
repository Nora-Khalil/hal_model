...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', '[O]C([O])F(782)'],
    products = ['[O]C(F)O[CH]F(868)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)O[CH]F(873)'],
    products = ['[O]C(F)O[CH]F(868)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][CH]F(516)', '[O][CH]F(516)'],
    products = ['[O]C(F)O[CH]F(868)'],
    transitionState = 'TS9',
