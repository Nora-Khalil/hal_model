...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C#COO(966)'],
    products = ['C#COOCF(995)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COOF(1042)'],
    products = ['C#COOCF(995)'],
    transitionState = 'TS3',
