...
"""),
    E0 = (-199.216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,364,474,579,619,655,1345,3000,3100,440,815,1455,1000,262.079,262.08],'cm^-1')),
        HinderedRotor(inertia=(0.618361,'amu*angstrom^2'), symmetry=1, barrier=(30.14,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245588,'amu*angstrom^2'), symmetry=1, barrier=(11.9702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.618375,'amu*angstrom^2'), symmetry=1, barrier=(30.14,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.53285,0.0427924,-9.44864e-06,-5.47072e-08,4.26427e-11,-23955.6,12.3071], Tmin=(10,'K'), Tmax=(645.748,'K')), NASAPolynomial(coeffs=[9.7715,0.0254934,-1.8848e-05,6.18588e-09,-7.49778e-13,-25206.4,-18.5083], Tmin=(645.748,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-199.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), label="""[CH2]C(F)(OF)OF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-331.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,519,593,830,1115,1166,1389,1413,3114,360,370,350,3000,3100,440,815,1455,1000,243.105,243.467,243.496,1586.23],'cm^-1')),
        HinderedRotor(inertia=(0.204058,'amu*angstrom^2'), symmetry=1, barrier=(8.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00285286,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204152,'amu*angstrom^2'), symmetry=1, barrier=(8.59327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.6727,'amu*angstrom^2'), symmetry=1, barrier=(28.3765,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.505869,0.083621,-0.000135536,1.15405e-07,-3.89856e-11,-39750,28.9069], Tmin=(100,'K'), Tmax=(779.544,'K')), NASAPolynomial(coeffs=[10.9461,0.0250619,-1.32584e-05,2.62519e-09,-1.84664e-13,-41226.1,-17.8891], Tmin=(779.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-331.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFFHO) + radical(Cs_P) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(F)(OF)O[CH]F(11036)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.202607,'amu*angstrom^2'), symmetry=1, barrier=(4.65833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201522,'amu*angstrom^2'), symmetry=1, barrier=(4.63338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0903,'amu*angstrom^2'), symmetry=1, barrier=(25.0682,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48404,0.0601421,-9.64808e-05,7.9651e-08,-2.604e-11,-12211.3,18.7212], Tmin=(100,'K'), Tmax=(751.507,'K')), NASAPolynomial(coeffs=[9.75038,0.016144,-8.66234e-06,1.74784e-09,-1.24716e-13,-13453.7,-18.7978], Tmin=(751.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sO2sCs)) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)
...
"""),
    E0 = (-517.637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,395,473,707,1436,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.136706,'amu*angstrom^2'), symmetry=1, barrier=(3.14315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136213,'amu*angstrom^2'), symmetry=1, barrier=(3.13181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.313399,'amu*angstrom^2'), symmetry=1, barrier=(7.20567,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
species(
    label = '[CH2]C(F)(OF)O[C](F)F(11039)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0295253,0.0980872,-0.000166409,1.47857e-07,-5.15455e-11,-92527.8,28.4195], Tmin=(100,'K'), Tmax=(803.837,'K')), NASAPolynomial(coeffs=[10.7625,0.0311592,-1.68388e-05,3.34293e-09,-2.34706e-13,-93835.5,-18.6317], Tmin=(803.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-770.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(Cs-CsHHH) + group(CsFFHO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O]C(F)(CF)OC(F)F(11041)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(OF)OC(F)F(10847)'],
    products = ['HF(38)', 'CF2O(49)', 'CH2CFO(79)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(14.5337,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[CH2]C(O)(F)OF(11032)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(81.6559,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[CH2]C(F)(OF)OF(11033)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.27832e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(10.1098,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'FO[C](F)OC(F)F(4926)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', '[CH]C(F)(OF)OC(F)F(11034)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(OF)OC(F)F(3444)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)(OF)O[CH]F(11036)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C([O])(F)OC(F)F(11037)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)F(615)', '[CH2][C](F)OF(1113)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF2(81)', '[CH2]C([O])(F)OF(11038)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', '[CH2][C](F)OC(F)F(2936)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(OF)O[C](F)F(11039)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', '[CH2]C(=O)OC(F)F(2210)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(OF)OC(F)F(10847)'],
    products = ['F2(78)', 'CHFO(47)', 'CH2CFO(79)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(195.786,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)(OF)OC(F)F(10847)'],
    products = ['CC(F)(OF)O[C](F)F(11040)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(OF)OC(F)F(10847)'],
    products = ['[O]C(F)(CF)OC(F)F(11041)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]OC(F)(CF)OF(11042)'],
    products = ['[CH2]C(F)(OF)OC(F)F(10847)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(177.832,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #3817',
    isomers = [
        '[CH2]C(F)(OF)OC(F)F(10847)',
    ],
    reactants = [
