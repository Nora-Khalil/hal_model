...
reaction(
    label = 'reaction2',
    reactants = ['[O][C](F)C(=O)OF(4970)'],
    products = ['[O]C(=O)C([O])(F)F(4707)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(=O)[C](F)F(3327)'],
    products = ['[O]C(=O)C([O])(F)F(4707)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(F)(F)[C]=O(4956)'],
    products = ['[O]C(=O)C([O])(F)F(4707)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)F(4846)', '[O][C]=O(293)'],
    products = ['[O]C(=O)C([O])(F)F(4707)'],
