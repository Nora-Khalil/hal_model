...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]C([O])(F)F(1114)'],
    products = ['[O]C(F)(F)C[CH]F(4693)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C[C](F)F(2948)'],
    products = ['[O]C(F)(F)C[CH]F(4693)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C=CF(4781)'],
    products = ['[O]C(F)(F)C[CH]F(4693)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C[CH]F(631)'],
    products = ['[O]C(F)(F)C[CH]F(4693)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH2]C([O])(F)F(1114)'],
    products = ['[O]C(F)(F)C[CH]F(4693)'],
