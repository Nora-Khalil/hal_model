...
"""),
    E0 = (-805.293,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,1380,1390,370,380,2900,435,1773.62,1773.62,1773.65,1773.77,1774.54],'cm^-1')),
        HinderedRotor(inertia=(0.228644,'amu*angstrom^2'), symmetry=1, barrier=(5.25698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228082,'amu*angstrom^2'), symmetry=1, barrier=(5.24406,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15145,0.0688287,-0.000180569,2.24714e-07,-9.51316e-11,-96815.1,23.1019], Tmin=(100,'K'), Tmax=(848.162,'K')), NASAPolynomial(coeffs=[-11.9741,0.0610481,-3.52339e-05,7.05911e-09,-4.9314e-13,-91743,104.699], Tmin=(848.162,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-805.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFFO) + radical(OCOJ) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-848.964,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,1855,455,950,180,798.649],'cm^-1')),
        HinderedRotor(inertia=(0.575822,'amu*angstrom^2'), symmetry=1, barrier=(13.2393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67295,'amu*angstrom^2'), symmetry=1, barrier=(38.4644,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1037.23,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,348.627,348.635,348.638,348.651,1026.52,1484.86,1484.86,1484.88],'cm^-1')),
        HinderedRotor(inertia=(0.104762,'amu*angstrom^2'), symmetry=1, barrier=(9.03538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302659,'amu*angstrom^2'), symmetry=1, barrier=(26.103,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'O=[C]OC(F)(F)F(5067)'],
    products = ['O=C(O)OC(F)(F)F(4744)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(=O)OC(F)(F)F(5068)'],
    products = ['O=C(O)OC(F)(F)F(4744)'],
    transitionState = 'TS8',
