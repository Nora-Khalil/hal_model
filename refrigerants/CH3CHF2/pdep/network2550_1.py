...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC([CH2])(F)F(3015)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH]C(C)=C(F)F(6582)'],
    products = ['[CH]=C(C)C([CH2])(F)F(6377)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(C)C(=C)F(6426)'],
    products = ['[CH]=C(C)C([CH2])(F)F(6377)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', 'C#CC([CH2])(F)F(3138)'],
    products = ['[CH]=C(C)C([CH2])(F)F(6377)'],
    transitionState = 'TS9',
