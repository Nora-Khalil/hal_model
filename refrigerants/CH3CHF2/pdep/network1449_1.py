...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C([CH2])(F)F(3989)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C(F)=C(F)F(4042)'],
    products = ['[CH]=C(F)C([CH2])(F)F(3989)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=C(F)C(=C)F(3978)'],
    products = ['[CH]=C(F)C([CH2])(F)F(3989)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[C]F(1074)', 'CH2CF2(57)'],
    products = ['[CH]=C(F)C([CH2])(F)F(3989)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CC([CH2])(F)F(3138)'],
    products = ['[CH]=C(F)C([CH2])(F)F(3989)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2HF(58)', '[CH2][C](F)F(2970)'],
    products = ['[CH]=C(F)C([CH2])(F)F(3989)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]F(1074)', '[CH2][C](F)F(2970)'],
    products = ['[CH]=C(F)C([CH2])(F)F(3989)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(78)', '[CH]=C=C([CH2])F(3139)'],
    products = ['[CH]=C(F)C([CH2])(F)F(3989)'],
