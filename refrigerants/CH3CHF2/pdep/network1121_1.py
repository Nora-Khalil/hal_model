...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', '[O]C[C](F)F(2986)'],
    products = ['F[CH]OC[C](F)F(3053)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]O[CH]F(325)'],
    products = ['F[CH]OC[C](F)F(3053)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]OC=C(F)F(3134)'],
    products = ['F[CH]OC[C](F)F(3053)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH2]O[CH]F(325)'],
    products = ['F[CH]OC[C](F)F(3053)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[O]C[C](F)F(2986)'],
    products = ['F[CH]OC[C](F)F(3053)'],
