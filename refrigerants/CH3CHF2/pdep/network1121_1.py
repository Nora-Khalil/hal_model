...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)C=C(F)F(3227)'],
    products = ['[O]C(F)C[C](F)F(3132)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CC[C](F)F(3062)'],
    products = ['[O]C(F)C[C](F)F(3132)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)C[C](F)F(3228)'],
    products = ['[O]C(F)C[C](F)F(3132)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C=C[C](F)F(3229)'],
    products = ['[O]C(F)C[C](F)F(3132)'],
