...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]C(=O)OC(1762)'],
    products = ['C=C(OC)OF(1721)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]OC(=C)OF(1763)'],
    products = ['C=C(OC)OF(1721)'],
