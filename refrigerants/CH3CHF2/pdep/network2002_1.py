...
"""),
    E0 = (-834.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,269.98,269.98,269.98],'cm^-1')),
        HinderedRotor(inertia=(0.198106,'amu*angstrom^2'), symmetry=1, barrier=(10.2468,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198106,'amu*angstrom^2'), symmetry=1, barrier=(10.2468,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.411313,'amu*angstrom^2'), symmetry=1, barrier=(21.2747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198106,'amu*angstrom^2'), symmetry=1, barrier=(10.2468,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.790007,0.11507,-0.000189351,1.63122e-07,-5.55147e-11,-100262,31.7533], Tmin=(100,'K'), Tmax=(790.98,'K')), NASAPolynomial(coeffs=[13.2494,0.0344751,-1.83115e-05,3.62344e-09,-2.54445e-13,-102183,-30.7888], Tmin=(790.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-834.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFFH) + group(Cs-CsHHH) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.689793,'amu*angstrom^2'), symmetry=1, barrier=(15.8597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.689499,'amu*angstrom^2'), symmetry=1, barrier=(15.8529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.588,'amu*angstrom^2'), symmetry=1, barrier=(36.5113,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.493091,0.107335,-0.000159776,1.25904e-07,-3.98559e-11,-97603.4,30.4351], Tmin=(100,'K'), Tmax=(771.947,'K')), NASAPolynomial(coeffs=[13.5636,0.0344928,-1.82233e-05,3.64816e-09,-2.60044e-13,-99773.5,-33.7409], Tmin=(771.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-812.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'CC(F)(F)C(F)(F)[CH]OF(5384)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-444.773,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,90,150,250,247,323,377,431,433,1065,1274,421.622,422.986,423.838,423.929],'cm^-1')),
        HinderedRotor(inertia=(0.0021965,'amu*angstrom^2'), symmetry=1, barrier=(7.19768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000942424,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180487,'amu*angstrom^2'), symmetry=1, barrier=(22.9216,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182853,'amu*angstrom^2'), symmetry=1, barrier=(22.9323,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.256354,0.101758,-0.000162837,1.3784e-07,-4.65003e-11,-53348.3,27.6216], Tmin=(100,'K'), Tmax=(767.505,'K')), NASAPolynomial(coeffs=[12.4131,0.0313171,-1.65476e-05,3.2824e-09,-2.31436e-13,-55163.2,-29.3021], Tmin=(767.505,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-444.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFHH) + group(Cs-CsHHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-837.348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,274,345,380,539,705,1166,1213,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,182,240,577,636,1210,1413,180,1192.67],'cm^-1')),
        HinderedRotor(inertia=(0.244563,'amu*angstrom^2'), symmetry=1, barrier=(5.62299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242685,'amu*angstrom^2'), symmetry=1, barrier=(5.5798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244151,'amu*angstrom^2'), symmetry=1, barrier=(5.61351,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.162856,0.107853,-0.000200635,1.96209e-07,-7.29289e-11,-100576,28.8427], Tmin=(100,'K'), Tmax=(832.931,'K')), NASAPolynomial(coeffs=[5.57479,0.0452419,-2.47474e-05,4.90043e-09,-3.41926e-13,-100315,9.51072], Tmin=(832.931,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-837.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-739.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,341.552,341.552,341.553],'cm^-1')),
        HinderedRotor(inertia=(0.130444,'amu*angstrom^2'), symmetry=1, barrier=(10.7985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130444,'amu*angstrom^2'), symmetry=1, barrier=(10.7985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130444,'amu*angstrom^2'), symmetry=1, barrier=(10.7985,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.112463,0.0982334,-0.000154926,1.30654e-07,-4.40432e-11,-88756.2,28.9604], Tmin=(100,'K'), Tmax=(767.367,'K')), NASAPolynomial(coeffs=[11.8829,0.0315395,-1.64121e-05,3.24173e-09,-2.28219e-13,-90474.5,-24.9345], Tmin=(767.367,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-739.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFFH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = 'CC(F)(F)[CH][C](F)F(3199)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-595.623,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,190,488,555,1236,1407,180,2048.32],'cm^-1')),
        HinderedRotor(inertia=(0.341616,'amu*angstrom^2'), symmetry=1, barrier=(7.85442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339994,'amu*angstrom^2'), symmetry=1, barrier=(7.81712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342101,'amu*angstrom^2'), symmetry=1, barrier=(7.86557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.540902,0.086179,-0.00014781,1.36736e-07,-4.90856e-11,-71522,27.1071], Tmin=(100,'K'), Tmax=(824.464,'K')), NASAPolynomial(coeffs=[7.5704,0.0332234,-1.71673e-05,3.36566e-09,-2.34581e-13,-72040.5,-1.5638], Tmin=(824.464,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-595.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.295582,'amu*angstrom^2'), symmetry=1, barrier=(6.79602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295226,'amu*angstrom^2'), symmetry=1, barrier=(6.78782,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.901199,'amu*angstrom^2'), symmetry=1, barrier=(20.7203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0884482,0.102827,-0.00019707,1.81735e-07,-6.31387e-11,-66588.5,29.1515], Tmin=(100,'K'), Tmax=(853.817,'K')), NASAPolynomial(coeffs=[10.9529,0.0248503,-1.39632e-05,2.75567e-09,-1.90016e-13,-67517.2,-16.7686], Tmin=(853.817,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-554.769,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sCsH)(F1s)(F1s)) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = 'CC(F)(F)[C](OF)[C](F)F(5388)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-654.879,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,190,488,555,1236,1407,206.713,206.718,206.721],'cm^-1')),
        HinderedRotor(inertia=(0.207337,'amu*angstrom^2'), symmetry=1, barrier=(6.28807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207388,'amu*angstrom^2'), symmetry=1, barrier=(6.28814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207383,'amu*angstrom^2'), symmetry=1, barrier=(6.28818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.356866,'amu*angstrom^2'), symmetry=1, barrier=(10.8227,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.844534,0.121795,-0.000226313,2.09385e-07,-7.35622e-11,-78603.9,32.3675], Tmin=(100,'K'), Tmax=(847.558,'K')), NASAPolynomial(coeffs=[10.8265,0.0358574,-1.96133e-05,3.84622e-09,-2.65481e-13,-79474,-15.4702], Tmin=(847.558,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-654.879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFFH) + group(Cs-CsHHH) + radical(C2CsJO) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]C(F)(F)C(OF)[C](F)F(5389)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-622.918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,215,315,519,588,595,1205,1248,190,488,555,1236,1407,3000,3100,440,815,1455,1000,279.186,279.225,279.289],'cm^-1')),
        HinderedRotor(inertia=(0.130055,'amu*angstrom^2'), symmetry=1, barrier=(7.19477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247199,'amu*angstrom^2'), symmetry=1, barrier=(13.673,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130032,'amu*angstrom^2'), symmetry=1, barrier=(7.19451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.515166,'amu*angstrom^2'), symmetry=1, barrier=(28.495,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.90673,0.118053,-0.000201847,1.74484e-07,-5.88183e-11,-74752.7,33.807], Tmin=(100,'K'), Tmax=(809.637,'K')), NASAPolynomial(coeffs=[14.448,0.0300616,-1.6352e-05,3.23834e-09,-2.26484e-13,-76841.5,-34.5729], Tmin=(809.637,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-622.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFFH) + group(Cs-CsHHH) + radical(Csj(Cs-O2sCsH)(F1s)(F1s)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'CC(F)(F)C(=O)[C](F)F(5390)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-867.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,348,427,405,1245,1236,1280,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,179,346,818,1406,1524,278.643,280.524],'cm^-1')),
        HinderedRotor(inertia=(0.126255,'amu*angstrom^2'), symmetry=1, barrier=(6.97046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124241,'amu*angstrom^2'), symmetry=1, barrier=(6.95362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.359947,'amu*angstrom^2'), symmetry=1, barrier=(20.0609,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.652739,0.0816873,-0.000113416,7.85051e-08,-1.8448e-11,-104279,26.0308], Tmin=(100,'K'), Tmax=(620.173,'K')), NASAPolynomial(coeffs=[10.5829,0.0293004,-1.49136e-05,2.93651e-09,-2.07207e-13,-105734,-18.9405], Tmin=(620.173,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-867.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsCs) + radical(Csj(CO-CsO2d)(F1s)(F1s))"""),
)

species(
    label = 'C[C](F)C(OF)=C(F)F(5391)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-473.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,346,659,817,1284,350,440,435,1725,182,240,577,636,1210,1413,180,2496.68],'cm^-1')),
        HinderedRotor(inertia=(0.272221,'amu*angstrom^2'), symmetry=1, barrier=(6.2589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84328,'amu*angstrom^2'), symmetry=1, barrier=(42.3805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84236,'amu*angstrom^2'), symmetry=1, barrier=(42.3596,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.444406,0.0881388,-0.000146668,1.36197e-07,-5.0034e-11,-56784,27.2506], Tmin=(100,'K'), Tmax=(796.29,'K')), NASAPolynomial(coeffs=[7.17681,0.0376549,-2.01769e-05,4.01446e-09,-2.8302e-13,-57327.8,-0.378247], Tmin=(796.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-473.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CsCdCsF1s)"""),
)

species(
    label = 'C=C(F)C(OF)[C](F)F(5392)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-471.311,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,323,467,575,827,1418,190,488,555,1236,1407,2950,3100,1380,975,1025,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0051952,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.667696,'amu*angstrom^2'), symmetry=1, barrier=(16.3824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.712149,'amu*angstrom^2'), symmetry=1, barrier=(16.3737,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.350356,0.086097,-0.000118376,8.34201e-08,-2.34372e-11,-56559.3,29.3914], Tmin=(100,'K'), Tmax=(868.707,'K')), NASAPolynomial(coeffs=[13.591,0.025131,-1.31079e-05,2.63657e-09,-1.89476e-13,-58859.8,-32.6239], Tmin=(868.707,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-471.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsOsH) + group(CsCsFFH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CsCsF1sF1s)"""),
)

species(
    label = 'CC(F)(F)C([C]F)OF-2(5353)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-448.859,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,617,898,1187,214.646,214.652],'cm^-1')),
        HinderedRotor(inertia=(0.298386,'amu*angstrom^2'), symmetry=1, barrier=(9.7614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.298436,'amu*angstrom^2'), symmetry=1, barrier=(9.76131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.813739,'amu*angstrom^2'), symmetry=1, barrier=(26.5976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.298472,'amu*angstrom^2'), symmetry=1, barrier=(9.76137,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0475235,0.0961694,-0.000146019,1.17819e-07,-3.80539e-11,-53846.2,28.5717], Tmin=(100,'K'), Tmax=(758.109,'K')), NASAPolynomial(coeffs=[12.4615,0.030182,-1.54827e-05,3.05107e-09,-2.15064e-13,-55743.2,-28.3155], Tmin=(758.109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-448.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'CC(F)(F)[C](OF)C(F)F(5393)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.815766,0.118159,-0.000204747,1.83551e-07,-6.37869e-11,-102881,31.2171], Tmin=(100,'K'), Tmax=(827.517,'K')), NASAPolynomial(coeffs=[11.6612,0.0369309,-1.95931e-05,3.84149e-09,-2.66928e-13,-104230,-22.2877], Tmin=(827.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-856.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFFH) + group(Cs-CsHHH) + radical(C2CsJO)"""),
)

species(
    label = '[CH2]C(F)(F)C(OF)C(F)F(5394)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-824.786,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,267.766,267.839,269.994],'cm^-1')),
        HinderedRotor(inertia=(0.168595,'amu*angstrom^2'), symmetry=1, barrier=(8.56275,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.332465,'amu*angstrom^2'), symmetry=1, barrier=(16.9288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165586,'amu*angstrom^2'), symmetry=1, barrier=(8.5492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.574962,'amu*angstrom^2'), symmetry=1, barrier=(29.3484,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.739323,0.112586,-0.000172867,1.3738e-07,-4.33869e-11,-99036,32.1714], Tmin=(100,'K'), Tmax=(776.691,'K')), NASAPolynomial(coeffs=[14.9632,0.0317168,-1.66839e-05,3.3197e-09,-2.3526e-13,-101475,-39.6156], Tmin=(776.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-824.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFFH) + group(Cs-CsHHH) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'CC(F)(F)C([O])C(F)(F)F(5395)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.482611,0.107898,-0.000174105,1.50625e-07,-5.17728e-11,-102012,31.6583], Tmin=(100,'K'), Tmax=(789.99,'K')), NASAPolynomial(coeffs=[11.7623,0.036001,-1.87975e-05,3.70445e-09,-2.59916e-13,-103638,-22.5753], Tmin=(789.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-849.444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cs-CsHHH) + radical(CsCsCsF1s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    products = ['HF(38)', 'O=C[C](F)F(3117)', 'CH2CF2(57)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CC(OF)[C](F)F(4469)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)[C](F)F(3371)', 'C[C]F(124)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'FOC([C](F)F)C(F)F(5369)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CC(F)(OF)C(F)[C](F)F(5383)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    products = ['CC(F)(F)C(F)(F)[CH]OF(5384)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'CC(F)(F)C([C]F)OF(5345)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C]F(2927)', 'CC(F)(F)[CH]OF(3368)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(126)', 'CC(F)(F)C=C(F)F(3195)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOC=C(F)F(4346)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(F)(F)C(OF)=C(F)F(5385)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C[C](F)C(OF)[C](F)F(4491)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'CC(F)(F)C([O])[C](F)F(5386)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', 'CC(F)(F)[CH][C](F)F(3199)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[CH][C](F)F(4344)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'FOC([C](F)F)[C](F)F(5387)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'CC(F)(F)[C](OF)[C](F)F(5388)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(F)(F)C(OF)[C](F)F(5389)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'CC(F)(F)C(=O)[C](F)F(5390)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C[C](F)C(OF)=C(F)F(5391)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'C=C(F)C(OF)[C](F)F(5392)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', 'CC(F)(F)C([C]F)OF-2(5353)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CF2(43)', 'CC(F)(F)[CH]OF(3368)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    products = ['CC(F)(F)[C](OF)C(F)F(5393)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(F)(F)C(OF)C(F)F(5394)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5315)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    products = ['CC(F)(F)C([O])C(F)(F)F(5395)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CC(F)(F)C(OF)[C](F)F(5315)'],
    products = ['C[C](F)C(OF)C(F)(F)F(5396)'],
...
network(
    ...
    isomers = [
        'CC(F)(F)C(OF)[C](F)F(5315)',
    ],
    reactants = [
        ('HF(38)', 'O=C[C](F)F(3117)', 'CH2CF2(57)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
