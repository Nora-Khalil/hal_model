...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3025)', '[CH2][O](132)'],
    products = ['[O]C[C](F)F(3183)'],
    transitionState = 'TS3',
