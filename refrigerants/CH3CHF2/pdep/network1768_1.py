...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(4646)', '[CH]C-2(610)'],
    products = ['C[CH]OC([O])(F)F(4683)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C=COC([O])(F)F(4968)'],
    products = ['C[CH]OC([O])(F)F(4683)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[CH]OC(=O)F(2468)'],
    products = ['C[CH]OC([O])(F)F(4683)'],
    transitionState = 'TS8',
