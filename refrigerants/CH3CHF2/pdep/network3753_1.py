...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.402947,'amu*angstrom^2'), symmetry=1, barrier=(9.26455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.40464,'amu*angstrom^2'), symmetry=1, barrier=(9.30347,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47867,0.0572576,-6.04995e-05,3.36577e-08,-7.61979e-12,-15510.1,23.2079], Tmin=(100,'K'), Tmax=(1058.54,'K')), NASAPolynomial(coeffs=[10.8673,0.02178,-1.02261e-05,1.99551e-09,-1.41989e-13,-17497.8,-22.6208], Tmin=(1058.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16644,0.0665474,-8.8709e-05,6.32706e-08,-1.81776e-11,-18162.3,24.2179], Tmin=(100,'K'), Tmax=(847.755,'K')), NASAPolynomial(coeffs=[10.4776,0.0226145,-1.0976e-05,2.14279e-09,-1.51423e-13,-19741,-19.1654], Tmin=(847.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-151.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=[C]C[C](F)OF(11386)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (164.845,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,2950,3100,1380,975,1025,1650,1685,370,232.673,232.673,232.673],'cm^-1')),
        HinderedRotor(inertia=(0.192784,'amu*angstrom^2'), symmetry=1, barrier=(7.40611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192784,'amu*angstrom^2'), symmetry=1, barrier=(7.40611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.53945,'amu*angstrom^2'), symmetry=1, barrier=(20.7239,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01704,0.071879,-0.000112319,9.72418e-08,-3.36167e-11,19927.7,25.1053], Tmin=(100,'K'), Tmax=(798.856,'K')), NASAPolynomial(coeffs=[8.3919,0.0271401,-1.36451e-05,2.65489e-09,-1.85156e-13,18998.7,-7.2578], Tmin=(798.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=[C]CC(=O)F(3317)'],
    products = ['C=[C]CC([O])(F)F(6962)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C#CCC([O])(F)F(8159)'],
    products = ['C=[C]CC([O])(F)F(6962)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(157.247,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #3753',
    isomers = [
        'C=[C]CC([O])(F)F(6962)',
    ],
    reactants = [
