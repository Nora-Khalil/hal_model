...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C=C(6596)'],
    products = ['[CH2]OC(F)[C]=C(10161)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=C=C(10612)'],
    products = ['[CH2]OC(F)[C]=C(10161)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC(F)O[CH2](10613)'],
    products = ['[CH2]OC(F)[C]=C(10161)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OC(F)[C]=C(10161)'],
    products = ['[CH2]C=C(F)O[CH2](10614)'],
