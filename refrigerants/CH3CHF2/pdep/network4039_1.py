...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)COOOC(F)F(6944)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OOOC[C](F)F(6034)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FOOOC[C](F)F(6943)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]COOOC(F)F(12083)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(3025)', '[CH2]OOOC(F)F(11088)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC(F)=COOOC(F)F(12084)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]OOOC[C](F)F(7409)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OC(F)F(3028)', '[O]C[C](F)F(3183)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)F(616)', '[O]OC[C](F)F(3122)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF2(81)', '[O]OOC[C](F)F(6013)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'F[C](F)[CH]OOOC(F)F(12085)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'F[C](F)COOO[C](F)F(6947)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'F[C]COOOC(F)F-2(12086)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', '[CH2]OOOC(F)F(11088)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)COOOC(F)F(6944)'],
    products = ['FC(F)[CH]OOOC(F)F(12087)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)OOOCC(F)F(12088)'],
    products = ['F[C](F)COOOC(F)F(6944)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)COOOC(F)F(6944)'],
    products = ['F[CH]OOOCC(F)(F)F(12089)'],
