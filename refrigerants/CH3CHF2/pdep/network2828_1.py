...
"""),
    E0 = (-340.383,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,493,600,700,1144,1293,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60919,0.0502529,-4.68058e-05,2.1847e-08,-4.08144e-12,-40850.7,24.7578], Tmin=(100,'K'), Tmax=(1280.33,'K')), NASAPolynomial(coeffs=[12.2975,0.0168613,-7.68599e-06,1.4778e-09,-1.04185e-13,-43587.6,-29.4485], Tmin=(1280.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-340.383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-OsHHH) + group(CsFFHO) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.835985,0.070897,-7.53457e-05,4.02587e-08,-8.63279e-12,-19294.9,27.6948], Tmin=(100,'K'), Tmax=(1120.6,'K')), NASAPolynomial(coeffs=[14.1868,0.0232412,-1.15553e-05,2.30862e-09,-1.66364e-13,-22287.1,-38.2355], Tmin=(1120.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (-354.483,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.994304,0.0709705,-7.58812e-05,4.37162e-08,-1.04704e-11,-42530.2,28.036], Tmin=(100,'K'), Tmax=(991.17,'K')), NASAPolynomial(coeffs=[10.885,0.0310543,-1.54722e-05,3.08377e-09,-2.21585e-13,-44490.8,-19.5928], Tmin=(991.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsHHH) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)OOOC(7320)'],
    products = ['CO[O](183)', 'FC1(F)CO1(3113)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]C(F)(F)OOO(7097)'],
    products = ['[CH2]C(F)(F)OOOC(7320)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'COOO[C](F)F(5410)'],
    products = ['[CH2]C(F)(F)OOOC(7320)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]C(F)(F)OOOC(8518)'],
    products = ['[CH2]C(F)(F)OOOC(7320)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)(F)OOOC(7320)'],
    products = ['CH3O(27)', 'FC1(F)COO1(3112)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)OOOC(5399)'],
    products = ['[CH2]C(F)(F)OOOC(7320)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['COO[O](1418)', 'CH2CF2(57)'],
    products = ['[CH2]C(F)(F)OOOC(7320)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2][C](F)OOOC(5401)'],
    products = ['[CH2]C(F)(F)OOOC(7320)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CO[O](183)', '[CH2]C([O])(F)F(1114)'],
    products = ['[CH2]C(F)(F)OOOC(7320)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.14976e+13,'m^3/(mol*s)'), n=-2.27223, Ea=(20.6779,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H"""),
)

reaction(
    label = 'reaction10',
    reactants = ['COO[O](1418)', '[CH2][C](F)F(2970)'],
    products = ['[CH2]C(F)(F)OOOC(7320)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3O(27)', '[CH2]C(F)(F)O[O](3042)'],
    products = ['[CH2]C(F)(F)OOOC(7320)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(8.14976e+13,'m^3/(mol*s)'), n=-2.27223, Ea=(21.4279,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H"""),
)

reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[CH2]C(F)(F)OO[O](6994)'],
    products = ['[CH2]C(F)(F)OOOC(7320)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]OOOC([CH2])(F)F(8519)'],
    products = ['[CH2]C(F)(F)OOOC(7320)'],
