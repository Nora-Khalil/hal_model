...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2927)', '[O]C[C](F)F(2986)'],
    products = ['F[C](F)CO[C](F)F(4720)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]O[C](F)F(3131)'],
    products = ['F[C](F)CO[C](F)F(4720)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)OC=C(F)F(4645)'],
    products = ['F[C](F)CO[C](F)F(4720)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH2]O[C](F)F(3131)'],
    products = ['F[C](F)CO[C](F)F(4720)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[O]C[C](F)F(2986)'],
    products = ['F[C](F)CO[C](F)F(4720)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)CO[C](F)F(4720)'],
    products = ['F[C](F)O[CH]C(F)F(4816)'],
