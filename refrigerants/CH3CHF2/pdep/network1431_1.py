...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)O[O](1081)'],
    products = ['O=O(143)', 'C2HF(58)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(=O)F(1066)'],
    products = ['[CH]=C(F)O[O](1081)'],
    transitionState = 'TS2',
