...
"""),
    E0 = (-246.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180,180,622.991,819.678],'cm^-1')),
        HinderedRotor(inertia=(0.032818,'amu*angstrom^2'), symmetry=1, barrier=(15.7778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.685359,'amu*angstrom^2'), symmetry=1, barrier=(15.7578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.61064,'amu*angstrom^2'), symmetry=1, barrier=(37.0318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.68601,'amu*angstrom^2'), symmetry=1, barrier=(15.7727,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.58252,0.0765891,-8.64678e-05,5.02147e-08,-1.16596e-11,-29484,25.0727], Tmin=(100,'K'), Tmax=(1043.62,'K')), NASAPolynomial(coeffs=[14.2276,0.024289,-1.12949e-05,2.19299e-09,-1.55691e-13,-32332,-41.339], Tmin=(1043.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-246.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(CsFHHO) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(Allyl_P)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02286,0.0710212,-8.32213e-05,5.3686e-08,-1.43963e-11,-12485.6,25.6254], Tmin=(100,'K'), Tmax=(892.36,'K')), NASAPolynomial(coeffs=[10.0119,0.0307288,-1.54938e-05,3.08906e-09,-2.21599e-13,-14089.9,-16.7181], Tmin=(892.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsCsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)

species(
    label = 'FCC1CO[C]1OF(9824)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.355706,0.065075,-5.82929e-05,2.73027e-08,-4.9235e-12,-21318.9,27.481], Tmin=(100,'K'), Tmax=(1538.41,'K')), NASAPolynomial(coeffs=[15.6442,0.0174282,-4.13743e-06,4.98565e-10,-2.55618e-14,-25088.6,-49.8262], Tmin=(1538.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsCsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + ring(Oxetane) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(OF)CC1CF(9825)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {6,S}
...
"""),
    E0 = (-52.5001,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,1855,455,950,244.438],'cm^-1')),
        HinderedRotor(inertia=(0.212393,'amu*angstrom^2'), symmetry=1, barrier=(8.82012,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208101,'amu*angstrom^2'), symmetry=1, barrier=(8.80369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.44675,'amu*angstrom^2'), symmetry=1, barrier=(19.0291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59416,0.0568167,-7.1829e-05,5.27115e-08,-1.60454e-11,-6231.23,22.589], Tmin=(100,'K'), Tmax=(793.925,'K')), NASAPolynomial(coeffs=[7.90524,0.0250188,-1.17498e-05,2.26086e-09,-1.58415e-13,-7233.3,-6.40177], Tmin=(793.925,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.5001,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(C)C=O) + radical(CC(C)CJ=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[CH2]C(CF)OF(9820)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(T)(18)', 'O=C([CH]CF)OF(1448)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]C(CF)C(=O)OF-2(9823)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2F(46)', 'C=CC(=O)OF(1439)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OF(167)', 'C=CCF(509)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=C(CF)C(=O)OF(8653)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[CH2]C([CH2])C(=O)OF(9827)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', '[CH2]C(CF)C([O])=O(9828)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]F(126)', '[CH2]C([C]=O)CF(9829)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2F(46)', '[CH2][CH]C(=O)OF(311)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=[C]OF(167)', '[CH2][CH]CF(1337)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[CH2][C](CF)C(=O)OF(9830)'],
    products = ['[CH2]C(CF)C(=O)OF(9698)'],
