...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C#COO(966)'],
    products = ['C#COOC(F)F(4677)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C#COO[CH]F(1011)'],
    products = ['C#COOC(F)F(4677)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)F(2933)', 'C2H(22)'],
    products = ['C#COOC(F)F(4677)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COO[C](F)F(4662)'],
    products = ['C#COOC(F)F(4677)'],
    transitionState = 'TS8',
