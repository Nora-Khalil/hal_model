...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52509,0.0622376,-9.80509e-05,9.32842e-08,-3.51444e-11,-12827.3,22.2841], Tmin=(100,'K'), Tmax=(812.945,'K')), NASAPolynomial(coeffs=[4.10813,0.0339486,-1.71074e-05,3.33173e-09,-2.32365e-13,-12732.5,13.5236], Tmin=(812.945,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsFHHO) + ring(Cs(F)-Cs-Cs(O2)) + radical(C2CsJOCs) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (-110.197,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,580,1155,1237,1373,3147,167,640,1190,233.657,551.845,567.59],'cm^-1')),
        HinderedRotor(inertia=(0.489685,'amu*angstrom^2'), symmetry=1, barrier=(11.4422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.493692,'amu*angstrom^2'), symmetry=1, barrier=(11.4793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0494869,'amu*angstrom^2'), symmetry=1, barrier=(11.4712,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33681,0.0624221,-7.56868e-05,4.92877e-08,-1.30669e-11,-13161.1,23.2398], Tmin=(100,'K'), Tmax=(911.259,'K')), NASAPolynomial(coeffs=[10.2374,0.023353,-1.13768e-05,2.23977e-09,-1.5962e-13,-14783.2,-18.8735], Tmin=(911.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFHHO) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(F1s)(O2s-Cd)(H)) + radical(Cdj(Cd-CsO2s)(F1s))"""),
)

species(
    label = 'C=C([C]F)OCF(7886)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-189.278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,180,180,490.137,649.6],'cm^-1')),
        HinderedRotor(inertia=(0.0639242,'amu*angstrom^2'), symmetry=1, barrier=(19.1569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0639687,'amu*angstrom^2'), symmetry=1, barrier=(19.1572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0639697,'amu*angstrom^2'), symmetry=1, barrier=(19.1568,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24113,0.0588929,-5.87766e-05,2.91115e-08,-5.73051e-12,-22664,21.1209], Tmin=(100,'K'), Tmax=(1223.47,'K')), NASAPolynomial(coeffs=[13.8189,0.0177716,-8.36132e-06,1.64051e-09,-1.17213e-13,-25741.8,-42.0964], Tmin=(1223.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsFHHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72087,0.0561958,-8.02229e-05,7.43407e-08,-2.83664e-11,-21693.4,22.204], Tmin=(100,'K'), Tmax=(781.005,'K')), NASAPolynomial(coeffs=[4.17589,0.0333614,-1.66602e-05,3.26169e-09,-2.29312e-13,-21763.9,12.9702], Tmin=(781.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFHH) + ring(O2s-Cs-Cs-Cs(F)) + radical(C2CsJOCs) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=CF)O[CH]F(7461)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]O[C]=CF(4089)'],
    products = ['[CH2]C(=CF)O[CH]F(7461)'],
    transitionState = 'TS3',
