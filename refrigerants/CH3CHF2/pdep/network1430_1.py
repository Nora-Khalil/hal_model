...
"""),
    E0 = (43.7685,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,2175,525,239,401,1367,243.579,243.591],'cm^-1')),
        HinderedRotor(inertia=(0.128035,'amu*angstrom^2'), symmetry=1, barrier=(5.39083,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.215957,'amu*angstrom^2'), symmetry=1, barrier=(4.96527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2173,'amu*angstrom^2'), symmetry=1, barrier=(4.99616,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91357,0.0512698,-7.53256e-05,6.91383e-08,-2.58774e-11,12220.1,21.0213], Tmin=(100,'K'), Tmax=(781.639,'K')), NASAPolynomial(coeffs=[4.88486,0.027598,-1.36512e-05,2.67826e-09,-1.88609e-13,12014.2,9.07294], Tmin=(781.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', 'C=C[C]F(3996)'],
    products = ['F[C]=CC[CH]F(3972)'],
    transitionState = 'TS3',
