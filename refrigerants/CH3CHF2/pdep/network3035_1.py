...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.982195,'amu*angstrom^2'), symmetry=1, barrier=(22.5826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.980716,'amu*angstrom^2'), symmetry=1, barrier=(22.5486,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.754388,0.0780122,-0.000113629,9.74494e-08,-3.42007e-11,10213.5,25.494], Tmin=(100,'K'), Tmax=(774.746,'K')), NASAPolynomial(coeffs=[7.79682,0.0349475,-1.72693e-05,3.36206e-09,-2.35562e-13,9323.49,-5.38575], Tmin=(774.746,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.0009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cds-CdsCsH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)

species(
    label = 'C#CC(F)C(F)[C]=C(8353)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.830755,'amu*angstrom^2'), symmetry=1, barrier=(19.1007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.37606,'amu*angstrom^2'), symmetry=1, barrier=(54.6303,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.634558,'amu*angstrom^2'), symmetry=1, barrier=(14.5897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.83636,0.0770231,-9.62153e-05,5.85932e-08,-9.64894e-12,9737.43,24.6984], Tmin=(100,'K'), Tmax=(613.998,'K')), NASAPolynomial(coeffs=[9.70734,0.031492,-1.49354e-05,2.86317e-09,-1.99407e-13,8416.97,-15.654], Tmin=(613.998,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.0723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cdj(Cs-F1sCsH)(Cd-HH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.562848,'amu*angstrom^2'), symmetry=1, barrier=(12.941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.56266,'amu*angstrom^2'), symmetry=1, barrier=(12.9367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562833,'amu*angstrom^2'), symmetry=1, barrier=(12.9406,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.704198,0.0792302,-0.000103113,7.92727e-08,-2.56436e-11,19502.6,27.9281], Tmin=(100,'K'), Tmax=(744.389,'K')), NASAPolynomial(coeffs=[8.49123,0.0373792,-1.87661e-05,3.71921e-09,-2.64948e-13,18343.5,-7.33987], Tmin=(744.389,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=C(F)C(F)C=C(8358)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {9,S}
...
"""),
    ...
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11899,0.0671865,-6.20314e-05,3.11771e-08,-6.62673e-12,5529.84,26.3164], Tmin=(100,'K'), Tmax=(1095.18,'K')), NASAPolynomial(coeffs=[10.3332,0.0335332,-1.59388e-05,3.11947e-09,-2.21968e-13,3511.58,-18.9745], Tmin=(1095.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.1417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cdj(Cs-HHH)(Cd-CsF1s))"""),
)

species(
    label = '[CH]=[C]C(F)C(F)C=C(8359)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {9,S}
...
"""),
    ...
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.6574,0.0800102,-0.000106231,8.4214e-08,-2.80414e-11,3177,26.767], Tmin=(100,'K'), Tmax=(724.772,'K')), NASAPolynomial(coeffs=[8.32622,0.03769,-1.86522e-05,3.6642e-09,-2.59382e-13,2065.27,-7.76277], Tmin=(724.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.4646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cd-F1sCd)(H)(H)) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=CC(F)C(=C)F(8361)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {9,S}
...
"""),
    ...
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.93832,0.0728784,-8.17928e-05,5.33818e-08,-1.47661e-11,5079.34,25.8231], Tmin=(100,'K'), Tmax=(860.607,'K')), NASAPolynomial(coeffs=[8.90757,0.0358391,-1.72364e-05,3.37457e-09,-2.39717e-13,3707.63,-11.4278], Tmin=(860.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.3553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', 'C=[C]C(F)[CH]F(6202)'],
    products = ['C=[C]C(F)C(F)[C]=C(7523)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]C(F)C=C=C(8351)'],
    products = ['C=[C]C(F)C(F)[C]=C(7523)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=[C]C(F)C(F)=C=C(8352)'],
    products = ['C=[C]C(F)C(F)[C]=C(7523)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#CC(F)C(F)[C]=C(8353)'],
    products = ['C=[C]C(F)C(F)[C]=C(7523)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F2(78)', 'C=[C]C=C[C]=C(8354)'],
    products = ['C=[C]C(F)C(F)[C]=C(7523)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2][C]=C(F)C=C=C(8355)'],
    products = ['C=[C]C(F)C(F)[C]=C(7523)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]C(F)C(F)[C]=C(7523)'],
    products = ['[CH2]C=C(F)C(F)[C]=C(8356)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC(F)C(F)[C]=C(8357)'],
    products = ['C=[C]C(F)C(F)[C]=C(7523)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]C(F)C(F)[C]=C(7523)'],
    products = ['[CH2][C]=C(F)C(F)C=C(8358)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]C(F)C(F)C=C(8359)'],
    products = ['C=[C]C(F)C(F)[C]=C(7523)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]C(F)C(F)[C]=C(7523)'],
    products = ['[CH2]C(F)=CC(F)[C]=C(8360)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]C(F)C(F)[C]=C(7523)'],
    products = ['[CH2][C]=CC(F)C(=C)F(8361)'],
...
network(
    label = 'PDepNetwork #3035',
    isomers = [
        'C=[C]C(F)C(F)[C]=C(7523)',
    ],
    reactants = [
