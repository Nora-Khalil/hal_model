...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.194731,'amu*angstrom^2'), symmetry=1, barrier=(4.47726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194379,'amu*angstrom^2'), symmetry=1, barrier=(4.46916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.936822,'amu*angstrom^2'), symmetry=1, barrier=(21.5394,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
...
"""),
    E0 = (-813.542,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,348,427,405,1245,1236,1280,528,1116,1182,1331,1402,1494,3075,3110,424.337,424.363,424.376,424.379,424.382,424.383,424.4],'cm^-1')),
        HinderedRotor(inertia=(0.000936236,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000936002,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48312,0.0615393,-9.07837e-05,8.28297e-08,-3.1545e-11,-97761.8,22.2744], Tmin=(100,'K'), Tmax=(734.885,'K')), NASAPolynomial(coeffs=[5.59673,0.0323252,-1.72256e-05,3.4648e-09,-2.47627e-13,-98182.2,4.94946], Tmin=(734.885,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-813.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OC(F)(F)CF(3494)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'O=C(O)C(F)(F)[C]F(3495)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'O=C(O)C(F)(F)F(3496)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(142)', 'O=C=C(F)CF(1516)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O)C(F)(F)[CH]F(3500)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](O)C(F)(F)[CH]F(3501)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)[C](F)CF(1528)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)O(2973)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'O=[C]C(F)(F)CF(3502)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)C(F)(F)CF(3503)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(46)', 'O=C(O)[C](F)F(3504)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]O(165)', 'CH2F-CF2(68)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C(F)(F)[CH]F(3505)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(78)', 'C=C(F)C(=O)O(176)'],
    products = ['O=C(O)C(F)(F)CF(3429)'],
