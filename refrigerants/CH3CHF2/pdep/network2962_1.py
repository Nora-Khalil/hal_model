...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77922,0.053167,-4.15548e-05,1.76139e-08,-3.26418e-12,-36676.1,20.6403], Tmin=(100,'K'), Tmax=(1199.02,'K')), NASAPolynomial(coeffs=[8.09092,0.0321107,-1.52128e-05,2.96744e-09,-2.1032e-13,-38189.7,-10.9556], Tmin=(1199.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C=C(F)CCF(7551)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43944,0.0584441,-5.14244e-05,2.45312e-08,-4.92942e-12,-30667.6,21.4252], Tmin=(100,'K'), Tmax=(1156.32,'K')), NASAPolynomial(coeffs=[9.92798,0.0290801,-1.33329e-05,2.56978e-09,-1.81304e-13,-32630.7,-20.76], Tmin=(1156.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-255.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.856024,'amu*angstrom^2'), symmetry=1, barrier=(19.6817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.856445,'amu*angstrom^2'), symmetry=1, barrier=(19.6914,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81814,0.0555024,-4.94925e-05,5.2346e-09,1.80503e-11,-8075.34,21.0531], Tmin=(100,'K'), Tmax=(523.434,'K')), NASAPolynomial(coeffs=[6.22521,0.0328651,-1.62609e-05,3.20708e-09,-2.28021e-13,-8687.95,1.19964], Tmin=(523.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.7342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (128.953,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,540,610,2055,180,439.182],'cm^-1')),
        HinderedRotor(inertia=(0.725893,'amu*angstrom^2'), symmetry=1, barrier=(16.6897,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63797,0.0481742,-3.5441e-05,1.32653e-08,-2.02654e-12,15597.4,21.6314], Tmin=(100,'K'), Tmax=(1516.29,'K')), NASAPolynomial(coeffs=[11.7524,0.0214921,-9.04549e-06,1.66007e-09,-1.13103e-13,12530.1,-31.3754], Tmin=(1516.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Csj(Cs-CdHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-62.0048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,145,326,398,834,1303,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,540,610,2055,342.696,342.7],'cm^-1')),
        HinderedRotor(inertia=(0.0586009,'amu*angstrom^2'), symmetry=1, barrier=(4.88377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227917,'amu*angstrom^2'), symmetry=1, barrier=(18.9945,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49825,0.0581689,-5.75655e-05,3.13449e-08,-7.15675e-12,-7369.97,22.4935], Tmin=(100,'K'), Tmax=(1032.93,'K')), NASAPolynomial(coeffs=[9.44155,0.0274081,-1.28946e-05,2.5132e-09,-1.78511e-13,-9010.92,-16.0856], Tmin=(1032.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.0048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Csj(Cs-CdHH)(F1s)(H))"""),
)

species(
    label = 'C#CC(F)C[CH]F(7554)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (-71.2119,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,233,378,609,1068,1270,1314,3037,334,575,1197,1424,3202,2175,525,750,770,3400,2100,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.903136,'amu*angstrom^2'), symmetry=1, barrier=(20.7649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.83246,'amu*angstrom^2'), symmetry=1, barrier=(65.1239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160007,'amu*angstrom^2'), symmetry=1, barrier=(3.67888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29497,0.0665892,-7.74525e-05,3.7388e-08,1.26384e-12,-8474.15,21.4691], Tmin=(100,'K'), Tmax=(586.55,'K')), NASAPolynomial(coeffs=[8.85174,0.0282283,-1.30382e-05,2.46361e-09,-1.69916e-13,-9587.23,-12.8881], Tmin=(586.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.2119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCsFHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16513,0.0689223,-9.72163e-05,8.66898e-08,-3.22519e-11,250.275,26.5765], Tmin=(100,'K'), Tmax=(757.924,'K')), NASAPolynomial(coeffs=[5.62918,0.0373244,-1.87723e-05,3.69732e-09,-2.61258e-13,-195.523,7.80051], Tmin=(757.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.28478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cdj(Cs-F1sCsH)(Cd-HH))"""),
)

species(
    label = '[CH2]C=C(F)C[CH]F(7556)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17442,0.0594299,-5.00265e-05,2.17009e-08,-3.83313e-12,-12482.7,24.6166], Tmin=(100,'K'), Tmax=(1333.67,'K')), NASAPolynomial(coeffs=[12.8633,0.0243715,-1.05951e-05,1.98987e-09,-1.38187e-13,-15600.5,-35.1409], Tmin=(1333.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.65,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(Csj(Cs-CdHH)(F1s)(H)) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CC(F)C[CH]F(7557)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (9.93421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,3120,650,792.5,1650,211.812,211.844],'cm^-1')),
        HinderedRotor(inertia=(0.193769,'amu*angstrom^2'), symmetry=1, barrier=(6.16988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.529453,'amu*angstrom^2'), symmetry=1, barrier=(16.8588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193767,'amu*angstrom^2'), symmetry=1, barrier=(6.16991,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07315,0.0701593,-9.1093e-05,7.12445e-08,-2.35446e-11,1294.84,25.0039], Tmin=(100,'K'), Tmax=(728.443,'K')), NASAPolynomial(coeffs=[7.63963,0.0341063,-1.68626e-05,3.31795e-09,-2.35304e-13,338.053,-4.59584], Tmin=(728.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.93421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-CsHH)(F1s)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=C(F)CCF(7558)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22558,0.0588334,-4.87596e-05,2.07419e-08,-3.6033e-12,-6724.45,24.7852], Tmin=(100,'K'), Tmax=(1349.06,'K')), NASAPolynomial(coeffs=[12.6811,0.0248677,-1.09936e-05,2.07908e-09,-1.44821e-13,-9815.28,-33.9108], Tmin=(1349.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.7541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cdj(Cs-HHH)(Cd-CsF1s))"""),
)

species(
    label = 'C=CC(F)[CH][CH]F(7559)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25928,0.0665393,-9.08511e-05,8.05749e-08,-3.03032e-11,-5033.29,26.4774], Tmin=(100,'K'), Tmax=(740.781,'K')), NASAPolynomial(coeffs=[5.34744,0.0377733,-1.90542e-05,3.76795e-09,-2.6727e-13,-5455.39,9.22013], Tmin=(740.781,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.6198,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[CH]=[C]C(F)CCF(7560)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (53.8388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,164,312,561,654,898,1207,1299,3167,528,1116,1182,1331,1402,1494,3075,3110,1685,370,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.576178,'amu*angstrom^2'), symmetry=1, barrier=(13.2475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.576892,'amu*angstrom^2'), symmetry=1, barrier=(13.2639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.574882,'amu*angstrom^2'), symmetry=1, barrier=(13.2177,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24519,0.0684853,-7.74586e-05,3.87731e-08,-1.92909e-13,6566.98,24.198], Tmin=(100,'K'), Tmax=(569.818,'K')), NASAPolynomial(coeffs=[7.82436,0.0338543,-1.67086e-05,3.28016e-09,-2.32186e-13,5629.63,-5.4881], Tmin=(569.818,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.8388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=CCC(F)F(6551)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33777,0.0590396,-5.12264e-05,2.35715e-08,-4.50289e-12,-8750.37,23.9202], Tmin=(100,'K'), Tmax=(1223.13,'K')), NASAPolynomial(coeffs=[11.0466,0.0272883,-1.22871e-05,2.34728e-09,-1.6473e-13,-11125.4,-24.8747], Tmin=(1223.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.5474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(F)=CC[CH]F(7561)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {4,S} {6,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22956,0.0609087,-5.37731e-05,2.49853e-08,-4.78622e-12,-13156.4,24.7084], Tmin=(100,'K'), Tmax=(1226.29,'K')), NASAPolynomial(coeffs=[11.6885,0.0267934,-1.20437e-05,2.29952e-09,-1.61374e-13,-15721.6,-27.8834], Tmin=(1226.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCsCdF) + radical(Csj(Cs-CdHH)(F1s)(H)) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(395)', 'F[CH]C[CH]F(239)'],
    products = ['C=[C]C(F)C[CH]F(7452)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['C=[C]C(F)C[CH]F(7452)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(43.4679,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=[C]C(F)C=CF(7552)'],
    products = ['C=[C]C(F)C[CH]F(7452)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C=CC[CH]F(6415)'],
    products = ['C=[C]C(F)C[CH]F(7452)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(58.4573,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(13.9175,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C=C(F)C[CH]F(7553)'],
    products = ['C=[C]C(F)C[CH]F(7452)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#CC(F)C[CH]F(7554)'],
    products = ['C=[C]C(F)C[CH]F(7452)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(8.81926,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C=[C]C=C[CH]F(6685)'],
    products = ['C=[C]C(F)C[CH]F(7452)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(297.88,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)
...
reaction(
    label = 'reaction19',
    reactants = ['C=[C]C(F)C[CH]F(7452)'],
    products = ['[CH2]C=C(F)C[CH]F(7556)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=[C]C(F)C[CH]F(7452)'],
    products = ['[CH2][C]=CCC(F)F(6551)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(192.345,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction25',
    reactants = ['C=[C]C(F)C[CH]F(7452)'],
    products = ['[CH2]C(F)=CC[CH]F(7561)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(131.958,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)
