...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65436,0.0549899,-4.51849e-05,2.03268e-08,-3.94752e-12,-37438.6,20.677], Tmin=(100,'K'), Tmax=(1168.17,'K')), NASAPolynomial(coeffs=[8.63544,0.0310856,-1.44904e-05,2.80965e-09,-1.98676e-13,-39069.6,-14.0878], Tmin=(1168.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C=C(F)C(C)F(7596)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54164,0.0583357,-5.37225e-05,2.83115e-08,-6.47338e-12,-30789.9,20.1567], Tmin=(100,'K'), Tmax=(1011.15,'K')), NASAPolynomial(coeffs=[8.08656,0.0324445,-1.53138e-05,2.98793e-09,-2.12274e-13,-32113.5,-11.4913], Tmin=(1011.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.708,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-CsHHH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.876276,'amu*angstrom^2'), symmetry=1, barrier=(20.1473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.876818,'amu*angstrom^2'), symmetry=1, barrier=(20.1598,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59611,0.0592158,-6.47779e-05,3.51645e-08,-3.68927e-12,-8833.78,21.3989], Tmin=(100,'K'), Tmax=(585.66,'K')), NASAPolynomial(coeffs=[6.82446,0.031736,-1.54735e-05,3.03296e-09,-2.14958e-13,-9587.32,-2.23248], Tmin=(585.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.1183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.27299,'amu*angstrom^2'), symmetry=1, barrier=(6.27659,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37581,0.0625645,-7.19668e-05,4.76398e-08,-1.32885e-11,-5906.96,22.5347], Tmin=(100,'K'), Tmax=(855.779,'K')), NASAPolynomial(coeffs=[8.39491,0.0297571,-1.44633e-05,2.84439e-09,-2.02517e-13,-7108.34,-10.2353], Tmin=(855.779,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.8639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-CsHHH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sCdH)(H)(H))"""),
)

species(
    label = 'C#CC(F)C([CH2])F(7600)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    E0 = (-65.363,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,233,378,609,1068,1270,1314,3037,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,189.585],'cm^-1')),
        HinderedRotor(inertia=(2.0353,'amu*angstrom^2'), symmetry=1, barrier=(51.8391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.445537,'amu*angstrom^2'), symmetry=1, barrier=(11.3292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.73337,'amu*angstrom^2'), symmetry=1, barrier=(95.4152,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05087,0.0684906,-8.60574e-05,6.02893e-08,-1.71994e-11,-7758.4,21.8906], Tmin=(100,'K'), Tmax=(851.236,'K')), NASAPolynomial(coeffs=[9.99996,0.0264393,-1.19587e-05,2.25835e-09,-1.56607e-13,-9281.99,-19.8424], Tmin=(851.236,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.34796,'amu*angstrom^2'), symmetry=1, barrier=(53.9843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.34737,'amu*angstrom^2'), symmetry=1, barrier=(53.9706,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.11103,'amu*angstrom^2'), symmetry=1, barrier=(57.9196,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63199,0.0471134,-3.70022e-05,1.52188e-08,-2.54571e-12,24288,21.4346], Tmin=(100,'K'), Tmax=(1411.93,'K')), NASAPolynomial(coeffs=[11.3878,0.0194747,-7.63912e-06,1.35434e-09,-9.07871e-14,21533.2,-28.9968], Tmin=(1411.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCCF) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CC=CCJ) + radical(Cdj(Cd-F1sCd)(Cd-HH))"""),
)

species(
    label = 'C=[C]C(F)[C](C)F(7602)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-11.5593,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,2950,3100,1380,975,1025,1650,1685,370,251.609],'cm^-1')),
        HinderedRotor(inertia=(0.173302,'amu*angstrom^2'), symmetry=1, barrier=(7.78454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.280596,'amu*angstrom^2'), symmetry=1, barrier=(10.3752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194984,'amu*angstrom^2'), symmetry=1, barrier=(7.73265,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00704,0.0731646,-0.000108897,9.79158e-08,-3.5673e-11,-1289.59,25.9272], Tmin=(100,'K'), Tmax=(795.42,'K')), NASAPolynomial(coeffs=[5.96488,0.036637,-1.81465e-05,3.52746e-09,-2.46496e-13,-1711.48,5.44914], Tmin=(795.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.5593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsCsF1s) + radical(Cdj(Cs-F1sCsH)(Cd-HH))"""),
)

species(
    label = '[CH2]C(F)[C](F)C=C(7603)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31619,0.0613171,-5.49975e-05,2.61825e-08,-5.20834e-12,-11134.7,23.4955], Tmin=(100,'K'), Tmax=(1171.33,'K')), NASAPolynomial(coeffs=[10.764,0.0290533,-1.36804e-05,2.66658e-09,-1.89248e-13,-13348,-23.579], Tmin=(1171.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.3661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCdCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[CH]=CC(F)C([CH2])F(7604)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (15.7831,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,259,529,569,1128,1321,1390,3140,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.363364,'amu*angstrom^2'), symmetry=1, barrier=(8.35446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.363342,'amu*angstrom^2'), symmetry=1, barrier=(8.35395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19247,'amu*angstrom^2'), symmetry=1, barrier=(27.7272,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22207,0.0664023,-7.35501e-05,4.66993e-08,-1.25636e-11,1993.76,24.0721], Tmin=(100,'K'), Tmax=(882.585,'K')), NASAPolynomial(coeffs=[8.70945,0.0324686,-1.58781e-05,3.13654e-09,-2.24061e-13,672.103,-11.1151], Tmin=(882.585,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.7831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sCsH)(H)(H)) + radical(Cds_P)"""),
)

species(
    label = 'C=[C][C](F)C(C)F(7605)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27828,0.0636384,-6.28758e-05,3.42938e-08,-7.8748e-12,-7612.94,23.1368], Tmin=(100,'K'), Tmax=(1024.88,'K')), NASAPolynomial(coeffs=[9.74319,0.0306003,-1.45211e-05,2.83951e-09,-2.02015e-13,-9348.03,-17.9095], Tmin=(1024.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-64.0865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCdCsF1s) + radical(Cdj(Cs-F1sCsH)(Cd-HH))"""),
)

species(
    label = '[CH2][C](F)C(F)C=C(7606)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10076,0.0700625,-9.78302e-05,8.52806e-08,-3.10346e-11,-4813.44,26.0951], Tmin=(100,'K'), Tmax=(758.539,'K')), NASAPolynomial(coeffs=[6.1973,0.0364699,-1.81188e-05,3.54968e-09,-2.50113e-13,-5393.38,4.18953], Tmin=(758.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[CH]=[C]C(F)C(C)F(7607)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.559174,'amu*angstrom^2'), symmetry=1, barrier=(12.8565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.55923,'amu*angstrom^2'), symmetry=1, barrier=(12.8578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.559487,'amu*angstrom^2'), symmetry=1, barrier=(12.8637,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04569,0.0705258,-8.84718e-05,6.4937e-08,-1.99788e-11,5521.15,24.1979], Tmin=(100,'K'), Tmax=(782.071,'K')), NASAPolynomial(coeffs=[8.43797,0.0327186,-1.59612e-05,3.12882e-09,-2.21739e-13,4364.84,-9.64878], Tmin=(782.071,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.0627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37366,0.0596506,-5.2795e-05,2.50947e-08,-4.99935e-12,-13526.8,22.0466], Tmin=(100,'K'), Tmax=(1169.02,'K')), NASAPolynomial(coeffs=[10.3723,0.0288599,-1.32864e-05,2.56367e-09,-1.80953e-13,-15630.7,-22.772], Tmin=(1169.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(395)', '[CH2]C(F)[CH]F(252)'],
    products = ['[CH2]C(F)C(F)[C]=C(7449)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_sec_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=[C]C(F)C=C(7597)'],
    products = ['[CH2]C(F)C(F)[C]=C(7449)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=[C]C(F)C(=C)F(7598)'],
    products = ['[CH2]C(F)C(F)[C]=C(7449)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)C=C=C(6436)'],
    products = ['[CH2]C(F)C(F)[C]=C(7449)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(F)C(F)=C=C(7599)'],
    products = ['[CH2]C(F)C(F)[C]=C(7449)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C#CC(F)C([CH2])F(7600)'],
    products = ['[CH2]C(F)C(F)[C]=C(7449)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', '[CH2]C=C[C]=C(6463)'],
    products = ['[CH2]C(F)C(F)[C]=C(7449)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', '[CH2]C(F)=C[C]=C(6694)'],
    products = ['[CH2]C(F)C(F)[C]=C(7449)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[CH2]C=C(F)[C]=C(7601)'],
    products = ['[CH2]C(F)C(F)[C]=C(7449)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=CC(F)C([CH2])F(7604)'],
    products = ['[CH2]C(F)C(F)[C]=C(7449)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(F)C(F)[C]=C(7449)'],
    products = ['[CH2]C(F)[CH]C(=C)F(7608)'],
...
network(
    label = 'PDepNetwork #2959',
    isomers = [
        '[CH2]C(F)C(F)[C]=C(7449)',
    ],
    reactants = [
