...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.473089,'amu*angstrom^2'), symmetry=1, barrier=(10.8772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473108,'amu*angstrom^2'), symmetry=1, barrier=(10.8777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473031,'amu*angstrom^2'), symmetry=1, barrier=(10.8759,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.992404,0.0720903,-0.000101362,8.59438e-08,-3.0068e-11,702.169,25.0737], Tmin=(100,'K'), Tmax=(774.939,'K')), NASAPolynomial(coeffs=[7.21253,0.0341215,-1.65207e-05,3.19433e-09,-2.23179e-13,-85.8477,-2.21306], Tmin=(774.939,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-F1sCdH)(F1s)(H)) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34342,0.0564956,-4.47794e-05,1.81672e-08,-3.02292e-12,-36473.7,20.6772], Tmin=(100,'K'), Tmax=(1395.8,'K')), NASAPolynomial(coeffs=[12.2615,0.0252073,-1.11552e-05,2.10746e-09,-1.46478e-13,-39521.6,-35.6369], Tmin=(1395.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-304.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)

species(
    label = 'C=C=CC(F)CF(6754)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.530381,'amu*angstrom^2'), symmetry=1, barrier=(12.1945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.530058,'amu*angstrom^2'), symmetry=1, barrier=(12.1871,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52122,0.0584504,-5.97675e-05,3.42941e-08,-8.31527e-12,-7878.97,20.5262], Tmin=(100,'K'), Tmax=(973.192,'K')), NASAPolynomial(coeffs=[8.80943,0.028494,-1.35943e-05,2.66347e-09,-1.8965e-13,-9297.51,-14.437], Tmin=(973.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.2243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-71.4985,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([323,546,651,945,1004,1329,3278,2750,2800,2850,1350,1500,750,1050,1375,1000,334,575,1197,1424,3202,2100,2250,500,550,215.033,222.322],'cm^-1')),
        HinderedRotor(inertia=(1.92408,'amu*angstrom^2'), symmetry=1, barrier=(65.9571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241532,'amu*angstrom^2'), symmetry=1, barrier=(8.81208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.04511,'amu*angstrom^2'), symmetry=1, barrier=(65.9863,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
...
"""),
    E0 = (275.454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,334,575,1197,1424,3202,2100,2250,500,550,311.376,314.229],'cm^-1')),
        HinderedRotor(inertia=(0.00174511,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00171746,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.810789,'amu*angstrom^2'), symmetry=1, barrier=(57.8146,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85889,0.046361,-4.4882e-05,2.61621e-08,-6.34257e-12,33207.2,23.4622], Tmin=(100,'K'), Tmax=(992.4,'K')), NASAPolynomial(coeffs=[7.92955,0.0218938,-7.90229e-06,1.32157e-09,-8.5247e-14,32002.2,-5.77928], Tmin=(992.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(275.454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsHH) + group(CsCsFHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Csj(Cs-F1sHH)(Ct-Ct)(H)) + radical(Csj(Cs-CtHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-93.3795,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,324.574,326.309,3065.64],'cm^-1')),
        HinderedRotor(inertia=(0.385464,'amu*angstrom^2'), symmetry=1, barrier=(29.3738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321036,'amu*angstrom^2'), symmetry=1, barrier=(24.2831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.389759,'amu*angstrom^2'), symmetry=1, barrier=(29.3717,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34285,0.0593306,-5.08954e-05,2.29343e-08,-4.29514e-12,-11136.2,22.486], Tmin=(100,'K'), Tmax=(1242.06,'K')), NASAPolynomial(coeffs=[11.1536,0.0277355,-1.27389e-05,2.45407e-09,-1.72915e-13,-13573.3,-26.972], Tmin=(1242.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.3795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'CC=[C]C(F)[CH]F(6767)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.475248,'amu*angstrom^2'), symmetry=1, barrier=(10.9269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473579,'amu*angstrom^2'), symmetry=1, barrier=(10.8885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.47539,'amu*angstrom^2'), symmetry=1, barrier=(10.9301,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12093,0.0702275,-0.000101515,9.10011e-08,-3.34383e-11,5971.41,24.1551], Tmin=(100,'K'), Tmax=(784.834,'K')), NASAPolynomial(coeffs=[5.61328,0.0370114,-1.83072e-05,3.56622e-09,-2.49887e-13,5584.11,5.59544], Tmin=(784.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.8427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C=C(F)[CH]F(6769)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19773,0.0557053,-4.16488e-05,1.57068e-08,-2.39673e-12,-16830.2,22.3372], Tmin=(100,'K'), Tmax=(1532.32,'K')), NASAPolynomial(coeffs=[13.7611,0.0229097,-9.5452e-06,1.73956e-09,-1.17972e-13,-20680.5,-43.6358], Tmin=(1532.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-140.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cds-CdsCsH) + group(CdCsCdF) + radical(Allyl_S) + radical(Csj(Cd-CdF1s)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69023,0.0544591,-4.42504e-05,1.98567e-08,-3.87991e-12,-10014.9,21.2713], Tmin=(100,'K'), Tmax=(1154.7,'K')), NASAPolynomial(coeffs=[8.22666,0.0318162,-1.48364e-05,2.87448e-09,-2.03145e-13,-11524.4,-11.2034], Tmin=(1154.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Cds_S)"""),
)

species(
    label = 'C[C](F)C=C[CH]F(6771)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52538,0.0540907,-3.931e-05,1.43035e-08,-2.15054e-12,-18249.5,22.506], Tmin=(100,'K'), Tmax=(1504.44,'K')), NASAPolynomial(coeffs=[11.7105,0.0270105,-1.23096e-05,2.33869e-09,-1.62295e-13,-21314.1,-30.7913], Tmin=(1504.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-152.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-HHH)(F1s)(Cd-CdH)) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', 'C[C]=C[CH]F(6432)'],
    products = ['C[C]=CC(F)[CH]F(6752)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C[C]=CC(F)=CF(6763)'],
    products = ['C[C]=CC(F)[CH]F(6752)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C=CC(F)[CH]F(6764)'],
    products = ['C[C]=CC(F)[CH]F(6752)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC#CC(F)[CH]F(6765)'],
    products = ['C[C]=CC(F)[CH]F(6752)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'CC#C[CH][CH]F(6684)'],
    products = ['C[C]=CC(F)[CH]F(6752)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', 'C[C]=C[CH]F(6432)'],
    products = ['C[C]=CC(F)[CH]F(6752)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C[CH]C(F)[CH]F(6766)'],
    products = ['C[C]=CC(F)[CH]F(6752)'],
