...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(395)', '[CH2]C[C]=O(359)'],
    products = ['C=[C]CC[C]=O(7037)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(128)', '[CH2]C[C]=C(1875)'],
    products = ['C=[C]CC[C]=O(7037)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C[C]=C(1875)'],
    products = ['C=[C]CC[C]=O(7037)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]=O(136)', 'C=C=C(6745)'],
    products = ['C=[C]CC[C]=O(7037)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2CO(28)', '[CH2][C]=C(7019)'],
    products = ['C=[C]CC[C]=O(7037)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]=O(136)', '[CH2][C]=C(7019)'],
    products = ['C=[C]CC[C]=O(7037)'],
