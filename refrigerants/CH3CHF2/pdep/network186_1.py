...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', '[CH]=C[O](133)'],
    products = ['[CH]=CO[CH]F(688)'],
    transitionState = 'TS2',
