...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C[O](133)', '[CH]C-2(611)'],
    products = ['[CH]=CO[CH]C(2973)'],
    transitionState = 'TS2',
