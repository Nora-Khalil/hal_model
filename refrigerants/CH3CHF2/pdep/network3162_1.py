...
"""),
    E0 = (-942.538,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00844277,'amu*angstrom^2'), symmetry=1, barrier=(1.95851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.397479,'amu*angstrom^2'), symmetry=1, barrier=(13.4816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.58573,'amu*angstrom^2'), symmetry=1, barrier=(13.4671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.581322,'amu*angstrom^2'), symmetry=1, barrier=(13.3657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.526967,0.0819247,-0.000121959,9.16832e-08,-2.71978e-11,-113241,26.0146], Tmin=(100,'K'), Tmax=(827.507,'K')), NASAPolynomial(coeffs=[13.207,0.0206315,-1.08529e-05,2.17143e-09,-1.54836e-13,-115340,-32.7581], Tmin=(827.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-942.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFFO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.116358,'amu*angstrom^2'), symmetry=1, barrier=(7.92208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116354,'amu*angstrom^2'), symmetry=1, barrier=(7.92197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116356,'amu*angstrom^2'), symmetry=1, barrier=(7.92203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2769,0.0395018,-4.92818e-05,3.26416e-08,-8.65751e-12,-33513.2,18.7225], Tmin=(100,'K'), Tmax=(918.811,'K')), NASAPolynomial(coeffs=[8.39217,0.0128795,-5.82022e-06,1.1073e-09,-7.73871e-14,-34637,-10.2623], Tmin=(918.811,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-279.149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'OC(F)C(O)(F)OF(8461)',
...
"""),
    E0 = (-927.09,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,557,1111,375,361,584,565,722,1474,261,493,600,1152,1365,1422,3097,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.901552,'amu*angstrom^2'), symmetry=1, barrier=(20.7285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560827,'amu*angstrom^2'), symmetry=1, barrier=(12.9654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.564022,'amu*angstrom^2'), symmetry=1, barrier=(12.968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25666,'amu*angstrom^2'), symmetry=1, barrier=(30.6311,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.443639,0.0831943,-0.000118959,8.47912e-08,-2.37851e-11,-111379,24.9265], Tmin=(100,'K'), Tmax=(874.683,'K')), NASAPolynomial(coeffs=[14.2744,0.0199418,-1.04809e-05,2.10679e-09,-1.51122e-13,-113799,-39.9462], Tmin=(874.683,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-927.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (-513.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,557,1111,1380,1390,370,380,2900,435,395,473,707,1436,208.805,208.82],'cm^-1')),
        HinderedRotor(inertia=(0.0038708,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.304218,'amu*angstrom^2'), symmetry=1, barrier=(9.39581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.304124,'amu*angstrom^2'), symmetry=1, barrier=(9.39734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.454438,'amu*angstrom^2'), symmetry=1, barrier=(14.065,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.755652,0.0787211,-0.000136621,1.19524e-07,-4.03605e-11,-61623.2,25.7756], Tmin=(100,'K'), Tmax=(836.92,'K')), NASAPolynomial(coeffs=[10.3975,0.0205849,-1.08206e-05,2.10513e-09,-1.45263e-13,-62814.9,-16.502], Tmin=(836.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-513.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFHO) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(F)(F)C(O)O(8464)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {9,S}
...
"""),
    ...
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19575,0.0658798,-9.53402e-05,7.11332e-08,-2.10385e-11,-98174.5,24.0288], Tmin=(100,'K'), Tmax=(828.973,'K')), NASAPolynomial(coeffs=[11.071,0.0182291,-9.1176e-06,1.79218e-09,-1.26675e-13,-99811.8,-21.7613], Tmin=(828.973,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-817.078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-716.832,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,205.923,207.064,209.427],'cm^-1')),
        HinderedRotor(inertia=(0.213997,'amu*angstrom^2'), symmetry=1, barrier=(6.54973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207556,'amu*angstrom^2'), symmetry=1, barrier=(6.53944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0101004,'amu*angstrom^2'), symmetry=1, barrier=(27.045,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.691426,0.0817507,-0.000144496,1.3211e-07,-4.69115e-11,-86104.6,26.9626], Tmin=(100,'K'), Tmax=(812.747,'K')), NASAPolynomial(coeffs=[8.91066,0.0263369,-1.46104e-05,2.91885e-09,-2.0516e-13,-86946.4,-7.94617], Tmin=(812.747,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-716.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-644.737,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,190,488,555,1236,1407,182.883],'cm^-1')),
        HinderedRotor(inertia=(5.04158,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.52431,'amu*angstrom^2'), symmetry=1, barrier=(12.4722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524829,'amu*angstrom^2'), symmetry=1, barrier=(12.47,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-737.291,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3580,3650,1210,1345,900,1100,253,525,597,667,842,1178,1324,360,370,350,263.556,264.22],'cm^-1')),
        HinderedRotor(inertia=(0.283243,'amu*angstrom^2'), symmetry=1, barrier=(14.2732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114643,'amu*angstrom^2'), symmetry=1, barrier=(5.45124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118578,'amu*angstrom^2'), symmetry=1, barrier=(5.4881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309321,'amu*angstrom^2'), symmetry=1, barrier=(14.2816,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.444003,0.0842064,-0.000138488,1.12887e-07,-3.59934e-11,-88553.2,26.9918], Tmin=(100,'K'), Tmax=(773.619,'K')), NASAPolynomial(coeffs=[13.2759,0.017845,-9.79038e-06,1.95751e-09,-1.38197e-13,-90538.2,-31.6182], Tmin=(773.619,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-737.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFFO) + radical(Cs_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00248372,'amu*angstrom^2'), symmetry=1, barrier=(28.2003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215115,'amu*angstrom^2'), symmetry=1, barrier=(4.94592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.728586,'amu*angstrom^2'), symmetry=1, barrier=(16.7516,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15252,0.0426579,-4.6453e-05,2.69809e-08,-6.41035e-12,-95167.1,20.7579], Tmin=(100,'K'), Tmax=(1008.55,'K')), NASAPolynomial(coeffs=[8.66833,0.0168152,-8.01684e-06,1.57356e-09,-1.12255e-13,-96481.4,-10.7324], Tmin=(1008.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-791.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(COCsFO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['FOF(499)', 'OC(O)[C]F(8460)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(142)', 'OC=C(F)OF(2007)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(142)', 'OC(O)=C(F)F(8462)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'OC(O)[C](F)OF(8463)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(F)(F)C(O)O(8464)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', 'O[CH]C(F)(F)OF(4993)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(O)C(F)(F)OF(8465)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(126)', 'OC(O)[C](F)F(8466)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FO[C](F)F(4748)', 'O[CH]O(7805)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O[C](O)C(F)(F)OF(8467)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', 'O=C(F)C(O)O(8047)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'OC(O)=C(F)OF(2758)'],
    products = ['OC(O)C(F)(F)OF(8453)'],
