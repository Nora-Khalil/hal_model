...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.214239,'amu*angstrom^2'), symmetry=1, barrier=(4.92578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214158,'amu*angstrom^2'), symmetry=1, barrier=(4.92392,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C(F)[CH]F(6137)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)[CH]F(6160)'],
    products = ['[CH2]C(F)C(F)[CH]F(6137)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)C=CF(243)'],
    products = ['[CH2]C(F)C(F)[CH]F(6137)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)C(F)=CF(4276)'],
    products = ['[CH2]C(F)C(F)[CH]F(6137)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=CC(F)[CH]F(6162)'],
    products = ['[CH2]C(F)C(F)[CH]F(6137)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(F)C(F)[CH]F(6163)'],
    products = ['[CH2]C(F)C(F)[CH]F(6137)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', '[CH2]C=C[CH]F(246)'],
    products = ['[CH2]C(F)C(F)[CH]F(6137)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C=C(F)[CH]F(4020)'],
    products = ['[CH2]C(F)C(F)[CH]F(6137)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(F)C(F)[CH]F(6137)'],
    products = ['[CH2]C(F)[CH]C(F)F(3100)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(F)C(F)[CH]F(6137)'],
    products = ['[CH2][CH]C(F)C(F)F(6166)'],
