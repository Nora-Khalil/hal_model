...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]C[O](339)'],
    products = ['[O]CC[CH]F(193)'],
    transitionState = 'TS3',
