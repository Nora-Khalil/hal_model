...
"""),
    E0 = (154.267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,1010.55,1010.56,1010.94,1011.12,1011.26,2405.42],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (257.652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,747.653],'cm^-1')),
        HinderedRotor(inertia=(0.25845,'amu*angstrom^2'), symmetry=1, barrier=(11.4326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0287841,'amu*angstrom^2'), symmetry=1, barrier=(11.4331,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (62.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42764,0.0329249,-3.57653e-05,1.92524e-08,-4.03062e-12,31046.4,15.7536], Tmin=(100,'K'), Tmax=(1170.9,'K')), NASAPolynomial(coeffs=[9.92823,0.00730172,-2.94054e-06,5.63297e-10,-4.0308e-14,29289.9,-21.6158], Tmin=(1170.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(257.652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO) + radical(CJCO)"""),
)
...
"""),
    E0 = (77.6289,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,1562.55,2710.3],'cm^-1')),
        HinderedRotor(inertia=(0.275516,'amu*angstrom^2'), symmetry=1, barrier=(6.33466,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (62.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.86456,0.0321395,-6.00557e-05,6.62842e-08,-2.70466e-11,9370.51,13.1151], Tmin=(100,'K'), Tmax=(832.514,'K')), NASAPolynomial(coeffs=[0.976899,0.0234337,-1.23425e-05,2.42902e-09,-1.69518e-13,10300.8,25.5755], Tmin=(832.514,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.6289,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(O)F-2(521)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {3,S} {7,S}
3 C u0 p0 c0 {1,S} {2,S} {4,S} {5,S}
...
"""),
    E0 = (-31.1803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,209.273,209.397,209.478],'cm^-1')),
        HinderedRotor(inertia=(0.00015262,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.539553,'amu*angstrom^2'), symmetry=1, barrier=(16.7781,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (62.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.79868,0.0289102,-3.09864e-05,1.88108e-08,-4.86038e-12,-3708.97,12.4506], Tmin=(100,'K'), Tmax=(913.23,'K')), NASAPolynomial(coeffs=[6.10751,0.0144172,-7.18098e-06,1.43247e-09,-1.02953e-13,-4313.31,-3.21225], Tmin=(913.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.1803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O(6)', 'CH2CHF(56)'],
    products = ['[O]C[CH]F(140)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C[CH]F(140)'],
    products = ['[O][CH]CF(449)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(4.206e+06,'s^-1'), n=1.94993, Ea=(168.313,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2H_S;C_rad_out_1H;XH_out]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]O[CH]F(325)'],
    products = ['FC1CO1(285)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(7.38971e+10,'s^-1'), n=0.0476667, Ea=(8.08907,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn;C_rad_out_2H;Cpri_rad_out_single] for rate rule [R3_SS;C_rad_out_2H;Cpri_rad_out_1H]
Euclidian distance = 2.23606797749979
family: Birad_recombination"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(10.0596,'m^3/(mol*s)'), n=1.78132, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.9261259964147351, var=4.897630090116633, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_N-3BrFOS->F_1CS->C_2CS->C_N-3BrOS->S_Sp-2C=1C_Ext-1C-R',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_N-3BrFOS->F_1CS->C_2CS->C_N-3BrOS->S_Sp-2C=1C_Ext-1C-R"""),
)

reaction(
    label = 'reaction29',
    reactants = ['[CH2]C([O])F(141)'],
    products = ['[CH2][C](O)F(454)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][CH]OF(466)'],
    products = ['[CH2]C([O])F(141)'],
    transitionState = 'TS31',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(78.972,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction32',
    reactants = ['[O][CH]CF(449)'],
    products = ['[CH2]C([O])F(141)'],
    transitionState = 'TS32',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(143.756,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

reaction(
    label = 'reaction33',
    reactants = ['C=C(O)F(209)'],
    products = ['CC(=O)F(210)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(205000,'s^-1'), n=2.37, Ea=(172.269,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R"""),
)

reaction(
    label = 'reaction34',
    reactants = ['F(37)', 'C=[C]O(137)'],
    products = ['C=C(O)F(209)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.21037e+06,'m^3/(mol*s)'), n=0.349925, Ea=(5.85077,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C"""),
)

reaction(
    label = 'reaction37',
    reactants = ['H(5)', '[CH]=C(O)F(519)'],
    products = ['C=C(O)F(209)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[OH+]=[C-]CF(520)'],
    products = ['C=C(O)F(209)'],
    transitionState = 'TS38',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(64.9961,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)

reaction(
    label = 'reaction39',
    reactants = ['[CH]C(O)F-2(521)'],
    products = ['C=C(O)F(209)'],
    transitionState = 'TS39',
    kinetics = Arrhenius(A=(1.20443e+17,'s^-1'), n=-1.43042, Ea=(14.6254,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH"""),
)

reaction(
    label = 'reaction40',
    reactants = ['HF(38)', 'CH2CO(28)'],
    products = ['C=C(O)F(209)'],
    transitionState = 'TS40',
    kinetics = Arrhenius(A=(7.80335e-09,'m^3/(mol*s)'), n=4.28272, Ea=(129.408,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction41',
    reactants = ['HF(38)', 'C#CO(522)'],
    products = ['C=C(O)F(209)'],
    transitionState = 'TS41',
    kinetics = Arrhenius(A=(1.56721e+32,'m^3/(mol*s)'), n=-7.40875, Ea=(282.497,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_3COCdCddCtO2d->Ct"""),
)

reaction(
    label = 'reaction42',
    reactants = ['[OH+]=[C-]F(523)', 'CH2(S)(25)'],
    products = ['C=C(O)F(209)'],
...
reaction(
    label = 'reaction43',
    reactants = ['CO(13)', 'CH3F(39)'],
    products = ['CC(=O)F(210)'],
    transitionState = 'TS43',
    kinetics = Arrhenius(A=(614.234,'cm^3/(mol*s)'), n=3.16963, Ea=(318.436,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.27036, dn = +|- 0.0314397, dEa = +|- 0.171094 kJ/molMatched reaction 15 CH3F + CO <=> C2H3FO in 1,2_Insertion_CO/training
This reaction matched rate rule [Root_1COCbCdCsCtHNOSSidSis->Cs_N-2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->Cs_N-2Br1sCl1sF1sH->H_2Br1sCl1sF1s->F1s]
family: 1,2_Insertion_CO"""),
)

reaction(
    label = 'reaction44',
    reactants = ['F(37)', 'CH3CO(34)'],
    products = ['CC(=O)F(210)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.15746e-06,'m^3/(mol*s)'), n=3.27904, Ea=(123.09,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-1.6829136876314708, var=127.63224188496864, Tref=1000.0, N=6, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct"""),
)
