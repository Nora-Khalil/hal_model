...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH]C=C(261)'],
    products = ['[CH]=CC[C]=O(542)'],
    transitionState = 'TS3',
