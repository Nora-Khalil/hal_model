...
reaction(
    label = 'reaction2',
    reactants = ['HF(38)', 'C=C[C]F-2(7023)'],
    products = ['C=CC(F)F(973)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]C=C(F)F(3055)'],
    products = ['C=CC(F)F(973)'],
    transitionState = 'TS9',
