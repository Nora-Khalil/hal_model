...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.53394,'amu*angstrom^2'), symmetry=1, barrier=(35.2682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54592,'amu*angstrom^2'), symmetry=1, barrier=(35.5437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54489,'amu*angstrom^2'), symmetry=1, barrier=(35.5201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53628,'amu*angstrom^2'), symmetry=1, barrier=(35.3221,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53521,0.0587325,-6.73279e-05,4.39922e-08,-1.20964e-11,40759.1,20.1142], Tmin=(100,'K'), Tmax=(867.691,'K')), NASAPolynomial(coeffs=[8.28479,0.027618,-1.35407e-05,2.66728e-09,-1.90034e-13,39587.8,-11.4908], Tmin=(867.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOOC)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.220981,'amu*angstrom^2'), symmetry=1, barrier=(7.01467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.428236,'amu*angstrom^2'), symmetry=1, barrier=(13.5069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.304963,'amu*angstrom^2'), symmetry=1, barrier=(7.01422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48067,'amu*angstrom^2'), symmetry=1, barrier=(47.1585,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64906,0.0561341,-6.20512e-05,4.21077e-08,-1.23863e-11,49039.7,25.3325], Tmin=(100,'K'), Tmax=(805.591,'K')), NASAPolynomial(coeffs=[6.78054,0.0306542,-1.46069e-05,2.84423e-09,-2.01288e-13,48213,1.68552], Tmin=(805.591,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C=[C]O[O](375)', '[CH]C-2(610)'],
    products = ['C=[C]OO[CH]C(2314)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', 'C[CH]O[O](378)'],
    products = ['C=[C]OO[CH]C(2314)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
