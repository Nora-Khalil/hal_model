...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CCC(=C)OF(7638)'],
    products = ['HF(38)', 'CH2CO(28)', '[CH]=C=C(4302)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(=C)OF(9265)'],
    products = ['[CH]=CCC(=C)OF(7638)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H2(23)', '[CH2]C(=C)OF(605)'],
    products = ['[CH]=CCC(=C)OF(7638)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=CCC(=C)[O](7129)'],
    products = ['[CH]=CCC(=C)OF(7638)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(126)', '[CH]=CC[C]=C(7250)'],
    products = ['[CH]=CCC(=C)OF(7638)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C=[C]OF(202)', '[CH]C=C(8213)'],
    products = ['[CH]=CCC(=C)OF(7638)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[CH](264)', '[CH2]C(=C)OF(605)'],
    products = ['[CH]=CCC(=C)OF(7638)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH]C=CC(=C)OF(9280)'],
    products = ['[CH]=CCC(=C)OF(7638)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=[C]CC(=C)OF(9281)'],
    products = ['[CH]=CCC(=C)OF(7638)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=CCC(=[CH])OF(9282)'],
    products = ['[CH]=CCC(=C)OF(7638)'],
