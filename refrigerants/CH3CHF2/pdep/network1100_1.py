...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]C(3035)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])(F)F(1114)', '[CH]C-2(610)'],
    products = ['[CH2]C(F)(F)O[CH]C(3035)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[C](F)F(3300)'],
    products = ['[CH2]C(F)(F)O[CH]C(3035)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[CH]C(1815)'],
    products = ['[CH2]C(F)(F)O[CH]C(3035)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)OC=C(3301)'],
    products = ['[CH2]C(F)(F)O[CH]C(3035)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]COC([CH2])(F)F(3302)'],
    products = ['[CH2]C(F)(F)O[CH]C(3035)'],
