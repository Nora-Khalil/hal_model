...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[C]=O(3114)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'O=[C]C[C](F)F(3060)'],
    products = ['[CH2]C(F)(F)C[C]=O(3114)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(128)', '[CH2]C([CH2])(F)F(3157)'],
    products = ['[CH2]C(F)(F)C[C]=O(3114)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C([CH2])(F)F(3157)'],
    products = ['[CH2]C(F)(F)C[C]=O(3114)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)C[C]=O(384)'],
    products = ['[CH2]C(F)(F)C[C]=O(3114)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C=O(3270)'],
    products = ['[CH2]C(F)(F)C[C]=O(3114)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C[C]=O(3271)'],
    products = ['[CH2]C(F)(F)C[C]=O(3114)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C=C[O](3272)'],
    products = ['[CH2]C(F)(F)C[C]=O(3114)'],
...
network(
    label = 'PDepNetwork #1100',
    isomers = [
        '[CH2]C(F)(F)C[C]=O(3114)',
    ],
    reactants = [
        ('CH2CF2(57)', 'CH2CO(28)'),
    ],
