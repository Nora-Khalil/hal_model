...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0104815,'amu*angstrom^2'), symmetry=1, barrier=(3.67601,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.668617,'amu*angstrom^2'), symmetry=1, barrier=(15.3728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0471389,'amu*angstrom^2'), symmetry=1, barrier=(15.4208,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4627,0.0594163,-5.07774e-05,2.27521e-08,-4.30713e-12,-23842.9,28.2248], Tmin=(100,'K'), Tmax=(1209.59,'K')), NASAPolynomial(coeffs=[10.2363,0.0304027,-1.47976e-05,2.92172e-09,-2.08523e-13,-25965.4,-15.7722], Tmin=(1209.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-198.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24682,0.0700248,-7.47762e-05,2.56965e-08,1.2115e-11,-24698.6,26.4952], Tmin=(100,'K'), Tmax=(530.078,'K')), NASAPolynomial(coeffs=[7.43752,0.0368336,-1.91232e-05,3.83471e-09,-2.74648e-13,-25544.9,-1.23418], Tmin=(530.078,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.945913,0.0632144,-5.59074e-05,2.50988e-08,-4.52592e-12,-61277,24.2753], Tmin=(100,'K'), Tmax=(1322.05,'K')), NASAPolynomial(coeffs=[14.3793,0.0225703,-9.79245e-06,1.84453e-09,-1.28538e-13,-64829,-44.2834], Tmin=(1322.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-510.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF)"""),
)

species(
    label = 'FC=C=CCC(F)F(7669)',
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23061,0.064065,-6.16864e-05,3.21421e-08,-7.0019e-12,-55233.1,24.1207], Tmin=(100,'K'), Tmax=(1079.37,'K')), NASAPolynomial(coeffs=[10.468,0.0298325,-1.41135e-05,2.75902e-09,-1.96296e-13,-57227.2,-21.1499], Tmin=(1079.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-460.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.703936,'amu*angstrom^2'), symmetry=1, barrier=(16.1849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.702398,'amu*angstrom^2'), symmetry=1, barrier=(16.1495,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17508,0.064647,-6.93918e-05,3.96125e-08,-9.2325e-12,-32684.7,23.9337], Tmin=(100,'K'), Tmax=(1028.33,'K')), NASAPolynomial(coeffs=[11.3162,0.025201,-1.1854e-05,2.31136e-09,-1.64307e-13,-34770.5,-25.2746], Tmin=(1028.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-272.585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.654568,'amu*angstrom^2'), symmetry=1, barrier=(18.4773,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42554,0.0544063,-4.55612e-05,1.94347e-08,-3.37092e-12,-10130.4,23.8379], Tmin=(100,'K'), Tmax=(1354.82,'K')), NASAPolynomial(coeffs=[12.341,0.0221793,-9.88078e-06,1.87736e-09,-1.31132e-13,-13088,-32.1374], Tmin=(1354.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-85.0129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)

species(
    label = 'FC=C=CC[C](F)F(7671)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-258.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,113,247,382,1207,3490,540,610,2055,180,908.938,914.046],'cm^-1')),
        HinderedRotor(inertia=(0.0295385,'amu*angstrom^2'), symmetry=1, barrier=(17.3133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166346,'amu*angstrom^2'), symmetry=1, barrier=(3.82462,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
...
"""),
    E0 = (-273.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,319,1023,1071,1259,1317,1409,3054,3019,190,488,555,1236,1407,2100,2250,500,550,180,181.029,2039.62],'cm^-1')),
        HinderedRotor(inertia=(3.02638,'amu*angstrom^2'), symmetry=1, barrier=(69.5825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633952,'amu*angstrom^2'), symmetry=1, barrier=(14.5758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.02142,'amu*angstrom^2'), symmetry=1, barrier=(69.4683,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08611,0.0663466,-8.07763e-05,5.55512e-08,-1.5509e-11,-32846.9,26.1619], Tmin=(100,'K'), Tmax=(871.745,'K')), NASAPolynomial(coeffs=[9.96857,0.0255903,-1.0649e-05,1.9225e-09,-1.29671e-13,-34395.6,-15.4718], Tmin=(871.745,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsHH) + group(CsCsFFH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Csj(Cs-CtHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4934,0.0582059,-4.6853e-05,1.93954e-08,-3.38133e-12,-31079.2,25.0696], Tmin=(100,'K'), Tmax=(1300.2,'K')), NASAPolynomial(coeffs=[10.5744,0.0302685,-1.46221e-05,2.86913e-09,-2.03669e-13,-33440.6,-21.1248], Tmin=(1300.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = 'F[CH]C=CC[C](F)F(7675)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-305.858,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,190,488,555,1236,1407,234,589,736,816,1240,3237,234.805,236.454],'cm^-1')),
        HinderedRotor(inertia=(0.00593757,'amu*angstrom^2'), symmetry=1, barrier=(5.71058,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.583732,'amu*angstrom^2'), symmetry=1, barrier=(23.1449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.5851,'amu*angstrom^2'), symmetry=1, barrier=(23.1447,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19436,0.0625594,-5.42709e-05,2.40032e-08,-4.36706e-12,-36686.2,26.7321], Tmin=(100,'K'), Tmax=(1280.93,'K')), NASAPolynomial(coeffs=[12.4615,0.027375,-1.30689e-05,2.55929e-09,-1.818e-13,-39572.6,-30.4148], Tmin=(1280.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)

species(
    label = 'FCC=[C]C[C](F)F(11925)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-199.276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,212,931,1104,1251,1325,1474,3102,3155,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,1685,370,404.119,407.489,415.275],'cm^-1')),
        HinderedRotor(inertia=(0.0688976,'amu*angstrom^2'), symmetry=1, barrier=(8.09654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.074817,'amu*angstrom^2'), symmetry=1, barrier=(8.21215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123804,'amu*angstrom^2'), symmetry=1, barrier=(14.0723,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23557,0.06674,-7.48663e-05,4.90453e-08,-1.37653e-11,-23872.9,27.6094], Tmin=(100,'K'), Tmax=(843.885,'K')), NASAPolynomial(coeffs=[8.09337,0.0342348,-1.70897e-05,3.40295e-09,-2.44055e-13,-25030.4,-4.31163], Tmin=(843.885,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cds_S)"""),
)

species(
    label = 'FC[C]=[C]CC(F)F(11926)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-162.404,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,122,584,932,1043,1247,1392,1461,2986,3039,1670,1700,300,440,322.896,324.923],'cm^-1')),
        HinderedRotor(inertia=(0.111272,'amu*angstrom^2'), symmetry=1, barrier=(7.90547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0996732,'amu*angstrom^2'), symmetry=1, barrier=(7.84507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220989,'amu*angstrom^2'), symmetry=1, barrier=(16.402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12141,0.0694238,-8.44888e-05,6.14082e-08,-1.90476e-11,-19434.6,28.0054], Tmin=(100,'K'), Tmax=(770.267,'K')), NASAPolynomial(coeffs=[7.73815,0.0350623,-1.75729e-05,3.4913e-09,-2.49544e-13,-20453.9,-2.18933], Tmin=(770.267,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = 'FC[CH]C=C[C](F)F(11927)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33243,0.0597781,-4.88724e-05,2.04445e-08,-3.55055e-12,-40257.4,24.1983], Tmin=(100,'K'), Tmax=(1324.39,'K')), NASAPolynomial(coeffs=[11.688,0.0285014,-1.34483e-05,2.61271e-09,-1.84498e-13,-43000.3,-28.6709], Tmin=(1324.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Csj(Cd-CdH)(F1s)(F1s))"""),
)

species(
    label = 'F[CH][C]=CCC(F)F(7677)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2422,0.0632504,-5.65593e-05,2.63189e-08,-5.097e-12,-32254.6,26.553], Tmin=(100,'K'), Tmax=(1200.66,'K')), NASAPolynomial(coeffs=[11.4202,0.0293428,-1.41987e-05,2.79849e-09,-1.99682e-13,-34698.7,-24.4115], Tmin=(1200.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = '[CH2][C]=CCC(F)(F)F(7695)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10723,0.0648934,-6.21709e-05,3.15486e-08,-6.58363e-12,-38444.5,25.3627], Tmin=(100,'K'), Tmax=(1135.36,'K')), NASAPolynomial(coeffs=[11.7613,0.0273579,-1.25802e-05,2.42962e-09,-1.71786e-13,-40863.8,-27.3896], Tmin=(1135.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-320.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(F)=CC[C](F)F(7696)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.954308,0.0677933,-6.57941e-05,3.31447e-08,-6.80492e-12,-38881.3,27.1465], Tmin=(100,'K'), Tmax=(1158.13,'K')), NASAPolynomial(coeffs=[12.8885,0.0265749,-1.24092e-05,2.41462e-09,-1.71459e-13,-41645.6,-32.1814], Tmin=(1158.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-324.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCsCdF) + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['FC[C]=CC[C](F)F(11829)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11828)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]C=[C]CF(11864)'],
    products = ['FC[C]=CC[C](F)F(11829)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC[C]=CC=C(F)F(11922)'],
    products = ['FC[C]=CC[C](F)F(11829)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C=CC[C](F)F(6544)'],
    products = ['FC[C]=CC[C](F)F(11829)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC=C=CC[C](F)F(7671)'],
    products = ['FC[C]=CC[C](F)F(11829)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FCC#CC[C](F)F(11923)'],
    products = ['FC[C]=CC[C](F)F(11829)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]C=[C]CF(11864)'],
    products = ['FC[C]=CC[C](F)F(11829)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FC[C]=CC[C](F)F(11829)'],
    products = ['FC[C]=C[CH]C(F)F(11924)'],
...
reaction(
    label = 'reaction19',
    reactants = ['FC[C]=CC[C](F)F(11829)'],
    products = ['FC[CH]C=C[C](F)F(11927)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FC[C]=CC[C](F)F(11829)'],
    products = ['[CH2]C(F)=CC[C](F)F(7696)'],
