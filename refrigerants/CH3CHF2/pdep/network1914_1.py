...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CC(F)(F)OF(3378)'],
    products = ['CCC(F)(F)OF(4827)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(499)', 'CC[C]F-2(1048)'],
    products = ['CCC(F)(F)OF(4827)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(142)', 'CC=C(F)F(4071)'],
    products = ['CCC(F)(F)OF(4827)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(126)', 'CC[C](F)F(3100)'],
    products = ['CCC(F)(F)OF(4827)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FO[C](F)F(4748)', 'C2H5(32)'],
    products = ['CCC(F)(F)OF(4827)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[CH2]C(F)(F)OF(4873)'],
    products = ['CCC(F)(F)OF(4827)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C[CH]C(F)(F)OF(4866)'],
    products = ['CCC(F)(F)OF(4827)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]CC(F)(F)OF(4872)'],
    products = ['CCC(F)(F)OF(4827)'],
