...
"""),
    E0 = (-221.111,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([364,474,579,619,655,1345,2950,1000,1855,455,950,422.715,424.804,428.488,430.646,432.282],'cm^-1')),
        HinderedRotor(inertia=(0.000927513,'amu*angstrom^2'), symmetry=1, barrier=(0.119739,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000914158,'amu*angstrom^2'), symmetry=1, barrier=(0.119859,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90093,0.0418584,-3.68287e-05,1.55459e-08,-2.59032e-12,-26514.5,19.3805], Tmin=(100,'K'), Tmax=(1436.49,'K')), NASAPolynomial(coeffs=[12.5964,0.0120762,-5.72985e-06,1.1132e-09,-7.85301e-14,-29587.3,-36.0932], Tmin=(1436.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (171.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,1855,455,950,288.13,288.132,288.133,288.134,288.138,288.14,288.14,1786.41],'cm^-1')),
        HinderedRotor(inertia=(0.12881,'amu*angstrom^2'), symmetry=1, barrier=(7.58885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.016421,'amu*angstrom^2'), symmetry=1, barrier=(37.1865,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0381,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60255,0.0639872,-0.000131916,1.2985e-07,-4.71415e-11,20692.1,16.5541], Tmin=(100,'K'), Tmax=(863.947,'K')), NASAPolynomial(coeffs=[5.32327,0.0207698,-1.17556e-05,2.30621e-09,-1.58052e-13,21019.2,4.76157], Tmin=(863.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + ring(oxirene) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02606,0.0510548,-5.63373e-05,2.96726e-08,-5.70068e-12,-30179.4,24.6692], Tmin=(100,'K'), Tmax=(1535.76,'K')), NASAPolynomial(coeffs=[14.4371,0.00406924,1.32888e-06,-4.71393e-10,3.83718e-14,-32877,-41.1566], Tmin=(1535.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(COFOO) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC1(F)[CH]O1(5665)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[O]C1(F)[CH]O1(5683)'],
    products = ['O=[C]OC1(F)[CH]O1(5665)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C1(F)[CH]O1(5683)'],
    products = ['O=[C]OC1(F)[CH]O1(5665)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC1=CO1(5685)'],
    products = ['O=[C]OC1(F)[CH]O1(5665)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OC1(F)[CH]O1(5665)'],
    products = ['O=C(F)O[C]1[CH]O1(5686)'],
