...
"""),
    E0 = (-73.7102,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,293,496,537,1218,3120,650,792.5,1650,362.739,362.773,362.998],'cm^-1')),
        HinderedRotor(inertia=(0.181849,'amu*angstrom^2'), symmetry=1, barrier=(16.9423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181408,'amu*angstrom^2'), symmetry=1, barrier=(16.94,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181065,'amu*angstrom^2'), symmetry=1, barrier=(16.9426,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.887383,0.064962,-8.6417e-05,5.36763e-08,-1.26256e-11,-8750.14,21.2467], Tmin=(100,'K'), Tmax=(1059.62,'K')), NASAPolynomial(coeffs=[16.7861,0.0049453,-1.45732e-06,2.23331e-10,-1.42527e-14,-12119.5,-56.3761], Tmin=(1059.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.7102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CdCFO) + group(Cds-CdsHH) + radical(OCJO) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22489,0.0299976,-1.66569e-06,-2.16902e-08,1.07365e-11,-45362,16.5857], Tmin=(100,'K'), Tmax=(1002.04,'K')), NASAPolynomial(coeffs=[12.1818,0.0110579,-4.46057e-06,8.9142e-10,-6.73943e-14,-48402.1,-36.6834], Tmin=(1002.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-377.759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFO) + ring(Cs-Cd-Cd(F)-O2s)"""),
)
...
"""),
    E0 = (-216.954,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([293,496,537,1218,2782.5,750,1395,475,1775,1000,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.988186,'amu*angstrom^2'), symmetry=1, barrier=(22.7203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0326398,'amu*angstrom^2'), symmetry=1, barrier=(32.8918,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29393,0.0415882,-4.39792e-05,2.45088e-08,-5.73261e-12,-26035.5,16.7842], Tmin=(100,'K'), Tmax=(1003.88,'K')), NASAPolynomial(coeffs=[7.95994,0.019012,-1.0246e-05,2.10713e-09,-1.53884e-13,-27173.1,-10.573], Tmin=(1003.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (-68.8105,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,615,860,1140,1343,3152,1685,370,314.605,314.605,314.605,314.605],'cm^-1')),
        HinderedRotor(inertia=(0.232275,'amu*angstrom^2'), symmetry=1, barrier=(16.314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232275,'amu*angstrom^2'), symmetry=1, barrier=(16.314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232275,'amu*angstrom^2'), symmetry=1, barrier=(16.314,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.97183,0.0635179,-8.37991e-05,5.10924e-08,-1.15641e-11,-8164.15,21.4171], Tmin=(100,'K'), Tmax=(947.917,'K')), NASAPolynomial(coeffs=[16.3508,0.00500564,-1.31016e-06,1.82718e-10,-1.10826e-14,-11366.6,-53.4679], Tmin=(947.917,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.8105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(OCJO) + radical(Cdj(Cd-F1sH)(O2s-Cs))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]O(237)', '[CH]C(=O)F(6019)'],
    products = ['[CH]=C(F)O[CH]O(8903)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH]=C(F)O[CH]O(8903)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(4.81139,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(219.512,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction13',
    reactants = ['O[CH]O[C]=CF(9029)'],
    products = ['[CH]=C(F)O[CH]O(8903)'],
