...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH]C(=C)F(4004)'],
    products = ['[CH]=C(F)C[CH]F(3971)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)C=CF(3980)'],
    products = ['[CH]=C(F)C[CH]F(3971)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[CH]C(=C)F(4004)'],
    products = ['[CH]=C(F)C[CH]F(3971)'],
