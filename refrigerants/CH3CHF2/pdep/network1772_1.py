...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C=CO[C](O)F(6892)'],
    products = ['C=COC(O)(F)F(4687)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(4619)', 'CH2CHO(35)'],
    products = ['C=COC(O)(F)F(4687)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(O)(F)F(4647)', 'C2H3(29)'],
    products = ['C=COC(O)(F)F(4687)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'C=CO[C](F)F(4785)'],
    products = ['C=COC(O)(F)F(4687)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=[C]OC(O)(F)F(5060)'],
    products = ['C=COC(O)(F)F(4687)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=COC(O)(F)F(6893)'],
    products = ['C=COC(O)(F)F(4687)'],
