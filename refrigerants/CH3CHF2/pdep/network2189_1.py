...
reaction(
    label = 'reaction8',
    reactants = ['CHFCHF[Z](59)', '[CH2][CH2](612)'],
    products = ['[CH2]CC(F)[CH]F(5608)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]CC(F)=CF(5722)'],
    products = ['[CH2]CC(F)[CH]F(5608)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH][CH]F(5567)', 'C2H4(30)'],
    products = ['[CH2]CC(F)[CH]F(5608)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=CC(F)[CH]F(5640)'],
    products = ['[CH2]CC(F)[CH]F(5608)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][CH]F(5567)', '[CH2][CH2](612)'],
    products = ['[CH2]CC(F)[CH]F(5608)'],
