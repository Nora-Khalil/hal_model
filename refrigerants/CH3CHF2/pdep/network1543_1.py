...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.79088,'amu*angstrom^2'), symmetry=1, barrier=(41.1759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78394,'amu*angstrom^2'), symmetry=1, barrier=(41.0163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78475,'amu*angstrom^2'), symmetry=1, barrier=(41.0348,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90262,0.0297657,1.4808e-05,-5.44076e-08,2.6128e-11,-62380.7,19.1222], Tmin=(100,'K'), Tmax=(950.725,'K')), NASAPolynomial(coeffs=[19.4229,-0.00307487,2.13549e-06,-3.02141e-10,9.88404e-15,-67559.3,-74.2323], Tmin=(950.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-519.415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(O2sFO) + group(Cds-OdOsOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(4.92267e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.73116,0.0558218,-0.000164086,2.12464e-07,-9.12444e-11,2532.07,18.6366], Tmin=(100,'K'), Tmax=(850.803,'K')), NASAPolynomial(coeffs=[-13.2089,0.0561189,-3.3009e-05,6.63669e-09,-4.63723e-13,7946.06,108.84], Tmin=(850.803,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.8977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2sFO) + group(Cs-OsOsOsH) + radical(OCOJ) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])OOF(4403)'],
    products = ['O=C(O)OOF(4326)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]F(126)', '[O]C(=O)O(1596)'],
    products = ['O=C(O)OOF(4326)'],
    transitionState = 'TS4',
