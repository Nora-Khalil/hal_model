...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(=[CH])F(4101)'],
    products = ['[CH]=C(C)C(=[CH])F(6378)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(19)', '[CH]=C(F)C#C(4196)'],
    products = ['[CH]=C(C)C(=[CH])F(6378)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(C)C#C(6453)'],
    products = ['[CH]=C(C)C(=[CH])F(6378)'],
    transitionState = 'TS6',
