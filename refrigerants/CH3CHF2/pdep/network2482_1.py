...
"""),
    E0 = (-427.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,350,440,435,1725,194,682,905,1196,1383,3221,292.468,292.522,1991.51],'cm^-1')),
        HinderedRotor(inertia=(0.131732,'amu*angstrom^2'), symmetry=1, barrier=(7.99951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131772,'amu*angstrom^2'), symmetry=1, barrier=(7.99988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.547057,'amu*angstrom^2'), symmetry=1, barrier=(33.2173,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32921,0.0677295,-6.90114e-05,2.04327e-08,1.36453e-11,-51281.7,24.6748], Tmin=(100,'K'), Tmax=(532.72,'K')), NASAPolynomial(coeffs=[7.22121,0.0366515,-1.8567e-05,3.68684e-09,-2.6273e-13,-52096.2,-1.79318], Tmin=(532.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-427.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[CH2]C(OF)[C](F)CF(6309)',
...
"""),
    E0 = (-166.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,3000,3100,440,815,1455,1000,349.937,349.951,349.981],'cm^-1')),
        HinderedRotor(inertia=(0.0933022,'amu*angstrom^2'), symmetry=1, barrier=(8.1111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0932996,'amu*angstrom^2'), symmetry=1, barrier=(8.10965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139648,'amu*angstrom^2'), symmetry=1, barrier=(12.142,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.398749,'amu*angstrom^2'), symmetry=1, barrier=(34.6699,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.178694,0.0911036,-0.000141026,1.18505e-07,-3.97925e-11,-19912.6,29.7], Tmin=(100,'K'), Tmax=(788.678,'K')), NASAPolynomial(coeffs=[10.8935,0.0309283,-1.54849e-05,3.00922e-09,-2.09861e-13,-21421.3,-18.2991], Tmin=(788.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-166.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsCsF1s) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(OF)C(F)[CH]F(6310)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-164.868,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,259,529,569,1128,1321,1390,3140,3000,3100,440,815,1455,1000,334,575,1197,1424,3202,326.495,326.515,326.629],'cm^-1')),
        HinderedRotor(inertia=(0.108205,'amu*angstrom^2'), symmetry=1, barrier=(8.17032,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107953,'amu*angstrom^2'), symmetry=1, barrier=(8.1696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214245,'amu*angstrom^2'), symmetry=1, barrier=(16.2118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.432558,'amu*angstrom^2'), symmetry=1, barrier=(32.6907,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.030574,0.0937014,-0.000139731,1.09781e-07,-3.43728e-11,-19692,28.7551], Tmin=(100,'K'), Tmax=(782.996,'K')), NASAPolynomial(coeffs=[12.8752,0.0280798,-1.40108e-05,2.73243e-09,-1.91608e-13,-21703.3,-30.0697], Tmin=(782.996,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-164.868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CJCO) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'C[C](OF)C(F)[CH]F(6311)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.203614,'amu*angstrom^2'), symmetry=1, barrier=(4.68148,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201871,'amu*angstrom^2'), symmetry=1, barrier=(4.64141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202109,'amu*angstrom^2'), symmetry=1, barrier=(4.64689,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0744382,0.0959988,-0.00016031,1.42513e-07,-4.93698e-11,-23483.6,28.3748], Tmin=(100,'K'), Tmax=(832.134,'K')), NASAPolynomial(coeffs=[9.62348,0.0332548,-1.68482e-05,3.25441e-09,-2.24656e-13,-24489.7,-12.4352], Tmin=(832.134,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(C2CsJO) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.816507,'amu*angstrom^2'), symmetry=1, barrier=(18.7731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60363,'amu*angstrom^2'), symmetry=1, barrier=(36.8707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275945,'amu*angstrom^2'), symmetry=1, barrier=(6.34452,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.675933,0.0796621,-0.000115991,9.41737e-08,-3.12523e-11,-21623.3,25.425], Tmin=(100,'K'), Tmax=(733.352,'K')), NASAPolynomial(coeffs=[9.65047,0.0307115,-1.58682e-05,3.15525e-09,-2.24206e-13,-22939.6,-15.0887], Tmin=(733.352,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(OF)C(F)CF(6315)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
4  O u0 p2 c0 {3,S} {6,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF(279)', 'C=COF(207)'],
    products = ['C=C(OF)C(F)CF(6304)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'C=C([C]F)OF(579)'],
    products = ['C=C(OF)C(F)CF(6304)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'C=C(CF)OF(581)'],
    products = ['C=C(OF)C(F)CF(6304)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'C=C(OF)C(F)[C]F(6306)'],
    products = ['C=C(OF)C(F)CF(6304)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'C=C(OF)C(F)F(3255)'],
    products = ['C=C(OF)C(F)CF(6304)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(OF)[C](F)CF(6309)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(OF)C(F)[CH]F(6310)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[C](OF)C(F)[CH]F(6311)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(=CCF)OF(606)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)C(=C)OF(593)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'C=C([O])C(F)CF(675)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(126)', 'C=[C]C(F)CF(674)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(46)', 'C=C([CH]F)OF(591)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OF(202)', 'CH2F-CHF(66)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'C=C(OF)[C](F)CF(6312)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'C=C(OF)C(F)[CH]F(6313)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH]=C(OF)C(F)CF(6314)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'C=C(F)C(=C)OF(3267)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'C=C(C=CF)OF(3283)'],
    products = ['C=C(OF)C(F)CF(6304)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C=C(OF)C(F)CF(6304)'],
    products = ['F2(78)', 'CH2CO(28)', 'CH2CHF(56)'],
