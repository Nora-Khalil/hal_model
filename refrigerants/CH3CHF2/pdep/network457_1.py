...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FCCOF(495)'],
    products = ['O=C(CCF)OF(1385)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(C[C]F)OF(1440)'],
    products = ['O=C(CCF)OF(1385)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]CC(=O)OF(1446)'],
    products = ['O=C(CCF)OF(1385)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', 'O=[C]CCF(1350)'],
    products = ['O=C(CCF)OF(1385)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2F(46)', '[CH2]C(=O)OF(1447)'],
    products = ['O=C(CCF)OF(1385)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(167)', 'CH2F-CH2(62)'],
    products = ['O=C(CCF)OF(1385)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=C([CH]CF)OF(1448)'],
    products = ['O=C(CCF)OF(1385)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(C[CH]F)OF(1449)'],
    products = ['O=C(CCF)OF(1385)'],
