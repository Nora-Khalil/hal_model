...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(4646)', '[CH]O(237)'],
    products = ['[O]C(F)(F)O[CH]O(7260)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O[CH]O[C](F)F(4863)'],
    products = ['[O]C(F)(F)O[CH]O(7260)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)OC=O(4980)'],
    products = ['[O]C(F)(F)O[CH]O(7260)'],
    transitionState = 'TS7',
