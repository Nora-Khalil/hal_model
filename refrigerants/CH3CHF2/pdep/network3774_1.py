...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09909,0.0543835,-4.39833e-05,1.11832e-08,8.89561e-13,-83666.6,21.9276], Tmin=(100,'K'), Tmax=(1066.36,'K')), NASAPolynomial(coeffs=[17.1926,0.0102777,-4.81695e-06,9.98275e-10,-7.54631e-14,-88023.5,-61.0836], Tmin=(1066.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-696.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'O=C(O)OC(F)=CF(11328)',
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.929111,0.0665143,-7.89281e-05,4.47883e-08,-9.88057e-12,-53531,24.8578], Tmin=(100,'K'), Tmax=(1110.65,'K')), NASAPolynomial(coeffs=[15.8171,0.0128953,-6.51259e-06,1.32109e-09,-9.64229e-14,-56838.1,-48.5308], Tmin=(1110.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdOsOs) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.561586,0.0721953,-8.03164e-05,4.24282e-08,-8.70169e-12,-103478,25.994], Tmin=(100,'K'), Tmax=(1192.7,'K')), NASAPolynomial(coeffs=[17.9625,0.0138369,-6.92143e-06,1.40336e-09,-1.02474e-13,-107628,-61.0216], Tmin=(1192.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-861.415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsOs) + radical(CCsJOC(O))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(O)OC(F)[CH]F(10804)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C(F)OC(=O)O-2(11324)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', 'O=C(O)O[CH]F(2379)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'O=C(O)OC(F)[C]F(5549)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(O)OC(F)[CH]F(10804)'],
    products = ['O[C]1OC(F)C(F)O1(11325)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(O)OC(F)[CH]F(10804)'],
    products = ['[O]C1(O)OC(F)C1F(11326)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)OC=CF(11327)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)O(1596)', 'CHFCHF[Z](59)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(O)OC(F)=CF(11328)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C(O)O[CH][CH]F(11329)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)O(1596)', 'F[CH][CH]F(5595)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]O(165)', '[O]C(F)[CH]F(646)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'O=[C]OC(F)[CH]F(6125)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(=O)OC(F)[CH]F(11330)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=C(O)O[C](F)[CH]F(11331)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'O=C(O)O[CH]F(2379)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=C(O)OC(F)[C]F-2(5558)'],
    products = ['O=C(O)OC(F)[CH]F(10804)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=C(O)OC(F)[CH]F(10804)'],
    products = ['O=C(O)O[CH]C(F)F(11334)'],
...
network(
    label = 'PDepNetwork #3774',
    isomers = [
        'O=C(O)OC(F)[CH]F(10804)',
    ],
    reactants = [
        ('HF(38)', 'CO2(14)', 'O=C[CH]F(338)'),
        ('[O]C(=O)O(1596)', 'CHFCHF[Z](59)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
