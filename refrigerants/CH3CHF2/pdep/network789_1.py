...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.401537,'amu*angstrom^2'), symmetry=1, barrier=(9.23212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401496,'amu*angstrom^2'), symmetry=1, barrier=(9.23119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401545,'amu*angstrom^2'), symmetry=1, barrier=(9.23232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.9017,'amu*angstrom^2'), symmetry=1, barrier=(43.7239,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17684,0.071107,-0.000115645,1.09319e-07,-4.04545e-11,36918.4,22.0272], Tmin=(100,'K'), Tmax=(825.406,'K')), NASAPolynomial(coeffs=[4.70132,0.0356832,-1.79334e-05,3.47459e-09,-2.4106e-13,36961.5,9.48519], Tmin=(825.406,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
