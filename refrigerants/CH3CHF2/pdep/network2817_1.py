...
"""),
    E0 = (-420.627,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,388.775,388.775],'cm^-1')),
        HinderedRotor(inertia=(0.432311,'amu*angstrom^2'), symmetry=1, barrier=(46.3671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00111489,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.432452,'amu*angstrom^2'), symmetry=1, barrier=(46.3671,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91872,0.0402537,-2.69088e-05,8.25967e-09,-9.94031e-13,-50510.1,20.8917], Tmin=(100,'K'), Tmax=(1934.22,'K')), NASAPolynomial(coeffs=[14.7227,0.0137742,-6.37327e-06,1.18153e-09,-7.91503e-14,-55463.2,-49.3264], Tmin=(1934.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-420.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.914791,'amu*angstrom^2'), symmetry=1, barrier=(21.0328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.917464,'amu*angstrom^2'), symmetry=1, barrier=(21.0943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.917154,'amu*angstrom^2'), symmetry=1, barrier=(21.0872,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
...
"""),
    E0 = (-237.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,180,1201.32,1208.98],'cm^-1')),
        HinderedRotor(inertia=(0.177269,'amu*angstrom^2'), symmetry=1, barrier=(4.07577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1789,'amu*angstrom^2'), symmetry=1, barrier=(4.11326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.10106,'amu*angstrom^2'), symmetry=1, barrier=(48.3076,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
...
"""),
    E0 = (-246.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,551,1088,1226,1380,1420,1481,3057,3119,3000,3050,390,425,1340,1360,335,370,240.498,240.721,240.721,240.763],'cm^-1')),
        HinderedRotor(inertia=(0.00291287,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.359895,'amu*angstrom^2'), symmetry=1, barrier=(14.8077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.359963,'amu*angstrom^2'), symmetry=1, barrier=(14.8078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.360169,'amu*angstrom^2'), symmetry=1, barrier=(14.8077,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
