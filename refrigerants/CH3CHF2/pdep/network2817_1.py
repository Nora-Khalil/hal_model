...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=COO[CH]F(1367)'],
    products = ['O=COOC(F)F(5857)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)F(615)', '[O]C=O(166)'],
    products = ['O=COOC(F)F(5857)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HCO(15)', '[O]OC(F)F(2933)'],
    products = ['O=COOC(F)F(5857)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]OOC(F)F(5854)'],
    products = ['O=COOC(F)F(5857)'],
