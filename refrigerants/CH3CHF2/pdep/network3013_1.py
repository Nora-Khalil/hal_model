...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29876,0.0635855,-7.01601e-05,4.09232e-08,-9.81807e-12,-63401.9,23.355], Tmin=(100,'K'), Tmax=(994.75,'K')), NASAPolynomial(coeffs=[10.728,0.0256692,-1.29849e-05,2.60494e-09,-1.87855e-13,-65277.8,-22.0858], Tmin=(994.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-527.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFO) + radical(C=COJ) + radical(Allyl_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.605668,'amu*angstrom^2'), symmetry=1, barrier=(13.9255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.606396,'amu*angstrom^2'), symmetry=1, barrier=(13.9422,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07965,0.0673935,-8.12111e-05,5.10815e-08,-1.29229e-11,-41572.3,24.3505], Tmin=(100,'K'), Tmax=(958.171,'K')), NASAPolynomial(coeffs=[11.8448,0.0224538,-1.08599e-05,2.13409e-09,-1.52113e-13,-43635.3,-27.1254], Tmin=(958.171,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-346.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(O2sj(Cs-F1sF1sCd)) + radical(Cdj(Cd-CsCs)(F1s))"""),
)

species(
    label = 'C=C([C]F)C(O)(F)F(8248)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.644624,0.0805866,-0.000129715,1.1155e-07,-3.82359e-11,-54982.5,24.3112], Tmin=(100,'K'), Tmax=(775.251,'K')), NASAPolynomial(coeffs=[10.1149,0.0262139,-1.38514e-05,2.74845e-09,-1.93774e-13,-56285.3,-17.8989], Tmin=(775.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-458.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH2]C([CH]F)=C(F)OF(8249)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-147.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,326,540,652,719,1357,234,589,736,816,1240,3237,3000,3100,440,815,1455,1000,1369.1],'cm^-1')),
        HinderedRotor(inertia=(0.279185,'amu*angstrom^2'), symmetry=1, barrier=(6.41902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.32529,'amu*angstrom^2'), symmetry=1, barrier=(53.4631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0400879,'amu*angstrom^2'), symmetry=1, barrier=(53.4686,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03375,0.071084,-9.66678e-05,7.34365e-08,-2.29637e-11,-17621.2,25.3999], Tmin=(100,'K'), Tmax=(774.596,'K')), NASAPolynomial(coeffs=[9.22484,0.0287847,-1.47543e-05,2.93554e-09,-2.09289e-13,-18890.2,-12.0252], Tmin=(774.596,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFO) + radical(Allyl_P) + radical(Csj(Cd-CsCd)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=CF)C([O])(F)F(7501)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(=CF)C([O])(F)F(7501)'],
    products = ['[CH2]C(=C([O])F)C(F)F(8244)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([CH]F)=C(F)F(7828)'],
    products = ['[CH2]C(=CF)C([O])(F)F(7501)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', '[O]C(F)(F)[C]=CF(4992)'],
    products = ['[CH2]C(=CF)C([O])(F)F(7501)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=CF)C([O])(F)F(7501)'],
    products = ['[CH2][C]1C(F)OC1(F)F(8246)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=CF)C([O])(F)F(7501)'],
    products = ['[CH2]C1([CH]F)OC1(F)F(8150)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=CF)C(=O)F(7948)'],
    products = ['[CH2]C(=CF)C([O])(F)F(7501)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH]F)=C(F)OF(8249)'],
    products = ['[CH2]C(=CF)C([O])(F)F(7501)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]F(230)', 'C=[C]C([O])(F)F(4842)'],
    products = ['[CH2]C(=CF)C([O])(F)F(7501)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(=CF)C([O])(F)F(7501)'],
    products = ['F[CH][C]1COC1(F)F(8253)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CHF(40)', 'C=[C]C([O])(F)F(4842)'],
    products = ['[CH2]C(=CF)C([O])(F)F(7501)'],
