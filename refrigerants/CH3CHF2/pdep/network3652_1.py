...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91283,0.0462809,-3.56685e-05,1.505e-08,-2.70324e-12,347.216,19.5763], Tmin=(100,'K'), Tmax=(1270.75,'K')), NASAPolynomial(coeffs=[8.59799,0.0252378,-1.0829e-05,2.01866e-09,-1.3953e-13,-1351.82,-14.2775], Tmin=(1270.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.26599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-Cd(CCO)HH) + group(Cds-CdsCsH) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.470595,'amu*angstrom^2'), symmetry=1, barrier=(10.8199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.470982,'amu*angstrom^2'), symmetry=1, barrier=(10.8288,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81098,0.051618,-6.28505e-05,4.75245e-08,-1.52453e-11,28953.9,20.4222], Tmin=(100,'K'), Tmax=(750.312,'K')), NASAPolynomial(coeffs=[6.58218,0.0261681,-1.19436e-05,2.26765e-09,-1.57595e-13,28238.3,-1.22287], Tmin=(750.312,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-Cd(CCO)HH) + group(Cds-CdsCsH) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + missing(Cdd-CdO2d) + radical(Cds_S)"""),
)
...
"""),
    E0 = (283.955,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,1855,455,950,3120,650,792.5,1650,219.95],'cm^-1')),
        HinderedRotor(inertia=(0.233517,'amu*angstrom^2'), symmetry=1, barrier=(7.75267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235892,'amu*angstrom^2'), symmetry=1, barrier=(7.732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232703,'amu*angstrom^2'), symmetry=1, barrier=(7.72065,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83122,0.0502801,-4.80734e-05,2.71328e-08,-6.57728e-12,34227.9,23.3701], Tmin=(100,'K'), Tmax=(968.689,'K')), NASAPolynomial(coeffs=[7.48367,0.0269395,-1.19307e-05,2.25888e-09,-1.57785e-13,33132.8,-3.71992], Tmin=(968.689,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O) + radical(Cds_P)"""),
)

species(
    label = 'C=CC[CH][C]=O(10965)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {6,D}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {5,D} {9,S}
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7071,0.0447709,-2.97288e-05,8.35982e-09,-2.89037e-13,24669.6,23.1655], Tmin=(100,'K'), Tmax=(1111.27,'K')), NASAPolynomial(coeffs=[10.3515,0.0211692,-8.01291e-06,1.41648e-09,-9.57835e-14,22284.4,-21.5382], Tmin=(1111.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (361.837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,1685,370,3120,650,792.5,1650,254.331],'cm^-1')),
        HinderedRotor(inertia=(0.155339,'amu*angstrom^2'), symmetry=1, barrier=(7.13672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15558,'amu*angstrom^2'), symmetry=1, barrier=(7.13886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155475,'amu*angstrom^2'), symmetry=1, barrier=(7.13923,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.245,0.0455969,-2.27986e-05,-3.42305e-08,4.34473e-11,43575,21.6413], Tmin=(100,'K'), Tmax=(487.523,'K')), NASAPolynomial(coeffs=[5.34578,0.0315735,-1.4782e-05,2.84605e-09,-1.99662e-13,43137,7.51787], Tmin=(487.523,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(361.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(128)', '[CH2]C[C]=C(1912)'],
    products = ['C=[C]CC[C]=O(10717)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C[C]=C(1912)'],
    products = ['C=[C]CC[C]=O(10717)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=[C]CC=C=O(10962)'],
    products = ['C=[C]CC[C]=O(10717)'],
