...
reaction(
    label = 'reaction1',
    reactants = ['CHF2(81)', 'C2HF(58)'],
    products = ['[CH]=C(F)C(F)F(3988)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[C]=C(F)C(F)F(4277)'],
    products = ['[CH]=C(F)C(F)F(3988)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=[C]C(F)F(3590)'],
    products = ['[CH]=C(F)C(F)F(3988)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]C(F)=C(F)F(4042)'],
    products = ['[CH]=C(F)C(F)F(3988)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'C#C[C](F)F(4278)'],
    products = ['[CH]=C(F)C(F)F(3988)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)C(F)F(3988)'],
    products = ['C=C(F)[C](F)F(4279)'],
