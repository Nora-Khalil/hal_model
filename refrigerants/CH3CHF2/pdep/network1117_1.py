...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]O[O](335)'],
    products = ['[O]OC[C](F)F(3041)'],
    transitionState = 'TS3',
