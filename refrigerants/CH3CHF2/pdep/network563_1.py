...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C#COC(F)C=O(2709)'],
    products = ['C#COC(F)C[O](1696)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CO[CH]C[O](1940)'],
    products = ['C#COC(F)C[O](1696)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C#CO[C](F)C[O](2710)'],
    products = ['C#COC(F)C[O](1696)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#COC(F)[CH][O](2711)'],
    products = ['C#COC(F)C[O](1696)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[C]#COC(F)C[O](2712)'],
    products = ['C#COC(F)C[O](1696)'],
