...
"""),
    ...
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.59077,0.0164986,-4.23089e-06,-1.37346e-09,4.87116e-13,11406.8,16.0753], Tmin=(100,'K'), Tmax=(1986.88,'K')), NASAPolynomial(coeffs=[10.7987,0.00995734,-5.30935e-06,1.00725e-09,-6.64608e-14,6969.46,-27.6062], Tmin=(1986.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.7754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsCsF1s) + radical(cyclopropane) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[C]1C[C]1F(6975)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.73006,0.0172538,-6.18353e-06,-3.44564e-11,2.01658e-13,7135.61,15.2106], Tmin=(100,'K'), Tmax=(2242.78,'K')), NASAPolynomial(coeffs=[14.2953,0.00588363,-3.577e-06,6.76396e-10,-4.31825e-14,517.028,-48.4844], Tmin=(2242.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.3367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsCsF1s) + radical(CsCsCsF1s) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (97.7924,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([303,403,394,494,1203,1303,3095,3195,817.765,817.866,817.871,817.879,817.917,818.067,818.12],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71095,0.0230384,-4.36193e-06,-8.4136e-09,3.88382e-12,11812.5,21.4692], Tmin=(100,'K'), Tmax=(1142.97,'K')), NASAPolynomial(coeffs=[8.60192,0.0135124,-6.41498e-06,1.27325e-09,-9.1826e-14,9741.47,-10.9075], Tmin=(1142.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.7924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(CsCCFH) + group(CsJ2_singlet-CsH) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + ring(Cyclopropane)"""),
)
...
"""),
    ...
    molecularWeight = (56.0383,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.765,0.0324079,-6.18372e-05,5.77306e-08,-1.96558e-11,55889.2,8.11343], Tmin=(100,'K'), Tmax=(926.901,'K')), NASAPolynomial(coeffs=[4.70598,0.0105105,-4.51981e-06,7.67678e-10,-4.72791e-14,56110.2,2.02983], Tmin=(926.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(464.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Ct-CtCs) + group(Ct-CtCs) + ring(Cyclopropyne)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC1=C(F)[CH]1(5732)'],
    products = ['FC1=CC1F(5208)'],
    transitionState = 'TS9',
