...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38785,0.0438499,-4.36619e-07,-4.17042e-08,2.24809e-11,-19209.7,22.2819], Tmin=(100,'K'), Tmax=(923.763,'K')), NASAPolynomial(coeffs=[17.5533,0.00908055,-1.18336e-06,1.18696e-10,-1.04729e-14,-23699.5,-62.5612], Tmin=(923.763,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-160.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.126869,'amu*angstrom^2'), symmetry=1, barrier=(6.61653,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91684,0.0382874,1.66122e-06,-3.65107e-08,2.05377e-11,12323.1,18.4466], Tmin=(100,'K'), Tmax=(849.371,'K')), NASAPolynomial(coeffs=[11.4682,0.0171419,-3.08933e-06,2.57072e-10,-8.9881e-15,9840.8,-31.1351], Tmin=(849.371,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1([O])OC1C(2476)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  O u1 p2 c0 {4,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {7,S}
...
"""),
    E0 = (-54.4932,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,378.713,379.271],'cm^-1')),
        HinderedRotor(inertia=(0.00116759,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100783,'amu*angstrom^2'), symmetry=1, barrier=(10.4449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102619,'amu*angstrom^2'), symmetry=1, barrier=(10.4331,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16324,0.0548444,-4.21215e-05,7.56109e-09,3.40958e-12,-6445.01,25.7186], Tmin=(100,'K'), Tmax=(948.053,'K')), NASAPolynomial(coeffs=[15.4408,0.0126071,-3.77677e-06,6.26203e-10,-4.33006e-14,-9961.21,-46.6675], Tmin=(948.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.4932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)=C(C)[O](2506)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (73.5699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,224.895],'cm^-1')),
        HinderedRotor(inertia=(0.445527,'amu*angstrom^2'), symmetry=1, barrier=(15.9799,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.445337,'amu*angstrom^2'), symmetry=1, barrier=(15.9799,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.445641,'amu*angstrom^2'), symmetry=1, barrier=(15.9806,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04525,0.0530665,-2.5224e-05,-1.69601e-08,1.36165e-11,8965.74,24.219], Tmin=(100,'K'), Tmax=(938.173,'K')), NASAPolynomial(coeffs=[18.5262,0.00842818,-1.64962e-06,2.51603e-10,-2.0445e-14,4370.12,-66.0124], Tmin=(938.173,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.5699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C([O])C(=C)O(2508)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {12,S}
2  O u1 p2 c0 {3,S}
3  C u0 p0 c0 {2,S} {4,S} {5,S} {7,S}
...
"""),
    E0 = (38.0628,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,390.142,390.232],'cm^-1')),
        HinderedRotor(inertia=(0.146518,'amu*angstrom^2'), symmetry=1, barrier=(15.8195,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146347,'amu*angstrom^2'), symmetry=1, barrier=(15.8168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146401,'amu*angstrom^2'), symmetry=1, barrier=(15.8167,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.967244,0.0547276,-2.83013e-05,-1.51957e-08,1.33785e-11,4698.11,24.7296], Tmin=(100,'K'), Tmax=(934.453,'K')), NASAPolynomial(coeffs=[19.0745,0.00752294,-1.17358e-06,1.56108e-10,-1.36409e-14,-9.08572,-68.4796], Tmin=(934.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.0628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH]=C([O])C(C)O(2509)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0912941,'amu*angstrom^2'), symmetry=1, barrier=(9.65239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.091753,'amu*angstrom^2'), symmetry=1, barrier=(9.61567,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10015,0.0484222,-3.98255e-06,-4.4888e-08,2.5336e-11,-11687.7,21.2261], Tmin=(100,'K'), Tmax=(916.205,'K')), NASAPolynomial(coeffs=[20.3277,0.00493581,9.75693e-07,-2.99117e-10,1.81207e-14,-16909.1,-79.1199], Tmin=(916.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.1641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=C(O)CJ)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20217,0.0439035,-3.08952e-05,1.2748e-08,-2.49855e-12,37589.4,17.441], Tmin=(100,'K'), Tmax=(1073.13,'K')), NASAPolynomial(coeffs=[5.24472,0.0325627,-1.50435e-05,2.90042e-09,-2.04436e-13,36936.4,2.54766], Tmin=(1073.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(312.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(C2CsJOO) + radical(CJCOOH)"""),
)

species(
    label = 'CC([O])=C(C)[O](2514)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
2  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35681,0.0538278,-4.87766e-05,2.09704e-08,-2.70699e-12,-21960,20.8815], Tmin=(100,'K'), Tmax=(959.637,'K')), NASAPolynomial(coeffs=[12.315,0.0172342,-5.77434e-06,9.59129e-10,-6.31469e-14,-24481.4,-33.7128], Tmin=(959.637,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(C)OJ) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH2]C([O])C(C)=O(2515)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {1,S} {5,S} {6,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00499314,'amu*angstrom^2'), symmetry=1, barrier=(3.64696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0205195,'amu*angstrom^2'), symmetry=1, barrier=(14.9703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.649913,'amu*angstrom^2'), symmetry=1, barrier=(14.9428,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56677,0.0469941,-3.43089e-05,1.1659e-08,-1.2653e-12,3370.05,25.9496], Tmin=(100,'K'), Tmax=(1189.93,'K')), NASAPolynomial(coeffs=[11.8782,0.0190214,-7.47993e-06,1.35232e-09,-9.2497e-14,442.469,-27.5803], Tmin=(1189.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.2467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(C=OCOJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C([O])C[O](854)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', '[CH2]C(=O)C=O(929)'],
    products = ['C=C([O])C(C)[O](2311)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=O)C(C)=O(2150)'],
    products = ['C=C([O])C(C)[O](2311)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(18)', 'CC([O])[C]=O(2511)'],
    products = ['C=C([O])C(C)[O](2311)'],
