...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[C]=O(690)', '[CH]C-2(611)'],
    products = ['C[CH]OC[C]=O(2301)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH2]O[CH]C(1780)'],
    products = ['C[CH]OC[C]=O(2301)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[CH2]O[CH]C(1780)'],
    products = ['C[CH]OC[C]=O(2301)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C[CH]OC=C=O(2494)'],
    products = ['C[CH]OC[C]=O(2301)'],
