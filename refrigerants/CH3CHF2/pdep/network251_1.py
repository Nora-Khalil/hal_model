...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=O)C=O(929)'],
    products = ['C=C([O])C([O])F(987)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)F(1031)'],
    products = ['C=C([O])C([O])F(987)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O][CH]F(516)', '[CH2][C]=O(136)'],
    products = ['C=C([O])C([O])F(987)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(18)', '[O]C(F)[C]=O(1038)'],
    products = ['C=C([O])C([O])F(987)'],
