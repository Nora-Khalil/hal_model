...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C(F)[CH]F(647)'],
    products = ['[CH2]C(F)C([O])F(619)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(F)C(=O)F(651)'],
    products = ['[CH2]C(F)C([O])F(619)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C(F)=C[O](652)'],
    products = ['[CH2]C(F)C([O])F(619)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[CH2][CH]C(=O)F(653)'],
    products = ['[CH2]C(F)C([O])F(619)'],
