...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', '[CH2]C([O])F(141)'],
    products = ['[CH2]C(F)O[CH]F(619)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]O[CH]F(639)'],
    products = ['[CH2]C(F)O[CH]F(619)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(F)O[CH]F(642)'],
    products = ['[CH2]C(F)O[CH]F(619)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]C([O])F(141)'],
    products = ['[CH2]C(F)O[CH]F(619)'],
