...
"""),
    E0 = (305.253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,3150,900,1100,972.058,972.059,972.082,972.096],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (58.0542,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.20035,0.00737745,3.81098e-05,-5.51261e-08,2.1519e-11,36751.4,11.0544], Tmin=(100,'K'), Tmax=(966.031,'K')), NASAPolynomial(coeffs=[9.39335,0.0075811,-2.33982e-06,4.85006e-10,-4.02745e-14,34348.9,-24.8514], Tmin=(966.031,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(305.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (271.452,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,918.869,918.869,918.872,918.872,918.875,918.875,3181.82],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (40.0638,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.63519,-0.00323132,6.10382e-05,-7.68394e-08,2.92233e-11,32671.6,7.35715], Tmin=(100,'K'), Tmax=(938.644,'K')), NASAPolynomial(coeffs=[7.97929,0.00707117,-1.47309e-06,2.63791e-10,-2.31972e-14,30586.7,-20.0872], Tmin=(938.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), label="""cC3H4""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (495.033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1021.42,1355.48,1355.9,1357.09,1359.99,1360.23,3268.57],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (40.0638,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.01739,-0.00758251,5.68441e-05,-6.034e-08,2.02381e-11,59544.4,11.4946], Tmin=(100,'K'), Tmax=(999.236,'K')), NASAPolynomial(coeffs=[3.49391,0.0142619,-5.59358e-06,1.09608e-09,-8.12451e-14,58663.1,9.08624], Tmin=(999.236,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(495.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(cyclopropane) + radical(cyclopropane)"""),
)
...
"""),
    ...
    molecularWeight = (39.0558,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.9457,-0.0154814,9.80946e-05,-1.20728e-07,4.66657e-11,52246.9,4.80943], Tmin=(100,'K'), Tmax=(917.276,'K')), NASAPolynomial(coeffs=[10.2691,-0.000173686,2.93752e-06,-6.031e-10,3.55075e-14,49282.7,-34.9851], Tmin=(917.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(cyclopropenyl-allyl)"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', '[CH]1[CH]C1(9414)'],
    products = ['FC1[CH]C1(6100)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'FC1[CH][CH]1(8666)'],
    products = ['FC1[CH]C1(6100)'],
