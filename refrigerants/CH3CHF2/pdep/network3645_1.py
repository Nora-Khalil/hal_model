...
"""),
    E0 = (-393.016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,180],'cm^-1')),
        HinderedRotor(inertia=(0.27435,'amu*angstrom^2'), symmetry=1, barrier=(6.30784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274616,'amu*angstrom^2'), symmetry=1, barrier=(6.31396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2932,'amu*angstrom^2'), symmetry=1, barrier=(29.7333,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77954,0.0601136,-3.55196e-05,-7.01421e-08,9.51301e-11,-47200.8,21.5721], Tmin=(100,'K'), Tmax=(455.746,'K')), NASAPolynomial(coeffs=[7.16303,0.0337037,-1.71874e-05,3.3762e-09,-2.37204e-13,-47907.9,-2.54414], Tmin=(455.746,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-393.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsHHH) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-3.40346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,181.268,1602.09],'cm^-1')),
        HinderedRotor(inertia=(0.0633701,'amu*angstrom^2'), symmetry=1, barrier=(1.457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346255,'amu*angstrom^2'), symmetry=1, barrier=(7.96109,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73269,'amu*angstrom^2'), symmetry=1, barrier=(39.8379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73337,'amu*angstrom^2'), symmetry=1, barrier=(39.8535,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51204,0.0604037,-8.60822e-05,7.63721e-08,-2.82548e-11,-325.217,20.3193], Tmin=(100,'K'), Tmax=(753.156,'K')), NASAPolynomial(coeffs=[5.72339,0.031654,-1.61107e-05,3.18263e-09,-2.25194e-13,-778.534,2.39774], Tmin=(753.156,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.40346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cs-OsHHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (55.5215,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.145099,'amu*angstrom^2'), symmetry=1, barrier=(3.3361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145106,'amu*angstrom^2'), symmetry=1, barrier=(3.33627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0599,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55772,0.0276485,-1.41029e-05,1.38445e-09,7.68502e-13,6732.98,13.7363], Tmin=(100,'K'), Tmax=(1177.94,'K')), NASAPolynomial(coeffs=[7.88975,0.0154487,-6.08882e-06,1.10561e-09,-7.57572e-14,5067.05,-14.6001], Tmin=(1177.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.5215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CsJOOC)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.121141,'amu*angstrom^2'), symmetry=1, barrier=(2.78527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.489959,'amu*angstrom^2'), symmetry=1, barrier=(11.2651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.32561,'amu*angstrom^2'), symmetry=1, barrier=(53.4704,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85978,0.0536576,-5.40529e-05,2.33638e-08,2.29205e-12,-47992.5,21.79], Tmin=(100,'K'), Tmax=(548.921,'K')), NASAPolynomial(coeffs=[5.86923,0.032163,-1.64184e-05,3.28535e-09,-2.35798e-13,-48549.1,3.79183], Tmin=(548.921,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-399.621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.165824,'amu*angstrom^2'), symmetry=1, barrier=(3.81263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16644,'amu*angstrom^2'), symmetry=1, barrier=(3.82679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.14879,'amu*angstrom^2'), symmetry=1, barrier=(49.405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.14754,'amu*angstrom^2'), symmetry=1, barrier=(49.3763,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.949788,0.0757683,-0.000125763,1.16411e-07,-4.23696e-11,-24743.8,24.639], Tmin=(100,'K'), Tmax=(811.932,'K')), NASAPolynomial(coeffs=[6.53381,0.0325826,-1.70199e-05,3.34466e-09,-2.33873e-13,-25133.9,2.04459], Tmin=(811.932,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]OOC[C](F)F(11507)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-199.419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,3000,3100,440,815,1455,1000,2163.74],'cm^-1')),
        HinderedRotor(inertia=(1.65621,'amu*angstrom^2'), symmetry=1, barrier=(38.0796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551805,'amu*angstrom^2'), symmetry=1, barrier=(12.6871,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65621,'amu*angstrom^2'), symmetry=1, barrier=(38.0794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65635,'amu*angstrom^2'), symmetry=1, barrier=(38.0827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.932356,0.0736966,-0.000111446,9.52334e-08,-3.31674e-11,-23880.1,24.1065], Tmin=(100,'K'), Tmax=(751.903,'K')), NASAPolynomial(coeffs=[8.53624,0.0293492,-1.52033e-05,3.00976e-09,-2.12743e-13,-24913.4,-9.67728], Tmin=(751.903,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsHHH) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(CsJOOC)"""),
)

species(
    label = 'COOC[C]F-2(11508)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.32171,'amu*angstrom^2'), symmetry=1, barrier=(7.39674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321362,'amu*angstrom^2'), symmetry=1, barrier=(7.38873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70867,0.0549822,-6.99788e-05,5.75317e-08,-2.0468e-11,-822.558,21.3118], Tmin=(100,'K'), Tmax=(714.716,'K')), NASAPolynomial(coeffs=[5.77687,0.0305096,-1.50401e-05,2.94991e-09,-2.08705e-13,-1360.55,3.35602], Tmin=(714.716,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.48924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04097,0.0715834,-0.000103778,9.08959e-08,-3.29421e-11,-49096.1,23.4763], Tmin=(100,'K'), Tmax=(757.086,'K')), NASAPolynomial(coeffs=[6.74578,0.0347896,-1.76979e-05,3.48933e-09,-2.46436e-13,-49769.2,-1.19942], Tmin=(757.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-409.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsHHH) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]OOCC(F)F(11510)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22062,0.0669086,-7.88366e-05,5.32315e-08,-1.51908e-11,-48240.7,22.2536], Tmin=(100,'K'), Tmax=(835.833,'K')), NASAPolynomial(coeffs=[8.52183,0.0319671,-1.61291e-05,3.21489e-09,-2.30442e-13,-49461.2,-11.6612], Tmin=(835.833,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-401.886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsHHH) + radical(CsJOOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OOC[C](F)F(2989)'],
    products = ['COOC[C](F)F(3353)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(2927)', '[CH2]OOC(5260)'],
    products = ['COOC[C](F)F(3353)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3O(27)', '[O]C[C](F)F(2986)'],
    products = ['COOC[C](F)F(3353)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(14.7519,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[O]OC[C](F)F(3041)'],
    products = ['COOC[C](F)F(3353)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'COO[CH][C](F)F(11506)'],
    products = ['COOC[C](F)F(3353)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]OOC[C](F)F(11507)'],
    products = ['COOC[C](F)F(3353)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'COOC[C]F-2(11508)'],
    products = ['COOC[C](F)F(3353)'],
...
reaction(
    label = 'reaction15',
    reactants = ['COOC[C](F)F(3353)'],
    products = ['[CH2]OOCC(F)F(11510)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(38738.3,'s^-1'), n=1.755, Ea=(50.208,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_SSSS;C_rad_out_single;Cs_H_out_2H] for rate rule [R5H_SSSS;C_rad_out_noH;Cs_H_out_2H]
Euclidian distance = 1.0
