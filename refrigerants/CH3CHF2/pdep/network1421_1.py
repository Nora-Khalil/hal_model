...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(O)C([CH2])OF(3929)'],
    products = ['C=C(OF)C(C)O(3862)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.437e+08,'s^-1'), n=1.045, Ea=(63.4002,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R3radExo;Y_rad;XH_Rrad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C=C([O])C(C)O(3931)'],
    products = ['C=C(OF)C(C)O(3862)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C(OF)C(C)[O](3932)'],
    products = ['C=C(OF)C(C)O(3862)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(126)', 'C=[C]C(C)O(3933)'],
    products = ['C=C(OF)C(C)O(3862)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', '[CH2]C(=CO)OF(1754)'],
    products = ['C=C(OF)C(C)O(3862)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(OF)=C(C)O(3934)'],
    products = ['C=C(OF)C(C)O(3862)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(O)C(=C)OF(3935)'],
    products = ['C=C(OF)C(C)O(3862)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH]=C(OF)C(C)O(3936)'],
    products = ['C=C(OF)C(C)O(3862)'],
