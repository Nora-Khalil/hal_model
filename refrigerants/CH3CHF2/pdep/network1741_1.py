...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2927)', '[O]C[O](778)'],
    products = ['[O]CO[C](F)F(4659)'],
    transitionState = 'TS2',
