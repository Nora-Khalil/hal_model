...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]O[CH]F(640)'],
    products = ['[CH2]C(F)O[CH]F(620)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(F)O[CH]F(643)'],
    products = ['[CH2]C(F)O[CH]F(620)'],
    transitionState = 'TS9',
