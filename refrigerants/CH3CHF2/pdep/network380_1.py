...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C]=O(721)'],
    products = ['[CH2]C(=O)O[C]=C(1247)'],
    transitionState = 'TS3',
