...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C([O])=C=O(1500)'],
    products = ['[CH2]C(=O)C([O])=O(1402)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([O])=C=O(1317)'],
    products = ['[CH2]C(=O)C([O])=O(1402)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C]=O(293)', '[CH2][C]=O(136)'],
    products = ['[CH2]C(=O)C([O])=O(1402)'],
