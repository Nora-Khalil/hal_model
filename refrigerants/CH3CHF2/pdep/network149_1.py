...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(395)', '[CH]=C[O](133)'],
    products = ['[CH]=CO[C]=C(541)'],
    transitionState = 'TS2',
