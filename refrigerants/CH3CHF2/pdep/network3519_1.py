...
"""),
    ...
    molecularWeight = (121.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.222446,0.0902739,-0.000130403,1.09728e-07,-3.76876e-11,-51579,28.8042], Tmin=(100,'K'), Tmax=(780.761,'K')), NASAPolynomial(coeffs=[8.98643,0.0387825,-1.88135e-05,3.63239e-09,-2.53278e-13,-52746.7,-10.0214], Tmin=(780.761,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-429.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C=C(CCF)OF(10156)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {6,S}
...
"""),
    ...
    molecularWeight = (121.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.689962,0.073465,-6.79807e-05,3.32343e-08,-6.68283e-12,-17517.7,27.5111], Tmin=(100,'K'), Tmax=(1175.01,'K')), NASAPolynomial(coeffs=[13.0619,0.0313477,-1.4214e-05,2.72843e-09,-1.9222e-13,-20425.1,-34.1716], Tmin=(1175.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_P)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.600373,0.0759801,-7.96402e-05,4.38166e-08,-9.76076e-12,18685.9,28.7529], Tmin=(100,'K'), Tmax=(1078.77,'K')), NASAPolynomial(coeffs=[13.5844,0.0278353,-1.26947e-05,2.44427e-09,-1.72701e-13,15884.6,-34.8717], Tmin=(1078.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsCsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'FCC1CC[C]1OF(10158)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (121.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.765319,0.0611389,-3.48626e-05,3.81744e-09,2.0562e-12,-7770.14,26.644], Tmin=(100,'K'), Tmax=(1149.98,'K')), NASAPolynomial(coeffs=[14.7868,0.0279257,-1.18338e-05,2.23182e-09,-1.56687e-13,-12023.8,-47.4339], Tmin=(1149.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.6422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFHH) + ring(Cyclobutane) + radical(C2CsJO)"""),
)

species(
    label = '[CH2]C1(OF)CC1CF(10159)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {5,S}
...
"""),
    ...
    molecularWeight = (121.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.520098,0.0762418,-7.16932e-05,3.53276e-08,-7.10115e-12,-5447.66,24.5726], Tmin=(100,'K'), Tmax=(1182.35,'K')), NASAPolynomial(coeffs=[14.0384,0.0305079,-1.3672e-05,2.61229e-09,-1.83666e-13,-8644.31,-42.9096], Tmin=(1182.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.338,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFHH) + ring(Cs(C-F)-Cs-Cs) + radical(CJC(C)2O)"""),
)
...
"""),
    E0 = (-108.781,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,318.937,319.167,3836.43],'cm^-1')),
        HinderedRotor(inertia=(0.246176,'amu*angstrom^2'), symmetry=1, barrier=(17.8161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16721,'amu*angstrom^2'), symmetry=1, barrier=(84.154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.246455,'amu*angstrom^2'), symmetry=1, barrier=(17.8209,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.517594,0.0665388,-6.16044e-05,2.98677e-08,-5.68615e-12,-12949.4,28.8582], Tmin=(100,'K'), Tmax=(1339.79,'K')), NASAPolynomial(coeffs=[15.7901,0.0187968,-5.75171e-06,8.80838e-10,-5.43127e-14,-16849.3,-48.5719], Tmin=(1339.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.781,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Isobutyl)"""),
)
...
"""),
    E0 = (205.815,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,394.264,394.548],'cm^-1')),
        HinderedRotor(inertia=(0.0765642,'amu*angstrom^2'), symmetry=1, barrier=(8.48392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.077432,'amu*angstrom^2'), symmetry=1, barrier=(8.4883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.907952,'amu*angstrom^2'), symmetry=1, barrier=(100.057,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48192,0.0521529,-4.16746e-05,1.83992e-08,-3.37104e-12,24847.1,24.3092], Tmin=(100,'K'), Tmax=(1283.46,'K')), NASAPolynomial(coeffs=[10.3268,0.0245872,-9.45792e-06,1.66484e-09,-1.11404e-13,22576.7,-20.5693], Tmin=(1283.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(205.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
"""),
    E0 = (9.20611,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,212,931,1104,1251,1325,1474,3102,3155,325,375,415,465,420,450,1700,1750,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,636.525,3318.35],'cm^-1')),
        HinderedRotor(inertia=(0.637673,'amu*angstrom^2'), symmetry=1, barrier=(14.6613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0147947,'amu*angstrom^2'), symmetry=1, barrier=(14.6555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.87382,'amu*angstrom^2'), symmetry=1, barrier=(43.0828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.87461,'amu*angstrom^2'), symmetry=1, barrier=(43.1009,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.554199,0.0796465,-9.3391e-05,5.96211e-08,-1.5511e-11,1228.06,27.2534], Tmin=(100,'K'), Tmax=(928.597,'K')), NASAPolynomial(coeffs=[11.9465,0.0305745,-1.41251e-05,2.71536e-09,-1.91021e-13,-887.78,-26.8644], Tmin=(928.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.20611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(Allyl_P) + radical(C=C(O)CJ)"""),
)
...
"""),
    E0 = (-141.288,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,551,1088,1226,1380,1420,1481,3057,3119,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,350,440,435,1725,2950,3100,1380,975,1025,1650,430.657,431.064,1407.66],'cm^-1')),
        HinderedRotor(inertia=(0.206008,'amu*angstrom^2'), symmetry=1, barrier=(27.0704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0641316,'amu*angstrom^2'), symmetry=1, barrier=(8.42943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205993,'amu*angstrom^2'), symmetry=1, barrier=(27.0779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0641421,'amu*angstrom^2'), symmetry=1, barrier=(8.43483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.105,'amu'),
...
species(
    label = 'C=C([O])C(CF)CF(10164)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {7,S}
4  C u0 p0 c0 {5,S} {6,S} {7,S} {9,S}
5  C u0 p0 c0 {2,S} {4,S} {10,S} {13,S}
...
"""),
    ...
    molecularWeight = (121.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.292944,0.074784,-6.9273e-05,3.28556e-08,-6.19171e-12,-60321.6,28.1275], Tmin=(100,'K'), Tmax=(1282.56,'K')), NASAPolynomial(coeffs=[16.7361,0.0235013,-9.29555e-06,1.67954e-09,-1.14735e-13,-64539.4,-55.2933], Tmin=(1282.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-502.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(CsCsFHH) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
reaction(
    ...
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(CF)C(=C)OF(10090)'],
    products = ['[CH2]C(CF)C(=O)CF(10155)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(18)', '[CH2]C(=CCF)OF(606)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]C(CF)C(=C)OF-2(10157)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CF)C(=C)OF(10090)'],
    products = ['[CH2]C1(OF)CC1CF(10159)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2F(46)', 'C=CC(=C)OF(596)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]OF(202)', 'C=CCF(509)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C(CF)C(=C)OF(9276)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C([CH2])C(=C)OF(10160)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]C(CF)C(=C)[O](10161)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(126)', '[CH2]C([C]=C)CF(10162)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(46)', '[CH2]C=C([CH2])OF(437)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=[C]OF(202)', '[CH2][CH]CF(1337)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH2]C(CF)=C([CH2])OF(10163)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[CH]=C(OF)C([CH2])CF(9290)'],
    products = ['[CH2]C(CF)C(=C)OF(10090)'],
