...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[O]C[C]=O(690)'],
    products = ['O=[C]CO[C]=O(1407)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH2]O[C]=O(292)'],
    products = ['O=[C]CO[C]=O(1407)'],
    transitionState = 'TS3',
