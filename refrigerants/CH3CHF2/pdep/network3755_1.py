...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.223793,'amu*angstrom^2'), symmetry=1, barrier=(5.14544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224033,'amu*angstrom^2'), symmetry=1, barrier=(5.15096,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45208,0.0637356,-0.0001022,9.54695e-08,-3.50666e-11,-14756.6,25.592], Tmin=(100,'K'), Tmax=(823.9,'K')), NASAPolynomial(coeffs=[4.96459,0.0314517,-1.56946e-05,3.03523e-09,-2.10484e-13,-14818.4,12.4638], Tmin=(823.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-Cs)) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-114.14,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,493,600,700,1144,1293,3120,650,792.5,1650,180,180,3842.39],'cm^-1')),
        HinderedRotor(inertia=(0.285995,'amu*angstrom^2'), symmetry=1, barrier=(6.57558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.85558,'amu*angstrom^2'), symmetry=1, barrier=(42.6634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286323,'amu*angstrom^2'), symmetry=1, barrier=(6.58312,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42959,0.0624236,-9.31601e-05,8.22933e-08,-2.94328e-11,-13641,25.6035], Tmin=(100,'K'), Tmax=(795.055,'K')), NASAPolynomial(coeffs=[6.33142,0.0292339,-1.44528e-05,2.80458e-09,-1.95748e-13,-14150.9,4.77432], Tmin=(795.055,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-Cs)) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.212245,'amu*angstrom^2'), symmetry=1, barrier=(4.87993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211431,'amu*angstrom^2'), symmetry=1, barrier=(4.86121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214932,'amu*angstrom^2'), symmetry=1, barrier=(4.94171,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(2927)', 'C=[C]C[O](726)'],
    products = ['C=[C]CO[C](F)F(10788)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', '[CH2]O[C](F)F(3131)'],
    products = ['C=[C]CO[C](F)F(10788)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#CCO[C](F)F(8131)'],
    products = ['C=[C]CO[C](F)F(10788)'],
    transitionState = 'TS9',
