...
"""),
    E0 = (-549.299,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,275,321,533,585,746,850,1103,246,474,533,1155,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.285181,'amu*angstrom^2'), symmetry=1, barrier=(6.55687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.285103,'amu*angstrom^2'), symmetry=1, barrier=(6.55509,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.72167,0.0197823,0.000156542,-4.87353e-07,4.0652e-10,-66059.6,12.8958], Tmin=(10,'K'), Tmax=(443.839,'K')), NASAPolynomial(coeffs=[7.94091,0.026883,-1.99628e-05,6.83844e-09,-8.70094e-13,-66878.6,-9.03947], Tmin=(443.839,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-549.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""[CH]DC(F)C(O)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-287.162,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,323,467,575,827,1418,278.055,278.068],'cm^-1')),
        HinderedRotor(inertia=(0.144971,'amu*angstrom^2'), symmetry=1, barrier=(7.95394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145037,'amu*angstrom^2'), symmetry=1, barrier=(7.95424,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145005,'amu*angstrom^2'), symmetry=1, barrier=(7.9538,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.749669,0.0786267,-0.000116301,8.6137e-08,-2.34914e-11,-34427.2,25.3266], Tmin=(100,'K'), Tmax=(647.241,'K')), NASAPolynomial(coeffs=[11.1633,0.0240364,-1.24209e-05,2.45285e-09,-1.73009e-13,-35979.8,-21.9631], Tmin=(647.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CdCdJ2_triplet)"""),
)
...
"""),
    E0 = (-157.742,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,246,474,533,1155,3120,650,792.5,1650,207.635,207.643],'cm^-1')),
        HinderedRotor(inertia=(0.16887,'amu*angstrom^2'), symmetry=1, barrier=(5.16659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168859,'amu*angstrom^2'), symmetry=1, barrier=(5.1663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16885,'amu*angstrom^2'), symmetry=1, barrier=(5.16635,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.989067,0.0716248,-0.000109883,9.17828e-08,-3.05649e-11,-18868.7,25.2839], Tmin=(100,'K'), Tmax=(802.526,'K')), NASAPolynomial(coeffs=[9.4069,0.0244414,-1.19233e-05,2.29117e-09,-1.58703e-13,-20051.5,-12.4268], Tmin=(802.526,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = '[CH]=[C]CC(O)(F)F(7222)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {10,S}
...
"""),
    E0 = (-151.827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,1685,370,3120,650,792.5,1650,264.308],'cm^-1')),
        HinderedRotor(inertia=(0.22359,'amu*angstrom^2'), symmetry=1, barrier=(11.0814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223572,'amu*angstrom^2'), symmetry=1, barrier=(11.0815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223588,'amu*angstrom^2'), symmetry=1, barrier=(11.0815,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16643,0.0665474,-8.87092e-05,6.32709e-08,-1.81777e-11,-18162.3,24.218], Tmin=(100,'K'), Tmax=(847.734,'K')), NASAPolynomial(coeffs=[10.4776,0.0226145,-1.0976e-05,2.1428e-09,-1.51424e-13,-19741,-19.1653], Tmin=(847.734,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-151.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-327.035,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,246,474,533,1155,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.123957,'amu*angstrom^2'), symmetry=1, barrier=(2.85001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123164,'amu*angstrom^2'), symmetry=1, barrier=(2.83177,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00333,0.0704947,-9.27361e-05,6.44393e-08,-1.80272e-11,-39229.3,25.2402], Tmin=(100,'K'), Tmax=(869.468,'K')), NASAPolynomial(coeffs=[11.2126,0.0235281,-1.17118e-05,2.31535e-09,-1.6497e-13,-41004.7,-22.5858], Tmin=(869.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-327.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(CdCsCdF) + group(Cds-CdsHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    E0 = (-487.959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,275,321,533,585,746,850,1103,3010,987.5,1337.5,450,1655,323,467,575,827,1418,372.2,372.201,372.201,372.201],'cm^-1')),
        HinderedRotor(inertia=(0.536945,'amu*angstrom^2'), symmetry=1, barrier=(52.7849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.536948,'amu*angstrom^2'), symmetry=1, barrier=(52.7849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.536947,'amu*angstrom^2'), symmetry=1, barrier=(52.7849,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0059193,'amu*angstrom^2'), symmetry=1, barrier=(2.05829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.062631,'amu*angstrom^2'), symmetry=1, barrier=(21.8233,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99087,0.0442967,-3.3056e-05,1.10683e-08,-1.46483e-12,-35693.8,20.5229], Tmin=(100,'K'), Tmax=(1729.44,'K')), NASAPolynomial(coeffs=[13.9315,0.016679,-9.10183e-06,1.83428e-09,-1.29967e-13,-39823.8,-43.6244], Tmin=(1729.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.369,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CdCsCdF) + group(COCsFO) + group(Cds-CdsHH) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = '[CH]=C(F)C=C(O)F(8318)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-582.874,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,395,473,707,1436,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.248154,'amu*angstrom^2'), symmetry=1, barrier=(5.70555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248541,'amu*angstrom^2'), symmetry=1, barrier=(5.71444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248441,'amu*angstrom^2'), symmetry=1, barrier=(5.71216,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.551646,0.082745,-0.000130773,1.1193e-07,-3.79778e-11,-69985.9,26.9995], Tmin=(100,'K'), Tmax=(809.323,'K')), NASAPolynomial(coeffs=[9.79814,0.0284384,-1.41701e-05,2.73975e-09,-1.90109e-13,-71200.8,-13.9119], Tmin=(809.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-582.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'OC(F)(F)C[C]=CF(8322)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-581.823,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,615,860,1140,1343,3152,1685,370,333.213,333.277,333.473],'cm^-1')),
        HinderedRotor(inertia=(0.127753,'amu*angstrom^2'), symmetry=1, barrier=(10.0734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0015175,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127806,'amu*angstrom^2'), symmetry=1, barrier=(10.073,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0975,0.0669787,-7.50349e-05,4.42358e-08,-1.05983e-11,-69875.2,26.406], Tmin=(100,'K'), Tmax=(1003.57,'K')), NASAPolynomial(coeffs=[11.6778,0.0248099,-1.20092e-05,2.36988e-09,-1.69523e-13,-71998.9,-24.6759], Tmin=(1003.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-CsHH)(Cd-F1sH))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)CC(O)(F)F(8252)'],
    products = ['HF(38)', 'CF2O(49)', '[CH]=C=C(4302)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.98542e+10,'s^-1'), n=0.978818, Ea=(197.619,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C_Ext-2C-R',), comment="""Estimated from node Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C_Ext-2C-R"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C(O)(F)F(8293)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(145.904,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CF2(43)', '[CH]=C(F)CO(8196)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(188.379,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['H2O(3)', '[CH]=C(F)C=C(F)F(4174)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2CF2(57)', '[CH]=C(O)F(519)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[C]=C(F)CC(O)(F)F(8314)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CCC(O)(F)F(7062)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2HF(58)', '[CH2]C(O)(F)F(1116)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(8.48406,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=C(F)C[C](O)F(8315)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=[C]CC(O)(F)F(7222)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', '[CH]=C(F)C[C](F)F(4129)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH]=C(F)CC([O])(F)F(8316)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(4570)', '[CH]C(=C)F(4143)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(18.7856,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction14',
    reactants = ['[CH]=[C]F(1074)', '[CH2]C(O)(F)F(1116)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[CH]=C(F)C=C(O)F(8318)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(188.947,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction18',
    reactants = ['HF(38)', '[CH]=C=CC(O)(F)F(6874)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(270.521,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['C=C(F)[CH]C(O)(F)F(8319)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O[C](F)CC(F)=CF(8321)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(0.000550858,'s^-1'), n=4.50663, Ea=(239.715,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction22',
    reactants = ['OC(F)(F)C[C]=CF(8322)'],
    products = ['[CH]=C(F)CC(O)(F)F(8252)'],
...
network(
    label = 'PDepNetwork #3088',
    isomers = [
        '[CH]=C(F)CC(O)(F)F(8252)',
    ],
    reactants = [
