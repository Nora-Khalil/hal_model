...
"""),
    E0 = (163.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,401.148,2171.6],'cm^-1')),
        HinderedRotor(inertia=(0.0703344,'amu*angstrom^2'), symmetry=1, barrier=(9.20095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0204627,'amu*angstrom^2'), symmetry=1, barrier=(2.50455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399563,'amu*angstrom^2'), symmetry=1, barrier=(9.18674,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3362,0.0379301,-3.71701e-05,2.20962e-08,-5.55875e-12,19773.7,16.104], Tmin=(100,'K'), Tmax=(945.833,'K')), NASAPolynomial(coeffs=[6.70523,0.0194525,-7.86561e-06,1.44048e-09,-9.8918e-14,18947.2,-4.73057], Tmin=(945.833,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CJCO) + radical(CsJOCC)"""),
)
