...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(128)', '[CH2]C1O[C]1F(6072)'],
    products = ['O=[C]CC1O[C]1F(6049)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C1O[C]1F(6072)'],
    products = ['O=[C]CC1O[C]1F(6049)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]CC1=C(F)O1(6126)'],
    products = ['O=[C]CC1O[C]1F(6049)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=CC1O[C]1F(6127)'],
    products = ['O=[C]CC1O[C]1F(6049)'],
