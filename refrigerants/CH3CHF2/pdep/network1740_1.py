...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[C](F)F(2986)'],
    products = ['[O]CC([O])(F)F(4585)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C=O(4407)'],
    products = ['[O]CC([O])(F)F(4585)'],
    transitionState = 'TS9',
