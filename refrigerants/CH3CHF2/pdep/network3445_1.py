...
"""),
    E0 = (-966.693,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,259,529,569,1128,1321,1390,3140,375,361,584,565,722,1474,190,488,555,1236,1407,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.462717,'amu*angstrom^2'), symmetry=1, barrier=(10.6388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.466363,'amu*angstrom^2'), symmetry=1, barrier=(10.7226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.803936,'amu*angstrom^2'), symmetry=1, barrier=(18.4841,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00143841,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00143799,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00143889,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00881288,'amu*angstrom^2'), symmetry=1, barrier=(12.1811,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0612182,0.0951331,-0.000151577,1.17054e-07,-3.37261e-11,-71667.6,27.6864], Tmin=(100,'K'), Tmax=(659.318,'K')), NASAPolynomial(coeffs=[13.8714,0.0226797,-1.25191e-05,2.51225e-09,-1.77934e-13,-73734.9,-35.0547], Tmin=(659.318,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-1007.37,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,275,321,533,585,746,850,1103,350,440,435,1725,182,240,577,636,1210,1413,180,1145.58],'cm^-1')),
        HinderedRotor(inertia=(0.224093,'amu*angstrom^2'), symmetry=1, barrier=(5.15234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226714,'amu*angstrom^2'), symmetry=1, barrier=(5.21261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221702,'amu*angstrom^2'), symmetry=1, barrier=(5.09736,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.15197,0.108443,-0.000214068,2.08226e-07,-7.5804e-11,-121025,29.2023], Tmin=(100,'K'), Tmax=(849.081,'K')), NASAPolynomial(coeffs=[7.03259,0.0368307,-2.08392e-05,4.12628e-09,-2.85895e-13,-120884,3.73288], Tmin=(849.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1007.37,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-727.234,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,190,488,555,1236,1407,205.226,205.78,213.676],'cm^-1')),
        HinderedRotor(inertia=(0.583254,'amu*angstrom^2'), symmetry=1, barrier=(17.0487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225726,'amu*angstrom^2'), symmetry=1, barrier=(6.64844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217659,'amu*angstrom^2'), symmetry=1, barrier=(6.67828,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.429542,0.106893,-0.000187791,1.6344e-07,-5.51346e-11,-87315.6,32.229], Tmin=(100,'K'), Tmax=(814.18,'K')), NASAPolynomial(coeffs=[13.8611,0.0245837,-1.38578e-05,2.76628e-09,-1.93781e-13,-89241.6,-31.3146], Tmin=(814.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-727.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.272786,'amu*angstrom^2'), symmetry=1, barrier=(6.27189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273277,'amu*angstrom^2'), symmetry=1, barrier=(6.28318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272261,'amu*angstrom^2'), symmetry=1, barrier=(6.25982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.690373,'amu*angstrom^2'), symmetry=1, barrier=(15.873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.681841,0.117395,-0.000225181,2.06362e-07,-7.12596e-11,-96916.6,32.9653], Tmin=(100,'K'), Tmax=(856.305,'K')), NASAPolynomial(coeffs=[12.3739,0.0270432,-1.54716e-05,3.04732e-09,-2.09464e-13,-98075.9,-21.7093], Tmin=(856.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-807.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(C2CsJO) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = 'O=C(F)C(OF)[C](F)F(9848)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.154121,'amu*angstrom^2'), symmetry=1, barrier=(3.54354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155745,'amu*angstrom^2'), symmetry=1, barrier=(3.58088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.29485,'amu*angstrom^2'), symmetry=1, barrier=(52.7632,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.201265,0.0966269,-0.000183695,1.73051e-07,-6.16788e-11,-73265,28.0959], Tmin=(100,'K'), Tmax=(845.131,'K')), NASAPolynomial(coeffs=[8.62966,0.0296144,-1.66203e-05,3.28543e-09,-2.27695e-13,-73721.1,-5.41779], Tmin=(845.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-610.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cd-O2sCd)(F1s)(F1s))"""),
)

species(
    label = 'OC(F)(F)C([C]F)OF-2(9851)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-601.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,617,898,1187,256.063,256.067],'cm^-1')),
        HinderedRotor(inertia=(0.210773,'amu*angstrom^2'), symmetry=1, barrier=(9.80629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210744,'amu*angstrom^2'), symmetry=1, barrier=(9.80582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210743,'amu*angstrom^2'), symmetry=1, barrier=(9.80608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.682641,'amu*angstrom^2'), symmetry=1, barrier=(31.7592,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.110078,0.0918322,-0.000145105,1.15039e-07,-3.58139e-11,-72158.6,29.1875], Tmin=(100,'K'), Tmax=(790.921,'K')), NASAPolynomial(coeffs=[14.0613,0.0212733,-1.12842e-05,2.23834e-09,-1.57875e-13,-74365.4,-34.8462], Tmin=(790.921,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-601.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'OC(F)(F)[C](OF)C(F)F(9852)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C(C(O)(F)F)C(F)(F)F(9715)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    ...
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)(OF)C(F)[C](F)F(9840)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)C(OF)[C](F)F(9709)'],
    products = ['OC(F)(F)C(F)(F)[CH]OF(9841)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)(F)C([C]F)OF(9842)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(2927)', 'OC(F)(F)[CH]OF(4939)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(126)', 'OC(F)(F)C=C(F)F(4820)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O[C](F)F(4619)', 'FOC=C(F)F(4346)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'OC(F)(F)C(OF)=C(F)F(9843)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[C](F)C(OF)[C](F)F(9844)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C([C](F)F)C(O)(F)F(9845)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(126)', 'OC(F)(F)[CH][C](F)F(4824)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'FOC([C](F)F)[C](F)F(5387)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)(F)C(OF)[C](F)F(9846)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O[C](F)F(4619)', 'FO[CH][C](F)F(4344)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)(F)[C](OF)[C](F)F(9847)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=C(F)C(OF)[C](F)F(9848)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C([C](F)F)C(O)(F)F(9849)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'OC(F)=C(OF)[C](F)F(9850)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', 'OC(F)(F)C([C]F)OF-2(9851)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CF2(43)', 'OC(F)(F)[CH]OF(4939)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction22',
    reactants = ['OC(F)(F)C(OF)[C](F)F(9709)'],
    products = ['OC(F)(F)[C](OF)C(F)F(9852)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)(F)C(OF)C(F)F(9817)'],
    products = ['OC(F)(F)C(OF)[C](F)F(9709)'],
...
reaction(
    label = 'reaction24',
    reactants = ['OC(F)(F)C(OF)[C](F)F(9709)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(9715)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)(F)C(OF)[C](F)F(9709)'],
    products = ['O[C](F)C(OF)C(F)(F)F(9853)'],
...
network(
    label = 'PDepNetwork #3445',
    isomers = [
        'OC(F)(F)C(OF)[C](F)F(9709)',
    ],
    reactants = [
