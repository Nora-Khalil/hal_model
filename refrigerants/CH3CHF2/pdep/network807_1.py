...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(126)', '[CH2]C(=O)O(1378)'],
    products = ['O=C(O)COF(2327)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(165)', '[CH2]OF(186)'],
    products = ['O=C(O)COF(2327)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)[CH]OF(2375)'],
    products = ['O=C(O)COF(2327)'],
