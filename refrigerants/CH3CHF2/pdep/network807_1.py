...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCOF(1735)'],
    products = ['O=C(F)OCO(2338)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(168)', 'CH2OH(33)'],
    products = ['O=C(F)OCO(2338)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[CH]O(2372)'],
    products = ['O=C(F)OCO(2338)'],
