...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01953,0.0489897,-4.74976e-05,1.91678e-08,2.67019e-12,10407.5,19.0962], Tmin=(100,'K'), Tmax=(570.812,'K')), NASAPolynomial(coeffs=[6.00208,0.0285902,-1.36217e-05,2.64728e-09,-1.86919e-13,9830.53,1.04423], Tmin=(570.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.9827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-OsHHH) + ring(Cs(F)-Cs-Cs) + radical(C2CsJOCs) + radical(CsJOCC2)"""),
)
...
"""),
    E0 = (98.4616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,167,640,1190,180,757.384],'cm^-1')),
        HinderedRotor(inertia=(0.385887,'amu*angstrom^2'), symmetry=1, barrier=(8.87231,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0217957,'amu*angstrom^2'), symmetry=1, barrier=(8.87231,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00916576,'amu*angstrom^2'), symmetry=1, barrier=(3.73109,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91364,0.0477159,-4.31585e-05,2.11698e-08,-4.3611e-12,11915.8,21.2941], Tmin=(100,'K'), Tmax=(1133.05,'K')), NASAPolynomial(coeffs=[8.86097,0.02319,-1.069e-05,2.06605e-09,-1.46033e-13,10341.4,-13.0906], Tmin=(1133.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.4616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=COCJ) + radical(Cdj(Cd-CsO2s)(F1s))"""),
)

species(
    label = 'C=C([C]F)OC(7983)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (25.064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,180,479.146,479.148,479.173,479.175],'cm^-1')),
        HinderedRotor(inertia=(0.0148341,'amu*angstrom^2'), symmetry=1, barrier=(2.41693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.780544,'amu*angstrom^2'), symmetry=1, barrier=(17.9462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110153,'amu*angstrom^2'), symmetry=1, barrier=(17.9462,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54702,0.0512006,-4.60647e-05,2.09678e-08,-3.8311e-12,3105.02,18.418], Tmin=(100,'K'), Tmax=(1305.55,'K')), NASAPolynomial(coeffs=[12.3695,0.0180428,-7.96909e-06,1.51499e-09,-1.06156e-13,279.103,-36.6802], Tmin=(1305.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80577,0.0504305,-6.07256e-05,4.54735e-08,-1.34337e-11,6533.41,19.1485], Tmin=(100,'K'), Tmax=(999.177,'K')), NASAPolynomial(coeffs=[5.96891,0.0246041,-8.2027e-06,1.25413e-09,-7.41267e-14,6158.72,1.35529], Tmin=(999.177,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.6818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=CF(4117)'],
    products = ['[CH2]OC([CH2])=CF(7400)'],
    transitionState = 'TS3',
