...
reaction(
    label = 'reaction5',
    reactants = ['OF(142)', 'CC(F)(F)[C]F(3364)'],
    products = ['CC(F)(F)C(F)OF(3360)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(F)OF(760)'],
    products = ['CC(F)(F)C(F)OF(3360)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)[CH]OF(3368)'],
    products = ['CC(F)(F)C(F)OF(3360)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC(F)(F)C([O])F(3369)'],
    products = ['CC(F)(F)C(F)OF(3360)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(126)', 'CC(F)(F)[CH]F(3370)'],
    products = ['CC(F)(F)C(F)OF(3360)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(614)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(F)OF(3360)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'FOC(F)[C](F)F(3371)'],
    products = ['CC(F)(F)C(F)OF(3360)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC(F)(F)[C](F)OF(3372)'],
    products = ['CC(F)(F)C(F)OF(3360)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)OF(3373)'],
    products = ['CC(F)(F)C(F)OF(3360)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'CC(F)(F)C=O(155)'],
    products = ['CC(F)(F)C(F)OF(3360)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'CC(F)(F)C(=O)F(3164)'],
    products = ['CC(F)(F)C(F)OF(3360)'],
