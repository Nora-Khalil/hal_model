...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06715,0.0551921,-0.00011256,1.18518e-07,-4.51869e-11,23488.4,17.9743], Tmin=(100,'K'), Tmax=(871.267,'K')), NASAPolynomial(coeffs=[0.743851,0.0299942,-1.53371e-05,2.92888e-09,-1.9875e-13,24905.9,30.9879], Tmin=(871.267,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.54179,0.0161762,-6.53135e-06,5.6218e-10,4.72597e-14,43628.3,-3.32631], Tmin=(100,'K'), Tmax=(2854.07,'K')), NASAPolynomial(coeffs=[32.9528,-0.0134841,3.71844e-06,-5.84994e-10,3.85143e-14,23273.7,-177.437], Tmin=(2854.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-C2dc) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'O=CC[C-]=[OH+](2524)',
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.10976,0.0228573,-9.67057e-06,1.13299e-09,1.559e-14,17811,12.0106], Tmin=(100,'K'), Tmax=(2741.12,'K')), NASAPolynomial(coeffs=[30.6283,-0.00603643,7.75979e-07,-1.0295e-10,9.31281e-15,-410.106,-149.384], Tmin=(2741.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cds-OdCsH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C[O+]=[C-]O(2298)'],
    products = ['CO(13)', 'CH3CHO(36)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(10.9809,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C=C[O+]=[C-]O(2298)'],
    products = ['C=C[OH+][C-]=O(2523)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C[O+]=[C-]O(2298)'],
    products = ['O=CC[C-]=[OH+](2524)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(137.839,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction4',
    reactants = ['C=C[O+]=[C-]O(2298)'],
    products = ['O=[C-][OH2+](2525)', 'C2H2(23)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(7.93334e+10,'s^-1'), n=0.59, Ea=(381.969,'kJ/mol'), T0=(1,'K'), Tmin=(500,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_5CO->O',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_5CO->O
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #766',
    isomers = [
        'C=C[O+]=[C-]O(2298)',
    ],
    reactants = [
