...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[O]C[CH]F(140)'],
    products = ['O=[C]OC[CH]F(180)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]O[C]=O(292)'],
    products = ['O=[C]OC[CH]F(180)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]O[C]=O(292)'],
    products = ['O=[C]OC[CH]F(180)'],
