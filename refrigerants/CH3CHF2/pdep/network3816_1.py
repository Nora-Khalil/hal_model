...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.235236,'amu*angstrom^2'), symmetry=1, barrier=(5.40853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234197,'amu*angstrom^2'), symmetry=1, barrier=(5.38464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234721,'amu*angstrom^2'), symmetry=1, barrier=(5.3967,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.110747,0.0944784,-0.000165853,1.44897e-07,-4.85704e-11,-46418.2,27.983], Tmin=(100,'K'), Tmax=(849.066,'K')), NASAPolynomial(coeffs=[11.8919,0.0232203,-1.21286e-05,2.33964e-09,-1.60159e-13,-47850.8,-23.5819], Tmin=(849.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-387.036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(C2CsJO) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(F)(OF)[C](O)F(11069)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
species(
    label = '[CH2]C(F)(OF)C([O])(F)F(11071)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.29332,'amu*angstrom^2'), symmetry=1, barrier=(29.7359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29882,'amu*angstrom^2'), symmetry=1, barrier=(29.8625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29559,'amu*angstrom^2'), symmetry=1, barrier=(29.7881,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.67844,0.0789201,-0.000119163,9.14925e-08,-2.78421e-11,-61737.8,23.9401], Tmin=(100,'K'), Tmax=(805.75,'K')), NASAPolynomial(coeffs=[12.3429,0.0210114,-1.13541e-05,2.28906e-09,-1.63735e-13,-63617.4,-29.8144], Tmin=(805.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-514.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(COCsFO) + radical(CJCO)"""),
)
...
reaction(
    ...
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
    products = ['OC(F)(F)C[C](F)OF(11066)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', 'OC(F)(F)[C](F)OF(4943)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]C(F)(OF)C(O)(F)F(11067)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(OF)C(O)(F)F(4756)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(126)', 'C=C(F)C(O)(F)F(4789)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O[C](F)F(4619)', 'C=C(F)OF(1118)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2][C](OF)C(O)(F)F(11068)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)(OF)[C](O)F(11069)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', '[CH2][C](F)C(O)(F)F(4793)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', '[CH2]C(F)(OF)[C](F)F(5324)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]C(F)(OF)C([O])(F)F(11071)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[C](F)F(4619)', '[CH2][C](F)OF(1113)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[CH2]C(F)(OF)C(=O)F(11072)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', '[CH2]C(OF)=C(O)F(2096)'],
    products = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)(OF)C(O)(F)F(10846)'],
    products = ['CC(F)(OF)C([O])(F)F(10862)'],
