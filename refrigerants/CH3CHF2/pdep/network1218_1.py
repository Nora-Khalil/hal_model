...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.69341,'amu*angstrom^2'), symmetry=1, barrier=(38.9349,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05664,'amu*angstrom^2'), symmetry=1, barrier=(24.2942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05646,'amu*angstrom^2'), symmetry=1, barrier=(24.2901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.69324,'amu*angstrom^2'), symmetry=1, barrier=(38.9309,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43382,0.0599934,-6.79367e-05,4.16906e-08,-1.05232e-11,44073.8,22.1748], Tmin=(100,'K'), Tmax=(950.211,'K')), NASAPolynomial(coeffs=[9.87749,0.0244488,-1.18257e-05,2.32296e-09,-1.65503e-13,42469.2,-18.1297], Tmin=(950.211,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJCOOH)"""),
)
...
"""),
    ...
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.54474,0.02234,2.86522e-05,-5.16066e-08,2.14261e-11,24351.8,17.3929], Tmin=(100,'K'), Tmax=(936.252,'K')), NASAPolynomial(coeffs=[8.89915,0.0196213,-6.13165e-06,1.03123e-09,-7.1219e-14,22091.2,-18.5629], Tmin=(936.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(34dihydro12dioxin) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1CCOO1(3519)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {2,S} {4,S}
2  O u0 p2 c0 {1,S} {5,S}
3  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55865,0.0160365,5.60876e-05,-8.32052e-08,3.23745e-11,27350.7,19.8054], Tmin=(100,'K'), Tmax=(971.024,'K')), NASAPolynomial(coeffs=[11.8733,0.0169837,-6.11233e-06,1.1982e-09,-9.19215e-14,23688.1,-34.4032], Tmin=(971.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(226.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.75299,'amu*angstrom^2'), symmetry=1, barrier=(63.2966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31862,'amu*angstrom^2'), symmetry=1, barrier=(30.3176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551367,'amu*angstrom^2'), symmetry=1, barrier=(12.677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.75437,'amu*angstrom^2'), symmetry=1, barrier=(63.3285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62306,0.0588181,-6.51535e-05,2.8659e-08,3.36134e-12,58879,20.2859], Tmin=(100,'K'), Tmax=(575.445,'K')), NASAPolynomial(coeffs=[7.77583,0.0274147,-1.2921e-05,2.46885e-09,-1.71668e-13,57982.7,-7.63263], Tmin=(575.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(488.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C#COO[CH2](901)'],
    products = ['C#COOC[CH2](2543)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[CH]COOC#C-2(1851)'],
    products = ['C#COOC[CH2](2543)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['C#CO[O](374)', '[CH2][CH2](611)'],
    products = ['C#COOC[CH2](2543)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C#COO[CH][CH2](1230)'],
    products = ['C#COOC[CH2](2543)'],
