...
"""),
    E0 = (254.484,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,365.232,365.466,365.523,365.548],'cm^-1')),
        HinderedRotor(inertia=(0.00126287,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101558,'amu*angstrom^2'), symmetry=1, barrier=(9.62168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101473,'amu*angstrom^2'), symmetry=1, barrier=(9.62056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101435,'amu*angstrom^2'), symmetry=1, barrier=(9.61617,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29421,0.0629982,-6.60744e-05,4.16024e-08,-1.11575e-11,30701.7,23.7313], Tmin=(100,'K'), Tmax=(886.417,'K')), NASAPolynomial(coeffs=[8.06721,0.0324357,-1.43582e-05,2.70846e-09,-1.88469e-13,29501,-8.12807], Tmin=(886.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.927349,0.0530331,-7.41408e-06,-3.75043e-08,2.08268e-11,-5279.7,20.5719], Tmin=(100,'K'), Tmax=(943.705,'K')), NASAPolynomial(coeffs=[18.5221,0.0146456,-3.92103e-06,6.64512e-10,-4.96973e-14,-10212.1,-71.8314], Tmin=(943.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.9283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=CCOC=C(11520)',
    structure = adjacencyList("""1  O u0 p2 c0 {2,S} {4,S}
2  C u0 p0 c0 {1,S} {3,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23933,0.0441585,1.53073e-05,-5.96027e-08,2.83433e-11,-9019.89,21.6946], Tmin=(100,'K'), Tmax=(942.449,'K')), NASAPolynomial(coeffs=[18.0159,0.0145221,-3.68262e-06,6.29893e-10,-4.87432e-14,-14028.2,-68.0422], Tmin=(942.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (161.894,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,237.796,237.803,237.804,237.805],'cm^-1')),
        HinderedRotor(inertia=(0.503454,'amu*angstrom^2'), symmetry=1, barrier=(20.2047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.503469,'amu*angstrom^2'), symmetry=1, barrier=(20.2047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.503453,'amu*angstrom^2'), symmetry=1, barrier=(20.2047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20904,0.0487302,-9.40742e-06,-3.03767e-08,1.73666e-11,19583.3,22.2769], Tmin=(100,'K'), Tmax=(946.571,'K')), NASAPolynomial(coeffs=[16.8152,0.0140406,-3.97062e-06,6.81297e-10,-5.0267e-14,15228.5,-59.5542], Tmin=(946.571,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.964588,'amu*angstrom^2'), symmetry=1, barrier=(22.1778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.964071,'amu*angstrom^2'), symmetry=1, barrier=(22.1659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.96448,'amu*angstrom^2'), symmetry=1, barrier=(22.1753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.964504,'amu*angstrom^2'), symmetry=1, barrier=(22.1759,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.52244,0.0602582,-1.65079e-05,-3.70304e-08,2.29703e-11,15041.2,22.7263], Tmin=(100,'K'), Tmax=(928.883,'K')), NASAPolynomial(coeffs=[22.0951,0.00900305,-9.84452e-07,9.09412e-11,-9.98339e-15,9237.02,-89.4279], Tmin=(928.883,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]COC[C]=C(11622)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {3,S}
...
"""),
    E0 = (285.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,306.171,306.187,306.203,3170.67],'cm^-1')),
        HinderedRotor(inertia=(0.00179852,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.552165,'amu*angstrom^2'), symmetry=1, barrier=(36.7308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141182,'amu*angstrom^2'), symmetry=1, barrier=(9.39079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14115,'amu*angstrom^2'), symmetry=1, barrier=(9.39119,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70168,0.0571029,-4.5973e-05,6.13343e-09,1.29548e-11,34428.3,23.5126], Tmin=(100,'K'), Tmax=(555.462,'K')), NASAPolynomial(coeffs=[5.96932,0.0363123,-1.66757e-05,3.19242e-09,-2.237e-13,33800.8,4.05235], Tmin=(555.462,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCO[CH]C(11623)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {4,S}
2  C u0 p0 c0 {1,S} {5,S} {7,S} {8,S}
3  C u0 p0 c0 {4,S} {9,S} {10,S} {11,S}
...
"""),
    E0 = (263.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,338.126,338.126,338.126],'cm^-1')),
        HinderedRotor(inertia=(0.141027,'amu*angstrom^2'), symmetry=1, barrier=(11.4416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0014745,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141027,'amu*angstrom^2'), symmetry=1, barrier=(11.4416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141027,'amu*angstrom^2'), symmetry=1, barrier=(11.4416,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23786,0.0621911,-5.92537e-05,3.18346e-08,-7.15208e-12,31818.7,23.8569], Tmin=(100,'K'), Tmax=(1054.35,'K')), NASAPolynomial(coeffs=[9.87411,0.0294274,-1.26421e-05,2.36246e-09,-1.63954e-13,29997.5,-18.2652], Tmin=(1054.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=COCC(6787)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {4,S}
2  C u0 p0 c0 {1,S} {3,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {9,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.854788,0.0554955,-1.46049e-05,-3.00234e-08,1.81939e-11,20308.4,22.5329], Tmin=(100,'K'), Tmax=(943.418,'K')), NASAPolynomial(coeffs=[18.4236,0.0149478,-4.10212e-06,6.90378e-10,-5.0722e-14,15483,-69.2083], Tmin=(943.418,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH]OCC=C(11624)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {4,S}
2  C u0 p0 c0 {1,S} {3,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {5,D} {9,S}
...
"""),
    E0 = (321.124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,305.525,305.525,305.526],'cm^-1')),
        HinderedRotor(inertia=(0.00180595,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11068,'amu*angstrom^2'), symmetry=1, barrier=(7.33153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110681,'amu*angstrom^2'), symmetry=1, barrier=(7.33153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110681,'amu*angstrom^2'), symmetry=1, barrier=(7.33152,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91589,0.0531605,-3.01741e-05,-2.3967e-08,3.4851e-11,38690.1,22.5483], Tmin=(100,'K'), Tmax=(509.766,'K')), NASAPolynomial(coeffs=[5.41221,0.0372317,-1.71596e-05,3.28974e-09,-2.30654e-13,38184.1,6.57007], Tmin=(509.766,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C-2(610)', 'C=[C]C[O](726)'],
    products = ['C=[C]CO[CH]C(11517)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', '[CH2]O[CH]C(1805)'],
    products = ['C=[C]CO[CH]C(11517)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['C=[C]CO[CH]C(11517)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(78.1786,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
