...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.331419,'amu*angstrom^2'), symmetry=1, barrier=(7.61996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.584863,'amu*angstrom^2'), symmetry=1, barrier=(13.4472,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16356,0.0681405,-7.63682e-05,4.92005e-08,-1.3463e-11,-57306.5,22.4195], Tmin=(100,'K'), Tmax=(867.476,'K')), NASAPolynomial(coeffs=[8.65355,0.0336039,-1.66496e-05,3.30642e-09,-2.36838e-13,-58606,-12.6507], Tmin=(867.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.657735,'amu*angstrom^2'), symmetry=1, barrier=(15.1226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.656866,'amu*angstrom^2'), symmetry=1, barrier=(15.1026,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64764,0.0553088,-5.04111e-05,2.48247e-08,-5.18241e-12,-8921.15,20.9444], Tmin=(100,'K'), Tmax=(1109.66,'K')), NASAPolynomial(coeffs=[9.21583,0.0280272,-1.35323e-05,2.66818e-09,-1.90594e-13,-10600.8,-16.3552], Tmin=(1109.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.255674,'amu*angstrom^2'), symmetry=1, barrier=(5.87844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00752767,'amu*angstrom^2'), symmetry=1, barrier=(5.87398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.791697,0.0769556,-0.000113177,9.50275e-08,-3.27742e-11,-31870.7,25.034], Tmin=(100,'K'), Tmax=(730.27,'K')), NASAPolynomial(coeffs=[8.78379,0.031448,-1.61462e-05,3.20089e-09,-2.26898e-13,-32991.8,-10.6948], Tmin=(730.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-265.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)
...
"""),
    E0 = (-280.637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([190,359,486,598,681,1014,1151,319,1023,1071,1259,1317,1409,3054,3019,3000,3100,440,815,1455,1000,2100,2250,500,550,180,2008.55],'cm^-1')),
        HinderedRotor(inertia=(0.518302,'amu*angstrom^2'), symmetry=1, barrier=(11.9168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.86689,'amu*angstrom^2'), symmetry=1, barrier=(65.9155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.8678,'amu*angstrom^2'), symmetry=1, barrier=(65.9364,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938869,0.0707951,-9.1686e-05,6.63258e-08,-1.94384e-11,-33645.8,24.1145], Tmin=(100,'K'), Tmax=(831.652,'K')), NASAPolynomial(coeffs=[10.1623,0.0264275,-1.16529e-05,2.16193e-09,-1.47968e-13,-35179.7,-18.6819], Tmin=(831.652,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Csj(Cs-F1sF1sCt)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.323984,'amu*angstrom^2'), symmetry=1, barrier=(7.44904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323465,'amu*angstrom^2'), symmetry=1, barrier=(7.43709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417867,'amu*angstrom^2'), symmetry=1, barrier=(9.60759,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.564753,0.0846405,-0.000136022,1.24735e-07,-4.55796e-11,-24709.8,27.4018], Tmin=(100,'K'), Tmax=(794.979,'K')), NASAPolynomial(coeffs=[7.00366,0.0375785,-1.95547e-05,3.86193e-09,-2.71589e-13,-25270.2,0.729572], Tmin=(794.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cds_S)"""),
)

species(
    label = 'CC(F)(F)[C]=[C]CF(11953)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.392015,'amu*angstrom^2'), symmetry=1, barrier=(9.0132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391763,'amu*angstrom^2'), symmetry=1, barrier=(9.0074,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.847233,0.076435,-0.000111899,9.88226e-08,-3.61069e-11,-21499.5,27.0158], Tmin=(100,'K'), Tmax=(750.692,'K')), NASAPolynomial(coeffs=[6.91238,0.0370351,-1.90206e-05,3.77246e-09,-2.67419e-13,-22210.6,0.823394], Tmin=(750.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.644,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = 'CC(F)(F)[CH][C]=CF(7732)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22716,0.0650316,-6.31698e-05,3.32051e-08,-7.33439e-12,-34601.1,23.6526], Tmin=(100,'K'), Tmax=(1061.37,'K')), NASAPolynomial(coeffs=[10.265,0.0309703,-1.50319e-05,2.96856e-09,-2.12307e-13,-36519.5,-20.488], Tmin=(1061.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Allyl_S) + radical(Cdj(Cs-CsHH)(Cd-F1sH))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C=[C]CF(11828)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'FC[C]=C[C](F)F(11949)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11828)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)C=[C]CF(11880)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11828)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C=CF(7726)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11828)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)(F)C#CCF(11950)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11828)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH2][C](F)C#CCF(11951)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11828)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)C=[C]CF(11828)'],
    products = ['[CH2]C(F)(F)[CH]C=CF(7730)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)[C]=CCF(11952)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11828)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)C=[C]CF(11828)'],
    products = ['[CH2]C(F)=C[C](F)CF(11955)'],
...
network(
    label = 'PDepNetwork #4011',
    isomers = [
        '[CH2]C(F)(F)C=[C]CF(11828)',
    ],
    reactants = [
