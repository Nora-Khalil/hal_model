...
"""),
    E0 = (-428.961,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,3010,987.5,1337.5,450,1655,268.374,268.431,268.452,268.464,268.468],'cm^-1')),
        HinderedRotor(inertia=(0.436203,'amu*angstrom^2'), symmetry=1, barrier=(22.3102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.436205,'amu*angstrom^2'), symmetry=1, barrier=(22.3103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.43617,'amu*angstrom^2'), symmetry=1, barrier=(22.31,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.229773,0.0768079,-9.17785e-05,5.18554e-08,-1.11891e-11,-51451.1,25.514], Tmin=(100,'K'), Tmax=(1148.86,'K')), NASAPolynomial(coeffs=[19.6436,0.00921477,-3.5263e-06,6.43986e-10,-4.52195e-14,-55911.9,-70.8404], Tmin=(1148.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-428.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsFHHO) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)
...
"""),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29495,0.0651289,-7.73468e-05,5.003e-08,-1.34443e-11,-12108.6,21.6655], Tmin=(100,'K'), Tmax=(889.902,'K')), NASAPolynomial(coeffs=[9.59375,0.0278269,-1.44712e-05,2.92702e-09,-2.11676e-13,-13585.6,-17.4034], Tmin=(889.902,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(CsCsFHH) + ring(12dioxetane) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(OF)OC1CF(10887)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58958,0.0585683,-7.99499e-05,7.11278e-08,-2.67655e-11,-36903.6,24.3546], Tmin=(100,'K'), Tmax=(749.772,'K')), NASAPolynomial(coeffs=[5.00996,0.0337008,-1.6956e-05,3.34022e-09,-2.36242e-13,-37230.5,10.0792], Tmin=(749.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-307.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsOs) + group(CsCsFHH) + ring(Cs(C-F)-Cs-O2s) + radical(CCOJ)"""),
)

species(
    label = '[O]C(CF)=C(O)OF(10888)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {8,S}
...
"""),
    E0 = (-434.512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,212,931,1104,1251,1325,1474,3102,3155,325,375,415,465,420,450,1700,1750,342.157,342.157,342.157],'cm^-1')),
        HinderedRotor(inertia=(0.155385,'amu*angstrom^2'), symmetry=1, barrier=(12.9088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155385,'amu*angstrom^2'), symmetry=1, barrier=(12.9088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155385,'amu*angstrom^2'), symmetry=1, barrier=(12.9088,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
"""),
    E0 = (-158.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,1855,455,950,276.941,277.052],'cm^-1')),
        HinderedRotor(inertia=(0.00219522,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150043,'amu*angstrom^2'), symmetry=1, barrier=(8.2448,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96841,0.0409532,-3.89105e-05,1.86669e-08,-3.53725e-12,-18968.4,24.0361], Tmin=(100,'K'), Tmax=(1279.53,'K')), NASAPolynomial(coeffs=[11.2892,0.0118151,-4.75186e-06,8.69401e-10,-5.99057e-14,-21353.7,-23.2287], Tmin=(1279.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.897656,0.0653435,-6.57185e-05,3.19708e-08,-6.13255e-12,-18923.4,27.6271], Tmin=(100,'K'), Tmax=(1258.69,'K')), NASAPolynomial(coeffs=[15.9798,0.0174142,-8.60077e-06,1.71848e-09,-1.23882e-13,-22720.2,-48.6053], Tmin=(1258.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]C(CF)OF(1383)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]CC(=O)OF(2364)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', '[O]C(F)C(=O)OF(2666)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(142)', 'O=[C]C(=O)CF(2802)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['O(6)', 'O=C([CH]CF)OF(1448)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', 'O=CC(=O)OF(2668)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OF(167)', 'O=CCF(208)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C(CF)C(=O)OF(10889)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C([O])C(=O)OF(2690)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C(=O)C([O])CF(2798)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(126)', '[O]C([C]=O)CF(10890)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(46)', '[O]C=C([O])OF(1459)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]OF(167)', '[O][CH]CF(449)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[O]C(CF)=C([O])OF(10891)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', '[CH2]C(=O)C(=O)OF(2696)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(CF)C(=O)OF(10806)'],
    products = ['F2(78)', 'CO2(14)', 'CH2CHO(35)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(OF)C(=O)OF(10894)'],
    products = ['[O]C(CF)C(=O)OF(10806)'],
