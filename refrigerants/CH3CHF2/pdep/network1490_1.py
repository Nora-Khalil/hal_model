...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'F[C]C=CF(4149)'],
    products = ['[O]C(F)C=[C]F(4116)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'O=C(F)C=[C]F(4064)'],
    products = ['[O]C(F)C=[C]F(4116)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O]C=C=[C]F(4260)'],
    products = ['[O]C(F)C=[C]F(4116)'],
