...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C#COO[CH]F(1011)'],
    products = ['C#COOC([CH2])F(1103)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[CH]C(F)OOC#C(1225)'],
    products = ['C#COOC([CH2])F(1103)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['C#CO[O](374)', 'CH2CHF(56)'],
    products = ['C#COOC([CH2])F(1103)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C#COO[CH][CH2](1230)'],
    products = ['C#COOC([CH2])F(1103)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C#CO[O](374)', '[CH2][CH]F(233)'],
    products = ['C#COOC([CH2])F(1103)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C2H(22)', '[CH2]C(F)O[O](222)'],
    products = ['C#COOC([CH2])F(1103)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#COO[C]([CH2])F(1231)'],
    products = ['C#COOC([CH2])F(1103)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[C]#COOC([CH2])F(1232)'],
    products = ['C#COOC([CH2])F(1103)'],
