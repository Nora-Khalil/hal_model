...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(128)', '[CH2]C([CH2])=C(7071)'],
    products = ['[CH2]C(=C)C[C]=O(6478)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(=C)C[C]=O(6478)'],
    products = ['[CH2]C1([CH2])CC1=O(7104)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CO(13)', '[CH2]C([CH2])=C(7071)'],
    products = ['[CH2]C(=C)C[C]=O(6478)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=C)C=C=O(7105)'],
    products = ['[CH2]C(=C)C[C]=O(6478)'],
