...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3025)', '[CH2]C(=C)[O](413)'],
    products = ['C=C([O])C[C](F)F(3111)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C[C](F)F(3201)'],
    products = ['C=C([O])C[C](F)F(3111)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=C([O])C=C(F)F(3296)'],
    products = ['C=C([O])C[C](F)F(3111)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C([O])C[C](F)F(3111)'],
    products = ['[CH2][C]1CC(F)(F)O1(3302)'],
