...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]C[CH2](937)'],
    products = ['[CH2]CC[C](F)F(3032)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]CC=C(F)F(3271)'],
    products = ['[CH2]CC[C](F)F(3032)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(43)', '[CH2]C[CH2](937)'],
    products = ['[CH2]CC[C](F)F(3032)'],
