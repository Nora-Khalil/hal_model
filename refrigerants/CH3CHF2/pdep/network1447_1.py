...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C]C=C(F)F(4036)'],
    products = ['F[C]=CC(F)F(3987)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C]=[C]C(F)F(4250)'],
    products = ['F[C]=CC(F)F(3987)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'FC#C[CH]F(4251)'],
    products = ['F[C]=CC(F)F(3987)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]=CC(F)F(3987)'],
    products = ['F[CH]C=C(F)F(3936)'],
