...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15854,0.0299266,1.65559e-05,-4.32537e-08,1.8978e-11,5853.15,20.4817], Tmin=(100,'K'), Tmax=(955.769,'K')), NASAPolynomial(coeffs=[11.149,0.018344,-6.13938e-06,1.08643e-09,-7.72661e-14,2945.06,-28.7083], Tmin=(955.769,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.0351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCsCdF) + ring(Cs(F)-Cs-Cd-Cd) + radical(Allyl_T) + radical(Isobutyl) + longDistanceInteraction_cyclic(Cs(F)-Cds(F))"""),
)

species(
    label = '[CH2]C1([CH]F)C=C1F(10894)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C=[C]F)=CF(10787)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[C]C=C=CF(4287)'],
    products = ['[CH2]C(C=[C]F)=CF(10787)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(C=[C]F)=CF(10787)'],
    products = ['[CH2][C]1C=C(F)C1F(10904)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C=[C]F)=CF(10787)'],
    products = ['[CH2]C1([CH]F)C=C1F(10894)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(C#CF)=CF(10905)'],
    products = ['[CH2]C(C=[C]F)=CF(10787)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]F(230)', 'C=C=C[C]F(4195)'],
    products = ['[CH2]C(C=[C]F)=CF(10787)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(C=[C]F)=CF(10787)'],
    products = ['F[CH][C]1C=C(F)C1(10910)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CHF(40)', 'C=C=C[C]F(4195)'],
    products = ['[CH2]C(C=[C]F)=CF(10787)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(=C=[C]F)CF(10911)'],
    products = ['[CH2]C(C=[C]F)=CF(10787)'],
