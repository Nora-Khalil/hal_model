...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76495,0.0474674,-5.02854e-05,2.68305e-08,-5.65415e-12,-8977.81,19.654], Tmin=(100,'K'), Tmax=(1154.02,'K')), NASAPolynomial(coeffs=[11.6584,0.0131753,-5.71225e-06,1.08099e-09,-7.59157e-14,-11261.2,-29.4933], Tmin=(1154.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cds-CdsOsH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (76.6777,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3010,987.5,1337.5,450,1655,113,247,382,1207,3490,540,610,2055,1606.72],'cm^-1')),
        HinderedRotor(inertia=(0.540494,'amu*angstrom^2'), symmetry=1, barrier=(12.427,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05174,0.0435852,-5.3924e-05,3.47742e-08,-8.87409e-12,9291.74,19.3855], Tmin=(100,'K'), Tmax=(959.499,'K')), NASAPolynomial(coeffs=[9.51658,0.0124654,-5.27385e-06,9.71642e-10,-6.67405e-14,7859.25,-16.3194], Tmin=(959.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.6777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cds-CdsOsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)
...
"""),
    E0 = (142.682,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2175,525,239,401,1367,180],'cm^-1')),
        HinderedRotor(inertia=(0.142756,'amu*angstrom^2'), symmetry=1, barrier=(3.28225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143047,'amu*angstrom^2'), symmetry=1, barrier=(3.28894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09396,0.0481503,-8.15872e-05,7.47085e-08,-2.59359e-11,17223.4,19.2213], Tmin=(100,'K'), Tmax=(886.331,'K')), NASAPolynomial(coeffs=[5.14709,0.0198335,-9.06075e-06,1.65052e-09,-1.09207e-13,17253.2,8.08152], Tmin=(886.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CtOsHH) + group(Ct-CtCs) + group(CtCF) + radical(ROOJ)"""),
)
...
"""),
    E0 = (234.204,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,1685,370,167,640,1190,309.465],'cm^-1')),
        HinderedRotor(inertia=(0.168877,'amu*angstrom^2'), symmetry=1, barrier=(11.5205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00702618,'amu*angstrom^2'), symmetry=1, barrier=(41.8007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.614192,'amu*angstrom^2'), symmetry=1, barrier=(41.7957,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12007,0.0449654,-5.20736e-05,3.46431e-08,-9.72769e-12,28232.8,22.0451], Tmin=(100,'K'), Tmax=(849.611,'K')), NASAPolynomial(coeffs=[7.11034,0.0214703,-1.05915e-05,2.09228e-09,-1.49274e-13,27384.9,-1.21661], Tmin=(849.611,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-O2sHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=[C]COOF(9084)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (504.732,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,2750,2850,1437.5,1250,1305,750,350,1685,370,3120,650,792.5,1650,274.723,2848.89],'cm^-1')),
        HinderedRotor(inertia=(0.683337,'amu*angstrom^2'), symmetry=1, barrier=(36.0946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141934,'amu*angstrom^2'), symmetry=1, barrier=(7.50659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.679514,'amu*angstrom^2'), symmetry=1, barrier=(36.1012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64823,0.0572277,-9.14519e-05,8.09627e-08,-2.84144e-11,60784.6,22.381], Tmin=(100,'K'), Tmax=(810.504,'K')), NASAPolynomial(coeffs=[6.99368,0.0223949,-1.13452e-05,2.20637e-09,-1.53558e-13,60195.7,-0.572038], Tmin=(810.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(504.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sFO) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[C]=CF(4122)'],
    products = ['[O]OC[C]=CF(7446)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]O[O](335)', '[C]=CF(1084)'],
    products = ['[O]OC[C]=CF(7446)'],
    transitionState = 'TS3',
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.6844e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(14.9347,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]COOF(9084)'],
    products = ['[O]OC[C]=CF(7446)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(62.1172,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction17',
    reactants = ['[O]OC[C]=CF(7446)'],
    products = ['[CH]=C(F)CO[O](9085)'],
