...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.630828,'amu*angstrom^2'), symmetry=1, barrier=(14.504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.627349,'amu*angstrom^2'), symmetry=1, barrier=(14.424,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65543,0.054067,-6.23781e-05,4.09955e-08,-1.10974e-11,43339,19.4817], Tmin=(100,'K'), Tmax=(891.449,'K')), NASAPolynomial(coeffs=[8.58211,0.0229876,-1.00843e-05,1.88928e-09,-1.30804e-13,42104,-13.1399], Tmin=(891.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CdH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.58355,'amu*angstrom^2'), symmetry=1, barrier=(36.4088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58259,'amu*angstrom^2'), symmetry=1, barrier=(36.387,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0835,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00009,0.0374335,-1.60842e-05,-7.83194e-09,6.38766e-12,35367,19.0739], Tmin=(100,'K'), Tmax=(966.483,'K')), NASAPolynomial(coeffs=[10.9786,0.0153885,-5.32794e-06,9.2956e-10,-6.42228e-14,32925.6,-27.5881], Tmin=(966.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtHHH) + group(Cds-CdsCtH) + group(CdCFH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Cdj(Cd-CtH)(F1s))"""),
)
...
"""),
    E0 = (372.758,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,2175,525,239,401,1367,213.225],'cm^-1')),
        HinderedRotor(inertia=(0.677521,'amu*angstrom^2'), symmetry=1, barrier=(15.5775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109705,'amu*angstrom^2'), symmetry=1, barrier=(15.6045,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0835,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31242,0.0410111,-3.57167e-05,1.77374e-08,-3.91029e-12,44889.9,17.5588], Tmin=(100,'K'), Tmax=(1025.97,'K')), NASAPolynomial(coeffs=[6.45537,0.0248588,-1.21014e-05,2.39239e-09,-1.71127e-13,44039.8,-2.53469], Tmin=(1025.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(372.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(CtCF) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82788,0.041733,-2.80344e-05,9.44916e-09,-1.28836e-12,36064.1,19.8044], Tmin=(100,'K'), Tmax=(1698.47,'K')), NASAPolynomial(coeffs=[11.8595,0.0181087,-7.17115e-06,1.26034e-09,-8.30734e-14,32656.4,-33.9065], Tmin=(1698.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Allyl_S) + radical(Cdj(Cdd-Cd)(F1s))"""),
)
