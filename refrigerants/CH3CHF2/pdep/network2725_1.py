...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC[C](F)F(3041)'],
    products = ['[O]OOC[C](F)F(6993)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH2]OO[O](188)'],
    products = ['[O]OOC[C](F)F(6993)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]OOC=C(F)F(4342)'],
    products = ['[O]OOC[C](F)F(6993)'],
    transitionState = 'TS8',
