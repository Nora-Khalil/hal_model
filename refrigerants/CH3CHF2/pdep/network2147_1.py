...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[O]C1O[C]1F(5677)'],
    products = ['O=[C]OC1O[C]1F(5666)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C1O[C]1F(5677)'],
    products = ['O=[C]OC1O[C]1F(5666)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC1=C(F)O1(5680)'],
    products = ['O=[C]OC1O[C]1F(5666)'],
    transitionState = 'TS9',
