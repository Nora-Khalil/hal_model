...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3025)', '[O]C([O])F(782)'],
    products = ['[O]C(F)O[C](F)F(4756)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)F(3224)'],
    products = ['[O]C(F)O[C](F)F(4756)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=CO[C](F)F(4712)'],
    products = ['[O]C(F)O[C](F)F(4756)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)O[C](F)F(4919)'],
    products = ['[O]C(F)O[C](F)F(4756)'],
    transitionState = 'TS9',
