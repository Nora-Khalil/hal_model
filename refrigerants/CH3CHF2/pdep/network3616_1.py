...
"""),
    E0 = (521.937,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,750,770,3400,2100,302.608,302.682,302.818,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.111735,'amu*angstrom^2'), symmetry=1, barrier=(7.26085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111704,'amu*angstrom^2'), symmetry=1, barrier=(7.26041,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19865,0.0428436,-5.85697e-05,4.35419e-08,-1.31062e-11,62836.5,-5.50772], Tmin=(100,'K'), Tmax=(808.505,'K')), NASAPolynomial(coeffs=[7.75344,0.0153622,-7.58457e-06,1.5017e-09,-1.06986e-13,61938.2,-31.1257], Tmin=(808.505,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(521.937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(Ct-CtCs) + group(CsJ2_singlet-CsH) + group(Ct-CtH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.248291,'amu*angstrom^2'), symmetry=1, barrier=(5.70869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248972,'amu*angstrom^2'), symmetry=1, barrier=(5.72435,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12205,0.052117,-0.000107215,1.08029e-07,-3.94045e-11,67713.5,4.38709], Tmin=(100,'K'), Tmax=(888.661,'K')), NASAPolynomial(coeffs=[3.07226,0.0213476,-1.05604e-05,1.97267e-09,-1.31112e-13,68590.7,5.8007], Tmin=(888.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(562.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsJ2_singlet-CsH) + group(Cds-CdsCsCs) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[C-]=[O+]C#C(4248)'],
    products = ['[C-]=[O+]CC#C(10705)'],
    transitionState = 'TS2',
