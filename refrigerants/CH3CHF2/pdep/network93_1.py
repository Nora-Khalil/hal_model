...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(230)', '[CH2]C([CH2])F(238)'],
    products = ['[CH2]C(F)C[CH]F(227)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[CH]C[CH]F(239)'],
    products = ['[CH2]C(F)C[CH]F(227)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)C=CF(243)'],
    products = ['[CH2]C(F)C[CH]F(227)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(F)C[CH]F(245)'],
    products = ['[CH2]C(F)C[CH]F(227)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C([CH2])F(238)'],
    products = ['[CH2]C(F)C[CH]F(227)'],
