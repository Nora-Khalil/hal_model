...
"""),
    E0 = (-441.217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,2120,512.5,787.5,213.634,214.087],'cm^-1')),
        HinderedRotor(inertia=(0.242787,'amu*angstrom^2'), symmetry=1, barrier=(7.93965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244362,'amu*angstrom^2'), symmetry=1, barrier=(7.94819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24597,'amu*angstrom^2'), symmetry=1, barrier=(7.94001,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.967323,0.0747149,-0.00012057,1.07866e-07,-3.75377e-11,-52964.6,23.5], Tmin=(100,'K'), Tmax=(851.908,'K')), NASAPolynomial(coeffs=[6.94669,0.030565,-1.45291e-05,2.73403e-09,-1.8593e-13,-53400.1,-0.96507], Tmin=(851.908,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-441.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)OsHH) + group(CsCFHH) + group(Cds-(Cdd-O2d)CsCs) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'C=C=C(O)OCF(7467)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-378.859,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,2950,3100,1380,975,1025,1650,540,610,2055,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.01861,'amu*angstrom^2'), symmetry=1, barrier=(23.4198,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02012,'amu*angstrom^2'), symmetry=1, barrier=(23.4547,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.195565,0.0735784,-8.20435e-05,4.387e-08,-8.9283e-12,-45420.6,22.7612], Tmin=(100,'K'), Tmax=(1261.86,'K')), NASAPolynomial(coeffs=[19.8956,0.00884741,-2.38217e-06,3.49295e-10,-2.18507e-14,-50210.5,-76.1417], Tmin=(1261.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-378.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFHHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=C(CF)C([O])[O](7468)',
...
"""),
    E0 = (-117.08,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,1380,1390,370,380,2900,435,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,1466.87,1467.19],'cm^-1')),
        HinderedRotor(inertia=(0.101925,'amu*angstrom^2'), symmetry=1, barrier=(2.34346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102179,'amu*angstrom^2'), symmetry=1, barrier=(2.3493,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.56463,0.0346275,-1.56693e-05,2.13442e-09,-3.63677e-14,-14151.7,14.137], Tmin=(100,'K'), Tmax=(2889.56,'K')), NASAPolynomial(coeffs=[57.6244,-0.0227596,5.78237e-06,-8.90965e-10,5.89359e-14,-51521.6,-309.751], Tmin=(2889.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C([CH]F)C(=O)O(7469)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-281.629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.830965,0.0765813,-0.000118128,1.02747e-07,-3.56749e-11,-33764.6,26.1479], Tmin=(100,'K'), Tmax=(810.555,'K')), NASAPolynomial(coeffs=[8.04834,0.0309791,-1.52586e-05,2.94048e-09,-2.03892e-13,-34606.6,-5.13241], Tmin=(810.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CsCsF1sH) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C(=CF)C([O])O(7470)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {4,S} {12,S}
3  O u1 p2 c0 {4,S}
...
"""),
    E0 = (-207.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,350,440,435,1725,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,461.697,461.974],'cm^-1')),
        HinderedRotor(inertia=(0.118319,'amu*angstrom^2'), symmetry=1, barrier=(2.72039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0179344,'amu*angstrom^2'), symmetry=1, barrier=(2.71891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118263,'amu*angstrom^2'), symmetry=1, barrier=(2.7191,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20389,0.0667706,-9.24351e-05,7.67976e-08,-2.65119e-11,-24870,25.8193], Tmin=(100,'K'), Tmax=(755.266,'K')), NASAPolynomial(coeffs=[7.34765,0.0310335,-1.51063e-05,2.93244e-09,-2.05602e-13,-25706.8,-1.49237], Tmin=(755.266,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-207.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(CCOJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=C(CF)C([O])O(7471)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-95.6889,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3120,650,792.5,1650,183.463,1361.48],'cm^-1')),
        HinderedRotor(inertia=(0.267537,'amu*angstrom^2'), symmetry=1, barrier=(6.42106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26852,'amu*angstrom^2'), symmetry=1, barrier=(6.43024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267458,'amu*angstrom^2'), symmetry=1, barrier=(6.42637,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08424,0.0732469,-0.000120879,1.1394e-07,-4.20283e-11,-11412.6,27.1602], Tmin=(100,'K'), Tmax=(820.815,'K')), NASAPolynomial(coeffs=[5.27483,0.0348218,-1.77589e-05,3.4635e-09,-2.41175e-13,-11494,11.4648], Tmin=(820.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.6889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(CF)C([O])=O(7472)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u1 p2 c0 {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-277.092,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,325,375,415,465,420,450,1700,1750,234,589,736,816,1240,3237,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.990345,'amu*angstrom^2'), symmetry=1, barrier=(22.77,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.988629,'amu*angstrom^2'), symmetry=1, barrier=(22.7305,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.989073,'amu*angstrom^2'), symmetry=1, barrier=(22.7407,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.990622,'amu*angstrom^2'), symmetry=1, barrier=(22.7764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.170586,0.0790883,-9.12512e-05,4.95615e-08,-1.00927e-11,-33165.5,25.6183], Tmin=(100,'K'), Tmax=(1328.37,'K')), NASAPolynomial(coeffs=[21.7955,0.00580458,-4.37141e-07,-6.1208e-11,7.8149e-15,-38371.4,-84.2216], Tmin=(1328.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Csj(Cd-CsCd)(F1s)(H)) + radical(Allyl_P)"""),
)

species(
    label = '[CH]C(CF)=C(O)O(7474)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.07569,'amu*angstrom^2'), symmetry=1, barrier=(47.7243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.07537,'amu*angstrom^2'), symmetry=1, barrier=(47.7169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.07541,'amu*angstrom^2'), symmetry=1, barrier=(47.7177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.07571,'amu*angstrom^2'), symmetry=1, barrier=(47.7248,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.106102,0.0810704,-9.29559e-05,5.35922e-08,-1.20234e-11,-24352.5,24.3018], Tmin=(100,'K'), Tmax=(1097.91,'K')), NASAPolynomial(coeffs=[17.4688,0.0178125,-6.53039e-06,1.11303e-09,-7.34833e-14,-28165,-61.0851], Tmin=(1097.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C[C](CF)C([O])=O(7475)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u1 p2 c0 {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-309.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.75754,0.0402514,-1.99451e-05,3.82985e-09,-2.45031e-13,-37145.1,19.2158], Tmin=(100,'K'), Tmax=(2518.38,'K')), NASAPolynomial(coeffs=[26.781,0.00856809,-4.92975e-06,8.75717e-10,-5.31026e-14,-51298.1,-122.948], Tmin=(2518.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77686,0.0532374,-4.52502e-05,2.08351e-08,-4.15156e-12,-28521.6,22.6082], Tmin=(100,'K'), Tmax=(1137.19,'K')), NASAPolynomial(coeffs=[8.37441,0.0300304,-1.46387e-05,2.88909e-09,-2.06222e-13,-30022.1,-10.0693], Tmin=(1137.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsCsH) + group(CsCsFHH) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'C=CC(=O)O(1530)'],
    products = ['C=C(CF)C(=O)O(7274)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'C=C(F)C(=O)O(176)'],
    products = ['C=C(CF)C(=O)O(7274)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C=C(O)OCF(7467)'],
    products = ['C=C(CF)C(=O)O(7274)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(117.255,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['C=C(CF)C([O])[O](7468)'],
    products = ['C=C(CF)C(=O)O(7274)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH]F)C(=O)O(7469)'],
    products = ['C=C(CF)C(=O)O(7274)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH]F)=C(O)O(7473)'],
    products = ['C=C(CF)C(=O)O(7274)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[CH2]C(=C)C(=O)O(7476)'],
    products = ['C=C(CF)C(=O)O(7274)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OH(7)', 'C=C([C]=O)CF(7477)'],
    products = ['C=C(CF)C(=O)O(7274)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'C=C(CF)C([O])=O(7478)'],
    products = ['C=C(CF)C(=O)O(7274)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2F(46)', 'C=[C]C(=O)O(2402)'],
    products = ['C=C(CF)C(=O)O(7274)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH2]C(=CF)C(=O)O(7479)'],
    products = ['C=C(CF)C(=O)O(7274)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=[C]O(165)', 'C=[C]CF(7024)'],
    products = ['C=C(CF)C(=O)O(7274)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', '[CH]=C(CF)C(=O)O(7480)'],
    products = ['C=C(CF)C(=O)O(7274)'],
