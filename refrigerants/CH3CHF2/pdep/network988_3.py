...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]C(F)F(2929)'],
    products = ['O=C(F)[CH]F(4261)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C]F(2927)', 'HCO(15)'],
    products = ['O=C[C](F)F(3117)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FC1(F)[C]O1(11631)'],
    products = ['FC1(F)[CH]O1(4338)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F(37)', 'F[C]1[CH]O1(5679)'],
    products = ['FC1(F)[CH]O1(4338)'],
