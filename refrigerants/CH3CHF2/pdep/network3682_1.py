...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00256,0.042735,-2.35974e-05,6.15005e-09,-6.40676e-13,21019.4,21.5097], Tmin=(100,'K'), Tmax=(2119.08,'K')), NASAPolynomial(coeffs=[12.8455,0.0222676,-9.10922e-06,1.59199e-09,-1.02929e-13,16424.1,-38.9438], Tmin=(2119.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFHH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[CH2][C]1CC(F)C1(10870)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32391,0.052503,-3.70926e-05,1.31107e-08,-1.87327e-12,4708.04,20.7463], Tmin=(100,'K'), Tmax=(1626,'K')), NASAPolynomial(coeffs=[13.6463,0.0221895,-9.12816e-06,1.64515e-09,-1.10427e-13,700.781,-44.6926], Tmin=(1626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.3012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(230)', '[CH2]C([CH2])=C(10867)'],
    products = ['[CH2]C(=C)C[CH]F(6409)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(=C)C=CF(10872)'],
    products = ['[CH2]C(=C)C[CH]F(6409)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C([CH2])=C(10867)'],
    products = ['[CH2]C(=C)C[CH]F(6409)'],
