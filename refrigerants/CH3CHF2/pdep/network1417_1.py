...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=COCOF(2328)'],
    products = ['CC(OF)OC=O(3858)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(OF)O[CH]O(3978)'],
    products = ['CC(OF)OC=O(3858)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(126)', 'C[CH]OC=O(2502)'],
    products = ['CC(OF)OC=O(3858)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'O=CO[CH]OF(2366)'],
    products = ['CC(OF)OC=O(3858)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C[C](OF)OC=O(3980)'],
    products = ['CC(OF)OC=O(3858)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]C(OF)OC=O(3981)'],
    products = ['CC(OF)OC=O(3858)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'CC(OF)O[C]=O(3982)'],
    products = ['CC(OF)OC=O(3858)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'CC(=O)OC=O(2811)'],
    products = ['CC(OF)OC=O(3858)'],
