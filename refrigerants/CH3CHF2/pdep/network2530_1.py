...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.369029,'amu*angstrom^2'), symmetry=1, barrier=(8.4847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.369586,'amu*angstrom^2'), symmetry=1, barrier=(8.4975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368452,'amu*angstrom^2'), symmetry=1, barrier=(8.47144,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0891,0.0495855,-2.54493e-05,-3.21945e-08,4.20941e-11,23154.4,20.7916], Tmin=(100,'K'), Tmax=(486.127,'K')), NASAPolynomial(coeffs=[5.09338,0.035909,-1.73249e-05,3.39526e-09,-2.41122e-13,22731.9,7.12253], Tmin=(486.127,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-F1sCdH)(H)(H)) + radical(Cds_S)"""),
)
...
"""),
    E0 = (190.191,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,1685,370,285.2,285.219],'cm^-1')),
        HinderedRotor(inertia=(0.00207221,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188926,'amu*angstrom^2'), symmetry=1, barrier=(10.9046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188894,'amu*angstrom^2'), symmetry=1, barrier=(10.9045,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54139,0.0461023,-2.07095e-05,-3.10472e-09,3.55194e-12,-16405.6,19.2012], Tmin=(100,'K'), Tmax=(1112.73,'K')), NASAPolynomial(coeffs=[11.6384,0.0239535,-9.92344e-06,1.85905e-09,-1.30385e-13,-19528.5,-34.5252], Tmin=(1112.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (118.208,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([323,546,651,945,1004,1329,3278,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2100,2250,500,550,180],'cm^-1')),
        HinderedRotor(inertia=(0.0230509,'amu*angstrom^2'), symmetry=1, barrier=(67.7875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.543836,'amu*angstrom^2'), symmetry=1, barrier=(12.5039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.94968,'amu*angstrom^2'), symmetry=1, barrier=(67.819,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79818,0.049398,-4.52893e-05,2.5505e-08,-6.1785e-12,14295.6,20.032], Tmin=(100,'K'), Tmax=(973.875,'K')), NASAPolynomial(coeffs=[7.23734,0.0270576,-1.08795e-05,1.94959e-09,-1.31646e-13,13236.2,-6.06486], Tmin=(973.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Csj(Cs-F1sCtH)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.406513,'amu*angstrom^2'), symmetry=1, barrier=(9.34654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.406452,'amu*angstrom^2'), symmetry=1, barrier=(9.34514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.577357,'amu*angstrom^2'), symmetry=1, barrier=(13.2746,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07769,0.0463171,-3.07245e-05,1.09947e-08,-1.76131e-12,15653.9,19.8774], Tmin=(100,'K'), Tmax=(1312.39,'K')), NASAPolynomial(coeffs=[6.73289,0.0321286,-1.45078e-05,2.75702e-09,-1.92092e-13,14432,-3.84678], Tmin=(1312.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-HHH)(F1s)(Cd-CdH)) + radical(Cds_S)"""),
)
...
"""),
    E0 = (223.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([164,312,561,654,898,1207,1299,3167,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1670,1700,300,440],'cm^-1')),
        HinderedRotor(inertia=(0.332867,'amu*angstrom^2'), symmetry=1, barrier=(7.65327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331687,'amu*angstrom^2'), symmetry=1, barrier=(7.62614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331567,'amu*angstrom^2'), symmetry=1, barrier=(7.62337,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55604,0.0598665,-8.04164e-05,7.29985e-08,-2.76392e-11,26903.5,21.2854], Tmin=(100,'K'), Tmax=(785.978,'K')), NASAPolynomial(coeffs=[3.93952,0.0374675,-1.80709e-05,3.49402e-09,-2.44202e-13,26846,12.3783], Tmin=(785.978,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(F)=C[CH]C(6443)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51367,0.0466418,-2.01541e-05,-4.26796e-09,4.09154e-12,3223.24,20.3731], Tmin=(100,'K'), Tmax=(1091.99,'K')), NASAPolynomial(coeffs=[11.5353,0.024607,-1.00445e-05,1.86689e-09,-1.30511e-13,159.577,-32.8638], Tmin=(1091.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.9988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCsCdF) + radical(Allyl_S) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90579,0.045852,-2.80319e-05,8.39792e-09,-1.03546e-12,16620.9,19.7006], Tmin=(100,'K'), Tmax=(1771.97,'K')), NASAPolynomial(coeffs=[10.7745,0.0258322,-1.10851e-05,2.02213e-09,-1.3594e-13,13477.8,-28.1596], Tmin=(1771.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=C[C](C)F(6445)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57303,0.0454139,-1.84274e-05,-5.07003e-09,4.14459e-12,5297.81,21.5052], Tmin=(100,'K'), Tmax=(1104.42,'K')), NASAPolynomial(coeffs=[11.2629,0.0248561,-1.02503e-05,1.91224e-09,-1.33783e-13,2270.88,-30.2192], Tmin=(1104.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.2664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-HHH)(F1s)(Cd-CdH)) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[C]=C[CH]F(6432)'],
    products = ['[CH2]C(F)C=[C]C(6359)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=CC=[C]C(6434)'],
    products = ['[CH2]C(F)C=[C]C(6359)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(66.2277,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
Ea raised from -21.3 to 0.0 kJ/mol."""),
)

reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2][CH]C#CC(6438)'],
    products = ['[CH2]C(F)C=[C]C(6359)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(271.979,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['C[C]=C[C](C)F(6439)'],
    products = ['[CH2]C(F)C=[C]C(6359)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)C=[C]C(6359)'],
    products = ['[CH2]C=C[C](C)F(6445)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(159.496,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
