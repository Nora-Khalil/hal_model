...
"""),
    E0 = (118.833,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,797.388],'cm^-1')),
        HinderedRotor(inertia=(0.516568,'amu*angstrom^2'), symmetry=1, barrier=(11.8769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12268,'amu*angstrom^2'), symmetry=1, barrier=(2.82065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00662523,'amu*angstrom^2'), symmetry=1, barrier=(2.92878,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7348,0.0432476,-2.04581e-05,-3.2101e-10,2.22133e-12,14379.3,21.6911], Tmin=(100,'K'), Tmax=(1125.04,'K')), NASAPolynomial(coeffs=[10.0238,0.0244801,-9.7065e-06,1.7644e-09,-1.21233e-13,11836.8,-22.2857], Tmin=(1125.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)
...
"""),
    E0 = (255.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3120.78],'cm^-1')),
        HinderedRotor(inertia=(0.207826,'amu*angstrom^2'), symmetry=1, barrier=(4.77832,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.13092,'amu*angstrom^2'), symmetry=1, barrier=(71.986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000691649,'amu*angstrom^2'), symmetry=1, barrier=(4.77833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.60724,0.0163687,6.56514e-05,-9.99182e-08,4.19694e-11,-15901.6,14.3746], Tmin=(100,'K'), Tmax=(884.947,'K')), NASAPolynomial(coeffs=[10.4295,0.0189454,-3.01379e-06,2.48276e-10,-1.19007e-14,-18771.4,-30.7992], Tmin=(884.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94484,0.0349454,7.66245e-06,-3.36232e-08,1.49832e-11,-22687.9,20.7219], Tmin=(100,'K'), Tmax=(989.603,'K')), NASAPolynomial(coeffs=[11.37,0.0209935,-7.7874e-06,1.4396e-09,-1.03044e-13,-25735.6,-30.6239], Tmin=(989.603,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0860889,'amu*angstrom^2'), symmetry=1, barrier=(1.97935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0858784,'amu*angstrom^2'), symmetry=1, barrier=(1.97451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0861584,'amu*angstrom^2'), symmetry=1, barrier=(1.98095,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28203,0.0410003,-2.92977e-05,1.25296e-08,-2.5095e-12,-5546.14,17.7899], Tmin=(100,'K'), Tmax=(1074.56,'K')), NASAPolynomial(coeffs=[5.39526,0.0294112,-1.31201e-05,2.49269e-09,-1.74336e-13,-6215.2,2.54651], Tmin=(1074.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.6048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CJCC=O)"""),
)
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74737,0.0520372,-4.94716e-05,2.87645e-08,-7.24989e-12,7908.68,21.2673], Tmin=(100,'K'), Tmax=(932.135,'K')), NASAPolynomial(coeffs=[7.09923,0.0290718,-1.25165e-05,2.33486e-09,-1.61614e-13,6910.92,-4.17645], Tmin=(932.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.0998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.795,0.0417469,-1.70397e-05,-5.22725e-09,4.43766e-12,10714.1,24.1601], Tmin=(100,'K'), Tmax=(1041.51,'K')), NASAPolynomial(coeffs=[10.1682,0.0227641,-8.6752e-06,1.56438e-09,-1.07964e-13,8255.39,-20.0067], Tmin=(1041.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([CH2])O(2910)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {13,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {6,S}
3  C u0 p0 c0 {2,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (100.061,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,702.551],'cm^-1')),
        HinderedRotor(inertia=(0.0752404,'amu*angstrom^2'), symmetry=1, barrier=(1.72993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0754737,'amu*angstrom^2'), symmetry=1, barrier=(1.73529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0750342,'amu*angstrom^2'), symmetry=1, barrier=(1.72518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516718,'amu*angstrom^2'), symmetry=1, barrier=(11.8804,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8589,0.0476153,-3.47198e-05,1.40984e-08,-2.47519e-12,10926.7,18.8778], Tmin=(100,'K'), Tmax=(1281.5,'K')), NASAPolynomial(coeffs=[8.13139,0.0280367,-1.18029e-05,2.1764e-09,-1.49398e-13,9319.1,-12.9391], Tmin=(1281.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.2142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C([O])CC(2912)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
...
"""),
    E0 = (125.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,495.968,519.687],'cm^-1')),
        HinderedRotor(inertia=(0.0188395,'amu*angstrom^2'), symmetry=1, barrier=(3.5876,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0527574,'amu*angstrom^2'), symmetry=1, barrier=(10.57,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.45966,'amu*angstrom^2'), symmetry=1, barrier=(10.5685,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52113,0.0479929,-3.07943e-05,7.97487e-09,-1.13237e-13,15149.8,21.305], Tmin=(100,'K'), Tmax=(1146.86,'K')), NASAPolynomial(coeffs=[11.1279,0.0228555,-8.86262e-06,1.58895e-09,-1.08218e-13,12395.9,-28.7583], Tmin=(1146.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]CC[O](1669)'],
    products = ['[CH2]CC(C)[O](2837)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(C)[O](1820)'],
    products = ['[CH2]CC(C)[O](2837)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][CH2](611)', 'CH3CHO(36)'],
    products = ['[CH2]CC(C)[O](2837)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[CH2]CC=O(1632)'],
    products = ['[CH2]CC(C)[O](2837)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH2](611)', 'C[CH][O](468)'],
    products = ['[CH2]CC(C)[O](2837)'],
