...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.70022,'amu*angstrom^2'), symmetry=1, barrier=(16.0994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.700503,'amu*angstrom^2'), symmetry=1, barrier=(16.106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35749,0.0313483,-2.2925e-05,7.99154e-09,-1.1013e-12,37302.2,15.5751], Tmin=(100,'K'), Tmax=(1708.84,'K')), NASAPolynomial(coeffs=[11.2465,0.0105414,-4.66114e-06,8.66387e-10,-5.89123e-14,34264.2,-32.0724], Tmin=(1708.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + group(CJ2_singlet-FC)"""),
)

species(
    label = 'C=C(F)C=C(O)F(6959)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789771,0.0619097,-6.25395e-05,3.06e-08,-5.78016e-12,-59432,21.3621], Tmin=(100,'K'), Tmax=(1302.32,'K')), NASAPolynomial(coeffs=[17.2669,0.0113019,-4.25078e-06,7.61991e-10,-5.23858e-14,-63723.8,-62.483], Tmin=(1302.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-495.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + group(CdCFO) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.372068,'amu*angstrom^2'), symmetry=1, barrier=(8.55457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.371902,'amu*angstrom^2'), symmetry=1, barrier=(8.55075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09464,'amu*angstrom^2'), symmetry=1, barrier=(25.168,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28706,0.0636836,-7.95954e-05,5.37009e-08,-1.4727e-11,-31273.3,22.5575], Tmin=(100,'K'), Tmax=(883.135,'K')), NASAPolynomial(coeffs=[10.1481,0.0235487,-1.14255e-05,2.23964e-09,-1.59027e-13,-32838.4,-19.0904], Tmin=(883.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]C=CC(O)(F)F(6961)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-279.461,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,275,321,533,585,746,850,1103,2995,3025,975,1000,1300,1375,400,500,1630,1680,340.916,340.923,340.936,341.047],'cm^-1')),
        HinderedRotor(inertia=(0.629088,'amu*angstrom^2'), symmetry=1, barrier=(51.8861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.629045,'amu*angstrom^2'), symmetry=1, barrier=(51.8844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.628907,'amu*angstrom^2'), symmetry=1, barrier=(51.8867,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39776,0.0606142,-5.99675e-05,3.33966e-08,-7.89012e-12,-33520.5,22.5131], Tmin=(100,'K'), Tmax=(995.876,'K')), NASAPolynomial(coeffs=[8.9687,0.0302049,-1.41646e-05,2.73479e-09,-1.92911e-13,-35028.4,-13.981], Tmin=(995.876,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-279.461,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.33012,'amu*angstrom^2'), symmetry=1, barrier=(30.5821,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.999693,0.0573176,-6.28499e-05,3.38639e-08,-6.91713e-12,-12041.8,19.6279], Tmin=(100,'K'), Tmax=(1323.05,'K')), NASAPolynomial(coeffs=[15.5459,0.00832781,-1.62566e-06,1.50533e-10,-5.70494e-15,-15452.3,-52.9634], Tmin=(1323.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFO) + group(Cds-CdsHH) + radical(C=CJC=C)"""),
)
...
"""),
    E0 = (-333.944,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,157,399,436,611,601,744,1127,3000,3100,440,815,1455,1000,2100,2250,500,550,2015.38],'cm^-1')),
        HinderedRotor(inertia=(0.776473,'amu*angstrom^2'), symmetry=1, barrier=(81.5137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.557675,'amu*angstrom^2'), symmetry=1, barrier=(12.822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.30415,'amu*angstrom^2'), symmetry=1, barrier=(98.9608,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42403,0.0584719,-7.36423e-05,4.92807e-08,-1.31514e-11,-40073,21.5922], Tmin=(100,'K'), Tmax=(915.722,'K')), NASAPolynomial(coeffs=[10.6018,0.0183839,-7.979e-06,1.47838e-09,-1.01552e-13,-41753.9,-21.8775], Tmin=(915.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-333.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Propargyl)"""),
)

species(
    label = '[CH]=C=CC(O)(F)F(6966)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.804983,'amu*angstrom^2'), symmetry=1, barrier=(18.5082,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18119,0.0645855,-8.90995e-05,6.40598e-08,-1.8182e-11,-38275.4,21.8556], Tmin=(100,'K'), Tmax=(865.625,'K')), NASAPolynomial(coeffs=[11.3359,0.0176629,-7.79289e-06,1.44355e-09,-9.86149e-14,-40033.5,-25.6703], Tmin=(865.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-319.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ)"""),
)

species(
    label = 'C=C[C]C(O)(F)F(6967)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {4,S} {11,S}
4  C u0 p0 c0 {1,S} {2,S} {3,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.70135,'amu*angstrom^2'), symmetry=1, barrier=(39.1175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70004,'amu*angstrom^2'), symmetry=1, barrier=(39.0874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.69957,'amu*angstrom^2'), symmetry=1, barrier=(39.0765,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.9824,0.0721888,-0.000108148,9.15367e-08,-3.13279e-11,-25062.2,32.6207], Tmin=(100,'K'), Tmax=(784.433,'K')), NASAPolynomial(coeffs=[8.47312,0.028512,-1.41499e-05,2.74492e-09,-1.91545e-13,-26068.8,-0.624362], Tmin=(784.433,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C=CC(O)(F)F-2(6968)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {4,S} {10,S}
4  C u0 p0 c0 {1,S} {2,S} {3,S} {5,S}
...
"""),
    E0 = (-199.045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,275,321,533,585,746,850,1103,2995,3025,975,1000,1300,1375,400,500,1630,1680,231.529,231.533,231.542,3360.5],'cm^-1')),
        HinderedRotor(inertia=(0.114297,'amu*angstrom^2'), symmetry=1, barrier=(4.34775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114291,'amu*angstrom^2'), symmetry=1, barrier=(4.34772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114283,'amu*angstrom^2'), symmetry=1, barrier=(4.34763,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06294,0.0711309,-0.000112634,9.8946e-08,-3.47029e-11,-23840.2,22.7344], Tmin=(100,'K'), Tmax=(793.386,'K')), NASAPolynomial(coeffs=[8.08378,0.0273486,-1.4004e-05,2.74761e-09,-1.92546e-13,-24690.3,-7.84895], Tmin=(793.386,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.729865,'amu*angstrom^2'), symmetry=1, barrier=(16.781,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31804,0.0389355,-3.50063e-05,1.69943e-08,-3.48131e-12,-21527,16.7133], Tmin=(100,'K'), Tmax=(1133.55,'K')), NASAPolynomial(coeffs=[7.85665,0.0193911,-9.14362e-06,1.78378e-09,-1.26679e-13,-22782.7,-10.7015], Tmin=(1133.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cd-Cd(CO)H) + group(COCFO) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=C=C=C(O)F(6970)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45302,0.0524266,-5.90455e-05,3.25323e-08,-6.93637e-12,-6089.75,17.7855], Tmin=(100,'K'), Tmax=(1155.02,'K')), NASAPolynomial(coeffs=[13.7097,0.00997992,-3.9207e-06,7.14614e-10,-4.95281e-14,-8921.07,-43.112], Tmin=(1155.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.4212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CdCddFO) + group(Cds-CdsHH) + group(Cdd-CdsCds) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['OF(142)', 'C=C=C[C]F-2(6958)'],
    products = ['C=C=CC(O)(F)F(6397)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C=[C]C(O)(F)F(6960)'],
    products = ['C=C=CC(O)(F)F(6397)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=[C]C=C(O)F(6963)'],
    products = ['C=C=CC(O)(F)F(6397)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=[C]C=C(F)F(6964)'],
    products = ['C=C=CC(O)(F)F(6397)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](F)F(4619)', '[CH]=C=C(4167)'],
    products = ['C=C=CC(O)(F)F(6397)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C#CC(O)(F)F(6965)'],
    products = ['C=C=CC(O)(F)F(6397)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C=CC(O)(F)F(6966)'],
    products = ['C=C=CC(O)(F)F(6397)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C=CC(O)(F)F-2(6968)'],
    products = ['C=C=CC(O)(F)F(6397)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=C=CC(=O)F(6969)'],
    products = ['C=C=CC(O)(F)F(6397)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C=C=C=C(O)F(6970)'],
    products = ['C=C=CC(O)(F)F(6397)'],
