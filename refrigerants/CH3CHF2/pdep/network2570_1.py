...
reaction(
    label = 'reaction1',
    reactants = ['C#CC[C-]=[OH+](7028)'],
    products = ['CO(13)', 'C=C=C(6745)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C#C[OH+][C-]=C(7201)'],
    products = ['C#CC[C-]=[OH+](7028)'],
    transitionState = 'TS2',
