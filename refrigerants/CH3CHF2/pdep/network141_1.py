...
reaction(
    label = 'reaction2',
    reactants = ['CH3F(39)', 'OC[C]F-2(447)'],
    products = ['OCC(F)CF(480)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'OC(F)CF(544)'],
    products = ['OCC(F)CF(480)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(25)', 'OCC(F)F(886)'],
    products = ['OCC(F)CF(480)'],
    transitionState = 'TS7',
