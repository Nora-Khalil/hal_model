...
"""),
    ...
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73712,0.053943,-6.82563e-05,4.97793e-08,-1.51266e-11,25109.5,21.1678], Tmin=(100,'K'), Tmax=(793.122,'K')), NASAPolynomial(coeffs=[7.65719,0.0240852,-1.17858e-05,2.31116e-09,-1.63795e-13,24170.5,-6.02075], Tmin=(793.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(CdCsCdF) + group(Cds-CdsHH) + group(Ct-CtCs) + group(CtCF) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.8421,'amu*angstrom^2'), symmetry=1, barrier=(42.3536,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.0755,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63738,0.0503913,-5.36427e-05,2.40828e-08,-1.78865e-12,47736.4,18.42], Tmin=(100,'K'), Tmax=(814.822,'K')), NASAPolynomial(coeffs=[12.1573,0.0106995,-2.57456e-06,3.00172e-10,-1.44678e-14,45625.3,-32.6126], Tmin=(814.822,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CJC=C) + radical(C=C=CJ)"""),
)
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5257,0.0579074,-6.8299e-05,4.51396e-08,-1.23037e-11,21304.5,23.633], Tmin=(100,'K'), Tmax=(883.721,'K')), NASAPolynomial(coeffs=[8.93513,0.0243696,-1.13722e-05,2.19421e-09,-1.54527e-13,19995,-11.1972], Tmin=(883.721,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=[C]CC(F)=CF(8117)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {4,S} {6,S} {8,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.3202,'amu*angstrom^2'), symmetry=1, barrier=(7.36202,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (188.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,161,331,427,521,441,625,1076,1234,3115,3125,620,680,785,800,1600,1700,180,2691.96],'cm^-1')),
        HinderedRotor(inertia=(0.0294769,'amu*angstrom^2'), symmetry=1, barrier=(8.50623,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.413,0.0584623,-6.34899e-05,3.65141e-08,-8.51069e-12,22736,22.8667], Tmin=(100,'K'), Tmax=(1033.18,'K')), NASAPolynomial(coeffs=[10.9584,0.021507,-9.83742e-06,1.89464e-09,-1.33821e-13,20763.6,-23.4961], Tmin=(1033.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CdCsCdF) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cd-CsF1s)(H)) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1084)', '[CH]C(=C)F(4004)'],
    products = ['[CH]=C(F)C[C]=CF(7488)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=C(F)CC#C(8112)'],
    products = ['[CH]=C(F)C[C]=CF(7488)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(F)CC#CF(8113)'],
    products = ['[CH]=C(F)C[C]=CF(7488)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH]=C=C[C]=CF(8114)'],
    products = ['[CH]=C(F)C[C]=CF(7488)'],
