...
reaction(
    label = 'reaction2',
    reactants = ['C[C]F(124)', 'C=C(O)O(1836)'],
    products = ['C=C(O)OC(C)F(3861)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C=C(O)OC(4304)'],
    products = ['C=C(O)OC(C)F(3861)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'C=C(O)OCF(1722)'],
    products = ['C=C(O)OC(C)F(3861)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2CHF(56)', 'C=C(O)O(1836)'],
    products = ['C=C(O)OC(C)F(3861)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=C(O)O[CH]C(4312)'],
    products = ['C=C(O)OC(C)F(3861)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(=O)O(1378)', 'CH3-CHF(63)'],
    products = ['C=C(O)OC(C)F(3861)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]O(137)', 'CC([O])F(377)'],
    products = ['C=C(O)OC(C)F(3861)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'C=[C]OC(C)F(1980)'],
    products = ['C=C(O)OC(C)F(3861)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(=O)OC(C)F(4313)'],
    products = ['C=C(O)OC(C)F(3861)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(19)', 'C=C(O)O[CH]F(1844)'],
    products = ['C=C(O)OC(C)F(3861)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'C=C(O)O[C](C)F(4314)'],
    products = ['C=C(O)OC(C)F(3861)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH2]C(F)OC(=C)O(4315)'],
    products = ['C=C(O)OC(C)F(3861)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH]=C(O)OC(C)F(4316)'],
    products = ['C=C(O)OC(C)F(3861)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C(O)OC(C)F(3861)'],
    products = ['CH2CHF(56)', 'CC(=O)O(1258)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'C=COC(=C)O(2309)'],
    products = ['C=C(O)OC(C)F(3861)'],
