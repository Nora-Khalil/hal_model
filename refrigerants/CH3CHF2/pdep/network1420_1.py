...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', 'C=C[C]F(3996)'],
    products = ['O=[C]CC=[C]F(3966)'],
    transitionState = 'TS3',
