...
reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'F[C]COF(492)'],
    products = ['CC(F)COF(478)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(126)', '[CH2]C(C)F(185)'],
    products = ['CC(F)COF(478)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]OF(186)', 'CH3-CHF(63)'],
    products = ['CC(F)COF(478)'],
