species(
    label = '[CH2]C(F)(F)OOC=C(F)F(6967)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.223769,'amu*angstrom^2'), symmetry=1, barrier=(5.14488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79092,'amu*angstrom^2'), symmetry=1, barrier=(41.1768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78642,'amu*angstrom^2'), symmetry=1, barrier=(41.0733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.543275,'amu*angstrom^2'), symmetry=1, barrier=(12.491,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00909979,0.0964929,-0.000136877,1.03407e-07,-3.16885e-11,-82083.9,32.6704], Tmin=(100,'K'), Tmax=(793.279,'K')), NASAPolynomial(coeffs=[12.4334,0.0337523,-1.824e-05,3.70423e-09,-2.66983e-13,-84057.9,-24.476], Tmin=(793.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-683.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]C(F)(F)OC(F)(F)C=O(7228)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0808735,0.0976728,-0.000144595,1.136e-07,-3.59294e-11,-124434,30.4095], Tmin=(100,'K'), Tmax=(771.924,'K')), NASAPolynomial(coeffs=[12.587,0.0320265,-1.70259e-05,3.41996e-09,-2.44357e-13,-126390,-27.426], Tmin=(771.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1035.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
"""),
    E0 = (-449.37,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,223,363,546,575,694,1179,1410,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,297.523,297.524,297.524,2095.84],'cm^-1')),
        HinderedRotor(inertia=(0.176,'amu*angstrom^2'), symmetry=1, barrier=(11.056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588183,'amu*angstrom^2'), symmetry=1, barrier=(36.9477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.58818,'amu*angstrom^2'), symmetry=1, barrier=(36.9478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0118534,'amu*angstrom^2'), symmetry=1, barrier=(36.9476,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0512649,0.0975461,-0.000146089,1.14783e-07,-3.63059e-11,-53908.5,31.8263], Tmin=(100,'K'), Tmax=(771.427,'K')), NASAPolynomial(coeffs=[12.7153,0.0313481,-1.73687e-05,3.54172e-09,-2.5516e-13,-55878.2,-26.4519], Tmin=(771.427,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-449.37,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CCJ2_triplet)"""),
)

species(
    label = 'FC1(F)[CH]OOC(F)(F)C1(7230)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.413881,0.0822651,-8.39018e-05,4.24744e-08,-8.20338e-12,-105028,25.4745], Tmin=(100,'K'), Tmax=(1397.18,'K')), NASAPolynomial(coeffs=[20.7374,0.0145376,-3.48916e-06,4.30868e-10,-2.29556e-14,-110238,-81.1371], Tmin=(1397.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-874.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(CsCsCsFF) + group(CsCFFO) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCsJOOC)"""),
)

species(
    label = 'F[C](F)C1CC(F)(F)OO1(7231)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.390406,0.0823984,-8.62392e-05,4.46364e-08,-8.7884e-12,-99623.5,29.0671], Tmin=(100,'K'), Tmax=(1374.88,'K')), NASAPolynomial(coeffs=[20.7059,0.0135683,-3.01344e-06,3.37916e-10,-1.64201e-14,-104720,-76.8649], Tmin=(1374.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-829.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCsFFH) + ring(12dioxolane) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
species(
    label = '[CH2]C(F)(F)OO[C]=C(F)F(7232)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-443.878,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,562,600,623,1070,1265,1685,370,180,2350.6],'cm^-1')),
        HinderedRotor(inertia=(1.91234,'amu*angstrom^2'), symmetry=1, barrier=(43.9685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386561,'amu*angstrom^2'), symmetry=1, barrier=(8.8878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386451,'amu*angstrom^2'), symmetry=1, barrier=(8.88527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.91469,'amu*angstrom^2'), symmetry=1, barrier=(44.0226,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.119774,0.102449,-0.000180587,1.67487e-07,-6.04583e-11,-53249.3,36.1695], Tmin=(100,'K'), Tmax=(809.177,'K')), NASAPolynomial(coeffs=[9.08179,0.0364533,-2.02293e-05,4.04697e-09,-2.84968e-13,-54067,-2.12544], Tmin=(809.177,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-443.878,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CJCOOH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-194.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,2175,525,239,401,1367,290.503],'cm^-1')),
        HinderedRotor(inertia=(0.446043,'amu*angstrom^2'), symmetry=1, barrier=(10.2554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37855,'amu*angstrom^2'), symmetry=1, barrier=(31.6955,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37838,'amu*angstrom^2'), symmetry=1, barrier=(31.6916,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.178358,0.0921794,-0.000148198,1.25017e-07,-4.23168e-11,-23259.9,29.3735], Tmin=(100,'K'), Tmax=(723.208,'K')), NASAPolynomial(coeffs=[11.6822,0.0285427,-1.61885e-05,3.30844e-09,-2.37677e-13,-24923.6,-22.3959], Tmin=(723.208,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsCFFO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(CtCF) + radical(CJCOOH)"""),
)

species(
    label = 'CC(F)(F)OO[C]=C(F)F(7234)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-657.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,562,600,623,1070,1265,1685,370,180,2400.66],'cm^-1')),
        HinderedRotor(inertia=(1.82989,'amu*angstrom^2'), symmetry=1, barrier=(42.0728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.41619,'amu*angstrom^2'), symmetry=1, barrier=(9.56902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.416507,'amu*angstrom^2'), symmetry=1, barrier=(9.57631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.82892,'amu*angstrom^2'), symmetry=1, barrier=(42.0505,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0197892,0.0993322,-0.000166145,1.53538e-07,-5.62046e-11,-78985.8,33.8152], Tmin=(100,'K'), Tmax=(790.672,'K')), NASAPolynomial(coeffs=[8.15956,0.0406701,-2.20679e-05,4.41223e-09,-3.11936e-13,-79739,-0.308029], Tmin=(790.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-657.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(C=CJO)"""),
)

species(
    label = 'FC[C](F)OOC=C(F)F(7235)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.63887,'amu*angstrom^2'), symmetry=1, barrier=(37.6807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.708451,'amu*angstrom^2'), symmetry=1, barrier=(16.2887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63759,'amu*angstrom^2'), symmetry=1, barrier=(37.6515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.710705,'amu*angstrom^2'), symmetry=1, barrier=(16.3405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.310014,0.103379,-0.000159638,1.3126e-07,-4.34268e-11,-73840.3,32.4337], Tmin=(100,'K'), Tmax=(739.067,'K')), NASAPolynomial(coeffs=[12.5655,0.0336887,-1.81876e-05,3.6584e-09,-2.60921e-13,-75743.4,-25.7895], Tmin=(739.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-615.167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
    products = ['[CH2]C(F)(F)OC(F)(F)C=O(7228)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[C](F)OOC=C(F)F(4800)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]C(F)(F)OOC=C(F)F(7229)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
    products = ['FC1(F)[CH]OOC(F)(F)C1(7230)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
    products = ['F[C](F)C1CC(F)(F)OO1(7231)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)OOC=C(F)F(4486)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2][C](F)OOC=C(F)F(4488)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)(F)OOC=[C]F(6647)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C[C](F)F(3189)', '[CH2]C([O])(F)F(1114)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2CH(73)', '[CH2]C(F)(F)O[O](3123)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(F)(F)OO[C]=C(F)F(7232)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2]C(F)(F)OOC#CF(7233)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC(F)(F)OO[C]=C(F)F(7234)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC[C](F)OOC=C(F)F(7235)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]=COOC(F)(F)CF(7236)'],
    products = ['[CH2]C(F)(F)OOC=C(F)F(6967)'],
