...
"""),
    E0 = (401.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1670,1700,300,440,402.572,402.765,402.827,403.14],'cm^-1')),
        HinderedRotor(inertia=(0.130729,'amu*angstrom^2'), symmetry=1, barrier=(15.089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130991,'amu*angstrom^2'), symmetry=1, barrier=(15.0766,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130936,'amu*angstrom^2'), symmetry=1, barrier=(15.0811,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38371,0.0508909,-3.76246e-05,9.99695e-09,5.44169e-13,48405.9,24.7791], Tmin=(100,'K'), Tmax=(1024.69,'K')), NASAPolynomial(coeffs=[12.9457,0.0177132,-6.55909e-06,1.17247e-09,-8.10001e-14,45408.7,-34.3456], Tmin=(1024.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.10614,'amu*angstrom^2'), symmetry=1, barrier=(25.4322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10623,'amu*angstrom^2'), symmetry=1, barrier=(25.4344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10589,'amu*angstrom^2'), symmetry=1, barrier=(25.4266,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19021,0.0545897,-4.62677e-05,1.42709e-08,2.35843e-13,44755,19.8011], Tmin=(100,'K'), Tmax=(992.368,'K')), NASAPolynomial(coeffs=[15.211,0.0124892,-4.41846e-06,7.93288e-10,-5.60749e-14,41262.6,-51.3094], Tmin=(992.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (410.892,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,341.789,341.789,341.79],'cm^-1')),
        HinderedRotor(inertia=(0.200961,'amu*angstrom^2'), symmetry=1, barrier=(16.6593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200961,'amu*angstrom^2'), symmetry=1, barrier=(16.6593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200961,'amu*angstrom^2'), symmetry=1, barrier=(16.6593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36535,0.0495562,-2.86315e-05,-2.93948e-09,6.00551e-12,49521.3,24.7741], Tmin=(100,'K'), Tmax=(974.961,'K')), NASAPolynomial(coeffs=[14.2132,0.0156512,-5.40162e-06,9.60774e-10,-6.77762e-14,46122.3,-41.4674], Tmin=(974.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COC[C]=C(11076)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.904214,'amu*angstrom^2'), symmetry=1, barrier=(20.7897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.90565,'amu*angstrom^2'), symmetry=1, barrier=(20.8227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.905597,'amu*angstrom^2'), symmetry=1, barrier=(20.8215,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13798,0.0522198,-2.59443e-05,-1.31575e-08,1.15233e-11,49303,22.9352], Tmin=(100,'K'), Tmax=(942.13,'K')), NASAPolynomial(coeffs=[17.0503,0.0112167,-2.94182e-06,4.83768e-10,-3.55025e-14,45126.1,-59.1385], Tmin=(942.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(395)', 'C=[C]C[O](726)'],
    products = ['C=[C]CO[C]=C(10716)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', '[CH2]O[C]=C(396)'],
    products = ['C=[C]CO[C]=C(10716)'],
    transitionState = 'TS3',
