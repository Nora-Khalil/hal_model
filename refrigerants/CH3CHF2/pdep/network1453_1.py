...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]=C(F)C#C(3958)'],
    products = ['[CH]=C(F)C(=[CH])F(3993)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=[C]F(1074)', '[CH]=[C]F(1074)'],
    products = ['[CH]=C(F)C(=[CH])F(3993)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(78)', '[CH]=C=C=[CH](4055)'],
    products = ['[CH]=C(F)C(=[CH])F(3993)'],
    transitionState = 'TS6',
