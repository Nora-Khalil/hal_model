...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]O(165)', '[CH]=C=C(4302)'],
    products = ['C#CCC(=O)O(1373)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C#C[CH]C(=O)O(6756)'],
    products = ['C#CCC(=O)O(1373)'],
