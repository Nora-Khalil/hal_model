...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.976958,0.0574496,-4.57749e-05,1.83358e-08,-2.92113e-12,-37095.3,23.1696], Tmin=(100,'K'), Tmax=(1501.14,'K')), NASAPolynomial(coeffs=[15.3577,0.0191313,-7.48676e-06,1.3322e-09,-8.94347e-14,-41412.9,-52.0513], Tmin=(1501.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH)"""),
)
...
"""),
    E0 = (-58.7499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,319,1023,1071,1259,1317,1409,3054,3019,334,575,1197,1424,3202,2100,2250,500,550,211.05,211.05,3518.23],'cm^-1')),
        HinderedRotor(inertia=(2.49826,'amu*angstrom^2'), symmetry=1, barrier=(79.033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.49754,'amu*angstrom^2'), symmetry=1, barrier=(79.0328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.49967,'amu*angstrom^2'), symmetry=1, barrier=(79.0337,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45094,0.057792,-6.41458e-05,4.24358e-08,-1.16556e-11,-6975.77,24.1451], Tmin=(100,'K'), Tmax=(878.79,'K')), NASAPolynomial(coeffs=[8.32629,0.0264981,-1.07315e-05,1.91552e-09,-1.285e-13,-8184.19,-8.13622], Tmin=(878.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.7499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsHH) + group(CsCsFHH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Csj(Cs-CtHH)(F1s)(H))"""),
)
...
"""),
    E0 = (14.6903,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,212,931,1104,1251,1325,1474,3102,3155,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,1685,370,297.993,298.063,298.346],'cm^-1')),
        HinderedRotor(inertia=(0.00723864,'amu*angstrom^2'), symmetry=1, barrier=(26.0026,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188646,'amu*angstrom^2'), symmetry=1, barrier=(11.7752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.186999,'amu*angstrom^2'), symmetry=1, barrier=(11.783,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53148,0.0596008,-6.19318e-05,3.97202e-08,-1.12764e-11,1851.09,25.0983], Tmin=(100,'K'), Tmax=(823.819,'K')), NASAPolynomial(coeffs=[6.61494,0.0349179,-1.69887e-05,3.34977e-09,-2.39073e-13,1013.53,1.5588], Tmin=(823.819,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.6903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-CdHH)(F1s)(H)) + radical(Cds_S)"""),
)

species(
    label = 'FC[C]=[C]CCF(11871)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {4,S} {6,S} {8,S} {9,S}
...
"""),
    E0 = (59.1013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,122,584,932,1043,1247,1392,1461,2986,3039,1670,1700,300,440,323.526,323.735],'cm^-1')),
        HinderedRotor(inertia=(0.132728,'amu*angstrom^2'), symmetry=1, barrier=(9.86486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132755,'amu*angstrom^2'), symmetry=1, barrier=(9.86762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234631,'amu*angstrom^2'), symmetry=1, barrier=(17.4467,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65417,0.0569534,-5.43933e-05,3.16386e-08,-8.26753e-12,7188.15,25.3085], Tmin=(100,'K'), Tmax=(880.396,'K')), NASAPolynomial(coeffs=[6.47682,0.0350428,-1.70637e-05,3.37228e-09,-2.41208e-13,6338.95,2.65619], Tmin=(880.396,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.1013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = 'F[CH]C=C[CH]CF(11872)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27604,0.0543151,-3.82391e-05,1.30555e-08,-1.78904e-12,-17278.3,22.6258], Tmin=(100,'K'), Tmax=(1687.77,'K')), NASAPolynomial(coeffs=[14.7977,0.0222687,-9.75793e-06,1.80541e-09,-1.22619e-13,-21842.5,-49.6858], Tmin=(1687.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]C=[C]CF(11864)'],
    products = ['F[CH]CC=[C]CF(11813)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC=CC=[C]CF(11867)'],
    products = ['F[CH]CC=[C]CF(11813)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C=[C]CF(11864)'],
    products = ['F[CH]CC=[C]CF(11813)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(157.182,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
