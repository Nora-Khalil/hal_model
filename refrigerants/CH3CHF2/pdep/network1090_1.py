...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[C]=O(3025)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(128)', '[CH2]C([CH2])(F)F(3089)'],
    products = ['[CH2]C(F)(F)C[C]=O(3025)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C([CH2])(F)F(3089)'],
    products = ['[CH2]C(F)(F)C[C]=O(3025)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C=O(3014)'],
    products = ['[CH2]C(F)(F)C[C]=O(3025)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C[C]=O(3188)'],
    products = ['[CH2]C(F)(F)C[C]=O(3025)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C=C[O](3189)'],
    products = ['[CH2]C(F)(F)C[C]=O(3025)'],
