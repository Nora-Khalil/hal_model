...
"""),
    E0 = (-37.9935,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,395,473,707,1436,3000,3100,440,815,1455,1000,180,681.783,681.796,681.799,681.808,681.808,681.894],'cm^-1')),
        HinderedRotor(inertia=(0.00825718,'amu*angstrom^2'), symmetry=1, barrier=(2.72336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00825308,'amu*angstrom^2'), symmetry=1, barrier=(2.72346,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96215,0.0391546,-3.07341e-05,1.16961e-08,-1.76335e-12,-4491.53,19.346], Tmin=(100,'K'), Tmax=(1575.25,'K')), NASAPolynomial(coeffs=[12.3849,0.0126883,-5.53198e-06,1.03016e-09,-7.06141e-14,-7775.19,-35.6737], Tmin=(1575.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.9935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-OsHHH) + ring(Cs(O2)-O2s-Cs(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80591,0.0659622,-0.00014644,1.6097e-07,-6.31494e-11,-3071.24,16.564], Tmin=(100,'K'), Tmax=(861.114,'K')), NASAPolynomial(coeffs=[-1.72146,0.0381076,-2.08566e-05,4.08364e-09,-2.80981e-13,-823.522,42.5779], Tmin=(861.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-26.051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(oxirene)"""),
)

species(
    label = '[CH2]O[CH]C(=O)F(10655)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
...
"""),
    E0 = (165.957,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,3000,3100,440,815,1455,1000,180,180,1981.99,1987.35,1990.07],'cm^-1')),
        HinderedRotor(inertia=(0.26147,'amu*angstrom^2'), symmetry=1, barrier=(6.01171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263328,'amu*angstrom^2'), symmetry=1, barrier=(6.05442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91603,0.0639354,-0.000148343,1.63924e-07,-6.41807e-11,20017.6,18.6543], Tmin=(100,'K'), Tmax=(863.779,'K')), NASAPolynomial(coeffs=[-1.67843,0.0352283,-1.97345e-05,3.87927e-09,-2.66807e-13,22330.5,45.2627], Tmin=(863.779,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(165.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(CdCFO) + ring(oxirene) + radical(C=COCJ) + longDistanceInteraction_cyclic(Cd(F)=CdOs)"""),
)
...
"""),
    E0 = (-20.6181,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,262.257,262.291,262.297,262.323,1500.75,1500.76],'cm^-1')),
        HinderedRotor(inertia=(0.00245324,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0373857,'amu*angstrom^2'), symmetry=1, barrier=(36.6658,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42923,0.0347957,-2.43388e-05,8.26853e-09,-1.15224e-12,-2423.93,18.2444], Tmin=(100,'K'), Tmax=(1605.66,'K')), NASAPolynomial(coeffs=[9.36744,0.0175115,-8.19218e-06,1.56454e-09,-1.08448e-13,-4652.03,-18.514], Tmin=(1605.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.6181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-OsHHH) + ring(Cs(O2)-O2s-Cs(F)) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C1O[C]1F(5677)'],
    products = ['[CH2]OC1O[C]1F(10625)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]O[CH]C(=O)F(10655)'],
    products = ['[CH2]OC1O[C]1F(10625)'],
    transitionState = 'TS5',
