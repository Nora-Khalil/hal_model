...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37835,0.0629648,-6.39286e-05,3.98387e-08,-1.09608e-11,-2876.7,23.8834], Tmin=(100,'K'), Tmax=(849.164,'K')), NASAPolynomial(coeffs=[6.95016,0.0367186,-1.75659e-05,3.43977e-09,-2.44624e-13,-3822.97,-2.08632], Tmin=(849.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)

species(
    label = 'COC(C)=COF(3820)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-240.737,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3010,987.5,1337.5,450,1655,347.393,347.414,347.441],'cm^-1')),
        HinderedRotor(inertia=(0.173567,'amu*angstrom^2'), symmetry=1, barrier=(14.8653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173582,'amu*angstrom^2'), symmetry=1, barrier=(14.8653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173561,'amu*angstrom^2'), symmetry=1, barrier=(14.8653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173614,'amu*angstrom^2'), symmetry=1, barrier=(14.8654,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.502552,0.0677501,-5.3794e-05,1.43343e-08,1.27175e-12,-28820,23.7365], Tmin=(100,'K'), Tmax=(994.878,'K')), NASAPolynomial(coeffs=[17.463,0.0179385,-6.40279e-06,1.14655e-09,-8.04947e-14,-33104.2,-62.5719], Tmin=(994.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-240.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH)"""),
)
...
"""),
    E0 = (-301.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,325,375,415,465,420,450,1700,1750,295.936],'cm^-1')),
        HinderedRotor(inertia=(0.184485,'amu*angstrom^2'), symmetry=1, barrier=(11.4621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184387,'amu*angstrom^2'), symmetry=1, barrier=(11.462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184476,'amu*angstrom^2'), symmetry=1, barrier=(11.4622,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184267,'amu*angstrom^2'), symmetry=1, barrier=(11.4616,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.568432,0.0726499,-7.58873e-05,4.10152e-08,-8.79372e-12,-36101.5,23.8713], Tmin=(100,'K'), Tmax=(1134.61,'K')), NASAPolynomial(coeffs=[14.9571,0.0219221,-8.82158e-06,1.60816e-09,-1.1057e-13,-39366.6,-47.3626], Tmin=(1134.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-301.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.184762,'amu*angstrom^2'), symmetry=1, barrier=(4.24803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184604,'amu*angstrom^2'), symmetry=1, barrier=(4.24441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185432,'amu*angstrom^2'), symmetry=1, barrier=(4.26344,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.081,0.0668455,-7.65778e-05,4.87892e-08,-1.27015e-11,-19550.6,23.5407], Tmin=(100,'K'), Tmax=(928.248,'K')), NASAPolynomial(coeffs=[10.3949,0.0267071,-1.17115e-05,2.1989e-09,-1.52637e-13,-21279.6,-20.6994], Tmin=(928.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-163.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH2]C(OF)C(C)=O(3826)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {4,S}
3  O u0 p2 c0 {6,D}
...
"""),
    E0 = (-81.9787,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,243.296,4000],'cm^-1')),
        HinderedRotor(inertia=(0.608109,'amu*angstrom^2'), symmetry=1, barrier=(25.7079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.61401,'amu*angstrom^2'), symmetry=1, barrier=(25.7004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00226309,'amu*angstrom^2'), symmetry=1, barrier=(25.6953,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607355,'amu*angstrom^2'), symmetry=1, barrier=(25.7034,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.924572,0.0613743,-5.38601e-05,2.36488e-08,-4.12605e-12,-9743.89,27.6459], Tmin=(100,'K'), Tmax=(1375.54,'K')), NASAPolynomial(coeffs=[15.3178,0.0195198,-8.21874e-06,1.52843e-09,-1.05762e-13,-13703.6,-46.3823], Tmin=(1375.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.9787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CJCO)"""),
)
...
"""),
    E0 = (-349.054,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,365,385,505,600,445,480,1700,1720,307.776],'cm^-1')),
        HinderedRotor(inertia=(0.0902886,'amu*angstrom^2'), symmetry=1, barrier=(6.64125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0992223,'amu*angstrom^2'), symmetry=1, barrier=(6.58001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0122585,'amu*angstrom^2'), symmetry=1, barrier=(25.0304,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97039,0.0419197,-2.50877e-05,7.09539e-09,-8.01836e-13,-41906.6,18.9265], Tmin=(100,'K'), Tmax=(1988.28,'K')), NASAPolynomial(coeffs=[12.9514,0.0198281,-8.42126e-06,1.50714e-09,-9.91839e-14,-46273.2,-41.5976], Tmin=(1988.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-349.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)Cs)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['OF(142)', 'C=CC(C)=O(1920)'],
    products = ['CC(=O)C(C)OF(3771)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'CC(=O)C(C)[O](3823)'],
    products = ['CC(=O)C(C)OF(3771)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', 'CC=C(C)[O](3824)'],
    products = ['CC(=O)C(C)OF(3771)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'CC([O])=COF(1771)'],
    products = ['CC(=O)C(C)OF(3771)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'CC([O])=C(C)OF(3825)'],
    products = ['CC(=O)C(C)OF(3771)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(OF)C(C)=O(3826)'],
    products = ['CC(=O)C(C)OF(3771)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(19)', 'CC([C]=O)OF(3827)'],
    products = ['CC(=O)C(C)OF(3771)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'CC(=O)C(C)=O(2512)'],
    products = ['CC(=O)C(C)OF(3771)'],
