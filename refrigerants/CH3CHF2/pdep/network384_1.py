...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[CH2]C[C]=O(359)'],
    products = ['O=[C]CC[C]=O(1251)'],
    transitionState = 'TS3',
