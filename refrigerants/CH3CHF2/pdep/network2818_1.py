...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50486,0.0622448,-9.915e-05,9.26091e-08,-3.41978e-11,-31239.8,24.3393], Tmin=(100,'K'), Tmax=(814.808,'K')), NASAPolynomial(coeffs=[5.02261,0.0309074,-1.55618e-05,3.02823e-09,-2.10983e-13,-31346.1,10.9543], Tmin=(814.808,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37539,0.0258635,1.73563e-05,-3.73277e-08,1.47802e-11,-63825.7,19.2159], Tmin=(100,'K'), Tmax=(1027.23,'K')), NASAPolynomial(coeffs=[9.91474,0.0199946,-8.37348e-06,1.63129e-09,-1.18977e-13,-66613.9,-23.3918], Tmin=(1027.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-531.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(O2s-Cs-Cs-Cs(F))"""),
)

species(
    label = 'OC(O)C=CF(7820)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77918,0.0508302,-5.35486e-05,3.10538e-08,-7.42439e-12,-65557.3,21.1679], Tmin=(100,'K'), Tmax=(1000.58,'K')), NASAPolynomial(coeffs=[9.09022,0.0216037,-9.73535e-06,1.86261e-09,-1.31001e-13,-67020.4,-14.108], Tmin=(1000.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-545.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.228569,'amu*angstrom^2'), symmetry=1, barrier=(5.25525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22965,'amu*angstrom^2'), symmetry=1, barrier=(5.28012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96229,0.0503364,-7.45067e-05,6.88173e-08,-2.5752e-11,-38421.6,22.0557], Tmin=(100,'K'), Tmax=(796.835,'K')), NASAPolynomial(coeffs=[4.50027,0.0278473,-1.38203e-05,2.69045e-09,-1.88191e-13,-38516.5,12.3299], Tmin=(796.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-320.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-238.466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,360,370,350,291.318,293.988,1459.58],'cm^-1')),
        HinderedRotor(inertia=(0.0900184,'amu*angstrom^2'), symmetry=1, barrier=(5.57817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0913228,'amu*angstrom^2'), symmetry=1, barrier=(5.61134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0925635,'amu*angstrom^2'), symmetry=1, barrier=(5.57655,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68235,0.0570731,-8.48455e-05,7.78704e-08,-2.89898e-11,-28603.3,24.0258], Tmin=(100,'K'), Tmax=(792.867,'K')), NASAPolynomial(coeffs=[4.88825,0.0305976,-1.52676e-05,2.97964e-09,-2.08744e-13,-28787.9,11.3453], Tmin=(792.867,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'OC(O)[CH][CH]F(7823)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {11,S}
3  O u0 p2 c0 {4,S} {10,S}
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56808,0.056475,-6.87483e-05,4.56579e-08,-1.23197e-11,-33279.7,25.8427], Tmin=(100,'K'), Tmax=(897.997,'K')), NASAPolynomial(coeffs=[9.49341,0.0211729,-9.7803e-06,1.88058e-09,-1.32209e-13,-34703.1,-11.5398], Tmin=(897.997,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCJCO) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]C([O])O(7819)'],
    products = ['[O]C(O)C[CH]F(3553)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=CC[CH]F(343)'],
    products = ['[O]C(O)C[CH]F(3553)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(35.6906,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(68.862,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(15.9,'m^3/(mol*s)'), n=1.84, Ea=(51.7579,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C([O])O(7819)'],
    products = ['[O]C(O)C[CH]F(3553)'],
