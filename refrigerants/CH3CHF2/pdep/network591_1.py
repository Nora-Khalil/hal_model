...
"""),
    E0 = (-172.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,262,1290,369.175,369.343],'cm^-1')),
        HinderedRotor(inertia=(0.00123599,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0910921,'amu*angstrom^2'), symmetry=1, barrier=(8.8155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.091022,'amu*angstrom^2'), symmetry=1, barrier=(8.813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76954,0.0524116,-7.34486e-05,5.53377e-08,-1.67365e-11,-20679.3,20.5798], Tmin=(100,'K'), Tmax=(808.072,'K')), NASAPolynomial(coeffs=[8.85561,0.0173326,-8.32771e-06,1.60849e-09,-1.12578e-13,-21824.4,-12.0959], Tmin=(808.072,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + group(CJ2_singlet-FCO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.572725,'amu*angstrom^2'), symmetry=1, barrier=(13.1681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0861651,'amu*angstrom^2'), symmetry=1, barrier=(1.98111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.62619,'amu*angstrom^2'), symmetry=1, barrier=(37.3892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92943,0.0502628,-5.34682e-05,3.46879e-08,-9.92146e-12,-28758.7,19.8536], Tmin=(100,'K'), Tmax=(818.965,'K')), NASAPolynomial(coeffs=[6.30064,0.0289132,-1.43653e-05,2.85718e-09,-2.04867e-13,-29474.7,-0.362057], Tmin=(818.965,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-239.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-230.999,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,252.854,252.896,252.926],'cm^-1')),
        HinderedRotor(inertia=(0.329016,'amu*angstrom^2'), symmetry=1, barrier=(14.924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.32855,'amu*angstrom^2'), symmetry=1, barrier=(14.9265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00263974,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17907,0.0656824,-9.12756e-05,6.86196e-08,-2.06521e-11,-27684.5,22.8476], Tmin=(100,'K'), Tmax=(813.332,'K')), NASAPolynomial(coeffs=[10.1584,0.0215191,-9.82203e-06,1.85043e-09,-1.2754e-13,-29145,-18.6168], Tmin=(813.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-230.999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(CC(C)OJ) + radical(CCsJOH)"""),
)

species(
    label = '[O]C([CH]F)CO(3725)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-216.74,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,310.369,310.369,310.369],'cm^-1')),
        HinderedRotor(inertia=(0.00175006,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112879,'amu*angstrom^2'), symmetry=1, barrier=(7.71614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11288,'amu*angstrom^2'), symmetry=1, barrier=(7.71613,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21186,0.0673104,-0.000104853,9.0652e-08,-3.09835e-11,-25973.2,23.5003], Tmin=(100,'K'), Tmax=(829.722,'K')), NASAPolynomial(coeffs=[7.82542,0.0257921,-1.23766e-05,2.35313e-09,-1.61599e-13,-26739,-5.17313], Tmin=(829.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(CC(C)OJ) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)

species(
    label = '[O]CC([O])CF(3726)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u1 p2 c0 {4,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.122664,'amu*angstrom^2'), symmetry=1, barrier=(2.82029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122285,'amu*angstrom^2'), symmetry=1, barrier=(2.81158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72814,0.055279,-7.67807e-05,6.83184e-08,-2.51896e-11,-22244.8,22.1818], Tmin=(100,'K'), Tmax=(783.206,'K')), NASAPolynomial(coeffs=[4.94177,0.030966,-1.50854e-05,2.92384e-09,-2.04502e-13,-22505.9,9.01004], Tmin=(783.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-185.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(CC(C)OJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C[C](O)CF(3727)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {6,S} {11,S}
3  O u1 p2 c0 {4,S}
...
"""),
    E0 = (-239.324,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,180,180,1636.17],'cm^-1')),
        HinderedRotor(inertia=(0.308914,'amu*angstrom^2'), symmetry=1, barrier=(7.10253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308927,'amu*angstrom^2'), symmetry=1, barrier=(7.10284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308924,'amu*angstrom^2'), symmetry=1, barrier=(7.10277,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36306,0.0685792,-0.000121697,1.1789e-07,-4.31814e-11,-28699.3,23.1075], Tmin=(100,'K'), Tmax=(858.879,'K')), NASAPolynomial(coeffs=[3.97325,0.0322349,-1.59797e-05,3.04179e-09,-2.07347e-13,-28255.5,16.1056], Tmin=(858.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-239.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(CCOJ) + radical(C2CsJOH)"""),
)

species(
    label = 'OC=C(O)CF(3728)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.0717,'amu*angstrom^2'), symmetry=1, barrier=(24.6404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07873,'amu*angstrom^2'), symmetry=1, barrier=(24.8022,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.852269,0.0548446,-2.43485e-05,-2.74564e-08,2.03172e-11,-68787.6,19.5193], Tmin=(100,'K'), Tmax=(909.265,'K')), NASAPolynomial(coeffs=[22.3234,-0.000759322,3.28864e-06,-7.28089e-10,4.81087e-14,-74298.2,-90.8556], Tmin=(909.265,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-572.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH)"""),
)
...
"""),
    E0 = (-526.568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,194,682,905,1196,1383,3221,269.707],'cm^-1')),
        HinderedRotor(inertia=(0.00231781,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188077,'amu*angstrom^2'), symmetry=1, barrier=(9.71029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188125,'amu*angstrom^2'), symmetry=1, barrier=(9.71094,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58916,0.0522979,-5.37014e-05,2.90965e-08,-6.33677e-12,-63244,21.0943], Tmin=(100,'K'), Tmax=(1109.02,'K')), NASAPolynomial(coeffs=[11.0253,0.0182636,-7.66834e-06,1.4245e-09,-9.8802e-14,-65337,-25.406], Tmin=(1109.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-526.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    E0 = (-298.164,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,358.983,359.062,3298.61],'cm^-1')),
        HinderedRotor(inertia=(0.117071,'amu*angstrom^2'), symmetry=1, barrier=(10.7188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217759,'amu*angstrom^2'), symmetry=1, barrier=(19.8918,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05418,0.0461252,-5.12748e-05,3.36201e-08,-9.36652e-12,-35793.7,20.2598], Tmin=(100,'K'), Tmax=(854.591,'K')), NASAPolynomial(coeffs=[6.97041,0.0231143,-1.08854e-05,2.11235e-09,-1.4931e-13,-36634,-2.68566], Tmin=(854.591,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-298.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(C=OCOJ)"""),
)
...
"""),
    E0 = (-388.763,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,194,682,905,1196,1383,3221,284.68,2953.41],'cm^-1')),
        HinderedRotor(inertia=(0.102589,'amu*angstrom^2'), symmetry=1, barrier=(5.86874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101936,'amu*angstrom^2'), symmetry=1, barrier=(5.86637,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09285,0.0462419,-5.1266e-05,2.80436e-08,-3.27383e-12,-46692.7,20.8145], Tmin=(100,'K'), Tmax=(614.884,'K')), NASAPolynomial(coeffs=[6.81492,0.0224734,-1.02371e-05,1.94128e-09,-1.3486e-13,-47404.8,-0.738645], Tmin=(614.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-388.763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=C(C)OJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C([C]F)CO(3722)'],
    products = ['O=C(CO)CF(1720)'],
    transitionState = 'TS3',
