...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[O](393)'],
    products = ['O=O(143)', 'C2H4(30)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C[O](339)'],
    products = ['[CH2]CO[O](393)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[O](335)'],
    products = ['[CH2]CO[O](393)'],
    transitionState = 'TS3',
