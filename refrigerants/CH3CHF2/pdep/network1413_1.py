...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]=CC#C(281)'],
    products = ['[CH]=CC(=[CH])F(3959)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', '[CH]=C=C=[CH](4055)'],
    products = ['[CH]=CC(=[CH])F(3959)'],
    transitionState = 'TS8',
