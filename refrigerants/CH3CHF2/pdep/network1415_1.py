...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH]C(F)=C=C(4056)'],
    products = ['[CH]=C(F)C(=C)[O](3961)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=[C]F(1074)', 'CH2CO(28)'],
    products = ['[CH]=C(F)C(=C)[O](3961)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]F(1074)', '[CH2][C]=O(136)'],
    products = ['[CH]=C(F)C(=C)[O](3961)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(T)(18)', '[CH]=C(F)[C]=O(4097)'],
    products = ['[CH]=C(F)C(=C)[O](3961)'],
