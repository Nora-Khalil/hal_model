...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)C[O](3384)'],
    products = ['CC(F)(F)COF(3356)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(126)', '[CH2]C(C)(F)F(3002)'],
    products = ['CC(F)(F)COF(3356)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OF(186)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)COF(3356)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'FOC[C](F)F(3385)'],
    products = ['CC(F)(F)COF(3356)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)(F)[CH]OF(3368)'],
    products = ['CC(F)(F)COF(3356)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)COF(3386)'],
    products = ['CC(F)(F)COF(3356)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC(F)(F)C=O(155)'],
    products = ['CC(F)(F)COF(3356)'],
