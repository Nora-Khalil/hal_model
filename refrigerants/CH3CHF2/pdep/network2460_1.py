...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C=CCF(8116)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'C=C=CC[C]F(21019)'],
    products = ['C=C=CCCF(6358)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]CC=C=C(6675)'],
    products = ['C=C=CCCF(6358)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2F(46)', 'C=[C]C=C(8399)'],
    products = ['C=C=CCCF(6358)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F-CH2(62)', '[CH]=C=C(4302)'],
    products = ['C=C=CCCF(6358)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C=C=C[CH]CF(21022)'],
    products = ['C=C=CCCF(6358)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C=C=CC[CH]F(6410)'],
    products = ['C=C=CCCF(6358)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C#CCCF(21023)'],
    products = ['C=C=CCCF(6358)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'C#C[CH]CCF(17074)'],
    products = ['C=C=CCCF(6358)'],
