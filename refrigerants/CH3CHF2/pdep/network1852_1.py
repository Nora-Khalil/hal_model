...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CC(F)(F)OF(3365)'],
    products = ['CCC(F)(F)OF(4759)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(142)', 'CC=C(F)F(4801)'],
    products = ['CCC(F)(F)OF(4759)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(126)', 'CC[C](F)F(3001)'],
    products = ['CCC(F)(F)OF(4759)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FO[C](F)F(4688)', 'C2H5(32)'],
    products = ['CCC(F)(F)OF(4759)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[CH2]C(F)(F)OF(4811)'],
    products = ['CCC(F)(F)OF(4759)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C[CH]C(F)(F)OF(4802)'],
    products = ['CCC(F)(F)OF(4759)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]CC(F)(F)OF(4809)'],
    products = ['CCC(F)(F)OF(4759)'],
