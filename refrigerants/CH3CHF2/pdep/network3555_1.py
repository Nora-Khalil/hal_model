...
"""),
    E0 = (-773.009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,286.493,286.927,287.146],'cm^-1')),
...
"""),
    E0 = (-774.757,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,259,529,569,1128,1321,1390,3140,223,363,546,575,694,1179,1410,3025,407.5,1350,352.5,304.481,304.482,304.483],'cm^-1')),
        HinderedRotor(inertia=(0.368319,'amu*angstrom^2'), symmetry=1, barrier=(24.2311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261039,'amu*angstrom^2'), symmetry=1, barrier=(17.1734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16638,'amu*angstrom^2'), symmetry=1, barrier=(10.9457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166376,'amu*angstrom^2'), symmetry=1, barrier=(10.9457,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.208162,0.098328,-0.000147155,1.08934e-07,-3.15495e-11,-93035.4,29.0002], Tmin=(100,'K'), Tmax=(849.937,'K')), NASAPolynomial(coeffs=[16.1742,0.0212291,-1.10882e-05,2.20698e-09,-1.56841e-13,-95820.2,-47.3714], Tmin=(849.937,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-774.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + radical(CCsJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.281317,'amu*angstrom^2'), symmetry=1, barrier=(6.46804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.281732,'amu*angstrom^2'), symmetry=1, barrier=(6.47757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282214,'amu*angstrom^2'), symmetry=1, barrier=(6.48865,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.234161,'amu*angstrom^2'), symmetry=1, barrier=(5.38383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.233893,'amu*angstrom^2'), symmetry=1, barrier=(5.37767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.812631,'amu*angstrom^2'), symmetry=1, barrier=(18.684,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.13563,0.101463,-0.000181664,1.62559e-07,-5.59614e-11,-61565.8,29.6648], Tmin=(100,'K'), Tmax=(832.081,'K')), NASAPolynomial(coeffs=[11.6452,0.026866,-1.48037e-05,2.92443e-09,-2.03323e-13,-62904.5,-21.2684], Tmin=(832.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-513.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.24872,'amu*angstrom^2'), symmetry=1, barrier=(5.71857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249874,'amu*angstrom^2'), symmetry=1, barrier=(5.7451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251385,'amu*angstrom^2'), symmetry=1, barrier=(5.77983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.729759,'amu*angstrom^2'), symmetry=1, barrier=(16.7786,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.375966,0.111817,-0.000218512,2.04765e-07,-7.1787e-11,-71167.3,30.3587], Tmin=(100,'K'), Tmax=(862.691,'K')), NASAPolynomial(coeffs=[10.1057,0.0294181,-1.64725e-05,3.21876e-09,-2.20126e-13,-71718,-11.3717], Tmin=(862.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-592.904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(C2CsJO) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)

species(
    label = 'O=C(F)C([CH]F)OF(10451)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.263272,0.0878025,-0.000122666,8.7346e-08,-2.4686e-11,-131354,27.7603], Tmin=(100,'K'), Tmax=(865.497,'K')), NASAPolynomial(coeffs=[14.015,0.0242476,-1.25192e-05,2.50335e-09,-1.79171e-13,-133735,-36.5973], Tmin=(865.497,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1093.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C([CH]F)OF(10393)'],
...
reaction(
    ...
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)C(F)[CH]OF(10445)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]C(OF)C(O)(F)F-2(10446)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(230)', 'OC(F)(F)[CH]OF(4939)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'OC(F)(F)C([C]F)OF(9842)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C([CH]F)C(O)(F)F(5179)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(126)', 'OC(F)(F)[CH][CH]F(4783)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)C([CH]F)OF(10449)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](F)F(4619)', 'F[CH][CH]OF(1538)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'OC(F)(F)[C]([CH]F)OF(10450)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C(F)C([CH]F)OF(10451)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(166.924,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(471.288,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'OC(F)=C([CH]F)OF(10452)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CHF(40)', 'OC(F)(F)[CH]OF(4939)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'OC(F)(F)C([C]F)OF-2(9851)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)(F)C([CH]F)OF(10393)'],
    products = ['[O]C(C(F)F)C(O)(F)F(10399)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O[C](F)C(OF)C(F)F(10454)'],
    products = ['OC(F)(F)C([CH]F)OF(10393)'],
