...
"""),
    E0 = (-253.662,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([526,555,698,907,1200,1145,1227,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.25139,'amu*angstrom^2'), symmetry=1, barrier=(28.772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25125,'amu*angstrom^2'), symmetry=1, barrier=(28.7688,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61297,0.0548125,-5.18239e-05,2.57273e-08,-5.29567e-12,-37136.4,21.1038], Tmin=(100,'K'), Tmax=(1140.63,'K')), NASAPolynomial(coeffs=[10.2962,0.0243621,-1.17799e-05,2.32276e-09,-1.65945e-13,-39117.3,-21.9302], Tmin=(1140.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFO) + radical(C=COJ) + radical(Allyl_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00596819,'amu*angstrom^2'), symmetry=1, barrier=(2.43099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133166,'amu*angstrom^2'), symmetry=1, barrier=(54.3211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.09658,'amu*angstrom^2'), symmetry=1, barrier=(25.2126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18217,0.0407799,-4.25347e-05,2.2824e-08,-4.92534e-12,-15057.8,18.3938], Tmin=(100,'K'), Tmax=(1113.52,'K')), NASAPolynomial(coeffs=[9.61054,0.0140958,-6.58933e-06,1.30349e-09,-9.37366e-14,-16712.2,-18.2426], Tmin=(1113.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sF1sCd)) + radical(Cdj(Cs-F1sF1sO2s)(Cd-HH))"""),
)

species(
    label = 'C=C1COC1(F)F(10789)',
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90909,0.0353177,3.44047e-06,-2.80914e-08,1.23041e-11,-54945.7,17.8097], Tmin=(100,'K'), Tmax=(1044.11,'K')), NASAPolynomial(coeffs=[12.3083,0.0195861,-8.59306e-06,1.70589e-09,-1.25388e-13,-58431.4,-39.1022], Tmin=(1044.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsCFFO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = '[O]C(F)(F)[C]1CC1(11387)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04911,0.034353,-9.44643e-07,-1.88362e-08,8.03446e-12,-24592.4,20.1132], Tmin=(100,'K'), Tmax=(1103.37,'K')), NASAPolynomial(coeffs=[10.449,0.0224972,-1.01078e-05,1.97522e-09,-1.41945e-13,-27578,-26.367], Tmin=(1103.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-205.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCFFO) + ring(Cs-Cs(C-FF)-Cs) + radical(O2sj(Cs-CsF1sF1s)) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2][C]1COC1(F)F(11388)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11343,0.0322142,7.09154e-06,-3.05285e-08,1.34868e-11,-30461.3,21.5844], Tmin=(100,'K'), Tmax=(993.039,'K')), NASAPolynomial(coeffs=[10.4677,0.0202819,-7.6913e-06,1.42022e-09,-1.01068e-13,-33191.4,-24.0535], Tmin=(993.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-253.903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1([CH2])OC1(F)F(11383)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789523,0.0715536,-9.63279e-05,6.63125e-08,-1.7807e-11,-18304.2,22.3895], Tmin=(100,'K'), Tmax=(918.984,'K')), NASAPolynomial(coeffs=[13.4369,0.0165042,-6.47381e-06,1.12877e-09,-7.44261e-14,-20628.8,-37.5581], Tmin=(918.984,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cs(C)-Cs(F)(F)-O2s) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
"""),
    E0 = (33.8749,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,326,540,652,719,1357,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,934.87],'cm^-1')),
        HinderedRotor(inertia=(0.00589268,'amu*angstrom^2'), symmetry=1, barrier=(44.3314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92787,'amu*angstrom^2'), symmetry=1, barrier=(44.3255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92805,'amu*angstrom^2'), symmetry=1, barrier=(44.3298,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38261,0.0610437,-6.79319e-05,4.10145e-08,-1.02027e-11,4165.57,21.6264], Tmin=(100,'K'), Tmax=(962.649,'K')), NASAPolynomial(coeffs=[9.99865,0.0252421,-1.21456e-05,2.38033e-09,-1.69404e-13,2506.74,-19.6129], Tmin=(962.649,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.8749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFO) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)C([O])(F)F(6696)'],
    products = ['CF2O(49)', 'C=C=C(6730)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(=C)C([O])(F)F(6696)'],
    products = ['[CH2]C(CF)=C([O])F(7958)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.49186e+12,'s^-1'), n=0.63878, Ea=(281.822,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='F_Ext-2R!H-R',), comment="""Estimated from node F_Ext-2R!H-R
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([CH2])=C(F)F(6937)'],
    products = ['[CH2]C(=C)C([O])(F)F(6696)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'C=[C]C([O])(F)F(4842)'],
    products = ['[CH2]C(=C)C([O])(F)F(6696)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=C)C([O])(F)F(6696)'],
    products = ['[CH2][C]1COC1(F)F(11388)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=C)C([O])(F)F(6696)'],
    products = ['[CH2]C1([CH2])OC1(F)F(11383)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.62453e+10,'s^-1'), n=0.5217, Ea=(102.877,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_O]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=C)C(=O)F(9484)'],
    products = ['[CH2]C(=C)C([O])(F)F(6696)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2O(49)', '[CH2][C]=C(6957)'],
    products = ['[CH2]C(=C)C([O])(F)F(6696)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)F(4778)', 'C=C=C(6730)'],
    products = ['[CH2]C(=C)C([O])(F)F(6696)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(6.77851,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction13',
    reactants = ['[O][C](F)F(4778)', '[CH2][C]=C(6957)'],
    products = ['[CH2]C(=C)C([O])(F)F(6696)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH2])=C(F)OF(11389)'],
    products = ['[CH2]C(=C)C([O])(F)F(6696)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(84.52,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

network(
    label = 'PDepNetwork #3752',
    isomers = [
        '[CH2]C(=C)C([O])(F)F(6696)',
    ],
    reactants = [
        ('CF2O(49)', 'C=C=C(6730)'),
    ],
