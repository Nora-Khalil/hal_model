...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17344,0.0400931,-2.59125e-05,7.4786e-09,-8.46579e-13,-37190.8,13.9119], Tmin=(100,'K'), Tmax=(1999.04,'K')), NASAPolynomial(coeffs=[14.0021,0.0164246,-8.15259e-06,1.55579e-09,-1.05873e-13,-41920,-51.3476], Tmin=(1999.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCCFO) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsCs) + longDistanceInteraction_cyclic(Cs(F)-CO) + polycyclic(s2_3_4_ane)"""),
)

species(
    label = 'O=CCC1=C(F)O1(10678)',
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.09608,0.0315309,-1.56128e-05,2.04366e-09,1.72053e-14,-8047.05,13.0495], Tmin=(100,'K'), Tmax=(2565.57,'K')), NASAPolynomial(coeffs=[38.1977,-0.00771926,-8.0197e-07,3.09543e-10,-1.98613e-14,-30125.6,-192.528], Tmin=(2565.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.5993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCFO) + group(Cds-OdCsH) + ring(oxirene)"""),
)

species(
    label = 'O=C=CC1OC1F(10679)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {7,D}
4  C u0 p0 c0 {2,S} {5,S} {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7773,0.0494973,-5.05886e-05,2.76372e-08,-6.14825e-12,-37279.7,19.5586], Tmin=(100,'K'), Tmax=(1077.98,'K')), NASAPolynomial(coeffs=[9.92636,0.0192586,-8.51113e-06,1.61442e-09,-1.13104e-13,-39036.6,-20.3677], Tmin=(1077.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsOsH) + group(CsCFHO) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + ring(Cs-Cs(F)-O2s)"""),
)

species(
    label = 'O=[C]C[CH]C(=O)F(10680)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {6,D}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-204.033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,611,648,830,1210,1753,1855,455,950,188.037,2358.59],'cm^-1')),
        HinderedRotor(inertia=(0.228946,'amu*angstrom^2'), symmetry=1, barrier=(5.82126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234338,'amu*angstrom^2'), symmetry=1, barrier=(5.79885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215207,'amu*angstrom^2'), symmetry=1, barrier=(5.80109,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
...
"""),
    E0 = (93.3613,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,326,540,652,719,1357,1855,455,950,180,180,2483.18,4000],'cm^-1')),
        HinderedRotor(inertia=(0.136479,'amu*angstrom^2'), symmetry=1, barrier=(3.13792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07796,'amu*angstrom^2'), symmetry=1, barrier=(24.7845,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77625,0.0593914,-0.000112761,1.19791e-07,-4.86072e-11,11298.5,22.3324], Tmin=(100,'K'), Tmax=(792.804,'K')), NASAPolynomial(coeffs=[2.19293,0.0337372,-1.96618e-05,4.03353e-09,-2.8873e-13,11972.6,25.0869], Tmin=(792.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.3613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCFO) + group(Cds-OdCsH) + ring(oxirene) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (-116.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,395,473,707,1436,3010,987.5,1337.5,450,1655,2120,512.5,787.5,222.716,222.716,222.716,222.716,2247.49,2247.49],'cm^-1')),
        HinderedRotor(inertia=(0.331835,'amu*angstrom^2'), symmetry=1, barrier=(11.6803,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55086,0.0591692,-9.53163e-05,8.2108e-08,-2.75329e-11,-13876.7,21.8633], Tmin=(100,'K'), Tmax=(853.856,'K')), NASAPolynomial(coeffs=[7.85171,0.0199659,-9.43053e-06,1.76526e-09,-1.19562e-13,-14599.6,-5.47152], Tmin=(853.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsOsH) + group(CsCFHO) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + ring(Cs-Cs(F)-O2s) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62239,0.0396879,-4.36041e-06,-3.19088e-08,1.73738e-11,-10751,25.0845], Tmin=(100,'K'), Tmax=(953.036,'K')), NASAPolynomial(coeffs=[16.7898,0.0070068,-1.68052e-06,3.23259e-10,-2.82132e-14,-15048.9,-54.7409], Tmin=(953.036,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.1959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cs-Cs(F)-O2s) + radical(C=COJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'O=[C][CH]C1OC1F(10685)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-18.8784,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,2782.5,750,1395,475,1775,1000,180,180,1452.32,1453.38,1453.86],'cm^-1')),
        HinderedRotor(inertia=(0.199038,'amu*angstrom^2'), symmetry=1, barrier=(4.57628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198587,'amu*angstrom^2'), symmetry=1, barrier=(4.56592,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96884,0.0501488,-7.15286e-05,6.62097e-08,-2.51255e-11,-2202.72,23.697], Tmin=(100,'K'), Tmax=(790.885,'K')), NASAPolynomial(coeffs=[4.04294,0.0299515,-1.48115e-05,2.8815e-09,-2.017e-13,-2227.21,16.0966], Tmin=(790.885,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.8784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(Cds-OdCsH) + ring(O2s-Cs(F)-Cs(C)) + radical(C2CsJO) + radical(Csj(Cs-O2sCsH)(F1s)(O2s-Cs)_ring)"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(52.6589,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(128)', '[CH2]C1O[C]1F(9528)'],
    products = ['O=[C]CC1O[C]1F(10633)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]C[CH]C(=O)F(10680)'],
    products = ['O=[C]CC1O[C]1F(10633)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C1O[C]1F(9528)'],
    products = ['O=[C]CC1O[C]1F(10633)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]CC1=C(F)O1(10681)'],
    products = ['O=[C]CC1O[C]1F(10633)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=CC1O[C]1F(10682)'],
    products = ['O=[C]CC1O[C]1F(10633)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=CC[C]1O[C]1F(10686)'],
    products = ['O=[C]CC1O[C]1F(10633)'],
