...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)C(F)CF(749)'],
    products = ['HF(38)', 'CHFO(47)', 'CH2CHF(56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH3F(39)', 'OC(F)[C]F(826)'],
    products = ['OC(F)C(F)CF(749)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'F[C]C(F)CF(827)'],
    products = ['OC(F)C(F)CF(749)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'OC(F)C(F)[C]F(828)'],
    products = ['OC(F)C(F)CF(749)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(25)', 'OC(F)C(F)F(829)'],
    products = ['OC(F)C(F)CF(749)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O[CH]C(F)CF(833)'],
    products = ['OC(F)C(F)CF(749)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)C(O)F(834)'],
    products = ['OC(F)C(F)CF(749)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'F[CH]C(F)CF(835)'],
    products = ['OC(F)C(F)CF(749)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)C(F)CF(836)'],
    products = ['OC(F)C(F)CF(749)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[CH]F(450)', 'CH2F-CHF(66)'],
    products = ['OC(F)C(F)CF(749)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(46)', 'OC(F)[CH]F(837)'],
    products = ['OC(F)C(F)CF(749)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O[C](F)C(F)CF(839)'],
    products = ['OC(F)C(F)CF(749)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(F)C(F)[CH]F(840)'],
    products = ['OC(F)C(F)CF(749)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'C=C(F)C(O)F(647)'],
    products = ['OC(F)C(F)CF(749)'],
