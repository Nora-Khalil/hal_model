...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)OOO(7097)'],
    products = ['HO2(11)', 'FC1(F)CO1(3113)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['OOO[C](F)F(4649)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)OOO(7097)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[CH]C(F)(F)OOO(7098)'],
    products = ['[CH2]C(F)(F)OOO(7097)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2][C](F)OOO(486)'],
    products = ['[CH2]C(F)(F)OOO(7097)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HO2(11)', '[CH2]C([O])(F)F(1114)'],
    products = ['[CH2]C(F)(F)OOO(7097)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', '[CH2]C(F)(F)O[O](3042)'],
    products = ['[CH2]C(F)(F)OOO(7097)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)OO[O](6994)'],
    products = ['[CH2]C(F)(F)OOO(7097)'],
    transitionState = 'TS9',
...
network(
    label = 'PDepNetwork #2769',
    isomers = [
        '[CH2]C(F)(F)OOO(7097)',
    ],
    reactants = [
        ('HO2(11)', 'FC1(F)CO1(3113)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
