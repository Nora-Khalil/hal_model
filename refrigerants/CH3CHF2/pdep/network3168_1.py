...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.889235,'amu*angstrom^2'), symmetry=1, barrier=(20.4453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.888025,'amu*angstrom^2'), symmetry=1, barrier=(20.4174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.888911,'amu*angstrom^2'), symmetry=1, barrier=(20.4378,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.702927,0.07802,-8.90923e-05,5.63875e-08,-1.48285e-11,-17130.8,23.6805], Tmin=(100,'K'), Tmax=(909.758,'K')), NASAPolynomial(coeffs=[10.7008,0.0340618,-1.6615e-05,3.27682e-09,-2.33875e-13,-18949.9,-23.6082], Tmin=(909.758,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'CC(=CF)C(=O)CF(9303)',
...
"""),
    ...
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97117,0.0555596,-6.48839e-06,-1.13367e-07,1.22738e-10,-63140.9,21.9972], Tmin=(100,'K'), Tmax=(431.672,'K')), NASAPolynomial(coeffs=[5.331,0.0421066,-2.11773e-05,4.19955e-09,-2.99135e-13,-63595.7,6.70254], Tmin=(431.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-525.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)Cs) + group(CdCFH)"""),
)

species(
    label = 'CCC(=C=CF)OF(9304)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {6,S}
...
"""),
    E0 = (-106.453,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,113,247,382,1207,3490,540,610,2055,342.399,1246.05,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00144025,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185267,'amu*angstrom^2'), symmetry=1, barrier=(15.6434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427994,'amu*angstrom^2'), symmetry=1, barrier=(35.4402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.980809,0.0704729,-7.3451e-05,4.28204e-08,-1.04549e-11,-12698,25.8219], Tmin=(100,'K'), Tmax=(972.357,'K')), NASAPolynomial(coeffs=[10.1379,0.0328031,-1.53394e-05,2.97763e-09,-2.10934e-13,-14478.7,-18.0989], Tmin=(972.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'CC1=C(OF)CC1F(9305)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (176.37,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,167,640,1190,180,609.966],'cm^-1')),
        HinderedRotor(inertia=(0.0443335,'amu*angstrom^2'), symmetry=1, barrier=(11.7052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147056,'amu*angstrom^2'), symmetry=1, barrier=(11.7056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.509093,'amu*angstrom^2'), symmetry=1, barrier=(11.705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0443331,'amu*angstrom^2'), symmetry=1, barrier=(11.7048,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.365927,0.0833428,-0.000100172,6.33781e-08,-1.61125e-11,21340.4,29.3074], Tmin=(100,'K'), Tmax=(954.83,'K')), NASAPolynomial(coeffs=[13.6123,0.0278525,-1.30013e-05,2.51708e-09,-1.77957e-13,18810.8,-33.9867], Tmin=(954.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.37,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(CJCO) + radical(Cdj(Cd-CsCs)(F1s))"""),
)
...
species(
    label = 'CC([C]F)=C(C)OF(9308)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {1,S} {6,S}
4  C u0 p0 c0 {6,S} {9,S} {10,S} {12,S}
5  C u0 p0 c0 {7,S} {11,S} {13,S} {14,S}
...
"""),
    E0 = (69.3642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,325,375,415,465,420,450,1700,1750,303.737,312.287,313.003,1570.89],'cm^-1')),
        HinderedRotor(inertia=(0.00174345,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143225,'amu*angstrom^2'), symmetry=1, barrier=(9.15812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13684,'amu*angstrom^2'), symmetry=1, barrier=(9.07117,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12771,'amu*angstrom^2'), symmetry=1, barrier=(9.07284,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.463222,0.0858104,-0.000130219,1.14771e-07,-4.07762e-11,8462.2,26.2108], Tmin=(100,'K'), Tmax=(795.542,'K')), NASAPolynomial(coeffs=[7.70293,0.0381087,-1.89702e-05,3.68861e-09,-2.57592e-13,7667.9,-4.81319], Tmin=(795.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(69.3642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.602803,'amu*angstrom^2'), symmetry=1, barrier=(13.8596,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.602675,'amu*angstrom^2'), symmetry=1, barrier=(13.8567,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.633488,0.0683651,-7.0867e-05,3.79388e-08,-7.96889e-12,-25317.3,22.2769], Tmin=(100,'K'), Tmax=(1167.35,'K')), NASAPolynomial(coeffs=[15.3032,0.0180981,-6.2751e-06,1.05045e-09,-6.87867e-14,-28742.2,-50.7655], Tmin=(1167.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-211.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCFH) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.09779,'amu*angstrom^2'), symmetry=1, barrier=(25.2402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09772,'amu*angstrom^2'), symmetry=1, barrier=(25.2387,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29445,0.0554053,-5.16241e-05,2.60778e-08,-5.3016e-12,7742.39,18.7575], Tmin=(100,'K'), Tmax=(1189.41,'K')), NASAPolynomial(coeffs=[11.7408,0.0202737,-7.31806e-06,1.2439e-09,-8.17485e-14,5257.42,-33.452], Tmin=(1189.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.5352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(Cds-CdsHH) + radical(C=CJC=C)"""),
)
...
"""),
    E0 = (45.039,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,2950,3100,1380,975,1025,1650,615,860,1140,1343,3152,1685,370,180,180,223.646],'cm^-1')),
        HinderedRotor(inertia=(0.784353,'amu*angstrom^2'), symmetry=1, barrier=(18.0338,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.992759,0.0695865,-0.000103625,8.07994e-08,-2.46963e-11,5521.96,20.9513], Tmin=(100,'K'), Tmax=(861.782,'K')), NASAPolynomial(coeffs=[11.066,0.0187761,-8.12727e-06,1.46313e-09,-9.7136e-14,3936.36,-25.2741], Tmin=(861.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFH) + radical(C=CJC=C)"""),
)
...
"""),
    E0 = (65.0292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,2950,3100,1380,975,1025,1650,167,640,1190,291.33,291.378],'cm^-1')),
        HinderedRotor(inertia=(0.181835,'amu*angstrom^2'), symmetry=1, barrier=(10.9529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277815,'amu*angstrom^2'), symmetry=1, barrier=(16.7388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181829,'amu*angstrom^2'), symmetry=1, barrier=(10.9528,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.381903,0.0841772,-0.000115928,8.56232e-08,-2.52905e-11,7947.3,24.8092], Tmin=(100,'K'), Tmax=(828.406,'K')), NASAPolynomial(coeffs=[12.2155,0.0270381,-1.24659e-05,2.36155e-09,-1.63467e-13,5986.69,-30.0533], Tmin=(828.406,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.0292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCFH) + group(Cds-CdsHH) + radical(CdCdF1s)"""),
)

species(
    label = '[CH]=C(OF)C(C)=CF(9314)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.834434,'amu*angstrom^2'), symmetry=1, barrier=(19.1853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.520095,'amu*angstrom^2'), symmetry=1, barrier=(11.958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.520124,'amu*angstrom^2'), symmetry=1, barrier=(11.9587,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.359907,0.0840012,-0.000112163,7.912e-08,-2.22346e-11,6808.6,24.6391], Tmin=(100,'K'), Tmax=(870.64,'K')), NASAPolynomial(coeffs=[13.0476,0.0257107,-1.17369e-05,2.2231e-09,-1.54309e-13,4599.29,-34.8143], Tmin=(870.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.5491,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCFH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(C)(F)C(=C)OF(9315)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {6,S}
...
"""),
    ...
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.213133,0.0904826,-0.00013558,1.14403e-07,-3.89393e-11,19930.5,27.285], Tmin=(100,'K'), Tmax=(788.765,'K')), NASAPolynomial(coeffs=[9.7701,0.0351388,-1.72523e-05,3.33598e-09,-2.3237e-13,18636.8,-15.1978], Tmin=(788.765,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (354.255,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,1394.45],'cm^-1')),
        HinderedRotor(inertia=(2.71976,'amu*angstrom^2'), symmetry=1, barrier=(62.5327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03969,'amu*angstrom^2'), symmetry=1, barrier=(23.9044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.72056,'amu*angstrom^2'), symmetry=1, barrier=(62.5511,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43008,0.0620271,-8.86241e-05,7.67101e-08,-2.70808e-11,42694.3,30.4566], Tmin=(100,'K'), Tmax=(803.033,'K')), NASAPolynomial(coeffs=[6.1668,0.0304078,-1.45717e-05,2.78813e-09,-1.93139e-13,42192.3,10.2549], Tmin=(803.033,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.255,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(OF)C(C)=[C]F(9306)'],
    products = ['C=C(OF)C(C)=CF(9277)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.437e+08,'s^-1'), n=1.045, Ea=(63.4002,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R3radExo;Y_rad;XH_Rrad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(OF)C(C)[CH]F(9307)'],
    products = ['C=C(OF)C(C)=CF(9277)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH]=C(C)C(=C)OF(9309)'],
    products = ['C=C(OF)C(C)=CF(9277)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'C=C([O])C(C)=CF(9310)'],
    products = ['C=C(OF)C(C)=CF(9277)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(126)', 'C=[C]C(C)=CF(9311)'],
    products = ['C=C(OF)C(C)=CF(9277)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(19)', 'C=C([C]=CF)OF(9312)'],
    products = ['C=C(OF)C(C)=CF(9277)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=[C]OF(202)', 'C[C]=CF(4287)'],
    products = ['C=C(OF)C(C)=CF(9277)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'C=C(OF)C(C)=[C]F(9313)'],
    products = ['C=C(OF)C(C)=CF(9277)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH]=C(OF)C(C)=CF(9314)'],
    products = ['C=C(OF)C(C)=CF(9277)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C(C)(F)C(=C)OF(9315)'],
    products = ['C=C(OF)C(C)=CF(9277)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CHF(40)', 'C=C([C]C)OF(9318)'],
    products = ['C=C(OF)C(C)=CF(9277)'],
