...
"""),
    E0 = (-532.121,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,3000,3100,440,815,1455,1000,426.098,426.233,426.409],'cm^-1')),
        HinderedRotor(inertia=(0.000927859,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0648739,'amu*angstrom^2'), symmetry=1, barrier=(8.36865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0649252,'amu*angstrom^2'), symmetry=1, barrier=(8.36964,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.752732,0.0738052,-8.3185e-05,4.93657e-08,-1.18271e-11,-63884.4,26.4059], Tmin=(100,'K'), Tmax=(1008.22,'K')), NASAPolynomial(coeffs=[12.803,0.0259974,-1.20586e-05,2.33507e-09,-1.65364e-13,-66314.3,-31.8285], Tmin=(1008.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-532.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFF) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)[CH]C(F)(F)F(3899)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-562.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,341.086,341.134],'cm^-1')),
        HinderedRotor(inertia=(0.00144793,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0014484,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0859261,'amu*angstrom^2'), symmetry=1, barrier=(7.09887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.085951,'amu*angstrom^2'), symmetry=1, barrier=(7.09874,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07413,0.0698245,-8.53316e-05,6.10493e-08,-1.83682e-11,-109213,23.2825], Tmin=(100,'K'), Tmax=(797.818,'K')), NASAPolynomial(coeffs=[8.42606,0.0329647,-1.60314e-05,3.14187e-09,-2.2281e-13,-110386,-10.5258], Tmin=(797.818,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-908.885,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs)"""),
)
...
"""),
    E0 = (-750.572,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,350,440,435,1725,2950,3100,1380,975,1025,1650,316.573,316.65,4000],'cm^-1')),
        HinderedRotor(inertia=(0.24006,'amu*angstrom^2'), symmetry=1, barrier=(17.0758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24019,'amu*angstrom^2'), symmetry=1, barrier=(17.0751,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.858751,0.0654766,-6.79608e-05,3.56798e-08,-7.38237e-12,-90156.8,25.2491], Tmin=(100,'K'), Tmax=(1177.39,'K')), NASAPolynomial(coeffs=[14.8644,0.0178943,-7.34033e-06,1.35478e-09,-9.39277e-14,-93454.8,-44.6068], Tmin=(1177.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-750.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
"""),
    E0 = (-728.196,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,219,296,586,564,718,793,1177,1228,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,384.359],'cm^-1')),
        HinderedRotor(inertia=(0.12681,'amu*angstrom^2'), symmetry=1, barrier=(13.2281,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124268,'amu*angstrom^2'), symmetry=1, barrier=(13.2374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12462,'amu*angstrom^2'), symmetry=1, barrier=(13.2268,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.412724,0.0720967,-7.64262e-05,3.67376e-08,-5.89379e-12,-87446.5,24.962], Tmin=(100,'K'), Tmax=(983.867,'K')), NASAPolynomial(coeffs=[18.322,0.0119187,-3.94073e-06,6.73256e-10,-4.6276e-14,-91582.1,-64.2562], Tmin=(983.867,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-728.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(CsCdFFF) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=C(O)CC(F)(F)F(3904)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-641.281,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,350,440,435,1725,3120,650,792.5,1650,244.304],'cm^-1')),
        HinderedRotor(inertia=(0.332477,'amu*angstrom^2'), symmetry=1, barrier=(14.0812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.332483,'amu*angstrom^2'), symmetry=1, barrier=(14.0812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.332468,'amu*angstrom^2'), symmetry=1, barrier=(14.0812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.225085,0.0752526,-8.50479e-05,4.62355e-08,-9.62995e-12,-76985.7,26.4254], Tmin=(100,'K'), Tmax=(1188.98,'K')), NASAPolynomial(coeffs=[19.3827,0.0108019,-3.73766e-06,6.44442e-10,-4.37698e-14,-81541.3,-69.3152], Tmin=(1188.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-641.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(O)CC(F)(F)F(3905)',
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.601841,0.0805267,-0.000111603,8.52763e-08,-2.6469e-11,-62781.9,26.6484], Tmin=(100,'K'), Tmax=(784.427,'K')), NASAPolynomial(coeffs=[10.5487,0.0298066,-1.4617e-05,2.85273e-09,-2.00966e-13,-64342.4,-18.9244], Tmin=(784.427,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-522.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsOsH) + group(CsCsFFF) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C([O])CC(F)(F)F(3898)'],
    products = ['C=C(O)CC(F)(F)F(3080)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(O)[CH]C(F)(F)F(3899)'],
    products = ['C=C(O)CC(F)(F)F(3080)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(O)C[C](F)F(1062)'],
    products = ['C=C(O)CC(F)(F)F(3080)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'C=[C]CC(F)(F)F(3901)'],
    products = ['C=C(O)CC(F)(F)F(3080)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C([O])CC(F)(F)F(3902)'],
    products = ['C=C(O)CC(F)(F)F(3080)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF3(45)', '[CH2]C(=C)O(1060)'],
    products = ['C=C(O)CC(F)(F)F(3080)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(F)(F)F(3044)', 'C=[C]O(137)'],
    products = ['C=C(O)CC(F)(F)F(3080)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(O)=CC(F)(F)F(3903)'],
    products = ['C=C(O)CC(F)(F)F(3080)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH]=C(O)CC(F)(F)F(3904)'],
    products = ['C=C(O)CC(F)(F)F(3080)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C(O)CC(F)(F)F(3905)'],
    products = ['C=C(O)CC(F)(F)F(3080)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C=C(O)C=C(F)F(3216)'],
    products = ['C=C(O)CC(F)(F)F(3080)'],
