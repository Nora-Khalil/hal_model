...
"""),
    E0 = (307.892,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,246,474,533,1155,2175,525,3120,650,792.5,1650,750,770,3400,2100,262.917],'cm^-1')),
        HinderedRotor(inertia=(0.410304,'amu*angstrom^2'), symmetry=1, barrier=(9.4337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117811,'amu*angstrom^2'), symmetry=1, barrier=(34.1623,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0835,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83787,0.0465199,-4.50505e-05,2.32457e-08,-4.86078e-12,37109.6,18.4738], Tmin=(100,'K'), Tmax=(1147.84,'K')), NASAPolynomial(coeffs=[10.1128,0.0176831,-7.36638e-06,1.35865e-09,-9.37443e-14,35209.9,-22.5891], Tmin=(1147.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(307.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(CdCsCdF) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83986,0.0479168,-4.35458e-05,2.14492e-08,-4.38055e-12,43999.5,21.5537], Tmin=(100,'K'), Tmax=(1154.69,'K')), NASAPolynomial(coeffs=[9.40426,0.0217128,-9.50541e-06,1.79583e-09,-1.25431e-13,42252.6,-16.0282], Tmin=(1154.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(395)', '[CH]C(=C)F(9482)'],
    products = ['[CH]=C(F)C[C]=C(10768)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]=C(F)CC#C(8112)'],
    products = ['[CH]=C(F)C[C]=C(10768)'],
