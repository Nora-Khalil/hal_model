...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)O[C](F)F(6684)'],
    products = ['CF2O(49)', 'C=C=C(6745)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)O[C](F)F(6684)'],
    products = ['[CH2]C1([CH2])OC1(F)F(7214)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2O(49)', '[CH2][C]=C(7019)'],
    products = ['[CH2]C(=C)O[C](F)F(6684)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(4846)', 'C=C=C(6745)'],
    products = ['[CH2]C(=C)O[C](F)F(6684)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C](F)F(4846)', '[CH2][C]=C(7019)'],
    products = ['[CH2]C(=C)O[C](F)F(6684)'],
...
network(
    label = 'PDepNetwork #2632',
    isomers = [
        '[CH2]C(=C)O[C](F)F(6684)',
    ],
    reactants = [
        ('CF2O(49)', 'C=C=C(6745)'),
    ],
