...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(F)O[CH]O(1865)'],
    products = ['C=C(F)OCO(1714)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(25)', 'OC[O+]=[C-]F(1869)'],
    products = ['C=C(F)OCO(1714)'],
