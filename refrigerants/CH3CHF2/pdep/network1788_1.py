...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[C](F)F(3183)'],
    products = ['[O]CC([O])(F)F(4714)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C([O])(F)F(1114)'],
    products = ['[O]CC([O])(F)F(4714)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(4846)', 'CH2O(20)'],
    products = ['[O]CC([O])(F)F(4714)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C=O(4553)'],
    products = ['[O]CC([O])(F)F(4714)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C](F)F(4846)', '[CH2][O](132)'],
    products = ['[O]CC([O])(F)F(4714)'],
