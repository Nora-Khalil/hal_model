...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C(F)[CH]F(5628)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', '[O]C(F)(F)[CH]F(4855)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]C(F)[C](F)F(5657)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)C=CF(4849)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(4846)', 'CHFCHF[Z](59)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C(F)=CF(5591)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C(F)[CH]F(5693)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2O(49)', 'F[CH][CH]F(5567)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(4846)', 'F[CH][CH]F(5567)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'O=C(F)[CH][CH]F(4264)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)[C](F)[CH]F(5075)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[O]C(F)(F)[CH]F(4855)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][CH]C(F)(F)OF(5740)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(F)C(F)[CH]F(5628)'],
    products = ['[O]C(F)(F)[CH]C(F)F(4884)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)[C](F)OF(5741)'],
    products = ['[O]C(F)(F)C(F)[CH]F(5628)'],
