...
"""),
    E0 = (-231.874,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2175,525,239,401,1367,180.002,560.406,834.37],'cm^-1')),
        HinderedRotor(inertia=(2.26678,'amu*angstrom^2'), symmetry=1, barrier=(52.1177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00576632,'amu*angstrom^2'), symmetry=1, barrier=(52.1411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0364279,'amu*angstrom^2'), symmetry=1, barrier=(52.1468,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37567,0.0394362,-2.93063e-05,1.20773e-08,-2.24677e-12,-27832.8,20.401], Tmin=(100,'K'), Tmax=(1163.65,'K')), NASAPolynomial(coeffs=[6.18275,0.0263495,-1.24369e-05,2.4126e-09,-1.70384e-13,-28718.8,1.45708], Tmin=(1163.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CtOsHH) + group(Cds-OdOsH) + group(Ct-CtCs) + group(CtCF)"""),
)
...
"""),
    E0 = (-165.003,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,2175,525,239,401,1367,491.535,491.594],'cm^-1')),
        HinderedRotor(inertia=(0.241304,'amu*angstrom^2'), symmetry=1, barrier=(41.3751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241215,'amu*angstrom^2'), symmetry=1, barrier=(41.3762,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0371,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53846,0.0310526,-2.31472e-05,7.57022e-09,-9.66626e-13,-19792.2,15.614], Tmin=(100,'K'), Tmax=(1811.33,'K')), NASAPolynomial(coeffs=[12.0617,0.0100223,-5.7315e-06,1.16033e-09,-8.19339e-14,-23242.2,-35.9875], Tmin=(1811.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.003,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-OdOsH) + group(Ct-CtOs) + group(CtCF)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72468,0.0371412,6.30461e-06,-4.75705e-08,2.51993e-11,-4045.69,16.5413], Tmin=(100,'K'), Tmax=(899.239,'K')), NASAPolynomial(coeffs=[16.7905,0.00518343,1.1329e-06,-3.81376e-10,2.6913e-14,-8172.7,-62.424], Tmin=(899.239,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.4199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(CdCFO) + ring(24dihydro13dioxin) + radical(OCJO) + radical(Cds_S)"""),
)

species(
    label = '[O]COC=C=[C]F(10920)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u1 p2 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.44723,'amu*angstrom^2'), symmetry=1, barrier=(33.2747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44652,'amu*angstrom^2'), symmetry=1, barrier=(33.2582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44472,'amu*angstrom^2'), symmetry=1, barrier=(33.2169,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39057,0.0629135,-8.80949e-05,6.97944e-08,-2.28732e-11,-16985.3,20.2273], Tmin=(100,'K'), Tmax=(738.971,'K')), NASAPolynomial(coeffs=[8.15254,0.0263117,-1.37995e-05,2.76901e-09,-1.98178e-13,-17984.7,-10.3498], Tmin=(738.971,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-141.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cd)OsHH) + group(CdCCF) + group(Cds-OdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCC#CF(10917)'],
    products = ['O=COCC#CF(10149)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=COC#CF(10918)'],
    products = ['O=COCC#CF(10149)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['FC1=[C]CO[CH]O1(10919)'],
    products = ['O=COCC#CF(10149)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C=O(166)', '[CH2]C#CF(10124)'],
    products = ['O=COCC#CF(10149)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[C]#CF(4087)', '[CH2]OC=O(798)'],
    products = ['O=COCC#CF(10149)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=COC=C=[C]F(10922)'],
    products = ['O=COCC#CF(10149)'],
