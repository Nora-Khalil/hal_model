...
"""),
    E0 = (-203.524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,395,473,707,1436,762.047,762.047,762.048,762.055,762.058,762.063,762.064,762.072,762.078,762.083,762.086,762.103],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.6401,0.0109842,6.6371e-05,-9.85552e-08,3.908e-11,-24412.2,21.3309], Tmin=(100,'K'), Tmax=(962.483,'K')), NASAPolynomial(coeffs=[15.0207,0.00728472,-2.28507e-06,5.48016e-10,-5.10173e-14,-29007.3,-49.4151], Tmin=(962.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(Cds-OdCsOs) + ring(Cyclopentane) + radical(CCJCO) + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-46.7816,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,395,473,707,1436,1855,455,950,605.437,605.453,605.743,3682.41,4000],'cm^-1')),
        HinderedRotor(inertia=(0.109509,'amu*angstrom^2'), symmetry=1, barrier=(28.519,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0371,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55131,0.0262177,-1.30503e-05,-4.88479e-09,4.38569e-12,-5569.37,22.1602], Tmin=(100,'K'), Tmax=(1000.83,'K')), NASAPolynomial(coeffs=[10.4433,0.00699758,-2.71137e-06,5.29701e-10,-3.96301e-14,-7766.18,-19.0036], Tmin=(1000.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.7816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsOsH) + group(CsCFHO) + group(Cds-OdCsH) + ring(Cs-Cs(F)-O2s) + radical(CsCsF1sO2s) + radical(CCCJ=O)"""),
)

species(
    label = 'O=C1OC2(F)OC12(5667)',
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72431,0.0122518,5.23021e-05,-7.61145e-08,2.87132e-11,-63131.7,14.29], Tmin=(100,'K'), Tmax=(1010.4,'K')), NASAPolynomial(coeffs=[12.9262,0.0116928,-5.99649e-06,1.36472e-09,-1.1024e-13,-67226.4,-45.0946], Tmin=(1010.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-525.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsOsH) + group(CsCFOO) + group(Cds-OdCsOs) + polycyclic(s2_3_4_ane)"""),
)

species(
    label = 'O=C(O)C1=C(F)O1(5662)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56105,0.073191,-0.000171291,1.84936e-07,-7.10058e-11,-26307.1,21.2089], Tmin=(100,'K'), Tmax=(867.494,'K')), NASAPolynomial(coeffs=[-0.388635,0.0337495,-1.9348e-05,3.81203e-09,-2.61573e-13,-24146.4,40.8413], Tmin=(867.494,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-Cds(Cds-O2d)O2s) + group(CdCFO) + group(Cds-O2d(Cds-Cds)O2s) + ring(oxirene)"""),
)

species(
    label = 'F[C]1OC1[C]1OO1(5689)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15762,0.0279131,1.39599e-05,-4.8469e-08,2.36439e-11,17757.5,21.7307], Tmin=(100,'K'), Tmax=(920.104,'K')), NASAPolynomial(coeffs=[15.3878,0.00318411,8.23652e-07,-2.23008e-10,1.23355e-14,13935,-48.5372], Tmin=(920.104,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(O2s-Cs(F)-Cs(C)) + ring(dioxirane) + radical(Cs_P) + radical(Csj(Cs-O2sCsH)(F1s)(O2s-Cs)_ring)"""),
)

species(
    label = '[O][C]1OC2(F)OC12(5690)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.68847,0.0338471,-2.24579e-05,6.03935e-09,-6.14064e-13,-12649.7,14.7178], Tmin=(100,'K'), Tmax=(2255.47,'K')), NASAPolynomial(coeffs=[16.1989,0.00988684,-6.52315e-06,1.32938e-09,-9.20031e-14,-18744.1,-61.4507], Tmin=(2255.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFOO) + group(Cs-CsOsOsH) + polycyclic(s2_3_4_ane) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[O]C([O])=CC(=O)F(5691)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u1 p2 c0 {7,S}
3 O u1 p2 c0 {7,S}
...
"""),
    E0 = (6.40141,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,180,180,180,180,2130.89,2132.28,2132.31,2132.31,2133.84],'cm^-1')),
        HinderedRotor(inertia=(0.290728,'amu*angstrom^2'), symmetry=1, barrier=(6.68441,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.029,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90508,0.0706748,-0.000184476,2.11327e-07,-8.37481e-11,821.77,20.1404], Tmin=(100,'K'), Tmax=(868.243,'K')), NASAPolynomial(coeffs=[-5.05769,0.0401277,-2.351e-05,4.65796e-09,-3.20253e-13,4391.31,66.3414], Tmin=(868.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.40141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-Cds(Cds-O2d)O2s) + group(CdCFO) + group(Cds-O2d(Cds-Cds)O2s) + ring(oxirene) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C1O[C]1F(5664)'],
    products = ['CO2(14)', 'FC1=CO1(4047)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(=O)C1O[C]1F(5664)'],
    products = ['[O]C(=O)C1(F)[CH]O1(5663)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C1[CH][C](F)OO1(5687)'],
    products = ['[O]C(=O)C1O[C]1F(5664)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C1O[C]1F(5688)'],
    products = ['[O]C(=O)C1O[C]1F(5664)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(O)[C]1O[C]1F(5693)'],
    products = ['[O]C(=O)C1O[C]1F(5664)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C]=O(293)', 'FC1=CO1(4047)'],
    products = ['[O]C(=O)C1O[C]1F(5664)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C1=C(F)O1(5694)'],
    products = ['[O]C(=O)C1O[C]1F(5664)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CO2(14)', 'F[C]1[CH]O1(5679)'],
    products = ['[O]C(=O)C1O[C]1F(5664)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O][C]=O(293)', 'F[C]1[CH]O1(5679)'],
    products = ['[O]C(=O)C1O[C]1F(5664)'],
