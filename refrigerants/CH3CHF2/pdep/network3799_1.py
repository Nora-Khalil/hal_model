...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70999,0.0562504,-8.73314e-05,7.83465e-08,-2.77835e-11,-35880.7,22.0707], Tmin=(100,'K'), Tmax=(831.51,'K')), NASAPolynomial(coeffs=[5.78638,0.0256631,-1.23504e-05,2.35291e-09,-1.61818e-13,-36179.1,5.43863], Tmin=(831.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-298.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CdCddCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=[C]C(F)[C]1OO1(10692)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13954,0.0446658,-4.15879e-05,2.16939e-08,-4.89865e-12,33157.6,23.7471], Tmin=(100,'K'), Tmax=(1021.49,'K')), NASAPolynomial(coeffs=[7.28804,0.024505,-1.19827e-05,2.37228e-09,-1.69833e-13,32105.8,-1.2009], Tmin=(1021.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(275.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(O2s-O2s-Cs(C-F)) + radical(Cs_P) + radical(Cdj(Cs-F1sCsH)(Cd-HH))"""),
)

species(
    label = '[CH2][C]1OC(=O)C1F(10675)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {6,D}
...
"""),
    E0 = (-108.78,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,297.31,297.315,297.33,297.336,297.339,1746.17],'cm^-1')),
        HinderedRotor(inertia=(0.514723,'amu*angstrom^2'), symmetry=1, barrier=(32.2905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0294962,'amu*angstrom^2'), symmetry=1, barrier=(32.2906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.90701,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0929,0.0501439,-4.12937e-05,-1.84079e-08,4.09557e-11,-13022.9,21.3535], Tmin=(100,'K'), Tmax=(483.869,'K')), NASAPolynomial(coeffs=[6.45313,0.0277731,-1.43331e-05,2.84949e-09,-2.02473e-13,-13604.9,1.82912], Tmin=(483.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-73.262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,180,180,180,180,1376.53,1378.81],'cm^-1')),
        HinderedRotor(inertia=(0.317485,'amu*angstrom^2'), symmetry=1, barrier=(7.29962,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04097,0.0538985,-0.000101139,1.05607e-07,-4.09216e-11,-8751.29,21.0484], Tmin=(100,'K'), Tmax=(850.487,'K')), NASAPolynomial(coeffs=[1.16074,0.0319643,-1.64667e-05,3.1878e-09,-2.19568e-13,-7658.56,30.6963], Tmin=(850.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CdCddCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-160.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,750,770,3400,2100,433.945,434.275,434.322,434.395,434.471,434.546],'cm^-1')),
        HinderedRotor(inertia=(0.388044,'amu*angstrom^2'), symmetry=1, barrier=(52.1768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391224,'amu*angstrom^2'), symmetry=1, barrier=(52.1712,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82498,0.0542049,-8.4453e-05,7.86355e-08,-2.90826e-11,-19197,18.8213], Tmin=(100,'K'), Tmax=(816.978,'K')), NASAPolynomial(coeffs=[4.59866,0.0282648,-1.41326e-05,2.73481e-09,-1.89936e-13,-19237.7,8.52503], Tmin=(816.978,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-160.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCOJ)"""),
)

species(
    label = 'C=CC(F)=C([O])[O](10697)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u1 p2 c0 {7,S}
3  O u1 p2 c0 {7,S}
...
"""),
    E0 = (-79.0666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,180,180,821.634,1069.12,1069.26],'cm^-1')),
        HinderedRotor(inertia=(2.12125,'amu*angstrom^2'), symmetry=1, barrier=(48.7718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.122,'amu*angstrom^2'), symmetry=1, barrier=(48.7889,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82779,0.0543073,-8.07296e-05,7.84619e-08,-3.13128e-11,-9437.67,21.5945], Tmin=(100,'K'), Tmax=(764.507,'K')), NASAPolynomial(coeffs=[3.46058,0.034022,-1.78899e-05,3.57381e-09,-2.54085e-13,-9344.17,16.3999], Tmin=(764.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.0666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C(F)C(=O)O(10699)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-66.93,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,1685,370,3120,650,792.5,1650,259.546,259.546,259.552,259.559,2201.04],'cm^-1')),
        HinderedRotor(inertia=(0.709869,'amu*angstrom^2'), symmetry=1, barrier=(33.9419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.709377,'amu*angstrom^2'), symmetry=1, barrier=(33.9412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.710442,'amu*angstrom^2'), symmetry=1, barrier=(33.944,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94702,0.0535119,-5.08033e-05,-5.41233e-09,3.2826e-11,-7984.35,21.5838], Tmin=(100,'K'), Tmax=(497.609,'K')), NASAPolynomial(coeffs=[7.01342,0.0270362,-1.39511e-05,2.76546e-09,-1.95878e-13,-8664.99,-1.0954], Tmin=(497.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=C(F)[CH]C([O])=O(10700)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u1 p2 c0 {7,S}
3  O u0 p2 c0 {7,D}
...
reaction(
    label = 'reaction3',
    reactants = ['C=[C][CH]C(=O)OF(10691)'],
    products = ['C=[C]C(F)C([O])=O(10140)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)[C]=O(10460)'],
    products = ['C=[C]C(F)C([O])=O(10140)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['C=[C]C(F)C([O])=O(10140)'],
    products = ['[CH2][C]1OC(=O)C1F(10675)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C=C=CC([O])=O(6634)'],
    products = ['C=[C]C(F)C([O])=O(10140)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C=C(F)C([O])=O(10695)'],
    products = ['C=[C]C(F)C([O])=O(10140)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C#CC(F)C([O])=O(10696)'],
    products = ['C=[C]C(F)C([O])=O(10140)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=[C]C(F)C(=O)O(10699)'],
    products = ['C=[C]C(F)C([O])=O(10140)'],
