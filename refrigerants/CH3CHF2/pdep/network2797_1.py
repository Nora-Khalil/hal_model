...
"""),
    E0 = (119.822,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,1855,455,950,3120,650,792.5,1650],'cm^-1')),
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[C]=C(O)C(=O)OF(7738)'],
    products = ['[CH]=C(O)C(=O)OF(2422)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH]=C(O)C([O])=O(1505)'],
    products = ['[CH]=C(O)C(=O)OF(2422)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', '[CH]=C=C([O])OF(4282)'],
    products = ['[CH]=C(O)C(=O)OF(2422)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]C(=O)C(=O)OF(7741)'],
    products = ['[CH]=C(O)C(=O)OF(2422)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(126)', '[CH]=C(O)[C]=O(7742)'],
    products = ['[CH]=C(O)C(=O)OF(2422)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OF(167)', '[CH]=[C]O(1068)'],
    products = ['[CH]=C(O)C(=O)OF(2422)'],
