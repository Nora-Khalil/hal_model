...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.217482,'amu*angstrom^2'), symmetry=1, barrier=(5.00033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214012,'amu*angstrom^2'), symmetry=1, barrier=(4.92056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.884216,'amu*angstrom^2'), symmetry=1, barrier=(20.3299,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64522,0.0578919,-5.5773e-05,3.26423e-08,-8.65241e-12,2101.21,25.3945], Tmin=(100,'K'), Tmax=(864.188,'K')), NASAPolynomial(coeffs=[6.3246,0.0362327,-1.81779e-05,3.63984e-09,-2.62236e-13,1292.45,3.50228], Tmin=(864.188,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.8088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-F1sCdH)(H)(H)) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)
...
"""),
    E0 = (14.9914,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,122,584,932,1043,1247,1392,1461,2986,3039,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,1685,370,259.427,259.735],'cm^-1')),
        HinderedRotor(inertia=(0.0880885,'amu*angstrom^2'), symmetry=1, barrier=(4.20619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391892,'amu*angstrom^2'), symmetry=1, barrier=(18.7241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0130244,'amu*angstrom^2'), symmetry=1, barrier=(18.7235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74999,0.0524537,-3.86998e-05,1.47021e-08,-2.37469e-12,1881.13,25.7381], Tmin=(100,'K'), Tmax=(1373.03,'K')), NASAPolynomial(coeffs=[9.51494,0.0298326,-1.39871e-05,2.70311e-09,-1.89951e-13,-251.2,-14.185], Tmin=(1373.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.9914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-CdHH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6861,0.0418109,-7.03752e-06,-1.54307e-08,7.11538e-12,-33400.6,20.3897], Tmin=(100,'K'), Tmax=(1120.6,'K')), NASAPolynomial(coeffs=[11.2302,0.0264974,-1.16435e-05,2.24442e-09,-1.59745e-13,-36717.2,-31.9957], Tmin=(1120.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCCFH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cs(F)-Cs-Cd-Cd)"""),
)

species(
    label = 'C=C(F)C=CCF(11878)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29169,0.0552668,-4.12759e-05,1.52161e-08,-2.26506e-12,-37507.9,21.7473], Tmin=(100,'K'), Tmax=(1560.02,'K')), NASAPolynomial(coeffs=[13.9333,0.0228529,-1.01093e-05,1.89726e-09,-1.30667e-13,-41452.1,-44.8631], Tmin=(1560.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-312.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00423057,'amu*angstrom^2'), symmetry=1, barrier=(9.3787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.73877,'amu*angstrom^2'), symmetry=1, barrier=(62.9696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.73585,'amu*angstrom^2'), symmetry=1, barrier=(62.9025,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54736,0.0582684,-6.3182e-05,3.7347e-08,-7.37898e-12,-6806.28,22.6014], Tmin=(100,'K'), Tmax=(659.49,'K')), NASAPolynomial(coeffs=[7.47787,0.0292216,-1.28626e-05,2.39864e-09,-1.65195e-13,-7739.06,-4.68254], Tmin=(659.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.2923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Csj(Cs-F1sCtH)(H)(H))"""),
)
...
"""),
    E0 = (-45.5904,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,122,584,932,1043,1247,1392,1461,2986,3039,346,659,817,1284,3010,987.5,1337.5,450,1655,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.191124,'amu*angstrom^2'), symmetry=1, barrier=(4.39432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.456799,'amu*angstrom^2'), symmetry=1, barrier=(10.5027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.595024,'amu*angstrom^2'), symmetry=1, barrier=(26.3822,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8514,0.0503984,-3.43921e-05,1.17264e-08,-1.68682e-12,-5409.26,23.7814], Tmin=(100,'K'), Tmax=(1511.08,'K')), NASAPolynomial(coeffs=[9.68678,0.0296574,-1.38034e-05,2.643e-09,-1.84037e-13,-7777.25,-17.2545], Tmin=(1511.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.5904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-HHH)(F1s)(Cd-CdH)) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.215446,'amu*angstrom^2'), symmetry=1, barrier=(4.95352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217107,'amu*angstrom^2'), symmetry=1, barrier=(4.99172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.672053,'amu*angstrom^2'), symmetry=1, barrier=(15.4518,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15414,0.0689856,-9.61938e-05,8.48167e-08,-3.14067e-11,2081.76,25.6825], Tmin=(100,'K'), Tmax=(747.444,'K')), NASAPolynomial(coeffs=[5.86942,0.0370542,-1.86725e-05,3.68549e-09,-2.60938e-13,1563.96,5.55799], Tmin=(747.444,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.5077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-F1sCdH)(H)(H)) + radical(Cds_S)"""),
)

species(
    label = 'CC(F)[C]=[C]CF(11885)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {1,S} {4,S} {6,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.200273,'amu*angstrom^2'), symmetry=1, barrier=(7.52932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202655,'amu*angstrom^2'), symmetry=1, barrier=(7.52943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204607,'amu*angstrom^2'), symmetry=1, barrier=(7.53272,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39034,0.0631418,-8.11094e-05,7.02021e-08,-2.64716e-11,5838.29,24.9813], Tmin=(100,'K'), Tmax=(717.064,'K')), NASAPolynomial(coeffs=[5.10058,0.0379579,-1.90421e-05,3.77061e-09,-2.68239e-13,5421.54,9.11989], Tmin=(717.064,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.8063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = '[CH2]C(F)=C[CH]CF(11886)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16347,0.0582512,-4.60857e-05,1.8465e-08,-3.00241e-12,-19479.4,22.5678], Tmin=(100,'K'), Tmax=(1440.51,'K')), NASAPolynomial(coeffs=[13.5172,0.0239471,-1.03644e-05,1.93308e-09,-1.33261e-13,-23038.5,-41.5407], Tmin=(1440.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCsCdF) + radical(Allyl_S) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C=[C]CF(11812)'],
    products = ['CH2CHF(56)', 'C#CCF(3587)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]C=[C]CF(11877)'],
    products = ['[CH2]C(F)C=[C]CF(11812)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=CC=[C]CF(11879)'],
    products = ['[CH2]C(F)C=[C]CF(11812)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CHF(56)', '[CH]=[C]CF(4166)'],
    products = ['[CH2]C(F)C=[C]CF(11812)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(F)C=[C]CF(11880)'],
    products = ['[CH2]C(F)C=[C]CF(11812)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH]F(233)', 'C#CCF(3587)'],
    products = ['[CH2]C(F)C=[C]CF(11812)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(F)C#CCF(11881)'],
    products = ['[CH2]C(F)C=[C]CF(11812)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]F(233)', '[CH]=[C]CF(4166)'],
    products = ['[CH2]C(F)C=[C]CF(11812)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2][CH]C#CCF(11882)'],
    products = ['[CH2]C(F)C=[C]CF(11812)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)C=[C]CF(11812)'],
    products = ['[CH2]C(F)=C[CH]CF(11886)'],
...
network(
    label = 'PDepNetwork #3987',
    isomers = [
        '[CH2]C(F)C=[C]CF(11812)',
    ],
    reactants = [
        ('CH2CHF(56)', 'C#CCF(3587)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
