...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.098127,'amu*angstrom^2'), symmetry=1, barrier=(2.25613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13964,'amu*angstrom^2'), symmetry=1, barrier=(52.6657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', '[CH]C=CF(270)'],
    products = ['[CH]=CC(F)[CH]F(6248)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[CH](264)', 'CHFCHF[Z](59)'],
    products = ['[CH]=CC(F)[CH]F(6248)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H2(23)', 'F[CH][CH]F(5595)'],
    products = ['[CH]=CC(F)[CH]F(6248)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#CC(F)[CH]F(6261)'],
    products = ['[CH]=CC(F)[CH]F(6248)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](264)', 'F[CH][CH]F(5595)'],
    products = ['[CH]=CC(F)[CH]F(6248)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH]=C=C[CH]F(4007)'],
    products = ['[CH]=CC(F)[CH]F(6248)'],
