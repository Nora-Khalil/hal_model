...
"""),
    E0 = (-158.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,334,575,1197,1424,3202,244.909,245.515,1166.57],'cm^-1')),
        HinderedRotor(inertia=(0.153367,'amu*angstrom^2'), symmetry=1, barrier=(6.51293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152165,'amu*angstrom^2'), symmetry=1, barrier=(6.51415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.771365,'amu*angstrom^2'), symmetry=1, barrier=(32.8689,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-96.7871,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,2120,512.5,787.5,180.08,1572.97],'cm^-1')),
        HinderedRotor(inertia=(0.975319,'amu*angstrom^2'), symmetry=1, barrier=(22.442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.561777,'amu*angstrom^2'), symmetry=1, barrier=(12.9746,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1862,0.0421267,-3.68326e-05,1.76751e-08,-3.6183e-12,-11577.4,19.5401], Tmin=(100,'K'), Tmax=(1126.84,'K')), NASAPolynomial(coeffs=[7.79125,0.0222303,-1.03473e-05,2.00584e-09,-1.41928e-13,-12840.6,-8.17034], Tmin=(1126.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.7871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(CsCsFHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-CdHH)(F1s)(H))"""),
)

species(
    label = 'C=C(OF)OC[CH]F(9832)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0351145,0.0931943,-0.00013912,1.08934e-07,-3.38789e-11,-21484.5,27.0833], Tmin=(100,'K'), Tmax=(789.288,'K')), NASAPolynomial(coeffs=[13.1086,0.026932,-1.31771e-05,2.54525e-09,-1.77384e-13,-23548,-32.8939], Tmin=(789.288,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5279,0.0595393,-6.05808e-05,3.587e-08,-9.22516e-12,10901.1,23.0114], Tmin=(100,'K'), Tmax=(908.457,'K')), NASAPolynomial(coeffs=[7.6573,0.0325517,-1.60211e-05,3.17082e-09,-2.26817e-13,9787.42,-5.97112], Tmin=(908.457,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.9331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00331816,'amu*angstrom^2'), symmetry=1, barrier=(10.7001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426932,'amu*angstrom^2'), symmetry=1, barrier=(39.408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0122188,'amu*angstrom^2'), symmetry=1, barrier=(39.4052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426402,'amu*angstrom^2'), symmetry=1, barrier=(39.4081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40286,0.0668385,-6.66443e-05,9.14278e-09,2.5076e-11,-21149.4,23.0991], Tmin=(100,'K'), Tmax=(512.237,'K')), NASAPolynomial(coeffs=[7.37273,0.0352804,-1.83321e-05,3.66131e-09,-2.61207e-13,-21958.6,-3.63703], Tmin=(512.237,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CsCCl_triplet)"""),
)

species(
    label = 'FO[C]1CCC(F)O1(9835)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40703,0.043222,1.24236e-05,-5.33246e-08,2.58747e-11,-34141.2,21.0125], Tmin=(100,'K'), Tmax=(923.492,'K')), NASAPolynomial(coeffs=[15.4178,0.0181248,-4.61738e-06,7.06983e-10,-4.90294e-14,-38246.5,-53.6826], Tmin=(923.492,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(Tetrahydrofuran) + radical(Cs_P)"""),
)
...
"""),
    E0 = (-219.749,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,350,440,435,1725,334,575,1197,1424,3202,301.956,301.962,301.981],'cm^-1')),
        HinderedRotor(inertia=(0.00184852,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202001,'amu*angstrom^2'), symmetry=1, barrier=(13.0787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.317382,'amu*angstrom^2'), symmetry=1, barrier=(20.5402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202165,'amu*angstrom^2'), symmetry=1, barrier=(13.0787,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.354316,0.0842027,-0.000112048,7.77683e-08,-2.14633e-11,-26301.9,27.4999], Tmin=(100,'K'), Tmax=(886.28,'K')), NASAPolynomial(coeffs=[13.5002,0.0248716,-1.1631e-05,2.23361e-09,-1.56484e-13,-28632.1,-34.3344], Tmin=(886.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(Csj(Cs-CdHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53248,0.0635412,-9.87687e-05,9.92817e-08,-3.94476e-11,-31649.7,24.0423], Tmin=(100,'K'), Tmax=(806.513,'K')), NASAPolynomial(coeffs=[1.70236,0.0423703,-2.15859e-05,4.23004e-09,-2.96371e-13,-31016,27.358], Tmin=(806.513,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18475,0.0699491,-0.000100416,9.55626e-08,-3.75321e-11,-81381.9,24.9371], Tmin=(100,'K'), Tmax=(772.429,'K')), NASAPolynomial(coeffs=[3.43019,0.0440756,-2.25083e-05,4.44583e-09,-3.14182e-13,-81303.8,17.4349], Tmin=(772.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-677.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'F[CH]CCOF(515)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(142)', 'O=C=CC[CH]F(364)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]CCC(=O)OF(9833)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]F(230)', '[CH2]CC(=O)OF(1446)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(CC[C]F)OF-2(9834)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C(CC=CF)OF(8652)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)CC[CH]F(9837)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(126)', 'O=[C]CC[CH]F(216)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C([CH]C[CH]F)OF(8834)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O=C(C[CH][CH]F)OF(9838)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHF(40)', '[CH2]CC(=O)OF(1446)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(CC[C]F)OF(8848)'],
    products = ['O=C(CC[CH]F)OF(9695)'],
