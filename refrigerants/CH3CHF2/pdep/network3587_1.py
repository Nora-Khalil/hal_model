...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32404,0.0282736,2.16479e-06,-2.05923e-08,8.58452e-12,-40373,11.3376], Tmin=(100,'K'), Tmax=(1099.55,'K')), NASAPolynomial(coeffs=[10.9273,0.0163757,-8.06874e-06,1.65819e-09,-1.22744e-13,-43437.7,-36.317], Tmin=(1099.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-336.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCFOO) + group(Cs-CsOsHH) + polycyclic(s2_3_4_ane)"""),
)

species(
    label = 'OCC1=C(F)O1(10659)',
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95085,0.0588977,-0.000122191,1.30396e-07,-5.04153e-11,-14429,20.1492], Tmin=(100,'K'), Tmax=(861.376,'K')), NASAPolynomial(coeffs=[0.256708,0.0327244,-1.73347e-05,3.36375e-09,-2.30712e-13,-12874.3,35.4001], Tmin=(861.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(CdCFO) + ring(oxirene)"""),
)

species(
    label = 'O=CC1OC1F(1663)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {4,S} {5,S}
3 O u0 p2 c0 {6,D}
4 C u0 p0 c0 {2,S} {5,S} {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69333,0.0154973,3.96562e-05,-6.37671e-08,2.54017e-11,-48205.9,19.3359], Tmin=(100,'K'), Tmax=(975.105,'K')), NASAPolynomial(coeffs=[11.8747,0.0108632,-4.02315e-06,8.32713e-10,-6.65068e-14,-51566.7,-32.7789], Tmin=(975.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-401.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsOsH) + group(CsCFHO) + group(Cds-OdCsH) + ring(Cs-Cs(F)-O2s)"""),
)

species(
    label = '[O]C[CH]C(=O)F(10660)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u1 p2 c0 {4,S}
3 O u0 p2 c0 {6,D}
...
"""),
    E0 = (105.232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,326,540,652,719,1357,180,180,2532.02,2536.42,2542.36],'cm^-1')),
        HinderedRotor(inertia=(0.132537,'amu*angstrom^2'), symmetry=1, barrier=(3.04729,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29374,0.0563959,-0.000135431,1.56862e-07,-6.31918e-11,12699.8,19.7779], Tmin=(100,'K'), Tmax=(864.009,'K')), NASAPolynomial(coeffs=[-4.40853,0.0390958,-2.14927e-05,4.20872e-09,-2.89312e-13,15661.9,61.572], Tmin=(864.009,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(CdCFO) + ring(oxirene) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-71.9331,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,1000,395,473,707,1436,3025,407.5,1350,352.5,180,180,1053.09,1053.09,1053.09,1053.11],'cm^-1')),
        HinderedRotor(inertia=(0.125641,'amu*angstrom^2'), symmetry=1, barrier=(2.88873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125613,'amu*angstrom^2'), symmetry=1, barrier=(2.88809,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05273,0.0440214,-4.73845e-05,2.75408e-08,-6.52411e-12,-8582.4,20.265], Tmin=(100,'K'), Tmax=(1015.52,'K')), NASAPolynomial(coeffs=[8.88231,0.0171199,-7.6478e-06,1.45382e-09,-1.0187e-13,-9969.48,-12.7887], Tmin=(1015.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.9331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(Cs-CsOsHH) + ring(O2s-Cs(F)-Cs(C)) + radical(Csj(Cs-O2sCsH)(F1s)(O2s-Cs)_ring) + radical(CCsJOH)"""),
)

species(
    label = '[O][CH]C1OC1F(10665)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {4,S} {5,S}
3 O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35475,0.0402644,-5.19863e-05,4.74142e-08,-1.846e-11,-8282.36,19.2503], Tmin=(100,'K'), Tmax=(763.927,'K')), NASAPolynomial(coeffs=[3.66459,0.026972,-1.32529e-05,2.58725e-09,-1.82115e-13,-8294.75,14.5126], Tmin=(763.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.3232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(Cs-CsOsHH) + ring(O2s-Cs(F)-Cs(C)) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'OC[C]1O[C]1F(10666)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {4,S} {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC1O[C]1F(10623)'],
    products = ['CH2O(20)', 'FC1=CO1(4047)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C1O[C]1F(9528)'],
    products = ['[O]CC1O[C]1F(10623)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](132)', 'FC1=CO1(4047)'],
    products = ['[O]CC1O[C]1F(10623)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]CC1=C(F)O1(10661)'],
    products = ['[O]CC1O[C]1F(10623)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2O(20)', 'F[C]1[CH]O1(5679)'],
    products = ['[O]CC1O[C]1F(10623)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CC1O[C]1F(10662)'],
    products = ['[O]CC1O[C]1F(10623)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](132)', 'F[C]1[CH]O1(5679)'],
    products = ['[O]CC1O[C]1F(10623)'],
