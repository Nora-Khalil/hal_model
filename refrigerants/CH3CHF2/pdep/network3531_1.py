species(
    label = '[CH2]C(F)(F)C1O[C]1F(10246)',
...
"""),
    E0 = (-348.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,215,315,519,588,595,1205,1248,395,473,707,1436,3000,3100,440,815,1455,1000,180,437.128,1019.99,1148.38,2400.95,2409.82],'cm^-1')),
        HinderedRotor(inertia=(1.30379,'amu*angstrom^2'), symmetry=1, barrier=(29.9766,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C1(F)O[C](F)C1F(10362)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-325.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,190,488,555,1236,1407,358.961,358.971,358.999,359.009,359.011,1359.25,2069.7],'cm^-1')),
        HinderedRotor(inertia=(0.0143883,'amu*angstrom^2'), symmetry=1, barrier=(43.7386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0013082,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6818,0.0556778,-5.71584e-05,3.30251e-08,-8.15733e-12,-39127.2,24.6861], Tmin=(100,'K'), Tmax=(949.451,'K')), NASAPolynomial(coeffs=[8.14631,0.0284427,-1.41303e-05,2.81206e-09,-2.01841e-13,-40354.7,-6.16597], Tmin=(949.451,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-325.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + ring(O2s-Cs(F)-Cs(C)) + radical(Csj(Cs-O2sCsH)(F1s)(O2s-Cs)_ring) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05351,0.0551824,-4.2884e-05,1.50853e-08,-2.05568e-12,-78947.2,16.2846], Tmin=(100,'K'), Tmax=(1751.58,'K')), NASAPolynomial(coeffs=[19.5205,0.0130099,-6.7685e-06,1.3394e-09,-9.37353e-14,-85416.5,-83.159], Tmin=(1751.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-657.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCsCsFF) + polycyclic(s2_3_4_ane)"""),
)

species(
    label = 'CC(F)(F)C1=C(F)O1(10363)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30331,0.0683681,-0.000114247,1.11009e-07,-4.24e-11,-48056.6,22.0367], Tmin=(100,'K'), Tmax=(801.558,'K')), NASAPolynomial(coeffs=[4.37682,0.0351637,-1.8675e-05,3.71139e-09,-2.61598e-13,-47975.3,11.469], Tmin=(801.558,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-400.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(CdCFO) + ring(Cd(C-FF)-Cd-O2s)"""),
)

species(
    label = '[CH2]C(F)(F)[CH]C(=O)F(10364)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[CH2]C(F)(F)C1=C(F)O1(10365)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-188.916,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,326,540,652,719,1357,3000,3100,440,815,1455,1000,180,2623.7,2625.91],'cm^-1')),
        HinderedRotor(inertia=(0.170317,'amu*angstrom^2'), symmetry=1, barrier=(3.91591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170686,'amu*angstrom^2'), symmetry=1, barrier=(3.92442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16631,0.0741283,-0.000138829,1.38246e-07,-5.22629e-11,-22630.8,23.8261], Tmin=(100,'K'), Tmax=(827.786,'K')), NASAPolynomial(coeffs=[4.24241,0.0334814,-1.84543e-05,3.67432e-09,-2.5744e-13,-22256.7,14.9027], Tmin=(827.786,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(CdCFO) + ring(Cd(C-FF)-Cd-O2s) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)
...
"""),
    E0 = (-231.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,323,467,575,827,1418,395,473,707,1436,2950,3100,1380,975,1025,1650,180,627.094,696.853,705.806,3252.79,4000],'cm^-1')),
        HinderedRotor(inertia=(1.1909,'amu*angstrom^2'), symmetry=1, barrier=(27.3812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70548,0.0455318,-3.89627e-05,1.65103e-08,-2.77781e-12,-27740.1,23.6203], Tmin=(100,'K'), Tmax=(1422.12,'K')), NASAPolynomial(coeffs=[12.7349,0.0145094,-6.24153e-06,1.17122e-09,-8.1297e-14,-30877.1,-33.4743], Tmin=(1422.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(CsCFHO) + group(CdCsCdF) + group(Cds-CdsHH) + ring(Cs-Cs(F)-O2s) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66118,0.0605283,-5.95406e-05,9.29584e-10,3.05143e-11,-45667.3,22.536], Tmin=(100,'K'), Tmax=(506.941,'K')), NASAPolynomial(coeffs=[7.47565,0.0301224,-1.53553e-05,3.03115e-09,-2.14272e-13,-46455.6,-3.52626], Tmin=(506.941,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-380.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCFHO) + group(Cs-CsHHH) + ring(O2s-Cs(F)-Cs(C)) + radical(C2CsJO) + radical(Csj(Cs-O2sCsH)(F1s)(O2s-Cs)_ring)"""),
)

species(
    label = '[CH2][C](F)C1OC1(F)F(10368)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43143,0.0611309,-7.48757e-05,5.2636e-08,-1.54479e-11,-44563.9,26.1386], Tmin=(100,'K'), Tmax=(819.096,'K')), NASAPolynomial(coeffs=[8.30151,0.027582,-1.34395e-05,2.63376e-09,-1.86781e-13,-45689.3,-5.63471], Tmin=(819.096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(CsCFFO) + group(Cs-CsHHH) + ring(Cs(C)-Cs(F)(F)-O2s) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'FC[C](F)C1O[C]1F(10369)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    products = ['FC1=CO1(4047)', 'CH2CF2(57)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    products = ['[CH2]C1(F)O[C](F)C1F(10362)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(10245)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)CC1O[C]1F(10248)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C1O[C]1F(5712)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    products = ['FC1(F)CC2(F)OC12(10302)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    products = ['CC(F)(F)C1=C(F)O1(10363)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)[CH]C(=O)F(10364)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FC1=CO1(4047)', '[CH2][C](F)F(2970)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C1=C(F)O1(10365)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C1O[C]1F(9547)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]1[CH]O1(5679)', 'CH2CF2(57)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]1[CH]O1(5679)', '[CH2][C](F)F(2970)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C=C(F)[C]1O[C]1F(10366)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    products = ['[CH2]C(F)(F)[C]1OC1F(10322)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    products = ['CC(F)(F)[C]1O[C]1F(10367)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
    products = ['[CH2][C](F)C1OC1(F)F(10368)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FC[C](F)C1O[C]1F(10369)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(10246)'],
...
network(
    label = 'PDepNetwork #3531',
    isomers = [
        '[CH2]C(F)(F)C1O[C]1F(10246)',
    ],
    reactants = [
        ('FC1=CO1(4047)', 'CH2CF2(57)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
