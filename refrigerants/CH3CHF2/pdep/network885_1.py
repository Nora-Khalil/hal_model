...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(=O)OC=O(2684)'],
    products = ['C=C(OF)OC=O(2636)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C=O(166)', 'C=[C]OF(202)'],
    products = ['C=C(OF)OC=O(2636)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(126)', 'C=[C]OC=O(920)'],
    products = ['C=C(OF)OC=O(2636)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C(OF)OC=O(2685)'],
    products = ['C=C(OF)OC=O(2636)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=C(OF)O[C]=O(2686)'],
    products = ['C=C(OF)OC=O(2636)'],
