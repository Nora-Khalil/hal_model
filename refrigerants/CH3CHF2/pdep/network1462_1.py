...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', 'O=C[C]F(1531)'],
    products = ['O=[C]OC=[C]F(4094)'],
    transitionState = 'TS2',
