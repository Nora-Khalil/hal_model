...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(1066)', '[CH]C-2(610)'],
    products = ['[CH]=C(F)O[CH]C(4209)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[CH]=C(F)OC=C(4218)'],
    products = ['[CH]=C(F)O[CH]C(4209)'],
    transitionState = 'TS6',
