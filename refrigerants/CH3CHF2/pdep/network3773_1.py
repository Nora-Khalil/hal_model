...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.987337,0.0674797,-7.15709e-05,3.73275e-08,-7.77883e-12,-60681.6,25.3479], Tmin=(100,'K'), Tmax=(1152.26,'K')), NASAPolynomial(coeffs=[14.4153,0.0208654,-1.08891e-05,2.21876e-09,-1.61492e-13,-63776.1,-41.3376], Tmin=(1152.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-505.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdOsOs) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01875,0.0571285,-5.34206e-05,2.35114e-08,-4.01332e-12,-7375.98,24.3386], Tmin=(100,'K'), Tmax=(1425.29,'K')), NASAPolynomial(coeffs=[17.2695,0.0115216,-5.42321e-06,1.06112e-09,-7.54794e-14,-12008.4,-59.8208], Tmin=(1425.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.2782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02811,0.0574114,-6.69236e-05,3.93565e-08,-8.58926e-12,-48196.8,21.025], Tmin=(100,'K'), Tmax=(1324.24,'K')), NASAPolynomial(coeffs=[13.5524,0.0090245,-1.57474e-07,-2.75317e-10,2.91553e-14,-50588.3,-39.42], Tmin=(1324.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-401.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFHO) + group(Cs-OsOsOsH) + ring(1,3-Dioxolane) + radical(Cs_P)"""),
)
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75397,0.0528548,-5.74345e-05,3.33383e-08,-7.99473e-12,-47572.4,22.9073], Tmin=(100,'K'), Tmax=(993.257,'K')), NASAPolynomial(coeffs=[9.38097,0.0221398,-1.10492e-05,2.205e-09,-1.58574e-13,-49087.5,-13.837], Tmin=(993.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-396.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-204.872,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,1855,455,950,359.987,360.066,360.084],'cm^-1')),
        HinderedRotor(inertia=(0.0013002,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0927865,'amu*angstrom^2'), symmetry=1, barrier=(8.53683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254604,'amu*angstrom^2'), symmetry=1, barrier=(23.4256,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88235,0.0493701,-6.0764e-05,3.98351e-08,-1.05682e-11,-24566.5,20.6789], Tmin=(100,'K'), Tmax=(913.3,'K')), NASAPolynomial(coeffs=[9.15304,0.0175263,-8.46359e-06,1.65803e-09,-1.17805e-13,-25894.5,-13.7386], Tmin=(913.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdOsH) + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical((O)CJOCC)"""),
)

species(
    label = 'O=C(OF)O[CH][CH]F(10912)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.586851,0.0772011,-9.93406e-05,6.09064e-08,-1.45631e-11,-37343.7,26.2641], Tmin=(100,'K'), Tmax=(1024.34,'K')), NASAPolynomial(coeffs=[16.4776,0.0151494,-8.47618e-06,1.7705e-09,-1.30638e-13,-40599.3,-50.782], Tmin=(1024.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdOsOs) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46709,0.0576726,-5.61799e-05,2.8006e-08,-5.71204e-12,-97522.7,23.748], Tmin=(100,'K'), Tmax=(1159.06,'K')), NASAPolynomial(coeffs=[11.48,0.0231176,-1.14608e-05,2.28471e-09,-1.6421e-13,-99843.8,-26.0367], Tmin=(1159.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-811.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)OC[CH]F(10803)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]COC(=O)OF-2(10908)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(230)', '[CH2]OC(=O)OF(2344)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'O=C(OF)OC[C]F(5442)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)OF(2343)', 'CH2CHF(56)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(OF)OC=CF(10910)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)OC[CH]F(10911)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)OF(2343)', '[CH2][CH]F(233)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(126)', 'O=[C]OC[CH]F(180)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C(OF)O[CH][CH]F(10912)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]OC(=O)OF(2344)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=C(OF)OC[C]F-2(5447)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(OF)O[CH]CF(10913)'],
    products = ['O=C(OF)OC[CH]F(10803)'],
...
network(
    label = 'PDepNetwork #3773',
    isomers = [
        'O=C(OF)OC[CH]F(10803)',
    ],
    reactants = [
