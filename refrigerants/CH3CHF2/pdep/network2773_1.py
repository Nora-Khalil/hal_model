...
"""),
    E0 = (-183.956,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1277.5,1000,3025,407.5,1350,352.5,1855,455,950],'cm^-1')),
        HinderedRotor(inertia=(1.67027,'amu*angstrom^2'), symmetry=1, barrier=(38.4029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66643,'amu*angstrom^2'), symmetry=1, barrier=(38.3145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.665,'amu*angstrom^2'), symmetry=1, barrier=(38.2816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66928,'amu*angstrom^2'), symmetry=1, barrier=(38.38,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.834661,0.0566055,-6.33005e-05,3.1982e-08,-5.99357e-12,-21999.7,23.2403], Tmin=(100,'K'), Tmax=(1470.44,'K')), NASAPolynomial(coeffs=[18.7807,0.000903661,5.43112e-07,-1.46965e-10,1.01818e-14,-26533.2,-67.7277], Tmin=(1470.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCJO) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.81665,0.00282149,9.3011e-05,-1.29515e-07,5.08267e-11,-55882.7,18.1355], Tmin=(100,'K'), Tmax=(955.415,'K')), NASAPolynomial(coeffs=[16.8225,0.00319616,-2.26591e-07,1.92314e-10,-2.974e-14,-61252.3,-62.891], Tmin=(955.415,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-465.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-OdCsOs) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47343,0.00805481,9.07777e-05,-1.34271e-07,5.40105e-11,-72953.7,19.5613], Tmin=(100,'K'), Tmax=(951.837,'K')), NASAPolynomial(coeffs=[19.7788,9.8955e-05,1.24715e-06,-7.51693e-11,-1.25529e-14,-79182,-78.485], Tmin=(951.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-607.222,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-O2d)) + group(Cds-OdOsH) + group(Cds-OdOsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.89171,'amu*angstrom^2'), symmetry=1, barrier=(43.4942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89226,'amu*angstrom^2'), symmetry=1, barrier=(43.5068,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0268,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26635,0.0157923,6.27644e-05,-1.06118e-07,4.47151e-11,-49321.7,18.9319], Tmin=(100,'K'), Tmax=(945.571,'K')), NASAPolynomial(coeffs=[20.082,-0.00293736,2.63337e-06,-3.79914e-10,1.17882e-14,-55222.8,-79.4094], Tmin=(945.571,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-410.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-O2d)) + group(Cds-OdOsH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)

species(
    label = '[O]COO[C]=O(7184)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {2,S} {5,S}
2 O u0 p2 c0 {1,S} {6,S}
3 O u1 p2 c0 {5,S}
...
"""),
    E0 = (-145.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,1855,455,950,180],'cm^-1')),
        HinderedRotor(inertia=(1.8869,'amu*angstrom^2'), symmetry=1, barrier=(43.3835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88599,'amu*angstrom^2'), symmetry=1, barrier=(43.3626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88615,'amu*angstrom^2'), symmetry=1, barrier=(43.3663,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87023,0.0323905,1.00789e-05,-4.47107e-08,2.1057e-11,-17412.1,20.2018], Tmin=(100,'K'), Tmax=(973.258,'K')), NASAPolynomial(coeffs=[17.0148,0.00516006,-1.915e-06,4.67879e-10,-4.26327e-14,-22018.3,-60.9707], Tmin=(973.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCOJ) + radical((O)CJOC)"""),
)

species(
    label = '[O][CH]OOC=O(7185)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {2,S} {5,S}
2 O u0 p2 c0 {1,S} {6,S}
3 O u1 p2 c0 {5,S}
...
"""),
    E0 = (-153.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,499.46],'cm^-1')),
        HinderedRotor(inertia=(0.270919,'amu*angstrom^2'), symmetry=1, barrier=(47.926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271794,'amu*angstrom^2'), symmetry=1, barrier=(47.9413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.270398,'amu*angstrom^2'), symmetry=1, barrier=(47.9231,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0348,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44036,0.0361798,-2.53491e-05,7.7993e-09,-9.47309e-13,-18348.8,19.311], Tmin=(100,'K'), Tmax=(1847.41,'K')), NASAPolynomial(coeffs=[12.1277,0.0152049,-8.31881e-06,1.6537e-09,-1.15666e-13,-21928.1,-33.3711], Tmin=(1847.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(700)', '[CH]O(237)'],
    products = ['O=[C]OO[CH]O(7110)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(128)', '[O]O[CH]O(780)'],
    products = ['O=[C]OO[CH]O(7110)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]O[CH]O(780)'],
    products = ['O=[C]OO[CH]O(7110)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(9.47144,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)
...
reaction(
    ...
    products = ['O=[C]OO[CH]O(7110)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(178.985,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
...
reaction(
    ...
    products = ['O=[C]OO[CH]O(7110)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(204.208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0
Ea raised from 203.5 to 204.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OOC=O(5660)'],
    products = ['O=[C]OO[CH]O(7110)'],
    transitionState = 'TS9',
