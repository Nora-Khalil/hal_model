...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(128)', '[O]C([O])F(782)'],
    products = ['[O]C(F)O[C]=O(1415)'],
    transitionState = 'TS2',
