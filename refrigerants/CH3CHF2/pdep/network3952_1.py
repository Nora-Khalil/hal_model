...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03451,0.054882,-2.79501e-05,-1.11812e-08,1.06593e-11,-5481.24,21.1829], Tmin=(100,'K'), Tmax=(943.387,'K')), NASAPolynomial(coeffs=[16.4616,0.0148177,-4.55004e-06,7.63537e-10,-5.35422e-14,-9519.92,-58.3231], Tmin=(943.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.5399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC[O](685)'],
    products = ['[CH]=C(C[O])CF(8026)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(C=O)CF(11960)'],
    products = ['[CH]=C(C[O])CF(8026)'],
    transitionState = 'TS8',
