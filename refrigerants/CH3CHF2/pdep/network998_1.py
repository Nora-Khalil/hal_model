...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2][CH]C(F)F(2954)'],
    products = ['[CH2]CC(F)F(975)'],
    transitionState = 'TS9',
