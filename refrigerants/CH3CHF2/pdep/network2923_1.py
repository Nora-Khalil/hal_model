...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11337,0.0249649,4.48697e-05,-7.71638e-08,3.12326e-11,-14357.5,20.6677], Tmin=(100,'K'), Tmax=(971.986,'K')), NASAPolynomial(coeffs=[14.039,0.0169217,-6.04325e-06,1.19022e-09,-9.18788e-14,-18614.2,-46.4991], Tmin=(971.986,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(CdCFH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=C(O)C=C=CF(7839)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.234058,0.069688,-7.36958e-05,3.75637e-08,-7.23236e-12,-18272.9,23.1276], Tmin=(100,'K'), Tmax=(1406.26,'K')), NASAPolynomial(coeffs=[19.4703,0.00856026,-1.65428e-06,1.68773e-10,-8.02964e-15,-23049.2,-73.9804], Tmin=(1406.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'FC=[C]C[C]1CO1(7840)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.81952,0.0361054,-1.54319e-05,2.00212e-09,2.83885e-14,4932.28,19.7443], Tmin=(100,'K'), Tmax=(2244.64,'K')), NASAPolynomial(coeffs=[19.2267,0.0153954,-7.29118e-06,1.27686e-09,-7.93489e-14,-4581.71,-77.4622], Tmin=(2244.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.7361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(Cds-OdCsCs) + ring(Cyclobutanone) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-15.3454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,113,247,382,1207,3490,540,610,2055,440.887,445.706,446.08],'cm^-1')),
        HinderedRotor(inertia=(0.108389,'amu*angstrom^2'), symmetry=1, barrier=(15.082,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.958907,0.0615635,-6.70491e-05,3.67628e-08,-7.82521e-12,-1731.57,22.0223], Tmin=(100,'K'), Tmax=(1157.93,'K')), NASAPolynomial(coeffs=[14.9396,0.0132683,-4.48711e-06,7.43453e-10,-4.85873e-14,-4969.31,-47.4764], Tmin=(1157.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.3454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(C=C(C)OJ)"""),
)
...
"""),
    E0 = (70.3231,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,167,640,1190,292.633,295.753,304.01],'cm^-1')),
        HinderedRotor(inertia=(0.00193292,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128517,'amu*angstrom^2'), symmetry=1, barrier=(7.85791,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.109767,0.0736623,-8.409e-05,4.61965e-08,-9.50031e-12,4263.25,26.5872], Tmin=(100,'K'), Tmax=(1343.96,'K')), NASAPolynomial(coeffs=[19.4222,0.00745574,-4.56143e-07,-1.21491e-10,1.44219e-14,-139.615,-69.3612], Tmin=(1343.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(C=C(O)CJ) + radical(Cdj(Cd-CdH)(Cd-F1sH))"""),
)

species(
    label = '[CH]=C(O)C[C]=CF(7848)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
...
"""),
    E0 = (167.338,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,615,860,1140,1343,3152,1685,370,3120,650,792.5,1650,244.675,244.902],'cm^-1')),
        HinderedRotor(inertia=(0.322237,'amu*angstrom^2'), symmetry=1, barrier=(13.6929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322072,'amu*angstrom^2'), symmetry=1, barrier=(13.6937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322142,'amu*angstrom^2'), symmetry=1, barrier=(13.6947,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
...
"""),
    E0 = (67.3013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,350,440,435,1725,194,682,905,1196,1383,3221,3120,650,792.5,1650,375.145,375.153],'cm^-1')),
        HinderedRotor(inertia=(0.0870922,'amu*angstrom^2'), symmetry=1, barrier=(8.69274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0870645,'amu*angstrom^2'), symmetry=1, barrier=(8.69318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.910586,0.0600005,-5.80224e-05,2.84718e-08,-5.46097e-12,8212.42,26.7315], Tmin=(100,'K'), Tmax=(1277.55,'K')), NASAPolynomial(coeffs=[15.3106,0.0149148,-5.08707e-06,8.48913e-10,-5.56077e-14,4533.01,-46.2678], Tmin=(1277.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.3013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = 'C=C(O)C[C]=[C]F(7850)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    E0 = (170.36,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,1685,370,167,640,1190,313.683,313.688],'cm^-1')),
        HinderedRotor(inertia=(0.188903,'amu*angstrom^2'), symmetry=1, barrier=(13.1739,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188561,'amu*angstrom^2'), symmetry=1, barrier=(13.1757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189223,'amu*angstrom^2'), symmetry=1, barrier=(13.1727,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.641778,0.0670689,-7.29651e-05,3.93749e-08,-8.2079e-12,20616.3,26.7536], Tmin=(100,'K'), Tmax=(1184.54,'K')), NASAPolynomial(coeffs=[16.7103,0.0128078,-4.25328e-06,7.03261e-10,-4.61416e-14,16809.5,-53.4891], Tmin=(1184.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=[C]CC(=C)OF(7851)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (516.935,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,331.199,331.205],'cm^-1')),
        HinderedRotor(inertia=(0.00153677,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157175,'amu*angstrom^2'), symmetry=1, barrier=(12.2352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157175,'amu*angstrom^2'), symmetry=1, barrier=(12.2352,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27911,0.0632326,-7.28609e-05,4.61975e-08,-1.20186e-11,62268.1,26.0028], Tmin=(100,'K'), Tmax=(925.596,'K')), NASAPolynomial(coeffs=[9.9812,0.0256261,-1.19163e-05,2.30155e-09,-1.62399e-13,60657.1,-15.3068], Tmin=(925.596,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(516.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)CC(=C)[O](7852)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u1 p2 c0 {4,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (61.7581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,246,474,533,1155,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,321.769,331.582,331.622],'cm^-1')),
        HinderedRotor(inertia=(0.00168271,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0722212,'amu*angstrom^2'), symmetry=1, barrier=(5.22617,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.939529,0.060994,-6.03775e-05,3.04208e-08,-6.01197e-12,7543.32,26.0901], Tmin=(100,'K'), Tmax=(1237.31,'K')), NASAPolynomial(coeffs=[14.8737,0.015947,-5.76614e-06,9.95787e-10,-6.6544e-14,4095.17,-44.1013], Tmin=(1237.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.7581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34812,0.0155735,7.47837e-05,-1.0273e-07,3.72095e-11,-22920.7,17.4382], Tmin=(100,'K'), Tmax=(1036.12,'K')), NASAPolynomial(coeffs=[14.5881,0.0217453,-1.14943e-05,2.54729e-09,-1.99612e-13,-28324.8,-55.8858], Tmin=(1036.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-OdCsCs) + group(CdCFH) + ring(Cyclobutane)"""),
)

species(
    label = 'CC(=O)C=C=CF(7853)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,D}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99704,0.0491051,-4.60666e-05,2.97697e-08,-9.36946e-12,-19136.5,20.9883], Tmin=(100,'K'), Tmax=(718.955,'K')), NASAPolynomial(coeffs=[4.43168,0.0355595,-1.78052e-05,3.56341e-09,-2.56713e-13,-19486.6,10.0459], Tmin=(718.955,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=C1C[C]([CH]F)O1(7824)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {5,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.492869,0.0640419,-6.40762e-05,3.19206e-08,-6.03418e-12,13881.6,22.1685], Tmin=(100,'K'), Tmax=(1454.63,'K')), NASAPolynomial(coeffs=[17.1169,0.0112162,-2.269e-06,2.32773e-10,-1.04669e-14,9797.7,-61.6766], Tmin=(1454.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(C2CsJOC(O)) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)

species(
    label = 'CC([O])=C[C]=CF(7854)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u1 p2 c0 {4,S}
3  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.945717,0.0639922,-7.0193e-05,4.02187e-08,-9.06375e-12,1686.51,24.4016], Tmin=(100,'K'), Tmax=(1088.64,'K')), NASAPolynomial(coeffs=[13.579,0.0175731,-6.23283e-06,1.04997e-09,-6.87578e-14,-1064.07,-37.6194], Tmin=(1088.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.0852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(C=C(C)OJ) + radical(Cdj(Cd-CdH)(Cd-F1sH))"""),
)

species(
    label = 'CC(=O)C[C]=[C]F(7855)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {5,S} {6,S} {8,S} {9,S}
...
"""),
    E0 = (148.159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,1685,370,167,640,1190,376.84,376.897],'cm^-1')),
        HinderedRotor(inertia=(0.00118659,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00118685,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110373,'amu*angstrom^2'), symmetry=1, barrier=(11.1225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16967,0.0470985,-3.23036e-05,1.02818e-08,-1.35011e-12,17878.4,21.6221], Tmin=(100,'K'), Tmax=(1626.46,'K')), NASAPolynomial(coeffs=[10.2479,0.0272314,-1.39812e-05,2.77167e-09,-1.95733e-13,15250.6,-21.2801], Tmin=(1626.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=[C]CC(=O)CF(7856)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {5,S} {6,S} {8,S} {9,S}
...
"""),
    E0 = (173.062,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,1685,370,3120,650,792.5,1650,180,560.837],'cm^-1')),
        HinderedRotor(inertia=(0.0702049,'amu*angstrom^2'), symmetry=1, barrier=(15.6276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114883,'amu*angstrom^2'), symmetry=1, barrier=(15.6775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0722818,'amu*angstrom^2'), symmetry=1, barrier=(15.6297,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01913,0.0511762,-3.97856e-05,1.53168e-08,-2.53656e-12,20879,22.1037], Tmin=(100,'K'), Tmax=(1307.77,'K')), NASAPolynomial(coeffs=[8.74393,0.0306075,-1.61935e-05,3.29015e-09,-2.37491e-13,19120.1,-12.144], Tmin=(1307.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=C([O])C=C=CF(7842)'],
    products = ['C=C([O])C[C]=CF(7417)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(T)(18)', 'O=[C]C[C]=CF(4061)'],
    products = ['C=C([O])C[C]=CF(7417)'],
