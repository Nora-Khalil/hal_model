...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(=C)F(4004)'],
    products = ['[CH]=C(F)C[O](3949)'],
    transitionState = 'TS2',
