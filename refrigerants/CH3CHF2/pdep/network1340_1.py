...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.914996,'amu*angstrom^2'), symmetry=1, barrier=(21.0376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915145,'amu*angstrom^2'), symmetry=1, barrier=(21.041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.914122,'amu*angstrom^2'), symmetry=1, barrier=(21.0175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.914305,'amu*angstrom^2'), symmetry=1, barrier=(21.0217,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.194382,0.0720859,-5.44729e-05,7.52518e-09,5.33111e-12,-68209.6,22.2999], Tmin=(100,'K'), Tmax=(970.431,'K')), NASAPolynomial(coeffs=[20.6786,0.0136867,-4.44625e-06,8.02884e-10,-5.8943e-14,-73411.2,-82.226], Tmin=(970.431,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-568.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.737528,'amu*angstrom^2'), symmetry=1, barrier=(16.9572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.73779,'amu*angstrom^2'), symmetry=1, barrier=(16.9632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.73782,'amu*angstrom^2'), symmetry=1, barrier=(16.9639,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4831,0.0462812,-2.45585e-05,-1.04938e-08,1.01588e-11,-36595.6,15.6745], Tmin=(100,'K'), Tmax=(928.391,'K')), NASAPolynomial(coeffs=[15.5528,0.00896108,-1.90534e-06,2.71623e-10,-1.95344e-14,-40212.1,-56.5659], Tmin=(928.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6156,0.0579715,-4.7607e-05,2.30047e-08,-5.07739e-12,-84719.6,21.4159], Tmin=(100,'K'), Tmax=(1007.21,'K')), NASAPolynomial(coeffs=[6.57945,0.0382582,-1.82489e-05,3.57267e-09,-2.54165e-13,-85719.5,-2.56742], Tmin=(1007.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-705.074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)

species(
    label = '[CH2]C([O])OC(C)F(3922)',
...
"""),
    E0 = (-262.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,542.078,1746.68,4000],'cm^-1')),
        HinderedRotor(inertia=(1.10134,'amu*angstrom^2'), symmetry=1, barrier=(25.322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203727,'amu*angstrom^2'), symmetry=1, barrier=(4.68408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10141,'amu*angstrom^2'), symmetry=1, barrier=(25.3236,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1299,0.069454,-8.2203e-05,6.22891e-08,-2.07966e-11,-31416.1,26.1279], Tmin=(100,'K'), Tmax=(710.657,'K')), NASAPolynomial(coeffs=[6.35934,0.0400166,-2.00624e-05,3.98905e-09,-2.85288e-13,-32159.2,2.68559], Tmin=(710.657,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-262.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO)"""),
)
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43883,0.0480344,-1.76479e-05,-4.95708e-09,3.38627e-12,-82792.3,23.2164], Tmin=(100,'K'), Tmax=(1221.75,'K')), NASAPolynomial(coeffs=[11.689,0.029355,-1.29827e-05,2.46562e-09,-1.72356e-13,-86407.4,-32.8326], Tmin=(1221.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-689.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.78312,'amu*angstrom^2'), symmetry=1, barrier=(18.0055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.783399,'amu*angstrom^2'), symmetry=1, barrier=(18.0119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.783063,'amu*angstrom^2'), symmetry=1, barrier=(18.0041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.783311,'amu*angstrom^2'), symmetry=1, barrier=(18.0099,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.211716,0.0786885,-8.80924e-05,4.68186e-08,-9.32344e-12,-17722.9,23.0618], Tmin=(100,'K'), Tmax=(1372.39,'K')), NASAPolynomial(coeffs=[21.6557,0.00676604,-5.33712e-07,-6.177e-11,8.31601e-15,-22953.9,-86.5488], Tmin=(1372.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-148.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOC(O))"""),
)
...
"""),
    E0 = (-171.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,251.271,251.271,251.271],'cm^-1')),
        HinderedRotor(inertia=(0.478805,'amu*angstrom^2'), symmetry=1, barrier=(21.4522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.478805,'amu*angstrom^2'), symmetry=1, barrier=(21.4522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.478806,'amu*angstrom^2'), symmetry=1, barrier=(21.4522,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0882,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32052,0.0477906,-1.67652e-05,-1.80496e-08,1.16882e-11,-20516.9,21.6002], Tmin=(100,'K'), Tmax=(977.376,'K')), NASAPolynomial(coeffs=[15.7703,0.0144163,-5.08332e-06,9.51228e-10,-7.02769e-14,-24571.9,-54.0757], Tmin=(977.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31438,0.0528214,-3.56591e-05,1.15294e-08,-1.48878e-12,-57341.2,24.9951], Tmin=(100,'K'), Tmax=(1787.14,'K')), NASAPolynomial(coeffs=[15.333,0.0214446,-9.3235e-06,1.70522e-09,-1.14483e-13,-62351.8,-50.776], Tmin=(1787.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CJCO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.785661,'amu*angstrom^2'), symmetry=1, barrier=(18.0639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.786567,'amu*angstrom^2'), symmetry=1, barrier=(18.0847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.785502,'amu*angstrom^2'), symmetry=1, barrier=(18.0602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.785693,'amu*angstrom^2'), symmetry=1, barrier=(18.0646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.119593,0.0798926,-9.22264e-05,5.20938e-08,-1.13505e-11,-44813.2,23.3718], Tmin=(100,'K'), Tmax=(1133.31,'K')), NASAPolynomial(coeffs=[18.7409,0.0141697,-5.23914e-06,9.24232e-10,-6.29751e-14,-49033.9,-68.7957], Tmin=(1133.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C(F)OC(=C)O(3931)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.930307,'amu*angstrom^2'), symmetry=1, barrier=(21.3896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.931168,'amu*angstrom^2'), symmetry=1, barrier=(21.4094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.930455,'amu*angstrom^2'), symmetry=1, barrier=(21.393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.930096,'amu*angstrom^2'), symmetry=1, barrier=(21.3847,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.193855,0.0809964,-8.97807e-05,4.75781e-08,-9.6037e-12,-42614.5,25.3938], Tmin=(100,'K'), Tmax=(1261.46,'K')), NASAPolynomial(coeffs=[21.7038,0.00969764,-2.78411e-06,4.30674e-10,-2.7844e-14,-47990.9,-84.7482], Tmin=(1261.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-355.653,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH]=C(O)OC(C)F(3932)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.946529,'amu*angstrom^2'), symmetry=1, barrier=(21.7626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.947661,'amu*angstrom^2'), symmetry=1, barrier=(21.7886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.946587,'amu*angstrom^2'), symmetry=1, barrier=(21.7639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.946057,'amu*angstrom^2'), symmetry=1, barrier=(21.7517,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.281842,0.0802512,-8.68698e-05,4.45884e-08,-8.65809e-12,-38472.2,24.4184], Tmin=(100,'K'), Tmax=(1361.77,'K')), NASAPolynomial(coeffs=[22.503,0.00823157,-1.9302e-06,2.59319e-10,-1.581e-14,-44205.6,-90.8073], Tmin=(1361.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-321.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.999318,0.0722669,-8.26497e-05,5.43332e-08,-1.51516e-11,-29750.5,25.2496], Tmin=(100,'K'), Tmax=(852.636,'K')), NASAPolynomial(coeffs=[8.87362,0.0353259,-1.7661e-05,3.51914e-09,-2.52466e-13,-31093.3,-11.484], Tmin=(852.636,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C[C]F(124)', 'C=C(O)O(1862)'],
    products = ['C=C(O)OC(C)F(3764)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C=C(O)OC(3920)'],
    products = ['C=C(O)OC(C)F(3764)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2CHF(56)', 'C=C(O)O(1862)'],
    products = ['C=C(O)OC(C)F(3764)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=C(O)O[CH]C(3928)'],
    products = ['C=C(O)OC(C)F(3764)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'C=[C]OC(C)F(2020)'],
    products = ['C=C(O)OC(C)F(3764)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(=O)OC(C)F(3929)'],
    products = ['C=C(O)OC(C)F(3764)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(19)', 'C=C(O)O[CH]F(1870)'],
    products = ['C=C(O)OC(C)F(3764)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'C=C(O)O[C](C)F(3930)'],
    products = ['C=C(O)OC(C)F(3764)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH2]C(F)OC(=C)O(3931)'],
    products = ['C=C(O)OC(C)F(3764)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH]=C(O)OC(C)F(3932)'],
    products = ['C=C(O)OC(C)F(3764)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'C=COC(=C)O(2324)'],
    products = ['C=C(O)OC(C)F(3764)'],
