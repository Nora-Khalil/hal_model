...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])=C(6672)'],
    products = ['C2H4(30)', 'C=C=C(6745)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC[C]=C(7044)'],
    products = ['[CH2]CC([CH2])=C(6672)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C([CH2])=C(7071)'],
    products = ['[CH2]CC([CH2])=C(6672)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C[C]=C(1875)'],
    products = ['[CH2]CC([CH2])=C(6672)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H4(30)', '[CH2][C]=C(7019)'],
    products = ['[CH2]CC([CH2])=C(6672)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(=C)C=C(7090)'],
    products = ['[CH2]CC([CH2])=C(6672)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH2](612)', 'C=C=C(6745)'],
    products = ['[CH2]CC([CH2])=C(6672)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH2](612)', '[CH2][C]=C(7019)'],
    products = ['[CH2]CC([CH2])=C(6672)'],
