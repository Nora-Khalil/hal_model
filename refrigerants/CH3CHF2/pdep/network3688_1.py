...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0208402,'amu*angstrom^2'), symmetry=1, barrier=(17.0462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48137,'amu*angstrom^2'), symmetry=1, barrier=(34.0597,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44129,0.0455408,-1.65163e-05,-1.76244e-08,1.16417e-11,-14843.5,20.3049], Tmin=(100,'K'), Tmax=(968.359,'K')), NASAPolynomial(coeffs=[15.606,0.012281,-4.10942e-06,7.61438e-10,-5.67745e-14,-18770.7,-53.689], Tmin=(968.359,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Allyl_P)"""),
)
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53823,0.0233304,2.13816e-05,-3.75596e-08,1.39224e-11,519.483,18.6757], Tmin=(100,'K'), Tmax=(1048.27,'K')), NASAPolynomial(coeffs=[7.9717,0.0239787,-1.01411e-05,1.94516e-09,-1.39311e-13,-1794.45,-13.3972], Tmin=(1048.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.81884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCFHO) + ring(Cs(C-F)-Cs-Cs) + radical(O2sj(Cs-CsF1sH)) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2][C]1COC1F(8021)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.65144,0.0189189,3.69123e-05,-5.71751e-08,2.21111e-11,-683.789,19.6983], Tmin=(100,'K'), Tmax=(975.172,'K')), NASAPolynomial(coeffs=[8.56337,0.0213319,-7.81156e-06,1.4376e-09,-1.03069e-13,-3104.58,-15.1749], Tmin=(975.172,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.16886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(CsCFHO) + group(Cs-CsHHH) + ring(O2s-Cs-Cs-Cs(F)) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1([CH2])OC1F(11155)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31404,0.0603314,-7.29176e-05,4.74051e-08,-1.23176e-11,7763.91,19.3945], Tmin=(100,'K'), Tmax=(939.582,'K')), NASAPolynomial(coeffs=[10.8344,0.0198009,-8.21218e-06,1.49404e-09,-1.01711e-13,5974.88,-25.9424], Tmin=(939.582,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.7575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(O2s-Cs(F)-Cs(C)) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
"""),
    E0 = (-207.046,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,255,533,799,832,1228,227.995],'cm^-1')),
        HinderedRotor(inertia=(0.139118,'amu*angstrom^2'), symmetry=1, barrier=(5.14572,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18089,0.0533444,-3.74489e-05,2.53784e-09,5.01471e-12,-14796.2,19.8707], Tmin=(100,'K'), Tmax=(963.669,'K')), NASAPolynomial(coeffs=[15.9429,0.0119202,-3.86761e-06,6.81264e-10,-4.88627e-14,-18563,-55.5834], Tmin=(963.669,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFO) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69206,0.047645,-3.79843e-05,1.54826e-08,-2.56851e-12,-16027.1,19.168], Tmin=(100,'K'), Tmax=(1412.41,'K')), NASAPolynomial(coeffs=[11.4783,0.0199302,-8.55118e-06,1.59019e-09,-1.09547e-13,-18791.6,-31.4244], Tmin=(1412.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFO) + radical(C=COJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=C(C)C([O])F(6367)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u1 p2 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.535963,'amu*angstrom^2'), symmetry=1, barrier=(12.3228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.534902,'amu*angstrom^2'), symmetry=1, barrier=(12.2985,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81131,0.0491727,-4.51494e-05,2.241e-08,-4.62511e-12,6794.61,19.9006], Tmin=(100,'K'), Tmax=(1140.17,'K')), NASAPolynomial(coeffs=[9.39733,0.0225589,-1.01363e-05,1.9374e-09,-1.36167e-13,5064.75,-17.6926], Tmin=(1140.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.8456,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sCdH)) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-47.7835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,236,527,855,1015,1182,1348,3236,350,440,435,1725,2950,3100,1380,975,1025,1650,309.98,309.984,309.998,310.002],'cm^-1')),
        HinderedRotor(inertia=(0.745343,'amu*angstrom^2'), symmetry=1, barrier=(50.8231,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.745247,'amu*angstrom^2'), symmetry=1, barrier=(50.8237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.745207,'amu*angstrom^2'), symmetry=1, barrier=(50.823,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60193,0.0528125,-4.21016e-05,1.80195e-08,-3.25716e-12,-5660.91,20.5114], Tmin=(100,'K'), Tmax=(1270.76,'K')), NASAPolynomial(coeffs=[9.68863,0.0273579,-1.20553e-05,2.2567e-09,-1.5611e-13,-7716.17,-20.44], Tmin=(1270.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.7835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C(=C)[CH]OF(11168)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (217.235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,350,440,435,1725,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,600.231,600.269],'cm^-1')),
        HinderedRotor(inertia=(0.121021,'amu*angstrom^2'), symmetry=1, barrier=(30.9459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121014,'amu*angstrom^2'), symmetry=1, barrier=(30.9441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120954,'amu*angstrom^2'), symmetry=1, barrier=(30.9381,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54429,0.0428554,-9.80136e-06,-2.27293e-08,1.28222e-11,26225.7,21.5409], Tmin=(100,'K'), Tmax=(981.176,'K')), NASAPolynomial(coeffs=[15.0123,0.0138557,-5.07194e-06,9.66906e-10,-7.20065e-14,22335.8,-49.5332], Tmin=(981.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=CCJO) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(=C)C([O])F(6563)'],
    products = ['[CH2]C(=C[O])CF(8029)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.45932e+11,'s^-1'), n=0.63878, Ea=(268.172,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='F_Ext-2R!H-R',), comment="""Estimated from node F_Ext-2R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([CH2])=CF(7562)'],
    products = ['[CH2]C(=C)C([O])F(6563)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(=C)C([O])F(6563)'],
    products = ['[CH2]C1([CH2])OC1F(11155)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.62453e+10,'s^-1'), n=0.5217, Ea=(105.522,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_O]
Euclidian distance = 1.0
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(4.32115,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(=C)C([O])F(6563)'],
    products = ['[CH2]C([CH2])=C(O)F(11167)'],
