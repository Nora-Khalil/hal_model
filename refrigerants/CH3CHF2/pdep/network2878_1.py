...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.150905,'amu*angstrom^2'), symmetry=1, barrier=(3.46959,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33668,0.0556249,-0.000131489,1.57646e-07,-6.57673e-11,-43455.6,21.76], Tmin=(100,'K'), Tmax=(847.086,'K')), NASAPolynomial(coeffs=[-5.94529,0.0451938,-2.52951e-05,5.03111e-09,-3.50715e-13,-40275.2,70.8323], Tmin=(847.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-361.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFHHO) + radical(OCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(230)', '[O]C([O])O(7860)'],
    products = ['[O]C(O)O[CH]F(2485)'],
    transitionState = 'TS2',
