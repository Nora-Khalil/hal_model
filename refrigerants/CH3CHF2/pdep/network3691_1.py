...
"""),
    E0 = (95.9241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,580,1155,1237,1373,3147,2950,3100,1380,975,1025,1650,1685,370,261.511,261.515,261.518,3261.38],'cm^-1')),
        HinderedRotor(inertia=(0.153608,'amu*angstrom^2'), symmetry=1, barrier=(7.45475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.746585,'amu*angstrom^2'), symmetry=1, barrier=(36.2313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153612,'amu*angstrom^2'), symmetry=1, barrier=(7.45474,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74344,0.0556718,-8.20453e-05,7.49518e-08,-2.75658e-11,11612.4,22.6897], Tmin=(100,'K'), Tmax=(813.281,'K')), NASAPolynomial(coeffs=[4.62331,0.0303255,-1.46731e-05,2.81898e-09,-1.95477e-13,11513.8,11.6648], Tmin=(813.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.9241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFHHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(F1s)(O2s-Cs)(H)) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0786466,'amu*angstrom^2'), symmetry=1, barrier=(1.80824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0787554,'amu*angstrom^2'), symmetry=1, barrier=(1.81074,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477356,'amu*angstrom^2'), symmetry=1, barrier=(10.9753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26322,0.0456824,-2.70732e-05,-3.55646e-08,4.94495e-11,12704.9,20.8761], Tmin=(100,'K'), Tmax=(479.527,'K')), NASAPolynomial(coeffs=[5.92689,0.0282346,-1.35132e-05,2.60927e-09,-1.82582e-13,12202.8,4.32167], Tmin=(479.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFHHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(F1s)(O2s-Cs)(H)) + radical(Cds_P)"""),
)
