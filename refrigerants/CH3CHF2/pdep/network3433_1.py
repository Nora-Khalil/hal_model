...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02016,'amu*angstrom^2'), symmetry=1, barrier=(23.4555,'kJ/mol'), semiclassical=False),
        ...
        HinderedRotor(inertia=(1.01913,'amu*angstrom^2'), symmetry=1, barrier=(23.4318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35673,0.0634483,-7.55755e-05,5.3789e-08,-1.63443e-11,-30802.6,23.3498], Tmin=(100,'K'), Tmax=(785.577,'K')), NASAPolynomial(coeffs=[7.49632,0.0321863,-1.58825e-05,3.13098e-09,-2.2283e-13,-31767.2,-4.7884], Tmin=(785.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00154391,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00154414,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00154326,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27205,0.068658,-7.83387e-05,3.56801e-08,4.10694e-12,-61088.2,23.6295], Tmin=(100,'K'), Tmax=(549.429,'K')), NASAPolynomial(coeffs=[7.80759,0.0336945,-1.73306e-05,3.45016e-09,-2.45843e-13,-61996.8,-5.71978], Tmin=(549.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-508.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CsCCl_triplet)"""),
)

species(
    label = 'O[C]1CC(F)C(F)O1(10270)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42997,0.0434219,9.77288e-06,-5.11348e-08,2.55965e-11,-72839.5,21.2721], Tmin=(100,'K'), Tmax=(910.824,'K')), NASAPolynomial(coeffs=[15.3256,0.0170202,-3.76614e-06,5.09232e-10,-3.36571e-14,-76806.9,-52.3524], Tmin=(910.824,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-606.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(Tetrahydrofuran) + radical(Cs_P) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = '[O]C1(O)CC(F)C1F(9999)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.81237,'amu*angstrom^2'), symmetry=1, barrier=(18.678,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.811787,'amu*angstrom^2'), symmetry=1, barrier=(18.6646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.811359,'amu*angstrom^2'), symmetry=1, barrier=(18.6547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.811829,'amu*angstrom^2'), symmetry=1, barrier=(18.6655,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.334056,0.0942841,-0.00012655,8.2137e-08,-2.04749e-11,-67527.4,27.2032], Tmin=(100,'K'), Tmax=(994.077,'K')), NASAPolynomial(coeffs=[19.5937,0.0140973,-5.55121e-06,9.89842e-10,-6.70242e-14,-71489.3,-68.8179], Tmin=(994.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-562.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(Csj(Cs-F1sCdH)(F1s)(H))"""),
)

species(
    label = 'O=C(O)CC=CF(10272)',
...
"""),
    E0 = (-550.616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,396.563,396.586,396.591,396.592,396.595,396.597],'cm^-1')),
        HinderedRotor(inertia=(0.0010716,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00107181,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00107192,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66324,0.0425194,-1.26431e-05,-9.56224e-09,4.85354e-12,-66132.5,22.2338], Tmin=(100,'K'), Tmax=(1211.41,'K')), NASAPolynomial(coeffs=[12.9251,0.0235613,-1.17389e-05,2.36112e-09,-1.7043e-13,-70198.5,-39.7784], Tmin=(1211.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-550.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(CdCFH)"""),
)
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57376,0.058299,-6.65196e-05,4.7321e-08,-1.46843e-11,-34750,26.2428], Tmin=(100,'K'), Tmax=(764.197,'K')), NASAPolynomial(coeffs=[6.50525,0.0324848,-1.58473e-05,3.11312e-09,-2.21244e-13,-35503.7,3.77774], Tmin=(764.197,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCJCC=O) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.638766,0.0851325,-0.000147589,1.39956e-07,-5.12339e-11,-59605.7,28.7472], Tmin=(100,'K'), Tmax=(831.204,'K')), NASAPolynomial(coeffs=[5.85669,0.0370274,-1.92808e-05,3.76433e-09,-2.61363e-13,-59678.7,9.31686], Tmin=(831.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-496.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'O=C(O)[CH]C=CF(9394)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-433.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,478.013,478.014,478.015,478.016,478.022,478.032],'cm^-1')),
        HinderedRotor(inertia=(0.000737768,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275218,'amu*angstrom^2'), symmetry=1, barrier=(44.6252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275233,'amu*angstrom^2'), symmetry=1, barrier=(44.6253,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43701,0.0465942,-2.09334e-05,-4.84556e-09,4.01687e-12,-52061.7,20.2431], Tmin=(100,'K'), Tmax=(1190.77,'K')), NASAPolynomial(coeffs=[14.8381,0.0198758,-1.03269e-05,2.12138e-09,-1.55244e-13,-56550.5,-52.1967], Tmin=(1190.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(CdCFH) + radical(C=CCJCO)"""),
)
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34346,0.063491,-6.13685e-05,3.31324e-08,-7.67536e-12,-81613.7,26.197], Tmin=(100,'K'), Tmax=(1004.12,'K')), NASAPolynomial(coeffs=[8.91103,0.0333452,-1.63358e-05,3.23411e-09,-2.31525e-13,-83133.4,-10.3433], Tmin=(1004.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-679.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CCJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCC(F)[CH]F(964)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CO2(14)', 'CC(F)[CH]F(758)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2O(3)', 'O=C=CC(F)[CH]F(6187)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2CO(28)', 'OC(F)[CH]F(837)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=C(O)OC(F)[CH]F(10267)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]C(F)CC(=O)O(10268)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]F(230)', 'O=C(O)C[CH]F(1562)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(O)CC(F)[C]F(10269)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C(O)CC(F)[CH]F(9697)'],
    products = ['O[C]1CC(F)C(F)O1(10270)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OC(O)=CC(F)[CH]F(10271)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=C(O)CC=CF(10272)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHFCHF[Z](59)', '[CH2]C(=O)O(1378)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=C(O)CC(F)=CF(8656)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=C(O)C[CH][CH]F(10273)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'O=[C]CC(F)[CH]F(6133)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)CC(F)[CH]F(10274)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH][CH]F(5595)', '[CH2]C(=O)O(1378)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]O(165)', '[CH2]C(F)[CH]F(252)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)[CH]C(F)[CH]F(10275)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=C(O)C[C](F)[CH]F(10276)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(O)[CH]C=CF(9394)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CHF(40)', 'O=C(O)C[CH]F(1562)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(5)', 'O=C(O)CC(F)[C]F-2(10277)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O=C(O)[CH]C(F)CF(10012)'],
    products = ['O=C(O)CC(F)[CH]F(9697)'],
