...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'CC(=O)OF(1441)'],
    products = ['CCC(=O)OF(1758)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[CH2]C(=O)OF(1447)'],
    products = ['CCC(=O)OF(1758)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C[CH]C(=O)OF(1433)'],
    products = ['CCC(=O)OF(1758)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]CC(=O)OF(1446)'],
    products = ['CCC(=O)OF(1758)'],
