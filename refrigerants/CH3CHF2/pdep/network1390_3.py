...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.406222,'amu*angstrom^2'), symmetry=1, barrier=(9.33983,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.0271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.94637,0.0252443,-3.64306e-05,2.70907e-08,-8.00061e-12,25225.4,12.0644], Tmin=(100,'K'), Tmax=(828.342,'K')), NASAPolynomial(coeffs=[6.68718,0.00718077,-3.72125e-06,7.66301e-10,-5.59275e-14,24605.7,-5.27845], Tmin=(828.342,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(7)', 'C2HF(58)'],
    products = ['[CH]=C(O)F(519)'],
    transitionState = 'TS1',
