...
"""),
    E0 = (-258.021,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,615,860,1140,1343,3152,1685,370,324.588,324.64,1935.76],'cm^-1')),
        HinderedRotor(inertia=(0.158487,'amu*angstrom^2'), symmetry=1, barrier=(11.8444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158431,'amu*angstrom^2'), symmetry=1, barrier=(11.8447,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39335,0.0601669,-6.10021e-05,3.38275e-08,-7.80158e-12,-30941.3,25.3788], Tmin=(100,'K'), Tmax=(1028.57,'K')), NASAPolynomial(coeffs=[9.93244,0.0269599,-1.2576e-05,2.44079e-09,-1.72978e-13,-32697.9,-16.0581], Tmin=(1028.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFF) + group(CdCFH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-183.764,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,190,488,555,1236,1407,2175,525,239,401,1367,180,180,735.037],'cm^-1')),
        HinderedRotor(inertia=(0.118235,'amu*angstrom^2'), symmetry=1, barrier=(2.71844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108628,'amu*angstrom^2'), symmetry=1, barrier=(2.49757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118272,'amu*angstrom^2'), symmetry=1, barrier=(2.71931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.951487,0.0741069,-0.00011379,9.98494e-08,-3.47716e-11,-21998.7,26.5158], Tmin=(100,'K'), Tmax=(829.507,'K')), NASAPolynomial(coeffs=[7.18128,0.0318434,-1.52627e-05,2.90074e-09,-1.99278e-13,-22611.8,0.159816], Tmin=(829.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(CsCsFFH) + group(Ct-CtCs) + group(CtCF) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-191.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,167,640,1190,323.699,325.418,1745.74],'cm^-1')),
        HinderedRotor(inertia=(0.132799,'amu*angstrom^2'), symmetry=1, barrier=(9.92389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129936,'amu*angstrom^2'), symmetry=1, barrier=(9.9054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132576,'amu*angstrom^2'), symmetry=1, barrier=(9.8845,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.880321,0.0742967,-9.90419e-05,7.74917e-08,-2.52327e-11,-22958.1,27.9611], Tmin=(100,'K'), Tmax=(743.098,'K')), NASAPolynomial(coeffs=[8.50541,0.0332503,-1.61835e-05,3.15292e-09,-2.22046e-13,-24091.3,-6.56121], Tmin=(743.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61952,0.0617864,-4.91051e-05,-1.63661e-08,4.07828e-11,-29673.2,27.4896], Tmin=(100,'K'), Tmax=(496.373,'K')), NASAPolynomial(coeffs=[6.65447,0.0363746,-1.81317e-05,3.57244e-09,-2.53267e-13,-30359.8,4.844], Tmin=(496.373,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C]=[C]CCC(F)F(7679)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-145.583,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,235,523,627,1123,1142,1372,1406,3097,1685,370,167,640,1190,352.742,353.818,354.65],'cm^-1')),
        HinderedRotor(inertia=(0.0055089,'amu*angstrom^2'), symmetry=1, barrier=(12.2963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138976,'amu*angstrom^2'), symmetry=1, barrier=(12.2765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137499,'amu*angstrom^2'), symmetry=1, barrier=(12.293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11257,0.0681167,-7.43306e-05,4.51793e-08,-1.14769e-11,-17409.5,27.7366], Tmin=(100,'K'), Tmax=(937.313,'K')), NASAPolynomial(coeffs=[9.80938,0.0310025,-1.49353e-05,2.9337e-09,-2.0906e-13,-19039.8,-13.6573], Tmin=(937.313,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=[C]CCC(F)(F)F(7680)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0062,0.0703081,-8.08032e-05,5.1592e-08,-1.36277e-11,-25473.2,26.2975], Tmin=(100,'K'), Tmax=(908.48,'K')), NASAPolynomial(coeffs=[10.1538,0.0300311,-1.43005e-05,2.78984e-09,-1.97892e-13,-27135.3,-16.9562], Tmin=(908.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)CC[C](F)F(7681)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.769893,0.076909,-0.000104158,8.13204e-08,-2.62417e-11,-23984.4,27.7346], Tmin=(100,'K'), Tmax=(751.221,'K')), NASAPolynomial(coeffs=[9.05493,0.0327915,-1.60617e-05,3.13556e-09,-2.21003e-13,-25229.1,-9.86544], Tmin=(751.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(2927)', '[CH2]C[C]=CF(4143)'],
    products = ['FC=[C]CC[C](F)F(7481)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=CF(1084)', '[CH2]C[C](F)F(3082)'],
    products = ['FC=[C]CC[C](F)F(7481)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC=[C]CC=C(F)F(7670)'],
    products = ['FC=[C]CC[C](F)F(7481)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C#CCC[C](F)F(7672)'],
    products = ['FC=[C]CC[C](F)F(7481)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FC#CCC[C](F)F(7673)'],
    products = ['FC=[C]CC[C](F)F(7481)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[CH2]C[C]=CF(4143)'],
    products = ['FC=[C]CC[C](F)F(7481)'],
