...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]F(3052)'],
...
reaction(
    ...
    products = ['[CH2]C(F)(F)O[CH]F(3052)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)O[CH]F(642)'],
    products = ['[CH2]C(F)(F)O[CH]F(3052)'],
    transitionState = 'TS6',
