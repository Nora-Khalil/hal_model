...
reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'F[C]C(F)OF(750)'],
    products = ['CC(F)C(F)OF(747)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'FCC(F)OF(752)'],
    products = ['CC(F)C(F)OF(747)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[CH]C(F)OF(756)'],
    products = ['CC(F)C(F)OF(747)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(126)', 'CC(F)[CH]F(758)'],
    products = ['CC(F)C(F)OF(747)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(614)', 'CH3-CHF(63)'],
    products = ['CC(F)C(F)OF(747)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'F[CH]C(F)OF(759)'],
    products = ['CC(F)C(F)OF(747)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C[C](F)C(F)OF(760)'],
    products = ['CC(F)C(F)OF(747)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(F)C(F)OF(762)'],
    products = ['CC(F)C(F)OF(747)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'CC(F)C(=O)F(154)'],
    products = ['CC(F)C(F)OF(747)'],
