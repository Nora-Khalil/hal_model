...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2927)', '[CH]C(=C)F(4004)'],
    products = ['[CH]=C(F)C[C](F)F(3991)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)C=C(F)F(4032)'],
    products = ['[CH]=C(F)C[C](F)F(3991)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CC[C](F)F(3123)'],
    products = ['[CH]=C(F)C[C](F)F(3991)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH]=C=C[C](F)F(4033)'],
    products = ['[CH]=C(F)C[C](F)F(3991)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH]C(=C)F(4004)'],
    products = ['[CH]=C(F)C[C](F)F(3991)'],
