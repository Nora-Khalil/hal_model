...
"""),
    E0 = (376.354,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,246,474,533,1155,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,425.162,425.162],'cm^-1')),
        HinderedRotor(inertia=(0.0601573,'amu*angstrom^2'), symmetry=1, barrier=(7.71656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0601576,'amu*angstrom^2'), symmetry=1, barrier=(7.71657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88711,0.0467652,-4.08448e-05,1.93117e-08,-3.80371e-12,45340.7,21.6043], Tmin=(100,'K'), Tmax=(1189.45,'K')), NASAPolynomial(coeffs=[9.24655,0.0220158,-9.63331e-06,1.81791e-09,-1.26806e-13,43590,-15.1774], Tmin=(1189.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = '[CH]=C=C([CH2])CF(7774)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54576,0.0520879,-4.9759e-05,2.56007e-08,-5.33662e-12,28729.5,20.1475], Tmin=(100,'K'), Tmax=(1153.43,'K')), NASAPolynomial(coeffs=[10.8192,0.0199279,-7.93527e-06,1.42677e-09,-9.69735e-14,26590.3,-25.9151], Tmin=(1153.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_P) + radical(C=C=CJ)"""),
)
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33288,0.023,3.70096e-05,-6.62049e-08,2.75003e-11,35680.9,16.5897], Tmin=(100,'K'), Tmax=(951.401,'K')), NASAPolynomial(coeffs=[12.3423,0.0151751,-4.66522e-06,8.44689e-10,-6.34782e-14,32225.9,-39.3493], Tmin=(951.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CdCsCdF) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Allyl_T) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = '[CH2]C1=C(F)[CH]C1(11379)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8903,0.0359643,1.40162e-06,-2.83748e-08,1.34105e-11,25505.9,17.8933], Tmin=(100,'K'), Tmax=(997.911,'K')), NASAPolynomial(coeffs=[12.5994,0.0171892,-6.6789e-06,1.27563e-09,-9.32796e-14,22166,-39.7746], Tmin=(997.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + ring(Cd(F)-Cd-Cs-Cs) + radical(Csj(Cs-CdHH)(Cd-CdF1s)(H)_ring) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1([CH2])C=C1F(11373)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37161,0.050143,-2.9272e-05,3.65397e-09,1.70115e-12,27995.1,19.7128], Tmin=(100,'K'), Tmax=(1106.49,'K')), NASAPolynomial(coeffs=[12.1256,0.0234566,-9.61947e-06,1.76934e-09,-1.22524e-13,24869.1,-36.629], Tmin=(1106.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C(=C)[C]=CF(11375)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  C u0 p0 c0 {3,S} {4,D} {6,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(F)C[C]=C(10768)'],
    products = ['[CH]=C(F)C([CH2])=C(6686)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH]C(F)=C=C(4056)'],
    products = ['[CH]=C(F)C([CH2])=C(6686)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(F)C([CH2])=C(6686)'],
    products = ['[CH2]C1=C(F)[CH]C1(11379)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(F)C([CH2])=C(6686)'],
    products = ['[CH2]C1([CH2])C=C1F(11373)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C#CC([CH2])=C(11380)'],
    products = ['[CH]=C(F)C([CH2])=C(6686)'],
