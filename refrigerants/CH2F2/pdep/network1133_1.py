...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)OOO(3065)'],
    products = ['HO2(11)', 'FC1=CO1(1027)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(6)', '[C]=C(F)OOO(3100)'],
    products = ['[CH]=C(F)OOO(3065)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(11)', '[CH]C(=O)F-2(2868)'],
    products = ['[CH]=C(F)OOO(3065)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', '[CH]=C(F)O[O](2467)'],
    products = ['[CH]=C(F)OOO(3065)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH]=C(F)OO[O](2721)'],
    products = ['[CH]=C(F)OOO(3065)'],
    transitionState = 'TS8',
