...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(184)', 'O=C[C]F(816)'],
    products = ['O=[C]OC=[C]F(2543)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C]=O(145)', '[CH]=[C]F(2014)'],
    products = ['O=[C]OC=[C]F(2543)'],
    transitionState = 'TS8',
