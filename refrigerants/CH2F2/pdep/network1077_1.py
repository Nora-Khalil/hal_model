...
species(
    label = '[CH2]C(F)(F)C(F)(F)[C](F)F(2400)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'FC1(F)CC(F)(F)C1(F)F(2443)',
...
species(
    label = 'F[C](F)C(F)(F)[CH]C(F)F(2445)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C](F)[CH]C(F)(F)C(F)F(564)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-974.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,190,488,555,1236,1407,180,180,1539.82],'cm^-1')),
        HinderedRotor(inertia=(0.205739,'amu*angstrom^2'), symmetry=1, barrier=(4.73034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205643,'amu*angstrom^2'), symmetry=1, barrier=(4.72813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205758,'amu*angstrom^2'), symmetry=1, barrier=(4.73079,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.049,'amu'),
...
species(
    label = 'F[C](F)C[C](F)C(F)(F)F(2446)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0687477,0.101648,-0.000182088,1.68068e-07,-5.94989e-11,-120897,30.9957], Tmin=(100,'K'), Tmax=(835.673,'K')), NASAPolynomial(coeffs=[9.28007,0.033505,-1.77816e-05,3.49207e-09,-2.42527e-13,-121643,-7.54116], Tmin=(835.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1006.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sF1s)(F1s)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[C](F)CC(F)(F)F(2447)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.071287,0.100691,-0.000176945,1.61133e-07,-5.66814e-11,-121900,31.5515], Tmin=(100,'K'), Tmax=(827.136,'K')), NASAPolynomial(coeffs=[9.93072,0.0324725,-1.72358e-05,3.39547e-09,-2.36661e-13,-122875,-10.6997], Tmin=(827.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1014.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C](F)F(2400)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', 'F[C](F)C[C](F)F(1057)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(130)', '[CH2]C(F)(F)[C](F)F(1063)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
    products = ['FC1(F)CC(F)(F)C1(F)F(2443)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
    products = ['FC(F)=CC(F)(F)C(F)F(2444)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)CC(F)=C(F)F(1075)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2CF2(60)', '[CH2][C](F)F(933)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[C](F)[C](F)F(384)', 'CH2CF2(56)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)C(F)(F)C=C(F)F(2425)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)[C](F)F(384)', '[CH2][C](F)F(933)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'F[C](F)C=C(F)[C](F)F(548)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(42)', 'F[C](F)C[C](F)F(1057)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(42)', '[CH2]C(F)(F)[C](F)F(1063)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)C(F)(F)[CH]C(F)F(2445)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)[CH]C(F)(F)C(F)F(564)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
    products = ['F[C](F)C[C](F)C(F)(F)F(2446)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(2401)'],
    products = ['F[C](F)[C](F)CC(F)(F)F(2447)'],
