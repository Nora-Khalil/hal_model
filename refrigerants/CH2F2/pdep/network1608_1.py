...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60796,0.0575883,-7.13458e-05,4.95008e-08,-1.43186e-11,-76633.5,22.8382], Tmin=(100,'K'), Tmax=(829.67,'K')), NASAPolynomial(coeffs=[8.30371,0.0253065,-1.29818e-05,2.6031e-09,-1.87076e-13,-77744.5,-8.21464], Tmin=(829.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-637.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-O2d(Cds-O2d)Cs) + group(Cd-Cd(CO)H) + group(COCFO) + group(CdCFH)"""),
)

species(
    label = 'F[C]=CC1OO[C]1F(4576)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-302.799,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,552.5,462.5,1710,280,501,1494,1531,3010,987.5,1337.5,450,1655,167,640,1190,180,2371.17],'cm^-1')),
        HinderedRotor(inertia=(0.44118,'amu*angstrom^2'), symmetry=1, barrier=(10.1436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.85169,'amu*angstrom^2'), symmetry=1, barrier=(42.5739,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84361,'amu*angstrom^2'), symmetry=1, barrier=(42.3883,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07567,0.0737227,-0.000129132,1.21899e-07,-4.45089e-11,-36322.1,25.1982], Tmin=(100,'K'), Tmax=(824.316,'K')), NASAPolynomial(coeffs=[6.23451,0.0301412,-1.60747e-05,3.1668e-09,-2.20993e-13,-36542.4,5.12884], Tmin=(824.316,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + group(CdCFH) + radical(CsCOF1sO2s) + radical(Cdj(Cd-COH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.117462,'amu*angstrom^2'), symmetry=1, barrier=(2.70069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.32383,'amu*angstrom^2'), symmetry=1, barrier=(30.4375,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23255,0.0663237,-0.000105672,9.00855e-08,-3.07185e-11,-46533.2,24.3036], Tmin=(100,'K'), Tmax=(765.385,'K')), NASAPolynomial(coeffs=[9.1441,0.0216123,-1.14524e-05,2.27492e-09,-1.60598e-13,-47645.7,-11.106], Tmin=(765.385,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-387.684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-O2d(Cds-O2d)Cs) + group(Cd-Cd(CO)H) + group(COCFO) + group(CdCFH) + radical(Cdj(Cd-COH)(F1s))"""),
)
...
"""),
    E0 = (-214.413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,486,617,768,1157,1926,2175,525,239,401,1367,315.756,1063.02,1063.02],'cm^-1')),
        HinderedRotor(inertia=(0.0785904,'amu*angstrom^2'), symmetry=1, barrier=(5.56039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0785906,'amu*angstrom^2'), symmetry=1, barrier=(5.56037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57855,0.0566946,-7.918e-05,5.92593e-08,-1.77741e-11,-25703.8,26.5977], Tmin=(100,'K'), Tmax=(815.19,'K')), NASAPolynomial(coeffs=[9.37615,0.0184335,-8.77785e-06,1.68463e-09,-1.17426e-13,-26975.1,-9.42795], Tmin=(815.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(COCsFO) + group(Ct-CtCs) + group(CtCF) + radical(C=OCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.742948,0.0732177,-9.94319e-05,6.53033e-08,-1.66276e-11,-44091.6,23.2493], Tmin=(100,'K'), Tmax=(967.972,'K')), NASAPolynomial(coeffs=[15.2605,0.0132262,-6.46739e-06,1.27629e-09,-9.12397e-14,-46902.2,-46.3168], Tmin=(967.972,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-367.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-CdsCsH) + group(COCFO) + radical(CsCCl_triplet)"""),
)

species(
    label = '[O]C([C]=CF)C(=O)F(4584)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49889,0.0592299,-7.72595e-05,5.47754e-08,-1.58093e-11,-28123.1,28.2787], Tmin=(100,'K'), Tmax=(840.21,'K')), NASAPolynomial(coeffs=[9.30144,0.0220845,-1.09453e-05,2.15857e-09,-1.53511e-13,-29434.2,-8.00568], Tmin=(840.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cds-CdsCsH) + group(COCsFO) + group(CdCFH) + radical(C=OCOJ) + radical(Cds_S)"""),
)

species(
    label = 'O=C(F)C(O)[C]=[C]F(4585)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {10,S}
...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24621,0.0649435,-9.03199e-05,6.57956e-08,-1.91784e-11,-27346.2,28.8952], Tmin=(100,'K'), Tmax=(837.686,'K')), NASAPolynomial(coeffs=[10.6202,0.0201831,-1.01716e-05,2.01154e-09,-1.42971e-13,-28916.7,-14.6688], Tmin=(837.686,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cds-CdsCsH) + group(COCsFO) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[O]C(F)=C([O])C=CF(4586)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u1 p2 c0 {6,S}
...
"""),
    E0 = (82.4579,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,1855,455,950,167,640,1190,437.664,440.679],'cm^-1')),
        HinderedRotor(inertia=(0.0853001,'amu*angstrom^2'), symmetry=1, barrier=(11.7437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0866765,'amu*angstrom^2'), symmetry=1, barrier=(11.7354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.085784,'amu*angstrom^2'), symmetry=1, barrier=(11.7656,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14139,0.0649931,-8.24532e-05,5.23113e-08,-1.30848e-11,10018.6,28.8605], Tmin=(100,'K'), Tmax=(977.357,'K')), NASAPolynomial(coeffs=[12.9762,0.0165575,-8.11744e-06,1.6066e-09,-1.15068e-13,7705.22,-27.9649], Tmin=(977.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.4579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFH) + radical(CCCJ=O) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[O]C([C]=O)C=C(F)F(4588)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49054,0.0566636,-6.62201e-05,3.99777e-08,-9.63811e-12,-31117.4,28.7302], Tmin=(100,'K'), Tmax=(1007.51,'K')), NASAPolynomial(coeffs=[11.3052,0.0176974,-8.20619e-06,1.58991e-09,-1.12674e-13,-33095,-18.6933], Tmin=(1007.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFF) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(C=[C]F)C(=O)F(4519)'],
    products = ['C2HF(57)', 'O=CC(=O)F(711)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]C(F)C=[C]F(2658)'],
    products = ['[O]C(C=[C]F)C(=O)F(4519)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=C(F)C=C[C]F(3067)'],
    products = ['[O]C(C=[C]F)C(=O)F(4519)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(C=[C]F)C(=O)F(4519)'],
    products = ['O=C(F)C1C=C(F)O1(4574)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(C=[C]F)C(=O)F(4519)'],
    products = ['[O]C1C=C(F)O[C]1F(4577)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(C=[C]F)C(=O)F(4519)'],
    products = ['[O]C1C=C(F)C1([O])F(4579)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(C=[C]F)[C](O)F(4580)'],
    products = ['[O]C(C=[C]F)C(=O)F(4519)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[C]F(2014)', 'O=CC(=O)F(711)'],
    products = ['[O]C(C=[C]F)C(=O)F(4519)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CFO(50)', 'O=CC=[C]F(2678)'],
    products = ['[O]C(C=[C]F)C(=O)F(4519)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(F)C(=O)C=[C]F(4581)'],
    products = ['[O]C(C=[C]F)C(=O)F(4519)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C2HF(57)', '[O][CH]C(=O)F(753)'],
    products = ['[O]C(C=[C]F)C(=O)F(4519)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(C#CF)C(=O)F(4582)'],
    products = ['[O]C(C=[C]F)C(=O)F(4519)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]F(2014)', '[O][CH]C(=O)F(753)'],
    products = ['[O]C(C=[C]F)C(=O)F(4519)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=[C]C(=O)C=[C]F(4568)'],
    products = ['[O]C(C=[C]F)C(=O)F(4519)'],
...
network(
    label = 'PDepNetwork #1608',
    isomers = [
        '[O]C(C=[C]F)C(=O)F(4519)',
    ],
    reactants = [
        ('C2HF(57)', 'O=CC(=O)F(711)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
