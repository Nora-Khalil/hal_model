...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(4710)', '[CH2]C([O])=O(1180)'],
    products = ['[CH2]C(=O)O[C]=C(5337)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C]=O(4742)'],
    products = ['[CH2]C(=O)O[C]=C(5337)'],
    transitionState = 'TS3',
