...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'CC(=O)C([O])=O(4487)'],
    products = ['CC(=O)C(=O)OF(4650)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(125)', 'CC(=O)[C]=O(4703)'],
    products = ['CC(=O)C(=O)OF(4650)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'O=[C]C(=O)OF(414)'],
    products = ['CC(=O)C(=O)OF(4650)'],
