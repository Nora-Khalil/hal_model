...
reaction(
    label = 'reaction4',
    reactants = ['O(7)', '[O]C([O])C(=O)F(3178)'],
    products = ['[O]OC([O])C(=O)F(3124)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', '[O]OC(=O)C(=O)F(5480)'],
    products = ['[O]OC([O])C(=O)F(3124)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', '[O]OC(=O)[C]=O(5471)'],
    products = ['[O]OC([O])C(=O)F(3124)'],
