...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(144)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])(F)F(1553)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(7)', '[CH2]O[C](F)F(1174)'],
    products = ['[CH2]OC([O])(F)F(1553)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(=O)F(1622)'],
    products = ['[CH2]OC([O])(F)F(1553)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(249)', '[CH2][O](1455)'],
    products = ['[CH2]OC([O])(F)F(1553)'],
    transitionState = 'TS8',
