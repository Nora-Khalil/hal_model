...
reaction(
    label = 'reaction5',
    reactants = ['O(7)', '[O]C([O])(F)C=O(3166)'],
    products = ['[O]OC([O])(F)C=O(3125)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]OC([O])(F)C=O(3125)'],
    products = ['HO2(11)', 'O=[C]C(=O)F(1824)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]OC(=O)C=O(5470)'],
    products = ['[O]OC([O])(F)C=O(3125)'],
