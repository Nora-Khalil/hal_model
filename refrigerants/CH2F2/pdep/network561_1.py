...
reaction(
    label = 'reaction2',
    reactants = ['OOO[C](F)F(284)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)OOO(1480)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(6)', '[CH]C(F)(F)OOO(1502)'],
    products = ['[CH2]C(F)(F)OOO(1480)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2][C](F)OOO(1504)'],
    products = ['[CH2]C(F)(F)OOO(1480)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HO2(11)', '[CH2]C([O])(F)F(1145)'],
    products = ['[CH2]C(F)(F)OOO(1480)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(5)', '[CH2]C(F)(F)O[O](652)'],
    products = ['[CH2]C(F)(F)OOO(1480)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', '[CH2]C(F)(F)OO[O](1459)'],
    products = ['[CH2]C(F)(F)OOO(1480)'],
    transitionState = 'TS9',
