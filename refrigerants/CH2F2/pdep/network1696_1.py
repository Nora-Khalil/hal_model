...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=C(O)O[C](F)F(373)'],
    products = ['[O]C(F)(F)OC(=O)O(3685)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)(F)OC(=O)O(3685)'],
    products = ['[O]C1(O)OC(F)(F)O1(4997)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(237)', '[O]C(=O)O(226)'],
    products = ['[O]C(F)(F)OC(=O)O(3685)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(150)', 'O=[C]O(161)'],
    products = ['[O]C(F)(F)OC(=O)O(3685)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[O]C(F)(F)O[C]=O(232)'],
    products = ['[O]C(F)(F)OC(=O)O(3685)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC([O])(F)F(4998)'],
    products = ['[O]C(F)(F)OC(=O)O(3685)'],
