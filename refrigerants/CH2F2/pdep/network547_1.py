...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(F)(F)O[O](582)'],
    products = ['[CH2]C(F)(F)OO[O](1373)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OO[C](F)F(222)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)OO[O](1373)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)OO[O](1469)'],
    products = ['[CH2]C(F)(F)OO[O](1373)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', '[CH2]C([O])(F)F(975)'],
    products = ['[CH2]C(F)(F)OO[O](1373)'],
    transitionState = 'TS8',
