...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441769,0.0902743,-0.000170134,1.60149e-07,-5.71313e-11,-107440,29.5694], Tmin=(100,'K'), Tmax=(841.677,'K')), NASAPolynomial(coeffs=[8.41901,0.027902,-1.53838e-05,3.04705e-09,-2.11829e-13,-107917,-2.39415], Tmin=(841.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-894.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC(F)[C](F)F(477)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[O]C(F)[C](F)F(452)'],
    products = ['F[C](F)OC(F)[C](F)F(477)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)OC=C(F)F(498)'],
    products = ['F[C](F)OC(F)[C](F)F(477)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C](F)OC(F)=C(F)F(499)'],
    products = ['F[C](F)OC(F)[C](F)F(477)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(42)', '[O]C(F)[C](F)F(452)'],
    products = ['F[C](F)OC(F)[C](F)F(477)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C](F)OC(F)[C](F)F(477)'],
    products = ['F[C](F)O[C](F)C(F)F(500)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)OC(F)[C](F)F(477)'],
    products = ['F[C](F)O[CH]C(F)(F)F(502)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)OC(F)[C](F)F(477)'],
    products = ['F[C](F)[CH]OC(F)(F)F(503)'],
...
network(
    label = 'PDepNetwork #212',
    isomers = [
        'F[C](F)OC(F)[C](F)F(477)',
    ],
    reactants = [
        ('CF2O(48)', 'CHFCF2(54)'),
    ],
