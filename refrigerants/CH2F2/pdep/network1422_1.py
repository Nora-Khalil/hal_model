...
species(
    label = '[CH2]C(F)(F)OC1(F)[CH]O1(3764)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'F[C]1[CH]OCC(F)(F)O1(3720)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O][CH]C1(F)CC(F)(F)O1(3772)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(3123)', '[CH2]C([O])(F)F(975)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=C[C](F)O[C](F)F(2832)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
    products = ['O=CC1(F)CC(F)(F)O1(3697)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
    products = ['[CH2]C(F)(F)OC1(F)[CH]O1(3764)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
    products = ['F[C]1[CH]OCC(F)(F)O1(3720)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
    products = ['[O]C1CC(F)(F)O[C]1F(3753)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)O[C](F)C=O(3765)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)OC(F)=C=O(3766)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C[C]F-2(818)', '[CH2]C([O])(F)F(975)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)OC(F)[C]=O(3767)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
    products = ['CC(F)(F)O[C](F)[C]=O(3768)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C](F)OC(F)(F)C=O(3769)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C[C](F)O[C](F)CF(3770)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(6)', '[CH]=C(F)OC([CH2])(F)F(3771)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
    products = ['[O][CH]C1(F)CC(F)(F)O1(3772)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', '[CH2]C(F)(F)O[C]=C=O(3773)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(F)(F)OC(F)=[C]O(3774)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=C(F)O[C](F)[CH]OF(3775)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(F)(F)O[C]=COF(3776)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C=[C]OC(F)(F)CF(3777)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3689)'],
...
network(
    label = 'PDepNetwork #1422',
    isomers = [
        '[CH2]C(F)(F)O[C](F)C=O(3689)',
    ],
    reactants = [
