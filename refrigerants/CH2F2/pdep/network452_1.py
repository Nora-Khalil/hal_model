...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(187)', '[O]C[C](F)F(1144)'],
    products = ['O=[C]OC[C](F)F(1141)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(162)', '[CH2]O[C]=O(1168)'],
    products = ['O=[C]OC[C](F)F(1141)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C[C](F)F(1144)'],
    products = ['O=[C]OC[C](F)F(1141)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'O=[C]OC=C(F)F(507)'],
    products = ['O=[C]OC[C](F)F(1141)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]O[C]=O(1168)'],
    products = ['O=[C]OC[C](F)F(1141)'],
