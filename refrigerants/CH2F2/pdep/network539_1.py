...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[O]OC[C](F)F(1123)'],
    products = ['[O]OOC[C](F)F(1458)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(162)', '[CH2]OO[O](1460)'],
    products = ['[O]OOC[C](F)F(1458)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[O]OOC=C(F)F(1463)'],
    products = ['[O]OOC[C](F)F(1458)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]OO[O](1460)'],
    products = ['[O]OOC[C](F)F(1458)'],
