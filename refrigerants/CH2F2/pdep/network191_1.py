...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(461)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)[C](F)[CH]F(517)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(461)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(129)', '[O]C(=O)[C](F)F(247)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(461)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C(F)(F)[CH]F(518)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(461)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(461)'],
    products = ['F[CH]C(F)(F)[C]1OO1(519)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(461)'],
    products = ['[O]C1([O])C(F)C1(F)F(511)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(=O)C(F)=CF(521)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(461)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[O]C(=O)[C](F)F(247)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(461)'],
