...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[C](F)F(974)'],
    products = ['[O]CC([O])(F)F(1352)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C](F)F(237)', '[CH2][O](1324)'],
    products = ['[O]CC([O])(F)F(1352)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O][CH]C(=O)F(753)'],
    products = ['[O]CC([O])(F)F(1352)'],
