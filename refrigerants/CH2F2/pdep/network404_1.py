...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH2]C([O])=O(1038)'],
    products = ['[O]C(=O)C[C](F)F(986)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C[C](F)F(1039)'],
    products = ['[O]C(=O)C[C](F)F(986)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(=O)C=C(F)F(513)'],
    products = ['[O]C(=O)C[C](F)F(986)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(42)', '[CH2]C([O])=O(1038)'],
    products = ['[O]C(=O)C[C](F)F(986)'],
