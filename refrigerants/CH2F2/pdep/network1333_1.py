...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(184)', '[CH]C(=C)F(2631)'],
    products = ['[CH]=C(F)C[C]=O(3187)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C=C=O(3201)'],
    products = ['[CH]=C(F)C[C]=O(3187)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C[C]=O(3203)'],
    products = ['[CH]=C(F)C[C]=O(3187)'],
