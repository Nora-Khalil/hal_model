...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)OOF(1253)'],
    products = ['O=O(148)', 'HF(38)', 'CF2O(48)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'O[C](F)OOF(280)'],
    products = ['OC(F)(F)OOF(1253)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]F(125)', '[O]C(O)(F)F(178)'],
    products = ['OC(F)(F)OOF(1253)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OF(124)', 'O[C](F)F(220)'],
    products = ['OC(F)(F)OOF(1253)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)OOF(1258)'],
    products = ['OC(F)(F)OOF(1253)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'O=C(F)OOF(1259)'],
    products = ['OC(F)(F)OOF(1253)'],
    transitionState = 'TS8',
