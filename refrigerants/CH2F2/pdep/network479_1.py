...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[O]C[C](F)F(1144)'],
    products = ['[O]OC[C](F)F(1123)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(162)', '[CH2]O[O](1124)'],
    products = ['[O]OC[C](F)F(1123)'],
    transitionState = 'TS3',
