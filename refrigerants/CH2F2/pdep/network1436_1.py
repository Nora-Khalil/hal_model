...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(184)', '[CH]=C[O](930)'],
    products = ['[CH]=CO[C]=O(3832)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C]=O(145)', '[CH]=[CH](1596)'],
    products = ['[CH]=CO[C]=O(3832)'],
    transitionState = 'TS8',
