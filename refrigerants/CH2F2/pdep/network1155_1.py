...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)O[O](2544)'],
    products = ['O=O(148)', 'C2HF(57)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(=O)F-2(2561)'],
    products = ['[CH]=C(F)O[O](2544)'],
    transitionState = 'TS2',
