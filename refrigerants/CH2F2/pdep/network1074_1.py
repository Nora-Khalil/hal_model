...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.185926,'amu*angstrom^2'), symmetry=1, barrier=(4.27481,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187237,'amu*angstrom^2'), symmetry=1, barrier=(4.30495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.564198,'amu*angstrom^2'), symmetry=1, barrier=(12.972,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.281432,0.095153,-0.000183302,1.74385e-07,-6.25747e-11,-107426,28.298], Tmin=(100,'K'), Tmax=(843.185,'K')), NASAPolynomial(coeffs=[8.32139,0.0291716,-1.63954e-05,3.26121e-09,-2.26926e-13,-107793,-3.25007], Tmin=(843.185,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-894.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.200287,0.0946853,-0.000176124,1.60608e-07,-5.55452e-11,-109467,27.8517], Tmin=(100,'K'), Tmax=(849.857,'K')), NASAPolynomial(coeffs=[10.5503,0.0241647,-1.31665e-05,2.58447e-09,-1.7826e-13,-110438,-15.7641], Tmin=(849.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-911.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sF1s)(F1s)(O2s-Cs)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = 'F[C](F)[C](F)OC(F)F(501)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441398,0.0895934,-0.000166494,1.55635e-07,-5.54651e-11,-107913,29.8632], Tmin=(100,'K'), Tmax=(833.845,'K')), NASAPolynomial(coeffs=[8.77711,0.0275693,-1.52768e-05,3.04063e-09,-2.12341e-13,-108537,-4.24323], Tmin=(833.845,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-898.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[C](F)F(2399)'],
...
reaction(
    ...
    products = ['F[CH]OC(F)(F)[C](F)F(2399)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', 'F[CH]O[C](F)F(496)'],
    products = ['F[CH]OC(F)(F)[C](F)F(2399)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CHFO(46)', 'F[C](F)[C](F)F(384)'],
    products = ['F[CH]OC(F)(F)[C](F)F(2399)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=C(F)F(763)'],
    products = ['F[CH]OC(F)(F)[C](F)F(2399)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][CH]F(134)', 'CF2CF2(60)'],
    products = ['F[CH]OC(F)(F)[C](F)F(2399)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(134)', 'F[C](F)[C](F)F(384)'],
    products = ['F[CH]OC(F)(F)[C](F)F(2399)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(42)', 'F[CH]O[C](F)F(496)'],
    products = ['F[CH]OC(F)(F)[C](F)F(2399)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]OC(F)(F)[C](F)F(2399)'],
    products = ['F[CH]O[C](F)C(F)(F)F(2437)'],
