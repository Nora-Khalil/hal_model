...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(128)', '[O]C1O[C]1F(2736)'],
    products = ['F[CH]OC1O[C]1F(2754)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]O[CH]F(2874)'],
    products = ['F[CH]OC1O[C]1F(2754)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'F[CH]OC1=C(F)O1(2875)'],
    products = ['F[CH]OC1O[C]1F(2754)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[O]C1O[C]1F(2736)'],
    products = ['F[CH]OC1O[C]1F(2754)'],
