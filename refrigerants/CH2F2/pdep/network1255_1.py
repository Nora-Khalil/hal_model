...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC1(F)[CH]O1(2807)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(129)', '[O]C1(F)[CH]O1(2760)'],
    products = ['F[CH]OC1(F)[CH]O1(2807)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC1=CO1(2937)'],
    products = ['F[CH]OC1(F)[CH]O1(2807)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[O]C1(F)[CH]O1(2760)'],
    products = ['F[CH]OC1(F)[CH]O1(2807)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]OC1(F)[CH]O1(2807)'],
    products = ['FC(F)O[C]1[CH]O1(2938)'],
