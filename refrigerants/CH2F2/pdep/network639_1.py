...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(128)', '[O]C[O](1550)'],
    products = ['[O]CO[CH]F(1566)'],
    transitionState = 'TS2',
