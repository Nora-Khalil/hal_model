...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C(F)(F)[CH]F(724)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)C(F)[C](F)F(726)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(129)', '[O]C(F)[C](F)F(452)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)(F)[CH]F(553)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)C(F)=CF(785)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(134)', 'CHFCF2(54)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=CC(F)(F)[CH]F(786)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHFO(46)', 'F[CH][C](F)F(383)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(F)C(F)(F)[CH]F(537)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(134)', 'F[CH][C](F)F(383)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(77)', '[O]C=C(F)[CH]F(787)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=C(F)[C](F)[CH]F(538)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[O]C(F)[C](F)F(452)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)[CH]OF(791)'],
    products = ['[O]C(F)C(F)(F)[CH]F(724)'],
