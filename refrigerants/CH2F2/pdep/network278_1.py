...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OC(F)OF(777)'],
    products = ['O=COC(F)OF(715)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]OF(553)', '[O]C=O(135)'],
    products = ['O=COC(F)OF(715)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(203)', 'O=CO[CH]F(764)'],
    products = ['O=COC(F)OF(715)'],
