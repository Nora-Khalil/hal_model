...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)F(133)', 'CH2(S)(25)'],
    products = ['CC(F)(F)O[O](979)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)O[O](979)'],
    products = ['HO2(11)', 'CH2CF2(56)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[C](F)F(165)', 'CH3(19)'],
    products = ['CC(F)(F)O[O](979)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)O[O](582)'],
    products = ['CC(F)(F)O[O](979)'],
    transitionState = 'TS9',
