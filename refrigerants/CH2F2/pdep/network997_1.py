...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH]C(=O)F-2(2474)'],
    products = ['[CH]=C(F)O[O](2467)'],
    transitionState = 'TS2',
