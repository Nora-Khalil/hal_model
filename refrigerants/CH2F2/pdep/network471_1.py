...
reaction(
    label = 'reaction4',
    reactants = ['[O]O[C](F)F(165)', '[CH]F(129)'],
    products = ['[O]OC(F)(F)[CH]F(425)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[C](F)F(165)', 'CHF(40)'],
    products = ['[O]OC(F)(F)[CH]F(425)'],
    transitionState = 'TS9',
