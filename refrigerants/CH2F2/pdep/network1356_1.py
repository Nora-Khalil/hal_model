...
"""),
    E0 = (-505.253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,486,617,768,1157,1926,180,971.908,972.02,972.229,972.527,972.578,972.603,972.62],'cm^-1')),
        HinderedRotor(inertia=(0.187524,'amu*angstrom^2'), symmetry=1, barrier=(4.31155,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92109,0.0522177,-8.11524e-05,7.88301e-08,-3.09125e-11,-60699.4,26.1769], Tmin=(100,'K'), Tmax=(778.936,'K')), NASAPolynomial(coeffs=[3.76549,0.0306125,-1.61811e-05,3.22493e-09,-2.28492e-13,-60618.6,20.1024], Tmin=(778.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-505.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-CsCsOsH) + group(Cds-OdCsOs) + group(COCsFO) + radical(C=OCOJ) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.113095,'amu*angstrom^2'), symmetry=1, barrier=(2.60028,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63797,0.0582828,-0.000102082,9.12364e-08,-3.11705e-11,-36633.5,24.3232], Tmin=(100,'K'), Tmax=(859.863,'K')), NASAPolynomial(coeffs=[7.64254,0.0175891,-8.8319e-06,1.67854e-09,-1.1396e-13,-37194.4,-0.995584], Tmin=(859.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(COCsFO) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(C=OCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4787,0.0448381,-2.1792e-05,-1.6734e-08,1.33671e-11,-17226.5,29.0596], Tmin=(100,'K'), Tmax=(921.661,'K')), NASAPolynomial(coeffs=[17.4152,0.00342345,4.47774e-07,-1.53254e-10,8.59539e-15,-21342.7,-52.9188], Tmin=(921.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsOsOsH) + group(COCsFO) + ring(dioxirane) + radical(C=OCOJ) + radical(Cs_P)"""),
)

species(
    label = '[O]C(=O)C1OO[C]1F(3441)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {3,S} {6,S}
3 O u0 p2 c0 {2,S} {7,S}
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09115,0.0720898,-0.000126788,1.16774e-07,-4.18704e-11,-62210.6,25.1632], Tmin=(100,'K'), Tmax=(809.692,'K')), NASAPolynomial(coeffs=[7.87965,0.024814,-1.37538e-05,2.749e-09,-1.93433e-13,-62859.5,-3.37316], Tmin=(809.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-518.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)O2s) + radical(C=OC=OOJ) + radical(CsCOF1sO2s)"""),
)

species(
    label = '[O][C](C(=O)O)C(=O)F(3444)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {8,S}
2 O u0 p2 c0 {7,S} {9,S}
3 O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40152,0.0636925,-0.000105594,9.49022e-08,-3.35233e-11,-66583.3,27.301], Tmin=(100,'K'), Tmax=(814.676,'K')), NASAPolynomial(coeffs=[7.32499,0.0238452,-1.24079e-05,2.42886e-09,-1.69308e-13,-67191.3,2.12998], Tmin=(814.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-554.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-CsCsOsH) + group(Cds-OdCsOs) + group(COCsFO) + radical(C=OCOJ) + radical(C2CsJOH)"""),
)
...
"""),
    E0 = (-578.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,552.5,462.5,1710,286,619,818,1246,1924,222.523,222.524,222.524,222.525,1423.45,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.524097,'amu*angstrom^2'), symmetry=1, barrier=(18.4158,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524101,'amu*angstrom^2'), symmetry=1, barrier=(18.4158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.028,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07747,0.0729103,-0.000138156,1.2629e-07,-4.3732e-11,-69446,25.2058], Tmin=(100,'K'), Tmax=(846.952,'K')), NASAPolynomial(coeffs=[9.31242,0.0172548,-9.89842e-06,1.96447e-09,-1.36043e-13,-70239.7,-9.60568], Tmin=(846.952,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-578.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cds-O2d(Cds-O2d)(Cds-O2d)) + group(Cds-O2d(Cds-O2d)O2s) + group(COCFO) + radical(C=OC=OOJ)"""),
)
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.34822,0.0758484,-0.000103619,6.44962e-08,-1.51076e-11,-73184.4,24.0532], Tmin=(100,'K'), Tmax=(1066.38,'K')), NASAPolynomial(coeffs=[19.8795,0.00258736,-5.69868e-07,7.3753e-11,-4.75856e-15,-77350,-71.4295], Tmin=(1066.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-609.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-CdsCsCs) + group(COCFO) + radical(C=COJ) + radical(C=COJ)"""),
)

species(
    label = '[O]C(=O)C([C]=O)OF(3447)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2336,0.0700164,-0.00012458,1.18588e-07,-4.36027e-11,-24018.9,25.7135], Tmin=(100,'K'), Tmax=(820.684,'K')), NASAPolynomial(coeffs=[6.03544,0.0284812,-1.55256e-05,3.08005e-09,-2.15702e-13,-24196.5,7.21626], Tmin=(820.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-CsCsOsH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(CCOJ) + radical(C=OCCJ=O)"""),
)

species(
    label = '[O]C([C]=O)C(=O)OF(3448)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C([O])C(=O)F(3249)'],
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C([O])=CC(=O)F(2866)'],
    products = ['[O]C(=O)C([O])C(=O)F(3249)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C([C]=O)C(=O)F(3438)'],
    products = ['[O]C(=O)C([O])C(=O)F(3249)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)C([O])C(=O)F(3249)'],
    products = ['[O]C([C]1OO1)C(=O)F(3440)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(=O)C(=O)[C](O)F(3443)'],
    products = ['[O]C(=O)C([O])C(=O)F(3249)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O][C](C(=O)O)C(=O)F(3444)'],
    products = ['[O]C(=O)C([O])C(=O)F(3249)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CFO(50)', '[O]C(=O)C=O(742)'],
    products = ['[O]C(=O)C([O])C(=O)F(3249)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[O]C(=O)C(=O)C(=O)F(3445)'],
    products = ['[O]C(=O)C([O])C(=O)F(3249)'],
