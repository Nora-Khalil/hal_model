...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC(F)(F)[CH]F(2550)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]=CC(F)[C](F)F(2552)'],
    products = ['F[C]=CC(F)(F)[CH]F(2550)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(129)', 'F[C]C=C(F)F-2(2564)'],
    products = ['F[C]=CC(F)(F)[CH]F(2550)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]=CC(F)=CF(2614)'],
    products = ['F[C]=CC(F)(F)[CH]F(2550)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC#CC(F)(F)[CH]F(2615)'],
    products = ['F[C]=CC(F)(F)[CH]F(2550)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'F[C]=C=C(F)[CH]F(2616)'],
    products = ['F[C]=CC(F)(F)[CH]F(2550)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', 'F[C]C=C(F)F-2(2564)'],
    products = ['F[C]=CC(F)(F)[CH]F(2550)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]C(F)(F)[C]=CF(2617)'],
    products = ['F[C]=CC(F)(F)[CH]F(2550)'],
