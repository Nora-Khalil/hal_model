...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)C1OC1F(3070)'],
    products = ['HF(38)', 'CO2(14)', 'FC1=CO1(1027)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'O=CC(=O)OF(816)'],
    products = ['O=C(OF)C1OC1F(3070)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O-2(130)', 'O=C(C=CF)OF(631)'],
    products = ['O=C(OF)C1OC1F(3070)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(173)', 'O=C=C1OC1F(3086)'],
    products = ['O=C(OF)C1OC1F(3070)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C([CH]O[CH]F)OF(3089)'],
    products = ['O=C(OF)C1OC1F(3070)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([CH]F)C(=O)OF(2231)'],
    products = ['O=C(OF)C1OC1F(3070)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)[CH]C(=O)OF(3090)'],
    products = ['O=C(OF)C1OC1F(3070)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(OF)C1O[C]1F(3092)'],
    products = ['O=C(OF)C1OC1F(3070)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](OF)C1O[C]1F(3093)'],
    products = ['O=C(OF)C1OC1F(3070)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(OF)C1[CH]O1(3095)'],
    products = ['O=C(OF)C1OC1F(3070)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(=O)C1OC1F(3096)'],
    products = ['O=C(OF)C1OC1F(3070)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(203)', 'O=[C]C1OC1F(3097)'],
    products = ['O=C(OF)C1OC1F(3070)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]OF(142)', 'FC1[CH]O1(2719)'],
    products = ['O=C(OF)C1OC1F(3070)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', 'O=C(OF)[C]1OC1F(3098)'],
    products = ['O=C(OF)C1OC1F(3070)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(6)', 'O=C(OF)C1O[C]1F(3099)'],
    products = ['O=C(OF)C1OC1F(3070)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(OF)C1=CO1(3085)'],
    products = ['O=C(OF)C1OC1F(3070)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=C(OF)C1OC1F(3070)'],
    products = ['F2(77)', 'CO2(14)', 'C1=CO1(3003)'],
