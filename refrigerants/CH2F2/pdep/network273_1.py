...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.12465,'amu*angstrom^2'), symmetry=1, barrier=(48.8498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473995,'amu*angstrom^2'), symmetry=1, barrier=(10.8981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12454,'amu*angstrom^2'), symmetry=1, barrier=(48.8474,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
