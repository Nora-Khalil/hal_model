...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]OC(F)F(133)'],
    products = ['[O]OC(F)(F)C=O(708)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OF(124)', 'O=C[C]F-2(818)'],
    products = ['[O]OC(F)(F)C=O(708)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]O[C](F)C=O(2071)'],
    products = ['[O]OC(F)(F)C=O(708)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(165)', 'HCO(15)'],
    products = ['[O]OC(F)(F)C=O(708)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(F)(F)[C]=O(2072)'],
    products = ['[O]OC(F)(F)C=O(708)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O]OC(F)=C=O(2073)'],
    products = ['[O]OC(F)(F)C=O(708)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F(37)', 'O=COO[C]F(4390)'],
    products = ['O=COO[C](F)F(3821)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[C]F(130)', '[O]OC=O(704)'],
    products = ['O=COO[C](F)F(3821)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[O][C](F)F(237)', '[O]C=O(141)'],
    products = ['O=COO[C](F)F(3821)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(5)', 'O=[C]OO[C](F)F(233)'],
    products = ['O=COO[C](F)F(3821)'],
...
reaction(
    label = 'reaction34',
    reactants = ['F(37)', 'O=CO[O+]=[C-]F(3486)'],
    products = ['O=COO[C](F)F(3821)'],
