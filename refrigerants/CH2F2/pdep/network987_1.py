...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]OC(F)(F)F(422)'],
    products = ['[O]OOOC(F)(F)F(2286)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]OOC(F)(F)F(2329)'],
    products = ['[O]OOOC(F)(F)F(2286)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOOC(F)(F)F(2286)'],
    products = ['[O-][O+]=O(199)', 'CF3O(47)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]OOO[C](F)F(202)'],
    products = ['[O]OOOC(F)(F)F(2286)'],
    transitionState = 'TS5',
