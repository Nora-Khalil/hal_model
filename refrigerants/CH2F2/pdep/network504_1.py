...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(183)', 'CH2(T)(18)'],
    products = ['[CH2]OO[C]=O(1338)'],
    transitionState = 'TS2',
