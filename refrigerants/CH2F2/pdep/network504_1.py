...
reaction(
    label = 'reaction2',
    reactants = ['[O]OC(F)(F)F(433)', 'CH2(S)(25)'],
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]OC[C](F)F(1123)'],
    products = ['[O]OCC(F)(F)F(649)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[O]O[CH]C(F)(F)F(929)'],
    products = ['[O]OCC(F)(F)F(649)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', '[O]OC=C(F)F(660)'],
    products = ['[O]OCC(F)(F)F(649)'],
    transitionState = 'TS9',
