...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](126)', 'O=C[C]F(3123)'],
    products = ['[O]OO[C](F)C=O(3264)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OOC(F)=C=O(4784)'],
    products = ['[O]OO[C](F)C=O(3264)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]O[O](126)', 'O=C[C]F-2(818)'],
    products = ['[O]OO[C](F)C=O(3264)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(6)', '[CH]=C(F)OO[O](2787)'],
    products = ['[O]OO[C](F)C=O(3264)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', '[O]OO[C]=C=O(4789)'],
    products = ['[O]OO[C](F)C=O(3264)'],
