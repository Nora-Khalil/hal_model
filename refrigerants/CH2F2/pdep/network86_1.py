...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC1(F)[CH]O1(1024)'],
    products = ['FC1OC1(F)F(275)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'F[C]1OC1(F)F(1026)'],
    products = ['FC1OC1(F)F(275)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1=C(F)O1(1028)'],
    products = ['FC1OC1(F)F(275)'],
