...
species(
    label = 'F[C](F)O[C](F)C(F)(F)F(2409)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC(F)(F)[C](F)F(2394)'],
...
reaction(
    ...
    products = ['F[C](F)OC(F)(F)[C](F)F(2394)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', 'F[C](F)O[C](F)F(269)'],
    products = ['F[C](F)OC(F)(F)[C](F)F(2394)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C](F)OC(F)=C(F)F(499)'],
    products = ['F[C](F)OC(F)(F)[C](F)F(2394)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(42)', 'F[C](F)O[C](F)F(269)'],
    products = ['F[C](F)OC(F)(F)[C](F)F(2394)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)OC(F)(F)[C](F)F(2394)'],
    products = ['F[C](F)O[C](F)C(F)(F)F(2409)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)OC(F)(F)[C](F)F(2394)'],
    products = ['F[C](F)[C](F)OC(F)(F)F(2410)'],
