...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(O)F(696)'],
    products = ['HO2(11)', 'CHFO(46)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[O]C(O)F(864)'],
    products = ['[O]OC(O)F(696)'],
    transitionState = 'TS2',
