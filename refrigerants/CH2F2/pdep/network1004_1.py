...
reaction(
    label = 'reaction4',
    reactants = ['H(6)', '[CH]=C(F)C#CF(2623)'],
    products = ['[CH]=C(F)C=[C]F(2496)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', '[CH]=C=C=[C]F(2625)'],
    products = ['[CH]=C(F)C=[C]F(2496)'],
    transitionState = 'TS7',
