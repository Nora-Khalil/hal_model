...
reaction(
    label = 'reaction4',
    reactants = ['OF(147)', 'O=[C]C(=O)OF(414)'],
    products = ['[O]C(F)(OF)C(=O)O(4954)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['O(6)', 'O=C(O)[C](F)OF(353)'],
    products = ['[O]C(F)(OF)C(=O)O(4954)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(125)', 'O=C(O)C(=O)F(358)'],
    products = ['[O]C(F)(OF)C(=O)O(4954)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(F)OF(151)', 'O=[C]O(161)'],
    products = ['[O]C(F)(OF)C(=O)O(4954)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C([O])(F)C(=O)O(2363)'],
    products = ['[O]C(F)(OF)C(=O)O(4954)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(125)', '[O][C](F)C(=O)O(741)'],
    products = ['[O]C(F)(OF)C(=O)O(4954)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', '[O]C(F)([C]=O)OF(4979)'],
    products = ['[O]C(F)(OF)C(=O)O(4954)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(=O)C([O])(F)OF(4980)'],
    products = ['[O]C(F)(OF)C(=O)O(4954)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O][C](F)OF(149)', 'O=[C]O(161)'],
    products = ['[O]C(F)(OF)C(=O)O(4954)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', '[O]C(=O)C(=O)O(413)'],
    products = ['[O]C(F)(OF)C(=O)O(4954)'],
