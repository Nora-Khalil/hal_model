...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F-2(2868)', '[C]=C(4710)'],
    products = ['[CH]=C(F)O[C]=C(4841)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[CH]=C(F)OC#C(4218)'],
    products = ['[CH]=C(F)O[C]=C(4841)'],
    transitionState = 'TS7',
