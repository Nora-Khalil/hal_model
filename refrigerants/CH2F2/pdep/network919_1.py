...
reaction(
    label = 'reaction1',
    reactants = ['[OH2+][C-](F)OC(F)(F)F(2180)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[OH2+][C-](F)OF(2186)'],
    products = ['[OH2+][C-](F)OC(F)(F)F(2180)'],
    transitionState = 'TS2',
