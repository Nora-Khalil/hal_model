...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09554,0.0444917,-6.12345e-05,4.8371e-08,-1.52755e-11,-28501.7,16.784], Tmin=(100,'K'), Tmax=(867.076,'K')), NASAPolynomial(coeffs=[7.01798,0.0175594,-7.33541e-06,1.31124e-09,-8.70529e-14,-29196.6,-5.34617], Tmin=(867.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)OsHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42148,0.0297309,-1.3141e-05,-2.46618e-09,2.58559e-12,1427.72,18.7185], Tmin=(100,'K'), Tmax=(1078.39,'K')), NASAPolynomial(coeffs=[8.70211,0.0156016,-6.23876e-06,1.14956e-09,-8.00753e-14,-459.907,-14.5273], Tmin=(1078.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ) + radical(C=COJ)"""),
)

species(
    label = 'O=[C]C[CH]O(5196)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82492,0.05439,-9.35845e-05,8.42527e-08,-2.8682e-11,-2681.18,20.2698], Tmin=(100,'K'), Tmax=(890.615,'K')), NASAPolynomial(coeffs=[6.29006,0.0191607,-8.69187e-06,1.57495e-09,-1.03596e-13,-2874.69,2.62419], Tmin=(890.615,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.8922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCsJOH) + radical(CCCJ=O)"""),
)

species(
    label = '[O][CH]CC=O(5197)',
    structure = adjacencyList("""multiplicity 3
1 O u1 p2 c0 {4,S}
2 O u0 p2 c0 {5,D}
3 C u0 p0 c0 {4,S} {5,S} {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25161,0.0488099,-9.15015e-05,9.63605e-08,-3.73636e-11,5206.94,18.7785], Tmin=(100,'K'), Tmax=(859.637,'K')), NASAPolynomial(coeffs=[0.717782,0.0305548,-1.53407e-05,2.93506e-09,-2.00608e-13,6408.85,31.4033], Tmin=(859.637,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.8524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'O=[C][CH]CO(5198)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26833,0.0406713,-5.4552e-05,4.34987e-08,-1.40917e-11,-335.571,21.6263], Tmin=(100,'K'), Tmax=(838.608,'K')), NASAPolynomial(coeffs=[6.32204,0.0179152,-7.7301e-06,1.41275e-09,-9.5346e-14,-895.184,3.50016], Tmin=(838.608,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.28798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(187)', '[CH2]C[O](1702)'],
    products = ['[O]CC[C]=O(4826)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2O(20)', '[CH2][C]=O(3543)'],
    products = ['[O]CC[C]=O(4826)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][O](1455)', '[CH2][C]=O(3543)'],
    products = ['[O]CC[C]=O(4826)'],
