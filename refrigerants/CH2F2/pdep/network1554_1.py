...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(185)', '[CH]C-2(1597)'],
    products = ['C[CH]OC([O])=O(4433)'],
    transitionState = 'TS2',
