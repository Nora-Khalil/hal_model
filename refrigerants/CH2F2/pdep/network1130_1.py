...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.134592,'amu*angstrom^2'), symmetry=1, barrier=(12.6949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24625,'amu*angstrom^2'), symmetry=1, barrier=(51.6456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.054,'amu'),
...
"""),
    E0 = (-109.064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([161,297,490,584,780,1358,540,610,2055,3120,650,792.5,1650,413.641,414.396,414.398,415.167],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60357,0.0563225,-8.58563e-05,6.93274e-08,-2.21455e-11,-13034.5,21.719], Tmin=(100,'K'), Tmax=(803.069,'K')), NASAPolynomial(coeffs=[9.25063,0.0163379,-7.63136e-06,1.45013e-09,-9.99321e-14,-14201.6,-13.116], Tmin=(803.069,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-109.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-F1sCdd)(F1s)(F1s)) + radical(C=C=CJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0970238,'amu*angstrom^2'), symmetry=1, barrier=(2.23077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.56774,'amu*angstrom^2'), symmetry=1, barrier=(59.0375,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.339208,'amu*angstrom^2'), symmetry=1, barrier=(7.79907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.29059,'amu*angstrom^2'), symmetry=1, barrier=(75.6572,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
...
"""),
    ...
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.705112,0.0792601,-0.000132136,1.14164e-07,-3.86214e-11,-44985.7,24.243], Tmin=(100,'K'), Tmax=(808.334,'K')), NASAPolynomial(coeffs=[10.5352,0.022463,-1.16092e-05,2.28158e-09,-1.59433e-13,-46308.6,-19.4422], Tmin=(808.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = 'FC=[C]C(F)[C](F)F(2599)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH]C(F)=CF(2603)'],
    products = ['[CH]=C(F)C(F)[C](F)F(2551)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)C=C(F)F(2606)'],
    products = ['[CH]=C(F)C(F)[C](F)F(2551)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C(F)=C(F)F(2607)'],
    products = ['[CH]=C(F)C(F)[C](F)F(2551)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CC(F)[C](F)F(2608)'],
    products = ['[CH]=C(F)C(F)[C](F)F(2551)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', '[CH]=C=C[C](F)F(2609)'],
    products = ['[CH]=C(F)C(F)[C](F)F(2551)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH]=C=C(F)[C](F)F(2610)'],
    products = ['[CH]=C(F)C(F)[C](F)F(2551)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(42)', '[CH]C(F)=CF(2603)'],
    products = ['[CH]=C(F)C(F)[C](F)F(2551)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C(F)[C](F)F(2551)'],
    products = ['[CH2]C(F)=C(F)[C](F)F(1089)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(F)C(F)[C](F)F(2551)'],
    products = ['[CH]=[C]C(F)C(F)(F)F(2613)'],
