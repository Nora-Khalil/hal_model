...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(162)', '[O]O[CH]F(126)'],
    products = ['[O]OC(F)[C](F)F(452)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', '[O]OC(F)=C(F)F(439)'],
    products = ['[O]OC(F)[C](F)F(452)'],
    transitionState = 'TS9',
