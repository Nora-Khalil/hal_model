...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(187)', '[O]C[C]=O(1617)'],
    products = ['O=[C]CO[C]=O(4688)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(187)', '[CH2]O[C]=O(1168)'],
    products = ['O=[C]CO[C]=O(4688)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[C]=O(1168)'],
    products = ['O=[C]CO[C]=O(4688)'],
    transitionState = 'TS6',
