...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CO[C](F)F(1353)'],
    products = ['CC([O])O[C](F)F(2480)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', 'CC([O])[O](2501)'],
    products = ['CC([O])O[C](F)F(2480)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C[CH]O[C](F)F(1994)'],
    products = ['CC([O])O[C](F)F(2480)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', 'O=CO[C](F)F(333)'],
    products = ['CC([O])O[C](F)F(2480)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'CC(=O)O[C](F)F(2503)'],
    products = ['CC([O])O[C](F)F(2480)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(O)O[C](F)F(2506)'],
    products = ['CC([O])O[C](F)F(2480)'],
