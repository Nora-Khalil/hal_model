...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[O+]=[C-]O(4506)'],
    products = ['CO(13)', 'O=C(O)F(140)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O[C-]=[O+]F(4509)'],
    products = ['O=C(F)[O+]=[C-]O(4506)'],
    transitionState = 'TS2',
