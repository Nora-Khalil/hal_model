...
reaction(
    label = 'reaction2',
    reactants = ['O=C=C(O)OOF(408)'],
    products = ['O=C(O)C(=O)OF(401)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(=O)C(=O)OF(415)'],
    products = ['O=C(O)C(=O)OF(401)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(125)', 'O=[C]C(=O)O(416)'],
    products = ['O=C(O)C(=O)OF(401)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OF(146)', 'O=[C]O(161)'],
    products = ['O=C(O)C(=O)OF(401)'],
