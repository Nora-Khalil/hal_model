...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(O)(F)O[C](F)F(2343)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[O]C([O])(O)F(2351)'],
    products = ['[O]C(O)(F)O[C](F)F(2343)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(O)O[C](F)F(373)'],
    products = ['[O]C(O)(F)O[C](F)F(2343)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'O=C(F)O[C](F)F(271)'],
    products = ['[O]C(O)(F)O[C](F)F(2343)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(42.3457,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[O]C(=O)O[C](F)F(231)'],
    products = ['[O]C(O)(F)O[C](F)F(2343)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[O]C([O])(O)F(2351)'],
    products = ['[O]C(O)(F)O[C](F)F(2343)'],
...
network(
    label = 'PDepNetwork #1041',
    isomers = [
        '[O]C(O)(F)O[C](F)F(2343)',
    ],
    reactants = [
        ('CF2O(48)', 'O=C(O)F(140)'),
    ],
