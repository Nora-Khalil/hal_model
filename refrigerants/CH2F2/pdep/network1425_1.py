...
species(
    label = 'O=C(F)[CH]O[CH]C(F)F(3723)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC[C](F)F(3692)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F-2(3116)', '[O]C[C](F)F(974)'],
    products = ['O=C(F)[CH]OC[C](F)F(3692)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH2]O[CH]C(=O)F(2999)'],
    products = ['O=C(F)[CH]OC[C](F)F(3692)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OC[C](F)F(3692)'],
    products = ['F[C](F)COC1O[C]1F(3719)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)[CH]OC[C](F)F(3692)'],
    products = ['[O]C1(F)[CH]OCC1(F)F(3721)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(F)[CH]OC=C(F)F(3531)'],
    products = ['O=C(F)[CH]OC[C](F)F(3692)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C=COC[C](F)F(3722)'],
    products = ['O=C(F)[CH]OC[C](F)F(3692)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(42)', '[CH2]O[CH]C(=O)F(2999)'],
    products = ['O=C(F)[CH]OC[C](F)F(3692)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]OC[C](F)F(3692)'],
    products = ['O=C(F)[CH]O[CH]C(F)F(3723)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(F)CO[CH][C](F)F(3724)'],
    products = ['O=C(F)[CH]OC[C](F)F(3692)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)C[C](F)F(3691)'],
    products = ['O=C(F)[CH]OC[C](F)F(3692)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(6)', 'F[C]=COC[C](F)F(3726)'],
    products = ['O=C(F)[CH]OC[C](F)F(3692)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(F)[CH]OC[C](F)F(3692)'],
    products = ['[O][C](F)C1OCC1(F)F(3729)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)=[C]OC[C](F)F(3730)'],
    products = ['O=C(F)[CH]OC[C](F)F(3692)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)=[C]OCC(F)F(3731)'],
    products = ['O=C(F)[CH]OC[C](F)F(3692)'],
...
reaction(
    label = 'reaction27',
    reactants = ['OC(F)=CO[CH][C](F)F(3732)'],
    products = ['O=C(F)[CH]OC[C](F)F(3692)'],
