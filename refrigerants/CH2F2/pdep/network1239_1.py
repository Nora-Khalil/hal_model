...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C1O[C]1F(2793)'],
    products = ['CF2O(48)', 'FC1=CO1(1231)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)C1O[C]1F(2793)'],
    products = ['[O]C1(F)O[C](F)C1F(2835)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)(F)C1(F)[CH]O1(2792)'],
    products = ['[O]C(F)(F)C1O[C]1F(2793)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C1O[C]1F(2836)'],
    products = ['[O]C(F)(F)C1O[C]1F(2793)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(F)C1O[C]1F(2793)'],
    products = ['FC1(F)OC2(F)OC12(2796)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)C1O[C]1F(2793)'],
    products = ['OC(F)(F)C1=C(F)O1(2837)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(237)', 'FC1=CO1(1231)'],
    products = ['[O]C(F)(F)C1O[C]1F(2793)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C1=C(F)O1(2839)'],
    products = ['[O]C(F)(F)C1O[C]1F(2793)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C(F)C1O[C]1F(2840)'],
    products = ['[O]C(F)(F)C1O[C]1F(2793)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2O(48)', 'F[C]1[CH]O1(2828)'],
    products = ['[O]C(F)(F)C1O[C]1F(2793)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)F(237)', 'F[C]1[CH]O1(2828)'],
    products = ['[O]C(F)(F)C1O[C]1F(2793)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)[C]1O[C]1F(2841)'],
    products = ['[O]C(F)(F)C1O[C]1F(2793)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)(F)C1O[C]1F(2793)'],
    products = ['OC(F)(F)[C]1O[C]1F(2843)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FO[C](F)C1O[C]1F(2844)'],
    products = ['[O]C(F)(F)C1O[C]1F(2793)'],
...
network(
    label = 'PDepNetwork #1239',
    isomers = [
        '[O]C(F)(F)C1O[C]1F(2793)',
    ],
    reactants = [
        ('CF2O(48)', 'FC1=CO1(1231)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
