...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.928578,'amu*angstrom^2'), symmetry=1, barrier=(21.3498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40288,'amu*angstrom^2'), symmetry=1, barrier=(32.255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.927602,'amu*angstrom^2'), symmetry=1, barrier=(21.3274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.931262,'amu*angstrom^2'), symmetry=1, barrier=(21.4116,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.313777,0.104361,-0.000177198,1.55409e-07,-5.35074e-11,-126355,30.4425], Tmin=(100,'K'), Tmax=(797.797,'K')), NASAPolynomial(coeffs=[12.173,0.0303546,-1.66179e-05,3.31196e-09,-2.32989e-13,-127984,-24.7045], Tmin=(797.797,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1051.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.33488,'amu*angstrom^2'), symmetry=1, barrier=(30.6914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33499,'amu*angstrom^2'), symmetry=1, barrier=(30.6941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33702,'amu*angstrom^2'), symmetry=1, barrier=(30.7408,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.579386,0.0817732,-0.00013883,1.18123e-07,-3.94332e-11,-58966.5,22.8219], Tmin=(100,'K'), Tmax=(776.733,'K')), NASAPolynomial(coeffs=[12.0176,0.0191885,-1.08609e-05,2.18717e-09,-1.54701e-13,-60632.4,-28.7563], Tmin=(776.733,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-491.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH)"""),
)
...
"""),
    E0 = (-810.262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,197,221,431,657,2120,512.5,787.5,370.541,372.911,373.578,1436.11],'cm^-1')),
        HinderedRotor(inertia=(0.131015,'amu*angstrom^2'), symmetry=1, barrier=(12.6658,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282052,'amu*angstrom^2'), symmetry=1, barrier=(27.4105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27931,0.0612459,-7.63617e-05,4.67739e-08,-1.12498e-11,-97355.1,22.0924], Tmin=(100,'K'), Tmax=(1016.61,'K')), NASAPolynomial(coeffs=[13.1828,0.0144096,-7.25457e-06,1.45489e-09,-1.05099e-13,-99775.4,-35.531], Tmin=(1016.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-810.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsFFHO) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'FOC=C(OF)OC(F)F(3985)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {7,S}
4  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.519521,0.104563,-0.000158645,1.17331e-07,-3.36899e-11,-77424.1,30.2237], Tmin=(100,'K'), Tmax=(859.92,'K')), NASAPolynomial(coeffs=[17.8274,0.0192187,-9.77263e-06,1.91284e-09,-1.34369e-13,-80579.5,-55.5203], Tmin=(859.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-645.056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(O2sCF) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsOsH)"""),
)

species(
    label = 'FOC(F)=COOC(F)F(3986)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.2147,'amu*angstrom^2'), symmetry=1, barrier=(4.93637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217161,'amu*angstrom^2'), symmetry=1, barrier=(4.99296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17238,'amu*angstrom^2'), symmetry=1, barrier=(49.9472,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.15852,'amu*angstrom^2'), symmetry=1, barrier=(26.6367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15722,'amu*angstrom^2'), symmetry=1, barrier=(26.6068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15687,'amu*angstrom^2'), symmetry=1, barrier=(26.5987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15891,'amu*angstrom^2'), symmetry=1, barrier=(26.6456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
...
"""),
    ...
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.445094,0.115729,-0.000226449,2.19489e-07,-7.97524e-11,-84597.7,33.473], Tmin=(100,'K'), Tmax=(849.108,'K')), NASAPolynomial(coeffs=[7.34339,0.0395732,-2.2197e-05,4.3852e-09,-3.03594e-13,-84497.7,5.5496], Tmin=(849.108,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsOsHH) + group(CsFFHO) + radical(CCOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'O[CH]C(F)(OF)O[C](F)F(3989)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.528812,'amu*angstrom^2'), symmetry=1, barrier=(20.3921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.528815,'amu*angstrom^2'), symmetry=1, barrier=(20.3921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.528814,'amu*angstrom^2'), symmetry=1, barrier=(20.3921,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0511222,0.0867753,-0.000113516,6.99396e-08,-1.6483e-11,-79399.9,27.4778], Tmin=(100,'K'), Tmax=(1051.4,'K')), NASAPolynomial(coeffs=[20.0132,0.0104407,-4.61058e-06,8.84477e-10,-6.30135e-14,-83619,-70.3264], Tmin=(1051.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-661.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)

species(
    label = 'O=CC(F)(OF)O[CH]F(3991)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.31461,'amu*angstrom^2'), symmetry=1, barrier=(30.2254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.836118,'amu*angstrom^2'), symmetry=1, barrier=(19.224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29706,'amu*angstrom^2'), symmetry=1, barrier=(29.8219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.835525,'amu*angstrom^2'), symmetry=1, barrier=(19.2104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0059189,0.0985684,-0.000175531,1.58396e-07,-5.52047e-11,-74514.1,28.6393], Tmin=(100,'K'), Tmax=(824.334,'K')), NASAPolynomial(coeffs=[10.8013,0.0284366,-1.57245e-05,3.12027e-09,-2.1791e-13,-75694.8,-17.7655], Tmin=(824.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-620.661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFHHO) + group(Cds-OdCsH) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = '[O]C(F)(C=O)OC(F)F(3992)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.511885,'amu*angstrom^2'), symmetry=1, barrier=(11.7692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.512965,'amu*angstrom^2'), symmetry=1, barrier=(11.7941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50338,'amu*angstrom^2'), symmetry=1, barrier=(34.5657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363548,0.0895466,-0.000155914,1.40607e-07,-4.90718e-11,-113242,28.6203], Tmin=(100,'K'), Tmax=(829.902,'K')), NASAPolynomial(coeffs=[9.49355,0.0286121,-1.51796e-05,2.97351e-09,-2.0643e-13,-114175,-10.212], Tmin=(829.902,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-942.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(C=OCOJ)"""),
)
...
"""),
    E0 = (-838.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,280,501,1494,1531,2782.5,750,1395,475,1775,1000,180,180,1702.26],'cm^-1')),
        HinderedRotor(inertia=(2.30713,'amu*angstrom^2'), symmetry=1, barrier=(53.0454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.420177,'amu*angstrom^2'), symmetry=1, barrier=(9.6607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.31192,'amu*angstrom^2'), symmetry=1, barrier=(53.1555,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44408,0.0622344,-9.38883e-05,8.40279e-08,-3.07311e-11,-100776,23.4352], Tmin=(100,'K'), Tmax=(768.732,'K')), NASAPolynomial(coeffs=[6.27116,0.0295329,-1.52801e-05,3.02247e-09,-2.1346e-13,-101294,2.87444], Tmin=(768.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-838.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(CsCOF1sO2s)"""),
)
...
"""),
    E0 = (-723.414,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,519,593,830,1115,1166,1389,1413,3114,482,586,761,1411,180,180,180,3153.92],'cm^-1')),
        HinderedRotor(inertia=(1.67161,'amu*angstrom^2'), symmetry=1, barrier=(38.4337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.529811,'amu*angstrom^2'), symmetry=1, barrier=(12.1814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67924,'amu*angstrom^2'), symmetry=1, barrier=(38.6091,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24775,0.065953,-9.77813e-05,7.55622e-08,-2.33841e-11,-86912.4,24.0991], Tmin=(100,'K'), Tmax=(789.532,'K')), NASAPolynomial(coeffs=[10.2725,0.0202313,-1.09167e-05,2.21544e-09,-1.59373e-13,-88337.5,-17.3072], Tmin=(789.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-723.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sO2sO2s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.579814,'amu*angstrom^2'), symmetry=1, barrier=(13.3311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.577818,'amu*angstrom^2'), symmetry=1, barrier=(13.2852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49411,'amu*angstrom^2'), symmetry=1, barrier=(34.3525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50118,'amu*angstrom^2'), symmetry=1, barrier=(34.5152,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.294838,0.106601,-0.000195568,1.78747e-07,-6.26298e-11,-100883,31.533], Tmin=(100,'K'), Tmax=(830.452,'K')), NASAPolynomial(coeffs=[11.1343,0.0295775,-1.6755e-05,3.33867e-09,-2.33099e-13,-102024,-16.9207], Tmin=(830.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-839.979,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'O=[C]C(F)(OF)OC(F)F(3996)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.975199,'amu*angstrom^2'), symmetry=1, barrier=(22.4217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44637,'amu*angstrom^2'), symmetry=1, barrier=(33.255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.97823,'amu*angstrom^2'), symmetry=1, barrier=(22.4914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.968343,'amu*angstrom^2'), symmetry=1, barrier=(22.2641,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.288476,0.105032,-0.000187819,1.68277e-07,-5.82732e-11,-107754,31.0295], Tmin=(100,'K'), Tmax=(819.598,'K')), NASAPolynomial(coeffs=[12.0354,0.0279617,-1.5793e-05,3.1544e-09,-2.21004e-13,-109206,-22.5063], Tmin=(819.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-897.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80952,0.0540566,-6.219e-05,4.26286e-08,-1.28135e-11,-109487,22.5868], Tmin=(100,'K'), Tmax=(782.542,'K')), NASAPolynomial(coeffs=[6.52576,0.0299494,-1.59807e-05,3.26186e-09,-2.3696e-13,-110225,0.990077], Tmin=(782.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-910.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsFFHO) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H)"""),
)

species(
    label = 'O=C=C(OF)OC(F)F(3998)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
4  O u0 p2 c0 {7,S} {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FOC(F)OC(F)F(884)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'O=CC(O)(F)OF(3982)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'O=CC(F)(OF)OF(3983)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OC(F)F(229)', 'O=C=C(F)OF(349)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(147)', 'O=C=C(F)OC(F)F(3984)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOC=C(OF)OC(F)F(3985)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['FOOC=C(F)OC(F)F(3987)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]CC(F)(OF)O[C](F)F(3988)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O[CH]C(F)(OF)O[C](F)F(3989)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C=C(OF)OC(F)F(3990)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=CC(F)(OF)O[CH]F(3991)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)(C=O)OC(F)F(3992)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)F(164)', 'O=C[C](F)OF(3262)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(81)', '[O]C(F)(C=O)OF(3993)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(125)', 'O=C[C](F)OC(F)F(3994)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HCO(15)', 'FO[C](F)OC(F)F(298)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O=CC(F)(OF)O[C](F)F(3995)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=[C]C(F)(OF)OC(F)F(3996)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=CC(F)(OF)OC(F)F(3961)'],
    products = ['CF2O(48)', 'OC=C(F)OF(910)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(77)', 'O=CC(=O)OC(F)F(3997)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C=C(OF)OC(F)F(3998)'],
    products = ['O=CC(F)(OF)OC(F)F(3961)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=CC(F)(OF)OC(F)F(3961)'],
    products = ['F2(77)', 'CHFO(46)', 'O=CC(=O)F(711)'],
