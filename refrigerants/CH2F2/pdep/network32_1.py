...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])=C=O(191)'],
    products = ['[O]C(=O)C([O])=O(169)'],
    transitionState = 'TS2',
