...
reaction(
    label = 'reaction1',
    reactants = ['OOOC[C](F)F(1479)'],
    products = ['HO2(11)', 'FC1(F)CO1(1188)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'OOOC[C]F(1525)'],
    products = ['OOOC[C](F)F(1479)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(162)', '[CH2]OOO(1526)'],
    products = ['OOOC[C](F)F(1479)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(11)', '[O]C[C](F)F(1144)'],
    products = ['OOOC[C](F)F(1479)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', '[O]OC[C](F)F(1123)'],
    products = ['OOOC[C](F)F(1479)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[O]OOC[C](F)F(1458)'],
    products = ['OOOC[C](F)F(1479)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'OOO[CH][C](F)F(1465)'],
    products = ['OOOC[C](F)F(1479)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'OOOC[C]F-2(1527)'],
    products = ['OOOC[C](F)F(1479)'],
...
network(
    label = 'PDepNetwork #560',
    isomers = [
        'OOOC[C](F)F(1479)',
    ],
    reactants = [
        ('HO2(11)', 'FC1(F)CO1(1188)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
