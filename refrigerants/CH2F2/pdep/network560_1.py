...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(142)', 'CH2OH(33)'],
    products = ['O=C(F)OCO(1482)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]OC(=O)F(1387)'],
    products = ['O=C(F)OCO(1482)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[CH]O(1306)'],
    products = ['O=C(F)OCO(1482)'],
