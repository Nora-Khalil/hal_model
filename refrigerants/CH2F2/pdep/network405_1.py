...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(184)', '[CH2]C([O])(F)F(975)'],
    products = ['[CH2]C(F)(F)O[C]=O(987)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[C](F)F(238)'],
    products = ['[CH2]C(F)(F)O[C]=O(987)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[CH2]C([O])(F)F(975)'],
    products = ['[CH2]C(F)(F)O[C]=O(987)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[C]=O(1035)'],
    products = ['[CH2]C(F)(F)O[C]=O(987)'],
    transitionState = 'TS7',
