...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]=C(F)C#CF(2722)'],
    products = ['[CH]=C(F)C=[C]F(2666)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', '[CH]=C=C=[C]F(2724)'],
    products = ['[CH]=C(F)C=[C]F(2666)'],
    transitionState = 'TS7',
