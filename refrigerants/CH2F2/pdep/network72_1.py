...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[O]C([O])=O(185)'],
    products = ['[O]C(=O)O[C](F)F(231)'],
    transitionState = 'TS2',
