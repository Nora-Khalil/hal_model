...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[O]C(F)(F)[CH]F(474)'],
    products = ['[O]C(F)C([O])(F)F(701)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)C=O(747)'],
    products = ['[O]C(F)C([O])(F)F(701)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[O]C(F)(F)C(=O)F(271)'],
    products = ['[O]C(F)C([O])(F)F(701)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)C(=O)F(748)'],
    products = ['[O]C(F)C([O])(F)F(701)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(249)', '[O][CH]F(127)'],
    products = ['[O]C(F)C([O])(F)F(701)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', '[O][CH]C(=O)F(749)'],
    products = ['[O]C(F)C([O])(F)F(701)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O][C](F)C(=O)F(272)'],
    products = ['[O]C(F)C([O])(F)F(701)'],
