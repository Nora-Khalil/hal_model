...
reaction(
    label = 'reaction3',
    reactants = ['OF(147)', 'O=C(O)[C]F(348)'],
    products = ['O=C(O)C(F)OF(1265)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'O=C=C(F)OF(349)'],
    products = ['O=C(O)C(F)OF(1265)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(O)[CH]OF(1298)'],
    products = ['O=C(O)C(F)OF(1265)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(=O)O(1299)'],
    products = ['O=C(O)C(F)OF(1265)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(125)', 'O=C(O)[CH]F(830)'],
    products = ['O=C(O)C(F)OF(1265)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'O=[C]C(F)OF(1300)'],
    products = ['O=C(O)C(F)OF(1265)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(F)OF(1301)'],
    products = ['O=C(O)C(F)OF(1265)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(717)', 'O=[C]O(161)'],
    products = ['O=C(O)C(F)OF(1265)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)[C](F)OF(353)'],
    products = ['O=C(O)C(F)OF(1265)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(O)C(=O)F(358)'],
    products = ['O=C(O)C(F)OF(1265)'],
