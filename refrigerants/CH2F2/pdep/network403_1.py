...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][C](F)C(=O)OF(1045)'],
    products = ['[CH2]C(F)(F)C([O])=O(985)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C(=O)[C](F)F(247)'],
    products = ['[CH2]C(F)(F)C([O])=O(985)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=O(1046)'],
    products = ['[CH2]C(F)(F)C([O])=O(985)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C([O])=O(985)'],
    products = ['[CH2]C(F)(F)[C]1OO1(1047)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C([O])=O(1049)'],
    products = ['[CH2]C(F)(F)C([O])=O(985)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CO2(14)', '[CH2][C](F)F(933)'],
    products = ['[CH2]C(F)(F)C([O])=O(985)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(145)', '[CH2][C](F)F(933)'],
    products = ['[CH2]C(F)(F)C([O])=O(985)'],
