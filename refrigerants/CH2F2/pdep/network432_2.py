...
reaction(
    label = 'reaction1',
    reactants = ['CF2(42)', 'CH2CF2(56)'],
    products = ['FC(F)=CC(F)F(471)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['HF(38)', 'F[C]C=C(F)F(1316)'],
    products = ['FC(F)=CC(F)F(471)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FC(F)=CC(F)F(471)'],
    products = ['FC=CC(F)(F)F(1317)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]C=C(F)F(601)'],
    products = ['FC(F)=CC(F)F(471)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C]=CC(F)F(1318)'],
    products = ['FC(F)=CC(F)F(471)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C](F)C=C(F)F(603)'],
    products = ['FC(F)=CC(F)F(471)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC(F)=[C]C(F)F(1319)'],
    products = ['FC(F)=CC(F)F(471)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'FC=C=C(F)F(1321)'],
    products = ['FC(F)=CC(F)F(471)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'FC#CC(F)F(1322)'],
    products = ['FC(F)=CC(F)F(471)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(42)', '[CH]C(F)F-2(973)'],
    products = ['FC(F)=CC(F)F(471)'],
