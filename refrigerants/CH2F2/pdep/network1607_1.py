...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)O[C](F)C=O(4518)'],
...
reaction(
    ...
    products = ['[CH]=C(F)O[C](F)C=O(4518)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=C(F)O[C](F)C=O(4518)'],
    products = ['[CH]=C(F)OC1(F)[CH]O1(4589)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CO[C](F)C=O(4590)'],
    products = ['[CH]=C(F)O[C](F)C=O(4518)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(F)OC(F)=C=O(4591)'],
    products = ['[CH]=C(F)O[C](F)C=O(4518)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C[C]F-2(818)', '[CH]C(=O)F-2(3116)'],
    products = ['[CH]=C(F)O[C](F)C=O(4518)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(F)OC(F)[C]=O(4592)'],
    products = ['[CH]=C(F)O[C](F)C=O(4518)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]OC(F)(F)C=O(4594)'],
    products = ['[CH]=C(F)O[C](F)C=O(4518)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(F)C([O])C(=O)F(4515)'],
    products = ['[CH]=C(F)O[C](F)C=O(4518)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(6)', '[CH]=C(F)OC(=[CH])F(4595)'],
    products = ['[CH]=C(F)O[C](F)C=O(4518)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(F)O[C](F)C=O(4518)'],
    products = ['[O][CH]C1(F)C=C(F)O1(4596)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C(F)OC(F)=[C]O(4598)'],
    products = ['[CH]=C(F)O[C](F)C=O(4518)'],
