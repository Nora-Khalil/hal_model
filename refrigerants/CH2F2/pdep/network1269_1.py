...
"""),
    E0 = (-1451.19,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,431,527,613,668,835,1199,1245,1322,486,617,768,1157,1926,264.032,264.069,1972.5,1972.57],'cm^-1')),
        HinderedRotor(inertia=(0.195072,'amu*angstrom^2'), symmetry=1, barrier=(9.65157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.534085,'amu*angstrom^2'), symmetry=1, barrier=(26.4606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194786,'amu*angstrom^2'), symmetry=1, barrier=(9.65088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195575,'amu*angstrom^2'), symmetry=1, barrier=(9.6521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.605274,0.0812782,-0.000112568,8.3163e-08,-2.49006e-11,-174421,31.5443], Tmin=(100,'K'), Tmax=(811.704,'K')), NASAPolynomial(coeffs=[11.3203,0.0284752,-1.49893e-05,3.01991e-09,-2.16928e-13,-176161,-17.9143], Tmin=(811.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1451.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsFFFO) + group(COCsFO)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.86771,0.0228707,-2.2339e-05,1.13145e-08,-2.26468e-12,-19887.6,11.2463], Tmin=(100,'K'), Tmax=(1217.44,'K')), NASAPolynomial(coeffs=[7.78054,0.0067292,-2.4511e-06,4.23933e-10,-2.82988e-14,-21083.9,-13.4219], Tmin=(1217.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), label="""hydroxyketene""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.974069,'amu*angstrom^2'), symmetry=1, barrier=(22.3958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.975393,'amu*angstrom^2'), symmetry=1, barrier=(22.4262,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.399133,0.0648265,-7.52065e-05,3.93816e-08,-7.60126e-12,-102740,23.6366], Tmin=(100,'K'), Tmax=(1445.83,'K')), NASAPolynomial(coeffs=[20.5573,-5.50773e-05,1.56004e-06,-3.74331e-10,2.67424e-14,-107616,-77.7529], Tmin=(1445.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-855.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsFFFO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'OC=C(F)OOC(F)(F)F(4185)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.755299,'amu*angstrom^2'), symmetry=1, barrier=(17.3658,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.583887,'amu*angstrom^2'), symmetry=1, barrier=(13.4247,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.18635,'amu*angstrom^2'), symmetry=1, barrier=(50.2684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.584424,'amu*angstrom^2'), symmetry=1, barrier=(13.4371,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238534,0.0882295,-0.000116481,7.76135e-08,-2.05904e-11,-130913,30.104], Tmin=(100,'K'), Tmax=(918.312,'K')), NASAPolynomial(coeffs=[14.7405,0.0250594,-1.32936e-05,2.70042e-09,-1.95542e-13,-133576,-38.6235], Tmin=(918.312,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1089.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFFO) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH)"""),
)

species(
    label = 'OOC(F)=COC(F)(F)F(4186)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1070.8,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,431,527,613,668,835,1199,1245,1322,3010,987.5,1337.5,450,1655,326,540,652,719,1357,254.051,254.052,254.052],'cm^-1')),
        HinderedRotor(inertia=(0.196761,'amu*angstrom^2'), symmetry=1, barrier=(9.01157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.46748,'amu*angstrom^2'), symmetry=1, barrier=(21.4106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196761,'amu*angstrom^2'), symmetry=1, barrier=(9.01153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.81957,'amu*angstrom^2'), symmetry=1, barrier=(37.5359,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.250899,0.0870057,-0.000111858,7.17402e-08,-1.82482e-11,-128656,29.4367], Tmin=(100,'K'), Tmax=(957.878,'K')), NASAPolynomial(coeffs=[15.4593,0.0234972,-1.24064e-05,2.52397e-09,-1.83213e-13,-131570,-43.2805], Tmin=(957.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1070.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsFFFO) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[O]C(F)[C](O)OC(F)(F)F(4187)',
...
"""),
    E0 = (-1069.9,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,391,562,707,872,1109,1210,1289,3137,431,527,613,668,835,1199,1245,1322,360,370,350,270.354,270.354,270.366,2162.27],'cm^-1')),
        HinderedRotor(inertia=(0.122596,'amu*angstrom^2'), symmetry=1, barrier=(6.35861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122611,'amu*angstrom^2'), symmetry=1, barrier=(6.35867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122589,'amu*angstrom^2'), symmetry=1, barrier=(6.35864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122592,'amu*angstrom^2'), symmetry=1, barrier=(6.35866,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.259748,0.0909715,-0.000136044,9.95363e-08,-2.5926e-11,-128553,33.43], Tmin=(100,'K'), Tmax=(634.032,'K')), NASAPolynomial(coeffs=[12.4437,0.0267641,-1.40897e-05,2.7953e-09,-1.97397e-13,-130353,-21.8052], Tmin=(634.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1069.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsFFFO) + radical(O2sj(Cs-CsF1sH)) + radical(Cs_P)"""),
)

species(
    label = '[O]C(F)C([O])OC(F)(F)F(4188)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1049.44,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,391,562,707,872,1109,1210,1289,3137,431,527,613,668,835,1199,1245,1322,180,180,180,1815.19,1815.84],'cm^-1')),
        HinderedRotor(inertia=(0.265998,'amu*angstrom^2'), symmetry=1, barrier=(6.11582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265888,'amu*angstrom^2'), symmetry=1, barrier=(6.11328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266395,'amu*angstrom^2'), symmetry=1, barrier=(6.12495,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.304323,0.0914618,-0.000155676,1.43146e-07,-5.15744e-11,-126096,33.4043], Tmin=(100,'K'), Tmax=(808.582,'K')), NASAPolynomial(coeffs=[8.21136,0.0349979,-1.87467e-05,3.71557e-09,-2.60787e-13,-126807,0.444388], Tmin=(808.582,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1049.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsFFFO) + radical(CCOJ) + radical(O2sj(Cs-CsF1sH))"""),
)

species(
    label = '[O]C(OC(F)(F)F)[C](O)F(4189)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0503273,0.103599,-0.000194172,1.85079e-07,-6.69167e-11,-129938,34.5767], Tmin=(100,'K'), Tmax=(841.088,'K')), NASAPolynomial(coeffs=[7.6717,0.0364024,-1.99894e-05,3.94364e-09,-2.73792e-13,-130159,5.06618], Tmin=(841.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1081.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsFFFO) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'OC(F)=C(O)OC(F)(F)F(4190)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.724758,'amu*angstrom^2'), symmetry=1, barrier=(16.6636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.725029,'amu*angstrom^2'), symmetry=1, barrier=(16.6699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.725732,'amu*angstrom^2'), symmetry=1, barrier=(16.686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.724827,'amu*angstrom^2'), symmetry=1, barrier=(16.6652,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.620166,0.100791,-0.000138657,8.93135e-08,-2.1977e-11,-162493,28.2954], Tmin=(100,'K'), Tmax=(1007.88,'K')), NASAPolynomial(coeffs=[21.9853,0.011077,-5.13996e-06,9.99501e-10,-7.13724e-14,-167049,-80.9405], Tmin=(1007.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1352.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsFFFO) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    E0 = (-1006.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,486,617,768,1157,1926,493,600,700,1144,1293,180,180,900.576,900.897],'cm^-1')),
        HinderedRotor(inertia=(0.234903,'amu*angstrom^2'), symmetry=1, barrier=(5.40088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234717,'amu*angstrom^2'), symmetry=1, barrier=(5.3966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234799,'amu*angstrom^2'), symmetry=1, barrier=(5.39849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234825,'amu*angstrom^2'), symmetry=1, barrier=(5.39909,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.656296,0.0816695,-0.000136889,1.22815e-07,-4.34653e-11,-120885,31.8665], Tmin=(100,'K'), Tmax=(797.063,'K')), NASAPolynomial(coeffs=[8.92718,0.0286386,-1.5402e-05,3.06298e-09,-2.15631e-13,-121837,-3.86332], Tmin=(797.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1006.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsFFHO) + group(COCsFO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'O=[C]C(O)OC(F)(F)F(4192)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1042.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,431,527,613,668,835,1199,1245,1322,1855,455,950,263.867,263.869,2515.28],'cm^-1')),
        HinderedRotor(inertia=(0.00242127,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158911,'amu*angstrom^2'), symmetry=1, barrier=(7.8511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158907,'amu*angstrom^2'), symmetry=1, barrier=(7.85111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.576044,'amu*angstrom^2'), symmetry=1, barrier=(28.4606,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01387,0.0716055,-9.96299e-05,7.46686e-08,-2.27488e-11,-125285,29.8289], Tmin=(100,'K'), Tmax=(797.449,'K')), NASAPolynomial(coeffs=[10.1323,0.0258651,-1.35878e-05,2.73384e-09,-1.96155e-13,-126739,-12.098], Tmin=(797.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1042.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsFFFO) + group(Cds-OdCsH) + radical(CsCJ=O)"""),
)
...
"""),
    E0 = (-1056.08,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3025,407.5,1350,352.5,611,648,830,1210,1753,310.934,311.749,313.404,314.428],'cm^-1')),
        HinderedRotor(inertia=(0.0779223,'amu*angstrom^2'), symmetry=1, barrier=(5.44412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0775383,'amu*angstrom^2'), symmetry=1, barrier=(5.39558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219574,'amu*angstrom^2'), symmetry=1, barrier=(15.2374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1207.46,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,431,527,613,668,835,1199,1245,1322,486,617,768,1157,1926,201.796,201.796,201.796,1797.88,1797.88],'cm^-1')),
        HinderedRotor(inertia=(0.292166,'amu*angstrom^2'), symmetry=1, barrier=(8.44307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292178,'amu*angstrom^2'), symmetry=1, barrier=(8.44307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00413989,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.603503,0.0814963,-0.000128825,1.09899e-07,-3.768e-11,-145108,32.3133], Tmin=(100,'K'), Tmax=(752.872,'K')), NASAPolynomial(coeffs=[10.1371,0.0275161,-1.46455e-05,2.92184e-09,-2.0701e-13,-146449,-10.3482], Tmin=(752.872,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1207.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsFFFO) + group(COCsFO) + radical(C=OCOJ)"""),
)
...
"""),
    E0 = (-897.696,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,431,527,613,668,835,1199,1245,1322,3025,407.5,1350,352.5,242.247,242.255,242.265],'cm^-1')),
        HinderedRotor(inertia=(0.00287252,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161906,'amu*angstrom^2'), symmetry=1, barrier=(6.74249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.594392,'amu*angstrom^2'), symmetry=1, barrier=(24.7601,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1245.94,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,431,527,613,668,835,1199,1245,1322,360,370,350,611,648,830,1210,1753,180,180,1051.36,1051.95],'cm^-1')),
        HinderedRotor(inertia=(0.246882,'amu*angstrom^2'), symmetry=1, barrier=(5.67631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247213,'amu*angstrom^2'), symmetry=1, barrier=(5.68391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.246687,'amu*angstrom^2'), symmetry=1, barrier=(5.67181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247052,'amu*angstrom^2'), symmetry=1, barrier=(5.68021,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.497763,0.0838826,-0.000130406,1.06384e-07,-3.47352e-11,-149733,32.6076], Tmin=(100,'K'), Tmax=(749.852,'K')), NASAPolynomial(coeffs=[11.4157,0.0256412,-1.38983e-05,2.79909e-09,-1.99706e-13,-151370,-16.9219], Tmin=(749.852,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1245.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsFFFO) + group(COCsFO) + radical(Cs_P)"""),
)

species(
    label = 'O=C=C(O)OC(F)(F)F(4165)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
4  O u0 p2 c0 {7,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.24132,'amu*angstrom^2'), symmetry=1, barrier=(28.5404,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.30942,0.0694012,-2.19742e-05,-6.18533e-08,4.036e-11,-125500,25.0751], Tmin=(100,'K'), Tmax=(901.025,'K')), NASAPolynomial(coeffs=[35.8952,-0.0217549,1.39609e-05,-2.74746e-09,1.83546e-13,-134848,-161.489], Tmin=(901.025,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1044.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + missing(O2d-Cdd) + group(CsFFFO) + group(Cds-(Cdd-O2d)OsOs) + missing(Cdd-CdO2d)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)C(O)OC(F)(F)F(3606)'],
    products = ['HF(38)', 'CF2O(48)', 'O=CC(=O)F(907)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OC(F)OC(F)(F)F(723)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'O=C(F)C(O)OF(3854)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(598)', 'O=C=CO(805)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(173)', 'O=C=COC(F)(F)F(4184)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC=C(F)OOC(F)(F)F(4185)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OOC(F)=COC(F)(F)F(4186)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)[C](O)OC(F)(F)F(4187)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)C([O])OC(F)(F)F(4188)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(OC(F)(F)F)[C](O)F(4189)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OC(F)=C(O)OC(F)(F)F(4190)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(F)C(O)O[C](F)F(4191)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=[C]C(O)OC(F)(F)F(4192)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF3O(47)', 'O=C(F)[CH]O(2971)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF3(44)', '[O]C(O)C(=O)F(4072)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(5)', 'O=C(F)[CH]OC(F)(F)F(4193)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[O]C(OC(F)(F)F)C(=O)F(4194)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CFO(50)', 'O[CH]OC(F)(F)F(885)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', 'O=C(F)[C](O)OC(F)(F)F(4195)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C=C(O)OC(F)(F)F(4165)'],
    products = ['O=C(F)C(O)OC(F)(F)F(3606)'],
...
network(
    ...
    isomers = [
        'O=C(F)C(O)OC(F)(F)F(3606)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(48)', 'O=CC(=O)F(907)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
