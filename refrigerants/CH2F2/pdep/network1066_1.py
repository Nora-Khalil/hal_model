species(
    label = '[O]C(F)(F)C(F)(F)[C](F)F(2393)',
...
species(
    label = 'FC1(F)OC(F)(F)C1(F)F(2395)',
...
species(
    label = '[O]C(F)(F)[C](F)C(F)(F)F(2420)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[O][C](F)C(F)(F)C(F)(F)F(2422)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[O]C(F)(F)[C](F)F(274)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[C](F)C(F)(F)[C](F)F(2417)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
    products = ['FC1(F)OC(F)(F)C1(F)F(2395)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)C(F)=C(F)F(525)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O][C](F)F(237)', 'CF2CF2(60)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(F)C(F)(F)[C](F)F(2418)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2O(48)', 'F[C](F)[C](F)F(384)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(237)', 'F[C](F)[C](F)F(384)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(77)', 'O=C(F)[C](F)[C](F)F(528)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[O]C(F)(F)[C](F)F(274)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOC(F)(F)[C](F)[C](F)F(2419)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
    products = ['[O]C(F)(F)[C](F)C(F)(F)F(2420)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FO[C](F)C(F)(F)[C](F)F(2421)'],
    products = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)(F)C(F)(F)[C](F)F(2393)'],
    products = ['[O][C](F)C(F)(F)C(F)(F)F(2422)'],
