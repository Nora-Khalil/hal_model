...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH2][O](1324)'],
    products = ['[O]C[C](F)F(974)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C[C](F)F(974)'],
    products = ['FC1(F)CO1(1226)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FC1(F)[CH]O1(1228)'],
    products = ['FC1(F)CO1(1226)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O][C](F)F(237)', 'CH2(T)(18)'],
    products = ['[CH2]C([O])(F)F(975)'],
