...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)CC1O[C]1F(2814)'],
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(130)', '[CH2]C1O[C]1F(2962)'],
    products = ['F[C](F)CC1O[C]1F(2814)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)[CH]C[C](F)F(2966)'],
    products = ['F[C](F)CC1O[C]1F(2814)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)CC1=C(F)O1(2967)'],
    products = ['F[C](F)CC1O[C]1F(2814)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[C]1OC1C=C(F)F(2885)'],
    products = ['F[C](F)CC1O[C]1F(2814)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(42)', '[CH2]C1O[C]1F(2962)'],
    products = ['F[C](F)CC1O[C]1F(2814)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)CC1O[C]1F(2814)'],
    products = ['F[C]1OC1[CH]C(F)F(2969)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)CC1O[C]1F(2814)'],
    products = ['F[C]1O[C]1CC(F)F(2971)'],
