...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O=C(F)O[C](O)F(405)'],
    products = ['O=C(F)OC(O)(F)F(340)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=[C]OC(O)(F)F(406)'],
    products = ['O=C(F)OC(O)(F)F(340)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(5)', 'O=C(F)O[C](F)F(267)'],
    products = ['O=C(F)OC(O)(F)F(340)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', '[O]C(F)(F)OC(=O)F(327)'],
    products = ['O=C(F)OC(O)(F)F(340)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)OC(=O)F(407)'],
    products = ['O=C(F)OC(O)(F)F(340)'],
