...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(131)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])F(1565)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]F(127)', '[CH2][O](1455)'],
    products = ['[CH2]OC([O])F(1565)'],
