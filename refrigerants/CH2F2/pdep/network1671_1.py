...
"""),
    E0 = (-472.089,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,548,1085,1183,1302,1466,1520,3060,3119,197,221,431,657,2120,512.5,787.5,180,1698.37],'cm^-1')),
        HinderedRotor(inertia=(0.36202,'amu*angstrom^2'), symmetry=1, barrier=(8.32354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78632,'amu*angstrom^2'), symmetry=1, barrier=(41.0709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0199731,'amu*angstrom^2'), symmetry=1, barrier=(41.1492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11827,0.0469856,-8.14583e-05,7.59498e-08,-2.75697e-11,-30928.4,18.922], Tmin=(100,'K'), Tmax=(815.369,'K')), NASAPolynomial(coeffs=[5.85125,0.0183803,-9.9002e-06,1.961e-09,-1.37409e-13,-31195.1,3.77244], Tmin=(815.369,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + missing(O2d-Cdd) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-162.371,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,197,221,431,657,2120,512.5,787.5,180,827.977,836.309],'cm^-1')),
        HinderedRotor(inertia=(0.0080761,'amu*angstrom^2'), symmetry=1, barrier=(3.92283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00787622,'amu*angstrom^2'), symmetry=1, barrier=(3.83374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75186,0.0567396,-0.00010456,9.87109e-08,-3.57607e-11,-19454.9,21.6179], Tmin=(100,'K'), Tmax=(823.335,'K')), NASAPolynomial(coeffs=[6.53031,0.0194556,-1.1002e-05,2.2016e-09,-1.54483e-13,-19764.9,2.3894], Tmin=(823.335,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + missing(O2d-Cdd) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.249144,'amu*angstrom^2'), symmetry=1, barrier=(5.72832,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.529001,'amu*angstrom^2'), symmetry=1, barrier=(12.1628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.15633,'amu*angstrom^2'), symmetry=1, barrier=(49.5782,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57024,0.0599046,-9.9286e-05,9.04498e-08,-3.24125e-11,-5227.41,25.633], Tmin=(100,'K'), Tmax=(812.308,'K')), NASAPolynomial(coeffs=[6.62506,0.023955,-1.24812e-05,2.44936e-09,-1.71095e-13,-5683.78,4.54286], Tmin=(812.308,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.1386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsFHHO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.977788,0.0800047,-0.000152574,1.51868e-07,-5.67163e-11,-50246.5,36.8622], Tmin=(100,'K'), Tmax=(846.401,'K')), NASAPolynomial(coeffs=[3.8649,0.0355386,-1.91484e-05,3.75165e-09,-2.59558e-13,-49631.2,29.9369], Tmin=(846.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-418.569,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFHHO) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35723,0.0399599,-5.42377e-05,4.80577e-08,-1.83934e-11,-60045.7,17.7214], Tmin=(100,'K'), Tmax=(703.712,'K')), NASAPolynomial(coeffs=[4.85817,0.0229486,-1.20184e-05,2.41571e-09,-1.73144e-13,-60328.5,7.02649], Tmin=(703.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-499.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFHHO) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'O=C=C(F)OO(3477)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=C=C(F)OOF(3478)'],
    products = ['O=C=C(F)OOCF(4837)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]OOC(F)=C=O(4102)'],
    products = ['O=C=C(F)OOCF(4837)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C=[C]OOCF(4944)'],
    products = ['O=C=C(F)OOCF(4837)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]CF(703)', 'O=[C]C(=O)F(2239)'],
    products = ['O=C=C(F)OOCF(4837)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(45)', '[O]OC(F)=C=O(2073)'],
    products = ['O=C=C(F)OOCF(4837)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OCF(577)', 'O=C=[C]F(443)'],
    products = ['O=C=C(F)OOCF(4837)'],
