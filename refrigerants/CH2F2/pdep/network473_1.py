...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([O])F(282)'],
    products = ['O=O(148)', 'CHFO(46)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])F(137)'],
    products = ['[O]OC([O])F(282)'],
    transitionState = 'TS2',
