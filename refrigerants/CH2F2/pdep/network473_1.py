...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'F[CH]OC=C(F)F(785)'],
    products = ['F[CH]OC[C](F)F(1160)'],
    transitionState = 'TS8',
