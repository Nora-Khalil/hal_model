...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]=C(F)C#C(2726)'],
    products = ['[CH]=C(F)C(=[CH])F(2665)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=[C]F(2014)', '[CH]=[C]F(2014)'],
    products = ['[CH]=C(F)C(=[CH])F(2665)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(77)', '[CH]=C=C=[CH](2727)'],
    products = ['[CH]=C(F)C(=[CH])F(2665)'],
    transitionState = 'TS6',
