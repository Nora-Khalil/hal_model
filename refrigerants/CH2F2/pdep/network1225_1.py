...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C1O[C]1F(2962)'],
    products = ['[O]CC1O[C]1F(2781)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]CC1=C(F)O1(3009)'],
    products = ['[O]CC1O[C]1F(2781)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CC1O[C]1F(2944)'],
    products = ['[O]CC1O[C]1F(2781)'],
