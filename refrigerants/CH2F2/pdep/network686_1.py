...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43346,0.0428561,3.53521e-07,-4.32758e-08,2.34878e-11,-57964.6,14.5925], Tmin=(100,'K'), Tmax=(915.125,'K')), NASAPolynomial(coeffs=[17.7395,0.00739807,-2.32508e-07,-8.16765e-11,4.23944e-15,-62448.7,-70.8225], Tmin=(915.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-482.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCCFF) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane)"""),
)

species(
    label = '[CH2]C(F)(F)[C]1CO1(1932)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87393,0.0530164,-5.37541e-05,2.28262e-08,2.68718e-12,-21157.5,21.7353], Tmin=(100,'K'), Tmax=(558.864,'K')), NASAPolynomial(coeffs=[6.18901,0.0303588,-1.50221e-05,2.96385e-09,-2.10917e-13,-21768.3,2.27879], Tmin=(558.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cs(C-FF)-Cs-O2s) + radical(C2CsJO) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = '[O][C]1CCC1(F)F(1933)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {7,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32139,0.060074,-6.29176e-05,3.45387e-08,-7.68618e-12,-11425.4,20.1165], Tmin=(100,'K'), Tmax=(1078.66,'K')), NASAPolynomial(coeffs=[11.5368,0.0221924,-1.02391e-05,1.98075e-09,-1.40284e-13,-13629.1,-29.9403], Tmin=(1078.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.7902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(CsCsCsFF) + group(Cs-CsHHH) + ring(Cs-Cs(F)(F)-Cs(O2)) + radical(CC(C)2OJ) + radical(CJC(C)2O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.691524,'amu*angstrom^2'), symmetry=1, barrier=(15.8995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.692323,'amu*angstrom^2'), symmetry=1, barrier=(15.9179,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.572859,0.0805223,-0.000121731,9.42786e-08,-2.8814e-11,-21443.6,22.9119], Tmin=(100,'K'), Tmax=(804.244,'K')), NASAPolynomial(coeffs=[12.5703,0.0208549,-1.04513e-05,2.03978e-09,-1.43012e-13,-23373.5,-32.3558], Tmin=(804.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])C(C)(F)F(1936)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.405561,'amu*angstrom^2'), symmetry=1, barrier=(9.32465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404429,'amu*angstrom^2'), symmetry=1, barrier=(9.29861,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.967656,0.0721816,-0.000110111,9.20733e-08,-3.0784e-11,-30307.7,21.6909], Tmin=(100,'K'), Tmax=(797.697,'K')), NASAPolynomial(coeffs=[9.30098,0.0252997,-1.23729e-05,2.38267e-09,-1.65346e-13,-31475.1,-15.613], Tmin=(797.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(F)=C([CH2])OF(1937)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00367504,'amu*angstrom^2'), symmetry=1, barrier=(10.8947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84814,'amu*angstrom^2'), symmetry=1, barrier=(42.4924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0143343,'amu*angstrom^2'), symmetry=1, barrier=(42.4943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05262,0.0704444,-0.000105556,8.91376e-08,-3.03702e-11,4489.41,24.0394], Tmin=(100,'K'), Tmax=(789.836,'K')), NASAPolynomial(coeffs=[8.4386,0.027516,-1.35394e-05,2.61708e-09,-1.82208e-13,3494.96,-8.76047], Tmin=(789.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.4894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=C(O)CJ) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.301407,'amu*angstrom^2'), symmetry=1, barrier=(6.92994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301352,'amu*angstrom^2'), symmetry=1, barrier=(6.92868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301375,'amu*angstrom^2'), symmetry=1, barrier=(6.92921,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.919594,0.0744738,-0.000120168,1.04442e-07,-3.56706e-11,-35895.6,24.8011], Tmin=(100,'K'), Tmax=(826.175,'K')), NASAPolynomial(coeffs=[8.81099,0.0257989,-1.27888e-05,2.45795e-09,-1.69575e-13,-36842.3,-9.60137], Tmin=(826.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.322,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C(F)(F)[C]=O(1046)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {6,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.282157,'amu*angstrom^2'), symmetry=1, barrier=(6.48734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282134,'amu*angstrom^2'), symmetry=1, barrier=(6.48683,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77663,0.0557151,-9.88127e-05,9.22946e-08,-3.32127e-11,-29207.4,20.2578], Tmin=(100,'K'), Tmax=(825.023,'K')), NASAPolynomial(coeffs=[6.46847,0.0200858,-1.06134e-05,2.09932e-09,-1.46845e-13,-29543.2,1.18174], Tmin=(825.023,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCO)(H)(H)) + radical(COj(Cs-F1sF1sCs)(O2d))"""),
)

species(
    label = 'O=C1CCC1(F)F(1881)',
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04795,0.0342686,-6.63527e-07,-2.02866e-08,8.99598e-12,-61256,19.9786], Tmin=(100,'K'), Tmax=(1063.13,'K')), NASAPolynomial(coeffs=[10.5229,0.0213144,-9.09863e-06,1.75361e-09,-1.2588e-13,-64128,-26.459], Tmin=(1063.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-509.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCCFF) + group(Cds-OdCsCs) + longDistanceInteraction_cyclic(Cs(F)2-CO) + ring(Cyclobutanone)"""),
)

species(
    label = '[CH2][C]1OCC1(F)F(1939)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54838,0.0584556,-7.47444e-05,5.73357e-08,-1.85191e-11,-19878.3,20.6417], Tmin=(100,'K'), Tmax=(745.901,'K')), NASAPolynomial(coeffs=[7.22233,0.028027,-1.35504e-05,2.63988e-09,-1.86184e-13,-20724.7,-5.06816], Tmin=(745.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cs-O2s-Cs-Cs(F)(F)) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(=C)[O](1680)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(=O)[C](F)F(1754)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1680)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=C(1931)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1680)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C(=C)[O](1680)'],
    products = ['[CH2]C(F)(F)[C]1CO1(1932)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)C(=C)[O](1680)'],
    products = ['[CH2]C1([O])CC1(F)F(1922)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(3.24059e+09,'s^-1'), n=0.736667, Ea=(192.78,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 191.5 to 192.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C(=C)F(1934)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1680)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CF2(56)', '[CH2][C]=O(1600)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1680)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C](F)F(933)', 'CH2CO(28)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1680)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C](F)F(933)', '[CH2][C]=O(1600)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1680)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(O)C([CH2])(F)F(1935)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1680)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)=C([CH2])OF(1937)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1680)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', '[CH2]C(F)(F)[C]=O(1046)'],
    products = ['[CH2]C(F)(F)C(=C)[O](1680)'],
