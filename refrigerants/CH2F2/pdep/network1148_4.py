...
reaction(
    label = 'reaction1',
    reactants = ['CF2(42)', 'C2HF(57)'],
    products = ['FC1=CC1(F)F(2656)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'FC1=C(F)[CH]1(3136)'],
    products = ['FC1=CC1(F)F(2656)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC1(F)[C]=C1(3137)'],
    products = ['FC1=CC1(F)F(2656)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC1=[C]C1(F)F(3138)'],
    products = ['FC1=CC1(F)F(2656)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'FC1=C=C1F(3141)'],
    products = ['FC1=CC1(F)F(2656)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1(F)C#C1(3142)'],
    products = ['FC1=CC1(F)F(2656)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', '[CH]=C=[C]F(3826)'],
    products = ['[CH]C(F)=C(F)F(2570)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]F(130)', '[CH]=[C]F(2014)'],
    products = ['[CH]C(F)=C(F)F(2570)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'F[C]=C=[C]F(3829)'],
    products = ['F[C]C=C(F)F-2(2564)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'F[C]=C=C(F)F(2755)'],
    products = ['F[C]C=C(F)F-2(2564)'],
