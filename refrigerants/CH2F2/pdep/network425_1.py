...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH2]O[C](F)F(1051)'],
    products = ['F[C](F)CO[C](F)F(1003)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)OC=C(F)F(498)'],
    products = ['F[C](F)CO[C](F)F(1003)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(42)', '[CH2]O[C](F)F(1051)'],
    products = ['F[C](F)CO[C](F)F(1003)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)CO[C](F)F(1003)'],
    products = ['F[C](F)O[CH]C(F)F(1053)'],
