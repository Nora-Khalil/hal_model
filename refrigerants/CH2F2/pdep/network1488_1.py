...
"""),
    E0 = (-1413.8,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,251,367,519,700,855,1175,1303,435,565,619,662,854,1178,1396,2782.5,750,1395,475,1775,1000,219.438,219.439,219.46],'cm^-1')),
        HinderedRotor(inertia=(0.248438,'amu*angstrom^2'), symmetry=1, barrier=(8.49061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305609,'amu*angstrom^2'), symmetry=1, barrier=(10.4415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248463,'amu*angstrom^2'), symmetry=1, barrier=(8.49062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10686,'amu*angstrom^2'), symmetry=1, barrier=(37.8104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0621637,0.0939048,-0.000140735,1.09023e-07,-3.36811e-11,-169906,29.3319], Tmin=(100,'K'), Tmax=(792.202,'K')), NASAPolynomial(coeffs=[13.2466,0.0273363,-1.46954e-05,2.96064e-09,-2.11785e-13,-171995,-31.2049], Tmin=(792.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1413.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFFOO) + group(Cds-OdCsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.90875,'amu*angstrom^2'), symmetry=1, barrier=(43.886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.474271,'amu*angstrom^2'), symmetry=1, barrier=(10.9044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.474356,'amu*angstrom^2'), symmetry=1, barrier=(10.9064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.91066,'amu*angstrom^2'), symmetry=1, barrier=(43.9299,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.127002,0.0930979,-0.000137276,1.06582e-07,-3.3345e-11,-127300,31.061], Tmin=(100,'K'), Tmax=(779.452,'K')), NASAPolynomial(coeffs=[12.3467,0.0303905,-1.66026e-05,3.37301e-09,-2.42694e-13,-129205,-24.8474], Tmin=(779.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1059.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]CC(F)(F)OC([O])(F)F(4205)',
...
"""),
    E0 = (-1023.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,375,486,586,623,710,938,1161,1294,180,180,180,682.589,684.978],'cm^-1')),
        HinderedRotor(inertia=(0.181531,'amu*angstrom^2'), symmetry=1, barrier=(4.17375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182309,'amu*angstrom^2'), symmetry=1, barrier=(4.19165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183281,'amu*angstrom^2'), symmetry=1, barrier=(4.21399,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0264456,0.0964678,-0.000159582,1.41545e-07,-4.99064e-11,-122996,31.3422], Tmin=(100,'K'), Tmax=(779.842,'K')), NASAPolynomial(coeffs=[10.3516,0.0332001,-1.80625e-05,3.61539e-09,-2.55834e-13,-124293,-13.8937], Tmin=(779.842,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1023.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsOsHH) + group(CsFFOO) + radical(CCOJ) + radical(O2sj(Cs-F1sF1sO2s))"""),
)

species(
    label = '[O]C(F)(F)OC(F)(F)[CH]O(4206)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1072.11,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,525,597,667,842,1178,1324,375,486,586,623,710,938,1161,1294,3025,407.5,1350,352.5,180,180,180,1720.4],'cm^-1')),
        HinderedRotor(inertia=(0.342183,'amu*angstrom^2'), symmetry=1, barrier=(7.86745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.34245,'amu*angstrom^2'), symmetry=1, barrier=(7.87361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342646,'amu*angstrom^2'), symmetry=1, barrier=(7.8781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342366,'amu*angstrom^2'), symmetry=1, barrier=(7.87167,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.518187,0.112907,-0.000209193,1.91051e-07,-6.61467e-11,-128795,32.8489], Tmin=(100,'K'), Tmax=(854.85,'K')), NASAPolynomial(coeffs=[11.2022,0.030592,-1.65478e-05,3.21901e-09,-2.20707e-13,-129795,-15.9855], Tmin=(854.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1072.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsOsHH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-F1sF1sO2s)(O2s-H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.06837,'amu*angstrom^2'), symmetry=1, barrier=(24.564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.25173,'amu*angstrom^2'), symmetry=1, barrier=(51.7718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24699,'amu*angstrom^2'), symmetry=1, barrier=(51.6628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00449063,'amu*angstrom^2'), symmetry=1, barrier=(11.9747,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.758549,0.0777634,-0.000115672,9.49664e-08,-3.1774e-11,-126386,26.433], Tmin=(100,'K'), Tmax=(728.286,'K')), NASAPolynomial(coeffs=[9.63116,0.0290248,-1.52743e-05,3.04943e-09,-2.16928e-13,-127678,-13.5578], Tmin=(728.286,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1051.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFOO) + group(Cds-OdCsH) + radical(CsCOF1sO2s)"""),
)

species(
    label = 'O=CC(F)(F)O[C](O)F(4208)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-976.849,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,251,367,519,700,855,1175,1303,2782.5,750,1395,475,1775,1000,482,586,761,1411,320.061,320.072,320.12],'cm^-1')),
        HinderedRotor(inertia=(0.106954,'amu*angstrom^2'), symmetry=1, barrier=(7.7734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275246,'amu*angstrom^2'), symmetry=1, barrier=(20.0111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106907,'amu*angstrom^2'), symmetry=1, barrier=(7.77334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.563508,'amu*angstrom^2'), symmetry=1, barrier=(40.9741,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.696678,0.0770191,-0.000100075,6.55222e-08,-1.70604e-11,-117372,28.2688], Tmin=(100,'K'), Tmax=(935.612,'K')), NASAPolynomial(coeffs=[13.6434,0.0216694,-1.13386e-05,2.29449e-09,-1.6594e-13,-119795,-33.3302], Tmin=(935.612,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-976.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFHOO) + group(Cds-OdCsH) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.159598,'amu*angstrom^2'), symmetry=1, barrier=(3.66947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.385428,'amu*angstrom^2'), symmetry=1, barrier=(8.86175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159043,'amu*angstrom^2'), symmetry=1, barrier=(3.65671,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.672188,0.0818559,-0.000142322,1.29031e-07,-4.56014e-11,-118821,27.7557], Tmin=(100,'K'), Tmax=(811.329,'K')), NASAPolynomial(coeffs=[9.01392,0.0267666,-1.46569e-05,2.91617e-09,-2.0467e-13,-119715,-7.91212], Tmin=(811.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-988.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFFHO) + group(Cds-OdCsH) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-1147.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([251,367,519,700,855,1175,1303,375,486,586,623,710,938,1161,1294,2782.5,750,1395,475,1775,1000,217.124,217.124,217.124],'cm^-1')),
        HinderedRotor(inertia=(0.171761,'amu*angstrom^2'), symmetry=1, barrier=(5.746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17176,'amu*angstrom^2'), symmetry=1, barrier=(5.746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.937638,'amu*angstrom^2'), symmetry=1, barrier=(31.3672,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.499958,0.0829275,-0.00011314,7.82842e-08,-2.16119e-11,-137866,28.6641], Tmin=(100,'K'), Tmax=(882.726,'K')), NASAPolynomial(coeffs=[13.5047,0.0239971,-1.30001e-05,2.65456e-09,-1.92445e-13,-140162,-32.4542], Tmin=(882.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1147.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFFOO) + group(Cds-OdCsH) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.451752,'amu*angstrom^2'), symmetry=1, barrier=(10.3867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.451562,'amu*angstrom^2'), symmetry=1, barrier=(10.3823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.451548,'amu*angstrom^2'), symmetry=1, barrier=(10.382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.451832,'amu*angstrom^2'), symmetry=1, barrier=(10.3885,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.662867,0.123874,-0.000260094,2.49014e-07,-8.68647e-11,-149339,31.2291], Tmin=(100,'K'), Tmax=(894.578,'K')), NASAPolynomial(coeffs=[8.9397,0.0296262,-1.60253e-05,3.0087e-09,-1.9752e-13,-149003,-2.55252], Tmin=(894.578,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1242.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFFOO) + group(Cds-OdCsH) + radical(COj(Cs-F1sF1sO2s)(O2d))"""),
)

species(
    label = 'O=CC(F)(F)OC(=O)F(4211)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  O u0 p2 c0 {7,S} {9,S}
...
"""),
    E0 = (-1148.28,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([251,367,519,700,855,1175,1303,2782.5,750,1395,475,1775,1000,482,664,788,1296,1923,232.115,232.173,2153.14],'cm^-1')),
        HinderedRotor(inertia=(0.696663,'amu*angstrom^2'), symmetry=1, barrier=(26.7181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.40602,'amu*angstrom^2'), symmetry=1, barrier=(15.5159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.957628,'amu*angstrom^2'), symmetry=1, barrier=(36.7375,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31653,0.0632919,-7.32694e-05,4.31968e-08,-1.03303e-11,-138013,24.8011], Tmin=(100,'K'), Tmax=(1003.51,'K')), NASAPolynomial(coeffs=[11.6114,0.0222563,-1.1931e-05,2.44732e-09,-1.78547e-13,-140080,-24.9017], Tmin=(1003.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1148.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsH) + group(COFOO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=CC(F)(F)OC(O)(F)F(3971)'],
...
reaction(
    ...
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)(F)OF(296)', 'O=C[C]F-2(818)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(O)(F)F(922)', 'CF2CO(75)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)(F)OOC=C(F)F(4204)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]CC(F)(F)OC([O])(F)F(4205)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)OC(F)(F)[CH]O(4206)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C[C](F)OC(O)(F)F(4207)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CC(F)(F)O[C](O)F(4208)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(O)(F)F(178)', 'O=C[C](F)F(961)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O[C](F)F(220)', '[O]C(F)(F)C=O(751)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'O=CC(F)(F)O[C](F)F(2047)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)(F)C=O(4209)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(15)', 'OC(F)(F)O[C](F)F(319)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O=[C]C(F)(F)OC(O)(F)F(4210)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=CC(F)(F)OC(=O)F(4211)'],
    products = ['O=CC(F)(F)OC(O)(F)F(3971)'],
...
network(
    ...
    isomers = [
        'O=CC(F)(F)OC(O)(F)F(3971)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(48)', 'O=CC(=O)F(711)'),
        ('[O]C(O)(F)F(178)', 'O=C[C](F)F(961)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
