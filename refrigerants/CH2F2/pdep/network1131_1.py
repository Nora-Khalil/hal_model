species(
    label = 'F[C]1OC1C(F)(F)[C](F)F(3016)',
...
species(
    label = 'F[C]1OC(F)([C](F)F)C1F(3041)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)(F)C1(F)[CH]O1(3015)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'FC1(F)C2OC2(F)C1(F)F(3026)',
...
species(
    label = 'FC1=C(C(F)(F)C(F)F)O1(3042)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
species(
    label = 'O=C(F)[CH]C(F)(F)[C](F)F(3043)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)(F)C1=C(F)O1(3044)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C]1O[C]1C(F)=C(F)F(3045)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)(F)[C]1OC1F(3029)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C]1O[C]1C(F)(F)C(F)F(3046)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C](F)[C](F)C1OC1(F)F(3047)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C]1OC1[C](F)C(F)(F)F(3048)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    products = ['CF2CF2(60)', 'FC1=CO1(1027)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    products = ['F[C]1OC(F)([C](F)F)C1F(3041)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)C(F)(F)C1(F)[CH]O1(3015)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(162)', 'F[C](F)C1O[C]1F(2781)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    products = ['FC1(F)C2OC2(F)C1(F)F(3026)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    products = ['FC1=C(C(F)(F)C(F)F)O1(3042)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)[CH]C(F)(F)[C](F)F(3043)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C](F)[C](F)F(418)', 'FC1=CO1(1027)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'F[C](F)C(F)(F)C1=C(F)O1(3044)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[C]1OC1C(F)=C(F)F(2827)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2CF2(60)', 'F[C]1[CH]O1(2769)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)[C](F)F(418)', 'F[C]1[CH]O1(2769)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[C]1O[C]1C(F)=C(F)F(3045)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(42)', 'F[C](F)C1O[C]1F(2781)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    products = ['F[C](F)C(F)(F)[C]1OC1F(3029)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    products = ['F[C]1O[C]1C(F)(F)C(F)F(3046)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    products = ['F[C](F)[C](F)C1OC1(F)F(3047)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(3016)'],
    products = ['F[C]1OC1[C](F)C(F)(F)F(3048)'],
...
network(
    ...
    isomers = [
        'F[C]1OC1C(F)(F)[C](F)F(3016)',
    ],
    reactants = [
        ('CF2CF2(60)', 'FC1=CO1(1027)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
