...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.114765,'amu*angstrom^2'), symmetry=1, barrier=(2.63868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113234,'amu*angstrom^2'), symmetry=1, barrier=(2.60348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.420642,'amu*angstrom^2'), symmetry=1, barrier=(9.67138,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2][C](F)C(F)(F)C(F)F(1104)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1009)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1010)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)(F)[C](F)F(535)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1009)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(129)', '[CH2]C(F)(F)[C](F)F(1063)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1009)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_ter_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1009)'],
    products = ['FC1CC(F)(F)C1(F)F(1071)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C(F)(F)[CH]F(1100)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1009)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)=CF(1101)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1009)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', '[CH2]C(F)=C(F)[CH]F(1102)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1009)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH2]C(F)(F)[C](F)F(1063)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1009)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]C(F)(F)[C](F)CF(1103)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1009)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(1009)'],
    products = ['[CH2][C](F)C(F)(F)C(F)F(1104)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH][C](F)C(F)(F)CF(1105)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(1009)'],
