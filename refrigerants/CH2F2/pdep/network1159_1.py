...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.971958,'amu*angstrom^2'), symmetry=1, barrier=(22.3472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.975793,'amu*angstrom^2'), symmetry=1, barrier=(22.4354,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.315371,0.0827449,-0.000116668,7.91568e-08,-2.07277e-11,-56750.6,27.8681], Tmin=(100,'K'), Tmax=(943.963,'K')), NASAPolynomial(coeffs=[16.7049,0.0132945,-6.30696e-06,1.21501e-09,-8.53793e-14,-59844.8,-50.2567], Tmin=(943.963,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-472.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(O2sj(Cs-F1sF1sCd)) + radical(C=C(C)OJ)"""),
)

species(
    label = '[O]C(F)(F)O[CH]C(=O)F(3131)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C(F)(F)C1(F)[CH]OO1(3219)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-616.428,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([377,639,914,1335,375,552.5,462.5,1710,2782.5,750,1395,475,1775,1000,180,180,994.853,994.959,995.34],'cm^-1')),
        HinderedRotor(inertia=(0.241748,'amu*angstrom^2'), symmetry=1, barrier=(5.55826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241342,'amu*angstrom^2'), symmetry=1, barrier=(5.54893,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45261,0.0645159,-0.000112722,1.07743e-07,-3.99284e-11,-74055.7,24.437], Tmin=(100,'K'), Tmax=(817.976,'K')), NASAPolynomial(coeffs=[5.43776,0.0281622,-1.51282e-05,2.9945e-09,-2.09761e-13,-74143.4,9.46064], Tmin=(817.976,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-616.428,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H) + radical(O2sj(Cs-F1sF1sCO))"""),
)
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.199607,0.0891495,-0.000144861,1.15041e-07,-3.55099e-11,-94497.9,28.8779], Tmin=(100,'K'), Tmax=(800.481,'K')), NASAPolynomial(coeffs=[14.7248,0.0165613,-8.82919e-06,1.74025e-09,-1.21765e-13,-96823.2,-37.964], Tmin=(800.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-786.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(O2sj(Cs-CsF1sF1s)) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(F)([C]=O)C(O)(F)F(3226)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.121824,0.0915205,-0.000154835,1.27905e-07,-4.08555e-11,-96448.4,29.3436], Tmin=(100,'K'), Tmax=(826.11,'K')), NASAPolynomial(coeffs=[14.3342,0.0169425,-8.95757e-06,1.73979e-09,-1.19853e-13,-98600,-35.3179], Tmin=(826.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-803.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C=C(OF)C([O])(F)F(3227)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.21368,'amu*angstrom^2'), symmetry=1, barrier=(27.9048,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.99763,'amu*angstrom^2'), symmetry=1, barrier=(22.9375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.999638,'amu*angstrom^2'), symmetry=1, barrier=(22.9836,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147033,0.0942374,-0.000168764,1.499e-07,-5.11376e-11,-50577.1,29.2237], Tmin=(100,'K'), Tmax=(836.848,'K')), NASAPolynomial(coeffs=[11.5212,0.0235966,-1.29737e-05,2.55266e-09,-1.76831e-13,-51910.9,-20.2192], Tmin=(836.848,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(F)(C=O)[C](F)OF(3230)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,395,473,707,1436,2782.5,750,1395,475,1775,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.08554,'amu*angstrom^2'), symmetry=1, barrier=(24.9588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08447,'amu*angstrom^2'), symmetry=1, barrier=(24.934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08038,'amu*angstrom^2'), symmetry=1, barrier=(24.8401,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.111583,0.0955965,-0.000173149,1.55278e-07,-5.3399e-11,-48512.6,29.2279], Tmin=(100,'K'), Tmax=(835.927,'K')), NASAPolynomial(coeffs=[11.2972,0.0243704,-1.35752e-05,2.68318e-09,-1.86298e-13,-49764.2,-19.0325], Tmin=(835.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-404.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]C(F)C([O])(F)F(701)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=COF)C([O])(F)F(3217)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
    products = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(7)', '[O]C=C(F)C([O])(F)F(2796)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(7)', '[O]C(F)(C=O)[C](F)F(3218)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1667.73,'m^3/(mol*s)'), n=1.126, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_ter_rad;O_birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
    products = ['O=CC1(F)OOC1(F)F(3138)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
    products = ['[O]C(F)(F)C1(F)[CH]OO1(3219)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
    products = ['[O]C1(F)[CH]OOC1(F)F(3156)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
    products = ['[O]C1OC1(F)C([O])(F)F(3220)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)C=O(3221)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HCO(15)', '[O]C(F)(F)C(=O)F(271)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C(F)(C=O)C(=O)F(3222)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(77)', '[O]C=C([O])C(=O)F(3223)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[O]C(F)(F)C(=O)[C]=O(3224)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
    products = ['[O]C(F)(F)C(O)(F)[C]=O(3225)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
    products = ['[O]C(F)([C]=O)C(O)(F)F(3226)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C=C(OF)C([O])(F)F(3227)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C=C([O])C(F)(F)OF(3228)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O][C](F)C(F)(C=O)OF(3229)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(C=O)[C](F)OF(3230)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(3130)'],
...
network(
    label = 'PDepNetwork #1159',
    isomers = [
        '[O]C(F)(F)C([O])(F)C=O(3130)',
    ],
    reactants = [
