...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.356292,'amu*angstrom^2'), symmetry=1, barrier=(8.19185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.354968,'amu*angstrom^2'), symmetry=1, barrier=(8.16141,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.247612,0.0930321,-0.000169676,1.54725e-07,-5.40301e-11,-66969.2,27.3573], Tmin=(100,'K'), Tmax=(832.785,'K')), NASAPolynomial(coeffs=[10.3082,0.0256978,-1.41503e-05,2.80971e-09,-1.95956e-13,-67985.5,-15.3799], Tmin=(832.785,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s)) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0193,0.0705893,-8.67165e-05,5.89261e-08,-1.64889e-11,-79819.6,24.9473], Tmin=(100,'K'), Tmax=(861.535,'K')), NASAPolynomial(coeffs=[9.99286,0.0289247,-1.41727e-05,2.78885e-09,-1.98411e-13,-81365.7,-17.0072], Tmin=(861.535,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-664.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)

species(
    label = 'F[CH]C(F)=C(F)[C](F)F(560)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674743,0.0823315,-0.000125241,8.7977e-08,-1.91153e-11,-70203,25.2016], Tmin=(100,'K'), Tmax=(597.531,'K')), NASAPolynomial(coeffs=[11.657,0.0231543,-1.26849e-05,2.56162e-09,-1.82366e-13,-71771.4,-24.2681], Tmin=(597.531,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-584.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sF1sCs)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = 'FC=[C]C(F)(F)[C](F)F(2688)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[CH]C(F)=C(F)F(2570)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    products = ['FC1=CC(F)(F)C1(F)F(2685)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=C(F)C(F)=C(F)F(2607)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2CF2(60)', '[CH]=[C]F(2014)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C#CC(F)(F)[C](F)F(2691)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[C](F)[C](F)F(384)', 'C2HF(57)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C](F)[C](F)F(384)', '[CH]=[C]F(2014)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F2(77)', '[CH]=C=C(F)[C](F)F(2610)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(42)', '[CH]C(F)=C(F)F(2570)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    products = ['[CH]C(F)=C(F)C(F)(F)F(2692)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    products = ['F[CH]C(F)=C(F)[C](F)F(560)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    products = ['[CH]=[C]C(F)(F)C(F)(F)F(2693)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(2663)'],
    products = ['FC=[C]C(F)(F)[C](F)F(2688)'],
