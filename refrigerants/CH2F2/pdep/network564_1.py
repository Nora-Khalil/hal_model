...
"""),
    E0 = (-826.642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,375,486,586,623,710,938,1161,1294,180,180,672.016],'cm^-1')),
        HinderedRotor(inertia=(0.247644,'amu*angstrom^2'), symmetry=1, barrier=(5.69382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.960629,'amu*angstrom^2'), symmetry=1, barrier=(22.0868,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'OC(O)(F)F(922)'],
    products = ['OC(F)(F)OCF(1486)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)(F)OF(296)', 'CH2(S)(25)'],
    products = ['OC(F)(F)OCF(1486)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(O)(F)F(1554)'],
    products = ['OC(F)(F)OCF(1486)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(220)', '[O]CF(703)'],
    products = ['OC(F)(F)OCF(1486)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(O)(F)F(178)', 'CH2F(45)'],
    products = ['OC(F)(F)OCF(1486)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OC(F)(F)O[CH]F(924)'],
    products = ['OC(F)(F)OCF(1486)'],
