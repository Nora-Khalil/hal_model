...
"""),
    E0 = (-581.534,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,280,501,1494,1531,600,916.095,916.095,916.095,916.095,916.095,916.095,916.095,916.095,916.095,916.095,916.095,2357.03],'cm^-1')),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.79587,0.0206012,1.45542e-05,-2.45191e-08,7.89921e-12,-69894.4,22.2251], Tmin=(100,'K'), Tmax=(1216.94,'K')), NASAPolynomial(coeffs=[7.37505,0.0238602,-1.20323e-05,2.40966e-09,-1.72865e-13,-72364.8,-6.33647], Tmin=(1216.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsCFHO) + group(Cds-OdCsOs) + ring(Cyclopentane) + radical(Cs_P) + radical(CsCOF1sO2s)"""),
)

species(
    label = '[O]C([O])OC(F)=C=O(3663)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u1 p2 c0 {6,S}
...
"""),
    E0 = (-290.367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,197,221,431,657,2120,512.5,787.5,180,1331.78,1332.2,1332.28,1332.39,1332.9],'cm^-1')),
        HinderedRotor(inertia=(0.00328239,'amu*angstrom^2'), symmetry=1, barrier=(4.12877,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-313.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,2120,512.5,787.5,1855,455,950,346.84,359.163,365.361],'cm^-1')),
        HinderedRotor(inertia=(0.400005,'amu*angstrom^2'), symmetry=1, barrier=(38.8771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.019343,'amu*angstrom^2'), symmetry=1, barrier=(38.87,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.029,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6249,0.0574678,-9.80426e-05,8.61769e-08,-2.98293e-11,-37597.7,19.1859], Tmin=(100,'K'), Tmax=(785.055,'K')), NASAPolynomial(coeffs=[8.57401,0.0165442,-9.30932e-06,1.87375e-09,-1.32603e-13,-38518.8,-11.5751], Tmin=(785.055,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + missing(O2d-Cdd) + group(Cd(Cdd-Od)FO) + group(Cds-OdOsH) + missing(Cdd-CdO2d) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-201.126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2782.5,750,1395,475,1775,1000,180,180,180,531.429,646.073,1600,1828.57,2971.43,3200],'cm^-1')),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31339,0.07511,-0.000159893,1.6381e-07,-6.09279e-11,-24108.4,23.3397], Tmin=(100,'K'), Tmax=(871.314,'K')), NASAPolynomial(coeffs=[2.56517,0.0306421,-1.66799e-05,3.23068e-09,-2.19814e-13,-22856.7,25.9076], Tmin=(871.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-O2d)H) + group(Cds-CdsCsCs) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O=C1O[C](O)O[C]1F(3662)'],
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C=[C]OC(=O)O(3664)'],
    products = ['O=C=C(F)OC(=O)O(3260)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]O(161)', 'O=[C]C(=O)F(2239)'],
    products = ['O=C=C(F)OC(=O)O(3260)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(226)', 'O=C=[C]F(443)'],
    products = ['O=C=C(F)OC(=O)O(3260)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'O=[C]OC(F)=C=O(3665)'],
    products = ['O=C=C(F)OC(=O)O(3260)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C(F)[C-]=[O+]C(=O)O(3666)'],
    products = ['O=C=C(F)OC(=O)O(3260)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C=C(F)OC(=O)O(3260)'],
    products = ['HF(38)', 'CO2(14)', 'O=C=C=O(3248)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C=C(F)OC(=O)O(3260)'],
    products = ['CO(13)', 'O=C(O)[O+]=[C-]F(3667)'],
