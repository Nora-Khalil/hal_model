...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C([O])=O(1180)'],
    products = ['[CH2]OC([CH2])=O(4827)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=O(1168)'],
    products = ['[CH2]OC([CH2])=O(4827)'],
    transitionState = 'TS3',
