...
reaction(
    label = 'reaction1',
    reactants = ['[O]OOC[C](F)F(1372)'],
    products = ['O2(2)', 'FC1(F)CO1(1226)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC[C](F)F(956)'],
    products = ['[O]OOC[C](F)F(1372)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH2]OO[O](1348)'],
    products = ['[O]OOC[C](F)F(1372)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]OOC=C(F)F(1459)'],
    products = ['[O]OOC[C](F)F(1372)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[O](126)', '[CH2][C](F)F(933)'],
    products = ['[O]OOC[C](F)F(1372)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]OO[O](1348)'],
    products = ['[O]OOC[C](F)F(1372)'],
