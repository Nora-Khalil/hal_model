...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(F)=CF(2603)'],
    products = ['[CH]=C(F)C([O])F(2657)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=C(F)C=O(2694)'],
    products = ['[CH]=C(F)C([O])F(2657)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)C(=O)F(2015)'],
    products = ['[CH]=C(F)C([O])F(2657)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]F(134)', '[CH]=[C]F(2014)'],
    products = ['[CH]=C(F)C([O])F(2657)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C([O])F(2312)'],
    products = ['[CH]=C(F)C([O])F(2657)'],
