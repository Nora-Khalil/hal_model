...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([O])(F)F(223)'],
    products = ['O=O(148)', 'CF2O(48)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])(F)F(150)'],
    products = ['[O]OC([O])(F)F(223)'],
    transitionState = 'TS2',
