...
species(
    label = 'F[CH][C](F)C(F)(F)C(F)F(568)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C(F)(F)[CH]F(484)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(129)', 'F[CH]C(F)(F)[C](F)F(535)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(484)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)=CF(566)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(484)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F2(77)', 'F[CH]C(F)=C(F)[CH]F(567)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(484)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'F[CH]C(F)(F)[C](F)F(535)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(484)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]C(F)(F)C(F)(F)[CH]F(484)'],
    products = ['F[CH][C](F)C(F)(F)C(F)F(568)'],
