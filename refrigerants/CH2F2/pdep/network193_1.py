...
"""),
    E0 = (-639.87,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,334,575,1197,1424,3202,1855,455,950,253.92,254.247,254.615],'cm^-1')),
        HinderedRotor(inertia=(0.89616,'amu*angstrom^2'), symmetry=1, barrier=(41.3315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.902012,'amu*angstrom^2'), symmetry=1, barrier=(41.338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.900233,'amu*angstrom^2'), symmetry=1, barrier=(41.3316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13577,0.0674792,-9.14623e-05,6.26707e-08,-1.71014e-11,-76859.3,22.3966], Tmin=(100,'K'), Tmax=(893.583,'K')), NASAPolynomial(coeffs=[11.9443,0.0190971,-1.02479e-05,2.08114e-09,-1.50423e-13,-78791,-28.5326], Tmin=(893.583,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-639.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-OdOsH) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H)) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(184)', '[O]C(F)(F)[CH]F(453)'],
    products = ['O=[C]OC(F)(F)[CH]F(463)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(129)', 'O=[C]O[C](F)F(238)'],
    products = ['O=[C]OC(F)(F)[CH]F(463)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C(F)(F)[CH]F(453)'],
    products = ['O=[C]OC(F)(F)[CH]F(463)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=CF(494)'],
    products = ['O=[C]OC(F)(F)[CH]F(463)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', 'O=[C]O[C](F)F(238)'],
    products = ['O=[C]OC(F)(F)[CH]F(463)'],
