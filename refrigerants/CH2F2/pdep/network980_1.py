...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH]C(F)=C(F)F(2530)'],
    products = ['[CH]=C(F)C([O])(F)F(2475)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=C(F)C(=O)F(1827)'],
    products = ['[CH]=C(F)C([O])(F)F(2475)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C#CC([O])(F)F(2531)'],
    products = ['[CH]=C(F)C([O])(F)F(2475)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F2(77)', '[CH]=C=C([O])F(2532)'],
    products = ['[CH]=C(F)C([O])(F)F(2475)'],
    transitionState = 'TS9',
