...
"""),
    E0 = (-103.985,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,277,555,632,350,440,435,1725,2950,3100,1380,975,1025,1650,365.881,373.067],'cm^-1')),
        HinderedRotor(inertia=(0.0633497,'amu*angstrom^2'), symmetry=1, barrier=(5.94613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208051,'amu*angstrom^2'), symmetry=1, barrier=(19.6246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149314,'amu*angstrom^2'), symmetry=1, barrier=(14.3478,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48966,0.0577686,-8.00928e-05,5.62581e-08,-1.55364e-11,-12418.3,19.448], Tmin=(100,'K'), Tmax=(889.544,'K')), NASAPolynomial(coeffs=[11.1585,0.0142889,-6.77136e-06,1.30495e-09,-9.15012e-14,-14138.4,-26.0662], Tmin=(889.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-103.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2sFO) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = '[O]C([O])COF(1516)',
...
"""),
    E0 = (-30.7115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,180,180,1644.96,1645.08],'cm^-1')),
        HinderedRotor(inertia=(0.171871,'amu*angstrom^2'), symmetry=1, barrier=(3.95166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171788,'amu*angstrom^2'), symmetry=1, barrier=(3.94974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92789,0.0578179,-0.000113586,1.20516e-07,-4.71693e-11,-3630.98,22.3138], Tmin=(100,'K'), Tmax=(844.53,'K')), NASAPolynomial(coeffs=[0.779369,0.0336334,-1.80138e-05,3.53679e-09,-2.45388e-13,-2380.53,33.9154], Tmin=(844.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.7115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)[CH]OF(1517)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
...
"""),
    E0 = (-72.6942,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,345.41,361.013,1956.91],'cm^-1')),
        HinderedRotor(inertia=(0.0815455,'amu*angstrom^2'), symmetry=1, barrier=(7.18582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0836244,'amu*angstrom^2'), symmetry=1, barrier=(7.15597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27463,'amu*angstrom^2'), symmetry=1, barrier=(23.1368,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39858,0.0636928,-0.000108818,9.72253e-08,-3.37818e-11,-8655.66,24.2512], Tmin=(100,'K'), Tmax=(825.529,'K')), NASAPolynomial(coeffs=[8.04523,0.0206156,-1.07922e-05,2.11051e-09,-1.46618e-13,-9382.61,-4.2969], Tmin=(825.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.6942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.983406,'amu*angstrom^2'), symmetry=1, barrier=(22.6104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.97627,'amu*angstrom^2'), symmetry=1, barrier=(22.4464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.981661,'amu*angstrom^2'), symmetry=1, barrier=(22.5703,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.27671,0.068768,-8.88608e-05,5.08479e-08,-1.05578e-11,-44928.6,20.6877], Tmin=(100,'K'), Tmax=(1378.37,'K')), NASAPolynomial(coeffs=[20.819,-0.00376879,4.14054e-06,-9.35546e-10,6.80908e-14,-49363.9,-80.5558], Tmin=(1378.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2sCF) + group(Cds-CdsCsCs) + group(Cds-CdsOsH)"""),
)
...
"""),
    E0 = (-345.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,180,180,704.696,704.806,704.807,704.835],'cm^-1')),
        HinderedRotor(inertia=(0.00834879,'amu*angstrom^2'), symmetry=1, barrier=(2.94236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00833904,'amu*angstrom^2'), symmetry=1, barrier=(2.93906,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-228.633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,510.821,510.821,510.823,510.825,510.828,510.828,510.831],'cm^-1')),
        HinderedRotor(inertia=(0.000646029,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000646038,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0338,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.79855,0.0320485,-1.23321e-05,-3.41955e-08,4.01128e-11,-27460.8,16.0803], Tmin=(100,'K'), Tmax=(448.379,'K')), NASAPolynomial(coeffs=[4.35852,0.0252448,-1.33663e-05,2.72208e-09,-1.97617e-13,-27672.2,9.00829], Tmin=(448.379,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCOF(1498)'],
    products = ['O=C(O)COF(1480)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(125)', '[CH2]C(=O)O(1218)'],
    products = ['O=C(O)COF(1480)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(161)', '[CH2]OF(1347)'],
    products = ['O=C(O)COF(1480)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)[CH]OF(1298)'],
    products = ['O=C(O)COF(1480)'],
