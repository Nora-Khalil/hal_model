...
reaction(
    label = 'reaction1',
    reactants = ['O(7)', 'C2HF(57)'],
    products = ['O=C[C]F(921)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C[C]F(921)'],
    products = ['FC1=CO1(1027)'],
    transitionState = 'TS3',
