...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)[CH]F(768)'],
    products = ['[O]C(F)C([O])F(798)'],
    transitionState = 'TS2',
