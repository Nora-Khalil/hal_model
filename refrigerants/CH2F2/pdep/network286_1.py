...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O[CH]OC(F)(F)F(885)'],
    products = ['OC(F)OC(F)(F)F(723)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)O[C](F)F(886)'],
    products = ['OC(F)OC(F)(F)F(723)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'F[CH]OC(F)(F)F(415)'],
    products = ['OC(F)OC(F)(F)F(723)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[O]C(F)OC(F)(F)F(887)'],
    products = ['OC(F)OC(F)(F)F(723)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'O[C](F)OC(F)(F)F(317)'],
    products = ['OC(F)OC(F)(F)F(723)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=COC(F)(F)F(328)'],
    products = ['OC(F)OC(F)(F)F(723)'],
