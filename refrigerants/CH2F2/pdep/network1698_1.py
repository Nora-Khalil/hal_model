...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(O)(F)O[C](O)F(5039)'],
    products = ['O=C(F)OC(O)(O)F(4958)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O=C(F)O[C](O)O(5040)'],
    products = ['O=C(F)OC(O)(O)F(4958)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=[C]OC(O)(O)F(5041)'],
    products = ['O=C(F)OC(O)(O)F(4958)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)F(142)', 'O[C](O)F(2341)'],
    products = ['O=C(F)OC(O)(O)F(4958)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CFO(50)', '[O]C(O)(O)F(3682)'],
    products = ['O=C(F)OC(O)(O)F(4958)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', 'O=C(F)O[C](O)F(369)'],
    products = ['O=C(F)OC(O)(O)F(4958)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(O)(F)OC(=O)F(4953)'],
    products = ['O=C(F)OC(O)(O)F(4958)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(F)OC(O)(O)F(4958)'],
    products = ['O=C(O)F(140)', 'O=C(O)F(140)'],
