...
"""),
    E0 = (-249.934,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,482,586,761,1411,180,180.005,207.164,1031.71,1031.75],'cm^-1')),
        HinderedRotor(inertia=(0.0306987,'amu*angstrom^2'), symmetry=1, barrier=(23.1895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00844,'amu*angstrom^2'), symmetry=1, barrier=(23.1887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20292,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6517,0.0519785,-5.36307e-05,2.70525e-08,-5.44502e-12,-29975.8,22.9255], Tmin=(100,'K'), Tmax=(1191.39,'K')), NASAPolynomial(coeffs=[12.3747,0.015977,-8.30372e-06,1.68888e-09,-1.2276e-13,-32530.9,-30.6844], Tmin=(1191.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-249.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsFHOO) + radical(OCOJ) + radical(CsF1sO2sO2s)"""),
)

species(
    label = 'O[CH]O[C](F)OF(1275)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-466.906,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,1855,455,950,234.159,234.299,234.503],'cm^-1')),
        HinderedRotor(inertia=(1.15203,'amu*angstrom^2'), symmetry=1, barrier=(44.8919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15184,'amu*angstrom^2'), symmetry=1, barrier=(44.9023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.722779,'amu*angstrom^2'), symmetry=1, barrier=(28.1116,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66541,0.0551257,-7.2161e-05,4.79986e-08,-1.27859e-11,-56075,19.3165], Tmin=(100,'K'), Tmax=(912.117,'K')), NASAPolynomial(coeffs=[10.4231,0.0167198,-9.00141e-06,1.83523e-09,-1.33097e-13,-57672.6,-22.1285], Tmin=(912.117,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-466.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFHOO) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=CO[CH]OF(1276)'],
    products = ['O=COC(F)OF(1263)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)OC=O(1277)'],
    products = ['O=COC(F)OF(1263)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]OF(717)', '[O]C=O(141)'],
    products = ['O=COC(F)OF(1263)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(125)', 'O=CO[CH]F(804)'],
    products = ['O=COC(F)OF(1263)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]OC(F)OF(1278)'],
    products = ['O=COC(F)OF(1263)'],
