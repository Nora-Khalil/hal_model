...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)CC[C](F)F(1167)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1166)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(162)', '[CH2]C[C](F)F(1272)'],
    products = ['F[C](F)CC[C](F)F(1167)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2CF2(56)', '[CH2][C](F)F(1096)'],
    products = ['F[C](F)CC[C](F)F(1167)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', 'F[C](F)CC=C(F)F(1213)'],
    products = ['F[C](F)CC[C](F)F(1167)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C](F)F(1096)', '[CH2][C](F)F(1096)'],
    products = ['F[C](F)CC[C](F)F(1167)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(42)', '[CH2]C[C](F)F(1272)'],
    products = ['F[C](F)CC[C](F)F(1167)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)CC[C](F)F(1167)'],
    products = ['F[C](F)C[CH]C(F)F(1275)'],
