...
"""),
    E0 = (-710.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3000,3100,440,815,1455,1000,180,921.799],'cm^-1')),
        HinderedRotor(inertia=(0.247701,'amu*angstrom^2'), symmetry=1, barrier=(5.69512,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction6',
    reactants = ['OH(5)', '[CH2]OC(F)(F)F(1780)'],
    products = ['OCOC(F)(F)F(1594)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[O]COC(F)(F)F(1781)'],
    products = ['OCOC(F)(F)F(1594)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'O[CH]OC(F)(F)F(885)'],
    products = ['OCOC(F)(F)F(1594)'],
    transitionState = 'TS8',
