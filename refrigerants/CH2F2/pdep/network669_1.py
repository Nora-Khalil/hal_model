...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C=C=O(1730)'],
    products = ['[O]C(F)(F)C[C]=O(1665)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]CC(=O)F(1731)'],
    products = ['[O]C(F)(F)C[C]=O(1665)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=[C][CH]C(=O)F(1732)'],
    products = ['[O]C(F)(F)C[C]=O(1665)'],
