...
reaction(
    label = 'reaction6',
    reactants = ['FOF(305)', 'C=C(O)F(1537)'],
    products = ['OC(F)(F)COF(1488)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]CC(O)(F)F(1539)'],
    products = ['OC(F)(F)COF(1488)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(125)', '[CH2]C(O)(F)F(977)'],
    products = ['OC(F)(F)COF(1488)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)COF(1541)'],
    products = ['OC(F)(F)COF(1488)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(220)', '[CH2]OF(1347)'],
    products = ['OC(F)(F)COF(1488)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]OF(915)'],
    products = ['OC(F)(F)COF(1488)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)COF(1542)'],
    products = ['OC(F)(F)COF(1488)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CC(O)(F)F(920)'],
    products = ['OC(F)(F)COF(1488)'],
