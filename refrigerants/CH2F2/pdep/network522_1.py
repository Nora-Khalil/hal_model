...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[O]C[O](1374)'],
    products = ['[O]CO[C](F)F(1353)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]O[C](F)F(1051)'],
    products = ['[O]CO[C](F)F(1353)'],
    transitionState = 'TS3',
