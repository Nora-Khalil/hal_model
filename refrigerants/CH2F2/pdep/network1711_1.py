...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.94682,'amu*angstrom^2'), symmetry=1, barrier=(67.7533,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00327,0.0620773,-0.000147615,1.64497e-07,-6.4762e-11,-51092.5,18.8103], Tmin=(100,'K'), Tmax=(861.133,'K')), NASAPolynomial(coeffs=[-1.83325,0.0342592,-1.96609e-05,3.89272e-09,-2.6872e-13,-48739.5,46.5709], Tmin=(861.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(CsFOOO) + radical(OCOJ) + radical(ROOJ)"""),
)
...
"""),
    E0 = (-349.866,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0675346,'amu*angstrom^2'), symmetry=1, barrier=(52.6964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166869,'amu*angstrom^2'), symmetry=1, barrier=(52.6282,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28472,0.0629887,-0.000168266,2.06333e-07,-8.6388e-11,-42041.9,16.8181], Tmin=(100,'K'), Tmax=(849.539,'K')), NASAPolynomial(coeffs=[-9.24674,0.0510023,-3.00717e-05,6.0473e-09,-4.22585e-13,-37690.8,84.6476], Tmin=(849.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-349.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(CsFOOO) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[O]O[C](O)OF(1018)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00238736,'amu*angstrom^2'), symmetry=1, barrier=(6.50873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21466,0.0593513,-0.000149696,1.74476e-07,-7.08306e-11,-105.913,21.4004], Tmin=(100,'K'), Tmax=(853.101,'K')), NASAPolynomial(coeffs=[-4.33462,0.0386031,-2.27387e-05,4.56042e-09,-3.17707e-13,2883.98,62.9308], Tmin=(853.101,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.25383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2sFO) + group(Cs-OsOsOsH) + radical(OCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([O])(O)F(4285)'],
    products = ['O=O(177)', 'O=C(O)F(134)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[O]C([O])(O)F(4301)'],
    products = ['[O]OC([O])(O)F(4285)'],
    transitionState = 'TS2',
