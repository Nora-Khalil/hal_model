...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'FO[CH]OC(F)F(844)'],
    products = ['FOC(F)OC(F)F(721)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]OC(F)OF(845)'],
    products = ['FOC(F)OC(F)F(721)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)OC(F)F(846)'],
    products = ['FOC(F)OC(F)F(721)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]OF(553)', '[O]C(F)F(170)'],
    products = ['FOC(F)OC(F)F(721)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(203)', 'F[CH]OC(F)F(686)'],
    products = ['FOC(F)OC(F)F(721)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'FO[C](F)OC(F)F(296)'],
    products = ['FOC(F)OC(F)F(721)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', 'FOC(F)O[C](F)F(847)'],
    products = ['FOC(F)OC(F)F(721)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)OC(F)F(167)'],
    products = ['FOC(F)OC(F)F(721)'],
