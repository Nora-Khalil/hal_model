...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C1O[C]1F(2879)'],
    products = ['[O]C(F)C1O[C]1F(2806)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)C1=C(F)O1(2943)'],
    products = ['[O]C(F)C1O[C]1F(2806)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=CC1O[C]1F(2944)'],
    products = ['[O]C(F)C1O[C]1F(2806)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C(F)C1O[C]1F(2840)'],
    products = ['[O]C(F)C1O[C]1F(2806)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C[C]1O[C]1F(2945)'],
    products = ['[O]C(F)C1O[C]1F(2806)'],
