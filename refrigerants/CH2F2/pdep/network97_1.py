...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FOOOOC(F)F(400)'],
    products = ['FC(F)OOOOC(F)F(286)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[CH]OOOOC(F)F(401)'],
    products = ['FC(F)OOOOC(F)F(286)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(170)', '[O]OOC(F)F(225)'],
    products = ['FC(F)OOOOC(F)F(286)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF2(81)', '[O]OOOC(F)F(210)'],
    products = ['FC(F)OOOOC(F)F(286)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', 'F[C](F)OOOOC(F)F(402)'],
    products = ['FC(F)OOOOC(F)F(286)'],
    transitionState = 'TS7',
