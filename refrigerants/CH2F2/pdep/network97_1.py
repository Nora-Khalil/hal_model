...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[O]C([O])(F)F(150)'],
    products = ['[O]C(F)(F)O[C](F)F(266)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[C](F)O[C](F)F(269)'],
    products = ['[O]C(F)(F)O[C](F)F(266)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[C](F)F(271)'],
    products = ['[O]C(F)(F)O[C](F)F(266)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(237)', '[O][C](F)F(237)'],
    products = ['[O]C(F)(F)O[C](F)F(266)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2(42)', '[O]C([O])(F)F(150)'],
    products = ['[O]C(F)(F)O[C](F)F(266)'],
    transitionState = 'TS8',
