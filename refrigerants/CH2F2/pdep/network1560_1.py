...
"""),
    E0 = (-184.216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,272.347],'cm^-1')),
        HinderedRotor(inertia=(0.00274426,'amu*angstrom^2'), symmetry=1, barrier=(6.12829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116508,'amu*angstrom^2'), symmetry=1, barrier=(6.12963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116625,'amu*angstrom^2'), symmetry=1, barrier=(6.14288,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0872,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54762,0.0584196,-7.00204e-05,5.07071e-08,-1.55335e-11,-22071.8,18.6808], Tmin=(100,'K'), Tmax=(783.134,'K')), NASAPolynomial(coeffs=[7.31901,0.0289395,-1.35517e-05,2.63375e-09,-1.86164e-13,-22975.7,-7.75169], Tmin=(783.134,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(RCCJ)"""),
)
...
"""),
    E0 = (-156.817,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,190,488,555,1236,1407,3000,3100,440,815,1455,1000,180,2551.18],'cm^-1')),
        HinderedRotor(inertia=(0.107938,'amu*angstrom^2'), symmetry=1, barrier=(2.48171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107926,'amu*angstrom^2'), symmetry=1, barrier=(2.48144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108926,'amu*angstrom^2'), symmetry=1, barrier=(2.50442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0872,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82573,0.0532623,-6.99876e-05,6.39985e-08,-2.46844e-11,-18787.7,21.9813], Tmin=(100,'K'), Tmax=(769.67,'K')), NASAPolynomial(coeffs=[3.7813,0.0344892,-1.66209e-05,3.23943e-09,-2.27976e-13,-18833.7,14.7155], Tmin=(769.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (92.0872,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03463,0.0475596,-4.64927e-05,3.16636e-08,-1.01399e-11,-24214.3,18.8044], Tmin=(100,'K'), Tmax=(720.578,'K')), NASAPolynomial(coeffs=[4.70953,0.0327113,-1.55841e-05,3.06812e-09,-2.19102e-13,-24599.8,6.77608], Tmin=(720.578,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.885,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-HHH)(H)) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[C](F)CF(4479)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])(F)F(4439)'],
    products = ['CH2CF2(56)', 'C2H4(30)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC[C](F)F(4440)'],
    products = ['[CH2]CC([CH2])(F)F(4439)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C[C](F)F(1142)'],
    products = ['[CH2]CC([CH2])(F)F(4439)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C([CH2])(F)F(1147)'],
    products = ['[CH2]CC([CH2])(F)F(4439)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]CC(=C)F(4474)'],
    products = ['[CH2]CC([CH2])(F)F(4439)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CF2(56)', '[CH2][CH2](1598)'],
    products = ['[CH2]CC([CH2])(F)F(4439)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C](F)F(933)', 'C2H4(30)'],
    products = ['[CH2]CC([CH2])(F)F(4439)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C(4475)'],
    products = ['[CH2]CC([CH2])(F)F(4439)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C](F)F(933)', '[CH2][CH2](1598)'],
    products = ['[CH2]CC([CH2])(F)F(4439)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C=C([CH2])F(4476)'],
    products = ['[CH2]CC([CH2])(F)F(4439)'],
