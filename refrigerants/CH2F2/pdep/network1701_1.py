...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3648.6,'J/mol'), sigma=(5.64233,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=569.90 K, Pc=46.09 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-694.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,3615,1277.5,1000,482,586,761,1411,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(OF)O[C](O)F(5032)'],
    products = ['O=C(OF)OC(O)F(4961)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(OF)O[CH]O(5036)'],
    products = ['O=C(OF)OC(O)F(4961)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)OC(O)F(5037)'],
    products = ['O=C(OF)OC(O)F(4961)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(365)', 'O[CH]F(292)'],
    products = ['O=C(OF)OC(O)F(4961)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]OF(146)', '[O]C(O)F(927)'],
    products = ['O=C(OF)OC(O)F(4961)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=C(OF)O[CH]F(363)'],
    products = ['O=C(OF)OC(O)F(4961)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)OC(=O)OF(4956)'],
    products = ['O=C(OF)OC(O)F(4961)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(125)', 'O=[C]OC(O)F(1307)'],
    products = ['O=C(OF)OC(O)F(4961)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C(OF)O[C](O)F(4987)'],
    products = ['O=C(OF)OC(O)F(4961)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=COC(=O)OF(399)'],
    products = ['O=C(OF)OC(O)F(4961)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(OF)OC(O)F(4961)'],
    products = ['F2(77)', 'CO2(14)', 'O=CO(168)'],
