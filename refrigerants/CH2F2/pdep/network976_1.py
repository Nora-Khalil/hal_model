...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(187)', '[CH]C(=O)F-2(2474)'],
    products = ['[CH]=C(F)O[C]=O(2472)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CO(13)', '[CH]C(=O)F-2(2474)'],
    products = ['[CH]=C(F)O[C]=O(2472)'],
    transitionState = 'TS4',
