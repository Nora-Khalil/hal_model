...
reaction(
    label = 'reaction6',
    reactants = ['OF(147)', 'C=C(F)OF(1532)'],
    products = ['OCC(F)(F)OF(1487)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)(F)CO(1534)'],
    products = ['OCC(F)(F)OF(1487)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]C(F)(F)OF(1188)'],
    products = ['OCC(F)(F)OF(1487)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]CC(F)(F)OF(1535)'],
    products = ['OCC(F)(F)OF(1487)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(125)', 'OC[C](F)F(976)'],
    products = ['OCC(F)(F)OF(1487)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(221)', 'CH2OH(33)'],
    products = ['OCC(F)(F)OF(1487)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O[CH]C(F)(F)OF(906)'],
    products = ['OCC(F)(F)OF(1487)'],
