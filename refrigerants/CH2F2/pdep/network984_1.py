...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'FC1=C(F)[CH]1(4492)'],
    products = ['FC1=CC1(F)F(2479)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC1(F)[C]=C1(4493)'],
    products = ['FC1=CC1(F)F(2479)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', 'FC1=[C]C1(F)F(4494)'],
    products = ['FC1=CC1(F)F(2479)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'FC1=C=C1F(4497)'],
    products = ['FC1=CC1(F)F(2479)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1(F)C#C1(4498)'],
    products = ['FC1=CC1(F)F(2479)'],
