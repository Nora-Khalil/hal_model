...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(129)', '[O]O[CH]F(128)'],
    products = ['F[CH]OO[CH]F(800)'],
    transitionState = 'TS2',
