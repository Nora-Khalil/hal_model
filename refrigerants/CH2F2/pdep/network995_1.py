...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C(F)F(2309)'],
    products = ['[CH]=CC([O])(F)F(2305)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(237)', '[CH]=[CH](1596)'],
    products = ['[CH]=CC([O])(F)F(2305)'],
    transitionState = 'TS8',
