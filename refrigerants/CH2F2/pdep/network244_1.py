...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.687088,'amu*angstrom^2'), symmetry=1, barrier=(15.7975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.682754,'amu*angstrom^2'), symmetry=1, barrier=(15.6979,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'FCC(F)(F)OF(617)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'F[C]C(F)(F)OF(303)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(633)', 'F[C]CF(578)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(305)', 'F[C]C(F)(F)CF(634)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)(F)C(F)(F)OF(635)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'FOC(F)(F)C(F)F(636)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'FOC(F)(F)C(F)(F)F(637)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(305)', 'FCC(F)=C(F)F(473)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[C](F)C(F)(F)OF(639)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FCC(F)(F)[C](F)OF(640)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)(F)OF(641)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)(F)C(F)(F)CF(642)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(125)', 'FCC(F)(F)[C](F)F(392)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FO[C](F)F(221)', 'CH2F-CF2(67)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(45)', 'FOC(F)(F)[C](F)F(312)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)(F)OF(643)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'O=C(F)C(F)(F)CF(644)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(77)', 'FCC(F)=C(F)OF(645)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(77)', 'C=C(F)C(F)(F)OF(646)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'FC=C(F)C(F)(F)OF(647)'],
    products = ['FCC(F)(F)C(F)(F)OF(614)'],
