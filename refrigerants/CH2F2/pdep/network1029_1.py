...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(185)', 'O[C]F-2(1323)'],
    products = ['[O]C(=O)O[C](O)F(420)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([O])=O(185)', 'O[C]F(432)'],
    products = ['[O]C(=O)O[C](O)F(420)'],
