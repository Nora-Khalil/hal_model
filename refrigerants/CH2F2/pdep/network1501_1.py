...
"""),
    E0 = (-561.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,182,240,577,636,1210,1413,180,1817.26],'cm^-1')),
        HinderedRotor(inertia=(0.122595,'amu*angstrom^2'), symmetry=1, barrier=(2.8187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123578,'amu*angstrom^2'), symmetry=1, barrier=(2.84129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120867,'amu*angstrom^2'), symmetry=1, barrier=(2.77896,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.988363,0.0759419,-0.00013108,1.2323e-07,-4.47429e-11,-67393,26.7899], Tmin=(100,'K'), Tmax=(833.253,'K')), NASAPolynomial(coeffs=[6.03303,0.0320232,-1.65518e-05,3.22227e-09,-2.23329e-13,-67549.8,7.47675], Tmin=(833.253,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-561.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[CH2]C(OF)C([O])(F)F(4290)',
...
"""),
    E0 = (-307.173,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,3000,3100,440,815,1455,1000,267.801,267.803],'cm^-1')),
        HinderedRotor(inertia=(0.125982,'amu*angstrom^2'), symmetry=1, barrier=(6.41426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125976,'amu*angstrom^2'), symmetry=1, barrier=(6.41346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322518,'amu*angstrom^2'), symmetry=1, barrier=(16.4012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.501299,0.0821708,-0.000121243,9.1116e-08,-2.70408e-11,-36823.1,26.7616], Tmin=(100,'K'), Tmax=(827.289,'K')), NASAPolynomial(coeffs=[13.0966,0.0212713,-1.0822e-05,2.13344e-09,-1.50828e-13,-38907.1,-31.6153], Tmin=(827.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-307.173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(CJCO)"""),
)

species(
    label = 'C[C](OF)C([O])(F)F(4291)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.203849,'amu*angstrom^2'), symmetry=1, barrier=(4.68689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204291,'amu*angstrom^2'), symmetry=1, barrier=(4.69705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204434,'amu*angstrom^2'), symmetry=1, barrier=(4.70034,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.509249,0.084929,-0.000143632,1.26539e-07,-4.33731e-11,-40613.2,26.5078], Tmin=(100,'K'), Tmax=(829.285,'K')), NASAPolynomial(coeffs=[9.8873,0.0263714,-1.3615e-05,2.64478e-09,-1.82981e-13,-41710.5,-14.2182], Tmin=(829.285,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-338.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(C2CsJO)"""),
)
...
"""),
    E0 = (-401.955,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,526,555,698,907,1200,1145,1227,350,440,435,1725,2950,3100,1380,975,1025,1650,196.951,198.848,199.471],'cm^-1')),
        HinderedRotor(inertia=(0.329358,'amu*angstrom^2'), symmetry=1, barrier=(8.7221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56953,'amu*angstrom^2'), symmetry=1, barrier=(43.6408,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08144,0.0697579,-0.000100126,7.70316e-08,-2.39619e-11,-48244,23.7635], Tmin=(100,'K'), Tmax=(783.353,'K')), NASAPolynomial(coeffs=[10.0359,0.0240329,-1.25667e-05,2.5132e-09,-1.79381e-13,-49646.9,-17.2499], Tmin=(783.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-401.955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sF1sCd))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.478794,'amu*angstrom^2'), symmetry=1, barrier=(11.0084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.478988,'amu*angstrom^2'), symmetry=1, barrier=(11.0129,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.216863,'amu*angstrom^2'), symmetry=1, barrier=(4.9861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215343,'amu*angstrom^2'), symmetry=1, barrier=(4.95115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.8356,'amu*angstrom^2'), symmetry=1, barrier=(19.2121,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.427629,0.0892505,-0.000164528,1.50687e-07,-5.24842e-11,-48336,24.9893], Tmin=(100,'K'), Tmax=(848.566,'K')), NASAPolynomial(coeffs=[9.512,0.0251777,-1.3703e-05,2.6804e-09,-1.84701e-13,-49112.6,-12.8376], Tmin=(848.566,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-402.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(OF)C(O)(F)F(4298)',
...
"""),
    E0 = (-368.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,255,533,799,832,1228,2950,3100,1380,975,1025,1650,211.158,211.159],'cm^-1')),
        HinderedRotor(inertia=(0.462981,'amu*angstrom^2'), symmetry=1, barrier=(14.6481,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00481759,'amu*angstrom^2'), symmetry=1, barrier=(31.5571,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57051,0.0569986,-7.65961e-05,5.3795e-08,-1.51252e-11,-44272.7,19.6777], Tmin=(100,'K'), Tmax=(867.35,'K')), NASAPolynomial(coeffs=[10.0584,0.0178529,-8.89409e-06,1.75518e-09,-1.24831e-13,-45745,-20.063], Tmin=(867.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-368.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-Cds(Cds-O2d)O2s) + group(COCFO) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'C=C(O)OF(4270)'],
    products = ['C=C(OF)C(O)(F)F(4267)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OF(147)', 'C=C([C]F)OF(4287)'],
    products = ['C=C(OF)C(O)(F)F(4267)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(OF)C([O])(F)F(4290)'],
    products = ['C=C(OF)C(O)(F)F(4267)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(OF)=C(O)F(4292)'],
    products = ['C=C(OF)C(O)(F)F(4267)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'C=C(OF)[C](F)F(4294)'],
    products = ['C=C(OF)C(O)(F)F(4267)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(OF)C([O])(F)F(4295)'],
    products = ['C=C(OF)C(O)(F)F(4267)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(125)', 'C=[C]C(O)(F)F(4296)'],
    products = ['C=C(OF)C(O)(F)F(4267)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](F)F(220)', 'C=[C]OF(1653)'],
    products = ['C=C(OF)C(O)(F)F(4267)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C(OF)C(O)(F)F(4297)'],
    products = ['C=C(OF)C(O)(F)F(4267)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C(OF)C(O)(F)F(4298)'],
    products = ['C=C(OF)C(O)(F)F(4267)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'C=C(OF)C(=O)F(4299)'],
    products = ['C=C(OF)C(O)(F)F(4267)'],
