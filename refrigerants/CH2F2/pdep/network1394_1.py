species(
    label = 'O=C(F)[CH]OC(F)(F)[CH]F(3492)',
...
species(
    label = 'F[CH]C(F)(F)OC1O[C]1F(3602)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C1(F)[CH]OC(F)(F)C1F(3552)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.21527,'amu*angstrom^2'), symmetry=1, barrier=(27.9415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21758,'amu*angstrom^2'), symmetry=1, barrier=(27.9947,'kJ/mol'), semiclassical=False),
...
species(
    label = 'O=C(F)C(F)O[C](F)[CH]F(3605)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.15012,'amu*angstrom^2'), symmetry=1, barrier=(26.4436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15251,'amu*angstrom^2'), symmetry=1, barrier=(26.4985,'kJ/mol'), semiclassical=False),
...
species(
    label = '[O]C(F)(C=O)C(F)(F)[CH]F(3491)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.16175,'amu*angstrom^2'), symmetry=1, barrier=(26.7109,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15928,'amu*angstrom^2'), symmetry=1, barrier=(26.6541,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16161,'amu*angstrom^2'), symmetry=1, barrier=(26.7078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.149017,0.0924596,-0.000126649,8.23729e-08,-2.06482e-11,-62422.2,27.356], Tmin=(100,'K'), Tmax=(985.299,'K')), NASAPolynomial(coeffs=[19.2168,0.0138403,-6.95997e-06,1.38904e-09,-1.00029e-13,-66238.4,-65.7857], Tmin=(985.299,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-520.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)

species(
    label = 'FC1=COC(F)(F)C(F)O1(3518)',
...
"""),
    ...
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.613089,0.104538,-0.000148135,1.00009e-07,-2.60829e-11,-89038.5,32.2054], Tmin=(100,'K'), Tmax=(946.507,'K')), NASAPolynomial(coeffs=[20.2204,0.0164942,-8.6043e-06,1.73082e-09,-1.24662e-13,-92982.3,-67.1585], Tmin=(946.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-741.668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H)) + radical(C=CJO)"""),
)

species(
    label = '[O]C(F)=[C]OC(F)(F)CF(3610)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-800.865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,528,1116,1182,1331,1402,1494,3075,3110,293,496,537,1218,1685,370,387.132,387.132,387.132,387.132,387.132,387.132],'cm^-1')),
        HinderedRotor(inertia=(0.148068,'amu*angstrom^2'), symmetry=1, barrier=(15.7474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262859,'amu*angstrom^2'), symmetry=1, barrier=(27.9556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262859,'amu*angstrom^2'), symmetry=1, barrier=(27.9556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.157968,0.0892504,-0.000113739,7.19738e-08,-1.80708e-11,-96187.4,30.6897], Tmin=(100,'K'), Tmax=(969.359,'K')), NASAPolynomial(coeffs=[15.9472,0.0241012,-1.29325e-05,2.64982e-09,-1.93144e-13,-99248.7,-44.994], Tmin=(969.359,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-800.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = 'F[CH][C](F)OC=C(F)OF(3611)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F-2(3116)', '[O]C(F)(F)[CH]F(453)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(129)', 'O=C(F)[CH]O[C](F)F(2827)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
    products = ['F[CH]C(F)(F)OC1O[C]1F(3602)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
    products = ['F[C]1[CH]OC(F)(F)C(F)O1(3506)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
    products = ['[O]C1(F)[CH]OC(F)(F)C1F(3552)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)[CH]OC(F)=CF(3603)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=C=COC(F)(F)[CH]F(3604)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'O=C(F)[CH]O[C](F)F(2827)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C(F)C(F)O[C](F)[CH]F(3605)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)=CO[C](F)C(F)F(3534)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
    products = ['[O][C]=COC(F)(F)C(F)F(3606)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(C=O)C(F)(F)[CH]F(3491)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(6)', 'F[C]=COC(F)(F)[CH]F(3607)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
    products = ['FC1=COC(F)(F)C(F)O1(3518)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
    products = ['[O][C](F)C1OC(F)(F)C1F(3608)'],
...
reaction(
    label = 'reaction23',
    reactants = ['OC(F)=[C]OC(F)(F)[CH]F(3609)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)=[C]OC(F)(F)CF(3610)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[CH][C](F)OC=C(F)OF(3611)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F[CH]C(F)(F)OC=[C]OF(3612)'],
    products = ['O=C(F)[CH]OC(F)(F)[CH]F(3492)'],
