...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=CCOF(4314)'],
    products = ['O=CCC(=O)OF(4646)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(147)', 'O=C=CC=O(1621)'],
    products = ['O=CCC(=O)OF(4646)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)CC=O(4737)'],
    products = ['O=CCC(=O)OF(4646)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(125)', 'O=[C]CC=O(3870)'],
    products = ['O=CCC(=O)OF(4646)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(146)', 'CH2CHO(35)'],
    products = ['O=CCC(=O)OF(4646)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HCO(15)', '[CH2]C(=O)OF(1166)'],
    products = ['O=CCC(=O)OF(4646)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C=CC(=O)OF(4738)'],
    products = ['O=CCC(=O)OF(4646)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O=[C]CC(=O)OF(4739)'],
    products = ['O=CCC(=O)OF(4646)'],
