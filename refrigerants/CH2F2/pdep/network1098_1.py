...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(150)', '[CH]C-2(1597)'],
    products = ['C[CH]OC([O])(F)F(2481)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C=COC([O])(F)F(2495)'],
    products = ['C[CH]OC([O])(F)F(2481)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[CH]OC(=O)F(2496)'],
    products = ['C[CH]OC([O])(F)F(2481)'],
    transitionState = 'TS8',
