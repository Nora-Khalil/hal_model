...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[C-]=[O+]OF(4507)'],
    products = ['[C-]=[O+]OC(=O)F(4505)'],
    transitionState = 'TS2',
