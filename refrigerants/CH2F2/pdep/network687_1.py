...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH2]C(=C)[O](1917)'],
    products = ['C=C([O])C[C](F)F(1681)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C[C](F)F(1918)'],
    products = ['C=C([O])C[C](F)F(1681)'],
    transitionState = 'TS4',
...
reaction(
    ...
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.17979e+10,'s^-1'), n=0.520585, Ea=(207.68,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=C([O])C=C(F)F(1860)'],
    products = ['C=C([O])C[C](F)F(1681)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(42)', '[CH2]C(=C)[O](1917)'],
    products = ['C=C([O])C[C](F)F(1681)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(18)', 'O=[C]C[C](F)F(1039)'],
    products = ['C=C([O])C[C](F)F(1681)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C([O])C[C](F)F(1681)'],
    products = ['[CH2][C]1CC(F)(F)O1(1928)'],
