...
"""),
    E0 = (39.6727,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655,167,640,1190],'cm^-1')),
        HinderedRotor(inertia=(0.396155,'amu*angstrom^2'), symmetry=1, barrier=(9.10839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.396111,'amu*angstrom^2'), symmetry=1, barrier=(9.10737,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0344,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.56585,0.0418089,-0.000105232,1.61742e-07,-9.94491e-11,4771.68,11.0037], Tmin=(10,'K'), Tmax=(435.728,'K')), NASAPolynomial(coeffs=[5.95239,0.0171837,-1.11077e-05,3.42229e-09,-4.02867e-13,4589.49,1.76857], Tmin=(435.728,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(39.6727,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""OOCD[C]F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (504.009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655],'cm^-1')),
        HinderedRotor(inertia=(0.660797,'amu*angstrom^2'), symmetry=1, barrier=(15.193,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.661041,'amu*angstrom^2'), symmetry=1, barrier=(15.1986,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (58.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.66511,0.0319797,-5.01489e-05,4.26159e-08,-1.44796e-11,60663.9,14.8209], Tmin=(100,'K'), Tmax=(754.627,'K')), NASAPolynomial(coeffs=[6.51466,0.0104855,-5.25906e-06,1.04582e-09,-7.42118e-14,60113.9,-2.46172], Tmin=(754.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(504.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CdCdJ2_triplet)"""),
)
...
"""),
    E0 = (71.4217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2175,525,239,401,1367],'cm^-1')),
        HinderedRotor(inertia=(0.281051,'amu*angstrom^2'), symmetry=1, barrier=(6.46192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31285,'amu*angstrom^2'), symmetry=1, barrier=(30.1849,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0265,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.78241,0.0182429,6.89228e-05,-3.15821e-07,3.38621e-10,8588.02,10.1721], Tmin=(10,'K'), Tmax=(363.893,'K')), NASAPolynomial(coeffs=[6.23457,0.0143645,-1.02125e-05,3.426e-09,-4.31892e-13,8256.77,-1.2786], Tmin=(363.893,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(71.4217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), label="""OOC#CF""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OOC=[C]F(2649)'],
    products = ['OH(7)', 'FC1=CO1(1231)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.2122e+14,'s^-1'), n=-0.378125, Ea=(69.0738,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2OO;Y_rad_intra;OOH] for rate rule [R2OO_D;Cd_sec_rad_in;OOH]
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[C]=COO(3125)'],
    products = ['OOC=[C]F(2649)'],
    transitionState = 'TS2',
