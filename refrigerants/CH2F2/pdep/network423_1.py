...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C[C](F)F(1001)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C[C](F)F(1057)'],
    products = ['[O]C(F)(F)C[C](F)F(1001)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C=C(F)F(524)'],
    products = ['[O]C(F)(F)C[C](F)F(1001)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C[C](F)F(1058)'],
    products = ['[O]C(F)(F)C[C](F)F(1001)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)[CH][C](F)F(527)'],
    products = ['[O]C(F)(F)C[C](F)F(1001)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)(F)[CH]C(F)F(1059)'],
    products = ['[O]C(F)(F)C[C](F)F(1001)'],
