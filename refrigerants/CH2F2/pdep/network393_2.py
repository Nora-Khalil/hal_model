...
reaction(
    label = 'reaction1',
    reactants = ['OH(7)', 'CH2CF2(56)'],
    products = ['OC[C](F)F(976)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction10',
    reactants = ['OC[C](F)F(976)'],
    products = ['O[CH]C(F)F(2206)'],
