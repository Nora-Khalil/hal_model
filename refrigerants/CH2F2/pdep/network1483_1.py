...
"""),
    E0 = (-1112.93,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,486,617,768,1157,1926,180,832.208,832.252],'cm^-1')),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.137836,'amu*angstrom^2'), symmetry=1, barrier=(3.16913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.766596,'amu*angstrom^2'), symmetry=1, barrier=(17.6255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78691,0.0518408,-6.64875e-05,4.54501e-08,-1.25464e-11,-54086.9,23.7547], Tmin=(100,'K'), Tmax=(879.967,'K')), NASAPolynomial(coeffs=[9.23679,0.0179765,-8.76227e-06,1.71728e-09,-1.21831e-13,-55398,-11.2341], Tmin=(879.967,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-450.343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(COCsFO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.428274,'amu*angstrom^2'), symmetry=1, barrier=(9.84685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.978544,'amu*angstrom^2'), symmetry=1, barrier=(22.4987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05467,0.0702337,-0.000108778,8.63673e-08,-2.72302e-11,-67312.3,22.2267], Tmin=(100,'K'), Tmax=(777.878,'K')), NASAPolynomial(coeffs=[10.9697,0.0192489,-1.04626e-05,2.10831e-09,-1.50486e-13,-68854.8,-23.117], Tmin=(777.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-560.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + missing(O2d-Cdd) + group(CsCFFO) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'O=C(F)C=C(F)OF(4067)',
    structure = adjacencyList("""1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.257707,'amu*angstrom^2'), symmetry=1, barrier=(5.9252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257053,'amu*angstrom^2'), symmetry=1, barrier=(5.91016,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25087,0.0687526,-0.000120765,1.1274e-07,-4.08324e-11,-66810,23.4125], Tmin=(100,'K'), Tmax=(817.852,'K')), NASAPolynomial(coeffs=[6.8523,0.0259757,-1.40986e-05,2.7966e-09,-1.95932e-13,-67211.8,0.660028], Tmin=(817.852,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cd-Cd(CO)H) + group(CdCFO) + group(COCFO)"""),
)

species(
    label = 'O=C(F)C(O)=C(F)F(4068)',
    structure = adjacencyList("""1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {8,S}
...
"""),
    E0 = (-884.008,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,255,533,799,832,1228,182,240,577,636,1210,1413,305.933],'cm^-1')),
        HinderedRotor(inertia=(0.10507,'amu*angstrom^2'), symmetry=1, barrier=(6.97749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265599,'amu*angstrom^2'), symmetry=1, barrier=(17.6443,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07889,0.0675043,-9.54261e-05,6.65883e-08,-1.8185e-11,-106219,21.5135], Tmin=(100,'K'), Tmax=(900.121,'K')), NASAPolynomial(coeffs=[12.9442,0.0147745,-7.55142e-06,1.50213e-09,-1.07242e-13,-108355,-34.4808], Tmin=(900.121,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-884.008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-O2d)O2s) + group(COCFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'OOC(F)=CC(F)(F)OF(4069)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.312048,'amu*angstrom^2'), symmetry=1, barrier=(7.17461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.315111,'amu*angstrom^2'), symmetry=1, barrier=(7.24502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311659,'amu*angstrom^2'), symmetry=1, barrier=(7.16566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.00193,'amu*angstrom^2'), symmetry=1, barrier=(46.0284,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.342457,0.107054,-0.000189552,1.72544e-07,-6.09981e-11,-89952.5,31.3116], Tmin=(100,'K'), Tmax=(812.232,'K')), NASAPolynomial(coeffs=[10.8187,0.0332844,-1.85903e-05,3.71833e-09,-2.61419e-13,-91145.4,-16.3953], Tmin=(812.232,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-749.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCFO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.369755,'amu*angstrom^2'), symmetry=1, barrier=(8.50139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3666,'amu*angstrom^2'), symmetry=1, barrier=(8.42885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368841,'amu*angstrom^2'), symmetry=1, barrier=(8.48039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562123,'amu*angstrom^2'), symmetry=1, barrier=(12.9243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.774546,0.115805,-0.000206267,1.79964e-07,-6.01544e-11,-91373.4,33.3061], Tmin=(100,'K'), Tmax=(845.551,'K')), NASAPolynomial(coeffs=[14.4248,0.0256251,-1.38647e-05,2.70201e-09,-1.85747e-13,-93290.4,-33.6084], Tmin=(845.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-761.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(C2CsJOH)"""),
)

species(
    label = '[O]C(F)C([O])C(F)(F)OF(4071)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-707.332,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,391,562,707,872,1109,1210,1289,3137,279.553,279.723,279.752,280.234],'cm^-1')),
        HinderedRotor(inertia=(0.131307,'amu*angstrom^2'), symmetry=1, barrier=(7.28646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13128,'amu*angstrom^2'), symmetry=1, barrier=(7.28776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427332,'amu*angstrom^2'), symmetry=1, barrier=(23.8332,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.240462,0.100283,-0.000152378,1.16746e-07,-3.52856e-11,-84926.1,31.7883], Tmin=(100,'K'), Tmax=(812.61,'K')), NASAPolynomial(coeffs=[15.0618,0.0249575,-1.33332e-05,2.67263e-09,-1.90429e-13,-87413,-38.861], Tmin=(812.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-707.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCFHO) + radical(CC(C)OJ) + radical(O2sj(Cs-CsF1sH))"""),
)

species(
    label = '[O]C([C](O)F)C(F)(F)OF(4072)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-739.352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,395,473,707,1436,298.366,298.367,298.367,298.367],'cm^-1')),
        HinderedRotor(inertia=(0.142513,'amu*angstrom^2'), symmetry=1, barrier=(9.00291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433927,'amu*angstrom^2'), symmetry=1, barrier=(27.4123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142513,'amu*angstrom^2'), symmetry=1, barrier=(9.00292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142513,'amu*angstrom^2'), symmetry=1, barrier=(9.00291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.768277,0.114698,-0.000200077,1.72676e-07,-5.76776e-11,-88761.2,33.5673], Tmin=(100,'K'), Tmax=(821.658,'K')), NASAPolynomial(coeffs=[14.861,0.0257464,-1.42041e-05,2.80986e-09,-1.95709e-13,-90895.3,-36.1225], Tmin=(821.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-739.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCFHO) + radical(CC(C)OJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'OC(F)=C(O)C(F)(F)OF(4073)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.701841,'amu*angstrom^2'), symmetry=1, barrier=(16.1367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.702373,'amu*angstrom^2'), symmetry=1, barrier=(16.1489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16956,'amu*angstrom^2'), symmetry=1, barrier=(26.8905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.702172,'amu*angstrom^2'), symmetry=1, barrier=(16.1443,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.789016,0.114317,-0.000186863,1.47212e-07,-4.41512e-11,-124976,28.5536], Tmin=(100,'K'), Tmax=(695.244,'K')), NASAPolynomial(coeffs=[17.0132,0.0227225,-1.26082e-05,2.52156e-09,-1.77798e-13,-127713,-52.743], Tmin=(695.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1040.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    E0 = (-683.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,395,473,707,1436,486,617,768,1157,1926,277.562,277.684,277.788],'cm^-1')),
        HinderedRotor(inertia=(0.00219849,'amu*angstrom^2'), symmetry=1, barrier=(0.12059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107645,'amu*angstrom^2'), symmetry=1, barrier=(5.88747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238447,'amu*angstrom^2'), symmetry=1, barrier=(13.0574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.424943,'amu*angstrom^2'), symmetry=1, barrier=(23.1573,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-698.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,1855,455,950,295.147,295.152],'cm^-1')),
...
"""),
    E0 = (-987.473,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,351,323,533,609,664,892,1120,1201,486,617,768,1157,1926,326.62,326.623],'cm^-1')),
        HinderedRotor(inertia=(0.00158018,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114639,'amu*angstrom^2'), symmetry=1, barrier=(8.67878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114644,'amu*angstrom^2'), symmetry=1, barrier=(8.67877,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.866208,0.0708113,-8.448e-05,4.98839e-08,-1.16479e-11,-118654,30.0568], Tmin=(100,'K'), Tmax=(1041.84,'K')), NASAPolynomial(coeffs=[14.4238,0.0187579,-9.53455e-06,1.92606e-09,-1.3974e-13,-121479,-35.9064], Tmin=(1041.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-987.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCFFO) + group(COCsFO) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    E0 = (-869.2,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,486,617,768,1157,1926,180,180,530.052,845.678],'cm^-1')),
        HinderedRotor(inertia=(0.191675,'amu*angstrom^2'), symmetry=1, barrier=(4.40699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.592659,'amu*angstrom^2'), symmetry=1, barrier=(13.6264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0268438,'amu*angstrom^2'), symmetry=1, barrier=(13.6257,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.422515,0.0840343,-0.000114899,7.81357e-08,-2.10259e-11,-104416,32.021], Tmin=(100,'K'), Tmax=(907.919,'K')), NASAPolynomial(coeffs=[14.5903,0.0216156,-1.17752e-05,2.41378e-09,-1.75492e-13,-106989,-34.9617], Tmin=(907.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-869.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCFFO) + group(COCsFO) + radical(C=OCOJ)"""),
)
...
"""),
    E0 = (-936.305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,253,525,597,667,842,1178,1324,360,370,350,611,648,830,1210,1753,185.126,185.127,185.127],'cm^-1')),
        HinderedRotor(inertia=(0.942661,'amu*angstrom^2'), symmetry=1, barrier=(22.9255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.430656,'amu*angstrom^2'), symmetry=1, barrier=(10.4736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00491884,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.430655,'amu*angstrom^2'), symmetry=1, barrier=(10.4736,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0968646,0.0972441,-0.000154015,1.20592e-07,-3.70447e-11,-112471,32.5234], Tmin=(100,'K'), Tmax=(801.062,'K')), NASAPolynomial(coeffs=[15.0855,0.0214335,-1.20596e-05,2.45332e-09,-1.7576e-13,-114903,-37.3551], Tmin=(801.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-936.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCFFO) + group(COCsFO) + radical(C2CsJOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    ...
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(305)', 'O=C(F)C(O)[C]F(4064)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(147)', 'O=C=CC(F)(F)OF(4066)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(147)', 'O=C(F)C=C(F)OF(4067)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(147)', 'O=C(F)C(O)=C(F)F(4068)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OOC(F)=CC(F)(F)OF(4069)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)[C](O)C(F)(F)OF(4070)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)C([O])C(F)(F)OF(4071)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([C](O)F)C(F)(F)OF(4072)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OC(F)=C(O)C(F)(F)OF(4073)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(F)C(O)[C](F)OF(4074)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=[C]C(O)C(F)(F)OF(4075)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[O]C(F)(F)C(O)C(=O)F(4076)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OH(7)', 'O=C(F)[CH]C(F)(F)OF(4077)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[O]C(C(=O)F)C(F)(F)OF(4078)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]F(125)', 'O=C(F)C(O)[C](F)F(2163)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FO[C](F)F(221)', 'O=C(F)[CH]O(3120)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CFO(50)', 'O[CH]C(F)(F)OF(906)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'O=C(F)[C](O)C(F)(F)OF(4079)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(77)', 'O=C(F)C(O)C(=O)F(4080)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'O=C(F)C(O)=C(F)OF(4081)'],
    products = ['O=C(F)C(O)C(F)(F)OF(3966)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O=C(F)C(O)C(F)(F)OF(3966)'],
    products = ['F2(77)', 'CF2O(48)', 'O=C=CO(1280)'],
