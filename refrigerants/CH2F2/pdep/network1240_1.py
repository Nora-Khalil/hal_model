...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC1(F)[CH]O1(2794)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[O]C1(F)[CH]O1(2760)'],
    products = ['F[C](F)OC1(F)[CH]O1(2794)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C[C](F)O[C](F)F(2832)'],
    products = ['F[C](F)OC1(F)[CH]O1(2794)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C](F)OC1=CO1(2833)'],
    products = ['F[C](F)OC1(F)[CH]O1(2794)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(42)', '[O]C1(F)[CH]O1(2760)'],
    products = ['F[C](F)OC1(F)[CH]O1(2794)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)OC1(F)[CH]O1(2794)'],
    products = ['FC(F)(F)O[C]1[CH]O1(2834)'],
