...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C#COO(2969)'],
    products = ['C#COOCF(4812)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COOF(4769)'],
    products = ['C#COOCF(4812)'],
    transitionState = 'TS3',
