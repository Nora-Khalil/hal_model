...
reaction(
    ...
    products = ['[CH]=C(F)C([O])C(=O)F(4515)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH]C(F)=CC(=O)F(3088)'],
    products = ['[CH]=C(F)C([O])C(=O)F(4515)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(F)C([O])C(=O)F(4515)'],
    products = ['[CH]=C(F)C1OO[C]1F(4624)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(F)C([O])C(=O)F(4515)'],
    products = ['[CH]=C(F)C1OC1([O])F(4625)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(F)C(=O)[C](O)F(4626)'],
    products = ['[CH]=C(F)C([O])C(=O)F(4515)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CFO(50)', '[CH]=C(F)C=O(2694)'],
    products = ['[CH]=C(F)C([O])C(=O)F(4515)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)C(=O)C(=O)F(4627)'],
    products = ['[CH]=C(F)C([O])C(=O)F(4515)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'C#CC([O])C(=O)F(4628)'],
    products = ['[CH]=C(F)C([O])C(=O)F(4515)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C#CC([O])=C([O])F(4629)'],
    products = ['[CH]=C(F)C([O])C(=O)F(4515)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C(F)C([O])C(=O)F(4515)'],
    products = ['[CH]C(F)=C(O)C(=O)F(4630)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=[C]C(OF)C(=O)F(4631)'],
    products = ['[CH]=C(F)C([O])C(=O)F(4515)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C(F)C([C]=O)OF(4632)'],
    products = ['[CH]=C(F)C([O])C(=O)F(4515)'],
