...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O[C-]=[O+]F(5329)'],
    products = ['O=C(F)[O+]=[C-]O(5326)'],
    transitionState = 'TS2',
