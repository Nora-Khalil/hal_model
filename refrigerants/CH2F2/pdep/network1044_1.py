...
reaction(
    label = 'reaction3',
    reactants = ['CF2(42)', 'O=C(F)OO(1245)'],
    products = ['O=C(F)OOC(F)F(2346)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(F)OOF(1259)', 'CHF(40)'],
    products = ['O=C(F)OOC(F)F(2346)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(F)OO[CH]F(2387)'],
    products = ['O=C(F)OOC(F)F(2346)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]OOC(F)F(709)'],
    products = ['O=C(F)OOC(F)F(2346)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)F(142)', '[O]C(F)F(164)'],
    products = ['O=C(F)OOC(F)F(2346)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OC(=O)F(154)', 'CHF2(81)'],
    products = ['O=C(F)OOC(F)F(2346)'],
