...
"""),
    E0 = (-201.209,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,395,473,707,1436,1855,455,950,478.489,478.49,478.492,478.493,478.498,478.531,478.536],'cm^-1')),
        HinderedRotor(inertia=(0.000736198,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00073619,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90301,0.0400301,-3.26945e-05,1.25554e-08,-1.89109e-12,-24119.3,19.7687], Tmin=(100,'K'), Tmax=(1585.69,'K')), NASAPolynomial(coeffs=[13.4168,0.010986,-5.21992e-06,1.00435e-09,-6.99576e-14,-27770.8,-41.0866], Tmin=(1585.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cds-OdOsH) + ring(Cs(O2)-O2s-Cs(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53898,0.0239277,8.38342e-06,-2.38709e-08,8.93076e-12,-62366.4,14.0196], Tmin=(100,'K'), Tmax=(1138.07,'K')), NASAPolynomial(coeffs=[10.1966,0.0171144,-9.13053e-06,1.90844e-09,-1.4144e-13,-65411.1,-29.6336], Tmin=(1138.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-519.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(CsCCFO) + group(Cs-CsOsOsH) + group(Cds-OdCsOs) + longDistanceInteraction_cyclic(Cs(F)-CO) + polycyclic(s2_3_4_ane)"""),
)

species(
    label = 'O=COC1=C(F)O1(2728)',
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79169,0.059461,-0.000115769,1.20824e-07,-4.75089e-11,-33154.6,18.2272], Tmin=(100,'K'), Tmax=(817.401,'K')), NASAPolynomial(coeffs=[2.5383,0.0309124,-1.7695e-05,3.57567e-09,-2.52817e-13,-32445,19.8631], Tmin=(817.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsCsCs) + group(CdCFO) + group(Cds-OdOsH) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(Cyclopropene)"""),
)

species(
    label = 'O=[C]O[CH]C(=O)F(2776)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
...
"""),
    E0 = (-79.7877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,1855,455,950,180,180,180,1255.36,1257.46],'cm^-1')),
        HinderedRotor(inertia=(0.285094,'amu*angstrom^2'), symmetry=1, barrier=(6.55488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.27135,'amu*angstrom^2'), symmetry=1, barrier=(52.2229,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.029,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56388,0.0673923,-0.000144131,1.48735e-07,-5.62686e-11,-9521.84,17.6748], Tmin=(100,'K'), Tmax=(850.209,'K')), NASAPolynomial(coeffs=[3.15233,0.0273426,-1.5999e-05,3.19739e-09,-2.22352e-13,-8614.53,17.1934], Tmin=(850.209,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.7877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsCsCs) + group(CdCFO) + group(Cds-OdOsH) + ring(Cyclopropene) + radical((O)CJOC) + longDistanceInteraction_cyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'O=[C]O[C]1OC1F(2778)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06224,0.0365882,-2.55252e-05,7.30926e-09,-6.0849e-13,-26525.6,20.0723], Tmin=(100,'K'), Tmax=(1382.47,'K')), NASAPolynomial(coeffs=[12.3729,0.0128389,-6.35723e-06,1.24876e-09,-8.81067e-14,-29957.8,-35.1124], Tmin=(1382.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cds-OdOsH) + ring(Cs(O2)-O2s-Cs(F)) + radical(Cs_P) + radical((O)CJOC)"""),
)

species(
    label = 'O=CO[C]1O[C]1F(2779)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-192.411,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([395,473,707,1436,2782.5,750,1395,475,1775,1000,507.969,507.974,507.977,507.989,507.996,508.011],'cm^-1')),
        HinderedRotor(inertia=(0.000653243,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000653261,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.036,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC1O[C]1F(2733)'],
    products = ['CO2(14)', 'FC1=CO1(1027)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(187)', '[O]C1O[C]1F(2736)'],
    products = ['O=[C]OC1O[C]1F(2733)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C1O[C]1F(2736)'],
    products = ['O=[C]OC1O[C]1F(2733)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CO2(14)', 'F[C]1[CH]O1(2769)'],
    products = ['O=[C]OC1O[C]1F(2733)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C]=O(141)', 'FC1=CO1(1027)'],
    products = ['O=[C]OC1O[C]1F(2733)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(2.90891,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'O=[C]OC1=C(F)O1(2777)'],
    products = ['O=[C]OC1O[C]1F(2733)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(141)', 'F[C]1[CH]O1(2769)'],
    products = ['O=[C]OC1O[C]1F(2733)'],
