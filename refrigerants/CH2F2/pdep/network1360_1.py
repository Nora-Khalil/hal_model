...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(O[C]=O)C(=O)F(3253)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(184)', '[O]C([O])C(=O)F(3353)'],
    products = ['[O]C(O[C]=O)C(=O)F(3253)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['CO(13)', '[O]C([O])C(=O)F(3353)'],
    products = ['[O]C(O[C]=O)C(=O)F(3253)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=[C]OC(=O)C(=O)F(3373)'],
    products = ['[O]C(O[C]=O)C(=O)F(3253)'],
...
network(
    label = 'PDepNetwork #1360',
    isomers = [
        '[O]C(O[C]=O)C(=O)F(3253)',
    ],
    reactants = [
        ('CO2(14)', 'O=CC(=O)F(711)'),
    ],
