...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.476418,'amu*angstrom^2'), symmetry=1, barrier=(10.9538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.476945,'amu*angstrom^2'), symmetry=1, barrier=(10.9659,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.666579,'amu*angstrom^2'), symmetry=1, barrier=(15.326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.666529,'amu*angstrom^2'), symmetry=1, barrier=(15.3248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79136,'amu*angstrom^2'), symmetry=1, barrier=(41.1869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
...
"""),
    ...
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20008,0.0712112,-0.000130067,1.23546e-07,-4.48019e-11,-36450.5,22.5652], Tmin=(100,'K'), Tmax=(835.439,'K')), NASAPolynomial(coeffs=[6.41084,0.0264897,-1.42697e-05,2.81226e-09,-1.95655e-13,-36631.1,2.49289], Tmin=(835.439,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-303.828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJOO)"""),
)

species(
    label = 'F[CH]C(F)OOF(593)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)C(F)F(569)'],
    products = ['HO2(11)', 'CHFCF2(54)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['HO2(11)', 'F[C]C(F)F(206)'],
    products = ['[O]OC(F)C(F)F(569)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]O[CH]C(F)F(587)'],
    products = ['[O]OC(F)C(F)F(569)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]OC(F)[CH]F(588)'],
    products = ['[O]OC(F)C(F)F(569)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(81)', '[O]O[CH]F(128)'],
    products = ['[O]OC(F)C(F)F(569)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]O[C](F)C(F)F(424)'],
    products = ['[O]OC(F)C(F)F(569)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OC(F)[C](F)F(467)'],
    products = ['[O]OC(F)C(F)F(569)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]OC=C(F)F(590)'],
    products = ['[O]OC(F)C(F)F(569)'],
