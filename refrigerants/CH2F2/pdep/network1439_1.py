...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(184)', '[CH2]C[O](1329)'],
    products = ['[O]CC[C]=O(3835)'],
    transitionState = 'TS3',
