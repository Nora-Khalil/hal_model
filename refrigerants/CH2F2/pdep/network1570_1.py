...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.77214,0.017284,2.70461e-05,-4.09744e-08,1.41245e-11,-20328.7,13.7918], Tmin=(100,'K'), Tmax=(1121.65,'K')), NASAPolynomial(coeffs=[9.67087,0.0189998,-1.04439e-05,2.22724e-09,-1.67143e-13,-23531.8,-27.6624], Tmin=(1121.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.457,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-O2d(Cds-Cds)Cs) + group(CdCsCdF) + group(Cd-Cd(CO)H) + ring(Cyclobutene)"""),
)

species(
    label = 'C=C(F)C=C=O(5256)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31687,0.0381138,-3.20158e-05,1.39606e-08,-2.53822e-12,-20931.5,16.4458], Tmin=(100,'K'), Tmax=(1268.64,'K')), NASAPolynomial(coeffs=[8.58236,0.0183589,-8.65813e-06,1.68629e-09,-1.19415e-13,-22521.2,-15.2724], Tmin=(1268.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CdCCF) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21041,0.0444712,-3.97951e-05,2.26414e-08,-6.23923e-12,5450.81,17.8952], Tmin=(100,'K'), Tmax=(805.421,'K')), NASAPolynomial(coeffs=[4.73542,0.0319312,-1.64411e-05,3.31086e-09,-2.3915e-13,5044.07,6.25988], Tmin=(805.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.8216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C(F)=C[C]=O(5010)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {6,D}
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(187)', '[CH]C(=C)F(2601)'],
    products = ['[CH]=C(F)C[C]=O(4842)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]F(1826)', 'CH2CO(28)'],
    products = ['[CH]=C(F)C[C]=O(4842)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH]=C(F)C=C=O(4220)'],
    products = ['[CH]=C(F)C[C]=O(4842)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['C2HF(57)', '[CH2][C]=O(3543)'],
    products = ['[CH]=C(F)C[C]=O(4842)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]F(1826)', '[CH2][C]=O(3543)'],
    products = ['[CH]=C(F)C[C]=O(4842)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C[C]=O(5258)'],
    products = ['[CH]=C(F)C[C]=O(4842)'],
