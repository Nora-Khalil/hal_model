...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[C](F)F(4698)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(162)', '[CH2]C([O])=O(1180)'],
    products = ['[CH2]C(=O)O[C](F)F(4698)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[C](F)F(250)'],
    products = ['[CH2]C(=O)O[C](F)F(4698)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[C](F)F(4698)'],
    products = ['[CH2][C]1OC(F)(F)O1(4714)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=O)O[C](F)F(4698)'],
    products = ['[CH2]C1([O])OC1(F)F(4715)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]C([O])=O(1180)'],
    products = ['[CH2]C(=O)O[C](F)F(4698)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O(7)', 'C=[C]O[C](F)F(4716)'],
    products = ['[CH2]C(=O)O[C](F)F(4698)'],
...
network(
    label = 'PDepNetwork #1497',
    isomers = [
        '[CH2]C(=O)O[C](F)F(4698)',
    ],
    reactants = [
        ('CF2O(48)', 'CH2CO(28)'),
    ],
