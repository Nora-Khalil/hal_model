...
reaction(
    label = 'reaction20',
    reactants = ['O(7)', '[CH2][C](F)F(1096)'],
    products = ['[CH2]C([O])(F)F(1145)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction21',
    reactants = ['[O][C](F)F(249)', 'CH2(T)(18)'],
    products = ['[CH2]C([O])(F)F(1145)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', 'FC1(F)[CH]O1(1024)'],
    products = ['FC1(F)CO1(1188)'],
