...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C]=O(1140)'],
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[C]=O(1171)'],
    products = ['[CH2]C(F)(F)O[C]=O(1140)'],
    transitionState = 'TS7',
