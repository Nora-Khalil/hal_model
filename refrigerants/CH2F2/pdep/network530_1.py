...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C(F)F(1396)'],
    products = ['[CH2]OC(F)[C](F)F(1359)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=C(F)F(1397)'],
    products = ['[CH2]OC(F)[C](F)F(1359)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OC(F)[C](F)F(1359)'],
    products = ['[CH2]O[CH]C(F)(F)F(1400)'],
