...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC1O[C]1F(2795)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[O]C1O[C]1F(2759)'],
    products = ['F[C](F)OC1O[C]1F(2795)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]O[C](F)F(2827)'],
    products = ['F[C](F)OC1O[C]1F(2795)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)OC1=C(F)O1(2829)'],
    products = ['F[C](F)OC1O[C]1F(2795)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(42)', '[O]C1O[C]1F(2759)'],
    products = ['F[C](F)OC1O[C]1F(2795)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)OC1O[C]1F(2795)'],
    products = ['F[C]1O[C]1OC(F)F(2831)'],
