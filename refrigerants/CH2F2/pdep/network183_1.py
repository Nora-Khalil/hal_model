...
"""),
    E0 = (-535.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([90,150,250,247,323,377,431,433,1065,1274,933.982,2230,4000],'cm^-1')),
        HinderedRotor(inertia=(0.000193235,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0465574,'amu*angstrom^2'), symmetry=1, barrier=(28.8318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03472,0.0467403,-6.75072e-05,4.90265e-08,-1.407e-11,-64352.5,16.8123], Tmin=(100,'K'), Tmax=(853.384,'K')), NASAPolynomial(coeffs=[9.44493,0.0120062,-6.45349e-06,1.33003e-09,-9.69315e-14,-65617.2,-17.7627], Tmin=(853.384,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-535.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(7)', 'CHFCF2(54)'],
    products = ['OC(F)(F)[CH]F(455)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C(O)(F)F(4820)'],
    products = ['OC(F)(F)[CH]F(455)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(129)', 'O[C](F)F(220)'],
    products = ['OC(F)(F)[CH]F(455)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'OC(F)(F)[C]F-2(4821)'],
    products = ['OC(F)(F)[CH]F(455)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O[C](F)[CH]F(4822)'],
    products = ['OC(F)(F)[CH]F(455)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)[CH]F(453)'],
    products = ['OC(F)(F)[CH]F(455)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'O=C(F)[CH]F(1260)'],
    products = ['OC(F)(F)[CH]F(455)'],
    transitionState = 'TS9',
