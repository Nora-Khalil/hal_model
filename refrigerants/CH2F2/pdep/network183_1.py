...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C(O)(F)F(1083)'],
    products = ['OC(F)(F)[CH]F(456)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(128)', 'O[C](F)F(232)'],
    products = ['OC(F)(F)[CH]F(456)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(6)', 'OC(F)(F)[C]F-2(1084)'],
    products = ['OC(F)(F)[CH]F(456)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O[C](F)[CH]F(1085)'],
    products = ['OC(F)(F)[CH]F(456)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[O]C(F)(F)[CH]F(474)'],
    products = ['OC(F)(F)[CH]F(456)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'O=C(F)[CH]F(1029)'],
    products = ['OC(F)(F)[CH]F(456)'],
    transitionState = 'TS9',
