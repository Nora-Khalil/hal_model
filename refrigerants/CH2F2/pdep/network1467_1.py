...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.26359,'amu*angstrom^2'), symmetry=1, barrier=(29.0524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26788,'amu*angstrom^2'), symmetry=1, barrier=(29.151,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55119,0.0388695,7.23986e-07,-4.41795e-08,2.39156e-11,-16716.2,18.6926], Tmin=(100,'K'), Tmax=(927.453,'K')), NASAPolynomial(coeffs=[19.713,-0.000820625,2.42294e-06,-4.79659e-10,2.73656e-14,-21746.9,-76.5189], Tmin=(927.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-OsOsHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(OCOJ)"""),
)

species(
    label = 'O=C(F)[CH]O[CH]O(4167)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.629571,0.0761568,-0.000113103,8.11101e-08,-2.23826e-11,-45457.3,25.5373], Tmin=(100,'K'), Tmax=(897.955,'K')), NASAPolynomial(coeffs=[15.1403,0.0115183,-5.12685e-06,9.46285e-10,-6.42898e-14,-48063.3,-42.9066], Tmin=(897.955,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-378.947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsOsHH) + group(COCsFO) + radical(CCsJOCs) + radical(OCJO)"""),
)

species(
    label = '[O][CH]OCC(=O)F(4168)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u0 p2 c0 {6,D}
...
"""),
    E0 = (-332.005,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,3025,407.5,1350,352.5,180,180,1965.52,1966.4,1968.42],'cm^-1')),
        HinderedRotor(inertia=(0.340256,'amu*angstrom^2'), symmetry=1, barrier=(7.82316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57544,'amu*angstrom^2'), symmetry=1, barrier=(36.2224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57735,'amu*angstrom^2'), symmetry=1, barrier=(36.2663,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45015,0.0668263,-0.000120908,1.21242e-07,-4.63683e-11,-39849.7,23.6129], Tmin=(100,'K'), Tmax=(826.799,'K')), NASAPolynomial(coeffs=[3.28304,0.0341114,-1.82909e-05,3.61447e-09,-2.52675e-13,-39337.6,20.0481], Tmin=(826.799,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsOsHH) + group(COCsFO) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = '[O][C]=COCOF(4169)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-18.5526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,167,640,1190,304.491,304.519,304.562,304.677],'cm^-1')),
        HinderedRotor(inertia=(0.422897,'amu*angstrom^2'), symmetry=1, barrier=(27.8248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.422519,'amu*angstrom^2'), symmetry=1, barrier=(27.8208,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47613,0.0460367,-2.98715e-05,-3.45519e-09,6.85836e-12,-2131.96,20.1226], Tmin=(100,'K'), Tmax=(972.396,'K')), NASAPolynomial(coeffs=[16.409,0.00630268,-2.04154e-06,4.06814e-10,-3.28668e-14,-6061.67,-56.7751], Tmin=(972.396,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.5526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(OCOJ) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    E0 = (-325.914,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,293,496,537,1218,1685,370,410.568,410.905,411.215,411.452,412.849],'cm^-1')),
        HinderedRotor(inertia=(0.169586,'amu*angstrom^2'), symmetry=1, barrier=(20.3188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168675,'amu*angstrom^2'), symmetry=1, barrier=(20.3189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168595,'amu*angstrom^2'), symmetry=1, barrier=(20.2912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.836845,0.0544631,-2.56657e-05,-2.52444e-08,1.88709e-11,-39070.5,26.5319], Tmin=(100,'K'), Tmax=(927.91,'K')), NASAPolynomial(coeffs=[23.0294,-0.00223804,3.00427e-06,-5.87141e-10,3.48122e-14,-44866.5,-87.9131], Tmin=(927.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-325.914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = 'O=CO[CH][C](O)F(4175)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u0 p2 c0 {6,S} {10,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](1374)', '[CH]C(=O)F-2(3116)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CO[CH]C(=O)F(4165)'],
    products = ['[O]CO[CH]C(=O)F(3950)'],
