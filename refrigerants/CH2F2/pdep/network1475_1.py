...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'O=C=C(F)OO(3477)'],
...
reaction(
    label = 'reaction8',
    reactants = ['CH3O(27)', 'O=[C]C(=O)F(2239)'],
    products = ['COOC(F)=C=O(3958)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[O]OC(F)=C=O(2073)'],
    products = ['COOC(F)=C=O(3958)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CO[O](1201)', 'O=C=[C]F(443)'],
    products = ['COOC(F)=C=O(3958)'],
