...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]C(=O)F(142)'],
    products = ['[O]OOC(=O)F(152)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOC(=O)F(152)'],
    products = ['F[C]1OOOO1(155)'],
    transitionState = 'TS4',
