...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(162)', '[CH2][O](1455)'],
    products = ['[O]C[C](F)F(1144)'],
    transitionState = 'TS3',
