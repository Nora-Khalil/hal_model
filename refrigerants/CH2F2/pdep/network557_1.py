...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]C(=O)OF(1166)'],
    products = ['O=C(CO)OF(1479)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C([CH]O)OF(1287)'],
    products = ['O=C(CO)OF(1479)'],
