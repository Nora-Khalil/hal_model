...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.3758,'amu*angstrom^2'), symmetry=1, barrier=(8.64039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.526616,'amu*angstrom^2'), symmetry=1, barrier=(12.1079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.372998,'amu*angstrom^2'), symmetry=1, barrier=(8.57595,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.303254,'amu*angstrom^2'), symmetry=1, barrier=(6.9724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303116,'amu*angstrom^2'), symmetry=1, barrier=(6.96922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.30306,'amu*angstrom^2'), symmetry=1, barrier=(6.96795,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (167.03,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(F)(F)C(F)F(420)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF3(41)', 'OC(F)(F)[C]F(302)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)F(237)', 'F[C]C(F)F(316)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(173)', 'F[C]C(F)(F)C(F)F(910)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'OC(F)(F)C(F)(F)[C]F(911)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'OC(F)(F)C(F)(F)F(912)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OC(F)(F)C(F)(F)C(F)F(498)'],
    products = ['OC(F)(C(F)F)C(F)(F)F(913)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(173)', 'FC(F)=C(F)C(F)F(488)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OC(F)F(324)', 'CF2CF2(60)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)(F)[C](F)C(F)F(914)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[C](F)C(F)(F)C(F)F(915)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)(F)C(F)(F)[CH]F(916)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(5)', 'F[C](F)C(F)(F)C(F)F(448)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[O]C(F)(F)C(F)(F)C(F)F(431)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(81)', 'OC(F)(F)[C](F)F(312)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', 'OC(F)(F)C(F)(F)[C](F)F(917)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)C(F)F(918)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(77)', 'OC(F)=C(F)C(F)F(919)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(77)', 'OC(F)(F)C(F)=CF(920)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'OC(F)(F)C(F)=C(F)F(534)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(498)'],
