...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)C=C[C]F(2942)'],
    products = ['F[C]=CC1O[C]1F(2766)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', 'F[C]=CC1=C(F)O1(2943)'],
    products = ['F[C]=CC1O[C]1F(2766)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'FC#CC1O[C]1F(2944)'],
    products = ['F[C]=CC1O[C]1F(2766)'],
    transitionState = 'TS9',
