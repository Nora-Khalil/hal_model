...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=C=C[C]F(2579)'],
    products = ['[O]C(=O)C=[C]F(2541)'],
    transitionState = 'TS2',
