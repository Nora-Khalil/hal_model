...
"""),
    E0 = (-511.724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,334,575,1197,1424,3202,219.671,4000],'cm^-1')),
        HinderedRotor(inertia=(0.303674,'amu*angstrom^2'), symmetry=1, barrier=(10.4045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11742,'amu*angstrom^2'), symmetry=1, barrier=(37.3444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15245,'amu*angstrom^2'), symmetry=1, barrier=(37.3594,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.857749,0.0748593,-0.000121339,1.02232e-07,-3.38978e-11,-61438.6,23.9266], Tmin=(100,'K'), Tmax=(797.229,'K')), NASAPolynomial(coeffs=[10.7174,0.0206534,-1.04385e-05,2.04195e-09,-1.42636e-13,-62860.1,-20.4622], Tmin=(797.229,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-511.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    E0 = (-157.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,334,575,1197,1424,3202,275.859,276.014,276.062],'cm^-1')),
        HinderedRotor(inertia=(0.123156,'amu*angstrom^2'), symmetry=1, barrier=(6.65715,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123075,'amu*angstrom^2'), symmetry=1, barrier=(6.65441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.424029,'amu*angstrom^2'), symmetry=1, barrier=(22.9038,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.695029,0.0821342,-0.000147903,1.35796e-07,-4.7914e-11,-18820.8,23.3116], Tmin=(100,'K'), Tmax=(828.031,'K')), NASAPolynomial(coeffs=[8.95008,0.0251308,-1.36167e-05,2.70172e-09,-1.88801e-13,-19600.8,-11.4113], Tmin=(828.031,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-453.61,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,180,180,1619.25],'cm^-1')),
        HinderedRotor(inertia=(0.374877,'amu*angstrom^2'), symmetry=1, barrier=(8.61915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.37357,'amu*angstrom^2'), symmetry=1, barrier=(8.58911,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(128)', '[O]C[C](F)F(1144)'],
    products = ['[O]CC(F)(F)[CH]F(1559)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'O=CC(F)(F)[CH]F(832)'],
    products = ['[O]CC(F)(F)[CH]F(1559)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]C=C(F)[CH]F(833)'],
    products = ['[O]CC(F)(F)[CH]F(1559)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[O]C[C](F)F(1144)'],
    products = ['[O]CC(F)(F)[CH]F(1559)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]C(F)(F)[CH]F(1654)'],
    products = ['[O]CC(F)(F)[CH]F(1559)'],
