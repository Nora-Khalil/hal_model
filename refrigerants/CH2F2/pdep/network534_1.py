...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(129)', '[O]C[O](1374)'],
    products = ['[O]CO[CH]F(1362)'],
    transitionState = 'TS2',
