...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(187)', 'O=C[C]F(921)'],
    products = ['O=[C]OC=[C]F(2473)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C]=O(141)', '[CH]=[C]F(1826)'],
    products = ['O=[C]OC=[C]F(2473)'],
    transitionState = 'TS8',
