...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)OOO(2765)'],
    products = ['HO2(11)', 'FC1=CO1(1231)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(5)', '[C]=C(F)OOO(3112)'],
    products = ['[CH]=C(F)OOO(2765)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(11)', '[CH]C(=O)F-2(3116)'],
    products = ['[CH]=C(F)OOO(2765)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', '[CH]=C(F)O[O](2544)'],
    products = ['[CH]=C(F)OOO(2765)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)OO[O](2787)'],
    products = ['[CH]=C(F)OOO(2765)'],
    transitionState = 'TS8',
