...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'F[C]C=C(F)F-2(2524)'],
    products = ['F[C]=CC(F)F(2468)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'F[C]=[C]C(F)F(2651)'],
    products = ['F[C]=CC(F)F(2468)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'FC#C[CH]F(2652)'],
    products = ['F[C]=CC(F)F(2468)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]=CC(F)F(2468)'],
    products = ['F[CH]C=C(F)F(935)'],
