...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437357,0.0564113,-5.73205e-05,2.76242e-08,-4.85022e-12,-40376.6,25.9569], Tmin=(100,'K'), Tmax=(1694.59,'K')), NASAPolynomial(coeffs=[15.9914,0.00512358,9.77576e-07,-3.85618e-10,3.0696e-14,-43555.7,-51.1125], Tmin=(1694.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-336.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2sCF) + group(Cs-OsOsOsH) + group(CsFHOO) + ring(124trioxolane) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(OF)OC(F)O1(4983)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {8,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31699,0.0542015,-0.000118057,1.4135e-07,-5.95465e-11,-58619.8,21.3206], Tmin=(100,'K'), Tmax=(842.327,'K')), NASAPolynomial(coeffs=[-5.63765,0.0471566,-2.56977e-05,5.0824e-09,-3.54242e-13,-55689.7,67.7704], Tmin=(842.327,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-487.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsOs) + group(CsFHOO) + ring(O2s-Cs-O2s-Cs(F)) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-810.166,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,482,664,788,1296,1923,180,180,180,180,1600,1685.99,2814.3,3200],'cm^-1')),
        HinderedRotor(inertia=(0.150871,'amu*angstrom^2'), symmetry=1, barrier=(3.46882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150871,'amu*angstrom^2'), symmetry=1, barrier=(3.46882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150871,'amu*angstrom^2'), symmetry=1, barrier=(3.46882,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17142,0.0607566,-7.71631e-05,4.44646e-08,-9.79581e-12,-97337.2,25.0688], Tmin=(100,'K'), Tmax=(1120.07,'K')), NASAPolynomial(coeffs=[16.4827,0.00607662,-3.93534e-06,8.79297e-10,-6.75356e-14,-100767,-50.5356], Tmin=(1120.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-810.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2sCF) + group(Cds-OdOsOs) + group(COFOO)"""),
)

species(
    label = '[O][CH]OC(=O)OF(4985)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u0 p2 c0 {1,S} {6,S}
...
"""),
    E0 = (-439.02,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,482,586,761,1411,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (126.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46124,0.0468005,-3.57887e-05,6.75684e-09,1.69331e-12,-52702.8,26.0554], Tmin=(100,'K'), Tmax=(1084.02,'K')), NASAPolynomial(coeffs=[16.1429,0.00842267,-4.54283e-06,9.83848e-10,-7.55714e-14,-56814,-50.2408], Tmin=(1084.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-439.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2sCF) + group(CsFHOO) + group(Cds-OdOsOs) + radical(O2sj(Cs-F1sO2sH)) + radical(CsF1sO2sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3699,0.0591356,-6.8522e-05,3.85493e-08,-8.56811e-12,-78923.9,23.1435], Tmin=(100,'K'), Tmax=(1091.38,'K')), NASAPolynomial(coeffs=[13.3503,0.0152261,-8.17194e-06,1.68426e-09,-1.23445e-13,-81538.9,-35.7024], Tmin=(1091.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-656.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(O2s-(Cds-O2d)H) + group(CsFHOO) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)

species(
    label = 'O=C(OF)O[CH]OF(4989)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {7,S} {8,S}
...
"""),
    E0 = (-341.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,557,1111,3025,407.5,1350,352.5,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.64009,0.0708997,-8.63966e-05,4.83981e-08,-1.03926e-11,-40941.4,24.7261], Tmin=(100,'K'), Tmax=(1148.02,'K')), NASAPolynomial(coeffs=[18.5575,0.00847066,-4.82705e-06,1.02984e-09,-7.73856e-14,-45055.4,-64.1885], Tmin=(1148.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-341.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-OdOsOs) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)OC(=O)OF(4956)'],
    products = ['HF(38)', 'CO2(14)', '[O]C(=O)F(142)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(11.4445,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=C(OF)O[CH]F(363)'],
    products = ['[O]C(F)OC(=O)OF(4956)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)OC(=O)OF(4956)'],
    products = ['FO[C]1OOC(F)O1(4982)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.12332e+09,'s^-1'), n=0.5388, Ea=(308.272,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra] for rate rule [R5_SS_CO;carbonyl_intra_Nd;radadd_intra_O]
Euclidian distance = 2.449489742783178
family: Intra_R_Add_Endocyclic
Ea raised from 307.2 to 308.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)OC(=O)OF(4956)'],
    products = ['[O]C1(OF)OC(F)O1(4983)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.724e+10,'s^-1'), n=0.478, Ea=(157.449,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_O] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_O]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 156.5 to 157.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O=COC(=O)OF(399)'],
    products = ['[O]C(F)OC(=O)OF(4956)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)OF(365)', 'CHFO(46)'],
    products = ['[O]C(F)OC(=O)OF(4956)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(54.8714,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'O=C(F)OC(=O)OF(4984)'],
    products = ['[O]C(F)OC(=O)OF(4956)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O][CH]OC(=O)OF(4985)'],
    products = ['[O]C(F)OC(=O)OF(4956)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)OC([O])F(419)'],
    products = ['[O]C(F)OC(=O)OF(4956)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)OF(365)', '[O][CH]F(134)'],
    products = ['[O]C(F)OC(=O)OF(4956)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OF(146)', '[O]C([O])F(137)'],
    products = ['[O]C(F)OC(=O)OF(4956)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(125)', '[O]C(F)O[C]=O(714)'],
    products = ['[O]C(F)OC(=O)OF(4956)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O][C](F)OC(=O)OF(4986)'],
    products = ['[O]C(F)OC(=O)OF(4956)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)OC(=O)OF(4956)'],
    products = ['F2(77)', 'CO2(14)', '[O]C=O(141)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(193.793,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)OC(=O)OF(4956)'],
    products = ['O=C(OF)O[C](O)F(4987)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)OC(=O)OF(4956)'],
    products = ['[O]C(=O)OC(F)OF(4988)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(192.934,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction17',
    reactants = ['O=C(OF)O[CH]OF(4989)'],
    products = ['[O]C(F)OC(=O)OF(4956)'],
