...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)OOC(F)F(280)'],
    products = ['CF2O(48)', '[O]C(=O)O(229)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]C(=O)OO(207)'],
    products = ['[O]C(=O)OOC(F)F(280)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=O)OOF(1023)', 'CHF(40)'],
    products = ['[O]C(=O)OOC(F)F(280)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(=O)OOC(F)F(280)'],
    products = ['O=C1OO1(969)', '[O]C(F)F(170)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(=O)OO[CH]F(4488)'],
    products = ['[O]C(=O)OOC(F)F(280)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])=O(188)', '[O]C(F)F(170)'],
    products = ['[O]C(=O)OOC(F)F(280)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OC([O])=O(178)', 'CHF2(81)'],
    products = ['[O]C(=O)OOC(F)F(280)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C]=O(141)', '[O]OC(F)F(163)'],
    products = ['[O]C(=O)OOC(F)F(280)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', '[O]C(=O)OO[C](F)F(4489)'],
    products = ['[O]C(=O)OOC(F)F(280)'],
