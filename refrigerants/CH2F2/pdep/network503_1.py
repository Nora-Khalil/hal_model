...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(184)', '[O]C[O](1374)'],
    products = ['[O]CO[C]=O(1337)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(145)', '[CH2][O](1324)'],
    products = ['[O]CO[C]=O(1337)'],
