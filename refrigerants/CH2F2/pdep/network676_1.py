...
reaction(
    label = 'reaction1',
    reactants = ['C=C([O])C(F)(F)[CH]F(1670)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(CF)=C(F)[CH]F(1871)'],
    products = ['C=C([O])C(F)(F)[CH]F(1670)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(129)', '[CH2]C(=O)[C](F)F(1754)'],
    products = ['C=C([O])C(F)(F)[CH]F(1670)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)(F)[CH]F(1872)'],
    products = ['C=C([O])C(F)(F)[CH]F(1670)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C([O])C(F)(F)[CH]F(1670)'],
    products = ['F[CH]C(F)(F)[C]1CO1(1873)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C(F)(F)[CH]F(1670)'],
    products = ['[O][C]1CC(F)C1(F)F(1874)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C(F)=CF(1875)'],
    products = ['C=C([O])C(F)(F)[CH]F(1670)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C(=O)[C](F)F(1754)'],
    products = ['C=C([O])C(F)(F)[CH]F(1670)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(O)C(F)(F)[CH]F(1876)'],
    products = ['C=C([O])C(F)(F)[CH]F(1670)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C([O])C(F)(F)CF(1877)'],
    products = ['C=C([O])C(F)(F)[CH]F(1670)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(OF)=C(F)[CH]F(1878)'],
    products = ['C=C([O])C(F)(F)[CH]F(1670)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(18)', 'O=[C]C(F)(F)[CH]F(518)'],
    products = ['C=C([O])C(F)(F)[CH]F(1670)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([O])C(F)(F)[CH]F(1670)'],
    products = ['[CH2][C]1OC(F)C1(F)F(1879)'],
