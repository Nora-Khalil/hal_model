...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.81855,'amu*angstrom^2'), symmetry=1, barrier=(41.812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81864,'amu*angstrom^2'), symmetry=1, barrier=(41.8142,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.86593,0.0755629,-0.000119935,9.97792e-08,-3.33292e-11,-67022.4,25.3448], Tmin=(100,'K'), Tmax=(732.43,'K')), NASAPolynomial(coeffs=[10.3963,0.0235081,-1.33142e-05,2.71892e-09,-1.95349e-13,-68418.3,-17.6648], Tmin=(732.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-558.143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsOs) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-874.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,230,274,587,678,790,1206,1241,1314,193.045,194.175,194.383,194.697,2422.27,2422.84],'cm^-1')),
        HinderedRotor(inertia=(0.149959,'amu*angstrom^2'), symmetry=1, barrier=(34.719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29483,'amu*angstrom^2'), symmetry=1, barrier=(34.7135,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-603.228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,171,205,598,1104,1143,1317,1411,3153,323,467,575,827,1418,350,440,435,1725,180,1230.24,1231.01],'cm^-1')),
        HinderedRotor(inertia=(0.277929,'amu*angstrom^2'), symmetry=1, barrier=(6.39013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277929,'amu*angstrom^2'), symmetry=1, barrier=(6.39014,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277657,'amu*angstrom^2'), symmetry=1, barrier=(6.38388,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.100147,0.10944,-0.000222395,2.20525e-07,-8.1001e-11,-72422.4,29.956], Tmin=(100,'K'), Tmax=(856.33,'K')), NASAPolynomial(coeffs=[5.45348,0.0393083,-2.21419e-05,4.36331e-09,-3.00901e-13,-71753.3,13.4847], Tmin=(856.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-603.228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs)"""),
)
...
"""),
    E0 = (-740.412,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,1380,1390,370,380,2900,435,190,488,555,1236,1407,180,180,180,711.544],'cm^-1')),
        HinderedRotor(inertia=(0.237747,'amu*angstrom^2'), symmetry=1, barrier=(5.46627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229863,'amu*angstrom^2'), symmetry=1, barrier=(5.285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235617,'amu*angstrom^2'), symmetry=1, barrier=(5.41729,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.413684,0.113786,-0.00022356,2.13506e-07,-7.64746e-11,-88908.2,32.9092], Tmin=(100,'K'), Tmax=(850.817,'K')), NASAPolynomial(coeffs=[8.91243,0.0339652,-1.941e-05,3.84548e-09,-2.66085e-13,-89193,-2.92509], Tmin=(850.817,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-740.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(CCOJ) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = 'O[C](OF)C(F)(F)[C](F)F(2462)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-760.871,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,215,315,519,588,595,1205,1248,360,370,350,190,488,555,1236,1407,201.755,201.757,201.77],'cm^-1')),
        HinderedRotor(inertia=(0.167841,'amu*angstrom^2'), symmetry=1, barrier=(4.84814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167845,'amu*angstrom^2'), symmetry=1, barrier=(4.84813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167846,'amu*angstrom^2'), symmetry=1, barrier=(4.84813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.618537,'amu*angstrom^2'), symmetry=1, barrier=(17.865,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.722573,0.117052,-0.000220826,1.99251e-07,-6.80473e-11,-91354.2,33.8467], Tmin=(100,'K'), Tmax=(852.972,'K')), NASAPolynomial(coeffs=[13.4132,0.0252268,-1.44409e-05,2.84769e-09,-1.96021e-13,-92836.8,-26.6569], Tmin=(852.972,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-760.871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(Cs_P) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)C(F)(F)C(F)F(2403)'],
    products = ['HF(38)', 'CO2(14)', 'CF2CF2(60)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FOC(F)(F)C(F)F(636)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF3(41)', 'O=C([C]F)OF(336)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(42)', 'O=C(OF)C(F)F(619)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'O=C(OF)C(F)(F)[C]F(618)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'O=C(OF)C(F)(F)F(620)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(305)', 'O=C=C(F)C(F)F(652)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FOC(OF)=C(F)C(F)F(2460)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOC(OC(F)F)=C(F)F(2128)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(OF)C(F)(F)[C](F)F(2461)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O[C](OF)C(F)(F)[C](F)F(2462)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(OF)[C](F)C(F)F(664)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=C(OF)C(F)(F)[CH]F(630)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)C(F)(F)C(F)F(389)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(125)', 'O=[C]C(F)(F)C(F)F(690)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(81)', 'O=C(OF)[C](F)F(344)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OF(146)', 'CHF2-CF2(68)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(OF)C(F)(F)[C](F)F(2463)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'O=C(OF)C(F)=CF(632)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(OF)C(F)=C(F)F(2464)'],
    products = ['O=C(OF)C(F)(F)C(F)F(2403)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=C(OF)C(F)(F)C(F)F(2403)'],
    products = ['F2(77)', 'CO2(14)', 'CHFCF2(54)'],
...
network(
    label = 'PDepNetwork #1081',
    isomers = [
        'O=C(OF)C(F)(F)C(F)F(2403)',
    ],
    reactants = [
        ('HF(38)', 'CO2(14)', 'CF2CF2(60)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
