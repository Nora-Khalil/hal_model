...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[C]=C(F)C(F)F(2744)'],
    products = ['[CH]=C(F)C(F)F(2655)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=[C]C(F)F(2745)'],
    products = ['[CH]=C(F)C(F)F(2655)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]C(F)=C(F)F(2570)'],
    products = ['[CH]=C(F)C(F)F(2655)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'C#C[C](F)F(2747)'],
    products = ['[CH]=C(F)C(F)F(2655)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)C(F)F(2655)'],
    products = ['C=C(F)[C](F)F(2748)'],
