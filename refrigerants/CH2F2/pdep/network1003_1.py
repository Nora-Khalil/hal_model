...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]=C(F)C#C(2627)'],
    products = ['[CH]=C(F)C(=[CH])F(2495)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=[C]F(1826)', '[CH]=[C]F(1826)'],
    products = ['[CH]=C(F)C(=[CH])F(2495)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(77)', '[CH]=C=C=[CH](2628)'],
    products = ['[CH]=C(F)C(=[CH])F(2495)'],
    transitionState = 'TS6',
