...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(130)', '[O]C([O])=CF(507)'],
    products = ['[O]C(=O)C(F)[C](F)F(462)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C(F)[C](F)F(508)'],
    products = ['[O]C(=O)C(F)[C](F)F(462)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(=O)C=C(F)F(513)'],
    products = ['[O]C(=O)C(F)[C](F)F(462)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(=O)C(F)=C(F)F(514)'],
    products = ['[O]C(=O)C(F)[C](F)F(462)'],
