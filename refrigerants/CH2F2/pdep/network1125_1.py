...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'F[C]C=C(F)F-2(2564)'],
    products = ['[O]C(F)(F)C=[C]F(2546)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=C(F)C=[C]F(2026)'],
    products = ['[O]C(F)(F)C=[C]F(2546)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)C#CF(2565)'],
    products = ['[O]C(F)(F)C=[C]F(2546)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'O=C(F)[C]=[C]F(2566)'],
    products = ['[O]C(F)(F)C=[C]F(2546)'],
    transitionState = 'TS9',
