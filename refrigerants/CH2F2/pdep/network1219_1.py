...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(=O)C1O[C]1F(2775)'],
    products = ['[O]C(=O)C1(F)[CH]O1(2774)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C1[CH][C](F)OO1(2862)'],
    products = ['[O]C(=O)C1O[C]1F(2775)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C1O[C]1F(2863)'],
    products = ['[O]C(=O)C1O[C]1F(2775)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(O)[C]1O[C]1F(2868)'],
    products = ['[O]C(=O)C1O[C]1F(2775)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C1=C(F)O1(2869)'],
    products = ['[O]C(=O)C1O[C]1F(2775)'],
