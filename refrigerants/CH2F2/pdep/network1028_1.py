...
reaction(
    label = 'reaction3',
    reactants = ['O(7)', '[O]OOC(F)(F)F(2687)'],
    products = ['[O]OOOC(F)(F)F(954)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOOC(F)(F)F(954)'],
    products = ['[O-][O+]=O(222)', 'CF3O(47)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]OOO[C](F)F(226)'],
    products = ['[O]OOOC(F)(F)F(954)'],
    transitionState = 'TS5',
