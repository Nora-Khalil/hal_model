...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[O]C(F)(F)OO(258)'],
    products = ['OOC(F)(F)OF(1252)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', '[O]OC(F)(F)OF(1256)'],
    products = ['OOC(F)(F)OF(1252)'],
    transitionState = 'TS5',
