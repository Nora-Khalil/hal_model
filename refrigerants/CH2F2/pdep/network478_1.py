...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH2]C([O])(F)F(1145)'],
    products = ['[CH2]C(F)(F)O[O](652)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(171)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)O[O](652)'],
    transitionState = 'TS3',
