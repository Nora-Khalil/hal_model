...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC([O])F(1361)'],
    products = ['CHFO(46)', 'CH2O(20)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[CH]F(1403)'],
    products = ['[O]CC([O])F(1361)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(134)', '[CH2][O](1324)'],
    products = ['[O]CC([O])F(1361)'],
