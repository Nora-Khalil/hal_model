...
"""),
    E0 = (-281.874,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,180,180,180,738.031,738.032,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0560036,'amu*angstrom^2'), symmetry=1, barrier=(21.6472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339004,'amu*angstrom^2'), symmetry=1, barrier=(21.6472,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25336,0.0404163,-6.17014e-05,4.50952e-08,-1.27422e-11,-33840.5,19.4311], Tmin=(100,'K'), Tmax=(874.602,'K')), NASAPolynomial(coeffs=[9.67821,0.00645664,-3.45479e-06,6.94012e-10,-4.95489e-14,-35139.2,-15.3943], Tmin=(874.602,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cds-OdOsOs) + group(Cds-OdOsH) + radical(OC=OOJ) + radical((O)CJOC)"""),
)

species(
    label = '[O]C([O])(F)OC=O(2353)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u1 p2 c0 {6,S}
...
"""),
    E0 = (-215.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,360,370,350,1855,455,950,180,180,577.393],'cm^-1')),
        HinderedRotor(inertia=(0.214859,'amu*angstrom^2'), symmetry=1, barrier=(4.94002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00729118,'amu*angstrom^2'), symmetry=1, barrier=(36.3221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57995,'amu*angstrom^2'), symmetry=1, barrier=(36.3263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00729152,'amu*angstrom^2'), symmetry=1, barrier=(36.3205,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52203,0.0646157,-0.00012497,1.23218e-07,-4.59325e-11,-25845,23.7772], Tmin=(100,'K'), Tmax=(830.331,'K')), NASAPolynomial(coeffs=[5.19598,0.0251626,-1.43983e-05,2.88769e-09,-2.02552e-13,-25705.2,11.2515], Tmin=(830.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cds-OdOsH) + radical(Cs_P) + radical((O)CJOC)"""),
)

species(
    label = '[O][C](F)OC(=O)O(2355)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {6,S} {7,S}
3 O u0 p2 c0 {6,S} {8,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(184)', '[O]C([O])(O)F(2351)'],
    products = ['[O]C(O)(F)O[C]=O(2336)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C([O])(O)F(2351)'],
    products = ['[O]C(O)(F)O[C]=O(2336)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O]C(=O)O[C]=O(170)'],
    products = ['[O]C(O)(F)O[C]=O(2336)'],
