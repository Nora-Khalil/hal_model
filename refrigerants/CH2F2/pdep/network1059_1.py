...
"""),
    E0 = (-718.143,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,190,488,555,1236,1407,180,1493.08],'cm^-1')),
        HinderedRotor(inertia=(0.428993,'amu*angstrom^2'), symmetry=1, barrier=(9.86338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.71557,'amu*angstrom^2'), symmetry=1, barrier=(16.4524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83179,'amu*angstrom^2'), symmetry=1, barrier=(42.1164,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.482566,0.0852691,-0.000147043,1.2961e-07,-4.45958e-11,-86253.6,25.8003], Tmin=(100,'K'), Tmax=(802.064,'K')), NASAPolynomial(coeffs=[10.8981,0.023394,-1.27516e-05,2.55032e-09,-1.79698e-13,-87604.9,-20.1597], Tmin=(802.064,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-718.143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.115506,'amu*angstrom^2'), symmetry=1, barrier=(2.6557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662336,'amu*angstrom^2'), symmetry=1, barrier=(15.2284,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.468128,0.0914084,-0.000177837,1.70786e-07,-6.14574e-11,-43143.9,27.2889], Tmin=(100,'K'), Tmax=(852.204,'K')), NASAPolynomial(coeffs=[7.29833,0.0294636,-1.62021e-05,3.19055e-09,-2.20442e-13,-43222.8,1.79669], Tmin=(852.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-359.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = '[O]C[C](F)C(F)(F)F(2468)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.875226,0.0792691,-0.000144181,1.36114e-07,-4.89918e-11,-83321.7,24.8607], Tmin=(100,'K'), Tmax=(839.631,'K')), NASAPolynomial(coeffs=[6.94345,0.0287103,-1.51801e-05,2.97707e-09,-2.06525e-13,-83577.6,1.19016], Tmin=(839.631,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-693.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-O2sHH)(Cs-F1sF1sF1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC(F)(F)[C](F)F(2107)'],
    products = ['CH2O(20)', 'CF2CF2(60)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[O]C[C](F)F(974)'],
    products = ['[O]CC(F)(F)[C](F)F(2107)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]CC(F)=C(F)F(1407)'],
    products = ['[O]CC(F)(F)[C](F)F(2107)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](1324)', 'CF2CF2(60)'],
    products = ['[O]CC(F)(F)[C](F)F(2107)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2O(20)', 'F[C](F)[C](F)F(384)'],
    products = ['[O]CC(F)(F)[C](F)F(2107)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=CC(F)(F)[C](F)F(710)'],
    products = ['[O]CC(F)(F)[C](F)F(2107)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](1324)', 'F[C](F)[C](F)F(384)'],
    products = ['[O]CC(F)(F)[C](F)F(2107)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O]C=C(F)[C](F)F(774)'],
    products = ['[O]CC(F)(F)[C](F)F(2107)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(42)', '[O]C[C](F)F(974)'],
    products = ['[O]CC(F)(F)[C](F)F(2107)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[CH]C(F)(F)[C](F)F(2466)'],
    products = ['[O]CC(F)(F)[C](F)F(2107)'],
