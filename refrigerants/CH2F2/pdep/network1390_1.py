...
"""),
    E0 = (28.6386,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,2120,512.5,787.5,181.901,205.367,208.441,271.385,984.187,1686.08,1833.02,3051.36,3286.08],'cm^-1')),
        HinderedRotor(inertia=(0.126648,'amu*angstrom^2'), symmetry=1, barrier=(2.99466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126648,'amu*angstrom^2'), symmetry=1, barrier=(2.99466,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59467,0.0689009,-0.000150574,1.58661e-07,-6.04285e-11,3515.68,23.2945], Tmin=(100,'K'), Tmax=(862.307,'K')), NASAPolynomial(coeffs=[1.26746,0.031446,-1.76262e-05,3.46337e-09,-2.38159e-13,5021.06,33.2263], Tmin=(862.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.6386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + missing(O2d-Cdd) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (125.191,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2120,512.5,787.5,180,180,180,1116.85,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.358703,'amu*angstrom^2'), symmetry=1, barrier=(8.2473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.659466,'amu*angstrom^2'), symmetry=1, barrier=(15.1624,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9588,0.0565609,-0.000119645,1.22372e-07,-4.56419e-11,15119.4,18.5458], Tmin=(100,'K'), Tmax=(864.193,'K')), NASAPolynomial(coeffs=[3.26941,0.022662,-1.24964e-05,2.44603e-09,-1.67786e-13,15932.1,18.4273], Tmin=(864.193,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-O4dc) + missing(O2d-Cdd) + group(CsJ2_singlet-CsH) + group(Cd(Cdd-Od)CF) + missing(Cdd-CdO2d)"""),
)

species(
    label = '[C-]=[O+]C(=O)C(=O)F(3641)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97487,0.0553276,-0.000113679,1.16442e-07,-4.39849e-11,-3880.44,8.72618], Tmin=(100,'K'), Tmax=(849.243,'K')), NASAPolynomial(coeffs=[3.33229,0.0237042,-1.32597e-05,2.6293e-09,-1.82578e-13,-3201.19,7.75581], Tmin=(849.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.7836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cds-CdsCsCs) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[C-]=[O+]OC(F)=C=O(3488)'],
    products = ['CO(13)', 'O=CC(=O)F(711)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O=C=C(F)[C-][O+]=O(3640)'],
    products = ['[C-]=[O+]OC(F)=C=O(3488)'],
    transitionState = 'TS2',
