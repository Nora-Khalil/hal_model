...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69624,0.0387729,-2.02522e-06,-3.96335e-08,2.28691e-11,-84525.1,22.6021], Tmin=(100,'K'), Tmax=(889.165,'K')), NASAPolynomial(coeffs=[17.0459,0.00303122,2.07643e-06,-5.76615e-10,4.16948e-14,-88571.5,-57.0525], Tmin=(889.165,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-703.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFOO) + ring(124trioxolane) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(O)OC(F)(F)O1(5561)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {8,S}
2 F u0 p3 c0 {8,S}
3 O u0 p2 c0 {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (127.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25785,0.0520447,-0.000104551,1.19692e-07,-4.94706e-11,-104398,20.676], Tmin=(100,'K'), Tmax=(839.258,'K')), NASAPolynomial(coeffs=[-2.71295,0.0407465,-2.18215e-05,4.29909e-09,-2.99474e-13,-102331,51.1275], Tmin=(839.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-868.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsOs) + group(CsFFOO) + ring(Cs-O2s-Cs(F)(F)-O2s) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-757.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,180,180,180,572.509,1069.16,1069.24,1069.36,1069.8],'cm^-1')),
        HinderedRotor(inertia=(0.00593849,'amu*angstrom^2'), symmetry=1, barrier=(4.81532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39884,'amu*angstrom^2'), symmetry=1, barrier=(32.162,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.016,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48456,0.0490051,-4.97239e-05,2.33841e-08,-4.23246e-12,-90963.1,24.1171], Tmin=(100,'K'), Tmax=(1353.25,'K')), NASAPolynomial(coeffs=[15.4864,0.0076177,-3.84824e-06,7.83827e-10,-5.7263e-14,-94752.7,-47.6693], Tmin=(1353.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-757.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsFFOO) + group(Cds-OdOsOs) + radical(O2sj(Cs-F1sF1sO2s)) + radical(OC=OOJ)"""),
)

species(
    label = '[O]C(=O)OC(O)(F)F(2432)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {7,S} {8,S}
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', 'O=C(O)O[C](F)F(409)'],
    products = ['[O]C(F)(F)OC(=O)O(4486)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)(F)OC(=O)O(4486)'],
    products = ['[O]C1(O)OC(F)(F)O1(5561)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O=C(O)OC(=O)F(337)'],
    products = ['[O]C(F)(F)OC(=O)O(4486)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O][C](F)OC(=O)O(4331)'],
    products = ['[O]C(F)(F)OC(=O)O(4486)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(249)', '[O]C(=O)O(229)'],
    products = ['[O]C(F)(F)OC(=O)O(4486)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(144)', 'O=[C]O(176)'],
    products = ['[O]C(F)(F)OC(=O)O(4486)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(5)', '[O]C(F)(F)O[C]=O(242)'],
    products = ['[O]C(F)(F)OC(=O)O(4486)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[O]C(=O)OC([O])(F)F(5562)'],
    products = ['[O]C(F)(F)OC(=O)O(4486)'],
