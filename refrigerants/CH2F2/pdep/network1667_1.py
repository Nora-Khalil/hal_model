...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OO[CH]F(4833)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[CH]F(128)', '[CH]C(=O)F-2(3116)'],
    products = ['O=C(F)[CH]OO[CH]F(4833)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(129)', '[O]O[CH]C(=O)F(3108)'],
    products = ['O=C(F)[CH]OO[CH]F(4833)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C=COO[CH]F(4854)'],
    products = ['O=C(F)[CH]OO[CH]F(4833)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[O]O[CH]C(=O)F(3108)'],
    products = ['O=C(F)[CH]OO[CH]F(4833)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]OO[CH]F(4833)'],
    products = ['[O]C(F)(C=O)O[CH]F(4832)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(6)', 'F[C]=COO[CH]F(4856)'],
    products = ['O=C(F)[CH]OO[CH]F(4833)'],
...
network(
    ...
    isomers = [
        'O=C(F)[CH]OO[CH]F(4833)',
    ],
    reactants = [
        ('CHFO(46)', 'O=CC(=O)F(711)'),
        ('CHF(40)', '[O]O[CH]C(=O)F(3108)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
