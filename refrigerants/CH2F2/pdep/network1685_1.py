...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.23875,'amu*angstrom^2'), symmetry=1, barrier=(28.4814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23871,'amu*angstrom^2'), symmetry=1, barrier=(28.4805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23199,'amu*angstrom^2'), symmetry=1, barrier=(28.3258,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (150.047,'amu'),
...
"""),
    E0 = (-872.679,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,415.583,1446.93,1446.95],'cm^-1')),
        HinderedRotor(inertia=(0.000978922,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0444807,'amu*angstrom^2'), symmetry=1, barrier=(5.43245,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['FOCC(F)(F)C(F)F(5571)'],
    products = ['HF(38)', 'CH2O(20)', 'CF2CF2(60)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'FOCC(F)F(1325)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF3(41)', 'F[C]COF(1725)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FCOF(685)', 'F[C]C(F)F(316)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FOC(F)(F)C(F)F(601)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]C(F)(F)COF(1747)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'FOCC(F)(F)F(1748)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(303)', 'C=C(F)C(F)F(1133)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FOC[C](F)C(F)F(1765)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[CH]C(F)(F)COF(1755)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]CC(F)(F)C(F)F(1557)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(203)', '[CH2]C(F)(F)C(F)F(1136)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OF(1534)', 'CHF2-CF2(68)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF2(81)', 'FOC[C](F)F(1729)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', 'FO[CH]C(F)(F)C(F)F(5572)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', 'FOCC(F)(F)[C](F)F(5573)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(77)', 'FC=C(F)COF(1757)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC(F)(F)C(F)F(902)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'FOC=C(F)C(F)F(1066)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'FOCC(F)=C(F)F(5574)'],
    products = ['FOCC(F)(F)C(F)F(5571)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FOCC(F)(F)C(F)F(5571)'],
    products = ['F2(77)', 'CH2O(20)', 'CHFCF2(54)'],
...
network(
    label = 'PDepNetwork #1685',
    isomers = [
        'FOCC(F)(F)C(F)F(5571)',
    ],
    reactants = [
        ('HF(38)', 'CH2O(20)', 'CF2CF2(60)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
