...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(188)', '[C]=C(4710)'],
    products = ['C=[C]OC([O])=O(4684)'],
    transitionState = 'TS2',
