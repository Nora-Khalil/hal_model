...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'C#CO[C](O)F(1975)'],
    products = ['C#COC(O)(F)F(1669)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(O)(F)F(178)', 'C2H(22)'],
    products = ['C#COC(O)(F)F(1669)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OH(7)', 'C#CO[C](F)F(1976)'],
    products = ['C#COC(O)(F)F(1669)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[C]#COC(O)(F)F(1977)'],
    products = ['C#COC(O)(F)F(1669)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'C#COC(=O)F(1979)'],
    products = ['C#COC(O)(F)F(1669)'],
    transitionState = 'TS9',
