...
species(
    label = '[O]C1(F)[CH]OC(F)(F)O1(3308)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3273)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C([CH]OF)O[C](F)F(3304)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3273)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(130)', '[O]C([O])(F)C=O(3305)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3273)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3273)'],
    products = ['F[C](F)OC1(F)[CH]OO1(3307)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3273)'],
    products = ['[O]C1(F)[CH]OC(F)(F)O1(3308)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3273)'],
    products = ['[O]C1OC1(F)O[C](F)F(3309)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=CC(=O)O[C](F)F(3311)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3273)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(15)', 'O=C(F)O[C](F)F(271)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3273)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF2(42)', '[O]C([O])(F)C=O(3305)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3273)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3273)'],
    products = ['O=[C]C(O)(F)O[C](F)F(3313)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3273)'],
    products = ['[O]C(F)([C]=O)OC(F)F(3314)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C=C(OF)O[C](F)F(3315)'],
    products = ['[O]C(F)(C=O)O[C](F)F(3273)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(C=O)O[C](F)F(3273)'],
    products = ['[O]C=C([O])OC(F)(F)F(3316)'],
