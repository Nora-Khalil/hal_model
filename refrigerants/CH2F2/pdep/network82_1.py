...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(162)', '[O]C([O])(F)F(144)'],
    products = ['[O]C(F)(F)O[C](F)F(246)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(7)', 'F[C](F)O[C](F)F(265)'],
    products = ['[O]C(F)(F)O[C](F)F(246)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[C](F)F(267)'],
    products = ['[O]C(F)(F)O[C](F)F(246)'],
    transitionState = 'TS6',
