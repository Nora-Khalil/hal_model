...
"""),
    E0 = (-221.111,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([364,474,579,619,655,1345,2950,1000,1855,455,950,427.869,427.882,427.888,427.889,427.911],'cm^-1')),
        HinderedRotor(inertia=(0.000920699,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000920726,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90093,0.0418584,-3.68287e-05,1.55459e-08,-2.59032e-12,-26514.5,19.3805], Tmin=(100,'K'), Tmax=(1436.5,'K')), NASAPolynomial(coeffs=[12.5964,0.0120761,-5.72985e-06,1.11319e-09,-7.853e-14,-29587.3,-36.0932], Tmin=(1436.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (67.471,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,1855,455,950,180,180,180,180,412.529,736.756,736.757,736.759],'cm^-1')),
        HinderedRotor(inertia=(0.0448352,'amu*angstrom^2'), symmetry=1, barrier=(17.27,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109386,'amu*angstrom^2'), symmetry=1, barrier=(42.1343,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0381,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80237,0.0491689,-6.52842e-05,4.16709e-08,-1.03187e-11,8193.39,15.1858], Tmin=(100,'K'), Tmax=(994.122,'K')), NASAPolynomial(coeffs=[11.8162,0.00887549,-4.485e-06,8.97215e-10,-6.46892e-14,6202.45,-33.066], Tmin=(994.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + ring(Cyclopropene) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02608,0.0510546,-5.63368e-05,2.9672e-08,-5.70052e-12,-30179.4,24.6691], Tmin=(100,'K'), Tmax=(1535.8,'K')), NASAPolynomial(coeffs=[14.4365,0.00407012,1.32844e-06,-4.71297e-10,3.83644e-14,-32876.7,-41.153], Tmin=(1535.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(COFOO) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC1(F)[CH]O1(2776)'],
    products = ['CO2(14)', 'FC1=CO1(1231)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(184)', '[O]C1(F)[CH]O1(2760)'],
    products = ['O=[C]OC1(F)[CH]O1(2776)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C1(F)[CH]O1(2760)'],
    products = ['O=[C]OC1(F)[CH]O1(2776)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CO2(14)', 'F[C]1[CH]O1(2828)'],
    products = ['O=[C]OC1(F)[CH]O1(2776)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC1=CO1(2860)'],
    products = ['O=[C]OC1(F)[CH]O1(2776)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(22.632,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[O][C]=O(145)', 'FC1=CO1(1231)'],
    products = ['O=[C]OC1(F)[CH]O1(2776)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(1.61003,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['[O][C]=O(145)', 'F[C]1[CH]O1(2828)'],
    products = ['O=[C]OC1(F)[CH]O1(2776)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OC1(F)[CH]O1(2776)'],
    products = ['O=C(F)O[C]1[CH]O1(2861)'],
...
network(
    label = 'PDepNetwork #1220',
    isomers = [
        'O=[C]OC1(F)[CH]O1(2776)',
    ],
    reactants = [
        ('CO2(14)', 'FC1=CO1(1231)'),
    ],
