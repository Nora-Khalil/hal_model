...
reaction(
    label = 'reaction3',
    reactants = ['OF(173)', 'O=C(O)[C]F(383)'],
    products = ['O=C(O)C(F)OF(716)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'O=C=C(F)OF(384)'],
    products = ['O=C(O)C(F)OF(716)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(O)[CH]OF(823)'],
    products = ['O=C(O)C(F)OF(716)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(=O)O(824)'],
    products = ['O=C(O)C(F)OF(716)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(203)', 'O=C(O)[CH]F(825)'],
    products = ['O=C(O)C(F)OF(716)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', '[O]C(=O)C(F)OF(827)'],
    products = ['O=C(O)C(F)OF(716)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(553)', 'O=[C]O(176)'],
    products = ['O=C(O)C(F)OF(716)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', 'O=C(O)[C](F)OF(388)'],
    products = ['O=C(O)C(F)OF(716)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(O)C(=O)F(393)'],
    products = ['O=C(O)C(F)OF(716)'],
