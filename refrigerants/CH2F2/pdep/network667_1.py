...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(150)', '[C]=C(1595)'],
    products = ['C=[C]OC([O])(F)F(1663)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C=[C]O[C](F)F(1741)'],
    products = ['C=[C]OC([O])(F)F(1663)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O][C](F)F(237)', 'CH2CO(28)'],
    products = ['C=[C]OC([O])(F)F(1663)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(=O)F(1743)'],
    products = ['C=[C]OC([O])(F)F(1663)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CF2O(48)', '[CH2][C]=O(1600)'],
    products = ['C=[C]OC([O])(F)F(1663)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC([O])(F)F(1744)'],
    products = ['C=[C]OC([O])(F)F(1663)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(237)', '[CH2][C]=O(1600)'],
    products = ['C=[C]OC([O])(F)F(1663)'],
    transitionState = 'TS9',
