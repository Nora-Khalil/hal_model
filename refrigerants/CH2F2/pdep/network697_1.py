...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FCC(F)(F)OF(617)'],
    products = ['FCC(F)(F)COF(1691)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)(F)COF(1703)'],
    products = ['FCC(F)(F)COF(1691)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'FOCC(F)(F)F(1704)'],
    products = ['FCC(F)(F)COF(1691)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(305)', 'C=C(F)CF(1706)'],
    products = ['FCC(F)(F)COF(1691)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[C](F)COF(1707)'],
    products = ['FCC(F)(F)COF(1691)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)(F)COF(1708)'],
    products = ['FCC(F)(F)COF(1691)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(F)(F)CF(1709)'],
    products = ['FCC(F)(F)COF(1691)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(125)', '[CH2]C(F)(F)CF(1710)'],
    products = ['FCC(F)(F)COF(1691)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(1347)', 'CH2F-CF2(67)'],
    products = ['FCC(F)(F)COF(1691)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(45)', 'FOC[C](F)F(1540)'],
    products = ['FCC(F)(F)COF(1691)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FCC(F)(F)[CH]OF(1711)'],
    products = ['FCC(F)(F)COF(1691)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[CH]C(F)(F)COF(1712)'],
    products = ['FCC(F)(F)COF(1691)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'C=C(F)COF(1713)'],
    products = ['FCC(F)(F)COF(1691)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'FCC(F)=COF(1714)'],
    products = ['FCC(F)(F)COF(1691)'],
