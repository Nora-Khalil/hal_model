...
species(
    label = '[CH2]C(F)(F)C1=C(F)O1(2983)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
    products = ['[CH2]C1(F)O[C](F)C1F(2980)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C1O[C]1F(2836)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
    products = ['FC1(F)CC2(F)OC12(2973)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
    products = ['CC(F)(F)C1=C(F)O1(2981)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)[CH]C(=O)F(2982)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C1=C(F)O1(2983)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C1O[C]1F(2984)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C=C(F)[C]1O[C]1F(2985)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
    products = ['CC(F)(F)[C]1O[C]1F(2987)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
    products = ['[CH2][C](F)C1OC1(F)F(2988)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FC[C](F)C1O[C]1F(2989)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(2812)'],
