...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC(F)(F)OF(1307)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'O=C([C]F)OF(371)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'O=C(OF)C(F)F(556)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(303)', 'CC(F)=C=O(1317)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)C([O])OF(1320)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)[C](O)OF(1321)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(=O)OF(1322)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])=O(1323)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(203)', 'CC(F)(F)[C]=O(1324)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'O=C(OF)[C](F)F(379)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH2]C(F)(F)C(=O)OF(564)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C=C(F)C(=O)OF(568)'],
    products = ['CC(F)(F)C(=O)OF(1300)'],
