...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[CH]C(=O)F-2(2561)'],
    products = ['[CH]=C(F)O[C](F)F(2547)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C#CO[C](F)F(1976)'],
    products = ['[CH]=C(F)O[C](F)F(2547)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2(42)', '[CH]C(=O)F-2(2561)'],
    products = ['[CH]=C(F)O[C](F)F(2547)'],
    transitionState = 'TS8',
