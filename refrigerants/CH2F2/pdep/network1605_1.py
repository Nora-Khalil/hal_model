...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.855936,'amu*angstrom^2'), symmetry=1, barrier=(19.6797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.853682,'amu*angstrom^2'), symmetry=1, barrier=(19.6278,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.038888,'amu*angstrom^2'), symmetry=1, barrier=(12.2484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.48024,'amu*angstrom^2'), symmetry=1, barrier=(57.0255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C([O])(F)C=O(4516)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[CH]=C(F)C([O])F(2657)'],
    products = ['[CH]=C(F)C([O])(F)C=O(4516)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C([O])(F)C=O(4516)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(4517)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH]C(F)=C(F)C=O(3100)'],
    products = ['[CH]=C(F)C([O])(F)C=O(4516)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(F)C([O])(F)C=O(4516)'],
    products = ['[CH]=C(F)C1(F)[CH]OO1(4613)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(F)C([O])(F)C=O(4516)'],
    products = ['[O]C1(F)[CH]OC=C1F(4546)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(F)C([O])(F)C=O(4516)'],
    products = ['[CH]=C(F)C1(F)OC1[O](4614)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(F)C(=O)C=O(4615)'],
    products = ['[CH]=C(F)C([O])(F)C=O(4516)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', '[CH]=C(F)C(=O)F(2015)'],
    products = ['[CH]=C(F)C([O])(F)C=O(4516)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'C#CC([O])(F)C=O(4616)'],
    products = ['[CH]=C(F)C([O])(F)C=O(4516)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(77)', 'C#CC([O])=C[O](4617)'],
    products = ['[CH]=C(F)C([O])(F)C=O(4516)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', '[CH]=C(F)C(=O)[C]=O(4618)'],
    products = ['[CH]=C(F)C([O])(F)C=O(4516)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(F)C([O])(F)C=O(4516)'],
    products = ['[CH]=C(F)C(O)(F)[C]=O(4619)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(F)=C(C=O)OF(4621)'],
    products = ['[CH]=C(F)C([O])(F)C=O(4516)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=[C]C(F)(C=O)OF(4622)'],
    products = ['[CH]=C(F)C([O])(F)C=O(4516)'],
...
network(
    label = 'PDepNetwork #1605',
    isomers = [
        '[CH]=C(F)C([O])(F)C=O(4516)',
    ],
    reactants = [
