...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C([O])=C=O(194)'],
    products = ['[CH2]C(=O)C([O])=O(4683)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(7)', '[CH2]C([O])=C=O(4756)'],
    products = ['[CH2]C(=O)C([O])=O(4683)'],
    transitionState = 'TS4',
