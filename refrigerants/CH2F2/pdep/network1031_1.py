...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(183)', 'O[C]F-2(1323)'],
    products = ['O=[C]OO[C](O)F(2337)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(184)', '[O]O[C](O)F(279)'],
    products = ['O=[C]OO[C](O)F(2337)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C]=O(183)', 'O[C]F(432)'],
    products = ['O=[C]OO[C](O)F(2337)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(2.07289,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)OO[C]=O(2349)'],
    products = ['O=[C]OO[C](O)F(2337)'],
