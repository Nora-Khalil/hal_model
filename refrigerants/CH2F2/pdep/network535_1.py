...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(137)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])F(1363)'],
    transitionState = 'TS2',
