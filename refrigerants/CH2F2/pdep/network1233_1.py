...
species(
    label = 'O=C(F)[CH]O[CH]C(F)F(3690)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC[C](F)F(3570)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F-2(2868)', '[O]C[C](F)F(1144)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(162)', '[CH2]O[CH]C(=O)F(3018)'],
    products = ['O=C(F)[CH]OC[C](F)F(3570)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OC[C](F)F(3570)'],
    products = ['F[C](F)COC1O[C]1F(3686)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)[CH]OC[C](F)F(3570)'],
    products = ['[O]C1(F)[CH]OCC1(F)F(3688)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', 'O=C(F)[CH]OC=C(F)F(3414)'],
    products = ['O=C(F)[CH]OC[C](F)F(3570)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C=COC[C](F)F(3689)'],
    products = ['O=C(F)[CH]OC[C](F)F(3570)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(42)', '[CH2]O[CH]C(=O)F(3018)'],
    products = ['O=C(F)[CH]OC[C](F)F(3570)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]OC[C](F)F(3570)'],
    products = ['O=C(F)[CH]O[CH]C(F)F(3690)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(F)CO[CH][C](F)F(3691)'],
    products = ['O=C(F)[CH]OC[C](F)F(3570)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]C(F)OC[C](F)F(3630)'],
    products = ['O=C(F)[CH]OC[C](F)F(3570)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(7)', 'F[C]=COC[C](F)F(3693)'],
    products = ['O=C(F)[CH]OC[C](F)F(3570)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(F)[CH]OC[C](F)F(3570)'],
    products = ['[O][C](F)C1OCC1(F)F(3696)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C=[C]OC[C](F)F(3637)'],
    products = ['O=C(F)[CH]OC[C](F)F(3570)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)=[C]OC[C](F)F(3697)'],
    products = ['O=C(F)[CH]OC[C](F)F(3570)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)=[C]OCC(F)F(3698)'],
    products = ['O=C(F)[CH]OC[C](F)F(3570)'],
...
reaction(
    label = 'reaction27',
    reactants = ['OC(F)=CO[CH][C](F)F(3699)'],
    products = ['O=C(F)[CH]OC[C](F)F(3570)'],
