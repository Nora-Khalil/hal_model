...
reaction(
    label = 'reaction1',
    reactants = ['CO(13)', 'CHF2(81)'],
    products = ['O=[C]C(F)F(434)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]C(F)F(434)'],
    products = ['O=C(F)[CH]F(1260)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C[C]F(816)'],
    products = ['O=C[C](F)F(961)'],
    transitionState = 'TS9',
