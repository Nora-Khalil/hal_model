...
reaction(
    label = 'reaction2',
    reactants = ['[O]OC(F)[C](F)F(467)'],
    products = ['O=O(148)', 'CHFCF2(54)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(130)', '[O]O[CH]F(128)'],
    products = ['[O]OC(F)[C](F)F(467)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)=C(F)F(428)'],
    products = ['[O]OC(F)[C](F)F(467)'],
    transitionState = 'TS9',
