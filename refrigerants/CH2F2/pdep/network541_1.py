...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH2]O[CH2](1438)'],
    products = ['[CH2]OC[C](F)F(1369)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]OC=C(F)F(1396)'],
    products = ['[CH2]OC[C](F)F(1369)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(42)', '[CH2]O[CH2](1438)'],
    products = ['[CH2]OC[C](F)F(1369)'],
