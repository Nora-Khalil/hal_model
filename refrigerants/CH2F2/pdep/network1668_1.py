...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[CH]F(128)', 'O=C[C]F(3123)'],
    products = ['O=C[C](F)OO[CH]F(4834)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(129)', '[O]O[C](F)C=O(2071)'],
    products = ['O=C[C](F)OO[CH]F(4834)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['O=C[C](F)OO[CH]F(4834)'],
    products = ['F[CH]OOC1(F)[CH]O1(4839)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C=C(F)OO[CH]F(3479)'],
    products = ['O=C[C](F)OO[CH]F(4834)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]O[CH]F(128)', 'O=C[C]F-2(818)'],
    products = ['O=C[C](F)OO[CH]F(4834)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[O]O[C](F)C=O(2071)'],
    products = ['O=C[C](F)OO[CH]F(4834)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]C(F)OO[CH]F(4842)'],
    products = ['O=C[C](F)OO[CH]F(4834)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(6)', '[CH]=C(F)OO[CH]F(4844)'],
    products = ['O=C[C](F)OO[CH]F(4834)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=C[C](F)OO[CH]F(4834)'],
    products = ['[O][CH]F(134)', 'FC1=COO1(2668)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=C=[C]OO[CH]F(4847)'],
    products = ['O=C[C](F)OO[CH]F(4834)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O[C]=C(F)OO[CH]F(4848)'],
    products = ['O=C[C](F)OO[CH]F(4834)'],
