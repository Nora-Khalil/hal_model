...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(137)', '[C]=C(1595)'],
    products = ['C=[C]OC([O])F(3847)'],
    transitionState = 'TS2',
