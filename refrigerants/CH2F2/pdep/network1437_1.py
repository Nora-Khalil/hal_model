...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.10343,0.0067304,5.71884e-05,-7.51673e-08,2.76809e-11,10972.4,14.7016], Tmin=(100,'K'), Tmax=(991.366,'K')), NASAPolynomial(coeffs=[9.09127,0.0156783,-6.44463e-06,1.31119e-09,-1.00361e-13,8158.27,-22.3398], Tmin=(991.366,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.8656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=C(O)C=O(3934)',
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46209,0.0380077,-5.12247e-05,4.36607e-08,-1.39667e-11,17196.6,16.954], Tmin=(100,'K'), Tmax=(1007.41,'K')), NASAPolynomial(coeffs=[3.07283,0.0219674,-7.06875e-06,1.02436e-09,-5.68182e-14,17764.5,17.4321], Tmin=(1007.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(C2CsJO)"""),
)

species(
    label = '[O][C]1COC1(3936)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79905,0.0347503,-2.75231e-05,1.27744e-08,-2.24486e-12,16712.6,16.9687], Tmin=(100,'K'), Tmax=(1741.82,'K')), NASAPolynomial(coeffs=[6.72231,0.0143935,-2.19816e-06,9.82688e-11,2.70044e-15,16370.5,-5.57411], Tmin=(1741.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1([O])CO1(3918)',
    structure = adjacencyList("""multiplicity 3
1 O u0 p2 c0 {3,S} {4,S}
2 O u1 p2 c0 {3,S}
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.102858,0.0566825,-6.34935e-05,3.1956e-08,-5.66228e-12,-14328,23.2851], Tmin=(100,'K'), Tmax=(1743.91,'K')), NASAPolynomial(coeffs=[16.045,-0.0011761,4.58688e-06,-1.0711e-09,7.60046e-14,-16650.6,-53.2095], Tmin=(1743.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C(O)=C[O](3938)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (111.231,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3120,650,792.5,1650,349.945],'cm^-1')),
        HinderedRotor(inertia=(0.0871703,'amu*angstrom^2'), symmetry=1, barrier=(7.58358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0877174,'amu*angstrom^2'), symmetry=1, barrier=(7.57751,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13195,0.0413022,-4.46389e-05,2.60775e-08,-6.14667e-12,13445.1,18.9499], Tmin=(100,'K'), Tmax=(1027.35,'K')), NASAPolynomial(coeffs=[8.89199,0.0149821,-6.21007e-06,1.14055e-09,-7.84347e-14,12056.1,-13.8458], Tmin=(1027.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])CO(3940)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99748,0.041781,-4.62048e-05,2.69312e-08,-6.16146e-12,2880.04,20.0683], Tmin=(100,'K'), Tmax=(1074.95,'K')), NASAPolynomial(coeffs=[10.1728,0.0113594,-3.75339e-06,6.0303e-10,-3.82449e-14,1122.46,-19.9634], Tmin=(1074.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.3303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97511,0.00701282,6.36251e-05,-8.78529e-08,3.37583e-11,-20939.1,12.8077], Tmin=(100,'K'), Tmax=(966.601,'K')), NASAPolynomial(coeffs=[11.4899,0.0111325,-3.84164e-06,8.01736e-10,-6.57029e-14,-24423.8,-37.4926], Tmin=(966.601,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.40902,0.0257272,-1.20881e-05,2.28106e-09,-1.52667e-13,41916.8,11.8187], Tmin=(100,'K'), Tmax=(2888.77,'K')), NASAPolynomial(coeffs=[24.4388,0.000353081,-8.57285e-07,1.38044e-10,-6.04764e-15,28204,-114.652], Tmin=(2888.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(C2CsJOO) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(=C)[O](1917)'],
    products = ['C=C([O])C[O](3833)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2O(20)', '[CH2][C]=O(1600)'],
    products = ['C=C([O])C[O](3833)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(=O)C=O(3900)'],
    products = ['C=C([O])C[O](3833)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](1324)', '[CH2][C]=O(1600)'],
    products = ['C=C([O])C[O](3833)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[O]C[C]=O(1381)'],
    products = ['C=C([O])C[O](3833)'],
