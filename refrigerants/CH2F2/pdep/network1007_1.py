...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', 'C=C[C]F(2593)'],
    products = ['[O]CC=[C]F(2630)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](1455)', '[CH]=[C]F(1826)'],
    products = ['[O]CC=[C]F(2630)'],
    transitionState = 'TS9',
