...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'O=C(F)O[CH]F(157)'],
    products = ['[O]C(F)O[CH]F(712)'],
    transitionState = 'TS8',
