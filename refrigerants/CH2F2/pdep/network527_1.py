...
reaction(
    label = 'reaction2',
    reactants = ['[O]CC(F)[C](F)F(1357)'],
    products = ['[O]CC(F)(F)[CH]F(1356)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[CH]F(1082)'],
    products = ['[O]CC(F)(F)[CH]F(1356)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](1324)', 'CHFCF2(54)'],
    products = ['[O]CC(F)(F)[CH]F(1356)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2O(20)', 'F[CH][C](F)F(383)'],
    products = ['[O]CC(F)(F)[CH]F(1356)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=CC(F)(F)[CH]F(786)'],
    products = ['[O]CC(F)(F)[CH]F(1356)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](1324)', 'F[CH][C](F)F(383)'],
    products = ['[O]CC(F)(F)[CH]F(1356)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]C=C(F)[CH]F(787)'],
    products = ['[O]CC(F)(F)[CH]F(1356)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]C(F)(F)[CH]F(1416)'],
    products = ['[O]CC(F)(F)[CH]F(1356)'],
