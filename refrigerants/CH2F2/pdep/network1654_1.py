...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](126)', '[CH]C(=O)F-2(3116)'],
    products = ['[O]OO[CH]C(=O)F(3263)'],
    transitionState = 'TS2',
