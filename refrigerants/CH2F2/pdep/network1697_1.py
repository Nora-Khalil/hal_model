...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3925.47,'J/mol'), sigma=(6.12965,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=613.15 K, Pc=38.67 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(OF)O[CH]O(5027)'],
    products = ['O=COC(O)(F)OF(4957)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=CO[C](O)OF(5028)'],
    products = ['O=COC(O)(F)OF(4957)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(O)(F)OC=O(5029)'],
    products = ['O=COC(O)(F)OF(4957)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C=O(141)', 'O[C](F)OF(2299)'],
    products = ['O=COC(O)(F)OF(4957)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HCO(15)', '[O]C(O)(F)OF(4968)'],
    products = ['O=COC(O)(F)OF(4957)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=CO[C](F)OF(331)'],
    products = ['O=COC(O)(F)OF(4957)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)(OF)OC=O(4952)'],
    products = ['O=COC(O)(F)OF(4957)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(125)', 'O=CO[C](O)F(5030)'],
    products = ['O=COC(O)(F)OF(4957)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=[C]OC(O)(F)OF(4994)'],
    products = ['O=COC(O)(F)OF(4957)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=COC(O)(F)OF(4957)'],
    products = ['O=C(F)OF(151)', 'O=CO(168)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(77)', 'O=COC(=O)O(5031)'],
    products = ['O=COC(O)(F)OF(4957)'],
