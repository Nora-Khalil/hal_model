...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]CC(F)F-2(1190)'],
    products = ['F[C](F)CC(F)F(996)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(130)', 'CHF2-CH2(63)'],
    products = ['F[C](F)CC(F)F(996)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C[C](F)F(1070)'],
    products = ['F[C](F)CC(F)F(996)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(81)', '[CH2][C](F)F(933)'],
    products = ['F[C](F)CC(F)F(996)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)[CH]C(F)F(599)'],
    products = ['F[C](F)CC(F)F(996)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)C[C](F)F(1057)'],
    products = ['F[C](F)CC(F)F(996)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'F[CH]C=C(F)F(601)'],
    products = ['F[C](F)CC(F)F(996)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[C]CC(F)F(1183)'],
    products = ['F[C](F)CC(F)F(996)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)CC(F)F(996)'],
    products = ['F[CH]CC(F)(F)F(1192)'],
