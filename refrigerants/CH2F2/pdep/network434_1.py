...
species(
    label = 'F[CH]C(F)(F)[CH]C(F)F(1098)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0866714,0.0954155,-0.000161408,1.43835e-07,-5.01788e-11,-96879.9,29.9835], Tmin=(100,'K'), Tmax=(808.59,'K')), NASAPolynomial(coeffs=[10.3663,0.0308674,-1.62588e-05,3.21521e-09,-2.2542e-13,-98094.6,-14.6573], Tmin=(808.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-806.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'F[C](F)C[C](F)C(F)F(1077)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1010)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)CC(F)[C](F)F(1012)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1010)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(129)', 'F[C](F)C[C](F)F(1057)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1010)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]C(F)(F)C=C(F)F(556)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1010)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=C(F)C[C](F)F(1097)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1010)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[CH]C(F)=C[C](F)F(559)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1010)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'F[C](F)C[C](F)F(1057)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1010)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)[CH]C(F)F(1098)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1010)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FCC(F)(F)[CH][C](F)F(1094)'],
    products = ['F[CH]C(F)(F)C[C](F)F(1010)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1010)'],
    products = ['F[CH][C](F)CC(F)(F)F(1099)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C[C](F)F(1010)'],
    products = ['F[C](F)C[C](F)C(F)F(1077)'],
