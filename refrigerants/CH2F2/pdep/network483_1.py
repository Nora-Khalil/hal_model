...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(81)', '[CH2]O[O](1124)'],
    products = ['[O]OCC(F)F(1289)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', '[O]O[CH]C(F)F(657)'],
    products = ['[O]OCC(F)F(1289)'],
