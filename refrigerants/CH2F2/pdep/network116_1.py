...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CO[C](F)OF(331)'],
    products = ['O=COC(F)(F)OF(325)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)OC=O(332)'],
    products = ['O=COC(F)(F)OF(325)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(221)', '[O]C=O(141)'],
    products = ['O=COC(F)(F)OF(325)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)OF(301)', 'HCO(15)'],
    products = ['O=COC(F)(F)OF(325)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(125)', 'O=CO[C](F)F(333)'],
    products = ['O=COC(F)(F)OF(325)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC(F)(F)OF(334)'],
    products = ['O=COC(F)(F)OF(325)'],
    transitionState = 'TS9',
