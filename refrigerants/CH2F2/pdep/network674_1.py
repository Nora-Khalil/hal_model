...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'C#COO(1905)'],
    products = ['C#COOC(F)F(1668)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C#COO[CH]F(1907)'],
    products = ['C#COOC(F)F(1668)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COO[C](F)F(1738)'],
    products = ['C#COOC(F)F(1668)'],
    transitionState = 'TS8',
