...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.893883,'amu*angstrom^2'), symmetry=1, barrier=(20.5521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.893017,'amu*angstrom^2'), symmetry=1, barrier=(20.5322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.893093,'amu*angstrom^2'), symmetry=1, barrier=(20.534,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-379.532,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,1896.4],'cm^-1')),
        HinderedRotor(inertia=(0.348931,'amu*angstrom^2'), symmetry=1, barrier=(8.02261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.349172,'amu*angstrom^2'), symmetry=1, barrier=(8.02814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03906,'amu*angstrom^2'), symmetry=1, barrier=(23.8901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
"""),
    E0 = (-638.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,528,1116,1182,1331,1402,1494,3075,3110,2750,2850,1437.5,1250,1305,750,350,395.883,395.932,395.979],'cm^-1')),
        HinderedRotor(inertia=(0.00107493,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00107508,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'FCCOF(1746)'],
    products = ['FCC(F)(F)COF(1599)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(1)', 'F[C]COF(1725)'],
    products = ['FCC(F)(F)COF(1599)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FCC(F)(F)OF(554)'],
    products = ['FCC(F)(F)COF(1599)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)(F)COF(1747)'],
    products = ['FCC(F)(F)COF(1599)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'FOCC(F)F(1325)'],
    products = ['FCC(F)(F)COF(1599)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'FOCC(F)(F)F(1748)'],
    products = ['FCC(F)(F)COF(1599)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(303)', 'C=C(F)CF(1750)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[C](F)COF(1751)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)(F)COF(1752)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(F)(F)CF(1753)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(203)', '[CH2]C(F)(F)CF(1754)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(1534)', 'CH2F-CF2(67)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(45)', 'FOC[C](F)F(1729)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', 'FCC(F)(F)[CH]OF(1044)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', 'F[CH]C(F)(F)COF(1755)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'C=C(F)COF(1756)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=CC(F)(F)CF(1049)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'FCC(F)=COF(1050)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'FC=C(F)COF(1757)'],
    products = ['FCC(F)(F)COF(1599)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FCC(F)(F)COF(1599)'],
    products = ['F2(77)', 'CH2O(20)', 'CH2CF2(56)'],
