...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(129)', '[O]C1O[C]1F(2759)'],
    products = ['F[CH]OC1O[C]1F(2808)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]O[CH]F(2932)'],
    products = ['F[CH]OC1O[C]1F(2808)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]OC1=C(F)O1(2933)'],
    products = ['F[CH]OC1O[C]1F(2808)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[O]C1O[C]1F(2759)'],
    products = ['F[CH]OC1O[C]1F(2808)'],
