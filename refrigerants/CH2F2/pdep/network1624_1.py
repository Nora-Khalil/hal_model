...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C=C(O)OF(4270)'],
    products = ['C=C(O)C(=O)OF(4648)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)C([O])=O(4695)'],
    products = ['C=C(O)C(=O)OF(4648)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=[C]C(=O)OF(4696)'],
    products = ['C=C(O)C(=O)OF(4648)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)OF(4697)'],
    products = ['C=C(O)C(=O)OF(4648)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(125)', 'C=C(O)[C]=O(4698)'],
    products = ['C=C(O)C(=O)OF(4648)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OF(146)', 'C=[C]O(1601)'],
    products = ['C=C(O)C(=O)OF(4648)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)C(=O)OF(4699)'],
    products = ['C=C(O)C(=O)OF(4648)'],
