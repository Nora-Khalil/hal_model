...
reaction(
    label = 'reaction1',
    reactants = ['[O]CO[O](1349)'],
    products = ['O=O(148)', 'CH2O(20)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[O](1374)'],
    products = ['[O]CO[O](1349)'],
    transitionState = 'TS2',
