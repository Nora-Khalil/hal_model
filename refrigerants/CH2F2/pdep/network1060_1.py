...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH]=C(F)O[O](2467)'],
    products = ['[CH]=C(F)OO[O](2721)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['O2(2)', '[CH]C(=O)F-2(2868)'],
    products = ['[CH]=C(F)OO[O](2721)'],
    transitionState = 'TS7',
