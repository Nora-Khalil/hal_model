...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(F)(F)[C](F)F(2392)'],
...
reaction(
    ...
    products = ['[CH2]OC(F)(F)[C](F)F(2392)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(F)=C(F)F(1397)'],
    products = ['[CH2]OC(F)(F)[C](F)F(2392)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OC(F)(F)[C](F)F(2392)'],
    products = ['[CH2]O[C](F)C(F)(F)F(2465)'],
