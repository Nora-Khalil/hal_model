...
"""),
    E0 = (-696.258,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,1855,455,950,180,180,180],'cm^-1')),
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O=C(F)O[C](O)F(369)'],
    products = ['[O]C(O)(F)OC(=O)F(4953)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(O)(F)OC(=O)F(4953)'],
    products = ['[O]C1(F)OC(O)(F)O1(5001)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(O)OC(=O)F(400)'],
    products = ['[O]C(O)(F)OC(=O)F(4953)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)F(142)', 'O=C(O)F(140)'],
    products = ['[O]C(O)(F)OC(=O)F(4953)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'O=C(F)OC(=O)F(371)'],
    products = ['[O]C(O)(F)OC(=O)F(4953)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O][C](F)OC(=O)O(2355)'],
    products = ['[O]C(O)(F)OC(=O)F(4953)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(O)(F)O[C]=O(2336)'],
    products = ['[O]C(O)(F)OC(=O)F(4953)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)F(142)', '[O][C](O)F(143)'],
    products = ['[O]C(O)(F)OC(=O)F(4953)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CFO(50)', '[O]C([O])(O)F(2351)'],
    products = ['[O]C(O)(F)OC(=O)F(4953)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', '[O][C](F)OC(=O)F(242)'],
    products = ['[O]C(O)(F)OC(=O)F(4953)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C([O])(F)OC(=O)F(5002)'],
    products = ['[O]C(O)(F)OC(=O)F(4953)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C(=O)OC(=O)F(255)'],
    products = ['[O]C(O)(F)OC(=O)F(4953)'],
