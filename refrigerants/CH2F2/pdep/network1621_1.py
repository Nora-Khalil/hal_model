...
reaction(
    label = 'reaction3',
    reactants = ['O[C]1OC[C](F)O1(4753)'],
    products = ['C=C(F)OC(=O)O(4645)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=[C]OC(=O)O(4759)'],
    products = ['C=C(F)OC(=O)O(4645)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(226)', 'CH2CF(69)'],
    products = ['C=C(F)OC(=O)O(4645)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=C(F)O[C]=O(1035)'],
    products = ['C=C(F)OC(=O)O(4645)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(F)OC([O])=O(4760)'],
    products = ['C=C(F)OC(=O)O(4645)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)OC(=O)O(4761)'],
    products = ['C=C(F)OC(=O)O(4645)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COC(=O)O(1638)'],
    products = ['C=C(F)OC(=O)O(4645)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(25)', 'O=C(O)[O+]=[C-]F(3667)'],
    products = ['C=C(F)OC(=O)O(4645)'],
