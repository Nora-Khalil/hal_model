...
reaction(
    label = 'reaction3',
    reactants = ['FOF(305)', 'OC(F)[C]F(900)'],
    products = ['OC(F)C(F)(F)OF(887)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2O(3)', 'F[C]C(F)(F)OF(303)'],
    products = ['OC(F)C(F)(F)OF(887)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(147)', 'OC(F)=C(F)F(308)'],
    products = ['OC(F)C(F)(F)OF(887)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(305)', 'OC=C(F)F(903)'],
    products = ['OC(F)C(F)(F)OF(887)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(147)', 'FC=C(F)OF(904)'],
    products = ['OC(F)C(F)(F)OF(887)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)[C](F)OF(905)'],
    products = ['OC(F)C(F)(F)OF(887)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[CH]C(F)(F)OF(906)'],
    products = ['OC(F)C(F)(F)OF(887)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(O)F(907)'],
    products = ['OC(F)C(F)(F)OF(887)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(125)', 'OC(F)[C](F)F(454)'],
    products = ['OC(F)C(F)(F)OF(887)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'F[CH]C(F)(F)OF(674)'],
    products = ['OC(F)C(F)(F)OF(887)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)C(F)(F)OF(908)'],
    products = ['OC(F)C(F)(F)OF(887)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FO[C](F)F(221)', 'O[CH]F(292)'],
    products = ['OC(F)C(F)(F)OF(887)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O[C](F)C(F)(F)OF(309)'],
    products = ['OC(F)C(F)(F)OF(887)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(77)', 'O=C(F)C(O)F(809)'],
    products = ['OC(F)C(F)(F)OF(887)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=CC(F)(F)OF(909)'],
    products = ['OC(F)C(F)(F)OF(887)'],
