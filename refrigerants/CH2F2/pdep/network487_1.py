...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'O=C(O)O(1309)'],
    products = ['O=C(O)OC(F)F(1268)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)O[CH]F(1313)'],
    products = ['O=C(O)OC(F)F(1268)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)F(164)', 'O=[C]O(161)'],
    products = ['O=C(O)OC(F)F(1268)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(F)F(364)'],
    products = ['O=C(O)OC(F)F(1268)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(O)O[C](F)F(373)'],
    products = ['O=C(O)OC(F)F(1268)'],
