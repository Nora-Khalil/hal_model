...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'O=C([C]F)OF(336)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'O=C(OF)C(F)F(619)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(305)', 'CC(F)=C=O(1124)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)C([O])OF(1127)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)[C](O)OF(1128)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(=O)OF(1129)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])=O(1130)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(125)', 'CC(F)(F)[C]=O(1131)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'O=C(OF)[C](F)F(344)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OF(146)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)OF(627)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C=C(F)C(=O)OF(631)'],
    products = ['CC(F)(F)C(=O)OF(1025)'],
