...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'F[C]COF(1536)'],
    products = ['CC(F)(F)COF(1695)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'CC(F)(F)OF(1123)'],
    products = ['CC(F)(F)COF(1695)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(305)', 'C=C(C)F(1769)'],
    products = ['CC(F)(F)COF(1695)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)C[O](1771)'],
    products = ['CC(F)(F)COF(1695)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(125)', '[CH2]C(C)(F)F(1606)'],
    products = ['CC(F)(F)COF(1695)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OF(1347)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)COF(1695)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'FOC[C](F)F(1540)'],
    products = ['CC(F)(F)COF(1695)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)(F)[CH]OF(1575)'],
    products = ['CC(F)(F)COF(1695)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)COF(1708)'],
    products = ['CC(F)(F)COF(1695)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC(F)(F)C=O(1451)'],
    products = ['CC(F)(F)COF(1695)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(F)COF(1713)'],
    products = ['CC(F)(F)COF(1695)'],
