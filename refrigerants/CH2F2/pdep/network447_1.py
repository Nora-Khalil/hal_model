...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH2]C[C](F)F(1142)'],
    products = ['F[C](F)CC[C](F)F(1023)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C](F)CC=C(F)F(1074)'],
    products = ['F[C](F)CC[C](F)F(1023)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(42)', '[CH2]C[C](F)F(1142)'],
    products = ['F[C](F)CC[C](F)F(1023)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)CC[C](F)F(1023)'],
    products = ['F[C](F)C[CH]C(F)F(1145)'],
