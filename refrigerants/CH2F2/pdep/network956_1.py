...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)(F)F(2259)'],
    products = ['CF2(42)', 'CF3(44)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'F[C]C(F)(F)F-2(2260)'],
    products = ['F[C](F)C(F)(F)F(2259)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C](F)[C](F)F(384)'],
    products = ['F[C](F)C(F)(F)F(2259)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]C(F)(F)F(850)'],
    products = ['F[C](F)C(F)(F)F(2259)'],
    transitionState = 'TS6',
