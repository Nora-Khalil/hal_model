...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(162)', '[O]C[C](F)F(1144)'],
    products = ['F[C](F)CO[C](F)F(1149)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(162)', '[CH2]O[C](F)F(1174)'],
    products = ['F[C](F)CO[C](F)F(1149)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CF2O(48)', '[CH2][C](F)F(1096)'],
    products = ['F[C](F)CO[C](F)F(1149)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(249)', 'CH2CF2(56)'],
    products = ['F[C](F)CO[C](F)F(1149)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'F[C](F)OC=C(F)F(500)'],
    products = ['F[C](F)CO[C](F)F(1149)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(249)', '[CH2][C](F)F(1096)'],
    products = ['F[C](F)CO[C](F)F(1149)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(42)', '[CH2]O[C](F)F(1174)'],
    products = ['F[C](F)CO[C](F)F(1149)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[O]C[C](F)F(1144)'],
    products = ['F[C](F)CO[C](F)F(1149)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)CO[C](F)F(1149)'],
    products = ['F[C](F)O[CH]C(F)F(1176)'],
