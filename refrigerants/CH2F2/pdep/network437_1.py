...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C([O])F(1013)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C(F)[C](F)F(452)'],
    products = ['[CH2]C(F)(F)C([O])F(1013)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C([O])F(1133)'],
    products = ['[CH2]C(F)(F)C([O])F(1013)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C=O(1134)'],
    products = ['[CH2]C(F)(F)C([O])F(1013)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)F(943)'],
    products = ['[CH2]C(F)(F)C([O])F(1013)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(77)', '[CH2]C(F)=C[O](1135)'],
    products = ['[CH2]C(F)(F)C([O])F(1013)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2][C](F)C(=O)F(1065)'],
    products = ['[CH2]C(F)(F)C([O])F(1013)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)[CH]OF(1140)'],
    products = ['[CH2]C(F)(F)C([O])F(1013)'],
