...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'CCOF(1769)'],
    products = ['CC(F)(F)COF(1603)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'F[C]COF(1725)'],
    products = ['CC(F)(F)COF(1603)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'CC(F)(F)OF(1307)'],
    products = ['CC(F)(F)COF(1603)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'FOCC(F)F(1325)'],
    products = ['CC(F)(F)COF(1603)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(303)', 'C=C(C)F(1771)'],
    products = ['CC(F)(F)COF(1603)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)C[O](1773)'],
    products = ['CC(F)(F)COF(1603)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(203)', '[CH2]C(C)(F)F(1774)'],
    products = ['CC(F)(F)COF(1603)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OF(1534)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)COF(1603)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'FOC[C](F)F(1729)'],
    products = ['CC(F)(F)COF(1603)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'CC(F)(F)[CH]OF(1422)'],
    products = ['CC(F)(F)COF(1603)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH2]C(F)(F)COF(1752)'],
    products = ['CC(F)(F)COF(1603)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC(F)(F)C=O(1425)'],
    products = ['CC(F)(F)COF(1603)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(F)COF(1756)'],
    products = ['CC(F)(F)COF(1603)'],
