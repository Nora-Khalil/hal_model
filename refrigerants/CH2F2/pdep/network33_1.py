...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(184)', '[O]C([O])=O(185)'],
    products = ['[O]C(=O)O[C]=O(170)'],
    transitionState = 'TS2',
