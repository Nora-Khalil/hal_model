...
reaction(
    label = 'reaction2',
    reactants = ['[O][C](F)C(=O)OF(258)'],
    products = ['[O]C(=O)C([O])(F)F(240)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(=O)F(263)'],
    products = ['[O]C(=O)C([O])(F)F(240)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)F(249)', '[O][C]=O(141)'],
    products = ['[O]C(=O)C([O])(F)F(240)'],
