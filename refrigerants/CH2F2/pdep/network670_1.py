...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[O]C[C]=O(1381)'],
    products = ['O=[C]CO[C](F)F(1666)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(184)', '[CH2]O[C](F)F(1051)'],
    products = ['O=[C]CO[C](F)F(1666)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[C](F)F(1051)'],
    products = ['O=[C]CO[C](F)F(1666)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[C](F)F(1699)'],
    products = ['O=[C]CO[C](F)F(1666)'],
    transitionState = 'TS9',
