...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.488842,'amu*angstrom^2'), symmetry=1, barrier=(11.2394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.488004,'amu*angstrom^2'), symmetry=1, barrier=(11.2202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.970267,'amu*angstrom^2'), symmetry=1, barrier=(22.3083,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['FOF(303)', 'OC[C]F-2(1403)'],
    products = ['OCC(F)(F)OF(1595)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(173)', 'C=C(F)OF(1721)'],
    products = ['OCC(F)(F)OF(1595)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)(F)CO(1723)'],
    products = ['OCC(F)(F)OF(1595)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(203)', 'OC[C](F)F(1130)'],
    products = ['OCC(F)(F)OF(1595)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(5)', '[CH2]C(F)(F)OF(1343)'],
    products = ['OCC(F)(F)OF(1595)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', '[O]CC(F)(F)OF(1724)'],
    products = ['OCC(F)(F)OF(1595)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(233)', 'CH2OH(33)'],
    products = ['OCC(F)(F)OF(1595)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'O[CH]C(F)(F)OF(854)'],
    products = ['OCC(F)(F)OF(1595)'],
