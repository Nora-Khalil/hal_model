...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]CC(F)(F)[C](F)F(4257)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', 'O=[C]C[C](F)F(1039)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4257)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(184)', '[CH2]C(F)(F)[C](F)F(1063)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4257)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O=[C]CC(F)(F)[C](F)F(4257)'],
    products = ['O=C=CC(F)(F)C(F)F(4324)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[CH2]C(F)(F)[C](F)F(1063)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4257)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]CC(F)=C(F)F(1820)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4257)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C=CC(F)(F)[C](F)F(4325)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4257)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=[C]C=C(F)[C](F)F(4326)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4257)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(42)', 'O=[C]C[C](F)F(1039)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4257)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C=CC(F)(F)[C](F)F(4327)'],
    products = ['O=[C]CC(F)(F)[C](F)F(4257)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]CC(F)(F)[C](F)F(4257)'],
    products = ['O=[C][CH]C(F)(F)C(F)F(4328)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]CC(F)(F)[C](F)F(4257)'],
    products = ['O=[C]C[C](F)C(F)(F)F(4329)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]CC(F)(F)[C](F)F(4257)'],
    products = ['O=C(F)C[C](F)[C](F)F(4330)'],
