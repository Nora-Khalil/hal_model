...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C=O(3911)'],
    products = ['[CH]=CC([O])=O(3831)'],
    transitionState = 'TS2',
