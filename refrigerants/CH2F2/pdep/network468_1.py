...
"""),
    E0 = (-56.2808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,1253.29,1253.29],'cm^-1')),
        HinderedRotor(inertia=(0.0018997,'amu*angstrom^2'), symmetry=1, barrier=(2.11746,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (52.0052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.97911,0.00115375,2.94544e-05,-5.18438e-08,2.73491e-11,-6768.77,7.43519], Tmin=(10,'K'), Tmax=(613.689,'K')), NASAPolynomial(coeffs=[3.10837,0.0118162,-8.79685e-06,2.95141e-09,-3.67313e-13,-6755.81,10.4457], Tmin=(613.689,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-56.2808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(78.9875,'J/(mol*K)'), label="""OOF""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=O(148)', 'HF(38)'],
    products = ['OOF(131)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.40824e-07,'m^3/(mol*s)'), n=3.98107, Ea=(215.271,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-3.8966013497491856, var=40.52401585746036, Tref=1000.0, N=2, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'HO2(11)'],
    products = ['OOF(131)'],
    transitionState = 'TS2',
