...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FOOC(F)F(209)'],
    products = ['O=C(F)OOC(F)F(4291)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(F)OOF(984)', 'CHF(40)'],
    products = ['O=C(F)OOC(F)F(4291)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(F)OO[CH]F(1806)'],
    products = ['O=C(F)OOC(F)F(4291)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]OOC(F)F(899)'],
    products = ['O=C(F)OOC(F)F(4291)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)F(136)', '[O]C(F)F(170)'],
    products = ['O=C(F)OOC(F)F(4291)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OC(=O)F(148)', 'CHF2(81)'],
    products = ['O=C(F)OOC(F)F(4291)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', 'O=C(F)OO[C](F)F(326)'],
    products = ['O=C(F)OOC(F)F(4291)'],
