...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(4710)', '[O]C[C]=O(1617)'],
    products = ['C=[C]OC[C]=O(5340)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(187)', '[CH2]O[C]=C(4975)'],
    products = ['C=[C]OC[C]=O(5340)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[C]=C(4975)'],
    products = ['C=[C]OC[C]=O(5340)'],
    transitionState = 'TS6',
