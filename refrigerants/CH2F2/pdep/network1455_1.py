...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(129)', '[CH2]C([O])=O(1038)'],
    products = ['[CH2]C(=O)O[CH]F(3846)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[CH]F(487)'],
    products = ['[CH2]C(=O)O[CH]F(3846)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]C([O])=O(1038)'],
    products = ['[CH2]C(=O)O[CH]F(3846)'],
