...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C([O])=C=O(191)'],
    products = ['[CH2]C(=O)C([O])=O(1628)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([O])=C=O(1807)'],
    products = ['[CH2]C(=O)C([O])=O(1628)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C]=O(145)', '[CH2][C]=O(1600)'],
    products = ['[CH2]C(=O)C([O])=O(1628)'],
