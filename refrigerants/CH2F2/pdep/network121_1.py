...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'O=[C]OC(F)(F)F(374)'],
    products = ['O=C(O)OC(F)(F)F(330)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(=O)OC(F)(F)F(375)'],
    products = ['O=C(O)OC(F)(F)F(330)'],
    transitionState = 'TS8',
