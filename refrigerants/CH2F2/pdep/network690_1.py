...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[C]=O(1684)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(184)', '[CH2]C([CH2])(F)F(1147)'],
    products = ['[CH2]C(F)(F)C[C]=O(1684)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C([CH2])(F)F(1147)'],
    products = ['[CH2]C(F)(F)C[C]=O(1684)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)C[C]=O(1891)'],
    products = ['[CH2]C(F)(F)C[C]=O(1684)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C=O(1892)'],
    products = ['[CH2]C(F)(F)C[C]=O(1684)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C[C]=O(1893)'],
    products = ['[CH2]C(F)(F)C[C]=O(1684)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C=C[O](1894)'],
    products = ['[CH2]C(F)(F)C[C]=O(1684)'],
...
network(
    label = 'PDepNetwork #690',
    isomers = [
        '[CH2]C(F)(F)C[C]=O(1684)',
    ],
    reactants = [
        ('CH2CF2(56)', 'CH2CO(28)'),
    ],
