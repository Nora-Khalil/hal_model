...
"""),
    E0 = (-754.932,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,225.942,225.942],'cm^-1')),
        HinderedRotor(inertia=(0.190222,'amu*angstrom^2'), symmetry=1, barrier=(6.89097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190224,'amu*angstrom^2'), symmetry=1, barrier=(6.89097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.618636,'amu*angstrom^2'), symmetry=1, barrier=(22.4105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OCOF(1677)'],
    products = ['OC(F)(F)COF(1593)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)OF(294)', 'CH2(S)(25)'],
    products = ['OC(F)(F)COF(1593)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(303)', 'C=C(O)F(1726)'],
    products = ['OC(F)(F)COF(1593)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]CC(O)(F)F(1728)'],
    products = ['OC(F)(F)COF(1593)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[O]C(F)(F)COF(1730)'],
    products = ['OC(F)(F)COF(1593)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(203)', '[CH2]C(O)(F)F(1131)'],
    products = ['OC(F)(F)COF(1593)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(232)', '[CH2]OF(1534)'],
    products = ['OC(F)(F)COF(1593)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'OC(F)(F)[CH]OF(870)'],
    products = ['OC(F)(F)COF(1593)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)COF(1731)'],
    products = ['OC(F)(F)COF(1593)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CC(O)(F)F(875)'],
    products = ['OC(F)(F)COF(1593)'],
