...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC1(F)[CH]O1(2782)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C1(F)[CH]O1(2760)'],
    products = ['[CH2]OC1(F)[CH]O1(2782)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC1=CO1(3004)'],
    products = ['[CH2]OC1(F)[CH]O1(2782)'],
    transitionState = 'TS6',
