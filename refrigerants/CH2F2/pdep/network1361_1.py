...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(C=O)O[C]=O(3254)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]C(F)O[C]=O(714)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(184)', '[O]C([O])(F)C=O(3305)'],
    products = ['[O]C(F)(C=O)O[C]=O(3254)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(C=O)O[C]=O(3254)'],
    products = ['O=[C]OC1(F)[CH]OO1(3343)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['CO(13)', '[O]C([O])(F)C=O(3305)'],
    products = ['[O]C(F)(C=O)O[C]=O(3254)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=[C]OC(=O)C=O(3347)'],
    products = ['[O]C(F)(C=O)O[C]=O(3254)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HCO(15)', 'O=[C]OC(=O)F(240)'],
    products = ['[O]C(F)(C=O)O[C]=O(3254)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=[C]OC(=O)[C]=O(3348)'],
    products = ['[O]C(F)(C=O)O[C]=O(3254)'],
...
network(
    label = 'PDepNetwork #1361',
    isomers = [
        '[O]C(F)(C=O)O[C]=O(3254)',
    ],
    reactants = [
        ('CO2(14)', 'O=CC(=O)F(711)'),
    ],
