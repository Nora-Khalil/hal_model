...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(150)', '[CH]F(129)'],
    products = ['[O]C(F)(F)O[CH]F(721)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[CH]F(749)'],
    products = ['[O]C(F)(F)O[CH]F(721)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(150)', 'CHF(40)'],
    products = ['[O]C(F)(F)O[CH]F(721)'],
    transitionState = 'TS9',
