...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(184)', '[O]C1O[C]1F(2759)'],
    products = ['O=[C]OC1O[C]1F(2777)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C1O[C]1F(2759)'],
    products = ['O=[C]OC1O[C]1F(2777)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC1=C(F)O1(2856)'],
    products = ['O=[C]OC1O[C]1F(2777)'],
    transitionState = 'TS9',
