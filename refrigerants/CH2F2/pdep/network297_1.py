...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.642454,0.073516,-9.6215e-05,6.03655e-08,-1.46104e-11,-45908.3,32.7897], Tmin=(100,'K'), Tmax=(1020.03,'K')), NASAPolynomial(coeffs=[16.3764,0.0118154,-5.48026e-06,1.06262e-09,-7.55931e-14,-49118.1,-43.4291], Tmin=(1020.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]OOOC(F)(F)[CH]F(4723)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (146.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.30176,0.0761452,-9.60411e-05,5.637e-08,-1.25695e-11,-46745.4,32.7898], Tmin=(100,'K'), Tmax=(1114.72,'K')), NASAPolynomial(coeffs=[19.6573,0.00669045,-2.58008e-06,4.74484e-10,-3.36598e-14,-51060.5,-62.6913], Tmin=(1114.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20117,0.0645235,-9.01597e-05,6.25768e-08,-1.70219e-11,-42820,31.195], Tmin=(100,'K'), Tmax=(903.272,'K')), NASAPolynomial(coeffs=[12.4637,0.0146487,-7.33549e-06,1.44724e-09,-1.02889e-13,-44854.6,-21.9943], Tmin=(903.272,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-356.843,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsH) + group(CdCFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + radical(ROOJ)"""),
)

species(
    label = 'OOOOC(F)(F)[C](F)F(4727)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]OC(F)(F)C(F)F(390)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', '[O]OOOC(F)F(196)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OOOF(197)', 'F[C]C(F)F(206)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOOC(F)(F)F(2286)', 'CHF(40)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OOOC(F)(F)C(F)F(834)'],
    products = ['[O]OOOC(F)C(F)(F)F(2508)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]OOC(F)(F)C(F)F(4721)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OOOC(F)(F)C(F)F(834)'],
    products = ['[O-][O+]=O(199)', '[O]C(F)(F)C(F)F(236)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]OOO[C](F)C(F)F(4722)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OOOC(F)(F)[CH]F(4723)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[O](126)', '[O]C(F)(F)C(F)F(236)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]OO[O](201)', 'CHF2-CF2(68)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OOO[C](F)F(202)', 'CHF2(81)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]OOOC(F)(F)[C](F)F(4724)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(77)', '[O]OOOC(F)=CF(4725)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]OOOC(F)=C(F)F(4726)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OOOOC(F)(F)[C](F)F(4727)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FOOOO[C](F)C(F)F(4728)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)OOOOF(4729)'],
    products = ['[O]OOOC(F)(F)C(F)F(834)'],
...
network(
    ...
    isomers = [
        '[O]OOOC(F)(F)C(F)F(834)',
    ],
    reactants = [
        ('O2(2)', '[O]OC(F)(F)C(F)F(390)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
