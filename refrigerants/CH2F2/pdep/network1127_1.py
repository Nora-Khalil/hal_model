...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', 'O=C[C]F(816)'],
    products = ['F[C]=CO[C](F)F(2548)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'FC#CO[C](F)F(2558)'],
    products = ['F[C]=CO[C](F)F(2548)'],
    transitionState = 'TS6',
