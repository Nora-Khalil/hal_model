...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C1O[C]1F(2736)'],
    products = ['[CH2]OC1O[C]1F(3012)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH2]OC1=C(F)O1(3019)'],
    products = ['[CH2]OC1O[C]1F(3012)'],
    transitionState = 'TS8',
