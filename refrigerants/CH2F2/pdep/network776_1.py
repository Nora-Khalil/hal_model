...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[CH2]C[O](1329)'],
    products = ['[CH2]CO[C](F)F(1991)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C](F)F(1051)'],
    products = ['[CH2]CO[C](F)F(1991)'],
    transitionState = 'TS3',
