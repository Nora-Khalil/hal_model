...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
    products = ['CF2O(48)', 'FC1=CO1(1027)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
    products = ['[O]C1(F)O[CH]C1(F)F(2794)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
    products = ['[O]C(F)(F)C1O[C]1F(2739)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(7)', 'F[C](F)C1(F)[CH]O1(2795)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C=C(F)C([O])(F)F(2796)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)(F)C1=CO1(2797)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(249)', 'FC1=CO1(1027)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C1(F)[CH]O1(2798)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2O(48)', 'F[C]1[CH]O1(2769)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(249)', 'F[C]1[CH]O1(2769)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', 'O=C(F)[C]1[CH]O1(2799)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FOC(F)(F)[C]1[CH]O1(2800)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)C1(F)[CH]O1(2801)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(2738)'],
...
network(
    ...
    isomers = [
        '[O]C(F)(F)C1(F)[CH]O1(2738)',
    ],
    reactants = [
        ('CF2O(48)', 'FC1=CO1(1027)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
