...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11219,0.0711218,-0.000114744,1.04534e-07,-3.77285e-11,-58956.3,28.5068], Tmin=(100,'K'), Tmax=(807.651,'K')), NASAPolynomial(coeffs=[6.67413,0.0306991,-1.57545e-05,3.08447e-09,-2.15559e-13,-59434.8,5.46169], Tmin=(807.651,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-490.994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(COCsFO) + radical(CCJCC=O) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['C=C([O])C(F)[C](F)F(1671)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(130)', 'O=[C]C[CH]F(1815)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(184)', '[CH2]C(F)[C](F)F(1069)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C(F)[C](F)F(1069)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]CC=C(F)F(1819)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHFCF2(54)', '[CH2][C]=O(1600)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]CC(F)=C(F)F(1820)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH][C](F)F(383)', 'CH2CO(28)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C=CC(F)[C](F)F(1821)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH][C](F)F(383)', '[CH2][C]=O(1600)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=[C]C=C[C](F)F(1822)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(42)', 'O=[C]C[CH]F(1815)'],
    products = ['O=[C]CC(F)[C](F)F(1675)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]CC(F)[C](F)F(1675)'],
    products = ['O=[C][CH]C(F)C(F)F(1825)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=[C]CC(F)[C](F)F(1675)'],
    products = ['O=[C]C[CH]C(F)(F)F(1827)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=[C]CC(F)[C](F)F(1675)'],
    products = ['O=C(F)C[CH][C](F)F(1828)'],
