...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=C(O)OF(359)'],
    products = ['O=COC(=O)OF(399)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]OF(146)', '[O]C=O(141)'],
    products = ['O=COC(=O)OF(399)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(125)', 'O=[C]OC=O(406)'],
    products = ['O=COC(=O)OF(399)'],
    transitionState = 'TS9',
