...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])=O(1038)'],
    products = ['[O]CC([O])=O(1335)'],
    transitionState = 'TS2',
