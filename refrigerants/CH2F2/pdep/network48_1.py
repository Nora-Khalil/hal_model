...
"""),
    ...
    molecularWeight = (115.013,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50503,0.0487392,-5.10862e-05,2.27395e-08,-3.15741e-12,631.326,27.1587], Tmin=(100,'K'), Tmax=(1027.25,'K')), NASAPolynomial(coeffs=[15.2653,0.00516476,-2.07001e-06,4.11391e-10,-3.11925e-14,-2723.7,-42.1665], Tmin=(1027.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.45752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2sFO) + group(CsFHHO) + radical(CsF1sHO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]OC(F)F(133)'],
    products = ['[O]OOOC(F)F(196)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OOOC(F)F(196)'],
    products = ['[O-][O+]=O(199)', '[O]C(F)F(164)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]O[O](126)', '[O]C(F)F(164)'],
    products = ['[O]OOOC(F)F(196)'],
    transitionState = 'TS7',
