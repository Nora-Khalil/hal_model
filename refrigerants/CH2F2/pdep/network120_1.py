...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'O=C(O)OF(359)'],
    products = ['O=C(OF)OC(F)F(329)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)OF(360)', 'CHF(40)'],
    products = ['O=C(OF)OC(F)F(329)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(OF)O[CH]F(363)'],
    products = ['O=C(OF)OC(F)F(329)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)OC(F)F(364)'],
    products = ['O=C(OF)OC(F)F(329)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(365)', 'CHF2(81)'],
    products = ['O=C(OF)OC(F)F(329)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]OF(146)', '[O]C(F)F(164)'],
    products = ['O=C(OF)OC(F)F(329)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(125)', 'O=[C]OC(F)F(174)'],
    products = ['O=C(OF)OC(F)F(329)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(OF)O[C](F)F(366)'],
    products = ['O=C(OF)OC(F)F(329)'],
