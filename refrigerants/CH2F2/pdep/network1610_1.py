...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC=[C]F(4521)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(3123)', '[CH]C(=O)F-2(3116)'],
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]OC=[C]F(4521)'],
    products = ['F[C]1[CH]OC=C(F)O1(4545)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)[CH]OC#CF(4547)'],
    products = ['O=C(F)[CH]OC=[C]F(4521)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C=COC=[C]F(4548)'],
    products = ['O=C(F)[CH]OC=[C]F(4521)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(6)', 'F[C]=COC=[C]F(4552)'],
    products = ['O=C(F)[CH]OC=[C]F(4521)'],
