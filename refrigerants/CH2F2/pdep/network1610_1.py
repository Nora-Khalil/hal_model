...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(4710)', 'C=[C]O[O](4694)'],
    products = ['C=[C]OO[C]=C(5339)'],
    transitionState = 'TS2',
