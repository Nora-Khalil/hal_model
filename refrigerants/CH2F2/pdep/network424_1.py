...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C](F)F(1002)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[CH2]C([O])(F)F(975)'],
    products = ['[CH2]C(F)(F)O[C](F)F(1002)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[C](F)O[C](F)F(269)'],
    products = ['[CH2]C(F)(F)O[C](F)F(1002)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)O[C](F)F(1054)'],
    products = ['[CH2]C(F)(F)O[C](F)F(1002)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(42)', '[CH2]C([O])(F)F(975)'],
    products = ['[CH2]C(F)(F)O[C](F)F(1002)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(F)(F)O[C](F)F(1002)'],
    products = ['[CH2][C](F)OC(F)(F)F(1056)'],
