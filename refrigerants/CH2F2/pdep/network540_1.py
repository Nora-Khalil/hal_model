...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH2]C(F)(F)O[O](652)'],
    products = ['[CH2]C(F)(F)OO[O](1459)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OO[C](F)F(234)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)OO[O](1459)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)OO[O](1466)'],
    products = ['[CH2]C(F)(F)OO[O](1459)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', '[CH2]C([O])(F)F(1145)'],
    products = ['[CH2]C(F)(F)OO[O](1459)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[O](152)', '[CH2][C](F)F(1096)'],
    products = ['[CH2]C(F)(F)OO[O](1459)'],
    transitionState = 'TS9',
