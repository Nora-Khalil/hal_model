...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=[C]O(161)'],
    products = ['[O]C(=O)O(226)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=O)O(226)'],
    products = ['O[C]1OO1(2317)'],
    transitionState = 'TS2',
