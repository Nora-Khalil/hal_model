...
reaction(
    label = 'reaction1',
    reactants = ['O=CC(F)OC(F)(F)OF(3969)'],
...
reaction(
    ...
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C[C](F)OC(F)(F)OF(4001)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OC=C(F)OC(F)(F)OF(4002)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C=COC(F)(F)OF(4003)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CC(F)O[C](F)OF(4004)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)(F)OC(F)C=O(4005)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)(F)OF(301)', 'O=C[CH]F(2151)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(221)', '[O]C(F)C=O(810)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(125)', 'O=CC(F)O[C](F)F(4006)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(15)', 'F[CH]OC(F)(F)OF(299)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O=C[C](F)OC(F)(F)OF(4007)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=[C]C(F)OC(F)(F)OF(4008)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(77)', 'O=CC(F)OC(=O)F(4009)'],
    products = ['O=CC(F)OC(F)(F)OF(3969)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=CC(F)OC(F)(F)OF(3969)'],
    products = ['F2(77)', 'CF2O(48)', 'O=CC=O(1331)'],
...
network(
    label = 'PDepNetwork #1486',
    isomers = [
        'O=CC(F)OC(F)(F)OF(3969)',
    ],
    reactants = [
