...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C=C([O])OF(2586)'],
    products = ['[CH]=C(F)C([O])=O(2540)'],
    transitionState = 'TS2',
