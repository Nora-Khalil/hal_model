...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(150)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])(F)F(1354)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(=O)F(1387)'],
    products = ['[CH2]OC([O])(F)F(1354)'],
    transitionState = 'TS6',
