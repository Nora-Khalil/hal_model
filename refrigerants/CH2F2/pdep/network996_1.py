...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', '[CH]=C[O](930)'],
    products = ['[CH]=CO[C](F)F(2306)'],
    transitionState = 'TS2',
