...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)O[O](582)'],
    products = ['O=O(148)', 'CH2CF2(56)'],
    transitionState = 'TS2',
