...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)O[CH]C(=O)F(4517)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F-2(3116)', '[CH]C(=O)F-2(3116)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(F)O[CH]C(=O)F(4517)'],
    products = ['[CH]=C(F)OC1O[C]1F(4602)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=C(F)O[CH]C(=O)F(4517)'],
    products = ['[O]C1(F)[CH]OC(F)=C1(4562)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CO[CH]C(=O)F(4603)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(4517)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=C(F)OC=C=O(4604)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(4517)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C(F)[CH]O[C]=CF(4549)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(4517)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(F)O[CH]C(=O)F(4517)'],
    products = ['[O][C](F)C1C=C(F)O1(4607)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', '[CH]=C(F)O[C]=C=O(4597)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(4517)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(F)O[C]=C(O)F(4608)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(4517)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C(F)O[C]C(=O)F(4609)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(4517)'],
...
network(
    label = 'PDepNetwork #1606',
    isomers = [
        '[CH]=C(F)O[CH]C(=O)F(4517)',
    ],
    reactants = [
