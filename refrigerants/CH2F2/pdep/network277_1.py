...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[CH]F(725)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(129)', '[O]C(F)(F)[CH]F(453)'],
    products = ['F[CH]OC(F)(F)[CH]F(725)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(129)', 'F[CH]O[C](F)F(496)'],
    products = ['F[CH]OC(F)(F)[CH]F(725)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=CF(783)'],
    products = ['F[CH]OC(F)(F)[CH]F(725)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'F[CH]O[C](F)F(496)'],
    products = ['F[CH]OC(F)(F)[CH]F(725)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[O]C(F)(F)[CH]F(453)'],
    products = ['F[CH]OC(F)(F)[CH]F(725)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]O[C](F)C(F)F(764)'],
    products = ['F[CH]OC(F)(F)[CH]F(725)'],
