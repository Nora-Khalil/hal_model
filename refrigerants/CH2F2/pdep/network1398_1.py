...
reaction(
    label = 'reaction3',
    reactants = ['FOF(303)', 'O=C=C(O)O(4521)'],
    products = ['O=C(OF)C(O)(O)F(4502)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C(OF)[C](O)O(4526)'],
    products = ['O=C(OF)C(O)(O)F(4502)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(O)(O)F(4527)'],
    products = ['O=C(OF)C(O)(O)F(4502)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(5)', 'O=C(OF)[C](O)F(377)'],
    products = ['O=C(OF)C(O)(O)F(4502)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[O]C(O)(F)C(=O)OF(4528)'],
    products = ['O=C(OF)C(O)(O)F(4502)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(203)', 'O=[C]C(O)(O)F(4529)'],
    products = ['O=C(OF)C(O)(O)F(4502)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]OF(142)', 'O[C](O)F(4284)'],
    products = ['O=C(OF)C(O)(O)F(4502)'],
