...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C(=O)[C](F)F(1754)'],
    products = ['C=C([O])C([O])(F)F(1661)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C([O])(F)F(1755)'],
    products = ['C=C([O])C([O])(F)F(1661)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C([O])(F)F(1661)'],
    products = ['[CH2]C1([O])OC1(F)F(1750)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(=O)C(=O)F(1758)'],
    products = ['C=C([O])C([O])(F)F(1661)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[O]C(F)(F)[C]=O(248)'],
    products = ['C=C([O])C([O])(F)F(1661)'],
