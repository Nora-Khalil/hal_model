...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)OF(151)', '[O]C=O(141)'],
    products = ['[O]C(F)(OF)OC=O(4952)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(125)', 'O=COC(=O)F(335)'],
    products = ['[O]C(F)(OF)OC=O(4952)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C([O])(F)OC=O(2353)'],
    products = ['[O]C(F)(OF)OC=O(4952)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)OF(149)', '[O]C=O(141)'],
    products = ['[O]C(F)(OF)OC=O(4952)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([O])(F)OF(4992)', 'HCO(15)'],
    products = ['[O]C(F)(OF)OC=O(4952)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(125)', '[O][CH]OC(=O)F(732)'],
    products = ['[O]C(F)(OF)OC=O(4952)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(OF)O[C]=O(4993)'],
    products = ['[O]C(F)(OF)OC=O(4952)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(77)', '[O]C(=O)OC=O(405)'],
    products = ['[O]C(F)(OF)OC=O(4952)'],
