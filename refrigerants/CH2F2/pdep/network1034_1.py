...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(142)', 'O=[C]O(161)'],
    products = ['O=C(O)OC(=O)F(400)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(=O)F(255)'],
    products = ['O=C(O)OC(=O)F(400)'],
