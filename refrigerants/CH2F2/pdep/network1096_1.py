...
species(
    label = 'F[CH]C1(F)O[CH]C1(F)F(2859)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3205.24,'J/mol'), sigma=(5.54479,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=500.65 K, Pc=42.66 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-182.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,2950,1000,334,575,1197,1424,3202,240.044,240.044,240.044,982.786,1722.42,1722.42,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00292563,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.618145,'amu*angstrom^2'), symmetry=1, barrier=(25.2755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47464,0.0593185,-7.18905e-05,4.55979e-08,-1.17154e-11,-21913.8,24.4686], Tmin=(100,'K'), Tmax=(940.004,'K')), NASAPolynomial(coeffs=[10.5018,0.0209048,-1.05918e-05,2.1235e-09,-1.52963e-13,-23610.9,-18.5237], Tmin=(940.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cd(C-FF)-Cd-O2s) + radical(Csj(Cs-F1sF1sCd)(F1s)(H))"""),
)
...
species(
    label = 'FC(F)C(F)(F)[C]1[CH]O1(2864)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.722982,0.0783,-0.000115957,9.32285e-08,-3.03269e-11,-70044.3,26.9798], Tmin=(100,'K'), Tmax=(750.224,'K')), NASAPolynomial(coeffs=[10.2646,0.027424,-1.42299e-05,2.82722e-09,-2.00612e-13,-71475.9,-16.3104], Tmin=(750.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-583.314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + ring(Cs(C-FF)-Cs-O2s) + radical(C2CsJO) + radical(CCsJO)"""),
)

species(
    label = 'F[CH][C](F)C1(F)OC1F(2865)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
    products = ['F[CH]C1(F)O[CH]C1(F)F(2859)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
    products = ['F[CH]C(F)(F)C1O[C]1F(2748)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(128)', 'F[C](F)C1(F)[CH]O1(2795)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
    products = ['FC1C2OC2(F)C1(F)F(2821)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C[C](F)C(F)(F)[CH]F(2860)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C(F)(F)C1=CO1(2861)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=C(F)C1(F)[CH]O1(2862)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(77)', 'F[CH]C(F)=C1[CH]O1(2863)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', 'F[C](F)C1(F)[CH]O1(2795)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
    products = ['F[CH]C(F)(F)[C]1OC1F(2856)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
    products = ['FC(F)C(F)(F)[C]1[CH]O1(2864)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(2747)'],
    products = ['F[CH][C](F)C1(F)OC1F(2865)'],
