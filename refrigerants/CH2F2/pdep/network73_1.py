...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(184)', '[O]C([O])(F)F(150)'],
    products = ['[O]C(F)(F)O[C]=O(232)'],
    transitionState = 'TS2',
