...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)F(275)'],
    products = ['[O]C(F)(F)C([O])(F)F(265)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F2(77)', '[O][C](F)C(=O)F(276)'],
    products = ['[O]C(F)(F)C([O])(F)F(265)'],
    transitionState = 'TS7',
