...
reaction(
    label = 'reaction3',
    reactants = ['O(7)', '[CH2]C1(F)[CH]O1(2904)'],
    products = ['[O]CC1(F)[CH]O1(3009)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'O=CC1(F)[CH]O1(2915)'],
    products = ['[O]CC1(F)[CH]O1(3009)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]C=C1[CH]O1(2916)'],
    products = ['[O]CC1(F)[CH]O1(3009)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[CH]C1(F)[CH]O1(3052)'],
    products = ['[O]CC1(F)[CH]O1(3009)'],
