...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)C=C[C]F(3067)'],
    products = ['F[C]=CC1O[C]1F(2818)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]=CC1=C(F)O1(3068)'],
    products = ['F[C]=CC1O[C]1F(2818)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC#CC1O[C]1F(3069)'],
    products = ['F[C]=CC1O[C]1F(2818)'],
    transitionState = 'TS9',
