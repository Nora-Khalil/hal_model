...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3951.25,'J/mol'), sigma=(6.4425,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=617.18 K, Pc=33.53 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=[C]OC(O)(F)F(370)'],
    products = ['O=C(F)OC(O)(F)F(326)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)F(142)', 'O[C](F)F(220)'],
    products = ['O=C(F)OC(O)(F)F(326)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CFO(50)', '[O]C(O)(F)F(178)'],
    products = ['O=C(F)OC(O)(F)F(326)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)OC(=O)F(371)'],
    products = ['O=C(F)OC(O)(F)F(326)'],
...
network(
    label = 'PDepNetwork #1045',
    isomers = [
        'O=C(F)OC(O)(F)F(326)',
    ],
    reactants = [
        ('CF2O(48)', 'O=C(O)F(140)'),
        ('[O]C(=O)F(142)', 'O[C](F)F(220)'),
        ('CFO(50)', '[O]C(O)(F)F(178)'),
