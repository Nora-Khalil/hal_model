...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[O][CH]F(134)'],
    products = ['[O]C(F)[C](F)F(452)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)[C](F)F(452)'],
    products = ['FC1OC1(F)F(259)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC1(F)[CH]O1(1228)'],
    products = ['FC1OC1(F)F(259)'],
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C]1OC1(F)F(1230)'],
    products = ['FC1OC1(F)F(259)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1=C(F)O1(1232)'],
    products = ['FC1OC1(F)F(259)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C](F)F(237)', '[CH]F(129)'],
    products = ['[O]C(F)(F)[CH]F(453)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=C(F)[CH]F(1260)'],
    products = ['[O]C(F)(F)[CH]F(453)'],
