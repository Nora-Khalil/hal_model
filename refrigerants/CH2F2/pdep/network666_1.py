...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[C](F)F(1662)'],
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[C](F)F(1662)'],
    products = ['[CH2][C]1OC(F)(F)O1(1749)'],
    transitionState = 'TS6',
