...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', 'O=C=C[C]F(2509)'],
    products = ['[O]C(=O)C=[C]F(2471)'],
    transitionState = 'TS2',
