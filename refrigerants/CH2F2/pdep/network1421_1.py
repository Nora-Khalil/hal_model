species(
    label = '[CH2]C(F)(F)O[CH]C(=O)F(3688)',
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34602,0.0459711,-8.08164e-06,-2.35817e-08,1.19595e-11,-114076,27.0193], Tmin=(100,'K'), Tmax=(1040.67,'K')), NASAPolynomial(coeffs=[15.3667,0.0191752,-8.51287e-06,1.71331e-09,-1.27351e-13,-118461,-48.2305], Tmin=(1040.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-949.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(COCsFO) + ring(Cs-Cs(F)(F)-O2s-Cs)"""),
)

species(
    label = '[CH2]C(F)(F)OC1O[C]1F(3778)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C]1[CH]OC(F)(F)CO1(3702)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-497.367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,326,540,652,719,1357,611,648,830,1210,1753,2950,3100,1380,975,1025,1650,271.943,272.145,272.299,274.677],'cm^-1')),
        HinderedRotor(inertia=(0.356962,'amu*angstrom^2'), symmetry=1, barrier=(18.6546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.35521,'amu*angstrom^2'), symmetry=1, barrier=(18.677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.365064,'amu*angstrom^2'), symmetry=1, barrier=(18.698,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.448828,0.0744385,-8.73475e-05,4.878e-08,-1.0506e-11,-59688.4,25.4496], Tmin=(100,'K'), Tmax=(1143.24,'K')), NASAPolynomial(coeffs=[18.2592,0.0121225,-5.58448e-06,1.10046e-09,-7.95276e-14,-63760.6,-62.8592], Tmin=(1143.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-497.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(CdCFO) + group(COCsFO) + group(Cds-CdsHH) + radical(CCsJOC(O))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.03954,'amu*angstrom^2'), symmetry=1, barrier=(23.9011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0396,'amu*angstrom^2'), symmetry=1, barrier=(23.9024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03933,'amu*angstrom^2'), symmetry=1, barrier=(23.8963,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0661162,0.0782139,-9.16824e-05,4.98439e-08,-1.02068e-11,-54827,25.7639], Tmin=(100,'K'), Tmax=(1270.85,'K')), NASAPolynomial(coeffs=[22.214,0.00468121,-8.70755e-07,9.68131e-11,-5.78279e-15,-60214.9,-85.9832], Tmin=(1270.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)

species(
    label = '[CH2][C](F)OC(F)C(=O)F(3781)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-641.088,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,395,473,707,1436,486,617,768,1157,1926,3000,3100,440,815,1455,1000,211.554,227.573,228.448,1692.82],'cm^-1')),
        HinderedRotor(inertia=(0.227551,'amu*angstrom^2'), symmetry=1, barrier=(8.68965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263899,'amu*angstrom^2'), symmetry=1, barrier=(8.83985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.879846,'amu*angstrom^2'), symmetry=1, barrier=(34.1951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.884515,'amu*angstrom^2'), symmetry=1, barrier=(34.1939,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.133991,0.0936218,-0.000154005,1.35542e-07,-4.73457e-11,-76974.2,31.0992], Tmin=(100,'K'), Tmax=(786.177,'K')), NASAPolynomial(coeffs=[10.3656,0.0316883,-1.69954e-05,3.38104e-09,-2.38361e-13,-78277.7,-13.86], Tmin=(786.177,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-641.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(COCsFO) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'O=C(F)[CH]O[C](F)CF(3782)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[CH2]C(F)(F)C([O])(F)C=O(3687)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.915735,'amu*angstrom^2'), symmetry=1, barrier=(21.0545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.916318,'amu*angstrom^2'), symmetry=1, barrier=(21.068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915947,'amu*angstrom^2'), symmetry=1, barrier=(21.0594,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.409343,0.0788417,-9.92064e-05,6.03824e-08,-1.42682e-11,-40266.6,25.2225], Tmin=(100,'K'), Tmax=(1040.7,'K')), NASAPolynomial(coeffs=[17.0269,0.0149704,-7.14552e-06,1.40818e-09,-1.01083e-13,-43725.3,-55.6103], Tmin=(1040.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)

species(
    label = 'FC1=COC(F)(F)CO1(3710)',
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.158993,0.0688455,-6.59666e-05,3.11005e-08,-5.45094e-12,-106985,19.757], Tmin=(100,'K'), Tmax=(1657.38,'K')), NASAPolynomial(coeffs=[18.0786,0.0109687,-1.0406e-06,-6.15174e-11,1.06978e-14,-111126,-71.7], Tmin=(1657.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-890.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCFFO) + group(CdCFO) + group(Cds-CdsOsH) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(23dihydro14dioxin)"""),
)

species(
    label = '[O][C](F)C1CC(F)(F)O1(3785)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26991,0.0640491,-6.7674e-05,3.89788e-08,-9.34392e-12,-69611.1,26.469], Tmin=(100,'K'), Tmax=(990.741,'K')), NASAPolynomial(coeffs=[10.0853,0.028458,-1.37884e-05,2.71939e-09,-1.94352e-13,-71357.8,-15.9782], Tmin=(990.741,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-579.569,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCFHO) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)
...
species(
    label = '[CH2]C(F)(F)O[C]=C(O)F(3786)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-557.298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,293,496,537,1218,1685,370,180.027,180.066,180.285,773.498],'cm^-1')),
        HinderedRotor(inertia=(0.356235,'amu*angstrom^2'), symmetry=1, barrier=(13.5842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0531564,'amu*angstrom^2'), symmetry=1, barrier=(22.7866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.98693,'amu*angstrom^2'), symmetry=1, barrier=(22.8211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589526,'amu*angstrom^2'), symmetry=1, barrier=(13.5697,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0306953,0.0906288,-0.000119642,7.66241e-08,-1.90975e-11,-66883.9,29.9863], Tmin=(100,'K'), Tmax=(986.459,'K')), NASAPolynomial(coeffs=[17.9316,0.0177925,-8.88682e-06,1.77285e-09,-1.27614e-13,-70427.7,-56.4264], Tmin=(986.459,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(C=CJO)"""),
)

species(
    label = 'CC(F)(F)O[C]=C([O])F(3787)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-631.921,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,293,496,537,1218,1685,370,290.912,291.873,292.284,292.481,1650.77],'cm^-1')),
        HinderedRotor(inertia=(0.0778652,'amu*angstrom^2'), symmetry=1, barrier=(20.2051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.333485,'amu*angstrom^2'), symmetry=1, barrier=(20.2043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334288,'amu*angstrom^2'), symmetry=1, barrier=(20.2044,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.585202,0.079018,-9.34928e-05,5.58241e-08,-1.33567e-11,-75882.7,27.7472], Tmin=(100,'K'), Tmax=(1010.38,'K')), NASAPolynomial(coeffs=[14.3095,0.0246864,-1.28351e-05,2.6063e-09,-1.89289e-13,-78656.1,-38.6067], Tmin=(1010.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-631.921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = 'C=C(F)O[CH][C](F)OF(3788)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.550864,0.106801,-0.000169475,1.31986e-07,-4.00537e-11,-27897,29.7589], Tmin=(100,'K'), Tmax=(813.108,'K')), NASAPolynomial(coeffs=[16.8873,0.0210143,-1.12147e-05,2.22624e-09,-1.56984e-13,-30732.8,-50.7622], Tmin=(813.108,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFHO) + group(CdCFO) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C(F)(F)OC=[C]OF(3789)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F-2(3116)', '[CH2]C([O])(F)F(975)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=C(F)[CH]O[C](F)F(2827)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
    products = ['O=C(F)C1CC(F)(F)O1(3696)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
    products = ['[CH2]C(F)(F)OC1O[C]1F(3778)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
    products = ['F[C]1[CH]OC(F)(F)CO1(3702)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
    products = ['[O]C1(F)[CH]OC(F)(F)C1(3738)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)O[CH]C(=O)F(3779)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(F)(F)OC=C=O(3780)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C](F)OC(F)C(=O)F(3781)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C(F)[CH]O[C](F)CF(3782)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C([O])(F)C=O(3687)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(6)', '[CH2]C(F)(F)OC=[C]F(3784)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
    products = ['[O][C](F)C1CC(F)(F)O1(3785)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)(F)O[C]=C(O)F(3786)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC(F)(F)O[C]=C([O])F(3787)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=C(F)O[CH][C](F)OF(3788)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(F)(F)OC=[C]OF(3789)'],
    products = ['[CH2]C(F)(F)O[CH]C(=O)F(3688)'],
