...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', 'O=C(OF)O[CH]F(397)'],
    products = ['[O]C(F)OC(=O)OF(4559)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)OF(349)', 'CHFO(46)'],
    products = ['[O]C(F)OC(=O)OF(4559)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', 'O=C(F)OC(=O)OF(5551)'],
    products = ['[O]C(F)OC(=O)OF(4559)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O][CH]OC(=O)OF(5552)'],
    products = ['[O]C(F)OC(=O)OF(4559)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)OC([O])F(368)'],
    products = ['[O]C(F)OC(=O)OF(4559)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)OF(349)', '[O][CH]F(127)'],
    products = ['[O]C(F)OC(=O)OF(4559)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OF(142)', '[O]C([O])F(131)'],
    products = ['[O]C(F)OC(=O)OF(4559)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(203)', '[O]C(F)O[C]=O(693)'],
    products = ['[O]C(F)OC(=O)OF(4559)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[O][C](F)OC(=O)OF(5553)'],
    products = ['[O]C(F)OC(=O)OF(4559)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)OC(=O)OF(4559)'],
    products = ['F2(77)', 'CO2(14)', '[O]C=O(135)'],
