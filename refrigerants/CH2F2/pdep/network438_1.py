...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH2]C([O])F(1113)'],
    products = ['[O]C(F)C[C](F)F(1014)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C[C](F)F(1070)'],
    products = ['[O]C(F)C[C](F)F(1014)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)C=C(F)F(770)'],
    products = ['[O]C(F)C[C](F)F(1014)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CC[C](F)F(1116)'],
    products = ['[O]C(F)C[C](F)F(1014)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)C[C](F)F(1058)'],
    products = ['[O]C(F)C[C](F)F(1014)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C=C[C](F)F(773)'],
    products = ['[O]C(F)C[C](F)F(1014)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(42)', '[CH2]C([O])F(1113)'],
    products = ['[O]C(F)C[C](F)F(1014)'],
