...
reaction(
    label = 'reaction1',
    reactants = ['OH(5)', 'CH2CF2(56)'],
    products = ['OC[C](F)F(1130)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction10',
    reactants = ['OC[C](F)F(1130)'],
    products = ['O[CH]C(F)F(1404)'],
