...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)F(422)', 'CH2(S)(25)'],
    products = ['[O]OC(F)(F)CF(570)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)O[O](582)'],
    products = ['[O]OC(F)(F)CF(570)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(165)', 'CH2F(45)'],
    products = ['[O]OC(F)(F)CF(570)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(F)(F)[CH]F(425)'],
    products = ['[O]OC(F)(F)CF(570)'],
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C(F)(F)F(851)'],
    products = ['[O]OCC(F)(F)F(579)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]O[CH]C(F)(F)F(845)'],
    products = ['[O]OCC(F)(F)F(579)'],
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OCC(F)(F)F(579)'],
    products = ['OH(7)', 'CF3CHO(74)'],
...
network(
    ...
    reactants = [
        ('HO2(11)', 'CHFCF2(54)'),
        ('CHF(40)', '[O]OC(F)F(133)'),
        ('[O]OC(F)(F)F(422)', 'CH2(S)(25)'),
        ('O2(2)', 'CH2F-CF2(67)'),
        ('O2(2)', '[CH2]C(F)(F)F(851)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
