...
reaction(
    ...
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)C(OF)[C](F)F(2093)'],
    products = ['OC(F)(F)C(F)(F)[CH]OF(2168)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)(F)C([C]F)OF(2169)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(130)', 'OC(F)(F)[CH]OF(915)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(125)', 'OC(F)(F)C=C(F)F(863)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O[C](F)F(220)', 'FOC=C(F)F(912)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'OC(F)(F)C(OF)=C(F)F(2170)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[C](F)C(OF)[C](F)F(2171)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(125)', 'OC(F)(F)[CH][C](F)F(1060)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'FOC([C](F)F)[C](F)F(2173)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)(F)C(OF)[C](F)F(2174)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O[C](F)F(220)', 'FO[CH][C](F)F(964)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)(F)[C](OF)[C](F)F(2175)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=C(F)C(OF)[C](F)F(2176)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'OC(F)=C(OF)[C](F)F(2178)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', 'OC(F)(F)C([C]F)OF-2(2179)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CF2(42)', 'OC(F)(F)[CH]OF(915)'],
    products = ['OC(F)(F)C(OF)[C](F)F(2093)'],
...
reaction(
    label = 'reaction22',
    reactants = ['OC(F)(F)C(OF)[C](F)F(2093)'],
    products = ['OC(F)(F)[C](OF)C(F)F(2180)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)(F)C(OF)[C](F)F(2093)'],
    products = ['O[C](F)C(OF)C(F)(F)F(2181)'],
