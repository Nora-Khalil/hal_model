...
reaction(
    label = 'reaction1',
    reactants = ['[O]OOC([O])(F)F(835)'],
    products = ['O2(2)', 'FC1(F)OO1(702)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC([O])(F)F(223)'],
    products = ['[O]OOC([O])(F)F(835)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[O](126)', '[O][C](F)F(237)'],
    products = ['[O]OOC([O])(F)F(835)'],
    transitionState = 'TS9',
