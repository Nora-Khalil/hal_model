...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F-2(3116)', '[C]=C(1595)'],
    products = ['[CH]=C(F)O[C]=C(3185)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)OC#C(3215)'],
    products = ['[CH]=C(F)O[C]=C(3185)'],
    transitionState = 'TS7',
