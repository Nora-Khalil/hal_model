...
"""),
    E0 = (-487.562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,197,221,431,657,2782.5,750,1395,475,1775,1000,2120,512.5,787.5,662.681],'cm^-1')),
        HinderedRotor(inertia=(0.147059,'amu*angstrom^2'), symmetry=1, barrier=(45.8775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147215,'amu*angstrom^2'), symmetry=1, barrier=(45.8756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147158,'amu*angstrom^2'), symmetry=1, barrier=(45.8839,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31803,0.0689007,-0.000122095,1.20976e-07,-4.6563e-11,-44765.9,35.104], Tmin=(100,'K'), Tmax=(802.831,'K')), NASAPolynomial(coeffs=[4.25621,0.0339662,-1.89043e-05,3.79877e-09,-2.68734e-13,-44583.6,25.6476], Tmin=(802.831,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-372.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(Cds-OdOsH) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=C=C(F)OO(3477)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O=C1O[CH]OO[C]1F(3483)'],
    products = ['O=C=C(F)OOC=O(3259)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C=[C]OOC=O(3484)'],
    products = ['O=C=C(F)OOC=O(3259)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C=O(141)', 'O=[C]C(=O)F(2239)'],
    products = ['O=C=C(F)OOC=O(3259)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OC=O(704)', 'O=C=[C]F(443)'],
    products = ['O=C=C(F)OOC=O(3259)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HCO(15)', '[O]OC(F)=C=O(2073)'],
    products = ['O=C=C(F)OOC=O(3259)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C=C(F)OOC=O(3259)'],
    products = ['CO(13)', 'O=CO[O+]=[C-]F(3486)'],
