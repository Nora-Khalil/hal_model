...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C([O])=O(1038)'],
    products = ['[CH2]CC([O])=O(1982)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(145)', '[CH2][CH2](1598)'],
    products = ['[CH2]CC([O])=O(1982)'],
