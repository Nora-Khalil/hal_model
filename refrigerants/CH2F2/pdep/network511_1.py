...
"""),
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.14403,0.016134,3.97541e-06,-9.75365e-09,3.12581e-12,-1856.7,8.1606], Tmin=(100,'K'), Tmax=(1249.44,'K')), NASAPolynomial(coeffs=[4.88628,0.0182402,-7.778e-06,1.43975e-09,-9.87301e-14,-2891.83,-3.03285], Tmin=(1249.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.7111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxetane)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.223719,'amu*angstrom^2'), symmetry=1, barrier=(5.14373,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47471,0.0416319,-7.70009e-05,7.78822e-08,-2.90445e-11,-1203.08,16.4058], Tmin=(100,'K'), Tmax=(877.583,'K')), NASAPolynomial(coeffs=[2.29996,0.0226911,-1.0891e-05,2.03337e-09,-1.36527e-13,-412.381,21.5563], Tmin=(877.583,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.3955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC[O](1343)'],
    products = ['CH2O(20)', 'CH2O(20)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C[O](1329)'],
    products = ['[O]CC[O](1343)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](1324)', '[CH2][O](1324)'],
    products = ['[O]CC[O](1343)'],
    transitionState = 'TS7',
