...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(185)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])=O(1336)'],
    transitionState = 'TS2',
