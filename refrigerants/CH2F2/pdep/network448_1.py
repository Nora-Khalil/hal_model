...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FOCC(F)F(1155)'],
    products = ['O=C(CC(F)F)OF(1024)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'O=C(C[C]F)OF(1157)'],
    products = ['O=C(CC(F)F)OF(1024)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'O=C(CF)OF(649)'],
    products = ['O=C(CC(F)F)OF(1024)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(147)', 'O=C=CC(F)F(651)'],
    products = ['O=C(CC(F)F)OF(1024)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C([CH]C(F)F)OF(1159)'],
    products = ['O=C(CC(F)F)OF(1024)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(C[CH]F)OF(1163)'],
    products = ['O=C(CC(F)F)OF(1024)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(=O)CC(F)F(1164)'],
    products = ['O=C(CC(F)F)OF(1024)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(125)', 'O=[C]CC(F)F(1165)'],
    products = ['O=C(CC(F)F)OF(1024)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF2(81)', '[CH2]C(=O)OF(1166)'],
    products = ['O=C(CC(F)F)OF(1024)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(146)', 'CHF2-CH2(63)'],
    products = ['O=C(CC(F)F)OF(1024)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=C([CH]C(F)F)OF(659)'],
    products = ['O=C(CC(F)F)OF(1024)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(C[C](F)F)OF(1167)'],
    products = ['O=C(CC(F)F)OF(1024)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(C=CF)OF(666)'],
    products = ['O=C(CC(F)F)OF(1024)'],
