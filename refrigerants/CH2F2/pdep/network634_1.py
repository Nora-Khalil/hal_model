...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(162)', '[CH2]O[CH]F(1221)'],
    products = ['[CH2]OC(F)[C](F)F(1562)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C(F)F(1634)'],
    products = ['[CH2]OC(F)[C](F)F(1562)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', '[CH2]OC(F)=C(F)F(1635)'],
    products = ['[CH2]OC(F)[C](F)F(1562)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]O[CH]F(1221)'],
    products = ['[CH2]OC(F)[C](F)F(1562)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OC(F)[C](F)F(1562)'],
    products = ['[CH2]O[CH]C(F)(F)F(1638)'],
