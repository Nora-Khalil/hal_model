...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'F[C]C(F)(F)F(850)'],
    products = ['FCC(F)(F)F(436)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]C(F)(F)F(851)'],
    products = ['FCC(F)(F)F(436)'],
    transitionState = 'TS7',
