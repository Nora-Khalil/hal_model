...
species(
    label = 'F[C]1[CH]OC(F)(F)OO1(3142)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(144)', '[CH]C(=O)F-2(2868)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
    products = ['[O]C(F)(F)OC1O[C]1F(3205)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
    products = ['F[C]1[CH]OC(F)(F)OO1(3142)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)[CH]OC(=O)F(3206)'],
    products = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)(F)OC=C=O(3207)'],
    products = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C(F)[CH]O[C](F)OF(3208)'],
    products = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C](F)OC(F)C(=O)F(3209)'],
    products = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)(F)OC(F)[C]=O(3194)'],
    products = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(7)', '[O]C(F)(F)OC=[C]F(3211)'],
    products = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
    products = ['[O][C](F)C1OC(F)(F)O1(3212)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', '[O]C(F)(F)O[C]=C=O(3200)'],
    products = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(F)O[C]=C(O)F(3213)'],
    products = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
    products = ['[O]C(F)=[C]OC(O)(F)F(3214)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=C(F)O[CH][C](F)OF(3215)'],
    products = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(F)OC=[C]OF(3216)'],
    products = ['[O]C(F)(F)O[CH]C(=O)F(3131)'],
...
network(
    label = 'PDepNetwork #1160',
    isomers = [
        '[O]C(F)(F)O[CH]C(=O)F(3131)',
    ],
    reactants = [
