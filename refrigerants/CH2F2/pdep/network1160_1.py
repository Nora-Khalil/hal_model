...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC(F)(F)[C](F)F(2664)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(130)', 'F[C]C=C(F)F-2(2564)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2664)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]=CC(F)=C(F)F(2595)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2664)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC#CC(F)(F)[C](F)F(2686)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2664)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'F[C]=C=C(F)[C](F)F(2687)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2664)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(42)', 'F[C]C=C(F)F-2(2564)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2664)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FC=[C]C(F)(F)[C](F)F(2688)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2664)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]=[C]C(F)(F)C(F)F(2689)'],
    products = ['F[C]=CC(F)(F)[C](F)F(2664)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]=CC(F)(F)[C](F)F(2664)'],
    products = ['F[C]C=C(F)C(F)(F)F(2690)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]=CC(F)(F)[C](F)F(2664)'],
    products = ['F[C](F)C=C(F)[C](F)F(548)'],
