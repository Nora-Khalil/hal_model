...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'C#COO(2969)'],
    products = ['C#COOC(F)F(4702)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C#COO[CH]F(4770)'],
    products = ['C#COOC(F)F(4702)'],
    transitionState = 'TS4',
