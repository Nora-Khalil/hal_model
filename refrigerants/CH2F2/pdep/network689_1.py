...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(1595)', '[O]C[C](F)F(974)'],
    products = ['C=[C]OC[C](F)F(1683)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH2]O[C]=C(1898)'],
    products = ['C=[C]OC[C](F)F(1683)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=[C]OC=C(F)F(1839)'],
    products = ['C=[C]OC[C](F)F(1683)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#COC[C](F)F(1900)'],
    products = ['C=[C]OC[C](F)F(1683)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]O[C]=C(1898)'],
    products = ['C=[C]OC[C](F)F(1683)'],
