...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(184)', '[O]C[C](F)F(974)'],
    products = ['O=[C]OC[C](F)F(988)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(130)', '[CH2]O[C]=O(1032)'],
    products = ['O=[C]OC[C](F)F(988)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC=C(F)F(488)'],
    products = ['O=[C]OC[C](F)F(988)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(42)', '[CH2]O[C]=O(1032)'],
    products = ['O=[C]OC[C](F)F(988)'],
