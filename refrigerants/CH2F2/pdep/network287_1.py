...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(129)', '[O]C([O])F(137)'],
    products = ['[O]C(F)O[CH]F(799)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)O[CH]F(749)'],
    products = ['[O]C(F)O[CH]F(799)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][CH]F(134)', '[O][CH]F(134)'],
    products = ['[O]C(F)O[CH]F(799)'],
    transitionState = 'TS9',
