...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(142)', '[O]C=O(141)'],
    products = ['O=COOC(=O)F(2339)'],
    transitionState = 'TS8',
