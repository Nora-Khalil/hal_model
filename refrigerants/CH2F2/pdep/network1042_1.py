...
reaction(
    label = 'reaction16',
    reactants = ['CF2(42)', '[O]C1OO1(2690)'],
    products = ['[O]C1OOC1(F)F(2113)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction19',
    reactants = ['O(7)', 'FC1(F)[CH]OO1(1829)'],
    products = ['[O]C1OOC1(F)F(2113)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction21',
    reactants = ['H(6)', 'O=C1OOC1(F)F(244)'],
    products = ['[O]C1OOC1(F)F(2113)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', '[O]C1OO[C]1F(2693)'],
    products = ['[O]C1OOC1(F)F(2113)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction23',
    reactants = ['H(6)', '[O][C]1OOC1(F)F(262)'],
    products = ['[O]C1OOC1(F)F(2113)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C1OO[C]1F(2694)'],
    products = ['[O]C1OOC1(F)F(2113)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C1OOC1(F)F(2113)'],
    products = ['O[C]1OOC1(F)F(2695)'],
