...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)O[C](F)F(479)'],
...
reaction(
    ...
    products = ['F[CH]C(F)(F)O[C](F)F(479)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(128)', 'F[C](F)O[C](F)F(265)'],
    products = ['F[CH]C(F)(F)O[C](F)F(479)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC=C(F)O[C](F)F(531)'],
    products = ['F[CH]C(F)(F)O[C](F)F(479)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'F[C](F)O[C](F)F(265)'],
    products = ['F[CH]C(F)(F)O[C](F)F(479)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)O[C](F)C(F)F(502)'],
    products = ['F[CH]C(F)(F)O[C](F)F(479)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]C(F)(F)O[C](F)F(479)'],
    products = ['F[CH][C](F)OC(F)(F)F(532)'],
