...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(185)', '[C]=C(1595)'],
    products = ['C=[C]OC([O])=O(1629)'],
    transitionState = 'TS2',
