...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.828898,0.0765428,-0.000118176,1.02715e-07,-3.56345e-11,-74192.1,27.1804], Tmin=(100,'K'), Tmax=(804.033,'K')), NASAPolynomial(coeffs=[8.30638,0.0302241,-1.47518e-05,2.8548e-09,-1.98746e-13,-75099.7,-5.43017], Tmin=(804.033,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-617.763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'FC[C](F)C[C](F)F(1154)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)CC[C](F)F(1023)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1022)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(130)', '[CH2]C([CH2])(F)F(1147)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1022)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C[C](F)F(1057)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1022)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C(F)F(1086)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1022)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C[C](F)F(1150)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1022)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(F)=C[C](F)F(1088)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1022)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(42)', '[CH2]C([CH2])(F)F(1147)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1022)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)[CH]C(F)F(1151)'],
    products = ['[CH2]C(F)(F)C[C](F)F(1022)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C[C](F)F(1022)'],
    products = ['[CH2][C](F)CC(F)(F)F(1153)'],
...
network(
    label = 'PDepNetwork #446',
    isomers = [
        '[CH2]C(F)(F)C[C](F)F(1022)',
    ],
    reactants = [
        ('CH2CF2(56)', 'CH2CF2(56)'),
    ],
