...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])(O)F(2351)'],
    products = ['[O]OC([O])(O)F(2340)'],
    transitionState = 'TS2',
