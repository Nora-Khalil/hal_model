...
reaction(
    label = 'reaction1',
    reactants = ['O=C=C(F)OOC(F)F(3278)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'O=C=C(F)OO(3477)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'O=C=C(F)OOF(3478)'],
    products = ['O=C=C(F)OOC(F)F(3278)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C=C(F)OO[CH]F(3479)'],
    products = ['O=C=C(F)OOC(F)F(3278)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C=[C]OOC(F)F(3480)'],
    products = ['O=C=C(F)OOC(F)F(3278)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)F(164)', 'O=[C]C(=O)F(2239)'],
    products = ['O=C=C(F)OOC(F)F(3278)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(81)', '[O]OC(F)=C=O(2073)'],
    products = ['O=C=C(F)OOC(F)F(3278)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC(F)F(133)', 'O=C=[C]F(443)'],
    products = ['O=C=C(F)OOC(F)F(3278)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C(F)[C-]=[O+]OC(F)F(3481)'],
    products = ['O=C=C(F)OOC(F)F(3278)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C=C(F)OOC(F)F(3278)'],
    products = ['CO(13)', 'F[C-]=[O+]OC(F)F(3482)'],
