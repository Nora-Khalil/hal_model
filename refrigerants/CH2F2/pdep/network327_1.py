...
reaction(
    label = 'reaction2',
    reactants = ['CF2(42)', 'OC(F)OF(894)'],
    products = ['OC(F)(F)C(F)OF(885)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OF(147)', 'F[C]C(F)OF(911)'],
    products = ['OC(F)(F)C(F)OF(885)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(147)', 'OC(F)(F)[C]F(304)'],
    products = ['OC(F)(F)C(F)OF(885)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'OC(F)(F)OF(296)'],
    products = ['OC(F)(F)C(F)OF(885)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'FOC(F)=C(F)F(307)'],
    products = ['OC(F)(F)C(F)OF(885)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(147)', 'FOC=C(F)F(912)'],
    products = ['OC(F)(F)C(F)OF(885)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O[C](F)C(F)OF(914)'],
    products = ['OC(F)(F)C(F)OF(885)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)[CH]OF(915)'],
    products = ['OC(F)(F)C(F)OF(885)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(O)(F)F(916)'],
    products = ['OC(F)(F)C(F)OF(885)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'FOC(F)[C](F)F(917)'],
    products = ['OC(F)(F)C(F)OF(885)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)C(F)OF(918)'],
    products = ['OC(F)(F)C(F)OF(885)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(125)', 'OC(F)(F)[CH]F(455)'],
    products = ['OC(F)(F)C(F)OF(885)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(717)', 'O[C](F)F(220)'],
    products = ['OC(F)(F)C(F)OF(885)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)(F)[C](F)OF(310)'],
    products = ['OC(F)(F)C(F)OF(885)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(F)C(F)OF(919)'],
    products = ['OC(F)(F)C(F)OF(885)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(77)', 'O=CC(O)(F)F(920)'],
    products = ['OC(F)(F)C(F)OF(885)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=C(F)C(O)(F)F(316)'],
    products = ['OC(F)(F)C(F)OF(885)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)=C(F)OF(317)'],
    products = ['OC(F)(F)C(F)OF(885)'],
