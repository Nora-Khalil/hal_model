...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[O](1366)'],
    products = ['CH2O(20)', 'CH2CF2(56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]CC[C](F)F(1367)'],
    products = ['[CH2]C(F)(F)C[O](1366)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C[C](F)F(974)'],
    products = ['[CH2]C(F)(F)C[O](1366)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([CH2])(F)F(1147)'],
    products = ['[CH2]C(F)(F)C[O](1366)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](1324)', 'CH2CF2(56)'],
    products = ['[CH2]C(F)(F)C[O](1366)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2O(20)', '[CH2][C](F)F(933)'],
    products = ['[CH2]C(F)(F)C[O](1366)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C=O(1134)'],
    products = ['[CH2]C(F)(F)C[O](1366)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](1324)', '[CH2][C](F)F(933)'],
    products = ['[CH2]C(F)(F)C[O](1366)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(F)=C[O](1135)'],
    products = ['[CH2]C(F)(F)C[O](1366)'],
