species(
    label = '[CH2]C(F)(F)O[C](F)C=O(3567)',
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.425776,0.0788072,-9.03508e-05,5.09621e-08,-1.13257e-11,-103479,24.805], Tmin=(100,'K'), Tmax=(1095.15,'K')), NASAPolynomial(coeffs=[16.512,0.0200527,-9.87585e-06,1.97316e-09,-1.42511e-13,-107003,-54.2635], Tmin=(1095.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-861.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFFO) + group(Cs-CsHHH) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)

species(
    label = '[CH2]C(F)(F)OC1(F)[CH]O1(3742)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.102662,0.0814853,-0.0001,6.2482e-08,-1.43805e-11,-78033.4,22.885], Tmin=(100,'K'), Tmax=(1284.83,'K')), NASAPolynomial(coeffs=[15.4965,0.0144447,-1.61488e-07,-5.14393e-10,5.50446e-14,-80516.8,-50.3467], Tmin=(1284.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-650.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFFO) + group(Cs-CsOsHH) + group(CsCFHO) + ring(1,4-Dioxane) + radical(CCsJOCs) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C1CC(F)(F)O[C]1F(3720)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.29513,0.0660535,-6.14201e-05,2.90527e-08,-5.25214e-12,-75894.6,24.3393], Tmin=(100,'K'), Tmax=(1531.91,'K')), NASAPolynomial(coeffs=[16.8529,0.0148205,-3.42212e-06,4.04261e-10,-2.06152e-14,-80029.1,-59.541], Tmin=(1531.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-632.243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCFFO) + ring(Tetrahydrofuran) + radical(CC(C)OJ) + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-526.725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,501,1494,1531,326,540,652,719,1357,2782.5,750,1395,475,1775,1000,2950,3100,1380,975,1025,1650,322.635,322.638,322.639],'cm^-1')),
        HinderedRotor(inertia=(0.354741,'amu*angstrom^2'), symmetry=1, barrier=(26.2038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.459714,'amu*angstrom^2'), symmetry=1, barrier=(33.9581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.828397,'amu*angstrom^2'), symmetry=1, barrier=(61.1909,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-645.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,197,221,431,657,2120,512.5,787.5,180,180,180,1253.58],'cm^-1')),
        HinderedRotor(inertia=(0.0707298,'amu*angstrom^2'), symmetry=1, barrier=(17.509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.753998,'amu*angstrom^2'), symmetry=1, barrier=(17.3359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0279231,'amu*angstrom^2'), symmetry=1, barrier=(31.4756,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.433348,0.0808259,-0.000103395,6.47175e-08,-1.58839e-11,-77492.5,26.2254], Tmin=(100,'K'), Tmax=(997.266,'K')), NASAPolynomial(coeffs=[16.01,0.0183508,-9.4291e-06,1.90368e-09,-1.37899e-13,-80599.4,-48.8806], Tmin=(997.266,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-645.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFFO) + group(Cs-CsHHH) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
"""),
    E0 = (-654.401,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,355,410,600,1181,1341,1420,3056,3000,3100,440,815,1455,1000,1855,455,950,242.642,242.643,242.643],'cm^-1')),
        HinderedRotor(inertia=(0.205704,'amu*angstrom^2'), symmetry=1, barrier=(8.59399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205698,'amu*angstrom^2'), symmetry=1, barrier=(8.594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205701,'amu*angstrom^2'), symmetry=1, barrier=(8.59399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.889422,'amu*angstrom^2'), symmetry=1, barrier=(37.1594,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0737931,0.0978508,-0.000162872,1.39954e-07,-4.70602e-11,-78567.4,29.4367], Tmin=(100,'K'), Tmax=(816.039,'K')), NASAPolynomial(coeffs=[12.1091,0.0275955,-1.43617e-05,2.80308e-09,-1.94731e-13,-80204.9,-24.7121], Tmin=(816.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-654.401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = 'CC(F)(F)O[C](F)[C]=O(3746)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.271684,0.0909434,-0.000150586,1.33555e-07,-4.64005e-11,-87824.6,26.9703], Tmin=(100,'K'), Tmax=(823.291,'K')), NASAPolynomial(coeffs=[9.37506,0.0320017,-1.63911e-05,3.18299e-09,-2.20647e-13,-88824.9,-12.1499], Tmin=(823.291,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-731.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CsCOF1sO2s) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = '[CH2][C](F)OC(F)(F)C=O(3747)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.15916,'amu*angstrom^2'), symmetry=1, barrier=(3.6594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.382152,'amu*angstrom^2'), symmetry=1, barrier=(8.78642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147686,'amu*angstrom^2'), symmetry=1, barrier=(3.3956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.76476,'amu*angstrom^2'), symmetry=1, barrier=(40.5753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.057017,0.0960577,-0.000162266,1.44241e-07,-5.02799e-11,-73223.4,31.0589], Tmin=(100,'K'), Tmax=(808.325,'K')), NASAPolynomial(coeffs=[10.3951,0.0312559,-1.66953e-05,3.29926e-09,-2.31029e-13,-74448.9,-13.8592], Tmin=(808.325,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-609.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'O=C[C](F)O[C](F)CF(3748)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[CH2]C(F)(F)C([O])C(=O)F(3564)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-352.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,293,496,537,1218,3120,650,792.5,1650,180,180,827.557],'cm^-1')),
        HinderedRotor(inertia=(0.984257,'amu*angstrom^2'), symmetry=1, barrier=(22.63,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.983734,'amu*angstrom^2'), symmetry=1, barrier=(22.618,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.726578,'amu*angstrom^2'), symmetry=1, barrier=(16.7054,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.496361,0.0776495,-9.60462e-05,5.76553e-08,-1.35072e-11,-42281.2,24.6088], Tmin=(100,'K'), Tmax=(1046.05,'K')), NASAPolynomial(coeffs=[16.5277,0.0163475,-8.14184e-06,1.63271e-09,-1.18178e-13,-45635.2,-53.4551], Tmin=(1046.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-352.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = 'FC1=COCC(F)(F)O1(3694)',
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.159,0.0688455,-6.59667e-05,3.11006e-08,-5.45099e-12,-106985,19.757], Tmin=(100,'K'), Tmax=(1657.37,'K')), NASAPolynomial(coeffs=[18.0789,0.0109682,-1.04038e-06,-6.1562e-11,1.07011e-14,-111127,-71.7018], Tmin=(1657.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-890.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCFFO) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(23dihydro14dioxin)"""),
)

species(
    label = '[O][CH]C1(F)CC(F)(F)O1(3750)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.968219,0.073675,-9.56678e-05,7.23154e-08,-2.31014e-11,-73604,24.4885], Tmin=(100,'K'), Tmax=(751.125,'K')), NASAPolynomial(coeffs=[8.23579,0.0349718,-1.83755e-05,3.71252e-09,-2.67497e-13,-74695.7,-8.49328], Tmin=(751.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-612.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsHH) + group(CsCFFO) + group(Cs-CsOsHH) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
"""),
    E0 = (-557.298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,293,496,537,1218,1685,370,180,180,180,775.604],'cm^-1')),
        HinderedRotor(inertia=(0.0318564,'amu*angstrom^2'), symmetry=1, barrier=(13.5778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353402,'amu*angstrom^2'), symmetry=1, barrier=(13.5753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.991751,'amu*angstrom^2'), symmetry=1, barrier=(22.8023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.991911,'amu*angstrom^2'), symmetry=1, barrier=(22.806,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0307076,0.0906289,-0.000119643,7.66245e-08,-1.90976e-11,-66883.9,29.9864], Tmin=(100,'K'), Tmax=(986.424,'K')), NASAPolynomial(coeffs=[17.9316,0.0177926,-8.88686e-06,1.77286e-09,-1.27615e-13,-70427.6,-56.4262], Tmin=(986.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(C=CJO)"""),
)

species(
    label = 'C=C(F)O[C](F)[CH]OF(3753)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.262136,0.0994452,-0.000146125,1.05699e-07,-2.99158e-11,-29133.6,29.4571], Tmin=(100,'K'), Tmax=(869.126,'K')), NASAPolynomial(coeffs=[16.7107,0.0213254,-1.12914e-05,2.26704e-09,-1.62217e-13,-32083.7,-50.0452], Tmin=(869.126,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsCFHO) + group(Cs-CsOsHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C(F)(F)O[C]=COF(3754)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-241.08,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,283.024,283.03,283.034,283.037],'cm^-1')),
        HinderedRotor(inertia=(0.357887,'amu*angstrom^2'), symmetry=1, barrier=(20.3438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357858,'amu*angstrom^2'), symmetry=1, barrier=(20.3437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357872,'amu*angstrom^2'), symmetry=1, barrier=(20.3436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357873,'amu*angstrom^2'), symmetry=1, barrier=(20.3437,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.387642,0.0915342,-0.000115377,6.84277e-08,-1.54826e-11,-28832.9,31.7082], Tmin=(100,'K'), Tmax=(1096.51,'K')), NASAPolynomial(coeffs=[21.9168,0.0101684,-4.06937e-06,7.53699e-10,-5.31345e-14,-33724.3,-77.9529], Tmin=(1096.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-241.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(C=CJO)"""),
)

species(
    label = '[O]C=[C]OC(F)(F)CF(3755)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.23884,'amu*angstrom^2'), symmetry=1, barrier=(28.4833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23852,'amu*angstrom^2'), symmetry=1, barrier=(28.4759,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(3061)', '[CH2]C([O])(F)F(1145)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=C[C](F)O[C](F)F(2773)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
    products = ['[CH2]C(F)(F)OC1(F)[CH]O1(3742)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
    products = ['F[C]1[CH]OCC(F)(F)O1(3687)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
    products = ['[O]C1CC(F)(F)O[C]1F(3720)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)O[C](F)C=O(3743)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', '[CH2]C(F)(F)OC(F)=C=O(3744)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C[C]F-2(923)', '[CH2]C([O])(F)F(1145)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)OC(F)[C]=O(3745)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
    products = ['CC(F)(F)O[C](F)[C]=O(3746)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C](F)OC(F)(F)C=O(3747)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C[C](F)O[C](F)CF(3748)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)C([O])C(=O)F(3564)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(7)', '[CH]=C(F)OC([CH2])(F)F(3749)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
    products = ['[O][CH]C1(F)CC(F)(F)O1(3750)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', '[CH2]C(F)(F)O[C]=C=O(3751)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(F)(F)OC(F)=[C]O(3752)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=C(F)O[C](F)[CH]OF(3753)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(F)(F)O[C]=COF(3754)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C=[C]OC(F)(F)CF(3755)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(3567)'],
