...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[C]=O(186)'],
    products = ['[CH2]C(=O)O[C]=O(1631)'],
    transitionState = 'TS3',
