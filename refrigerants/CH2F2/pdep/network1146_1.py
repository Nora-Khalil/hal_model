...
reaction(
    label = 'reaction12',
    reactants = ['O(7)', '[O][CH]C(=O)F(749)'],
    products = ['[O]O[CH]C(=O)F(3056)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction14',
    reactants = ['[O]O[CH]C(=O)F(3056)'],
    products = ['O=C(F)C1OO1(3111)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', '[O]O[C]=C=O(3118)'],
    products = ['[O]O[CH]C(=O)F(3056)'],
