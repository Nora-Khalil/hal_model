...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C]C=C(F)F-2(2564)'],
    products = ['F[C]=CC(F)F(1318)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C]=[C]C(F)F(2732)'],
    products = ['F[C]=CC(F)F(1318)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'FC#C[CH]F(2733)'],
    products = ['F[C]=CC(F)F(1318)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]=CC(F)F(1318)'],
    products = ['F[CH]C=C(F)F(601)'],
