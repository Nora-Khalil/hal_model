...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83143,0.0422615,-2.8783e-05,8.91193e-09,-1.0791e-12,-84451.5,21.6699], Tmin=(100,'K'), Tmax=(1924.39,'K')), NASAPolynomial(coeffs=[15.4611,0.013931,-6.70032e-06,1.26181e-09,-8.52674e-14,-89697.3,-53.0077], Tmin=(1924.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-702.856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(Cds-OdOsH)"""),
)

species(
    label = 'O=C=C(F)OCO(3959)',
...
"""),
    E0 = (-306.662,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,180,180,1875.69,1877.15],'cm^-1')),
        HinderedRotor(inertia=(1.83536,'amu*angstrom^2'), symmetry=1, barrier=(42.1986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83454,'amu*angstrom^2'), symmetry=1, barrier=(42.1797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201392,'amu*angstrom^2'), symmetry=1, barrier=(4.63039,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39487,0.0686617,-0.000125712,1.2712e-07,-4.89014e-11,-36800.2,23.0091], Tmin=(100,'K'), Tmax=(825.709,'K')), NASAPolynomial(coeffs=[2.99336,0.0354743,-1.92008e-05,3.80606e-09,-2.66474e-13,-36196.8,20.8558], Tmin=(825.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-306.662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = 'O=[C][C](F)OCO(4154)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {5,S} {10,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.619692,0.0650317,-7.68353e-05,4.27585e-08,-8.92818e-12,-51016.4,25.4227], Tmin=(100,'K'), Tmax=(1289.87,'K')), NASAPolynomial(coeffs=[18.2964,0.00474362,-3.63416e-07,-5.41736e-11,7.03187e-15,-55121.4,-62.5924], Tmin=(1289.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(CsCOF1sO2s) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)
...
"""),
    E0 = (-35.2725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,293,496,537,1218,3120,650,792.5,1650,430.823,430.829,430.83,430.845],'cm^-1')),
        HinderedRotor(inertia=(0.208454,'amu*angstrom^2'), symmetry=1, barrier=(27.4576,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208461,'amu*angstrom^2'), symmetry=1, barrier=(27.4576,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49462,0.0456634,-2.96191e-05,-2.35711e-09,5.96679e-12,-4143.69,19.754], Tmin=(100,'K'), Tmax=(992.644,'K')), NASAPolynomial(coeffs=[16.1347,0.00729834,-2.81842e-06,5.79612e-10,-4.56775e-14,-8066.52,-55.8874], Tmin=(992.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.2725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CdCFO) + group(Cds-CdsHH) + radical(OCOJ) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06138,0.0725901,-0.000125256,1.12921e-07,-3.92433e-11,-50147.1,25.5217], Tmin=(100,'K'), Tmax=(844.179,'K')), NASAPolynomial(coeffs=[8.01393,0.024373,-1.24415e-05,2.39652e-09,-1.64628e-13,-50776.7,-3.61926], Tmin=(844.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-417.763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(O2s-H)(H))"""),
)

species(
    label = '[O]C=[C]OCOF(4161)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.18584,'amu*angstrom^2'), symmetry=1, barrier=(27.2648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18785,'amu*angstrom^2'), symmetry=1, barrier=(27.3109,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18621,'amu*angstrom^2'), symmetry=1, barrier=(27.2733,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.456248,0.0519545,1.23285e-05,-8.83723e-08,4.77971e-11,-3816.19,26.0554], Tmin=(100,'K'), Tmax=(902.716,'K')), NASAPolynomial(coeffs=[32.1815,-0.0184404,1.2682e-05,-2.50929e-09,1.6667e-13,-12403.5,-139.592], Tmin=(902.716,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.9939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = '[O]CO[C]=COF(4162)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (76.2397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1685,370,369.968,369.984,369.985,369.993,370.002],'cm^-1')),
        HinderedRotor(inertia=(0.25528,'amu*angstrom^2'), symmetry=1, barrier=(24.8,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255336,'amu*angstrom^2'), symmetry=1, barrier=(24.8001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255329,'amu*angstrom^2'), symmetry=1, barrier=(24.8004,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.899067,0.0560721,-3.64733e-05,-8.17474e-09,1.1234e-11,9292.31,25.824], Tmin=(100,'K'), Tmax=(940.471,'K')), NASAPolynomial(coeffs=[20.5196,0.00282948,2.66833e-07,-6.60627e-11,5.58995e-18,4265.9,-74.732], Tmin=(940.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.2397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(OCOJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](1374)', 'O=C[C]F(3123)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=CO[C](F)C=O(4149)'],
    products = ['[O]CO[C](F)C=O(3951)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]COC(F)=C=O(4150)'],
    products = ['[O]CO[C](F)C=O(3951)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C[O](1374)', 'O=C[C]F-2(818)'],
    products = ['[O]CO[C](F)C=O(3951)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(6)', '[CH]=C(F)OC[O](4155)'],
    products = ['[O]CO[C](F)C=O(3951)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', '[O]CO[C]=C=O(4158)'],
    products = ['[O]CO[C](F)C=O(3951)'],
