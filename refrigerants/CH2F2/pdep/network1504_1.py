...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'C#CO[C](O)F(4781)'],
    products = ['C#COC(O)(F)F(4271)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(O)(F)F(155)', 'C2H(22)'],
    products = ['C#COC(O)(F)F(4271)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OH(5)', 'C#CO[C](F)F(2522)'],
    products = ['C#COC(O)(F)F(4271)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(6)', 'C#COC([O])(F)F(3560)'],
    products = ['C#COC(O)(F)F(4271)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[C]#COC(O)(F)F(4782)'],
    products = ['C#COC(O)(F)F(4271)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'C#COC(=O)F(4784)'],
    products = ['C#COC(O)(F)F(4271)'],
    transitionState = 'TS9',
