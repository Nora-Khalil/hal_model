...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[CH]F(453)'],
    products = ['[O]C(F)C([O])(F)F(720)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)C=O(751)'],
    products = ['[O]C(F)C([O])(F)F(720)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C(=O)F(275)'],
    products = ['[O]C(F)C([O])(F)F(720)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)C(=O)F(752)'],
    products = ['[O]C(F)C([O])(F)F(720)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(237)', '[O][CH]F(134)'],
    products = ['[O]C(F)C([O])(F)F(720)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', '[O][CH]C(=O)F(753)'],
    products = ['[O]C(F)C([O])(F)F(720)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O][C](F)C(=O)F(276)'],
    products = ['[O]C(F)C([O])(F)F(720)'],
