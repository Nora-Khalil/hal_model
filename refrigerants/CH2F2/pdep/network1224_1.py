...
reaction(
    label = 'reaction2',
    reactants = ['[O]CC1O[C]1F(2781)'],
    products = ['[O]CC1(F)[CH]O1(2780)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C1(F)[CH]O1(2972)'],
    products = ['[O]CC1(F)[CH]O1(2780)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=CC1(F)[CH]O1(2955)'],
    products = ['[O]CC1(F)[CH]O1(2780)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]C=C1[CH]O1(2956)'],
    products = ['[O]CC1(F)[CH]O1(2780)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[CH]C1(F)[CH]O1(3017)'],
    products = ['[O]CC1(F)[CH]O1(2780)'],
