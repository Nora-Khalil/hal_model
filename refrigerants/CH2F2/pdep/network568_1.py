...
reaction(
    label = 'reaction6',
    reactants = ['OH(7)', '[CH2]OC(F)(F)F(1551)'],
    products = ['OCOC(F)(F)F(1490)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]COC(F)(F)F(1552)'],
    products = ['OCOC(F)(F)F(1490)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O[CH]OC(F)(F)F(925)'],
    products = ['OCOC(F)(F)F(1490)'],
    transitionState = 'TS8',
