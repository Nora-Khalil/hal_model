...
"""),
    E0 = (-310.753,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,2120,512.5,787.5,180,244.325],'cm^-1')),
        HinderedRotor(inertia=(0.0159287,'amu*angstrom^2'), symmetry=1, barrier=(14.4191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.627146,'amu*angstrom^2'), symmetry=1, barrier=(14.4193,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88397,0.04931,-4.98033e-05,2.6934e-08,-6.0521e-12,-37301.1,22.0762], Tmin=(100,'K'), Tmax=(1052.03,'K')), NASAPolynomial(coeffs=[9.11314,0.0218232,-1.06119e-05,2.09842e-09,-1.50229e-13,-38822.1,-13.167], Tmin=(1052.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(CsCsFFH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21643,0.0502605,-2.53266e-05,-1.09746e-08,9.69538e-12,-35120.3,24.9973], Tmin=(100,'K'), Tmax=(976.28,'K')), NASAPolynomial(coeffs=[16.8938,0.0111593,-3.86374e-06,7.3726e-10,-5.59201e-14,-39379.1,-56.3947], Tmin=(976.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C][CH]CC(F)F(1887)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48585,0.0579082,-6.71517e-05,4.31036e-08,-1.13155e-11,-37190.6,22.9738], Tmin=(100,'K'), Tmax=(919.958,'K')), NASAPolynomial(coeffs=[9.49204,0.0230969,-1.03912e-05,1.97068e-09,-1.37506e-13,-38663.7,-14.9835], Tmin=(919.958,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC[CH][C](F)F(1888)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.159312,'amu*angstrom^2'), symmetry=1, barrier=(3.66289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159312,'amu*angstrom^2'), symmetry=1, barrier=(3.66289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159298,'amu*angstrom^2'), symmetry=1, barrier=(3.66259,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53223,0.0603021,-8.92943e-05,8.03381e-08,-2.93981e-11,-28421.6,26.0751], Tmin=(100,'K'), Tmax=(789.969,'K')), NASAPolynomial(coeffs=[5.56988,0.0305785,-1.52358e-05,2.96998e-09,-2.07958e-13,-28770,9.38032], Tmin=(789.969,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.001,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(130)', '[CH2]C[C]=O(1880)'],
    products = ['O=[C]CC[C](F)F(1685)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(184)', '[CH2]C[C](F)F(1142)'],
    products = ['O=[C]CC[C](F)F(1685)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C[C](F)F(1142)'],
    products = ['O=[C]CC[C](F)F(1685)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]CC=C(F)F(1819)'],
    products = ['O=[C]CC[C](F)F(1685)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=CC[C](F)F(1884)'],
    products = ['O=[C]CC[C](F)F(1685)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(42)', '[CH2]C[C]=O(1880)'],
    products = ['O=[C]CC[C](F)F(1685)'],
