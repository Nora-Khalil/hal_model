...
"""),
    E0 = (-2.8727,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2950,1000,246,474,533,1155,3120,650,792.5,1650,448.942,448.958,448.958,448.967],'cm^-1')),
        HinderedRotor(inertia=(0.149809,'amu*angstrom^2'), symmetry=1, barrier=(21.4275,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (270.437,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,250,446,589,854,899,3120,650,792.5,1650,399.039,399.66,400.212,400.726,401.882,402.867],'cm^-1')),
        HinderedRotor(inertia=(0.00105071,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0563,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32685,0.0506841,-5.70591e-05,3.00036e-08,-5.95522e-12,32629.2,17.4603], Tmin=(100,'K'), Tmax=(1317.74,'K')), NASAPolynomial(coeffs=[15.9023,0.00389261,-8.95496e-07,1.22276e-10,-7.79616e-15,29009.1,-56.04], Tmin=(1317.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.437,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Cdj(Cd-CdF1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.82526,'amu*angstrom^2'), symmetry=1, barrier=(41.9664,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0563,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60518,0.0459139,-5.05932e-05,2.70868e-08,-5.50951e-12,13720.7,17.5422], Tmin=(100,'K'), Tmax=(1304.08,'K')), NASAPolynomial(coeffs=[13.5802,0.00616641,-1.40434e-06,1.66904e-10,-8.74229e-15,10853.9,-42.4262], Tmin=(1304.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + ring(Cs-Cs(F)-O2s) + radical(CCsJO)"""),
)
...
"""),
    E0 = (436.636,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,540,610,2055,3120,650,792.5,1650,446.519,446.585,447.082,447.122,447.312,447.94],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (66.0579,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.50265,0.0122573,6.1724e-05,-1.08644e-07,4.8574e-11,52588.5,12.9327], Tmin=(100,'K'), Tmax=(900.383,'K')), NASAPolynomial(coeffs=[20.0295,-0.0107707,8.73344e-06,-1.76714e-09,1.17489e-13,47209.6,-82.1284], Tmin=(900.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(methyleneoxirane) + radical(C=CCJO) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]C(F)=C1OC1F(3092)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.46476,'amu*angstrom^2'), symmetry=1, barrier=(33.6778,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85834,0.0478145,-4.85552e-05,2.48805e-08,-5.139e-12,5839.85,20.4796], Tmin=(100,'K'), Tmax=(1157.44,'K')), NASAPolynomial(coeffs=[10.8707,0.0166686,-8.19124e-06,1.63156e-09,-1.17366e-13,3753.58,-24.3177], Tmin=(1157.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cs-Cs(F)-O2s) + radical(Cds_S) + radical(Cds_P) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'FC=[C]C1(F)[CH]O1(3098)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C1(F)[CH]O1(2815)'],
    products = ['C2HF(57)', 'FC1=CO1(1231)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(68.7134,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission
Ea raised from 0.0 to 68.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(F)C1O[C]1F(2816)'],
    products = ['[CH]=C(F)C1(F)[CH]O1(2815)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=C(F)C1=CO1(3101)'],
    products = ['[CH]=C(F)C1(F)[CH]O1(2815)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(25.4548,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction6',
    reactants = ['[CH]=[C]F(2014)', 'FC1=CO1(1231)'],
    products = ['[CH]=C(F)C1(F)[CH]O1(2815)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CC1(F)[CH]O1(3102)'],
    products = ['[CH]=C(F)C1(F)[CH]O1(2815)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2HF(57)', 'F[C]1[CH]O1(2828)'],
    products = ['[CH]=C(F)C1(F)[CH]O1(2815)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]F(2014)', 'F[C]1[CH]O1(2828)'],
    products = ['[CH]=C(F)C1(F)[CH]O1(2815)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(77)', '[CH]=C=C1[CH]O1(3103)'],
    products = ['[CH]=C(F)C1(F)[CH]O1(2815)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)C1(F)[CH]O1(2815)'],
    products = ['F[CH]C(F)=C1[CH]O1(2922)'],
...
network(
    ...
    isomers = [
        '[CH]=C(F)C1(F)[CH]O1(2815)',
    ],
    reactants = [
        ('C2HF(57)', 'FC1=CO1(1231)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
