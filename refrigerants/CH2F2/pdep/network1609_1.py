...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(187)', '[CH2]C(=C)[O](4981)'],
    products = ['C=C([O])C[C]=O(5338)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['CO(13)', '[CH2]C(=C)[O](4981)'],
    products = ['C=C([O])C[C]=O(5338)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', 'C=C([O])C=C=O(5402)'],
    products = ['C=C([O])C[C]=O(5338)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', 'O=[C]C[C]=O(4747)'],
    products = ['C=C([O])C[C]=O(5338)'],
