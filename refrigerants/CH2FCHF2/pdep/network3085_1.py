...
species(
    label = 'O=CC1(F)OC(F)(F)C1(F)F(12088)',
...
species(
    label = 'O=C=C(F)OC(F)(F)C(F)F(12089)',
...
"""),
    ...
    molecularWeight = (176.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.288416,0.0984339,-0.000132559,8.69064e-08,-2.23006e-11,-148976,29.9672], Tmin=(100,'K'), Tmax=(955.703,'K')), NASAPolynomial(coeffs=[18.1744,0.0211571,-1.12675e-05,2.29467e-09,-1.66581e-13,-152505,-58.2682], Tmin=(955.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1239.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'F[C](F)C(F)(F)OC1(F)[CH]O1(12097)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (176.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.399126,0.104824,-0.000160679,1.25078e-07,-3.85991e-11,-110021,31.1138], Tmin=(100,'K'), Tmax=(794.662,'K')), NASAPolynomial(coeffs=[14.9023,0.0278,-1.52818e-05,3.09473e-09,-2.21701e-13,-112453,-39.189], Tmin=(794.662,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-916.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(CsCFOO) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)
...
species(
    label = 'O=C=C(F)OC(F)(F)[C](F)F(12100)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1033.74,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,190,488,555,1236,1407,197,221,431,657,2120,512.5,787.5,362.188,362.612,363.454,364.248,364.257],'cm^-1')),
        HinderedRotor(inertia=(0.391226,'amu*angstrom^2'), symmetry=1, barrier=(36.8481,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10272,'amu*angstrom^2'), symmetry=1, barrier=(9.65087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210257,'amu*angstrom^2'), symmetry=1, barrier=(19.5869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (175.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.658761,0.109669,-0.000175584,1.35923e-07,-4.09217e-11,-124169,30.9621], Tmin=(100,'K'), Tmax=(819.643,'K')), NASAPolynomial(coeffs=[17.7401,0.0198831,-1.12776e-05,2.28745e-09,-1.63264e-13,-127185,-54.1433], Tmin=(819.643,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1033.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)
...
species(
    label = 'O=[C][C](F)OC(F)(F)C(F)F(12102)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (176.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.559182,0.112085,-0.000198683,1.77844e-07,-6.11881e-11,-133317,32.5412], Tmin=(100,'K'), Tmax=(840.481,'K')), NASAPolynomial(coeffs=[11.8045,0.031761,-1.69894e-05,3.31394e-09,-2.28709e-13,-134636,-20.4441], Tmin=(840.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1109.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdCsH) + radical(CsCOF1sO2s) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = 'O=CC(F)(F)O[C](F)[C](F)F(12103)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-996.279,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([251,367,519,700,855,1175,1303,395,473,707,1436,2782.5,750,1395,475,1775,1000,190,488,555,1236,1407,217.845,217.968,217.99,1860.48],'cm^-1')),
        HinderedRotor(inertia=(0.195751,'amu*angstrom^2'), symmetry=1, barrier=(6.59049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195664,'amu*angstrom^2'), symmetry=1, barrier=(6.59041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00144,'amu*angstrom^2'), symmetry=1, barrier=(33.7834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00168,'amu*angstrom^2'), symmetry=1, barrier=(33.7841,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.373446,0.106814,-0.000183949,1.65675e-07,-5.88338e-11,-119677,35.7759], Tmin=(100,'K'), Tmax=(782.755,'K')), NASAPolynomial(coeffs=[11.2575,0.0341538,-1.9368e-05,3.92035e-09,-2.78518e-13,-121093,-14.9002], Tmin=(782.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-996.279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'O=C[C](F)O[C](F)C(F)(F)F(12104)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (176.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.310894,0.107782,-0.000193141,1.79293e-07,-6.41562e-11,-130274,32.1034], Tmin=(100,'K'), Tmax=(826.017,'K')), NASAPolynomial(coeffs=[9.26144,0.0370163,-2.03052e-05,4.02238e-09,-2.80883e-13,-131023,-7.20691], Tmin=(826.017,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1084.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Cds-OdCsH) + radical(Csj(Cs-F1sF1sF1s)(F1s)(O2s-Cs)) + radical(CsCOF1sO2s)"""),
)
...
species(
    label = '[CH]=C(F)OC(F)(F)[C](F)F(12105)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-740.971,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,190,488,555,1236,1407,293,496,537,1218,3120,650,792.5,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.960231,'amu*angstrom^2'), symmetry=1, barrier=(22.0776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.960478,'amu*angstrom^2'), symmetry=1, barrier=(22.0833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.960006,'amu*angstrom^2'), symmetry=1, barrier=(22.0724,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.503624,0.105329,-0.0001638,1.22573e-07,-3.56127e-11,-88961.6,29.0203], Tmin=(100,'K'), Tmax=(849.305,'K')), NASAPolynomial(coeffs=[17.9516,0.018414,-1.0304e-05,2.09158e-09,-1.49833e-13,-92096.6,-57.0021], Tmin=(849.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-740.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s)) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
species(
    label = '[O][CH]C1(F)OC(F)(F)C1(F)F(12107)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (176.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.27043,0.102494,-0.000166807,1.43216e-07,-4.88633e-11,-119902,30.2885], Tmin=(100,'K'), Tmax=(776.539,'K')), NASAPolynomial(coeffs=[12.1694,0.0316659,-1.69536e-05,3.37069e-09,-2.37659e-13,-121630,-25.2698], Tmin=(776.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-998.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(CsCsCsFF) + group(CsCFFO) + group(Cs-CsOsHH) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(CCOJ) + radical(CCsJOH) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2)"""),
)
...
species(
    label = 'O[C]=C(F)OC(F)(F)[C](F)F(12109)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (176.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.10009,0.119203,-0.000190881,1.46548e-07,-4.35509e-11,-113561,34.6415], Tmin=(100,'K'), Tmax=(831.806,'K')), NASAPolynomial(coeffs=[19.6759,0.0192957,-1.07162e-05,2.1517e-09,-1.52543e-13,-117018,-61.7644], Tmin=(831.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-945.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s)) + radical(C=CJO)"""),
)

species(
    label = 'FOC=C(F)O[C](F)[C](F)F(12110)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {11,S}
...
10 C u0 p0 c0 {7,S} {8,D} {12,S}
11 C u1 p0 c0 {3,S} {4,S} {9,S}
12 H u0 p0 c0 {10,S}
"""),
    E0 = (-608.637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,326,540,652,719,1357,395,473,707,1436,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (176.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.76425,0.115291,-0.000186674,1.46862e-07,-4.36213e-11,-73040.4,35.4647], Tmin=(100,'K'), Tmax=(659.477,'K')), NASAPolynomial(coeffs=[15.8234,0.0273869,-1.56337e-05,3.17308e-09,-2.26108e-13,-75504.5,-39.7505], Tmin=(659.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-608.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'FOC=[C]OC(F)(F)[C](F)F(12111)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C=[C]OC(F)(F)C(F)(F)F(12112)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)[C](F)F(2628)', 'O=C[C]F(9027)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'O=C[C](F)O[C](F)F(1741)'],
    products = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    products = ['O=CC1(F)OC(F)(F)C1(F)F(12088)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    products = ['O=C=C(F)OC(F)(F)C(F)F(12089)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    products = ['F[C](F)C(F)(F)OC1(F)[CH]O1(12097)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.81516e-05,'m^3/(mol*s)'), n=3.04336, Ea=(28.3483,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C[C](F)OC(F)=C(F)F(5814)'],
    products = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(44.5116,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C=C(F)OC(F)(F)[C](F)F(12100)'],
    products = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)(F)[C](F)F(2628)', 'O=C[C]F-2(1596)'],
    products = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', 'O=C[C](F)O[C](F)F(1741)'],
    products = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    products = ['O=[C][C](F)OC(F)(F)C(F)F(12102)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=CC(F)(F)O[C](F)[C](F)F(12103)'],
    products = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(196.363,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction19',
    reactants = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    products = ['O=C[C](F)O[C](F)C(F)(F)F(12104)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(6)', '[CH]=C(F)OC(F)(F)[C](F)F(12105)'],
    products = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    products = ['[O][CH]C1(F)OC(F)(F)C1(F)F(12107)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(4.06771e+06,'s^-1'), n=1.35044, Ea=(63.9625,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
...
reaction(
    label = 'reaction25',
    reactants = ['O[C]=C(F)OC(F)(F)[C](F)F(12109)'],
    products = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
...
reaction(
    label = 'reaction26',
    reactants = ['FOC=C(F)O[C](F)[C](F)F(12110)'],
    products = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(43.9314,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction27',
    reactants = ['FOC=[C]OC(F)(F)[C](F)F(12111)'],
    products = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O=C[C](F)OC(F)(F)[C](F)F(12086)'],
    products = ['[O]C=[C]OC(F)(F)C(F)(F)F(12112)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(184.913,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #3085',
    isomers = [
        'O=C[C](F)OC(F)(F)[C](F)F(12086)',
    ],
    reactants = [
