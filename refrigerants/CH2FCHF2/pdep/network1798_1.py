...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', '[CH2]C[C]=O(6367)'],
    products = ['O=[C]CC[C](F)F(6187)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]CC=C(F)F(6370)'],
    products = ['O=[C]CC[C](F)F(6187)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=CC[C](F)F(6371)'],
    products = ['O=[C]CC[C](F)F(6187)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C[C]=O(6367)'],
    products = ['O=[C]CC[C](F)F(6187)'],
