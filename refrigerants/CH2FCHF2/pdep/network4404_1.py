...
"""),
    E0 = (197.909,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,326,540,652,719,1357,194,682,905,1196,1383,3221,1685,370,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.226409,'amu*angstrom^2'), symmetry=1, barrier=(5.20558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225862,'amu*angstrom^2'), symmetry=1, barrier=(5.19301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.397127,'amu*angstrom^2'), symmetry=1, barrier=(9.13074,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
...
"""),
    E0 = (-19.3836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,293,496,537,1218,167,640,1190,180,889.903],'cm^-1')),
        HinderedRotor(inertia=(0.265085,'amu*angstrom^2'), symmetry=1, barrier=(6.09482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264662,'amu*angstrom^2'), symmetry=1, barrier=(6.08511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.00373,'amu*angstrom^2'), symmetry=1, barrier=(46.0698,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[C]=COOC(F)=CF(9710)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=COOC(F)=CF(8784)'],
    products = ['O=C(F)[CH]F(215)', 'C1=CO1(907)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=COOC(F)=CF(8784)'],
    products = ['F[CH]C1(F)C=COO1(16853)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)=CF(214)', 'C2H2(23)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COOC(F)=CF(16854)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=COO[C]=CF(16855)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=COOC(=[CH])F(16856)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(F)[CH]F(215)', '[CH]=C[O](3464)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHFCF[Z](72)', '[CH]=CO[O](6534)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC(F)=CF(214)', '[CH]=[CH](4466)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=[C]OOC(F)=CF(16857)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=COOC(F)=[C]F(16858)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', '[CH]=COOC#C(15978)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[CH]=COOC#CF(16859)'],
    products = ['[CH]=COOC(F)=CF(8784)'],
...
network(
    ...
    reactants = [
        ...
        ('O=C(F)[CH]F(215)', 'C1=CO1(907)'),
        ('O=C(F)[CH]F(215)', '[CH]=C[O](3464)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
