...
reaction(
    label = 'reaction3',
    reactants = ['O=C1O[C](O)O[C]1F(8956)'],
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C=[C]OC(=O)O(8958)'],
    products = ['O=C=C(F)OC(=O)O(6165)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]O(338)', 'O=[C]C(=O)F(1543)'],
    products = ['O=C=C(F)OC(=O)O(6165)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(4910)', 'O=C=[C]F(289)'],
    products = ['O=C=C(F)OC(=O)O(6165)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'O=[C]OC(F)=C=O(8959)'],
    products = ['O=C=C(F)OC(=O)O(6165)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C(F)[C-]=[O+]C(=O)O(8960)'],
    products = ['O=C=C(F)OC(=O)O(6165)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C=C(F)OC(=O)O(6165)'],
    products = ['HF(38)', 'CO2(14)', 'O=C=C=O(1544)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C=C(F)OC(=O)O(6165)'],
    products = ['CO(13)', 'O=C(O)[O+]=[C-]F(4918)'],
