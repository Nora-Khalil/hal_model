...
"""),
    E0 = (-181.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,326,540,652,719,1357,323,467,575,827,1418,363.153,369.712,374.272],'cm^-1')),
        HinderedRotor(inertia=(0.52921,'amu*angstrom^2'), symmetry=1, barrier=(52.3505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.538613,'amu*angstrom^2'), symmetry=1, barrier=(52.4291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-216.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,250,446,589,854,899,194,682,905,1196,1383,3221,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.877806,'amu*angstrom^2'), symmetry=1, barrier=(20.1825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.878132,'amu*angstrom^2'), symmetry=1, barrier=(20.19,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03002,0.0670715,-8.67617e-05,5.58292e-08,-1.40849e-11,-25983.8,20.2407], Tmin=(100,'K'), Tmax=(972.156,'K')), NASAPolynomial(coeffs=[13.5177,0.0156902,-7.48252e-06,1.46271e-09,-1.04048e-13,-28411.8,-39.6524], Tmin=(972.156,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsHH) + radical(Cdj(Cd-CdF1s)(H))"""),
)
...
"""),
    E0 = (-246.941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,334,575,1197,1424,3202,2175,525,750,770,3400,2100,180],'cm^-1')),
        HinderedRotor(inertia=(1.55459,'amu*angstrom^2'), symmetry=1, barrier=(35.7432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54883,'amu*angstrom^2'), symmetry=1, barrier=(35.6106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55051,'amu*angstrom^2'), symmetry=1, barrier=(35.6492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.705662,0.0767186,-0.000120739,9.61855e-08,-2.97587e-11,-29585.6,21.5929], Tmin=(100,'K'), Tmax=(858.616,'K')), NASAPolynomial(coeffs=[12.3093,0.0173998,-7.91739e-06,1.44924e-09,-9.67461e-14,-31384.3,-31.4897], Tmin=(858.616,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-246.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtCs) + group(Ct-CtH) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (71.3251,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,234,589,736,816,1240,3237,540,610,2055,3120,650,792.5,1650],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02328,0.0582383,-6.94437e-05,3.95652e-08,-8.49136e-12,8691.84,20.3313], Tmin=(100,'K'), Tmax=(1249.94,'K')), NASAPolynomial(coeffs=[16.0604,0.0055593,-7.56051e-07,1.27175e-11,3.0155e-15,5288.8,-54.1446], Tmin=(1249.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.3251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CsCdF1sH) + radical(C=C=CJ)"""),
)
...
"""),
    E0 = (-339.487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,1685,370,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.1545,'amu*angstrom^2'), symmetry=1, barrier=(26.5443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15556,'amu*angstrom^2'), symmetry=1, barrier=(26.5687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14893,'amu*angstrom^2'), symmetry=1, barrier=(26.4161,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.557943,0.0830004,-0.000125364,9.42793e-08,-2.64148e-11,-40713.7,25.6123], Tmin=(100,'K'), Tmax=(657.176,'K')), NASAPolynomial(coeffs=[11.9429,0.0235795,-1.22772e-05,2.42566e-09,-1.70933e-13,-42423.3,-26.1568], Tmin=(657.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-339.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', '[CH]C(F)=C(O)F(476)'],
    products = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=C(F)C(O)=CF(16542)'],
    products = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(56.4973,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction6',
    reactants = ['OH(7)', '[CH]=C(F)C(F)=CF(263)'],
    products = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(1.09158,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH]=C(F)C([O])=CF(3196)'],
    products = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(172.652,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[CH]=C=C(O)[CH]F(16544)'],
    products = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(17.5064,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH]C(F)=C(O)F(476)'],
    products = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(F)C([O])(F)CF(3075)'],
    products = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
    products = ['C=C(F)C([O])(F)[CH]F(3198)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
    products = ['[CH]C(F)=C(O)C(F)F(16545)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(146.581,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
    products = ['OC([CH]F)=C(F)[CH]F(16465)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(180.393,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[CH]=[C]C(O)(F)C(F)F(16546)'],
    products = ['[CH]=C(F)C(O)(F)[CH]F(3197)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(221.214,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
