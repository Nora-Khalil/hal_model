...
"""),
    E0 = (-511.436,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,580,1155,1237,1373,3147,188.164,188.217,188.278,188.415],'cm^-1')),
        HinderedRotor(inertia=(0.450414,'amu*angstrom^2'), symmetry=1, barrier=(11.3137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.449589,'amu*angstrom^2'), symmetry=1, barrier=(11.3147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.51039,'amu*angstrom^2'), symmetry=1, barrier=(38.0931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-307.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3025,407.5,1350,352.5,580,1155,1237,1373,3147,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11245,0.0691174,-9.73346e-05,7.43858e-08,-2.31349e-11,-36840.4,25.5246], Tmin=(100,'K'), Tmax=(781.688,'K')), NASAPolynomial(coeffs=[9.67827,0.0252831,-1.32159e-05,2.64155e-09,-1.88572e-13,-38179.5,-13.6903], Tmin=(781.688,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-307.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsFHHO) + group(Cds-OdCsOs) + radical(OCJC=O) + radical(Csj(F1s)(O2s-CO)(H))"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3490.06,'J/mol'), sigma=(5.52916,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=545.14 K, Pc=46.85 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1114,0.0705977,-0.00011509,1.03445e-07,-3.69314e-11,-30502.2,24.6187], Tmin=(100,'K'), Tmax=(795.152,'K')), NASAPolynomial(coeffs=[7.6264,0.0275517,-1.45083e-05,2.86898e-09,-2.01662e-13,-31213.5,-3.27697], Tmin=(795.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-254.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFOO) + group(Cs-CsOsHH) + group(CsFHHO) + ring(Cs-Cs(F)-O2s-O2s) + radical(CCsJOO) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = '[O]C1(F)[CH]OC(F)O1(1995)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0764972,0.070114,-9.28909e-05,5.57133e-08,-1.1805e-11,-66820.5,20.6056], Tmin=(100,'K'), Tmax=(1434.62,'K')), NASAPolynomial(coeffs=[17.9067,-0.00240445,6.77585e-06,-1.6818e-09,1.27562e-13,-69589.7,-63.671], Tmin=(1434.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsOsHH) + group(CsFHOO) + ring(1,3-Dioxolane) + radical(O2sj(Cs-F1sO2sCs)) + radical(CCsJOCs)"""),
)

species(
    label = '[O]C1OC1(F)O[CH]F(1996)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41602,0.0638493,-0.000100904,9.4558e-08,-3.59684e-11,-54387,24.876], Tmin=(100,'K'), Tmax=(762.168,'K')), NASAPolynomial(coeffs=[5.59651,0.0315779,-1.70587e-05,3.43341e-09,-2.44706e-13,-54724.1,7.81151], Tmin=(762.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-452.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsOsOsH) + group(CsFHHO) + ring(Cs(F)(O2)-O2s-Cs) + radical(CCOJ) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
6 C u0 p0 c0 {4,D} {5,S} {8,S}
7 C u1 p0 c0 {1,S} {2,S} {9,S}
8 H u0 p0 c0 {6,S}
9 H u0 p0 c0 {7,S}
"""),
    E0 = (-473.086,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,580,1155,1237,1373,3147,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98126,0.04957,-6.03096e-05,4.29437e-08,-1.31611e-11,-56831,20.6542], Tmin=(100,'K'), Tmax=(774.802,'K')), NASAPolynomial(coeffs=[6.65087,0.0254617,-1.36347e-05,2.78155e-09,-2.01813e-13,-57554.6,-0.682396], Tmin=(774.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-473.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsFHHO) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H) + radical(Csj(F1s)(O2s-CO)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92733,0.0499483,-6.58803e-05,4.62462e-08,-1.32653e-11,-37761.8,21.6203], Tmin=(100,'K'), Tmax=(842.469,'K')), NASAPolynomial(coeffs=[8.53452,0.018577,-1.0023e-05,2.04397e-09,-1.48082e-13,-38875.1,-9.12281], Tmin=(842.469,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsFHHO) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H) + radical(Csj(F1s)(O2s-CO)(H)) + radical(OC=OCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.526531,0.0864939,-0.000158012,1.44364e-07,-5.03464e-11,-72107.8,27.2363], Tmin=(100,'K'), Tmax=(843.183,'K')), NASAPolynomial(coeffs=[9.41015,0.0248156,-1.35353e-05,2.65617e-09,-1.83643e-13,-72911.5,-9.98885], Tmin=(843.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-600.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFHHO) + group(Cds-OdCsH) + radical(Csj(F1s)(O2s-Cs)(H)) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C(F)([C]=O)OCF(2001)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.853003,0.0780559,-0.000137011,1.25222e-07,-4.42192e-11,-66701,26.5888], Tmin=(100,'K'), Tmax=(829.692,'K')), NASAPolynomial(coeffs=[8.20905,0.0263115,-1.40294e-05,2.75453e-09,-1.9149e-13,-67361.3,-4.1495], Tmin=(829.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-555.455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFHHO) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C=C(OF)O[CH]F(2002)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {6,S} {8,S}
...
"""),
    E0 = (-231.271,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,3010,987.5,1337.5,450,1655,580,1155,1237,1373,3147,271.376,271.38,271.38,271.385,271.388],'cm^-1')),
        HinderedRotor(inertia=(0.398303,'amu*angstrom^2'), symmetry=1, barrier=(20.8166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.398312,'amu*angstrom^2'), symmetry=1, barrier=(20.8166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.398321,'amu*angstrom^2'), symmetry=1, barrier=(20.8166,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.260438,0.0796615,-0.000106604,6.6595e-08,-1.58326e-11,-27678.5,26.1518], Tmin=(100,'K'), Tmax=(1045.08,'K')), NASAPolynomial(coeffs=[19.0977,0.00756234,-3.1202e-06,5.81088e-10,-4.09177e-14,-31615.8,-65.5575], Tmin=(1045.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsFHHO) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(F1s)(O2s-Cd)(H))"""),
)

species(
    label = '[O]C=C([O])OC(F)F(2003)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0628013,0.0745021,-8.70357e-05,4.59634e-08,-8.99241e-12,-81354.6,26.4644], Tmin=(100,'K'), Tmax=(1402.97,'K')), NASAPolynomial(coeffs=[22.9507,0.00039829,1.27037e-06,-3.11404e-10,2.20698e-14,-86976.5,-89.3769], Tmin=(1402.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-677.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(C=O)O[CH]F(1898)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]C(F)O[CH]F(382)'],
    products = ['[O]C(F)(C=O)O[CH]F(1898)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.81927e-16,'m^3/(mol*s)'), n=6.80628, Ea=(310.652,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1COCbCdCsCtHNOSSidSis->Cs_N-2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->Cs_Ext-1Cs-R_N-2Br1sCl1sF1sH->F1s_N-5R!H->C',), comment="""Estimated from node Root_1COCbCdCsCtHNOSSidSis->Cs_N-2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->Cs_Ext-1Cs-R_N-2Br1sCl1sF1sH->F1s_N-5R!H->C"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O=C([CH]OF)O[CH]F(1991)'],
    products = ['[O]C(F)(C=O)O[CH]F(1898)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(8.88952e+10,'s^-1'), n=0.725184, Ea=(216.683,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(137)', '[O]C([O])(F)C=O(1992)'],
    products = ['[O]C(F)(C=O)O[CH]F(1898)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(C=O)O[CH]F(1898)'],
    products = ['F[CH]OC1(F)[CH]OO1(1994)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(C=O)O[CH]F(1898)'],
    products = ['[O]C1(F)[CH]OC(F)O1(1995)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(C=O)O[CH]F(1898)'],
    products = ['[O]C1OC1(F)O[CH]F(1996)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(902977,'s^-1'), n=1.63829, Ea=(62.8331,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs] for rate rule [R5_SS_CO;carbonylbond_intra_H;radadd_intra_cs]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 60.7 to 62.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(122.059,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=CC(=O)O[CH]F(1998)'],
    products = ['[O]C(F)(C=O)O[CH]F(1898)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(30.4794,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(53.3666,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['HCO(15)', 'O=C(F)O[CH]F(464)'],
    products = ['[O]C(F)(C=O)O[CH]F(1898)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(520000,'m^3/(mol*s)'), n=-1.07934e-11, Ea=(129.753,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(2.52089,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=[C]C(=O)O[CH]F(1999)'],
    products = ['[O]C(F)(C=O)O[CH]F(1898)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(308.943,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['CHF(40)', '[O]C([O])(F)C=O(1992)'],
    products = ['[O]C(F)(C=O)O[CH]F(1898)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)O[CH]F(1898)'],
    products = ['O=[C]C(O)(F)O[CH]F(2000)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(C=O)O[CH]F(1898)'],
    products = ['[O]C(F)([C]=O)OCF(2001)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(823.921,'s^-1'), n=2.44436, Ea=(83.491,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_SSS;C_rad_out_1H;XH_out] for rate rule [R4H_SSS_OCs;C_rad_out_1H;CO_H_out]
Euclidian distance = 1.4142135623730951
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C=C(OF)O[CH]F(2002)'],
    products = ['[O]C(F)(C=O)O[CH]F(1898)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(87.1257,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(C=O)O[CH]F(1898)'],
    products = ['[O]C=C([O])OC(F)F(2003)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(152.618,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #343',
    isomers = [
        '[O]C(F)(C=O)O[CH]F(1898)',
    ],
    reactants = [
