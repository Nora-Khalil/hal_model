...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', '[O]C[O](2715)'],
    products = ['[O]CO[C](F)F(2699)'],
    transitionState = 'TS2',
