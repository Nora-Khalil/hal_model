...
"""),
    E0 = (-261.419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([364,474,579,619,655,1345,2950,1000,580,1155,1237,1373,3147,279.236,281.616,281.65,281.654,1040.09,2492.9],'cm^-1')),
        HinderedRotor(inertia=(0.00797963,'amu*angstrom^2'), symmetry=1, barrier=(35.2465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.630937,'amu*angstrom^2'), symmetry=1, barrier=(35.2598,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90562,0.0498666,-5.70007e-05,3.5092e-08,-8.93978e-12,-31369.2,20.2334], Tmin=(100,'K'), Tmax=(937.697,'K')), NASAPolynomial(coeffs=[8.69817,0.0208914,-1.06504e-05,2.13892e-09,-1.54205e-13,-32643,-12.0998], Tmin=(937.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-261.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(CsCFOO) + group(Cs-CsOsHH) + group(CsFHHO) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    E0 = (104.556,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,580,1155,1237,1373,3147,180,180,180,538.474,617.568,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.170029,'amu*angstrom^2'), symmetry=1, barrier=(3.9093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170029,'amu*angstrom^2'), symmetry=1, barrier=(3.9093,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44574,0.062196,-0.000109283,9.58964e-08,-3.22845e-11,12661.4,18.5694], Tmin=(100,'K'), Tmax=(848.721,'K')), NASAPolynomial(coeffs=[9.01809,0.0157589,-8.21393e-06,1.58523e-09,-1.08589e-13,11763.2,-14.44], Tmin=(848.721,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(oxirene) + radical(Csj(F1s)(O2s-Cd)(H))"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47339,0.0537909,-5.67364e-05,2.19046e-08,9.37039e-13,-36506.3,22.5776], Tmin=(100,'K'), Tmax=(791.936,'K')), NASAPolynomial(coeffs=[13.4604,0.00884181,-1.13994e-06,-2.93055e-11,1.06975e-14,-38893.9,-35.5445], Tmin=(791.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-304.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(CsFFHO) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC1(F)[CH]O1(8862)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[O]C1(F)[CH]O1(8502)'],
    products = ['F[CH]OC1(F)[CH]O1(8862)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC1=CO1(8872)'],
    products = ['F[CH]OC1(F)[CH]O1(8862)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(12.6793,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[O]C1(F)[CH]O1(8502)'],
    products = ['F[CH]OC1(F)[CH]O1(8862)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]OC1(F)[CH]O1(8862)'],
    products = ['FC(F)O[C]1[CH]O1(8873)'],
