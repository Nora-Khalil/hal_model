...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FCC(F)(F)OF(2808)'],
    products = ['FCC(F)(F)COF(5406)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)(F)COF(5546)'],
    products = ['FCC(F)(F)COF(5406)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'FOCC(F)(F)F(5547)'],
    products = ['FCC(F)(F)COF(5406)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(488)', 'C=C(F)CF(2846)'],
    products = ['FCC(F)(F)COF(5406)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[C](F)COF(2853)'],
    products = ['FCC(F)(F)COF(5406)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)(F)COF(2865)'],
    products = ['FCC(F)(F)COF(5406)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(F)(F)CF(5316)'],
    products = ['FCC(F)(F)COF(5406)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(128)', '[CH2]C(F)(F)CF(3197)'],
    products = ['FCC(F)(F)COF(5406)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(2545)', 'CH2F-CF2(68)'],
    products = ['FCC(F)(F)COF(5406)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'FOC[C](F)F(2864)'],
    products = ['FCC(F)(F)COF(5406)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FCC(F)(F)[CH]OF(5424)'],
    products = ['FCC(F)(F)COF(5406)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[CH]C(F)(F)COF(5548)'],
    products = ['FCC(F)(F)COF(5406)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', 'C=C(F)COF(2856)'],
    products = ['FCC(F)(F)COF(5406)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FCC(F)(F)COF(5406)'],
    products = ['F2(78)', 'CH2O(20)', 'CH2CF2(57)'],
