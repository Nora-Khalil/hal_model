species(
    label = '[O]C(F)(CF)C(F)(F)[CH]F(3845)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.262624,'amu*angstrom^2'), symmetry=1, barrier=(6.03824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.99996,'amu*angstrom^2'), symmetry=1, barrier=(22.991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262457,'amu*angstrom^2'), symmetry=1, barrier=(6.03441,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.604266,0.111838,-0.000191135,1.6814e-07,-5.7539e-11,-107475,31.9961], Tmin=(100,'K'), Tmax=(823.551,'K')), NASAPolynomial(coeffs=[12.3429,0.032667,-1.72703e-05,3.38291e-09,-2.3507e-13,-109055,-24.5997], Tmin=(823.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-894.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.99136,'amu*angstrom^2'), symmetry=1, barrier=(22.7933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.93707,'amu*angstrom^2'), symmetry=1, barrier=(44.5371,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.234206,'amu*angstrom^2'), symmetry=1, barrier=(5.38485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237451,'amu*angstrom^2'), symmetry=1, barrier=(5.45946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64907,'amu*angstrom^2'), symmetry=1, barrier=(37.9154,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0283707,0.101056,-0.000182045,1.70086e-07,-6.11001e-11,-88522,29.2729], Tmin=(100,'K'), Tmax=(825.88,'K')), NASAPolynomial(coeffs=[8.75833,0.0348678,-1.89105e-05,3.75406e-09,-2.62666e-13,-89167.4,-6.55772], Tmin=(825.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-737.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    E0 = (-790.489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([249,341,381,651,928,1217,1251,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,334,575,1197,1424,3202,198.657,198.707,2092.73],'cm^-1')),
        HinderedRotor(inertia=(0.43393,'amu*angstrom^2'), symmetry=1, barrier=(12.1545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.434135,'amu*angstrom^2'), symmetry=1, barrier=(12.1551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27227,'amu*angstrom^2'), symmetry=1, barrier=(35.6146,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.283378,0.0895524,-0.000144431,1.25179e-07,-4.30123e-11,-94947.5,28.6454], Tmin=(100,'K'), Tmax=(798.757,'K')), NASAPolynomial(coeffs=[10.249,0.0303126,-1.56545e-05,3.0683e-09,-2.14501e-13,-96241.8,-15.3299], Tmin=(798.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-790.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(Csj(Cs-F1sF1sCO)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.5061,'amu*angstrom^2'), symmetry=1, barrier=(34.6283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50163,'amu*angstrom^2'), symmetry=1, barrier=(34.5253,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431267,0.0843015,-0.000112196,7.79751e-08,-2.17851e-11,-89217.5,25.3209], Tmin=(100,'K'), Tmax=(870.681,'K')), NASAPolynomial(coeffs=[12.8345,0.0273188,-1.40252e-05,2.80564e-09,-2.01169e-13,-91377.3,-32.7995], Tmin=(870.681,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-742.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CC(C)OJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.23718,'amu*angstrom^2'), symmetry=1, barrier=(51.4372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214212,'amu*angstrom^2'), symmetry=1, barrier=(4.92516,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.900161,0.0748146,-0.000115946,1.00961e-07,-3.5407e-11,-55821.3,24.8927], Tmin=(100,'K'), Tmax=(781.134,'K')), NASAPolynomial(coeffs=[8.28287,0.0296851,-1.52197e-05,2.99122e-09,-2.1011e-13,-56751.2,-7.47065], Tmin=(781.134,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-464.999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cds-CdsCsOs) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=C(C)OJ) + radical(Csj(Cd-CdF1s)(F1s)(H))"""),
)

species(
    label = 'C=C([O])C(F)(F)[CH]F(3924)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0901901,'amu*angstrom^2'), symmetry=1, barrier=(2.07365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439285,'amu*angstrom^2'), symmetry=1, barrier=(10.1,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.911684,0.0744229,-0.000105473,7.6446e-08,-2.04647e-11,-56157.1,25.9505], Tmin=(100,'K'), Tmax=(651.858,'K')), NASAPolynomial(coeffs=[10.4194,0.0250452,-1.24779e-05,2.43458e-09,-1.70888e-13,-57587.1,-17.3109], Tmin=(651.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-467.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Csj(Cs-F1sF1sCd)(F1s)(H))"""),
)
...
species(
    label = 'O=C([CH]F)C(F)(F)[CH]F(3925)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-636.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([249,341,381,651,928,1217,1251,375,552.5,462.5,1710,334,575,1197,1424,3202,235,1215,1347,1486,3221,313.052,314.078,838.716],'cm^-1')),
        HinderedRotor(inertia=(0.0865733,'amu*angstrom^2'), symmetry=1, barrier=(6.04256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0878254,'amu*angstrom^2'), symmetry=1, barrier=(6.0054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.740893,'amu*angstrom^2'), symmetry=1, barrier=(52.5091,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.489689,0.0837834,-0.000132975,1.12237e-07,-3.76883e-11,-76387.4,27.8033], Tmin=(100,'K'), Tmax=(784.751,'K')), NASAPolynomial(coeffs=[10.7766,0.0263342,-1.35783e-05,2.66194e-09,-1.86323e-13,-77847.5,-18.3475], Tmin=(784.751,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(Csj(Cs-F1sF1sCO)(F1s)(H)) + radical(Csj(CO-CsO2d)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.221881,'amu*angstrom^2'), symmetry=1, barrier=(5.10148,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222246,'amu*angstrom^2'), symmetry=1, barrier=(5.10987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221662,'amu*angstrom^2'), symmetry=1, barrier=(5.09643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15757,'amu*angstrom^2'), symmetry=1, barrier=(26.6148,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.878429,0.123973,-0.000234702,2.19354e-07,-7.72647e-11,-72598.4,33.1956], Tmin=(100,'K'), Tmax=(856.766,'K')), NASAPolynomial(coeffs=[10.1545,0.0369166,-2.00531e-05,3.90572e-09,-2.67866e-13,-73184.3,-10.7125], Tmin=(856.766,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-604.945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsCsFHH) + radical(C2CsJO) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[O][C](CF)C(F)(F)C(F)F(3929)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-589.321,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,528,1116,1182,1331,1402,1494,3075,3110,212,367,445,1450,334,575,1197,1424,3202,213.999,214.385,215.813,215.958],'cm^-1')),
        HinderedRotor(inertia=(0.262784,'amu*angstrom^2'), symmetry=1, barrier=(8.69035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05331,'amu*angstrom^2'), symmetry=1, barrier=(34.6188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04972,'amu*angstrom^2'), symmetry=1, barrier=(34.6184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.540729,'amu*angstrom^2'), symmetry=1, barrier=(17.7293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.8197,0.116277,-0.000196984,1.71668e-07,-5.8758e-11,-70715.3,33.2472], Tmin=(100,'K'), Tmax=(794.907,'K')), NASAPolynomial(coeffs=[13.529,0.0327379,-1.79544e-05,3.58118e-09,-2.52069e-13,-72638.3,-30.4309], Tmin=(794.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-589.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = '[O]C(F)(CF)[C](F)C(F)F(3913)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.354789,0.104847,-0.000171754,1.48706e-07,-5.08903e-11,-107907,32.9085], Tmin=(100,'K'), Tmax=(796.16,'K')), NASAPolynomial(coeffs=[11.9084,0.0330773,-1.73981e-05,3.42937e-09,-2.40308e-13,-109538,-21.4368], Tmin=(796.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-898.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(O2sj(Cs-F1sCsCs)) + radical(CsCsCsF1s)"""),
)

species(
    label = '[CH2]C(F)(OF)C(F)(F)[CH]F(3931)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.292063,'amu*angstrom^2'), symmetry=1, barrier=(6.71509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.879356,'amu*angstrom^2'), symmetry=1, barrier=(20.2181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.0228,'amu*angstrom^2'), symmetry=1, barrier=(46.5082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291718,'amu*angstrom^2'), symmetry=1, barrier=(6.70718,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12122,0.126486,-0.000229572,2.0716e-07,-7.15354e-11,-73113.2,31.8223], Tmin=(100,'K'), Tmax=(840.458,'K')), NASAPolynomial(coeffs=[12.9954,0.0337783,-1.85618e-05,3.65073e-09,-2.52715e-13,-74584.7,-28.4663], Tmin=(840.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-609.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + radical(Csj(Cs-F1sO2sCs)(H)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[CH2]C([O])(F)C(F)(F)C(F)F(3932)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]C(F)C(F)(F)[CH]F(3676)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]C(F)(F)C(F)(F)[CH]F(3681)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)(CF)C(F)[C](F)F(3846)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'F[CH]C(F)(F)[C](F)CF(3713)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(137)', '[O]C(F)(CF)[C](F)F(3100)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C(CF)C(F)(F)[CH]F(3923)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2F(46)', 'O=C(F)C(F)(F)[CH]F(3787)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)(CF)C(F)=CF(3056)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[O]C(CF)=C(F)[CH]F(3059)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', 'C=C([O])C(F)(F)[CH]F(3924)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=C([CH]F)C(F)(F)[CH]F(3925)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', '[O]C(F)(CF)[C](F)F(3100)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
    products = ['OC(F)([CH]F)C(F)(F)[CH]F(3926)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)([CH]F)C(F)(F)CF(3927)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)[C](CF)OF(3928)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
    products = ['[O][C](CF)C(F)(F)C(F)F(3929)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH][C](F)C(F)(CF)OF(3930)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
    products = ['[O]C(F)(CF)[C](F)C(F)F(3913)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(F)(OF)C(F)(F)[CH]F(3931)'],
    products = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(CF)C(F)(F)[CH]F(3845)'],
    products = ['[CH2]C([O])(F)C(F)(F)C(F)F(3932)'],
