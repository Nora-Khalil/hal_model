...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(2711)', '[CH]F(137)'],
    products = ['[O]C(F)(F)O[CH]F(2703)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[CH]F(464)'],
    products = ['[O]C(F)(F)O[CH]F(2703)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(2711)', 'CHF(40)'],
    products = ['[O]C(F)(F)O[CH]F(2703)'],
    transitionState = 'TS9',
