...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.584831,'amu*angstrom^2'), symmetry=1, barrier=(13.4464,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0553,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3319.97,'J/mol'), sigma=(5.949e-10,'m'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with fixed Lennard Jones Parameters. This is the fallback method! Try improving transport databases!"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69408,0.0571226,-9.88748e-05,9.04918e-08,-3.21693e-11,11838.4,16.4177], Tmin=(100,'K'), Tmax=(822.3,'K')), NASAPolynomial(coeffs=[6.90619,0.0203029,-1.07944e-05,2.12507e-09,-1.48236e-13,11368.8,-5.35087], Tmin=(822.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.7909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsCsH) + group(CdJ2_singlet-Cds)"""),
)

species(
    label = 'C#CC(F)=CF(1428)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {4,S}
3 C u0 p0 c0 {1,S} {4,D} {5,S}
4 C u0 p0 c0 {2,S} {3,D} {7,S}
...
"""),
    E0 = (-82.5866,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([179,423,629,811,888,194,682,905,1196,1383,3221,2175,525,750,770,3400,2100],'cm^-1')),
        HinderedRotor(inertia=(1.28874,'amu*angstrom^2'), symmetry=1, barrier=(36.206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.85621,0.00964218,0.000117822,-3.04501e-07,2.26357e-10,-9926.12,10.3815], Tmin=(10,'K'), Tmax=(473.148,'K')), NASAPolynomial(coeffs=[5.14319,0.0255316,-1.74176e-05,5.62874e-09,-6.89706e-13,-10347.6,1.96915], Tmin=(473.148,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-82.5866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""C#CC(F)DCF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (932.284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,180,900.902,900.92,900.96,901.001,901.05,901.056,901.097],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (50.0585,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.26862,0.0107893,1.39453e-06,-3.51803e-09,7.41548e-13,112103,16.0512], Tmin=(100,'K'), Tmax=(2156.13,'K')), NASAPolynomial(coeffs=[11.6575,0.00851458,-4.97673e-06,9.11216e-10,-5.71666e-14,106259,-31.4354], Tmin=(2156.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(932.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + group(Cdd-CdsCds) + ring(cyclobutadiene_13)"""),
)
...
"""),
    E0 = (188.281,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,346,659,817,1284,2950,1000,180,931.927,1376.49,1376.77],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26921,0.0322639,-1.94956e-05,2.09376e-09,1.26536e-12,22712.1,17.5599], Tmin=(100,'K'), Tmax=(1148.6,'K')), NASAPolynomial(coeffs=[10.8624,0.0118522,-5.26379e-06,1.04481e-09,-7.59265e-14,20110.5,-27.8197], Tmin=(1148.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCdH)(F1s)(Cd-CdH)_ring) + radical(Cdj(Cs-CsF1sH)(Cd-CsH)_ring) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    ...
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48575,0.0257076,-5.85052e-07,-1.73047e-08,7.96289e-12,30916.4,16.221], Tmin=(100,'K'), Tmax=(1050.19,'K')), NASAPolynomial(coeffs=[10.5512,0.0119841,-5.25975e-06,1.07328e-09,-8.04988e-14,28285,-27.5476], Tmin=(1050.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-CsF1sH)(Cd-CsH)_ring) + radical(Cdj(Cs-CsF1sH)(Cd-CsH)_ring) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (542.466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,180,180,180,1025.5,1645.73,1654.56],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0569,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.87823,0.0310553,-5.3966e-05,6.09904e-08,-2.60864e-11,65277.8,12.6061], Tmin=(100,'K'), Tmax=(801.591,'K')), NASAPolynomial(coeffs=[0.805769,0.0254758,-1.37323e-05,2.75077e-09,-1.94872e-13,66121.5,25.3368], Tmin=(801.591,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(542.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + ring(cyclobutadiene_13) + radical(Cds_S)"""),
)
...
"""),
    E0 = (846.726,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,713.713,1095.86,1095.86,1095.9,1095.92,1095.99,1096,1096.09],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (50.0585,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.70701,-0.00077576,4.26232e-05,-5.10215e-08,1.83814e-11,101855,10.3188], Tmin=(100,'K'), Tmax=(969.9,'K')), NASAPolynomial(coeffs=[5.41446,0.0107649,-3.96375e-06,7.54016e-10,-5.58659e-14,100649,-2.37224], Tmin=(969.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(846.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + ring(cyclobutadiene_13) + radical(C=CCJC=C) + radical(Cds_S)"""),
)
...
"""),
    E0 = (669.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,250,446,589,854,899,180,666.918,1396.08,1397.35,1620.75],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.0489,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.74854,0.0234823,-1.66482e-05,4.27209e-09,-2.9177e-14,80574.3,14.4091], Tmin=(100,'K'), Tmax=(1217.58,'K')), NASAPolynomial(coeffs=[9.37164,0.00720069,-3.33687e-06,6.77787e-10,-4.96655e-14,78555.5,-20.5145], Tmin=(1217.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(669.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(cyclobutadiene-C1) + radical(Cdj(Cd-CdF1s)(Cd-CdH)_ring)"""),
)
...
"""),
    E0 = (146.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([136,307,446,511,682,757,1180,1185,2750,3150,900,1100,180,551.795,1248.89,1254.07,1255.91,1258.82],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20175,0.0327736,-1.72576e-05,-2.31476e-09,3.18611e-12,17652.9,16.5622], Tmin=(100,'K'), Tmax=(1088.71,'K')), NASAPolynomial(coeffs=[11.6725,0.0108836,-4.8797e-06,9.94162e-10,-7.40075e-14,14825.8,-33.4464], Tmin=(1088.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(Cd-CdH)(H)_ring) + radical(Cdj(Cs-CsF1sF1s)(Cd-CsH)_ring)"""),
)

species(
    label = 'F[C]C=C=CF-2(1427)',
    structure = adjacencyList("""1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44619,0.035976,-3.18673e-05,1.43395e-08,-2.67642e-12,16395.3,16.7516], Tmin=(100,'K'), Tmax=(1239.95,'K')), NASAPolynomial(coeffs=[8.49188,0.016473,-8.27396e-06,1.65443e-09,-1.18832e-13,14896,-13.7155], Tmin=(1239.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds) + group(CJ2_singlet-FC)"""),
)

species(
    label = '[C]=CC#C(1429)',
    structure = adjacencyList("""1 C u0 p0 c0 {2,S} {4,D} {5,S}
...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2175,525,750,770,3400,2100],'cm^-1')),
        HinderedRotor(inertia=(1.56364,'amu*angstrom^2'), symmetry=1, barrier=(35.9512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (50.0585,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.84037,0.0286536,-3.56263e-05,2.03368e-08,-2.03576e-12,76596.7,9.88022], Tmin=(100,'K'), Tmax=(585.73,'K')), NASAPolynomial(coeffs=[6.00366,0.0120591,-5.95419e-06,1.1615e-09,-8.16662e-14,76140.2,-4.42212], Tmin=(585.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(636.539,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-CdsCsH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + group(CdJ2_singlet-Cds)"""),
)
...
"""),
    E0 = (536.773,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2175,525,239,401,1367,180],'cm^-1')),
        HinderedRotor(inertia=(0.924444,'amu*angstrom^2'), symmetry=1, barrier=(21.2548,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.0489,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46982,0.0398371,-7.52382e-05,7.43217e-08,-2.78727e-11,64608,13.5077], Tmin=(100,'K'), Tmax=(827.776,'K')), NASAPolynomial(coeffs=[4.48812,0.0167874,-9.37536e-06,1.87228e-09,-1.31286e-13,64729.4,6.90381], Tmin=(827.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(536.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-CdsCsH) + group(Ct-Ct(Cds-Cds)) + group(CtCF) + group(CdJ2_singlet-Cds)"""),
)

species(
    label = '[C]#CC(F)[CH]F(2497)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {4,S}
3 C u0 p0 c0 {1,S} {4,S} {5,S} {7,S}
...
"""),
    E0 = (320.985,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([323,546,651,945,1004,1329,3278,334,575,1197,1424,3202,2175,525,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.256097,'amu*angstrom^2'), symmetry=1, barrier=(5.88817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.65215,'amu*angstrom^2'), symmetry=1, barrier=(60.9782,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57973,0.0616342,-0.000114067,1.06144e-07,-3.70489e-11,38684.7,18.8662], Tmin=(100,'K'), Tmax=(872.819,'K')), NASAPolynomial(coeffs=[6.64537,0.0196706,-9.72869e-06,1.83928e-09,-1.23998e-13,38514.6,-0.792499], Tmin=(872.819,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCtH)(F1s)(H)) + radical(Acetyl)"""),
)

species(
    label = '[C]#C[C](F)CF(2498)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {4,S}
...
"""),
    E0 = (278.255,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,263,352,430,1258,2175,525,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.175199,'amu*angstrom^2'), symmetry=1, barrier=(4.02816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.72912,'amu*angstrom^2'), symmetry=1, barrier=(62.7478,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86111,0.0547958,-9.89237e-05,9.32861e-08,-3.31451e-11,33535.9,20.2245], Tmin=(100,'K'), Tmax=(866.67,'K')), NASAPolynomial(coeffs=[5.45556,0.020862,-1.01739e-05,1.92621e-09,-1.30554e-13,33564.3,7.15565], Tmin=(866.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.255,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(F1s)(Ct-Ct)) + radical(Acetyl)"""),
)

species(
    label = '[CH]=C=C=CF(2499)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {2,S}
2 C u0 p0 c0 {1,S} {3,D} {6,S}
3 C u0 p0 c0 {2,D} {4,D}
...
"""),
    E0 = (307.767,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([113,247,382,1207,3490,540,563.333,586.667,610,1970,2140,3120,650,792.5,1650],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0569,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.84971,0.0112112,0.000104818,-3.31769e-07,2.94037e-10,37017.7,10.0693], Tmin=(10,'K'), Tmax=(406.072,'K')), NASAPolynomial(coeffs=[5.38408,0.0195975,-1.29703e-05,4.12807e-09,-5.02288e-13,36699.3,1.66398], Tmin=(406.072,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(307.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), label="""[CH]DCDCDCF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (183.586,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([322,421,608,607,2175,525,167,640,1190,750,770,3400,2100,1250.16],'cm^-1')),
        HinderedRotor(inertia=(1.57004,'amu*angstrom^2'), symmetry=1, barrier=(36.0983,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0473,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.82926,0.0121238,0.000111438,-3.31812e-07,2.73144e-10,22084.5,11.0742], Tmin=(10,'K'), Tmax=(440.363,'K')), NASAPolynomial(coeffs=[5.95632,0.0210107,-1.49167e-05,4.93942e-09,-6.14454e-13,21623.7,-0.548499], Tmin=(440.363,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(183.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), label="""C#CC(F)D[C]F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = '[C]#CC(F)=CF(2501)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {4,S}
3 C u0 p0 c0 {1,S} {4,D} {5,S}
...
"""),
    E0 = (235.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([179,423,629,811,888,194,682,905,1196,1383,3221,2175,525,304.867],'cm^-1')),
        HinderedRotor(inertia=(0.00181499,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0473,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.70415,0.0256389,1.15272e-07,-5.29586e-08,4.84586e-11,28266,11.1842], Tmin=(10,'K'), Tmax=(481.687,'K')), NASAPolynomial(coeffs=[5.16653,0.0220116,-1.51102e-05,4.81946e-09,-5.79293e-13,28026.3,4.17172], Tmin=(481.687,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(235.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), label="""[C]#CC(F)DCF""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'C#C[C]C(F)F(2502)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {3,S}
3 C u0 p0 c0 {1,S} {2,S} {4,S} {7,S}
...
"""),
    E0 = (182.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([257,409,1143,1361,2944,2175,525,750,770,3400,2100,397.87,397.87,397.87,397.871,397.871],'cm^-1')),
        HinderedRotor(inertia=(0.468162,'amu*angstrom^2'), symmetry=1, barrier=(52.5904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.468163,'amu*angstrom^2'), symmetry=1, barrier=(52.5904,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73881,0.0552265,-8.91512e-05,7.79209e-08,-2.63619e-11,22085,27.2042], Tmin=(100,'K'), Tmax=(869.723,'K')), NASAPolynomial(coeffs=[6.79501,0.0205204,-9.54343e-06,1.7599e-09,-1.17832e-13,21638.6,6.0067], Tmin=(869.723,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(CsJ2_singlet-CsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)

species(
    label = '[CH]C(F)(F)C#C(2503)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {3,S}
3 C u0 p0 c0 {1,S} {2,S} {4,S} {5,S}
4 C u0 p0 c0 {3,S} {6,T}
5 C u0 p1 c0 {3,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.57418,'amu*angstrom^2'), symmetry=1, barrier=(36.1936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58164,'amu*angstrom^2'), symmetry=1, barrier=(36.3651,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58801,0.0587894,-0.000100413,8.77941e-08,-2.94673e-11,20882.1,16.2643], Tmin=(100,'K'), Tmax=(862.554,'K')), NASAPolynomial(coeffs=[8.1607,0.0170873,-8.37679e-06,1.57612e-09,-1.06445e-13,20165.7,-12.0534], Tmin=(862.554,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Ct-CtCs) + group(CsJ2_singlet-CsH) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC(F)[C]F(2504)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {5,S}
3 C u0 p0 c0 {1,S} {4,S} {5,S} {7,S}
4 C u0 p0 c0 {3,S} {6,T}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.60564,'amu*angstrom^2'), symmetry=1, barrier=(36.9167,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60498,'amu*angstrom^2'), symmetry=1, barrier=(36.9016,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89867,0.0488881,-7.09969e-05,5.56664e-08,-1.73407e-11,15341.7,17.17], Tmin=(100,'K'), Tmax=(832.346,'K')), NASAPolynomial(coeffs=[8.42221,0.0154254,-6.88528e-06,1.26688e-09,-8.55611e-14,14328.9,-12.6656], Tmin=(832.346,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Ct-CtCs) + group(CJ2_singlet-FCs) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC#C(2505)',
    structure = adjacencyList("""1 C u0 p0 c0 {2,S} {3,T}
...
"""),
    E0 = (445.117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2100,2250,500,550,750,756.667,763.333,770,3350,3450,2000,2200],'cm^-1')),
        HinderedRotor(inertia=(1.58047,'amu*angstrom^2'), symmetry=1, barrier=(36.3382,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (50.0585,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01412,0.031062,-3.68579e-05,2.21632e-08,-5.1637e-12,53590.1,10.3658], Tmin=(100,'K'), Tmax=(1061.13,'K')), NASAPolynomial(coeffs=[8.53384,0.00648511,-2.11585e-06,3.35827e-10,-2.1154e-14,52206.5,-21.4748], Tmin=(1061.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(445.117,'kJ/mol'), Cp0=(29.1007,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), label="""HCCCCH""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (328.233,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2100,2250,500,550,750,770,3400,2100,239,401,1367,180],'cm^-1')),
        HinderedRotor(inertia=(1.50947,'amu*angstrom^2'), symmetry=1, barrier=(34.7056,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.0489,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.33944,0.011118,9.94889e-05,-2.99927e-07,2.44691e-10,39482.9,8.3993], Tmin=(10,'K'), Tmax=(454.738,'K')), NASAPolynomial(coeffs=[6.26577,0.0148613,-1.01149e-05,3.33877e-09,-4.21438e-13,38911.9,-6.76437], Tmin=(454.738,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(328.233,'kJ/mol'), Cp0=(29.1007,'J/(mol*K)'), CpInf=(137.189,'J/(mol*K)'), label="""C#CC#CF""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction57',
    reactants = ['F[C]C=C=CF-2(1427)'],
    products = ['[C]=CC(F)=CF(893)'],
    transitionState = 'TS57',
    kinetics = Arrhenius(A=(8.88952e+10,'s^-1'), n=0.725184, Ea=(290.904,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction58',
    reactants = ['[C]=CC(F)=CF(893)'],
    products = ['C#CC(F)=CF(1428)'],
    transitionState = 'TS58',
    kinetics = Arrhenius(A=(1.20443e+17,'s^-1'), n=-1.43042, Ea=(42.5712,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH"""),
)

reaction(
    label = 'reaction59',
    reactants = ['F2(78)', '[C]=CC#C(1429)'],
    products = ['[C]=CC(F)=CF(893)'],
    transitionState = 'TS59',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(6.3143,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction60',
    reactants = ['HF(38)', '[C]=CC#CF(1430)'],
    products = ['[C]=CC(F)=CF(893)'],
    transitionState = 'TS60',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(291.164,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(205.348,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction62',
    reactants = ['[C]#CC(F)[CH]F(2497)'],
    products = ['C#CC(F)=CF(1428)'],
...
reaction(
    label = 'reaction69',
    reactants = ['C#C[C]C(F)F(2502)'],
    products = ['C#CC(F)=CF(1428)'],
    transitionState = 'TS69',
    kinetics = Arrhenius(A=(3.82066e+10,'s^-1'), n=0.827, Ea=(109.128,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction70',
    reactants = ['[CH]C(F)(F)C#C(2503)'],
    products = ['C#CC(F)=CF(1428)'],
    transitionState = 'TS70',
    kinetics = Arrhenius(A=(3.82066e+10,'s^-1'), n=0.827, Ea=(112.312,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction71',
    reactants = ['C#CC(F)[C]F(2504)'],
    products = ['C#CC(F)=CF(1428)'],
    transitionState = 'TS71',
    kinetics = Arrhenius(A=(3.33334e+12,'s^-1'), n=-1.40567e-07, Ea=(69.8633,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCH_Ext-3C-R_N-4R!H->Br_4CClFINOPSSi->F',), comment="""Estimated from node CCH_Ext-3C-R_N-4R!H->Br_4CClFINOPSSi->F"""),
)

reaction(
    label = 'reaction72',
    reactants = ['F2(78)', 'C#CC#C(2505)'],
    products = ['C#CC(F)=CF(1428)'],
    transitionState = 'TS72',
    kinetics = Arrhenius(A=(0.000237309,'m^3/(mol*s)'), n=2.63647, Ea=(6.99531,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction73',
    reactants = ['HF(38)', 'C#CC#CF(2506)'],
    products = ['C#CC(F)=CF(1428)'],
    transitionState = 'TS73',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(303.023,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)

reaction(
    label = 'reaction74',
    reactants = ['CHF(40)', 'C#C[C]F(2507)'],
    products = ['C#CC(F)=CF(1428)'],
