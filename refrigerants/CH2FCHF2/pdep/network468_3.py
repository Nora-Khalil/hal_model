...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C=O(1557)'],
    products = ['[O]CC([O])(F)F(2512)'],
    transitionState = 'TS9',
