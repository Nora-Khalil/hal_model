...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]CC(F)=C(F)F(3817)'],
    products = ['[O]CC(F)(F)[C](F)F(9074)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=CC(F)(F)[C](F)F(3965)'],
    products = ['[O]CC(F)(F)[C](F)F(9074)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['O[CH]C(F)(F)[C](F)F(11961)'],
    products = ['[O]CC(F)(F)[C](F)F(9074)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]CC(F)(F)[C](F)F(9074)'],
    products = ['[O]C[C](F)C(F)(F)F(11963)'],
