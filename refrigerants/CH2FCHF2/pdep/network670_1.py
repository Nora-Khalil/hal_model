...
reaction(
    label = 'reaction1',
    reactants = ['O=C=C(F)OC(O)(F)F(3567)'],
...
reaction(
    ...
    products = ['O=C=C(F)OC(O)(F)F(3567)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(F)O[C](F)C=O(3562)'],
    products = ['O=C=C(F)OC(O)(F)F(3567)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(F)OC(F)=[C]O(3598)'],
    products = ['O=C=C(F)OC(O)(F)F(3567)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C=C(F)O[C](O)F(9156)'],
    products = ['O=C=C(F)OC(O)(F)F(3567)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C=[C]OC(O)(F)F(9157)'],
    products = ['O=C=C(F)OC(O)(F)F(3567)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O[C](F)F(2676)', 'O=[C]C(=O)F(1665)'],
    products = ['O=C=C(F)OC(O)(F)F(3567)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(O)(F)F(3033)', 'O=C=[C]F(289)'],
    products = ['O=C=C(F)OC(O)(F)F(3567)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=C=C(F)O[C](F)F(9158)'],
    products = ['O=C=C(F)OC(O)(F)F(3567)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)=C=O(3589)'],
    products = ['O=C=C(F)OC(O)(F)F(3567)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(F)[C-]=[O+]C(O)(F)F(9159)'],
    products = ['O=C=C(F)OC(O)(F)F(3567)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C=C(F)OC(=O)F(9160)'],
    products = ['O=C=C(F)OC(O)(F)F(3567)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C=C(F)OC(O)(F)F(3567)'],
    products = ['CO(13)', 'OC(F)(F)[O+]=[C-]F(4310)'],
