...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C(F)[C](F)F(4087)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C([CH][C](F)F)OF(4143)'],
    products = ['[O]C(=O)C(F)[C](F)F(4087)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', '[O]C([O])=CF(524)'],
    products = ['[O]C(=O)C(F)[C](F)F(4087)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C(F)[C](F)F(4144)'],
    products = ['[O]C(=O)C(F)[C](F)F(4087)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C(F)[C](F)F(4087)'],
    products = ['F[C](F)C(F)[C]1OO1(4145)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(O)[C](F)[C](F)F(4148)'],
    products = ['[O]C(=O)C(F)[C](F)F(4087)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(=O)C=C(F)F(546)'],
    products = ['[O]C(=O)C(F)[C](F)F(4087)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(=O)C(F)=C(F)F(4149)'],
    products = ['[O]C(=O)C(F)[C](F)F(4087)'],
