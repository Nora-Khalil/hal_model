...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[CH]=C[O](3464)'],
    products = ['[CH]=CO[C]=O(9828)'],
    transitionState = 'TS2',
