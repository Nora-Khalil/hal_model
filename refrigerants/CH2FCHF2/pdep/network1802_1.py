...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C]=C(6416)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(4465)', '[CH2]C([O])(F)F(218)'],
    products = ['[CH2]C(F)(F)O[C]=C(6416)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C](F)F(6449)'],
    products = ['[CH2]C(F)(F)O[C]=C(6416)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(=C)F(6450)'],
    products = ['[CH2]C(F)(F)O[C]=C(6416)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC([CH2])(F)F(6451)'],
    products = ['[CH2]C(F)(F)O[C]=C(6416)'],
    transitionState = 'TS8',
