...
reaction(
    label = 'reaction7',
    reactants = ['C2HF(58)', '[CH2][CH2](4469)'],
    products = ['[CH2]CC=[C]F(6481)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]F(252)', '[CH2][CH2](4469)'],
    products = ['[CH2]CC=[C]F(6481)'],
    transitionState = 'TS9',
