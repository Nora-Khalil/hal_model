...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C(F)(F)F(3968)'],
    products = ['F[C](F)CC(F)(F)F(3969)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]CC(F)(F)F-2(12882)'],
    products = ['F[C](F)CC(F)(F)F(3969)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(156)', '[CH2]C(F)(F)F(133)'],
    products = ['F[C](F)CC(F)(F)F(3969)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'FC(F)=CC(F)(F)F(3952)'],
    products = ['F[C](F)CC(F)(F)F(3969)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)C[C](F)F(195)'],
    products = ['F[C](F)CC(F)(F)F(3969)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF3(45)', '[CH2][C](F)F(163)'],
    products = ['F[C](F)CC(F)(F)F(3969)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C](F)[CH]C(F)(F)F(12883)'],
    products = ['F[C](F)CC(F)(F)F(3969)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'F[C](F)C=C(F)F(3983)'],
    products = ['F[C](F)CC(F)(F)F(3969)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[C]CC(F)(F)F(5105)'],
    products = ['F[C](F)CC(F)(F)F(3969)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH2]C(F)(F)F(133)'],
    products = ['F[C](F)CC(F)(F)F(3969)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FC(F)[CH]C(F)(F)F(7119)'],
    products = ['F[C](F)CC(F)(F)F(3969)'],
...
network(
    ...
    reactants = [
        ('CF3(45)', 'CH2CF2(57)'),
        ('CF2(43)', 'CH2F-CF2(68)'),
        ('F(37)', 'F[C](F)C[C](F)F(195)'),
        ('CF2(43)', '[CH2]C(F)(F)F(133)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
