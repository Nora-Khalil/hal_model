...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)C(F)F(4810)'],
    products = ['F[C](F)CC(F)F(2837)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]CC(F)F-2(4844)'],
    products = ['F[C](F)CC(F)F(2837)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(156)', 'CHF2-CH2(64)'],
    products = ['F[C](F)CC(F)F(2837)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC(F)=CC(F)F(2834)'],
    products = ['F[C](F)CC(F)F(2837)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C[C](F)F(157)'],
    products = ['F[C](F)CC(F)F(2837)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(82)', '[CH2][C](F)F(163)'],
    products = ['F[C](F)CC(F)F(2837)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)[CH]C(F)F(4845)'],
    products = ['F[C](F)CC(F)F(2837)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)C[C](F)F(195)'],
    products = ['F[C](F)CC(F)F(2837)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'F[CH]C=C(F)F(4846)'],
    products = ['F[C](F)CC(F)F(2837)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)CC(F)F(2837)'],
    products = ['F[CH]CC(F)(F)F(4031)'],
