...
"""),
    E0 = (-297.989,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([162,485,641,721,926,1292,1380,3063,3000,3100,440,815,1455,1000,562,600,623,1070,1265,1685,370,267.62,267.62,1710.2],'cm^-1')),
        HinderedRotor(inertia=(0.208103,'amu*angstrom^2'), symmetry=1, barrier=(10.5765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208103,'amu*angstrom^2'), symmetry=1, barrier=(10.5765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.728441,'amu*angstrom^2'), symmetry=1, barrier=(37.0219,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00211,0.0703626,-9.01134e-05,6.05008e-08,-1.63594e-11,-35735.6,25.7254], Tmin=(100,'K'), Tmax=(898.029,'K')), NASAPolynomial(coeffs=[11.5321,0.0234591,-1.17674e-05,2.33799e-09,-1.67255e-13,-37626.8,-23.9427], Tmin=(898.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.989,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(CsJOCH3) + radical(Cdj(Cs-F1sO2sH)(Cd-F1sF1s))"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61935,0.0426785,-1.31737e-05,-1.20825e-08,6.75934e-12,-73953.2,19.8138], Tmin=(100,'K'), Tmax=(1095.89,'K')), NASAPolynomial(coeffs=[13.1196,0.0202691,-9.28275e-06,1.8428e-09,-1.34018e-13,-77648.8,-42.0823], Tmin=(1095.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-615.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(CdCFF) + ring(Cyclobutane)"""),
)

species(
    label = 'COC(F)=C=C(F)F(10929)',
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13662,0.0635943,-6.92028e-05,3.81942e-08,-8.42e-12,-65083.5,22.3545], Tmin=(100,'K'), Tmax=(1096.19,'K')), NASAPolynomial(coeffs=[13.1036,0.0199273,-9.45084e-06,1.85557e-09,-1.32631e-13,-67707.2,-36.4785], Tmin=(1096.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-541.989,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(CdCddFO) + group(CdCddFF) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (-184.046,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,94,120,354,641,825,1294,540,610,2055,503.664,505.301],'cm^-1')),
        HinderedRotor(inertia=(0.109283,'amu*angstrom^2'), symmetry=1, barrier=(19.714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109064,'amu*angstrom^2'), symmetry=1, barrier=(19.7118,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19574,0.0516842,-3.45543e-05,-3.64983e-09,8.20928e-12,-22025.5,22.9172], Tmin=(100,'K'), Tmax=(946.146,'K')), NASAPolynomial(coeffs=[17.6943,0.0063402,-1.36055e-06,2.25461e-10,-1.86705e-14,-26240,-61.5385], Tmin=(946.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(CdCddFF) + group(Cdd-CdsCds) + radical(C=COCJ)"""),
)
...
"""),
    E0 = (-349.981,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,3000,3100,440,815,1455,1000,94,120,354,641,825,1294,540,610,2055,180,1102.92,1102.92],'cm^-1')),
        HinderedRotor(inertia=(0.020452,'amu*angstrom^2'), symmetry=1, barrier=(17.6546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00405506,'amu*angstrom^2'), symmetry=1, barrier=(3.50041,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2522,0.061491,-7.08038e-05,4.07556e-08,-9.30502e-12,-41994.9,24.4262], Tmin=(100,'K'), Tmax=(1063.57,'K')), NASAPolynomial(coeffs=[13.0032,0.0172964,-8.47392e-06,1.68586e-09,-1.21355e-13,-44494.5,-32.9897], Tmin=(1063.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-349.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(CdCddFO) + group(CdCddFF) + group(Cdd-CdsCds) + radical(C=COCJ)"""),
)

species(
    label = '[CH2]OC(F)C#CF(10932)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-104.612,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([242,464,653,889,1056,1342,3790,3000,3100,440,815,1455,1000,2175,525,239,401,1367,180,180,773.023],'cm^-1')),
        HinderedRotor(inertia=(0.0106041,'amu*angstrom^2'), symmetry=1, barrier=(4.49426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0105798,'amu*angstrom^2'), symmetry=1, barrier=(4.50691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.38291,'amu*angstrom^2'), symmetry=1, barrier=(54.7879,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35553,0.0629354,-9.36664e-05,7.80188e-08,-2.62185e-11,-12491.2,21.5983], Tmin=(100,'K'), Tmax=(787.863,'K')), NASAPolynomial(coeffs=[8.28866,0.0237898,-1.16247e-05,2.24046e-09,-1.55769e-13,-13461.2,-9.41972], Tmin=(787.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-OsHHH) + group(Ct-CtCs) + group(CtCF) + radical(CsJOCH3)"""),
)

species(
    label = '[CH2]OC(F)=C[C](F)F(10933)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07807,0.0726321,-9.74062e-05,5.86183e-08,-6.95699e-12,-40430,24.668], Tmin=(100,'K'), Tmax=(579.776,'K')), NASAPolynomial(coeffs=[9.67569,0.0268264,-1.38532e-05,2.73797e-09,-1.9332e-13,-41654,-14.0822], Tmin=(579.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-336.962,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(CdCFO) + radical(Csj(Cd-CdH)(F1s)(F1s)) + radical(Cdj(Cs-F1sF1sH)(Cd-F1sO2s))"""),
)

species(
    label = 'FCO[CH][C]=C(F)F(10935)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57141,0.0590556,-8.08875e-05,7.21485e-08,-2.74245e-11,-43669.3,27.6548], Tmin=(100,'K'), Tmax=(731.174,'K')), NASAPolynomial(coeffs=[5.11725,0.0338832,-1.74005e-05,3.46168e-09,-2.46377e-13,-44033.5,12.7139], Tmin=(731.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-363.769,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFHHO) + group(Cds-CdsCsH) + group(CdCFF) + radical(C=CCJ(O)C) + radical(Cdj(Cs-O2sHH)(Cd-F1sF1s))"""),
)

species(
    label = '[CH2]O[CH]C(F)=C(F)F(10936)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10405,0.0709086,-0.00011205,1.00326e-07,-3.55945e-11,-46748.9,26.8537], Tmin=(100,'K'), Tmax=(818.482,'K')), NASAPolynomial(coeffs=[6.86086,0.0304022,-1.51411e-05,2.92377e-09,-2.02663e-13,-47276.8,2.76517], Tmin=(818.482,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(CdCsCdF) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + radical(C=CCJ(O)C) + radical(CsJOCC)"""),
)

species(
    label = 'F[C]=[C]C(F)OCF(10937)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-251.936,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([162,485,641,721,926,1292,1380,3063,548,1085,1183,1302,1466,1520,3060,3119,1685,370,167,640,1190,218.79,218.835,2971.29],'cm^-1')),
        HinderedRotor(inertia=(0.966987,'amu*angstrom^2'), symmetry=1, barrier=(32.8619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25312,'amu*angstrom^2'), symmetry=1, barrier=(8.59093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.967947,'amu*angstrom^2'), symmetry=1, barrier=(32.8629,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38795,0.0654101,-8.08154e-05,4.54224e-08,-3.50138e-12,-30214.5,25.7206], Tmin=(100,'K'), Tmax=(562.31,'K')), NASAPolynomial(coeffs=[7.92057,0.0299753,-1.57273e-05,3.1547e-09,-2.25606e-13,-31123.7,-3.58594], Tmin=(562.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsFHHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sO2sH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH2]OC(F)C(F)=[C]F(10938)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-275.224,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([236,527,855,1015,1182,1348,3236,246,474,533,1155,3000,3100,440,815,1455,1000,167,640,1190,275.153,275.561,276.463,278.797],'cm^-1')),
        HinderedRotor(inertia=(0.00407869,'amu*angstrom^2'), symmetry=1, barrier=(7.81648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.788216,'amu*angstrom^2'), symmetry=1, barrier=(42.5879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00407634,'amu*angstrom^2'), symmetry=1, barrier=(7.81236,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.71318,0.078422,-0.000121808,1.0235e-07,-3.44637e-11,-32989.3,26.024], Tmin=(100,'K'), Tmax=(772.756,'K')), NASAPolynomial(coeffs=[10.0532,0.0263443,-1.34771e-05,2.64386e-09,-1.85482e-13,-34321.4,-15.9077], Tmin=(772.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-275.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-OsHHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CsJOCH3) + radical(Cdj(Cd-CsF1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(F)[C]=C(F)F(10183)'],
    products = ['CH2O(20)', 'FC=C=C(F)F(5206)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C(F)[C]=C(F)F(10152)'],
    products = ['[CH2]OC(F)[C]=C(F)F(10183)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(3960)', '[CH2]O[CH]F(410)'],
    products = ['[CH2]OC(F)[C]=C(F)F(10183)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(20)', 'F[CH][C]=C(F)F(6282)'],
    products = ['[CH2]OC(F)[C]=C(F)F(10183)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C=C(F)F(10930)'],
    products = ['[CH2]OC(F)[C]=C(F)F(10183)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](2653)', 'FC=C=C(F)F(5206)'],
    products = ['[CH2]OC(F)[C]=C(F)F(10183)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=C=C(F)F(10931)'],
    products = ['[CH2]OC(F)[C]=C(F)F(10183)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]OC(F)C#CF(10932)'],
    products = ['[CH2]OC(F)[C]=C(F)F(10183)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](2653)', 'F[CH][C]=C(F)F(6282)'],
    products = ['[CH2]OC(F)[C]=C(F)F(10183)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OC(F)[C]=C(F)F(10183)'],
    products = ['[CH2]OC(F)=C[C](F)F(10933)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OC(F)[C]=C(F)F(10183)'],
    products = ['[CH2]O[CH]C(F)=C(F)F(10936)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]OC(F)C(F)=[C]F(10938)'],
    products = ['[CH2]OC(F)[C]=C(F)F(10183)'],
...
network(
    ...
    isomers = [
        '[CH2]OC(F)[C]=C(F)F(10183)',
    ],
    reactants = [
        ('CH2O(20)', 'FC=C=C(F)F(5206)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
