...
species(
    label = '[CH]C(F)OOOC(F)C(F)(F)F(10956)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-819.387,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([205,317,423,563,514,686,1105,1199,1293,1437,1381,1463,3031,3163,193,295,551,588,656,1146,1192,1350,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.965266,0.111149,-0.000129925,7.37569e-08,-1.65072e-11,-98372.1,38.2494], Tmin=(100,'K'), Tmax=(1085.89,'K')), NASAPolynomial(coeffs=[21.6814,0.0277279,-1.4693e-05,3.01274e-09,-2.20284e-13,-103291,-72.8743], Tmin=(1085.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-819.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'F[CH]OOOC(F)C(F)(F)F(10957)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1019.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,193,295,551,588,656,1146,1192,1350,580,1155,1237,1373,3147,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (181.038,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.179263,0.097123,-0.000122813,7.72211e-08,-1.9294e-11,-122486,34.2735], Tmin=(100,'K'), Tmax=(973.222,'K')), NASAPolynomial(coeffs=[16.9382,0.0267704,-1.43823e-05,2.94638e-09,-2.14728e-13,-125818,-47.8441], Tmin=(973.222,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1019.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(CsFHHO) + radical(CsF1sHO2s)"""),
)
...
species(
    label = 'F[C]C(F)OOOC(F)C(F)(F)F(10958)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
"""),
    E0 = (-1071.19,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([205,317,423,563,514,686,1105,1199,1293,1437,1381,1463,3031,3163,193,295,551,588,656,1146,1192,1350,90,150,250,247,323,377,431,433,1065,1274,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14261,0.11837,-0.000146029,8.7838e-08,-2.09027e-11,-128654,38.815], Tmin=(100,'K'), Tmax=(1021.35,'K')), NASAPolynomial(coeffs=[21.3251,0.0303784,-1.68021e-05,3.48837e-09,-2.56288e-13,-133243,-70.0538], Tmin=(1021.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1071.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCCl_triplet)"""),
)
...
species(
    label = 'FC=COOOC(F)C(F)(F)F(10959)',
...
"""),
    E0 = (-1063.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,193,295,551,588,656,1146,1192,1350,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (194.057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.536284,0.102473,-0.000115929,6.48968e-08,-1.44616e-11,-127805,37.6782], Tmin=(100,'K'), Tmax=(1084.75,'K')), NASAPolynomial(coeffs=[19.1718,0.0298002,-1.54383e-05,3.13739e-09,-2.28203e-13,-132081,-59.0052], Tmin=(1084.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1063.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = '[O]OOC(F)C(F)(F)F(10960)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-852.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,193,295,551,588,656,1146,1192,1350,418.09,418.091,418.095,418.096,418.105,3289.16],'cm^-1')),
        HinderedRotor(inertia=(0.322638,'amu*angstrom^2'), symmetry=1, barrier=(40.0209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000964376,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180265,'amu*angstrom^2'), symmetry=1, barrier=(22.3608,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.021,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.811253,0.0700254,-8.62363e-05,5.14713e-08,-1.19636e-11,-102389,27.3652], Tmin=(100,'K'), Tmax=(1055.68,'K')), NASAPolynomial(coeffs=[15.5467,0.0141914,-6.90113e-06,1.3698e-09,-9.86736e-14,-105500,-44.5228], Tmin=(1055.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-852.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + radical(ROOJ)"""),
)
...
species(
    label = 'FC=C(F)OOOC(F)C(F)(F)F(10961)',
...
"""),
    E0 = (-1251.05,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,193,295,551,588,656,1146,1192,1350,326,540,652,719,1357,194,682,905,1196,1383,3221,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (212.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.890533,0.116995,-0.000159635,1.12401e-07,-3.185e-11,-150299,39.6878], Tmin=(100,'K'), Tmax=(857.634,'K')), NASAPolynomial(coeffs=[16.1777,0.0373903,-2.04077e-05,4.17613e-09,-3.02957e-13,-153227,-40.0356], Tmin=(857.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1251.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)
...
species(
    label = 'F[CH][CH]OOOC(F)C(F)(F)F(10962)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-849.381,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,193,295,551,588,656,1146,1192,1350,3025,407.5,1350,352.5,334,575,1197,1424,3202,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (194.057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.15673,0.122214,-0.000173283,1.25164e-07,-3.59945e-11,-101979,39.9065], Tmin=(100,'K'), Tmax=(849.635,'K')), NASAPolynomial(coeffs=[17.4577,0.0345771,-1.85594e-05,3.7571e-09,-2.70455e-13,-105142,-46.8639], Tmin=(849.635,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-849.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(CsCsFHH) + radical(CCsJOO) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
species(
    label = 'F[CH][C](F)OOOC(F)C(F)(F)F(10964)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
"""),
    E0 = (-1048.57,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,193,295,551,588,656,1146,1192,1350,395,473,707,1436,334,575,1197,1424,3202,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (212.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.67023,0.134416,-0.00019992,1.48551e-07,-4.35889e-11,-125918,42.2517], Tmin=(100,'K'), Tmax=(835.667,'K')), NASAPolynomial(coeffs=[19.4544,0.0332999,-1.84177e-05,3.75281e-09,-2.70433e-13,-129449,-55.8699], Tmin=(835.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1048.57,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
species(
    label = 'F[C]C(F)OOOC(F)C(F)(F)F-2(10966)',
    structure = adjacencyList("""1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
4  F u0 p3 c0 {11,S}
...
"""),
    E0 = (-1089.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,193,295,551,588,656,1146,1192,1350,2750,2850,1437.5,1250,1305,750,350,617,898,1187,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (212.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.07719,0.116841,-0.000144626,8.77531e-08,-2.10768e-11,-130912,39.9035], Tmin=(100,'K'), Tmax=(1012.37,'K')), NASAPolynomial(coeffs=[20.7992,0.0304044,-1.65553e-05,3.41584e-09,-2.50129e-13,-135341,-65.9062], Tmin=(1012.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1089.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'FC[C](F)OOOC(F)C(F)(F)F(10967)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (213.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.29762,0.124561,-0.000162367,1.06582e-07,-2.79101e-11,-149821,40.5659], Tmin=(100,'K'), Tmax=(928.755,'K')), NASAPolynomial(coeffs=[19.2519,0.0360548,-1.94204e-05,3.97112e-09,-2.88692e-13,-153638,-57.0545], Tmin=(928.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1247.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'FCC(F)OOO[C](F)C(F)(F)F(10968)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {12,S}
...
9  O u0 p2 c0 {7,S} {8,S}
10 C u0 p0 c0 {1,S} {7,S} {11,S} {14,S}
11 C u0 p0 c0 {2,S} {10,S} {15,S} {16,S}
12 C u0 p0 c0 {3,S} {4,S} {5,S} {13,S}
13 C u1 p0 c0 {6,S} {8,S} {12,S}
14 H u0 p0 c0 {10,S}
15 H u0 p0 c0 {11,S}
16 H u0 p0 c0 {11,S}
"""),
    ...
    molecularWeight = (213.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.29763,0.124561,-0.000162368,1.06583e-07,-2.79102e-11,-149821,40.5659], Tmin=(100,'K'), Tmax=(928.741,'K')), NASAPolynomial(coeffs=[19.2519,0.0360549,-1.94204e-05,3.97113e-09,-2.88692e-13,-153638,-57.0543], Tmin=(928.741,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1247.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'FC(F)C(F)OOO[CH]C(F)(F)F(10969)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
12 C u0 p0 c0 {4,S} {5,S} {6,S} {13,S}
...
"""),
    ...
    molecularWeight = (213.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26542,0.123988,-0.000160322,1.0485e-07,-2.74232e-11,-151456,39.823], Tmin=(100,'K'), Tmax=(928.768,'K')), NASAPolynomial(coeffs=[18.9196,0.0370551,-1.99213e-05,4.07032e-09,-2.95788e-13,-155205,-56.0664], Tmin=(928.768,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1260.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + radical(CCsJOO)"""),
)

species(
    label = 'F[C](F)C(F)OOOC(F)C(F)F(10970)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {12,S}
...
11 C u0 p0 c0 {2,S} {8,S} {13,S} {15,S}
12 C u0 p0 c0 {3,S} {4,S} {10,S} {16,S}
...
"""),
    E0 = (-1211.16,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,487,638,688,1119,1325,1387,3149,235,523,627,1123,1142,1372,1406,3097,190,488,555,1236,1407,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (213.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.22094,0.120034,-0.000142603,8.32842e-08,-1.93442e-11,-145485,41.7178], Tmin=(100,'K'), Tmax=(1042.5,'K')), NASAPolynomial(coeffs=[21.3007,0.0336194,-1.8266e-05,3.77167e-09,-2.76391e-13,-150180,-67.8736], Tmin=(1042.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1211.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'FC(F)[CH]OOOC(F)C(F)(F)F(10971)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (213.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.3244,0.125488,-0.000166048,1.11362e-07,-2.98222e-11,-151934,40.3297], Tmin=(100,'K'), Tmax=(908.745,'K')), NASAPolynomial(coeffs=[18.8162,0.0368363,-1.97195e-05,4.01528e-09,-2.91e-13,-155595,-54.9103], Tmin=(908.745,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1264.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(CsCsFFH) + radical(CCsJOO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    products = ['[O]OC(F)C(F)(F)F(9646)', 'FC1OC1F(211)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]C(F)(F)F(4171)', 'OOOC(F)[CH]F(4004)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(40.8352,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)
...
reaction(
    ...
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.67164e-06,'m^3/(mol*s)'), n=3.3552, Ea=(260.355,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]C(F)OOOC(F)C(F)(F)F(10956)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]F(137)', 'F[CH]OOOC(F)C(F)(F)F(10957)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C]C(F)OOOC(F)C(F)(F)F(10958)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    products = ['[O]C(F)C(F)(F)F(9666)', 'FC1OOC1F(210)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=COOOC(F)C(F)(F)F(10959)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]OOC(F)C(F)(F)F(10960)', 'CHFCHF[Z](59)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC=C(F)OOOC(F)C(F)(F)F(10961)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[CH]C(F)OOO[CH]C(F)(F)F(5124)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'F[CH]C(F)OOOC(F)[C](F)F(6748)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'F[CH][CH]OOOC(F)C(F)(F)F(10962)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)C(F)(F)F(9666)', '[O]OC(F)[CH]F(131)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(1.8834,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['CF3-CHF(54)', '[O]OOC(F)[CH]F(908)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]OC(F)C(F)(F)F(9646)', '[O]C(F)[CH]F(208)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(1.28312,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['[O]OOC(F)C(F)(F)F(10960)', 'F[CH][CH]F(141)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CF3(45)', 'F[CH]OOOC(F)[CH]F(5165)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'F[CH]C(F)OOO[C](F)C(F)(F)F(10963)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'F[CH][C](F)OOOC(F)C(F)(F)F(10964)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'F[CH]C(F)OOOC=C(F)F(5126)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(5)', 'F[C]C(F)OOOC(F)C(F)(F)F-2(10966)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    products = ['FC[C](F)OOOC(F)C(F)(F)F(10967)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    products = ['FCC(F)OOO[C](F)C(F)(F)F(10968)'],
...
reaction(
    label = 'reaction29',
    reactants = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    products = ['FC(F)C(F)OOO[CH]C(F)(F)F(10969)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(189.437,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction30',
    reactants = ['F[C](F)C(F)OOOC(F)C(F)F(10970)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    transitionState = 'TS30',
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(182.852,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction31',
    reactants = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    products = ['FC(F)[CH]OOOC(F)C(F)(F)F(10971)'],
...
network(
    ...
    isomers = [
        'F[CH]C(F)OOOC(F)C(F)(F)F(10950)',
    ],
    reactants = [
        ('[O]OC(F)C(F)(F)F(9646)', 'FC1OC1F(211)'),
        ('[O]OC(F)C(F)(F)F(9646)', '[O]C(F)[CH]F(208)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
