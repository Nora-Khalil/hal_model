...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21656,0.0706229,-0.000118127,1.14983e-07,-4.401e-11,-49376.4,22.795], Tmin=(100,'K'), Tmax=(800.947,'K')), NASAPolynomial(coeffs=[4.30521,0.0365815,-1.95098e-05,3.87975e-09,-2.73529e-13,-49274,12.3073], Tmin=(800.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-411.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = 'OCO[C](F)[CH]F(3451)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.205536,0.0768861,-9.01056e-05,4.43188e-08,-6.45504e-12,-52071.3,26.4908], Tmin=(100,'K'), Tmax=(923.432,'K')), NASAPolynomial(coeffs=[21.036,0.0041286,-3.02884e-07,-2.28926e-11,2.09709e-15,-56663.3,-76.3786], Tmin=(923.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-434.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2][C](F)OCOF(3452)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-111.758,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,3000,3100,440,815,1455,1000,355.802,356.914,357.457,357.91],'cm^-1')),
        HinderedRotor(inertia=(0.206565,'amu*angstrom^2'), symmetry=1, barrier=(18.6905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205983,'amu*angstrom^2'), symmetry=1, barrier=(18.69,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207408,'amu*angstrom^2'), symmetry=1, barrier=(18.6878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205941,'amu*angstrom^2'), symmetry=1, barrier=(18.6896,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.130028,0.074937,-8.72257e-05,4.72541e-08,-9.6787e-12,-13293.4,28.1113], Tmin=(100,'K'), Tmax=(1242.92,'K')), NASAPolynomial(coeffs=[21.2574,0.00538619,-1.40887e-06,2.15803e-10,-1.45753e-14,-18424.9,-77.9262], Tmin=(1242.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)(F)OC[O](3453)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38017,0.0573661,-5.44307e-05,2.57429e-08,-4.90619e-12,-53392.4,22.7669], Tmin=(100,'K'), Tmax=(1246.79,'K')), NASAPolynomial(coeffs=[12.8912,0.0204356,-9.99951e-06,1.985e-09,-1.42315e-13,-56262.7,-35.306], Tmin=(1246.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-444.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](2715)', 'F[C]CF-2(3008)'],
    products = ['[O]CO[C](F)CF(3367)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)OC[O](3446)'],
    products = ['[O]CO[C](F)CF(3367)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CO[C](F)CF(3265)'],
    products = ['[O]CO[C](F)CF(3367)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C[O](2715)', 'F[C]CF(126)'],
    products = ['[O]CO[C](F)CF(3367)'],
