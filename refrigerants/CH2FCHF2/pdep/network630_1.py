...
"""),
    E0 = (-202.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,308.752,308.79,308.81,308.822,308.823,2424.52],'cm^-1')),
        HinderedRotor(inertia=(0.00176877,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263804,'amu*angstrom^2'), symmetry=1, barrier=(17.8536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.523879,'amu*angstrom^2'), symmetry=1, barrier=(35.4556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04089,0.0691812,-0.000103781,7.73802e-08,-2.26034e-11,-18631.5,25.958], Tmin=(100,'K'), Tmax=(842.525,'K')), NASAPolynomial(coeffs=[12.3737,0.0153768,-7.98951e-06,1.58239e-09,-1.12045e-13,-20541.1,-26.7744], Tmin=(842.525,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-155.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2][C](F)OOOF(3492)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (129.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,395,473,707,1436,3000,3100,440,815,1455,1000,180,180,770.889,2352.05],'cm^-1')),
        HinderedRotor(inertia=(0.763425,'amu*angstrom^2'), symmetry=1, barrier=(17.5526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.67893,'amu*angstrom^2'), symmetry=1, barrier=(33.2255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0414662,'amu*angstrom^2'), symmetry=1, barrier=(17.5663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00845369,'amu*angstrom^2'), symmetry=1, barrier=(33.2118,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30084,0.0628073,-8.61928e-05,5.90629e-08,-1.59656e-11,15611.7,26.7443], Tmin=(100,'K'), Tmax=(905.825,'K')), NASAPolynomial(coeffs=[11.9702,0.0156928,-8.17366e-06,1.64267e-09,-1.18094e-13,13678.8,-23.674], Tmin=(905.825,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2sFO) + group(CsCFHO) + group(Cs-CsHHH) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(F)(F)OO[O](3493)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {6,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](129)', 'F[C]CF-2(3036)'],
    products = ['[O]OO[C](F)CF(913)'],
    transitionState = 'TS2',
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.6844e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(62.3774,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[O]O[O](129)', 'F[C]CF(126)'],
    products = ['[O]OO[C](F)CF(913)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(257654,'m^3/(mol*s)'), n=0.469398, Ea=(2.46435,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['[O]OOC(F)[CH]F(908)'],
    products = ['[O]OO[C](F)CF(913)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OOO[C](F)[CH]F(914)'],
    products = ['[O]OO[C](F)CF(913)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.0378492,'s^-1'), n=3.26, Ea=(26.8822,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5Hall;C_rad_out_1H;XH_out] for rate rule [R5HJ_1;C_rad_out_1H;O_H_out]
Euclidian distance = 1.4142135623730951
family: intra_H_migration"""),
)
