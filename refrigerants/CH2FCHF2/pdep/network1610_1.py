...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CO[C](F)OF(5645)'],
    products = ['O=COC(F)(F)OF(5367)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)OC=O(4690)'],
    products = ['O=COC(F)(F)OF(5367)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(2677)', '[O]C=O(339)'],
    products = ['O=COC(F)(F)OF(5367)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)OF(5153)', 'HCO(15)'],
    products = ['O=COC(F)(F)OF(5367)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(128)', 'O=CO[C](F)F(2833)'],
    products = ['O=COC(F)(F)OF(5367)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC(F)(F)OF(5651)'],
    products = ['O=COC(F)(F)OF(5367)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(78)', 'O=COC(=O)F(1235)'],
    products = ['O=COC(F)(F)OF(5367)'],
