...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.89979,0.00596573,0.000101988,-2.11392e-07,1.28902e-10,-83508.5,10.7235], Tmin=(10,'K'), Tmax=(559.279,'K')), NASAPolynomial(coeffs=[3.81617,0.0291105,-2.05581e-05,6.76682e-09,-8.36615e-13,-83851.8,7.92577], Tmin=(559.279,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-694.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""OC1OC1(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'OOC(O)=C(F)F(4065)',
    structure = adjacencyList("""1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08007,0.0722777,-0.000129105,1.16867e-07,-4.05595e-11,-66856,22.0662], Tmin=(100,'K'), Tmax=(842.367,'K')), NASAPolynomial(coeffs=[8.56907,0.0214548,-1.14294e-05,2.22915e-09,-1.53834e-13,-67576.2,-9.56532], Tmin=(842.367,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-404.677,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,492.5,1135,1000,350,440,435,1725,182,240,577,636,1210,1413],'cm^-1')),
        HinderedRotor(inertia=(0.295167,'amu*angstrom^2'), symmetry=1, barrier=(6.78646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.294996,'amu*angstrom^2'), symmetry=1, barrier=(6.78253,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33632,0.068768,-0.000134022,1.26249e-07,-4.42078e-11,-48585.2,21.9057], Tmin=(100,'K'), Tmax=(876.581,'K')), NASAPolynomial(coeffs=[6.96276,0.0198259,-1.0457e-05,1.9929e-09,-1.34083e-13,-48677.7,0.601522], Tmin=(876.581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-404.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(O)[C](F)F(4014)'],
    products = ['HO2(11)', 'O=C[C](F)F(234)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]OC(O)[C](F)F(4014)'],
    products = ['O=O(207)', 'OC=C(F)F(3558)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(18.7328,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(O)[C](F)F(4062)'],
    products = ['[O]OC(O)[C](F)F(4014)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', '[O]O[CH]O(2717)'],
    products = ['[O]OC(O)[C](F)F(4014)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', 'OC=C(F)F(3558)'],
    products = ['[O]OC(O)[C](F)F(4014)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(10834.1,'m^3/(mol*s)'), n=0.762578, Ea=(75.5789,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R
Multiplied by reaction path degeneracy 2.0
Ea raised from 74.6 to 75.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['OH(7)', '[O]OC=C(F)F(233)'],
    products = ['[O]OC(O)[C](F)F(4014)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]OC(O)=C(F)F(4066)'],
    products = ['[O]OC(O)[C](F)F(4014)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O2(2)', 'O[CH][C](F)F(3554)'],
    products = ['[O]OC(O)[C](F)F(4014)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[O]O[CH]O(2717)'],
    products = ['[O]OC(O)[C](F)F(4014)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]OC(O)[C](F)F(4014)'],
    products = ['OH(7)', 'O=C(O)[C](F)F(4068)'],
...
network(
    label = 'PDepNetwork #939',
    isomers = [
        '[O]OC(O)[C](F)F(4014)',
    ],
    reactants = [
        ('HO2(11)', 'O=C[C](F)F(234)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
