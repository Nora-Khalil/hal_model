...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'O=C=C(F)OO(2244)'],
    products = ['COOC(F)=C=O(6178)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3O(27)', 'O=[C]C(=O)F(1543)'],
    products = ['COOC(F)=C=O(6178)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[O]OC(F)=C=O(2248)'],
    products = ['COOC(F)=C=O(6178)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CO[O](2900)', 'O=C=[C]F(289)'],
    products = ['COOC(F)=C=O(6178)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]OOC(F)=C=O(2246)'],
    products = ['COOC(F)=C=O(6178)'],
