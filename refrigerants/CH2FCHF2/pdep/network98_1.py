...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[O]C(F)[CH]F(208)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]C(F)[CH]F(136)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(388)', 'CHFCHF[Z](59)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)C(F)=CF(396)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CC(F)[CH]F(397)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHFO(47)', 'F[CH][CH]F(141)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)C(F)[CH]F(398)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][CH]F(388)', 'F[CH][CH]F(141)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[O]C=C[CH]F(399)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C=C(F)[CH]F(400)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=C(F)[CH][CH]F(401)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', '[O]C(F)[CH]F(208)'],
    products = ['[O]C(F)C(F)[CH]F(369)'],
