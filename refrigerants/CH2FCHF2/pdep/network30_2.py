...
"""),
    E0 = (109.045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,3025,407.5,1350,352.5,334,575,1197,1424,3202],'cm^-1')),
        HinderedRotor(inertia=(1.75111,'amu*angstrom^2'), symmetry=1, barrier=(40.2614,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51836,0.0667183,-0.000134893,1.34822e-07,-4.9763e-11,13192.8,21.5056], Tmin=(100,'K'), Tmax=(858.584,'K')), NASAPolynomial(coeffs=[4.30393,0.0256079,-1.39214e-05,2.72731e-09,-1.87716e-13,13751.4,14.5302], Tmin=(858.584,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJOO) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-172.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,505,655,1117,1193,1185,1289,1311,1435,3104,3190,296.862],'cm^-1')),
        HinderedRotor(inertia=(0.510297,'amu*angstrom^2'), symmetry=1, barrier=(11.7327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.99439,'amu*angstrom^2'), symmetry=1, barrier=(45.8549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.99439,'amu*angstrom^2'), symmetry=1, barrier=(45.8548,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06054,0.0476916,-6.60568e-05,5.26177e-08,-1.76133e-11,-20724.7,19.7767], Tmin=(100,'K'), Tmax=(719.013,'K')), NASAPolynomial(coeffs=[6.72091,0.0217668,-1.19763e-05,2.47773e-09,-1.80868e-13,-21394.9,-1.16992], Tmin=(719.013,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsF1sHO2s) + radical(CsF1sHO2s)"""),
)
...
"""),
    E0 = (-241.031,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,395,473,707,1436,180,594.126,1209.79,1210.2],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.91615,0.00509704,9.05989e-05,-1.90779e-07,1.18975e-10,-28984.6,11.8234], Tmin=(10,'K'), Tmax=(540.14,'K')), NASAPolynomial(coeffs=[3.4463,0.0265749,-1.90293e-05,6.22077e-09,-7.58659e-13,-29196.4,11.3704], Tmin=(540.14,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-241.031,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), label="""F[C]1OOC1F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]OC(F)[CH]F(131)'],
    products = ['O=O(207)', 'CHFCHF[Z](59)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(4.6417,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission
Ea raised from 0.0 to 4.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(F)[CH]F(208)'],
    products = ['[O]OC(F)[CH]F(131)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', '[O]O[CH]F(209)'],
    products = ['[O]OC(F)[CH]F(131)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]OC=CF(213)'],
    products = ['[O]OC(F)[CH]F(131)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(52.7481,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CHFCHF[Z](59)'],
    products = ['[O]OC(F)[CH]F(131)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(21668.1,'m^3/(mol*s)'), n=0.762578, Ea=(89.6699,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R
Multiplied by reaction path degeneracy 4.0
Ea raised from 88.6 to 89.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)=CF(214)'],
    products = ['[O]OC(F)[CH]F(131)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH][CH]OOF(216)'],
    products = ['[O]OC(F)[CH]F(131)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(93.5523,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[O]OC(F)[CH]F(131)'],
    products = ['[O]O[CH]C(F)F(217)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(5.38157e+14,'s^-1'), n=-0.447076, Ea=(183.976,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.08474952276158404, var=26.08378321593064, Tref=1000.0, N=4, data_mean=0.0, correlation='R2F_Ext-1R!H-R',), comment="""Estimated from node R2F_Ext-1R!H-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'FC1OO1(314)'],
    products = ['FC1OOC1F(210)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(4.25106e-07,'m^3/(mol*s)'), n=3.34134, Ea=(136.526,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction17',
    reactants = ['FC1OOC1F(210)'],
    products = ['FC(F)C1OO1(315)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHFO(47)', 'CHFO(47)'],
    products = ['FC1OOC1F(210)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.36636e-32,'m^3/(mol*s)'), n=10.9581, Ea=(342.467,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1COCSCdCdd->Cd',), comment="""Estimated from node Root_N-1COCSCdCdd->Cd
Ea raised from 337.3 to 342.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction19',
    reactants = ['F[CH]OO[CH]F(316)'],
    products = ['FC1OOC1F(210)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(209.746,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)
