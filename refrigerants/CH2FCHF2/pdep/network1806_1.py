...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0937054,'amu*angstrom^2'), symmetry=1, barrier=(2.15447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.668169,'amu*angstrom^2'), symmetry=1, barrier=(15.3625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.54626,'amu*angstrom^2'), symmetry=1, barrier=(58.5435,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71768,0.0544621,-7.34732e-05,5.47188e-08,-1.66877e-11,-3679.7,25.9039], Tmin=(100,'K'), Tmax=(795.032,'K')), NASAPolynomial(coeffs=[8.3242,0.0212232,-1.07611e-05,2.13228e-09,-1.51728e-13,-4730.18,-4.4534], Tmin=(795.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-O2s)) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01232,'amu*angstrom^2'), symmetry=1, barrier=(23.2752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.4249,'amu*angstrom^2'), symmetry=1, barrier=(32.7612,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37353,0.0570477,-6.65547e-05,3.80516e-08,-8.51475e-12,-2778.52,24.4059], Tmin=(100,'K'), Tmax=(1092.89,'K')), NASAPolynomial(coeffs=[13.3975,0.0130397,-6.15321e-06,1.20636e-09,-8.63473e-14,-5406.69,-34.6707], Tmin=(1092.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.8941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-O2s)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OOC(F)F(6821)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.08433,'amu*angstrom^2'), symmetry=1, barrier=(47.9228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.474248,'amu*angstrom^2'), symmetry=1, barrier=(10.9039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471895,'amu*angstrom^2'), symmetry=1, barrier=(10.8498,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43284,0.0623309,-0.000101529,8.97544e-08,-3.14699e-11,-173.41,26.8197], Tmin=(100,'K'), Tmax=(797.005,'K')), NASAPolynomial(coeffs=[7.79733,0.0225247,-1.18117e-05,2.3286e-09,-1.63314e-13,-938.145,-0.874317], Tmin=(797.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-2.16337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', 'C=[C]O[O](6818)'],
    products = ['C=[C]OO[C](F)F(6191)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(219)', '[C]=C(4368)'],
    products = ['C=[C]OO[C](F)F(6191)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
