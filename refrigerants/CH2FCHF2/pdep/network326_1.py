...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=C(F)C=C[C]F(1839)'],
    products = ['[O]C(C=[C]F)C(=O)F(1583)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(C=[C]F)[C](O)F(1846)'],
    products = ['[O]C(C=[C]F)C(=O)F(1583)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(F)C(=O)C=[C]F(1847)'],
    products = ['[O]C(C=[C]F)C(=O)F(1583)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(C#CF)C(=O)F(1848)'],
    products = ['[O]C(C=[C]F)C(=O)F(1583)'],
