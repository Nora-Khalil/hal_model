...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.926895,'amu*angstrom^2'), symmetry=1, barrier=(21.3111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.930811,'amu*angstrom^2'), symmetry=1, barrier=(21.4012,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.930052,'amu*angstrom^2'), symmetry=1, barrier=(21.3837,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.608625,0.0748253,-9.69616e-05,6.17315e-08,-1.52567e-11,-17263.6,24.1255], Tmin=(100,'K'), Tmax=(997.133,'K')), NASAPolynomial(coeffs=[15.6068,0.0146601,-6.45438e-06,1.21991e-09,-8.53675e-14,-20254.7,-48.1891], Tmin=(997.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sCdH)(F1s)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])C(F)CF(6850)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.813321,'amu*angstrom^2'), symmetry=1, barrier=(18.6998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.812594,'amu*angstrom^2'), symmetry=1, barrier=(18.6831,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27122,0.0626872,-7.33433e-05,4.53249e-08,-1.13097e-11,-24046.4,22.3248], Tmin=(100,'K'), Tmax=(969.645,'K')), NASAPolynomial(coeffs=[11.142,0.0219674,-1.03503e-05,2.01424e-09,-1.42885e-13,-25960.6,-24.9916], Tmin=(969.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(=C[CH]F)OF(6851)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-261.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,1855,455,950,256.427,256.427],'cm^-1')),
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', '[CH2]C(=O)[CH]F(6840)'],
    products = ['C=C([O])C(F)[CH]F(3105)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C(F)[CH]F(6841)'],
    products = ['C=C([O])C(F)[CH]F(3105)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['C=C([O])C(F)[CH]F(3105)'],
    products = ['[CH2]C1([O])C(F)C1F(6845)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C=CF(6846)'],
    products = ['C=C([O])C(F)[CH]F(3105)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHFCHF[Z](59)', '[CH2][C]=O(4470)'],
    products = ['C=C([O])C(F)[CH]F(3105)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C([O])C(F)=CF(6847)'],
    products = ['C=C([O])C(F)[CH]F(3105)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH][CH]F(141)', '[CH2][C]=O(4470)'],
    products = ['C=C([O])C(F)[CH]F(3105)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C(=O)[CH]F(6840)'],
    products = ['C=C([O])C(F)[CH]F(3105)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=C([O])C(F)[CH]F(3105)'],
    products = ['[CH2]C(O)=C(F)[CH]F(6848)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(O)C(F)[CH]F(6849)'],
    products = ['C=C([O])C(F)[CH]F(3105)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(=C[CH]F)OF(6851)'],
    products = ['C=C([O])C(F)[CH]F(3105)'],
