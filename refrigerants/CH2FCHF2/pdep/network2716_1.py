...
species(
    label = 'F[CH]C(F)(F)C(F)[C]=C(F)F(9801)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH]C(F)=C([CH]F)C(F)(F)F(10047)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'F[CH]C(F)(F)[C]=C(F)F(10048)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'FC(F)=C1C(F)C(F)C1(F)F(9988)',
...
species(
    label = 'F[CH]C(F)(F)[C]1C(F)C1(F)F(10049)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.033084,0.0983455,-0.000158831,1.42144e-07,-5.07039e-11,-105565,31.402], Tmin=(100,'K'), Tmax=(790.569,'K')), NASAPolynomial(coeffs=[9.12784,0.0386689,-2.03187e-05,4.01959e-09,-2.82802e-13,-106597,-8.00761], Tmin=(790.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-878.851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFF) + group(CsCsCsFF) + group(CsCsCsFH) + group(CsCsFHH) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F))"""),
)
...
species(
    label = 'F[CH]C(C(F)=CF)=C(F)F(9879)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C]C(=CF)C(F)(F)C(F)F(10051)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-858.345,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,235,523,627,1123,1142,1372,1406,3097,350,440,435,1725,194,682,905,1196,1383,3221,185.239,187.729,190.031,1795.01,1796.83],'cm^-1')),
        HinderedRotor(inertia=(0.362498,'amu*angstrom^2'), symmetry=1, barrier=(9.97641,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399909,'amu*angstrom^2'), symmetry=1, barrier=(10.038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09138,'amu*angstrom^2'), symmetry=1, barrier=(31.1293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.628405,0.112666,-0.000192379,1.70959e-07,-5.95347e-11,-103079,31.9243], Tmin=(100,'K'), Tmax=(803.504,'K')), NASAPolynomial(coeffs=[11.9846,0.0348265,-1.89736e-05,3.77559e-09,-2.6532e-13,-104620,-23.144], Tmin=(803.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-858.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(CsCCl_triplet)"""),
)

species(
    label = 'F[C]=C(C(F)F)C(F)(F)[CH]F(10052)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-786.305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,334,575,1197,1424,3202,167,640,1190,180,2370.42],'cm^-1')),
        HinderedRotor(inertia=(0.353146,'amu*angstrom^2'), symmetry=1, barrier=(8.11951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.352011,'amu*angstrom^2'), symmetry=1, barrier=(8.09344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33127,'amu*angstrom^2'), symmetry=1, barrier=(30.6086,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.627828,0.112021,-0.000189054,1.6601e-07,-5.73052e-11,-94413.8,35.7589], Tmin=(100,'K'), Tmax=(797.711,'K')), NASAPolynomial(coeffs=[12.4907,0.0337264,-1.8299e-05,3.64033e-09,-2.55982e-13,-96108.6,-22.0697], Tmin=(797.711,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-786.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Csj(Cs-F1sF1sCd)(F1s)(H)) + radical(Cdj(Cd-CsCs)(F1s))"""),
)
...
species(
    label = 'FC=C1C(F)(F)C(F)C1(F)F(9971)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)[C]1C(F)C(F)C1(F)F(10053)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.202998,0.0911659,-0.000136393,1.16005e-07,-4.0345e-11,-103409,31.9257], Tmin=(100,'K'), Tmax=(745.425,'K')), NASAPolynomial(coeffs=[9.56981,0.036868,-1.90111e-05,3.76431e-09,-2.66319e-13,-104693,-9.75984], Tmin=(745.425,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-860.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFF) + group(CsCsCsFH) + group(CsCsCsFH) + group(CsCsFFH) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(F1s)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
species(
    label = 'F[C]C(=C(F)F)C(F)(F)CF(10054)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-849.851,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,528,1116,1182,1331,1402,1494,3075,3110,350,440,435,1725,182,240,577,636,1210,1413,229.843,229.87,229.977,230.029,1706.51],'cm^-1')),
        HinderedRotor(inertia=(0.00318843,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26808,'amu*angstrom^2'), symmetry=1, barrier=(10.053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.799446,'amu*angstrom^2'), symmetry=1, barrier=(29.9773,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.591206,0.111349,-0.000187535,1.65718e-07,-5.77912e-11,-102058,31.6144], Tmin=(100,'K'), Tmax=(788.525,'K')), NASAPolynomial(coeffs=[12.0638,0.0350007,-1.91824e-05,3.83819e-09,-2.71059e-13,-103676,-24.0366], Tmin=(788.525,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-849.851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]C(=C(F)F)C(F)(F)C(F)F(10055)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.166683,'amu*angstrom^2'), symmetry=1, barrier=(3.83238,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.630472,'amu*angstrom^2'), symmetry=1, barrier=(14.4958,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.431269,0.105547,-0.000161236,1.2764e-07,-4.024e-11,-101665,33.7332], Tmin=(100,'K'), Tmax=(777.34,'K')), NASAPolynomial(coeffs=[14.1749,0.0303841,-1.6192e-05,3.24218e-09,-2.3075e-13,-103935,-33.0536], Tmin=(777.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-846.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsCdFFF) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sCd)(F1s)(H)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[CH]C(F)(F)C(F)[C]=C(F)F(9801)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
    products = ['F[CH]C(F)=C([CH]F)C(F)(F)F(10047)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(137)', 'F[CH]C([C](F)F)=C(F)F(9960)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(137)', 'F[CH]C(F)(F)[C]=C(F)F(10048)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
    products = ['FC(F)=C1C(F)C(F)C1(F)F(9988)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
    products = ['F[CH]C(F)(F)[C]1C(F)C1(F)F(10049)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
    products = ['F[CH][C]1C(F)(F)C(F)C1(F)F(10050)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[CH]C(C(F)=CF)=C(F)F(9879)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'F[CH]C([C](F)F)=C(F)F(9960)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[CH]C(F)(F)[C]=C(F)F(10048)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
    products = ['F[CH]C(F)=C([C](F)F)C(F)F(7337)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C]C(=CF)C(F)(F)C(F)F(10051)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C]=C(C(F)F)C(F)(F)[CH]F(10052)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]F(156)', 'F[CH]C(F)(F)[C]=CF(3878)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
    products = ['FC=C1C(F)(F)C(F)C1(F)F(9971)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
    products = ['F[C](F)[C]1C(F)C(F)C1(F)F(10053)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CF2(43)', 'F[CH]C(F)(F)[C]=CF(3878)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F[C]C(=C(F)F)C(F)(F)CF(10054)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
    products = ['[CH]C(=C(F)F)C(F)(F)C(F)F(10055)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=C(C(F)(F)F)C(F)(F)[CH]F(10056)'],
    products = ['F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)'],
...
network(
    label = 'PDepNetwork #2716',
    isomers = [
        'F[CH]C(=C(F)F)C(F)(F)[CH]F(7338)',
    ],
    reactants = [
