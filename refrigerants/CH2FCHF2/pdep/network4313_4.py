...
reaction(
    label = 'reaction43',
    reactants = ['F(37)', 'F[C]1CC1(F)F(12740)'],
    products = ['FC1(F)CC1(F)F(3948)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction44',
    reactants = ['H(5)', 'FC1(F)[CH]C1(F)F(14986)'],
    products = ['FC1(F)CC1(F)F(3948)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction45',
    reactants = ['F2(78)', 'FC1=C(F)C1(14987)'],
    products = ['FC1(F)CC1(F)F(3948)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction46',
    reactants = ['HF(38)', 'FC1=CC1(F)F(3949)'],
    products = ['FC1(F)CC1(F)F(3948)'],
    transitionState = 'TS8',
...
network(
    ...
    reactants = [
        ('CF2(43)', 'CH2CF2(57)'),
        ('CH2(S)(25)', 'CF2CF2(61)'),
        ('HF(38)', 'F[C]C=C(F)F-2(6976)'),
        ('CHF(40)', 'CHFCF2(55)'),
        ('F(37)', 'F[CH]C=C(F)F(4846)'),
        ('CHF2(82)', 'CF2CH(73)'),
        ('HF(38)', 'FC=C=C(F)F(5101)'),
        ('CF2(43)', '[CH]C(F)F(130)'),
    ],
    bathGas = {
        'N2': 0.5,
