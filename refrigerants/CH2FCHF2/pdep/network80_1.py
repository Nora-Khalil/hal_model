...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C(F)[CH]F(208)'],
    products = ['O=[C]OC(F)[CH]F(347)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'O=[C]O[CH]F(515)'],
    products = ['O=[C]OC(F)[CH]F(347)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C(F)[CH]F(208)'],
    products = ['O=[C]OC(F)[CH]F(347)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', 'O=[C]O[CH]F(515)'],
    products = ['O=[C]OC(F)[CH]F(347)'],
