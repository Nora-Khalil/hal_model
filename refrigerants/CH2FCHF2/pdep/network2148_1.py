...
"""),
    E0 = (286.803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([293,496,537,1218,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,287.835,289.692,2274.17],'cm^-1')),
        HinderedRotor(inertia=(0.151724,'amu*angstrom^2'), symmetry=1, barrier=(8.96273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.631553,'amu*angstrom^2'), symmetry=1, barrier=(37.4353,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92826,0.0495558,-7.09787e-05,5.97839e-08,-2.06696e-11,34565.3,23.1269], Tmin=(100,'K'), Tmax=(771.795,'K')), NASAPolynomial(coeffs=[6.61007,0.0219217,-1.07225e-05,2.07864e-09,-1.45362e-13,33943,2.40277], Tmin=(771.795,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (294.155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([293,496,537,1218,3010,987.5,1337.5,450,1655,3115,3125,620,680,785,800,1600,1700,273.42,273.483],'cm^-1')),
        HinderedRotor(inertia=(0.282997,'amu*angstrom^2'), symmetry=1, barrier=(15.0152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551348,'amu*angstrom^2'), symmetry=1, barrier=(29.2489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7112,0.0504796,-5.74283e-05,3.32125e-08,-7.61547e-12,35461.1,21.1833], Tmin=(100,'K'), Tmax=(1061.36,'K')), NASAPolynomial(coeffs=[11.2609,0.0144882,-6.56092e-06,1.2606e-09,-8.9085e-14,33434,-25.4569], Tmin=(1061.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = 'C#CO[C]([CH2])F(8088)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {3,S} {5,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(323)', '[C]=C(4368)'],
    products = ['[CH]=C(F)O[C]=C(8059)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)OC#C(8050)'],
    products = ['[CH]=C(F)O[C]=C(8059)'],
    transitionState = 'TS7',
