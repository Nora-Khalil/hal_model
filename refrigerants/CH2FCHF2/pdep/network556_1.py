...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.414845,0.107072,-0.000181779,1.58857e-07,-5.38537e-11,-84363.8,30.6244], Tmin=(100,'K'), Tmax=(835.127,'K')), NASAPolynomial(coeffs=[12.0335,0.0311112,-1.60001e-05,3.0948e-09,-2.13302e-13,-85873.3,-23.7779], Tmin=(835.127,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-702.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs))"""),
)

species(
    label = 'F[CH]C(F)OC[C](F)F(3122)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.122767,0.0991495,-0.000159964,1.3808e-07,-4.73705e-11,-87126.5,30.1665], Tmin=(100,'K'), Tmax=(787.676,'K')), NASAPolynomial(coeffs=[11.2771,0.0326971,-1.71127e-05,3.37592e-09,-2.37027e-13,-88656.8,-20.4245], Tmin=(787.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-725.578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFFO) + group(Cs-CsHHH) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = '[CH2][C](F)OCC(F)(F)F(3126)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FC[C](F)OC[C](F)F(3070)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(3036)', '[O]C[C](F)F(230)'],
    products = ['FC[C](F)OC[C](F)F(3070)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]O[C](F)CF(2714)'],
    products = ['FC[C](F)OC[C](F)F(3070)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC[C](F)OC=C(F)F(3119)'],
    products = ['FC[C](F)OC[C](F)F(3070)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)OC[C](F)F(3120)'],
    products = ['FC[C](F)OC[C](F)F(3070)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'FC=C(F)OC[C](F)F(3121)'],
    products = ['FC[C](F)OC[C](F)F(3070)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]O[C](F)CF(2714)'],
    products = ['FC[C](F)OC[C](F)F(3070)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FC[C](F)OC[C](F)F(3070)'],
    products = ['FC[C](F)O[CH]C(F)F(3096)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)OC[C](F)F(3122)'],
    products = ['FC[C](F)OC[C](F)F(3070)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC[C](F)OC[C](F)F(3070)'],
    products = ['FCC(F)O[CH][C](F)F(3123)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FC[C](F)OC[C](F)F(3070)'],
    products = ['F[CH][C](F)OCC(F)F(3124)'],
...
reaction(
    label = 'reaction19',
    reactants = ['FC[C](F)OC[C](F)F(3070)'],
    products = ['[CH2]C(F)(F)OC[C](F)F(3125)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FC[C](F)OC[C](F)F(3070)'],
    products = ['[CH2][C](F)OCC(F)(F)F(3126)'],
