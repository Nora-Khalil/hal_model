...
"""),
    E0 = (-556.192,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,259,529,569,1128,1321,1390,3140,3000,3100,440,815,1455,1000,334,575,1197,1424,3202,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.257252,'amu*angstrom^2'), symmetry=1, barrier=(5.91472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05195,'amu*angstrom^2'), symmetry=1, barrier=(24.1865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255641,'amu*angstrom^2'), symmetry=1, barrier=(5.87768,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.100106,0.0963649,-0.000168438,1.52861e-07,-5.35402e-11,-66764.3,26.5894], Tmin=(100,'K'), Tmax=(831.56,'K')), NASAPolynomial(coeffs=[9.68061,0.0311422,-1.62646e-05,3.18557e-09,-2.21277e-13,-67695.9,-13.8852], Tmin=(831.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C[C](F)F(151)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]C(F)[CH]F(155)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', 'F[CH]C[C](F)F(157)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CF2(57)', 'F[CH][CH]F(141)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]C(F)C=C(F)F(161)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=CC[C](F)F(162)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHFCHF[Z](59)', '[CH2][C](F)F(163)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC=C(F)C[C](F)F(164)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH][CH]F(141)', '[CH2][C](F)F(163)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[CH]C=C[C](F)F(165)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C(F)[CH]F(155)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[CH]C[C](F)F(157)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)[CH]C(F)F(147)'],
    products = ['F[CH]C(F)C[C](F)F(151)'],
