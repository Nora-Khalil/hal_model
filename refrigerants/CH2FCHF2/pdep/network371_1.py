...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24598,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.811654,0.077246,-0.000125445,1.10708e-07,-3.9133e-11,-45898.3,27.0109], Tmin=(100,'K'), Tmax=(768.697,'K')), NASAPolynomial(coeffs=[8.95724,0.0277787,-1.50994e-05,3.02468e-09,-2.14411e-13,-46941.4,-8.78325], Tmin=(768.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFHHO) + group(COCsFO) + radical(OCJC=O) + radical(CsF1sHO2s)"""),
)
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49451,0.0604831,-6.7419e-05,3.95496e-08,-9.636e-12,-22821.3,23.7625], Tmin=(100,'K'), Tmax=(973.561,'K')), NASAPolynomial(coeffs=[9.96598,0.025677,-1.37919e-05,2.82725e-09,-2.06075e-13,-24470.8,-16.8804], Tmin=(973.561,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-190.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsFHHO) + ring(Cs(O2)-O2s-Cs(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring) + radical(CsF1sHO2s)"""),
)

species(
    label = 'F[C]1[CH]OOC(F)O1(2276)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.780863,'amu*angstrom^2'), symmetry=1, barrier=(17.9536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.781237,'amu*angstrom^2'), symmetry=1, barrier=(17.9622,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49838,'amu*angstrom^2'), symmetry=1, barrier=(34.4508,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37095,0.0621412,-9.04563e-05,6.85601e-08,-2.07147e-11,-10110.8,23.4686], Tmin=(100,'K'), Tmax=(810.181,'K')), NASAPolynomial(coeffs=[10.2382,0.018361,-9.39759e-06,1.85813e-09,-1.31647e-13,-11547.5,-17.4439], Tmin=(810.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.8201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsFHHO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(CsF1sHO2s)"""),
)
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26811,0.068358,-9.08348e-05,5.55723e-08,-7.34243e-12,-48662.4,25.8974], Tmin=(100,'K'), Tmax=(568.091,'K')), NASAPolynomial(coeffs=[8.67151,0.0279556,-1.5117e-05,3.04971e-09,-2.18241e-13,-49692.8,-7.29866], Tmin=(568.091,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFFHO) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CsCJ=O)"""),
)

species(
    label = '[O]C(F)(C=O)O[CH]F(2044)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.467403,'amu*angstrom^2'), symmetry=1, barrier=(10.7465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.555662,'amu*angstrom^2'), symmetry=1, barrier=(12.7758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.22256,'amu*angstrom^2'), symmetry=1, barrier=(51.1009,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18291,0.070828,-0.000127348,1.19087e-07,-4.28014e-11,4478.25,25.2924], Tmin=(100,'K'), Tmax=(830.27,'K')), NASAPolynomial(coeffs=[7.04301,0.0252647,-1.37207e-05,2.70861e-09,-1.8873e-13,4102.51,1.70815], Tmin=(830.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.4621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsF1sHO2s) + radical(Cdj(Cd-O2sH)(F1s))"""),
)

species(
    label = 'FC1=COOC(F)O1(2281)',
...
"""),
    E0 = (-259.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,548,1085,1183,1302,1466,1520,3060,3119,486,617,768,1157,1926,232.56,233.462,235.012],'cm^-1')),
        HinderedRotor(inertia=(0.368681,'amu*angstrom^2'), symmetry=1, barrier=(14.1909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.733362,'amu*angstrom^2'), symmetry=1, barrier=(28.7841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.739162,'amu*angstrom^2'), symmetry=1, barrier=(28.8106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.731657,'amu*angstrom^2'), symmetry=1, barrier=(28.8051,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0833,0.0701154,-9.19508e-05,6.14923e-08,-1.65979e-11,-31059.8,24.7961], Tmin=(100,'K'), Tmax=(896.607,'K')), NASAPolynomial(coeffs=[11.683,0.0228266,-1.28366e-05,2.66652e-09,-1.95338e-13,-32960.5,-25.1845], Tmin=(896.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFHHO) + group(COCsFO) + radical(CH2_triplet)"""),
)

species(
    label = 'F[CH]OOC=[C]OF(2285)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OO[CH]F(2045)'],
...
reaction(
    ...
    products = ['O=C(F)[CH]OO[CH]F(2045)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', '[O]O[CH]C(=O)F(2224)'],
    products = ['O=C(F)[CH]OO[CH]F(2045)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OO[CH]F(2045)'],
    products = ['F[C]1[CH]OOC(F)O1(2276)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C=COO[CH]F(2278)'],
    products = ['O=C(F)[CH]OO[CH]F(2045)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[O]O[CH]C(=O)F(2224)'],
    products = ['O=C(F)[CH]OO[CH]F(2045)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]OO[CH]F(2045)'],
    products = ['[O]C(F)(C=O)O[CH]F(2044)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(6)', 'F[C]=COO[CH]F(2280)'],
    products = ['O=C(F)[CH]OO[CH]F(2045)'],
