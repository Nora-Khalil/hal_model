...
"""),
    ...
    molecularWeight = (136.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0169,0.0712855,-9.32573e-05,6.95541e-08,-2.15035e-11,-78106.4,25.2056], Tmin=(100,'K'), Tmax=(781.409,'K')), NASAPolynomial(coeffs=[8.95473,0.0306525,-1.52587e-05,3.0095e-09,-2.1379e-13,-79346.9,-11.132], Tmin=(781.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-650.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-412.422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([131,334,551,600,680,832,1063,1162,1194,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,2120,512.5,787.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.461146,'amu*angstrom^2'), symmetry=1, barrier=(10.6027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.460294,'amu*angstrom^2'), symmetry=1, barrier=(10.5831,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (135.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.782751,0.0785067,-0.000128474,1.1434e-07,-4.00725e-11,-49494.5,26.5037], Tmin=(100,'K'), Tmax=(815.051,'K')), NASAPolynomial(coeffs=[8.33183,0.029133,-1.49242e-05,2.90962e-09,-2.02495e-13,-50315.7,-5.86097], Tmin=(815.051,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-412.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-422.144,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,110,430,447,631,613,772,1183,1186,2100,2250,500,550,1855,455,950,180,930.565],'cm^-1')),
        HinderedRotor(inertia=(0.205394,'amu*angstrom^2'), symmetry=1, barrier=(4.72241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0303879,'amu*angstrom^2'), symmetry=1, barrier=(18.6732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0303669,'amu*angstrom^2'), symmetry=1, barrier=(18.6706,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (135.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16395,0.0566495,-5.0128e-05,2.11154e-08,-3.49865e-12,-50665.4,28.7705], Tmin=(100,'K'), Tmax=(1446.19,'K')), NASAPolynomial(coeffs=[16.0038,0.0156039,-7.55497e-06,1.48993e-09,-1.06023e-13,-54957.7,-48.2982], Tmin=(1446.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CtHH) + group(CsCtFFF) + group(Cds-OdCsH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C=CC=[C]C(F)(F)F(12950)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (136.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.165287,0.0786405,-8.56184e-05,4.40739e-08,-8.60182e-12,-49661.1,28.8683], Tmin=(100,'K'), Tmax=(1335.71,'K')), NASAPolynomial(coeffs=[22.1527,0.00806537,-2.16243e-06,3.23789e-10,-2.08926e-14,-55289.5,-84.0145], Tmin=(1335.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-414.245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Cds_S)"""),
)

species(
    label = 'O=[C]C[C]=CC(F)(F)F(12951)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (136.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41859,0.0635467,-6.35604e-05,3.30738e-08,-7.26212e-12,-44896.2,26.4139], Tmin=(100,'K'), Tmax=(1057.48,'K')), NASAPolynomial(coeffs=[10.1879,0.0303764,-1.65098e-05,3.41193e-09,-2.49775e-13,-46750.8,-16.383], Tmin=(1057.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Cds_S) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC[C]=[C]C(F)(F)F(12952)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-282.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,131,334,551,600,680,832,1063,1162,1194,2782.5,750,1395,475,1775,1000,1670,1700,300,440,180],'cm^-1')),
        HinderedRotor(inertia=(0.162992,'amu*angstrom^2'), symmetry=1, barrier=(3.74751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0154643,'amu*angstrom^2'), symmetry=1, barrier=(15.6572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.679509,'amu*angstrom^2'), symmetry=1, barrier=(15.6233,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (136.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7112,0.0595017,-5.52528e-05,2.77615e-08,-6.24374e-12,-33857.7,25.8119], Tmin=(100,'K'), Tmax=(992.343,'K')), NASAPolynomial(coeffs=[7.46587,0.036305,-2.01888e-05,4.20475e-09,-3.09019e-13,-34999.8,-1.90672], Tmin=(992.343,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Cds_S) + radical(Cdj(Cs-F1sF1sF1s)(Cd-CsH))"""),
)

species(
    label = 'O=[C]C=C[CH]C(F)(F)F(12953)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (136.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.738715,0.0791378,-0.000105788,7.6536e-08,-2.27716e-11,-59492.7,25.6395], Tmin=(100,'K'), Tmax=(811.302,'K')), NASAPolynomial(coeffs=[10.4974,0.0310258,-1.68378e-05,3.44636e-09,-2.50127e-13,-61076.2,-19.4004], Tmin=(811.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-495.573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Allyl_S) + radical(C=CCJ=O)"""),
)

species(
    label = 'O=[C]CC=C(F)[C](F)F(11229)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', '[CH2]C=[C]C(F)(F)F(12297)'],
    products = ['O=[C]CC=[C]C(F)(F)F(12929)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O=[C]CC=[C]C(F)(F)F(12929)'],
    products = ['O=C=CC=CC(F)(F)F(12947)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]CC=[C]C(F)(F)F(12929)'],
    products = ['[O]C=CC=[C]C(F)(F)F(12950)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]CC=[C]C(F)(F)F(12929)'],
    products = ['O=[C]C[C]=CC(F)(F)F(12951)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=CC[C]=[C]C(F)(F)F(12952)'],
    products = ['O=[C]CC=[C]C(F)(F)F(12929)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]CC=[C]C(F)(F)F(12929)'],
    products = ['O=[C]C=C[CH]C(F)(F)F(12953)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]CC=[C]C(F)(F)F(12929)'],
    products = ['O=[C]CC=C(F)[C](F)F(11229)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]CC=[C]C(F)(F)F(12929)'],
    products = ['O=C(F)CC=[C][C](F)F(11230)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(4.94559e+07,'s^-1'), n=1.15307, Ea=(192.854,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 3.0"""),
)
