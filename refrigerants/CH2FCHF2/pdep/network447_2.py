...
"""),
    E0 = (24.7562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,528,1116,1182,1331,1402,1494,3075,3110,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.00544,'amu*angstrom^2'), symmetry=1, barrier=(23.117,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00298,'amu*angstrom^2'), symmetry=1, barrier=(23.0605,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (62.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1873,0.0322353,-2.07888e-05,-4.40297e-09,5.95455e-12,3049.63,12.978], Tmin=(100,'K'), Tmax=(972.874,'K')), NASAPolynomial(coeffs=[14.1328,0.000889078,1.46182e-07,2.40443e-11,-7.12591e-15,-115.527,-48.6453], Tmin=(972.874,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.7562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction29',
    reactants = ['O[C](F)CF(2940)'],
    products = ['[CH2]C(O)(F)F(2782)'],
