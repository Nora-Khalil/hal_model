...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)(F)F(12902)'],
    products = ['CF2(43)', 'CF3(45)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'F[C]C(F)(F)F-2(12709)'],
    products = ['F[C](F)C(F)(F)F(12902)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C](F)[C](F)F(5099)'],
    products = ['F[C](F)C(F)(F)F(12902)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]C(F)(F)F(4089)'],
    products = ['F[C](F)C(F)(F)F(12902)'],
    transitionState = 'TS6',
