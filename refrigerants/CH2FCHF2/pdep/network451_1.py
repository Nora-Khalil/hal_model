...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', '[O]C[C](F)F(230)'],
    products = ['F[C](F)CO[C](F)F(2685)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]O[C](F)F(2728)'],
    products = ['F[C](F)CO[C](F)F(2685)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)OC=C(F)F(2730)'],
    products = ['F[C](F)CO[C](F)F(2685)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH2]O[C](F)F(2728)'],
    products = ['F[C](F)CO[C](F)F(2685)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[O]C[C](F)F(230)'],
    products = ['F[C](F)CO[C](F)F(2685)'],
