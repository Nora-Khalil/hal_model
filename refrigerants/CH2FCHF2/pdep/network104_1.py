...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[O]C[C](F)F(230)'],
    products = ['F[CH]OC[C](F)F(375)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]OC=C(F)F(412)'],
    products = ['F[CH]OC[C](F)F(375)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[O]C[C](F)F(230)'],
    products = ['F[CH]OC[C](F)F(375)'],
