...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C[C]=O(4676)'],
    products = ['O=[C]CO[C]=O(8292)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', '[CH2]O[C]=O(534)'],
    products = ['O=[C]CO[C]=O(8292)'],
    transitionState = 'TS3',
