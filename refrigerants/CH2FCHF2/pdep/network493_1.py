...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(O)(F)F(2944)'],
    products = ['[O]OC(O)(F)F(2786)'],
    transitionState = 'TS2',
