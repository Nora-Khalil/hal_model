...
reaction(
    label = 'reaction4',
    reactants = ['CF2O(49)', '[O][C](F)F(2694)'],
    products = ['F[C](F)OO[C](F)F(2819)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O][C](F)F(2694)', '[O][C](F)F(2694)'],
    products = ['F[C](F)OO[C](F)F(2819)'],
    transitionState = 'TS5',
