...
reaction(
    label = 'reaction1',
    reactants = ['H(5)', 'O=C=C=O(1666)'],
    products = ['O=[C]C=O(1664)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(3.8901e+06,'m^3/(mol*s)'), n=0.615377, Ea=(4.16528,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_4R!H-u0_4R!H->C_N-Sp-4C-1COS',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_4R!H-u0_4R!H->C_N-Sp-4C-1COS
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', 'HCO(15)'],
    products = ['O=[C]C=O(1664)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]C=O(1664)'],
    products = ['O=C1[CH]O1(14310)'],
    transitionState = 'TS3',
