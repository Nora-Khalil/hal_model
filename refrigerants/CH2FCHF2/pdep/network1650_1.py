...
reaction(
    label = 'reaction3',
    reactants = ['OF(482)', 'O=C(O)[C]F(4999)'],
    products = ['O=C(O)C(F)OF(5366)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'O=C=C(F)OF(5612)'],
    products = ['O=C(O)C(F)OF(5366)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(O)[CH]OF(5618)'],
    products = ['O=C(O)C(F)OF(5366)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(=O)O(5619)'],
    products = ['O=C(O)C(F)OF(5366)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(128)', 'O=C(O)[CH]F(5620)'],
    products = ['O=C(O)C(F)OF(5366)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'O=[C]C(F)OF(5621)'],
    products = ['O=C(O)C(F)OF(5366)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(F)OF(5622)'],
    products = ['O=C(O)C(F)OF(5366)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(363)', 'O=[C]O(338)'],
    products = ['O=C(O)C(F)OF(5366)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)[C](F)OF(5623)'],
    products = ['O=C(O)C(F)OF(5366)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(O)C(=O)F(1352)'],
    products = ['O=C(O)C(F)OF(5366)'],
