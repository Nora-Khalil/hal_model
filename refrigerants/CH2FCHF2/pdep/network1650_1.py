...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O[CH]OC(F)(F)F(6025)'],
    products = ['OC(F)OC(F)(F)F(5406)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)O[C](F)F(1209)'],
    products = ['OC(F)OC(F)(F)F(5406)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'F[CH]OC(F)(F)F(6026)'],
    products = ['OC(F)OC(F)(F)F(5406)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)OC(F)(F)F(6027)'],
    products = ['OC(F)OC(F)(F)F(5406)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[C](F)OC(F)(F)F(5164)'],
    products = ['OC(F)OC(F)(F)F(5406)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=COC(F)(F)F(5088)'],
    products = ['OC(F)OC(F)(F)F(5406)'],
