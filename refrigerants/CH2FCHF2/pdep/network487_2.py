...
reaction(
    label = 'reaction10',
    reactants = ['OC[C](F)F(2781)'],
    products = ['O[CH]C(F)F(2941)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', '[CH]C(F)F-2(3493)'],
    products = ['O[CH]C(F)F(2941)'],
