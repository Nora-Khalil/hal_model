...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C(F)F-2(3493)'],
    products = ['CHF2-CHF(67)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'F[C]C(F)F-2(3545)'],
    products = ['CHF2-CHF(67)'],
    transitionState = 'TS4',
