...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(9027)', '[CH]C-2(4371)'],
    products = ['C[CH]OC=[C]F(13390)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C[CH]OC#CF(13411)'],
    products = ['C[CH]OC=[C]F(13390)'],
    transitionState = 'TS8',
