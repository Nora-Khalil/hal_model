...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.158644,'amu*angstrom^2'), symmetry=1, barrier=(3.64754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158257,'amu*angstrom^2'), symmetry=1, barrier=(3.63864,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56952,0.0618151,-0.000110509,1.04497e-07,-3.77318e-11,-4909.32,20.2371], Tmin=(100,'K'), Tmax=(844.098,'K')), NASAPolynomial(coeffs=[5.72526,0.024455,-1.27241e-05,2.47033e-09,-1.70403e-13,-4981.51,4.62063], Tmin=(844.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-41.4791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(O2s-OsH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = '[O]C([CH]O)OF(5787)',
...
"""),
    E0 = (-76.1187,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,180,180,908.414],'cm^-1')),
...
"""),
    E0 = (-30.7115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,180,180,1642.86,1647.4],'cm^-1')),
        HinderedRotor(inertia=(0.172695,'amu*angstrom^2'), symmetry=1, barrier=(3.9706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170994,'amu*angstrom^2'), symmetry=1, barrier=(3.93148,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92796,0.057817,-0.000113582,1.20511e-07,-4.71667e-11,-3630.98,23.0068], Tmin=(100,'K'), Tmax=(844.541,'K')), NASAPolynomial(coeffs=[0.779229,0.0336337,-1.80139e-05,3.53683e-09,-2.45391e-13,-2380.48,34.6093], Tmin=(844.541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.7115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C[C](O)OF(5789)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
...
"""),
    E0 = (-51.1702,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,215.058,2200.22,2200.3],'cm^-1')),
        HinderedRotor(inertia=(0.226003,'amu*angstrom^2'), symmetry=1, barrier=(7.40454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.9411,'amu*angstrom^2'), symmetry=1, barrier=(30.8873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225906,'amu*angstrom^2'), symmetry=1, barrier=(7.40499,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62096,0.061058,-0.000110749,1.06106e-07,-3.86646e-11,-6077.11,23.9377], Tmin=(100,'K'), Tmax=(844.332,'K')), NASAPolynomial(coeffs=[5.27678,0.0249011,-1.30483e-05,2.53989e-09,-1.75399e-13,-6023,10.8954], Tmin=(844.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.1702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'OC=C(O)OF(5790)',
    structure = adjacencyList("""1 F u0 p3 c0 {2,S}
2 O u0 p2 c0 {1,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.97828,'amu*angstrom^2'), symmetry=1, barrier=(22.4926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.982564,'amu*angstrom^2'), symmetry=1, barrier=(22.5911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.981769,'amu*angstrom^2'), symmetry=1, barrier=(22.5728,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.276713,0.0687679,-8.88607e-05,5.08478e-08,-1.05578e-11,-44928.6,20.6877], Tmin=(100,'K'), Tmax=(1378.37,'K')), NASAPolynomial(coeffs=[20.819,-0.00376871,4.1405e-06,-9.35537e-10,6.80901e-14,-49363.9,-80.5555], Tmin=(1378.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.21085,'amu*angstrom^2'), symmetry=1, barrier=(27.8397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20962,'amu*angstrom^2'), symmetry=1, barrier=(27.8116,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (59.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.80067,0.0149398,2.57519e-05,-4.93209e-08,2.1035e-11,-21335.3,13.9998], Tmin=(100,'K'), Tmax=(958.149,'K')), NASAPolynomial(coeffs=[12.5151,0.00304247,-4.86583e-07,1.51252e-10,-1.80935e-14,-24512.3,-39.316], Tmin=(958.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]C(=O)OF(1347)'],
    products = ['O=C(CO)OF(5360)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C([CH]O)OF(5604)'],
    products = ['O=C(CO)OF(5360)'],
