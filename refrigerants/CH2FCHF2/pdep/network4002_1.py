...
"""),
    E0 = (-560.448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,519,593,830,1115,1166,1389,1413,3114,482,586,761,1411,180,3089.08],'cm^-1')),
        HinderedRotor(inertia=(2.02663,'amu*angstrom^2'), symmetry=1, barrier=(46.5962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.02608,'amu*angstrom^2'), symmetry=1, barrier=(46.5835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.02642,'amu*angstrom^2'), symmetry=1, barrier=(46.5915,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67794,0.0561728,-6.83564e-05,4.46878e-08,-1.21009e-11,-67327.1,26.0626], Tmin=(100,'K'), Tmax=(884.168,'K')), NASAPolynomial(coeffs=[8.96034,0.0232271,-1.24637e-05,2.54452e-09,-1.84797e-13,-68614.8,-8.17421], Tmin=(884.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-560.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsFHOO) + group(CsFFHO) + radical(O2sj(Cs-F1sO2sH)) + radical(CsF1sO2sO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(219)', 'O[C]F(3009)'],
    products = ['O[C](F)OO[C](F)F(14094)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[O]O[C](O)F(445)'],
    products = ['O[C](F)OO[C](F)F(14094)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[C](F)F(219)', '[OH+]=[C-]F(2955)'],
    products = ['O[C](F)OO[C](F)F(14094)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(5.83144,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[O]O[C](O)F(445)'],
    products = ['O[C](F)OO[C](F)F(14094)'],
...
network(
    label = 'PDepNetwork #4002',
    isomers = [
        'O[C](F)OO[C](F)F(14094)',
    ],
    reactants = [
        ('CF2O(49)', 'O=C(O)F(343)'),
    ],
