...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.993046,'amu*angstrom^2'), symmetry=1, barrier=(22.8321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.991977,'amu*angstrom^2'), symmetry=1, barrier=(22.8075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.993041,'amu*angstrom^2'), symmetry=1, barrier=(22.832,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.992096,'amu*angstrom^2'), symmetry=1, barrier=(22.8102,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.430165,0.104705,-0.000135058,9.06598e-08,-2.45265e-11,-123081,27.8863], Tmin=(100,'K'), Tmax=(896.712,'K')), NASAPolynomial(coeffs=[15.2597,0.0347177,-1.79853e-05,3.62261e-09,-2.61111e-13,-125895,-46.098], Tmin=(896.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1024.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.978081,'amu*angstrom^2'), symmetry=1, barrier=(22.488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.97725,'amu*angstrom^2'), symmetry=1, barrier=(22.4689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.976401,'amu*angstrom^2'), symmetry=1, barrier=(22.4494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.97696,'amu*angstrom^2'), symmetry=1, barrier=(22.4622,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.451713,0.104987,-0.000135931,9.14603e-08,-2.47588e-11,-122453,28.0605], Tmin=(100,'K'), Tmax=(896.946,'K')), NASAPolynomial(coeffs=[15.4086,0.0342569,-1.76476e-05,3.54564e-09,-2.55192e-13,-125298,-46.7317], Tmin=(896.946,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1019.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH)"""),
)

species(
    label = 'CC(F)(F)C(F)(F)COF(4105)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (164.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.826418,0.115818,-0.000185811,1.59334e-07,-5.41863e-11,-123264,29.9758], Tmin=(100,'K'), Tmax=(796.689,'K')), NASAPolynomial(coeffs=[12.6538,0.0377912,-1.94239e-05,3.80173e-09,-2.6563e-13,-125083,-29.9338], Tmin=(796.689,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1026.24,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(Cs-CsHHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.381723,'amu*angstrom^2'), symmetry=1, barrier=(8.77656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.38162,'amu*angstrom^2'), symmetry=1, barrier=(8.7742,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.33499,'amu*angstrom^2'), symmetry=1, barrier=(7.70208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.335047,'amu*angstrom^2'), symmetry=1, barrier=(7.70339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334933,'amu*angstrom^2'), symmetry=1, barrier=(7.70078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.868174,'amu*angstrom^2'), symmetry=1, barrier=(19.961,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-607.415,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,528,1116,1182,1331,1402,1494,3075,3110,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,203.772,203.78,204.003],'cm^-1')),
        HinderedRotor(inertia=(0.37143,'amu*angstrom^2'), symmetry=1, barrier=(10.9403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.852616,'amu*angstrom^2'), symmetry=1, barrier=(25.13,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.370177,'amu*angstrom^2'), symmetry=1, barrier=(10.9385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14899,'amu*angstrom^2'), symmetry=1, barrier=(33.8781,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0246368,0.0952257,-0.000132448,1.00687e-07,-3.12231e-11,-72919.1,28.4029], Tmin=(100,'K'), Tmax=(783.26,'K')), NASAPolynomial(coeffs=[11.6738,0.0357312,-1.8504e-05,3.69825e-09,-2.64253e-13,-74743.8,-24.9509], Tmin=(783.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-607.415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(CsCsCsF1s)"""),
)

species(
    label = '[CH2]C(F)(OF)C(C)(F)F(4110)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.562064,'amu*angstrom^2'), symmetry=1, barrier=(12.923,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560822,'amu*angstrom^2'), symmetry=1, barrier=(12.8944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64404,'amu*angstrom^2'), symmetry=1, barrier=(37.7998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.56433,'amu*angstrom^2'), symmetry=1, barrier=(12.9751,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.245578,0.104002,-0.000149496,1.04899e-07,-2.47048e-11,-76785.3,26.192], Tmin=(100,'K'), Tmax=(614.831,'K')), NASAPolynomial(coeffs=[12.8179,0.0345775,-1.80943e-05,3.59281e-09,-2.54276e-13,-78685.9,-32.8699], Tmin=(614.831,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-639.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)

species(
    label = 'CC(F)(F)C([O])(F)CF(4111)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.49097,'amu*angstrom^2'), symmetry=1, barrier=(11.2884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.491119,'amu*angstrom^2'), symmetry=1, barrier=(11.2918,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.156965,0.0913047,-0.000121718,8.80404e-08,-2.59013e-11,-111142,26.7442], Tmin=(100,'K'), Tmax=(825.048,'K')), NASAPolynomial(coeffs=[12.0481,0.0336541,-1.69055e-05,3.34816e-09,-2.3848e-13,-113104,-28.3369], Tmin=(825.048,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-925.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs))"""),
)
...
"""),
    E0 = (-768.538,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,256.473,256.739],'cm^-1')),
        HinderedRotor(inertia=(0.306062,'amu*angstrom^2'), symmetry=1, barrier=(14.3294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181386,'amu*angstrom^2'), symmetry=1, barrier=(8.49249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.794478,'amu*angstrom^2'), symmetry=1, barrier=(37.1823,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction2',
    reactants = ['FCOF(367)', 'CC(F)(F)[C]F(704)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]CF(126)', 'CC(F)(F)OF(705)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['FCC(F)(F)OF(2808)', 'C[C]F(702)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2(8)', 'CC(F)(F)C(F)([C]F)OF(4103)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHF(40)', 'CC(F)(F)C(F)OF(698)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(S)(25)', 'CC(F)(F)C(F)(F)OF(2804)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CC(F)(OF)C(F)(F)CF(4104)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC(F)(F)C(F)(CF)OF(4100)'],
    products = ['CC(F)(F)C(F)(F)COF(4105)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FOF(488)', 'CC(F)=C(F)CF(4106)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OF(482)', 'CC(F)(F)C(F)=CF(173)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FOF(488)', 'C=C(F)C(C)(F)F(4107)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'CC(F)(F)[C](CF)OF(4108)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'C[C](F)C(F)(CF)OF(4109)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', '[CH2]C(F)(OF)C(C)(F)F(4110)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', 'CC(F)(F)C([O])(F)CF(4111)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]F(128)', 'CC(F)(F)[C](F)CF(4112)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FC[C](F)OF(3020)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2F(46)', 'CC(F)(F)[C](F)OF(713)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(19)', 'FCC(F)(OF)[C](F)F(4113)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', 'CC(F)(F)C(F)([CH]F)OF(4114)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)(CF)OF(4115)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F2(78)', 'CC(F)(F)C(=O)CF(4116)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F2(78)', 'CC(F)=C(CF)OF(4117)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F2(78)', 'C=C(OF)C(C)(F)F(4118)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
...
reaction(
    label = 'reaction29',
    reactants = ['HF(38)', 'CC(F)(F)C(=CF)OF(4119)'],
    products = ['CC(F)(F)C(F)(CF)OF(4100)'],
