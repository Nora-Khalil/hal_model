...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'FC=C(F)OF(1046)'],
    products = ['OC(F)C(F)OF(1033)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[CH]C(F)OF(1049)'],
    products = ['OC(F)C(F)OF(1033)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)[CH]OF(1050)'],
    products = ['OC(F)C(F)OF(1033)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)C(O)F(1051)'],
    products = ['OC(F)C(F)OF(1033)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)C(F)OF(1052)'],
    products = ['OC(F)C(F)OF(1033)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O[C](F)C(F)OF(1053)'],
    products = ['OC(F)C(F)OF(1033)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)[C](F)OF(1054)'],
    products = ['OC(F)C(F)OF(1033)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC(F)OF(1055)'],
    products = ['OC(F)C(F)OF(1033)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'OC=C(F)OF(1059)'],
    products = ['OC(F)C(F)OF(1033)'],
