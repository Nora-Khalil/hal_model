...
reaction(
    label = 'reaction3',
    reactants = ['O[C]1OC[C](F)O1(13297)'],
    products = ['C=C(F)OC(=O)O(6038)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)OC([O])=O(13300)'],
    products = ['C=C(F)OC(=O)O(6038)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(F)O[C](O)O(13301)'],
    products = ['C=C(F)OC(=O)O(6038)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=[C]OC(=O)O(13303)'],
    products = ['C=C(F)OC(=O)O(6038)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(4910)', 'CH2CF(70)'],
    products = ['C=C(F)OC(=O)O(6038)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(F)OC([O])=O(4325)'],
    products = ['C=C(F)OC(=O)O(6038)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)OC(=O)O(4909)'],
    products = ['C=C(F)OC(=O)O(6038)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COC(=O)O(4916)'],
    products = ['C=C(F)OC(=O)O(6038)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(25)', 'O=C(O)[O+]=[C-]F(4918)'],
    products = ['C=C(F)OC(=O)O(6038)'],
