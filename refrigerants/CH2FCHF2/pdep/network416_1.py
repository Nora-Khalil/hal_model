...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C(F)[CH]F(208)'],
    products = ['[CH2]OC(F)[CH]F(2548)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', '[CH2]O[CH]F(410)'],
    products = ['[CH2]OC(F)[CH]F(2548)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=CF(2600)'],
    products = ['[CH2]OC(F)[CH]F(2548)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]O[CH]F(410)'],
    products = ['[CH2]OC(F)[CH]F(2548)'],
