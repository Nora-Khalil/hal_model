species(
    label = 'F[CH]C(F)C(F)(F)[CH]F(3710)',
...
species(
    label = 'F[CH][CH]C(F)(F)C(F)F(3769)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)C(F)[C](F)F(3711)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', 'F[CH]C(F)(F)[CH]F(3762)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
    products = ['FC1C(F)C(F)(F)C1F(3746)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C(F)(F)C=CF(3764)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH][C](F)F(3428)', 'CHFCHF[Z](59)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)=CF(3765)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][C](F)F(3428)', 'F[CH][CH]F(141)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[CH]C(F)=C(F)[CH]F(3766)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[CH]C(F)(F)[CH]F(3762)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
    products = ['F[CH]C(F)(F)[C](F)CF(3767)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
    products = ['F[CH][C](F)C(F)(F)CF(3768)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
    products = ['F[CH]C(F)[C](F)C(F)F(3754)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
    products = ['F[CH][C](F)C(F)C(F)F(3756)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
    products = ['F[CH][CH]C(F)(F)C(F)F(3769)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3710)'],
    products = ['F[CH]C(F)(F)[CH]C(F)F(3770)'],
