...
"""),
    E0 = (-940.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,326,540,652,719,1357,190,488,555,1236,1407,194,682,905,1196,1383,3221,310.154,310.155,310.155,310.156],'cm^-1')),
        HinderedRotor(inertia=(0.00175244,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119242,'amu*angstrom^2'), symmetry=1, barrier=(8.13973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119241,'amu*angstrom^2'), symmetry=1, barrier=(8.13974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.36925,'amu*angstrom^2'), symmetry=1, barrier=(25.2061,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.356484,0.103512,-0.000158679,1.25227e-07,-3.92306e-11,-112970,32.9073], Tmin=(100,'K'), Tmax=(783.05,'K')), NASAPolynomial(coeffs=[14.3114,0.0285835,-1.51449e-05,3.02421e-09,-2.14829e-13,-115267,-34.2695], Tmin=(783.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-940.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)
...
species(
    label = 'O=C(F)C(F)C(O)[C](F)F(7001)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-556.076,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,194,682,905,1196,1383,3221,90,150,250,247,323,377,431,433,1065,1274,436.924,436.929,436.997,1348.25],'cm^-1')),
        HinderedRotor(inertia=(0.000883039,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000882995,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000882846,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000882905,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.167185,0.0899653,-0.000125544,8.78885e-08,-2.43321e-11,-66747.4,28.3534], Tmin=(100,'K'), Tmax=(883.933,'K')), NASAPolynomial(coeffs=[14.9117,0.0232427,-1.23179e-05,2.49227e-09,-1.79677e-13,-69354,-40.9613], Tmin=(883.933,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CsCCl_triplet)"""),
)
...
species(
    label = 'OC1O[C](F)C(F)C1(F)F(7003)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.268425,0.0787245,-8.54006e-05,4.56868e-08,-8.67375e-12,-124684,26.2263], Tmin=(100,'K'), Tmax=(901.028,'K')), NASAPolynomial(coeffs=[15.8856,0.0204319,-6.73255e-06,1.07657e-09,-6.84726e-14,-127946,-49.9762], Tmin=(901.028,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1037.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCsCsFF) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(Tetrahydrofuran) + radical(CsCsF1sO2s) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'OC1OC(F)([CH]F)C1(F)F(7004)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.142551,0.0997016,-0.000160226,1.38609e-07,-4.79103e-11,-118730,29.8732], Tmin=(100,'K'), Tmax=(771.66,'K')), NASAPolynomial(coeffs=[11.2203,0.0336268,-1.78404e-05,3.54912e-09,-2.50705e-13,-120270,-20.6166], Tmin=(771.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-988.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(O2s-Cs-Cs-Cs(F)) + radical(Csj(Cs-F1sO2sCs)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F))"""),
)
...
"""),
    E0 = (-896.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,326,540,652,719,1357,182,240,577,636,1210,1413,194,682,905,1196,1383,3221,180,180,816.593],'cm^-1')),
        HinderedRotor(inertia=(0.231186,'amu*angstrom^2'), symmetry=1, barrier=(5.31543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231354,'amu*angstrom^2'), symmetry=1, barrier=(5.31928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.230646,'amu*angstrom^2'), symmetry=1, barrier=(5.30301,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.177748,0.10514,-0.000191573,1.78254e-07,-6.33239e-11,-107722,30.5375], Tmin=(100,'K'), Tmax=(841.318,'K')), NASAPolynomial(coeffs=[8.98176,0.0349219,-1.88286e-05,3.69111e-09,-2.55511e-13,-108319,-6.45974], Tmin=(841.318,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-896.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)

species(
    label = 'OC(O[C]=CF)[C](F)F(7006)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-551.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,326,540,652,719,1357,190,488,555,1236,1407,194,682,905,1196,1383,3221,284.362,284.461,284.583,284.631],'cm^-1')),
        HinderedRotor(inertia=(0.271506,'amu*angstrom^2'), symmetry=1, barrier=(15.5743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271226,'amu*angstrom^2'), symmetry=1, barrier=(15.5744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.270735,'amu*angstrom^2'), symmetry=1, barrier=(15.5745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.276154,0.100175,-0.000159116,1.22816e-07,-3.68364e-11,-66185.3,28.9527], Tmin=(100,'K'), Tmax=(823.169,'K')), NASAPolynomial(coeffs=[16.5792,0.0182781,-9.89365e-06,1.97431e-09,-1.39643e-13,-68960.5,-49.0861], Tmin=(823.169,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-551.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = '[O]C(OC(F)=CF)[C](F)F(4746)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-714.825,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,326,540,652,719,1357,190,488,555,1236,1407,194,682,905,1196,1383,3221,206.308,206.309,206.309,206.309,1515.65],'cm^-1')),
        HinderedRotor(inertia=(0.241317,'amu*angstrom^2'), symmetry=1, barrier=(7.28873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0044712,'amu*angstrom^2'), symmetry=1, barrier=(7.28873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20433,'amu*angstrom^2'), symmetry=1, barrier=(36.3756,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.181223,0.103214,-0.000180799,1.65123e-07,-5.87146e-11,-85833.9,33.1233], Tmin=(100,'K'), Tmax=(811.008,'K')), NASAPolynomial(coeffs=[10.0323,0.0342543,-1.888e-05,3.76589e-09,-2.64647e-13,-86879.4,-10.2434], Tmin=(811.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-714.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCOJ) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'O[C](OC(F)=CF)[C](F)F(7008)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-735.284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,360,370,350,326,540,652,719,1357,190,488,555,1236,1407,194,682,905,1196,1383,3221,233.609,233.912,234.347,4000],'cm^-1')),
        HinderedRotor(inertia=(0.259948,'amu*angstrom^2'), symmetry=1, barrier=(10.1603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00308159,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.821148,'amu*angstrom^2'), symmetry=1, barrier=(31.828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.816891,'amu*angstrom^2'), symmetry=1, barrier=(31.83,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.206846,0.102439,-0.000159787,1.18905e-07,-3.14019e-11,-88292.1,33.7775], Tmin=(100,'K'), Tmax=(634.663,'K')), NASAPolynomial(coeffs=[14.2769,0.0259993,-1.42105e-05,2.84266e-09,-2.01009e-13,-90429.5,-31.8684], Tmin=(634.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-735.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'OC(OC(F)=[C]F)[C](F)F(7009)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.462685,0.107235,-0.000182437,1.57404e-07,-5.31517e-11,-80548.6,34.3123], Tmin=(100,'K'), Tmax=(798.792,'K')), NASAPolynomial(coeffs=[13.5665,0.0275634,-1.51381e-05,3.01494e-09,-2.11792e-13,-82489.4,-28.3378], Tmin=(798.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-670.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    E0 = (-478.893,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,190,488,555,1236,1407,2175,525,239,401,1367,335.569,335.57,335.572,335.573],'cm^-1')),
        HinderedRotor(inertia=(0.00149704,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.230512,'amu*angstrom^2'), symmetry=1, barrier=(18.4197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23051,'amu*angstrom^2'), symmetry=1, barrier=(18.4196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.230507,'amu*angstrom^2'), symmetry=1, barrier=(18.4197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.190343,0.0896492,-0.000133242,9.73219e-08,-2.78712e-11,-57465.5,28.547], Tmin=(100,'K'), Tmax=(858.058,'K')), NASAPolynomial(coeffs=[15.2122,0.0196216,-1.08243e-05,2.2092e-09,-1.59466e-13,-60043.4,-41.6252], Tmin=(858.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-478.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Ct-CtOs) + group(CtCF) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-560.162,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,326,540,652,719,1357,194,682,905,1196,1383,3221,617,898,1187,279.5,280.169,280.57],'cm^-1')),
        HinderedRotor(inertia=(0.00213849,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209014,'amu*angstrom^2'), symmetry=1, barrier=(11.4533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207767,'amu*angstrom^2'), symmetry=1, barrier=(11.3773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.476963,'amu*angstrom^2'), symmetry=1, barrier=(25.8154,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.293354,0.0855068,-0.000113471,7.53042e-08,-1.97135e-11,-67241.7,29.5904], Tmin=(100,'K'), Tmax=(934.654,'K')), NASAPolynomial(coeffs=[15.2181,0.0216348,-1.09655e-05,2.19036e-09,-1.57283e-13,-70031.7,-41.4043], Tmin=(934.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-560.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-942.909,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,522,611,926,1093,1137,1374,1416,3112,360,370,350,326,540,652,719,1357,194,682,905,1196,1383,3221,302.931,302.932,302.932,302.933],'cm^-1')),
        HinderedRotor(inertia=(0.115465,'amu*angstrom^2'), symmetry=1, barrier=(7.5191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295022,'amu*angstrom^2'), symmetry=1, barrier=(19.2118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115464,'amu*angstrom^2'), symmetry=1, barrier=(7.5191,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.277197,0.101139,-0.000145123,1.05514e-07,-3.04273e-11,-105524,32.1579], Tmin=(100,'K'), Tmax=(848.704,'K')), NASAPolynomial(coeffs=[15.3979,0.0272586,-1.45433e-05,2.93907e-09,-2.1131e-13,-108185,-40.8937], Tmin=(848.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-878.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = 'OC(O[C]=CF)C(F)(F)F(7014)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction2',
    reactants = ['OC(OC(F)=CF)[C](F)F(3587)'],
    products = ['O=C(F)C(F)C(O)[C](F)F(7001)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'OC([C]F)OC(F)=CF(7002)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', 'O[CH]OC(F)=CF(4179)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OC(OC(F)=CF)[C](F)F(3587)'],
    products = ['OC1O[C](F)C(F)C1(F)F(7003)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(OC(F)=CF)[C](F)F(3587)'],
    products = ['OC1OC(F)([CH]F)C1(F)F(7004)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)[CH]F(215)', 'OC=C(F)F(3558)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'FC=C(F)OC=C(F)F(4736)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'OC(OC(F)=CF)=C(F)F(7005)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'OC(O[C]=CF)[C](F)F(7006)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(F)OC(O)[C](F)F(7007)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(F)[CH]F(215)', 'O[CH][C](F)F(3554)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHFCF[Z](72)', '[O]C(O)[C](F)F(4062)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'FC=C(F)O[CH][C](F)F(4732)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(OC(F)=CF)[C](F)F(4746)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O[C](OC(F)=CF)[C](F)F(7008)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'OC(OC(F)=[C]F)[C](F)F(7009)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'C#COC(O)[C](F)F(7010)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'OC(OC#CF)[C](F)F(7011)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OC(OC(F)=CF)[C](F)F(3587)'],
    products = ['HF(38)', 'O=C=CF(2952)', 'O=C[C](F)F(234)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F(37)', 'OC([C]F)OC(F)=CF-2(7012)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CF2(43)', 'O[CH]OC(F)=CF(4179)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O[C](OC(F)=CF)C(F)F(4970)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(OC(F)=[C]F)C(F)F(7013)'],
    products = ['OC(OC(F)=CF)[C](F)F(3587)'],
...
reaction(
    label = 'reaction26',
    reactants = ['OC(OC(F)=CF)[C](F)F(3587)'],
    products = ['OC(O[C]=CF)C(F)(F)F(7014)'],
...
reaction(
    label = 'reaction27',
    reactants = ['OC(OC(F)=CF)[C](F)F(3587)'],
    products = ['[CH]=C(F)OC(O)C(F)(F)F(7015)'],
