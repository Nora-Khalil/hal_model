...
This reaction matched rate rule [Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing]
family: R_Recombination"""),
)

reaction(
    label = 'reaction2',
    reactants = ['HO2(11)', 'CH2(S)(25)'],
    products = ['CO[O](2900)'],
    transitionState = 'TS2',
