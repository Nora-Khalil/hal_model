...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[O]C[O](2715)'],
    products = ['[O]CO[CH]F(2695)'],
    transitionState = 'TS2',
