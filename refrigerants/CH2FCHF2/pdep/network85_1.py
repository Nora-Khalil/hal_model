...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]C([O])=O(540)'],
    products = ['[O]C(=O)C[C](F)F(352)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(=O)C=C(F)F(546)'],
    products = ['[O]C(=O)C[C](F)F(352)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C([O])=O(540)'],
    products = ['[O]C(=O)C[C](F)F(352)'],
