...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', 'C=C[C]F(270)'],
    products = ['O=[C]CC=[C]F(8494)'],
    transitionState = 'TS3',
