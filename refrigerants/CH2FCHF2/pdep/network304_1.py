...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.60542,0.0766061,-8.63696e-05,4.86867e-08,-1.09456e-11,-100045,25.3899], Tmin=(100,'K'), Tmax=(1075.32,'K')), NASAPolynomial(coeffs=[15.0133,0.0230103,-1.16054e-05,2.33413e-09,-1.68878e-13,-103143,-45.1656], Tmin=(1075.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-832.822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-OdCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)

species(
    label = 'O=C=C(F)OC(F)CF(1566)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.386892,0.0768744,-8.2838e-05,4.33094e-08,-8.88128e-12,-96194,26.0422], Tmin=(100,'K'), Tmax=(1186.08,'K')), NASAPolynomial(coeffs=[17.7073,0.0184614,-8.96381e-06,1.78594e-09,-1.28922e-13,-100303,-60.4742], Tmin=(1186.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-800.903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)
...
species(
    label = 'F[C]1[CH]OC(F)C(F)O1(1591)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-506.517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,501,1494,1531,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,194,682,905,1196,1383,3221,201.815,201.909,201.973],'cm^-1')),
        HinderedRotor(inertia=(1.28827,'amu*angstrom^2'), symmetry=1, barrier=(37.2689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28733,'amu*angstrom^2'), symmetry=1, barrier=(37.2751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29375,'amu*angstrom^2'), symmetry=1, barrier=(37.2743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.901668,0.0618554,-5.88299e-05,2.73027e-08,-4.97402e-12,-60803.1,23.8206], Tmin=(100,'K'), Tmax=(1330.3,'K')), NASAPolynomial(coeffs=[16.186,0.0158978,-7.00955e-06,1.33334e-09,-9.36525e-14,-64869.6,-54.2795], Tmin=(1330.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-506.517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCOF1sO2s)"""),
)
...
"""),
    E0 = (-602.262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,334,575,1197,1424,3202,197,221,431,657,2120,512.5,787.5,180.003,180.006,285.634,615.146,616.142],'cm^-1')),
        HinderedRotor(inertia=(0.929943,'amu*angstrom^2'), symmetry=1, barrier=(21.3825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140088,'amu*angstrom^2'), symmetry=1, barrier=(37.6628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0796064,'amu*angstrom^2'), symmetry=1, barrier=(21.3517,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.326174,0.0829173,-0.000106495,6.65285e-08,-1.62535e-11,-72304.7,26.6193], Tmin=(100,'K'), Tmax=(1003.03,'K')), NASAPolynomial(coeffs=[16.6406,0.0178563,-9.19722e-06,1.85892e-09,-1.3478e-13,-75577.5,-52.1374], Tmin=(1003.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-602.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-611.301,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,355,410,600,1181,1341,1420,3056,334,575,1197,1424,3202,1855,455,950,201.022,201.023,201.023,201.023],'cm^-1')),
        HinderedRotor(inertia=(0.351207,'amu*angstrom^2'), symmetry=1, barrier=(10.0713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.351207,'amu*angstrom^2'), symmetry=1, barrier=(10.0713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.836554,'amu*angstrom^2'), symmetry=1, barrier=(23.9893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45622,'amu*angstrom^2'), symmetry=1, barrier=(41.7589,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.283168,0.0929345,-0.000131717,7.59905e-08,-4.37468e-12,-73399.6,28.249], Tmin=(100,'K'), Tmax=(572.375,'K')), NASAPolynomial(coeffs=[12.6644,0.0272567,-1.42319e-05,2.7847e-09,-1.93945e-13,-75158.4,-27.558], Tmin=(572.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-611.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = 'O=CC(F)O[C](F)[CH]F(1599)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-574.961,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([232,360,932,1127,1349,1365,3045,395,473,707,1436,2782.5,750,1395,475,1775,1000,334,575,1197,1424,3202,245.09,245.095,245.097,245.098],'cm^-1')),
        HinderedRotor(inertia=(0.202038,'amu*angstrom^2'), symmetry=1, barrier=(8.61263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.52446,'amu*angstrom^2'), symmetry=1, barrier=(22.3566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202048,'amu*angstrom^2'), symmetry=1, barrier=(8.61263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.988744,'amu*angstrom^2'), symmetry=1, barrier=(42.1495,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.172773,0.100899,-0.000170969,1.4903e-07,-5.06353e-11,-69010.3,30.0999], Tmin=(100,'K'), Tmax=(821.248,'K')), NASAPolynomial(coeffs=[11.91,0.0288288,-1.51885e-05,2.97177e-09,-2.06459e-13,-70549.2,-23.0991], Tmin=(821.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-574.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'O=[C][C](F)OC(F)CF(1600)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.366855,0.0873846,-0.000137255,1.18338e-07,-4.08026e-11,-80544.9,27.7305], Tmin=(100,'K'), Tmax=(790.014,'K')), NASAPolynomial(coeffs=[9.72079,0.0318558,-1.63133e-05,3.19303e-09,-2.23432e-13,-81767.9,-13.5788], Tmin=(790.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-670.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(CsCOF1sO2s) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = 'O=CC(F)(F)O[CH][CH]F(1601)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-605.625,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([251,367,519,700,855,1175,1303,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,334,575,1197,1424,3202,272.822,275.878,279.066,279.869],'cm^-1')),
        HinderedRotor(inertia=(0.143638,'amu*angstrom^2'), symmetry=1, barrier=(7.92657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145164,'amu*angstrom^2'), symmetry=1, barrier=(7.93709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144403,'amu*angstrom^2'), symmetry=1, barrier=(7.93516,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.552763,'amu*angstrom^2'), symmetry=1, barrier=(29.8727,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.377992,0.107136,-0.000189797,1.68332e-07,-5.7308e-11,-72692.6,31.0472], Tmin=(100,'K'), Tmax=(843.672,'K')), NASAPolynomial(coeffs=[12.1551,0.0282764,-1.503e-05,2.92348e-09,-2.01264e-13,-74115.6,-23.1875], Tmin=(843.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-605.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)

species(
    label = 'O=C[C](F)O[CH]C(F)F(1602)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04883,0.0490524,3.73351e-06,-5.41176e-08,2.88836e-11,-102938,15.289], Tmin=(100,'K'), Tmax=(909.373,'K')), NASAPolynomial(coeffs=[19.6817,0.00929807,-3.08683e-07,-1.17902e-10,7.70519e-15,-108072,-82.4288], Tmin=(909.373,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-856.885,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(CsCFHO) + group(CdCFO) + group(Cds-CdsOsH) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(23dihydro14dioxin)"""),
)

species(
    label = 'OC=C(F)OC(F)=CF(1605)',
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03054,0.0718653,-9.24515e-05,7.00726e-08,-2.2491e-11,-63317.2,26.1281], Tmin=(100,'K'), Tmax=(747.599,'K')), NASAPolynomial(coeffs=[7.975,0.0347082,-1.78966e-05,3.58693e-09,-2.57278e-13,-64355.5,-5.35468], Tmin=(747.599,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-527.288,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(CsCsCsFH) + group(CsCFHO) + group(Cs-CsOsHH) + ring(O2s-Cs-Cs-Cs(F)) + radical(CCOJ) + radical(CCsJOH) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.04452,'amu*angstrom^2'), symmetry=1, barrier=(24.0157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04456,'amu*angstrom^2'), symmetry=1, barrier=(24.0164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0438,'amu*angstrom^2'), symmetry=1, barrier=(23.999,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.504457,0.0765134,-0.000102137,6.49991e-08,-1.59073e-11,-20838.5,26.8572], Tmin=(100,'K'), Tmax=(1010.49,'K')), NASAPolynomial(coeffs=[17.0176,0.0111472,-5.10623e-06,9.84063e-10,-6.97722e-14,-24175.8,-52.9815], Tmin=(1010.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(C=CJO)"""),
)

species(
    label = 'O[C]=C(F)OC(F)[CH]F(1608)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-559.389,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,326,540,652,719,1357,395,473,707,1436,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.01108,'amu*angstrom^2'), symmetry=1, barrier=(23.2467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01094,'amu*angstrom^2'), symmetry=1, barrier=(23.2434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01055,'amu*angstrom^2'), symmetry=1, barrier=(23.2346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01085,'amu*angstrom^2'), symmetry=1, barrier=(23.2415,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.508806,0.0998365,-0.000137603,8.98171e-08,-2.25237e-11,-67117,29.3832], Tmin=(100,'K'), Tmax=(986.569,'K')), NASAPolynomial(coeffs=[20.7411,0.0136797,-6.60888e-06,1.29858e-09,-9.28105e-14,-71309.9,-72.848], Tmin=(986.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-559.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'FC=CO[C](F)[CH]OF(1610)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-223.257,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,395,473,707,1436,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,194,682,905,1196,1383,3221,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.333146,0.0977243,-0.000133834,8.78524e-08,-2.23378e-11,-26697.5,29.7592], Tmin=(100,'K'), Tmax=(969.248,'K')), NASAPolynomial(coeffs=[19.2706,0.0168214,-8.62908e-06,1.73444e-09,-1.25187e-13,-30497.6,-64.2052], Tmin=(969.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsCFHO) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCsF1sO2s) + radical(CCsJO)"""),
)

species(
    label = 'F[CH]C(F)O[C]=COF(1611)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-629.252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,3010,987.5,1337.5,450,1655,1685,370,180,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.29596,'amu*angstrom^2'), symmetry=1, barrier=(29.7967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29697,'amu*angstrom^2'), symmetry=1, barrier=(29.82,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.30086,'amu*angstrom^2'), symmetry=1, barrier=(29.9094,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.995898,0.0876774,-9.65217e-05,4.81039e-08,-8.85901e-12,-75482.6,33.3918], Tmin=(100,'K'), Tmax=(1515.65,'K')), NASAPolynomial(coeffs=[26.9892,0.00136425,1.22846e-06,-3.14715e-10,2.18726e-14,-82535,-108.537], Tmin=(1515.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-629.252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(284)', '[O]C(F)[CH]F(208)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'O=C[C](F)O[CH]F(1588)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C[C](F)OC(F)[CH]F(1563)'],
    products = ['O=CC1(F)OC(F)C1F(1565)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C[C](F)OC(F)[CH]F(1563)'],
    products = ['F[CH]C(F)OC1(F)[CH]O1(1590)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C[C](F)OC(F)[CH]F(1563)'],
    products = ['F[C]1[CH]OC(F)C(F)O1(1591)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=C[C](F)OC(F)[CH]F(1563)'],
    products = ['[O]C1[C](F)OC(F)C1F(1592)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.81516e-05,'m^3/(mol*s)'), n=3.04336, Ea=(31.047,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=C[C](F)OC=CF(1593)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C[C](F)OC(F)=CF(1594)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C=C(F)OC(F)[CH]F(1595)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C[C]F-2(1596)', '[O]C(F)[CH]F(208)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', 'O=C[C](F)O[CH]F(1588)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C[C](F)OC(F)[CH]F(1563)'],
    products = ['O=C[C](F)O[C](F)CF(1597)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]C(F)OC(F)[CH]F(1598)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=CC(F)O[C](F)[CH]F(1599)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=CC(F)(F)O[CH][CH]F(1601)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(213.984,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['O=C[C](F)OC(F)[CH]F(1563)'],
    products = ['O=C[C](F)O[CH]C(F)F(1602)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(C(=O)F)C(F)[CH]F(1560)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(6)', '[CH]=C(F)OC(F)[CH]F(1603)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=C[C](F)OC(F)[CH]F(1563)'],
    products = ['FC1=COC(F)C(F)O1(1604)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O=C[C](F)OC(F)[CH]F(1563)'],
    products = ['[O][CH]C1(F)OC(F)C1F(1606)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(4.06771e+06,'s^-1'), n=1.35044, Ea=(103.328,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 101.9 to 103.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction29',
    reactants = ['HF(38)', 'O=C=[C]OC(F)[CH]F(1607)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O[C]=C(F)OC(F)[CH]F(1608)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction31',
    reactants = ['OC=C(F)O[C](F)[CH]F(1609)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction32',
    reactants = ['FC=CO[C](F)[CH]OF(1610)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
    transitionState = 'TS32',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(53.1745,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction33',
    reactants = ['F[CH]C(F)O[C]=COF(1611)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[O]C=[C]OC(F)C(F)F(1612)'],
    products = ['O=C[C](F)OC(F)[CH]F(1563)'],
    transitionState = 'TS34',
    kinetics = Arrhenius(A=(9.39758e+07,'s^-1'), n=1.42748, Ea=(198.314,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F
Multiplied by reaction path degeneracy 2.0"""),
)
