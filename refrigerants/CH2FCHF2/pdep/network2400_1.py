...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0190533,'amu*angstrom^2'), symmetry=1, barrier=(14.6542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.47092,'amu*angstrom^2'), symmetry=1, barrier=(56.8113,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH]C=C(9236)'],
    products = ['[CH]=CC[C](F)F(9234)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[CH](4466)', 'CH2CF2(57)'],
    products = ['[CH]=CC[C](F)F(9234)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=CC=C(F)F(9239)'],
    products = ['[CH]=CC[C](F)F(9234)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](4466)', '[CH2][C](F)F(163)'],
    products = ['[CH]=CC[C](F)F(9234)'],
