species(
    label = '[CH2]C(F)(F)C1(F)[CH]O1(7376)',
...
species(
    label = '[CH2]C1(F)O[CH]C1(F)F(7470)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
    products = ['[CH2]C1(F)O[CH]C1(F)F(7470)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(7377)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
    products = ['F[C](F)CC1(F)[CH]O1(7378)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C1(F)[CH]O1(7471)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)[C](F)C=O(1908)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)(F)C1=CO1(7472)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C1(F)[CH]O1(7473)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C]1[CH]O1(7422)', 'CH2CF2(57)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]1[CH]O1(7422)', '[CH2][C](F)F(163)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH2]C(F)=C1[CH]O1(7474)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
    products = ['[CH2]C(F)(F)[C]1OC1F(7467)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
    products = ['FCC(F)(F)[C]1[CH]O1(7475)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
    products = ['[CH2][C](F)C1(F)OC1F(7476)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC[C](F)C1(F)[CH]O1(7439)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(7376)'],
