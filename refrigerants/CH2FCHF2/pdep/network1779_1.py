...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]O[O](231)', 'O=C[C]F(284)'],
    products = ['[CH2]OO[C](F)C=O(6175)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]O[C](F)C=O(1934)'],
    products = ['[CH2]OO[C](F)C=O(6175)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]OO[C](F)C=O(6175)'],
    products = ['[CH2]OOC1(F)[CH]O1(6627)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]O[O](231)', 'O=C[C]F-2(1596)'],
    products = ['[CH2]OO[C](F)C=O(6175)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(6)', '[CH]=C(F)OO[CH2](6632)'],
    products = ['[CH2]OO[C](F)C=O(6175)'],
