...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', '[CH2]C[C]=O(6367)'],
    products = ['O=[C]CC[C]=O(13738)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]C[C]=O(6367)'],
    products = ['O=[C]CC[C]=O(13738)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=[C]CC=C=O(13785)'],
    products = ['O=[C]CC[C]=O(13738)'],
    transitionState = 'TS8',
