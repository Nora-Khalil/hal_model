...
reaction(
    label = 'reaction1',
    reactants = ['H(5)', 'FC=C=C(F)F(5206)'],
    products = ['F[CH]C=C(F)F(5039)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C=C(F)F(9242)'],
    products = ['F[CH]C=C(F)F(5039)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'F[C]C=C(F)F(11769)'],
    products = ['F[CH]C=C(F)F(5039)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C=C(F)F(5039)'],
    products = ['FC1[CH]C1(F)F(11770)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[CH][C]=C(F)F(6282)'],
    products = ['F[CH]C=C(F)F(5039)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'FC#C[CH]F(5082)'],
    products = ['F[CH]C=C(F)F(5039)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C]C=C(F)F-2(6211)'],
    products = ['F[CH]C=C(F)F(5039)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'F[C]C=CF-2(11771)'],
    products = ['F[CH]C=C(F)F(5039)'],
