...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C#COO(7307)'],
    products = ['C#COOCF(3372)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COOF(7308)'],
    products = ['C#COOCF(3372)'],
    transitionState = 'TS3',
