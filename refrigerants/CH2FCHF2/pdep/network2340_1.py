...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C=C(F)F(8897)'],
    products = ['[CH]=CC([CH2])(F)F(8860)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#CC([CH2])(F)F(298)'],
    products = ['[CH]=CC([CH2])(F)F(8860)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[CH]=C=C([CH2])F(299)'],
    products = ['[CH]=CC([CH2])(F)F(8860)'],
