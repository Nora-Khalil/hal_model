...
"""),
    E0 = (558.874,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([374,480,2175,525,180],'cm^-1')),
        HinderedRotor(inertia=(0.265396,'amu*angstrom^2'), symmetry=1, barrier=(89.9612,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (59.0191,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.89136,0.0278038,-5.34187e-05,4.72763e-08,-1.53026e-11,67253.8,11.8468], Tmin=(100,'K'), Tmax=(936.133,'K')), NASAPolynomial(coeffs=[6.21828,0.00460157,-1.84132e-06,2.90775e-10,-1.6294e-14,67024.7,-1.88093], Tmin=(936.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(558.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O(6)', '[C]#CF(235)'],
    products = ['O=C=[C]F(289)'],
    transitionState = 'TS1',
...
reaction(
    ...
    products = ['FC1=[C]O1(8451)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.631e+12,'s^-1'), n=0.216, Ea=(281.892,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R3;multiplebond_intra;radadd_intra_cdsingle]
...
reaction(
    label = 'reaction4',
    reactants = ['[C]#COF(11054)'],
    products = ['O=C=[C]F(289)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(47.7921,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
