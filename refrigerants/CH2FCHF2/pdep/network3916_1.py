...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'F[C]C(F)(F)F-2(9639)'],
    products = ['F[C](F)C(F)(F)F(11865)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C](F)[C](F)F(4977)'],
    products = ['F[C](F)C(F)(F)F(11865)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]C(F)(F)F(4171)'],
    products = ['F[C](F)C(F)(F)F(11865)'],
    transitionState = 'TS5',
