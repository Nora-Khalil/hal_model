...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.939925,'amu*angstrom^2'), symmetry=1, barrier=(21.6107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.387136,'amu*angstrom^2'), symmetry=1, barrier=(8.90103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.387034,'amu*angstrom^2'), symmetry=1, barrier=(8.89867,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-115.046,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,461.606,461.618],'cm^-1')),
        HinderedRotor(inertia=(0.0592676,'amu*angstrom^2'), symmetry=1, barrier=(8.96159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217617,'amu*angstrom^2'), symmetry=1, barrier=(32.9052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217627,'amu*angstrom^2'), symmetry=1, barrier=(32.9051,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.938542,'amu*angstrom^2'), symmetry=1, barrier=(21.5789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.942315,'amu*angstrom^2'), symmetry=1, barrier=(21.6657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(128)', '[CH2]C(O)F(5650)'],
    products = ['OC(F)COF(5391)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]F(361)', '[CH2]OF(2545)'],
    products = ['OC(F)COF(5391)'],
