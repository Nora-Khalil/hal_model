...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.641252,'amu*angstrom^2'), symmetry=1, barrier=(14.7436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.641011,'amu*angstrom^2'), symmetry=1, barrier=(14.7381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.640931,'amu*angstrom^2'), symmetry=1, barrier=(14.7363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-628.454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,2750,2850,1437.5,1250,1305,750,350,180,180,180,875.703],'cm^-1')),
        HinderedRotor(inertia=(0.0936694,'amu*angstrom^2'), symmetry=1, barrier=(2.15364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0936862,'amu*angstrom^2'), symmetry=1, barrier=(2.15403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-636.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,493,600,700,1144,1293,198.557,198.941,199.009],'cm^-1')),
        HinderedRotor(inertia=(0.305838,'amu*angstrom^2'), symmetry=1, barrier=(8.58185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410251,'amu*angstrom^2'), symmetry=1, barrier=(11.516,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305555,'amu*angstrom^2'), symmetry=1, barrier=(8.57508,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OCO(6106)'],
    products = ['OCOC(F)F(5393)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(364)', 'CH2OH(33)'],
    products = ['OCOC(F)F(5393)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', '[CH2]OC(F)F(4809)'],
    products = ['OCOC(F)F(5393)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[CH]OC(F)F(1239)'],
    products = ['OCOC(F)F(5393)'],
    transitionState = 'TS9',
