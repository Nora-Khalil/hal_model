...
reaction(
    label = 'reaction3',
    reactants = ['FO[C](F)F(2677)', 'CHF(40)'],
    products = ['F[C](F)OC(F)F(5025)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]OC(F)F(13199)'],
    products = ['F[C](F)OC(F)F(5025)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(156)', '[O]C(F)F(364)'],
    products = ['F[C](F)OC(F)F(5025)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]O[C](F)F(426)'],
    products = ['F[C](F)OC(F)F(5025)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(2694)', 'CHF2(82)'],
    products = ['F[C](F)OC(F)F(5025)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)O[C](F)F(2738)'],
    products = ['F[C](F)OC(F)F(5025)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C-]=[O+]C(F)F(13200)'],
    products = ['F[C](F)OC(F)F(5025)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)OC(F)F(5025)'],
    products = ['F[CH]OC(F)(F)F(6026)'],
