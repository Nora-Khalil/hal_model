...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[C]=C(F)C(F)F(4873)'],
    products = ['[CH]=C(F)C(F)F(4843)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=[C]C(F)F(4875)'],
    products = ['[CH]=C(F)C(F)F(4843)'],
    transitionState = 'TS7',
