...
reaction(
    label = 'reaction3',
    reactants = ['FO[C](F)F(2563)', 'CHF(40)'],
    products = ['F[C](F)OC(F)F(4811)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]OC(F)F(13522)'],
    products = ['F[C](F)OC(F)F(4811)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(2580)', 'CHF2(82)'],
    products = ['F[C](F)OC(F)F(4811)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)O[C](F)F(2625)'],
    products = ['F[C](F)OC(F)F(4811)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C-]=[O+]C(F)F(13523)'],
    products = ['F[C](F)OC(F)F(4811)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)OC(F)F(4811)'],
    products = ['F[CH]OC(F)(F)F(6023)'],
