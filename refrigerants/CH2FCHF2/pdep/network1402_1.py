...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.478337,'amu*angstrom^2'), symmetry=1, barrier=(10.9979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477742,'amu*angstrom^2'), symmetry=1, barrier=(10.9842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0602,'amu*angstrom^2'), symmetry=1, barrier=(24.376,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'OC(F)([C]F)C(F)(F)CF-2(5012)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.492729,0.106501,-0.000158403,1.19327e-07,-3.5592e-11,-115007,28.955], Tmin=(100,'K'), Tmax=(821.887,'K')), NASAPolynomial(coeffs=[15.6475,0.0279471,-1.50353e-05,3.03307e-09,-2.17294e-13,-117660,-45.746], Tmin=(821.887,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-957.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + radical(CsCCl_triplet)"""),
)

species(
    label = 'OC(=CF)C(F)(F)CF(4765)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.342904,'amu*angstrom^2'), symmetry=1, barrier=(7.88404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343379,'amu*angstrom^2'), symmetry=1, barrier=(7.89497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343946,'amu*angstrom^2'), symmetry=1, barrier=(7.908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.970809,'amu*angstrom^2'), symmetry=1, barrier=(22.3208,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.649248,0.116869,-0.0002162,1.98944e-07,-6.92936e-11,-89763.9,30.3968], Tmin=(100,'K'), Tmax=(857.739,'K')), NASAPolynomial(coeffs=[10.551,0.0341181,-1.81168e-05,3.50465e-09,-2.39648e-13,-90562.6,-15.3751], Tmin=(857.739,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-747.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsCsFHH) + radical(C2CsJOH) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
species(
    label = '[CH2]C(F)(F)C(O)(F)[CH]F(3153)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.413421,'amu*angstrom^2'), symmetry=1, barrier=(9.50535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.413646,'amu*angstrom^2'), symmetry=1, barrier=(9.51054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44979,'amu*angstrom^2'), symmetry=1, barrier=(33.3335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.413444,'amu*angstrom^2'), symmetry=1, barrier=(9.50589,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.817441,'amu*angstrom^2'), symmetry=1, barrier=(18.7946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.818397,'amu*angstrom^2'), symmetry=1, barrier=(18.8166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.818677,'amu*angstrom^2'), symmetry=1, barrier=(18.823,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0703286,0.0993874,-0.000181885,1.61598e-07,-5.49736e-11,-84517,25.0138], Tmin=(100,'K'), Tmax=(830.026,'K')), NASAPolynomial(coeffs=[12.9177,0.0211049,-1.20575e-05,2.41724e-09,-1.69055e-13,-86132.5,-31.97], Tmin=(830.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-703.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sCs)(F1s)(H)) + radical(Csj(Cs-F1sO2sCs)(F1s)(F1s))"""),
)

species(
    label = 'OC(F)([CH]F)C(F)(F)[CH]F(3939)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.334319,'amu*angstrom^2'), symmetry=1, barrier=(7.68664,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3337,'amu*angstrom^2'), symmetry=1, barrier=(7.67242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334135,'amu*angstrom^2'), symmetry=1, barrier=(7.68243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43771,'amu*angstrom^2'), symmetry=1, barrier=(33.0557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.1821,'amu*angstrom^2'), symmetry=1, barrier=(27.1789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18197,'amu*angstrom^2'), symmetry=1, barrier=(27.1759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18225,'amu*angstrom^2'), symmetry=1, barrier=(27.1824,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.819153,0.0722425,-8.04242e-05,4.56206e-08,-1.03958e-11,-73576,23.6835], Tmin=(100,'K'), Tmax=(1058.02,'K')), NASAPolynomial(coeffs=[13.6354,0.023789,-1.17296e-05,2.33574e-09,-1.68038e-13,-76288,-38.8703], Tmin=(1058.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-612.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCdCsF1s)"""),
)

species(
    label = 'C=C(F)C(O)(F)[CH]F(5018)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.12425,'amu*angstrom^2'), symmetry=1, barrier=(25.8487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12178,'amu*angstrom^2'), symmetry=1, barrier=(25.7919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12313,'amu*angstrom^2'), symmetry=1, barrier=(25.8229,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.445888,0.0838508,-0.000121069,9.22946e-08,-2.81188e-11,-73371.5,25.3602], Tmin=(100,'K'), Tmax=(803.221,'K')), NASAPolynomial(coeffs=[12.0735,0.0259431,-1.29224e-05,2.52889e-09,-1.78133e-13,-75239.3,-28.1876], Tmin=(803.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-611.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CsCsF1sH)"""),
)
...
"""),
    ...
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.920537,0.118735,-0.000201007,1.74272e-07,-5.87783e-11,-139791,31.8326], Tmin=(100,'K'), Tmax=(826.265,'K')), NASAPolynomial(coeffs=[13.6402,0.0328412,-1.71104e-05,3.33203e-09,-2.30735e-13,-141671,-32.4538], Tmin=(826.265,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1163.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFFH) + group(CsCsFHH) + radical(C2CsJOH)"""),
)

species(
    label = 'OC(F)([C](F)CF)C(F)F(5020)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.603283,0.107859,-0.000151245,1.07255e-07,-3.00957e-11,-139760,30.8508], Tmin=(100,'K'), Tmax=(872.678,'K')), NASAPolynomial(coeffs=[16.7258,0.0284253,-1.47026e-05,2.94051e-09,-2.10477e-13,-142784,-50.3911], Tmin=(872.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1163.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    ...
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]CF(126)', 'OC(F)(F)[CH]F(3946)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'OC(F)([CH]F)C(F)(F)F(5009)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
    products = ['OC(F)(CF)C(F)(F)[CH]F(4760)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
    products = ['O[C](F)C(F)C(F)(F)CF(5010)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH]C(O)(F)C(F)(F)CF(5011)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OC(F)([C]F)C(F)(F)CF-2(5012)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(=CF)C(F)(F)CF(4765)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'FC=C(F)C(F)(F)CF(3763)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O[C]([CH]F)C(F)(F)CF(5013)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'OC(F)([CH]F)[C](F)CF(5014)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]C(F)(F)C(O)(F)[CH]F(3153)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'F[CH][C](F)C(F)(F)CF(3768)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(F)([CH]F)C(F)(F)CF(3940)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2F(46)', 'OC(F)([CH]F)[C](F)F(5015)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(F)([CH]F)C(F)(F)[CH]F(3939)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=C([CH]F)C(F)(F)CF(5016)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'OC(=CF)[C](F)CF(5017)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'C=C(F)C(O)(F)[CH]F(5018)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(5)', 'OC(F)([C]F)C(F)(F)CF(4749)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O]C(F)(CF)C(F)(F)CF(4757)'],
    products = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
...
reaction(
    label = 'reaction29',
    reactants = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
    products = ['O[C](C(F)F)C(F)(F)CF(5019)'],
...
reaction(
    label = 'reaction30',
    reactants = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
    products = ['OC(F)([C](F)CF)C(F)F(5020)'],
...
reaction(
    label = 'reaction31',
    reactants = ['OC(F)([CH]F)C(F)(F)CF(4759)'],
    products = ['[CH2]C(F)(F)C(O)(F)C(F)F(5021)'],
