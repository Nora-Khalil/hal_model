...
reaction(
    label = 'reaction2',
    reactants = ['O=C=C(O)OOF(5744)'],
    products = ['O=C(O)C(=O)OF(5357)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'O=[C]C(=O)OF(5750)'],
    products = ['O=C(O)C(=O)OF(5357)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(=O)C(=O)OF(5751)'],
    products = ['O=C(O)C(=O)OF(5357)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(128)', 'O=[C]C(=O)O(5752)'],
    products = ['O=C(O)C(=O)OF(5357)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OF(340)', 'O=[C]O(338)'],
    products = ['O=C(O)C(=O)OF(5357)'],
