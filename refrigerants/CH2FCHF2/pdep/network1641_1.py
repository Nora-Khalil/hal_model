...
"""),
    E0 = (-656.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,180,180,1763.85],'cm^-1')),
        HinderedRotor(inertia=(0.42605,'amu*angstrom^2'), symmetry=1, barrier=(9.79573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15049,'amu*angstrom^2'), symmetry=1, barrier=(26.452,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['COF(2660)', 'F[C]C(F)F(125)'],
    products = ['FOCC(F)C(F)F(5397)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'F[C]C(F)COF(2959)'],
    products = ['FOCC(F)C(F)F(5397)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(482)', 'C=C(F)C(F)F(5726)'],
    products = ['FOCC(F)C(F)F(5397)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(488)', 'C=CC(F)F(2982)'],
    products = ['FOCC(F)C(F)F(5397)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FOC[CH]C(F)F(2987)'],
    products = ['FOCC(F)C(F)F(5397)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[CH]C(F)COF(2969)'],
    products = ['FOCC(F)C(F)F(5397)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(F)C(F)F(3433)'],
    products = ['FOCC(F)C(F)F(5397)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(128)', '[CH2]C(F)C(F)F(4164)'],
    products = ['FOCC(F)C(F)F(5397)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(2659)', 'CHF2-CHF(67)'],
    products = ['FOCC(F)C(F)F(5397)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(82)', 'F[CH]COF(2967)'],
    products = ['FOCC(F)C(F)F(5397)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC[C](F)C(F)F(5727)'],
    products = ['FOCC(F)C(F)F(5397)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FO[CH]C(F)C(F)F(5434)'],
    products = ['FOCC(F)C(F)F(5397)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FOCC(F)[C](F)F(5728)'],
    products = ['FOCC(F)C(F)F(5397)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'FOCC=C(F)F(5729)'],
    products = ['FOCC(F)C(F)F(5397)'],
