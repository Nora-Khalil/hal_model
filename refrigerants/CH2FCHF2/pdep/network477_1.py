...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', '[O]C([O])F(441)'],
    products = ['[O]C(F)O[C](F)F(2702)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)F(426)'],
    products = ['[O]C(F)O[C](F)F(2702)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=CO[C](F)F(2722)'],
    products = ['[O]C(F)O[C](F)F(2702)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)O[C](F)F(2723)'],
    products = ['[O]C(F)O[C](F)F(2702)'],
    transitionState = 'TS9',
