...
"""),
    E0 = (-394.301,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,326,540,652,719,1357,194,682,905,1196,1383,3221],'cm^-1')),
        HinderedRotor(inertia=(0.152927,'amu*angstrom^2'), symmetry=1, barrier=(3.51609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152745,'amu*angstrom^2'), symmetry=1, barrier=(3.51191,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44799,0.0639243,-0.000100447,9.60548e-08,-3.67864e-11,-47339.1,22.8532], Tmin=(100,'K'), Tmax=(791.434,'K')), NASAPolynomial(coeffs=[4.27706,0.0350905,-1.82495e-05,3.60989e-09,-2.54419e-13,-47331.7,12.7423], Tmin=(791.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-394.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79066,0.0535895,-5.8719e-05,3.85903e-08,-1.10567e-11,-94345.3,20.3613], Tmin=(100,'K'), Tmax=(821.594,'K')), NASAPolynomial(coeffs=[6.73263,0.0295296,-1.47933e-05,2.9484e-09,-2.11554e-13,-95157.4,-2.50985], Tmin=(821.594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-785.056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-OsHHH) + group(COCsFO)"""),
)

species(
    label = '[CH2]OOC(F)[CH]F(3430)',
...
"""),
    E0 = (-192.776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,402.931],'cm^-1')),
        HinderedRotor(inertia=(2.03442,'amu*angstrom^2'), symmetry=1, barrier=(46.7753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.846713,'amu*angstrom^2'), symmetry=1, barrier=(19.4676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.03431,'amu*angstrom^2'), symmetry=1, barrier=(46.7729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.03555,'amu*angstrom^2'), symmetry=1, barrier=(46.8013,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15018,0.0679891,-8.20127e-05,5.29643e-08,-1.40597e-11,-23087.5,22.6098], Tmin=(100,'K'), Tmax=(904.874,'K')), NASAPolynomial(coeffs=[10.4412,0.0269189,-1.39327e-05,2.80744e-09,-2.02553e-13,-24769,-21.2855], Tmin=(904.874,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsHHH) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(CsJOOC)"""),
)

species(
    label = '[CH2]OO[C](F)CF(3369)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-196.863,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(1.94396,'amu*angstrom^2'), symmetry=1, barrier=(44.6954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.94558,'amu*angstrom^2'), symmetry=1, barrier=(44.7327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.538878,'amu*angstrom^2'), symmetry=1, barrier=(12.3899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.94653,'amu*angstrom^2'), symmetry=1, barrier=(44.7546,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06304,0.0706917,-9.99814e-05,8.07178e-08,-2.69809e-11,-23577.1,23.3637], Tmin=(100,'K'), Tmax=(725.004,'K')), NASAPolynomial(coeffs=[8.45737,0.0298973,-1.55832e-05,3.11388e-09,-2.22165e-13,-24649.3,-9.9321], Tmin=(725.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsHHH) + radical(CsCsF1sO2s) + radical(CsJOOC)"""),
)
...
"""),
    E0 = (31.7516,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,615,860,1140,1343,3152,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.206899,'amu*angstrom^2'), symmetry=1, barrier=(4.75702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63562,'amu*angstrom^2'), symmetry=1, barrier=(37.606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47619,0.0416473,-1.13102e-05,-7.37031e-08,8.43275e-11,3865.16,18.0278], Tmin=(100,'K'), Tmax=(437.53,'K')), NASAPolynomial(coeffs=[5.35057,0.0290192,-1.48142e-05,2.94117e-09,-2.09154e-13,3482.98,5.04354], Tmin=(437.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.7516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOC(3468)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (35.0211,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,293,496,537,1218,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.198741,'amu*angstrom^2'), symmetry=1, barrier=(4.56944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198902,'amu*angstrom^2'), symmetry=1, barrier=(4.57314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.44993,'amu*angstrom^2'), symmetry=1, barrier=(56.3288,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75033,0.0556212,-8.45898e-05,7.88633e-08,-2.98532e-11,4287.11,21.1104], Tmin=(100,'K'), Tmax=(780.287,'K')), NASAPolynomial(coeffs=[4.81184,0.0297698,-1.53682e-05,3.03884e-09,-2.14469e-13,4118.54,9.08127], Tmin=(780.287,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.0211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (-271.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,180,180,180,180,251.53],'cm^-1')),
        HinderedRotor(inertia=(2.25104,'amu*angstrom^2'), symmetry=1, barrier=(51.7558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24022,'amu*angstrom^2'), symmetry=1, barrier=(51.5071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.2339,'amu*angstrom^2'), symmetry=1, barrier=(51.3618,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26114,0.074001,-0.000137638,1.413e-07,-5.42902e-11,-32592.4,34.221], Tmin=(100,'K'), Tmax=(845.375,'K')), NASAPolynomial(coeffs=[1.36837,0.0409948,-2.1408e-05,4.1662e-09,-2.87935e-13,-31449.3,40.5901], Tmin=(845.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-271.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(Cs-OsHHH) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OOC(3471)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {5,S}
4  O u0 p2 c0 {3,S} {6,S}
...
"""),
    E0 = (-194.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,229.106],'cm^-1')),
        HinderedRotor(inertia=(0.459995,'amu*angstrom^2'), symmetry=1, barrier=(10.5762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42772,'amu*angstrom^2'), symmetry=1, barrier=(32.8261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42774,'amu*angstrom^2'), symmetry=1, barrier=(32.8266,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71382,0.0616697,-4.81494e-05,-4.82545e-08,8.018e-11,-23317.4,19.7459], Tmin=(100,'K'), Tmax=(461.539,'K')), NASAPolynomial(coeffs=[7.58566,0.0314094,-1.68469e-05,3.37141e-09,-2.39155e-13,-24079.2,-6.42252], Tmin=(461.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFFO) + group(Cs-OsHHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'COOC(F)[C]F(3472)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
4  O u0 p2 c0 {3,S} {6,S}
...
"""),
    E0 = (-233.198,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,617,898,1187],'cm^-1')),
        HinderedRotor(inertia=(1.27915,'amu*angstrom^2'), symmetry=1, barrier=(29.4103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28241,'amu*angstrom^2'), symmetry=1, barrier=(29.4851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28177,'amu*angstrom^2'), symmetry=1, barrier=(29.4704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27969,'amu*angstrom^2'), symmetry=1, barrier=(29.4227,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54088,0.0599111,-6.91614e-05,4.6025e-08,-1.31142e-11,-27963.8,22.102], Tmin=(100,'K'), Tmax=(831.419,'K')), NASAPolynomial(coeffs=[7.69816,0.0302885,-1.57186e-05,3.17281e-09,-2.29108e-13,-28987.7,-6.46665], Tmin=(831.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.198,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-OsHHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.49871,'amu*angstrom^2'), symmetry=1, barrier=(34.4583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49701,'amu*angstrom^2'), symmetry=1, barrier=(34.4192,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3275,0.0401583,-3.87761e-05,2.12741e-08,-5.05629e-12,22824,15.1398], Tmin=(100,'K'), Tmax=(976.241,'K')), NASAPolynomial(coeffs=[6.78206,0.0219063,-1.07316e-05,2.1226e-09,-1.51848e-13,21954.3,-6.24368], Tmin=(976.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-OsHHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (89.5268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,239,401,1367],'cm^-1')),
        HinderedRotor(inertia=(0.193053,'amu*angstrom^2'), symmetry=1, barrier=(4.43867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47937,'amu*angstrom^2'), symmetry=1, barrier=(34.0136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73299,'amu*angstrom^2'), symmetry=1, barrier=(39.8449,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88581,0.0519778,-7.92795e-05,7.34007e-08,-2.78901e-11,10838.4,19.0332], Tmin=(100,'K'), Tmax=(755.78,'K')), NASAPolynomial(coeffs=[5.24337,0.0266976,-1.42e-05,2.84658e-09,-2.02696e-13,10545.4,5.19407], Tmin=(755.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.5268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-OsHHH) + group(Ct-CtOs) + group(CtCF)"""),
)
...
"""),
    E0 = (-285.368,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,942.944,944.102,946.123,946.36,947.106],'cm^-1')),
        HinderedRotor(inertia=(0.182607,'amu*angstrom^2'), symmetry=1, barrier=(4.19849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183468,'amu*angstrom^2'), symmetry=1, barrier=(4.21829,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['COOC(F)=CF(3371)'],
    products = ['CH2O(20)', 'O=C(F)CF(879)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1054.45,'s^-1'), n=2.72887, Ea=(27.3387,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OOC(F)=CF(212)'],
    products = ['COOC(F)=CF(3371)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(F)OOC(3468)'],
    products = ['COOC(F)=CF(3371)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CO[O](2900)', 'CHFCF[Z](72)'],
    products = ['COOC(F)=CF(3371)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]OOC(F)=CF(3295)'],
    products = ['COOC(F)=CF(3371)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF(40)', 'CO[O+]=[C-]F(3475)'],
    products = ['COOC(F)=CF(3371)'],
