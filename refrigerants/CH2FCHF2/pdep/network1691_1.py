...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.654327,'amu*angstrom^2'), symmetry=1, barrier=(15.0443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.654888,'amu*angstrom^2'), symmetry=1, barrier=(15.0572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07735,'amu*angstrom^2'), symmetry=1, barrier=(24.7705,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.057,'amu'),
...
"""),
    E0 = (-656.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,180,180,1763.84],'cm^-1')),
        HinderedRotor(inertia=(0.426047,'amu*angstrom^2'), symmetry=1, barrier=(9.79566,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-520.824,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,2507.96],'cm^-1')),
        HinderedRotor(inertia=(0.397302,'amu*angstrom^2'), symmetry=1, barrier=(9.13474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3622,'amu*angstrom^2'), symmetry=1, barrier=(31.3197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.221503,'amu*angstrom^2'), symmetry=1, barrier=(5.0928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03206,'amu*angstrom^2'), symmetry=1, barrier=(23.7292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221482,'amu*angstrom^2'), symmetry=1, barrier=(5.09231,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['FOCC(F)C(F)F(5405)'],
    products = ['HF(38)', 'CH2O(20)', 'CHFCF2(55)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2F2(41)', 'F[C]COF(2842)'],
    products = ['FOCC(F)C(F)F(5405)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['COF(2546)', 'F[C]C(F)F(125)'],
    products = ['FOCC(F)C(F)F(5405)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FOC(F)C(F)F(484)'],
    products = ['FOCC(F)C(F)F(5405)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'F[C]C(F)COF(2844)'],
    products = ['FOCC(F)C(F)F(5405)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(482)', 'C=C(F)C(F)F(5654)'],
    products = ['FOCC(F)C(F)F(5405)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(488)', 'C=CC(F)F(2867)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FOC[CH]C(F)F(2872)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[CH]C(F)COF(2854)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(F)C(F)F(3615)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(128)', '[CH2]C(F)C(F)F(4001)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(2545)', 'CHF2-CHF(67)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(82)', 'F[CH]COF(2852)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC[C](F)C(F)F(5655)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FO[CH]C(F)C(F)F(5430)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FOCC(F)[C](F)F(5656)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'FC=C(F)COF(5549)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'FOC=CC(F)F(731)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'FOCC=C(F)F(5657)'],
    products = ['FOCC(F)C(F)F(5405)'],
...
reaction(
    label = 'reaction25',
    reactants = ['FOCC(F)C(F)F(5405)'],
    products = ['F2(78)', 'CH2O(20)', 'CHFCHF[Z](59)'],
...
network(
    label = 'PDepNetwork #1691',
    isomers = [
        'FOCC(F)C(F)F(5405)',
    ],
    reactants = [
        ('HF(38)', 'CH2O(20)', 'CHFCF2(55)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
