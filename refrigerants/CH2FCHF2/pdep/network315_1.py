...
reaction(
    label = 'reaction1',
    reactants = ['O=C[C](F)OC[C](F)F(1574)'],
...
reaction(
    ...
    products = ['O=C[C](F)OC[C](F)F(1574)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]O[C](F)C=O(1672)'],
    products = ['O=C[C](F)OC[C](F)F(1574)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C[C](F)OC[C](F)F(1574)'],
    products = ['F[C](F)COC1(F)[CH]O1(1674)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C[C](F)OC=C(F)F(1677)'],
    products = ['O=C[C](F)OC[C](F)F(1574)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=C(F)OC[C](F)F(1678)'],
    products = ['O=C[C](F)OC[C](F)F(1574)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C[C]F-2(1596)', '[O]C[C](F)F(230)'],
    products = ['O=C[C](F)OC[C](F)F(1574)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[CH2]O[C](F)C=O(1672)'],
    products = ['O=C[C](F)OC[C](F)F(1574)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=CC(F)O[CH][C](F)F(1680)'],
    products = ['O=C[C](F)OC[C](F)F(1574)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(6)', '[CH]=C(F)OC[C](F)F(1682)'],
    products = ['O=C[C](F)OC[C](F)F(1574)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O=C[C](F)OC[C](F)F(1574)'],
    products = ['[O][CH]C1(F)OCC1(F)F(1685)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O[C]=C(F)OC[C](F)F(1687)'],
    products = ['O=C[C](F)OC[C](F)F(1574)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OC=C(F)O[CH][C](F)F(1688)'],
    products = ['O=C[C](F)OC[C](F)F(1574)'],
