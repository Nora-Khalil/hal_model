...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)[CH]F(208)', '[CH]C-2(4371)'],
    products = ['C[CH]OC(F)[CH]F(4404)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'C[CH]O[CH]F(4435)'],
    products = ['C[CH]OC(F)[CH]F(4404)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[CH]OC=CF(4437)'],
    products = ['C[CH]OC(F)[CH]F(4404)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C[CH]OC(F)=CF(4439)'],
    products = ['C[CH]OC(F)[CH]F(4404)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=COC(F)[CH]F(4440)'],
    products = ['C[CH]OC(F)[CH]F(4404)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'C[CH]O[CH]F(4435)'],
    products = ['C[CH]OC(F)[CH]F(4404)'],
