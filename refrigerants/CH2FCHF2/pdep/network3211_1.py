...
species(
    label = '[O]C(F)[CH]OC(F)(F)OF(12483)',
...
species(
    label = 'O=C(F)[CH]OC(F)(F)OF(12489)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)COC(F)(F)OF(12450)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FCOC(F)(F)OF(5206)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)(F)OF(5026)', 'CH2CO(28)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C(F)OOC(F)(F)OF(12482)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)[CH]OC(F)(F)OF(12483)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(F)CO[C](F)OF(12485)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]COC(F)(F)OF(12486)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)(F)OCC(=O)F(12487)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(F)OF(5030)', 'CH2CFO(79)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FO[C](F)F(2563)', '[O]CC(=O)F(1554)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(128)', 'O=C(F)CO[C](F)F(12488)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CFO(51)', '[CH2]OC(F)(F)OF(5420)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(F)[CH]OC(F)(F)OF(12489)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', 'O=C(F)COC(=O)F(2171)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=C=COC(F)(F)OF(12490)'],
    products = ['O=C(F)COC(F)(F)OF(12450)'],
...
network(
    label = 'PDepNetwork #3211',
    isomers = [
        'O=C(F)COC(F)(F)OF(12450)',
    ],
    reactants = [
