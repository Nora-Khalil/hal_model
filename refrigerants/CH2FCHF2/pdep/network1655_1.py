...
"""),
    E0 = (-577.166,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,2750,2850,1437.5,1250,1305,750,350,617,898,1187,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.14136,'amu*angstrom^2'), symmetry=1, barrier=(26.242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14139,'amu*angstrom^2'), symmetry=1, barrier=(26.2427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14138,'amu*angstrom^2'), symmetry=1, barrier=(26.2427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14117,'amu*angstrom^2'), symmetry=1, barrier=(26.2378,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.312284,0.0881199,-0.000132235,1.01623e-07,-3.11098e-11,-69290.6,27.4261], Tmin=(100,'K'), Tmax=(799.35,'K')), NASAPolynomial(coeffs=[12.9333,0.0249656,-1.37283e-05,2.79024e-09,-2.00631e-13,-71308.4,-30.6369], Tmin=(799.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-577.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsFHOO) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00467625,0.0953147,-0.000142075,1.13059e-07,-3.61873e-11,-112853,27.8325], Tmin=(100,'K'), Tmax=(763.513,'K')), NASAPolynomial(coeffs=[12.224,0.0312985,-1.63084e-05,3.2448e-09,-2.3039e-13,-114719,-27.8214], Tmin=(763.513,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-939.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFHOO)"""),
)
...
"""),
    E0 = (-537.199,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-661.288,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,580,1155,1237,1373,3147,180,180,180,1621.79],'cm^-1')),
        HinderedRotor(inertia=(0.422207,'amu*angstrom^2'), symmetry=1, barrier=(9.70736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.423742,'amu*angstrom^2'), symmetry=1, barrier=(9.74266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26402,'amu*angstrom^2'), symmetry=1, barrier=(29.0624,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.37757,0.0633554,-0.000162632,3.07746e-07,-2.3651e-10,-79534.5,13.5576], Tmin=(10,'K'), Tmax=(378.08,'K')), NASAPolynomial(coeffs=[5.15593,0.0365112,-2.42736e-05,7.60769e-09,-9.05581e-13,-79611.6,7.46668], Tmin=(378.08,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-661.288,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""F[CH]OC(F)CF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-734.1,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.284933,0.102166,-0.000168779,1.42567e-07,-4.73124e-11,-88145.1,28.5898], Tmin=(100,'K'), Tmax=(796.047,'K')), NASAPolynomial(coeffs=[13.4697,0.0265614,-1.40865e-05,2.77505e-09,-1.94073e-13,-90129.4,-33.3394], Tmin=(796.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-734.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHOO) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs))"""),
)

species(
    label = 'F[CH]C(F)OC(F)OF(5518)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0325841,0.0959008,-0.000142999,1.09044e-07,-3.30448e-11,-87701.1,28.0761], Tmin=(100,'K'), Tmax=(808.215,'K')), NASAPolynomial(coeffs=[13.9781,0.0265584,-1.43014e-05,2.88423e-09,-2.06527e-13,-89965.7,-36.5338], Tmin=(808.215,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-730.341,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHOO) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-807.49,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,2782.5,750,1395,475,1775,1000,434.812,435.016,435.479],'cm^-1')),
        HinderedRotor(inertia=(0.272241,'amu*angstrom^2'), symmetry=1, barrier=(36.5178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272107,'amu*angstrom^2'), symmetry=1, barrier=(36.5023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271056,'amu*angstrom^2'), symmetry=1, barrier=(36.5224,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58948,0.045126,-2.49438e-05,2.19725e-09,1.39869e-12,-97025.4,21.6724], Tmin=(100,'K'), Tmax=(1242.02,'K')), NASAPolynomial(coeffs=[13.1405,0.0201611,-9.571e-06,1.87773e-09,-1.33589e-13,-100838,-40.3576], Tmin=(1242.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-807.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsH)"""),
)

species(
    label = 'C=COC(F)OF(5519)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-626.449,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.01795,'amu*angstrom^2'), symmetry=1, barrier=(23.4046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01701,'amu*angstrom^2'), symmetry=1, barrier=(23.3829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01778,'amu*angstrom^2'), symmetry=1, barrier=(23.4008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583196,0.0743157,-8.74299e-05,4.98129e-08,-1.10773e-11,-75220.6,23.1322], Tmin=(100,'K'), Tmax=(1100.26,'K')), NASAPolynomial(coeffs=[16.6516,0.0158989,-7.78952e-06,1.55743e-09,-1.12729e-13,-78756.5,-55.9238], Tmin=(1100.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-626.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFHOO) + group(CdCFO) + group(Cds-CdsHH)"""),
)

species(
    label = 'FC=COC(F)OF(5521)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
4  O u0 p2 c0 {6,S} {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FCC(F)OC(F)OF(5411)'],
    products = ['HF(38)', 'CHFO(47)', 'O=C(F)CF(879)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(20.4336,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['OC(F)OF(1035)', 'F[C]CF(126)'],
    products = ['FCC(F)OC(F)OF(5411)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(52.3781,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FCOC(F)OF(1032)'],
    products = ['FCC(F)OC(F)OF(5411)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(125.518,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'F[C]C(F)OC(F)OF(5510)'],
    products = ['FCC(F)OC(F)OF(5411)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FOC(F)OC(F)F(5405)'],
    products = ['FCC(F)OC(F)OF(5411)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(158.81,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction7',
    reactants = ['OC(F)OF(1035)', 'CHFCHF[Z](59)'],
    products = ['FCC(F)OC(F)OF(5411)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FOC(F)OF(1036)', 'CH2CHF(56)'],
    products = ['FCC(F)OC(F)OF(5411)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FC[CH]OC(F)OF(5512)'],
    products = ['FCC(F)OC(F)OF(5411)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)OC(F)OF(5513)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FCC(F)O[CH]OF(5514)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)OC(F)CF(5515)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(F)OF(1040)', 'CH2F-CHF(66)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(363)', '[O]C(F)CF(2886)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(128)', 'F[CH]OC(F)CF(5516)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'F[CH]OC(F)OF(1043)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FC[C](F)OC(F)OF(5517)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[CH]C(F)OC(F)OF(5518)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FCC(F)O[C](F)OF(5473)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', 'O=COC(F)CF(3254)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'C=COC(F)OF(5519)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=C(F)OC(F)OF(5520)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'FC=COC(F)OF(5521)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C(F)OC(F)CF(3340)'],
    products = ['FCC(F)OC(F)OF(5411)'],
...
reaction(
    label = 'reaction25',
    reactants = ['FCC(F)OC(F)OF(5411)'],
    products = ['F2(78)', 'CHFO(47)', 'O=CCF(4766)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(244.861,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

network(
    label = 'PDepNetwork #1655',
    isomers = [
        'FCC(F)OC(F)OF(5411)',
    ],
    reactants = [
