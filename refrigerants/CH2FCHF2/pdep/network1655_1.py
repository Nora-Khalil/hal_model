...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=[C]OC(O)(F)F(5803)'],
    products = ['O=C(F)OC(O)(F)F(5371)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)F(341)', 'O[C](F)F(2562)'],
    products = ['O=C(F)OC(O)(F)F(5371)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CFO(51)', '[O]C(O)(F)F(2944)'],
    products = ['O=C(F)OC(O)(F)F(5371)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)OC(=O)F(5805)'],
    products = ['O=C(F)OC(O)(F)F(5371)'],
