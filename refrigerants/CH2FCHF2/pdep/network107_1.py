...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([O])F(366)'],
    products = ['O=O(207)', 'CHFO(47)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])F(441)'],
    products = ['[O]OC([O])F(366)'],
    transitionState = 'TS2',
