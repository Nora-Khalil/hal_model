...
species(
    label = '[CH]=C(F)C(F)(F)O[C]=C(10827)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]OC(F)(F)[C]=CF(9712)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(4368)', '[O]C(F)(F)[C]=CF(2656)'],
    products = ['C=[C]OC(F)(F)[C]=CF(9712)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF-2(3543)', 'C=[C]O[C](F)F(6398)'],
    products = ['C=[C]OC(F)(F)[C]=CF(9712)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(F)=C=CF(10817)'],
    products = ['C=[C]OC(F)(F)[C]=CF(9712)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CC(F)(F)O[C]=C(10818)'],
    products = ['C=[C]OC(F)(F)[C]=CF(9712)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=[C]OC(F)(F)C#CF(10819)'],
    products = ['C=[C]OC(F)(F)[C]=CF(9712)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#COC(F)(F)[C]=CF(10820)'],
    products = ['C=[C]OC(F)(F)[C]=CF(9712)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=[C]OC(F)(F)[C]=CF(9712)'],
    products = ['C=[C]OC(F)(F)C=[C]F(10821)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=COC(F)(F)[C]=CF(10822)'],
    products = ['C=[C]OC(F)(F)[C]=CF(9712)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=[C]OC(F)(F)[C]=CF(9712)'],
    products = ['[CH]=[C]OC(F)(F)C=CF(10823)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=COC(F)(F)[C]=[C]F(10824)'],
    products = ['C=[C]OC(F)(F)[C]=CF(9712)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C]O[C](F)C(F)=CF(10825)'],
    products = ['C=[C]OC(F)(F)[C]=CF(9712)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=C(F)OC(F)=[C][CH]F(10826)'],
    products = ['C=[C]OC(F)(F)[C]=CF(9712)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OC(F)(F)[C]=CF(9712)'],
    products = ['[CH]=C(F)C(F)(F)O[C]=C(10827)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]C(F)(F)OC(=C)F(10828)'],
    products = ['C=[C]OC(F)(F)[C]=CF(9712)'],
...
network(
    label = 'PDepNetwork #2606',
    isomers = [
        'C=[C]OC(F)(F)[C]=CF(9712)',
    ],
    reactants = [
