...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CO[C]=O(4624)'],
    products = ['CC([O])O[C]=O(9559)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'O=[C]OC=O(1308)'],
    products = ['CC([O])O[C]=O(9559)'],
