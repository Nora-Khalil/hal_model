...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CO[C](F)OF(5589)'],
    products = ['O=COC(F)(F)OF(5370)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)OC=O(5624)'],
    products = ['O=COC(F)(F)OF(5370)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(2563)', '[O]C=O(339)'],
    products = ['O=COC(F)(F)OF(5370)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)OF(5030)', 'HCO(15)'],
    products = ['O=COC(F)(F)OF(5370)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(128)', 'O=CO[C](F)F(2722)'],
    products = ['O=COC(F)(F)OF(5370)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC(F)(F)OF(5625)'],
    products = ['O=COC(F)(F)OF(5370)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(78)', 'O=COC(=O)F(1307)'],
    products = ['O=COC(F)(F)OF(5370)'],
