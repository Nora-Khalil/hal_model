...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)[C](F)F(171)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', '[CH2]C(F)(F)[CH]F(172)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C(F)[CH]F(174)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C=CF(175)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)=CF(176)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH2]C(F)=C[CH]F(177)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C(F)[CH]F(178)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C(F)(F)[CH]F(172)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
    products = ['[CH2][C](F)C(F)C(F)F(181)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH][CH]C(F)(F)CF(182)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)(F)C(F)[CH]F(150)'],
    products = ['[CH2]C(F)(F)[CH]C(F)F(183)'],
