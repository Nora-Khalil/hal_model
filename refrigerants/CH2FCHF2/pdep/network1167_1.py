...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', '[O]C([O])=O(1281)'],
    products = ['[O]C(=O)O[C](F)F(4555)'],
    transitionState = 'TS2',
