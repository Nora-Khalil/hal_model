...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]=CC#C(8343)'],
    products = ['[CH]=CC(=[CH])F(8337)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]F(252)', '[CH]=[CH](4369)'],
    products = ['[CH]=CC(=[CH])F(8337)'],
    transitionState = 'TS7',
