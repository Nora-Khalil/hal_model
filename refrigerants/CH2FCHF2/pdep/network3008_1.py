...
species(
    label = 'O=[C][CH]C(F)(F)C(F)F(12029)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]CC(F)(F)[C](F)F(11862)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'O=[C]C[C](F)F(541)'],
    products = ['O=[C]CC(F)(F)[C](F)F(11862)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(514)', '[CH2]C(F)(F)[C](F)F(203)'],
    products = ['O=[C]CC(F)(F)[C](F)F(11862)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O=[C]CC(F)(F)[C](F)F(11862)'],
    products = ['O=C=CC(F)(F)C(F)F(12025)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[CH2]C(F)(F)[C](F)F(203)'],
    products = ['O=[C]CC(F)(F)[C](F)F(11862)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]CC(F)=C(F)F(7964)'],
    products = ['O=[C]CC(F)(F)[C](F)F(11862)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C=CC(F)(F)[C](F)F(12026)'],
    products = ['O=[C]CC(F)(F)[C](F)F(11862)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=[C]C=C(F)[C](F)F(12027)'],
    products = ['O=[C]CC(F)(F)[C](F)F(11862)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', 'O=[C]C[C](F)F(541)'],
    products = ['O=[C]CC(F)(F)[C](F)F(11862)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C=CC(F)(F)[C](F)F(12028)'],
    products = ['O=[C]CC(F)(F)[C](F)F(11862)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]CC(F)(F)[C](F)F(11862)'],
    products = ['O=[C][CH]C(F)(F)C(F)F(12029)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]CC(F)(F)[C](F)F(11862)'],
    products = ['O=[C]C[C](F)C(F)(F)F(12030)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]CC(F)(F)[C](F)F(11862)'],
    products = ['O=C(F)C[C](F)[C](F)F(12031)'],
...
network(
    label = 'PDepNetwork #3008',
    isomers = [
        'O=[C]CC(F)(F)[C](F)F(11862)',
    ],
    reactants = [
        ('CF2CF2(61)', 'CH2CO(28)'),
    ],
