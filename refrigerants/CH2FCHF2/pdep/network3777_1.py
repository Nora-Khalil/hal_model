...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', '[CH2]C(=C)[O](6417)'],
    products = ['C=C([O])C[C]=O(8153)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['CO(13)', '[CH2]C(=C)[O](6417)'],
    products = ['C=C([O])C[C]=O(8153)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C([O])C=C=O(13802)'],
    products = ['C=C([O])C[C]=O(8153)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', 'O=[C]C[C]=O(8310)'],
    products = ['C=C([O])C[C]=O(8153)'],
