...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]=CC#C(8557)'],
    products = ['[CH]=CC(=[CH])F(8489)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]F(252)', '[CH]=[CH](4466)'],
    products = ['[CH]=CC(=[CH])F(8489)'],
    transitionState = 'TS7',
