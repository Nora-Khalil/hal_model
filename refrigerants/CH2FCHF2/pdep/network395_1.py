...
reaction(
    label = 'reaction5',
    reactants = ['FOF(488)', 'CC(F)=C=O(2083)'],
    products = ['CC(F)(F)C(=O)OF(2069)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)C([O])OF(2086)'],
    products = ['CC(F)(F)C(=O)OF(2069)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)[C](O)OF(2087)'],
    products = ['CC(F)(F)C(=O)OF(2069)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(=O)OF(2088)'],
    products = ['CC(F)(F)C(=O)OF(2069)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])=O(2089)'],
    products = ['CC(F)(F)C(=O)OF(2069)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(128)', 'CC(F)(F)[C]=O(2090)'],
    products = ['CC(F)(F)C(=O)OF(2069)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'O=C(OF)[C](F)F(2091)'],
    products = ['CC(F)(F)C(=O)OF(2069)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OF(340)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(=O)OF(2069)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)OF(2092)'],
    products = ['CC(F)(F)C(=O)OF(2069)'],
