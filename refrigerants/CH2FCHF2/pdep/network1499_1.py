...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]OO[O](2657)'],
    products = ['[O]OOC[C](F)F(5196)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]OOC=C(F)F(3987)'],
    products = ['[O]OOC[C](F)F(5196)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]OO[O](2657)'],
    products = ['[O]OOC[C](F)F(5196)'],
