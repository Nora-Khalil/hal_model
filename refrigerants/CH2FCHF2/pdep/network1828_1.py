...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.168792,'amu*angstrom^2'), symmetry=1, barrier=(3.88087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167628,'amu*angstrom^2'), symmetry=1, barrier=(3.8541,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.04385,'amu*angstrom^2'), symmetry=1, barrier=(52.4887,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.376535,'amu*angstrom^2'), symmetry=1, barrier=(8.65729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376081,'amu*angstrom^2'), symmetry=1, barrier=(8.64684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.56376,'amu*angstrom^2'), symmetry=1, barrier=(58.9458,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11474,0.0719565,-0.000128393,1.18122e-07,-4.17718e-11,-33168.8,28.2209], Tmin=(100,'K'), Tmax=(835.246,'K')), NASAPolynomial(coeffs=[7.741,0.0239181,-1.28398e-05,2.51887e-09,-1.74734e-13,-33706.9,0.850708], Tmin=(835.246,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsFFHO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.531167,0.091948,-0.00018129,1.79038e-07,-6.58766e-11,-78188.2,39.4187], Tmin=(100,'K'), Tmax=(854.172,'K')), NASAPolynomial(coeffs=[4.9392,0.0355756,-1.95509e-05,3.83175e-09,-2.6409e-13,-77637.8,26.4772], Tmin=(854.172,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-651.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFFHO) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C=C(F)OOC(F)F(6206)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'O=C=C(F)OO(2244)'],
    products = ['O=C=C(F)OOC(F)F(6206)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'O=C=C(F)OOF(2245)'],
    products = ['O=C=C(F)OOC(F)F(6206)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['O[C]=C(F)OO[C](F)F(6285)'],
    products = ['O=C=C(F)OOC(F)F(6206)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C=C(F)OO[CH]F(1938)'],
    products = ['O=C=C(F)OOC(F)F(6206)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C=[C]OOC(F)F(6891)'],
    products = ['O=C=C(F)OOC(F)F(6206)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)F(364)', 'O=[C]C(=O)F(1543)'],
    products = ['O=C=C(F)OOC(F)F(6206)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(82)', '[O]OC(F)=C=O(2248)'],
    products = ['O=C=C(F)OOC(F)F(6206)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC(F)F(2774)', 'O=C=[C]F(289)'],
    products = ['O=C=C(F)OOC(F)F(6206)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=C(F)OO[C](F)F(6278)'],
    products = ['O=C=C(F)OOC(F)F(6206)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C(F)[C-]=[O+]OC(F)F(6892)'],
    products = ['O=C=C(F)OOC(F)F(6206)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C=C(F)OOC(F)F(6206)'],
    products = ['CO(13)', 'F[C-]=[O+]OC(F)F(3485)'],
