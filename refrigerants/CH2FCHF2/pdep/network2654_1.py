...
species(
    label = '[O]C(F)[CH]C(F)=C(F)F(10287)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O][CH]C(F)C(F)=C(F)F(10289)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(3536)', '[O]C(F)[CH]F(208)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)[C]=C(F)F(9850)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
    products = ['OC(F)C(F)=C=C(F)F(10274)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
    products = ['O=C(F)C(F)C=C(F)F(4734)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(F)C=C=C(F)F(10275)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)C(F)=C=C(F)F(10276)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=CC(F)[C]=C(F)F(10277)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C(F)C(F)[C]=C(F)F(10278)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)C(F)C#CF(10279)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', '[O]C=C[C]=C(F)F(10280)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=CC(F)=[C][C](F)F(10281)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C(F)C=[C][C](F)F(10282)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
    products = ['[O]C(F)C(F)=C[C](F)F(10283)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
    products = ['O[C](F)C(F)[C]=C(F)F(10284)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
    products = ['[O][C](F)C(F)C=C(F)F(4735)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
    products = ['OC(F)C(F)=[C][C](F)F(10285)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FOC(F)[CH][C]=C(F)F(10286)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
    products = ['[O]C(F)[CH]C(F)=C(F)F(10287)'],
...
reaction(
    label = 'reaction25',
    reactants = ['FO[CH]C(F)[C]=C(F)F(10288)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
    products = ['[O][CH]C(F)C(F)=C(F)F(10289)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[C]=[C]C(F)C(F)OF(10290)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O]C(F)C(F)C(F)=[C]F(10291)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(9746)'],
...
network(
    label = 'PDepNetwork #2654',
    isomers = [
        '[O]C(F)C(F)[C]=C(F)F(9746)',
    ],
    reactants = [
