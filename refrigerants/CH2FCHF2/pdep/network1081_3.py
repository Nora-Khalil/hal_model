...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[O]C1OO1(4190)'],
    products = ['[O]C1OOC1(F)F(3935)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction19',
    reactants = ['O(6)', 'FC1(F)[CH]OO1(2514)'],
    products = ['[O]C1OOC1(F)F(3935)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C1OOC1(F)F(4264)'],
    products = ['[O]C1OOC1(F)F(3935)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', '[O]C1OO[C]1F(4349)'],
    products = ['[O]C1OOC1(F)F(3935)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', '[O][C]1OOC1(F)F(4275)'],
    products = ['[O]C1OOC1(F)F(3935)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C1OO[C]1F(4350)'],
    products = ['[O]C1OOC1(F)F(3935)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C1OOC1(F)F(3935)'],
    products = ['O[C]1OOC1(F)F(4351)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OF(127)', 'O=C[C]F-2(1596)'],
    products = ['[O]OC(F)(F)C=O(3559)'],
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)(F)C=O(1557)'],
    products = ['[O]OC(F)(F)C=O(3559)'],
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]O[C](F)C=O(1934)'],
    products = ['[O]OC(F)(F)C=O(3559)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(F)(F)[C]=O(3936)'],
    products = ['[O]OC(F)(F)C=O(3559)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F(37)', 'O=COO[C]F(4611)'],
    products = ['O=COO[C](F)F(4348)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[O][C](F)F(2580)', '[O]C=O(339)'],
    products = ['O=COO[C](F)F(4348)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(5)', 'O=[C]OO[C](F)F(4263)'],
    products = ['O=COO[C](F)F(4348)'],
...
reaction(
    label = 'reaction34',
    reactants = ['F(37)', 'O=CO[O+]=[C-]F(4364)'],
    products = ['O=COO[C](F)F(4348)'],
