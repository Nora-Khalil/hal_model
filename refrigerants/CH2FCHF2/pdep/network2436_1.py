...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(2711)', '[CH]C-2(4371)'],
    products = ['C[CH]OC([O])(F)F(9374)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C[CH]O[C](F)F(4470)'],
    products = ['C[CH]OC([O])(F)F(9374)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C=COC([O])(F)F(9408)'],
    products = ['C[CH]OC([O])(F)F(9374)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[CH]OC(=O)F(9409)'],
    products = ['C[CH]OC([O])(F)F(9374)'],
    transitionState = 'TS8',
