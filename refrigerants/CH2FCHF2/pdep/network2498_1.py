...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.4624,'amu*angstrom^2'), symmetry=1, barrier=(33.6235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.0271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48393,0.0351435,-5.60215e-05,4.02914e-08,-1.03736e-11,828.456,10.2731], Tmin=(100,'K'), Tmax=(730.135,'K')), NASAPolynomial(coeffs=[9.24041,0.00335039,-1.43322e-06,2.43634e-10,-1.51296e-14,-297.36,-21.1511], Tmin=(730.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.44767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CdCFO) + group(CdJ2_singlet-Cds)"""),
)
