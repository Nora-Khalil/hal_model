species(
    label = 'F[C](F)CC(F)(F)[C](F)F(11869)',
...
species(
    label = '[CH2]C(F)(F)C(F)(F)[C](F)F(11868)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'FC1(F)CC(F)(F)C1(F)F(11905)',
...
"""),
    E0 = (-974.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,190,488,555,1236,1407,180,180,1539.81],'cm^-1')),
        HinderedRotor(inertia=(0.205731,'amu*angstrom^2'), symmetry=1, barrier=(4.73016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205707,'amu*angstrom^2'), symmetry=1, barrier=(4.7296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205705,'amu*angstrom^2'), symmetry=1, barrier=(4.72955,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.049,'amu'),
...
species(
    label = 'F[C](F)C[C](F)C(F)(F)F(11906)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0687506,0.101648,-0.000182088,1.68069e-07,-5.9499e-11,-120897,30.9957], Tmin=(100,'K'), Tmax=(835.673,'K')), NASAPolynomial(coeffs=[9.28007,0.033505,-1.77816e-05,3.49207e-09,-2.42527e-13,-121643,-7.54119], Tmin=(835.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1006.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sF1s)(F1s)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[C](F)CC(F)(F)F(11907)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0713546,0.100692,-0.000176948,1.61138e-07,-5.66841e-11,-121900,31.5517], Tmin=(100,'K'), Tmax=(827.12,'K')), NASAPolynomial(coeffs=[9.93085,0.0324723,-1.72356e-05,3.39544e-09,-2.36658e-13,-122875,-10.7004], Tmin=(827.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1014.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C](F)F(11868)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'F[C](F)C[C](F)F(195)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', '[CH2]C(F)(F)[C](F)F(203)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
    products = ['FC1(F)CC(F)(F)C1(F)F(11905)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
    products = ['FC(F)=CC(F)(F)C(F)F(7175)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)CC(F)=C(F)F(3721)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2CF2(61)', '[CH2][C](F)F(163)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[C](F)[C](F)F(4977)', 'CH2CF2(57)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)C(F)(F)C=C(F)F(7834)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)[C](F)F(4977)', '[CH2][C](F)F(163)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'F[C](F)C=C(F)[C](F)F(3754)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(43)', 'F[C](F)C[C](F)F(195)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]C(F)(F)[C](F)F(203)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)C(F)(F)[CH]C(F)F(7253)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)[CH]C(F)(F)C(F)F(3766)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
    products = ['F[C](F)C[C](F)C(F)(F)F(11906)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)CC(F)(F)[C](F)F(11869)'],
    products = ['F[C](F)[C](F)CC(F)(F)F(11907)'],
...
network(
    ...
    isomers = [
        'F[C](F)CC(F)(F)[C](F)F(11869)',
    ],
    reactants = [
        ('CF2CF2(61)', 'CH2CF2(57)'),
        ('CF2(43)', 'F[C](F)C[C](F)F(195)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
