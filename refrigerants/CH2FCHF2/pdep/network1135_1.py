...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]C(4409)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])(F)F(218)', '[CH]C-2(4371)'],
    products = ['[CH2]C(F)(F)O[CH]C(4409)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[C](F)F(4470)'],
    products = ['[CH2]C(F)(F)O[CH]C(4409)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[CH]C(4471)'],
    products = ['[CH2]C(F)(F)O[CH]C(4409)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)OC=C(4472)'],
    products = ['[CH2]C(F)(F)O[CH]C(4409)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]COC([CH2])(F)F(4473)'],
    products = ['[CH2]C(F)(F)O[CH]C(4409)'],
...
network(
    label = 'PDepNetwork #1135',
    isomers = [
        '[CH2]C(F)(F)O[CH]C(4409)',
    ],
    reactants = [
        ('CH2CF2(57)', 'CH3CHO(36)'),
    ],
