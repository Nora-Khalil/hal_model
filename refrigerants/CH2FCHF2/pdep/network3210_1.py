...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])OOF(12520)'],
    products = ['O=C(O)OOF(12449)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]F(128)', '[O]C(=O)O(4910)'],
    products = ['O=C(O)OOF(12449)'],
    transitionState = 'TS4',
