...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', '[O]C([O])=O(1332)'],
    products = ['[O]C(=O)O[C](F)F(4261)'],
    transitionState = 'TS2',
