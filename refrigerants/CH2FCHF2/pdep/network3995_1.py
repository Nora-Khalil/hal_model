...
reaction(
    label = 'reaction4',
    reactants = ['F[C]1OO[CH]OO1(14164)'],
    products = ['O=COOC(=O)F(14089)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OOC=O(14046)'],
    products = ['O=COOC(=O)F(14089)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(341)', '[O]C=O(339)'],
    products = ['O=COOC(=O)F(14089)'],
    transitionState = 'TS8',
