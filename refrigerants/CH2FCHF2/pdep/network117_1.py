...
"""),
    E0 = (-659.297,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,528,1116,1182,1331,1402,1494,3075,3110,391,562,707,872,1109,1210,1289,3137,180,180],'cm^-1')),
...
reaction(
    label = 'reaction5',
    reactants = ['OF(482)', 'F[C]C(F)CF(481)'],
    products = ['FCC(F)C(F)OF(383)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)C(F)OF(483)'],
    products = ['FCC(F)C(F)OF(383)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[CH]C(F)OF(489)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FCC(F)[CH]OF(490)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)C(F)OF(491)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)C(F)CF(492)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(128)', 'F[CH]C(F)CF(493)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]OF(363)', 'CH2F-CHF(66)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(46)', 'F[CH]C(F)OF(494)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FC[C](F)C(F)OF(495)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FCC(F)[C](F)OF(496)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'F[CH]C(F)C(F)OF(497)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'O=C(F)C(F)CF(327)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'FCC=C(F)OF(503)'],
    products = ['FCC(F)C(F)OF(383)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'FC=CC(F)OF(504)'],
    products = ['FCC(F)C(F)OF(383)'],
