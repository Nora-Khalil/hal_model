...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'CC(=O)C([O])=O(9586)'],
    products = ['CC(=O)C(=O)OF(13076)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(128)', 'CC(=O)[C]=O(13118)'],
    products = ['CC(=O)C(=O)OF(13076)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'O=[C]C(=O)OF(5750)'],
    products = ['CC(=O)C(=O)OF(13076)'],
