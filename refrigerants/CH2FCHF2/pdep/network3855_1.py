...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.000529909,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191469,'amu*angstrom^2'), symmetry=1, barrier=(43.2966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192198,'amu*angstrom^2'), symmetry=1, barrier=(43.2622,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191963,'amu*angstrom^2'), symmetry=1, barrier=(43.3738,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.828371,0.0759754,-0.000103198,7.13343e-08,-1.98046e-11,14835.8,23.4557], Tmin=(100,'K'), Tmax=(874.961,'K')), NASAPolynomial(coeffs=[12.3185,0.0234458,-1.31415e-05,2.71586e-09,-1.98135e-13,12825.1,-30.4426], Tmin=(874.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(122.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(Ct-CtH) + radical(CsCCl_triplet)"""),
)

species(
    label = 'FC1C=[C]OOC1F(13962)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.6418,'amu*angstrom^2'), symmetry=1, barrier=(37.7482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64044,'amu*angstrom^2'), symmetry=1, barrier=(37.7168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64043,'amu*angstrom^2'), symmetry=1, barrier=(37.7168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64038,'amu*angstrom^2'), symmetry=1, barrier=(37.7155,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.64389,0.0818187,-0.000139685,1.23948e-07,-4.28822e-11,41396.6,25.2028], Tmin=(100,'K'), Tmax=(819.64,'K')), NASAPolynomial(coeffs=[9.61747,0.0254635,-1.35612e-05,2.66398e-09,-1.85532e-13,40347.5,-13.7306], Tmin=(819.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.61814,'amu*angstrom^2'), symmetry=1, barrier=(37.2041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.61756,'amu*angstrom^2'), symmetry=1, barrier=(37.1909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.61768,'amu*angstrom^2'), symmetry=1, barrier=(37.1935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.61756,'amu*angstrom^2'), symmetry=1, barrier=(37.1909,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.876083,0.0746771,-0.000102701,7.25575e-08,-2.05931e-11,12578.1,24.6062], Tmin=(100,'K'), Tmax=(856.935,'K')), NASAPolynomial(coeffs=[11.8782,0.0233211,-1.28058e-05,2.62196e-09,-1.90181e-13,10692.5,-26.7741], Tmin=(856.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsCFHO) + group(CJ2_singlet-FCs) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.70586,'amu*angstrom^2'), symmetry=1, barrier=(39.2211,'kJ/mol'), semiclassical=False),
        ...
        HinderedRotor(inertia=(1.70584,'amu*angstrom^2'), symmetry=1, barrier=(39.2206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.652894,0.0794798,-0.000110676,8.16022e-08,-2.42441e-11,10821.4,25.2058], Tmin=(100,'K'), Tmax=(820.004,'K')), NASAPolynomial(coeffs=[11.5267,0.0264368,-1.36467e-05,2.71647e-09,-1.93635e-13,9038.13,-25.0962], Tmin=(820.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.0161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)

species(
    label = 'C#COO[CH]C(F)F(13965)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C#COOC(F)[CH]F(4786)'],
    products = ['O=C(F)[CH]F(215)', 'CH2CO(28)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C(F)OOC#C(13960)'],
    products = ['C#COOC(F)[CH]F(4786)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'C#COO[CH]F(6895)'],
    products = ['C#COOC(F)[CH]F(4786)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'C#COOC(F)[C]F-2(13961)'],
    products = ['C#COOC(F)[CH]F(4786)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['C#CO[O](302)', 'CHFCHF[Z](59)'],
    products = ['C#COOC(F)[CH]F(4786)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C#COO[CH][CH]F(13964)'],
    products = ['C#COOC(F)[CH]F(4786)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HCCO(21)', '[O]C(F)[CH]F(208)'],
    products = ['C#COOC(F)[CH]F(4786)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C#CO[O](302)', 'F[CH][CH]F(141)'],
    products = ['C#COOC(F)[CH]F(4786)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C2H(22)', '[O]OC(F)[CH]F(131)'],
    products = ['C#COOC(F)[CH]F(4786)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[C]#COOC(F)[CH]F(11136)'],
    products = ['C#COOC(F)[CH]F(4786)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', 'C#COO[CH]F(6895)'],
    products = ['C#COOC(F)[CH]F(4786)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C#COOC(F)[C]F(8257)'],
    products = ['C#COOC(F)[CH]F(4786)'],
...
network(
    ...
    reactants = [
        ('O=C(F)[CH]F(215)', 'CH2CO(28)'),
        ('HCCO(21)', 'FC1OC1F(211)'),
        ('HCCO(21)', '[O]C(F)[CH]F(208)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
