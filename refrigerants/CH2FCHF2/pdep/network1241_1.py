...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])=C=O(4742)'],
    products = ['[O]C(=O)C([O])=O(4719)'],
    transitionState = 'TS2',
