...
"""),
    ...
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.89612,0.00629437,0.000104386,-2.22393e-07,1.39356e-10,-82789.1,10.8597], Tmin=(10,'K'), Tmax=(544.932,'K')), NASAPolynomial(coeffs=[3.91466,0.0288752,-2.03016e-05,6.64965e-09,-8.183e-13,-83128.4,7.68674], Tmin=(544.932,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-688.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""OC1(F)OC1F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-75.2333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3615,1277.5,1000,277,555,632,360,370,350,334,575,1197,1424,3202],'cm^-1')),
        HinderedRotor(inertia=(0.872041,'amu*angstrom^2'), symmetry=1, barrier=(20.0499,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.873056,'amu*angstrom^2'), symmetry=1, barrier=(20.0733,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.640214,0.085431,-0.000165735,1.54926e-07,-5.44072e-11,-8938.55,26.6236], Tmin=(100,'K'), Tmax=(855.913,'K')), NASAPolynomial(coeffs=[8.88758,0.0225172,-1.27679e-05,2.51391e-09,-1.73e-13,-9457.67,-6.66714], Tmin=(855.913,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.2333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]OC(O)(F)[CH]F(3387)'],
    products = ['O=O(207)', 'OC(F)=CF(878)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(17.5487,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission
Ea raised from 0.0 to 17.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(O)(F)[CH]F(4869)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', '[O]O[C](O)F(445)'],
    products = ['[O]OC(O)(F)[CH]F(3387)'],
    transitionState = 'TS4',
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(173.997,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[O]O[C](O)F(445)'],
    products = ['[O]OC(O)(F)[CH]F(3387)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O[C]([CH]F)OOF(4872)'],
    products = ['[O]OC(O)(F)[CH]F(3387)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(85.9604,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
