species(
    label = 'F[CH]C(F)OOOC(F)C(F)F(7196)',
...
species(
    label = '[CH]C(F)OOOC(F)C(F)F(7200)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C]C(F)OOOC(F)C(F)F(7201)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.832812,0.110049,-0.000127976,7.26992e-08,-1.63932e-11,-99915.9,37.5995], Tmin=(100,'K'), Tmax=(1073.33,'K')), NASAPolynomial(coeffs=[20.5944,0.0301954,-1.63783e-05,3.38334e-09,-2.48088e-13,-104516,-67.2906], Tmin=(1073.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-832.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-613.243,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,180,683.998,684.051,684.054,684.097,684.197],'cm^-1')),
        HinderedRotor(inertia=(0.096195,'amu*angstrom^2'), symmetry=1, barrier=(2.21171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.581361,'amu*angstrom^2'), symmetry=1, barrier=(13.3666,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.46313,'amu*angstrom^2'), symmetry=1, barrier=(33.6402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07578,0.0622011,-6.97548e-05,3.81622e-08,-8.1561e-12,-73649,26.3147], Tmin=(100,'K'), Tmax=(1143.86,'K')), NASAPolynomial(coeffs=[14.8851,0.0139111,-6.42991e-06,1.25511e-09,-8.97695e-14,-76808.2,-42.1632], Tmin=(1143.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-613.243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(ROOJ)"""),
)

species(
    label = 'FC=C(F)OOOC(F)C(F)F(7204)',
...
"""),
    ...
    molecularWeight = (176.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.82251,0.114111,-0.0001539,1.06694e-07,-2.96232e-11,-73300.1,37.8947], Tmin=(100,'K'), Tmax=(876.867,'K')), NASAPolynomial(coeffs=[16.5313,0.0349478,-1.84807e-05,3.73623e-09,-2.69383e-13,-76343.5,-43.547], Tmin=(876.867,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-610.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CCsJOO) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'F[CH]C(F)OOOC(F)[CH]F(7206)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'F[CH][CH]OOOC(F)C(F)F(7207)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[CH]C(F)OOOC(F)[C](F)F(7209)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
...
species(
    label = 'F[C]C(F)OOOC(F)C(F)F-2(7212)',
    structure = adjacencyList("""1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (194.057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.763649,0.108473,-0.000126402,7.23878e-08,-1.64705e-11,-102174,38.6748], Tmin=(100,'K'), Tmax=(1064.07,'K')), NASAPolynomial(coeffs=[20.0394,0.0302705,-1.61598e-05,3.31747e-09,-2.42481e-13,-106602,-62.9796], Tmin=(1064.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-850.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'FC[C](F)OOOC(F)C(F)F(6165)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (195.065,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.93861,0.115634,-0.0001421,8.84765e-08,-2.2106e-11,-121085,39.1759], Tmin=(100,'K'), Tmax=(968.735,'K')), NASAPolynomial(coeffs=[18.2785,0.0362846,-1.92346e-05,3.92229e-09,-2.8515e-13,-124808,-52.925], Tmin=(968.735,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1008.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'FCC(F)OOO[C](F)C(F)F(7213)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (195.065,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.938615,0.115634,-0.0001421,8.84766e-08,-2.2106e-11,-121085,39.1759], Tmin=(100,'K'), Tmax=(968.729,'K')), NASAPolynomial(coeffs=[18.2785,0.0362846,-1.92346e-05,3.9223e-09,-2.85151e-13,-124808,-52.9249], Tmin=(968.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1008.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'FCC(F)OOOC(F)[C](F)F(7214)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (195.065,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.849592,0.109589,-0.000120366,6.49768e-08,-1.39954e-11,-119483,39.4925], Tmin=(100,'K'), Tmax=(1117.81,'K')), NASAPolynomial(coeffs=[20.5939,0.0328539,-1.73944e-05,3.56352e-09,-2.60155e-13,-124277,-66.3481], Tmin=(1117.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-994.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'FC(F)[CH]OOOC(F)C(F)F(7215)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
    products = ['FC1OC1F(211)', '[O]OC(F)C(F)F(3435)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]C(F)F(125)', 'OOOC(F)[CH]F(4193)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'F[CH]C(F)OOOC(F)F(4640)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]C(F)OOOC(F)C(F)F(7200)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(137)', 'F[CH]OOOC(F)C(F)F(6672)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]C(F)OOOC(F)C(F)F(7201)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
    products = ['[O]C(F)C(F)F(3447)', 'FC1OOC1F(210)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FC=COOOC(F)C(F)F(7202)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHFCHF[Z](59)', '[O]OOC(F)C(F)F(7203)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'FC=C(F)OOOC(F)C(F)F(7204)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[CH]C(F)OOO[CH]C(F)F(7205)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[CH]C(F)OOOC(F)[CH]F(7206)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'F[CH][CH]OOOC(F)C(F)F(7207)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)C(F)F(3447)', '[O]OC(F)[CH]F(131)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C(F)[CH]F(208)', '[O]OC(F)C(F)F(3435)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH][CH]F(141)', '[O]OOC(F)C(F)F(7203)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF2(82)', 'F[CH]OOOC(F)[CH]F(5290)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'F[CH]C(F)OOO[C](F)C(F)F(7208)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'F[CH]C(F)OOOC(F)[C](F)F(7209)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'F[CH][C](F)OOOC(F)C(F)F(7210)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'F[CH]C(F)OOOC=CF(7211)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'F[CH]C(F)OOOC(F)=CF(6161)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CHF(40)', 'F[CH]OOOC(F)C(F)F(6672)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(5)', 'F[C]C(F)OOOC(F)C(F)F-2(7212)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
    products = ['FC[C](F)OOOC(F)C(F)F(6165)'],
...
reaction(
    label = 'reaction29',
    reactants = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
    products = ['FCC(F)OOO[C](F)C(F)F(7213)'],
...
reaction(
    label = 'reaction30',
    reactants = ['FCC(F)OOOC(F)[C](F)F(7214)'],
    products = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
...
reaction(
    label = 'reaction31',
    reactants = ['F[CH]C(F)OOOC(F)C(F)F(7196)'],
    products = ['FC(F)[CH]OOOC(F)C(F)F(7215)'],
...
network(
    ...
    isomers = [
        'F[CH]C(F)OOOC(F)C(F)F(7196)',
    ],
    reactants = [
        ('FC1OC1F(211)', '[O]OC(F)C(F)F(3435)'),
        ('[O]C(F)[CH]F(208)', '[O]OC(F)C(F)F(3435)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
