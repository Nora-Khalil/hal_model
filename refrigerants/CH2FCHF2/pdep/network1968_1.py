species(
    label = 'F[C]=CC(F)(F)[CH]C(F)F(7134)',
...
species(
    label = 'F[C]C=C(F)C(F)C(F)F(7288)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'F[C]=CC(F)(F)C(F)[CH]F(7289)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
    products = ['C2HF(58)', 'FC(F)=CC(F)F(2834)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]=CC([C](F)F)C(F)F(7135)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C(F)F-2(3493)', 'F[C]C=C(F)F(290)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
    products = ['FC1=CC(F)(F)C1C(F)F(7278)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]=CC(F)=CC(F)F(7279)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]F(252)', 'FC(F)=CC(F)F(2834)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[C]=CC(F)(F)C=CF(7280)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C]=CC(F)(F)C=C(F)F(7281)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C2HF(58)', 'F[C](F)[CH]C(F)F(4845)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'FC#CC(F)(F)[CH]C(F)F(7282)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[C]F(252)', 'F[C](F)[CH]C(F)F(4845)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[C]=C=C(F)[CH]C(F)F(7283)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]=CC(F)(F)C[C](F)F(7284)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FC=[C]C(F)(F)[CH]C(F)F(7285)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
    products = ['F[C]C=C(F)C(F)C(F)F(7288)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
    products = ['F[C](F)C=C(F)[CH]C(F)F(7234)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C]=CC(F)(F)C(F)[CH]F(7289)'],
    products = ['F[C]=CC(F)(F)[CH]C(F)F(7134)'],
...
network(
    ...
    isomers = [
        'F[C]=CC(F)(F)[CH]C(F)F(7134)',
    ],
    reactants = [
        ('C2HF(58)', 'FC(F)=CC(F)F(2834)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
