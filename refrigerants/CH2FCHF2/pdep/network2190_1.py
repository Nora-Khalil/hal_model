...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C([O])=C=O(4825)'],
    products = ['[CH2]C(=O)C([O])=O(4336)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([O])=C=O(8321)'],
    products = ['[CH2]C(=O)C([O])=O(4336)'],
    transitionState = 'TS4',
