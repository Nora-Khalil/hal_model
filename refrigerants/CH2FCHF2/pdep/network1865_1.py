...
reaction(
    label = 'reaction3',
    reactants = ['O=C1O[C](O)O[C]1F(9141)'],
    products = ['O=C=C(F)OC(=O)O(6529)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(=O)O[C](F)C=O(6521)'],
    products = ['O=C=C(F)OC(=O)O(6529)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C=[C]OC(=O)O(9143)'],
    products = ['O=C=C(F)OC(=O)O(6529)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]O(338)', 'O=[C]C(=O)F(1665)'],
    products = ['O=C=C(F)OC(=O)O(6529)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(4707)', 'O=C=[C]F(289)'],
    products = ['O=C=C(F)OC(=O)O(6529)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'O=[C]OC(F)=C=O(9144)'],
    products = ['O=C=C(F)OC(=O)O(6529)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(=O)OC(F)=C=O(7127)'],
    products = ['O=C=C(F)OC(=O)O(6529)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C(F)[C-]=[O+]C(=O)O(9145)'],
    products = ['O=C=C(F)OC(=O)O(6529)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C=C(F)OC(=O)O(6529)'],
    products = ['CO(13)', 'O=C(O)[O+]=[C-]F(4715)'],
