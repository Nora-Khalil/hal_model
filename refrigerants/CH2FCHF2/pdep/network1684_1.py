...
"""),
    E0 = (-710.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3000,3100,440,815,1455,1000,180,921.502],'cm^-1')),
        HinderedRotor(inertia=(0.248358,'amu*angstrom^2'), symmetry=1, barrier=(5.71023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248379,'amu*angstrom^2'), symmetry=1, barrier=(5.71072,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-868.646,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,431,527,613,668,835,1199,1245,1322,180,180,1133.79,1135.6],'cm^-1')),
        HinderedRotor(inertia=(0.21515,'amu*angstrom^2'), symmetry=1, barrier=(4.94672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216358,'amu*angstrom^2'), symmetry=1, barrier=(4.97449,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction6',
    reactants = ['OH(7)', '[CH2]OC(F)(F)F(6123)'],
    products = ['OCOC(F)(F)F(5398)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]COC(F)(F)F(6124)'],
    products = ['OCOC(F)(F)F(5398)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O[CH]OC(F)(F)F(6022)'],
    products = ['OCOC(F)(F)F(5398)'],
    transitionState = 'TS8',
