...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[O]C[O](2826)'],
    products = ['[O]CO[CH]F(2806)'],
    transitionState = 'TS2',
