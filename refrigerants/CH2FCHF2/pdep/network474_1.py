...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([O])(F)F(2561)'],
    products = ['O=O(207)', 'CF2O(49)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])(F)F(2711)'],
    products = ['[O]OC([O])(F)F(2561)'],
    transitionState = 'TS2',
