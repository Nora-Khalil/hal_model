...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'F[C]C=CF(248)'],
    products = ['F[C]=CC(F)[C](F)F(3844)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]=CC=C(F)F(273)'],
    products = ['F[C]=CC(F)[C](F)F(3844)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C]=CC(F)=C(F)F(3868)'],
    products = ['F[C]=CC(F)[C](F)F(3844)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC#CC(F)[C](F)F(3869)'],
    products = ['F[C]=CC(F)[C](F)F(3844)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'F[C]=C=C[C](F)F(3870)'],
    products = ['F[C]=CC(F)[C](F)F(3844)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]=[C]C(F)C(F)F(3873)'],
    products = ['F[C]=CC(F)[C](F)F(3844)'],
