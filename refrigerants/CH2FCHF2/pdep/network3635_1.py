...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(=O)O(5808)'],
    products = ['C=C(O)O[O](4100)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]=C(O)O[O](14555)'],
    products = ['C=C(O)O[O](4100)'],
    transitionState = 'TS9',
