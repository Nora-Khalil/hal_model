...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30344,0.0389949,-5.35334e-05,3.63416e-08,-9.66952e-12,-46716.1,17.5892], Tmin=(100,'K'), Tmax=(922.733,'K')), NASAPolynomial(coeffs=[9.26777,0.00880526,-4.45746e-06,8.85012e-10,-6.32283e-14,-48001.3,-15.4497], Tmin=(922.733,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-388.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26343,0.0667407,-0.000113422,1.00006e-07,-3.41334e-11,-47215.2,22.8306], Tmin=(100,'K'), Tmax=(841.282,'K')), NASAPolynomial(coeffs=[8.52488,0.020605,-1.04621e-05,2.01241e-09,-1.38209e-13,-48026.2,-8.5049], Tmin=(841.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-393.337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(CsCFFO) + radical(O2sj(Cs-CsF1sF1s)) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81768,0.0320203,1.86639e-05,-5.36019e-08,2.36647e-11,-52443.2,18.3352], Tmin=(100,'K'), Tmax=(988.637,'K')), NASAPolynomial(coeffs=[17.2375,0.00816473,-3.60495e-06,8.38229e-10,-7.09109e-14,-57375.3,-65.4041], Tmin=(988.637,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-436.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFOO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.68431,'amu*angstrom^2'), symmetry=1, barrier=(38.7256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58435,'amu*angstrom^2'), symmetry=1, barrier=(36.4273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560601,'amu*angstrom^2'), symmetry=1, barrier=(12.8893,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.827276,0.0780558,-0.000139214,1.25148e-07,-4.33046e-11,-40029.7,23.5629], Tmin=(100,'K'), Tmax=(833.138,'K')), NASAPolynomial(coeffs=[9.47924,0.0219533,-1.19858e-05,2.36026e-09,-1.63886e-13,-40965.9,-13.565], Tmin=(833.138,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-333.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-F1sO2sCs)) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)

species(
    label = '[O]O[C](CF)OF(3389)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.385745,'amu*angstrom^2'), symmetry=1, barrier=(8.86905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25786,'amu*angstrom^2'), symmetry=1, barrier=(28.9207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.384425,'amu*angstrom^2'), symmetry=1, barrier=(8.83869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08795,0.0705889,-0.000120509,1.0576e-07,-3.61939e-11,-9808.7,24.7468], Tmin=(100,'K'), Tmax=(816.202,'K')), NASAPolynomial(coeffs=[9.44077,0.0202886,-1.08568e-05,2.13876e-09,-1.49195e-13,-10860.3,-11.9434], Tmin=(816.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.3737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(ROOJ) + radical(Cs_P)"""),
)

species(
    label = '[O][C](CF)OOF(3390)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.41845,'amu*angstrom^2'), symmetry=1, barrier=(32.613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41493,'amu*angstrom^2'), symmetry=1, barrier=(32.5321,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29317,0.0689017,-0.000125016,1.20618e-07,-4.48797e-11,-5670.31,25.3193], Tmin=(100,'K'), Tmax=(814.077,'K')), NASAPolynomial(coeffs=[5.82804,0.0280969,-1.57002e-05,3.1479e-09,-2.21808e-13,-5794.89,8.14369], Tmin=(814.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.8804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(F)(O[O])OF(3391)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.539098,'amu*angstrom^2'), symmetry=1, barrier=(12.3949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17639,'amu*angstrom^2'), symmetry=1, barrier=(27.0476,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.540231,'amu*angstrom^2'), symmetry=1, barrier=(12.421,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.766665,0.0778807,-0.000135243,1.16678e-07,-3.88474e-11,-14172.9,24.0248], Tmin=(100,'K'), Tmax=(835.494,'K')), NASAPolynomial(coeffs=[11.1171,0.0181351,-9.68014e-06,1.88718e-09,-1.30218e-13,-15546.7,-21.9208], Tmin=(835.494,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(CsCFOO) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C([O])(F)OOF(3392)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-51.2924,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,373,336,502,477,708,1220,1477,3000,3100,440,815,1455,1000,230.684,1935.47],'cm^-1')),
        HinderedRotor(inertia=(0.189291,'amu*angstrom^2'), symmetry=1, barrier=(7.16532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.893995,'amu*angstrom^2'), symmetry=1, barrier=(33.8476,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.893909,'amu*angstrom^2'), symmetry=1, barrier=(33.8499,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.990427,0.0725058,-0.000121678,1.05666e-07,-3.61349e-11,-6066.73,24.4899], Tmin=(100,'K'), Tmax=(791.428,'K')), NASAPolynomial(coeffs=[9.90502,0.0208805,-1.13803e-05,2.26716e-09,-1.59596e-13,-7272.04,-15.1328], Tmin=(791.428,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.2924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(CsCFOO) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sO2sCs)) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[O]OC([O])(F)CF(3022)'],
    products = ['HO2(11)', 'O=C(F)[CH]F(215)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]OC([O])F(366)'],
    products = ['[O]OC([O])(F)CF(3022)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC([O])(F)F(2561)', 'CH2(S)(25)'],
    products = ['[O]OC([O])(F)CF(3022)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC(=O)F(444)', 'CH2F(46)'],
    products = ['[O]OC([O])(F)CF(3022)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[CH2]C(=O)O[O](3385)'],
    products = ['[O]OC([O])(F)CF(3022)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]OC(=O)[CH]F(3386)'],
    products = ['[O]OC([O])(F)CF(3022)'],
...
network(
    ...
    reactants = [
        ('HO2(11)', 'O=C(F)[CH]F(215)'),
        ('O=O(207)', 'O=C(F)CF(879)'),
        ('O2(2)', 'O=C(F)CF(879)'),
    ],
    bathGas = {
        'N2': 0.5,
