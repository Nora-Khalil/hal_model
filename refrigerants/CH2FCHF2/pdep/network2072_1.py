species(
    label = 'FOC(F)C(C(F)F)C(F)F(7802)',
...
"""),
    E0 = (-1225.06,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,261,493,600,1152,1365,1422,3097,176,294,457,589,547,707,1086,1160,1127,1157,1302,1442,1365,1447,3042,3152,277.427,277.501,278.975,279.042],'cm^-1')),
        HinderedRotor(inertia=(0.236538,'amu*angstrom^2'), symmetry=1, barrier=(13.0692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.593567,'amu*angstrom^2'), symmetry=1, barrier=(32.5224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236427,'amu*angstrom^2'), symmetry=1, barrier=(13.0795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.469542,'amu*angstrom^2'), symmetry=1, barrier=(25.4154,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (182.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.544876,0.107805,-0.000141285,9.61609e-08,-2.63668e-11,-147183,31.4654], Tmin=(100,'K'), Tmax=(885.217,'K')), NASAPolynomial(coeffs=[15.478,0.0354022,-1.85969e-05,3.76234e-09,-2.71679e-13,-150020,-43.8821], Tmin=(885.217,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1225.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFFH) + group(CsCsFFH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.201892,'amu*angstrom^2'), symmetry=1, barrier=(10.6839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473596,'amu*angstrom^2'), symmetry=1, barrier=(25.0619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.808185,'amu*angstrom^2'), symmetry=1, barrier=(42.7682,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00131236,0.0947462,-0.000128282,8.98232e-08,-2.52154e-11,-76482.7,30.7254], Tmin=(100,'K'), Tmax=(867.361,'K')), NASAPolynomial(coeffs=[14.1424,0.0295189,-1.54782e-05,3.11931e-09,-2.24463e-13,-78936.2,-35.4973], Tmin=(867.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-637.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFFH) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'FOC(F)C(F)C(F)F(4562)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.44374,'amu*angstrom^2'), symmetry=1, barrier=(33.1945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.759426,'amu*angstrom^2'), symmetry=1, barrier=(17.4607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44413,'amu*angstrom^2'), symmetry=1, barrier=(33.2033,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (150.047,'amu'),
...
"""),
    E0 = (-1015.65,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([87,255,155,255,543,653,1088,1120,1106,1180,1251,1383,1373,1449,3068,3238,350,440,435,1725,194,682,905,1196,1383,3221,180,2494.91],'cm^-1')),
        HinderedRotor(inertia=(0.314908,'amu*angstrom^2'), symmetry=1, barrier=(7.24037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37626,'amu*angstrom^2'), symmetry=1, barrier=(31.643,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
...
species(
    label = 'FO[CH]C(C(F)F)C(F)F(7770)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[CH]C(C(F)F)C(F)OF(7808)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-810.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,334,575,1197,1424,3202,346.581,346.936,347.138,352.048],'cm^-1')),
        HinderedRotor(inertia=(0.403654,'amu*angstrom^2'), symmetry=1, barrier=(33.608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394211,'amu*angstrom^2'), symmetry=1, barrier=(33.6207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103297,'amu*angstrom^2'), symmetry=1, barrier=(9.02335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104567,'amu*angstrom^2'), symmetry=1, barrier=(8.99991,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.23752,0.101581,-0.000143946,1.09178e-07,-3.35536e-11,-97353.8,30.9856], Tmin=(100,'K'), Tmax=(791.691,'K')), NASAPolynomial(coeffs=[12.8363,0.0355247,-1.87878e-05,3.78295e-09,-2.71313e-13,-99423.8,-29.0339], Tmin=(791.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-810.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFFH) + group(CsCsFHH) + radical(Csj(Cs-CsCsH)(F1s)(H))"""),
)

species(
    label = '[O]C(F)C(C(F)F)C(F)F(7809)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1132.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,176,294,457,589,547,707,1086,1160,1127,1157,1302,1442,1365,1447,3042,3152,391,562,707,872,1109,1210,1289,3137,206.252,207.24,207.55],'cm^-1')),
        HinderedRotor(inertia=(0.244697,'amu*angstrom^2'), symmetry=1, barrier=(7.38696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239977,'amu*angstrom^2'), symmetry=1, barrier=(7.37774,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.670361,'amu*angstrom^2'), symmetry=1, barrier=(20.4678,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0709331,0.0928714,-0.000120478,8.32203e-08,-2.32784e-11,-136131,29.981], Tmin=(100,'K'), Tmax=(867.334,'K')), NASAPolynomial(coeffs=[13.1117,0.0327291,-1.64649e-05,3.27126e-09,-2.33799e-13,-138394,-31.0771], Tmin=(867.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1132.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFFH) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.03253,'amu*angstrom^2'), symmetry=1, barrier=(23.7398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25735,'amu*angstrom^2'), symmetry=1, barrier=(5.91698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257218,'amu*angstrom^2'), symmetry=1, barrier=(5.91395,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'FOC(F)[C](C(F)F)C(F)F(7811)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.675761,'amu*angstrom^2'), symmetry=1, barrier=(15.5371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72066,'amu*angstrom^2'), symmetry=1, barrier=(39.5614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.675953,'amu*angstrom^2'), symmetry=1, barrier=(15.5415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72169,'amu*angstrom^2'), symmetry=1, barrier=(39.5851,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (181.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.242546,0.100803,-0.000128743,8.49317e-08,-2.26264e-11,-128843,30.5751], Tmin=(100,'K'), Tmax=(908.592,'K')), NASAPolynomial(coeffs=[14.9963,0.0337151,-1.79872e-05,3.66607e-09,-2.66018e-13,-131613,-41.4825], Tmin=(908.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1072.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFFH) + group(CsCsFFH) + radical(CCJ(C)CO)"""),
)
...
species(
    label = 'FOC(F)C([C](F)F)C(F)F(7812)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1026.07,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,190,488,555,1236,1407,324.712,324.712,324.712,324.712],'cm^-1')),
        HinderedRotor(inertia=(0.127803,'amu*angstrom^2'), symmetry=1, barrier=(9.56233,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127803,'amu*angstrom^2'), symmetry=1, barrier=(9.56235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308001,'amu*angstrom^2'), symmetry=1, barrier=(23.045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.469826,'amu*angstrom^2'), symmetry=1, barrier=(35.1529,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (181.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.632134,0.110533,-0.000161897,1.23196e-07,-3.75079e-11,-123248,33.9256], Tmin=(100,'K'), Tmax=(802.6,'K')), NASAPolynomial(coeffs=[14.8205,0.0335155,-1.7949e-05,3.62073e-09,-2.59572e-13,-125729,-37.2255], Tmin=(802.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1026.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFHO) + group(CsCsFFH) + group(CsCsFFH) + radical(Csj(Cs-CsCsH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-871.849,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,87,255,155,255,543,653,1088,1120,1106,1180,1251,1383,1373,1449,3068,3238,350,440,435,1725,3010,987.5,1337.5,450,1655,319.087,320.124,320.284],'cm^-1')),
        HinderedRotor(inertia=(0.00164853,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181093,'amu*angstrom^2'), symmetry=1, barrier=(13.0635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.372131,'amu*angstrom^2'), symmetry=1, barrier=(26.9656,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.117168,0.0923968,-0.000127571,9.28927e-08,-2.72552e-11,-104726,29.7308], Tmin=(100,'K'), Tmax=(829.734,'K')), NASAPolynomial(coeffs=[12.9271,0.0306424,-1.59311e-05,3.1938e-09,-2.28841e-13,-106851,-29.679], Tmin=(829.734,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-871.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction2',
    reactants = ['OF(482)', 'F[C]C(C(F)F)C(F)F(7725)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FOC(C(F)F)C(F)F(5429)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'F[C]C(C(F)F)C(F)OF(7806)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'FOC(F)C(F)C(F)F(4562)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(482)', 'FC=C(C(F)F)C(F)F(7807)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FO[CH]C(C(F)F)C(F)F(7770)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C(C(F)F)C(F)OF(7808)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)C(C(F)F)C(F)F(7809)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(128)', 'F[CH]C(C(F)F)C(F)F(7810)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]OF(363)', 'FC(F)[CH]C(F)F(4847)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF2(82)', 'FOC(F)[CH]C(F)F(727)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FOC(F)[C](C(F)F)C(F)F(7811)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'FO[C](F)C(C(F)F)C(F)F(7727)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FOC(F)C([C](F)F)C(F)F(7812)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'O=CC(C(F)F)C(F)F(7552)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'FOC=C(C(F)F)C(F)F(7813)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'FC=C(C(F)F)C(F)OF(7814)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(C(F)F)C(F)F(7458)'],
    products = ['FOC(F)C(C(F)F)C(F)F(7802)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FOC(F)C(C(F)F)C(F)F(7802)'],
    products = ['F2(78)', 'CHFO(47)', 'FC=CC(F)F(721)'],
