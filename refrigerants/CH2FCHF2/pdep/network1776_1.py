...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C([O])C(=O)F(2004)'],
    products = ['[CH2]OC([O])C(=O)F(6172)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction15',
    reactants = ['CFO(51)', '[CH2]OC=O(2738)'],
    products = ['[CH2]OC([O])C(=O)F(6172)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]OC(=O)C(=O)F(6669)'],
    products = ['[CH2]OC([O])C(=O)F(6172)'],
