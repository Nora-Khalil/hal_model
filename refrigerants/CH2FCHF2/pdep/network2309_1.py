...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C1O[C]1F(8486)'],
    products = ['[O]CC1O[C]1F(8653)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]CC1=C(F)O1(8728)'],
    products = ['[O]CC1O[C]1F(8653)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CC1O[C]1F(8729)'],
    products = ['[O]CC1O[C]1F(8653)'],
