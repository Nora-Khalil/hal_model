...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(1332)', 'O[C]F(3009)'],
    products = ['[O]C(=O)O[C](O)F(5797)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O=[C]O[C](O)F(1310)'],
    products = ['[O]C(=O)O[C](O)F(5797)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([O])=O(1332)', '[OH+]=[C-]F(2955)'],
    products = ['[O]C(=O)O[C](O)F(5797)'],
