...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.251437,'amu*angstrom^2'), symmetry=1, barrier=(5.78104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.761105,'amu*angstrom^2'), symmetry=1, barrier=(17.4993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.06072,'amu*angstrom^2'), symmetry=1, barrier=(47.38,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.05413,'amu*angstrom^2'), symmetry=1, barrier=(47.2286,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.476936,0.0875566,-0.000116472,7.63084e-08,-1.48282e-11,-55954.7,29.2893], Tmin=(100,'K'), Tmax=(581.47,'K')), NASAPolynomial(coeffs=[9.70535,0.0370853,-1.98396e-05,4.00208e-09,-2.86848e-13,-57247.9,-12.1204], Tmin=(581.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-466.209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-294.276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,326,540,652,719,1357,2950,3100,1380,975,1025,1650,90,150,250,247,323,377,431,433,1065,1274,449.599],'cm^-1')),
        HinderedRotor(inertia=(0.000834013,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000834013,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000834011,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000834011,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.662084,0.082712,-0.000113965,8.22192e-08,-2.14872e-11,-35281.8,27.8734], Tmin=(100,'K'), Tmax=(592.147,'K')), NASAPolynomial(coeffs=[9.08263,0.0356497,-1.96216e-05,4.00672e-09,-2.89307e-13,-36451.2,-9.79206], Tmin=(592.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-294.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)

species(
    label = 'F[C]1CC(F)C(F)OO1(13969)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.199122,'amu*angstrom^2'), symmetry=1, barrier=(4.57821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198707,'amu*angstrom^2'), symmetry=1, barrier=(4.56866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.20259,'amu*angstrom^2'), symmetry=1, barrier=(50.642,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61439,0.0614796,-5.67875e-05,4.08636e-09,2.41726e-11,-34448.1,25.5626], Tmin=(100,'K'), Tmax=(506.15,'K')), NASAPolynomial(coeffs=[6.46818,0.0358803,-1.87352e-05,3.7705e-09,-2.70868e-13,-35102.9,3.83643], Tmin=(506.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    E0 = (-73.4724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,326,540,652,719,1357,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,180,3212.27],'cm^-1')),
        HinderedRotor(inertia=(1.89045,'amu*angstrom^2'), symmetry=1, barrier=(43.4651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17747,'amu*angstrom^2'), symmetry=1, barrier=(4.08038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89227,'amu*angstrom^2'), symmetry=1, barrier=(43.507,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.467985,0.0890898,-0.000155027,1.4668e-07,-5.37697e-11,-8720.56,29.6328], Tmin=(100,'K'), Tmax=(822.663,'K')), NASAPolynomial(coeffs=[6.43969,0.0375289,-1.99432e-05,3.92828e-09,-2.74278e-13,-8940.88,6.62112], Tmin=(822.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.4724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-249.041,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,395,473,707,1436,326,540,652,719,1357,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,180],'cm^-1')),
        HinderedRotor(inertia=(0.219094,'amu*angstrom^2'), symmetry=1, barrier=(5.03741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221127,'amu*angstrom^2'), symmetry=1, barrier=(5.08414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217681,'amu*angstrom^2'), symmetry=1, barrier=(5.00491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.23083,'amu*angstrom^2'), symmetry=1, barrier=(51.2911,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0351883,0.100075,-0.000180696,1.70536e-07,-6.18901e-11,-29822.4,32.7223], Tmin=(100,'K'), Tmax=(825.918,'K')), NASAPolynomial(coeffs=[7.84565,0.0369951,-2.02678e-05,4.02029e-09,-2.81066e-13,-30251.2,1.7494], Tmin=(825.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-249.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.680243,'amu*angstrom^2'), symmetry=1, barrier=(15.6401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53389,'amu*angstrom^2'), symmetry=1, barrier=(35.2672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52909,'amu*angstrom^2'), symmetry=1, barrier=(35.1567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53324,'amu*angstrom^2'), symmetry=1, barrier=(35.2522,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.920488,0.0781072,-9.63613e-05,4.81542e-08,2.7353e-12,-37548.5,28.3113], Tmin=(100,'K'), Tmax=(541.136,'K')), NASAPolynomial(coeffs=[8.70943,0.035404,-1.92131e-05,3.89512e-09,-2.79852e-13,-38609.3,-6.49459], Tmin=(541.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(CdCFO) + group(Cds-CdsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.196492,0.0936419,-0.0001526,1.39829e-07,-5.10146e-11,-58671.2,30.4254], Tmin=(100,'K'), Tmax=(791.111,'K')), NASAPolynomial(coeffs=[7.74918,0.0398894,-2.11698e-05,4.2037e-09,-2.96352e-13,-59379.1,-1.16391], Tmin=(791.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-488.878,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CdCFO) + group(Cds-CdsHH) + radical(CCsJOOC)"""),
)

species(
    label = 'C=[C]OOC(F)C(F)F(13975)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-456.187,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,2950,3100,1380,975,1025,1650,1685,370,269.771,270.083],'cm^-1')),
        HinderedRotor(inertia=(0.754039,'amu*angstrom^2'), symmetry=1, barrier=(38.9935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.755872,'amu*angstrom^2'), symmetry=1, barrier=(38.996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.360583,'amu*angstrom^2'), symmetry=1, barrier=(18.6156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197961,'amu*angstrom^2'), symmetry=1, barrier=(10.2252,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.663467,0.079626,-9.37304e-05,5.91232e-08,-1.53717e-11,-54751.7,30.8371], Tmin=(100,'K'), Tmax=(921.51,'K')), NASAPolynomial(coeffs=[11.5722,0.0322731,-1.66495e-05,3.35771e-09,-2.42531e-13,-56762.2,-20.8995], Tmin=(921.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-456.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(F)OOC(F)[CH]F(13929)'],
    products = ['CH2CFO(79)', 'FC1OC1F(211)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C=C(F)OOC(F)[CH]F(13929)'],
    products = ['O=C(F)COC(F)[CH]F(13966)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]C(F)OOC(=C)F(13967)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', 'C=C(F)OO[CH]F(3244)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'C=C(F)OOC(F)[C]F(13968)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=C(F)OOC(F)[CH]F(13929)'],
    products = ['F[C]1CC(F)C(F)OO1(13969)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C(F)OOC(F)[CH]F(13929)'],
    products = ['[CH2]C1(F)OOC(F)C1F(13970)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)OOC=CF(13971)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHFCHF[Z](59)', 'C=C(F)O[O](222)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)OOC(F)=CF(3354)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)OO[CH][CH]F(13972)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C=[C]OOC(F)[CH]F(8167)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2CFO(79)', '[O]C(F)[CH]F(208)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH][CH]F(141)', 'C=C(F)O[O](222)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2CF(70)', '[O]OC(F)[CH]F(131)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2][C](F)OOC(F)=CF(13955)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(F)OOC(F)[CH]F(4784)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C(F)OOC(F)[CH]F(13929)'],
    products = ['O=C(F)[CH]F(215)', 'CC(=O)F(5326)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COOC(F)[CH]F(4786)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHF(40)', 'C=C(F)OO[CH]F(3244)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'C=C(F)OOC(F)[C]F-2(13973)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C(F)OOC(F)CF(3347)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=C(F)OOC(F)[CH]F(13929)'],
    products = ['C=C(F)OO[CH]C(F)F(13974)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=[C]OOC(F)C(F)F(13975)'],
    products = ['C=C(F)OOC(F)[CH]F(13929)'],
...
network(
    ...
    isomers = [
        'C=C(F)OOC(F)[CH]F(13929)',
    ],
    reactants = [
        ('CH2CFO(79)', 'FC1OC1F(211)'),
        ('CH2CFO(79)', '[O]C(F)[CH]F(208)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
