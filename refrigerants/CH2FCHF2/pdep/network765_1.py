...
reaction(
    label = 'reaction1',
    reactants = ['CO(13)', '[CH2]C(F)(F)F(133)'],
    products = ['O=[C]CC(F)(F)F(3649)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(=O)C(F)(F)F(9636)'],
    products = ['O=[C]CC(F)(F)F(3649)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(514)', '[CH2]C(F)(F)F(133)'],
    products = ['O=[C]CC(F)(F)F(3649)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'O=C=CC(F)(F)F(8424)'],
    products = ['O=[C]CC(F)(F)F(3649)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]C[C](F)F(541)'],
    products = ['O=[C]CC(F)(F)F(3649)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C][CH]C(F)(F)F(9637)'],
    products = ['O=[C]CC(F)(F)F(3649)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=[C]C=C(F)F(3537)'],
    products = ['O=[C]CC(F)(F)F(3649)'],
