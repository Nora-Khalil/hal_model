...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)F(368)', 'F[C]CF(126)'],
    products = ['OC(F)C(F)(F)CF(700)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'F[C]C(F)(F)CF(775)'],
    products = ['OC(F)C(F)(F)CF(700)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'OC(F)(F)CF(776)'],
    products = ['OC(F)C(F)(F)CF(700)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2(8)', 'OC(F)C(F)(F)[C]F(777)'],
    products = ['OC(F)C(F)(F)CF(700)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(S)(25)', 'OC(F)C(F)(F)F(779)'],
    products = ['OC(F)C(F)(F)CF(700)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['OF(482)', 'FC=C(F)CF(486)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)[C](F)CF(782)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O[CH]C(F)(F)CF(783)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C(F)(F)C(O)F(784)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'F[CH]C(F)(F)CF(785)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(F)C(F)(F)CF(786)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O[CH]F(361)', 'CH2F-CF2(68)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(46)', 'OC(F)[C](F)F(787)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O[C](F)C(F)(F)CF(788)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(F)C(F)(F)[CH]F(789)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=CC(F)(F)CF(328)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'C=C(F)C(O)F(791)'],
    products = ['OC(F)C(F)(F)CF(700)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'OC(F)=C(F)CF(792)'],
    products = ['OC(F)C(F)(F)CF(700)'],
