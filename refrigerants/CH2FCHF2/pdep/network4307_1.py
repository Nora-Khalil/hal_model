...
"""),
    E0 = (266.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2161.91],'cm^-1')),
        HinderedRotor(inertia=(0.130312,'amu*angstrom^2'), symmetry=1, barrier=(6.72028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127653,'amu*angstrom^2'), symmetry=1, barrier=(6.72911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00962797,'amu*angstrom^2'), symmetry=1, barrier=(6.69193,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35532,0.0344795,-1.7272e-05,4.08056e-09,-3.78294e-13,32109.4,17.5603], Tmin=(100,'K'), Tmax=(2451.51,'K')), NASAPolynomial(coeffs=[13.9857,0.0155026,-5.66048e-06,9.22847e-10,-5.62708e-14,26407.1,-48.9782], Tmin=(2451.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(RCCJ) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.27024,-0.00231014,0.000102462,-1.25885e-07,4.64182e-11,1711.44,10.4048], Tmin=(100,'K'), Tmax=(958.654,'K')), NASAPolynomial(coeffs=[9.08671,0.0204704,-6.80128e-06,1.2948e-09,-9.89883e-14,-1565.75,-28.6869], Tmin=(958.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.98997,0.0287412,-9.5147e-06,4.19239e-10,1.90524e-13,30780.1,16.8971], Tmin=(100,'K'), Tmax=(2154.57,'K')), NASAPolynomial(coeffs=[12.4232,0.018224,-7.0631e-06,1.16767e-09,-7.11809e-14,25091.4,-39.6218], Tmin=(2154.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]CC(14985)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {5,S} {6,S}
2  C u0 p0 c0 {1,S} {7,S} {8,S} {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[CH2](14976)'],
    products = ['C2H4(30)', 'C2H4(30)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C[CH2](5062)'],
    products = ['[CH2]CC[CH2](14976)'],
    transitionState = 'TS2',
