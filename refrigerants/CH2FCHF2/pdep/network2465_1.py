...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[CH]C=CF(9467)'],
    products = ['[CH]=CC(F)[CH]F(9466)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[CH](4369)', 'CHFCHF[Z](59)'],
    products = ['[CH]=CC(F)[CH]F(9466)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H2(23)', 'F[CH][CH]F(141)'],
    products = ['[CH]=CC(F)[CH]F(9466)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](4369)', 'F[CH][CH]F(141)'],
    products = ['[CH]=CC(F)[CH]F(9466)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH]=C=C[CH]F(265)'],
    products = ['[CH]=CC(F)[CH]F(9466)'],
