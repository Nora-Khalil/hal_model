...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](129)', '[C]=C(4368)'],
    products = ['C=[C]OO[O](5323)'],
    transitionState = 'TS2',
