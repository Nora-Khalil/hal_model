...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.11362,0.0238634,-1.57855e-05,4.50024e-09,-5.05241e-13,-19523.1,12.9639], Tmin=(100,'K'), Tmax=(1934.52,'K')), NASAPolynomial(coeffs=[8.92919,0.0118386,-6.46169e-06,1.28711e-09,-9.00076e-14,-21773.2,-18.9304], Tmin=(1934.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cds-(Cdd-O2d)CsH) + group(Cds-O2d(Cds-Cds)H) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.683151,0.0535787,-4.99822e-05,2.35033e-08,-4.10127e-12,24376.2,25.1856], Tmin=(100,'K'), Tmax=(1693.85,'K')), NASAPolynomial(coeffs=[13.6802,0.0105709,-9.90363e-07,-7.12972e-11,1.1693e-14,21740,-39.1522], Tmin=(1693.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2sCF) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(12dioxolane) + radical(Cs_P) + radical(CCsJOOC)"""),
)

species(
    label = '[O]C=CC([O])OF(15314)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {5,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (-61.0519,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,403.452,622.164,622.193],'cm^-1')),
        HinderedRotor(inertia=(0.793247,'amu*angstrom^2'), symmetry=1, barrier=(18.2383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.793244,'amu*angstrom^2'), symmetry=1, barrier=(18.2382,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48448,0.0575229,-6.48236e-05,3.74813e-08,-8.7248e-12,-7254.04,24.3673], Tmin=(100,'K'), Tmax=(1035.77,'K')), NASAPolynomial(coeffs=[11.3694,0.019349,-9.54089e-06,1.89934e-09,-1.36586e-13,-9301.76,-23.6693], Tmin=(1035.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.0519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ) + radical(C=COJ)"""),
)

species(
    label = '[O]C[CH]C(=O)OF(15315)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (-43.2081,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,1855,455,950,180,180,1686.91],'cm^-1')),
        HinderedRotor(inertia=(0.242659,'amu*angstrom^2'), symmetry=1, barrier=(5.57921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242045,'amu*angstrom^2'), symmetry=1, barrier=(5.56508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24279,'amu*angstrom^2'), symmetry=1, barrier=(5.58223,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28696,0.0704578,-0.00012968,1.26117e-07,-4.64043e-11,-5109.45,26.8401], Tmin=(100,'K'), Tmax=(846.462,'K')), NASAPolynomial(coeffs=[4.76738,0.0301079,-1.5818e-05,3.07927e-09,-2.12537e-13,-4842.34,15.6875], Tmin=(846.462,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.2081,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsOsH) + group(Cds-OdCsH) + radical(CCOJ) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]C[C](O)OF(15317)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {6,S}
...
"""),
    E0 = (-63.6669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,1855,455,950,247.809,247.883],'cm^-1')),
        HinderedRotor(inertia=(0.00274301,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150142,'amu*angstrom^2'), symmetry=1, barrier=(6.54493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150146,'amu*angstrom^2'), symmetry=1, barrier=(6.54463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15011,'amu*angstrom^2'), symmetry=1, barrier=(6.54477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.979231,0.0737082,-0.000126884,1.11768e-07,-3.79298e-11,-7555.56,27.7736], Tmin=(100,'K'), Tmax=(847.47,'K')), NASAPolynomial(coeffs=[9.26636,0.0213727,-1.08509e-05,2.08195e-09,-1.42514e-13,-8485.41,-8.03445], Tmin=(847.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.6669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsOsH) + group(Cds-OdCsH) + radical(Cs_P) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC=C(O)OF(15318)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {6,S}
3  O u0 p2 c0 {6,S} {10,S}
4  O u0 p2 c0 {7,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.676093,'amu*angstrom^2'), symmetry=1, barrier=(15.5447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.675641,'amu*angstrom^2'), symmetry=1, barrier=(15.5343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.674972,'amu*angstrom^2'), symmetry=1, barrier=(15.5189,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01219,0.071673,-0.000112361,9.2581e-08,-3.05384e-11,-34712.2,21.2795], Tmin=(100,'K'), Tmax=(742.447,'K')), NASAPolynomial(coeffs=[10.2328,0.0219879,-1.19634e-05,2.41596e-09,-1.72615e-13,-36081.2,-20.4572], Tmin=(742.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cd-Cd(CO)H) + group(Cds-CdsCsCs) + group(Cds-O2d(Cds-Cds)H)"""),
)

species(
    label = 'O=C(C=CO)OF(15319)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.234714,'amu*angstrom^2'), symmetry=1, barrier=(5.39654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235038,'amu*angstrom^2'), symmetry=1, barrier=(5.40399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242653,'amu*angstrom^2'), symmetry=1, barrier=(5.57907,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47323,0.0499389,-5.60944e-05,2.69634e-08,-4.18957e-12,-43427.5,19.2688], Tmin=(100,'K'), Tmax=(999.956,'K')), NASAPolynomial(coeffs=[15.7604,0.0028991,-6.99381e-07,1.44057e-10,-1.26226e-14,-46790.3,-52.1857], Tmin=(999.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-361.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsOsH)"""),
)
...
"""),
    E0 = (-312.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,180,180,795.627,795.96,796.224,796.418],'cm^-1')),
        HinderedRotor(inertia=(0.00724052,'amu*angstrom^2'), symmetry=1, barrier=(3.25625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00724298,'amu*angstrom^2'), symmetry=1, barrier=(3.25959,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.29595,0.0259351,-1.01289e-05,5.19839e-10,2.07316e-13,-37609.9,16.3271], Tmin=(100,'K'), Tmax=(2176.02,'K')), NASAPolynomial(coeffs=[15.9183,0.0113934,-6.07516e-06,1.10698e-09,-7.0281e-14,-45153.7,-59.0939], Tmin=(2176.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-312.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-244.007,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2850,1437.5,1250,1305,750,350,1855,455,950,340.307,340.316,340.317,340.319,340.321,2274.88],'cm^-1')),
        HinderedRotor(inertia=(0.116677,'amu*angstrom^2'), symmetry=1, barrier=(9.58914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.525964,'amu*angstrom^2'), symmetry=1, barrier=(43.2265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.525956,'amu*angstrom^2'), symmetry=1, barrier=(43.2265,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42125,0.0618518,-9.66482e-05,8.26492e-08,-2.83455e-11,-29259.3,21.6777], Tmin=(100,'K'), Tmax=(780.022,'K')), NASAPolynomial(coeffs=[8.27971,0.0220956,-1.13781e-05,2.23426e-09,-1.56738e-13,-30189.8,-8.81234], Tmin=(780.022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(C=OCCJ=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=CCOF(8573)'],
    products = ['O=CCC(=O)OF(15260)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(482)', 'O=C=CC=O(6495)'],
    products = ['O=CCC(=O)OF(15260)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['FO[C]1C[CH]OO1(15313)'],
    products = ['O=CCC(=O)OF(15260)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)CC=O(15320)'],
    products = ['O=CCC(=O)OF(15260)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(128)', 'O=[C]CC=O(8813)'],
    products = ['O=CCC(=O)OF(15260)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(340)', 'CH2CHO(35)'],
    products = ['O=CCC(=O)OF(15260)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HCO(15)', '[CH2]C(=O)OF(2414)'],
    products = ['O=CCC(=O)OF(15260)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C=CC(=O)OF(13030)'],
    products = ['O=CCC(=O)OF(15260)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O=[C]CC(=O)OF(15321)'],
    products = ['O=CCC(=O)OF(15260)'],
