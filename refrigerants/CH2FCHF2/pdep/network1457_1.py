...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.00746e-06,'m^3/(mol*s)'), n=3.3552, Ea=(269.719,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R
...
reaction(
    ...
    products = ['HF(38)', 'F[C]C(F)(F)F(4171)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'F[C](F)C(F)(F)F(11865)'],
    products = ['CHF2-CF3(81)'],
    transitionState = 'TS6',
