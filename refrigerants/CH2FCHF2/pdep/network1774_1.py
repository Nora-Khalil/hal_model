...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](2715)', '[CH]C(=O)F(323)'],
    products = ['[O]CO[CH]C(=O)F(6170)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]O[CH]C(=O)F(1691)'],
    products = ['[O]CO[CH]C(=O)F(6170)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CO[CH]C(=O)F(2173)'],
    products = ['[O]CO[CH]C(=O)F(6170)'],
