...
reaction(
    label = 'reaction1',
    reactants = ['[O]OOO[C](F)F(6308)'],
    products = ['O2(2)', 'FC1(F)OO1(2642)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OO[C](F)F(2674)'],
    products = ['[O]OOO[C](F)F(6308)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOO[C](F)F(6308)'],
    products = ['[O-][O+]=O(2905)', '[O][C](F)F(2694)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]O[O](129)', '[O][C](F)F(2694)'],
    products = ['[O]OOO[C](F)F(6308)'],
    transitionState = 'TS7',
