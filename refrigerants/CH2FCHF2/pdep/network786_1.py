...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27322,0.0671055,-0.000111445,1.01833e-07,-3.67273e-11,-56731.2,23.9526], Tmin=(100,'K'), Tmax=(797.234,'K')), NASAPolynomial(coeffs=[7.21224,0.0262446,-1.37497e-05,2.732e-09,-1.92633e-13,-57326.5,-1.14903], Tmin=(797.234,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-472.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(CsJOCH3)"""),
)

species(
    label = 'CO[C](F)[C](F)F(3814)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-452.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,190,488,555,1236,1407,180,180,1627.98],'cm^-1')),
        HinderedRotor(inertia=(0.236024,'amu*angstrom^2'), symmetry=1, barrier=(5.42665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237333,'amu*angstrom^2'), symmetry=1, barrier=(5.45675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235506,'amu*angstrom^2'), symmetry=1, barrier=(5.41475,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40475,0.0671028,-0.0001209,1.19206e-07,-4.49999e-11,-54332.9,24.141], Tmin=(100,'K'), Tmax=(822.65,'K')), NASAPolynomial(coeffs=[4.42148,0.0311777,-1.6636e-05,3.30212e-09,-2.31644e-13,-54110,14.5477], Tmin=(822.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-452.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]O[CH]C(F)(F)F(3815)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56996,0.0585967,-8.00577e-05,5.77391e-08,-1.55552e-11,-61367.7,23.3375], Tmin=(100,'K'), Tmax=(650.14,'K')), NASAPolynomial(coeffs=[8.61308,0.0218621,-1.05275e-05,2.05214e-09,-1.44498e-13,-62423,-8.68139], Tmin=(650.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-510.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sF1s)(O2s-Cs)(H)) + radical(CsJOCC)"""),
)

species(
    label = 'FCO[CH][C](F)F(413)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]O[CH]F(410)'],
    products = ['[CH2]OC(F)[C](F)F(3667)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(20)', 'F[CH][C](F)F(3610)'],
    products = ['[CH2]OC(F)[C](F)F(3667)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C(F)F(2635)'],
    products = ['[CH2]OC(F)[C](F)F(3667)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](2599)', 'CHFCF2(55)'],
    products = ['[CH2]OC(F)[C](F)F(3667)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=C(F)F(3812)'],
    products = ['[CH2]OC(F)[C](F)F(3667)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](2599)', 'F[CH][C](F)F(3610)'],
    products = ['[CH2]OC(F)[C](F)F(3667)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]O[CH]F(410)'],
    products = ['[CH2]OC(F)[C](F)F(3667)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OC(F)[C](F)F(3667)'],
    products = ['[CH2]O[CH]C(F)(F)F(3815)'],
