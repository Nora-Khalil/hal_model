...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCOF(5576)'],
    products = ['O=C(F)OCO(5363)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]OC(=O)F(2739)'],
    products = ['O=C(F)OCO(5363)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[CH]O(5834)'],
    products = ['O=C(F)OCO(5363)'],
