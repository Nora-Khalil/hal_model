...
species(
    label = 'FOC(C=C(F)F)C(F)(F)F(10973)',
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0501702,0.0941786,-0.00011911,7.55492e-08,-1.90702e-11,-131317,31.4623], Tmin=(100,'K'), Tmax=(963.366,'K')), NASAPolynomial(coeffs=[16.1957,0.0267234,-1.40786e-05,2.8652e-09,-2.08094e-13,-134447,-46.3083], Tmin=(963.366,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1093.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-CdsCsH) + group(CdCFF)"""),
)
...
species(
    label = 'FOC(F)(F)C=CC(F)(F)F(10974)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
species(
    label = 'FO[C](F)C(F)C=C(F)F(10977)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.4783,'amu*angstrom^2'), symmetry=1, barrier=(33.9889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302605,'amu*angstrom^2'), symmetry=1, barrier=(6.95748,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
...
"""),
    E0 = (-624.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,284,328,853,1146,1135,1297,3239,223,363,546,575,694,1179,1410,3010,987.5,1337.5,450,1655,167,640,1190,232.975,233.425,233.543],'cm^-1')),
        HinderedRotor(inertia=(0.235328,'amu*angstrom^2'), symmetry=1, barrier=(9.07038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235608,'amu*angstrom^2'), symmetry=1, barrier=(9.07124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.781689,'amu*angstrom^2'), symmetry=1, barrier=(30.2205,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.135925,0.0989112,-0.00015535,1.26636e-07,-4.11429e-11,-74928.8,29.6801], Tmin=(100,'K'), Tmax=(754.676,'K')), NASAPolynomial(coeffs=[13.1267,0.0286019,-1.55748e-05,3.13687e-09,-2.23625e-13,-76930.2,-30.5686], Tmin=(754.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-624.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[O]C(F)(F)C(F)C=C(F)F(10979)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.348449,0.0874545,-0.00012609,9.67919e-08,-3.00033e-11,-114117,28.883], Tmin=(100,'K'), Tmax=(786.186,'K')), NASAPolynomial(coeffs=[11.7228,0.0295813,-1.5667e-05,3.15259e-09,-2.25845e-13,-115905,-23.2552], Tmin=(786.186,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-949.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(CdCFF) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
species(
    label = 'FOC(F)(F)C(F)=C[C](F)F(10980)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.254037,'amu*angstrom^2'), symmetry=1, barrier=(5.8408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254061,'amu*angstrom^2'), symmetry=1, barrier=(5.84135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.9271,'amu*angstrom^2'), symmetry=1, barrier=(44.3077,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (179.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.630988,0.110734,-0.000184744,1.57121e-07,-5.26557e-11,-113227,31.8847], Tmin=(100,'K'), Tmax=(776.692,'K')), NASAPolynomial(coeffs=[14.265,0.028631,-1.57748e-05,3.15586e-09,-2.22769e-13,-115378,-35.1691], Tmin=(776.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-942.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CsCFFH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(Csj(Cd-CdH)(F1s)(F1s))"""),
)

species(
    label = 'FOC(F)(F)C(F)[C]=C(F)F(10981)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-812.243,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,164,312,561,654,898,1207,1299,3167,223,363,546,575,694,1179,1410,562,600,623,1070,1265,1685,370,180,180,1151.57],'cm^-1')),
        HinderedRotor(inertia=(0.289691,'amu*angstrom^2'), symmetry=1, barrier=(6.66057,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287287,'amu*angstrom^2'), symmetry=1, barrier=(6.60529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65662,'amu*angstrom^2'), symmetry=1, barrier=(38.0889,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (179.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.130047,0.0999602,-0.000157026,1.30645e-07,-4.38628e-11,-97550.1,32.6382], Tmin=(100,'K'), Tmax=(727.52,'K')), NASAPolynomial(coeffs=[12.0706,0.032866,-1.86632e-05,3.83088e-09,-2.76408e-13,-99325,-22.3392], Tmin=(727.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-812.243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(CdCFF) + radical(Cdj(Cs-F1sCsH)(Cd-F1sF1s))"""),
)

species(
    label = 'FOC(F)(F)C(F)[C]C(F)F(10982)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.913933,0.119061,-0.000200653,1.77005e-07,-6.17324e-11,-92978,43.3705], Tmin=(100,'K'), Tmax=(782.5,'K')), NASAPolynomial(coeffs=[12.8128,0.0369965,-2.05378e-05,4.12454e-09,-2.919e-13,-94762,-17.1593], Tmin=(782.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-774.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'F[C]C(F)C(F)C(F)(F)OF(10983)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.22216,'amu*angstrom^2'), symmetry=1, barrier=(28.0999,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.765247,0.076133,-0.000102608,7.23806e-08,-2.04768e-11,-64244.7,25.2177], Tmin=(100,'K'), Tmax=(861.416,'K')), NASAPolynomial(coeffs=[11.9446,0.0242209,-1.22117e-05,2.41971e-09,-1.72433e-13,-66170.7,-27.0482], Tmin=(861.416,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-535.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFO) + group(CdCFF)"""),
)

species(
    label = 'FOC(F)=C(F)C=C(F)F(10985)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-705.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,280,518,736,852,873,3010,987.5,1337.5,450,1655,326,540,652,719,1357,182,240,577,636,1210,1413,180,2183.02],'cm^-1')),
        HinderedRotor(inertia=(1.74082,'amu*angstrom^2'), symmetry=1, barrier=(40.0249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.500807,'amu*angstrom^2'), symmetry=1, barrier=(11.5145,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.131796,0.0932874,-0.000154364,1.34475e-07,-4.65425e-11,-84692.2,27.9613], Tmin=(100,'K'), Tmax=(771.879,'K')), NASAPolynomial(coeffs=[11.1798,0.0290482,-1.59496e-05,3.20079e-09,-2.26788e-13,-86189.6,-21.13], Tmin=(771.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-705.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-Cds(Cds-Cds)H) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFF)"""),
)

species(
    label = 'FOC(F)(F)C=C=C(F)F(10986)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.125474,0.0924835,-0.000144601,1.1605e-07,-3.69935e-11,-84984.6,27.8477], Tmin=(100,'K'), Tmax=(769.518,'K')), NASAPolynomial(coeffs=[13.0262,0.0254233,-1.38802e-05,2.79837e-09,-1.99658e-13,-86970,-31.0107], Tmin=(769.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-707.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCddFF) + group(Cdd-CdsCds)"""),
)

species(
    label = 'FC#CC(F)C(F)(F)OF(10987)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-616.312,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,233,378,609,1068,1270,1314,3037,223,363,546,575,694,1179,1410,2175,525,239,401,1367,180,180,2497.48],'cm^-1')),
        HinderedRotor(inertia=(0.588001,'amu*angstrom^2'), symmetry=1, barrier=(13.5193,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5856,'amu*angstrom^2'), symmetry=1, barrier=(36.456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58542,'amu*angstrom^2'), symmetry=1, barrier=(36.4519,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0986647,0.098511,-0.000166697,1.43717e-07,-4.84456e-11,-73985.7,28.1302], Tmin=(100,'K'), Tmax=(807.963,'K')), NASAPolynomial(coeffs=[12.551,0.0260923,-1.40686e-05,2.77816e-09,-1.9414e-13,-75710.1,-28.2217], Tmin=(807.963,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-616.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Ct-CtCs) + group(CtCF)"""),
)

species(
    label = '[CH]C(F)C(F)(F)OF(10988)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
4  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.615683,0.0814034,-0.000133423,1.14174e-07,-3.90168e-11,-40087.4,23.7202], Tmin=(100,'K'), Tmax=(733.729,'K')), NASAPolynomial(coeffs=[10.8733,0.0241288,-1.35658e-05,2.75652e-09,-1.97041e-13,-41556.3,-22.3427], Tmin=(733.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]C(F)(F)OF(2807)', 'CH2CF2(57)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2(43)', 'FOC(F)C=C(F)F(5434)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FOF(488)', 'F[C]C(F)C=C(F)F(10972)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
    products = ['FOC(C=C(F)F)C(F)(F)F(10973)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(488)', 'FC(F)=CC=C(F)F(3539)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
    products = ['FOC(F)(F)C=CC(F)(F)F(10974)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
    products = ['FC=CC(F)(F)C(F)(F)OF(7724)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOC(F)(F)[C](F)C[C](F)F(10975)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FOC(F)(F)[CH]C=C(F)F(10976)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'FO[C](F)C(F)C=C(F)F(10977)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'F[C]=CC(F)C(F)(F)OF(10978)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(F)(F)C(F)C=C(F)F(10979)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(128)', 'F[C](F)C(F)C=C(F)F(3722)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FO[C](F)F(2563)', 'F[CH]C=C(F)F(4846)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CF2CH(73)', 'F[CH]C(F)(F)OF(2818)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'FOC(F)(F)C(F)=C[C](F)F(10980)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'FOC(F)(F)C(F)[C]=C(F)F(10981)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FOC(F)(F)C(F)[C]C(F)F(10982)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C]C(F)C(F)C(F)(F)OF(10983)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'O=C(F)C(F)C=C(F)F(4734)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F2(78)', 'FOC(F)=CC=C(F)F(10984)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'FOC(F)=C(F)C=C(F)F(10985)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'FOC(F)(F)C=C=C(F)F(10986)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'FC#CC(F)C(F)(F)OF(10987)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CF2(43)', '[CH]C(F)C(F)(F)OF(10988)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(10922)'],
