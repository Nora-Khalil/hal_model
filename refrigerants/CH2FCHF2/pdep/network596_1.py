...
reaction(
    label = 'reaction2',
    reactants = ['HO2(11)', 'F[C]C(F)F(125)'],
    products = ['[O]OC(F)C(F)F(3435)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]OC(F)F(2885)'],
    products = ['[O]OC(F)C(F)F(3435)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C(F)C(F)F(3447)'],
    products = ['[O]OC(F)C(F)F(3435)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]O[CH]C(F)F(217)'],
    products = ['[O]OC(F)C(F)F(3435)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]OC(F)[CH]F(131)'],
    products = ['[O]OC(F)C(F)F(3435)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(82)', '[O]O[CH]F(209)'],
    products = ['[O]OC(F)C(F)F(3435)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]O[C](F)C(F)F(3448)'],
    products = ['[O]OC(F)C(F)F(3435)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OC(F)[C](F)F(3449)'],
    products = ['[O]OC(F)C(F)F(3435)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]OC(F)C(F)F(3435)'],
    products = ['OH(7)', 'O=C(F)C(F)F(3450)'],
