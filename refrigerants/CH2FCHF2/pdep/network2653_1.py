...
"""),
    ...
    molecularWeight = (75.0185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.49189,0.0135236,-6.97203e-06,1.2204e-09,-3.74999e-14,22562.5,13.2984], Tmin=(100,'K'), Tmax=(2085.91,'K')), NASAPolynomial(coeffs=[9.801,0.00441005,-2.56489e-06,4.97899e-10,-3.31305e-14,19281.1,-23.3345], Tmin=(2085.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.461,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=CJO) + longDistanceInteraction_cyclic(Cd(F)=CdOs)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]C(=O)F(1665)'],
    products = ['O=C1O[C]1F(8556)'],
    transitionState = 'TS2',
