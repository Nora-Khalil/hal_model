...
"""),
    ...
    molecularWeight = (100.03,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49459,0.0206588,2.36576e-05,-4.93122e-08,2.08089e-11,-15270.4,20.307], Tmin=(100,'K'), Tmax=(979.738,'K')), NASAPolynomial(coeffs=[13.1508,0.00765157,-3.12265e-06,6.84102e-10,-5.63424e-14,-18822.2,-38.3551], Tmin=(979.738,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-127.508,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cds-OdCsOs) + group(Cds-OdOsH) + ring(cyclopropanone) + radical(Cs_P) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (100.03,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71208,0.0294649,3.03496e-05,-8.54894e-08,4.21538e-11,-12378,20.2614], Tmin=(100,'K'), Tmax=(903.529,'K')), NASAPolynomial(coeffs=[24.091,-0.0138404,9.659e-06,-1.90994e-09,1.26308e-13,-18698.4,-98.0309], Tmin=(903.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-103.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cds-OdCsOs) + group(Cds-OdCsH) + ring(cyclopropanone) + radical(C=OCOJ) + radical(C=OCCJ=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C([O])=C=O(4742)'],
    products = ['O=[C]OC(=O)[C]=O(7105)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', 'O=[C]O[C]=O(4737)'],
    products = ['O=[C]OC(=O)[C]=O(7105)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]OC(=O)[C]=O(7105)'],
    products = ['[O]C1([C]=O)OC1=O(13618)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.1935e+10,'s^-1'), n=0.672833, Ea=(120.033,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_CO]
Euclidian distance = 1.7320508075688772
family: Intra_R_Add_Exocyclic
Ea raised from 117.0 to 120.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['CO(13)', 'O=[C]O[C]=O(4737)'],
    products = ['O=[C]OC(=O)[C]=O(7105)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[O]C([O])=C=O(4742)'],
    products = ['O=[C]OC(=O)[C]=O(7105)'],
    transitionState = 'TS9',
