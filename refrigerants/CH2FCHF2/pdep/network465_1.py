...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(441)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])F(2696)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]F(388)', '[CH2][O](2599)'],
    products = ['[CH2]OC([O])F(2696)'],
