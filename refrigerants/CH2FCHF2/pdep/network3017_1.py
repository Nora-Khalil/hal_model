...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)(F)[C](F)F(11866)'],
    products = ['O=O(207)', 'CF2CF2(61)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[C](F)F(2628)'],
    products = ['[O]OC(F)(F)[C](F)F(11866)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[O]O[C](F)F(219)'],
    products = ['[O]OC(F)(F)[C](F)F(11866)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)[C](F)F(11866)'],
    products = ['O(6)', 'FC1(F)OC1(F)F(3982)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]OC(F)=C(F)F(3744)'],
    products = ['[O]OC(F)(F)[C](F)F(11866)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', 'F[C](F)[C](F)F(4977)'],
    products = ['[O]OC(F)(F)[C](F)F(11866)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(43)', '[O]O[C](F)F(219)'],
    products = ['[O]OC(F)(F)[C](F)F(11866)'],
    transitionState = 'TS9',
