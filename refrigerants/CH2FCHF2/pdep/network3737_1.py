...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.382165,0.0685123,-5.97823e-05,1.38646e-08,3.28661e-12,-58509.6,25.3292], Tmin=(100,'K'), Tmax=(969.114,'K')), NASAPolynomial(coeffs=[21.4534,0.00630208,-1.8181e-06,3.54498e-10,-2.93417e-14,-63756.4,-81.6652], Tmin=(969.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-487.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsOsH) + group(COCsFO) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.285135,'amu*angstrom^2'), symmetry=1, barrier=(6.55582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.28536,'amu*angstrom^2'), symmetry=1, barrier=(6.56099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80105,'amu*angstrom^2'), symmetry=1, barrier=(41.4096,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.810242,0.0780259,-0.000132513,1.19196e-07,-4.21469e-11,32481.1,28.0338], Tmin=(100,'K'), Tmax=(800.053,'K')), NASAPolynomial(coeffs=[8.82636,0.0264874,-1.4397e-05,2.86794e-09,-2.01876e-13,31565.2,-6.55888], Tmin=(800.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.171,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'F[C]1OOC=CC1F(13710)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.92644,'amu*angstrom^2'), symmetry=1, barrier=(44.2927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.851241,'amu*angstrom^2'), symmetry=1, barrier=(19.5717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92036,'amu*angstrom^2'), symmetry=1, barrier=(44.1528,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.806285,0.0783622,-0.000132547,1.20239e-07,-4.30133e-11,-6798.19,25.278], Tmin=(100,'K'), Tmax=(795.185,'K')), NASAPolynomial(coeffs=[8.38169,0.0282641,-1.54237e-05,3.08056e-09,-2.17341e-13,-7623.83,-7.14886], Tmin=(795.185,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.4143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsCt) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.11679,'amu*angstrom^2'), symmetry=1, barrier=(25.6771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11696,'amu*angstrom^2'), symmetry=1, barrier=(25.6812,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.596625,'amu*angstrom^2'), symmetry=1, barrier=(13.7176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.598274,'amu*angstrom^2'), symmetry=1, barrier=(13.7555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67291,'amu*angstrom^2'), symmetry=1, barrier=(38.4636,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29835,0.0639895,-8.47469e-05,5.90294e-08,-1.65843e-11,46697.2,25.6654], Tmin=(100,'K'), Tmax=(864.804,'K')), NASAPolynomial(coeffs=[10.4851,0.0214971,-1.10424e-05,2.21034e-09,-1.58549e-13,45108.3,-17.3206], Tmin=(864.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.965947,0.0771381,-0.000139603,1.32853e-07,-4.84336e-11,23902.2,30.628], Tmin=(100,'K'), Tmax=(831.864,'K')), NASAPolynomial(coeffs=[6.34396,0.0299905,-1.62018e-05,3.19537e-09,-2.22586e-13,23744,10.0993], Tmin=(831.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COOC(F)=[C]F(13716)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.167038,'amu*angstrom^2'), symmetry=1, barrier=(3.84052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268159,'amu*angstrom^2'), symmetry=1, barrier=(6.1655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.99488,'amu*angstrom^2'), symmetry=1, barrier=(45.8662,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.838094,0.0766583,-0.000126798,1.11944e-07,-3.91907e-11,27494.5,28.9968], Tmin=(100,'K'), Tmax=(786.186,'K')), NASAPolynomial(coeffs=[9.19346,0.0258263,-1.39372e-05,2.77764e-09,-1.95967e-13,26437.9,-7.6676], Tmin=(786.186,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cds_P) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17916,'amu*angstrom^2'), symmetry=1, barrier=(27.1113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17952,'amu*angstrom^2'), symmetry=1, barrier=(27.1195,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45591,0.0600852,-7.84851e-05,5.21688e-08,-1.38851e-11,53247.6,23.5088], Tmin=(100,'K'), Tmax=(912.925,'K')), NASAPolynomial(coeffs=[10.999,0.0182706,-9.77892e-06,1.99445e-09,-1.44744e-13,51505.2,-21.6616], Tmin=(912.925,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsCt) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(CtCF) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.78877,'amu*angstrom^2'), symmetry=1, barrier=(41.1273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77026,'amu*angstrom^2'), symmetry=1, barrier=(40.7018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190298,'amu*angstrom^2'), symmetry=1, barrier=(4.37532,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09627,0.0703011,-9.79109e-05,7.81338e-08,-2.59802e-11,-3254.09,26.8016], Tmin=(100,'K'), Tmax=(726.815,'K')), NASAPolynomial(coeffs=[8.27902,0.0307694,-1.6322e-05,3.29367e-09,-2.36571e-13,-4298.16,-5.55886], Tmin=(726.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.8759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOC=CF(13720)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.265523,'amu*angstrom^2'), symmetry=1, barrier=(6.10489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157654,'amu*angstrom^2'), symmetry=1, barrier=(3.62477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.05881,'amu*angstrom^2'), symmetry=1, barrier=(47.3362,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52423,0.0650735,-6.45519e-05,-7.44775e-09,4.4034e-11,-2881.14,26.0354], Tmin=(100,'K'), Tmax=(489.706,'K')), NASAPolynomial(coeffs=[7.89414,0.0312499,-1.6717e-05,3.35326e-09,-2.38697e-13,-3723.32,-2.37697], Tmin=(489.706,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.6064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[C]=COOC(F)=CF(11116)'],
    products = ['[CH]=COOC(F)=CF(8276)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=COOC(F)=CF(8276)'],
    products = ['F[CH]C1(F)C=COO1(13711)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COOC(F)=CF(13712)'],
    products = ['[CH]=COOC(F)=CF(8276)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=COO[C]=CF(13713)'],
    products = ['[CH]=COOC(F)=CF(8276)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=COOC(=[CH])F(13714)'],
    products = ['[CH]=COOC(F)=CF(8276)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(F)[CH]F(215)', '[CH]=C[O](4002)'],
    products = ['[CH]=COOC(F)=CF(8276)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHFCF[Z](72)', '[CH]=CO[O](6974)'],
    products = ['[CH]=COOC(F)=CF(8276)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC(F)=CF(214)', '[CH]=[CH](4369)'],
    products = ['[CH]=COOC(F)=CF(8276)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=[C]OOC(F)=CF(13715)'],
    products = ['[CH]=COOC(F)=CF(8276)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=COOC(F)=[C]F(13716)'],
    products = ['[CH]=COOC(F)=CF(8276)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', '[CH]=COOC#C(13717)'],
    products = ['[CH]=COOC(F)=CF(8276)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[CH]=COOC#CF(13718)'],
    products = ['[CH]=COOC(F)=CF(8276)'],
