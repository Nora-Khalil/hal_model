...
"""),
    E0 = (-530.705,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,518,736,852,873,350,440,435,1725,182,240,577,636,1210,1413,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', '[CH2]C(=O)[CH]F(6840)'],
    products = ['C=C([O])C(F)[C](F)F(3923)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)[C](F)F(8666)'],
    products = ['C=C([O])C(F)[C](F)F(3923)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C(F)[C](F)F(3923)'],
    products = ['F[C](F)C(F)[C]1CO1(8668)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C([O])C=C(F)F(6462)'],
    products = ['C=C([O])C(F)[C](F)F(3923)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C([O])C(F)=C(F)F(8671)'],
    products = ['C=C([O])C(F)[C](F)F(3923)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[CH2]C(=O)[CH]F(6840)'],
    products = ['C=C([O])C(F)[C](F)F(3923)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C([O])C(F)[C](F)F(3923)'],
    products = ['[CH2]C(O)=C(F)[C](F)F(8673)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(O)C(F)[C](F)F(8674)'],
    products = ['C=C([O])C(F)[C](F)F(3923)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C([O])C(F)C(F)F(8675)'],
    products = ['C=C([O])C(F)[C](F)F(3923)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(=C[C](F)F)OF(8676)'],
    products = ['C=C([O])C(F)[C](F)F(3923)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([O])C(F)[C](F)F(3923)'],
    products = ['[CH2]C([O])=CC(F)(F)F(8677)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(18)', 'O=[C]C(F)[C](F)F(4354)'],
    products = ['C=C([O])C(F)[C](F)F(3923)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C([O])C(F)[C](F)F(3923)'],
    products = ['[CH2][C]1OC(F)(F)C1F(8679)'],
