...
"""),
    E0 = (-291.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,197,221,431,657,2120,512.5,787.5,1855,455,950,464.107],'cm^-1')),
        HinderedRotor(inertia=(0.306511,'amu*angstrom^2'), symmetry=1, barrier=(47.0101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302243,'amu*angstrom^2'), symmetry=1, barrier=(46.9593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305776,'amu*angstrom^2'), symmetry=1, barrier=(47.0091,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.028,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49643,0.0544451,-5.8879e-05,3.03437e-08,-6.15609e-12,-34922.2,24.5803], Tmin=(100,'K'), Tmax=(1192.5,'K')), NASAPolynomial(coeffs=[13.7223,0.0134358,-7.29465e-06,1.50531e-09,-1.10293e-13,-37838,-36.5547], Tmin=(1192.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-291.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + missing(O2d-Cdd) + group(Cd(Cdd-Od)FO) + group(Cds-OdOsH) + missing(Cdd-CdO2d) + radical((O)CJOC)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.71562,'amu*angstrom^2'), symmetry=1, barrier=(39.4454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.716,'amu*angstrom^2'), symmetry=1, barrier=(39.4542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71633,'amu*angstrom^2'), symmetry=1, barrier=(39.4617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71584,'amu*angstrom^2'), symmetry=1, barrier=(39.4504,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789821,0.0683645,-8.18079e-05,4.62802e-08,-1.01196e-11,-42603.6,25.5357], Tmin=(100,'K'), Tmax=(1124.22,'K')), NASAPolynomial(coeffs=[16.8201,0.0113278,-5.70547e-06,1.15074e-09,-8.38103e-14,-46207.9,-53.6782], Tmin=(1124.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-355.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical(COj(Cs-F1sO2sH)(O2d)) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C][C](F)OOC=O(6773)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {3,S} {6,S}
3 O u0 p2 c0 {2,S} {7,S}
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33808,0.055927,-5.53175e-05,2.63815e-08,-4.97146e-12,-49505.5,25.1569], Tmin=(100,'K'), Tmax=(1277.77,'K')), NASAPolynomial(coeffs=[14.2975,0.0153591,-7.69532e-06,1.53565e-09,-1.10412e-13,-52817.4,-40.5417], Tmin=(1277.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-412.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical(CsCOF1sO2s) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = '[O]C(O[C]=O)C(=O)F(6158)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {6,S} {8,S}
3 O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63519,0.0570575,-7.93608e-05,6.16802e-08,-1.97845e-11,-60376.6,26.428], Tmin=(100,'K'), Tmax=(754.816,'K')), NASAPolynomial(coeffs=[7.99949,0.023331,-1.23376e-05,2.48381e-09,-1.78159e-13,-61337.4,-2.48594], Tmin=(754.816,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-502.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(COCsFO) + group(Cds-OdOsH) + radical(C=OCOJ) + radical((O)CJOC)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.87744,'amu*angstrom^2'), symmetry=1, barrier=(43.1661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.8774,'amu*angstrom^2'), symmetry=1, barrier=(43.1651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.8771,'amu*angstrom^2'), symmetry=1, barrier=(43.1583,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47644,0.0521915,-5.44955e-05,2.67718e-08,-5.12422e-12,292.75,23.2652], Tmin=(100,'K'), Tmax=(1270.38,'K')), NASAPolynomial(coeffs=[14.6013,0.0108656,-5.70012e-06,1.16515e-09,-8.50443e-14,-3041.98,-43.1959], Tmin=(1270.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.65581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cdj(Cd-F1sO2s)(H)) + radical((O)CJOC)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.80341,'amu*angstrom^2'), symmetry=1, barrier=(41.464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80233,'amu*angstrom^2'), symmetry=1, barrier=(41.439,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80328,'amu*angstrom^2'), symmetry=1, barrier=(41.461,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.03,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6365,0.0484287,-5.56198e-05,2.99527e-08,-6.20171e-12,16545.9,24.96], Tmin=(100,'K'), Tmax=(1189.84,'K')), NASAPolynomial(coeffs=[13.9688,0.00696951,-3.35293e-06,6.67344e-10,-4.84502e-14,13611.2,-36.6799], Tmin=(1189.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + missing(O2d-Cdd) + group(Cds-(Cdd-O2d)OsH) + group(Cds-OdOsH) + missing(Cdd-CdO2d) + radical(C=CJO) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C]OOC(F)=[C]O(6778)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {3,S} {6,S}
3 O u0 p2 c0 {2,S} {8,S}
...
"""),
    E0 = (-203.05,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1277.5,1000,293,496,537,1218,1685,370,1855,455,950,203.531],'cm^-1')),
        HinderedRotor(inertia=(1.36254,'amu*angstrom^2'), symmetry=1, barrier=(40.0856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36364,'amu*angstrom^2'), symmetry=1, barrier=(40.0852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36406,'amu*angstrom^2'), symmetry=1, barrier=(40.0849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36453,'amu*angstrom^2'), symmetry=1, barrier=(40.085,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05058,0.0640141,-7.4245e-05,4.1068e-08,-8.8654e-12,-24314.3,28.2777], Tmin=(100,'K'), Tmax=(1131.08,'K')), NASAPolynomial(coeffs=[15.389,0.013307,-6.99861e-06,1.43242e-09,-1.048e-13,-27557.8,-42.6629], Tmin=(1131.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(O2s-(Cds-Cd)H) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(C=CJO) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C]OO[C]=COF(6779)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {3,S} {7,S}
3 O u0 p2 c0 {2,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.70389,'amu*angstrom^2'), symmetry=1, barrier=(39.1759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71013,'amu*angstrom^2'), symmetry=1, barrier=(39.3192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70379,'amu*angstrom^2'), symmetry=1, barrier=(39.1735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.69979,'amu*angstrom^2'), symmetry=1, barrier=(39.0814,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.520287,0.0668206,-7.59976e-05,3.98677e-08,-7.92293e-12,13744.5,30.6314], Tmin=(100,'K'), Tmax=(1256.78,'K')), NASAPolynomial(coeffs=[19.9014,0.00487446,-1.75165e-06,3.18175e-10,-2.28315e-14,8893.57,-67.2191], Tmin=(1256.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(O2sCF) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(C=CJO) + radical((O)CJOC)"""),
)

species(
    label = '[O]C=[C]OOC(=O)F(6780)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {3,S} {7,S}
3 O u0 p2 c0 {2,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.56692,'amu*angstrom^2'), symmetry=1, barrier=(36.0266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57637,'amu*angstrom^2'), symmetry=1, barrier=(36.2439,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56604,'amu*angstrom^2'), symmetry=1, barrier=(36.0064,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.966559,0.0513244,-2.04196e-05,-2.70053e-08,1.81257e-11,-38631.6,30.029], Tmin=(100,'K'), Tmax=(949.729,'K')), NASAPolynomial(coeffs=[22.2121,-0.000261666,1.20481e-06,-1.72259e-10,3.26022e-15,-44376.1,-80.3702], Tmin=(949.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-322.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(COFOO) + radical(C=COJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(1130)', 'O=C[C]F(284)'],
    products = ['O=[C]OO[C](F)C=O(6161)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', '[O]O[C](F)C=O(1934)'],
    products = ['O=[C]OO[C](F)C=O(6161)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['O=[C]OO[C](F)C=O(6161)'],
    products = ['O=[C]OOC1(F)[CH]O1(6768)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[O]O[C](F)C=O(1934)'],
    products = ['O=[C]OO[C](F)C=O(6161)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]OOC(F)=C=O(6771)'],
    products = ['O=[C]OO[C](F)C=O(6161)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]O[C]=O(1130)', 'O=C[C]F-2(1596)'],
    products = ['O=[C]OO[C](F)C=O(6161)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(6)', '[CH]=C(F)OO[C]=O(6774)'],
    products = ['O=[C]OO[C](F)C=O(6161)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]OO[C](F)C=O(6161)'],
    products = ['[O][C]=O(517)', 'FC1=COO1(285)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=[C]OO[C]=C=O(6777)'],
    products = ['O=[C]OO[C](F)C=O(6161)'],
