...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', '[CH2]C[O](2752)'],
    products = ['[CH2]CO[C](F)F(6394)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C](F)F(2728)'],
    products = ['[CH2]CO[C](F)F(6394)'],
    transitionState = 'TS3',
