...
species(
    label = 'F[CH]O[C](F)C(F)(F)F(11931)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[C](F)F(11872)'],
...
reaction(
    ...
    products = ['F[CH]OC(F)(F)[C](F)F(11872)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=C(F)F(3770)'],
    products = ['F[CH]OC(F)(F)[C](F)F(11872)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]OC(F)(F)[C](F)F(11872)'],
    products = ['F[CH]O[C](F)C(F)(F)F(11931)'],
...
network(
    label = 'PDepNetwork #3021',
    isomers = [
        'F[CH]OC(F)(F)[C](F)F(11872)',
    ],
    reactants = [
        ('CHFO(47)', 'CF2CF2(61)'),
    ],
