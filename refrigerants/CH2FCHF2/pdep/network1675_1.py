...
"""),
    E0 = (-505.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,180,180],'cm^-1')),
...
"""),
    E0 = (-107.186,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,194.953,195.739],'cm^-1')),
        HinderedRotor(inertia=(0.733734,'amu*angstrom^2'), symmetry=1, barrier=(19.3881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.72123,'amu*angstrom^2'), symmetry=1, barrier=(19.4166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.741987,'amu*angstrom^2'), symmetry=1, barrier=(19.3802,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0504,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.856574,0.0547087,-5.97813e-05,2.96164e-08,-5.40698e-12,-12766,20.8845], Tmin=(100,'K'), Tmax=(1536.36,'K')), NASAPolynomial(coeffs=[18.4927,0.000603085,1.03899e-06,-2.44405e-10,1.65567e-14,-17218.7,-68.6278], Tmin=(1536.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.21832,'amu*angstrom^2'), symmetry=1, barrier=(28.0116,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0504,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.470922,'amu*angstrom^2'), symmetry=1, barrier=(10.8274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.470875,'amu*angstrom^2'), symmetry=1, barrier=(10.8263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.469906,'amu*angstrom^2'), symmetry=1, barrier=(10.8041,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13387,0.0683624,-0.0001154,9.70294e-08,-3.13427e-11,-39202.3,20.9233], Tmin=(100,'K'), Tmax=(863.681,'K')), NASAPolynomial(coeffs=[10.5822,0.0154114,-7.47105e-06,1.39684e-09,-9.38548e-14,-40491.5,-21.2897], Tmin=(863.681,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsOsHH) + radical(Csj(Cs-F1sO2sH)(O2s-H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.15329,'amu*angstrom^2'), symmetry=1, barrier=(26.5165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15016,'amu*angstrom^2'), symmetry=1, barrier=(26.4445,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.75097,0.0145248,3.55437e-05,-6.12373e-08,2.54841e-11,-39934.3,13.5046], Tmin=(100,'K'), Tmax=(953.76,'K')), NASAPolynomial(coeffs=[12.7141,0.00531924,-1.21614e-06,2.71958e-10,-2.64288e-14,-43316.5,-41.858], Tmin=(953.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""HOCH2CHO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.22276,'amu*angstrom^2'), symmetry=1, barrier=(28.1136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2099,'amu*angstrom^2'), symmetry=1, barrier=(27.8179,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69976,0.036601,-2.17238e-06,-4.3355e-08,2.53418e-11,-26078.8,15.8031], Tmin=(100,'K'), Tmax=(894.672,'K')), NASAPolynomial(coeffs=[20.121,-0.00708394,6.22784e-06,-1.29769e-09,8.83314e-14,-30922.8,-79.6685], Tmin=(894.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(Cds-CdsOsH) + group(Cds-CdsOsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OC(F)OF(1038)'],
    products = ['OCC(F)OF(5390)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OF(482)', 'OC[C]F-2(5177)'],
    products = ['OCC(F)OF(5390)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(128)', 'OC[CH]F(5595)'],
    products = ['OCC(F)OF(5390)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(363)', 'CH2OH(33)'],
    products = ['OCC(F)OF(5390)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O[CH]C(F)OF(1052)'],
    products = ['OCC(F)OF(5390)'],
