...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.069313,0.100709,-0.00018069,1.64686e-07,-5.78683e-11,-76669.9,30.6288], Tmin=(100,'K'), Tmax=(825.987,'K')), NASAPolynomial(coeffs=[10.3752,0.0302952,-1.6797e-05,3.33385e-09,-2.32793e-13,-77718.7,-13.6673], Tmin=(825.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-638.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFFHO) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2]C(F)(F)OO[C](F)F(3397)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.438033,0.0847293,-0.000118928,8.53363e-08,-2.44635e-11,-79300.4,29.0679], Tmin=(100,'K'), Tmax=(850.889,'K')), NASAPolynomial(coeffs=[13.156,0.0249408,-1.35263e-05,2.75217e-09,-1.98775e-13,-81464.7,-30.2351], Tmin=(850.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-660.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFFO) + group(Cs-CsHHH) + group(CsFFHO) + radical(CJCOOH) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)

species(
    label = '[CH2][C](F)OOC(F)(F)F(3398)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.271899,0.0897422,-0.000147395,1.27682e-07,-4.39775e-11,-81954.8,30.3753], Tmin=(100,'K'), Tmax=(772.245,'K')), NASAPolynomial(coeffs=[10.9784,0.0279957,-1.52426e-05,3.04916e-09,-2.15705e-13,-83420.8,-17.2961], Tmin=(772.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-682.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFFFO) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(219)', 'F[C]CF-2(3008)'],
    products = ['FC[C](F)OO[C](F)F(3374)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)OO[C](F)F(3393)'],
    products = ['FC[C](F)OO[C](F)F(3374)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction14',
    reactants = ['FC[C](F)OO[C](F)F(3374)'],
    products = ['F[CH][C](F)OOC(F)F(3396)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FC[C](F)OO[C](F)F(3374)'],
    products = ['[CH2]C(F)(F)OO[C](F)F(3397)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FC[C](F)OO[C](F)F(3374)'],
    products = ['[CH2][C](F)OOC(F)(F)F(3398)'],
