...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20456,0.0669657,-9.57127e-05,7.38715e-08,-2.3063e-11,-85295.8,24.8675], Tmin=(100,'K'), Tmax=(780.418,'K')), NASAPolynomial(coeffs=[9.69317,0.0234549,-1.20777e-05,2.42231e-09,-1.7346e-13,-86620.6,-13.98], Tmin=(780.418,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-709.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]C(F)(F)C([O])(F)CF(3067)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.658862,0.0653986,-5.27462e-05,2.02837e-08,-3.08018e-12,-125017,23.6062], Tmin=(100,'K'), Tmax=(1563.41,'K')), NASAPolynomial(coeffs=[18.3057,0.0202492,-9.42796e-06,1.81209e-09,-1.26439e-13,-130535,-69.4152], Tmin=(1563.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1040.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsCsHH) + group(CsCFFO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(Cs-Cs(F)(F)-O2s-Cs)"""),
)
...
"""),
    E0 = (-631.083,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,190,488,555,1236,1407,281.558,281.748,282.556],'cm^-1')),
        HinderedRotor(inertia=(0.134826,'amu*angstrom^2'), symmetry=1, barrier=(7.57178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135732,'amu*angstrom^2'), symmetry=1, barrier=(7.57147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134716,'amu*angstrom^2'), symmetry=1, barrier=(7.57118,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.574282,0.085719,-0.000147595,1.36294e-07,-4.85216e-11,-75788.4,25.7805], Tmin=(100,'K'), Tmax=(841.274,'K')), NASAPolynomial(coeffs=[7.19968,0.033337,-1.69678e-05,3.27582e-09,-2.25674e-13,-76164.3,-0.646546], Tmin=(841.274,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-631.083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.272761,0.0887462,-0.000122293,8.94307e-08,-2.64017e-11,-89436.5,30.6465], Tmin=(100,'K'), Tmax=(824.316,'K')), NASAPolynomial(coeffs=[12.3581,0.0301,-1.55706e-05,3.11605e-09,-2.2305e-13,-91428.8,-25.3228], Tmin=(824.316,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-744.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + radical(CCJCO) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'OC(F)([CH]F)C[C](F)F(3135)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.478135,0.11274,-0.000206598,1.91721e-07,-6.77082e-11,-89454.8,30.5276], Tmin=(100,'K'), Tmax=(846.895,'K')), NASAPolynomial(coeffs=[9.59368,0.0360931,-1.93428e-05,3.77633e-09,-2.60448e-13,-90118,-10.2332], Tmin=(846.895,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-744.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + radical(Csj(Cs-F1sO2sCs)(F1s)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O]C(F)([CH]F)CC(F)F(3136)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-711.586,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,316,385,515,654,689,1295,235,523,627,1123,1142,1372,1406,3097,334,575,1197,1424,3202,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.261216,'amu*angstrom^2'), symmetry=1, barrier=(6.00586,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261251,'amu*angstrom^2'), symmetry=1, barrier=(6.00667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261263,'amu*angstrom^2'), symmetry=1, barrier=(6.00696,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.294137,0.107376,-0.00019168,1.76496e-07,-6.22522e-11,-85441.9,29.6481], Tmin=(100,'K'), Tmax=(842.617,'K')), NASAPolynomial(coeffs=[9.32756,0.0360286,-1.89707e-05,3.69348e-09,-2.54931e-13,-86152,-9.71555], Tmin=(842.617,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-711.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-F1sO2sCs)(F1s)(H))"""),
)

species(
    label = 'FC[C](C[C](F)F)OF(3137)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-400.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,190,488,555,1236,1407,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.156218,'amu*angstrom^2'), symmetry=1, barrier=(3.59175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156212,'amu*angstrom^2'), symmetry=1, barrier=(3.59161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156214,'amu*angstrom^2'), symmetry=1, barrier=(3.59167,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.926126,'amu*angstrom^2'), symmetry=1, barrier=(21.2935,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.146139,0.103759,-0.000183686,1.6955e-07,-6.00716e-11,-48067.6,31.4582], Tmin=(100,'K'), Tmax=(840.869,'K')), NASAPolynomial(coeffs=[8.73796,0.0365002,-1.91138e-05,3.71865e-09,-2.56809e-13,-48677.9,-4.60783], Tmin=(840.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-400.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCsFHH) + group(CsCsFFH) + radical(C2CsJO) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O][C](CF)CC(F)(F)F(3138)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.322413,0.0893756,-0.000124939,8.74205e-08,-2.12425e-11,-90791.5,27.7084], Tmin=(100,'K'), Tmax=(629.47,'K')), NASAPolynomial(coeffs=[11.4594,0.0310533,-1.5623e-05,3.06064e-09,-2.15297e-13,-92440.2,-22.8248], Tmin=(629.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-755.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCsFHH) + group(CsCsFFF) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(F)(C[C](F)F)OF(3139)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-425.063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,190,488,555,1236,1407,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.220752,'amu*angstrom^2'), symmetry=1, barrier=(5.07553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222076,'amu*angstrom^2'), symmetry=1, barrier=(5.10597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633757,'amu*angstrom^2'), symmetry=1, barrier=(14.5713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77259,'amu*angstrom^2'), symmetry=1, barrier=(40.7553,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.43826,0.10911,-0.000189349,1.70817e-07,-5.98649e-11,-50974.6,29.794], Tmin=(100,'K'), Tmax=(821.2,'K')), NASAPolynomial(coeffs=[10.7777,0.0351274,-1.88658e-05,3.72091e-09,-2.59623e-13,-52164.2,-18.1341], Tmin=(821.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(Csj(Cs-F1sO2sCs)(H)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]C([O])(F)CC(F)(F)F(3140)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0221546,0.0974224,-0.000159375,1.39572e-07,-4.81222e-11,-92848.3,28.5231], Tmin=(100,'K'), Tmax=(813.426,'K')), NASAPolynomial(coeffs=[10.4144,0.0331553,-1.69907e-05,3.31189e-09,-2.30424e-13,-94117.9,-17.0397], Tmin=(813.426,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-773.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFF) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(CF)C[C](F)F(3069)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]C(F)C[C](F)F(374)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(23.2546,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]C(F)(F)C[C](F)F(2684)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(158.706,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)C([O])(F)CF(3067)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'FC[C](F)C[C](F)F(166)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(156)', '[CH2]C([O])(F)CF(3127)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(CF)C[C](F)F(3069)'],
    products = ['FCC1(F)CC(F)(F)O1(3072)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', 'C=C([O])C[C](F)F(3131)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(19.7841,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[O]C(=C[C](F)F)CF(3132)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(298.329,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=C([CH]F)C[C](F)F(3133)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(286.672,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['CF2(43)', '[CH2]C([O])(F)CF(3127)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(2.01583,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(CF)C[C](F)F(3069)'],
    products = ['OC(F)([CH][C](F)F)CF(3134)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)(CF)C[C](F)F(3069)'],
    products = ['OC(F)([CH]F)C[C](F)F(3135)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)([CH]F)CC(F)F(3136)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FC[C](C[C](F)F)OF(3137)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)(CF)C[C](F)F(3069)'],
    products = ['[O][C](CF)CC(F)(F)F(3138)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(205.605,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(F)(C[C](F)F)OF(3139)'],
    products = ['[O]C(F)(CF)C[C](F)F(3069)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)(CF)C[C](F)F(3069)'],
    products = ['[CH2]C([O])(F)CC(F)(F)F(3140)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(0.000550858,'s^-1'), n=4.50663, Ea=(212.104,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R"""),
)

network(
    label = 'PDepNetwork #555',
    isomers = [
        '[O]C(F)(CF)C[C](F)F(3069)',
    ],
    reactants = [
