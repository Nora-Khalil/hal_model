...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(O)(F)F(3033)'],
    products = ['[O]OC(O)(F)F(2901)'],
    transitionState = 'TS2',
