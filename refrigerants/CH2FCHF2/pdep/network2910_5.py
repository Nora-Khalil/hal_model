...
"""),
    E0 = (499.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,180,430.24,2270.75,2271.98],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (41.0287,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.53854,0.0135514,-2.71195e-05,2.95089e-08,-1.15133e-11,60077.6,11.1074], Tmin=(100,'K'), Tmax=(870.424,'K')), NASAPolynomial(coeffs=[2.73239,0.00877365,-4.26824e-06,8.10999e-10,-5.50988e-14,60539.2,16.7306], Tmin=(870.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(499.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C=CJO)"""),
)
...
"""),
    E0 = (314.199,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([293,496,537,1218,2525.01,2525.03],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (59.0191,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.3106,0.0276456,-7.98501e-05,9.64782e-08,-3.90912e-11,37802.3,12.6394], Tmin=(100,'K'), Tmax=(875.806,'K')), NASAPolynomial(coeffs=[-2.11326,0.020067,-1.1463e-05,2.2456e-09,-1.53152e-13,39993,45.1703], Tmin=(875.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(83.1447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + ring(oxirene) + radical(C=CJO)"""),
)

species(
    label = 'FC1[C-]=[O+]1(8452)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.25485,0.0183198,-3.16152e-05,2.52852e-08,-7.90352e-12,76363.3,5.26718], Tmin=(100,'K'), Tmax=(786.534,'K')), NASAPolynomial(coeffs=[6.26383,0.00301754,-2.43253e-06,5.50259e-10,-4.15946e-14,75889.9,-8.52694], Tmin=(786.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(634.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(58.2013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Ct-CtOs) + group(Ct-CtOs) + ring(Cyclopropyne)"""),
)

species(
    label = '[CH]C(=O)F-2(12398)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {3,D}
3 C u0 p0 c0 {1,S} {2,D} {4,S}
...
"""),
    ...
    molecularWeight = (60.0271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.17735,0.0201067,-2.58793e-05,2.00363e-08,-6.66688e-12,3378.69,10.997], Tmin=(100,'K'), Tmax=(718.062,'K')), NASAPolynomial(coeffs=[4.9288,0.0103509,-5.50129e-06,1.11825e-09,-8.08765e-14,3127.14,3.12717], Tmin=(718.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.8611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(5)', 'O=C=[C]F(289)'],
    products = ['O=[C][CH]F(4685)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O=[C][CH]F(4685)'],
    products = ['O=C=CF(2952)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'HCCO(21)'],
    products = ['O=[C][CH]F(4685)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(39.5794,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O=C[C]F(9027)'],
    products = ['O=[C][CH]F(4685)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O[C]=[C]F(6968)'],
    products = ['O=[C][CH]F(4685)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.98415e+06,'s^-1'), n=1.87925, Ea=(175.074,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3Hall;Cd_rad_out_single;XH_out] for rate rule [R3HJ;Cd_rad_out_single;O_H_out]
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[C]OF(8043)'],
    products = ['O=[C][CH]F(4685)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(49.5216,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH]C(=O)F(8932)'],
    products = ['O=[C][CH]F(4685)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O(6)', '[CH]=[C]F(252)'],
    products = ['[CH]C(=O)F(8932)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction28',
    reactants = ['O=C=CF(2952)'],
    products = ['CO(13)', 'CHF(40)'],
