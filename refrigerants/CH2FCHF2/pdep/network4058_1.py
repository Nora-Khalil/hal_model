...
reaction(
    label = 'reaction1',
    reactants = ['HO2(11)', '[O]OC(F)(F)F(3645)'],
    products = ['OOOOC(F)(F)F(14313)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'OOOO[C](F)F(14318)'],
    products = ['OOOOC(F)(F)F(14313)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OH(7)', '[O]OOC(F)(F)F(13017)'],
    products = ['OOOOC(F)(F)F(14313)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[O]OOOC(F)(F)F(12876)'],
    products = ['OOOOC(F)(F)F(14313)'],
    transitionState = 'TS6',
