...
10 C u0 p0 c0 {3,S} {7,S} {8,S} {14,S}
...
"""),
    E0 = (-1230.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,265.446,267.131,267.751,269.014],'cm^-1')),
        HinderedRotor(inertia=(0.577974,'amu*angstrom^2'), symmetry=1, barrier=(29.4838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22321,'amu*angstrom^2'), symmetry=1, barrier=(11.3704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221687,'amu*angstrom^2'), symmetry=1, barrier=(11.3707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.447799,'amu*angstrom^2'), symmetry=1, barrier=(23.0704,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (182.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.810956,0.114832,-0.000163633,1.21875e-07,-3.64542e-11,-147773,31.7881], Tmin=(100,'K'), Tmax=(815.295,'K')), NASAPolynomial(coeffs=[15.1709,0.0364212,-1.93685e-05,3.9085e-09,-2.80699e-13,-150379,-42.0513], Tmin=(815.295,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1230.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH)"""),
)
...
"""),
    E0 = (-1161.68,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,180,180,1173.44],'cm^-1')),
        HinderedRotor(inertia=(0.413735,'amu*angstrom^2'), symmetry=1, barrier=(9.51258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70668,'amu*angstrom^2'), symmetry=1, barrier=(39.24,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-642.034,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,617,898,1187,254.953,254.961,254.973],'cm^-1')),
        HinderedRotor(inertia=(0.202447,'amu*angstrom^2'), symmetry=1, barrier=(9.3384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202425,'amu*angstrom^2'), symmetry=1, barrier=(9.33845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.446781,'amu*angstrom^2'), symmetry=1, barrier=(20.6093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.841113,'amu*angstrom^2'), symmetry=1, barrier=(38.7981,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.27985,0.101963,-0.000151507,1.17004e-07,-3.60886e-11,-77071.9,30.397], Tmin=(100,'K'), Tmax=(793.174,'K')), NASAPolynomial(coeffs=[13.9108,0.0303973,-1.61633e-05,3.24408e-09,-2.31647e-13,-79322.9,-34.7763], Tmin=(793.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-642.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-1226.91,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,333,384,448,608,1254,1480,2750,2850,1437.5,1250,1305,750,350,176,294,457,589,547,707,1086,1160,1127,1157,1302,1442,1365,1447,3042,3152,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.915555,'amu*angstrom^2'), symmetry=1, barrier=(21.0504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915499,'amu*angstrom^2'), symmetry=1, barrier=(21.0491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915572,'amu*angstrom^2'), symmetry=1, barrier=(21.0508,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (182.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.778928,0.1135,-0.000155619,1.10262e-07,-3.13187e-11,-147398,31.6264], Tmin=(100,'K'), Tmax=(857.547,'K')), NASAPolynomial(coeffs=[16.0071,0.0351977,-1.86466e-05,3.77158e-09,-2.71821e-13,-150277,-46.7759], Tmin=(857.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1226.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsCsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFFH)"""),
)
...
"""),
    E0 = (-812.811,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,487,638,688,1119,1325,1387,3149,235,523,627,1123,1142,1372,1406,3097,212,367,445,1450,224.56,224.56,224.561,224.562],'cm^-1')),
        HinderedRotor(inertia=(0.155737,'amu*angstrom^2'), symmetry=1, barrier=(5.57297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.514909,'amu*angstrom^2'), symmetry=1, barrier=(18.4263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155736,'amu*angstrom^2'), symmetry=1, barrier=(5.57297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01684,'amu*angstrom^2'), symmetry=1, barrier=(36.3869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.449376,0.106711,-0.000167134,1.42072e-07,-4.86599e-11,-97606.8,32.6234], Tmin=(100,'K'), Tmax=(748.704,'K')), NASAPolynomial(coeffs=[11.9363,0.0367762,-1.94807e-05,3.88328e-09,-2.75165e-13,-99356,-22.8414], Tmin=(748.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-812.811,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + radical(CsCsCsF1s)"""),
)

species(
    label = 'FO[CH]C(F)(F)CC(F)F(7779)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-840.487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,187.872,187.875,187.914,187.922],'cm^-1')),
        HinderedRotor(inertia=(0.00477379,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.584777,'amu*angstrom^2'), symmetry=1, barrier=(14.6512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.584776,'amu*angstrom^2'), symmetry=1, barrier=(14.6507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.798079,'amu*angstrom^2'), symmetry=1, barrier=(19.9993,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.813078,0.115154,-0.000179253,1.4201e-07,-4.39073e-11,-100923,31.3541], Tmin=(100,'K'), Tmax=(693.127,'K')), NASAPolynomial(coeffs=[15.1231,0.0316368,-1.67987e-05,3.3449e-09,-2.36722e-13,-103335,-41.1516], Tmin=(693.127,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-840.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CCsJO)"""),
)

species(
    label = 'F[CH]CC(F)(F)C(F)OF(7819)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-816.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,334,575,1197,1424,3202,307.456,307.46,307.463,307.496],'cm^-1')),
        HinderedRotor(inertia=(0.11939,'amu*angstrom^2'), symmetry=1, barrier=(8.01146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119395,'amu*angstrom^2'), symmetry=1, barrier=(8.01156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.366115,'amu*angstrom^2'), symmetry=1, barrier=(24.5641,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.450813,'amu*angstrom^2'), symmetry=1, barrier=(30.2458,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.63536,0.110698,-0.000171257,1.39951e-07,-4.57891e-11,-98033.4,31.496], Tmin=(100,'K'), Tmax=(748.623,'K')), NASAPolynomial(coeffs=[13.654,0.0343328,-1.82149e-05,3.63628e-09,-2.58094e-13,-100172,-33.302], Tmin=(748.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-816.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFHH) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[O]C(F)C(F)(F)CC(F)F(7820)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1137.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,222,329,445,522,589,1214,1475,235,523,627,1123,1142,1372,1406,3097,391,562,707,872,1109,1210,1289,3137,219.231,219.244,219.336],'cm^-1')),
        HinderedRotor(inertia=(0.231913,'amu*angstrom^2'), symmetry=1, barrier=(7.89974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391728,'amu*angstrom^2'), symmetry=1, barrier=(13.3787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231281,'amu*angstrom^2'), symmetry=1, barrier=(7.89803,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.211441,0.10014,-0.000143916,1.10732e-07,-3.43214e-11,-136720,30.3591], Tmin=(100,'K'), Tmax=(787.334,'K')), NASAPolynomial(coeffs=[12.8881,0.0335929,-1.71411e-05,3.39386e-09,-2.40798e-13,-138783,-29.7071], Tmin=(787.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1137.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sH))"""),
)
...
"""),
    E0 = (-973.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.195068,'amu*angstrom^2'), symmetry=1, barrier=(4.48501,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195053,'amu*angstrom^2'), symmetry=1, barrier=(4.48466,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.13713,0.0833688,-0.000154894,1.8129e-07,-8.92311e-11,-117128,14.3948], Tmin=(10,'K'), Tmax=(488.131,'K')), NASAPolynomial(coeffs=[8.13961,0.0423756,-2.89237e-05,9.24436e-09,-1.11617e-12,-117616,-6.15163], Tmin=(488.131,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-973.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), label="""F[CH]C(F)(F)CC(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
species(
    label = 'FOC(F)C(F)(F)[CH]C(F)F(7821)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1022.42,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,261,493,600,1152,1365,1422,3097,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,180,180,180,1939.4],'cm^-1')),
        HinderedRotor(inertia=(0.540984,'amu*angstrom^2'), symmetry=1, barrier=(12.4383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.540814,'amu*angstrom^2'), symmetry=1, barrier=(12.4344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28592,'amu*angstrom^2'), symmetry=1, barrier=(29.5659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28596,'amu*angstrom^2'), symmetry=1, barrier=(29.5668,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (181.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.665767,0.111773,-0.000167018,1.3047e-07,-4.08648e-11,-122809,34.3583], Tmin=(100,'K'), Tmax=(780.177,'K')), NASAPolynomial(coeffs=[14.369,0.0346834,-1.87937e-05,3.8021e-09,-2.72708e-13,-125155,-34.4426], Tmin=(780.177,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1022.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H))"""),
)
...
species(
    label = 'FOC(F)C(F)(F)C[C](F)F(7822)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1029.49,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,190,488,555,1236,1407,205.944,205.959,205.983,206.002],'cm^-1')),
        HinderedRotor(inertia=(0.273703,'amu*angstrom^2'), symmetry=1, barrier=(8.23934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06848,'amu*angstrom^2'), symmetry=1, barrier=(32.1549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00397658,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.692352,'amu*angstrom^2'), symmetry=1, barrier=(20.8332,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (181.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04537,0.121363,-0.000201211,1.74033e-07,-5.95913e-11,-123647,33.966], Tmin=(100,'K'), Tmax=(778.474,'K')), NASAPolynomial(coeffs=[13.8591,0.035943,-1.95911e-05,3.9162e-09,-2.76668e-13,-125700,-32.4873], Tmin=(778.474,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1029.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + group(CsCsFFH) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-1038.74,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,231,348,427,405,1245,1236,1280,235,523,627,1123,1142,1372,1406,3097,2782.5,750,1395,475,1775,1000,268.889,268.891],'cm^-1')),
        HinderedRotor(inertia=(0.172655,'amu*angstrom^2'), symmetry=1, barrier=(8.85868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17266,'amu*angstrom^2'), symmetry=1, barrier=(8.85873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311621,'amu*angstrom^2'), symmetry=1, barrier=(15.9885,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.632116,0.0808587,-0.000106534,7.83188e-08,-2.37716e-11,-124816,26.4391], Tmin=(100,'K'), Tmax=(795.915,'K')), NASAPolynomial(coeffs=[10.0721,0.0334149,-1.71169e-05,3.41999e-09,-2.44834e-13,-126319,-16.9483], Tmin=(795.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1038.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFFH) + group(Cds-OdCsH)"""),
)

species(
    label = 'FOC=C(F)CC(F)F(7783)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-659.554,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,323,467,575,827,1418,3010,987.5,1337.5,450,1655,292.679,292.706,292.716],'cm^-1')),
        HinderedRotor(inertia=(0.12588,'amu*angstrom^2'), symmetry=1, barrier=(7.65231,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125875,'amu*angstrom^2'), symmetry=1, barrier=(7.65219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.454441,'amu*angstrom^2'), symmetry=1, barrier=(27.6271,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.495756,0.0835008,-0.000108732,7.68694e-08,-2.22e-11,-79205.5,27.4312], Tmin=(100,'K'), Tmax=(838.097,'K')), NASAPolynomial(coeffs=[11.3359,0.0317646,-1.6138e-05,3.21641e-09,-2.30134e-13,-81022.6,-22.952], Tmin=(838.097,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-659.554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH)"""),
)

species(
    label = 'FOC(F)C(F)=CC(F)F(7823)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-873.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,236,527,855,1015,1182,1348,3236,171,205,598,1104,1143,1317,1411,3153,323,467,575,827,1418,3010,987.5,1337.5,450,1655,248.506,260.335,265.494],'cm^-1')),
        HinderedRotor(inertia=(0.173835,'amu*angstrom^2'), symmetry=1, barrier=(8.553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190747,'amu*angstrom^2'), symmetry=1, barrier=(8.61743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.962515,'amu*angstrom^2'), symmetry=1, barrier=(40.0107,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.129284,0.0929092,-0.000132445,1.0209e-07,-3.19814e-11,-104874,29.1316], Tmin=(100,'K'), Tmax=(776.437,'K')), NASAPolynomial(coeffs=[11.6589,0.0335106,-1.769e-05,3.5571e-09,-2.54809e-13,-106664,-23.5744], Tmin=(776.437,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-873.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CsCFFH) + group(CdCsCdF) + group(Cds-CdsCsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    products = ['HF(38)', 'CHFO(47)', 'FC(F)=CC(F)F(2834)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(47.0453,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FOC(F)CC(F)F(697)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(339.723,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['FOC(F)F(703)', 'F[C]CC(F)F(718)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(185.504,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F[C]C(F)OF(479)', 'CH2FCHF2(1)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(174.512,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FOC(F)C(F)(F)C(F)F(7815)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.000166864,'m^3/(mol*s)'), n=2.82973, Ea=(139.481,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction6',
    reactants = ['OF(482)', 'F[C]C(F)(F)CC(F)F(7712)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(47.1281,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'FOC(F)(F)CC(F)F(2803)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(130.003,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CF2(43)', 'CC(F)(F)C(F)OF(698)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.00405e-10,'m^3/(mol*s)'), n=4.72997, Ea=(130.576,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'F[C]CC(F)(F)C(F)OF(7816)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(133.48,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction11',
    reactants = ['FOC(F)(CC(F)F)C(F)F(7817)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOF(488)', 'FC=C(F)CC(F)F(160)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FOC(F)[C](F)CC(F)F(7818)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'FO[CH]C(F)(F)CC(F)F(7779)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'F[CH]CC(F)(F)C(F)OF(7819)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(F)C(F)(F)CC(F)F(7820)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(128)', 'F[CH]C(F)(F)CC(F)F(4097)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FOC(F)[C](F)F(712)', 'CHF2-CH2(64)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]OF(363)', 'F[C](F)CC(F)F(2837)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHF2(82)', '[CH2]C(F)(F)C(F)OF(714)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'FOC(F)C(F)(F)[CH]C(F)F(7821)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'FO[C](F)C(F)(F)CC(F)F(7716)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'FOC(F)C(F)(F)C[C](F)F(7822)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'O=CC(F)(F)CC(F)F(7562)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(68.3415,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction25',
    reactants = ['F2(78)', 'FOC=C(F)CC(F)F(7783)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(4.46059,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'FOC(F)C(F)=CC(F)F(7823)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(188.827,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'FC=CC(F)(F)C(F)OF(7824)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)CC(F)F(7472)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(468.227,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction29',
    reactants = ['HF(38)', 'FOC(F)=C(F)CC(F)F(7722)'],
    products = ['FOC(F)C(F)(F)CC(F)F(7803)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(179.098,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

network(
    label = 'PDepNetwork #2073',
    isomers = [
        'FOC(F)C(F)(F)CC(F)F(7803)',
    ],
    reactants = [
        ('HF(38)', 'CHFO(47)', 'FC(F)=CC(F)F(2834)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
