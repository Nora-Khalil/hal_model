...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'O[C](F)OOF(3034)'],
    products = ['OC(F)(F)OOF(9781)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[O]OC(O)(F)F(2901)'],
    products = ['OC(F)(F)OOF(9781)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]F(128)', '[O]C(O)(F)F(3033)'],
    products = ['OC(F)(F)OOF(9781)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OF(127)', 'O[C](F)F(2676)'],
    products = ['OC(F)(F)OOF(9781)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)OOF(9811)'],
    products = ['OC(F)(F)OOF(9781)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'O=C(F)OOF(9812)'],
    products = ['OC(F)(F)OOF(9781)'],
    transitionState = 'TS8',
