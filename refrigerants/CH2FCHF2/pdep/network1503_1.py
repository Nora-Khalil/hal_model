...
"""),
    E0 = (-106.52,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,1191.68],'cm^-1')),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[CH2]C[CH]F(5221)'],
    products = ['[CH2]CC(F)[CH]F(5218)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CHFCHF[Z](59)', '[CH2][CH2](4469)'],
    products = ['[CH2]CC(F)[CH]F(5218)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]CC(F)=CF(5226)'],
    products = ['[CH2]CC(F)[CH]F(5218)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=CC(F)[CH]F(5227)'],
    products = ['[CH2]CC(F)[CH]F(5218)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][CH]F(141)', '[CH2][CH2](4469)'],
    products = ['[CH2]CC(F)[CH]F(5218)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH2]C=C[CH]F(5228)'],
    products = ['[CH2]CC(F)[CH]F(5218)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C[CH]F(5221)'],
    products = ['[CH2]CC(F)[CH]F(5218)'],
