...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[CH2]C([O])=O(540)'],
    products = ['[CH2]C(=O)O[CH]F(3254)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[CH]F(515)'],
    products = ['[CH2]C(=O)O[CH]F(3254)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]C([O])=O(540)'],
    products = ['[CH2]C(=O)O[CH]F(3254)'],
