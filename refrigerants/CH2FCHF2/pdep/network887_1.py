...
"""),
    E0 = (-474.34,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([347,453,1141,1468,235,523,627,1123,1142,1372,1406,3097,321.072,321.08,321.08,321.082,321.099,1542.38,2121.48],'cm^-1')),
        HinderedRotor(inertia=(0.140232,'amu*angstrom^2'), symmetry=1, barrier=(10.2589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00163517,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32284,0.0647219,-0.00010542,9.24441e-08,-3.23487e-11,-56959.2,20.1369], Tmin=(100,'K'), Tmax=(773.296,'K')), NASAPolynomial(coeffs=[8.44429,0.0222138,-1.19647e-05,2.39105e-09,-1.69228e-13,-57891,-11.2927], Tmin=(773.296,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-474.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['HF(38)', 'F[C]C(F)=CF(5202)'],
    products = ['FC=C(F)C(F)F(796)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]C(F)=CF(5038)'],
    products = ['FC=C(F)C(F)F(796)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC=[C]C(F)F(5083)'],
    products = ['FC=C(F)C(F)F(796)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(F)C(F)F(5024)'],
    products = ['FC=C(F)C(F)F(796)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC=C(F)[C](F)F(4140)'],
    products = ['FC=C(F)C(F)F(796)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C]=C(F)C(F)F(4139)'],
    products = ['FC=C(F)C(F)F(796)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'FC=C=C(F)F(5206)'],
    products = ['FC=C(F)C(F)F(796)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'FC#CC(F)F(4078)'],
    products = ['FC=C(F)C(F)F(796)'],
