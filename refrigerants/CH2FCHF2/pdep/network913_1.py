...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]1OC1(F)F(5985)'],
    products = ['FC1(F)OC1(F)F(3982)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(78)', 'FC1=C(F)O1(5986)'],
    products = ['FC1(F)OC1(F)F(3982)'],
    transitionState = 'TS6',
