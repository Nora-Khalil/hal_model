...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C([O])(F)F(2711)'],
    products = ['[O]C(F)(F)O[C]=O(4262)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C([O])(F)F(2711)'],
    products = ['[O]C(F)(F)O[C]=O(4262)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(=O)F(1309)'],
    products = ['[O]C(F)(F)O[C]=O(4262)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(2580)', '[O][C]=O(517)'],
    products = ['[O]C(F)(F)O[C]=O(4262)'],
    transitionState = 'TS9',
