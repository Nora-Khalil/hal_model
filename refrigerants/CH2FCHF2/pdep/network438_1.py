...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C=C[C]F(270)'],
    products = ['[O]CC=[C]F(2671)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](2653)', '[CH]=[C]F(252)'],
    products = ['[O]CC=[C]F(2671)'],
    transitionState = 'TS9',
