...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)O[C](F)F(3683)'],
...
reaction(
    ...
    products = ['F[CH]C(F)(F)O[C](F)F(3683)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'F[C](F)O[C](F)F(2625)'],
    products = ['F[CH]C(F)(F)O[C](F)F(3683)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC=C(F)O[C](F)F(2581)'],
    products = ['F[CH]C(F)(F)O[C](F)F(3683)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'F[C](F)O[C](F)F(2625)'],
    products = ['F[CH]C(F)(F)O[C](F)F(3683)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)O[C](F)C(F)F(3794)'],
    products = ['F[CH]C(F)(F)O[C](F)F(3683)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]C(F)(F)O[C](F)F(3683)'],
    products = ['F[CH][C](F)OC(F)(F)F(3798)'],
...
network(
    label = 'PDepNetwork #811',
    isomers = [
        'F[CH]C(F)(F)O[C](F)F(3683)',
    ],
    reactants = [
        ('CF2O(49)', 'CHFCF2(55)'),
    ],
