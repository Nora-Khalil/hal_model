...
species(
    label = 'F[C]=CC(F)(F)O[C](F)F(10093)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C]=[C]C(F)(F)OC(F)F(10094)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][C]=C(F)OC(F)(F)F(10095)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'F[CH]C(F)=C(F)O[C](F)F(10096)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[CH]=[C]C(F)(F)OC(F)(F)F(10097)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[CH]=C(F)C(F)(F)O[C](F)F(10098)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FC=[C]C(F)(F)O[C](F)F(9759)'],
...
reaction(
    ...
    products = ['FC=[C]C(F)(F)O[C](F)F(9759)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)O[C](F)F(2625)', '[C]=CF-2(3543)'],
    products = ['FC=[C]C(F)(F)O[C](F)F(9759)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC=C=C(F)O[C](F)F(10090)'],
    products = ['FC=[C]C(F)(F)O[C](F)F(9759)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CC(F)(F)O[C](F)F(10091)'],
    products = ['FC=[C]C(F)(F)O[C](F)F(9759)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['FC=[C]C(F)(F)O[C](F)F(9759)'],
    products = ['F[C]=CC(F)(F)O[C](F)F(10093)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]=[C]C(F)(F)OC(F)F(10094)'],
    products = ['FC=[C]C(F)(F)O[C](F)F(9759)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FC=[C]C(F)(F)O[C](F)F(9759)'],
    products = ['F[CH][C]=C(F)OC(F)(F)F(10095)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FC=[C]C(F)(F)O[C](F)F(9759)'],
    products = ['F[CH]C(F)=C(F)O[C](F)F(10096)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FC=[C]C(F)(F)O[C](F)F(9759)'],
    products = ['[CH]=[C]C(F)(F)OC(F)(F)F(10097)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC=[C]C(F)(F)O[C](F)F(9759)'],
    products = ['[CH]=C(F)C(F)(F)O[C](F)F(10098)'],
