...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.35261,'amu*angstrom^2'), symmetry=1, barrier=(31.0991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34228,'amu*angstrom^2'), symmetry=1, barrier=(30.8616,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34571,'amu*angstrom^2'), symmetry=1, barrier=(30.9406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33845,'amu*angstrom^2'), symmetry=1, barrier=(30.7737,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0528652,0.0850052,-0.00011705,7.42797e-08,-1.79116e-11,-27842.4,23.4736], Tmin=(100,'K'), Tmax=(1030.55,'K')), NASAPolynomial(coeffs=[20.2027,0.00679442,-3.2105e-06,6.35288e-10,-4.61176e-14,-31995.4,-74.3436], Tmin=(1030.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-232.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + group(CJ2_singlet-FCs) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0687865,0.0844073,-0.00010242,5.89057e-08,-1.29733e-11,-71582.3,23.8264], Tmin=(100,'K'), Tmax=(1123.86,'K')), NASAPolynomial(coeffs=[20.5301,0.0110923,-4.5667e-06,8.59729e-10,-6.10222e-14,-76212.3,-77.9564], Tmin=(1123.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCFFO) + group(Ct-CtOs) + group(Ct-CtH)"""),
)

species(
    label = 'C#COC(F)(F)CO(12419)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {7,S}
4  O u0 p2 c0 {6,S} {11,S}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0687865,0.0844073,-0.00010242,5.89057e-08,-1.29733e-11,-71582.3,23.8264], Tmin=(100,'K'), Tmax=(1123.86,'K')), NASAPolynomial(coeffs=[20.5301,0.0110923,-4.5667e-06,8.59729e-10,-6.10222e-14,-76212.3,-77.9564], Tmin=(1123.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.21056,'amu*angstrom^2'), symmetry=1, barrier=(27.8333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21024,'amu*angstrom^2'), symmetry=1, barrier=(27.8259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21153,'amu*angstrom^2'), symmetry=1, barrier=(27.8555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21131,'amu*angstrom^2'), symmetry=1, barrier=(27.8503,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.104121,0.0889775,-0.000121886,7.89025e-08,-1.95108e-11,-29601.9,23.839], Tmin=(100,'K'), Tmax=(1003.8,'K')), NASAPolynomial(coeffs=[19.6499,0.01026,-4.25631e-06,7.78755e-10,-5.36673e-14,-33567.7,-71.5376], Tmin=(1003.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    E0 = (-407.876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,3010,987.5,1337.5,450,1655,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.945401,'amu*angstrom^2'), symmetry=1, barrier=(21.7366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.946222,'amu*angstrom^2'), symmetry=1, barrier=(21.7555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.944939,'amu*angstrom^2'), symmetry=1, barrier=(21.726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.946669,'amu*angstrom^2'), symmetry=1, barrier=(21.7658,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.100477,0.0953645,-0.000141951,1.04776e-07,-3.02234e-11,-48913.2,24.1854], Tmin=(100,'K'), Tmax=(853.915,'K')), NASAPolynomial(coeffs=[15.8919,0.0204505,-1.03545e-05,2.03475e-09,-1.43558e-13,-51644.3,-50.4426], Tmin=(853.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-407.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COC(O)(F)CF(4056)'],
    products = ['CH2CO(28)', 'O=C(F)CF(879)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(114.542,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction2',
    reactants = ['H2(8)', 'C#COC(O)(F)[C]F(12417)'],
    products = ['C#COC(O)(F)CF(4056)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C#COC(O)F(4186)'],
    products = ['C#COC(O)(F)CF(4056)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'C#COC(O)(F)F(4077)'],
    products = ['C#COC(O)(F)CF(4056)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'C#COC(F)=CF(12420)'],
    products = ['C#COC(O)(F)CF(4056)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(482)', 'C#COC(=C)F(8064)'],
    products = ['C#COC(O)(F)CF(4056)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CO[C](O)CF(12421)'],
    products = ['C#COC(O)(F)CF(4056)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C#COC([CH2])(O)F(12422)'],
    products = ['C#COC(O)(F)CF(4056)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HCCO(21)', 'O[C](F)CF(2940)'],
    products = ['C#COC(O)(F)CF(4056)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(2.31904,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['C2H(22)', '[O]C(O)(F)CF(3973)'],
    products = ['C#COC(O)(F)CF(4056)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'C#CO[C](F)CF(3147)'],
    products = ['C#COC(O)(F)CF(4056)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2F(46)', 'C#CO[C](O)F(8429)'],
    products = ['C#COC(O)(F)CF(4056)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C#COC(O)(F)[CH]F(4968)'],
    products = ['C#COC(O)(F)CF(4056)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[C]#COC(O)(F)CF(12423)'],
    products = ['C#COC(O)(F)CF(4056)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C#COC(=O)CF(12425)'],
    products = ['C#COC(O)(F)CF(4056)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(160.751,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C#COC(O)=CF(12426)'],
    products = ['C#COC(O)(F)CF(4056)'],
