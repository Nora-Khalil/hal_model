...
"""),
    E0 = (-997.999,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,326,540,652,719,1357,194,682,905,1196,1383,3221,180,180,722.532],'cm^-1')),
        HinderedRotor(inertia=(0.545684,'amu*angstrom^2'), symmetry=1, barrier=(12.5463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.85885,'amu*angstrom^2'), symmetry=1, barrier=(19.7467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.859323,'amu*angstrom^2'), symmetry=1, barrier=(19.7575,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.32677,0.0821776,-9.2229e-05,5.17636e-08,-1.15584e-11,-119900,24.4345], Tmin=(100,'K'), Tmax=(1084.26,'K')), NASAPolynomial(coeffs=[16.0646,0.0241185,-1.19085e-05,2.37805e-09,-1.71511e-13,-123313,-52.7648], Tmin=(1084.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-997.999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.572628,0.0823016,-0.000109611,8.11527e-08,-2.47572e-11,-131121,25.486], Tmin=(100,'K'), Tmax=(792.6,'K')), NASAPolynomial(coeffs=[10.2454,0.0334857,-1.72262e-05,3.44548e-09,-2.46719e-13,-132654,-18.9311], Tmin=(792.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1091.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(COCsFO)"""),
)

species(
    label = '[CH2]C(F)(F)OC(F)[CH]F(3050)',
...
"""),
    E0 = (-718.935,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,253,525,597,667,842,1178,1324,3000,3100,440,815,1455,1000,334,575,1197,1424,3202,268.742,268.742,268.742,268.744],'cm^-1')),
        HinderedRotor(inertia=(0.147988,'amu*angstrom^2'), symmetry=1, barrier=(7.58439,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.648125,'amu*angstrom^2'), symmetry=1, barrier=(33.2166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.648118,'amu*angstrom^2'), symmetry=1, barrier=(33.2166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147988,'amu*angstrom^2'), symmetry=1, barrier=(7.58439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0636134,0.0937796,-0.000131578,9.70691e-08,-2.88122e-11,-86332.6,28.7848], Tmin=(100,'K'), Tmax=(820.923,'K')), NASAPolynomial(coeffs=[13.0448,0.0305284,-1.60056e-05,3.21449e-09,-2.30375e-13,-88463.9,-31.2806], Tmin=(820.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-718.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2]C(F)(F)O[C](F)CF(3028)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-722.694,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,3000,3100,440,815,1455,1000,198.716,198.718,198.72,198.723],'cm^-1')),
        HinderedRotor(inertia=(0.605251,'amu*angstrom^2'), symmetry=1, barrier=(16.9611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.30343,'amu*angstrom^2'), symmetry=1, barrier=(8.50295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39537,'amu*angstrom^2'), symmetry=1, barrier=(39.1012,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303427,'amu*angstrom^2'), symmetry=1, barrier=(8.50295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
...
"""),
    E0 = (-568.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,326,540,652,719,1357,194,682,905,1196,1383,3221,257.678,257.707,257.74],'cm^-1')),
        HinderedRotor(inertia=(0.212979,'amu*angstrom^2'), symmetry=1, barrier=(10.033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212871,'amu*angstrom^2'), symmetry=1, barrier=(10.0339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.533764,'amu*angstrom^2'), symmetry=1, barrier=(25.1642,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.74433,0.0764224,-9.64555e-05,6.39477e-08,-1.7108e-11,-68290.3,23.5397], Tmin=(100,'K'), Tmax=(906.443,'K')), NASAPolynomial(coeffs=[12.1673,0.0260131,-1.30353e-05,2.59267e-09,-1.8569e-13,-70361.1,-30.4473], Tmin=(906.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-568.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'CC(F)(F)O[C]=CF(4590)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-563.778,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,615,860,1140,1343,3152,1685,370,232.346,232.346,232.346,232.346],'cm^-1')),
        HinderedRotor(inertia=(0.49842,'amu*angstrom^2'), symmetry=1, barrier=(19.0938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.49842,'amu*angstrom^2'), symmetry=1, barrier=(19.0938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.498422,'amu*angstrom^2'), symmetry=1, barrier=(19.0938,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481947,0.0752545,-8.40701e-05,4.60245e-08,-9.86525e-12,-67678.2,23.6868], Tmin=(100,'K'), Tmax=(1139.08,'K')), NASAPolynomial(coeffs=[16.898,0.0176079,-8.15812e-06,1.59573e-09,-1.14228e-13,-71418.1,-57.6487], Tmin=(1139.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-563.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-Cs))"""),
)

species(
    label = '[CH]=C(F)OC(C)(F)F(4591)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-568.677,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,293,496,537,1218,3120,650,792.5,1650,272.208,273.066,276.989],'cm^-1')),
        HinderedRotor(inertia=(0.36961,'amu*angstrom^2'), symmetry=1, barrier=(19.8655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376115,'amu*angstrom^2'), symmetry=1, barrier=(19.861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368794,'amu*angstrom^2'), symmetry=1, barrier=(19.8833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.445414,0.0761253,-8.46447e-05,4.59044e-08,-9.74954e-12,-68266.3,23.345], Tmin=(100,'K'), Tmax=(1148.45,'K')), NASAPolynomial(coeffs=[17.1973,0.0177796,-8.43937e-06,1.66806e-09,-1.2003e-13,-72114.1,-59.7919], Tmin=(1148.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-568.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (-781.914,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,326,540,652,719,1357,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,214.753,214.755,214.756],'cm^-1')),
        HinderedRotor(inertia=(0.114461,'amu*angstrom^2'), symmetry=1, barrier=(3.74601,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551563,'amu*angstrom^2'), symmetry=1, barrier=(18.0515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.898306,'amu*angstrom^2'), symmetry=1, barrier=(29.399,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.318196,0.0843756,-0.000105851,6.62063e-08,-1.63871e-11,-93912.7,25.9136], Tmin=(100,'K'), Tmax=(984.864,'K')), NASAPolynomial(coeffs=[15.5789,0.0223949,-1.14519e-05,2.30672e-09,-1.66776e-13,-96918.7,-47.4779], Tmin=(984.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-781.914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)

species(
    label = 'CC(F)(F)OC(F)=[C]F(4592)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-728.452,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,293,496,537,1218,167,640,1190,315.046,315.24,315.333,315.359],'cm^-1')),
        HinderedRotor(inertia=(0.375791,'amu*angstrom^2'), symmetry=1, barrier=(26.4999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0171683,'amu*angstrom^2'), symmetry=1, barrier=(6.73172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239524,'amu*angstrom^2'), symmetry=1, barrier=(16.8967,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441566,0.0829645,-0.000104133,6.6226e-08,-1.68282e-11,-87488.3,25.0684], Tmin=(100,'K'), Tmax=(955.629,'K')), NASAPolynomial(coeffs=[14.3181,0.0248819,-1.2965e-05,2.62616e-09,-1.90217e-13,-90140.5,-41.2482], Tmin=(955.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-728.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = 'CC(F)(F)[O+]=[C-]C(F)F(4593)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.69509,'amu*angstrom^2'), symmetry=1, barrier=(38.9735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71665,'amu*angstrom^2'), symmetry=1, barrier=(39.4691,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0870285,0.0963747,-0.000157657,1.44108e-07,-5.22344e-11,-82276,37.8433], Tmin=(100,'K'), Tmax=(799.235,'K')), NASAPolynomial(coeffs=[7.93398,0.0404038,-2.12709e-05,4.20312e-09,-2.95244e-13,-82997,5.08131], Tmin=(799.235,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-685.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-CsHHH) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OC(C)(F)F(4594)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0371699,0.0953655,-0.000144352,1.18292e-07,-3.92931e-11,-89239.8,26.1161], Tmin=(100,'K'), Tmax=(734.377,'K')), NASAPolynomial(coeffs=[11.3849,0.0335501,-1.8077e-05,3.64766e-09,-2.6104e-13,-90906.4,-25.1255], Tmin=(734.377,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-743.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-CsHHH) + group(CsCFFO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'CC(F)(F)OC(F)[C]F(4595)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.829554,'amu*angstrom^2'), symmetry=1, barrier=(19.0731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.829585,'amu*angstrom^2'), symmetry=1, barrier=(19.0738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.830087,'amu*angstrom^2'), symmetry=1, barrier=(19.0853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50927,'amu*angstrom^2'), symmetry=1, barrier=(34.701,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.572579,0.0818396,-9.97605e-05,6.47644e-08,-1.72329e-11,-93916.3,26.1068], Tmin=(100,'K'), Tmax=(903.873,'K')), NASAPolynomial(coeffs=[11.9142,0.0316483,-1.64665e-05,3.32946e-09,-2.40705e-13,-95966.6,-27.4638], Tmin=(903.873,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-781.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-CsHHH) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-567.468,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([262,390,483,597,572,732,631,807,1275,1439,2950,3100,1380,975,1025,1650,194,682,905,1196,1383,3221,180,180,1402.46],'cm^-1')),
        HinderedRotor(inertia=(0.19588,'amu*angstrom^2'), symmetry=1, barrier=(4.50366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196535,'amu*angstrom^2'), symmetry=1, barrier=(4.51873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.23619,'amu*angstrom^2'), symmetry=1, barrier=(28.4225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23271,'amu*angstrom^2'), symmetry=1, barrier=(28.3424,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23154,'amu*angstrom^2'), symmetry=1, barrier=(28.3155,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.590375,0.0654585,-5.989e-05,1.93483e-08,7.90042e-14,-52379.2,18.7562], Tmin=(100,'K'), Tmax=(995.935,'K')), NASAPolynomial(coeffs=[19.4675,0.00872019,-3.16952e-06,6.14696e-10,-4.67008e-14,-57085.4,-76.9883], Tmin=(995.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-436.596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)

species(
    label = 'CC(F)(F)OC#CF(4597)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
4  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-536.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,239,401,1367,228.224,229.563,230.01],'cm^-1')),
        HinderedRotor(inertia=(0.584472,'amu*angstrom^2'), symmetry=1, barrier=(21.7134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.584685,'amu*angstrom^2'), symmetry=1, barrier=(21.6968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.579346,'amu*angstrom^2'), symmetry=1, barrier=(21.7183,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.559599,0.0721478,-8.08254e-05,4.30499e-08,-8.89185e-12,-64382.5,21.1919], Tmin=(100,'K'), Tmax=(1185.73,'K')), NASAPolynomial(coeffs=[17.9425,0.0135071,-6.64176e-06,1.3405e-09,-9.77506e-14,-68504.8,-65.6317], Tmin=(1185.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-536.362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(CtCF)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.68568,'amu*angstrom^2'), symmetry=1, barrier=(38.7571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68646,'amu*angstrom^2'), symmetry=1, barrier=(38.7749,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78403,0.051066,-4.82077e-05,2.32535e-08,-4.62308e-12,-83973.3,17.5857], Tmin=(100,'K'), Tmax=(1178.95,'K')), NASAPolynomial(coeffs=[10.4093,0.0218015,-1.09738e-05,2.19857e-09,-1.58299e-13,-86007,-25.4464], Tmin=(1178.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-698.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-CsHHH) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)OC(F)=CF(3034)'],
    products = ['CH2CF2(57)', 'O=C(F)CF(879)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'COC(F)=CF(2597)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FC=C(F)OF(1049)', 'C[C]F(702)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'FC=C(F)OC(F)F(2578)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2CF2(57)', 'OC(F)=CF(878)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CC(F)(F)OC(F)=CF(3034)'],
    products = ['CC(F)(F)C(F)C(=O)F(4588)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)OC(F)[CH]F(3050)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)(F)O[C](F)CF(3028)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C[C](F)OC(F)=CF(4589)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)O[C]=CF(4590)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(F)OC(C)(F)F(4591)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(F)[CH]F(215)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHFCF[Z](72)', 'CC([O])(F)F(2901)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'FC=C(F)O[C](F)F(2581)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)OC(F)=CF(3096)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC(F)(F)OC(F)=[C]F(4592)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC(F)(F)[O+]=[C-]C(F)F(4593)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C(F)(F)OC(C)(F)F(4594)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC(F)(F)OC(F)[C]F(4595)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C=C(F)OC(F)=CF(3040)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'C#COC(C)(F)F(4596)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'CC(F)(F)OC#CF(4597)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', 'CC(F)(F)[O+]=[C-]F(4598)'],
    products = ['CC(F)(F)OC(F)=CF(3034)'],
