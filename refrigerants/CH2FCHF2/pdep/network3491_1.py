...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]=C[O](3464)'],
    products = ['[CH]=CO[CH2](13202)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](2653)', '[CH]=[CH](4466)'],
    products = ['[CH]=CO[CH2](13202)'],
    transitionState = 'TS7',
...
network(
    label = 'PDepNetwork #3491',
    isomers = [
        '[CH]=CO[CH2](13202)',
    ],
    reactants = [
        ('CH2O(20)', 'C2H2(23)'),
        ('CH2(T)(18)', '[CH]=C[O](3464)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
