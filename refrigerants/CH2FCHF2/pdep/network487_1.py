...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=CO[C](F)F(2833)'],
    products = ['[O]C(F)O[C](F)F(2813)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(2694)', 'CHFO(47)'],
    products = ['[O]C(F)O[C](F)F(2813)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)O[C](F)F(2834)'],
    products = ['[O]C(F)O[C](F)F(2813)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C](F)F(2694)', '[O][CH]F(388)'],
    products = ['[O]C(F)O[C](F)F(2813)'],
