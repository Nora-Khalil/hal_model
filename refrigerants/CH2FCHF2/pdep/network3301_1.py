species(
    label = 'F[CH]C(F)OOOC(F)(F)C(F)F(10955)',
...
species(
    label = 'F[CH]C(F)OOOC(F)C(F)(F)F(10950)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
species(
    label = '[CH]C(F)OOOC(F)(F)C(F)F(14438)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.995225,0.114268,-0.000140098,8.44041e-08,-2.01185e-11,-96413.4,38.869], Tmin=(100,'K'), Tmax=(1020.41,'K')), NASAPolynomial(coeffs=[20.5611,0.0297697,-1.58881e-05,3.25538e-09,-2.37602e-13,-100813,-65.5638], Tmin=(1020.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-803.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'F[CH]OOOC(F)(F)C(F)F(12634)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (181.038,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.302533,0.101372,-0.000137042,9.32392e-08,-2.52343e-11,-120523,35.2253], Tmin=(100,'K'), Tmax=(900.977,'K')), NASAPolynomial(coeffs=[16.1785,0.028204,-1.5229e-05,3.10719e-09,-2.25288e-13,-123493,-42.5679], Tmin=(900.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1003.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsFHHO) + radical(CsF1sHO2s)"""),
)
...
species(
    label = 'F[C]C(F)OOOC(F)(F)C(F)F(14439)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.22427,0.122098,-0.000158308,1.01169e-07,-2.56345e-11,-126693,39.6198], Tmin=(100,'K'), Tmax=(960.772,'K')), NASAPolynomial(coeffs=[20.3887,0.0321171,-1.78265e-05,3.69146e-09,-2.70373e-13,-130846,-63.7856], Tmin=(960.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1054.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCCl_triplet)"""),
)

species(
    label = '[O]C(F)(F)C(F)F(4812)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {7,S}
...
species(
    label = 'FC=COOOC(F)(F)C(F)F(14440)',
...
"""),
    E0 = (-835.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,235,523,627,1123,1142,1372,1406,3097,180,180,180,833.959,837.103,3188.51],'cm^-1')),
        HinderedRotor(inertia=(0.153821,'amu*angstrom^2'), symmetry=1, barrier=(14.9663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.650706,'amu*angstrom^2'), symmetry=1, barrier=(14.961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100082,'amu*angstrom^2'), symmetry=1, barrier=(49.5468,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.021,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.764261,0.0733724,-9.73028e-05,6.33743e-08,-1.61365e-11,-100429,28.0438], Tmin=(100,'K'), Tmax=(964.272,'K')), NASAPolynomial(coeffs=[14.6188,0.0159011,-7.9026e-06,1.56634e-09,-1.12143e-13,-103101,-38.2926], Tmin=(964.272,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-835.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(ROOJ)"""),
)
...
species(
    label = 'FC=C(F)OOOC(F)(F)C(F)F(14442)',
...
"""),
    ...
    molecularWeight = (194.057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36776,0.127648,-0.000192374,1.48566e-07,-4.55935e-11,-100013,41.1634], Tmin=(100,'K'), Tmax=(798.442,'K')), NASAPolynomial(coeffs=[17.0508,0.0353746,-1.90237e-05,3.82481e-09,-2.73117e-13,-102954,-43.5494], Tmin=(798.442,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-833.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFHH) + radical(CCsJOO) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
species(
    label = 'F[CH][C](F)OOOC(F)(F)C(F)F(14444)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
...
species(
    label = 'F[C]C(F)OOOC(F)(F)C(F)F-2(14445)',
    structure = adjacencyList("""1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
4  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (213.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.45181,0.129205,-0.000178117,1.24767e-07,-3.48603e-11,-147857,41.6265], Tmin=(100,'K'), Tmax=(872.763,'K')), NASAPolynomial(coeffs=[18.6018,0.0372962,-2.01538e-05,4.10475e-09,-2.96971e-13,-151357,-52.3916], Tmin=(872.763,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1230.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'FCC(F)OOOC(F)(F)[C](F)F(14446)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (213.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.5292,0.130011,-0.00017391,1.16268e-07,-3.08793e-11,-146455,40.7699], Tmin=(100,'K'), Tmax=(917.879,'K')), NASAPolynomial(coeffs=[20.1829,0.03539,-1.92762e-05,3.95209e-09,-2.87507e-13,-150441,-62.1174], Tmin=(917.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1219.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)

species(
    label = 'F[C](OOOC(F)C(F)F)C(F)F(14447)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {11,S}
3  F u0 p3 c0 {11,S}
...
species(
    label = 'FC(F)[CH]OOOC(F)(F)C(F)F(14449)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {10,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (213.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.4932,0.130328,-0.000182597,1.30746e-07,-3.73586e-11,-149969,41.4411], Tmin=(100,'K'), Tmax=(854.097,'K')), NASAPolynomial(coeffs=[18.2285,0.0379657,-2.03857e-05,4.13259e-09,-2.97897e-13,-153338,-50.5943], Tmin=(854.097,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1248.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + radical(CCsJOO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    products = ['[O]OC(F)(F)C(F)F(8445)', 'FC1OC1F(211)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'F[CH]C(F)OOOC(F)F(4523)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]C(F)F(125)', 'F[CH]C(F)OOOF(4524)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'F[CH]C(F)OOOC(F)(F)F(5112)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    products = ['F[CH]C(F)OOOC(F)C(F)(F)F(10950)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]C(F)OOOC(F)(F)C(F)F(14438)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]F(137)', 'F[CH]OOOC(F)(F)C(F)F(12634)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C]C(F)OOOC(F)(F)C(F)F(14439)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    products = ['[O]C(F)(F)C(F)F(4812)', 'FC1OOC1F(210)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=COOOC(F)(F)C(F)F(14440)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]OOC(F)(F)C(F)F(14441)', 'CHFCHF[Z](59)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC=C(F)OOOC(F)(F)C(F)F(14442)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[CH]C(F)OOO[C](F)C(F)F(6747)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'F[CH]C(F)OOOC(F)(F)[CH]F(5270)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'F[CH][CH]OOOC(F)(F)C(F)F(14443)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)(F)C(F)F(4812)', '[O]OC(F)[CH]F(131)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]OC(F)(F)C(F)F(8445)', '[O]C(F)[CH]F(208)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]OOC(F)(F)C(F)F(14441)', 'F[CH][CH]F(141)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHF2(82)', 'F[CH]C(F)OOO[C](F)F(4537)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'F[CH]C(F)OOOC(F)(F)[C](F)F(14156)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'F[CH][C](F)OOOC(F)(F)C(F)F(14444)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'F[CH]C(F)OOOC(F)=CF(5273)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'F[CH]C(F)OOOC(F)=C(F)F(10965)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CHF(40)', 'F[CH]OOOC(F)(F)C(F)F(12634)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(5)', 'F[C]C(F)OOOC(F)(F)C(F)F-2(14445)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    products = ['FC[C](F)OOOC(F)(F)C(F)F(12637)'],
...
reaction(
    label = 'reaction28',
    reactants = ['FCC(F)OOOC(F)(F)[C](F)F(14446)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction29',
    reactants = ['F[C](OOOC(F)C(F)F)C(F)F(14447)'],
    products = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
...
reaction(
    label = 'reaction30',
    reactants = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    products = ['F[CH]C(F)(F)OOOC(F)C(F)F(14448)'],
...
reaction(
    label = 'reaction31',
    reactants = ['F[CH]C(F)OOOC(F)(F)C(F)F(10955)'],
    products = ['FC(F)[CH]OOOC(F)(F)C(F)F(14449)'],
...
network(
    ...
    isomers = [
        'F[CH]C(F)OOOC(F)(F)C(F)F(10955)',
    ],
    reactants = [
        ('[O]OC(F)(F)C(F)F(8445)', 'FC1OC1F(211)'),
        ('[O]OC(F)(F)C(F)F(8445)', '[O]C(F)[CH]F(208)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
