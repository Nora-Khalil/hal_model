...
reaction(
    label = 'reaction6',
    reactants = ['FOF(488)', 'C=C(O)F(3010)'],
    products = ['OC(F)(F)COF(5396)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'FOC=C(F)F(3557)'],
    products = ['OC(F)(F)COF(5396)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]CC(O)(F)F(5730)'],
    products = ['OC(F)(F)COF(5396)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(128)', '[CH2]C(O)(F)F(2782)'],
    products = ['OC(F)(F)COF(5396)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)COF(5731)'],
    products = ['OC(F)(F)COF(5396)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(2562)', '[CH2]OF(2545)'],
    products = ['OC(F)(F)COF(5396)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]OF(5550)'],
    products = ['OC(F)(F)COF(5396)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)COF(1558)'],
    products = ['OC(F)(F)COF(5396)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CC(O)(F)F(1559)'],
    products = ['OC(F)(F)COF(5396)'],
