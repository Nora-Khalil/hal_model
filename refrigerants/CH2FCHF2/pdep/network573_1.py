...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.388234,0.0886328,-0.000151498,1.36916e-07,-4.84778e-11,-48728.7,28.0335], Tmin=(100,'K'), Tmax=(806.787,'K')), NASAPolynomial(coeffs=[9.24741,0.0303531,-1.6451e-05,3.26737e-09,-2.2941e-13,-49690.9,-9.90919], Tmin=(806.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-406.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHHO) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2]C(F)(F)OO[CH]F(3248)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.553735,0.0827963,-0.000126205,1.02428e-07,-3.35086e-11,-53629,27.4299], Tmin=(100,'K'), Tmax=(746.593,'K')), NASAPolynomial(coeffs=[10.8979,0.0273753,-1.48568e-05,3.00012e-09,-2.14666e-13,-55173.5,-19.4519], Tmin=(746.593,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFFO) + group(Cs-CsHHH) + group(CsFHHO) + radical(CJCOOH) + radical(CsF1sHO2s)"""),
)

species(
    label = '[CH2][C](F)OOC(F)F(3249)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.503928,0.0852457,-0.000142544,1.27344e-07,-4.48947e-11,-53898.1,28.9074], Tmin=(100,'K'), Tmax=(797.324,'K')), NASAPolynomial(coeffs=[9.28914,0.0295469,-1.58882e-05,3.15607e-09,-2.22009e-13,-54929.5,-9.16914], Tmin=(797.324,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-449.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFFHO) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[CH]F(209)', 'F[C]CF-2(3008)'],
    products = ['F[CH]OO[C](F)CF(3234)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)OO[CH]F(3244)'],
    products = ['F[CH]OO[C](F)CF(3234)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]OO[C](F)CF(3234)'],
    products = ['[CH2]C(F)(F)OO[CH]F(3248)'],
