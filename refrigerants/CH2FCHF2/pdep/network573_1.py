...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.717742,0.0781556,-0.000109599,7.99288e-08,-2.33825e-11,-149433,26.144], Tmin=(100,'K'), Tmax=(833.357,'K')), NASAPolynomial(coeffs=[11.9022,0.0244689,-1.29605e-05,2.61596e-09,-1.88079e-13,-151297,-25.775], Tmin=(833.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1243.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(COCsFO)"""),
)

species(
    label = '[O]C(F)(F)OC(F)[CH]F(3218)',
...
"""),
    E0 = (-830.459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,375,486,586,623,710,938,1161,1294,334,575,1197,1424,3202,259.546,259.577,262.061,262.703],'cm^-1')),
        HinderedRotor(inertia=(0.443607,'amu*angstrom^2'), symmetry=1, barrier=(21.1627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127795,'amu*angstrom^2'), symmetry=1, barrier=(6.15854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.810562,'amu*angstrom^2'), symmetry=1, barrier=(38.9664,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.572284,0.0800059,-0.000104125,6.79e-08,-1.75929e-11,-99761.5,27.2906], Tmin=(100,'K'), Tmax=(940.183,'K')), NASAPolynomial(coeffs=[14.1831,0.0220987,-1.17381e-05,2.39007e-09,-1.73446e-13,-102321,-37.5344], Tmin=(940.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-830.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[O]C(F)(F)O[C](F)CF(3082)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.853735,'amu*angstrom^2'), symmetry=1, barrier=(19.629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.852774,'amu*angstrom^2'), symmetry=1, barrier=(19.6069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.853267,'amu*angstrom^2'), symmetry=1, barrier=(19.6183,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.598014,0.0739692,-9.51704e-05,5.81793e-08,-1.37008e-11,-87161.6,24.15], Tmin=(100,'K'), Tmax=(1048.03,'K')), NASAPolynomial(coeffs=[17.032,0.0112443,-5.39256e-06,1.06888e-09,-7.71553e-14,-90606.2,-55.9049], Tmin=(1048.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-725.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-Cs))"""),
)

species(
    label = '[CH]=C(F)OC(O)(F)F(4302)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-890.403,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,293,496,537,1218,167,640,1190,317.982,317.985,317.999,318.007],'cm^-1')),
        HinderedRotor(inertia=(0.0872657,'amu*angstrom^2'), symmetry=1, barrier=(6.26189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202101,'amu*angstrom^2'), symmetry=1, barrier=(14.5019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.492522,'amu*angstrom^2'), symmetry=1, barrier=(35.3422,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.446696,0.0830247,-0.000120076,8.48023e-08,-2.34473e-11,-106967,25.9266], Tmin=(100,'K'), Tmax=(888.491,'K')), NASAPolynomial(coeffs=[14.9691,0.0176444,-9.69769e-06,1.9812e-09,-1.43375e-13,-109548,-42.4188], Tmin=(888.491,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-890.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = 'OC(F)(F)[O+]=[C-]C(F)F(4304)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0145553,0.0958975,-0.000162648,1.40935e-07,-4.81e-11,-108717,27.0646], Tmin=(100,'K'), Tmax=(777.819,'K')), NASAPolynomial(coeffs=[12.3765,0.0256804,-1.44218e-05,2.90684e-09,-2.05975e-13,-110440,-28.1761], Tmin=(777.819,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-905.056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFFOO) + group(CsCFFO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'OC(F)(F)OC(F)[C]F(4306)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)OC(F)=CF(3087)'],
    products = ['CF2O(49)', 'O=C(F)CF(879)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(121.912,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction2',
    reactants = ['OC(F)(F)OC(F)=CF(3087)'],
    products = ['O=C(F)C(F)C(O)(F)F(4300)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(122.063,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)(F)OC(F)[CH]F(3218)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(F)O[C](F)CF(3082)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O[C](F)OC(F)=CF(4262)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'OC(F)(F)O[C]=CF(4301)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(F)OC(O)(F)F(4302)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O[C](F)F(2676)', 'O=C(F)[CH]F(215)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(4.7437,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['[O]C(O)(F)F(3033)', 'CHFCF[Z](72)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'FC=C(F)O[C](F)F(2695)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)=CF(3216)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'OC(F)(F)OC(F)=[C]F(4303)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OC(F)(F)[O+]=[C-]C(F)F(4304)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C(F)(F)OC(O)(F)F(4305)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OC(F)(F)OC(F)[C]F(4306)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=C(F)OC(F)=CF(4307)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'C#COC(O)(F)F(4308)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'OC(F)(F)OC#CF(4309)'],
    products = ['OC(F)(F)OC(F)=CF(3087)'],
