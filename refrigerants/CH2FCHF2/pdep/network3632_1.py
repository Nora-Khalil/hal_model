...
"""),
    E0 = (-324.929,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,493,600,700,1144,1293,224.174,224.174,224.174,1814.21],'cm^-1')),
        HinderedRotor(inertia=(0.216437,'amu*angstrom^2'), symmetry=1, barrier=(7.71844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00335451,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216437,'amu*angstrom^2'), symmetry=1, barrier=(7.71844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784004,'amu*angstrom^2'), symmetry=1, barrier=(27.9585,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.497693,0.0850196,-0.000143161,1.26303e-07,-4.37195e-11,-38961.5,29.4064], Tmin=(100,'K'), Tmax=(806.858,'K')), NASAPolynomial(coeffs=[10.0254,0.0267332,-1.42543e-05,2.81618e-09,-1.97198e-13,-40139.2,-12.2848], Tmin=(806.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-324.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFFHO) + radical(CJCO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'C[C](OF)O[C](F)F(13756)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.538141,0.0850077,-0.000145782,1.32017e-07,-4.68233e-11,-35632.2,27.6076], Tmin=(100,'K'), Tmax=(805.228,'K')), NASAPolynomial(coeffs=[9.05106,0.02896,-1.5743e-05,3.13407e-09,-2.20374e-13,-36557.1,-8.84829], Tmin=(805.228,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsFFHO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C=C(O)OF(13753)'],
    products = ['C=C(OF)OC(F)F(2406)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C=C(OF)OF(13754)'],
    products = ['C=C(OF)OC(F)F(2406)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(OF)O[C](F)F(13755)'],
    products = ['C=C(OF)OC(F)F(2406)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[C](OF)O[C](F)F(13756)'],
    products = ['C=C(OF)OC(F)F(2406)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(OF)O[CH]F(13757)'],
    products = ['C=C(OF)OC(F)F(2406)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(=O)OC(F)F(13758)'],
    products = ['C=C(OF)OC(F)F(2406)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(128)', 'C=[C]OC(F)F(9167)'],
    products = ['C=C(OF)OC(F)F(2406)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(OF)O[C](F)F(13759)'],
    products = ['C=C(OF)OC(F)F(2406)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(OF)OC(F)F(13760)'],
    products = ['C=C(OF)OC(F)F(2406)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]C(OF)OC(F)F(13761)'],
    products = ['C=C(OF)OC(F)F(2406)'],
