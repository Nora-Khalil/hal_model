...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C1(F)[CH]O1(7529)'],
    products = ['[O]OC1(F)[CH]O1(7373)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', 'F[C]1[CH]O1(7422)'],
    products = ['[O]OC1(F)[CH]O1(7373)'],
    transitionState = 'TS8',
