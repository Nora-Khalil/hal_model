...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC=C(F)F(233)'],
    products = ['FC1(F)[CH]OO1(2514)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[O]O[C]=C(F)F(3541)'],
    products = ['[O]OC=C(F)F(233)'],
    transitionState = 'TS6',
