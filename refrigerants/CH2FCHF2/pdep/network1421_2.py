...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C]=[C]C(F)F(4858)'],
    products = ['F[C]=CC(F)F(4842)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH]C=C(F)F(14709)'],
    products = ['F[CH]C=C(F)F(4846)'],
