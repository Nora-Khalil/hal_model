...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', '[O]C[C]=O(4676)'],
    products = ['O=[C]CO[C](F)F(6193)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', '[CH2]O[C](F)F(2615)'],
    products = ['O=[C]CO[C](F)F(6193)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[C](F)F(2615)'],
    products = ['O=[C]CO[C](F)F(6193)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[C](F)F(6624)'],
    products = ['O=[C]CO[C](F)F(6193)'],
    transitionState = 'TS9',
