...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COC(F)F(8488)'],
    products = ['C#COCC(F)F(4329)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'C#COC[C]F(9275)'],
    products = ['C#COCC(F)F(4329)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#COC[CH]F(9276)'],
    products = ['C#COCC(F)F(4329)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H(22)', '[O]CC(F)F(3003)'],
    products = ['C#COCC(F)F(4329)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CHF2(82)', 'C#CO[CH2](2782)'],
    products = ['C#COCC(F)F(4329)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C#CO[CH]C(F)F(9277)'],
    products = ['C#COCC(F)F(4329)'],
