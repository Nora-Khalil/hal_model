...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00488961,'amu*angstrom^2'), symmetry=1, barrier=(35.2401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0248226,'amu*angstrom^2'), symmetry=1, barrier=(35.2505,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01439,0.0481021,-6.14308e-05,4.53234e-08,-1.40089e-11,-37300.3,18.0904], Tmin=(100,'K'), Tmax=(777.638,'K')), NASAPolynomial(coeffs=[7.07819,0.0220554,-1.11895e-05,2.25228e-09,-1.62303e-13,-38087.8,-5.06609], Tmin=(777.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.101973,'amu*angstrom^2'), symmetry=1, barrier=(2.34457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.455518,'amu*angstrom^2'), symmetry=1, barrier=(10.4733,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65307,0.0602678,-0.000108446,1.04623e-07,-3.84676e-11,-35829.5,22.2914], Tmin=(100,'K'), Tmax=(837.509,'K')), NASAPolynomial(coeffs=[5.08191,0.0254933,-1.32131e-05,2.58614e-09,-1.79611e-13,-35758.6,10.2094], Tmin=(837.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-298.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(137)', 'CH2F-CHF(66)'],
    products = ['F[CH]C(F)CF(493)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'F[C]C(F)CF-2(3993)'],
    products = ['F[CH]C(F)CF(493)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH][CH]CF(3994)'],
    products = ['F[CH]C(F)CF(493)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)[CH]F(155)'],
    products = ['F[CH]C(F)CF(493)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', 'F[CH][CH]F(141)'],
    products = ['F[CH]C(F)CF(493)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH][C](F)CF(3995)'],
    products = ['F[CH]C(F)CF(493)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[CH]C(F)[CH]F(136)'],
    products = ['F[CH]C(F)CF(493)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C=C(F)[CH]F(3997)'],
    products = ['F[CH]C(F)CF(493)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'F[CH]C=CF(3998)'],
    products = ['F[CH]C(F)CF(493)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)CF(493)'],
    products = ['FC[C](F)CF(3999)'],
