...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(4368)', '[CH2]C([O])=O(540)'],
    products = ['[CH2]C(=O)O[C]=C(8177)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C]=O(8305)'],
    products = ['[CH2]C(=O)O[C]=C(8177)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CO(28)', '[CH2][C]=O(4373)'],
    products = ['[CH2]C(=O)O[C]=C(8177)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#COC([CH2])=O(13814)'],
    products = ['[CH2]C(=O)O[C]=C(8177)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]=O(4373)', '[CH2][C]=O(4373)'],
    products = ['[CH2]C(=O)O[C]=C(8177)'],
