...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.926841,0.0767952,-0.000133001,1.23288e-07,-4.42697e-11,-47640.8,25.6942], Tmin=(100,'K'), Tmax=(828.88,'K')), NASAPolynomial(coeffs=[7.00329,0.0297132,-1.5661e-05,3.06415e-09,-2.12869e-13,-48038.1,1.1992], Tmin=(828.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-396.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFHHO) + group(Cds-OdCsH) + radical(CsCOF1sO2s) + radical(COj(Cs-F1sO2sH)(O2d))"""),
)

species(
    label = '[O]C(O[CH]F)C(=O)F(1897)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13037,0.0713777,-0.000122989,1.13556e-07,-4.07793e-11,-65209.6,29.0878], Tmin=(100,'K'), Tmax=(820.545,'K')), NASAPolynomial(coeffs=[7.11436,0.0270794,-1.43554e-05,2.82668e-09,-1.9735e-13,-65682.4,4.50531], Tmin=(820.545,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsFHHO) + group(COCsFO) + radical(C=OCOJ) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.467078,'amu*angstrom^2'), symmetry=1, barrier=(10.739,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175548,'amu*angstrom^2'), symmetry=1, barrier=(4.0362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.20187,'amu*angstrom^2'), symmetry=1, barrier=(50.6253,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21505,0.0703213,-0.000126801,1.20147e-07,-4.38804e-11,2465.93,24.8733], Tmin=(100,'K'), Tmax=(820.562,'K')), NASAPolynomial(coeffs=[6.57816,0.026583,-1.46831e-05,2.92513e-09,-2.05161e-13,2178.13,3.66942], Tmin=(820.562,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.7422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFHHO) + group(CdCFO) + group(Cds-CdsHH) + radical(CsF1sHO2s) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.36172,'amu*angstrom^2'), symmetry=1, barrier=(31.3086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.843848,'amu*angstrom^2'), symmetry=1, barrier=(19.4017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84502,'amu*angstrom^2'), symmetry=1, barrier=(19.4287,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03851,0.0656192,-7.8327e-05,4.61033e-08,-1.0663e-11,-37970.6,29.1085], Tmin=(100,'K'), Tmax=(1055.92,'K')), NASAPolynomial(coeffs=[14.158,0.015921,-7.72822e-06,1.53037e-09,-1.09957e-13,-40741.2,-34.8992], Tmin=(1055.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.59,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', '[O]O[C](F)C=O(1934)'],
    products = ['O=C[C](F)OO[CH]F(1900)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['O=C[C](F)OO[CH]F(1900)'],
    products = ['F[CH]OOC1(F)[CH]O1(1935)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]O[CH]F(209)', 'O=C[C]F-2(1596)'],
    products = ['O=C[C](F)OO[CH]F(1900)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[O]O[C](F)C=O(1934)'],
    products = ['O=C[C](F)OO[CH]F(1900)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C[C](F)OO[CH]F(1900)'],
    products = ['[O]C(O[CH]F)C(=O)F(1897)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(6)', '[CH]=C(F)OO[CH]F(1941)'],
    products = ['O=C[C](F)OO[CH]F(1900)'],
