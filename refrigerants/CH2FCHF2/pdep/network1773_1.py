...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C=C(F)C[O](6723)'],
    products = ['[O]CC([O])(F)C=O(6169)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[CH2]C([O])(F)C=O(1710)'],
    products = ['[O]CC([O])(F)C=O(6169)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(=O)C=O(6727)'],
    products = ['[O]CC([O])(F)C=O(6169)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(15)', '[O]CC(=O)F(1554)'],
    products = ['[O]CC([O])(F)C=O(6169)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(F)(C=O)C=O(2195)'],
    products = ['[O]CC([O])(F)C=O(6169)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[O]C=C([O])C=O(2197)'],
    products = ['[O]CC([O])(F)C=O(6169)'],
