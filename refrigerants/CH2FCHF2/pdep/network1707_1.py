...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction3',
    reactants = ['FCOF(367)', 'F[C]C(F)F(125)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(482)', 'F[C]C(F)C(F)F(793)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'F[C]C(F)C(F)OF(483)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(482)', 'FC=C(F)C(F)F(796)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(488)', 'FC=CC(F)F(721)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FOC(F)[CH]C(F)F(727)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FO[CH]C(F)C(F)F(5430)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[CH]C(F)C(F)OF(497)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)C(F)C(F)F(801)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(128)', 'F[CH]C(F)C(F)F(800)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]OF(363)', 'CHF2-CHF(67)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(82)', 'F[CH]C(F)OF(494)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FOC(F)[C](F)C(F)F(5431)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FO[C](F)C(F)C(F)F(4514)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'FOC(F)C(F)[C](F)F(5432)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'O=CC(F)C(F)F(326)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(78)', 'FOC=CC(F)F(731)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'FOC=C(F)C(F)F(5433)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'FC=CC(F)OF(504)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'O=C(F)C(F)C(F)F(3775)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'FOC(F)=CC(F)F(2841)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'FOC(F)C=C(F)F(5434)'],
    products = ['FOC(F)C(F)C(F)F(4562)'],
...
network(
    label = 'PDepNetwork #1707',
    isomers = [
        'FOC(F)C(F)C(F)F(4562)',
    ],
    reactants = [
