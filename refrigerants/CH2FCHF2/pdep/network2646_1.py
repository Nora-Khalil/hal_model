...
species(
    label = '[CH]=C(F)C([CH]F)=C(F)F(7311)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-0.651196,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([323,467,575,827,1418,194,682,905,1196,1383,3221,439.435,439.564,439.597],'cm^-1')),
        HinderedRotor(inertia=(0.377592,'amu*angstrom^2'), symmetry=1, barrier=(51.7341,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59677,0.0297955,-1.83591e-05,5.50976e-09,-6.73981e-13,-27.3053,15.0855], Tmin=(100,'K'), Tmax=(1812.93,'K')), NASAPolynomial(coeffs=[9.00424,0.0156583,-6.66213e-06,1.20844e-09,-8.08368e-14,-2350.57,-19.6389], Tmin=(1812.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.651196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.929481,0.0716366,-9.09159e-05,6.04604e-08,-1.61629e-11,-60842.9,24.4641], Tmin=(100,'K'), Tmax=(908.969,'K')), NASAPolynomial(coeffs=[11.8506,0.0235761,-1.16034e-05,2.2887e-09,-1.63142e-13,-62828.2,-27.1814], Tmin=(908.969,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-506.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)-Cds(F)) + group(CdCddCF) + longDistanceInteraction_noncyclic(Cds(F)-Cds(F)) + group(Cds-CdsHH) + group(CdCddFF) + group(Cdd-CdsCds)"""),
)
...
species(
    label = '[CH]=C(F)C(F)=C=C(F)F(10132)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,250,446,589,854,899,94,120,354,641,825,1294,540,610,2055,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(1.34062,'amu*angstrom^2'), symmetry=1, barrier=(30.8235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (137.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.64676,0.0787972,-0.000119913,9.32179e-08,-2.85786e-11,-29185.3,25.7751], Tmin=(100,'K'), Tmax=(801.96,'K')), NASAPolynomial(coeffs=[12.4127,0.0201146,-1.01581e-05,1.98341e-09,-1.38977e-13,-31072.6,-28.3926], Tmin=(801.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)-Cds(F)) + group(CdCddCF) + longDistanceInteraction_noncyclic(Cds(F)-Cds(F)) + group(Cds-CdsHH) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Cdj(Cd-CdF1s)(H))"""),
)

species(
    label = 'C#CC(F)[C]=C(F)F(10133)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (12.4852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,246,474,533,1155,2175,525,3120,650,792.5,1650,239,401,1367,180,373.906],'cm^-1')),
        HinderedRotor(inertia=(0.575023,'amu*angstrom^2'), symmetry=1, barrier=(13.2209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.42991,'amu*angstrom^2'), symmetry=1, barrier=(55.8684,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.986648,0.0739589,-0.000124462,1.10801e-07,-3.81826e-11,1602.75,23.6321], Tmin=(100,'K'), Tmax=(846.499,'K')), NASAPolynomial(coeffs=[8.16671,0.0254528,-1.26767e-05,2.41986e-09,-1.65534e-13,909.46,-6.72602], Tmin=(846.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.4852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-CdsHH) + group(Ct-CtCs) + group(CtCF) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,562,600,623,1070,1265,1685,370,540,610,2055,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.79993,'amu*angstrom^2'), symmetry=1, barrier=(41.384,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (118.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.819487,0.0761345,-0.000128372,1.07302e-07,-3.39397e-11,1519.13,23.3206], Tmin=(100,'K'), Tmax=(914.498,'K')), NASAPolynomial(coeffs=[10.8697,0.0172688,-7.36831e-06,1.26674e-09,-7.96914e-14,304.263,-20.8596], Tmin=(914.498,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.7268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(CdCFF) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CJC=C) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]C(F)=C(F)C=C(F)F(10137)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.710633,0.0772111,-9.05137e-05,5.72957e-08,-1.49037e-11,-41128.4,25.1796], Tmin=(100,'K'), Tmax=(923.885,'K')), NASAPolynomial(coeffs=[11.4134,0.0308737,-1.52822e-05,3.01006e-09,-2.14391e-13,-43106,-25.6077], Tmin=(923.885,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-342.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]C(F)C(F)=C(F)F(10139)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-180.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,182,240,577,636,1210,1413,1685,370,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.802561,'amu*angstrom^2'), symmetry=1, barrier=(18.4525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.807522,'amu*angstrom^2'), symmetry=1, barrier=(18.5665,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.28828,0.0926376,-0.000166134,1.52547e-07,-5.36485e-11,-21582.4,27.931], Tmin=(100,'K'), Tmax=(841.636,'K')), NASAPolynomial(coeffs=[8.94823,0.0299134,-1.59078e-05,3.10546e-09,-2.1457e-13,-22276.3,-7.81745], Tmin=(841.636,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-CdsCsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(F)C(F)C(F)=[C]F(10140)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-158.127,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,161,331,427,521,441,625,1076,1234,167,640,1190,3120,650,792.5,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.006234,'amu*angstrom^2'), symmetry=1, barrier=(11.6156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38972,'amu*angstrom^2'), symmetry=1, barrier=(31.9524,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.33345,0.089583,-0.000153125,1.35851e-07,-4.67413e-11,-18894.9,28.096], Tmin=(100,'K'), Tmax=(833.461,'K')), NASAPolynomial(coeffs=[9.97545,0.0279279,-1.44814e-05,2.81166e-09,-1.94263e-13,-19967.9,-13.4598], Tmin=(833.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + radical(Cdj(Cd-CsF1s)(F1s)) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = 'F[C]=[C]C(F)C(F)=CF(10141)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-182.662,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,194,682,905,1196,1383,3221,1685,370,167,640,1190,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.627375,'amu*angstrom^2'), symmetry=1, barrier=(14.4246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.630705,'amu*angstrom^2'), symmetry=1, barrier=(14.5011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.341825,0.0918573,-0.000165806,1.53431e-07,-5.42115e-11,-21848.4,27.9715], Tmin=(100,'K'), Tmax=(845.409,'K')), NASAPolynomial(coeffs=[8.39825,0.0306439,-1.62183e-05,3.15732e-09,-2.17685e-13,-22385.3,-4.66199], Tmin=(845.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    products = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(3536)', '[CH]C(F)=CF(260)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    products = ['C=C(F)C(F)=C=C(F)F(10130)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)C=C=C(F)F(10131)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(54.5957,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(23.5437,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(F)C(F)C#CF(10134)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH]=C=C[C]=C(F)F(10135)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(20.1449,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH]=C=C(F)[C]=C(F)F(10136)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(294.926,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    products = ['[CH]C(F)=C(F)C=C(F)F(10137)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    products = ['[CH2]C(F)=C(F)[C]=C(F)F(9951)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    products = ['[CH]C(F)=CC(F)=C(F)F(10138)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(128.298,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    products = ['FC=C(F)[CH][C]=C(F)F(9860)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(166.496,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]C(F)C(F)=C(F)F(10139)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(213.446,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(F)C(F)C(F)=[C]F(10140)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]=[C]C(F)C(F)=CF(10141)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(9740)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(185.194,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #2646',
    isomers = [
        '[CH]=C(F)C(F)[C]=C(F)F(9740)',
    ],
    reactants = [
