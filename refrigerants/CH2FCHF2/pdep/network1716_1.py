...
"""),
    E0 = (-425.785,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,334,575,1197,1424,3202,180,180,180,664.886,664.958,3062.74],'cm^-1')),
        HinderedRotor(inertia=(0.806932,'amu*angstrom^2'), symmetry=1, barrier=(18.553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27078,'amu*angstrom^2'), symmetry=1, barrier=(18.5532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183045,'amu*angstrom^2'), symmetry=1, barrier=(57.4275,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.903153,0.0696718,-9.65931e-05,6.44824e-08,-1.66546e-11,-51099.8,26.5234], Tmin=(100,'K'), Tmax=(955.502,'K')), NASAPolynomial(coeffs=[14.716,0.0118455,-5.81118e-06,1.14052e-09,-8.11208e-14,-53739.4,-39.4863], Tmin=(955.502,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)
...
"""),
    E0 = (-60.4656,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,395,473,707,1436,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.641944,0.0793501,-0.000128501,1.02535e-07,-3.19777e-11,-7156.51,28.7688], Tmin=(100,'K'), Tmax=(790.626,'K')), NASAPolynomial(coeffs=[13.0846,0.0163966,-9.05878e-06,1.81523e-09,-1.28472e-13,-9123.93,-28.3363], Tmin=(790.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.4656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2sFO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-418.689,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([522,611,926,1093,1137,1374,1416,3112,395,473,707,1436,349.37,349.411,349.434,349.46,349.473,2649.34],'cm^-1')),
        HinderedRotor(inertia=(0.126479,'amu*angstrom^2'), symmetry=1, barrier=(10.9589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126446,'amu*angstrom^2'), symmetry=1, barrier=(10.9585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.489644,'amu*angstrom^2'), symmetry=1, barrier=(42.4342,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC(F)(F)[CH]F(3669)'],
    products = ['[O]OOC(F)(F)[CH]F(5988)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OO[C](F)F(2560)', '[CH]F(137)'],
    products = ['[O]OOC(F)(F)[CH]F(5988)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]OOC(F)=CF(912)'],
    products = ['[O]OOC(F)(F)[CH]F(5988)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(35.994,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[O]OO[C](F)F(2560)', 'CHF(40)'],
    products = ['[O]OOC(F)(F)[CH]F(5988)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH][C](F)OOOF(5996)'],
    products = ['[O]OOC(F)(F)[CH]F(5988)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(63.6111,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[O]OO[C](F)C(F)F(5992)'],
    products = ['[O]OOC(F)(F)[CH]F(5988)'],
