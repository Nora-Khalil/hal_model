...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)(F)C=O(3559)'],
    products = ['[O]CC(F)(F)O[O](4018)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(219)', '[CH2][O](2599)'],
    products = ['[O]CC(F)(F)O[O](4018)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]O[C](F)C=O(1934)'],
    products = ['[O]CC(F)(F)O[O](4018)'],
