species(
    label = 'F[CH]C(F)C(F)(F)[CH]F(3670)',
...
species(
    label = 'F[CH][CH]C(F)(F)C(F)F(3715)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)C(F)[C](F)F(3671)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'F[CH]C(F)[C](F)F(171)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', 'F[CH]C(F)(F)[CH]F(3708)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    products = ['FC1C(F)C(F)(F)C1F(3692)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[CH]C(F)C(F)=CF(142)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHFCF2(55)', 'F[CH][CH]F(141)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C(F)(F)C=CF(3710)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH][C](F)F(3610)', 'CHFCHF[Z](59)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)=CF(3711)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][C](F)F(3610)', 'F[CH][CH]F(141)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', 'F[CH]C=C(F)[CH]F(144)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[CH]C(F)=C(F)[CH]F(3712)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'F[CH]C(F)[C](F)F(171)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[CH]C(F)(F)[CH]F(3708)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    products = ['F[CH]C(F)(F)[C](F)CF(3713)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    products = ['F[CH][C](F)C(F)(F)CF(3714)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    products = ['F[CH]C(F)[C](F)C(F)F(3700)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    products = ['F[CH][C](F)C(F)C(F)F(3702)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    products = ['F[CH][CH]C(F)(F)C(F)F(3715)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(3670)'],
    products = ['F[CH]C(F)(F)[CH]C(F)F(3716)'],
...
network(
    label = 'PDepNetwork #795',
    isomers = [
        'F[CH]C(F)C(F)(F)[CH]F(3670)',
    ],
    reactants = [
