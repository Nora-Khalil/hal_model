...
species(
    label = '[O]C(CF)(OF)C(F)(F)CF(15208)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (179.065,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.02694,0.117652,-0.00016174,1.11916e-07,-3.06565e-11,-115824,33.2963], Tmin=(100,'K'), Tmax=(892.88,'K')), NASAPolynomial(coeffs=[18.3064,0.0310392,-1.62304e-05,3.26867e-09,-2.35195e-13,-119276,-57.7847], Tmin=(892.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-964.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsCsFHH) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[O]C(F)(CF)C(F)(F)COF(15209)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (179.065,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.2999,0.126722,-0.000206963,1.7598e-07,-5.90856e-11,-114139,34.8284], Tmin=(100,'K'), Tmax=(791.31,'K')), NASAPolynomial(coeffs=[14.8381,0.0363945,-1.91487e-05,3.77337e-09,-2.64355e-13,-116419,-37.5195], Tmin=(791.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-950.508,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-F1sCsCs))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.4973,'amu*angstrom^2'), symmetry=1, barrier=(34.4258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49201,'amu*angstrom^2'), symmetry=1, barrier=(34.3042,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.896025,0.0709514,-7.85224e-05,4.4993e-08,-1.04221e-11,-69161.4,22.8735], Tmin=(100,'K'), Tmax=(1038.65,'K')), NASAPolynomial(coeffs=[12.8251,0.0250114,-1.21779e-05,2.41006e-09,-1.72739e-13,-71639.5,-35.1302], Tmin=(1038.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-575.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (160.067,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4191.5,'J/mol'), sigma=(6.84912,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=654.70 K, Pc=29.6 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-526.234,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,528,1116,1182,1331,1402,1494,3075,3110,395,473,707,1436,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.667593,'amu*angstrom^2'), symmetry=1, barrier=(15.3493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394188,'amu*angstrom^2'), symmetry=1, barrier=(9.06315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73041,'amu*angstrom^2'), symmetry=1, barrier=(39.7856,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.015645,0.0959891,-0.000160309,1.36393e-07,-4.5528e-11,-63154,28.9551], Tmin=(100,'K'), Tmax=(797.031,'K')), NASAPolynomial(coeffs=[12.8146,0.0247379,-1.33035e-05,2.6315e-09,-1.84327e-13,-64981.3,-28.6657], Tmin=(797.031,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-526.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)
...
species(
    label = '[O]C(F)([CH]F)C(F)(CF)OF(15211)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-742.546,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,333,384,448,608,1254,1480,316,385,515,654,689,1295,528,1116,1182,1331,1402,1494,3075,3110,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-474.926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,166,258,854,1008,1066,1142,1198,1304,1253,1397,1428,1520,3056,3148,3059,3251,325,375,415,465,420,450,1700,1750,343.261,343.264,343.272,1829.96],'cm^-1')),
        HinderedRotor(inertia=(0.123162,'amu*angstrom^2'), symmetry=1, barrier=(10.2969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123165,'amu*angstrom^2'), symmetry=1, barrier=(10.2967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.407511,'amu*angstrom^2'), symmetry=1, barrier=(34.0647,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.15886,0.0921704,-0.000143815,1.23169e-07,-4.22337e-11,-56989.5,29.1164], Tmin=(100,'K'), Tmax=(786.603,'K')), NASAPolynomial(coeffs=[10.2568,0.0332153,-1.68886e-05,3.30389e-09,-2.31285e-13,-58342.8,-15.6809], Tmin=(786.603,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-474.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(C)OJ)"""),
)
...
"""),
    E0 = (-579.786,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,350,440,435,1725,194,682,905,1196,1383,3221,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.52141,'amu*angstrom^2'), symmetry=1, barrier=(34.9803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52032,'amu*angstrom^2'), symmetry=1, barrier=(34.9551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52128,'amu*angstrom^2'), symmetry=1, barrier=(34.9773,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.350084,0.105905,-0.000175477,1.56821e-07,-5.57433e-11,-69585.3,30.365], Tmin=(100,'K'), Tmax=(779.58,'K')), NASAPolynomial(coeffs=[10.5545,0.0376699,-2.05474e-05,4.11814e-09,-2.91662e-13,-70912.2,-17.1338], Tmin=(779.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-579.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CC(C)OJ)"""),
)

species(
    label = 'O=C([CH]F)C(F)(CF)OF(15214)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-710.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,375,552.5,462.5,1710,235,1215,1347,1486,3221,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.4072,'amu*angstrom^2'), symmetry=1, barrier=(32.3544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41567,'amu*angstrom^2'), symmetry=1, barrier=(32.5489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40837,'amu*angstrom^2'), symmetry=1, barrier=(32.3811,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40955,'amu*angstrom^2'), symmetry=1, barrier=(32.4083,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0830416,0.0969182,-0.000133318,9.50482e-08,-2.71757e-11,-85300,28.7857], Tmin=(100,'K'), Tmax=(852.051,'K')), NASAPolynomial(coeffs=[14.119,0.0302466,-1.59468e-05,3.21495e-09,-2.31189e-13,-87720.2,-37.4572], Tmin=(852.051,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-710.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(Csj(CO-CsO2d)(F1s)(H))"""),
)
...
"""),
    E0 = (-646.971,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,316,385,515,654,689,1295,528,1116,1182,1331,1402,1494,3075,3110,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (179.065,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.48854,0.131742,-0.000218991,1.88319e-07,-6.38471e-11,-77625.6,35.4252], Tmin=(100,'K'), Tmax=(788.744,'K')), NASAPolynomial(coeffs=[15.1506,0.0372638,-2.01164e-05,3.99791e-09,-2.81213e-13,-79936.3,-38.9096], Tmin=(788.744,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-646.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsOsH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + radical(C2CsJO)"""),
)

species(
    label = '[CH2]C(F)(OF)C(F)(CF)OF(15216)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-656.565,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,333,384,448,608,1254,1480,316,385,515,654,689,1295,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (179.065,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.49725,0.131163,-0.000201573,1.57902e-07,-4.90952e-11,-78777.9,33.134], Tmin=(100,'K'), Tmax=(788.502,'K')), NASAPolynomial(coeffs=[17.3715,0.0354442,-1.94819e-05,3.94686e-09,-2.82789e-13,-81753.5,-53.4131], Tmin=(788.502,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-656.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(14.8972,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F[C]CF(126)', '[O]C(F)(CF)OF(5201)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.14358e+07,'m^3/(mol*s)'), n=-0.641018, Ea=(181.818,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17570294811609, var=29.477358162589667, Tref=1000.0, N=2, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]C(F)(CF)C(F)OF(5520)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', '[O]C(F)(CF)C(F)(F)OF(5228)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', '[O]C(F)(F)C(F)(CF)OF(5242)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    products = ['[O]C(CF)(OF)C(F)(F)CF(15208)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    products = ['[O]C(F)(CF)C(F)(F)COF(15209)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+13,'s^-1'), n=0, Ea=(299,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [OF]
Euclidian distance = 0
family: 1,2_XY_interchange"""),
...
reaction(
    label = 'reaction9',
    reactants = ['OF(482)', '[O]C(F)(CF)C(F)=CF(3056)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(488)', 'C=C(F)C([O])(F)CF(3102)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O(6)', 'FC[C](F)C(F)(CF)OF(3525)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O][C](CF)C(F)(CF)OF(3336)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[CH2]C([O])(F)C(F)(CF)OF(3338)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', '[CH2]C(F)(OF)C([O])(F)CF(3337)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', '[O]C(F)(CF)C([O])(F)CF(3238)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]F(128)', '[O]C(F)(CF)[C](F)CF(3061)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O][C](F)CF(882)', 'FC[C](F)OF(3020)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2F(46)', '[O]C(F)(CF)[C](F)OF(3428)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2F(46)', '[O][C](F)C(F)(CF)OF(3427)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(5)', '[O]C(F)([CH]F)C(F)(CF)OF(15211)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F2(78)', '[O]C(F)(CF)C(=O)CF(3329)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(69.5909,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction27',
    reactants = ['F2(78)', '[O]C(CF)=C(CF)OF(15212)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(12.455,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction28',
    reactants = ['F2(78)', 'C=C(OF)C([O])(F)CF(14559)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(7.12316,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction29',
    reactants = ['F2(78)', 'C=C([O])C(F)(CF)OF(14544)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(19.1086,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction30',
    reactants = ['HF(38)', '[O]C(F)(CF)C(=CF)OF(15213)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS30',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(224.117,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction31',
    reactants = ['HF(38)', 'O=C([CH]F)C(F)(CF)OF(15214)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS31',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(288.114,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction32',
    reactants = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    products = ['F2(78)', 'CH2CFO(79)', 'O=C(F)CF(879)'],
    transitionState = 'TS32',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(171.527,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    label = 'reaction35',
    reactants = ['FC[C](OF)C(F)(CF)OF(15215)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
    transitionState = 'TS35',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(106.635,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(F)(OF)C(F)(CF)OF(15216)'],
    products = ['[O]C(F)(CF)C(F)(CF)OF(5536)'],
...
network(
    label = 'PDepNetwork #4379',
    isomers = [
        '[O]C(F)(CF)C(F)(CF)OF(5536)',
    ],
    reactants = [
