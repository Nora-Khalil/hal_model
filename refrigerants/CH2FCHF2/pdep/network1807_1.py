...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', '[CH2]C([O])(F)F(218)'],
    products = ['[O]C(F)(F)C[C]=O(6192)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[CH2]C([O])(F)F(218)'],
    products = ['[O]C(F)(F)C[C]=O(6192)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C=C=O(6702)'],
    products = ['[O]C(F)(F)C[C]=O(6192)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]CC(=O)F(6703)'],
    products = ['[O]C(F)(F)C[C]=O(6192)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=[C][CH]C(=O)F(6704)'],
    products = ['[O]C(F)(F)C[C]=O(6192)'],
