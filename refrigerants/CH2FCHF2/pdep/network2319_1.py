...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(=C)[O](6456)'],
    products = ['C=C([O])C[O](3267)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2O(20)', '[CH2][C]=O(4470)'],
    products = ['C=C([O])C[O](3267)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(=O)C=O(8827)'],
    products = ['C=C([O])C[O](3267)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](2653)', '[CH2][C]=O(4470)'],
    products = ['C=C([O])C[O](3267)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[O]C[C]=O(4906)'],
    products = ['C=C([O])C[O](3267)'],
