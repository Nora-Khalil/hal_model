...
"""),
    E0 = (-603.128,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,482,586,761,1411,180,180,558.993,733.081,733.224],'cm^-1')),
        HinderedRotor(inertia=(1.20929,'amu*angstrom^2'), symmetry=1, barrier=(27.8039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.072888,'amu*angstrom^2'), symmetry=1, barrier=(27.8033,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.970708,0.0593839,-5.34588e-05,2.30721e-08,-3.9041e-12,-72424.5,27.352], Tmin=(100,'K'), Tmax=(1425.29,'K')), NASAPolynomial(coeffs=[16.6865,0.0152789,-7.04242e-06,1.3615e-09,-9.60525e-14,-76904.4,-54.0371], Tmin=(1425.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-603.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = 'OC(F)O[C](F)[CH]F(3270)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.22345,'amu*angstrom^2'), symmetry=1, barrier=(5.13756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220834,'amu*angstrom^2'), symmetry=1, barrier=(5.07742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.977021,'amu*angstrom^2'), symmetry=1, barrier=(22.4636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57974,'amu*angstrom^2'), symmetry=1, barrier=(36.3213,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.184943,0.092536,-0.000158849,1.39673e-07,-4.78685e-11,-41676.8,28.4294], Tmin=(100,'K'), Tmax=(814.582,'K')), NASAPolynomial(coeffs=[11.1968,0.0262129,-1.41633e-05,2.79907e-09,-1.95562e-13,-43064.4,-19.9437], Tmin=(814.582,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-347.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHOO) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)(F)OC([O])F(3272)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10632,0.0679947,-8.30353e-05,5.31503e-08,-1.37818e-11,-78367.1,25.3421], Tmin=(100,'K'), Tmax=(931.899,'K')), NASAPolynomial(coeffs=[11.3682,0.0239471,-1.2135e-05,2.42901e-09,-1.7474e-13,-80279.7,-23.4419], Tmin=(931.899,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-652.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsHHH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)

species(
    label = 'FC[C](F)O[CH]OF(3273)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(441)', 'F[C]CF-2(3008)'],
    products = ['[O]C(F)O[C](F)CF(3232)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)OC([O])F(3263)'],
    products = ['[O]C(F)O[C](F)CF(3232)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CO[C](F)CF(3265)'],
    products = ['[O]C(F)O[C](F)CF(3232)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[C](F)CF(3266)'],
    products = ['[O]C(F)O[C](F)CF(3232)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C](F)OC(F)OF(3271)'],
    products = ['[O]C(F)O[C](F)CF(3232)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)O[C](F)CF(3232)'],
    products = ['[CH2]C(F)(F)OC([O])F(3272)'],
