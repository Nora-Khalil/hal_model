...
species(
    label = '[CH2]C1([O])C(F)C1(F)F(7994)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48068,0.0479341,-3.27592e-05,9.04926e-09,-4.44537e-13,-83929.7,22.2405], Tmin=(100,'K'), Tmax=(1224.83,'K')), NASAPolynomial(coeffs=[12.9841,0.0191413,-8.24368e-06,1.5545e-09,-1.08588e-13,-87405.9,-38.2767], Tmin=(1224.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-698.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCCFF) + group(Cds-OdCsCs) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-CO) + ring(Cyclobutanone)"""),
)

species(
    label = '[CH2][C]1OC(F)C1(F)F(8011)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C=C([O])C(F)(F)[CH]F(3924)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=C([O])C(F)[C](F)F(3910)'],
    products = ['C=C([O])C(F)(F)[CH]F(3924)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(CF)=C(F)[CH]F(3059)'],
    products = ['C=C([O])C(F)(F)[CH]F(3924)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', '[CH2]C(=O)[C](F)F(6453)'],
    products = ['C=C([O])C(F)(F)[CH]F(3924)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)(F)[CH]F(8005)'],
    products = ['C=C([O])C(F)(F)[CH]F(3924)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C([O])C(F)(F)[CH]F(3924)'],
    products = ['F[CH]C(F)(F)[C]1CO1(8006)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C(F)(F)[CH]F(3924)'],
    products = ['[O][C]1CC(F)C1(F)F(8007)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C=C([O])C(F)(F)[CH]F(3924)'],
    products = ['[CH2]C1([O])C(F)C1(F)F(7994)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C(F)=CF(6335)'],
    products = ['C=C([O])C(F)(F)[CH]F(3924)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C(=O)[C](F)F(6453)'],
    products = ['C=C([O])C(F)(F)[CH]F(3924)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(O)C(F)(F)[CH]F(8008)'],
    products = ['C=C([O])C(F)(F)[CH]F(3924)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C([O])C(F)(F)CF(8009)'],
    products = ['C=C([O])C(F)(F)[CH]F(3924)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(OF)=C(F)[CH]F(8010)'],
    products = ['C=C([O])C(F)(F)[CH]F(3924)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(18)', 'O=[C]C(F)(F)[CH]F(4153)'],
    products = ['C=C([O])C(F)(F)[CH]F(3924)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([O])C(F)(F)[CH]F(3924)'],
    products = ['[CH2][C]1OC(F)C1(F)F(8011)'],
...
network(
    label = 'PDepNetwork #2082',
    isomers = [
        'C=C([O])C(F)(F)[CH]F(3924)',
    ],
    reactants = [
        ('CHFCF2(55)', 'CH2CO(28)'),
    ],
