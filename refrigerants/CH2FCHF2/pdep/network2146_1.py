...
"""),
    E0 = (330.845,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([145,326,398,834,1303,2950,3100,1380,975,1025,1650,540,610,2055,246.091,263.34,272.558],'cm^-1')),
        HinderedRotor(inertia=(1.06931,'amu*angstrom^2'), symmetry=1, barrier=(50.6649,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0649,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49574,0.0331483,-2.03112e-05,6.20309e-09,-7.87549e-13,39845.1,15.2364], Tmin=(100,'K'), Tmax=(1712.2,'K')), NASAPolynomial(coeffs=[8.39369,0.0193696,-8.24018e-06,1.50306e-09,-1.01292e-13,37825.4,-16.3896], Tmin=(1712.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C=C1OC=C1F(8079)',
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.39594,0.0288718,-7.0822e-06,-9.2238e-09,4.6859e-12,-5756.81,13.0181], Tmin=(100,'K'), Tmax=(1108.65,'K')), NASAPolynomial(coeffs=[9.63061,0.0158158,-7.06943e-06,1.38317e-09,-9.95519e-14,-8162.74,-26.2472], Tmin=(1108.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.3897,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsOsH) + group(Cds-CdsHH) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(Oxetene)"""),
)

species(
    label = '[CH]C(F)=C1CO1(8101)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.08375,0.00517715,6.65626e-05,-8.84084e-08,3.33195e-11,5234.52,18.9726], Tmin=(100,'K'), Tmax=(971.303,'K')), NASAPolynomial(coeffs=[10.3329,0.0133925,-4.91412e-06,1.00168e-09,-7.91833e-14,2030.56,-25.033], Tmin=(971.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCCFH) + group(Cds-OdCsCs) + ring(Cyclobutanone) + radical(CCJCC=O) + radical(CsCOCsF1s)"""),
)

species(
    label = '[CH2]C1([O])C=C1F(8092)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u1 p2 c0 {3,S}
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60295,0.0546967,-7.09417e-05,4.42775e-08,-9.27458e-12,48595.6,20.4825], Tmin=(100,'K'), Tmax=(737.443,'K')), NASAPolynomial(coeffs=[10.8572,0.0133499,-4.8406e-06,7.93624e-10,-4.99201e-14,46990.1,-22.977], Tmin=(737.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(403.343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C(O)CJ) + radical(C=C=CJ)"""),
)

species(
    label = 'C=C([O])[C]=CF(8094)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u1 p2 c0 {3,S}
...
"""),
    E0 = (116.584,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,246,474,533,1155,1855,455,950,3120,650,792.5,1650,221.239],'cm^-1')),
        HinderedRotor(inertia=(0.695958,'amu*angstrom^2'), symmetry=1, barrier=(23.9971,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00211237,'amu*angstrom^2'), symmetry=1, barrier=(23.984,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
...
"""),
    E0 = (144.404,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([244,384,691,1241,1855,455,950,3120,650,792.5,1650],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32806,0.0397956,-6.07777e-05,4.69438e-08,-1.42846e-11,17425.2,14.5804], Tmin=(100,'K'), Tmax=(807.397,'K')), NASAPolynomial(coeffs=[8.36399,0.00989002,-5.2141e-06,1.06136e-09,-7.65324e-14,16450.6,-13.2477], Tmin=(807.397,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cd-F1sCO)(H)) + radical(COj(Cd-F1sCd)(O2d))"""),
)

species(
    label = 'O=C1CC=C1F(8067)',
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61005,0.0374156,7.0245e-06,-5.47252e-08,2.96466e-11,9301.96,14.2196], Tmin=(100,'K'), Tmax=(893.993,'K')), NASAPolynomial(coeffs=[19.9691,-0.00306458,5.03873e-06,-1.11415e-09,7.65833e-14,4354.47,-81.6065], Tmin=(893.993,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.5063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCCFH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(CsCdCsF1s) + radical(CCsJOC(O))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH]C(F)=C=C(8100)'],
    products = ['[CH]=C(F)C(=C)[O](3152)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['C2HF(58)', '[CH2][C]=O(4373)'],
    products = ['[CH]=C(F)C(=C)[O](3152)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]F(252)', '[CH2][C]=O(4373)'],
    products = ['[CH]=C(F)C(=C)[O](3152)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(T)(18)', '[CH]=C(F)[C]=O(568)'],
    products = ['[CH]=C(F)C(=C)[O](3152)'],
