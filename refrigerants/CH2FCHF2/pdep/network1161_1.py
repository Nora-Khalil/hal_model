...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.37442,'amu*angstrom^2'), symmetry=1, barrier=(8.60864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374484,'amu*angstrom^2'), symmetry=1, barrier=(8.61011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.526444,'amu*angstrom^2'), symmetry=1, barrier=(12.104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
...
species(
    label = '[O]C(F)(F)C(F)(F)C(F)F(8948)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.303107,'amu*angstrom^2'), symmetry=1, barrier=(6.96903,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303191,'amu*angstrom^2'), symmetry=1, barrier=(6.97095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303132,'amu*angstrom^2'), symmetry=1, barrier=(6.96961,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (167.03,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.52722,'amu*angstrom^2'), symmetry=1, barrier=(12.1218,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.527795,'amu*angstrom^2'), symmetry=1, barrier=(12.135,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(F)(F)C(F)F(3185)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF3(42)', 'OC(F)(F)[C]F(3183)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)F(2564)', 'F[C]C(F)F(125)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(482)', 'F[C]C(F)(F)C(F)F(8944)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'OC(F)(F)C(F)(F)[C]F(3184)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'OC(F)(F)C(F)(F)F(3186)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
    products = ['OC(F)(C(F)F)C(F)(F)F(8945)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(482)', 'FC(F)=C(F)C(F)F(3954)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OC(F)F(368)', 'CF2CF2(61)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)(F)[C](F)C(F)F(4995)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[C](F)C(F)(F)C(F)F(8946)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)(F)C(F)(F)[CH]F(3193)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'F[C](F)C(F)(F)C(F)F(8947)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)(F)C(F)(F)C(F)F(8948)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](F)F(2562)', 'CHF2-CF2(69)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(82)', 'OC(F)(F)[C](F)F(3192)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)(F)C(F)(F)[C](F)F(8949)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)C(F)F(8950)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', 'OC(F)=C(F)C(F)F(4997)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'OC(F)(F)C(F)=CF(2587)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'OC(F)(F)C(F)=C(F)F(3799)'],
    products = ['OC(F)(F)C(F)(F)C(F)F(4506)'],
...
network(
    label = 'PDepNetwork #1161',
    isomers = [
        'OC(F)(F)C(F)(F)C(F)F(4506)',
    ],
    reactants = [
