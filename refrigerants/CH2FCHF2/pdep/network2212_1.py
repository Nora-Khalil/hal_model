...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(441)', '[C]=C(4368)'],
    products = ['C=[C]OC([O])F(8173)'],
    transitionState = 'TS2',
