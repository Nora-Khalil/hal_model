...
species(
    label = '[CH2]C(F)(F)C(F)(F)C#CF(9935)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH2]C(F)(F)C(F)(F)C=[C]F(9937)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {6,S}
...
species(
    label = '[CH2][C](F)C(F)(F)C(F)=CF(9939)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][C]=C(F)C(F)(F)CF(9940)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH2]C(F)(F)[C](F)C(F)=CF(9941)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH]=[C]C(F)(F)C(F)(F)CF(9942)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH]=C(F)C(F)(F)C([CH2])(F)F(9943)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'FC=[C]C(F)(F)[C](F)F(9931)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=CF-2(3543)', '[CH2]C(F)(F)[C](F)F(203)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_ter_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
    products = ['FC=C1CC(F)(F)C1(F)F(9924)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C(F)(F)[C]=CF(9932)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)=C=CF(9933)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C#CC(F)(F)C([CH2])(F)F(9934)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)(F)C#CF(9935)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[CH2]C(F)=C(F)[C]=CF(9936)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
    products = ['[CH2]C(F)(F)C(F)(F)C=[C]F(9937)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC(F)(F)C(F)(F)[C]=[C]F(9938)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC=[C]C(F)(F)[C](F)CF(9846)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
    products = ['[CH2][C](F)C(F)(F)C(F)=CF(9939)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
    products = ['F[CH][C]=C(F)C(F)(F)CF(9940)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
    products = ['[CH2]C(F)(F)[C](F)C(F)=CF(9941)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=[C]C(F)(F)C(F)(F)CF(9942)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=C(F)C(F)(F)C([CH2])(F)F(9943)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(9734)'],
...
network(
    label = 'PDepNetwork #2635',
    isomers = [
        '[CH2]C(F)(F)C(F)(F)[C]=CF(9734)',
    ],
    reactants = [
