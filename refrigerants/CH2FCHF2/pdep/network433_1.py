...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(=C)F(2750)'],
    products = ['[CH2]OC([CH2])(F)F(2666)'],
    transitionState = 'TS6',
