...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.97332,'amu*angstrom^2'), symmetry=1, barrier=(45.3704,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (41.0287,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.22258,0.0203743,-3.96926e-05,3.63081e-08,-1.1889e-11,50197.8,8.10618], Tmin=(100,'K'), Tmax=(966.544,'K')), NASAPolynomial(coeffs=[4.70877,0.00503525,-1.62775e-06,2.17578e-10,-1.00825e-14,50339.7,3.20699], Tmin=(966.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo library: FFCM1(-) + radical(Acetyl)"""),
)

species(
    label = '[C]=C(O)F-2(15467)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.4624,'amu*angstrom^2'), symmetry=1, barrier=(33.6234,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.0271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48391,0.0351438,-5.6023e-05,4.02938e-08,-1.0375e-11,828.457,10.2731], Tmin=(100,'K'), Tmax=(730.152,'K')), NASAPolynomial(coeffs=[9.24044,0.00335034,-1.43319e-06,2.43626e-10,-1.51289e-14,-297.371,-21.1513], Tmin=(730.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.44767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CdCFO) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    ...
    products = ['OC#CF(2954)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.21037e+06,'m^3/(mol*s)'), n=0.349925, Ea=(9.00551,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[C]=C(O)F-2(15467)'],
    products = ['OC#CF(2954)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(204.032,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)
