...
"""),
    E0 = (-709.643,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,2750,2800,2850,1350,1500,750,1050,1375,1000,233.619,233.62,233.62,233.62],'cm^-1')),
        HinderedRotor(inertia=(0.542032,'amu*angstrom^2'), symmetry=1, barrier=(20.9927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239387,'amu*angstrom^2'), symmetry=1, barrier=(9.27137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239387,'amu*angstrom^2'), symmetry=1, barrier=(9.27137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.925464,'amu*angstrom^2'), symmetry=1, barrier=(35.8432,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.522012,0.083317,-0.000114898,8.81874e-08,-2.77702e-11,-85231.4,24.0481], Tmin=(100,'K'), Tmax=(770.322,'K')), NASAPolynomial(coeffs=[10.2153,0.0329821,-1.68823e-05,3.35883e-09,-2.39393e-13,-86724.7,-20.1868], Tmin=(770.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-709.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsHHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.759937,'amu*angstrom^2'), symmetry=1, barrier=(17.4724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.760347,'amu*angstrom^2'), symmetry=1, barrier=(17.4819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78447,'amu*angstrom^2'), symmetry=1, barrier=(41.0285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.762621,'amu*angstrom^2'), symmetry=1, barrier=(17.5342,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.4673,0.0859219,-0.000144591,1.28046e-07,-4.44886e-11,-42917.4,25.1674], Tmin=(100,'K'), Tmax=(808.646,'K')), NASAPolynomial(coeffs=[9.8255,0.0277871,-1.47835e-05,2.91679e-09,-2.04077e-13,-44043.7,-15.5985], Tmin=(808.646,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-357.828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(Cs-OsHHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (130.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.5262,0.0831063,-0.000121852,1.01813e-07,-3.48529e-11,-86665,24.879], Tmin=(100,'K'), Tmax=(741.81,'K')), NASAPolynomial(coeffs=[9.2714,0.0336088,-1.70293e-05,3.35334e-09,-2.36701e-13,-87898,-14.2655], Tmin=(741.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-721.561,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFFO) + group(Cs-OsHHH)"""),
)

species(
    label = 'COC(F)(F)COF(5489)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {5,S}
4  O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (130.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.526116,0.0831075,-0.000121857,1.01821e-07,-3.48575e-11,-86665,24.8793], Tmin=(100,'K'), Tmax=(741.678,'K')), NASAPolynomial(coeffs=[9.2715,0.0336086,-1.70292e-05,3.35331e-09,-2.36698e-13,-87898,-14.266], Tmin=(741.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-721.561,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-OsHHH)"""),
)
...
"""),
    E0 = (-285.138,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,551,1088,1226,1380,1420,1481,3057,3119,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,237.841,237.854,237.856,237.858],'cm^-1')),
        HinderedRotor(inertia=(0.00297918,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00298003,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173457,'amu*angstrom^2'), symmetry=1, barrier=(6.96302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.62378,'amu*angstrom^2'), symmetry=1, barrier=(25.0428,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36795,0.0657434,-7.76753e-05,4.10143e-08,-1.46207e-12,-34206.9,23.6176], Tmin=(100,'K'), Tmax=(564.108,'K')), NASAPolynomial(coeffs=[7.78417,0.0313992,-1.60067e-05,3.17993e-09,-2.26402e-13,-35108.2,-5.23635], Tmin=(564.108,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(Cs-OsHHH) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(F)(OC)OF(5492)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.542077,'amu*angstrom^2'), symmetry=1, barrier=(12.4634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19019,'amu*angstrom^2'), symmetry=1, barrier=(4.37284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191161,'amu*angstrom^2'), symmetry=1, barrier=(4.39518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65593,'amu*angstrom^2'), symmetry=1, barrier=(38.073,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.593811,0.0821999,-0.000129964,1.13107e-07,-3.93027e-11,-38480.9,22.9139], Tmin=(100,'K'), Tmax=(792.296,'K')), NASAPolynomial(coeffs=[9.117,0.0304866,-1.56194e-05,3.06156e-09,-2.14391e-13,-39559,-14.5013], Tmin=(792.296,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-320.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)

species(
    label = 'COC([O])(F)CF(5493)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.244542,'amu*angstrom^2'), symmetry=1, barrier=(5.62249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2436,'amu*angstrom^2'), symmetry=1, barrier=(5.60085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19302,'amu*angstrom^2'), symmetry=1, barrier=(27.4299,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62689,0.0603293,-5.92058e-05,1.23161e-08,1.67817e-11,-70339.2,20.7978], Tmin=(100,'K'), Tmax=(528.317,'K')), NASAPolynomial(coeffs=[6.94514,0.0326383,-1.62876e-05,3.2102e-09,-2.27678e-13,-71076.7,-3.12721], Tmin=(528.317,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-585.478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsHHH) + radical(O2sj(Cs-F1sO2sCs))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.272195,'amu*angstrom^2'), symmetry=1, barrier=(6.2583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272393,'amu*angstrom^2'), symmetry=1, barrier=(6.26285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272334,'amu*angstrom^2'), symmetry=1, barrier=(6.2615,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.18039,'amu*angstrom^2'), symmetry=1, barrier=(4.14751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.586986,'amu*angstrom^2'), symmetry=1, barrier=(13.496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180474,'amu*angstrom^2'), symmetry=1, barrier=(4.14946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.75675,'amu*angstrom^2'), symmetry=1, barrier=(40.3911,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.165229,0.0935479,-0.000157831,1.4029e-07,-4.87464e-11,-61045.4,25.8685], Tmin=(100,'K'), Tmax=(818.103,'K')), NASAPolynomial(coeffs=[10.0346,0.0307866,-1.61597e-05,3.16793e-09,-2.20665e-13,-62174.7,-16.7968], Tmin=(818.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-508.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsHHH) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H2(8)', 'COC(F)([C]F)OF(5487)'],
    products = ['COC(F)(CF)OF(5399)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'COC(F)OF(5388)'],
    products = ['COC(F)(CF)OF(5399)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'COC(F)(F)OF(5394)'],
    products = ['COC(F)(CF)OF(5399)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3OH(26)', 'FC=C(F)OF(1049)'],
    products = ['COC(F)(CF)OF(5399)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['COF(2546)', 'C=C(F)OF(3013)'],
    products = ['COC(F)(CF)OF(5399)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(482)', 'COC(F)=CF(2597)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FOF(488)', 'C=C(F)OC(5490)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CO[C](CF)OF(5491)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)(OC)OF(5492)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'COC([O])(F)CF(5493)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3O(27)', 'FC[C](F)OF(3020)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', '[O]C(F)(CF)OF(5201)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(128)', 'CO[C](F)CF(4386)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(46)', 'CO[C](F)OF(5494)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'COC(F)([CH]F)OF(5495)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH2]OC(F)(CF)OF(5441)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(78)', 'C=C(OC)OF(5497)'],
    products = ['COC(F)(CF)OF(5399)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'COC(=CF)OF(5498)'],
    products = ['COC(F)(CF)OF(5399)'],
