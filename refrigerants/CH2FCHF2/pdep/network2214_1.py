...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', '[CH2]C([O])F(415)'],
    products = ['[O]C(F)C[C]=O(8149)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)C=C=O(8355)'],
    products = ['[O]C(F)C[C]=O(8149)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C=C[C]=O(8356)'],
    products = ['[O]C(F)C[C]=O(8149)'],
