species(
    label = '[CH]=C(F)C(F)(F)[C](F)F(11870)',
...
species(
    label = '[CH]C(F)=C(F)C(F)(F)F(11927)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
species(
    label = '[CH]=[C]C(F)(F)C(F)(F)F(11928)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(11870)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', '[CH]C(F)=C(F)F(296)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(11870)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=C(F)C(F)=C(F)F(3881)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(11870)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C#CC(F)(F)[C](F)F(11926)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(11870)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F2(78)', '[CH]=C=C(F)[C](F)F(3883)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(11870)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH]C(F)=C(F)F(296)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(11870)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(11870)'],
    products = ['[CH]C(F)=C(F)C(F)(F)F(11927)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(11870)'],
    products = ['F[CH]C(F)=C(F)[C](F)F(3762)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(11870)'],
    products = ['[CH]=[C]C(F)(F)C(F)(F)F(11928)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(11870)'],
    products = ['FC=[C]C(F)(F)[C](F)F(9931)'],
