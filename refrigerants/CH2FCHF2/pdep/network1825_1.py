...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(219)', 'O=C[C]F(284)'],
    products = ['O=C[C](F)OO[C](F)F(6203)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[O]O[C](F)C=O(1934)'],
    products = ['O=C[C](F)OO[C](F)F(6203)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['O=C[C](F)OO[C](F)F(6203)'],
    products = ['F[C](F)OOC1(F)[CH]O1(6275)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]O[C](F)F(219)', 'O=C[C]F-2(1596)'],
    products = ['O=C[C](F)OO[C](F)F(6203)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[O]O[C](F)C=O(1934)'],
    products = ['O=C[C](F)OO[C](F)F(6203)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(6)', '[CH]=C(F)OO[C](F)F(6281)'],
    products = ['O=C[C](F)OO[C](F)F(6203)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=C[C](F)OO[C](F)F(6203)'],
    products = ['[O][CH]C1(F)OOC1(F)F(6283)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C=[C]OOC(F)(F)F(6287)'],
    products = ['O=C[C](F)OO[C](F)F(6203)'],
