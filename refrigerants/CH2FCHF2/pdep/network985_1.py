...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05656,0.0479603,-5.79336e-05,4.35905e-08,-1.45451e-11,-62587.3,23.2867], Tmin=(100,'K'), Tmax=(707.526,'K')), NASAPolynomial(coeffs=[5.64509,0.0276716,-1.49184e-05,3.05761e-09,-2.22482e-13,-63095.1,7.21581], Tmin=(707.526,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-520.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(O2s-Cs-Cs-Cs(F)) + radical(CCOJ) + radical(Cs_P) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F))"""),
)

species(
    label = '[O]C1([O])C(F)C1(F)F(4147)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(4086)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)[C](F)[CH]F(4152)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(4086)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', '[O]C(=O)[C](F)F(548)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(4086)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C(F)(F)[CH]F(4153)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(4086)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(4086)'],
    products = ['F[CH]C(F)(F)[C]1OO1(4154)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(4086)'],
    products = ['[O][C]1OC(F)C1(F)F(4155)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(4086)'],
    products = ['[O]C1([O])C(F)C1(F)F(4147)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(=O)C(F)=CF(531)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(4086)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[O]C(=O)[C](F)F(548)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(4086)'],
