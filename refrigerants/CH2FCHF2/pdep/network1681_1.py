...
reaction(
    label = 'reaction4',
    reactants = ['FOF(488)', 'OC[C]F-2(5177)'],
    products = ['OCC(F)(F)OF(5395)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(482)', 'C=C(F)OF(3013)'],
    products = ['OCC(F)(F)OF(5395)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(482)', 'OC=C(F)F(3558)'],
    products = ['OCC(F)(F)OF(5395)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)(F)CO(5610)'],
    products = ['OCC(F)(F)OF(5395)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]C(F)(F)OF(2838)'],
    products = ['OCC(F)(F)OF(5395)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]CC(F)(F)OF(5611)'],
    products = ['OCC(F)(F)OF(5395)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(128)', 'OC[C](F)F(2781)'],
    products = ['OCC(F)(F)OF(5395)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(2563)', 'CH2OH(33)'],
    products = ['OCC(F)(F)OF(5395)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O[CH]C(F)(F)OF(5485)'],
    products = ['OCC(F)(F)OF(5395)'],
