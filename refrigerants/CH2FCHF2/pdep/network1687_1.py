...
"""),
    E0 = (-736.325,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,333,384,448,608,1254,1480,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.844554,'amu*angstrom^2'), symmetry=1, barrier=(19.418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844567,'amu*angstrom^2'), symmetry=1, barrier=(19.4183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844578,'amu*angstrom^2'), symmetry=1, barrier=(19.4185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844604,'amu*angstrom^2'), symmetry=1, barrier=(19.4191,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.4591,0.0832209,-0.000106475,7.17629e-08,-1.95113e-11,-88436.5,25.0237], Tmin=(100,'K'), Tmax=(892.7,'K')), NASAPolynomial(coeffs=[12.724,0.028266,-1.41368e-05,2.80669e-09,-2.00704e-13,-90626.3,-32.7555], Tmin=(892.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-736.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.88071,0.0254385,-2.53337e-05,1.48259e-08,-3.65564e-12,-9452.08,14.087], Tmin=(100,'K'), Tmax=(964.964,'K')), NASAPolynomial(coeffs=[5.99227,0.0125404,-5.28411e-06,9.74208e-10,-6.69772e-14,-10052.6,-0.813498], Tmin=(964.964,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.9184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsOsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-384.509,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,617,898,1187,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.973338,'amu*angstrom^2'), symmetry=1, barrier=(22.379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.972284,'amu*angstrom^2'), symmetry=1, barrier=(22.3547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.97243,'amu*angstrom^2'), symmetry=1, barrier=(22.3581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.972266,'amu*angstrom^2'), symmetry=1, barrier=(22.3543,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.524614,0.0839696,-0.000127139,9.50429e-08,-2.61654e-11,-46127.7,25.7367], Tmin=(100,'K'), Tmax=(651.566,'K')), NASAPolynomial(coeffs=[12.0852,0.0235512,-1.23402e-05,2.44059e-09,-1.71983e-13,-47858.2,-26.803], Tmin=(651.566,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-384.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-507.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,323.905,323.979],'cm^-1')),
        HinderedRotor(inertia=(0.133581,'amu*angstrom^2'), symmetry=1, barrier=(9.94551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133705,'amu*angstrom^2'), symmetry=1, barrier=(9.94956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357228,'amu*angstrom^2'), symmetry=1, barrier=(26.5823,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70742,0.053405,-6.17135e-05,3.81229e-08,-9.60674e-12,-60970.1,19.1024], Tmin=(100,'K'), Tmax=(955.347,'K')), NASAPolynomial(coeffs=[9.59364,0.0203849,-9.86718e-06,1.94229e-09,-1.38597e-13,-62476.9,-18.5837], Tmin=(955.347,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-507.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFHO)"""),
)

species(
    label = 'OCC(F)(F)OF(5395)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.488151,'amu*angstrom^2'), symmetry=1, barrier=(11.2235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.488649,'amu*angstrom^2'), symmetry=1, barrier=(11.235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.970321,'amu*angstrom^2'), symmetry=1, barrier=(22.3096,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.039,'amu'),
...
"""),
    ...
    molecularWeight = (130.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.104812,0.0937923,-0.000151606,1.30802e-07,-4.44166e-11,-90061.6,26.5728], Tmin=(100,'K'), Tmax=(818.756,'K')), NASAPolynomial(coeffs=[10.6525,0.0308796,-1.54946e-05,2.99426e-09,-2.07294e-13,-91407.3,-19.8747], Tmin=(818.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-749.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(Cs-CsOsHH)"""),
)

species(
    label = 'OC(CF)(CF)OF(5755)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-327.045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,212.487,212.504,212.51],'cm^-1')),
        HinderedRotor(inertia=(0.159015,'amu*angstrom^2'), symmetry=1, barrier=(5.09777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159043,'amu*angstrom^2'), symmetry=1, barrier=(5.09724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159082,'amu*angstrom^2'), symmetry=1, barrier=(5.09779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.509629,'amu*angstrom^2'), symmetry=1, barrier=(16.3316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694372,0.0808106,-0.000132844,1.17541e-07,-4.0477e-11,-39223.1,25.8154], Tmin=(100,'K'), Tmax=(843.155,'K')), NASAPolynomial(coeffs=[8.43358,0.0291231,-1.42548e-05,2.71408e-09,-1.85768e-13,-39996,-7.04554], Tmin=(843.155,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-327.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(C2CsJO)"""),
)

species(
    label = '[CH2]C(F)(CO)OF(5778)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {5,S}
...
"""),
    E0 = (-351.311,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,191.132,208.885],'cm^-1')),
        HinderedRotor(inertia=(1.24844,'amu*angstrom^2'), symmetry=1, barrier=(34.5593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.428935,'amu*angstrom^2'), symmetry=1, barrier=(11.5028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255509,'amu*angstrom^2'), symmetry=1, barrier=(7.25356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256995,'amu*angstrom^2'), symmetry=1, barrier=(7.23944,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.412789,0.0860251,-0.000137966,1.18008e-07,-3.98807e-11,-42130.6,24.1141], Tmin=(100,'K'), Tmax=(809.009,'K')), NASAPolynomial(coeffs=[10.4479,0.0277959,-1.40342e-05,2.72302e-09,-1.89148e-13,-43472.5,-20.431], Tmin=(809.009,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-351.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)

species(
    label = '[O]C(F)(CO)CF(5779)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-636.882,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,286,334,437,422,648,895,1187,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,274.801,274.804],'cm^-1')),
        HinderedRotor(inertia=(0.169704,'amu*angstrom^2'), symmetry=1, barrier=(9.09425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169695,'amu*angstrom^2'), symmetry=1, barrier=(9.09423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16972,'amu*angstrom^2'), symmetry=1, barrier=(9.0942,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03949,0.0699287,-9.36595e-05,7.00421e-08,-2.13741e-11,-76496.9,23.9038], Tmin=(100,'K'), Tmax=(796.408,'K')), NASAPolynomial(coeffs=[9.56617,0.0271019,-1.29951e-05,2.51693e-09,-1.76757e-13,-77855.1,-15.2912], Tmin=(796.408,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-F1sCsCs))"""),
)
...
"""),
    E0 = (-464.688,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.87407,'amu*angstrom^2'), symmetry=1, barrier=(20.0966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.874797,'amu*angstrom^2'), symmetry=1, barrier=(20.1133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.873681,'amu*angstrom^2'), symmetry=1, barrier=(20.0876,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.75725,0.0162607,0.000174195,-4.66816e-07,3.51343e-10,-55878.1,12.0202], Tmin=(10,'K'), Tmax=(477.346,'K')), NASAPolynomial(coeffs=[6.99495,0.0342358,-2.40295e-05,7.98373e-09,-9.98563e-13,-56701.1,-6.58836], Tmin=(477.346,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-464.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""OC[C](F)CF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-510.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,333,384,448,608,1254,1480,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,180,180,180,180],'cm^-1')),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.63989,'amu*angstrom^2'), symmetry=1, barrier=(14.7123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276185,'amu*angstrom^2'), symmetry=1, barrier=(6.35003,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38842,0.0642801,-0.000111168,9.94613e-08,-3.42512e-11,-37563.2,21.0385], Tmin=(100,'K'), Tmax=(847.347,'K')), NASAPolynomial(coeffs=[7.92862,0.0203695,-1.03587e-05,1.99006e-09,-1.3638e-13,-38203.6,-6.66922], Tmin=(847.347,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFHO) + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-536.736,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.381862,'amu*angstrom^2'), symmetry=1, barrier=(8.77976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.38218,'amu*angstrom^2'), symmetry=1, barrier=(8.78707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.382533,'amu*angstrom^2'), symmetry=1, barrier=(8.79519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38217,'amu*angstrom^2'), symmetry=1, barrier=(31.7789,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.134033,0.102402,-0.000183389,1.65916e-07,-5.74362e-11,-64416.5,26.8369], Tmin=(100,'K'), Tmax=(846.266,'K')), NASAPolynomial(coeffs=[10.5014,0.0300181,-1.58925e-05,3.08908e-09,-2.126e-13,-65424.7,-18.0189], Tmin=(846.266,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-536.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sO2sCs)(F1s)(H))"""),
)
...
"""),
    E0 = (-541.898,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,539.704,549.016],'cm^-1')),
        HinderedRotor(inertia=(0.052188,'amu*angstrom^2'), symmetry=1, barrier=(11.3504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0833761,'amu*angstrom^2'), symmetry=1, barrier=(11.3572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.495449,'amu*angstrom^2'), symmetry=1, barrier=(11.3913,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88006,0.0483547,-4.54226e-05,2.32284e-08,-4.96046e-12,-65100.3,20.0978], Tmin=(100,'K'), Tmax=(1101.5,'K')), NASAPolynomial(coeffs=[8.97552,0.0225885,-1.0335e-05,1.99237e-09,-1.40709e-13,-66663.5,-14.8197], Tmin=(1101.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-541.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs)"""),
)

species(
    label = 'C=C(CO)OF(5784)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {11,S}
...
"""),
    E0 = (-368.762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,194,682,905,1196,1383,3221,180,1788.8],'cm^-1')),
        HinderedRotor(inertia=(0.157209,'amu*angstrom^2'), symmetry=1, barrier=(3.61455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159274,'amu*angstrom^2'), symmetry=1, barrier=(3.66203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157123,'amu*angstrom^2'), symmetry=1, barrier=(3.61257,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36577,0.065275,-0.000104036,9.56918e-08,-3.48019e-11,-44264.1,24.3586], Tmin=(100,'K'), Tmax=(816.705,'K')), NASAPolynomial(coeffs=[5.70023,0.0305075,-1.53148e-05,2.97279e-09,-2.06742e-13,-44520.5,7.08919], Tmin=(816.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-368.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OCC(F)(CF)OF(5401)'],
    products = ['HF(38)', 'CH2O(20)', 'O=C(F)CF(879)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['FCOF(367)', 'OC[C]F-2(5177)'],
    products = ['OCC(F)(CF)OF(5401)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OCOF(5576)', 'F[C]CF(126)'],
    products = ['OCC(F)(CF)OF(5401)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'OC(F)(CF)OF(5192)'],
    products = ['OCC(F)(CF)OF(5401)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'OCC(F)([C]F)OF(5774)'],
    products = ['OCC(F)(CF)OF(5401)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'OCC(F)OF(5390)'],
    products = ['OCC(F)(CF)OF(5401)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(25)', 'OCC(F)(F)OF(5395)'],
    products = ['OCC(F)(CF)OF(5401)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(156.175,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction10',
    reactants = ['OF(482)', 'OC=C(F)CF(790)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OF(482)', 'OCC(F)=CF(2606)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOF(488)', 'C=C(F)CO(5775)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OF(482)', 'C=C(CF)OF(5776)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OCF(781)', 'C=C(F)OF(3013)'],
    products = ['OCC(F)(CF)OF(5401)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(3.04532e-05,'m^3/(mol*s)'), n=2.636, Ea=(296.228,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Cd_Cd;R_OH] + [Cd/disub_Cd/unsub;R_OR] for rate rule [Cd/disub_Cd/unsub;R_OH]
Euclidian distance = 1.0
family: 1,3_Insertion_ROR"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'OC[C](CF)OF(5777)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]C(F)(CO)OF(5778)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[O]C(F)(CO)CF(5779)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(128)', 'OC[C](F)CF(5780)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OH(7)', '[CH2]C(F)(CF)OF(4130)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[O]CC(F)(CF)OF(5781)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2OH(33)', 'FC[C](F)OF(3020)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2F(46)', 'OC[C](F)OF(5596)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'O[CH]C(F)(CF)OF(5557)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', 'OCC(F)([CH]F)OF(5782)'],
    products = ['OCC(F)(CF)OF(5401)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F2(78)', 'O=C(CO)CF(5783)'],
    products = ['OCC(F)(CF)OF(5401)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(67.4009,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction26',
    reactants = ['F2(78)', 'C=C(CO)OF(5784)'],
    products = ['OCC(F)(CF)OF(5401)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(6.83744,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'OC=C(CF)OF(5563)'],
    products = ['OCC(F)(CF)OF(5401)'],
