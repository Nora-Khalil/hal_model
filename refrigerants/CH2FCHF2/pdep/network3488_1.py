...
reaction(
    label = 'reaction4',
    reactants = ['OH(7)', 'CF3(45)'],
    products = ['OC(F)(F)F(2678)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)F(2678)'],
    products = ['HF(38)', 'CF2O(49)'],
    transitionState = 'TS5',
