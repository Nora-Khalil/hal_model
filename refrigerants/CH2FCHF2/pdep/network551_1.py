...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.0752,'amu*angstrom^2'), symmetry=1, barrier=(24.721,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07216,'amu*angstrom^2'), symmetry=1, barrier=(24.6511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07345,'amu*angstrom^2'), symmetry=1, barrier=(24.6807,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.48909,0.0801669,-0.000106948,7.07068e-08,-1.83322e-11,-35580,25.4024], Tmin=(100,'K'), Tmax=(946.208,'K')), NASAPolynomial(coeffs=[15.0786,0.0184897,-9.17075e-06,1.81476e-09,-1.29693e-13,-38340.9,-44.1767], Tmin=(946.208,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCsF1sO2s) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    E0 = (-121.426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,167,640,1190,180,180,2267.22],'cm^-1')),
        HinderedRotor(inertia=(0.484696,'amu*angstrom^2'), symmetry=1, barrier=(11.1441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92613,'amu*angstrom^2'), symmetry=1, barrier=(44.2854,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44218,0.0626199,-9.83799e-05,8.86244e-08,-3.18972e-11,-14518.3,23.4527], Tmin=(100,'K'), Tmax=(800.902,'K')), NASAPolynomial(coeffs=[6.42329,0.027674,-1.40729e-05,2.75109e-09,-1.92377e-13,-14993.2,2.54363], Tmin=(800.902,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.13453,'amu*angstrom^2'), symmetry=1, barrier=(3.09311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134587,'amu*angstrom^2'), symmetry=1, barrier=(3.09442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.954963,0.0763708,-0.000134042,1.24871e-07,-4.48795e-11,-34573.6,25.9713], Tmin=(100,'K'), Tmax=(831.284,'K')), NASAPolynomial(coeffs=[6.96618,0.0290162,-1.53383e-05,3.00468e-09,-2.08739e-13,-34936.2,1.9115], Tmin=(831.284,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.09649,'amu*angstrom^2'), symmetry=1, barrier=(25.2105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09764,'amu*angstrom^2'), symmetry=1, barrier=(25.2369,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.749672,0.0743082,-9.76227e-05,6.21878e-08,-1.5509e-11,-33713.5,22.422], Tmin=(100,'K'), Tmax=(982.143,'K')), NASAPolynomial(coeffs=[15.0588,0.0160298,-8.61365e-06,1.76821e-09,-1.29116e-13,-36524.1,-46.3531], Tmin=(982.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(CtCF) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.14148,'amu*angstrom^2'), symmetry=1, barrier=(26.245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14164,'amu*angstrom^2'), symmetry=1, barrier=(26.2486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14306,'amu*angstrom^2'), symmetry=1, barrier=(26.2813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.517364,0.0783778,-0.000100102,6.28224e-08,-1.54361e-11,-29255,25.0297], Tmin=(100,'K'), Tmax=(997.537,'K')), NASAPolynomial(coeffs=[15.678,0.0175842,-8.68463e-06,1.72595e-09,-1.2402e-13,-32279.6,-48.0741], Tmin=(997.537,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-Cs)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)

species(
    label = 'F[CH][C](F)OC=CF(3119)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.413107,0.0804719,-0.00010475,6.65896e-08,-1.65047e-11,-42831.1,25.6611], Tmin=(100,'K'), Tmax=(991.173,'K')), NASAPolynomial(coeffs=[16.2315,0.0166349,-8.14255e-06,1.61098e-09,-1.1547e-13,-45966.8,-50.5135], Tmin=(991.173,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-357.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(284)', 'F[C]CF-2(3008)'],
    products = ['F[C]=CO[C](F)CF(3038)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)OC=[C]F(3114)'],
    products = ['F[C]=CO[C](F)CF(3038)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]=COC(F)=CF(3115)'],
    products = ['F[C]=CO[C](F)CF(3038)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC#CO[C](F)CF(3116)'],
    products = ['F[C]=CO[C](F)CF(3038)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]=CO[C](F)CF(3038)'],
    products = ['[CH2]C(F)(F)OC=[C]F(1761)'],
