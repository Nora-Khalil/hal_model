...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[C]=O(538)'],
    products = ['[CH2]C(F)(F)O[C]=O(353)'],
    transitionState = 'TS7',
