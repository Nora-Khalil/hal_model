...
"""),
    E0 = (-696.537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,3615,1277.5,1000,180,233,1109,1254,1325,1339,3290,395,473,707,1436,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.97722,'amu*angstrom^2'), symmetry=1, barrier=(22.4682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.983904,'amu*angstrom^2'), symmetry=1, barrier=(22.6219,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40846,0.061204,-9.26789e-05,6.82688e-08,-1.96691e-11,-35062.5,17.4032], Tmin=(100,'K'), Tmax=(853.522,'K')), NASAPolynomial(coeffs=[11.7904,0.01255,-7.17431e-06,1.48406e-09,-1.07841e-13,-36834.8,-31.0395], Tmin=(853.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-O2d)O2s) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-O2d(Cds-Cds)H) + radical(C=CCJ=O)"""),
)

species(
    label = 'OC([CH]F)=C(OF)OF(11347)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-264.285,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,175,287,726,856,325,375,415,465,420,450,1700,1750,234,589,736,816,1240,3237,252.933,253.528],'cm^-1')),
        HinderedRotor(inertia=(0.177678,'amu*angstrom^2'), symmetry=1, barrier=(8.07754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00262304,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.629305,'amu*angstrom^2'), symmetry=1, barrier=(28.6448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.92886,'amu*angstrom^2'), symmetry=1, barrier=(42.3761,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
...
species(
    label = 'O=C(OF)C(O)(F)[C]F-2(11349)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.71906,'amu*angstrom^2'), symmetry=1, barrier=(39.5245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72094,'amu*angstrom^2'), symmetry=1, barrier=(39.5677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72106,'amu*angstrom^2'), symmetry=1, barrier=(39.5705,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.512377,0.0836436,-0.000123665,9.27515e-08,-2.77398e-11,-64964.6,25.2164], Tmin=(100,'K'), Tmax=(816.926,'K')), NASAPolynomial(coeffs=[12.7799,0.0235789,-1.33816e-05,2.75568e-09,-1.99827e-13,-66969,-31.4873], Tmin=(816.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-541.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CsCCl_triplet)"""),
)

species(
    label = 'OC1(F)[C](OF)OC1F(11350)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.821171,0.0759559,-0.000115052,9.06119e-08,-2.85166e-11,-38539.9,28.1457], Tmin=(100,'K'), Tmax=(777.583,'K')), NASAPolynomial(coeffs=[11.1805,0.022664,-1.22453e-05,2.46712e-09,-1.76335e-13,-40150.9,-19.2258], Tmin=(777.583,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-321.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(C2CsJOH) + radical(CsCsF1sH)"""),
)

species(
    label = '[O]C(=O)C(O)(F)[CH]F(4338)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {10,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.877537,0.077539,-0.000132697,1.2325e-07,-4.49402e-11,-75098.7,24.9416], Tmin=(100,'K'), Tmax=(802.005,'K')), NASAPolynomial(coeffs=[7.25128,0.0306355,-1.67042e-05,3.33231e-09,-2.34819e-13,-75634.9,-1.37126], Tmin=(802.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-625.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (-425.327,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,334,575,1197,1424,3202,1855,455,950,180],'cm^-1')),
        HinderedRotor(inertia=(1.0785,'amu*angstrom^2'), symmetry=1, barrier=(24.7968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0783,'amu*angstrom^2'), symmetry=1, barrier=(24.7921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07432,'amu*angstrom^2'), symmetry=1, barrier=(24.7008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.909915,0.0732392,-0.000122536,1.02112e-07,-3.30156e-11,-51048.8,24.1727], Tmin=(100,'K'), Tmax=(828.951,'K')), NASAPolynomial(coeffs=[11.5583,0.015958,-8.21129e-06,1.58467e-09,-1.08995e-13,-52611.6,-23.9797], Tmin=(828.951,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(CsCsF1sH) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3842.27,'J/mol'), sigma=(5.96431,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=600.15 K, Pc=41.09 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)C(O)(F)[CH]F(5683)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)C(F)[C](O)F(11324)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(488)', 'O=[C]C(O)=CF(11346)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OC([CH]F)=C(OF)OF(11347)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.7779e+11,'s^-1'), n=0.725184, Ea=(129.57,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(OF)C(O)(F)[CH]F(5683)'],
    products = ['OH(7)', 'O=C(OF)C(F)=CF(5453)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(4.62709e+20,'s^-1'), n=-1.9758, Ea=(385.087,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]C(O)(F)C(=O)OF(11348)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]F(137)', 'O=C(OF)[C](O)F(5608)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(OF)C(O)(F)[C]F-2(11349)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C(OF)C(O)(F)[CH]F(5683)'],
    products = ['OC1(F)[C](OF)OC1F(11350)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(OF)C(O)(F)[CH]F(5683)'],
    products = ['[O]C1(OF)C(F)C1(O)F(11351)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(OF)C(O)=CF(5686)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(34.5221,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction13',
    reactants = ['O=[C]OF(340)', 'OC(F)=CF(878)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(153.031,'m^3/(mol*s)'), n=1.16366, Ea=(13.1968,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H"""),
)

reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=C(OF)[C](O)[CH]F(11352)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C(=O)C(O)(F)[CH]F(4338)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'O=C(OF)[C](F)[CH]F(4152)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(128)', 'O=[C]C(O)(F)[CH]F(11353)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]OF(340)', 'O[C](F)[CH]F(881)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(159.399,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction21',
    reactants = ['CHF(40)', 'O=C(OF)[C](O)F(5608)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=C(OF)C(O)(F)[C]F(5668)'],
    products = ['O=C(OF)C(O)(F)[CH]F(5683)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(74.7069,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(170.892,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

network(
    label = 'PDepNetwork #2936',
    isomers = [
        'O=C(OF)C(O)(F)[CH]F(5683)',
    ],
    reactants = [
