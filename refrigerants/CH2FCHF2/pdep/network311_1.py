...
species(
    label = '[O][CH]C1(F)CC(F)(F)O1(1749)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(284)', '[CH2]C([O])(F)F(218)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=C[C](F)O[C](F)F(1741)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
    products = ['O=CC1(F)CC(F)(F)O1(1578)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
    products = ['[O]C1CC(F)(F)O[C]1F(1730)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)O[C](F)C=O(1743)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)OC(F)=C=O(1744)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C[C]F-2(1596)', '[CH2]C([O])(F)F(218)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
    products = ['CC(F)(F)O[C](F)[C]=O(1746)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C](F)OC(F)(F)C=O(1747)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(6)', '[CH]=C(F)OC([CH2])(F)F(1748)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
    products = ['[O][CH]C1(F)CC(F)(F)O1(1749)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(F)(F)OC(F)=[C]O(1751)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=C(F)O[C](F)[CH]OF(1752)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(F)(F)O[C]=COF(1753)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C=[C]OC(F)(F)CF(1754)'],
    products = ['[CH2]C(F)(F)O[C](F)C=O(1570)'],
