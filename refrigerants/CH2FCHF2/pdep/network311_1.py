...
reaction(
    label = 'reaction2',
    reactants = ['O=C=C(F)[C-][O+]=O(2030)'],
    products = ['[C-]=[O+]OC(F)=C=O(1688)'],
    transitionState = 'TS2',
