...
reaction(
    label = 'reaction3',
    reactants = ['O[C](F)OC(F)[CH]F(4537)'],
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O[CH]OC(F)=CF(4538)'],
    products = ['OC(F)OC(F)=CF(3317)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'OC(F)O[C]=CF(4539)'],
    products = ['OC(F)OC(F)=CF(3317)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.52887e+10,'m^3/(mol*s)'), n=-0.421056, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.030895812897821735, var=3.1393582276389975, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=C(F)OC(O)F(4540)'],
    products = ['OC(F)OC(F)=CF(3317)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(O)F(1205)', 'CHFCF[Z](72)'],
    products = ['OC(F)OC(F)=CF(3317)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O[C](F)OC(F)=CF(4262)'],
    products = ['OC(F)OC(F)=CF(3317)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'OC(F)OC(F)=[C]F(4541)'],
    products = ['OC(F)OC(F)=CF(3317)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C(F)(F)OC(O)F(4543)'],
    products = ['OC(F)OC(F)=CF(3317)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', 'C#COC(O)F(4545)'],
    products = ['OC(F)OC(F)=CF(3317)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'OC(F)OC#CF(4546)'],
    products = ['OC(F)OC(F)=CF(3317)'],
...
reaction(
    label = 'reaction22',
    reactants = ['OC(F)OC(F)=CF(3317)'],
    products = ['HF(38)', 'CHFO(47)', 'O=C=CF(3028)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', 'OC(F)[O+]=[C-]F(4547)'],
    products = ['OC(F)OC(F)=CF(3317)'],
