...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C(F)[CH]F(2679)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[O]C(F)(F)[CH]F(2700)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]C(F)[C](F)F(171)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)C=CF(2702)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(2694)', 'CHFCHF[Z](59)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C(F)=CF(2703)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C(F)[CH]F(398)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(2694)', 'F[CH][CH]F(141)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'O=C(F)[CH][CH]F(401)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)[C](F)[CH]F(2704)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[O]C(F)(F)[CH]F(2700)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][CH]C(F)(F)OF(2707)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(F)C(F)[CH]F(2679)'],
    products = ['[O]C(F)(F)[CH]C(F)F(2708)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)[C](F)OF(2709)'],
    products = ['[O]C(F)(F)C(F)[CH]F(2679)'],
...
network(
    label = 'PDepNetwork #445',
    isomers = [
        '[O]C(F)(F)C(F)[CH]F(2679)',
    ],
    reactants = [
        ('CF2O(49)', 'CHFCHF[Z](59)'),
    ],
