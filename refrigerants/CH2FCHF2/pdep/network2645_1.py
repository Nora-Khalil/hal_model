...
species(
    label = '[CH]=C=C([CH]F)C(F)(F)F(10142)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
species(
    label = '[CH]=C(F)[C]1C(F)C1(F)F(10144)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.888062,0.0617255,-5.84029e-05,2.7218e-08,-4.98148e-12,-32422.5,24.4326], Tmin=(100,'K'), Tmax=(1325.87,'K')), NASAPolynomial(coeffs=[16.0102,0.0161034,-6.78892e-06,1.26565e-09,-8.79906e-14,-36432.5,-52.7886], Tmin=(1325.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-270.554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCsCsFH) + group(CsCsCsFF) + group(CdCsCdF) + group(Cds-CdsHH) + ring(Cs-Cs(F)(F)-Cs) + radical(Allyl_T) + radical(Cdj(Cd-CsF1s)(H)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[CH]C1=C(F)[CH]C1(F)F(10145)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[CH]=C(F)C(=[C]F)C(F)F(10149)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH]=C(F)C(=[CH])C(F)(F)F(10153)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
    products = ['[CH]=C=C([CH]F)C(F)(F)F(10142)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', '[CH]C(F)=C=C(F)F(10143)'],
    products = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
    products = ['[CH]=C(F)[C]1C(F)C1(F)F(10144)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
    products = ['F[CH]C1=C(F)[CH]C1(F)F(10145)'],
    transitionState = 'TS7',
...
reaction(
    ...
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.54e+10,'s^-1'), n=0.69, Ea=(141,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_D_D;doublebond_intra;radadd_intra_cdsingleH]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 140.9 to 141.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C#CC([CH]F)=C(F)F(10147)'],
    products = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH]C(F)=C=C(F)F(10143)'],
    products = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
    products = ['C#C[C]([C](F)F)C(F)F(7312)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C(=[C]F)C(F)F(10149)'],
    products = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]C(=CF)C(F)=CF(10150)'],
    products = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
    products = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C]F(156)', '[CH]C(F)=C=CF(311)'],
    products = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
    products = ['FC=C1C(F)=CC1(F)F(10057)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
    products = ['F[C](F)[C]1C(F)=CC1F(10151)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CF2(43)', '[CH]C(F)=C=CF(311)'],
    products = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
    products = ['C=C(F)C([C]F)=C(F)F(10152)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C(F)C(=[CH])C(F)(F)F(10153)'],
    products = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=C(F)C([CH]F)=C(F)F(7311)'],
    products = ['[CH]C(C(F)=CF)=C(F)F(10154)'],
...
network(
    label = 'PDepNetwork #2645',
    isomers = [
        '[CH]=C(F)C([CH]F)=C(F)F(7311)',
    ],
    reactants = [
