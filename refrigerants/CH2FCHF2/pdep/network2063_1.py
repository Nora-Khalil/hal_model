...
"""),
    E0 = (-1024.21,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,235,523,627,1123,1142,1372,1406,3097,181.32,182.017,182.384,182.794],'cm^-1')),
        HinderedRotor(inertia=(0.439379,'amu*angstrom^2'), symmetry=1, barrier=(10.3274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.43824,'amu*angstrom^2'), symmetry=1, barrier=(10.3264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961336,'amu*angstrom^2'), symmetry=1, barrier=(22.6662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0051024,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.963998,'amu*angstrom^2'), symmetry=1, barrier=(22.1642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.964038,'amu*angstrom^2'), symmetry=1, barrier=(22.1651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.96396,'amu*angstrom^2'), symmetry=1, barrier=(22.1633,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-592.476,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,193.62,195.085],'cm^-1')),
        HinderedRotor(inertia=(0.176298,'amu*angstrom^2'), symmetry=1, barrier=(4.72964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177638,'amu*angstrom^2'), symmetry=1, barrier=(4.73547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.596767,'amu*angstrom^2'), symmetry=1, barrier=(15.9279,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.066,'amu'),
...
"""),
    E0 = (-436.216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,617,898,1187,207.285,207.285,207.285],'cm^-1')),
        HinderedRotor(inertia=(0.220889,'amu*angstrom^2'), symmetry=1, barrier=(6.73502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22089,'amu*angstrom^2'), symmetry=1, barrier=(6.73502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220889,'amu*angstrom^2'), symmetry=1, barrier=(6.73502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.809528,'amu*angstrom^2'), symmetry=1, barrier=(24.6829,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.13593,0.0995458,-0.000161789,1.39782e-07,-4.7697e-11,-52324,29.226], Tmin=(100,'K'), Tmax=(804.351,'K')), NASAPolynomial(coeffs=[11.3061,0.0321665,-1.65952e-05,3.24566e-09,-2.26404e-13,-53825.7,-21.3772], Tmin=(804.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-436.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.893762,'amu*angstrom^2'), symmetry=1, barrier=(20.5494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.893099,'amu*angstrom^2'), symmetry=1, barrier=(20.5341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.893265,'amu*angstrom^2'), symmetry=1, barrier=(20.5379,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.057,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(2912.39,'J/mol'), sigma=(5.1984,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=454.91 K, Pc=47.04 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (164.074,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3143.48,'J/mol'), sigma=(5.33728,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=491.00 K, Pc=46.91 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-601.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,235,523,627,1123,1142,1372,1406,3097,212,367,445,1450,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.139712,'amu*angstrom^2'), symmetry=1, barrier=(3.21226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139607,'amu*angstrom^2'), symmetry=1, barrier=(3.20983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139262,'amu*angstrom^2'), symmetry=1, barrier=(3.20192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.745834,'amu*angstrom^2'), symmetry=1, barrier=(17.1482,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.182852,0.102654,-0.000170377,1.53307e-07,-5.40909e-11,-72236.5,31.1227], Tmin=(100,'K'), Tmax=(819.041,'K')), NASAPolynomial(coeffs=[9.26365,0.0384817,-1.98161e-05,3.86704e-09,-2.69044e-13,-73178.9,-8.87196], Tmin=(819.041,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-601.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CsCsCsF1s)"""),
)

species(
    label = 'F[CH]CC(F)(F)COF(7776)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-610.598,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,334,575,1197,1424,3202,194.939,194.951,194.954,4000],'cm^-1')),
        HinderedRotor(inertia=(1.13041,'amu*angstrom^2'), symmetry=1, barrier=(30.4856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.359723,'amu*angstrom^2'), symmetry=1, barrier=(9.70152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.359714,'amu*angstrom^2'), symmetry=1, barrier=(9.70152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13036,'amu*angstrom^2'), symmetry=1, barrier=(30.4857,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.416255,0.107287,-0.000177486,1.56469e-07,-5.41764e-11,-73288.7,30.0618], Tmin=(100,'K'), Tmax=(814.766,'K')), NASAPolynomial(coeffs=[10.9439,0.0362937,-1.87627e-05,3.66617e-09,-2.55257e-13,-74634.6,-19.3165], Tmin=(814.766,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-610.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[O]CC(F)(F)CC(F)F(7777)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-933.012,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,222,329,445,522,589,1214,1475,235,523,627,1123,1142,1372,1406,3097,180,180,180,1329.87],'cm^-1')),
        HinderedRotor(inertia=(0.281166,'amu*angstrom^2'), symmetry=1, barrier=(6.46456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.281134,'amu*angstrom^2'), symmetry=1, barrier=(6.46382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.281265,'amu*angstrom^2'), symmetry=1, barrier=(6.46684,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0324888,0.0991116,-0.000166666,1.55512e-07,-5.67154e-11,-112084,28.7851], Tmin=(100,'K'), Tmax=(818.166,'K')), NASAPolynomial(coeffs=[6.98264,0.0427322,-2.22338e-05,4.36101e-09,-3.04366e-13,-112472,1.23118], Tmin=(818.166,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-933.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-793.367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.381051,'amu*angstrom^2'), symmetry=1, barrier=(8.76111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.381088,'amu*angstrom^2'), symmetry=1, barrier=(8.76197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.654759,'amu*angstrom^2'), symmetry=1, barrier=(15.0542,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.60463,0.0300465,0.00020817,-6.84807e-07,6.08311e-10,-95419.7,13.7783], Tmin=(10,'K'), Tmax=(411.331,'K')), NASAPolynomial(coeffs=[7.5914,0.0433919,-3.05443e-05,1.01112e-08,-1.25838e-12,-96188.5,-7.273], Tmin=(411.331,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-793.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), label="""[CH2]C(F)(F)CC(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-816.605,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.189601,'amu*angstrom^2'), symmetry=1, barrier=(4.3593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188577,'amu*angstrom^2'), symmetry=1, barrier=(4.33577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19026,'amu*angstrom^2'), symmetry=1, barrier=(4.37445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01135,'amu*angstrom^2'), symmetry=1, barrier=(23.2529,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.547891,0.109712,-0.000178814,1.55663e-07,-5.37456e-11,-98060.4,33.2778], Tmin=(100,'K'), Tmax=(790.6,'K')), NASAPolynomial(coeffs=[11.8223,0.0363447,-1.91593e-05,3.78728e-09,-2.66058e-13,-99679.4,-21.3639], Tmin=(790.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-816.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H))"""),
)
...
"""),
    E0 = (-823.668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,222,329,445,522,589,1214,1475,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,190,488,555,1236,1407,200.955,200.959,200.96,200.963],'cm^-1')),
        HinderedRotor(inertia=(0.170178,'amu*angstrom^2'), symmetry=1, barrier=(4.87707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170187,'amu*angstrom^2'), symmetry=1, barrier=(4.8772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170185,'amu*angstrom^2'), symmetry=1, barrier=(4.87732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.713572,'amu*angstrom^2'), symmetry=1, barrier=(20.4494,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (163.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.742481,0.116829,-0.000202798,1.8333e-07,-6.42652e-11,-98905.7,32.2394], Tmin=(100,'K'), Tmax=(825.893,'K')), NASAPolynomial(coeffs=[10.9723,0.038229,-2.03369e-05,3.99477e-09,-2.77991e-13,-100095,-17.5228], Tmin=(825.893,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-823.668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'FOCC(F)=CC(F)F(7781)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FOCC(F)(F)CC(F)F(4122)'],
    products = ['HF(38)', 'CH2O(20)', 'FC(F)=CC(F)F(2834)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(68.5616,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FOCCC(F)F(2797)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(334.762,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)
...
reaction(
    ...
    products = ['FOCC(F)(F)CC(F)F(4122)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(180.55,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F[C]COF(2842)', 'CH2FCHF2(1)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(167.652,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FOCC(F)(F)C(F)F(7773)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.000166864,'m^3/(mol*s)'), n=2.82973, Ea=(144.181,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s"""),
)
...
reaction(
    ...
    products = ['FOCC(F)(F)CC(F)F(4122)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(66.0766,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CF2(43)', 'CC(F)(F)COF(2798)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.00405e-10,'m^3/(mol*s)'), n=4.72997, Ea=(130.328,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'F[C]CC(F)(F)COF(7774)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'FCC(F)(F)COF(5406)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(135.994,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FOC[C](F)CC(F)F(7775)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[CH]CC(F)(F)COF(7776)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]CC(F)(F)CC(F)F(7777)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(128)', '[CH2]C(F)(F)CC(F)F(3505)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FOC[C](F)F(2864)', 'CHF2-CH2(64)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R
Ea raised from -14.8 to 0.0 kJ/mol."""),
)

reaction(
    label = 'reaction17',
    reactants = ['[CH2]OF(2545)', 'F[C](F)CC(F)F(2837)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF2(82)', '[CH2]C(F)(F)COF(2865)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FOCC(F)(F)[CH]C(F)F(7778)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'FO[CH]C(F)(F)CC(F)F(7779)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'FOCC(F)(F)C[C](F)F(7780)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'FOCC(F)=CC(F)F(7781)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(181.962,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'FC=CC(F)(F)COF(7782)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=CC(F)(F)CC(F)F(7562)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'FOC=C(F)CC(F)F(7783)'],
    products = ['FOCC(F)(F)CC(F)F(4122)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(185.524,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

network(
    label = 'PDepNetwork #2063',
    isomers = [
        'FOCC(F)(F)CC(F)F(4122)',
    ],
    reactants = [
        ('HF(38)', 'CH2O(20)', 'FC(F)=CC(F)F(2834)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
