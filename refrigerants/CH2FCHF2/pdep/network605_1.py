...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(2711)', 'F[C]CF-2(3008)'],
    products = ['[O]C(F)(F)O[C](F)CF(3310)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)OC([O])(F)F(3410)'],
    products = ['[O]C(F)(F)O[C](F)CF(3310)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)O[C](F)CF(3266)'],
    products = ['[O]C(F)(F)O[C](F)CF(3310)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C([O])(F)F(2711)', 'F[C]CF(126)'],
    products = ['[O]C(F)(F)O[C](F)CF(3310)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)(F)O[C](F)CF(3310)'],
    products = ['OC(F)(F)O[C](F)[CH]F(3413)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C](F)OC(F)(F)OF(3414)'],
    products = ['[O]C(F)(F)O[C](F)CF(3310)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)(F)O[C](F)CF(3310)'],
    products = ['[CH2]C(F)(F)OC([O])(F)F(3415)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC[C](F)O[C](F)OF(3416)'],
    products = ['[O]C(F)(F)O[C](F)CF(3310)'],
