...
reaction(
    label = 'reaction2',
    reactants = ['[O]OC(F)(F)F(3472)', 'CH2(S)(25)'],
    products = ['[O]OCC(F)(F)F(3466)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]O[CH]C(F)(F)F(3474)'],
    products = ['[O]OCC(F)(F)F(3466)'],
    transitionState = 'TS8',
