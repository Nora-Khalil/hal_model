...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]F(373)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[CH2]C([O])(F)F(218)'],
    products = ['[CH2]C(F)(F)O[CH]F(373)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]O[C](F)F(426)'],
    products = ['[CH2]C(F)(F)O[CH]F(373)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)O[CH]F(427)'],
    products = ['[CH2]C(F)(F)O[CH]F(373)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[CH2]C([O])(F)F(218)'],
    products = ['[CH2]C(F)(F)O[CH]F(373)'],
    transitionState = 'TS9',
