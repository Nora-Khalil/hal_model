...
"""),
    E0 = (-137.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([526,555,698,907,1200,1145,1227,2950,1000,180,180,180,325.741,1152.69,1154.68,1156.48,4000],'cm^-1')),
...
"""),
    E0 = (-73.8068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,611,648,830,1210,1753,508.224,510.153,511.566,512.149,513.252,514.908,515.012],'cm^-1')),
        HinderedRotor(inertia=(0.000640238,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0371,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60944,0.0396542,-4.38329e-05,2.36896e-08,-4.60073e-12,-8779.68,22.0609], Tmin=(100,'K'), Tmax=(1571.68,'K')), NASAPolynomial(coeffs=[10.7201,0.00422406,1.66619e-06,-5.6636e-10,4.5953e-14,-10131.3,-21.2013], Tmin=(1571.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.8068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsOsHH) + group(COCsFO) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCsJO)"""),
)

species(
    label = 'FOC(F)(F)[C]1[CH]O1(8537)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-222.555,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,2950,1000,310.236,310.236,310.236,310.236,310.237,310.237,310.237,1738.11],'cm^-1')),
        HinderedRotor(inertia=(0.0176735,'amu*angstrom^2'), symmetry=1, barrier=(37.888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00175152,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31949,0.0640856,-8.92757e-05,6.44762e-08,-1.87198e-11,-26675.1,23.6093], Tmin=(100,'K'), Tmax=(838.387,'K')), NASAPolynomial(coeffs=[10.4882,0.0203414,-1.10107e-05,2.24167e-09,-1.61998e-13,-28212.5,-19.008], Tmin=(838.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-222.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCFFO) + ring(Cs(C-FF)-Cs-O2s) + radical(C2CsJO) + radical(CCsJO)"""),
)

species(
    label = '[O]C(F)(F)[C]1OC1F(8520)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {7,S}
...
"""),
    E0 = (-156.509,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,2950,1000,395,473,707,1436,180,180,180,824.412,825.045],'cm^-1')),
        HinderedRotor(inertia=(0.142659,'amu*angstrom^2'), symmetry=1, barrier=(3.28001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00683315,'amu*angstrom^2'), symmetry=1, barrier=(3.31604,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16983,0.0675315,-0.000103646,8.38949e-08,-2.71889e-11,-18726.7,24.3983], Tmin=(100,'K'), Tmax=(755.463,'K')), NASAPolynomial(coeffs=[9.97359,0.020916,-1.1086e-05,2.21117e-09,-1.5691e-13,-20056.9,-15.6057], Tmin=(755.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCCFO) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(Cs(F)(C)-Cs-O2s) + radical(Csj(Cs-F1sO2sCs)(O2s-Cs)(H)_ring) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O][C](F)C1(F)OC1F(8539)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
    products = ['CF2O(49)', 'FC1=CO1(286)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
    products = ['[O]C1(F)O[CH]C1(F)F(8533)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
    products = ['[O]C(F)(F)C1O[C]1F(8470)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C1(F)[CH]O1(8525)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C=C(F)C([O])(F)F(6441)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)(F)C1=CO1(8534)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(2580)', 'FC1=CO1(286)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C1(F)[CH]O1(8535)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2O(49)', 'F[C]1[CH]O1(8491)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(2580)', 'F[C]1[CH]O1(8491)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'O=C(F)[C]1[CH]O1(8536)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FOC(F)(F)[C]1[CH]O1(8537)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)C1(F)[CH]O1(8538)'],
    products = ['[O]C(F)(F)C1(F)[CH]O1(8469)'],
