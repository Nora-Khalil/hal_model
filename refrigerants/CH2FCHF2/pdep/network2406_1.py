...
"""),
    E0 = (-1318.9,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,431,527,613,668,835,1199,1245,1322,190,488,555,1236,1407,259.945,259.945,259.946,1400.53],'cm^-1')),
        HinderedRotor(inertia=(0.129624,'amu*angstrom^2'), symmetry=1, barrier=(6.21572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129631,'amu*angstrom^2'), symmetry=1, barrier=(6.21582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129628,'amu*angstrom^2'), symmetry=1, barrier=(6.21578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129631,'amu*angstrom^2'), symmetry=1, barrier=(6.21587,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.009833,0.097212,-0.000165666,1.4718e-07,-5.1125e-11,-158493,33.0604], Tmin=(100,'K'), Tmax=(811.355,'K')), NASAPolynomial(coeffs=[10.7263,0.0304016,-1.63079e-05,3.22383e-09,-2.25597e-13,-159772,-13.5648], Tmin=(811.355,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1318.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFFO) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-1174.43,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,180,441.618,3734.24],'cm^-1')),
        HinderedRotor(inertia=(1.74786,'amu*angstrom^2'), symmetry=1, barrier=(40.1866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.833347,'amu*angstrom^2'), symmetry=1, barrier=(19.1603,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-1342.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,431,527,613,668,835,1199,1245,1322,350,440,435,1725,182,240,577,636,1210,1413,299.665,299.665,299.666],'cm^-1')),
        HinderedRotor(inertia=(0.197369,'amu*angstrom^2'), symmetry=1, barrier=(12.577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197368,'amu*angstrom^2'), symmetry=1, barrier=(12.577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283689,'amu*angstrom^2'), symmetry=1, barrier=(18.0777,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00563473,0.0910515,-0.000128833,8.79303e-08,-2.32768e-11,-161339,26.7187], Tmin=(100,'K'), Tmax=(931.353,'K')), NASAPolynomial(coeffs=[17.4298,0.0162173,-8.30751e-06,1.65709e-09,-1.18681e-13,-164585,-56.1037], Tmin=(931.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1342.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFFO) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'OC(O[C](F)F)[C](F)F(9177)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-873.742,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,190,488,555,1236,1407,493,600,700,1144,1293,180,180,180,1479.52],'cm^-1')),
        HinderedRotor(inertia=(0.217725,'amu*angstrom^2'), symmetry=1, barrier=(5.00594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217503,'amu*angstrom^2'), symmetry=1, barrier=(5.00082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214431,'amu*angstrom^2'), symmetry=1, barrier=(4.9302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215702,'amu*angstrom^2'), symmetry=1, barrier=(4.95942,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.290622,0.0945766,-0.00017774,1.68165e-07,-6.02642e-11,-104966,32.5779], Tmin=(100,'K'), Tmax=(845.054,'K')), NASAPolynomial(coeffs=[7.89099,0.0313688,-1.72064e-05,3.3856e-09,-2.34395e-13,-105278,2.94325], Tmin=(845.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-873.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFHO) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-952.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,3025,407.5,1350,352.5,190,488,555,1236,1407,180,180,759.68,761.047],'cm^-1')),
        HinderedRotor(inertia=(0.176784,'amu*angstrom^2'), symmetry=1, barrier=(4.06461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177984,'amu*angstrom^2'), symmetry=1, barrier=(4.09219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176989,'amu*angstrom^2'), symmetry=1, barrier=(4.06933,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70652,0.0791689,-0.00012972,1.11729e-07,-3.82796e-11,-114443,29.3089], Tmin=(100,'K'), Tmax=(757.025,'K')), NASAPolynomial(coeffs=[10.5224,0.0237424,-1.28392e-05,2.58592e-09,-1.83988e-13,-115828,-14.6407], Tmin=(757.025,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-952.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = '[O]C(OC(F)(F)F)[C](F)F(9178)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1113.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,431,527,613,668,835,1199,1245,1322,360,370,350,190,488,555,1236,1407,196.355,196.895,1336.98,1337.47],'cm^-1')),
        HinderedRotor(inertia=(0.240353,'amu*angstrom^2'), symmetry=1, barrier=(6.6261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240098,'amu*angstrom^2'), symmetry=1, barrier=(6.62273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240164,'amu*angstrom^2'), symmetry=1, barrier=(6.62532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238892,'amu*angstrom^2'), symmetry=1, barrier=(6.62573,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0259573,0.0981973,-0.000176987,1.60482e-07,-5.59371e-11,-133809,33.6901], Tmin=(100,'K'), Tmax=(831.205,'K')), NASAPolynomial(coeffs=[10.6353,0.0279042,-1.54193e-05,3.0523e-09,-2.12555e-13,-134908,-11.5349], Tmin=(831.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1113.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFFO) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'OC([C]F)OC(F)(F)F-2(9180)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1321.28,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,522,611,926,1093,1137,1374,1416,3112,431,527,613,668,835,1199,1245,1322,360,370,350,277.396,277.402,277.402,277.403],'cm^-1')),
        HinderedRotor(inertia=(0.0992728,'amu*angstrom^2'), symmetry=1, barrier=(5.42089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0992712,'amu*angstrom^2'), symmetry=1, barrier=(5.4209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0992709,'amu*angstrom^2'), symmetry=1, barrier=(5.42089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16386,'amu*angstrom^2'), symmetry=1, barrier=(8.94791,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0576118,0.0940918,-0.000147582,1.20499e-07,-3.91951e-11,-158778,32.0766], Tmin=(100,'K'), Tmax=(753.858,'K')), NASAPolynomial(coeffs=[12.6521,0.0272687,-1.46276e-05,2.92881e-09,-2.08056e-13,-160677,-25.1268], Tmin=(753.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1321.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFFO) + radical(Cs_P)"""),
)

species(
    label = '[O]C(OC(F)(F)F)C(F)F(9181)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.264178,0.0921856,-0.000155869,1.4328e-07,-5.19483e-11,-156328,31.4968], Tmin=(100,'K'), Tmax=(795.297,'K')), NASAPolynomial(coeffs=[8.37402,0.0356,-1.93495e-05,3.86602e-09,-2.72955e-13,-157118,-2.63027], Tmin=(795.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1300.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFFFO) + radical(CCOJ)"""),
)

species(
    label = 'OC(O[C](F)F)C(F)(F)F(9182)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1316.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,493,600,700,1144,1293,270.9,270.9,270.901,1136.23],'cm^-1')),
        HinderedRotor(inertia=(0.118575,'amu*angstrom^2'), symmetry=1, barrier=(6.17498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118574,'amu*angstrom^2'), symmetry=1, barrier=(6.17498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118573,'amu*angstrom^2'), symmetry=1, barrier=(6.17498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118574,'amu*angstrom^2'), symmetry=1, barrier=(6.17498,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['OC(OC(F)(F)F)[C](F)F(8999)'],
...
reaction(
    ...
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'OC([C]F)OC(F)(F)F(9174)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', 'O[CH]OC(F)(F)F(6022)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF3O(48)', 'OC=C(F)F(3558)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(7)', 'FC(F)=COC(F)(F)F(9175)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'OC(OC(F)(F)F)=C(F)F(9176)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'OC(O[C](F)F)[C](F)F(9177)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF3O(48)', 'O[CH][C](F)F(3554)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF3(45)', '[O]C(O)[C](F)F(4062)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'F[C](F)[CH]OC(F)(F)F(3797)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(OC(F)(F)F)[C](F)F(9178)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O[C](OC(F)(F)F)[C](F)F(9179)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'OC([C]F)OC(F)(F)F-2(9180)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', 'O[CH]OC(F)(F)F(6022)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](OC(F)(F)F)C(F)F(7952)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OC(OC(F)(F)F)[C](F)F(8999)'],
    products = ['[O]C(OC(F)(F)F)C(F)F(9181)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OC(O[C](F)F)C(F)(F)F(9182)'],
    products = ['OC(OC(F)(F)F)[C](F)F(8999)'],
