...
reaction(
    label = 'reaction4',
    reactants = ['O[C]1CO[C](F)O1(13228)'],
    products = ['C=C(O)OC(=O)F(6020)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C([O])OC(=O)F(13229)'],
    products = ['C=C(O)OC(=O)F(6020)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)OC([O])F(13230)'],
    products = ['C=C(O)OC(=O)F(6020)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=O)O[C](O)F(13232)'],
    products = ['C=C(O)OC(=O)F(6020)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(O)O[C](O)F(13233)'],
    products = ['C=C(O)OC(=O)F(6020)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2.1261e+09,'s^-1'), n=0.137, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;Y_rad;XH_Rrad] for rate rule [R5radEndo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)O[C]=O(13235)'],
    products = ['C=C(O)OC(=O)F(6020)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(=O)F(341)', 'C=[C]O(4375)'],
    products = ['C=C(O)OC(=O)F(6020)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'C=[C]OC(=O)F(6846)'],
    products = ['C=C(O)OC(=O)F(6020)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(=O)OC(=O)F(13236)'],
    products = ['C=C(O)OC(=O)F(6020)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)OC(=O)F(13237)'],
    products = ['C=C(O)OC(=O)F(6020)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C(O)OC(=O)F(6020)'],
    products = ['O=C(O)F(343)', 'C#CO(2953)'],
