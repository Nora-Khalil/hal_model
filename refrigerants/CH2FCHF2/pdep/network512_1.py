...
"""),
    E0 = (-167.187,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,353,444,1253,3145,2750,2850,1437.5,1250,1305,750,350,617,898,1187,264.036,264.285,264.394,264.648,264.963],'cm^-1')),
        HinderedRotor(inertia=(0.00149887,'amu*angstrom^2'), symmetry=1, barrier=(4.71445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00240938,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.665709,'amu*angstrom^2'), symmetry=1, barrier=(33.116,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24557,0.0659746,-0.000100592,8.49512e-08,-2.90861e-11,-20013.9,22.7214], Tmin=(100,'K'), Tmax=(748.562,'K')), NASAPolynomial(coeffs=[8.59814,0.0243818,-1.26301e-05,2.50099e-09,-1.76771e-13,-21050.1,-10.19], Tmin=(748.562,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(Cs-CsOsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-530.098,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,442,614,1089,1143,1126,1238,1254,1408,1339,1465,1463,1525,3023,3127,3088,3132,188.846,194.677,199.987],'cm^-1')),
        HinderedRotor(inertia=(0.132185,'amu*angstrom^2'), symmetry=1, barrier=(3.57201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.60758,'amu*angstrom^2'), symmetry=1, barrier=(17.2577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29484,'amu*angstrom^2'), symmetry=1, barrier=(31.4557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.066,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00260338,'amu*angstrom^2'), symmetry=1, barrier=(6.8484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.297814,'amu*angstrom^2'), symmetry=1, barrier=(6.84733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16692,'amu*angstrom^2'), symmetry=1, barrier=(26.8299,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-436.283,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,528,1116,1182,1331,1402,1494,3075,3110,2750,2850,1437.5,1250,1305,750,350,180,208.807,494.954],'cm^-1')),
        HinderedRotor(inertia=(0.409317,'amu*angstrom^2'), symmetry=1, barrier=(12.3776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.885006,'amu*angstrom^2'), symmetry=1, barrier=(26.3088,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.240319,'amu*angstrom^2'), symmetry=1, barrier=(5.5254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240437,'amu*angstrom^2'), symmetry=1, barrier=(5.52812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.78578,'amu*angstrom^2'), symmetry=1, barrier=(18.0666,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CH3F(39)', 'F[C]COF(2957)'],
    products = ['FCC(F)COF(2910)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)COF(2959)'],
    products = ['FCC(F)COF(2910)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(482)', 'C=C(F)CF(2961)'],
    products = ['FCC(F)COF(2910)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)COF(2964)'],
    products = ['FCC(F)COF(2910)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(128)', '[CH2]C(F)CF(2966)'],
    products = ['FCC(F)COF(2910)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(2659)', 'CH2F-CHF(66)'],
    products = ['FCC(F)COF(2910)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'F[CH]COF(2967)'],
    products = ['FCC(F)COF(2910)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'F[CH]C(F)COF(2969)'],
    products = ['FCC(F)COF(2910)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'C=C(F)COF(2971)'],
    products = ['FCC(F)COF(2910)'],
