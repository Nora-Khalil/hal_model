...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)CC[C](F)F(154)'],
    products = ['[CH2]C(F)(F)C[C](F)F(153)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C](F)CC=C(F)F(192)'],
    products = ['F[C](F)CC[C](F)F(154)'],
    transitionState = 'TS7',
