...
species(
    label = 'FC1C(F)C(F)(F)C1(F)F(3751)',
...
species(
    label = 'F[CH][C](F)C(F)(F)C(F)F(3768)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C(F)(F)[CH]F(3689)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'F[CH]C(F)(F)[C](F)F(3747)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(3689)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(F)(F)C(F)(F)[CH]F(3689)'],
    products = ['FC1C(F)C(F)(F)C1(F)F(3751)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)=CF(3711)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(3689)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F2(78)', 'F[CH]C(F)=C(F)[CH]F(3712)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(3689)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'F[CH]C(F)(F)[C](F)F(3747)'],
    products = ['F[CH]C(F)(F)C(F)(F)[CH]F(3689)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]C(F)(F)C(F)(F)[CH]F(3689)'],
    products = ['F[CH][C](F)C(F)(F)C(F)F(3768)'],
