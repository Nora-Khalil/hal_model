...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C[O](2715)'],
    products = ['[O]CO[C]=O(4624)'],
    transitionState = 'TS2',
