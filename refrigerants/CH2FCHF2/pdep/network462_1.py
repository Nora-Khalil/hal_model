...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CO[O](2894)'],
    products = ['CC(F)(F)O[O](2796)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)F(2885)', 'CH2(S)(25)'],
    products = ['CC(F)(F)O[O](2796)'],
    transitionState = 'TS4',
