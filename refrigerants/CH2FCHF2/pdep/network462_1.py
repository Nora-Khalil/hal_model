...
"""),
    ...
    molecularWeight = (62.0248,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.46874,-0.0219087,0.000160131,-2.12636e-07,8.54413e-11,2990.31,11.1439], Tmin=(100,'K'), Tmax=(918.182,'K')), NASAPolynomial(coeffs=[22.5078,-0.0180857,1.21399e-05,-2.26683e-09,1.40363e-13,-4163.38,-99.0001], Tmin=(918.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.4436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OO[O](2543)'],
    products = ['O=O(207)', 'CH2O(20)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](129)', 'CH2(T)(18)'],
    products = ['[CH2]OO[O](2543)'],
    transitionState = 'TS2',
