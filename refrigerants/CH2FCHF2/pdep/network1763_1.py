...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(C=O)O[C]=O(6159)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(514)', '[O]C([O])(F)C=O(1992)'],
    products = ['[O]C(F)(C=O)O[C]=O(6159)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(C=O)O[C]=O(6159)'],
    products = ['O=[C]OC1(F)[CH]OO1(6795)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['CO(13)', '[O]C([O])(F)C=O(1992)'],
    products = ['[O]C(F)(C=O)O[C]=O(6159)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=[C]OC(=O)C=O(6799)'],
    products = ['[O]C(F)(C=O)O[C]=O(6159)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HCO(15)', 'O=[C]OC(=O)F(1309)'],
    products = ['[O]C(F)(C=O)O[C]=O(6159)'],
