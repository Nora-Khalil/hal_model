...
reaction(
    label = 'reaction1',
    reactants = ['[OH+]=[C-]C(F)(F)C=C(F)F(7100)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[OH+]=[C-]C(F)(F)C=C(F)F(7100)'],
    products = ['[OH+]=[C-]C(F)=CC(F)(F)F(7605)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[OH+][C-]=C(F)C=C(F)F(7606)'],
    products = ['[OH+]=[C-]C(F)(F)C=C(F)F(7100)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FC(F)=[C-][OH+]C=C(F)F(7607)'],
    products = ['[OH+]=[C-]C(F)(F)C=C(F)F(7100)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', '[OH+]=[C-]C(F)=C=C(F)F(7608)'],
    products = ['[OH+]=[C-]C(F)(F)C=C(F)F(7100)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', '[OH+]=[C-]C(F)(F)C#CF(7609)'],
    products = ['[OH+]=[C-]C(F)(F)C=C(F)F(7100)'],
    transitionState = 'TS6',
...
network(
    label = 'PDepNetwork #1930',
    isomers = [
        '[OH+]=[C-]C(F)(F)C=C(F)F(7100)',
    ],
    reactants = [
