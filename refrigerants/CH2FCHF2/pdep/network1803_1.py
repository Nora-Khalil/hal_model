...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(4465)', '[O]C[C](F)F(230)'],
    products = ['C=[C]OC[C](F)F(6417)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]O[C]=C(6441)'],
    products = ['C=[C]OC[C](F)F(6417)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=[C]OC=C(F)F(6443)'],
    products = ['C=[C]OC[C](F)F(6417)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#COC[C](F)F(6444)'],
    products = ['C=[C]OC[C](F)F(6417)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]O[C]=C(6441)'],
    products = ['C=[C]OC[C](F)F(6417)'],
