...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'OC(O)(F)F(5253)'],
    products = ['OC(F)(F)OCF(5249)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)(F)OF(5025)', 'CH2(S)(25)'],
    products = ['OC(F)(F)OCF(5249)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(O)(F)F(6125)'],
    products = ['OC(F)(F)OCF(5249)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(2562)', '[O]CF(362)'],
    products = ['OC(F)(F)OCF(5249)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(O)(F)F(2944)', 'CH2F(46)'],
    products = ['OC(F)(F)OCF(5249)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)OCF(5421)'],
    products = ['OC(F)(F)OCF(5249)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OC(F)(F)O[CH]F(5809)'],
    products = ['OC(F)(F)OCF(5249)'],
