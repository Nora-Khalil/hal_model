...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]C(=C)[O](6417)'],
    products = ['C=C([O])C[C](F)F(3084)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C[C](F)F(6418)'],
    products = ['C=C([O])C[C](F)F(3084)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=C([O])C=C(F)F(6423)'],
    products = ['C=C([O])C[C](F)F(3084)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]C(=C)[O](6417)'],
    products = ['C=C([O])C[C](F)F(3084)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C([O])C[C](F)F(3084)'],
    products = ['[CH2][C]1CC(F)(F)O1(6428)'],
