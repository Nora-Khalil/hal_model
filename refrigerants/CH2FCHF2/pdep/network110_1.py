...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[CH]C(=O)F(323)'],
    products = ['[CH]=C(F)O[CH]F(379)'],
    transitionState = 'TS2',
