...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.552034,'amu*angstrom^2'), symmetry=1, barrier=(12.6924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.546876,'amu*angstrom^2'), symmetry=1, barrier=(51.5931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.054,'amu'),
...
"""),
    ...
    molecularWeight = (108.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89449,0.0498956,-3.99545e-05,1.72583e-08,-3.22649e-12,-37976.1,18.0452], Tmin=(100,'K'), Tmax=(1201.05,'K')), NASAPolynomial(coeffs=[8.2155,0.0288441,-1.36634e-05,2.66497e-09,-1.88897e-13,-39494.5,-13.608], Tmin=(1201.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH]C=CF(9467)'],
    products = ['[CH]=CC(F)[C](F)F(9476)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=CC=C(F)F(8894)'],
    products = ['[CH]=CC(F)[C](F)F(9476)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=CC(F)=C(F)F(9479)'],
    products = ['[CH]=CC(F)[C](F)F(9476)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC(F)[C](F)F(3882)'],
    products = ['[CH]=CC(F)[C](F)F(9476)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C[C](F)F(282)'],
    products = ['[CH]=CC(F)[C](F)F(9476)'],
