...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])=O(540)'],
    products = ['[O]CC([O])=O(4622)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(517)', '[CH2][O](2599)'],
    products = ['[O]CC([O])=O(4622)'],
