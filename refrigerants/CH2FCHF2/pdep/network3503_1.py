...
reaction(
    label = 'reaction4',
    reactants = ['OF(482)', 'O=C=CC=O(6153)'],
    products = ['O=CCC(=O)OF(13074)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['FO[C]1C[CH]OO1(13205)'],
    products = ['O=CCC(=O)OF(13074)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)CC=O(13212)'],
    products = ['O=CCC(=O)OF(13074)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(128)', 'O=[C]CC=O(8234)'],
    products = ['O=CCC(=O)OF(13074)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C=CC(=O)OF(11321)'],
    products = ['O=CCC(=O)OF(13074)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O=[C]CC(=O)OF(13213)'],
    products = ['O=CCC(=O)OF(13074)'],
