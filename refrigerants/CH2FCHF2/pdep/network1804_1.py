...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[C](F)F(3402)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[C](F)F(537)'],
    products = ['[CH2]C(=O)O[C](F)F(3402)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[C](F)F(3402)'],
    products = ['[CH2][C]1OC(F)(F)O1(6864)'],
    transitionState = 'TS6',
