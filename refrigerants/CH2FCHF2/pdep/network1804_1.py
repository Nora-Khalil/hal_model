...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.433927,'amu*angstrom^2'), symmetry=1, barrier=(9.97684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.432994,'amu*angstrom^2'), symmetry=1, barrier=(9.95539,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[C]=O(6418)'],
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)C[C]=O(6434)'],
    products = ['[CH2]C(F)(F)C[C]=O(6418)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C=O(6435)'],
    products = ['[CH2]C(F)(F)C[C]=O(6418)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C[C]=O(6436)'],
    products = ['[CH2]C(F)(F)C[C]=O(6418)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C=C[O](6437)'],
    products = ['[CH2]C(F)(F)C[C]=O(6418)'],
