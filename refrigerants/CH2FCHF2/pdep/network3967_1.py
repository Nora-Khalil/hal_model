...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCCF(14035)'],
    products = ['O=C(O)CCF(14056)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(O)C[C]F(14367)'],
    products = ['O=C(O)CCF(14056)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'O=C(O)CF(8423)'],
    products = ['O=C(O)CCF(14056)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]CC(=O)O(14373)'],
    products = ['O=C(O)CCF(14056)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(46)', '[CH2]C(=O)O(5771)'],
    products = ['O=C(O)CCF(14056)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(338)', 'CH2F-CH2(62)'],
    products = ['O=C(O)CCF(14056)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(O)[CH]CF(14375)'],
    products = ['O=C(O)CCF(14056)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C[CH]F(14376)'],
    products = ['O=C(O)CCF(14056)'],
