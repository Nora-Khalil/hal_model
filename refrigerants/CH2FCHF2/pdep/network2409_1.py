...
"""),
    E0 = (-1304.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,435,565,619,662,854,1178,1396,190,488,555,1236,1407,240.46,240.461,240.461,240.461],'cm^-1')),
        HinderedRotor(inertia=(0.228312,'amu*angstrom^2'), symmetry=1, barrier=(9.36797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.787249,'amu*angstrom^2'), symmetry=1, barrier=(32.3017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228312,'amu*angstrom^2'), symmetry=1, barrier=(9.36797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.787247,'amu*angstrom^2'), symmetry=1, barrier=(32.3017,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0497925,0.0943452,-0.00013524,9.89091e-08,-2.88806e-11,-156702,30.2577], Tmin=(100,'K'), Tmax=(835.852,'K')), NASAPolynomial(coeffs=[14.0433,0.0273855,-1.50875e-05,3.08684e-09,-2.23448e-13,-159042,-34.7453], Tmin=(835.852,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1304.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.0285,'amu*angstrom^2'), symmetry=1, barrier=(23.6473,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.196433,0.0794784,-9.43608e-05,5.29016e-08,-1.14062e-11,-140009,26.1331], Tmin=(100,'K'), Tmax=(1143.6,'K')), NASAPolynomial(coeffs=[19.5696,0.0117156,-5.47876e-06,1.08671e-09,-7.88803e-14,-144440,-69.9303], Tmin=(1143.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1165.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-1346.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,326,540,652,719,1357,182,240,577,636,1210,1413,226.442,226.442,226.442],'cm^-1')),
        HinderedRotor(inertia=(0.339361,'amu*angstrom^2'), symmetry=1, barrier=(12.3482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.33936,'amu*angstrom^2'), symmetry=1, barrier=(12.3482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.802928,'amu*angstrom^2'), symmetry=1, barrier=(29.2158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00895156,0.0924815,-0.000131398,9.06761e-08,-2.44346e-11,-161810,27.1708], Tmin=(100,'K'), Tmax=(912.102,'K')), NASAPolynomial(coeffs=[16.8193,0.0187634,-1.01696e-05,2.07254e-09,-1.50029e-13,-164877,-52.3834], Tmin=(912.102,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1346.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(CdCFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F))"""),
)

species(
    label = 'OC(F)(F)O[CH][C](F)F(9167)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-917.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,3025,407.5,1350,352.5,190,488,555,1236,1407,193.572,194.269,194.437,196.044],'cm^-1')),
        HinderedRotor(inertia=(0.255616,'amu*angstrom^2'), symmetry=1, barrier=(7.14574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00454117,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268149,'amu*angstrom^2'), symmetry=1, barrier=(7.14549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12761,'amu*angstrom^2'), symmetry=1, barrier=(29.8363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.163341,0.101247,-0.000179657,1.57813e-07,-5.3276e-11,-110220,30.3616], Tmin=(100,'K'), Tmax=(838.682,'K')), NASAPolynomial(coeffs=[12.6001,0.0242683,-1.31748e-05,2.58046e-09,-1.78281e-13,-111795,-25.5927], Tmin=(838.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-917.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFFOO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'O[C](F)OC(F)[C](F)F(9168)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-867.072,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,482,586,761,1411,333.073,333.302,333.666,335.287],'cm^-1')),
        HinderedRotor(inertia=(0.0993398,'amu*angstrom^2'), symmetry=1, barrier=(7.86642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.428715,'amu*angstrom^2'), symmetry=1, barrier=(33.8104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235875,'amu*angstrom^2'), symmetry=1, barrier=(18.4572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427335,'amu*angstrom^2'), symmetry=1, barrier=(33.8171,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.61799,0.0783548,-9.82572e-05,6.09911e-08,-1.50246e-11,-104166,29.425], Tmin=(100,'K'), Tmax=(987.065,'K')), NASAPolynomial(coeffs=[14.7163,0.0212213,-1.14322e-05,2.34806e-09,-1.71445e-13,-106949,-38.4075], Tmin=(987.065,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-867.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFHOO) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.21078,'amu*angstrom^2'), symmetry=1, barrier=(4.84624,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213568,'amu*angstrom^2'), symmetry=1, barrier=(4.91035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.807569,'amu*angstrom^2'), symmetry=1, barrier=(18.5676,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.292349,0.0917373,-0.000166907,1.51851e-07,-5.298e-11,-106900,29.2182], Tmin=(100,'K'), Tmax=(830.11,'K')), NASAPolynomial(coeffs=[10.3791,0.025089,-1.38692e-05,2.75969e-09,-1.9277e-13,-107953,-13.8217], Tmin=(830.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-889.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O]C(F)(F)OC(F)[C](F)F(9169)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1037.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,375,486,586,623,710,938,1161,1294,190,488,555,1236,1407,230.185,233.512,236.709,237.377],'cm^-1')),
        HinderedRotor(inertia=(0.976672,'amu*angstrom^2'), symmetry=1, barrier=(37.3273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.601374,'amu*angstrom^2'), symmetry=1, barrier=(23.2785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0773865,'amu*angstrom^2'), symmetry=1, barrier=(3.04016,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.446906,0.0839388,-0.000110089,7.20216e-08,-1.87802e-11,-124661,29.7299], Tmin=(100,'K'), Tmax=(932.319,'K')), NASAPolynomial(coeffs=[14.4846,0.0237111,-1.31887e-05,2.73084e-09,-1.99852e-13,-127278,-37.01], Tmin=(932.319,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1037.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'OC(F)(F)O[C](F)[C](F)F(9170)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1100.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,395,473,707,1436,190,488,555,1236,1407,200.25,200.25,200.252,1872.68],'cm^-1')),
        HinderedRotor(inertia=(0.269756,'amu*angstrom^2'), symmetry=1, barrier=(7.67623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269755,'amu*angstrom^2'), symmetry=1, barrier=(7.67623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13353,'amu*angstrom^2'), symmetry=1, barrier=(32.256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13353,'amu*angstrom^2'), symmetry=1, barrier=(32.256,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-1038.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,482,664,788,1296,1923,272.65,272.751,273.251,273.945],'cm^-1')),
        HinderedRotor(inertia=(0.0310734,'amu*angstrom^2'), symmetry=1, barrier=(33.1749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.392597,'amu*angstrom^2'), symmetry=1, barrier=(20.7762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.625038,'amu*angstrom^2'), symmetry=1, barrier=(33.17,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22027,0.0648675,-7.2419e-05,4.00592e-08,-8.93289e-12,-124806,26.0179], Tmin=(100,'K'), Tmax=(1074.04,'K')), NASAPolynomial(coeffs=[12.8681,0.0214886,-1.18372e-05,2.45607e-09,-1.80302e-13,-127308,-31.0084], Tmin=(1074.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1038.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(COFOO) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'OC(F)(F)OC(F)[C]F(4075)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.86092,'amu*angstrom^2'), symmetry=1, barrier=(19.7942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.861884,'amu*angstrom^2'), symmetry=1, barrier=(19.8164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.857979,'amu*angstrom^2'), symmetry=1, barrier=(19.7266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.62507,'amu*angstrom^2'), symmetry=1, barrier=(37.3636,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.540251,0.082386,-0.000117615,8.61302e-08,-2.51869e-11,-113393,27.0963], Tmin=(100,'K'), Tmax=(834.936,'K')), NASAPolynomial(coeffs=[12.686,0.0241965,-1.30719e-05,2.65377e-09,-1.91273e-13,-115422,-29.3086], Tmin=(834.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-943.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFFOO) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-1308.46,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,522,611,926,1093,1137,1374,1416,3112,395,473,707,1436,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.88954,'amu*angstrom^2'), symmetry=1, barrier=(43.4442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265088,'amu*angstrom^2'), symmetry=1, barrier=(6.0949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.776724,'amu*angstrom^2'), symmetry=1, barrier=(17.8584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264953,'amu*angstrom^2'), symmetry=1, barrier=(6.09178,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0625418,0.0946379,-0.00014537,1.17483e-07,-3.81349e-11,-157237,31.0902], Tmin=(100,'K'), Tmax=(753.09,'K')), NASAPolynomial(coeffs=[12.2493,0.0299052,-1.64286e-05,3.33245e-09,-2.39e-13,-159072,-24.2473], Tmin=(753.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1308.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO) + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-1245.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,375,486,586,623,710,938,1161,1294,320.333,320.667,321.683,322.967],'cm^-1')),
        HinderedRotor(inertia=(0.434269,'amu*angstrom^2'), symmetry=1, barrier=(32.123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102136,'amu*angstrom^2'), symmetry=1, barrier=(7.61543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.329684,'amu*angstrom^2'), symmetry=1, barrier=(24.5177,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
...
species(
    label = 'OC(F)(F)O[CH]C(F)(F)F(9172)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)OC(F)[C](F)F(9002)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'OC(F)(F)OC(F)[C]F-2(9164)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'OC(F)(F)O[CH]F(5809)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)(F)OC=C(F)F(9165)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'OC(F)(F)OC(F)=C(F)F(9166)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'OC(F)(F)O[CH][C](F)F(9167)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)OC(F)[C](F)F(9168)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(O)(F)F(2944)', 'F[CH][C](F)F(3610)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'F[C](F)OC(F)[C](F)F(3684)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)[C](F)F(9169)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'OC(F)(F)O[C](F)[C](F)F(9170)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=C(F)OC(F)[C](F)F(9171)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'OC(F)(F)OC(F)[C]F(4075)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', 'OC(F)(F)O[CH]F(5809)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OC(F)(F)OC(F)[C](F)F(9002)'],
    products = ['OC(F)(F)O[C](F)C(F)F(7959)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(F)OC(F)C(F)F(7922)'],
    products = ['OC(F)(F)OC(F)[C](F)F(9002)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OC(F)(F)OC(F)[C](F)F(9002)'],
    products = ['OC(F)(F)O[CH]C(F)(F)F(9172)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OC(F)(F)OC(F)[C](F)F(9002)'],
    products = ['O[C](F)OC(F)C(F)(F)F(9173)'],
...
network(
    label = 'PDepNetwork #2409',
    isomers = [
        'OC(F)(F)OC(F)[C](F)F(9002)',
    ],
    reactants = [
