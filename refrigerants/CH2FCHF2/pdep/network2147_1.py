...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C=C=C[C]F(8089)'],
    products = ['C=C([O])C=[C]F(3130)'],
    transitionState = 'TS2',
