...
reaction(
    label = 'reaction1',
    reactants = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(488)', 'O=C=COC=O(8287)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['FOC1O[CH]OO[C]1F(13241)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)[C](OF)OC=O(13242)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]CO[C](OF)C(=O)F(13243)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(F)[C](OF)O[CH]O(13244)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)C(OF)O[C]=O(13245)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]OC(OF)[C](O)F(13246)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=COC(OF)=C(O)F(13158)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=[C]C(OF)OC=O(13247)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(OC=O)C(=O)F(13248)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C=O(339)', 'O=C(F)[CH]OF(1555)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HCO(15)', '[O]C(OF)C(=O)F(12550)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]F(128)', 'O=CO[CH]C(=O)F(2173)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CFO(51)', 'O=CO[CH]OF(5587)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=CO[C](OF)C(=O)F(13249)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=[C]OC(OF)C(=O)F(13250)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=COC(=O)C(=O)F(6807)'],
    products = ['O=COC(OF)C(=O)F(13077)'],
...
network(
    label = 'PDepNetwork #3511',
    isomers = [
        'O=COC(OF)C(=O)F(13077)',
    ],
    reactants = [
