...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36762,0.054758,-5.95379e-05,3.09567e-08,-6.26022e-12,-23613.7,24.5638], Tmin=(100,'K'), Tmax=(1208.59,'K')), NASAPolynomial(coeffs=[14.56,0.0110958,-5.34783e-06,1.06485e-09,-7.69883e-14,-26802.5,-41.5809], Tmin=(1208.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-197.146,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)

species(
    label = 'OOO[C](F)CF(3700)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C(F)OOO(4197)'],
    products = ['OOOC(F)[CH]F(4193)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'OOO[CH]F(2907)'],
    products = ['OOOC(F)[CH]F(4193)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'OOOC(F)[C]F-2(4198)'],
    products = ['OOOC(F)[CH]F(4193)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'OOO[CH][CH]F(4200)'],
    products = ['OOOC(F)[CH]F(4193)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'OOO[CH]F(2907)'],
    products = ['OOOC(F)[CH]F(4193)'],
