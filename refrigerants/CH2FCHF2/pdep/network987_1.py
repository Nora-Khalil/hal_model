...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)(F)[CH]F(4088)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C(F)(F)[CH]F(2586)'],
    products = ['O=[C]OC(F)(F)[CH]F(4088)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'O=[C]O[C](F)F(537)'],
    products = ['O=[C]OC(F)(F)[CH]F(4088)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C(F)(F)[CH]F(2586)'],
    products = ['O=[C]OC(F)(F)[CH]F(4088)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=CF(518)'],
    products = ['O=[C]OC(F)(F)[CH]F(4088)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', 'O=[C]O[C](F)F(537)'],
    products = ['O=[C]OC(F)(F)[CH]F(4088)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]O[C](F)C(F)F(4139)'],
    products = ['O=[C]OC(F)(F)[CH]F(4088)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OC(F)(F)[CH]F(4088)'],
    products = ['O=C(F)O[C](F)[CH]F(4142)'],
