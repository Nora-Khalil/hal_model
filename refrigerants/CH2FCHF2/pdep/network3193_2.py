...
"""),
    E0 = (-869.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,261,493,600,1152,1365,1422,3097,193,295,551,588,656,1146,1192,1350,180],'cm^-1')),
        HinderedRotor(inertia=(0.253756,'amu*angstrom^2'), symmetry=1, barrier=(5.83436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.746479,'amu*angstrom^2'), symmetry=1, barrier=(17.163,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.410438,'amu*angstrom^2'), symmetry=1, barrier=(9.43678,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410469,'amu*angstrom^2'), symmetry=1, barrier=(9.43748,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25468,0.0750929,-0.000159695,1.59456e-07,-5.79293e-11,-53655.5,22.0924], Tmin=(100,'K'), Tmax=(876.585,'K')), NASAPolynomial(coeffs=[4.60527,0.0247253,-1.34816e-05,2.60581e-09,-1.76358e-13,-52895.3,14.0564], Tmin=(876.585,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]OC(F)(F)[CH]F(3669)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.481716,'amu*angstrom^2'), symmetry=1, barrier=(11.0756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.481737,'amu*angstrom^2'), symmetry=1, barrier=(11.0761,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0515,0.0759334,-0.000150287,1.41514e-07,-4.94987e-11,-54727.4,21.7764], Tmin=(100,'K'), Tmax=(871.504,'K')), NASAPolynomial(coeffs=[7.94338,0.0195369,-1.05966e-05,2.05049e-09,-1.39104e-13,-54988.2,-5.12955], Tmin=(871.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-455.824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.423861,'amu*angstrom^2'), symmetry=1, barrier=(9.7454,'kJ/mol'), semiclassical=False),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3380.85,'J/mol'), sigma=(5.63196,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=528.08 K, Pc=42.94 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.752117,0.0844091,-0.000171854,1.63426e-07,-5.74732e-11,-78847.6,24.2131], Tmin=(100,'K'), Tmax=(870.766,'K')), NASAPolynomial(coeffs=[8.29008,0.020595,-1.16481e-05,2.27712e-09,-1.54979e-13,-79053.8,-4.7563], Tmin=(870.766,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-656.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.641087,'amu*angstrom^2'), symmetry=1, barrier=(14.7399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.640985,'amu*angstrom^2'), symmetry=1, barrier=(14.7375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.641126,'amu*angstrom^2'), symmetry=1, barrier=(14.7407,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
...
"""),
    ...
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.765291,0.0821433,-0.000155416,1.47641e-07,-5.34232e-11,-59842.9,24.4523], Tmin=(100,'K'), Tmax=(828.205,'K')), NASAPolynomial(coeffs=[7.80718,0.0264077,-1.51238e-05,3.03884e-09,-2.13328e-13,-60264.2,-3.69515], Tmin=(828.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = 'F[CH]C(F)(F)OOF(12406)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {8,S}
...
"""),
    E0 = (-885.938,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([391,562,707,872,1109,1210,1289,3137,193,295,551,588,656,1146,1192,1350,365.758],'cm^-1')),
        HinderedRotor(inertia=(0.498242,'amu*angstrom^2'), symmetry=1, barrier=(11.4556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (117.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.81608,0.0125198,0.000127947,-3.40855e-07,2.5569e-10,-106551,12.4026], Tmin=(10,'K'), Tmax=(472.983,'K')), NASAPolynomial(coeffs=[5.50546,0.0289556,-2.16106e-05,7.27662e-09,-9.06887e-13,-107054,1.88433], Tmin=(472.983,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-885.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), label="""[O]C(F)C(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = '[O]O[CH]C(F)(F)F(3646)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.444207,'amu*angstrom^2'), symmetry=1, barrier=(10.2132,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11152,0.0700307,-0.000125493,1.08808e-07,-3.58052e-11,-58093.8,20.6343], Tmin=(100,'K'), Tmax=(866.856,'K')), NASAPolynomial(coeffs=[10.6159,0.013874,-7.03542e-06,1.33867e-09,-9.03557e-14,-59279.4,-21.1951], Tmin=(866.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-483.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CCsJOOH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.391735,'amu*angstrom^2'), symmetry=1, barrier=(9.00675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391751,'amu*angstrom^2'), symmetry=1, barrier=(9.00713,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (132.014,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.864762,0.0828453,-0.000171392,1.65951e-07,-5.91413e-11,-82057.6,23.0674], Tmin=(100,'K'), Tmax=(871.145,'K')), NASAPolynomial(coeffs=[7.04616,0.022571,-1.2695e-05,2.47977e-09,-1.6883e-13,-81924.5,1.04391], Tmin=(871.145,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-683.094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.72079,0.0266886,-5.00817e-06,-2.59522e-08,1.78901e-11,-125222,11.7773], Tmin=(10,'K'), Tmax=(716.609,'K')), NASAPolynomial(coeffs=[7.22499,0.0187733,-1.28143e-05,3.98566e-09,-4.64972e-13,-126023,-6.04694], Tmin=(716.609,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1041.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), label="""ODC(F)C(F)(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'FOO[CH]C(F)(F)F(9668)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {7,S}
...
"""),
    E0 = (-542.801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(1.64761,'amu*angstrom^2'), symmetry=1, barrier=(37.8818,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.979543,0.0740953,-0.000127493,1.16206e-07,-4.18211e-11,-65182.5,23.5375], Tmin=(100,'K'), Tmax=(779.956,'K')), NASAPolynomial(coeffs=[8.54333,0.025257,-1.42443e-05,2.88976e-09,-2.05785e-13,-66056.8,-9.11448], Tmin=(779.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJOO)"""),
)

species(
    label = 'FOOC(F)[C](F)F(9669)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {8,S}
...
"""),
    E0 = (-486.477,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,487,638,688,1119,1325,1387,3149,190,488,555,1236,1407],'cm^-1')),
        HinderedRotor(inertia=(1.52731,'amu*angstrom^2'), symmetry=1, barrier=(35.1158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.022,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.22189,0.0847912,-0.000320951,7.64654e-07,-7.15372e-10,-58510.7,13.54], Tmin=(10,'K'), Tmax=(303.838,'K')), NASAPolynomial(coeffs=[6.13323,0.0360152,-2.85692e-05,9.94487e-09,-1.26684e-12,-58639.4,3.75622], Tmin=(303.838,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-486.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), label="""FOOC(F)[C](F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CF2(43)', '[O]OC(F)F(2774)'],
    products = ['[O]OC(F)(F)C(F)F(8445)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OF(127)', 'F[C]C(F)F(125)'],
    products = ['[O]OC(F)(F)C(F)F(8445)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)(F)F(3645)', 'CHF(40)'],
    products = ['[O]OC(F)(F)C(F)F(8445)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)C(F)F(8445)'],
    products = ['[O]OC(F)C(F)(F)F(9646)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)(F)C(F)F(4812)'],
    products = ['[O]OC(F)(F)C(F)F(8445)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]O[C](F)C(F)F(3625)'],
    products = ['[O]OC(F)(F)C(F)F(8445)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OC(F)(F)[CH]F(3669)'],
    products = ['[O]OC(F)(F)C(F)F(8445)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[C](F)F(219)', 'CHF2(82)'],
    products = ['[O]OC(F)(F)C(F)F(8445)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OC(F)(F)[C](F)F(11866)'],
    products = ['[O]OC(F)(F)C(F)F(8445)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O]OC(F)=C(F)F(3744)'],
    products = ['[O]OC(F)(F)C(F)F(8445)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)OOF(12406)'],
    products = ['[O]OC(F)(F)C(F)F(8445)'],
...
reaction(
    label = 'reaction2',
    reactants = ['HO2(11)', 'F[C]C(F)(F)F(4171)'],
    products = ['[O]OC(F)C(F)(F)F(9646)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(45.2905,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.67164e-06,'m^3/(mol*s)'), n=3.3552, Ea=(262.765,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)C(F)(F)F(9666)'],
    products = ['[O]OC(F)C(F)(F)F(9646)'],
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]O[CH]C(F)(F)F(3646)'],
    products = ['[O]OC(F)C(F)(F)F(9646)'],
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]OC(F)[C](F)F(3626)'],
    products = ['[O]OC(F)C(F)(F)F(9646)'],
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CF3-CHF(54)'],
    products = ['[O]OC(F)C(F)(F)F(9646)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(7.6844e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(1.2071,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['CF3(45)', '[O]O[CH]F(209)'],
    products = ['[O]OC(F)C(F)(F)F(9646)'],
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]O[C](F)C(F)(F)F(9667)'],
    products = ['[O]OC(F)C(F)(F)F(9646)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F2(78)', '[O]OC=C(F)F(233)'],
    products = ['[O]OC(F)C(F)(F)F(9646)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FOO[CH]C(F)(F)F(9668)'],
    products = ['[O]OC(F)C(F)(F)F(9646)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(97.0606,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction15',
    reactants = ['FOOC(F)[C](F)F(9669)'],
    products = ['[O]OC(F)C(F)(F)F(9646)'],
    transitionState = 'TS30',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(58.476,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #3193',
    isomers = [
        '[O]OC(F)C(F)(F)F(9646)',
        '[O]OC(F)(F)C(F)F(8445)',
    ],
    reactants = [
        ('CF2(43)', '[O]OC(F)F(2774)'),
        ('HO2(11)', 'CF2CF2(61)'),
        ('O2(2)', 'CHF2-CF2(69)'),
        ('O2(2)', 'CF3-CHF(54)'),
    ],
