...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
    products = ['CO2(14)', 'CF2CF2(61)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O=C(OF)[C](F)[C](F)F(11966)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[O]C(=O)[C](F)F(548)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C(F)(F)[C](F)F(7049)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
    products = ['O=C1OC(F)(F)C1(F)F(11858)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
    products = ['F[C](F)C(F)(F)[C]1OO1(11967)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
    products = ['[O][C]1OC(F)(F)C1(F)F(11968)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
    products = ['[O]C1([O])C(F)(F)C1(F)F(11969)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(F)=C(F)F(4149)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CO2(14)', 'F[C](F)[C](F)F(4977)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C]=O(517)', 'F[C](F)[C](F)F(4977)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2(43)', '[O]C(=O)[C](F)F(548)'],
    products = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(=O)C(F)(F)[C](F)F(11856)'],
    products = ['[O]C(=O)[C](F)C(F)(F)F(11970)'],
...
network(
    label = 'PDepNetwork #2998',
    isomers = [
        '[O]C(=O)C(F)(F)[C](F)F(11856)',
    ],
    reactants = [
        ('CO2(14)', 'CF2CF2(61)'),
    ],
