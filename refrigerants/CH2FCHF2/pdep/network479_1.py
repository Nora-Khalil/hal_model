...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', '[O]C[O](2826)'],
    products = ['[O]CO[C](F)F(2810)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]O[C](F)F(2728)'],
    products = ['[O]CO[C](F)F(2810)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(2694)', 'CH2O(20)'],
    products = ['[O]CO[C](F)F(2810)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(2694)', '[CH2][O](2653)'],
    products = ['[O]CO[C](F)F(2810)'],
    transitionState = 'TS9',
