...
"""),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.360986,0.101338,-0.000134995,9.11072e-08,-2.43744e-11,-139102,29.6165], Tmin=(100,'K'), Tmax=(913.328,'K')), NASAPolynomial(coeffs=[16.4594,0.0276707,-1.40062e-05,2.79221e-09,-2.00096e-13,-142174,-50.007], Tmin=(913.328,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1157.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCFFO) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)

species(
    label = 'OCC(F)(F)OC(F)=CF(4039)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
species(
    label = 'OC(F)([CH]F)OC(F)[CH]F(4042)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-721.403,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,326,540,652,719,1357,194,682,905,1196,1383,3221,279.022,279.966,280.079,1103.59],'cm^-1')),
        HinderedRotor(inertia=(0.132533,'amu*angstrom^2'), symmetry=1, barrier=(7.41424,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.315189,'amu*angstrom^2'), symmetry=1, barrier=(17.5842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.318578,'amu*angstrom^2'), symmetry=1, barrier=(17.6052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.316816,'amu*angstrom^2'), symmetry=1, barrier=(17.5976,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.169665,0.0886764,-0.000113687,7.37035e-08,-1.89808e-11,-86630.5,29.4144], Tmin=(100,'K'), Tmax=(946.478,'K')), NASAPolynomial(coeffs=[15.2554,0.0249214,-1.26464e-05,2.53448e-09,-1.82501e-13,-89486.2,-42.5357], Tmin=(946.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-721.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(O)(F)OC(F)=CF(4044)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-757.176,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,326,540,652,719,1357,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,223.829,223.833,223.836],'cm^-1')),
        HinderedRotor(inertia=(0.271627,'amu*angstrom^2'), symmetry=1, barrier=(9.65614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.815045,'amu*angstrom^2'), symmetry=1, barrier=(28.9786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271622,'amu*angstrom^2'), symmetry=1, barrier=(9.65614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.643062,'amu*angstrom^2'), symmetry=1, barrier=(22.8621,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.303287,0.100519,-0.0001433,1.02588e-07,-2.89358e-11,-90917.4,27.6891], Tmin=(100,'K'), Tmax=(869.789,'K')), NASAPolynomial(coeffs=[16.1575,0.0248229,-1.27649e-05,2.54216e-09,-1.81369e-13,-93781.1,-49.4291], Tmin=(869.789,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-757.176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)

species(
    label = 'OC(F)(CF)O[C]=CF(4045)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02914,'amu*angstrom^2'), symmetry=1, barrier=(23.662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02935,'amu*angstrom^2'), symmetry=1, barrier=(23.6667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02871,'amu*angstrom^2'), symmetry=1, barrier=(23.6522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02893,'amu*angstrom^2'), symmetry=1, barrier=(23.657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.110197,0.0915185,-0.000117975,7.26468e-08,-1.73598e-11,-82151.7,25.4475], Tmin=(100,'K'), Tmax=(1028.49,'K')), NASAPolynomial(coeffs=[19.1694,0.0165353,-8.61415e-06,1.75863e-09,-1.28477e-13,-86117.4,-68.1069], Tmin=(1028.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-684.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H2(8)', 'OC(F)([C]F)OC(F)=CF(4037)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'OC(F)OC(F)=CF(3237)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'OC(F)(F)OC(F)=CF(3376)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OC(F)=CF(878)', 'OC(F)=CF(878)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FC=C(F)OF(1049)', 'C=C(O)F(3010)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H2O(3)', 'FC=C(F)OC(F)=CF(4040)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(482)', 'C=C(F)OC(F)=CF(3040)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OC(F)(CF)OC(F)=CF(3243)'],
    products = ['O=C(F)C(F)C(O)(F)CF(4041)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OC(F)([CH]F)OC(F)[CH]F(4042)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OC(F)([CH]F)O[C](F)CF(3319)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O[C](CF)OC(F)=CF(4043)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[CH2]C(O)(F)OC(F)=CF(4044)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'OC(F)(CF)O[C]=CF(4045)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', '[CH]=C(F)OC(O)(F)CF(4046)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=C(F)[CH]F(215)', 'O[C](F)CF(2940)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CHFCF[Z](72)', '[O]C(O)(F)CF(3973)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction22',
    reactants = ['OH(7)', 'FC=C(F)O[C](F)CF(3042)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2F(46)', 'O[C](F)OC(F)=CF(4047)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(5)', 'OC(F)([CH]F)OC(F)=CF(4048)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(5)', 'OC(F)(CF)OC(F)=[C]F(4049)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction27',
    reactants = ['OC(F)(CF)OC(F)=CF(3243)'],
    products = ['O=C(F)CF(879)', 'OC(F)=CF(878)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OC(F)(CF)[O+]=[C-]C(F)F(4050)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]C(F)(F)OC(O)(F)CF(4051)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction30',
    reactants = ['OC(F)(CF)OC(F)[C]F(4052)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction31',
    reactants = ['HF(38)', 'O=C(CF)OC(F)=CF(4053)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction32',
    reactants = ['F2(78)', 'C=C(O)OC(F)=CF(4054)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction33',
    reactants = ['HF(38)', 'OC(=CF)OC(F)=CF(4055)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction34',
    reactants = ['F2(78)', 'C#COC(O)(F)CF(4056)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction35',
    reactants = ['HF(38)', 'OC(F)(CF)OC#CF(4057)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
...
reaction(
    label = 'reaction36',
    reactants = ['OC(F)(CF)OC(F)=CF(3243)'],
    products = ['HF(38)', 'O=C=CF(2952)', 'O=C(F)CF(879)'],
...
reaction(
    label = 'reaction37',
    reactants = ['CHF(40)', 'OC(F)(CF)[O+]=[C-]F(4058)'],
    products = ['OC(F)(CF)OC(F)=CF(3243)'],
