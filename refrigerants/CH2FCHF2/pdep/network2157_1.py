...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(=C)[O](6417)'],
    products = ['C=C([O])C[O](3456)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2O(20)', '[CH2][C]=O(4373)'],
    products = ['C=C([O])C[O](3456)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(=O)C=O(8250)'],
    products = ['C=C([O])C[O](3456)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](2599)', '[CH2][C]=O(4373)'],
    products = ['C=C([O])C[O](3456)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[O]C[C]=O(4676)'],
    products = ['C=C([O])C[O](3456)'],
