...
species(
    label = '[CH2]C(F)(F)OO[C](F)CF(3378)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FC[C](F)OO[C](F)CF(3320)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(3036)', '[O]O[C](F)CF(188)'],
    products = ['FC[C](F)OO[C](F)CF(3320)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FC[C](F)OO[C](F)CF(3320)'],
    products = ['FCC1(F)OOC1(F)CF(3321)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)OO[C](F)CF(3374)'],
    products = ['FC[C](F)OO[C](F)CF(3320)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC=C(F)OO[C](F)CF(3375)'],
    products = ['FC[C](F)OO[C](F)CF(3320)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]C(F)OO[C](F)CF(3376)'],
    products = ['FC[C](F)OO[C](F)CF(3320)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH][C](F)OOC(F)CF(3377)'],
    products = ['FC[C](F)OO[C](F)CF(3320)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FC[C](F)OO[C](F)CF(3320)'],
    products = ['[CH2]C(F)(F)OO[C](F)CF(3378)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FC[C](F)OO[C](F)CF(3320)'],
    products = ['[CH2][C](F)OOC(F)(F)CF(3379)'],
