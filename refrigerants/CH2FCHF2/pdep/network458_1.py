...
"""),
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.95189,-0.0184004,0.000183539,-2.55053e-07,1.05042e-10,-27998.3,9.75982], Tmin=(100,'K'), Tmax=(910.35,'K')), NASAPolynomial(coeffs=[29.032,-0.0252584,1.73208e-05,-3.3282e-09,2.13459e-13,-37210.9,-138.131], Tmin=(910.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-OsOsHH) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)
...
"""),
    E0 = (26.1241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1585.5,1585.99],'cm^-1')),
        HinderedRotor(inertia=(0.178483,'amu*angstrom^2'), symmetry=1, barrier=(4.10368,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.85381,0.0354447,-7.02829e-05,8.2357e-08,-3.43449e-11,3173.35,13.6116], Tmin=(100,'K'), Tmax=(849.197,'K')), NASAPolynomial(coeffs=[-1.87193,0.0312395,-1.6108e-05,3.12771e-09,-2.16045e-13,4930.21,41.2566], Tmin=(849.197,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.1241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C[O](2715)'],
    products = ['[CH2]OC[O](2691)'],
    transitionState = 'TS2',
