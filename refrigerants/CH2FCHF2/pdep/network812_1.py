...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441683,0.0902754,-0.000170139,1.60156e-07,-5.71347e-11,-107440,29.5697], Tmin=(100,'K'), Tmax=(841.661,'K')), NASAPolynomial(coeffs=[8.41918,0.0279017,-1.53836e-05,3.04701e-09,-2.11825e-13,-107917,-2.39513], Tmin=(841.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-894.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = 'F[C](F)[C](F)OC(F)F(3795)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441397,0.0895934,-0.000166494,1.55635e-07,-5.54652e-11,-107913,29.8632], Tmin=(100,'K'), Tmax=(833.845,'K')), NASAPolynomial(coeffs=[8.77711,0.0275693,-1.52768e-05,3.04063e-09,-2.12341e-13,-108537,-4.24323], Tmin=(833.845,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-898.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)O[CH]C(F)(F)F(3796)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC(F)[C](F)F(3684)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', '[O]C(F)[C](F)F(429)'],
    products = ['F[C](F)OC(F)[C](F)F(3684)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'F[CH]O[C](F)F(426)'],
    products = ['F[C](F)OC(F)[C](F)F(3684)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C](F)OC(F)[C](F)F(3684)'],
    products = ['FC1OC(F)(F)C1(F)F(3686)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)OC=C(F)F(2617)'],
    products = ['F[C](F)OC(F)[C](F)F(3684)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C](F)OC(F)=C(F)F(3793)'],
    products = ['F[C](F)OC(F)[C](F)F(3684)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', 'F[CH]O[C](F)F(426)'],
    products = ['F[C](F)OC(F)[C](F)F(3684)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[O]C(F)[C](F)F(429)'],
    products = ['F[C](F)OC(F)[C](F)F(3684)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C](F)OC(F)[C](F)F(3684)'],
    products = ['F[C](F)O[C](F)C(F)F(3794)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C](F)OC(F)[C](F)F(3684)'],
    products = ['F[C](F)[C](F)OC(F)F(3795)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)OC(F)[C](F)F(3684)'],
    products = ['F[C](F)O[CH]C(F)(F)F(3796)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)OC(F)[C](F)F(3684)'],
    products = ['F[C](F)[CH]OC(F)(F)F(3797)'],
...
network(
    label = 'PDepNetwork #812',
    isomers = [
        'F[C](F)OC(F)[C](F)F(3684)',
    ],
    reactants = [
        ('CF2O(49)', 'CHFCF2(55)'),
    ],
