...
"""),
    E0 = (-843.879,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,190,488,555,1236,1407,1855,455,950,180,180,343.432],'cm^-1')),
        HinderedRotor(inertia=(0.821989,'amu*angstrom^2'), symmetry=1, barrier=(18.8991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.28659,'amu*angstrom^2'), symmetry=1, barrier=(52.5731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.28503,'amu*angstrom^2'), symmetry=1, barrier=(52.5374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481258,0.0843579,-0.000143168,1.2281e-07,-4.13836e-11,-101375,25.4187], Tmin=(100,'K'), Tmax=(782.621,'K')), NASAPolynomial(coeffs=[11.8193,0.0211397,-1.19026e-05,2.39053e-09,-1.68836e-13,-102988,-25.4708], Tmin=(782.621,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-843.879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdOsH) + radical(Csj(Cs-F1sF1sO2s)(F1s)(F1s)) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (144.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.711206,0.0789136,-0.000131588,1.13015e-07,-3.83507e-11,-104741,25.2215], Tmin=(100,'K'), Tmax=(777.055,'K')), NASAPolynomial(coeffs=[10.8408,0.0218923,-1.21005e-05,2.4228e-09,-1.71154e-13,-106168,-20.1451], Tmin=(777.055,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-871.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Cds-OdOsH) + radical(CsCsF1sO2s) + radical((O)CJOC)"""),
)

species(
    label = 'O=C(F)O[C](F)[C](F)F(11965)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)(F)[C](F)F(11857)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C(F)(F)[C](F)F(2628)'],
    products = ['O=[C]OC(F)(F)[C](F)F(11857)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'O=[C]O[C](F)F(537)'],
    products = ['O=[C]OC(F)(F)[C](F)F(11857)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C(F)(F)[C](F)F(2628)'],
    products = ['O=[C]OC(F)(F)[C](F)F(11857)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=C(F)F(4138)'],
    products = ['O=[C]OC(F)(F)[C](F)F(11857)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', 'O=[C]O[C](F)F(537)'],
    products = ['O=[C]OC(F)(F)[C](F)F(11857)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OC(F)(F)[C](F)F(11857)'],
    products = ['O=[C]O[C](F)C(F)(F)F(11964)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OC(F)(F)[C](F)F(11857)'],
    products = ['O=C(F)O[C](F)[C](F)F(11965)'],
