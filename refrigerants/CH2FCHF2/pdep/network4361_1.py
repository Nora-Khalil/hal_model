...
species(
    label = 'OC([CH]F)C(F)(F)[CH]F(16461)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.526495,0.114496,-0.000212694,1.97535e-07,-6.93479e-11,-87048.9,31.6668], Tmin=(100,'K'), Tmax=(857.544,'K')), NASAPolynomial(coeffs=[9.65421,0.0353038,-1.87168e-05,3.62172e-09,-2.478e-13,-87629.3,-9.08777], Tmin=(857.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-725.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsCsFHH) + radical(Csj(Cs-O2sCsH)(F1s)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    E0 = (-556.646,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,174,267,591,721,1107,1278,1348,3273,350,440,435,1725,334,575,1197,1424,3202,194,682,905,1196,1383,3221,207.253],'cm^-1')),
        HinderedRotor(inertia=(0.428766,'amu*angstrom^2'), symmetry=1, barrier=(13.112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.423371,'amu*angstrom^2'), symmetry=1, barrier=(13.1228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14809,'amu*angstrom^2'), symmetry=1, barrier=(34.968,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.533688,0.0816672,-0.00011267,8.15625e-08,-2.36418e-11,-66829,25.4623], Tmin=(100,'K'), Tmax=(842.023,'K')), NASAPolynomial(coeffs=[12.3297,0.0256334,-1.28553e-05,2.53832e-09,-1.80316e-13,-68815.6,-29.4188], Tmin=(842.023,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-F1sCdH)(F1s)(H))"""),
)
...
"""),
    E0 = (-294.234,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,173,295,515,663,653,819,693,939,1188,1292,3205,3269],'cm^-1')),
        HinderedRotor(inertia=(1.24251,'amu*angstrom^2'), symmetry=1, barrier=(28.5678,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24246,'amu*angstrom^2'), symmetry=1, barrier=(28.5666,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2427,'amu*angstrom^2'), symmetry=1, barrier=(28.5722,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.768895,0.0648876,-6.73804e-05,3.38655e-08,-6.60947e-12,-35266.7,23.4478], Tmin=(100,'K'), Tmax=(1254.72,'K')), NASAPolynomial(coeffs=[16.9624,0.0132632,-5.66408e-06,1.07392e-09,-7.58149e-14,-39330.3,-58.3511], Tmin=(1254.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-294.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsCFHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Csj(Cd-O2sCd)(F1s)(H)) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)

species(
    label = 'OC([CH]F)=C(F)[CH]F(16465)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.725486,'amu*angstrom^2'), symmetry=1, barrier=(16.6803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362978,'amu*angstrom^2'), symmetry=1, barrier=(8.34557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362837,'amu*angstrom^2'), symmetry=1, barrier=(8.34234,'kJ/mol'), semiclassical=False),
...
species(
    label = 'O[C](C(F)F)C(F)[CH]F(16466)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'OC(F)([CH][CH]F)C(F)F(16467)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.146408,0.090744,-0.00012362,8.72547e-08,-2.46151e-11,-89818,30.9759], Tmin=(100,'K'), Tmax=(864.693,'K')), NASAPolynomial(coeffs=[13.7979,0.0275966,-1.40818e-05,2.80682e-09,-2.00697e-13,-92179,-32.9006], Tmin=(864.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-747.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + radical(CCJCO) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    products = ['OC([CH]F)C(F)(F)[CH]F(16461)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(137)', 'OC(F)([CH]F)[CH]F(4995)'],
    products = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'OC(=CF)C(F)[CH]F(16463)'],
    products = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(50.833,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction9',
    reactants = ['OH(7)', 'F[CH]C(F)C(F)=CF(142)'],
    products = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(8.08706e-06,'m^3/(mol*s)'), n=3.0961, Ea=(5.47535,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)([CH]F)C=CF(5000)'],
    products = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(64.6526,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(8.08706e-06,'m^3/(mol*s)'), n=3.0961, Ea=(5.47573,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'OC(F)([CH]F)C(F)=CF(5001)'],
    products = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(168.633,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'OC([CH]F)=C[CH]F(16464)'],
    products = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(18.3024,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'OC([CH]F)=C(F)[CH]F(16465)'],
    products = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(273.432,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)
...
reaction(
    label = 'reaction19',
    reactants = ['CHF(40)', 'OC(F)([CH]F)[CH]F(4995)'],
    products = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    products = ['OC(F)([CH]F)[C](F)CF(5014)'],
...
reaction(
    label = 'reaction24',
    reactants = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    products = ['O[C](C(F)F)C(F)[CH]F(16466)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    products = ['O[C]([CH]F)C(F)C(F)F(4994)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(216.321,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction26',
    reactants = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    products = ['OC(F)([CH][CH]F)C(F)F(16467)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(210.101,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction27',
    reactants = ['OC(F)([CH]F)C(F)[CH]F(3110)'],
    products = ['OC(F)([CH]F)[CH]C(F)F(4993)'],
...
network(
    label = 'PDepNetwork #4361',
    isomers = [
        'OC(F)([CH]F)C(F)[CH]F(3110)',
    ],
    reactants = [
