...
"""),
    E0 = (-529.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([235,523,627,1123,1142,1372,1406,3097,90,150,250,247,323,377,431,433,1065,1274,2227.2],'cm^-1')),
        HinderedRotor(inertia=(0.00118405,'amu*angstrom^2'), symmetry=1, barrier=(4.16935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00937918,'amu*angstrom^2'), symmetry=1, barrier=(33.2416,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44917,0.0629879,-0.000106331,9.77306e-08,-3.52901e-11,-63573.9,20.0334], Tmin=(100,'K'), Tmax=(801.09,'K')), NASAPolynomial(coeffs=[7.00714,0.0241234,-1.27518e-05,2.53786e-09,-1.78918e-13,-64107.9,-3.32244], Tmin=(801.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-529.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.228733,'amu*angstrom^2'), symmetry=1, barrier=(5.25901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228316,'amu*angstrom^2'), symmetry=1, barrier=(5.24943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26154,0.0728591,-0.000144045,1.42868e-07,-5.26272e-11,-62110.5,23.6265], Tmin=(100,'K'), Tmax=(855.449,'K')), NASAPolynomial(coeffs=[4.61503,0.0282819,-1.52113e-05,2.97834e-09,-2.05301e-13,-61626.9,14.1513], Tmin=(855.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-517.135,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]C(F)C(F)F(4851)'],
    products = ['F[CH]C(F)C(F)F(800)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(137)', 'CHF2-CHF(67)'],
    products = ['F[CH]C(F)C(F)F(800)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'F[C]C(F)C(F)F-2(4852)'],
    products = ['F[CH]C(F)C(F)F(800)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC=C(F)C(F)F(796)'],
    products = ['F[CH]C(F)C(F)F(800)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH][CH]C(F)F(4853)'],
    products = ['F[CH]C(F)C(F)F(800)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]C(F)[CH]F(136)'],
    products = ['F[CH]C(F)C(F)F(800)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(82)', 'F[CH][CH]F(141)'],
    products = ['F[CH]C(F)C(F)F(800)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH][C](F)C(F)F(4854)'],
    products = ['F[CH]C(F)C(F)F(800)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[CH]C(F)[C](F)F(171)'],
    products = ['F[CH]C(F)C(F)F(800)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', 'F[CH]C=CF(3998)'],
    products = ['F[CH]C(F)C(F)F(800)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[CH]C(F)=CF(4855)'],
    products = ['F[CH]C(F)C(F)F(800)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'F[C]C(F)C(F)F(793)'],
    products = ['F[CH]C(F)C(F)F(800)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)C(F)F(800)'],
    products = ['FC[C](F)C(F)F(4856)'],
