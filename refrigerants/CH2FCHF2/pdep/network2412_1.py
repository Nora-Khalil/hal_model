species(
    label = '[O]C(F)C(F)(F)C(O)(F)F(9005)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.292803,'amu*angstrom^2'), symmetry=1, barrier=(6.73212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.565774,'amu*angstrom^2'), symmetry=1, barrier=(13.0083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292513,'amu*angstrom^2'), symmetry=1, barrier=(6.72545,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.204144,0.0991034,-0.000154567,1.2224e-07,-3.80524e-11,-155272,30.3008], Tmin=(100,'K'), Tmax=(790.525,'K')), NASAPolynomial(coeffs=[14.5859,0.0242631,-1.25516e-05,2.46897e-09,-1.73444e-13,-157610,-37.5751], Tmin=(790.525,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1292.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH))"""),
)
...
species(
    label = '[O]C(F)C(O)(F)C(F)(F)F(9326)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1192.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,348,427,405,1245,1236,1280,223,363,546,575,694,1179,1410,2782.5,750,1395,475,1775,1000,225.061],'cm^-1')),
        HinderedRotor(inertia=(0.203723,'amu*angstrom^2'), symmetry=1, barrier=(7.13096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213833,'amu*angstrom^2'), symmetry=1, barrier=(7.17651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.453826,'amu*angstrom^2'), symmetry=1, barrier=(16.7047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.637868,0.0798409,-0.000117251,8.99184e-08,-2.75454e-11,-143368,26.3863], Tmin=(100,'K'), Tmax=(798.644,'K')), NASAPolynomial(coeffs=[11.769,0.0240872,-1.25288e-05,2.49547e-09,-1.77513e-13,-145146,-24.8115], Tmin=(798.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1192.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdCsH)"""),
)
...
species(
    label = 'O=C(F)C(F)(F)C(O)(F)F(9328)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.236304,'amu*angstrom^2'), symmetry=1, barrier=(5.4331,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236656,'amu*angstrom^2'), symmetry=1, barrier=(5.4412,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.152885,0.0915214,-0.000146222,1.19569e-07,-3.86892e-11,-173900,29.0451], Tmin=(100,'K'), Tmax=(759.787,'K')), NASAPolynomial(coeffs=[12.9667,0.0240372,-1.29442e-05,2.58469e-09,-1.82964e-13,-175846,-29.2495], Tmin=(759.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1446.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(COCsFO)"""),
)

species(
    label = '[O]C(F)[C](F)C(O)(F)F(9329)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.309584,'amu*angstrom^2'), symmetry=1, barrier=(7.11794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310113,'amu*angstrom^2'), symmetry=1, barrier=(7.1301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309115,'amu*angstrom^2'), symmetry=1, barrier=(7.10716,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.675434,0.0832869,-0.0001177,6.65778e-08,-2.4634e-12,-106569,28.9722], Tmin=(100,'K'), Tmax=(569.088,'K')), NASAPolynomial(coeffs=[11.7663,0.0243984,-1.27378e-05,2.49176e-09,-1.73453e-13,-108140,-20.9953], Tmin=(569.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-886.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsCsF1s)"""),
)

species(
    label = '[O]C(F)C(F)(F)[C](O)F(9330)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.28978,'amu*angstrom^2'), symmetry=1, barrier=(6.66261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289411,'amu*angstrom^2'), symmetry=1, barrier=(6.65413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288988,'amu*angstrom^2'), symmetry=1, barrier=(6.64439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00806813,0.101516,-0.00019192,1.77338e-07,-6.15157e-11,-105185,29.9004], Tmin=(100,'K'), Tmax=(868.939,'K')), NASAPolynomial(coeffs=[9.59016,0.0281451,-1.48789e-05,2.85225e-09,-1.9318e-13,-105752,-8.71653], Tmin=(868.939,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-875.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = '[O][CH]C(F)(F)C(O)(F)F(9331)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-909.761,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,3025,407.5,1350,352.5,180,1092.31,1097.25],'cm^-1')),
        HinderedRotor(inertia=(0.143001,'amu*angstrom^2'), symmetry=1, barrier=(3.28787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146467,'amu*angstrom^2'), symmetry=1, barrier=(3.36756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143606,'amu*angstrom^2'), symmetry=1, barrier=(3.30179,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.558497,0.0867615,-0.00015412,1.45497e-07,-5.30287e-11,-109306,29.8157], Tmin=(100,'K'), Tmax=(823.098,'K')), NASAPolynomial(coeffs=[6.9997,0.0338554,-1.83348e-05,3.6297e-09,-2.53823e-13,-109634,4.44014], Tmin=(823.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-909.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)
...
species(
    label = '[O]C(F)C(F)(F)C([O])(F)F(9333)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.275697,'amu*angstrom^2'), symmetry=1, barrier=(6.33881,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0497978,0.0959156,-0.00015663,1.29573e-07,-4.2105e-11,-124011,30.3298], Tmin=(100,'K'), Tmax=(784.971,'K')), NASAPolynomial(coeffs=[13.6951,0.023101,-1.21869e-05,2.39759e-09,-1.67666e-13,-126083,-32.1091], Tmin=(784.971,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1032.24,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + radical(O2sj(Cs-CsF1sF1s)) + radical(O2sj(Cs-CsF1sH))"""),
)
...
species(
    label = '[O][C](F)C(F)(F)C(O)(F)F(9334)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1098.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,395,473,707,1436,180,180,3231.25],'cm^-1')),
        HinderedRotor(inertia=(0.363917,'amu*angstrom^2'), symmetry=1, barrier=(8.36716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.363711,'amu*angstrom^2'), symmetry=1, barrier=(8.36243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.363971,'amu*angstrom^2'), symmetry=1, barrier=(8.36841,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.448563,0.1143,-0.000225479,2.10748e-07,-7.31195e-11,-131960,32.0854], Tmin=(100,'K'), Tmax=(878.513,'K')), NASAPolynomial(coeffs=[10.1238,0.0287559,-1.55478e-05,2.97206e-09,-1.99579e-13,-132374,-9.33511], Tmin=(878.513,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1098.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = '[O]C(F)C(F)(F)C(=O)F(9335)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.335753,'amu*angstrom^2'), symmetry=1, barrier=(7.71962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.335757,'amu*angstrom^2'), symmetry=1, barrier=(7.7197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.881272,0.0742551,-0.00011105,8.70024e-08,-2.72534e-11,-119886,26.7341], Tmin=(100,'K'), Tmax=(781.267,'K')), NASAPolynomial(coeffs=[10.9671,0.0226104,-1.18825e-05,2.37099e-09,-1.68618e-13,-121462,-19.4334], Tmin=(781.267,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-997.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(COCsFO) + radical(O2sj(Cs-CsF1sH))"""),
)
...
species(
    label = 'O[C](F)C(F)(F)C(O)(F)F(9338)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.690368,0.118172,-0.0002246,2.06072e-07,-7.09962e-11,-159201,32.0502], Tmin=(100,'K'), Tmax=(868.064,'K')), NASAPolynomial(coeffs=[11.5026,0.0297309,-1.60369e-05,3.08952e-09,-2.09532e-13,-160102,-18.0482], Tmin=(868.064,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1324.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = '[O]C(F)(F)C(F)(F)C(O)F(9339)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1258.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,222,329,445,522,589,1214,1475,261,493,600,1152,1365,1422,3097,351,323,533,609,664,892,1120,1201,201.869,201.889],'cm^-1')),
        HinderedRotor(inertia=(0.233071,'amu*angstrom^2'), symmetry=1, barrier=(6.73271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234001,'amu*angstrom^2'), symmetry=1, barrier=(6.72796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.685064,'amu*angstrom^2'), symmetry=1, barrier=(19.7497,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.140401,0.0978155,-0.000147888,1.13124e-07,-3.41545e-11,-151258,29.764], Tmin=(100,'K'), Tmax=(813.366,'K')), NASAPolynomial(coeffs=[14.7266,0.0247017,-1.3052e-05,2.60653e-09,-1.85376e-13,-153676,-38.8897], Tmin=(813.366,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1258.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(O2sj(Cs-CsF1sF1s))"""),
)

species(
    label = 'OOC(F)C(F)(F)[C](F)F(9340)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.83693,'amu*angstrom^2'), symmetry=1, barrier=(42.2347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.623558,'amu*angstrom^2'), symmetry=1, barrier=(14.3368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.614987,'amu*angstrom^2'), symmetry=1, barrier=(14.1398,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.35543,'amu*angstrom^2'), symmetry=1, barrier=(8.17204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.355005,'amu*angstrom^2'), symmetry=1, barrier=(8.16227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.355286,'amu*angstrom^2'), symmetry=1, barrier=(8.16871,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53336,'amu*angstrom^2'), symmetry=1, barrier=(35.2549,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.741393,0.117938,-0.000218457,1.98579e-07,-6.85931e-11,-116232,31.8], Tmin=(100,'K'), Tmax=(849.589,'K')), NASAPolynomial(coeffs=[12.159,0.0304608,-1.67996e-05,3.29247e-09,-2.26785e-13,-117459,-22.6544], Tmin=(849.589,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-967.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CsCFHO) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = 'OC(F)(F)C(F)(F)[CH]OF(9154)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-994.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,215,315,519,588,595,1205,1248,223,363,546,575,694,1179,1410,3025,407.5,1350,352.5,294.298,294.767,295.096],'cm^-1')),
        HinderedRotor(inertia=(0.167257,'amu*angstrom^2'), symmetry=1, barrier=(10.3178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.405826,'amu*angstrom^2'), symmetry=1, barrier=(25.0298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167167,'amu*angstrom^2'), symmetry=1, barrier=(10.3127,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167934,'amu*angstrom^2'), symmetry=1, barrier=(10.3267,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.666506,0.112157,-0.000181184,1.3855e-07,-3.89737e-11,-119480,30.8144], Tmin=(100,'K'), Tmax=(667.984,'K')), NASAPolynomial(coeffs=[16.7234,0.0224918,-1.2324e-05,2.44861e-09,-1.71833e-13,-122126,-48.4813], Tmin=(667.984,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-994.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    ...
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
    products = ['[O]C(F)C(O)(F)C(F)(F)F(9326)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(O)F(1241)', 'CF2CF2(61)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(6)', 'OC(F)(F)C(F)(F)[CH]F(3193)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=CC(F)(F)C(O)(F)F(9327)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHFO(47)', 'OC(F)(F)[C](F)F(3192)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=C(F)C(F)(F)C(O)(F)F(9328)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)[C](F)C(O)(F)F(9329)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)C(F)(F)[C](O)F(9330)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O][CH]C(F)(F)C(O)(F)F(9331)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', '[O]C(F)C(F)(F)[C](F)F(9332)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C(F)(F)C([O])(F)F(9333)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](F)F(2562)', '[O]C(F)[C](F)F(429)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O][CH]F(388)', 'OC(F)(F)[C](F)F(3192)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O][C](F)C(F)(F)C(O)(F)F(9334)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[O]C(F)C(F)(F)C(=O)F(9335)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', '[O]C(F)C(F)=C(O)F(9336)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', '[O]C=C(F)C(O)(F)F(9337)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
    products = ['O[C](F)C(F)(F)C(O)(F)F(9338)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)(F)C(F)(F)C(O)F(9339)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OOC(F)C(F)(F)[C](F)F(9340)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction26',
    reactants = ['OC(F)(F)[C](F)C(F)OF(9341)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O[C](F)C(F)(F)C(F)OF(9342)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OC(F)(F)C(F)(F)[CH]OF(9154)'],
    products = ['[O]C(F)C(F)(F)C(O)(F)F(9005)'],
...
network(
    label = 'PDepNetwork #2412',
    isomers = [
        '[O]C(F)C(F)(F)C(O)(F)F(9005)',
    ],
    reactants = [
