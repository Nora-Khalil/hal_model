...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'O=C(C[C]F)OF(1337)'],
    products = ['O=C(CC(F)F)OF(1032)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C([CH]C(F)F)OF(1340)'],
    products = ['O=C(CC(F)F)OF(1032)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(C[CH]F)OF(1344)'],
    products = ['O=C(CC(F)F)OF(1032)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(=O)CC(F)F(1345)'],
    products = ['O=C(CC(F)F)OF(1032)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(128)', 'O=[C]CC(F)F(1346)'],
    products = ['O=C(CC(F)F)OF(1032)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=C([CH]C(F)F)OF(1348)'],
    products = ['O=C(CC(F)F)OF(1032)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(C[C](F)F)OF(1349)'],
    products = ['O=C(CC(F)F)OF(1032)'],
