...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC1(F)[CH]O1(7386)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[O]C1(F)[CH]O1(7529)'],
    products = ['F[CH]OC1(F)[CH]O1(7386)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC1=CO1(7559)'],
    products = ['F[CH]OC1(F)[CH]O1(7386)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[O]C1(F)[CH]O1(7529)'],
    products = ['F[CH]OC1(F)[CH]O1(7386)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]OC1(F)[CH]O1(7386)'],
    products = ['FC(F)O[C]1[CH]O1(7560)'],
