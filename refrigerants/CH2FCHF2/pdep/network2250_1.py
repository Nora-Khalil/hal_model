...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]=C(F)O[O](238)'],
    products = ['[CH]=C(F)OO[O](2134)'],
    transitionState = 'TS2',
