...
"""),
    E0 = (-245.664,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,182,240,577,636,1210,1413,180,2261.71],'cm^-1')),
        HinderedRotor(inertia=(0.238411,'amu*angstrom^2'), symmetry=1, barrier=(5.48153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80268,'amu*angstrom^2'), symmetry=1, barrier=(41.4472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79834,'amu*angstrom^2'), symmetry=1, barrier=(41.3474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79966,'amu*angstrom^2'), symmetry=1, barrier=(41.3778,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0516452,0.0975753,-0.000167803,1.53355e-07,-5.46839e-11,-29414.7,32.2567], Tmin=(100,'K'), Tmax=(814.99,'K')), NASAPolynomial(coeffs=[9.0179,0.0351099,-1.88612e-05,3.72897e-09,-2.60961e-13,-30263.2,-5.40508], Tmin=(814.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-245.664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)

species(
    label = 'F[C]=COOC(F)[CH]F(4210)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[CH]C(F)OO[C]=C(F)F(4211)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C]C(F)OOC=C(F)F-2(4213)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)OOC=C(F)F(4194)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)OOC=C(F)F(4194)'],
    products = ['O=CC(F)(F)OC(F)[CH]F(4203)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]C(F)OOC=C(F)F(4204)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', 'F[CH]OOC=C(F)F(4152)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'F[C]C(F)OOC=C(F)F(4205)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)OOC=C(F)F(4194)'],
    products = ['FC1OO[CH]C(F)(F)C1F(4206)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C(F)OOC=C(F)F(4194)'],
    products = ['F[C](F)C1OOC(F)C1F(4207)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=COOC=C(F)F(4208)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[CH][CH]OOC=C(F)F(4209)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[C]=COOC(F)[CH]F(4210)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'F[CH]C(F)OO[C]=C(F)F(4211)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)OOC=C(F)F(4194)'],
    products = ['O=C(F)[CH]F(215)', 'O=CC(F)F(3005)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'FC#COOC(F)[CH]F(4212)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHF(40)', 'F[CH]OOC=C(F)F(4152)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'F[C]C(F)OOC=C(F)F-2(4213)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]C(F)OOC=C(F)F(4194)'],
    products = ['FC[C](F)OOC=C(F)F(4008)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FCC(F)OO[C]=C(F)F(4214)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[CH]C(F)OOC=C(F)F(4194)'],
    products = ['FC(F)=COO[CH]C(F)F(4215)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[C]=COOC(F)C(F)F(4216)'],
    products = ['F[CH]C(F)OOC=C(F)F(4194)'],
