...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08248,0.0296446,1.82972e-05,-5.28696e-08,2.50007e-11,-107274,20.3906], Tmin=(100,'K'), Tmax=(917.289,'K')), NASAPolynomial(coeffs=[14.3028,0.00898177,-1.26549e-06,1.22894e-10,-9.76715e-15,-110888,-44.992], Tmin=(917.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-892.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCCFF) + group(CsCFHO) + group(Cds-OdCsOs) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-CO) + ring(Beta-Propiolactone)"""),
)

species(
    label = 'O=COC(F)=C(F)F(4084)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {7,S}
4 O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50456,0.0618692,-8.76504e-05,6.44192e-08,-1.72724e-11,-100086,21.0025], Tmin=(100,'K'), Tmax=(593.374,'K')), NASAPolynomial(coeffs=[8.00914,0.0254186,-1.42063e-05,2.91341e-09,-2.10681e-13,-100988,-8.0807], Tmin=(593.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-832.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + group(Cds-OdOsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.07547,'amu*angstrom^2'), symmetry=1, barrier=(15.2529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.31532,'amu*angstrom^2'), symmetry=1, barrier=(53.2338,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.026,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02133,0.0734041,-0.000132076,1.19971e-07,-4.21635e-11,-76442.1,21.3326], Tmin=(100,'K'), Tmax=(814.957,'K')), NASAPolynomial(coeffs=[9.08255,0.0209997,-1.19909e-05,2.40706e-09,-1.6925e-13,-77329.6,-13.293], Tmin=(814.957,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26234,0.0671471,-9.80441e-05,7.11229e-08,-1.82365e-11,-76013.1,23.1753], Tmin=(100,'K'), Tmax=(615.53,'K')), NASAPolynomial(coeffs=[9.49321,0.0228194,-1.23437e-05,2.48015e-09,-1.76731e-13,-77199.9,-13.9493], Tmin=(615.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-632.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdOsH) + radical(CsCsF1sO2s) + radical((O)CJOC)"""),
)

species(
    label = 'O=CO[C](F)[C](F)F(4140)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4914,0.0612357,-8.77852e-05,7.05358e-08,-2.3547e-11,-74646.3,25.8544], Tmin=(100,'K'), Tmax=(724.214,'K')), NASAPolynomial(coeffs=[7.90615,0.0258004,-1.43803e-05,2.95385e-09,-2.14161e-13,-75575.3,-3.02231], Tmin=(724.214,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-621.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdOsH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C]O[CH]C(F)(F)F(4141)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C(F)[C](F)F(429)'],
    products = ['O=[C]OC(F)[C](F)F(4089)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'O=[C]O[CH]F(515)'],
    products = ['O=[C]OC(F)[C](F)F(4089)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C(F)[C](F)F(429)'],
    products = ['O=[C]OC(F)[C](F)F(4089)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CO2(14)', 'F[CH][C](F)F(3610)'],
    products = ['O=[C]OC(F)[C](F)F(4089)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]OC=C(F)F(535)'],
    products = ['O=[C]OC(F)[C](F)F(4089)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(F)=C(F)F(4138)'],
    products = ['O=[C]OC(F)[C](F)F(4089)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C]=O(517)', 'F[CH][C](F)F(3610)'],
    products = ['O=[C]OC(F)[C](F)F(4089)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', 'O=[C]O[CH]F(515)'],
    products = ['O=[C]OC(F)[C](F)F(4089)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OC(F)[C](F)F(4089)'],
    products = ['O=[C]O[CH]C(F)(F)F(4141)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OC(F)[C](F)F(4089)'],
    products = ['O=C(F)O[CH][C](F)F(3594)'],
