...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', 'O=[C]C[CH]F(6778)'],
    products = ['O=[C]CC(F)[C](F)F(8636)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(514)', '[CH2]C(F)[C](F)F(3771)'],
    products = ['O=[C]CC(F)[C](F)F(8636)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C(F)[C](F)F(3771)'],
    products = ['O=[C]CC(F)[C](F)F(8636)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]CC=C(F)F(6427)'],
    products = ['O=[C]CC(F)[C](F)F(8636)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]CC(F)=C(F)F(8644)'],
    products = ['O=[C]CC(F)[C](F)F(8636)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C=CC(F)[C](F)F(8478)'],
    products = ['O=[C]CC(F)[C](F)F(8636)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=[C]C=C[C](F)F(8645)'],
    products = ['O=[C]CC(F)[C](F)F(8636)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', 'O=[C]C[CH]F(6778)'],
    products = ['O=[C]CC(F)[C](F)F(8636)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]CC(F)[C](F)F(8636)'],
    products = ['O=[C][CH]C(F)C(F)F(8648)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=[C]CC(F)[C](F)F(8636)'],
    products = ['O=[C]C[CH]C(F)(F)F(8650)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=[C]CC(F)[C](F)F(8636)'],
    products = ['O=C(F)C[CH][C](F)F(8651)'],
