...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(284)', '[C]=C(4368)'],
    products = ['C=[C]OC=[C]F(8060)'],
    transitionState = 'TS2',
