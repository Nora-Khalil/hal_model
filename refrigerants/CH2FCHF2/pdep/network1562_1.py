...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.368429,'amu*angstrom^2'), symmetry=1, barrier=(8.47091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07197,'amu*angstrom^2'), symmetry=1, barrier=(24.6467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368647,'amu*angstrom^2'), symmetry=1, barrier=(8.47592,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.849747,'amu*angstrom^2'), symmetry=1, barrier=(19.5374,'kJ/mol'), semiclassical=False),
        ...
        HinderedRotor(inertia=(0.855428,'amu*angstrom^2'), symmetry=1, barrier=(19.668,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (166.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.769129,0.112956,-0.000179353,1.43579e-07,-4.52379e-11,-140952,29.8037], Tmin=(100,'K'), Tmax=(781.043,'K')), NASAPolynomial(coeffs=[15.9843,0.0271494,-1.45486e-05,2.89902e-09,-2.05005e-13,-143569,-46.8804], Tmin=(781.043,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1173.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFOO) + group(CsCsFHH)"""),
)

species(
    label = 'OCC(F)(F)C(F)(F)OF(5221)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (166.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.672718,0.111528,-0.000185073,1.56808e-07,-5.20737e-11,-141576,30.6056], Tmin=(100,'K'), Tmax=(804.241,'K')), NASAPolynomial(coeffs=[14.2467,0.028896,-1.5234e-05,2.99116e-09,-2.08629e-13,-143703,-36.427], Tmin=(804.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1178.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsHH)"""),
)

species(
    label = 'OC(CF)(OF)C(F)(F)F(5222)',
...
"""),
    ...
    molecularWeight = (166.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.46358,0.106298,-0.000131196,7.35204e-08,-1.54453e-11,-144702,31.795], Tmin=(100,'K'), Tmax=(1227.44,'K')), NASAPolynomial(coeffs=[29.4216,0.00224003,1.34024e-07,-7.19991e-11,4.55805e-15,-152027,-122.492], Tmin=(1227.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1204.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsOs) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsCsFHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.808952,'amu*angstrom^2'), symmetry=1, barrier=(18.5994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.809338,'amu*angstrom^2'), symmetry=1, barrier=(18.6083,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.533288,'amu*angstrom^2'), symmetry=1, barrier=(12.2613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.533723,'amu*angstrom^2'), symmetry=1, barrier=(12.2713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.046,'amu*angstrom^2'), symmetry=1, barrier=(24.0495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.532908,'amu*angstrom^2'), symmetry=1, barrier=(12.2526,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction2',
    reactants = ['OCF(781)', 'F[C]C(F)(F)OF(2807)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(488)', 'OC(F)([C]F)CF(4240)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'OC(F)([C]F)C(F)(F)OF(5218)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'OC(F)C(F)(F)OF(5219)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'OC(F)(F)C(F)(F)OF(5023)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)(OF)C(F)(F)CF(5220)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OC(F)(CF)C(F)(F)OF(5187)'],
    products = ['OCC(F)(F)C(F)(F)OF(5221)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OC(F)(CF)C(F)(F)OF(5187)'],
    products = ['OC(CF)(OF)C(F)(F)F(5222)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OF(482)', 'FCC(F)=C(F)OF(2821)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H2O(3)', 'FC=C(F)C(F)(F)OF(4512)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OF(482)', 'C=C(F)C(F)(F)OF(2823)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FOF(488)', 'OC(CF)=C(F)F(5223)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O[C](CF)C(F)(F)OF(5224)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'OC(F)(CF)[C](F)OF(5225)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', '[CH2]C(O)(F)C(F)(F)OF(5226)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', '[O]C(F)(F)C(O)(F)CF(5227)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OH(7)', 'FC[C](F)C(F)(F)OF(2819)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[O]C(F)(CF)C(F)(F)OF(5228)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]F(128)', 'OC(F)(CF)[C](F)F(4250)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FO[C](F)F(2563)', 'O[C](F)CF(2940)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2F(46)', 'O[C](F)C(F)(F)OF(5035)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(5)', 'OC(F)([CH]F)C(F)(F)OF(5229)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'O=C(CF)C(F)(F)OF(5230)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F2(78)', 'O=C(F)C(O)(F)CF(3275)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F2(78)', 'OC(CF)=C(F)OF(5231)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction29',
    reactants = ['F2(78)', 'C=C(O)C(F)(F)OF(5232)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction30',
    reactants = ['HF(38)', 'OC(=CF)C(F)(F)OF(5233)'],
    products = ['OC(F)(CF)C(F)(F)OF(5187)'],
...
reaction(
    label = 'reaction31',
    reactants = ['OC(F)(CF)C(F)(F)OF(5187)'],
    products = ['F2(78)', 'CF2O(49)', 'C=C(O)F(3010)'],
...
network(
    label = 'PDepNetwork #1562',
    isomers = [
        'OC(F)(CF)C(F)(F)OF(5187)',
    ],
    reactants = [
