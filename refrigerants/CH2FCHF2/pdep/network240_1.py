...
reaction(
    label = 'reaction2',
    reactants = ['H2O(3)', 'F[C]C(F)OF(479)'],
    products = ['OC(F)C(F)OF(1036)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'FC=C(F)OF(1049)'],
    products = ['OC(F)C(F)OF(1036)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[CH]C(F)OF(1052)'],
    products = ['OC(F)C(F)OF(1036)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)[CH]OF(1053)'],
    products = ['OC(F)C(F)OF(1036)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)C(O)F(1054)'],
    products = ['OC(F)C(F)OF(1036)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'F[CH]C(F)OF(494)'],
    products = ['OC(F)C(F)OF(1036)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)C(F)OF(1055)'],
    products = ['OC(F)C(F)OF(1036)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(128)', 'OC(F)[CH]F(802)'],
    products = ['OC(F)C(F)OF(1036)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]OF(363)', 'O[CH]F(361)'],
    products = ['OC(F)C(F)OF(1036)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O[C](F)C(F)OF(1056)'],
    products = ['OC(F)C(F)OF(1036)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)[C](F)OF(1057)'],
    products = ['OC(F)C(F)OF(1036)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC(F)OF(1058)'],
    products = ['OC(F)C(F)OF(1036)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(F)C(O)F(505)'],
    products = ['OC(F)C(F)OF(1036)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'OC=C(F)OF(1062)'],
    products = ['OC(F)C(F)OF(1036)'],
