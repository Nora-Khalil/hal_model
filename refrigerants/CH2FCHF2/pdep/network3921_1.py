...
"""),
    ...
    molecularWeight = (151.012,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.501258,0.0839592,-0.000138084,1.10146e-07,-3.35824e-11,-87586.1,26.8183], Tmin=(100,'K'), Tmax=(685.779,'K')), NASAPolynomial(coeffs=[13.1857,0.0176855,-9.99188e-06,2.02222e-09,-1.43728e-13,-89507.2,-30.9144], Tmin=(685.779,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-729.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = 'FOOC(F)(F)[C](F)F(14021)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {8,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'F[C](F)C(F)(F)F(11865)'],
    products = ['[O]OC(F)(F)C(F)(F)F(13321)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]OC(F)(F)F(3645)'],
    products = ['[O]OC(F)(F)C(F)(F)F(13321)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(219.572,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]OF(127)', 'F[C]C(F)(F)F(4171)'],
    products = ['[O]OC(F)(F)C(F)(F)F(13321)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(F)(F)C(F)(F)F(12762)'],
    products = ['[O]OC(F)(F)C(F)(F)F(13321)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]O[C](F)C(F)(F)F(9667)'],
    products = ['[O]OC(F)(F)C(F)(F)F(13321)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]OC(F)(F)[C](F)F(11866)'],
    products = ['[O]OC(F)(F)C(F)(F)F(13321)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.8422e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['CF3(45)', '[O]O[C](F)F(219)'],
    products = ['[O]OC(F)(F)C(F)(F)F(13321)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F2(78)', '[O]OC(F)=C(F)F(3744)'],
    products = ['[O]OC(F)(F)C(F)(F)F(13321)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOO[C](F)C(F)(F)F(14020)'],
    products = ['[O]OC(F)(F)C(F)(F)F(13321)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOOC(F)(F)[C](F)F(14021)'],
    products = ['[O]OC(F)(F)C(F)(F)F(13321)'],
...
network(
    ...
    isomers = [
        '[O]OC(F)(F)C(F)(F)F(13321)',
    ],
    reactants = [
        ('O2(2)', 'F[C](F)C(F)(F)F(11865)'),
        ('CF2(43)', '[O]OC(F)(F)F(3645)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
