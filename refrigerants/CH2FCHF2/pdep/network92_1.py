...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[CH]C(=O)F(323)'],
    products = ['[CH]=C(F)O[C]=O(359)'],
    transitionState = 'TS2',
