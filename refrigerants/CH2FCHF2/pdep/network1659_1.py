...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'O=[C]OC(F)(F)F(5888)'],
    products = ['O=C(O)OC(F)(F)F(5375)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(=O)OC(F)(F)F(5889)'],
    products = ['O=C(O)OC(F)(F)F(5375)'],
    transitionState = 'TS8',
