...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.0833,'amu*angstrom^2'), symmetry=1, barrier=(24.9072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08101,'amu*angstrom^2'), symmetry=1, barrier=(24.8547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08513,'amu*angstrom^2'), symmetry=1, barrier=(24.9493,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-538.262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([347,453,1141,1468,528,1116,1182,1331,1402,1494,3075,3110,617,898,1187,258.579,258.579,258.579,258.579],'cm^-1')),
        HinderedRotor(inertia=(0.213534,'amu*angstrom^2'), symmetry=1, barrier=(10.1316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.556197,'amu*angstrom^2'), symmetry=1, barrier=(26.3901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70366,0.0545345,-6.8539e-05,4.54569e-08,-1.22532e-11,-64658.7,19.7086], Tmin=(100,'K'), Tmax=(896.455,'K')), NASAPolynomial(coeffs=[9.52135,0.0196515,-1.01702e-05,2.04944e-09,-1.47815e-13,-66060.3,-17.1526], Tmin=(896.455,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-538.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.980034,'amu*angstrom^2'), symmetry=1, barrier=(22.5329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.980778,'amu*angstrom^2'), symmetry=1, barrier=(22.55,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.980366,'amu*angstrom^2'), symmetry=1, barrier=(22.5405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.290272,0.0859414,-0.000119467,8.11694e-08,-2.1574e-11,-69290.6,24.1702], Tmin=(100,'K'), Tmax=(923.701,'K')), NASAPolynomial(coeffs=[15.89,0.0183876,-9.76534e-06,1.99329e-09,-1.44765e-13,-72172.4,-49.8514], Tmin=(923.701,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-577.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO)"""),
)
...
"""),
    E0 = (-584.562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,261,493,600,1152,1365,1422,3097,3000,3100,440,815,1455,1000,180,304.676],'cm^-1')),
        HinderedRotor(inertia=(0.585643,'amu*angstrom^2'), symmetry=1, barrier=(13.4651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68474,'amu*angstrom^2'), symmetry=1, barrier=(38.7356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11704,'amu*angstrom^2'), symmetry=1, barrier=(2.69098,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17604,'amu*angstrom^2'), symmetry=1, barrier=(27.0395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18471,'amu*angstrom^2'), symmetry=1, barrier=(27.2388,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.21786,'amu*angstrom^2'), symmetry=1, barrier=(28.0009,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.665312,'amu*angstrom^2'), symmetry=1, barrier=(15.2968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.667118,'amu*angstrom^2'), symmetry=1, barrier=(15.3384,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (149.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.21088,0.0927293,-0.000142066,1.00552e-07,-2.29919e-11,-91721.9,26.4611], Tmin=(100,'K'), Tmax=(619.158,'K')), NASAPolynomial(coeffs=[13.439,0.0232183,-1.23012e-05,2.43133e-09,-1.70538e-13,-93665.7,-33.4841], Tmin=(619.158,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-763.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.724626,'amu*angstrom^2'), symmetry=1, barrier=(16.6606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.721349,'amu*angstrom^2'), symmetry=1, barrier=(16.5852,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'FCC(F)(F)OF(2923)'],
    products = ['FCC(F)(F)C(F)OF(4935)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2(8)', 'F[C]C(F)(F)C(F)OF(5426)'],
    products = ['FCC(F)(F)C(F)OF(4935)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(S)(25)', 'FOC(F)C(F)(F)F(5427)'],
    products = ['FCC(F)(F)C(F)OF(4935)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FCC(F)(F)[CH]OF(5428)'],
    products = ['FCC(F)(F)C(F)OF(4935)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FCC(F)(F)[C](F)OF(4941)'],
    products = ['FCC(F)(F)C(F)OF(4935)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)OF(5429)'],
    products = ['FCC(F)(F)C(F)OF(4935)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)CF(3000)'],
    products = ['FCC(F)(F)C(F)OF(4935)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'FCC(F)=C(F)OF(2936)'],
    products = ['FCC(F)(F)C(F)OF(4935)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'FC=C(F)C(F)OF(5430)'],
    products = ['FCC(F)(F)C(F)OF(4935)'],
