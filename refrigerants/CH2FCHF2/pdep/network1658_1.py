...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'O=C(O)OF(5568)'],
    products = ['O=C(OF)OC(F)F(5374)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)OF(5569)', 'CHF(40)'],
    products = ['O=C(OF)OC(F)F(5374)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(OF)O[CH]F(5575)'],
    products = ['O=C(OF)OC(F)F(5374)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(=O)OC(F)F(5666)'],
    products = ['O=C(OF)OC(F)F(5374)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(5574)', 'CHF2(82)'],
    products = ['O=C(OF)OC(F)F(5374)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(128)', 'O=[C]OC(F)F(4861)'],
    products = ['O=C(OF)OC(F)F(5374)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(OF)O[C](F)F(5667)'],
    products = ['O=C(OF)OC(F)F(5374)'],
