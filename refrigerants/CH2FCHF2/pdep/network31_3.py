...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C([O])(F)F(218)'],
    products = ['[CH2]C(F)(F)O[O](135)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]O[C](F)F(219)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)O[O](135)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['FC1(F)OO1(2642)', 'CH2(S)(25)'],
    products = ['FC1(F)COO1(220)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FC1(F)[CH]OO1(2647)'],
    products = ['FC1(F)COO1(220)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[C](F)F(230)'],
    products = ['[O]OC[C](F)F(134)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]O[O](231)'],
    products = ['[O]OC[C](F)F(134)'],
