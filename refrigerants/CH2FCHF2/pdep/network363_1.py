...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]O[C](F)C=O(2194)'],
    products = ['[O]OO[C](F)C=O(1691)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OOC(F)=C=O(2213)'],
    products = ['[O]OO[C](F)C=O(1691)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]O[O](129)', 'O=C[C]F-2(1738)'],
    products = ['[O]OO[C](F)C=O(1691)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(6)', '[CH]=C(F)OO[O](2216)'],
    products = ['[O]OO[C](F)C=O(1691)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', '[O]OO[C]=C=O(2220)'],
    products = ['[O]OO[C](F)C=O(1691)'],
