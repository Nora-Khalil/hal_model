...
"""),
    E0 = (-615.877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,197,221,431,657,2120,512.5,787.5,180,180,2246.2],'cm^-1')),
        HinderedRotor(inertia=(0.0995845,'amu*angstrom^2'), symmetry=1, barrier=(2.28964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00996721,'amu*angstrom^2'), symmetry=1, barrier=(35.6835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55182,'amu*angstrom^2'), symmetry=1, barrier=(35.6795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5521,'amu*angstrom^2'), symmetry=1, barrier=(35.6857,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-301.607,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,2950,3100,1380,975,1025,1650,197,221,431,657,2120,512.5,787.5,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
    ...
    molecularWeight = (152.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.881872,0.0783842,-0.000100381,5.70475e-08,-4.07349e-12,-36172.1,33.7229], Tmin=(100,'K'), Tmax=(557.821,'K')), NASAPolynomial(coeffs=[9.04093,0.0338428,-1.81604e-05,3.66374e-09,-2.6244e-13,-37299.6,-2.82475], Tmin=(557.821,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-301.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + missing(O2d-Cdd) + group(CdCFO) + group(Cds-CdsHH) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-579.192,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,395,473,707,1436,280,501,1494,1531,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (152.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09617,0.0206699,0.000137259,-2.2538e-07,9.67941e-11,-69516,27.9038], Tmin=(100,'K'), Tmax=(919.487,'K')), NASAPolynomial(coeffs=[34.9797,-0.0147479,1.23527e-05,-2.36367e-09,1.45058e-13,-80480.9,-158.462], Tmin=(919.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-579.192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsOsHH) + group(CsCFHO) + group(Cds-OdCsOs) + ring(Cycloheptane) + radical(CsCsF1sO2s) + radical(CsCOF1sO2s)"""),
)

species(
    label = '[O]C(F)[CH]OOC(F)=C=O(2458)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-267.818,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,391,562,707,872,1109,1210,1289,3137,3025,407.5,1350,352.5,197,221,431,657,2120,512.5,787.5,180,1020.61,1022.64],'cm^-1')),
        HinderedRotor(inertia=(0.135009,'amu*angstrom^2'), symmetry=1, barrier=(3.10412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.3341,'amu*angstrom^2'), symmetry=1, barrier=(53.6655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132909,'amu*angstrom^2'), symmetry=1, barrier=(3.05585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135941,'amu*angstrom^2'), symmetry=1, barrier=(3.12556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (152.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0838635,0.102462,-0.000183063,1.70722e-07,-6.13046e-11,-32076.2,34.9814], Tmin=(100,'K'), Tmax=(829.076,'K')), NASAPolynomial(coeffs=[8.46226,0.0367581,-1.99114e-05,3.92828e-09,-2.73725e-13,-32652.2,0.425529], Tmin=(829.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-267.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(CsCFHO) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(O2sj(Cs-CsF1sH)) + radical(CCsJOOC)"""),
)
...
"""),
    E0 = (-519.583,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1277.5,1000,3010,987.5,1337.5,450,1655,326,540,652,719,1357,197,221,431,657,2120,512.5,787.5,214.672,214.673],'cm^-1')),
        HinderedRotor(inertia=(1.10598,'amu*angstrom^2'), symmetry=1, barrier=(36.1683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00284396,'amu*angstrom^2'), symmetry=1, barrier=(6.40491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195854,'amu*angstrom^2'), symmetry=1, barrier=(6.40493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10599,'amu*angstrom^2'), symmetry=1, barrier=(36.1683,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (152.053,'amu'),
...
"""),
    E0 = (-207.214,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,197,221,431,657,1855,455,950,2120,512.5,787.5,2082.79,2088.87],'cm^-1')),
        HinderedRotor(inertia=(1.50512,'amu*angstrom^2'), symmetry=1, barrier=(34.6056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50652,'amu*angstrom^2'), symmetry=1, barrier=(34.6379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163743,'amu*angstrom^2'), symmetry=1, barrier=(3.76477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50829,'amu*angstrom^2'), symmetry=1, barrier=(34.6786,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37812,0.0693752,-6.97238e-05,-1.26916e-08,5.3768e-11,-24839.6,28.7118], Tmin=(100,'K'), Tmax=(484.026,'K')), NASAPolynomial(coeffs=[8.43967,0.0317328,-1.72636e-05,3.46979e-09,-2.46685e-13,-25765.9,-2.73873], Tmin=(484.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-207.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(CsCJ=O)"""),
)

species(
    label = 'O=C=[C]OOCC(=O)F(2460)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {3,S} {6,S}
...
"""),
    E0 = (-187.927,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,1685,370,2120,512.5,787.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.154436,'amu*angstrom^2'), symmetry=1, barrier=(3.55078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.869484,'amu*angstrom^2'), symmetry=1, barrier=(19.9912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153868,'amu*angstrom^2'), symmetry=1, barrier=(3.53774,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17294,'amu*angstrom^2'), symmetry=1, barrier=(49.9602,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583416,0.0822443,-0.000132276,1.14483e-07,-3.9511e-11,-22486.1,32.536], Tmin=(100,'K'), Tmax=(780.725,'K')), NASAPolynomial(coeffs=[9.8679,0.0278631,-1.47044e-05,2.91134e-09,-2.04936e-13,-23728.2,-8.62833], Tmin=(780.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-(Cds-O2d)OsHH) + group(COCsFO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-562.357,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,2782.5,750,1395,475,1775,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (152.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0347722,0.102671,-0.000186807,1.77635e-07,-6.45919e-11,-67504.1,43.8561], Tmin=(100,'K'), Tmax=(834.645,'K')), NASAPolynomial(coeffs=[7.19914,0.0392827,-2.12733e-05,4.18976e-09,-2.91379e-13,-67711.3,16.2569], Tmin=(834.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-562.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(COCsFO) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C=C(F)OOCC(=O)F(1918)'],
    products = ['O=CC(=O)F(335)', 'O=CC(=O)F(335)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(24.8375,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction3',
    reactants = ['C=C(F)OOOC(F)=C=O(2456)'],
    products = ['O=C=C(F)OOCC(=O)F(1918)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C1O[C](F)COO[C]1F(2457)'],
    products = ['O=C=C(F)OOCC(=O)F(1918)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)[CH]OOC(F)=C=O(2458)'],
    products = ['O=C=C(F)OOCC(=O)F(1918)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C=C(F)OOC=C(O)F(2294)'],
    products = ['O=C=C(F)OOCC(=O)F(1918)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=[C]COOC(F)=C=O(2459)'],
    products = ['O=C=C(F)OOCC(=O)F(1918)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C=[C]OOCC(=O)F(2460)'],
    products = ['O=C=C(F)OOCC(=O)F(1918)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]C(=O)F(1543)', '[O]CC(=O)F(1554)'],
    products = ['O=C=C(F)OOCC(=O)F(1918)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(1.81e+06,'m^3/(mol*s)'), n=0, Ea=(83.1687,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_N-2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_N-2R->C"""),
)

reaction(
    label = 'reaction14',
    reactants = ['[O]OC(F)=C=O(2248)', 'CH2CFO(79)'],
    products = ['O=C=C(F)OOCC(=O)F(1918)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(8.14976e+13,'m^3/(mol*s)'), n=-2.27223, Ea=(3.23308,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H"""),
)

reaction(
    label = 'reaction15',
    reactants = ['O=C=[C]F(289)', '[O]OCC(=O)F(2461)'],
    products = ['O=C=C(F)OOCC(=O)F(1918)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CFO(51)', '[CH2]OOC(F)=C=O(2246)'],
    products = ['O=C=C(F)OOCC(=O)F(1918)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C(F)[C-]=[O+]OCC(=O)F(2462)'],
    products = ['O=C=C(F)OOCC(=O)F(1918)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=C=C(F)OOCC(=O)F(1918)'],
    products = ['CO(13)', 'O=C(F)CO[O+]=[C-]F(2464)'],
