...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.854895,'amu*angstrom^2'), symmetry=1, barrier=(19.6557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.854781,'amu*angstrom^2'), symmetry=1, barrier=(19.6531,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C([O])(F)C=O(1581)'],
...
reaction(
    ...
    products = ['[CH]=C(F)C([O])(F)C=O(1581)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C([O])(F)C=O(1581)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(1582)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH]C(F)=C(F)C=O(1877)'],
    products = ['[CH]=C(F)C([O])(F)C=O(1581)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(F)C([O])(F)C=O(1581)'],
    products = ['[CH]=C(F)C1(F)[CH]OO1(1878)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(F)C([O])(F)C=O(1581)'],
    products = ['[O]C1(F)[CH]OC=C1F(1812)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(F)C([O])(F)C=O(1581)'],
    products = ['[CH]=C(F)C1(F)OC1[O](1879)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(F)C([O])(F)C=O(1581)'],
    products = ['[O]C1C=C(F)C1([O])F(1845)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(F)C(=O)C=O(1880)'],
    products = ['[CH]=C(F)C([O])(F)C=O(1581)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'C#CC([O])(F)C=O(1881)'],
    products = ['[CH]=C(F)C([O])(F)C=O(1581)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'C#CC([O])=C[O](1882)'],
    products = ['[CH]=C(F)C([O])(F)C=O(1581)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(F)C([O])(F)C=O(1581)'],
    products = ['[CH]=C(F)C(O)(F)[C]=O(1883)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(F)=C(C=O)OF(1885)'],
    products = ['[CH]=C(F)C([O])(F)C=O(1581)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=[C]C(F)(C=O)OF(1886)'],
    products = ['[CH]=C(F)C([O])(F)C=O(1581)'],
