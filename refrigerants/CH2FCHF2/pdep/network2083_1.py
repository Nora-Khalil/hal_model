...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', '[CH2]C(=O)[CH]F(6328)'],
    products = ['C=C([O])C(F)[C](F)F(3910)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)[C](F)F(7990)'],
    products = ['C=C([O])C(F)[C](F)F(3910)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C(F)[C](F)F(3910)'],
    products = ['F[C](F)C(F)[C]1CO1(7992)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C([O])C=C(F)F(6423)'],
    products = ['C=C([O])C(F)[C](F)F(3910)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C([O])C(F)=C(F)F(7995)'],
    products = ['C=C([O])C(F)[C](F)F(3910)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[CH2]C(=O)[CH]F(6328)'],
    products = ['C=C([O])C(F)[C](F)F(3910)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C([O])C(F)[C](F)F(3910)'],
    products = ['[CH2]C(O)=C(F)[C](F)F(7997)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(O)C(F)[C](F)F(7998)'],
    products = ['C=C([O])C(F)[C](F)F(3910)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C([O])C(F)C(F)F(7999)'],
    products = ['C=C([O])C(F)[C](F)F(3910)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(=C[C](F)F)OF(8000)'],
    products = ['C=C([O])C(F)[C](F)F(3910)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([O])C(F)[C](F)F(3910)'],
    products = ['[CH2]C([O])=CC(F)(F)F(8001)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(18)', 'O=[C]C(F)[C](F)F(4144)'],
    products = ['C=C([O])C(F)[C](F)F(3910)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C([O])C(F)[C](F)F(3910)'],
    products = ['[CH2][C]1OC(F)(F)C1F(8003)'],
