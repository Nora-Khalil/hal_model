...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[CH]C=CF(9821)'],
    products = ['[CH]=CC(F)[CH]F(9820)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[CH](4466)', 'CHFCHF[Z](59)'],
    products = ['[CH]=CC(F)[CH]F(9820)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](4466)', 'F[CH][CH]F(141)'],
    products = ['[CH]=CC(F)[CH]F(9820)'],
