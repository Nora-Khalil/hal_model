...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C(=C)[O](6417)'],
    products = ['[CH2]CC(=C)[O](9392)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]=O(4373)', 'C2H4(30)'],
    products = ['[CH2]CC(=C)[O](9392)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CO(28)', '[CH2][CH2](4372)'],
    products = ['[CH2]CC(=C)[O](9392)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]=O(4373)', '[CH2][CH2](4372)'],
    products = ['[CH2]CC(=C)[O](9392)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[CH2]C[C]=O(6367)'],
    products = ['[CH2]CC(=C)[O](9392)'],
