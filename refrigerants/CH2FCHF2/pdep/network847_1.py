...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'OC(F)[C]F-2(2938)'],
    products = ['OC(F)[C](F)F(787)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'O[CH]F(361)'],
    products = ['OC(F)[C](F)F(787)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O[CH][C](F)F(3554)'],
    products = ['OC(F)[C](F)F(787)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[C](F)[C](F)F(11789)'],
    products = ['OC(F)[C](F)F(787)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['OC(F)[C](F)F(787)'],
    products = ['O[C](F)C(F)F(7084)'],
