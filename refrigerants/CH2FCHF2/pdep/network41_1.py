...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH]C(=C)F(277)'],
    products = ['[CH]=C(F)C[C](F)F(243)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)C=C(F)F(280)'],
    products = ['[CH]=C(F)C[C](F)F(243)'],
    transitionState = 'TS7',
