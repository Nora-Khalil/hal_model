...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.748089,0.0790344,-0.000134222,1.16719e-07,-3.89912e-11,-15433.4,22.5164], Tmin=(100,'K'), Tmax=(863.632,'K')), NASAPolynomial(coeffs=[9.75618,0.022717,-1.1057e-05,2.07428e-09,-1.39858e-13,-16445,-16.4704], Tmin=(863.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cds-CdsCsH) + group(CdCFH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(F)(F)C#C(13596)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29869,0.0641982,-8.83158e-05,6.12719e-08,-1.52942e-11,8729.69,19.636], Tmin=(100,'K'), Tmax=(674.176,'K')), NASAPolynomial(coeffs=[10.1335,0.0202349,-9.31164e-06,1.74978e-09,-1.20119e-13,7346.31,-20.9284], Tmin=(674.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.8105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC(F)(F)C#CF(13597)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.4834,'amu*angstrom^2'), symmetry=1, barrier=(34.1063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.46865,'amu*angstrom^2'), symmetry=1, barrier=(33.7672,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.915919,0.0754591,-0.000127662,1.13443e-07,-3.91286e-11,-3258.49,23.3104], Tmin=(100,'K'), Tmax=(836.395,'K')), NASAPolynomial(coeffs=[8.66074,0.0248841,-1.26846e-05,2.44871e-09,-1.68727e-13,-4080.58,-9.8399], Tmin=(836.395,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(CtCF) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.80028,'amu*angstrom^2'), symmetry=1, barrier=(41.3921,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16495,0.0668479,-0.000106713,8.65621e-08,-2.67246e-11,25686.8,21.0734], Tmin=(100,'K'), Tmax=(928.727,'K')), NASAPolynomial(coeffs=[10.1443,0.0164878,-6.50093e-06,1.07834e-09,-6.64894e-14,24522.9,-18.8695], Tmin=(928.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(212.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(CdCFH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CJC=C) + radical(C=C=CJ)"""),
)

species(
    label = 'C=[C]C(F)(F)[C]=CF(10856)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.28008,'amu*angstrom^2'), symmetry=1, barrier=(29.4315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27782,'amu*angstrom^2'), symmetry=1, barrier=(29.3796,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.790439,0.07704,-0.000121182,1.03908e-07,-3.56926e-11,-4197.85,25.1682], Tmin=(100,'K'), Tmax=(776.722,'K')), NASAPolynomial(coeffs=[9.42904,0.0270398,-1.39753e-05,2.7545e-09,-1.93693e-13,-5373.52,-13.2549], Tmin=(776.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.8125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH) + radical(Cdj(Cd-CsH)(F1s)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C(F)(F)C=CF(13599)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.27459,'amu*angstrom^2'), symmetry=1, barrier=(29.3053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27813,'amu*angstrom^2'), symmetry=1, barrier=(29.3866,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.072,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.23283,'amu*angstrom^2'), symmetry=1, barrier=(28.3452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23369,'amu*angstrom^2'), symmetry=1, barrier=(28.365,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.801632,0.0784984,-0.000130797,1.17922e-07,-4.17226e-11,-5312.99,25.1964], Tmin=(100,'K'), Tmax=(814.564,'K')), NASAPolynomial(coeffs=[8.09573,0.0291968,-1.51805e-05,2.97621e-09,-2.07669e-13,-6053.98,-5.75166], Tmin=(814.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.0669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]C=C(F)C(F)=CF(13601)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.34285,'amu*angstrom^2'), symmetry=1, barrier=(30.8748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34803,'amu*angstrom^2'), symmetry=1, barrier=(30.9938,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.675929,0.0791293,-0.000123249,1.02923e-07,-3.43304e-11,-3222.51,24.989], Tmin=(100,'K'), Tmax=(776.336,'K')), NASAPolynomial(coeffs=[10.4312,0.025452,-1.29393e-05,2.53135e-09,-1.77247e-13,-4634.29,-18.942], Tmin=(776.336,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.7411,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(Cds-CdsCsH) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cd-CsF1s)(H)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF-2(3543)', '[CH]C=C(F)F(8897)'],
    products = ['[CH]=CC(F)(F)[C]=CF(13577)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=CC(F)=C=CF(13595)'],
    products = ['[CH]=CC(F)(F)[C]=CF(13577)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#CC(F)(F)[C]=CF(10101)'],
    products = ['[CH]=CC(F)(F)[C]=CF(13577)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=CC(F)(F)C#C(13596)'],
    products = ['[CH]=CC(F)(F)[C]=CF(13577)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]=CC(F)(F)C#CF(13597)'],
    products = ['[CH]=CC(F)(F)[C]=CF(13577)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C(F)[C]=CF(10104)'],
    products = ['[CH]=CC(F)(F)[C]=CF(13577)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC(F)(F)C=[C]F(13598)'],
    products = ['[CH]=CC(F)(F)[C]=CF(13577)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C]C(F)(F)C=CF(13599)'],
    products = ['[CH]=CC(F)(F)[C]=CF(13577)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=CC(F)(F)[C]=[C]F(13600)'],
    products = ['[CH]=CC(F)(F)[C]=CF(13577)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC(F)(F)[C]=CF(13577)'],
    products = ['[CH]C=C(F)C(F)=CF(13601)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=CC(F)(F)C(=[CH])F(13602)'],
    products = ['[CH]=CC(F)(F)[C]=CF(13577)'],
