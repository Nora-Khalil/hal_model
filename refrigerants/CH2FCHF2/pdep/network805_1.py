...
"""),
    E0 = (-691.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,334,575,1197,1424,3202,580,1155,1237,1373,3147,180,180,180,1399.52],'cm^-1')),
        HinderedRotor(inertia=(0.282042,'amu*angstrom^2'), symmetry=1, barrier=(6.48471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288096,'amu*angstrom^2'), symmetry=1, barrier=(6.62389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.96554,'amu*angstrom^2'), symmetry=1, barrier=(45.1917,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.876119,0.0762015,-0.000128052,1.14804e-07,-4.05951e-11,-83011.7,26.4102], Tmin=(100,'K'), Tmax=(791.075,'K')), NASAPolynomial(coeffs=[8.87451,0.0258693,-1.38629e-05,2.77139e-09,-1.959e-13,-83967.7,-8.34716], Tmin=(791.075,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-691.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.168194,'amu*angstrom^2'), symmetry=1, barrier=(3.8671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168157,'amu*angstrom^2'), symmetry=1, barrier=(3.86627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.789105,'amu*angstrom^2'), symmetry=1, barrier=(18.1431,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[CH]F(3678)'],
...
reaction(
    ...
    products = ['F[CH]OC(F)(F)[CH]F(3678)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=CF(389)'],
    products = ['F[CH]OC(F)(F)[CH]F(3678)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]O[C](F)C(F)F(3771)'],
    products = ['F[CH]OC(F)(F)[CH]F(3678)'],
