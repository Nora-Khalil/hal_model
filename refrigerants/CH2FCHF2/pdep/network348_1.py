...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC=[C]F(1726)'],
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]OC=[C]F(1726)'],
    products = ['F[C]1[CH]OC=C(F)O1(1951)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)[CH]OC#CF(1953)'],
    products = ['O=C(F)[CH]OC=[C]F(1726)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C=COC=[C]F(1954)'],
    products = ['O=C(F)[CH]OC=[C]F(1726)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(6)', 'F[C]=COC=[C]F(1958)'],
    products = ['O=C(F)[CH]OC=[C]F(1726)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C=[C]OC=[C]F(1945)'],
    products = ['O=C(F)[CH]OC=[C]F(1726)'],
