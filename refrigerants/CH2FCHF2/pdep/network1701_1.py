...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.08801,'amu*angstrom^2'), symmetry=1, barrier=(25.0155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08797,'amu*angstrom^2'), symmetry=1, barrier=(25.0147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08801,'amu*angstrom^2'), symmetry=1, barrier=(25.0154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08796,'amu*angstrom^2'), symmetry=1, barrier=(25.0144,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0897377,0.0944654,-0.000160325,1.40238e-07,-4.82161e-11,-68683.4,28.1271], Tmin=(100,'K'), Tmax=(792.48,'K')), NASAPolynomial(coeffs=[11.6009,0.0269961,-1.48901e-05,2.97726e-09,-2.09889e-13,-70213.7,-22.8746], Tmin=(792.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-572.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(CsFHHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.211597,0.0907933,-0.000133975,1.08249e-07,-3.55372e-11,-112434,27.6196], Tmin=(100,'K'), Tmax=(742.522,'K')), NASAPolynomial(coeffs=[10.9325,0.0330302,-1.72662e-05,3.44597e-09,-2.45268e-13,-114025,-20.9089], Tmin=(742.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-935.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFFO) + group(CsFHHO)"""),
)

species(
    label = 'FCOC(F)(F)COF(5437)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.211587,0.0907935,-0.000133975,1.0825e-07,-3.55374e-11,-112434,27.6197], Tmin=(100,'K'), Tmax=(742.445,'K')), NASAPolynomial(coeffs=[10.9324,0.0330302,-1.72662e-05,3.44597e-09,-2.45268e-13,-114025,-20.9089], Tmin=(742.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-935.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFFO) + group(Cs-CsOsHH) + group(CsFHHO)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.775174,0.077665,-0.000110644,8.76179e-08,-2.84711e-11,-59963.6,27.3043], Tmin=(100,'K'), Tmax=(747.088,'K')), NASAPolynomial(coeffs=[9.57086,0.0305698,-1.60822e-05,3.2314e-09,-2.31358e-13,-61277.7,-12.5648], Tmin=(747.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-499.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(CsFHHO) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(F)(OF)OCF(5440)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-535.252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,364,474,579,619,655,1345,548,1085,1183,1302,1466,1520,3060,3119,3000,3100,440,815,1455,1000,225.95,225.954,225.954,225.956],'cm^-1')),
        HinderedRotor(inertia=(0.188429,'amu*angstrom^2'), symmetry=1, barrier=(6.82674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188425,'amu*angstrom^2'), symmetry=1, barrier=(6.82672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844721,'amu*angstrom^2'), symmetry=1, barrier=(30.6047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844745,'amu*angstrom^2'), symmetry=1, barrier=(30.6047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.224538,0.090635,-0.000145267,1.24665e-07,-4.27259e-11,-64247.2,25.8445], Tmin=(100,'K'), Tmax=(770.923,'K')), NASAPolynomial(coeffs=[10.8688,0.0297388,-1.57521e-05,3.12844e-09,-2.20748e-13,-65720,-21.646], Tmin=(770.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-535.252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(Cs-CsHHH) + group(CsFHHO) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)

species(
    label = '[CH2]OC(F)(CF)OF(5441)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-521.772,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,300.891,300.891,300.891,300.891],'cm^-1')),
        HinderedRotor(inertia=(0.488323,'amu*angstrom^2'), symmetry=1, barrier=(31.3728,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['H2(8)', 'F[C]C(F)(OF)OCF(5435)'],
    products = ['FCOC(F)(CF)OF(5409)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FCOC(F)OF(1035)'],
    products = ['FCOC(F)(CF)OF(5409)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'FCOC(F)(F)OF(5206)'],
    products = ['FCOC(F)(CF)OF(5409)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'FCC(F)(OF)OF(5193)'],
    products = ['FCOC(F)(CF)OF(5409)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['FCOF(367)', 'C=C(F)OF(3013)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOF(488)', 'C=C(F)OCF(5438)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FCO[C](CF)OF(5439)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)(OF)OCF(5440)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]OC(F)(CF)OF(5441)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(F)(CF)OCF(5442)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]CF(362)', 'FC[C](F)OF(3020)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(46)', '[O]C(F)(CF)OF(5201)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]F(128)', 'FCO[C](F)CF(3377)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2F(46)', 'FCO[C](F)OF(1045)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'F[CH]C(F)(OF)OCF(5443)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'F[CH]OC(F)(CF)OF(5199)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'O=C(CF)OCF(5444)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'C=C(OF)OCF(5445)'],
    products = ['FCOC(F)(CF)OF(5409)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'FC=C(OF)OCF(1273)'],
    products = ['FCOC(F)(CF)OF(5409)'],
