...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C([O])=C=O(4742)'],
    products = ['[CH2]C(=O)C([O])=O(4611)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([O])=C=O(7256)'],
    products = ['[CH2]C(=O)C([O])=O(4611)'],
    transitionState = 'TS4',
