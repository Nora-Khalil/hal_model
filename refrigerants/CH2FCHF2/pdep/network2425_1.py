...
"""),
    E0 = (121.543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3010,987.5,1337.5,450,1655,326,540,652,719,1357,401.755,401.788,401.796,401.884],'cm^-1')),
        HinderedRotor(inertia=(0.447223,'amu*angstrom^2'), symmetry=1, barrier=(51.183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.446444,'amu*angstrom^2'), symmetry=1, barrier=(51.1832,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C(F)F(8897)'],
    products = ['[CH]=CC([O])(F)F(9359)'],
    transitionState = 'TS2',
