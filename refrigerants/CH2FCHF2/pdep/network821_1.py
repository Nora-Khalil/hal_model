...
"""),
    ...
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.705162,0.0792595,-0.000132133,1.14159e-07,-3.86193e-11,-44985.7,24.2428], Tmin=(100,'K'), Tmax=(808.361,'K')), NASAPolynomial(coeffs=[10.5351,0.0224631,-1.16093e-05,2.2816e-09,-1.59435e-13,-46308.5,-19.4417], Tmin=(808.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C(F)[C](F)F(3842)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(F)C(F)[C](F)F(3842)'],
    products = ['[CH]=C(F)C(F)(F)[CH]F(3841)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH]C(F)=CF(260)'],
    products = ['[CH]=C(F)C(F)[C](F)F(3842)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)C=C(F)F(280)'],
    products = ['[CH]=C(F)C(F)[C](F)F(3842)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]F(252)', 'CHFCF2(55)'],
    products = ['[CH]=C(F)C(F)[C](F)F(3842)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C(F)=C(F)F(3881)'],
    products = ['[CH]=C(F)C(F)[C](F)F(3842)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CC(F)[C](F)F(3882)'],
    products = ['[CH]=C(F)C(F)[C](F)F(3842)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C2HF(58)', 'F[CH][C](F)F(3610)'],
    products = ['[CH]=C(F)C(F)[C](F)F(3842)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]F(252)', 'F[CH][C](F)F(3610)'],
    products = ['[CH]=C(F)C(F)[C](F)F(3842)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[CH]=C=C[C](F)F(282)'],
    products = ['[CH]=C(F)C(F)[C](F)F(3842)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH]C(F)=CF(260)'],
    products = ['[CH]=C(F)C(F)[C](F)F(3842)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(F)C(F)[C](F)F(3842)'],
    products = ['[CH]C(F)=C(F)C(F)F(3884)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C(F)[C](F)F(3842)'],
    products = ['[CH2]C(F)=C(F)[C](F)F(3737)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(F)C(F)[C](F)F(3842)'],
    products = ['F[CH]C(F)=C[C](F)F(3699)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(F)C(F)[C](F)F(3842)'],
    products = ['[CH]=[C]C(F)C(F)(F)F(3886)'],
