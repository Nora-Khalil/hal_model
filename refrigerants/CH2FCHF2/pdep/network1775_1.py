...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC([O])(F)F(2675)'],
    products = ['[O]OOC([O])(F)F(6309)'],
    transitionState = 'TS2',
