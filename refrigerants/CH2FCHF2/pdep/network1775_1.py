...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](2715)', 'O=C[C]F(284)'],
    products = ['[O]CO[C](F)C=O(6171)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=CO[C](F)C=O(2108)'],
    products = ['[O]CO[C](F)C=O(6171)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]COC(F)=C=O(6676)'],
    products = ['[O]CO[C](F)C=O(6171)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C[O](2715)', 'O=C[C]F-2(1596)'],
    products = ['[O]CO[C](F)C=O(6171)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(6)', '[CH]=C(F)OC[O](6681)'],
    products = ['[O]CO[C](F)C=O(6171)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', '[O]CO[C]=C=O(6684)'],
    products = ['[O]CO[C](F)C=O(6171)'],
