...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=C(O)O[C](F)F(6012)'],
    products = ['O=C(O)OC(F)(F)F(5372)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'O=[C]OC(F)(F)F(6013)'],
    products = ['O=C(O)OC(F)(F)F(5372)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(=O)OC(F)(F)F(6014)'],
    products = ['O=C(O)OC(F)(F)F(5372)'],
    transitionState = 'TS8',
