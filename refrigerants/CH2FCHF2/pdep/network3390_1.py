...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(=O)O(5771)'],
    products = ['C=C(O)O[O](3976)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]=C(O)O[O](14188)'],
    products = ['C=C(O)O[O](3976)'],
    transitionState = 'TS9',
