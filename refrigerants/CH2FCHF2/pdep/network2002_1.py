...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[O]C1O[C]1F(7517)'],
    products = ['F[CH]OC1O[C]1F(7387)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]O[CH]F(1755)'],
    products = ['F[CH]OC1O[C]1F(7387)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]OC1=C(F)O1(7556)'],
    products = ['F[CH]OC1O[C]1F(7387)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[O]C1O[C]1F(7517)'],
    products = ['F[CH]OC1O[C]1F(7387)'],
