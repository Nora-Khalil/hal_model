...
species(
    label = '[O]C(F)(F)OC1(F)[CH]O1(6312)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[O][CH]C1(F)OC(F)(F)O1(6322)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(2711)', 'O=C[C]F(284)'],
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)O[C](F)C=O(6202)'],
    products = ['[O]C(F)(F)OC1(F)[CH]O1(6312)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C[C](F)OC(=O)F(2109)'],
    products = ['[O]C(F)(F)O[C](F)C=O(6202)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C([O])(F)F(2711)', 'O=C[C]F-2(1596)'],
    products = ['[O]C(F)(F)O[C](F)C=O(6202)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)(F)O[C](F)C=O(6202)'],
    products = ['O=[C][C](F)OC(O)(F)F(6317)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C[C](F)O[C](F)OF(6318)'],
    products = ['[O]C(F)(F)O[C](F)C=O(6202)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O][C](F)OC(F)(F)C=O(6319)'],
    products = ['[O]C(F)(F)O[C](F)C=O(6202)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(6)', '[CH]=C(F)OC([O])(F)F(6320)'],
    products = ['[O]C(F)(F)O[C](F)C=O(6202)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(F)O[C](F)C=O(6202)'],
    products = ['[O][CH]C1(F)OC(F)(F)O1(6322)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O=C(F)O[C](F)[CH]OF(6325)'],
    products = ['[O]C(F)(F)O[C](F)C=O(6202)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C=[C]OC(F)(F)OF(6326)'],
    products = ['[O]C(F)(F)O[C](F)C=O(6202)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C(F)(F)O[C]=COF(6327)'],
    products = ['[O]C(F)(F)O[C](F)C=O(6202)'],
