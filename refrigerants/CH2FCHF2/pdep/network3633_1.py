...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.20287,'amu*angstrom^2'), symmetry=1, barrier=(27.6564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2023,'amu*angstrom^2'), symmetry=1, barrier=(27.6432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20674,'amu*angstrom^2'), symmetry=1, barrier=(27.7453,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.16078,0.0719709,-7.99169e-05,4.14812e-08,-8.11214e-12,-17137.7,25.1528], Tmin=(100,'K'), Tmax=(1354.94,'K')), NASAPolynomial(coeffs=[21.067,0.00552341,-1.12039e-06,1.35324e-10,-8.14576e-15,-22369,-80.4563], Tmin=(1354.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cds_P)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79128,0.0462864,-4.1994e-05,1.95857e-08,-3.6799e-12,3894.53,20.7811], Tmin=(100,'K'), Tmax=(1270.86,'K')), NASAPolynomial(coeffs=[11.1433,0.0168511,-7.25145e-06,1.36049e-09,-9.46869e-14,1517.51,-26.5786], Tmin=(1270.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.7044,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52476,0.0572991,-6.75406e-05,4.21405e-08,-1.06492e-11,-16170,22.5182], Tmin=(100,'K'), Tmax=(956.231,'K')), NASAPolynomial(coeffs=[10.3131,0.0205366,-9.87265e-06,1.93523e-09,-1.37746e-13,-17850.7,-19.4869], Tmin=(956.231,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-135.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(3008)', '[CH]=C[O](4002)'],
    products = ['[CH]=CO[C](F)CF(13575)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=COC(=C)F(13581)'],
    products = ['[CH]=CO[C](F)CF(13575)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=COC(F)=CF(13582)'],
    products = ['[CH]=CO[C](F)CF(13575)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#CO[C](F)CF(3147)'],
    products = ['[CH]=CO[C](F)CF(13575)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C]CF(126)', '[CH]=C[O](4002)'],
    products = ['[CH]=CO[C](F)CF(13575)'],
