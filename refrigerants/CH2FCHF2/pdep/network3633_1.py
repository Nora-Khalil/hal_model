...
"""),
    E0 = (-678.893,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,431,527,613,668,835,1199,1245,1322,3000,3100,440,815,1455,1000,180,180,1461.16,1461.44],'cm^-1')),
        HinderedRotor(inertia=(0.216964,'amu*angstrom^2'), symmetry=1, barrier=(4.98844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216965,'amu*angstrom^2'), symmetry=1, barrier=(4.98846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216867,'amu*angstrom^2'), symmetry=1, barrier=(4.98619,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03564,0.0728044,-0.000117697,1.07016e-07,-3.87084e-11,-81552.6,27.6381], Tmin=(100,'K'), Tmax=(796.429,'K')), NASAPolynomial(coeffs=[7.0452,0.0307254,-1.60397e-05,3.16625e-09,-2.22471e-13,-82132.5,2.38198], Tmin=(796.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-678.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFFFO) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = 'CC(=O)OC(F)(F)F(3695)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71217,0.0482619,-3.67239e-05,1.38183e-08,-2.11643e-12,-132151,22.8558], Tmin=(100,'K'), Tmax=(1505.82,'K')), NASAPolynomial(coeffs=[11.937,0.0211015,-9.66875e-06,1.84043e-09,-1.27863e-13,-135231,-30.6585], Tmin=(1505.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1099.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(CsFFFO) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdCsOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0203711,'amu*angstrom^2'), symmetry=1, barrier=(5.0164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.620359,'amu*angstrom^2'), symmetry=1, barrier=(14.2633,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.802084,0.0768977,-0.000123,1.0612e-07,-3.65487e-11,-79882.7,27.125], Tmin=(100,'K'), Tmax=(778.047,'K')), NASAPolynomial(coeffs=[9.53795,0.0260893,-1.36782e-05,2.70734e-09,-1.90665e-13,-81063.6,-11.6811], Tmin=(778.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-665.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsFFFO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C([O])OC(F)(F)F(13800)'],
    products = ['C=C(O)OC(F)(F)F(6039)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(O)O[C](F)F(13801)'],
    products = ['C=C(O)OC(F)(F)F(6039)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CF3(45)', '[CH2]C(=O)O(5808)'],
    products = ['C=C(O)OC(F)(F)F(6039)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', 'C=[C]OC(F)(F)F(13802)'],
    products = ['C=C(O)OC(F)(F)F(6039)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(=O)OC(F)(F)F(13803)'],
    products = ['C=C(O)OC(F)(F)F(6039)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(O)OC(F)(F)F(13804)'],
    products = ['C=C(O)OC(F)(F)F(6039)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C(O)OC(F)(F)F(13805)'],
    products = ['C=C(O)OC(F)(F)F(6039)'],
