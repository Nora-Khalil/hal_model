...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](129)', 'F[C]CF-2(3008)'],
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)OO[O](3380)'],
    products = ['[O]OO[C](F)CF(913)'],
    transitionState = 'TS8',
