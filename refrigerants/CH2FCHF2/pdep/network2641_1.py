...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([CH]F)=C(F)F(7697)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=C([CH]F)[C](F)F(9674)'],
    products = ['[O]OC([CH]F)=C(F)F(7697)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', '[O]O[C]=C(F)F(3541)'],
    products = ['[O]OC([CH]F)=C(F)F(7697)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]OC([CH]F)=C(F)F(7697)'],
    products = ['[O]O[C]1C(F)C1(F)F(10309)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC([CH]F)=C(F)F(7697)'],
    products = ['F[CH][C]1OOC1(F)F(10310)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]OC([CH]F)=C(F)F(7697)'],
    products = ['F[CH]C1([C](F)F)OO1(10311)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[O]O[C]=C(F)F(3541)'],
    products = ['[O]OC([CH]F)=C(F)F(7697)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC(=[C]F)C(F)F(10313)'],
    products = ['[O]OC([CH]F)=C(F)F(7697)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]F(156)', '[O]O[C]=CF(288)'],
    products = ['[O]OC([CH]F)=C(F)F(7697)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C(OOF)=C(F)F(10318)'],
    products = ['[O]OC([CH]F)=C(F)F(7697)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]OC([CH]F)=C(F)F(7697)'],
    products = ['[CH]=C(O[O])C(F)(F)F(10319)'],
...
network(
    label = 'PDepNetwork #2641',
    isomers = [
        '[O]OC([CH]F)=C(F)F(7697)',
    ],
    reactants = [
