...
species(
    label = '[C]=C(F)C(F)(F)OC(F)F(12750)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FC#CC(F)(F)OC(F)F(10270)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FC#COC(F)F(9689)'],
    products = ['FC#CC(F)(F)OC(F)F(10270)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)F(703)', 'F[C]C#CF(11063)'],
    products = ['FC#CC(F)(F)OC(F)F(10270)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'FC#CC(F)(F)OF(12747)'],
    products = ['FC#CC(F)(F)OC(F)F(10270)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]=C=C(F)OC(F)F(12748)'],
    products = ['FC#CC(F)(F)OC(F)F(10270)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC#CC(F)(F)O[CH]F(10614)'],
    products = ['FC#CC(F)(F)OC(F)F(10270)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[C]#CC(F)(F)OC(F)F(12749)'],
    products = ['FC#CC(F)(F)OC(F)F(10270)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)F(364)', 'F[C]=C=C(F)F(4317)'],
    products = ['FC#CC(F)(F)OC(F)F(10270)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF2(82)', '[O]C(F)(F)C#CF(2767)'],
    products = ['FC#CC(F)(F)OC(F)F(10270)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[C]#CF(235)', 'F[C](F)OC(F)F(5025)'],
    products = ['FC#CC(F)(F)OC(F)F(10270)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC#CC(F)(F)O[C](F)F(10648)'],
    products = ['FC#CC(F)(F)OC(F)F(10270)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[C]=C(F)C(F)(F)OC(F)F(12750)'],
    products = ['FC#CC(F)(F)OC(F)F(10270)'],
...
network(
    label = 'PDepNetwork #2900',
    isomers = [
        'FC#CC(F)(F)OC(F)F(10270)',
    ],
    reactants = [
