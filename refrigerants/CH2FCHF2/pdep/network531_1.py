...
"""),
    E0 = (-191.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180,180,180,180,440.938],'cm^-1')),
        HinderedRotor(inertia=(2.52434,'amu*angstrom^2'), symmetry=1, barrier=(58.0395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.51908,'amu*angstrom^2'), symmetry=1, barrier=(57.9185,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27911,0.0771022,-0.000162816,1.69237e-07,-6.37206e-11,-22982.5,33.1385], Tmin=(100,'K'), Tmax=(871.094,'K')), NASAPolynomial(coeffs=[1.06628,0.0358826,-1.91752e-05,3.6957e-09,-2.51231e-13,-21344.5,43.3253], Tmin=(871.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68393,0.058744,-0.000102267,9.66192e-08,-3.5064e-11,-39950.8,30.4204], Tmin=(100,'K'), Tmax=(840.653,'K')), NASAPolynomial(coeffs=[5.333,0.0249923,-1.27999e-05,2.47836e-09,-1.71045e-13,-39985.2,16.8935], Tmin=(840.653,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CJ2_singlet-FO) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'O=[C-][OH+]C(F)=CF(3122)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93748,0.0573964,-0.000116972,1.22484e-07,-4.71042e-11,-2754.78,18.5316], Tmin=(100,'K'), Tmax=(849.351,'K')), NASAPolynomial(coeffs=[1.88071,0.028867,-1.57308e-05,3.10001e-09,-2.14926e-13,-1706.44,24.9109], Tmin=(849.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.4254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-C2dc) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.54685,'amu*angstrom^2'), symmetry=1, barrier=(58.5572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0686675,'amu*angstrom^2'), symmetry=1, barrier=(58.6373,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (70.0467,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08835,0.0555322,-0.000119922,1.22898e-07,-4.47106e-11,42585,26.1614], Tmin=(100,'K'), Tmax=(909.484,'K')), NASAPolynomial(coeffs=[1.49159,0.023965,-1.14666e-05,2.0622e-09,-1.32477e-13,44107.6,36.758], Tmin=(909.484,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsJ2_singlet-CsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (253.839,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2175,525,239,401,1367,180,180,180,180,1282.39],'cm^-1')),
        HinderedRotor(inertia=(0.20126,'amu*angstrom^2'), symmetry=1, barrier=(4.62737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0495247,'amu*angstrom^2'), symmetry=1, barrier=(57.9037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0371,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87227,0.0644733,-0.000149132,1.58094e-07,-5.90053e-11,30589.7,29.2583], Tmin=(100,'K'), Tmax=(895.828,'K')), NASAPolynomial(coeffs=[-0.133834,0.028905,-1.50207e-05,2.80634e-09,-1.84989e-13,32735.7,48.6878], Tmin=(895.828,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsJ2_singlet-CsH) + group(Ct-CtCs) + group(CtCF)"""),
)

species(
    label = 'O=C(F)C(F)[C-]=[OH+](3125)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction4',
    reactants = ['F2(78)', 'C#C[O+]=[C-]O(3123)'],
    products = ['O[C-]=[O+]C(F)=CF(3019)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'O[C-]=[O+]C#CF(3124)'],
    products = ['O[C-]=[O+]C(F)=CF(3019)'],
    transitionState = 'TS5',
