...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(1281)', '[CH]F(137)'],
    products = ['[O]C(=O)O[CH]F(992)'],
    transitionState = 'TS2',
