...
"""),
    E0 = (-301.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,2950,3100,1380,975,1025,1650,1685,370,221.846,224.098,224.57],'cm^-1')),
        HinderedRotor(inertia=(0.605248,'amu*angstrom^2'), symmetry=1, barrier=(21.3287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600166,'amu*angstrom^2'), symmetry=1, barrier=(21.3289,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28748,0.0501872,-3.76473e-05,1.02284e-09,6.28703e-12,-36169.9,23.7033], Tmin=(100,'K'), Tmax=(953.261,'K')), NASAPolynomial(coeffs=[17.6569,0.00412926,-7.82391e-07,1.44777e-10,-1.38508e-14,-40318.9,-59.879], Tmin=(953.261,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-301.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sF1sO2s)) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55538,0.0318066,3.6033e-05,-8.69561e-08,3.98767e-11,-74257.2,13.6492], Tmin=(100,'K'), Tmax=(938.92,'K')), NASAPolynomial(coeffs=[22.9852,-0.00368251,3.57445e-06,-6.05984e-10,2.94021e-14,-80741.2,-101.486], Tmin=(938.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-618.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(CsFFOO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.42724,'amu*angstrom^2'), symmetry=1, barrier=(32.8151,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.468433,0.0610926,-7.07331e-05,3.59674e-08,-6.67786e-12,-39793.2,20.9813], Tmin=(100,'K'), Tmax=(1525.59,'K')), NASAPolynomial(coeffs=[20.8849,-0.00288502,2.44313e-06,-4.98485e-10,3.34101e-14,-44806.9,-82.1553], Tmin=(1525.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFFOO) + group(Ct-CtOs) + group(Ct-CtH) + radical(O2sj(Cs-F1sF1sO2s))"""),
)

species(
    label = '[CH]=COC([O])(F)F(6848)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (4.68711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,482,586,761,1411,2950,3100,1380,975,1025,1650,1685,370,286.844,286.845,286.845,286.845],'cm^-1')),
        HinderedRotor(inertia=(0.415528,'amu*angstrom^2'), symmetry=1, barrier=(24.2619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.415526,'amu*angstrom^2'), symmetry=1, barrier=(24.2619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.415527,'amu*angstrom^2'), symmetry=1, barrier=(24.2619,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03644,0.0587835,-6.5162e-05,3.25786e-08,-5.81263e-12,676.017,25.4021], Tmin=(100,'K'), Tmax=(1039.22,'K')), NASAPolynomial(coeffs=[16.8539,0.00663668,-2.50227e-06,4.70339e-10,-3.43069e-14,-3083.25,-53.7861], Tmin=(1039.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.68711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFHOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsF1sO2sO2s) + radical(C=CJO)"""),
)

species(
    label = '[CH2][C](F)OC(=O)F(539)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62216,0.0581091,-8.24636e-05,6.11651e-08,-1.7047e-11,-53883,24.1339], Tmin=(100,'K'), Tmax=(624.649,'K')), NASAPolynomial(coeffs=[8.24376,0.022194,-1.17961e-05,2.36928e-09,-1.6927e-13,-54836.8,-5.70861], Tmin=(624.649,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-448.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(Cs-CsHHH) + group(COFOO) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(2711)', '[C]=C(4368)'],
    products = ['C=[C]OC([O])(F)F(6190)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C=[C]O[C](F)F(6398)'],
    products = ['C=[C]OC([O])(F)F(6190)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(=O)F(6846)'],
    products = ['C=[C]OC([O])(F)F(6190)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC([O])(F)F(6847)'],
    products = ['C=[C]OC([O])(F)F(6190)'],
    transitionState = 'TS8',
