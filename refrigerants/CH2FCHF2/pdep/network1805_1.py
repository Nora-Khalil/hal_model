...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', '[CH2]C[C]=O(6424)'],
    products = ['O=[C]CC[C](F)F(6419)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(514)', '[CH2]C[C](F)F(189)'],
    products = ['O=[C]CC[C](F)F(6419)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C[C](F)F(189)'],
    products = ['O=[C]CC[C](F)F(6419)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]CC=C(F)F(6427)'],
    products = ['O=[C]CC[C](F)F(6419)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=CC[C](F)F(6428)'],
    products = ['O=[C]CC[C](F)F(6419)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C[C]=O(6424)'],
    products = ['O=[C]CC[C](F)F(6419)'],
