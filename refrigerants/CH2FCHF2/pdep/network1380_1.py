...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C([O])=O(1332)'],
    products = ['[O]C(=O)O[C]=O(4799)'],
    transitionState = 'TS2',
