...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C#COO(6893)'],
    products = ['C#COOC(F)F(3483)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C#COO[CH]F(6895)'],
    products = ['C#COOC(F)F(3483)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)F(2774)', 'C2H(22)'],
    products = ['C#COOC(F)F(3483)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COO[C](F)F(6819)'],
    products = ['C#COOC(F)F(3483)'],
    transitionState = 'TS8',
