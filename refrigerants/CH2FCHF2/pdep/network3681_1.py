...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CO[O](2900)'],
    products = ['CC(F)(F)O[O](2685)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[C](F)F(219)', 'CH3(19)'],
    products = ['CC(F)(F)O[O](2685)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)O[O](135)'],
    products = ['CC(F)(F)O[O](2685)'],
    transitionState = 'TS9',
