...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.546922,'amu*angstrom^2'), symmetry=1, barrier=(12.5748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.940903,'amu*angstrom^2'), symmetry=1, barrier=(21.6332,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.026,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.683192,0.086482,-0.000176531,1.71828e-07,-6.25311e-11,-39206.4,23.5341], Tmin=(100,'K'), Tmax=(841.342,'K')), NASAPolynomial(coeffs=[7.49743,0.0250735,-1.53246e-05,3.10501e-09,-2.17469e-13,-39326.2,-2.06125], Tmin=(841.342,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-Cds(Cds-O2d)O2s) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-O2d(Cds-Cds)H) + radical(C=CCJ=O)"""),
)

species(
    label = 'O[C](C=C(F)F)OOF(12993)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.850719,'amu*angstrom^2'), symmetry=1, barrier=(19.5597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.855362,'amu*angstrom^2'), symmetry=1, barrier=(19.6665,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.26564,0.0895752,-0.00014776,1.26752e-07,-4.30293e-11,-44939.2,31.1243], Tmin=(100,'K'), Tmax=(778.615,'K')), NASAPolynomial(coeffs=[11.5517,0.0258719,-1.40103e-05,2.79305e-09,-1.97024e-13,-46523.3,-19.3863], Tmin=(778.615,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFF) + radical(Cs_P)"""),
)
...
species(
    label = '[O]C1(O)C(OF)C1(F)F(12996)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.633696,'amu*angstrom^2'), symmetry=1, barrier=(14.5699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633577,'amu*angstrom^2'), symmetry=1, barrier=(14.5672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44917,'amu*angstrom^2'), symmetry=1, barrier=(33.3193,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633618,'amu*angstrom^2'), symmetry=1, barrier=(14.5681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
...
"""),
    E0 = (-659.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,350,440,435,1725,182,240,577,636,1210,1413,180,180,180,1605.11,1609.29,1609.8],'cm^-1')),
        HinderedRotor(inertia=(0.16809,'amu*angstrom^2'), symmetry=1, barrier=(3.86472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169941,'amu*angstrom^2'), symmetry=1, barrier=(3.90729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170269,'amu*angstrom^2'), symmetry=1, barrier=(3.91482,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.587411,0.0903719,-0.000180675,1.7842e-07,-6.56027e-11,-79270.6,27.8892], Tmin=(100,'K'), Tmax=(851.33,'K')), NASAPolynomial(coeffs=[5.43674,0.0329618,-1.85139e-05,3.65823e-09,-2.53154e-13,-78841.5,12.6439], Tmin=(851.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-659.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C([C](F)F)C(=O)O(12999)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-478.13,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,190,488,555,1236,1407,180,180,180,180,1148.94,1149.09],'cm^-1')),
        HinderedRotor(inertia=(0.00380104,'amu*angstrom^2'), symmetry=1, barrier=(3.56058,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0598665,'amu*angstrom^2'), symmetry=1, barrier=(56.0948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155143,'amu*angstrom^2'), symmetry=1, barrier=(3.56703,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5662,0.0590188,-9.38041e-05,8.2498e-08,-2.8865e-11,-57423.4,24.2624], Tmin=(100,'K'), Tmax=(803.423,'K')), NASAPolynomial(coeffs=[7.29365,0.0227448,-1.15944e-05,2.26178e-09,-1.57786e-13,-58093.3,-0.557264], Tmin=(803.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-478.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCJCO) + radical(Csj(Cs-COHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-286.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,190,488,555,1236,1407,1855,455,950,241.795,242.261],'cm^-1')),
        HinderedRotor(inertia=(0.390638,'amu*angstrom^2'), symmetry=1, barrier=(16.2018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.388282,'amu*angstrom^2'), symmetry=1, barrier=(16.2067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00288984,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06961,0.0682654,-9.75078e-05,6.81838e-08,-1.86699e-11,-34383.2,28.3849], Tmin=(100,'K'), Tmax=(897.005,'K')), NASAPolynomial(coeffs=[13.0805,0.0147046,-7.94086e-06,1.61559e-09,-1.16768e-13,-36537.9,-28.2552], Tmin=(897.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-286.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsH) + radical(CsCsF1sF1s) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(=O)C(OF)[C](F)F(13001)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.540924,0.0830674,-0.000136478,1.16902e-07,-3.98847e-11,-63899.5,31.8739], Tmin=(100,'K'), Tmax=(750.228,'K')), NASAPolynomial(coeffs=[11.0269,0.0243769,-1.35696e-05,2.73944e-09,-1.94915e-13,-65394.5,-15.1795], Tmin=(750.228,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-532.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(C2CsJO) + radical(CsCsF1sF1s)"""),
)

species(
    label = 'O=C(O)C(=O)[C](F)F(4984)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {8,S}
2 F u0 p3 c0 {8,S}
...
"""),
    E0 = (-734.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,522,611,926,1093,1137,1374,1416,3112,360,370,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868449,0.0750129,-9.86754e-05,6.81502e-08,-1.91034e-11,-88246.9,29.0911], Tmin=(100,'K'), Tmax=(863.672,'K')), NASAPolynomial(coeffs=[11.3822,0.0263199,-1.41073e-05,2.87251e-09,-2.0803e-13,-90063,-20.0907], Tmin=(863.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-734.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(C2CsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    ...
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=[C]C(OF)=C(F)F(12992)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](C=C(F)F)OOF(12993)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)C([C]F)OF(12994)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C]F(156)', 'O=C(O)[CH]OF(5618)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=C(O)C(OF)[C](F)F(12933)'],
    products = ['O[C]1OC(F)(F)C1OF(12995)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C(O)C(OF)[C](F)F(12933)'],
    products = ['[O]C1(O)C(OF)C1(F)F(12996)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OC(O)=C(OF)[C](F)F(12997)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(128)', 'O=C(O)C=C(F)F(350)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(338)', 'FOC=C(F)F(3557)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)C(OF)=C(F)F(12998)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C([C](F)F)C(=O)O(12999)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(128)', 'O=C(O)[CH][C](F)F(545)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'O=[C]C(OF)[C](F)F(13000)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)C(OF)[C](F)F(13001)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(338)', 'FO[CH][C](F)F(3555)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(O)[C](OF)[C](F)F(13002)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(O)C(=O)[C](F)F(4984)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', 'O=C(O)C([C]F)OF-2(13003)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CF2(43)', 'O=C(O)[CH]OF(5618)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=C(O)C(OF)[C](F)F(12933)'],
    products = ['O=C(O)[C](OF)C(F)F(11368)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(=O)C(OF)C(F)F(12968)'],
    products = ['O=C(O)C(OF)[C](F)F(12933)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=C(O)C(OF)[C](F)F(12933)'],
    products = ['[O]C(C(=O)O)C(F)(F)F(12940)'],
...
network(
    label = 'PDepNetwork #3472',
    isomers = [
        'O=C(O)C(OF)[C](F)F(12933)',
    ],
    reactants = [
