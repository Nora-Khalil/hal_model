...
reaction(
    label = 'reaction1',
    reactants = ['F(37)', '[CH]C(F)F-2(3426)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', 'F[C]C(F)F-2(3427)'],
    products = ['CHF2-CHF(67)'],
    transitionState = 'TS3',
