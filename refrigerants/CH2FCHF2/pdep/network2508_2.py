...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59656,0.0338665,-4.11384e-05,2.54316e-08,-6.35988e-12,-66685.3,14.317], Tmin=(100,'K'), Tmax=(961.988,'K')), NASAPolynomial(coeffs=[7.95729,0.0115755,-6.37964e-06,1.34271e-09,-9.94794e-14,-67716.6,-11.3375], Tmin=(961.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-554.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (82.0245,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97023,0.0240336,-2.143e-05,9.72927e-09,-1.81775e-12,-37522.2,13.6041], Tmin=(100,'K'), Tmax=(1244.43,'K')), NASAPolynomial(coeffs=[7.14387,0.0106182,-5.25939e-06,1.06637e-09,-7.7418e-14,-38560.9,-7.44402], Tmin=(1244.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-312.275,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]C(F)(F)F(3538)'],
    products = ['CF3-CHF(54)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C]C(F)(F)F-2(9639)'],
    products = ['CF3-CHF(54)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[CH][C](F)F(3610)'],
    products = ['CF3-CHF(54)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'F[C]C(F)(F)F(4171)'],
    products = ['CF3-CHF(54)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.75,'m^3/(mol*s)'), n=-0.32, Ea=(0.758241,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_3R->H_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CHF2-CF2(69)'],
    products = ['CF3-CHF(54)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'F[C]C(F)F-2(3545)'],
    products = ['CHF2-CF2(69)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [H/Val7_rad;Birad] for rate rule [Val7_rad;Birad]
Euclidian distance = 1.0
family: Birad_R_Recombination"""),
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'F[C](F)[C](F)F(4977)'],
    products = ['CHF2-CF2(69)'],
