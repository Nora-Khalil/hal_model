...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'F[CH]O[CH]F(385)'],
    products = ['F[CH]OC(F)[CH]F(370)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]OC(F)=CF(389)'],
    products = ['F[CH]OC(F)[CH]F(370)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', 'F[CH]O[CH]F(385)'],
    products = ['F[CH]OC(F)[CH]F(370)'],
