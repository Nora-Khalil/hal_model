...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(F)(F)[CH]F(3666)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C(F)(F)[CH]F(2586)'],
    products = ['[CH2]OC(F)(F)[CH]F(3666)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', '[CH2]O[C](F)F(2615)'],
    products = ['[CH2]OC(F)(F)[CH]F(3666)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(F)=CF(2600)'],
    products = ['[CH2]OC(F)(F)[CH]F(3666)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[CH2]O[C](F)F(2615)'],
    products = ['[CH2]OC(F)(F)[CH]F(3666)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]O[C](F)C(F)F(3813)'],
    products = ['[CH2]OC(F)(F)[CH]F(3666)'],
