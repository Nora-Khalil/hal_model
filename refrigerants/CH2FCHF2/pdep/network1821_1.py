...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(C=O)O[C](F)F(6199)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C([CH]OF)O[C](F)F(6430)'],
    products = ['[O]C(F)(C=O)O[C](F)F(6199)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(156)', '[O]C([O])(F)C=O(1992)'],
    products = ['[O]C(F)(C=O)O[C](F)F(6199)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', 'O=C[C](F)O[C](F)F(1741)'],
    products = ['[O]C(F)(C=O)O[C](F)F(6199)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(C=O)O[C](F)F(6199)'],
    products = ['O=CC1(F)OC(F)(F)O1(6311)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(C=O)O[C](F)F(6199)'],
    products = ['F[C](F)OC1(F)[CH]OO1(6431)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(C=O)O[C](F)F(6199)'],
    products = ['[O]C1OC1(F)O[C](F)F(6432)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=CC(=O)O[C](F)F(6434)'],
    products = ['[O]C(F)(C=O)O[C](F)F(6199)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HCO(15)', 'O=C(F)O[C](F)F(2723)'],
    products = ['[O]C(F)(C=O)O[C](F)F(6199)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF2(43)', '[O]C([O])(F)C=O(1992)'],
    products = ['[O]C(F)(C=O)O[C](F)F(6199)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)O[C](F)F(6199)'],
    products = ['O=[C]C(O)(F)O[C](F)F(6436)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(C=O)O[C](F)F(6199)'],
    products = ['[O]C(F)([C]=O)OC(F)F(6437)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C=C(OF)O[C](F)F(6438)'],
    products = ['[O]C(F)(C=O)O[C](F)F(6199)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(C=O)O[C](F)F(6199)'],
    products = ['[O]C=C([O])OC(F)(F)F(6439)'],
...
network(
    label = 'PDepNetwork #1821',
    isomers = [
        '[O]C(F)(C=O)O[C](F)F(6199)',
    ],
    reactants = [
