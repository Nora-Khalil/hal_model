...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C=O(10049)'],
    products = ['[CH]=CC([O])=O(9827)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C]=O(517)', '[CH]=[CH](4466)'],
    products = ['[CH]=CC([O])=O(9827)'],
