...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(4368)', 'C=[C]O[O](6818)'],
    products = ['C=[C]OO[C]=C(13736)'],
    transitionState = 'TS2',
