...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'F[C]C=C(F)F(290)'],
    products = ['[O]C(F)(F)C=[C]F(2576)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=C(F)C=[C]F(454)'],
    products = ['[O]C(F)(F)C=[C]F(2576)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O][C](F)F(2580)', 'C2HF(58)'],
    products = ['[O]C(F)(F)C=[C]F(2576)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)C#CF(2654)'],
    products = ['[O]C(F)(F)C=[C]F(2576)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(2580)', '[CH]=[C]F(252)'],
    products = ['[O]C(F)(F)C=[C]F(2576)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'O=C(F)[C]=[C]F(2655)'],
    products = ['[O]C(F)(F)C=[C]F(2576)'],
    transitionState = 'TS9',
