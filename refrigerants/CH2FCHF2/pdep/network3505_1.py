...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C([O])C(=O)OF(13115)'],
    products = ['C=C(O)C(=O)OF(5685)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([O])=C(O)OF(13117)'],
    products = ['C=C(O)C(=O)OF(5685)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)C([O])=O(13123)'],
    products = ['C=C(O)C(=O)OF(5685)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=[C]C(=O)OF(13124)'],
    products = ['C=C(O)C(=O)OF(5685)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)OF(11304)'],
    products = ['C=C(O)C(=O)OF(5685)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(128)', 'C=C(O)[C]=O(13125)'],
    products = ['C=C(O)C(=O)OF(5685)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OF(340)', 'C=[C]O(4375)'],
    products = ['C=C(O)C(=O)OF(5685)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)C(=O)OF(13126)'],
    products = ['C=C(O)C(=O)OF(5685)'],
