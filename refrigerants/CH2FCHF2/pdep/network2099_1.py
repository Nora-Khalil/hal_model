...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.434003,'amu*angstrom^2'), symmetry=1, barrier=(9.97859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.43405,'amu*angstrom^2'), symmetry=1, barrier=(9.97967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.434033,'amu*angstrom^2'), symmetry=1, barrier=(9.97927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64082,'amu*angstrom^2'), symmetry=1, barrier=(37.7258,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.95697,0.121328,-0.000220738,1.95771e-07,-6.63064e-11,-116986,31.6019], Tmin=(100,'K'), Tmax=(845.122,'K')), NASAPolynomial(coeffs=[14.2478,0.0274551,-1.52406e-05,2.99341e-09,-2.06481e-13,-118774,-34.5652], Tmin=(845.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-974.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFOO) + group(CsCsFHH) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'OC([CH]F)(OF)C(F)(F)F(7926)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.2914,0.109827,-0.000149188,9.16775e-08,-2.12e-11,-121232,31.8542], Tmin=(100,'K'), Tmax=(1079.56,'K')), NASAPolynomial(coeffs=[27.4854,0.00320396,-1.04322e-06,1.93912e-10,-1.492e-14,-127445,-109.181], Tmin=(1079.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1009.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsOs) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsCsFHH) + radical(CsCsF1sH)"""),
)
...
species(
    label = 'OC(F)([C]F)C(F)(F)OF-2(7928)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00101847,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119782,'amu*angstrom^2'), symmetry=1, barrier=(14.0426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000447272,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.258431,'amu*angstrom^2'), symmetry=1, barrier=(30.3028,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.41136,0.104606,-0.000165052,1.26853e-07,-3.81278e-11,-96820.5,28.6073], Tmin=(100,'K'), Tmax=(819.059,'K')), NASAPolynomial(coeffs=[16.6664,0.0212047,-1.23157e-05,2.53487e-09,-1.82898e-13,-99618.1,-50.3745], Tmin=(819.059,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-806.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCCl_triplet)"""),
)

species(
    label = 'OC(=CF)C(F)(F)OF(5233)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.473867,'amu*angstrom^2'), symmetry=1, barrier=(10.8951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66925,'amu*angstrom^2'), symmetry=1, barrier=(38.3793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.472086,'amu*angstrom^2'), symmetry=1, barrier=(10.8542,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0701964,0.0976896,-0.000165491,1.42382e-07,-4.80202e-11,-100681,25.54], Tmin=(100,'K'), Tmax=(794.368,'K')), NASAPolynomial(coeffs=[12.7868,0.0251603,-1.3828e-05,2.75708e-09,-1.93904e-13,-102478,-31.9813], Tmin=(794.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-838.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    E0 = (-596.381,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,253,525,597,667,842,1178,1324,360,370,350,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.348934,'amu*angstrom^2'), symmetry=1, barrier=(8.02269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348459,'amu*angstrom^2'), symmetry=1, barrier=(8.01177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348036,'amu*angstrom^2'), symmetry=1, barrier=(8.00203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19043,'amu*angstrom^2'), symmetry=1, barrier=(27.3703,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.537975,0.114588,-0.000221327,2.04221e-07,-7.07318e-11,-71578.8,29.9439], Tmin=(100,'K'), Tmax=(862.141,'K')), NASAPolynomial(coeffs=[11.5023,0.0274971,-1.54699e-05,3.02409e-09,-2.06745e-13,-72494.3,-19.6266], Tmin=(862.141,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(C2CsJOH) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)

species(
    label = 'OC(F)([CH]F)[C](F)OF(7930)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-553.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,316,385,515,654,689,1295,395,473,707,1436,334,575,1197,1424,3202,180,180,180],'cm^-1')),
...
"""),
    E0 = (-851.8,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,316,385,515,654,689,1295,351,323,533,609,664,892,1120,1201,334,575,1197,1424,3202,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.477373,'amu*angstrom^2'), symmetry=1, barrier=(10.9757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477757,'amu*angstrom^2'), symmetry=1, barrier=(10.9846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.478045,'amu*angstrom^2'), symmetry=1, barrier=(10.9912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.269764,0.104427,-0.000188011,1.66739e-07,-5.66434e-11,-102304,28.5872], Tmin=(100,'K'), Tmax=(841.33,'K')), NASAPolynomial(coeffs=[12.5598,0.0250578,-1.37488e-05,2.69922e-09,-1.86514e-13,-103813,-27.2273], Tmin=(841.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-851.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-F1sO2sCs)(F1s)(H))"""),
)

species(
    label = 'F[CH][C](F)C(F)(F)OF(3808)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.235628,'amu*angstrom^2'), symmetry=1, barrier=(5.41756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235332,'amu*angstrom^2'), symmetry=1, barrier=(5.41076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235414,'amu*angstrom^2'), symmetry=1, barrier=(5.41263,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00754082,0.10424,-0.000210084,2.0126e-07,-7.1614e-11,-69117.9,30.1181], Tmin=(100,'K'), Tmax=(861.972,'K')), NASAPolynomial(coeffs=[8.61089,0.0285201,-1.61453e-05,3.17983e-09,-2.18369e-13,-69276.4,-2.48203], Tmin=(861.972,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-575.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.20961,'amu*angstrom^2'), symmetry=1, barrier=(27.8112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20981,'amu*angstrom^2'), symmetry=1, barrier=(27.8159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20987,'amu*angstrom^2'), symmetry=1, barrier=(27.8173,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.811106,0.0776415,-0.000117828,8.6491e-08,-2.24608e-11,-100834,24.6632], Tmin=(100,'K'), Tmax=(632.581,'K')), NASAPolynomial(coeffs=[11.4089,0.0217377,-1.16082e-05,2.30948e-09,-1.6314e-13,-102397,-23.3684], Tmin=(632.581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-839.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COCsFO) + radical(CsCsF1sH)"""),
)

species(
    label = 'OC([CH]F)=C(F)OF(7932)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-423.366,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,350,440,435,1725,326,540,652,719,1357,234,589,736,816,1240,3237,1124.18],'cm^-1')),
        HinderedRotor(inertia=(0.383659,'amu*angstrom^2'), symmetry=1, barrier=(8.82108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66323,'amu*angstrom^2'), symmetry=1, barrier=(38.2409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.14535,'amu*angstrom^2'), symmetry=1, barrier=(26.3338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14559,'amu*angstrom^2'), symmetry=1, barrier=(26.3395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14558,'amu*angstrom^2'), symmetry=1, barrier=(26.3391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14514,'amu*angstrom^2'), symmetry=1, barrier=(26.329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.366408,0.103362,-0.000164853,1.28624e-07,-3.92261e-11,-99078.1,29.7663], Tmin=(100,'K'), Tmax=(807.846,'K')), NASAPolynomial(coeffs=[16.2672,0.0210028,-1.19321e-05,2.42909e-09,-1.7392e-13,-101766,-46.9321], Tmin=(807.846,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-825.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-969.094,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,316,385,515,654,689,1295,235,523,627,1123,1142,1372,1406,3097,395,473,707,1436,180,180,180],'cm^-1')),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(F)([CH]F)OF(7903)'],
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)(OF)C(F)(F)[CH]F(7925)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
    products = ['OC([CH]F)(OF)C(F)(F)F(7926)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]C(O)(F)C(F)(F)OF(7927)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]F(137)', 'O[C](F)C(F)(F)OF(5035)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'OC(F)([C]F)C(F)(F)OF-2(7928)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(=CF)C(F)(F)OF(5233)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(55.7978,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'FC=C(F)C(F)(F)OF(4512)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FO[C](F)F(2563)', 'OC(F)=CF(878)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[C]([CH]F)C(F)(F)OF(7929)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)([CH]F)[C](F)OF(7930)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)(F)C(O)(F)[CH]F(3421)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'F[CH][C](F)C(F)(F)OF(3808)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(128)', 'OC(F)([CH]F)[C](F)F(6905)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FO[C](F)F(2563)', 'O[C](F)[CH]F(881)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(174.101,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction20',
    reactants = ['F2(78)', 'O=C(F)C(O)(F)[CH]F(7931)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(86.7449,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'OC([CH]F)=C(F)OF(7932)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CHF(40)', 'O[C](F)C(F)(F)OF(5035)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'OC(F)([C]F)C(F)(F)OF(5218)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
    products = ['[O]C(F)(F)C(O)(F)C(F)F(7933)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(82.8628,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction26',
    reactants = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
    products = ['O[C](C(F)F)C(F)(F)OF(7934)'],
...
reaction(
    label = 'reaction27',
    reactants = ['OC(F)([C](F)OF)C(F)F(7935)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5229)'],
