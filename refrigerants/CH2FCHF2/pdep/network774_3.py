...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.556221,'amu*angstrom^2'), symmetry=1, barrier=(12.7886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31595,'amu*angstrom^2'), symmetry=1, barrier=(30.2562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.556646,'amu*angstrom^2'), symmetry=1, barrier=(12.7984,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.34554,'amu*angstrom^2'), symmetry=1, barrier=(30.9366,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15791,0.0721025,-0.000132535,1.25983e-07,-4.58341e-11,-34171.8,23.5797], Tmin=(100,'K'), Tmax=(827.224,'K')), NASAPolynomial(coeffs=[6.74997,0.0259903,-1.43365e-05,2.85517e-09,-1.99937e-13,-34444.4,1.60615], Tmin=(827.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C(F)(F)OOF(3940)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-201.693,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,223,363,546,575,694,1179,1410,356.828,356.912,1778.04],'cm^-1')),
        HinderedRotor(inertia=(0.0837508,'amu*angstrom^2'), symmetry=1, barrier=(7.5717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0837729,'amu*angstrom^2'), symmetry=1, barrier=(7.57237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.405721,'amu*angstrom^2'), symmetry=1, barrier=(36.673,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45951,0.060888,-9.86373e-05,8.18949e-08,-2.69204e-11,-24171.3,19.1761], Tmin=(100,'K'), Tmax=(747.517,'K')), NASAPolynomial(coeffs=[9.82034,0.0161427,-8.83737e-06,1.79685e-09,-1.2873e-13,-25421.1,-18.726], Tmin=(747.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJ2_triplet)"""),
)

species(
    label = 'OOC(F)(F)[C]F(4974)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {7,S}
...
"""),
    E0 = (-437.915,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([90,150,250,247,323,377,431,433,1065,1274,1133.17,1133.19,1134.62,1135.05,1135.17],'cm^-1')),
        HinderedRotor(inertia=(0.265596,'amu*angstrom^2'), symmetry=1, barrier=(6.10658,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0554676,'amu*angstrom^2'), symmetry=1, barrier=(1.27531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26444,'amu*angstrom^2'), symmetry=1, barrier=(6.08001,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0221,0.0752529,-0.000144647,1.355e-07,-4.80398e-11,-52571.2,20.5731], Tmin=(100,'K'), Tmax=(838.136,'K')), NASAPolynomial(coeffs=[8.55267,0.0201098,-1.15899e-05,2.32757e-09,-1.62762e-13,-53159.1,-10.404], Tmin=(838.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-437.915,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-467.829,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,617,898,1187],'cm^-1')),
        HinderedRotor(inertia=(1.54904,'amu*angstrom^2'), symmetry=1, barrier=(35.6155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55002,'amu*angstrom^2'), symmetry=1, barrier=(35.638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5497,'amu*angstrom^2'), symmetry=1, barrier=(35.6307,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35788,0.0631421,-9.78261e-05,7.68723e-08,-2.39616e-11,-56176.3,20.6987], Tmin=(100,'K'), Tmax=(786.626,'K')), NASAPolynomial(coeffs=[10.4799,0.0167563,-9.37377e-06,1.90862e-09,-1.37067e-13,-57611.5,-21.1205], Tmin=(786.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-467.829,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFFO) + group(CJ2_singlet-FCs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]OCF(2249)'],
    products = ['[O]OC(F)(F)CF(3632)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', '[O]OC(F)F(2774)'],
    products = ['[O]OC(F)(F)CF(3632)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)F(3645)', 'CH2(S)(25)'],
    products = ['[O]OC(F)(F)CF(3632)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)O[O](135)'],
    products = ['[O]OC(F)(F)CF(3632)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(219)', 'CH2F(46)'],
    products = ['[O]OC(F)(F)CF(3632)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(F)(F)[CH]F(3669)'],
    products = ['[O]OC(F)(F)CF(3632)'],
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C(F)(F)F(133)'],
    products = ['[O]OCC(F)(F)F(3636)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]O[CH]C(F)(F)F(3646)'],
    products = ['[O]OCC(F)(F)F(3636)'],
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', '[O]OC=C(F)F(233)'],
    products = ['[O]OCC(F)(F)F(3636)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(5)', 'OOC(F)(F)[C]F(4974)'],
    products = ['OOC(F)(F)[CH]F(3658)'],
...
reaction(
    label = 'reaction31',
    reactants = ['OOC(F)(F)[CH]F(3658)'],
    products = ['OH(7)', 'FC1OC1(F)F(3742)'],
    transitionState = 'TS31',
    kinetics = Arrhenius(A=(1.38e+12,'s^-1','*|/',1.2), n=0, Ea=(45.6433,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [R2OO_S;C_sec_rad_intra;OOH]
Euclidian distance = 0
...
reaction(
    label = 'reaction32',
    reactants = ['F(37)', 'OOC(F)=CF(212)'],
    products = ['OOC(F)(F)[CH]F(3658)'],
    transitionState = 'TS32',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(43.0729,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction33',
    reactants = ['OH(7)', '[O]C(F)(F)[CH]F(2586)'],
    products = ['OOC(F)(F)[CH]F(3658)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(4.76347,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction34',
    reactants = ['HO2(11)', 'F[CH][C](F)F(3610)'],
    products = ['OOC(F)(F)[CH]F(3658)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(5)', 'OOC(F)(F)[C]F-2(4975)'],
    products = ['OOC(F)(F)[CH]F(3658)'],
    transitionState = 'TS36',
    kinetics = Arrhenius(A=(2.75,'m^3/(mol*s)'), n=-0.32, Ea=(10.7654,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_3R->H_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction37',
    reactants = ['OOC(F)(F)[CH]F(3658)'],
    products = ['[O]C(F)(F)C(O)F(4976)'],
