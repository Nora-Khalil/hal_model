...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.1045,'amu*angstrom^2'), symmetry=1, barrier=(25.3947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10527,'amu*angstrom^2'), symmetry=1, barrier=(25.4124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10471,'amu*angstrom^2'), symmetry=1, barrier=(25.3995,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.303227,0.0860002,-0.000119295,8.21851e-08,-2.22861e-11,-59963.6,27.3982], Tmin=(100,'K'), Tmax=(903.834,'K')), NASAPolynomial(coeffs=[15.0708,0.0206445,-1.08303e-05,2.1813e-09,-1.56946e-13,-62633.1,-42.3537], Tmin=(903.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-499.639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CsCsF1sO2s) + radical(Cdj(Cd-F1sF1s)(O2s-Cs))"""),
)
...
species(
    label = 'FC[C](F)O[C]1C(F)C1(F)F(10239)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (174.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.725887,0.117247,-0.000204215,1.87343e-07,-6.66583e-11,-100595,32.9031], Tmin=(100,'K'), Tmax=(823.194,'K')), NASAPolynomial(coeffs=[9.94033,0.0413609,-2.21002e-05,4.35471e-09,-3.0378e-13,-101536,-11.5289], Tmin=(823.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-837.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + ring(O2s-Cs-Cs-Cs(F)) + radical(C2CsJOCs) + radical(Csj(Cs-O2sCsH)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
species(
    label = 'C=C(F)OC([CH]F)=C(F)F(10242)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-620.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,326,540,652,719,1357,234,589,736,816,1240,3237,182,240,577,636,1210,1413,2950,3100,1380,975,1025,1650,180,1137.67,1138.03],'cm^-1')),
        HinderedRotor(inertia=(0.156199,'amu*angstrom^2'), symmetry=1, barrier=(3.59132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.3009,'amu*angstrom^2'), symmetry=1, barrier=(52.9023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156005,'amu*angstrom^2'), symmetry=1, barrier=(3.58686,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (155.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.204812,0.0951178,-0.00015971,1.51809e-07,-5.69162e-11,-74457,32.3074], Tmin=(100,'K'), Tmax=(797.341,'K')), NASAPolynomial(coeffs=[6.15099,0.0440631,-2.3734e-05,4.73273e-09,-3.34069e-13,-74730.6,9.19799], Tmin=(797.341,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-620.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-CdsHH) + radical(Csj(Cd-O2sCd)(F1s)(H))"""),
)
...
species(
    label = 'FC=C(F)O[C](CF)[C](F)F(10245)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (174.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.512995,0.107235,-0.000144237,9.93727e-08,-2.74505e-11,-100219,32.9719], Tmin=(100,'K'), Tmax=(880.408,'K')), NASAPolynomial(coeffs=[15.8201,0.0330264,-1.78011e-05,3.63064e-09,-2.63124e-13,-103094,-43.7453], Tmin=(880.408,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-834.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Csj(Cd-O2sCd)(F1s)(H))"""),
)

species(
    label = 'C=C(F)O[C]([C](F)F)C(F)F(10247)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (174.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.879164,0.11959,-0.000184105,1.34059e-07,-3.32788e-11,-99148.7,35.5553], Tmin=(100,'K'), Tmax=(618.935,'K')), NASAPolynomial(coeffs=[15.5248,0.0322486,-1.76855e-05,3.54885e-09,-2.51546e-13,-101537,-38.6037], Tmin=(618.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-825.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(CsCsFFH) + group(CsCsFFH) + group(CdCFO) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = 'F[C]C(=CF)OC(F)(F)CF(10248)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'FC=C1OC(F)(CF)C1(F)F(9770)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-962.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,326,540,652,719,1357,151,237,609,755,844,966,1147,1245,1323,1443,3181,3261,180,180,1273.93,1275.29],'cm^-1')),
        HinderedRotor(inertia=(0.214658,'amu*angstrom^2'), symmetry=1, barrier=(4.9354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213795,'amu*angstrom^2'), symmetry=1, barrier=(4.91556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213189,'amu*angstrom^2'), symmetry=1, barrier=(4.90165,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.316372,0.113241,-0.000211622,2.1125e-07,-7.99657e-11,-115578,33.9288], Tmin=(100,'K'), Tmax=(830.176,'K')), NASAPolynomial(coeffs=[3.91017,0.0524429,-2.87129e-05,5.69799e-09,-3.98432e-13,-114886,22.7165], Tmin=(830.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-962.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)

species(
    label = 'FCC1(F)O[C]([C](F)F)C1F(10250)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C]C(OC(F)CF)=C(F)F(10251)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (174.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.290895,0.103267,-0.000137379,9.55112e-08,-2.6947e-11,-92433,30.8906], Tmin=(100,'K'), Tmax=(858.052,'K')), NASAPolynomial(coeffs=[14.1571,0.0359138,-1.96359e-05,4.02954e-09,-2.93007e-13,-94912.4,-36.6007], Tmin=(858.052,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-769.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CsCCl_triplet)"""),
)

species(
    label = 'F[CH][C](OC(F)=CF)C(F)F(10252)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (174.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.494085,0.10381,-0.000121157,7.29808e-08,-1.77504e-11,-101276,32.2683], Tmin=(100,'K'), Tmax=(992.156,'K')), NASAPolynomial(coeffs=[16.4594,0.0354605,-1.78208e-05,3.54553e-09,-2.54353e-13,-104640,-49.3888], Tmin=(992.156,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-843.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(O[C](F)CF)C(F)(F)F(10255)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(3008)', 'O=C([CH]F)[C](F)F(9674)'],
    products = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'FC[C](F)O[C]=C(F)F(10238)'],
    products = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    products = ['FC[C](F)O[C]1C(F)C1(F)F(10239)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    products = ['F[CH][C]1OC(F)(CF)C1(F)F(10240)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)OC([CH]F)=C(F)F(10242)'],
    products = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]CF(126)', 'O=C([CH]F)[C](F)F(9674)'],
    products = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'FC[C](F)O[C]=C(F)F(10238)'],
    products = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC=C(F)O[C](CF)[C](F)F(10245)'],
    products = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    products = ['[CH2]C(F)(F)OC([CH]F)=C(F)F(10246)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    products = ['C=C(F)O[C]([C](F)F)C(F)F(10247)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    products = ['F[C]C(=CF)OC(F)(F)CF(10248)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C]=C(O[C](F)CF)C(F)F(10249)'],
    products = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]F(156)', 'FC=[C]O[C](F)CF(3117)'],
    products = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    products = ['FC=C1OC(F)(CF)C1(F)F(9770)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    products = ['FC=C(F)OC(=CF)C(F)F(9552)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    products = ['FCC1(F)O[C]([C](F)F)C1F(10250)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CF2(43)', 'FC=[C]O[C](F)CF(3117)'],
    products = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[C]C(OC(F)CF)=C(F)F(10251)'],
    products = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[CH][C](OC(F)=CF)C(F)F(10252)'],
    products = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
...
reaction(
    label = 'reaction29',
    reactants = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    products = ['C=C(F)O[C]([CH]F)C(F)(F)F(10253)'],
...
reaction(
    label = 'reaction30',
    reactants = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    products = ['[CH]C(OC(F)(F)CF)=C(F)F(10254)'],
...
reaction(
    label = 'reaction31',
    reactants = ['F[CH]C(O[C](F)CF)=C(F)F(7372)'],
    products = ['[CH]=C(O[C](F)CF)C(F)(F)F(10255)'],
...
network(
    label = 'PDepNetwork #2680',
    isomers = [
        'F[CH]C(O[C](F)CF)=C(F)F(7372)',
    ],
    reactants = [
