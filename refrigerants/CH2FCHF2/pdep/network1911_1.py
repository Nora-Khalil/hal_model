...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.019064,'amu*angstrom^2'), symmetry=1, barrier=(14.6589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.47511,'amu*angstrom^2'), symmetry=1, barrier=(56.9076,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28323,0.0711896,-0.000123818,1.24352e-07,-4.77189e-11,-43062.4,24.4507], Tmin=(100,'K'), Tmax=(830.581,'K')), NASAPolynomial(coeffs=[2.53848,0.0394705,-2.01686e-05,3.94149e-09,-2.74393e-13,-42385.3,23.9589], Tmin=(830.581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-358.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]C[CH]C(F)(F)F(7073)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9277,0.0511215,-4.76824e-05,2.72999e-08,-7.12936e-12,-48892.6,24.0706], Tmin=(100,'K'), Tmax=(872.029,'K')), NASAPolynomial(coeffs=[5.91461,0.0328334,-1.62244e-05,3.25001e-09,-2.34518e-13,-49587.9,5.38203], Tmin=(872.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-407.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sF1s)(H)) + radical(RCCJ)"""),
)

species(
    label = 'FCC[CH][C](F)F(7074)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45375,0.0643905,-0.000100358,9.78215e-08,-3.79605e-11,-42160.7,27.0653], Tmin=(100,'K'), Tmax=(797.795,'K')), NASAPolynomial(coeffs=[3.38962,0.037971,-1.92603e-05,3.79383e-09,-2.66974e-13,-41937.7,21.4966], Tmin=(797.795,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-351.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]C[CH]F(4420)'],
    products = ['[CH2]CC(F)[C](F)F(7061)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(F)[C](F)F(3717)'],
    products = ['[CH2]CC(F)[C](F)F(7061)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]CC=C(F)F(5066)'],
    products = ['[CH2]CC(F)[C](F)F(7061)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHFCF2(55)', '[CH2][CH2](4372)'],
    products = ['[CH2]CC(F)[C](F)F(7061)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]CC(F)=C(F)F(7066)'],
    products = ['[CH2]CC(F)[C](F)F(7061)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH][C](F)F(3610)', 'C2H4(30)'],
    products = ['[CH2]CC(F)[C](F)F(7061)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=CC(F)[C](F)F(7067)'],
    products = ['[CH2]CC(F)[C](F)F(7061)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH][C](F)F(3610)', '[CH2][CH2](4372)'],
    products = ['[CH2]CC(F)[C](F)F(7061)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C=C[C](F)F(7068)'],
    products = ['[CH2]CC(F)[C](F)F(7061)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C[CH]F(4420)'],
    products = ['[CH2]CC(F)[C](F)F(7061)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC(F)[C](F)F(7061)'],
    products = ['[CH2][CH]C(F)C(F)F(7071)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC(F)[C](F)F(7061)'],
    products = ['[CH2]C[CH]C(F)(F)F(7073)'],
