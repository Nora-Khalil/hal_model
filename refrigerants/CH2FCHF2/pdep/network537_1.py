...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.15662,'amu*angstrom^2'), symmetry=1, barrier=(26.593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.155,'amu*angstrom^2'), symmetry=1, barrier=(26.5558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15417,'amu*angstrom^2'), symmetry=1, barrier=(26.5367,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.47995,0.0743425,-8.07404e-05,4.28689e-08,-8.91022e-12,-66720.6,25.0633], Tmin=(100,'K'), Tmax=(1173.57,'K')), NASAPolynomial(coeffs=[17.1688,0.0174603,-8.03638e-06,1.5681e-09,-1.12112e-13,-70637.7,-58.1217], Tmin=(1173.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-555.822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(3008)', '[O]C(F)[CH]F(208)'],
    products = ['F[CH]C(F)O[C](F)CF(3024)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC=CO[C](F)CF(3041)'],
    products = ['F[CH]C(F)O[C](F)CF(3024)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)OC(F)[CH]F(3043)'],
    products = ['F[CH]C(F)O[C](F)CF(3024)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][C](F)OC(F)CF(3047)'],
    products = ['F[CH]C(F)O[C](F)CF(3024)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)O[C](F)CF(3024)'],
    products = ['F[CH][CH]OC(F)(F)CF(3048)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)O[C](F)CF(3024)'],
    products = ['[CH2]C(F)(F)OC(F)[CH]F(3050)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)O[C](F)CF(3024)'],
    products = ['[CH2][C](F)OC(F)C(F)F(3051)'],
