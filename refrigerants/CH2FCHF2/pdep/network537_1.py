...
reaction(
    label = 'reaction4',
    reactants = ['F2(78)', 'C#C[O+]=[C-]O(3280)'],
    products = ['O[C-]=[O+]C(F)=CF(3052)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'O[C-]=[O+]C#CF(3281)'],
    products = ['O[C-]=[O+]C(F)=CF(3052)'],
    transitionState = 'TS5',
