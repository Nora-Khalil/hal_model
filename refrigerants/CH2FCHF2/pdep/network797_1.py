...
"""),
    E0 = (-471.012,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,3150,900,1100,180,648.215,1274.08,1275.26,1275.95,1276.7,1278.14],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51497,0.0594011,-8.12744e-05,5.87635e-08,-1.71901e-11,-84481.5,20.4549], Tmin=(100,'K'), Tmax=(830.516,'K')), NASAPolynomial(coeffs=[9.61958,0.0203678,-1.07775e-05,2.17576e-09,-1.5655e-13,-85827.7,-17.1402], Tmin=(830.516,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-703.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.294614,'amu*angstrom^2'), symmetry=1, barrier=(6.77376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.294408,'amu*angstrom^2'), symmetry=1, barrier=(6.76903,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295222,'amu*angstrom^2'), symmetry=1, barrier=(6.78773,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.882011,0.0842621,-0.000176175,1.72333e-07,-6.13588e-11,-57144.9,24.0224], Tmin=(100,'K'), Tmax=(889.353,'K')), NASAPolynomial(coeffs=[5.46398,0.0257639,-1.3605e-05,2.56428e-09,-1.70107e-13,-56461.4,10.8788], Tmin=(889.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-475.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFFO) + group(Cs-CsOsHH) + radical(ROOJ) + radical(Csj(Cs-F1sF1sO2s)(O2s-H)(H))"""),
)

species(
    label = '[O][CH]C(F)(F)OO(3981)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.452082,'amu*angstrom^2'), symmetry=1, barrier=(10.3943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.45258,'amu*angstrom^2'), symmetry=1, barrier=(10.4057,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.452338,'amu*angstrom^2'), symmetry=1, barrier=(10.4001,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948764,0.0779531,-0.000148242,1.38783e-07,-4.87302e-11,-10669.2,24.1368], Tmin=(100,'K'), Tmax=(866.137,'K')), NASAPolynomial(coeffs=[7.56688,0.0234727,-1.24724e-05,2.4001e-09,-1.63132e-13,-10918.5,-1.662], Tmin=(866.137,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.5361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(CsCFHO) + group(Cs-CsOsHH) + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C[C](F)OOF(4220)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.84242,'amu*angstrom^2'), symmetry=1, barrier=(42.3609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.828622,'amu*angstrom^2'), symmetry=1, barrier=(19.0516,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16203,0.0761519,-0.00015224,1.52773e-07,-5.69228e-11,-6531.15,24.6815], Tmin=(100,'K'), Tmax=(851.587,'K')), NASAPolynomial(coeffs=[3.96838,0.0312572,-1.73022e-05,3.40608e-09,-2.35485e-13,-5859.21,18.3449], Tmin=(851.587,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.0427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(CsCFHO) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]CO[O](2658)'],
    products = ['[O]CC(F)(F)O[O](3979)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)O[O](135)'],
    products = ['[O]CC(F)(F)O[O](3979)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[C](F)F(219)', 'CH2O(20)'],
    products = ['[O]CC(F)(F)O[O](3979)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)(F)C=O(3986)'],
    products = ['[O]CC(F)(F)O[O](3979)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(219)', '[CH2][O](2653)'],
    products = ['[O]CC(F)(F)O[O](3979)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]O[C](F)C=O(2194)'],
    products = ['[O]CC(F)(F)O[O](3979)'],
