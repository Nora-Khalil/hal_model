...
"""),
    ...
    molecularWeight = (56.0201,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.09811,0.0228498,-4.1793e-05,3.86221e-08,-1.34609e-11,1179.06,7.86902], Tmin=(100,'K'), Tmax=(871.081,'K')), NASAPolynomial(coeffs=[4.98311,0.00749282,-3.80901e-06,7.20357e-10,-4.85532e-14,1104.89,0.494435], Tmin=(871.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.55717,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(78.9875,'J/(mol*K)'), label="""OCCO""", comment="""Thermo library: primaryThermoLibrary"""),
)

species(
    label = 'FC1=[C]OO1(9536)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (75.0185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.49189,0.0135236,-6.97205e-06,1.22041e-09,-3.75025e-14,22562.5,13.2984], Tmin=(100,'K'), Tmax=(2085.92,'K')), NASAPolynomial(coeffs=[9.80113,0.0044099,-2.56482e-06,4.97885e-10,-3.31295e-14,19281,-23.3352], Tmin=(2085.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.461,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=CJO) + longDistanceInteraction_cyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'O=C=[C]OF(11268)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (75.0185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.85908,0.0322553,-6.79187e-05,7.15317e-08,-2.74184e-11,19070.7,16.5523], Tmin=(100,'K'), Tmax=(855.887,'K')), NASAPolynomial(coeffs=[2.6972,0.0157052,-8.58246e-06,1.68801e-09,-1.16615e-13,19732.3,21.0112], Tmin=(855.887,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', 'CFO(51)'],
    products = ['O=[C]C(=O)F(1543)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]C(=O)F(1543)'],
    products = ['O=C1O[C]1F(8931)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(169.231,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra;radadd_intra_CO]
...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]C(=O)F(1543)'],
    products = ['FC1=[C]OO1(9536)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.8957e+11,'s^-1'), n=0.254, Ea=(512.801,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4;multiplebond_intra;radadd_intra_O]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 511.5 to 512.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['O=C=[C]OF(11268)'],
    products = ['O=[C]C(=O)F(1543)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(38.7688,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)
