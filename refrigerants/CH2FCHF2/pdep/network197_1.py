...
reaction(
    label = 'reaction2',
    reactants = ['[O]C=C([O])OF(1350)'],
    products = ['[O]C(=O)C([O])F(991)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C(=O)F(1357)'],
    products = ['[O]C(=O)C([O])F(991)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O][C]=O(517)', '[O][CH]F(388)'],
    products = ['[O]C(=O)C([O])F(991)'],
