...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(O)=C([O])OF(14124)'],
    products = ['[O]C(=O)C([O])(O)F(14085)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=O)C([O])(O)F(14085)'],
    products = ['OH(7)', '[O]C(=O)C(=O)F(1357)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(=O)[C](O)F(1358)'],
    products = ['[O]C(=O)C([O])(O)F(14085)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C(O)(F)[C]=O(14125)'],
    products = ['[O]C(=O)C([O])(O)F(14085)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(=O)C(=O)O(5749)'],
    products = ['[O]C(=O)C([O])(O)F(14085)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C(=O)C([O])=O(4798)'],
    products = ['[O]C(=O)C([O])(O)F(14085)'],
