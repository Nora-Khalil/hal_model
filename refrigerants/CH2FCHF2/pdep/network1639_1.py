...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'F[C]C(F)OCOF(5731)'],
    products = ['FCC(F)OCOF(5395)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FOCOC(F)F(5389)'],
    products = ['FCC(F)OCOF(5395)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['OCOF(5602)', 'CHFCHF[Z](59)'],
    products = ['FCC(F)OCOF(5395)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FOCOF(5603)', 'CH2CHF(56)'],
    products = ['FCC(F)OCOF(5395)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FC[CH]OCOF(5733)'],
    products = ['FCC(F)OCOF(5395)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)OCOF(5734)'],
    products = ['FCC(F)OCOF(5395)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]COC(F)CF(5735)'],
    products = ['FCC(F)OCOF(5395)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]COF(4677)', 'CH2F-CHF(66)'],
    products = ['FCC(F)OCOF(5395)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]OF(2659)', '[O]C(F)CF(2886)'],
    products = ['FCC(F)OCOF(5395)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(128)', '[CH2]OC(F)CF(5320)'],
    products = ['FCC(F)OCOF(5395)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2F(46)', 'F[CH]OCOF(5604)'],
    products = ['FCC(F)OCOF(5395)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FC[C](F)OCOF(5736)'],
    products = ['FCC(F)OCOF(5395)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'F[CH]C(F)OCOF(5737)'],
    products = ['FCC(F)OCOF(5395)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FCC(F)O[CH]OF(5514)'],
    products = ['FCC(F)OCOF(5395)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C=C(F)OCOF(5739)'],
    products = ['FCC(F)OCOF(5395)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=COC(F)CF(3254)'],
    products = ['FCC(F)OCOF(5395)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FCC(F)OCOF(5395)'],
    products = ['F2(78)', 'CH2O(20)', 'O=CCF(4766)'],
