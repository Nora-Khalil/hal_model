...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62515,0.0477227,-3.58503e-05,1.31125e-08,-1.92274e-12,-56988.2,19.8693], Tmin=(100,'K'), Tmax=(1591.27,'K')), NASAPolynomial(coeffs=[13.2668,0.0184595,-8.26616e-06,1.55632e-09,-1.07215e-13,-60693.2,-41.7031], Tmin=(1591.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-474.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(Cs-Cs(F)-O2s-O2s)"""),
)
...
"""),
    E0 = (-191.819,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,334,575,1197,1424,3202,180],'cm^-1')),
        HinderedRotor(inertia=(0.385918,'amu*angstrom^2'), symmetry=1, barrier=(8.87301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92233,'amu*angstrom^2'), symmetry=1, barrier=(44.1983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.385845,'amu*angstrom^2'), symmetry=1, barrier=(8.87133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92052,'amu*angstrom^2'), symmetry=1, barrier=(44.1566,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.771176,0.0800201,-0.000135494,1.24336e-07,-4.45691e-11,-22962.9,25.0549], Tmin=(100,'K'), Tmax=(819.008,'K')), NASAPolynomial(coeffs=[7.45547,0.0311739,-1.63623e-05,3.21127e-09,-2.2397e-13,-23514.5,-2.54128], Tmin=(819.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsHHH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2]OOC([CH2])(F)F(3432)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20291,0.0663497,-7.80467e-05,4.86016e-08,-1.24031e-11,-28527.9,22.9615], Tmin=(100,'K'), Tmax=(940.405,'K')), NASAPolynomial(coeffs=[10.752,0.0257324,-1.32592e-05,2.67233e-09,-1.92995e-13,-30323.9,-22.5206], Tmin=(940.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH) + radical(CsJOOC)"""),
)

species(
    label = '[CH2][C](F)OOCF(3433)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50237,0.0646795,-6.95937e-05,9.85651e-09,2.78393e-11,-25979.9,24.484], Tmin=(100,'K'), Tmax=(509.034,'K')), NASAPolynomial(coeffs=[8.04211,0.0298387,-1.56909e-05,3.12728e-09,-2.21916e-13,-26860.1,-4.7565], Tmin=(509.034,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHHO) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]O[O](231)', 'F[C]CF-2(3008)'],
    products = ['[CH2]OO[C](F)CF(3369)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]O[C](F)CF(188)'],
    products = ['[CH2]OO[C](F)CF(3369)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH2]OO[C](F)CF(3369)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(168.632,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]OOC(=C)F(3429)'],
    products = ['[CH2]OO[C](F)CF(3369)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](2599)', '[O][C](F)CF(882)'],
    products = ['[CH2]OO[C](F)CF(3369)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(19.1402,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[CH2]O[O](231)', 'F[C]CF(126)'],
    products = ['[CH2]OO[C](F)CF(3369)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(1.90285,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['COO[C](F)[CH]F(3431)'],
    products = ['[CH2]OO[C](F)CF(3369)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(107.783,'s^-1'), n=2.52115, Ea=(41.4129,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R5Hall;C_rad_out_single;Cs_H_out_2H] + [R5Hall;C_rad_out_1H;Cs_H_out] for rate rule [R5HJ_1;C_rad_out_1H;Cs_H_out_2H]
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OO[C](F)CF(3369)'],
    products = ['[CH2][C](F)OOCF(3433)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(188.452,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
