...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.87684,0.0752153,-0.000107575,8.43688e-08,-2.70492e-11,-148049,26.1937], Tmin=(100,'K'), Tmax=(757.705,'K')), NASAPolynomial(coeffs=[9.71881,0.0285357,-1.51609e-05,3.05503e-09,-2.1905e-13,-149389,-14.0099], Tmin=(757.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1231.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(COCsFO)"""),
)

species(
    label = 'F[CH]C(F)OO[C](F)F(3395)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.85107,'amu*angstrom^2'), symmetry=1, barrier=(42.5597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84742,'amu*angstrom^2'), symmetry=1, barrier=(42.4758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84887,'amu*angstrom^2'), symmetry=1, barrier=(42.5091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.720187,'amu*angstrom^2'), symmetry=1, barrier=(16.5585,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370359,0.0865788,-0.00012379,9.10943e-08,-2.68217e-11,-73859.4,28.7676], Tmin=(100,'K'), Tmax=(828.801,'K')), NASAPolynomial(coeffs=[12.925,0.0259824,-1.41123e-05,2.8659e-09,-2.06515e-13,-75940.3,-29.4432], Tmin=(828.801,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-615.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFFHO) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)

species(
    label = 'FC[C](F)OO[C](F)F(3374)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.97496,'amu*angstrom^2'), symmetry=1, barrier=(45.4082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.35321,'amu*angstrom^2'), symmetry=1, barrier=(31.1129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.96414,'amu*angstrom^2'), symmetry=1, barrier=(45.1595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588772,'amu*angstrom^2'), symmetry=1, barrier=(13.537,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.553919,0.085325,-0.000123061,8.39846e-08,-1.75096e-11,-74360.6,28.5918], Tmin=(100,'K'), Tmax=(593.367,'K')), NASAPolynomial(coeffs=[11.0124,0.0288372,-1.56905e-05,3.15509e-09,-2.24685e-13,-75848.5,-18.4844], Tmin=(593.367,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-619.226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFFHO) + radical(CsCsF1sO2s) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.92934,'amu*angstrom^2'), symmetry=1, barrier=(44.3594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.398047,'amu*angstrom^2'), symmetry=1, barrier=(9.15187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.91561,'amu*angstrom^2'), symmetry=1, barrier=(44.0437,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.981215,0.0732292,-0.000117273,1.03898e-07,-3.71053e-11,-49814.2,25.785], Tmin=(100,'K'), Tmax=(760.216,'K')), NASAPolynomial(coeffs=[8.32769,0.0280311,-1.51806e-05,3.04664e-09,-2.16496e-13,-50742.1,-6.3998], Tmin=(760.216,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-415.028,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOC(F)F(3478)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.331627,'amu*angstrom^2'), symmetry=1, barrier=(7.62476,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331044,'amu*angstrom^2'), symmetry=1, barrier=(7.61136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.18591,'amu*angstrom^2'), symmetry=1, barrier=(50.2584,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.905866,0.0763576,-0.000129944,1.19387e-07,-4.31959e-11,-49419.7,26.6985], Tmin=(100,'K'), Tmax=(796.391,'K')), NASAPolynomial(coeffs=[7.75609,0.0288471,-1.57766e-05,3.15501e-09,-2.22749e-13,-50095.2,-2.1813], Tmin=(796.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-411.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.190768,'amu*angstrom^2'), symmetry=1, barrier=(4.38612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192285,'amu*angstrom^2'), symmetry=1, barrier=(4.42101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.4216,'amu*angstrom^2'), symmetry=1, barrier=(55.6772,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.669031,0.0822011,-0.000141859,1.29961e-07,-4.66531e-11,-74826.3,28.7049], Tmin=(100,'K'), Tmax=(802.503,'K')), NASAPolynomial(coeffs=[8.40437,0.0292902,-1.61292e-05,3.22333e-09,-2.27144e-13,-75605.6,-4.03174], Tmin=(802.503,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-623.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.423877,0.0946503,-0.000182687,1.81458e-07,-6.7509e-11,-86299.5,39.7834], Tmin=(100,'K'), Tmax=(847.24,'K')), NASAPolynomial(coeffs=[4.27426,0.0401407,-2.18573e-05,4.29231e-09,-2.97056e-13,-85648,29.5411], Tmin=(847.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-718.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFFHO) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OOC(F)F(3481)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.40506,'amu*angstrom^2'), symmetry=1, barrier=(32.305,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40606,'amu*angstrom^2'), symmetry=1, barrier=(32.3282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.870826,'amu*angstrom^2'), symmetry=1, barrier=(20.022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40529,'amu*angstrom^2'), symmetry=1, barrier=(32.3104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.108908,0.0949817,-0.000162931,1.46623e-07,-5.21029e-11,-76992,27.8745], Tmin=(100,'K'), Tmax=(780.517,'K')), NASAPolynomial(coeffs=[10.422,0.0306864,-1.73776e-05,3.51775e-09,-2.50019e-13,-78253.3,-17.0919], Tmin=(780.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-641.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFFO) + group(CsFFHO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'F[C]C(F)OOC(F)F(3482)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.38654,'amu*angstrom^2'), symmetry=1, barrier=(31.8793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38728,'amu*angstrom^2'), symmetry=1, barrier=(31.8963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38753,'amu*angstrom^2'), symmetry=1, barrier=(31.902,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.628294,0.0815068,-0.00011783,9.14293e-08,-2.88798e-11,-81667.7,27.931], Tmin=(100,'K'), Tmax=(769.336,'K')), NASAPolynomial(coeffs=[10.6623,0.0293369,-1.61127e-05,3.28611e-09,-2.37181e-13,-83211.6,-17.8463], Tmin=(769.336,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-679.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(CsFFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.55521,'amu*angstrom^2'), symmetry=1, barrier=(35.7573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5557,'amu*angstrom^2'), symmetry=1, barrier=(35.7686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55225,'amu*angstrom^2'), symmetry=1, barrier=(35.6893,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44025,0.061345,-8.54774e-05,6.33225e-08,-1.90095e-11,-30880.9,20.885], Tmin=(100,'K'), Tmax=(809.642,'K')), NASAPolynomial(coeffs=[9.53722,0.0213415,-1.13624e-05,2.29427e-09,-1.6492e-13,-32192,-16.4682], Tmin=(809.642,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsFFHO) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.80226,'amu*angstrom^2'), symmetry=1, barrier=(41.4376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80016,'amu*angstrom^2'), symmetry=1, barrier=(41.3893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.512039,'amu*angstrom^2'), symmetry=1, barrier=(11.7728,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03776,0.0727584,-0.000124791,1.14111e-07,-4.12904e-11,-42868.3,24.6339], Tmin=(100,'K'), Tmax=(778.775,'K')), NASAPolynomial(coeffs=[8.20638,0.0257407,-1.45876e-05,2.95768e-09,-2.10545e-13,-43675.6,-6.17264], Tmin=(778.775,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-357.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsFFHO) + group(Ct-CtOs) + group(CtCF)"""),
)

species(
    label = 'F[C-]=[O+]OC(F)F(3485)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {7,S}
4 O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-732.148,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,180,180,180,180,1373.29,1375.14,1375.65,1375.72],'cm^-1')),
        HinderedRotor(inertia=(2.10295,'amu*angstrom^2'), symmetry=1, barrier=(48.3511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.384027,'amu*angstrom^2'), symmetry=1, barrier=(8.82954,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86543,0.0524752,-8.51059e-05,7.81238e-08,-2.87531e-11,-87985.5,20.4372], Tmin=(100,'K'), Tmax=(776.688,'K')), NASAPolynomial(coeffs=[6.12258,0.0226412,-1.22131e-05,2.44509e-09,-1.73365e-13,-88408.3,2.51056], Tmin=(776.688,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-732.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFFHO) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OOC(F)=CF(212)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FC=C(F)OOF(3293)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FC=C(F)OOC(F)F(3340)'],
    products = ['O=C(F)C(F)OC(F)F(3476)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)OO[C](F)F(3395)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction5',
    reactants = ['FC[C](F)OO[C](F)F(3374)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[CH]OOC(F)=CF(3245)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=[C]OOC(F)F(3477)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=C(F)OOC(F)F(3478)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)F(364)', 'O=C(F)[CH]F(215)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(82)', '[O]OC(F)=CF(214)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC(F)F(2774)', 'CHFCF[Z](72)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FC=C(F)OO[C](F)F(3394)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'F[C]=C(F)OOC(F)F(3479)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FC(F)[C-]=[O+]OC(F)F(3480)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C(F)(F)OOC(F)F(3481)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]C(F)OOC(F)F(3482)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'C#COOC(F)F(3483)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'FC#COOC(F)F(3484)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHF(40)', 'F[C-]=[O+]OC(F)F(3485)'],
    products = ['FC=C(F)OOC(F)F(3340)'],
