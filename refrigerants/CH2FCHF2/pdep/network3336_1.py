...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]C(=O)F(341)'],
    products = ['[O]OOC(=O)F(6945)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOC(=O)F(6945)'],
    products = ['F[C]1OOOO1(12675)'],
    transitionState = 'TS4',
