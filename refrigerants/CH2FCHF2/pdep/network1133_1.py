...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(C)[O](4407)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]C(F)(F)C[O](2550)'],
    products = ['[CH2]C(F)(F)C(C)[O](4407)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[CH]C(4487)'],
    products = ['[CH2]C(F)(F)C(C)[O](4407)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'CC([O])[C](F)F(4488)'],
    products = ['[CH2]C(F)(F)C(C)[O](4407)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[CH2]C(F)(F)C=O(432)'],
    products = ['[CH2]C(F)(F)C(C)[O](4407)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C(C)=O(4490)'],
    products = ['[CH2]C(F)(F)C(C)[O](4407)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C(C)[O](4491)'],
    products = ['[CH2]C(F)(F)C(C)[O](4407)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C(C)[O](4492)'],
    products = ['[CH2]C(F)(F)C(C)[O](4407)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(O)C([CH2])(F)F(4494)'],
    products = ['[CH2]C(F)(F)C(C)[O](4407)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([O])C(C)(F)F(4496)'],
    products = ['[CH2]C(F)(F)C(C)[O](4407)'],
...
network(
    label = 'PDepNetwork #1133',
    isomers = [
        '[CH2]C(F)(F)C(C)[O](4407)',
    ],
    reactants = [
        ('CH2CF2(57)', 'CH3CHO(36)'),
    ],
