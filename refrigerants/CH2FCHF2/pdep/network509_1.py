...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]CC(F)(F)OF(2833)'],
    products = ['FOC(F)(F)CC(F)F(2803)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]CC(F)(F)OF(2835)'],
    products = ['FOC(F)(F)CC(F)F(2803)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)(F)CC(F)F(2836)'],
    products = ['FOC(F)(F)CC(F)F(2803)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(128)', 'F[C](F)CC(F)F(2837)'],
    products = ['FOC(F)(F)CC(F)F(2803)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(2563)', 'CHF2-CH2(64)'],
    products = ['FOC(F)(F)CC(F)F(2803)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF2(82)', '[CH2]C(F)(F)OF(2838)'],
    products = ['FOC(F)(F)CC(F)F(2803)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'FOC(F)(F)[CH]C(F)F(2839)'],
    products = ['FOC(F)(F)CC(F)F(2803)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FOC(F)(F)C[C](F)F(2840)'],
    products = ['FOC(F)(F)CC(F)F(2803)'],
