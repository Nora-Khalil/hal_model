...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90316,0.0513707,-5.38072e-05,3.21342e-08,-8.32191e-12,-59902.2,21.3637], Tmin=(100,'K'), Tmax=(901.333,'K')), NASAPolynomial(coeffs=[7.25839,0.0276055,-1.42579e-05,2.88243e-09,-2.08605e-13,-60867.6,-3.91598], Tmin=(901.333,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFH) + ring(Cs-Cs(F)-O2s-O2s) + radical(C2CsJOO)"""),
)

species(
    label = 'F[CH]C1(C(F)F)OO1(11271)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.692806,0.0568924,-2.57065e-05,-2.81302e-08,2.05806e-11,-58172.1,24.5126], Tmin=(100,'K'), Tmax=(923.467,'K')), NASAPolynomial(coeffs=[23.8752,-0.00224282,3.29688e-06,-6.63123e-10,4.05617e-14,-64213.8,-95.0134], Tmin=(923.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-484.782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(CsCsFFH) + group(CsCsFHH) + ring(O2s-O2s-Cs(C-FF)) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (-102.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,350,440,435,1725,234,589,736,816,1240,3237,194,682,905,1196,1383,3221],'cm^-1')),
        HinderedRotor(inertia=(0.130497,'amu*angstrom^2'), symmetry=1, barrier=(3.00038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130549,'amu*angstrom^2'), symmetry=1, barrier=(3.00158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59931,0.0619274,-0.000110993,1.0849e-07,-4.06251e-11,-12246.1,23.1056], Tmin=(100,'K'), Tmax=(828.493,'K')), NASAPolynomial(coeffs=[4.45942,0.0285876,-1.52693e-05,3.00943e-09,-2.09961e-13,-12049.8,13.8907], Tmin=(828.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(ROOJ) + radical(Csj(Cd-O2sCd)(F1s)(H))"""),
)

species(
    label = '[CH]=C(O[O])C(F)F(11273)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-57.9012,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.268418,'amu*angstrom^2'), symmetry=1, barrier=(6.17146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2683,'amu*angstrom^2'), symmetry=1, barrier=(6.16875,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40866,0.0682207,-0.000131041,1.2835e-07,-4.69776e-11,-6881.38,23.4851], Tmin=(100,'K'), Tmax=(857.098,'K')), NASAPolynomial(coeffs=[4.71453,0.0271917,-1.44323e-05,2.80115e-09,-1.92218e-13,-6507.73,13.5316], Tmin=(857.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.9012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-446.87,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,350,440,435,1725,234,589,736,816,1240,3237,182,240,577,636,1210,1413],'cm^-1')),
        HinderedRotor(inertia=(0.0215023,'amu*angstrom^2'), symmetry=1, barrier=(48.8582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238877,'amu*angstrom^2'), symmetry=1, barrier=(5.49226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.11891,'amu*angstrom^2'), symmetry=1, barrier=(48.718,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
...
"""),
    E0 = (-360.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(0.275686,'amu*angstrom^2'), symmetry=1, barrier=(6.33857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276788,'amu*angstrom^2'), symmetry=1, barrier=(6.3639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0211917,'amu*angstrom^2'), symmetry=1, barrier=(50.8015,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.929821,0.0829366,-0.000165777,1.68875e-07,-6.39531e-11,-43298.2,26.4969], Tmin=(100,'K'), Tmax=(843.776,'K')), NASAPolynomial(coeffs=[3.10333,0.0369611,-2.06308e-05,4.09106e-09,-2.84632e-13,-42395.2,23.905], Tmin=(843.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-CsO2s)(F1s))"""),
)

species(
    label = 'F[CH]C(=CF)OOF(11275)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-159.169,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,350,440,435,1725,234,589,736,816,1240,3237,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00127039,'amu*angstrom^2'), symmetry=1, barrier=(2.60875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.93799,'amu*angstrom^2'), symmetry=1, barrier=(44.5583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0218524,'amu*angstrom^2'), symmetry=1, barrier=(44.6343,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.994134,0.0749975,-0.000128612,1.21437e-07,-4.52018e-11,-19044.1,25.8989], Tmin=(100,'K'), Tmax=(790.214,'K')), NASAPolynomial(coeffs=[6.59358,0.0315585,-1.75014e-05,3.52427e-09,-2.49984e-13,-19457.7,3.18532], Tmin=(790.214,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cd-O2sCd)(F1s)(H))"""),
)

species(
    label = '[CH]=C(OOF)C(F)F(11276)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-114.605,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00275859,'amu*angstrom^2'), symmetry=1, barrier=(4.40152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19214,'amu*angstrom^2'), symmetry=1, barrier=(4.41768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79265,'amu*angstrom^2'), symmetry=1, barrier=(41.2166,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.790465,0.0814394,-0.000149123,1.41727e-07,-5.16057e-11,-13678.7,26.3252], Tmin=(100,'K'), Tmax=(827.798,'K')), NASAPolynomial(coeffs=[6.94521,0.0299915,-1.65628e-05,3.29147e-09,-2.30173e-13,-13954,2.28762], Tmin=(827.798,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
reaction(
    ...
    products = ['[O]OC(=CF)C(F)F(7797)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.44768e+28,'m^3/(mol*s)'), n=-6.4458, Ea=(135.453,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.6591608693425184, var=5.4995193120720405, Tref=1000.0, N=19, data_mean=0.0, correlation='CH',), comment="""Estimated from node CH"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]OC(F)=CF(214)'],
    products = ['[O]OC(=CF)C(F)F(7797)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(180.157,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=C([CH]F)C(F)F(11269)'],
    products = ['[O]OC(=CF)C(F)F(7797)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]OC(=CF)C(F)F(7797)'],
    products = ['F[CH]C1(C(F)F)OO1(11271)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]OC([CH]F)=CF(11272)'],
    products = ['[O]OC(=CF)C(F)F(7797)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH]=C(O[O])C(F)F(11273)'],
    products = ['[O]OC(=CF)C(F)F(7797)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O2(2)', 'FC=[C]C(F)F(4860)'],
    products = ['[O]OC(=CF)C(F)F(7797)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.6844e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(1.54507,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CHF2(82)', '[O]O[C]=CF(288)'],
    products = ['[O]OC(=CF)C(F)F(7797)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(=[C]F)C(F)F(10313)'],
    products = ['[O]OC(=CF)C(F)F(7797)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OOC([CH]F)=C(F)F(9682)'],
    products = ['[O]OC(=CF)C(F)F(7797)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(11.4093,'s^-1'), n=2.935, Ea=(94.8722,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R4H_SSS;C_rad_out_single;O_H_out] + [R4H_S(Cd)SS;C_rad_out_single;XH_out] for rate rule [R4H_S(Cd)SS;C_rad_out_noH;O_H_out]
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(=CF)OOF(11275)'],
    products = ['[O]OC(=CF)C(F)F(7797)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(77.7218,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(OOF)C(F)F(11276)'],
    products = ['[O]OC(=CF)C(F)F(7797)'],
