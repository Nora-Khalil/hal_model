...
species(
    label = '[CH2]C([O])=CC(F)(F)C(F)F(8816)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'C=C(O)C(=C(F)F)C(F)F(8819)',
...
species(
    label = 'F[C](F)C([C]1CO1)C(F)F(8820)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = '[O][C]1CC(F)(F)C1C(F)F(8821)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'C=C([O])C(=C(F)F)C(F)F(8823)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'C=C([O])[C](C(F)F)C(F)F(8825)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH2]C(O)=C([C](F)F)C(F)F(8826)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[CH]=C(O)C([C](F)F)C(F)F(8827)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'C=C(O)C([C](F)F)[C](F)F(8828)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[CH]=C([O])C(C(F)F)C(F)F(8829)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'C=C(OF)C([CH]F)[C](F)F(8830)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'C=C([O])C([CH]F)C(F)(F)F(8831)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH2]C(=C[C](F)F)OC(F)F(8832)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = '[CH2][C]1OC(F)(F)C1C(F)F(8834)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'O=C(CF)C([CH]F)[C](F)F(8837)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C=C([O])C[C](F)F(3084)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C=C([O])C(F)[C](F)F(3910)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    products = ['[CH2]C([O])=CC(F)(F)C(F)F(8816)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    products = ['[O]C(=C[C](F)F)CC(F)F(8817)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[C]F(156)', '[CH2]C([O])=CC(F)F(6341)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O(6)', 'C=[C]C([C](F)F)C(F)F(8818)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    products = ['C=C(O)C(=C(F)F)C(F)F(8819)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    products = ['F[C](F)C([C]1CO1)C(F)F(8820)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    products = ['[O][C]1CC(F)(F)C1C(F)F(8821)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF2(82)', 'C=C([O])C=C(F)F(6423)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=C([O])C(=C(F)F)C(F)F(8823)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=C([O])C([CH]F)=C(F)F(8824)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CF2(43)', '[CH2]C([O])=CC(F)F(6341)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    products = ['C=C([O])[C](C(F)F)C(F)F(8825)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(O)=C([C](F)F)C(F)F(8826)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C(O)C([C](F)F)C(F)F(8827)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=C(O)C([C](F)F)[C](F)F(8828)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=C([O])C(C(F)F)C(F)F(8829)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C=C(OF)C([CH]F)[C](F)F(8830)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    products = ['C=C([O])C([CH]F)C(F)(F)F(8831)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    products = ['[CH2]C(=C[C](F)F)OC(F)F(8832)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(T)(18)', 'O=[C]C([C](F)F)C(F)F(7594)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    products = ['CC(=O)C(=C(F)F)C(F)F(8833)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    products = ['[CH2][C]1OC(F)(F)C1C(F)F(8834)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C=C([O])C([C](F)F)C(F)F(7423)'],
    products = ['CC([O])=C([C](F)F)C(F)F(8835)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CC(=O)C([C](F)F)[C](F)F(8836)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
...
reaction(
    label = 'reaction36',
    reactants = ['O=C(CF)C([CH]F)[C](F)F(8837)'],
    products = ['C=C([O])C([C](F)F)C(F)F(7423)'],
