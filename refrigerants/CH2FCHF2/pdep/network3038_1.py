...
species(
    label = 'FC(F)=C(F)C(F)(F)C(F)F(11913)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)[C](F)C(F)(F)F(11918)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)[C](F)C(F)C(F)(F)F(11919)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)[CH]C(F)(F)C(F)(F)F(11920)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)(F)[CH]C(F)(F)F(11921)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'F[C](F)C(F)[C](F)F(3733)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
    products = ['FC(F)=C(F)C(F)(F)C(F)F(11913)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)C(F)C(F)=C(F)F(3753)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)C(F)(F)C=C(F)F(7834)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)C(F)(F)C(F)=C(F)F(11914)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', 'F[C](F)C=C(F)[C](F)F(3754)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[C](F)C(F)=C(F)[C](F)F(11915)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', 'F[C](F)C(F)[C](F)F(3733)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
    products = ['F[C](F)C(F)[C](F)C(F)(F)F(11918)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
    products = ['F[C](F)[C](F)C(F)C(F)(F)F(11919)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
    products = ['F[C](F)[CH]C(F)(F)C(F)(F)F(11920)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(11886)'],
    products = ['F[C](F)C(F)(F)[CH]C(F)(F)F(11921)'],
...
network(
    label = 'PDepNetwork #3038',
    isomers = [
        'F[C](F)C(F)C(F)(F)[C](F)F(11886)',
    ],
    reactants = [
        ('CF2CF2(61)', 'CHFCF2(55)'),
    ],
