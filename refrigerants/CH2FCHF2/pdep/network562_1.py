...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)O[C](F)CF(3076)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(323)', 'F[C]CF-2(3036)'],
    products = ['[CH]=C(F)O[C](F)CF(3076)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)OC(=C)F(3181)'],
    products = ['[CH]=C(F)O[C](F)CF(3076)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)OC(F)=CF(3182)'],
    products = ['[CH]=C(F)O[C](F)CF(3076)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CO[C](F)CF(3183)'],
    products = ['[CH]=C(F)O[C](F)CF(3076)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)OC(F)[CH]F(1745)'],
    products = ['[CH]=C(F)O[C](F)CF(3076)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(F)O[C](F)CF(3076)'],
    products = ['[CH]=C(F)OC([CH2])(F)F(1888)'],
