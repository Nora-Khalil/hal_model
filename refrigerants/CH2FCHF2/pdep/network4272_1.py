species(
    label = 'OC(F)(F)C(F)C(F)[C](F)F(14792)',
...
species(
    label = 'OC(C(F)[C](F)F)C(F)(F)F(14842)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'OC(F)(F)C(F)C(F)(F)[CH]F(14843)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'OC(F)(F)C(F)C(F)[C]F(14844)',
...
species(
    label = 'OC(F)(F)C(F)C=C(F)F(14845)',
...
species(
    label = 'OC(F)(F)[CH]C(F)[C](F)F(14846)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'OC(F)(F)C(F)[CH][C](F)F(14847)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'O[C](F)C(F)C(F)[C](F)F(14848)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'OC(F)(F)C(F)[C](F)[C](F)F(14849)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'O=C(F)C(F)C(F)[C](F)F(4759)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1053.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,206,363,518,1175,1317,1481,3059,190,488,555,1236,1407,486,617,768,1157,1926,181.721,181.727,181.728],'cm^-1')),
        HinderedRotor(inertia=(0.167484,'amu*angstrom^2'), symmetry=1, barrier=(3.92461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167487,'amu*angstrom^2'), symmetry=1, barrier=(3.92463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54747,'amu*angstrom^2'), symmetry=1, barrier=(36.2629,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'OC(F)=C(F)C(F)[C](F)F(14852)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'OC(F)(F)C(F)C(F)[C]F-2(14853)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
species(
    label = 'OC(F)(F)C(F)[C](F)C(F)F(14854)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C(F)(F)C(F)C(F)C(F)F(14855)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'O[C](F)C(F)C(F)C(F)(F)F(14858)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction2',
    reactants = ['OC(F)(F)[C]F(3183)', 'CH2F-CF2(68)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(43)', 'OC(F)C(F)[C](F)F(805)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
    products = ['OC(C(F)[C](F)F)C(F)(F)F(14842)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
    products = ['OC(F)(F)C(F)C(F)(F)[CH]F(14843)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'F[C](F)C(F)C(F)=C(F)F(3753)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(482)', 'F[C](F)C(F)C=C(F)F(3722)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHFCF2(55)', 'OC(F)[C](F)F(787)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'OC(F)(F)C(F)C(F)[C]F(14844)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C]F(156)', 'OC(F)(F)C(F)[CH]F(4994)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)C(F)C=C(F)F(14845)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHFCF2(55)', 'OC(F)(F)[CH]F(3941)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)C(F)C(F)=C(F)F(10924)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'OC(F)(F)[CH]C(F)[C](F)F(14846)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'OC(F)(F)C(F)[CH][C](F)F(14847)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'O[C](F)C(F)C(F)[C](F)F(14848)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OH(7)', 'F[C](F)C(F)C(F)[C](F)F(3691)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[O]C(F)(F)C(F)C(F)[C](F)F(11524)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH][C](F)F(3610)', 'OC(F)(F)[CH]F(3941)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'OC(F)(F)[C](F)C(F)[C](F)F(11523)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'OC(F)(F)C(F)[C](F)[C](F)F(14849)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C(F)C(F)C(F)[C](F)F(4759)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F2(78)', 'OC(F)(F)[CH]C=C(F)F(14850)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'OC(F)(F)C(F)=C[C](F)F(7831)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F2(78)', 'OC(F)=CC(F)[C](F)F(14851)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'OC(F)=C(F)C(F)[C](F)F(14852)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction29',
    reactants = ['HF(38)', 'OC(F)(F)[CH]C(F)=C(F)F(11526)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction30',
    reactants = ['F(37)', 'OC(F)(F)C(F)C(F)[C]F-2(14853)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction32',
    reactants = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
    products = ['OC(F)(F)C(F)[C](F)C(F)F(14854)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[O]C(F)(F)C(F)C(F)C(F)F(14855)'],
    products = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
...
reaction(
    label = 'reaction35',
    reactants = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
    products = ['OC(F)(F)[CH]C(F)C(F)(F)F(14856)'],
...
reaction(
    label = 'reaction36',
    reactants = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
    products = ['OC(F)(F)C(F)[CH]C(F)(F)F(14857)'],
...
reaction(
    label = 'reaction37',
    reactants = ['OC(F)(F)C(F)C(F)[C](F)F(14792)'],
    products = ['O[C](F)C(F)C(F)C(F)(F)F(14858)'],
...
network(
    label = 'PDepNetwork #4272',
    isomers = [
        'OC(F)(F)C(F)C(F)[C](F)F(14792)',
    ],
    reactants = [
