...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[O]C([O])F(441)'],
    products = ['[O]C(F)O[CH]F(382)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)O[CH]F(464)'],
    products = ['[O]C(F)O[CH]F(382)'],
    transitionState = 'TS8',
