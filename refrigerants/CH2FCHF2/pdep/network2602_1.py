...
species(
    label = '[CH]=C(O)C(F)[C]=C(F)F(10881)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH]=C([O])C(F)C=C(F)F(10882)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'C=C([O])[CH]C(F)=C(F)F(10884)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction3',
    reactants = ['C=C([O])C(F)[C]=C(F)F(9709)'],
    products = ['[O]C(=C[C]=C(F)F)CF(10358)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(F)F(3536)', '[CH2]C(=O)[CH]F(6328)'],
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)[C]=C(F)F(10872)'],
    products = ['C=C([O])C(F)[C]=C(F)F(9709)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C([O])C(F)[C]=C(F)F(9709)'],
    products = ['C=C(O)C(F)=C=C(F)F(10873)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C(F)[C]=C(F)F(9709)'],
    products = ['FC(F)=[C]C(F)[C]1CO1(10874)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C([O])C=C=C(F)F(10876)'],
    products = ['C=C([O])C(F)[C]=C(F)F(9709)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C([O])C(F)=C=C(F)F(10877)'],
    products = ['C=C([O])C(F)[C]=C(F)F(9709)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'C=C([O])C(F)C#CF(10878)'],
    products = ['C=C([O])C(F)[C]=C(F)F(9709)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=C([O])C(F)[C]=C(F)F(9709)'],
    products = ['C=C([O])C(F)=C[C](F)F(10879)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C([O])C(F)[C]=C(F)F(9709)'],
    products = ['C=C(O)C(F)=[C][C](F)F(10880)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(O)C(F)[C]=C(F)F(10881)'],
    products = ['C=C([O])C(F)[C]=C(F)F(9709)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C([O])C(F)C=C(F)F(10882)'],
    products = ['C=C([O])C(F)[C]=C(F)F(9709)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=C([CH][C]=C(F)F)OF(10883)'],
    products = ['C=C([O])C(F)[C]=C(F)F(9709)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([O])C(F)[C]=C(F)F(9709)'],
    products = ['C=C([O])[CH]C(F)=C(F)F(10884)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C(OF)C(F)[C]=[C]F(10885)'],
    products = ['C=C([O])C(F)[C]=C(F)F(9709)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=C([O])C(F)C(F)=[C]F(10886)'],
    products = ['C=C([O])C(F)[C]=C(F)F(9709)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(18)', 'O=[C]C(F)[C]=C(F)F(10514)'],
    products = ['C=C([O])C(F)[C]=C(F)F(9709)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C=C([O])C(F)[C]=C(F)F(9709)'],
    products = ['CC(=O)C(F)=C=C(F)F(10887)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C=C([O])C(F)[C]=C(F)F(9709)'],
    products = ['CC(=O)C(F)=[C][C](F)F(10888)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O=C(CF)C(F)[C]=[C]F(10889)'],
    products = ['C=C([O])C(F)[C]=C(F)F(9709)'],
...
network(
    label = 'PDepNetwork #2602',
    isomers = [
        'C=C([O])C(F)[C]=C(F)F(9709)',
    ],
    reactants = [
