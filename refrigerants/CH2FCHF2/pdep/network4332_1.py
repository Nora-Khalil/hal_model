...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]OC[O](2691)'],
    products = ['[CH2]OC(C)[O](15038)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'CC([O])[O](9414)'],
    products = ['[CH2]OC(C)[O](15038)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[CH2]OC=O(2738)'],
    products = ['[CH2]OC(C)[O](15038)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]OC(C)=O(15110)'],
    products = ['[CH2]OC(C)[O](15038)'],
