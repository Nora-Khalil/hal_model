...
reaction(
    label = 'reaction2',
    reactants = ['[O][C](F)C(=O)OF(4272)'],
    products = ['[O]C(=O)C([O])(F)F(4260)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(F)(F)[C]=O(4273)'],
    products = ['[O]C(=O)C([O])(F)F(4260)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(=O)F(1357)'],
    products = ['[O]C(=O)C([O])(F)F(4260)'],
    transitionState = 'TS9',
