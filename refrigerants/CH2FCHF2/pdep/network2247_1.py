...
"""),
    E0 = (-116.215,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,323,467,575,827,1418,531.912],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
...
"""),
    E0 = (95.833,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([347,453,1141,1468,2750,3150,900,1100,409.997,410.038,410.082,410.413,820.863,1340.94,1340.99],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]1C=C1(13640)'],
    products = ['FC1(F)C=C1(8456)'],
    transitionState = 'TS4',
