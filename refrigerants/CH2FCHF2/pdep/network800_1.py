...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', 'F[CH]C[C](F)F(157)'],
    products = ['F[C](F)CC(F)[C](F)F(3675)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(156)', '[CH2]C(F)[C](F)F(3717)'],
    products = ['F[C](F)CC(F)[C](F)F(3675)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)CC=C(F)F(192)'],
    products = ['F[C](F)CC(F)[C](F)F(3675)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)CC(F)=C(F)F(3721)'],
    products = ['F[C](F)CC(F)[C](F)F(3675)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C](F)C(F)C=C(F)F(3722)'],
    products = ['F[C](F)CC(F)[C](F)F(3675)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[C](F)C=C[C](F)F(3723)'],
    products = ['F[C](F)CC(F)[C](F)F(3675)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', 'F[CH]C[C](F)F(157)'],
    products = ['F[C](F)CC(F)[C](F)F(3675)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', '[CH2]C(F)[C](F)F(3717)'],
    products = ['F[C](F)CC(F)[C](F)F(3675)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)[CH]C(F)F(3707)'],
    products = ['F[C](F)CC(F)[C](F)F(3675)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)[CH]C(F)C(F)F(3705)'],
    products = ['F[C](F)CC(F)[C](F)F(3675)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)CC(F)[C](F)F(3675)'],
    products = ['F[C](F)[C](F)CC(F)F(3725)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)CC(F)[C](F)F(3675)'],
    products = ['F[C](F)C[CH]C(F)(F)F(3726)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C](F)CC(F)[C](F)F(3675)'],
    products = ['F[C](F)[CH]CC(F)(F)F(3727)'],
