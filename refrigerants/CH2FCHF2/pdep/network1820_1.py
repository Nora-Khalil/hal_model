...
species(
    label = '[O]C(F)(F)C1(F)[CH]OO1(6442)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    ...
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=COF)C([O])(F)F(6440)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C=C(F)C([O])(F)F(6441)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)(C=O)[C](F)F(1769)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1667.73,'m^3/(mol*s)'), n=1.126, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_ter_rad;O_birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
    products = ['O=CC1(F)OOC1(F)F(6205)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
    products = ['[O]C(F)(F)C1(F)[CH]OO1(6442)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
    products = ['[O]C1OC1(F)C([O])(F)F(6443)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)C=O(6445)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HCO(15)', '[O]C(F)(F)C(=O)F(2728)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C(F)(C=O)C(=O)F(2196)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', '[O]C=C([O])C(=O)F(2198)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
    products = ['[O]C(F)(F)C(O)(F)[C]=O(6447)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
    products = ['[O]C(F)([C]=O)C(O)(F)F(6448)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C=C(OF)C([O])(F)F(6449)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C=C([O])C(F)(F)OF(6450)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O][C](F)C(F)(C=O)OF(6451)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(C=O)[C](F)OF(6452)'],
    products = ['[O]C(F)(F)C([O])(F)C=O(6198)'],
...
network(
    label = 'PDepNetwork #1820',
    isomers = [
        '[O]C(F)(F)C([O])(F)C=O(6198)',
    ],
    reactants = [
