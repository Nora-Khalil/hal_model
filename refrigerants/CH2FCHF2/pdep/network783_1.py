...
reaction(
    label = 'reaction2',
    reactants = ['[O]CC(F)[C](F)F(3665)'],
    products = ['[O]CC(F)(F)[CH]F(3664)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=CC(F)(F)[CH]F(3612)'],
    products = ['[O]CC(F)(F)[CH]F(3664)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]C(F)(F)[CH]F(3823)'],
    products = ['[O]CC(F)(F)[CH]F(3664)'],
