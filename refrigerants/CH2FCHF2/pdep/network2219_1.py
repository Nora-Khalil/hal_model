...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C#COO(6893)'],
    products = ['C#COOCF(3302)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COOF(6894)'],
    products = ['C#COOCF(3302)'],
    transitionState = 'TS3',
