...
reaction(
    label = 'reaction2',
    reactants = ['H(5)', 'CH3(19)'],
    products = ['CH4(4)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.801e+14,'cm^3/(mol*s)'), n=0, Ea=(0,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library FFCM1(-)"""),
)

reaction(
    label = 'reaction1',
    reactants = ['H2(8)', 'CH2(S)(25)'],
    products = ['CH4(4)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(11.6611,'m^3/(mol*s)'), n=1.785, Ea=(3.14361,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.12638824541802388, var=0.1087312542899948, Tref=1000.0, N=2, data_mean=0.0, correlation='HH_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->Br1s',), comment="""Estimated from node HH_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->Br1s"""),
)

network(
    label = 'PDepNetwork #2420',
    isomers = [
        'CH4(4)',
    ],
    reactants = [
