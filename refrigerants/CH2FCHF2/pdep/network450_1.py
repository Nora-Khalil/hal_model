...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C[C](F)F(2684)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C=C(F)F(2733)'],
    products = ['[O]C(F)(F)C[C](F)F(2684)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)[CH][C](F)F(2734)'],
    products = ['[O]C(F)(F)C[C](F)F(2684)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)(F)[CH]C(F)F(2708)'],
    products = ['[O]C(F)(F)C[C](F)F(2684)'],
