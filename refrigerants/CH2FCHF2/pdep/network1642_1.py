...
"""),
    E0 = (-638.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,395.909,395.941,395.963],'cm^-1')),
        HinderedRotor(inertia=(0.00107512,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00107506,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FCCOF(2958)'],
    products = ['FCC(F)(F)COF(5398)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(41)', 'F[C]COF(2957)'],
    products = ['FCC(F)(F)COF(5398)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FCC(F)(F)OF(2923)'],
    products = ['FCC(F)(F)COF(5398)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)(F)COF(5577)'],
    products = ['FCC(F)(F)COF(5398)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'FOCC(F)(F)F(5578)'],
    products = ['FCC(F)(F)COF(5398)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(488)', 'C=C(F)CF(2961)'],
    products = ['FCC(F)(F)COF(5398)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[C](F)COF(2968)'],
    products = ['FCC(F)(F)COF(5398)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)(F)COF(2980)'],
    products = ['FCC(F)(F)COF(5398)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]CC(F)(F)CF(5319)'],
    products = ['FCC(F)(F)COF(5398)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(128)', '[CH2]C(F)(F)CF(4106)'],
    products = ['FCC(F)(F)COF(5398)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(2659)', 'CH2F-CF2(68)'],
    products = ['FCC(F)(F)COF(5398)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'FOC[C](F)F(2979)'],
    products = ['FCC(F)(F)COF(5398)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FCC(F)(F)[CH]OF(5428)'],
    products = ['FCC(F)(F)COF(5398)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[CH]C(F)(F)COF(5579)'],
    products = ['FCC(F)(F)COF(5398)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', 'C=C(F)COF(2971)'],
    products = ['FCC(F)(F)COF(5398)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'FC=C(F)COF(5580)'],
    products = ['FCC(F)(F)COF(5398)'],
