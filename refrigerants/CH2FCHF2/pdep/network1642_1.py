...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)OF(5574)', 'CH3(19)'],
    products = ['COC(=O)OF(5358)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(=O)OF(5572)'],
    products = ['COC(=O)OF(5358)'],
    transitionState = 'TS9',
