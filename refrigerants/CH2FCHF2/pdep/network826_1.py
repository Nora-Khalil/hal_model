...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.460353,0.0736544,-6.82668e-05,3.0955e-08,-5.57682e-12,-144694,25.8321], Tmin=(100,'K'), Tmax=(1328.78,'K')), NASAPolynomial(coeffs=[17.3768,0.0227309,-1.07811e-05,2.11352e-09,-1.50472e-13,-149189,-60.5886], Tmin=(1328.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1204.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(CsCsCsFH) + group(CsCFFO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + ring(Cs-Cs(F)(F)-O2s-Cs)"""),
)

species(
    label = 'FC=C(F)OC(F)(F)CF(3852)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0741498,0.0920962,-0.000111372,6.64912e-08,-1.56738e-11,-140206,27.283], Tmin=(100,'K'), Tmax=(1033.2,'K')), NASAPolynomial(coeffs=[17.5854,0.0237284,-1.21167e-05,2.44748e-09,-1.77495e-13,-143855,-58.4909], Tmin=(1033.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1166.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)
...
species(
    label = 'F[CH]C(F)OC(F)(F)[CH]F(3903)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.869169,0.11662,-0.000196917,1.68234e-07,-5.60294e-11,-109171,32.0511], Tmin=(100,'K'), Tmax=(816.027,'K')), NASAPolynomial(coeffs=[14.6403,0.0292708,-1.55374e-05,3.04621e-09,-2.11814e-13,-111325,-37.3097], Tmin=(816.027,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-909.083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-891.081,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,522,611,926,1093,1137,1374,1416,3112,353,437,368,578,616,798,1350,1522,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(F)(F)OC(F)(F)[CH]F(3905)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.481,0.106505,-0.000160574,1.23956e-07,-3.7996e-11,-113672,30.8531], Tmin=(100,'K'), Tmax=(799.62,'K')), NASAPolynomial(coeffs=[14.9579,0.0292705,-1.56843e-05,3.15171e-09,-2.25011e-13,-116141,-40.1774], Tmin=(799.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-946.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFO) + group(Cs-CsHHH) + group(CsCsFHH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)

species(
    label = '[CH2][C](F)OC(F)(F)C(F)F(3906)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.538842,0.109303,-0.00018169,1.5751e-07,-5.3826e-11,-111788,33.2245], Tmin=(100,'K'), Tmax=(794.559,'K')), NASAPolynomial(coeffs=[12.6669,0.0325637,-1.74523e-05,3.45897e-09,-2.42913e-13,-113563,-25.4111], Tmin=(794.559,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-930.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)[CH]F(2586)', 'F[C]CF-2(3008)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'FC[C](F)O[C](F)F(2582)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
    products = ['FCC1(F)OC(F)(F)C1F(3849)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
    products = ['FC=C(F)OC(F)(F)CF(3852)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(58.5139,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC=C(F)O[C](F)CF(3042)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(49.0328,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)OC(F)(F)[CH]F(3901)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]C(F)(F)OC(F)=CF(3902)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)(F)[CH]F(2586)', 'F[C]CF(126)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'FC[C](F)O[C](F)F(2582)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]C(F)OC(F)(F)[CH]F(3903)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
    products = ['F[CH][C](F)OC(F)(F)CF(3904)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FC[C](F)O[C](F)C(F)F(3893)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
    products = ['[CH2]C(F)(F)OC(F)(F)[CH]F(3905)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)O[C](F)CF(3847)'],
    products = ['[CH2][C](F)OC(F)(F)C(F)F(3906)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(186.17,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #826',
    isomers = [
        'F[CH]C(F)(F)O[C](F)CF(3847)',
    ],
    reactants = [
