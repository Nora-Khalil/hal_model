...
"""),
    E0 = (-607.261,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([249,341,381,651,928,1217,1251,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,201.798,206.093],'cm^-1')),
        HinderedRotor(inertia=(0.181072,'amu*angstrom^2'), symmetry=1, barrier=(5.37427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178625,'amu*angstrom^2'), symmetry=1, barrier=(5.41776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.781031,'amu*angstrom^2'), symmetry=1, barrier=(22.2202,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.575911,0.0827261,-0.000130702,1.14235e-07,-4.00132e-11,-72920.5,26.3394], Tmin=(100,'K'), Tmax=(782.109,'K')), NASAPolynomial(coeffs=[9.03539,0.0312421,-1.61988e-05,3.19621e-09,-2.24841e-13,-73992.4,-10.7866], Tmin=(782.109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-607.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(Csj(Cs-F1sF1sCO)(H)(H))"""),
)
...
"""),
    E0 = (-452.893,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([249,341,381,651,928,1217,1251,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,235,1215,1347,1486,3221,268.024,1386.57],'cm^-1')),
        HinderedRotor(inertia=(0.178002,'amu*angstrom^2'), symmetry=1, barrier=(9.06862,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178035,'amu*angstrom^2'), symmetry=1, barrier=(9.07518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.742824,'amu*angstrom^2'), symmetry=1, barrier=(37.8399,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789838,0.0768561,-0.000118838,1.00676e-07,-3.43844e-11,-54360.8,25.4707], Tmin=(100,'K'), Tmax=(759.717,'K')), NASAPolynomial(coeffs=[9.54315,0.0273,-1.41447e-05,2.79528e-09,-1.97126e-13,-55590.7,-13.6946], Tmin=(759.717,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-452.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(Csj(Cs-F1sF1sCO)(H)(H)) + radical(Csj(CO-CsO2d)(F1s)(H))"""),
)
...
"""),
    E0 = (-423.176,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,3000,3100,440,815,1455,1000,228.04,228.102,228.109],'cm^-1')),
        HinderedRotor(inertia=(0.193459,'amu*angstrom^2'), symmetry=1, barrier=(7.14251,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193451,'amu*angstrom^2'), symmetry=1, barrier=(7.14272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.842847,'amu*angstrom^2'), symmetry=1, barrier=(31.1221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193371,'amu*angstrom^2'), symmetry=1, barrier=(7.14067,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.474989,0.109575,-0.000190418,1.69673e-07,-5.84479e-11,-50745.9,30.843], Tmin=(100,'K'), Tmax=(833.45,'K')), NASAPolynomial(coeffs=[11.5421,0.0326155,-1.72022e-05,3.35753e-09,-2.3242e-13,-52079.2,-20.925], Tmin=(833.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-423.176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFHH) + group(Cs-CsHHH) + radical(C2CsJO) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = '[O][C](CF)C(F)(F)CF(3109)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.1069,'amu*angstrom^2'), symmetry=1, barrier=(25.4498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.556583,'amu*angstrom^2'), symmetry=1, barrier=(12.7969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.556484,'amu*angstrom^2'), symmetry=1, barrier=(12.7947,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.303407,0.103221,-0.000168492,1.44376e-07,-4.87481e-11,-85464.3,28.6394], Tmin=(100,'K'), Tmax=(804.93,'K')), NASAPolynomial(coeffs=[12.2335,0.0311868,-1.61164e-05,3.15119e-09,-2.1966e-13,-87167.2,-27.1649], Tmin=(804.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-711.811,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsCsFHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2][C](F)C(F)(CF)OF(3110)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-400.684,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,528,1116,1182,1331,1402,1494,3075,3110,212,367,445,1450,3000,3100,440,815,1455,1000,219.578,220.416,226.762],'cm^-1')),
        HinderedRotor(inertia=(0.378663,'amu*angstrom^2'), symmetry=1, barrier=(13.118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130895,'amu*angstrom^2'), symmetry=1, barrier=(5.028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.898758,'amu*angstrom^2'), symmetry=1, barrier=(35.8683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.993806,'amu*angstrom^2'), symmetry=1, barrier=(35.8767,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.257064,0.101972,-0.000162525,1.38274e-07,-4.70413e-11,-48045.8,30.8013], Tmin=(100,'K'), Tmax=(763.423,'K')), NASAPolynomial(coeffs=[12.0392,0.0328301,-1.74095e-05,3.46057e-09,-2.44411e-13,-49785.9,-24.3017], Tmin=(763.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-400.684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
species(
    label = '[CH2]C(F)(F)C([CH2])(F)OF(3111)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH2]C(F)(F)C([O])F(372)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH2]C(F)(F)C([O])(F)F(2568)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C](F)CF(179)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', '[O]C(F)(CF)[C](F)F(3100)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)CF(3101)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2F(46)', '[CH2]C(F)(F)C(=O)F(433)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C([O])(F)CF(3102)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[CH2]C(F)=C([O])CF(3103)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', '[CH2]C(F)(F)C(=C)[O](3104)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C(F)(F)C(=O)[CH]F(3105)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
    products = ['[CH2]C(F)(F)C(O)(F)[CH]F(3106)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
    products = ['CC(F)(F)C([O])(F)[CH]F(3107)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)[C](CF)OF(3108)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O][C](CF)C(F)(F)CF(3109)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][C](F)C(F)(CF)OF(3110)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(CF)[C](F)CF(3061)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(F)(F)C([CH2])(F)OF(3111)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([O])(F)C(F)(F)CF(3112)'],
    products = ['[CH2]C(F)(F)C([O])(F)CF(3027)'],
