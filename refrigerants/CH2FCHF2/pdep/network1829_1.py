...
"""),
    E0 = (-585.088,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,482,586,761,1411,197,221,431,657,2120,512.5,787.5,682.879,682.883,682.886,682.892],'cm^-1')),
        HinderedRotor(inertia=(0.160429,'amu*angstrom^2'), symmetry=1, barrier=(3.68858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84937,'amu*angstrom^2'), symmetry=1, barrier=(19.5287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73048,'amu*angstrom^2'), symmetry=1, barrier=(39.7871,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04837,0.064749,-8.221e-05,4.99608e-08,-1.17585e-11,-70263.3,24.9722], Tmin=(100,'K'), Tmax=(1045.63,'K')), NASAPolynomial(coeffs=[15.0067,0.0113513,-5.60757e-06,1.12038e-09,-8.10291e-14,-73182.3,-42.9915], Tmin=(1045.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-585.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + missing(O2d-Cdd) + group(CsFHOO) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(CsF1sO2sO2s)"""),
)

species(
    label = 'O=C=[C]OC(O)(F)F(8952)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.813561,'amu*angstrom^2'), symmetry=1, barrier=(18.7054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.813447,'amu*angstrom^2'), symmetry=1, barrier=(18.7028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.813864,'amu*angstrom^2'), symmetry=1, barrier=(18.7123,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.68732,0.0714899,-9.83206e-05,6.30752e-08,-1.5406e-11,-71495.1,25.6247], Tmin=(100,'K'), Tmax=(1017.19,'K')), NASAPolynomial(coeffs=[17.1397,0.00679323,-2.91663e-06,5.4807e-10,-3.85483e-14,-74842.2,-54.029], Tmin=(1017.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-595.447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + missing(O2d-Cdd) + group(CsFFOO) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-595.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,493,600,700,1144,1293,2120,512.5,787.5,382.861,383.168,383.869,384.011],'cm^-1')),
        HinderedRotor(inertia=(0.00115086,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00114195,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.026,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51137,0.0549321,-6.58004e-05,3.76387e-08,-8.40602e-12,-71575.9,23.5316], Tmin=(100,'K'), Tmax=(1093.95,'K')), NASAPolynomial(coeffs=[13.4173,0.0113984,-6.10783e-06,1.26129e-09,-9.26967e-14,-74180.8,-34.9766], Tmin=(1093.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-595.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsFFHO) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.75356,'amu*angstrom^2'), symmetry=1, barrier=(40.3178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.75454,'amu*angstrom^2'), symmetry=1, barrier=(40.3403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7572,'amu*angstrom^2'), symmetry=1, barrier=(40.4015,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.282185,0.0927152,-0.000168365,1.54649e-07,-5.44106e-11,-93647,38.042], Tmin=(100,'K'), Tmax=(837.197,'K')), NASAPolynomial(coeffs=[9.35311,0.0284078,-1.55776e-05,3.06786e-09,-2.12872e-13,-94431,0.280466], Tmin=(837.197,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-779.65,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFFOO) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53551,0.024033,-4.26136e-05,3.8732e-08,-1.34304e-11,7697.1,25.5768], Tmin=(100,'K'), Tmax=(857.4,'K')), NASAPolynomial(coeffs=[4.78323,0.00773535,-3.93447e-06,7.52111e-10,-5.12486e-14,7525.27,16.3244], Tmin=(857.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.731,'kJ/mol'), Cp0=(29.1007,'J/(mol*K)'), CpInf=(87.302,'J/(mol*K)'), label="""OCCO(S)""", comment="""Thermo library: primaryThermoLibrary"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C=C(F)OC(O)(F)F(6207)'],
...
reaction(
    ...
    products = ['O=C=C(F)OC(O)(F)F(6207)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(F)O[C](F)C=O(6202)'],
    products = ['O=C=C(F)OC(O)(F)F(6207)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(F)OC(F)=[C]O(6324)'],
    products = ['O=C=C(F)OC(O)(F)F(6207)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C=C(F)O[C](O)F(8951)'],
    products = ['O=C=C(F)OC(O)(F)F(6207)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C=[C]OC(O)(F)F(8952)'],
    products = ['O=C=C(F)OC(O)(F)F(6207)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O[C](F)F(2562)', 'O=[C]C(=O)F(1543)'],
    products = ['O=C=C(F)OC(O)(F)F(6207)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(O)(F)F(2944)', 'O=C=[C]F(289)'],
    products = ['O=C=C(F)OC(O)(F)F(6207)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=C=C(F)O[C](F)F(8953)'],
    products = ['O=C=C(F)OC(O)(F)F(6207)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)=C=O(6315)'],
    products = ['O=C=C(F)OC(O)(F)F(6207)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(F)[C-]=[O+]C(O)(F)F(8954)'],
    products = ['O=C=C(F)OC(O)(F)F(6207)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C=C(F)OC(=O)F(8955)'],
    products = ['O=C=C(F)OC(O)(F)F(6207)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C=C(F)OC(O)(F)F(6207)'],
    products = ['HF(38)', 'CF2O(49)', 'O=C=C=O(1544)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C=C(F)OC(O)(F)F(6207)'],
    products = ['CO(13)', 'OC(F)(F)[O+]=[C-]F(4079)'],
...
network(
    label = 'PDepNetwork #1829',
    isomers = [
        'O=C=C(F)OC(O)(F)F(6207)',
    ],
    reactants = [
