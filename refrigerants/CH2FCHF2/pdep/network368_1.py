...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)O[C](F)C=O(2042)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O=C[C](F)O[CH]F(1730)'],
    products = ['[O]C(F)O[C](F)C=O(2042)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)O[C](F)C=O(2042)'],
    products = ['[O]C(F)OC1(F)[CH]O1(2330)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=CO[C](F)C=O(2331)'],
    products = ['[O]C(F)O[C](F)C=O(2042)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C[C](F)OC(=O)F(2332)'],
    products = ['[O]C(F)O[C](F)C=O(2042)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)OC(F)=C=O(2333)'],
    products = ['[O]C(F)O[C](F)C=O(2042)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C([O])F(441)', 'O=C[C]F-2(1738)'],
    products = ['[O]C(F)O[C](F)C=O(2042)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=C[C](F)O[CH]OF(2338)'],
    products = ['[O]C(F)O[C](F)C=O(2042)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O][CH]OC(F)(F)C=O(2339)'],
    products = ['[O]C(F)O[C](F)C=O(2042)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)C([O])C(=O)F(2039)'],
    products = ['[O]C(F)O[C](F)C=O(2042)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(6)', '[CH]=C(F)OC([O])F(2340)'],
    products = ['[O]C(F)O[C](F)C=O(2042)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C(F)O[C](F)C=O(2042)'],
    products = ['[O][CH]C1(F)OC(F)O1(2342)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', '[O]C(F)O[C]=C=O(2343)'],
    products = ['[O]C(F)O[C](F)C=O(2042)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[O]C(F)O[C](F)C=O(2042)'],
    products = ['O=C(F)O[C](F)[CH]O(2345)'],
