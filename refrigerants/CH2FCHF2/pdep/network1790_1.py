...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'O=[C]C[CH]F(6288)'],
    products = ['O=[C]CC(F)[CH]F(6182)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(514)', '[CH2]C(F)[CH]F(155)'],
    products = ['O=[C]CC(F)[CH]F(6182)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C(F)[CH]F(155)'],
    products = ['O=[C]CC(F)[CH]F(6182)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]CC(F)=CF(6292)'],
    products = ['O=[C]CC(F)[CH]F(6182)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=CC(F)[CH]F(6293)'],
    products = ['O=[C]CC(F)[CH]F(6182)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=[C]C=C[CH]F(6294)'],
    products = ['O=[C]CC(F)[CH]F(6182)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'O=[C]C[CH]F(6288)'],
    products = ['O=[C]CC(F)[CH]F(6182)'],
