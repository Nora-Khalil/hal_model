...
"""),
    E0 = (163.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,451.779,2171.56],'cm^-1')),
        HinderedRotor(inertia=(0.227454,'amu*angstrom^2'), symmetry=1, barrier=(9.19485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0103931,'amu*angstrom^2'), symmetry=1, barrier=(1.50124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290361,'amu*angstrom^2'), symmetry=1, barrier=(9.19912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3362,0.0379301,-3.71702e-05,2.20964e-08,-5.55881e-12,19773.7,16.1041], Tmin=(100,'K'), Tmax=(945.802,'K')), NASAPolynomial(coeffs=[6.70522,0.0194526,-7.86563e-06,1.44049e-09,-9.89183e-14,18947.2,-4.7305], Tmin=(945.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CJCO) + radical(CsJOCC)"""),
)
...
"""),
    ...
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38891,0.020356,3.9567e-05,-7.42368e-08,3.24739e-11,-17723.4,12.6366], Tmin=(100,'K'), Tmax=(922.775,'K')), NASAPolynomial(coeffs=[14.789,0.00555521,3.11009e-07,-1.33449e-10,5.00706e-15,-21670.2,-55.1756], Tmin=(922.775,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90614,0.0490486,-6.79678e-05,5.41326e-08,-1.72811e-11,18907.6,15.3998], Tmin=(100,'K'), Tmax=(841.191,'K')), NASAPolynomial(coeffs=[7.45111,0.0190454,-7.98276e-06,1.45438e-09,-9.8097e-14,18103.4,-9.62787], Tmin=(841.191,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(156.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCsJOCs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[CH2](2633)'],
    products = ['[CH2]CO[CH2](9367)'],
    transitionState = 'TS3',
