...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][C](F)C(=O)OF(547)'],
    products = ['[CH2]C(F)(F)C([O])=O(351)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C(=O)[C](F)F(548)'],
    products = ['[CH2]C(F)(F)C([O])=O(351)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=O(549)'],
    products = ['[CH2]C(F)(F)C([O])=O(351)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C([O])=O(552)'],
    products = ['[CH2]C(F)(F)C([O])=O(351)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CO2(14)', '[CH2][C](F)F(163)'],
    products = ['[CH2]C(F)(F)C([O])=O(351)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(517)', '[CH2][C](F)F(163)'],
    products = ['[CH2]C(F)(F)C([O])=O(351)'],
