...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF(126)', 'C#COO(7307)'],
    products = ['C#COOC(F)CF(3423)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'C#COOC(F)[C]F(8767)'],
    products = ['C#COOC(F)CF(3423)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'C#COOC(F)F(3308)'],
    products = ['C#COOC(F)CF(3423)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#COO[CH]CF(8769)'],
    products = ['C#COOC(F)CF(3423)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#COOC([CH2])F(8770)'],
    products = ['C#COOC(F)CF(3423)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HCCO(21)', '[O]C(F)CF(2886)'],
    products = ['C#COOC(F)CF(3423)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C2H(22)', '[O]OC(F)CF(2793)'],
    products = ['C#COOC(F)CF(3423)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2F(46)', 'C#COO[CH]F(7309)'],
    products = ['C#COOC(F)CF(3423)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#COO[C](F)CF(8715)'],
    products = ['C#COOC(F)CF(3423)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#COOC(F)[CH]F(4983)'],
    products = ['C#COOC(F)CF(3423)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[C]#COOC(F)CF(8771)'],
    products = ['C#COOC(F)CF(3423)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C#COOC(=C)F(8774)'],
    products = ['C#COOC(F)CF(3423)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COOC=CF(8775)'],
    products = ['C#COOC(F)CF(3423)'],
