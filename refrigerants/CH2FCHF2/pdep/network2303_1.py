...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C1O[C]1F(8497)'],
    products = ['O=[C]OC1O[C]1F(8649)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C1O[C]1F(8497)'],
    products = ['O=[C]OC1O[C]1F(8649)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC1=C(F)O1(8741)'],
    products = ['O=[C]OC1O[C]1F(8649)'],
    transitionState = 'TS9',
