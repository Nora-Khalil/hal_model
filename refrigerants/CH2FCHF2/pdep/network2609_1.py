...
species(
    label = '[CH]=C(F)C(F)(F)C[C]=O(10689)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=CF-2(3543)', 'O=[C]C[C](F)F(541)'],
    products = ['O=[C]CC(F)(F)[C]=CF(9714)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(514)', '[CH2]C(F)(F)[C]=CF(294)'],
    products = ['O=[C]CC(F)(F)[C]=CF(9714)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]CC(F)(F)[C]=CF(9714)'],
    products = ['O=C=CC(F)(F)C=CF(10677)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C(F)(F)[C]=CF(294)'],
    products = ['O=[C]CC(F)(F)[C]=CF(9714)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=[C]CC(F)=C=CF(10678)'],
    products = ['O=[C]CC(F)(F)[C]=CF(9714)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C=CC(F)(F)[C]=CF(10679)'],
    products = ['O=[C]CC(F)(F)[C]=CF(9714)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C#CC(F)(F)C[C]=O(10680)'],
    products = ['O=[C]CC(F)(F)[C]=CF(9714)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=[C]CC(F)(F)C#CF(10681)'],
    products = ['O=[C]CC(F)(F)[C]=CF(9714)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=[C]C=C(F)[C]=CF(10682)'],
    products = ['O=[C]CC(F)(F)[C]=CF(9714)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]CC(F)(F)[C]=CF(9714)'],
    products = ['[O]C=CC(F)(F)[C]=CF(10683)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]CC(F)(F)[C]=CF(9714)'],
    products = ['O=[C]CC(F)(F)C=[C]F(10684)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]CC(F)(F)[C]=CF(9714)'],
    products = ['O=[C][CH]C(F)(F)C=CF(10685)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=CCC(F)(F)[C]=[C]F(10686)'],
    products = ['O=[C]CC(F)(F)[C]=CF(9714)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=[C]CC(F)(F)[C]=CF(9714)'],
    products = ['O=[C]C[C](F)C(F)=CF(10687)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=[C]CC(F)(F)[C]=CF(9714)'],
    products = ['O=C(F)CC(F)=[C][CH]F(10688)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C(F)C(F)(F)C[C]=O(10689)'],
    products = ['O=[C]CC(F)(F)[C]=CF(9714)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=[C]C(F)(F)CC(=O)F(10690)'],
    products = ['O=[C]CC(F)(F)[C]=CF(9714)'],
