...
species(
    label = 'F[C]1[CH]OCC(F)(F)O1(1835)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC[C](F)F(1715)'],
...
reaction(
    ...
    products = ['O=C(F)[CH]OC[C](F)F(1715)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]O[CH]C(=O)F(1832)'],
    products = ['O=C(F)[CH]OC[C](F)F(1715)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C(F)[CH]OC[C](F)F(1715)'],
    products = ['O=C(F)C1OCC1(F)F(1717)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OC[C](F)F(1715)'],
    products = ['F[C](F)COC1O[C]1F(1834)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)[CH]OC[C](F)F(1715)'],
    products = ['F[C]1[CH]OCC(F)(F)O1(1835)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(F)[CH]OC=C(F)F(1837)'],
    products = ['O=C(F)[CH]OC[C](F)F(1715)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C=COC[C](F)F(1838)'],
    products = ['O=C(F)[CH]OC[C](F)F(1715)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]O[CH]C(=O)F(1832)'],
    products = ['O=C(F)[CH]OC[C](F)F(1715)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(F)CO[CH][C](F)F(1839)'],
    products = ['O=C(F)[CH]OC[C](F)F(1715)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)C[C](F)F(1714)'],
    products = ['O=C(F)[CH]OC[C](F)F(1715)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(6)', 'F[C]=COC[C](F)F(1841)'],
    products = ['O=C(F)[CH]OC[C](F)F(1715)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(F)[CH]OC[C](F)F(1715)'],
    products = ['[O][C](F)C1OCC1(F)F(1844)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)=[C]OC[C](F)F(1845)'],
    products = ['O=C(F)[CH]OC[C](F)F(1715)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)=[C]OCC(F)F(1846)'],
    products = ['O=C(F)[CH]OC[C](F)F(1715)'],
...
reaction(
    label = 'reaction27',
    reactants = ['OC(F)=CO[CH][C](F)F(1847)'],
    products = ['O=C(F)[CH]OC[C](F)F(1715)'],
