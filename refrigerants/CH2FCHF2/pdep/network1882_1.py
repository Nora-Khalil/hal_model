...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C(=C)F(277)'],
    products = ['[CH]=C(F)C[CH2](6977)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[CH]=C=C[CH2](6990)'],
    products = ['[CH]=C(F)C[CH2](6977)'],
