...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(2822)', '[C]=C(4465)'],
    products = ['C=[C]OC([O])(F)F(6538)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C=[C]O[C](F)F(6449)'],
    products = ['C=[C]OC([O])(F)F(6538)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(=O)F(6947)'],
    products = ['C=[C]OC([O])(F)F(6538)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC([O])(F)F(6948)'],
    products = ['C=[C]OC([O])(F)F(6538)'],
    transitionState = 'TS8',
