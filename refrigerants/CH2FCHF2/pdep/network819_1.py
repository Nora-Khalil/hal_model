...
species(
    label = 'F[C](F)[C](F)C(F)C(F)F(3756)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C](F)C(F)[CH]C(F)(F)F(3757)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C](F)[CH]C(F)C(F)(F)F(3758)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(3691)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'F[CH]C(F)[C](F)F(171)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(3691)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(3691)'],
    products = ['FC(F)=C(F)C(F)C(F)F(3752)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C](F)C(F)C=C(F)F(3722)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(3691)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)C(F)C(F)=C(F)F(3753)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(3691)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(78)', 'F[C](F)C=C[C](F)F(3723)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(3691)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', 'F[CH]C(F)[C](F)F(171)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(3691)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(3691)'],
    products = ['F[C](F)[C](F)C(F)C(F)F(3756)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(3691)'],
    products = ['F[C](F)C(F)[CH]C(F)(F)F(3757)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(3691)'],
    products = ['F[C](F)[CH]C(F)C(F)(F)F(3758)'],
...
network(
    label = 'PDepNetwork #819',
    isomers = [
        'F[C](F)C(F)C(F)[C](F)F(3691)',
    ],
    reactants = [
        ('CHFCF2(55)', 'CHFCF2(55)'),
    ],
