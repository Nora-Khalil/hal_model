...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]C(6550)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])(F)F(218)', '[CH]C-2(4468)'],
    products = ['[CH2]C(F)(F)O[CH]C(6550)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[C](F)F(6397)'],
    products = ['[CH2]C(F)(F)O[CH]C(6550)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[CH]C(6789)'],
    products = ['[CH2]C(F)(F)O[CH]C(6550)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CF2(57)', 'C[CH][O](4509)'],
    products = ['[CH2]C(F)(F)O[CH]C(6550)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)OC=C(6790)'],
    products = ['[CH2]C(F)(F)O[CH]C(6550)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C](F)F(163)', 'C[CH][O](4509)'],
    products = ['[CH2]C(F)(F)O[CH]C(6550)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]COC([CH2])(F)F(6791)'],
    products = ['[CH2]C(F)(F)O[CH]C(6550)'],
...
network(
    label = 'PDepNetwork #1899',
    isomers = [
        '[CH2]C(F)(F)O[CH]C(6550)',
    ],
    reactants = [
        ('CH2CF2(57)', 'CH3CHO(36)'),
    ],
