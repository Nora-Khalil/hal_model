...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(F)=C(F)F(296)'],
    products = ['[CH]=C(F)C([O])(F)F(2574)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=C(F)C(=O)F(472)'],
    products = ['[CH]=C(F)C([O])(F)F(2574)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C#CC([O])(F)F(2661)'],
    products = ['[CH]=C(F)C([O])(F)F(2574)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F2(78)', '[CH]=C=C([O])F(475)'],
    products = ['[CH]=C(F)C([O])(F)F(2574)'],
    transitionState = 'TS9',
