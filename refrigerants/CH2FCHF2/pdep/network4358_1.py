...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(O)C(F)(F)OF(12831)'],
...
reaction(
    ...
    products = ['[CH]=C(O)C(F)(F)OF(12831)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[C]=C(O)C(F)(F)OF(15146)'],
    products = ['[CH]=C(O)C(F)(F)OF(12831)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OH(7)', 'C#CC(F)(F)OF(15147)'],
    products = ['[CH]=C(O)C(F)(F)OF(12831)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FO[C](F)F(2563)', 'C#CO(2953)'],
    products = ['[CH]=C(O)C(F)(F)OF(12831)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]C(O)=C(F)OF(15148)'],
    products = ['[CH]=C(O)C(F)(F)OF(12831)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(O)C([O])(F)F(6884)'],
    products = ['[CH]=C(O)C(F)(F)OF(12831)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(128)', '[CH]C(O)=C(F)F(15149)'],
    products = ['[CH]=C(O)C(F)(F)OF(12831)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', '[CH]=[C]C(F)(F)OF(2663)'],
    products = ['[CH]=C(O)C(F)(F)OF(12831)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]=C([O])C(F)(F)OF(15150)'],
    products = ['[CH]=C(O)C(F)(F)OF(12831)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FO[C](F)F(2563)', '[CH]=[C]O(8039)'],
    products = ['[CH]=C(O)C(F)(F)OF(12831)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[CH]=C(O)C(=O)F(15151)'],
    products = ['[CH]=C(O)C(F)(F)OF(12831)'],
...
network(
    label = 'PDepNetwork #4358',
    isomers = [
        '[CH]=C(O)C(F)(F)OF(12831)',
    ],
    reactants = [
