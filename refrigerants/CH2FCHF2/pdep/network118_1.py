...
"""),
    E0 = (-1100.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,250,417,511,1155,1315,1456,3119,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.38268,'amu*angstrom^2'), symmetry=1, barrier=(31.7905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05499,'amu*angstrom^2'), symmetry=1, barrier=(24.2562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05433,'amu*angstrom^2'), symmetry=1, barrier=(24.2412,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.51381,0.0450837,9.32577e-06,-7.7418e-08,4.98377e-11,-132374,12.4997], Tmin=(10,'K'), Tmax=(669.25,'K')), NASAPolynomial(coeffs=[8.46531,0.0381082,-2.5736e-05,8.00866e-09,-9.38069e-13,-133543,-13.1843], Tmin=(669.25,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1100.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), label="""OC(F)C(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-1099,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,176,294,457,589,547,707,1086,1160,1127,1157,1302,1442,1365,1447,3042,3152,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.504459,'amu*angstrom^2'), symmetry=1, barrier=(11.5985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.504336,'amu*angstrom^2'), symmetry=1, barrier=(11.5957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43636,'amu*angstrom^2'), symmetry=1, barrier=(33.0247,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.4711,0.0464979,5.84888e-05,-3.16636e-07,3.16468e-10,-132181,12.4553], Tmin=(10,'K'), Tmax=(397.729,'K')), NASAPolynomial(coeffs=[6.79035,0.0414469,-2.93103e-05,9.62867e-09,-1.18696e-12,-132669,-3.31491], Tmin=(397.729,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), label="""OC(C(F)F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.16577,'amu*angstrom^2'), symmetry=1, barrier=(26.8034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16688,'amu*angstrom^2'), symmetry=1, barrier=(26.8289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1666,'amu*angstrom^2'), symmetry=1, barrier=(26.8224,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-702.163,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,259,529,569,1128,1321,1390,3140,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,204.946,211.156],'cm^-1')),
        HinderedRotor(inertia=(0.155562,'amu*angstrom^2'), symmetry=1, barrier=(4.71676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.702056,'amu*angstrom^2'), symmetry=1, barrier=(19.158,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22171,'amu*angstrom^2'), symmetry=1, barrier=(34.8914,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.54944,0.0384912,4.56379e-05,-2.00493e-07,1.6623e-10,-84448.2,13.0053], Tmin=(10,'K'), Tmax=(474.775,'K')), NASAPolynomial(coeffs=[6.69679,0.0365021,-2.55692e-05,8.30564e-09,-1.01276e-12,-85023.5,-2.74552], Tmin=(474.775,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-702.163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""O[CH]C(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'OC(F)C(F)[CH]F(799)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-872.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,391,562,707,872,1109,1210,1289,3137,235,523,627,1123,1142,1372,1406,3097,180,312.73],'cm^-1')),
        HinderedRotor(inertia=(0.523433,'amu*angstrom^2'), symmetry=1, barrier=(12.0347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50009,'amu*angstrom^2'), symmetry=1, barrier=(34.4901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.468045,'amu*angstrom^2'), symmetry=1, barrier=(10.7613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17178,'amu*angstrom^2'), symmetry=1, barrier=(49.9336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.468103,'amu*angstrom^2'), symmetry=1, barrier=(10.7626,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0502781,'amu*angstrom^2'), symmetry=1, barrier=(2.11901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.704141,'amu*angstrom^2'), symmetry=1, barrier=(16.1896,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
"""),
    E0 = (-578.414,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,171,205,598,1104,1143,1317,1411,3153,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.654588,'amu*angstrom^2'), symmetry=1, barrier=(15.0503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.944625,'amu*angstrom^2'), symmetry=1, barrier=(21.7188,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.75323,0.0207563,8.55911e-05,-2.62969e-07,2.19139e-10,-69567.1,11.0323], Tmin=(10,'K'), Tmax=(417.424,'K')), NASAPolynomial(coeffs=[4.14153,0.0339672,-2.27264e-05,7.19833e-09,-8.65571e-13,-69747,7.73126], Tmin=(417.424,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-578.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""OCDCC(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'OC=C(F)C(F)F(807)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-787.865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,171,205,598,1104,1143,1317,1411,3153,3010,987.5,1337.5,450,1655,326,540,652,719,1357,382.608],'cm^-1')),
        HinderedRotor(inertia=(0.372684,'amu*angstrom^2'), symmetry=1, barrier=(38.7174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.372681,'amu*angstrom^2'), symmetry=1, barrier=(38.7178,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
...
reaction(
    label = 'reaction9',
    reactants = ['H2O(3)', 'FC=C(F)C(F)F(796)'],
    products = ['OC(F)C(F)C(F)F(384)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(482)', 'FC=CC(F)F(721)'],
    products = ['OC(F)C(F)C(F)F(384)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OC(F)F(368)', 'CHFCHF[Z](59)'],
    products = ['OC(F)C(F)C(F)F(384)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'OC(F)C(F)[CH]F(799)'],
    products = ['OC(F)C(F)C(F)F(384)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'F[CH]C(F)C(F)F(800)'],
    products = ['OC(F)C(F)C(F)F(384)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)C(F)C(F)F(801)'],
    products = ['OC(F)C(F)C(F)F(384)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[CH]F(361)', 'CHF2-CHF(67)'],
    products = ['OC(F)C(F)C(F)F(384)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF2(82)', 'OC(F)[CH]F(802)'],
    products = ['OC(F)C(F)C(F)F(384)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OC(F)[C](F)C(F)F(803)'],
    products = ['OC(F)C(F)C(F)F(384)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O[C](F)C(F)C(F)F(804)'],
    products = ['OC(F)C(F)C(F)F(384)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(F)C(F)[C](F)F(805)'],
    products = ['OC(F)C(F)C(F)F(384)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=CC(F)C(F)F(326)'],
    products = ['OC(F)C(F)C(F)F(384)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(147.794,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'OC=CC(F)F(806)'],
    products = ['OC(F)C(F)C(F)F(384)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(7.54797,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'OC=C(F)C(F)F(807)'],
    products = ['OC(F)C(F)C(F)F(384)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(232.221,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction25',
    reactants = ['F2(78)', 'OC(F)C=CF(808)'],
    products = ['OC(F)C(F)C(F)F(384)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(6.37877,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'OC(F)C(F)=CF(394)'],
    products = ['OC(F)C(F)C(F)F(384)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(186.853,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'OC(F)=CC(F)F(809)'],
    products = ['OC(F)C(F)C(F)F(384)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(248.619,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'OC(F)C=C(F)F(416)'],
    products = ['OC(F)C(F)C(F)F(384)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(236.618,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)
