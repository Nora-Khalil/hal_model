...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.92286,'amu*angstrom^2'), symmetry=1, barrier=(44.2103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.385941,'amu*angstrom^2'), symmetry=1, barrier=(8.87355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92007,'amu*angstrom^2'), symmetry=1, barrier=(44.1461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.385837,'amu*angstrom^2'), symmetry=1, barrier=(8.87116,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.771099,0.0800211,-0.000135498,1.24342e-07,-4.45723e-11,-22962.9,25.0552], Tmin=(100,'K'), Tmax=(818.986,'K')), NASAPolynomial(coeffs=[7.4556,0.0311736,-1.63622e-05,3.21123e-09,-2.23967e-13,-23514.6,-2.54205], Tmin=(818.986,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsHHH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2]OOC([CH2])(F)F(3241)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20292,0.0663497,-7.80464e-05,4.86013e-08,-1.2403e-11,-28527.9,22.9615], Tmin=(100,'K'), Tmax=(940.422,'K')), NASAPolynomial(coeffs=[10.752,0.0257324,-1.32591e-05,2.67232e-09,-1.92995e-13,-30323.9,-22.5207], Tmin=(940.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH) + radical(CsJOOC)"""),
)

species(
    label = '[CH2][C](F)OOCF(3242)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50235,0.0646799,-6.95957e-05,9.86079e-09,2.7836e-11,-25979.9,24.4841], Tmin=(100,'K'), Tmax=(509.036,'K')), NASAPolynomial(coeffs=[8.04212,0.0298387,-1.56909e-05,3.12728e-09,-2.21916e-13,-26860.1,-4.75653], Tmin=(509.036,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHHO) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]O[O](231)', 'F[C]CF-2(3036)'],
    products = ['[CH2]OO[C](F)CF(3056)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]OOC(=C)F(3237)'],
    products = ['[CH2]OO[C](F)CF(3056)'],
    transitionState = 'TS8',
