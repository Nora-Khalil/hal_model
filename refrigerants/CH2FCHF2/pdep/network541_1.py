...
"""),
    E0 = (-615.043,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,326,540,652,719,1357,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,180,792.119],'cm^-1')),
        HinderedRotor(inertia=(0.554352,'amu*angstrom^2'), symmetry=1, barrier=(12.7456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.99632,'amu*angstrom^2'), symmetry=1, barrier=(22.9074,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.998584,'amu*angstrom^2'), symmetry=1, barrier=(22.9594,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.612936,0.0730418,-7.92505e-05,4.24059e-08,-8.94494e-12,-73849.4,24.0748], Tmin=(100,'K'), Tmax=(1151.68,'K')), NASAPolynomial(coeffs=[16.1233,0.0191713,-9.08735e-06,1.79097e-09,-1.28508e-13,-77422,-52.9444], Tmin=(1151.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-615.043,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.425028,0.10614,-0.00017559,1.50403e-07,-5.04873e-11,-88867.2,29.0513], Tmin=(100,'K'), Tmax=(814.039,'K')), NASAPolynomial(coeffs=[12.8326,0.0301612,-1.5623e-05,3.04713e-09,-2.11724e-13,-90666.7,-29.9764], Tmin=(814.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-740.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2][C](F)OC(F)(F)CF(3098)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH2]C(F)(F)OC([CH2])(F)F(3099)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.14519,0.0920114,-0.000129715,9.70295e-08,-2.92834e-11,-91519.2,27.7882], Tmin=(100,'K'), Tmax=(807.087,'K')), NASAPolynomial(coeffs=[12.4703,0.0309251,-1.61801e-05,3.24554e-09,-2.32349e-13,-93508.7,-29.0315], Tmin=(807.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-762.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(3008)', '[CH2]C([O])(F)F(218)'],
    products = ['[CH2]C(F)(F)O[C](F)CF(3028)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'FC[C](F)O[C](F)F(2582)'],
    products = ['[CH2]C(F)(F)O[C](F)CF(3028)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[C](F)CF(3094)'],
    products = ['[CH2]C(F)(F)O[C](F)CF(3028)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)OC(=C)F(3095)'],
    products = ['[CH2]C(F)(F)O[C](F)CF(3028)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)O[C](F)CF(3028)'],
    products = ['CC(F)(F)O[C](F)[CH]F(3097)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)O[C](F)CF(3028)'],
    products = ['[CH2][C](F)OC(F)(F)CF(3098)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)O[C](F)CF(3028)'],
    products = ['[CH2]C(F)(F)OC([CH2])(F)F(3099)'],
