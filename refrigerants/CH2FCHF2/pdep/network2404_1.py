...
reaction(
    label = 'reaction1',
    reactants = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    ...
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FOC(OF)[C](F)F(9118)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]C(OF)OC(F)F(9119)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(156)', 'FO[CH]OC(F)F(5427)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)F(364)', 'FOC=C(F)F(3557)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(128)', 'FC(F)=COC(F)F(2616)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FOC(OC(F)F)=C(F)F(9120)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]OC(OF)[C](F)F(9121)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(OC(F)F)[C](F)F(9122)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)F(364)', 'FO[CH][C](F)F(3555)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF2(82)', '[O]C(OF)[C](F)F(9123)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(128)', 'F[C](F)[CH]OC(F)F(2618)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FO[C](OC(F)F)[C](F)F(9124)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'FOC(O[C](F)F)[C](F)F(9125)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=C(OC(F)F)[C](F)F(9126)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'F[C]C(OF)OC(F)F-2(9127)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CF2(43)', 'FO[CH]OC(F)F(5427)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FO[C](OC(F)F)C(F)F(7913)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FOC(O[C](F)F)C(F)F(9128)'],
    products = ['FOC(OC(F)F)[C](F)F(8997)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FOC(OC(F)F)[C](F)F(8997)'],
    products = ['[O]C(OC(F)F)C(F)(F)F(9129)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FOC(OC(F)F)[C](F)F(8997)'],
    products = ['F[CH]OC(OF)C(F)(F)F(9130)'],
...
network(
    label = 'PDepNetwork #2404',
    isomers = [
        'FOC(OC(F)F)[C](F)F(8997)',
    ],
    reactants = [
