...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH]C(F)=C=C(8532)'],
    products = ['[CH]=C(F)C(=C)[O](3194)'],
    transitionState = 'TS3',
