...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.200366,'amu*angstrom^2'), symmetry=1, barrier=(4.6068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20101,'amu*angstrom^2'), symmetry=1, barrier=(4.62162,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49453,0.0627114,-0.000104014,9.77947e-08,-3.60167e-11,-25352.7,21.4455], Tmin=(100,'K'), Tmax=(813.9,'K')), NASAPolynomial(coeffs=[5.52759,0.0285351,-1.45707e-05,2.86121e-09,-2.00251e-13,-25533.7,5.7397], Tmin=(813.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-211.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)

species(
    label = 'FCC1(F)C=C(F)O1(3168)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0781799,'amu*angstrom^2'), symmetry=1, barrier=(1.79751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.814618,'amu*angstrom^2'), symmetry=1, barrier=(18.7297,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51889,0.0610151,-9.58143e-05,8.81909e-08,-3.28067e-11,-27818.7,22.1656], Tmin=(100,'K'), Tmax=(773.878,'K')), NASAPolynomial(coeffs=[5.91735,0.028859,-1.52249e-05,3.03462e-09,-2.14998e-13,-28217.3,3.89586], Tmin=(773.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + group(CdCFH) + radical(Cdj(Cd-COH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.69543,'amu*angstrom^2'), symmetry=1, barrier=(38.9813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.69525,'amu*angstrom^2'), symmetry=1, barrier=(38.977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.918792,0.0728739,-0.000107237,8.32551e-08,-2.5835e-11,-37369.7,22.2873], Tmin=(100,'K'), Tmax=(788.895,'K')), NASAPolynomial(coeffs=[10.863,0.022451,-1.13591e-05,2.22937e-09,-1.57062e-13,-38938.6,-23.3294], Tmin=(788.895,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtCs) + group(CtCF) + radical(CC(C)OJ)"""),
)
...
"""),
    E0 = (-47.3399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3010,987.5,1337.5,450,1655,268.495,268.499,268.499,268.5,2034.3],'cm^-1')),
        HinderedRotor(inertia=(0.00291702,'amu*angstrom^2'), symmetry=1, barrier=(8.56637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551788,'amu*angstrom^2'), symmetry=1, barrier=(28.2296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551823,'amu*angstrom^2'), symmetry=1, barrier=(28.2295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.846505,0.0784239,-0.000132873,1.23828e-07,-4.5359e-11,-5588.92,25.2134], Tmin=(100,'K'), Tmax=(802.467,'K')), NASAPolynomial(coeffs=[6.91927,0.0324079,-1.74265e-05,3.4672e-09,-2.44158e-13,-6056.59,0.410969], Tmin=(802.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.3399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsCFHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.16282,'amu*angstrom^2'), symmetry=1, barrier=(26.7354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16233,'amu*angstrom^2'), symmetry=1, barrier=(26.7242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16358,'amu*angstrom^2'), symmetry=1, barrier=(26.753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.347228,0.0867455,-0.000136084,1.1028e-07,-3.54441e-11,-3428.62,25.4314], Tmin=(100,'K'), Tmax=(764.109,'K')), NASAPolynomial(coeffs=[12.3684,0.0238142,-1.25409e-05,2.48771e-09,-1.75646e-13,-5265.65,-29.329], Tmin=(764.109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.5509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(CJCO) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH2]C([O])(F)C=C(F)F(3180)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.849296,0.074428,-9.89534e-05,6.8676e-08,-1.91576e-11,-46177.4,23.7928], Tmin=(100,'K'), Tmax=(871.987,'K')), NASAPolynomial(coeffs=[11.8226,0.0240912,-1.23632e-05,2.47446e-09,-1.77503e-13,-48091.1,-27.6437], Tmin=(871.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-384.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]C(F)(F)C=[C]F(2690)'],
    products = ['[O]C(F)(C=[C]F)CF(3077)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(C=[C]F)CF(3169)'],
    products = ['[O]C(F)(C=[C]F)CF(3077)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)(C#CF)CF(3170)'],
    products = ['[O]C(F)(C=[C]F)CF(3077)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'C=C([O])C=[C]F(3171)'],
    products = ['[O]C(F)(C=[C]F)CF(3077)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C(=C=[C]F)CF(3173)'],
    products = ['[O]C(F)(C=[C]F)CF(3077)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)(C=[C]F)OF(3179)'],
    products = ['[O]C(F)(C=[C]F)CF(3077)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(C=[C]F)CF(3077)'],
    products = ['[CH2]C([O])(F)C=C(F)F(3180)'],
