...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(4368)', '[O]C(F)[CH]F(208)'],
    products = ['C=[C]OC(F)[CH]F(6181)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'C=[C]O[CH]F(6301)'],
    products = ['C=[C]OC(F)[CH]F(6181)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=[C]OC(F)=CF(6303)'],
    products = ['C=[C]OC(F)[CH]F(6181)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#COC(F)[CH]F(6304)'],
    products = ['C=[C]OC(F)[CH]F(6181)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', 'C=[C]O[CH]F(6301)'],
    products = ['C=[C]OC(F)[CH]F(6181)'],
