...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=CO[CH]OF(5786)'],
    products = ['O=COC(F)OF(5637)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)OC=O(4689)'],
    products = ['O=COC(F)OF(5637)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['HCO(15)', '[O]C(F)OF(1040)'],
    products = ['O=COC(F)OF(5637)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CO[C](F)OF(5645)'],
    products = ['O=COC(F)OF(5637)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]OC(F)OF(6327)'],
    products = ['O=COC(F)OF(5637)'],
