...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38867,0.0369087,-2.54044e-05,7.9849e-09,-1.00467e-12,-37552.8,19.617], Tmin=(100,'K'), Tmax=(1774.09,'K')), NASAPolynomial(coeffs=[11.1735,0.0171018,-8.65771e-06,1.69185e-09,-1.17874e-13,-40669.8,-27.8008], Tmin=(1774.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-312.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Cs-O2s-Cs-Cs(F)(F)) + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-Cs)(H)_ring)"""),
)
...
"""),
    E0 = (59.5495,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([361,769,965,1078,1132,1246,3247,2950,1000,180,180,180,180,180,1113.29,1114.46,3126.92],'cm^-1')),
        HinderedRotor(inertia=(0.137293,'amu*angstrom^2'), symmetry=1, barrier=(3.15665,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91714,0.050361,-8.01701e-05,7.02066e-08,-2.45604e-11,7232.78,18.8246], Tmin=(100,'K'), Tmax=(786.751,'K')), NASAPolynomial(coeffs=[7.10078,0.0187,-9.68882e-06,1.91016e-09,-1.34239e-13,6581.36,-3.89652], Tmin=(786.751,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.5495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(CsCFHO) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(oxirene) + radical(O2sj(Cs-F1sCdH))"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69471,0.0545508,-7.45266e-05,5.54191e-08,-1.67035e-11,-34921.7,22.3462], Tmin=(100,'K'), Tmax=(807.56,'K')), NASAPolynomial(coeffs=[8.74004,0.0196518,-9.69979e-06,1.89926e-09,-1.34171e-13,-36059.6,-10.1372], Tmin=(807.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-291.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(Cs(F)(C)-Cs-O2s) + radical(Csj(Cs-F1sO2sCs)(O2s-Cs)(H)_ring) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O][C](F)C1(F)CO1(8887)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97103,0.0479704,-6.18555e-05,4.66424e-08,-1.46068e-11,-33495,21.976], Tmin=(100,'K'), Tmax=(772.398,'K')), NASAPolynomial(coeffs=[7.12038,0.0213017,-1.0061e-05,1.93457e-09,-1.35318e-13,-34290.4,-1.53639], Tmin=(772.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-279.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(Cs(F)(C)-Cs-O2s) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'FOC(F)[C]1[CH]O1(8888)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (14.5183,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,2950,1000,325.559,325.559,325.559,325.559,325.56,1057.72,2174.13,2174.13],'cm^-1')),
        HinderedRotor(inertia=(0.418127,'amu*angstrom^2'), symmetry=1, barrier=(31.4481,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.418127,'amu*angstrom^2'), symmetry=1, barrier=(31.4481,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89569,0.0499842,-5.49079e-05,3.16951e-08,-7.54807e-12,1818.87,21.3365], Tmin=(100,'K'), Tmax=(999.016,'K')), NASAPolynomial(coeffs=[9.25813,0.0205053,-1.06458e-05,2.15782e-09,-1.56443e-13,347.84,-14.1757], Tmin=(999.016,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.5183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCFHO) + ring(Cs(C-F)-Cs-O2s) + radical(C2CsJO) + radical(CCsJO)"""),
)
...
"""),
    E0 = (51.0319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,2950,1000,3025,407.5,1350,352.5,489.254,489.26,489.263,489.264,489.272],'cm^-1')),
        HinderedRotor(inertia=(0.00314566,'amu*angstrom^2'), symmetry=1, barrier=(0.534371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00314867,'amu*angstrom^2'), symmetry=1, barrier=(0.53473,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48609,0.0559662,-6.63075e-05,3.92084e-08,-9.14878e-12,6227.76,22.307], Tmin=(100,'K'), Tmax=(1045.04,'K')), NASAPolynomial(coeffs=[12.28,0.0146509,-7.00501e-06,1.377e-09,-9.84885e-14,3971.76,-30.243], Tmin=(1045.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.0319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Cs(F)(C)-Cs-O2s) + radical(Csj(Cs-F1sO2sCs)(O2s-Cs)(H)_ring) + radical(CCsJO)"""),
)

species(
    label = '[O][CH]C1(F)OC1F(8890)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {5,S} {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C1(F)[CH]O1(8708)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C1(F)[CH]O1(8592)'],
    products = ['[O]C(F)C1(F)[CH]O1(8708)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(F)C1=CO1(8885)'],
    products = ['[O]C(F)C1(F)[CH]O1(8708)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(18.3832,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CC1(F)[CH]O1(8736)'],
    products = ['[O]C(F)C1(F)[CH]O1(8708)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)C1(F)[CH]O1(8535)'],
    products = ['[O]C(F)C1(F)[CH]O1(8708)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[O]C=C1[CH]O1(8737)'],
    products = ['[O]C(F)C1(F)[CH]O1(8708)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)[C]1[CH]O1(8536)'],
    products = ['[O]C(F)C1(F)[CH]O1(8708)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)C1(F)[CH]O1(8708)'],
    products = ['O[C](F)C1(F)[CH]O1(8886)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FOC(F)[C]1[CH]O1(8888)'],
    products = ['[O]C(F)C1(F)[CH]O1(8708)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FO[CH]C1(F)[CH]O1(8889)'],
    products = ['[O]C(F)C1(F)[CH]O1(8708)'],
...
network(
    label = 'PDepNetwork #2342',
    isomers = [
        '[O]C(F)C1(F)[CH]O1(8708)',
    ],
    reactants = [
        ('CHFO(47)', 'FC1=CO1(286)'),
    ],
