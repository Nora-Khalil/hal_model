...
species(
    label = '[O][CH]C(F)(F)C(F)(F)OF(9075)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'O[CH]C(F)(F)C(F)(F)OF(9078)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]CC(F)(F)OF(5611)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
    products = ['[O]CC(F)(OF)C(F)(F)F(9069)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(488)', '[O]CC(F)=C(F)F(3817)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[CH2]C(F)(F)C(F)(F)OF(2832)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2O(20)', 'FOC(F)(F)[C](F)F(2831)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=CC(F)(F)C(F)(F)OF(9070)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C[C](F)C(F)(F)OF(9071)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]CC(F)(F)[C](F)OF(9072)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]CC(F)(F)C([O])(F)F(9073)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(128)', '[O]CC(F)(F)[C](F)F(9074)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(2563)', '[O]C[C](F)F(230)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][O](2599)', 'FOC(F)(F)[C](F)F(2831)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O][CH]C(F)(F)C(F)(F)OF(9075)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', '[O]CC(F)(F)C(=O)F(9076)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', '[O]CC(F)=C(F)OF(9077)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
    products = ['O[CH]C(F)(F)C(F)(F)OF(9078)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(F)C(F)(F)COF(9079)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FOC[C](F)C(F)(F)OF(9080)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FOCC(F)(F)[C](F)OF(9081)'],
    products = ['[O]CC(F)(F)C(F)(F)OF(9003)'],
...
network(
    label = 'PDepNetwork #2410',
    isomers = [
        '[O]CC(F)(F)C(F)(F)OF(9003)',
    ],
    reactants = [
