...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OC(F)(F)CF(776)'],
    products = ['OC(F)(F)CCF(13090)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(482)', 'F[C]CCF(14036)'],
    products = ['OC(F)(F)CCF(13090)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'OC(F)(F)C[C]F(14037)'],
    products = ['OC(F)(F)CCF(13090)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'CC(O)(F)F(2772)'],
    products = ['OC(F)(F)CCF(13090)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'FCC=C(F)F(2813)'],
    products = ['OC(F)(F)CCF(13090)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O[C](F)CCF(14038)'],
    products = ['OC(F)(F)CCF(13090)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]CC(O)(F)F(14039)'],
    products = ['OC(F)(F)CCF(13090)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)CCF(14040)'],
    products = ['OC(F)(F)CCF(13090)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(2562)', 'CH2F-CH2(62)'],
    products = ['OC(F)(F)CCF(13090)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2F(46)', '[CH2]C(O)(F)F(2782)'],
    products = ['OC(F)(F)CCF(13090)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'OC(F)(F)[CH]CF(14041)'],
    products = ['OC(F)(F)CCF(13090)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)(F)C[CH]F(14042)'],
    products = ['OC(F)(F)CCF(13090)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=C(F)CCF(14043)'],
    products = ['OC(F)(F)CCF(13090)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'OC(F)=CCF(14044)'],
    products = ['OC(F)(F)CCF(13090)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=CC(O)(F)F(7022)'],
    products = ['OC(F)(F)CCF(13090)'],
