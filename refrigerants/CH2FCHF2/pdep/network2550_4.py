...
reaction(
    label = 'reaction1',
    reactants = ['H(5)', 'FC=C=C(F)F(5101)'],
    products = ['F[CH]C=C(F)F(4846)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C=C(F)F(8897)'],
    products = ['F[CH]C=C(F)F(4846)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'F[C]C=C(F)F(11503)'],
    products = ['F[CH]C=C(F)F(4846)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C=C(F)F(4846)'],
    products = ['FC1[CH]C1(F)F(11504)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[CH][C]=C(F)F(5078)'],
    products = ['F[CH]C=C(F)F(4846)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'FC#C[CH]F(4859)'],
    products = ['F[CH]C=C(F)F(4846)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C]C=C(F)F-2(6976)'],
    products = ['F[CH]C=C(F)F(4846)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]F(156)', 'CHFCH[Z](71)'],
    products = ['F[CH]C=C(F)F(4846)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C#C[C](F)F(4877)'],
    products = ['F[CH]C=C(F)F(4846)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'F[C]C=CF-2(10989)'],
    products = ['F[CH]C=C(F)F(4846)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(46)', '[C]=C(F)F(3536)'],
    products = ['FC[C]=C(F)F(9672)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', 'C=C=C(F)F(10940)'],
    products = ['FC[C]=C(F)F(9672)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F(37)', 'C=[C][C](F)F(12320)'],
    products = ['FC[C]=C(F)F(9672)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F(37)', 'C=C(F)[C]F(12739)'],
    products = ['C=C(F)[C](F)F(4878)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C=C(F)[C](F)F(4878)'],
    products = ['F[C]1CC1(F)F(12740)'],
...
reaction(
    label = 'reaction35',
    reactants = ['F(37)', 'C=C(F)[C]F-2(12741)'],
    products = ['C=C(F)[C](F)F(4878)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH2(T)(18)', 'F[C]=C(F)F(3656)'],
    products = ['C=C(F)[C](F)F(4878)'],
...
reaction(
    label = 'reaction40',
    reactants = ['F2(78)', '[CH2]C#CF(12743)'],
    products = ['C=C(F)[C](F)F(4878)'],
...
reaction(
    label = 'reaction42',
    reactants = ['CF3(45)', '[C]=C(4368)'],
    products = ['C=[C]C(F)(F)F(12742)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(5)', '[CH]=[C]C(F)(F)F(5077)'],
    products = ['C=[C]C(F)(F)F(12742)'],
