...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.756354,0.0718166,-8.18007e-05,4.70209e-08,-1.07125e-11,-88282.6,24.0434], Tmin=(100,'K'), Tmax=(1067.37,'K')), NASAPolynomial(coeffs=[14.4888,0.0203528,-9.47601e-06,1.84681e-09,-1.31566e-13,-91214,-43.1028], Tmin=(1067.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-734.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(COCsFO) + group(Cds-CdsHH)"""),
)

species(
    label = 'O[C]1CC(F)[C](F)O1(8398)',
...
"""),
    E0 = (-300.52,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,326,540,652,719,1357,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,273.93,273.967,274.193,1413.06],'cm^-1')),
        HinderedRotor(inertia=(0.174376,'amu*angstrom^2'), symmetry=1, barrier=(9.28762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00655432,'amu*angstrom^2'), symmetry=1, barrier=(9.28778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.555586,'amu*angstrom^2'), symmetry=1, barrier=(29.6168,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.720098,0.0784331,-0.000107977,8.08508e-08,-2.4656e-11,-36031.8,27.3072], Tmin=(100,'K'), Tmax=(796.34,'K')), NASAPolynomial(coeffs=[10.5522,0.0290496,-1.49628e-05,2.98768e-09,-2.13495e-13,-37597.8,-17.8886], Tmin=(796.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-300.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(=O)OC(F)[CH]F(8191)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.03744,'amu*angstrom^2'), symmetry=1, barrier=(23.8529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03745,'amu*angstrom^2'), symmetry=1, barrier=(23.853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03808,'amu*angstrom^2'), symmetry=1, barrier=(23.8675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03733,'amu*angstrom^2'), symmetry=1, barrier=(23.8502,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.501716,0.093584,-0.000121637,7.37105e-08,-1.69448e-11,-35527.4,26.8617], Tmin=(100,'K'), Tmax=(1082.67,'K')), NASAPolynomial(coeffs=[22.7366,0.0077288,-2.68869e-06,4.66806e-10,-3.2143e-14,-40559.3,-87.0957], Tmin=(1082.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(O)OC(F)=[C]F(8401)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-256.678,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,293,496,537,1218,167,640,1190,380.133,380.133,380.134,4000],'cm^-1')),
        HinderedRotor(inertia=(0.274278,'amu*angstrom^2'), symmetry=1, barrier=(28.125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0540506,'amu*angstrom^2'), symmetry=1, barrier=(5.54253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274279,'amu*angstrom^2'), symmetry=1, barrier=(28.125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172154,'amu*angstrom^2'), symmetry=1, barrier=(17.6525,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.435689,0.0825673,-0.00011039,7.46729e-08,-1.99833e-11,-30746.4,28.5018], Tmin=(100,'K'), Tmax=(914.014,'K')), NASAPolynomial(coeffs=[14.274,0.0220069,-1.10035e-05,2.18276e-09,-1.55994e-13,-33276.1,-37.0158], Tmin=(914.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CJCO) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.973375,'amu*angstrom^2'), symmetry=1, barrier=(22.3798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.97343,'amu*angstrom^2'), symmetry=1, barrier=(22.3811,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.973321,'amu*angstrom^2'), symmetry=1, barrier=(22.3786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.973398,'amu*angstrom^2'), symmetry=1, barrier=(22.3803,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.242911,0.0920052,-0.000123594,7.8935e-08,-1.93074e-11,-36031.7,26.3876], Tmin=(100,'K'), Tmax=(1013.39,'K')), NASAPolynomial(coeffs=[20.05,0.0119054,-5.03077e-06,9.3662e-10,-6.53014e-14,-40144.6,-71.7837], Tmin=(1013.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-300.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cds_P)"""),
)

species(
    label = 'C[C](O)OC(F)=[C]F(8402)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-263.021,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,293,496,537,1218,167,640,1190,314.445,314.846,315.445,520.534],'cm^-1')),
        HinderedRotor(inertia=(0.176627,'amu*angstrom^2'), symmetry=1, barrier=(12.7788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00170264,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.390089,'amu*angstrom^2'), symmetry=1, barrier=(27.8301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00245197,'amu*angstrom^2'), symmetry=1, barrier=(27.8398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.666313,0.0776117,-9.92724e-05,6.53037e-08,-1.71661e-11,-31517.6,27.7293], Tmin=(100,'K'), Tmax=(925.795,'K')), NASAPolynomial(coeffs=[13.1505,0.0236705,-1.18722e-05,2.36446e-09,-1.6955e-13,-33829.1,-31.5368], Tmin=(925.795,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cs_P) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = 'CC(=O)OC(F)=CF(8138)',
...
"""),
    E0 = (-112.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,615,860,1140,1343,3152,1685,370,247.235,247.263,247.37,2727.82],'cm^-1')),
        HinderedRotor(inertia=(0.265645,'amu*angstrom^2'), symmetry=1, barrier=(11.5452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265692,'amu*angstrom^2'), symmetry=1, barrier=(11.5364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.764953,'amu*angstrom^2'), symmetry=1, barrier=(33.2081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12514,0.0683644,-0.000102774,8.56341e-08,-2.8571e-11,-13441.2,25.7361], Tmin=(100,'K'), Tmax=(804.711,'K')), NASAPolynomial(coeffs=[8.81494,0.0248904,-1.19516e-05,2.28403e-09,-1.5784e-13,-14508.8,-8.63577], Tmin=(804.711,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-112.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C(F)OC(=C)O(8404)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.65266,'amu*angstrom^2'), symmetry=1, barrier=(37.998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65787,'amu*angstrom^2'), symmetry=1, barrier=(38.1178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65598,'amu*angstrom^2'), symmetry=1, barrier=(38.0742,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.245324,0.0926937,-0.000157842,1.42182e-07,-4.95082e-11,-32187.4,36.383], Tmin=(100,'K'), Tmax=(843.619,'K')), NASAPolynomial(coeffs=[8.81041,0.0326413,-1.64979e-05,3.16863e-09,-2.17508e-13,-32940.7,0.618204], Tmin=(843.619,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(O)OC(F)=CF(8408)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
4  O u0 p2 c0 {5,S} {12,S}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.173665,0.090294,-0.000118144,7.32664e-08,-1.74345e-11,-42179.3,23.9744], Tmin=(100,'K'), Tmax=(1039.73,'K')), NASAPolynomial(coeffs=[20.1102,0.0122584,-5.56219e-06,1.07946e-09,-7.71873e-14,-46397.2,-74.6734], Tmin=(1039.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-351.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'C=C(O)OC(F)[C]F(8410)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {6,S}
4  O u0 p2 c0 {6,S} {12,S}
...
"""),
    E0 = (-77.7619,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,2175,525,239,401,1367,357.064,357.853,358.071],'cm^-1')),
        HinderedRotor(inertia=(0.175383,'amu*angstrom^2'), symmetry=1, barrier=(15.8091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174748,'amu*angstrom^2'), symmetry=1, barrier=(15.8128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174643,'amu*angstrom^2'), symmetry=1, barrier=(15.8011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10652,0.0674744,-9.56687e-05,6.92231e-08,-1.97878e-11,-9251.8,21.0009], Tmin=(100,'K'), Tmax=(858.079,'K')), NASAPolynomial(coeffs=[11.7696,0.017769,-8.78183e-06,1.72017e-09,-1.21535e-13,-11081.8,-28.8106], Tmin=(858.079,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-77.7619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Ct-CtOs) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['O[C]1CC(F)[C](F)O1(8398)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C([O])OC(F)=CF(8399)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)OC(F)[CH]F(8191)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(O)OC(F)[CH]F(8400)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(O)OC(F)=[C]F(8401)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(=O)O[C](F)CF(3316)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(O)O[C](F)CF(8195)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=C(O)O[C]=CF(8403)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH]=C(F)OC(=C)O(8404)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]F(215)', 'C=[C]O(4375)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHFCF[Z](72)', '[CH2]C(=O)O(5771)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'C=[C]OC(F)=CF(6303)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(=O)OC(F)=CF(4894)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH]=C(O)OC(F)=CF(8405)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'C=C(O)OC(F)=[C]F(8406)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=C(O)OC(F)=CF(4054)'],
    products = ['C#CO(2953)', 'O=C(F)CF(879)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C(O)[O+]=[C-]C(F)F(8407)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]C(F)(F)OC(=C)O(8409)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F2(78)', 'C#COC(=C)O(8411)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'C=C(O)OC#CF(8412)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C=C(O)OC(F)=CF(4054)'],
    products = ['HF(38)', 'O=C=CF(2952)', 'CH2CO(28)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CHF(40)', 'C=C(O)[O+]=[C-]F(8413)'],
    products = ['C=C(O)OC(F)=CF(4054)'],
