...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC(F)[CH]F(131)'],
    products = ['[O]OOC(F)[CH]F(908)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', '[O]OO[CH]F(365)'],
    products = ['[O]OOC(F)[CH]F(908)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[O](129)', 'CHFCHF[Z](59)'],
    products = ['[O]OOC(F)[CH]F(908)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[O](129)', 'F[CH][CH]F(141)'],
    products = ['[O]OOC(F)[CH]F(908)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[O]OO[CH]F(365)'],
    products = ['[O]OOC(F)[CH]F(908)'],
