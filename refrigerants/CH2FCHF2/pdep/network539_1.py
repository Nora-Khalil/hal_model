...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.25437,'amu*angstrom^2'), symmetry=1, barrier=(28.8404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25423,'amu*angstrom^2'), symmetry=1, barrier=(28.8371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25411,'amu*angstrom^2'), symmetry=1, barrier=(28.8345,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.565633,0.0785751,-9.78085e-05,6.00985e-08,-1.45941e-11,-70315,25.6222], Tmin=(100,'K'), Tmax=(1003.31,'K')), NASAPolynomial(coeffs=[15.1943,0.0202531,-1.06134e-05,2.15972e-09,-1.57052e-13,-73250.4,-45.0007], Tmin=(1003.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-585.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-532.491,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,326,540,652,719,1357,194,682,905,1196,1383,3221,189.055,189.352,189.604,191.139],'cm^-1')),
        HinderedRotor(inertia=(0.708521,'amu*angstrom^2'), symmetry=1, barrier=(18.459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.720173,'amu*angstrom^2'), symmetry=1, barrier=(18.4579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.704247,'amu*angstrom^2'), symmetry=1, barrier=(18.4618,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.296275,0.0841685,-0.000109442,7.07244e-08,-1.79458e-11,-63912.8,24.5815], Tmin=(100,'K'), Tmax=(965.742,'K')), NASAPolynomial(coeffs=[15.7862,0.020011,-9.79239e-06,1.93477e-09,-1.38374e-13,-66904.6,-49.6084], Tmin=(965.742,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-532.491,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]C(F)OC(F)=CF(4226)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-550.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,326,540,652,719,1357,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,180,180,645.857],'cm^-1')),
        HinderedRotor(inertia=(0.412105,'amu*angstrom^2'), symmetry=1, barrier=(9.4751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17511,'amu*angstrom^2'), symmetry=1, barrier=(27.018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17349,'amu*angstrom^2'), symmetry=1, barrier=(26.9809,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.680083,0.0747475,-8.49997e-05,4.86395e-08,-1.10918e-11,-66102.8,24.6567], Tmin=(100,'K'), Tmax=(1061.98,'K')), NASAPolynomial(coeffs=[14.5855,0.0223706,-1.10175e-05,2.19517e-09,-1.58069e-13,-69056.1,-43.2645], Tmin=(1061.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-550.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'FC=[C]OC(F)CF(4227)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-503.234,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,615,860,1140,1343,3152,1685,370,180,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.20799,'amu*angstrom^2'), symmetry=1, barrier=(27.7741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20746,'amu*angstrom^2'), symmetry=1, barrier=(27.7619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20651,'amu*angstrom^2'), symmetry=1, barrier=(27.74,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.4096,0.0736783,-7.7641e-05,3.95729e-08,-7.85677e-12,-60391.3,25.0467], Tmin=(100,'K'), Tmax=(1230.46,'K')), NASAPolynomial(coeffs=[18.1908,0.0158741,-7.17361e-06,1.39306e-09,-9.94609e-14,-64767.1,-64.4249], Tmin=(1230.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-503.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-Cs))"""),
)

species(
    label = '[CH]=C(F)OC(F)CF(4228)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-508.134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,293,496,537,1218,3120,650,792.5,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.25867,'amu*angstrom^2'), symmetry=1, barrier=(28.9393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25934,'amu*angstrom^2'), symmetry=1, barrier=(28.9546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25884,'amu*angstrom^2'), symmetry=1, barrier=(28.9433,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.369365,0.0745908,-7.83507e-05,3.96108e-08,-7.80062e-12,-60979.2,24.7184], Tmin=(100,'K'), Tmax=(1239.4,'K')), NASAPolynomial(coeffs=[18.528,0.0159852,-7.42146e-06,1.45776e-09,-1.04647e-13,-65480.3,-66.7838], Tmin=(1239.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-508.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (-667.908,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,293,496,537,1218,167,640,1190,361.07,361.07,361.071,361.071,361.071],'cm^-1')),
        HinderedRotor(inertia=(0.346939,'amu*angstrom^2'), symmetry=1, barrier=(32.097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257227,'amu*angstrom^2'), symmetry=1, barrier=(23.7973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257227,'amu*angstrom^2'), symmetry=1, barrier=(23.7973,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.509266,0.0798157,-9.25737e-05,5.36244e-08,-1.23992e-11,-80207.5,25.9209], Tmin=(100,'K'), Tmax=(1045.92,'K')), NASAPolynomial(coeffs=[15.1276,0.0239085,-1.2393e-05,2.51642e-09,-1.82873e-13,-83265.4,-45.26], Tmin=(1045.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-667.908,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = 'FCC(F)[O+]=[C-]C(F)F(4230)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.77011,'amu*angstrom^2'), symmetry=1, barrier=(40.6984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77536,'amu*angstrom^2'), symmetry=1, barrier=(40.8191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.76702,'amu*angstrom^2'), symmetry=1, barrier=(40.6272,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13985,0.0770121,-5.72966e-05,-6.40523e-08,1.01604e-10,-75036.9,35.4027], Tmin=(100,'K'), Tmax=(462.875,'K')), NASAPolynomial(coeffs=[8.40619,0.0400228,-2.10489e-05,4.17749e-09,-2.9497e-13,-75986,2.95807], Tmin=(462.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-624.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OC(F)CF(4231)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-682.561,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,2750,2850,1437.5,1250,1305,750,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.281997,0.0898365,-0.000123029,9.07886e-08,-2.73977e-11,-81966.4,26.352], Tmin=(100,'K'), Tmax=(802.425,'K')), NASAPolynomial(coeffs=[11.5298,0.0337677,-1.82183e-05,3.71107e-09,-2.68355e-13,-83771.6,-25.4365], Tmin=(802.425,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-682.561,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'F[C]C(F)OC(F)CF(4232)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-721.302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,2750,2850,1437.5,1250,1305,750,350,617,898,1187,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.28508,'amu*angstrom^2'), symmetry=1, barrier=(29.5466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28472,'amu*angstrom^2'), symmetry=1, barrier=(29.5382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28526,'amu*angstrom^2'), symmetry=1, barrier=(29.5507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28619,'amu*angstrom^2'), symmetry=1, barrier=(29.572,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.693091,0.0780754,-8.60867e-05,4.94625e-08,-1.16622e-11,-86637.8,26.7694], Tmin=(100,'K'), Tmax=(1011.33,'K')), NASAPolynomial(coeffs=[12.6478,0.0307926,-1.59574e-05,3.23362e-09,-2.34453e-13,-89055.9,-31.0397], Tmin=(1011.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-721.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-475.818,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,2175,525,239,401,1367,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.28284,'amu*angstrom^2'), symmetry=1, barrier=(29.495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2837,'amu*angstrom^2'), symmetry=1, barrier=(29.5148,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28144,'amu*angstrom^2'), symmetry=1, barrier=(29.4628,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.459751,0.0708626,-7.52701e-05,3.75514e-08,-7.22236e-12,-57094.3,22.6529], Tmin=(100,'K'), Tmax=(1275.57,'K')), NASAPolynomial(coeffs=[19.3648,0.0115789,-5.55557e-06,1.11559e-09,-8.12487e-14,-61917.3,-73.1546], Tmin=(1275.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-475.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(CtCF)"""),
)

species(
    label = 'F[C-]=[O+]C(F)CF(4236)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-638.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,330.077,330.096,330.11,330.111,330.12,330.121,330.135],'cm^-1')),
        HinderedRotor(inertia=(0.538078,'amu*angstrom^2'), symmetry=1, barrier=(41.6125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.538115,'amu*angstrom^2'), symmetry=1, barrier=(41.6129,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69994,0.0496612,-4.24638e-05,1.77125e-08,-2.98274e-12,-76686,18.9847], Tmin=(100,'K'), Tmax=(1390.36,'K')), NASAPolynomial(coeffs=[12.3505,0.01902,-9.40632e-06,1.86172e-09,-1.32616e-13,-79647.7,-35.9083], Tmin=(1390.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-638.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    ...
    products = ['FC=C(F)OC(F)CF(3026)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(121.726,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'F[C]C(F)OC(F)=CF(4223)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['FC=C(F)OC(F)CF(3026)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(154.967,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['CHFCHF[Z](59)', 'OC(F)=CF(878)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['FC=C(F)OC(F)CF(3026)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.02114e-05,'m^3/(mol*s)'), n=2.925, Ea=(197.904,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd/unsub_Cd/monosub;H_OR]
Euclidian distance = 0
family: 1,3_Insertion_ROR"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['FC=C(F)OC(F)CF(3026)'],
    products = ['O=C(F)C(F)C(F)CF(4224)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]C(F)O[C](F)CF(3024)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FC[C](F)O[C](F)CF(3045)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]C(F)OC(F)[CH]F(3046)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FC=C(F)O[CH]CF(4225)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)OC(F)=CF(4226)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'FC=[C]OC(F)CF(4227)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH]=C(F)OC(F)CF(4228)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C(F)[CH]F(215)', 'CH2F-CHF(66)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(2.1322,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction18',
    reactants = ['CHFCF[Z](72)', '[O]C(F)CF(2775)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(46)', 'F[CH]OC(F)=CF(389)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'FC=C(F)O[C](F)CF(3042)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'F[CH]C(F)OC(F)=CF(3044)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'F[C]=C(F)OC(F)CF(4229)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FCC(F)[O+]=[C-]C(F)F(4230)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C(F)(F)OC(F)CF(4231)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[C]C(F)OC(F)CF(4232)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F2(78)', 'C=COC(F)=CF(4233)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction29',
    reactants = ['F2(78)', 'C#COC(F)CF(4234)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction30',
    reactants = ['HF(38)', 'FC#COC(F)CF(4235)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CHF(40)', 'F[C-]=[O+]C(F)CF(4236)'],
    products = ['FC=C(F)OC(F)CF(3026)'],
