...
"""),
    E0 = (-266.774,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,3000,3100,440,815,1455,1000,180,180,180,2095.5],'cm^-1')),
        HinderedRotor(inertia=(0.591046,'amu*angstrom^2'), symmetry=1, barrier=(13.5893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.590929,'amu*angstrom^2'), symmetry=1, barrier=(13.5866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.59107,'amu*angstrom^2'), symmetry=1, barrier=(13.5899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43889,'amu*angstrom^2'), symmetry=1, barrier=(33.0829,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.884406,0.0767233,-9.5778e-05,5.32508e-08,-4.10778e-12,-31981.1,24.3159], Tmin=(100,'K'), Tmax=(590.93,'K')), NASAPolynomial(coeffs=[9.86608,0.0303181,-1.45154e-05,2.7862e-09,-1.93789e-13,-33293.9,-16.4167], Tmin=(590.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-266.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(CJCO)"""),
)
...
"""),
    E0 = (-159.123,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,326,540,652,719,1357,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,180,1519.4],'cm^-1')),
        HinderedRotor(inertia=(0.791208,'amu*angstrom^2'), symmetry=1, barrier=(18.1914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112504,'amu*angstrom^2'), symmetry=1, barrier=(18.1916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.791236,'amu*angstrom^2'), symmetry=1, barrier=(18.1921,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0882,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05305,0.0581757,-5.34531e-05,2.47804e-08,-4.53552e-12,-19026.5,21.3091], Tmin=(100,'K'), Tmax=(1324.1,'K')), NASAPolynomial(coeffs=[14.7455,0.0168118,-6.59401e-06,1.18735e-09,-8.09686e-14,-22652.5,-48.5929], Tmin=(1324.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CJCO)"""),
)

species(
    label = '[CH2]COC(F)=CF(9386)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-325.994,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,326,540,652,719,1357,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,228.493,228.503,963.253],'cm^-1')),
        HinderedRotor(inertia=(0.126284,'amu*angstrom^2'), symmetry=1, barrier=(4.67743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.402176,'amu*angstrom^2'), symmetry=1, barrier=(14.8828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.608188,'amu*angstrom^2'), symmetry=1, barrier=(22.5177,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.933375,0.0675888,-7.39819e-05,4.15514e-08,-9.30953e-12,-39097.7,22.5101], Tmin=(100,'K'), Tmax=(1081.66,'K')), NASAPolynomial(coeffs=[13.5007,0.0211155,-9.53584e-06,1.83161e-09,-1.29406e-13,-41816.4,-39.1066], Tmin=(1081.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-325.994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CJCO)"""),
)
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.69272,0.0800425,-0.000121548,1.06443e-07,-3.75875e-11,-33647.5,26.7761], Tmin=(100,'K'), Tmax=(793.366,'K')), NASAPolynomial(coeffs=[7.77474,0.03461,-1.72601e-05,3.35804e-09,-2.34594e-13,-34465.1,-3.82218], Tmin=(793.366,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + group(CsCsFHH) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(3008)', '[CH2]C[O](2639)'],
    products = ['[CH2]CO[C](F)CF(9370)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C](F)CF(2601)'],
    products = ['[CH2]CO[C](F)CF(9370)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=CO[C](F)CF(9384)'],
    products = ['[CH2]CO[C](F)CF(9370)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]COC(=C)F(9385)'],
    products = ['[CH2]CO[C](F)CF(9370)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]COC(F)=CF(9386)'],
    products = ['[CH2]CO[C](F)CF(9370)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]CF(126)', '[CH2]C[O](2639)'],
    products = ['[CH2]CO[C](F)CF(9370)'],
