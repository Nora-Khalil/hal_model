...
species(
    label = '[CH2]C(F)(F)C(OF)[C](F)F(9017)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[CH2]C(F)(F)C(OF)C(F)F(9022)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CC(OF)[C](F)F(9007)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'FOC([C](F)F)C(F)F(9008)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CC(F)(OF)C(F)[C](F)F(9009)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CC(F)(F)C(OF)[C](F)F(8994)'],
    products = ['CC(F)(F)C(F)(F)[CH]OF(9010)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'CC(F)(F)C([C]F)OF(9011)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['FOC=C(F)F(3557)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(F)(F)C(OF)=C(F)F(9012)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C[C](F)C(OF)[C](F)F(9013)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'CC(F)(F)C([O])[C](F)F(9014)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[CH][C](F)F(3555)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'FOC([C](F)F)[C](F)F(9015)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'CC(F)(F)[C](OF)[C](F)F(9016)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(F)(F)C(OF)[C](F)F(9017)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'CC(F)(F)C(=O)[C](F)F(9018)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C[C](F)C(OF)=C(F)F(9019)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'C=C(F)C(OF)[C](F)F(9020)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', 'CC(F)(F)C([C]F)OF-2(9021)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC(F)(F)C(OF)[C](F)F(8994)'],
    products = ['CC(F)(F)[C](OF)C(F)F(6260)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(F)(F)C(OF)C(F)F(9022)'],
    products = ['CC(F)(F)C(OF)[C](F)F(8994)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CC(F)(F)C(OF)[C](F)F(8994)'],
    products = ['CC(F)(F)C([O])C(F)(F)F(9023)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CC(F)(F)C(OF)[C](F)F(8994)'],
    products = ['C[C](F)C(OF)C(F)(F)F(9024)'],
