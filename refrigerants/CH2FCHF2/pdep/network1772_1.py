...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]CC([O])F(2694)'],
    products = ['[O]CC([O])C(=O)F(6168)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C[CH]C(=O)F(6755)'],
    products = ['[O]CC([O])C(=O)F(6168)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C([O])C(=O)F(1726)'],
    products = ['[O]CC([O])C(=O)F(6168)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]CC(=O)C(=O)F(6761)'],
    products = ['[O]CC([O])C(=O)F(6168)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(C=O)C(=O)F(2234)'],
    products = ['[O]CC([O])C(=O)F(6168)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', '[O]CC([O])=C=O(6728)'],
    products = ['[O]CC([O])C(=O)F(6168)'],
