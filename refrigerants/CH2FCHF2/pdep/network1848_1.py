...
"""),
    E0 = (-31.7153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,907.781,908.329,909.344,910,910.369],'cm^-1')),
        HinderedRotor(inertia=(0.1027,'amu*angstrom^2'), symmetry=1, barrier=(2.36126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103477,'amu*angstrom^2'), symmetry=1, barrier=(2.37913,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.62022,0.0355634,-4.74756e-05,4.96273e-08,-2.1179e-11,-3769.91,16.4499], Tmin=(100,'K'), Tmax=(787.641,'K')), NASAPolynomial(coeffs=[1.1905,0.0307635,-1.53662e-05,3.0089e-09,-2.11622e-13,-3170.58,25.381], Tmin=(787.641,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.7153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CJCC=O)"""),
)
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.42893,-0.00147678,8.09488e-05,-1.04606e-07,4.09854e-11,-35622.8,13.5561], Tmin=(100,'K'), Tmax=(906.756,'K')), NASAPolynomial(coeffs=[8.45799,0.01245,-1.82703e-06,1.72902e-10,-1.21901e-14,-38019.4,-18.4], Tmin=(906.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone)"""),
)
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44972,0.0225988,2.31384e-05,-5.38757e-08,2.49248e-11,39049.4,18.8109], Tmin=(100,'K'), Tmax=(908.278,'K')), NASAPolynomial(coeffs=[13.0469,0.00626718,7.94203e-09,-1.24014e-10,7.91527e-15,35873,-38.1834], Tmin=(908.278,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(Cs_P) + radical(RCCJ)"""),
)

species(
    label = '[O][C]1CCO1(7049)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.9168,0.0181441,1.33062e-05,-2.30492e-08,7.95609e-12,14646.6,14.8399], Tmin=(100,'K'), Tmax=(1123.17,'K')), NASAPolynomial(coeffs=[6.33712,0.0204597,-9.14646e-06,1.76908e-09,-1.25816e-13,12963.9,-6.12896], Tmin=(1123.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopropane) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C=C([O])O(7051)',
    structure = adjacencyList("""multiplicity 3
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([O])=O(6512)'],
    products = ['CO2(14)', 'C2H4(30)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C([O])=O(540)'],
    products = ['[CH2]CC([O])=O(6512)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]CC([O])=O(6512)'],
    products = ['[CH2]C[C]1OO1(7048)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(355.837,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_O]
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CC([O])=O(6512)'],
    products = ['[O]C1([O])CC1(7050)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.34239e+09,'s^-1'), n=0.889391, Ea=(153.131,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs2H]
Euclidian distance = 1.4142135623730951
