...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.55729,'amu*angstrom^2'), symmetry=1, barrier=(12.8132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.557252,'amu*angstrom^2'), symmetry=1, barrier=(12.8123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.557322,'amu*angstrom^2'), symmetry=1, barrier=(12.8139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50678,'amu*angstrom^2'), symmetry=1, barrier=(34.6438,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.462274,0.0867835,-0.000125119,8.48002e-08,-1.76214e-11,-66780.2,25.8709], Tmin=(100,'K'), Tmax=(609.864,'K')), NASAPolynomial(coeffs=[11.8459,0.0268324,-1.38508e-05,2.72458e-09,-1.91394e-13,-68442.3,-25.6622], Tmin=(609.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFHH) + radical(C2CsJOH)"""),
)

species(
    label = 'OC(F)([CH]OF)CF(5517)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.875133,'amu*angstrom^2'), symmetry=1, barrier=(20.121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.875125,'amu*angstrom^2'), symmetry=1, barrier=(20.1209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.875125,'amu*angstrom^2'), symmetry=1, barrier=(20.1208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.87512,'amu*angstrom^2'), symmetry=1, barrier=(20.1207,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.221651,0.0872687,-0.000117663,7.89909e-08,-2.0876e-11,-66330.2,26.0749], Tmin=(100,'K'), Tmax=(926.812,'K')), NASAPolynomial(coeffs=[15.5113,0.0212825,-1.08704e-05,2.17596e-09,-1.56339e-13,-69164.4,-46.527], Tmin=(926.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-552.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C(O)(F)C(F)OF(5518)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-562.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,316,385,515,654,689,1295,261,493,600,1152,1365,1422,3097,3000,3100,440,815,1455,1000,210.272,223.95],'cm^-1')),
        HinderedRotor(inertia=(0.445066,'amu*angstrom^2'), symmetry=1, barrier=(14.3928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368323,'amu*angstrom^2'), symmetry=1, barrier=(9.0249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36071,'amu*angstrom^2'), symmetry=1, barrier=(32.8606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.35769,'amu*angstrom^2'), symmetry=1, barrier=(32.8696,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
...
"""),
    E0 = (-713.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,286,334,437,422,648,895,1187,261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,216.008,216.008,216.01],'cm^-1')),
        HinderedRotor(inertia=(0.62969,'amu*angstrom^2'), symmetry=1, barrier=(20.8489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435904,'amu*angstrom^2'), symmetry=1, barrier=(14.4328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09619,'amu*angstrom^2'), symmetry=1, barrier=(36.2947,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.407412,0.0849462,-0.000111667,7.55412e-08,-2.05088e-11,-85679.1,26.8935], Tmin=(100,'K'), Tmax=(895.093,'K')), NASAPolynomial(coeffs=[13.4401,0.0267058,-1.40673e-05,2.84919e-09,-2.05897e-13,-88012.2,-34.5372], Tmin=(895.093,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-713.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-F1sCsCs))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.06945,'amu*angstrom^2'), symmetry=1, barrier=(24.5887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06786,'amu*angstrom^2'), symmetry=1, barrier=(24.5521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07368,'amu*angstrom^2'), symmetry=1, barrier=(24.6861,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.913628,0.0688894,-9.1717e-05,5.75958e-08,-1.39564e-11,-63042.1,20.7944], Tmin=(100,'K'), Tmax=(1017.03,'K')), NASAPolynomial(coeffs=[15.7496,0.0105364,-5.64927e-06,1.17559e-09,-8.68579e-14,-66059.7,-51.0307], Tmin=(1017.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-525.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(F1s)(O2s-H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.504534,'amu*angstrom^2'), symmetry=1, barrier=(11.6002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37008,'amu*angstrom^2'), symmetry=1, barrier=(31.5008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37349,'amu*angstrom^2'), symmetry=1, barrier=(31.5793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.506726,'amu*angstrom^2'), symmetry=1, barrier=(11.6506,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
...
"""),
    E0 = (-636.039,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,232,360,932,1127,1349,1365,3045,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,286.202,287.325,287.981],'cm^-1')),
        HinderedRotor(inertia=(0.320718,'amu*angstrom^2'), symmetry=1, barrier=(18.8137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224563,'amu*angstrom^2'), symmetry=1, barrier=(13.1221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.651076,'amu*angstrom^2'), symmetry=1, barrier=(37.9235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.962966,0.0727639,-9.93512e-05,7.31006e-08,-2.1897e-11,-76393.8,23.696], Tmin=(100,'K'), Tmax=(810.047,'K')), NASAPolynomial(coeffs=[10.3048,0.0266345,-1.39318e-05,2.80101e-09,-2.01044e-13,-77907.3,-19.4049], Tmin=(810.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.26508,'amu*angstrom^2'), symmetry=1, barrier=(29.0867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26353,'amu*angstrom^2'), symmetry=1, barrier=(29.0511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2656,'amu*angstrom^2'), symmetry=1, barrier=(29.0987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39819,0.0597201,-6.44327e-05,3.63218e-08,-8.33246e-12,-93784.9,20.9315], Tmin=(100,'K'), Tmax=(1044.4,'K')), NASAPolynomial(coeffs=[11.1275,0.0224569,-1.09134e-05,2.1586e-09,-1.54649e-13,-95817.2,-26.4293], Tmin=(1044.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-780.534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH)"""),
)

species(
    label = 'OC(=COF)CF(5523)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.971913,'amu*angstrom^2'), symmetry=1, barrier=(22.3462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.973338,'amu*angstrom^2'), symmetry=1, barrier=(22.379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.973679,'amu*angstrom^2'), symmetry=1, barrier=(22.3868,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.06154,'amu*angstrom^2'), symmetry=1, barrier=(24.4068,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.67292,0.0683159,-7.63262e-05,4.11653e-08,-8.58404e-12,-52762.4,21.7001], Tmin=(100,'K'), Tmax=(1179.63,'K')), NASAPolynomial(coeffs=[17.159,0.0124136,-5.2421e-06,9.92416e-10,-7.02291e-14,-56652,-60.5596], Tmin=(1179.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-439.722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-573.593,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,326,540,652,719,1357,180,593.245],'cm^-1')),
        HinderedRotor(inertia=(0.214379,'amu*angstrom^2'), symmetry=1, barrier=(4.92899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346154,'amu*angstrom^2'), symmetry=1, barrier=(7.95876,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81574,'amu*angstrom^2'), symmetry=1, barrier=(41.7474,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.820926,'amu*angstrom^2'), symmetry=1, barrier=(18.8747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.820835,'amu*angstrom^2'), symmetry=1, barrier=(18.8726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50054,'amu*angstrom^2'), symmetry=1, barrier=(34.5005,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.754932,0.0759055,-9.87751e-05,6.52689e-08,-1.71948e-11,-72617.9,22.8814], Tmin=(100,'K'), Tmax=(924.164,'K')), NASAPolynomial(coeffs=[13.1756,0.0221464,-1.152e-05,2.32596e-09,-1.67971e-13,-74913.7,-36.0617], Tmin=(924.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-604.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['OCF(781)', 'F[C]C(F)OF(479)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(482)', 'OC(F)([C]F)CF(4240)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'OC(F)([C]F)C(F)OF(5511)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'OC(F)(F)C(F)OF(5235)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H2O(3)', 'FCC(F)=C(F)OF(2821)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OF(482)', 'FCC(F)=COF(500)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H2O(3)', 'FC=C(F)C(F)OF(5426)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OF(482)', 'C=C(F)C(F)OF(502)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FOF(488)', 'OC(=CF)CF(5515)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'O[C](CF)C(F)OF(5516)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'OC(F)([CH]OF)CF(5517)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', '[CH2]C(O)(F)C(F)OF(5518)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', '[O]C(F)C(O)(F)CF(5519)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OH(7)', 'FC[C](F)C(F)OF(495)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[O]C(F)(CF)C(F)OF(5520)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]F(128)', 'OC(F)([CH]F)CF(5088)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[CH]OF(363)', 'O[C](F)CF(2940)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2F(46)', 'O[C](F)C(F)OF(1056)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(5)', 'OC(F)(CF)[C](F)OF(5225)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(5)', 'OC(F)([CH]F)C(F)OF(5521)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'O=C(CF)C(F)OF(5522)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction29',
    reactants = ['F2(78)', 'O=CC(O)(F)CF(3454)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction30',
    reactants = ['F2(78)', 'OC(=COF)CF(5523)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction31',
    reactants = ['F2(78)', 'C=C(O)C(F)OF(5524)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction32',
    reactants = ['HF(38)', 'O=C(F)C(O)(F)CF(3275)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction33',
    reactants = ['HF(38)', 'OC(CF)=C(F)OF(5231)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction34',
    reactants = ['HF(38)', 'OC(=CF)C(F)OF(5525)'],
    products = ['OC(F)(CF)C(F)OF(5412)'],
...
reaction(
    label = 'reaction35',
    reactants = ['OC(F)(CF)C(F)OF(5412)'],
    products = ['F2(78)', 'CHFO(47)', 'C=C(O)F(3010)'],
...
reaction(
    label = 'reaction36',
    reactants = ['OC(F)(CF)C(F)OF(5412)'],
    products = ['HF(38)', 'CHFO(47)', 'OC(F)=CF(878)'],
