...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(156)', '[CH]=C[O](4002)'],
    products = ['[CH]=CO[C](F)F(9360)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O][C](F)F(2580)', 'C2H2(23)'],
    products = ['[CH]=CO[C](F)F(9360)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(2580)', '[CH]=[CH](4369)'],
    products = ['[CH]=CO[C](F)F(9360)'],
    transitionState = 'TS7',
