...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(219)', '[CH]C-2(4468)'],
    products = ['C[CH]OO[C](F)F(6559)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', 'C[CH]O[O](7054)'],
    products = ['C[CH]OO[C](F)F(6559)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['[O][C](F)F(2694)', 'CH3CHO(36)'],
    products = ['C[CH]OO[C](F)F(6559)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(2694)', 'C[CH][O](4509)'],
    products = ['C[CH]OO[C](F)F(6559)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', 'C[CH]O[O](7054)'],
    products = ['C[CH]OO[C](F)F(6559)'],
