...
"""),
    ...
    molecularWeight = (95.0249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.81381,0.0147468,7.14887e-05,-1.96756e-07,1.43407e-10,-33016.6,12.1025], Tmin=(10,'K'), Tmax=(495.959,'K')), NASAPolynomial(coeffs=[5.28736,0.0234114,-1.68662e-05,5.55088e-09,-6.81189e-13,-33415.4,3.47897], Tmin=(495.959,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-274.535,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), label="""F[CH]C1(F)OO1""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-149.641,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,293,496,537,1218,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(0.499801,'amu*angstrom^2'), symmetry=1, barrier=(11.4914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.016467,'amu*angstrom^2'), symmetry=1, barrier=(31.1466,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.51975,0.0416425,-6.43322e-05,5.43475e-08,-1.89028e-11,-17995.3,11.282], Tmin=(10,'K'), Tmax=(681.062,'K')), NASAPolynomial(coeffs=[7.4771,0.0184002,-1.31427e-05,4.24003e-09,-5.09717e-13,-18534.4,-6.28991], Tmin=(681.062,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-149.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""OOC(F)D[C]F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (106.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,615,860,1140,1343,3152,1685,370,180,363.195,1930.66],'cm^-1')),
        HinderedRotor(inertia=(1.57689,'amu*angstrom^2'), symmetry=1, barrier=(36.2559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57728,'amu*angstrom^2'), symmetry=1, barrier=(36.2648,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32336,0.0445474,-4.96529e-05,-2.51054e-09,3.27458e-11,12831.2,13.9372], Tmin=(100,'K'), Tmax=(483.467,'K')), NASAPolynomial(coeffs=[7.19733,0.0180207,-1.01624e-05,2.06808e-09,-1.47662e-13,12198.6,-7.70241], Tmin=(483.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOF(4603)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (109.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,293,496,537,1218,3120,650,792.5,1650,180,957.119],'cm^-1')),
        HinderedRotor(inertia=(0.339334,'amu*angstrom^2'), symmetry=1, barrier=(7.80197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17118,'amu*angstrom^2'), symmetry=1, barrier=(26.9277,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.68384,0.0247924,9.36003e-05,-3.73178e-07,3.49188e-10,13151.2,11.6151], Tmin=(10,'K'), Tmax=(415.785,'K')), NASAPolynomial(coeffs=[7.82824,0.0200413,-1.59574e-05,5.63223e-09,-7.26805e-13,12503,-8.39262], Tmin=(415.785,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(109.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""[CH]DC(F)OOF""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CHFCF[Z](72)'],
    products = ['[O]OC(F)=CF(214)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC(F)=CF(214)'],
    products = ['F[C]1OOC1F(319)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', '[O]OC#CF(287)'],
    products = ['[O]OC(F)=CF(214)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(270.22,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)

reaction(
    label = 'reaction10',
    reactants = ['OOC(F)=[C]F(4601)'],
    products = ['[O]OC(F)=CF(214)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FC=[C]OOF(4602)'],
    products = ['[O]OC(F)=CF(214)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(88.3862,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)OOF(4603)'],
    products = ['[O]OC(F)=CF(214)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(64.4124,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
