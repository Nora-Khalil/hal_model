...
species(
    label = '[O]C(C(O)(F)F)C(F)(F)F(9006)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(OF)[C](F)F(9117)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)(OF)C(F)[C](F)F(9143)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)C(OF)[C](F)F(8998)'],
    products = ['OC(F)(F)C(F)(F)[CH]OF(9154)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)(F)C([C]F)OF(9155)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(156)', 'OC(F)(F)[CH]OF(5550)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(128)', 'OC(F)(F)C=C(F)F(2619)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O[C](F)F(2562)', 'FOC=C(F)F(3557)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'OC(F)(F)C(OF)=C(F)F(9156)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[C](F)C(OF)[C](F)F(9157)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C([C](F)F)C(O)(F)F(9158)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(128)', 'OC(F)(F)[CH][C](F)F(2622)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'FOC([C](F)F)[C](F)F(9015)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)(F)C(OF)[C](F)F(9159)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O[C](F)F(2562)', 'FO[CH][C](F)F(3555)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)(F)[C](OF)[C](F)F(9160)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=C(F)C(OF)[C](F)F(2102)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'OC(F)=C(OF)[C](F)F(9161)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', 'OC(F)(F)C([C]F)OF-2(9162)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CF2(43)', 'OC(F)(F)[CH]OF(5550)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction22',
    reactants = ['OC(F)(F)C(OF)[C](F)F(8998)'],
    products = ['OC(F)(F)[C](OF)C(F)F(7945)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)(F)C(OF)C(F)F(9140)'],
    products = ['OC(F)(F)C(OF)[C](F)F(8998)'],
...
reaction(
    label = 'reaction24',
    reactants = ['OC(F)(F)C(OF)[C](F)F(8998)'],
    products = ['[O]C(C(O)(F)F)C(F)(F)F(9006)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)(F)C(OF)[C](F)F(8998)'],
    products = ['O[C](F)C(OF)C(F)(F)F(9163)'],
...
network(
    label = 'PDepNetwork #2405',
    isomers = [
        'OC(F)(F)C(OF)[C](F)F(8998)',
    ],
    reactants = [
