...
reaction(
    label = 'reaction3',
    reactants = ['OF(482)', 'F[C]CC(F)F(718)'],
    products = ['FOC(F)CC(F)F(697)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]CC(F)OF(720)'],
    products = ['FOC(F)CC(F)F(697)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FO[CH]CC(F)F(722)'],
    products = ['FOC(F)CC(F)F(697)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]CC(F)OF(723)'],
    products = ['FOC(F)CC(F)F(697)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)CC(F)F(724)'],
    products = ['FOC(F)CC(F)F(697)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(128)', 'F[CH]CC(F)F(725)'],
    products = ['FOC(F)CC(F)F(697)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH]OF(363)', 'CHF2-CH2(64)'],
    products = ['FOC(F)CC(F)F(697)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF2(82)', '[CH2]C(F)OF(726)'],
    products = ['FOC(F)CC(F)F(697)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'FOC(F)[CH]C(F)F(727)'],
    products = ['FOC(F)CC(F)F(697)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FO[C](F)CC(F)F(728)'],
    products = ['FOC(F)CC(F)F(697)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC(F)C[C](F)F(729)'],
    products = ['FOC(F)CC(F)F(697)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(F)CC(F)F(324)'],
    products = ['FOC(F)CC(F)F(697)'],
