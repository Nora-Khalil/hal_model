...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C([O])F(441)'],
    products = ['[O]C(F)O[C]=O(993)'],
    transitionState = 'TS2',
