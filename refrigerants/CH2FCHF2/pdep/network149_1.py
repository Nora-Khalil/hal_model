...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CC(F)OF(701)'],
    products = ['CC(F)(F)C(F)OF(698)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'F[C]C(F)OF(479)'],
    products = ['CC(F)(F)C(F)OF(698)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)F(703)', 'C[C]F(702)'],
    products = ['CC(F)(F)C(F)OF(698)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(482)', 'CC(F)(F)[C]F(704)'],
    products = ['CC(F)(F)C(F)OF(698)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'CC(F)(F)OF(705)'],
    products = ['CC(F)(F)C(F)OF(698)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(F)OF(708)'],
    products = ['CC(F)(F)C(F)OF(698)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)[CH]OF(709)'],
    products = ['CC(F)(F)C(F)OF(698)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC(F)(F)C([O])F(710)'],
    products = ['CC(F)(F)C(F)OF(698)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(128)', 'CC(F)(F)[CH]F(711)'],
    products = ['CC(F)(F)C(F)OF(698)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(363)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(F)OF(698)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'FOC(F)[C](F)F(712)'],
    products = ['CC(F)(F)C(F)OF(698)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC(F)(F)[C](F)OF(713)'],
    products = ['CC(F)(F)C(F)OF(698)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)OF(714)'],
    products = ['CC(F)(F)C(F)OF(698)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'CC(F)(F)C=O(715)'],
    products = ['CC(F)(F)C(F)OF(698)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'CC(F)(F)C(=O)F(430)'],
    products = ['CC(F)(F)C(F)OF(698)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'CC(F)=C(F)OF(717)'],
    products = ['CC(F)(F)C(F)OF(698)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=C(F)C(F)OF(502)'],
    products = ['CC(F)(F)C(F)OF(698)'],
