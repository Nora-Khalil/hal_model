...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC([O])=O(4622)'],
    products = ['CC([O])C([O])=O(9557)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[O]C(=O)C=O(1356)'],
    products = ['CC([O])C([O])=O(9557)'],
