...
reaction(
    label = 'reaction1',
    reactants = ['[O]OO[C]=O(336)'],
    products = ['O=O(207)', 'CO2(14)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](129)', '[C]=O(514)'],
    products = ['[O]OO[C]=O(336)'],
    transitionState = 'TS2',
