...
"""),
    E0 = (-352.939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,180,180,180,997.103,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0217837,'amu*angstrom^2'), symmetry=1, barrier=(15.3701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188967,'amu*angstrom^2'), symmetry=1, barrier=(41.5412,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74128,0.0449977,-5.13133e-05,2.60625e-08,-4.66904e-12,-42363.3,23.7156], Tmin=(100,'K'), Tmax=(1018.17,'K')), NASAPolynomial(coeffs=[13.9748,0.00404513,-1.4528e-06,2.72239e-10,-2.01714e-14,-45222.9,-37.3336], Tmin=(1018.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-352.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (114.005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.8289,-0.000299983,0.000102882,-1.46987e-07,5.95135e-11,-58783.5,18.9231], Tmin=(100,'K'), Tmax=(935.239,'K')), NASAPolynomial(coeffs=[19.7734,-0.00600477,4.947e-06,-8.43368e-10,4.2876e-14,-64872.9,-77.3005], Tmin=(935.239,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-489.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(CsFFOO) + ring(Cyclopentane)"""),
)

species(
    label = 'FC1(F)OOO1(2710)',
...
"""),
    E0 = (-46.6344,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,482,586,761,1411,180,180,349.639,878.152,878.657,4000],'cm^-1')),
        HinderedRotor(inertia=(1.97308,'amu*angstrom^2'), symmetry=1, barrier=(45.3649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.731182,'amu*angstrom^2'), symmetry=1, barrier=(16.8113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217026,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71741,0.0508605,-6.90477e-05,4.46855e-08,-1.11665e-11,-5527.11,24.6035], Tmin=(100,'K'), Tmax=(987.535,'K')), NASAPolynomial(coeffs=[12.2827,0.00806623,-4.04624e-06,8.04263e-10,-5.77583e-14,-7613.83,-26.2352], Tmin=(987.535,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.6344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFHOO) + radical(ROOJ) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O][C](F)OOOF(6947)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {4,S} {7,S}
...
"""),
    E0 = (17.6848,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,482,586,761,1411,463.075,463.08,463.088,463.101,463.114],'cm^-1')),
        HinderedRotor(inertia=(0.000786145,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000786063,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000786141,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.005,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OOC([O])(F)F(6943)'],
    products = ['O2(2)', 'FC1(F)OO1(2509)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC([O])(F)F(2561)'],
    products = ['[O]OOC([O])(F)F(6943)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[O](129)', '[O][C](F)F(2580)'],
    products = ['[O]OOC([O])(F)F(6943)'],
    transitionState = 'TS9',
