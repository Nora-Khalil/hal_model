...
species(
    label = 'F[C]C(=C(F)F)C(F)(F)OF(10928)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-748.568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,350,440,435,1725,182,240,577,636,1210,1413,315,622,1128,180,2183.95],'cm^-1')),
        HinderedRotor(inertia=(0.507584,'amu*angstrom^2'), symmetry=1, barrier=(11.6703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28212,'amu*angstrom^2'), symmetry=1, barrier=(29.4784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29003,'amu*angstrom^2'), symmetry=1, barrier=(29.6604,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (178.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.381563,0.106056,-0.000173844,1.40818e-07,-4.40804e-11,-89883.2,30.4201], Tmin=(100,'K'), Tmax=(667.761,'K')), NASAPolynomial(coeffs=[14.4492,0.0263689,-1.54003e-05,3.15883e-09,-2.26637e-13,-92067.9,-36.6684], Tmin=(667.761,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-748.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(Cds-CdsCsCs) + group(CdCFF) + group(CJ2_singlet-FC)"""),
)
...
species(
    label = 'FCC(=C(F)OF)C(F)(F)F(10930)',
...
species(
    label = 'C=C(C(F)(F)F)C(F)(F)OF(10931)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
species(
    label = '[CH2]C(=C(F)F)C(F)(F)OF(10933)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.21393,'amu*angstrom^2'), symmetry=1, barrier=(4.91867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214096,'amu*angstrom^2'), symmetry=1, barrier=(4.92249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07367,'amu*angstrom^2'), symmetry=1, barrier=(24.6857,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.420084,0.107219,-0.000184813,1.62829e-07,-5.59992e-11,-76284.7,30.0296], Tmin=(100,'K'), Tmax=(807.395,'K')), NASAPolynomial(coeffs=[12.456,0.0300228,-1.64918e-05,3.28242e-09,-2.30344e-13,-77927,-26.6294], Tmin=(807.395,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-635.511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Cdj(Cd-CsCs)(F1s))"""),
)

species(
    label = '[O]C(F)(F)C(CF)=C(F)F(10935)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-973.484,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,526,555,698,907,1200,1145,1227,350,440,435,1725,182,240,577,636,1210,1413,228.321,228.733,228.824],'cm^-1')),
        HinderedRotor(inertia=(0.181479,'amu*angstrom^2'), symmetry=1, barrier=(6.71412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.71241,'amu*angstrom^2'), symmetry=1, barrier=(26.3505,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.535061,0.0818419,-0.000103151,6.74903e-08,-1.78276e-11,-116963,28.4795], Tmin=(100,'K'), Tmax=(916.551,'K')), NASAPolynomial(coeffs=[12.9681,0.0275815,-1.43492e-05,2.89892e-09,-2.09448e-13,-119242,-30.4191], Tmin=(916.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-973.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(O2sj(Cs-F1sF1sCd))"""),
)
...
species(
    label = 'F[C]C(F)(CF)C(F)(F)OF(10939)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.13633,'amu*angstrom^2'), symmetry=1, barrier=(26.1264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13747,'amu*angstrom^2'), symmetry=1, barrier=(26.1526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1387,'amu*angstrom^2'), symmetry=1, barrier=(26.1809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13724,'amu*angstrom^2'), symmetry=1, barrier=(26.1474,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.873537,0.116049,-0.000186607,1.52639e-07,-4.93451e-11,-101351,33.0683], Tmin=(100,'K'), Tmax=(760.545,'K')), NASAPolynomial(coeffs=[15.5462,0.0296742,-1.62189e-05,3.25385e-09,-2.30864e-13,-103848,-41.6499], Tmin=(760.545,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-844.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.173753,'amu*angstrom^2'), symmetry=1, barrier=(3.99493,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.83325,'amu*angstrom^2'), symmetry=1, barrier=(42.15,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83095,'amu*angstrom^2'), symmetry=1, barrier=(42.0971,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83213,'amu*angstrom^2'), symmetry=1, barrier=(42.1243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.525909,0.0846453,-0.000143018,1.27552e-07,-4.48074e-11,-42350.5,34.0254], Tmin=(100,'K'), Tmax=(796.983,'K')), NASAPolynomial(coeffs=[9.58215,0.0279815,-1.52706e-05,3.04245e-09,-2.14185e-13,-43437.9,-5.37682], Tmin=(796.983,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-353.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FCC(OF)=C(F)F(5237)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOF(488)', 'F[C]C(CF)=C(F)F(10927)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'F[C]C(=C(F)F)C(F)(F)OF(10928)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'FOC(F)(F)C(F)=C(F)F(10929)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FCC(=C(F)OF)C(F)(F)F(10930)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
    products = ['C=C(C(F)(F)F)C(F)(F)OF(10931)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FCC([C](F)F)=C(F)OF(10932)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(=C(F)F)C(F)(F)OF(10933)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[C]=C(CF)C(F)(F)OF(10934)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(CF)=C(F)F(10935)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(128)', 'FCC([C](F)F)=C(F)F(10936)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(2563)', 'FC[C]=C(F)F(9672)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'FOC(F)(F)[C]=C(F)F(10937)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]C(F)(CF)C(F)(F)OF(10939)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', 'O=C(F)C(CF)=C(F)F(10293)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
    products = ['F2(78)', 'CF2O(49)', 'C=C=C(F)F(10940)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CF2(43)', 'FC[C]C(F)(F)OF(10941)'],
    products = ['FCC(=C(F)F)C(F)(F)OF(10923)'],
