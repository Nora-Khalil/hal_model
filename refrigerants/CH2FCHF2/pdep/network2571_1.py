...
reaction(
    label = 'reaction1',
    reactants = ['[OH+]=[C-]C(F)(F)C#CF(7609)'],
...
reaction(
    label = 'reaction2',
    reactants = ['FC#CC(F)=[C-][OH+]F(10525)'],
    products = ['[OH+]=[C-]C(F)(F)C#CF(7609)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FC#C[OH+][C-]=C(F)F(10526)'],
    products = ['[OH+]=[C-]C(F)(F)C#CF(7609)'],
    transitionState = 'TS3',
