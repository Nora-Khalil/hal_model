...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.446888,0.0870967,-0.000153257,1.38694e-07,-4.89759e-11,-85414.5,25.6015], Tmin=(100,'K'), Tmax=(797.445,'K')), NASAPolynomial(coeffs=[10.1235,0.0259629,-1.45711e-05,2.94524e-09,-2.08756e-13,-86557.3,-16.381], Tmin=(797.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-711.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[O][C](F)C(F)(F)CF(2632)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.79896,'amu*angstrom^2'), symmetry=1, barrier=(41.3615,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.928351,0.0741274,-0.000109606,8.6044e-08,-2.726e-11,-82141.8,23.6599], Tmin=(100,'K'), Tmax=(769.468,'K')), NASAPolynomial(coeffs=[10.4163,0.0248071,-1.34644e-05,2.74987e-09,-1.98675e-13,-83602,-19.6278], Tmin=(769.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-683.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = 'F[CH][C](F)C(F)OF(3789)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.10651,'amu*angstrom^2'), symmetry=1, barrier=(2.44888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236478,'amu*angstrom^2'), symmetry=1, barrier=(13.2635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.22852,'amu*angstrom^2'), symmetry=1, barrier=(51.238,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.495699,0.0901751,-0.000172515,1.66293e-07,-6.06243e-11,-43272.3,25.8382], Tmin=(100,'K'), Tmax=(836.389,'K')), NASAPolynomial(coeffs=[7.1149,0.0311042,-1.74096e-05,3.473e-09,-2.42688e-13,-43420.7,0.819368], Tmin=(836.389,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = '[O]C(F)[C](F)C(F)F(3780)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.449189,'amu*angstrom^2'), symmetry=1, barrier=(10.3277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.623145,'amu*angstrom^2'), symmetry=1, barrier=(14.3273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
"""),
    E0 = (-377.957,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,334,575,1197,1424,3202,241.902,241.903,241.905],'cm^-1')),
        HinderedRotor(inertia=(0.256779,'amu*angstrom^2'), symmetry=1, barrier=(10.6627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.485688,'amu*angstrom^2'), symmetry=1, barrier=(20.1682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.485699,'amu*angstrom^2'), symmetry=1, barrier=(20.1681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0124772,0.0957821,-0.000166497,1.41607e-07,-4.66972e-11,-45320.5,26.3712], Tmin=(100,'K'), Tmax=(800.661,'K')), NASAPolynomial(coeffs=[14.2032,0.0186251,-1.04487e-05,2.10045e-09,-1.47927e-13,-47400.1,-37.8222], Tmin=(800.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-377.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[O][CH]C(F)(F)C(F)F(3791)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.927888,0.0763919,-0.000130953,1.22836e-07,-4.53763e-11,-83500.3,24.488], Tmin=(100,'K'), Tmax=(789.447,'K')), NASAPolynomial(coeffs=[7.09912,0.0307338,-1.68592e-05,3.3984e-09,-2.41349e-13,-84026.2,-0.985669], Tmin=(789.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-695.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C(F)(F)[CH]F(3676)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)C(F)[C](F)F(3677)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', '[O]C(F)[C](F)F(429)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)(F)[CH]F(3708)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)C(F)=CF(396)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(388)', 'CHFCF2(55)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=CC(F)(F)[CH]F(3612)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHFO(47)', 'F[CH][C](F)F(3610)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(F)C(F)(F)[CH]F(3787)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(388)', 'F[CH][C](F)F(3610)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[O]C=C(F)[CH]F(400)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=C(F)[C](F)[CH]F(2590)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[O]C(F)[C](F)F(429)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)C(F)(F)[CH]F(3676)'],
    products = ['O[C](F)C(F)(F)[CH]F(3788)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH][C](F)C(F)OF(3789)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)[C](F)C(F)F(3780)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)[CH]OF(3790)'],
    products = ['[O]C(F)C(F)(F)[CH]F(3676)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)C(F)(F)[CH]F(3676)'],
    products = ['[O][CH]C(F)(F)C(F)F(3791)'],
...
network(
    label = 'PDepNetwork #803',
    isomers = [
        '[O]C(F)C(F)(F)[CH]F(3676)',
    ],
    reactants = [
        ('CHFO(47)', 'CHFCF2(55)'),
    ],
