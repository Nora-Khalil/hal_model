...
"""),
    E0 = (-296.244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,223,363,546,575,694,1179,1410,293.933,294.578,294.795],'cm^-1')),
        HinderedRotor(inertia=(0.00195725,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00480776,'amu*angstrom^2'), symmetry=1, barrier=(19.3048,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0334,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9555,0.0408487,-4.71283e-05,2.49391e-08,-4.82219e-12,-35552.7,16.3981], Tmin=(100,'K'), Tmax=(1043.53,'K')), NASAPolynomial(coeffs=[12.9643,0.00373762,-1.0963e-06,2.02877e-10,-1.53165e-14,-38127.3,-38.5093], Tmin=(1043.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (-535.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([90,150,250,247,323,377,431,433,1065,1274,500.786,934.888,3026.99],'cm^-1')),
        HinderedRotor(inertia=(0.000157817,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000163575,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03471,0.0467404,-6.75076e-05,4.90269e-08,-1.40702e-11,-64352.5,16.8123], Tmin=(100,'K'), Tmax=(853.343,'K')), NASAPolynomial(coeffs=[9.44491,0.0120063,-6.45351e-06,1.33004e-09,-9.69321e-14,-65617.2,-17.7626], Tmin=(853.343,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-535.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.68598,'amu*angstrom^2'), symmetry=1, barrier=(15.772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.685731,'amu*angstrom^2'), symmetry=1, barrier=(15.7663,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0318,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OH(7)', 'CHFCF2(55)'],
    products = ['OC(F)(F)[CH]F(3941)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C(O)(F)F-2(7082)'],
    products = ['OC(F)(F)[CH]F(3941)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'O[C](F)F(2562)'],
    products = ['OC(F)(F)[CH]F(3941)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'OC(F)(F)[C]F-2(7083)'],
    products = ['OC(F)(F)[CH]F(3941)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'F[CH][C](F)F(3610)'],
    products = ['OC(F)(F)[CH]F(3941)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)[CH]F(2586)'],
    products = ['OC(F)(F)[CH]F(3941)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'O=C(F)[CH]F(215)'],
    products = ['OC(F)(F)[CH]F(3941)'],
    transitionState = 'TS9',
