...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OO[CH]C(=O)F(6160)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(1130)', '[CH]C(=O)F(323)'],
    products = ['O=[C]OO[CH]C(=O)F(6160)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', '[O]O[CH]C(=O)F(1948)'],
    products = ['O=[C]OO[CH]C(=O)F(6160)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[O]O[CH]C(=O)F(1948)'],
    products = ['O=[C]OO[CH]C(=O)F(6160)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=[C]OOC=C=O(6784)'],
    products = ['O=[C]OO[CH]C(=O)F(6160)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(6)', 'O=[C]OOC=[C]F(6786)'],
    products = ['O=[C]OO[CH]C(=O)F(6160)'],
...
network(
    label = 'PDepNetwork #1764',
    isomers = [
        'O=[C]OO[CH]C(=O)F(6160)',
    ],
    reactants = [
        ('CO2(14)', 'O=CC(=O)F(335)'),
    ],
