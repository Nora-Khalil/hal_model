...
species(
    label = '[CH2]C(F)(F)C1=C(F)O1(8556)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
    products = ['[CH2]C1(F)O[C](F)C1F(8554)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)CC1O[C]1F(8464)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C1O[C]1F(8515)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
    products = ['FC1(F)CC2(F)OC12(8506)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
    products = ['CC(F)(F)C1=C(F)O1(8555)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)[CH]C(=O)F(1781)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C1=C(F)O1(8556)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C1O[C]1F(8557)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C=C(F)[C]1O[C]1F(8558)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
    products = ['CC(F)(F)[C]1O[C]1F(8559)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
    products = ['[CH2][C](F)C1OC1(F)F(8560)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FC[C](F)C1O[C]1F(8550)'],
    products = ['[CH2]C(F)(F)C1O[C]1F(8462)'],
...
network(
    label = 'PDepNetwork #2258',
    isomers = [
        '[CH2]C(F)(F)C1O[C]1F(8462)',
    ],
    reactants = [
