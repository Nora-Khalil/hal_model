...
reaction(
    label = 'reaction3',
    reactants = ['O=C1[CH][C](F)OO1(8748)'],
    products = ['[O]C(=O)C1O[C]1F(8647)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C1O[C]1F(8749)'],
    products = ['[O]C(=O)C1O[C]1F(8647)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(O)[C]1O[C]1F(8753)'],
    products = ['[O]C(=O)C1O[C]1F(8647)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C1=C(F)O1(8754)'],
    products = ['[O]C(=O)C1O[C]1F(8647)'],
