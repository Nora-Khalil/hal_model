...
"""),
    E0 = (-617.935,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.208442,'amu*angstrom^2'), symmetry=1, barrier=(4.79249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374996,'amu*angstrom^2'), symmetry=1, barrier=(8.6219,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.68264,0.0255402,0.000151924,-4.95276e-07,4.43355e-10,-74321.3,12.1604], Tmin=(10,'K'), Tmax=(397.362,'K')), NASAPolynomial(coeffs=[5.2786,0.0413779,-2.82932e-05,9.13257e-09,-1.115e-12,-74700,2.7644], Tmin=(397.362,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-617.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), label="""CCC(F)(F)OF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-514.425,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,351,323,533,609,664,892,1120,1201,180],'cm^-1')),
        HinderedRotor(inertia=(0.178621,'amu*angstrom^2'), symmetry=1, barrier=(4.10684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178722,'amu*angstrom^2'), symmetry=1, barrier=(4.10917,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.63453,0.0328428,-6.34108e-06,-1.56583e-08,8.9743e-12,-61869.3,11.5134], Tmin=(10,'K'), Tmax=(842.728,'K')), NASAPolynomial(coeffs=[5.66303,0.0313141,-1.80366e-05,4.99851e-09,-5.36933e-13,-62498.8,0.367713], Tmin=(842.728,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-514.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""CCC([O])(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCC(F)(F)OF(13089)'],
    products = ['HF(38)', 'CF2O(49)', 'C2H4(30)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(46.3284,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CC(F)(F)OF(705)'],
    products = ['CCC(F)(F)OF(13089)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000166864,'m^3/(mol*s)'), n=2.82973, Ea=(154.802,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CF2(43)', 'CCOF(2858)'],
    products = ['CCC(F)(F)OF(13089)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(196.607,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['FOF(488)', 'CC[C]F(13290)'],
    products = ['CCC(F)(F)OF(13089)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.27832e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(12.6067,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['OF(482)', 'CC=C(F)F(13066)'],
    products = ['CCC(F)(F)OF(13089)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'CC[C](F)OF(13291)'],
    products = ['CCC(F)(F)OF(13089)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'CCC([O])(F)F(13292)'],
    products = ['CCC(F)(F)OF(13089)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(128)', 'CC[C](F)F(4380)'],
    products = ['CCC(F)(F)OF(13089)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FO[C](F)F(2563)', 'C2H5(32)'],
    products = ['CCC(F)(F)OF(13089)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[CH2]C(F)(F)OF(2838)'],
    products = ['CCC(F)(F)OF(13089)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C[CH]C(F)(F)OF(13293)'],
    products = ['CCC(F)(F)OF(13089)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]CC(F)(F)OF(13294)'],
    products = ['CCC(F)(F)OF(13089)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', 'CCC(=O)F(13295)'],
    products = ['CCC(F)(F)OF(13089)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(85.7077,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'CC=C(F)OF(13296)'],
    products = ['CCC(F)(F)OF(13089)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(183.724,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)
