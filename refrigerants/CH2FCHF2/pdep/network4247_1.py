...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3165.61,'J/mol'), sigma=(5.6889,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=494.46 K, Pc=39.01 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]OO[CH]C(=O)F(15632)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(7689)', 'C=[C]O[O](6926)'],
    products = ['C=[C]OO[CH]C(=O)F(15632)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[CH]C(=O)F(2224)', '[C]=C(4465)'],
    products = ['C=[C]OO[CH]C(=O)F(15632)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['C=[C]OO[CH]C(=O)F(15632)'],
    products = ['C=C1OO[CH][C](F)O1(16031)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C=[C]OO[CH]C(=O)F(15632)'],
    products = ['C=C1OO[CH]C1([O])F(16032)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=[C]OOC=C=O(16033)'],
    products = ['C=[C]OO[CH]C(=O)F(15632)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C#COO[CH]C(=O)F(16034)'],
    products = ['C=[C]OO[CH]C(=O)F(15632)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=COO[CH]C(=O)F(16035)'],
    products = ['C=[C]OO[CH]C(=O)F(15632)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C]OO[CH]C(=O)F(15632)'],
    products = ['C=C(F)OO[CH][C]=O(16037)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(6)', 'C=[C]OOC=[C]F(16038)'],
    products = ['C=[C]OO[CH]C(=O)F(15632)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=[C]OO[CH]C(=O)F(15632)'],
    products = ['FC1=COO1(285)', '[CH2][C]=O(4470)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=[C]OO[C]=C=O(15549)'],
    products = ['C=[C]OO[CH]C(=O)F(15632)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=[C]OO[C]=C(O)F(16041)'],
    products = ['C=[C]OO[CH]C(=O)F(15632)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=[C]OOC=C(O)F(16043)'],
    products = ['C=[C]OO[CH]C(=O)F(15632)'],
