species(
    label = '[CH]=C(O[C]=C)C(F)(F)F(11400)',
...
"""),
    E0 = (-205.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([219,296,586,564,718,793,1177,1228,350,440,435,1725,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,309.854,311.728,312.882],'cm^-1')),
        HinderedRotor(inertia=(0.147661,'amu*angstrom^2'), symmetry=1, barrier=(10.2962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00157764,'amu*angstrom^2'), symmetry=1, barrier=(10.3358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.511392,'amu*angstrom^2'), symmetry=1, barrier=(35.47,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-235.876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([219,296,586,564,718,793,1177,1228,350,440,435,1725,3120,650,792.5,1650,2175,525,750,770,3400,2100,266.662,268.188],'cm^-1')),
        HinderedRotor(inertia=(0.217937,'amu*angstrom^2'), symmetry=1, barrier=(11.262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.696457,'amu*angstrom^2'), symmetry=1, barrier=(35.1487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401593,'amu*angstrom^2'), symmetry=1, barrier=(20.5121,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (135.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397157,0.0841853,-0.000121436,8.8282e-08,-2.52856e-11,-28243.9,25.921], Tmin=(100,'K'), Tmax=(857.076,'K')), NASAPolynomial(coeffs=[13.962,0.0208793,-1.06442e-05,2.10597e-09,-1.49499e-13,-30569.2,-37.4297], Tmin=(857.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCdFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COC(=[CH])C(F)(F)F(12956)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-198.106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([219,296,586,564,718,793,1177,1228,350,440,435,1725,3010,987.5,1337.5,450,1655,3115,3125,620,680,785,800,1600,1700,180,694.589],'cm^-1')),
        HinderedRotor(inertia=(0.4821,'amu*angstrom^2'), symmetry=1, barrier=(11.0844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.763723,'amu*angstrom^2'), symmetry=1, barrier=(17.5595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.765953,'amu*angstrom^2'), symmetry=1, barrier=(17.6108,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (136.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.289081,0.0825526,-0.000104023,6.50034e-08,-1.58875e-11,-23693.7,29.2499], Tmin=(100,'K'), Tmax=(1004.12,'K')), NASAPolynomial(coeffs=[16.3191,0.0186947,-8.62777e-06,1.66644e-09,-1.17983e-13,-26912.8,-48.1513], Tmin=(1004.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-198.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCdFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = 'C#CO[C]([CH2])C(F)(F)F(12957)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (136.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.803674,0.111714,-0.000184164,1.46893e-07,-4.51518e-11,-31916.3,27.2035], Tmin=(100,'K'), Tmax=(838.669,'K')), NASAPolynomial(coeffs=[18.0144,0.0178321,-8.86608e-06,1.67492e-09,-1.13428e-13,-34927.4,-59.406], Tmin=(838.669,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-266.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH]C(OC(=C)F)=C(F)F(11401)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[CH]=C(F)O[C]=C(8491)'],
    products = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(206.559,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[C]=C(4465)', '[CH]=C([O])C(F)(F)F(12335)'],
    products = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(69.6679,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)
...
reaction(
    ...
    products = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(99.5958,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CF3(45)', 'C#CO[C]=C(8518)'],
    products = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(12.1555,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(OC#C)C(F)(F)F(12955)'],
    products = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(3.45519,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction10',
    reactants = ['[CH]=COC(=[CH])C(F)(F)F(12956)'],
    products = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
    products = ['C#CO[C]([CH2])C(F)(F)F(12957)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
    products = ['[CH]C(OC(=C)F)=C(F)F(11401)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(1.40964e+08,'s^-1'), n=1.42748, Ea=(180.367,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction23',
    reactants = ['C=[C]OC([CH]F)=C(F)F(9459)'],
    products = ['[CH]=C(O[C]=C)C(F)(F)F(11400)'],
