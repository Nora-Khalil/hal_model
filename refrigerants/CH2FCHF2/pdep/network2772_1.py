...
species(
    label = 'O=[C]O[CH]C(F)=C(F)F(11004)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'O=C(F)O[CH][C]=C(F)F(11005)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)[C]=C(F)F(10168)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C(F)[C]=C(F)F(10152)'],
    products = ['O=[C]OC(F)[C]=C(F)F(10168)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(3960)', 'O=[C]O[CH]F(515)'],
    products = ['O=[C]OC(F)[C]=C(F)F(10168)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=[C]OC(F)[C]=C(F)F(10168)'],
    products = ['O=C1OC(F)C1=C(F)F(10172)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=[C]OC(F)[C]=C(F)F(10168)'],
    products = ['O=COC(F)=C=C(F)F(10165)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C(F)[C]=C(F)F(10152)'],
    products = ['O=[C]OC(F)[C]=C(F)F(10168)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]OC=C=C(F)F(10999)'],
    products = ['O=[C]OC(F)[C]=C(F)F(10168)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(F)=C=C(F)F(11000)'],
    products = ['O=[C]OC(F)[C]=C(F)F(10168)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=[C]OC(F)C#CF(11001)'],
    products = ['O=[C]OC(F)[C]=C(F)F(10168)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]OC(F)[C]=C(F)F(10168)'],
    products = ['O=[C]OC(F)=C[C](F)F(11002)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OC(F)[C]=C(F)F(10168)'],
    products = ['O=COC(F)=[C][C](F)F(11003)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OC(F)[C]=C(F)F(10168)'],
    products = ['O=[C]O[CH]C(F)=C(F)F(11004)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OC(F)[C]=C(F)F(10168)'],
    products = ['O=C(F)O[CH][C]=C(F)F(11005)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OC(F)C(F)=[C]F(11006)'],
    products = ['O=[C]OC(F)[C]=C(F)F(10168)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C(F)OC(F)[C]=[C]F(11007)'],
    products = ['O=[C]OC(F)[C]=C(F)F(10168)'],
