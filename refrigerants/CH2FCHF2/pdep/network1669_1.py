...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.160242,'amu*angstrom^2'), symmetry=1, barrier=(3.68427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161575,'amu*angstrom^2'), symmetry=1, barrier=(3.71493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.765714,'amu*angstrom^2'), symmetry=1, barrier=(17.6053,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0767085,0.0970455,-0.000174372,1.576e-07,-5.45449e-11,-91400.3,26.8574], Tmin=(100,'K'), Tmax=(843.018,'K')), NASAPolynomial(coeffs=[10.4148,0.0276974,-1.4867e-05,2.90399e-09,-2.0042e-13,-92422.1,-16.975], Tmin=(843.018,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-761.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'OC(OC(F)F)=C(F)F(9353)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1109.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,519,593,830,1115,1166,1389,1413,3114,350,440,435,1725,182,240,577,636,1210,1413,221.432,221.453,221.551],'cm^-1')),
        HinderedRotor(inertia=(0.466848,'amu*angstrom^2'), symmetry=1, barrier=(16.2486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.466727,'amu*angstrom^2'), symmetry=1, barrier=(16.2491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.466592,'amu*angstrom^2'), symmetry=1, barrier=(16.249,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.252309,0.0863531,-0.000123153,8.63888e-08,-2.36536e-11,-133283,25.2003], Tmin=(100,'K'), Tmax=(898.936,'K')), NASAPolynomial(coeffs=[15.6134,0.0179993,-9.09265e-06,1.79809e-09,-1.27885e-13,-136045,-47.2713], Tmin=(898.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1109.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C([O])C(F)(F)C(F)F(9354)',
...
"""),
    E0 = (-851.887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,235,523,627,1123,1142,1372,1406,3097,1380,1390,370,380,2900,435,180,180,1589.84,1590.97],'cm^-1')),
        HinderedRotor(inertia=(0.262687,'amu*angstrom^2'), symmetry=1, barrier=(6.0397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262488,'amu*angstrom^2'), symmetry=1, barrier=(6.03512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.527576,0.0922974,-0.000179755,1.80234e-07,-6.76794e-11,-102349,28.9532], Tmin=(100,'K'), Tmax=(841.626,'K')), NASAPolynomial(coeffs=[3.95741,0.0399055,-2.20557e-05,4.36574e-09,-3.0375e-13,-101648,20.5914], Tmin=(841.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-851.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)C(F)(F)[C](F)F(9355)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-874.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,1380,1390,370,380,2900,435,190,488,555,1236,1407,180,180,1896.86],'cm^-1')),
        HinderedRotor(inertia=(0.295496,'amu*angstrom^2'), symmetry=1, barrier=(6.79404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295477,'amu*angstrom^2'), symmetry=1, barrier=(6.7936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295517,'amu*angstrom^2'), symmetry=1, barrier=(6.79452,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0830114,0.101173,-0.000195922,1.87306e-07,-6.71613e-11,-105102,30.956], Tmin=(100,'K'), Tmax=(854.689,'K')), NASAPolynomial(coeffs=[7.69626,0.0326702,-1.80055e-05,3.52917e-09,-2.42976e-13,-105203,2.44587], Tmin=(854.689,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-874.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(CCOJ) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = 'O[C](O)C(F)(F)[C](F)F(9356)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-895.379,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,215,315,519,588,595,1205,1248,360,370,350,190,488,555,1236,1407,223.234,223.65],'cm^-1')),
        HinderedRotor(inertia=(0.162471,'amu*angstrom^2'), symmetry=1, barrier=(5.77754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162086,'amu*angstrom^2'), symmetry=1, barrier=(5.77043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162647,'amu*angstrom^2'), symmetry=1, barrier=(5.77734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1626,'amu*angstrom^2'), symmetry=1, barrier=(5.77884,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.22745,0.10446,-0.000193271,1.73179e-07,-5.87991e-11,-107548,31.2059], Tmin=(100,'K'), Tmax=(858.661,'K')), NASAPolynomial(coeffs=[12.199,0.0239281,-1.30342e-05,2.53083e-09,-1.72865e-13,-108847,-21.9903], Tmin=(858.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-895.379,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + radical(Cs_P) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-1044.11,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,249,341,381,651,928,1217,1251,190,488,555,1236,1407,180,180,180,180,993.782,995.102],'cm^-1')),
        HinderedRotor(inertia=(0.142165,'amu*angstrom^2'), symmetry=1, barrier=(3.26865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0046675,'amu*angstrom^2'), symmetry=1, barrier=(3.27609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.35718,'amu*angstrom^2'), symmetry=1, barrier=(54.1962,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.686517,0.0802267,-0.000133162,1.17086e-07,-4.07339e-11,-125465,27.294], Tmin=(100,'K'), Tmax=(790.077,'K')), NASAPolynomial(coeffs=[9.66131,0.0261567,-1.41185e-05,2.80853e-09,-1.97797e-13,-126614,-12.1844], Tmin=(790.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1044.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdCsOs) + radical(Csj(Cs-F1sF1sCO)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OC(F)(F)C(F)F(3185)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF3(42)', 'O=C(O)[C]F(4999)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(43)', 'O=C(O)C(F)F(4291)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'O=C(O)C(F)(F)[C]F(5000)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'O=C(O)C(F)(F)F(4903)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CO2(14)', 'FC(F)C(F)F(3616)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(482)', 'O=C=C(F)C(F)F(5474)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OC(OF)=C(F)C(F)F(5479)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OC(OC(F)F)=C(F)F(9353)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C([O])C(F)(F)C(F)F(9354)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O)C(F)(F)[C](F)F(9355)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](O)C(F)(F)[C](F)F(9356)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)[C](F)C(F)F(8443)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=C(O)C(F)(F)[CH]F(5008)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'O=[C]C(F)(F)C(F)F(7052)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)C(F)(F)C(F)F(9357)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF2(82)', 'O=C(O)[C](F)F(4068)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]O(338)', 'CHF2-CF2(69)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C(F)(F)[C](F)F(9358)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(78)', 'O=C(O)C(F)=CF(345)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(O)C(F)=C(F)F(4085)'],
    products = ['O=C(O)C(F)(F)C(F)F(5384)'],
