...
"""),
    E0 = (-695.168,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,197,221,431,657,2120,512.5,787.5,180,980.204,1336.26],'cm^-1')),
        HinderedRotor(inertia=(1.68517,'amu*angstrom^2'), symmetry=1, barrier=(38.7454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68219,'amu*angstrom^2'), symmetry=1, barrier=(38.6769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.349001,'amu*angstrom^2'), symmetry=1, barrier=(8.02423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68306,'amu*angstrom^2'), symmetry=1, barrier=(38.6969,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-343.352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,197,221,431,657,617,898,1187,2120,512.5,787.5,180,869.111],'cm^-1')),
        HinderedRotor(inertia=(0.304734,'amu*angstrom^2'), symmetry=1, barrier=(7.00643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79529,'amu*angstrom^2'), symmetry=1, barrier=(41.2773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79739,'amu*angstrom^2'), symmetry=1, barrier=(41.3255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79585,'amu*angstrom^2'), symmetry=1, barrier=(41.2902,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.125253,0.0948217,-0.000162098,1.46731e-07,-5.2502e-11,-41165.5,32.5773], Tmin=(100,'K'), Tmax=(781.86,'K')), NASAPolynomial(coeffs=[9.93683,0.0322055,-1.81402e-05,3.6658e-09,-2.60369e-13,-42320.1,-9.91576], Tmin=(781.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-343.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFHO) + group(Cd(Cdd-Od)FO) + group(CJ2_singlet-FCs) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3047.95,'J/mol'), sigma=(5.30435,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=476.08 K, Pc=46.34 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    molecularWeight = (156.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.124454,0.101255,-0.000168848,1.53403e-07,-5.51258e-11,-84730.2,32.7807], Tmin=(100,'K'), Tmax=(795.032,'K')), NASAPolynomial(coeffs=[9.16258,0.0386556,-2.07907e-05,4.13749e-09,-2.9158e-13,-85705.2,-6.73856], Tmin=(795.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-705.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-408.464,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1277.5,1000,487,638,688,1119,1325,1387,3149,334,575,1197,1424,3202,293,496,537,1218,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (156.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.637795,0.111819,-0.000186799,1.62598e-07,-5.59136e-11,-48969.3,36.8264], Tmin=(100,'K'), Tmax=(784.577,'K')), NASAPolynomial(coeffs=[12.8647,0.033309,-1.82122e-05,3.63894e-09,-2.56823e-13,-50790.4,-23.1428], Tmin=(784.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-408.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsOsH) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-297.69,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,197,221,431,657,2120,512.5,787.5,180,180,1673.27],'cm^-1')),
        HinderedRotor(inertia=(1.81415,'amu*angstrom^2'), symmetry=1, barrier=(41.7109,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175379,'amu*angstrom^2'), symmetry=1, barrier=(4.03231,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.020992,'amu*angstrom^2'), symmetry=1, barrier=(41.7287,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.31942,0.0917961,-0.000157091,1.46506e-07,-5.34129e-11,-35681.9,30.6956], Tmin=(100,'K'), Tmax=(811.517,'K')), NASAPolynomial(coeffs=[7.36438,0.0373554,-2.00212e-05,3.96489e-09,-2.78077e-13,-36176.1,2.17904], Tmin=(811.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]C(F)OOC(F)=C=O(6918)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-307.042,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,3000,3100,440,815,1455,1000,197,221,431,657,2120,512.5,787.5,2957,2957.42],'cm^-1')),
        HinderedRotor(inertia=(1.56282,'amu*angstrom^2'), symmetry=1, barrier=(35.9322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56281,'amu*angstrom^2'), symmetry=1, barrier=(35.9322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56301,'amu*angstrom^2'), symmetry=1, barrier=(35.9367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56288,'amu*angstrom^2'), symmetry=1, barrier=(35.9338,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (137.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.686178,0.0822772,-0.000112006,7.55838e-08,-1.60522e-11,-36818.3,30.3654], Tmin=(100,'K'), Tmax=(585.203,'K')), NASAPolynomial(coeffs=[9.54037,0.0337228,-1.82228e-05,3.68629e-09,-2.64483e-13,-38059.4,-9.35758], Tmin=(585.203,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-307.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFHO) + group(Cs-CsHHH) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(CJCOOH)"""),
)

species(
    label = 'O=C=[C]OOC(F)CF(6919)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-267.217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,1685,370,2120,512.5,787.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.7723,'amu*angstrom^2'), symmetry=1, barrier=(40.7487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.874203,'amu*angstrom^2'), symmetry=1, barrier=(20.0996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.486343,'amu*angstrom^2'), symmetry=1, barrier=(11.182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77072,'amu*angstrom^2'), symmetry=1, barrier=(40.7122,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (137.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.497426,0.0840641,-0.000121331,9.55232e-08,-3.06142e-11,-32019.1,31.2031], Tmin=(100,'K'), Tmax=(759.317,'K')), NASAPolynomial(coeffs=[10.5917,0.0308817,-1.62574e-05,3.25873e-09,-2.32804e-13,-33551.9,-14.7153], Tmin=(759.317,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-267.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-496.527,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,334,575,1197,1424,3202,197,221,431,657,2120,512.5,787.5,180,452.94,2046.79],'cm^-1')),
        HinderedRotor(inertia=(0.169948,'amu*angstrom^2'), symmetry=1, barrier=(3.90744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72496,'amu*angstrom^2'), symmetry=1, barrier=(39.6601,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72462,'amu*angstrom^2'), symmetry=1, barrier=(39.6523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72495,'amu*angstrom^2'), symmetry=1, barrier=(39.66,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (155.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.217509,0.102569,-0.000172695,1.53857e-07,-5.42693e-11,-59576,33.2203], Tmin=(100,'K'), Tmax=(782.128,'K')), NASAPolynomial(coeffs=[10.9696,0.0338213,-1.87277e-05,3.76338e-09,-2.66576e-13,-60973.1,-15.7465], Tmin=(782.128,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-496.527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'O=C(F)[C-]=[O+]OC(F)CF(6921)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (156.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.268983,0.10647,-0.000184001,1.71266e-07,-6.21345e-11,-77030.8,43.0407], Tmin=(100,'K'), Tmax=(814.529,'K')), NASAPolynomial(coeffs=[8.24067,0.0417186,-2.24719e-05,4.45016e-09,-3.11821e-13,-77655.4,8.40808], Tmin=(814.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-641.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (-152.378,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,197,221,431,657,2120,512.5,787.5,367.801,2361.88],'cm^-1')),
        HinderedRotor(inertia=(0.0854327,'amu*angstrom^2'), symmetry=1, barrier=(8.19994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334325,'amu*angstrom^2'), symmetry=1, barrier=(32.089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334341,'amu*angstrom^2'), symmetry=1, barrier=(32.0892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-337.584,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,326,540,652,719,1357,2950,3100,1380,975,1025,1650,197,221,431,657,2120,512.5,787.5,180,909.981],'cm^-1')),
        HinderedRotor(inertia=(0.0065575,'amu*angstrom^2'), symmetry=1, barrier=(3.87118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170755,'amu*angstrom^2'), symmetry=1, barrier=(3.926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164617,'amu*angstrom^2'), symmetry=1, barrier=(3.78487,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (136.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.790715,0.0815091,-0.000143205,1.38219e-07,-5.18043e-11,-40497,29.8603], Tmin=(100,'K'), Tmax=(810.709,'K')), NASAPolynomial(coeffs=[5.55457,0.0364259,-1.98654e-05,3.96159e-09,-2.78868e-13,-40560.3,12.2506], Tmin=(810.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-337.584,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(CdCFO) + group(Cds-CdsHH) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'O=C=C(F)OOC=CF(6924)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {6,S}
4  O u0 p2 c0 {3,S} {8,S}
...
"""),
    E0 = (-317.375,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,197,221,431,657,2120,512.5,787.5,180,1117.02],'cm^-1')),
        HinderedRotor(inertia=(0.216016,'amu*angstrom^2'), symmetry=1, barrier=(4.96664,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00561696,'amu*angstrom^2'), symmetry=1, barrier=(4.96663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.16227,'amu*angstrom^2'), symmetry=1, barrier=(49.7149,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (136.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6362,0.064548,-4.61371e-05,-7.01175e-08,1.0462e-10,-38099.5,27.1053], Tmin=(100,'K'), Tmax=(452.092,'K')), NASAPolynomial(coeffs=[7.97955,0.0321443,-1.7328e-05,3.45781e-09,-2.44184e-13,-38915.5,-1.14294], Tmin=(452.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-317.375,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + missing(O2d-Cdd) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cd(Cdd-Od)FO) + missing(Cdd-CdO2d)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C=C(F)OOC(F)CF(6218)'],
    products = ['O=CC(=O)F(335)', 'O=C(F)CF(879)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(16.6358,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['O=C=C(F)OO(2244)', 'F[C]CF(126)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'O=C=C(F)OOCF(1903)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'O=C=C(F)OOC(F)[C]F(6913)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'O=C=C(F)OOC(F)F(6206)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C=C(F)OOC(F)CF(6218)'],
    products = ['O=C=C(F)OOCC(F)F(6914)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['O[C]=C(F)OOC(F)[CH]F(6916)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=C=C(F)OO[CH]CF(6917)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C(F)OOC(F)=C=O(6918)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=C=[C]OOC(F)CF(6919)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=C=[C]F(289)', '[O]OC(F)CF(2682)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2F(46)', 'O=C=C(F)OO[CH]F(1938)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=C=C(F)OOC(F)[CH]F(6920)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(F)[C-]=[O+]OC(F)CF(6921)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'C=COOC(F)=C=O(6922)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'C=C(F)OOC(F)=C=O(6923)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'O=C=C(F)OOC=CF(6924)'],
    products = ['O=C=C(F)OOC(F)CF(6218)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O=C=C(F)OOC(F)CF(6218)'],
    products = ['CO(13)', 'F[C-]=[O+]OC(F)CF(3358)'],
