...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C[C]=O(4906)'],
    products = ['O=[C]CO[C]=O(6506)'],
    transitionState = 'TS2',
