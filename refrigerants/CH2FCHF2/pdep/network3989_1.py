...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O[C-]=[O+]F(14130)'],
    products = ['O=C(F)[O+]=[C-]O(14084)'],
    transitionState = 'TS2',
