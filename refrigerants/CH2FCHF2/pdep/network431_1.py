...
reaction(
    label = 'reaction2',
    reactants = ['[O]CC[C](F)F(2665)'],
    products = ['[CH2]C(F)(F)C[O](2664)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C[C](F)F(230)'],
    products = ['[CH2]C(F)(F)C[O](2664)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([CH2])(F)F(194)'],
    products = ['[CH2]C(F)(F)C[O](2664)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](2653)', 'CH2CF2(57)'],
    products = ['[CH2]C(F)(F)C[O](2664)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C=O(432)'],
    products = ['[CH2]C(F)(F)C[O](2664)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](2653)', '[CH2][C](F)F(163)'],
    products = ['[CH2]C(F)(F)C[O](2664)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(F)=C[O](434)'],
    products = ['[CH2]C(F)(F)C[O](2664)'],
