...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.745712,0.0632166,-4.99631e-05,1.89479e-08,-2.84212e-12,-116243,24.8662], Tmin=(100,'K'), Tmax=(1581,'K')), NASAPolynomial(coeffs=[17.7539,0.0201854,-9.13689e-06,1.73273e-09,-1.1994e-13,-121621,-64.9794], Tmin=(1581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-967.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(Cs-O2s-Cs-Cs(F)(F))"""),
)
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.32475,0.0876205,-0.00013087,1.08217e-07,-3.62796e-11,-119756,27.6088], Tmin=(100,'K'), Tmax=(746.53,'K')), NASAPolynomial(coeffs=[10.4286,0.0320165,-1.61987e-05,3.1825e-09,-2.2413e-13,-121223,-17.9092], Tmin=(746.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-996.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(CdCFF)"""),
)
...
"""),
    E0 = (-559.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,323,467,575,827,1418,180,180,2794.64],'cm^-1')),
        HinderedRotor(inertia=(0.0870506,'amu*angstrom^2'), symmetry=1, barrier=(2.00147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0863175,'amu*angstrom^2'), symmetry=1, barrier=(1.98461,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23688,0.070166,-0.000113282,1.09912e-07,-4.19783e-11,-67237.6,26.3614], Tmin=(100,'K'), Tmax=(811.23,'K')), NASAPolynomial(coeffs=[3.6371,0.0390254,-2.00046e-05,3.92141e-09,-2.74373e-13,-66991.8,19.1991], Tmin=(811.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-559.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(CsCFFH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-771.047,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,180,180,2291.87],'cm^-1')),
        HinderedRotor(inertia=(0.174828,'amu*angstrom^2'), symmetry=1, barrier=(4.01965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176192,'amu*angstrom^2'), symmetry=1, barrier=(4.051,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.582432,0.0862199,-0.000148431,1.40982e-07,-5.20551e-11,-92623.2,27.537], Tmin=(100,'K'), Tmax=(818.265,'K')), NASAPolynomial(coeffs=[6.01528,0.0379336,-2.00837e-05,3.96099e-09,-2.77089e-13,-92784.9,6.86121], Tmin=(818.265,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-771.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFF) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(CCOJ)"""),
)
...
species(
    label = 'O[CH]C(F)(F)[CH]C(F)F(7566)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-773.61,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,215,315,519,588,595,1205,1248,522,611,926,1093,1137,1374,1416,3112,3000,3050,390,425,1340,1360,335,370,197.476,197.479,197.494],'cm^-1')),
        HinderedRotor(inertia=(0.189096,'amu*angstrom^2'), symmetry=1, barrier=(5.23376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0089381,'amu*angstrom^2'), symmetry=1, barrier=(33.1346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188897,'amu*angstrom^2'), symmetry=1, barrier=(5.23398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00893812,'amu*angstrom^2'), symmetry=1, barrier=(33.1345,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.402308,0.0866598,-0.000131607,1.13649e-07,-4.00064e-11,-92921.4,32.6411], Tmin=(100,'K'), Tmax=(753.455,'K')), NASAPolynomial(coeffs=[9.02743,0.0353156,-1.83316e-05,3.63664e-09,-2.5738e-13,-94063.4,-5.48214], Tmin=(753.455,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-773.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)

species(
    label = '[O]CC(F)(F)C[C](F)F(7567)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0806248,0.101919,-0.000189161,1.84629e-07,-6.81785e-11,-87969.9,29.9733], Tmin=(100,'K'), Tmax=(843.104,'K')), NASAPolynomial(coeffs=[5.15441,0.0431929,-2.30237e-05,4.50732e-09,-3.12123e-13,-87593.8,13.6655], Tmin=(843.104,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-732.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CCOJ) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[O][CH]C(F)(F)CC(F)F(7568)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.460526,0.0890048,-0.000148417,1.41635e-07,-5.32108e-11,-90750.2,30.1909], Tmin=(100,'K'), Tmax=(803.17,'K')), NASAPolynomial(coeffs=[5.47594,0.0428665,-2.27307e-05,4.5071e-09,-3.17128e-13,-90873.3,11.3425], Tmin=(803.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-755.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)

species(
    label = 'OCC(F)(F)[CH][C](F)F(7569)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0285023,0.100228,-0.00017489,1.60272e-07,-5.66492e-11,-90139,32.6026], Tmin=(100,'K'), Tmax=(835.96,'K')), NASAPolynomial(coeffs=[8.87018,0.0353451,-1.84458e-05,3.59329e-09,-2.48676e-13,-90847.4,-4.07267], Tmin=(835.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-750.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'FOC[C](F)[CH]C(F)F(7570)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-396.426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,3025,407.5,1350,352.5,182.998,185.962,187.494,1881.41],'cm^-1')),
        HinderedRotor(inertia=(0.190256,'amu*angstrom^2'), symmetry=1, barrier=(4.60212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190903,'amu*angstrom^2'), symmetry=1, barrier=(4.58392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190453,'amu*angstrom^2'), symmetry=1, barrier=(4.58517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44633,'amu*angstrom^2'), symmetry=1, barrier=(35.5919,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.139765,0.0965159,-0.000166005,1.55291e-07,-5.66284e-11,-47551.3,33.2412], Tmin=(100,'K'), Tmax=(814.853,'K')), NASAPolynomial(coeffs=[7.40223,0.0392964,-2.09696e-05,4.14708e-09,-2.90541e-13,-48018.8,4.0849], Tmin=(814.853,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-396.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(H))"""),
)

species(
    label = '[O]C[C](F)C(F)C(F)F(7571)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-688.298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,235,523,627,1123,1142,1372,1406,3097,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,180,180,180,1196.5],'cm^-1')),
        HinderedRotor(inertia=(0.2001,'amu*angstrom^2'), symmetry=1, barrier=(4.60069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199858,'amu*angstrom^2'), symmetry=1, barrier=(4.59513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199766,'amu*angstrom^2'), symmetry=1, barrier=(4.59301,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.200767,0.0970119,-0.00017226,1.64733e-07,-6.0345e-11,-82659.3,31.1693], Tmin=(100,'K'), Tmax=(837.096,'K')), NASAPolynomial(coeffs=[5.88817,0.0414042,-2.16705e-05,4.22923e-09,-2.93093e-13,-82615.4,10.692], Tmin=(837.096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-688.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CCOJ) + radical(CsCsCsF1s)"""),
)

species(
    label = 'F[CH][CH]C(F)(F)COF(7572)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-408.214,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,334,575,1197,1424,3202,230.873,230.889,230.898,1973.61],'cm^-1')),
        HinderedRotor(inertia=(0.14786,'amu*angstrom^2'), symmetry=1, barrier=(5.59674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147934,'amu*angstrom^2'), symmetry=1, barrier=(5.59723,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147914,'amu*angstrom^2'), symmetry=1, barrier=(5.59552,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.942985,'amu*angstrom^2'), symmetry=1, barrier=(35.6175,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.269696,0.10704,-0.000191463,1.77605e-07,-6.32224e-11,-48955.8,31.9455], Tmin=(100,'K'), Tmax=(836.619,'K')), NASAPolynomial(coeffs=[8.93333,0.0371756,-1.98294e-05,3.88563e-09,-2.69432e-13,-49590.5,-5.40258], Tmin=(836.619,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-408.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[O]CC(F)(F)C(F)[CH]F(7573)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-696.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,259,529,569,1128,1321,1390,3140,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,180,180,180,2237.11],'cm^-1')),
        HinderedRotor(inertia=(0.30453,'amu*angstrom^2'), symmetry=1, barrier=(7.00176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67878,'amu*angstrom^2'), symmetry=1, barrier=(38.5986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302547,'amu*angstrom^2'), symmetry=1, barrier=(6.95616,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.145622,0.104674,-0.000187249,1.75626e-07,-6.31185e-11,-83689.9,29.8992], Tmin=(100,'K'), Tmax=(838.113,'K')), NASAPolynomial(coeffs=[7.85366,0.0390464,-2.0666e-05,4.0406e-09,-2.79928e-13,-84066.7,-1.52853], Tmin=(838.113,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-696.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CCOJ) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[O]CC([C](F)F)C(F)F(7112)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C(F)F-2(3493)', '[O]C[C](F)F(230)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]CC(F)=CC(F)F(7563)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CC(F)(F)[CH]C(F)F(7474)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]CC(F)(F)C=CF(7564)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]CC(F)(F)C=C(F)F(7565)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C=C(F)[CH]C(F)F(7477)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[CH]C(F)(F)[CH]C(F)F(7566)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
    products = ['[O]CC(F)(F)C[C](F)F(7567)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
    products = ['[O][CH]C(F)(F)CC(F)F(7568)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
    products = ['OCC(F)(F)[CH][C](F)F(7569)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FOC[C](F)[CH]C(F)F(7570)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C[C](F)C(F)C(F)F(7571)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH][CH]C(F)(F)COF(7572)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]CC(F)(F)C(F)[CH]F(7573)'],
    products = ['[O]CC(F)(F)[CH]C(F)F(7111)'],
...
network(
    label = 'PDepNetwork #1943',
    isomers = [
        '[O]CC(F)(F)[CH]C(F)F(7111)',
    ],
    reactants = [
