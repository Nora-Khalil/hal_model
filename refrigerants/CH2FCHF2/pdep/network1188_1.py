...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(1332)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])=O(4623)'],
    transitionState = 'TS2',
