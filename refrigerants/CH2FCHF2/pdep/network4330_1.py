...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC[O](2690)'],
    products = ['CC([O])C[O](15036)'],
    transitionState = 'TS2',
