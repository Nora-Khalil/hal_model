...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)O[C](F)F(2680)'],
...
reaction(
    ...
    products = ['F[CH]C(F)O[C](F)F(2680)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC=CO[C](F)F(2693)'],
    products = ['F[CH]C(F)O[C](F)F(2680)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC=C(F)O[C](F)F(2695)'],
    products = ['F[CH]C(F)O[C](F)F(2680)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(F)O[C](F)F(2680)'],
    products = ['F[C](F)O[CH]C(F)F(2698)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)O[C](F)F(2680)'],
    products = ['F[CH][CH]OC(F)(F)F(2699)'],
