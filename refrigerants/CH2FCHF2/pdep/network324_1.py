...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)O[CH]C(=O)F(1582)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=C(F)O[CH]C(=O)F(1582)'],
    products = ['O=C(F)C1C=C(F)O1(1840)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(F)O[CH]C(=O)F(1582)'],
    products = ['[CH]=C(F)OC1O[C]1F(1866)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CO[CH]C(=O)F(1867)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(1582)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=C(F)OC=C=O(1868)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(1582)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C(F)[CH]O[C]=CF(1815)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(1582)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(F)O[CH]C(=O)F(1582)'],
    products = ['[O][C](F)C1C=C(F)O1(1871)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(F)O[C]=C(O)F(1872)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(1582)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C(F)O[C]C(=O)F(1873)'],
    products = ['[CH]=C(F)O[CH]C(=O)F(1582)'],
