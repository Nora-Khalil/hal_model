...
species(
    label = 'F[CH]C(F)OC1(F)[CH]O1(1732)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-506.517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,501,1494,1531,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,194,682,905,1196,1383,3221,201.066,202.087,202.289],'cm^-1')),
        HinderedRotor(inertia=(1.28896,'amu*angstrom^2'), symmetry=1, barrier=(37.2718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29191,'amu*angstrom^2'), symmetry=1, barrier=(37.2744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28526,'amu*angstrom^2'), symmetry=1, barrier=(37.2725,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    ...
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'O=C[C](F)O[CH]F(1730)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=C[C](F)OC(F)[CH]F(1705)'],
    products = ['O=CC1(F)OC(F)C1F(1707)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C[C](F)OC(F)[CH]F(1705)'],
    products = ['F[CH]C(F)OC1(F)[CH]O1(1732)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['O=C[C](F)OC(F)[CH]F(1705)'],
    products = ['[O]C1[C](F)OC(F)C1F(1734)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=C[C](F)OC=CF(1735)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C[C](F)OC(F)=CF(1736)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C=C(F)OC(F)[CH]F(1737)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C[C]F-2(1738)', '[O]C(F)[CH]F(208)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', 'O=C[C](F)O[CH]F(1730)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C[C](F)OC(F)[CH]F(1705)'],
    products = ['O=C[C](F)O[C](F)CF(1739)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=CC(F)O[C](F)[CH]F(1741)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=CC(F)(F)O[CH][CH]F(1743)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C[C](F)OC(F)[CH]F(1705)'],
    products = ['O=C[C](F)O[CH]C(F)F(1744)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(C(=O)F)C(F)[CH]F(1702)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(6)', '[CH]=C(F)OC(F)[CH]F(1745)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O=C[C](F)OC(F)[CH]F(1705)'],
    products = ['[O][CH]C1(F)OC(F)C1F(1748)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O[C]=C(F)OC(F)[CH]F(1750)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction31',
    reactants = ['OC=C(F)O[C](F)[CH]F(1751)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction32',
    reactants = ['FC=CO[C](F)[CH]OF(1752)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction33',
    reactants = ['F[CH]C(F)O[C]=COF(1753)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[O]C=[C]OC(F)C(F)F(1754)'],
    products = ['O=C[C](F)OC(F)[CH]F(1705)'],
