...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0877823,0.0940608,-0.000143268,1.08094e-07,-3.04641e-11,-74600.5,30.196], Tmin=(100,'K'), Tmax=(664.551,'K')), NASAPolynomial(coeffs=[13.3316,0.0253868,-1.31828e-05,2.59664e-09,-1.82512e-13,-76604.5,-30.1202], Tmin=(664.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-621.373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFFH) + group(COCsFO) + radical(CCsJOCs) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.265277,0.0750904,-7.85629e-05,3.9433e-08,-7.67284e-12,-103713,27.7652], Tmin=(100,'K'), Tmax=(1258.79,'K')), NASAPolynomial(coeffs=[19.3056,0.0145856,-6.46274e-06,1.24739e-09,-8.89069e-14,-108506,-68.4753], Tmin=(1258.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-863.485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(COCsFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = 'F[C](F)COC1O[C]1F(1693)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.930769,'amu*angstrom^2'), symmetry=1, barrier=(21.4002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.93041,'amu*angstrom^2'), symmetry=1, barrier=(21.392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.928658,'amu*angstrom^2'), symmetry=1, barrier=(21.3517,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.182429,0.0789923,-9.82951e-05,5.79301e-08,-1.30246e-11,-50456.5,25.6128], Tmin=(100,'K'), Tmax=(1104.06,'K')), NASAPolynomial(coeffs=[19.4738,0.0090994,-3.33636e-06,5.90594e-10,-4.06845e-14,-54716.2,-69.3663], Tmin=(1104.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-420.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
species(
    label = 'O=C(F)[CH]O[CH]C(F)F(1623)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0574752,0.0951031,-0.000157969,1.37244e-07,-4.68328e-11,-73930.6,31.447], Tmin=(100,'K'), Tmax=(808.687,'K')), NASAPolynomial(coeffs=[11.2421,0.0289531,-1.51873e-05,2.98104e-09,-2.0802e-13,-75385.5,-17.9486], Tmin=(808.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-615.807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFFH) + group(COCsFO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C]C(F)OC[C](F)F(1679)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-299.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,3010,987.5,1337.5,450,1655,167,640,1190,232.642,233.004,233.635,234.383],'cm^-1')),
        HinderedRotor(inertia=(0.473018,'amu*angstrom^2'), symmetry=1, barrier=(18.3674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477757,'amu*angstrom^2'), symmetry=1, barrier=(18.3608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.476805,'amu*angstrom^2'), symmetry=1, barrier=(18.3626,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.416107,0.08236,-0.000114902,7.95995e-08,-2.15839e-11,-35885.4,25.9463], Tmin=(100,'K'), Tmax=(906.498,'K')), NASAPolynomial(coeffs=[14.9176,0.0183839,-9.06092e-06,1.77715e-09,-1.2596e-13,-38515,-42.5947], Tmin=(906.498,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)

species(
    label = 'FC1=COCC(F)(F)O1(1701)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0899498,0.0949599,-0.000138332,9.99336e-08,-2.82506e-11,-62499.9,30.9445], Tmin=(100,'K'), Tmax=(870.426,'K')), NASAPolynomial(coeffs=[16.041,0.0208304,-1.05841e-05,2.09006e-09,-1.48183e-13,-65308,-44.6393], Tmin=(870.426,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-520.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(C=CJO)"""),
)

species(
    label = '[O]C(F)=[C]OCC(F)F(1705)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-581.846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,293,496,537,1218,1685,370,372.976,372.979,372.979,372.98,372.982,1271.77],'cm^-1')),
        HinderedRotor(inertia=(0.150273,'amu*angstrom^2'), symmetry=1, barrier=(14.8346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109632,'amu*angstrom^2'), symmetry=1, barrier=(10.8227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334909,'amu*angstrom^2'), symmetry=1, barrier=(33.0621,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.513861,0.0825445,-0.000108175,7.38068e-08,-2.02832e-11,-69859.4,29.3563], Tmin=(100,'K'), Tmax=(883.552,'K')), NASAPolynomial(coeffs=[12.7498,0.0271497,-1.41308e-05,2.84738e-09,-2.05142e-13,-72021.6,-28.1601], Tmin=(883.552,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = 'OC(F)=CO[CH][C](F)F(1706)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.923298,'amu*angstrom^2'), symmetry=1, barrier=(21.2284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.92702,'amu*angstrom^2'), symmetry=1, barrier=(21.314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.92297,'amu*angstrom^2'), symmetry=1, barrier=(21.2209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.923795,'amu*angstrom^2'), symmetry=1, barrier=(21.2399,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.817924,0.104505,-0.000145562,9.38827e-08,-2.30323e-11,-67978.3,30.5865], Tmin=(100,'K'), Tmax=(1012.78,'K')), NASAPolynomial(coeffs=[23.3506,0.00904886,-4.18056e-06,8.15381e-10,-5.85314e-14,-72873.7,-86.319], Tmin=(1012.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-566.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'FO[C]=COC[C](F)F(1707)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC[C](F)F(1573)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(323)', '[O]C[C](F)F(230)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]O[CH]C(=O)F(1691)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)[CH]OC[C](F)F(1573)'],
    products = ['F[C](F)COC1O[C]1F(1693)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)[CH]OC[C](F)F(1573)'],
    products = ['F[C]1[CH]OCC(F)(F)O1(1694)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)[CH]OC[C](F)F(1573)'],
    products = ['[O]C1(F)[CH]OCC1(F)F(1695)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(F)[CH]OC=C(F)F(1696)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C=COC[C](F)F(1697)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]O[CH]C(=O)F(1691)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]OC[C](F)F(1573)'],
    products = ['O=C(F)[CH]O[CH]C(F)F(1623)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(F)CO[CH][C](F)F(1698)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]C(F)OC[C](F)F(1679)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)C[C](F)F(1572)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(6)', 'F[C]=COC[C](F)F(1700)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(F)[CH]OC[C](F)F(1573)'],
    products = ['[O][C](F)C1OCC1(F)F(1703)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C=[C]OC[C](F)F(1686)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)=[C]OC[C](F)F(1704)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)=[C]OCC(F)F(1705)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
...
reaction(
    label = 'reaction27',
    reactants = ['OC(F)=CO[CH][C](F)F(1706)'],
    products = ['O=C(F)[CH]OC[C](F)F(1573)'],
