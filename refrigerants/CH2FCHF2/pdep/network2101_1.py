...
species(
    label = '[CH]C(F)(F)OC(O)(F)F-2(7954)',
...
species(
    label = 'OC(F)(F)OC(F)(F)[C]F-2(7955)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1154.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,90,150,250,247,323,377,431,433,1065,1274,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.15452,0.0990955,-0.000158123,1.25893e-07,-3.94864e-11,-138715,28.5657], Tmin=(100,'K'), Tmax=(783.712,'K')), NASAPolynomial(coeffs=[14.6693,0.0234373,-1.33191e-05,2.71761e-09,-1.94947e-13,-141039,-39.3384], Tmin=(783.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1154.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsFFOO) + radical(CsCCl_triplet)"""),
)
...
species(
    label = '[O]C(F)(F)OC(F)(F)[CH]F(7957)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1057.93,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,375,486,586,623,710,938,1161,1294,334,575,1197,1424,3202,246.612,246.615,246.626,246.665],'cm^-1')),
        HinderedRotor(inertia=(0.446877,'amu*angstrom^2'), symmetry=1, barrier=(19.295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174177,'amu*angstrom^2'), symmetry=1, barrier=(7.52218,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.962488,'amu*angstrom^2'), symmetry=1, barrier=(41.564,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0603233,0.0922704,-0.000131139,9.1661e-08,-2.5182e-11,-127102,29.2467], Tmin=(100,'K'), Tmax=(892.548,'K')), NASAPolynomial(coeffs=[15.9313,0.0211422,-1.15997e-05,2.37213e-09,-1.71905e-13,-129935,-45.5172], Tmin=(892.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1057.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)

species(
    label = 'O=C(F)OC(F)(F)[CH]F(7958)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1058.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,334,575,1197,1424,3202,482,664,788,1296,1923,180,180,599.06,618.351],'cm^-1')),
        HinderedRotor(inertia=(0.441647,'amu*angstrom^2'), symmetry=1, barrier=(35.4533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.619457,'amu*angstrom^2'), symmetry=1, barrier=(14.2425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54697,'amu*angstrom^2'), symmetry=1, barrier=(35.5679,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.860612,0.0728063,-9.1781e-05,5.71397e-08,-1.41109e-11,-127249,25.4435], Tmin=(100,'K'), Tmax=(984.85,'K')), NASAPolynomial(coeffs=[13.984,0.0195034,-1.0594e-05,2.18069e-09,-1.59371e-13,-129834,-37.6686], Tmin=(984.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1058.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(COFOO) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)
...
"""),
    E0 = (-1297.67,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,223,363,546,575,694,1179,1410,235,523,627,1123,1142,1372,1406,3097,482,586,761,1411,351.533,354.451,357.677,359.146],'cm^-1')),
        HinderedRotor(inertia=(0.100652,'amu*angstrom^2'), symmetry=1, barrier=(9.14373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103752,'amu*angstrom^2'), symmetry=1, barrier=(9.14896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277451,'amu*angstrom^2'), symmetry=1, barrier=(24.1466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471749,'amu*angstrom^2'), symmetry=1, barrier=(41.4746,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.10986,0.0901542,-0.000119078,7.81446e-08,-2.02558e-11,-155938,30.402], Tmin=(100,'K'), Tmax=(942.544,'K')), NASAPolynomial(coeffs=[15.9575,0.0229002,-1.20489e-05,2.44276e-09,-1.76847e-13,-158925,-45.1159], Tmin=(942.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1297.67,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsFHOO) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'OC(F)(F)O[C](F)F(5042)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'OC(F)(F)OC(F)(F)[C]F-2(7955)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)(F)OC(F)=CF(3376)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(6.40718,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'OC(F)(F)O[C](F)[CH]F(3413)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O[C](F)OC(F)(F)[CH]F(7956)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'F[CH]C(F)(F)O[C](F)F(3683)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)(F)[CH]F(7957)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)OC(F)(F)[CH]F(7958)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', 'OC(F)(F)O[C](F)F(5042)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'OC(F)(F)OC(F)(F)[C]F(5250)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)(F)OC(F)(F)CF(5257)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OC(F)(F)O[C](F)C(F)F(7959)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O[C](F)OC(F)(F)C(F)F(7960)'],
    products = ['OC(F)(F)OC(F)(F)[CH]F(5258)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(9.39758e+07,'s^-1'), n=1.42748, Ea=(186.385,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F
Multiplied by reaction path degeneracy 2.0"""),
)
