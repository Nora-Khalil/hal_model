...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C](F)F(2569)'],
...
reaction(
    ...
    products = ['[CH2]C(F)(F)O[C](F)F(2569)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[C](F)O[C](F)F(2625)'],
    products = ['[CH2]C(F)(F)O[C](F)F(2569)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)O[C](F)F(2626)'],
    products = ['[CH2]C(F)(F)O[C](F)F(2569)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(F)(F)O[C](F)F(2569)'],
    products = ['[CH2][C](F)OC(F)(F)F(2627)'],
