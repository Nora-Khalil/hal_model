...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.587179,0.0815924,-0.000111257,8.18286e-08,-2.44904e-11,-30984.9,24.9491], Tmin=(100,'K'), Tmax=(811.042,'K')), NASAPolynomial(coeffs=[11.0865,0.0298091,-1.54818e-05,3.10036e-09,-2.21993e-13,-32687.9,-23.5046], Tmin=(811.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.786255,'amu*angstrom^2'), symmetry=1, barrier=(18.0775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.786189,'amu*angstrom^2'), symmetry=1, barrier=(18.076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56367,'amu*angstrom^2'), symmetry=1, barrier=(35.9517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5636,'amu*angstrom^2'), symmetry=1, barrier=(35.9502,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.357932,0.0892421,-0.000147489,1.3366e-07,-4.80951e-11,-11145.7,26.4439], Tmin=(100,'K'), Tmax=(789.257,'K')), NASAPolynomial(coeffs=[8.56972,0.0345111,-1.85501e-05,3.69709e-09,-2.60986e-13,-12033.5,-8.64233], Tmin=(789.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.6877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF(126)', 'C#COO(6893)'],
    products = ['C#COOC(F)CF(3356)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'C#COOC(F)[C]F(8257)'],
    products = ['C#COOC(F)CF(3356)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'C#COOC(F)F(3483)'],
    products = ['C#COOC(F)CF(3356)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#COO[CH]CF(8259)'],
    products = ['C#COOC(F)CF(3356)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#COOC([CH2])F(8260)'],
    products = ['C#COOC(F)CF(3356)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HCCO(21)', '[O]C(F)CF(2775)'],
    products = ['C#COOC(F)CF(3356)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C#CO[O](302)', 'CH2F-CHF(66)'],
    products = ['C#COOC(F)CF(3356)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H(22)', '[O]OC(F)CF(2682)'],
    products = ['C#COOC(F)CF(3356)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2F(46)', 'C#COO[CH]F(6895)'],
    products = ['C#COOC(F)CF(3356)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#COOC(F)[CH]F(4786)'],
    products = ['C#COOC(F)CF(3356)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[C]#COOC(F)CF(8261)'],
    products = ['C#COOC(F)CF(3356)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C#COOC(=C)F(8264)'],
    products = ['C#COOC(F)CF(3356)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COOC=CF(8265)'],
    products = ['C#COOC(F)CF(3356)'],
