...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(441)', 'F[C]CF-2(3036)'],
    products = ['[O]C(F)O[C](F)CF(3312)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)OC([O])F(3341)'],
    products = ['[O]C(F)O[C](F)CF(3312)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)OC(F)=CF(3342)'],
    products = ['[O]C(F)O[C](F)CF(3312)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CO[C](F)CF(3257)'],
    products = ['[O]C(F)O[C](F)CF(3312)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[C](F)CF(3217)'],
    products = ['[O]C(F)O[C](F)CF(3312)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C([O])F(441)', 'F[C]CF(126)'],
    products = ['[O]C(F)O[C](F)CF(3312)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)OC(F)[CH]F(3343)'],
    products = ['[O]C(F)O[C](F)CF(3312)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C](F)OC(F)OF(3347)'],
    products = ['[O]C(F)O[C](F)CF(3312)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)O[C](F)CF(3312)'],
    products = ['[CH2]C(F)(F)OC([O])F(3348)'],
