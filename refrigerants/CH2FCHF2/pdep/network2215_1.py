...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[O]C[C]=O(4676)'],
    products = ['O=[C]CO[CH]F(8345)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', '[CH2]O[CH]F(410)'],
    products = ['O=[C]CO[CH]F(8345)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[CH]F(410)'],
    products = ['O=[C]CO[CH]F(8345)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[CH]F(8350)'],
    products = ['O=[C]CO[CH]F(8345)'],
    transitionState = 'TS9',
