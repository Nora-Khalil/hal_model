...
species(
    label = '[CH]=C(F)C(F)(F)C(=[CH])F(10108)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF-2(3543)', '[CH]C(F)=C(F)F(296)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=C(F)C(F)=C=CF(10100)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CC(F)(F)[C]=CF(10101)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=C(F)C(F)(F)C#C(10102)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]=C(F)C(F)(F)C#CF(10103)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[CH]=C=C(F)[C]=CF(10104)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
    products = ['C=C(F)C(F)(F)[C]=[C]F(10105)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
    products = ['[CH]C(F)=C(F)C(F)=CF(10106)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
    products = ['F[CH]C(F)=C(F)[C]=CF(9845)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]C(F)(F)C(F)=CF(10107)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(F)C(F)(F)C(=[CH])F(10108)'],
    products = ['[CH]=C(F)C(F)(F)[C]=CF(9741)'],
