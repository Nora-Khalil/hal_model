...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[O]C(F)(F)OO(2903)'],
    products = ['OOC(F)(F)OF(9780)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OH(7)', '[O]C(F)(F)OF(5153)'],
    products = ['OOC(F)(F)OF(9780)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['HO2(11)', 'FO[C](F)F(2677)'],
    products = ['OOC(F)(F)OF(9780)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', '[O]OC(F)(F)OF(9809)'],
    products = ['OOC(F)(F)OF(9780)'],
    transitionState = 'TS5',
