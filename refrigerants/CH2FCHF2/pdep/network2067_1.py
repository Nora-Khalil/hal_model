...
"""),
    ...
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.387264,0.0818184,-0.000105151,6.58653e-08,-1.61553e-11,-75201.1,26.1247], Tmin=(100,'K'), Tmax=(998.454,'K')), NASAPolynomial(coeffs=[16.3079,0.0180386,-9.33499e-06,1.89046e-09,-1.37178e-13,-78380.4,-50.6587], Tmin=(998.454,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-626.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CdCFO) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (78.6452,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,326,540,652,719,1357,180],'cm^-1')),
        HinderedRotor(inertia=(0.122138,'amu*angstrom^2'), symmetry=1, barrier=(2.8082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121933,'amu*angstrom^2'), symmetry=1, barrier=(2.80349,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.60736,'amu*angstrom^2'), symmetry=1, barrier=(59.9483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.598373,0.0875392,-0.000164971,1.60246e-07,-5.92895e-11,9568.99,30.559], Tmin=(100,'K'), Tmax=(826.487,'K')), NASAPolynomial(coeffs=[6.3023,0.0335131,-1.89673e-05,3.79751e-09,-2.66472e-13,9528.51,9.58687], Tmin=(826.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.6452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-CdsHH) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'FC1=CC(F)(F)[CH]OO1(7726)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40224,0.0617722,-7.14471e-05,4.8864e-08,-1.419e-11,-55732.1,19.8562], Tmin=(100,'K'), Tmax=(822.135,'K')), NASAPolynomial(coeffs=[7.79245,0.0306815,-1.47218e-05,2.86578e-09,-2.02593e-13,-56782.9,-9.72133], Tmin=(822.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-464.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCCFF) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(CdCFO) + ring(34dihydro12dioxin) + radical(CCsJOOC)"""),
)

species(
    label = 'F[C](F)C1C=C(F)OO1(7727)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44393,0.0579318,-5.19796e-05,2.27886e-08,-4.06415e-12,-51610.2,26.4788], Tmin=(100,'K'), Tmax=(1308.24,'K')), NASAPolynomial(coeffs=[12.8306,0.0231165,-1.20611e-05,2.44639e-09,-1.7682e-13,-54589.5,-31.5146], Tmin=(1308.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-429.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFO) + ring(12dioxolene) + radical(CsCsF1sF1s)"""),
)
...
"""),
    E0 = (192.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,1685,370,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.213242,'amu*angstrom^2'), symmetry=1, barrier=(4.90285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417436,'amu*angstrom^2'), symmetry=1, barrier=(9.59767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.08682,'amu*angstrom^2'), symmetry=1, barrier=(47.9801,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
...
"""),
    E0 = (22.7384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,293,496,537,1218,562,600,623,1070,1265,1685,370,3120,650,792.5,1650,180,1094.83],'cm^-1')),
        HinderedRotor(inertia=(0.235867,'amu*angstrom^2'), symmetry=1, barrier=(5.42305,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235875,'amu*angstrom^2'), symmetry=1, barrier=(5.42322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23725,'amu*angstrom^2'), symmetry=1, barrier=(5.45485,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.679417,0.0881452,-0.000173737,1.73838e-07,-6.51097e-11,2839.75,33.1307], Tmin=(100,'K'), Tmax=(840.501,'K')), NASAPolynomial(coeffs=[4.4294,0.0362687,-2.04242e-05,4.06232e-09,-2.83163e-13,3411.39,22.8414], Tmin=(840.501,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.7384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (272.142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,293,496,537,1218,3120,650,792.5,1650,2175,525,239,401,1367,180],'cm^-1')),
        HinderedRotor(inertia=(0.436749,'amu*angstrom^2'), symmetry=1, barrier=(10.0417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0259588,'amu*angstrom^2'), symmetry=1, barrier=(37.7967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64773,'amu*angstrom^2'), symmetry=1, barrier=(37.8846,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.863394,0.0793808,-0.000147415,1.40491e-07,-5.14648e-11,32834,26.7343], Tmin=(100,'K'), Tmax=(815.089,'K')), NASAPolynomial(coeffs=[7.34298,0.0277867,-1.60371e-05,3.239e-09,-2.28649e-13,32435.3,0.832765], Tmin=(815.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsCt) + group(CdCFO) + group(Cds-CdsHH) + group(Ct-CtOs) + group(CtCF) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = 'C=C(F)OO[C]=C(F)F(7733)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.856565,0.0827945,-0.000154298,1.55289e-07,-5.92872e-11,-28730.9,32.3823], Tmin=(100,'K'), Tmax=(827.769,'K')), NASAPolynomial(coeffs=[3.37935,0.040198,-2.20108e-05,4.3727e-09,-3.06155e-13,-28106.8,26.9804], Tmin=(827.769,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-239.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)OOC=C(F)F(7721)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(F)OOC=C(F)F(7721)'],
    products = ['[CH]=C(F)OC(F)(F)C=O(7724)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[C]=C(F)OOC=C(F)F(7725)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(F)OOC=C(F)F(7721)'],
    products = ['FC1=CC(F)(F)[CH]OO1(7726)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=C(F)OOC=C(F)F(7721)'],
    products = ['F[C](F)C1C=C(F)OO1(7727)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C#COOC=C(F)F(7728)'],
    products = ['[CH]=C(F)OOC=C(F)F(7721)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=[C]OOC=C(F)F(7730)'],
    products = ['[CH]=C(F)OOC=C(F)F(7721)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C(=O)F(7689)', 'O=C[C](F)F(234)'],
    products = ['[CH]=C(F)OOC=C(F)F(7721)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(183.377,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CF2CH(73)', '[CH]=C(F)O[O](238)'],
    products = ['[CH]=C(F)OOC=C(F)F(7721)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH]=C(F)OO[C]=C(F)F(7731)'],
    products = ['[CH]=C(F)OOC=C(F)F(7721)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH]=C(F)OOC#CF(7732)'],
    products = ['[CH]=C(F)OOC=C(F)F(7721)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(F)OOC=C(F)F(7721)'],
    products = ['C=C(F)OO[C]=C(F)F(7733)'],
