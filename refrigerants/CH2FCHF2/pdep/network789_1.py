...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[O]O[CH]F(209)'],
    products = ['[O]OC(F)[C](F)F(3626)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)=C(F)F(3744)'],
    products = ['[O]OC(F)[C](F)F(3626)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC(F)[C](F)F(3626)'],
    products = ['OH(7)', 'O=C(F)[C](F)F(3745)'],
