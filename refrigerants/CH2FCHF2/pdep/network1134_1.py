...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC[C](F)F(2551)'],
    products = ['CC([O])C[C](F)F(4408)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C[CH]C[C](F)F(4476)'],
    products = ['CC([O])C[C](F)F(4408)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(156)', '[CH2]C(C)[O](4477)'],
    products = ['CC([O])C[C](F)F(4408)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'O=CC[C](F)F(418)'],
    products = ['CC([O])C[C](F)F(4408)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(=O)C[C](F)F(4480)'],
    products = ['CC([O])C[C](F)F(4408)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'CC([O])C=C(F)F(4481)'],
    products = ['CC([O])C[C](F)F(4408)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C(C)[O](4477)'],
    products = ['CC([O])C[C](F)F(4408)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(O)C[C](F)F(4484)'],
    products = ['CC([O])C[C](F)F(4408)'],
