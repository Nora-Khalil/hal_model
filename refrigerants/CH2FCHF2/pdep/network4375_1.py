...
species(
    label = 'OC(F)([CH]F)C(F)(F)COF(15281)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[CH]C(O)(F)C(F)(CF)OF(15283)',
...
"""),
    E0 = (-553.708,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,318,348,354,414,366,530,521,695,1154,1354,1414,1546,528,1116,1182,1331,1402,1494,3075,3110,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OC(F)([C]F)C(F)(CF)OF-2(15284)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-805.512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,318,348,354,414,366,530,521,695,1154,1354,1414,1546,528,1116,1182,1331,1402,1494,3075,3110,90,150,250,247,323,377,431,433,1065,1274],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05482,0.119588,-0.000172223,1.23266e-07,-3.48533e-11,-96706,32.0549], Tmin=(100,'K'), Tmax=(865.98,'K')), NASAPolynomial(coeffs=[18.4082,0.0296884,-1.65037e-05,3.38769e-09,-2.45741e-13,-100077,-59.0421], Tmin=(865.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-805.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-581.889,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,316,385,515,654,689,1295,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,334,575,1197,1424,3202,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.33627,0.135108,-0.000255645,2.37465e-07,-8.31268e-11,-69810,34.4096], Tmin=(100,'K'), Tmax=(858.35,'K')), NASAPolynomial(coeffs=[11.355,0.0383573,-2.08468e-05,4.05574e-09,-2.77743e-13,-70603.3,-16.8096], Tmin=(858.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsOsH) + group(CsCsFHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(C2CsJO) + radical(Csj(Cs-F1sO2sCs)(F1s)(H))"""),
)

species(
    label = 'O[C]([CH]F)C(F)(CF)OF(15286)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-590.4,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,316,385,515,654,689,1295,528,1116,1182,1331,1402,1494,3075,3110,360,370,350,334,575,1197,1424,3202,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.35639,0.1318,-0.00023691,2.12418e-07,-7.30044e-11,-70829.2,34.1072], Tmin=(100,'K'), Tmax=(840.472,'K')), NASAPolynomial(coeffs=[13.6393,0.035085,-1.90628e-05,3.73802e-09,-2.58463e-13,-72454.6,-30.3061], Tmin=(840.472,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-590.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsOsH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + radical(C2CsJOH) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)

species(
    label = '[CH2]C(F)(OF)C(O)(F)[CH]F(15287)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-591.483,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,289,343,342,428,440,590,571,737,593,785,1204,1386,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57308,0.13754,-0.000250418,2.25606e-07,-7.77154e-11,-70952.7,32.917], Tmin=(100,'K'), Tmax=(841.17,'K')), NASAPolynomial(coeffs=[14.0782,0.0356243,-1.96602e-05,3.86971e-09,-2.67836e-13,-72613.2,-34.1036], Tmin=(841.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-591.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sCs)(F1s)(H)) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)
...
"""),
    E0 = (-877.054,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,316,385,515,654,689,1295,286,334,437,422,648,895,1187,528,1116,1182,1331,1402,1494,3075,3110,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.474236,'amu*angstrom^2'), symmetry=1, barrier=(10.9036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473266,'amu*angstrom^2'), symmetry=1, barrier=(10.8813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.474685,'amu*angstrom^2'), symmetry=1, barrier=(10.9139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47623,'amu*angstrom^2'), symmetry=1, barrier=(33.9415,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (160.067,'amu'),
...
"""),
    E0 = (-804.025,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.04661,'amu*angstrom^2'), symmetry=1, barrier=(24.0635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04591,'amu*angstrom^2'), symmetry=1, barrier=(24.0475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04681,'amu*angstrom^2'), symmetry=1, barrier=(24.0682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0461,'amu*angstrom^2'), symmetry=1, barrier=(24.0519,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.227158,0.101052,-0.000162673,1.38105e-07,-4.64763e-11,-96557.4,29.8915], Tmin=(100,'K'), Tmax=(788.549,'K')), NASAPolynomial(coeffs=[12.296,0.0307268,-1.5965e-05,3.13766e-09,-2.1975e-13,-98321.1,-26.2101], Tmin=(788.549,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-804.025,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (-462.505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,212,931,1104,1251,1325,1474,3102,3155,325,375,415,465,420,450,1700,1750,234,589,736,816,1240,3237,375.305,375.696],'cm^-1')),
        HinderedRotor(inertia=(0.130427,'amu*angstrom^2'), symmetry=1, barrier=(13.0157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334468,'amu*angstrom^2'), symmetry=1, barrier=(33.4076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334181,'amu*angstrom^2'), symmetry=1, barrier=(33.4171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130569,'amu*angstrom^2'), symmetry=1, barrier=(13.0261,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
...
"""),
    E0 = (-614.9,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,1380,1390,370,380,2900,435,350,440,435,1725,334,575,1197,1424,3202,194,682,905,1196,1383,3221,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.312116,'amu*angstrom^2'), symmetry=1, barrier=(7.17616,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.35495,'amu*angstrom^2'), symmetry=1, barrier=(31.1529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.35848,'amu*angstrom^2'), symmetry=1, barrier=(31.2342,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OC(F)([C](CF)OF)C(F)F(15293)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (179.065,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.877034,0.122014,-0.000175253,1.04101e-07,-8.42063e-12,-119842,34.0503], Tmin=(100,'K'), Tmax=(572.5,'K')), NASAPolynomial(coeffs=[15.3266,0.0355731,-1.89161e-05,3.73258e-09,-2.61336e-13,-122136,-38.9171], Tmin=(572.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-997.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + group(Cs-CsCsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + radical(C2CsJO)"""),
)

species(
    label = 'O[C](C(F)F)C(F)(CF)OF(15294)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'OC(F)([CH]F)C(F)OF(5521)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'OC(F)([CH]F)C(F)(F)OF(5229)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    products = ['OC(F)([CH]F)C(F)(F)COF(15281)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+13,'s^-1'), n=0, Ea=(299,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [OF]
Euclidian distance = 0
family: 1,2_XY_interchange"""),
...
reaction(
    label = 'reaction9',
    reactants = ['OF(482)', 'OC(F)([CH]F)C(F)=CF(6909)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(488)', 'C=C(F)C(O)(F)[CH]F(6908)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]C(O)(F)C(F)(CF)OF(15283)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]F(137)', 'O[C](F)C(F)(CF)OF(5239)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'OC(F)([C]F)C(F)(CF)OF-2(15284)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'OC(=CF)C(F)(CF)OF(5544)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(54.8054,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'FC=C(F)C(F)(CF)OF(4560)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'O[C]([CH]F)C(F)(CF)OF(15286)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', '[CH2]C(F)(OF)C(O)(F)[CH]F(15287)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', '[O]C(F)(CF)C(O)(F)[CH]F(3333)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]F(128)', 'OC(F)([CH]F)[C](F)CF(6904)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction22',
    reactants = ['OH(7)', 'F[CH][C](F)C(F)(CF)OF(3930)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O[C](F)[CH]F(881)', 'FC[C](F)OF(3020)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2F(46)', 'OC(F)([CH]F)[C](F)OF(7930)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F2(78)', 'O=C(CF)C(O)(F)[CH]F(15289)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(74.5361,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(177.415,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction29',
    reactants = ['F2(78)', 'OC([CH]F)=C(CF)OF(15290)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction30',
    reactants = ['F2(78)', 'C=C(OF)C(O)(F)[CH]F(14561)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    transitionState = 'TS30',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(7.24791,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction31',
    reactants = ['HF(38)', 'OC(F)([CH]F)C(=CF)OF(15291)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    transitionState = 'TS31',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(224.891,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction32',
    reactants = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    products = ['HF(38)', 'O=C(F)[CH]F(215)', 'C=C(F)OF(3013)'],
    transitionState = 'TS32',
    kinetics = Arrhenius(A=(1.98542e+10,'s^-1'), n=0.978818, Ea=(205.691,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C_Ext-2C-R',), comment="""Estimated from node Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_Sp-7BrCClFINPSSi-2C_Ext-2C-R"""),
)

reaction(
    label = 'reaction33',
    reactants = ['CHF(40)', 'O[C](F)C(F)(CF)OF(5239)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(5)', 'OC(F)([C]F)C(F)(CF)OF(5526)'],
    products = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
...
reaction(
    label = 'reaction37',
    reactants = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    products = ['[O]C(F)(CF)C(O)(F)C(F)F(15292)'],
    transitionState = 'TS37',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(75.5248,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction38',
    reactants = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    products = ['OC(F)([C](CF)OF)C(F)F(15293)'],
    transitionState = 'TS38',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(216.591,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction39',
    reactants = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    products = ['O[C](C(F)F)C(F)(CF)OF(15294)'],
...
reaction(
    label = 'reaction40',
    reactants = ['OC(F)([CH]F)C(F)(CF)OF(5537)'],
    products = ['[CH2]C(F)(OF)C(O)(F)C(F)F(15295)'],
