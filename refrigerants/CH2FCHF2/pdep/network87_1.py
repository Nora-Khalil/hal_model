...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C[C](F)F(230)'],
    products = ['O=[C]OC[C](F)F(354)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(156)', '[CH2]O[C]=O(534)'],
    products = ['O=[C]OC[C](F)F(354)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC=C(F)F(535)'],
    products = ['O=[C]OC[C](F)F(354)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]O[C]=O(534)'],
    products = ['O=[C]OC[C](F)F(354)'],
