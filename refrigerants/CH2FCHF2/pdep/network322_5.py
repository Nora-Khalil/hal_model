...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3999.14,'J/mol'), sigma=(6.22389,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=624.66 K, Pc=37.64 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.786175,'amu*angstrom^2'), symmetry=1, barrier=(18.0757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784431,'amu*angstrom^2'), symmetry=1, barrier=(18.0356,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.297274,0.0825243,-0.000121045,8.32251e-08,-2.13084e-11,3832.78,25.1439], Tmin=(100,'K'), Tmax=(823.919,'K')), NASAPolynomial(coeffs=[17.1411,0.00929334,-3.2767e-06,5.18896e-10,-3.16385e-14,767.212,-54.6152], Tmin=(823.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.7662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(CdCFH) + radical(C=C(C)OJ) + radical(Cdj(Cd-CdH)(F1s))"""),
)

species(
    label = 'O=C(F)[CH]OC=[C]F(1584)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-119.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([288,410,724,839,1320,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,180,180,1391.08],'cm^-1')),
        HinderedRotor(inertia=(0.113489,'amu*angstrom^2'), symmetry=1, barrier=(2.60933,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17504,0.0459071,-5.11789e-05,3.34104e-08,-9.67691e-12,-14331.1,18.7069], Tmin=(100,'K'), Tmax=(803.462,'K')), NASAPolynomial(coeffs=[6.11535,0.0262905,-1.45565e-05,3.02326e-09,-2.2189e-13,-14964.2,0.559375], Tmin=(803.462,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-119.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(Cds-O2d(Cds-Cds)H) + radical(CsCCl_triplet)"""),
)

species(
    label = 'O=CC1(F)C=C(F)O1(1827)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {7,S}
4  O u0 p2 c0 {8,D}
...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53189,0.0601086,-8.70541e-05,7.80955e-08,-2.94577e-11,-16692.1,22.6223], Tmin=(100,'K'), Tmax=(723.677,'K')), NASAPolynomial(coeffs=[5.82608,0.031233,-1.65477e-05,3.32837e-09,-2.38113e-13,-17179,4.22415], Tmin=(723.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(CdCFH) + ring(Cs(O2)-O2s-Cs(F)) + radical(CCOJ) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'O=CC(=O)C=[C]F(1830)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {4,D}
3 O u0 p2 c0 {6,D}
...
"""),
    E0 = (-124.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,552.5,462.5,1710,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(0.131179,'amu*angstrom^2'), symmetry=1, barrier=(9.02818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13033,'amu*angstrom^2'), symmetry=1, barrier=(48.9805,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65443,0.0564124,-8.43368e-05,7.23059e-08,-2.53771e-11,-14856.5,21.7823], Tmin=(100,'K'), Tmax=(750.462,'K')), NASAPolynomial(coeffs=[7.21394,0.023534,-1.21329e-05,2.40071e-09,-1.69749e-13,-15599.5,-2.83415], Tmin=(750.462,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-O2d(Cds-O2d)Cs) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-O2d)H) + group(CdCFH) + radical(Cdj(Cd-COH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.99938,'amu*angstrom^2'), symmetry=1, barrier=(22.9777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.04905,'amu*angstrom^2'), symmetry=1, barrier=(47.1117,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03129,0.0738267,-0.000131734,1.19123e-07,-4.10119e-11,-23184.3,23.7004], Tmin=(100,'K'), Tmax=(861.126,'K')), NASAPolynomial(coeffs=[8.29443,0.0224295,-1.14443e-05,2.18225e-09,-1.48231e-13,-23780.5,-6.45236], Tmin=(861.126,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(Ct-CtCs) + group(CtCF) + radical(C=OCOJ)"""),
)

species(
    label = '[O]C=C([O])C#CF(1832)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u1 p2 c0 {4,S}
3 O u1 p2 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.36425,'amu*angstrom^2'), symmetry=1, barrier=(31.3669,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.972387,0.0569668,-6.77115e-05,3.6701e-08,-7.41e-12,3427.59,22.0927], Tmin=(100,'K'), Tmax=(1337.41,'K')), NASAPolynomial(coeffs=[17.9127,0.00121307,5.2655e-07,-1.58396e-10,1.17756e-14,-648.632,-62.8587], Tmin=(1337.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.5236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsOsH) + group(Ct-Ct(Cds-Cds)) + group(CtCF) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)

species(
    label = 'O=[C]C(=O)C=[C]F(1833)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {4,D}
3 O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.621954,0.0830699,-0.000146794,1.31466e-07,-4.52621e-11,-24823.5,26.2687], Tmin=(100,'K'), Tmax=(840.706,'K')), NASAPolynomial(coeffs=[9.69576,0.0238971,-1.26692e-05,2.4682e-09,-1.7031e-13,-25783.7,-12.5698], Tmin=(840.706,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-207.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'O=[C]C(O)(F)C=[C]F(1836)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {10,S}
...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.592243,0.0812841,-0.000136332,1.15162e-07,-3.77582e-11,-34187,26.722], Tmin=(100,'K'), Tmax=(832.741,'K')), NASAPolynomial(coeffs=[11.7018,0.0195335,-9.99488e-06,1.92668e-09,-1.32471e-13,-35746.4,-23.0957], Tmin=(832.741,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFH) + radical(CCCJ=O) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[O]C(F)([C]=O)C=CF(1837)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.831844,0.0757401,-0.000123945,1.0515e-07,-3.48906e-11,-34963.2,26.1515], Tmin=(100,'K'), Tmax=(825.776,'K')), NASAPolynomial(coeffs=[10.4046,0.0213961,-1.07454e-05,2.06807e-09,-1.42535e-13,-36272.3,-16.5527], Tmin=(825.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-291.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC(=C[C]F)OF(1838)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {8,S}
...
"""),
    E0 = (28.9582,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,180,180,180,759.906],'cm^-1')),
        HinderedRotor(inertia=(0.00702464,'amu*angstrom^2'), symmetry=1, barrier=(6.11875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.701908,'amu*angstrom^2'), symmetry=1, barrier=(16.1382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.701855,'amu*angstrom^2'), symmetry=1, barrier=(16.137,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.777659,0.0796779,-0.00013972,1.2987e-07,-4.75797e-11,3590.37,24.2022], Tmin=(100,'K'), Tmax=(778.123,'K')), NASAPolynomial(coeffs=[8.32615,0.0282711,-1.63272e-05,3.33601e-09,-2.38392e-13,2797.18,-7.86951], Tmin=(778.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.9582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHH) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)H) + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction73',
    reactants = ['CO(13)', '[O]C(F)C=[C]F(380)'],
    products = ['[O]C(F)(C=O)C=[C]F(1467)'],
...
reaction(
    label = 'reaction76',
    reactants = ['O(6)', 'O=CC(F)=C[C]F(1826)'],
    products = ['[O]C(F)(C=O)C=[C]F(1467)'],
...
reaction(
    label = 'reaction77',
    reactants = ['[O]C(F)(C=O)C=[C]F(1467)'],
    products = ['O=CC1(F)C=C(F)O1(1827)'],
...
reaction(
    label = 'reaction79',
    reactants = ['[O]C(F)(C=O)C=[C]F(1467)'],
    products = ['[O]C1(F)[CH]OC(F)=C1(1828)'],
...
reaction(
    label = 'reaction81',
    reactants = ['F(37)', 'O=CC(=O)C=[C]F(1830)'],
    products = ['[O]C(F)(C=O)C=[C]F(1467)'],
...
reaction(
    label = 'reaction83',
    reactants = ['HCO(15)', 'O=C(F)C=[C]F(454)'],
    products = ['[O]C(F)(C=O)C=[C]F(1467)'],
...
reaction(
    label = 'reaction85',
    reactants = ['H(5)', '[O]C(F)(C#CF)C=O(1831)'],
    products = ['[O]C(F)(C=O)C=[C]F(1467)'],
...
reaction(
    label = 'reaction87',
    reactants = ['HF(38)', '[O]C=C([O])C#CF(1832)'],
    products = ['[O]C(F)(C=O)C=[C]F(1467)'],
...
reaction(
    label = 'reaction88',
    reactants = ['HF(38)', 'O=[C]C(=O)C=[C]F(1833)'],
    products = ['[O]C(F)(C=O)C=[C]F(1467)'],
...
reaction(
    label = 'reaction95',
    reactants = ['[CH]=C(F)O[C](F)C=O(1482)'],
    products = ['C2HF(58)', 'O=CC(=O)F(335)'],
...
reaction(
    label = 'reaction96',
    reactants = ['O=C[C]F(284)', '[CH]C(=O)F(323)'],
    products = ['[CH]=C(F)O[C](F)C=O(1482)'],
...
reaction(
    label = 'reaction99',
    reactants = ['[CH]=C(F)O[C](F)C=O(1482)'],
    products = ['[CH]=C(F)OC1(F)[CH]O1(1853)'],
...
reaction(
    label = 'reaction100',
    reactants = ['[CH]=C(F)O[C](F)C=O(1482)'],
    products = ['F[C]1[CH]OC=C(F)O1(1811)'],
...
reaction(
    label = 'reaction101',
    reactants = ['[CH]=C(F)O[C](F)C=O(1482)'],
    products = ['[O]C1C=C(F)O[C]1F(1843)'],
...
reaction(
    label = 'reaction103',
    reactants = ['F(37)', 'C#CO[C](F)C=O(1854)'],
    products = ['[CH]=C(F)O[C](F)C=O(1482)'],
...
reaction(
    label = 'reaction105',
    reactants = ['H(5)', '[CH]=C(F)OC(F)=C=O(1855)'],
    products = ['[CH]=C(F)O[C](F)C=O(1482)'],
...
reaction(
    label = 'reaction107',
    reactants = ['O=C[C]F-2(1596)', '[CH]C(=O)F(323)'],
    products = ['[CH]=C(F)O[C](F)C=O(1482)'],
...
reaction(
    label = 'reaction108',
    reactants = ['[CH]=C(F)OC(F)[C]=O(1856)'],
    products = ['[CH]=C(F)O[C](F)C=O(1482)'],
...
reaction(
    label = 'reaction110',
    reactants = ['[CH]=[C]OC(F)(F)C=O(1858)'],
    products = ['[CH]=C(F)O[C](F)C=O(1482)'],
...
reaction(
    label = 'reaction112',
    reactants = ['O(6)', '[CH]=C(F)OC(=[CH])F(1859)'],
    products = ['[CH]=C(F)O[C](F)C=O(1482)'],
...
reaction(
    label = 'reaction114',
    reactants = ['[CH]=C(F)O[C](F)C=O(1482)'],
    products = ['[O][CH]C1(F)C=C(F)O1(1860)'],
...
reaction(
    label = 'reaction115',
    reactants = ['HF(38)', '[CH]=C(F)O[C]=C=O(1861)'],
    products = ['[CH]=C(F)O[C](F)C=O(1482)'],
...
reaction(
    label = 'reaction116',
    reactants = ['[CH]=C(F)OC(F)=[C]O(1862)'],
    products = ['[CH]=C(F)O[C](F)C=O(1482)'],
...
network(
    ...
    isomers = [
        ...
        '[O]C1C(F)=CC1([O])F(964)',
        'FC1=CC2(F)OOC12(939)',
        '[O]C(F)(C=O)C=[C]F(1467)',
        '[CH]=C(F)O[C](F)C=O(1482)',
    ],
    reactants = [
