...
"""),
    E0 = (-404.773,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,543.893,543.976,544.231,544.284,544.789,544.956],'cm^-1')),
        HinderedRotor(inertia=(0.000567744,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149862,'amu*angstrom^2'), symmetry=1, barrier=(31.6157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15043,'amu*angstrom^2'), symmetry=1, barrier=(31.609,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20392,0.0287382,1.88036e-06,-2.92946e-08,1.45287e-11,-48608.6,16.8272], Tmin=(100,'K'), Tmax=(975.641,'K')), NASAPolynomial(coeffs=[14.1868,0.00541943,-1.94887e-06,4.36299e-10,-3.74672e-14,-52175.2,-46.983], Tmin=(975.641,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-404.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-OsHHH) + group(Cds-OdOsOs) + radical(CsJOC(O))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'O=C(O)O(4912)'],
    products = ['O=C(O)OCF(5359)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(O)OF(5568)', 'CH2(S)(25)'],
    products = ['O=C(O)OCF(5359)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC(=O)O(6130)'],
    products = ['O=C(O)OCF(5359)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)O(4910)', 'CH2F(46)'],
    products = ['O=C(O)OCF(5359)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(O)O[CH]F(6028)'],
    products = ['O=C(O)OCF(5359)'],
