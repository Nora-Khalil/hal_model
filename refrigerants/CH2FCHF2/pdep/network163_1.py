...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10531,0.0771972,-0.000152811,1.56225e-07,-6.00479e-11,54109.1,11.2447], Tmin=(100,'K'), Tmax=(822.917,'K')), NASAPolynomial(coeffs=[3.69905,0.034437,-1.99071e-05,4.03047e-09,-2.8471e-13,54703.2,5.44014], Tmin=(822.917,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(CdCddCF) + group(CdCddCF) + group(Cdd-CdsCds) + group(CsJ2_singlet-CsH) + ring(cyclobutadiene_13)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[C-]=[O+]C1C(F)=C=C1F(888)'],
    products = ['CO(13)', 'FC1=CC(F)=C1(307)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.66316e+09,'s^-1'), n=1.02661, Ea=(42.8007,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=3.6261064499336317, var=38.37240951049941, Tref=1000.0, N=4, data_mean=0.0, correlation='Root_1R!H->C_N-2R!H->C',), comment="""Estimated from node Root_1R!H->C_N-2R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[C-]=[O+]C1C(F)=C=C1F(888)'],
    products = ['FC1=C=C(F)C=[O+][C-]1(890)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(9.25418e+20,'s^-1'), n=-1.9758, Ea=(170.27,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction3',
    reactants = ['[C-]=[O+]C1C(F)=C=C1F(888)'],
    products = ['[C-]=[O+]C1=C(F)C=C1F(891)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.09884e+62,'s^-1'), n=-13.6281, Ea=(339.975,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.1335689029548193, var=267.23618516426137, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_1R!H-inRing',), comment="""Estimated from node Root_1R!H-inRing"""),
)

reaction(
    label = 'reaction4',
    reactants = ['HF(38)', '[C-]=[O+]C1=C=C=C1F(892)'],
    products = ['[C-]=[O+]C1C(F)=C=C1F(888)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(235.794,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)
