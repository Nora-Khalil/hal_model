...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FC=CCOF(2857)'],
    products = ['FC=CC(F)(F)COF(7782)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHFCHF[Z](59)', 'F[C]COF(2842)'],
    products = ['FC=CC(F)(F)COF(7782)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FCOF(367)', 'F[C]C=CF-2(10989)'],
    products = ['FC=CC(F)(F)COF(7782)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FC=CC(F)(F)OF(2824)'],
    products = ['FC=CC(F)(F)COF(7782)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(488)', 'C=C(F)C=CF(12295)'],
    products = ['FC=CC(F)(F)COF(7782)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['FOCC(F)C=C(F)F(12247)'],
    products = ['FC=CC(F)(F)COF(7782)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]CC(F)(F)[CH]OF(12296)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FC[CH]C(F)(F)[CH]OF(12297)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[CH]C=C(F)COF(12298)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH]=CC(F)(F)COF(12299)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(128)', '[CH2]C(F)(F)C=CF(175)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]OF(2545)', 'F[CH]C=C(F)F(4846)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHFCH[Z](71)', 'FOC[C](F)F(2864)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FC=CC(F)(F)[CH]OF(12300)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FC=[C]C(F)(F)COF(12301)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'F[C]=CC(F)(F)COF(12302)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FC[C]C(F)(F)COF(12303)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C(F)C(F)(F)COF(12304)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=CC(F)(F)C=CF(10434)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'FC=CC(F)=COF(12305)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'FC=C=C(F)COF(12306)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'C#CC(F)(F)COF(12307)'],
    products = ['FC=CC(F)(F)COF(7782)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CHF(40)', '[CH]C(F)(F)COF(12308)'],
    products = ['FC=CC(F)(F)COF(7782)'],
