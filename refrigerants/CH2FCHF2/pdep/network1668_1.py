...
"""),
    E0 = (-844.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,219,296,586,564,718,793,1177,1228,3010,987.5,1337.5,450,1655,350,440,435,1725,305.016,313.552],'cm^-1')),
        HinderedRotor(inertia=(0.237876,'amu*angstrom^2'), symmetry=1, barrier=(15.4776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127697,'amu*angstrom^2'), symmetry=1, barrier=(8.57286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127096,'amu*angstrom^2'), symmetry=1, barrier=(8.52108,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.221547,0.0882637,-0.000135182,1.03627e-07,-3.10923e-11,-101457,25.2171], Tmin=(100,'K'), Tmax=(821.246,'K')), NASAPolynomial(coeffs=[14.3069,0.0196631,-9.89138e-06,1.92561e-09,-1.34622e-13,-103770,-39.9636], Tmin=(821.246,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-844.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'OC(=CF)OC(F)(F)F(5294)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-870.927,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,193,295,551,588,656,1146,1192,1350,1380,1390,370,380,2900,435,180,180,1736.15,1736.6],'cm^-1')),
        HinderedRotor(inertia=(0.172557,'amu*angstrom^2'), symmetry=1, barrier=(3.96744,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.67996,0.0865326,-0.000161406,1.59283e-07,-5.96516e-11,-104642,28.3507], Tmin=(100,'K'), Tmax=(832.569,'K')), NASAPolynomial(coeffs=[4.66411,0.037916,-2.07121e-05,4.10239e-09,-2.86373e-13,-104284,15.9946], Tmin=(832.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-870.927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)[C](F)C(F)(F)F(12698)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-906.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,253,522,585,610,849,1160,1215,1402,212,367,445,1450,180,180,2417.58],'cm^-1')),
        HinderedRotor(inertia=(0.21115,'amu*angstrom^2'), symmetry=1, barrier=(4.85476,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211158,'amu*angstrom^2'), symmetry=1, barrier=(4.85494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211187,'amu*angstrom^2'), symmetry=1, barrier=(4.8556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.393499,0.0929348,-0.000175913,1.68652e-07,-6.10095e-11,-108869,31.2231], Tmin=(100,'K'), Tmax=(847.865,'K')), NASAPolynomial(coeffs=[6.82752,0.0331323,-1.80142e-05,3.53367e-09,-2.44216e-13,-108901,7.48656], Tmin=(847.865,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-906.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + radical(CCOJ) + radical(CsCsCsF1s)"""),
)

species(
    label = 'OC(O)=C(F)C(F)(F)F(12699)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.600192,'amu*angstrom^2'), symmetry=1, barrier=(13.7996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600254,'amu*angstrom^2'), symmetry=1, barrier=(13.801,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.599942,'amu*angstrom^2'), symmetry=1, barrier=(13.7938,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0308086,0.0902058,-0.000131785,9.27979e-08,-2.52314e-11,-139113,24.4582], Tmin=(100,'K'), Tmax=(909.372,'K')), NASAPolynomial(coeffs=[17.2203,0.0145957,-7.06813e-06,1.36753e-09,-9.59399e-14,-142240,-56.8385], Tmin=(909.372,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1157.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCdFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs)"""),
)
...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3242.95,'J/mol'), sigma=(5.45683,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=506.54 K, Pc=45.29 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-1051.9,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([206,363,518,1175,1317,1481,3059,193,295,551,588,656,1146,1192,1350,505.307,505.308,505.308,505.309,505.313,505.314,505.315],'cm^-1')),
        HinderedRotor(inertia=(0.000660213,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000660232,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66947,0.0619976,-5.67354e-05,-2.23444e-08,5.62807e-11,-126441,21.6017], Tmin=(100,'K'), Tmax=(475.124,'K')), NASAPolynomial(coeffs=[7.54869,0.0309379,-1.68834e-05,3.40867e-09,-2.43442e-13,-127208,-4.57692], Tmin=(475.124,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1051.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-1121.23,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,522,585,610,849,1160,1215,1402,234,347,1316,1464,239.674,240.022,241,242.006,730.932,732.518],'cm^-1')),
        HinderedRotor(inertia=(0.147118,'amu*angstrom^2'), symmetry=1, barrier=(55.9537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53292,'amu*angstrom^2'), symmetry=1, barrier=(55.9629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00294136,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03656,0.0686013,-8.47025e-05,5.29354e-08,-1.32121e-11,-134749,24.065], Tmin=(100,'K'), Tmax=(972.673,'K')), NASAPolynomial(coeffs=[12.7249,0.0205342,-1.05762e-05,2.12945e-09,-1.53766e-13,-137023,-32.0008], Tmin=(972.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1121.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdCsOs) + radical(CsCOCsF1s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OC(F)C(F)(F)F(779)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO2(14)', 'FCC(F)(F)F(3631)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(482)', 'O=C=CC(F)(F)F(8424)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OC(F)(F)F(2564)', 'O=C=CF(2952)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OC(=CC(F)(F)F)OF(12696)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C([O])C(F)C(F)(F)F(12697)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(O)[C](F)C(F)(F)F(12698)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OC(O)=C(F)C(F)(F)F(12699)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=C(O)[CH]C(F)(F)F(8428)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)C(F)[C](F)F(5310)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'O=[C]C(F)C(F)(F)F(9641)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(=O)C(F)C(F)(F)F(9643)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF3(45)', 'O=C(O)[CH]F(5620)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(338)', 'CF3-CHF(54)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(O)[C](F)C(F)(F)F(12700)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'O=C(O)C=C(F)F(350)'],
    products = ['O=C(O)C(F)C(F)(F)F(4221)'],
...
network(
    ...
    isomers = [
        'O=C(O)C(F)C(F)(F)F(4221)',
    ],
    reactants = [
        ('HF(38)', 'CO2(14)', 'CHFCF2(55)'),
        ('CO2(14)', 'FCC(F)(F)F(3631)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
