...
species(
    label = 'F[C]C1C(F)(F)C1(F)F(15460)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH]C1[C](F)C1(F)F(15461)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'F[CH][C]1C(F)(F)C1(F)F(15462)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'F[CH]C1=C(F)C1(F)F(15463)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 F u0 p3 c0 {7,S}
...
species(
    label = 'F[C]C1C(F)(F)C1(F)F-2(15465)',
...
species(
    label = 'FC[C]1C(F)(F)C1(F)F(15466)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
    products = ['FC1[CH]C(F)(F)C1(F)F(14888)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F(37)', '[CH]C1C(F)(F)C1(F)F(15459)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]F(137)', 'FC1(F)[CH]C1(F)F(14986)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(5)', 'F[C]C1C(F)(F)C1(F)F(15460)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(5)', 'FC=C1C(F)(F)C1(F)F(9808)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F(37)', 'F[CH]C1[C](F)C1(F)F(15461)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(5)', 'F[CH][C]1C(F)(F)C1(F)F(15462)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
...
reaction(
    label = 'reaction29',
    reactants = ['HF(38)', 'F[CH]C1=C(F)C1(F)F(15463)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
...
reaction(
    label = 'reaction30',
    reactants = ['F2(78)', 'F[CH]C1C(F)=C1F(15464)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CHF(40)', 'FC1(F)[CH]C1(F)F(14986)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(5)', 'F[C]C1C(F)(F)C1(F)F-2(15465)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
...
reaction(
    label = 'reaction33',
    reactants = ['FC[C]1C(F)(F)C1(F)F(15466)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(14768)'],
