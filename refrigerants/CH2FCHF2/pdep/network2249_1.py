...
reaction(
    label = 'reaction1',
    reactants = ['[O]OOC=[C]F(2148)'],
    products = ['O2(2)', 'FC1=CO1(286)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[O](129)', '[CH]=[C]F(252)'],
    products = ['[O]OOC=[C]F(2148)'],
    transitionState = 'TS8',
