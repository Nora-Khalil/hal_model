...
"""),
    E0 = (-215.403,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([562,600,623,1070,1265,1685,370,1855,455,950,180,180,1074.61],'cm^-1')),
        HinderedRotor(inertia=(0.829626,'amu*angstrom^2'), symmetry=1, barrier=(19.0747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.48136,'amu*angstrom^2'), symmetry=1, barrier=(57.0515,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.028,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67973,0.0588957,-0.000109694,1.0406e-07,-3.76986e-11,-25831.1,21.7466], Tmin=(100,'K'), Tmax=(830.044,'K')), NASAPolynomial(coeffs=[6.42954,0.0202607,-1.14213e-05,2.27671e-09,-1.59197e-13,-26077.2,2.98373], Tmin=(830.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-OdOsH) + radical(C=CJO) + radical((O)CJOC)"""),
)

species(
    label = 'O=C1OC(=C(F)F)C1F(9691)',
...
"""),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.862286,0.0671481,-8.1126e-05,4.86324e-08,-1.09385e-11,-99116.4,24.7035], Tmin=(100,'K'), Tmax=(899.795,'K')), NASAPolynomial(coeffs=[14.312,0.0143726,-4.84027e-06,7.75399e-10,-4.90196e-14,-101821,-40.3412], Tmin=(899.795,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-825.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CsCCFH) + group(Cds-CdsCsOs) + group(Cds-OdCsOs) + group(CdCFF) + longDistanceInteraction_cyclic(Cs(F)-CO) + ring(4-Methylene-2-oxetanone)"""),
)

species(
    label = 'O=[C]O[C]1C(F)C1(F)F(10492)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'O=C1O[C]([CH]F)C1(F)F(10493)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-416.4,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,167,640,1190,1855,455,950,180,276.589,4000],'cm^-1')),
        HinderedRotor(inertia=(1.80715,'amu*angstrom^2'), symmetry=1, barrier=(41.55,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81377,'amu*angstrom^2'), symmetry=1, barrier=(41.7021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79957,'amu*angstrom^2'), symmetry=1, barrier=(41.3757,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.421416,0.0936085,-0.000183077,1.80088e-07,-6.66465e-11,-49966.9,26.814], Tmin=(100,'K'), Tmax=(837.825,'K')), NASAPolynomial(coeffs=[5.88153,0.0350256,-1.99805e-05,3.98938e-09,-2.78606e-13,-49740.6,8.2487], Tmin=(837.825,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-416.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-OdOsH) + radical(Cdj(Cd-CsO2s)(F1s)) + radical((O)CJOC)"""),
)

species(
    label = 'O=C(F)OC([C]F)=CF(10496)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.586822,0.0844302,-0.000148704,1.38184e-07,-5.05351e-11,-61077.8,26.279], Tmin=(100,'K'), Tmax=(780.518,'K')), NASAPolynomial(coeffs=[8.6404,0.029565,-1.71421e-05,3.50132e-09,-2.50016e-13,-61921,-7.92696], Tmin=(780.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-508.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(COFOO) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-23.004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([615,860,1140,1343,3152,1685,370,1855,455,950,180,180,1147.5],'cm^-1')),
        HinderedRotor(inertia=(0.87702,'amu*angstrom^2'), symmetry=1, barrier=(20.1644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.36931,'amu*angstrom^2'), symmetry=1, barrier=(54.475,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-478.573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,182,240,577,636,1210,1413,2782.5,750,1395,475,1775,1000,180,180,1755.38,1755.76,1755.83],'cm^-1')),
        HinderedRotor(inertia=(1.34649,'amu*angstrom^2'), symmetry=1, barrier=(30.9585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34649,'amu*angstrom^2'), symmetry=1, barrier=(30.9585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34657,'amu*angstrom^2'), symmetry=1, barrier=(30.9603,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.786919,0.0809526,-0.000143873,1.38895e-07,-5.25842e-11,-57453.3,25.9484], Tmin=(100,'K'), Tmax=(785.421,'K')), NASAPolynomial(coeffs=[6.44094,0.0340167,-1.95884e-05,3.99465e-09,-2.85117e-13,-57781.9,3.59877], Tmin=(785.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-478.573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-OdOsH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]=C(O[C]=O)C(F)(F)F(10499)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.43261,0.0841859,-0.000128594,9.78931e-08,-2.92908e-11,-61548.3,25.0507], Tmin=(100,'K'), Tmax=(821.655,'K')), NASAPolynomial(coeffs=[13.7143,0.0195283,-1.05565e-05,2.12212e-09,-1.51388e-13,-63730.9,-36.4168], Tmin=(821.655,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-512.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CsCdFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P) + radical((O)CJOC)"""),
)

species(
    label = '[CH]C(OC(=O)F)=C(F)F(10500)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7577)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', 'O=C([CH]F)[C](F)F(9674)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7577)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(137)', 'O=[C]O[C]=C(F)F(10491)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7577)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7577)'],
    products = ['O=C1OC(=C(F)F)C1F(9691)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7577)'],
    products = ['O=[C]O[C]1C(F)C1(F)F(10492)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7577)'],
    products = ['O=C1O[C]([CH]F)C1(F)F(10493)'],
    transitionState = 'TS6',
...
reaction(
    ...
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(4.64245e+09,'s^-1'), n=0.690807, Ea=(46.3011,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra] for rate rule [R4_S_D;doublebond_intra;radadd_intra_CO]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', 'O=C([CH]F)[C](F)F(9674)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7577)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', 'O=[C]O[C]=C(F)F(10491)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7577)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]OC(=[C]F)C(F)F(10495)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7577)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7577)'],
    products = ['O=C(F)OC([C]F)=CF(10496)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7577)'],
    products = ['O=C1OC(=CF)C1(F)F(9692)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7577)'],
    products = ['O=C1O[C]([C](F)F)C1F(10497)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=COC([C]F)=C(F)F(10498)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7577)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7577)'],
    products = ['[CH]=C(O[C]=O)C(F)(F)F(10499)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7577)'],
    products = ['[CH]C(OC(=O)F)=C(F)F(10500)'],
