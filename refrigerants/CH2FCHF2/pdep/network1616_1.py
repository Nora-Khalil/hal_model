...
"""),
    E0 = (-881.436,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,2782.5,750,1395,475,1775,1000,270.197,270.198,270.198,270.198],'cm^-1')),
        HinderedRotor(inertia=(0.3715,'amu*angstrom^2'), symmetry=1, barrier=(19.2464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.688014,'amu*angstrom^2'), symmetry=1, barrier=(35.6441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.688016,'amu*angstrom^2'), symmetry=1, barrier=(35.6441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142177,'amu*angstrom^2'), symmetry=1, barrier=(35.6441,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.864034,0.0744199,-8.15876e-05,4.59444e-08,-1.06106e-11,-105904,25.1928], Tmin=(100,'K'), Tmax=(1030.18,'K')), NASAPolynomial(coeffs=[12.5542,0.0290292,-1.54964e-05,3.17457e-09,-2.31434e-13,-108312,-31.5533], Tmin=(1030.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-881.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (-529.621,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,617,898,1187,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.51945,'amu*angstrom^2'), symmetry=1, barrier=(34.9352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5195,'amu*angstrom^2'), symmetry=1, barrier=(34.9363,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5204,'amu*angstrom^2'), symmetry=1, barrier=(34.9569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.51986,'amu*angstrom^2'), symmetry=1, barrier=(34.9445,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.849797,0.0762084,-0.000106812,7.77329e-08,-2.28864e-11,-63591.3,26.1888], Tmin=(100,'K'), Tmax=(824.505,'K')), NASAPolynomial(coeffs=[11.3268,0.0253806,-1.43431e-05,2.96551e-09,-2.16063e-13,-65319,-22.3348], Tmin=(824.505,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-529.621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsCFOO) + group(Cds-OdOsH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-895.477,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,435,565,619,662,854,1178,1396,2782.5,750,1395,475,1775,1000,206.875,207.881,1439.4],'cm^-1')),
        HinderedRotor(inertia=(1.22078,'amu*angstrom^2'), symmetry=1, barrier=(36.9223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22745,'amu*angstrom^2'), symmetry=1, barrier=(36.8787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915053,'amu*angstrom^2'), symmetry=1, barrier=(28.5423,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70192,0.053237,-5.40512e-05,2.69764e-08,-5.46228e-12,-107621,21.2074], Tmin=(100,'K'), Tmax=(1168.77,'K')), NASAPolynomial(coeffs=[11.5957,0.0193764,-1.05941e-05,2.18831e-09,-1.60053e-13,-109933,-28.0671], Tmin=(1168.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-895.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsFFOO) + group(Cds-OdOsH)"""),
)

species(
    label = 'O=COCC(F)(F)OF(5638)',
...
"""),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.979876,0.0726317,-8.17207e-05,4.86772e-08,-1.20231e-11,-107342,25.6397], Tmin=(100,'K'), Tmax=(962.661,'K')), NASAPolynomial(coeffs=[11.0984,0.0305873,-1.62072e-05,3.30697e-09,-2.40482e-13,-109290,-22.7913], Tmin=(962.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-893.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFFO) + group(Cds-OdOsH)"""),
)

species(
    label = 'O=COC(F)(F)COF(5639)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
4  O u0 p2 c0 {7,S} {9,S}
...
"""),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.979862,0.0726319,-8.17211e-05,4.86776e-08,-1.20233e-11,-107342,25.6397], Tmin=(100,'K'), Tmax=(962.639,'K')), NASAPolynomial(coeffs=[11.0984,0.0305874,-1.62072e-05,3.30699e-09,-2.40483e-13,-109290,-22.7911], Tmin=(962.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-893.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (-646.276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,194,682,905,1196,1383,3221,2782.5,750,1395,475,1775,1000,180,1510.44],'cm^-1')),
        HinderedRotor(inertia=(0.647209,'amu*angstrom^2'), symmetry=1, barrier=(14.8806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.91539,'amu*angstrom^2'), symmetry=1, barrier=(44.0385,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97577,0.0499351,-5.93245e-05,4.01448e-08,-1.16372e-11,-77660.8,18.5931], Tmin=(100,'K'), Tmax=(816.882,'K')), NASAPolynomial(coeffs=[7.06853,0.0249989,-1.35379e-05,2.77993e-09,-2.0258e-13,-78492.9,-4.9468], Tmin=(816.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-646.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-OdOsH)"""),
)
...
"""),
    E0 = (-473.193,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,364,474,579,619,655,1345,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00737517,0.0951891,-0.00013846,1.02853e-07,-3.04489e-11,-56774.8,28.8428], Tmin=(100,'K'), Tmax=(825.476,'K')), NASAPolynomial(coeffs=[14.0528,0.0271396,-1.48236e-05,3.01677e-09,-2.17523e-13,-59093.9,-36.2262], Tmin=(825.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-473.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsOsHH) + radical(OCOJ) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)

species(
    label = 'O[CH]OC(F)([CH]F)OF(5642)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-511.631,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,364,474,579,619,655,1345,334,575,1197,1424,3202,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.926496,0.118624,-0.000211091,1.81421e-07,-5.95714e-11,-61367.4,31.4887], Tmin=(100,'K'), Tmax=(853.088,'K')), NASAPolynomial(coeffs=[15.8372,0.0227887,-1.22799e-05,2.37572e-09,-1.62136e-13,-63600.5,-43.0474], Tmin=(853.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-511.631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H)) + radical(OCJO)"""),
)
...
"""),
    E0 = (-757.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([373,336,502,477,708,1220,1477,528,1116,1182,1331,1402,1494,3075,3110,2782.5,750,1395,475,1775,1000,227.855,228.124,228.309],'cm^-1')),
        HinderedRotor(inertia=(0.0356227,'amu*angstrom^2'), symmetry=1, barrier=(40.1177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.598211,'amu*angstrom^2'), symmetry=1, barrier=(22.0991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08468,'amu*angstrom^2'), symmetry=1, barrier=(40.122,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.051,'amu'),
...
"""),
    E0 = (-680.427,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,364,474,579,619,655,1345,334,575,1197,1424,3202,2782.5,750,1395,475,1775,1000,259.926,259.929,259.934,1069.9],'cm^-1')),
        HinderedRotor(inertia=(0.798191,'amu*angstrom^2'), symmetry=1, barrier=(38.2675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.798162,'amu*angstrom^2'), symmetry=1, barrier=(38.2675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184059,'amu*angstrom^2'), symmetry=1, barrier=(8.82425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.798143,'amu*angstrom^2'), symmetry=1, barrier=(38.2676,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.500365,0.0844315,-0.000122349,9.33314e-08,-2.87877e-11,-81717.2,27.0574], Tmin=(100,'K'), Tmax=(789.001,'K')), NASAPolynomial(coeffs=[11.5666,0.0283289,-1.56905e-05,3.21e-09,-2.32109e-13,-83463.5,-23.7083], Tmin=(789.001,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-680.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsH) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)

species(
    label = 'O=[C]OC(F)(CF)OF(5647)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-684.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,1855,455,950,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.51664,'amu*angstrom^2'), symmetry=1, barrier=(34.8705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5172,'amu*angstrom^2'), symmetry=1, barrier=(34.8834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.51312,'amu*angstrom^2'), symmetry=1, barrier=(34.7897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5141,'amu*angstrom^2'), symmetry=1, barrier=(34.812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.462911,0.0843831,-0.000117138,8.36695e-08,-2.39737e-11,-82263.4,25.2639], Tmin=(100,'K'), Tmax=(849.795,'K')), NASAPolynomial(coeffs=[12.8577,0.026042,-1.41608e-05,2.88585e-09,-2.08686e-13,-84370,-32.517], Tmin=(849.795,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-684.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09606,0.0463703,-4.95501e-05,3.08258e-08,-8.31532e-12,-84657.9,23.1559], Tmin=(100,'K'), Tmax=(869.569,'K')), NASAPolynomial(coeffs=[6.74548,0.0249827,-1.26562e-05,2.54017e-09,-1.83112e-13,-85466.5,1.37503], Tmin=(869.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + group(Cds-OdOsH)"""),
)

species(
    label = 'C=C(OF)OC=O(5649)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=COC(F)(CF)OF(5373)'],
    products = ['HF(38)', 'CO2(14)', 'O=C(F)CF(879)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(12.1629,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OC(F)(CF)OF(5440)'],
    products = ['O=COC(F)(CF)OF(5373)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.27e-07,'m^3/(mol*s)'), n=3.7, Ea=(227.619,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->H_1COCbCdCtHNOSSidSis->O',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->H_1COCbCdCtHNOSSidSis->O"""),
)

reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=COC(F)([C]F)OF(5636)'],
    products = ['O=COC(F)(CF)OF(5373)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'O=COC(F)OF(5637)'],
    products = ['O=COC(F)(CF)OF(5373)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'O=COC(F)(F)OF(5367)'],
    products = ['O=COC(F)(CF)OF(5373)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(482)', 'O=COC(F)=CF(344)'],
    products = ['O=COC(F)(CF)OF(5373)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(488)', 'C=C(F)OC=O(5640)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]COC(F)([CH]F)OF(5641)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O[CH]OC(F)([CH]F)OF(5642)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=CO[C](CF)OF(5643)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)(OF)OC=O(5644)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[O]C(F)(CF)OC=O(4693)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C=O(339)', 'FC[C](F)OF(3060)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HCO(15)', '[O]C(F)(CF)OF(5449)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(128)', 'O=CO[C](F)CF(3257)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(46)', 'O=CO[C](F)OF(5645)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=COC(F)([CH]F)OF(5646)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=[C]OC(F)(CF)OF(5647)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=COC(F)(CF)OF(5373)'],
    products = ['O=CO(2909)', 'FC=C(F)OF(1046)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(8.91252e+12,'s^-1'), n=0, Ea=(207.373,'kJ/mol'), T0=(1,'K'), Tmin=(500,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N_Ext-2R!H-R_1BrClFINOPSSi->O_Ext-2R!H-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N_Ext-2R!H-R_1BrClFINOPSSi->O_Ext-2R!H-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'O=COC(=O)CF(5648)'],
    products = ['O=COC(F)(CF)OF(5373)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(72.8558,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'C=C(OF)OC=O(5649)'],
    products = ['O=COC(F)(CF)OF(5373)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'O=COC(=CF)OF(5650)'],
    products = ['O=COC(F)(CF)OF(5373)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(197.305,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)
