...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[CH2]C([O])=O(540)'],
    products = ['[CH2]C(=O)O[C]=O(4314)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[C]=O(4820)'],
    products = ['[CH2]C(=O)O[C]=O(4314)'],
    transitionState = 'TS3',
