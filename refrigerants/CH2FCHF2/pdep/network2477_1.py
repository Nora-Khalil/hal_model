...
species(
    label = 'OC(F)([C]F)C(F)(F)OF-2(9396)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.348638,'amu*angstrom^2'), symmetry=1, barrier=(8.01587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348713,'amu*angstrom^2'), symmetry=1, barrier=(8.0176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348055,'amu*angstrom^2'), symmetry=1, barrier=(8.00247,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19044,'amu*angstrom^2'), symmetry=1, barrier=(27.3705,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.537942,0.114587,-0.000221325,2.04218e-07,-7.07306e-11,-71578.8,29.9438], Tmin=(100,'K'), Tmax=(862.147,'K')), NASAPolynomial(coeffs=[11.5022,0.0274972,-1.547e-05,3.02411e-09,-2.06747e-13,-72494.3,-19.6262], Tmin=(862.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(C2CsJOH) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)

species(
    label = 'OC(F)([CH]F)[C](F)OF(9398)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.477853,'amu*angstrom^2'), symmetry=1, barrier=(10.9868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477643,'amu*angstrom^2'), symmetry=1, barrier=(10.9819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477682,'amu*angstrom^2'), symmetry=1, barrier=(10.9828,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.269705,0.104426,-0.000188008,1.66735e-07,-5.66411e-11,-102304,28.587], Tmin=(100,'K'), Tmax=(841.345,'K')), NASAPolynomial(coeffs=[12.5597,0.025058,-1.37489e-05,2.69925e-09,-1.86516e-13,-103813,-27.2267], Tmin=(841.345,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-851.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-F1sO2sCs)(F1s)(H))"""),
)

species(
    label = 'F[CH][C](F)C(F)(F)OF(3885)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[O]C(F)([CH]F)C(F)(F)OF(9349)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.265831,'amu*angstrom^2'), symmetry=1, barrier=(6.11197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04761,'amu*angstrom^2'), symmetry=1, barrier=(24.0865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265358,'amu*angstrom^2'), symmetry=1, barrier=(6.1011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.749198,0.118481,-0.000224518,2.04745e-07,-7.06351e-11,-89241.9,31.0313], Tmin=(100,'K'), Tmax=(851.531,'K')), NASAPolynomial(coeffs=[12.6659,0.0277384,-1.58303e-05,3.12435e-09,-2.15417e-13,-90521.3,-25.6301], Tmin=(851.531,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-743.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-F1sO2sCs)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.20992,'amu*angstrom^2'), symmetry=1, barrier=(27.8184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20883,'amu*angstrom^2'), symmetry=1, barrier=(27.7933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21073,'amu*angstrom^2'), symmetry=1, barrier=(27.8371,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.811149,0.0776409,-0.000117824,8.64852e-08,-2.24571e-11,-100834,24.6631], Tmin=(100,'K'), Tmax=(632.571,'K')), NASAPolynomial(coeffs=[11.4088,0.0217378,-1.16083e-05,2.30949e-09,-1.63141e-13,-102397,-23.3683], Tmin=(632.571,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-839.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COCsFO) + radical(CsCsF1sH)"""),
)

species(
    label = 'OC([CH]F)=C(F)OF(9400)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-423.366,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,350,440,435,1725,326,540,652,719,1357,234,589,736,816,1240,3237,1125.49],'cm^-1')),
        HinderedRotor(inertia=(0.384301,'amu*angstrom^2'), symmetry=1, barrier=(8.83584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66335,'amu*angstrom^2'), symmetry=1, barrier=(38.2436,'kJ/mol'), semiclassical=False),
...
species(
    label = '[O]C(F)(F)C(O)(F)C(F)F(9401)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    ...
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]C(O)(F)C(F)(F)OF(9395)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]F(137)', 'O[C](F)C(F)(F)OF(5158)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'OC(F)([C]F)C(F)(F)OF-2(9396)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(=CF)C(F)(F)OF(5623)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'FC=C(F)C(F)(F)OF(4950)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FO[C](F)F(2677)', 'OC(F)=CF(878)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[C]([CH]F)C(F)(F)OF(9397)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)([CH]F)[C](F)OF(9398)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)(F)C(O)(F)[CH]F(3229)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'F[CH][C](F)C(F)(F)OF(3885)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)([CH]F)C(F)(F)OF(9349)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(128)', 'OC(F)([CH]F)[C](F)F(5015)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FO[C](F)F(2677)', 'O[C](F)[CH]F(881)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', 'O=C(F)C(O)(F)[CH]F(9399)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'OC([CH]F)=C(F)OF(9400)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CHF(40)', 'O[C](F)C(F)(F)OF(5158)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'OC(F)([C]F)C(F)(F)OF(5611)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)(CF)C(F)(F)OF(5619)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
    products = ['[O]C(F)(F)C(O)(F)C(F)F(9401)'],
...
reaction(
    label = 'reaction27',
    reactants = ['OC(F)([C](F)OF)C(F)F(9402)'],
    products = ['OC(F)([CH]F)C(F)(F)OF(5620)'],
