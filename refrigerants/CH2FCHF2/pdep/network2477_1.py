...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[CH]=C[O](4002)'],
    products = ['[CH]=CO[C]=O(9528)'],
    transitionState = 'TS2',
