...
reaction(
    label = 'reaction12',
    reactants = ['O(6)', '[O][CH]C(=O)F(509)'],
    products = ['[O]O[CH]C(=O)F(1948)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', '[O]O[C]=C=O(8937)'],
    products = ['[O]O[CH]C(=O)F(1948)'],
