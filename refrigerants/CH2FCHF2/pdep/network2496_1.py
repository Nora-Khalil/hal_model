...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(1130)', '[CH]C-2(4371)'],
    products = ['C[CH]OO[C]=O(9560)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(514)', 'C[CH]O[O](9403)'],
    products = ['C[CH]OO[C]=O(9560)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(517)', 'C[CH][O](4438)'],
    products = ['C[CH]OO[C]=O(9560)'],
