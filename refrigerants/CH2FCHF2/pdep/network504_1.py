...
"""),
    E0 = (-496.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,363.434,368.811],'cm^-1')),
        HinderedRotor(inertia=(0.0758969,'amu*angstrom^2'), symmetry=1, barrier=(7.24316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0745809,'amu*angstrom^2'), symmetry=1, barrier=(7.25307,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(488)', 'C=C(C)F(2860)'],
    products = ['CC(F)(F)COF(2798)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)C[O](2862)'],
    products = ['CC(F)(F)COF(2798)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(128)', '[CH2]C(C)(F)F(2863)'],
    products = ['CC(F)(F)COF(2798)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OF(2545)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)COF(2798)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'FOC[C](F)F(2864)'],
    products = ['CC(F)(F)COF(2798)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)(F)[CH]OF(709)'],
    products = ['CC(F)(F)COF(2798)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)COF(2865)'],
    products = ['CC(F)(F)COF(2798)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC(F)(F)C=O(715)'],
    products = ['CC(F)(F)COF(2798)'],
