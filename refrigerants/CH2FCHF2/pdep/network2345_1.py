...
"""),
    E0 = (-241.516,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,395,473,707,1436,580,1155,1237,1373,3147,238.543,410.63,410.683,410.69,410.708,410.735,410.741,2230.66],'cm^-1')),
        HinderedRotor(inertia=(0.00955253,'amu*angstrom^2'), symmetry=1, barrier=(33.7296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0258395,'amu*angstrom^2'), symmetry=1, barrier=(33.7298,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0634,0.0463611,-4.76866e-05,2.62439e-08,-6.06239e-12,-28981,20.0518], Tmin=(100,'K'), Tmax=(1017.5,'K')), NASAPolynomial(coeffs=[8.38912,0.0214935,-1.10269e-05,2.22459e-09,-1.60862e-13,-30268.3,-10.5759], Tmin=(1017.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-241.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsFHHO) + ring(Cs(O2)-O2s-Cs(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41349,0.0746896,-0.000162849,1.74053e-07,-6.72454e-11,-28836.6,19.5763], Tmin=(100,'K'), Tmax=(856.176,'K')), NASAPolynomial(coeffs=[0.118858,0.0372012,-2.08944e-05,4.12747e-09,-2.85387e-13,-27019.2,34.94], Tmin=(856.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-240.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(oxirene)"""),
)
...
"""),
    E0 = (-42.7026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,580,1155,1237,1373,3147,180,180,180,180,2042.75,2054.49],'cm^-1')),
        HinderedRotor(inertia=(0.308095,'amu*angstrom^2'), symmetry=1, barrier=(7.08372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.307988,'amu*angstrom^2'), symmetry=1, barrier=(7.08126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32498,0.0789396,-0.000182459,1.94732e-07,-7.4249e-11,-5058.87,20.6417], Tmin=(100,'K'), Tmax=(867.196,'K')), NASAPolynomial(coeffs=[0.251649,0.0344058,-1.98336e-05,3.91068e-09,-2.68368e-13,-3012.02,36.3951], Tmin=(867.196,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.7026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsCsCs) + group(CdCFO) + ring(oxirene) + radical(Csj(F1s)(O2s-Cd)(H)) + longDistanceInteraction_cyclic(Cd(F)=CdOs)"""),
)
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28846,0.0422156,-3.83663e-05,1.85876e-08,-3.89247e-12,-31390.4,20.114], Tmin=(100,'K'), Tmax=(1086.01,'K')), NASAPolynomial(coeffs=[7.45624,0.0231816,-1.20766e-05,2.44925e-09,-1.7742e-13,-32512.9,-5.24393], Tmin=(1086.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-261.475,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsFHHO) + ring(Cs(O2)-O2s-Cs(F)) + radical(Cs_P) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = 'FCO[C]1O[C]1F(8871)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-234.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,395,473,707,1436,180,180,180,858.687,858.922,860.469,860.616],'cm^-1')),
        HinderedRotor(inertia=(0.00899916,'amu*angstrom^2'), symmetry=1, barrier=(4.71845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92605,'amu*angstrom^2'), symmetry=1, barrier=(44.2836,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13707,0.0423065,-3.63946e-05,1.56185e-08,-2.75804e-12,-28193.4,20.9005], Tmin=(100,'K'), Tmax=(1309.98,'K')), NASAPolynomial(coeffs=[9.86506,0.0187089,-9.37351e-06,1.86695e-09,-1.33602e-13,-30218.1,-18.4691], Tmin=(1309.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsFHHO) + ring(Cs(O2)-O2s-Cs(F)) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(O2s-Cs)_ring)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(137)', '[O]C1O[C]1F(8497)'],
    products = ['F[CH]OC1O[C]1F(8863)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]O[CH]F(1613)'],
    products = ['F[CH]OC1O[C]1F(8863)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]OC1=C(F)O1(8869)'],
    products = ['F[CH]OC1O[C]1F(8863)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[O]C1O[C]1F(8497)'],
    products = ['F[CH]OC1O[C]1F(8863)'],
