...
reaction(
    label = 'reaction3',
    reactants = ['O[C]1OC[C](F)O1(15336)'],
    products = ['C=C(F)OC(=O)O(6107)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)OC([O])=O(15339)'],
    products = ['C=C(F)OC(=O)O(6107)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(F)O[C](O)O(15340)'],
    products = ['C=C(F)OC(=O)O(6107)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=[C]OC(=O)O(15342)'],
    products = ['C=C(F)OC(=O)O(6107)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(4707)', 'CH2CF(70)'],
    products = ['C=C(F)OC(=O)O(6107)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=C(F)O[C]=O(538)'],
    products = ['C=C(F)OC(=O)O(6107)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(F)OC([O])=O(4600)'],
    products = ['C=C(F)OC(=O)O(6107)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)OC(=O)O(4706)'],
    products = ['C=C(F)OC(=O)O(6107)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COC(=O)O(4713)'],
    products = ['C=C(F)OC(=O)O(6107)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(25)', 'O=C(O)[O+]=[C-]F(4715)'],
    products = ['C=C(F)OC(=O)O(6107)'],
