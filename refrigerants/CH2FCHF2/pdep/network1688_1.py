...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.844572,'amu*angstrom^2'), symmetry=1, barrier=(19.4184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84457,'amu*angstrom^2'), symmetry=1, barrier=(19.4183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844571,'amu*angstrom^2'), symmetry=1, barrier=(19.4183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844589,'amu*angstrom^2'), symmetry=1, barrier=(19.4188,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.972204,'amu*angstrom^2'), symmetry=1, barrier=(22.3529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.97424,'amu*angstrom^2'), symmetry=1, barrier=(22.3997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.974644,'amu*angstrom^2'), symmetry=1, barrier=(22.409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.969147,'amu*angstrom^2'), symmetry=1, barrier=(22.2826,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-330.522,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,246.127,250.105,254.809],'cm^-1')),
        HinderedRotor(inertia=(0.18451,'amu*angstrom^2'), symmetry=1, barrier=(8.14803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185035,'amu*angstrom^2'), symmetry=1, barrier=(8.14713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181326,'amu*angstrom^2'), symmetry=1, barrier=(8.14409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.500714,'amu*angstrom^2'), symmetry=1, barrier=(22.2362,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.535627,0.0835392,-0.000135499,1.16768e-07,-3.93145e-11,-39634.9,25.3891], Tmin=(100,'K'), Tmax=(839.074,'K')), NASAPolynomial(coeffs=[9.82059,0.0272191,-1.32623e-05,2.52186e-09,-1.72594e-13,-40768.6,-15.2472], Tmin=(839.074,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-330.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(O)(F)COF(5758)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-351.311,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,198.091,199.444],'cm^-1')),
        HinderedRotor(inertia=(0.408237,'amu*angstrom^2'), symmetry=1, barrier=(11.5029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.259132,'amu*angstrom^2'), symmetry=1, barrier=(7.24686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260221,'amu*angstrom^2'), symmetry=1, barrier=(7.24565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24097,'amu*angstrom^2'), symmetry=1, barrier=(34.5593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
...
"""),
    E0 = (-645.127,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,333,384,448,608,1254,1480,528,1116,1182,1331,1402,1494,3075,3110,2750,2850,1437.5,1250,1305,750,350,227.375,227.375,227.377],'cm^-1')),
        HinderedRotor(inertia=(0.226705,'amu*angstrom^2'), symmetry=1, barrier=(8.31714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226703,'amu*angstrom^2'), symmetry=1, barrier=(8.31714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.999775,'amu*angstrom^2'), symmetry=1, barrier=(36.6789,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.706,0.0606563,-4.73473e-05,-3.27906e-08,5.97349e-11,-77518.8,21.3742], Tmin=(100,'K'), Tmax=(479.386,'K')), NASAPolynomial(coeffs=[7.23739,0.0326468,-1.64795e-05,3.23669e-09,-2.27912e-13,-78257.6,-3.41911], Tmin=(479.386,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-645.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-502.374,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,286,334,437,422,648,895,1187,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,217.104,217.11,217.129],'cm^-1')),
        HinderedRotor(inertia=(0.24014,'amu*angstrom^2'), symmetry=1, barrier=(8.03248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240275,'amu*angstrom^2'), symmetry=1, barrier=(8.03267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.739861,'amu*angstrom^2'), symmetry=1, barrier=(24.7499,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.512961,0.0829353,-0.000122903,9.87361e-08,-3.19827e-11,-60301.9,25.9615], Tmin=(100,'K'), Tmax=(754.413,'K')), NASAPolynomial(coeffs=[10.8075,0.0283512,-1.43721e-05,2.82651e-09,-1.99295e-13,-61855.1,-20.8025], Tmin=(754.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-502.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-F1sCsCs))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.382486,'amu*angstrom^2'), symmetry=1, barrier=(8.7941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.381948,'amu*angstrom^2'), symmetry=1, barrier=(8.78174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.38215,'amu*angstrom^2'), symmetry=1, barrier=(8.78637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38217,'amu*angstrom^2'), symmetry=1, barrier=(31.7788,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
...
"""),
    E0 = (-407.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,391.559,391.57,391.603],'cm^-1')),
        HinderedRotor(inertia=(0.0889908,'amu*angstrom^2'), symmetry=1, barrier=(9.68556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114734,'amu*angstrom^2'), symmetry=1, barrier=(12.4853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224297,'amu*angstrom^2'), symmetry=1, barrier=(24.405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46798,0.0598146,-6.83183e-05,4.23007e-08,-1.08089e-11,-48910,21.758], Tmin=(100,'K'), Tmax=(937.054,'K')), NASAPolynomial(coeffs=[9.66661,0.024817,-1.22954e-05,2.44313e-09,-1.75169e-13,-50446.5,-17.2626], Tmin=(937.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-407.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)OsHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs)"""),
)
...
"""),
    E0 = (-392.06,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,194,682,905,1196,1383,3221,314.138,314.143],'cm^-1')),
        HinderedRotor(inertia=(0.0571301,'amu*angstrom^2'), symmetry=1, barrier=(4.00072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183617,'amu*angstrom^2'), symmetry=1, barrier=(12.8584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239023,'amu*angstrom^2'), symmetry=1, barrier=(16.7382,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22695,0.0632122,-7.48724e-05,4.61471e-08,-1.13963e-11,-47055.9,22.5726], Tmin=(100,'K'), Tmax=(982.858,'K')), NASAPolynomial(coeffs=[11.7378,0.0204349,-9.58668e-06,1.86367e-09,-1.32196e-13,-49122,-27.9545], Tmin=(982.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-392.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['OCF(781)', 'F[C]COF(2842)'],
    products = ['OC(F)(CF)COF(5402)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'OC(F)([C]F)COF(5753)'],
    products = ['OC(F)(CF)COF(5402)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'OC(F)COF(5391)'],
    products = ['OC(F)(CF)COF(5402)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(25)', 'OC(F)(F)COF(5396)'],
    products = ['OC(F)(CF)COF(5402)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['H2O(3)', 'FC=C(F)COF(5549)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OF(482)', 'C=C(F)COF(2856)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FOF(488)', 'C=C(O)CF(5756)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O[C](CF)COF(5757)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C(O)(F)COF(5758)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]CC(O)(F)CF(5759)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'FC[C](F)COF(2853)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(F)(CF)COF(5760)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]F(128)', '[CH2]C(O)(F)CF(5761)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]OF(2545)', 'O[C](F)CF(2940)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2F(46)', 'O[C](F)COF(5652)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'OC(F)([CH]OF)CF(5517)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'OC(F)([CH]F)COF(5762)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C(CF)COF(5763)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F2(78)', 'C=C(O)COF(5764)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'O=CC(O)(F)CF(3454)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'OC(=COF)CF(5523)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'OC(=CF)COF(5765)'],
    products = ['OC(F)(CF)COF(5402)'],
...
reaction(
    label = 'reaction29',
    reactants = ['OC(F)(CF)COF(5402)'],
    products = ['F2(78)', 'CH2O(20)', 'C=C(O)F(3010)'],
...
reaction(
    label = 'reaction30',
    reactants = ['OC(F)(CF)COF(5402)'],
    products = ['HF(38)', 'CH2O(20)', 'OC(F)=CF(878)'],
