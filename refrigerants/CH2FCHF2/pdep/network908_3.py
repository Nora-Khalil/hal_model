...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.848284,'amu*angstrom^2'), symmetry=1, barrier=(19.5037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0239,'amu'),
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)[C](F)F(3745)'],
    products = ['[O]C(F)[C](F)F(429)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC1(F)[CH]O1(3546)'],
    products = ['FC1OC1(F)F(3742)'],
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C]1OC1(F)F(5985)'],
    products = ['FC1OC1(F)F(3742)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1=C(F)O1(5986)'],
    products = ['FC1OC1(F)F(3742)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C](F)F(2580)', '[CH]F(137)'],
    products = ['[O]C(F)(F)[CH]F(2586)'],
