...
species(
    label = 'F[CH]C(F)[C](F)C(F)(F)F(11903)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][CH]C(F)(F)C(F)(F)F(11904)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
...
reaction(
    ...
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
    products = ['FC=C(F)C(F)(F)C(F)F(11900)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]C(F)C(F)=C(F)F(3695)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CF2CF2(61)', 'F[CH][CH]F(141)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=CC(F)(F)[C](F)F(10995)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[C](F)[C](F)F(4977)', 'CHFCHF[Z](59)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC=C(F)C(F)(F)[C](F)F(11901)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)[C](F)F(4977)', 'F[CH][CH]F(141)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'F[CH]C=C(F)[C](F)F(3698)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
    products = ['FC[C](F)C(F)(F)[C](F)F(11902)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
    products = ['F[CH]C(F)[C](F)C(F)(F)F(11903)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
    products = ['F[CH][CH]C(F)(F)C(F)(F)F(11904)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11867)'],
    products = ['F[C](F)C(F)(F)[CH]C(F)F(7253)'],
