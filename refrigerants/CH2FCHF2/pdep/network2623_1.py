...
"""),
    E0 = (-324.425,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,157,399,436,611,601,744,1127,2175,525,239,401,1367,180],'cm^-1')),
        HinderedRotor(inertia=(0.0968563,'amu*angstrom^2'), symmetry=1, barrier=(2.22692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.443609,'amu*angstrom^2'), symmetry=1, barrier=(10.1994,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.026,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02262,0.0747892,-0.000140444,1.28052e-07,-4.38752e-11,-38921,22.392], Tmin=(100,'K'), Tmax=(872.504,'K')), NASAPolynomial(coeffs=[8.73906,0.0192014,-1.01307e-05,1.93141e-09,-1.30166e-13,-39498.2,-9.37423], Tmin=(872.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-324.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFFO) + group(Ct-CtCs) + group(CtCF) + radical(ROOJ)"""),
)
...
"""),
    E0 = (-220.995,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,140,424,499,621,667,843,876,1082,1685,370,167,640,1190],'cm^-1')),
        HinderedRotor(inertia=(0.520443,'amu*angstrom^2'), symmetry=1, barrier=(11.966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.14573,'amu*angstrom^2'), symmetry=1, barrier=(49.3346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519111,'amu*angstrom^2'), symmetry=1, barrier=(11.9354,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.555037,0.0859842,-0.000160395,1.46787e-07,-5.10467e-11,-26465.3,25.7307], Tmin=(100,'K'), Tmax=(846.238,'K')), NASAPolynomial(coeffs=[9.72554,0.0226439,-1.26823e-05,2.49984e-09,-1.72807e-13,-27301.5,-12.7509], Tmin=(846.238,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-220.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sF1sO2s)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[CH][C]=C(F)OOF(10562)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (41.429,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,293,496,537,1218,234,589,736,816,1240,3237,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.726043,'amu*angstrom^2'), symmetry=1, barrier=(16.6931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.82961,0.0819087,-0.000158716,1.52539e-07,-5.51468e-11,5085.2,26.0527], Tmin=(100,'K'), Tmax=(847.081,'K')), NASAPolynomial(coeffs=[6.85256,0.0271859,-1.52744e-05,3.02069e-09,-2.09338e-13,5007.74,3.56068], Tmin=(847.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(CsCFHH) + group(Cds-CdsCsH) + group(CdCFO) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-F1sO2s))"""),
)

species(
    label = '[O]OC(F)=C(F)[CH]F(10563)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {8,S}
...
"""),
    E0 = (-315.833,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,271,519,563,612,1379,326,540,652,719,1357,234,589,736,816,1240,3237],'cm^-1')),
        HinderedRotor(inertia=(0.16994,'amu*angstrom^2'), symmetry=1, barrier=(3.90725,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172367,'amu*angstrom^2'), symmetry=1, barrier=(3.96307,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02518,0.0765401,-0.000144807,1.37872e-07,-4.94209e-11,-37889.5,25.3206], Tmin=(100,'K'), Tmax=(855.022,'K')), NASAPolynomial(coeffs=[6.5458,0.0263967,-1.41782e-05,2.75832e-09,-1.8942e-13,-37944.7,4.74926], Tmin=(855.022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-315.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(ROOJ) + radical(Csj(Cd-CdF1s)(F1s)(H))"""),
)

species(
    label = '[CH]=[C]C(F)(F)OOF(10564)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (49.1237,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,140,424,499,621,667,843,876,1082,1685,370,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.878186,'amu*angstrom^2'), symmetry=1, barrier=(20.1912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188499,'amu*angstrom^2'), symmetry=1, barrier=(4.33397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.22457,'amu*angstrom^2'), symmetry=1, barrier=(51.1472,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.582472,0.08475,-0.000155384,1.4222e-07,-5.00303e-11,6022.03,25.8345], Tmin=(100,'K'), Tmax=(823.924,'K')), NASAPolynomial(coeffs=[9.70312,0.0236644,-1.35765e-05,2.72155e-09,-1.90823e-13,5089.54,-12.9391], Tmin=(823.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.1237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sFO) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sF1sO2s)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)C(F)(F)O[O](10565)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.743248,0.0789561,-0.000137909,1.20128e-07,-4.02293e-11,-38883.4,24.2096], Tmin=(100,'K'), Tmax=(846.224,'K')), NASAPolynomial(coeffs=[10.6617,0.0194975,-1.02231e-05,1.97473e-09,-1.35363e-13,-40111.8,-19.3248], Tmin=(846.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-324.211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCsCdF) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    ...
    products = ['[O]OC(F)(F)[C]=CF(9729)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(10834.1,'m^3/(mol*s)'), n=0.762578, Ea=(57.9101,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)(F)[C]=CF(9729)'],
    products = ['O=O(207)', 'FC=C=C(F)F(5101)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(40.0912,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission
Ea raised from 0.0 to 40.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[C]=CF(2656)'],
    products = ['[O]OC(F)(F)[C]=CF(9729)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(219)', '[C]=CF-2(3543)'],
    products = ['[O]OC(F)(F)[C]=CF(9729)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)[C]=CF(9729)'],
    products = ['O(6)', 'FC=C1OC1(F)F(10315)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]OC(F)=C=CF(10557)'],
    products = ['[O]OC(F)(F)[C]=CF(9729)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(33.8555,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CC(F)(F)O[O](10558)'],
    products = ['[O]OC(F)(F)[C]=CF(9729)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(50.8111,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)(F)C#CF(10559)'],
    products = ['[O]OC(F)(F)[C]=CF(9729)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.6844e+07,'m^3/(mol*s)'), n=-0.361029, Ea=(3.92502,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H_Ext-2C-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH][C]=C(F)OOF(10562)'],
    products = ['[O]OC(F)(F)[C]=CF(9729)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(87.3448,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction14',
    reactants = ['[O]OC(F)=C(F)[CH]F(10563)'],
    products = ['[O]OC(F)(F)[C]=CF(9729)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(152.227,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C]C(F)(F)OOF(10564)'],
    products = ['[O]OC(F)(F)[C]=CF(9729)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(62.5494,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction16',
    reactants = ['[O]OC(F)(F)[C]=CF(9729)'],
    products = ['[CH]=C(F)C(F)(F)O[O](10565)'],
