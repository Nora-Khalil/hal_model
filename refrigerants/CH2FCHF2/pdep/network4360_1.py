...
"""),
    E0 = (-346.973,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,519,593,830,1115,1166,1389,1413,3114,350,440,435,1725,3120,650,792.5,1650,253.738,254.237,254.642],'cm^-1')),
        HinderedRotor(inertia=(0.248541,'amu*angstrom^2'), symmetry=1, barrier=(11.3766,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248625,'amu*angstrom^2'), symmetry=1, barrier=(11.3776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.497083,'amu*angstrom^2'), symmetry=1, barrier=(22.7585,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.550421,0.0808757,-0.000126707,9.91257e-08,-3.03389e-11,-41611.6,24.4559], Tmin=(100,'K'), Tmax=(805.453,'K')), NASAPolynomial(coeffs=[13.2683,0.0177183,-9.09108e-06,1.77797e-09,-1.24363e-13,-43660.4,-34.1491], Tmin=(805.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-346.973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.979853,'amu*angstrom^2'), symmetry=1, barrier=(22.5288,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09818,0.0602324,-8.44192e-05,5.17854e-08,-1.16165e-11,23611.4,19.5294], Tmin=(100,'K'), Tmax=(961.288,'K')), NASAPolynomial(coeffs=[17.4906,-0.00125667,1.04055e-06,-2.08499e-10,1.37683e-14,20149.2,-60.5229], Tmin=(961.288,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(195.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cds_P)"""),
)
...
"""),
    E0 = (-35.9671,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,519,593,830,1115,1166,1389,1413,3114,350,440,435,1725,280.193,285.46,286.283,289.116],'cm^-1')),
        HinderedRotor(inertia=(0.139731,'amu*angstrom^2'), symmetry=1, barrier=(8.12817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137771,'amu*angstrom^2'), symmetry=1, barrier=(8.14347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.402986,'amu*angstrom^2'), symmetry=1, barrier=(23.321,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.490299,0.0849853,-0.00015218,1.3244e-07,-4.41322e-11,-4206.92,24.6395], Tmin=(100,'K'), Tmax=(844.146,'K')), NASAPolynomial(coeffs=[11.982,0.0176777,-9.73725e-06,1.90633e-09,-1.31269e-13,-5689.06,-26.1414], Tmin=(844.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.9671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CdCdJ2_triplet)"""),
)
...
"""),
    E0 = (83.1548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,580,1155,1237,1373,3147,3120,650,792.5,1650,308.032,308.033,308.033],'cm^-1')),
        HinderedRotor(inertia=(0.175427,'amu*angstrom^2'), symmetry=1, barrier=(11.8122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175421,'amu*angstrom^2'), symmetry=1, barrier=(11.8123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348299,'amu*angstrom^2'), symmetry=1, barrier=(23.4513,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.955099,0.0724605,-0.000114027,8.58661e-08,-2.39358e-11,10105.8,22.8073], Tmin=(100,'K'), Tmax=(687.205,'K')), NASAPolynomial(coeffs=[12.3994,0.0147655,-7.55986e-06,1.4653e-09,-1.01522e-13,8322.28,-29.6438], Tmin=(687.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.1548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFHHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(F1s)(O2s-Cd)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=O)OC(F)F(6867)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28836,0.0408167,-3.53456e-05,1.62677e-08,-3.20593e-12,-50997.1,21.717], Tmin=(100,'K'), Tmax=(1156,'K')), NASAPolynomial(coeffs=[7.73764,0.0219608,-1.08783e-05,2.15713e-09,-1.54288e-13,-52257,-5.36249], Tmin=(1156,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-424.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(CsFFHO) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (156.657,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,180,180,180,944.701,944.756,944.778,944.797,944.8],'cm^-1')),
        HinderedRotor(inertia=(0.233745,'amu*angstrom^2'), symmetry=1, barrier=(5.37425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00848493,'amu*angstrom^2'), symmetry=1, barrier=(5.37356,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0265,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.68643,0.0316504,-3.90118e-05,2.53271e-08,-6.69745e-12,18886.5,15.2866], Tmin=(100,'K'), Tmax=(910.727,'K')), NASAPolynomial(coeffs=[7.23037,0.0116933,-6.14235e-06,1.26654e-09,-9.27813e-14,18058.8,-6.21048], Tmin=(910.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(156.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.271569,'amu*angstrom^2'), symmetry=1, barrier=(6.24389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.270992,'amu*angstrom^2'), symmetry=1, barrier=(6.23065,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82522,0.0590307,-0.00011918,1.19908e-07,-4.43445e-11,-10359.4,20.8031], Tmin=(100,'K'), Tmax=(864.48,'K')), NASAPolynomial(coeffs=[3.68864,0.0240239,-1.26566e-05,2.45416e-09,-1.67907e-13,-9695.68,17.7868], Tmin=(864.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.6948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(OF)O[C](F)F(15138)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {7,S}
3 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-132.571,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,493,600,700,1144,1293,3120,650,792.5,1650,309.155,324.863,724.695],'cm^-1')),
        HinderedRotor(inertia=(0.14484,'amu*angstrom^2'), symmetry=1, barrier=(10.7237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0983617,'amu*angstrom^2'), symmetry=1, barrier=(7.84331,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.358659,'amu*angstrom^2'), symmetry=1, barrier=(26.8264,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.875434,0.0733628,-0.000111478,8.32683e-08,-2.43292e-11,-15836.3,25.5687], Tmin=(100,'K'), Tmax=(842.429,'K')), NASAPolynomial(coeffs=[13.069,0.015467,-8.39217e-06,1.69186e-09,-1.20984e-13,-17890.7,-31.1674], Tmin=(842.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-Cd)) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-379.667,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,2950,3100,1380,975,1025,1650,493,600,700,1144,1293,337.32,337.399,337.839,1723.37],'cm^-1')),
        HinderedRotor(inertia=(0.139935,'amu*angstrom^2'), symmetry=1, barrier=(11.2332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206518,'amu*angstrom^2'), symmetry=1, barrier=(16.6449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.29754,'amu*angstrom^2'), symmetry=1, barrier=(23.9435,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04547,0.0686747,-9.05925e-05,6.01462e-08,-1.58291e-11,-45560.1,24.5575], Tmin=(100,'K'), Tmax=(927.637,'K')), NASAPolynomial(coeffs=[12.6631,0.0185784,-9.58524e-06,1.92787e-09,-1.38918e-13,-47715.5,-30.6182], Tmin=(927.637,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-379.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)

species(
    label = 'O=C([CH]F)OC(F)F(7911)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-868.986,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,235,1215,1347,1486,3221,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58988,0.0583954,-7.15777e-05,4.9601e-08,-1.44601e-11,-104433,23.2172], Tmin=(100,'K'), Tmax=(820.197,'K')), NASAPolynomial(coeffs=[8.04098,0.0269336,-1.40382e-05,2.83125e-09,-2.04117e-13,-105491,-6.62681], Tmin=(820.197,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-868.986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFFHO) + group(Cds-OdCsOs) + radical(Csj(CO-O2sO2d)(F1s)(H))"""),
)

species(
    label = 'F[CH]OC(=CF)OF(15139)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-328.939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,194,682,905,1196,1383,3221,580,1155,1237,1373,3147,275.545,275.574,275.71,1664.36],'cm^-1')),
        HinderedRotor(inertia=(0.173812,'amu*angstrom^2'), symmetry=1, barrier=(9.36398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173655,'amu*angstrom^2'), symmetry=1, barrier=(9.36293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.653241,'amu*angstrom^2'), symmetry=1, barrier=(35.1798,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.616505,0.0828713,-0.00014469,1.29417e-07,-4.48581e-11,-39448.5,25.0621], Tmin=(100,'K'), Tmax=(824.554,'K')), NASAPolynomial(coeffs=[9.74734,0.0246047,-1.3276e-05,2.61647e-09,-1.82249e-13,-40479.3,-14.3473], Tmin=(824.554,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFHHO) + group(Cds-CdsCsCs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(F1s)(O2s-Cd)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(OF)OC(F)F(12780)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[CH]=C(OF)OF(15134)'],
    products = ['[CH]=C(OF)OC(F)F(12780)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[C]=C(OF)OC(F)F(15135)'],
    products = ['[CH]=C(OF)OC(F)F(12780)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(364)', 'C#COF(8042)'],
    products = ['[CH]=C(OF)OC(F)F(12780)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]F(128)', 'C#COC(F)F(8286)'],
    products = ['[CH]=C(OF)OC(F)F(12780)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(OF)O[CH]F(15136)'],
    products = ['[CH]=C(OF)OC(F)F(12780)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH]C(=O)OC(F)F(6867)'],
    products = ['[CH]=C(OF)OC(F)F(12780)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(82)', '[CH]C(=O)OF(15137)'],
    products = ['[CH]=C(OF)OC(F)F(12780)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)F(364)', '[CH]=[C]OF(8043)'],
    products = ['[CH]=C(OF)OC(F)F(12780)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(128)', '[CH]=[C]OC(F)F(470)'],
    products = ['[CH]=C(OF)OC(F)F(12780)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH]=C(OF)O[C](F)F(15138)'],
    products = ['[CH]=C(OF)OC(F)F(12780)'],
...
network(
    label = 'PDepNetwork #4360',
    isomers = [
        '[CH]=C(OF)OC(F)F(12780)',
    ],
    reactants = [
