...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C(=O)F(323)'],
    products = ['[CH]=C(F)O[CH2](2558)'],
    transitionState = 'TS2',
