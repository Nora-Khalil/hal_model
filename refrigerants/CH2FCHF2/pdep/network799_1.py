...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.169126,0.0955048,-0.000168274,1.548e-07,-5.47631e-11,-92905.9,29.9982], Tmin=(100,'K'), Tmax=(836.116,'K')), NASAPolynomial(coeffs=[8.74761,0.0328501,-1.70939e-05,3.33909e-09,-2.31464e-13,-93584.9,-5.33438], Tmin=(836.116,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-773.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[CH][C](F)CC(F)(F)F(3732)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0867154,0.0954149,-0.000161405,1.43831e-07,-5.01769e-11,-96879.9,29.9833], Tmin=(100,'K'), Tmax=(808.604,'K')), NASAPolynomial(coeffs=[10.3663,0.0308675,-1.62588e-05,3.21523e-09,-2.25422e-13,-98094.6,-14.6569], Tmin=(808.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-806.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C[C](F)F(3674)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)CC(F)[C](F)F(3675)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(137)', 'F[C](F)C[C](F)F(195)'],
    products = ['F[CH]C(F)(F)C[C](F)F(3674)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=C(F)C[C](F)F(164)'],
    products = ['F[CH]C(F)(F)C[C](F)F(3674)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH]C(F)(F)C=C(F)F(3730)'],
    products = ['F[CH]C(F)(F)C[C](F)F(3674)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[CH]C(F)=C[C](F)F(3699)'],
    products = ['F[CH]C(F)(F)C[C](F)F(3674)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', 'F[C](F)C[C](F)F(195)'],
    products = ['F[CH]C(F)(F)C[C](F)F(3674)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)[CH]C(F)F(3716)'],
    products = ['F[CH]C(F)(F)C[C](F)F(3674)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FCC(F)(F)[CH][C](F)F(3731)'],
    products = ['F[CH]C(F)(F)C[C](F)F(3674)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C[C](F)F(3674)'],
    products = ['F[C](F)C[C](F)C(F)F(3724)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C[C](F)F(3674)'],
    products = ['F[CH][C](F)CC(F)(F)F(3732)'],
