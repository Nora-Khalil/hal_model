...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.04246,'amu*angstrom^2'), symmetry=1, barrier=(23.9683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04316,'amu*angstrom^2'), symmetry=1, barrier=(23.9843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04225,'amu*angstrom^2'), symmetry=1, barrier=(23.9633,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (152.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.511096,0.10492,-0.000165651,1.29595e-07,-3.94467e-11,-44075.4,32.6764], Tmin=(100,'K'), Tmax=(811.828,'K')), NASAPolynomial(coeffs=[16.555,0.0208203,-1.02395e-05,1.95362e-09,-1.34247e-13,-46845.9,-46.0973], Tmin=(811.828,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-367.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.3477,'amu*angstrom^2'), symmetry=1, barrier=(30.9864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34873,'amu*angstrom^2'), symmetry=1, barrier=(31.01,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (136.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.576968,0.080512,-0.000111607,7.9597e-08,-2.26111e-11,-59834.9,27.7263], Tmin=(100,'K'), Tmax=(860.15,'K')), NASAPolynomial(coeffs=[12.8606,0.0233889,-1.19906e-05,2.38835e-09,-1.70548e-13,-61948,-29.6844], Tmin=(860.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-OdCsH) + group(Cds-CdsOsH) + radical(C=OCOJ) + radical(C=COJ)"""),
)
...
species(
    label = '[O]C(F)(C=O)C1(F)[CH]OO1(2370)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (152.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.369521,0.0870384,-0.000124574,9.61976e-08,-3.01459e-11,-43676.4,29.609], Tmin=(100,'K'), Tmax=(776.687,'K')), NASAPolynomial(coeffs=[11.251,0.0309936,-1.63275e-05,3.27746e-09,-2.34477e-13,-45366.5,-20.137], Tmin=(776.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-364.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsCCFO) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Cs-Cs(F)-O2s-O2s) + radical(C=OCOJ) + radical(CCsJOO)"""),
)
...
species(
    label = '[O]C1OC1(F)C([O])(F)C=O(2371)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (152.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.970998,0.0780606,-8.8519e-05,2.57052e-08,2.1771e-11,-67162.3,27.4829], Tmin=(100,'K'), Tmax=(515.337,'K')), NASAPolynomial(coeffs=[8.60734,0.0366251,-1.98305e-05,4.01074e-09,-2.87486e-13,-68186.2,-6.59364], Tmin=(515.337,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-559.231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsOsOsH) + group(Cds-OdCsH) + ring(Cs(O2)-O2s-Cs(F)) + radical(C=OCOJ) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17784,'amu*angstrom^2'), symmetry=1, barrier=(27.0808,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13731,'amu*angstrom^2'), symmetry=1, barrier=(26.1489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23952,'amu*angstrom^2'), symmetry=1, barrier=(28.4989,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (133.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.474921,0.0852523,-0.000139618,1.22342e-07,-4.25062e-11,-64846.6,28.3026], Tmin=(100,'K'), Tmax=(791.383,'K')), NASAPolynomial(coeffs=[9.84653,0.0287639,-1.52627e-05,3.02146e-09,-2.1237e-13,-66044.4,-12.9128], Tmin=(791.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-540.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-OdCsH) + group(Cds-O2d(Cds-O2d)H) + radical(C=OCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.20482,'amu*angstrom^2'), symmetry=1, barrier=(27.7011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20265,'amu*angstrom^2'), symmetry=1, barrier=(27.6512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.135366,0.0722728,-8.45348e-05,4.54141e-08,-9.09128e-12,-25433.5,26.2704], Tmin=(100,'K'), Tmax=(1357.1,'K')), NASAPolynomial(coeffs=[21.4467,0.00240342,4.89601e-07,-1.843e-10,1.43727e-14,-30568.2,-80.6584], Tmin=(1357.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-CdsOsH) + group(Cds-O2d(Cds-O2d)H) + radical(C=OCOJ) + radical(C=COJ)"""),
)
...
species(
    label = '[O]C(F)(C=O)C(O)(F)[C]=O(2376)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (152.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.488994,0.10641,-0.000176929,1.47399e-07,-4.79262e-11,-83751.5,33.5187], Tmin=(100,'K'), Tmax=(806.991,'K')), NASAPolynomial(coeffs=[14.9129,0.0240566,-1.26818e-05,2.48173e-09,-1.72519e-13,-86041.6,-36.2709], Tmin=(806.991,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-697.633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(F)([C]=O)C(O)(F)C=O(2377)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {7,S} {12,S}
...
"""),
    ...
    molecularWeight = (152.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.488994,0.10641,-0.000176929,1.47399e-07,-4.79262e-11,-83751.5,33.5187], Tmin=(100,'K'), Tmax=(806.991,'K')), NASAPolynomial(coeffs=[14.9129,0.0240566,-1.26818e-05,2.48173e-09,-1.72519e-13,-86041.6,-36.2709], Tmin=(806.991,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-697.633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C=C(OF)C([O])(F)C=O(2378)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.23303,'amu*angstrom^2'), symmetry=1, barrier=(28.3497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23378,'amu*angstrom^2'), symmetry=1, barrier=(28.367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23264,'amu*angstrom^2'), symmetry=1, barrier=(28.3408,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (152.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.273301,0.0995032,-0.000145533,1.05674e-07,-3.00629e-11,-43643.6,31.7419], Tmin=(100,'K'), Tmax=(864.555,'K')), NASAPolynomial(coeffs=[16.4324,0.0222114,-1.14319e-05,2.26644e-09,-1.60973e-13,-46532.2,-46.4221], Tmin=(864.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-364.112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(C=COJ)"""),
)

species(
    label = '[O]C=C([O])C(F)(C=O)OF(2379)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.38187,'amu*angstrom^2'), symmetry=1, barrier=(31.772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38292,'amu*angstrom^2'), symmetry=1, barrier=(31.796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38206,'amu*angstrom^2'), symmetry=1, barrier=(31.7762,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (152.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.542392,0.0996981,-0.000133141,8.44213e-08,-2.05921e-11,-59171,31.1251], Tmin=(100,'K'), Tmax=(1013.3,'K')), NASAPolynomial(coeffs=[21.0637,0.0144066,-6.88066e-06,1.35101e-09,-9.67609e-14,-63549.7,-73.3968], Tmin=(1013.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-493.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
reaction(
    ...
    products = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=COF)C([O])(F)C=O(2368)'],
    products = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C=C(F)C([O])(F)C=O(2369)'],
    products = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
    products = ['[O]C(F)(C=O)C1(F)[CH]OO1(2370)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
    products = ['[O]C1OC1(F)C([O])(F)C=O(2371)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)(C=O)C(=O)C=O(2373)'],
    products = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', '[O]C(F)(C=O)C(=O)F(2196)'],
    products = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
    products = ['O=[C]C(=O)F(1543)', 'O=C(F)[CH]O(1552)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', '[O]C=C([O])C(=O)C=O(2374)'],
    products = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
    products = ['[O]C(F)(C=O)C(O)(F)[C]=O(2376)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
    products = ['[O]C(F)([C]=O)C(O)(F)C=O(2377)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C=C(OF)C([O])(F)C=O(2378)'],
    products = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C=C([O])C(F)(C=O)OF(2379)'],
    products = ['[O]C(F)(C=O)C([O])(F)C=O(1909)'],
