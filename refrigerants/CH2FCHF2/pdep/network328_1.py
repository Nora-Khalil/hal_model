...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[CH]OC=[C]F(1584)'],
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)[CH]OC#CF(1813)'],
    products = ['O=C(F)[CH]OC=[C]F(1584)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C=COC=[C]F(1814)'],
    products = ['O=C(F)[CH]OC=[C]F(1584)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(6)', 'F[C]=COC=[C]F(1818)'],
    products = ['O=C(F)[CH]OC=[C]F(1584)'],
