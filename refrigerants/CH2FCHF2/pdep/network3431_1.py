...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC(F)(F)OF(705)'],
    products = ['O=CCC(F)(F)OF(12770)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(488)', 'O=CC[C]F(12838)'],
    products = ['O=CCC(F)(F)OF(12770)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(482)', 'O=CC=C(F)F(331)'],
    products = ['O=CCC(F)(F)OF(12770)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C[CH]C(F)(F)OF(12839)'],
    products = ['O=CCC(F)(F)OF(12770)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=CC[C](F)OF(12841)'],
    products = ['O=CCC(F)(F)OF(12770)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)(F)CC=O(12842)'],
    products = ['O=CCC(F)(F)OF(12770)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(128)', 'O=CC[C](F)F(418)'],
    products = ['O=CCC(F)(F)OF(12770)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FO[C](F)F(2563)', 'CH2CHO(35)'],
    products = ['O=CCC(F)(F)OF(12770)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', '[CH2]C(F)(F)OF(2838)'],
    products = ['O=CCC(F)(F)OF(12770)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C=CC(F)(F)OF(7894)'],
    products = ['O=CCC(F)(F)OF(12770)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=[C]CC(F)(F)OF(12843)'],
    products = ['O=CCC(F)(F)OF(12770)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'O=CCC(=O)F(8354)'],
    products = ['O=CCC(F)(F)OF(12770)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=CC=C(F)OF(12844)'],
    products = ['O=CCC(F)(F)OF(12770)'],
