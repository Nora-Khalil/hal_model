...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.225291,0.101776,-0.000164222,1.42422e-07,-4.93213e-11,-123794,31.9709], Tmin=(100,'K'), Tmax=(773.247,'K')), NASAPolynomial(coeffs=[11.3153,0.0343175,-1.83097e-05,3.64441e-09,-2.57398e-13,-125347,-19.238], Tmin=(773.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1030.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + group(COCsFO) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-250.11,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,90,150,250,247,323,377,431,433,1065,1274,215.124,909.19,1250.17,1673.4,1847.95],'cm^-1')),
        HinderedRotor(inertia=(0.103319,'amu*angstrom^2'), symmetry=1, barrier=(3.07365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103319,'amu*angstrom^2'), symmetry=1, barrier=(3.07365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103319,'amu*angstrom^2'), symmetry=1, barrier=(3.07365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103319,'amu*angstrom^2'), symmetry=1, barrier=(3.07365,'kJ/mol'), semiclassical=False),
    ],
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.25011,0.0835049,-9.16148e-05,5.08069e-08,-1.0804e-11,-95513.4,26.7068], Tmin=(100,'K'), Tmax=(1250.18,'K')), NASAPolynomial(coeffs=[19.0775,0.016064,-3.97652e-06,4.89294e-10,-2.51848e-14,-99908.3,-69.1027], Tmin=(1250.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-795.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCsCsFF) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCFHO) + ring(12dioxane) + radical(CsCsF1sO2s) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[CH]C1(F)OOCC1(F)F(3828)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-370.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,293,496,537,1218,167,640,1190,180,180,2278.81],'cm^-1')),
        HinderedRotor(inertia=(0.194341,'amu*angstrom^2'), symmetry=1, barrier=(4.46828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19727,'amu*angstrom^2'), symmetry=1, barrier=(4.53561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.93032,'amu*angstrom^2'), symmetry=1, barrier=(44.3819,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.326354,0.111229,-0.00021093,2.03156e-07,-7.42027e-11,-44381.5,34.6509], Tmin=(100,'K'), Tmax=(835.811,'K')), NASAPolynomial(coeffs=[7.50763,0.039966,-2.24301e-05,4.46085e-09,-3.11209e-13,-44511.5,5.31799], Tmin=(835.811,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-370.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.11159,'amu*angstrom^2'), symmetry=1, barrier=(2.56566,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['FC=C(F)OOC[C](F)F(3586)'],
...
reaction(
    label = 'reaction2',
    reactants = ['FC=C(F)OOC[C](F)F(3586)'],
    products = ['O=C(F)C(F)OC[C](F)F(3825)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'F[C]COOC(F)=CF(3826)'],
    products = ['FC=C(F)OOC[C](F)F(3586)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(156)', '[CH2]OOC(F)=CF(3295)'],
    products = ['FC=C(F)OOC[C](F)F(3586)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['FC=C(F)OOC[C](F)F(3586)'],
    products = ['F[C]1OOCC(F)(F)C1F(3827)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FC=C(F)OOC[C](F)F(3586)'],
    products = ['F[CH]C1(F)OOCC1(F)F(3828)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=[C]OOC[C](F)F(3830)'],
    products = ['FC=C(F)OOC[C](F)F(3586)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(F)OOC[C](F)F(3831)'],
    products = ['FC=C(F)OOC[C](F)F(3586)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'F[C]=C(F)OOC[C](F)F(3833)'],
    products = ['FC=C(F)OOC[C](F)F(3586)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'C#COOC[C](F)F(3834)'],
    products = ['FC=C(F)OOC[C](F)F(3586)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'FC#COOC[C](F)F(3835)'],
    products = ['FC=C(F)OOC[C](F)F(3586)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', 'F[C]COOC(F)=CF-2(3836)'],
    products = ['FC=C(F)OOC[C](F)F(3586)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CF2(43)', '[CH2]OOC(F)=CF(3295)'],
    products = ['FC=C(F)OOC[C](F)F(3586)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]=C(F)OOCC(F)F(3838)'],
    products = ['FC=C(F)OOC[C](F)F(3586)'],
...
reaction(
    label = 'reaction24',
    reactants = ['FC=C(F)OOC[C](F)F(3586)'],
    products = ['[CH]=C(F)OOCC(F)(F)F(3840)'],
