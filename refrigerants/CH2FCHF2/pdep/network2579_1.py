...
"""),
    E0 = (-497.216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([140,424,499,621,667,843,876,1082,615,860,1140,1343,3152,1685,370,1855,455,950,180,180,1694.03],'cm^-1')),
        HinderedRotor(inertia=(2.14003,'amu*angstrom^2'), symmetry=1, barrier=(49.2036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.464655,'amu*angstrom^2'), symmetry=1, barrier=(10.6833,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.603877,0.0822547,-0.000137154,1.2063e-07,-4.1892e-11,-59686.3,26.6385], Tmin=(100,'K'), Tmax=(793.912,'K')), NASAPolynomial(coeffs=[9.85794,0.0264229,-1.42714e-05,2.83569e-09,-1.99459e-13,-60865.5,-14.044], Tmin=(793.912,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-497.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-OdOsH) + radical(Cdj(Cs-F1sF1sO2s)(Cd-F1sH)) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-296.865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,113,247,382,1207,3490,540,610,2055,1855,455,950,483.984,484.892,485.84,486.83],'cm^-1')),
        HinderedRotor(inertia=(0.000716456,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000714682,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03585,0.0713639,-0.000116709,1.01007e-07,-3.48882e-11,-35603.7,22.4663], Tmin=(100,'K'), Tmax=(759.882,'K')), NASAPolynomial(coeffs=[9.54211,0.022551,-1.23852e-05,2.49035e-09,-1.76849e-13,-36780,-15.469], Tmin=(759.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCddFO) + group(CdCddFH) + group(Cds-OdOsH) + group(Cdd-CdsCds) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-402.768,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([157,399,436,611,601,744,1127,2175,525,1855,455,950,750,770,3400,2100,282.788,283.826],'cm^-1')),
        HinderedRotor(inertia=(0.893635,'amu*angstrom^2'), symmetry=1, barrier=(50.8246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.895997,'amu*angstrom^2'), symmetry=1, barrier=(50.8225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.889203,'amu*angstrom^2'), symmetry=1, barrier=(50.8293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09348,0.0673963,-9.55573e-05,6.93624e-08,-1.98835e-11,-48340.2,20.6394], Tmin=(100,'K'), Tmax=(856.226,'K')), NASAPolynomial(coeffs=[11.7217,0.0177489,-8.58839e-06,1.65299e-09,-1.15392e-13,-50160.4,-28.9867], Tmin=(856.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-402.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + group(Cds-OdOsH) + group(Ct-CtCs) + group(Ct-CtH) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.748678,0.0779309,-0.000118198,9.46975e-08,-3.04976e-11,-61274.7,25.6072], Tmin=(100,'K'), Tmax=(758.837,'K')), NASAPolynomial(coeffs=[10.7943,0.0249751,-1.35135e-05,2.72277e-09,-1.94576e-13,-62799.2,-20.0842], Tmin=(758.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-510.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-OdOsH) + radical(Cdj(Cd-CsH)(F1s)) + radical((O)CJOC)"""),
)

species(
    label = 'O=COC(F)(F)[C]=[C]F(10477)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-443.547,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([140,424,499,621,667,843,876,1082,2782.5,750,1395,475,1775,1000,1685,370,167,640,1190,180,2366.07],'cm^-1')),
        HinderedRotor(inertia=(0.206873,'amu*angstrom^2'), symmetry=1, barrier=(4.75641,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.82667,'amu*angstrom^2'), symmetry=1, barrier=(41.9987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.82566,'amu*angstrom^2'), symmetry=1, barrier=(41.9755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.824519,0.0770129,-0.000125075,1.10764e-07,-3.94147e-11,-53238.9,27.7095], Tmin=(100,'K'), Tmax=(758.796,'K')), NASAPolynomial(coeffs=[8.88163,0.0280345,-1.53939e-05,3.10166e-09,-2.20746e-13,-54274.4,-7.7034], Tmin=(758.796,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-443.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-OdOsH) + radical(Cdj(Cs-F1sF1sO2s)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'O=[C]OC(F)=C(F)[CH]F(10478)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.355886,0.0888142,-0.000155579,1.38738e-07,-4.8262e-11,-63444,26.9246], Tmin=(100,'K'), Tmax=(802.161,'K')), NASAPolynomial(coeffs=[10.8066,0.0249216,-1.40761e-05,2.82912e-09,-1.99562e-13,-64741.7,-18.8281], Tmin=(802.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-528.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CsCFHH) + group(Cds-CdsCsH) + group(CdCFO) + group(COFOO) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-F1sO2s))"""),
)

species(
    label = '[CH]=C(F)C(F)(F)O[C]=O(10480)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.641673,0.0799299,-0.000119939,9.32635e-08,-2.89248e-11,-60299.7,25.4012], Tmin=(100,'K'), Tmax=(789.358,'K')), NASAPolynomial(coeffs=[11.8022,0.023375,-1.24693e-05,2.49747e-09,-1.77939e-13,-62061.6,-25.8019], Tmin=(789.358,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-502.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cdj(Cd-CsF1s)(H)) + radical((O)CJOC)"""),
)

species(
    label = '[CH]=[C]C(F)(F)OC(=O)F(10481)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.730874,'amu*angstrom^2'), symmetry=1, barrier=(16.8042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.95903,'amu*angstrom^2'), symmetry=1, barrier=(45.0419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114251,'amu*angstrom^2'), symmetry=1, barrier=(2.62686,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.716215,0.079155,-0.000124626,1.03682e-07,-3.46998e-11,-58981.8,27.6166], Tmin=(100,'K'), Tmax=(730.726,'K')), NASAPolynomial(coeffs=[10.5418,0.0253575,-1.41683e-05,2.88597e-09,-2.07194e-13,-60417.4,-16.7018], Tmin=(730.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-491.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(COFOO) + radical(Cdj(Cs-F1sF1sO2s)(Cd-HH)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)(F)[C]=CF(9690)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(514)', '[O]C(F)(F)[C]=CF(2656)'],
    products = ['O=[C]OC(F)(F)[C]=CF(9690)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]O[C](F)F(537)', '[C]=CF-2(3543)'],
    products = ['O=[C]OC(F)(F)[C]=CF(9690)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C(F)(F)[C]=CF(2656)'],
    products = ['O=[C]OC(F)(F)[C]=CF(9690)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=C=CF(10473)'],
    products = ['O=[C]OC(F)(F)[C]=CF(9690)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CC(F)(F)O[C]=O(10474)'],
    products = ['O=[C]OC(F)(F)[C]=CF(9690)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(F)(F)C#CF(10475)'],
    products = ['O=[C]OC(F)(F)[C]=CF(9690)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OC(F)(F)[C]=CF(9690)'],
    products = ['O=[C]OC(F)(F)C=[C]F(10476)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=COC(F)(F)[C]=[C]F(10477)'],
    products = ['O=[C]OC(F)(F)[C]=CF(9690)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OC(F)(F)[C]=CF(9690)'],
    products = ['O=[C]OC(F)=C(F)[CH]F(10478)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OC(F)(F)[C]=CF(9690)'],
    products = ['O=C(F)OC(F)=[C][CH]F(10479)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OC(F)(F)[C]=CF(9690)'],
    products = ['[CH]=C(F)C(F)(F)O[C]=O(10480)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]C(F)(F)OC(=O)F(10481)'],
    products = ['O=[C]OC(F)(F)[C]=CF(9690)'],
