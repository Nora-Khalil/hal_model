...
#SBATCH --output=slurm/output/fc_all.slurm.%x.log
#SBATCH --error=slurm/error/error_fc_all.slurm.%x.log
#SBATCH --nodes=1
...
my_path="/work/westgroup/nora/Code/projects/halogens/refrigerants/patterns_in_blends/blends_of_2/${folder_name}"
