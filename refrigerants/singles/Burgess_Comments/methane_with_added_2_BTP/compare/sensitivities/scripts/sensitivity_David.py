...
directory = '/work/westgroup/nora/Code/projects/halogens/refrigerants/singles/Burgess_Comments/compare/models/David/2-BTP_press_dep/cantera/chem_annotated_press_dep.cti'
...
dot_file = 'rxnpath_NIST.dot'
img_file = 'rxnpath_NIST.png'
