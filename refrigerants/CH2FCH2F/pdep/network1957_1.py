...
"""),
    E0 = (-504.747,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,383.44,383.445,2895.18],'cm^-1')),
        HinderedRotor(inertia=(0.112529,'amu*angstrom^2'), symmetry=1, barrier=(11.7448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112524,'amu*angstrom^2'), symmetry=1, barrier=(11.7441,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64658,0.0559231,-7.57092e-05,5.86646e-08,-1.87236e-11,-60626.1,23.2339], Tmin=(100,'K'), Tmax=(760.194,'K')), NASAPolynomial(coeffs=[7.84584,0.0233014,-1.13357e-05,2.20677e-09,-1.55298e-13,-61568.6,-4.97372], Tmin=(760.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-504.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsCs) + radical(C=OCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.920322,0.0799609,-0.00014783,1.4219e-07,-5.14199e-11,-55325.8,25.4832], Tmin=(100,'K'), Tmax=(861.14,'K')), NASAPolynomial(coeffs=[5.23133,0.0322436,-1.64751e-05,3.15614e-09,-2.15204e-13,-55041.5,11.2914], Tmin=(861.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-460.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CCOJ) + radical(C2CsJOH)"""),
)

species(
    label = '[O]C([CH]O)C(F)F(5091)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {7,S} {11,S}
...
"""),
    E0 = (-435.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,200.439,201.291,1775.87],'cm^-1')),
        HinderedRotor(inertia=(0.190985,'amu*angstrom^2'), symmetry=1, barrier=(5.47385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190149,'amu*angstrom^2'), symmetry=1, barrier=(5.46074,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189894,'amu*angstrom^2'), symmetry=1, barrier=(5.47412,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07598,0.0745033,-0.000131113,1.24324e-07,-4.50693e-11,-52293.8,26.5477], Tmin=(100,'K'), Tmax=(845.862,'K')), NASAPolynomial(coeffs=[5.55361,0.0314758,-1.60571e-05,3.09912e-09,-2.13259e-13,-52269.5,10.3165], Tmin=(845.862,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-435.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CCOJ) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = '[O][CH]C(O)C(F)F(5093)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {11,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.842058,0.0795158,-0.000140323,1.29949e-07,-4.59411e-11,-54879.6,25.8897], Tmin=(100,'K'), Tmax=(853.715,'K')), NASAPolynomial(coeffs=[7.02827,0.0293129,-1.48345e-05,2.84223e-09,-1.94328e-13,-55162.6,1.55174], Tmin=(853.715,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[O][C](CO)C(F)F(5094)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {11,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.745868,0.0784021,-0.000128457,1.10425e-07,-3.69498e-11,-54754.4,25.0582], Tmin=(100,'K'), Tmax=(843.718,'K')), NASAPolynomial(coeffs=[9.78525,0.0241601,-1.17788e-05,2.2351e-09,-1.52578e-13,-55874.5,-14.6136], Tmin=(843.718,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-456.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[O]C(CO)[C](F)F(5095)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18199,0.0688994,-9.31408e-05,5.93268e-08,-1.04545e-11,-51734.3,25.1579], Tmin=(100,'K'), Tmax=(610.449,'K')), NASAPolynomial(coeffs=[9.87697,0.023826,-1.16291e-05,2.24475e-09,-1.56374e-13,-53017.6,-14.3151], Tmin=(610.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-430.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CC(C)OJ) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = '[O]CC([CH]F)OF(5096)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]CC[O](3072)'],
    products = ['[O]CC([O])C(F)F(4970)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.67207e-10,'m^3/(mol*s)'), n=4.72997, Ea=(126.614,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
...
reaction(
    ...
    products = ['[O]CC([O])C(F)F(4970)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(151.458,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C[CH]C(F)F(947)'],
    products = ['[O]CC([O])C(F)F(4970)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C([O])C(F)F(4737)'],
    products = ['[O]CC([O])C(F)F(4970)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(82)', '[O]CC=O(1896)'],
    products = ['[O]CC([O])C(F)F(4970)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(34.2049,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(40.2028,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]CC(=O)C(F)F(5088)'],
    products = ['[O]CC([O])C(F)F(4970)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(15.9,'m^3/(mol*s)'), n=1.84, Ea=(12.3254,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H"""),
)
