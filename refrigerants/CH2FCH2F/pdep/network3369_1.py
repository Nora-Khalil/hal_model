...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43907,0.0611546,-8.2563e-05,6.48224e-08,-2.1134e-11,-96475.1,22.701], Tmin=(100,'K'), Tmax=(742.458,'K')), NASAPolynomial(coeffs=[7.80608,0.0268535,-1.32664e-05,2.60195e-09,-1.83938e-13,-97420.6,-6.1204], Tmin=(742.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-802.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsOsHH) + group(COCsFO)"""),
)

species(
    label = 'O[CH]OC(F)[CH]F(11232)',
...
"""),
    E0 = (-443.812,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,3025,407.5,1350,352.5,285.606,285.723,286.23,286.247],'cm^-1')),
        HinderedRotor(inertia=(0.195307,'amu*angstrom^2'), symmetry=1, barrier=(11.3708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.349691,'amu*angstrom^2'), symmetry=1, barrier=(20.4311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195657,'amu*angstrom^2'), symmetry=1, barrier=(11.375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194859,'amu*angstrom^2'), symmetry=1, barrier=(11.3768,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.398478,0.0849619,-0.000138867,1.14168e-07,-3.63255e-11,-53254.1,25.2372], Tmin=(100,'K'), Tmax=(853.863,'K')), NASAPolynomial(coeffs=[12.6567,0.0193516,-9.22853e-06,1.72372e-09,-1.16226e-13,-55049,-30.2179], Tmin=(853.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-443.812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(OCJO)"""),
)

species(
    label = '[O]COC(F)[CH]F(5085)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-401.615,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,278.898,279.035,279.098,279.133,1358.02],'cm^-1')),
        HinderedRotor(inertia=(0.0769766,'amu*angstrom^2'), symmetry=1, barrier=(25.5548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.463513,'amu*angstrom^2'), symmetry=1, barrier=(25.5555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.461557,'amu*angstrom^2'), symmetry=1, barrier=(25.5554,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26584,0.0595314,-5.77476e-05,2.77923e-08,-5.36372e-12,-48204.3,23.1872], Tmin=(100,'K'), Tmax=(1236.84,'K')), NASAPolynomial(coeffs=[13.4904,0.0199963,-9.80032e-06,1.94812e-09,-1.39859e-13,-51228.2,-38.3876], Tmin=(1236.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-401.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsOsHH) + radical(OCOJ) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.934828,'amu*angstrom^2'), symmetry=1, barrier=(21.4935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.933865,'amu*angstrom^2'), symmetry=1, barrier=(21.4714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.93474,'amu*angstrom^2'), symmetry=1, barrier=(21.4915,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03649,0.0469561,-2.38171e-06,-5.4067e-08,3.09273e-11,-30878.9,21.3968], Tmin=(100,'K'), Tmax=(908.095,'K')), NASAPolynomial(coeffs=[24.4543,-0.00731243,6.51471e-06,-1.32026e-09,8.67414e-14,-37147.5,-100.42], Tmin=(908.095,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-Cs))"""),
)

species(
    label = '[CH]=C(F)OCO(4594)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-464.594,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,326,540,652,719,1357,194,682,905,1196,1383,3221,180,388.475,556.674,556.731],'cm^-1')),
        HinderedRotor(inertia=(0.110824,'amu*angstrom^2'), symmetry=1, barrier=(24.3816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110846,'amu*angstrom^2'), symmetry=1, barrier=(24.3818,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14231,0.0544804,-4.68512e-05,1.58663e-08,-1.00959e-12,-55767.7,21.6804], Tmin=(100,'K'), Tmax=(1084.86,'K')), NASAPolynomial(coeffs=[16.2173,0.0115995,-5.12405e-06,1.01676e-09,-7.46515e-14,-59786,-55.7204], Tmin=(1084.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-464.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(OCOJ)"""),
)

species(
    label = 'O[CH]OC(F)=CF(11000)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-422.445,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,293,496,537,1218,167,640,1190,378.702,378.723,378.727,378.734],'cm^-1')),
        HinderedRotor(inertia=(0.196121,'amu*angstrom^2'), symmetry=1, barrier=(19.9617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196084,'amu*angstrom^2'), symmetry=1, barrier=(19.9616,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196284,'amu*angstrom^2'), symmetry=1, barrier=(19.963,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.393476,0.0709193,-7.87925e-05,3.87155e-08,-6.87207e-12,-50628,27.7741], Tmin=(100,'K'), Tmax=(1649.78,'K')), NASAPolynomial(coeffs=[22.9252,-0.00256814,3.43436e-06,-7.39409e-10,5.0448e-14,-56015.4,-89.4083], Tmin=(1649.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = 'OC[O+]=[C-]C(F)F(11235)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.338686,'amu*angstrom^2'), symmetry=1, barrier=(7.78705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.337311,'amu*angstrom^2'), symmetry=1, barrier=(7.75544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.340119,'amu*angstrom^2'), symmetry=1, barrier=(7.82,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18379,0.0699143,-0.000118457,1.11007e-07,-4.11585e-11,-37093.1,13.4562], Tmin=(100,'K'), Tmax=(784.456,'K')), NASAPolynomial(coeffs=[6.72543,0.0289627,-1.58782e-05,3.20137e-09,-2.27554e-13,-37571.9,-9.44418], Tmin=(784.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsCs) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OCO(11236)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
4  O u0 p2 c0 {5,S} {11,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.107537,0.0727807,-8.24375e-05,4.29811e-08,-8.40705e-12,-52419.6,25.5608], Tmin=(100,'K'), Tmax=(1356.38,'K')), NASAPolynomial(coeffs=[21.9273,0.00354743,-4.698e-07,3.77353e-11,-2.45601e-15,-57889.3,-84.7012], Tmin=(1356.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-437.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsCFFO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'OCOC(F)[C]F(7344)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
4  O u0 p2 c0 {5,S} {11,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02168,'amu*angstrom^2'), symmetry=1, barrier=(23.4904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02036,'amu*angstrom^2'), symmetry=1, barrier=(23.4601,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02087,'amu*angstrom^2'), symmetry=1, barrier=(23.4719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02164,'amu*angstrom^2'), symmetry=1, barrier=(23.4895,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.769677,0.0580588,-3.52251e-05,-1.12843e-08,1.25598e-11,-57101.9,25.0782], Tmin=(100,'K'), Tmax=(943.345,'K')), NASAPolynomial(coeffs=[21.1461,0.00380626,-7.75627e-08,2.53623e-12,-5.29825e-15,-62376.8,-79.6198], Tmin=(943.345,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-475.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.00793,'amu*angstrom^2'), symmetry=1, barrier=(23.1744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00742,'amu*angstrom^2'), symmetry=1, barrier=(23.1626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0086,'amu*angstrom^2'), symmetry=1, barrier=(23.1898,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1534,0.0433938,2.39607e-06,-5.88927e-08,3.26107e-11,-27584.8,18.7609], Tmin=(100,'K'), Tmax=(912.468,'K')), NASAPolynomial(coeffs=[25.1704,-0.0108679,7.72182e-06,-1.50332e-09,9.72881e-14,-34091.8,-106.546], Tmin=(912.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-230.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Ct-CtOs) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O[CH]OC(F)[CH]F(11232)'],
    products = ['OCOC(F)=CF(7351)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH]=C(F)OCO(4594)'],
    products = ['OCOC(F)=CF(7351)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2OH(33)', 'O=C(F)[CH]F(980)'],
    products = ['OCOC(F)=CF(7351)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', '[CH2]OC(F)=CF(1577)'],
    products = ['OCOC(F)=CF(7351)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]COC(F)=CF(10309)'],
    products = ['OCOC(F)=CF(7351)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O[CH]OC(F)=CF(11000)'],
    products = ['OCOC(F)=CF(7351)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OCOC(F)=[C]F(11234)'],
    products = ['OCOC(F)=CF(7351)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OCOC(F)=CF(7351)'],
    products = ['HF(38)', 'CH2O(20)', 'O=C=CF(434)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CHF(40)', 'OC[O+]=[C-]F(4597)'],
    products = ['OCOC(F)=CF(7351)'],
...
network(
    label = 'PDepNetwork #3369',
    isomers = [
        'OCOC(F)=CF(7351)',
    ],
    reactants = [
        ('CH2O(20)', 'O=C(F)CF(476)'),
        ('CH2OH(33)', 'O=C(F)[CH]F(980)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
