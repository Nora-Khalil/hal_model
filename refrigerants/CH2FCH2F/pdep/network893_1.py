...
"""),
    E0 = (-131.359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,180,1712.9],'cm^-1')),
        HinderedRotor(inertia=(0.242272,'amu*angstrom^2'), symmetry=1, barrier=(5.57031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240962,'amu*angstrom^2'), symmetry=1, barrier=(5.54018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243743,'amu*angstrom^2'), symmetry=1, barrier=(5.60414,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0872,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42939,0.0636225,-9.62734e-05,8.88078e-08,-3.27604e-11,-15713.2,22.8306], Tmin=(100,'K'), Tmax=(809.843,'K')), NASAPolynomial(coeffs=[4.94359,0.03332,-1.61701e-05,3.12847e-09,-2.17929e-13,-15857.8,9.23865], Tmin=(809.843,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(F1s)(H)) + radical(RCCJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.272866,'amu*angstrom^2'), symmetry=1, barrier=(6.27373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272815,'amu*angstrom^2'), symmetry=1, barrier=(6.27256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272997,'amu*angstrom^2'), symmetry=1, barrier=(6.27675,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0872,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5284,0.0622764,-9.66757e-05,9.19732e-08,-3.45024e-11,-16153.9,23.9533], Tmin=(100,'K'), Tmax=(822.147,'K')), NASAPolynomial(coeffs=[3.85122,0.0347525,-1.68606e-05,3.25179e-09,-2.25709e-13,-15987.5,16.5363], Tmin=(822.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-134.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sHH)(F1s)) + radical(RCCJ)"""),
)
...
"""),
    E0 = (-131.199,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,1322.15],'cm^-1')),
        HinderedRotor(inertia=(0.0898785,'amu*angstrom^2'), symmetry=1, barrier=(2.06648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0895847,'amu*angstrom^2'), symmetry=1, barrier=(2.05973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.089733,'amu*angstrom^2'), symmetry=1, barrier=(2.06314,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0872,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99234,0.0484353,-5.23531e-05,4.26896e-08,-1.62703e-11,-15711.4,23.7833], Tmin=(100,'K'), Tmax=(685.466,'K')), NASAPolynomial(coeffs=[4.07493,0.0341548,-1.64472e-05,3.24015e-09,-2.30922e-13,-15946.9,14.8871], Tmin=(685.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-HHH)(H)) + radical(RCCJ)"""),
)

species(
    label = 'CC[C](F)[CH]F(1918)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (92.0872,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31798,0.0691302,-0.000117164,1.13805e-07,-4.23674e-11,-17710.7,23.448], Tmin=(100,'K'), Tmax=(842.565,'K')), NASAPolynomial(coeffs=[3.67621,0.0355298,-1.74588e-05,3.35542e-09,-2.31223e-13,-17312.8,17.1943], Tmin=(842.565,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = '[CH2]C[CH]C(F)F(1198)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {5,S} {6,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (92.0872,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02423,0.0478036,-4.6975e-05,3.17166e-08,-9.98687e-12,-19029.5,22.8741], Tmin=(100,'K'), Tmax=(734.091,'K')), NASAPolynomial(coeffs=[4.8612,0.0323446,-1.53856e-05,3.02736e-09,-2.16129e-13,-19446,10.0645], Tmin=(734.091,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsHH)(Cs-F1sF1sH)(H)) + radical(RCCJ)"""),
)

species(
    label = 'F[CH][CH]CCF(229)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', '[CH2]C[CH]F(222)'],
    products = ['[CH2]CC(F)[CH]F(1912)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C(F)[CH]F(245)'],
    products = ['[CH2]CC(F)[CH]F(1912)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CHFCHF[Z](59)', '[CH2][CH2](511)'],
    products = ['[CH2]CC(F)[CH]F(1912)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]CC(F)=CF(1916)'],
    products = ['[CH2]CC(F)[CH]F(1912)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH][CH]F(493)', 'C2H4(30)'],
    products = ['[CH2]CC(F)[CH]F(1912)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][CH]F(493)', '[CH2][CH2](511)'],
    products = ['[CH2]CC(F)[CH]F(1912)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C[CH]F(222)'],
    products = ['[CH2]CC(F)[CH]F(1912)'],
