...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH2]C(=C)[O](386)'],
    products = ['C=C([O])C[C](F)F(683)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=C([O])C=C(F)F(860)'],
    products = ['C=C([O])C[C](F)F(683)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]C(=C)[O](386)'],
    products = ['C=C([O])C[C](F)F(683)'],
