...
reaction(
    label = 'reaction1',
    reactants = ['CH3(19)', 'CH2CHF(56)'],
    products = ['CC[CH]F(177)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CC[CH]F(177)'],
    products = ['[CH2]C(C)F(178)'],
    transitionState = 'TS3',
