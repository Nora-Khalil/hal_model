...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[CH]F(280)'],
    products = ['[CH2]C(=O)O[CH]F(1419)'],
    transitionState = 'TS3',
