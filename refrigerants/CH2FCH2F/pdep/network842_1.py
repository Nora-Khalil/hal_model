...
"""),
    E0 = (-466.813,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,271,519,563,612,1379,3025,407.5,1350,352.5,182,240,577,636,1210,1413,180,986.183],'cm^-1')),
        HinderedRotor(inertia=(0.372593,'amu*angstrom^2'), symmetry=1, barrier=(19.7062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0622172,'amu*angstrom^2'), symmetry=1, barrier=(42.5517,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22985,0.0624818,-7.53186e-05,4.42162e-08,-1.02103e-11,-56046.1,22.6495], Tmin=(100,'K'), Tmax=(1055.13,'K')), NASAPolynomial(coeffs=[13.7374,0.015066,-7.91152e-06,1.6264e-09,-1.19203e-13,-58685.5,-38.3635], Tmin=(1055.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-466.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=CCJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00964829,'amu*angstrom^2'), symmetry=1, barrier=(3.41068,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34396,0.0671311,-0.000125465,1.18138e-07,-4.23656e-11,-49069.9,19.7922], Tmin=(100,'K'), Tmax=(832.159,'K')), NASAPolynomial(coeffs=[7.36148,0.0211183,-1.17228e-05,2.34039e-09,-1.63796e-13,-49479.7,-4.57826], Tmin=(832.159,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-408.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (129.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58111,0.0555548,-6.15332e-05,3.47099e-08,-7.88965e-12,-74835.5,20.2503], Tmin=(100,'K'), Tmax=(1057.75,'K')), NASAPolynomial(coeffs=[11.2842,0.0188621,-9.49995e-06,1.9155e-09,-1.38772e-13,-76888.2,-27.1063], Tmin=(1057.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-622.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CC(C)OJ) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)2)"""),
)

species(
    label = 'O=CC(F)=C(F)F(3838)',
...
"""),
    E0 = (-625.976,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([288,410,724,839,1320,2782.5,750,1395,475,1775,1000,182,240,577,636,1210,1413],'cm^-1')),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.38494,'amu*angstrom^2'), symmetry=1, barrier=(31.8425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38162,'amu*angstrom^2'), symmetry=1, barrier=(31.7663,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74147,0.0541563,-8.46028e-05,7.17391e-08,-2.45324e-11,-51274.8,20.7175], Tmin=(100,'K'), Tmax=(744.867,'K')), NASAPolynomial(coeffs=[8.04587,0.0186843,-9.91411e-06,1.97755e-09,-1.40202e-13,-52169.2,-7.53951], Tmin=(744.867,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-426.964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsH) + group(CJ2_singlet-FCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CF2(43)', 'O=C[C](F)F(787)'],
    products = ['O=CC(F)(F)[C](F)F(1812)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['FO[CH]C(F)=C(F)F(3835)'],
    products = ['O=CC(F)(F)[C](F)F(1812)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CC(F)(F)[C]F(3836)'],
    products = ['O=CC(F)(F)[C](F)F(1812)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(744)', 'O=C[C](F)F(787)'],
    products = ['O=CC(F)(F)[C](F)F(1812)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=CC(F)(F)[C](F)F(1812)'],
    products = ['FC1(F)[CH]OC1(F)F(3837)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=CC(F)(F)[C](F)F(1812)'],
    products = ['[O]C1C(F)(F)C1(F)F(1813)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=CC(F)=C(F)F(3838)'],
    products = ['O=CC(F)(F)[C](F)F(1812)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C=C(F)[C](F)F(3839)'],
    products = ['O=CC(F)(F)[C](F)F(1812)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HCO(15)', 'F[C](F)[C](F)F(3840)'],
    products = ['O=CC(F)(F)[C](F)F(1812)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]C(F)(F)[C](F)F(3841)'],
    products = ['O=CC(F)(F)[C](F)F(1812)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C=C(F)[C](F)F(3842)'],
    products = ['O=CC(F)(F)[C](F)F(1812)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=CC(F)(F)[C]F-2(3843)'],
    products = ['O=CC(F)(F)[C](F)F(1812)'],
