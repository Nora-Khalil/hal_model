...
"""),
    E0 = (-479.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.304126,0.1058,-0.000227897,2.43729e-07,-9.47203e-11,-57611.6,31.1038], Tmin=(100,'K'), Tmax=(849.259,'K')), NASAPolynomial(coeffs=[-1.27171,0.0536058,-3.04132e-05,6.04702e-09,-4.20419e-13,-55194,51.1062], Tmin=(849.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(CsCsFFH) + radical(OCOJ) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H))"""),
)

species(
    label = 'O[C](OF)O[CH]C(F)F(5798)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-502.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.213336,0.109342,-0.000213554,2.05809e-07,-7.43384e-11,-60249.5,33.1778], Tmin=(100,'K'), Tmax=(851.377,'K')), NASAPolynomial(coeffs=[7.60524,0.0360852,-2.014e-05,3.97006e-09,-2.74346e-13,-60257.2,4.48933], Tmin=(851.377,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-502.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Cs_P)"""),
)

species(
    label = '[O]C(OF)OC[C](F)F(5799)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-463.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,190,488,555,1236,1407,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.407291,0.103978,-0.000225785,2.4421e-07,-9.57135e-11,-55637.8,30.9563], Tmin=(100,'K'), Tmax=(847.63,'K')), NASAPolynomial(coeffs=[-2.23071,0.0552905,-3.14358e-05,6.26136e-09,-4.35981e-13,-52994.3,56.2023], Tmin=(847.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-463.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(CsCsFFH) + radical(OCOJ) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'O[C](OF)OC[C](F)F(5800)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-485.626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,190,488,555,1236,1407,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.10922,0.107507,-0.000211391,2.06213e-07,-7.52931e-11,-58275.8,33.027], Tmin=(100,'K'), Tmax=(848.778,'K')), NASAPolynomial(coeffs=[6.64476,0.0377726,-2.11642e-05,4.18479e-09,-2.89942e-13,-58056.9,9.59367], Tmin=(848.778,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-485.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(CsCsFFH) + radical(Cs_P) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-620.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,1855,455,950,323.254,324.073,324.227],'cm^-1')),
        HinderedRotor(inertia=(0.00160335,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177733,'amu*angstrom^2'), symmetry=1, barrier=(13.217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.332732,'amu*angstrom^2'), symmetry=1, barrier=(24.6556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63098,0.053723,-5.77134e-05,3.20106e-08,-7.17944e-12,-74518.1,21.3959], Tmin=(100,'K'), Tmax=(1070.69,'K')), NASAPolynomial(coeffs=[10.8943,0.0191157,-9.22932e-06,1.82167e-09,-1.3042e-13,-76501.7,-23.9269], Tmin=(1070.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-620.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-OdOsH) + radical((O)CJOCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)OCC(F)F(5791)'],
    products = ['HF(38)', 'CO2(14)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(27.6465,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(43)', 'COC(=O)OF(4073)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'O=C(OF)OC[C]F(5795)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(OF)O[CH]C(F)F(5797)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O[C](OF)O[CH]C(F)F(5798)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(OF)OC[C](F)F(5799)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O[C](OF)OC[C](F)F(5800)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=C(OF)OC[CH]F(5801)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(=O)OCC(F)F(5802)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(=O)OF(3721)', 'CHF2-CH2(64)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OF(160)', '[O]CC(F)F(517)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(127)', 'O=[C]OCC(F)F(3192)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(82)', '[CH2]OC(=O)OF(4194)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=C(OF)O[CH]C(F)F(5803)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(OF)OC[C](F)F(5804)'],
    products = ['O=C(OF)OCC(F)F(5791)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(187.163,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)
