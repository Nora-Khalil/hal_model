...
"""),
    E0 = (-502.308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,259,529,569,1128,1321,1390,3140,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,346.032,346.147,346.19],'cm^-1')),
        HinderedRotor(inertia=(0.0873045,'amu*angstrom^2'), symmetry=1, barrier=(7.41302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0872704,'amu*angstrom^2'), symmetry=1, barrier=(7.41253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.32337,'amu*angstrom^2'), symmetry=1, barrier=(27.4746,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3529.87,'J/mol'), sigma=(5.87464,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=551.36 K, Pc=39.51 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25353,0.0511737,-2.49544e-05,-1.46178e-09,3.10232e-12,-88632.1,23.3626], Tmin=(100,'K'), Tmax=(1165.15,'K')), NASAPolynomial(coeffs=[13.5716,0.0246026,-1.09818e-05,2.12127e-09,-1.5068e-13,-92569.5,-42.5263], Tmin=(1165.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-737.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(Cs-O2s-Cs-Cs(F))"""),
)
...
"""),
    E0 = (-605.488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([180,233,1109,1254,1325,1339,3290,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,282.101,282.192],'cm^-1')),
        HinderedRotor(inertia=(0.16261,'amu*angstrom^2'), symmetry=1, barrier=(9.18552,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162045,'amu*angstrom^2'), symmetry=1, barrier=(9.17865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.470488,'amu*angstrom^2'), symmetry=1, barrier=(26.5512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.599111,0.0821371,-0.000129214,1.12804e-07,-3.95034e-11,-72708,26.4949], Tmin=(100,'K'), Tmax=(782.088,'K')), NASAPolynomial(coeffs=[8.94891,0.0313182,-1.61849e-05,3.19005e-09,-2.24314e-13,-73765.9,-10.1494], Tmin=(782.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-605.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsCs) + radical(Csj(Cs-F1sCOH)(H)(H))"""),
)
...
"""),
    E0 = (-369.309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,374.806,375.074,375.18],'cm^-1')),
        HinderedRotor(inertia=(0.163907,'amu*angstrom^2'), symmetry=1, barrier=(16.4174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164596,'amu*angstrom^2'), symmetry=1, barrier=(16.4296,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03228,0.0570863,-4.86446e-05,2.03678e-08,-3.36131e-12,-44303.9,25.5423], Tmin=(100,'K'), Tmax=(1458.36,'K')), NASAPolynomial(coeffs=[15.8419,0.0164666,-6.86528e-06,1.26908e-09,-8.73254e-14,-48623.5,-51.4934], Tmin=(1458.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-369.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)
...
"""),
    E0 = (-328.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,202.523,202.569],'cm^-1')),
        HinderedRotor(inertia=(0.593217,'amu*angstrom^2'), symmetry=1, barrier=(17.2803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0112306,'amu*angstrom^2'), symmetry=1, barrier=(40.8646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49218,0.0587381,-6.71823e-05,4.27715e-08,-1.12665e-11,-39388.3,21.5832], Tmin=(100,'K'), Tmax=(911.087,'K')), NASAPolynomial(coeffs=[9.14149,0.0251537,-1.18875e-05,2.30939e-09,-1.63409e-13,-40782.1,-14.6078], Tmin=(911.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ) + radical(Allyl_P)"""),
)
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00374966,0.0970486,-0.000161173,1.40594e-07,-4.77563e-11,-66740.7,28.7844], Tmin=(100,'K'), Tmax=(836.091,'K')), NASAPolynomial(coeffs=[10.7288,0.0307456,-1.5388e-05,2.95435e-09,-2.03107e-13,-68012.6,-17.9462], Tmin=(836.091,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'C[C](F)C([O])C(F)F(4768)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-518.565,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,299.256,299.257,299.258],'cm^-1')),
        HinderedRotor(inertia=(0.00188244,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147128,'amu*angstrom^2'), symmetry=1, barrier=(9.34995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147128,'amu*angstrom^2'), symmetry=1, barrier=(9.34996,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.516996,0.0833262,-0.000123836,1.04559e-07,-3.59e-11,-62249.9,27.9062], Tmin=(100,'K'), Tmax=(767.373,'K')), NASAPolynomial(coeffs=[9.18597,0.0333161,-1.66547e-05,3.25397e-09,-2.28339e-13,-63438.4,-10.6961], Tmin=(767.373,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-518.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CsCsCsF1s)"""),
)

species(
    label = '[CH2][C](F)C(O)C(F)F(4769)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.223724,0.0920291,-0.000151324,1.33754e-07,-4.62709e-11,-65083.6,30.5535], Tmin=(100,'K'), Tmax=(828.17,'K')), NASAPolynomial(coeffs=[9.41101,0.0325902,-1.63808e-05,3.16176e-09,-2.18452e-13,-66088.7,-8.91868], Tmin=(828.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)C(O)[C](F)F(4770)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-530.8,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,259,529,569,1128,1321,1390,3140,190,488,555,1236,1407,3000,3100,440,815,1455,1000,209.629,209.629],'cm^-1')),
        HinderedRotor(inertia=(0.217651,'amu*angstrom^2'), symmetry=1, barrier=(6.78717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0038362,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217651,'amu*angstrom^2'), symmetry=1, barrier=(6.78717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.659297,'amu*angstrom^2'), symmetry=1, barrier=(20.5593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.177339,0.0912709,-0.000143248,1.21056e-07,-4.06615e-11,-63709.7,29.759], Tmin=(100,'K'), Tmax=(799.555,'K')), NASAPolynomial(coeffs=[10.9565,0.0301464,-1.50706e-05,2.92168e-09,-2.03219e-13,-65203.3,-18.394], Tmin=(799.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-530.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(Csj(Cs-O2sCsH)(F1s)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'CC(F)[C]([O])C(F)F(4771)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.657065,0.0828525,-0.000107241,6.16349e-08,-5.55791e-12,-63922.8,24.8822], Tmin=(100,'K'), Tmax=(582.345,'K')), NASAPolynomial(coeffs=[10.3764,0.0317278,-1.58273e-05,3.08884e-09,-2.16708e-13,-65319.9,-19.029], Tmin=(582.345,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-532.411,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
"""),
    E0 = (-187.459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,580.974,1341.8],'cm^-1')),
        HinderedRotor(inertia=(0.143872,'amu*angstrom^2'), symmetry=1, barrier=(3.3079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0399984,'amu*angstrom^2'), symmetry=1, barrier=(9.58137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0841191,'amu*angstrom^2'), symmetry=1, barrier=(9.58068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117304,'amu*angstrom^2'), symmetry=1, barrier=(28.099,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.800263,0.0737026,-8.32824e-05,4.9688e-08,-1.20366e-11,-22433.6,29.6387], Tmin=(100,'K'), Tmax=(994.029,'K')), NASAPolynomial(coeffs=[12.3756,0.0271242,-1.29972e-05,2.5511e-09,-1.81912e-13,-24735,-26.1369], Tmin=(994.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C([O])C(F)F(4703)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[CH2]C(F)C[O](183)'],
    products = ['[CH2]C(F)C([O])C(F)F(4703)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(123.021,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
...
reaction(
    ...
    products = ['[CH2]C(F)C([O])C(F)F(4703)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(148.177,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)[CH]C(F)F(768)'],
    products = ['[CH2]C(F)C([O])C(F)F(4703)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', '[O]C([CH]F)C(F)F(4759)'],
    products = ['[CH2]C(F)C([O])C(F)F(4703)'],
    transitionState = 'TS6',
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(12.7282,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=C(F)C([O])C(F)F(4764)'],
    products = ['[CH2]C(F)C([O])C(F)F(4703)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[CH2]C=C([O])C(F)F(4765)'],
    products = ['[CH2]C(F)C([O])C(F)F(4703)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(319.52,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(238.173,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)C([O])C(F)F(4703)'],
    products = ['[CH2]C(F)[C](O)C(F)F(4767)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[C](F)C([O])C(F)F(4768)'],
    products = ['[CH2]C(F)C([O])C(F)F(4703)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)C([O])C(F)F(4703)'],
    products = ['[CH2][C](F)C(O)C(F)F(4769)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)C(O)[C](F)F(4770)'],
    products = ['[CH2]C(F)C([O])C(F)F(4703)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][CH]C(OF)C(F)F(4773)'],
    products = ['[CH2]C(F)C([O])C(F)F(4703)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(F)C([CH]F)OF(4774)'],
    products = ['[CH2]C(F)C([O])C(F)F(4703)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O]C([CH]F)C(F)CF(4775)'],
    products = ['[CH2]C(F)C([O])C(F)F(4703)'],
...
network(
    label = 'PDepNetwork #1903',
    isomers = [
        '[CH2]C(F)C([O])C(F)F(4703)',
    ],
    reactants = [
