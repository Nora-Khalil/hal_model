...
reaction(
    label = 'reaction3',
    reactants = ['C2H2(23)', '[CH]=[CH](257)'],
    products = ['[CH]=CC=[CH](191)'],
    transitionState = 'TS3',
