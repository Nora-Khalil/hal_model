...
"""),
    E0 = (-437.169,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,180],'cm^-1')),
        HinderedRotor(inertia=(0.202231,'amu*angstrom^2'), symmetry=1, barrier=(4.64968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202254,'amu*angstrom^2'), symmetry=1, barrier=(4.65022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20119,'amu*angstrom^2'), symmetry=1, barrier=(27.6177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.62945,'amu*angstrom^2'), symmetry=1, barrier=(60.4562,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.984593,0.071971,-7.89165e-05,4.99445e-08,-1.34354e-11,-95083.9,24.7706], Tmin=(100,'K'), Tmax=(881.644,'K')), NASAPolynomial(coeffs=[8.95538,0.0358085,-1.73921e-05,3.42306e-09,-2.44009e-13,-96489.4,-12.68], Tmin=(881.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-791.435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
"""),
    E0 = (-223.206,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,1725.87],'cm^-1')),
        HinderedRotor(inertia=(0.224714,'amu*angstrom^2'), symmetry=1, barrier=(9.21436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225839,'amu*angstrom^2'), symmetry=1, barrier=(9.21317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00171,'amu*angstrom^2'), symmetry=1, barrier=(40.8001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.999212,'amu*angstrom^2'), symmetry=1, barrier=(40.7934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.864651,0.0753391,-9.39324e-05,6.73265e-08,-2.02429e-11,-26738.3,29.1546], Tmin=(100,'K'), Tmax=(798.416,'K')), NASAPolynomial(coeffs=[8.98953,0.0346336,-1.74574e-05,3.47011e-09,-2.47993e-13,-28035.7,-8.21403], Tmin=(798.416,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.206,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CJCOOH)"""),
)

species(
    label = 'CCOO[C]=C(F)F(7204)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-197.425,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,562,600,623,1070,1265,1685,370,180,1448.49],'cm^-1')),
        HinderedRotor(inertia=(0.301157,'amu*angstrom^2'), symmetry=1, barrier=(6.92419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301352,'amu*angstrom^2'), symmetry=1, barrier=(6.92867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.33445,'amu*angstrom^2'), symmetry=1, barrier=(53.6737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.30108,'amu*angstrom^2'), symmetry=1, barrier=(6.92243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.884569,0.0777652,-0.000121475,1.14736e-07,-4.33365e-11,-23641.5,30.1928], Tmin=(100,'K'), Tmax=(798.688,'K')), NASAPolynomial(coeffs=[4.66017,0.041654,-2.1348e-05,4.19356e-09,-2.94268e-13,-23695.9,16.2612], Tmin=(798.688,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-197.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(C=CJO)"""),
)
...
"""),
    E0 = (130.936,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,928.71,930.773,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.107481,'amu*angstrom^2'), symmetry=1, barrier=(2.47119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107481,'amu*angstrom^2'), symmetry=1, barrier=(2.47119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107481,'amu*angstrom^2'), symmetry=1, barrier=(2.47119,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95483,0.0536253,-8.74037e-05,8.83082e-08,-3.43916e-11,15813.2,19.3985], Tmin=(100,'K'), Tmax=(832.275,'K')), NASAPolynomial(coeffs=[1.7795,0.0345628,-1.71728e-05,3.3158e-09,-2.2961e-13,16531.8,24.3538], Tmin=(832.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCOOC=C(F)F(6720)'],
    products = ['O=CC(F)F(990)', 'CH3CHO(36)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(35.0818,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'COOC=C(F)F(4975)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[CH2]OOC=C(F)F(1854)'],
    products = ['CCOOC=C(F)F(6720)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]COOC=C(F)F(7203)'],
    products = ['CCOOC=C(F)F(6720)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'CCOO[C]=C(F)F(7204)'],
    products = ['CCOOC=C(F)F(6720)'],
