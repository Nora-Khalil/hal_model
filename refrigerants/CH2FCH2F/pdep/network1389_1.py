...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)OO[O](3087)'],
    products = ['O2(2)', 'FC1(F)CO1(783)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OO[C](F)F(2146)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)OO[O](3087)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', '[CH2]C([O])(F)F(475)'],
    products = ['[CH2]C(F)(F)OO[O](3087)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[O](128)', '[CH2][C](F)F(507)'],
    products = ['[CH2]C(F)(F)OO[O](3087)'],
    transitionState = 'TS9',
