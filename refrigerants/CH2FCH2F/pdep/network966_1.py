...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(=C)F(1947)'],
    products = ['[CH]=C(F)C[O](2131)'],
    transitionState = 'TS2',
