...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C(C)OF(2585)'],
    products = ['C=C(CC)OF(9016)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[CH2]C(=C)OF(2610)'],
    products = ['C=C(CC)OF(9016)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(=CC)OF(2593)'],
    products = ['C=C(CC)OF(9016)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]CC(=C)OF(2607)'],
    products = ['C=C(CC)OF(9016)'],
