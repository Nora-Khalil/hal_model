...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'O=C(O)O(4496)'],
    products = ['O=C(O)OC(F)F(4094)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=C(O)O[CH]F(4500)'],
    products = ['O=C(O)OC(F)F(4094)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)F(1061)', 'O=[C]O(158)'],
    products = ['O=C(O)OC(F)F(4094)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=[C]OC(F)F(3722)'],
    products = ['O=C(O)OC(F)F(4094)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(F)F(3720)'],
    products = ['O=C(O)OC(F)F(4094)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(O)O[C](F)F(3789)'],
    products = ['O=C(O)OC(F)F(4094)'],
