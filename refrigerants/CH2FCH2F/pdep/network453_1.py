...
reaction(
    ...
    products = ['[CH2]C(F)(F)C(F)[CH]F(880)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)[C](F)F(919)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(880)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]C(F)(F)C=CF(757)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(880)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)=CF(921)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(880)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C(F)[CH]F(897)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(880)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH2]C(F)=C[CH]F(758)'],
    products = ['[CH2]C(F)(F)C(F)[CH]F(880)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)(F)C(F)[CH]F(880)'],
    products = ['[CH2]C(F)(F)[CH]C(F)F(800)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)C(F)[CH]F(880)'],
    products = ['[CH2][C](F)C(F)C(F)F(925)'],
