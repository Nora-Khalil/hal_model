...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CF2(43)'],
    products = ['[O]O[C](F)F(788)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]O[C](F)F(788)'],
    products = ['FC1(F)OO1(2408)'],
    transitionState = 'TS4',
