...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'CC(=O)OF(3327)'],
    products = ['CCC(=O)OF(4196)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[CH2]C(=O)OF(3335)'],
    products = ['CCC(=O)OF(4196)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C[CH]C(=O)OF(3321)'],
    products = ['CCC(=O)OF(4196)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]CC(=O)OF(3334)'],
    products = ['CCC(=O)OF(4196)'],
