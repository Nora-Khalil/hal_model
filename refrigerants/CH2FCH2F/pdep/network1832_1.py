...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'OC(O)(F)F(3785)'],
    products = ['OC(F)(F)OCF(4115)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)(F)OF(3467)', 'CH2(S)(25)'],
    products = ['OC(F)(F)OCF(4115)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(O)(F)F(4537)'],
    products = ['OC(F)(F)OCF(4115)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(1777)', '[O]CF(180)'],
    products = ['OC(F)(F)OCF(4115)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(O)(F)F(2300)', 'CH2F(46)'],
    products = ['OC(F)(F)OCF(4115)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)OCF(3602)'],
    products = ['OC(F)(F)OCF(4115)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OC(F)(F)O[CH]F(3787)'],
    products = ['OC(F)(F)OCF(4115)'],
