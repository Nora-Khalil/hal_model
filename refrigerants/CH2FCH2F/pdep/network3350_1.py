...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.871508,0.0668919,-7.06022e-05,3.54738e-08,-7.00108e-12,-50596.5,27.239], Tmin=(100,'K'), Tmax=(1226.41,'K')), NASAPolynomial(coeffs=[16.4189,0.0161833,-8.58142e-06,1.75982e-09,-1.28579e-13,-54410,-50.9413], Tmin=(1226.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2]C(F)(F)OO[C]=O(10363)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.65229,0.0681261,-7.33822e-05,3.69479e-08,-7.18676e-12,-54568.7,29.0497], Tmin=(100,'K'), Tmax=(1258.86,'K')), NASAPolynomial(coeffs=[18.4782,0.011484,-5.88929e-06,1.20459e-09,-8.83226e-14,-59056.7,-61.0533], Tmin=(1258.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-454.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsCFHO) + group(Cs-CsHHH) + group(COFOO) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(513)', 'F[C]CF-2(467)'],
    products = ['O=[C]OO[C](F)CF(9958)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[O]O[C](F)CF(501)'],
    products = ['O=[C]OO[C](F)CF(9958)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]O[C](F)CF(501)'],
    products = ['O=[C]OO[C](F)CF(9958)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)OO[C]=O(582)'],
    products = ['O=[C]OO[C](F)CF(9958)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]O[C]=O(513)', 'F[C]CF(125)'],
    products = ['O=[C]OO[C](F)CF(9958)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OO[C](F)CF(9958)'],
    products = ['[CH2]C(F)(F)OO[C]=O(10363)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OO[C](F)CF(9958)'],
    products = ['[CH2][C](F)OOC(=O)F(10364)'],
