...
"""),
    E0 = (-560.822,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([373,336,502,477,708,1220,1477,528,1116,1182,1331,1402,1494,3075,3110,1855,455,950,234.41,234.41,234.41],'cm^-1')),
        HinderedRotor(inertia=(1.23699,'amu*angstrom^2'), symmetry=1, barrier=(48.2332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23699,'amu*angstrom^2'), symmetry=1, barrier=(48.2332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.754337,'amu*angstrom^2'), symmetry=1, barrier=(29.4133,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21766,0.066887,-8.96746e-05,6.52592e-08,-1.94582e-11,-67356.2,23.1972], Tmin=(100,'K'), Tmax=(811.518,'K')), NASAPolynomial(coeffs=[9.5707,0.0257137,-1.3569e-05,2.73673e-09,-1.96854e-13,-68711.9,-15.3567], Tmin=(811.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-560.822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsH) + radical(O2sj(Cs-F1sO2sCs)) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-567.024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,1855,455,950,180,818.092],'cm^-1')),
        HinderedRotor(inertia=(0.456505,'amu*angstrom^2'), symmetry=1, barrier=(46.4732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.02173,'amu*angstrom^2'), symmetry=1, barrier=(46.4836,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0205,0.0423341,-4.48375e-05,2.27884e-08,-4.55459e-12,-68124.9,19.4157], Tmin=(100,'K'), Tmax=(1211.83,'K')), NASAPolynomial(coeffs=[11.6712,0.0104796,-5.40834e-06,1.09732e-09,-7.97668e-14,-70463.9,-28.9974], Tmin=(1211.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-567.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsFFOO) + group(Cds-OdOsH) + radical(O2sj(Cs-F1sF1sO2s)) + radical((O)CJOC)"""),
)

species(
    label = '[O]C(F)(F)CO[C]=O(10377)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17379,0.0659825,-8.65623e-05,5.80324e-08,-1.55058e-11,-68482.1,24.9883], Tmin=(100,'K'), Tmax=(912.203,'K')), NASAPolynomial(coeffs=[11.8126,0.0193318,-9.85188e-06,1.97044e-09,-1.4149e-13,-70423.1,-25.3603], Tmin=(912.203,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-570.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCFFO) + group(Cds-OdOsH) + radical(O2sj(Cs-CsF1sF1s)) + radical((O)CJOCC)"""),
)
...
"""),
    E0 = (-416.487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,1855,455,950,180,180,565.795],'cm^-1')),
        HinderedRotor(inertia=(1.12703,'amu*angstrom^2'), symmetry=1, barrier=(25.9127,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.32965,'amu*angstrom^2'), symmetry=1, barrier=(53.5632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.33018,'amu*angstrom^2'), symmetry=1, barrier=(53.5755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6378,0.0568831,-7.81597e-05,6.00779e-08,-1.90643e-11,-50011.3,20.9251], Tmin=(100,'K'), Tmax=(762.624,'K')), NASAPolynomial(coeffs=[8.02863,0.0233651,-1.22379e-05,2.4546e-09,-1.75748e-13,-50986.1,-8.17551], Tmin=(762.624,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-416.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsH) + radical(CsCsF1sO2s) + radical((O)CJOC)"""),
)

species(
    label = 'O=C1OC(F)(CF)O1(10378)',
...
"""),
    E0 = (-507.976,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([244,1102,1254,1379,1468,1475,3037,3083,1855,455,950,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60194,0.0577541,-9.16199e-05,7.92614e-08,-2.72792e-11,-61013.8,23.5396], Tmin=(100,'K'), Tmax=(799.062,'K')), NASAPolynomial(coeffs=[7.80896,0.0206054,-1.04762e-05,2.04433e-09,-1.42693e-13,-61811.8,-3.79935], Tmin=(799.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-507.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.519936,0.0830405,-0.000136404,1.15343e-07,-3.84554e-11,-74267.6,25.4246], Tmin=(100,'K'), Tmax=(788.286,'K')), NASAPolynomial(coeffs=[11.5041,0.0224823,-1.19962e-05,2.37022e-09,-1.6618e-13,-75849.6,-24.0044], Tmin=(788.286,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-618.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsH) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H)) + radical((O)CJOC)"""),
)

species(
    label = '[O]C(F)([CH]F)OC=O(10381)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20619,0.0676119,-9.77838e-05,7.95967e-08,-2.67674e-11,-66807.9,25.1603], Tmin=(100,'K'), Tmax=(720.934,'K')), NASAPolynomial(coeffs=[8.37891,0.0278161,-1.49854e-05,3.03291e-09,-2.1788e-13,-67842.2,-7.09717], Tmin=(720.934,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsH) + radical(O2sj(Cs-F1sO2sCs)) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)

species(
    label = 'O=[C]O[C](CF)OF(10382)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94685,0.0546741,-4.65664e-05,-2.34504e-08,5.10251e-11,-70696.3,25.3662], Tmin=(100,'K'), Tmax=(470.37,'K')), NASAPolynomial(coeffs=[6.69013,0.0297566,-1.62759e-05,3.30913e-09,-2.37957e-13,-71313.1,4.24702], Tmin=(470.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-588.336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(COFOO) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(F)(OF)O[C]=O(10384)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {6,S} {8,S}
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]C(F)(F)O[C]=O(2413)'],
    products = ['[O]C(F)(CF)O[C]=O(9957)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(129)', '[O]C([O])(F)CF(9947)'],
    products = ['[O]C(F)(CF)O[C]=O(9957)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', 'O=[C]O[C](F)CF(1041)'],
    products = ['[O]C(F)(CF)O[C]=O(9957)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[O]C([O])(F)CF(9947)'],
    products = ['[O]C(F)(CF)O[C]=O(9957)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(68.2,'m^3/(mol*s)'), n=8.73864e-09, Ea=(9.91642,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    products = ['[O]C(F)(CF)O[C]=O(9957)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.81516e-05,'m^3/(mol*s)'), n=3.04336, Ea=(111.557,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]OC(=O)CF(10379)'],
    products = ['[O]C(F)(CF)O[C]=O(9957)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(25.9505,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[CH2]C(=O)O[C]=O(567)'],
    products = ['[O]C(F)(CF)O[C]=O(9957)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(16.8639,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C(F)(CF)O[C]=O(9957)'],
    products = ['[O]C(F)([CH]F)OC=O(10381)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(CF)O[C]=O(9957)'],
    products = ['[O][C](CF)OC(=O)F(10383)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(213.647,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(OF)O[C]=O(10384)'],
    products = ['[O]C(F)(CF)O[C]=O(9957)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)(CF)O[C]=O(9957)'],
    products = ['[CH2]C([O])(F)OC(=O)F(10385)'],
