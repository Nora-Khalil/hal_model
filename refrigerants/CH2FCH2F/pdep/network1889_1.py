...
"""),
    E0 = (-3.2728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,1685,370,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.338376,'amu*angstrom^2'), symmetry=1, barrier=(7.77992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.933235,'amu*angstrom^2'), symmetry=1, barrier=(21.4569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.338631,'amu*angstrom^2'), symmetry=1, barrier=(7.7858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.04015,'amu*angstrom^2'), symmetry=1, barrier=(46.907,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.545826,0.0830294,-0.000129161,1.11148e-07,-3.84501e-11,-276.01,31.0024], Tmin=(100,'K'), Tmax=(778.227,'K')), NASAPolynomial(coeffs=[9.3919,0.0309095,-1.58808e-05,3.12239e-09,-2.19339e-13,-1451.42,-8.16251], Tmin=(778.227,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.2728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(F)F(506)', 'C=[C]O[O](452)'],
    products = ['C=[C]OO[CH]C(F)F(4690)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(368)', '[O]O[CH]C(F)F(786)'],
    products = ['C=[C]OO[CH]C(F)F(4690)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['C=[C]OO[CH]C(F)F(4690)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(333.873,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 330.1 to 333.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['C=[C]OO[CH]C(F)F(4690)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(252.65,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 247.1 to 252.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=[C]OOC=CF(2458)'],
    products = ['C=[C]OO[CH]C(F)F(4690)'],
    transitionState = 'TS8',
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(72.7398,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]OO[CH]C(F)F(4690)'],
    products = ['C=C(F)OO[CH][CH]F(4635)'],
...
network(
    label = 'PDepNetwork #1889',
    isomers = [
        'C=[C]OO[CH]C(F)F(4690)',
    ],
    reactants = [
