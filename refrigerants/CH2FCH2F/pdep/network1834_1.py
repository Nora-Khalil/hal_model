...
reaction(
    label = 'reaction6',
    reactants = ['FOF(1520)', 'C=C(O)F(213)'],
    products = ['OC(F)(F)COF(4117)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'FOC=C(F)F(1650)'],
    products = ['OC(F)(F)COF(4117)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]CC(O)(F)F(4436)'],
    products = ['OC(F)(F)COF(4117)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(127)', '[CH2]C(O)(F)F(489)'],
    products = ['OC(F)(F)COF(4117)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)COF(4437)'],
    products = ['OC(F)(F)COF(4117)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(1777)', '[CH2]OF(179)'],
    products = ['OC(F)(F)COF(4117)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]OF(3656)'],
    products = ['OC(F)(F)COF(4117)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)COF(4438)'],
    products = ['OC(F)(F)COF(4117)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CC(O)(F)F(1711)'],
    products = ['OC(F)(F)COF(4117)'],
