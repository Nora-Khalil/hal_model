...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.31375,'amu*angstrom^2'), symmetry=1, barrier=(30.2056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3136,'amu*angstrom^2'), symmetry=1, barrier=(30.2022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31404,'amu*angstrom^2'), symmetry=1, barrier=(30.2123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31408,'amu*angstrom^2'), symmetry=1, barrier=(30.2134,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.628504,0.0941597,-0.000116152,6.63555e-08,-1.43907e-11,-36811.6,28.6316], Tmin=(100,'K'), Tmax=(1145.88,'K')), NASAPolynomial(coeffs=[24.1079,0.00781049,-3.11751e-06,5.92636e-10,-4.29955e-14,-42480.6,-94.0758], Tmin=(1145.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-307.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsCFOO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (142.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.853821,0.0947052,-0.000105162,5.52223e-08,-1.10667e-11,-80546.8,29.3617], Tmin=(100,'K'), Tmax=(1236.8,'K')), NASAPolynomial(coeffs=[24.9234,0.0113377,-4.05352e-06,7.21985e-10,-5.02712e-14,-86923.1,-100.477], Tmin=(1236.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-671.243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFFO) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=COC(F)(F)COF(11656)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {5,S}
4  O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.237,'amu*angstrom^2'), symmetry=1, barrier=(28.441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23588,'amu*angstrom^2'), symmetry=1, barrier=(28.4153,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-296.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,2750,2850,1437.5,1250,1305,750,350,180,180,180,318.884,1426.3,1600,2933.33,3200],'cm^-1')),
...
reaction(
    label = 'reaction2',
    reactants = ['H2(8)', 'C=COC(F)([C]F)OF(11654)'],
    products = ['C=COC(F)(CF)OF(11593)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'C=COC(F)(F)OF(3585)'],
    products = ['C=COC(F)(CF)OF(11593)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['FC=C(F)OF(3648)', 'C=CO(461)'],
    products = ['C=COC(F)(CF)OF(11593)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C(F)OF(479)', 'C=COF(211)'],
    products = ['C=COC(F)(CF)OF(11593)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(140)', 'C=COC(F)=CF(1242)'],
    products = ['C=COC(F)(CF)OF(11593)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(1520)', 'C=COC(=C)F(378)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]COC(F)([CH]F)OF(11657)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH]OC(F)([CH]F)OF(11658)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'C=CO[C](CF)OF(11659)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C(F)(OF)OC=C(11660)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'C=COC([O])(F)CF(11398)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(CF)OF(10505)', 'C2H3(29)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]F(127)', 'C=CO[C](F)CF(10111)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2F(46)', 'C=CO[C](F)OF(3732)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'C=COC(F)([CH]F)OF(11661)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'C=[C]OC(F)(CF)OF(11662)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', '[CH]=COC(F)(CF)OF(11663)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=COC(F)(CF)OF(11593)'],
    products = ['FC=C(F)OF(3648)', 'CH3CHO(36)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C[C-]=[O+]C(F)(CF)OF(11664)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]COC(F)(CF)OF(11665)'],
    products = ['C=COC(F)(CF)OF(11593)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F2(78)', 'C=COC(=O)CF(6016)'],
    products = ['C=COC(F)(CF)OF(11593)'],
