...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C([O])C[O](608)'],
    products = ['C=C([O])C(C)[O](5669)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', '[CH2]C(=O)C=O(1342)'],
    products = ['C=C([O])C(C)[O](5669)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=O)C(C)=O(5743)'],
    products = ['C=C([O])C(C)[O](5669)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(18)', 'CC([O])[C]=O(4488)'],
    products = ['C=C([O])C(C)[O](5669)'],
