...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.508321,0.0724503,-9.0896e-05,5.2955e-08,-1.17429e-11,770.209,22.3883], Tmin=(100,'K'), Tmax=(1118.92,'K')), NASAPolynomial(coeffs=[18.8486,0.00688717,-3.00491e-06,5.89292e-10,-4.30264e-14,-3334.12,-68.154], Tmin=(1118.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.32689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.12872,'amu*angstrom^2'), symmetry=1, barrier=(25.9514,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.801234,0.0569919,-7.09583e-05,3.89699e-08,-7.74763e-12,7147.07,17.4889], Tmin=(100,'K'), Tmax=(1448.61,'K')), NASAPolynomial(coeffs=[18.5345,-0.00345231,3.51528e-06,-7.73383e-10,5.5179e-14,3213.68,-70.4789], Tmin=(1448.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.3708,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(OCJO)"""),
)

species(
    label = 'OC1O[C]=CC1(F)F(3850)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37425,0.0477312,-2.10204e-05,-1.59953e-08,1.2359e-11,-62027.9,21.1294], Tmin=(100,'K'), Tmax=(929.31,'K')), NASAPolynomial(coeffs=[15.9542,0.0106042,-2.46148e-06,3.67332e-10,-2.62044e-14,-65844.4,-54.0959], Tmin=(929.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-516.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCCFF) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1OC(O)C1(F)F(3851)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.134524,0.0708303,-7.61566e-05,3.80531e-08,-6.99147e-12,-52267,23.7921], Tmin=(100,'K'), Tmax=(1561.64,'K')), NASAPolynomial(coeffs=[20.9904,0.00350838,1.19899e-06,-3.87895e-10,2.97988e-14,-57253.8,-82.3812], Tmin=(1561.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-435.953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCCFF) + group(Cs-CsOsOsH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.5873,'amu*angstrom^2'), symmetry=1, barrier=(36.4951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58572,'amu*angstrom^2'), symmetry=1, barrier=(36.4589,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65324,0.0543692,-6.49909e-05,4.01823e-08,-1.00026e-11,-21357.1,19.4682], Tmin=(100,'K'), Tmax=(971.875,'K')), NASAPolynomial(coeffs=[10.4628,0.018112,-9.03259e-06,1.798e-09,-1.2908e-13,-23069.5,-22.7817], Tmin=(971.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (-335.393,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,182,240,577,636,1210,1413,2175,525,750,770,3400,2100,192.045,192.097],'cm^-1')),
        HinderedRotor(inertia=(0.977647,'amu*angstrom^2'), symmetry=1, barrier=(25.5816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.510203,'amu*angstrom^2'), symmetry=1, barrier=(13.3559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44914,'amu*angstrom^2'), symmetry=1, barrier=(37.9406,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.529906,0.0830149,-0.00013944,1.18676e-07,-3.93231e-11,-40219.9,23.2767], Tmin=(100,'K'), Tmax=(823.649,'K')), NASAPolynomial(coeffs=[11.567,0.0209238,-1.09004e-05,2.11973e-09,-1.46648e-13,-41750.1,-26.0815], Tmin=(823.649,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.2116,'amu*angstrom^2'), symmetry=1, barrier=(27.8572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21291,'amu*angstrom^2'), symmetry=1, barrier=(27.8872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21176,'amu*angstrom^2'), symmetry=1, barrier=(27.8608,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.252682,0.0787643,-0.000111076,7.10502e-08,-1.70873e-11,-294.623,22.2919], Tmin=(100,'K'), Tmax=(1039.07,'K')), NASAPolynomial(coeffs=[20.1697,0.00209287,-3.94565e-07,3.8063e-11,-1.97081e-15,-4433.7,-74.5596], Tmin=(1039.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.59854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOCs) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'C#COC([O])[C](F)F(3855)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-153.422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,190,488,555,1236,1407,2175,525,750,770,3400,2100,347.253,347.253,347.253,347.253],'cm^-1')),
        HinderedRotor(inertia=(0.316438,'amu*angstrom^2'), symmetry=1, barrier=(27.0775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215602,'amu*angstrom^2'), symmetry=1, barrier=(18.449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.316437,'amu*angstrom^2'), symmetry=1, barrier=(27.0775,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.667628,0.0792254,-0.000121116,9.4034e-08,-2.89081e-11,-18337.9,25.3682], Tmin=(100,'K'), Tmax=(798.08,'K')), NASAPolynomial(coeffs=[12.3272,0.0207847,-1.12715e-05,2.2727e-09,-1.62438e-13,-20198.8,-28.2523], Tmin=(798.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCOJ) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'C#CO[C](O)[C](F)F(3856)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-173.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,360,370,350,190,488,555,1236,1407,2175,525,750,770,3400,2100,308.357,308.357,308.358],'cm^-1')),
        HinderedRotor(inertia=(0.307985,'amu*angstrom^2'), symmetry=1, barrier=(20.781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.307985,'amu*angstrom^2'), symmetry=1, barrier=(20.781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.307988,'amu*angstrom^2'), symmetry=1, barrier=(20.781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.307987,'amu*angstrom^2'), symmetry=1, barrier=(20.781,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.344879,0.0827259,-0.000119543,8.17568e-08,-2.15244e-11,-20783.4,27.0441], Tmin=(100,'K'), Tmax=(939.241,'K')), NASAPolynomial(coeffs=[17.0278,0.0116775,-6.07698e-06,1.21937e-09,-8.76193e-14,-23917.2,-52.3957], Tmin=(939.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-173.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = '[C]#COC(O)[C](F)F(3857)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-41.9838,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,190,488,555,1236,1407,2175,525,324.138,324.138,324.14,324.142],'cm^-1')),
        HinderedRotor(inertia=(0.216164,'amu*angstrom^2'), symmetry=1, barrier=(16.1167,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216164,'amu*angstrom^2'), symmetry=1, barrier=(16.1166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216161,'amu*angstrom^2'), symmetry=1, barrier=(16.1167,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.489755,'amu*angstrom^2'), symmetry=1, barrier=(36.5158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.208539,0.087042,-0.000137262,1.0414e-07,-3.04193e-11,-4916.31,26.8898], Tmin=(100,'K'), Tmax=(848.538,'K')), NASAPolynomial(coeffs=[15.9363,0.0128997,-6.1947e-06,1.16257e-09,-7.89539e-14,-7585.38,-46.4041], Tmin=(848.538,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-41.9838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s)) + radical(Acetyl)"""),
)

species(
    label = 'C#COC(O)[C]F-2(3858)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {4,S} {9,S}
4  C u0 p0 c0 {2,S} {3,S} {5,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.021,'amu*angstrom^2'), symmetry=1, barrier=(23.4748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02076,'amu*angstrom^2'), symmetry=1, barrier=(23.4692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02068,'amu*angstrom^2'), symmetry=1, barrier=(23.4674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02072,'amu*angstrom^2'), symmetry=1, barrier=(23.4683,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.588221,0.0685117,-8.05486e-05,4.25527e-08,-8.06396e-12,277.882,23.7932], Tmin=(100,'K'), Tmax=(1009.63,'K')), NASAPolynomial(coeffs=[18.9786,0.00559275,-1.83964e-06,3.32785e-10,-2.4476e-14,-3942.28,-67.6152], Tmin=(1009.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.24111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CJ2_singlet-FCs) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.0261,'amu*angstrom^2'), symmetry=1, barrier=(23.592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0263,'amu*angstrom^2'), symmetry=1, barrier=(23.5966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02606,'amu*angstrom^2'), symmetry=1, barrier=(23.5911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02646,'amu*angstrom^2'), symmetry=1, barrier=(23.6004,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0852283,0.0823,-0.000104135,6.1483e-08,-1.38548e-11,-45740.3,25.7661], Tmin=(100,'K'), Tmax=(1099.67,'K')), NASAPolynomial(coeffs=[20.2612,0.00891093,-4.02929e-06,7.94412e-10,-5.78113e-14,-50177.6,-73.4881], Tmin=(1099.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-381.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cs_P)"""),
)

species(
    label = 'C#COC([O])C(F)F(1733)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-249.609,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,2175,525,223.44,223.623,223.749,223.96],'cm^-1')),
        HinderedRotor(inertia=(0.607466,'amu*angstrom^2'), symmetry=1, barrier=(21.601,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.614099,'amu*angstrom^2'), symmetry=1, barrier=(21.5989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.611544,'amu*angstrom^2'), symmetry=1, barrier=(21.5977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.608397,'amu*angstrom^2'), symmetry=1, barrier=(21.5927,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.114662,0.0845776,-0.000114354,7.36442e-08,-1.81788e-11,-29880.2,25.7162], Tmin=(100,'K'), Tmax=(1003.93,'K')), NASAPolynomial(coeffs=[18.5182,0.011252,-4.79688e-06,8.91945e-10,-6.19972e-14,-33575.4,-63.1422], Tmin=(1003.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-249.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COC(O)[C](F)F(1726)'],
    products = ['O=C[C](F)F(787)', 'CH2CO(28)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'C#COC(O)[C]F(3849)'],
    products = ['C#COC(O)[C](F)F(1726)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', 'C#CO[CH]O(3046)'],
    products = ['C#COC(O)[C](F)F(1726)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C#COC(O)[C](F)F(1726)'],
    products = ['[CH]=C1OC(O)C1(F)F(3851)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HCCO(21)', 'OC=C(F)F(1567)'],
    products = ['C#COC(O)[C](F)F(1726)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'C#COC=C(F)F(3852)'],
    products = ['C#COC(O)[C](F)F(1726)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC(O)=C(F)F(3853)'],
    products = ['C#COC(O)[C](F)F(1726)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HCCO(21)', 'O[CH][C](F)F(1635)'],
    products = ['C#COC(O)[C](F)F(1726)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H(22)', '[O]C(O)[C](F)F(1704)'],
    products = ['C#COC(O)[C](F)F(1726)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'C#CO[CH][C](F)F(3854)'],
    products = ['C#COC(O)[C](F)F(1726)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C#COC([O])[C](F)F(3855)'],
    products = ['C#COC(O)[C](F)F(1726)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#CO[C](O)[C](F)F(3856)'],
    products = ['C#COC(O)[C](F)F(1726)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[C]#COC(O)[C](F)F(3857)'],
    products = ['C#COC(O)[C](F)F(1726)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'C#COC(O)[C]F-2(3858)'],
    products = ['C#COC(O)[C](F)F(1726)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', 'C#CO[CH]O(3046)'],
    products = ['C#COC(O)[C](F)F(1726)'],
