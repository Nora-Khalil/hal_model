...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C=C(274)'],
    products = ['[CH]=CC(=C)[O](1587)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(18)', '[CH]C=C=O(1608)'],
    products = ['[CH]=CC(=C)[O](1587)'],
