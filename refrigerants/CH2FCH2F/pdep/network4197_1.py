...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0439801,'amu*angstrom^2'), symmetry=1, barrier=(53.7936,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33874,0.0667128,-0.000119691,1.13291e-07,-4.16595e-11,-27687.9,22.4508], Tmin=(100,'K'), Tmax=(801.033,'K')), NASAPolynomial(coeffs=[6.92433,0.0244831,-1.37642e-05,2.78698e-09,-1.97815e-13,-28122.7,-0.386014], Tmin=(801.033,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-230.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-F1sCdd)(F1s)(F1s)) + radical(Cdj(Cdd-Cd)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.43905,'amu*angstrom^2'), symmetry=1, barrier=(10.0946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.438948,'amu*angstrom^2'), symmetry=1, barrier=(10.0923,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.372348,0.0901265,-0.000163693,1.49781e-07,-5.25021e-11,-62071.5,27.583], Tmin=(100,'K'), Tmax=(833.405,'K')), NASAPolynomial(coeffs=[9.74249,0.0261196,-1.42316e-05,2.81797e-09,-1.96344e-13,-62972.3,-11.9491], Tmin=(833.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-517.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[C]C=C(F)C(F)(F)F-2(12718)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.866171,0.0762817,-0.00012591,1.12829e-07,-4.03718e-11,-79758.3,24.834], Tmin=(100,'K'), Tmax=(764.774,'K')), NASAPolynomial(coeffs=[8.77965,0.0272768,-1.48573e-05,3.00242e-09,-2.14078e-13,-80746,-9.76579], Tmin=(764.774,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-664.028,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC(F)(F)[C](F)F(11265)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', 'F[C]C=C(F)F(9126)'],
    products = ['F[C]=CC(F)(F)[C](F)F(11265)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]=CC(F)(F)[C](F)F(11265)'],
    products = ['FC1=CC(F)(F)C1(F)F(12715)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]=CC(F)=C(F)F(6408)'],
    products = ['F[C]=CC(F)(F)[C](F)F(11265)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2CF2(61)', '[CH]=[C]F(465)'],
    products = ['F[C]=CC(F)(F)[C](F)F(11265)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)[C](F)F(3840)', 'C2HF(58)'],
    products = ['F[C]=CC(F)(F)[C](F)F(11265)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC#CC(F)(F)[C](F)F(8761)'],
    products = ['F[C]=CC(F)(F)[C](F)F(11265)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C](F)[C](F)F(3840)', '[CH]=[C]F(465)'],
    products = ['F[C]=CC(F)(F)[C](F)F(11265)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'F[C]=C=C(F)[C](F)F(12716)'],
    products = ['F[C]=CC(F)(F)[C](F)F(11265)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', 'F[C]C=C(F)F(9126)'],
    products = ['F[C]=CC(F)(F)[C](F)F(11265)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FC=[C]C(F)(F)[C](F)F(7760)'],
    products = ['F[C]=CC(F)(F)[C](F)F(11265)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]=[C]C(F)(F)C(F)F(12717)'],
    products = ['F[C]=CC(F)(F)[C](F)F(11265)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]=CC(F)(F)[C](F)F(11265)'],
    products = ['F[C]C=C(F)C(F)(F)F-2(12718)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]=CC(F)(F)[C](F)F(11265)'],
    products = ['F[C](F)C=C(F)[C](F)F(6363)'],
...
network(
    label = 'PDepNetwork #4197',
    isomers = [
        'F[C]=CC(F)(F)[C](F)F(11265)',
    ],
    reactants = [
        ('CF2CF2(61)', 'C2HF(58)'),
    ],
