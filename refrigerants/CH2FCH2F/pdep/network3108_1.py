...
"""),
    E0 = (449.483,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,278.991,279.002,279.005,279.009,279.01,279.014],'cm^-1')),
        HinderedRotor(inertia=(0.00216549,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.0659,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01595,0.0336664,-8.17979e-06,-2.49198e-08,1.53491e-11,54141.1,14.5149], Tmin=(100,'K'), Tmax=(915.227,'K')), NASAPolynomial(coeffs=[15.4185,0.00148663,1.2997e-06,-3.12676e-10,1.97461e-14,50582.3,-54.9968], Tmin=(915.227,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Cds_P)"""),
)
...
"""),
    E0 = (248.581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,3150,900,1100,1685,370,3120,650,792.5,1650,406.195,406.34,406.592,406.627],'cm^-1')),
        HinderedRotor(inertia=(0.0010192,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2312,0.041497,-4.19476e-05,2.33609e-08,-5.46225e-12,29958.9,18.3616], Tmin=(100,'K'), Tmax=(1009.26,'K')), NASAPolynomial(coeffs=[7.76221,0.0195757,-9.36692e-06,1.83947e-09,-1.31188e-13,28842.5,-8.37324], Tmin=(1009.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cs-Cs(F)-O2s) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=CC1=CO1(9488)'],
    products = ['[CH]=CC1(F)[CH]O1(9318)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(28.6533,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#CC1(F)[CH]O1(9489)'],
    products = ['[CH]=CC1(F)[CH]O1(9318)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[CH]=C=C1[CH]O1(9490)'],
    products = ['[CH]=CC1(F)[CH]O1(9318)'],
