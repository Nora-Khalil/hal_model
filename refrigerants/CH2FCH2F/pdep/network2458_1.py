...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.123149,0.0758808,-8.47702e-05,4.3593e-08,-8.3847e-12,-54739.9,26.8338], Tmin=(100,'K'), Tmax=(1403.12,'K')), NASAPolynomial(coeffs=[22.8436,0.00360721,-2.36673e-07,-2.56814e-11,2.4629e-15,-60515.6,-89.3611], Tmin=(1403.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-456.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29426,0.0518924,-3.45847e-05,4.06725e-09,3.22207e-12,-33442.3,18.8185], Tmin=(100,'K'), Tmax=(992.47,'K')), NASAPolynomial(coeffs=[13.7736,0.017397,-6.32975e-06,1.12901e-09,-7.85482e-14,-36697.6,-45.2132], Tmin=(992.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCCFF) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(34dihydro12dioxin) + radical(CCsJOOC)"""),
)

species(
    label = 'F[C](F)C1C=COO1(7195)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17472,0.0497287,-2.01479e-05,-1.62209e-08,1.10212e-11,-29312.8,26.0368], Tmin=(100,'K'), Tmax=(1003.78,'K')), NASAPolynomial(coeffs=[17.5461,0.0120257,-4.95456e-06,1.01721e-09,-7.85491e-14,-33986.7,-59.9174], Tmin=(1003.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(12dioxolene) + radical(CsCsF1sF1s)"""),
)
...
"""),
    E0 = (404.207,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2995,3025,975,1000,1300,1375,400,500,1630,1680,3120,650,792.5,1650,167,640,1190],'cm^-1')),
        HinderedRotor(inertia=(0.878397,'amu*angstrom^2'), symmetry=1, barrier=(20.1961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.879171,'amu*angstrom^2'), symmetry=1, barrier=(20.2139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.880466,'amu*angstrom^2'), symmetry=1, barrier=(20.2437,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22506,0.0650348,-8.7457e-05,6.12421e-08,-1.71465e-11,48711.3,26.2288], Tmin=(100,'K'), Tmax=(871.268,'K')), NASAPolynomial(coeffs=[11.0254,0.0200422,-9.99776e-06,1.97377e-09,-1.40415e-13,47003.5,-19.7016], Tmin=(871.268,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(404.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cds_P) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    E0 = (192.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,562,600,623,1070,1265,1685,370,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.323294,'amu*angstrom^2'), symmetry=1, barrier=(7.43317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322815,'amu*angstrom^2'), symmetry=1, barrier=(7.42215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.16202,'amu*angstrom^2'), symmetry=1, barrier=(49.709,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04006,0.0718318,-0.000116563,1.03074e-07,-3.62781e-11,23263.2,30.7218], Tmin=(100,'K'), Tmax=(788.991,'K')), NASAPolynomial(coeffs=[8.36597,0.0262532,-1.38688e-05,2.74599e-09,-1.93206e-13,22369.8,-1.2208], Tmin=(788.991,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = 'C#COO[CH][C](F)F(1767)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.61892,'amu*angstrom^2'), symmetry=1, barrier=(37.2221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.61709,'amu*angstrom^2'), symmetry=1, barrier=(37.1802,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.61605,'amu*angstrom^2'), symmetry=1, barrier=(37.1562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.61863,'amu*angstrom^2'), symmetry=1, barrier=(37.2154,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.305679,0.0902398,-0.000158011,1.40846e-07,-4.87392e-11,15797.2,27.0721], Tmin=(100,'K'), Tmax=(818.421,'K')), NASAPolynomial(coeffs=[10.6372,0.0257584,-1.41952e-05,2.8156e-09,-1.96817e-13,14574.5,-17.8393], Tmin=(818.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-7.88652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2995,3025,975,1000,1300,1375,400,500,1630,1680,194,682,905,1196,1383,3221,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(0.281115,'amu*angstrom^2'), symmetry=1, barrier=(6.46338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.558677,'amu*angstrom^2'), symmetry=1, barrier=(12.8451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.08532,'amu*angstrom^2'), symmetry=1, barrier=(47.9456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.877143,0.0754564,-0.000117542,1.0277e-07,-3.63699e-11,-842.575,28.5224], Tmin=(100,'K'), Tmax=(762.461,'K')), NASAPolynomial(coeffs=[8.3949,0.0298537,-1.57021e-05,3.12291e-09,-2.21025e-13,-1809.82,-4.53279], Tmin=(762.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.88652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=COOC=C(F)F(4948)'],
    products = ['HCCO(21)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(26.0238,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[CH]=COOC=C(F)F(4948)'],
    products = ['[CH]=COC(F)(F)C=O(7192)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[C]=COOC=C(F)F(7193)'],
    products = ['[CH]=COOC=C(F)F(4948)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=COOC=C(F)F(4948)'],
    products = ['O=C[C](F)F(787)', 'C1=CO1(450)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=COOC=[C]F(7196)'],
    products = ['[CH]=COOC=C(F)F(4948)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C[C](F)F(787)', '[CH]=C[O](134)'],
    products = ['[CH]=COOC=C(F)F(4948)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(194.876,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CF2CH(73)', '[CH]=CO[O](192)'],
    products = ['[CH]=COOC=C(F)F(4948)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC=C(F)F(785)', '[CH]=[CH](257)'],
    products = ['[CH]=COOC=C(F)F(4948)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH]=COO[C]=C(F)F(7197)'],
    products = ['[CH]=COOC=C(F)F(4948)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]=COOC=CF(7199)'],
    products = ['[CH]=COOC=C(F)F(4948)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(178.892,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
...
network(
    ...
    reactants = [
        ('HCCO(21)', 'O=CC(F)F(990)'),
        ('O=C[C](F)F(787)', 'C1=CO1(450)'),
        ('O=C[C](F)F(787)', '[CH]=C[O](134)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
