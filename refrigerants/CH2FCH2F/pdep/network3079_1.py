...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60991,0.0536878,-4.86462e-05,2.27488e-08,-4.37867e-12,-75587.8,21.5696], Tmin=(100,'K'), Tmax=(1218.23,'K')), NASAPolynomial(coeffs=[10.9151,0.0231348,-1.10264e-05,2.1617e-09,-1.53872e-13,-77854.9,-25.1592], Tmin=(1218.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-629.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(CdCFF) + ring(Cs-Cs(F)-O2s)"""),
)

species(
    label = '[O]C=C(F)C[C](F)F(9272)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-117.792,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,190,488,555,1236,1407,180,613.319,613.525,613.529,613.835,613.902,613.918,614.04],'cm^-1')),
        HinderedRotor(inertia=(0.0117579,'amu*angstrom^2'), symmetry=1, barrier=(3.14437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0509812,'amu*angstrom^2'), symmetry=1, barrier=(13.6468,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30013,0.0505784,-3.71737e-05,4.56619e-09,3.61489e-12,-14062,23.2368], Tmin=(100,'K'), Tmax=(998.03,'K')), NASAPolynomial(coeffs=[16.0404,0.00991784,-3.74225e-06,7.24075e-10,-5.41911e-14,-17921.5,-52.4423], Tmin=(998.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76295,0.0524581,-4.92516e-05,2.51906e-08,-5.45288e-12,-42700.6,25.7882], Tmin=(100,'K'), Tmax=(1076.48,'K')), NASAPolynomial(coeffs=[8.84874,0.0261285,-1.2563e-05,2.46925e-09,-1.76094e-13,-44226.1,-8.91878], Tmin=(1076.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-355.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(Cs(F)(C)-Cs-O2s) + radical(CCJCO) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.615142,0.0723318,-9.47898e-05,6.34474e-08,-1.61275e-11,-50472.4,24.7988], Tmin=(100,'K'), Tmax=(1092.55,'K')), NASAPolynomial(coeffs=[14.0355,0.0144634,-3.34859e-06,3.33318e-10,-1.12278e-14,-52883.6,-38.749], Tmin=(1092.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-420.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFFF) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)CC1(F)[CH]O1(9207)'],
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', '[CH2]C1(F)[CH]O1(9221)'],
    products = ['F[C](F)CC1(F)[CH]O1(9207)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C=C(F)C[C](F)F(9272)'],
    products = ['F[C](F)CC1(F)[CH]O1(9207)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[C](F)CC1=CO1(9273)'],
    products = ['F[C](F)CC1(F)[CH]O1(9207)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(34.9488,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    products = ['F[C](F)CC1(F)[CH]O1(9207)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(3.04093,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'FC(F)=CC1(F)[CH]O1(9274)'],
    products = ['F[C](F)CC1(F)[CH]O1(9207)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[C](F)C=C1[CH]O1(9275)'],
    products = ['F[C](F)CC1(F)[CH]O1(9207)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]C1(F)[CH]O1(9221)'],
    products = ['F[C](F)CC1(F)[CH]O1(9207)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)CC1(F)[CH]O1(9207)'],
    products = ['FC(F)[CH]C1(F)[CH]O1(9276)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)CC1(F)[CH]O1(9207)'],
    products = ['F[C](F)[CH]C1(F)CO1(9277)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)CC1(F)[CH]O1(9207)'],
    products = ['FC(F)(F)C[C]1[CH]O1(9278)'],
...
network(
    label = 'PDepNetwork #3079',
    isomers = [
        'F[C](F)CC1(F)[CH]O1(9207)',
    ],
    reactants = [
