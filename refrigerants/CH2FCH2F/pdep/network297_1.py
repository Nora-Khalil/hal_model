...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(=C)[O](386)'],
    products = ['C=C([O])C[O](608)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(=O)C=O(1342)'],
    products = ['C=C([O])C[O](608)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](133)', '[CH2][C]=O(338)'],
    products = ['C=C([O])C[O](608)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[O]C[C]=O(515)'],
    products = ['C=C([O])C[O](608)'],
