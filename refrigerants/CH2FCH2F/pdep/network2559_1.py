...
"""),
    E0 = (-958.71,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,235,523,627,1123,1142,1372,1406,3097,299.53,299.753,300.148,300.348],'cm^-1')),
        HinderedRotor(inertia=(0.177018,'amu*angstrom^2'), symmetry=1, barrier=(11.3032,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.451041,'amu*angstrom^2'), symmetry=1, barrier=(28.9651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240589,'amu*angstrom^2'), symmetry=1, barrier=(15.2578,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.228094,0.100318,-0.000149794,1.12634e-07,-3.34955e-11,-115160,29.6965], Tmin=(100,'K'), Tmax=(824.486,'K')), NASAPolynomial(coeffs=[15.1555,0.0256843,-1.40112e-05,2.84136e-09,-2.04148e-13,-117697,-41.5513], Tmin=(824.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-958.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(CC(C)OJ)"""),
)
...
"""),
    E0 = (-1065.45,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,251,367,519,700,855,1175,1303,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,231.984,231.984,231.985],'cm^-1')),
        HinderedRotor(inertia=(0.232163,'amu*angstrom^2'), symmetry=1, barrier=(8.86623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232163,'amu*angstrom^2'), symmetry=1, barrier=(8.86623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.811859,'amu*angstrom^2'), symmetry=1, barrier=(31.0047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0538859,0.0973413,-0.000163892,1.41152e-07,-4.7806e-11,-128005,29.452], Tmin=(100,'K'), Tmax=(788.138,'K')), NASAPolynomial(coeffs=[12.5437,0.0260842,-1.43404e-05,2.86394e-09,-2.01805e-13,-129764,-26.8821], Tmin=(788.138,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1065.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsCs)"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3968.15,'J/mol'), sigma=(6.48152,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=619.82 K, Pc=33.07 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-327.033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,3025,407.5,1350,352.5,180,180,1888.7],'cm^-1')),
        HinderedRotor(inertia=(0.424218,'amu*angstrom^2'), symmetry=1, barrier=(9.75362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.424911,'amu*angstrom^2'), symmetry=1, barrier=(9.76955,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.952994,0.0886849,-0.000205363,2.15272e-07,-8.06311e-11,-39244,21.5345], Tmin=(100,'K'), Tmax=(873.811,'K')), NASAPolynomial(coeffs=[1.50435,0.0331659,-1.90852e-05,3.74668e-09,-2.55451e-13,-37317.1,30.5259], Tmin=(873.811,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-327.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-F1sF1sO2s)(O2s-H)(H))"""),
)

species(
    label = '[O][C](C(F)F)C(F)(F)OF(6940)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.60038,'amu*angstrom^2'), symmetry=1, barrier=(13.8039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.601925,'amu*angstrom^2'), symmetry=1, barrier=(13.8394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01554,'amu*angstrom^2'), symmetry=1, barrier=(23.3492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.653117,0.112551,-0.000200612,1.75137e-07,-5.89481e-11,-93905,30.6267], Tmin=(100,'K'), Tmax=(824.28,'K')), NASAPolynomial(coeffs=[14.5119,0.0244515,-1.38915e-05,2.76724e-09,-1.93116e-13,-95912.2,-36.6155], Tmin=(824.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-782.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[O]C([C](F)F)C(F)(F)OF(3038)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-756.841,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,190,488,555,1236,1407,324.791,324.803,324.807,324.81],'cm^-1')),
        HinderedRotor(inertia=(0.382259,'amu*angstrom^2'), symmetry=1, barrier=(28.6177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142014,'amu*angstrom^2'), symmetry=1, barrier=(10.6331,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142015,'amu*angstrom^2'), symmetry=1, barrier=(10.6327,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.196623,0.102771,-0.000164141,1.22247e-07,-3.15605e-11,-90885.8,30.6556], Tmin=(100,'K'), Tmax=(623.971,'K')), NASAPolynomial(coeffs=[14.562,0.024194,-1.37887e-05,2.78841e-09,-1.97897e-13,-93039.7,-36.0865], Tmin=(623.971,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-756.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(CC(C)OJ) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-703.396,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,280,501,1494,1531,180,180,1209.68],'cm^-1')),
        HinderedRotor(inertia=(2.23488,'amu*angstrom^2'), symmetry=1, barrier=(51.3843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.608441,'amu*angstrom^2'), symmetry=1, barrier=(13.9893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.2434,'amu*angstrom^2'), symmetry=1, barrier=(51.5802,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.717042,0.0802115,-0.00013478,1.2079e-07,-4.26202e-11,-84488.5,26.2923], Tmin=(100,'K'), Tmax=(802.401,'K')), NASAPolynomial(coeffs=[8.83884,0.0279353,-1.50174e-05,2.97671e-09,-2.08985e-13,-85412.4,-8.7379], Tmin=(802.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-703.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsCs) + radical(CsCOF1sO2s)"""),
)

species(
    label = 'O=C([CH]F)C(F)(F)OF(6942)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0156915,'amu*angstrom^2'), symmetry=1, barrier=(19.632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.15107,'amu*angstrom^2'), symmetry=1, barrier=(49.4573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.472406,'amu*angstrom^2'), symmetry=1, barrier=(10.8615,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.573383,0.0815542,-0.000126904,1.01209e-07,-3.20177e-11,-84613.4,25.5916], Tmin=(100,'K'), Tmax=(775.659,'K')), NASAPolynomial(coeffs=[12.1048,0.0220921,-1.1922e-05,2.39019e-09,-1.69975e-13,-86402.5,-27.112], Tmin=(775.659,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(Csj(CO-CsO2d)(F1s)(H))"""),
)
...
"""),
    E0 = (-1012.44,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,253,525,597,667,842,1178,1324,522,611,926,1093,1137,1374,1416,3112,360,370,350,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.617325,'amu*angstrom^2'), symmetry=1, barrier=(14.1935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616547,'amu*angstrom^2'), symmetry=1, barrier=(14.1756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.617427,'amu*angstrom^2'), symmetry=1, barrier=(14.1959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616734,'amu*angstrom^2'), symmetry=1, barrier=(14.1799,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.815698,0.116534,-0.000206432,1.79953e-07,-6.0393e-11,-121606,31.4025], Tmin=(100,'K'), Tmax=(832.761,'K')), NASAPolynomial(coeffs=[14.6168,0.0261752,-1.44368e-05,2.84501e-09,-1.97287e-13,-123613,-36.847], Tmin=(832.761,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1012.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(C2CsJOH)"""),
)

species(
    label = 'OC([C](F)F)C(F)(F)OF(5565)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-987.202,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,190,488,555,1236,1407,293.062,297.31,297.519],'cm^-1')),
...
"""),
    E0 = (-625.302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,395,473,707,1436,200.696,200.765,200.779,200.834],'cm^-1')),
        HinderedRotor(inertia=(0.312389,'amu*angstrom^2'), symmetry=1, barrier=(8.92573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311579,'amu*angstrom^2'), symmetry=1, barrier=(8.92611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2107,'amu*angstrom^2'), symmetry=1, barrier=(34.6233,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.701866,'amu*angstrom^2'), symmetry=1, barrier=(20.0898,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.725502,0.114591,-0.000201475,1.7692e-07,-6.01591e-11,-75046.6,32.4206], Tmin=(100,'K'), Tmax=(820.044,'K')), NASAPolynomial(coeffs=[13.7906,0.0284317,-1.57927e-05,3.13593e-09,-2.19031e-13,-76911.1,-31.5837], Tmin=(820.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-625.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFH) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'F[CH]C(OF)C(F)(F)OF(6944)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-638.501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,234.143,234.143,234.144,234.146],'cm^-1')),
        HinderedRotor(inertia=(0.198244,'amu*angstrom^2'), symmetry=1, barrier=(7.71246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198245,'amu*angstrom^2'), symmetry=1, barrier=(7.71246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.73448,'amu*angstrom^2'), symmetry=1, barrier=(28.5738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.734474,'amu*angstrom^2'), symmetry=1, barrier=(28.5738,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.847413,0.118072,-0.000210556,1.86559e-07,-6.38548e-11,-76630.4,31.8012], Tmin=(100,'K'), Tmax=(820.858,'K')), NASAPolynomial(coeffs=[13.8624,0.0291209,-1.645e-05,3.28197e-09,-2.29638e-13,-78463.5,-32.7171], Tmin=(820.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-638.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]C(OF)C(F)F(5548)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(43)', '[O]CC(F)(F)OF(4405)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', '[O]C(F)C(F)(F)OF(3652)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'FOC(F)(F)[CH]C(F)F(3373)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(2145)', 'O=CC(F)F(990)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF2(82)', 'O=CC(F)(F)OF(3653)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(C(F)F)C(F)(F)OF(6939)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C([C](F)OF)C(F)F(5128)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C([CH]F)C(F)(F)OF(5126)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(C(F)F)C([O])(F)F(5012)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', '[O]C([C](F)F)C(F)F(4816)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(2145)', '[O][CH]C(F)F(1636)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF2(82)', '[O][CH]C(F)(F)OF(2356)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O][C](C(F)F)C(F)(F)OF(6940)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C([C](F)F)C(F)(F)OF(3038)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', '[O]C(C(=O)F)C(F)F(5051)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C([C](F)OF)C(F)F(6941)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=C([CH]F)C(F)(F)OF(6942)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
    products = ['F2(78)', 'CF2O(49)', 'O=C[CH]F(435)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
    products = ['O[C](C(F)F)C(F)(F)OF(5564)'],
...
reaction(
    label = 'reaction22',
    reactants = ['OC([C](F)F)C(F)(F)OF(5565)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)(F)C(OF)C(F)F(5576)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction24',
    reactants = ['FO[C](F)C(OF)C(F)F(6943)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[CH]C(OF)C(F)(F)OF(6944)'],
    products = ['[O]C(C(F)F)C(F)(F)OF(5562)'],
...
network(
    label = 'PDepNetwork #2559',
    isomers = [
        '[O]C(C(F)F)C(F)(F)OF(5562)',
    ],
    reactants = [
