...
"""),
    E0 = (-426.784,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,326,540,652,719,1357,194,682,905,1196,1383,3221,180,1087.7],'cm^-1')),
        HinderedRotor(inertia=(0.322973,'amu*angstrom^2'), symmetry=1, barrier=(7.42579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3229,'amu*angstrom^2'), symmetry=1, barrier=(7.42411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322893,'amu*angstrom^2'), symmetry=1, barrier=(7.42396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.2084,'amu*angstrom^2'), symmetry=1, barrier=(50.7755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0188655,0.100899,-0.000176242,1.6542e-07,-6.01755e-11,-51197.6,31.8554], Tmin=(100,'K'), Tmax=(821.602,'K')), NASAPolynomial(coeffs=[7.51751,0.0401716,-2.14879e-05,4.24135e-09,-2.96388e-13,-51624.7,1.91481], Tmin=(821.602,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-426.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.117133,0.0932987,-0.000145666,1.25169e-07,-4.32836e-11,-98195,30.0868], Tmin=(100,'K'), Tmax=(769.535,'K')), NASAPolynomial(coeffs=[10.2875,0.0340376,-1.76848e-05,3.49502e-09,-2.46303e-13,-99570.9,-15.0844], Tmin=(769.535,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-817.539,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + group(COCsFO) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (16.3667,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,326,540,652,719,1357,194,682,905,1196,1383,3221,180,180,1393.86,1395.4],'cm^-1')),
        HinderedRotor(inertia=(0.135803,'amu*angstrom^2'), symmetry=1, barrier=(3.12239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135511,'amu*angstrom^2'), symmetry=1, barrier=(3.11566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139194,'amu*angstrom^2'), symmetry=1, barrier=(3.20035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.36949,'amu*angstrom^2'), symmetry=1, barrier=(54.4794,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.576745,0.0839894,-0.000135606,1.23087e-07,-4.45123e-11,2083.31,28.8161], Tmin=(100,'K'), Tmax=(794.037,'K')), NASAPolynomial(coeffs=[7.58727,0.035347,-1.85421e-05,3.66446e-09,-2.57654e-13,1390.1,-0.743448], Tmin=(794.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.3667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0627473,0.0725371,-6.90588e-05,3.35643e-08,-6.20205e-12,-67442.4,25.8862], Tmin=(100,'K'), Tmax=(1517.36,'K')), NASAPolynomial(coeffs=[17.6986,0.0157957,-3.16032e-06,3.02723e-10,-1.20214e-14,-71690.5,-63.4448], Tmin=(1517.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-562.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCsCsFH) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCFHO) + ring(12dioxane) + radical(CsCsF1sO2s) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[CH]C1(F)OOCC1F(10954)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.192344,0.0814017,-9.25165e-05,5.33062e-08,-1.14663e-11,-68877.5,23.5625], Tmin=(100,'K'), Tmax=(894.929,'K')), NASAPolynomial(coeffs=[15.6298,0.0214875,-7.32232e-06,1.1862e-09,-7.55581e-14,-72004.4,-51.2335], Tmin=(894.929,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-573.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(12dioxolane) + radical(Csj(Cs-F1sO2sCs)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (-157.237,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,293,496,537,1218,167,640,1190,180,180,1957.07],'cm^-1')),
        HinderedRotor(inertia=(0.00333815,'amu*angstrom^2'), symmetry=1, barrier=(9.06765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88225,'amu*angstrom^2'), symmetry=1, barrier=(43.2765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88004,'amu*angstrom^2'), symmetry=1, barrier=(43.2259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.393789,'amu*angstrom^2'), symmetry=1, barrier=(9.05399,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0125859,0.102799,-0.000192571,1.86215e-07,-6.83283e-11,-18782.2,32.779], Tmin=(100,'K'), Tmax=(837.294,'K')), NASAPolynomial(coeffs=[6.48472,0.0396769,-2.17995e-05,4.31006e-09,-2.99994e-13,-18737.2,9.44467], Tmin=(837.294,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    E0 = (-351.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,293,496,537,1218,167,640,1190,180,180,1978.01],'cm^-1')),
        HinderedRotor(inertia=(0.269447,'amu*angstrom^2'), symmetry=1, barrier=(6.19511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269856,'amu*angstrom^2'), symmetry=1, barrier=(6.20452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89886,'amu*angstrom^2'), symmetry=1, barrier=(43.6585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89982,'amu*angstrom^2'), symmetry=1, barrier=(43.6806,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.173819,0.0960953,-0.000164487,1.55712e-07,-5.76132e-11,-42105.8,31.2312], Tmin=(100,'K'), Tmax=(809.764,'K')), NASAPolynomial(coeffs=[6.57334,0.0419616,-2.24905e-05,4.46133e-09,-3.13379e-13,-42403.8,6.26688], Tmin=(809.764,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-351.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = 'FC=[C]OOCC(F)F(10719)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-416.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,615,860,1140,1343,3152,1685,370,180,180,207.685],'cm^-1')),
        HinderedRotor(inertia=(0.327783,'amu*angstrom^2'), symmetry=1, barrier=(7.53637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.107001,0.0937572,-0.00014421,1.24234e-07,-4.35601e-11,-49917.3,29.9231], Tmin=(100,'K'), Tmax=(744.403,'K')), NASAPolynomial(coeffs=[9.88993,0.0364754,-1.92861e-05,3.84937e-09,-2.73285e-13,-51243.2,-13.509], Tmin=(744.403,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-416.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOCC(F)F(10720)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-412.868,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,293,496,537,1218,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.192062,'amu*angstrom^2'), symmetry=1, barrier=(4.41589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26777,'amu*angstrom^2'), symmetry=1, barrier=(29.1486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191845,'amu*angstrom^2'), symmetry=1, barrier=(4.4109,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.1368,'amu*angstrom^2'), symmetry=1, barrier=(49.1293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.013788,0.0971237,-0.000157855,1.41213e-07,-5.03989e-11,-49522.1,30.8989], Tmin=(100,'K'), Tmax=(783.861,'K')), NASAPolynomial(coeffs=[9.35976,0.0372151,-1.98355e-05,3.94629e-09,-2.7856e-13,-50612,-9.52], Tmin=(783.861,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-412.868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]COOC(F)=CF(10718)'],
    products = ['O=C[CH]F(435)', 'O=C(F)CF(476)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(19.8266,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]COOC(F)=CF(10718)'],
    products = ['O=C(F)C(F)OC[CH]F(10951)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]COOC(F)=CF-2(10952)'],
    products = ['F[CH]COOC(F)=CF(10718)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', '[CH2]OOC(F)=CF(10297)'],
    products = ['F[CH]COOC(F)=CF(10718)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'F[C]COOC(F)=CF-2(10902)'],
    products = ['F[CH]COOC(F)=CF(10718)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]COOC(F)=CF(10718)'],
    products = ['F[C]1OOCC(F)C1F(10953)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]COOC(F)=CF(10718)'],
    products = ['F[CH]C1(F)OOCC1F(10954)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[CH]COO[C]=CF(10955)'],
    products = ['F[CH]COOC(F)=CF(10718)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH]=C(F)OOC[CH]F(10956)'],
    products = ['F[CH]COOC(F)=CF(10718)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHFCF[Z](72)', '[O]OC[CH]F(215)'],
    products = ['F[CH]COOC(F)=CF(10718)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'C#COOC[CH]F(2454)'],
    products = ['F[CH]COOC(F)=CF(10718)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHF(40)', '[CH2]OOC(F)=CF(10297)'],
    products = ['F[CH]COOC(F)=CF(10718)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'F[C]COOC(F)=CF(10715)'],
    products = ['F[CH]COOC(F)=CF(10718)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]COOC(F)=CF(10718)'],
    products = ['FC=C(F)OO[CH]CF(10485)'],
...
reaction(
    label = 'reaction24',
    reactants = ['FC=[C]OOCC(F)F(10719)'],
    products = ['F[CH]COOC(F)=CF(10718)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(193.229,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction25',
    reactants = ['[CH]=C(F)OOCC(F)F(10720)'],
    products = ['F[CH]COOC(F)=CF(10718)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(191.485,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)
...
network(
    ...
    isomers = [
        'F[CH]COOC(F)=CF(10718)',
    ],
    reactants = [
        ('O=C[CH]F(435)', 'O=C(F)CF(476)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
