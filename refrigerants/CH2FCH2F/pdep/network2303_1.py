...
"""),
    E0 = (-542.078,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([207,311,436,622,447,691,1074,1182,1276,1366,1311,1469,3045,3235,190,488,555,1236,1407,3000,3100,440,815,1455,1000,217.539,217.555],'cm^-1')),
        HinderedRotor(inertia=(0.264259,'amu*angstrom^2'), symmetry=1, barrier=(8.86742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.937549,'amu*angstrom^2'), symmetry=1, barrier=(31.4913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263832,'amu*angstrom^2'), symmetry=1, barrier=(8.86932,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.348812,0.0877593,-0.000139716,1.20351e-07,-4.14563e-11,-65072.6,26.5813], Tmin=(100,'K'), Tmax=(767.755,'K')), NASAPolynomial(coeffs=[10.4401,0.0296647,-1.54305e-05,3.06732e-09,-2.16911e-13,-66459.5,-18.377], Tmin=(767.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-542.078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sH)(F1s)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(2909.47,'J/mol'), sigma=(5.31245,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=454.45 K, Pc=44.03 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.78332,0.0209893,8.22449e-05,-1.65199e-07,8.98509e-11,-96062.3,11.7884], Tmin=(10,'K'), Tmax=(637.733,'K')), NASAPolynomial(coeffs=[3.76105,0.0446586,-2.87709e-05,8.70825e-09,-1.00295e-12,-96537.9,8.13445], Tmin=(637.733,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-798.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), label="""FC1CC(F)C1(F)F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'C=C(F)C(F)(F)CF(6144)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
4  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-423.815,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.334455,'amu*angstrom^2'), symmetry=1, barrier=(7.68979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334278,'amu*angstrom^2'), symmetry=1, barrier=(7.68571,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.48146,0.050217,-6.75417e-05,6.86046e-08,-3.29917e-11,-50973.2,13.2063], Tmin=(10,'K'), Tmax=(476.435,'K')), NASAPolynomial(coeffs=[5.13615,0.0363248,-2.38036e-05,7.40269e-09,-8.77199e-13,-51130.9,6.45021], Tmin=(476.435,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-423.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""CDCC(F)(F)[CH]F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.55872,'amu*angstrom^2'), symmetry=1, barrier=(35.838,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.50239,'amu*angstrom^2'), symmetry=1, barrier=(34.5428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0178324,'amu*angstrom^2'), symmetry=1, barrier=(69.795,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-565.378,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,334,575,1197,1424,3202,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.238509,'amu*angstrom^2'), symmetry=1, barrier=(5.48378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238655,'amu*angstrom^2'), symmetry=1, barrier=(5.48714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238561,'amu*angstrom^2'), symmetry=1, barrier=(5.48499,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.253914,0.09539,-0.000174898,1.64807e-07,-5.88282e-11,-67876.9,25.9922], Tmin=(100,'K'), Tmax=(851.591,'K')), NASAPolynomial(coeffs=[7.49371,0.0336982,-1.74678e-05,3.38693e-09,-2.32901e-13,-68106.1,-1.87835], Tmin=(851.591,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-565.378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-HHH)(F1s)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[CH2][C](F)C(F)(F)CF(806)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.280246,'amu*angstrom^2'), symmetry=1, barrier=(6.44341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.85315,'amu*angstrom^2'), symmetry=1, barrier=(19.6156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.279943,'amu*angstrom^2'), symmetry=1, barrier=(6.43645,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.228191,0.0928396,-0.000159696,1.43979e-07,-5.02687e-11,-66972.1,26.3551], Tmin=(100,'K'), Tmax=(830.357,'K')), NASAPolynomial(coeffs=[9.5079,0.0306551,-1.57822e-05,3.07981e-09,-2.13725e-13,-67910.5,-13.06], Tmin=(830.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-557.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)[C](F)C(F)F(6139)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (128.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.507118,0.0878546,-0.000153071,1.4444e-07,-5.28e-11,-65437.7,27.4406], Tmin=(100,'K'), Tmax=(819.68,'K')), NASAPolynomial(coeffs=[6.851,0.0357018,-1.88457e-05,3.72513e-09,-2.60858e-13,-65765.7,2.4398], Tmin=(819.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-545.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'F[CH][C](F)C(F)CF(907)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-517.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,528,1116,1182,1331,1402,1494,3075,3110,212,367,445,1450,334,575,1197,1424,3202,204.574,205.146,205.806],'cm^-1')),
        HinderedRotor(inertia=(0.623023,'amu*angstrom^2'), symmetry=1, barrier=(18.9679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.665965,'amu*angstrom^2'), symmetry=1, barrier=(20.1191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.604229,'amu*angstrom^2'), symmetry=1, barrier=(18.9446,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.068,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C(F)[C](F)F(6109)'],
    products = ['[CH2]C(F)C(F)(F)[CH]F(6108)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', '[CH2]C(F)[C](F)F(772)'],
    products = ['[CH2]C(F)C(F)(F)[CH]F(6108)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)(F)[CH]F(6143)'],
    products = ['[CH2]C(F)C(F)(F)[CH]F(6108)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)C(F)=CF(895)'],
    products = ['[CH2]C(F)C(F)(F)[CH]F(6108)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(48.0596,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[CH2]C=C(F)[CH]F(898)'],
    products = ['[CH2]C(F)C(F)(F)[CH]F(6108)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(16.2774,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2]C(F)=C(F)[CH]F(922)'],
    products = ['[CH2]C(F)C(F)(F)[CH]F(6108)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(246.049,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', '[CH2]C(F)[C](F)F(772)'],
    products = ['[CH2]C(F)C(F)(F)[CH]F(6108)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[C](F)C(F)(F)[CH]F(6147)'],
    products = ['[CH2]C(F)C(F)(F)[CH]F(6108)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)C(F)(F)[CH]F(6108)'],
    products = ['[CH2]C(F)[C](F)C(F)F(6139)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(2.01526e+12,'s^-1'), n=0.18834, Ea=(182.583,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction20',
    reactants = ['F[CH][C](F)C(F)CF(907)'],
    products = ['[CH2]C(F)C(F)(F)[CH]F(6108)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(213.763,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(208.962,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)C(F)(F)[CH]F(6108)'],
    products = ['F[CH]C(F)(F)[CH]CF(6132)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(182.019,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

network(
    label = 'PDepNetwork #2303',
    isomers = [
        '[CH2]C(F)C(F)(F)[CH]F(6108)',
    ],
    reactants = [
        ('CHFCF2(55)', 'CH2CHF(56)'),
    ],
