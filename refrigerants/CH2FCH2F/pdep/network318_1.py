...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH2]O[CH2](313)'],
    products = ['[CH2]OC[C](F)F(629)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]OC=C(F)F(927)'],
    products = ['[CH2]OC[C](F)F(629)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH2]O[CH2](313)'],
    products = ['[CH2]OC[C](F)F(629)'],
