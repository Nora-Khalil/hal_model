...
species(
    label = '[CH2]C(F)OC([CH2])(F)F(10116)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.602508,0.0811513,-0.000104065,7.25494e-08,-2.07289e-11,-63713.3,26.8894], Tmin=(100,'K'), Tmax=(845.437,'K')), NASAPolynomial(coeffs=[11.0742,0.0316068,-1.61619e-05,3.23388e-09,-2.32028e-13,-65483.9,-21.8724], Tmin=(845.437,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-530.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(467)', '[CH2]C([O])F(139)'],
    products = ['[CH2]C(F)O[C](F)CF(9998)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]O[C](F)CF(1130)'],
    products = ['[CH2]C(F)O[C](F)CF(9998)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]CF(125)', '[CH2]C([O])F(139)'],
    products = ['[CH2]C(F)O[C](F)CF(9998)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)O[C](F)CF(9998)'],
    products = ['CC(F)O[C](F)[CH]F(10114)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)O[C](F)CF(9998)'],
    products = ['[CH2][CH]OC(F)(F)CF(10115)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(218.226,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)O[C](F)CF(9998)'],
    products = ['[CH2]C(F)OC([CH2])(F)F(10116)'],
...
network(
    ...
    isomers = [
        '[CH2]C(F)O[C](F)CF(9998)',
    ],
    reactants = [
        ('O=C(F)CF(476)', 'CH2CHF(56)'),
        ('F[C]CF(125)', '[CH2]C([O])F(139)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
