...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(9632)', 'F[C]CF-2(467)'],
    products = ['F[C]=CO[C](F)CF(10042)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)OC=[C]F(2010)'],
    products = ['F[C]=CO[C](F)CF(10042)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]=COC(F)=CF(10292)'],
    products = ['F[C]=CO[C](F)CF(10042)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC#CO[C](F)CF(10293)'],
    products = ['F[C]=CO[C](F)CF(10042)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['O=C[C]F(9632)', 'F[C]CF(125)'],
    products = ['F[C]=CO[C](F)CF(10042)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]=CO[C](F)CF(10042)'],
    products = ['[CH2]C(F)(F)OC=[C]F(10296)'],
