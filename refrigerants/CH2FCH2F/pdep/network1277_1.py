...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C=C([O])OF(2696)'],
    products = ['[CH]=C(F)C([O])=O(2680)'],
    transitionState = 'TS2',
