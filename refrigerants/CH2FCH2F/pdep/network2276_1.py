...
reaction(
    label = 'reaction2',
    reactants = ['C=C=C(O)COF(6211)'],
    products = ['C=C(O)C(=C)OF(6004)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(O)C([CH2])OF(6214)'],
    products = ['C=C(O)C(=C)OF(6004)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.437e+08,'s^-1'), n=1.045, Ea=(63.4002,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R3radExo;Y_rad;XH_Rrad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(OF)C([CH2])O(6215)'],
    products = ['C=C(O)C(=C)OF(6004)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.437e+08,'s^-1'), n=1.045, Ea=(63.4002,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R3radExo;Y_rad;XH_Rrad]
Euclidian distance = 0
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'C=[C]C(=C)OF(6218)'],
    products = ['C=C(O)C(=C)OF(6004)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(127)', 'C=[C]C(=C)O(6219)'],
    products = ['C=C(O)C(=C)OF(6004)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OF(196)', 'C=[C]O(195)'],
    products = ['C=C(O)C(=C)OF(6004)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH]=C(O)C(=C)OF(6220)'],
    products = ['C=C(O)C(=C)OF(6004)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH]=C(OF)C(=C)O(6221)'],
    products = ['C=C(O)C(=C)OF(6004)'],
