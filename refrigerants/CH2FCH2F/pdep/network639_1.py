...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', '[O]C[CH]F(138)'],
    products = ['[O]CC(F)[CH]F(1568)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O]C=C[CH]F(1079)'],
    products = ['[O]CC(F)[CH]F(1568)'],
