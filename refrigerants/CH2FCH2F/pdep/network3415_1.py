...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64777,0.0562815,-7.04624e-05,4.64052e-08,-1.24679e-11,-88234.7,20.2964], Tmin=(100,'K'), Tmax=(897.138,'K')), NASAPolynomial(coeffs=[9.61965,0.0207388,-1.10369e-05,2.247e-09,-1.62945e-13,-89665.1,-17.2983], Tmin=(897.138,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-734.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(COCsFO)"""),
)
...
"""),
    E0 = (67.8045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([615,860,1140,1343,3152,1685,370,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
"""),
    E0 = (-88.7005,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([293,496,537,1218,167,640,1190,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.024,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66568,0.0560708,-8.93979e-05,7.6431e-08,-2.62531e-11,-10588.7,24.9731], Tmin=(100,'K'), Tmax=(746.477,'K')), NASAPolynomial(coeffs=[8.29814,0.0185551,-1.00424e-05,2.01426e-09,-1.43098e-13,-11523.8,-4.71674], Tmin=(746.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.7005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = 'OO[O+]=[C-]C(F)F(11036)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19472,0.0778599,-0.000161355,1.66122e-07,-6.25751e-11,-35622.6,34.1141], Tmin=(100,'K'), Tmax=(861.219,'K')), NASAPolynomial(coeffs=[2.07589,0.0349833,-1.91255e-05,3.73217e-09,-2.56151e-13,-34336.1,38.345], Tmin=(861.219,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-OsH) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OOO-2(11037)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {6,S}
4 O u0 p2 c0 {3,S} {5,S}
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31969,0.0622038,-8.12465e-05,5.22538e-08,-1.32738e-11,-18957.9,22.8464], Tmin=(100,'K'), Tmax=(960.589,'K')), NASAPolynomial(coeffs=[12.5133,0.0155922,-8.46042e-06,1.73888e-09,-1.26899e-13,-21108.4,-30.7064], Tmin=(960.589,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'OOOC(F)[C]F-2(4581)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {4,S} {6,S}
4 O u0 p2 c0 {3,S} {5,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.6116,0.0359827,-6.48176e-05,6.40556e-08,-2.42658e-11,-37307.5,14.8557], Tmin=(100,'K'), Tmax=(823.363,'K')), NASAPolynomial(coeffs=[4.05491,0.0172516,-9.34303e-06,1.85155e-09,-1.29641e-13,-37148,10.5854], Tmin=(823.363,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(O2s-OsH) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OOOC(F)=CF(4569)'],
    products = ['O=O(141)', 'O=C(F)CF(476)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(72.3574,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['OOOC(F)=CF(4569)'],
    products = ['O=C(F)C(F)OO(11034)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)OOO(9835)'],
    products = ['OOOC(F)=CF(4569)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HO2(11)', 'O=C(F)[CH]F(980)'],
    products = ['OOOC(F)=CF(4569)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.49151e+08,'m^3/(mol*s)'), n=0.0472428, Ea=(81.4373,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_N-2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_N-2R->C
Ea raised from 80.6 to 81.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['OH(7)', '[O]OC(F)=CF(979)'],
    products = ['OOOC(F)=CF(4569)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OOOC(F)=[C]F(11035)'],
    products = ['OOOC(F)=CF(4569)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OO[O+]=[C-]C(F)F(11036)'],
    products = ['OOOC(F)=CF(4569)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(3.82066e+10,'s^-1'), n=0.827, Ea=(188.447,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[CH]C(F)(F)OOO-2(11037)'],
    products = ['OOOC(F)=CF(4569)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'OO[O+]=[C-]F(11038)'],
    products = ['OOOC(F)=CF(4569)'],
