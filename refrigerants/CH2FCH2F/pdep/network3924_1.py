...
"""),
    E0 = (-595.546,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,261,493,600,1152,1365,1422,3097,617,898,1187,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.25218,'amu*angstrom^2'), symmetry=1, barrier=(28.7901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25236,'amu*angstrom^2'), symmetry=1, barrier=(28.7943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25261,'amu*angstrom^2'), symmetry=1, barrier=(28.7999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25182,'amu*angstrom^2'), symmetry=1, barrier=(28.7817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0633267,0.0965768,-0.00014346,1.11058e-07,-3.43044e-11,-115233,29.0524], Tmin=(100,'K'), Tmax=(792.582,'K')), NASAPolynomial(coeffs=[13.3815,0.0287129,-1.50049e-05,2.99298e-09,-2.12955e-13,-117364,-32.6838], Tmin=(792.582,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-959.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH)"""),
)

species(
    label = 'OCC(F)(F)C(F)OF(12110)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0741152,0.0966747,-0.000143229,1.10963e-07,-3.43118e-11,-114808,27.8662], Tmin=(100,'K'), Tmax=(791.719,'K')), NASAPolynomial(coeffs=[13.3214,0.0289929,-1.49913e-05,2.9752e-09,-2.11047e-13,-116929,-33.6305], Tmin=(791.719,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-955.734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(Cs-CsOsHH)"""),
)

species(
    label = 'OC(CF)(OF)C(F)F(12111)',
...
"""),
    E0 = (-556.231,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,487,638,688,1119,1325,1387,3149,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.557249,'amu*angstrom^2'), symmetry=1, barrier=(12.8123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50677,'amu*angstrom^2'), symmetry=1, barrier=(34.6435,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.557302,'amu*angstrom^2'), symmetry=1, barrier=(12.8135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.557313,'amu*angstrom^2'), symmetry=1, barrier=(12.8137,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-855.295,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,333,384,448,608,1254,1480,391,562,707,872,1109,1210,1289,3137,528,1116,1182,1331,1402,1494,3075,3110,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.889055,'amu*angstrom^2'), symmetry=1, barrier=(20.4411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.889031,'amu*angstrom^2'), symmetry=1, barrier=(20.4406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.88759,'amu*angstrom^2'), symmetry=1, barrier=(20.4074,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.803704,0.072493,-8.32871e-05,4.89212e-08,-1.14988e-11,-102755,25.0498], Tmin=(100,'K'), Tmax=(1030.1,'K')), NASAPolynomial(coeffs=[13.5746,0.0229023,-1.10751e-05,2.18679e-09,-1.56612e-13,-105386,-36.9411], Tmin=(1030.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-855.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-CsF1sH))"""),
)
...
"""),
    E0 = (-713.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,286,334,437,422,648,895,1187,261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,216.007,216.007,216.007],'cm^-1')),
        HinderedRotor(inertia=(0.629684,'amu*angstrom^2'), symmetry=1, barrier=(20.8489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435899,'amu*angstrom^2'), symmetry=1, barrier=(14.4327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09619,'amu*angstrom^2'), symmetry=1, barrier=(36.2949,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.407398,0.0849463,-0.000111667,7.55417e-08,-2.0509e-11,-85679.1,26.8936], Tmin=(100,'K'), Tmax=(895.066,'K')), NASAPolynomial(coeffs=[13.44,0.0267059,-1.40673e-05,2.8492e-09,-2.05898e-13,-88012.2,-34.537], Tmin=(895.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-713.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-F1sCsCs))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.07081,'amu*angstrom^2'), symmetry=1, barrier=(24.6201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07163,'amu*angstrom^2'), symmetry=1, barrier=(24.6389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06898,'amu*angstrom^2'), symmetry=1, barrier=(24.5779,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.913618,0.0688895,-9.17173e-05,5.75962e-08,-1.39565e-11,-63042.1,20.7944], Tmin=(100,'K'), Tmax=(1016.99,'K')), NASAPolynomial(coeffs=[15.7496,0.0105364,-5.64931e-06,1.1756e-09,-8.68588e-14,-66059.7,-51.0305], Tmin=(1016.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-525.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(F1s)(O2s-H))"""),
)

species(
    label = 'OC(F)(CF)[C](F)OF(10584)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-747.772,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,316,385,515,654,689,1295,261,493,600,1152,1365,1422,3097,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19022,'amu*angstrom^2'), symmetry=1, barrier=(27.3654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.574907,'amu*angstrom^2'), symmetry=1, barrier=(13.2182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.575172,'amu*angstrom^2'), symmetry=1, barrier=(13.2243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.448992,0.107082,-0.000182559,1.58114e-07,-5.35748e-11,-89784.9,28.5079], Tmin=(100,'K'), Tmax=(800.858,'K')), NASAPolynomial(coeffs=[13.344,0.0280052,-1.53719e-05,3.06017e-09,-2.14886e-13,-91667.5,-32.9329], Tmin=(800.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-747.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sO2sCs)(F1s)(H))"""),
)

species(
    label = 'O=C(CF)C(F)OF(12119)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
4  O u0 p2 c0 {3,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.28631,'amu*angstrom^2'), symmetry=1, barrier=(29.5747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28345,'amu*angstrom^2'), symmetry=1, barrier=(29.5089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2879,'amu*angstrom^2'), symmetry=1, barrier=(29.6113,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
...
"""),
    E0 = (-573.593,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,326,540,652,719,1357,180,591.78],'cm^-1')),
        HinderedRotor(inertia=(0.213764,'amu*angstrom^2'), symmetry=1, barrier=(4.91487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346053,'amu*angstrom^2'), symmetry=1, barrier=(7.95643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81573,'amu*angstrom^2'), symmetry=1, barrier=(41.7472,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction2',
    reactants = ['OCF(190)', 'F[C]C(F)OF(1513)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)OF(3638)', 'F[C]CF(125)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(140)', 'OC(F)([C]F)CF(10577)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(49.8547,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'OC(F)([C]F)C(F)OF(12108)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'OC(F)(F)C(F)OF(3597)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(160.884,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction12',
    reactants = ['H2O(3)', 'FCC(F)=C(F)OF(3425)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OF(140)', 'FCC(F)=COF(3992)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H2O(3)', 'FC=C(F)C(F)OF(12112)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OF(140)', 'C=C(F)C(F)OF(3108)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FOF(1520)', 'OC(=CF)CF(12113)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'O[C](CF)C(F)OF(12114)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'OC(F)([CH]OF)CF(11334)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', '[CH2]C(O)(F)C(F)OF(12115)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', '[O]C(F)C(O)(F)CF(12116)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OH(7)', 'FC[C](F)C(F)OF(3990)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[O]C(F)(CF)C(F)OF(12117)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]F(127)', 'OC(F)([CH]F)CF(11062)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[CH]OF(1060)', 'O[C](F)CF(9946)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2F(46)', 'O[C](F)C(F)OF(3657)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(5)', 'OC(F)(CF)[C](F)OF(10584)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(5)', 'OC(F)([CH]F)C(F)OF(12118)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'O=C(CF)C(F)OF(12119)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction29',
    reactants = ['F2(78)', 'O=CC(O)(F)CF(10317)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(76.0977,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction30',
    reactants = ['F2(78)', 'OC(=COF)CF(4209)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction31',
    reactants = ['F2(78)', 'C=C(O)C(F)OF(4126)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction32',
    reactants = ['HF(38)', 'O=C(F)C(O)(F)CF(10203)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
    transitionState = 'TS32',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(484.529,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction33',
    reactants = ['HF(38)', 'OC(CF)=C(F)OF(3724)'],
    products = ['OC(F)(CF)C(F)OF(11721)'],
...
reaction(
    label = 'reaction35',
    reactants = ['OC(F)(CF)C(F)OF(11721)'],
    products = ['F2(78)', 'CHFO(47)', 'C=C(O)F(213)'],
    transitionState = 'TS35',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(257.246,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction36',
    reactants = ['OC(F)(CF)C(F)OF(11721)'],
    products = ['HF(38)', 'CHFO(47)', 'OC(F)=CF(3655)'],
    transitionState = 'TS36',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(47.607,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #3924',
    isomers = [
        'OC(F)(CF)C(F)OF(11721)',
    ],
    reactants = [
