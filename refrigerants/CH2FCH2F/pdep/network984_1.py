...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)O[C](F)F(2149)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[CH2]C([O])F(139)'],
    products = ['[CH2]C(F)O[C](F)F(2149)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]O[C](F)F(1161)'],
    products = ['[CH2]C(F)O[C](F)F(2149)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=CO[C](F)F(2195)'],
    products = ['[CH2]C(F)O[C](F)F(2149)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(F)O[C](F)F(1794)'],
    products = ['[CH2]C(F)O[C](F)F(2149)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]C([O])F(139)'],
    products = ['[CH2]C(F)O[C](F)F(2149)'],
