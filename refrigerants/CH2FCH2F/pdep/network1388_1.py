...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC[C](F)F(699)'],
    products = ['[O]OOC[C](F)F(3086)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH2]OO[O](181)'],
    products = ['[O]OOC[C](F)F(3086)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]OOC=C(F)F(1652)'],
    products = ['[O]OOC[C](F)F(3086)'],
    transitionState = 'TS8',
