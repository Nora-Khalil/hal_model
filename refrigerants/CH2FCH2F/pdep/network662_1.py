...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH]C=C(254)'],
    products = ['[CH]=CC[C]=O(1589)'],
    transitionState = 'TS3',
