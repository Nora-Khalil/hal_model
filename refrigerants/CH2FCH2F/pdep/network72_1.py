...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', '[CH2]C[C]=O(334)'],
    products = ['O=[C]CC[CH]F(206)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(129)', '[CH2]C[CH]F(222)'],
    products = ['O=[C]CC[CH]F(206)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C[CH]F(222)'],
    products = ['O=[C]CC[CH]F(206)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C[C]=O(334)'],
    products = ['O=[C]CC[CH]F(206)'],
