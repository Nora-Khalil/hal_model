...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.28626,'amu*angstrom^2'), symmetry=1, barrier=(29.5736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28613,'amu*angstrom^2'), symmetry=1, barrier=(29.5708,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.012,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34385,0.0631496,-9.24264e-05,6.72397e-08,-1.93472e-11,-80842.7,19.5554], Tmin=(100,'K'), Tmax=(850.863,'K')), NASAPolynomial(coeffs=[11.414,0.0158089,-8.96894e-06,1.8495e-09,-1.34339e-13,-82556.4,-27.401], Tmin=(850.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-672.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(CsFFOO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.908422,'amu*angstrom^2'), symmetry=1, barrier=(20.8864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.860528,'amu*angstrom^2'), symmetry=1, barrier=(19.7852,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (117.004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39771,0.0622561,-0.000107669,9.19257e-08,-3.05001e-11,-62563.4,20.1065], Tmin=(100,'K'), Tmax=(807.696,'K')), NASAPolynomial(coeffs=[10.2364,0.013411,-7.53614e-06,1.50152e-09,-1.05133e-13,-63825.7,-19.6232], Tmin=(807.696,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-520.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(CsFFOO) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[O]C(F)(F)OO(2303)'],
    products = ['OOC(F)(F)OF(12943)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OH(7)', '[O]C(F)(F)OF(3472)'],
    products = ['OOC(F)(F)OF(12943)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['HO2(11)', 'FO[C](F)F(2145)'],
    products = ['OOC(F)(F)OF(12943)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', '[O]OC(F)(F)OF(12950)'],
    products = ['OOC(F)(F)OF(12943)'],
    transitionState = 'TS5',
