...
"""),
    E0 = (-493.623,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,2175,525,750,770,3400,2100,180],'cm^-1')),
        HinderedRotor(inertia=(1.37026,'amu*angstrom^2'), symmetry=1, barrier=(31.5051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36772,'amu*angstrom^2'), symmetry=1, barrier=(31.4466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36898,'amu*angstrom^2'), symmetry=1, barrier=(31.4754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3659,'amu*angstrom^2'), symmetry=1, barrier=(31.4048,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.264219,0.0893355,-0.000127113,9.54242e-08,-2.88816e-11,-59241.1,25.9116], Tmin=(100,'K'), Tmax=(804.928,'K')), NASAPolynomial(coeffs=[12.2903,0.0295699,-1.57326e-05,3.17096e-09,-2.27504e-13,-61177,-29.4971], Tmin=(804.928,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-493.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (-490.839,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,431,527,613,668,835,1199,1245,1322,2175,525,750,770,3400,2100],'cm^-1')),
        HinderedRotor(inertia=(1.52526,'amu*angstrom^2'), symmetry=1, barrier=(35.0686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52719,'amu*angstrom^2'), symmetry=1, barrier=(35.1132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5265,'amu*angstrom^2'), symmetry=1, barrier=(35.0973,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24376,0.0654178,-8.88002e-05,6.15263e-08,-1.70629e-11,-58939.1,22.2257], Tmin=(100,'K'), Tmax=(877.746,'K')), NASAPolynomial(coeffs=[11.2785,0.0196883,-1.06519e-05,2.1709e-09,-1.57179e-13,-60700.7,-24.8774], Tmin=(877.746,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-490.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsFFFO) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (-477.616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,223,363,546,575,694,1179,1410,528,1116,1182,1331,1402,1494,3075,3110,2175,525,750,770,3400,2100,180],'cm^-1')),
        HinderedRotor(inertia=(1.532,'amu*angstrom^2'), symmetry=1, barrier=(35.2237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52978,'amu*angstrom^2'), symmetry=1, barrier=(35.1726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53052,'amu*angstrom^2'), symmetry=1, barrier=(35.1897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53048,'amu*angstrom^2'), symmetry=1, barrier=(35.1887,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.299014,0.0874271,-0.000113428,7.50728e-08,-1.99279e-11,-57315.7,26.0444], Tmin=(100,'K'), Tmax=(914.604,'K')), NASAPolynomial(coeffs=[14.0941,0.0270955,-1.44817e-05,2.95049e-09,-2.14005e-13,-59839.1,-39.2775], Tmin=(914.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (-156.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,2175,525,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.466437,'amu*angstrom^2'), symmetry=1, barrier=(10.7243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12142,'amu*angstrom^2'), symmetry=1, barrier=(48.7755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12092,'amu*angstrom^2'), symmetry=1, barrier=(48.7642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12122,'amu*angstrom^2'), symmetry=1, barrier=(48.771,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0143047,0.0963923,-0.000163441,1.42383e-07,-4.83068e-11,-18685,27.5314], Tmin=(100,'K'), Tmax=(824.685,'K')), NASAPolynomial(coeffs=[11.5269,0.0275284,-1.44965e-05,2.82855e-09,-1.96067e-13,-20141,-23.1058], Tmin=(824.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)

species(
    label = '[C]=COOCC(F)(F)F(3045)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
4  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-339.183,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,193,295,551,588,656,1146,1192,1350,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.337245,'amu*angstrom^2'), symmetry=1, barrier=(7.75394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.488385,'amu*angstrom^2'), symmetry=1, barrier=(11.2289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.338398,'amu*angstrom^2'), symmetry=1, barrier=(7.78044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.09135,'amu*angstrom^2'), symmetry=1, barrier=(48.0842,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0959082,0.103719,-0.000190381,1.79338e-07,-6.44907e-11,-40660,28.1225], Tmin=(100,'K'), Tmax=(836.72,'K')), NASAPolynomial(coeffs=[8.24547,0.0361927,-1.97566e-05,3.89631e-09,-2.70829e-13,-41088,-4.84903], Tmin=(836.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-339.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COOCC(F)(F)F(2740)'],
    products = ['CF3CHO(75)', 'CH2CO(28)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(22.7771,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COOC(F)(F)F(3041)'],
    products = ['C#COOCC(F)(F)F(2740)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C#COOC[C](F)F(1725)'],
    products = ['C#COOCC(F)(F)F(2740)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H(22)', '[O]OCC(F)(F)F(3043)'],
    products = ['C#COOCC(F)(F)F(2740)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF3(45)', 'C#COO[CH2](1312)'],
    products = ['C#COOCC(F)(F)F(2740)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[C]#COOCC(F)(F)F(3044)'],
    products = ['C#COOCC(F)(F)F(2740)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'C#COOC=C(F)F(1766)'],
    products = ['C#COOCC(F)(F)F(2740)'],
