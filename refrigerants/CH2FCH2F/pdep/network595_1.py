...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', '[CH]C=CF(263)'],
    products = ['[CH]=CC(F)[CH]F(1492)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[CH](257)', 'CHFCHF[Z](59)'],
    products = ['[CH]=CC(F)[CH]F(1492)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H2(23)', 'F[CH][CH]F(493)'],
    products = ['[CH]=CC(F)[CH]F(1492)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#CC(F)[CH]F(1497)'],
    products = ['[CH]=CC(F)[CH]F(1492)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](257)', 'F[CH][CH]F(493)'],
    products = ['[CH]=CC(F)[CH]F(1492)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH]=C=C[CH]F(1498)'],
    products = ['[CH]=CC(F)[CH]F(1492)'],
