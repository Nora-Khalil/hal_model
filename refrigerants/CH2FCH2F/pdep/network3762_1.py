...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.15368,'amu*angstrom^2'), symmetry=1, barrier=(26.5253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15334,'amu*angstrom^2'), symmetry=1, barrier=(26.5176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15407,'amu*angstrom^2'), symmetry=1, barrier=(26.5343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15384,'amu*angstrom^2'), symmetry=1, barrier=(26.529,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-703.615,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,235,523,627,1123,1142,1372,1406,3097,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0227274,0.077632,-7.13516e-05,2.36245e-08,-1.21846e-13,-84470.8,27.4005], Tmin=(100,'K'), Tmax=(988.457,'K')), NASAPolynomial(coeffs=[21.9039,0.0110182,-3.82668e-06,7.18536e-10,-5.36643e-14,-89886,-83.5934], Tmin=(988.457,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-703.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsOsHH)"""),
)
...
"""),
    E0 = (-156.652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([504,610,1067,1155,2750,2850,1437.5,1250,1305,750,350,204.471,210.029],'cm^-1')),
        HinderedRotor(inertia=(0.0753038,'amu*angstrom^2'), symmetry=1, barrier=(18.458,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1696,'amu*angstrom^2'), symmetry=1, barrier=(37.6715,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.312193,0.0813064,-9.37144e-05,5.01336e-08,-1.00498e-11,-36078.8,27.1558], Tmin=(100,'K'), Tmax=(1336.79,'K')), NASAPolynomial(coeffs=[23.2314,0.00445082,-2.85923e-07,-4.53284e-11,4.93058e-15,-41800.9,-91.1212], Tmin=(1336.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-301.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H))"""),
)

species(
    label = '[CH2]C(F)OCOF(11320)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-600.256,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,2750,2850,1437.5,1250,1305,750,350,285.053,638.238,638.241,638.255,638.296],'cm^-1')),
        HinderedRotor(inertia=(1.20375,'amu*angstrom^2'), symmetry=1, barrier=(27.6766,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20376,'amu*angstrom^2'), symmetry=1, barrier=(27.6767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20377,'amu*angstrom^2'), symmetry=1, barrier=(27.677,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.967756,0.0573082,-4.56674e-05,1.73324e-08,-2.58387e-12,-72077.1,23.9266], Tmin=(100,'K'), Tmax=(1602.24,'K')), NASAPolynomial(coeffs=[17.3672,0.0163668,-7.33839e-06,1.3843e-09,-9.5451e-14,-77332.3,-62.9218], Tmin=(1602.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-600.256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsOsHH) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-457.716,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,210.273,210.487,1335.65],'cm^-1')),
        HinderedRotor(inertia=(0.204765,'amu*angstrom^2'), symmetry=1, barrier=(6.44345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204966,'amu*angstrom^2'), symmetry=1, barrier=(6.45961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.978919,'amu*angstrom^2'), symmetry=1, barrier=(30.7338,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.156792,0.0824907,-9.03114e-05,4.19262e-08,-5.91916e-12,-59769.7,27.6099], Tmin=(100,'K'), Tmax=(978.873,'K')), NASAPolynomial(coeffs=[22.5758,0.00729707,-2.20818e-06,3.94405e-10,-2.96225e-14,-65068.1,-85.9073], Tmin=(978.873,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs))"""),
)

species(
    label = 'F[CH]C(F)OCOF(11323)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.616158,0.0847081,-9.47066e-05,4.84566e-08,-9.26562e-12,-59294.7,29.6444], Tmin=(100,'K'), Tmax=(1409.51,'K')), NASAPolynomial(coeffs=[25.43,0.00331799,-1.3659e-07,-3.52577e-11,2.53183e-15,-65894.6,-102.319], Tmin=(1409.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-494.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.06636,'amu*angstrom^2'), symmetry=1, barrier=(24.5177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06669,'amu*angstrom^2'), symmetry=1, barrier=(24.5254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06755,'amu*angstrom^2'), symmetry=1, barrier=(24.5452,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.625532,0.0557284,-1.33134e-05,-4.39515e-08,2.66045e-11,-46841.4,22.4568], Tmin=(100,'K'), Tmax=(927.995,'K')), NASAPolynomial(coeffs=[25.1449,-0.00230722,3.47091e-06,-6.75803e-10,3.93984e-14,-53443.9,-105.058], Tmin=(927.995,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-390.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-OsOsHH) + group(CdCFO) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.16957,'amu*angstrom^2'), symmetry=1, barrier=(26.8908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16917,'amu*angstrom^2'), symmetry=1, barrier=(26.8814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17061,'amu*angstrom^2'), symmetry=1, barrier=(26.9147,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.569372,0.0537633,1.43921e-07,-6.37087e-08,3.51514e-11,-44405.8,22.7102], Tmin=(100,'K'), Tmax=(921.23,'K')), NASAPolynomial(coeffs=[27.4515,-0.00635216,5.85605e-06,-1.14069e-09,7.06681e-14,-51760.7,-117.812], Tmin=(921.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-370.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'O=COC(F)CF(156)',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'F[C]C(F)OCOF(11318)'],
    products = ['FCC(F)OCOF(6992)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OCOF(4203)', 'CHFCHF[Z](59)'],
    products = ['FCC(F)OCOF(6992)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FOCOF(4204)', 'CH2CHF(56)'],
    products = ['FCC(F)OCOF(6992)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FC[CH]OCOF(11319)'],
    products = ['FCC(F)OCOF(6992)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)OCOF(11320)'],
    products = ['FCC(F)OCOF(6992)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]COC(F)CF(11321)'],
    products = ['FCC(F)OCOF(6992)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]COF(4207)', 'CH2F-CHF(66)'],
    products = ['FCC(F)OCOF(6992)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]OF(179)', '[O]C(F)CF(490)'],
    products = ['FCC(F)OCOF(6992)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', '[CH2]OC(F)CF(3163)'],
    products = ['FCC(F)OCOF(6992)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2F(46)', 'F[CH]OCOF(4208)'],
    products = ['FCC(F)OCOF(6992)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FC[C](F)OCOF(11322)'],
    products = ['FCC(F)OCOF(6992)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'F[CH]C(F)OCOF(11323)'],
    products = ['FCC(F)OCOF(6992)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FCC(F)O[CH]OF(11324)'],
    products = ['FCC(F)OCOF(6992)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C=C(F)OCOF(11325)'],
    products = ['FCC(F)OCOF(6992)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=COC(F)CF(156)'],
    products = ['FCC(F)OCOF(6992)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FCC(F)OCOF(6992)'],
    products = ['F2(78)', 'CH2O(20)', 'O=CCF(212)'],
