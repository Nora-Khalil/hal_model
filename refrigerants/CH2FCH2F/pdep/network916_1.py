...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', 'F[C]C=CF(1952)'],
    products = ['F[C]=CC(F)[CH]F(1938)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]=CC(F)=CF(1974)'],
    products = ['F[C]=CC(F)[CH]F(1938)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC#CC(F)[CH]F(1975)'],
    products = ['F[C]=CC(F)[CH]F(1938)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'F[C]=C=C[CH]F(1976)'],
    products = ['F[C]=CC(F)[CH]F(1938)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', 'F[C]C=CF(1952)'],
    products = ['F[C]=CC(F)[CH]F(1938)'],
