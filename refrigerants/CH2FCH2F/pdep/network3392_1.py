...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0687887,0.0844073,-0.00010242,5.89057e-08,-1.29733e-11,-71582.3,23.8264], Tmin=(100,'K'), Tmax=(1123.84,'K')), NASAPolynomial(coeffs=[20.5301,0.0110923,-4.56671e-06,8.59732e-10,-6.10224e-14,-76212.3,-77.9563], Tmin=(1123.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-596.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.945277,'amu*angstrom^2'), symmetry=1, barrier=(21.7338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.945965,'amu*angstrom^2'), symmetry=1, barrier=(21.7496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.945736,'amu*angstrom^2'), symmetry=1, barrier=(21.7443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.945798,'amu*angstrom^2'), symmetry=1, barrier=(21.7457,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.100483,0.0953646,-0.000141951,1.04776e-07,-3.02235e-11,-48913.2,24.1855], Tmin=(100,'K'), Tmax=(853.892,'K')), NASAPolynomial(coeffs=[15.8918,0.0204506,-1.03545e-05,2.03475e-09,-1.43558e-13,-51644.3,-50.4425], Tmin=(853.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-407.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H2(8)', 'C#COC(O)(F)[C]F(10968)'],
    products = ['C#COC(O)(F)CF(9988)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'C#COC(O)(F)F(2144)'],
    products = ['C#COC(O)(F)CF(9988)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'C#COC(F)=CF(10971)'],
    products = ['C#COC(O)(F)CF(9988)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(140)', 'C#COC(=C)F(1389)'],
    products = ['C#COC(O)(F)CF(9988)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CO[C](O)CF(1392)'],
    products = ['C#COC(O)(F)CF(9988)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C#COC([CH2])(O)F(668)'],
    products = ['C#COC(O)(F)CF(9988)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HCCO(21)', 'O[C](F)CF(9946)'],
    products = ['C#COC(O)(F)CF(9988)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C2H(22)', '[O]C(O)(F)CF(9948)'],
    products = ['C#COC(O)(F)CF(9988)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'C#CO[C](F)CF(3846)'],
    products = ['C#COC(O)(F)CF(9988)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2F(46)', 'C#CO[C](O)F(1385)'],
    products = ['C#COC(O)(F)CF(9988)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C#COC(O)(F)[CH]F(10972)'],
    products = ['C#COC(O)(F)CF(9988)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[C]#COC(O)(F)CF(10973)'],
    products = ['C#COC(O)(F)CF(9988)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C#COC(O)(F)CF(9988)'],
    products = ['CH2CO(28)', 'OC(F)=CF(3655)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C#COC(=O)CF(10975)'],
    products = ['C#COC(O)(F)CF(9988)'],
