...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)[O+]=[C-]O(12223)'],
    products = ['CO(13)', 'O=C(O)F(175)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O[C-]=[O+]F(12452)'],
    products = ['O=C(F)[O+]=[C-]O(12223)'],
    transitionState = 'TS2',
