...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31566,0.0576465,-5.63059e-05,2.82684e-08,-5.70356e-12,-10789.4,20.2929], Tmin=(100,'K'), Tmax=(1189.83,'K')), NASAPolynomial(coeffs=[12.509,0.0200164,-8.86611e-06,1.68762e-09,-1.18552e-13,-13453,-35.6538], Tmin=(1189.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.5213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(CsCsCsFH) + group(CsCsCsFH) + group(Cs-CsHHH) + ring(Cs(C)-Cs-Cs(F)) + radical(CC(C)2OJ) + radical(CJC(C)2O) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]C(=O)[CH]F(400)'],
    products = ['C=C([O])C(F)[CH]F(1224)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C(F)[CH]F(1250)'],
    products = ['C=C([O])C(F)[CH]F(1224)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['C=C([O])C(F)[CH]F(1224)'],
    products = ['[CH2]C1([O])C(F)C1F(1254)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.17979e+10,'s^-1'), n=0.520585, Ea=(163.322,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 162.2 to 163.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C=CF(391)'],
    products = ['C=C([O])C(F)[CH]F(1224)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C([O])C(F)=CF(1255)'],
    products = ['C=C([O])C(F)[CH]F(1224)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C(=O)[CH]F(400)'],
    products = ['C=C([O])C(F)[CH]F(1224)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=C([O])C(F)[CH]F(1224)'],
    products = ['[CH2]C(O)=C(F)[CH]F(1256)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(O)C(F)[CH]F(1257)'],
    products = ['C=C([O])C(F)[CH]F(1224)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(=C[CH]F)OF(1259)'],
    products = ['C=C([O])C(F)[CH]F(1224)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(18)', 'O=[C]C(F)[CH]F(1260)'],
    products = ['C=C([O])C(F)[CH]F(1224)'],
