...
species(
    label = '[CH2]C(F)(F)OC([CH2])(F)F(10161)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(467)', '[CH2]C([O])(F)F(475)'],
    products = ['[CH2]C(F)(F)O[C](F)CF(10018)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'FC[C](F)O[C](F)F(2217)'],
    products = ['[CH2]C(F)(F)O[C](F)CF(10018)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)O[C](F)CF(10018)'],
    products = ['FCC1(F)CC(F)(F)O1(10022)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[C](F)CF(10005)'],
    products = ['[CH2]C(F)(F)O[C](F)CF(10018)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)OC(=C)F(735)'],
    products = ['[CH2]C(F)(F)O[C](F)CF(10018)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]CF(125)', '[CH2]C([O])(F)F(475)'],
    products = ['[CH2]C(F)(F)O[C](F)CF(10018)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)O[C](F)CF(10018)'],
    products = ['CC(F)(F)O[C](F)[CH]F(10159)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)O[C](F)CF(10018)'],
    products = ['[CH2][C](F)OC(F)(F)CF(10160)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FC[C](F)O[C](F)CF(10131)'],
    products = ['[CH2]C(F)(F)O[C](F)CF(10018)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)O[C](F)CF(10018)'],
    products = ['[CH2]C(F)(F)OC([CH2])(F)F(10161)'],
