...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C([O])F(1122)'],
    products = ['[O]C(F)O[C]=O(2556)'],
    transitionState = 'TS2',
