...
species(
    label = 'FC(F)=CC(F)C(F)=C(F)F(8393)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.32152,0.104615,-0.000171906,1.50888e-07,-5.23841e-11,-127129,31.1048], Tmin=(100,'K'), Tmax=(796.959,'K')), NASAPolynomial(coeffs=[11.1143,0.035181,-1.85665e-05,3.66628e-09,-2.57208e-13,-128570,-19.073], Tmin=(796.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1058.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-CdsCsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + group(CdCFF)"""),
)

species(
    label = 'FC(F)=C=C(F)C(F)C(F)F(8394)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)C=C=C(F)F(8396)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.510604,'amu*angstrom^2'), symmetry=1, barrier=(11.7398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0095432,'amu*angstrom^2'), symmetry=1, barrier=(26.7665,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.341504,0.0880119,-0.00013482,1.13926e-07,-3.91898e-11,-75874.3,30.4112], Tmin=(100,'K'), Tmax=(717.584,'K')), NASAPolynomial(coeffs=[10.1705,0.032531,-1.74009e-05,3.49584e-09,-2.49326e-13,-77267.2,-13.6223], Tmin=(717.584,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-631.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sCdH)(F1s)(F1s))"""),
)
...
species(
    label = 'F[C](F)C(F)C(F)=C=C(F)F(8397)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-812.525,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,145,326,398,834,1303,190,488,555,1236,1407,94,120,354,641,825,1294,540,610,2055,980.036],'cm^-1')),
        HinderedRotor(inertia=(0.166786,'amu*angstrom^2'), symmetry=1, barrier=(3.83473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167605,'amu*angstrom^2'), symmetry=1, barrier=(3.85356,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (175.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.17903,0.101089,-0.000168063,1.47503e-07,-5.12212e-11,-97582.6,32.9725], Tmin=(100,'K'), Tmax=(787.256,'K')), NASAPolynomial(coeffs=[11.3483,0.0322898,-1.74852e-05,3.4856e-09,-2.45809e-13,-99080.6,-17.8697], Tmin=(787.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-812.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CdCddCF) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sCdH)(F1s)(F1s))"""),
)

species(
    label = 'FC#CC(F)C(F)[C](F)F(8398)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-560.934,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,233,378,609,1068,1270,1314,3037,190,488,555,1236,1407,2175,525,239,401,1367,180,180,1372.33],'cm^-1')),
        HinderedRotor(inertia=(0.2937,'amu*angstrom^2'), symmetry=1, barrier=(6.75273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.293413,'amu*angstrom^2'), symmetry=1, barrier=(6.74615,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.09524,'amu*angstrom^2'), symmetry=1, barrier=(52.2779,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0736918,0.100923,-0.000176988,1.60723e-07,-5.62175e-11,-67329,30.3281], Tmin=(100,'K'), Tmax=(838.759,'K')), NASAPolynomial(coeffs=[9.64391,0.0331309,-1.73924e-05,3.38441e-09,-2.33768e-13,-68204.7,-10.3474], Tmin=(838.759,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-560.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Ct-CtCs) + group(CtCF) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
species(
    label = 'F[C](F)C=C(F)[C]=C(F)F(8400)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-538.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,86,203,488,582,605,741,161,297,490,584,780,1358,562,600,623,1070,1265,1685,370,509.039],'cm^-1')),
        HinderedRotor(inertia=(0.0113489,'amu*angstrom^2'), symmetry=1, barrier=(2.08731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.278815,'amu*angstrom^2'), symmetry=1, barrier=(51.3456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (156.053,'amu'),
...
species(
    label = 'F[C](F)C(F)[C](F)C=C(F)F(8402)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.506366,0.113324,-0.000204879,1.91532e-07,-6.87201e-11,-99613.3,35.8116], Tmin=(100,'K'), Tmax=(831.213,'K')), NASAPolynomial(coeffs=[9.05912,0.0395048,-2.15193e-05,4.25155e-09,-2.96238e-13,-100244,-2.79357], Tmin=(831.213,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-829.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(CdCFF) + radical(CsCsCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'FC(F)=[C]C(F)[CH]C(F)(F)F(8405)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0916516,0.096084,-0.000157188,1.44992e-07,-5.38188e-11,-100048,35.244], Tmin=(100,'K'), Tmax=(762.022,'K')), NASAPolynomial(coeffs=[8.12043,0.0408054,-2.25212e-05,4.55867e-09,-3.25457e-13,-100890,1.19393], Tmin=(762.022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-832.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCsFFF) + group(Cds-CdsCsH) + group(CdCFF) + radical(Cs_S) + radical(Cdj(Cs-F1sCsH)(Cd-F1sF1s))"""),
)

species(
    label = 'FC(F)=[C][CH]C(F)C(F)(F)F(8406)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.277768,0.0877926,-0.000108989,7.07452e-08,-1.85933e-11,-105684,30.9117], Tmin=(100,'K'), Tmax=(919.99,'K')), NASAPolynomial(coeffs=[13.4341,0.0305906,-1.57241e-05,3.16092e-09,-2.27794e-13,-108104,-31.4626], Tmin=(919.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-879.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Cds-CdsCsH) + group(CdCFF) + radical(Allyl_S) + radical(Cdj(Cs-CsHH)(Cd-F1sF1s))"""),
)

species(
    label = 'F[C](F)C(F)[CH]C(F)=C(F)F(8407)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.527798,0.109341,-0.000181481,1.58288e-07,-5.44032e-11,-103580,32.4376], Tmin=(100,'K'), Tmax=(800.024,'K')), NASAPolynomial(coeffs=[12.1392,0.0341125,-1.81298e-05,3.58076e-09,-2.50948e-13,-105227,-23.4678], Tmin=(800.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-862.494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CdCsCdF) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + radical(Allyl_S) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C]=[C]C(F)C(F)C(F)(F)F(8408)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-755.749,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,164,312,561,654,898,1207,1299,3167,193,295,551,588,656,1146,1192,1350,1685,370,167,640,1190,180,2386.8],'cm^-1')),
        HinderedRotor(inertia=(0.348116,'amu*angstrom^2'), symmetry=1, barrier=(8.00387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.349524,'amu*angstrom^2'), symmetry=1, barrier=(8.03625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42765,'amu*angstrom^2'), symmetry=1, barrier=(32.8245,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.499628,0.108796,-0.000181203,1.58757e-07,-5.49151e-11,-90743,33.4355], Tmin=(100,'K'), Tmax=(792.15,'K')), NASAPolynomial(coeffs=[12.0297,0.0341764,-1.84097e-05,3.66014e-09,-2.5761e-13,-92371.9,-21.8435], Tmin=(792.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-755.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sCsH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[C]=C(F)C(F)C(F)[C](F)F(8409)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-731.547,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,259,529,569,1128,1321,1390,3140,246,474,533,1155,190,488,555,1236,1407,167,640,1190,180,180,180,755.627],'cm^-1')),
        HinderedRotor(inertia=(0.203697,'amu*angstrom^2'), symmetry=1, barrier=(4.6834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203792,'amu*angstrom^2'), symmetry=1, barrier=(4.68559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206578,'amu*angstrom^2'), symmetry=1, barrier=(4.74963,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.72794,0.116562,-0.000205715,1.85882e-07,-6.48374e-11,-87826.6,34.7956], Tmin=(100,'K'), Tmax=(830.115,'K')), NASAPolynomial(coeffs=[11.4512,0.0356085,-1.91984e-05,3.77653e-09,-2.62523e-13,-89081.4,-17.0729], Tmin=(830.115,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-731.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s)) + radical(Cdj(Cd-CsF1s)(F1s))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', 'F[CH]C(F)[C]=C(F)F(7658)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(F)F(1544)', 'F[CH]C(F)[C](F)F(919)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_sec_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction7',
    reactants = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
    products = ['FC(F)=CC(F)C(F)=C(F)F(8393)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
    products = ['FC(F)=C=C(F)C(F)C(F)F(8394)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FC(F)=[C]C(F)C=C(F)F(7714)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'FC(F)=[C]C(F)C(F)=C(F)F(8395)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[C](F)C(F)C=C=C(F)F(8396)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'F[C](F)C(F)C(F)=C=C(F)F(8397)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'FC#CC(F)C(F)[C](F)F(8398)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'FC(F)=[C][CH]C=C(F)F(7718)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'FC(F)=[C][CH]C(F)=C(F)F(8399)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'F[C](F)C=C(F)[C]=C(F)F(8400)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CF2(43)', 'F[CH]C(F)[C]=C(F)F(7658)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
    products = ['F[C](F)C(F)[C](F)C=C(F)F(8402)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
    products = ['F[C]([C]=C(F)F)C(F)C(F)F(8403)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
    products = ['F[C](F)[C](F)C(F)C=C(F)F(8404)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
    products = ['FC(F)=[C]C(F)[CH]C(F)(F)F(8405)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
    products = ['FC(F)=[C][CH]C(F)C(F)(F)F(8406)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
    products = ['F[C](F)C(F)[CH]C(F)=C(F)F(8407)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[C]=[C]C(F)C(F)C(F)(F)F(8408)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
...
reaction(
    label = 'reaction29',
    reactants = ['F[C]=C(F)C(F)C(F)[C](F)F(8409)'],
    products = ['F[C](F)C(F)C(F)[C]=C(F)F(7576)'],
