...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.142999,0.0996286,-0.000165606,1.4306e-07,-4.86968e-11,-90804.9,29.19], Tmin=(100,'K'), Tmax=(794.043,'K')), NASAPolynomial(coeffs=[12.1167,0.0290384,-1.55723e-05,3.08617e-09,-2.16701e-13,-92473.4,-25.3754], Tmin=(794.043,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-756.167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsFFOO) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-1039.57,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,375,486,586,623,710,938,1161,1294,184.505,184.506,184.51,184.512],'cm^-1')),
        HinderedRotor(inertia=(0.107871,'amu*angstrom^2'), symmetry=1, barrier=(2.60583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107858,'amu*angstrom^2'), symmetry=1, barrier=(2.60573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00524,'amu*angstrom^2'), symmetry=1, barrier=(24.283,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.679418,0.0784813,-9.93386e-05,6.59753e-08,-1.77301e-11,-124916,26.8036], Tmin=(100,'K'), Tmax=(900.995,'K')), NASAPolynomial(coeffs=[12.2308,0.0271987,-1.39624e-05,2.80373e-09,-2.01823e-13,-126998,-27.7209], Tmin=(900.995,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1039.57,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    E0 = (-892.314,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,493,600,700,1144,1293,180,180,180,1245.39],'cm^-1')),
        HinderedRotor(inertia=(0.251751,'amu*angstrom^2'), symmetry=1, barrier=(5.78825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251866,'amu*angstrom^2'), symmetry=1, barrier=(5.79089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251549,'amu*angstrom^2'), symmetry=1, barrier=(5.78361,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.16806,0.0862785,-0.000293806,6.09119e-07,-4.83658e-10,-107320,13.8355], Tmin=(10,'K'), Tmax=(374.725,'K')), NASAPolynomial(coeffs=[6.25786,0.0361411,-2.44373e-05,7.71813e-09,-9.21982e-13,-107431,3.56903], Tmin=(374.725,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-892.314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""F[C](F)OCC(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-1040.56,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,482,664,788,1296,1923,311.391,311.509,311.604,2456.5],'cm^-1')),
        HinderedRotor(inertia=(0.211768,'amu*angstrom^2'), symmetry=1, barrier=(14.5921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435385,'amu*angstrom^2'), symmetry=1, barrier=(29.982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435897,'amu*angstrom^2'), symmetry=1, barrier=(29.9832,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)(F)OCC(F)F(5532)'],
    products = ['HF(38)', 'CF2O(49)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(34.7477,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(65.0481,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CF2(43)', 'COC(F)(F)OF(4114)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.00405e-10,'m^3/(mol*s)'), n=4.72997, Ea=(125.44,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'F[C]COC(F)(F)OF(5534)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['FOC(F)(F)OCC(F)F(5532)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(142.693,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]COC(F)(F)OF(5536)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FO[C](F)OCC(F)F(5537)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)(F)OCC(F)F(5538)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)(F)OF(3472)', 'CHF2-CH2(64)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(2145)', '[O]CC(F)F(517)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'F[C](F)OCC(F)F(2402)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF2(82)', '[CH2]OC(F)(F)OF(3601)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FOC(F)(F)O[CH]C(F)F(5539)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC(F)(F)OC[C](F)F(5540)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'O=C(F)OCC(F)F(5038)'],
    products = ['FOC(F)(F)OCC(F)F(5532)'],
