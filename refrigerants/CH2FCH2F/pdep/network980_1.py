...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'C#CO[C](O)F(1385)'],
    products = ['C#COC(O)(F)F(2144)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O[C](F)F(1777)', 'HCCO(21)'],
    products = ['C#COC(O)(F)F(2144)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(O)(F)F(2300)', 'C2H(22)'],
    products = ['C#COC(O)(F)F(2144)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OH(7)', 'C#CO[C](F)F(2255)'],
    products = ['C#COC(O)(F)F(2144)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[C]#COC(O)(F)F(3214)'],
    products = ['C#COC(O)(F)F(2144)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'C#COC(=O)F(1366)'],
    products = ['C#COC(O)(F)F(2144)'],
    transitionState = 'TS9',
