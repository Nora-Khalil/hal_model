...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OCO(4531)'],
    products = ['OCOC(F)F(4113)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(1061)', 'CH2OH(33)'],
    products = ['OCOC(F)F(4113)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', '[CH2]OC(F)F(4388)'],
    products = ['OCOC(F)F(4113)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[CH]OC(F)F(4502)'],
    products = ['OCOC(F)F(4113)'],
    transitionState = 'TS9',
