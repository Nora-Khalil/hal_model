...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH]C=C(254)'],
    products = ['[CH]=CC[CH]F(194)'],
    transitionState = 'TS3',
