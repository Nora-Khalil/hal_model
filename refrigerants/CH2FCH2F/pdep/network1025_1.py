...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(O)(F)F(2300)'],
    products = ['[O]OC(O)(F)F(2301)'],
    transitionState = 'TS2',
