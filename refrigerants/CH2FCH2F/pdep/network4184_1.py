species(
    label = 'F[CH]C(F)C(F)(F)[C](F)F(11792)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.214701,'amu*angstrom^2'), symmetry=1, barrier=(4.9364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214268,'amu*angstrom^2'), symmetry=1, barrier=(4.92643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.773513,'amu*angstrom^2'), symmetry=1, barrier=(17.7846,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.53819,0.110567,-0.000195035,1.71903e-07,-5.82158e-11,-111941,31.886], Tmin=(100,'K'), Tmax=(839.93,'K')), NASAPolynomial(coeffs=[12.9991,0.0278364,-1.46766e-05,2.86404e-09,-1.9777e-13,-113571,-27.2276], Tmin=(839.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-932.001,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
species(
    label = 'FC1C(F)C(F)(F)C1(F)F(6360)',
...
species(
    label = 'FC=C(F)C(F)(F)[C](F)F(12676)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][C](F)C(F)(F)C(F)F(6467)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.230661,0.102689,-0.00017526,1.54653e-07,-5.3313e-11,-113363,32.4192], Tmin=(100,'K'), Tmax=(807.934,'K')), NASAPolynomial(coeffs=[11.7874,0.0300648,-1.60624e-05,3.18621e-09,-2.23533e-13,-114877,-20.3473], Tmin=(807.934,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-943.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'F[CH]C(F)[C](F)C(F)(F)F(12678)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.203218,0.102761,-0.000175961,1.5913e-07,-5.68266e-11,-116765,31.3201], Tmin=(100,'K'), Tmax=(778.591,'K')), NASAPolynomial(coeffs=[10.7445,0.0338859,-1.89346e-05,3.83912e-09,-2.73437e-13,-118087,-16.298], Tmin=(778.591,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-972.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sF1s)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'F[C](F)[C](F)C(F)C(F)F(6365)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[CH][CH]C(F)(F)C(F)(F)F(12679)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0754764,0.0978439,-0.00017205,1.59737e-07,-5.74573e-11,-120058,32.0725], Tmin=(100,'K'), Tmax=(818.322,'K')), NASAPolynomial(coeffs=[8.60927,0.0352169,-1.89193e-05,3.75489e-09,-2.63245e-13,-120754,-3.10865], Tmin=(818.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-999.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = 'F[C](F)C(F)(F)[CH]C(F)F(12672)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    products = ['CF2CF2(61)', 'CHFCHF[Z](59)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', 'F[CH]C(F)[C](F)F(919)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'F[CH]C(F)(F)[C](F)F(6191)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    products = ['FC1C(F)C(F)(F)C1(F)F(6360)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    products = ['FC=C(F)C(F)(F)C(F)F(12675)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]C(F)C(F)=C(F)F(6152)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(45.8082,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CF2CF2(61)', 'F[CH][CH]F(493)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.61741e-05,'m^3/(mol*s)'), n=3.0961, Ea=(1.59669,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=CC(F)(F)[C](F)F(8968)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(63.9012,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F[C](F)[C](F)F(3840)', 'CHFCHF[Z](59)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.61741e-05,'m^3/(mol*s)'), n=3.0961, Ea=(6.35824,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC=C(F)C(F)(F)[C](F)F(12676)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)[C](F)F(3840)', 'F[CH][CH]F(493)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.05252e-10,'m^3/(mol*s)'), n=4.71246, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 4.0
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'F[CH]C=C(F)[C](F)F(6154)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(15.5355,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'F[CH]C(F)(F)[C](F)F(6191)'],
    products = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    products = ['FC[C](F)C(F)(F)[C](F)F(12677)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    products = ['F[CH][C](F)C(F)(F)C(F)F(6467)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    products = ['F[CH]C(F)[C](F)C(F)(F)F(12678)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2.01526e+12,'s^-1'), n=0.18834, Ea=(162.435,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    products = ['F[C](F)[C](F)C(F)C(F)F(6365)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(222.391,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    products = ['F[CH][CH]C(F)(F)C(F)(F)F(12679)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(194.554,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)C(F)(F)[C](F)F(11792)'],
    products = ['F[C](F)C(F)(F)[CH]C(F)F(12672)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(162.577,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

network(
    label = 'PDepNetwork #4184',
    isomers = [
        'F[CH]C(F)C(F)(F)[C](F)F(11792)',
    ],
    reactants = [
        ('CF2CF2(61)', 'CHFCHF[Z](59)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
