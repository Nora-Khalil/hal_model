...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8745,0.0411029,-3.33425e-05,9.93269e-09,1.23441e-13,36058,21.3282], Tmin=(100,'K'), Tmax=(1020.57,'K')), NASAPolynomial(coeffs=[12.1998,0.0109397,-4.15642e-06,7.61834e-10,-5.38047e-14,33413.8,-31.3249], Tmin=(1020.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (95.0498,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84042,0.0460675,-4.45541e-05,2.26563e-08,-4.64515e-12,-22282,22.1444], Tmin=(100,'K'), Tmax=(1172.34,'K')), NASAPolynomial(coeffs=[10.4456,0.0167065,-6.98679e-06,1.29306e-09,-8.94374e-14,-24299.7,-20.739], Tmin=(1172.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-185.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]COOO(4026)'],
    products = ['OOOC[CH]F(3956)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]OOO(1843)'],
    products = ['OOOC[CH]F(3956)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OOO[CH][CH]F(1289)'],
    products = ['OOOC[CH]F(3956)'],
