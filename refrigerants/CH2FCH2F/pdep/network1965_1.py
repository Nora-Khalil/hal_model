...
"""),
    E0 = (-286.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,262.126,262.22,262.223,2191.59],'cm^-1')),
        HinderedRotor(inertia=(0.211876,'amu*angstrom^2'), symmetry=1, barrier=(10.3336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211814,'amu*angstrom^2'), symmetry=1, barrier=(10.3332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211775,'amu*angstrom^2'), symmetry=1, barrier=(10.333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.674996,'amu*angstrom^2'), symmetry=1, barrier=(32.9462,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.54003,0.0822577,-0.000122738,1.02112e-07,-3.41041e-11,-34291.6,26.3792], Tmin=(100,'K'), Tmax=(801.656,'K')), NASAPolynomial(coeffs=[9.68804,0.0305534,-1.46564e-05,2.802e-09,-1.93777e-13,-35563.6,-14.518], Tmin=(801.656,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-286.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(CJCO)"""),
)
...
"""),
    E0 = (-138.915,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,360.28,360.313,360.655],'cm^-1')),
        HinderedRotor(inertia=(0.212514,'amu*angstrom^2'), symmetry=1, barrier=(19.6212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212761,'amu*angstrom^2'), symmetry=1, barrier=(19.6235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21287,'amu*angstrom^2'), symmetry=1, barrier=(19.6223,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0882,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06536,0.0554903,-3.79489e-05,3.16615e-09,4.40994e-12,-16593.9,21.3118], Tmin=(100,'K'), Tmax=(987.328,'K')), NASAPolynomial(coeffs=[15.9667,0.0145223,-5.18533e-06,9.47082e-10,-6.79598e-14,-20482.1,-55.1777], Tmin=(987.328,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.915,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CJCO)"""),
)
...
"""),
    E0 = (-276.398,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.247796,0.0912461,-0.000149553,1.31192e-07,-4.49058e-11,-33116.3,26.7993], Tmin=(100,'K'), Tmax=(837.933,'K')), NASAPolynomial(coeffs=[9.57182,0.0315641,-1.5555e-05,2.97261e-09,-2.0401e-13,-34146.2,-13.3566], Tmin=(837.933,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsCsFHH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[CH]C(F)F(4978)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(F)F(506)', '[CH2]C[O](325)'],
    products = ['[CH2]CO[CH]C(F)F(4978)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[CH]C(F)F(928)'],
    products = ['[CH2]CO[CH]C(F)F(4978)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]COC=C(F)F(3568)'],
    products = ['[CH2]CO[CH]C(F)F(4978)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH][CH]OCCF(5201)'],
    products = ['[CH2]CO[CH]C(F)F(4978)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(192.847,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #1965',
    isomers = [
        '[CH2]CO[CH]C(F)F(4978)',
    ],
    reactants = [
