...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C[CH]C([O])(F)F(3463)'],
    products = ['CC([O])C([O])(F)F(3874)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', '[O]C(F)(F)C=O(1680)'],
    products = ['CC([O])C([O])(F)F(3874)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'CC(=O)C([O])(F)F(3679)'],
    products = ['CC([O])C([O])(F)F(3874)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC([O])C(=O)F(3901)'],
    products = ['CC([O])C([O])(F)F(3874)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'CC([O])=C([O])F(1469)'],
    products = ['CC([O])C([O])(F)F(3874)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(O)C([O])(F)F(3903)'],
    products = ['CC([O])C([O])(F)F(3874)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([O])C(O)(F)F(3905)'],
    products = ['CC([O])C([O])(F)F(3874)'],
