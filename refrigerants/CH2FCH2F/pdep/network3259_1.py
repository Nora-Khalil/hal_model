...
"""),
    E0 = (87.7939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,167,640,1190,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9549,0.0457492,-5.533e-05,3.36299e-08,-8.06695e-12,10632.2,22.5461], Tmin=(100,'K'), Tmax=(1017.91,'K')), NASAPolynomial(coeffs=[10.5303,0.0120504,-5.66996e-06,1.10502e-09,-7.8609e-14,8886.46,-18.9773], Tmin=(1017.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.7939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81535,0.0385186,-4.18164e-05,2.08756e-08,-3.86254e-12,66468.7,21.6015], Tmin=(100,'K'), Tmax=(1509.43,'K')), NASAPolynomial(coeffs=[13.7001,0.00158592,2.89316e-07,-1.07868e-10,8.15331e-15,63500.4,-38.5772], Tmin=(1509.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(551.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CdCdJ2_triplet)"""),
)
...
"""),
    E0 = (125.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,239,401,1367,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14259,0.041347,-4.84347e-05,2.74489e-08,-6.11624e-12,15170.3,19.9781], Tmin=(100,'K'), Tmax=(1092.22,'K')), NASAPolynomial(coeffs=[10.7351,0.00987893,-5.21765e-06,1.07005e-09,-7.82888e-14,13293.3,-22.2335], Tmin=(1092.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsOs) + group(O2s-OsH) + group(Ct-CtOs) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[C]=COOO-2(9936)'],
    products = ['OOOC=[C]F(9834)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.11355e+11,'s^-1'), n=0, Ea=(75.8559,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3OO;Y_rad_intra;OOH] for rate rule [R3OO;Cd_sec_rad_in;OOH]
