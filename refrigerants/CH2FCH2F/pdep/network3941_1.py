...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C([O])(O)F(12238)'],
    products = ['[O]C(O)(F)O[C]=O(12225)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C([O])(O)F(12238)'],
    products = ['[O]C(O)(F)O[C]=O(12225)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O]C(=O)O[C]=O(3156)'],
    products = ['[O]C(O)(F)O[C]=O(12225)'],
