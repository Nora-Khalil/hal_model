...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C[C](F)F(518)'],
    products = ['O=[C]OC[C](F)F(593)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH2]O[C]=O(275)'],
    products = ['O=[C]OC[C](F)F(593)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC=C(F)F(1030)'],
    products = ['O=[C]OC[C](F)F(593)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]O[C]=O(275)'],
    products = ['O=[C]OC[C](F)F(593)'],
