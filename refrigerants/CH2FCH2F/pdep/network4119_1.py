...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[O]C(=O)F(161)'],
    products = ['[O]OOC(=O)F(9001)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOC(=O)F(9001)'],
    products = ['F[C]1OOOO1(12559)'],
    transitionState = 'TS4',
