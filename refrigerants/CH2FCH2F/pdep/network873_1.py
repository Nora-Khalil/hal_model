...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]C[CH2](1193)'],
    products = ['[CH2]CC[CH]F(1858)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH2]C[CH2](1193)'],
    products = ['[CH2]CC[CH]F(1858)'],
