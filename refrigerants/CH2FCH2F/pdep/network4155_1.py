...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C(F)(F)[C](F)F(804)'],
    products = ['[O]CC(F)(F)[C](F)F(6865)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]CC(F)=C(F)F(6247)'],
    products = ['[O]CC(F)(F)[C](F)F(6865)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2O(20)', 'F[C](F)[C](F)F(3840)'],
    products = ['[O]CC(F)(F)[C](F)F(6865)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=CC(F)(F)[C](F)F(1812)'],
    products = ['[O]CC(F)(F)[C](F)F(6865)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](133)', 'F[C](F)[C](F)F(3840)'],
    products = ['[O]CC(F)(F)[C](F)F(6865)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[CH]C(F)(F)[C](F)F(12698)'],
    products = ['[O]CC(F)(F)[C](F)F(6865)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]CC(F)(F)[C](F)F(6865)'],
    products = ['[O]C[C](F)C(F)(F)F(12700)'],
