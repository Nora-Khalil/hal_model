...
"""),
    E0 = (-973.969,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([157,399,436,611,601,744,1127,519,593,830,1115,1166,1389,1413,3114,2175,525,239,401,1367,180,180,180,1789.51],'cm^-1')),
        HinderedRotor(inertia=(0.203286,'amu*angstrom^2'), symmetry=1, barrier=(4.67394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203321,'amu*angstrom^2'), symmetry=1, barrier=(4.67474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.33803,'amu*angstrom^2'), symmetry=1, barrier=(53.7558,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0876489,0.0961159,-0.000168562,1.50978e-07,-5.2161e-11,-117010,28.121], Tmin=(100,'K'), Tmax=(835.771,'K')), NASAPolynomial(coeffs=[10.4434,0.0286126,-1.52108e-05,2.9704e-09,-2.05488e-13,-118115,-16.2329], Tmin=(835.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-973.969,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(CsFFHO) + group(Ct-CtCs) + group(CtCF)"""),
)
...
"""),
    E0 = (-586.102,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,197,221,431,657,540,610,2055,137,207,812,180,389.271,521.189,533.618],'cm^-1')),
        HinderedRotor(inertia=(0.0782109,'amu*angstrom^2'), symmetry=1, barrier=(15.1543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00758928,'amu*angstrom^2'), symmetry=1, barrier=(33.1461,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.731143,0.0759422,-0.000104882,7.21581e-08,-1.95487e-11,-70377.6,25.8834], Tmin=(100,'K'), Tmax=(904.634,'K')), NASAPolynomial(coeffs=[13.7305,0.0184626,-9.5722e-06,1.91966e-09,-1.37819e-13,-72729.5,-35.5281], Tmin=(904.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-586.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsFFHO) + group(CdCddFO) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cdj(Cdd-Cd)(F1s))"""),
)

species(
    label = 'FC#CC(F)(F)O[CH]F(7894)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-537.059,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([157,399,436,611,601,744,1127,519,593,830,1115,1166,1389,1413,3114,2175,525,180,180,180,2433.24],'cm^-1')),
        HinderedRotor(inertia=(2.79952,'amu*angstrom^2'), symmetry=1, barrier=(64.3666,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.408973,'amu*angstrom^2'), symmetry=1, barrier=(9.40309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.79722,'amu*angstrom^2'), symmetry=1, barrier=(64.3135,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.302309,0.0909812,-0.000162673,1.43224e-07,-4.76272e-11,-64469.3,25.7724], Tmin=(100,'K'), Tmax=(885.536,'K')), NASAPolynomial(coeffs=[10.7314,0.0226703,-1.1047e-05,2.03665e-09,-1.34518e-13,-65485.1,-18.5801], Tmin=(885.536,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-537.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(CsFFHO) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
species(
    label = '[C]=C(F)C(F)(F)OC(F)F(11875)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.08501,'amu*angstrom^2'), symmetry=1, barrier=(24.9465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08061,'amu*angstrom^2'), symmetry=1, barrier=(24.8454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08374,'amu*angstrom^2'), symmetry=1, barrier=(24.9174,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.402604,0.108173,-0.00019569,1.75891e-07,-6.08166e-11,-104230,28.1283], Tmin=(100,'K'), Tmax=(827.424,'K')), NASAPolynomial(coeffs=[12.2429,0.0279972,-1.58192e-05,3.15113e-09,-2.20054e-13,-105671,-26.5442], Tmin=(827.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-867.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CsFFHO) + group(CdCCF) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FC#CC(F)(F)OC(F)F(7551)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FC#COC(F)F(11871)'],
    products = ['FC#CC(F)(F)OC(F)F(7551)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)F(2153)', 'F[C]C#CF(8583)'],
    products = ['FC#CC(F)(F)OC(F)F(7551)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(43)', 'OC(F)(F)C#CF(8710)'],
    products = ['FC#CC(F)(F)OC(F)F(7551)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'FC#CC(F)(F)OF(11872)'],
    products = ['FC#CC(F)(F)OC(F)F(7551)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]=C=C(F)OC(F)F(11873)'],
    products = ['FC#CC(F)(F)OC(F)F(7551)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC#CC(F)(F)O[CH]F(7894)'],
    products = ['FC#CC(F)(F)OC(F)F(7551)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[C]#CC(F)(F)OC(F)F(11874)'],
    products = ['FC#CC(F)(F)OC(F)F(7551)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)F(1061)', 'F[C]=C=C(F)F(7369)'],
    products = ['FC#CC(F)(F)OC(F)F(7551)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF2(82)', '[O]C(F)(F)C#CF(2244)'],
    products = ['FC#CC(F)(F)OC(F)F(7551)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[C]#CF(1924)', 'F[C](F)OC(F)F(3473)'],
    products = ['FC#CC(F)(F)OC(F)F(7551)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[C]=C(F)C(F)(F)OC(F)F(11875)'],
    products = ['FC#CC(F)(F)OC(F)F(7551)'],
