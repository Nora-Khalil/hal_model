...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][C](F)C(=O)OF(1055)'],
    products = ['[CH2]C(F)(F)C([O])=O(590)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C(=O)[C](F)F(1056)'],
    products = ['[CH2]C(F)(F)C([O])=O(590)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=O(876)'],
    products = ['[CH2]C(F)(F)C([O])=O(590)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C([O])=O(590)'],
    products = ['[CH2]C(F)(F)[C]1OO1(1057)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C([O])=O(311)'],
    products = ['[CH2]C(F)(F)C([O])=O(590)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CO2(14)', '[CH2][C](F)F(507)'],
    products = ['[CH2]C(F)(F)C([O])=O(590)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(276)', '[CH2][C](F)F(507)'],
    products = ['[CH2]C(F)(F)C([O])=O(590)'],
