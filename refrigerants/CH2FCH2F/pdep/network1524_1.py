...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC[C](F)F(627)'],
    products = ['CC([O])C[C](F)F(3271)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C[CH]C[C](F)F(1199)'],
    products = ['CC([O])C[C](F)F(3271)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(744)', '[CH2]C(C)[O](3496)'],
    products = ['CC([O])C[C](F)F(3271)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'O=CC[C](F)F(596)'],
    products = ['CC([O])C[C](F)F(3271)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(=O)C[C](F)F(3498)'],
    products = ['CC([O])C[C](F)F(3271)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'CC([O])C=C(F)F(3499)'],
    products = ['CC([O])C[C](F)F(3271)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C(C)[O](3496)'],
    products = ['CC([O])C[C](F)F(3271)'],
