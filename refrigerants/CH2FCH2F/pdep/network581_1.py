...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C#COO(1351)'],
    products = ['C#COOCF(1426)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COOF(1470)'],
    products = ['C#COOCF(1426)'],
    transitionState = 'TS3',
