...
"""),
    E0 = (-445.321,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,493,600,700,1144,1293,180,180,180,2282.51],'cm^-1')),
        HinderedRotor(inertia=(0.100068,'amu*angstrom^2'), symmetry=1, barrier=(2.30077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101532,'amu*angstrom^2'), symmetry=1, barrier=(2.33443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100624,'amu*angstrom^2'), symmetry=1, barrier=(2.31354,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48654,0.0647842,-0.000109444,1.08333e-07,-4.16303e-11,-53478.5,25.9105], Tmin=(100,'K'), Tmax=(817.228,'K')), NASAPolynomial(coeffs=[3.25181,0.0357222,-1.86178e-05,3.66259e-09,-2.56301e-13,-53085,21.9227], Tmin=(817.228,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-445.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFFHO) + radical(CCOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07722,0.0358486,-1.11188e-05,-5.81397e-09,3.09415e-12,-93328.6,19.1701], Tmin=(100,'K'), Tmax=(1239.17,'K')), NASAPolynomial(coeffs=[10.0924,0.0225996,-1.03621e-05,1.99993e-09,-1.40859e-13,-96284.3,-25.1283], Tmin=(1239.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-776.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFFOO) + ring(Cs-O2s-Cs(F)(F)-O2s)"""),
)
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47875,0.0635948,-0.000102656,9.86862e-08,-3.75114e-11,-54266.2,25.467], Tmin=(100,'K'), Tmax=(804.82,'K')), NASAPolynomial(coeffs=[4.21133,0.0339805,-1.75793e-05,3.4612e-09,-2.42881e-13,-54186.8,16.1033], Tmin=(804.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-451.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFFHO) + radical(CCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CO[C](F)F(2314)'],
    products = ['CC([O])O[C](F)F(3875)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', 'CC([O])[O](3893)'],
    products = ['CC([O])O[C](F)F(3875)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C[CH]O[C](F)F(3427)'],
    products = ['CC([O])O[C](F)F(3875)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(2186)', 'CH3CHO(36)'],
    products = ['CC([O])O[C](F)F(3875)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', 'O=CO[C](F)F(2344)'],
    products = ['CC([O])O[C](F)F(3875)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'CC(=O)O[C](F)F(3895)'],
    products = ['CC([O])O[C](F)F(3875)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C](F)F(2186)', 'C[CH][O](3430)'],
    products = ['CC([O])O[C](F)F(3875)'],
