...
reaction(
    label = 'reaction2',
    reactants = ['CH3F(39)', 'F[C]COF(3400)'],
    products = ['FCC(F)COF(3983)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FCC(F)OF(1516)'],
    products = ['FCC(F)COF(3983)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)COF(4002)'],
    products = ['FCC(F)COF(3983)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(25)', 'FOCC(F)F(3109)'],
    products = ['FCC(F)COF(3983)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(140)', 'C=C(F)CF(1190)'],
    products = ['FCC(F)COF(3983)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)COF(3525)'],
    products = ['FCC(F)COF(3983)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', '[CH2]C(F)CF(1034)'],
    products = ['FCC(F)COF(3983)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(179)', 'CH2F-CHF(66)'],
    products = ['FCC(F)COF(3983)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'F[CH]COF(2471)'],
    products = ['FCC(F)COF(3983)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FCC(F)[CH]OF(3989)'],
    products = ['FCC(F)COF(3983)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'F[CH]C(F)COF(4005)'],
    products = ['FCC(F)COF(3983)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'C=C(F)COF(3405)'],
    products = ['FCC(F)COF(3983)'],
