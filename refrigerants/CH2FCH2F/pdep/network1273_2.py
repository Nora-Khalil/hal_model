...
reaction(
    label = 'reaction19',
    reactants = ['O(6)', 'FC1(F)[CH]OO1(1553)'],
    products = ['[O]C1OOC1(F)F(1682)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C1OOC1(F)F(2415)'],
    products = ['[O]C1OOC1(F)F(1682)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', '[O]C1OO[C]1F(2675)'],
    products = ['[O]C1OOC1(F)F(1682)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', '[O][C]1OOC1(F)F(2425)'],
    products = ['[O]C1OOC1(F)F(1682)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C1OO[C]1F(2676)'],
    products = ['[O]C1OOC1(F)F(1682)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C1OOC1(F)F(1682)'],
    products = ['O[C]1OOC1(F)F(2677)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[O]OC(F)F(499)'],
    products = ['[O]OC(F)(F)C=O(1651)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OF(126)', 'O=C[C]F-2(1630)'],
    products = ['[O]OC(F)(F)C=O(1651)'],
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)(F)C=O(1680)'],
    products = ['[O]OC(F)(F)C=O(1651)'],
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]O[C](F)C=O(1683)'],
    products = ['[O]OC(F)(F)C=O(1651)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(F)(F)[C]=O(1684)'],
    products = ['[O]OC(F)(F)C=O(1651)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O]OC(F)=C=O(1685)'],
    products = ['[O]OC(F)(F)C=O(1651)'],
