...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0302416,0.0958646,-0.000154446,1.34637e-07,-4.659e-11,-94443.8,30.0814], Tmin=(100,'K'), Tmax=(797.516,'K')), NASAPolynomial(coeffs=[10.344,0.0335557,-1.73547e-05,3.4059e-09,-2.38346e-13,-95752.5,-15.2339], Tmin=(797.516,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-786.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (11.0464,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,358.183,358.919,362.097,362.824],'cm^-1')),
        HinderedRotor(inertia=(0.0812872,'amu*angstrom^2'), symmetry=1, barrier=(7.42759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0263906,'amu*angstrom^2'), symmetry=1, barrier=(48.2413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0804313,'amu*angstrom^2'), symmetry=1, barrier=(7.44359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0263953,'amu*angstrom^2'), symmetry=1, barrier=(48.2467,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.819438,0.0764284,-0.000103272,7.88744e-08,-2.49394e-11,1437.19,28.3214], Tmin=(100,'K'), Tmax=(764.73,'K')), NASAPolynomial(coeffs=[9.2684,0.0322357,-1.65902e-05,3.30867e-09,-2.36265e-13,144.936,-10.1738], Tmin=(764.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.0464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.266784,0.0907462,-0.000146889,1.3083e-07,-4.66979e-11,-30595.1,29.8376], Tmin=(100,'K'), Tmax=(772.511,'K')), NASAPolynomial(coeffs=[9.25906,0.034418,-1.85507e-05,3.70994e-09,-2.62834e-13,-31693,-9.3377], Tmin=(772.511,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-255.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CsCCl_triplet)"""),
)

species(
    label = 'FC1COO[CH]C1(F)F(5345)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0790952,0.0745392,-7.27525e-05,3.62645e-08,-6.89337e-12,-72357,24.1135], Tmin=(100,'K'), Tmax=(1458.7,'K')), NASAPolynomial(coeffs=[17.965,0.0160808,-3.40631e-06,3.51745e-10,-1.52548e-14,-76666,-66.4772], Tmin=(1458.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-602.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCsCsFH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCsJOOC) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F))"""),
)

species(
    label = 'F[C](F)C1OOCC1F(5346)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0448477,0.0750108,-7.60241e-05,3.93524e-08,-7.82275e-12,-69797.7,26.3303], Tmin=(100,'K'), Tmax=(1356.79,'K')), NASAPolynomial(coeffs=[17.8451,0.0161773,-3.95381e-06,4.87578e-10,-2.54048e-14,-74042.9,-62.821], Tmin=(1356.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-581.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(12dioxolane) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-192.36,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,562,600,623,1070,1265,1685,370,180,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.175217,'amu*angstrom^2'), symmetry=1, barrier=(4.02857,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.216454,0.0979487,-0.000182251,1.77236e-07,-6.53735e-11,-23013.6,34.4973], Tmin=(100,'K'), Tmax=(838.765,'K')), NASAPolynomial(coeffs=[5.64824,0.0401199,-2.17407e-05,4.28074e-09,-2.9743e-13,-22801.8,15.9415], Tmin=(838.765,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(H)) + radical(C=CJO)"""),
)
...
"""),
    E0 = (57.0436,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,2175,525,239,401,1367,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0797024,'amu*angstrom^2'), symmetry=1, barrier=(1.83252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16723,'amu*angstrom^2'), symmetry=1, barrier=(26.8369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.406485,0.0891067,-0.000155628,1.43455e-07,-5.15242e-11,6980.42,28.0796], Tmin=(100,'K'), Tmax=(810.692,'K')), NASAPolynomial(coeffs=[8.54448,0.031669,-1.73723e-05,3.46195e-09,-2.43299e-13,6228.91,-5.97058], Tmin=(810.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(57.0436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Ct-CtOs) + group(CtCF) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-386.26,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,562,600,623,1070,1265,1685,370,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.125254,'amu*angstrom^2'), symmetry=1, barrier=(2.87984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123457,'amu*angstrom^2'), symmetry=1, barrier=(2.83852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.546982,'amu*angstrom^2'), symmetry=1, barrier=(12.5762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.32855,'amu*angstrom^2'), symmetry=1, barrier=(53.5379,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.376792,0.0912561,-0.000154203,1.46775e-07,-5.46715e-11,-46337.1,32.9527], Tmin=(100,'K'), Tmax=(811.207,'K')), NASAPolynomial(coeffs=[5.74207,0.0423954,-2.24262e-05,4.43067e-09,-3.10702e-13,-46470.4,12.7347], Tmin=(811.207,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-386.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]COOC=C(F)F(5259)'],
    products = ['O=C[C](F)F(787)', 'FC1CO1(289)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]COOC=C(F)F(5259)'],
    products = ['O=CC(F)(F)OC[CH]F(5343)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]COOC=C(F)F-2(5344)'],
    products = ['F[CH]COOC=C(F)F(5259)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', '[CH2]OOC=C(F)F(1854)'],
    products = ['F[CH]COOC=C(F)F(5259)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'F[C]COOC=C(F)F(5222)'],
    products = ['F[CH]COOC=C(F)F(5259)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]COOC=C(F)F(5259)'],
    products = ['FC1COO[CH]C1(F)F(5345)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[C]=COOC[CH]F(5347)'],
    products = ['F[CH]COOC=C(F)F(5259)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C[C](F)F(787)', '[O]C[CH]F(138)'],
    products = ['F[CH]COOC=C(F)F(5259)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(46.1499,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction13',
    reactants = ['[O]OC=C(F)F(785)', '[CH2][CH]F(226)'],
    products = ['F[CH]COOC=C(F)F(5259)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2CH(73)', '[O]OC[CH]F(215)'],
    products = ['F[CH]COOC=C(F)F(5259)'],
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]COOC=C(F)F(5259)'],
    products = ['O=C[CH]F(435)', 'O=CC(F)F(990)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(30.891,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'FC#COOC[CH]F(5349)'],
    products = ['F[CH]COOC=C(F)F(5259)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF(40)', '[CH2]OOC=C(F)F(1854)'],
    products = ['F[CH]COOC=C(F)F(5259)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'F[C]COOC=C(F)F-2(5228)'],
    products = ['F[CH]COOC=C(F)F(5259)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]=COOCC(F)F(5260)'],
    products = ['F[CH]COOC=C(F)F(5259)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(180.59,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #2508',
    isomers = [
        'F[CH]COOC=C(F)F(5259)',
    ],
    reactants = [
        ('O=C[C](F)F(787)', 'FC1CO1(289)'),
        ('O=C[CH]F(435)', 'O=CC(F)F(990)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
