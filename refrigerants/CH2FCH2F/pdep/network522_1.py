...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'F[CH]O[CH]F(1084)'],
    products = ['F[CH]OC(F)[CH]F(1115)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[CH]OC=CF(1074)'],
    products = ['F[CH]OC(F)[CH]F(1115)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]OC(F)=CF(1129)'],
    products = ['F[CH]OC(F)[CH]F(1115)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', 'F[CH]O[CH]F(1084)'],
    products = ['F[CH]OC(F)[CH]F(1115)'],
