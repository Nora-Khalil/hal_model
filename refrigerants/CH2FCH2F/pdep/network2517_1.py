...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(O)C[C]F(3826)'],
    products = ['O=C(O)CCF(4552)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'O=C(O)CF(3761)'],
    products = ['O=C(O)CCF(4552)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]CC(=O)O(6678)'],
    products = ['O=C(O)CCF(4552)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(158)', 'CH2F-CH2(62)'],
    products = ['O=C(O)CCF(4552)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(O)[CH]CF(3769)'],
    products = ['O=C(O)CCF(4552)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C[CH]F(3242)'],
    products = ['O=C(O)CCF(4552)'],
