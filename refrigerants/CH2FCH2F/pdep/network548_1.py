...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(368)', '[O]C(F)[CH]F(975)'],
    products = ['C=[C]OC(F)[CH]F(1225)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'C=[C]O[CH]F(377)'],
    products = ['C=[C]OC(F)[CH]F(1225)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=[C]OC(F)=CF(1243)'],
    products = ['C=[C]OC(F)[CH]F(1225)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#COC(F)[CH]F(1244)'],
    products = ['C=[C]OC(F)[CH]F(1225)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', 'C=[C]O[CH]F(377)'],
    products = ['C=[C]OC(F)[CH]F(1225)'],
