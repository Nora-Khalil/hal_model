...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C[O](325)'],
    products = ['[CH2]CC[O](3245)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](133)', '[CH2][CH2](511)'],
    products = ['[CH2]CC[O](3245)'],
