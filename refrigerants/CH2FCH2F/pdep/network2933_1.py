...
reaction(
    label = 'reaction4',
    reactants = ['[O]OOO[C](F)F(8998)'],
    products = ['[O-][O+]=O(821)', '[O][C](F)F(2186)'],
    transitionState = 'TS4',
