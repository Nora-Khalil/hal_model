...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.64634,'amu*angstrom^2'), symmetry=1, barrier=(14.8606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.649261,'amu*angstrom^2'), symmetry=1, barrier=(14.9278,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.528381,0.0865265,-0.000151621,1.39927e-07,-4.99205e-11,-25194.7,27.9502], Tmin=(100,'K'), Tmax=(828.115,'K')), NASAPolynomial(coeffs=[8.03527,0.03111,-1.65443e-05,3.25042e-09,-2.26218e-13,-25781.2,-2.88442], Tmin=(828.115,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-210.438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFF) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.371773,0.0846249,-0.00012198,8.93559e-08,-2.58164e-11,-36870.4,25.7269], Tmin=(100,'K'), Tmax=(849.812,'K')), NASAPolynomial(coeffs=[13.7586,0.0216137,-1.07585e-05,2.10377e-09,-1.48247e-13,-39145.7,-36.6782], Tmin=(849.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-307.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + group(CdCFH) + radical(CsCdF1sH) + radical(Cdj(Cd-CdH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.869173,0.0732826,-9.68035e-05,6.72346e-08,-1.87319e-11,-61156.2,24.5792], Tmin=(100,'K'), Tmax=(874.477,'K')), NASAPolynomial(coeffs=[11.7286,0.0236098,-1.1599e-05,2.27786e-09,-1.61658e-13,-63055.5,-26.3545], Tmin=(874.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-509.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(CdCFH) + group(CdCddFF) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,94,120,354,641,825,1294,540,610,2055,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(1.1628,'amu*angstrom^2'), symmetry=1, barrier=(26.7352,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (137.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.524649,0.0841072,-0.000143658,1.24929e-07,-4.20429e-11,-30392.5,25.7303], Tmin=(100,'K'), Tmax=(838.415,'K')), NASAPolynomial(coeffs=[10.7144,0.0229611,-1.18408e-05,2.28733e-09,-1.57336e-13,-31660.7,-19.0067], Tmin=(838.415,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-253.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(CdCFH) + group(CdCddFF) + group(Cdd-CdsCds) + radical(Cdj(Cd-CdH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.433121,'amu*angstrom^2'), symmetry=1, barrier=(9.95831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.35333,'amu*angstrom^2'), symmetry=1, barrier=(54.1077,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (137.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.685389,0.0845482,-0.000156603,1.47403e-07,-5.24533e-11,-24256.7,25.9811], Tmin=(100,'K'), Tmax=(855.588,'K')), NASAPolynomial(coeffs=[7.14563,0.0291715,-1.53835e-05,2.97616e-09,-2.03919e-13,-24440.7,1.20638], Tmin=(855.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-202.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(CdCFF) + group(Ct-CtCs) + group(CtCF) + radical(Cds_S)"""),
)

species(
    label = 'F[C]=CC(F)C#CF(8140)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.87156,'amu*angstrom^2'), symmetry=1, barrier=(43.0309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588862,'amu*angstrom^2'), symmetry=1, barrier=(13.5391,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05509,0.073387,-0.000126654,1.15857e-07,-4.08004e-11,1387.86,23.6651], Tmin=(100,'K'), Tmax=(845.651,'K')), NASAPolynomial(coeffs=[7.20705,0.0269981,-1.37018e-05,2.63486e-09,-1.80896e-13,965.588,-1.32794], Tmin=(845.651,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.7265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(CdCFH) + group(Ct-CtCs) + group(CtCF) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.12003,'amu*angstrom^2'), symmetry=1, barrier=(48.7438,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (118.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10823,0.0674023,-9.65431e-05,6.76903e-08,-1.73706e-11,9080.98,22.8686], Tmin=(100,'K'), Tmax=(717.815,'K')), NASAPolynomial(coeffs=[11.9126,0.0158535,-6.91505e-06,1.25193e-09,-8.36815e-14,7306.83,-27.2277], Tmin=(717.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.6663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + group(CdCddFH) + group(Cdd-CdsCds) + radical(C=CJC=C) + radical(Cdj(Cdd-Cd)(F1s))"""),
)

species(
    label = 'F[C]C=C(F)C=C(F)F(8142)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.952634,0.0732054,-9.56496e-05,6.64477e-08,-1.8829e-11,-40180.1,24.4565], Tmin=(100,'K'), Tmax=(853.063,'K')), NASAPolynomial(coeffs=[10.8118,0.0269756,-1.436e-05,2.91974e-09,-2.11321e-13,-41862.2,-21.5415], Tmin=(853.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(CdCCF) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.680046,'amu*angstrom^2'), symmetry=1, barrier=(15.6356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.680247,'amu*angstrom^2'), symmetry=1, barrier=(15.6402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.232522,'amu*angstrom^2'), symmetry=1, barrier=(5.34614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.714546,'amu*angstrom^2'), symmetry=1, barrier=(16.4288,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.400456,0.0890298,-0.000155391,1.41018e-07,-4.94143e-11,-19109.7,28.1341], Tmin=(100,'K'), Tmax=(834.271,'K')), NASAPolynomial(coeffs=[9.01867,0.029468,-1.55033e-05,3.0259e-09,-2.09561e-13,-19912.9,-8.07771], Tmin=(834.271,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cds-CdsCsH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + radical(Cdj(Cd-CsF1s)(F1s)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7537)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7537)'],
    products = ['F[C]=CC([CH]F)=C(F)F(7536)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(1544)', 'F[C]C=CF(1952)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7537)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C]=CC=C=C(F)F(8137)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7537)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C]=CC(F)=C=C(F)F(8138)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7537)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC#CC(F)[C]=C(F)F(8139)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7537)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[C]=CC(F)C#CF(8140)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7537)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[C]=C=C[C]=C(F)F(8141)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7537)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7537)'],
    products = ['F[C]C=C(F)C=C(F)F(8142)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]=[C]C(F)C=C(F)F(8144)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7537)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7537)'],
    products = ['F[CH]C=C(F)[C]=C(F)F(7806)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7537)'],
    products = ['F[C]=C[CH]C(F)=C(F)F(8145)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C]=CC(F)[C]=C(F)F(7537)'],
    products = ['FC(F)=[C][CH]C=C(F)F(7718)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C]=CC(F)C(F)=[C]F(8146)'],
    products = ['F[C]=CC(F)[C]=C(F)F(7537)'],
