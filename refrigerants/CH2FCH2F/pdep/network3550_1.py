...
"""),
    E0 = (-789.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,333,384,448,608,1254,1480,2750,2850,1437.5,1250,1305,750,350,442,614,1089,1143,1126,1238,1254,1408,1339,1465,1463,1525,3023,3127,3088,3132,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.03056,'amu*angstrom^2'), symmetry=1, barrier=(23.6946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03025,'amu*angstrom^2'), symmetry=1, barrier=(23.6876,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03097,'amu*angstrom^2'), symmetry=1, barrier=(23.7041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03122,'amu*angstrom^2'), symmetry=1, barrier=(23.7097,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.158432,0.0902123,-0.000102147,6.10809e-08,-1.495e-11,-94774.8,26.5844], Tmin=(100,'K'), Tmax=(979.037,'K')), NASAPolynomial(coeffs=[13.6611,0.035046,-1.76272e-05,3.52912e-09,-2.54232e-13,-97418.8,-38.2726], Tmin=(979.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-789.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH)"""),
)
...
"""),
    E0 = (-437.297,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,617,898,1187,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.14639,'amu*angstrom^2'), symmetry=1, barrier=(26.3577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14717,'amu*angstrom^2'), symmetry=1, barrier=(26.3757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14702,'amu*angstrom^2'), symmetry=1, barrier=(26.3723,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14721,'amu*angstrom^2'), symmetry=1, barrier=(26.3766,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.136711,0.0921632,-0.000128268,9.44523e-08,-2.80666e-11,-52462,27.6022], Tmin=(100,'K'), Tmax=(819.077,'K')), NASAPolynomial(coeffs=[12.6666,0.0309759,-1.62197e-05,3.25803e-09,-2.33589e-13,-54514.7,-30.3473], Tmin=(819.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-437.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(CsCCFO) + group(CsCsFHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (146.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0250012,0.0973255,-0.000130156,8.79334e-08,-1.97112e-11,-96409.2,27.3898], Tmin=(100,'K'), Tmax=(611.145,'K')), NASAPolynomial(coeffs=[11.0798,0.0386227,-1.95829e-05,3.86562e-09,-2.7367e-13,-98015.3,-22.5854], Tmin=(611.145,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-802.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFHH)"""),
)
...
"""),
    E0 = (-579.581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,323,467,575,827,1418,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.163792,'amu*angstrom^2'), symmetry=1, barrier=(3.76589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163537,'amu*angstrom^2'), symmetry=1, barrier=(3.76004,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
...
"""),
    E0 = (-404.099,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.445753,'amu*angstrom^2'), symmetry=1, barrier=(10.2487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02645,'amu*angstrom^2'), symmetry=1, barrier=(23.6001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444941,'amu*angstrom^2'), symmetry=1, barrier=(10.2301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43457,'amu*angstrom^2'), symmetry=1, barrier=(32.9835,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.085,'amu'),
...
"""),
    E0 = (-689.67,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([286,334,437,422,648,895,1187,2750,2850,1437.5,1250,1305,750,350,442,614,1089,1143,1126,1238,1254,1408,1339,1465,1463,1525,3023,3127,3088,3132,225.603,225.631,225.682],'cm^-1')),
        HinderedRotor(inertia=(0.310495,'amu*angstrom^2'), symmetry=1, barrier=(11.2182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560221,'amu*angstrom^2'), symmetry=1, barrier=(20.2384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310543,'amu*angstrom^2'), symmetry=1, barrier=(11.2181,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.085,'amu'),
...
"""),
    E0 = (-530.449,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.777875,'amu*angstrom^2'), symmetry=1, barrier=(17.8849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.777925,'amu*angstrom^2'), symmetry=1, barrier=(17.886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.777806,'amu*angstrom^2'), symmetry=1, barrier=(17.8833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.5741,0.04213,9.71333e-05,-5.23594e-07,6.55019e-10,-63802.2,12.8725], Tmin=(10,'K'), Tmax=(296.713,'K')), NASAPolynomial(coeffs=[4.89283,0.0459394,-3.12565e-05,1.00782e-08,-1.23182e-12,-63975.4,6.51132], Tmin=(296.713,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-530.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), label="""FCC[C](F)CF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-589.524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,334,575,1197,1424,3202,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.582521,'amu*angstrom^2'), symmetry=1, barrier=(13.3933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.582315,'amu*angstrom^2'), symmetry=1, barrier=(13.3886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.622,'amu*angstrom^2'), symmetry=1, barrier=(37.293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.58203,'amu*angstrom^2'), symmetry=1, barrier=(13.382,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.566576,0.110992,-0.000184957,1.63599e-07,-5.69141e-11,-70749.1,28.8686], Tmin=(100,'K'), Tmax=(806.747,'K')), NASAPolynomial(coeffs=[11.3312,0.0370058,-1.9514e-05,3.84457e-09,-2.69007e-13,-72180.8,-22.952], Tmin=(806.747,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-589.524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + radical(Csj(Cs-F1sO2sCs)(F1s)(H))"""),
)
...
"""),
    E0 = (-610.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,269.924,269.976,270.218],'cm^-1')),
        HinderedRotor(inertia=(0.142729,'amu*angstrom^2'), symmetry=1, barrier=(7.39724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142464,'amu*angstrom^2'), symmetry=1, barrier=(7.39582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.420196,'amu*angstrom^2'), symmetry=1, barrier=(21.7891,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['FCCC(F)(CF)OF(10918)'],
    products = ['HF(38)', 'O=C(F)CF(476)', 'CH2CHF(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(41.9999,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['FCOF(1070)', 'F[C]CCF(1532)'],
    products = ['FCCC(F)(CF)OF(10918)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]CF(125)', 'FCCOF(1533)'],
    products = ['FCCC(F)(CF)OF(10918)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.14358e+07,'m^3/(mol*s)'), n=-0.641018, Ea=(179.274,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17570294811609, var=29.477358162589667, Tref=1000.0, N=2, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    ...
    products = ['FCCC(F)(CF)OF(10918)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(23.7199,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(25)', 'FCCC(F)(F)OF(2580)'],
    products = ['FCCC(F)(CF)OF(10918)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(160.234,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['H2(8)', 'F[C]CC(F)(CF)OF(10939)'],
    products = ['FCCC(F)(CF)OF(10918)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['FCCC(F)(CF)OF(10918)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.39871e-05,'m^3/(mol*s)'), n=3.10993, Ea=(25.5376,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s
...
reaction(
    label = 'reaction12',
    reactants = ['OF(140)', 'FC=C(F)CCF(884)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FOF(1520)', 'C=C(F)CCF(235)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'FCC[C](CF)OF(10942)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]CC(F)(CF)OF(10943)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]C(F)(CCF)OF(10944)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[O]C(F)(CF)CCF(10945)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(127)', 'FCC[C](F)CF(10946)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction19',
    reactants = ['FC[C](F)OF(9995)', 'CH2F-CH2(62)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2F(46)', 'FCC[C](F)OF(1539)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2F(46)', '[CH2]C(F)(CF)OF(10947)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'FC[CH]C(F)(CF)OF(10948)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'F[CH]C(F)(CCF)OF(10949)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', 'F[CH]CC(F)(CF)OF(10950)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F2(78)', 'O=C(CF)CCF(2603)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F2(78)', 'C=C(CCF)OF(2576)'],
    products = ['FCCC(F)(CF)OF(10918)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'FCC=C(CF)OF(4152)'],
    products = ['FCCC(F)(CF)OF(10918)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(220.524,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)
...
reaction(
    label = 'reaction30',
    reactants = ['FCCC(F)(CF)OF(10918)'],
    products = ['F2(78)', 'O=C(F)CF(476)', 'C2H4(30)'],
    transitionState = 'TS30',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(268.155,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
