...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)O[O](470)'],
    products = ['O=O(141)', 'C2HF(58)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(=O)F(427)'],
    products = ['[CH]=C(F)O[O](470)'],
    transitionState = 'TS2',
