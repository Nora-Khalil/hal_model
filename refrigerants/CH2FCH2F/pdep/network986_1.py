...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]O[C](F)F(941)'],
    products = ['F[CH]CO[C](F)F(2151)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC=CO[C](F)F(2187)'],
    products = ['F[CH]CO[C](F)F(2151)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[CH2]O[C](F)F(941)'],
    products = ['F[CH]CO[C](F)F(2151)'],
