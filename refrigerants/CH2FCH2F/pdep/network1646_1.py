...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C([O])OC(F)(F)F(3753)'],
    products = ['C=C(O)OC(F)(F)F(3593)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(O)O[C](F)F(3755)'],
    products = ['C=C(O)OC(F)(F)F(3593)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', 'C=[C]OC(F)(F)F(3756)'],
    products = ['C=C(O)OC(F)(F)F(3593)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(=O)OC(F)(F)F(3757)'],
    products = ['C=C(O)OC(F)(F)F(3593)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(O)OC(F)(F)F(3758)'],
    products = ['C=C(O)OC(F)(F)F(3593)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C(O)OC(F)(F)F(3759)'],
    products = ['C=C(O)OC(F)(F)F(3593)'],
