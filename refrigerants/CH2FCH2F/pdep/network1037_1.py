...
reaction(
    label = 'reaction2',
    reactants = ['O[C](F)F(1777)', 'CH2(S)(25)'],
    products = ['CO[C](F)F(2313)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CO[C](F)F(2313)'],
    products = ['[CH2]OC(F)F(4388)'],
    transitionState = 'TS9',
