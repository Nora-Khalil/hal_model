...
"""),
    E0 = (-438.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,90,150,250,247,323,377,431,433,1065,1274,1877.14],'cm^-1')),
        HinderedRotor(inertia=(0.0680792,'amu*angstrom^2'), symmetry=1, barrier=(8.01563,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0140759,'amu*angstrom^2'), symmetry=1, barrier=(35.1692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04021,0.0725662,-0.000120643,1.09707e-07,-3.95442e-11,-52659.3,22.764], Tmin=(100,'K'), Tmax=(785.529,'K')), NASAPolynomial(coeffs=[7.86036,0.0274527,-1.46673e-05,2.93706e-09,-2.08098e-13,-53410.4,-6.45356], Tmin=(785.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-438.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
species(
    label = 'F[CH]C1C(F)(F)C1(F)F(9819)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.585881,'amu*angstrom^2'), symmetry=1, barrier=(13.4706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.585427,'amu*angstrom^2'), symmetry=1, barrier=(13.4601,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.702498,0.0818537,-0.000145628,1.33443e-07,-4.70916e-11,-46492.1,24.7387], Tmin=(100,'K'), Tmax=(828.176,'K')), NASAPolynomial(coeffs=[8.75047,0.0260603,-1.39245e-05,2.75111e-09,-1.91955e-13,-47244.8,-9.0671], Tmin=(828.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-387.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s)) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.343342,0.0915139,-0.000169073,1.55611e-07,-5.44468e-11,-68688.3,27.2742], Tmin=(100,'K'), Tmax=(845.282,'K')), NASAPolynomial(coeffs=[9.5609,0.0260318,-1.40739e-05,2.76566e-09,-1.91336e-13,-69465.5,-11.0257], Tmin=(845.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-572.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (-424.106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([86,203,488,582,605,741,182,240,577,636,1210,1413,615,860,1140,1343,3152,1685,370,728.442],'cm^-1')),
        HinderedRotor(inertia=(0.156167,'amu*angstrom^2'), symmetry=1, barrier=(3.5906,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.45218,'amu*angstrom^2'), symmetry=1, barrier=(10.3965,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.051,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['FC=CC(F)(F)[C](F)F(8968)'],
    products = ['F[C](F)C(F)=CC(F)F(11261)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'F[C]C(F)(F)C=CF-2(11262)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['FC=CC(F)(F)[C](F)F(8968)'],
    products = ['F[CH]C1C(F)(F)C1(F)F(9819)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC=CC(F)=C(F)F(6407)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C=C(F)[C](F)F(6154)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=CC(F)(F)[C](F)F(11264)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)[C](F)F(3840)', 'CHFCH[Z](71)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC=[C]C(F)(F)[C](F)F(7760)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C]=CC(F)(F)[C](F)F(11265)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'FC=[C]C(F)=C(F)F(11266)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C#CC(F)(F)[C](F)F(11267)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'F[C]C(F)(F)C=CF(8961)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC=[C]C(F)(F)C(F)F(7570)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]=CC(F)(F)C(F)F(11268)'],
    products = ['FC=CC(F)(F)[C](F)F(8968)'],
...
reaction(
    label = 'reaction19',
    reactants = ['FC=CC(F)(F)[C](F)F(8968)'],
    products = ['F[CH]C=C(F)C(F)(F)F(9820)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FC=CC(F)(F)[C](F)F(8968)'],
    products = ['[CH]=CC(F)(F)C(F)(F)F(11269)'],
...
network(
    label = 'PDepNetwork #3246',
    isomers = [
        'FC=CC(F)(F)[C](F)F(8968)',
    ],
    reactants = [
