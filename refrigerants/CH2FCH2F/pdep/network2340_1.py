...
species(
    label = '[CH2]C1([O])C(F)C1(F)F(6377)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.879945,0.0729716,-9.42685e-05,6.41458e-08,-1.75544e-11,-32466,21.8994], Tmin=(100,'K'), Tmax=(888.674,'K')), NASAPolynomial(coeffs=[11.7249,0.0241575,-1.18748e-05,2.33547e-09,-1.6603e-13,-34393.5,-29.1411], Tmin=(888.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-270.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(CsCsCsFH) + group(CsCsCsFF) + group(Cs-CsHHH) + ring(Cs-Cs(F)(F)-Cs(O2)) + radical(CC(C)2OJ) + radical(CJC(C)2O) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F))"""),
)
...
"""),
    E0 = (-590.391,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([219,296,586,564,718,793,1177,1228,3010,987.5,1337.5,450,1655,350,440,435,1725,3000,3100,440,815,1455,1000,180,2437.2],'cm^-1')),
        HinderedRotor(inertia=(0.0464749,'amu*angstrom^2'), symmetry=1, barrier=(12.8302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.442695,'amu*angstrom^2'), symmetry=1, barrier=(12.8318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['C=C([O])C(F)[C](F)F(6297)'],
    products = ['C=C([O])C(F)(F)[CH]F(6296)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', '[CH2]C(=O)[CH]F(400)'],
    products = ['C=C([O])C(F)[C](F)F(6297)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)[C](F)F(6373)'],
    products = ['C=C([O])C(F)[C](F)F(6297)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C(F)[C](F)F(6297)'],
    products = ['F[C](F)C(F)[C]1CO1(6375)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['C=C([O])C(F)[C](F)F(6297)'],
    products = ['[CH2]C1([O])C(F)C1(F)F(6377)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C([O])C=C(F)F(860)'],
    products = ['C=C([O])C(F)[C](F)F(6297)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C([O])C(F)=C(F)F(6378)'],
    products = ['C=C([O])C(F)[C](F)F(6297)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[CH2]C(=O)[CH]F(400)'],
    products = ['C=C([O])C(F)[C](F)F(6297)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C([O])C(F)[C](F)F(6297)'],
    products = ['[CH2]C(O)=C(F)[C](F)F(6380)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(O)C(F)[C](F)F(6381)'],
    products = ['C=C([O])C(F)[C](F)F(6297)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C([O])C(F)C(F)F(6382)'],
    products = ['C=C([O])C(F)[C](F)F(6297)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(=C[C](F)F)OF(6383)'],
    products = ['C=C([O])C(F)[C](F)F(6297)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([O])C(F)[C](F)F(6297)'],
    products = ['[CH2]C([O])=CC(F)(F)F(2965)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(18)', 'O=[C]C(F)[C](F)F(6384)'],
    products = ['C=C([O])C(F)[C](F)F(6297)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C([O])C(F)[C](F)F(6297)'],
    products = ['[CH2][C]1OC(F)(F)C1F(6386)'],
...
network(
    label = 'PDepNetwork #2340',
    isomers = [
        'C=C([O])C(F)[C](F)F(6297)',
    ],
    reactants = [
        ('CHFCF2(55)', 'CH2CO(28)'),
    ],
