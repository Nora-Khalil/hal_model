...
"""),
    E0 = (-22.4801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,1122.63,1122.66],'cm^-1')),
        HinderedRotor(inertia=(0.134998,'amu*angstrom^2'), symmetry=1, barrier=(3.10386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135013,'amu*angstrom^2'), symmetry=1, barrier=(3.10422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135023,'amu*angstrom^2'), symmetry=1, barrier=(3.10444,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.22222,0.0324637,-1.64326e-05,3.44964e-09,-2.70688e-13,-2692.85,16.6534], Tmin=(100,'K'), Tmax=(2919.75,'K')), NASAPolynomial(coeffs=[17.7396,0.0125757,-6.21547e-06,1.11681e-09,-7.09458e-14,-11170.4,-68.9399], Tmin=(2919.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.4801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48582,0.00501537,0.000112712,-1.61867e-07,6.53872e-11,-33505.4,15.2032], Tmin=(100,'K'), Tmax=(934.501,'K')), NASAPolynomial(coeffs=[20.3466,0.0010235,2.81373e-06,-4.94172e-10,1.94845e-14,-40007.4,-86.683], Tmin=(934.501,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-279.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)
...
"""),
    E0 = (-224.235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,180,180,180,935.023,935.114],'cm^-1')),
        HinderedRotor(inertia=(0.00384036,'amu*angstrom^2'), symmetry=1, barrier=(2.38312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00384034,'amu*angstrom^2'), symmetry=1, barrier=(2.38298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0785732,'amu*angstrom^2'), symmetry=1, barrier=(48.7579,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.43138,0.0286131,-4.12037e-06,-1.02703e-08,4.49731e-12,-26907.9,17.3188], Tmin=(100,'K'), Tmax=(1147.82,'K')), NASAPolynomial(coeffs=[8.40361,0.0199831,-8.76291e-06,1.67293e-09,-1.1795e-13,-29081.5,-15.8129], Tmin=(1147.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-224.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CsJOC(O)C)"""),
)

species(
    label = '[CH2]O[C](C)O(5696)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04706,0.0446944,-4.08696e-05,2.07799e-08,-4.46074e-12,-5095.48,20.8073], Tmin=(100,'K'), Tmax=(1089.98,'K')), NASAPolynomial(coeffs=[8.15283,0.0222876,-1.00341e-05,1.92005e-09,-1.35028e-13,-6426.52,-9.17555], Tmin=(1089.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.9389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(Cs_P) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (-5.10465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,180,1736.22,1738.36],'cm^-1')),
        HinderedRotor(inertia=(0.199263,'amu*angstrom^2'), symmetry=1, barrier=(4.58145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198699,'amu*angstrom^2'), symmetry=1, barrier=(4.56848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199995,'amu*angstrom^2'), symmetry=1, barrier=(4.59827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32041,0.0428939,-5.74355e-05,5.83456e-08,-2.42471e-11,-559.298,19.8889], Tmin=(100,'K'), Tmax=(792.601,'K')), NASAPolynomial(coeffs=[1.27767,0.0348841,-1.71594e-05,3.34221e-09,-2.34362e-13,22.8857,27.307], Tmin=(792.601,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.10465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]OC([CH2])O(5698)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {5,S}
...
"""),
    E0 = (-36.5961,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,633.456],'cm^-1')),
        HinderedRotor(inertia=(0.0127315,'amu*angstrom^2'), symmetry=1, barrier=(3.62471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157691,'amu*angstrom^2'), symmetry=1, barrier=(3.62562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0127302,'amu*angstrom^2'), symmetry=1, barrier=(3.62551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.591995,'amu*angstrom^2'), symmetry=1, barrier=(13.6111,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82118,0.049559,-5.15251e-05,2.93893e-08,-6.90018e-12,-4324.38,21.5655], Tmin=(100,'K'), Tmax=(1018.85,'K')), NASAPolynomial(coeffs=[9.12128,0.020898,-9.32793e-06,1.77755e-09,-1.24774e-13,-5811.88,-13.7894], Tmin=(1018.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.5961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCO) + radical(CsJOCH3)"""),
)

species(
    label = '[CH2]C([O])OC(5699)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  O u1 p2 c0 {3,S}
3  C u0 p0 c0 {1,S} {2,S} {5,S} {6,S}
...
"""),
    E0 = (1.23808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,887.047,1724.94],'cm^-1')),
        HinderedRotor(inertia=(0.152284,'amu*angstrom^2'), symmetry=1, barrier=(3.5013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150468,'amu*angstrom^2'), symmetry=1, barrier=(3.45956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148053,'amu*angstrom^2'), symmetry=1, barrier=(3.40403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.70063,0.0306887,-1.46019e-05,2.68038e-09,-1.7025e-13,133.53,14.7233], Tmin=(100,'K'), Tmax=(3044.22,'K')), NASAPolynomial(coeffs=[39.5492,-0.0101767,2.46016e-06,-3.82957e-10,2.60382e-14,-24583.3,-202.881], Tmin=(3044.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.23808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]OC[O](3073)'],
    products = ['[CH2]OC(C)[O](5663)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'CC([O])[O](3893)'],
    products = ['[CH2]OC(C)[O](5663)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[CH2]OC=O(1887)'],
    products = ['[CH2]OC(C)[O](5663)'],
    transitionState = 'TS9',
