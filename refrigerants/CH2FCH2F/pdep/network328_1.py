...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH]C=C(254)'],
    products = ['[CH]=CC[C](F)F(639)'],
    transitionState = 'TS3',
