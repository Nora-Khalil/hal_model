...
"""),
    E0 = (-41.4931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,2950,1000,180,1536.43,1536.46,1536.58,1536.72],'cm^-1')),
        HinderedRotor(inertia=(0.198376,'amu*angstrom^2'), symmetry=1, barrier=(4.56105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.36278,0.0299078,-9.97263e-06,-6.31166e-09,3.71629e-12,-50478.4,17.8694], Tmin=(100,'K'), Tmax=(1120.71,'K')), NASAPolynomial(coeffs=[9.60513,0.0158893,-7.04453e-06,1.36604e-09,-9.76475e-14,-52844.6,-21.2107], Tmin=(1120.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-420.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Cs-Cs(F)-O2s)"""),
)

species(
    label = '[O]C=C(F)C[O](9498)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u1 p2 c0 {4,S}
3 O u1 p2 c0 {6,S}
...
"""),
    E0 = (186.493,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,337.531,337.539,337.642,337.745,769.046,1413.39,1413.54,1861.89],'cm^-1')),
        HinderedRotor(inertia=(0.00147749,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.60025,0.0289341,-2.10693e-05,7.88603e-09,-1.21403e-12,22481.7,16.6158], Tmin=(100,'K'), Tmax=(1495.59,'K')), NASAPolynomial(coeffs=[8.31602,0.0136472,-5.73742e-06,1.05179e-09,-7.16377e-14,20772,-13.2602], Tmin=(1495.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-86.9004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,316,385,515,654,689,1295,2950,1000,3025,407.5,1350,352.5,180,180,1250.07,1250.43],'cm^-1')),
        HinderedRotor(inertia=(0.00449275,'amu*angstrom^2'), symmetry=1, barrier=(5.00234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217793,'amu*angstrom^2'), symmetry=1, barrier=(5.00748,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88231,0.0488965,-6.19033e-05,4.2683e-08,-1.18731e-11,-10377.5,20.0619], Tmin=(100,'K'), Tmax=(875.318,'K')), NASAPolynomial(coeffs=[8.79146,0.0173223,-7.794e-06,1.47045e-09,-1.0199e-13,-11587,-12.3504], Tmin=(875.318,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.9004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Cs(F)(C)-Cs-O2s) + radical(Csj(Cs-F1sO2sCs)(O2s-Cs)(H)_ring) + radical(CCsJOH)"""),
)

species(
    label = '[O][CH]C1(F)CO1(9501)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {5,S}
3 O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21474,0.0442744,-6.39674e-05,5.93326e-08,-2.2288e-11,-9060.42,19.4431], Tmin=(100,'K'), Tmax=(808.466,'K')), NASAPolynomial(coeffs=[3.92248,0.0262501,-1.27608e-05,2.45797e-09,-1.70819e-13,-9023.63,13.5026], Tmin=(808.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.8266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Cs(F)(C)-Cs-O2s) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'FOC[C]1[CH]O1(9502)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
...
"""),
    E0 = (235.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2950,1000,180,180,180,180,180,180,913.916,915.066],'cm^-1')),
        HinderedRotor(inertia=(0.00950842,'amu*angstrom^2'), symmetry=1, barrier=(5.64485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105414,'amu*angstrom^2'), symmetry=1, barrier=(62.5764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30445,0.0581814,-8.06732e-05,5.61971e-08,-1.45357e-11,28371.3,20.6153], Tmin=(100,'K'), Tmax=(1126.55,'K')), NASAPolynomial(coeffs=[11.4296,0.0104106,-1.32844e-06,-7.06847e-11,1.78006e-14,26840.1,-26.1101], Tmin=(1126.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCsJO)"""),
)

species(
    label = '[O]C[C]1OC1F(9483)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {4,S} {6,S}
3 O u1 p2 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC1(F)[CH]O1(9312)'],
    products = ['CH2O(20)', 'FC1=CO1(3064)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]CC1O[C]1F(9313)'],
    products = ['[O]CC1(F)[CH]O1(9312)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C1(F)[CH]O1(9221)'],
    products = ['[O]CC1(F)[CH]O1(9312)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]CC1=CO1(9499)'],
    products = ['[O]CC1(F)[CH]O1(9312)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(33.8656,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](133)', 'FC1=CO1(3064)'],
    products = ['[O]CC1(F)[CH]O1(9312)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2O(20)', 'F[C]1[CH]O1(9215)'],
    products = ['[O]CC1(F)[CH]O1(9312)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=CC1(F)[CH]O1(9439)'],
    products = ['[O]CC1(F)[CH]O1(9312)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](133)', 'F[C]1[CH]O1(9215)'],
    products = ['[O]CC1(F)[CH]O1(9312)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]C=C1[CH]O1(9441)'],
    products = ['[O]CC1(F)[CH]O1(9312)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[CH]C1(F)[CH]O1(9500)'],
    products = ['[O]CC1(F)[CH]O1(9312)'],
...
network(
    label = 'PDepNetwork #3102',
    isomers = [
        '[O]CC1(F)[CH]O1(9312)',
    ],
    reactants = [
        ('CH2O(20)', 'FC1=CO1(3064)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
