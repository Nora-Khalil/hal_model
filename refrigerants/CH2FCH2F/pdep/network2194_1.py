...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])=O(296)', '[CH]C-2(510)'],
    products = ['[CH2]C(=O)O[CH]C(5670)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[C]=O(3466)'],
    products = ['[CH2]C(=O)O[CH]C(5670)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(=O)OC=C(5732)'],
    products = ['[CH2]C(=O)O[CH]C(5670)'],
