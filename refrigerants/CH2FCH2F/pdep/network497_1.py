...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.259983,'amu*angstrom^2'), symmetry=1, barrier=(5.97752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25994,'amu*angstrom^2'), symmetry=1, barrier=(5.97653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0692,'amu*angstrom^2'), symmetry=1, barrier=(24.583,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36233,0.0631147,-9.7273e-05,8.26259e-08,-2.81124e-11,-33400.1,21.814], Tmin=(100,'K'), Tmax=(781.1,'K')), NASAPolynomial(coeffs=[8.48205,0.0224448,-1.10871e-05,2.1662e-09,-1.51884e-13,-34383.9,-9.9535], Tmin=(781.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(H)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.755432,'amu*angstrom^2'), symmetry=1, barrier=(17.3689,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39295,0.0634396,-0.000102393,9.06602e-08,-3.16299e-11,-33903.2,22.5613], Tmin=(100,'K'), Tmax=(814.41,'K')), NASAPolynomial(coeffs=[7.6033,0.0235627,-1.1681e-05,2.27007e-09,-1.58031e-13,-34603.9,-4.21642], Tmin=(814.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'F[CH]O[CH]CF(1075)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-257.078,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,580,1155,1237,1373,3147,241.089,241.615,241.648,2146.26],'cm^-1')),
        HinderedRotor(inertia=(0.299808,'amu*angstrom^2'), symmetry=1, barrier=(12.5668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302329,'amu*angstrom^2'), symmetry=1, barrier=(12.5658,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.833412,'amu*angstrom^2'), symmetry=1, barrier=(34.4743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5199,0.0598659,-9.19872e-05,8.01532e-08,-2.80459e-11,-30835.1,21.9537], Tmin=(100,'K'), Tmax=(788.057,'K')), NASAPolynomial(coeffs=[7.34984,0.024026,-1.18755e-05,2.32039e-09,-1.62689e-13,-31560,-3.55277], Tmin=(788.057,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)

species(
    label = '[CH2][CH]OC(F)F(1088)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29878,0.0634565,-9.44152e-05,7.44656e-08,-2.33043e-11,-37403.1,20.9625], Tmin=(100,'K'), Tmax=(784.915,'K')), NASAPolynomial(coeffs=[10.0952,0.0186227,-8.72408e-06,1.67364e-09,-1.16394e-13,-38783.8,-19.3437], Tmin=(784.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJOCs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', '[CH2]C([O])F(139)'],
    products = ['[CH2]C(F)O[CH]F(1065)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]O[CH]F(1084)'],
    products = ['[CH2]C(F)O[CH]F(1065)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CHFO(47)', '[CH2][CH]F(226)'],
    products = ['[CH2]C(F)O[CH]F(1065)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(1073)', 'CH2CHF(56)'],
    products = ['[CH2]C(F)O[CH]F(1065)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(F)O[CH]F(1086)'],
    products = ['[CH2]C(F)O[CH]F(1065)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]F(1073)', '[CH2][CH]F(226)'],
    products = ['[CH2]C(F)O[CH]F(1065)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]C([O])F(139)'],
    products = ['[CH2]C(F)O[CH]F(1065)'],
