...
reaction(
    label = 'reaction1',
    reactants = ['[O]OO[C](F)F(2146)'],
    products = ['O=O(141)', 'CF2O(49)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](128)', 'F[C]F(744)'],
    products = ['[O]OO[C](F)F(2146)'],
    transitionState = 'TS2',
