...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)OOF(12944)'],
    products = ['O=O(141)', 'HF(38)', 'CF2O(49)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'O[C](F)OOF(2399)'],
    products = ['OC(F)(F)OOF(12944)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[O]OC(O)(F)F(2301)'],
    products = ['OC(F)(F)OOF(12944)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]F(127)', '[O]C(O)(F)F(2300)'],
    products = ['OC(F)(F)OOF(12944)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OF(126)', 'O[C](F)F(1777)'],
    products = ['OC(F)(F)OOF(12944)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(7)', 'FOO[C](F)F(12971)'],
    products = ['OC(F)(F)OOF(12944)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)OOF(12972)'],
    products = ['OC(F)(F)OOF(12944)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'O=C(F)OOF(12562)'],
    products = ['OC(F)(F)OOF(12944)'],
    transitionState = 'TS8',
...
network(
    label = 'PDepNetwork #4304',
    isomers = [
        'OC(F)(F)OOF(12944)',
    ],
    reactants = [
        ('O=O(141)', 'HF(38)', 'CF2O(49)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
