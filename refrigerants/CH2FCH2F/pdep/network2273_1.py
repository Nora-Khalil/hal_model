...
reaction(
    label = 'reaction4',
    reactants = ['O[C]1CC[C](F)O1(6272)'],
    products = ['C=C(O)OC(=C)F(6001)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)OC([CH2])F(6274)'],
    products = ['C=C(O)OC(=C)F(6001)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(O)OC([CH2])F(6275)'],
    products = ['C=C(O)OC(=C)F(6001)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(F)OC([CH2])O(6276)'],
    products = ['C=C(O)OC(=C)F(6001)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=O)O[C](C)F(6277)'],
    products = ['C=C(O)OC(=C)F(6001)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=[C]OC(=C)O(6281)'],
    products = ['C=C(O)OC(=C)F(6001)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2CF(70)', '[CH2]C(=O)O(523)'],
    products = ['C=C(O)OC(=C)F(6001)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(=O)OC(=C)F(673)'],
    products = ['C=C(O)OC(=C)F(6001)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH]=C(O)OC(=C)F(6282)'],
    products = ['C=C(O)OC(=C)F(6001)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH]=C(F)OC(=C)O(6283)'],
    products = ['C=C(O)OC(=C)F(6001)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(25)', 'C=C(O)[O+]=[C-]F(6287)'],
    products = ['C=C(O)OC(=C)F(6001)'],
