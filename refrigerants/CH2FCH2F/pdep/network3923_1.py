...
"""),
    E0 = (-1290.93,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,519,593,830,1115,1166,1389,1413,3114,194.623,194.623,194.623,194.623],'cm^-1')),
        HinderedRotor(inertia=(0.391377,'amu*angstrom^2'), symmetry=1, barrier=(10.5198,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.498689,'amu*angstrom^2'), symmetry=1, barrier=(13.4042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3143,'amu*angstrom^2'), symmetry=1, barrier=(35.3271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391376,'amu*angstrom^2'), symmetry=1, barrier=(10.5198,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.148306,0.0917912,-0.00013408,1.04823e-07,-3.30089e-11,-155131,27.7734], Tmin=(100,'K'), Tmax=(775.364,'K')), NASAPolynomial(coeffs=[11.9962,0.0306671,-1.58267e-05,3.14409e-09,-2.23316e-13,-156968,-26.3712], Tmin=(775.364,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1290.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFFHO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.719811,'amu*angstrom^2'), symmetry=1, barrier=(16.5499,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.719061,'amu*angstrom^2'), symmetry=1, barrier=(16.5326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717811,'amu*angstrom^2'), symmetry=1, barrier=(16.5039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47491,'amu*angstrom^2'), symmetry=1, barrier=(33.9111,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.12146,0.0940217,-0.000162222,1.42267e-07,-4.84855e-11,-112818,28.7955], Tmin=(100,'K'), Tmax=(820.32,'K')), NASAPolynomial(coeffs=[11.5446,0.0255858,-1.37973e-05,2.7191e-09,-1.89458e-13,-114264,-21.4407], Tmin=(820.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-939.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(CsFFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-884.588,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,180],'cm^-1')),
        HinderedRotor(inertia=(1.13359,'amu*angstrom^2'), symmetry=1, barrier=(26.0635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13492,'amu*angstrom^2'), symmetry=1, barrier=(26.094,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.80449,0.0116812,0.00014904,-3.34781e-07,2.119e-10,-106379,10.4638], Tmin=(10,'K'), Tmax=(564.827,'K')), NASAPolynomial(coeffs=[6.92232,0.0335127,-2.55516e-05,8.93056e-09,-1.15287e-12,-107432,-8.99749], Tmin=(564.827,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-884.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), label="""OC(O)(F)CF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.168263,0.0913644,-0.00014011,1.16946e-07,-3.92762e-11,-156565,28.5494], Tmin=(100,'K'), Tmax=(760.406,'K')), NASAPolynomial(coeffs=[11.0323,0.0313311,-1.59968e-05,3.14429e-09,-2.21112e-13,-158134,-20.3393], Tmin=(760.406,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1302.85,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCFFO) + group(CsFFHO)"""),
)

species(
    label = 'OCC(F)(F)OC(F)F(12141)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.168265,0.0913644,-0.00014011,1.16946e-07,-3.92761e-11,-156565,28.5494], Tmin=(100,'K'), Tmax=(760.408,'K')), NASAPolynomial(coeffs=[11.0323,0.0313311,-1.59968e-05,3.14429e-09,-2.21112e-13,-158134,-20.3393], Tmin=(760.408,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1302.85,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsOsHH) + group(CsFFHO)"""),
)
...
"""),
    E0 = (-859.803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,580,1155,1237,1373,3147,213.465,213.466,213.466,213.467],'cm^-1')),
        HinderedRotor(inertia=(0.529618,'amu*angstrom^2'), symmetry=1, barrier=(17.1257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.280324,'amu*angstrom^2'), symmetry=1, barrier=(9.06464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.280322,'amu*angstrom^2'), symmetry=1, barrier=(9.06463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05628,'amu*angstrom^2'), symmetry=1, barrier=(34.1556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.338893,0.0875672,-0.000138888,1.17888e-07,-3.99038e-11,-103285,26.3796], Tmin=(100,'K'), Tmax=(778.638,'K')), NASAPolynomial(coeffs=[10.8465,0.0283412,-1.4685e-05,2.89141e-09,-2.03029e-13,-104763,-20.663], Tmin=(778.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-859.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHHO) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.395978,'amu*angstrom^2'), symmetry=1, barrier=(9.10432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.395148,'amu*angstrom^2'), symmetry=1, barrier=(9.08523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.61559,'amu*angstrom^2'), symmetry=1, barrier=(37.1455,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.350974,0.0876991,-0.00013776,1.18414e-07,-4.09539e-11,-124028,27.8503], Tmin=(100,'K'), Tmax=(763.988,'K')), NASAPolynomial(coeffs=[10.077,0.0313478,-1.64621e-05,3.26715e-09,-2.3079e-13,-125355,-15.4171], Tmin=(763.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1032.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFFHO) + radical(O2sj(Cs-F1sO2sCs))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.35769,'amu*angstrom^2'), symmetry=1, barrier=(31.2161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.506222,'amu*angstrom^2'), symmetry=1, barrier=(11.639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.506396,'amu*angstrom^2'), symmetry=1, barrier=(11.643,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1089.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,519,593,830,1115,1166,1389,1413,3114,334,575,1197,1424,3202,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.310899,'amu*angstrom^2'), symmetry=1, barrier=(7.14817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311565,'amu*angstrom^2'), symmetry=1, barrier=(7.16348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49492,'amu*angstrom^2'), symmetry=1, barrier=(34.3712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.312043,'amu*angstrom^2'), symmetry=1, barrier=(7.17448,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.180092,0.101642,-0.000175447,1.54503e-07,-5.27487e-11,-130946,29.4947], Tmin=(100,'K'), Tmax=(828.026,'K')), NASAPolynomial(coeffs=[11.7485,0.0285945,-1.5179e-05,2.97157e-09,-2.06158e-13,-132393,-22.6102], Tmin=(828.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1089.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFFHO) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)
...
reaction(
    ...
    products = ['OC(F)(CF)OC(F)F(11804)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(25.6826,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'OC(F)(F)OC(F)F(3596)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(168.098,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CF2(43)', 'OC(O)(F)CF(11519)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.5279e-12,'m^3/(mol*s)'), n=5.02686, Ea=(82.5021,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    products = ['OC(F)(CF)OC(F)F(11804)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(10.7471,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction7',
    reactants = ['OC(F)(CF)OC(F)F(11804)'],
    products = ['OC(F)(F)COC(F)F(12140)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)F(1071)', 'OC(F)=CF(3655)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOC(F)F(2153)', 'C=C(O)F(213)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H2O(3)', 'FC=C(F)OC(F)F(2224)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OF(140)', 'C=C(F)OC(F)F(2194)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O[C](CF)OC(F)F(12142)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(O)(F)OC(F)F(12143)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'OC(F)(CF)O[CH]F(11527)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)F(1061)', 'O[C](F)CF(9946)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(82)', '[O]C(O)(F)CF(9948)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OH(7)', 'FC[C](F)OC(F)F(10053)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[O]C(F)(CF)OC(F)F(10544)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2F(46)', 'O[C](F)OC(F)F(3786)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(F)([CH]F)OC(F)F(12144)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'OC(F)(CF)O[C](F)F(10760)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(CF)OC(F)F(3665)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'C=C(O)OC(F)F(3827)'],
    products = ['OC(F)(CF)OC(F)F(11804)'],
...
network(
    label = 'PDepNetwork #3923',
    isomers = [
        'OC(F)(CF)OC(F)F(11804)',
    ],
    reactants = [
