...
"""),
    ...
    molecularWeight = (77.0344,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.82005,0.0166992,1.59553e-05,-4.46619e-08,2.48729e-11,-5663.24,10.0469], Tmin=(10,'K'), Tmax=(676.593,'K')), NASAPolynomial(coeffs=[4.69232,0.0206737,-1.31e-05,3.91418e-09,-4.46232e-13,-5990.28,4.63494], Tmin=(676.593,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-47.0998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), label="""F[CH]C1OO1""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (296.343,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,831.074],'cm^-1')),
        HinderedRotor(inertia=(0.880952,'amu*angstrom^2'), symmetry=1, barrier=(20.2548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55102,'amu*angstrom^2'), symmetry=1, barrier=(35.6611,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0344,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.80417,0.0270285,-2.09904e-05,6.76524e-09,-5.60479e-13,35639.5,10.8466], Tmin=(10,'K'), Tmax=(1178.33,'K')), NASAPolynomial(coeffs=[10.0318,0.0105011,-5.82344e-06,1.50652e-09,-1.49639e-13,33851.6,-21.5787], Tmin=(1178.33,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(296.343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""[CH]DCOOF""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CHFCH[Z](71)'],
    products = ['[O]OC=CF(448)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.62995e+14,'m^3/(mol*s)'), n=-2.27223, Ea=(11.2533,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=C[CH]F(435)'],
    products = ['[O]OC=CF(448)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC=CF(448)'],
    products = ['FC1[CH]OO1(2081)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'C#CO[O](451)'],
    products = ['[O]OC=CF(448)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(298.615,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)

reaction(
    label = 'reaction9',
    reactants = ['[O]OC=CF(448)'],
    products = ['OH(7)', 'O=C=CF(434)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=COOF(2084)'],
    products = ['[O]OC=CF(448)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(61.0904,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)
