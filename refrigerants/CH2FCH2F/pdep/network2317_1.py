...
"""),
    E0 = (-691.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,334,575,1197,1424,3202,580,1155,1237,1373,3147,180,180,180,1399.73],'cm^-1')),
        HinderedRotor(inertia=(0.287007,'amu*angstrom^2'), symmetry=1, barrier=(6.59886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283219,'amu*angstrom^2'), symmetry=1, barrier=(6.51177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.96586,'amu*angstrom^2'), symmetry=1, barrier=(45.199,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.876328,0.0761987,-0.00012804,1.14786e-07,-4.05857e-11,-83011.7,26.4094], Tmin=(100,'K'), Tmax=(791.164,'K')), NASAPolynomial(coeffs=[8.87418,0.0258699,-1.38633e-05,2.77148e-09,-1.95907e-13,-83967.6,-8.34535], Tmin=(791.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-691.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sO2s)(F1s)(H)) + radical(Csj(F1s)(O2s-Cs)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.168162,'amu*angstrom^2'), symmetry=1, barrier=(3.86638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.789089,'amu*angstrom^2'), symmetry=1, barrier=(18.1427,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[CH]F(6120)'],
...
reaction(
    ...
    products = ['F[CH]OC(F)(F)[CH]F(6120)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=CF(1129)'],
    products = ['F[CH]OC(F)(F)[CH]F(6120)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]O[C](F)C(F)F(6195)'],
    products = ['F[CH]OC(F)(F)[CH]F(6120)'],
...
network(
    label = 'PDepNetwork #2317',
    isomers = [
        'F[CH]OC(F)(F)[CH]F(6120)',
    ],
    reactants = [
        ('CHFO(47)', 'CHFCF2(55)'),
    ],
