...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[C](F)F(788)', 'CH3(19)'],
    products = ['CC(F)(F)O[O](537)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)O[O](700)'],
    products = ['CC(F)(F)O[O](537)'],
    transitionState = 'TS9',
