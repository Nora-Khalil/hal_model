...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(514)', '[C]=C(368)'],
    products = ['C=[C]OC([O])=O(565)'],
    transitionState = 'TS2',
