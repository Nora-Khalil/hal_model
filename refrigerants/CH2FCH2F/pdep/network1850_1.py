...
reaction(
    label = 'reaction2',
    reactants = ['H2O(3)', 'F[C]C(F)OF(1513)'],
    products = ['OC(F)C(F)OF(4131)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(140)', 'OC(F)[C]F(1611)'],
    products = ['OC(F)C(F)OF(4131)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'FC=C(F)OF(3648)'],
    products = ['OC(F)C(F)OF(4131)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[CH]C(F)OF(4137)'],
    products = ['OC(F)C(F)OF(4131)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)[CH]OF(4138)'],
    products = ['OC(F)C(F)OF(4131)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(F)C(O)F(4139)'],
    products = ['OC(F)C(F)OF(4131)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'F[CH]C(F)OF(1524)'],
    products = ['OC(F)C(F)OF(4131)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)C(F)OF(4140)'],
    products = ['OC(F)C(F)OF(4131)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(127)', 'OC(F)[CH]F(982)'],
    products = ['OC(F)C(F)OF(4131)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]OF(1060)', 'O[CH]F(459)'],
    products = ['OC(F)C(F)OF(4131)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O[C](F)C(F)OF(3657)'],
    products = ['OC(F)C(F)OF(4131)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)[C](F)OF(3650)'],
    products = ['OC(F)C(F)OF(4131)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC(F)OF(4141)'],
    products = ['OC(F)C(F)OF(4131)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(F)C(O)F(1180)'],
    products = ['OC(F)C(F)OF(4131)'],
