...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)[C](F)F(6121)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', 'F[CH]O[CH]F(1084)'],
    products = ['F[CH]OC(F)[C](F)F(6121)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[CH]OC=C(F)F(1135)'],
    products = ['F[CH]OC(F)[C](F)F(6121)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]OC(F)=C(F)F(6194)'],
    products = ['F[CH]OC(F)[C](F)F(6121)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', 'F[CH]O[CH]F(1084)'],
    products = ['F[CH]OC(F)[C](F)F(6121)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH]OC(F)[C](F)F(6121)'],
    products = ['F[CH]O[C](F)C(F)F(6195)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]OC(F)[C](F)F(6121)'],
    products = ['F[CH]O[CH]C(F)(F)F(2806)'],
