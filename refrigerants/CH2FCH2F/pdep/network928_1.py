...
reaction(
    label = 'reaction3',
    reactants = ['F[C]1CC=[C]O1(5655)'],
    products = ['C#COC(=C)F(1389)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(25)', 'C#C[O+]=[C-]F(5660)'],
    products = ['C#COC(=C)F(1389)'],
