...
"""),
    E0 = (-677.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,1855,455,950,180],'cm^-1')),
        HinderedRotor(inertia=(1.89061,'amu*angstrom^2'), symmetry=1, barrier=(43.469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89043,'amu*angstrom^2'), symmetry=1, barrier=(43.4647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.8908,'amu*angstrom^2'), symmetry=1, barrier=(43.4733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89065,'amu*angstrom^2'), symmetry=1, barrier=(43.4698,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.57432,0.0743777,-8.42922e-05,4.56172e-08,-9.66529e-12,-81352.3,26.1256], Tmin=(100,'K'), Tmax=(1149.1,'K')), NASAPolynomial(coeffs=[17.1972,0.0165138,-8.75841e-06,1.7952e-09,-1.31316e-13,-85172.5,-56.3804], Tmin=(1149.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-677.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-OdOsH) + radical(CCsJOOC) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-626.792,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,1855,455,950,180],'cm^-1')),
        HinderedRotor(inertia=(1.79829,'amu*angstrom^2'), symmetry=1, barrier=(41.3463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79823,'amu*angstrom^2'), symmetry=1, barrier=(41.3448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79799,'amu*angstrom^2'), symmetry=1, barrier=(41.3394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7984,'amu*angstrom^2'), symmetry=1, barrier=(41.3488,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.313648,0.0742855,-7.90756e-05,3.88386e-08,-7.35472e-12,-75247.3,29.054], Tmin=(100,'K'), Tmax=(1292.36,'K')), NASAPolynomial(coeffs=[20.5567,0.0116308,-6.35416e-06,1.32502e-09,-9.79033e-14,-80479.6,-73.7989], Tmin=(1292.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-626.792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdOsH) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical((O)CJOC)"""),
)

species(
    label = 'O=C(F)OO[CH][C](F)F(6999)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-658.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,190,488,555,1236,1407,482,664,788,1296,1923,234.473,234.474],'cm^-1')),
        HinderedRotor(inertia=(1.01424,'amu*angstrom^2'), symmetry=1, barrier=(39.5693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01424,'amu*angstrom^2'), symmetry=1, barrier=(39.569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01424,'amu*angstrom^2'), symmetry=1, barrier=(39.5691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01421,'amu*angstrom^2'), symmetry=1, barrier=(39.569,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.561466,0.0757205,-8.90328e-05,4.97358e-08,-1.08608e-11,-79134.5,29.2683], Tmin=(100,'K'), Tmax=(1116.61,'K')), NASAPolynomial(coeffs=[17.2366,0.0159865,-8.79009e-06,1.82785e-09,-1.34704e-13,-82858.5,-53.0189], Tmin=(1116.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-658.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(COFOO) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OO[CH]C(F)(F)F(6690)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(513)', '[CH]C(F)(F)F(1545)'],
    products = ['O=[C]OO[CH]C(F)(F)F(6690)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[O]O[CH]C(F)(F)F(2887)'],
    products = ['O=[C]OO[CH]C(F)(F)F(6690)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]O[CH]C(F)(F)F(2887)'],
    products = ['O=[C]OO[CH]C(F)(F)F(6690)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(9.33845,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)
...
reaction(
    ...
    products = ['O=[C]OO[CH]C(F)(F)F(6690)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(106.944,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
...
reaction(
    ...
    products = ['O=[C]OO[CH]C(F)(F)F(6690)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(224.775,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0
Ea raised from 222.6 to 224.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]OOC=C(F)F(2311)'],
    products = ['O=[C]OO[CH]C(F)(F)F(6690)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['O=[C]OO[CH]C(F)(F)F(6690)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.47663e+07,'m^3/(mol*s)'), n=1.31229e-07, Ea=(3.14237,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['O=[C]OOC(F)[C](F)F(6998)'],
    products = ['O=[C]OO[CH]C(F)(F)F(6690)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(F)OO[CH][C](F)F(6999)'],
    products = ['O=[C]OO[CH]C(F)(F)F(6690)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(189.04,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #2448',
    isomers = [
        'O=[C]OO[CH]C(F)(F)F(6690)',
    ],
    reactants = [
        ('CO2(14)', 'CF3CHO(75)'),
    ],
