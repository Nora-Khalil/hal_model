...
"""),
    E0 = (-1168.07,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,250,417,511,1155,1315,1456,3119,375,361,584,565,722,1474,235,523,627,1123,1142,1372,1406,3097,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.691291,'amu*angstrom^2'), symmetry=1, barrier=(15.8941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54228,'amu*angstrom^2'), symmetry=1, barrier=(35.46,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.691415,'amu*angstrom^2'), symmetry=1, barrier=(15.897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.691596,'amu*angstrom^2'), symmetry=1, barrier=(15.9012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (166.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.560077,0.107767,-0.000162904,1.24346e-07,-3.74564e-11,-140329,29.9915], Tmin=(100,'K'), Tmax=(815.23,'K')), NASAPolynomial(coeffs=[15.8913,0.0270445,-1.43702e-05,2.87622e-09,-2.04836e-13,-143011,-46.0153], Tmin=(815.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1168.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F))"""),
)

species(
    label = 'OC(F)(F)C(F)C(F)OF(5569)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
10 C u0 p0 c0 {4,S} {6,S} {8,S} {12,S}
11 H u0 p0 c0 {8,S}
12 H u0 p0 c0 {10,S}
13 H u0 p0 c0 {7,S}
"""),
    E0 = (-1169.52,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,250,417,511,1155,1315,1456,3119,223,363,546,575,694,1179,1410,261,493,600,1152,1365,1422,3097,294.477,296.294,296.7],'cm^-1')),
        HinderedRotor(inertia=(0.20882,'amu*angstrom^2'), symmetry=1, barrier=(13.1016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211779,'amu*angstrom^2'), symmetry=1, barrier=(13.0695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.406708,'amu*angstrom^2'), symmetry=1, barrier=(25.2203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.513994,'amu*angstrom^2'), symmetry=1, barrier=(31.9285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (166.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.186202,0.0977492,-0.000130652,8.752e-08,-2.32323e-11,-140514,29.2651], Tmin=(100,'K'), Tmax=(919.779,'K')), NASAPolynomial(coeffs=[16.2975,0.0260641,-1.37468e-05,2.78653e-09,-2.01537e-13,-143547,-48.8811], Tmin=(919.779,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1169.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (-806.841,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,182,240,577,636,1210,1413,323.096,324.052],'cm^-1')),
        HinderedRotor(inertia=(0.00162479,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00163204,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.33963,0.0704918,-0.000162203,2.59455e-07,-1.77285e-10,-97043.4,13.9408], Tmin=(10,'K'), Tmax=(354.084,'K')), NASAPolynomial(coeffs=[6.10614,0.0392391,-2.98076e-05,1.0181e-08,-1.28534e-12,-97239.3,3.46619], Tmin=(354.084,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-806.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""FOC(DC(F)F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-773.009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,334,575,1197,1424,3202,286.115,286.658,287.02],'cm^-1')),
        HinderedRotor(inertia=(0.15674,'amu*angstrom^2'), symmetry=1, barrier=(9.13929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156264,'amu*angstrom^2'), symmetry=1, barrier=(9.13223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156769,'amu*angstrom^2'), symmetry=1, barrier=(9.14419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.529078,'amu*angstrom^2'), symmetry=1, barrier=(30.8489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.350976,0.10546,-0.000182908,1.60316e-07,-5.45042e-11,-92824.2,29.849], Tmin=(100,'K'), Tmax=(822.491,'K')), NASAPolynomial(coeffs=[12.6547,0.0278112,-1.50369e-05,2.96359e-09,-2.06354e-13,-94476.6,-27.3933], Tmin=(822.491,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-773.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)

species(
    label = '[O]C(C(F)F)C(O)(F)F(5574)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1093.22,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,235,523,627,1123,1142,1372,1406,3097,206.569,206.589,206.59],'cm^-1')),
        HinderedRotor(inertia=(0.537958,'amu*angstrom^2'), symmetry=1, barrier=(16.2864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00395045,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.537846,'amu*angstrom^2'), symmetry=1, barrier=(16.2868,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.263276,0.0878025,-0.000122666,8.73458e-08,-2.46859e-11,-131354,27.7603], Tmin=(100,'K'), Tmax=(865.508,'K')), NASAPolynomial(coeffs=[14.015,0.0242476,-1.25192e-05,2.50335e-09,-1.79171e-13,-133735,-36.5973], Tmin=(865.508,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1093.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFFH) + radical(CC(C)OJ)"""),
)
...
"""),
    E0 = (-1199.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,251,367,519,700,855,1175,1303,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,240.511,240.511],'cm^-1')),
        HinderedRotor(inertia=(0.174483,'amu*angstrom^2'), symmetry=1, barrier=(7.16224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368557,'amu*angstrom^2'), symmetry=1, barrier=(15.1287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174483,'amu*angstrom^2'), symmetry=1, barrier=(7.16224,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-790.895,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,326,540,652,719,1357,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.118703,'amu*angstrom^2'), symmetry=1, barrier=(2.72921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118758,'amu*angstrom^2'), symmetry=1, barrier=(2.73048,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24276,'amu*angstrom^2'), symmetry=1, barrier=(51.5655,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.2207,0.0956869,-0.000176329,1.66569e-07,-6.01573e-11,-94998.8,26.8845], Tmin=(100,'K'), Tmax=(831.337,'K')), NASAPolynomial(coeffs=[7.98642,0.0332462,-1.84213e-05,3.65713e-09,-2.55289e-13,-95423.5,-3.93452], Tmin=(831.337,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-790.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(OF)C(F)F(5529)'],
    products = ['HF(38)', 'CF2O(49)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(OF)C(F)F(4136)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(200.101,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OF(140)', 'F[C]C(OF)C(F)F(5302)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(43)', 'OC(F)(F)COF(4117)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(129.508,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'OC(F)(F)C([C]F)OF(5568)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(145.178,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction7',
    reactants = ['OC(F)(OF)C(F)C(F)F(5555)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OC(F)(F)C(F)C(F)OF(5569)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+13,'s^-1'), n=0, Ea=(299,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [OF]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(1520)', 'OC(F)=CC(F)F(5570)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(140)', 'OC(F)(F)C=C(F)F(2209)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FOF(1520)', 'OC(F)(F)C=CF(2189)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H2O(3)', 'FOC(=C(F)F)C(F)F(5571)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OC(F)F(1071)', 'FOC=C(F)F(1650)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O[C](F)C(OF)C(F)F(5572)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'OC(F)(F)C([CH]F)OF(5573)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(C(F)F)C(O)(F)F(5574)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(127)', 'OC(F)(F)[CH]C(F)F(5575)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OH(7)', 'FOC([C](F)F)C(F)F(5326)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[O]C(F)(F)C(OF)C(F)F(5576)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O[C](F)F(1777)', 'FO[CH]C(F)F(4702)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CHF2(82)', 'OC(F)(F)[CH]OF(3656)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'OC(F)(F)[C](OF)C(F)F(5577)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'OC(F)(F)C(OF)[C](F)F(5578)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'O=C(F)C(OF)C(F)F(5579)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'O=C(C(F)F)C(O)(F)F(5117)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(433.37,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'OC(F)=C(OF)C(F)F(5580)'],
    products = ['OC(F)(F)C(OF)C(F)F(5529)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(172.538,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)
...
network(
    ...
    isomers = [
        'OC(F)(F)C(OF)C(F)F(5529)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(49)', 'O=CC(F)F(990)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
