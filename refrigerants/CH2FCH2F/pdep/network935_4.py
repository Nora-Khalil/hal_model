...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'FC1=C(F)[CH]1(7336)'],
    products = ['FC1=CC1(F)F(2014)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC1(F)[C]=C1(5605)'],
    products = ['FC1=CC1(F)F(2014)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC1=[C]C1(F)F(7337)'],
    products = ['FC1=CC1(F)F(2014)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'FC1=C=C1F(7339)'],
    products = ['FC1=CC1(F)F(2014)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1(F)C#C1(7340)'],
    products = ['FC1=CC1(F)F(2014)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[CH]=C=[C]F(7341)'],
    products = ['[CH]C(F)=C(F)F(1996)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]F(744)', '[CH]=[C]F(465)'],
    products = ['[CH]C(F)=C(F)F(1996)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'F[C]=C=[C]F(7368)'],
    products = ['F[C]C=C(F)F(1991)'],
