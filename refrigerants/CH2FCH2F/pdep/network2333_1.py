...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)(F)[CH]F(6292)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C(F)(F)[CH]F(2198)'],
    products = ['O=[C]OC(F)(F)[CH]F(6292)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'O=[C]O[C](F)F(1040)'],
    products = ['O=[C]OC(F)(F)[CH]F(6292)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C(F)(F)[CH]F(2198)'],
    products = ['O=[C]OC(F)(F)[CH]F(6292)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=CF(1500)'],
    products = ['O=[C]OC(F)(F)[CH]F(6292)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', 'O=[C]O[C](F)F(1040)'],
    products = ['O=[C]OC(F)(F)[CH]F(6292)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]O[C](F)C(F)F(6435)'],
    products = ['O=[C]OC(F)(F)[CH]F(6292)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OC(F)(F)[CH]F(6292)'],
    products = ['O=C(F)O[C](F)[CH]F(6438)'],
...
network(
    label = 'PDepNetwork #2333',
    isomers = [
        'O=[C]OC(F)(F)[CH]F(6292)',
    ],
    reactants = [
        ('CO2(14)', 'CHFCF2(55)'),
    ],
