...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C=C(C)OF(2585)'],
    products = ['C=C(OF)C(C)=O(6005)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(=O)C(C)=O(5743)'],
    products = ['C=C(OF)C(C)=O(6005)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(127)', 'C=C=C(C)[O](6055)'],
    products = ['C=C(OF)C(C)=O(6005)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'C=C([C]=O)OF(4306)'],
    products = ['C=C(OF)C(C)=O(6005)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=C([O])C(=C)OF(6056)'],
    products = ['C=C(OF)C(C)=O(6005)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)C(C)=O(6057)'],
    products = ['C=C(OF)C(C)=O(6005)'],
