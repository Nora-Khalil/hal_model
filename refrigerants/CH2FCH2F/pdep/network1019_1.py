...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(F)=C(F)F(1996)'],
    products = ['[CH]=C(F)C([O])(F)F(2181)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=C(F)C(=O)F(1559)'],
    products = ['[CH]=C(F)C([O])(F)F(2181)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C#CC([O])(F)F(2295)'],
    products = ['[CH]=C(F)C([O])(F)F(2181)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F2(78)', '[CH]=C=C([O])F(2119)'],
    products = ['[CH]=C(F)C([O])(F)F(2181)'],
    transitionState = 'TS9',
