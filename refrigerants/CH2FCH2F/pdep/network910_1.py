...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.9029,0.00577124,0.000123786,-2.44154e-07,1.45162e-10,-34562.1,10.4898], Tmin=(10,'K'), Tmax=(552.747,'K')), NASAPolynomial(coeffs=[2.10915,0.0402056,-2.78782e-05,8.98578e-09,-1.08828e-12,-34691.5,15.1155], Tmin=(552.747,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-287.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), label="""FCDCCDCF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (101.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,1685,370,167,640,1190,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.21596,'amu*angstrom^2'), symmetry=1, barrier=(4.96536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217296,'amu*angstrom^2'), symmetry=1, barrier=(4.99606,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91354,0.0512702,-7.53274e-05,6.91412e-08,-2.58789e-11,12220.1,21.0214], Tmin=(100,'K'), Tmax=(781.623,'K')), NASAPolynomial(coeffs=[4.88491,0.0275979,-1.36511e-05,2.67824e-09,-1.88608e-13,12014.2,9.07267], Tmin=(781.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[CH]C=C[CH]F(888)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'C=C[C]F(1939)'],
    products = ['F[C]=CC[CH]F(1932)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['F[C]=CC[CH]F(1932)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(9.67788,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]=CC=CF(1942)'],
    products = ['F[C]=CC[CH]F(1932)'],
    transitionState = 'TS7',
