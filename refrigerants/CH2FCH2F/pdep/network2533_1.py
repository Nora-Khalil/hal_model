...
"""),
    E0 = (-1046.74,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,205,317,423,563,514,686,1105,1199,1293,1437,1381,1463,3031,3163,548,1085,1183,1302,1466,1520,3060,3119,289.717,289.882,290.537,1850.49],'cm^-1')),
        HinderedRotor(inertia=(0.226699,'amu*angstrom^2'), symmetry=1, barrier=(13.5957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417203,'amu*angstrom^2'), symmetry=1, barrier=(25.0341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.415928,'amu*angstrom^2'), symmetry=1, barrier=(24.8977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.419745,'amu*angstrom^2'), symmetry=1, barrier=(25.0136,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07706,0.0671966,-6.50191e-05,3.25463e-08,-6.70907e-12,-125791,24.671], Tmin=(100,'K'), Tmax=(1142.97,'K')), NASAPolynomial(coeffs=[12.1852,0.0283222,-1.40018e-05,2.78932e-09,-2.00412e-13,-128330,-30.4038], Tmin=(1142.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1046.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHHO)"""),
)
...
"""),
    E0 = (-658.526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,277.853,277.857,1220.96],'cm^-1')),
        HinderedRotor(inertia=(0.278921,'amu*angstrom^2'), symmetry=1, barrier=(15.2805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144529,'amu*angstrom^2'), symmetry=1, barrier=(7.91972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0144445,'amu*angstrom^2'), symmetry=1, barrier=(15.2807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144589,'amu*angstrom^2'), symmetry=1, barrier=(7.91967,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
...
"""),
    E0 = (-855.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,522,611,926,1093,1137,1374,1416,3112,548,1085,1183,1302,1466,1520,3060,3119,360,370,350,267.591,276.32,291.944,1621.34],'cm^-1')),
        HinderedRotor(inertia=(0.188747,'amu*angstrom^2'), symmetry=1, barrier=(9.7659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201185,'amu*angstrom^2'), symmetry=1, barrier=(9.75394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204591,'amu*angstrom^2'), symmetry=1, barrier=(9.77925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.456484,'amu*angstrom^2'), symmetry=1, barrier=(22.5326,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789383,0.0769587,-0.00011126,8.89248e-08,-2.89913e-11,-102782,27.866], Tmin=(100,'K'), Tmax=(746.488,'K')), NASAPolynomial(coeffs=[9.72397,0.0290813,-1.50508e-05,2.99956e-09,-2.13563e-13,-104116,-12.6257], Tmin=(746.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-855.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFHHO) + radical(Cs_P)"""),
)

species(
    label = 'OC(OCF)[C](F)F(7397)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-853.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,548,1085,1183,1302,1466,1520,3060,3119,190,488,555,1236,1407,330.116,330.121,330.121,2105.77],'cm^-1')),
        HinderedRotor(inertia=(0.101483,'amu*angstrom^2'), symmetry=1, barrier=(7.84813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101483,'amu*angstrom^2'), symmetry=1, barrier=(7.84809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101484,'amu*angstrom^2'), symmetry=1, barrier=(7.84818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.345607,'amu*angstrom^2'), symmetry=1, barrier=(26.7267,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.716128,0.0804239,-0.000130788,1.17878e-07,-4.21007e-11,-102496,28.9385], Tmin=(100,'K'), Tmax=(802.247,'K')), NASAPolynomial(coeffs=[7.85503,0.0321089,-1.66667e-05,3.2787e-09,-2.29743e-13,-103232,-1.37839], Tmin=(802.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-853.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFHHO) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)
...
reaction(
    ...
    products = ['OC(OCF)C(F)F(6737)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(153.065,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'OC(O)C(F)F(6564)'],
    products = ['OC(OCF)C(F)F(6737)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.34896e-06,'m^3/(mol*s)'), n=3.15288, Ea=(1.68821,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node OH_2Br1sCl1sF1sHI1s->H
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    products = ['OC(OCF)C(F)F(6737)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(6.63811,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction7',
    reactants = ['OC(F)C(F)OCF(7393)'],
    products = ['OC(OCF)C(F)F(6737)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OCF(190)', 'OC=C(F)F(1567)'],
    products = ['OC(OCF)C(F)F(6737)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H2O(3)', 'FCOC=C(F)F(1134)'],
    products = ['OC(OCF)C(F)F(6737)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC([CH]F)OCF(7394)'],
    products = ['OC(OCF)C(F)F(6737)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]OC(O)C(F)F(7395)'],
    products = ['OC(OCF)C(F)F(6737)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]CF(180)', 'O[CH]C(F)F(1906)'],
    products = ['OC(OCF)C(F)F(6737)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2F(46)', '[O]C(O)C(F)F(4954)'],
    products = ['OC(OCF)C(F)F(6737)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'FCO[CH]C(F)F(4720)'],
    products = ['OC(OCF)C(F)F(6737)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(OCF)C(F)F(6036)'],
    products = ['OC(OCF)C(F)F(6737)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF2(82)', 'O[CH]OCF(4550)'],
    products = ['OC(OCF)C(F)F(6737)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O[C](OCF)C(F)F(7396)'],
    products = ['OC(OCF)C(F)F(6737)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'OC(OCF)[C](F)F(7397)'],
    products = ['OC(OCF)C(F)F(6737)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(O[CH]F)C(F)F(6567)'],
    products = ['OC(OCF)C(F)F(6737)'],
