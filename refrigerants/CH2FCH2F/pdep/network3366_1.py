...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]O[O](418)', 'F[C]CF-2(467)'],
    products = ['[CH2]OO[C](F)CF(9967)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]O[C](F)CF(501)'],
    products = ['[CH2]OO[C](F)CF(9967)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]OOC(=C)F(624)'],
    products = ['[CH2]OO[C](F)CF(9967)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]O[O](418)', 'F[C]CF(125)'],
    products = ['[CH2]OO[C](F)CF(9967)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OO[C](F)CF(9967)'],
    products = ['[CH2]OOC([CH2])(F)F(10298)'],
