...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(427)', '[C]=C(368)'],
    products = ['[CH]=C(F)O[C]=C(2003)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)OC#C(2040)'],
    products = ['[CH]=C(F)O[C]=C(2003)'],
    transitionState = 'TS7',
