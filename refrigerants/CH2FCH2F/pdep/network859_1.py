...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])F(139)'],
    products = ['[O]CC([O])F(1409)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(1073)', '[CH2][O](133)'],
    products = ['[O]CC([O])F(1409)'],
