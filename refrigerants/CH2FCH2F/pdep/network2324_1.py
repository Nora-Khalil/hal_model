...
"""),
    E0 = (-452.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,190,488,555,1236,1407,180,180,1628],'cm^-1')),
        HinderedRotor(inertia=(0.236824,'amu*angstrom^2'), symmetry=1, barrier=(5.44506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234933,'amu*angstrom^2'), symmetry=1, barrier=(5.40158,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237115,'amu*angstrom^2'), symmetry=1, barrier=(5.45175,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40477,0.0671025,-0.000120899,1.19205e-07,-4.49991e-11,-54332.9,24.141], Tmin=(100,'K'), Tmax=(822.654,'K')), NASAPolynomial(coeffs=[4.42145,0.0311778,-1.66361e-05,3.30213e-09,-2.31644e-13,-54110,14.5479], Tmin=(822.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-452.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C(F)[C](F)F(1163)'],
    products = ['[CH2]OC(F)[C](F)F(6240)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH2]O[CH]F(318)'],
    products = ['[CH2]OC(F)[C](F)F(6240)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C(F)F(927)'],
    products = ['[CH2]OC(F)[C](F)F(6240)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=C(F)F(6242)'],
    products = ['[CH2]OC(F)[C](F)F(6240)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]O[CH]F(318)'],
    products = ['[CH2]OC(F)[C](F)F(6240)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OC(F)[C](F)F(6240)'],
    products = ['[CH2]O[CH]C(F)(F)F(2788)'],
