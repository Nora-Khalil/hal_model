species(
    label = '[CH2]C(F)(F)C(F)(F)[C]=CF(7489)',
...
"""),
    E0 = (-440.22,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,145,326,398,834,1303,3000,3100,440,815,1455,1000,113,247,382,1207,3490,540,610,2055,1733.91],'cm^-1')),
        HinderedRotor(inertia=(0.150119,'amu*angstrom^2'), symmetry=1, barrier=(3.45153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146741,'amu*angstrom^2'), symmetry=1, barrier=(3.37385,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.226197,0.0915309,-0.000150578,1.32493e-07,-4.59586e-11,-52818.6,27.4456], Tmin=(100,'K'), Tmax=(806.868,'K')), NASAPolynomial(coeffs=[9.99631,0.0311796,-1.62293e-05,3.18497e-09,-2.22514e-13,-54007.3,-15.1891], Tmin=(806.868,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-440.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(Cs-CsHHH) + group(CdCddCF) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.970347,'amu*angstrom^2'), symmetry=1, barrier=(22.3102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410611,'amu*angstrom^2'), symmetry=1, barrier=(9.44075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.76603,'amu*angstrom^2'), symmetry=1, barrier=(63.5966,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0959459,0.0961802,-0.000152029,1.23336e-07,-3.91605e-11,-60263.9,26.5677], Tmin=(100,'K'), Tmax=(830.074,'K')), NASAPolynomial(coeffs=[13.6281,0.0242679,-1.16365e-05,2.19441e-09,-1.49584e-13,-62343.2,-35.8877], Tmin=(830.074,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-502.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
species(
    label = '[CH2]C(F)(F)C(F)(F)C#CF(7763)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.347578,'amu*angstrom^2'), symmetry=1, barrier=(7.99149,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00299213,'amu*angstrom^2'), symmetry=1, barrier=(7.9701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13588,'amu*angstrom^2'), symmetry=1, barrier=(49.108,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.328719,0.105347,-0.000182186,1.60034e-07,-5.42447e-11,-72258.5,29.7227], Tmin=(100,'K'), Tmax=(841.23,'K')), NASAPolynomial(coeffs=[11.9995,0.0292099,-1.51904e-05,2.93826e-09,-2.02057e-13,-73712.9,-23.9383], Tmin=(841.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-602.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsHHH) + group(Ct-CtCs) + group(CtCF) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
species(
    label = '[CH2]C(F)(F)C(F)(F)C=[C]F(7764)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.462129,0.107027,-0.000176074,1.50987e-07,-5.1008e-11,-73197.5,31.6085], Tmin=(100,'K'), Tmax=(799.38,'K')), NASAPolynomial(coeffs=[12.8043,0.0313,-1.64418e-05,3.23446e-09,-2.26211e-13,-75020,-27.5562], Tmin=(799.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-609.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'CC(F)(F)C(F)(F)[C]=[C]F(7765)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.358458,'amu*angstrom^2'), symmetry=1, barrier=(8.24165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.359833,'amu*angstrom^2'), symmetry=1, barrier=(8.27327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357435,'amu*angstrom^2'), symmetry=1, barrier=(8.21812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.338313,0.105597,-0.000177818,1.57728e-07,-5.48711e-11,-67530.4,31.0725], Tmin=(100,'K'), Tmax=(809.212,'K')), NASAPolynomial(coeffs=[11.0719,0.0343531,-1.82453e-05,3.59936e-09,-2.51829e-13,-68891.2,-18.5573], Tmin=(809.212,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-562.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'FC=[C]C(F)(F)[C](F)CF(7752)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.208823,'amu*angstrom^2'), symmetry=1, barrier=(4.80126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209403,'amu*angstrom^2'), symmetry=1, barrier=(4.81459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11635,'amu*angstrom^2'), symmetry=1, barrier=(25.667,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.18895,0.102302,-0.000170892,1.53065e-07,-5.40374e-11,-69198.7,33.2094], Tmin=(100,'K'), Tmax=(801.327,'K')), NASAPolynomial(coeffs=[10.0972,0.0361259,-1.92546e-05,3.81388e-09,-2.67839e-13,-70371.1,-11.166], Tmin=(801.327,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-576.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(CdCFH) + radical(CsCsCsF1s) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH))"""),
)

species(
    label = '[CH2][C](F)C(F)(F)C(F)=CF(7766)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.481185,0.111391,-0.000197909,1.80537e-07,-6.32045e-11,-74636.7,32.8561], Tmin=(100,'K'), Tmax=(841.404,'K')), NASAPolynomial(coeffs=[10.2169,0.0357492,-1.88759e-05,3.67671e-09,-2.53827e-13,-75559.7,-11.6952], Tmin=(841.404,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-621.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'F[CH][C]=C(F)C(F)(F)CF(7767)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.127101,0.0985911,-0.000146895,1.16572e-07,-3.72193e-11,-76293.8,29.852], Tmin=(100,'K'), Tmax=(765.264,'K')), NASAPolynomial(coeffs=[12.5486,0.0323276,-1.69958e-05,3.3944e-09,-2.41578e-13,-78233.6,-27.9084], Tmin=(765.264,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-635.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsCFHH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-CsF1s))"""),
)

species(
    label = '[CH2]C(F)(F)[C](F)C(F)=CF(7768)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.737665,'amu*angstrom^2'), symmetry=1, barrier=(16.9604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.737506,'amu*angstrom^2'), symmetry=1, barrier=(16.9567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.738154,'amu*angstrom^2'), symmetry=1, barrier=(16.9716,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.448019,0.106468,-0.000173129,1.47529e-07,-4.98335e-11,-67155.5,31.644], Tmin=(100,'K'), Tmax=(780.53,'K')), NASAPolynomial(coeffs=[12.8987,0.0315838,-1.67525e-05,3.31873e-09,-2.33455e-13,-69041.4,-28.1736], Tmin=(780.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-559.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sF1sCs)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)C(F)(F)C([CH2])(F)F(7770)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0935566,'amu*angstrom^2'), symmetry=1, barrier=(2.15105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0936069,'amu*angstrom^2'), symmetry=1, barrier=(2.15221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.499905,'amu*angstrom^2'), symmetry=1, barrier=(11.4938,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.581436,0.109181,-0.000178412,1.50432e-07,-4.98726e-11,-72222,31.446], Tmin=(100,'K'), Tmax=(802.655,'K')), NASAPolynomial(coeffs=[13.8127,0.0297006,-1.53987e-05,3.00956e-09,-2.09615e-13,-74283.1,-33.2781], Tmin=(802.655,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-601.792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cs-CsHHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
    products = ['FC=[C]C(F)(F)C[C](F)F(7492)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'FC=[C]C(F)(F)[C](F)F(7760)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=CF(1054)', '[CH2]C(F)(F)[C](F)F(804)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_ter_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C(F)(F)[C]=CF(7643)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)=C=CF(7761)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C#CC(F)(F)C([CH2])(F)F(7762)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)(F)C#CF(7763)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[CH2]C(F)=C(F)[C]=CF(7648)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
    products = ['[CH2]C(F)(F)C(F)(F)C=[C]F(7764)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC(F)(F)C(F)(F)[C]=[C]F(7765)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC=[C]C(F)(F)[C](F)CF(7752)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
    products = ['[CH2][C](F)C(F)(F)C(F)=CF(7766)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
    products = ['F[CH][C]=C(F)C(F)(F)CF(7767)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
    products = ['[CH2]C(F)(F)[C](F)C(F)=CF(7768)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=[C]C(F)(F)C(F)(F)CF(7769)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=C(F)C(F)(F)C([CH2])(F)F(7770)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C]=CF(7489)'],
