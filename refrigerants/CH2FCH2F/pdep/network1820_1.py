...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', '[CH2]C(=C)OF(2610)'],
    products = ['C=C(CO)OF(4103)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(=CO)OF(4185)'],
    products = ['C=C(CO)OF(4103)'],
