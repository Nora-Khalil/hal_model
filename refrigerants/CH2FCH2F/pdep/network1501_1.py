...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[CH]=C[O](134)'],
    products = ['[CH]=CO[C](F)F(3252)'],
    transitionState = 'TS2',
