...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.03696,'amu*angstrom^2'), symmetry=1, barrier=(23.8416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03697,'amu*angstrom^2'), symmetry=1, barrier=(23.8419,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.571329,0.0790206,-0.000103904,6.80804e-08,-1.75977e-11,-37594.4,24.8066], Tmin=(100,'K'), Tmax=(946.006,'K')), NASAPolynomial(coeffs=[14.5476,0.0199253,-1.02027e-05,2.04804e-09,-1.47534e-13,-40238.8,-41.8451], Tmin=(946.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (-305.017,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,293,496,537,1218,194,682,905,1196,1383,3221,3120,650,792.5,1650,180,180,1193.49],'cm^-1')),
        HinderedRotor(inertia=(0.181516,'amu*angstrom^2'), symmetry=1, barrier=(4.17341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180452,'amu*angstrom^2'), symmetry=1, barrier=(4.14894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.987766,0.0758552,-0.000133457,1.25871e-07,-4.5927e-11,-36585.9,25.5499], Tmin=(100,'K'), Tmax=(822.231,'K')), NASAPolynomial(coeffs=[6.50084,0.0303354,-1.63013e-05,3.22134e-09,-2.25182e-13,-36860.4,3.87546], Tmin=(822.231,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFO) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)O[C](F)CF(10040)'],
    products = ['C2HF(58)', 'O=C(F)CF(476)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(9628)', 'F[C]CF-2(467)'],
    products = ['[CH]=C(F)O[C](F)CF(10040)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=C(F)O[C](F)CF(10040)'],
    products = ['FCC1(F)C=C(F)O1(10349)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=[C]F(465)', 'O=C(F)CF(476)'],
    products = ['[CH]=C(F)O[C](F)CF(10040)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)OC(=C)F(2011)'],
    products = ['[CH]=C(F)O[C](F)CF(10040)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)OC(F)=CF(10359)'],
    products = ['[CH]=C(F)O[C](F)CF(10040)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CO[C](F)CF(3846)'],
    products = ['[CH]=C(F)O[C](F)CF(10040)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2HF(58)', '[O][C](F)CF(478)'],
    products = ['[CH]=C(F)O[C](F)CF(10040)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[C]F(465)', '[O][C](F)CF(478)'],
    products = ['[CH]=C(F)O[C](F)CF(10040)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C(=O)F(9628)', 'F[C]CF(125)'],
    products = ['[CH]=C(F)O[C](F)CF(10040)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(F)O[C](F)CF(10040)'],
    products = ['[CH]=C(F)OC([CH2])(F)F(10360)'],
...
network(
    ...
    isomers = [
        '[CH]=C(F)O[C](F)CF(10040)',
    ],
    reactants = [
        ('C2HF(58)', 'O=C(F)CF(476)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
