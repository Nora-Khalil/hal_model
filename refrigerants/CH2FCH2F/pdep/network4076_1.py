...
"""),
    E0 = (94.7754,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,212,367,445,1450,2950,1000,2565.8,2565.82],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.59078,0.0164986,-4.2308e-06,-1.37354e-09,4.87134e-13,11406.8,16.0753], Tmin=(100,'K'), Tmax=(1986.86,'K')), NASAPolynomial(coeffs=[10.7981,0.00995807,-5.3097e-06,1.00731e-09,-6.64657e-14,6969.8,-27.6028], Tmin=(1986.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.7754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsCsF1s) + radical(cyclopropane) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[C]1C[C]1F(12565)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {5,S}
...
"""),
    E0 = (59.3367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,165,259,333,401,397,493,1395,1505,2265.34,2265.34,2265.35],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.73006,0.0172538,-6.18354e-06,-3.44509e-11,2.01657e-13,7135.61,15.2106], Tmin=(100,'K'), Tmax=(2242.79,'K')), NASAPolynomial(coeffs=[14.2954,0.00588349,-3.57694e-06,6.76384e-10,-4.31816e-14,516.956,-48.485], Tmin=(2242.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.3367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsCsF1s) + radical(CsCsCsF1s) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (132.179,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,246,474,533,1155,547.629],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0367,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.9446,0.00323263,6.51786e-05,-1.27441e-07,7.43184e-11,15900.5,10.5884], Tmin=(10,'K'), Tmax=(571.402,'K')), NASAPolynomial(coeffs=[3.22172,0.021004,-1.48411e-05,4.85018e-09,-5.9475e-13,15775.6,11.8556], Tmin=(571.402,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(132.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), label="""FC1D[C]C1F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'FC1[C]C1F(12568)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {4,S}
3 C u0 p0 c0 {1,S} {4,S} {5,S} {6,S}
...
"""),
    E0 = (97.7924,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([303,403,394,494,1203,1303,3095,3195,815.845,817.522,817.854,818.21,818.423,818.708,818.922],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71095,0.0230384,-4.36191e-06,-8.41363e-09,3.88383e-12,11812.5,21.4692], Tmin=(100,'K'), Tmax=(1142.97,'K')), NASAPolynomial(coeffs=[8.60191,0.0135124,-6.41498e-06,1.27325e-09,-9.1826e-14,9741.47,-10.9075], Tmin=(1142.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.7924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(CsCCFH) + group(CsJ2_singlet-CsH) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + ring(Cyclopropane)"""),
)
...
"""),
    ...
    molecularWeight = (56.0383,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.76497,0.0324082,-6.18384e-05,5.77322e-08,-1.96566e-11,55889.2,8.11352], Tmin=(100,'K'), Tmax=(926.89,'K')), NASAPolynomial(coeffs=[4.70605,0.0105104,-4.51974e-06,7.6766e-10,-4.72776e-14,56110.1,2.02942], Tmin=(926.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(464.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Ct-CtCs) + group(Ct-CtCs) + ring(Cyclopropyne)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CHF(40)', 'C2HF(58)'],
    products = ['FC1=CC1F(5603)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(3.34524e+09,'m^3/(mol*s)'), n=-0.731, Ea=(0.0474187,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [carbene;mb_tb]
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]C=CF(1952)'],
    products = ['FC1=CC1F(5603)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2e+12,'s^-1'), n=0, Ea=(7.5312,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn;C_rad_out_1H;Ypri_rad_out] for rate rule [R3_SD;C_rad_out_1H;Cdsinglepri_rad_out]
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC1=C(F)[CH]1(7336)'],
    products = ['FC1=CC1F(5603)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['FC1[C]C1F(12568)'],
    products = ['FC1=CC1F(5603)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(3.82066e+10,'s^-1'), n=0.827, Ea=(127.151,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'C1=CC=1(12569)'],
    products = ['FC1=CC1F(5603)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(5353.26,'m^3/(mol*s)'), n=0.732206, Ea=(196.803,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'FC1C#C1(12570)'],
    products = ['FC1=CC1F(5603)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(3.28966e+40,'m^3/(mol*s)'), n=-10.004, Ea=(231.719,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #4076',
    isomers = [
        'FC1=CC1F(5603)',
    ],
    reactants = [
