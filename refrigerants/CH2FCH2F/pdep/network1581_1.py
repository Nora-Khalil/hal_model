...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C(=C)F(1947)'],
    products = ['[CH]=C(F)C[CH2](3531)'],
    transitionState = 'TS2',
