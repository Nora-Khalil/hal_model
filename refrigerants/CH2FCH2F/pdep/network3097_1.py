...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70468,0.072841,-0.000176762,2.00566e-07,-8.00939e-11,-20660.8,19.1972], Tmin=(100,'K'), Tmax=(855.408,'K')), NASAPolynomial(coeffs=[-3.97409,0.0428415,-2.49861e-05,4.98955e-09,-3.46586e-13,-17620.1,57.8013], Tmin=(855.408,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsCsCs) + group(CdCFO) + group(Cds-OdOsH) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(oxirene)"""),
)

species(
    label = 'O=[C]O[CH]C(=O)F(9503)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.117208,'amu*angstrom^2'), symmetry=1, barrier=(2.69484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116778,'amu*angstrom^2'), symmetry=1, barrier=(2.68495,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.029,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48861,0.080645,-0.000204768,2.28231e-07,-8.88985e-11,2971.56,18.6022], Tmin=(100,'K'), Tmax=(869.736,'K')), NASAPolynomial(coeffs=[-3.4655,0.0394562,-2.33987e-05,4.63731e-09,-3.18306e-13,6252.91,55.7215], Tmin=(869.736,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.1573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsCsCs) + group(CdCFO) + group(Cds-OdOsH) + ring(oxirene) + radical((O)CJOC) + longDistanceInteraction_cyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'O=[C]O[C]1OC1F(9505)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {6,S} {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C1O[C]1F(9399)'],
    products = ['O=[C]OC1O[C]1F(9307)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C1O[C]1F(9399)'],
    products = ['O=[C]OC1O[C]1F(9307)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC1=C(F)O1(9504)'],
    products = ['O=[C]OC1O[C]1F(9307)'],
    transitionState = 'TS9',
