...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', '[O]C[O](1330)'],
    products = ['[O]CO[CH]F(1846)'],
    transitionState = 'TS2',
