...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(F)OCF(4109)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'OC(F)OC(F)(F)[C]F(12145)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'OC(F)OC(F)(F)F(3599)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OC(O)F(4501)', 'CHFCF2(55)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)OF(3638)', 'CH2CF2(57)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'OC(F)O[C](F)CF(12147)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(F)(F)OC(O)F(12148)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[CH]OC(F)(F)CF(11439)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O)F(1207)', 'CH2F-CF2(68)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]F(459)', '[O]C(F)(F)CF(2328)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'F[CH]OC(F)(F)CF(12149)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)OC(F)(F)CF(12150)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(46)', 'OC(F)O[C](F)F(3821)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)OC(F)(F)[CH]F(12151)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O[C](F)OC(F)(F)CF(10655)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=COC(F)(F)CF(12152)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'C=C(F)OC(O)F(4123)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'OC(F)OC(F)=CF(6506)'],
    products = ['OC(F)OC(F)(F)CF(11821)'],
...
network(
    label = 'PDepNetwork #3926',
    isomers = [
        'OC(F)OC(F)(F)CF(11821)',
    ],
    reactants = [
