...
"""),
    E0 = (-834.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,375,486,586,623,710,938,1161,1294,395,473,707,1436,198.895,198.9,198.902,199.03],'cm^-1')),
        HinderedRotor(inertia=(0.396541,'amu*angstrom^2'), symmetry=1, barrier=(11.1402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.396691,'amu*angstrom^2'), symmetry=1, barrier=(11.1404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15742,'amu*angstrom^2'), symmetry=1, barrier=(32.5011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.390834,0.0852281,-0.000125217,9.37337e-08,-2.77979e-11,-100209,27.5629], Tmin=(100,'K'), Tmax=(826.567,'K')), NASAPolynomial(coeffs=[13.2866,0.0228212,-1.19642e-05,2.38976e-09,-1.70323e-13,-102340,-32.1956], Tmin=(826.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-834.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O]C(F)(F)CO[C](F)CF(10402)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02339,'amu*angstrom^2'), symmetry=1, barrier=(23.5297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02276,'amu*angstrom^2'), symmetry=1, barrier=(23.5152,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.305121,0.0840394,-9.76465e-05,5.73228e-08,-1.34323e-11,-86509.1,26.407], Tmin=(100,'K'), Tmax=(1033.73,'K')), NASAPolynomial(coeffs=[15.4342,0.0254973,-1.26981e-05,2.53808e-09,-1.82958e-13,-89636.9,-47.0838], Tmin=(1033.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-720.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sO2sCs))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.293,0.0652732,-7.48792e-05,4.94418e-08,-1.38811e-11,-54897.9,27.1827], Tmin=(100,'K'), Tmax=(846.368,'K')), NASAPolynomial(coeffs=[8.29613,0.032175,-1.62184e-05,3.23472e-09,-2.32061e-13,-56083.3,-5.43502], Tmin=(846.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CsCsF1sO2s) + radical(CJCO)"""),
)
...
species(
    label = '[O]C(F)([CH]F)OC(F)CF(10409)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.563481,0.10925,-0.000170446,1.43084e-07,-4.83533e-11,-98694.4,32.4441], Tmin=(100,'K'), Tmax=(737.779,'K')), NASAPolynomial(coeffs=[12.6144,0.0363576,-1.93035e-05,3.85194e-09,-2.73183e-13,-100600,-26.8571], Tmin=(737.779,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-821.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-F1sO2sCs)) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)

species(
    label = 'OC(F)(CF)O[C](F)[CH]F(10410)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.306419,0.104869,-0.00016985,1.52078e-07,-5.45725e-11,-103391,33.8692], Tmin=(100,'K'), Tmax=(772.646,'K')), NASAPolynomial(coeffs=[9.8088,0.0405646,-2.18365e-05,4.37027e-09,-3.09811e-13,-104598,-10.016], Tmin=(772.646,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-860.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsCsFHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(F)(OF)O[C](F)CF(10413)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    ...
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]C(F)(F)O[C](F)CF(10046)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)(CF)O[C](F)CF(10080)'],
    products = ['[O]C(F)(F)CO[C](F)CF(10402)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]CF-2(467)', '[O]C([O])(F)CF(9947)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', 'FC[C](F)O[C](F)CF(10131)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(CF)O[C](F)CF(10080)'],
    products = ['FCC1(F)OC(F)(CF)O1(10403)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C(CF)O[C](F)CF(10404)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', 'O=C(F)O[C](F)CF(10195)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C=C(F)OC([O])(F)CF(10014)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', '[CH2]C(=O)O[C](F)CF(9980)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]CF(125)', '[O]C([O])(F)CF(9947)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)(CF)O[C](F)CF(10080)'],
    products = ['OC(F)([CH]F)O[C](F)CF(10408)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)([CH]F)OC(F)CF(10409)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)(CF)O[C](F)CF(10080)'],
    products = ['OC(F)(CF)O[C](F)[CH]F(10410)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FC[C](F)O[C](CF)OF(10411)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)(CF)O[C](F)CF(10080)'],
    products = ['[O][C](CF)OC(F)(F)CF(10412)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(F)(OF)O[C](F)CF(10413)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C(F)(CF)O[C](F)CF(10080)'],
    products = ['[CH2]C([O])(F)OC(F)(F)CF(10414)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][C](F)OC(F)(CF)OF(10415)'],
    products = ['[O]C(F)(CF)O[C](F)CF(10080)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C(F)(CF)O[C](F)CF(10080)'],
    products = ['[CH2]C(F)(F)OC([O])(F)CF(10416)'],
...
network(
    label = 'PDepNetwork #3502',
    isomers = [
        '[O]C(F)(CF)O[C](F)CF(10080)',
    ],
    reactants = [
