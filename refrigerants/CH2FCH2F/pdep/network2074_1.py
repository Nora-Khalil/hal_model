...
"""),
    E0 = (-1036.85,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,222,329,445,522,589,1214,1475,235,523,627,1123,1142,1372,1406,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,245.751,245.751,245.751],'cm^-1')),
        HinderedRotor(inertia=(0.273193,'amu*angstrom^2'), symmetry=1, barrier=(11.7081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273194,'amu*angstrom^2'), symmetry=1, barrier=(11.7081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273193,'amu*angstrom^2'), symmetry=1, barrier=(11.7081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.531953,'amu*angstrom^2'), symmetry=1, barrier=(22.7976,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.571551,0.108923,-0.000157571,1.21662e-07,-3.78329e-11,-124548,29.9393], Tmin=(100,'K'), Tmax=(784.824,'K')), NASAPolynomial(coeffs=[13.6803,0.0362848,-1.87373e-05,3.72785e-09,-2.65187e-13,-126785,-35.364], Tmin=(784.824,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1036.85,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFFH) + group(Cs-CsHHH)"""),
)
...
"""),
    E0 = (-1014.18,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,333,384,448,608,1254,1480,250,417,511,1155,1315,1456,3119,2750,2800,2850,1350,1500,750,1050,1375,1000,235,523,627,1123,1142,1372,1406,3097,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.959641,'amu*angstrom^2'), symmetry=1, barrier=(22.064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.955016,'amu*angstrom^2'), symmetry=1, barrier=(21.9577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.957688,'amu*angstrom^2'), symmetry=1, barrier=(22.0191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.957206,'amu*angstrom^2'), symmetry=1, barrier=(22.0081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.29966,0.100605,-0.000122964,7.77504e-08,-1.98169e-11,-121827,28.4442], Tmin=(100,'K'), Tmax=(949.258,'K')), NASAPolynomial(coeffs=[15.59,0.0336494,-1.71636e-05,3.44789e-09,-2.48627e-13,-124844,-47.3871], Tmin=(949.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1014.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F))"""),
)

species(
    label = 'CC(F)(F)C(F)C(F)OF(5322)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {7,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1017.3,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,250,417,511,1155,1315,1456,3119,222,329,445,522,589,1214,1475,261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,267.342,267.343,267.344],'cm^-1')),
        HinderedRotor(inertia=(0.620382,'amu*angstrom^2'), symmetry=1, barrier=(31.4649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265062,'amu*angstrom^2'), symmetry=1, barrier=(13.4433,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265057,'amu*angstrom^2'), symmetry=1, barrier=(13.4433,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.412884,'amu*angstrom^2'), symmetry=1, barrier=(20.9408,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.282454,0.101279,-0.000128308,8.53485e-08,-2.29789e-11,-122205,28.4344], Tmin=(100,'K'), Tmax=(899.295,'K')), NASAPolynomial(coeffs=[14.5745,0.0351951,-1.80788e-05,3.63178e-09,-2.61485e-13,-124877,-41.6644], Tmin=(899.295,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1017.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH)"""),
)
...
"""),
    E0 = (-620.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,222,329,445,522,589,1214,1475,2750,2800,2850,1350,1500,750,1050,1375,1000,334,575,1197,1424,3202,251.785,253.889,257.924],'cm^-1')),
        HinderedRotor(inertia=(0.206425,'amu*angstrom^2'), symmetry=1, barrier=(9.04455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197936,'amu*angstrom^2'), symmetry=1, barrier=(9.04397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202106,'amu*angstrom^2'), symmetry=1, barrier=(9.04718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.595819,'amu*angstrom^2'), symmetry=1, barrier=(26.5161,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.507424,0.109785,-0.000183778,1.63022e-07,-5.66947e-11,-74511.8,29.229], Tmin=(100,'K'), Tmax=(813.717,'K')), NASAPolynomial(coeffs=[11.0728,0.0366866,-1.92148e-05,3.77125e-09,-2.63109e-13,-75861,-20.9614], Tmin=(813.717,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-620.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFHH) + group(Cs-CsHHH) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)

species(
    label = 'CC(F)(F)C([O])C(F)F(5002)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-940.999,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,222,329,445,522,589,1214,1475,235,523,627,1123,1142,1372,1406,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,317.495,317.537,317.69],'cm^-1')),
        HinderedRotor(inertia=(0.174702,'amu*angstrom^2'), symmetry=1, barrier=(12.496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174647,'amu*angstrom^2'), symmetry=1, barrier=(12.496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174584,'amu*angstrom^2'), symmetry=1, barrier=(12.4961,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.141753,0.0916475,-0.000121508,8.68488e-08,-2.52174e-11,-113043,27.0192], Tmin=(100,'K'), Tmax=(835.762,'K')), NASAPolynomial(coeffs=[12.3309,0.0333119,-1.68127e-05,3.33948e-09,-2.38363e-13,-115081,-29.5999], Tmin=(835.762,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-940.999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(CsCsFFH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
"""),
    E0 = (-796.221,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.335333,'amu*angstrom^2'), symmetry=1, barrier=(7.70997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.335512,'amu*angstrom^2'), symmetry=1, barrier=(7.71408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.335534,'amu*angstrom^2'), symmetry=1, barrier=(7.71459,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.22861,0.0651681,-7.99596e-05,5.84336e-08,-1.83071e-11,-95757.9,14.3526], Tmin=(10,'K'), Tmax=(737.093,'K')), NASAPolynomial(coeffs=[8.40928,0.0370539,-2.27467e-05,6.68695e-09,-7.56201e-13,-96521.6,-9.0608], Tmin=(737.093,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-796.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), label="""CC(F)(F)[CH]C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-1029.94,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,348,427,405,1245,1236,1280,2750,2800,2850,1350,1500,750,1050,1375,1000,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,325.395,325.416],'cm^-1')),
        HinderedRotor(inertia=(0.132588,'amu*angstrom^2'), symmetry=1, barrier=(9.95151,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132626,'amu*angstrom^2'), symmetry=1, barrier=(9.95128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132512,'amu*angstrom^2'), symmetry=1, barrier=(9.95112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
...
"""),
    E0 = (-641.421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,171,205,598,1104,1143,1317,1411,3153,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,323,467,575,827,1418,180,1426.41],'cm^-1')),
        HinderedRotor(inertia=(0.267256,'amu*angstrom^2'), symmetry=1, barrier=(6.14473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267528,'amu*angstrom^2'), symmetry=1, barrier=(6.151,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269164,'amu*angstrom^2'), symmetry=1, barrier=(6.18862,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.341658,0.0956894,-0.000175112,1.74184e-07,-6.58826e-11,-77028.2,27.0832], Tmin=(100,'K'), Tmax=(831.595,'K')), NASAPolynomial(coeffs=[3.68038,0.0459515,-2.46483e-05,4.86177e-09,-3.39087e-13,-76419,18.5932], Tmin=(831.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-641.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)C(OF)C(F)F(5285)'],
    products = ['HF(38)', 'CH2CF2(57)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(69.6706,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CC(OF)C(F)F(1517)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.22791e-07,'m^3/(mol*s)'), n=3.59921, Ea=(330.164,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node CC_N-2Br1sCl1sF1sHI1s->H"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)C(F)F(3101)', 'C[C]F(137)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(173.669,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CF2(43)', 'CC(F)(F)COF(3295)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(125.831,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'CC(F)(F)C([C]F)OF(5319)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(144.271,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CC(F)(OF)C(F)C(F)F(5321)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC(F)(F)C(F)C(F)OF(5322)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FOF(1520)', 'CC(F)=CC(F)F(5306)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OF(140)', 'CC(F)(F)C=C(F)F(797)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FOF(1520)', 'CC(F)(F)C=CF(756)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'C[C](F)C(OF)C(F)F(5314)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'CC(F)(F)C([CH]F)OF(5323)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'CC(F)(F)C([O])C(F)F(5002)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(127)', 'CC(F)(F)[CH]C(F)F(5324)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FO[CH]C(F)F(4702)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF2(82)', 'CC(F)(F)[CH]OF(3103)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'CC(F)(F)[C](OF)C(F)F(5325)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(19)', 'FOC([C](F)F)C(F)F(5326)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'CC(F)(F)C(OF)[C](F)F(5327)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', '[CH2]C(F)(F)C(OF)C(F)F(5328)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'CC(F)(F)C(=O)C(F)F(4817)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(422.203,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'CC(F)=C(OF)C(F)F(5329)'],
    products = ['CC(F)(F)C(OF)C(F)F(5285)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(174.03,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(175.393,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)
...
network(
    ...
    isomers = [
        'CC(F)(F)C(OF)C(F)F(5285)',
    ],
    reactants = [
        ('HF(38)', 'CH2CF2(57)', 'O=CC(F)F(990)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
