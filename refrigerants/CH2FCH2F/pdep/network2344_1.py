...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92511,0.0518492,-4.2377e-05,1.66466e-08,-2.73141e-12,-78719.5,20.6838], Tmin=(100,'K'), Tmax=(1357.82,'K')), NASAPolynomial(coeffs=[10.4733,0.0266669,-1.45576e-05,2.98767e-09,-2.16532e-13,-81040.9,-23.1711], Tmin=(1357.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-655.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-OdCsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F))"""),
)

species(
    label = 'O=C=CC(F)C(F)F(6339)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
4  O u0 p2 c0 {8,D}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32406,0.0639756,-7.80244e-05,5.2178e-08,-1.44195e-11,-82654.9,22.8055], Tmin=(100,'K'), Tmax=(869.538,'K')), NASAPolynomial(coeffs=[9.45681,0.0265641,-1.34881e-05,2.69896e-09,-1.93923e-13,-84069.3,-15.2935], Tmin=(869.538,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-687.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.205613,'amu*angstrom^2'), symmetry=1, barrier=(4.72746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.870184,'amu*angstrom^2'), symmetry=1, barrier=(20.0073,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53357,0.0617744,-7.94416e-05,4.6691e-08,-4.88245e-12,-58213.3,23.8954], Tmin=(100,'K'), Tmax=(564.483,'K')), NASAPolynomial(coeffs=[7.99497,0.0265931,-1.41349e-05,2.84438e-09,-2.03536e-13,-59111.7,-5.07873], Tmin=(564.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-484.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(Csj(Cs-F1sCdH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.904651,'amu*angstrom^2'), symmetry=1, barrier=(20.7997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.905592,'amu*angstrom^2'), symmetry=1, barrier=(20.8213,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83117,0.057498,-6.37496e-05,-1.65387e-09,3.99266e-11,-23021.8,20.5864], Tmin=(100,'K'), Tmax=(484.61,'K')), NASAPolynomial(coeffs=[7.96506,0.0240926,-1.36639e-05,2.7863e-09,-1.99399e-13,-23818.5,-6.64935], Tmin=(484.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Csj(Cd-CdH)(F1s)(F1s)) + radical(C=CCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.735979,0.0822579,-0.000146263,1.35824e-07,-4.81478e-11,-57551.4,28.2692], Tmin=(100,'K'), Tmax=(850.683,'K')), NASAPolynomial(coeffs=[7.20479,0.02993,-1.53586e-05,2.9584e-09,-2.02882e-13,-57859.1,2.76688], Tmin=(850.683,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(CsCsCsF1s) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C=CC(F)[C](F)F(6344)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.00696,'amu*angstrom^2'), symmetry=1, barrier=(23.152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00584,'amu*angstrom^2'), symmetry=1, barrier=(23.1262,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948122,0.0642728,-6.62183e-05,3.33262e-08,-6.60124e-12,-56551.2,25.9888], Tmin=(100,'K'), Tmax=(1223.86,'K')), NASAPolynomial(coeffs=[15.5076,0.0166874,-7.89648e-06,1.55705e-09,-1.11713e-13,-60115,-47.1936], Tmin=(1223.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-471.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-F1sCdH)(F1s)(F1s))"""),
)

species(
    label = 'O=[C][CH]C(F)C(F)F(6345)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.975586,0.070262,-9.40642e-05,6.68895e-08,-1.90319e-11,-60312.9,25.1713], Tmin=(100,'K'), Tmax=(858.498,'K')), NASAPolynomial(coeffs=[11.2394,0.0224422,-1.0516e-05,2.01356e-09,-1.40592e-13,-62075.3,-22.7804], Tmin=(858.498,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-502.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC[C](F)[C](F)F(6346)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.301654,'amu*angstrom^2'), symmetry=1, barrier=(6.93561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301736,'amu*angstrom^2'), symmetry=1, barrier=(6.9375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.30212,'amu*angstrom^2'), symmetry=1, barrier=(6.94634,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.846328,0.0832267,-0.00015786,1.55795e-07,-5.76065e-11,-52577.6,28.3563], Tmin=(100,'K'), Tmax=(852.836,'K')), NASAPolynomial(coeffs=[4.17701,0.0359349,-1.89788e-05,3.68835e-09,-2.53789e-13,-51994,19.5702], Tmin=(852.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-437.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(CsCsCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-373.753,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,395,473,707,1436,182,240,577,636,1210,1413,249.081,249.088,2742.44],'cm^-1')),
        HinderedRotor(inertia=(0.160896,'amu*angstrom^2'), symmetry=1, barrier=(7.08404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160877,'amu*angstrom^2'), symmetry=1, barrier=(7.08405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01768,0.0715408,-0.000110211,9.40956e-08,-3.20083e-11,-44850.4,27.2229], Tmin=(100,'K'), Tmax=(812.16,'K')), NASAPolynomial(coeffs=[8.53246,0.0267281,-1.30362e-05,2.50159e-09,-1.73015e-13,-45813.7,-5.884], Tmin=(812.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsH) + group(CdCFF) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['C=C([O])C(F)[C](F)F(6297)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', 'O=[C]C[CH]F(297)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(129)', '[CH2]C(F)[C](F)F(772)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C(F)[C](F)F(772)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]CC=C(F)F(832)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHFCF2(55)', '[CH2][C]=O(338)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]CC(F)=C(F)F(6340)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH][C](F)F(3911)', 'CH2CO(28)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C=CC(F)[C](F)F(6341)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH][C](F)F(3911)', '[CH2][C]=O(338)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=[C]C=C[C](F)F(6342)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', 'O=[C]C[CH]F(297)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]CC(F)[C](F)F(6301)'],
    products = ['O=[C][CH]C(F)C(F)F(6345)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=[C]CC(F)[C](F)F(6301)'],
    products = ['O=[C]C[CH]C(F)(F)F(2927)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O][C](F)CC=C(F)F(1573)'],
    products = ['O=[C]CC(F)[C](F)F(6301)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(183.662,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #2344',
    isomers = [
        'O=[C]CC(F)[C](F)F(6301)',
    ],
    reactants = [
