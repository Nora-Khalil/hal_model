...
"""),
    E0 = (-512.109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,326,540,652,719,1357,194,682,905,1196,1383,3221,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0209803,'amu*angstrom^2'), symmetry=1, barrier=(30.3104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.509083,'amu*angstrom^2'), symmetry=1, barrier=(11.7048,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0026696,'amu*angstrom^2'), symmetry=1, barrier=(30.3108,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03402,0.0712538,-8.08477e-05,5.14345e-08,-1.37708e-11,-61490.8,25.5525], Tmin=(100,'K'), Tmax=(888.443,'K')), NASAPolynomial(coeffs=[9.46426,0.0332993,-1.67684e-05,3.35179e-09,-2.40958e-13,-62988.8,-14.1215], Tmin=(888.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-512.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.33465,0.0884764,-0.000121482,8.64392e-08,-2.25525e-11,-56805.9,29.4751], Tmin=(100,'K'), Tmax=(645.48,'K')), NASAPolynomial(coeffs=[11.1144,0.0323691,-1.59482e-05,3.10763e-09,-2.18307e-13,-58420.3,-19.5374], Tmin=(645.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-473.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Cs_P) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.91016,0.0750368,-9.28036e-05,7.17609e-08,-2.41756e-11,-53118.7,28.28], Tmin=(100,'K'), Tmax=(706.885,'K')), NASAPolynomial(coeffs=[6.87501,0.0412907,-2.12093e-05,4.25348e-09,-3.05444e-13,-53962.1,1.57094], Tmin=(706.885,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-442.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(O)O[C](F)CF(11413)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.124341,0.0931969,-0.000131813,9.48815e-08,-2.50581e-11,-56035.6,30.1746], Tmin=(100,'K'), Tmax=(655.366,'K')), NASAPolynomial(coeffs=[12.2552,0.0306709,-1.50572e-05,2.92023e-09,-2.0425e-13,-57872.9,-25.1101], Tmin=(655.366,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-467.005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])OC(F)CF(11414)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.709049,0.0796269,-0.000102534,7.90902e-08,-2.59627e-11,-52348.7,28.9476], Tmin=(100,'K'), Tmax=(730.632,'K')), NASAPolynomial(coeffs=[8.02506,0.0395745,-2.03068e-05,4.06318e-09,-2.91133e-13,-53417.8,-4.05192], Tmin=(730.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-436.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = 'CC(O)O[C](F)[CH]F(11415)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.150923,0.0989874,-0.000156306,1.31646e-07,-4.37717e-11,-57583,30.85], Tmin=(100,'K'), Tmax=(817.812,'K')), NASAPolynomial(coeffs=[11.7753,0.0314079,-1.53932e-05,2.95036e-09,-2.03516e-13,-59224.4,-22.3978], Tmin=(817.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2][C](F)OC(C)OF(11416)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.109322,0.0931076,-0.000139944,1.17794e-07,-4.03084e-11,-18819.6,31.2653], Tmin=(100,'K'), Tmax=(750.996,'K')), NASAPolynomial(coeffs=[10.2601,0.0355926,-1.81772e-05,3.58377e-09,-2.52827e-13,-20247,-14.1518], Tmin=(750.996,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)(F)OC(C)[O](11417)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.596252,0.0824512,-0.000119441,1.05118e-07,-3.83827e-11,-59086.2,29.0427], Tmin=(100,'K'), Tmax=(750.435,'K')), NASAPolynomial(coeffs=[7.04369,0.0405784,-2.07402e-05,4.10569e-09,-2.90797e-13,-59842.6,1.19687], Tmin=(750.435,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-492.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CO[C](F)CF(9965)'],
    products = ['CC([O])O[C](F)CF(11274)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]CF-2(467)', 'CC([O])[O](3893)'],
    products = ['CC([O])O[C](F)CF(11274)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'O=CO[C](F)CF(10194)'],
    products = ['CC([O])O[C](F)CF(11274)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(=O)O[C](F)CF(11408)'],
    products = ['CC([O])O[C](F)CF(11274)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C=C(F)OC(C)[O](11409)'],
    products = ['CC([O])O[C](F)CF(11274)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'CC([O])OC(F)=CF(11410)'],
    products = ['CC([O])O[C](F)CF(11274)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C]CF(125)', 'CC([O])[O](3893)'],
    products = ['CC([O])O[C](F)CF(11274)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(O)O[C](F)CF(11413)'],
    products = ['CC([O])O[C](F)CF(11274)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C([O])OC(F)CF(11414)'],
    products = ['CC([O])O[C](F)CF(11274)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC([O])O[C](F)CF(11274)'],
    products = ['CC(O)O[C](F)[CH]F(11415)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][C](F)OC(C)OF(11416)'],
    products = ['CC([O])O[C](F)CF(11274)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC([O])O[C](F)CF(11274)'],
    products = ['[CH2]C(F)(F)OC(C)[O](11417)'],
