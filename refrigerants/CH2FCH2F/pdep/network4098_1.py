...
reaction(
    label = 'reaction1',
    reactants = ['CC([O])C(F)[C](F)F(12488)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC(F)[C](F)F(6238)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CC([O])C(F)[C](F)F(12488)'],
    products = ['CC([O])C(F)(F)[CH]F(12487)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C[CH]C(F)[C](F)F(6582)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(744)', 'CC([O])[CH]F(2544)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH][C](F)F(3911)', 'CH3CHO(36)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'O=CC(F)[C](F)F(2507)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(=O)C(F)[C](F)F(12505)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC([O])C=C(F)F(3499)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHFCF2(55)', 'C[CH][O](3430)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC([O])C(F)=C(F)F(12506)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH][C](F)F(3911)', 'C[CH][O](3430)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC([O])=C[C](F)F(867)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', 'CC([O])[CH]F(2544)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CC([O])C(F)[C](F)F(12488)'],
    products = ['C[C]([O])C(F)C(F)F(12509)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC([CH][C](F)F)OF(12510)'],
    products = ['CC([O])C(F)[C](F)F(12488)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC([O])C(F)[C](F)F(12488)'],
    products = ['CC([O])[CH]C(F)(F)F(12511)'],
