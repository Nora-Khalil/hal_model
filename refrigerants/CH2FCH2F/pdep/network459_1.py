...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C([O])(O)F(524)'],
    products = ['[CH2]C(O)(F)O[O](964)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]O[C](O)F(1125)', 'CH2(T)(18)'],
    products = ['[CH2]C(O)(F)O[O](964)'],
    transitionState = 'TS4',
