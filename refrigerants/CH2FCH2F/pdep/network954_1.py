...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', '[CH]C(=O)F(427)'],
    products = ['[CH]=C(F)O[CH]F(2103)'],
    transitionState = 'TS2',
