species(
    label = '[CH]=C(F)C(F)(F)[C](F)F(12626)',
...
species(
    label = '[CH]C(F)=C(F)C(F)(F)F(12720)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
species(
    label = '[CH]=[C]C(F)(F)C(F)(F)F(12721)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(12626)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[CH]C(F)=C(F)F(12719)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(12626)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=C(F)C(F)=C(F)F(6426)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(12626)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C#CC(F)(F)[C](F)F(11267)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(12626)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F2(78)', '[CH]=C=C(F)[C](F)F(6428)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(12626)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH]C(F)=C(F)F(12719)'],
    products = ['[CH]=C(F)C(F)(F)[C](F)F(12626)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(12626)'],
    products = ['[CH]C(F)=C(F)C(F)(F)F(12720)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(12626)'],
    products = ['F[CH]C(F)=C(F)[C](F)F(6400)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(12626)'],
    products = ['[CH]=[C]C(F)(F)C(F)(F)F(12721)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(F)C(F)(F)[C](F)F(12626)'],
    products = ['FC=[C]C(F)(F)[C](F)F(7760)'],
...
network(
    label = 'PDepNetwork #4196',
    isomers = [
        '[CH]=C(F)C(F)(F)[C](F)F(12626)',
    ],
    reactants = [
        ('CF2CF2(61)', 'C2HF(58)'),
    ],
