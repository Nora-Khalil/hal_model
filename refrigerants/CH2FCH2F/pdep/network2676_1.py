...
species(
    label = 'O=[C]O[C]1C(F)C1(F)F(8271)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7422)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', 'O=C([CH]F)[C](F)F(7925)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7422)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'O=[C]O[C]=C(F)F(8270)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7422)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7422)'],
    products = ['O=[C]O[C]1C(F)C1(F)F(8271)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7422)'],
    products = ['O=C1OC1([CH]F)[C](F)F(8273)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', 'O=C([CH]F)[C](F)F(7925)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7422)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', 'O=[C]O[C]=C(F)F(8270)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7422)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]OC(=[C]F)C(F)F(8274)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7422)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C]F(744)', 'O=[C]O[C]=CF(2687)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7422)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF2(43)', 'O=[C]O[C]=CF(2687)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7422)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=COC([C]F)=C(F)F(8277)'],
    products = ['O=[C]OC([CH]F)=C(F)F(7422)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7422)'],
    products = ['[CH]=C(O[C]=O)C(F)(F)F(8278)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=[C]OC([CH]F)=C(F)F(7422)'],
    products = ['[CH]C(OC(=O)F)=C(F)F(8279)'],
...
network(
    label = 'PDepNetwork #2676',
    isomers = [
        'O=[C]OC([CH]F)=C(F)F(7422)',
    ],
    reactants = [
