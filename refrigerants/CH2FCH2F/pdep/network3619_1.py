...
"""),
    E0 = (-213.932,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([90,150,250,247,323,377,431,433,1065,1274,2175,525,750,770,3400,2100,463.711,464.536,464.608,465.753],'cm^-1')),
        HinderedRotor(inertia=(0.000779284,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155182,'amu*angstrom^2'), symmetry=1, barrier=(23.7854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155263,'amu*angstrom^2'), symmetry=1, barrier=(23.7935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155623,'amu*angstrom^2'), symmetry=1, barrier=(23.7937,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.018672,0.0866,-0.000118654,7.45914e-08,-1.78228e-11,-25583.7,22.4075], Tmin=(100,'K'), Tmax=(1039.39,'K')), NASAPolynomial(coeffs=[20.7214,0.00678365,-3.46736e-06,7.10422e-10,-5.25074e-14,-29895.2,-78.4529], Tmin=(1039.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-213.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(Ct-CtH) + radical(CsCCl_triplet)"""),
)

species(
    label = 'OC1(F)O[C]=CC1F(11217)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2519,0.0511716,-2.87972e-05,-9.03526e-09,1.02245e-11,-59791.1,19.8512], Tmin=(100,'K'), Tmax=(922.361,'K')), NASAPolynomial(coeffs=[16.1436,0.0107775,-2.43994e-06,3.44087e-10,-2.34976e-14,-63567.1,-56.3664], Tmin=(922.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(C=CJO) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = '[CH]=C1OC(O)(F)C1F(11218)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.165807,0.0732881,-8.08959e-05,4.15991e-08,-7.88278e-12,-50034.4,22.1806], Tmin=(100,'K'), Tmax=(1503.72,'K')), NASAPolynomial(coeffs=[21.2599,0.00363146,1.21979e-06,-4.06489e-10,3.18696e-14,-55046.4,-85.1665], Tmin=(1503.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-417.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCCFH) + group(CsCFOO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(Cds_P) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'C#COC(O)=CF(6633)',
...
"""),
    E0 = (-172.936,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,194,682,905,1196,1383,3221,2175,525,750,770,3400,2100,180,488.262],'cm^-1')),
        HinderedRotor(inertia=(0.767285,'amu*angstrom^2'), symmetry=1, barrier=(17.6414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.31019,'amu*angstrom^2'), symmetry=1, barrier=(53.1158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43007,0.061559,-9.53513e-05,8.08855e-08,-2.76703e-11,-20711.7,19.9018], Tmin=(100,'K'), Tmax=(758.324,'K')), NASAPolynomial(coeffs=[8.42657,0.0218832,-1.13898e-05,2.25399e-09,-1.59068e-13,-21693.1,-11.3915], Tmin=(758.324,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Ct-CtOs) + group(Ct-CtH)"""),
)

species(
    label = 'C#CO[C](O)[CH]F(6635)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {4,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.10743,'amu*angstrom^2'), symmetry=1, barrier=(25.4621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10586,'amu*angstrom^2'), symmetry=1, barrier=(25.4258,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53718,0.0522583,-6.27184e-05,3.55518e-08,-7.74697e-12,-51043.2,19.8523], Tmin=(100,'K'), Tmax=(1131.09,'K')), NASAPolynomial(coeffs=[14.1249,0.0077425,-3.68275e-06,7.55669e-10,-5.60169e-14,-53890.8,-42.4263], Tmin=(1131.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sO2sCs)) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)

species(
    label = 'C#CO[C](F)[CH]F(11220)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.31392,'amu*angstrom^2'), symmetry=1, barrier=(30.2097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31307,'amu*angstrom^2'), symmetry=1, barrier=(30.19,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31287,'amu*angstrom^2'), symmetry=1, barrier=(30.1856,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.574447,0.0755165,-0.000107338,7.11972e-08,-1.80287e-11,2185.04,21.0733], Tmin=(100,'K'), Tmax=(979.955,'K')), NASAPolynomial(coeffs=[17.1513,0.0078518,-3.76364e-06,7.33852e-10,-5.22105e-14,-1063.82,-58.5645], Tmin=(979.955,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.1423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(Ct-CtH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-46.3537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,334,575,1197,1424,3202,2175,525,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.10641,'amu*angstrom^2'), symmetry=1, barrier=(25.4385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10711,'amu*angstrom^2'), symmetry=1, barrier=(25.4546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10765,'amu*angstrom^2'), symmetry=1, barrier=(25.467,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.26273,0.0966092,-0.000154434,1.15567e-07,-3.29643e-11,-5424.2,24.9652], Tmin=(100,'K'), Tmax=(871.897,'K')), NASAPolynomial(coeffs=[18.7612,0.00933638,-4.29675e-06,7.7334e-10,-5.06592e-14,-8741.7,-64.2071], Tmin=(871.897,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.3537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(Ct-CtH) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H)) + radical(Acetyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.34046,'amu*angstrom^2'), symmetry=1, barrier=(30.8197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34346,'amu*angstrom^2'), symmetry=1, barrier=(30.8888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34385,'amu*angstrom^2'), symmetry=1, barrier=(30.8978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34184,'amu*angstrom^2'), symmetry=1, barrier=(30.8515,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0528552,0.0850053,-0.000117051,7.428e-08,-1.79118e-11,-27842.4,23.4736], Tmin=(100,'K'), Tmax=(1030.49,'K')), NASAPolynomial(coeffs=[20.2026,0.00679449,-3.21054e-06,6.35299e-10,-4.61185e-14,-31995.4,-74.3434], Tmin=(1030.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-232.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + group(CJ2_singlet-FCs) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COC(O)(F)[CH]F(10972)'],
    products = ['O=C(F)[CH]F(980)', 'CH2CO(28)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(100.981,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C(O)(F)OC#C(1386)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'C#CO[C](O)F(1385)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'C#COC(O)(F)[C]F-2(11216)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C#COC(O)(F)[CH]F(10972)'],
    products = ['[CH]=C1OC(O)(F)C1F(11218)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#COC(O)=CF(6633)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HCCO(21)', 'OC(F)=CF(3655)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.0603e-20,'m^3/(mol*s)'), n=7.37188, Ea=(2.79163,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.4161614592809219, var=2.5944177025948685, Tref=1000.0, N=250, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_N-Sp-2R!H#1R!H_Sp-4R!H-3R_Ext-1R!H-R_N-6R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_N-Sp-2R!H#1R!H_Sp-4R!H-3R_Ext-1R!H-R_N-6R!H-inRing"""),
)

reaction(
    label = 'reaction9',
    reactants = ['OH(7)', 'C#COC(F)=CF(10971)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C#CO[C](O)[CH]F(6635)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HCCO(21)', 'O[C](F)[CH]F(4019)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(2.31254,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['C2H(22)', '[O]C(O)(F)[CH]F(11219)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'C#CO[C](F)[CH]F(11220)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[C]#COC(O)(F)[CH]F(11221)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(177.408,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', 'C#CO[C](O)F(1385)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C#COC(O)(F)[C]F(10968)'],
    products = ['C#COC(O)(F)[CH]F(10972)'],
...
network(
    label = 'PDepNetwork #3619',
    isomers = [
        'C#COC(O)(F)[CH]F(10972)',
    ],
    reactants = [
