species(
    label = '[CH2]C(F)(F)O[CH]C(F)F(4712)',
...
"""),
    E0 = (-742.023,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,255.917,255.931,255.959,256.01],'cm^-1')),
        HinderedRotor(inertia=(0.16165,'amu*angstrom^2'), symmetry=1, barrier=(7.51772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161837,'amu*angstrom^2'), symmetry=1, barrier=(7.51835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161662,'amu*angstrom^2'), symmetry=1, barrier=(7.51701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.796689,'amu*angstrom^2'), symmetry=1, barrier=(37.0444,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.223445,0.100935,-0.000161913,1.37313e-07,-4.62107e-11,-89100.4,30.3054], Tmin=(100,'K'), Tmax=(787.039,'K')), NASAPolynomial(coeffs=[12.2407,0.0310047,-1.60858e-05,3.16056e-09,-2.21379e-13,-90858.4,-25.5463], Tmin=(787.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-742.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0216247,0.0814221,-8.53934e-05,4.32634e-08,-8.53622e-12,-120523,25.8828], Tmin=(100,'K'), Tmax=(1237.94,'K')), NASAPolynomial(coeffs=[19.8116,0.0174773,-7.91244e-06,1.53778e-09,-1.09829e-13,-125423,-73.8168], Tmin=(1237.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1003.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
"""),
    E0 = (-594.835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,217.279,217.279,217.279],'cm^-1')),
        HinderedRotor(inertia=(0.696368,'amu*angstrom^2'), symmetry=1, barrier=(23.3293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.696366,'amu*angstrom^2'), symmetry=1, barrier=(23.3293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.696367,'amu*angstrom^2'), symmetry=1, barrier=(23.3293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.223982,0.0749877,-7.9399e-05,4.01924e-08,-7.84962e-12,-71399.3,25.5228], Tmin=(100,'K'), Tmax=(1258.78,'K')), NASAPolynomial(coeffs=[19.7471,0.0129496,-5.4727e-06,1.04009e-09,-7.37938e-14,-76314.4,-73.1581], Tmin=(1258.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-594.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
"""),
    E0 = (-787.234,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,182,240,577,636,1210,1413,269.188,269.2,269.213],'cm^-1')),
        HinderedRotor(inertia=(0.454325,'amu*angstrom^2'), symmetry=1, barrier=(23.3598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.454203,'amu*angstrom^2'), symmetry=1, barrier=(23.3599,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.454258,'amu*angstrom^2'), symmetry=1, barrier=(23.3601,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.141609,0.0821863,-9.4386e-05,5.22271e-08,-1.12409e-11,-94541.1,26.8953], Tmin=(100,'K'), Tmax=(1138.2,'K')), NASAPolynomial(coeffs=[18.817,0.0165542,-7.89046e-06,1.56442e-09,-1.12925e-13,-98792.3,-65.6201], Tmin=(1138.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-787.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.247753,0.10215,-0.000167284,1.44343e-07,-4.91513e-11,-90738.1,29.7865], Tmin=(100,'K'), Tmax=(800.263,'K')), NASAPolynomial(coeffs=[11.8662,0.0316643,-1.65413e-05,3.25031e-09,-2.27282e-13,-92358.8,-23.9691], Tmin=(800.263,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-755.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]C(F)F(4712)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(F)F(506)', '[CH2]C([O])(F)F(475)'],
    products = ['[CH2]C(F)(F)O[CH]C(F)F(4712)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[C](F)O[CH]C(F)F(2207)'],
    products = ['[CH2]C(F)(F)O[CH]C(F)F(4712)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)OC=CF(2477)'],
    products = ['[CH2]C(F)(F)O[CH]C(F)F(4712)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)OC=C(F)F(1668)'],
    products = ['[CH2]C(F)(F)O[CH]C(F)F(4712)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(F)(F)OC[C](F)F(4798)'],
    products = ['[CH2]C(F)(F)O[CH]C(F)F(4712)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(F)(F)O[CH]C(F)F(4712)'],
    products = ['CC(F)(F)O[CH][C](F)F(1758)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C](F)OC(F)C(F)F(4799)'],
    products = ['[CH2]C(F)(F)O[CH]C(F)F(4712)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(211.254,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][CH]OC(F)(F)CF(4801)'],
    products = ['[CH2]C(F)(F)O[CH]C(F)F(4712)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(185.322,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #1914',
    isomers = [
        '[CH2]C(F)(F)O[CH]C(F)F(4712)',
    ],
    reactants = [
