...
reaction(
    label = 'reaction4',
    reactants = ['[O]C[C](F)F(518)'],
    products = ['FC1(F)CO1(783)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FC1(F)[CH]O1(1628)'],
    products = ['FC1(F)CO1(783)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O][C](F)F(2186)', 'CH2(T)(18)'],
    products = ['[CH2]C([O])(F)F(475)'],
...
reaction(
    label = 'reaction37',
    reactants = ['HF(38)', 'O=C[C]F-2(1630)'],
    products = ['O=CC(F)F(990)'],
