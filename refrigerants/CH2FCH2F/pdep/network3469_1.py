...
reaction(
    label = 'reaction2',
    reactants = ['OC(F)(F)OC(F)=CF(5591)'],
    products = ['O=C(F)C(F)C(O)(F)F(10976)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'O[C](F)OC(F)=CF(10977)'],
    products = ['OC(F)(F)OC(F)=CF(5591)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'OC(F)(F)O[C]=CF(10978)'],
    products = ['OC(F)(F)OC(F)=CF(5591)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(F)OC(O)(F)F(3815)'],
    products = ['OC(F)(F)OC(F)=CF(5591)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O[C](F)F(1777)', 'O=C(F)[CH]F(980)'],
    products = ['OC(F)(F)OC(F)=CF(5591)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(O)(F)F(2300)', 'CHFCF[Z](72)'],
    products = ['OC(F)(F)OC(F)=CF(5591)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'FC=C(F)O[C](F)F(2225)'],
    products = ['OC(F)(F)OC(F)=CF(5591)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'OC(F)(F)OC(F)=[C]F(10979)'],
    products = ['OC(F)(F)OC(F)=CF(5591)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C(F)(F)OC(O)(F)F(10980)'],
    products = ['OC(F)(F)OC(F)=CF(5591)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=C(F)OC(F)=CF(10627)'],
    products = ['OC(F)(F)OC(F)=CF(5591)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'C#COC(O)(F)F(2144)'],
    products = ['OC(F)(F)OC(F)=CF(5591)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OC(F)(F)OC(F)=CF(5591)'],
    products = ['HF(38)', 'CF2O(49)', 'O=C=CF(434)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHF(40)', 'OC(F)(F)[O+]=[C-]F(3819)'],
    products = ['OC(F)(F)OC(F)=CF(5591)'],
