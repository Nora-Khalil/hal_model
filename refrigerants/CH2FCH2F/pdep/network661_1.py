...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(368)', '[CH]=C[O](134)'],
    products = ['[CH]=CO[C]=C(1588)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=[CH](257)', '[CH2][C]=O(338)'],
    products = ['[CH]=CO[C]=C(1588)'],
    transitionState = 'TS8',
