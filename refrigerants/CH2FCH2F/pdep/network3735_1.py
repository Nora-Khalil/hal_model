...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.210891,'amu*angstrom^2'), symmetry=1, barrier=(4.8488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212767,'amu*angstrom^2'), symmetry=1, barrier=(4.89194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2126,'amu*angstrom^2'), symmetry=1, barrier=(4.8881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.33974,'amu*angstrom^2'), symmetry=1, barrier=(53.7953,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.693806,0.0801499,-0.000113316,9.99557e-08,-3.6845e-11,-51827.5,27.3939], Tmin=(100,'K'), Tmax=(751.558,'K')), NASAPolynomial(coeffs=[6.3625,0.0420071,-2.12766e-05,4.19836e-09,-2.96977e-13,-52454.4,3.16268], Tmin=(751.558,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-431.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11226,0.0689703,-6.87882e-05,3.88347e-08,-9.39745e-12,-98837,24.6265], Tmin=(100,'K'), Tmax=(966.638,'K')), NASAPolynomial(coeffs=[9.10115,0.0359117,-1.74884e-05,3.45417e-09,-2.46976e-13,-100381,-13.6442], Tmin=(966.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-822.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(COCsFO)"""),
)
...
"""),
    E0 = (-5.79614,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,615,860,1140,1343,3152,1685,370,252.023,252.023],'cm^-1')),
        HinderedRotor(inertia=(0.962369,'amu*angstrom^2'), symmetry=1, barrier=(43.376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173364,'amu*angstrom^2'), symmetry=1, barrier=(7.81388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.962367,'amu*angstrom^2'), symmetry=1, barrier=(43.376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173363,'amu*angstrom^2'), symmetry=1, barrier=(7.81388,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26507,0.0661219,-7.39963e-05,5.02389e-08,-1.48525e-11,-603.914,24.062], Tmin=(100,'K'), Tmax=(799.012,'K')), NASAPolynomial(coeffs=[7.21457,0.0363383,-1.80843e-05,3.58897e-09,-2.56752e-13,-1554.68,-3.30607], Tmin=(799.012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.79614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOCC(11458)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.144448,'amu*angstrom^2'), symmetry=1, barrier=(3.32115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144408,'amu*angstrom^2'), symmetry=1, barrier=(3.32023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144288,'amu*angstrom^2'), symmetry=1, barrier=(3.31747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.29661,'amu*angstrom^2'), symmetry=1, barrier=(52.8035,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.662771,0.0824818,-0.00012925,1.19511e-07,-4.43101e-11,-29404.4,27.7979], Tmin=(100,'K'), Tmax=(793.928,'K')), NASAPolynomial(coeffs=[5.94415,0.0404955,-2.08699e-05,4.10779e-09,-2.88587e-13,-29758.3,6.58918], Tmin=(793.928,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-245.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]COOC(F)=CF(11459)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.133293,'amu*angstrom^2'), symmetry=1, barrier=(3.06467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133466,'amu*angstrom^2'), symmetry=1, barrier=(3.06865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132895,'amu*angstrom^2'), symmetry=1, barrier=(3.05553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.38828,'amu*angstrom^2'), symmetry=1, barrier=(54.9113,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58908,0.0663698,-3.1343e-05,-1.08566e-07,1.37028e-10,-26132.9,26.4436], Tmin=(100,'K'), Tmax=(442.837,'K')), NASAPolynomial(coeffs=[7.67707,0.0370491,-1.89776e-05,3.71841e-09,-2.60111e-13,-26923.8,-0.810316], Tmin=(442.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CJCOOH)"""),
)

species(
    label = 'CCOOC(F)=[C]F(11460)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-162.301,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,293,496,537,1218,167,640,1190,180,1271.61],'cm^-1')),
        HinderedRotor(inertia=(0.215414,'amu*angstrom^2'), symmetry=1, barrier=(4.95278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214633,'amu*angstrom^2'), symmetry=1, barrier=(4.93484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214671,'amu*angstrom^2'), symmetry=1, barrier=(4.93572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.25985,'amu*angstrom^2'), symmetry=1, barrier=(51.9584,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.681776,0.0826023,-0.000131752,1.23669e-07,-4.62795e-11,-19410.2,28.4706], Tmin=(100,'K'), Tmax=(797.028,'K')), NASAPolynomial(coeffs=[5.48987,0.0412231,-2.1414e-05,4.22462e-09,-2.96978e-13,-19628.7,9.80219], Tmin=(797.028,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = 'CCO[O+]=[C-]C(F)F(7205)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.457757,0.0908525,-0.000152894,1.4852e-07,-5.58182e-11,-37078.7,38.935], Tmin=(100,'K'), Tmax=(830.592,'K')), NASAPolynomial(coeffs=[3.63209,0.0475899,-2.42416e-05,4.70758e-09,-3.26496e-13,-36641,30.019], Tmin=(830.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OOCC(11461)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
4  O u0 p2 c0 {3,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.309651,0.0889607,-0.000124039,9.97268e-08,-3.33584e-11,-27778.2,26.4432], Tmin=(100,'K'), Tmax=(723.375,'K')), NASAPolynomial(coeffs=[9.36212,0.0389006,-2.02268e-05,4.04709e-09,-2.89192e-13,-29087.8,-14.2978], Tmin=(723.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-232.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCFFO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'CCOOC(F)[C]F(7206)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {5,S}
4  O u0 p2 c0 {3,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.981655,'amu*angstrom^2'), symmetry=1, barrier=(22.5702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53881,'amu*angstrom^2'), symmetry=1, barrier=(35.3803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.974637,'amu*angstrom^2'), symmetry=1, barrier=(22.4088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.98061,'amu*angstrom^2'), symmetry=1, barrier=(22.5461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55926,'amu*angstrom^2'), symmetry=1, barrier=(35.8505,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.861358,0.0753003,-7.92392e-05,4.62581e-08,-1.14436e-11,-32455.5,26.3716], Tmin=(100,'K'), Tmax=(952.164,'K')), NASAPolynomial(coeffs=[10.0489,0.0367029,-1.84333e-05,3.68339e-09,-2.64939e-13,-34205,-17.5025], Tmin=(952.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-270.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0415039,'amu*angstrom^2'), symmetry=1, barrier=(2.59683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.653443,'amu*angstrom^2'), symmetry=1, barrier=(15.0239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71546,'amu*angstrom^2'), symmetry=1, barrier=(39.4418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71238,'amu*angstrom^2'), symmetry=1, barrier=(39.3711,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24893,0.0665917,-8.52644e-05,6.61727e-08,-2.19788e-11,6345.09,23.1666], Tmin=(100,'K'), Tmax=(721.071,'K')), NASAPolynomial(coeffs=[7.12618,0.0339932,-1.74606e-05,3.49292e-09,-2.50227e-13,5497.4,-3.26654], Tmin=(721.071,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.979,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'COOC(F)=CF(9106)'],
    products = ['CCOOC(F)=CF(11279)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'CCOO[C]=CF(11457)'],
    products = ['CCOOC(F)=CF(11279)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=C(F)OOCC(11458)'],
    products = ['CCOOC(F)=CF(11279)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C(F)[CH]F(980)', 'CC[O](3057)'],
    products = ['CCOOC(F)=CF(11279)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]OC(F)=CF(979)', 'C2H5(32)'],
    products = ['CCOOC(F)=CF(11279)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHFCF[Z](72)', 'CCO[O](3221)'],
    products = ['CCOOC(F)=CF(11279)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', '[CH2]OOC(F)=CF(10297)'],
    products = ['CCOOC(F)=CF(11279)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C[CH]OOC(F)=CF(11388)'],
    products = ['CCOOC(F)=CF(11279)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]COOC(F)=CF(11459)'],
    products = ['CCOOC(F)=CF(11279)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CCOOC(F)=[C]F(11460)'],
    products = ['CCOOC(F)=CF(11279)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CHF(40)', 'CCO[O+]=[C-]F(11462)'],
    products = ['CCOOC(F)=CF(11279)'],
