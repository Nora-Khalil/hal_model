...
"""),
    E0 = (-778.998,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,326,540,652,719,1357,190,488,555,1236,1407,2950,3100,1380,975,1025,1650,225.853,225.853,225.853,225.853],'cm^-1')),
        HinderedRotor(inertia=(0.70855,'amu*angstrom^2'), symmetry=1, barrier=(25.6477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.70855,'amu*angstrom^2'), symmetry=1, barrier=(25.6477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.708552,'amu*angstrom^2'), symmetry=1, barrier=(25.6477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.408642,0.0787568,-8.73367e-05,4.71948e-08,-1.0057e-11,-93562.2,26.8049], Tmin=(100,'K'), Tmax=(1138.54,'K')), NASAPolynomial(coeffs=[17.0525,0.0202817,-1.02963e-05,2.08372e-09,-1.51461e-13,-97352.1,-55.6515], Tmin=(1138.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-778.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'FC=C(F)OC(F)[C](F)F(10435)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-945.869,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,326,540,652,719,1357,190,488,555,1236,1407,194,682,905,1196,1383,3221,259.43,259.984,260.026,260.292],'cm^-1')),
        HinderedRotor(inertia=(0.657716,'amu*angstrom^2'), symmetry=1, barrier=(31.5024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.361888,'amu*angstrom^2'), symmetry=1, barrier=(17.2023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.553217,'amu*angstrom^2'), symmetry=1, barrier=(26.4383,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0960127,0.0902825,-0.000114527,7.16611e-08,-1.77481e-11,-113625,28.7093], Tmin=(100,'K'), Tmax=(983.281,'K')), NASAPolynomial(coeffs=[16.51,0.0235112,-1.26681e-05,2.60188e-09,-1.89973e-13,-116853,-50.2023], Tmin=(983.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-945.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)
...
species(
    label = 'FC[C](F)O[C](F)C(F)F(10436)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-895.882,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,395,473,707,1436,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-924.586,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,190,488,555,1236,1407,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(F)(F)OC(F)[C](F)F(2849)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-925.989,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,3000,3100,440,815,1455,1000,219.943,219.945,219.946,219.946],'cm^-1')),
        HinderedRotor(inertia=(0.276178,'amu*angstrom^2'), symmetry=1, barrier=(9.48084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00348462,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.993637,'amu*angstrom^2'), symmetry=1, barrier=(34.1097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.993588,'amu*angstrom^2'), symmetry=1, barrier=(34.1097,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0803308,0.0979336,-0.000138329,1.02246e-07,-3.04741e-11,-111231,31.2906], Tmin=(100,'K'), Tmax=(816.5,'K')), NASAPolynomial(coeffs=[13.3505,0.0321373,-1.74559e-05,3.55552e-09,-2.56823e-13,-113424,-30.7828], Tmin=(816.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-925.989,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)

species(
    label = '[CH2][C](F)OC(F)C(F)(F)F(2847)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-947.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,193,295,551,588,656,1146,1192,1350,395,473,707,1436,3000,3100,440,815,1455,1000,277.053,277.294,277.911,2145.89],'cm^-1')),
        HinderedRotor(inertia=(0.169018,'amu*angstrom^2'), symmetry=1, barrier=(9.15754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.60177,'amu*angstrom^2'), symmetry=1, barrier=(32.622,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168626,'amu*angstrom^2'), symmetry=1, barrier=(9.17378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.603573,'amu*angstrom^2'), symmetry=1, barrier=(32.6339,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.199273,0.101912,-0.000153153,1.16767e-07,-3.36421e-11,-113760,31.5314], Tmin=(100,'K'), Tmax=(645.242,'K')), NASAPolynomial(coeffs=[12.8748,0.0321533,-1.72328e-05,3.45303e-09,-2.45629e-13,-115682,-27.6366], Tmin=(645.242,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-947.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFHO) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FC[C](F)OC(F)[C](F)F(10058)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)[C](F)F(1163)', 'F[C]CF-2(467)'],
    products = ['FC[C](F)OC(F)[C](F)F(10058)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', 'F[CH]O[C](F)CF(1130)'],
    products = ['FC[C](F)OC(F)[C](F)F(10058)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['FC[C](F)OC(F)[C](F)F(10058)'],
    products = ['FCC(F)OC(F)=C(F)F(10433)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FC[C](F)OC(F)[C](F)F(10058)'],
    products = ['FC=C(F)OC(F)C(F)F(10061)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC[C](F)OC=C(F)F(10036)'],
    products = ['FC[C](F)OC(F)[C](F)F(10058)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC[C](F)OC(F)=C(F)F(10434)'],
    products = ['FC[C](F)OC(F)[C](F)F(10058)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)OC(F)[C](F)F(6561)'],
    products = ['FC[C](F)OC(F)[C](F)F(10058)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC=C(F)OC(F)[C](F)F(10435)'],
    products = ['FC[C](F)OC(F)[C](F)F(10058)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)[C](F)F(1163)', 'F[C]CF(125)'],
    products = ['FC[C](F)OC(F)[C](F)F(10058)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', 'F[CH]O[C](F)CF(1130)'],
    products = ['FC[C](F)OC(F)[C](F)F(10058)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FC[C](F)OC(F)[C](F)F(10058)'],
    products = ['FC[C](F)O[C](F)C(F)F(10436)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FCC(F)O[C](F)[C](F)F(10437)'],
    products = ['FC[C](F)OC(F)[C](F)F(10058)'],
...
reaction(
    label = 'reaction19',
    reactants = ['FC[C](F)OC(F)[C](F)F(10058)'],
    products = ['F[CH][C](F)OC(F)C(F)F(6470)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FC[C](F)OC(F)[C](F)F(10058)'],
    products = ['FCC(F)(F)O[CH][C](F)F(2850)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FC[C](F)OC(F)[C](F)F(10058)'],
    products = ['[CH2]C(F)(F)OC(F)[C](F)F(2849)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FC[C](F)OC(F)[C](F)F(10058)'],
    products = ['[CH2][C](F)OC(F)C(F)(F)F(2847)'],
