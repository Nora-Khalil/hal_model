...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]C([O])=O(296)'],
    products = ['[O]C(=O)C[C]=O(566)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C=C=O(1293)'],
    products = ['[O]C(=O)C[C]=O(566)'],
