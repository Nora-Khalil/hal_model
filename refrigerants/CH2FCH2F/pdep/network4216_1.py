...
species(
    label = 'F[C]1OC(F)([C](F)F)C1F(12856)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'FC1=C(C(F)(F)C(F)F)O1(12857)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
species(
    label = 'O=C(F)[CH]C(F)(F)[C](F)F(12858)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)(F)C1=C(F)O1(12859)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C]1O[C]1C(F)=C(F)F(12860)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {9,S}
...
species(
    label = 'F[C]1O[C]1C(F)(F)C(F)F(12861)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C](F)[C](F)C1OC1(F)F(12862)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C]1OC1[C](F)C(F)(F)F(12863)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
    products = ['F[C]1OC(F)([C](F)F)C1F(12856)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', 'F[C](F)C1O[C]1F(9280)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
    products = ['FC1=C(C(F)(F)C(F)F)O1(12857)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)[CH]C(F)(F)[C](F)F(12858)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C](F)C(F)(F)C1=C(F)O1(12859)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[C]1OC1C(F)=C(F)F(9560)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[C]1O[C]1C(F)=C(F)F(12860)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', 'F[C](F)C1O[C]1F(9280)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
    products = ['F[C]1O[C]1C(F)(F)C(F)F(12861)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
    products = ['F[C](F)[C](F)C1OC1(F)F(12862)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
    products = ['F[C]1OC1[C](F)C(F)(F)F(12863)'],
...
network(
    label = 'PDepNetwork #4216',
    isomers = [
        'F[C]1OC1C(F)(F)[C](F)F(12643)',
    ],
    reactants = [
