...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)[CH]F(502)'],
    products = ['O=O(141)', 'CHFCHF[Z](59)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[O]O[CH]F(287)'],
    products = ['[O]OC(F)[CH]F(502)'],
    transitionState = 'TS3',
