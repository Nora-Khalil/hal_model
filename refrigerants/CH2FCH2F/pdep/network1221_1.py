...
reaction(
    label = 'reaction2',
    reactants = ['[O]C=C([O])OF(2624)'],
    products = ['[O]C(=O)C([O])F(2554)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C(=O)F(2426)'],
    products = ['[O]C(=O)C([O])F(2554)'],
