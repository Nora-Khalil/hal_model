...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(368)', '[CH2]C([O])(F)F(475)'],
    products = ['[CH2]C(F)(F)O[C]=C(684)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C](F)F(851)'],
    products = ['[CH2]C(F)(F)O[C]=C(684)'],
    transitionState = 'TS3',
