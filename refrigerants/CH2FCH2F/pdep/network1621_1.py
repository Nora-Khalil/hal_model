...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])F(139)', '[CH]C-2(510)'],
    products = ['[CH2]C(F)O[CH]C(3571)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[CH]F(3340)'],
    products = ['[CH2]C(F)O[CH]C(3571)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)O[CH]C(3475)'],
    products = ['[CH2]C(F)O[CH]C(3571)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)OC=C(3612)'],
    products = ['[CH2]C(F)O[CH]C(3571)'],
