species(
    label = 'F[CH]C(F)(F)O[C](F)CF(10056)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.08114,'amu*angstrom^2'), symmetry=1, barrier=(24.8575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0808,'amu*angstrom^2'), symmetry=1, barrier=(24.8498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08121,'amu*angstrom^2'), symmetry=1, barrier=(24.8591,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0978985,0.0861374,-0.000104841,6.20045e-08,-1.43252e-11,-96006.8,26.054], Tmin=(100,'K'), Tmax=(1059.79,'K')), NASAPolynomial(coeffs=[18.0018,0.0185632,-9.19981e-06,1.84171e-09,-1.33218e-13,-99801.7,-61.3619], Tmin=(1059.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-799.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)
...
species(
    label = 'F[CH]C(F)(F)OC(F)=CF(10452)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[CH][C](F)OC(F)(F)CF(10453)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.869162,0.11662,-0.000196917,1.68234e-07,-5.60292e-11,-109171,32.0511], Tmin=(100,'K'), Tmax=(816.03,'K')), NASAPolynomial(coeffs=[14.6403,0.0292708,-1.55375e-05,3.04621e-09,-2.11814e-13,-111325,-37.3097], Tmin=(816.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-909.083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
species(
    label = '[CH2]C(F)(F)OC(F)(F)[CH]F(10454)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.481008,0.106505,-0.000160575,1.23957e-07,-3.79962e-11,-113672,30.8532], Tmin=(100,'K'), Tmax=(799.595,'K')), NASAPolynomial(coeffs=[14.9579,0.0292706,-1.56843e-05,3.15172e-09,-2.25012e-13,-116141,-40.1774], Tmin=(799.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-946.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFO) + group(Cs-CsHHH) + group(CsCsFHH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Csj(Cs-F1sF1sO2s)(F1s)(H))"""),
)

species(
    label = '[CH2][C](F)OC(F)(F)C(F)F(10455)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)[CH]F(2198)', 'F[C]CF-2(467)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'FC[C](F)O[C](F)F(2217)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
    products = ['FC=C(F)OC(F)(F)CF(10062)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC=C(F)O[C](F)CF(10129)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)OC(F)(F)[CH]F(6562)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]C(F)(F)OC(F)=CF(10452)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)(F)[CH]F(2198)', 'F[C]CF(125)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'FC[C](F)O[C](F)F(2217)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
    products = ['F[CH][C](F)OC(F)(F)CF(10453)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FC[C](F)O[C](F)C(F)F(10436)'],
    products = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
    products = ['[CH2]C(F)(F)OC(F)(F)[CH]F(10454)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)O[C](F)CF(10056)'],
    products = ['[CH2][C](F)OC(F)(F)C(F)F(10455)'],
