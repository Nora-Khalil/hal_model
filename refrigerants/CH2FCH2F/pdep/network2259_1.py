...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)=COOCF(5987)'],
    products = ['CHFO(47)', '[O]OC(F)C=O(2464)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[O]OC(F)=COO(6254)'],
    products = ['[O]OC(F)=COOCF(5987)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]OC(F)=COOF(6255)'],
    products = ['[O]OC(F)=COOCF(5987)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=C(F)[CH]OOCF(6257)'],
    products = ['[O]OC(F)=COOCF(5987)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]OC(F)=COOCF(5987)'],
    products = ['[O]CF(180)', 'FC1=COOO1(6258)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]OC(F)=COOCF(5987)'],
    products = ['FCOO[CH]C1(F)OO1(6260)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]OOC=C(F)O[O](6261)'],
    products = ['[O]OC(F)=COOCF(5987)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]O[C]=COOCF(6262)'],
    products = ['[O]OC(F)=COOCF(5987)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]CF(180)', '[O]O[C](F)C=O(1683)'],
    products = ['[O]OC(F)=COOCF(5987)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2F(46)', '[O]OC=C(F)O[O](6263)'],
    products = ['[O]OC(F)=COOCF(5987)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OCF(414)', '[CH]=C(F)O[O](470)'],
    products = ['[O]OC(F)=COOCF(5987)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]OC(F)=COO[CH]F(6264)'],
    products = ['[O]OC(F)=COOCF(5987)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]OC(F)=[C]OOCF(6265)'],
    products = ['[O]OC(F)=COOCF(5987)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[O]OC#COOCF(6266)'],
    products = ['[O]OC(F)=COOCF(5987)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]OOC=C(F)OOF(6269)'],
    products = ['[O]OC(F)=COOCF(5987)'],
