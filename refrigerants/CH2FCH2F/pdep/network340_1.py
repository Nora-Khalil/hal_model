...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(368)', 'C=[C]O[O](452)'],
    products = ['C=[C]OO[C]=C(651)'],
    transitionState = 'TS2',
