...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(788)', 'O[C]F(5653)'],
    products = ['O[C](F)OO[C](F)F(12232)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[O]O[C](O)F(1125)'],
    products = ['O[C](F)OO[C](F)F(12232)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[C](F)F(788)', '[OH+]=[C-]F(1375)'],
    products = ['O[C](F)OO[C](F)F(12232)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[O]O[C](O)F(1125)'],
    products = ['O[C](F)OO[C](F)F(12232)'],
