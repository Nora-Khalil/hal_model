...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C1O[C]1F(9209)'],
    products = ['[O]CC1O[C]1F(9313)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]CC1=C(F)O1(9482)'],
    products = ['[O]CC1O[C]1F(9313)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CC1O[C]1F(9427)'],
    products = ['[O]CC1O[C]1F(9313)'],
