...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.807922,'amu*angstrom^2'), symmetry=1, barrier=(18.5757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.807324,'amu*angstrom^2'), symmetry=1, barrier=(18.562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.807996,'amu*angstrom^2'), symmetry=1, barrier=(18.5774,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.690337,0.0676243,-7.90371e-05,4.4893e-08,-9.79495e-12,12437.8,21.861], Tmin=(100,'K'), Tmax=(1134.52,'K')), NASAPolynomial(coeffs=[16.8462,0.0106626,-3.72489e-06,6.37605e-10,-4.28405e-14,8772,-58.1207], Tmin=(1134.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(102.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCsJOC(O)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    E0 = (63.7791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,167,640,1190,201.841,201.844,201.846],'cm^-1')),
        HinderedRotor(inertia=(0.743553,'amu*angstrom^2'), symmetry=1, barrier=(21.4961,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (104.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2175,525,239,401,1367,276.789,277.158,280.426],'cm^-1')),
        HinderedRotor(inertia=(0.357619,'amu*angstrom^2'), symmetry=1, barrier=(20.0412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362762,'amu*angstrom^2'), symmetry=1, barrier=(20.0334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374141,'amu*angstrom^2'), symmetry=1, barrier=(20.0531,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.82124,0.0616672,-6.98524e-05,3.74579e-08,-7.6337e-12,12691.1,19.3196], Tmin=(100,'K'), Tmax=(1240.71,'K')), NASAPolynomial(coeffs=[17.679,0.00636234,-1.83388e-06,2.88645e-10,-1.90447e-14,8581.61,-65.3489], Tmin=(1240.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(CtCF) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]COC=[C]F(5863)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    E0 = (120.047,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,167,640,1190,316.639,316.696,316.788],'cm^-1')),
        HinderedRotor(inertia=(0.249493,'amu*angstrom^2'), symmetry=1, barrier=(17.774,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249583,'amu*angstrom^2'), symmetry=1, barrier=(17.7738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249794,'amu*angstrom^2'), symmetry=1, barrier=(17.7745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.958265,0.0627873,-6.96823e-05,3.84962e-08,-8.26929e-12,14551.4,22.06], Tmin=(100,'K'), Tmax=(1144.76,'K')), NASAPolynomial(coeffs=[15.0516,0.0135422,-5.15497e-06,9.17473e-10,-6.25479e-14,11324.8,-47.8375], Tmin=(1144.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CJCO) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    E0 = (155.601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,167,640,1190,273.982,273.994,274.01],'cm^-1')),
        HinderedRotor(inertia=(0.272339,'amu*angstrom^2'), symmetry=1, barrier=(14.5047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272249,'amu*angstrom^2'), symmetry=1, barrier=(14.5047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272267,'amu*angstrom^2'), symmetry=1, barrier=(14.5046,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25337,0.0612996,-7.24185e-05,4.47846e-08,-1.10228e-11,18812.7,20.9059], Tmin=(100,'K'), Tmax=(990.828,'K')), NASAPolynomial(coeffs=[11.777,0.0188161,-8.10461e-06,1.51254e-09,-1.04876e-13,16727.2,-29.768], Tmin=(990.828,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-Cs)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(1627)', '[CH]C-2(510)'],
    products = ['C[CH]OC=[C]F(5786)'],
    transitionState = 'TS2',
