...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', 'C=C[C]F(1939)'],
    products = ['O=[C]CC=[C]F(2006)'],
    transitionState = 'TS3',
