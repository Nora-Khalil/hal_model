...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.5988,'amu*angstrom^2'), symmetry=1, barrier=(36.7596,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59556,'amu*angstrom^2'), symmetry=1, barrier=(36.6852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60382,'amu*angstrom^2'), symmetry=1, barrier=(36.875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60148,'amu*angstrom^2'), symmetry=1, barrier=(36.8213,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.824496,0.073691,-8.04041e-05,4.47606e-08,-1.01206e-11,-29731.6,23.8444], Tmin=(100,'K'), Tmax=(1057.69,'K')), NASAPolynomial(coeffs=[13.2365,0.0267512,-1.38351e-05,2.80211e-09,-2.03179e-13,-32357.3,-36.7325], Tmin=(1057.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.65499,0.029663,-3.34487e-05,1.90151e-08,-4.28754e-12,22824.1,11.7003], Tmin=(100,'K'), Tmax=(1077.67,'K')), NASAPolynomial(coeffs=[8.36422,0.00847193,-3.95297e-06,7.68441e-10,-5.46336e-14,21593.6,-16.2705], Tmin=(1077.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.60089,'amu*angstrom^2'), symmetry=1, barrier=(36.8075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60044,'amu*angstrom^2'), symmetry=1, barrier=(36.7974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60115,'amu*angstrom^2'), symmetry=1, barrier=(36.8137,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3063.83,'J/mol'), sigma=(5.14337,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=478.56 K, Pc=51.09 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97411,0.0483843,-5.32218e-05,3.14713e-08,-7.74837e-12,-2942.97,18.0148], Tmin=(100,'K'), Tmax=(964.525,'K')), NASAPolynomial(coeffs=[8.54337,0.0211408,-1.08534e-05,2.18678e-09,-1.57972e-13,-4210.21,-13.4408], Tmin=(964.525,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.0494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsFHHO) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (-258.597,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,2175,525,750,770,3400,2100,180],'cm^-1')),
        HinderedRotor(inertia=(1.39515,'amu*angstrom^2'), symmetry=1, barrier=(32.0773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39598,'amu*angstrom^2'), symmetry=1, barrier=(32.0964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39545,'amu*angstrom^2'), symmetry=1, barrier=(32.0841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3945,'amu*angstrom^2'), symmetry=1, barrier=(32.0622,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.587178,0.0815924,-0.000111257,8.18287e-08,-2.44904e-11,-30984.9,24.9491], Tmin=(100,'K'), Tmax=(811.04,'K')), NASAPolynomial(coeffs=[11.0864,0.0298091,-1.54818e-05,3.10036e-09,-2.21993e-13,-32687.9,-23.5046], Tmin=(811.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (-93.6877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.56436,'amu*angstrom^2'), symmetry=1, barrier=(35.9677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.5628,'amu*angstrom^2'), symmetry=1, barrier=(35.9318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.785662,'amu*angstrom^2'), symmetry=1, barrier=(18.0639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.786801,'amu*angstrom^2'), symmetry=1, barrier=(18.0901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.357945,0.0892419,-0.000147489,1.33659e-07,-4.80945e-11,-11145.7,26.4439], Tmin=(100,'K'), Tmax=(789.261,'K')), NASAPolynomial(coeffs=[8.5697,0.0345112,-1.85502e-05,3.69709e-09,-2.60986e-13,-12033.5,-8.64222], Tmin=(789.261,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.6877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COOC(F)CF(4939)'],
    products = ['CH2CO(28)', 'O=C(F)CF(476)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(13.156,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F[C]CF(125)', 'C#COO(1351)'],
    products = ['C#COOC(F)CF(4939)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'C#COOC(F)[C]F-2(7271)'],
    products = ['C#COOC(F)CF(4939)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'C#COOC(F)F(2143)'],
    products = ['C#COOC(F)CF(4939)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#COO[CH]CF(940)'],
    products = ['C#COOC(F)CF(4939)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#COOC([CH2])F(667)'],
    products = ['C#COOC(F)CF(4939)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['C2H(22)', '[O]OC(F)CF(495)'],
    products = ['C#COOC(F)CF(4939)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2F(46)', 'C#COO[CH]F(930)'],
    products = ['C#COOC(F)CF(4939)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#COO[C](F)CF(7272)'],
    products = ['C#COOC(F)CF(4939)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#COOC(F)[CH]F(4639)'],
    products = ['C#COOC(F)CF(4939)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[C]#COOC(F)CF(7273)'],
    products = ['C#COOC(F)CF(4939)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C#COOC(=C)F(934)'],
    products = ['C#COOC(F)CF(4939)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COOC=CF(2532)'],
    products = ['C#COOC(F)CF(4939)'],
