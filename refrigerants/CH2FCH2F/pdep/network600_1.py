...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.49589,'amu*angstrom^2'), symmetry=1, barrier=(11.4015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386416,'amu*angstrom^2'), symmetry=1, barrier=(8.88447,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'F[C]C(F)OF(1513)'],
    products = ['CC(F)C(F)OF(1511)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(140)', 'CC(F)[C]F(1515)'],
    products = ['CC(F)C(F)OF(1511)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[CH]C(F)OF(1521)'],
    products = ['CC(F)C(F)OF(1511)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)[CH]OF(1522)'],
    products = ['CC(F)C(F)OF(1511)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC(F)C([O])F(1523)'],
    products = ['CC(F)C(F)OF(1511)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(127)', 'CC(F)[CH]F(1491)'],
    products = ['CC(F)C(F)OF(1511)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(1060)', 'CH3-CHF(63)'],
    products = ['CC(F)C(F)OF(1511)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'F[CH]C(F)OF(1524)'],
    products = ['CC(F)C(F)OF(1511)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C[C](F)C(F)OF(1525)'],
    products = ['CC(F)C(F)OF(1511)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'CC(F)[C](F)OF(1526)'],
    products = ['CC(F)C(F)OF(1511)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(F)C(F)OF(1527)'],
    products = ['CC(F)C(F)OF(1511)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'CC(F)C(=O)F(1090)'],
    products = ['CC(F)C(F)OF(1511)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'CC=C(F)OF(1530)'],
    products = ['CC(F)C(F)OF(1511)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'C=CC(F)OF(1531)'],
    products = ['CC(F)C(F)OF(1511)'],
