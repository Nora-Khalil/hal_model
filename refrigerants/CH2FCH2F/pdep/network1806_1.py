...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=CO[CH]OF(4256)'],
    products = ['O=COC(F)OF(4089)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)OC=O(4257)'],
    products = ['O=COC(F)OF(4089)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]OF(1060)', '[O]C=O(159)'],
    products = ['O=COC(F)OF(4089)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HCO(15)', '[O]C(F)OF(3643)'],
    products = ['O=COC(F)OF(4089)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(127)', 'O=CO[CH]F(1174)'],
    products = ['O=COC(F)OF(4089)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CO[C](F)OF(3683)'],
    products = ['O=COC(F)OF(4089)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]OC(F)OF(4258)'],
    products = ['O=COC(F)OF(4089)'],
