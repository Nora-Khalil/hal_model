...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OOC(F)=CF(978)'],
    products = ['COOC(F)=CF(9106)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(F)OOC(10510)'],
    products = ['COOC(F)=CF(9106)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3O(27)', 'O=C(F)[CH]F(980)'],
    products = ['COOC(F)=CF(9106)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[O]OC(F)=CF(979)'],
    products = ['COOC(F)=CF(9106)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]OOC(F)=CF(10297)'],
    products = ['COOC(F)=CF(9106)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'COOC(F)=[C]F(10511)'],
    products = ['COOC(F)=CF(9106)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF(40)', 'CO[O+]=[C-]F(10513)'],
    products = ['COOC(F)=CF(9106)'],
