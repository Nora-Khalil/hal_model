...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C[C]=O(515)'],
    products = ['O=[C]CO[C]=O(569)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]O[C]=O(275)'],
    products = ['O=[C]CO[C]=O(569)'],
    transitionState = 'TS3',
