...
"""),
    E0 = (-1238.55,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,482,664,788,1296,1923,186.164,186.682,187.369,976.476],'cm^-1')),
        HinderedRotor(inertia=(0.799596,'amu*angstrom^2'), symmetry=1, barrier=(19.7944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.806144,'amu*angstrom^2'), symmetry=1, barrier=(19.7944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.84227,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.804601,'amu*angstrom^2'), symmetry=1, barrier=(19.7911,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.660044,0.077476,-9.15762e-05,5.48378e-08,-1.31837e-11,-148846,26.4393], Tmin=(100,'K'), Tmax=(1004.84,'K')), NASAPolynomial(coeffs=[13.9094,0.0247351,-1.2848e-05,2.60665e-09,-1.89193e-13,-151509,-37.5457], Tmin=(1004.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1238.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COFOO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.988164,'amu*angstrom^2'), symmetry=1, barrier=(22.7198,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.988081,'amu*angstrom^2'), symmetry=1, barrier=(22.7179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.988183,'amu*angstrom^2'), symmetry=1, barrier=(22.7203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70365,'amu*angstrom^2'), symmetry=1, barrier=(39.1702,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.684474,0.0788565,-0.000115577,8.52606e-08,-2.49417e-11,-106535,27.2933], Tmin=(100,'K'), Tmax=(836.706,'K')), NASAPolynomial(coeffs=[12.8243,0.0208191,-1.15292e-05,2.35647e-09,-1.7028e-13,-108566,-29.11], Tmin=(836.706,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-886.731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFOO) + group(COFOO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.782514,0.075634,-9.16215e-05,5.75715e-08,-1.46348e-11,-150284,26.8607], Tmin=(100,'K'), Tmax=(949.791,'K')), NASAPolynomial(coeffs=[12.5321,0.0261509,-1.34728e-05,2.71805e-09,-1.96454e-13,-152516,-29.219], Tmin=(949.791,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1250.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCFFO) + group(COFOO)"""),
)

species(
    label = 'O=C(F)OC(F)(F)CO(10626)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  O u0 p2 c0 {7,S} {9,S}
...
"""),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.78251,0.075634,-9.16216e-05,5.75716e-08,-1.46349e-11,-150284,26.8607], Tmin=(100,'K'), Tmax=(949.783,'K')), NASAPolynomial(coeffs=[12.5321,0.026151,-1.34729e-05,2.71805e-09,-1.96454e-13,-152516,-29.2189], Tmin=(949.783,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1250.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsOsHH) + group(COFOO)"""),
)
...
"""),
    E0 = (-757.739,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([373,336,502,477,708,1220,1477,528,1116,1182,1331,1402,1494,3075,3110,451,553,637,1069,1180,1265,1301,3056,245.959,246.78,246.97,249.185],'cm^-1')),
        HinderedRotor(inertia=(0.338557,'amu*angstrom^2'), symmetry=1, barrier=(14.4198,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165153,'amu*angstrom^2'), symmetry=1, barrier=(7.14801,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01518,'amu*angstrom^2'), symmetry=1, barrier=(44.6304,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.579356,0.0816393,-0.000110953,8.07882e-08,-2.38725e-11,-91017.5,28.4557], Tmin=(100,'K'), Tmax=(821.775,'K')), NASAPolynomial(coeffs=[11.3716,0.0291126,-1.50843e-05,3.02128e-09,-2.16441e-13,-92791.4,-21.4934], Tmin=(821.775,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-757.739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sCs)) + radical(O2sj(Cs-F1sO2sH))"""),
)

species(
    label = '[O]C(F)OC(O)(F)[CH]F(10629)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-815.403,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,451,553,637,1069,1180,1265,1301,3056,334,575,1197,1424,3202,195.132,195.16,195.167,195.171],'cm^-1')),
        HinderedRotor(inertia=(0.0044258,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.299126,'amu*angstrom^2'), symmetry=1, barrier=(8.08435,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54988,'amu*angstrom^2'), symmetry=1, barrier=(41.8926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435517,'amu*angstrom^2'), symmetry=1, barrier=(11.7764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.116995,0.0943768,-0.000141906,1.02693e-07,-2.58933e-11,-97939,29.8747], Tmin=(100,'K'), Tmax=(634.078,'K')), NASAPolynomial(coeffs=[13.1427,0.0261958,-1.37099e-05,2.70473e-09,-1.90109e-13,-99872.1,-29.2503], Tmin=(634.078,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-815.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)

species(
    label = '[O]C(F)(CF)O[C](O)F(10630)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-808.439,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,373,336,502,477,708,1220,1477,528,1116,1182,1331,1402,1494,3075,3110,482,586,761,1411,286.121,286.152,286.209,286.318],'cm^-1')),
        HinderedRotor(inertia=(0.48695,'amu*angstrom^2'), symmetry=1, barrier=(28.318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202233,'amu*angstrom^2'), symmetry=1, barrier=(11.7579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202278,'amu*angstrom^2'), symmetry=1, barrier=(11.7579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662598,'amu*angstrom^2'), symmetry=1, barrier=(38.4889,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.382908,0.0852132,-0.000114153,7.8424e-08,-2.15307e-11,-97107.4,29.4968], Tmin=(100,'K'), Tmax=(887.369,'K')), NASAPolynomial(coeffs=[13.6129,0.0255766,-1.33445e-05,2.68802e-09,-1.93532e-13,-99455.3,-32.7492], Tmin=(887.369,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-808.439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sCs)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = 'O[C](F)OC(O)(F)[CH]F(10631)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-979.873,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([373,336,502,477,708,1220,1477,528,1116,1182,1331,1402,1494,3075,3110,482,664,788,1296,1923,323.396,323.427,323.484,323.513],'cm^-1')),
        HinderedRotor(inertia=(0.147546,'amu*angstrom^2'), symmetry=1, barrier=(10.9612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458413,'amu*angstrom^2'), symmetry=1, barrier=(34.0416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458061,'amu*angstrom^2'), symmetry=1, barrier=(34.0396,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0149,0.0713051,-8.65512e-05,5.48589e-08,-1.41917e-11,-117749,25.9882], Tmin=(100,'K'), Tmax=(929.407,'K')), NASAPolynomial(coeffs=[11.4492,0.026399,-1.40777e-05,2.87499e-09,-2.09029e-13,-119688,-23.5878], Tmin=(929.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-979.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COFOO) + radical(O2sj(Cs-F1sO2sCs))"""),
)
...
"""),
    E0 = (-1037.54,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,334,575,1197,1424,3202,482,664,788,1296,1923,232.336,232.355,232.403,232.615],'cm^-1')),
        HinderedRotor(inertia=(0.874198,'amu*angstrom^2'), symmetry=1, barrier=(33.5178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.875333,'amu*angstrom^2'), symmetry=1, barrier=(33.5175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00617041,'amu*angstrom^2'), symmetry=1, barrier=(12.7447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.332165,'amu*angstrom^2'), symmetry=1, barrier=(12.7439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.34702,0.0869294,-0.00013054,1.00028e-07,-3.04384e-11,-124661,28.1195], Tmin=(100,'K'), Tmax=(805.221,'K')), NASAPolynomial(coeffs=[13.0585,0.0237763,-1.28813e-05,2.60198e-09,-1.86405e-13,-126708,-30.4504], Tmin=(805.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1037.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COFOO) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    ...
    products = ['O=C(F)OC(O)(F)CF(10086)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(F)OC(O)(F)[C]F(10624)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'O=C(F)OC(O)(F)F(3580)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)OC(O)(F)CF(10086)'],
    products = ['O=C(F)OCC(O)(F)F(10625)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)OC(O)(F)CF(10086)'],
    products = ['O=C(F)OC(F)(F)CO(10626)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'s^-1'), n=0, Ea=(299,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [OF]
Euclidian distance = 0
family: 1,2_XY_interchange"""),
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'O=C(F)OC(F)=CF(10627)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(140)', 'C=C(F)OC(=O)F(3818)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)OC([O])(F)CF(10628)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)OC(O)(F)[CH]F(10629)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)(CF)O[C](O)F(10630)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)OC(O)(F)[CH]F(10631)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O=C(F)O[C](O)CF(10632)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C(O)(F)OC(=O)F(10633)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=[C]OC(O)(F)CF(10634)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C(=O)F(161)', 'O[C](F)CF(9946)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CFO(51)', '[O]C(O)(F)CF(9948)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OH(7)', 'O=C(F)O[C](F)CF(10195)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[O]C(F)(CF)OC(=O)F(10635)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2F(46)', 'O=C(F)O[C](O)F(3749)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=C(F)OC(O)(F)[CH]F(10636)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(F)OC(O)(F)CF(10086)'],
    products = ['O=C(O)F(175)', 'O=C(F)CF(476)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=C(F)OC(O)(F)CF(10086)'],
    products = ['O=C(O)F(175)', 'OC(F)=CF(3655)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'O=C(F)OC(=O)CF(10637)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F2(78)', 'C=C(O)OC(=O)F(4088)'],
    products = ['O=C(F)OC(O)(F)CF(10086)'],
