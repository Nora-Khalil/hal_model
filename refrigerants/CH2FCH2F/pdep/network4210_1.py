species(
    label = 'F[C](F)C(F)C(F)(F)[C](F)F(12637)',
...
species(
    label = 'F[CH]C(F)(F)C(F)(F)[C](F)F(12636)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'FC1C(F)(F)C(F)(F)C1(F)F(12769)',
...
species(
    label = 'FC(F)=C(F)C(F)(F)C(F)F(12770)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)C(F)=C(F)F(6362)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)(F)C=C(F)F(12671)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)(F)C(F)=C(F)F(12771)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)=C(F)[C](F)F(12772)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)(F)[C](F)C(F)F(12773)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)[C](F)C(F)(F)C(F)F(12774)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[C](F)C(F)[C](F)C(F)(F)F(12775)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (182.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.312239,0.108043,-0.000196106,1.83258e-07,-6.59052e-11,-140608,34.7548], Tmin=(100,'K'), Tmax=(821.021,'K')), NASAPolynomial(coeffs=[9.44207,0.0360821,-1.99857e-05,3.99512e-09,-2.80575e-13,-141386,-5.36444], Tmin=(821.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1170.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sF1s)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[C](F)C(F)C(F)(F)F(12776)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (182.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.408419,0.115145,-0.000225952,2.18593e-07,-7.887e-11,-140041,34.6387], Tmin=(100,'K'), Tmax=(858.101,'K')), NASAPolynomial(coeffs=[7.28604,0.0385891,-2.10014e-05,4.1066e-09,-2.82239e-13,-139863,7.42365], Tmin=(858.101,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1165.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[CH]C(F)(F)C(F)(F)F(12777)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (182.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.277265,0.107842,-0.000197545,1.8634e-07,-6.74467e-11,-144970,34.5228], Tmin=(100,'K'), Tmax=(823.252,'K')), NASAPolynomial(coeffs=[8.85128,0.0371061,-2.05908e-05,4.11608e-09,-2.88952e-13,-145579,-2.31179], Tmin=(823.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1206.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)C(F)(F)[CH]C(F)(F)F(12778)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (182.039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.734544,0.120256,-0.000229195,2.16307e-07,-7.73234e-11,-145543,33.9774], Tmin=(100,'K'), Tmax=(839.155,'K')), NASAPolynomial(coeffs=[10.0786,0.0360744,-2.03775e-05,4.06248e-09,-2.83258e-13,-146208,-9.44641], Tmin=(839.155,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1211.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sF1s)(H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(12636)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', 'F[C](F)C(F)[C](F)F(6178)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', 'F[CH]C(F)(F)[C](F)F(6191)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    products = ['FC1C(F)(F)C(F)(F)C1(F)F(12769)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    products = ['FC(F)=C(F)C(F)(F)C(F)F(12770)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)C(F)C(F)=C(F)F(6362)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2CF2(61)', 'F[CH][C](F)F(3911)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)C(F)(F)C=C(F)F(12671)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)[C](F)F(3840)', 'CHFCF2(55)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)C(F)(F)C(F)=C(F)F(12771)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)[C](F)F(3840)', 'F[CH][C](F)F(3911)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', 'F[C](F)C=C(F)[C](F)F(6363)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[C](F)C(F)=C(F)[C](F)F(12772)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', 'F[C](F)C(F)[C](F)F(6178)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', 'F[CH]C(F)(F)[C](F)F(6191)'],
    products = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    products = ['F[C](F)C(F)(F)[C](F)C(F)F(12773)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    products = ['F[C](F)[C](F)C(F)(F)C(F)F(12774)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    products = ['F[C](F)C(F)[C](F)C(F)(F)F(12775)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    products = ['F[C](F)[C](F)C(F)C(F)(F)F(12776)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    products = ['F[C](F)[CH]C(F)(F)C(F)(F)F(12777)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)C(F)C(F)(F)[C](F)F(12637)'],
    products = ['F[C](F)C(F)(F)[CH]C(F)(F)F(12778)'],
...
network(
    label = 'PDepNetwork #4210',
    isomers = [
        'F[C](F)C(F)C(F)(F)[C](F)F(12637)',
    ],
    reactants = [
        ('CF2CF2(61)', 'CHFCF2(55)'),
    ],
