...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(127)', '[CH2]C(O)F(143)'],
    products = ['OC(F)COF(4111)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]F(459)', '[CH2]OF(179)'],
    products = ['OC(F)COF(4111)'],
