...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])(F)F(2271)'],
    products = ['[O]OC([O])(F)F(2147)'],
    transitionState = 'TS2',
