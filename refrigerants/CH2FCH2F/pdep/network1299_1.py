...
"""),
    E0 = (-450.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.0456761,'amu*angstrom^2'), symmetry=1, barrier=(50.0966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.304227,'amu*angstrom^2'), symmetry=1, barrier=(6.99477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17861,'amu*angstrom^2'), symmetry=1, barrier=(50.0906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17892,'amu*angstrom^2'), symmetry=1, barrier=(50.0978,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.701847,0.0791612,-0.000119536,1.00293e-07,-3.43292e-11,-54066.8,24.1972], Tmin=(100,'K'), Tmax=(723.409,'K')), NASAPolynomial(coeffs=[9.45528,0.0299491,-1.58127e-05,3.15588e-09,-2.24254e-13,-55312,-15.0522], Tmin=(723.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-450.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CsJOOC)"""),
)
...
"""),
    E0 = (-399.83,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.906618,'amu*angstrom^2'), symmetry=1, barrier=(20.8449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.01546,'amu*angstrom^2'), symmetry=1, barrier=(46.3394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20087,'amu*angstrom^2'), symmetry=1, barrier=(46.3607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.0158,'amu*angstrom^2'), symmetry=1, barrier=(46.3473,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01691,0.0720122,-8.8281e-05,5.74692e-08,-1.54087e-11,-47986.5,25.0776], Tmin=(100,'K'), Tmax=(894.609,'K')), NASAPolynomial(coeffs=[10.7399,0.0285386,-1.53887e-05,3.1497e-09,-2.29096e-13,-49726.1,-20.7474], Tmin=(894.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-399.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-OsHHH) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(CsJOOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OO[CH]C(F)(F)F(2729)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]O[O](418)', '[CH]C(F)(F)F(1545)'],
    products = ['[CH2]OO[CH]C(F)(F)F(2729)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]O[CH]C(F)(F)F(2887)'],
    products = ['[CH2]OO[CH]C(F)(F)F(2729)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH2]OO[CH]C(F)(F)F(2729)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(171.32,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    products = ['[CH2]OO[CH]C(F)(F)F(2729)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(10.7869,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction9',
    reactants = ['[CH2]OOC(F)[C](F)F(2993)'],
    products = ['[CH2]OO[CH]C(F)(F)F(2729)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(183.572,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #1299',
    isomers = [
        '[CH2]OO[CH]C(F)(F)F(2729)',
    ],
    reactants = [
        ('CH2O(20)', 'CF3CHO(75)'),
    ],
