...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(F)C([CH2])(F)F(1933)'],
    products = ['[CH]=C(F)C[C](F)F(1935)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH]C(=C)F(1947)'],
    products = ['[CH]=C(F)C[C](F)F(1935)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)C=C(F)F(1988)'],
    products = ['[CH]=C(F)C[C](F)F(1935)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH]C(=C)F(1947)'],
    products = ['[CH]=C(F)C[C](F)F(1935)'],
