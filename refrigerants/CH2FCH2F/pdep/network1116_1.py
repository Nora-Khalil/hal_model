...
reaction(
    label = 'reaction1',
    reactants = ['C#COOC[CH]F(2454)'],
    products = ['CH2CO(28)', 'O=C[CH]F(435)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]COOC#C-2(2529)'],
    products = ['C#COOC[CH]F(2454)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'C#COO[CH2](1312)'],
    products = ['C#COOC[CH]F(2454)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['HCCO(21)', '[O]C[CH]F(138)'],
    products = ['C#COOC[CH]F(2454)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C2H(22)', '[O]OC[CH]F(215)'],
    products = ['C#COOC[CH]F(2454)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#COO[CH][CH]F(2533)'],
    products = ['C#COOC[CH]F(2454)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[C]#COOC[CH]F(2534)'],
    products = ['C#COOC[CH]F(2454)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'C#COO[CH2](1312)'],
    products = ['C#COOC[CH]F(2454)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C#COOC[C]F-2(1769)'],
    products = ['C#COOC[CH]F(2454)'],
