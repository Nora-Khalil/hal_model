species(
    label = 'F[C](F)OO[CH]C(F)(F)F(2782)',
...
"""),
    E0 = (-872.835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,493,600,700,1144,1293,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.116083,'amu*angstrom^2'), symmetry=1, barrier=(2.66897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.54675,'amu*angstrom^2'), symmetry=1, barrier=(58.5547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.52211,'amu*angstrom^2'), symmetry=1, barrier=(57.9882,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0668266,0.0976829,-0.000161372,1.3888e-07,-4.74243e-11,-104839,30.3109], Tmin=(100,'K'), Tmax=(770.448,'K')), NASAPolynomial(coeffs=[12.1066,0.0286953,-1.57949e-05,3.16511e-09,-2.23964e-13,-106543,-24.13], Tmin=(770.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-872.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFFHO) + radical(CCsJOOC) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    E0 = (-822.193,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,493,600,700,1144,1293,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.713744,'amu*angstrom^2'), symmetry=1, barrier=(16.4104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92036,'amu*angstrom^2'), symmetry=1, barrier=(44.1528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92048,'amu*angstrom^2'), symmetry=1, barrier=(44.1556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92069,'amu*angstrom^2'), symmetry=1, barrier=(44.1604,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.227499,0.0907195,-0.000130492,9.62013e-08,-2.84502e-11,-98758,31.2695], Tmin=(100,'K'), Tmax=(823.909,'K')), NASAPolynomial(coeffs=[13.2305,0.0275916,-1.55627e-05,3.20694e-09,-2.32963e-13,-100901,-28.9439], Tmin=(823.909,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-822.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFHO) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)

species(
    label = 'F[C](F)[CH]OOC(F)(F)F(2926)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.137451,0.101143,-0.000176547,1.58156e-07,-5.52393e-11,-106507,31.7326], Tmin=(100,'K'), Tmax=(808.049,'K')), NASAPolynomial(coeffs=[11.1904,0.0300664,-1.6757e-05,3.34763e-09,-2.35313e-13,-107848,-17.473], Tmin=(808.049,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-886.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFFFO) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OO[CH]C(F)(F)F(2782)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(788)', '[CH]C(F)(F)F(1545)'],
    products = ['F[C](F)OO[CH]C(F)(F)F(2782)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[O]O[CH]C(F)(F)F(2887)'],
    products = ['F[C](F)OO[CH]C(F)(F)F(2782)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['F[C](F)OO[CH]C(F)(F)F(2782)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(179.097,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    products = ['F[C](F)OO[CH]C(F)(F)F(2782)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(244.847,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 242.0 to 244.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)OOC=C(F)F(2178)'],
    products = ['F[C](F)OO[CH]C(F)(F)F(2782)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['F[C](F)OO[CH]C(F)(F)F(2782)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(26.0512,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['CF2(43)', '[O]O[CH]C(F)(F)F(2887)'],
    products = ['F[C](F)OO[CH]C(F)(F)F(2782)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(14.3383,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['F[C](F)OOC(F)[C](F)F(2925)'],
    products = ['F[C](F)OO[CH]C(F)(F)F(2782)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)OO[CH]C(F)(F)F(2782)'],
    products = ['F[C](F)[CH]OOC(F)(F)F(2926)'],
