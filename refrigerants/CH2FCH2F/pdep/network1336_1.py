...
"""),
    E0 = (-659.348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,580,1155,1237,1373,3147,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.148489,'amu*angstrom^2'), symmetry=1, barrier=(3.41405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.49526,'amu*angstrom^2'), symmetry=1, barrier=(57.371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.49078,'amu*angstrom^2'), symmetry=1, barrier=(57.268,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.158248,0.0943499,-0.000163145,1.47709e-07,-5.22954e-11,-79172.4,28.2873], Tmin=(100,'K'), Tmax=(806.178,'K')), NASAPolynomial(coeffs=[9.79282,0.031223,-1.71782e-05,3.42527e-09,-2.40852e-13,-80227.9,-13.0298], Tmin=(806.178,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-659.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFHHO) + radical(CCsJOOC) + radical(CsF1sHO2s)"""),
)
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21737,0.0580885,-5.25919e-05,2.33056e-08,-4.1161e-12,-112018,23.6212], Tmin=(100,'K'), Tmax=(1349.69,'K')), NASAPolynomial(coeffs=[14.4613,0.0188384,-8.97076e-06,1.75937e-09,-1.25149e-13,-115593,-44.2444], Tmin=(1349.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-932.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFF) + ring(Cs-Cs(F)-O2s-O2s)"""),
)
...
"""),
    E0 = (-608.706,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,580,1155,1237,1373,3147,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.62635,'amu*angstrom^2'), symmetry=1, barrier=(37.3931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.666046,'amu*angstrom^2'), symmetry=1, barrier=(15.3137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.62208,'amu*angstrom^2'), symmetry=1, barrier=(37.2948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.62204,'amu*angstrom^2'), symmetry=1, barrier=(37.2938,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.302384,0.08935,-0.000140182,1.17191e-07,-3.95796e-11,-73084.8,29.773], Tmin=(100,'K'), Tmax=(723.2,'K')), NASAPolynomial(coeffs=[11.0531,0.029876,-1.68011e-05,3.43212e-09,-2.46902e-13,-74639.5,-18.6069], Tmin=(723.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-608.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFHHO) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(CsF1sHO2s)"""),
)

species(
    label = 'F[C](F)[CH]OOC(F)F(2889)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-653.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,519,593,830,1115,1166,1389,1413,3114,3025,407.5,1350,352.5,190,488,555,1236,1407,180,180],'cm^-1')),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149991,'amu*angstrom^2'), symmetry=1, barrier=(3.44858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42946,'amu*angstrom^2'), symmetry=1, barrier=(32.8661,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.108965,0.096461,-0.000170968,1.56765e-07,-5.56637e-11,-78450.8,30.2141], Tmin=(100,'K'), Tmax=(820.081,'K')), NASAPolynomial(coeffs=[9.45698,0.0316978,-1.7451e-05,3.46635e-09,-2.42621e-13,-79339.5,-9.1007], Tmin=(820.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-653.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFFHO) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OO[CH]C(F)(F)F(2768)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[CH]F(287)', '[CH]C(F)(F)F(1545)'],
    products = ['F[CH]OO[CH]C(F)(F)F(2768)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[O]O[CH]C(F)(F)F(2887)'],
    products = ['F[CH]OO[CH]C(F)(F)F(2768)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['F[CH]OO[CH]C(F)(F)F(2768)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(160.63,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    products = ['F[CH]OO[CH]C(F)(F)F(2768)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(234.018,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 232.6 to 234.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['F[CH]OO[CH]C(F)(F)F(2768)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(11.4669,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[O]O[CH]C(F)(F)F(2887)'],
    products = ['F[CH]OO[CH]C(F)(F)F(2768)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]OOC(F)[C](F)F(2888)'],
    products = ['F[CH]OO[CH]C(F)(F)F(2768)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)[CH]OOC(F)F(2889)'],
    products = ['F[CH]OO[CH]C(F)(F)F(2768)'],
