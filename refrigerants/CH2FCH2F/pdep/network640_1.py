...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]O[CH]F(318)'],
    products = ['[CH2]OC(F)[CH]F(1569)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(20)', 'F[CH][CH]F(493)'],
    products = ['[CH2]OC(F)[CH]F(1569)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](133)', 'CHFCHF[Z](59)'],
    products = ['[CH2]OC(F)[CH]F(1569)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=CF(1577)'],
    products = ['[CH2]OC(F)[CH]F(1569)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](133)', 'F[CH][CH]F(493)'],
    products = ['[CH2]OC(F)[CH]F(1569)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]O[CH]F(318)'],
    products = ['[CH2]OC(F)[CH]F(1569)'],
