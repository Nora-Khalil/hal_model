...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C(=O)F(427)'],
    products = ['[CH]=C(F)O[CH2](2133)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](133)', '[CH]=[C]F(465)'],
    products = ['[CH]=C(F)O[CH2](2133)'],
    transitionState = 'TS7',
