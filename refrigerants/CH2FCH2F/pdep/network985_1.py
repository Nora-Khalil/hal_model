...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]C([O])(F)F(475)'],
    products = ['[O]C(F)(F)C[CH]F(2150)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C[C](F)F(754)'],
    products = ['[O]C(F)(F)C[CH]F(2150)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C=CF(2190)'],
    products = ['[O]C(F)(F)C[CH]F(2150)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C[CH]F(552)'],
    products = ['[O]C(F)(F)C[CH]F(2150)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH2]C([O])(F)F(475)'],
    products = ['[O]C(F)(F)C[CH]F(2150)'],
