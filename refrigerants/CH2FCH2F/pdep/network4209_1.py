...
species(
    label = 'F[CH]C(F)(F)[C](F)C(F)(F)F(12779)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[CH][C](F)C(F)(F)C(F)(F)F(12780)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(12636)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', 'F[C](F)C(F)(F)[C](F)F(12680)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(12636)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)=C(F)F(6399)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(12636)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=C(F)C(F)(F)[C](F)F(12676)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(12636)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F2(78)', 'F[CH]C(F)=C(F)[C](F)F(6400)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(12636)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'F[C](F)C(F)(F)[C](F)F(12680)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C](F)F(12636)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(12636)'],
    products = ['F[CH]C(F)(F)[C](F)C(F)(F)F(12779)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C](F)F(12636)'],
    products = ['F[CH][C](F)C(F)(F)C(F)(F)F(12780)'],
...
network(
    label = 'PDepNetwork #4209',
    isomers = [
        'F[CH]C(F)(F)C(F)(F)[C](F)F(12636)',
    ],
    reactants = [
        ('CF2CF2(61)', 'CHFCF2(55)'),
    ],
