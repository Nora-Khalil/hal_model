...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[CH]=C[O](134)'],
    products = ['[CH]=CO[C]=O(3228)'],
    transitionState = 'TS2',
