...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(2271)', '[CH]F(223)'],
    products = ['[O]C(F)(F)O[CH]F(2331)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(F)O[CH]F(1175)'],
    products = ['[O]C(F)(F)O[CH]F(2331)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C([O])(F)F(2271)', 'CHF(40)'],
    products = ['[O]C(F)(F)O[CH]F(2331)'],
    transitionState = 'TS9',
