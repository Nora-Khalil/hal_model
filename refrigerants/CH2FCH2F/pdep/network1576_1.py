...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(127)', '[CH2]CCF(3529)'],
    products = ['FCCCOF(3517)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]OF(179)', 'CH2F-CH2(62)'],
    products = ['FCCCOF(3517)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2F(46)', '[CH2]COF(3453)'],
    products = ['FCCCOF(3517)'],
