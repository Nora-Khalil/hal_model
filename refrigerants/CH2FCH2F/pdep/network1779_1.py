...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C=COO(3912)'],
    products = ['C=COOCF(4064)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C=COOF(3913)'],
    products = ['C=COOCF(4064)'],
    transitionState = 'TS3',
