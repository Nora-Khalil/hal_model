species(
    label = 'FOC(F)(F)C(F)(F)C(F)F(12659)',
...
species(
    label = 'FOC(F)(C(F)F)C(F)(F)F(12819)',
    structure = adjacencyList("""1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
species(
    label = 'FO[C](F)C(F)(F)C(F)F(12820)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = '[O]C(F)(F)C(F)(F)C(F)F(9123)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'FOC(F)(F)C(F)(F)[C](F)F(12821)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.37021,'amu*angstrom^2'), symmetry=1, barrier=(8.51185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.370771,'amu*angstrom^2'), symmetry=1, barrier=(8.52474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.903123,'amu*angstrom^2'), symmetry=1, barrier=(20.7646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FOC(F)(F)C(F)F(3368)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF3(42)', 'F[C]C(F)(F)OF(2632)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(3367)', 'F[C]C(F)F-2(1828)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(1520)', 'F[C]C(F)(F)C(F)F(9119)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]C(F)(F)C(F)(F)OF(7014)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'FOC(F)(F)C(F)(F)F(7015)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
    products = ['FOC(F)(C(F)F)C(F)(F)F(12819)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(1520)', 'FC(F)=C(F)C(F)F(6315)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FOC(F)(F)[C](F)C(F)F(7122)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FO[C](F)C(F)(F)C(F)F(12820)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)(F)OF(7018)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(F)(F)C(F)F(9123)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'F[C](F)C(F)(F)C(F)F(9122)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(2145)', 'CHF2-CF2(69)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(82)', 'FOC(F)(F)[C](F)F(3370)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC(F)(F)C(F)(F)[C](F)F(12821)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'O=C(F)C(F)(F)C(F)F(9125)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', 'FOC(F)=C(F)C(F)F(7124)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', 'FC=C(F)C(F)(F)OF(7019)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'FOC(F)(F)C(F)=C(F)F(8885)'],
    products = ['FOC(F)(F)C(F)(F)C(F)F(12659)'],
...
network(
    label = 'PDepNetwork #4232',
    isomers = [
        'FOC(F)(F)C(F)(F)C(F)F(12659)',
    ],
    reactants = [
