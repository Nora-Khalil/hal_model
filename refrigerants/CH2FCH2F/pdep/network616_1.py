...
"""),
    E0 = (106.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,615,860,1140,1343,3152,1685,370,180,363.188,1930.67],'cm^-1')),
        HinderedRotor(inertia=(1.57698,'amu*angstrom^2'), symmetry=1, barrier=(36.2578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57721,'amu*angstrom^2'), symmetry=1, barrier=(36.2632,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32349,0.0445452,-4.96406e-05,-2.53843e-09,3.27677e-11,12831.2,13.9368], Tmin=(100,'K'), Tmax=(483.453,'K')), NASAPolynomial(coeffs=[7.1973,0.0180208,-1.01625e-05,2.06809e-09,-1.47663e-13,12198.7,-7.70226], Tmin=(483.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOF(7260)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {4,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (109.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,293,496,537,1218,3120,650,792.5,1650,180,956.286],'cm^-1')),
        HinderedRotor(inertia=(0.338886,'amu*angstrom^2'), symmetry=1, barrier=(7.79166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17119,'amu*angstrom^2'), symmetry=1, barrier=(26.9279,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0249,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC(F)=CF(979)'],
    products = ['F[C]1OOC1F(7255)'],
    transitionState = 'TS3',
