...
species(
    label = 'F[CH]C(F)C1(F)[CH]O1(9330)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-170.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,326,540,652,719,1357,334,575,1197,1424,3202,180,180,180,2825.19],'cm^-1')),
        HinderedRotor(inertia=(0.143528,'amu*angstrom^2'), symmetry=1, barrier=(3.3,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143493,'amu*angstrom^2'), symmetry=1, barrier=(3.29919,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.744791,0.0893653,-0.000185917,1.89942e-07,-7.12636e-11,-20381.2,25.5545], Tmin=(100,'K'), Tmax=(856.192,'K')), NASAPolynomial(coeffs=[2.96197,0.0370455,-2.0742e-05,4.08875e-09,-2.82269e-13,-19222.9,24.1839], Tmin=(856.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsOs) + group(CdCFO) + ring(oxirene) + radical(Csj(Cs-F1sCdH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C1O[C]1F(9331)'],
    products = ['FC1=CO1(3064)', 'CHFCHF[Z](59)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)C1O[C]1F(9331)'],
    products = ['F[CH]C1O[C](F)C1F(9359)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[CH]C(F)C1O[C]1F(9331)'],
    products = ['F[CH]C(F)C1(F)[CH]O1(9330)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', 'F[CH]C1O[C]1F(9232)'],
    products = ['F[CH]C(F)C1O[C]1F(9331)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)C1O[C]1F(9331)'],
    products = ['FC1C(F)C2(F)OC12(9360)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C(F)[CH]C(F)[CH]F(9363)'],
    products = ['F[CH]C(F)C1O[C]1F(9331)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FC1=CO1(3064)', 'F[CH][CH]F(493)'],
    products = ['F[CH]C(F)C1O[C]1F(9331)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]C(F)C1=C(F)O1(9364)'],
    products = ['F[CH]C(F)C1O[C]1F(9331)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC=CC1O[C]1F(9216)'],
    products = ['F[CH]C(F)C1O[C]1F(9331)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]1[CH]O1(9215)', 'CHFCHF[Z](59)'],
    products = ['F[CH]C(F)C1O[C]1F(9331)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FC=C(F)C1O[C]1F(9365)'],
    products = ['F[CH]C(F)C1O[C]1F(9331)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]1[CH]O1(9215)', 'F[CH][CH]F(493)'],
    products = ['F[CH]C(F)C1O[C]1F(9331)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'FC=C[C]1O[C]1F(9366)'],
    products = ['F[CH]C(F)C1O[C]1F(9331)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[CH]C1O[C]1F(9232)'],
    products = ['F[CH]C(F)C1O[C]1F(9331)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)C1O[C]1F(9331)'],
    products = ['F[CH]C(F)[C]1OC1F(9367)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)C1O[C]1F(9331)'],
    products = ['F[CH][CH]C1OC1(F)F(9370)'],
...
network(
    ...
    isomers = [
        'F[CH]C(F)C1O[C]1F(9331)',
    ],
    reactants = [
        ('FC1=CO1(3064)', 'CHFCHF[Z](59)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
