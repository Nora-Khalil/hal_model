...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', '[CH2]C[O](325)'],
    products = ['[CH2]CO[CH]F(3261)'],
    transitionState = 'TS2',
