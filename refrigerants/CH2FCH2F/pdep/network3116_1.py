...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0078,0.0415024,-2.76454e-05,7.74262e-09,-8.22714e-13,-20438.1,20.0684], Tmin=(100,'K'), Tmax=(2216.21,'K')), NASAPolynomial(coeffs=[19.988,0.00905002,-5.68059e-06,1.13525e-09,-7.73646e-14,-28407.7,-80.9843], Tmin=(2216.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCFO) + group(Cds-OdCsH) + ring(Cyclopropene)"""),
)

species(
    label = 'O=C=CC1OC1F(9382)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {7,D}
4  C u0 p0 c0 {2,S} {5,S} {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77729,0.0494973,-5.05886e-05,2.76372e-08,-6.14826e-12,-37279.7,19.5586], Tmin=(100,'K'), Tmax=(1077.98,'K')), NASAPolynomial(coeffs=[9.92636,0.0192586,-8.51113e-06,1.61442e-09,-1.13104e-13,-39036.6,-20.3677], Tmin=(1077.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsOsH) + group(CsCFHO) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + ring(Cs-Cs(F)-O2s)"""),
)

species(
    label = 'O=[C]C[CH]C(=O)F(9383)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {6,D}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-204.033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,611,648,830,1210,1753,1855,455,950,189.81,2358.59],'cm^-1')),
        HinderedRotor(inertia=(0.227057,'amu*angstrom^2'), symmetry=1, barrier=(5.80691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227653,'amu*angstrom^2'), symmetry=1, barrier=(5.80689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227146,'amu*angstrom^2'), symmetry=1, barrier=(5.80743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63594,0.0585421,-9.40771e-05,8.5699e-08,-3.06039e-11,-24460.7,26.3922], Tmin=(100,'K'), Tmax=(833.552,'K')), NASAPolynomial(coeffs=[5.77331,0.0260246,-1.27727e-05,2.4468e-09,-1.68535e-13,-24710.5,9.82389], Tmin=(833.552,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(COCsFO) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (-10.5837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,326,540,652,719,1357,1855,455,950,180,557.539,860.572,868.599],'cm^-1')),
        HinderedRotor(inertia=(0.956003,'amu*angstrom^2'), symmetry=1, barrier=(21.9804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00193187,'amu*angstrom^2'), symmetry=1, barrier=(21.9345,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28156,0.0409511,-3.27304e-05,1.18918e-08,-1.74032e-12,-1214.43,19.8623], Tmin=(100,'K'), Tmax=(1545.99,'K')), NASAPolynomial(coeffs=[11.38,0.0174104,-9.88999e-06,2.04249e-09,-1.47607e-13,-4027.66,-27.9963], Tmin=(1545.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.5837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCFO) + group(Cds-OdCsH) + ring(Cyclopropene) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (-116.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,395,473,707,1436,3010,987.5,1337.5,450,1655,2120,512.5,787.5,222.692,222.746,222.753,222.756,2247.47,2247.51],'cm^-1')),
        HinderedRotor(inertia=(0.332079,'amu*angstrom^2'), symmetry=1, barrier=(11.6803,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55086,0.0591692,-9.53164e-05,8.21081e-08,-2.7533e-11,-13876.7,21.8633], Tmin=(100,'K'), Tmax=(853.855,'K')), NASAPolynomial(coeffs=[7.85172,0.0199659,-9.43052e-06,1.76526e-09,-1.19562e-13,-14599.6,-5.47154], Tmin=(853.855,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsOsH) + group(CsCFHO) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + ring(Cs-Cs(F)-O2s) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'O=[C]C[C]1OC1F(9386)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62236,0.0396883,-4.36179e-06,-3.1907e-08,1.73729e-11,-10751,25.0846], Tmin=(100,'K'), Tmax=(953.042,'K')), NASAPolynomial(coeffs=[16.7899,0.00700663,-1.68041e-06,3.23234e-10,-2.82112e-14,-15048.9,-54.7415], Tmin=(953.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.1959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cs-Cs(F)-O2s) + radical(C=COJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'O=[C][CH]C1OC1F(9388)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15046,0.0392461,-2.88751e-05,1.08566e-08,-1.6856e-12,-7415.32,24.4623], Tmin=(100,'K'), Tmax=(1473.82,'K')), NASAPolynomial(coeffs=[9.60141,0.0190239,-8.29369e-06,1.5468e-09,-1.06404e-13,-9611.58,-14.3741], Tmin=(1473.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.2157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(Cds-OdCsH) + ring(O2s-Cs(F)-Cs(C)) + radical(CCJCO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC[C]1O[C]1F(9389)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-18.8784,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,2782.5,750,1395,475,1775,1000,180,180,1452.31,1453.39,1453.87],'cm^-1')),
        HinderedRotor(inertia=(0.199039,'amu*angstrom^2'), symmetry=1, barrier=(4.57631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198588,'amu*angstrom^2'), symmetry=1, barrier=(4.56594,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96887,0.0501483,-7.15265e-05,6.62063e-08,-2.51237e-11,-2202.73,23.6969], Tmin=(100,'K'), Tmax=(790.902,'K')), NASAPolynomial(coeffs=[4.04287,0.0299516,-1.48116e-05,2.88152e-09,-2.01702e-13,-2227.18,16.0969], Tmin=(790.902,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.8784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(Cds-OdCsH) + ring(O2s-Cs(F)-Cs(C)) + radical(C2CsJO) + radical(Csj(Cs-O2sCsH)(F1s)(O2s-Cs)_ring)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(129)', '[CH2]C1O[C]1F(9209)'],
    products = ['O=[C]CC1O[C]1F(9325)'],
    transitionState = 'TS4',
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(6.2849,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]CC1=C(F)O1(9384)'],
    products = ['O=[C]CC1O[C]1F(9325)'],
