...
"""),
    ...
    molecularWeight = (142.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.632824,0.0808605,-9.82111e-05,6.87131e-08,-2.02352e-11,-131646,27.1424], Tmin=(100,'K'), Tmax=(813.121,'K')), NASAPolynomial(coeffs=[9.36261,0.0379184,-1.89983e-05,3.77125e-09,-2.69493e-13,-133066,-13.1683], Tmin=(813.121,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1095.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsOs)"""),
)

species(
    label = '[CH2]C([O])OC(F)C(F)F(7210)',
...
"""),
    E0 = (-652.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (142.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.458048,0.0879613,-0.00011269,7.08809e-08,-1.2173e-11,-78355.9,30.7761], Tmin=(100,'K'), Tmax=(580.125,'K')), NASAPolynomial(coeffs=[9.45965,0.0390919,-2.04546e-05,4.09965e-09,-2.93089e-13,-79622.4,-9.66396], Tmin=(580.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-652.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)O[C](F)C(F)F(7211)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-674.732,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,522,611,926,1093,1137,1374,1416,3112,395,473,707,1436,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0873946,0.0936923,-0.00013364,1.04158e-07,-3.3027e-11,-81017.7,33.5408], Tmin=(100,'K'), Tmax=(767.351,'K')), NASAPolynomial(coeffs=[11.4516,0.0344554,-1.78484e-05,3.56197e-09,-2.54004e-13,-82761.8,-18.2757], Tmin=(767.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-674.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs)) + radical(CJCO)"""),
)

species(
    label = 'C[C](O)O[C](F)C(F)F(7212)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-681.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,522,611,926,1093,1137,1374,1416,3112,360,370,350,395,473,707,1436,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.304381,0.0888915,-0.000123042,9.54567e-08,-3.05083e-11,-81788.3,32.8176], Tmin=(100,'K'), Tmax=(758.132,'K')), NASAPolynomial(coeffs=[10.2941,0.0361845,-1.87583e-05,3.75402e-09,-2.6846e-13,-83303,-12.6107], Tmin=(758.132,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-681.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Cs_P) + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2]C(O)OC(F)[C](F)F(7213)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-670.3,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,487,638,688,1119,1325,1387,3149,3000,3100,440,815,1455,1000,190,488,555,1236,1407,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0570806,0.0936536,-0.000124644,8.74594e-08,-2.47836e-11,-80482.5,32.7685], Tmin=(100,'K'), Tmax=(857.143,'K')), NASAPolynomial(coeffs=[13.3071,0.0318205,-1.64363e-05,3.29872e-09,-2.36936e-13,-82754,-29.1128], Tmin=(857.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-670.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(CJCO) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'C[C](O)OC(F)[C](F)F(7214)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-676.643,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,190,488,555,1236,1407,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.287709,0.0886879,-0.000113444,7.79197e-08,-2.18676e-11,-81253.8,31.9966], Tmin=(100,'K'), Tmax=(860.805,'K')), NASAPolynomial(coeffs=[12.1575,0.0335326,-1.73347e-05,3.48776e-09,-2.51122e-13,-83297.3,-23.4892], Tmin=(860.805,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-676.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Cs_P) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'CC(=O)OC(F)C(F)F(7215)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (142.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938844,0.0655414,-5.06583e-05,1.92295e-08,-2.97051e-12,-129740,27.1875], Tmin=(100,'K'), Tmax=(1491.42,'K')), NASAPolynomial(coeffs=[14.7396,0.0285279,-1.34319e-05,2.58933e-09,-1.81198e-13,-133857,-44.9096], Tmin=(1491.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1079.65,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (-559.057,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.875567,'amu*angstrom^2'), symmetry=1, barrier=(20.131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.875303,'amu*angstrom^2'), symmetry=1, barrier=(20.1249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.873712,'amu*angstrom^2'), symmetry=1, barrier=(20.0884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.873747,'amu*angstrom^2'), symmetry=1, barrier=(20.0892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-561.922,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,2950,3100,1380,975,1025,1650,1685,370,191.789,192.918,193.015,193.263],'cm^-1')),
        HinderedRotor(inertia=(0.966541,'amu*angstrom^2'), symmetry=1, barrier=(25.4425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.973498,'amu*angstrom^2'), symmetry=1, barrier=(25.4398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.982939,'amu*angstrom^2'), symmetry=1, barrier=(25.4426,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.382261,0.0702291,-6.60683e-05,2.6141e-08,-2.78991e-12,-67445.2,27.1616], Tmin=(100,'K'), Tmax=(1042.1,'K')), NASAPolynomial(coeffs=[19.2433,0.012855,-5.10635e-06,9.74179e-10,-7.07738e-14,-72191.9,-68.5233], Tmin=(1042.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-561.922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-868.057,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.954764,0.0687408,-6.35836e-05,2.99755e-08,-5.79748e-12,-104295,28.4604], Tmin=(100,'K'), Tmax=(1214.21,'K')), NASAPolynomial(coeffs=[13.1233,0.0286541,-1.40623e-05,2.78598e-09,-1.99352e-13,-107250,-32.6078], Tmin=(1214.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-868.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CJCO)"""),
)
...
"""),
    E0 = (-764.249,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,522,611,926,1093,1137,1374,1416,3112,395,473,707,1436,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.915686,'amu*angstrom^2'), symmetry=1, barrier=(21.0534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.916698,'amu*angstrom^2'), symmetry=1, barrier=(21.0767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915579,'amu*angstrom^2'), symmetry=1, barrier=(21.051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.917232,'amu*angstrom^2'), symmetry=1, barrier=(21.089,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.570587,0.0993715,-0.000131074,8.26822e-08,-2.00466e-11,-91752.2,28.0462], Tmin=(100,'K'), Tmax=(1020.4,'K')), NASAPolynomial(coeffs=[21.069,0.0145425,-6.37232e-06,1.20853e-09,-8.50931e-14,-96168.3,-76.7888], Tmin=(1020.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-764.249,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'C=C(O)OC(F)[C](F)F(7221)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02874,'amu*angstrom^2'), symmetry=1, barrier=(23.6528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02823,'amu*angstrom^2'), symmetry=1, barrier=(23.6409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02639,'amu*angstrom^2'), symmetry=1, barrier=(23.5987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02597,'amu*angstrom^2'), symmetry=1, barrier=(23.5892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.622953,0.0948432,-0.000114009,6.44848e-08,-1.39351e-11,-90143.5,28.8806], Tmin=(100,'K'), Tmax=(1146.21,'K')), NASAPolynomial(coeffs=[23.3202,0.0112871,-4.66199e-06,8.85546e-10,-6.33929e-14,-95632.3,-89.8985], Tmin=(1146.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-750.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = '[CH]=C(O)OC(F)C(F)F(7222)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.05113,'amu*angstrom^2'), symmetry=1, barrier=(24.1676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0496,'amu*angstrom^2'), symmetry=1, barrier=(24.1325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05108,'amu*angstrom^2'), symmetry=1, barrier=(24.1664,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04985,'amu*angstrom^2'), symmetry=1, barrier=(24.138,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
...
"""),
    E0 = (-638.663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0354673,0.0950813,-0.000133682,1.01537e-07,-3.13452e-11,-76677.8,30.8984], Tmin=(100,'K'), Tmax=(787.463,'K')), NASAPolynomial(coeffs=[11.9878,0.0343672,-1.8029e-05,3.62318e-09,-2.59667e-13,-78560.2,-23.9088], Tmin=(787.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-638.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsOsOsH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(O)OC(F)C(F)F(6751)'],
    products = ['HF(38)', 'CH2CO(28)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5.29418e+10,'s^-1'), n=0.745914, Ea=(145.96,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_7R!H->C',), comment="""Estimated from node Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_7R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F[C]C(F)F-2(1828)', 'C=C(O)O(4483)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.5279e-12,'m^3/(mol*s)'), n=5.02686, Ea=(45.2789,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C=C(O)OC(F)F(3827)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CF2(43)', 'C=C(O)OCF(4107)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'C=C(O)OC(F)[C]F(5427)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHFCF2(55)', 'C=C(O)O(4483)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.000341245,'m^3/(mol*s)'), n=2.84144, Ea=(220.872,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_Cd;H_OR] for rate rule [Cd/disub_Cd/monosub;H_OCd]
...
reaction(
    label = 'reaction7',
    reactants = ['CHFCHF[Z](59)', 'C=C(O)OF(3663)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C(O)OC(F)C(F)F(6751)'],
    products = ['O=C(O)CC(F)C(F)F(7209)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([O])OC(F)C(F)F(7210)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)O[C](F)C(F)F(7211)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[C](O)O[C](F)C(F)F(7212)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(O)OC(F)[C](F)F(7213)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[C](O)OC(F)[C](F)F(7214)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'C=C(O)O[CH]C(F)F(7216)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'C=C(O)OC(F)[CH]F(7217)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2-CHF(67)', '[CH2]C(=O)O(523)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(2.06325,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)C(F)F(1662)', 'C=[C]O(195)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OH(7)', 'C=[C]OC(F)C(F)F(7218)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH2]C(=O)OC(F)C(F)F(7219)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CHF2(82)', 'C=C(O)O[CH]F(4484)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'C=C(O)O[C](F)C(F)F(7220)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'C=C(O)OC(F)[C](F)F(7221)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', '[CH]=C(O)OC(F)C(F)F(7222)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F2(78)', 'C=C(O)OC=CF(7224)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'C=C(O)OC(F)=CF(7225)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(163.756,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction29',
    reactants = ['HF(38)', 'C=C(O)OC=C(F)F(4700)'],
    products = ['C=C(O)OC(F)C(F)F(6751)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(201.637,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

network(
    label = 'PDepNetwork #2547',
    isomers = [
        'C=C(O)OC(F)C(F)F(6751)',
    ],
    reactants = [
