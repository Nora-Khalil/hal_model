...
reaction(
    label = 'reaction6',
    reactants = ['OF(140)', 'C=CC(F)F(3051)'],
    products = ['FOCCC(F)F(3294)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(127)', '[CH2]CC(F)F(3452)'],
    products = ['FOCCC(F)F(3294)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OF(179)', 'CHF2-CH2(64)'],
    products = ['FOCCC(F)F(3294)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(82)', '[CH2]COF(3453)'],
    products = ['FOCCC(F)F(3294)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FOC[CH]C(F)F(3454)'],
    products = ['FOCCC(F)F(3294)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FO[CH]CC(F)F(3110)'],
    products = ['FOCCC(F)F(3294)'],
