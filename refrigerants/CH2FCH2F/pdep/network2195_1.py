...
"""),
    E0 = (79.7113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,480.374,481.043,481.579,483.359],'cm^-1')),
        HinderedRotor(inertia=(0.0725428,'amu*angstrom^2'), symmetry=1, barrier=(1.6773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.531231,'amu*angstrom^2'), symmetry=1, barrier=(15.8908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0963414,'amu*angstrom^2'), symmetry=1, barrier=(15.8808,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47255,0.0511821,-4.15164e-05,1.7185e-08,-2.87284e-12,9681.58,24.9085], Tmin=(100,'K'), Tmax=(1413.66,'K')), NASAPolynomial(coeffs=[12.5243,0.0199106,-8.33471e-06,1.5367e-09,-1.05475e-13,6556.94,-32.2354], Tmin=(1413.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.7113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CJO)"""),
)
...
"""),
    E0 = (49.2936,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,288.384,288.384,288.384],'cm^-1')),
        HinderedRotor(inertia=(0.404181,'amu*angstrom^2'), symmetry=1, barrier=(23.8532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404181,'amu*angstrom^2'), symmetry=1, barrier=(23.8532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404181,'amu*angstrom^2'), symmetry=1, barrier=(23.8532,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12968,0.0549675,-4.13136e-05,7.54257e-09,2.87432e-12,7237.07,25.9618], Tmin=(100,'K'), Tmax=(980.782,'K')), NASAPolynomial(coeffs=[15.6059,0.0134553,-4.63126e-06,8.29412e-10,-5.89914e-14,3554.45,-47.8944], Tmin=(980.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.2526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC(C)[O](5720)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {5,S}
2  O u1 p2 c0 {3,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {7,S}
...
"""),
    E0 = (87.0633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,325.07,325.071,325.072],'cm^-1')),
        HinderedRotor(inertia=(0.25134,'amu*angstrom^2'), symmetry=1, barrier=(18.847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251341,'amu*angstrom^2'), symmetry=1, barrier=(18.847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251338,'amu*angstrom^2'), symmetry=1, barrier=(18.847,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13663,0.0536379,-3.41506e-05,2.91634e-10,5.10225e-12,10582.7,23.3849], Tmin=(100,'K'), Tmax=(996.726,'K')), NASAPolynomial(coeffs=[15.7423,0.0148021,-5.47126e-06,1.01833e-09,-7.3636e-14,6688.61,-51.9597], Tmin=(996.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.0633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2][CH]OC(C)=O(5721)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {5,S}
2  O u0 p2 c0 {4,D}
3  C u0 p0 c0 {4,S} {7,S} {8,S} {9,S}
...
"""),
    E0 = (65.5953,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,329.374,329.65,330.049],'cm^-1')),
        HinderedRotor(inertia=(0.00154958,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220635,'amu*angstrom^2'), symmetry=1, barrier=(17.1075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221369,'amu*angstrom^2'), symmetry=1, barrier=(17.1055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220408,'amu*angstrom^2'), symmetry=1, barrier=(17.1135,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.940835,0.0594197,-5.06238e-05,1.45075e-08,1.10824e-12,8006.5,26.5852], Tmin=(100,'K'), Tmax=(969.289,'K')), NASAPolynomial(coeffs=[16.5961,0.0120186,-3.89351e-06,6.78647e-10,-4.80005e-14,4163.41,-52.6232], Tmin=(969.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.5953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCO) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C([O])OC=C(5723)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05964,0.0552919,-3.72298e-05,2.10492e-09,4.81928e-12,6314.99,23.8916], Tmin=(100,'K'), Tmax=(989.673,'K')), NASAPolynomial(coeffs=[16.2633,0.0139418,-5.02051e-06,9.28704e-10,-6.7312e-14,2321.36,-54.2723], Tmin=(989.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.5562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = '[CH]=[C]OC(C)O(5724)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {5,S}
...
"""),
    E0 = (101.102,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,360.915,360.92],'cm^-1')),
        HinderedRotor(inertia=(0.161216,'amu*angstrom^2'), symmetry=1, barrier=(14.9024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161221,'amu*angstrom^2'), symmetry=1, barrier=(14.9025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161213,'amu*angstrom^2'), symmetry=1, barrier=(14.9027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161213,'amu*angstrom^2'), symmetry=1, barrier=(14.9026,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01637,0.0577852,-4.7625e-05,1.28176e-08,1.32933e-12,12274.2,26.0836], Tmin=(100,'K'), Tmax=(977.732,'K')), NASAPolynomial(coeffs=[16.0716,0.0128843,-4.34703e-06,7.68872e-10,-5.43707e-14,8532.43,-50.2898], Tmin=(977.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=[C]OC[O](609)'],
    products = ['C=[C]OC(C)[O](5671)'],
    transitionState = 'TS2',
