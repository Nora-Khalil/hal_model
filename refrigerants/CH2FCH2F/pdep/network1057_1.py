...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[O]C([O])F(1122)'],
    products = ['[O]C(F)O[C](F)F(2330)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)F(1161)'],
    products = ['[O]C(F)O[C](F)F(2330)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=CO[C](F)F(2344)'],
    products = ['[O]C(F)O[C](F)F(2330)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)O[C](F)F(2345)'],
    products = ['[O]C(F)O[C](F)F(2330)'],
    transitionState = 'TS9',
