...
"""),
    E0 = (-572.754,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,205,317,423,563,514,686,1105,1199,1293,1437,1381,1463,3031,3163,2175,525,750,770,3400,2100,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.32966,'amu*angstrom^2'), symmetry=1, barrier=(30.5716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.32872,'amu*angstrom^2'), symmetry=1, barrier=(30.5499,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3306,'amu*angstrom^2'), symmetry=1, barrier=(30.5932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3309,'amu*angstrom^2'), symmetry=1, barrier=(30.6,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0025659,0.0769555,-7.34924e-05,2.6047e-08,-1.07198e-12,-68732.4,23.9203], Tmin=(100,'K'), Tmax=(1003.03,'K')), NASAPolynomial(coeffs=[22.5243,0.00854813,-3.23616e-06,6.49673e-10,-5.04241e-14,-74329.4,-90.2003], Tmin=(1003.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-572.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (-410.122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,3010,987.5,1337.5,450,1655,225.904,225.904,225.904,225.904],'cm^-1')),
        HinderedRotor(inertia=(0.433277,'amu*angstrom^2'), symmetry=1, barrier=(15.6906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433278,'amu*angstrom^2'), symmetry=1, barrier=(15.6906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433278,'amu*angstrom^2'), symmetry=1, barrier=(15.6906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433278,'amu*angstrom^2'), symmetry=1, barrier=(15.6906,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0988006,0.0912009,-0.000135279,1.00695e-07,-2.94279e-11,-49190.7,26.1322], Tmin=(100,'K'), Tmax=(841.557,'K')), NASAPolynomial(coeffs=[14.7833,0.0214042,-1.08734e-05,2.14295e-09,-1.51481e-13,-51662.3,-42.1792], Tmin=(841.557,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-410.122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COC(O)C(F)F(4697)'],
    products = ['CH2CO(28)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(140.125,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C#COCO(618)'],
    products = ['C#COC(O)C(F)F(4697)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['HF(38)', 'C#COC(O)[C]F-2(3858)'],
    products = ['C#COC(O)C(F)F(4697)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'C#COC(O)F(1427)'],
    products = ['C#COC(O)C(F)F(4697)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'C#COC=C(F)F(3852)'],
    products = ['C#COC(O)C(F)F(4697)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(140)', 'C#COC=CF(2007)'],
    products = ['C#COC(O)C(F)F(4697)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#COC(O)[CH]F(2455)'],
    products = ['C#COC(O)C(F)F(4697)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HCCO(21)', 'O[CH]C(F)F(1906)'],
    products = ['C#COC(O)C(F)F(4697)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H(22)', '[O]C(O)C(F)F(4954)'],
    products = ['C#COC(O)C(F)F(4697)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'C#CO[CH]C(F)F(3027)'],
    products = ['C#COC(O)C(F)F(4697)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF2(82)', 'C#CO[CH]O(3046)'],
    products = ['C#COC(O)C(F)F(4697)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#CO[C](O)C(F)F(3859)'],
    products = ['C#COC(O)C(F)F(4697)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C#COC(O)[C](F)F(1726)'],
    products = ['C#COC(O)C(F)F(4697)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[C]#COC(O)C(F)F(3860)'],
    products = ['C#COC(O)C(F)F(4697)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COC(O)=CF(6633)'],
    products = ['C#COC(O)C(F)F(4697)'],
