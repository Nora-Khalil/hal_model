...
"""),
    E0 = (-645.684,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,1855,455,950,284.868,284.868,284.869,1798.26],'cm^-1')),
        HinderedRotor(inertia=(0.164875,'amu*angstrom^2'), symmetry=1, barrier=(9.49445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164875,'amu*angstrom^2'), symmetry=1, barrier=(9.49444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164875,'amu*angstrom^2'), symmetry=1, barrier=(9.49445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.570361,'amu*angstrom^2'), symmetry=1, barrier=(32.8447,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147005,0.0931867,-0.000154254,1.34888e-07,-4.64356e-11,-77527.2,29.4839], Tmin=(100,'K'), Tmax=(805.702,'K')), NASAPolynomial(coeffs=[10.6509,0.0299018,-1.56998e-05,3.08701e-09,-2.15781e-13,-78858.3,-16.6786], Tmin=(805.702,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-645.684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-OdCsH) + radical(Csj(Cs-F1sF1sF1s)(O2s-Cs)(H)) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.224893,0.0846338,-9.94305e-05,5.51883e-08,-1.16762e-11,-103057,26.0408], Tmin=(100,'K'), Tmax=(1173.08,'K')), NASAPolynomial(coeffs=[21.809,0.00950252,-3.36169e-06,5.92194e-10,-4.10171e-14,-108227,-83.7772], Tmin=(1173.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-858.192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-664.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2120,512.5,787.5,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.977203,'amu*angstrom^2'), symmetry=1, barrier=(22.4678,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.97758,'amu*angstrom^2'), symmetry=1, barrier=(22.4765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.977548,'amu*angstrom^2'), symmetry=1, barrier=(22.4758,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.545413,0.0935095,-0.000124651,7.59438e-08,-1.74264e-11,-79723.2,26.6631], Tmin=(100,'K'), Tmax=(1088.2,'K')), NASAPolynomial(coeffs=[23.8773,0.00373508,-9.01551e-07,1.29679e-10,-8.7858e-15,-85038.5,-93.2263], Tmin=(1088.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-664.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(CCsJOC(O))"""),
)
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.69835,0.0998783,-0.000119279,6.27355e-08,-1.20081e-11,-84478,31.4148], Tmin=(100,'K'), Tmax=(1489.31,'K')), NASAPolynomial(coeffs=[30.6814,-0.00525143,4.89964e-06,-1.04023e-09,7.20998e-14,-92108.2,-130.933], Tmin=(1489.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-704.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCsJOC(O))"""),
)

species(
    label = '[O][C]=COCC(F)(F)F(2885)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-593.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,1855,455,950,307.496,307.497,307.497,307.499],'cm^-1')),
        HinderedRotor(inertia=(0.468353,'amu*angstrom^2'), symmetry=1, barrier=(31.4255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17397,'amu*angstrom^2'), symmetry=1, barrier=(11.673,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.468354,'amu*angstrom^2'), symmetry=1, barrier=(31.4254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00178287,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.785334,0.0772132,-9.56587e-05,6.2744e-08,-1.68627e-11,-71280.5,29.2508], Tmin=(100,'K'), Tmax=(895.017,'K')), NASAPolynomial(coeffs=[11.4566,0.0295215,-1.57301e-05,3.20807e-09,-2.32923e-13,-73190.7,-21.0482], Tmin=(895.017,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-593.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s)) + radical(CsCJ=O)"""),
)

species(
    label = 'O=C(F)CO[CH][C](F)F(1735)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]CO[CH]C(F)(F)F(2736)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(F)(F)F(1545)', '[O]C[C]=O(515)'],
    products = ['O=[C]CO[CH]C(F)(F)F(2736)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]O[CH]C(F)(F)F(2788)'],
    products = ['O=[C]CO[CH]C(F)(F)F(2736)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['O=[C]CO[CH]C(F)(F)F(2736)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(51.2266,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]COC=C(F)F(1730)'],
    products = ['O=[C]CO[CH]C(F)(F)F(2736)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]CO[CH]C(F)(F)F(2736)'],
    products = ['[O]C=CO[CH]C(F)(F)F(2884)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]COC(F)[C](F)F(2886)'],
    products = ['O=[C]CO[CH]C(F)(F)F(2736)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)CO[CH][C](F)F(1735)'],
    products = ['O=[C]CO[CH]C(F)(F)F(2736)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(183.48,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #1306',
    isomers = [
        'O=[C]CO[CH]C(F)(F)F(2736)',
    ],
    reactants = [
        ('CF3CHO(75)', 'CH2CO(28)'),
    ],
