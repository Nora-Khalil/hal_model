...
"""),
    E0 = (-468.558,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,395,473,707,1436,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0295143,0.0980872,-0.000163802,1.43997e-07,-4.92109e-11,-56218.5,28.192], Tmin=(100,'K'), Tmax=(838.489,'K')), NASAPolynomial(coeffs=[10.385,0.0319396,-1.60129e-05,3.07321e-09,-2.11134e-13,-57386.2,-16.7659], Tmin=(838.489,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-468.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2]C(F)(F)OC[CH]F(10100)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.217985,0.0906947,-0.0001415,1.20968e-07,-4.14038e-11,-61527.2,28.2883], Tmin=(100,'K'), Tmax=(785.539,'K')), NASAPolynomial(coeffs=[10.253,0.0324104,-1.64836e-05,3.22552e-09,-2.25845e-13,-62882.1,-16.2913], Tmin=(785.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-512.639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFFO) + group(Cs-CsHHH) + group(CsCsFHH) + radical(Csj(Cs-F1sF1sO2s)(H)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(467)', '[O]C[CH]F(138)'],
    products = ['F[CH]CO[C](F)CF(10000)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]O[C](F)CF(942)'],
    products = ['F[CH]CO[C](F)CF(10000)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['F[CH]CO[C](F)CF(10000)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(69.6957,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]CF(125)', '[O]C[CH]F(138)'],
    products = ['F[CH]CO[C](F)CF(10000)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]O[C](F)CF(942)'],
    products = ['F[CH]CO[C](F)CF(10000)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]CO[C](F)CF(10000)'],
    products = ['[CH2]C(F)(F)OC[CH]F(10100)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]CO[C](F)CF(10000)'],
    products = ['[CH2][C](F)OCC(F)F(725)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(183.754,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #3406',
    isomers = [
        'F[CH]CO[C](F)CF(10000)',
    ],
    reactants = [
