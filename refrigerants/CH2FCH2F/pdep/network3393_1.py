...
"""),
    E0 = (-188.407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,259,529,569,1128,1321,1390,3140,395,473,707,1436,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.329299,0.062523,-5.58584e-05,2.58405e-08,-4.53625e-12,-22512.3,24.2693], Tmin=(100,'K'), Tmax=(1631.26,'K')), NASAPolynomial(coeffs=[15.1762,0.0155707,-2.9863e-06,2.69298e-10,-9.90757e-15,-25952.9,-50.3226], Tmin=(1631.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCFHO) + ring(12dioxane) + radical(CCsJOOC) + radical(CsCsF1sO2s) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.477487,'amu*angstrom^2'), symmetry=1, barrier=(10.9784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64153,'amu*angstrom^2'), symmetry=1, barrier=(37.742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63869,'amu*angstrom^2'), symmetry=1, barrier=(37.6767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477386,'amu*angstrom^2'), symmetry=1, barrier=(10.976,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
...
"""),
    E0 = (51.6615,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,293,496,537,1218,167,640,1190,2007.51,2007.72],'cm^-1')),
        HinderedRotor(inertia=(1.8668,'amu*angstrom^2'), symmetry=1, barrier=(42.9215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.300527,'amu*angstrom^2'), symmetry=1, barrier=(6.9097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.86792,'amu*angstrom^2'), symmetry=1, barrier=(42.9471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.300084,'amu*angstrom^2'), symmetry=1, barrier=(6.89951,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583719,0.0856959,-0.000146114,1.37524e-07,-5.05042e-11,6326.22,30.8181], Tmin=(100,'K'), Tmax=(815.836,'K')), NASAPolynomial(coeffs=[6.40139,0.0370255,-1.95869e-05,3.86216e-09,-2.70248e-13,6047.43,8.04442], Tmin=(815.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.6615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CJCOOH) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = '[CH]=COO[C](F)CF(10238)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.11799,'amu*angstrom^2'), symmetry=1, barrier=(25.7047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11799,'amu*angstrom^2'), symmetry=1, barrier=(25.7049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11876,'amu*angstrom^2'), symmetry=1, barrier=(25.7226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11813,'amu*angstrom^2'), symmetry=1, barrier=(25.7079,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.615845,0.0794448,-0.000101428,6.72576e-08,-1.79347e-11,-4452,28.1959], Tmin=(100,'K'), Tmax=(910.395,'K')), NASAPolynomial(coeffs=[12.8055,0.025887,-1.31839e-05,2.63738e-09,-1.89456e-13,-6671.46,-29.4676], Tmin=(910.395,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.9939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cds_P)"""),
)

species(
    label = 'C[CH]OOC(F)=[C]F(10489)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (24.1396,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,293,496,537,1218,167,640,1190,180,1655.17],'cm^-1')),
        HinderedRotor(inertia=(0.272787,'amu*angstrom^2'), symmetry=1, barrier=(6.2719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273124,'amu*angstrom^2'), symmetry=1, barrier=(6.27965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0263345,'amu*angstrom^2'), symmetry=1, barrier=(51.1401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.20625,'amu*angstrom^2'), symmetry=1, barrier=(50.726,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.681673,0.0845362,-0.000146143,1.41037e-07,-5.27539e-11,3011.6,28.7659], Tmin=(100,'K'), Tmax=(820.337,'K')), NASAPolynomial(coeffs=[4.96765,0.0399002,-2.11214e-05,4.16193e-09,-2.9096e-13,3107.12,13.8055], Tmin=(820.337,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.1396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCsJOOC) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.923257,'amu*angstrom^2'), symmetry=1, barrier=(21.2275,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.924014,'amu*angstrom^2'), symmetry=1, barrier=(21.2449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6205,'amu*angstrom^2'), symmetry=1, barrier=(37.2586,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43381,0.0576675,-5.72528e-05,2.92495e-08,-6.08083e-12,16583.3,24.1209], Tmin=(100,'K'), Tmax=(1144.58,'K')), NASAPolynomial(coeffs=[11.6132,0.0220935,-1.06323e-05,2.09519e-09,-1.49779e-13,14253.1,-26.3632], Tmin=(1144.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOC=C(10491)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (19.2514,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,326,540,652,719,1357,194,682,905,1196,1383,3221,180,2306.31,2307.6,2307.79],'cm^-1')),
        HinderedRotor(inertia=(0.296902,'amu*angstrom^2'), symmetry=1, barrier=(6.82635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.296929,'amu*angstrom^2'), symmetry=1, barrier=(6.82698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73634,'amu*angstrom^2'), symmetry=1, barrier=(39.9219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7364,'amu*angstrom^2'), symmetry=1, barrier=(39.9233,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.541605,0.0882794,-0.000156534,1.51153e-07,-5.62716e-11,2428.09,28.0773], Tmin=(100,'K'), Tmax=(822.188,'K')), NASAPolynomial(coeffs=[5.49607,0.039088,-2.1019e-05,4.15886e-09,-2.91032e-13,2461.35,10.3016], Tmin=(822.188,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.2514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OOC=C(10495)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {5,S}
4  O u0 p2 c0 {3,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.2,'amu*angstrom^2'), symmetry=1, barrier=(27.5904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20006,'amu*angstrom^2'), symmetry=1, barrier=(27.5917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19998,'amu*angstrom^2'), symmetry=1, barrier=(27.5899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19975,'amu*angstrom^2'), symmetry=1, barrier=(27.5845,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.722331,0.0772913,-9.44202e-05,5.95539e-08,-1.51856e-11,-10601.1,25.6494], Tmin=(100,'K'), Tmax=(946.984,'K')), NASAPolynomial(coeffs=[12.7716,0.0263962,-1.38035e-05,2.80074e-09,-2.03023e-13,-12883.2,-31.8249], Tmin=(946.984,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.0881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]1OO[CH]CC1F(10487)'],
    products = ['C=COOC(F)=CF(9989)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]COOC(F)=[C]F(10488)'],
    products = ['C=COOC(F)=CF(9989)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]OOC(F)=[C]F(10489)'],
    products = ['C=COOC(F)=CF(9989)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=COO[C]=CF(10490)'],
    products = ['C=COOC(F)=CF(9989)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH]=C(F)OOC=C(10491)'],
    products = ['C=COOC(F)=CF(9989)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]OC(F)=CF(979)', 'C2H3(29)'],
    products = ['C=COOC(F)=CF(9989)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHFCF[Z](72)', 'C=CO[O](291)'],
    products = ['C=COOC(F)=CF(9989)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=[C]OOC(F)=CF(10237)'],
    products = ['C=COOC(F)=CF(9989)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=COOC(F)=CF(9975)'],
    products = ['C=COOC(F)=CF(9989)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C=COOC(F)=[C]F(10492)'],
    products = ['C=COOC(F)=CF(9989)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C(F)(F)OOC=C(10495)'],
    products = ['C=COOC(F)=CF(9989)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CHF(40)', 'C=CO[O+]=[C-]F(10496)'],
    products = ['C=COOC(F)=CF(9989)'],
