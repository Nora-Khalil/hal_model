...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(368)', '[CH2]C([O])F(139)'],
    products = ['[CH2]C(F)O[C]=C(203)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[CH]F(377)'],
    products = ['[CH2]C(F)O[C]=C(203)'],
    transitionState = 'TS3',
