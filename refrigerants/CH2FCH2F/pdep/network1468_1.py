...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C([O])=O(296)'],
    products = ['[CH2]CC([O])=O(3232)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(276)', '[CH2][CH2](511)'],
    products = ['[CH2]CC([O])=O(3232)'],
