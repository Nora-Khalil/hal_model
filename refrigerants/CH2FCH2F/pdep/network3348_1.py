...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(514)', 'F[C]CF-2(467)'],
    products = ['[O]C(=O)O[C](F)CF(9956)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)O[C](F)CF(9956)'],
    products = ['FC[C](F)O[C]1OO1(10386)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)O[C](F)CF(9956)'],
    products = ['[O][C]1OC(F)(CF)O1(10387)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)OC([O])=O(583)'],
    products = ['[O]C(=O)O[C](F)CF(9956)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C([O])=O(514)', 'F[C]CF(125)'],
    products = ['[O]C(=O)O[C](F)CF(9956)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(=O)O[C](F)CF(9956)'],
    products = ['O=C(O)O[C](F)[CH]F(10390)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C](F)OC(=O)OF(10391)'],
    products = ['[O]C(=O)O[C](F)CF(9956)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(=O)O[C](F)CF(9956)'],
    products = ['[CH2]C(F)(F)OC([O])=O(10392)'],
