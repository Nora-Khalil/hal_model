...
"""),
    E0 = (34.1652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,261,493,600,1152,1365,1422,3097,180,428.387,2024.33],'cm^-1')),
        HinderedRotor(inertia=(0.0328996,'amu*angstrom^2'), symmetry=1, barrier=(10.3311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116815,'amu*angstrom^2'), symmetry=1, barrier=(36.0987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57063,'amu*angstrom^2'), symmetry=1, barrier=(36.1118,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23732,0.042117,-4.64464e-05,2.66923e-08,-6.29174e-12,4169.84,15.8536], Tmin=(100,'K'), Tmax=(1010.67,'K')), NASAPolynomial(coeffs=[8.66548,0.0166757,-8.68717e-06,1.78512e-09,-1.3064e-13,2870.49,-15.2268], Tmin=(1010.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.1652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (-209.144,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([90,150,250,247,323,377,431,433,1065,1274,974.539,1589.71,1589.72,1589.77,1589.79],'cm^-1')),
        HinderedRotor(inertia=(0.0013037,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00130323,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00130292,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81944,0.0531782,-7.96059e-05,6.11417e-08,-1.7752e-11,-25080.6,18.2093], Tmin=(100,'K'), Tmax=(635.73,'K')), NASAPolynomial(coeffs=[8.41312,0.0175362,-9.30098e-06,1.87869e-09,-1.34553e-13,-26037.1,-11.5436], Tmin=(635.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.48616,'amu*angstrom^2'), symmetry=1, barrier=(34.1698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48745,'amu*angstrom^2'), symmetry=1, barrier=(34.1993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48971,'amu*angstrom^2'), symmetry=1, barrier=(34.2513,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97039,0.0482191,-5.96761e-05,3.83669e-08,-1.00112e-11,-27968.1,18.2962], Tmin=(100,'K'), Tmax=(924.609,'K')), NASAPolynomial(coeffs=[9.19023,0.0169852,-9.00546e-06,1.83227e-09,-1.32901e-13,-29303.2,-15.9695], Tmin=(924.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['F(37)', '[CH]C(F)OO(4538)'],
    products = ['OOC(F)[CH]F(503)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction27',
    reactants = ['HO2(11)', 'F[CH][CH]F(493)'],
    products = ['OOC(F)[CH]F(503)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction29',
    reactants = ['H(5)', 'OOC(F)[C]F-2(4543)'],
    products = ['OOC(F)[CH]F(503)'],
