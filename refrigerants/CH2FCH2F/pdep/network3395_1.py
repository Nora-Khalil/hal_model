...
"""),
    E0 = (-411.938,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,3150,900,1100,259,529,569,1128,1321,1390,3140,395,473,707,1436,486.047,1008.5,1008.5,1008.5,1008.5,1008.5,1008.5,1008.5,1008.5,1008.5,2341.95],'cm^-1')),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.770989,0.0580822,-5.18805e-05,2.45253e-08,-4.47526e-12,-49417.4,25.1363], Tmin=(100,'K'), Tmax=(1520.88,'K')), NASAPolynomial(coeffs=[13.9648,0.0163953,-3.8756e-06,4.62356e-10,-2.33532e-14,-52622.7,-41.3921], Tmin=(1520.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-411.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(Tetrahydrofuran) + radical(Cs_P) + radical(CsCsF1sO2s) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = '[CH2]C([O])OC(F)=CF(10848)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-300.52,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,326,540,652,719,1357,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,274.027,274.028,274.028,1413.09],'cm^-1')),
        HinderedRotor(inertia=(0.174299,'amu*angstrom^2'), symmetry=1, barrier=(9.28773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00655452,'amu*angstrom^2'), symmetry=1, barrier=(9.28773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.555803,'amu*angstrom^2'), symmetry=1, barrier=(29.6167,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.720101,0.078433,-0.000107977,8.08506e-08,-2.4656e-11,-36031.8,27.3071], Tmin=(100,'K'), Tmax=(796.352,'K')), NASAPolynomial(coeffs=[10.5522,0.0290496,-1.49628e-05,2.98768e-09,-2.13495e-13,-37597.8,-17.8887], Tmin=(796.352,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-300.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(=O)OC(F)[CH]F(4873)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-256.678,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,293,496,537,1218,167,640,1190,380.125,380.134,380.14,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0540496,'amu*angstrom^2'), symmetry=1, barrier=(5.5425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172151,'amu*angstrom^2'), symmetry=1, barrier=(17.6526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274276,'amu*angstrom^2'), symmetry=1, barrier=(28.1249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27429,'amu*angstrom^2'), symmetry=1, barrier=(28.1249,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.435694,0.0825672,-0.000110389,7.46727e-08,-1.99833e-11,-30746.4,28.5018], Tmin=(100,'K'), Tmax=(914.028,'K')), NASAPolynomial(coeffs=[14.274,0.0220069,-1.10035e-05,2.18275e-09,-1.55993e-13,-33276.1,-37.0159], Tmin=(914.028,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CJCO) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    E0 = (-300.866,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,350,440,435,1725,3120,650,792.5,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.974336,'amu*angstrom^2'), symmetry=1, barrier=(22.4019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.973247,'amu*angstrom^2'), symmetry=1, barrier=(22.3769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.971643,'amu*angstrom^2'), symmetry=1, barrier=(22.34,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.974487,'amu*angstrom^2'), symmetry=1, barrier=(22.4054,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.242914,0.0920052,-0.000123594,7.89351e-08,-1.93074e-11,-36031.7,26.3876], Tmin=(100,'K'), Tmax=(1013.37,'K')), NASAPolynomial(coeffs=[20.05,0.0119054,-5.03078e-06,9.36623e-10,-6.53017e-14,-40144.6,-71.7836], Tmin=(1013.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-300.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cds_P)"""),
)

species(
    label = 'C[C](O)OC(F)=[C]F(10851)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    E0 = (-263.021,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,293,496,537,1218,167,640,1190,315.77,315.956,316.017,520.307],'cm^-1')),
        HinderedRotor(inertia=(0.393127,'amu*angstrom^2'), symmetry=1, barrier=(27.8346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180853,'amu*angstrom^2'), symmetry=1, barrier=(12.7783,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00167933,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00245163,'amu*angstrom^2'), symmetry=1, barrier=(27.8359,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.666303,0.0776118,-9.92728e-05,6.5304e-08,-1.71663e-11,-31517.6,27.7293], Tmin=(100,'K'), Tmax=(925.771,'K')), NASAPolynomial(coeffs=[13.1505,0.0236705,-1.18723e-05,2.36446e-09,-1.69551e-13,-33829.1,-31.5366], Tmin=(925.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cs_P) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    E0 = (-112.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,615,860,1140,1343,3152,1685,370,247.197,247.587,247.623,2727.84],'cm^-1')),
        HinderedRotor(inertia=(0.265667,'amu*angstrom^2'), symmetry=1, barrier=(11.5385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26597,'amu*angstrom^2'), symmetry=1, barrier=(11.5431,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.767437,'amu*angstrom^2'), symmetry=1, barrier=(33.2084,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12514,0.0683644,-0.000102774,8.56343e-08,-2.85711e-11,-13441.2,25.7361], Tmin=(100,'K'), Tmax=(804.708,'K')), NASAPolynomial(coeffs=[8.81494,0.0248904,-1.19516e-05,2.28403e-09,-1.5784e-13,-14508.8,-8.6358], Tmin=(804.708,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-112.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.290155,'amu*angstrom^2'), symmetry=1, barrier=(6.67123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288667,'amu*angstrom^2'), symmetry=1, barrier=(6.63703,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.408975,0.0858565,-0.000141675,1.20191e-07,-3.97522e-11,-35033.2,26.2995], Tmin=(100,'K'), Tmax=(830.926,'K')), NASAPolynomial(coeffs=[11.4431,0.0233013,-1.17118e-05,2.24992e-09,-1.54714e-13,-36541.1,-22.9297], Tmin=(830.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cds_P)"""),
)

species(
    label = 'C=C(O)OC(F)=[C]F(10853)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-269.852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,293,496,537,1218,167,640,1190,293.803,296.392,298.105,298.871],'cm^-1')),
        HinderedRotor(inertia=(0.149667,'amu*angstrom^2'), symmetry=1, barrier=(9.24086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150656,'amu*angstrom^2'), symmetry=1, barrier=(9.25135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00943486,'amu*angstrom^2'), symmetry=1, barrier=(35.3081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.534543,0.0840032,-0.000140628,1.22888e-07,-4.18333e-11,-32338.4,26.4817], Tmin=(100,'K'), Tmax=(830.673,'K')), NASAPolynomial(coeffs=[10.004,0.0259271,-1.32256e-05,2.55754e-09,-1.76542e-13,-33481.1,-14.8553], Tmin=(830.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-269.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    E0 = (-286.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,326,540,652,719,1357,194,682,905,1196,1383,3221,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.504073,0.0823445,-0.000112757,7.94107e-08,-2.23036e-11,-34362.6,26.7297], Tmin=(100,'K'), Tmax=(869.035,'K')), NASAPolynomial(coeffs=[13.1224,0.0242644,-1.25076e-05,2.50519e-09,-1.79641e-13,-36555.8,-32.3751], Tmin=(869.035,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-286.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OC(=C)O(10855)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {6,S}
4  O u0 p2 c0 {6,S} {12,S}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.173667,0.090294,-0.000118144,7.32665e-08,-1.74345e-11,-42179.3,23.9744], Tmin=(100,'K'), Tmax=(1039.72,'K')), NASAPolynomial(coeffs=[20.1101,0.0122584,-5.5622e-06,1.07946e-09,-7.71875e-14,-46397.2,-74.6734], Tmin=(1039.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-351.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFFO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(O)OC(F)=CF(7225)'],
    products = ['CH2CO(28)', 'O=C(F)CF(476)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(96.7728,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C=C(O)OC(F)=CF(7225)'],
    products = ['O=C(O)CC(F)=CF(10845)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C(O)OC(F)=CF(7225)'],
    products = ['C=C(O)C(F)C(=O)F(10846)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O[C]1CC(F)[C](F)O1(10847)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C([O])OC(F)=CF(10848)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)OC(F)[CH]F(4873)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(O)OC(F)[CH]F(10849)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(O)OC(F)=[C]F(10850)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(=O)O[C](F)CF(9980)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(O)O[C](F)CF(10262)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[C](O)OC(F)=[C]F(10851)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=C(O)O[C]=CF(10852)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH]=C(F)OC(=C)O(6283)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]F(980)', 'C=[C]O(195)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(4.05349,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction16',
    reactants = ['CHFCF[Z](72)', '[CH2]C(=O)O(523)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(1.91863,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'C=[C]OC(F)=CF(1243)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(=O)OC(F)=CF(9971)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH]=C(O)OC(F)=CF(9976)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'C=C(O)OC(F)=[C]F(10853)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C(O)OC(F)=CF(7225)'],
    products = ['C2F2(60)', 'CC(=O)O(541)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(3.33333e+07,'s^-1'), n=1.2, Ea=(213.414,'kJ/mol'), T0=(1,'K'), Tmin=(500,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.82066e+10,'s^-1'), n=0.827, Ea=(107.727,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction24',
    reactants = ['[CH]C(O)OC(F)=CF(10854)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]C(F)(F)OC(=C)O(10855)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C=C(O)OC(F)=CF(7225)'],
    products = ['HF(38)', 'O=C=CF(434)', 'CH2CO(28)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(5.29418e+10,'s^-1'), n=0.745914, Ea=(126.651,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_7R!H->C',), comment="""Estimated from node Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_7R!H->C"""),
)

reaction(
    label = 'reaction30',
    reactants = ['CHF(40)', 'C=C(O)[O+]=[C-]F(6287)'],
    products = ['C=C(O)OC(F)=CF(7225)'],
