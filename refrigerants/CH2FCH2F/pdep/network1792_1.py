...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.159058,'amu*angstrom^2'), symmetry=1, barrier=(3.65705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157772,'amu*angstrom^2'), symmetry=1, barrier=(3.62749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48088,'amu*angstrom^2'), symmetry=1, barrier=(34.0482,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56955,0.0618147,-0.000110508,1.04495e-07,-3.77307e-11,-4909.32,20.237], Tmin=(100,'K'), Tmax=(844.105,'K')), NASAPolynomial(coeffs=[5.7252,0.0244551,-1.27242e-05,2.47035e-09,-1.70405e-13,-4981.48,4.62094], Tmin=(844.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-41.4791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sCF) + group(O2s-OsH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = '[O]C([CH]O)OF(4382)',
...
"""),
    E0 = (-76.1187,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,180,180,908.343],'cm^-1')),
        HinderedRotor(inertia=(0.186514,'amu*angstrom^2'), symmetry=1, barrier=(4.28833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183981,'amu*angstrom^2'), symmetry=1, barrier=(4.23007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.186775,'amu*angstrom^2'), symmetry=1, barrier=(4.29434,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34057,0.0687402,-0.000130271,1.24343e-07,-4.45254e-11,-9069.03,23.8061], Tmin=(100,'K'), Tmax=(860.858,'K')), NASAPolynomial(coeffs=[6.01671,0.0241459,-1.27247e-05,2.4569e-09,-1.67861e-13,-9026.84,6.8682], Tmin=(860.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.1187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[O]CC([O])OF(4383)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
2 O u0 p2 c0 {1,S} {5,S}
3 O u1 p2 c0 {5,S}
...
"""),
    E0 = (-30.7115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,180,180,1642.82,1647.43],'cm^-1')),
        HinderedRotor(inertia=(0.172705,'amu*angstrom^2'), symmetry=1, barrier=(3.97082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170984,'amu*angstrom^2'), symmetry=1, barrier=(3.93127,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92798,0.0578168,-0.000113581,1.20509e-07,-4.7166e-11,-3630.98,23.0067], Tmin=(100,'K'), Tmax=(844.544,'K')), NASAPolynomial(coeffs=[0.779195,0.0336337,-1.8014e-05,3.53684e-09,-2.45392e-13,-2380.47,34.6095], Tmin=(844.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.7115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C[C](O)OF(4384)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
...
"""),
    E0 = (-51.1702,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,180.009,2199.42,2201.23],'cm^-1')),
        HinderedRotor(inertia=(0.212252,'amu*angstrom^2'), symmetry=1, barrier=(7.35543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.799434,'amu*angstrom^2'), symmetry=1, barrier=(30.8884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211661,'amu*angstrom^2'), symmetry=1, barrier=(7.45813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62107,0.0610567,-0.000110744,1.06098e-07,-3.86606e-11,-6077.12,23.9373], Tmin=(100,'K'), Tmax=(844.359,'K')), NASAPolynomial(coeffs=[5.27657,0.0249015,-1.30485e-05,2.53995e-09,-1.75404e-13,-6022.91,10.8966], Tmin=(844.359,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.1702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'OC=C(O)OF(4385)',
    structure = adjacencyList("""1 F u0 p3 c0 {2,S}
2 O u0 p2 c0 {1,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.981154,'amu*angstrom^2'), symmetry=1, barrier=(22.5587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.979964,'amu*angstrom^2'), symmetry=1, barrier=(22.5313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.981807,'amu*angstrom^2'), symmetry=1, barrier=(22.5737,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]C(=O)OF(3335)'],
    products = ['O=C(CO)OF(4075)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C([CH]O)OF(4266)'],
    products = ['O=C(CO)OF(4075)'],
