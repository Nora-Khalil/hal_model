...
"""),
    E0 = (-391.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,212,931,1104,1251,1325,1474,3102,3155,323,467,575,827,1418,350,440,435,1725,180,180,1307.21],'cm^-1')),
        HinderedRotor(inertia=(0.174107,'amu*angstrom^2'), symmetry=1, barrier=(4.00306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17488,'amu*angstrom^2'), symmetry=1, barrier=(4.02083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174507,'amu*angstrom^2'), symmetry=1, barrier=(4.01225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.324664,0.0982477,-0.000196028,1.95561e-07,-7.24583e-11,-46919.9,27.6294], Tmin=(100,'K'), Tmax=(853.462,'K')), NASAPolynomial(coeffs=[4.39916,0.0390628,-2.15499e-05,4.23404e-09,-2.92244e-13,-46155.4,17.1714], Tmin=(853.462,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-391.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'FCOC(OF)=C(F)F(6796)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-719.028,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,182,240,577,636,1210,1413,314.313,314.344,314.563,1030.54],'cm^-1')),
        HinderedRotor(inertia=(0.100487,'amu*angstrom^2'), symmetry=1, barrier=(7.05514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10052,'amu*angstrom^2'), symmetry=1, barrier=(7.05164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.582679,'amu*angstrom^2'), symmetry=1, barrier=(40.9498,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.354012,0.0889659,-0.000150967,1.34796e-07,-4.72103e-11,-86356.3,26.3343], Tmin=(100,'K'), Tmax=(805.638,'K')), NASAPolynomial(coeffs=[9.82185,0.0291379,-1.57055e-05,3.11453e-09,-2.18534e-13,-87465.8,-14.7143], Tmin=(805.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-719.028,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFHHO) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C(OF)C(F)(F)[CH]F(6797)',
...
"""),
    E0 = (-534.317,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,1380,1390,370,380,2900,435,334,575,1197,1424,3202,180,180,180,1048.25],'cm^-1')),
        HinderedRotor(inertia=(0.20462,'amu*angstrom^2'), symmetry=1, barrier=(4.70463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206099,'amu*angstrom^2'), symmetry=1, barrier=(4.73863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206296,'amu*angstrom^2'), symmetry=1, barrier=(4.74315,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0226578,0.103348,-0.000201685,1.95111e-07,-7.08217e-11,-64135.6,30.7217], Tmin=(100,'K'), Tmax=(848.393,'K')), NASAPolynomial(coeffs=[7.13835,0.0351039,-1.96829e-05,3.89044e-09,-2.69476e-13,-64094.3,4.9213], Tmin=(848.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-534.317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCOJ) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'O[C](OF)C(F)(F)[CH]F(6798)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.121973,'amu*angstrom^2'), symmetry=1, barrier=(2.80441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121767,'amu*angstrom^2'), symmetry=1, barrier=(2.79966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122006,'amu*angstrom^2'), symmetry=1, barrier=(2.80516,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.669441,'amu*angstrom^2'), symmetry=1, barrier=(15.3918,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.285609,0.106606,-0.000198918,1.80805e-07,-6.23686e-11,-66581.7,31.6571], Tmin=(100,'K'), Tmax=(849.704,'K')), NASAPolynomial(coeffs=[11.6383,0.026367,-1.47147e-05,2.89288e-09,-1.99432e-13,-67737.8,-18.8058], Tmin=(849.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-554.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(Cs_P) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)C(F)(F)CF(6733)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FCC(F)(F)OF(2634)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'O=C(OF)C(F)(F)[C]F(6793)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'O=C(OF)C(F)(F)F(6794)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(1520)', 'O=C=C(F)CF(3762)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(OF)C(F)(F)[CH]F(6797)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O[C](OF)C(F)(F)[CH]F(6798)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(OF)[C](F)CF(4000)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)OF(3365)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)C(F)(F)CF(4017)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(127)', 'O=[C]C(F)(F)CF(4016)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'O=C(OF)[C](F)F(3364)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OF(160)', 'CH2F-CF2(68)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(OF)C(F)(F)[CH]F(6799)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', 'C=C(F)C(=O)OF(3366)'],
    products = ['O=C(OF)C(F)(F)CF(6733)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=C(OF)C(F)(F)CF(6733)'],
    products = ['F2(78)', 'CO2(14)', 'CH2CF2(57)'],
