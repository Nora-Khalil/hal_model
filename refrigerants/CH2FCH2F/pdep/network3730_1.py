...
"""),
    E0 = (-442.569,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([373,336,502,477,708,1220,1477,528,1116,1182,1331,1402,1494,3075,3110,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,288.379,288.38,288.38,288.38],'cm^-1')),
        HinderedRotor(inertia=(0.203219,'amu*angstrom^2'), symmetry=1, barrier=(11.9927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203218,'amu*angstrom^2'), symmetry=1, barrier=(11.9927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203218,'amu*angstrom^2'), symmetry=1, barrier=(11.9927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.497368,'amu*angstrom^2'), symmetry=1, barrier=(29.3516,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.212301,0.0891611,-0.000119659,8.70825e-08,-2.56282e-11,-53097.7,27.0815], Tmin=(100,'K'), Tmax=(827.215,'K')), NASAPolynomial(coeffs=[12.1146,0.0316077,-1.5297e-05,2.97585e-09,-2.09655e-13,-55066.8,-28.0825], Tmin=(827.215,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-442.569,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sO2sCs)) + radical(CCsJOCs)"""),
)
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.177444,0.0897129,-0.000124324,9.32754e-08,-2.815e-11,-54374,27.833], Tmin=(100,'K'), Tmax=(809.266,'K')), NASAPolynomial(coeffs=[12.1657,0.0304555,-1.44839e-05,2.78592e-09,-1.94576e-13,-56314.2,-27.4657], Tmin=(809.266,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-453.192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(CsCFFO) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(CCsJOCs)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44296,0.058944,-5.1632e-05,2.44321e-08,-4.89166e-12,-52039.5,23.3586], Tmin=(100,'K'), Tmax=(1155.17,'K')), NASAPolynomial(coeffs=[9.81073,0.0299689,-1.40075e-05,2.71834e-09,-1.92404e-13,-53972.7,-18.2181], Tmin=(1155.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(CCsJOC(O))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.20212,'amu*angstrom^2'), symmetry=1, barrier=(27.6392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19819,'amu*angstrom^2'), symmetry=1, barrier=(27.5488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19828,'amu*angstrom^2'), symmetry=1, barrier=(27.5508,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0508173,0.0758294,-6.64008e-05,1.96201e-08,9.73358e-13,-64212.8,25.8981], Tmin=(100,'K'), Tmax=(991.5,'K')), NASAPolynomial(coeffs=[21.3693,0.0123342,-4.39538e-06,8.25924e-10,-6.11831e-14,-69546.7,-82.3487], Tmin=(991.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-535.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sO2sCs))"""),
)
...
"""),
    E0 = (-411.436,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([373,336,502,477,708,1220,1477,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,250.666,250.669,250.676,250.708],'cm^-1')),
        HinderedRotor(inertia=(0.00268208,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292561,'amu*angstrom^2'), symmetry=1, barrier=(13.0474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200391,'amu*angstrom^2'), symmetry=1, barrier=(8.9344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.886638,'amu*angstrom^2'), symmetry=1, barrier=(39.5329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.410137,0.0865423,-0.000116177,8.46297e-08,-2.382e-11,-49362.1,27.5713], Tmin=(100,'K'), Tmax=(652.226,'K')), NASAPolynomial(coeffs=[10.1416,0.0352393,-1.74585e-05,3.42029e-09,-2.41434e-13,-50809.8,-16.5845], Tmin=(652.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-411.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sO2sCs)) + radical(CJCO)"""),
)

species(
    label = 'C[CH]OC(O)(F)[CH]F(11400)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-422.016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,373,336,502,477,708,1220,1477,2750,2800,2850,1350,1500,750,1050,1375,1000,334,575,1197,1424,3202,200.932,200.945,200.973,4000],'cm^-1')),
        HinderedRotor(inertia=(1.24791,'amu*angstrom^2'), symmetry=1, barrier=(35.7556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305223,'amu*angstrom^2'), symmetry=1, barrier=(8.74528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305182,'amu*angstrom^2'), symmetry=1, barrier=(8.74542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24781,'amu*angstrom^2'), symmetry=1, barrier=(35.7557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.197537,0.0918809,-0.0001417,1.23429e-07,-4.30377e-11,-50627.9,28.2299], Tmin=(100,'K'), Tmax=(802.577,'K')), NASAPolynomial(coeffs=[8.89152,0.0372634,-1.85252e-05,3.58981e-09,-2.49878e-13,-51659.9,-9.53679], Tmin=(802.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sO2sCs)) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)

species(
    label = '[CH2][CH]OC(O)(F)CF(11402)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0653659,0.0927367,-0.000128126,9.40947e-08,-2.77504e-11,-16970.1,29.5265], Tmin=(100,'K'), Tmax=(827.381,'K')), NASAPolynomial(coeffs=[12.9733,0.0303341,-1.49957e-05,2.94071e-09,-2.07971e-13,-19106.1,-30.3012], Tmin=(827.381,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-142.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCsJOCs)"""),
)

species(
    label = 'CC(F)O[C]([O])CF(11404)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55094,0.0659806,-3.48075e-05,-7.38557e-08,9.65263e-11,-54912.5,25.805], Tmin=(100,'K'), Tmax=(453.279,'K')), NASAPolynomial(coeffs=[6.53109,0.0420383,-2.17799e-05,4.35222e-09,-3.10573e-13,-55569.5,3.45215], Tmin=(453.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsCsFHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(F)(OF)O[CH]C(11405)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.345879,0.103704,-0.000153706,1.15586e-07,-3.30925e-11,-21259.7,27.5873], Tmin=(100,'K'), Tmax=(682.35,'K')), NASAPolynomial(coeffs=[14.065,0.029897,-1.49118e-05,2.89934e-09,-2.02691e-13,-23474.8,-38.2489], Tmin=(682.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)

species(
    label = '[CH2]C([O])(F)OC(C)F(11406)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]OC([O])(F)CF(11275)'],
    products = ['O=C(F)CF(476)', 'CH3CHO(36)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C[CH]OC([O])(F)F(3876)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C([O])(F)CF(9947)', '[CH]C-2(510)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', 'C[CH]O[C](F)CF(3480)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)CF(478)', 'CH3CHO(36)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[CH]OC(=O)CF(11397)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(F)CF(476)', 'C[CH][O](3430)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2F(46)', 'C[CH]OC(=O)F(3888)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=COC([O])(F)CF(11398)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C](F)CF(478)', 'C[CH][O](3430)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', '[CH2]C(=O)O[CH]C(5670)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]COC([O])(F)CF(11399)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]OC([O])(F)CF(11275)'],
    products = ['C[CH]OC(O)(F)[CH]F(11400)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[CH]OC([O])(F)CF(11275)'],
    products = ['[CH2][CH]OC(O)(F)CF(11402)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C[CH]O[C](CF)OF(11403)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(F)(OF)O[CH]C(11405)'],
    products = ['C[CH]OC([O])(F)CF(11275)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C[CH]OC([O])(F)CF(11275)'],
    products = ['[CH2]C([O])(F)OC(C)F(11406)'],
...
network(
    ...
    isomers = [
        'C[CH]OC([O])(F)CF(11275)',
    ],
    reactants = [
        ('O=C(F)CF(476)', 'CH3CHO(36)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
