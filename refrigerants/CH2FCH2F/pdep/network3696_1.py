...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.06703,'amu*angstrom^2'), symmetry=1, barrier=(47.5251,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.06819,'amu*angstrom^2'), symmetry=1, barrier=(47.5518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.452619,'amu*angstrom^2'), symmetry=1, barrier=(10.4066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245042,'amu*angstrom^2'), symmetry=1, barrier=(5.63399,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.382508,0.106753,-0.000177617,1.58959e-07,-5.65354e-11,-75994.1,33.0844], Tmin=(100,'K'), Tmax=(780.024,'K')), NASAPolynomial(coeffs=[10.631,0.0377032,-2.06548e-05,4.14347e-09,-2.93526e-13,-77329.8,-14.8614], Tmin=(780.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-633.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
species(
    label = 'O=C(F)C(F)OC(F)[CH]F(11222)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00666572,0.095975,-0.000134053,9.8612e-08,-2.92985e-11,-123002,30.4766], Tmin=(100,'K'), Tmax=(818.625,'K')), NASAPolynomial(coeffs=[13.0402,0.0322275,-1.72504e-05,3.49471e-09,-2.51748e-13,-125138,-29.8562], Tmin=(818.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1023.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COCsFO) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-209.342,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,261,493,600,1152,1365,1422,3097,326,540,652,719,1357,194,682,905,1196,1383,3221,180,180,180,1483.82],'cm^-1')),
        HinderedRotor(inertia=(0.00202552,'amu*angstrom^2'), symmetry=1, barrier=(3.18147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.0897,'amu*angstrom^2'), symmetry=1, barrier=(48.0462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137113,'amu*angstrom^2'), symmetry=1, barrier=(3.15251,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.08674,'amu*angstrom^2'), symmetry=1, barrier=(47.9782,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.754994,0.0830976,-0.000102756,4.26448e-08,1.29605e-11,-25072.8,28.4563], Tmin=(100,'K'), Tmax=(528.066,'K')), NASAPolynomial(coeffs=[9.55071,0.0350776,-1.92038e-05,3.88553e-09,-2.78045e-13,-26261.2,-10.8179], Tmin=(528.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'F[C]C(F)OOC(F)=CF-2(11223)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-461.147,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,326,540,652,719,1357,194,682,905,1196,1383,3221,90,150,250,247,323,377,431,433,1065,1274,1121.04],'cm^-1')),
        HinderedRotor(inertia=(0.0030821,'amu*angstrom^2'), symmetry=1, barrier=(2.74729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119736,'amu*angstrom^2'), symmetry=1, barrier=(2.75296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00307609,'amu*angstrom^2'), symmetry=1, barrier=(2.74355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24268,'amu*angstrom^2'), symmetry=1, barrier=(51.5637,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.709991,0.0872005,-9.60897e-05,-4.96287e-09,6.26844e-11,-55359.9,28.6236], Tmin=(100,'K'), Tmax=(485.384,'K')), NASAPolynomial(coeffs=[10.1594,0.0359986,-2.02768e-05,4.10943e-09,-2.92723e-13,-56591.4,-13.3704], Tmin=(485.384,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-461.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CsCCl_triplet)"""),
)

species(
    label = 'F[C]1OOC(F)C(F)C1F(11224)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.528375,0.079824,-7.85422e-05,3.82115e-08,-7.00159e-12,-91557.1,28.3461], Tmin=(100,'K'), Tmax=(1535.74,'K')), NASAPolynomial(coeffs=[20.5262,0.0133463,-2.2439e-06,1.55618e-10,-3.23401e-15,-96651.5,-77.7944], Tmin=(1535.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-762.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCsCsFH) + group(CsCsCsFH) + group(CsCFHO) + group(CsCFHO) + ring(12dioxane) + radical(CsCsF1sO2s) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[CH]C1(F)OOC(F)C1F(11225)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.225394,0.0882208,-0.00010081,5.70383e-08,-1.21503e-11,-92994.5,25.844], Tmin=(100,'K'), Tmax=(958.028,'K')), NASAPolynomial(coeffs=[18.4756,0.0190352,-6.41278e-06,1.04187e-09,-6.70587e-14,-96985.9,-65.7062], Tmin=(958.028,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-774.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(CsCsCsFH) + group(CsCFHO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(12dioxolane) + radical(Csj(Cs-F1sO2sCs)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'FC=COOC(F)=CF(4670)',
...
"""),
    E0 = (-453.928,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,326,540,652,719,1357,151,237,609,755,844,966,1147,1245,1323,1443,3181,3261,180],'cm^-1')),
        HinderedRotor(inertia=(0.153981,'amu*angstrom^2'), symmetry=1, barrier=(3.54032,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153422,'amu*angstrom^2'), symmetry=1, barrier=(3.52747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.06995,'amu*angstrom^2'), symmetry=1, barrier=(70.5843,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.601766,0.0833282,-0.000133199,1.21635e-07,-4.47441e-11,-54480.9,29.8639], Tmin=(100,'K'), Tmax=(771.868,'K')), NASAPolynomial(coeffs=[7.38744,0.0365059,-1.95533e-05,3.91224e-09,-2.77552e-13,-55181.2,1.13347], Tmin=(771.868,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-453.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.138575,'amu*angstrom^2'), symmetry=1, barrier=(3.18611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138097,'amu*angstrom^2'), symmetry=1, barrier=(3.17512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13868,'amu*angstrom^2'), symmetry=1, barrier=(3.18853,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.143319,0.0993792,-0.000183513,1.79122e-07,-6.68117e-11,-76970.6,32.2262], Tmin=(100,'K'), Tmax=(824.81,'K')), NASAPolynomial(coeffs=[5.75614,0.0416552,-2.30612e-05,4.59607e-09,-3.22249e-13,-76858.9,12.5187], Tmin=(824.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-641.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)

species(
    label = 'F[CH][C](F)OOC=CF(4672)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-251.447,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,395,473,707,1436,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.307793,'amu*angstrom^2'), symmetry=1, barrier=(7.07676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844951,'amu*angstrom^2'), symmetry=1, barrier=(19.4271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.87366,'amu*angstrom^2'), symmetry=1, barrier=(43.0791,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0825598,0.0995168,-0.000168581,1.50336e-07,-5.26793e-11,-30104.4,32.0921], Tmin=(100,'K'), Tmax=(801.555,'K')), NASAPolynomial(coeffs=[10.6024,0.0325232,-1.76263e-05,3.50394e-09,-2.46282e-13,-31378.1,-14.3536], Tmin=(801.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'F[CH]C(F)OO[C]=CF(4673)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-207.028,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,334,575,1197,1424,3202,615,860,1140,1343,3152,1685,370,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.7605,'amu*angstrom^2'), symmetry=1, barrier=(40.4775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.76087,'amu*angstrom^2'), symmetry=1, barrier=(40.4858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.742368,'amu*angstrom^2'), symmetry=1, barrier=(17.0685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.76078,'amu*angstrom^2'), symmetry=1, barrier=(40.4839,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0938694,0.0939791,-0.000143424,1.17245e-07,-3.8734e-11,-24766.5,30.0848], Tmin=(100,'K'), Tmax=(738.9,'K')), NASAPolynomial(coeffs=[11.5622,0.0318921,-1.73773e-05,3.51341e-09,-2.51554e-13,-26461.2,-21.7723], Tmin=(738.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-207.028,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOC(F)[CH]F(4638)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-203.758,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,334,575,1197,1424,3202,293,496,537,1218,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.244191,'amu*angstrom^2'), symmetry=1, barrier=(5.61444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04539,'amu*angstrom^2'), symmetry=1, barrier=(24.0355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88792,'amu*angstrom^2'), symmetry=1, barrier=(43.407,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88103,'amu*angstrom^2'), symmetry=1, barrier=(43.2486,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0716898,0.0983378,-0.000161302,1.41069e-07,-4.92516e-11,-24368.2,31.3119], Tmin=(100,'K'), Tmax=(764.664,'K')), NASAPolynomial(coeffs=[11.1468,0.0324173,-1.77947e-05,3.57762e-09,-2.5402e-13,-25872.4,-18.4173], Tmin=(764.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (-438.526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,395,473,707,1436,326,540,652,719,1357,334,575,1197,1424,3202,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.37853,'amu*angstrom^2'), symmetry=1, barrier=(54.687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226318,'amu*angstrom^2'), symmetry=1, barrier=(5.2035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224413,'amu*angstrom^2'), symmetry=1, barrier=(5.1597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.52554,0.115382,-0.00021826,2.07097e-07,-7.45329e-11,-52594.8,34.3994], Tmin=(100,'K'), Tmax=(839.584,'K')), NASAPolynomial(coeffs=[8.88105,0.0378338,-2.12307e-05,4.21118e-09,-2.9296e-13,-53020.6,-2.46665], Tmin=(839.584,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-438.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'F[C]=C(F)OOC(F)[CH]F(11228)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00994484,'amu*angstrom^2'), symmetry=1, barrier=(40.9858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.304634,'amu*angstrom^2'), symmetry=1, barrier=(7.00413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78377,'amu*angstrom^2'), symmetry=1, barrier=(41.0123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78461,'amu*angstrom^2'), symmetry=1, barrier=(41.0316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.373895,0.108939,-0.000195012,1.81184e-07,-6.52897e-11,-43577.7,34.0886], Tmin=(100,'K'), Tmax=(810.969,'K')), NASAPolynomial(coeffs=[9.69062,0.0370425,-2.0867e-05,4.18802e-09,-2.95085e-13,-44478.3,-7.84617], Tmin=(810.969,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-363.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.516002,'amu*angstrom^2'), symmetry=1, barrier=(11.8639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58389,'amu*angstrom^2'), symmetry=1, barrier=(36.4167,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58958,'amu*angstrom^2'), symmetry=1, barrier=(36.5475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.606,'amu*angstrom^2'), symmetry=1, barrier=(36.9252,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0400799,0.0990109,-0.000167039,1.51864e-07,-5.47839e-11,-57583.6,32.4426], Tmin=(100,'K'), Tmax=(779.82,'K')), NASAPolynomial(coeffs=[9.59871,0.0360865,-2.00668e-05,4.04575e-09,-2.87307e-13,-58676.9,-9.0333], Tmin=(779.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CJ2_singlet-FCs)"""),
)
...
species(
    label = 'FC=C(F)OO[CH]C(F)F(10665)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-655.749,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,326,540,652,719,1357,194,682,905,1196,1383,3221,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.59232,'amu*angstrom^2'), symmetry=1, barrier=(59.6025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188129,'amu*angstrom^2'), symmetry=1, barrier=(4.32545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189688,'amu*angstrom^2'), symmetry=1, barrier=(4.36129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.60509,'amu*angstrom^2'), symmetry=1, barrier=(59.8962,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
...
"""),
    E0 = (-621.955,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,615,860,1140,1343,3152,1685,370,199.251,199.446,200.106],'cm^-1')),
        HinderedRotor(inertia=(1.4311,'amu*angstrom^2'), symmetry=1, barrier=(40.3926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42587,'amu*angstrom^2'), symmetry=1, barrier=(40.3933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.632068,'amu*angstrom^2'), symmetry=1, barrier=(18.0756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44432,'amu*angstrom^2'), symmetry=1, barrier=(40.3927,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0813381,0.0946248,-0.000127655,9.17709e-08,-2.69357e-11,-74670.2,30.6792], Tmin=(100,'K'), Tmax=(824.387,'K')), NASAPolynomial(coeffs=[12.393,0.0348878,-1.89624e-05,3.87397e-09,-2.80736e-13,-76700.2,-26.3402], Tmin=(824.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-621.955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOC(F)C(F)F(11230)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-618.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,293,496,537,1218,3120,650,792.5,1650,185.637,185.646],'cm^-1')),
        HinderedRotor(inertia=(1.41535,'amu*angstrom^2'), symmetry=1, barrier=(34.614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41548,'amu*angstrom^2'), symmetry=1, barrier=(34.614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.89171,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210048,'amu*angstrom^2'), symmetry=1, barrier=(5.13706,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.105218,0.0991827,-0.000145976,1.1579e-07,-3.73602e-11,-74271.1,31.9844], Tmin=(100,'K'), Tmax=(754.093,'K')), NASAPolynomial(coeffs=[11.8794,0.0356064,-1.95031e-05,3.96949e-09,-2.85939e-13,-76078.4,-22.4507], Tmin=(754.093,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-618.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)OOC(F)=CF(10606)'],
    products = ['O=C(F)[CH]F(980)', 'FC1OC1F(977)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)OOC(F)=CF(10606)'],
    products = ['O=C(F)C(F)OC(F)[CH]F(11222)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]C(F)OOC(F)=CF(10477)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', 'F[CH]OOC(F)=CF(10179)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'F[C]C(F)OOC(F)=CF-2(11223)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(F)OOC(F)=CF(10606)'],
    products = ['F[C]1OOC(F)C(F)C1F(11224)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C(F)OOC(F)=CF(10606)'],
    products = ['F[CH]C1(F)OOC(F)C1F(11225)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=COOC(F)=CF(4670)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'F[CH]C(F)OO[C]=CF(4673)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH]=C(F)OOC(F)[CH]F(4638)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C(F)[CH]F(980)', '[O]C(F)[CH]F(975)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(83.0996,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[O]OC(F)=CF(979)', 'F[CH][CH]F(493)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHFCF[Z](72)', '[O]OC(F)[CH]F(502)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'F[CH][C](F)OOC(F)=CF(11227)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[C]=C(F)OOC(F)[CH]F(11228)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)OOC(F)=CF(10606)'],
    products = ['O=C(F)[CH]F(980)', 'O=C(F)CF(476)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(13.4192,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction20',
    reactants = ['F2(78)', 'C#COOC(F)[CH]F(4639)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CHF(40)', 'F[CH]OOC(F)=CF(10179)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'F[C]C(F)OOC(F)=CF(10602)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[CH]C(F)OOC(F)=CF(10606)'],
    products = ['FC=C(F)OO[C](F)CF(10372)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[C]=C(F)OOC(F)CF(10607)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(26951.5,'s^-1'), n=1.60615, Ea=(55.0231,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H_RSSSR;Y_rad_out;Cs_H_out_1H] for rate rule [R6H_DSSSS;Cd_rad_out_single;Cs_H_out_1H]
...
reaction(
    label = 'reaction26',
    reactants = ['F[CH]C(F)OOC(F)=CF(10606)'],
    products = ['FC=C(F)OO[CH]C(F)F(10665)'],
...
reaction(
    label = 'reaction27',
    reactants = ['FC=[C]OOC(F)C(F)F(11229)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(193.082,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction28',
    reactants = ['[CH]=C(F)OOC(F)C(F)F(11230)'],
    products = ['F[CH]C(F)OOC(F)=CF(10606)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(191.339,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #3696',
    isomers = [
        'F[CH]C(F)OOC(F)=CF(10606)',
    ],
    reactants = [
        ('O=C(F)[CH]F(980)', 'FC1OC1F(977)'),
        ('O=C(F)[CH]F(980)', '[O]C(F)[CH]F(975)'),
        ('O=C(F)[CH]F(980)', 'O=C(F)CF(476)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
