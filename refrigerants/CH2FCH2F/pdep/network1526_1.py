...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[C](F)F(518)', '[CH]C-2(510)'],
    products = ['C[CH]OC[C](F)F(3273)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH2]O[CH]C(3428)'],
    products = ['C[CH]OC[C](F)F(3273)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][C](F)F(507)', 'CH3CHO(36)'],
    products = ['C[CH]OC[C](F)F(3273)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CF2(57)', 'C[CH][O](3430)'],
    products = ['C[CH]OC[C](F)F(3273)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C[CH]OC=C(F)F(3431)'],
    products = ['C[CH]OC[C](F)F(3273)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=COC[C](F)F(3432)'],
    products = ['C[CH]OC[C](F)F(3273)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C](F)F(507)', 'C[CH][O](3430)'],
    products = ['C[CH]OC[C](F)F(3273)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH2]O[CH]C(3428)'],
    products = ['C[CH]OC[C](F)F(3273)'],
