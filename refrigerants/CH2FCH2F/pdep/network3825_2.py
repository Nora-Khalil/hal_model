...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(=O)F(1124)'],
    products = ['F[C]1OOO1(11876)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['O-2(1205)', '[O]C(=O)F(161)'],
    products = ['[O]C1(F)OO1(11877)'],
    transitionState = 'TS8',
