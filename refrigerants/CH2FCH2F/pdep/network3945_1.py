...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(=O)O(4410)'],
    products = ['O=C(O)OC(=O)F(4071)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(161)', 'O=[C]O(158)'],
    products = ['O=C(O)OC(=O)F(4071)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'O=[C]OC(=O)F(2417)'],
    products = ['O=C(O)OC(=O)F(4071)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(=O)OC(=O)F(4411)'],
    products = ['O=C(O)OC(=O)F(4071)'],
