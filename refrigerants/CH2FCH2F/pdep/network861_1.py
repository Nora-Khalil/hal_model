...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(1122)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])F(1847)'],
    transitionState = 'TS2',
