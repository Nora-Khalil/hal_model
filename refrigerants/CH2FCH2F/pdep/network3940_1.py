...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(514)', 'O[C]F(5653)'],
    products = ['[O]C(=O)O[C](O)F(4409)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'O=[C]O[C](O)F(2618)'],
    products = ['[O]C(=O)O[C](O)F(4409)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([O])=O(514)', '[OH+]=[C-]F(1375)'],
    products = ['[O]C(=O)O[C](O)F(4409)'],
