...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF(125)', 'C#CO(429)'],
    products = ['C#COC(F)CF(1228)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'C#COC(F)[C]F(3845)'],
    products = ['C#COC(F)CF(1228)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CO[CH]CF(1381)'],
    products = ['C#COC(F)CF(1228)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#COC([CH2])F(381)'],
    products = ['C#COC(F)CF(1228)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', 'C#CO[CH]F(1547)'],
    products = ['C#COC(F)CF(1228)'],
