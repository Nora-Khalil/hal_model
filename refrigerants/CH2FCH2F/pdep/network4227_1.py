species(
    label = 'F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)',
...
species(
    label = 'FC1(F)C(F)(F)C(F)(F)C1(F)F(12788)',
...
species(
    label = 'F[C](F)C(F)(F)[C](F)C(F)(F)F(12789)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = 'F[C](F)[C](F)C(F)(F)C(F)(F)F(12790)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', 'F[C](F)C(F)(F)[C](F)F(12680)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)'],
    products = ['FC1(F)C(F)(F)C(F)(F)C1(F)F(12788)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C](F)C(F)(F)C(F)=C(F)F(12771)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2CF2(61)', 'F[C](F)[C](F)F(3840)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)[C](F)F(3840)', 'F[C](F)[C](F)F(3840)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F2(78)', 'F[C](F)C(F)=C(F)[C](F)F(12772)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF2(43)', 'F[C](F)C(F)(F)[C](F)F(12680)'],
    products = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)'],
    products = ['F[C](F)C(F)(F)[C](F)C(F)(F)F(12789)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)'],
    products = ['F[C](F)[C](F)C(F)(F)C(F)(F)F(12790)'],
...
network(
    label = 'PDepNetwork #4227',
    isomers = [
        'F[C](F)C(F)(F)C(F)(F)[C](F)F(12654)',
    ],
    reactants = [
        ('CF2CF2(61)', 'CF2CF2(61)'),
    ],
