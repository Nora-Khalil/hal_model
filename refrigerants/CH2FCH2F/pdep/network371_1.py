...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'C#COC(=O)F(1366)'],
    products = ['C#COC(C)([O])F(675)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=[C]OC(C)=O(1015)'],
    products = ['C#COC(C)([O])F(675)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C2H(22)', 'CC([O])([O])F(1367)'],
    products = ['C#COC(C)([O])F(675)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[CH]=[C]OC(=O)F(1368)'],
    products = ['C#COC(C)([O])F(675)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[C]#COC(C)([O])F(1370)'],
    products = ['C#COC(C)([O])F(675)'],
