...
"""),
    E0 = (-345.44,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,194,682,905,1196,1383,3221,314.651,314.651,314.651,314.651],'cm^-1')),
        HinderedRotor(inertia=(0.284823,'amu*angstrom^2'), symmetry=1, barrier=(20.0106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284823,'amu*angstrom^2'), symmetry=1, barrier=(20.0106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284823,'amu*angstrom^2'), symmetry=1, barrier=(20.0106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694324,0.0687387,-7.269e-05,3.81284e-08,-7.83773e-12,-41424.4,23.9189], Tmin=(100,'K'), Tmax=(1187.32,'K')), NASAPolynomial(coeffs=[16.0815,0.0169006,-7.20069e-06,1.35714e-09,-9.52911e-14,-45078.3,-52.9576], Tmin=(1187.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-345.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.198335,0.10267,-0.000175846,1.55713e-07,-5.3243e-11,-59742.7,29.1871], Tmin=(100,'K'), Tmax=(843.89,'K')), NASAPolynomial(coeffs=[10.8422,0.031551,-1.60374e-05,3.08383e-09,-2.11604e-13,-60937.1,-18.2394], Tmin=(843.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-497.903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsCsFHH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)

species(
    label = 'FCCO[CH][C](F)F(4735)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-484.061,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,190,488,555,1236,1407,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.143914,0.0941446,-0.000155662,1.38141e-07,-4.79471e-11,-58089.2,28.9409], Tmin=(100,'K'), Tmax=(827.465,'K')), NASAPolynomial(coeffs=[9.43994,0.0334047,-1.69084e-05,3.27086e-09,-2.26224e-13,-59086.6,-10.8775], Tmin=(827.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-484.061,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(F)F(506)', '[O]C[CH]F(138)'],
    products = ['F[CH]CO[CH]C(F)F(4706)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]O[CH]C(F)F(928)'],
    products = ['F[CH]CO[CH]C(F)F(4706)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['F[CH]CO[CH]C(F)F(4706)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(35.8713,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH2]O[CH]C(F)F(928)'],
    products = ['F[CH]CO[CH]C(F)F(4706)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]CO[CH]C(F)F(4706)'],
    products = ['FC[CH]O[CH]C(F)F(4732)'],
...
network(
    label = 'PDepNetwork #1906',
    isomers = [
        'F[CH]CO[CH]C(F)F(4706)',
    ],
    reactants = [
