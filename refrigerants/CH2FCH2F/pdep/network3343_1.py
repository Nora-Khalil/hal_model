...
reaction(
    label = 'reaction2',
    reactants = ['O=[O+][C-]C(F)=CF(10315)'],
    products = ['[C-]=[O+]OC(F)=CF(9951)'],
    transitionState = 'TS2',
