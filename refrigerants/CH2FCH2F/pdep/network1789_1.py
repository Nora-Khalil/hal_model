...
reaction(
    label = 'reaction2',
    reactants = ['O=C=C(O)OOF(4352)'],
    products = ['O=C(O)C(=O)OF(4072)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'O=[C]C(=O)OF(4351)'],
    products = ['O=C(O)C(=O)OF(4072)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(=O)C(=O)OF(4358)'],
    products = ['O=C(O)C(=O)OF(4072)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(127)', 'O=[C]C(=O)O(4359)'],
    products = ['O=C(O)C(=O)OF(4072)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OF(160)', 'O=[C]O(158)'],
    products = ['O=C(O)C(=O)OF(4072)'],
