...
reaction(
    label = 'reaction3',
    reactants = ['FCOF(1070)', 'F[C]CF(125)'],
    products = ['FCC(F)C(F)OF(3985)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'FCC(F)OF(1516)'],
    products = ['FCC(F)C(F)OF(3985)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(140)', 'F[C]C(F)CF(1612)'],
    products = ['FCC(F)C(F)OF(3985)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)C(F)OF(3987)'],
    products = ['FCC(F)C(F)OF(3985)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(1520)', 'FC=CCF(1191)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC[CH]C(F)OF(1538)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'FCC(F)[CH]OF(3989)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(F)C(F)OF(1527)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)C(F)CF(1619)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(127)', 'F[CH]C(F)CF(1037)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]OF(1060)', 'CH2F-CHF(66)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(46)', 'F[CH]C(F)OF(1524)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FC[C](F)C(F)OF(3990)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'FCC(F)[C](F)OF(3422)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'F[CH]C(F)C(F)OF(3991)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'FCC(F)=COF(3992)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'C=CC(F)OF(1531)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'O=C(F)C(F)CF(1138)'],
    products = ['FCC(F)C(F)OF(3985)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'FC=CC(F)OF(3115)'],
    products = ['FCC(F)C(F)OF(3985)'],
