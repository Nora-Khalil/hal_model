...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', 'F[CH]C[CH]F(232)'],
    products = ['F[CH]CC(F)[C](F)F(6111)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]CC=C(F)F(748)'],
    products = ['F[CH]CC(F)[C](F)F(6111)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH]CC(F)=C(F)F(6125)'],
    products = ['F[CH]CC(F)[C](F)F(6111)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FC=CC(F)[C](F)F(6126)'],
    products = ['F[CH]CC(F)[C](F)F(6111)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', 'F[CH]C[CH]F(232)'],
    products = ['F[CH]CC(F)[C](F)F(6111)'],
...
reaction(
    label = 'reaction19',
    reactants = ['FC[CH]C(F)[C](F)F(6128)'],
    products = ['F[CH]CC(F)[C](F)F(6111)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]CC(F)[C](F)F(6111)'],
    products = ['F[CH]C[CH]C(F)(F)F(2794)'],
...
network(
    label = 'PDepNetwork #2306',
    isomers = [
        'F[CH]CC(F)[C](F)F(6111)',
    ],
    reactants = [
        ('CHFCF2(55)', 'CH2CHF(56)'),
    ],
