...
"""),
    E0 = (-73.2618,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,251.127,251.584],'cm^-1')),
        HinderedRotor(inertia=(0.153698,'amu*angstrom^2'), symmetry=1, barrier=(6.88868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154139,'amu*angstrom^2'), symmetry=1, barrier=(6.88857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0150993,'amu*angstrom^2'), symmetry=1, barrier=(22.7974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07284,0.0448337,-4.53695e-05,2.52658e-08,-5.84625e-12,-8743.99,18.6033], Tmin=(100,'K'), Tmax=(1025.28,'K')), NASAPolynomial(coeffs=[8.3894,0.0201905,-9.31634e-06,1.82311e-09,-1.3011e-13,-10039.2,-12.0282], Tmin=(1025.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.2618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(H)(H)) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (-66.6079,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,3000,3100,440,815,1455,1000,205.259,1998.07],'cm^-1')),
        HinderedRotor(inertia=(0.2764,'amu*angstrom^2'), symmetry=1, barrier=(8.27166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276185,'amu*angstrom^2'), symmetry=1, barrier=(8.27148,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27652,'amu*angstrom^2'), symmetry=1, barrier=(8.27237,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90448,0.0519062,-8.05051e-05,7.40452e-08,-2.69746e-11,-7941.26,19.5225], Tmin=(100,'K'), Tmax=(818.899,'K')), NASAPolynomial(coeffs=[5.0954,0.0254937,-1.22942e-05,2.37058e-09,-1.64609e-13,-8100.87,6.98209], Tmin=(818.899,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.6079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH2]O[CH]CF(316)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-46.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,304.375,304.38,3628.85],'cm^-1')),
        HinderedRotor(inertia=(0.11555,'amu*angstrom^2'), symmetry=1, barrier=(7.5965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.74782,'amu*angstrom^2'), symmetry=1, barrier=(49.1663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115542,'amu*angstrom^2'), symmetry=1, barrier=(7.59664,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82215,0.0527369,-7.95302e-05,6.88798e-08,-2.35187e-11,-5500.35,19.2441], Tmin=(100,'K'), Tmax=(848.491,'K')), NASAPolynomial(coeffs=[6.39229,0.0222885,-9.96173e-06,1.852e-09,-1.25713e-13,-5955.4,-0.164688], Tmin=(848.491,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(CsJOCC)"""),
)

species(
    label = '[CH2][CH]OCF(324)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (-64.8703,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,859.703,859.712],'cm^-1')),
        HinderedRotor(inertia=(0.0285291,'amu*angstrom^2'), symmetry=1, barrier=(3.57617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.595832,'amu*angstrom^2'), symmetry=1, barrier=(13.6994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.595839,'amu*angstrom^2'), symmetry=1, barrier=(13.6995,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9837,0.0450195,-4.53067e-05,2.44411e-08,-5.35876e-12,-7730.03,18.7408], Tmin=(100,'K'), Tmax=(1093.32,'K')), NASAPolynomial(coeffs=[9.49392,0.0175429,-7.60977e-06,1.45495e-09,-1.02727e-13,-9372.24,-18.1618], Tmin=(1093.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-64.8703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJOCs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[CH]F(318)'],
    products = ['[CH2]OC([CH2])F(185)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(20)', '[CH2][CH]F(226)'],
    products = ['[CH2]OC([CH2])F(185)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](133)', '[CH2][CH]F(226)'],
    products = ['[CH2]OC([CH2])F(185)'],
