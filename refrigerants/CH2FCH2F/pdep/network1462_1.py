...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C=O(1608)'],
    products = ['[CH]=CC([O])=O(3227)'],
    transitionState = 'TS2',
