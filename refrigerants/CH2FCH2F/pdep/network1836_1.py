...
reaction(
    label = 'reaction6',
    reactants = ['OH(7)', '[CH2]OC(F)(F)F(4534)'],
    products = ['OCOC(F)(F)F(4119)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]COC(F)(F)F(4535)'],
    products = ['OCOC(F)(F)F(4119)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O[CH]OC(F)(F)F(3820)'],
    products = ['OCOC(F)(F)F(4119)'],
    transitionState = 'TS8',
