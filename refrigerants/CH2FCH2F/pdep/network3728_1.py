...
"""),
    E0 = (-442.944,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([286,334,437,422,648,895,1187,1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,799.919],'cm^-1')),
        HinderedRotor(inertia=(0.532985,'amu*angstrom^2'), symmetry=1, barrier=(12.2544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0534727,'amu*angstrom^2'), symmetry=1, barrier=(12.2452,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-300.932,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([316,385,515,654,689,1295,528,1116,1182,1331,1402,1494,3075,3110,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,277.502,277.522,277.524],'cm^-1')),
        HinderedRotor(inertia=(0.00218873,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00218879,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234584,'amu*angstrom^2'), symmetry=1, barrier=(12.8206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33695,0.0595921,-5.3375e-05,2.54244e-08,-5.02411e-12,-36098.8,24.8657], Tmin=(100,'K'), Tmax=(1186.48,'K')), NASAPolynomial(coeffs=[10.9617,0.027144,-1.23527e-05,2.37447e-09,-1.67324e-13,-38382.7,-23.2139], Tmin=(1186.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-300.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(CCJCO)"""),
)

species(
    label = 'CC1OOC1(F)CF(11277)',
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.723803,0.063167,-4.81195e-05,1.79482e-08,-2.66468e-12,-61332.6,24.3215], Tmin=(100,'K'), Tmax=(1591.99,'K')), NASAPolynomial(coeffs=[17.0832,0.0220625,-9.39017e-06,1.72974e-09,-1.17796e-13,-66541.4,-62.2102], Tmin=(1591.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-510.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(Cs-CsCsOsH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + ring(Cs-Cs(F)-O2s-O2s)"""),
)

species(
    label = 'CC(=O)C(O)(F)CF(11418)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.776101,0.0745614,-7.91577e-05,4.508e-08,-1.05644e-11,-100363,24.7599], Tmin=(100,'K'), Tmax=(1018.39,'K')), NASAPolynomial(coeffs=[11.9172,0.0308009,-1.47008e-05,2.88368e-09,-2.05594e-13,-102632,-29.192], Tmin=(1018.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-835.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs)"""),
)
...
"""),
    E0 = (-348.209,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,340.236,340.238,4000],'cm^-1')),
        HinderedRotor(inertia=(0.236497,'amu*angstrom^2'), symmetry=1, barrier=(19.4274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00145627,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236498,'amu*angstrom^2'), symmetry=1, barrier=(19.4274,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-339.169,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,212,931,1104,1251,1325,1474,3102,3155,325,375,415,465,420,450,1700,1750,238.886,246.521,254.172],'cm^-1')),
        HinderedRotor(inertia=(0.102249,'amu*angstrom^2'), symmetry=1, barrier=(5.0265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108943,'amu*angstrom^2'), symmetry=1, barrier=(5.13079,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-461.716,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,286,334,437,422,648,895,1187,1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,346.496,346.572],'cm^-1')),
        HinderedRotor(inertia=(0.10221,'amu*angstrom^2'), symmetry=1, barrier=(8.71046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194767,'amu*angstrom^2'), symmetry=1, barrier=(16.5957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10226,'amu*angstrom^2'), symmetry=1, barrier=(8.71081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102292,'amu*angstrom^2'), symmetry=1, barrier=(8.71646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.241867,0.0876457,-0.00011589,8.17982e-08,-2.31834e-11,-55400.6,29.3034], Tmin=(100,'K'), Tmax=(860.377,'K')), NASAPolynomial(coeffs=[12.8425,0.0290626,-1.37536e-05,2.65573e-09,-1.86554e-13,-57568.9,-29.5925], Tmin=(860.377,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-461.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsOsH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(CJCO)"""),
)

species(
    label = 'CC(O)C([O])(F)[CH]F(11426)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {14,S}
...
"""),
    E0 = (-465.306,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,333,384,448,608,1254,1480,1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,275.639,277.197,282.004],'cm^-1')),
        HinderedRotor(inertia=(0.293891,'amu*angstrom^2'), symmetry=1, barrier=(15.9603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290821,'amu*angstrom^2'), symmetry=1, barrier=(15.9669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.413062,'amu*angstrom^2'), symmetry=1, barrier=(22.7945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.361255,'amu*angstrom^2'), symmetry=1, barrier=(19.0967,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.212723,0.0857804,-0.000101062,6.11742e-08,-1.47755e-11,-55829,28.0709], Tmin=(100,'K'), Tmax=(1005.76,'K')), NASAPolynomial(coeffs=[15.1536,0.0263579,-1.24365e-05,2.42786e-09,-1.72761e-13,-58834.3,-44.0958], Tmin=(1005.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-465.306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsOsH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = 'CC([O])[C](CF)OF(11428)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-133.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,273.73,274.537,274.779,275.084],'cm^-1')),
        HinderedRotor(inertia=(0.002237,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146306,'amu*angstrom^2'), symmetry=1, barrier=(7.89598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146987,'amu*angstrom^2'), symmetry=1, barrier=(7.89246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.418911,'amu*angstrom^2'), symmetry=1, barrier=(22.6623,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.51226,0.0850278,-0.000109723,7.03345e-08,-1.37377e-11,-15891.3,28.2244], Tmin=(100,'K'), Tmax=(615.118,'K')), NASAPolynomial(coeffs=[10.3329,0.0339865,-1.65193e-05,3.20248e-09,-2.24441e-13,-17342,-16.3535], Tmin=(615.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(CsCsFHH) + radical(CC(C)OJ) + radical(C2CsJO)"""),
)

species(
    label = 'CC(OF)[C]([O])CF(11429)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-136.584,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,331.349,331.349,331.349,331.349],'cm^-1')),
        HinderedRotor(inertia=(0.131335,'amu*angstrom^2'), symmetry=1, barrier=(10.2324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131335,'amu*angstrom^2'), symmetry=1, barrier=(10.2324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131335,'amu*angstrom^2'), symmetry=1, barrier=(10.2324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.332477,'amu*angstrom^2'), symmetry=1, barrier=(25.9035,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.14792,0.0908416,-0.000127232,9.73046e-08,-3.00492e-11,-16294.2,28.4993], Tmin=(100,'K'), Tmax=(790.148,'K')), NASAPolynomial(coeffs=[11.7822,0.0319485,-1.5437e-05,2.98674e-09,-2.09168e-13,-18132.9,-24.8899], Tmin=(790.148,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.584,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(CsCsFHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(F)(OF)C(C)[O](11430)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.189686,'amu*angstrom^2'), symmetry=1, barrier=(4.36126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189668,'amu*angstrom^2'), symmetry=1, barrier=(4.36085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189657,'amu*angstrom^2'), symmetry=1, barrier=(4.3606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.771732,'amu*angstrom^2'), symmetry=1, barrier=(17.7436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0250854,0.0963358,-0.000149515,1.27052e-07,-4.30158e-11,-18358.4,28.7278], Tmin=(100,'K'), Tmax=(804.136,'K')), NASAPolynomial(coeffs=[10.6679,0.0341939,-1.68987e-05,3.26229e-09,-2.26445e-13,-19788.6,-18.7288], Tmin=(804.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCCFO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'CC([O])C([O])(F)F(3874)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', '[O]CC([O])(F)CF(9964)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'CC([O])[C](F)CF(3511)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', 'C[CH]C([O])(F)CF(10468)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'CC([O])C(=O)CF(11419)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', 'CC([O])C(=O)F(3901)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', '[O]C(F)(C=O)CF(10204)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(=O)C([O])(F)CF(11420)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'C=C([O])C(C)[O](5669)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'CC([O])=C([O])CF(11421)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC([O])C([O])(F)CF(11273)'],
    products = ['CC([O])C(O)(F)[CH]F(11424)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(O)C([O])(F)CF(11425)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC([O])C([O])(F)CF(11273)'],
    products = ['CC(O)C([O])(F)[CH]F(11426)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([O])C(O)(F)CF(11427)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(F)(OF)C(C)[O](11430)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C([O])(F)C(C)OF(11431)'],
    products = ['CC([O])C([O])(F)CF(11273)'],
