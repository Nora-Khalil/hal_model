...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(514)', '[CH]F(223)'],
    products = ['[O]C(=O)O[CH]F(2555)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(276)', '[O][CH]F(1073)'],
    products = ['[O]C(=O)O[CH]F(2555)'],
