...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH][C](F)F(3911)'],
    products = ['CHF2-CF2(69)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'F[C](F)[C](F)F(3840)'],
    products = ['CHF2-CF2(69)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C]C(F)F-2(1828)'],
    products = ['CHF2-CF2(69)'],
    transitionState = 'TS6',
