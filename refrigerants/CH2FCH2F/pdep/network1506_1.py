...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C(=C)[O](386)'],
    products = ['[CH2]CC(=C)[O](3255)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CO(28)', '[CH2][CH2](511)'],
    products = ['[CH2]CC(=C)[O](3255)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]=O(338)', '[CH2][CH2](511)'],
    products = ['[CH2]CC(=C)[O](3255)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[CH2]C[C]=O(334)'],
    products = ['[CH2]CC(=C)[O](3255)'],
