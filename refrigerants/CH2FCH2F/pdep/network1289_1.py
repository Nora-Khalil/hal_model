...
reaction(
    label = 'reaction1',
    reactants = ['CO(13)', 'CHF3(42)'],
    products = ['CF3CHO(75)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.81927e-10,'cm^3/(mol*s)'), n=6.80628, Ea=(325.917,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 33.5544, dn = +|- 0.46156, dEa = +|- 2.51179 kJ/molMatched reaction 12 CHF3 + CO <=> C2HF3O in 1,2_Insertion_CO/training
This reaction matched rate rule [Root_1COCbCdCsCtHNOSSidSis->Cs_N-2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->Cs_Ext-1Cs-R_N-2Br1sCl1sF1sH->F1s_N-5R!H->C]
family: 1,2_Insertion_CO"""),
)

reaction(
    label = 'reaction2',
    reactants = ['FOC=C(F)F(1650)'],
    products = ['CF3CHO(75)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.88952e+10,'s^-1'), n=0.725184, Ea=(141.93,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O=C[C](F)F(787)'],
    products = ['CF3CHO(75)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0.49057,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'CF3CO(74)'],
    products = ['CF3CHO(75)'],
    transitionState = 'TS4',
