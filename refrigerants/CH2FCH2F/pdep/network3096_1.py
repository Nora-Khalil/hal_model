...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC1(F)[CH]O1(9306)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C1(F)[CH]O1(9413)'],
    products = ['O=[C]OC1(F)[CH]O1(9306)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C1(F)[CH]O1(9413)'],
    products = ['O=[C]OC1(F)[CH]O1(9306)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC1=CO1(9508)'],
    products = ['O=[C]OC1(F)[CH]O1(9306)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OC1(F)[CH]O1(9306)'],
    products = ['O=C(F)O[C]1[CH]O1(9509)'],
