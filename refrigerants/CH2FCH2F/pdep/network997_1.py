...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C[C](F)F(2161)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C([O])(F)F(2159)'],
    products = ['[O]C(F)(F)C[C](F)F(2161)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C[C](F)F(795)'],
    products = ['[O]C(F)(F)C[C](F)F(2161)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C=C(F)F(2210)'],
    products = ['[O]C(F)(F)C[C](F)F(2161)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C[C](F)F(1154)'],
    products = ['[O]C(F)(F)C[C](F)F(2161)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(F)(F)[CH]C(F)F(2212)'],
    products = ['[O]C(F)(F)C[C](F)F(2161)'],
...
network(
    label = 'PDepNetwork #997',
    isomers = [
        '[O]C(F)(F)C[C](F)F(2161)',
    ],
    reactants = [
        ('CF2O(49)', 'CH2CF2(57)'),
    ],
