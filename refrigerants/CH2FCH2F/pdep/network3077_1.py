...
species(
    label = '[CH2]C1(F)O[CH]C1(F)F(9289)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(9205)'],
    products = ['[CH2]C1(F)O[CH]C1(F)F(9289)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C1(F)[CH]O1(9290)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(9205)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)[C](F)C=O(9291)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(9205)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)(F)C1=CO1(9292)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(9205)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C1(F)[CH]O1(9251)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(9205)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH2]C(F)=C1[CH]O1(9253)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(9205)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(9205)'],
    products = ['FCC(F)(F)[C]1[CH]O1(9293)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C1(F)[CH]O1(9205)'],
    products = ['[CH2][C](F)C1(F)OC1F(9294)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC[C](F)C1(F)[CH]O1(9295)'],
    products = ['[CH2]C(F)(F)C1(F)[CH]O1(9205)'],
