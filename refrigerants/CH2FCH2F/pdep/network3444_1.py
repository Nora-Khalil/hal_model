...
"""),
    E0 = (-835.539,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,482,664,788,1296,1923,329.403,329.41,329.422,329.465],'cm^-1')),
        HinderedRotor(inertia=(0.377157,'amu*angstrom^2'), symmetry=1, barrier=(29.0486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113528,'amu*angstrom^2'), symmetry=1, barrier=(8.74505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.505032,'amu*angstrom^2'), symmetry=1, barrier=(38.8948,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46821,0.0608493,-7.31496e-05,4.67422e-08,-1.22984e-11,-100405,23.601], Tmin=(100,'K'), Tmax=(911.016,'K')), NASAPolynomial(coeffs=[9.80812,0.0242307,-1.28558e-05,2.61956e-09,-1.90196e-13,-101925,-15.8569], Tmin=(911.016,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-835.539,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COFOO) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.61444,0.0789558,-0.000110654,7.86956e-08,-2.212e-11,-79716,27.0742], Tmin=(100,'K'), Tmax=(871.867,'K')), NASAPolynomial(coeffs=[13.3142,0.0206943,-1.04237e-05,2.05917e-09,-1.46321e-13,-81930.6,-32.4541], Tmin=(871.867,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-663.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHOO) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = '[O][C](F)OC(F)CF(10197)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-603.128,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,482,586,761,1411,180,180,180,731.767,733.929],'cm^-1')),
        HinderedRotor(inertia=(0.125314,'amu*angstrom^2'), symmetry=1, barrier=(27.7932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0728069,'amu*angstrom^2'), symmetry=1, barrier=(27.8137,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.970712,0.0593838,-5.34587e-05,2.3072e-08,-3.90408e-12,-72424.5,27.352], Tmin=(100,'K'), Tmax=(1425.34,'K')), NASAPolynomial(coeffs=[16.6866,0.0152788,-7.04237e-06,1.36149e-09,-9.60515e-14,-76904.5,-54.0374], Tmin=(1425.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-603.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = 'OC(F)O[C](F)[CH]F(10198)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-347.594,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,509,613,660,1171,1360,1414,3084,395,473,707,1436,3000,3100,440,815,1455,1000,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.222178,'amu*angstrom^2'), symmetry=1, barrier=(5.1083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222095,'amu*angstrom^2'), symmetry=1, barrier=(5.1064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57961,'amu*angstrom^2'), symmetry=1, barrier=(36.3183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.977082,'amu*angstrom^2'), symmetry=1, barrier=(22.465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.184992,0.0925354,-0.000158847,1.39669e-07,-4.78665e-11,-41676.8,28.4292], Tmin=(100,'K'), Tmax=(814.599,'K')), NASAPolynomial(coeffs=[11.1967,0.0262131,-1.41633e-05,2.79909e-09,-1.95564e-13,-43064.4,-19.9433], Tmin=(814.599,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-347.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHOO) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)(F)OC([O])F(10200)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10633,0.0679947,-8.30352e-05,5.31503e-08,-1.37818e-11,-78367.1,25.3421], Tmin=(100,'K'), Tmax=(931.903,'K')), NASAPolynomial(coeffs=[11.3682,0.0239471,-1.2135e-05,2.42901e-09,-1.7474e-13,-80279.7,-23.4419], Tmin=(931.903,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-652.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsHHH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)

species(
    label = 'FC[C](F)O[CH]OF(10201)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-309.304,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0930818,0.0975087,-0.000166247,1.3999e-07,-4.54565e-11,-37060.5,27.1723], Tmin=(100,'K'), Tmax=(843.918,'K')), NASAPolynomial(coeffs=[13.8605,0.0206688,-1.06463e-05,2.04324e-09,-1.39607e-13,-39034.5,-35.5197], Tmin=(843.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(OCJO)"""),
)

species(
    label = '[O][CH]OC(F)(F)CF(10202)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694609,0.0844334,-0.000151863,1.46628e-07,-5.44458e-11,-76960.9,24.9738], Tmin=(100,'K'), Tmax=(822.668,'K')), NASAPolynomial(coeffs=[5.73202,0.0359012,-1.95407e-05,3.87827e-09,-2.7164e-13,-76976.2,6.59859], Tmin=(822.668,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-640.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)O[C](F)CF(10031)'],
    products = ['CHFO(47)', 'O=C(F)CF(476)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(1122)', 'F[C]CF-2(467)'],
    products = ['[O]C(F)O[C](F)CF(10031)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)CF(1130)'],
    products = ['[O]C(F)O[C](F)CF(10031)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)OC(F)=CF(10193)'],
    products = ['[O]C(F)O[C](F)CF(10031)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C([O])F(1122)', 'F[C]CF(125)'],
    products = ['[O]C(F)O[C](F)CF(10031)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)O[C](F)CF(10031)'],
    products = ['OC(F)O[C](F)[CH]F(10198)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C](F)OC(F)OF(10199)'],
    products = ['[O]C(F)O[C](F)CF(10031)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(90.5143,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)O[C](F)CF(10031)'],
    products = ['[CH2]C(F)(F)OC([O])F(10200)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FC[C](F)O[CH]OF(10201)'],
    products = ['[O]C(F)O[C](F)CF(10031)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)O[C](F)CF(10031)'],
    products = ['[O][CH]OC(F)(F)CF(10202)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(214.379,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #3444',
    isomers = [
        '[O]C(F)O[C](F)CF(10031)',
    ],
    reactants = [
        ('CHFO(47)', 'O=C(F)CF(476)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
