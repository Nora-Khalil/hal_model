...
reaction(
    label = 'reaction5',
    reactants = ['FO[C]1CC[CH]O1(6017)'],
    products = ['C=COC(=C)OF(6000)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(=O)OC=C(5732)'],
    products = ['C=COC(=C)OF(6000)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]OF(196)', 'CH2CHO(35)'],
    products = ['C=COC(=C)OF(6000)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(=O)OF(3335)', 'C2H3(29)'],
    products = ['C=COC(=C)OF(6000)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(127)', 'C=[C]OC=C(379)'],
    products = ['C=COC(=C)OF(6000)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=[C]OC(=C)OF(6024)'],
    products = ['C=COC(=C)OF(6000)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)OC=C(6025)'],
    products = ['C=COC(=C)OF(6000)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH]=COC(=C)OF(6026)'],
    products = ['C=COC(=C)OF(6000)'],
