...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[CH]C(=O)F(427)'],
    products = ['[CH]=C(F)O[C]=O(2682)'],
    transitionState = 'TS2',
