...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'O=[C]C[CH]F(297)'],
    products = ['[CH2]C(F)C[C]=O(205)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(129)', '[CH2]C([CH2])F(231)'],
    products = ['[CH2]C(F)C[C]=O(205)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C([CH2])F(231)'],
    products = ['[CH2]C(F)C[C]=O(205)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(F)C=C=O(361)'],
    products = ['[CH2]C(F)C[C]=O(205)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C=C[C]=O(362)'],
    products = ['[CH2]C(F)C[C]=O(205)'],
