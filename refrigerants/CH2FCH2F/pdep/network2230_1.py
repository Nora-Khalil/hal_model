...
"""),
    E0 = (-1240.79,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,482,664,788,1296,1923,299.741,299.742,299.742,860.453],'cm^-1')),
        HinderedRotor(inertia=(0.00187632,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120169,'amu*angstrom^2'), symmetry=1, barrier=(7.66157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368536,'amu*angstrom^2'), symmetry=1, barrier=(23.4964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368535,'amu*angstrom^2'), symmetry=1, barrier=(23.4964,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.879048,0.0730738,-8.40375e-05,4.95726e-08,-1.18494e-11,-149124,28.3157], Tmin=(100,'K'), Tmax=(1005.28,'K')), NASAPolynomial(coeffs=[12.7784,0.0257257,-1.33877e-05,2.71962e-09,-1.97504e-13,-151517,-29.1545], Tmin=(1005.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1240.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(COFOO)"""),
)
...
"""),
    E0 = (-1226.79,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,205,317,423,563,514,686,1105,1199,1293,1437,1381,1463,3031,3163,482,664,788,1296,1923,292.718,292.718,613.469,1620.05],'cm^-1')),
        HinderedRotor(inertia=(0.4273,'amu*angstrom^2'), symmetry=1, barrier=(25.9813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427302,'amu*angstrom^2'), symmetry=1, barrier=(25.9813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427302,'amu*angstrom^2'), symmetry=1, barrier=(25.9813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427302,'amu*angstrom^2'), symmetry=1, barrier=(25.9813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.744593,0.0695838,-6.82218e-05,3.24076e-08,-6.1085e-12,-147430,27.3144], Tmin=(100,'K'), Tmax=(1272.52,'K')), NASAPolynomial(coeffs=[16.3682,0.0204732,-1.03322e-05,2.07964e-09,-1.50267e-13,-151407,-51.8258], Tmin=(1272.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1226.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COFOO)"""),
)
...
"""),
    E0 = (-813.412,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,522,611,926,1093,1137,1374,1416,3112,451,553,637,1069,1180,1265,1301,3056,360,370,350,258.448,258.449,258.454,258.457],'cm^-1')),
        HinderedRotor(inertia=(0.101262,'amu*angstrom^2'), symmetry=1, barrier=(4.79985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101262,'amu*angstrom^2'), symmetry=1, barrier=(4.79979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10126,'amu*angstrom^2'), symmetry=1, barrier=(4.79981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.448828,'amu*angstrom^2'), symmetry=1, barrier=(21.2728,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.442578,0.0845518,-0.000120164,8.9239e-08,-2.65568e-11,-97708.4,31.4772], Tmin=(100,'K'), Tmax=(820.221,'K')), NASAPolynomial(coeffs=[12.3723,0.0263727,-1.37659e-05,2.75795e-09,-1.97281e-13,-99665.4,-23.7123], Tmin=(820.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-813.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Cs_P)"""),
)

species(
    label = 'O[C](F)O[C](O)C(F)F(5893)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-864.112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,522,611,926,1093,1137,1374,1416,3112,360,370,350,482,586,761,1411,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.244264,0.0881384,-0.000123365,8.68137e-08,-2.41627e-11,-103798,32.5255], Tmin=(100,'K'), Tmax=(879.445,'K')), NASAPolynomial(coeffs=[14.5928,0.0228761,-1.20506e-05,2.4308e-09,-1.74902e-13,-106322,-34.8544], Tmin=(879.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-864.112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFHOO) + radical(Cs_P) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = '[O]C(F)OC([O])C(F)F(5894)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-792.953,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,451,553,637,1069,1180,1265,1301,3056,180,180,180,546.905,552.276],'cm^-1')),
        HinderedRotor(inertia=(0.106843,'amu*angstrom^2'), symmetry=1, barrier=(2.45653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109143,'amu*angstrom^2'), symmetry=1, barrier=(2.50942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112275,'amu*angstrom^2'), symmetry=1, barrier=(2.58142,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37143,0.0704528,-5.98667e-05,-4.23593e-08,8.02571e-11,-95288.7,28.4966], Tmin=(100,'K'), Tmax=(469.29,'K')), NASAPolynomial(coeffs=[8.33365,0.0342673,-1.82234e-05,3.63048e-09,-2.56674e-13,-96197.2,-2.54177], Tmin=(469.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-792.953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFHOO) + radical(CCOJ) + radical(O2sj(Cs-F1sO2sH))"""),
)

species(
    label = '[O]C(F)OC(O)[C](F)F(5895)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-811.033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,451,553,637,1069,1180,1265,1301,3056,190,488,555,1236,1407,235.542,235.542,1883.09,1883.09],'cm^-1')),
        HinderedRotor(inertia=(0.273876,'amu*angstrom^2'), symmetry=1, barrier=(10.7824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273877,'amu*angstrom^2'), symmetry=1, barrier=(10.7824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273875,'amu*angstrom^2'), symmetry=1, barrier=(10.7824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.758318,'amu*angstrom^2'), symmetry=1, barrier=(29.8549,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.302337,0.0888819,-0.000143124,1.23379e-07,-4.2296e-11,-97418.9,32.7854], Tmin=(100,'K'), Tmax=(786.183,'K')), NASAPolynomial(coeffs=[10.5544,0.0293113,-1.53297e-05,3.02468e-09,-2.12428e-13,-98801.9,-12.7525], Tmin=(786.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-811.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = '[O]C(O[C](O)F)C(F)F(5896)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-843.653,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,482,586,761,1411,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.377572,0.0871419,-0.000135122,1.14741e-07,-3.95399e-11,-101345,32.2058], Tmin=(100,'K'), Tmax=(723.581,'K')), NASAPolynomial(coeffs=[10.2442,0.0313465,-1.68617e-05,3.39067e-09,-2.41786e-13,-102740,-11.9762], Tmin=(723.581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-843.653,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFHOO) + radical(CCOJ) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = 'O[C](F)OC(O)[C](F)F(5897)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-861.733,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,190,488,555,1236,1407,482,586,761,1411,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.130599,0.0920613,-0.00014442,1.17725e-07,-3.81496e-11,-103510,33.7442], Tmin=(100,'K'), Tmax=(757.28,'K')), NASAPolynomial(coeffs=[12.6176,0.02611,-1.3797e-05,2.74288e-09,-1.93951e-13,-105401,-23.0281], Tmin=(757.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-861.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsFHOO) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'O=C(F)OC(O)[C]F(5889)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'O=C(F)OC(O)F(4090)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C(F)OC(F)C(O)F(5890)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'O=C(F)OC=C(F)F(5480)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(140)', 'O=C(F)OC=CF(5891)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(F)O[C](O)C(F)F(5892)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O[C](F)O[C](O)C(F)F(5893)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)OC([O])C(F)F(5894)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(F)OC(O)[C](F)F(5895)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O[C](O)F)C(F)F(5896)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](F)OC(O)[C](F)F(5897)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(F)OC(O)[CH]F(5898)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=[C]OC(O)C(F)F(5899)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C(=O)F(161)', 'O[CH]C(F)F(1906)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CFO(51)', '[O]C(O)C(F)F(4954)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OH(7)', 'O=C(F)O[CH]C(F)F(5039)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[O]C(OC(=O)F)C(F)F(5900)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CHF2(82)', 'O=C(F)O[CH]O(4480)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=C(F)O[C](O)C(F)F(5901)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'O=C(F)OC(O)[C](F)F(5902)'],
    products = ['O=C(F)OC(O)C(F)F(5788)'],
