...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37284,0.0530122,-4.39079e-05,1.76975e-08,-2.84147e-12,-82320.5,22.4557], Tmin=(100,'K'), Tmax=(1475.18,'K')), NASAPolynomial(coeffs=[14.3029,0.0179519,-8.25761e-06,1.58633e-09,-1.1109e-13,-86135.3,-44.9511], Tmin=(1475.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-685.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFH) + ring(Cs-Cs(F)-O2s-O2s)"""),
)

species(
    label = 'O=C(C(O)F)C(F)F(5048)',
...
"""),
    E0 = (-750.55,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([241,322,589,815,1096,1220,1302,2892,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,180,3171.16],'cm^-1')),
        HinderedRotor(inertia=(0.408838,'amu*angstrom^2'), symmetry=1, barrier=(9.39999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.408587,'amu*angstrom^2'), symmetry=1, barrier=(9.39422,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.965231,0.0780903,-0.0001453,1.3765e-07,-4.90091e-11,-90172,25.5736], Tmin=(100,'K'), Tmax=(864.827,'K')), NASAPolynomial(coeffs=[6.28675,0.0280512,-1.44095e-05,2.75528e-09,-1.87264e-13,-90141.6,6.1704], Tmin=(864.827,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-750.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsCs) + radical(O2sj(Cs-F1sCOH))"""),
)
...
"""),
    E0 = (-511.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,3010,987.5,1337.5,450,1655,218.782,219.072,219.14],'cm^-1')),
        HinderedRotor(inertia=(0.706068,'amu*angstrom^2'), symmetry=1, barrier=(24.0874,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25593,0.0576485,-6.82096e-05,3.92222e-08,-8.71638e-12,-61360.6,21.6022], Tmin=(100,'K'), Tmax=(1109.31,'K')), NASAPolynomial(coeffs=[14.3712,0.0103566,-4.26164e-06,7.91033e-10,-5.52847e-14,-64270.4,-43.0321], Tmin=(1109.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-511.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)

species(
    label = '[O]C(F)[C](O)C(F)F(5054)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.4215,0.0865192,-0.000146659,1.27064e-07,-4.25652e-11,-82345.7,27.4871], Tmin=(100,'K'), Tmax=(844.738,'K')), NASAPolynomial(coeffs=[10.84,0.0239564,-1.20752e-05,2.31197e-09,-1.58196e-13,-83633.9,-18.2246], Tmin=(844.738,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-685.67,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sH)) + radical(C2CsJOH)"""),
)

species(
    label = '[O]C([C](O)F)C(F)F(5055)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-660.429,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,391,562,707,872,1109,1210,1289,3137,190,488,555,1236,1407,191.144,191.161],'cm^-1')),
        HinderedRotor(inertia=(0.25662,'amu*angstrom^2'), symmetry=1, barrier=(6.65749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257116,'amu*angstrom^2'), symmetry=1, barrier=(6.65669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256816,'amu*angstrom^2'), symmetry=1, barrier=(6.65735,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.60137,0.0807551,-0.000128773,1.07556e-07,-3.54661e-11,-79314.7,28.4661], Tmin=(100,'K'), Tmax=(802.546,'K')), NASAPolynomial(coeffs=[11.0793,0.0233367,-1.17456e-05,2.27634e-09,-1.58059e-13,-80829.2,-18.7367], Tmin=(802.546,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-660.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)

species(
    label = '[O][C](F)C(O)C(F)F(5057)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.490616,0.0857246,-0.000147895,1.30222e-07,-4.40509e-11,-80192.9,28.6174], Tmin=(100,'K'), Tmax=(854.28,'K')), NASAPolynomial(coeffs=[10.0779,0.0246934,-1.2392e-05,2.3612e-09,-1.60785e-13,-81241.9,-12.6787], Tmin=(854.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-667.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFH) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O][C](C(O)F)C(F)F(5058)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-322.652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,224.152,224.203,224.614,1854.26],'cm^-1')),
        HinderedRotor(inertia=(0.218659,'amu*angstrom^2'), symmetry=1, barrier=(7.74692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210141,'amu*angstrom^2'), symmetry=1, barrier=(7.7319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18056,'amu*angstrom^2'), symmetry=1, barrier=(41.5947,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.346349,0.092116,-0.000167913,1.5608e-07,-5.5222e-11,-38685.8,27.8394], Tmin=(100,'K'), Tmax=(848.35,'K')), NASAPolynomial(coeffs=[8.24161,0.0306129,-1.6242e-05,3.15926e-09,-2.17498e-13,-39151.8,-3.80344], Tmin=(848.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-322.652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[O]C([CH]OF)C(F)F(5063)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-314.572,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,378.094,378.121,378.154,378.158],'cm^-1')),
        HinderedRotor(inertia=(0.235008,'amu*angstrom^2'), symmetry=1, barrier=(23.8462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120041,'amu*angstrom^2'), symmetry=1, barrier=(12.1809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152742,'amu*angstrom^2'), symmetry=1, barrier=(15.4963,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.426829,0.0829822,-0.000117186,8.26079e-08,-2.28823e-11,-37709.4,27.166], Tmin=(100,'K'), Tmax=(886.314,'K')), NASAPolynomial(coeffs=[14.4603,0.0196484,-1.00005e-05,1.9856e-09,-1.41547e-13,-40197,-38.844], Tmin=(886.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CC(C)OJ) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C([O])C(F)F(4994)'],
...
reaction(
    ...
    products = ['[O]C(F)C([O])C(F)F(4994)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(127.181,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
...
reaction(
    ...
    products = ['[O]C(F)C([O])C(F)F(4994)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(9.9233e-06,'m^3/(mol*s)'), n=3.30609, Ea=(149.95,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(F)[CH]C(F)F(1148)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C([CH]F)C(F)F(4759)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(82)', '[O]C(F)C=O(1181)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(37.1864,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(35.4427,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]C(F)C(=O)C(F)F(5050)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(15.9,'m^3/(mol*s)'), n=1.84, Ea=(16.8942,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H"""),
)

reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(C=O)C(F)F(4967)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(17.1484,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(54.6549,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(C(=O)F)C(F)F(5051)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(245.854,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[O]C=C([O])C(F)F(5053)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(349.267,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)C([O])C(F)F(4994)'],
    products = ['[O]C(F)[C](O)C(F)F(5054)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)C(O)[C](F)F(5056)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)C([CH]F)OF(5060)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C([CH]F)C(F)OF(5061)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O][CH]C(OF)C(F)F(5062)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C([CH]OF)C(F)F(5063)'],
    products = ['[O]C(F)C([O])C(F)F(4994)'],
