...
reaction(
    label = 'reaction2',
    reactants = ['CH3F(39)', 'OC(F)[C]F(1611)'],
    products = ['OC(F)C(F)CF(1512)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'F[C]C(F)CF(1612)'],
    products = ['OC(F)C(F)CF(1512)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'OC(F)C(F)[C]F(1613)'],
    products = ['OC(F)C(F)CF(1512)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H2O(3)', 'FC=C(F)CF(1590)'],
    products = ['OC(F)C(F)CF(1512)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)[CH]CF(1616)'],
    products = ['OC(F)C(F)CF(1512)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O[CH]C(F)CF(1617)'],
    products = ['OC(F)C(F)CF(1512)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)C(O)F(1618)'],
    products = ['OC(F)C(F)CF(1512)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'F[CH]C(F)CF(1037)'],
    products = ['OC(F)C(F)CF(1512)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)C(F)CF(1619)'],
    products = ['OC(F)C(F)CF(1512)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[CH]F(459)', 'CH2F-CHF(66)'],
    products = ['OC(F)C(F)CF(1512)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(46)', 'OC(F)[CH]F(982)'],
    products = ['OC(F)C(F)CF(1512)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OC(F)[C](F)CF(1620)'],
    products = ['OC(F)C(F)CF(1512)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O[C](F)C(F)CF(1621)'],
    products = ['OC(F)C(F)CF(1512)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(F)C(F)[CH]F(1622)'],
    products = ['OC(F)C(F)CF(1512)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'OC=C(F)CF(1624)'],
    products = ['OC(F)C(F)CF(1512)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'C=C(F)C(O)F(1089)'],
    products = ['OC(F)C(F)CF(1512)'],
