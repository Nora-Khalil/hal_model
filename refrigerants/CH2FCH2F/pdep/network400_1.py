...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', '[CH2]C([CH2])F(231)'],
    products = ['[CH2]C(F)C[C](F)F(703)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)C=C(F)F(765)'],
    products = ['[CH2]C(F)C[C](F)F(703)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(F)C[C](F)F(707)'],
    products = ['[CH2]C(F)C[C](F)F(703)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[CH2]C([CH2])F(231)'],
    products = ['[CH2]C(F)C[C](F)F(703)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)[CH]C(F)F(768)'],
    products = ['[CH2]C(F)C[C](F)F(703)'],
