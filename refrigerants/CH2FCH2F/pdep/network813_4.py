...
"""),
    E0 = (-115.162,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,3010,987.5,1337.5,450,1655,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(0.188078,'amu*angstrom^2'), symmetry=1, barrier=(4.32428,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0526,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.93083,0.00710717,0.000173037,-7.74053e-07,1.12786e-09,-13850.7,10.7722], Tmin=(10,'K'), Tmax=(215.937,'K')), NASAPolynomial(coeffs=[3.44934,0.0251584,-1.57912e-05,4.76511e-09,-5.54129e-13,-13851.2,11.8641], Tmin=(215.937,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-115.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), label="""F[C]DCCF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    molecularWeight = (96.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.91328,0.00509825,0.000107993,-2.10562e-07,1.2351e-10,-62509.2,10.9485], Tmin=(10,'K'), Tmax=(562.913,'K')), NASAPolynomial(coeffs=[2.459,0.035048,-2.40853e-05,7.76439e-09,-9.45436e-13,-62656.2,14.3683], Tmin=(562.913,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-519.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), label="""FC1CC1(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['HF(38)', 'F[C]C=CF-2(8960)'],
    products = ['FC=CC(F)F(1788)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]C=C(F)F(1923)'],
    products = ['FC=CC(F)F(1788)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', '[CH]C(F)F-2(512)'],
    products = ['FC=CC(F)F(1788)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC[C]C(F)F(8995)'],
    products = ['FC=C(F)CF(1590)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(3.82066e+10,'s^-1'), n=0.827, Ea=(104.775,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['FC[C]C(F)F(8995)'],
    products = ['FCC=C(F)F(1550)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(3.33333e+12,'s^-1'), n=8.2394e-08, Ea=(26.7539,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCH_Ext-3C-R_N-4R!H->Br_N-4CClFINOPSSi->F_N-1C-inRing',), comment="""Estimated from node CCH_Ext-3C-R_N-4R!H->Br_N-4CClFINOPSSi->F_N-1C-inRing"""),
)

reaction(
    label = 'reaction19',
    reactants = ['FC[C]C(F)F(8995)'],
    products = ['C=C(F)C(F)F(1789)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(90.8933,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)

reaction(
    label = 'reaction20',
    reactants = ['H2(8)', 'F[C]C=C(F)F-2(5944)'],
    products = ['FCC=C(F)F(1550)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(3.26413e-09,'m^3/(mol*s)'), n=4.30786, Ea=(83.1694,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HH_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node HH_N-2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction21',
    reactants = ['CHF(40)', 'CH2CF2(57)'],
    products = ['FCC=C(F)F(1550)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(1.28954e+29,'m^3/(mol*s)'), n=-6.4458, Ea=(83.6617,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.6591608693425184, var=5.4995193120720405, Tref=1000.0, N=19, data_mean=0.0, correlation='CH',), comment="""Estimated from node CH
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(25)', 'CHFCF2(55)'],
    products = ['FCC=C(F)F(1550)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(139.423,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction23',
    reactants = ['FCC=C(F)F(1550)'],
    products = ['C=CC(F)(F)F(1787)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(8.88952e+10,'s^-1'), n=0.725184, Ea=(272.283,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)
...
reaction(
    label = 'reaction25',
    reactants = ['F(37)', '[CH2]C=C(F)F(5777)'],
    products = ['FCC=C(F)F(1550)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(5.27801,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C"""),
)

reaction(
    label = 'reaction29',
    reactants = ['H(5)', 'FC[C]=C(F)F(7404)'],
    products = ['FCC=C(F)F(1550)'],
...
reaction(
    label = 'reaction30',
    reactants = ['F[C]C(F)CF(1612)'],
    products = ['FCC=C(F)F(1550)'],
    transitionState = 'TS30',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(113.334,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)

reaction(
    label = 'reaction31',
    reactants = ['HF(38)', 'C=C=C(F)F(8866)'],
    products = ['FCC=C(F)F(1550)'],
    transitionState = 'TS31',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(214.012,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction32',
    reactants = ['HF(38)', 'FC#CCF(7264)'],
    products = ['FCC=C(F)F(1550)'],
    transitionState = 'TS32',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(282.663,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)

reaction(
    label = 'reaction33',
    reactants = ['CF2(43)', '[CH]CF(136)'],
    products = ['FCC=C(F)F(1550)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]F(223)', '[CH2][C](F)F(507)'],
    products = ['F[CH]C[C](F)F(754)'],
...
reaction(
    label = 'reaction35',
    reactants = ['F[C]F(744)', '[CH2][CH]F(226)'],
    products = ['F[CH]C[C](F)F(754)'],
...
network(
    ...
    reactants = [
        ...
        ('CHF(40)', 'CHFCHF[Z](59)'),
        ('CHF2(82)', 'CHFCH[Z](71)'),
        ('H(5)', 'F[CH]C=C(F)F(1923)'),
        ('H2(8)', 'F[C]C=C(F)F-2(5944)'),
        ('CHF(40)', 'CH2CF2(57)'),
        ('CH2(S)(25)', 'CHFCF2(55)'),
        ('CH2F(46)', 'CF2CH(73)'),
        ('CF2(43)', '[CH]CF(136)'),
