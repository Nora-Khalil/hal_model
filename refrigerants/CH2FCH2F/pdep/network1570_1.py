...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(F)(F)CF(4009)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(41)', 'OC(F)(F)[C]F(3485)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)F(2154)', 'F[C]CF(125)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(140)', 'F[C]C(F)(F)CF(4655)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'OC(F)(F)C(F)(F)[C]F(5504)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'OC(F)(F)C(F)F(5409)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'OC(F)(F)C(F)(F)F(5505)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)[C](F)CF(5413)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O[C](F)C(F)(F)CF(4662)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)(F)C(O)(F)F(5507)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'FCC(F)(F)[C](F)F(5508)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(F)(F)CF(5509)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[C](F)F(1777)', 'CH2F-CF2(68)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(46)', 'OC(F)(F)[C](F)F(3493)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OC(F)(F)C(F)(F)[CH]F(5510)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)CF(5511)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'OC(F)=C(F)CF(4664)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(78)', 'C=C(F)C(O)(F)F(2199)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)(F)C(F)=CF(2228)'],
    products = ['OC(F)(F)C(F)(F)CF(3305)'],
...
network(
    label = 'PDepNetwork #1570',
    isomers = [
        'OC(F)(F)C(F)(F)CF(3305)',
    ],
    reactants = [
