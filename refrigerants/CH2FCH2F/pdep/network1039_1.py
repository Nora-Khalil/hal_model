...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])(F)F(475)'],
    products = ['[O]CC([O])(F)F(1714)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)C=O(1680)'],
    products = ['[O]CC([O])(F)F(1714)'],
    transitionState = 'TS7',
