...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(514)', '[CH]C-2(510)'],
    products = ['C[CH]OC([O])=O(4035)'],
    transitionState = 'TS2',
