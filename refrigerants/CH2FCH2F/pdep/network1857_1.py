...
"""),
    E0 = (138.723,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,3025,407.5,1350,352.5,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15945,0.0670798,-0.000101517,7.85291e-08,-2.40366e-11,16782.6,26.4104], Tmin=(100,'K'), Tmax=(802.028,'K')), NASAPolynomial(coeffs=[11.0526,0.0177405,-9.24196e-06,1.82985e-09,-1.29385e-13,15195.7,-19.136], Tmin=(802.028,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2sFO) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(CCsJOO) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)

species(
    label = '[O]OO[CH]C(F)F(3116)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (112.032,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47652,0.0587917,-8.24503e-05,6.02877e-08,-1.75141e-11,-26369.3,24.4672], Tmin=(100,'K'), Tmax=(843.383,'K')), NASAPolynomial(coeffs=[10.2816,0.0170307,-8.17559e-06,1.57539e-09,-1.10147e-13,-27854.5,-16.5122], Tmin=(843.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(ROOJ) + radical(CCsJOO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OOC(F)[CH]F(4564)'],
    products = ['O2(2)', 'FC1OC1F(977)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC(F)[CH]F(502)'],
    products = ['[O]OOC(F)[CH]F(4564)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[O]OO[CH]F(1062)'],
    products = ['[O]OOC(F)[CH]F(4564)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[O](128)', 'CHFCHF[Z](59)'],
    products = ['[O]OOC(F)[CH]F(4564)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[O](128)', 'F[CH][CH]F(493)'],
    products = ['[O]OOC(F)[CH]F(4564)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[O]OO[CH]F(1062)'],
    products = ['[O]OOC(F)[CH]F(4564)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH][CH]OOOF(4572)'],
    products = ['[O]OOC(F)[CH]F(4564)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(70.7954,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction16',
    reactants = ['[O]OOC(F)[CH]F(4564)'],
    products = ['[O]OO[CH]C(F)F(3116)'],
