...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.62107,'amu*angstrom^2'), symmetry=1, barrier=(37.2716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.809417,'amu*angstrom^2'), symmetry=1, barrier=(18.6101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.62057,'amu*angstrom^2'), symmetry=1, barrier=(37.26,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.809464,'amu*angstrom^2'), symmetry=1, barrier=(18.6112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.969633,0.0725142,-8.71438e-05,5.65437e-08,-1.51377e-11,969.632,29.2555], Tmin=(100,'K'), Tmax=(896.135,'K')), NASAPolynomial(coeffs=[10.5883,0.0295796,-1.52768e-05,3.07872e-09,-2.22169e-13,-754.284,-16.0943], Tmin=(896.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.19612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(F)(F)OO[C]=C(10241)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {5,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(467)', 'C=[C]O[O](452)'],
    products = ['C=[C]OO[C](F)CF(9982)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(368)', '[O]O[C](F)CF(501)'],
    products = ['C=[C]OO[C](F)CF(9982)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=[C]OOC(=C)F(671)'],
    products = ['C=[C]OO[C](F)CF(9982)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]CF(125)', 'C=[C]O[O](452)'],
    products = ['C=[C]OO[C](F)CF(9982)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]OO[C](F)CF(9982)'],
    products = ['[CH2]C(F)(F)OO[C]=C(10241)'],
