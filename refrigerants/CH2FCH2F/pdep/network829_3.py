...
reaction(
    label = 'reaction2',
    reactants = ['HF(38)', 'F[C]C=C(F)F-2(5944)'],
    products = ['FC(F)=CC(F)F(1802)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FC(F)=CC(F)F(1802)'],
    products = ['FC=CC(F)(F)F(1804)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]C=C(F)F(1923)'],
    products = ['FC(F)=CC(F)F(1802)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C]=CC(F)F(2155)'],
    products = ['FC(F)=CC(F)F(1802)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C](F)C=C(F)F(1808)'],
    products = ['FC(F)=CC(F)F(1802)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC(F)=[C]C(F)F(5945)'],
    products = ['FC(F)=CC(F)F(1802)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'FC=C=C(F)F(5948)'],
    products = ['FC(F)=CC(F)F(1802)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'FC#CC(F)F(2015)'],
    products = ['FC(F)=CC(F)F(1802)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH]C(F)F-2(512)'],
    products = ['FC(F)=CC(F)F(1802)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]F(744)', '[CH2][C](F)F(507)'],
    products = ['F[C](F)C[C](F)F(795)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CF2(43)', '[CH2][C](F)F(507)'],
    products = ['F[C](F)C[C](F)F(795)'],
