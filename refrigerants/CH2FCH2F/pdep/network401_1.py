...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[CH]F(704)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[CH]C[C](F)F(754)'],
    products = ['[CH2]C(F)(F)C[CH]F(704)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(223)', '[CH2]C([CH2])(F)F(598)'],
    products = ['[CH2]C(F)(F)C[CH]F(704)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)C[CH]F(238)'],
    products = ['[CH2]C(F)(F)C[CH]F(704)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)(F)C=CF(757)'],
    products = ['[CH2]C(F)(F)C[CH]F(704)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C([CH2])(F)F(598)'],
    products = ['[CH2]C(F)(F)C[CH]F(704)'],
