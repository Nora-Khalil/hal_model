species(
    label = 'F[C](F)C(F)(F)C1(F)[CH]O1(12642)',
...
species(
    label = 'F[C](F)C1(F)O[CH]C1(F)F(12840)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0754029,0.0993976,-0.000173252,1.53745e-07,-5.28981e-11,-97164.1,28.6238], Tmin=(100,'K'), Tmax=(823.245,'K')), NASAPolynomial(coeffs=[11.4284,0.0280791,-1.52027e-05,2.99874e-09,-2.0894e-13,-98535.5,-21.4635], Tmin=(823.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-809.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + ring(O2s-Cs-Cs-Cs(F)) + radical(Csj(Cs-F1sF1sCs)(O2s-Cs)(H)_ring) + radical(Csj(Cs-F1sO2sCs)(F1s)(F1s)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F))"""),
)

species(
    label = 'F[C]1OC1C(F)(F)[C](F)F(12643)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'FC1(F)C2OC2(F)C1(F)F(12841)',
...
"""),
    E0 = (-856.612,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,234,347,1316,1464,190,488,555,1236,1407,2782.5,750,1395,475,1775,1000,211.136,211.251],'cm^-1')),
        HinderedRotor(inertia=(0.2818,'amu*angstrom^2'), symmetry=1, barrier=(8.91685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.281733,'amu*angstrom^2'), symmetry=1, barrier=(8.91645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45968,'amu*angstrom^2'), symmetry=1, barrier=(46.1876,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0794635,0.0989485,-0.000170975,1.49999e-07,-5.10807e-11,-102889,30.5423], Tmin=(100,'K'), Tmax=(823.648,'K')), NASAPolynomial(coeffs=[11.8912,0.0269162,-1.44827e-05,2.84706e-09,-1.97979e-13,-104389,-22.0252], Tmin=(823.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-856.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-OdCsH) + radical(CsCOCsF1s) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)
...
species(
    label = 'F[C](F)C(F)(F)C1=CO1(12843)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-389.349,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,2950,1000,190,488,555,1236,1407,343.273,343.275,343.275,343.275,1552.13,1552.14,3082.91],'cm^-1')),
        HinderedRotor(inertia=(0.0791153,'amu*angstrom^2'), symmetry=1, barrier=(6.61564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0791146,'amu*angstrom^2'), symmetry=1, barrier=(6.61563,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02179,0.073459,-0.000106963,7.28991e-08,-1.50753e-11,-46728.2,25.4066], Tmin=(100,'K'), Tmax=(600.677,'K')), NASAPolynomial(coeffs=[10.4719,0.0230321,-1.22585e-05,2.44171e-09,-1.72749e-13,-48089,-17.2453], Tmin=(600.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cd(C-FF)-Cd-O2s) + radical(Csj(Cs-F1sF1sCd)(F1s)(F1s))"""),
)
...
species(
    label = 'FC(F)=C(F)C1(F)[CH]O1(9573)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-614.581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,323,467,575,827,1418,2950,1000,182,240,577,636,1210,1413,401.756,401.798,402.063,402.179],'cm^-1')),
        HinderedRotor(inertia=(0.134581,'amu*angstrom^2'), symmetry=1, barrier=(15.4509,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.774472,0.0758092,-0.000105841,7.41701e-08,-2.0568e-11,-73805,24.5006], Tmin=(100,'K'), Tmax=(882.236,'K')), NASAPolynomial(coeffs=[13.1418,0.0197366,-1.0505e-05,2.12883e-09,-1.536e-13,-75987.2,-33.6151], Tmin=(882.236,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-614.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(CdCsCdF) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + ring(Cs-Cs(F)-O2s) + radical(CCsJO)"""),
)
...
"""),
    E0 = (-239.94,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([271,519,563,612,1379,2950,1000,161,297,490,584,780,1358,740.025,740.07,740.137,740.186,740.215,740.424,740.437],'cm^-1')),
        HinderedRotor(inertia=(0.000307789,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29148,0.0510006,-4.67919e-05,2.0281e-08,-3.40617e-12,-28753.4,25.6074], Tmin=(100,'K'), Tmax=(1450.33,'K')), NASAPolynomial(coeffs=[16.0885,0.0101907,-4.58456e-06,8.79758e-10,-6.19126e-14,-33045.5,-51.281], Tmin=(1450.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-239.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(Cds-CdsCsOs) + group(CdCsCdF) + ring(Cd(Cd-F)-Cs-O2s) + radical(C=CCJO) + radical(Csj(Cd-F1sCd)(F1s)(F1s))"""),
)
...
species(
    label = 'F[C](F)C(F)(F)[C]1OC1F(12844)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'FC(F)(F)C(F)(F)[C]1[CH]O1(12845)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.384573,0.0863566,-0.000132531,1.07264e-07,-3.4772e-11,-98440.4,28.3438], Tmin=(100,'K'), Tmax=(755.072,'K')), NASAPolynomial(coeffs=[11.622,0.026827,-1.42735e-05,2.85385e-09,-2.02847e-13,-100137,-22.7135], Tmin=(755.072,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-819.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFF) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)2) + ring(Cs(C-FF)-Cs-O2s) + radical(C2CsJO) + radical(CCsJO)"""),
)

species(
    label = 'F[C](F)[C](F)C1(F)OC1F(12846)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.823061,0.0784301,-0.00010843,7.36319e-08,-1.59262e-11,-90097,29.989], Tmin=(100,'K'), Tmax=(596.789,'K')), NASAPolynomial(coeffs=[9.82518,0.0298403,-1.58279e-05,3.16968e-09,-2.25857e-13,-91380.7,-10.5469], Tmin=(596.789,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-749.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + ring(Cs(F)(C)-Cs-O2s) + radical(CsCsCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[C](C(F)(F)F)C1(F)[CH]O1(12847)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.62702,0.081915,-0.00011905,8.776e-08,-2.38582e-11,-93108.3,28.9655], Tmin=(100,'K'), Tmax=(637.836,'K')), NASAPolynomial(coeffs=[10.9167,0.0273798,-1.43003e-05,2.83925e-09,-2.01103e-13,-94624.2,-17.6426], Tmin=(637.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-775.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCCFO) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-Cs(F)) + ring(Cs(F)(C)-Cs-O2s) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sO2sCs)(O2s-Cs)(H)_ring)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    products = ['CF2CF2(61)', 'FC1=CO1(3064)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(13.278,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission
Ea raised from 0.0 to 13.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    products = ['F[C](F)C1(F)O[CH]C1(F)F(12840)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    products = ['F[C]1OC1C(F)(F)[C](F)F(12643)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', 'F[C](F)C1(F)[CH]O1(9290)'],
    products = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    products = ['FC1(F)C2OC2(F)C1(F)F(12841)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O=C[C](F)C(F)(F)[C](F)F(12842)'],
    products = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)C(F)(F)C1=CO1(12843)'],
    products = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(15.7498,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F[C](F)[C](F)F(3840)', 'FC1=CO1(3064)'],
    products = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FC(F)=C(F)C1(F)[CH]O1(9573)'],
    products = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(61.8834,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CF2CF2(61)', 'F[C]1[CH]O1(9215)'],
    products = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.002046,'m^3/(mol*s)'), n=2.607, Ea=(23.002,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_4R!H->O',), comment="""Estimated from node Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_4R!H->O
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction11',
    reactants = ['F[C](F)[C](F)F(3840)', 'F[C]1[CH]O1(9215)'],
    products = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'F[C](F)C(F)=C1[CH]O1(9574)'],
    products = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(10.2374,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CF2(43)', 'F[C](F)C1(F)[CH]O1(9290)'],
    products = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    products = ['F[C](F)C(F)(F)[C]1OC1F(12844)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    products = ['FC(F)(F)C(F)(F)[C]1[CH]O1(12845)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(185.713,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction16',
    reactants = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    products = ['F[C](F)[C](F)C1(F)OC1F(12846)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(217.771,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['F[C](F)C(F)(F)C1(F)[CH]O1(12642)'],
    products = ['F[C](C(F)(F)F)C1(F)[CH]O1(12847)'],
...
network(
    label = 'PDepNetwork #4215',
    isomers = [
        'F[C](F)C(F)(F)C1(F)[CH]O1(12642)',
    ],
    reactants = [
        ('CF2CF2(61)', 'FC1=CO1(3064)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
