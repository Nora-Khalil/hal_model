...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[C]C=CF(1952)'],
    products = ['[CH2]C(F)C=[C]F(1930)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=C(F)C=[C]F(1954)'],
    products = ['[CH2]C(F)C=[C]F(1930)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)C#CF(1955)'],
    products = ['[CH2]C(F)C=[C]F(1930)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C=C=[C]F(1956)'],
    products = ['[CH2]C(F)C=[C]F(1930)'],
