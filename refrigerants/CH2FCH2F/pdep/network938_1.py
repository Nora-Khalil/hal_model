...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]=C(F)C#C(2071)'],
    products = ['[CH]=C(F)C(=[CH])F(2016)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(78)', '[CH]=C=C=[CH](2072)'],
    products = ['[CH]=C(F)C(=[CH])F(2016)'],
    transitionState = 'TS6',
