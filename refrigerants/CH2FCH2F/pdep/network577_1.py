...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', '[O]C[C]=O(515)'],
    products = ['O=[C]CO[CH]F(1423)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]O[CH]F(318)'],
    products = ['O=[C]CO[CH]F(1423)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[CH]F(318)'],
    products = ['O=[C]CO[CH]F(1423)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[CH]F(1429)'],
    products = ['O=[C]CO[CH]F(1423)'],
    transitionState = 'TS9',
