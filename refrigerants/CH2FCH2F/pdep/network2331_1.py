...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)[C](F)[CH]F(6456)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(6290)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', '[O]C(=O)[C](F)F(1056)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(6290)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C(F)(F)[CH]F(6395)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(6290)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(6290)'],
    products = ['F[CH]C(F)(F)[C]1OO1(6457)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C(F)(F)[CH]F(6290)'],
    products = ['[O][C]1OC(F)C1(F)F(6458)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(=O)C(F)=CF(1508)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(6290)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[O]C(=O)[C](F)F(1056)'],
    products = ['[O]C(=O)C(F)(F)[CH]F(6290)'],
