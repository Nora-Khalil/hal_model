...
reaction(
    label = 'reaction3',
    reactants = ['HO2(11)', 'O=C(F)[C]F(1816)'],
    products = ['[O]OC(F)C(=O)F(5430)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)C(=O)F(1182)'],
    products = ['[O]OC(F)C(=O)F(5430)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)C(=O)F(5430)'],
    products = ['F[C]1OOOC1F(11192)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]O[CH]C(=O)F(826)'],
    products = ['[O]OC(F)C(=O)F(5430)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]OC(F)[C]=O(2540)'],
    products = ['[O]OC(F)C(=O)F(5430)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]O[C](F)C(=O)F(11195)'],
    products = ['[O]OC(F)C(=O)F(5430)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]OC(F)C(=O)F(5430)'],
    products = ['OH(7)', 'O=C(F)C(=O)F(2128)'],
