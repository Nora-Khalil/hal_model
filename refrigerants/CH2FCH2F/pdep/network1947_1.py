...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.982555,0.0708618,-0.000107435,8.6156e-08,-2.74377e-11,-29045.7,26.2701], Tmin=(100,'K'), Tmax=(793.645,'K')), NASAPolynomial(coeffs=[10.5924,0.0208865,-1.00682e-05,1.92016e-09,-1.32452e-13,-30522.5,-17.5651], Tmin=(793.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-242.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(CsCsFFH) + ring(dioxirane) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Cs_P)"""),
)

species(
    label = '[O][C]1OC(C(F)F)O1(5149)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.16078,0.0292376,-8.85564e-06,-2.1749e-09,7.79883e-13,-53758.5,15.793], Tmin=(100,'K'), Tmax=(2225.62,'K')), NASAPolynomial(coeffs=[28.3469,0.00630902,-7.24584e-06,1.48958e-09,-9.75319e-14,-69611.4,-131.669], Tmin=(2225.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.67,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-OsOsOsH) + group(CsCsFFH) + ring(Cyclobutane) + radical(OCOJ) + radical(Cs_P)"""),
)
...
"""),
    E0 = (-452.832,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180,180,180,180,310.398,961.317,961.328,961.361],'cm^-1')),
        HinderedRotor(inertia=(0.0277535,'amu*angstrom^2'), symmetry=1, barrier=(18.2015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0277551,'amu*angstrom^2'), symmetry=1, barrier=(18.2016,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(514)', '[CH]C(F)F(506)'],
    products = ['[O]C(=O)O[CH]C(F)F(4960)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)O[CH]C(F)F(4960)'],
    products = ['FC(F)[CH]O[C]1OO1(5148)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(375.299,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_O]
Euclidian distance = 2.449489742783178
family: Intra_R_Add_Endocyclic
Ea raised from 375.2 to 375.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)O[CH]C(F)F(4960)'],
    products = ['[O][C]1OC(C(F)F)O1(5149)'],
    transitionState = 'TS7',
...
reaction(
    ...
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(6.44049e+09,'s^-1'), n=0.679905, Ea=(177.481,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_csHNd] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_csHNd]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
Ea raised from 174.8 to 177.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['[O]C(=O)O[CH]C(F)F(4960)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(153.031,'m^3/(mol*s)'), n=1.16366, Ea=(32.6669,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H"""),
)

reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(=O)OC=CF(3213)'],
    products = ['[O]C(=O)O[CH]C(F)F(4960)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(=O)O[CH]C(F)F(4960)'],
    products = ['O=C(O)O[CH][C](F)F(5152)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(OF)O[CH][CH]F(5153)'],
    products = ['[O]C(=O)O[CH]C(F)F(4960)'],
