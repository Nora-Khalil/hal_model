...
"""),
    E0 = (-555.822,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.15433,'amu*angstrom^2'), symmetry=1, barrier=(26.5404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1569,'amu*angstrom^2'), symmetry=1, barrier=(26.5994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15463,'amu*angstrom^2'), symmetry=1, barrier=(26.5473,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.479949,0.0743425,-8.07405e-05,4.28689e-08,-8.91022e-12,-66720.6,25.0633], Tmin=(100,'K'), Tmax=(1173.57,'K')), NASAPolynomial(coeffs=[17.1688,0.0174603,-8.03639e-06,1.5681e-09,-1.12112e-13,-70637.7,-58.1217], Tmin=(1173.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-555.822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-738.815,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,326,540,652,719,1357,334,575,1197,1424,3202,194,682,905,1196,1383,3221,228.789,230.236,230.898,230.97],'cm^-1')),
        HinderedRotor(inertia=(0.53734,'amu*angstrom^2'), symmetry=1, barrier=(20.2341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.536432,'amu*angstrom^2'), symmetry=1, barrier=(20.2461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.922904,'amu*angstrom^2'), symmetry=1, barrier=(34.374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (143.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.212379,0.0864517,-0.0001089,6.79567e-08,-1.67322e-11,-88725,26.3026], Tmin=(100,'K'), Tmax=(991.245,'K')), NASAPolynomial(coeffs=[16.2089,0.0219011,-1.12201e-05,2.26196e-09,-1.63653e-13,-91896.3,-50.7309], Tmin=(991.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-738.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-675.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([401,573,564,712,601,775,1078,1160,1259,1391,1337,1437,3048,3250,262,406,528,622,1148,1246,1368,1480,3164,3240,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0205495,0.0955828,-0.000133587,9.73365e-08,-2.8458e-11,-81145.8,28.4041], Tmin=(100,'K'), Tmax=(833.846,'K')), NASAPolynomial(coeffs=[13.6255,0.0301203,-1.58241e-05,3.18174e-09,-2.28257e-13,-83421.5,-34.9503], Tmin=(833.846,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-675.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'F[CH][C](F)OC(F)CF(10132)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-679.595,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,395,473,707,1436,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-716.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.590493,0.109761,-0.000182601,1.55331e-07,-5.16784e-11,-86069,30.6536], Tmin=(100,'K'), Tmax=(813.329,'K')), NASAPolynomial(coeffs=[13.823,0.0289027,-1.5084e-05,2.94669e-09,-2.04782e-13,-88083.7,-33.8774], Tmin=(813.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-716.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsCsFHH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-708.016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,395,473,707,1436,3000,3100,440,815,1455,1000,209.397,209.398,209.398,2971.16],'cm^-1')),
        HinderedRotor(inertia=(0.996127,'amu*angstrom^2'), symmetry=1, barrier=(30.9945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.360187,'amu*angstrom^2'), symmetry=1, barrier=(11.2073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.996134,'amu*angstrom^2'), symmetry=1, barrier=(30.9946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.996115,'amu*angstrom^2'), symmetry=1, barrier=(30.9945,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0547221,0.0945035,-0.000140008,1.11846e-07,-3.61346e-11,-85019.8,30.5034], Tmin=(100,'K'), Tmax=(755.183,'K')), NASAPolynomial(coeffs=[11.7215,0.0326999,-1.72344e-05,3.44929e-09,-2.45879e-13,-86781.7,-22.5047], Tmin=(755.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-708.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)O[C](F)CF(10025)'],
    products = ['CHFCHF[Z](59)', 'O=C(F)CF(476)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(467)', '[O]C(F)[CH]F(975)'],
    products = ['F[CH]C(F)O[C](F)CF(10025)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'F[CH]O[C](F)CF(1130)'],
    products = ['F[CH]C(F)O[C](F)CF(10025)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(F)O[C](F)CF(10025)'],
    products = ['FCC1(F)OC(F)C1F(10026)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH][CH]F(493)', 'O=C(F)CF(476)'],
    products = ['F[CH]C(F)O[C](F)CF(10025)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.81516e-05,'m^3/(mol*s)'), n=3.04336, Ea=(64.6547,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC=CO[C](F)CF(10096)'],
    products = ['F[CH]C(F)O[C](F)CF(10025)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(60.3195,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CHFCHF[Z](59)', '[O][C](F)CF(478)'],
    products = ['F[CH]C(F)O[C](F)CF(10025)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH]C(F)OC(F)=CF(10130)'],
    products = ['F[CH]C(F)O[C](F)CF(10025)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][CH]F(493)', '[O][C](F)CF(478)'],
    products = ['F[CH]C(F)O[C](F)CF(10025)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]CF(125)', '[O]C(F)[CH]F(975)'],
    products = ['F[CH]C(F)O[C](F)CF(10025)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', 'F[CH]O[C](F)CF(1130)'],
    products = ['F[CH]C(F)O[C](F)CF(10025)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(F)O[C](F)CF(10025)'],
    products = ['FC[C](F)O[C](F)CF(10131)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)OC(F)[CH]F(4785)'],
    products = ['F[CH]C(F)O[C](F)CF(10025)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2.61903e+09,'s^-1'), n=1.14834, Ea=(136.59,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2H_S;C_rad_out_1H;Cs_H_out_noH]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][C](F)OC(F)CF(10132)'],
    products = ['F[CH]C(F)O[C](F)CF(10025)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)O[C](F)CF(10025)'],
    products = ['F[CH][CH]OC(F)(F)CF(4801)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(209.832,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)O[C](F)CF(10025)'],
    products = ['[CH2]C(F)(F)OC(F)[CH]F(4800)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)O[C](F)CF(10025)'],
    products = ['[CH2][C](F)OC(F)C(F)F(4799)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(183.897,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #3438',
    isomers = [
        'F[CH]C(F)O[C](F)CF(10025)',
    ],
    reactants = [
        ('CHFCHF[Z](59)', 'O=C(F)CF(476)'),
        ('F[C]CF(125)', '[O]C(F)[CH]F(975)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
