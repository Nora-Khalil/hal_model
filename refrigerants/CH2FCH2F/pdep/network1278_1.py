...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=C=C[C]F(2051)'],
    products = ['[O]C(=O)C=[C]F(2681)'],
    transitionState = 'TS2',
