...
reaction(
    label = 'reaction1',
    reactants = ['COOC=C(F)O[O](9143)'],
    products = ['CH2O(20)', '[O]OC(F)C=O(2464)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]OC(F)=COO(6254)'],
    products = ['COOC=C(F)O[O](9143)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'COO[CH]C(=O)F(9176)'],
    products = ['COOC=C(F)O[O](9143)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['COOC=C(F)O[O](9143)'],
    products = ['CH3O(27)', 'FC1=COOO1(6258)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'COOC=[C]O[O](9179)'],
    products = ['COOC=C(F)O[O](9143)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3O(27)', '[O]O[C](F)C=O(1683)'],
    products = ['COOC=C(F)O[O](9143)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[O]OC=C(F)O[O](6263)'],
    products = ['COOC=C(F)O[O](9143)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CO[O](176)', '[CH]=C(F)O[O](470)'],
    products = ['COOC=C(F)O[O](9143)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]OOC=C(F)O[O](6261)'],
    products = ['COOC=C(F)O[O](9143)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'COO[C]=C(F)O[O](9180)'],
    products = ['COOC=C(F)O[O](9143)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'COOC#CO[O](9181)'],
    products = ['COOC=C(F)O[O](9143)'],
