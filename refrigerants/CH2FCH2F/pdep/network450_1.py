...
"""),
    E0 = (-331.185,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([207,311,436,622,447,691,1074,1182,1276,1366,1311,1469,3045,3235,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.46067,'amu*angstrom^2'), symmetry=1, barrier=(33.5836,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213944,'amu*angstrom^2'), symmetry=1, barrier=(4.91899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214455,'amu*angstrom^2'), symmetry=1, barrier=(4.93074,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.746331,0.0792912,-0.000126362,1.12877e-07,-4.01689e-11,-39722.7,24.0543], Tmin=(100,'K'), Tmax=(794.211,'K')), NASAPolynomial(coeffs=[8.0189,0.0318091,-1.61844e-05,3.18473e-09,-2.23714e-13,-40535.5,-7.20091], Tmin=(794.211,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-331.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(F1s)(H)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
"""),
    E0 = (-331.511,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,2750,2850,1437.5,1250,1305,750,350,262,406,528,622,1148,1246,1368,1480,3164,3240,307.907,307.942,307.961],'cm^-1')),
        HinderedRotor(inertia=(0.317527,'amu*angstrom^2'), symmetry=1, barrier=(21.3696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174092,'amu*angstrom^2'), symmetry=1, barrier=(11.7137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.317464,'amu*angstrom^2'), symmetry=1, barrier=(21.3699,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.934948,0.0726928,-9.00114e-05,5.92025e-08,-1.58116e-11,-39765.7,23.4992], Tmin=(100,'K'), Tmax=(904.865,'K')), NASAPolynomial(coeffs=[11.4045,0.0264106,-1.32867e-05,2.67333e-09,-1.93047e-13,-41660.4,-25.9632], Tmin=(904.865,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-331.511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(F1s)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.392126,'amu*angstrom^2'), symmetry=1, barrier=(9.01574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.392244,'amu*angstrom^2'), symmetry=1, barrier=(9.01846,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-379.183,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,323,467,575,827,1418,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221],'cm^-1')),
        HinderedRotor(inertia=(0.216575,'amu*angstrom^2'), symmetry=1, barrier=(4.97948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216625,'amu*angstrom^2'), symmetry=1, barrier=(4.98063,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.45959,0.0478937,-4.62937e-05,2.50777e-08,-5.83281e-12,-45602,13.3499], Tmin=(10,'K'), Tmax=(944.922,'K')), NASAPolynomial(coeffs=[7.64994,0.0301552,-1.8135e-05,5.21085e-09,-5.76574e-13,-46394,-6.62868], Tmin=(944.922,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-379.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""[CH2]C(F)C(F)DCF""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'C=CC(F)[CH]F(896)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {7,S}
...
"""),
    E0 = (-204.115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([174,267,591,721,1107,1278,1348,3273,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.414964,'amu*angstrom^2'), symmetry=1, barrier=(9.54084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49456,'amu*angstrom^2'), symmetry=1, barrier=(34.3628,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.0792,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.7945,0.0191989,0.000178522,-7.19457e-07,8.61058e-10,-24551.9,11.3095], Tmin=(10,'K'), Tmax=(283.451,'K')), NASAPolynomial(coeffs=[3.93096,0.0373847,-2.41435e-05,7.5185e-09,-8.98287e-13,-24640.4,9.39806], Tmin=(283.451,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-204.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), label="""CDCC(F)[CH]F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.869112,0.0817467,-0.000148784,1.46657e-07,-5.47482e-11,-41665.5,24.3747], Tmin=(100,'K'), Tmax=(841.133,'K')), NASAPolynomial(coeffs=[4.04444,0.037999,-1.96815e-05,3.8421e-09,-2.66293e-13,-41186.2,15.629], Tmin=(841.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-347.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = '[CH2]C(F)[CH]C(F)F(768)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-321.694,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,334,575,1197,1424,3202,319.692,320.115,322.569],'cm^-1')),
        HinderedRotor(inertia=(0.100198,'amu*angstrom^2'), symmetry=1, barrier=(7.37257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.380342,'amu*angstrom^2'), symmetry=1, barrier=(27.8044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212324,'amu*angstrom^2'), symmetry=1, barrier=(15.4681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09143,0.0700891,-9.03435e-05,6.5222e-08,-1.94769e-11,-38591.5,24.7951], Tmin=(100,'K'), Tmax=(807.488,'K')), NASAPolynomial(coeffs=[9.27971,0.0295272,-1.4995e-05,3.01365e-09,-2.1693e-13,-39913.9,-12.9577], Tmin=(807.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-321.694,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-F1sHH)(H)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C(F)[CH]F(878)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]CC(F)[CH]F(879)'],
    products = ['[CH2]C(F)C(F)[CH]F(878)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]C(F)[CH]F(245)'],
    products = ['[CH2]C(F)C(F)[CH]F(878)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)[CH]F(892)'],
    products = ['[CH2]C(F)C(F)[CH]F(878)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', '[CH2]C=C[CH]F(239)'],
    products = ['[CH2]C(F)C(F)[CH]F(878)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(20.0648,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C=C(F)[CH]F(898)'],
    products = ['[CH2]C(F)C(F)[CH]F(878)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(294.998,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[CH2]C(F)=C[CH]F(758)'],
    products = ['[CH2]C(F)C(F)[CH]F(878)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(309.814,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['CHF(40)', '[CH2]C(F)[CH]F(245)'],
    products = ['[CH2]C(F)C(F)[CH]F(878)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(F)C(F)[CH]F(878)'],
    products = ['[CH2]C(F)[CH]C(F)F(768)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(168.062,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

reaction(
    label = 'reaction24',
    reactants = ['F[CH][CH]C(F)CF(890)'],
    products = ['[CH2]C(F)C(F)[CH]F(878)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(223.535,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(214.615,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction26',
    reactants = ['F[CH]C(F)[CH]CF(889)'],
    products = ['[CH2]C(F)C(F)[CH]F(878)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(149.268,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

network(
    label = 'PDepNetwork #450',
    isomers = [
        '[CH2]C(F)C(F)[CH]F(878)',
    ],
    reactants = [
