...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(1544)', '[O]C(F)[CH]F(975)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)[C]=C(F)F(7658)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
    products = ['OC(F)C(F)=C=C(F)F(7956)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
    products = ['O=C(F)C(F)C=C(F)F(7957)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(F)C=C=C(F)F(7958)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)C(F)=C=C(F)F(7959)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O=CC(F)[C]=C(F)F(7960)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C(F)C(F)[C]=C(F)F(7961)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(F)C(F)C#CF(7962)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', '[O]C=C[C]=C(F)F(7963)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=CC(F)=[C][C](F)F(7964)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C(F)C=[C][C](F)F(7965)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
    products = ['[O]C(F)C(F)=C[C](F)F(7966)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
    products = ['O[C](F)C(F)[C]=C(F)F(7967)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
    products = ['[O][C](F)C(F)C=C(F)F(7968)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
    products = ['OC(F)C(F)=[C][C](F)F(7969)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FOC(F)[CH][C]=C(F)F(7970)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
    products = ['[O]C(F)[CH]C(F)=C(F)F(7971)'],
...
reaction(
    label = 'reaction25',
    reactants = ['FO[CH]C(F)[C]=C(F)F(7972)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
    products = ['[O][CH]C(F)C(F)=C(F)F(7973)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[C]=[C]C(F)C(F)OF(7974)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O]C(F)C(F)C(F)=[C]F(7975)'],
    products = ['[O]C(F)C(F)[C]=C(F)F(7503)'],
...
network(
    label = 'PDepNetwork #2760',
    isomers = [
        '[O]C(F)C(F)[C]=C(F)F(7503)',
    ],
    reactants = [
