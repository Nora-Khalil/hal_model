...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.644445,'amu*angstrom^2'), symmetry=1, barrier=(14.817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.642625,'amu*angstrom^2'), symmetry=1, barrier=(14.7752,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76817,0.0521618,-5.69026e-05,3.29089e-08,-7.78271e-12,-34981.6,19.1686], Tmin=(100,'K'), Tmax=(1011.67,'K')), NASAPolynomial(coeffs=[9.7692,0.0205266,-9.99676e-06,1.99877e-09,-1.44249e-13,-36600.5,-19.5245], Tmin=(1011.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-291.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sH)(Cs-HHH)(F1s))"""),
)

species(
    label = '[CH2]C(F)[C](O)F(1095)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58015,0.0579008,-7.44678e-05,5.16052e-08,-1.45678e-11,-37432.3,20.7763], Tmin=(100,'K'), Tmax=(857.035,'K')), NASAPolynomial(coeffs=[9.35286,0.0216231,-1.0973e-05,2.21355e-09,-1.59874e-13,-38764.6,-15.5233], Tmin=(857.035,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(F1s)(O2s-H)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'CC(F)[C]([O])F(1096)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.09409,'amu*angstrom^2'), symmetry=1, barrier=(48.1474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00093247,'amu*angstrom^2'), symmetry=1, barrier=(1.86964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0813263,'amu*angstrom^2'), symmetry=1, barrier=(1.86985,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86194,0.0523979,-7.53929e-05,6.95746e-08,-2.69449e-11,2083.59,22.4328], Tmin=(100,'K'), Tmax=(731.399,'K')), NASAPolynomial(coeffs=[4.94063,0.0293134,-1.52378e-05,3.06531e-09,-2.1957e-13,1800.33,9.68517], Tmin=(731.399,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.7268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-HHH)(H)) + radical(RCCJ)"""),
)

species(
    label = '[O]C(F)[CH]CF(1080)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {4,S}
...
"""),
    E0 = (35.7279,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,259,529,569,1128,1321,1390,3140,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,287.496,1628.63],'cm^-1')),
        HinderedRotor(inertia=(0.165929,'amu*angstrom^2'), symmetry=1, barrier=(10.0205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168228,'amu*angstrom^2'), symmetry=1, barrier=(9.96728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.509475,'amu*angstrom^2'), symmetry=1, barrier=(28.6291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41727,0.0615967,-8.75305e-05,6.76265e-08,-2.11094e-11,4385.69,22.247], Tmin=(100,'K'), Tmax=(781.145,'K')), NASAPolynomial(coeffs=[9.22107,0.0216371,-1.08001e-05,2.14309e-09,-1.52591e-13,3166.47,-13.4745], Tmin=(781.145,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.7279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[O][CH]C(F)CF(1100)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    E0 = (-255.571,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,180,180,291.297],'cm^-1')),
        HinderedRotor(inertia=(1.78731,'amu*angstrom^2'), symmetry=1, barrier=(41.0938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0302571,'amu*angstrom^2'), symmetry=1, barrier=(41.1561,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82897,0.0531855,-7.43598e-05,6.86208e-08,-2.70507e-11,-30665.1,19.5677], Tmin=(100,'K'), Tmax=(711.928,'K')), NASAPolynomial(coeffs=[4.72756,0.0312966,-1.64354e-05,3.32401e-09,-2.39112e-13,-30935.8,7.56579], Tmin=(711.928,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-255.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-F1sCsH)(O2s-H)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C(F)[CH]F(975)'],
    products = ['[CH2]C(F)C([O])F(1064)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)[CH]F(245)'],
    products = ['[CH2]C(F)C([O])F(1064)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)C([O])F(1092)'],
    products = ['[CH2]C(F)C([O])F(1064)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(F)C=O(349)'],
    products = ['[CH2]C(F)C([O])F(1064)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(F)C(=O)F(555)'],
    products = ['[CH2]C(F)C([O])F(1064)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C(F)=C[O](952)'],
    products = ['[CH2]C(F)C([O])F(1064)'],
