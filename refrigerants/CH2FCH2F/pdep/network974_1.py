...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]C([O])(F)F(475)'],
    products = ['[O]C(F)(F)C[C]=O(2139)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[CH2]C([O])(F)F(475)'],
    products = ['[O]C(F)(F)C[C]=O(2139)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C=C=O(2262)'],
    products = ['[O]C(F)(F)C[C]=O(2139)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=[C][CH]C(=O)F(2263)'],
    products = ['[O]C(F)(F)C[C]=O(2139)'],
