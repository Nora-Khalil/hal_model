...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(F)(F)[CH]F(6239)'],
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(F)=CF(1577)'],
    products = ['[CH2]OC(F)(F)[CH]F(6239)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]O[C](F)C(F)F(6243)'],
    products = ['[CH2]OC(F)(F)[CH]F(6239)'],
...
network(
    label = 'PDepNetwork #2323',
    isomers = [
        '[CH2]OC(F)(F)[CH]F(6239)',
    ],
    reactants = [
        ('CH2O(20)', 'CHFCF2(55)'),
    ],
