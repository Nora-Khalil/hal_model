...
species(
    label = '[CH2]C(F)(F)OO[C](F)F(10254)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(788)', 'F[C]CF-2(467)'],
    products = ['FC[C](F)OO[C](F)F(10048)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[O]O[C](F)CF(501)'],
    products = ['FC[C](F)OO[C](F)F(10048)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)OO[C](F)F(2322)'],
    products = ['FC[C](F)OO[C](F)F(10048)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(788)', 'F[C]CF(125)'],
    products = ['FC[C](F)OO[C](F)F(10048)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[O]O[C](F)CF(501)'],
    products = ['FC[C](F)OO[C](F)F(10048)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FC[C](F)OO[C](F)F(10048)'],
    products = ['F[CH][C](F)OOC(F)F(10253)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FC[C](F)OO[C](F)F(10048)'],
    products = ['[CH2]C(F)(F)OO[C](F)F(10254)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FC[C](F)OO[C](F)F(10048)'],
    products = ['[CH2][C](F)OOC(F)(F)F(10255)'],
