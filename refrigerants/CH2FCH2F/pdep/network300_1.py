...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=O(275)'],
    products = ['[CH2]OC([CH2])=O(611)'],
    transitionState = 'TS3',
