...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]F(1109)'],
...
reaction(
    ...
    products = ['[CH2]C(F)(F)O[CH]F(1109)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)O[CH]F(1086)'],
    products = ['[CH2]C(F)(F)O[CH]F(1109)'],
    transitionState = 'TS6',
