...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CO[O](192)'],
    products = ['O=O(141)', 'C2H2(23)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]=C[O](134)'],
    products = ['[CH]=CO[O](192)'],
    transitionState = 'TS2',
