...
"""),
    E0 = (-101.615,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,401.505,401.701],'cm^-1')),
        HinderedRotor(inertia=(0.0928307,'amu*angstrom^2'), symmetry=1, barrier=(10.621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0930003,'amu*angstrom^2'), symmetry=1, barrier=(10.6236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17002,'amu*angstrom^2'), symmetry=1, barrier=(19.4711,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15371,0.0645685,-7.78413e-05,4.88678e-08,-1.22463e-11,-12120.6,22.2401], Tmin=(100,'K'), Tmax=(971.421,'K')), NASAPolynomial(coeffs=[11.9467,0.020125,-9.21243e-06,1.76749e-09,-1.24386e-13,-14217.4,-29.5164], Tmin=(971.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CC(=CF)OOF(4169)',
...
"""),
    E0 = (-153.637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,194,682,905,1196,1383,3221,180,1159.24],'cm^-1')),
        HinderedRotor(inertia=(0.139287,'amu*angstrom^2'), symmetry=1, barrier=(3.20248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139602,'amu*angstrom^2'), symmetry=1, barrier=(3.20972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138671,'amu*angstrom^2'), symmetry=1, barrier=(3.18832,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43765,0.0634305,-9.81049e-05,9.15961e-08,-3.45426e-11,-18392.8,23.3023], Tmin=(100,'K'), Tmax=(782.966,'K')), NASAPolynomial(coeffs=[5.10445,0.0329154,-1.70719e-05,3.38002e-09,-2.38579e-13,-18605.9,8.81553], Tmin=(782.966,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'CC([O])[C](F)OF(3907)',
...
"""),
    E0 = (-332.946,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,280,501,1494,1531,216.228,217.271],'cm^-1')),
        HinderedRotor(inertia=(0.00383048,'amu*angstrom^2'), symmetry=1, barrier=(13.592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44503,'amu*angstrom^2'), symmetry=1, barrier=(48.5689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.4496,'amu*angstrom^2'), symmetry=1, barrier=(48.5684,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75905,0.0538468,-6.73376e-05,5.05774e-08,-1.61653e-11,-39967.7,20.1859], Tmin=(100,'K'), Tmax=(749.918,'K')), NASAPolynomial(coeffs=[6.81218,0.0268942,-1.34271e-05,2.65231e-09,-1.88693e-13,-40725.6,-2.73836], Tmin=(749.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CsCOF1sO2s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0201115,'amu*angstrom^2'), symmetry=1, barrier=(5.08815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11833,'amu*angstrom^2'), symmetry=1, barrier=(25.7126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5514,0.028106,-1.34056e-05,1.41155e-09,3.82905e-13,-34330.4,15.71], Tmin=(100,'K'), Tmax=(1438.68,'K')), NASAPolynomial(coeffs=[8.86746,0.0163467,-7.19376e-06,1.33595e-09,-9.10178e-14,-36748.1,-19.1452], Tmin=(1438.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H)"""),
)

species(
    label = 'CC(=O)C(=O)F(1467)',
...
"""),
    E0 = (-549.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,286,619,818,1246,1924,1156.16],'cm^-1')),
        HinderedRotor(inertia=(0.289062,'amu*angstrom^2'), symmetry=1, barrier=(6.64611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.797874,'amu*angstrom^2'), symmetry=1, barrier=(18.3447,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37211,0.0354015,-2.66244e-05,9.96737e-09,-1.53261e-12,-66018.2,17.343], Tmin=(100,'K'), Tmax=(1484.4,'K')), NASAPolynomial(coeffs=[9.31122,0.0167026,-7.72887e-06,1.481e-09,-1.03343e-13,-68078.3,-18.8751], Tmin=(1484.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-549.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-O2d)Cs) + group(COCFO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(=O)C(F)OF(4128)'],
    products = ['HF(38)', 'CHFO(47)', 'CH2CO(28)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(40.6453,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    ...
    products = ['CC(=O)C(F)OF(4128)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000538,'m^3/(mol*s)'), n=3.29, Ea=(451.447,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->Cs',), comment="""Estimated from node Root_1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->Cs"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OF(140)', 'CC(=O)[C]F(3674)'],
    products = ['CC(=O)C(F)OF(4128)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(43.3919,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CC(=COF)OF(4168)'],
    products = ['CC(=O)C(F)OF(4128)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(8.88952e+10,'s^-1'), n=0.725184, Ea=(155.064,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CC(=CF)OOF(4169)'],
    products = ['CC(=O)C(F)OF(4128)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4.62709e+20,'s^-1'), n=-1.9758, Ea=(103.051,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CC([O])[C](F)OF(3907)'],
    products = ['CC(=O)C(F)OF(4128)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CC(O)=C(F)OF(4171)'],
    products = ['CC(=O)C(F)OF(4128)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(205000,'s^-1'), n=2.37, Ea=(194.704,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R"""),
)

reaction(
    label = 'reaction9',
    reactants = ['C=C(O)C(F)OF(4126)'],
    products = ['CC(=O)C(F)OF(4128)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'CC(=O)[CH]F(4174)'],
    products = ['CC(=O)C(F)OF(4128)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'O=[C]C(F)OF(4175)'],
    products = ['CC(=O)C(F)OF(4128)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=C([O])C(F)OF(4176)'],
    products = ['CC(=O)C(F)OF(4128)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(3.1711e+07,'m^3/(mol*s)'), n=0.21519, Ea=(1.6147,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.0002075092942954368, var=8.990172124599921e-08, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_N-3C-inRing_Ext-3C-R_4R!H->C_Sp-3C-2C_N-Sp-4C=3C_Sp-4C-3C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_N-3C-inRing_Ext-3C-R_4R!H->C_Sp-3C-2C_N-Sp-4C=3C_Sp-4C-3C"""),
)

reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'CC(=O)C=O(1347)'],
    products = ['CC(=O)C(F)OF(4128)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(69.8286,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'CC(=O)C(=O)F(1467)'],
    products = ['CC(=O)C(F)OF(4128)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(478.035,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

network(
    label = 'PDepNetwork #1845',
    isomers = [
        'CC(=O)C(F)OF(4128)',
    ],
    reactants = [
