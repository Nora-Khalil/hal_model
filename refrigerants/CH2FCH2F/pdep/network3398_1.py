...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[C](F)CF(9993)'],
    products = ['O=C(F)CF(476)', 'C2H4(30)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(467)', '[CH2]C[O](325)'],
    products = ['[CH2]CO[C](F)CF(9993)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C](F)CF(942)'],
    products = ['[CH2]CO[C](F)CF(9993)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C(F)CF(476)', '[CH2][CH2](511)'],
    products = ['[CH2]CO[C](F)CF(9993)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)CF(478)', 'C2H4(30)'],
    products = ['[CH2]CO[C](F)CF(9993)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=CO[C](F)CF(10111)'],
    products = ['[CH2]CO[C](F)CF(9993)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]COC(=C)F(6701)'],
    products = ['[CH2]CO[C](F)CF(9993)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]COC(F)=CF(10464)'],
    products = ['[CH2]CO[C](F)CF(9993)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)CF(478)', '[CH2][CH2](511)'],
    products = ['[CH2]CO[C](F)CF(9993)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]CF(125)', '[CH2]C[O](325)'],
    products = ['[CH2]CO[C](F)CF(9993)'],
...
network(
    label = 'PDepNetwork #3398',
    isomers = [
        '[CH2]CO[C](F)CF(9993)',
    ],
    reactants = [
        ('O=C(F)CF(476)', 'C2H4(30)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
