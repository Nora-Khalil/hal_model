...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC[C](F)F(639)'],
    products = ['[CH]=CC([CH2])(F)F(638)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C=C(F)F(814)'],
    products = ['[CH]=CC([CH2])(F)F(638)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H2(23)', '[CH2][C](F)F(507)'],
    products = ['[CH]=CC([CH2])(F)F(638)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#CC([CH2])(F)F(815)'],
    products = ['[CH]=CC([CH2])(F)F(638)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[CH](257)', '[CH2][C](F)F(507)'],
    products = ['[CH]=CC([CH2])(F)F(638)'],
    transitionState = 'TS9',
