...
"""),
    E0 = (-532.318,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,236,527,855,1015,1182,1348,3236,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,747.245],'cm^-1')),
        HinderedRotor(inertia=(0.627081,'amu*angstrom^2'), symmetry=1, barrier=(14.4178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.48954,'amu*angstrom^2'), symmetry=1, barrier=(57.2395,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28902,0.0615959,-7.69707e-05,4.93868e-08,-1.25701e-11,-68317.4,23.9334], Tmin=(100,'K'), Tmax=(959.388,'K')), NASAPolynomial(coeffs=[11.8441,0.0175885,-8.1652e-06,1.57467e-09,-1.11074e-13,-70342.7,-26.551], Tmin=(959.388,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-568.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = '[O]OC(F)(F)C=CF(7406)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71941,0.0522801,-5.05686e-05,2.48901e-08,-5.01854e-12,-58059.4,22.257], Tmin=(100,'K'), Tmax=(1169.13,'K')), NASAPolynomial(coeffs=[10.8064,0.0211901,-1.06796e-05,2.14424e-09,-1.5466e-13,-60184.1,-23.0025], Tmin=(1169.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-483.401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFFH) + ring(Cs-Cs(F)-O2s-O2s) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-199.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,182,240,577,636,1210,1413,373.217],'cm^-1')),
        HinderedRotor(inertia=(0.221425,'amu*angstrom^2'), symmetry=1, barrier=(21.8864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0391886,'amu*angstrom^2'), symmetry=1, barrier=(83.1964,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72273,0.0465523,-4.43954e-05,2.10583e-08,-3.95309e-12,-23852.8,23.0759], Tmin=(100,'K'), Tmax=(1286.44,'K')), NASAPolynomial(coeffs=[12.3343,0.0135569,-5.92236e-06,1.12053e-09,-7.8468e-14,-26583,-30.7917], Tmin=(1286.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(ROOJ) + radical(C=CCJO)"""),
)

species(
    label = '[O]OC(F)C=[C]F(11133)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-97.5762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,236,527,855,1015,1182,1348,3236,3010,987.5,1337.5,450,1655,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(0.587764,'amu*angstrom^2'), symmetry=1, barrier=(13.5139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.585092,'amu*angstrom^2'), symmetry=1, barrier=(13.4524,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38694,0.0629531,-0.000101383,8.77439e-08,-3.00521e-11,-11646.9,22.2836], Tmin=(100,'K'), Tmax=(805.667,'K')), NASAPolynomial(coeffs=[8.36231,0.021341,-1.09127e-05,2.12791e-09,-1.4825e-13,-12544.3,-8.45523], Tmin=(805.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.5762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(ROOJ) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (-346.612,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3010,987.5,1337.5,450,1655,326,540,652,719,1357,161,297,490,584,780,1358],'cm^-1')),
        HinderedRotor(inertia=(0.163674,'amu*angstrom^2'), symmetry=1, barrier=(3.76318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16416,'amu*angstrom^2'), symmetry=1, barrier=(3.77437,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.960383,0.0715783,-9.6618e-05,6.65339e-08,-1.82764e-11,-52225.1,24.5102], Tmin=(100,'K'), Tmax=(887.517,'K')), NASAPolynomial(coeffs=[12.2008,0.0209182,-1.0997e-05,2.21893e-09,-1.59854e-13,-54220.3,-28.3771], Tmin=(887.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-435.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + group(Cds-CdsCsH) + group(CdCFF) + radical(Cdj(Cs-F1sO2sH)(Cd-F1sF1s))"""),
)

species(
    label = 'FOO[CH]C=C(F)F(11134)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-255.733,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,182,240,577,636,1210,1413],'cm^-1')),
        HinderedRotor(inertia=(1.77246,'amu*angstrom^2'), symmetry=1, barrier=(40.7524,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20463,0.0585439,-5.78482e-05,2.76732e-08,-5.22471e-12,-30654.6,25.5588], Tmin=(100,'K'), Tmax=(1277.08,'K')), NASAPolynomial(coeffs=[14.8058,0.0159436,-7.81248e-06,1.55365e-09,-1.1165e-13,-34128.6,-43.3856], Tmin=(1277.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-255.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sFO) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFF) + radical(C=CCJO)"""),
)

species(
    label = 'F[C]=CC(F)OOF(11135)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-154.28,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,236,527,855,1015,1182,1348,3236,3010,987.5,1337.5,450,1655,167,640,1190],'cm^-1')),
        HinderedRotor(inertia=(1.53021,'amu*angstrom^2'), symmetry=1, barrier=(35.1826,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.903766,0.0743897,-0.000112261,9.02177e-08,-2.92478e-11,-18450,24.6512], Tmin=(100,'K'), Tmax=(752.962,'K')), NASAPolynomial(coeffs=[10.2426,0.0247785,-1.3429e-05,2.71258e-09,-1.94237e-13,-19856.3,-17.7535], Tmin=(752.962,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sFO) + group(CsCFHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'F[CH]C=C(F)F(1923)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['HO2(11)', 'F[C]C=C(F)F-2(5944)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(51.8602,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]OC=C(F)F(785)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(165.261,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)C=C(F)F(7405)'],
    products = ['[O]OC=CC(F)(F)F(11131)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.72966e+11,'s^-1'), n=0.63878, Ea=(290.406,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='F_Ext-2R!H-R',), comment="""Estimated from node F_Ext-2R!H-R"""),
)

reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)C=C(F)F(7405)'],
    products = ['[O]OC(F)(F)C=CF(7406)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C(F)C=C(F)F(1153)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)C=C(F)F(7405)'],
    products = ['HO2(11)', 'FC=C=C(F)F(5948)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]OC(F)C=C(F)F(7405)'],
    products = ['FC1[CH]C(F)(F)OO1(9940)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]O[CH]C=C(F)F(11132)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]OC(F)C=[C]F(11133)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]O[CH]F(287)', 'CF2CH(73)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]OC(F)=C[C](F)F(8790)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]OC(F)[C]=C(F)F(7476)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]OC=C=C(F)F(8787)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(204.742,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[O]OC(F)C#CF(8789)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(1.64483e+40,'m^3/(mol*s)'), n=-10.004, Ea=(289.04,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_N-3COCdCddCtO2d->Cd"""),
)

reaction(
    label = 'reaction17',
    reactants = ['[O]OC(F)C=C(F)F(7405)'],
    products = ['OH(7)', 'O=C(F)C=C(F)F(6105)'],
...
reaction(
    label = 'reaction19',
    reactants = ['FOO[CH]C=C(F)F(11134)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(113.428,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction20',
    reactants = ['F[C]=CC(F)OOF(11135)'],
    products = ['[O]OC(F)C=C(F)F(7405)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(60.1454,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
...
network(
    ...
    reactants = [
        ('O2(2)', 'F[CH]C=C(F)F(1923)'),
        ('HO2(11)', 'FC=C=C(F)F(5948)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
