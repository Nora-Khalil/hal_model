...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C(F)[CH]F(975)'],
    products = ['O=[C]OC(F)[CH]F(1489)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'O=[C]O[CH]F(280)'],
    products = ['O=[C]OC(F)[CH]F(1489)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]C(F)[CH]F(975)'],
    products = ['O=[C]OC(F)[CH]F(1489)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(F)=CF(1500)'],
    products = ['O=[C]OC(F)[CH]F(1489)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', 'O=[C]O[CH]F(280)'],
    products = ['O=[C]OC(F)[CH]F(1489)'],
