species(
    label = 'O=C(OF)C(F)(F)C[CH]F(11990)',
...
species(
    label = '[CH2]C(F)C(F)(F)C(=O)OF(12014)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-745.237,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,231,348,427,405,1245,1236,1280,259,529,569,1128,1321,1390,3140,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0601076,0.0945951,-0.000132342,9.96756e-08,-3.05402e-11,-89496.6,30.0179], Tmin=(100,'K'), Tmax=(792.78,'K')), NASAPolynomial(coeffs=[12.0205,0.034249,-1.8164e-05,3.66144e-09,-2.62865e-13,-91393.1,-24.907], Tmin=(792.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-745.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
"""),
    E0 = (-246.695,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,145,326,398,834,1303,334,575,1197,1424,3202,2120,512.5,787.5,359.06,2554.72],'cm^-1')),
        HinderedRotor(inertia=(0.131762,'amu*angstrom^2'), symmetry=1, barrier=(11.9631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331257,'amu*angstrom^2'), symmetry=1, barrier=(30.0815,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65469,0.0556034,-6.77776e-05,4.56034e-08,-1.26464e-11,-29589.6,22.0097], Tmin=(100,'K'), Tmax=(868.411,'K')), NASAPolynomial(coeffs=[8.7573,0.0228885,-1.12704e-05,2.22437e-09,-1.58573e-13,-30823.2,-11.2543], Tmin=(868.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-246.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(CsCsFHH) + group(Cd(Cdd-Od)CF) + missing(Cdd-CdO2d) + radical(Csj(Cs-CdHH)(F1s)(H))"""),
)

species(
    label = 'F[CH]CC(F)=C(OF)OF(12016)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-243.647,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,350,440,435,1725,334,575,1197,1424,3202,180,180,923.875,924.348],'cm^-1')),
        HinderedRotor(inertia=(0.185542,'amu*angstrom^2'), symmetry=1, barrier=(4.26599,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185525,'amu*angstrom^2'), symmetry=1, barrier=(4.26559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185564,'amu*angstrom^2'), symmetry=1, barrier=(4.26648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18548,'amu*angstrom^2'), symmetry=1, barrier=(4.26455,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.408645,0.114392,-0.000217674,2.10786e-07,-7.69036e-11,-29162.1,33.3926], Tmin=(100,'K'), Tmax=(846.882,'K')), NASAPolynomial(coeffs=[6.64707,0.0428805,-2.33767e-05,4.5915e-09,-3.17666e-13,-28987.8,8.61025], Tmin=(846.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs) + radical(Csj(Cs-CdHH)(F1s)(H))"""),
)

species(
    label = 'F[CH]COC(OF)=C(F)F(12017)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {9,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-537.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,334,575,1197,1424,3202,182,240,577,636,1210,1413,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.727933,0.117313,-0.000210767,1.91735e-07,-6.68551e-11,-64449.2,32.3504], Tmin=(100,'K'), Tmax=(840.232,'K')), NASAPolynomial(coeffs=[11.2303,0.0351107,-1.88974e-05,3.70006e-09,-2.55921e-13,-65566.5,-17.9506], Tmin=(840.232,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-537.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-311.36,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,231,348,427,405,1245,1236,1280,2750,2850,1437.5,1250,1305,750,350,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.629762,0.0807956,-0.00010396,7.17774e-08,-2.02895e-11,-37332.4,27.2088], Tmin=(100,'K'), Tmax=(853.987,'K')), NASAPolynomial(coeffs=[11.2968,0.0308337,-1.6206e-05,3.27421e-09,-2.36146e-13,-39154.4,-22.5699], Tmin=(853.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'O=C(OF)C(F)(F)C[C]F-2(12019)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {10,S}
...
8  C u0 p0 c0 {7,S} {10,S} {11,S} {12,S}
9  C u0 p0 c0 {5,S} {6,D} {7,S}
10 C u2 p0 c0 {3,S} {8,S}
11 H u0 p0 c0 {8,S}
12 H u0 p0 c0 {8,S}
"""),
    E0 = (-577.837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,231,348,427,405,1245,1236,1280,2750,2850,1437.5,1250,1305,750,350,90,150,250,247,323,377,431,433,1065,1274],'cm^-1')),
        HinderedRotor(inertia=(0.00153444,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00153423,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589479,'amu*angstrom^2'), symmetry=1, barrier=(45.9644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589466,'amu*angstrom^2'), symmetry=1, barrier=(45.9657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.222453,0.0928241,-0.000136115,1.01892e-07,-2.8206e-11,-69370.9,28.2356], Tmin=(100,'K'), Tmax=(614.822,'K')), NASAPolynomial(coeffs=[11.056,0.0334695,-1.8455e-05,3.74848e-09,-2.69087e-13,-70913.4,-20.4707], Tmin=(614.822,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-577.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CsCCl_triplet)"""),
)

species(
    label = 'FO[C]1OC(F)CC1(F)F(12020)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0647949,0.0778699,-7.72242e-05,3.84813e-08,-7.44245e-12,-87521.5,25.954], Tmin=(100,'K'), Tmax=(1308.78,'K')), NASAPolynomial(coeffs=[19.2472,0.0170399,-5.43541e-06,8.58501e-10,-5.43212e-14,-92421.7,-71.8207], Tmin=(1308.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-728.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(Tetrahydrofuran) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(OF)C(F)CC1(F)F(12003)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0133313,0.0794411,-7.64524e-05,3.50527e-08,-6.26142e-12,-78821.4,27.8315], Tmin=(100,'K'), Tmax=(1359.96,'K')), NASAPolynomial(coeffs=[21.0099,0.0176076,-8.25306e-06,1.62146e-09,-1.15914e-13,-84539.6,-80.0576], Tmin=(1359.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-656.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(CsCsCsFH) + group(CsCsCsFF) + group(Cs-CsCsHH) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(CC(C)(O)OJ)"""),
)
...
"""),
    E0 = (-384.368,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2850,1437.5,1250,1305,750,350,234,347,1316,1464,334,575,1197,1424,3202,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.62785,0.0811877,-0.000111564,8.52901e-08,-2.6866e-11,-46113.8,28.2955], Tmin=(100,'K'), Tmax=(768.549,'K')), NASAPolynomial(coeffs=[9.91599,0.0328482,-1.72215e-05,3.45716e-09,-2.47686e-13,-47541.5,-14.0696], Tmin=(768.549,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-384.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CsCOCsF1s) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[O]C(=O)C(F)(F)C[CH]F(12022)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-665.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,231,348,427,405,1245,1236,1280,334,575,1197,1424,3202,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.626408,0.0849565,-0.000143031,1.36833e-07,-5.1452e-11,-79882.9,28.2642], Tmin=(100,'K'), Tmax=(802.875,'K')), NASAPolynomial(coeffs=[5.45676,0.0404358,-2.16366e-05,4.30005e-09,-3.02823e-13,-79999.3,10.1268], Tmin=(802.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-665.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-466.085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,169,350,401,508,725,1243,1223,334,575,1197,1424,3202,1855,455,950,275.086,275.241],'cm^-1')),
        HinderedRotor(inertia=(0.151315,'amu*angstrom^2'), symmetry=1, barrier=(8.13588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151278,'amu*angstrom^2'), symmetry=1, barrier=(8.13485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00824461,'amu*angstrom^2'), symmetry=1, barrier=(26.2521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.912552,0.0744661,-0.000116391,1.01214e-07,-3.54922e-11,-55952.2,27.0908], Tmin=(100,'K'), Tmax=(768.422,'K')), NASAPolynomial(coeffs=[8.59324,0.0284703,-1.48649e-05,2.94647e-09,-2.0805e-13,-56955,-6.78553], Tmin=(768.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-466.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-CsHH)(F1s)(H)) + radical(COj(Cs-F1sF1sCs)(O2d))"""),
)
...
species(
    label = 'O=C(OF)C(F)(F)[CH][CH]F(12024)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {10,S}
...
species(
    label = '[O]C(=O)C(F)(F)CC(F)F(12026)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.283589,0.0913007,-0.000144428,1.32751e-07,-4.93671e-11,-129615,29.1418], Tmin=(100,'K'), Tmax=(768.31,'K')), NASAPolynomial(coeffs=[7.16991,0.0421678,-2.25752e-05,4.51979e-09,-3.2097e-13,-130282,0.285223], Tmin=(768.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1078.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)

species(
    label = 'O=C(OF)[C](F)CC(F)F(12011)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437947,0.0856013,-0.000105489,7.01329e-08,-1.92319e-11,-95852.8,28.6322], Tmin=(100,'K'), Tmax=(875.971,'K')), NASAPolynomial(coeffs=[11.6047,0.0346095,-1.8171e-05,3.67838e-09,-2.6588e-13,-97809.1,-23.7623], Tmin=(875.971,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-797.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + group(Cds-OdCsOs) + radical(CsCOCsF1s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    products = ['HF(38)', 'CO2(14)', 'F[CH]C=C(F)F(1923)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(21.9639,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'F[CH]CC(F)(F)OF(2650)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000742267,'m^3/(mol*s)'), n=2.83796, Ea=(222.638,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.2632766423807829, var=145.9379134136138, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O=C([C]F)OF(3312)', 'CH2F-CHF(66)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(171.17,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)C(F)(F)C(=O)OF(12014)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(1520)', 'O=C=C(F)C[CH]F(12015)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]CC(F)=C(OF)OF(12016)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.7779e+11,'s^-1'), n=0.725184, Ea=(112.602,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F[CH]COC(OF)=C(F)F(12017)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(72.0818,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH]CC(F)(F)C(=O)OF(12018)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]F(223)', '[CH2]C(F)(F)C(=O)OF(3365)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=C(OF)C(F)(F)C[C]F-2(12019)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    products = ['FO[C]1OC(F)CC1(F)F(12020)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    products = ['[O]C1(OF)C(F)CC1(F)F(12003)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(902977,'s^-1'), n=1.63829, Ea=(99.6847,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_cs]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 97.1 to 99.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction13',
    reactants = ['O=C(OF)[C](F)F(3364)', 'CH2CHF(56)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.00252,'m^3/(mol*s)'), n=2.41, Ea=(9.37537,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H_Sp-2R!H=1R!H_Ext-4R!H-R_2R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H_Sp-2R!H=1R!H_Ext-4R!H-R_2R!H->C"""),
)

reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(OF)C(F)(F)C=CF(8835)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(OF)[C](F)C[CH]F(12021)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(=O)C(F)(F)C[CH]F(12022)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(127)', 'O=[C]C(F)(F)C[CH]F(12023)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C(OF)[C](F)F(3364)', '[CH2][CH]F(226)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]OF(160)', 'F[CH]C[C](F)F(754)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(OF)C(F)(F)[CH][CH]F(12024)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(OF)[C](F)C=CF(8929)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(190.726,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction22',
    reactants = ['CHF(40)', '[CH2]C(F)(F)C(=O)OF(3365)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'O=C(OF)C(F)(F)C[C]F(8938)'],
    products = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    products = ['[O]C(=O)C(F)(F)CC(F)F(12026)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=C(OF)C(F)(F)C[CH]F(11990)'],
    products = ['O=C(OF)[C](F)CC(F)F(12011)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(206.833,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #3873',
    isomers = [
        'O=C(OF)C(F)(F)C[CH]F(11990)',
    ],
    reactants = [
