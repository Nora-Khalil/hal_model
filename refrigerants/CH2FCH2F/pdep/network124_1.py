...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)O[O](216)'],
    products = ['O=O(141)', 'CH2CHF(56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]O[CH]F(287)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)O[O](216)'],
    transitionState = 'TS3',
