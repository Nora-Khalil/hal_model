...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(368)', '[O]C[C](F)F(518)'],
    products = ['C=[C]OC[C](F)F(685)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH2]O[C]=C(369)'],
    products = ['C=[C]OC[C](F)F(685)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=[C]OC=C(F)F(846)'],
    products = ['C=[C]OC[C](F)F(685)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]O[C]=C(369)'],
    products = ['C=[C]OC[C](F)F(685)'],
