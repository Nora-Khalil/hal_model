...
"""),
    E0 = (-726.419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,326,540,652,719,1357,194,682,905,1196,1383,3221,295.681,295.771,295.968,295.987],'cm^-1')),
        HinderedRotor(inertia=(0.181634,'amu*angstrom^2'), symmetry=1, barrier=(11.2696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263648,'amu*angstrom^2'), symmetry=1, barrier=(16.395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.420218,'amu*angstrom^2'), symmetry=1, barrier=(26.0273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.734138,0.0739757,-7.99212e-05,4.4797e-08,-1.01506e-11,-87252.1,23.5338], Tmin=(100,'K'), Tmax=(1061.03,'K')), NASAPolynomial(coeffs=[13.3761,0.0263166,-1.25447e-05,2.46312e-09,-1.75864e-13,-89934.8,-38.2053], Tmin=(1061.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-726.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2316,0.0668617,-7.28336e-05,4.57382e-08,-1.23075e-11,-102817,23.9394], Tmin=(100,'K'), Tmax=(877.01,'K')), NASAPolynomial(coeffs=[8.36796,0.0343142,-1.71677e-05,3.4247e-09,-2.45995e-13,-104069,-9.55313], Tmin=(877.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-855.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + group(COCsFO)"""),
)

species(
    label = 'F[CH]C(F)O[CH]CF(10858)',
...
"""),
    E0 = (-482.694,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.105718,0.0939586,-0.000136854,1.00461e-07,-2.71859e-11,-57922.2,27.2637], Tmin=(100,'K'), Tmax=(651.36,'K')), NASAPolynomial(coeffs=[12.4884,0.029471,-1.49561e-05,2.93326e-09,-2.06208e-13,-59780.4,-29.0489], Tmin=(651.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-482.694,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'FC[CH]O[C](F)CF(10098)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-486.453,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,615,1046,1130,1173,1279,1303,1457,1390,1450,1428,1534,3009,3105,3044,3194,3025,407.5,1350,352.5,395,473,707,1436,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.201826,0.101155,-0.000167646,1.44205e-07,-4.82957e-11,-58363.9,27.9602], Tmin=(100,'K'), Tmax=(835.995,'K')), NASAPolynomial(coeffs=[11.9103,0.0295864,-1.4803e-05,2.83808e-09,-1.94875e-13,-59913.2,-25.4584], Tmin=(835.995,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-486.453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs))"""),
)

species(
    label = 'F[CH]COC(F)[CH]F(4736)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-469.54,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,487,638,688,1119,1325,1387,3149,262,406,528,622,1148,1246,1368,1480,3164,3240,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.126539,0.0925833,-0.000143809,1.21642e-07,-4.124e-11,-56340.2,28.6269], Tmin=(100,'K'), Tmax=(778.07,'K')), NASAPolynomial(coeffs=[10.8217,0.032026,-1.63173e-05,3.19662e-09,-2.24064e-13,-57835.7,-19.2029], Tmin=(778.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-469.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)

species(
    label = 'F[CH]CO[C](F)CF(10000)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-473.299,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0282867,0.0968077,-0.000161264,1.42344e-07,-4.8954e-11,-56790.8,28.6014], Tmin=(100,'K'), Tmax=(833.732,'K')), NASAPolynomial(coeffs=[10.0461,0.0325167,-1.63979e-05,3.15974e-09,-2.17767e-13,-57897.2,-14.5243], Tmin=(833.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-473.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-292.197,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,615,860,1140,1343,3152,1685,370,247.118,247.241,247.438,247.668,247.775],'cm^-1')),
        HinderedRotor(inertia=(0.447856,'amu*angstrom^2'), symmetry=1, barrier=(19.41,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.446344,'amu*angstrom^2'), symmetry=1, barrier=(19.4178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.445184,'amu*angstrom^2'), symmetry=1, barrier=(19.4091,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.901042,0.0669271,-7.13785e-05,3.86272e-08,-8.29797e-12,-35030.5,22.7431], Tmin=(100,'K'), Tmax=(1129.26,'K')), NASAPolynomial(coeffs=[14.2022,0.0198122,-8.79532e-06,1.68056e-09,-1.18532e-13,-38034.6,-43.0442], Tmin=(1129.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-Cs))"""),
)

species(
    label = '[CH]=C(F)OCCF(10860)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-532.491,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,326,540,652,719,1357,194,682,905,1196,1383,3221,190.043,190.562,190.64,190.711],'cm^-1')),
        HinderedRotor(inertia=(0.715005,'amu*angstrom^2'), symmetry=1, barrier=(18.4583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.718931,'amu*angstrom^2'), symmetry=1, barrier=(18.4613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.719868,'amu*angstrom^2'), symmetry=1, barrier=(18.4592,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.29628,0.0841684,-0.000109442,7.07243e-08,-1.79458e-11,-63912.8,24.5815], Tmin=(100,'K'), Tmax=(965.754,'K')), NASAPolynomial(coeffs=[15.7862,0.020011,-9.79238e-06,1.93477e-09,-1.38374e-13,-66904.6,-49.6085], Tmin=(965.754,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-532.491,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CCsJOC(O))"""),
)
...
"""),
    E0 = (-456.871,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,293,496,537,1218,167,640,1190,391.852,391.973,392.086,392.099,392.151],'cm^-1')),
        HinderedRotor(inertia=(0.315906,'amu*angstrom^2'), symmetry=1, barrier=(34.5456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0868267,'amu*angstrom^2'), symmetry=1, barrier=(9.51499,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115061,'amu*angstrom^2'), symmetry=1, barrier=(12.5235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799254,0.0753522,-9.38952e-05,6.19508e-08,-1.65721e-11,-54837.9,24.3455], Tmin=(100,'K'), Tmax=(904.598,'K')), NASAPolynomial(coeffs=[11.7675,0.0268522,-1.34728e-05,2.68146e-09,-1.92138e-13,-56822.3,-27.4702], Tmin=(904.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-456.871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.327301,0.0887291,-0.000138428,1.2101e-07,-4.27016e-11,-56586.7,25.6243], Tmin=(100,'K'), Tmax=(769.169,'K')), NASAPolynomial(coeffs=[9.18156,0.034879,-1.81927e-05,3.60631e-09,-2.54686e-13,-57717.9,-13.2679], Tmin=(769.169,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-471.524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsCFFO) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3060.16,'J/mol'), sigma=(5.26068,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=477.99 K, Pc=47.69 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    ...
    products = ['FC=C(F)OCCF(10003)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(61.3536,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'F[C]COC(F)=CF(10856)'],
    products = ['FC=C(F)OCCF(10003)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['FC=C(F)OCCF(10003)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(8.39871e-05,'m^3/(mol*s)'), n=3.10993, Ea=(20.3594,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s
...
reaction(
    label = 'reaction6',
    reactants = ['FC=C(F)OF(3648)', 'C2H4(30)'],
    products = ['FC=C(F)OCCF(10003)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]C(F)O[CH]CF(10858)'],
    products = ['FC=C(F)OCCF(10003)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FC[CH]O[C](F)CF(10098)'],
    products = ['FC=C(F)OCCF(10003)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]COC(F)[CH]F(4736)'],
    products = ['FC=C(F)OCCF(10003)'],
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]CO[C](F)CF(10000)'],
    products = ['FC=C(F)OCCF(10003)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]COC(F)=CF(10464)'],
    products = ['FC=C(F)OCCF(10003)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FC=[C]OCCF(10859)'],
    products = ['FC=C(F)OCCF(10003)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH]=C(F)OCCF(10860)'],
    products = ['FC=C(F)OCCF(10003)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=C(F)[CH]F(980)', 'CH2F-CH2(62)'],
    products = ['FC=C(F)OCCF(10003)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(3.38501,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction16',
    reactants = ['CHFCF[Z](72)', '[O]CCF(419)'],
    products = ['FC=C(F)OCCF(10003)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(46)', '[CH2]OC(F)=CF(1577)'],
    products = ['FC=C(F)OCCF(10003)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FC=C(F)O[CH]CF(10861)'],
    products = ['FC=C(F)OCCF(10003)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'F[CH]COC(F)=CF(10097)'],
    products = ['FC=C(F)OCCF(10003)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'F[C]=C(F)OCCF(10862)'],
    products = ['FC=C(F)OCCF(10003)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CHF(40)', 'F[C-]=[O+]CCF(10867)'],
    products = ['FC=C(F)OCCF(10003)'],
