...
"""),
    E0 = (-763.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,326,540,652,719,1357,194,682,905,1196,1383,3221,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0342033,'amu*angstrom^2'), symmetry=1, barrier=(18.9882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.924897,'amu*angstrom^2'), symmetry=1, barrier=(21.2652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.922823,'amu*angstrom^2'), symmetry=1, barrier=(21.2175,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2674,0.0653543,-6.63195e-05,3.75181e-08,-9.03222e-12,-103873,23.1356], Tmin=(100,'K'), Tmax=(974.282,'K')), NASAPolynomial(coeffs=[9.19709,0.0327978,-1.61948e-05,3.21908e-09,-2.30983e-13,-105418,-14.9139], Tmin=(974.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-864.433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(COCsFO)"""),
)

species(
    label = 'C[C](F)OC(F)[CH]F(10884)',
...
species(
    label = 'C[C](F)O[C](F)CF(10113)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  O u0 p2 c0 {7,S} {8,S}
5  C u0 p0 c0 {1,S} {8,S} {10,S} {11,S}
...
"""),
    E0 = (-509.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,2750,2800,2850,1350,1500,750,1050,1375,1000,353,437,368,578,616,798,1350,1522,203.511,203.512,203.512,203.53],'cm^-1')),
        HinderedRotor(inertia=(0.37903,'amu*angstrom^2'), symmetry=1, barrier=(11.1404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379073,'amu*angstrom^2'), symmetry=1, barrier=(11.1406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07813,'amu*angstrom^2'), symmetry=1, barrier=(31.6892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379057,'amu*angstrom^2'), symmetry=1, barrier=(11.1405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.233636,0.0904823,-0.00014178,1.21825e-07,-4.18049e-11,-61156.2,27.2427], Tmin=(100,'K'), Tmax=(793.38,'K')), NASAPolynomial(coeffs=[10.0387,0.0326418,-1.65318e-05,3.22579e-09,-2.25357e-13,-62447.4,-16.1245], Tmin=(793.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-509.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2]C(F)OC(F)[CH]F(4757)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-487.613,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([401,573,564,712,601,775,1078,1160,1259,1391,1337,1437,3048,3250,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,235.552,235.56,235.59,235.615],'cm^-1')),
        HinderedRotor(inertia=(0.916916,'amu*angstrom^2'), symmetry=1, barrier=(36.1036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104605,'amu*angstrom^2'), symmetry=1, barrier=(4.11887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.396778,'amu*angstrom^2'), symmetry=1, barrier=(15.6328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.916334,'amu*angstrom^2'), symmetry=1, barrier=(36.1034,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.515777,0.0829931,-0.000106251,7.31101e-08,-2.05307e-11,-58526.4,27.2105], Tmin=(100,'K'), Tmax=(860.93,'K')), NASAPolynomial(coeffs=[11.6699,0.0311709,-1.59634e-05,3.19691e-09,-2.29548e-13,-60447,-24.9317], Tmin=(860.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-487.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)O[C](F)CF(9998)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-491.372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,3000,3100,440,815,1455,1000,192.892,193.135,193.244,193.36],'cm^-1')),
        HinderedRotor(inertia=(0.363961,'amu*angstrom^2'), symmetry=1, barrier=(9.62346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.363117,'amu*angstrom^2'), symmetry=1, barrier=(9.62434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.912585,'amu*angstrom^2'), symmetry=1, barrier=(24.013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.4774,'amu*angstrom^2'), symmetry=1, barrier=(39.1572,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.396709,0.0872421,-0.000122366,8.89765e-08,-2.40548e-11,-58976.1,27.2712], Tmin=(100,'K'), Tmax=(642.135,'K')), NASAPolynomial(coeffs=[10.9659,0.0315537,-1.59885e-05,3.14822e-09,-2.22356e-13,-60542.8,-20.6665], Tmin=(642.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-491.372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
"""),
    E0 = (-329.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,615,860,1140,1343,3152,1685,370,245.207,245.402,245.418,245.526],'cm^-1')),
        HinderedRotor(inertia=(0.513907,'amu*angstrom^2'), symmetry=1, barrier=(21.9401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.513879,'amu*angstrom^2'), symmetry=1, barrier=(21.9434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.512205,'amu*angstrom^2'), symmetry=1, barrier=(21.9368,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.679492,0.0652192,-6.29958e-05,2.97154e-08,-5.46877e-12,-39452,22.773], Tmin=(100,'K'), Tmax=(1324.75,'K')), NASAPolynomial(coeffs=[17.2714,0.0151205,-6.26911e-06,1.16803e-09,-8.14089e-14,-43848,-61.9393], Tmin=(1324.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-329.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-Cs))"""),
)

species(
    label = '[CH]=C(F)OC(C)F(10886)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.1743,'amu*angstrom^2'), symmetry=1, barrier=(26.9995,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.680076,0.0747475,-8.49999e-05,4.86397e-08,-1.10919e-11,-66102.8,24.6567], Tmin=(100,'K'), Tmax=(1061.96,'K')), NASAPolynomial(coeffs=[14.5854,0.0223707,-1.10176e-05,2.19518e-09,-1.5807e-13,-69056.1,-43.2644], Tmin=(1061.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-550.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'CC(F)OC(F)=[C]F(10888)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-493.745,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,293,496,537,1218,167,640,1190,312.591,312.591,312.594,1402.29],'cm^-1')),
        HinderedRotor(inertia=(0.349497,'amu*angstrom^2'), symmetry=1, barrier=(24.2339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231524,'amu*angstrom^2'), symmetry=1, barrier=(16.0538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3495,'amu*angstrom^2'), symmetry=1, barrier=(24.2339,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.884774,0.070228,-7.44891e-05,3.99445e-08,-8.62067e-12,-59273,23.26], Tmin=(100,'K'), Tmax=(1111.91,'K')), NASAPolynomial(coeffs=[13.8015,0.0237608,-1.18031e-05,2.35972e-09,-1.70118e-13,-62145.5,-40.4259], Tmin=(1111.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-493.745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = 'CC(F)[O+]=[C-]C(F)F(10889)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.73966,'amu*angstrom^2'), symmetry=1, barrier=(39.9981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73963,'amu*angstrom^2'), symmetry=1, barrier=(39.9976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73892,'amu*angstrom^2'), symmetry=1, barrier=(39.9813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.621767,0.0824046,-0.000123078,1.10786e-07,-4.0866e-11,-54064.4,35.7178], Tmin=(100,'K'), Tmax=(768.441,'K')), NASAPolynomial(coeffs=[6.56684,0.0407844,-2.09992e-05,4.15125e-09,-2.93217e-13,-54662.9,10.6527], Tmin=(768.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-450.463,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OC(C)F(10890)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
4  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.716129,0.0794944,-0.000102034,7.29849e-08,-2.1716e-11,-61034.4,23.4853], Tmin=(100,'K'), Tmax=(808.114,'K')), NASAPolynomial(coeffs=[9.86618,0.0342044,-1.79698e-05,3.6358e-09,-2.62404e-13,-62513.2,-18.7091], Tmin=(808.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-508.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCFFO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'CC(F)OC(F)[C]F(10891)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-547.139,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,617,898,1187,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.980962,'amu*angstrom^2'), symmetry=1, barrier=(22.5542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.980828,'amu*angstrom^2'), symmetry=1, barrier=(22.5512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.980485,'amu*angstrom^2'), symmetry=1, barrier=(22.5433,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.32217,'amu*angstrom^2'), symmetry=1, barrier=(30.3994,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0956,0.0681959,-6.70976e-05,3.47501e-08,-7.49358e-12,-65704.6,24.0098], Tmin=(100,'K'), Tmax=(1088.98,'K')), NASAPolynomial(coeffs=[11.3226,0.0306305,-1.53535e-05,3.07261e-09,-2.21276e-13,-67932,-26.2012], Tmin=(1088.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-547.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-301.655,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,239,401,1367,237.661,237.968,238.317],'cm^-1')),
        HinderedRotor(inertia=(0.622999,'amu*angstrom^2'), symmetry=1, barrier=(24.4693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607342,'amu*angstrom^2'), symmetry=1, barrier=(24.5057,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.599751,'amu*angstrom^2'), symmetry=1, barrier=(24.4798,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.704891,0.0626537,-6.13308e-05,2.8412e-08,-5.07192e-12,-36153.8,20.4711], Tmin=(100,'K'), Tmax=(1374.26,'K')), NASAPolynomial(coeffs=[18.5739,0.0106421,-4.55952e-06,8.71278e-10,-6.17399e-14,-41065.1,-71.4174], Tmin=(1374.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-301.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(CtCF)"""),
)

species(
    label = 'CC(F)[O+]=[C-]F(10893)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)OC(F)=CF(10004)'],
    products = ['O=C(F)CF(476)', 'CH2CHF(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(9.99999e+07,'s^-1'), n=1.2, Ea=(166.043,'kJ/mol'), T0=(1,'K'), Tmin=(500,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['OC(F)=CF(3655)', 'C[C]F(137)'],
    products = ['CC(F)OC(F)=CF(10004)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(46.1245,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'COC(F)=CF(1576)'],
    products = ['CC(F)OC(F)=CF(10004)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(111.132,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'FC=C(F)OCF(1128)'],
    products = ['CC(F)OC(F)=CF(10004)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OC(F)=CF(3655)', 'CH2CHF(56)'],
    products = ['CC(F)OC(F)=CF(10004)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C[C](F)OC(F)[CH]F(10884)'],
    products = ['CC(F)OC(F)=CF(10004)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C[C](F)O[C](F)CF(10113)'],
    products = ['CC(F)OC(F)=CF(10004)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)OC(F)[CH]F(4757)'],
    products = ['CC(F)OC(F)=CF(10004)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)O[C](F)CF(9998)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C[CH]OC(F)=CF(4162)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC(F)O[C]=CF(10885)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH]=C(F)OC(C)F(10886)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C(F)[CH]F(980)', 'CH3-CHF(63)'],
    products = ['CC(F)OC(F)=CF(10004)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(1.93149,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction15',
    reactants = ['CHFCF[Z](72)', 'CC([O])F(415)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'F[CH]OC(F)=CF(1129)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C[C](F)OC(F)=CF(10887)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(F)OC(F)=CF(10112)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'CC(F)OC(F)=[C]F(10888)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC(F)[O+]=[C-]C(F)F(10889)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(F)(F)OC(C)F(10890)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'C=COC(F)=CF(1242)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'CC(F)OC#CF(10892)'],
    products = ['CC(F)OC(F)=CF(10004)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CHF(40)', 'CC(F)[O+]=[C-]F(10893)'],
    products = ['CC(F)OC(F)=CF(10004)'],
