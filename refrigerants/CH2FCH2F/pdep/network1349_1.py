species(
    label = '[O]C(O[C](F)F)C(F)(F)F(2781)',
...
"""),
    E0 = (-1090.69,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,493,600,700,1144,1293,180,180,180,1524.83,1524.91],'cm^-1')),
        HinderedRotor(inertia=(0.210552,'amu*angstrom^2'), symmetry=1, barrier=(4.841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210542,'amu*angstrom^2'), symmetry=1, barrier=(4.84077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210622,'amu*angstrom^2'), symmetry=1, barrier=(4.84261,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.214102,0.0973904,-0.000184143,1.7827e-07,-6.56098e-11,-131057,32.0048], Tmin=(100,'K'), Tmax=(830.054,'K')), NASAPolynomial(coeffs=[6.8023,0.0362206,-2.04344e-05,4.08273e-09,-2.85937e-13,-131137,7.55305], Tmin=(830.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1090.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFFHO) + radical(CCOJ) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
species(
    label = '[O]C(F)C(F)(F)O[C](F)F(2984)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1070.28,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,391,562,707,872,1109,1210,1289,3137,493,600,700,1144,1293,180,180,180,1089.89],'cm^-1')),
        HinderedRotor(inertia=(0.307592,'amu*angstrom^2'), symmetry=1, barrier=(7.07215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308288,'amu*angstrom^2'), symmetry=1, barrier=(7.08814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308375,'amu*angstrom^2'), symmetry=1, barrier=(7.09016,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0565635,0.0951515,-0.000161151,1.40403e-07,-4.79897e-11,-128591,31.6469], Tmin=(100,'K'), Tmax=(799.228,'K')), NASAPolynomial(coeffs=[11.7577,0.0268343,-1.46242e-05,2.90831e-09,-2.04303e-13,-130150,-20.2331], Tmin=(799.228,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1070.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(CsFFHO) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    ...
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09882,0.0696339,-8.55518e-05,5.69842e-08,-1.56727e-11,-177524,27.1967], Tmin=(100,'K'), Tmax=(873.287,'K')), NASAPolynomial(coeffs=[10.0883,0.028458,-1.48255e-05,2.9914e-09,-2.15836e-13,-179094,-14.9545], Tmin=(873.287,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1476.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCOFFF) + group(CsFFHO) + group(Cds-OdCsOs)"""),
)
...
species(
    label = 'O=C(O[C](F)F)C(F)(F)F(2987)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1257.16,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([230,274,587,678,790,1206,1241,1314,493,600,700,1144,1293,180,180,180,356.412,1420.29,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.134463,'amu*angstrom^2'), symmetry=1, barrier=(3.09158,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134463,'amu*angstrom^2'), symmetry=1, barrier=(3.09158,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134463,'amu*angstrom^2'), symmetry=1, barrier=(3.09158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.45993,0.0845046,-0.000140309,1.18776e-07,-3.9248e-11,-151081,29.6847], Tmin=(100,'K'), Tmax=(821.818,'K')), NASAPolynomial(coeffs=[11.6683,0.0218889,-1.13065e-05,2.19202e-09,-1.51508e-13,-152651,-20.5333], Tmin=(821.818,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1257.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCOFFF) + group(CsFFHO) + group(Cds-OdCsOs) + radical(Csj(F1s)(F1s)(O2s-CO))"""),
)
...
"""),
    E0 = (-842.102,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([179,346,818,1406,1524,493,600,700,1144,1293,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.512464,0.0838093,-0.000145968,1.24846e-07,-4.09556e-11,-101163,28.8986], Tmin=(100,'K'), Tmax=(853.824,'K')), NASAPolynomial(coeffs=[11.9986,0.0180348,-9.39701e-06,1.79927e-09,-1.22377e-13,-102688,-22.1467], Tmin=(853.824,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-842.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFFHO) + group(Cds-OdCsOs) + radical(Csj(CO-O2sO2d)(F1s)(F1s)) + radical(Csj(F1s)(F1s)(O2s-CO))"""),
)

species(
    label = 'O[C](O[C](F)F)C(F)(F)F(2989)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0865545,0.10055,-0.000180994,1.63407e-07,-5.68899e-11,-133503,32.9134], Tmin=(100,'K'), Tmax=(822.941,'K')), NASAPolynomial(coeffs=[11.2825,0.027519,-1.54874e-05,3.0903e-09,-2.16326e-13,-134773,-16.0645], Tmin=(822.941,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1111.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFFHO) + radical(Cs_P) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[O][C](OC(F)F)C(F)(F)F(2990)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.202706,0.0962452,-0.000177514,1.68825e-07,-6.15685e-11,-131844,31.5741], Tmin=(100,'K'), Tmax=(823.125,'K')), NASAPolynomial(coeffs=[7.77864,0.0344489,-1.9378e-05,3.87699e-09,-2.7215e-13,-132245,1.63982], Tmin=(823.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1097.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsFFHO) + radical(CCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]C(F)O[C](F)F(2330)'],
    products = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(249.405,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)C(F)(F)O[C](F)F(2984)'],
    products = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', '[O]C([O])C(F)(F)F(2891)'],
    products = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
    products = ['O=C(OC(F)F)C(F)(F)F(2986)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(76.7963,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)
...
reaction(
    ...
    products = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(38.5015,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CF3(45)', 'O=CO[C](F)F(2344)'],
    products = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(50.4351,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(O[C](F)F)C(F)(F)F(2987)'],
    products = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(15.9,'m^3/(mol*s)'), n=1.84, Ea=(32.4429,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_2COS->O_Ext-1COS-R_Ext-1COS-R_Ext-5R!H-R_N-Sp-6R!H=5R!H"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
    products = ['O[C](O[C](F)F)C(F)(F)F(2989)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
    products = ['[O][C](OC(F)F)C(F)(F)F(2990)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FOC(O[C](F)F)[C](F)F(2991)'],
    products = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(O[C](F)F)C(F)(F)F(2781)'],
    products = ['[O]C(OC(F)(F)F)[C](F)F(2992)'],
