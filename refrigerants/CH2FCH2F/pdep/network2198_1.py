...
"""),
    E0 = (-4.8349,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1855,455,950,180,790.468,790.808],'cm^-1')),
        HinderedRotor(inertia=(0.0262219,'amu*angstrom^2'), symmetry=1, barrier=(3.81703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.64569,'amu*angstrom^2'), symmetry=1, barrier=(14.8457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.645845,'amu*angstrom^2'), symmetry=1, barrier=(14.8493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.645775,'amu*angstrom^2'), symmetry=1, barrier=(14.8476,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45154,0.0567119,-5.62565e-05,2.99659e-08,-6.53084e-12,-490.259,22.4708], Tmin=(100,'K'), Tmax=(1095.99,'K')), NASAPolynomial(coeffs=[10.6799,0.0230313,-1.01603e-05,1.92659e-09,-1.34941e-13,-2513.1,-22.8967], Tmin=(1095.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.8349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17601,0.0505572,-1.98663e-05,-2.05195e-08,1.44703e-11,-25484.5,19.4835], Tmin=(100,'K'), Tmax=(935.206,'K')), NASAPolynomial(coeffs=[17.3592,0.0105026,-2.39676e-06,3.71107e-10,-2.77594e-14,-29786.7,-64.3251], Tmin=(935.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.919826,'amu*angstrom^2'), symmetry=1, barrier=(21.1486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.922305,'amu*angstrom^2'), symmetry=1, barrier=(21.2056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.922561,'amu*angstrom^2'), symmetry=1, barrier=(21.2115,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.105996,0.0681407,-7.49637e-05,3.82217e-08,-7.1765e-12,-2117.49,22.8036], Tmin=(100,'K'), Tmax=(1515.96,'K')), NASAPolynomial(coeffs=[20.421,0.00283544,1.23301e-06,-3.79028e-10,2.89693e-14,-6932.2,-79.2217], Tmin=(1515.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.8964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(CCsJOC(O))"""),
)

species(
    label = 'C=COC[C]=O(5689)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {3,S} {4,S}
2  O u0 p2 c0 {6,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.04701,'amu*angstrom^2'), symmetry=1, barrier=(24.0729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04741,'amu*angstrom^2'), symmetry=1, barrier=(24.082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04747,'amu*angstrom^2'), symmetry=1, barrier=(24.0833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40894,0.0418262,3.06759e-06,-4.60567e-08,2.39335e-11,-11610.3,20.8718], Tmin=(100,'K'), Tmax=(937.295,'K')), NASAPolynomial(coeffs=[18.889,0.0055924,-3.41548e-07,3.69401e-11,-8.34413e-15,-16572.3,-71.317], Tmin=(937.295,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CsCJ=O)"""),
)

species(
    label = 'C[CH]OC=C[O](5690)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {5,S}
2  O u1 p2 c0 {6,S}
3  C u0 p0 c0 {4,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.555234,0.0558094,-4.93229e-06,-5.81066e-08,3.35094e-11,-6942.47,21.7929], Tmin=(100,'K'), Tmax=(909.124,'K')), NASAPolynomial(coeffs=[26.2915,-0.00399629,5.58736e-06,-1.17536e-09,7.70417e-14,-13830,-112.062], Tmin=(909.124,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.9096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]COC[C]=O(5691)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  O u0 p2 c0 {6,D}
3  C u0 p0 c0 {1,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (26.2982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1855,455,950,240.384,551.398,1871.93],'cm^-1')),
        HinderedRotor(inertia=(0.0574293,'amu*angstrom^2'), symmetry=1, barrier=(12.6416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.550343,'amu*angstrom^2'), symmetry=1, barrier=(12.6535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0890063,'amu*angstrom^2'), symmetry=1, barrier=(2.04643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18544,'amu*angstrom^2'), symmetry=1, barrier=(27.2557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7143,0.0534592,-5.15027e-05,2.80661e-08,-6.51117e-12,3242.6,22.7219], Tmin=(100,'K'), Tmax=(1010.08,'K')), NASAPolynomial(coeffs=[8.31131,0.0273353,-1.27089e-05,2.46227e-09,-1.74272e-13,1909.86,-9.17124], Tmin=(1010.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.2982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJCO) + radical(CsCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13397,0.0481724,-5.06463e-06,-4.15561e-08,2.34042e-11,-1457.74,23.3695], Tmin=(100,'K'), Tmax=(924.405,'K')), NASAPolynomial(coeffs=[19.6252,0.00664903,-1.42688e-07,-6.30325e-11,1.06217e-15,-6520.96,-73.2816], Tmin=(924.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.0928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = '[CH2][CH]OCC=O(5693)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {1,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (52.0832,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,308.539,308.539,308.539],'cm^-1')),
        HinderedRotor(inertia=(0.00177083,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00177084,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25124,'amu*angstrom^2'), symmetry=1, barrier=(16.9722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251239,'amu*angstrom^2'), symmetry=1, barrier=(16.9722,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21774,0.0618904,-6.7677e-05,3.9186e-08,-9.13015e-12,6363.83,23.266], Tmin=(100,'K'), Tmax=(1038.63,'K')), NASAPolynomial(coeffs=[11.6986,0.0215258,-9.38158e-06,1.76761e-09,-1.23395e-13,4186.7,-27.6953], Tmin=(1038.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.0832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[C]=O(515)', '[CH]C-2(510)'],
    products = ['C[CH]OC[C]=O(5674)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]O[CH]C(3428)'],
    products = ['C[CH]OC[C]=O(5674)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]=O(338)', 'C[CH][O](3430)'],
    products = ['C[CH]OC[C]=O(5674)'],
