...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CO[C]=O(3161)'],
    products = ['CC([O])O[C]=O(4036)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'O=[C]OC=O(2617)'],
    products = ['CC([O])O[C]=O(4036)'],
