...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]C([O])F(139)'],
    products = ['[O]C(F)C[C]=O(1422)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)C=C=O(1434)'],
    products = ['[O]C(F)C[C]=O(1422)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C=C[C]=O(1435)'],
    products = ['[O]C(F)C[C]=O(1422)'],
