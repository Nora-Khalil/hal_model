...
"""),
    E0 = (-30.1813,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,1556,1557.22,1557.82],'cm^-1')),
        HinderedRotor(inertia=(0.140752,'amu*angstrom^2'), symmetry=1, barrier=(3.23617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140679,'amu*angstrom^2'), symmetry=1, barrier=(3.23449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140071,'amu*angstrom^2'), symmetry=1, barrier=(3.2205,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.094,0.0602014,-0.000137088,1.59459e-07,-6.55825e-11,-3579.07,21.3002], Tmin=(100,'K'), Tmax=(844.175,'K')), NASAPolynomial(coeffs=[-4.32893,0.04378,-2.46527e-05,4.91531e-09,-3.4323e-13,-825.12,61.0877], Tmin=(844.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.1813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(CsJOCH3)"""),
)

species(
    label = '[CH2]O[C](O)OF(4344)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (-52.3328,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,360,370,350,3000,3100,440,815,1455,1000,180,1468.66,1468.69],'cm^-1')),
        HinderedRotor(inertia=(0.192164,'amu*angstrom^2'), symmetry=1, barrier=(4.41823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192206,'amu*angstrom^2'), symmetry=1, barrier=(4.4192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192188,'amu*angstrom^2'), symmetry=1, barrier=(4.41879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192184,'amu*angstrom^2'), symmetry=1, barrier=(4.4187,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57898,0.0637113,-0.000122618,1.21346e-07,-4.5105e-11,-6217.11,23.3657], Tmin=(100,'K'), Tmax=(842.886,'K')), NASAPolynomial(coeffs=[4.54355,0.0262675,-1.43844e-05,2.83953e-09,-1.97257e-13,-5886.52,14.4957], Tmin=(842.886,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.3328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(Cs_P) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (-363.705,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,388.718,389.028,389.065,389.149,1419.43,1419.44,1419.53],'cm^-1')),
        HinderedRotor(inertia=(0.0466728,'amu*angstrom^2'), symmetry=1, barrier=(5.01481,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.016479,'amu*angstrom^2'), symmetry=1, barrier=(23.5621,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.81903,0.0207219,1.00121e-06,-1.30346e-08,5.43414e-12,-43696.7,15.3388], Tmin=(100,'K'), Tmax=(1087.93,'K')), NASAPolynomial(coeffs=[7.67035,0.0144539,-6.30719e-06,1.21808e-09,-8.71052e-14,-45436.9,-11.6214], Tmin=(1087.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-363.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-OsHHH) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.140037,'amu*angstrom^2'), symmetry=1, barrier=(7.15945,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.17385,0.0160845,-2.93046e-06,-3.3379e-09,1.28644e-12,-20557.3,12.7606], Tmin=(100,'K'), Tmax=(1366.1,'K')), NASAPolynomial(coeffs=[6.09103,0.0131502,-5.86553e-06,1.0991e-09,-7.54103e-14,-21877.5,-4.13822], Tmin=(1366.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""CH3OCO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)OF(3721)', 'CH3(19)'],
    products = ['COC(=O)OF(4073)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(=O)OF(4194)'],
    products = ['COC(=O)OF(4073)'],
    transitionState = 'TS9',
