...
"""),
    E0 = (-277.515,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,337.805,337.843,337.902,337.922],'cm^-1')),
        HinderedRotor(inertia=(0.370365,'amu*angstrom^2'), symmetry=1, barrier=(29.9989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.370301,'amu*angstrom^2'), symmetry=1, barrier=(29.9921,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61135,0.0383972,3.12756e-06,-4.05595e-08,2.03669e-11,-33278.6,19.2741], Tmin=(100,'K'), Tmax=(960.642,'K')), NASAPolynomial(coeffs=[17.4128,0.00713867,-1.9914e-06,4.17824e-10,-3.67609e-14,-37908,-64.6187], Tmin=(960.642,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-469.915,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,374.692,375.056,375.313,376.199],'cm^-1')),
        HinderedRotor(inertia=(0.311355,'amu*angstrom^2'), symmetry=1, barrier=(31.1529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.312325,'amu*angstrom^2'), symmetry=1, barrier=(31.1442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23043,0.0490888,-2.39145e-05,-1.31664e-08,1.05548e-11,-56407.4,21.719], Tmin=(100,'K'), Tmax=(983.132,'K')), NASAPolynomial(coeffs=[17.8283,0.00851975,-3.15322e-06,6.50001e-10,-5.19412e-14,-60973.9,-64.7005], Tmin=(983.132,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-469.915,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-408.258,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,190,488,555,1236,1407,350.362,350.364,350.624,350.802,1266.97],'cm^-1')),
        HinderedRotor(inertia=(0.00136999,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160353,'amu*angstrom^2'), symmetry=1, barrier=(13.9688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.312802,'amu*angstrom^2'), symmetry=1, barrier=(27.2898,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48642,0.0596181,-6.53657e-05,3.84968e-08,-9.40241e-12,-49015.2,23.1414], Tmin=(100,'K'), Tmax=(974.19,'K')), NASAPolynomial(coeffs=[9.78811,0.0255322,-1.28835e-05,2.58246e-09,-1.86128e-13,-50632.7,-16.6926], Tmin=(974.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-408.258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'O[CH]O[CH]C(F)F(5081)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.405593,0.0853099,-0.000141264,1.17639e-07,-3.78263e-11,-55579.5,26.0972], Tmin=(100,'K'), Tmax=(857.09,'K')), NASAPolynomial(coeffs=[12.3016,0.0199311,-9.58703e-06,1.79434e-09,-1.20983e-13,-57256.6,-27.3471], Tmin=(857.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-463.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(OCJO)"""),
)

species(
    label = '[O][CH]OCC(F)F(5082)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-421.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,180,180,804.992,805.692,805.786],'cm^-1')),
        HinderedRotor(inertia=(0.214646,'amu*angstrom^2'), symmetry=1, barrier=(4.93514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216028,'amu*angstrom^2'), symmetry=1, barrier=(4.96692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215021,'amu*angstrom^2'), symmetry=1, barrier=(4.94376,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1035,0.077124,-0.000144236,1.45703e-07,-5.53632e-11,-50635.3,23.4486], Tmin=(100,'K'), Tmax=(840.939,'K')), NASAPolynomial(coeffs=[2.71615,0.0386128,-2.05322e-05,4.0247e-09,-2.7925e-13,-49816,22.4316], Tmin=(840.939,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = 'OCO[CH][C](F)F(5083)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.104623,0.076185,-9.32901e-05,5.30445e-08,-1.13253e-11,-53930.1,28.223], Tmin=(100,'K'), Tmax=(1231.8,'K')), NASAPolynomial(coeffs=[21.0818,0.00391762,-2.35884e-07,-5.18704e-11,5.75616e-15,-58783.3,-76.0752], Tmin=(1231.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-449.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'F[CH][CH]OCOF(5084)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {6,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](1330)', '[CH]C(F)F(506)'],
    products = ['[O]CO[CH]C(F)F(4971)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]COC=C(F)F(1855)'],
    products = ['[O]CO[CH]C(F)F(4971)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][CH]OCOF(5084)'],
    products = ['[O]CO[CH]C(F)F(4971)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(75.3084,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
