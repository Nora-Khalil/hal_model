...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[O]C[C]=O(515)'],
    products = ['O=[C]CO[C](F)F(2140)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]O[C](F)F(941)'],
    products = ['O=[C]CO[C](F)F(2140)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[C](F)F(941)'],
    products = ['O=[C]CO[C](F)F(2140)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[C](F)F(2236)'],
    products = ['O=[C]CO[C](F)F(2140)'],
    transitionState = 'TS9',
