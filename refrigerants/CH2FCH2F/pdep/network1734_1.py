...
reaction(
    label = 'reaction1',
    reactants = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OC(F)C(F)F(1614)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'O=C(O)C(F)[C]F(3760)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(140)', 'O=C=CC(F)F(1782)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H2O(3)', 'O=C=C(F)C(F)F(6890)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OC(F)F(1071)', 'O=C=CF(434)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([O])C(F)C(F)F(9076)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(O)[C](F)C(F)F(9077)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(O)C(F)[C](F)F(9078)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[C](O)C(F)[C](F)F(9079)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'O=C(O)[CH]C(F)F(3833)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', 'O=C(O)C(F)[CH]F(585)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OH(7)', 'O=[C]C(F)C(F)F(5623)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[O]C(=O)C(F)C(F)F(5628)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CHF2(82)', 'O=C(O)[CH]F(2553)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=[C]O(158)', 'CHF2-CHF(67)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', 'O=C(O)[C](F)C(F)F(7327)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(5)', 'O=C(O)C(F)[C](F)F(7364)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F2(78)', 'O=C(O)C=CF(166)'],
    products = ['O=C(O)C(F)C(F)F(3982)'],
...
network(
    label = 'PDepNetwork #1734',
    isomers = [
        'O=C(O)C(F)C(F)F(3982)',
    ],
    reactants = [
