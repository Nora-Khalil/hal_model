...
"""),
    E0 = (-154.824,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.06787,'amu*angstrom^2'), symmetry=1, barrier=(24.5524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07228,'amu*angstrom^2'), symmetry=1, barrier=(24.6538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07192,'amu*angstrom^2'), symmetry=1, barrier=(24.6455,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.26402,0.0803677,-9.6648e-05,5.29757e-08,-1.07908e-11,-18456,25.5905], Tmin=(100,'K'), Tmax=(1334.31,'K')), NASAPolynomial(coeffs=[23.4929,0.00126406,1.14261e-06,-3.12715e-10,2.32376e-14,-24093.9,-93.2443], Tmin=(1334.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(Cds_P)"""),
)
...
"""),
    E0 = (51.9127,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,194,682,905,1196,1383,3221,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.10783,'amu*angstrom^2'), symmetry=1, barrier=(25.4712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10767,'amu*angstrom^2'), symmetry=1, barrier=(25.4675,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6007,0.0459288,-3.43256e-05,7.69708e-09,1.30347e-12,6336.02,21.516], Tmin=(100,'K'), Tmax=(1021.6,'K')), NASAPolynomial(coeffs=[13.2955,0.0130462,-4.99624e-06,9.24933e-10,-6.57703e-14,3272.99,-38.451], Tmin=(1021.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.9127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-140.487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,182,240,577,636,1210,1413,3120,650,792.5,1650,184.476,185.155],'cm^-1')),
        HinderedRotor(inertia=(1.08341,'amu*angstrom^2'), symmetry=1, barrier=(26.2832,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07973,'amu*angstrom^2'), symmetry=1, barrier=(26.2847,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32534,0.0553629,-5.68827e-05,2.9094e-08,-5.85136e-12,-16797.4,23.5828], Tmin=(100,'K'), Tmax=(1210.22,'K')), NASAPolynomial(coeffs=[13.703,0.0144527,-6.17708e-06,1.16228e-09,-8.14187e-14,-19793.4,-38.4939], Tmin=(1210.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-140.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-151.512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,194,682,905,1196,1383,3221,198.166,198.173,198.244,198.254],'cm^-1')),
        HinderedRotor(inertia=(0.739314,'amu*angstrom^2'), symmetry=1, barrier=(20.611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.739171,'amu*angstrom^2'), symmetry=1, barrier=(20.6099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.739809,'amu*angstrom^2'), symmetry=1, barrier=(20.6115,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.352962,0.0778275,-9.85226e-05,5.95288e-08,-1.38133e-11,-18089.2,23.9253], Tmin=(100,'K'), Tmax=(1065.9,'K')), NASAPolynomial(coeffs=[18.0994,0.0112296,-4.80074e-06,9.09653e-10,-6.43577e-14,-21872.4,-62.8233], Tmin=(1065.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-151.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(F)F(506)', '[CH]=C[O](134)'],
    products = ['[CH]=CO[CH]C(F)F(5484)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=COC=C(F)F(5487)'],
    products = ['[CH]=CO[CH]C(F)F(5484)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['[CH]=CO[CH]C(F)F(5484)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(15.6759,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH][CH]OC=CF(5488)'],
    products = ['[CH]=CO[CH]C(F)F(5484)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(196.426,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)
