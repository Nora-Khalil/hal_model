species(
    label = 'F[CH]C(F)C(F)(F)[CH]F(6116)',
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)C(F)[C](F)F(6117)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'F[CH]C(F)[C](F)F(919)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', 'F[CH]C(F)(F)[CH]F(6143)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    products = ['FC1C(F)C(F)(F)C1F(6149)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[CH]C(F)C(F)=CF(904)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHFCF2(55)', 'F[CH][CH]F(493)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C(F)(F)C=CF(6131)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH][C](F)F(3911)', 'CHFCHF[Z](59)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH]C(F)(F)C(F)=CF(6186)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][C](F)F(3911)', 'F[CH][CH]F(493)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', 'F[CH]C=C(F)[CH]F(905)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[CH]C(F)=C(F)[CH]F(6187)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'F[CH]C(F)[C](F)F(919)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[CH]C(F)(F)[CH]F(6143)'],
    products = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    products = ['F[CH]C(F)(F)[C](F)CF(6188)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    products = ['F[CH][C](F)C(F)(F)CF(6189)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    products = ['F[CH]C(F)[C](F)C(F)F(6156)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    products = ['F[CH][C](F)C(F)C(F)F(6158)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]C(F)C(F)(F)[CH]F(6116)'],
    products = ['F[CH]C(F)(F)[CH]C(F)F(6175)'],
...
network(
    label = 'PDepNetwork #2313',
    isomers = [
        'F[CH]C(F)C(F)(F)[CH]F(6116)',
    ],
    reactants = [
