...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.60049,'amu*angstrom^2'), symmetry=1, barrier=(13.8064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208432,'amu*angstrom^2'), symmetry=1, barrier=(4.79225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.375016,'amu*angstrom^2'), symmetry=1, barrier=(8.62234,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-514.425,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CC(F)(F)OF(2633)'],
    products = ['CCC(F)(F)OF(5793)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(1520)', 'CC[C]F(5869)'],
    products = ['CCC(F)(F)OF(5793)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(140)', 'CC=C(F)F(2130)'],
    products = ['CCC(F)(F)OF(5793)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(127)', 'CC[C](F)F(606)'],
    products = ['CCC(F)(F)OF(5793)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FO[C](F)F(2145)', 'C2H5(32)'],
    products = ['CCC(F)(F)OF(5793)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[CH2]C(F)(F)OF(2648)'],
    products = ['CCC(F)(F)OF(5793)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C[CH]C(F)(F)OF(2637)'],
    products = ['CCC(F)(F)OF(5793)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]CC(F)(F)OF(2646)'],
    products = ['CCC(F)(F)OF(5793)'],
