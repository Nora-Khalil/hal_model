...
"""),
    E0 = (-705.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,190,488,555,1236,1407,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.303067,0.105579,-0.000181988,1.627e-07,-5.62958e-11,-84715.6,31.3316], Tmin=(100,'K'), Tmax=(834.569,'K')), NASAPolynomial(coeffs=[10.7157,0.033382,-1.73851e-05,3.3807e-09,-2.33701e-13,-85879.7,-15.7906], Tmin=(834.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-705.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-558.378,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,194,682,905,1196,1383,3221,278.407,278.468,278.475,278.495],'cm^-1')),
        HinderedRotor(inertia=(0.368876,'amu*angstrom^2'), symmetry=1, barrier=(20.295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368675,'amu*angstrom^2'), symmetry=1, barrier=(20.2959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.368943,'amu*angstrom^2'), symmetry=1, barrier=(20.2949,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.486575,0.0755889,-8.5368e-05,4.74587e-08,-1.03399e-11,-67029.4,25.3224], Tmin=(100,'K'), Tmax=(1120.95,'K')), NASAPolynomial(coeffs=[16.6289,0.0179859,-8.28531e-06,1.61429e-09,-1.15272e-13,-70648.3,-54.3976], Tmin=(1120.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-558.378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-689.121,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,146,234,414,562,504,606,1176,1296,1354,1460,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.198601,0.103741,-0.00017982,1.63112e-07,-5.72638e-11,-82741.9,30.4863], Tmin=(100,'K'), Tmax=(831.389,'K')), NASAPolynomial(coeffs=[9.75005,0.0350785,-1.84147e-05,3.59673e-09,-2.49406e-13,-83677.4,-11.3503], Tmin=(831.389,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-689.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsCsFFH) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)[CH]OCC(F)F(1751)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-705.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,3025,407.5,1350,352.5,190,488,555,1236,1407,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.523462,0.110446,-0.000191847,1.69547e-07,-5.77593e-11,-87998.8,30.157], Tmin=(100,'K'), Tmax=(841.621,'K')), NASAPolynomial(coeffs=[12.0609,0.0312842,-1.62712e-05,3.15022e-09,-2.16753e-13,-89431.7,-24.3141], Tmin=(841.621,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-732.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(CsCsFHH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)CO[CH]C(F)F(4714)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(F)F(506)', '[O]C[C](F)F(518)'],
    products = ['F[C](F)CO[CH]C(F)F(4714)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH2]O[CH]C(F)F(928)'],
    products = ['F[C](F)CO[CH]C(F)F(4714)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['F[C](F)CO[CH]C(F)F(4714)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(40.7304,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)COC=C(F)F(1667)'],
    products = ['F[C](F)CO[CH]C(F)F(4714)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH2]O[CH]C(F)F(928)'],
    products = ['F[C](F)CO[CH]C(F)F(4714)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(2.00017,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['F[C](F)COC[C](F)F(4778)'],
    products = ['F[C](F)CO[CH]C(F)F(4714)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(2.49e+06,'s^-1'), n=1.223, Ea=(12.1085,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 442 used for R2H_S;C_rad_out_noH;Cs_H_out_H/NonDeO
Exact match found for rate rule [R2H_S;C_rad_out_noH;Cs_H_out_H/NonDeO]
Euclidian distance = 0
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)[CH]OCC(F)F(1751)'],
    products = ['F[C](F)CO[CH]C(F)F(4714)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C](F)CO[CH]C(F)F(4714)'],
    products = ['F[CH][CH]OCC(F)(F)F(2792)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(3.29706e+07,'s^-1'), n=1.15307, Ea=(185.152,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #1916',
    isomers = [
        'F[C](F)CO[CH]C(F)F(4714)',
    ],
    reactants = [
