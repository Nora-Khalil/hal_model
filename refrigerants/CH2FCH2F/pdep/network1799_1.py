...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=C=CC(=O)F(5958)'],
    products = ['O=C(O)CC(=O)F(4082)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=[C]CC(=O)O(5967)'],
    products = ['O=C(O)CC(=O)F(4082)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)CC(=O)F(577)'],
    products = ['O=C(O)CC(=O)F(4082)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)[CH]C(=O)F(579)'],
    products = ['O=C(O)CC(=O)F(4082)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C=CC(=O)O(563)'],
    products = ['O=C(O)CC(=O)F(4082)'],
