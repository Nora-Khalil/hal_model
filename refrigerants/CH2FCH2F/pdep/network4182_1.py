species(
    label = '[CH2]C(F)(F)C(F)(F)[C](F)F(12617)',
...
species(
    label = 'F[C](F)CC(F)(F)[C](F)F(12618)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'FC1(F)CC(F)(F)C1(F)F(12669)',
...
species(
    label = '[CH2]C(F)(F)[C](F)C(F)(F)F(12681)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[CH2][C](F)C(F)(F)C(F)(F)F(12682)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
    products = ['F[C](F)CC(F)(F)[C](F)F(12618)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH2]C(F)(F)[C](F)F(804)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[C](F)C(F)(F)[C](F)F(12680)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
    products = ['FC1(F)CC(F)(F)C1(F)F(12669)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)=C(F)F(6180)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CF2CF2(61)', '[CH2][C](F)F(507)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)C(F)(F)[C](F)F(12665)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[C](F)[C](F)F(3840)', 'CH2CF2(57)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[C](F)[C](F)F(3840)', '[CH2][C](F)F(507)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F2(78)', '[CH2]C(F)=C(F)[C](F)F(6181)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH2]C(F)(F)[C](F)F(804)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
    products = ['[CH2]C(F)(F)[C](F)C(F)(F)F(12681)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FCC(F)(F)[C](F)[C](F)F(6402)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
    products = ['[CH2][C](F)C(F)(F)C(F)(F)F(12682)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FC[C](F)C(F)(F)[C](F)F(12677)'],
    products = ['[CH2]C(F)(F)C(F)(F)[C](F)F(12617)'],
...
network(
    label = 'PDepNetwork #4182',
    isomers = [
        '[CH2]C(F)(F)C(F)(F)[C](F)F(12617)',
    ],
    reactants = [
        ('CF2CF2(61)', 'CH2CF2(57)'),
    ],
