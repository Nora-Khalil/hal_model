...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC(F)(F)[C]=CF(7424)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C(F)(F)[C]=CF(2246)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7424)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]O[C](F)F(1040)', '[C]=CF(1054)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7424)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C(F)(F)[C]=CF(2246)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7424)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(F)=C=CF(8229)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7424)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CC(F)(F)O[C]=O(8230)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7424)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(F)(F)C#CF(8231)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7424)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OC(F)(F)[C]=CF(7424)'],
    products = ['O=[C]OC(F)(F)C=[C]F(8232)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=COC(F)(F)[C]=[C]F(8233)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7424)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OC(F)(F)[C]=CF(7424)'],
    products = ['O=[C]OC(F)=C(F)[CH]F(8234)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OC(F)(F)[C]=CF(7424)'],
    products = ['O=C(F)OC(F)=[C][CH]F(8235)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OC(F)(F)[C]=CF(7424)'],
    products = ['[CH]=C(F)C(F)(F)O[C]=O(8236)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]C(F)(F)OC(=O)F(8237)'],
    products = ['O=[C]OC(F)(F)[C]=CF(7424)'],
