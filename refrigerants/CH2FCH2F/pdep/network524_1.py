...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)[CH]F(975)'],
    products = ['[O]C(F)C([O])F(1117)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)C(=O)F(1182)'],
    products = ['[O]C(F)C([O])F(1117)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(1073)', '[O][CH]F(1073)'],
    products = ['[O]C(F)C([O])F(1117)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[O][CH]C(=O)F(1184)'],
    products = ['[O]C(F)C([O])F(1117)'],
