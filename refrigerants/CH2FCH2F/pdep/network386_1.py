...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COC(F)F(3026)'],
    products = ['C#COCC(F)F(690)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'C#COC[C]F(1377)'],
    products = ['C#COCC(F)F(690)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF2(82)', 'C#CO[CH2](1380)'],
    products = ['C#COCC(F)F(690)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C#CO[CH]C(F)F(3027)'],
    products = ['C#COCC(F)F(690)'],
