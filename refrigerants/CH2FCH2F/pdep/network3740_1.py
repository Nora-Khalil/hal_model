species(
    label = 'FC[C](F)OC1(F)[CH]O1(11284)',
...
"""),
    E0 = (-225.603,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,2950,1000,180,180,180,180,841.405,1368.02,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.156624,'amu*angstrom^2'), symmetry=1, barrier=(3.6011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156624,'amu*angstrom^2'), symmetry=1, barrier=(3.6011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156624,'amu*angstrom^2'), symmetry=1, barrier=(3.6011,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.299532,0.0787651,-9.70509e-05,5.70947e-08,-1.29364e-11,-26998.2,23.7883], Tmin=(100,'K'), Tmax=(1089.16,'K')), NASAPolynomial(coeffs=[18.3968,0.012302,-5.51748e-06,1.06796e-09,-7.63645e-14,-30940.4,-65.0663], Tmin=(1089.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.603,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(CsCsF1sO2s)"""),
)
...
"""),
    E0 = (-380.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([364,474,579,619,655,1345,2950,1000,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,180,676.464,1052.78,1052.84,1052.94],'cm^-1')),
        HinderedRotor(inertia=(1.15947,'amu*angstrom^2'), symmetry=1, barrier=(26.6586,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15947,'amu*angstrom^2'), symmetry=1, barrier=(26.6584,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799416,0.0612088,-5.24471e-05,1.77169e-08,-1.064e-12,-45659,23.2711], Tmin=(100,'K'), Tmax=(1074.11,'K')), NASAPolynomial(coeffs=[17.4292,0.0135455,-5.80825e-06,1.13537e-09,-8.27637e-14,-50054.5,-61.9781], Tmin=(1074.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-380.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(CsCFOO) + group(Cs-CsOsHH) + group(CdCFO) + group(Cds-CdsHH) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring)"""),
)
...
species(
    label = 'FC=C(F)OC1(F)[CH]O1(11371)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-547.525,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([364,474,579,619,655,1345,2950,1000,326,540,652,719,1357,194,682,905,1196,1383,3221,180,180,180,652.182,652.195,652.246],'cm^-1')),
        HinderedRotor(inertia=(0.00650588,'amu*angstrom^2'), symmetry=1, barrier=(1.96383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143376,'amu*angstrom^2'), symmetry=1, barrier=(43.2758,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (139.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.560396,0.0720221,-7.77621e-05,4.04014e-08,-8.18925e-12,-65725.1,24.8997], Tmin=(100,'K'), Tmax=(1203.64,'K')), NASAPolynomial(coeffs=[17.5207,0.0156573,-7.51753e-06,1.49375e-09,-1.07809e-13,-69807.9,-60.0674], Tmin=(1203.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-547.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(CsCFOO) + group(Cs-CsOsHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring)"""),
)
...
species(
    label = 'F[CH][C](F)OC1(F)CO1(11372)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.330312,0.0886789,-0.000128967,9.48959e-08,-2.58202e-11,-60809.6,27.2554], Tmin=(100,'K'), Tmax=(648.303,'K')), NASAPolynomial(coeffs=[11.8288,0.0284896,-1.45918e-05,2.87207e-09,-2.02356e-13,-62526.5,-24.9781], Tmin=(648.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-506.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(CsCFOO) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
species(
    label = 'FCC(F)(F)O[C]1[CH]O1(11373)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FC[C](F)OC1(F)[CH]O1(11284)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C1(F)[CH]O1(9413)', 'F[C]CF-2(467)'],
    products = ['FC[C](F)OC1(F)[CH]O1(11284)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FC[C](F)OC1(F)[CH]O1(11284)'],
    products = ['FC=C(F)OC1(F)CO1(11290)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C[C](F)O[C](F)CF(11368)'],
    products = ['FC[C](F)OC1(F)[CH]O1(11284)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC[C](F)OC1=CO1(11369)'],
    products = ['FC[C](F)OC1(F)[CH]O1(11284)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(27.1958,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)OC1(F)[CH]O1(11370)'],
    products = ['FC[C](F)OC1(F)[CH]O1(11284)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC=C(F)OC1(F)[CH]O1(11371)'],
    products = ['FC[C](F)OC1(F)[CH]O1(11284)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C1(F)[CH]O1(9413)', 'F[C]CF(125)'],
    products = ['FC[C](F)OC1(F)[CH]O1(11284)'],
...
reaction(
    label = 'reaction14',
    reactants = ['FC[C](F)OC1(F)[CH]O1(11284)'],
    products = ['F[CH][C](F)OC1(F)CO1(11372)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FC[C](F)OC1(F)[CH]O1(11284)'],
    products = ['FCC(F)(F)O[C]1[CH]O1(11373)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FC[C](F)OC1(F)[CH]O1(11284)'],
    products = ['[CH2][C](F)OC1(F)OC1F(11374)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FC[C](F)OC1(F)[CH]O1(11284)'],
    products = ['[CH2]C(F)(F)OC1(F)[CH]O1(11375)'],
...
network(
    label = 'PDepNetwork #3740',
    isomers = [
        'FC[C](F)OC1(F)[CH]O1(11284)',
    ],
    reactants = [
