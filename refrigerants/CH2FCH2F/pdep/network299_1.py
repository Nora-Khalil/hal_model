...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]C[O](325)'],
    products = ['[O]CC[C]=O(610)'],
    transitionState = 'TS3',
