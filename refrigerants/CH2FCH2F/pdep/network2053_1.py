...
reaction(
    label = 'reaction3',
    reactants = ['FO[C](F)F(2145)', 'CHF(40)'],
    products = ['F[C](F)OC(F)F(3473)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'F[C]OC(F)F(11868)'],
    products = ['F[C](F)OC(F)F(3473)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(744)', '[O]C(F)F(1061)'],
    products = ['F[C](F)OC(F)F(3473)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]O[C](F)F(1161)'],
    products = ['F[C](F)OC(F)F(3473)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(2186)', 'CHF2(82)'],
    products = ['F[C](F)OC(F)F(3473)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)O[C](F)F(2216)'],
    products = ['F[C](F)OC(F)F(3473)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C-]=[O+]C(F)F(11869)'],
    products = ['F[C](F)OC(F)F(3473)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)OC(F)F(3473)'],
    products = ['F[CH]OC(F)(F)F(3822)'],
