...
species(
    label = 'F[CH]C=C([CH]F)C(F)(F)F(7815)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.273788,0.0888237,-0.000116838,8.17779e-08,-2.32419e-11,-104984,26.8436], Tmin=(100,'K'), Tmax=(852.782,'K')), NASAPolynomial(coeffs=[12.439,0.0317614,-1.64666e-05,3.31029e-09,-2.38025e-13,-107059,-29.9088], Tmin=(852.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-873.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFF) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)

species(
    label = 'F[CH]C(F)[C]1C(F)C1(F)F(7817)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'F[CH][C]1C(F)C(F)C1(F)F(7818)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28709,0.0711269,-5.9504e-05,-2.31429e-08,5.52471e-11,-77543.3,26.6678], Tmin=(100,'K'), Tmax=(487.682,'K')), NASAPolynomial(coeffs=[7.56868,0.0389258,-1.98871e-05,3.93701e-09,-2.7904e-13,-78385.8,-1.4821], Tmin=(487.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-645.447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFH) + group(CsCsCsFF) + group(CsCsCsFH) + group(CsCsFHH) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[CH]C1([C](F)F)C(F)C1F(7819)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.410819,0.0849006,-9.88725e-05,5.95307e-08,-1.45933e-11,-70531.1,27.7738], Tmin=(100,'K'), Tmax=(979.031,'K')), NASAPolynomial(coeffs=[13.5954,0.0310326,-1.63393e-05,3.32986e-09,-2.42096e-13,-73112.7,-35.5546], Tmin=(979.031,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-587.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(CsCsCsFH) + group(CsCsCsFH) + group(CsCsFHH) + group(CsCsFFH) + ring(Cs(C)-Cs-Cs(F)) + radical(CsCsF1sH) + radical(CsCsF1sF1s) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
species(
    label = 'F[CH]C(F)=C(CF)[C](F)F(7821)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[CH]C=C([C](F)F)C(F)F(7822)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-642.875,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,235,523,627,1123,1142,1372,1406,3097,350,440,435,1725,194,682,905,1196,1383,3221,283.252,284.635,285.104,285.121,1724.33],'cm^-1')),
        HinderedRotor(inertia=(0.122846,'amu*angstrom^2'), symmetry=1, barrier=(7.0985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123349,'amu*angstrom^2'), symmetry=1, barrier=(7.09038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.544955,'amu*angstrom^2'), symmetry=1, barrier=(31.7033,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.151899,0.100235,-0.000161531,1.4104e-07,-4.92965e-11,-77179,29.7313], Tmin=(100,'K'), Tmax=(769.075,'K')), NASAPolynomial(coeffs=[10.8415,0.0350478,-1.87692e-05,3.74694e-09,-2.65226e-13,-78633.1,-18.879], Tmin=(769.075,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-642.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(CsCCl_triplet)"""),
)

species(
    label = 'F[C]=C(C(F)F)C(F)[CH]F(7824)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.160062,'amu*angstrom^2'), symmetry=1, barrier=(3.68013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160778,'amu*angstrom^2'), symmetry=1, barrier=(3.69661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.966354,'amu*angstrom^2'), symmetry=1, barrier=(22.2184,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.434371,0.108064,-0.000183895,1.63184e-07,-5.65223e-11,-68549.4,32.7757], Tmin=(100,'K'), Tmax=(817.076,'K')), NASAPolynomial(coeffs=[11.4037,0.0339016,-1.79881e-05,3.53819e-09,-2.46784e-13,-69942.8,-18.6333], Tmin=(817.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-571.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Csj(Cs-F1sCdH)(F1s)(H)) + radical(Cdj(Cd-CsCs)(F1s))"""),
)
...
species(
    label = 'F[CH]C(F)=C([CH]F)C(F)F(7827)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.208435,0.0908717,-0.000125451,9.43669e-08,-2.89701e-11,-86710.6,30.413], Tmin=(100,'K'), Tmax=(790.635,'K')), NASAPolynomial(coeffs=[11.427,0.0341117,-1.77605e-05,3.55717e-09,-2.54552e-13,-88484.4,-21.0742], Tmin=(790.635,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-722.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(CsCFHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cds-CdsCsCs) + group(CdCsCdF) + radical(Csj(Cd-CsCd)(F1s)(H)) + radical(Csj(Cd-CdF1s)(F1s)(H))"""),
)

species(
    label = 'F[C]C(=C(F)F)C(F)CF(7828)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-627.619,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,528,1116,1182,1331,1402,1494,3075,3110,350,440,435,1725,182,240,577,636,1210,1413,311.252,311.252,311.252,311.253,1388.16],'cm^-1')),
        HinderedRotor(inertia=(0.107826,'amu*angstrom^2'), symmetry=1, barrier=(7.41266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107826,'amu*angstrom^2'), symmetry=1, barrier=(7.41266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.486412,'amu*angstrom^2'), symmetry=1, barrier=(33.439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0542837,0.0981381,-0.000157327,1.38462e-07,-4.89713e-11,-75347.7,29.5029], Tmin=(100,'K'), Tmax=(764.692,'K')), NASAPolynomial(coeffs=[10.1657,0.0362694,-1.94716e-05,3.8961e-09,-2.76329e-13,-76664.9,-15.4529], Tmin=(764.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-627.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]C(=C(F)F)C(F)C(F)F(7829)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0665318,0.0937341,-0.000121853,8.91162e-08,-2.69537e-11,-80242.2,29.8194], Tmin=(100,'K'), Tmax=(798.705,'K')), NASAPolynomial(coeffs=[10.9213,0.0393699,-1.97499e-05,3.88885e-09,-2.7584e-13,-81976,-20.1083], Tmin=(798.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-668.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C(F)[CH]F)C(F)(F)F(7830)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.267229,'amu*angstrom^2'), symmetry=1, barrier=(6.14412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266646,'amu*angstrom^2'), symmetry=1, barrier=(6.13072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11218,'amu*angstrom^2'), symmetry=1, barrier=(25.5712,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.133192,0.100002,-0.000148348,1.10284e-07,-3.03003e-11,-75804.6,30.3942], Tmin=(100,'K'), Tmax=(647.496,'K')), NASAPolynomial(coeffs=[13.0907,0.0305671,-1.58914e-05,3.14354e-09,-2.21911e-13,-77774,-29.64], Tmin=(647.496,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-631.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCdFFF) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sCdH)(F1s)(H)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
...
reaction(
    label = 'reaction3',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    products = ['F[CH]C=C([CH]F)C(F)(F)F(7815)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', 'F[CH]C([CH]F)=C(F)F(7679)'],
    products = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    products = ['FC=C(F)C(CF)=C(F)F(7816)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    products = ['F[CH]C(F)[C]1C(F)C1(F)F(7817)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    products = ['F[CH][C]1C(F)C(F)C1(F)F(7818)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    products = ['F[CH]C1([C](F)F)C(F)C1F(7819)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(5.86885e+09,'s^-1'), n=0.611527, Ea=(70.977,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 70.0 to 71.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[CH]C(C=CF)=C(F)F(7629)'],
    products = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[CH]C(C(F)=CF)=C(F)F(7820)'],
    products = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[CH]C([CH]F)=C(F)F(7679)'],
    products = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    products = ['F[CH]C(F)=C(CF)[C](F)F(7821)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    products = ['F[CH]C=C([C](F)F)C(F)F(7822)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]C(=CF)C(F)C(F)F(7823)'],
    products = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C]=C(C(F)F)C(F)[CH]F(7824)'],
    products = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[C]F(744)', 'F[CH]C(F)[C]=CF(1978)'],
    products = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    products = ['FC=C(F)C(=CF)C(F)F(7825)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    products = ['F[C](F)[C]1C(F)C(F)C1F(7826)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CF2(43)', 'F[CH]C(F)[C]=CF(1978)'],
    products = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
...
reaction(
    label = 'reaction30',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    products = ['F[CH]C(F)=C([CH]F)C(F)F(7827)'],
...
reaction(
    label = 'reaction31',
    reactants = ['F[C]C(=C(F)F)C(F)CF(7828)'],
    products = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
...
reaction(
    label = 'reaction32',
    reactants = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
    products = ['[CH]C(=C(F)F)C(F)C(F)F(7829)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]=C(C(F)[CH]F)C(F)(F)F(7830)'],
    products = ['F[CH]C(=C(F)F)C(F)[CH]F(7495)'],
...
network(
    label = 'PDepNetwork #2752',
    isomers = [
        'F[CH]C(=C(F)F)C(F)[CH]F(7495)',
    ],
    reactants = [
