...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])=O(296)'],
    products = ['[O]CC([O])=O(3159)'],
    transitionState = 'TS2',
