...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.435798,'amu*angstrom^2'), symmetry=1, barrier=(10.0199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435914,'amu*angstrom^2'), symmetry=1, barrier=(10.0225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78414,'amu*angstrom^2'), symmetry=1, barrier=(41.0209,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.96999,0.0725893,-0.000101602,7.7505e-08,-2.40887e-11,-4927.86,27.5022], Tmin=(100,'K'), Tmax=(781.836,'K')), NASAPolynomial(coeffs=[9.89496,0.0269264,-1.39929e-05,2.79894e-09,-2.00032e-13,-6323.39,-13.3589], Tmin=(781.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-41.8347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.382134,0.0685126,-5.97837e-05,1.38664e-08,3.2858e-12,-58509.5,25.3293], Tmin=(100,'K'), Tmax=(969.122,'K')), NASAPolynomial(coeffs=[21.4535,0.00630188,-1.81798e-06,3.54471e-10,-2.93395e-14,-63756.4,-81.6659], Tmin=(969.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-487.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsOsH) + group(COCsFO) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33823,0.0513779,-3.57551e-05,6.64841e-09,2.00308e-12,-29246.6,19.8655], Tmin=(100,'K'), Tmax=(1006.26,'K')), NASAPolynomial(coeffs=[13.3275,0.0177575,-6.56509e-06,1.17395e-09,-8.1388e-14,-32370.2,-41.5824], Tmin=(1006.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCCFH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(34dihydro12dioxin) + radical(CsCsF1sO2s) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[CH]C1(F)C=COO1(10962)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.748104,0.0627783,-5.88497e-05,2.61474e-08,-4.51175e-12,-32056.2,23.5396], Tmin=(100,'K'), Tmax=(1409.62,'K')), NASAPolynomial(coeffs=[18.2295,0.0131722,-6.0628e-06,1.18224e-09,-8.40917e-14,-36984.6,-66.7996], Tmin=(1409.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-267.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCCFO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(12dioxolene) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (384.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,615,860,1140,1343,3152,1685,370,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.11662,'amu*angstrom^2'), symmetry=1, barrier=(25.6733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11675,'amu*angstrom^2'), symmetry=1, barrier=(25.6764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11664,'amu*angstrom^2'), symmetry=1, barrier=(25.6737,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36924,0.0609847,-7.28051e-05,4.4789e-08,-1.10878e-11,46302.9,24.763], Tmin=(100,'K'), Tmax=(977.089,'K')), NASAPolynomial(coeffs=[11.3418,0.0201582,-1.01282e-05,2.0238e-09,-1.45619e-13,44354.1,-23.1176], Tmin=(977.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(384.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sH)(O2s-O2s)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COOC(=[CH])F(10964)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (387.487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,293,496,537,1218,3115,3125,620,680,785,800,1600,1700],'cm^-1')),
        HinderedRotor(inertia=(0.597279,'amu*angstrom^2'), symmetry=1, barrier=(13.7326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.597607,'amu*angstrom^2'), symmetry=1, barrier=(13.7402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67293,'amu*angstrom^2'), symmetry=1, barrier=(38.4639,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29834,0.0639896,-8.47471e-05,5.90296e-08,-1.65844e-11,46697.2,25.6654], Tmin=(100,'K'), Tmax=(864.788,'K')), NASAPolynomial(coeffs=[10.4851,0.0214971,-1.10424e-05,2.21035e-09,-1.58549e-13,45108.3,-17.3206], Tmin=(864.788,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    E0 = (227.713,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,293,496,537,1218,3120,650,792.5,1650,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(0.267935,'amu*angstrom^2'), symmetry=1, barrier=(6.16035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167235,'amu*angstrom^2'), symmetry=1, barrier=(3.84505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.99404,'amu*angstrom^2'), symmetry=1, barrier=(45.8469,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.838134,0.0766577,-0.000126796,1.1194e-07,-3.91889e-11,27494.5,28.9966], Tmin=(100,'K'), Tmax=(786.206,'K')), NASAPolynomial(coeffs=[9.1934,0.0258264,-1.39373e-05,2.77766e-09,-1.95969e-13,26437.9,-7.66726], Tmin=(786.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cds_P) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    E0 = (441.993,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2175,525,239,401,1367],'cm^-1')),
        HinderedRotor(inertia=(1.17718,'amu*angstrom^2'), symmetry=1, barrier=(27.0657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17812,'amu*angstrom^2'), symmetry=1, barrier=(27.0872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17765,'amu*angstrom^2'), symmetry=1, barrier=(27.0764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4559,0.0600853,-7.84855e-05,5.21693e-08,-1.38853e-11,53247.6,23.5088], Tmin=(100,'K'), Tmax=(912.893,'K')), NASAPolynomial(coeffs=[10.999,0.0182707,-9.77895e-06,1.99446e-09,-1.44744e-13,51505.2,-21.6614], Tmin=(912.893,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsCt) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(CtCF) + radical(Cds_P)"""),
)

species(
    label = 'C=[C]OOC(F)=CF(10237)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.209525,'amu*angstrom^2'), symmetry=1, barrier=(4.8174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206798,'amu*angstrom^2'), symmetry=1, barrier=(4.7547,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06393,0.0733391,-0.000122065,1.14562e-07,-4.22958e-11,-5818.58,29.8729], Tmin=(100,'K'), Tmax=(807.808,'K')), NASAPolynomial(coeffs=[5.91677,0.0331482,-1.74261e-05,3.43962e-09,-2.4126e-13,-6075.31,10.7603], Tmin=(807.808,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.1867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C=COOC(F)=[C]F(10492)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-19.3836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,293,496,537,1218,2950,3100,1380,975,1025,1650,167,640,1190,180,889.881],'cm^-1')),
        HinderedRotor(inertia=(0.264092,'amu*angstrom^2'), symmetry=1, barrier=(6.072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265637,'amu*angstrom^2'), symmetry=1, barrier=(6.10753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.00351,'amu*angstrom^2'), symmetry=1, barrier=(46.0647,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21143,0.0688807,-9.09598e-05,6.10122e-08,-1.33078e-11,-2238.03,27.295], Tmin=(100,'K'), Tmax=(593.374,'K')), NASAPolynomial(coeffs=[8.44077,0.0295965,-1.55408e-05,3.11617e-09,-2.22762e-13,-3262.33,-5.21095], Tmin=(593.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.3836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)

species(
    label = 'FC=[C]OOC=CF(10966)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-27.8759,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,615,860,1140,1343,3152,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.77844,'amu*angstrom^2'), symmetry=1, barrier=(40.8899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7807,'amu*angstrom^2'), symmetry=1, barrier=(40.9418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1903,'amu*angstrom^2'), symmetry=1, barrier=(4.37537,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09625,0.0703013,-9.79116e-05,7.81347e-08,-2.59806e-11,-3254.09,26.8016], Tmin=(100,'K'), Tmax=(726.732,'K')), NASAPolynomial(coeffs=[8.279,0.0307695,-1.6322e-05,3.29368e-09,-2.36571e-13,-4298.15,-5.55876], Tmin=(726.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.8759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOC=CF(10967)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-24.6064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,293,496,537,1218,194,682,905,1196,1383,3221,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.266002,'amu*angstrom^2'), symmetry=1, barrier=(6.11592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157265,'amu*angstrom^2'), symmetry=1, barrier=(3.61582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.06299,'amu*angstrom^2'), symmetry=1, barrier=(47.4322,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52395,0.0650782,-6.45786e-05,-7.38743e-09,4.39872e-11,-2881.12,26.0363], Tmin=(100,'K'), Tmax=(489.731,'K')), NASAPolynomial(coeffs=[7.8942,0.0312497,-1.67169e-05,3.35324e-09,-2.38695e-13,-3723.34,-2.3773], Tmin=(489.731,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.6064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=COOC(F)=CF(9975)'],
    products = ['HCCO(21)', 'O=C(F)CF(476)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(16.0981,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[CH]=COOC(F)=CF(9975)'],
    products = ['[CH]=COC(F)C(=O)F(10959)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[C]=COOC(F)=CF(10960)'],
    products = ['[CH]=COOC(F)=CF(9975)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=COOC(F)=CF(9975)'],
    products = ['O=C(F)[CH]F(980)', 'C1=CO1(450)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=COOC(F)=CF(9975)'],
    products = ['F[CH]C1(F)C=COO1(10962)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=COO[C]=CF(10963)'],
    products = ['[CH]=COOC(F)=CF(9975)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=COOC(=[CH])F(10964)'],
    products = ['[CH]=COOC(F)=CF(9975)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C(F)[CH]F(980)', '[CH]=C[O](134)'],
    products = ['[CH]=COOC(F)=CF(9975)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(249.668,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C
Ea raised from 246.2 to 249.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction12',
    reactants = ['CHFCF[Z](72)', '[CH]=CO[O](192)'],
    products = ['[CH]=COOC(F)=CF(9975)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC(F)=CF(979)', '[CH]=[CH](257)'],
    products = ['[CH]=COOC(F)=CF(9975)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', '[CH]=COOC#C(1213)'],
    products = ['[CH]=COOC(F)=CF(9975)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[CH]=COOC#CF(7198)'],
    products = ['[CH]=COOC(F)=CF(9975)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=COOC(F)=[C]F(10492)'],
    products = ['[CH]=COOC(F)=CF(9975)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(26171.5,'s^-1'), n=1.78967, Ea=(62.3074,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H_RSSSR;Y_rad_out;XH_out] for rate rule [R6H_DSSSD;Cd_rad_out_single;Cd_H_out_singleH]
...
reaction(
    label = 'reaction20',
    reactants = ['FC=[C]OOC=CF(10966)'],
    products = ['[CH]=COOC(F)=CF(9975)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(191.461,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(F)OOC=CF(10967)'],
    products = ['[CH]=COOC(F)=CF(9975)'],
