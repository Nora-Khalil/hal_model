...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH]C=CF(263)'],
    products = ['[CH]=CC(F)[C](F)F(6530)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=CC=C(F)F(809)'],
    products = ['[CH]=CC(F)[C](F)F(6530)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=CC(F)=C(F)F(6533)'],
    products = ['[CH]=CC(F)[C](F)F(6530)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC(F)[C](F)F(6427)'],
    products = ['[CH]=CC(F)[C](F)F(6530)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C[C](F)F(1989)'],
    products = ['[CH]=CC(F)[C](F)F(6530)'],
