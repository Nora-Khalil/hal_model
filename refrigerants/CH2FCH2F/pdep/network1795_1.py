...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(161)', 'CH2OH(33)'],
    products = ['O=C(F)OCO(4078)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]OC(=O)F(1888)'],
    products = ['O=C(F)OCO(4078)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[CH]O(4480)'],
    products = ['O=C(F)OCO(4078)'],
