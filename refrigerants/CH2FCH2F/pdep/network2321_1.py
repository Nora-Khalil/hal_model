...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=CC(F)(F)[CH]F(5622)'],
    products = ['[O]CC(F)(F)[CH]F(6237)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[CH]C(F)(F)[CH]F(6252)'],
    products = ['[O]CC(F)(F)[CH]F(6237)'],
