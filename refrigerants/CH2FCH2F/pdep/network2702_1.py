...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1054)', '[CH]C=C(F)F(6536)'],
    products = ['[CH]=CC(F)(F)[C]=CF(7448)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=CC(F)=C=CF(8221)'],
    products = ['[CH]=CC(F)(F)[C]=CF(7448)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#CC(F)(F)[C]=CF(8149)'],
    products = ['[CH]=CC(F)(F)[C]=CF(7448)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=CC(F)(F)C#C(8222)'],
    products = ['[CH]=CC(F)(F)[C]=CF(7448)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]=CC(F)(F)C#CF(8223)'],
    products = ['[CH]=CC(F)(F)[C]=CF(7448)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C(F)[C]=CF(8152)'],
    products = ['[CH]=CC(F)(F)[C]=CF(7448)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC(F)(F)C=[C]F(8224)'],
    products = ['[CH]=CC(F)(F)[C]=CF(7448)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C]C(F)(F)C=CF(8225)'],
    products = ['[CH]=CC(F)(F)[C]=CF(7448)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=CC(F)(F)C(=[CH])F(8228)'],
    products = ['[CH]=CC(F)(F)[C]=CF(7448)'],
