...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC(F)[C](F)F(6323)'],
...
reaction(
    ...
    products = ['F[C](F)OC(F)[C](F)F(6323)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C](F)OC=C(F)F(1815)'],
    products = ['F[C](F)OC(F)[C](F)F(6323)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C](F)OC(F)=C(F)F(6416)'],
    products = ['F[C](F)OC(F)[C](F)F(6323)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['F[C](F)OC(F)[C](F)F(6323)'],
    products = ['F[C](F)O[C](F)C(F)F(6417)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)OC(F)[C](F)F(6323)'],
    products = ['F[C](F)O[CH]C(F)(F)F(2846)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)OC(F)[C](F)F(6323)'],
    products = ['F[C](F)[CH]OC(F)(F)F(6419)'],
