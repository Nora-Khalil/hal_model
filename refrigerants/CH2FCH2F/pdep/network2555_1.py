...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.441174,'amu*angstrom^2'), symmetry=1, barrier=(10.1435,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439865,'amu*angstrom^2'), symmetry=1, barrier=(10.1134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.441072,'amu*angstrom^2'), symmetry=1, barrier=(10.1411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.681071,'amu*angstrom^2'), symmetry=1, barrier=(15.6592,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (165.039,'amu'),
...
reaction(
    ...
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)C(OF)[C](F)F(5578)'],
    products = ['OC(F)(F)C(F)(F)[CH]OF(6957)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)(F)C([C]F)OF-2(6958)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(744)', 'OC(F)(F)[CH]OF(3656)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(127)', 'OC(F)(F)C=C(F)F(2209)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O[C](F)F(1777)', 'FOC=C(F)F(1650)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'OC(F)(F)C(OF)=C(F)F(6959)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[C](F)C(OF)[C](F)F(6960)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'OC(F)(F)[CH][C](F)F(2213)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'FOC([C](F)F)[C](F)F(6772)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)(F)C(OF)[C](F)F(3037)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O[C](F)F(1777)', 'FO[CH][C](F)F(1648)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)(F)[C](OF)[C](F)F(6961)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=C(F)C(OF)[C](F)F(6962)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'OC(F)=C(OF)[C](F)F(6964)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', 'OC(F)(F)C([C]F)OF(5568)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CF2(43)', 'OC(F)(F)[CH]OF(3656)'],
    products = ['OC(F)(F)C(OF)[C](F)F(5578)'],
...
reaction(
    label = 'reaction22',
    reactants = ['OC(F)(F)C(OF)[C](F)F(5578)'],
    products = ['OC(F)(F)[C](OF)C(F)F(5577)'],
...
reaction(
    label = 'reaction25',
    reactants = ['OC(F)(F)C(OF)[C](F)F(5578)'],
    products = ['O[C](F)C(OF)C(F)(F)F(6965)'],
