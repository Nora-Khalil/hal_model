...
"""),
    E0 = (-715.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,391,562,707,872,1109,1210,1289,3137,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.622201,'amu*angstrom^2'), symmetry=1, barrier=(14.3056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.620644,'amu*angstrom^2'), symmetry=1, barrier=(14.2698,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'F[C]C(F)OF(1513)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(140)', 'CC(F)(F)[C]F(3100)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(25)', 'FOC(F)C(F)F(3101)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(1520)', 'CC(F)=CF(1518)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(F)OF(1525)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)[CH]OF(3103)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC(F)(F)C([O])F(1869)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(127)', 'CC(F)(F)[CH]F(3104)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(1060)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'FOC(F)[C](F)F(3105)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC(F)(F)[C](F)OF(3106)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)OF(3107)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(78)', 'CC(F)(F)C=O(951)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'CC(F)(F)C(=O)F(1164)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=C(F)C(F)OF(3108)'],
    products = ['CC(F)(F)C(F)OF(3092)'],
