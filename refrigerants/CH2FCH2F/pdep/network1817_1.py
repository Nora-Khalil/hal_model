...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=CCOF(3738)'],
    products = ['O=CCCOF(4100)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(127)', '[CH2]CC=O(2076)'],
    products = ['O=CCCOF(4100)'],
