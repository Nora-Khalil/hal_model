...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]=C[O](134)'],
    products = ['O=C[CH]F(435)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C[CH]F(435)'],
    products = ['FC1[CH]O1(1206)'],
    transitionState = 'TS4',
