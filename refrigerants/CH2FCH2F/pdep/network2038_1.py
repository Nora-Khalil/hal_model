...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)C(F)F(1799)'],
    products = ['F[C](F)CC(F)F(1800)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]CC(F)F-2(5380)'],
    products = ['F[C](F)CC(F)F(1800)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(744)', 'CHF2-CH2(64)'],
    products = ['F[C](F)CC(F)F(1800)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC(F)=CC(F)F(1802)'],
    products = ['F[C](F)CC(F)F(1800)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C[C](F)F(754)'],
    products = ['F[C](F)CC(F)F(1800)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(82)', '[CH2][C](F)F(507)'],
    products = ['F[C](F)CC(F)F(1800)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)[CH]C(F)F(5381)'],
    products = ['F[C](F)CC(F)F(1800)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)C[C](F)F(795)'],
    products = ['F[C](F)CC(F)F(1800)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[C]CC(F)F(1829)'],
    products = ['F[C](F)CC(F)F(1800)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)CC(F)F(1800)'],
    products = ['F[CH]CC(F)(F)F(1795)'],
