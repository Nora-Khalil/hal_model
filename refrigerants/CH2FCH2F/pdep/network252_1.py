...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(513)', '[C]=C(368)'],
    products = ['C=[C]OO[C]=O(568)'],
    transitionState = 'TS2',
