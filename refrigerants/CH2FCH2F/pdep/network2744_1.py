...
species(
    label = '[CH2]C(F)(F)C(F)[C]=C(F)F(7488)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH2]C(F)=C([CH]F)C(F)(F)F(7785)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0997553,'amu*angstrom^2'), symmetry=1, barrier=(2.29357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0991401,'amu*angstrom^2'), symmetry=1, barrier=(2.27943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13734,0.0690105,-0.000108041,9.3612e-08,-3.27755e-11,-43228.8,26.4276], Tmin=(100,'K'), Tmax=(746.776,'K')), NASAPolynomial(coeffs=[8.60791,0.0254288,-1.33374e-05,2.67195e-09,-1.90177e-13,-44245.1,-6.76632], Tmin=(746.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sF1s))"""),
)

species(
    label = 'FC(F)=C1C(F)CC1(F)F(7711)',
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06804,0.0727645,-7.92327e-05,4.96035e-08,-1.35515e-11,-108690,21.444], Tmin=(100,'K'), Tmax=(854.99,'K')), NASAPolynomial(coeffs=[8.13958,0.0396798,-2.11869e-05,4.34172e-09,-3.16455e-13,-109899,-11.5641], Tmin=(854.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-904.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCCFF) + group(Cds-CdsCsCs) + group(CdCFF) + ring(methylenecyclobutane)"""),
)

species(
    label = '[CH2]C(F)(F)[C]1C(F)C1(F)F(7788)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'F[CH][C]1C(F)(F)CC1(F)F(7789)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437269,0.087271,-0.000135294,1.23513e-07,-4.58853e-11,-85727.7,27.7852], Tmin=(100,'K'), Tmax=(764.028,'K')), NASAPolynomial(coeffs=[6.99053,0.0412127,-2.18017e-05,4.35549e-09,-3.09251e-13,-86386.2,0.177529], Tmin=(764.028,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-713.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFF) + group(CsCsCsFF) + group(Cs-CsCsHH) + group(CsCsFHH) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(H))"""),
)
...
species(
    label = '[CH2]C(F)=C([C](F)F)C(F)F(7791)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.254607,0.0901446,-0.000122817,9.14623e-08,-2.79246e-11,-89807.7,31.4009], Tmin=(100,'K'), Tmax=(793.196,'K')), NASAPolynomial(coeffs=[11.2016,0.0349385,-1.84156e-05,3.71233e-09,-2.66809e-13,-91544.3,-18.8757], Tmin=(793.196,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-747.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(CsCFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + radical(Csj(Cd-CsCd)(F1s)(F1s)) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)

species(
    label = 'F[C]C(=CF)C(F)(F)CF(7792)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-648.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,528,1116,1182,1331,1402,1494,3075,3110,350,440,435,1725,194,682,905,1196,1383,3221,285.167,285.635,286.443,286.707,1652.6],'cm^-1')),
        HinderedRotor(inertia=(0.145623,'amu*angstrom^2'), symmetry=1, barrier=(8.46489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146663,'amu*angstrom^2'), symmetry=1, barrier=(8.45657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.498998,'amu*angstrom^2'), symmetry=1, barrier=(28.8492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.219821,0.101728,-0.000164569,1.4308e-07,-4.96779e-11,-77891.6,29.2761], Tmin=(100,'K'), Tmax=(771.532,'K')), NASAPolynomial(coeffs=[11.2753,0.0343345,-1.83845e-05,3.66676e-09,-2.59301e-13,-79433.3,-21.6958], Tmin=(771.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-648.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH2]C(F)(F)C(=[C]F)C(F)F(7793)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.271431,'amu*angstrom^2'), symmetry=1, barrier=(6.24073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273292,'amu*angstrom^2'), symmetry=1, barrier=(6.28351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271889,'amu*angstrom^2'), symmetry=1, barrier=(6.25126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.44332,0.109367,-0.000190112,1.72303e-07,-6.07675e-11,-72866.6,31.9553], Tmin=(100,'K'), Tmax=(815.695,'K')), NASAPolynomial(coeffs=[10.6348,0.0357889,-1.94042e-05,3.84702e-09,-2.69391e-13,-74033.4,-15.3073], Tmin=(815.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-607.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cdj(Cd-CsCs)(F1s))"""),
)
...
species(
    label = 'F[C](F)[C]1C(F)CC1(F)F(7794)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-680.907,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,182,240,577,636,1210,1413,229.052,229.466,229.572,1038.85],'cm^-1')),
        HinderedRotor(inertia=(0.187438,'amu*angstrom^2'), symmetry=1, barrier=(7.01822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00916373,'amu*angstrom^2'), symmetry=1, barrier=(7.01558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187177,'amu*angstrom^2'), symmetry=1, barrier=(7.01521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.148046,0.100882,-0.000166268,1.47991e-07,-5.23085e-11,-81754.1,28.618], Tmin=(100,'K'), Tmax=(786.305,'K')), NASAPolynomial(coeffs=[10.2553,0.0358924,-1.92687e-05,3.8393e-09,-2.70985e-13,-83017.1,-16.6988], Tmin=(786.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-680.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]C(=C(F)F)C(F)(F)CF(7796)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.604535,'amu*angstrom^2'), symmetry=1, barrier=(51.4284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.604536,'amu*angstrom^2'), symmetry=1, barrier=(51.4284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.604536,'amu*angstrom^2'), symmetry=1, barrier=(51.4284,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00757991,0.0953137,-0.000125262,9.1763e-08,-2.76625e-11,-80954.5,29.3855], Tmin=(100,'K'), Tmax=(802.706,'K')), NASAPolynomial(coeffs=[11.3672,0.0386339,-1.93511e-05,3.80518e-09,-2.69614e-13,-82780.7,-22.9922], Tmin=(802.706,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-674.24,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C([CH2])(F)F)C(F)(F)F(7797)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.350996,'amu*angstrom^2'), symmetry=1, barrier=(8.0701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.349789,'amu*angstrom^2'), symmetry=1, barrier=(8.04234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.35067,'amu*angstrom^2'), symmetry=1, barrier=(8.06259,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0345616,0.0985168,-0.000140229,9.04534e-08,-1.47291e-11,-80129.4,28.9774], Tmin=(100,'K'), Tmax=(585.009,'K')), NASAPolynomial(coeffs=[12.3651,0.0323842,-1.72686e-05,3.44352e-09,-2.43806e-13,-81883.1,-26.5581], Tmin=(585.009,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-667.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCdFFF) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C(F)[C]=C(F)F(7488)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    products = ['[CH2]C(F)=C([CH]F)C(F)(F)F(7785)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[CH]C([C](F)F)=C(F)F(7786)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(223)', '[CH2]C(F)(F)[C]=C(F)F(7787)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    products = ['FC(F)=C1C(F)CC1(F)F(7711)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    products = ['[CH2]C(F)(F)[C]1C(F)C1(F)F(7788)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    products = ['F[CH][C]1C(F)(F)CC1(F)F(7789)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C([CH]F)=C(F)F(7684)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C(F)(F)[C]=C(F)F(7787)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    products = ['F[CH]C([C](F)CF)=C(F)F(7790)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    products = ['[CH2]C(F)=C([C](F)F)C(F)F(7791)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]C(=CF)C(F)(F)CF(7792)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)C(=[C]F)C(F)F(7793)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C]F(744)', '[CH2]C(F)(F)[C]=CF(1994)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    products = ['FC=C1C(F)(F)CC1(F)F(7696)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    products = ['F[C](F)[C]1C(F)CC1(F)F(7794)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CF2(43)', '[CH2]C(F)(F)[C]=CF(1994)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC(F)(F)C([C]F)=C(F)F(7795)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]C(=C(F)F)C(F)(F)CF(7796)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=C(C([CH2])(F)F)C(F)(F)F(7797)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
...
network(
    label = 'PDepNetwork #2744',
    isomers = [
        '[CH2]C(F)(F)C([CH]F)=C(F)F(7487)',
    ],
    reactants = [
