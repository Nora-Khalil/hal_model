...
species(
    label = 'O=C(F)C(F)OC[C](F)F(10901)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['FC=C(F)OOC[C](F)F(10721)'],
    products = ['O=C[C](F)F(787)', 'O=C(F)CF(476)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['FC=C(F)OOC[C](F)F(10721)'],
    products = ['O=C(F)C(F)OC[C](F)F(10901)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'F[C]COOC(F)=CF-2(10902)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', '[CH2]OOC(F)=CF(10297)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FC=C(F)OOC[C](F)F(10721)'],
    products = ['O=C(F)[CH]F(980)', 'FC1(F)CO1(783)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FC=C(F)OOC[C](F)F(10721)'],
    products = ['F[C]1OOCC(F)(F)C1F(10903)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FC=C(F)OOC[C](F)F(10721)'],
    products = ['F[CH]C1(F)OOCC1(F)F(10904)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]OC(F)=CF(979)', 'CH2CF2(57)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=[C]OOC[C](F)F(10905)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(F)OOC[C](F)F(10906)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C(F)[CH]F(980)', '[O]C[C](F)F(518)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC(F)=CF(979)', '[CH2][C](F)F(507)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHFCF[Z](72)', '[O]OC[C](F)F(699)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'F[C]=C(F)OOC[C](F)F(10907)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'C#COOC[C](F)F(1725)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', 'F[C]COOC(F)=CF(10715)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CF2(43)', '[CH2]OOC(F)=CF(10297)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]=C(F)OOCC(F)F(10722)'],
    products = ['FC=C(F)OOC[C](F)F(10721)'],
...
reaction(
    label = 'reaction23',
    reactants = ['FC=C(F)OOC[C](F)F(10721)'],
    products = ['FC=[C]OOCC(F)(F)F(10908)'],
...
reaction(
    label = 'reaction24',
    reactants = ['FC=C(F)OOC[C](F)F(10721)'],
    products = ['[CH]=C(F)OOCC(F)(F)F(10909)'],
...
network(
    ...
    isomers = [
        'FC=C(F)OOC[C](F)F(10721)',
    ],
    reactants = [
        ('O=C[C](F)F(787)', 'O=C(F)CF(476)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
