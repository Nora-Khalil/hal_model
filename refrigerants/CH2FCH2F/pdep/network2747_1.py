species(
    label = 'F[CH]C(C[C](F)F)=C(F)F(7490)',
...
species(
    label = '[CH2]C(F)(F)C([CH]F)=C(F)F(7487)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-375.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,562,600,623,1070,1265,1685,370,180,180,1194.41],'cm^-1')),
        HinderedRotor(inertia=(0.145346,'amu*angstrom^2'), symmetry=1, barrier=(3.34179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145977,'amu*angstrom^2'), symmetry=1, barrier=(3.35631,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64716,0.0575535,-7.45757e-05,5.63233e-08,-1.79958e-11,-45068.3,26.0924], Tmin=(100,'K'), Tmax=(750.194,'K')), NASAPolynomial(coeffs=[7.28019,0.0275201,-1.4528e-05,2.9645e-09,-2.15108e-13,-45913.5,0.534964], Tmin=(750.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-375.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cdj(Cs-CsHH)(Cd-F1sF1s))"""),
)

species(
    label = 'FC(F)=C1CC(F)(F)C1F(7728)',
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.314696,0.0842758,-0.000100419,6.14803e-08,-1.50577e-11,-108694,27.2079], Tmin=(100,'K'), Tmax=(990.695,'K')), NASAPolynomial(coeffs=[14.6458,0.0264128,-1.2809e-05,2.52525e-09,-1.80508e-13,-111533,-41.7976], Tmin=(990.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-904.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + group(CdCFF)"""),
)

species(
    label = 'F[C](F)C[C]1C(F)C1(F)F(7730)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27871,0.0719476,-5.76547e-05,-3.5293e-08,6.80507e-11,-81511.3,26.3454], Tmin=(100,'K'), Tmax=(479.224,'K')), NASAPolynomial(coeffs=[7.77278,0.0388139,-1.98988e-05,3.93495e-09,-2.78283e-13,-82375.7,-2.73232], Tmin=(479.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-678.435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFF) + group(CsCsCsFF) + group(CsCsFHH) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(H)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2)"""),
)

species(
    label = 'F[CH]C1([C](F)F)CC1(F)F(7732)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.359375,0.0846097,-9.61581e-05,5.55817e-08,-1.29767e-11,-73313.9,28.4997], Tmin=(100,'K'), Tmax=(1029.54,'K')), NASAPolynomial(coeffs=[14.6895,0.0289339,-1.5041e-05,3.05547e-09,-2.21955e-13,-76264.6,-41.0522], Tmin=(1029.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-610.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-CsCsHH) + group(CsCsCsFF) + group(CsCsFHH) + group(CsCsFFH) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(CsCsF1sH) + radical(CsCsF1sF1s)"""),
)
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363946,0.0860405,-0.000113899,8.20596e-08,-2.40451e-11,-84779.8,29.5512], Tmin=(100,'K'), Tmax=(828.54,'K')), NASAPolynomial(coeffs=[11.5921,0.0318338,-1.57632e-05,3.09736e-09,-2.19578e-13,-86640.4,-22.5066], Tmin=(828.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-705.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCsFHH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFF) + radical(Allyl_T) + radical(CsCsF1sF1s)"""),
)

species(
    label = 'F[C]C(=CF)CC(F)(F)F(7736)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.187799,0.0911489,-0.000131022,1.0217e-07,-3.23079e-11,-85213.5,28.9884], Tmin=(100,'K'), Tmax=(770.318,'K')), NASAPolynomial(coeffs=[11.4791,0.0325162,-1.68486e-05,3.35817e-09,-2.39183e-13,-86953.1,-22.5392], Tmin=(770.318,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-709.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(CsCCl_triplet)"""),
)

species(
    label = 'F[C]=C(C[C](F)F)C(F)F(7737)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-599.956,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,190,488,555,1236,1407,167,640,1190,246.592,247.301,1836.26],'cm^-1')),
        HinderedRotor(inertia=(0.00275417,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3066,'amu*angstrom^2'), symmetry=1, barrier=(13.2015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.456888,'amu*angstrom^2'), symmetry=1, barrier=(19.9736,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.115484,0.0929001,-0.000134581,1.04999e-07,-3.31392e-11,-72025,32.5578], Tmin=(100,'K'), Tmax=(772.305,'K')), NASAPolynomial(coeffs=[11.82,0.0322791,-1.68422e-05,3.36493e-09,-2.3993e-13,-73832.9,-20.8858], Tmin=(772.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-599.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cdj(Cd-CsCs)(F1s))"""),
)

species(
    label = 'FC=[C]C(F)(F)C[C](F)F(7492)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.214946,'amu*angstrom^2'), symmetry=1, barrier=(4.94204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21419,'amu*angstrom^2'), symmetry=1, barrier=(4.92464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212168,'amu*angstrom^2'), symmetry=1, barrier=(4.87815,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.192983,0.103232,-0.000175923,1.60091e-07,-5.70865e-11,-73254.7,32.6261], Tmin=(100,'K'), Tmax=(807.521,'K')), NASAPolynomial(coeffs=[9.55458,0.037105,-1.99452e-05,3.95658e-09,-2.77761e-13,-74247.2,-8.71416], Tmin=(807.521,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-610.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFF) + group(CsCsFFH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH))"""),
)

species(
    label = 'FC=[C]C[C](F)F(1970)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.809254,0.0759666,-8.18539e-05,4.71888e-08,-1.13122e-11,-109610,23.4146], Tmin=(100,'K'), Tmax=(989.209,'K')), NASAPolynomial(coeffs=[11.4067,0.0331154,-1.68773e-05,3.39936e-09,-2.45673e-13,-111706,-27.597], Tmin=(989.209,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-912.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-(Cds-Cds)CsHH) + group(CsCCFF) + group(Cds-CdsCsCs) + group(CdCFH) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)2) + ring(methylenecyclobutane)"""),
)

species(
    label = 'FC=C(C=C(F)F)C(F)F(7739)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.283854,0.0846265,-0.000100672,6.12363e-08,-1.48662e-11,-110789,27.4252], Tmin=(100,'K'), Tmax=(1000.24,'K')), NASAPolynomial(coeffs=[14.9887,0.0258216,-1.2487e-05,2.4605e-09,-1.75893e-13,-113731,-43.5207], Tmin=(1000.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-922.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(CdCFF)"""),
)

species(
    label = 'F[C](F)[C]1CC(F)(F)C1F(7740)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.834924,0.0762654,-9.76468e-05,7.47437e-08,-2.42728e-11,-80910.8,29.1591], Tmin=(100,'K'), Tmax=(739.23,'K')), NASAPolynomial(coeffs=[8.00406,0.0374742,-1.89369e-05,3.76246e-09,-2.68487e-13,-81970.7,-3.26192], Tmin=(739.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-673.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCsCsFF) + group(CsCsFFH) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(F1s)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[CH]C(=C[C](F)F)C(F)F(7741)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.432325,0.0862124,-0.000115843,8.68128e-08,-2.69286e-11,-87423.5,31.0285], Tmin=(100,'K'), Tmax=(778.456,'K')), NASAPolynomial(coeffs=[10.2176,0.0359285,-1.89452e-05,3.82416e-09,-2.75158e-13,-88946.9,-13.7286], Tmin=(778.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-727.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(CsCFHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Csj(Cd-CsCd)(F1s)(H)) + radical(Csj(Cd-CdH)(F1s)(F1s))"""),
)

species(
    label = 'F[C]C(CC(F)F)=C(F)F(7742)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-663.666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,350,440,435,1725,182,240,577,636,1210,1413,313.897,313.916,313.917,313.924,313.927],'cm^-1')),
        HinderedRotor(inertia=(3.35426e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14113,'amu*angstrom^2'), symmetry=1, barrier=(9.86901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.443211,'amu*angstrom^2'), symmetry=1, barrier=(30.9948,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.233229,0.0921807,-0.000130255,9.36586e-08,-2.41077e-11,-79693.8,29.2465], Tmin=(100,'K'), Tmax=(618.443,'K')), NASAPolynomial(coeffs=[11.0754,0.0339442,-1.78421e-05,3.56439e-09,-2.53713e-13,-81262.2,-19.6887], Tmin=(618.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-663.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]C(CC(F)(F)F)=C(F)F(7743)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (158.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.315924,0.0859932,-9.74858e-05,6.05191e-08,-1.55145e-11,-88273,29.3832], Tmin=(100,'K'), Tmax=(935.248,'K')), NASAPolynomial(coeffs=[12.0027,0.0360093,-1.73185e-05,3.37351e-09,-2.3892e-13,-90459,-26.2162], Tmin=(935.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-735.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFF) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C[C](F)F)C(F)(F)F(7744)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['CH2CF2(57)', 'FC=C=C(F)F(5948)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['[CH2]C(F)(F)C([CH]F)=C(F)F(7487)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C](F)CC(F)[C]=C(F)F(7491)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', '[CH2]C([CH]F)=C(F)F(7622)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(223)', 'F[C](F)C[C]=C(F)F(7727)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['FC(F)=C1CC(F)(F)C1F(7728)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['FCC(C=C(F)F)=C(F)F(7729)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['F[C](F)C[C]1C(F)C1(F)F(7730)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['F[CH][C]1CC(F)(F)C1(F)F(7731)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['F[CH]C1([C](F)F)CC1(F)F(7732)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(5.86885e+09,'s^-1'), n=0.611527, Ea=(77.1442,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C([CH]F)=C(F)F(7622)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00976185,'m^3/(mol*s)'), n=2.64543, Ea=(7.27201,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'F[C](F)C[C]=C(F)F(7727)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['F[CH]C([CH]C(F)F)=C(F)F(7734)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['FC[C](C=C(F)F)[C](F)F(7735)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['F[C]C(=CF)CC(F)(F)F(7736)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.00110172,'s^-1'), n=4.50663, Ea=(231.341,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction20',
    reactants = ['F[C]=C(C[C](F)F)C(F)F(7737)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
...
reaction(
    label = 'reaction3',
    reactants = ['FC=[C]C(F)(F)C[C](F)F(7492)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]F(744)', 'FC=[C]C[C](F)F(1970)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['FC=C1CC(F)(F)C1(F)F(7738)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['FC=C(C=C(F)F)C(F)F(7739)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['F[C](F)[C]1CC(F)(F)C1F(7740)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CF2(43)', 'FC=[C]C[C](F)F(1970)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['F[CH]C(=C[C](F)F)C(F)F(7741)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[C]C(CC(F)F)=C(F)F(7742)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
...
reaction(
    label = 'reaction29',
    reactants = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
    products = ['[CH]C(CC(F)(F)F)=C(F)F(7743)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(0.000550858,'s^-1'), n=4.50663, Ea=(219.252,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction30',
    reactants = ['[CH]=C(C[C](F)F)C(F)(F)F(7744)'],
    products = ['F[CH]C(C[C](F)F)=C(F)F(7490)'],
...
network(
    ...
    isomers = [
        'F[CH]C(C[C](F)F)=C(F)F(7490)',
    ],
    reactants = [
        ('CH2CF2(57)', 'FC=C=C(F)F(5948)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
