...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(CF)=C(F)[CH]F(6388)'],
    products = ['C=C([O])C(F)(F)[CH]F(6296)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', '[CH2]C(=O)[C](F)F(869)'],
    products = ['C=C([O])C(F)(F)[CH]F(6296)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)(F)[CH]F(6389)'],
    products = ['C=C([O])C(F)(F)[CH]F(6296)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C([O])C(F)(F)[CH]F(6296)'],
    products = ['F[CH]C(F)(F)[C]1CO1(6390)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])C(F)(F)[CH]F(6296)'],
    products = ['[O][C]1CC(F)C1(F)F(6391)'],
    transitionState = 'TS8',
...
reaction(
    ...
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.17979e+10,'s^-1'), n=0.520585, Ea=(196.996,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C(F)=CF(1255)'],
    products = ['C=C([O])C(F)(F)[CH]F(6296)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C(=O)[C](F)F(869)'],
    products = ['C=C([O])C(F)(F)[CH]F(6296)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(O)C(F)(F)[CH]F(6392)'],
    products = ['C=C([O])C(F)(F)[CH]F(6296)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C([O])C(F)(F)CF(6393)'],
    products = ['C=C([O])C(F)(F)[CH]F(6296)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(OF)=C(F)[CH]F(6394)'],
    products = ['C=C([O])C(F)(F)[CH]F(6296)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(18)', 'O=[C]C(F)(F)[CH]F(6395)'],
    products = ['C=C([O])C(F)(F)[CH]F(6296)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([O])C(F)(F)[CH]F(6296)'],
    products = ['[CH2][C]1OC(F)C1(F)F(6396)'],
