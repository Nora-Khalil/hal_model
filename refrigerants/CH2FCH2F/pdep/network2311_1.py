...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)C[C](F)F(6114)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)CC(F)[C](F)F(6115)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', 'F[C](F)C[C](F)F(795)'],
    products = ['F[CH]C(F)(F)C[C](F)F(6114)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=C(F)C[C](F)F(913)'],
    products = ['F[CH]C(F)(F)C[C](F)F(6114)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH]C(F)(F)C=C(F)F(6174)'],
    products = ['F[CH]C(F)(F)C[C](F)F(6114)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', 'F[C](F)C[C](F)F(795)'],
    products = ['F[CH]C(F)(F)C[C](F)F(6114)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)[CH]C(F)F(6175)'],
    products = ['F[CH]C(F)(F)C[C](F)F(6114)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FCC(F)(F)[CH][C](F)F(6176)'],
    products = ['F[CH]C(F)(F)C[C](F)F(6114)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH]C(F)(F)C[C](F)F(6114)'],
    products = ['F[C](F)C[C](F)C(F)F(6169)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C[C](F)F(6114)'],
    products = ['F[CH][C](F)CC(F)(F)F(6177)'],
