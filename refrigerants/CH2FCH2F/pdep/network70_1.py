...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(368)', '[O]C[CH]F(138)'],
    products = ['C=[C]OC[CH]F(204)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]O[C]=C(369)'],
    products = ['C=[C]OC[CH]F(204)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]O[C]=C(369)'],
    products = ['C=[C]OC[CH]F(204)'],
