...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C=C(254)'],
    products = ['[CH]=CC[CH2](5610)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[CH](257)', '[CH2][CH2](511)'],
    products = ['[CH]=CC[CH2](5610)'],
    transitionState = 'TS9',
