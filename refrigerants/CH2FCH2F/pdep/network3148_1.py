...
species(
    label = 'F[CH]C1(F)O[CH]C1(F)F(9588)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'FC(F)C(F)(F)[C]1[CH]O1(9591)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(9355)'],
    products = ['F[CH]C1(F)O[CH]C1(F)F(9588)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(223)', 'F[C](F)C1(F)[CH]O1(9290)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(9355)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C[C](F)C(F)(F)[CH]F(9589)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(9355)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C(F)(F)C1=CO1(9590)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(9355)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'FC=C(F)C1(F)[CH]O1(9375)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(9355)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', 'F[CH]C(F)=C1[CH]O1(9376)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(9355)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', 'F[C](F)C1(F)[CH]O1(9290)'],
    products = ['F[CH]C(F)(F)C1(F)[CH]O1(9355)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(9355)'],
    products = ['FC(F)C(F)(F)[C]1[CH]O1(9591)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(9355)'],
    products = ['F[CH][C](F)C1(F)OC1F(9592)'],
