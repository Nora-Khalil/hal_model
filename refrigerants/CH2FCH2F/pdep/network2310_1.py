species(
    label = '[CH2]C(F)(F)C(F)[C](F)F(6113)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.203777,'amu*angstrom^2'), symmetry=1, barrier=(4.68523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346746,'amu*angstrom^2'), symmetry=1, barrier=(7.97237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203655,'amu*angstrom^2'), symmetry=1, barrier=(4.68242,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0277563,0.101324,-0.000183907,1.71823e-07,-6.14324e-11,-91002.6,29.4358], Tmin=(100,'K'), Tmax=(834.087,'K')), NASAPolynomial(coeffs=[8.73352,0.0343114,-1.844e-05,3.63912e-09,-2.53403e-13,-91594.7,-6.03052], Tmin=(834.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-757.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sH)(F1s)(F1s)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
species(
    label = '[CH2]C(F)(F)C(F)(F)[CH]F(6112)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-766.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([181,249,286,344,486,552,511,665,553,637,1169,1241,1190,1306,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.114032,'amu*angstrom^2'), symmetry=1, barrier=(2.62182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113972,'amu*angstrom^2'), symmetry=1, barrier=(2.62044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.420636,'amu*angstrom^2'), symmetry=1, barrier=(9.67125,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.12802,0.101874,-0.000179655,1.62827e-07,-5.69335e-11,-92094,29.2013], Tmin=(100,'K'), Tmax=(828.821,'K')), NASAPolynomial(coeffs=[10.4318,0.0313661,-1.66798e-05,3.28537e-09,-2.28809e-13,-93173.2,-15.7116], Tmin=(828.821,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-766.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'F[C](F)CC(F)[C](F)F(6115)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[CH2]C(F)(F)C(F)=C(F)F(6180)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = '[CH2]C(F)(F)[C](F)C(F)F(6182)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0297735,0.102981,-0.000192269,1.83052e-07,-6.60679e-11,-92008.6,30.2041], Tmin=(100,'K'), Tmax=(841.876,'K')), NASAPolynomial(coeffs=[7.74444,0.0360147,-1.94502e-05,3.83195e-09,-2.66014e-13,-92253.4,0.3562], Tmin=(841.876,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-766.094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'CC(F)(F)[C](F)[C](F)F(6183)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0963744,0.104247,-0.000207365,2.06768e-07,-7.65342e-11,-93302.8,29.4187], Tmin=(100,'K'), Tmax=(853.626,'K')), NASAPolynomial(coeffs=[4.54321,0.0412021,-2.24158e-05,4.40217e-09,-3.03971e-13,-92524.2,17.6764], Tmin=(853.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-776.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]C(F)(F)[CH]C(F)(F)F(2851)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-822.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,1010.29],'cm^-1')),
        HinderedRotor(inertia=(0.129446,'amu*angstrom^2'), symmetry=1, barrier=(2.97621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134338,'amu*angstrom^2'), symmetry=1, barrier=(3.08869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132451,'amu*angstrom^2'), symmetry=1, barrier=(3.0453,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.725223,0.0791523,-0.000110804,8.60136e-08,-2.74074e-11,-98768.3,29.4231], Tmin=(100,'K'), Tmax=(760.806,'K')), NASAPolynomial(coeffs=[9.83241,0.031277,-1.64256e-05,3.32461e-09,-2.39499e-13,-100154,-12.0254], Tmin=(760.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-822.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sF1s)(H)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = 'FCC(F)(F)[CH][C](F)F(6176)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0890023,'amu*angstrom^2'), symmetry=1, barrier=(2.04634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0887837,'amu*angstrom^2'), symmetry=1, barrier=(2.04131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.754391,'amu*angstrom^2'), symmetry=1, barrier=(17.3449,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.108177,0.0977864,-0.000175142,1.64136e-07,-5.91867e-11,-91661.2,29.792], Tmin=(100,'K'), Tmax=(825.893,'K')), NASAPolynomial(coeffs=[8.2171,0.0351365,-1.88994e-05,3.74423e-09,-2.6183e-13,-92203.4,-2.95111], Tmin=(825.893,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-763.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sF1sH)(H)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[CH2][C](F)C(F)C(F)(F)F(6184)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (146.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.332619,0.0886045,-0.000143632,1.25396e-07,-4.3286e-11,-94627.8,29.5665], Tmin=(100,'K'), Tmax=(801.002,'K')), NASAPolynomial(coeffs=[10.0314,0.030142,-1.53708e-05,3.01502e-09,-2.11007e-13,-95859.8,-13.0643], Tmin=(801.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-787.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCsH)(Cs-HHH)(F1s)) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    products = ['CHFCF2(55)', 'CH2CF2(57)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(6112)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    products = ['F[C](F)CC(F)[C](F)F(6115)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', '[CH2]C(F)(F)[CH]F(773)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[C](F)C(F)[C](F)F(6178)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    products = ['FC1C(F)(F)CC1(F)F(6172)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    products = ['CC(F)(F)C(F)=C(F)F(6179)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)(F)C=C(F)F(798)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHFCF2(55)', '[CH2][C](F)F(507)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)=C(F)F(6180)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(F)C(F)[C](F)F(6137)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][C](F)F(3911)', 'CH2CF2(57)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH][C](F)F(3911)', '[CH2][C](F)F(507)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[CH2]C(F)=C[C](F)F(799)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2]C(F)=C(F)[C](F)F(6181)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[CH2]C(F)(F)[CH]F(773)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    products = ['[CH2]C(F)(F)[C](F)C(F)F(6182)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    products = ['CC(F)(F)[C](F)[C](F)F(6183)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    products = ['[CH2]C(F)(F)[CH]C(F)(F)F(2851)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    products = ['FCC(F)(F)[CH][C](F)F(6176)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
    products = ['[CH2][C](F)C(F)C(F)(F)F(6184)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FC[C](F)C(F)[C](F)F(6157)'],
    products = ['[CH2]C(F)(F)C(F)[C](F)F(6113)'],
...
network(
    label = 'PDepNetwork #2310',
    isomers = [
        '[CH2]C(F)(F)C(F)[C](F)F(6113)',
    ],
    reactants = [
        ('CHFCF2(55)', 'CH2CF2(57)'),
    ],
