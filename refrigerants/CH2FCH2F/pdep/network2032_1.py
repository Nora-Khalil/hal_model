...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C][CH]C(F)F(5608)'],
    products = ['O=[C]CC(F)F(557)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]CC(F)F(557)'],
    products = ['O=C(F)C[CH]F(552)'],
