...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C[O](1330)'],
    products = ['[O]CO[C]=O(3161)'],
    transitionState = 'TS2',
