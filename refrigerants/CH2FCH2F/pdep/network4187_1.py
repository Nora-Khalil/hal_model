...
species(
    label = 'F[CH]O[C](F)C(F)(F)F(12691)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]OC(F)(F)[C](F)F(12619)'],
...
reaction(
    ...
    products = ['F[CH]OC(F)(F)[C](F)F(12619)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', 'F[CH]O[C](F)F(1161)'],
    products = ['F[CH]OC(F)(F)[C](F)F(12619)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]OC(F)=C(F)F(6194)'],
    products = ['F[CH]OC(F)(F)[C](F)F(12619)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(43)', 'F[CH]O[C](F)F(1161)'],
    products = ['F[CH]OC(F)(F)[C](F)F(12619)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH]OC(F)(F)[C](F)F(12619)'],
    products = ['F[CH]O[C](F)C(F)(F)F(12691)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]OC(F)(F)[C](F)F(12619)'],
    products = ['F[C](F)[C](F)OC(F)F(6418)'],
...
network(
    label = 'PDepNetwork #4187',
    isomers = [
        'F[CH]OC(F)(F)[C](F)F(12619)',
    ],
    reactants = [
        ('CHFO(47)', 'CF2CF2(61)'),
    ],
