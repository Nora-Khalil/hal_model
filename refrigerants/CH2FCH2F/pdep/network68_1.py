...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]C(=C)[O](386)'],
    products = ['C=C([O])C[CH]F(202)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C(=C)[O](386)'],
    products = ['C=C([O])C[CH]F(202)'],
