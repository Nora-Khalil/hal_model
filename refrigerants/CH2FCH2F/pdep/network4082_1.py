...
reaction(
    ...
    products = ['CH2FCH2F(1)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(8.39871e-05,'m^3/(mol*s)'), n=3.10993, Ea=(23.9495,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction1',
    reactants = ['H2(8)', 'F[C]CF(125)'],
    products = ['CH2FCH2F(1)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.26413e-09,'m^3/(mol*s)'), n=4.30786, Ea=(80.303,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HH_N-2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node HH_N-2Br1sCl1sF1sHI1s->H"""),
)
...
reaction(
    ...
    products = ['CH2FCH2F(1)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(158.682,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'CH2F-CH2(62)'],
    products = ['CH2FCH2F(1)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2F(46)', 'CH2F(46)'],
    products = ['CH2FCH2F(1)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.37e+24,'cm^3/(mol*s)'), n=-3.79, Ea=(2290,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 189 CH2F + CH2F <=> C2H4F2 in R_Recombination/training
This reaction matched rate rule [Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_N-4R!H->O_4BrCClF->F]
family: R_Recombination"""),
)

reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'CH2F-CHF(66)'],
    products = ['CH2FCH2F(1)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.56e+45,'cm^3/(mol*s)'), n=-10.8, Ea=(8070,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 180 C2H3F2 + H <=> C2H4F2 in R_Recombination/training
This reaction matched rate rule [Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_N-5CF->C_Sp-4C-2C]
family: R_Recombination"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F2(78)', 'C2H4(30)'],
    products = ['CH2FCH2F(1)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(8.90199,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CH2FCH2F(1)'],
    products = ['HF(38)', 'CH2CHF(56)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.5e+13,'s^-1'), n=0, Ea=(62900,'cal/mol'), T0=(1,'K'), comment="""Matched reaction 3 C2H4F2-2 <=> C2H3F + HF in XY_Addition_MultipleBond/training
This reaction matched rate rule [HF_Ext-3COCdCddCtO2d-R_3COCdCddCtO2d->Cd]
family: XY_Addition_MultipleBond"""),
)

network(
    label = 'PDepNetwork #4082',
    isomers = [
        'CH2FCH2F(1)',
    ],
    reactants = [
