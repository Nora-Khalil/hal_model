...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]OC(F)(F)[C]=CF(7455)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(368)', '[O]C(F)(F)[C]=CF(2246)'],
    products = ['C=[C]OC(F)(F)[C]=CF(7455)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1054)', 'C=[C]O[C](F)F(851)'],
    products = ['C=[C]OC(F)(F)[C]=CF(7455)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(F)=C=CF(7880)'],
    products = ['C=[C]OC(F)(F)[C]=CF(7455)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CC(F)(F)O[C]=C(7881)'],
    products = ['C=[C]OC(F)(F)[C]=CF(7455)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=[C]OC(F)(F)C#CF(7882)'],
    products = ['C=[C]OC(F)(F)[C]=CF(7455)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#COC(F)(F)[C]=CF(7883)'],
    products = ['C=[C]OC(F)(F)[C]=CF(7455)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=[C]OC(F)(F)[C]=CF(7455)'],
    products = ['C=[C]OC(F)(F)C=[C]F(7884)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=COC(F)(F)[C]=CF(7885)'],
    products = ['C=[C]OC(F)(F)[C]=CF(7455)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=[C]OC(F)(F)[C]=CF(7455)'],
    products = ['[CH]=[C]OC(F)(F)C=CF(7886)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=COC(F)(F)[C]=[C]F(7887)'],
    products = ['C=[C]OC(F)(F)[C]=CF(7455)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C]O[C](F)C(F)=CF(7888)'],
    products = ['C=[C]OC(F)(F)[C]=CF(7455)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=C(F)OC(F)=[C][CH]F(7889)'],
    products = ['C=[C]OC(F)(F)[C]=CF(7455)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OC(F)(F)[C]=CF(7455)'],
    products = ['[CH]=C(F)C(F)(F)O[C]=C(7890)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]C(F)(F)OC(=C)F(7891)'],
    products = ['C=[C]OC(F)(F)[C]=CF(7455)'],
...
network(
    label = 'PDepNetwork #2709',
    isomers = [
        'C=[C]OC(F)(F)[C]=CF(7455)',
    ],
    reactants = [
