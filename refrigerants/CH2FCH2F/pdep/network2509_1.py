...
"""),
    E0 = (-101.205,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,2950,3100,1380,975,1025,1650,300.582,300.822],'cm^-1')),
        HinderedRotor(inertia=(0.172831,'amu*angstrom^2'), symmetry=1, barrier=(11.0879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.259213,'amu*angstrom^2'), symmetry=1, barrier=(16.606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.645546,'amu*angstrom^2'), symmetry=1, barrier=(41.3529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.643795,'amu*angstrom^2'), symmetry=1, barrier=(41.3556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.62472,0.0799538,-0.000106834,7.59757e-08,-2.18436e-11,-12055.7,28.3379], Tmin=(100,'K'), Tmax=(845.323,'K')), NASAPolynomial(coeffs=[11.6773,0.0276548,-1.40318e-05,2.78818e-09,-1.98992e-13,-13924.3,-23.1272], Tmin=(845.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = '[CH2]C(F)OOC=[C]F(5241)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {5,S}
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)OOC=C(F)F(4983)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)OOC=C(F)F(4983)'],
    products = ['[CH2]C(F)OC(F)(F)C=O(5238)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]OOC=C(F)F(1677)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]C(F)OOC=C(F)F(4614)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)OOC=C(F)F(4983)'],
    products = ['FC1CC(F)(F)[CH]OO1(5239)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)OOC=C(F)F(4983)'],
    products = ['F[C](F)C1CC(F)OO1(5240)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=COOC=C(F)F(4698)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)OOC=C(F)F(1750)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=COO[CH][C](F)F(4853)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)OOC=[C]F(5241)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C[C](F)F(787)', '[CH2]C([O])F(139)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2CH(73)', '[CH2]C(F)O[O](216)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2][C](F)OOC=C(F)F(1743)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)OO[C]=C(F)F(5242)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)OOC=C(F)F(4983)'],
    products = ['CH2CFO(79)', 'O=CC(F)F(990)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[C](F)OOC=C(F)F(5244)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC(F)OO[C]=C(F)F(5245)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FC[CH]OOC=C(F)F(5246)'],
    products = ['[CH2]C(F)OOC=C(F)F(4983)'],
...
network(
    label = 'PDepNetwork #2509',
    isomers = [
        '[CH2]C(F)OOC=C(F)F(4983)',
    ],
    reactants = [
        ('O=C[C](F)F(787)', 'FC1CO1(289)'),
        ('CH2CFO(79)', 'O=CC(F)F(990)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
