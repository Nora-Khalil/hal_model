...
reaction(
    label = 'reaction5',
    reactants = ['FOF(1520)', 'CC(F)=C=O(3314)'],
    products = ['CC(F)(F)C(=O)OF(3291)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)C([O])OF(3362)'],
    products = ['CC(F)(F)C(=O)OF(3291)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)[C](O)OF(3363)'],
    products = ['CC(F)(F)C(=O)OF(3291)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](F)C(=O)OF(3323)'],
    products = ['CC(F)(F)C(=O)OF(3291)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])=O(3197)'],
    products = ['CC(F)(F)C(=O)OF(3291)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'CC(F)(F)[C]=O(1542)'],
    products = ['CC(F)(F)C(=O)OF(3291)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'O=C(OF)[C](F)F(3364)'],
    products = ['CC(F)(F)C(=O)OF(3291)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OF(160)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(=O)OF(3291)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)OF(3365)'],
    products = ['CC(F)(F)C(=O)OF(3291)'],
