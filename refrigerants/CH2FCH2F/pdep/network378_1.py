...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(=O)[C](F)F(869)'],
    products = ['[CH2]C(F)(F)C(=C)[O](682)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=C(817)'],
    products = ['[CH2]C(F)(F)C(=C)[O](682)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C(=C)F(405)'],
    products = ['[CH2]C(F)(F)C(=C)[O](682)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CF2(57)', '[CH2][C]=O(338)'],
    products = ['[CH2]C(F)(F)C(=C)[O](682)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C](F)F(507)', 'CH2CO(28)'],
    products = ['[CH2]C(F)(F)C(=C)[O](682)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C](F)F(507)', '[CH2][C]=O(338)'],
    products = ['[CH2]C(F)(F)C(=C)[O](682)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(O)C([CH2])(F)F(872)'],
    products = ['[CH2]C(F)(F)C(=C)[O](682)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)=C([CH2])OF(874)'],
    products = ['[CH2]C(F)(F)C(=C)[O](682)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', '[CH2]C(F)(F)[C]=O(876)'],
    products = ['[CH2]C(F)(F)C(=C)[O](682)'],
