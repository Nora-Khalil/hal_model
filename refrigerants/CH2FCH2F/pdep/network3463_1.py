...
species(
    label = '[O]C(F)(F)C(O)(F)[CH]F(10341)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[O]C(F)([CH]F)C(O)(F)F(10342)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-527.493,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,551,1088,1226,1380,1420,1481,3057,3119,253,525,597,667,842,1178,1324,360,370,350,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.229108,'amu*angstrom^2'), symmetry=1, barrier=(5.26765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224415,'amu*angstrom^2'), symmetry=1, barrier=(5.15975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607376,'amu*angstrom^2'), symmetry=1, barrier=(13.9648,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00597939,0.0983662,-0.000176178,1.5837e-07,-5.46465e-11,-63309,29.2516], Tmin=(100,'K'), Tmax=(838.195,'K')), NASAPolynomial(coeffs=[10.9423,0.0271607,-1.47217e-05,2.88882e-09,-2.00001e-13,-64474.4,-17.5949], Tmin=(838.195,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-527.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(C2CsJO)"""),
)

species(
    label = '[O][C](CF)C(F)(F)OF(10344)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.57194,'amu*angstrom^2'), symmetry=1, barrier=(13.15,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.572007,'amu*angstrom^2'), symmetry=1, barrier=(13.1516,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2733,'amu*angstrom^2'), symmetry=1, barrier=(29.2758,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.202785,0.101074,-0.000174124,1.50351e-07,-5.04972e-11,-67278.7,28.2241], Tmin=(100,'K'), Tmax=(812.91,'K')), NASAPolynomial(coeffs=[13.2243,0.0244953,-1.34275e-05,2.66046e-09,-1.85898e-13,-69114.5,-31.6369], Tmin=(812.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-560.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(CsCsFHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(F)(OF)C([O])(F)F(10345)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = '[CH2]C([O])(F)C(F)(F)OF(10346)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.667618,'amu*angstrom^2'), symmetry=1, barrier=(15.3498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394172,'amu*angstrom^2'), symmetry=1, barrier=(9.06278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73031,'amu*angstrom^2'), symmetry=1, barrier=(39.7833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0157439,0.0959904,-0.000160315,1.36401e-07,-4.55324e-11,-63154,28.9554], Tmin=(100,'K'), Tmax=(796.97,'K')), NASAPolynomial(coeffs=[12.8148,0.0247376,-1.33033e-05,2.63146e-09,-1.84323e-13,-64981.4,-28.6666], Tmin=(796.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-526.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(F)(CF)[C](F)OF(10348)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-518.856,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,528,1116,1182,1331,1402,1494,3075,3110,395,473,707,1436,180,180,184.282,186.86],'cm^-1')),
        HinderedRotor(inertia=(0.321511,'amu*angstrom^2'), symmetry=1, barrier=(8.97482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.49779,'amu*angstrom^2'), symmetry=1, barrier=(11.781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6105,'amu*angstrom^2'), symmetry=1, barrier=(37.0287,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0256121,0.0973247,-0.000167191,1.46069e-07,-4.9746e-11,-62267.5,29.2287], Tmin=(100,'K'), Tmax=(811.959,'K')), NASAPolynomial(coeffs=[12.0454,0.0262016,-1.42644e-05,2.82522e-09,-1.97589e-13,-63843.4,-24.1261], Tmin=(811.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-518.856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-F1sCsCs)) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C([O])(F)CF(10045)'],
...
reaction(
    ...
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.79957e-05,'m^3/(mol*s)'), n=3.10993, Ea=(26.3584,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]C(F)(F)C([O])(F)F(2336)'],
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.40188e+54,'m^3/(mol*s)'), n=-13.541, Ea=(157.19,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(F)(F)[C](F)CF(2221)'],
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C(F)(CF)[C](F)F(10170)'],
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1667.73,'m^3/(mol*s)'), n=1.126, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_ter_rad;O_birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)C([O])(F)CF(10045)'],
    products = ['FCC1(F)OOC1(F)F(10049)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', 'C=C([O])C([O])(F)F(2135)'],
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(21.4834,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[O]C(F)=C([O])CF(2285)'],
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(26.2883,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(288.7,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)(F)C([O])(F)CF(10045)'],
    products = ['[O]C(F)(F)C(O)(F)[CH]F(10341)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C(F)(F)C([O])(F)CF(10045)'],
    products = ['[O]C(F)([CH]F)C(O)(F)F(10342)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(F)[C](CF)OF(10343)'],
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O][C](CF)C(F)(F)OF(10344)'],
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(119.062,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(OF)C([O])(F)F(10345)'],
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([O])(F)C(F)(F)OF(10346)'],
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O][C](F)C(F)(CF)OF(10347)'],
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(107.923,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction23',
    reactants = ['[O]C(F)(CF)[C](F)OF(10348)'],
    products = ['[O]C(F)(F)C([O])(F)CF(10045)'],
