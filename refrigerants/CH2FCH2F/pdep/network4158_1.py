...
"""),
    ...
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32238,0.0602874,-5.9654e-05,3.14674e-08,-6.81418e-12,-59220,22.7624], Tmin=(100,'K'), Tmax=(1098.82,'K')), NASAPolynomial(coeffs=[11.0301,0.0249489,-1.1414e-05,2.19994e-09,-1.55426e-13,-61353.4,-24.9869], Tmin=(1098.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-493.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC(F)(F)[C](F)F(11264)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[CH]C=C(F)F(6536)'],
    products = ['[CH]=CC(F)(F)[C](F)F(11264)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=CC(F)(F)[C](F)F(11264)'],
    products = ['FC1(F)C=CC1(F)F(12741)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=CC(F)=C(F)F(6533)'],
    products = ['[CH]=CC(F)(F)[C](F)F(11264)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)[C](F)F(3840)', 'C2H2(23)'],
    products = ['[CH]=CC(F)(F)[C](F)F(11264)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C#CC(F)(F)[C](F)F(11267)'],
    products = ['[CH]=CC(F)(F)[C](F)F(11264)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C](F)[C](F)F(3840)', '[CH]=[CH](257)'],
    products = ['[CH]=CC(F)(F)[C](F)F(11264)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', '[CH]=C=C(F)[C](F)F(6428)'],
    products = ['[CH]=CC(F)(F)[C](F)F(11264)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH]C=C(F)F(6536)'],
    products = ['[CH]=CC(F)(F)[C](F)F(11264)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=CC(F)(F)[C](F)F(11264)'],
    products = ['C=[C]C(F)(F)[C](F)F(12706)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[C]C(F)(F)C(F)F(6433)'],
    products = ['[CH]=CC(F)(F)[C](F)F(11264)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=CC(F)(F)[C](F)F(11264)'],
    products = ['[CH]C=C(F)C(F)(F)F(12742)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC(F)(F)[C](F)F(11264)'],
    products = ['F[CH]C=C(F)[C](F)F(6154)'],
...
network(
    label = 'PDepNetwork #4158',
    isomers = [
        '[CH]=CC(F)(F)[C](F)F(11264)',
    ],
    reactants = [
        ('CF2CF2(61)', 'C2H2(23)'),
    ],
