...
"""),
    ...
    molecularWeight = (126.034,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.968826,0.0866096,-0.000191485,2.01127e-07,-7.63715e-11,-56778.4,22.1258], Tmin=(100,'K'), Tmax=(861.283,'K')), NASAPolynomial(coeffs=[1.18226,0.0372573,-2.13082e-05,4.21028e-09,-2.90147e-13,-55021.4,31.5411], Tmin=(861.283,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-472.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsFFHO) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(oxirene)"""),
)

species(
    label = 'O=C(F)[CH]O[C](F)F(9494)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 F u0 p3 c0 {8,S}
3 F u0 p3 c0 {8,S}
...
"""),
    E0 = (-258.429,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,493,600,700,1144,1293,180,180,180,180,2129.7,2132.89],'cm^-1')),
        HinderedRotor(inertia=(0.161422,'amu*angstrom^2'), symmetry=1, barrier=(3.7114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161112,'amu*angstrom^2'), symmetry=1, barrier=(3.70429,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.026,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21581,0.0801,-0.000180189,1.91065e-07,-7.31883e-11,-30999.7,23.5133], Tmin=(100,'K'), Tmax=(855.471,'K')), NASAPolynomial(coeffs=[1.13856,0.034728,-2.04433e-05,4.08399e-09,-2.83373e-13,-29313,33.6548], Tmin=(855.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsFFHO) + group(Cds-CdsCsCs) + group(CdCFO) + ring(oxirene) + radical(Csj(F1s)(F1s)(O2s-Cd)) + longDistanceInteraction_cyclic(Cd(F)=CdOs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)OC1O[C]1F(9350)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[O]C1O[C]1F(9399)'],
    products = ['F[C](F)OC1O[C]1F(9350)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(F)[CH]O[C](F)F(9494)'],
    products = ['F[C](F)OC1O[C]1F(9350)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)OC1=C(F)O1(9495)'],
    products = ['F[C](F)OC1O[C]1F(9350)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[O]C1O[C]1F(9399)'],
    products = ['F[C](F)OC1O[C]1F(9350)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C](F)OC1O[C]1F(9350)'],
    products = ['F[C]1O[C]1OC(F)F(9497)'],
