...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.816893,'amu*angstrom^2'), symmetry=1, barrier=(18.782,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.315121,'amu*angstrom^2'), symmetry=1, barrier=(7.24526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.315027,'amu*angstrom^2'), symmetry=1, barrier=(7.24308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.93021,'amu*angstrom^2'), symmetry=1, barrier=(44.3794,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00261733,0.0964961,-0.000149319,1.29553e-07,-4.51953e-11,-27450.5,29.6646], Tmin=(100,'K'), Tmax=(786.322,'K')), NASAPolynomial(coeffs=[9.61617,0.0379537,-1.93066e-05,3.77952e-09,-2.64807e-13,-28666,-12.5387], Tmin=(786.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-229.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2][CH]OOC(F)CF(11392)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-222.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,340.404,340.519],'cm^-1')),
        HinderedRotor(inertia=(0.371776,'amu*angstrom^2'), symmetry=1, barrier=(30.6985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0882087,'amu*angstrom^2'), symmetry=1, barrier=(7.25171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.495411,'amu*angstrom^2'), symmetry=1, barrier=(40.8033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.495356,'amu*angstrom^2'), symmetry=1, barrier=(40.7882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.496027,'amu*angstrom^2'), symmetry=1, barrier=(40.7832,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.638244,0.0801151,-8.81166e-05,5.28168e-08,-1.32169e-11,-26603.6,28.5228], Tmin=(100,'K'), Tmax=(949.437,'K')), NASAPolynomial(coeffs=[11.1677,0.035755,-1.80339e-05,3.60747e-09,-2.59586e-13,-28603,-21.7295], Tmin=(949.437,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-222.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(F)(F)OO[CH]C(11393)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.470355,0.084495,-0.000104197,7.15873e-08,-2.04183e-11,-33880.1,28.0261], Tmin=(100,'K'), Tmax=(842.575,'K')), NASAPolynomial(coeffs=[10.6286,0.0362694,-1.83418e-05,3.655e-09,-2.61784e-13,-35591.9,-19.2414], Tmin=(842.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][C](F)OOC(C)F(11394)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {5,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]CF-2(467)', 'C[CH]O[O](416)'],
    products = ['C[CH]OO[C](F)CF(11276)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)CF(501)', '[CH]C-2(510)'],
    products = ['C[CH]OO[C](F)CF(11276)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)OO[CH]C(11387)'],
    products = ['C[CH]OO[C](F)CF(11276)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]CF(125)', 'C[CH]O[O](416)'],
    products = ['C[CH]OO[C](F)CF(11276)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH]OOC(F)CF(11392)'],
    products = ['C[CH]OO[C](F)CF(11276)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]OO[C](F)CF(11276)'],
    products = ['[CH2]C(F)(F)OO[CH]C(11393)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH]OO[C](F)CF(11276)'],
    products = ['[CH2][C](F)OOC(C)F(11394)'],
