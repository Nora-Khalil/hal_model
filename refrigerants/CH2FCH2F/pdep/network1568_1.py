...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)C(F)(F)OF(3303)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'CC(F)(F)OF(2633)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FOC(F)(F)F(3367)', 'C[C]F(137)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(1520)', 'CC(F)(F)[C]F(3100)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(1520)', 'CC(F)=C(F)F(2636)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C[C](F)C(F)(F)OF(2641)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)[C](F)OF(3106)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)(F)C([O])(F)F(2335)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'CC(F)(F)[C](F)F(1807)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(2145)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'FOC(F)(F)[C](F)F(3370)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)C(F)(F)OF(3371)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'CC(F)(F)C(=O)F(1164)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F2(78)', 'CC(F)=C(F)OF(2643)'],
    products = ['CC(F)(F)C(F)(F)OF(3303)'],
