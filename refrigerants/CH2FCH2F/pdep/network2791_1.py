...
"""),
    ...
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.775353,0.0619406,-5.49622e-05,2.11228e-08,-2.46991e-12,-68311.2,21.0294], Tmin=(100,'K'), Tmax=(1113.99,'K')), NASAPolynomial(coeffs=[17.3299,0.014062,-6.06367e-06,1.17772e-09,-8.50306e-14,-72717,-63.8439], Tmin=(1113.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-569,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCsCdF) + group(Cds-Cds(Cds-Cds)H) + group(CdCFF) + longDistanceInteraction_cyclic(Cs(F)-Cds(F)) + ring(Cyclobutene)"""),
)

species(
    label = 'C=C(F)C(F)=C=C(F)F(8239)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {8,S}
...
"""),
    E0 = (12.4852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,246,474,533,1155,2175,525,3120,650,792.5,1650,239,401,1367,180,373.974],'cm^-1')),
        HinderedRotor(inertia=(0.57483,'amu*angstrom^2'), symmetry=1, barrier=(13.2165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.42593,'amu*angstrom^2'), symmetry=1, barrier=(55.7769,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.986596,0.0739596,-0.000124464,1.10805e-07,-3.81845e-11,1602.75,23.6323], Tmin=(100,'K'), Tmax=(846.482,'K')), NASAPolynomial(coeffs=[8.16682,0.0254526,-1.26766e-05,2.41983e-09,-1.65532e-13,909.418,-6.72663], Tmin=(846.482,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.4852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-CdsHH) + group(Ct-CtCs) + group(CtCF) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.819501,0.0761343,-0.000128372,1.07301e-07,-3.39392e-11,1519.13,23.3205], Tmin=(100,'K'), Tmax=(914.503,'K')), NASAPolynomial(coeffs=[10.8696,0.0172689,-7.36835e-06,1.26675e-09,-7.96922e-14,304.279,-20.8594], Tmin=(914.503,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.7268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(CdCFF) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CJC=C) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]C(F)=C(F)C=C(F)F(8246)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.802577,'amu*angstrom^2'), symmetry=1, barrier=(18.4528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.807493,'amu*angstrom^2'), symmetry=1, barrier=(18.5658,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.28839,0.0926362,-0.000166129,1.52539e-07,-5.36443e-11,-21582.4,27.9306], Tmin=(100,'K'), Tmax=(841.66,'K')), NASAPolynomial(coeffs=[8.94801,0.0299138,-1.59081e-05,3.10552e-09,-2.14575e-13,-22276.2,-7.81622], Tmin=(841.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-CdsCsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cds(F)2=Cds(F)) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'FC=[C]C(F)[C]=C(F)F(8143)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00622983,'amu*angstrom^2'), symmetry=1, barrier=(11.6653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39012,'amu*angstrom^2'), symmetry=1, barrier=(31.9617,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.333622,0.0895808,-0.000153116,1.35837e-07,-4.67345e-11,-18894.9,28.0954], Tmin=(100,'K'), Tmax=(833.513,'K')), NASAPolynomial(coeffs=[9.97511,0.0279285,-1.44817e-05,2.81175e-09,-1.9427e-13,-19967.8,-13.4579], Tmin=(833.513,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsHH) + radical(Cdj(Cd-CsF1s)(F1s)) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = 'F[C]=[C]C(F)C(F)=CF(8250)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.627377,'amu*angstrom^2'), symmetry=1, barrier=(14.4246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.63068,'amu*angstrom^2'), symmetry=1, barrier=(14.5006,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.341553,0.0918608,-0.00016582,1.53452e-07,-5.42218e-11,-21848.4,27.9725], Tmin=(100,'K'), Tmax=(845.352,'K')), NASAPolynomial(coeffs=[8.39881,0.0306429,-1.62177e-05,3.15717e-09,-2.17673e-13,-22385.5,-4.66511], Tmin=(845.352,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(F)F(1544)', '[CH]C(F)=CF(1960)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
    products = ['FC1=CC(=C(F)F)C1F(8238)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
    products = ['C=C(F)C(F)=C=C(F)F(8239)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)C=C=C(F)F(8240)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C(F)=C=C(F)F(8241)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CC(F)[C]=C(F)F(8242)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(F)C(F)C#CF(8243)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH]=C=C[C]=C(F)F(8244)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH]=C=C(F)[C]=C(F)F(8245)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
    products = ['[CH]C(F)=C(F)C=C(F)F(8246)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
    products = ['[CH2]C(F)=C(F)[C]=C(F)F(7776)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
    products = ['[CH]C(F)=CC(F)=C(F)F(8247)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
    products = ['FC=C(F)[CH][C]=C(F)F(7805)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]C(F)C(F)=C(F)F(8248)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
    products = ['FC=[C]C(F)[C]=C(F)F(8143)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(F)C(F)C(F)=[C]F(8249)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C]=[C]C(F)C(F)=CF(8250)'],
    products = ['[CH]=C(F)C(F)[C]=C(F)F(7534)'],
...
network(
    label = 'PDepNetwork #2791',
    isomers = [
        '[CH]=C(F)C(F)[C]=C(F)F(7534)',
    ],
    reactants = [
