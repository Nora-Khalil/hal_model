...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)(F)O[C](F)F(6322)'],
...
reaction(
    ...
    products = ['F[CH]C(F)(F)O[C](F)F(6322)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'F[C](F)O[C](F)F(2216)'],
    products = ['F[CH]C(F)(F)O[C](F)F(6322)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC=C(F)O[C](F)F(2225)'],
    products = ['F[CH]C(F)(F)O[C](F)F(6322)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', 'F[C](F)O[C](F)F(2216)'],
    products = ['F[CH]C(F)(F)O[C](F)F(6322)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F[C](F)O[C](F)C(F)F(6417)'],
    products = ['F[CH]C(F)(F)O[C](F)F(6322)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]C(F)(F)O[C](F)F(6322)'],
    products = ['F[CH][C](F)OC(F)(F)F(6439)'],
