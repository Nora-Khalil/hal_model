...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C1O[C]1F(9348)'],
    products = ['CF2O(49)', 'FC1=CO1(3064)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)(F)C1O[C]1F(9348)'],
    products = ['[O]C1(F)O[C](F)C1F(9513)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)(F)C1(F)[CH]O1(9347)'],
    products = ['[O]C(F)(F)C1O[C]1F(9348)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C](F)C1O[C]1F(9280)'],
    products = ['[O]C(F)(F)C1O[C]1F(9348)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)(F)C1O[C]1F(9348)'],
    products = ['FC1(F)OC2(F)OC12(9351)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)C1O[C]1F(9348)'],
    products = ['OC(F)(F)C1=C(F)O1(9514)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(2186)', 'FC1=CO1(3064)'],
    products = ['[O]C(F)(F)C1O[C]1F(9348)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C1=C(F)O1(9516)'],
    products = ['[O]C(F)(F)C1O[C]1F(9348)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=C(F)C1O[C]1F(9428)'],
    products = ['[O]C(F)(F)C1O[C]1F(9348)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CF2O(49)', 'F[C]1[CH]O1(9215)'],
    products = ['[O]C(F)(F)C1O[C]1F(9348)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)F(2186)', 'F[C]1[CH]O1(9215)'],
    products = ['[O]C(F)(F)C1O[C]1F(9348)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)[C]1O[C]1F(9517)'],
    products = ['[O]C(F)(F)C1O[C]1F(9348)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)(F)C1O[C]1F(9348)'],
    products = ['OC(F)(F)[C]1O[C]1F(9519)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FO[C](F)C1O[C]1F(9520)'],
    products = ['[O]C(F)(F)C1O[C]1F(9348)'],
...
network(
    label = 'PDepNetwork #3141',
    isomers = [
        '[O]C(F)(F)C1O[C]1F(9348)',
    ],
    reactants = [
        ('CF2O(49)', 'FC1=CO1(3064)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
