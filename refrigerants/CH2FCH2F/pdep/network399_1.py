...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C([CH2])(F)F(702)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C[C](F)F(703)'],
    products = ['[CH2]C(F)C([CH2])(F)F(702)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', '[CH2]C(F)(F)[CH]F(773)'],
    products = ['[CH2]C(F)C([CH2])(F)F(702)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)C(=C)F(248)'],
    products = ['[CH2]C(F)C([CH2])(F)F(702)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)(F)C=C(775)'],
    products = ['[CH2]C(F)C([CH2])(F)F(702)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=C)F(708)'],
    products = ['[CH2]C(F)C([CH2])(F)F(702)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[CH2]C=C([CH2])F(250)'],
    products = ['[CH2]C(F)C([CH2])(F)F(702)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2]C(F)=C([CH2])F(776)'],
    products = ['[CH2]C(F)C([CH2])(F)F(702)'],
