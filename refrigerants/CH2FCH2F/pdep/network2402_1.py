...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.189104,'amu*angstrom^2'), symmetry=1, barrier=(4.34787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188226,'amu*angstrom^2'), symmetry=1, barrier=(4.32769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188493,'amu*angstrom^2'), symmetry=1, barrier=(4.33382,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-354.891,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,212,367,445,1450,3000,3100,440,815,1455,1000,180,1745.26],'cm^-1')),
        HinderedRotor(inertia=(0.242938,'amu*angstrom^2'), symmetry=1, barrier=(5.58562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244089,'amu*angstrom^2'), symmetry=1, barrier=(5.61208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244205,'amu*angstrom^2'), symmetry=1, barrier=(5.61475,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
...
"""),
    E0 = (-334.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,212,367,445,1450,334,575,1197,1424,3202,232.677,233.501,234.891],'cm^-1')),
        HinderedRotor(inertia=(0.45445,'amu*angstrom^2'), symmetry=1, barrier=(17.7745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.456596,'amu*angstrom^2'), symmetry=1, barrier=(17.7655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458727,'amu*angstrom^2'), symmetry=1, barrier=(17.7897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.078,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC(F)(F)[CH]F(6576)'],
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]CC(F)=CF(1916)'],
    products = ['[CH2]CC(F)(F)[CH]F(6576)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=CC(F)(F)[CH]F(6145)'],
    products = ['[CH2]CC(F)(F)[CH]F(6576)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C[C](F)C(F)F(6581)'],
    products = ['[CH2]CC(F)(F)[CH]F(6576)'],
...
network(
    label = 'PDepNetwork #2402',
    isomers = [
        '[CH2]CC(F)(F)[CH]F(6576)',
    ],
    reactants = [
        ('CHFCF2(55)', 'C2H4(30)'),
    ],
