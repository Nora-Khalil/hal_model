...
"""),
    E0 = (-805.293,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,1380,1390,370,380,2900,435,1772.9,1773.4,1774.04,1774.13,1775.41],'cm^-1')),
        HinderedRotor(inertia=(0.22842,'amu*angstrom^2'), symmetry=1, barrier=(5.25181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22844,'amu*angstrom^2'), symmetry=1, barrier=(5.25228,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1518,0.0688242,-0.000180551,2.24688e-07,-9.51186e-11,-96815.1,23.1007], Tmin=(100,'K'), Tmax=(848.184,'K')), NASAPolynomial(coeffs=[-11.9748,0.0610494,-3.52347e-05,7.05929e-09,-4.93156e-13,-91742.7,104.703], Tmin=(848.184,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-805.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(CsFFFO) + radical(OCOJ) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-848.964,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,1855,455,950,180,798.643],'cm^-1')),
        HinderedRotor(inertia=(0.575819,'amu*angstrom^2'), symmetry=1, barrier=(13.2392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67299,'amu*angstrom^2'), symmetry=1, barrier=(38.4653,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1037.23,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([431,527,613,668,835,1199,1245,1322,329.189,329.19,329.19,329.19,996.402,1524.19,1524.19,3535.14],'cm^-1')),
        HinderedRotor(inertia=(0.382583,'amu*angstrom^2'), symmetry=1, barrier=(29.4203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.382585,'amu*angstrom^2'), symmetry=1, barrier=(29.4203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.015,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72566,0.0474764,-4.96471e-05,2.47346e-08,-4.81536e-12,-124666,21.8976], Tmin=(100,'K'), Tmax=(1248.19,'K')), NASAPolynomial(coeffs=[13.2226,0.0106332,-5.3715e-06,1.08695e-09,-7.90203e-14,-127536,-36.1176], Tmin=(1248.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1037.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsFFFO) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cds-OdOsOs) + radical(OC=OOJ)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'O=[C]OC(F)(F)F(3790)'],
    products = ['O=C(O)OC(F)(F)F(3584)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(=O)OC(F)(F)F(3791)'],
    products = ['O=C(O)OC(F)(F)F(3584)'],
    transitionState = 'TS8',
