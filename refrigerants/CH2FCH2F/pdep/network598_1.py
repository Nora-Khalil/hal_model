...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'F[C]CC(F)OF(1534)'],
    products = ['FCCC(F)OF(1509)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]CC(F)OF(1536)'],
    products = ['FCCC(F)OF(1509)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(127)', 'F[CH]CCF(1033)'],
    products = ['FCCC(F)OF(1509)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]OF(1060)', 'CH2F-CH2(62)'],
    products = ['FCCC(F)OF(1509)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2F(46)', '[CH2]C(F)OF(488)'],
    products = ['FCCC(F)OF(1509)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FC[CH]C(F)OF(1538)'],
    products = ['FCCC(F)OF(1509)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'F[CH]CC(F)OF(1540)'],
    products = ['FCCC(F)OF(1509)'],
