...
reaction(
    label = 'reaction2',
    reactants = ['C=C([O])C(F)[CH]F(1224)'],
    products = ['O=[C]CC(F)[CH]F(1226)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'O=[C]C[CH]F(297)'],
    products = ['O=[C]CC(F)[CH]F(1226)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(129)', '[CH2]C(F)[CH]F(245)'],
    products = ['O=[C]CC(F)[CH]F(1226)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C(F)[CH]F(245)'],
    products = ['O=[C]CC(F)[CH]F(1226)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CHFCHF[Z](59)', '[CH2][C]=O(338)'],
    products = ['O=[C]CC(F)[CH]F(1226)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]CC(F)=CF(1235)'],
    products = ['O=[C]CC(F)[CH]F(1226)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][CH]F(493)', 'CH2CO(28)'],
    products = ['O=[C]CC(F)[CH]F(1226)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=CC(F)[CH]F(1236)'],
    products = ['O=[C]CC(F)[CH]F(1226)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH][CH]F(493)', '[CH2][C]=O(338)'],
    products = ['O=[C]CC(F)[CH]F(1226)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=[C]C=C[CH]F(1237)'],
    products = ['O=[C]CC(F)[CH]F(1226)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'O=[C]C[CH]F(297)'],
    products = ['O=[C]CC(F)[CH]F(1226)'],
