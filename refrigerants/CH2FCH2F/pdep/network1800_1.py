...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C=C(O)OF(3663)'],
    products = ['C=C(O)C(=O)OF(4083)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)C([O])=O(4337)'],
    products = ['C=C(O)C(=O)OF(4083)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=[C]C(=O)OF(4338)'],
    products = ['C=C(O)C(=O)OF(4083)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)OF(4339)'],
    products = ['C=C(O)C(=O)OF(4083)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'C=C(O)[C]=O(4340)'],
    products = ['C=C(O)C(=O)OF(4083)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OF(160)', 'C=[C]O(195)'],
    products = ['C=C(O)C(=O)OF(4083)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)C(=O)OF(4341)'],
    products = ['C=C(O)C(=O)OF(4083)'],
