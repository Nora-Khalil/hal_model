...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(514)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])=O(3160)'],
    transitionState = 'TS2',
