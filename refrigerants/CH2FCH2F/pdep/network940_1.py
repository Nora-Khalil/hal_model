...
reaction(
    label = 'reaction3',
    reactants = ['C2HF(58)', '[CH]=[C]F(465)'],
    products = ['F[C]=CC=[C]F(2018)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=[C]F(465)', '[CH]=[C]F(465)'],
    products = ['F[C]=CC=[C]F(2018)'],
    transitionState = 'TS5',
