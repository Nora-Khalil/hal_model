...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59597,0.0397209,1.20744e-05,-4.74226e-08,2.2057e-11,-91096.1,20.8591], Tmin=(100,'K'), Tmax=(951.954,'K')), NASAPolynomial(coeffs=[14.2943,0.0187977,-6.06278e-06,1.06945e-09,-7.7065e-14,-94983.4,-47.4966], Tmin=(951.954,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-758.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCCFO) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + ring(Beta-Propiolactone)"""),
)

species(
    label = 'O=C=CC(O)(F)CF(10222)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-331.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,1855,455,950,226.436,226.791],'cm^-1')),
        HinderedRotor(inertia=(0.262547,'amu*angstrom^2'), symmetry=1, barrier=(9.59391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263982,'amu*angstrom^2'), symmetry=1, barrier=(9.59537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263673,'amu*angstrom^2'), symmetry=1, barrier=(9.59308,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09321,0.0710553,-0.000115347,1.02252e-07,-3.54451e-11,-39780.3,23.8316], Tmin=(100,'K'), Tmax=(837.146,'K')), NASAPolynomial(coeffs=[7.63464,0.0269198,-1.31867e-05,2.51833e-09,-1.72931e-13,-40424.3,-3.86871], Tmin=(837.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-331.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + group(Cds-OdCsH) + radical(C=OCCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.775802,'amu*angstrom^2'), symmetry=1, barrier=(17.8372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.774954,'amu*angstrom^2'), symmetry=1, barrier=(17.8177,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.724529,0.0771201,-0.00010551,7.65532e-08,-2.23025e-11,-54937.8,28.7837], Tmin=(100,'K'), Tmax=(837.303,'K')), NASAPolynomial(coeffs=[11.5992,0.0251665,-1.24318e-05,2.43996e-09,-1.72753e-13,-56758.8,-21.7487], Tmin=(837.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-457.722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]CC(O)(F)[CH]F(10227)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {12,S}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0546464,0.100055,-0.000185589,1.72526e-07,-6.04965e-11,-54959.5,28.3806], Tmin=(100,'K'), Tmax=(862.706,'K')), NASAPolynomial(coeffs=[8.63003,0.0315295,-1.64267e-05,3.15449e-09,-2.14756e-13,-55368.7,-5.52016], Tmin=(862.706,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-458.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(Csj(Cs-F1sO2sCs)(F1s)(H)) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(F)([CH]F)CC=O(10228)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (-384.045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,2782.5,750,1395,475,1775,1000,180,180,2293.62],'cm^-1')),
        HinderedRotor(inertia=(0.399916,'amu*angstrom^2'), symmetry=1, barrier=(9.19486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399989,'amu*angstrom^2'), symmetry=1, barrier=(9.19653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.400288,'amu*angstrom^2'), symmetry=1, barrier=(9.20341,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.380911,0.0943067,-0.000177516,1.7181e-07,-6.24247e-11,-46073.7,27.5318], Tmin=(100,'K'), Tmax=(857.231,'K')), NASAPolynomial(coeffs=[5.53257,0.0371166,-1.94343e-05,3.75684e-09,-2.57402e-13,-45738.9,10.5763], Tmin=(857.231,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-384.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsH) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-F1sO2sCs)(F1s)(H))"""),
)

species(
    label = 'O=[C]C[C](CF)OF(10229)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-113.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,1855,455,950,266.009,266.027,266.056],'cm^-1')),
        HinderedRotor(inertia=(0.153564,'amu*angstrom^2'), symmetry=1, barrier=(7.70996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153516,'amu*angstrom^2'), symmetry=1, barrier=(7.71,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153545,'amu*angstrom^2'), symmetry=1, barrier=(7.71021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153562,'amu*angstrom^2'), symmetry=1, barrier=(7.71036,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.38478,0.0910963,-0.000162751,1.5044e-07,-5.28867e-11,-13572.3,29.3179], Tmin=(100,'K'), Tmax=(858.351,'K')), NASAPolynomial(coeffs=[7.78598,0.0319161,-1.61856e-05,3.0939e-09,-2.10873e-13,-13933.3,0.0399601], Tmin=(858.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(Cds-OdCsH) + radical(C2CsJO) + radical(CCCJ=O)"""),
)

species(
    label = '[O][C](CF)CC(=O)F(10230)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  O u1 p2 c0 {7,S}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.560166,0.0848419,-0.000141664,1.28069e-07,-4.51094e-11,-52253.1,27.4343], Tmin=(100,'K'), Tmax=(832.077,'K')), NASAPolynomial(coeffs=[7.96402,0.0322864,-1.63413e-05,3.15848e-09,-2.1822e-13,-52898,-3.39523], Tmin=(832.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-435.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(COCsFO) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(F)(C[C]=O)OF(10231)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.358813,'amu*angstrom^2'), symmetry=1, barrier=(8.24982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.358797,'amu*angstrom^2'), symmetry=1, barrier=(8.24946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.358948,'amu*angstrom^2'), symmetry=1, barrier=(8.25291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31824,'amu*angstrom^2'), symmetry=1, barrier=(30.3089,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0880666,0.0965001,-0.000168581,1.51871e-07,-5.27105e-11,-16479.1,27.6702], Tmin=(100,'K'), Tmax=(840.026,'K')), NASAPolynomial(coeffs=[9.86016,0.0304825,-1.59016e-05,3.0875e-09,-2.12958e-13,-17433.4,-13.679], Tmin=(840.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Csj(Cs-F1sO2sCs)(H)(H)) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C([O])(F)CC(=O)F(711)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  O u1 p2 c0 {5,S}
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]C(F)(F)C[C]=O(2139)'],
    products = ['[O]C(F)(CF)C[C]=O(9983)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C[C](F)CF(843)'],
    products = ['[O]C(F)(CF)C[C]=O(9983)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[C]=O(129)', '[CH2]C([O])(F)CF(1051)'],
    products = ['[O]C(F)(CF)C[C]=O(9983)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C([O])(F)CF(1051)'],
    products = ['[O]C(F)(CF)C[C]=O(9983)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]CC(=O)CF(10223)'],
    products = ['[O]C(F)(CF)C[C]=O(9983)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2F(46)', 'O=[C]CC(=O)F(550)'],
    products = ['[O]C(F)(CF)C[C]=O(9983)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)(C=C=O)CF(9974)'],
    products = ['[O]C(F)(CF)C[C]=O(9983)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'C=C([O])C[C]=O(650)'],
    products = ['[O]C(F)(CF)C[C]=O(9983)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[O]C(=C[C]=O)CF(10224)'],
    products = ['[O]C(F)(CF)C[C]=O(9983)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)(CF)C[C]=O(9983)'],
    products = ['O=[C][CH]C(O)(F)CF(10226)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)(CF)C[C]=O(9983)'],
    products = ['O=[C]CC(O)(F)[CH]F(10227)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)([CH]F)CC=O(10228)'],
    products = ['[O]C(F)(CF)C[C]=O(9983)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(F)(C[C]=O)OF(10231)'],
    products = ['[O]C(F)(CF)C[C]=O(9983)'],
