...
reaction(
    label = 'reaction10',
    reactants = ['[O]OC(=O)F(1124)', 'CH3(19)'],
    products = ['CC([O])(F)O[O](969)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(=O)O[O](200)'],
    products = ['CC([O])(F)O[O](969)'],
