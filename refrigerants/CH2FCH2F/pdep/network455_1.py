...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)C(F)[CH]F(882)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', 'F[CH]C(F)[CH]F(892)'],
    products = ['F[CH]C(F)C(F)[CH]F(882)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]C(F)C=CF(887)'],
    products = ['F[CH]C(F)C(F)[CH]F(882)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHFCHF[Z](59)', 'F[CH][CH]F(493)'],
    products = ['F[CH]C(F)C(F)[CH]F(882)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[CH]C(F)C(F)=CF(904)'],
    products = ['F[CH]C(F)C(F)[CH]F(882)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH][CH]F(493)', 'F[CH][CH]F(493)'],
    products = ['F[CH]C(F)C(F)[CH]F(882)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F2(78)', 'F[CH]C=C[CH]F(888)'],
    products = ['F[CH]C(F)C(F)[CH]F(882)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', 'F[CH]C(F)[CH]F(892)'],
    products = ['F[CH]C(F)C(F)[CH]F(882)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]C(F)C(F)[CH]F(882)'],
    products = ['F[CH]C(F)[CH]C(F)F(908)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]C(F)C(F)[CH]F(882)'],
    products = ['F[CH][CH]C(F)C(F)F(909)'],
