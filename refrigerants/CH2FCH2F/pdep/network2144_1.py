...
"""),
    E0 = (-1120.06,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,435,565,619,662,854,1178,1396,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,202.235,202.263,202.277,202.286],'cm^-1')),
        HinderedRotor(inertia=(0.301947,'amu*angstrom^2'), symmetry=1, barrier=(8.76619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301857,'amu*angstrom^2'), symmetry=1, barrier=(8.76611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301893,'amu*angstrom^2'), symmetry=1, barrier=(8.76636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15237,'amu*angstrom^2'), symmetry=1, barrier=(33.4687,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0832826,0.0971952,-0.000158118,1.32774e-07,-4.39566e-11,-134572,29.2385], Tmin=(100,'K'), Tmax=(791.019,'K')), NASAPolynomial(coeffs=[12.8876,0.0263395,-1.37712e-05,2.70528e-09,-1.89161e-13,-136459,-29.2564], Tmin=(791.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1120.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFFOO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H))"""),
)

species(
    label = 'OC(F)(F)OC(F)[CH]F(5583)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1096.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,435,565,619,662,854,1178,1396,334,575,1197,1424,3202,218.397,218.405,218.416,218.419],'cm^-1')),
        HinderedRotor(inertia=(0.285723,'amu*angstrom^2'), symmetry=1, barrier=(9.67118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.285716,'amu*angstrom^2'), symmetry=1, barrier=(9.67115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.797846,'amu*angstrom^2'), symmetry=1, barrier=(27.0064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08202,'amu*angstrom^2'), symmetry=1, barrier=(36.6233,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.190472,0.0902307,-0.000128633,9.3932e-08,-2.7312e-11,-131804,27.7636], Tmin=(100,'K'), Tmax=(840.723,'K')), NASAPolynomial(coeffs=[13.7375,0.0257773,-1.36379e-05,2.74604e-09,-1.97023e-13,-134082,-35.243], Tmin=(840.723,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1096.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFFOO) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-1099.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,493,600,700,1144,1293,180,180,180,1771.69],'cm^-1')),
        HinderedRotor(inertia=(0.355842,'amu*angstrom^2'), symmetry=1, barrier=(8.18151,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.356028,'amu*angstrom^2'), symmetry=1, barrier=(8.18578,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.38202,0.0657452,-9.88053e-05,9.0913e-08,-3.64229e-11,-132292,15.7795], Tmin=(10,'K'), Tmax=(578.688,'K')), NASAPolynomial(coeffs=[7.33897,0.038394,-2.79093e-05,9.23871e-09,-1.13872e-12,-132750,-1.14604], Tmin=(578.688,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-1099.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""F[C](F)OC(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-1246.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,482,664,788,1296,1923,302.121,303.247,303.377,1121.52],'cm^-1')),
        HinderedRotor(inertia=(0.455551,'amu*angstrom^2'), symmetry=1, barrier=(29.3981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.387503,'amu*angstrom^2'), symmetry=1, barrier=(24.8588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.454409,'amu*angstrom^2'), symmetry=1, barrier=(29.3872,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0238,0.0655288,-6.59247e-05,3.23846e-08,-6.35377e-12,-149798,25.2623], Tmin=(100,'K'), Tmax=(1219.3,'K')), NASAPolynomial(coeffs=[14.7203,0.0205961,-1.06476e-05,2.16098e-09,-1.56827e-13,-153138,-43.5312], Tmin=(1219.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1246.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(COFOO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02849,'amu*angstrom^2'), symmetry=1, barrier=(23.6471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02924,'amu*angstrom^2'), symmetry=1, barrier=(23.6642,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    ...
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(133.449,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'OC(F)(F)OC(F)[C]F(5479)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'OC(F)(F)O[CH]C(F)F(5582)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(F)(F)OC(F)[CH]F(5583)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[C](F)OC(F)C(F)F(5584)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(O)(F)F(2300)', 'CHF2-CHF(67)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O[C](F)F(1777)', '[O]C(F)C(F)F(1662)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'F[C](F)OC(F)C(F)F(5585)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)(F)OC(F)C(F)F(5586)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF2(82)', 'OC(F)(F)O[CH]F(3787)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)(F)O[C](F)C(F)F(5587)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'OC(F)(F)OC(F)[C](F)F(5588)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'O=C(F)OC(F)C(F)F(5589)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', 'OC(F)(F)OC=CF(5590)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'OC(F)(F)OC=C(F)F(5018)'],
    products = ['OC(F)(F)OC(F)C(F)F(5533)'],
