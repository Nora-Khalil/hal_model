...
reaction(
    label = 'reaction2',
    reactants = ['C#CO(429)', 'C[C]F(137)'],
    products = ['C#COC(C)F(210)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'C#CO[CH]F(1547)'],
    products = ['C#COC(C)F(210)'],
    transitionState = 'TS8',
