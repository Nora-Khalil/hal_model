...
"""),
    E0 = (-652.101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,306.765,306.768,306.771,306.772],'cm^-1')),
        HinderedRotor(inertia=(0.243861,'amu*angstrom^2'), symmetry=1, barrier=(16.2854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243864,'amu*angstrom^2'), symmetry=1, barrier=(16.2853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243865,'amu*angstrom^2'), symmetry=1, barrier=(16.2853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243872,'amu*angstrom^2'), symmetry=1, barrier=(16.2853,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-675.764,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,222.426,222.448,2138.64],'cm^-1')),
        HinderedRotor(inertia=(0.244342,'amu*angstrom^2'), symmetry=1, barrier=(8.58026,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.89373,'amu*angstrom^2'), symmetry=1, barrier=(31.3476,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244633,'amu*angstrom^2'), symmetry=1, barrier=(8.58292,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.39215,0.0540375,-6.81558e-05,5.2307e-08,-1.74501e-11,-81272.7,13.1672], Tmin=(10,'K'), Tmax=(688.573,'K')), NASAPolynomial(coeffs=[7.1528,0.0321913,-2.05654e-05,6.23033e-09,-7.2096e-13,-81790.6,-3.57247], Tmin=(688.573,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-675.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""[CH2]OC(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-816.543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,2750,2850,1437.5,1250,1305,750,350,180,382.171,850.537,851.336,851.776],'cm^-1')),
        HinderedRotor(inertia=(1.11328,'amu*angstrom^2'), symmetry=1, barrier=(25.5965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11422,'amu*angstrom^2'), symmetry=1, barrier=(25.618,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11327,'amu*angstrom^2'), symmetry=1, barrier=(25.5963,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.885711,0.0647316,-5.89798e-05,2.60665e-08,-4.57616e-12,-98092.4,25.0857], Tmin=(100,'K'), Tmax=(1359.84,'K')), NASAPolynomial(coeffs=[16.0649,0.0200817,-9.72787e-06,1.92052e-09,-1.37048e-13,-102221,-52.8106], Tmin=(1359.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-816.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-OsOsHH) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-840.499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,395,473,707,1436,326.482,326.482,326.482,326.482],'cm^-1')),
        HinderedRotor(inertia=(0.235707,'amu*angstrom^2'), symmetry=1, barrier=(17.8286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235707,'amu*angstrom^2'), symmetry=1, barrier=(17.8286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235707,'amu*angstrom^2'), symmetry=1, barrier=(17.8286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235707,'amu*angstrom^2'), symmetry=1, barrier=(17.8286,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.331161,0.0697472,-6.04277e-05,1.56532e-08,2.13432e-12,-100947,28.9373], Tmin=(100,'K'), Tmax=(986.884,'K')), NASAPolynomial(coeffs=[20.9939,0.00903233,-3.15598e-06,6.15473e-10,-4.75689e-14,-106147,-76.1586], Tmin=(986.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-840.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs))"""),
)

species(
    label = 'OCOC(F)[C](F)F(7349)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-836.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,296.382,299.545,299.561,302.854],'cm^-1')),
        HinderedRotor(inertia=(0.319679,'amu*angstrom^2'), symmetry=1, barrier=(20.4622,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.319568,'amu*angstrom^2'), symmetry=1, barrier=(20.4927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.315601,'amu*angstrom^2'), symmetry=1, barrier=(20.4833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.320295,'amu*angstrom^2'), symmetry=1, barrier=(20.4709,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.18468,0.0711885,-5.7192e-05,7.45099e-09,6.19482e-12,-100407,28.5749], Tmin=(100,'K'), Tmax=(966.423,'K')), NASAPolynomial(coeffs=[22.8908,0.00632162,-1.69828e-06,3.41198e-10,-2.95724e-14,-106155,-87.2275], Tmin=(966.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-836.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-OsOsHH) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.04567,'amu*angstrom^2'), symmetry=1, barrier=(24.0419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04792,'amu*angstrom^2'), symmetry=1, barrier=(24.0936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04755,'amu*angstrom^2'), symmetry=1, barrier=(24.0853,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.707668,0.0515959,1.47439e-06,-6.32079e-08,3.47924e-11,-83729.4,23.1202], Tmin=(100,'K'), Tmax=(916.521,'K')), NASAPolynomial(coeffs=[26.4434,-0.00591464,5.89657e-06,-1.17714e-09,7.46476e-14,-90748.8,-111.355], Tmin=(916.521,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-697.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)
...
reaction(
    ...
    products = ['OCOC(F)C(F)F(6741)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(127.987,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'OCOC(F)[C]F(7344)'],
    products = ['OCOC(F)C(F)F(6741)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'OCO[CH]C(F)F(7345)'],
    products = ['OCOC(F)C(F)F(6741)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OCOC(F)[CH]F(7346)'],
    products = ['OCOC(F)C(F)F(6741)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]CO(521)', 'CHF2-CHF(67)'],
    products = ['OCOC(F)C(F)F(6741)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2OH(33)', '[O]C(F)C(F)F(1662)'],
    products = ['OCOC(F)C(F)F(6741)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', '[CH2]OC(F)C(F)F(5885)'],
    products = ['OCOC(F)C(F)F(6741)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]COC(F)C(F)F(7347)'],
    products = ['OCOC(F)C(F)F(6741)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF2(82)', 'OCO[CH]F(4532)'],
    products = ['OCOC(F)C(F)F(6741)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'OCO[C](F)C(F)F(7348)'],
    products = ['OCOC(F)C(F)F(6741)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OCOC(F)[C](F)F(7349)'],
    products = ['OCOC(F)C(F)F(6741)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O[CH]OC(F)C(F)F(6500)'],
    products = ['OCOC(F)C(F)F(6741)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'OCOC=C(F)F(4976)'],
    products = ['OCOC(F)C(F)F(6741)'],
