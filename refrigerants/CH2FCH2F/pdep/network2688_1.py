...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.255386,'amu*angstrom^2'), symmetry=1, barrier=(5.87182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.053,0.055336,-0.000114385,1.21336e-07,-4.67964e-11,-6515.47,19.2675], Tmin=(100,'K'), Tmax=(857.281,'K')), NASAPolynomial(coeffs=[1.09517,0.0293363,-1.55811e-05,3.04241e-09,-2.09633e-13,-5231.62,30.271], Tmin=(857.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.6554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Cdj(Cs-O2sHH)(Cd-F1sF1s))"""),
)

species(
    label = 'FC(F)=C1COC1F(7442)',
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.993782,0.0714105,-9.94567e-05,7.60539e-08,-2.36343e-11,-41269.2,24.4933], Tmin=(100,'K'), Tmax=(783.261,'K')), NASAPolynomial(coeffs=[9.82028,0.0263344,-1.31318e-05,2.5783e-09,-1.82226e-13,-42651.9,-15.9331], Tmin=(783.261,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-343.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsCsFFH) + ring(Cs(C-FF)-Cs-O2s) + radical(CsCsF1sH) + radical(CsCsF1sF1s)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.490756,0.0672767,-6.05255e-05,1.78368e-08,1.13896e-12,-59247.1,27.9543], Tmin=(100,'K'), Tmax=(980.078,'K')), NASAPolynomial(coeffs=[20.0382,0.00855342,-2.87616e-06,5.43457e-10,-4.14119e-14,-64090,-71.1167], Tmin=(980.078,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-493.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(Csj(Cd-CsCd)(F1s)(H)) + radical(Csj(Cd-CsCd)(F1s)(F1s))"""),
)

species(
    label = '[O]C=C(CF)[C](F)F(8175)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.870849,0.0634136,-6.25656e-05,2.99011e-08,-5.59507e-12,-59783.2,26.8528], Tmin=(100,'K'), Tmax=(1297.63,'K')), NASAPolynomial(coeffs=[16.4589,0.0153622,-7.01995e-06,1.36382e-09,-9.70567e-14,-63828.7,-52.4118], Tmin=(1297.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cd-CsCd)(F1s)(F1s))"""),
)

species(
    label = 'F[C]C(=CF)COF(8176)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-48.2767,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,194,682,905,1196,1383,3221,180,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.52046,'amu*angstrom^2'), symmetry=1, barrier=(34.9583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0100385,'amu*angstrom^2'), symmetry=1, barrier=(10.4405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000170539,'amu*angstrom^2'), symmetry=1, barrier=(0.609831,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.779631,0.0781887,-0.000126849,1.11975e-07,-3.91531e-11,-5697.47,25.5253], Tmin=(100,'K'), Tmax=(802.698,'K')), NASAPolynomial(coeffs=[8.68474,0.0284989,-1.47519e-05,2.89391e-09,-2.02367e-13,-6634.83,-8.80863], Tmin=(802.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.2767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[O]CC(=[C]F)C(F)F(8177)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-295.671,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,167,640,1190,180,1781.32,1781.71],'cm^-1')),
        HinderedRotor(inertia=(0.262889,'amu*angstrom^2'), symmetry=1, barrier=(6.04433,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263278,'amu*angstrom^2'), symmetry=1, barrier=(6.05328,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09195,0.0753769,-0.000134458,1.31533e-07,-4.9075e-11,-35467.3,27.0792], Tmin=(100,'K'), Tmax=(838.086,'K')), NASAPolynomial(coeffs=[4.1198,0.0357982,-1.86476e-05,3.63612e-09,-2.51967e-13,-35092.4,18.2712], Tmin=(838.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-295.671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(CCOJ) + radical(Cdj(Cd-CsCs)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.747505,0.0647747,-6.51308e-05,3.16301e-08,-5.97541e-12,-62894.8,26.434], Tmin=(100,'K'), Tmax=(1292.83,'K')), NASAPolynomial(coeffs=[17.2139,0.0138283,-6.02086e-06,1.14944e-09,-8.12769e-14,-67152.5,-57.2361], Tmin=(1292.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-523.958,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFFH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cd-CsCd)(F1s)(H))"""),
)

species(
    label = 'OCC([C]F)=C(F)F(8181)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-383.816,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,182,240,577,636,1210,1413,336.454,336.485,1390.34,1390.49],'cm^-1')),
        HinderedRotor(inertia=(0.0863632,'amu*angstrom^2'), symmetry=1, barrier=(6.93748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0863088,'amu*angstrom^2'), symmetry=1, barrier=(6.93452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.086288,'amu*angstrom^2'), symmetry=1, barrier=(6.93538,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.915529,0.0750568,-0.000121612,1.07561e-07,-3.75335e-11,-46058.3,25.8733], Tmin=(100,'K'), Tmax=(814.792,'K')), NASAPolynomial(coeffs=[8.23334,0.0279139,-1.4172e-05,2.75561e-09,-1.91578e-13,-46878.4,-5.64693], Tmin=(814.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-383.816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]C(COF)=C(F)F(8182)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-73.697,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,182,240,577,636,1210,1413,478.756,478.757,478.758,478.758,478.758],'cm^-1')),
        HinderedRotor(inertia=(0.324867,'amu*angstrom^2'), symmetry=1, barrier=(52.8398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.324866,'amu*angstrom^2'), symmetry=1, barrier=(52.8398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.324864,'amu*angstrom^2'), symmetry=1, barrier=(52.8398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.920772,0.0727202,-9.14322e-05,6.67247e-08,-2.0291e-11,-8757.37,25.8833], Tmin=(100,'K'), Tmax=(793.296,'K')), NASAPolynomial(coeffs=[8.87316,0.0326218,-1.56115e-05,3.00609e-09,-2.10445e-13,-10019.1,-10.6409], Tmin=(793.296,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFF) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C[O])C(F)(F)F(8183)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1408,0.070864,-0.00011465,1.05473e-07,-3.82653e-11,-42711.8,25.57], Tmin=(100,'K'), Tmax=(816.393,'K')), NASAPolynomial(coeffs=[6.11295,0.0318913,-1.6198e-05,3.15404e-09,-2.19581e-13,-43036.7,5.573], Tmin=(816.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-355.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(CsCdFFF) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC([CH]F)=C(F)F(7434)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C([CH]F)=C(F)F(7622)'],
    products = ['[O]CC([CH]F)=C(F)F(7434)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', '[O]C[C]=C(F)F(8170)'],
    products = ['[O]CC([CH]F)=C(F)F(7434)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]CC([CH]F)=C(F)F(7434)'],
    products = ['[O]C[C]1C(F)C1(F)F(8172)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]CC([CH]F)=C(F)F(7434)'],
    products = ['F[CH][C]1COC1(F)F(8173)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]CC([CH]F)=C(F)F(7434)'],
    products = ['F[CH]C1([C](F)F)CO1(8116)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CC([CH]F)=C(F)F(7980)'],
    products = ['[O]CC([CH]F)=C(F)F(7434)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[O]C[C]=C(F)F(8170)'],
    products = ['[O]CC([CH]F)=C(F)F(7434)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C]F(744)', '[O]C[C]=CF(2259)'],
    products = ['[O]CC([CH]F)=C(F)F(7434)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CF2(43)', '[O]C[C]=CF(2259)'],
    products = ['[O]CC([CH]F)=C(F)F(7434)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]CC([CH]F)=C(F)F(7434)'],
    products = ['[O]C=C([CH]F)C(F)F(8180)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=C(C[O])C(F)(F)F(8183)'],
    products = ['[O]CC([CH]F)=C(F)F(7434)'],
...
network(
    label = 'PDepNetwork #2688',
    isomers = [
        '[O]CC([CH]F)=C(F)F(7434)',
    ],
    reactants = [
