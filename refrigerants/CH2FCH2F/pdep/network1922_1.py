...
"""),
    E0 = (-566.918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.997492,'amu*angstrom^2'), symmetry=1, barrier=(22.9343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.999819,'amu*angstrom^2'), symmetry=1, barrier=(22.9878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0002,'amu*angstrom^2'), symmetry=1, barrier=(22.9966,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00258241,0.0833024,-9.91888e-05,5.62584e-08,-1.22669e-11,-68036.5,25.6936], Tmin=(100,'K'), Tmax=(1132.29,'K')), NASAPolynomial(coeffs=[20.0432,0.0125047,-5.39826e-06,1.03588e-09,-7.40171e-14,-72574.8,-73.4803], Tmin=(1132.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-566.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCsJOC(O))"""),
)
...
"""),
    E0 = (-551.736,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,194,682,905,1196,1383,3221,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.26556,'amu*angstrom^2'), symmetry=1, barrier=(29.0977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26571,'amu*angstrom^2'), symmetry=1, barrier=(29.1012,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26594,'amu*angstrom^2'), symmetry=1, barrier=(29.1063,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.112077,0.0771297,-8.26548e-05,4.21843e-08,-8.28944e-12,-66211.4,25.934], Tmin=(100,'K'), Tmax=(1252.81,'K')), NASAPolynomial(coeffs=[20.3572,0.0124905,-5.26151e-06,1.00028e-09,-7.10887e-14,-71284,-76.2999], Tmin=(1252.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-551.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.505257,0.107248,-0.000174368,1.46445e-07,-4.84968e-11,-84483.7,30.9282], Tmin=(100,'K'), Tmax=(791.329,'K')), NASAPolynomial(coeffs=[13.7745,0.0291839,-1.52431e-05,2.99352e-09,-2.09289e-13,-86559.5,-33.4575], Tmin=(791.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-703.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(F)F(506)', '[O]C(F)[CH]F(975)'],
    products = ['F[CH]C(F)O[CH]C(F)F(4718)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'F[CH]O[CH]C(F)F(1132)'],
    products = ['F[CH]C(F)O[CH]C(F)F(4718)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['F[CH]C(F)O[CH]C(F)F(4718)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.81516e-05,'m^3/(mol*s)'), n=3.04336, Ea=(33.856,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=CO[CH]C(F)F(4731)'],
    products = ['F[CH]C(F)O[CH]C(F)F(4718)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(57.5874,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH]C(F)OC=C(F)F(1671)'],
    products = ['F[CH]C(F)O[CH]C(F)F(4718)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', 'F[CH]O[CH]C(F)F(1132)'],
    products = ['F[CH]C(F)O[CH]C(F)F(4718)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][C](F)OCC(F)F(4783)'],
    products = ['F[CH]C(F)O[CH]C(F)F(4718)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)O[CH]C(F)F(4718)'],
    products = ['F[CH][CH]OC(F)C(F)F(4784)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(225.544,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)O[CH]C(F)F(4718)'],
    products = ['FC(F)[CH]O[CH]C(F)F(4777)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.07631e+15,'s^-1'), n=-0.447076, Ea=(177.137,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.08474952276158404, var=26.08378321593064, Tref=1000.0, N=4, data_mean=0.0, correlation='R2F_Ext-1R!H-R',), comment="""Estimated from node R2F_Ext-1R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #1922',
    isomers = [
        'F[CH]C(F)O[CH]C(F)F(4718)',
    ],
    reactants = [
