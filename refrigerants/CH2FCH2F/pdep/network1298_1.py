...
"""),
    E0 = (-667.848,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,193,295,551,588,656,1146,1192,1350,3000,3100,440,815,1455,1000,204.383,204.406,1664.46,1664.47],'cm^-1')),
        HinderedRotor(inertia=(1.02691,'amu*angstrom^2'), symmetry=1, barrier=(30.4424,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00387522,'amu*angstrom^2'), symmetry=1, barrier=(7.61863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257011,'amu*angstrom^2'), symmetry=1, barrier=(7.61866,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.922478,0.0760302,-0.000125907,1.16167e-07,-4.24726e-11,-80220.8,26.5368], Tmin=(100,'K'), Tmax=(794.022,'K')), NASAPolynomial(coeffs=[7.01809,0.0318571,-1.70204e-05,3.38697e-09,-2.38897e-13,-80764.3,1.20793], Tmin=(794.022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-667.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cs-OsHHH) + radical(CCOJ) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (-647.442,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,391,562,707,872,1109,1210,1289,3137,3000,3100,440,815,1455,1000,292.025,292.025,292.025],'cm^-1')),
        HinderedRotor(inertia=(0.00246892,'amu*angstrom^2'), symmetry=1, barrier=(8.70518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143851,'amu*angstrom^2'), symmetry=1, barrier=(8.70518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.535444,'amu*angstrom^2'), symmetry=1, barrier=(32.4027,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.959731,0.0712689,-9.28846e-05,6.31807e-08,-1.72476e-11,-77763.6,25.4939], Tmin=(100,'K'), Tmax=(891.237,'K')), NASAPolynomial(coeffs=[11.7386,0.0228912,-1.14613e-05,2.2734e-09,-1.62404e-13,-79684.9,-25.2668], Tmin=(891.237,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-647.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHO) + group(Cs-OsHHH) + radical(O2sj(Cs-CsF1sH)) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95668,0.0489534,-4.13103e-05,1.89992e-08,-3.79835e-12,-123818,21.5456], Tmin=(100,'K'), Tmax=(1130.7,'K')), NASAPolynomial(coeffs=[7.85229,0.0280969,-1.36419e-05,2.68584e-09,-1.91446e-13,-125151,-7.62156], Tmin=(1130.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1030.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCOFFF) + group(Cs-OsHHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (-828.36,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([230,274,587,678,790,1206,1241,1314,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59352,0.055946,-5.89776e-05,3.21461e-08,-7.17404e-12,-99544.5,22.5258], Tmin=(100,'K'), Tmax=(1066.09,'K')), NASAPolynomial(coeffs=[10.6515,0.0219606,-1.11602e-05,2.24434e-09,-1.621e-13,-101476,-21.7534], Tmin=(1066.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-828.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCOFFF) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CsJOC(O)C)"""),
)
...
"""),
    E0 = (-413.299,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([179,346,818,1406,1524,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60414,0.0557203,-6.62276e-05,4.03589e-08,-9.9092e-12,-49624.6,21.8922], Tmin=(100,'K'), Tmax=(983.725,'K')), NASAPolynomial(coeffs=[10.7536,0.0185159,-9.49634e-06,1.91133e-09,-1.38034e-13,-51424.7,-22.0984], Tmin=(983.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-413.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(Csj(CO-O2sO2d)(F1s)(F1s)) + radical(CsJOC(O)C)"""),
)

species(
    label = '[CH2]O[C](O)C(F)(F)F(3000)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.737938,0.0776446,-0.000116425,9.15275e-08,-2.87543e-11,-82672.1,27.0396], Tmin=(100,'K'), Tmax=(779.06,'K')), NASAPolynomial(coeffs=[11.2704,0.0235727,-1.23267e-05,2.45668e-09,-1.74586e-13,-84313.4,-21.1449], Tmin=(779.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-688.307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cs-OsHHH) + radical(Cs_P) + radical(CsJOCH3)"""),
)

species(
    label = 'CO[C]([O])C(F)(F)F(3001)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-650.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,522,585,610,849,1160,1215,1402,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,180,180,2489.68,2493.51],'cm^-1')),
        HinderedRotor(inertia=(0.211655,'amu*angstrom^2'), symmetry=1, barrier=(4.86637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58087,'amu*angstrom^2'), symmetry=1, barrier=(36.3474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212523,'amu*angstrom^2'), symmetry=1, barrier=(4.88633,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04139,0.0755801,-0.000132418,1.2863e-07,-4.83503e-11,-78137.4,26.0065], Tmin=(100,'K'), Tmax=(817.086,'K')), NASAPolynomial(coeffs=[4.86118,0.0353234,-1.89407e-05,3.7538e-09,-2.63275e-13,-78042,12.7534], Tmin=(817.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-650.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cs-OsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]OC(OF)[C](F)F(3002)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-316.393,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,190,488,555,1236,1407,3000,3100,440,815,1455,1000,277.746,278.265,2043.73,2043.91],'cm^-1')),
        HinderedRotor(inertia=(0.171791,'amu*angstrom^2'), symmetry=1, barrier=(9.18115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168526,'amu*angstrom^2'), symmetry=1, barrier=(9.18278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.50098,'amu*angstrom^2'), symmetry=1, barrier=(27.4712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.506605,'amu*angstrom^2'), symmetry=1, barrier=(27.4694,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC([O])C(F)(F)F(2728)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[CH2]OC([O])F(1847)'],
    products = ['[CH2]OC([O])C(F)(F)F(2728)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33582e-06,'m^3/(mol*s)'), n=3.3552, Ea=(249.968,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R',), comment="""Estimated from node CY_N-2Br1sCl1sF1sHI1s->H_Ext-4Cs-R"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[CH2]OC(F)(F)C([O])F(2995)'],
    products = ['[CH2]OC([O])C(F)(F)F(2728)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C([O])C(F)(F)F(2891)'],
    products = ['[CH2]OC([O])C(F)(F)F(2728)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2]OC([O])C(F)(F)F(2728)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(40.3168,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]OC(OF)[C](F)F(3002)'],
    products = ['[CH2]OC([O])C(F)(F)F(2728)'],
