...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=[C]O[O](452)'],
    products = ['[CH2]OO[C]=C(612)'],
    transitionState = 'TS2',
