...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'FOCC(F)F(3109)'],
    products = ['FOC(F)CC(F)F(3091)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['HF(38)', 'F[C]CC(F)OF(1534)'],
    products = ['FOC(F)CC(F)F(3091)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(140)', 'FC=CC(F)F(1788)'],
    products = ['FOC(F)CC(F)F(3091)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'FO[CH]CC(F)F(3110)'],
    products = ['FOC(F)CC(F)F(3091)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]CC(F)OF(1540)'],
    products = ['FOC(F)CC(F)F(3091)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]C(F)CC(F)F(1834)'],
    products = ['FOC(F)CC(F)F(3091)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'F[CH]CC(F)F(1833)'],
    products = ['FOC(F)CC(F)F(3091)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH]OF(1060)', 'CHF2-CH2(64)'],
    products = ['FOC(F)CC(F)F(3091)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF2(82)', '[CH2]C(F)OF(488)'],
    products = ['FOC(F)CC(F)F(3091)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'FOC(F)[CH]C(F)F(3111)'],
    products = ['FOC(F)CC(F)F(3091)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'FO[C](F)CC(F)F(3112)'],
    products = ['FOC(F)CC(F)F(3091)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'FOC(F)C[C](F)F(3113)'],
    products = ['FOC(F)CC(F)F(3091)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'FOC=CC(F)F(3114)'],
    products = ['FOC(F)CC(F)F(3091)'],
