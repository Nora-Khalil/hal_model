...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C(F)F(814)'],
    products = ['[CH]=CC([O])(F)F(3251)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O][C](F)F(2186)', 'C2H2(23)'],
    products = ['[CH]=CC([O])(F)F(3251)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(2186)', '[CH]=[CH](257)'],
    products = ['[CH]=CC([O])(F)F(3251)'],
    transitionState = 'TS8',
