...
species(
    label = 'F[C](F)C1O[CH]C1(F)F(9568)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
species(
    label = 'F[CH]C(F)(F)C1(F)[CH]O1(9355)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-643.147,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,234,347,1316,1464,190,488,555,1236,1407,2782.5,750,1395,475,1775,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.633084,'amu*angstrom^2'), symmetry=1, barrier=(14.5559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.20742,'amu*angstrom^2'), symmetry=1, barrier=(50.7529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0790823,'amu*angstrom^2'), symmetry=1, barrier=(1.81826,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.607458,0.0812548,-0.000127213,1.0809e-07,-3.69014e-11,-77236.8,28.5581], Tmin=(100,'K'), Tmax=(763.557,'K')), NASAPolynomial(coeffs=[10.0174,0.0279468,-1.46065e-05,2.89041e-09,-2.03808e-13,-78556.9,-13.5349], Tmin=(763.557,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-643.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdCsH) + radical(CsCOCsF1s) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)
...
species(
    label = 'F[C](C(F)F)C1(F)[CH]O1(9575)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'FC([C]1[CH]O1)C(F)(F)F(9577)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
species(
    label = 'FC(F)(F)[CH]C1(F)[CH]O1(9579)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    products = ['F[C](F)C1O[CH]C1(F)F(9568)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F[CH]C(F)(F)C1(F)[CH]O1(9355)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(744)', 'F[CH]C1(F)[CH]O1(9246)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    products = ['FC1C(F)(F)C2OC12F(9569)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    products = ['FC(F)=C(F)C1(F)CO1(9570)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C[C](F)C(F)[C](F)F(9571)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)C(F)C1=CO1(9572)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'FC(F)=CC1(F)[CH]O1(9274)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FC(F)=C(F)C1(F)[CH]O1(9573)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F2(78)', 'F[C](F)C=C1[CH]O1(9275)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'F[C](F)C(F)=C1[CH]O1(9574)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', 'F[CH]C1(F)[CH]O1(9246)'],
    products = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    products = ['F[C](C(F)F)C1(F)[CH]O1(9575)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    products = ['F[C](F)[C](F)C1(F)CO1(9576)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    products = ['FC([C]1[CH]O1)C(F)(F)F(9577)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    products = ['F[C](F)[CH]C1(F)OC1F(9578)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C](F)C(F)C1(F)[CH]O1(9357)'],
    products = ['FC(F)(F)[CH]C1(F)[CH]O1(9579)'],
