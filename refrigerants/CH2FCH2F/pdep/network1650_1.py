...
reaction(
    label = 'reaction2',
    reactants = ['OF(140)', 'OC(F)(F)[C]F(3485)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'OC(F)(F)OF(3467)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(140)', 'F[C]C(F)OF(1513)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(1520)', 'OC(F)=CF(3655)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H2O(3)', 'FOC(F)=C(F)F(3487)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(140)', 'FOC=C(F)F(1650)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'OC(F)(F)[CH]OF(3656)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O[C](F)C(F)OF(3657)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(O)(F)F(3658)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'OC(F)(F)[CH]F(3659)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'FOC(F)[C](F)F(3105)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(F)OF(3660)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(1060)', 'O[C](F)F(1777)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'OC(F)(F)[C](F)OF(3490)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F2(78)', 'O=CC(O)(F)F(1711)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(F)OF(3661)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'O=C(F)C(O)(F)F(2349)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)=C(F)OF(3495)'],
    products = ['OC(F)(F)C(F)OF(3597)'],
