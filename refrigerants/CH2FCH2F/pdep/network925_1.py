...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH]C(=C)F(1947)'],
    products = ['[CH]=C(F)C[C]=O(2005)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C=C=O(2028)'],
    products = ['[CH]=C(F)C[C]=O(2005)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C[C]=O(2029)'],
    products = ['[CH]=C(F)C[C]=O(2005)'],
