...
reaction(
    label = 'reaction4',
    reactants = ['FOF(1520)', 'OC[C]F-2(457)'],
    products = ['OCC(F)(F)OF(4116)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(140)', 'OC=C(F)F(1567)'],
    products = ['OCC(F)(F)OF(4116)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(F)(F)CO(4404)'],
    products = ['OCC(F)(F)OF(4116)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]C(F)(F)OF(2648)'],
    products = ['OCC(F)(F)OF(4116)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]CC(F)(F)OF(4405)'],
    products = ['OCC(F)(F)OF(4116)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'OC[C](F)F(529)'],
    products = ['OCC(F)(F)OF(4116)'],
...
reaction(
    label = 'reaction13',
    reactants = ['FO[C](F)F(2145)', 'CH2OH(33)'],
    products = ['OCC(F)(F)OF(4116)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O[CH]C(F)(F)OF(3649)'],
    products = ['OCC(F)(F)OF(4116)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'OC=C(F)OF(3654)'],
    products = ['OCC(F)(F)OF(4116)'],
