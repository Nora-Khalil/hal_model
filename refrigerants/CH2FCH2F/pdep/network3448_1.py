...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.226445,'amu*angstrom^2'), symmetry=1, barrier=(5.20641,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227526,'amu*angstrom^2'), symmetry=1, barrier=(5.23127,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24276,'amu*angstrom^2'), symmetry=1, barrier=(51.5654,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46096,0.0615359,-7.2181e-05,4.7482e-08,-1.31664e-11,-120113,23.1513], Tmin=(100,'K'), Tmax=(858.592,'K')), NASAPolynomial(coeffs=[8.49831,0.0287508,-1.49048e-05,3.00964e-09,-2.17403e-13,-121322,-9.72705], Tmin=(858.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-999.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsFHHO) + group(COCsFO)"""),
)
...
"""),
    E0 = (-182.59,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,548,1085,1183,1302,1466,1520,3060,3119,615,860,1140,1343,3152,1685,370,180,363.745],'cm^-1')),
        HinderedRotor(inertia=(0.498818,'amu*angstrom^2'), symmetry=1, barrier=(11.4688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.02198,'amu*angstrom^2'), symmetry=1, barrier=(46.4894,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.02274,'amu*angstrom^2'), symmetry=1, barrier=(46.5069,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70555,0.0572373,-6.96957e-05,4.25303e-08,-6.82946e-12,-21884.3,22.2754], Tmin=(100,'K'), Tmax=(568.676,'K')), NASAPolynomial(coeffs=[6.88884,0.028678,-1.52007e-05,3.07145e-09,-2.20993e-13,-22601.6,-0.928272], Tmin=(568.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.59,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-O2s))"""),
)

species(
    label = '[CH]=C(F)OOCF(10368)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-179.321,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,548,1085,1183,1302,1466,1520,3060,3119,293,496,537,1218,3120,650,792.5,1650,265.011],'cm^-1')),
        HinderedRotor(inertia=(0.0992828,'amu*angstrom^2'), symmetry=1, barrier=(2.28271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.859448,'amu*angstrom^2'), symmetry=1, barrier=(19.7604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.46909,'amu*angstrom^2'), symmetry=1, barrier=(56.7692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37675,0.0641163,-0.000100158,9.08718e-08,-3.35349e-11,-21479,24.056], Tmin=(100,'K'), Tmax=(759.919,'K')), NASAPolynomial(coeffs=[6.56295,0.029023,-1.55015e-05,3.10583e-09,-2.20834e-13,-22042.2,1.94022], Tmin=(759.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFHHO) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.871876,0.0826911,-0.000153918,1.54231e-07,-5.83334e-11,-58357.9,37.2221], Tmin=(100,'K'), Tmax=(839.01,'K')), NASAPolynomial(coeffs=[3.19087,0.0401197,-2.14643e-05,4.21447e-09,-2.92714e-13,-57637.8,33.0518], Tmin=(839.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-486.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFHHO) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OOCF(10370)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
4  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.31794,'amu*angstrom^2'), symmetry=1, barrier=(30.3021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31962,'amu*angstrom^2'), symmetry=1, barrier=(30.3407,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.32027,'amu*angstrom^2'), symmetry=1, barrier=(30.3557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31864,'amu*angstrom^2'), symmetry=1, barrier=(30.3182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06666,0.0751852,-9.48552e-05,4.13465e-08,1.0339e-11,-49072.1,23.5826], Tmin=(100,'K'), Tmax=(527.605,'K')), NASAPolynomial(coeffs=[9.08494,0.0311483,-1.72859e-05,3.51526e-09,-2.52196e-13,-50151.4,-12.1837], Tmin=(527.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-408.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFFO) + group(CsFHHO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'F[C]C(F)OOCF(5197)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.44647,'amu*angstrom^2'), symmetry=1, barrier=(33.2572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44579,'amu*angstrom^2'), symmetry=1, barrier=(33.2416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44645,'amu*angstrom^2'), symmetry=1, barrier=(33.2567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44645,'amu*angstrom^2'), symmetry=1, barrier=(33.2567,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20912,0.0678831,-8.27198e-05,5.50538e-08,-1.52892e-11,-53731.7,24.8993], Tmin=(100,'K'), Tmax=(860.562,'K')), NASAPolynomial(coeffs=[9.46516,0.0295076,-1.5829e-05,3.23381e-09,-2.34937e-13,-55152.7,-13.6914], Tmin=(860.562,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-447.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(CsFHHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.773091,'amu*angstrom^2'), symmetry=1, barrier=(17.7749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78752,'amu*angstrom^2'), symmetry=1, barrier=(41.0986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247448,'amu*angstrom^2'), symmetry=1, barrier=(41.0714,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52283,0.060333,-9.4286e-05,8.45822e-08,-3.11821e-11,-14928.2,21.9417], Tmin=(100,'K'), Tmax=(725.572,'K')), NASAPolynomial(coeffs=[6.96296,0.026009,-1.43689e-05,2.92235e-09,-2.09813e-13,-15603.5,-1.77263], Tmin=(725.572,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(CsFHHO) + group(Ct-CtOs) + group(CtCF)"""),
)

species(
    label = 'F[C-]=[O+]OCF(10371)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (-499.71,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,180,180,180,386.774,1184.67,1184.67,1184.7,1184.71],'cm^-1')),
        HinderedRotor(inertia=(2.13672,'amu*angstrom^2'), symmetry=1, barrier=(49.1274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147586,'amu*angstrom^2'), symmetry=1, barrier=(3.3933,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'FC=C(F)OOF(10365)'],
    products = ['FC=C(F)OOCF(10035)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OOC(F)=CF(10297)'],
    products = ['FC=C(F)OOCF(10035)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'FC=[C]OOCF(10367)'],
    products = ['FC=C(F)OOCF(10035)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=C(F)OOCF(10368)'],
    products = ['FC=C(F)OOCF(10035)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]CF(180)', 'O=C(F)[CH]F(980)'],
    products = ['FC=C(F)OOCF(10035)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', '[O]OC(F)=CF(979)'],
    products = ['FC=C(F)OOCF(10035)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OCF(414)', 'CHFCF[Z](72)'],
    products = ['FC=C(F)OOCF(10035)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'F[C]=C(F)OOCF(10369)'],
    products = ['FC=C(F)OOCF(10035)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHF(40)', 'F[C-]=[O+]OCF(10371)'],
    products = ['FC=C(F)OOCF(10035)'],
