...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC=C(F)F(785)'],
    products = ['FC1(F)[CH]OO1(1553)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[O]O[C]=C(F)F(1556)'],
    products = ['[O]OC=C(F)F(785)'],
    transitionState = 'TS6',
