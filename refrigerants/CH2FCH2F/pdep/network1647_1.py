...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)(F)OF(3468)', 'CH2(S)(25)'],
    products = ['FCOC(F)(F)OF(3594)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'FCO[C](F)OF(3600)'],
    products = ['FCOC(F)(F)OF(3594)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(F)(F)OF(3601)'],
    products = ['FCOC(F)(F)OF(3594)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)OCF(3602)'],
    products = ['FCOC(F)(F)OF(3594)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FO[C](F)F(2145)', '[O]CF(180)'],
    products = ['FCOC(F)(F)OF(3594)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)OF(3472)', 'CH2F(46)'],
    products = ['FCOC(F)(F)OF(3594)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(127)', 'FCO[C](F)F(2327)'],
    products = ['FCOC(F)(F)OF(3594)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]OC(F)(F)OF(3470)'],
    products = ['FCOC(F)(F)OF(3594)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F2(78)', 'O=C(F)OCF(1173)'],
    products = ['FCOC(F)(F)OF(3594)'],
