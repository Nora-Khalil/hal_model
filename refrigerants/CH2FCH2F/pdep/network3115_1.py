...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(129)', '[CH2]C1(F)[CH]O1(9221)'],
    products = ['O=[C]CC1(F)[CH]O1(9324)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C1(F)[CH]O1(9221)'],
    products = ['O=[C]CC1(F)[CH]O1(9324)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=[C]CC1=CO1(9393)'],
    products = ['O=[C]CC1(F)[CH]O1(9324)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C=CC1(F)[CH]O1(9394)'],
    products = ['O=[C]CC1(F)[CH]O1(9324)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=[C]C=C1[CH]O1(9395)'],
    products = ['O=[C]CC1(F)[CH]O1(9324)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]CC1(F)[CH]O1(9324)'],
    products = ['O=C(F)C[C]1[CH]O1(9398)'],
