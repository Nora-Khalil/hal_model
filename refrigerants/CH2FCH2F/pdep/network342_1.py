...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]C[C]=O(334)'],
    products = ['O=[C]CC[C]=O(653)'],
    transitionState = 'TS3',
