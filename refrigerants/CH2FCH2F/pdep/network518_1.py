...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', '[O]C[C](F)F(518)'],
    products = ['F[CH]OC[C](F)F(1111)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]OC=C(F)F(1135)'],
    products = ['F[CH]OC[C](F)F(1111)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[O]C[C](F)F(518)'],
    products = ['F[CH]OC[C](F)F(1111)'],
