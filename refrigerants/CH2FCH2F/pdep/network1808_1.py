...
reaction(
    label = 'reaction3',
    reactants = ['OF(140)', 'O=C(O)[C]F(3707)'],
    products = ['O=C(O)C(F)OF(4091)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'O=C=C(F)OF(3708)'],
    products = ['O=C(O)C(F)OF(4091)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'O=C(O)[CH]OF(4288)'],
    products = ['O=C(O)C(F)OF(4091)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)C(=O)O(4289)'],
    products = ['O=C(O)C(F)OF(4091)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'O=C(O)[CH]F(2553)'],
    products = ['O=C(O)C(F)OF(4091)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'O=[C]C(F)OF(4175)'],
    products = ['O=C(O)C(F)OF(4091)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(F)OF(4290)'],
    products = ['O=C(O)C(F)OF(4091)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]OF(1060)', 'O=[C]O(158)'],
    products = ['O=C(O)C(F)OF(4091)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)[C](F)OF(3712)'],
    products = ['O=C(O)C(F)OF(4091)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(O)C(=O)F(2625)'],
    products = ['O=C(O)C(F)OF(4091)'],
