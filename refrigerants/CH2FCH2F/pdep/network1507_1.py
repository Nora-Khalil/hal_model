...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(368)', '[CH2]C[O](325)'],
    products = ['[CH2]CO[C]=C(3256)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=C(369)'],
    products = ['[CH2]CO[C]=C(3256)'],
    transitionState = 'TS3',
