...
reaction(
    label = 'reaction1',
    reactants = ['C#COOCC(F)(F)O[O](3564)'],
    products = ['[O]OC(F)(F)C=O(1651)', 'CH2CO(28)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COOC(F)(F)O[O](3792)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(43)', 'C#COOCO[O](3793)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]OF(126)', 'C#COOC[C]F-2(1769)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C#COOC(F)(CF)O[O](3794)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', 'C#COOCC([O])(F)F(3795)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C#COOCC(F)(F)O[O](3564)'],
    products = ['HCCO(21)', 'FC1(F)COOO1(1715)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C#COOCC(F)(F)O[O](3564)'],
    products = ['HO2(11)', 'C#COOC=C(F)F(1766)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C#COOCC(F)(F)O[O](3564)'],
    products = ['FC1(F)COO[C]=COO1(3796)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C#COOCC(F)(F)O[O](3564)'],
    products = ['[CH]=C1OOCC(F)(F)OO1(3797)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C#COOC[C](F)O[O](3798)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HCCO(21)', '[O]CC(F)(F)O[O](1641)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C#CO[O](451)', '[CH2]C(F)(F)O[O](700)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O2(2)', 'C#COOC[C](F)F(1725)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C2H(22)', '[O]OCC(F)(F)O[O](3799)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]O[C](F)F(788)', 'C#COO[CH2](1312)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C#COO[CH]C(F)(F)O[O](3800)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[C]#COOCC(F)(F)O[O](3801)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COOC=C(F)O[O](3802)'],
    products = ['C#COOCC(F)(F)O[O](3564)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C#COOCC(F)(F)O[O](3564)'],
    products = ['C#COO[CH]C(F)(F)OO(3803)'],
...
network(
    ...
    isomers = [
        'C#COOCC(F)(F)O[O](3564)',
    ],
    reactants = [
        ('[O]OC(F)(F)C=O(1651)', 'CH2CO(28)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
