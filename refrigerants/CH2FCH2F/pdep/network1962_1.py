...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61781,0.057266,-7.19134e-05,5.47507e-08,-1.77705e-11,-90590.4,20.6583], Tmin=(100,'K'), Tmax=(738.635,'K')), NASAPolynomial(coeffs=[6.84701,0.0289477,-1.44051e-05,2.84549e-09,-2.02452e-13,-91362.9,-2.98542], Tmin=(738.635,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-753.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-OsHHH) + group(Cds-OdCsH)"""),
)
...
"""),
    E0 = (-159.877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,562,600,623,1070,1265,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.1852,'amu*angstrom^2'), symmetry=1, barrier=(4.2581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187286,'amu*angstrom^2'), symmetry=1, barrier=(4.30607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188302,'amu*angstrom^2'), symmetry=1, barrier=(4.32943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67372,0.0610883,-0.000106847,1.08318e-07,-4.21196e-11,-19154.6,25.5293], Tmin=(100,'K'), Tmax=(822.177,'K')), NASAPolynomial(coeffs=[2.46315,0.0349402,-1.84435e-05,3.63503e-09,-2.54258e-13,-18530.5,26.4604], Tmin=(822.177,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(C=CJO)"""),
)
...
"""),
    E0 = (168.484,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,241.069,241.079,241.113,1995.74,1995.77,1995.8,2791.69],'cm^-1')),
        HinderedRotor(inertia=(0.138768,'amu*angstrom^2'), symmetry=1, barrier=(5.72171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13872,'amu*angstrom^2'), symmetry=1, barrier=(5.72141,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.76133,0.0367353,-7.20065e-05,8.0901e-08,-3.27849e-11,20299.3,14.6734], Tmin=(100,'K'), Tmax=(852.713,'K')), NASAPolynomial(coeffs=[-0.497295,0.027991,-1.43529e-05,2.77773e-09,-1.91328e-13,21728.7,34.9979], Tmin=(852.713,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(Cs-OsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['COOC=C(F)F(4975)'],
    products = ['CH2O(20)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1054.45,'s^-1'), n=2.72887, Ea=(40.4547,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OOC=C(F)F(784)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'COO[C]=C(F)F(5216)'],
    products = ['COOC=C(F)F(4975)'],
