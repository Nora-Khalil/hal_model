...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COC([O])F(1362)'],
    products = ['C#COCC([O])F(674)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CHFO(47)', 'C#CO[CH2](1380)'],
    products = ['C#COCC([O])F(674)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['[O][CH]F(1073)', 'C#CO[CH2](1380)'],
    products = ['C#COCC([O])F(674)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#CO[CH]C([O])F(1410)'],
    products = ['C#COCC([O])F(674)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C#COC[C]([O])F(1411)'],
    products = ['C#COCC([O])F(674)'],
