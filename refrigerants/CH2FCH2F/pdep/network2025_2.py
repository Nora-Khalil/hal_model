...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]C(F)F(1631)'],
    products = ['O=C(F)[CH]F(980)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction1',
    reactants = ['F(37)', 'O=C[C]F(1627)'],
    products = ['O=C[C](F)F(787)'],
    transitionState = 'TS9',
