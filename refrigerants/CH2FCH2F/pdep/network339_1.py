...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]C(=C)[O](386)'],
    products = ['C=C([O])C[C]=O(650)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CO(28)', '[CH2][C]=O(338)'],
    products = ['C=C([O])C[C]=O(650)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]=O(338)', '[CH2][C]=O(338)'],
    products = ['C=C([O])C[C]=O(650)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', 'O=[C]C[C]=O(1004)'],
    products = ['C=C([O])C[C]=O(650)'],
