...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[O]C([O])=O(514)'],
    products = ['[O]C(=O)O[C](F)F(2412)'],
    transitionState = 'TS2',
