...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC(F)[C](F)F(6530)'],
    products = ['[CH]=CC(F)(F)[CH]F(6529)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH]C=C(F)F(6536)'],
    products = ['[CH]=CC(F)(F)[CH]F(6529)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=CC(F)=CF(1496)'],
    products = ['[CH]=CC(F)(F)[CH]F(6529)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F[CH][C](F)F(3911)', 'C2H2(23)'],
    products = ['[CH]=CC(F)(F)[CH]F(6529)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#CC(F)(F)[CH]F(6432)'],
    products = ['[CH]=CC(F)(F)[CH]F(6529)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH][C](F)F(3911)', '[CH]=[CH](257)'],
    products = ['[CH]=CC(F)(F)[CH]F(6529)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH]C=C(F)F(6536)'],
    products = ['[CH]=CC(F)(F)[CH]F(6529)'],
