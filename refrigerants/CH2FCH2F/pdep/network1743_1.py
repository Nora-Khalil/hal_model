...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(6.53287e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1167,'amu*angstrom^2'), symmetry=1, barrier=(29.39,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000475009,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000475014,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75565,0.0499526,-5.59946e-05,3.1617e-08,-7.10353e-12,4007.2,21.3099], Tmin=(100,'K'), Tmax=(1078.7,'K')), NASAPolynomial(coeffs=[11.2376,0.0147918,-7.10094e-06,1.39922e-09,-1.0019e-13,1961.58,-25.1532], Tmin=(1078.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(32.6494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (82.6062,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,598.292,598.383,598.734,598.87,598.912,599.017],'cm^-1')),
        HinderedRotor(inertia=(0.00531944,'amu*angstrom^2'), symmetry=1, barrier=(1.35184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00535737,'amu*angstrom^2'), symmetry=1, barrier=(1.35937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00530617,'amu*angstrom^2'), symmetry=1, barrier=(1.35046,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (63.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7238,0.0217118,-1.30816e-06,-1.69899e-08,8.87796e-12,9986.93,15.0407], Tmin=(100,'K'), Tmax=(958.875,'K')), NASAPolynomial(coeffs=[9.98344,0.00685232,-2.19217e-06,4.00769e-10,-3.00353e-14,7885.62,-23.3755], Tmin=(958.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.6062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-OsHHH) + radical(CsJOO)"""),
)
...
"""),
    ...
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75475,0.0469837,-4.90775e-05,2.56432e-08,-5.27748e-12,3518.29,23.0031], Tmin=(100,'K'), Tmax=(1182.65,'K')), NASAPolynomial(coeffs=[11.9396,0.0125358,-5.38543e-06,1.01345e-09,-7.09613e-14,1109.29,-27.8415], Tmin=(1182.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.5636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32627,0.0610191,-7.28392e-05,4.43596e-08,-1.07865e-11,-44644.7,24.2492], Tmin=(100,'K'), Tmax=(998.307,'K')), NASAPolynomial(coeffs=[11.9118,0.0186051,-9.11017e-06,1.8015e-09,-1.28979e-13,-46758.2,-26.8021], Tmin=(998.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CCsJOO)"""),
)

species(
    label = '[O]OOCC(F)F(4680)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51279,0.0560159,-6.5354e-05,3.96458e-08,-9.61192e-12,-48913.4,24.1126], Tmin=(100,'K'), Tmax=(1002.23,'K')), NASAPolynomial(coeffs=[11.1005,0.0177505,-8.08338e-06,1.55019e-09,-1.09186e-13,-50835.2,-22.1636], Tmin=(1002.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-407.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OOOC[C](F)F(4030)'],
    products = ['HO2(11)', 'FC1(F)CO1(783)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'OOOC[C]F(4027)'],
    products = ['OOOC[C](F)F(4030)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[CH2]OOO(1843)'],
    products = ['OOOC[C](F)F(4030)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(11)', '[O]C[C](F)F(518)'],
    products = ['OOOC[C](F)F(4030)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]OOC[C](F)F(3086)'],
    products = ['OOOC[C](F)F(4030)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'OOO[CH][C](F)F(1638)'],
    products = ['OOOC[C](F)F(4030)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'OOOC[C]F-2(4028)'],
    products = ['OOOC[C](F)F(4030)'],
...
network(
    label = 'PDepNetwork #1743',
    isomers = [
        'OOOC[C](F)F(4030)',
    ],
    reactants = [
        ('HO2(11)', 'FC1(F)CO1(783)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
