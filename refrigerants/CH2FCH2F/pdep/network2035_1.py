...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(223)', 'CHF2-CH2(64)'],
    products = ['F[CH]CC(F)F(1833)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]CC(F)F-2(5380)'],
    products = ['F[CH]CC(F)F(1833)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C[CH]F(232)'],
    products = ['F[CH]CC(F)F(1833)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH][CH]C(F)F(5386)'],
    products = ['F[CH]CC(F)F(1833)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH]C[C](F)F(754)'],
    products = ['F[CH]CC(F)F(1833)'],
