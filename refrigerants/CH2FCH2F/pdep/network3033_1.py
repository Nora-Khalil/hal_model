...
"""),
    E0 = (-261.869,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,611,648,830,1210,1753,2950,3100,1380,975,1025,1650,184.236,606.658],'cm^-1')),
        HinderedRotor(inertia=(0.922826,'amu*angstrom^2'), symmetry=1, barrier=(22.2342,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.922578,'amu*angstrom^2'), symmetry=1, barrier=(22.2238,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.42125,'amu*angstrom^2'), symmetry=1, barrier=(58.1382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58925,'amu*angstrom^2'), symmetry=1, barrier=(38.3916,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['C=COOC=C(F)O[O](9153)'],
    products = ['CH2CO(28)', '[O]OC(F)C=O(2464)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C=COOC=C(F)O[O](9153)'],
    products = ['C=COC(F)(C=O)O[O](10868)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=COO[CH]C(=O)F(10869)'],
    products = ['C=COOC=C(F)O[O](9153)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=COOC=C(F)O[O](9153)'],
    products = ['FC1=COOO1(6258)', 'CH2CHO(35)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C=COOC=C(F)O[O](9153)'],
    products = ['FC1=COO[CH]COO1(10871)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=COOC=C(F)O[O](9153)'],
    products = ['C=COO[CH]C1(F)OO1(10872)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C=COOC=C(F)O[O](9153)'],
    products = ['[CH2]C1OOC=C(F)OO1(10873)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=COOC=[C]O[O](10874)'],
    products = ['C=COOC=C(F)O[O](9153)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)C=O(1683)', 'CH2CHO(35)'],
    products = ['C=COOC=C(F)O[O](9153)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC=C(F)O[O](6263)', 'C2H3(29)'],
    products = ['C=COOC=C(F)O[O](9153)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(F)O[O](470)', 'C=CO[O](291)'],
    products = ['C=COOC=C(F)O[O](9153)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O2(2)', 'C=COOC=[C]F(4946)'],
    products = ['C=COOC=C(F)O[O](9153)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=COO[C]=C(F)O[O](10875)'],
    products = ['C=COOC=C(F)O[O](9153)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=[C]OOC=C(F)O[O](10876)'],
    products = ['C=COOC=C(F)O[O](9153)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=COOC=C(F)O[O](10877)'],
    products = ['C=COOC=C(F)O[O](9153)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=COOC=C(F)O[O](9153)'],
    products = ['[O]OC(F)=C=O(1685)', 'CH3CHO(36)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=COOC#CO[O](10878)'],
    products = ['C=COOC=C(F)O[O](9153)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=COO[C]=C(F)OO(10879)'],
    products = ['C=COOC=C(F)O[O](9153)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=[C]OOC=C(F)OO(10880)'],
    products = ['C=COOC=C(F)O[O](9153)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=COOC=C(F)OO(10881)'],
    products = ['C=COOC=C(F)O[O](9153)'],
