...
reaction(
    label = 'reaction8',
    reactants = ['FOF(1520)', 'C=C(C)F(3402)'],
    products = ['CC(F)(F)COF(3295)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)C[O](3166)'],
    products = ['CC(F)(F)COF(3295)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(127)', '[CH2]C(C)(F)F(607)'],
    products = ['CC(F)(F)COF(3295)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OF(179)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)COF(3295)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'FOC[C](F)F(1659)'],
    products = ['CC(F)(F)COF(3295)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)(F)[CH]OF(3103)'],
    products = ['CC(F)(F)COF(3295)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)COF(3404)'],
    products = ['CC(F)(F)COF(3295)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC(F)(F)C=O(951)'],
    products = ['CC(F)(F)COF(3295)'],
