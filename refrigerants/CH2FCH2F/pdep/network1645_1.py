...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C=C(OF)OF(3664)'],
    products = ['C=C(OF)OC(F)F(3377)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(OF)O[C](F)F(3666)'],
    products = ['C=C(OF)OC(F)F(3377)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(OF)O[CH]F(3668)'],
    products = ['C=C(OF)OC(F)F(3377)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(=O)OC(F)F(3669)'],
    products = ['C=C(OF)OC(F)F(3377)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(F)F(1061)', 'C=[C]OF(196)'],
    products = ['C=C(OF)OC(F)F(3377)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(127)', 'C=[C]OC(F)F(3670)'],
    products = ['C=C(OF)OC(F)F(3377)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(OF)O[C](F)F(3671)'],
    products = ['C=C(OF)OC(F)F(3377)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(OF)OC(F)F(3672)'],
    products = ['C=C(OF)OC(F)F(3377)'],
