...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    ...
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)F(1071)', 'F[C]C(F)F-2(1828)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CF2(43)', 'OC(F)C(F)F(1614)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(140)', 'F[C]C(F)C(F)F(5947)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'OC(F)(F)C(F)[C]F(5408)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)(F)C(F)C(F)F(3307)'],
    products = ['OC(C(F)F)C(F)(F)F(9061)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H2O(3)', 'FC(F)=C(F)C(F)F(6315)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OF(140)', 'FC(F)=CC(F)F(1802)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OC(F)F(1071)', 'CHFCF2(55)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)(F)[CH]C(F)F(5575)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O[C](F)C(F)C(F)F(9062)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'OC(F)(F)C(F)[CH]F(5414)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'F[C](F)C(F)C(F)F(5636)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(F)(F)C(F)C(F)F(5639)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O[C](F)F(1777)', 'CHF2-CHF(67)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHF2(82)', 'OC(F)(F)[CH]F(3659)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'OC(F)(F)[C](F)C(F)F(9063)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(F)(F)C(F)[C](F)F(9064)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=C(F)C(F)C(F)F(6198)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'OC(F)=CC(F)F(5570)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'OC(F)=C(F)C(F)F(9065)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F2(78)', 'OC(F)(F)C=CF(2189)'],
    products = ['OC(F)(F)C(F)C(F)F(3307)'],
