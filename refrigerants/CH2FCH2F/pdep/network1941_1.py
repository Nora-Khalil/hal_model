...
"""),
    E0 = (-643.633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,196.253],'cm^-1')),
        HinderedRotor(inertia=(0.371997,'amu*angstrom^2'), symmetry=1, barrier=(9.92883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374696,'amu*angstrom^2'), symmetry=1, barrier=(9.92875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362035,'amu*angstrom^2'), symmetry=1, barrier=(9.92578,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13182,0.0682876,-0.00010731,8.99369e-08,-2.99635e-11,-77312.9,24.5188], Tmin=(100,'K'), Tmax=(791.447,'K')), NASAPolynomial(coeffs=[9.57665,0.0214957,-1.08343e-05,2.10797e-09,-1.46959e-13,-78520.9,-13.4339], Tmin=(791.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-643.633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + radical(ROOJ)"""),
)
...
"""),
    E0 = (-629.635,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,205,317,423,563,514,686,1105,1199,1293,1437,1381,1463,3031,3163,180],'cm^-1')),
        HinderedRotor(inertia=(0.634296,'amu*angstrom^2'), symmetry=1, barrier=(14.5837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.86878,'amu*angstrom^2'), symmetry=1, barrier=(42.967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.634303,'amu*angstrom^2'), symmetry=1, barrier=(14.5839,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44719,0.0591757,-7.0407e-05,4.34331e-08,-1.07981e-11,-75638.1,21.9263], Tmin=(100,'K'), Tmax=(972.571,'K')), NASAPolynomial(coeffs=[10.9837,0.0199559,-9.92156e-06,1.97454e-09,-1.41767e-13,-77493.2,-23.8173], Tmin=(972.571,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-629.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(ROOJ)"""),
)
...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3938.64,'J/mol'), sigma=(6.32837,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=615.21 K, Pc=35.26 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-569.933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,180,2115.87],'cm^-1')),
        HinderedRotor(inertia=(0.428819,'amu*angstrom^2'), symmetry=1, barrier=(9.85939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56047,'amu*angstrom^2'), symmetry=1, barrier=(35.8784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55947,'amu*angstrom^2'), symmetry=1, barrier=(35.8554,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19836,0.0695754,-0.000116856,1.09066e-07,-4.02306e-11,-68453.9,24.3777], Tmin=(100,'K'), Tmax=(793.862,'K')), NASAPolynomial(coeffs=[6.5007,0.0295232,-1.59797e-05,3.19257e-09,-2.25581e-13,-68875.6,2.66761], Tmin=(793.862,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-569.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + radical(CCOJ)"""),
)

species(
    label = 'OOC(O)[C](F)F(5351)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-588.013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,190,488,555,1236,1407,180],'cm^-1')),
        HinderedRotor(inertia=(0.771405,'amu*angstrom^2'), symmetry=1, barrier=(17.7361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177075,'amu*angstrom^2'), symmetry=1, barrier=(4.07131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176847,'amu*angstrom^2'), symmetry=1, barrier=(4.06606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88285,'amu*angstrom^2'), symmetry=1, barrier=(43.2904,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.944625,0.0745936,-0.00012662,1.12916e-07,-3.93814e-11,-70618.7,25.9392], Tmin=(100,'K'), Tmax=(813.533,'K')), NASAPolynomial(coeffs=[8.8518,0.024327,-1.29394e-05,2.5507e-09,-1.7825e-13,-71528.4,-8.26034], Tmin=(813.533,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-588.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'OC([CH]F)OOF(5352)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-280.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3615,1277.5,1000,277,555,632,1380,1390,370,380,2900,435,334,575,1197,1424,3202],'cm^-1')),
        HinderedRotor(inertia=(0.953122,'amu*angstrom^2'), symmetry=1, barrier=(21.9142,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.952619,'amu*angstrom^2'), symmetry=1, barrier=(21.9026,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.613412,0.0845768,-0.000154888,1.42238e-07,-4.98411e-11,-33621.7,26.0319], Tmin=(100,'K'), Tmax=(842.384,'K')), NASAPolynomial(coeffs=[9.02812,0.0249266,-1.36042e-05,2.6728e-09,-1.84975e-13,-34340.6,-8.97354], Tmin=(842.384,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(Csj(Cs-O2sO2sH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(O)C(F)F(4955)'],
    products = ['HO2(11)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]OCO(695)'],
    products = ['[O]OC(O)C(F)F(4955)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(119.573,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[O]OC(O)F(1102)'],
    products = ['[O]OC(O)C(F)F(4955)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', '[O]OC=C(F)F(785)'],
    products = ['[O]OC(O)C(F)F(4955)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['O(6)', '[O]C(O)C(F)F(4954)'],
    products = ['[O]OC(O)C(F)F(4955)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]OC(O)C(F)F(4955)'],
    products = ['HO2(11)', 'OC=C(F)F(1567)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.58174e+10,'s^-1'), n=0.573333, Ea=(147.368,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO]
Euclidian distance = 0
family: HO2_Elimination_from_PeroxyRadical"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]OC(O)[CH]F(2432)'],
    products = ['[O]OC(O)C(F)F(4955)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O2(2)', 'O[CH]C(F)F(1906)'],
    products = ['[O]OC(O)C(F)F(4955)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', '[O]O[CH]C(F)F(786)'],
    products = ['[O]OC(O)C(F)F(4955)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC([O])C(F)F(1642)'],
    products = ['[O]OC(O)C(F)F(4955)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF2(82)', '[O]O[CH]O(1208)'],
    products = ['[O]OC(O)C(F)F(4955)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]O[C](O)C(F)F(1709)'],
    products = ['[O]OC(O)C(F)F(4955)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]OC(O)[C](F)F(1637)'],
    products = ['[O]OC(O)C(F)F(4955)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[O]OC(O)=CF(2552)'],
    products = ['[O]OC(O)C(F)F(4955)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(158.765,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['[O]OC(O)C(F)F(4955)'],
    products = ['OH(7)', 'O=C(O)C(F)F(2679)'],
