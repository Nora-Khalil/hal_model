...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(=O)[CH]F(400)'],
    products = ['[CH2]C(F)C(=C)[O](201)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]=O(338)', 'CH2CHF(56)'],
    products = ['[CH2]C(F)C(=C)[O](201)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2CO(28)', '[CH2][CH]F(226)'],
    products = ['[CH2]C(F)C(=C)[O](201)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]=O(338)', '[CH2][CH]F(226)'],
    products = ['[CH2]C(F)C(=C)[O](201)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(18)', '[CH2]C(F)[C]=O(306)'],
    products = ['[CH2]C(F)C(=C)[O](201)'],
