...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[C-]=[O+]OF(12455)'],
    products = ['[C-]=[O+]OC(=O)F(12222)'],
    transitionState = 'TS2',
