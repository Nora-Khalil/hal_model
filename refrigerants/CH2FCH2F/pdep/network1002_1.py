...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]C(F)O[C](F)F(2166)'],
...
reaction(
    ...
    products = ['F[CH]C(F)O[C](F)F(2166)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'F[CH]O[C](F)F(1161)'],
    products = ['F[CH]C(F)O[C](F)F(2166)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC=CO[C](F)F(2187)'],
    products = ['F[CH]C(F)O[C](F)F(2166)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC=C(F)O[C](F)F(2225)'],
    products = ['F[CH]C(F)O[C](F)F(2166)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', 'F[CH]O[C](F)F(1161)'],
    products = ['F[CH]C(F)O[C](F)F(2166)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)O[C](F)F(2166)'],
    products = ['F[CH][CH]OC(F)(F)F(2227)'],
