...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0627764,0.0745018,-8.7035e-05,4.59627e-08,-8.99217e-12,-81354.6,26.4643], Tmin=(100,'K'), Tmax=(1403.01,'K')), NASAPolynomial(coeffs=[22.9503,0.00039897,1.27002e-06,-3.11326e-10,2.20637e-14,-86976.3,-89.3743], Tmin=(1403.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-677.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=COJ)"""),
)
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88841,0.0198087,8.03175e-05,-1.28398e-07,5.2198e-11,-85401.3,23.5098], Tmin=(100,'K'), Tmax=(962.445,'K')), NASAPolynomial(coeffs=[21.5191,0.00519853,-1.29699e-06,4.40389e-10,-5.0022e-14,-92282,-86.5606], Tmin=(962.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-710.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFFH) + group(Cds-OdCsOs) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441286,0.0656313,-7.21995e-05,3.74544e-08,-7.2834e-12,-27953.7,28.1263], Tmin=(100,'K'), Tmax=(1404.99,'K')), NASAPolynomial(coeffs=[19.1539,0.00546615,-6.09491e-07,-5.66345e-12,3.2472e-15,-32531.8,-66.094], Tmin=(1404.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + ring(dioxirane) + radical(CC(C)OJ) + radical(Cs_P)"""),
)

species(
    label = '[O][C]1OOC1C(F)F(5158)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35535,0.0657406,-0.000106267,1.00284e-07,-3.79236e-11,-27785.8,22.9005], Tmin=(100,'K'), Tmax=(779.666,'K')), NASAPolynomial(coeffs=[5.48529,0.0319913,-1.71703e-05,3.43687e-09,-2.43772e-13,-28048,6.45217], Tmin=(779.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + ring(12dioxetane) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[O]C1([O])OC1C(F)F(5150)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.28518,0.0300245,-1.33471e-05,1.73805e-09,-1.31172e-14,-52990.4,15.9332], Tmin=(100,'K'), Tmax=(2808.27,'K')), NASAPolynomial(coeffs=[43.8194,-0.0131142,2.65912e-06,-3.91466e-10,2.77672e-14,-80389.1,-224.866], Tmin=(2808.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-440.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsOs) + group(CsCsFFH) + ring(Cs(C-FF)-Cs-O2s) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)=C([O])C(F)F(5159)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {8,S} {10,S}
...
"""),
    E0 = (-653.826,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,376.326,376.373,376.375,376.399,376.399,376.495,1412.14],'cm^-1')),
        HinderedRotor(inertia=(0.157313,'amu*angstrom^2'), symmetry=1, barrier=(15.8055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0044484,'amu*angstrom^2'), symmetry=1, barrier=(6.28524,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.035,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19963,0.0682506,-0.000114284,1.02774e-07,-3.69041e-11,-78542.7,24.8478], Tmin=(100,'K'), Tmax=(760.992,'K')), NASAPolynomial(coeffs=[8.3552,0.0238642,-1.344e-05,2.73178e-09,-1.95148e-13,-79435.6,-6.43047], Tmin=(760.992,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-653.826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)O2s) + radical(C=OC=OOJ)"""),
)
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.625506,0.0777121,-0.000110706,7.72736e-08,-2.10347e-11,-79802.5,23.5714], Tmin=(100,'K'), Tmax=(904.275,'K')), NASAPolynomial(coeffs=[14.6141,0.0158346,-8.06487e-06,1.60243e-09,-1.1433e-13,-82332.4,-42.5078], Tmin=(904.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-664.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ)"""),
)
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38077,0.0639183,-8.81651e-05,7.05876e-08,-2.38223e-11,-32657.7,26.8834], Tmin=(100,'K'), Tmax=(713.293,'K')), NASAPolynomial(coeffs=[7.48484,0.0296868,-1.61764e-05,3.30237e-09,-2.38891e-13,-33528.5,-0.502583], Tmin=(713.293,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-272.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CsCsF1sH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C([O])C(F)F(4959)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', '[O]CC([O])=O(3159)'],
    products = ['[O]C(=O)C([O])C(F)F(4959)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(=O)C([O])C(F)F(4959)'],
    products = ['[O]C=C([O])OC(F)F(5155)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.87873e+12,'s^-1'), n=0.324012, Ea=(117.194,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C([O])=CC(F)F(1049)'],
    products = ['[O]C(=O)C([O])C(F)F(4959)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', '[O]C([C]=O)C(F)F(4896)'],
    products = ['[O]C(=O)C([O])C(F)F(4959)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)C([O])C(F)F(4959)'],
    products = ['[O]C([C]1OO1)C(F)F(5157)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)C([O])C(F)F(4959)'],
    products = ['[O]C1([O])OC1C(F)F(5150)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(7.785e+11,'s^-1'), n=0.342, Ea=(139.608,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_O] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_O]
Euclidian distance = 1.4142135623730951
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(O)=C([O])C(F)F(5159)'],
    products = ['[O]C(=O)C([O])C(F)F(4959)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(205000,'s^-1'), n=2.37, Ea=(266.014,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CHF2(82)', '[O]C(=O)C=O(2629)'],
    products = ['[O]C(=O)C([O])C(F)F(4959)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(20.1894,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(91.371,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(220.102,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['[O]C(=O)C([O])C(F)F(4959)'],
    products = ['[O]C([O])=C(O)C(F)F(5162)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(=O)C(O)[C](F)F(5163)'],
    products = ['[O]C(=O)C([O])C(F)F(4959)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(=O)C([CH]F)OF(5165)'],
    products = ['[O]C(=O)C([O])C(F)F(4959)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C([CH]F)C(=O)OF(5166)'],
    products = ['[O]C(=O)C([O])C(F)F(4959)'],
