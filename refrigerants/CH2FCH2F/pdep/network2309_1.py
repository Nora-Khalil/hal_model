...
species(
    label = '[CH2][C](F)C(F)(F)C(F)F(6192)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(6112)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(6112)'],
    products = ['F[CH]C(F)(F)C[C](F)F(6114)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[CH]C(F)(F)[C](F)F(6191)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(6112)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_ter_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]C(F)(F)C(F)=CF(921)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(6112)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)C(F)(F)[CH]F(6146)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(6112)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[CH2]C(F)=C(F)[CH]F(922)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(6112)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH][C](F)C(F)(F)CF(6189)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(6112)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)(F)C(F)(F)[CH]F(6112)'],
    products = ['[CH2][C](F)C(F)(F)C(F)F(6192)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH]C(F)(F)[C](F)CF(6188)'],
    products = ['[CH2]C(F)(F)C(F)(F)[CH]F(6112)'],
