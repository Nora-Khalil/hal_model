...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]=C[O](134)'],
    products = ['[CH]=CO[CH2](3185)'],
    transitionState = 'TS2',
