...
"""),
    E0 = (-758.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,222,329,445,522,589,1214,1475,250,417,511,1155,1315,1456,3119,190,488,555,1236,1407,630.319,630.534,630.564,630.656,630.706],'cm^-1')),
        HinderedRotor(inertia=(0.000424005,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.051,'amu'),
...
species(
    label = 'FC1C(F)(F)[CH]C1(F)F(12519)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-359.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,90,150,250,247,323,377,431,433,1065,1274,1691.48,1691.6,1691.65,1691.68,1691.71,1691.87],'cm^-1')),
        HinderedRotor(inertia=(5.89193e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6762,0.0508438,-4.54637e-05,2.03312e-08,-3.67335e-12,-43102.9,20.974], Tmin=(100,'K'), Tmax=(1305.81,'K')), NASAPolynomial(coeffs=[11.9745,0.0192972,-9.2252e-06,1.82972e-09,-1.31155e-13,-45792.3,-31.457], Tmin=(1305.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-359.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)
...
"""),
    E0 = (-332.334,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,259,529,569,1128,1321,1390,3140,212,367,445,1450,190,488,555,1236,1407,641.67,642.061,642.406,642.888,643.469],'cm^-1')),
        HinderedRotor(inertia=(0.000409721,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27424,0.0543811,-5.07947e-05,2.31571e-08,-4.13551e-12,-39867.8,24.28], Tmin=(100,'K'), Tmax=(1356.55,'K')), NASAPolynomial(coeffs=[14.9997,0.0139102,-6.04484e-06,1.1655e-09,-8.27133e-14,-43591.7,-46.123], Tmin=(1356.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsCsH)(Cs-CsF1sH)(F1s)_ring) + radical(Csj(Cs-CsCsH)(F1s)(F1s)_1959_ring) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[C](F)C1[CH]C1(F)F(12522)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-358.845,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,215,315,519,588,595,1205,1248,190,488,555,1236,1407,180,314.686,939.51,939.529,939.539,939.956,1978.1],'cm^-1')),
        HinderedRotor(inertia=(1.54003,'amu*angstrom^2'), symmetry=1, barrier=(35.4082,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08202,0.0579057,-5.72658e-05,2.74726e-08,-5.12026e-12,-43048.8,24.4122], Tmin=(100,'K'), Tmax=(1310.75,'K')), NASAPolynomial(coeffs=[15.9858,0.0124241,-5.2174e-06,9.99971e-10,-7.11275e-14,-46955.8,-51.5227], Tmin=(1310.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-358.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsCsH)(Cs-CsF1sF1s)(H)_ring) + radical(Csj(Cs-CsCsH)(F1s)(F1s)_1959_ring)"""),
)

species(
    label = 'F[C](F)[C]1C(F)C1(F)F(12523)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-570.496,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([259,529,569,1128,1321,1390,3140,215,315,519,588,595,1205,1248,190,488,555,1236,1407,180,180,1541.39,1543.75],'cm^-1')),
        HinderedRotor(inertia=(0.0156261,'amu*angstrom^2'), symmetry=1, barrier=(6.24979,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (144.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09168,0.0697852,-0.0001057,8.93417e-08,-3.06865e-11,-68515.6,26.7573], Tmin=(100,'K'), Tmax=(734.659,'K')), NASAPolynomial(coeffs=[8.80433,0.0261981,-1.34509e-05,2.67718e-09,-1.90145e-13,-69605.8,-7.78088], Tmin=(734.659,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-570.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(F1s)_1959_ring) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F))"""),
)

species(
    label = 'F[C](F)C1[C](F)C1(F)F(12524)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-153.065,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,323,467,575,827,1418,190,488,555,1236,1407,180,180,932.353,932.841,932.885,933.113],'cm^-1')),
        HinderedRotor(inertia=(0.00816302,'amu*angstrom^2'), symmetry=1, barrier=(5.03755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'F[C]C1C(F)C1(F)F-2(12529)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
4  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-388.762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,250,417,511,1155,1315,1456,3119,222,329,445,522,589,1214,1475,617,898,1187,180,953.423,954.328,955.077],'cm^-1')),
...
species(
    label = 'F[C]1C(C(F)F)C1(F)F(12531)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-728.846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,215,315,519,588,595,1205,1248,235,523,627,1123,1142,1372,1406,3097,212,367,445,1450,180,785.274,785.343,785.421,785.481],'cm^-1')),
        HinderedRotor(inertia=(0.00919347,'amu*angstrom^2'), symmetry=1, barrier=(4.02552,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.051,'amu'),
...
species(
    label = 'F[C]1C(F)C1C(F)(F)F(12532)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'FC(F)(F)C1[CH]C1(F)F(12533)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', 'F[C](F)C=C(F)F(1808)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[C](F)C1C(F)C1(F)F(9821)'],
    products = ['FC1[CH]C(F)(F)C1(F)F(11263)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F[C](F)C1C(F)C1(F)F(9821)'],
    products = ['FC1C(F)(F)[CH]C1(F)F(12519)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F(37)', 'F[C]C1C(F)C1(F)F(12520)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F[C]F(744)', 'FC1[CH]C1(F)F(9127)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction28',
    reactants = ['F[CH]C(F)(F)C=C(F)F(6174)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(5)', 'FC(F)=C1C(F)C1(F)F(7528)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction30',
    reactants = ['F(37)', 'F[C](F)C1[C](F)C1F(12521)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction31',
    reactants = ['F(37)', 'F[C](F)C1[CH]C1(F)F(12522)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(5)', 'F[C](F)[C]1C(F)C1(F)F(12523)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(5)', 'F[C](F)C1[C](F)C1(F)F(12524)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction34',
    reactants = ['HF(38)', 'F[C](F)C1=C(F)C1F(12525)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction35',
    reactants = ['HF(38)', 'F[C](F)C1=CC1(F)F(12526)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction36',
    reactants = ['F2(78)', 'F[C](F)C1C=C1F(12527)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction37',
    reactants = ['HF(38)', 'F[C](F)C1C(F)=C1F(12528)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction38',
    reactants = ['F(37)', 'F[C]C1C(F)C1(F)F-2(12529)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CF2(43)', 'FC1[CH]C1(F)F(9127)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction40',
    reactants = ['FC(F)[C]1C(F)C1(F)F(12530)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction41',
    reactants = ['F[C]1C(C(F)F)C1(F)F(12531)'],
    products = ['F[C](F)C1C(F)C1(F)F(9821)'],
...
reaction(
    label = 'reaction42',
    reactants = ['F[C](F)C1C(F)C1(F)F(9821)'],
    products = ['F[C]1C(F)C1C(F)(F)F(12532)'],
...
reaction(
    label = 'reaction43',
    reactants = ['F[C](F)C1C(F)C1(F)F(9821)'],
    products = ['FC(F)(F)C1[CH]C1(F)F(12533)'],
