...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C#COC[O](1333)'],
    products = ['C#COC(F)C[O](2461)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(20)', 'C#CO[CH]F(1547)'],
    products = ['C#COC(F)C[O](2461)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C#COC(F)C=O(12173)'],
    products = ['C#COC(F)C[O](2461)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CO[CH]C[O](3066)'],
    products = ['C#COC(F)C[O](2461)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H(22)', '[O]CC([O])F(1409)'],
    products = ['C#COC(F)C[O](2461)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](133)', 'C#CO[CH]F(1547)'],
    products = ['C#COC(F)C[O](2461)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C#CO[C](F)C[O](12174)'],
    products = ['C#COC(F)C[O](2461)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#COC(F)[CH][O](12175)'],
    products = ['C#COC(F)C[O](2461)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[C]#COC(F)C[O](12176)'],
    products = ['C#COC(F)C[O](2461)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C#COC=C[O](1413)'],
    products = ['C#COC(F)C[O](2461)'],
