...
9  C u0 p0 c0 {1,S} {7,S} {13,S} {14,S}
10 H u0 p0 c0 {6,S}
11 H u0 p0 c0 {7,S}
12 H u0 p0 c0 {7,S}
13 H u0 p0 c0 {9,S}
...
"""),
    E0 = (-781.443,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,528,1116,1182,1331,1402,1494,3075,3110,292.34,292.426,292.431,292.638],'cm^-1')),
        HinderedRotor(inertia=(0.210812,'amu*angstrom^2'), symmetry=1, barrier=(12.7792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211074,'amu*angstrom^2'), symmetry=1, barrier=(12.7797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211142,'amu*angstrom^2'), symmetry=1, barrier=(12.7791,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.46507,'amu*angstrom^2'), symmetry=1, barrier=(28.2373,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.178634,0.090136,-0.000108135,7.0216e-08,-1.86804e-11,-93853.5,28.5343], Tmin=(100,'K'), Tmax=(905.414,'K')), NASAPolynomial(coeffs=[12.5656,0.0354112,-1.7471e-05,3.458e-09,-2.47161e-13,-96096.5,-29.9947], Tmin=(905.414,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-781.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCsFFH) + group(CsCsFHH)"""),
)
...
"""),
    E0 = (-414.955,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,617,898,1187,296.303,296.452,296.463],'cm^-1')),
        HinderedRotor(inertia=(0.153149,'amu*angstrom^2'), symmetry=1, barrier=(9.53203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153197,'amu*angstrom^2'), symmetry=1, barrier=(9.53415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152473,'amu*angstrom^2'), symmetry=1, barrier=(9.53507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.561429,'amu*angstrom^2'), symmetry=1, barrier=(35.0738,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-781.78,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,288.899,289.074,289.117,289.3],'cm^-1')),
        HinderedRotor(inertia=(0.239083,'amu*angstrom^2'), symmetry=1, barrier=(14.1756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238938,'amu*angstrom^2'), symmetry=1, barrier=(14.1754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.40521,'amu*angstrom^2'), symmetry=1, barrier=(24.0209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.50736,'amu*angstrom^2'), symmetry=1, barrier=(30.076,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.305468,0.0868031,-9.54951e-05,5.59447e-08,-1.34947e-11,-93898,27.1343], Tmin=(100,'K'), Tmax=(989.626,'K')), NASAPolynomial(coeffs=[13.006,0.0354692,-1.76881e-05,3.53034e-09,-2.5393e-13,-96411.7,-34.0061], Tmin=(989.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-781.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH)"""),
)
...
"""),
    E0 = (-387.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,346.474,347.238,1657.56],'cm^-1')),
        HinderedRotor(inertia=(0.128651,'amu*angstrom^2'), symmetry=1, barrier=(10.9874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128717,'amu*angstrom^2'), symmetry=1, barrier=(10.9445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346291,'amu*angstrom^2'), symmetry=1, barrier=(29.4958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129729,'amu*angstrom^2'), symmetry=1, barrier=(10.9522,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-365.382,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,334,575,1197,1424,3202,299.696,299.712,299.726,299.739],'cm^-1')),
        HinderedRotor(inertia=(0.215956,'amu*angstrom^2'), symmetry=1, barrier=(13.7679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134292,'amu*angstrom^2'), symmetry=1, barrier=(8.55663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13423,'amu*angstrom^2'), symmetry=1, barrier=(8.55684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516166,'amu*angstrom^2'), symmetry=1, barrier=(32.9049,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.085,'amu'),
...
"""),
    E0 = (-685.59,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,528,1116,1182,1331,1402,1494,3075,3110,339.554,341.247,341.812,347.505],'cm^-1')),
        HinderedRotor(inertia=(0.180059,'amu*angstrom^2'), symmetry=1, barrier=(15.7762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110956,'amu*angstrom^2'), symmetry=1, barrier=(9.46162,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226558,'amu*angstrom^2'), symmetry=1, barrier=(18.4317,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.085,'amu'),
...
"""),
    E0 = (-554.229,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,180,180,2417.04],'cm^-1')),
        HinderedRotor(inertia=(1.27354,'amu*angstrom^2'), symmetry=1, barrier=(29.2811,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.341377,'amu*angstrom^2'), symmetry=1, barrier=(7.84892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.341291,'amu*angstrom^2'), symmetry=1, barrier=(7.84695,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.20284,0.0852381,-0.000332089,7.85225e-07,-6.65843e-10,-66656.3,14.02], Tmin=(10,'K'), Tmax=(387.383,'K')), NASAPolynomial(coeffs=[3.45082,0.0446648,-2.77927e-05,8.24035e-09,-9.37705e-13,-66390.3,16.7402], Tmin=(387.383,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-554.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), label="""FCC[CH]C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-817.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,191.117,194.751,194.988],'cm^-1')),
        HinderedRotor(inertia=(0.188533,'amu*angstrom^2'), symmetry=1, barrier=(5.00994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193231,'amu*angstrom^2'), symmetry=1, barrier=(5.04827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.723398,'amu*angstrom^2'), symmetry=1, barrier=(18.5864,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['FCCC(OF)C(F)F(5280)'],
    products = ['HF(38)', 'O=CC(F)F(990)', 'CH2CHF(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(55.0514,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'FCCC(F)OF(1509)'],
    products = ['FCCC(OF)C(F)F(5280)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(153.076,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]CC(OF)C(F)F(5289)'],
    products = ['FCCC(OF)C(F)F(5280)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['FCCC(OF)C(F)F(5280)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(8.39871e-05,'m^3/(mol*s)'), n=3.10993, Ea=(26.6312,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['FCCC(F)C(F)OF(5290)'],
    products = ['FCCC(OF)C(F)F(5280)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(140)', 'FCC=CC(F)F(5291)'],
    products = ['FCCC(OF)C(F)F(5280)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(140)', 'FCCC=C(F)F(746)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FOF(1520)', 'FC=CCCF(225)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]CC(OF)C(F)F(5292)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[CH]C(CCF)OF(5293)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(CCF)C(F)F(5294)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(127)', 'FCC[CH]C(F)F(5295)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction16',
    reactants = ['FO[CH]C(F)F(4702)', 'CH2F-CH2(62)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(82)', 'FCC[CH]OF(1535)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'FCC[C](OF)C(F)F(5296)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(46)', '[CH2]C(OF)C(F)F(5297)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'FC[CH]C(OF)C(F)F(5298)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'FCCC(OF)[C](F)F(5299)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'F[CH]CC(OF)C(F)F(5300)'],
    products = ['FCCC(OF)C(F)F(5280)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(CCF)C(F)F(4738)'],
    products = ['FCCC(OF)C(F)F(5280)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(449.724,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'FC=C(CCF)OF(4153)'],
    products = ['FCCC(OF)C(F)F(5280)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(192.033,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)
...
reaction(
    label = 'reaction26',
    reactants = ['FCCC(OF)C(F)F(5280)'],
    products = ['F2(78)', 'O=CC(F)F(990)', 'C2H4(30)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(302.507,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
