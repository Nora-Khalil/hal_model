...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.920048,'amu*angstrom^2'), symmetry=1, barrier=(21.1537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915991,'amu*angstrom^2'), symmetry=1, barrier=(21.0604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.923775,'amu*angstrom^2'), symmetry=1, barrier=(21.2394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44998,'amu*angstrom^2'), symmetry=1, barrier=(33.338,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (164.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.37529,0.106638,-0.000189887,1.68536e-07,-5.78499e-11,-96624.3,30.7487], Tmin=(100,'K'), Tmax=(818.851,'K')), NASAPolynomial(coeffs=[12.7528,0.0268948,-1.521e-05,3.03738e-09,-2.12732e-13,-98250.9,-26.7667], Tmin=(818.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-804.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(CsFFHO) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (166.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.342385,0.104166,-0.00016854,1.44401e-07,-4.92483e-11,-140371,30.5512], Tmin=(100,'K'), Tmax=(773.081,'K')), NASAPolynomial(coeffs=[12.2676,0.0325902,-1.73792e-05,3.4551e-09,-2.43748e-13,-142131,-25.8157], Tmin=(773.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1168.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCFFO) + group(CsFFHO)"""),
)

species(
    label = 'FOCC(F)(F)OC(F)F(10540)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (166.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.342417,0.104166,-0.000168542,1.44404e-07,-4.92498e-11,-140371,30.5513], Tmin=(100,'K'), Tmax=(773.06,'K')), NASAPolynomial(coeffs=[12.2676,0.0325901,-1.73791e-05,3.45508e-09,-2.43747e-13,-142131,-25.816], Tmin=(773.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1168.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFFO) + group(Cs-CsOsHH) + group(CsFFHO)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.198561,0.0913472,-0.000146525,1.25896e-07,-4.33254e-11,-87899.8,30.3145], Tmin=(100,'K'), Tmax=(758.094,'K')), NASAPolynomial(coeffs=[10.9388,0.0300686,-1.61575e-05,3.23122e-09,-2.29039e-13,-89395.8,-17.653], Tmin=(758.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-731.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(CsFFHO) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(F)(OF)OC(F)F(10542)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.291975,'amu*angstrom^2'), symmetry=1, barrier=(6.71308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.815555,'amu*angstrom^2'), symmetry=1, barrier=(18.7512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290953,'amu*angstrom^2'), symmetry=1, barrier=(6.68959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.8076,'amu*angstrom^2'), symmetry=1, barrier=(41.5604,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.253331,0.102974,-0.000175487,1.53922e-07,-5.28134e-11,-92187.6,28.5112], Tmin=(100,'K'), Tmax=(806.918,'K')), NASAPolynomial(coeffs=[12.059,0.0295677,-1.60299e-05,3.17824e-09,-2.22715e-13,-93771.8,-25.7514], Tmin=(806.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-767.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(Cs-CsHHH) + group(CsFFHO) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)
...
species(
    label = 'F[CH]C(F)(OF)OC(F)F(10545)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-594.069,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,519,593,830,1115,1166,1389,1413,3114,350,440,435,1725,2950,3100,1380,975,1025,1650,323.857,323.87,323.922,323.932],'cm^-1')),
        HinderedRotor(inertia=(0.147855,'amu*angstrom^2'), symmetry=1, barrier=(11.0076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147815,'amu*angstrom^2'), symmetry=1, barrier=(11.0066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284036,'amu*angstrom^2'), symmetry=1, barrier=(21.1892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.746218,0.0758208,-0.000104231,7.34755e-08,-2.05412e-11,-71336.6,23.3563], Tmin=(100,'K'), Tmax=(875.48,'K')), NASAPolynomial(coeffs=[12.7283,0.0210759,-1.0434e-05,2.05078e-09,-1.4544e-13,-73434.6,-32.8569], Tmin=(875.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-594.069,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFFHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'FC=C(OF)OC(F)F(5552)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-759.066,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,519,593,830,1115,1166,1389,1413,3114,350,440,435,1725,194,682,905,1196,1383,3221,213.54,213.561,213.626,1786.86],'cm^-1')),
        HinderedRotor(inertia=(0.289369,'amu*angstrom^2'), symmetry=1, barrier=(9.37132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289473,'amu*angstrom^2'), symmetry=1, barrier=(9.36947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09092,'amu*angstrom^2'), symmetry=1, barrier=(35.2945,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.277148,0.0903345,-0.000152962,1.34824e-07,-4.65734e-11,-91168.7,26.4867], Tmin=(100,'K'), Tmax=(806.757,'K')), NASAPolynomial(coeffs=[10.6034,0.0275883,-1.4829e-05,2.93499e-09,-2.05623e-13,-92459.1,-18.7853], Tmin=(806.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-759.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsFFHO) + group(Cds-CdsCsCs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H2(8)', 'F[C]C(F)(OF)OC(F)F(10537)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'FOC(F)OC(F)F(3598)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'FCC(F)(OF)OF(10538)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FCC(F)(OF)OC(F)F(10090)'],
    products = ['FOC(F)(F)COC(F)F(10539)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['FCC(F)(OF)OC(F)F(10090)'],
    products = ['FOCC(F)(F)OC(F)F(10540)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+13,'s^-1'), n=0, Ea=(299,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [OF]
Euclidian distance = 0
family: 1,2_XY_interchange"""),
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)F(1071)', 'FC=C(F)OF(3648)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOC(F)F(2153)', 'C=C(F)OF(479)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OF(140)', 'FC=C(F)OC(F)F(2224)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOF(1520)', 'C=C(F)OC(F)F(2194)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FC[C](OF)OC(F)F(10541)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)(OF)OC(F)F(10542)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'F[CH]OC(F)(CF)OF(10543)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(F)(CF)OC(F)F(10544)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C(F)F(1061)', 'FC[C](F)OF(9995)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF2(82)', '[O]C(F)(CF)OF(10505)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]F(127)', 'FC[C](F)OC(F)F(10053)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2F(46)', 'FO[C](F)OC(F)F(3469)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'F[CH]C(F)(OF)OC(F)F(10545)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'FCC(F)(OF)O[C](F)F(10546)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(78)', 'O=C(CF)OC(F)F(3665)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'C=C(OF)OC(F)F(3377)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'FC=C(OF)OC(F)F(5552)'],
    products = ['FCC(F)(OF)OC(F)F(10090)'],
...
reaction(
    label = 'reaction26',
    reactants = ['FCC(F)(OF)OC(F)F(10090)'],
    products = ['F2(78)', 'CHFO(47)', 'O=C(F)CF(476)'],
