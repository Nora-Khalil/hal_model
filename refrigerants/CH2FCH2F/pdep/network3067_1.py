...
reaction(
    label = 'reaction1',
    reactants = ['[O]OOC=[C]F(9197)'],
    products = ['O2(2)', 'FC1=CO1(3064)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]OC=[C]F(1555)'],
    products = ['[O]OOC=[C]F(9197)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[O](128)', '[CH]=[C]F(465)'],
    products = ['[O]OOC=[C]F(9197)'],
    transitionState = 'TS8',
