...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[CH]C(=O)F(427)'],
    products = ['[CH]=C(F)O[C](F)F(2182)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C#CO[C](F)F(2255)'],
    products = ['[CH]=C(F)O[C](F)F(2182)'],
    transitionState = 'TS5',
