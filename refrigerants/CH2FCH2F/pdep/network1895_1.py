...
"""),
    E0 = (-104.157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.488199,'amu*angstrom^2'), symmetry=1, barrier=(11.2247,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.486378,'amu*angstrom^2'), symmetry=1, barrier=(11.1828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.489453,'amu*angstrom^2'), symmetry=1, barrier=(11.2535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.08387,'amu*angstrom^2'), symmetry=1, barrier=(47.9123,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.229826,0.095936,-0.000174346,1.65451e-07,-5.99467e-11,-12403.9,27.1504], Tmin=(100,'K'), Tmax=(838.244,'K')), NASAPolynomial(coeffs=[7.02623,0.0364604,-1.95233e-05,3.83005e-09,-2.65691e-13,-12593.2,1.22827], Tmin=(838.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COOCC(F)F(4696)'],
    products = ['CH2CO(28)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(22.7898,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'C#COOC[C]F-2(1769)'],
    products = ['C#COOCC(F)F(4696)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#COOC[CH]F(2454)'],
    products = ['C#COOCC(F)F(4696)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H(22)', '[O]OCC(F)F(500)'],
    products = ['C#COOCC(F)F(4696)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(82)', 'C#COO[CH2](1312)'],
    products = ['C#COOCC(F)F(4696)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C#COO[CH]C(F)F(1770)'],
    products = ['C#COOCC(F)F(4696)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#COOC[C](F)F(1725)'],
    products = ['C#COOCC(F)F(4696)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[C]#COOCC(F)F(1771)'],
    products = ['C#COOCC(F)F(4696)'],
