...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.48885,'amu*angstrom^2'), symmetry=1, barrier=(34.2316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47916,'amu*angstrom^2'), symmetry=1, barrier=(34.0089,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16044,0.0509472,-3.36773e-05,-2.75581e-09,6.65637e-12,-100984,20.691], Tmin=(100,'K'), Tmax=(1012.81,'K')), NASAPolynomial(coeffs=[18.8216,0.00560393,-2.67179e-06,6.30126e-10,-5.29161e-14,-105814,-70.9189], Tmin=(1012.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-840.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H2O(3)', 'F[C]C(F)(F)OF(2632)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['FOF(1520)', 'OC(F)[C]F(1611)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(140)', 'FC=C(F)OF(3648)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(140)', 'OC(F)=C(F)F(3488)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOF(1520)', 'OC=C(F)F(1567)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O[CH]C(F)(F)OF(3649)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)[C](F)OF(3650)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(O)F(3651)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'F[CH]C(F)(F)OF(2640)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C(F)(F)OF(3652)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(127)', 'OC(F)[C](F)F(1660)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FO[C](F)F(2145)', 'O[CH]F(459)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O[C](F)C(F)(F)OF(3489)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC(F)(F)OF(3653)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', 'O=C(F)C(O)F(1180)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'OC=C(F)OF(3654)'],
    products = ['OC(F)C(F)(F)OF(3595)'],
