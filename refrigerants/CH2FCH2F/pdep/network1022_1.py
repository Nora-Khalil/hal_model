...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', 'O=C[C]F(1627)'],
    products = ['F[C]=CO[C](F)F(2184)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'FC#CO[C](F)F(2240)'],
    products = ['F[C]=CO[C](F)F(2184)'],
    transitionState = 'TS6',
