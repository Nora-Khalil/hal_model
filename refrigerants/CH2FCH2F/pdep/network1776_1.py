...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0755,0.0504676,-1.7668e-05,-2.84827e-08,1.88454e-11,-69128.8,19.7795], Tmin=(100,'K'), Tmax=(927.114,'K')), NASAPolynomial(coeffs=[20.2965,0.00328019,8.51476e-07,-2.18192e-10,1.11235e-14,-74228.9,-79.7802], Tmin=(927.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-575.752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-196.497,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,451,553,637,1069,1180,1265,1301,3056,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.725878,'amu*angstrom^2'), symmetry=1, barrier=(16.6894,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0248341,'amu*angstrom^2'), symmetry=1, barrier=(4.2001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00542521,'amu*angstrom^2'), symmetry=1, barrier=(39.5975,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76609,0.0507017,-4.94841e-05,2.64217e-08,-5.85725e-12,-23554,21.7773], Tmin=(100,'K'), Tmax=(1069.2,'K')), NASAPolynomial(coeffs=[9.24068,0.0227385,-1.02541e-05,1.96115e-09,-1.37905e-13,-25152.4,-14.7834], Tmin=(1069.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(CJCO)"""),
)

species(
    label = 'C[CH]O[C](O)F(4277)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13611,0.059525,-6.43675e-05,3.49585e-08,-7.42991e-12,-33369.3,23.1812], Tmin=(100,'K'), Tmax=(1152.3,'K')), NASAPolynomial(coeffs=[14.1097,0.0144902,-5.74454e-06,1.04254e-09,-7.17115e-14,-36359.3,-41.2483], Tmin=(1152.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFHOO) + radical(CCsJOCs) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = 'CCO[C]([O])F(4278)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u1 p2 c0 {6,S}
...
"""),
    E0 = (-203.255,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,482,586,761,1411,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0552384,'amu*angstrom^2'), symmetry=1, barrier=(25.0866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.010536,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0169846,'amu*angstrom^2'), symmetry=1, barrier=(25.0831,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82485,0.0409586,-2.13419e-05,-2.17343e-10,2.50688e-12,-24361.9,22.8021], Tmin=(100,'K'), Tmax=(1101.99,'K')), NASAPolynomial(coeffs=[11.0917,0.0192259,-7.96369e-06,1.492e-09,-1.04784e-13,-27127.1,-26.0848], Tmin=(1101.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.255,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = '[CH2][CH]OC(O)F(4279)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {4,S} {11,S}
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.849647,0.0718987,-0.000101463,7.28975e-08,-2.04999e-11,-32551.5,22.977], Tmin=(100,'K'), Tmax=(876.191,'K')), NASAPolynomial(coeffs=[12.8749,0.0169992,-7.47523e-06,1.38286e-09,-9.43621e-14,-34658.8,-33.4484], Tmin=(876.191,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-271.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFHOO) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(1122)', '[CH]C-2(510)'],
    products = ['C[CH]OC([O])F(4061)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C[CH]O[CH]F(3340)'],
    products = ['C[CH]OC([O])F(4061)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(1073)', 'C[CH][O](3430)'],
    products = ['C[CH]OC([O])F(4061)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]OC([O])F(4061)'],
    products = ['CC(F)O[CH][O](4281)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(223.129,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #1776',
    isomers = [
        'C[CH]OC([O])F(4061)',
    ],
    reactants = [
