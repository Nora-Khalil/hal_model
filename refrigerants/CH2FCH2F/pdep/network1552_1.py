...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'O=C(O)C[C]F(3826)'],
    products = ['O=C(O)CC(F)F(3288)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'O=C=CC(F)F(1782)'],
    products = ['O=C(O)CC(F)F(3288)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OC(F)F(1071)', 'CH2CO(28)'],
    products = ['O=C(O)CC(F)F(3288)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)C[CH]F(3242)'],
    products = ['O=C(O)CC(F)F(3288)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(=O)CC(F)F(3193)'],
    products = ['O=C(O)CC(F)F(3288)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(158)', 'CHF2-CH2(64)'],
    products = ['O=C(O)CC(F)F(3288)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(O)[CH]C(F)F(3833)'],
    products = ['O=C(O)CC(F)F(3288)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C[C](F)F(3195)'],
    products = ['O=C(O)CC(F)F(3288)'],
