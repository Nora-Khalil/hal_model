...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)C=C(F)F(1153)'],
    products = ['[O]C(F)C[C](F)F(1110)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)C[C](F)F(1154)'],
    products = ['[O]C(F)C[C](F)F(1110)'],
