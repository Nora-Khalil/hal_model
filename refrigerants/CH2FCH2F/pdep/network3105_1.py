...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C1O[C]1F(9399)'],
    products = ['[CH2]OC1O[C]1F(9315)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]OC1=C(F)O1(9450)'],
    products = ['[CH2]OC1O[C]1F(9315)'],
    transitionState = 'TS8',
