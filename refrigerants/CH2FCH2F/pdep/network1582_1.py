...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=C[C]F(1939)'],
    products = ['[CH2]CC=[C]F(3532)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]F(465)', '[CH2][CH2](511)'],
    products = ['[CH2]CC=[C]F(3532)'],
    transitionState = 'TS9',
