...
"""),
    ...
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.309344,0.104304,-0.000172847,1.51652e-07,-5.25073e-11,-120043,31.9555], Tmin=(100,'K'), Tmax=(798.221,'K')), NASAPolynomial(coeffs=[11.3658,0.0338467,-1.79864e-05,3.55695e-09,-2.49582e-13,-121526,-19.3541], Tmin=(798.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-999.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFFH) + group(Cds-OdCsH) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.302917,'amu*angstrom^2'), symmetry=1, barrier=(6.96465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00246,'amu*angstrom^2'), symmetry=1, barrier=(23.0484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302796,'amu*angstrom^2'), symmetry=1, barrier=(6.96187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12485,'amu*angstrom^2'), symmetry=1, barrier=(48.8545,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0934545,0.101608,-0.000179581,1.64522e-07,-5.82252e-11,-23158.2,32.4242], Tmin=(100,'K'), Tmax=(827.202,'K')), NASAPolynomial(coeffs=[9.55854,0.0337882,-1.82547e-05,3.59966e-09,-2.50804e-13,-24031.5,-7.93688], Tmin=(827.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    E0 = (-458.602,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,190,488,555,1236,1407,182,240,577,636,1210,1413,180,2213.38],'cm^-1')),
        HinderedRotor(inertia=(0.327684,'amu*angstrom^2'), symmetry=1, barrier=(7.5341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77271,'amu*angstrom^2'), symmetry=1, barrier=(40.758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77219,'amu*angstrom^2'), symmetry=1, barrier=(40.7461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77234,'amu*angstrom^2'), symmetry=1, barrier=(40.7495,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.287209,0.106005,-0.000186164,1.70308e-07,-6.05689e-11,-55014,34.1282], Tmin=(100,'K'), Tmax=(814.344,'K')), NASAPolynomial(coeffs=[10.0385,0.035403,-1.94941e-05,3.88033e-09,-2.72224e-13,-56036.5,-9.51895], Tmin=(814.344,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-458.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CCsJOOC) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = 'F[C](F)COO[C]=C(F)F(5226)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.15875,'amu*angstrom^2'), symmetry=1, barrier=(3.64997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159317,'amu*angstrom^2'), symmetry=1, barrier=(3.66301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15852,'amu*angstrom^2'), symmetry=1, barrier=(3.64468,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.35486,'amu*angstrom^2'), symmetry=1, barrier=(54.1429,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (158.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.122256,0.106376,-0.000200598,1.94158e-07,-7.12376e-11,-48612.9,36.3684], Tmin=(100,'K'), Tmax=(837.224,'K')), NASAPolynomial(coeffs=[6.67093,0.0404094,-2.23716e-05,4.43159e-09,-3.08651e-13,-48575.9,11.816], Tmin=(837.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(C=CJO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.254939,'amu*angstrom^2'), symmetry=1, barrier=(5.86154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255767,'amu*angstrom^2'), symmetry=1, barrier=(5.88059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37429,'amu*angstrom^2'), symmetry=1, barrier=(31.5976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (159.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.347118,0.10545,-0.00017456,1.54177e-07,-5.39001e-11,-75765.7,32.3008], Tmin=(100,'K'), Tmax=(791.824,'K')), NASAPolynomial(coeffs=[11.0623,0.0355958,-1.90865e-05,3.79119e-09,-2.66857e-13,-77189.5,-17.6615], Tmin=(791.824,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-631.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)COOC=C(F)F(5006)'],
    products = ['O=C[C](F)F(787)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F[C](F)COOC=C(F)F(5006)'],
    products = ['O=CC(F)(F)OC[C](F)F(5221)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'F[C]COOC=C(F)F(5222)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(744)', '[CH2]OOC=C(F)F(1854)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)COOC=C(F)F(5006)'],
    products = ['O=C[C](F)F(787)', 'FC1(F)CO1(783)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C](F)COOC=C(F)F(5006)'],
    products = ['FC1(F)[CH]OOCC1(F)F(5223)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F[C](F)COOC=C(F)F(5006)'],
    products = ['F[C](F)C1OOCC1(F)F(5224)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]OC=C(F)F(785)', 'CH2CF2(57)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC(F)=COOC=C(F)F(1703)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[C]=COOC[C](F)F(5225)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C[C](F)F(787)', '[O]C[C](F)F(518)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC=C(F)F(785)', '[CH2][C](F)F(507)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CF2CH(73)', '[O]OC[C](F)F(699)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'F[C](F)[CH]OOC=C(F)F(1700)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'F[C](F)COO[C]=C(F)F(5226)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'FC#COOC[C](F)F(5227)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'F[C]COOC=C(F)F-2(5228)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CF2(43)', '[CH2]OOC=C(F)F(1854)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FC(F)=[C]OOCC(F)F(5229)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[C]=COOCC(F)(F)F(5230)'],
    products = ['F[C](F)COOC=C(F)F(5006)'],
...
network(
    label = 'PDepNetwork #2000',
    isomers = [
        'F[C](F)COOC=C(F)F(5006)',
    ],
    reactants = [
        ('O=C[C](F)F(787)', 'O=CC(F)F(990)'),
        ('O=C[C](F)F(787)', 'FC1(F)CO1(783)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
