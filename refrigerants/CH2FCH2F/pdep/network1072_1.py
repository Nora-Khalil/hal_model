...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]OO[O](198)'],
    products = ['O=O(141)', 'CH2CO(28)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](128)', '[C]=C(368)'],
    products = ['C=[C]OO[O](198)'],
    transitionState = 'TS2',
