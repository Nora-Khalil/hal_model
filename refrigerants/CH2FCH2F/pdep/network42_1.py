...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C[CH]F(138)'],
    products = ['O=[C]OC[CH]F(171)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]O[C]=O(275)'],
    products = ['O=[C]OC[CH]F(171)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]O[C]=O(275)'],
    products = ['O=[C]OC[CH]F(171)'],
