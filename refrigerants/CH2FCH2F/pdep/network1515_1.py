...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[CH2]C[O](325)'],
    products = ['[CH2]CO[C](F)F(3263)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C](F)F(941)'],
    products = ['[CH2]CO[C](F)F(3263)'],
    transitionState = 'TS3',
