...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'O=[C]C(F)F(1631)'],
    products = ['CC(F)(F)[C]=O(1542)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C[C](F)[C]=O(12457)'],
    products = ['CC(F)(F)[C]=O(1542)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'O=[C][C](F)F(1629)'],
    products = ['CC(F)(F)[C]=O(1542)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_4R!H->O',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_4R!H->O"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)[C]=O(876)'],
    products = ['CC(F)(F)[C]=O(1542)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CC(F)(F)[C]=O(1542)'],
    products = ['C[C](F)C(=O)F(12458)'],
