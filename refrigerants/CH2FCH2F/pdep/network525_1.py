...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', '[O]C([O])F(1122)'],
    products = ['[O]C(F)O[CH]F(1118)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[CH]F(1084)'],
    products = ['[O]C(F)O[CH]F(1118)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)O[CH]F(1175)'],
    products = ['[O]C(F)O[CH]F(1118)'],
    transitionState = 'TS8',
