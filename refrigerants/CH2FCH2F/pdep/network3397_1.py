...
"""),
    E0 = (-295.588,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([286,334,437,422,648,895,1187,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,266.832,2203.34],'cm^-1')),
        HinderedRotor(inertia=(0.216035,'amu*angstrom^2'), symmetry=1, barrier=(9.8663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195684,'amu*angstrom^2'), symmetry=1, barrier=(9.85035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.513996,'amu*angstrom^2'), symmetry=1, barrier=(24.5322,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26907,0.0643137,-6.74657e-05,3.99099e-08,-9.94677e-12,-35456.2,24.4121], Tmin=(100,'K'), Tmax=(950.697,'K')), NASAPolynomial(coeffs=[9.22831,0.0308252,-1.46273e-05,2.85695e-09,-2.03024e-13,-36969.6,-13.5841], Tmin=(950.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-295.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(RCCJ)"""),
)
...
"""),
    E0 = (-210.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,244,1102,1254,1379,1468,1475,3037,3083,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,253.98,254.283],'cm^-1')),
        HinderedRotor(inertia=(0.0021101,'amu*angstrom^2'), symmetry=1, barrier=(9.99638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.6329,'amu*angstrom^2'), symmetry=1, barrier=(28.3684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218542,'amu*angstrom^2'), symmetry=1, barrier=(9.98086,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0882,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03475,0.0509022,-3.51565e-05,-2.26513e-08,3.91778e-11,-25250.9,19.6461], Tmin=(100,'K'), Tmax=(497.319,'K')), NASAPolynomial(coeffs=[6.12422,0.0310766,-1.47697e-05,2.85064e-09,-1.99746e-13,-25819.2,1.14884], Tmin=(497.319,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-210.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(CJCC=O)"""),
)
...
"""),
    E0 = (-56.1029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,235,1215,1347,1486,3221,254.347,2374.53],'cm^-1')),
        HinderedRotor(inertia=(0.00260279,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277098,'amu*angstrom^2'), symmetry=1, barrier=(12.7303,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.968707,'amu*angstrom^2'), symmetry=1, barrier=(44.4079,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7929,0.0523498,-6.201e-05,4.52673e-08,-1.41161e-11,-6671.63,20.31], Tmin=(100,'K'), Tmax=(767.728,'K')), NASAPolynomial(coeffs=[6.63803,0.0271068,-1.26915e-05,2.44253e-09,-1.71336e-13,-7415.6,-1.78449], Tmin=(767.728,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.1029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(CJCC=O) + radical(Csj(CO-CsO2d)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.449874,0.0859204,-0.000136057,1.18792e-07,-4.10878e-11,-39563.5,25.8987], Tmin=(100,'K'), Tmax=(815.021,'K')), NASAPolynomial(coeffs=[8.97457,0.0324145,-1.61085e-05,3.11134e-09,-2.15722e-13,-40565.5,-11.107], Tmin=(815.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-329.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sCs)(F1s)(H)) + radical(RCCJ)"""),
)

species(
    label = 'CCC([O])(F)[CH]F(10471)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.653446,0.082538,-0.000132937,1.20286e-07,-4.27116e-11,-36119.5,24.5229], Tmin=(100,'K'), Tmax=(830.688,'K')), NASAPolynomial(coeffs=[7.00581,0.0352459,-1.73776e-05,3.33725e-09,-2.30236e-13,-36598.6,-1.47632], Tmin=(830.688,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-301.245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsCsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-F1sO2sCs)(F1s)(H))"""),
)

species(
    label = '[CH2]C[C](CF)OF(10472)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (14.2489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,3000,3100,440,815,1455,1000,213.946,214.025,2226.4],'cm^-1')),
        HinderedRotor(inertia=(0.306687,'amu*angstrom^2'), symmetry=1, barrier=(9.91999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00370879,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05915,'amu*angstrom^2'), symmetry=1, barrier=(34.2519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.306733,'amu*angstrom^2'), symmetry=1, barrier=(9.91875,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.79794,0.0767347,-0.000112361,9.55134e-08,-3.29453e-11,1823,26.7726], Tmin=(100,'K'), Tmax=(793.114,'K')), NASAPolynomial(coeffs=[8.0643,0.0329195,-1.59382e-05,3.06789e-09,-2.13289e-13,895.829,-5.17785], Tmin=(793.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.2489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCsFHH) + group(Cs-CsHHH) + radical(C2CsJO) + radical(RCCJ)"""),
)

species(
    label = '[O][C](CF)CCF(10473)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {7,S}
...
"""),
    E0 = (-287.457,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,285.141,285.168,285.203,285.212],'cm^-1')),
        HinderedRotor(inertia=(0.180339,'amu*angstrom^2'), symmetry=1, barrier=(10.4196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180545,'amu*angstrom^2'), symmetry=1, barrier=(10.4198,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379553,'amu*angstrom^2'), symmetry=1, barrier=(21.9187,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.884025,0.0739186,-9.70279e-05,7.33435e-08,-2.29204e-11,-34465.8,24.2664], Tmin=(100,'K'), Tmax=(774.718,'K')), NASAPolynomial(coeffs=[9.06841,0.0316648,-1.52232e-05,2.95409e-09,-2.07755e-13,-35734,-13.1301], Tmin=(774.718,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.457,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCsFHH) + group(CsCsFHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CC([CH2])(F)OF(10474)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {3,S}
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH2]CC([O])F(3260)'],
    products = ['[CH2]CC([O])(F)CF(9992)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH2]CC([O])(F)F(3262)'],
    products = ['[CH2]CC([O])(F)CF(9992)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C[C](F)CF(1204)'],
    products = ['[CH2]CC([O])(F)CF(9992)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', '[CH2]C([O])(F)CF(1051)'],
    products = ['[CH2]CC([O])(F)CF(9992)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]CC(=O)CF(10467)'],
    products = ['[CH2]CC([O])(F)CF(9992)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2F(46)', '[CH2]CC(=O)F(2652)'],
    products = ['[CH2]CC([O])(F)CF(9992)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=CC([O])(F)CF(10120)'],
    products = ['[CH2]CC([O])(F)CF(9992)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', '[CH2]CC(=C)[O](3255)'],
    products = ['[CH2]CC([O])(F)CF(9992)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2]C=C([O])CF(399)'],
    products = ['[CH2]CC([O])(F)CF(9992)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]CC(=O)[CH]F(5205)'],
    products = ['[CH2]CC([O])(F)CF(9992)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC([O])(F)CF(9992)'],
    products = ['[CH2][CH]C(O)(F)CF(10469)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC([O])(F)CF(9992)'],
    products = ['[CH2]CC(O)(F)[CH]F(10470)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC([CH2])(F)OF(10474)'],
    products = ['[CH2]CC([O])(F)CF(9992)'],
