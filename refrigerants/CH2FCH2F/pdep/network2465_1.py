...
"""),
    E0 = (118.833,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,797.61],'cm^-1')),
        HinderedRotor(inertia=(0.517462,'amu*angstrom^2'), symmetry=1, barrier=(11.8975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126943,'amu*angstrom^2'), symmetry=1, barrier=(2.91867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00642828,'amu*angstrom^2'), symmetry=1, barrier=(2.86687,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7348,0.0432476,-2.04579e-05,-3.21272e-10,2.22143e-12,14379.3,21.6911], Tmin=(100,'K'), Tmax=(1125.04,'K')), NASAPolynomial(coeffs=[10.0238,0.0244802,-9.70653e-06,1.76441e-09,-1.21234e-13,11836.8,-22.2855], Tmin=(1125.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)
...
"""),
    E0 = (158.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1593.09,1593.55],'cm^-1')),
        HinderedRotor(inertia=(0.00365575,'amu*angstrom^2'), symmetry=1, barrier=(6.58513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286515,'amu*angstrom^2'), symmetry=1, barrier=(6.58755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.12516,0.0202321,6.22899e-07,-6.19708e-09,1.72051e-12,19042.6,16.7651], Tmin=(100,'K'), Tmax=(1581.53,'K')), NASAPolynomial(coeffs=[6.24603,0.0215747,-9.4102e-06,1.7247e-09,-1.15418e-13,16900.4,-3.37351], Tmin=(1581.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCOJ) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94484,0.0349454,7.66236e-06,-3.36231e-08,1.49831e-11,-22687.9,20.7219], Tmin=(100,'K'), Tmax=(989.604,'K')), NASAPolynomial(coeffs=[11.37,0.0209935,-7.78739e-06,1.4396e-09,-1.03044e-13,-25735.6,-30.6239], Tmin=(989.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74738,0.0520371,-4.94713e-05,2.87642e-08,-7.24977e-12,7908.68,21.2672], Tmin=(100,'K'), Tmax=(932.17,'K')), NASAPolynomial(coeffs=[7.09926,0.0290718,-1.25165e-05,2.33485e-09,-1.61613e-13,6910.91,-4.17657], Tmin=(932.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.0998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C(C)[O](7170)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {5,S} {6,S}
3  C u0 p0 c0 {2,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93137,0.0368978,-2.88189e-07,-2.29681e-08,1.06435e-11,13731.5,21.6919], Tmin=(100,'K'), Tmax=(1011.05,'K')), NASAPolynomial(coeffs=[10.2269,0.0234022,-8.93528e-06,1.63759e-09,-1.15074e-13,11066.4,-23.3047], Tmin=(1011.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2][CH]C(C)O(7171)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79499,0.041747,-1.70401e-05,-5.22668e-09,4.43743e-12,10714.1,24.1602], Tmin=(100,'K'), Tmax=(1041.52,'K')), NASAPolynomial(coeffs=[10.1682,0.022764,-8.67515e-06,1.56437e-09,-1.07963e-13,8255.37,-20.007], Tmin=(1041.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([CH2])O(7172)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {13,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {6,S}
3  C u0 p0 c0 {2,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (100.061,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,702.658],'cm^-1')),
        HinderedRotor(inertia=(0.0759698,'amu*angstrom^2'), symmetry=1, barrier=(1.74669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0743331,'amu*angstrom^2'), symmetry=1, barrier=(1.70906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0755105,'amu*angstrom^2'), symmetry=1, barrier=(1.73613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516741,'amu*angstrom^2'), symmetry=1, barrier=(11.8809,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53762,0.0510969,-4.16986e-05,1.84751e-08,-3.37148e-12,12125.7,23.2207], Tmin=(100,'K'), Tmax=(1292.34,'K')), NASAPolynomial(coeffs=[10.6393,0.0229262,-9.00171e-06,1.60832e-09,-1.08678e-13,9773.17,-23.0239], Tmin=(1292.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.061,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8589,0.0476154,-3.47199e-05,1.40984e-08,-2.4752e-12,10926.7,18.8778], Tmin=(100,'K'), Tmax=(1281.48,'K')), NASAPolynomial(coeffs=[8.13137,0.0280368,-1.18029e-05,2.1764e-09,-1.49399e-13,9319.1,-12.939], Tmin=(1281.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.2142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C([O])CC(7174)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
...
"""),
    E0 = (125.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0441658,'amu*angstrom^2'), symmetry=1, barrier=(23.0816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0039,'amu*angstrom^2'), symmetry=1, barrier=(23.0816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.451141,'amu*angstrom^2'), symmetry=1, barrier=(10.3726,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52113,0.0479928,-3.07941e-05,7.97465e-09,-1.13152e-13,15149.8,21.3049], Tmin=(100,'K'), Tmax=(1146.86,'K')), NASAPolynomial(coeffs=[11.1279,0.0228555,-8.86265e-06,1.58896e-09,-1.08219e-13,12395.9,-28.7581], Tmin=(1146.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]CC[O](3245)'],
    products = ['[CH2]CC(C)[O](6695)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(C)[O](3496)'],
    products = ['[CH2]CC(C)[O](6695)'],
    transitionState = 'TS4',
