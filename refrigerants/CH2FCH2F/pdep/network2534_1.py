...
"""),
    E0 = (-728.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,346.387,346.388,346.397],'cm^-1')),
        HinderedRotor(inertia=(0.115171,'amu*angstrom^2'), symmetry=1, barrier=(9.80611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115176,'amu*angstrom^2'), symmetry=1, barrier=(9.80607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18121,'amu*angstrom^2'), symmetry=1, barrier=(15.4289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.395392,'amu*angstrom^2'), symmetry=1, barrier=(33.6675,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.066,'amu'),
...
"""),
    E0 = (-632.802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,307.82,307.896,307.977],'cm^-1')),
        HinderedRotor(inertia=(0.00177886,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167228,'amu*angstrom^2'), symmetry=1, barrier=(11.2442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167197,'amu*angstrom^2'), symmetry=1, barrier=(11.2439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
...
"""),
    E0 = (-502.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,237.769,237.811,237.848,237.898],'cm^-1')),
        HinderedRotor(inertia=(0.00225915,'amu*angstrom^2'), symmetry=1, barrier=(7.24535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180499,'amu*angstrom^2'), symmetry=1, barrier=(7.24547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949662,'amu*angstrom^2'), symmetry=1, barrier=(38.1386,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-548.55,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,2750,2850,1437.5,1250,1305,750,350,522,611,926,1093,1137,1374,1416,3112,360,370,350,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.262303,'amu*angstrom^2'), symmetry=1, barrier=(6.03086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.259863,'amu*angstrom^2'), symmetry=1, barrier=(5.97477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25944,'amu*angstrom^2'), symmetry=1, barrier=(5.96504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.531406,'amu*angstrom^2'), symmetry=1, barrier=(12.2181,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
...
"""),
    E0 = (-526.786,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,256.623,257.039,257.257],'cm^-1')),
        HinderedRotor(inertia=(0.185783,'amu*angstrom^2'), symmetry=1, barrier=(8.68249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00255322,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185516,'amu*angstrom^2'), symmetry=1, barrier=(8.67582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.390268,'amu*angstrom^2'), symmetry=1, barrier=(18.3221,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
...
"""),
    E0 = (-748.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,195,270,1147,1130,1359,1388,1409,3075,375,552.5,462.5,1710,326.406,326.407],'cm^-1')),
        HinderedRotor(inertia=(0.00158229,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146494,'amu*angstrom^2'), symmetry=1, barrier=(11.0757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146492,'amu*angstrom^2'), symmetry=1, barrier=(11.0757,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57539,0.0567674,-6.4211e-05,3.97969e-08,-1.01722e-11,-89936.9,22.7143], Tmin=(100,'K'), Tmax=(938.097,'K')), NASAPolynomial(coeffs=[9.33108,0.0236976,-1.13333e-05,2.21917e-09,-1.57861e-13,-91392.1,-14.2069], Tmin=(938.097,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-748.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cds-OdCsCs)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'OCC([C]F)OF(7113)'],
    products = ['OCC(OF)C(F)F(6738)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(140)', 'OC=CC(F)F(1838)'],
    products = ['OCC(OF)C(F)F(6738)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(140)', 'OCC=C(F)F(944)'],
    products = ['OCC(OF)C(F)F(6738)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H2O(3)', 'C=C(OF)C(F)F(3341)'],
    products = ['OCC(OF)C(F)F(6738)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OCC([CH]F)OF(7115)'],
    products = ['OCC(OF)C(F)F(6738)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(CO)C(F)F(7116)'],
    products = ['OCC(OF)C(F)F(6738)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'OC[CH]C(F)F(5642)'],
    products = ['OCC(OF)C(F)F(6738)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', '[CH2]C(OF)C(F)F(5297)'],
    products = ['OCC(OF)C(F)F(6738)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]CC(OF)C(F)F(7117)'],
    products = ['OCC(OF)C(F)F(6738)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2OH(33)', 'FO[CH]C(F)F(4702)'],
    products = ['OCC(OF)C(F)F(6738)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHF2(82)', 'OC[CH]OF(4250)'],
    products = ['OCC(OF)C(F)F(6738)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OC[C](OF)C(F)F(7118)'],
    products = ['OCC(OF)C(F)F(6738)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O[CH]C(OF)C(F)F(6075)'],
    products = ['OCC(OF)C(F)F(6738)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OCC(OF)[C](F)F(7119)'],
    products = ['OCC(OF)C(F)F(6738)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=C(CO)C(F)F(5086)'],
    products = ['OCC(OF)C(F)F(6738)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(439.506,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)
