...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COOC(F)O[O](9746)'],
    products = ['C#COOCC(F)O[O](9151)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['HO2(11)', 'C#COOC[C]F-2(1769)'],
    products = ['C#COOCC(F)O[O](9151)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'C#COOCO[O](3793)'],
    products = ['C#COOCC(F)O[O](9151)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O(6)', 'C#COOCC([O])F(9748)'],
    products = ['C#COOCC(F)O[O](9151)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C#COOCC(F)O[O](9151)'],
    products = ['HCCO(21)', 'FC1COOO1(1271)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C#COOCC(F)O[O](9151)'],
    products = ['HO2(11)', 'C#COOC=CF(2532)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C#COOC[CH]O[O](9751)'],
    products = ['C#COOCC(F)O[O](9151)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HCCO(21)', '[O]CC(F)O[O](2435)'],
    products = ['C#COOCC(F)O[O](9151)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C#CO[O](451)', '[CH2]C(F)O[O](216)'],
    products = ['C#COOCC(F)O[O](9151)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O2(2)', 'C#COOC[CH]F(2454)'],
    products = ['C#COOCC(F)O[O](9151)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C2H(22)', '[O]OCC(F)O[O](9752)'],
    products = ['C#COOCC(F)O[O](9151)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]O[CH]F(287)', 'C#COO[CH2](1312)'],
    products = ['C#COOCC(F)O[O](9151)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C#COO[CH]C(F)O[O](9753)'],
    products = ['C#COOCC(F)O[O](9151)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C#COOC[C](F)O[O](3798)'],
    products = ['C#COOCC(F)O[O](9151)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[C]#COOCC(F)O[O](9754)'],
    products = ['C#COOCC(F)O[O](9151)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C#COOC=CO[O](9755)'],
    products = ['C#COOCC(F)O[O](9151)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C#COOCC(F)O[O](9151)'],
    products = ['OH(7)', 'C#COOCC(=O)F(9756)'],
