...
"""),
    E0 = (-1134.16,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,205,317,423,563,514,686,1105,1199,1293,1437,1381,1463,3031,3163,326,540,652,719,1357,194,682,905,1196,1383,3221,254.692,254.713,254.714,911.416],'cm^-1')),
        HinderedRotor(inertia=(0.529174,'amu*angstrom^2'), symmetry=1, barrier=(24.3591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.529124,'amu*angstrom^2'), symmetry=1, barrier=(24.3595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.529148,'amu*angstrom^2'), symmetry=1, barrier=(24.3595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.382672,'amu*angstrom^2'), symmetry=1, barrier=(17.6198,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.26243,0.0936501,-0.000105818,5.85113e-08,-1.27448e-11,-136254,29.5838], Tmin=(100,'K'), Tmax=(1116.14,'K')), NASAPolynomial(coeffs=[19.2488,0.0237262,-1.18464e-05,2.3823e-09,-1.72664e-13,-140609,-66.6905], Tmin=(1116.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1134.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)
...
species(
    label = 'O=C(F)C(F)C(O)C(F)F(11841)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0994847,0.0978119,-0.000140998,1.09589e-07,-3.44291e-11,-150156,31.8546], Tmin=(100,'K'), Tmax=(776.148,'K')), NASAPolynomial(coeffs=[12.3027,0.0338924,-1.74605e-05,3.47175e-09,-2.46905e-13,-152081,-24.8352], Tmin=(776.148,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1249.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFFH) + group(COCsFO)"""),
)

species(
    label = 'O[C](OC(F)[CH]F)C(F)F(11842)',
...
"""),
    E0 = (-879.93,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,522,611,926,1093,1137,1374,1416,3112,360,370,350,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.663999,0.111252,-0.000172727,1.3967e-07,-4.50128e-11,-105671,35.1389], Tmin=(100,'K'), Tmax=(760.616,'K')), NASAPolynomial(coeffs=[14.3203,0.0324518,-1.7329e-05,3.46764e-09,-2.46427e-13,-107951,-33.0518], Tmin=(760.616,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-879.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Cs_P) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-883.689,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,522,611,926,1093,1137,1374,1416,3112,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,395,473,707,1436,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OC(OC(F)[CH]F)[C](F)F(11843)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-877.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,487,638,688,1119,1325,1387,3149,190,488,555,1236,1407,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.739743,0.114747,-0.000192362,1.68772e-07,-5.8196e-11,-105384,36.2203], Tmin=(100,'K'), Tmax=(802.96,'K')), NASAPolynomial(coeffs=[12.4461,0.0354898,-1.89515e-05,3.74844e-09,-2.62753e-13,-107065,-21.776], Tmin=(802.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-877.551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(F1s)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (160.067,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3698.1,'J/mol'), sigma=(5.9915,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=577.64 K, Pc=39.01 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-728.298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,326,540,652,719,1357,334,575,1197,1424,3202,194,682,905,1196,1383,3221,324.695,325.955,330.167,332.036],'cm^-1')),
        HinderedRotor(inertia=(0.115952,'amu*angstrom^2'), symmetry=1, barrier=(8.93065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116757,'amu*angstrom^2'), symmetry=1, barrier=(8.90385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.280353,'amu*angstrom^2'), symmetry=1, barrier=(21.2665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116737,'amu*angstrom^2'), symmetry=1, barrier=(8.94125,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.182594,0.101606,-0.000153273,1.11523e-07,-2.84815e-11,-87452.4,29.8337], Tmin=(100,'K'), Tmax=(635.887,'K')), NASAPolynomial(coeffs=[13.8783,0.0279986,-1.46491e-05,2.89263e-09,-2.03447e-13,-89540.6,-33.9953], Tmin=(635.887,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-728.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Csj(Cs-O2sO2sH)(F1s)(H))"""),
)

species(
    label = 'OC(O[C]=CF)C(F)F(11844)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-713.934,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,615,860,1140,1343,3152,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0213011,0.0908221,-0.000115675,7.27913e-08,-1.79704e-11,-85723.5,30.0081], Tmin=(100,'K'), Tmax=(992.004,'K')), NASAPolynomial(coeffs=[17.2365,0.0212342,-1.04521e-05,2.07676e-09,-1.49204e-13,-89147.4,-53.1123], Tmin=(992.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-713.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-Cs))"""),
)
...
species(
    label = 'OC([O+]=[C-]C(F)F)C(F)F(11847)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.489601,0.111396,-0.000193476,1.7881e-07,-6.4494e-11,-91948.5,33.2817], Tmin=(100,'K'), Tmax=(808.368,'K')), NASAPolynomial(coeffs=[9.40343,0.0407778,-2.22366e-05,4.43299e-09,-3.11875e-13,-92840.1,-7.96354], Tmin=(808.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-765.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsCs) + group(CsCsFFH) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)(F)OC(O)C(F)F(11848)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.753498,0.114618,-0.000190256,1.65692e-07,-5.71784e-11,-107273,33.4491], Tmin=(100,'K'), Tmax=(777.633,'K')), NASAPolynomial(coeffs=[12.9318,0.0350611,-1.91249e-05,3.82963e-09,-2.70911e-13,-109124,-27.3517], Tmin=(777.633,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-893.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(CsCFFO) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (-686.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,235,523,627,1123,1142,1372,1406,3097,2175,525,239,401,1367,358.395,358.58,358.633,359.13],'cm^-1')),
        HinderedRotor(inertia=(0.19723,'amu*angstrom^2'), symmetry=1, barrier=(18.0017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197242,'amu*angstrom^2'), symmetry=1, barrier=(18.0039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197293,'amu*angstrom^2'), symmetry=1, barrier=(18.0008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19723,'amu*angstrom^2'), symmetry=1, barrier=(17.9982,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.109601,0.0871087,-0.000110417,6.73649e-08,-1.6021e-11,-82430.1,27.3209], Tmin=(100,'K'), Tmax=(1030.83,'K')), NASAPolynomial(coeffs=[18.0437,0.0175163,-9.14801e-06,1.87017e-09,-1.36666e-13,-86127.4,-59.7447], Tmin=(1030.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-686.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Ct-CtOs) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OC(OC(F)=CF)C(F)F(8754)'],
    products = ['O=C(F)CF(476)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(145.187,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OCOC(F)=CF(7351)'],
...
reaction(
    label = 'reaction3',
    reactants = ['HF(38)', 'OC([C]F)OC(F)=CF(11838)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OC(F)C(F)OC(F)=CF(11839)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OC(F)=CF(3655)', 'OC=C(F)F(1567)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FC=C(F)OF(3648)', 'OC=CF(455)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'FC=C(F)OC=C(F)F(11840)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(140)', 'FC=COC(F)=CF(10043)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OC(OC(F)=CF)C(F)F(8754)'],
    products = ['O=C(F)C(F)C(O)C(F)F(11841)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(114.569,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['O[C](OC(F)[CH]F)C(F)F(11842)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O[C](O[C](F)CF)C(F)F(10690)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OC(OC(F)[CH]F)[C](F)F(11843)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'OC([CH]F)OC(F)=CF(10913)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'OC(O[C]=CF)C(F)F(11844)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', '[CH]=C(F)OC(O)C(F)F(7316)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=C(F)[CH]F(980)', 'O[CH]C(F)F(1906)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(2.37234,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction21',
    reactants = ['CHFCF[Z](72)', '[O]C(O)C(F)F(4954)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction22',
    reactants = ['OH(7)', 'FC=C(F)O[CH]C(F)F(4781)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CHF2(82)', 'O[CH]OC(F)=CF(11000)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(5)', 'O[C](OC(F)=CF)C(F)F(11845)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(5)', 'OC(OC(F)=CF)[C](F)F(10897)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(5)', 'OC(OC(F)=[C]F)C(F)F(11846)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OC(OC(F)=CF)C(F)F(8754)'],
    products = ['O=C(F)CF(476)', 'OC=C(F)F(1567)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(3.33333e+07,'s^-1'), n=1.2, Ea=(184.515,'kJ/mol'), T0=(1,'K'), Tmin=(500,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O"""),
)

reaction(
    label = 'reaction29',
    reactants = ['OC([O+]=[C-]C(F)F)C(F)F(11847)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(3.82066e+10,'s^-1'), n=0.827, Ea=(75.8106,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction30',
    reactants = ['[CH]C(F)(F)OC(O)C(F)F(11848)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction31',
    reactants = ['OC(OC(F)[C]F)C(F)F(8741)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction33',
    reactants = ['F2(78)', 'C#COC(O)C(F)F(4697)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction34',
    reactants = ['HF(38)', 'OC(OC#CF)C(F)F(11849)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
reaction(
    label = 'reaction35',
    reactants = ['OC(OC(F)=CF)C(F)F(8754)'],
    products = ['HF(38)', 'O=C=CF(434)', 'O=CC(F)F(990)'],
    transitionState = 'TS35',
    kinetics = Arrhenius(A=(5.29418e+10,'s^-1'), n=0.745914, Ea=(194.772,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_7R!H->C',), comment="""Estimated from node Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_7R!H->C"""),
)

reaction(
    label = 'reaction36',
    reactants = ['CHF(40)', 'OC([O+]=[C-]F)C(F)F(7320)'],
    products = ['OC(OC(F)=CF)C(F)F(8754)'],
...
network(
    ...
    isomers = [
        'OC(OC(F)=CF)C(F)F(8754)',
    ],
    reactants = [
        ('O=C(F)CF(476)', 'O=CC(F)F(990)'),
        ('O=C(F)[CH]F(980)', 'O[CH]C(F)F(1906)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
