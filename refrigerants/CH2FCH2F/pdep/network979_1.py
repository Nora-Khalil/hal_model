...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C#COO(1351)'],
    products = ['C#COOC(F)F(2143)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(1061)', 'HCCO(21)'],
    products = ['C#COOC(F)F(2143)'],
    transitionState = 'TS5',
