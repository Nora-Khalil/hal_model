...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'O=[C]C[C](F)F(837)'],
    products = ['[CH2]C(F)(F)C[C]=O(686)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(129)', '[CH2]C([CH2])(F)F(598)'],
    products = ['[CH2]C(F)(F)C[C]=O(686)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C([CH2])(F)F(598)'],
    products = ['[CH2]C(F)(F)C[C]=O(686)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(F)C[C]=O(360)'],
    products = ['[CH2]C(F)(F)C[C]=O(686)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)(F)C=C=O(637)'],
    products = ['[CH2]C(F)(F)C[C]=O(686)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C[C]=O(840)'],
    products = ['[CH2]C(F)(F)C[C]=O(686)'],
