...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30527,0.0649569,-8.42052e-05,6.16669e-08,-1.87979e-11,-116359,23.3899], Tmin=(100,'K'), Tmax=(789.981,'K')), NASAPolynomial(coeffs=[8.54683,0.0282927,-1.45932e-05,2.92575e-09,-2.09938e-13,-117503,-9.83983], Tmin=(789.981,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-968.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsFHHO) + group(Cds-OdCsH)"""),
)

species(
    label = 'F[CH]OOC[C](F)F(5025)',
...
"""),
    E0 = (-408.295,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,190,488,555,1236,1407,580,1155,1237,1373,3147,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.361967,'amu*angstrom^2'), symmetry=1, barrier=(8.32233,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73903,'amu*angstrom^2'), symmetry=1, barrier=(39.9837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73805,'amu*angstrom^2'), symmetry=1, barrier=(39.9611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362049,'amu*angstrom^2'), symmetry=1, barrier=(8.32422,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.41852,0.0884866,-0.000153412,1.40114e-07,-4.9847e-11,-48987,28.0928], Tmin=(100,'K'), Tmax=(815.172,'K')), NASAPolynomial(coeffs=[8.80307,0.0307534,-1.66483e-05,3.29871e-09,-2.31014e-13,-49802.7,-7.26332], Tmin=(815.172,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-408.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFHHO) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(CsF1sHO2s)"""),
)

species(
    label = 'F[CH]OO[CH]C(F)F(4997)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-424.321,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,580,1155,1237,1373,3147,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.32884,'amu*angstrom^2'), symmetry=1, barrier=(53.5447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.356513,'amu*angstrom^2'), symmetry=1, barrier=(8.19694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09489,'amu*angstrom^2'), symmetry=1, barrier=(25.1737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.33186,'amu*angstrom^2'), symmetry=1, barrier=(53.6141,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.483382,0.0865736,-0.000147132,1.33845e-07,-4.77564e-11,-50916.3,27.3175], Tmin=(100,'K'), Tmax=(807.447,'K')), NASAPolynomial(coeffs=[8.57765,0.0314835,-1.69406e-05,3.35798e-09,-2.35627e-13,-51734.8,-6.97524], Tmin=(807.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-424.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFHHO) + radical(CCsJOOC) + radical(CsF1sHO2s)"""),
)
...
"""),
    E0 = (-374.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,548,1085,1183,1302,1466,1520,3060,3119,562,600,623,1070,1265,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.124261,'amu*angstrom^2'), symmetry=1, barrier=(2.85701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124619,'amu*angstrom^2'), symmetry=1, barrier=(2.86523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.46669,'amu*angstrom^2'), symmetry=1, barrier=(56.7141,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28699,0.06975,-0.000123045,1.21184e-07,-4.61663e-11,-44920.2,28.5212], Tmin=(100,'K'), Tmax=(812.888,'K')), NASAPolynomial(coeffs=[4.2647,0.034102,-1.85218e-05,3.68859e-09,-2.59482e-13,-44710.6,19.0391], Tmin=(812.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsOsH) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-45.8578,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,186.314,186.314,186.315,186.316,1943.86,1943.86,1943.86,1943.87],'cm^-1')),
        HinderedRotor(inertia=(0.00485632,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471788,'amu*angstrom^2'), symmetry=1, barrier=(11.6215,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37039,0.0454458,-8.83612e-05,9.3928e-08,-3.68672e-11,-5466.05,17.6804], Tmin=(100,'K'), Tmax=(843.812,'K')), NASAPolynomial(coeffs=[1.33273,0.0271025,-1.44013e-05,2.82411e-09,-1.95947e-13,-4462.77,27.4176], Tmin=(843.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.8578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFHHO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FCOOC=C(F)F(4999)'],
    products = ['CHFO(47)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(26.9936,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'OOC=C(F)F(784)'],
    products = ['FCOOC=C(F)F(4999)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.67448e-06,'m^3/(mol*s)'), n=3.15288, Ea=(2.18754,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node OH_2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'FOOC=C(F)F(5192)'],
    products = ['FCOOC=C(F)F(4999)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(9.72733,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['FCOOC=C(F)F(4999)'],
    products = ['O=CC(F)(F)OCF(5193)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]OO[CH]C(F)F(4997)'],
    products = ['FCOOC=C(F)F(4999)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OOC=C(F)F(1854)'],
    products = ['FCOOC=C(F)F(4999)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH]OOC=C(F)F(1677)'],
    products = ['FCOOC=C(F)F(4999)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FCOO[C]=C(F)F(5195)'],
    products = ['FCOOC=C(F)F(4999)'],
