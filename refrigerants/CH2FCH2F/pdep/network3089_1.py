...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)OO(471)'],
    products = ['OH(7)', 'FC1=CO1(3064)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(5)', '[C]=C(F)OO(9626)'],
    products = ['[CH]=C(F)OO(471)'],
    transitionState = 'TS2',
