...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.747586,0.0747652,-8.96593e-05,4.77608e-08,-5.25415e-12,-36341.7,26.6119], Tmin=(100,'K'), Tmax=(700.541,'K')), NASAPolynomial(coeffs=[13.0621,0.0202441,-6.73488e-06,1.02726e-09,-6.08574e-14,-38454.6,-31.1815], Tmin=(700.541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-303.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H))"""),
)

species(
    label = '[CH2][C]1OC(C(F)F)O1(4869)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.793935,0.0606662,-4.99734e-05,1.92273e-08,-2.88536e-12,-38192.4,27.4273], Tmin=(100,'K'), Tmax=(1598.27,'K')), NASAPolynomial(coeffs=[18.9729,0.0151692,-7.27345e-06,1.41628e-09,-9.93603e-14,-44003.3,-68.8002], Tmin=(1598.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-318.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_P) + radical(CJCO)"""),
)
...
"""),
    E0 = (-303.477,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5611,0.054221,-5.02956e-05,2.39065e-08,-4.64194e-12,-36412.6,22.9819], Tmin=(100,'K'), Tmax=(1215.49,'K')), NASAPolynomial(coeffs=[11.3754,0.0219237,-1.04383e-05,2.0457e-09,-1.45645e-13,-38798.4,-26.2815], Tmin=(1215.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-303.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CJCO)"""),
)
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.976345,0.0720524,-9.14661e-05,6.39913e-08,-1.84169e-11,-57318.1,27.4382], Tmin=(100,'K'), Tmax=(838.698,'K')), NASAPolynomial(coeffs=[9.98762,0.0290763,-1.46066e-05,2.89906e-09,-2.07038e-13,-58829.7,-14.4512], Tmin=(838.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-428.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([244,1102,1254,1379,1468,1475,3037,3083,3025,407.5,1350,352.5,334,575,1197,1424,3202,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.7587,0.0788603,-0.000108995,7.80035e-08,-2.03625e-11,-51410.5,27.7489], Tmin=(100,'K'), Tmax=(629.497,'K')), NASAPolynomial(coeffs=[9.97004,0.0299358,-1.53068e-05,3.02713e-09,-2.14428e-13,-52760.5,-13.939], Tmin=(629.497,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-428.362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.741253,0.0510539,6.71857e-06,-6.03333e-08,3.02368e-11,-72810.8,20.1994], Tmin=(100,'K'), Tmax=(957.453,'K')), NASAPolynomial(coeffs=[23.8819,0.00511154,-7.87596e-07,2.35763e-10,-2.87812e-14,-79567.4,-102.578], Tmin=(957.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-606.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(CsCsFFH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23019,0.0559901,-4.97038e-05,2.48058e-08,-5.03615e-12,-37464.7,25.7453], Tmin=(100,'K'), Tmax=(1188.12,'K')), NASAPolynomial(coeffs=[11.1069,0.0227374,-7.72107e-06,1.24817e-09,-7.90834e-14,-39811.6,-23.6065], Tmin=(1188.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-312.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCsFFH) + ring(Oxetane) + radical(CCOJ) + radical(Cs_P)"""),
)
...
"""),
    E0 = (-425.613,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45988,0.0606894,-5.94698e-05,3.22268e-08,-7.45658e-12,-51102,25.6992], Tmin=(100,'K'), Tmax=(1007.7,'K')), NASAPolynomial(coeffs=[8.92328,0.0310641,-1.53717e-05,3.05291e-09,-2.18885e-13,-52606.2,-10.3647], Tmin=(1007.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C=C(O)O[CH][C](F)F(4878)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.810644,'amu*angstrom^2'), symmetry=1, barrier=(18.6383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.80993,'amu*angstrom^2'), symmetry=1, barrier=(18.6219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.809553,'amu*angstrom^2'), symmetry=1, barrier=(18.6132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.809744,'amu*angstrom^2'), symmetry=1, barrier=(18.6176,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.636275,0.100409,-0.000143039,9.48453e-08,-2.38614e-11,-42719.5,27.8435], Tmin=(100,'K'), Tmax=(989.689,'K')), NASAPolynomial(coeffs=[22.2213,0.00802544,-3.01768e-06,5.23718e-10,-3.50253e-14,-47243.8,-82.1937], Tmin=(989.689,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-356.59,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(F1s))"""),
)

species(
    label = '[CH2][C](OF)OC=CF(4879)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {6,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(F)F(506)', '[CH2]C([O])=O(296)'],
    products = ['[CH2]C(=O)O[CH]C(F)F(4688)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[CH]C(F)F(1031)'],
    products = ['[CH2]C(=O)O[CH]C(F)F(4688)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[CH]C(F)F(4688)'],
    products = ['FC(F)[CH]O[C]1CO1(4868)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.95361e+10,'s^-1'), n=0.549916, Ea=(165.323,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra_cs2H] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=O)O[CH]C(F)F(4688)'],
    products = ['[CH2][C]1OC(C(F)F)O1(4869)'],
    transitionState = 'TS7',
...
reaction(
    ...
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(6.44049e+09,'s^-1'), n=0.679905, Ea=(157.107,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_csHNd] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_csHNd]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
Ea raised from 155.3 to 157.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['[CH2]C(=O)O[CH]C(F)F(4688)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(153.031,'m^3/(mol*s)'), n=1.16366, Ea=(39.3926,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H"""),
)

reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=O)OC=CF(2460)'],
    products = ['[CH2]C(=O)O[CH]C(F)F(4688)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(48.7192,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['O=C(CF)O[CH][CH]F(4874)'],
    products = ['[CH2]C(=O)O[CH]C(F)F(4688)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(178.534,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction18',
    reactants = ['O(6)', 'C=[C]O[CH]C(F)F(847)'],
    products = ['[CH2]C(=O)O[CH]C(F)F(4688)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(=O)O[CH]C(F)F(4688)'],
    products = ['[O][C]1CC(C(F)F)O1(4875)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=C(O)O[CH][C](F)F(4878)'],
    products = ['[CH2]C(=O)O[CH]C(F)F(4688)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][C](OF)OC=CF(4879)'],
    products = ['[CH2]C(=O)O[CH]C(F)F(4688)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(41.0636,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #1887',
    isomers = [
        '[CH2]C(=O)O[CH]C(F)F(4688)',
    ],
    reactants = [
