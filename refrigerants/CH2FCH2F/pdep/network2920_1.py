...
species(
    label = 'FOC(C=C(F)F)C(F)(F)F(8943)',
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0501647,0.0941785,-0.00011911,7.55491e-08,-1.90702e-11,-131317,31.4622], Tmin=(100,'K'), Tmax=(963.376,'K')), NASAPolynomial(coeffs=[16.1957,0.0267234,-1.40786e-05,2.8652e-09,-2.08093e-13,-134447,-46.3084], Tmin=(963.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1093.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsOsH) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cds-CdsCsH) + group(CdCFF)"""),
)
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.228169,0.101134,-0.00014721,1.1166e-07,-3.39679e-11,-139165,29.7881], Tmin=(100,'K'), Tmax=(802.375,'K')), NASAPolynomial(coeffs=[13.7486,0.0314567,-1.69512e-05,3.43183e-09,-2.46649e-13,-141408,-34.5644], Tmin=(802.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1158.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(CsCdFFF) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'FOC(F)(F)[C](F)C[C](F)F(8946)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.201399,'amu*angstrom^2'), symmetry=1, barrier=(4.63057,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200503,'amu*angstrom^2'), symmetry=1, barrier=(4.60997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203196,'amu*angstrom^2'), symmetry=1, barrier=(4.67187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22207,'amu*angstrom^2'), symmetry=1, barrier=(28.0977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.990292,0.1242,-0.000226799,2.07856e-07,-7.29518e-11,-101074,36.226], Tmin=(100,'K'), Tmax=(834.848,'K')), NASAPolynomial(coeffs=[11.7302,0.0362027,-2.0088e-05,3.97601e-09,-2.76605e-13,-102256,-17.201], Tmin=(834.848,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-841.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFFH) + radical(CsCsCsF1s) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.47876,'amu*angstrom^2'), symmetry=1, barrier=(33.9997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47698,'amu*angstrom^2'), symmetry=1, barrier=(33.9586,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47585,'amu*angstrom^2'), symmetry=1, barrier=(33.9326,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0228282,0.0928277,-0.000121229,7.91096e-08,-2.04983e-11,-93452.6,26.6852], Tmin=(100,'K'), Tmax=(940.353,'K')), NASAPolynomial(coeffs=[15.895,0.0253127,-1.35345e-05,2.75992e-09,-2.00399e-13,-96437.7,-48.913], Tmin=(940.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-778.163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCFF) + radical(C=CCJCO)"""),
)

species(
    label = 'FO[C](F)C(F)C=C(F)F(8948)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-651.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,174,267,591,721,1107,1278,1348,3273,3010,987.5,1337.5,450,1655,395,473,707,1436,182,240,577,636,1210,1413,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.30319,'amu*angstrom^2'), symmetry=1, barrier=(6.97093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47829,'amu*angstrom^2'), symmetry=1, barrier=(33.9888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303136,'amu*angstrom^2'), symmetry=1, barrier=(6.96969,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.164936,0.101285,-0.00017174,1.52518e-07,-5.32665e-11,-78189.8,30.7866], Tmin=(100,'K'), Tmax=(796.936,'K')), NASAPolynomial(coeffs=[11.1061,0.03202,-1.74777e-05,3.486e-09,-2.45527e-13,-79583.2,-18.5023], Tmin=(796.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-651.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(CdCFF) + radical(CsCsF1sO2s)"""),
)

species(
    label = 'F[C]=CC(F)C(F)(F)OF(8949)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-624.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,284,328,853,1146,1135,1297,3239,223,363,546,575,694,1179,1410,3010,987.5,1337.5,450,1655,167,640,1190,233.222,233.223,233.223],'cm^-1')),
        HinderedRotor(inertia=(0.235004,'amu*angstrom^2'), symmetry=1, barrier=(9.07079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235005,'amu*angstrom^2'), symmetry=1, barrier=(9.07079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.782948,'amu*angstrom^2'), symmetry=1, barrier=(30.2206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.135937,0.0989114,-0.00015535,1.26636e-07,-4.11432e-11,-74928.8,29.6801], Tmin=(100,'K'), Tmax=(754.584,'K')), NASAPolynomial(coeffs=[13.1266,0.0286019,-1.55748e-05,3.13687e-09,-2.23626e-13,-76930.2,-30.5685], Tmin=(754.584,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-624.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[O]C(F)(F)C(F)C=C(F)F(8950)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-949.859,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,351,323,533,609,664,892,1120,1201,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.235448,'amu*angstrom^2'), symmetry=1, barrier=(5.41341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236004,'amu*angstrom^2'), symmetry=1, barrier=(5.42619,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.348417,0.0874549,-0.000126091,9.67934e-08,-3.0004e-11,-114117,28.8831], Tmin=(100,'K'), Tmax=(786.086,'K')), NASAPolynomial(coeffs=[11.7228,0.0295814,-1.56671e-05,3.15261e-09,-2.25846e-13,-115905,-23.2549], Tmin=(786.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-949.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(CdCFF) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
species(
    label = 'FOC(F)(F)C(F)=C[C](F)F(8951)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-942.736,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,323,467,575,827,1418,3010,987.5,1337.5,450,1655,161,297,490,584,780,1358,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.252822,'amu*angstrom^2'), symmetry=1, barrier=(5.81287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255278,'amu*angstrom^2'), symmetry=1, barrier=(5.86934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92694,'amu*angstrom^2'), symmetry=1, barrier=(44.3041,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (179.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.63104,0.110735,-0.000184747,1.57125e-07,-5.26582e-11,-113227,31.8849], Tmin=(100,'K'), Tmax=(776.652,'K')), NASAPolynomial(coeffs=[14.265,0.0286309,-1.57747e-05,3.15584e-09,-2.22768e-13,-115378,-35.1695], Tmin=(776.652,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-942.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CsCFFH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(Csj(Cd-CdH)(F1s)(F1s))"""),
)

species(
    label = 'FOC(F)(F)C(F)[C]=C(F)F(8952)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-812.243,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,164,312,561,654,898,1207,1299,3167,223,363,546,575,694,1179,1410,562,600,623,1070,1265,1685,370,180,180,1151.59],'cm^-1')),
        HinderedRotor(inertia=(0.28967,'amu*angstrom^2'), symmetry=1, barrier=(6.66008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287313,'amu*angstrom^2'), symmetry=1, barrier=(6.6059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65663,'amu*angstrom^2'), symmetry=1, barrier=(38.0892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (179.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.13008,0.0999606,-0.000157027,1.30647e-07,-4.38636e-11,-97550.1,32.6384], Tmin=(100,'K'), Tmax=(727.335,'K')), NASAPolynomial(coeffs=[12.0706,0.0328661,-1.86633e-05,3.83089e-09,-2.76409e-13,-99325,-22.339], Tmin=(727.335,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-812.243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(CdCFF) + radical(Cdj(Cs-F1sCsH)(Cd-F1sF1s))"""),
)

species(
    label = 'FOC(F)(F)C(F)[C]C(F)F(8953)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-774.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,353,444,1253,3145,223,363,546,575,694,1179,1410,257,409,1143,1361,2944,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.914048,0.119063,-0.00020066,1.77016e-07,-6.17378e-11,-92977.9,43.371], Tmin=(100,'K'), Tmax=(782.46,'K')), NASAPolynomial(coeffs=[12.813,0.0369962,-2.05376e-05,4.12449e-09,-2.91896e-13,-94762.1,-17.1603], Tmin=(782.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-774.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'F[C]C(F)C(F)C(F)(F)OF(8954)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-829.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,250,417,511,1155,1315,1456,3119,223,363,546,575,694,1179,1410,353,444,1253,3145,617,898,1187,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.581808,0.109407,-0.000165642,1.28104e-07,-3.93983e-11,-99560.9,32.6543], Tmin=(100,'K'), Tmax=(796.351,'K')), NASAPolynomial(coeffs=[15.1622,0.0303222,-1.66706e-05,3.38507e-09,-2.43135e-13,-102068,-39.7156], Tmin=(796.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-829.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.781849,'amu*angstrom^2'), symmetry=1, barrier=(17.9762,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-535.093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2995,3025,975,1000,1300,1375,400,500,1630,1680,326,540,652,719,1357,182,240,577,636,1210,1413,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.177995,'amu*angstrom^2'), symmetry=1, barrier=(4.09246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22216,'amu*angstrom^2'), symmetry=1, barrier=(28.1,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.765241,0.0761331,-0.000102609,7.23808e-08,-2.04768e-11,-64244.7,25.2177], Tmin=(100,'K'), Tmax=(861.399,'K')), NASAPolynomial(coeffs=[11.9445,0.024221,-1.22117e-05,2.41971e-09,-1.72433e-13,-66170.7,-27.0481], Tmin=(861.399,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-535.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFO) + group(CdCFF)"""),
)

species(
    label = 'FOC(F)=C(F)C=C(F)F(8956)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-705.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,280,518,736,852,873,3010,987.5,1337.5,450,1655,326,540,652,719,1357,182,240,577,636,1210,1413,180,2184.7],'cm^-1')),
        HinderedRotor(inertia=(1.74206,'amu*angstrom^2'), symmetry=1, barrier=(40.0535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.50138,'amu*angstrom^2'), symmetry=1, barrier=(11.5277,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.131794,0.0932875,-0.000154364,1.34475e-07,-4.65426e-11,-84692.2,27.9613], Tmin=(100,'K'), Tmax=(771.878,'K')), NASAPolynomial(coeffs=[11.1798,0.0290482,-1.59496e-05,3.20079e-09,-2.26788e-13,-86189.6,-21.13], Tmin=(771.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-705.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CdCCF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-Cds(Cds-Cds)H) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFF)"""),
)

species(
    label = 'FOC(F)(F)C=C=C(F)F(8957)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-707.706,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,3010,987.5,1337.5,450,1655,94,120,354,641,825,1294,540,610,2055,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.142406,'amu*angstrom^2'), symmetry=1, barrier=(3.27419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.921684,'amu*angstrom^2'), symmetry=1, barrier=(21.1913,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.125472,0.0924835,-0.000144601,1.1605e-07,-3.69935e-11,-84984.6,27.8477], Tmin=(100,'K'), Tmax=(769.509,'K')), NASAPolynomial(coeffs=[13.0262,0.0254233,-1.38802e-05,2.79837e-09,-1.99659e-13,-86970,-31.0107], Tmin=(769.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-707.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdCddFF) + group(Cdd-CdsCds)"""),
)

species(
    label = 'FC#CC(F)C(F)(F)OF(8958)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-616.312,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,233,378,609,1068,1270,1314,3037,223,363,546,575,694,1179,1410,2175,525,239,401,1367,180,180,2498.22],'cm^-1')),
        HinderedRotor(inertia=(0.588207,'amu*angstrom^2'), symmetry=1, barrier=(13.524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58673,'amu*angstrom^2'), symmetry=1, barrier=(36.4819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58468,'amu*angstrom^2'), symmetry=1, barrier=(36.4349,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0985207,0.0985091,-0.000166689,1.43705e-07,-4.84394e-11,-73985.7,28.1297], Tmin=(100,'K'), Tmax=(808.027,'K')), NASAPolynomial(coeffs=[12.5508,0.0260928,-1.40689e-05,2.77823e-09,-1.94146e-13,-75710,-28.2203], Tmin=(808.027,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-616.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Ct-CtCs) + group(CtCF)"""),
)

species(
    label = '[CH]C(F)C(F)(F)OF(8959)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
4  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-334.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,353,444,1253,3145,223,363,546,575,694,1179,1410,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.615694,0.0814032,-0.000133423,1.14173e-07,-3.90163e-11,-40087.4,23.7201], Tmin=(100,'K'), Tmax=(733.757,'K')), NASAPolynomial(coeffs=[10.8733,0.0241288,-1.35658e-05,2.75652e-09,-1.97041e-13,-41556.3,-22.3426], Tmin=(733.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(61.5168,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F[C]C(F)(F)OF(2632)', 'CH2CF2(57)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.28954e+29,'m^3/(mol*s)'), n=-6.4458, Ea=(94.8338,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.6591608693425184, var=5.4995193120720405, Tref=1000.0, N=19, data_mean=0.0, correlation='CH',), comment="""Estimated from node CH
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['FOC(F)F(2153)', 'F[C]C=C(F)F-2(5944)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.33872e-07,'m^3/(mol*s)'), n=3.38172, Ea=(56.7046,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_N-3Br1sCCl1sF1sHI1s->F1s_N-3Br1sCCl1sH->Cl1s_2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    ...
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(181.51,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CF2(43)', 'FOC(F)C=C(F)F(6062)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(213.221,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction6',
    reactants = ['FOF(1520)', 'F[C]C(F)C=C(F)F(8942)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
    products = ['FOC(C=C(F)F)C(F)(F)F(8943)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(140)', 'FC(F)=CC(F)=C(F)F(8944)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(1520)', 'FC(F)=CC=C(F)F(1575)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
    products = ['FOC(F)(F)C=CC(F)(F)F(8945)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(3.72966e+11,'s^-1'), n=0.63878, Ea=(268.682,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='F_Ext-2R!H-R',), comment="""Estimated from node F_Ext-2R!H-R"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['FOC(F)(F)[C](F)C[C](F)F(8946)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'FOC(F)(F)[CH]C=C(F)F(8947)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'FO[C](F)C(F)C=C(F)F(8948)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'F[C]=CC(F)C(F)(F)OF(8949)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[O]C(F)(F)C(F)C=C(F)F(8950)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(127)', 'F[C](F)C(F)C=C(F)F(6167)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(1.62507,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['CF2CH(73)', 'F[CH]C(F)(F)OF(2640)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'FOC(F)(F)C(F)=C[C](F)F(8951)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(7.52066,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C"""),
)

reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'FOC(F)(F)C(F)[C]=C(F)F(8952)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FOC(F)(F)C(F)[C]C(F)F(8953)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C]C(F)C(F)C(F)(F)OF(8954)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(78)', 'O=C(F)C(F)C=C(F)F(7957)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F2(78)', 'FOC(F)=CC=C(F)F(8955)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'FOC(F)=C(F)C=C(F)F(8956)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'FOC(F)(F)C=C=C(F)F(8957)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(223.102,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'FC#CC(F)C(F)(F)OF(8958)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CF2(43)', '[CH]C(F)C(F)(F)OF(8959)'],
    products = ['FOC(F)(F)C(F)C=C(F)F(8842)'],
