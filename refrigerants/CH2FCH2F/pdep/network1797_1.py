...
reaction(
    label = 'reaction3',
    reactants = ['O[C]1OC[C](F)O1(4510)'],
    products = ['C=C(F)OC(=O)O(4080)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=[C]OC(=O)O(4516)'],
    products = ['C=C(F)OC(=O)O(4080)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(520)', 'CH2CF(70)'],
    products = ['C=C(F)OC(=O)O(4080)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=C(F)O[C]=O(282)'],
    products = ['C=C(F)OC(=O)O(4080)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(F)OC([O])=O(583)'],
    products = ['C=C(F)OC(=O)O(4080)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)OC(=O)O(4517)'],
    products = ['C=C(F)OC(=O)O(4080)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(25)', 'O=C(O)[O+]=[C-]F(4520)'],
    products = ['C=C(F)OC(=O)O(4080)'],
