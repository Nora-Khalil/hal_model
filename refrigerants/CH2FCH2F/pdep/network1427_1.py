...
reaction(
    label = 'reaction1',
    reactants = ['[O]OO[C]=O(162)'],
    products = ['O=O(141)', 'CO2(14)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](128)', '[C]=O(129)'],
    products = ['[O]OO[C]=O(162)'],
    transitionState = 'TS2',
