...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)[CH]F(975)', '[CH]C-2(510)'],
    products = ['C[CH]OC(F)[CH]F(4056)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'C[CH]O[CH]F(3340)'],
    products = ['C[CH]OC(F)[CH]F(4056)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[CH]OC=CF(3604)'],
    products = ['C[CH]OC(F)[CH]F(4056)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C[CH]OC(F)=CF(4162)'],
    products = ['C[CH]OC(F)[CH]F(4056)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=COC(F)[CH]F(4163)'],
    products = ['C[CH]OC(F)[CH]F(4056)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'C[CH]O[CH]F(3340)'],
    products = ['C[CH]OC(F)[CH]F(4056)'],
