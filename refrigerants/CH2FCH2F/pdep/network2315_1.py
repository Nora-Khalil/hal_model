...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.44686,0.0870971,-0.000153259,1.38697e-07,-4.89772e-11,-85414.5,25.6016], Tmin=(100,'K'), Tmax=(797.436,'K')), NASAPolynomial(coeffs=[10.1235,0.0259629,-1.45711e-05,2.94523e-09,-2.08754e-13,-86557.3,-16.3813], Tmin=(797.436,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-711.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[O][C](F)C(F)(F)CF(2223)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.948028,'amu*angstrom^2'), symmetry=1, barrier=(21.797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79895,'amu*angstrom^2'), symmetry=1, barrier=(41.3614,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.92836,0.0741273,-0.000109606,8.60436e-08,-2.72598e-11,-82141.8,23.6598], Tmin=(100,'K'), Tmax=(769.5,'K')), NASAPolynomial(coeffs=[10.4163,0.0248071,-1.34644e-05,2.74986e-09,-1.98675e-13,-83602,-19.6279], Tmin=(769.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-683.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = 'F[CH][C](F)C(F)OF(6209)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-360.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,212,367,445,1450,334,575,1197,1424,3202,180,180,271.959],'cm^-1')),
        HinderedRotor(inertia=(0.101934,'amu*angstrom^2'), symmetry=1, barrier=(2.34366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.577206,'amu*angstrom^2'), symmetry=1, barrier=(13.2711,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.23206,'amu*angstrom^2'), symmetry=1, barrier=(51.3194,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.495493,0.0901777,-0.000172526,1.6631e-07,-6.06323e-11,-43272.3,25.8389], Tmin=(100,'K'), Tmax=(836.354,'K')), NASAPolynomial(coeffs=[7.1153,0.0311034,-1.74091e-05,3.4729e-09,-2.42679e-13,-43420.8,0.817111], Tmin=(836.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-F1sHH)(F1s)) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.449185,'amu*angstrom^2'), symmetry=1, barrier=(10.3276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.623151,'amu*angstrom^2'), symmetry=1, barrier=(14.3275,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
...
"""),
    E0 = (-377.957,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,334,575,1197,1424,3202,243.462,243.908,244.203],'cm^-1')),
        HinderedRotor(inertia=(0.273402,'amu*angstrom^2'), symmetry=1, barrier=(11.5434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386605,'amu*angstrom^2'), symmetry=1, barrier=(16.3103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.559273,'amu*angstrom^2'), symmetry=1, barrier=(23.6243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.235425,0.0921611,-0.000149593,1.10946e-07,-2.78799e-11,-45331.1,25.5208], Tmin=(100,'K'), Tmax=(624.83,'K')), NASAPolynomial(coeffs=[14.0998,0.0188297,-1.05794e-05,2.13364e-09,-1.50828e-13,-47364.7,-37.2562], Tmin=(624.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-377.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = '[O][CH]C(F)(F)C(F)F(5267)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (130.041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.928025,0.07639,-0.000130946,1.22824e-07,-4.537e-11,-83500.3,24.4876], Tmin=(100,'K'), Tmax=(789.487,'K')), NASAPolynomial(coeffs=[7.09891,0.0307342,-1.68594e-05,3.39845e-09,-2.41354e-13,-84026.2,-0.984482], Tmin=(789.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-695.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCOJ) + radical(Csj(Cs-F1sF1sCs)(O2s-H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C(F)(F)[CH]F(6118)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[O]C(F)[C](F)F(1163)'],
    products = ['[O]C(F)C(F)(F)[CH]F(6118)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C(F)(F)[CH]F(6143)'],
    products = ['[O]C(F)C(F)(F)[CH]F(6118)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)C(F)=CF(1139)'],
    products = ['[O]C(F)C(F)(F)[CH]F(6118)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=CC(F)(F)[CH]F(5622)'],
    products = ['[O]C(F)C(F)(F)[CH]F(6118)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=C(F)C(F)(F)[CH]F(6207)'],
    products = ['[O]C(F)C(F)(F)[CH]F(6118)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[O]C=C(F)[CH]F(1141)'],
    products = ['[O]C(F)C(F)(F)[CH]F(6118)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[O]C(F)[C](F)F(1163)'],
    products = ['[O]C(F)C(F)(F)[CH]F(6118)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)C(F)(F)[CH]F(6118)'],
    products = ['O[C](F)C(F)(F)[CH]F(6208)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[CH][C](F)C(F)OF(6209)'],
    products = ['[O]C(F)C(F)(F)[CH]F(6118)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(F)[C](F)C(F)F(6201)'],
    products = ['[O]C(F)C(F)(F)[CH]F(6118)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)[CH]OF(6210)'],
    products = ['[O]C(F)C(F)(F)[CH]F(6118)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)C(F)(F)[CH]F(6118)'],
    products = ['[O][CH]C(F)(F)C(F)F(5267)'],
...
network(
    label = 'PDepNetwork #2315',
    isomers = [
        '[O]C(F)C(F)(F)[CH]F(6118)',
    ],
    reactants = [
        ('CHFO(47)', 'CHFCF2(55)'),
    ],
