...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)(F)[C](F)F(12610)'],
    products = ['O=O(141)', 'CF2CF2(61)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[C](F)F(2219)'],
    products = ['[O]OC(F)(F)[C](F)F(12610)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', '[O]O[C](F)F(788)'],
    products = ['[O]OC(F)(F)[C](F)F(12610)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)[C](F)F(12610)'],
    products = ['O(6)', 'FC1(F)OC1(F)F(2180)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]OC(F)=C(F)F(6508)'],
    products = ['[O]OC(F)(F)[C](F)F(12610)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', 'F[C](F)[C](F)F(3840)'],
    products = ['[O]OC(F)(F)[C](F)F(12610)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2(43)', '[O]O[C](F)F(788)'],
    products = ['[O]OC(F)(F)[C](F)F(12610)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]OC(F)(F)[C](F)F(12610)'],
    products = ['[O]O[C](F)C(F)(F)F(12804)'],
...
network(
    label = 'PDepNetwork #4171',
    isomers = [
        '[O]OC(F)(F)[C](F)F(12610)',
    ],
    reactants = [
        ('O2(2)', 'CF2CF2(61)'),
        ('O=O(141)', 'CF2CF2(61)'),
