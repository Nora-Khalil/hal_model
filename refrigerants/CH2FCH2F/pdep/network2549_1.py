...
"""),
    E0 = (-834.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,222,329,445,522,589,1214,1475,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,269.977,269.978,269.979],'cm^-1')),
        HinderedRotor(inertia=(0.19811,'amu*angstrom^2'), symmetry=1, barrier=(10.2468,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198108,'amu*angstrom^2'), symmetry=1, barrier=(10.2468,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19811,'amu*angstrom^2'), symmetry=1, barrier=(10.2468,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(F)(F)C(OF)[C](F)F(2861)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-856.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,522,611,926,1093,1137,1374,1416,3112,360,370,350,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.439661,'amu*angstrom^2'), symmetry=1, barrier=(10.1087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.440407,'amu*angstrom^2'), symmetry=1, barrier=(10.1258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439847,'amu*angstrom^2'), symmetry=1, barrier=(10.1129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.43964,'amu*angstrom^2'), symmetry=1, barrier=(10.1082,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (163.066,'amu'),
...
species(
    label = '[CH2]C(F)(F)C(OF)C(F)F(5328)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    ...
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)[C](F)F(3105)', 'C[C]F(137)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CC(F)(OF)C(F)[C](F)F(6766)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CC(F)(F)C(OF)[C](F)F(5327)'],
    products = ['CC(F)(F)C(F)(F)[CH]OF(6767)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'CC(F)(F)C([C]F)OF-2(6768)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[C]F(744)', 'CC(F)(F)[CH]OF(3103)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(127)', 'CC(F)(F)C=C(F)F(797)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['FOC=C(F)F(1650)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(F)(F)C(OF)=C(F)F(6769)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C[C](F)C(OF)[C](F)F(6770)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'CC(F)(F)C([O])[C](F)F(1759)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'CC(F)(F)[CH][C](F)F(801)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[CH][C](F)F(1648)', 'CH3-CF2(65)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC(F)(F)[C](OF)[C](F)F(6771)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(19)', 'FOC([C](F)F)[C](F)F(6772)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(F)(F)C(OF)[C](F)F(2861)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'CC(F)(F)C(=O)[C](F)F(6773)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C[C](F)C(OF)=C(F)F(6774)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'C=C(F)C(OF)[C](F)F(6775)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F(37)', 'CC(F)(F)C([C]F)OF(5319)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CF2(43)', 'CC(F)(F)[CH]OF(3103)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC(F)(F)C(OF)[C](F)F(5327)'],
    products = ['CC(F)(F)[C](OF)C(F)F(5325)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(F)(F)C(OF)C(F)F(5328)'],
    products = ['CC(F)(F)C(OF)[C](F)F(5327)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CC(F)(F)C(OF)[C](F)F(5327)'],
    products = ['CC(F)(F)C([O])C(F)(F)F(6776)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CC(F)(F)C(OF)[C](F)F(5327)'],
    products = ['C[C](F)C(OF)C(F)(F)F(6777)'],
