...
"""),
    E0 = (-827.784,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,253,522,585,610,849,1160,1215,1402,3025,407.5,1350,352.5,190,488,555,1236,1407,180,180,1704.76],'cm^-1')),
        HinderedRotor(inertia=(0.163028,'amu*angstrom^2'), symmetry=1, barrier=(3.74833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16303,'amu*angstrom^2'), symmetry=1, barrier=(3.74838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162967,'amu*angstrom^2'), symmetry=1, barrier=(3.74692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.058,'amu'),
...
reaction(
    label = 'reaction5',
    reactants = ['F[C]F(744)', '[CH2]C(F)[C](F)F(772)'],
    products = ['F[C](F)CC(F)[C](F)F(6115)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[C](F)CC=C(F)F(792)'],
    products = ['F[C](F)CC(F)[C](F)F(6115)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)CC(F)=C(F)F(6166)'],
    products = ['F[C](F)CC(F)[C](F)F(6115)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'F[C](F)C(F)C=C(F)F(6167)'],
    products = ['F[C](F)CC(F)[C](F)F(6115)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[C](F)C=C[C](F)F(6168)'],
    products = ['F[C](F)CC(F)[C](F)F(6115)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', '[CH2]C(F)[C](F)F(772)'],
    products = ['F[C](F)CC(F)[C](F)F(6115)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C](F)C(F)[CH]C(F)F(6162)'],
    products = ['F[C](F)CC(F)[C](F)F(6115)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)[CH]C(F)C(F)F(6160)'],
    products = ['F[C](F)CC(F)[C](F)F(6115)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)CC(F)[C](F)F(6115)'],
    products = ['F[C](F)C[CH]C(F)(F)F(2834)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F[C](F)CC(F)[C](F)F(6115)'],
    products = ['F[C](F)[CH]CC(F)(F)F(6171)'],
