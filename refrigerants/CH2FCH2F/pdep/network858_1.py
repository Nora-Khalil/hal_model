...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C1O[C]1F(12466)'],
    products = ['O=C1OC1(F)F(1845)'],
    transitionState = 'TS8',
