...
"""),
    E0 = (-337.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([253,525,597,667,842,1178,1324,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,282.265,282.266,282.266],'cm^-1')),
        HinderedRotor(inertia=(0.00211584,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172576,'amu*angstrom^2'), symmetry=1, barrier=(9.75728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172577,'amu*angstrom^2'), symmetry=1, barrier=(9.75728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.398645,'amu*angstrom^2'), symmetry=1, barrier=(22.5388,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.725102,0.0756715,-9.22295e-05,6.00193e-08,-1.57656e-11,-40446.7,24.0194], Tmin=(100,'K'), Tmax=(923.69,'K')), NASAPolynomial(coeffs=[12.0783,0.0265066,-1.23885e-05,2.3939e-09,-1.68854e-13,-42544,-29.8516], Tmin=(923.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-337.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.607605,0.0596236,-2.31465e-05,-2.50967e-08,1.70974e-11,-77550.8,21.2373], Tmin=(100,'K'), Tmax=(954.805,'K')), NASAPolynomial(coeffs=[21.0535,0.0103009,-2.73796e-06,5.06432e-10,-4.11945e-14,-83111.3,-85.129], Tmin=(954.805,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-645.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.05811,'amu*angstrom^2'), symmetry=1, barrier=(24.3279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05835,'amu*angstrom^2'), symmetry=1, barrier=(24.3336,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.589717,0.0620056,-3.77154e-05,-9.09152e-09,1.14957e-11,-51562.9,22.7444], Tmin=(100,'K'), Tmax=(952.898,'K')), NASAPolynomial(coeffs=[20.9319,0.00793387,-1.89961e-06,3.4301e-10,-2.86979e-14,-56861.6,-81.8746], Tmin=(952.898,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-429.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sF1sO2s)(H)(H))"""),
)

species(
    label = '[CH2]COC([CH2])(F)F(3477)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.575243,0.0786755,-9.81671e-05,6.42521e-08,-1.68225e-11,-40981.8,23.7473], Tmin=(100,'K'), Tmax=(930.2,'K')), NASAPolynomial(coeffs=[13.0524,0.0250226,-1.16501e-05,2.24699e-09,-1.58328e-13,-43303.1,-35.5453], Tmin=(930.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-341.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = '[CH2][C](F)OC(C)F(3479)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-317.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,3000,3100,440,815,1455,1000,245.455,245.456,2101.02],'cm^-1')),
        HinderedRotor(inertia=(0.240901,'amu*angstrom^2'), symmetry=1, barrier=(10.2993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240897,'amu*angstrom^2'), symmetry=1, barrier=(10.2993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.66877,'amu*angstrom^2'), symmetry=1, barrier=(28.5924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.668776,'amu*angstrom^2'), symmetry=1, barrier=(28.5924,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]C(3272)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])(F)F(475)', '[CH]C-2(510)'],
    products = ['[CH2]C(F)(F)O[CH]C(3272)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[C](F)F(3427)'],
    products = ['[CH2]C(F)(F)O[CH]C(3272)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[CH]C(3475)'],
    products = ['[CH2]C(F)(F)O[CH]C(3272)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)OC=C(3476)'],
    products = ['[CH2]C(F)(F)O[CH]C(3272)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]COC([CH2])(F)F(3477)'],
    products = ['[CH2]C(F)(F)O[CH]C(3272)'],
