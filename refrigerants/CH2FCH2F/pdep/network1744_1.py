...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00201,0.0388981,-3.81596e-05,1.50383e-08,-1.33868e-12,-40853.1,21.091], Tmin=(100,'K'), Tmax=(1002.5,'K')), NASAPolynomial(coeffs=[12.8071,0.00524264,-1.95241e-06,3.70282e-10,-2.74227e-14,-43494.7,-33.4342], Tmin=(1002.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-340.307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsFFHO) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10674,0.0610019,-7.18268e-05,4.00034e-08,-8.60036e-12,-19292.2,24.4636], Tmin=(100,'K'), Tmax=(1143.88,'K')), NASAPolynomial(coeffs=[15.7101,0.00993657,-4.86445e-06,9.77482e-10,-7.1206e-14,-22633.1,-47.9525], Tmin=(1143.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['OOO[C](F)F(2302)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)(F)OOO(4031)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[CH]C(F)(F)OOO(4575)'],
    products = ['[CH2]C(F)(F)OOO(4031)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2][C](F)OOO(965)'],
    products = ['[CH2]C(F)(F)OOO(4031)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HO2(11)', '[CH2]C([O])(F)F(475)'],
    products = ['[CH2]C(F)(F)OOO(4031)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', '[CH2]C(F)(F)O[O](700)'],
    products = ['[CH2]C(F)(F)OOO(4031)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)OO[O](3087)'],
    products = ['[CH2]C(F)(F)OOO(4031)'],
    transitionState = 'TS9',
