...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(223)', '[CH]=C[O](134)'],
    products = ['[CH]=CO[CH]F(3085)'],
    transitionState = 'TS2',
