...
"""),
    E0 = (-679.265,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([234,347,1316,1464,190,488,555,1236,1407,611,648,830,1210,1753,212.411,215.371],'cm^-1')),
        HinderedRotor(inertia=(0.312414,'amu*angstrom^2'), symmetry=1, barrier=(10.0173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45608,'amu*angstrom^2'), symmetry=1, barrier=(46.6908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28612,0.0654741,-0.000109961,9.59799e-08,-3.31741e-11,-81604.5,24.1634], Tmin=(100,'K'), Tmax=(762.366,'K')), NASAPolynomial(coeffs=[9.40923,0.0188767,-1.0453e-05,2.1204e-09,-1.51251e-13,-82727.5,-12.064], Tmin=(762.366,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-679.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCOCsF1s) + radical(Csj(Cs-F1sCOH)(F1s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.245909,0.114737,-0.000246064,2.41829e-07,-8.65475e-11,-109483,28.5425], Tmin=(100,'K'), Tmax=(879.7,'K')), NASAPolynomial(coeffs=[6.97345,0.0313555,-1.76832e-05,3.42716e-09,-2.3112e-13,-108797,5.75705], Tmin=(879.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-911.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H)) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = '[O][C](F)C(F)(F)C(F)F(6461)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0976568,0.104471,-0.000217363,2.12556e-07,-7.61239e-11,-106618,27.6406], Tmin=(100,'K'), Tmax=(876.953,'K')), NASAPolynomial(coeffs=[6.55865,0.0311787,-1.70436e-05,3.28889e-09,-2.22215e-13,-106067,6.92577], Tmin=(876.953,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-887.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sF1sCs)(F1s)(O2s-H))"""),
)

species(
    label = 'FOC(F)[C](F)[C](F)F(12693)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-554.238,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,212,367,445,1450,190,488,555,1236,1407,180,180,1429.5],'cm^-1')),
        HinderedRotor(inertia=(0.343374,'amu*angstrom^2'), symmetry=1, barrier=(7.89484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.344383,'amu*angstrom^2'), symmetry=1, barrier=(7.91804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.20138,'amu*angstrom^2'), symmetry=1, barrier=(50.614,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.374383,0.0941782,-0.000183707,1.79039e-07,-6.56813e-11,-66542.9,29.0934], Tmin=(100,'K'), Tmax=(838.037,'K')), NASAPolynomial(coeffs=[6.75465,0.0328341,-1.86158e-05,3.72305e-09,-2.60256e-13,-66527.5,5.91159], Tmin=(838.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-554.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-F1sF1sH)(F1s)) + radical(Csj(Cs-CsF1sH)(F1s)(F1s))"""),
)

species(
    label = '[O]C(F)[C](F)C(F)(F)F(12694)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.282174,0.0911879,-0.000162421,1.46335e-07,-5.1042e-11,-108731,26.3982], Tmin=(100,'K'), Tmax=(813.653,'K')), NASAPolynomial(coeffs=[10.7357,0.0252575,-1.40707e-05,2.82167e-09,-1.98567e-13,-109951,-18.9208], Tmin=(813.653,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-905.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-F1sO2sH)(Cs-F1sF1sF1s)(F1s))"""),
)

species(
    label = 'FO[CH]C(F)(F)[C](F)F(12695)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.977715,'amu*angstrom^2'), symmetry=1, barrier=(22.4796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.978298,'amu*angstrom^2'), symmetry=1, barrier=(22.493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.977334,'amu*angstrom^2'), symmetry=1, barrier=(22.4708,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.32932,0.102221,-0.000169483,1.34165e-07,-4.10933e-11,-69929.5,27.734], Tmin=(100,'K'), Tmax=(807.255,'K')), NASAPolynomial(coeffs=[17.0601,0.0160518,-9.36168e-06,1.92484e-09,-1.38086e-13,-72736.9,-52.436], Tmin=(807.255,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-582.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCsJO) + radical(Csj(Cs-CsF1sF1s)(F1s)(F1s))"""),
)

species(
    label = '[O][CH]C(F)(F)C(F)(F)F(12696)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[O]C(F)[C](F)F(1163)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]C(F)(F)[C](F)F(6191)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    products = ['FC1OC(F)(F)C1(F)F(6325)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    products = ['O=C(F)C(F)(F)C(F)F(9125)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)C(F)=C(F)F(6199)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][CH]F(1073)', 'CF2CF2(61)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=CC(F)(F)[C](F)F(1812)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHFO(47)', 'F[C](F)[C](F)F(3840)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=C(F)C(F)(F)[C](F)F(12653)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][CH]F(1073)', 'F[C](F)[C](F)F(3840)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', '[O]C=C(F)[C](F)F(3839)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=C(F)[C](F)[C](F)F(6450)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[O]C(F)[C](F)F(1163)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    products = ['O[C](F)C(F)(F)[C](F)F(12692)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    products = ['[O][C](F)C(F)(F)C(F)F(6461)'],
...
reaction(
    label = 'reaction17',
    reactants = ['FOC(F)[C](F)[C](F)F(12693)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    products = ['[O]C(F)[C](F)C(F)(F)F(12694)'],
...
reaction(
    label = 'reaction19',
    reactants = ['FO[CH]C(F)(F)[C](F)F(12695)'],
    products = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(F)C(F)(F)[C](F)F(7380)'],
    products = ['[O][CH]C(F)(F)C(F)(F)F(12696)'],
...
network(
    label = 'PDepNetwork #4186',
    isomers = [
        '[O]C(F)C(F)(F)[C](F)F(7380)',
    ],
    reactants = [
        ('CHFO(47)', 'CF2CF2(61)'),
    ],
