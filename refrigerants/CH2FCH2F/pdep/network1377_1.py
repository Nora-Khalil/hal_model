...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C[O](1330)'],
    products = ['[CH2]OC[O](3073)'],
    transitionState = 'TS2',
