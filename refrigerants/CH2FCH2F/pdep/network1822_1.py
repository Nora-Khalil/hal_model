...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C([C]F)CO(6613)'],
    products = ['O=C(CO)CF(4105)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', '[CH2]C(=O)CF(1359)'],
    products = ['O=C(CO)CF(4105)'],
