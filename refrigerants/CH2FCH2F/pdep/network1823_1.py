...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]C(=O)OC(4200)'],
    products = ['C=C(OC)OF(4106)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]OC(=C)OF(4146)'],
    products = ['C=C(OC)OF(4106)'],
