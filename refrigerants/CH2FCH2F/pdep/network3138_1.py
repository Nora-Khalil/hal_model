...
reaction(
    label = 'reaction1',
    reactants = ['F[C]=CC1(F)[CH]O1(9345)'],
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]=CC1=CO1(9609)'],
    products = ['F[C]=CC1(F)[CH]O1(9345)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC#CC1(F)[CH]O1(9610)'],
    products = ['F[C]=CC1(F)[CH]O1(9345)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'F[C]=C=C1[CH]O1(9611)'],
    products = ['F[C]=CC1(F)[CH]O1(9345)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]=CC1(F)[CH]O1(9345)'],
    products = ['F[C](F)C=C1[CH]O1(9275)'],
