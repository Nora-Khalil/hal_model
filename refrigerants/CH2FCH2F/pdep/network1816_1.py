...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)O[CH]O(4589)'],
    products = ['C=C(F)OCO(4099)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(F)O[CH]O(4525)'],
    products = ['C=C(F)OCO(4099)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(25)', 'OC[O+]=[C-]F(4597)'],
    products = ['C=C(F)OCO(4099)'],
