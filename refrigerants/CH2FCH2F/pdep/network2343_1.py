...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24547,0.0656101,-8.16376e-05,5.51103e-08,-1.52631e-11,-83367,22.3876], Tmin=(100,'K'), Tmax=(870.539,'K')), NASAPolynomial(coeffs=[9.90355,0.0258274,-1.30892e-05,2.61533e-09,-1.87705e-13,-84874.5,-18.1822], Tmin=(870.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-693.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.94976,'amu*angstrom^2'), symmetry=1, barrier=(21.8369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.94706,'amu*angstrom^2'), symmetry=1, barrier=(21.7748,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.939146,'amu*angstrom^2'), symmetry=1, barrier=(21.5928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.939939,'amu*angstrom^2'), symmetry=1, barrier=(21.611,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.606546,0.067477,-7.13939e-05,3.62361e-08,-7.10077e-12,-57514.7,27.7398], Tmin=(100,'K'), Tmax=(1254.41,'K')), NASAPolynomial(coeffs=[18.0236,0.0119381,-4.9816e-06,9.40632e-10,-6.65003e-14,-61884.4,-60.2354], Tmin=(1254.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cs-F1sF1sCd)(F1s)(H))"""),
)

species(
    label = 'O=[C][CH]C(F)(F)CF(6352)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.804012,0.0749452,-0.00010867,8.37568e-08,-2.57552e-11,-61565.1,24.7544], Tmin=(100,'K'), Tmax=(796.916,'K')), NASAPolynomial(coeffs=[11.1329,0.0231023,-1.10901e-05,2.12764e-09,-1.47908e-13,-63211.4,-22.7318], Tmin=(796.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-512.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.682533,0.0860383,-0.000160828,1.55517e-07,-5.67228e-11,-58202.6,28.2073], Tmin=(100,'K'), Tmax=(849.96,'K')), NASAPolynomial(coeffs=[5.58201,0.0340642,-1.80732e-05,3.51958e-09,-2.4253e-13,-57990.9,11.5111], Tmin=(849.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-484.812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COCsFO) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]CC(F)(F)[CH]F(6300)'],
...
reaction(
    label = 'reaction3',
    reactants = ['C=C([O])C(F)(F)[CH]F(6296)'],
    products = ['O=[C]CC(F)(F)[CH]F(6300)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', 'O=[C]C[C](F)F(837)'],
    products = ['O=[C]CC(F)(F)[CH]F(6300)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(129)', '[CH2]C(F)(F)[CH]F(773)'],
    products = ['O=[C]CC(F)(F)[CH]F(6300)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(13)', '[CH2]C(F)(F)[CH]F(773)'],
    products = ['O=[C]CC(F)(F)[CH]F(6300)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=[C]CC(F)=CF(1235)'],
    products = ['O=[C]CC(F)(F)[CH]F(6300)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C=CC(F)(F)[CH]F(6349)'],
    products = ['O=[C]CC(F)(F)[CH]F(6300)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=[C]C=C(F)[CH]F(6350)'],
    products = ['O=[C]CC(F)(F)[CH]F(6300)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'O=[C]C[C](F)F(837)'],
    products = ['O=[C]CC(F)(F)[CH]F(6300)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C=CC(F)(F)[CH]F(6351)'],
    products = ['O=[C]CC(F)(F)[CH]F(6300)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]CC(F)(F)[CH]F(6300)'],
    products = ['O=C(F)C[C](F)[CH]F(6353)'],
