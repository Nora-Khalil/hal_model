...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([O])F(1063)'],
    products = ['O=O(141)', 'CHFO(47)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])F(1122)'],
    products = ['[O]OC([O])F(1063)'],
    transitionState = 'TS2',
