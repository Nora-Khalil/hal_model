...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC[C]=O(610)'],
    products = ['CC([O])C[C]=O(5673)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(129)', '[CH2]C(C)[O](3496)'],
    products = ['CC([O])C[C]=O(5673)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C(C)[O](3496)'],
    products = ['CC([O])C[C]=O(5673)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'O=[C]CC=O(1325)'],
    products = ['CC([O])C[C]=O(5673)'],
