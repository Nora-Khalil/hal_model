...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[O]C[O](1330)'],
    products = ['[O]CO[C](F)F(2314)'],
    transitionState = 'TS2',
