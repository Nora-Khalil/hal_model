...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C([O])F(1108)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)C[C](F)F(1110)'],
    products = ['[CH2]C(F)(F)C([O])F(1108)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[CH]F(773)'],
    products = ['[CH2]C(F)(F)C([O])F(1108)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C([O])F(1092)'],
    products = ['[CH2]C(F)(F)C([O])F(1108)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(1073)', 'CH2CF2(57)'],
    products = ['[CH2]C(F)(F)C([O])F(1108)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C=O(556)'],
    products = ['[CH2]C(F)(F)C([O])F(1108)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHFO(47)', '[CH2][C](F)F(507)'],
    products = ['[CH2]C(F)(F)C([O])F(1108)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)F(1165)'],
    products = ['[CH2]C(F)(F)C([O])F(1108)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(1073)', '[CH2][C](F)F(507)'],
    products = ['[CH2]C(F)(F)C([O])F(1108)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(78)', '[CH2]C(F)=C[O](952)'],
    products = ['[CH2]C(F)(F)C([O])F(1108)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)[CH]OF(1170)'],
    products = ['[CH2]C(F)(F)C([O])F(1108)'],
