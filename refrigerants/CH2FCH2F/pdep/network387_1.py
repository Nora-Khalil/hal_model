...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17428,'amu*angstrom^2'), symmetry=1, barrier=(26.9989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17408,'amu*angstrom^2'), symmetry=1, barrier=(26.9944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17497,'amu*angstrom^2'), symmetry=1, barrier=(27.0148,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.577299,0.069429,-8.39676e-05,4.81781e-08,-1.05356e-11,-11833.1,19.545], Tmin=(100,'K'), Tmax=(1135.9,'K')), NASAPolynomial(coeffs=[18.0677,0.00783806,-2.635e-06,4.4385e-10,-2.98631e-14,-15806.6,-67.0651], Tmin=(1135.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.4527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)

species(
    label = '[C]=COC(C)(F)F(3541)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {4,S} {6,S}
4  C u0 p0 c0 {1,S} {2,S} {3,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.83174,'amu*angstrom^2'), symmetry=1, barrier=(19.1233,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.83009,'amu*angstrom^2'), symmetry=1, barrier=(19.0854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.832813,'amu*angstrom^2'), symmetry=1, barrier=(19.148,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.806066,0.0731347,-9.45404e-05,6.15703e-08,-1.58362e-11,-31154.1,19.0858], Tmin=(100,'K'), Tmax=(950.711,'K')), NASAPolynomial(coeffs=[13.6355,0.0191563,-9.37518e-06,1.85001e-09,-1.32113e-13,-33593.5,-42.1606], Tmin=(950.711,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-CsHHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C#CO[C](C)F(1363)'],
    products = ['C#COC(C)(F)F(691)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'C#CO[C](F)F(2255)'],
    products = ['C#COC(C)(F)F(691)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#COC([CH2])(F)F(633)'],
    products = ['C#COC(C)(F)F(691)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[C]#COC(C)(F)F(3540)'],
    products = ['C#COC(C)(F)F(691)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'C#COC(=C)F(1389)'],
    products = ['C#COC(C)(F)F(691)'],
