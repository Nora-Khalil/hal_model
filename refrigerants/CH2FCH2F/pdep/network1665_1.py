...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(2271)', '[CH]C-2(510)'],
    products = ['C[CH]OC([O])(F)F(3876)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[CH]OC(=O)F(3888)'],
    products = ['C[CH]OC([O])(F)F(3876)'],
    transitionState = 'TS8',
