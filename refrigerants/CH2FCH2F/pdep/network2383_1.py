...
species(
    label = 'F[C](F)C(F)[CH]C(F)(F)F(6366)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
species(
    label = 'F[C](F)[CH]C(F)C(F)(F)F(6367)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(6336)'],
...
reaction(
    label = 'reaction5',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(6336)'],
    products = ['FC(F)=C(F)C(F)C(F)F(6361)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[C](F)C(F)C=C(F)F(6167)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(6336)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C](F)C(F)C(F)=C(F)F(6362)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(6336)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(78)', 'F[C](F)C=C[C](F)F(6168)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(6336)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'F[C](F)C=C(F)[C](F)F(6363)'],
    products = ['F[C](F)C(F)C(F)[C](F)F(6336)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(6336)'],
    products = ['F[C](F)C(F)[CH]C(F)(F)F(6366)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)C(F)C(F)[C](F)F(6336)'],
    products = ['F[C](F)[CH]C(F)C(F)(F)F(6367)'],
