...
"""),
    E0 = (-706.359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.15505,'amu*angstrom^2'), symmetry=1, barrier=(26.5569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15814,'amu*angstrom^2'), symmetry=1, barrier=(26.6278,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.553496,0.11093,-0.000201075,1.76928e-07,-5.94993e-11,-69053.6,30.1638], Tmin=(100,'K'), Tmax=(844.348,'K')), NASAPolynomial(coeffs=[13.9335,0.0237487,-1.32413e-05,2.60222e-09,-1.79488e-13,-70838.7,-33.3609], Tmin=(844.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-575.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsFFOO) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-547.242,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,482,586,761,1411,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0104401,0.0960231,-0.000162863,1.40893e-07,-4.7661e-11,-65682.3,30.5963], Tmin=(100,'K'), Tmax=(807.199,'K')), NASAPolynomial(coeffs=[12.2077,0.0257256,-1.39169e-05,2.75266e-09,-1.92548e-13,-67330.4,-23.6469], Tmin=(807.199,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-547.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(CsCsFFH) + group(CsFHOO) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H)) + radical(CsF1sO2sO2s)"""),
)

species(
    label = '[O][C](F)OC(F)C(F)F(5116)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-819.414,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,482,586,761,1411,393.428,393.438,393.448,393.45,393.463],'cm^-1')),
        HinderedRotor(inertia=(0.00108886,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348663,'amu*angstrom^2'), symmetry=1, barrier=(38.304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348647,'amu*angstrom^2'), symmetry=1, barrier=(38.3044,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (146.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.79711,0.0677146,-6.92547e-05,3.42389e-08,-6.66696e-12,-98435.2,28.8527], Tmin=(100,'K'), Tmax=(1241.82,'K')), NASAPolynomial(coeffs=[16.3511,0.0176138,-8.7375e-06,1.7503e-09,-1.26418e-13,-102298,-49.5549], Tmin=(1241.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-819.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(2271)', '[CH]C(F)F(506)'],
    products = ['[O]C(F)(F)O[CH]C(F)F(5013)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)O[CH]C(F)F(5039)'],
    products = ['[O]C(F)(F)O[CH]C(F)F(5013)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(39.8283,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(F)(F)O[CH]C(F)F(5013)'],
    products = ['OC(F)(F)O[CH][C](F)F(5112)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH][CH]OC(F)(F)OF(5113)'],
    products = ['[O]C(F)(F)O[CH]C(F)F(5013)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(86.3672,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['FO[C](F)O[CH]C(F)F(5115)'],
    products = ['[O]C(F)(F)O[CH]C(F)F(5013)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O][C](F)OC(F)C(F)F(5116)'],
    products = ['[O]C(F)(F)O[CH]C(F)F(5013)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(212.05,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #2009',
    isomers = [
        '[O]C(F)(F)O[CH]C(F)F(5013)',
    ],
    reactants = [
