...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCOF(4203)'],
    products = ['O=C(O)COF(4076)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(127)', '[CH2]C(=O)O(523)'],
    products = ['O=C(O)COF(4076)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(158)', '[CH2]OF(179)'],
    products = ['O=C(O)COF(4076)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)[CH]OF(4288)'],
    products = ['O=C(O)COF(4076)'],
