...
"""),
    E0 = (-455.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,194,682,905,1196,1383,3221,315,622,1128,235.341],'cm^-1')),
        HinderedRotor(inertia=(0.298252,'amu*angstrom^2'), symmetry=1, barrier=(11.7219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0160155,'amu*angstrom^2'), symmetry=1, barrier=(31.1885,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44608,0.0619179,-7.8497e-05,5.40344e-08,-1.53869e-11,-54729.1,22.3661], Tmin=(100,'K'), Tmax=(843.832,'K')), NASAPolynomial(coeffs=[9.14418,0.0254256,-1.36259e-05,2.78149e-09,-2.01864e-13,-56028.2,-13.4654], Tmin=(843.832,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-455.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFH) + group(CJ2_singlet-FC)"""),
)
...
species(
    label = 'F[C]C(=CF)C(F)(F)OF-2(8979)',
...
"""),
    E0 = (-547.536,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,350,440,435,1725,194,682,905,1196,1383,3221,315,622,1128,180,592.859],'cm^-1')),
        HinderedRotor(inertia=(0.578871,'amu*angstrom^2'), symmetry=1, barrier=(13.3094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70491,'amu*angstrom^2'), symmetry=1, barrier=(39.1992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21898,'amu*angstrom^2'), symmetry=1, barrier=(5.03477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0445862,0.0969784,-0.000153627,1.23508e-07,-3.93938e-11,-65715.2,28.1977], Tmin=(100,'K'), Tmax=(769.072,'K')), NASAPolynomial(coeffs=[13.66,0.0256975,-1.45964e-05,2.98546e-09,-2.14683e-13,-67823.1,-34.3201], Tmin=(769.072,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-547.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(Cds-CdsCsCs) + group(CdCFH) + group(CJ2_singlet-FC)"""),
)
...
species(
    label = 'FOC(F)=C(C(F)F)C(F)F(8980)',
...
9  C u0 p0 c0 {1,S} {4,S} {10,S} {13,S}
10 C u0 p0 c0 {8,S} {9,S} {11,D}
...
"""),
    E0 = (-1057.05,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,87,255,155,255,543,653,1088,1120,1106,1180,1251,1383,1373,1449,3068,3238,350,440,435,1725,326,540,652,719,1357,180,180,764.074],'cm^-1')),
        HinderedRotor(inertia=(0.132036,'amu*angstrom^2'), symmetry=1, barrier=(3.03578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131729,'amu*angstrom^2'), symmetry=1, barrier=(3.02871,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131979,'amu*angstrom^2'), symmetry=1, barrier=(3.03445,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.411026,0.110402,-0.000195952,1.83395e-07,-6.65282e-11,-126988,33.0108], Tmin=(100,'K'), Tmax=(815.32,'K')), NASAPolynomial(coeffs=[8.78826,0.040666,-2.23878e-05,4.46373e-09,-3.1355e-13,-127671,-4.4771], Tmin=(815.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1057.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFO)"""),
)

species(
    label = 'FOC(F)C(=C(F)F)C(F)F(8981)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {11,S}
...
"""),
    E0 = (-1070.75,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,236,527,855,1015,1182,1348,3236,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,182,240,577,636,1210,1413,180,180,2524.57],'cm^-1')),
        HinderedRotor(inertia=(0.520173,'amu*angstrom^2'), symmetry=1, barrier=(11.9598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38194,'amu*angstrom^2'), symmetry=1, barrier=(31.7735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38059,'amu*angstrom^2'), symmetry=1, barrier=(31.7424,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.268884,0.104227,-0.000156327,1.18851e-07,-3.38533e-11,-128637,30.9486], Tmin=(100,'K'), Tmax=(631.196,'K')), NASAPolynomial(coeffs=[12.6767,0.0342532,-1.8708e-05,3.77939e-09,-2.70173e-13,-130512,-27.4532], Tmin=(631.196,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1070.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFF)"""),
)
...
species(
    label = '[CH]=C(C(F)F)C(F)(F)OF(8984)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-665.536,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,3120,650,792.5,1650,188.413,217.932],'cm^-1')),
        HinderedRotor(inertia=(0.213598,'amu*angstrom^2'), symmetry=1, barrier=(7.86626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211876,'amu*angstrom^2'), symmetry=1, barrier=(7.82816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.869854,'amu*angstrom^2'), symmetry=1, barrier=(29.1347,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.354356,0.104499,-0.000173996,1.49487e-07,-5.07741e-11,-79897.1,29.9691], Tmin=(100,'K'), Tmax=(773.413,'K')), NASAPolynomial(coeffs=[13.059,0.0290853,-1.60171e-05,3.21251e-09,-2.27317e-13,-81791.2,-30.1282], Tmin=(773.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-665.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[O]C(F)(F)C(=CF)C(F)F(8985)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-990.918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([526,555,698,907,1200,1145,1227,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,194,682,905,1196,1383,3221,202.512,206.912,209.125],'cm^-1')),
        HinderedRotor(inertia=(0.187644,'amu*angstrom^2'), symmetry=1, barrier=(5.51512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.796526,'amu*angstrom^2'), symmetry=1, barrier=(25.0955,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (161.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.513683,0.0820798,-0.000103006,6.67224e-08,-1.74087e-11,-119059,28.663], Tmin=(100,'K'), Tmax=(928.353,'K')), NASAPolynomial(coeffs=[13.2923,0.027021,-1.40444e-05,2.83812e-09,-2.05155e-13,-121431,-32.0365], Tmin=(928.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-990.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(O2sj(Cs-F1sF1sCd))"""),
)
...
"""),
    E0 = (-848.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,161,297,490,584,780,1358,194,682,905,1196,1383,3221,1848.33],'cm^-1')),
        HinderedRotor(inertia=(0.0249114,'amu*angstrom^2'), symmetry=1, barrier=(8.96942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.86443,'amu*angstrom^2'), symmetry=1, barrier=(42.8668,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.41064,0.0544496,-5.17806e-05,2.47177e-08,-4.72345e-12,-102030,15.3685], Tmin=(10,'K'), Tmax=(1214.38,'K')), NASAPolynomial(coeffs=[12.8737,0.0232795,-1.32793e-05,3.58127e-09,-3.72172e-13,-104328,-32.1234], Tmin=(1214.38,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-848.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), label="""FCDC([C](F)F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-391.411,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,140,424,499,621,667,843,876,1082,615,860,1140,1343,3152,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.381496,'amu*angstrom^2'), symmetry=1, barrier=(8.77135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06424,'amu*angstrom^2'), symmetry=1, barrier=(24.4689,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.52616,0.0404973,2.27592e-05,-1.50832e-07,1.24039e-10,-47071.6,13.7225], Tmin=(10,'K'), Tmax=(518.697,'K')), NASAPolynomial(coeffs=[8.59587,0.0286115,-2.15567e-05,7.26141e-09,-9.02714e-13,-47963.5,-10.9365], Tmin=(518.697,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-391.411,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""FCD[C]C(F)(F)OF""", comment="""Thermo library: CHOF_G4"""),
)
...
species(
    label = 'F[C]=C(C(F)F)C(F)(F)OF(8987)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-853.976,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,167,640,1190,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.144914,'amu*angstrom^2'), symmetry=1, barrier=(3.33185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147749,'amu*angstrom^2'), symmetry=1, barrier=(3.39705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.986236,'amu*angstrom^2'), symmetry=1, barrier=(22.6755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (179.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.800347,0.116905,-0.000206913,1.83605e-07,-6.31655e-11,-102548,32.5081], Tmin=(100,'K'), Tmax=(814.207,'K')), NASAPolynomial(coeffs=[13.4972,0.0302593,-1.70643e-05,3.41252e-09,-2.39469e-13,-104332,-30.1911], Tmin=(814.207,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-853.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(CsCFFH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Cdj(Cd-CsCs)(F1s))"""),
)

species(
    label = '[CH]C(F)(C(F)F)C(F)(F)OF(8988)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    molecularWeight = (180.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.21451,0.125753,-0.000217972,1.89755e-07,-6.44201e-11,-94465.9,33.0602], Tmin=(100,'K'), Tmax=(801.999,'K')), NASAPolynomial(coeffs=[15.213,0.0311999,-1.75221e-05,3.50871e-09,-2.46847e-13,-96695,-40.038], Tmin=(801.999,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-786.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCCF) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (-949.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,255,533,799,832,1228,194,682,905,1196,1383,3221,180,1487.4],'cm^-1')),
        HinderedRotor(inertia=(0.171793,'amu*angstrom^2'), symmetry=1, barrier=(3.94986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17193,'amu*angstrom^2'), symmetry=1, barrier=(3.95301,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.952226,0.0732806,-0.000107749,8.93998e-08,-3.04711e-11,-114053,25.729], Tmin=(100,'K'), Tmax=(713.277,'K')), NASAPolynomial(coeffs=[8.78829,0.0293444,-1.53685e-05,3.07169e-09,-2.18846e-13,-115171,-9.42916], Tmin=(713.277,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-949.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cd-CdCs(CO)) + group(COCFO) + group(CdCFH)"""),
)
...
"""),
    ...
    molecularWeight = (148.031,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.144898,0.0943403,-0.000165149,1.48363e-07,-5.19828e-11,-68613.3,36.5067], Tmin=(100,'K'), Tmax=(806.194,'K')), NASAPolynomial(coeffs=[10.628,0.0282096,-1.58381e-05,3.17134e-09,-2.23208e-13,-69844.8,-8.96424], Tmin=(806.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-571.561,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(CsCFFH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
    products = ['HF(38)', 'CF2O(49)', 'FC=C=C(F)F(5948)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(71.0102,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'FC=C(OF)C(F)F(6074)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(205.254,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['FOF(1520)', 'F[C]C(=CF)C(F)F(8978)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(6.44768e+28,'m^3/(mol*s)'), n=-6.4458, Ea=(113.962,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.6591608693425184, var=5.4995193120720405, Tref=1000.0, N=19, data_mean=0.0, correlation='CH',), comment="""Estimated from node CH"""),
)

reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'F[C]C(=CF)C(F)(F)OF-2(8979)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHF(40)', 'FC=C(F)C(F)(F)OF(7019)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(156.213,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction7',
    reactants = ['FOC(F)=C(C(F)F)C(F)F(8980)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.49186e+12,'s^-1'), n=0.63878, Ea=(285.826,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='F_Ext-2R!H-R',), comment="""Estimated from node F_Ext-2R!H-R
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['FOC(F)C(=C(F)F)C(F)F(8981)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.62709e+20,'s^-1'), n=-1.9758, Ea=(214.102,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'F[CH]C(=C(F)OF)C(F)F(8982)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[CH]C(=CF)C(F)(F)OF(8983)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH]=C(C(F)F)C(F)(F)OF(8984)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[O]C(F)(F)C(=CF)C(F)F(8985)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(127)', 'FC=C([C](F)F)C(F)F(7571)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
...
reaction(
    label = 'reaction15',
    reactants = ['FO[C](F)F(2145)', 'FC=[C]C(F)F(5463)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF2(82)', 'FC=[C]C(F)(F)OF(8986)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'F[C]=C(C(F)F)C(F)(F)OF(8987)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]C(F)(C(F)F)C(F)(F)OF(8988)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(93.2492,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)

reaction(
    label = 'reaction20',
    reactants = ['F[C]C(C(F)F)C(F)(F)OF(8989)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(78)', 'O=C(F)C(=CF)C(F)F(7988)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
...
reaction(
    label = 'reaction22',
    reactants = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
    products = ['F2(78)', 'CF2O(49)', 'FC=C=CF(8881)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(342.094,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', 'FOC(F)(F)[C]C(F)F(8990)'],
    products = ['FC=C(C(F)F)C(F)(F)OF(8845)'],
...
network(
    label = 'PDepNetwork #2923',
    isomers = [
        'FC=C(C(F)F)C(F)(F)OF(8845)',
    ],
    reactants = [
