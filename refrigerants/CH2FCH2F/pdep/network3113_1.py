...
"""),
    E0 = (44.2953,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([364,474,579,619,655,1345,2950,1000,2950,3100,1380,975,1025,1650,1685,370,440.726,440.73,440.732,440.733,440.74,440.743],'cm^-1')),
        HinderedRotor(inertia=(0.256013,'amu*angstrom^2'), symmetry=1, barrier=(35.2899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000867865,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31617,0.0480311,-2.4117e-05,-1.28217e-08,1.08144e-11,5434.09,23.1322], Tmin=(100,'K'), Tmax=(960.1,'K')), NASAPolynomial(coeffs=[17.2426,0.00786774,-2.28532e-06,4.30704e-10,-3.4462e-14,1168.83,-59.3412], Tmin=(960.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.2953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring) + radical(C=CJO)"""),
)
...
"""),
    E0 = (374.78,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,2950,3100,1380,975,1025,1650,1685,370,180,180,180,380.147,768.13,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.152039,'amu*angstrom^2'), symmetry=1, barrier=(3.49568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152039,'amu*angstrom^2'), symmetry=1, barrier=(3.49568,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94297,0.0457154,-5.05508e-05,2.95144e-08,-6.91996e-12,45149.3,21.094], Tmin=(100,'K'), Tmax=(1033.57,'K')), NASAPolynomial(coeffs=[9.73881,0.0155449,-6.76487e-06,1.27193e-09,-8.86648e-14,43537.8,-16.7738], Tmin=(1033.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(C=CJO)"""),
)
...
"""),
    E0 = (13.8776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([364,474,579,619,655,1345,2950,1000,2175,525,750,770,3400,2100,331.603,332.303,333.088,334.063,337.43],'cm^-1')),
        HinderedRotor(inertia=(0.462625,'amu*angstrom^2'), symmetry=1, barrier=(37.0202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.469561,'amu*angstrom^2'), symmetry=1, barrier=(36.9989,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10864,0.0518876,-3.32665e-05,-7.97262e-09,1.03039e-11,1783.87,18.205], Tmin=(100,'K'), Tmax=(952.01,'K')), NASAPolynomial(coeffs=[19.6158,0.00246442,-4.29724e-08,2.77919e-11,-7.58643e-15,-3024.05,-76.9153], Tmin=(952.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.8776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(CsCFOO) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring)"""),
)

species(
    label = '[CH]=COC1(F)[CH]O1(9417)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (51.6473,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([364,474,579,619,655,1345,2950,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,375.215,375.845,376.022,376.487,376.511],'cm^-1')),
        HinderedRotor(inertia=(0.294159,'amu*angstrom^2'), symmetry=1, barrier=(29.5086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295162,'amu*angstrom^2'), symmetry=1, barrier=(29.5138,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03753,0.0497359,-1.3674e-05,-3.45223e-08,2.12572e-11,6332.62,21.407], Tmin=(100,'K'), Tmax=(933.303,'K')), NASAPolynomial(coeffs=[21.5747,0.000990363,1.54909e-06,-3.0886e-10,1.52281e-14,788.665,-85.4189], Tmin=(933.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.6473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cs(F)(O2)-O2s-Cs) + radical(Csj(Cs-F1sO2sO2s)(O2s-Cs)(H)_ring) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OC1(F)CO1(9418)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (74.4198,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,361,584,565,722,1474,2750,3150,900,1100,1685,370,3120,650,792.5,1650,415.692,415.703,415.704,415.704,415.71,415.713],'cm^-1')),
        HinderedRotor(inertia=(0.000975489,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000975536,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2698,0.0506506,-3.41915e-05,-5.16086e-10,5.98311e-12,9057.38,23.2781], Tmin=(100,'K'), Tmax=(973.791,'K')), NASAPolynomial(coeffs=[16.5126,0.00925732,-3.11508e-06,5.84979e-10,-4.42002e-14,5082.68,-55.0202], Tmin=(973.791,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.4198,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cs(F)(O2)-O2s-Cs) + radical(C=CJO) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.169616,0.0653956,-7.25363e-05,3.81592e-08,-7.30435e-12,1066.87,25.6229], Tmin=(100,'K'), Tmax=(1543.5,'K')), NASAPolynomial(coeffs=[17.6465,0.00437454,2.05111e-06,-6.58822e-10,5.23664e-14,-2454.55,-60.2093], Tmin=(1543.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.58883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(CdCFO) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]OC1(F)[CH]O1(9322)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C1(F)[CH]O1(9413)', '[C]=C(368)'],
    products = ['C=[C]OC1(F)[CH]O1(9322)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC1=CO1(9415)'],
    products = ['C=[C]OC1(F)[CH]O1(9322)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(16.9636,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC1(F)[CH]O1(9416)'],
    products = ['C=[C]OC1(F)[CH]O1(9322)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=COC1(F)[CH]O1(9417)'],
    products = ['C=[C]OC1(F)[CH]O1(9322)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]OC1(F)[CH]O1(9322)'],
    products = ['C=C(F)O[C]1[CH]O1(9419)'],
