...
"""),
    E0 = (-887.937,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,509,613,660,1171,1360,1414,3084,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,217.606,217.997,218.148,218.383],'cm^-1')),
        HinderedRotor(inertia=(0.274722,'amu*angstrom^2'), symmetry=1, barrier=(9.29335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27453,'amu*angstrom^2'), symmetry=1, barrier=(9.28959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.801536,'amu*angstrom^2'), symmetry=1, barrier=(27.3323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273872,'amu*angstrom^2'), symmetry=1, barrier=(9.28696,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-878.595,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,580,1155,1237,1373,3147,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.908394,'amu*angstrom^2'), symmetry=1, barrier=(20.8858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195432,'amu*angstrom^2'), symmetry=1, barrier=(4.49338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19571,'amu*angstrom^2'), symmetry=1, barrier=(4.49975,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.32229,0.0637139,-9.65105e-05,8.70362e-08,-3.32056e-11,-105669,14.2078], Tmin=(10,'K'), Tmax=(617.696,'K')), NASAPolynomial(coeffs=[8.03348,0.0332059,-2.2426e-05,7.07884e-09,-8.44635e-13,-106251,-6.25135], Tmin=(617.696,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-878.595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""F[CH]OC(F)C(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-1024.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,451,553,637,1069,1180,1265,1301,3056,331.46,331.461,331.462,331.462],'cm^-1')),
        HinderedRotor(inertia=(0.0824809,'amu*angstrom^2'), symmetry=1, barrier=(6.43051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272199,'amu*angstrom^2'), symmetry=1, barrier=(21.2216,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.503026,'amu*angstrom^2'), symmetry=1, barrier=(39.2178,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.804628,0.0732009,-8.05763e-05,4.51386e-08,-1.02022e-11,-123076,26.9622], Tmin=(100,'K'), Tmax=(1062.87,'K')), NASAPolynomial(coeffs=[13.5901,0.0250844,-1.26711e-05,2.54634e-09,-1.83994e-13,-125793,-35.4997], Tmin=(1062.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1024.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH))"""),
)
...
"""),
    E0 = (-1076.33,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,509,613,660,1171,1360,1414,3084,522,611,926,1093,1137,1374,1416,3112,395,473,707,1436,180.002,180.002,180.594,182.794],'cm^-1')),
        HinderedRotor(inertia=(0.726678,'amu*angstrom^2'), symmetry=1, barrier=(17.0526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269754,'amu*angstrom^2'), symmetry=1, barrier=(6.34941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276153,'amu*angstrom^2'), symmetry=1, barrier=(6.34929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57805,'amu*angstrom^2'), symmetry=1, barrier=(37.335,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.347691,0.0875678,-0.000131689,1.05894e-07,-3.43413e-11,-129328,29.4078], Tmin=(100,'K'), Tmax=(752.879,'K')), NASAPolynomial(coeffs=[11.3126,0.0293163,-1.56404e-05,3.1425e-09,-2.24366e-13,-130980,-20.3801], Tmin=(752.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1076.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFHOO) + radical(Csj(Cs-F1sF1sH)(F1s)(O2s-Cs))"""),
)

species(
    label = 'OC(F)OC(F)[C](F)F(6503)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1071.9,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,509,613,660,1171,1360,1414,3084,190,488,555,1236,1407,252.987,253.015,253.18,253.313],'cm^-1')),
        HinderedRotor(inertia=(0.576789,'amu*angstrom^2'), symmetry=1, barrier=(26.2472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224795,'amu*angstrom^2'), symmetry=1, barrier=(10.2053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22445,'amu*angstrom^2'), symmetry=1, barrier=(10.2065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.71339,'amu*angstrom^2'), symmetry=1, barrier=(32.397,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.329171,0.0873534,-0.000121886,8.78355e-08,-2.5354e-11,-128794,28.5954], Tmin=(100,'K'), Tmax=(844.507,'K')), NASAPolynomial(coeffs=[13.1192,0.0267736,-1.42853e-05,2.89345e-09,-2.08521e-13,-130954,-30.9474], Tmin=(844.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1071.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFHOO) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-1023.78,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,2782.5,750,1395,475,1775,1000,180,499.654,855.516],'cm^-1')),
        HinderedRotor(inertia=(1.53234,'amu*angstrom^2'), symmetry=1, barrier=(35.2315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0678748,'amu*angstrom^2'), symmetry=1, barrier=(35.2236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53225,'amu*angstrom^2'), symmetry=1, barrier=(35.2295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34876,0.0542411,-4.3338e-05,1.63767e-08,-2.46157e-12,-123033,23.4128], Tmin=(100,'K'), Tmax=(1559.82,'K')), NASAPolynomial(coeffs=[15.1639,0.0188136,-9.26931e-06,1.81575e-09,-1.27824e-13,-127343,-49.379], Tmin=(1559.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1023.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-OdOsH)"""),
)
...
reaction(
    ...
    products = ['OC(F)OC(F)C(F)F(6014)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.33604e-10,'m^3/(mol*s)'), n=4.72997, Ea=(131.191,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['HF(38)', 'OC(F)OC(F)[C]F(5975)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'OC(F)O[CH]C(F)F(6498)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'OC(F)OC(F)[CH]F(6499)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O[CH]OC(F)C(F)F(6500)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(O)F(1207)', 'CHF2-CHF(67)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O[CH]F(459)', '[O]C(F)C(F)F(1662)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'F[CH]OC(F)C(F)F(5887)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(F)OC(F)C(F)F(6501)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF2(82)', 'OC(F)O[CH]F(4503)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC(F)O[C](F)C(F)F(6502)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'OC(F)OC(F)[C](F)F(6503)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O[C](F)OC(F)C(F)F(5584)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=COC(F)C(F)F(6504)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(78)', 'OC(F)OC=CF(6505)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'OC(F)OC=C(F)F(5000)'],
    products = ['OC(F)OC(F)C(F)F(6014)'],
