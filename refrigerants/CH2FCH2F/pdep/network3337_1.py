...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.804271,'amu*angstrom^2'), symmetry=1, barrier=(18.4918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.803987,'amu*angstrom^2'), symmetry=1, barrier=(18.4852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.80409,'amu*angstrom^2'), symmetry=1, barrier=(18.4876,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12908,0.0696219,-0.000101045,7.11573e-08,-1.71284e-11,-77043.7,21.8959], Tmin=(100,'K'), Tmax=(634.782,'K')), NASAPolynomial(coeffs=[10.5331,0.0208334,-1.04978e-05,2.04546e-09,-1.42993e-13,-78448.6,-20.8609], Tmin=(634.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-641.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04839,0.0707332,-0.000114641,9.77115e-08,-3.26428e-11,-78473.7,23.0138], Tmin=(100,'K'), Tmax=(827.362,'K')), NASAPolynomial(coeffs=[9.53739,0.0215449,-1.06921e-05,2.05081e-09,-1.41178e-13,-79599.5,-14.6468], Tmin=(827.362,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-653.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(CsCFFO) + radical(ROOJ)"""),
)

species(
    label = '[O]OC(F)(F)CO(9129)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0485,0.0707318,-0.000114635,9.77032e-08,-3.26386e-11,-78473.7,23.0135], Tmin=(100,'K'), Tmax=(827.421,'K')), NASAPolynomial(coeffs=[9.5372,0.0215452,-1.06924e-05,2.05086e-09,-1.41183e-13,-79599.5,-14.6457], Tmin=(827.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-653.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFFO) + group(Cs-CsOsHH) + radical(ROOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.611595,'amu*angstrom^2'), symmetry=1, barrier=(14.0618,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.60981,'amu*angstrom^2'), symmetry=1, barrier=(14.0207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.611986,'amu*angstrom^2'), symmetry=1, barrier=(14.0708,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.032,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.25435,'amu*angstrom^2'), symmetry=1, barrier=(28.8399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25483,'amu*angstrom^2'), symmetry=1, barrier=(28.8509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25326,'amu*angstrom^2'), symmetry=1, barrier=(28.8149,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14744,0.068313,-9.82808e-05,7.61201e-08,-2.38875e-11,-64214.2,21.8704], Tmin=(100,'K'), Tmax=(776.163,'K')), NASAPolynomial(coeffs=[9.74688,0.0239898,-1.26117e-05,2.52745e-09,-1.80591e-13,-65548.9,-17.4368], Tmin=(776.163,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-534.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(O2sj(Cs-F1sO2sCs))"""),
)

species(
    label = 'OOC(O)(F)[CH]F(10835)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.612991,'amu*angstrom^2'), symmetry=1, barrier=(14.0939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.612355,'amu*angstrom^2'), symmetry=1, barrier=(14.0792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39546,'amu*angstrom^2'), symmetry=1, barrier=(32.0843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67128,'amu*angstrom^2'), symmetry=1, barrier=(38.426,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.50919,0.0836931,-0.000141919,1.2152e-07,-4.05157e-11,-71128.1,23.8889], Tmin=(100,'K'), Tmax=(818.114,'K')), NASAPolynomial(coeffs=[11.6102,0.0208838,-1.11137e-05,2.17907e-09,-1.51449e-13,-72658.9,-25.693], Tmin=(818.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-592.383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)

species(
    label = 'O[C](CF)OOF(10836)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.10092,'amu*angstrom^2'), symmetry=1, barrier=(25.3124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10017,'amu*angstrom^2'), symmetry=1, barrier=(25.2952,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09854,0.0694529,-0.000103915,8.22733e-08,-2.61826e-11,-32805.5,25.1713], Tmin=(100,'K'), Tmax=(767.653,'K')), NASAPolynomial(coeffs=[10.1329,0.0223798,-1.19373e-05,2.39946e-09,-1.71417e-13,-34192.6,-16.0259], Tmin=(767.653,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(O)(F)OOF(10837)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (113.04,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.74783,0.0771389,-0.000120271,9.56958e-08,-3.01078e-11,-37168.4,24.5519], Tmin=(100,'K'), Tmax=(780.958,'K')), NASAPolynomial(coeffs=[11.8852,0.0200867,-1.06757e-05,2.12703e-09,-1.5066e-13,-38907.7,-26.4244], Tmin=(780.958,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(CsCFOO) + group(Cs-CsHHH) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(O)(F)CF(9949)'],
    products = ['HO2(11)', 'O=C(F)CF(476)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC(O)(F)F(2301)', 'CH2(S)(25)'],
    products = ['[O]OC(O)(F)CF(9949)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['OF(140)', 'C=C(F)O[O](292)'],
    products = ['[O]OC(O)(F)CF(9949)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]O[C](O)CF(1905)'],
    products = ['[O]OC(O)(F)CF(9949)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(O)(F)O[O](964)'],
    products = ['[O]OC(O)(F)CF(9949)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]OC([O])(F)CF(9996)'],
    products = ['[O]OC(O)(F)CF(9949)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]O[C](O)F(1125)', 'CH2F(46)'],
    products = ['[O]OC(O)(F)CF(9949)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]OC(O)(F)[CH]F(10164)'],
    products = ['[O]OC(O)(F)CF(9949)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[O]OC(=O)CF(10163)'],
    products = ['[O]OC(O)(F)CF(9949)'],
