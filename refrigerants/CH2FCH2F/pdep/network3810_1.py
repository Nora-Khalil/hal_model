species(
    label = 'OC(F)(CF)OC(F)C(F)F(11604)',
...
11 C u0 p0 c0 {3,S} {4,S} {9,S} {13,S}
12 H u0 p0 c0 {9,S}
13 H u0 p0 c0 {11,S}
14 H u0 p0 c0 {10,S}
15 H u0 p0 c0 {10,S}
...
"""),
    E0 = (-1497.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,235,523,627,1123,1142,1372,1406,3097,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.84033,0.114469,-0.00015018,1.02153e-07,-2.79381e-11,-179983,32.9716], Tmin=(100,'K'), Tmax=(888.304,'K')), NASAPolynomial(coeffs=[16.3784,0.0369305,-1.92425e-05,3.88065e-09,-2.79752e-13,-183042,-48.0584], Tmin=(888.304,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1497.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F))"""),
)
...
species(
    label = 'OC(F)([C]F)OC(F)C(F)F(11805)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
4  F u0 p3 c0 {10,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.926026,0.11735,-0.0001804,1.42089e-07,-4.44354e-11,-137668,34.2075], Tmin=(100,'K'), Tmax=(784.149,'K')), NASAPolynomial(coeffs=[15.7773,0.0321415,-1.73987e-05,3.50262e-09,-2.49991e-13,-140287,-42.3141], Tmin=(784.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1146.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCFOO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    E0 = (-1511.9,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,435,565,619,662,854,1178,1396,272.187,272.188,272.188,272.188],'cm^-1')),
        HinderedRotor(inertia=(0.202137,'amu*angstrom^2'), symmetry=1, barrier=(10.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524856,'amu*angstrom^2'), symmetry=1, barrier=(27.5933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202138,'amu*angstrom^2'), symmetry=1, barrier=(10.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.644717,'amu*angstrom^2'), symmetry=1, barrier=(33.8947,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0754931,0.0922967,-0.000118918,7.80734e-08,-2.05202e-11,-181703,28.7122], Tmin=(100,'K'), Tmax=(924.276,'K')), NASAPolynomial(coeffs=[14.8905,0.0281802,-1.48616e-05,3.01773e-09,-2.18613e-13,-184442,-41.5949], Tmin=(924.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1511.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFFOO)"""),
)
...
"""),
    E0 = (-1058.49,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,548,1085,1183,1302,1466,1520,3060,3119,253.448,253.461,253.614,253.988],'cm^-1')),
        HinderedRotor(inertia=(0.412679,'amu*angstrom^2'), symmetry=1, barrier=(18.8403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238538,'amu*angstrom^2'), symmetry=1, barrier=(10.883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239098,'amu*angstrom^2'), symmetry=1, barrier=(10.8807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.725488,'amu*angstrom^2'), symmetry=1, barrier=(33.1057,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.711362,0.0783655,-9.96088e-05,6.92172e-08,-1.9731e-11,-127194,24.8061], Tmin=(100,'K'), Tmax=(847.16,'K')), NASAPolynomial(coeffs=[10.7627,0.0309102,-1.55894e-05,3.10364e-09,-2.2211e-13,-128897,-22.0192], Tmin=(847.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1058.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsFHHO)"""),
)
...
species(
    label = 'OC(F)(F)COC(F)C(F)F(11806)',
...
"""),
    ...
    molecularWeight = (180.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.768393,0.113279,-0.000152765,1.08538e-07,-3.11058e-11,-181420,33.5704], Tmin=(100,'K'), Tmax=(848.356,'K')), NASAPolynomial(coeffs=[15.1973,0.0380011,-1.96634e-05,3.94306e-09,-2.82898e-13,-184129,-40.8293], Tmin=(848.356,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1509.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(CsCFHO) + group(CsCFFO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F))"""),
)

species(
    label = 'OCC(F)(F)OC(F)C(F)F(11807)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {11,S}
...
"""),
    ...
    molecularWeight = (180.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.768391,0.113279,-0.000152765,1.08538e-07,-3.11058e-11,-181420,33.5704], Tmin=(100,'K'), Tmax=(848.359,'K')), NASAPolynomial(coeffs=[15.1973,0.0380011,-1.96634e-05,3.94306e-09,-2.82897e-13,-184129,-40.8293], Tmin=(848.359,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1509.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + group(CsCFHO) + group(Cs-CsOsHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F))"""),
)
...
"""),
    E0 = (-1153.74,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,326,540,652,719,1357,194,682,905,1196,1383,3221,275.372,275.379,275.388,275.433],'cm^-1')),
        HinderedRotor(inertia=(0.450305,'amu*angstrom^2'), symmetry=1, barrier=(24.2338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.450347,'amu*angstrom^2'), symmetry=1, barrier=(24.2341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.450413,'amu*angstrom^2'), symmetry=1, barrier=(24.2326,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0262207,0.0900685,-0.000105017,6.02064e-08,-1.36323e-11,-138619,27.6881], Tmin=(100,'K'), Tmax=(1073.61,'K')), NASAPolynomial(coeffs=[17.8533,0.0234548,-1.19486e-05,2.41571e-09,-1.75401e-13,-142458,-59.8407], Tmin=(1073.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1153.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F))"""),
)
...
"""),
    E0 = (-986.872,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,326,540,652,719,1357,2950,3100,1380,975,1025,1650,234.752,234.756,234.758,234.761],'cm^-1')),
        HinderedRotor(inertia=(0.662259,'amu*angstrom^2'), symmetry=1, barrier=(25.8997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662257,'amu*angstrom^2'), symmetry=1, barrier=(25.8998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.66225,'amu*angstrom^2'), symmetry=1, barrier=(25.8997,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.156081,0.0799988,-8.25377e-05,4.13269e-08,-8.11214e-12,-118551,26.2565], Tmin=(100,'K'), Tmax=(1237.81,'K')), NASAPolynomial(coeffs=[18.8962,0.0194395,-9.15079e-06,1.80166e-09,-1.29233e-13,-123190,-68.152], Tmin=(1237.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-986.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CdCFO) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-1073.35,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.213991,0.100309,-0.000130243,8.93654e-08,-2.48666e-11,-128949,33.2849], Tmin=(100,'K'), Tmax=(870.544,'K')), NASAPolynomial(coeffs=[13.9143,0.035392,-1.83869e-05,3.70544e-09,-2.66998e-13,-131409,-32.9173], Tmin=(870.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1073.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(CsCsFHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Cs_P)"""),
)

species(
    label = 'OC(F)(CF)O[CH]C(F)F(11810)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1106.02,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (161.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03893,0.119919,-0.00019172,1.60539e-07,-5.32718e-11,-132850,33.6357], Tmin=(100,'K'), Tmax=(784.258,'K')), NASAPolynomial(coeffs=[14.5196,0.0348256,-1.79914e-05,3.52876e-09,-2.46934e-13,-135114,-36.5191], Tmin=(784.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1106.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + radical(Csj(Cs-F1sF1sH)(O2s-Cs)(H))"""),
)

species(
    label = 'OC(F)(CF)OC(F)[CH]F(11811)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-1082.93,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,487,638,688,1119,1325,1387,3149,528,1116,1182,1331,1402,1494,3075,3110,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (161.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.749703,0.112734,-0.000161265,1.20107e-07,-3.57748e-11,-130083,32.1075], Tmin=(100,'K'), Tmax=(820.169,'K')), NASAPolynomial(coeffs=[15.3212,0.0343539,-1.7914e-05,3.58338e-09,-2.5599e-13,-132719,-42.2392], Tmin=(820.169,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1082.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2]C(O)(F)OC(F)C(F)F(11812)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1109.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (161.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.750083,0.112984,-0.000163195,1.23234e-07,-3.72634e-11,-133234,31.7804], Tmin=(100,'K'), Tmax=(807.907,'K')), NASAPolynomial(coeffs=[15.0119,0.0349429,-1.82954e-05,3.66213e-09,-2.6155e-13,-135780,-40.8993], Tmin=(807.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1109.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)
...
"""),
    E0 = (-1094.52,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.337166,0.103124,-0.000145925,1.0868e-07,-3.25181e-11,-131491,30.3896], Tmin=(100,'K'), Tmax=(815.202,'K')), NASAPolynomial(coeffs=[13.9166,0.0331861,-1.72392e-05,3.44488e-09,-2.46037e-13,-133815,-35.4647], Tmin=(815.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1094.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs))"""),
)
...
species(
    label = '[O]C(F)(CF)OC(F)C(F)F(11814)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {11,S}
...
"""),
    E0 = (-1239.18,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([373,336,502,477,708,1220,1477,261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,235,523,627,1123,1142,1372,1406,3097,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-1074.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,482,586,761,1411,180,467.882,467.885,467.885],'cm^-1')),
        HinderedRotor(inertia=(0.108051,'amu*angstrom^2'), symmetry=1, barrier=(10.1568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3613,'amu*angstrom^2'), symmetry=1, barrier=(31.2989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3613,'amu*angstrom^2'), symmetry=1, barrier=(31.2989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127756,'amu*angstrom^2'), symmetry=1, barrier=(19.8465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.487898,0.0782355,-8.90835e-05,4.99716e-08,-1.10918e-11,-129160,28.4318], Tmin=(100,'K'), Tmax=(1093.22,'K')), NASAPolynomial(coeffs=[16.1072,0.0210852,-1.06671e-05,2.15123e-09,-1.55995e-13,-132575,-48.3141], Tmin=(1093.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1074.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsFHOO) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
species(
    label = 'OC(F)(CF)O[C](F)C(F)F(11815)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {10,S}
...
"""),
    E0 = (-1296.85,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,334,575,1197,1424,3202,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (179.065,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.27707,0.125624,-0.000196287,1.58415e-07,-5.07858e-11,-155794,35.08], Tmin=(100,'K'), Tmax=(765.484,'K')), NASAPolynomial(coeffs=[16.0653,0.034997,-1.86877e-05,3.73243e-09,-2.64763e-13,-158449,-43.951], Tmin=(765.484,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1296.85,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Csj(Cs-F1sO2sO2s)(F1s)(H))"""),
)

species(
    label = 'OC(F)(CF)OC(F)[C](F)F(11817)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {10,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1289.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,487,638,688,1119,1325,1387,3149,528,1116,1182,1331,1402,1494,3075,3110,190,488,555,1236,1407,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (179.065,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.893364,0.116885,-0.000168006,1.25272e-07,-3.74319e-11,-154981,34.6122], Tmin=(100,'K'), Tmax=(816.613,'K')), NASAPolynomial(coeffs=[15.6275,0.0359618,-1.93636e-05,3.92423e-09,-2.82421e-13,-157680,-41.7444], Tmin=(816.613,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1289.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + radical(Csj(Cs-F1sO2sH)(F1s)(F1s))"""),
)

species(
    label = 'O=C(CF)OC(F)C(F)F(11818)',
    structure = adjacencyList("""1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
4  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-1243.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,244,1102,1254,1379,1468,1475,3037,3083,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.752694,0.0765617,-7.31955e-05,3.65152e-08,-7.60996e-12,-149447,28.7313], Tmin=(100,'K'), Tmax=(1119.57,'K')), NASAPolynomial(coeffs=[12.3002,0.035304,-1.79173e-05,3.59812e-09,-2.59416e-13,-152033,-28.2825], Tmin=(1119.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1243.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (-958.803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,235,523,627,1123,1142,1372,1406,3097,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.03433,'amu*angstrom^2'), symmetry=1, barrier=(23.7813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03431,'amu*angstrom^2'), symmetry=1, barrier=(23.7809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03595,'amu*angstrom^2'), symmetry=1, barrier=(23.8185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03443,'amu*angstrom^2'), symmetry=1, barrier=(23.7837,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.893054,0.0962473,-0.000109606,5.89559e-08,-1.20831e-11,-115131,28.3986], Tmin=(100,'K'), Tmax=(1210.94,'K')), NASAPolynomial(coeffs=[24.9909,0.0107454,-3.69261e-06,6.45632e-10,-4.4695e-14,-121400,-101.43], Tmin=(1210.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-958.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(CsCsFFH) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'OC(F)(CF)OC=CF(11819)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
4  O u0 p2 c0 {6,S} {8,S}
...
"""),
    E0 = (-958.83,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.07252,'amu*angstrom^2'), symmetry=1, barrier=(24.6593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07237,'amu*angstrom^2'), symmetry=1, barrier=(24.6558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0698,'amu*angstrom^2'), symmetry=1, barrier=(24.5969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07068,'amu*angstrom^2'), symmetry=1, barrier=(24.617,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.429543,0.0921034,-0.000102865,5.54339e-08,-1.15866e-11,-115157,28.2692], Tmin=(100,'K'), Tmax=(1173.95,'K')), NASAPolynomial(coeffs=[21.3668,0.0178361,-7.97014e-06,1.54418e-09,-1.10376e-13,-120274,-80.3809], Tmin=(1173.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-958.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)
...
"""),
    E0 = (-1151.23,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,3010,987.5,1337.5,450,1655,182,240,577,636,1210,1413,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.07618,'amu*angstrom^2'), symmetry=1, barrier=(24.7434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07615,'amu*angstrom^2'), symmetry=1, barrier=(24.7429,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07611,'amu*angstrom^2'), symmetry=1, barrier=(24.7419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07539,'amu*angstrom^2'), symmetry=1, barrier=(24.7252,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.067,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(CF)OC(F)C(F)F(11604)'],
    products = ['HF(38)', 'O=C(F)CF(476)', 'O=CC(F)F(990)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5.29418e+10,'s^-1'), n=0.745914, Ea=(138.747,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_7R!H->C',), comment="""Estimated from node Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_7R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['F[C]C(F)F-2(1828)', 'OC(O)(F)CF(11519)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.5279e-12,'m^3/(mol*s)'), n=5.02686, Ea=(50.5075,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'OC(F)(CF)OC(F)F(11804)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'OC(F)([C]F)OC(F)C(F)F(11805)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'OC(F)(F)OC(F)C(F)F(5533)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CF2(43)', 'OC(F)(CF)OCF(11298)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HF(38)', 'OC(F)(CF)OC(F)[C]F(11112)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OC(F)(CF)OC(F)C(F)F(11604)'],
    products = ['OC(F)(F)COC(F)C(F)F(11806)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OC(F)(CF)OC(F)C(F)F(11604)'],
    products = ['OCC(F)(F)OC(F)C(F)F(11807)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OC(F)=CF(3655)', 'OC(F)C(F)F(1614)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOC(F)C(F)F(3101)', 'C=C(O)F(213)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H2O(3)', 'FC=C(F)OC(F)C(F)F(10061)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OF(140)', 'C=C(F)OC(F)C(F)F(11808)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHFCF2(55)', 'OC(O)(F)CF(11519)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHFCHF[Z](59)', 'OC(F)(CF)OF(4403)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'O[C](CF)OC(F)C(F)F(11809)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F(37)', 'OC(F)(CF)O[CH]C(F)F(11810)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', 'OC(F)(CF)OC(F)[CH]F(11811)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', '[CH2]C(O)(F)OC(F)C(F)F(11812)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C(F)C(F)F(1662)', 'O[C](F)CF(9946)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CHF2-CHF(67)', '[O]C(O)(F)CF(9948)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction23',
    reactants = ['OH(7)', 'FC[C](F)OC(F)C(F)F(11813)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', '[O]C(F)(CF)OC(F)C(F)F(11814)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2F(46)', 'O[C](F)OC(F)C(F)F(5584)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CHF2(82)', 'OC(F)(CF)O[CH]F(11527)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(5)', 'OC(F)(CF)O[C](F)C(F)F(11815)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(5)', 'OC(F)([CH]F)OC(F)C(F)F(11816)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(5)', 'OC(F)(CF)OC(F)[C](F)F(11817)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction30',
    reactants = ['HF(38)', 'O=C(CF)OC(F)C(F)F(11818)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction31',
    reactants = ['F2(78)', 'C=C(O)OC(F)C(F)F(6751)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction32',
    reactants = ['F2(78)', 'OC(F)(CF)OC=CF(11819)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction33',
    reactants = ['HF(38)', 'OC(F)(CF)OC(F)=CF(10084)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
...
reaction(
    label = 'reaction35',
    reactants = ['HF(38)', 'OC(F)(CF)OC=C(F)F(10664)'],
    products = ['OC(F)(CF)OC(F)C(F)F(11604)'],
