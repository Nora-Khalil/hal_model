...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)OOO(3957)'],
    products = ['HO2(11)', 'FC1CO1(289)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'OOO[CH]F(1103)'],
    products = ['[CH2]C(F)OOO(3957)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2][CH]OOO(4022)'],
    products = ['[CH2]C(F)OOO(3957)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HO2(11)', '[CH2]C([O])F(139)'],
    products = ['[CH2]C(F)OOO(3957)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', '[CH2]C(F)O[O](216)'],
    products = ['[CH2]C(F)OOO(3957)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)OO[O](1266)'],
    products = ['[CH2]C(F)OOO(3957)'],
