...
"""),
    E0 = (-39.8815,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,562,600,623,1070,1265,1685,370,180,1841.52,1842.18],'cm^-1')),
        HinderedRotor(inertia=(0.20893,'amu*angstrom^2'), symmetry=1, barrier=(4.80371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208981,'amu*angstrom^2'), symmetry=1, barrier=(4.80489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31995,0.0413801,-6.33871e-05,5.86003e-08,-2.19007e-11,-4740.43,21.199], Tmin=(100,'K'), Tmax=(778.464,'K')), NASAPolynomial(coeffs=[5.01907,0.0207158,-1.04762e-05,2.07482e-09,-1.46783e-13,-4954.77,10.1757], Tmin=(778.464,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.8815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=COCJ) + radical(Cdj(Cd-F1sF1s)(O2s-Cs))"""),
)
...
species(
    label = '[CH2]O[C]1C(F)C1(F)F(8114)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-274.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,3000,3100,440,815,1455,1000,167,640,1190,277.07,277.123,1475.05],'cm^-1')),
        HinderedRotor(inertia=(0.115139,'amu*angstrom^2'), symmetry=1, barrier=(6.27256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00406251,'amu*angstrom^2'), symmetry=1, barrier=(6.27241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.677929,'amu*angstrom^2'), symmetry=1, barrier=(36.9246,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.885592,0.0764497,-0.000125039,1.13718e-07,-4.11157e-11,-32922.3,26.7355], Tmin=(100,'K'), Tmax=(791.927,'K')), NASAPolynomial(coeffs=[7.49537,0.0311046,-1.64985e-05,3.27533e-09,-2.30814e-13,-33594.2,-1.24322], Tmin=(791.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-274.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFH) + longDistanceInteraction_noncyclic(Cs(F)2-CdOs) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=COCJ) + radical(Cdj(Cd-CsO2s)(F1s))"""),
)

species(
    label = 'F[C]C(=CF)OCF(8118)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-354.275,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,194,682,905,1196,1383,3221,388.215,388.219,388.226,388.242,388.25,388.252],'cm^-1')),
        HinderedRotor(inertia=(0.0117927,'amu*angstrom^2'), symmetry=1, barrier=(27.0211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252621,'amu*angstrom^2'), symmetry=1, barrier=(27.0216,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0797791,'amu*angstrom^2'), symmetry=1, barrier=(8.53313,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19426,0.0679284,-8.59904e-05,5.91196e-08,-1.68031e-11,-42513.8,22.77], Tmin=(100,'K'), Tmax=(845.665,'K')), NASAPolynomial(coeffs=[9.67542,0.0278119,-1.48327e-05,3.02271e-09,-2.19182e-13,-43948.2,-16.7249], Tmin=(845.665,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.275,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(CsFHHO) + group(Cds-CdsCsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00737,0.0527577,-3.61927e-05,-3.39966e-08,5.39952e-11,-42663.2,22.4694], Tmin=(100,'K'), Tmax=(472.522,'K')), NASAPolynomial(coeffs=[6.18755,0.0319393,-1.63499e-05,3.25225e-09,-2.31567e-13,-43220.9,3.71532], Tmin=(472.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-355.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(CsCsFFH) + ring(Cs-O2s-Cs-Cs(F)) + radical(C2CsJOCs) + radical(Csj(Cs-O2sCsH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-332.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,182,240,577,636,1210,1413,330.248,332.733,333.18,333.675,2094.36],'cm^-1')),
        HinderedRotor(inertia=(0.0092046,'amu*angstrom^2'), symmetry=1, barrier=(28.6221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13885,'amu*angstrom^2'), symmetry=1, barrier=(11.0473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.364317,'amu*angstrom^2'), symmetry=1, barrier=(28.5999,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26279,0.0685479,-8.73638e-05,5.07664e-08,-4.94141e-12,-39879.8,22.0324], Tmin=(100,'K'), Tmax=(564.105,'K')), NASAPolynomial(coeffs=[8.3723,0.0298923,-1.58382e-05,3.18336e-09,-2.27684e-13,-40869,-9.85463], Tmin=(564.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]=C(O[CH2])C(F)(F)F(8121)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14129,0.0652851,-6.295e-05,3.21753e-08,-6.82816e-12,-46902,24.3774], Tmin=(100,'K'), Tmax=(1110.13,'K')), NASAPolynomial(coeffs=[11.2207,0.0289677,-1.38791e-05,2.7072e-09,-1.92097e-13,-49139.9,-25.3033], Tmin=(1110.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-390.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFHHO) + group(Cds-CdsCsOs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC([CH]F)=C(F)F(7437)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'O=C([CH]F)[C](F)F(7925)'],
    products = ['[CH2]OC([CH]F)=C(F)F(7437)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]O[C]=C(F)F(8113)'],
    products = ['[CH2]OC([CH]F)=C(F)F(7437)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]OC([CH]F)=C(F)F(7437)'],
    products = ['[CH2]O[C]1C(F)C1(F)F(8114)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]OC([CH]F)=C(F)F(7437)'],
    products = ['F[CH][C]1OCC1(F)F(8115)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]O[C]=C(F)F(8113)'],
    products = ['[CH2]OC([CH]F)=C(F)F(7437)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OC(=[C]F)C(F)F(8117)'],
    products = ['[CH2]OC([CH]F)=C(F)F(7437)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]F(744)', '[CH2]O[C]=CF(2251)'],
    products = ['[CH2]OC([CH]F)=C(F)F(7437)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', '[CH2]O[C]=CF(2251)'],
    products = ['[CH2]OC([CH]F)=C(F)F(7437)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]OC([CH]F)=C(F)F(7437)'],
    products = ['[CH]=C(O[CH2])C(F)(F)F(8121)'],
...
network(
    label = 'PDepNetwork #2691',
    isomers = [
        '[CH2]OC([CH]F)=C(F)F(7437)',
    ],
    reactants = [
