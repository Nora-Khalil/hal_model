...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.20387,'amu*angstrom^2'), symmetry=1, barrier=(27.6794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19553,'amu*angstrom^2'), symmetry=1, barrier=(27.4877,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.18188,0.103239,-0.000181774,1.64266e-07,-5.71996e-11,-78508.4,29.1356], Tmin=(100,'K'), Tmax=(835.835,'K')), NASAPolynomial(coeffs=[10.3811,0.0320598,-1.70143e-05,3.32553e-09,-2.30244e-13,-79553.6,-15.6198], Tmin=(835.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-653.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(Cds-CdsCsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + radical(Cds_S)"""),
)
...
species(
    label = 'F[CH]C(F)(F)C(F)=C=CF(8430)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-619.441,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,145,326,398,834,1303,334,575,1197,1424,3202,113,247,382,1207,3490,540,610,2055,180,1208.79],'cm^-1')),
        HinderedRotor(inertia=(0.00421286,'amu*angstrom^2'), symmetry=1, barrier=(4.35716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189428,'amu*angstrom^2'), symmetry=1, barrier=(4.35532,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370419,0.0893653,-0.000126896,8.48735e-08,-1.68895e-11,-74379.9,30.1223], Tmin=(100,'K'), Tmax=(601.964,'K')), NASAPolynomial(coeffs=[11.6522,0.0295032,-1.53671e-05,3.03934e-09,-2.14407e-13,-76011.8,-20.8526], Tmin=(601.964,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-619.441,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(CdCddCF) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sF1sCd)(F1s)(H))"""),
)
...
species(
    label = 'C#CC(F)(F)C(F)(F)[CH]F(8431)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.529772,'amu*angstrom^2'), symmetry=1, barrier=(12.1805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.33601,'amu*angstrom^2'), symmetry=1, barrier=(7.72553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.46222,'amu*angstrom^2'), symmetry=1, barrier=(56.6112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (157.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.511257,0.110736,-0.000196959,1.74017e-07,-5.84939e-11,-82116,28.9619], Tmin=(100,'K'), Tmax=(867.289,'K')), NASAPolynomial(coeffs=[12.2524,0.0285467,-1.44738e-05,2.73922e-09,-1.8474e-13,-83452.8,-25.7413], Tmin=(867.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-684.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
species(
    label = 'FC#CC(F)(F)C(F)(F)[CH]F(8432)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-783.776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,154,355,414,641,686,1150,1196,334,575,1197,1424,3202,2175,525,239,401,1367,180,180,786.861],'cm^-1')),
        HinderedRotor(inertia=(0.239668,'amu*angstrom^2'), symmetry=1, barrier=(5.51045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238768,'amu*angstrom^2'), symmetry=1, barrier=(5.48974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236573,'amu*angstrom^2'), symmetry=1, barrier=(5.43928,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (175.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.729899,0.11972,-0.000226392,2.09642e-07,-7.30519e-11,-94111.1,32.0672], Tmin=(100,'K'), Tmax=(863.114,'K')), NASAPolynomial(coeffs=[10.5935,0.0335433,-1.80604e-05,3.49102e-09,-2.37887e-13,-94810.5,-13.623], Tmin=(863.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-783.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFHH) + group(Ct-CtCs) + group(CtCF) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
species(
    label = 'F[C]=CC(F)(F)C(F)(F)[CH]F(8433)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.394961,'amu*angstrom^2'), symmetry=1, barrier=(9.08094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07361,'amu*angstrom^2'), symmetry=1, barrier=(24.6844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394912,'amu*angstrom^2'), symmetry=1, barrier=(9.0798,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.781849,0.116069,-0.000199112,1.75506e-07,-6.03852e-11,-87834.5,34.0702], Tmin=(100,'K'), Tmax=(810.92,'K')), NASAPolynomial(coeffs=[12.8791,0.033464,-1.81605e-05,3.59862e-09,-2.51934e-13,-89549.6,-25.8871], Tmin=(810.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-731.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-F1sF1sCs)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
species(
    label = 'F[CH][C](F)C(F)(F)C(F)=CF(8435)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.576687,'amu*angstrom^2'), symmetry=1, barrier=(13.2592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.583783,'amu*angstrom^2'), symmetry=1, barrier=(13.4223,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-783.562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,215,315,519,588,595,1205,1248,246,474,533,1155,334,575,1197,1424,3202,3120,650,792.5,1650,180,180,1307.6],'cm^-1')),
        HinderedRotor(inertia=(0.314128,'amu*angstrom^2'), symmetry=1, barrier=(7.22243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310883,'amu*angstrom^2'), symmetry=1, barrier=(7.14782,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.313926,'amu*angstrom^2'), symmetry=1, barrier=(7.21779,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (176.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01038,0.123903,-0.000223931,2.01849e-07,-6.94823e-11,-94073.4,33.8886], Tmin=(100,'K'), Tmax=(847.961,'K')), NASAPolynomial(coeffs=[12.5117,0.0338469,-1.81572e-05,3.53536e-09,-2.43169e-13,-95422.2,-23.5484], Tmin=(847.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-783.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)2) + group(CsCsFHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Csj(Cs-CsF1sF1s)(F1s)(H)) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(223)', 'FC=[C]C(F)(F)[C](F)F(7760)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=CF(1054)', 'F[CH]C(F)(F)[C](F)F(6191)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_ter_rad;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'FC=[C]C(F)(F)C(F)=CF(7747)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C(F)(F)C(F)=C=CF(8430)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C#CC(F)(F)C(F)(F)[CH]F(8431)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC#CC(F)(F)C(F)(F)[CH]F(8432)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(78)', 'F[CH]C(F)=C(F)[C]=CF(7751)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'FC=[C]C(F)(F)[C](F)F(7760)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
    products = ['F[C]=CC(F)(F)C(F)(F)[CH]F(8433)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[C]=[C]C(F)(F)C(F)(F)CF(8434)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
    products = ['F[CH][C](F)C(F)(F)C(F)=CF(8435)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
    products = ['F[CH][C]=C(F)C(F)(F)C(F)F(8436)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
    products = ['F[CH]C(F)(F)[C](F)C(F)=CF(8437)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=[C]C(F)(F)C(F)(F)C(F)F(8438)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C(F)C(F)(F)C(F)(F)[CH]F(8439)'],
    products = ['F[CH]C(F)(F)C(F)(F)[C]=CF(7574)'],
