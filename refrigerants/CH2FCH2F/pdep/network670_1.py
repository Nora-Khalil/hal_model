...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)O[O](700)'],
    products = ['[O]CC(F)(F)O[O](1641)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[C](F)F(788)', 'CH2O(20)'],
    products = ['[O]CC(F)(F)O[O](1641)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]OC(F)(F)C=O(1651)'],
    products = ['[O]CC(F)(F)O[O](1641)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(788)', '[CH2][O](133)'],
    products = ['[O]CC(F)(F)O[O](1641)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]O[C](F)C=O(1683)'],
    products = ['[O]CC(F)(F)O[O](1641)'],
