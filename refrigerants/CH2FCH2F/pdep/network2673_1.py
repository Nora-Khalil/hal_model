...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77027,0.0508819,-6.89217e-05,4.54398e-08,-1.1693e-11,-32268.3,19.3502], Tmin=(100,'K'), Tmax=(954.619,'K')), NASAPolynomial(coeffs=[11.4155,0.0104668,-5.41715e-06,1.09087e-09,-7.87218e-14,-34109.8,-26.7347], Tmin=(954.619,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(CdCddFF) + group(Cdd-CdsCds) + radical(C=COJ) + radical(C=COJ)"""),
)
...
species(
    label = '[O]C(=O)[C]1C(F)C1(F)F(8336)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66624,0.0574021,-7.84474e-05,7.39762e-08,-3.03305e-11,-64067.8,24.3993], Tmin=(100,'K'), Tmax=(702.11,'K')), NASAPolynomial(coeffs=[3.96232,0.0371954,-2.00537e-05,4.07513e-09,-2.93828e-13,-64214.6,15.3848], Tmin=(702.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-533.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(CsCsCsFH) + group(CsCsCsFF) + group(Cds-OdCsOs) + ring(Cs(F)-Cs-Cs) + radical(CCOJ) + radical(CCJ(C)CO) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'F[CH]C([C]1OO1)=C(F)F(8337)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.719909,0.0657913,-7.03528e-05,3.42919e-08,-5.74664e-12,-25865.4,28.4563], Tmin=(100,'K'), Tmax=(997.496,'K')), NASAPolynomial(coeffs=[17.1787,0.0106316,-3.70759e-06,6.45497e-10,-4.46028e-14,-29688.2,-53.61], Tmin=(997.496,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFF) + ring(dioxirane) + radical(Cs_P) + radical(Csj(Cd-CsCd)(F1s)(H))"""),
)

species(
    label = 'O=C1OC(F)[C]1[C](F)F(8338)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {9,S}
3  F u0 p3 c0 {9,S}
...
"""),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55884,0.0431347,-9.59392e-06,-2.38205e-08,1.37462e-11,-72923.8,25.3981], Tmin=(100,'K'), Tmax=(954.411,'K')), NASAPolynomial(coeffs=[14.4916,0.014486,-4.72881e-06,8.33843e-10,-5.99827e-14,-76556.2,-42.4884], Tmin=(954.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-607.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(CsCFHO) + group(CsCsFFH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(CCJ(C)CO) + radical(CsCsF1sF1s)"""),
)

species(
    label = 'O=C1OC(F)(F)[C]1[CH]F(8339)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-159.398,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,350,440,435,1725,194,682,905,1196,1383,3221,180,180,180,379.908,800.891,1600,1828.57,2971.43,3200],'cm^-1')),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.613166,0.0880269,-0.000170357,1.66536e-07,-6.14544e-11,-19062.2,27.7681], Tmin=(100,'K'), Tmax=(835.302,'K')), NASAPolynomial(coeffs=[6.14488,0.0324937,-1.84776e-05,3.69252e-09,-2.58203e-13,-18973.1,8.14132], Tmin=(835.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFH) + radical(CsCCl_triplet)"""),
)

species(
    label = '[O]C(=O)C(=[C]F)C(F)F(8341)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {9,S}
...
"""),
    E0 = (-400.663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,167,640,1190,180,180,180,1847.73,1847.76,1847.8,1847.81],'cm^-1')),
        HinderedRotor(inertia=(0.160572,'amu*angstrom^2'), symmetry=1, barrier=(3.69186,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160704,'amu*angstrom^2'), symmetry=1, barrier=(3.69489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.982603,0.0842614,-0.000175871,1.84259e-07,-7.07665e-11,-48097.3,28.5892], Tmin=(100,'K'), Tmax=(848.744,'K')), NASAPolynomial(coeffs=[1.20996,0.0403815,-2.26652e-05,4.49366e-09,-3.12114e-13,-46594,36.6129], Tmin=(848.744,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-400.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCFFH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFH) + radical(CCOJ) + radical(CdCdF1s)"""),
)
...
"""),
    E0 = (-494.937,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,182,240,577,636,1210,1413,180,180,180,353.579,1473.64,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.139939,'amu*angstrom^2'), symmetry=1, barrier=(3.21746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139939,'amu*angstrom^2'), symmetry=1, barrier=(3.21746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139939,'amu*angstrom^2'), symmetry=1, barrier=(3.21746,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.755751,0.0848114,-0.000164809,1.61701e-07,-5.96551e-11,-59423.3,28.0925], Tmin=(100,'K'), Tmax=(841,'K')), NASAPolynomial(coeffs=[5.6667,0.0319564,-1.79263e-05,3.56115e-09,-2.48e-13,-59206.2,11.4522], Tmin=(841,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-494.937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCFHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFF) + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH]C(C(=O)OF)=C(F)F(8343)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.622632,0.0843005,-0.000142024,1.32129e-07,-4.80869e-11,-22116.5,28.5869], Tmin=(100,'K'), Tmax=(819.092,'K')), NASAPolynomial(coeffs=[6.59728,0.0361352,-1.90456e-05,3.73335e-09,-2.60205e-13,-22458.3,4.84322], Tmin=(819.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(CdCFF) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C([O])=O)C(F)(F)F(8344)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-460.433,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([219,296,586,564,718,793,1177,1228,350,440,435,1725,3120,650,792.5,1650,180,180,1753.45,1755.11,1756.06,1756.74],'cm^-1')),
        HinderedRotor(inertia=(0.376554,'amu*angstrom^2'), symmetry=1, barrier=(8.65772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374914,'amu*angstrom^2'), symmetry=1, barrier=(8.62002,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.842929,0.0835285,-0.000162988,1.62465e-07,-6.07107e-11,-55277.2,27.0368], Tmin=(100,'K'), Tmax=(841.064,'K')), NASAPolynomial(coeffs=[4.49305,0.0345465,-1.92341e-05,3.81527e-09,-2.65666e-13,-54772.8,16.708], Tmin=(841.064,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-460.433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCdFFF) + longDistanceInteraction_noncyclic(Cs(F)3-R-CO) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[O]C([O])=C=C(F)F(8335)'],
    products = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C([CH]F)=C(F)F(8307)'],
    products = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
    products = ['[O]C(=O)[C]1C(F)C1(F)F(8336)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
    products = ['F[CH]C([C]1OO1)=C(F)F(8337)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
    products = ['O=C1OC(F)[C]1[C](F)F(8338)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
    products = ['O=C1OC(F)(F)[C]1[CH]F(8339)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.28489e+09,'s^-1'), n=0.690807, Ea=(50.584,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra] for rate rule [R4_S_(CO)_D;doublebond_intra;radadd_intra_O]
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[O]C([O])=C=C(F)F(8335)'],
    products = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=C(OF)C([C]F)=CF(8340)'],
    products = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C(=O)C(=[C]F)C(F)F(8341)'],
    products = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[C]F(744)', '[O]C([O])=C=CF(2695)'],
    products = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
    products = ['O=C1OC(F)(F)C1=CF(7428)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CF2(43)', '[O]C([O])=C=CF(2695)'],
    products = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(O)C([C]F)=C(F)F(8342)'],
    products = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C(C(=O)OF)=C(F)F(8343)'],
    products = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=C(C([O])=O)C(F)(F)F(8344)'],
    products = ['[O]C(=O)C([CH]F)=C(F)F(7419)'],
...
network(
    label = 'PDepNetwork #2673',
    isomers = [
        '[O]C(=O)C([CH]F)=C(F)F(7419)',
    ],
    reactants = [
