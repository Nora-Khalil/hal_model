...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(129)', '[CH2]O[C]=C(369)'],
    products = ['C=[C]OC[C]=O(652)'],
    transitionState = 'TS3',
