...
species(
    label = 'FC1=[C]C(F)(F)O[CH]O1(9084)',
...
"""),
    E0 = (-501.527,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([140,424,499,621,667,843,876,1082,2950,1000,293,496,537,1218,180,180,180,180,712.874,1070.9,1070.9,1070.92,1070.93,1070.93],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0275497,0.071761,-8.02761e-05,4.15309e-08,-7.93602e-12,-60160.4,22.1582], Tmin=(100,'K'), Tmax=(1476.22,'K')), NASAPolynomial(coeffs=[21.2498,0.00290304,1.07579e-06,-3.49373e-10,2.71512e-14,-65221.5,-84.6448], Tmin=(1476.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-501.527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(CdCFO) + ring(24dihydro13dioxin) + radical(OCJO) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-285.563,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,2782.5,750,1395,475,1775,1000,540,610,2055,137,207,812,470.817,474.542,477.004],'cm^-1')),
        HinderedRotor(inertia=(0.000758963,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000735527,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40915,0.0628613,-9.26343e-05,7.50589e-08,-2.49515e-11,-34257.5,23.1621], Tmin=(100,'K'), Tmax=(730.429,'K')), NASAPolynomial(coeffs=[8.45523,0.0242751,-1.33935e-05,2.73496e-09,-1.97387e-13,-35286.8,-8.61777], Tmin=(730.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CdCddFO) + group(Cds-OdOsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cdj(Cdd-Cd)(F1s))"""),
)

species(
    label = '[C]#CC(F)(F)OC=O(9086)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-262.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([157,399,436,611,601,744,1127,2782.5,750,1395,475,1775,1000,2175,525,180,180,1327.72],'cm^-1')),
        HinderedRotor(inertia=(2.68044,'amu*angstrom^2'), symmetry=1, barrier=(61.6286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0491942,'amu*angstrom^2'), symmetry=1, barrier=(61.5527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.68067,'amu*angstrom^2'), symmetry=1, barrier=(61.6339,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35574,0.062694,-8.75723e-05,6.32354e-08,-1.73196e-11,-31429,21.82], Tmin=(100,'K'), Tmax=(688.586,'K')), NASAPolynomial(coeffs=[9.80657,0.0202625,-9.64722e-06,1.83585e-09,-1.26961e-13,-32750.7,-16.9436], Tmin=(688.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-262.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + group(Cds-OdOsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.64058,'amu*angstrom^2'), symmetry=1, barrier=(37.7202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.642,'amu*angstrom^2'), symmetry=1, barrier=(37.7529,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.045,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.754124,0.0786094,-0.000115961,8.99926e-08,-2.82596e-11,-71194.2,23.8099], Tmin=(100,'K'), Tmax=(775.094,'K')), NASAPolynomial(coeffs=[10.8736,0.0263863,-1.48966e-05,3.06618e-09,-2.22305e-13,-72762.9,-22.4327], Tmin=(775.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-592.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCCF) + group(Cds-OdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CF2(43)', 'O=COC#CF(9083)'],
    products = ['O=COC(F)(F)C#CF(7429)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=COF(174)', 'F[C]C#CF(8583)'],
    products = ['O=COC(F)(F)C#CF(7429)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['FC1=[C]C(F)(F)O[CH]O1(9084)'],
    products = ['O=COC(F)(F)C#CF(7429)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=COC(F)=C=[C]F(9085)'],
    products = ['O=COC(F)(F)C#CF(7429)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[C]#CC(F)(F)OC=O(9086)'],
    products = ['O=COC(F)(F)C#CF(7429)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C=O(159)', 'F[C]=C=C(F)F(7369)'],
    products = ['O=COC(F)(F)C#CF(7429)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HCO(15)', '[O]C(F)(F)C#CF(2244)'],
    products = ['O=COC(F)(F)C#CF(7429)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[C]#CF(1924)', 'O=CO[C](F)F(2344)'],
    products = ['O=COC(F)(F)C#CF(7429)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[C]=C(F)C(F)(F)OC=O(9087)'],
    products = ['O=COC(F)(F)C#CF(7429)'],
