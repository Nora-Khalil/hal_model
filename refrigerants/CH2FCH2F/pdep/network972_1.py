...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(2271)', '[C]=C(368)'],
    products = ['C=[C]OC([O])(F)F(2137)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(=O)F(1445)'],
    products = ['C=[C]OC([O])(F)F(2137)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC([O])(F)F(2273)'],
    products = ['C=[C]OC([O])(F)F(2137)'],
    transitionState = 'TS8',
