...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[C](F)F(2136)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(744)', '[CH2]C([O])=O(296)'],
    products = ['[CH2]C(=O)O[C](F)F(2136)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'O=[C]O[C](F)F(1040)'],
    products = ['[CH2]C(=O)O[C](F)F(2136)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[C](F)F(2136)'],
    products = ['[CH2][C]1OC(F)(F)O1(2278)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]C([O])=O(296)'],
    products = ['[CH2]C(=O)O[C](F)F(2136)'],
