...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](1330)', '[CH]C-2(510)'],
    products = ['C[CH]OC[O](5662)'],
    transitionState = 'TS2',
