...
reaction(
    label = 'reaction1',
    reactants = ['OOOC(F)[CH]F(4578)'],
    products = ['HO2(11)', 'FC1OC1F(977)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C(F)OOO(4020)'],
    products = ['OOOC(F)[CH]F(4578)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', 'OOO[CH]F(1103)'],
    products = ['OOOC(F)[CH]F(4578)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'OOO[CH][CH]F(1289)'],
    products = ['OOOC(F)[CH]F(4578)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HO2(11)', '[O]C(F)[CH]F(975)'],
    products = ['OOOC(F)[CH]F(4578)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[O]OC(F)[CH]F(502)'],
    products = ['OOOC(F)[CH]F(4578)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[O]OOC(F)[CH]F(4564)'],
    products = ['OOOC(F)[CH]F(4578)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'OOO[C](F)[CH]F(4571)'],
    products = ['OOOC(F)[CH]F(4578)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'OOO[CH]F(1103)'],
    products = ['OOOC(F)[CH]F(4578)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OOOC(F)[C]F-2(4581)'],
    products = ['OOOC(F)[CH]F(4578)'],
