...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60151,0.0505512,-4.2818e-05,1.94801e-08,-3.64637e-12,-27047.4,20.5498], Tmin=(100,'K'), Tmax=(1261.04,'K')), NASAPolynomial(coeffs=[10.5366,0.0222095,-9.10633e-06,1.65824e-09,-1.13256e-13,-29301,-24.6296], Tmin=(1261.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCCFF) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(34dihydro12dioxin) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1OOCC1(F)F(1765)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48277,0.0457163,-2.00724e-05,-6.67798e-09,5.26569e-12,-24042.6,23.4446], Tmin=(100,'K'), Tmax=(1100.14,'K')), NASAPolynomial(coeffs=[13.9861,0.0187998,-8.65694e-06,1.72629e-09,-1.25923e-13,-27915.9,-43.1702], Tmin=(1100.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCCFF) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.9482,'amu*angstrom^2'), symmetry=1, barrier=(44.793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.564489,'amu*angstrom^2'), symmetry=1, barrier=(12.9787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.94897,'amu*angstrom^2'), symmetry=1, barrier=(44.8108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.94826,'amu*angstrom^2'), symmetry=1, barrier=(44.7943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.28296,0.0923689,-0.000167827,1.51962e-07,-5.23666e-11,33921.9,27.6014], Tmin=(100,'K'), Tmax=(854.993,'K')), NASAPolynomial(coeffs=[9.93974,0.0258691,-1.37531e-05,2.6584e-09,-1.81821e-13,33049.9,-12.9167], Tmin=(854.993,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Csj(Cs-O2sHH)(F1s)(F1s)) + radical(Acetyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.91694,'amu*angstrom^2'), symmetry=1, barrier=(44.0743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.91836,'amu*angstrom^2'), symmetry=1, barrier=(44.1068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.71254,'amu*angstrom^2'), symmetry=1, barrier=(16.3827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.91811,'amu*angstrom^2'), symmetry=1, barrier=(44.1012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.338966,0.0886226,-0.000147458,1.28571e-07,-4.37971e-11,9571.09,26.5631], Tmin=(100,'K'), Tmax=(826.869,'K')), NASAPolynomial(coeffs=[10.3111,0.02779,-1.42596e-05,2.76141e-09,-1.90854e-13,8352.44,-17.0476], Tmin=(826.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.5471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'C#COOC[C]F(1763)'],
    products = ['C#COOC[C](F)F(1725)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(744)', 'C#COO[CH2](1312)'],
    products = ['C#COOC[C](F)F(1725)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C#COOC[C](F)F(1725)'],
    products = ['HCCO(21)', 'FC1(F)CO1(783)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['C#CO[O](451)', 'CH2CF2(57)'],
    products = ['C#COOC[C](F)F(1725)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['HCCO(21)', '[O]C[C](F)F(518)'],
    products = ['C#COOC[C](F)F(1725)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C#CO[O](451)', '[CH2][C](F)F(507)'],
    products = ['C#COOC[C](F)F(1725)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H(22)', '[O]OC[C](F)F(699)'],
    products = ['C#COOC[C](F)F(1725)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[C]#COOC[C](F)F(1768)'],
    products = ['C#COOC[C](F)F(1725)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'C#COOC[C]F-2(1769)'],
    products = ['C#COOC[C](F)F(1725)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', 'C#COO[CH2](1312)'],
    products = ['C#COOC[C](F)F(1725)'],
