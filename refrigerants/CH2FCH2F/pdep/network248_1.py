...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C([O])=C=O(1300)'],
    products = ['[CH2]C(=O)C([O])=O(564)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([O])=C=O(1026)'],
    products = ['[CH2]C(=O)C([O])=O(564)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C]=O(276)', '[CH2][C]=O(338)'],
    products = ['[CH2]C(=O)C([O])=O(564)'],
