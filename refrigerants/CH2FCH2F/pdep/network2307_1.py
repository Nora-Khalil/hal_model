...
reaction(
    label = 'reaction3',
    reactants = ['FC(F)C(F)F(1810)'],
    products = ['HF(38)', 'F[C]C(F)F-2(1828)'],
    transitionState = 'TS3',
