...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', 'O[CH]OC(F)(F)F(3820)'],
    products = ['OC(F)OC(F)(F)F(3599)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'OC(F)O[C](F)F(3821)'],
    products = ['OC(F)OC(F)(F)F(3599)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'F[CH]OC(F)(F)F(3822)'],
    products = ['OC(F)OC(F)(F)F(3599)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)OC(F)(F)F(3823)'],
    products = ['OC(F)OC(F)(F)F(3599)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[C](F)OC(F)(F)F(3512)'],
    products = ['OC(F)OC(F)(F)F(3599)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'O=COC(F)(F)F(3824)'],
    products = ['OC(F)OC(F)(F)F(3599)'],
