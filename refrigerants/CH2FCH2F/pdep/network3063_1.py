...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[O](3184)'],
    products = ['[CH]=CC(C)[O](9185)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[CH](257)', 'C[CH][O](3430)'],
    products = ['[CH]=CC(C)[O](9185)'],
