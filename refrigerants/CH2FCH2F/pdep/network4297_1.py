...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)(F)OF(3467)', 'C2H4(30)'],
    products = ['CCOC(F)(F)OF(12937)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'CCO[C](F)OF(12945)'],
    products = ['CCOC(F)(F)OF(12937)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'CCOC([O])(F)F(12946)'],
    products = ['CCOC(F)(F)OF(12937)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)OF(3472)', 'C2H5(32)'],
    products = ['CCOC(F)(F)OF(12937)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FO[C](F)F(2145)', 'CC[O](3057)'],
    products = ['CCOC(F)(F)OF(12937)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(127)', 'CCO[C](F)F(5781)'],
    products = ['CCOC(F)(F)OF(12937)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[CH2]OC(F)(F)OF(3601)'],
    products = ['CCOC(F)(F)OF(12937)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C[CH]OC(F)(F)OF(12947)'],
    products = ['CCOC(F)(F)OF(12937)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]COC(F)(F)OF(12948)'],
    products = ['CCOC(F)(F)OF(12937)'],
