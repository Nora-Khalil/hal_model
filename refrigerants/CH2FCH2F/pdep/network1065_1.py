...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C([O])(F)F(2336)'],
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)F(2350)'],
    products = ['[O]C(F)(F)C([O])(F)F(2336)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F2(78)', '[O][C](F)C(=O)F(2351)'],
    products = ['[O]C(F)(F)C([O])(F)F(2336)'],
    transitionState = 'TS7',
