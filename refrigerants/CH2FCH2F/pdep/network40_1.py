...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH2]C([O])=O(296)'],
    products = ['[O]C(=O)C[CH]F(169)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C([O])=O(296)'],
    products = ['[O]C(=O)C[CH]F(169)'],
