...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=[C]OC(O)(F)F(3750)'],
    products = ['O=C(F)OC(O)(F)F(3580)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)F(161)', 'O[C](F)F(1777)'],
    products = ['O=C(F)OC(O)(F)F(3580)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CFO(51)', '[O]C(O)(F)F(2300)'],
    products = ['O=C(F)OC(O)(F)F(3580)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'O=C(F)OC(=O)F(3752)'],
    products = ['O=C(F)OC(O)(F)F(3580)'],
