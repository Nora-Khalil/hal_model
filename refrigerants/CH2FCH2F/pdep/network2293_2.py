...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC(F)(F)F(6552)', 'CH2(S)(25)'],
    products = ['[O]OC(F)(F)CF(6103)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)O[O](700)'],
    products = ['[O]OC(F)(F)CF(6103)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)F(788)', 'CH2F(46)'],
    products = ['[O]OC(F)(F)CF(6103)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]OC(F)(F)[CH]F(6107)'],
    products = ['[O]OC(F)(F)CF(6103)'],
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C(F)(F)F(698)'],
    products = ['[O]OCC(F)(F)F(3043)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]O[CH]C(F)(F)F(2887)'],
    products = ['[O]OCC(F)(F)F(3043)'],
