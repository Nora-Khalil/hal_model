...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(C=[C]F)CF(10041)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]C(F)(F)C=[C]F(2183)'],
    products = ['[O]C(F)(C=[C]F)CF(10041)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[C]C=C(F)CF(1977)'],
    products = ['[O]C(F)(C=[C]F)CF(10041)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=C(C=[C]F)CF(10350)'],
    products = ['[O]C(F)(C=[C]F)CF(10041)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2F(46)', 'O=C(F)C=[C]F(1584)'],
    products = ['[O]C(F)(C=[C]F)CF(10041)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)(C#CF)CF(10351)'],
    products = ['[O]C(F)(C=[C]F)CF(10041)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(78)', 'C=C([O])C=[C]F(2002)'],
    products = ['[O]C(F)(C=[C]F)CF(10041)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C(=C=[C]F)CF(10352)'],
    products = ['[O]C(F)(C=[C]F)CF(10041)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(F)(C=[C]F)CF(10041)'],
    products = ['OC(F)([CH]F)C=[C]F(10354)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(F)(C=[C]F)CF(10041)'],
    products = ['[O]C(F)([CH]F)C=CF(10356)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)(C=[C]F)OF(10358)'],
    products = ['[O]C(F)(C=[C]F)CF(10041)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C(F)(C=[C]F)CF(10041)'],
    products = ['[CH2]C([O])(F)C=C(F)F(1571)'],
