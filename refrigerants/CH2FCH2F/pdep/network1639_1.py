...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC(F)(F)OF(2633)'],
    products = ['O=CCC(F)(F)OF(3587)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(1520)', 'O=CC[C]F(3739)'],
    products = ['O=CCC(F)(F)OF(3587)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(140)', 'O=CC=C(F)F(558)'],
    products = ['O=CCC(F)(F)OF(3587)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C[CH]C(F)(F)OF(3740)'],
    products = ['O=CCC(F)(F)OF(3587)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=CC[C](F)OF(3742)'],
    products = ['O=CCC(F)(F)OF(3587)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(F)(F)CC=O(3743)'],
    products = ['O=CCC(F)(F)OF(3587)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(127)', 'O=CC[C](F)F(596)'],
    products = ['O=CCC(F)(F)OF(3587)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FO[C](F)F(2145)', 'CH2CHO(35)'],
    products = ['O=CCC(F)(F)OF(3587)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', '[CH2]C(F)(F)OF(2648)'],
    products = ['O=CCC(F)(F)OF(3587)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C=CC(F)(F)OF(3744)'],
    products = ['O=CCC(F)(F)OF(3587)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=[C]CC(F)(F)OF(3745)'],
    products = ['O=CCC(F)(F)OF(3587)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(78)', 'O=CCC(=O)F(1433)'],
    products = ['O=CCC(F)(F)OF(3587)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=CC=C(F)OF(3746)'],
    products = ['O=CCC(F)(F)OF(3587)'],
