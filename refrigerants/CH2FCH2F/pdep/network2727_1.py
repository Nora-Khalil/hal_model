...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC(F)(F)[C]=CF(7473)'],
    products = ['C2H4(30)', 'FC=C=C(F)F(5948)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(F)(F)[C]=CF(7473)'],
    products = ['[CH2]CC([CH]F)=C(F)F(7471)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C(F)(F)[C]=CF(1994)'],
    products = ['[CH2]CC(F)(F)[C]=CF(7473)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=CF(1054)', '[CH2]C[C](F)F(597)'],
    products = ['[CH2]CC(F)(F)[C]=CF(7473)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H4(30)', 'F[CH][C]=C(F)F(7343)'],
    products = ['[CH2]CC(F)(F)[C]=CF(7473)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=CC(F)(F)[C]=CF(7642)'],
    products = ['[CH2]CC(F)(F)[C]=CF(7473)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]CC(F)=C=CF(8548)'],
    products = ['[CH2]CC(F)(F)[C]=CF(7473)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH2](511)', 'FC=C=C(F)F(5948)'],
    products = ['[CH2]CC(F)(F)[C]=CF(7473)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C#CC(F)(F)C[CH2](8549)'],
    products = ['[CH2]CC(F)(F)[C]=CF(7473)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]CC(F)(F)C#CF(8550)'],
    products = ['[CH2]CC(F)(F)[C]=CF(7473)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH2](511)', 'F[CH][C]=C(F)F(7343)'],
    products = ['[CH2]CC(F)(F)[C]=CF(7473)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C=C(F)[C]=CF(7647)'],
    products = ['[CH2]CC(F)(F)[C]=CF(7473)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC(F)(F)[C]=CF(7473)'],
    products = ['[CH2]CC(F)(F)C=[C]F(8552)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(F)(F)[C]=CF(7473)'],
    products = ['[CH2][CH]C(F)(F)C=CF(8553)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC(F)(F)[C]=CF(7473)'],
    products = ['[CH2]C[C](F)C(F)=CF(8556)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=C(F)C(F)(F)C[CH2](8558)'],
    products = ['[CH2]CC(F)(F)[C]=CF(7473)'],
...
network(
    ...
    isomers = [
        '[CH2]CC(F)(F)[C]=CF(7473)',
    ],
    reactants = [
        ('C2H4(30)', 'FC=C=C(F)F(5948)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
