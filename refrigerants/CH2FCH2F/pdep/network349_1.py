...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C#COC(1378)'],
    products = ['C#COCC=O(658)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['HCO(15)', 'C#CO[CH2](1380)'],
    products = ['C#COCC=O(658)'],
