...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(223)', '[CH]C(=C)F(1947)'],
    products = ['[CH]=C(F)C[CH]F(1931)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)C=CF(1950)'],
    products = ['[CH]=C(F)C[CH]F(1931)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[CH]C(=C)F(1947)'],
    products = ['[CH]=C(F)C[CH]F(1931)'],
