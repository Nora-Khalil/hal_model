...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(129)', '[O]C([O])=O(514)'],
    products = ['[O]C(=O)O[C]=O(3156)'],
    transitionState = 'TS2',
