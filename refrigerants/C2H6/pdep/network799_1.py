...
reaction(
    label = 'reaction1',
    reactants = ['C#CCOC=O(1172)'],
    products = ['CO2(15)', 'C=C=C(430)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(14)', 'C#CCO(1605)'],
    products = ['C#CCOC=O(1172)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(24)', 'C#COC=O(1606)'],
    products = ['C#CCOC=O(1172)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C=O(157)', '[CH]=C=C(1111)'],
    products = ['C#CCOC=O(1172)'],
