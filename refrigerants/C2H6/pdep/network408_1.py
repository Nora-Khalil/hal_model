...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(57)', 'C=[C]O[O](97)'],
    products = ['C=[C]OO[C]=C(548)'],
    transitionState = 'TS2',
