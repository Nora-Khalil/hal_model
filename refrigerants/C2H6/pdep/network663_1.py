...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', 'C[C]=C[O](1200)'],
    products = ['[CH2]OC=[C]C(1131)'],
    transitionState = 'TS2',
