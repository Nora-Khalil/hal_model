...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09922,0.0515924,-1.226e-05,-2.65973e-08,1.55351e-11,-5105.06,19.9304], Tmin=(100,'K'), Tmax=(957.053,'K')), NASAPolynomial(coeffs=[16.1777,0.0180093,-5.76225e-06,1.01503e-09,-7.29503e-14,-9339.39,-59.1958], Tmin=(957.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.4061,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (148.601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,540,610,2055,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.841235,'amu*angstrom^2'), symmetry=1, barrier=(19.3417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84185,'amu*angstrom^2'), symmetry=1, barrier=(19.3558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.842431,'amu*angstrom^2'), symmetry=1, barrier=(19.3691,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21773,0.0494687,-1.38414e-05,-2.40156e-08,1.46326e-11,17983.4,21.9905], Tmin=(100,'K'), Tmax=(954.059,'K')), NASAPolynomial(coeffs=[16.1659,0.015224,-4.69466e-06,8.23595e-10,-5.9853e-14,13837.4,-56.2028], Tmin=(954.059,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(C=COCJ)"""),
)
...
"""),
    E0 = (185.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2100,2250,500,550,180,180,747.449],'cm^-1')),
        HinderedRotor(inertia=(0.18481,'amu*angstrom^2'), symmetry=1, barrier=(4.24915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0107179,'amu*angstrom^2'), symmetry=1, barrier=(4.24816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0107105,'amu*angstrom^2'), symmetry=1, barrier=(4.24822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.69989,'amu*angstrom^2'), symmetry=1, barrier=(62.0759,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84977,0.0448403,-2.62211e-05,3.26432e-09,2.67993e-12,22363.1,22.7053], Tmin=(100,'K'), Tmax=(871.603,'K')), NASAPolynomial(coeffs=[7.8561,0.026003,-8.82219e-06,1.44424e-09,-9.30734e-14,20984.6,-7.34806], Tmin=(871.603,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CtOsHH) + group(Cs-OsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CsJOCC)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22825,0.0475582,-7.11466e-07,-3.84771e-08,1.97226e-11,20837.8,20.8871], Tmin=(100,'K'), Tmax=(953.752,'K')), NASAPolynomial(coeffs=[16.126,0.0178708,-5.59614e-06,9.87928e-10,-7.18348e-14,16504.5,-58.0997], Tmin=(953.752,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_S) + radical(Cds_S)"""),
)
...
"""),
    E0 = (313.392,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1670,1700,300,440,251.482,251.488,2652.61],'cm^-1')),
        HinderedRotor(inertia=(0.16177,'amu*angstrom^2'), symmetry=1, barrier=(7.26015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161785,'amu*angstrom^2'), symmetry=1, barrier=(7.26019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161751,'amu*angstrom^2'), symmetry=1, barrier=(7.26014,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161774,'amu*angstrom^2'), symmetry=1, barrier=(7.26012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56605,0.0613439,-8.54143e-05,8.15794e-08,-3.13604e-11,37772.4,23.7453], Tmin=(100,'K'), Tmax=(824.944,'K')), NASAPolynomial(coeffs=[2.03843,0.0421661,-1.9837e-05,3.76923e-09,-2.59831e-13,38269.1,25.04], Tmin=(824.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.392,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]OC[C]=C(1420)'],
    products = ['[CH2]OC[C]=CC(1955)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]O[CH2](115)', '[C]=CC(210)'],
    products = ['[CH2]OC[C]=CC(1955)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2]OC[C]=CC(1955)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(67.3727,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(18)', 'C#CCO[CH2](1460)'],
    products = ['[CH2]OC[C]=CC(1955)'],
