...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'C=[C]C(=C)[O](641)'],
    products = ['[CH2]C(=C)C(=C)[O](1334)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(7)', '[CH2]C(=C)[C]=C(1483)'],
    products = ['[CH2]C(=C)C(=C)[O](1334)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=C)C(=C)[O](1334)'],
    products = ['[CH2]C1=C([CH2])OC1(1560)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(17)', '[CH2]C(=C)[C]=O(1494)'],
    products = ['[CH2]C(=C)C(=C)[O](1334)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(=C)C(=C)[O](1334)'],
    products = ['[CH2]C1([CH2])CC1=O(1509)'],
