...
"""),
    E0 = (63.6983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,540,610,2055,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.968823,'amu*angstrom^2'), symmetry=1, barrier=(22.2751,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15972,0.0301791,2.22121e-05,-4.10302e-08,1.49499e-11,1217.93,21.9923], Tmin=(100,'K'), Tmax=(1076.54,'K')), NASAPolynomial(coeffs=[8.72581,0.030764,-1.34117e-05,2.58645e-09,-1.84809e-13,-1643.42,-16.893], Tmin=(1076.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.50334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Cyclopropane) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C(=CC)[C]1OO1(2663)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16729,0.0508736,-1.38033e-05,-2.56674e-08,1.58357e-11,38833.1,24.2758], Tmin=(100,'K'), Tmax=(934.648,'K')), NASAPolynomial(coeffs=[15.9764,0.0163118,-4.58262e-06,7.42778e-10,-5.19052e-14,34806.1,-52.902], Tmin=(934.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(dioxirane) + radical(Cs_P) + radical(Allyl_P)"""),
)

species(
    label = 'C[CH][C]1COC1=O(2664)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45067,0.016119,7.62173e-05,-1.11944e-07,4.51896e-11,395.938,24.1091], Tmin=(100,'K'), Tmax=(921.996,'K')), NASAPolynomial(coeffs=[12.2443,0.0197096,-4.5911e-06,6.92505e-10,-4.98771e-14,-3368.55,-32.9653], Tmin=(921.996,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.69005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(CCJ(C)CO) + radical(CCJCC=O)"""),
)

species(
    label = '[CH2][C]1C(=O)OC1C(2665)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99278,0.0288616,4.3934e-05,-8.10366e-08,3.47801e-11,165.299,23.2625], Tmin=(100,'K'), Tmax=(920.52,'K')), NASAPolynomial(coeffs=[13.2491,0.0193449,-4.75491e-06,7.18191e-10,-5.00923e-14,-3576.16,-39.1766], Tmin=(920.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.655812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(CCJ(C)CO) + radical(CJC(C)C=O)"""),
)
...
"""),
    E0 = (130.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,1685,370,180,180,1931,1931,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.285514,'amu*angstrom^2'), symmetry=1, barrier=(6.56453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10017,'amu*angstrom^2'), symmetry=1, barrier=(25.2951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10021,'amu*angstrom^2'), symmetry=1, barrier=(25.296,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.9157,0.0328032,-1.17304e-05,2.70593e-10,2.31034e-13,15587.7,12.1763], Tmin=(100,'K'), Tmax=(2727.35,'K')), NASAPolynomial(coeffs=[52.6618,-0.0157773,3.19368e-06,-4.94406e-10,3.68909e-14,-18432.3,-280.698], Tmin=(2727.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(=[C]C)C(=O)O(2667)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (60.9797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15272,0.0694886,-0.000102488,9.13216e-08,-3.28301e-11,7430.05,25.3242], Tmin=(100,'K'), Tmax=(809.761,'K')), NASAPolynomial(coeffs=[5.87602,0.0346762,-1.67347e-05,3.21371e-09,-2.22867e-13,7041.5,5.85777], Tmin=(809.761,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.9797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)O2s) + radical(C=C(C=O)CJ) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21015,0.0262932,3.46615e-05,-5.76326e-08,2.17049e-11,-17600.6,22.085], Tmin=(100,'K'), Tmax=(1029.75,'K')), NASAPolynomial(coeffs=[10.6661,0.0255321,-1.09679e-05,2.16688e-09,-1.59218e-13,-21043.3,-27.2182], Tmin=(1029.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
"""),
    E0 = (152.968,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,193.46,193.473,193.488,1901.91,1901.93,1901.97],'cm^-1')),
        HinderedRotor(inertia=(0.152443,'amu*angstrom^2'), symmetry=1, barrier=(4.04913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152484,'amu*angstrom^2'), symmetry=1, barrier=(4.04956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152431,'amu*angstrom^2'), symmetry=1, barrier=(4.04939,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51202,0.0639209,-9.78943e-05,9.78693e-08,-3.87285e-11,18478.4,25.7352], Tmin=(100,'K'), Tmax=(809.295,'K')), NASAPolynomial(coeffs=[1.70125,0.0428468,-2.15074e-05,4.19632e-09,-2.93396e-13,19107.3,28.9369], Tmin=(809.295,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]C(=C)C([O])=O(1273)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', 'CC=C=C([O])[O](1293)'],
    products = ['[CH2]C(=CC)C([O])=O(2445)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(7)', '[CH2]C([C]=O)=CC(2661)'],
    products = ['[CH2]C(=CC)C([O])=O(2445)'],
    transitionState = 'TS5',
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.34239e+09,'s^-1'), n=0.889391, Ea=(182.639,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs2H]
Euclidian distance = 1.4142135623730951
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.36e+09,'s^-1'), n=0.84, Ea=(90.3312,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_HNd;radadd_intra] for rate rule [R4_S_(CO)_D;doublebond_intra_HNd;radadd_intra_O]
Euclidian distance = 2.23606797749979
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Exocyclic
Ea raised from 89.5 to 90.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(153.031,'m^3/(mol*s)'), n=1.16366, Ea=(22.3713,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(=[C]C)C(=O)O(2667)'],
    products = ['[CH2]C(=CC)C([O])=O(2445)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(=CC)C([O])=O(2445)'],
    products = ['[CH2][C](C=C)C(=O)O(2031)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(2.90777e+06,'s^-1'), n=1.705, Ea=(89.2238,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_SSMS;Y_rad_out;Cs_H_out_2H] for rate rule [R5H_SSMS;O_rad_out;Cs_H_out_2H]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(38)', 'C=C=C([O])[O](942)'],
    products = ['[CH2]C(=CC)C([O])=O(2445)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(6.44049e+09,'s^-1'), n=0.679905, Ea=(186.669,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_csHNd] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_csHNd]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
Ea raised from 186.6 to 186.7 kJ/mol to match endothermicity of reaction."""),
)
