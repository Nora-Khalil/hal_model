...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]CC=[C]C(1118)'],
    products = ['[CH2]C(C)C=[C]C(1150)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(17)', 'C[C]=C[CH]C(1192)'],
    products = ['[CH2]C(C)C=[C]C(1150)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(18)', 'C=CC=[C]C(1122)'],
    products = ['[CH2]C(C)C=[C]C(1150)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', 'C=C(C)C=[C]C(1252)'],
    products = ['[CH2]C(C)C=[C]C(1150)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', '[CH2]C(C)C#CC(1253)'],
    products = ['[CH2]C(C)C=[C]C(1150)'],
