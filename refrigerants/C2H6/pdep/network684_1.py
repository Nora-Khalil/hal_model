...
"""),
    E0 = (441.632,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,1602.35],'cm^-1')),
        HinderedRotor(inertia=(0.00155881,'amu*angstrom^2'), symmetry=1, barrier=(2.84034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123594,'amu*angstrom^2'), symmetry=1, barrier=(2.84168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.88154,'amu*angstrom^2'), symmetry=1, barrier=(66.2524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123516,'amu*angstrom^2'), symmetry=1, barrier=(2.83987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.1249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76408,0.0446329,-1.86049e-05,-5.60529e-09,5.6445e-12,53200.8,24.2515], Tmin=(100,'K'), Tmax=(919.27,'K')), NASAPolynomial(coeffs=[8.54581,0.0269621,-9.08784e-06,1.50179e-09,-9.81134e-14,51453.7,-10.6162], Tmin=(919.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.632,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
"""),
    E0 = (436.855,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2023.74,2024.7],'cm^-1')),
        HinderedRotor(inertia=(0.650663,'amu*angstrom^2'), symmetry=1, barrier=(50.6567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00222488,'amu*angstrom^2'), symmetry=1, barrier=(6.47441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00154146,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0833509,'amu*angstrom^2'), symmetry=1, barrier=(6.47211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.1249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34064,0.0403417,-1.88721e-05,3.96555e-09,-3.2058e-13,52596.9,24.0957], Tmin=(100,'K'), Tmax=(2853.98,'K')), NASAPolynomial(coeffs=[20.1356,0.0154,-5.76258e-06,9.03132e-10,-5.23091e-14,42440.1,-80.4155], Tmin=(2853.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ) + radical(RCCJ)"""),
)
...
"""),
    E0 = (684.601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,996.367,996.37,996.383,996.386],'cm^-1')),
        HinderedRotor(inertia=(0.106714,'amu*angstrom^2'), symmetry=1, barrier=(2.45357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106726,'amu*angstrom^2'), symmetry=1, barrier=(2.45385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106731,'amu*angstrom^2'), symmetry=1, barrier=(2.45396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1067,'amu*angstrom^2'), symmetry=1, barrier=(2.45325,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35611,0.0506983,-4.07186e-05,1.87001e-08,-3.49068e-12,82440,24.9335], Tmin=(100,'K'), Tmax=(1370.02,'K')), NASAPolynomial(coeffs=[10.6767,0.0214607,-6.49018e-06,9.65436e-10,-5.76292e-14,80076.1,-22.2738], Tmin=(1370.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(684.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([CH2])C[CH2](2401)',
    structure = adjacencyList("""multiplicity 5
1  C u0 p0 c0 {2,S} {3,S} {5,S} {6,S}
...
"""),
    E0 = (684.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,793.263,793.314,2543.74],'cm^-1')),
        HinderedRotor(inertia=(0.0111625,'amu*angstrom^2'), symmetry=1, barrier=(4.98523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183547,'amu*angstrom^2'), symmetry=1, barrier=(81.9582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216822,'amu*angstrom^2'), symmetry=1, barrier=(4.98516,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0120191,'amu*angstrom^2'), symmetry=1, barrier=(81.959,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63994,0.0466573,-2.8013e-05,4.85727e-09,1.38338e-12,82447.8,24.6112], Tmin=(100,'K'), Tmax=(1013.05,'K')), NASAPolynomial(coeffs=[9.82528,0.0239597,-8.652e-06,1.49177e-09,-9.97676e-14,80295.6,-17.4213], Tmin=(1013.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(684.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]CC1CC1(2402)',
    structure = adjacencyList("""multiplicity 2
1  C u0 p0 c0 {2,S} {3,S} {4,S} {6,S}
...
"""),
    ...
    molecularWeight = (69.1249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34284,0.0202276,6.00657e-05,-8.95558e-08,3.49472e-11,23012.3,18.8566], Tmin=(100,'K'), Tmax=(962.586,'K')), NASAPolynomial(coeffs=[11.455,0.0230939,-7.87322e-06,1.4569e-09,-1.07449e-13,19371,-34.5588], Tmin=(962.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.717,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1CCC1(2403)',
    structure = adjacencyList("""multiplicity 2
1  C u0 p0 c0 {2,S} {3,S} {5,S} {6,S}
2  C u0 p0 c0 {1,S} {4,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (69.1249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61536,0.0121054,8.45227e-05,-1.15508e-07,4.45973e-11,22453.3,17.8878], Tmin=(100,'K'), Tmax=(945.073,'K')), NASAPolynomial(coeffs=[11.0213,0.023144,-6.98586e-06,1.23581e-09,-9.12771e-14,18782.7,-33.2049], Tmin=(945.073,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC(=C)C(713)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.231063,'amu*angstrom^2'), symmetry=1, barrier=(5.31258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0234141,'amu*angstrom^2'), symmetry=1, barrier=(10.0831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0234134,'amu*angstrom^2'), symmetry=1, barrier=(10.0833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.1249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79448,0.0415223,-1.15396e-05,-8.3345e-09,4.56317e-12,18086.3,20.5419], Tmin=(100,'K'), Tmax=(1112.89,'K')), NASAPolynomial(coeffs=[9.12304,0.0282516,-1.1269e-05,2.05627e-09,-1.41622e-13,15645.8,-19.2344], Tmin=(1112.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.67,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(=C)CC(2404)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (69.1249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80358,0.0378053,8.87525e-06,-3.53093e-08,1.5373e-11,11625.1,18.3063], Tmin=(100,'K'), Tmax=(996.435,'K')), NASAPolynomial(coeffs=[10.9565,0.0255812,-9.63207e-06,1.76724e-09,-1.24959e-13,8583.9,-31.9261], Tmin=(996.435,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.9224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Allyl_P)"""),
)
...
"""),
    E0 = (627.055,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,1588.31],'cm^-1')),
        HinderedRotor(inertia=(0.00249066,'amu*angstrom^2'), symmetry=1, barrier=(4.45498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193837,'amu*angstrom^2'), symmetry=1, barrier=(4.45669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193228,'amu*angstrom^2'), symmetry=1, barrier=(4.44268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0024774,'amu*angstrom^2'), symmetry=1, barrier=(4.44006,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87791,0.0517317,-6.44055e-05,5.51193e-08,-1.89107e-11,75488.9,24.9777], Tmin=(100,'K'), Tmax=(906.507,'K')), NASAPolynomial(coeffs=[3.21681,0.0333249,-1.3266e-05,2.30019e-09,-1.49394e-13,75759.7,21.4822], Tmin=(906.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(627.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
"""),
    E0 = (421.973,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1836.7],'cm^-1')),
        HinderedRotor(inertia=(0.179905,'amu*angstrom^2'), symmetry=1, barrier=(4.13636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179584,'amu*angstrom^2'), symmetry=1, barrier=(4.12899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179689,'amu*angstrom^2'), symmetry=1, barrier=(4.13141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00172364,'amu*angstrom^2'), symmetry=1, barrier=(4.12783,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.1249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92895,0.0492287,-4.90949e-05,3.92124e-08,-1.4032e-11,50822.6,23.707], Tmin=(100,'K'), Tmax=(829.441,'K')), NASAPolynomial(coeffs=[3.01402,0.0374083,-1.58049e-05,2.87989e-09,-1.94942e-13,50869.2,20.0411], Tmin=(829.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
"""),
    ...
    molecularWeight = (69.1249,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84953,0.0508882,-5.3545e-05,4.23052e-08,-1.42227e-11,50805.9,23.2934], Tmin=(100,'K'), Tmax=(893.203,'K')), NASAPolynomial(coeffs=[3.3995,0.0356615,-1.40597e-05,2.44895e-09,-1.60524e-13,50859.5,17.841], Tmin=(893.203,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])[CH2](716)'],
    products = ['C2H4(29)', '[CH2]C=C(219)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[CH2][CH]C[CH2](60)'],
    products = ['[CH2]CC([CH2])[CH2](716)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', '[CH2]C([CH2])[CH2](2399)'],
    products = ['[CH2]CC([CH2])[CH2](716)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(6)', '[CH]CC([CH2])[CH2](2400)'],
    products = ['[CH2]CC([CH2])[CH2](716)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(6)', '[CH]C([CH2])C[CH2](2401)'],
    products = ['[CH2]CC([CH2])[CH2](716)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Hrad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[CH2]C[C]([CH2])[CH2](2405)'],
    products = ['[CH2]CC([CH2])[CH2](716)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.7979e+07,'m^3/(mol*s)'), n=0.240345, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_N-Sp-3C=2C_Sp-4R!H-2C_Ext-2C-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_N-Sp-3C=2C_Sp-4R!H-2C_Ext-2C-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['H(6)', '[CH2][CH]C([CH2])[CH2](2406)'],
    products = ['[CH2]CC([CH2])[CH2](716)'],
