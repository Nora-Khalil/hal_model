...
"""),
    E0 = (453.79,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,2100,2250,500,550,333.557,341.916],'cm^-1')),
        HinderedRotor(inertia=(0.0713903,'amu*angstrom^2'), symmetry=1, barrier=(5.60217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162182,'amu*angstrom^2'), symmetry=1, barrier=(12.7508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.858664,'amu*angstrom^2'), symmetry=1, barrier=(67.3707,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68309,0.0453314,-2.92101e-05,1.03236e-08,-1.53328e-12,54666.4,22.207], Tmin=(100,'K'), Tmax=(1538.52,'K')), NASAPolynomial(coeffs=[9.74402,0.0243739,-8.77742e-06,1.46984e-09,-9.45989e-14,52186,-20.1552], Tmin=(1538.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(Cs-CtHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Cds_S)"""),
)

species(
    label = 'C#CCC=[C]C(1592)',
    structure = adjacencyList("""multiplicity 2
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]CC=[C]C(1442)'],
    products = ['C#CC(211)', 'C=C=C(430)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(57)', '[CH2]C=[C]C(1189)'],
    products = ['C=[C]CC=[C]C(1442)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C=C(430)', '[CH]=[C]C(212)'],
    products = ['C=[C]CC=[C]C(1442)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['C#CC(211)', '[CH2][C]=C(431)'],
    products = ['C=[C]CC=[C]C(1442)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]=C(431)', '[CH]=[C]C(212)'],
    products = ['C=[C]CC=[C]C(1442)'],
