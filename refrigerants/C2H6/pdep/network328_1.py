...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(57)', '[CH]=C[O](94)'],
    products = ['[CH]=CO[C]=C(475)'],
    transitionState = 'TS2',
