...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25665,0.0525324,-2.34715e-05,3.68225e-10,1.79246e-12,10692.9,22.6022], Tmin=(100,'K'), Tmax=(1230.14,'K')), NASAPolynomial(coeffs=[10.9091,0.032634,-1.32163e-05,2.40216e-09,-1.63758e-13,7448.89,-29.4973], Tmin=(1230.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.0313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (293.278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,540,610,2055,180],'cm^-1')),
        HinderedRotor(inertia=(0.44504,'amu*angstrom^2'), symmetry=1, barrier=(10.2323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215576,'amu*angstrom^2'), symmetry=1, barrier=(4.95652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.682497,'amu*angstrom^2'), symmetry=1, barrier=(15.692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31838,0.0528778,-3.21213e-05,9.70903e-09,-1.19297e-12,35374.6,24.174], Tmin=(100,'K'), Tmax=(1840.37,'K')), NASAPolynomial(coeffs=[13.6702,0.0260314,-1.02399e-05,1.78259e-09,-1.16227e-13,30828.2,-42.9508], Tmin=(1840.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(RCCJ)"""),
)
...
"""),
    E0 = (288.867,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2100,2250,500,550,274.113,2457.93],'cm^-1')),
        HinderedRotor(inertia=(0.191172,'amu*angstrom^2'), symmetry=1, barrier=(10.1931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37998,'amu*angstrom^2'), symmetry=1, barrier=(73.5792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00224356,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38002,'amu*angstrom^2'), symmetry=1, barrier=(73.5792,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5806,0.0477085,-1.76536e-05,-7.22166e-09,5.87981e-12,34834.6,24.0558], Tmin=(100,'K'), Tmax=(954.954,'K')), NASAPolynomial(coeffs=[8.68631,0.0306103,-1.06907e-05,1.80592e-09,-1.19434e-13,32900,-12.9214], Tmin=(954.954,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(288.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C[C]=CC(1311)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (355.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,272.37,2221.17],'cm^-1')),
        HinderedRotor(inertia=(0.00227239,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148424,'amu*angstrom^2'), symmetry=1, barrier=(7.81356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148424,'amu*angstrom^2'), symmetry=1, barrier=(7.81354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14842,'amu*angstrom^2'), symmetry=1, barrier=(7.81359,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
"""),
    E0 = (399.356,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1670,1700,300,440,242.82,242.823],'cm^-1')),
        HinderedRotor(inertia=(0.151923,'amu*angstrom^2'), symmetry=1, barrier=(6.35201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15185,'amu*angstrom^2'), symmetry=1, barrier=(6.35408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152174,'amu*angstrom^2'), symmetry=1, barrier=(6.35345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151836,'amu*angstrom^2'), symmetry=1, barrier=(6.35338,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72335,0.0547482,-3.53283e-05,1.30127e-08,-2.24256e-12,48109.3,23.2486], Tmin=(100,'K'), Tmax=(1196.95,'K')), NASAPolynomial(coeffs=[5.83976,0.0409919,-1.80891e-05,3.41093e-09,-2.37107e-13,47123.9,2.6493], Tmin=(1196.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=CC(210)', '[CH2]C[CH2](51)'],
    products = ['[CH2]CC[C]=CC(1906)'],
    transitionState = 'TS5',
...
reaction(
    ...
    kinetics = Arrhenius(A=(139.199,'m^3/(mol*s)'), n=1.17866, Ea=(29.419,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.074922956820422, var=0.4204517451200674, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_N-1R!H->S_Sp-4R!H-3C_N-2R!H->S_Ext-2CNO-R_Ext-5R!H-R_Sp-2CNO=1CCNNO',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_N-1R!H->S_Sp-4R!H-3C_N-2R!H->S_Ext-2CNO-R_Ext-5R!H-R_Sp-2CNO=1CCNNO
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(6)', '[CH2]CC=C=CC(2458)'],
    products = ['[CH2]CC[C]=CC(1906)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(18)', 'C#CCC[CH2](1453)'],
    products = ['[CH2]CC[C]=CC(1906)'],
