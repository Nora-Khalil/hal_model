...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5393,0.0135141,7.25408e-05,-1.03794e-07,4.03778e-11,8696.21,17.5911], Tmin=(100,'K'), Tmax=(961.94,'K')), NASAPolynomial(coeffs=[13.136,0.0164822,-5.42631e-06,1.06741e-09,-8.43323e-14,4481.54,-44.4309], Tmin=(961.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.7271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=[C]O[C]1CC1(1544)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57314,0.0400649,3.81804e-06,-4.05033e-08,2.01995e-11,45878.2,22.7809], Tmin=(100,'K'), Tmax=(953.299,'K')), NASAPolynomial(coeffs=[16.117,0.0118367,-3.37137e-06,6.13828e-10,-4.76878e-14,41615,-54.5058], Tmin=(953.299,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C2CsJOC(O)) + radical(C=CJO)"""),
)

species(
    label = '[CH2][C]1CC(=C)O1(1545)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.168666,0.0612905,-5.89949e-05,2.79395e-08,-4.86724e-12,38532.5,22.53], Tmin=(100,'K'), Tmax=(1700.95,'K')), NASAPolynomial(coeffs=[16.0404,0.00923581,-9.98393e-08,-2.34992e-10,2.20562e-14,35264,-56.2088], Tmin=(1700.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(C2CsJOC(O)) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1([CH2])OC1=C(1546)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (334.035,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,646.127],'cm^-1')),
        HinderedRotor(inertia=(0.744934,'amu*angstrom^2'), symmetry=1, barrier=(17.1275,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.432489,'amu*angstrom^2'), symmetry=1, barrier=(17.1095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0573743,'amu*angstrom^2'), symmetry=1, barrier=(17.1577,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
...
"""),
    E0 = (414.863,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,395.35,395.353],'cm^-1')),
        HinderedRotor(inertia=(0.0814674,'amu*angstrom^2'), symmetry=1, barrier=(9.03537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0814656,'amu*angstrom^2'), symmetry=1, barrier=(9.03523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0814492,'amu*angstrom^2'), symmetry=1, barrier=(9.03536,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.80021,'amu*angstrom^2'), symmetry=1, barrier=(18.3984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800008,'amu*angstrom^2'), symmetry=1, barrier=(18.3938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800003,'amu*angstrom^2'), symmetry=1, barrier=(18.3936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800385,'amu*angstrom^2'), symmetry=1, barrier=(18.4024,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481112,0.078948,-0.000108823,7.5956e-08,-2.06435e-11,45661.6,21.0657], Tmin=(100,'K'), Tmax=(908.361,'K')), NASAPolynomial(coeffs=[14.4799,0.0173048,-7.03209e-06,1.25054e-09,-8.34308e-14,43118.4,-45.1253], Tmin=(908.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)O[C]=C(1318)'],
    products = ['CH2CO(27)', 'C=C=C(430)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(57)', '[CH2]C(=C)[O](569)'],
    products = ['[CH2]C(=C)O[C]=C(1318)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'C=[C]O[C]=C(629)'],
    products = ['[CH2]C(=C)O[C]=C(1318)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)O[C]=C(1318)'],
    products = ['[CH2]C1([CH2])OC1=C(1546)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CO(27)', '[CH2][C]=C(431)'],
    products = ['[CH2]C(=C)O[C]=C(1318)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]=O(167)', 'C=C=C(430)'],
    products = ['[CH2]C(=C)O[C]=C(1318)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'C#COC([CH2])=C(1547)'],
    products = ['[CH2]C(=C)O[C]=C(1318)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]=O(167)', '[CH2][C]=C(431)'],
    products = ['[CH2]C(=C)O[C]=C(1318)'],
