...
"""),
    E0 = (503.733,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2782.5,750,1395,475,1775,1000,2950,3100,1380,975,1025,1650,540,610,2055,180,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.261561,'amu*angstrom^2'), symmetry=1, barrier=(6.01379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262402,'amu*angstrom^2'), symmetry=1, barrier=(6.03313,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12233,0.0506604,-9.6194e-05,9.8524e-08,-3.76476e-11,60643.7,5.69887], Tmin=(100,'K'), Tmax=(844.102,'K')), NASAPolynomial(coeffs=[2.71934,0.0260073,-1.36026e-05,2.66402e-09,-1.84788e-13,61320.4,7.5252], Tmin=(844.102,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(503.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C[C][C-]=[O+]C=O(4403)',
    structure = adjacencyList("""1  O u0 p1 c+1 {4,S} {6,D}
2  O u0 p2 c0 {4,D}
3  C u0 p0 c0 {5,S} {7,S} {8,S} {9,S}
4  C u0 p0 c0 {1,S} {2,D} {10,S}
5  C u0 p1 c0 {3,S} {6,S}
6  C u0 p1 c-1 {1,D} {5,S}
7  H u0 p0 c0 {3,S}
8  H u0 p0 c0 {3,S}
9  H u0 p0 c0 {3,S}
10 H u0 p0 c0 {4,S}
"""),
    E0 = (698.595,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,180,180,180,180,2592.3,2593.15],'cm^-1')),
        HinderedRotor(inertia=(0.204277,'amu*angstrom^2'), symmetry=1, barrier=(4.69673,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204325,'amu*angstrom^2'), symmetry=1, barrier=(4.69784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204441,'amu*angstrom^2'), symmetry=1, barrier=(4.70051,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83034,0.0613733,-0.000122353,1.29351e-07,-4.99015e-11,84086.6,18.0054], Tmin=(100,'K'), Tmax=(860.844,'K')), NASAPolynomial(coeffs=[0.295857,0.0350404,-1.81602e-05,3.50395e-09,-2.39964e-13,85590.7,32.3801], Tmin=(860.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(698.595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(CsJ2_singlet-CsH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C[C-]=[O+]C=O(4404)',
    structure = adjacencyList("""1  O u0 p1 c+1 {4,S} {5,D}
2  O u0 p2 c0 {4,D}
3  C u0 p0 c0 {5,S} {6,S} {7,S} {8,S}
4  C u0 p0 c0 {1,S} {2,D} {9,S}
5  C u0 p1 c-1 {1,D} {3,S}
6  C u0 p1 c0 {3,S} {10,S}
7  H u0 p0 c0 {3,S}
8  H u0 p0 c0 {3,S}
9  H u0 p0 c0 {4,S}
10 H u0 p0 c0 {6,S}
"""),
    E0 = (721.031,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,180.327,579.968,612.36,1352.97,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.346417,'amu*angstrom^2'), symmetry=1, barrier=(7.97628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346417,'amu*angstrom^2'), symmetry=1, barrier=(7.97628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346417,'amu*angstrom^2'), symmetry=1, barrier=(7.97628,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86987,0.0599986,-0.000121742,1.28426e-07,-4.94957e-11,86784.1,8.70614], Tmin=(100,'K'), Tmax=(855.925,'K')), NASAPolynomial(coeffs=[0.986147,0.0322034,-1.70826e-05,3.3307e-09,-2.29455e-13,88104.8,19.6635], Tmin=(855.925,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(721.031,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cds-CdsCsCs) + group(CsJ2_singlet-CsH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C[C-]=[O+]C=O(3095)'],
    products = ['CO2(15)', '[C]=CC-2(2032)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.1009e+10,'s^-1'), n=0, Ea=(26.6395,'kJ/mol'), T0=(1,'K'), Tmin=(725,'K'), Tmax=(810,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R!H->C_N-2R!H->C_N-2NOS->S_2NO->O',), comment="""Estimated from node Root_1R!H->C_N-2R!H->C_N-2NOS->S_2NO->O"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(14)', 'C=C[C-]=[OH+](4327)'],
    products = ['C=C[C-]=[O+]C=O(3095)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.27e-07,'m^3/(mol*s)'), n=3.7, Ea=(329.457,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->H_1COCbCdCtHNOSSidSis->O',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->H_1COCbCdCtHNOSSidSis->O"""),
)

reaction(
    label = 'reaction3',
    reactants = ['C=C=[C-][OH+]C=O(4402)'],
    products = ['C=C[C-]=[O+]C=O(3095)'],
    transitionState = 'TS3',
