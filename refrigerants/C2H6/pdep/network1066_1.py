...
"""),
    E0 = (280.418,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,1117.05],'cm^-1')),
        HinderedRotor(inertia=(0.937981,'amu*angstrom^2'), symmetry=1, barrier=(21.566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179739,'amu*angstrom^2'), symmetry=1, barrier=(4.13256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.935881,'amu*angstrom^2'), symmetry=1, barrier=(21.5178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00465485,'amu*angstrom^2'), symmetry=1, barrier=(4.15803,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (338.275,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,3819.42,3819.86],'cm^-1')),
        HinderedRotor(inertia=(0.918958,'amu*angstrom^2'), symmetry=1, barrier=(21.1286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.919173,'amu*angstrom^2'), symmetry=1, barrier=(21.1336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.7837,'amu*angstrom^2'), symmetry=1, barrier=(86.9948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127238,'amu*angstrom^2'), symmetry=1, barrier=(87.0122,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28274,0.0511641,-1.42784e-05,-1.45056e-08,8.61939e-12,40790.4,27.6428], Tmin=(100,'K'), Tmax=(1000.13,'K')), NASAPolynomial(coeffs=[11.0728,0.0305554,-1.11857e-05,1.97482e-09,-1.35045e-13,37904.6,-24.2273], Tmin=(1000.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.275,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38271,0.0137141,9.9909e-05,-1.32781e-07,4.97155e-11,-2480.2,16.3217], Tmin=(100,'K'), Tmax=(970.879,'K')), NASAPolynomial(coeffs=[11.9074,0.0299218,-1.07999e-05,2.06379e-09,-1.5423e-13,-6942.99,-42.8064], Tmin=(970.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.2689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclohexene)"""),
)
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2361,0.0520915,-1.85105e-05,-6.93398e-09,4.74728e-12,12167.3,23.1083], Tmin=(100,'K'), Tmax=(1116.38,'K')), NASAPolynomial(coeffs=[11.1605,0.0322567,-1.29876e-05,2.38475e-09,-1.64938e-13,8971.52,-30.2524], Tmin=(1116.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = '[CH2]CCC1[CH]C1(1903)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7722,0.0366347,2.43808e-05,-5.05559e-08,1.99111e-11,47339.9,25.4982], Tmin=(100,'K'), Tmax=(1014.62,'K')), NASAPolynomial(coeffs=[10.3295,0.0323055,-1.2694e-05,2.37046e-09,-1.68437e-13,44089.7,-23.3694], Tmin=(1014.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(392.85,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1[CH]CCC1(1892)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44382,0.0152186,8.90153e-05,-1.20563e-07,4.59622e-11,33163.6,23.4964], Tmin=(100,'K'), Tmax=(951.813,'K')), NASAPolynomial(coeffs=[10.4689,0.0296654,-9.66867e-06,1.73008e-09,-1.25377e-13,29453.9,-26.2866], Tmin=(951.813,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(275.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][CH]C1CCC1(1904)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {5,S} {7,S}
2  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09963,0.0256467,5.80952e-05,-8.52575e-08,3.18782e-11,43027,24.546], Tmin=(100,'K'), Tmax=(998.748,'K')), NASAPolynomial(coeffs=[10.4112,0.0326162,-1.28342e-05,2.4466e-09,-1.77629e-13,39358.9,-25.5939], Tmin=(998.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_S) + radical(RCCJ)"""),
)
...
"""),
    E0 = (305.523,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,540,610,2055,180,1135.25],'cm^-1')),
        HinderedRotor(inertia=(0.224921,'amu*angstrom^2'), symmetry=1, barrier=(5.17138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.697201,'amu*angstrom^2'), symmetry=1, barrier=(16.03,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.695822,'amu*angstrom^2'), symmetry=1, barrier=(15.9983,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
...
"""),
    E0 = (269.618,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,308.68,1832.03],'cm^-1')),
        HinderedRotor(inertia=(0.103604,'amu*angstrom^2'), symmetry=1, barrier=(7.02472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00877016,'amu*angstrom^2'), symmetry=1, barrier=(20.8856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104095,'amu*angstrom^2'), symmetry=1, barrier=(7.02997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77168,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39226,0.0501127,-1.98029e-05,-1.40072e-09,2.06982e-12,32527.3,26.5158], Tmin=(100,'K'), Tmax=(1234.79,'K')), NASAPolynomial(coeffs=[9.73644,0.0340488,-1.36106e-05,2.44847e-09,-1.657e-13,29630.6,-18.8852], Tmin=(1234.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]CCC=[C]C(1309)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (366.761,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,192.357,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00455653,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07338,'amu*angstrom^2'), symmetry=1, barrier=(28.1795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.508514,'amu*angstrom^2'), symmetry=1, barrier=(13.3504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262904,'amu*angstrom^2'), symmetry=1, barrier=(6.90149,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55824,0.0537472,-3.11533e-05,8.99328e-09,-1.07944e-12,44198.1,25.1434], Tmin=(100,'K'), Tmax=(1788.85,'K')), NASAPolynomial(coeffs=[10.9605,0.0327231,-1.35241e-05,2.42324e-09,-1.61251e-13,40834.2,-25.6853], Tmin=(1788.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=C[CH]CC(1905)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44247,0.0442315,9.44513e-06,-3.84923e-08,1.63444e-11,26115.5,22.4839], Tmin=(100,'K'), Tmax=(1019.33,'K')), NASAPolynomial(coeffs=[11.6914,0.0315515,-1.242e-05,2.31228e-09,-1.63786e-13,22595.5,-34.1753], Tmin=(1019.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]CC[C]=CC(1906)',
    structure = adjacencyList("""multiplicity 3
...
species(
    label = '[CH2]C=[C]CCC(1907)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {6,S} {9,S} {10,S}
3  C u0 p0 c0 {1,S} {11,S} {12,S} {13,S}
4  C u0 p0 c0 {5,S} {6,D} {14,S}
5  C u1 p0 c0 {4,S} {15,S} {16,S}
6  C u1 p0 c0 {2,S} {4,D}
7  H u0 p0 c0 {1,S}
8  H u0 p0 c0 {1,S}
9  H u0 p0 c0 {2,S}
...
"""),
    E0 = (313.013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,192.802,1250.67],'cm^-1')),
        HinderedRotor(inertia=(0.273849,'amu*angstrom^2'), symmetry=1, barrier=(7.34845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00553817,'amu*angstrom^2'), symmetry=1, barrier=(0.134763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.7905,'amu*angstrom^2'), symmetry=1, barrier=(18.858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.730475,'amu*angstrom^2'), symmetry=1, barrier=(18.8818,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13269,0.0548743,-2.66111e-05,1.41326e-09,1.88265e-12,37756.8,25.1828], Tmin=(100,'K'), Tmax=(1179.64,'K')), NASAPolynomial(coeffs=[11.4983,0.0318644,-1.27871e-05,2.32368e-09,-1.58947e-13,34466.7,-30.1175], Tmin=(1179.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C[CH]C=CC(1908)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.135315,'amu*angstrom^2'), symmetry=1, barrier=(3.11115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133667,'amu*angstrom^2'), symmetry=1, barrier=(3.07328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133435,'amu*angstrom^2'), symmetry=1, barrier=(3.06794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133513,'amu*angstrom^2'), symmetry=1, barrier=(3.06973,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80558,0.0490136,-2.40298e-05,5.39389e-09,-4.72015e-13,38969.5,26.5298], Tmin=(100,'K'), Tmax=(2579.79,'K')), NASAPolynomial(coeffs=[18.9745,0.022393,-8.55148e-06,1.39402e-09,-8.43993e-14,30111.1,-72.5713], Tmin=(2579.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(323.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C=CC1CCC1(1888)',
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18287,0.0180465,9.09705e-05,-1.27226e-07,4.87978e-11,10443.4,20.4117], Tmin=(100,'K'), Tmax=(963.658,'K')), NASAPolynomial(coeffs=[13.3451,0.0270839,-9.28409e-06,1.75624e-09,-1.32145e-13,5721.15,-46.3658], Tmin=(963.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.1229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33939,0.0449407,1.23904e-05,-4.71832e-08,2.10596e-11,4347.53,22.263], Tmin=(100,'K'), Tmax=(977.76,'K')), NASAPolynomial(coeffs=[13.6767,0.0268897,-9.65482e-06,1.76045e-09,-1.2562e-13,385.191,-44.905], Tmin=(977.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.2502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48891,0.044133,5.49843e-06,-3.28724e-08,1.41068e-11,7761.35,23.363], Tmin=(100,'K'), Tmax=(1029.51,'K')), NASAPolynomial(coeffs=[11.1943,0.0314218,-1.24028e-05,2.30465e-09,-1.6263e-13,4438.27,-30.1758], Tmin=(1029.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = '[CH]1[CH]CCCC1(1910)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {4,S} {9,S} {10,S}
3  C u0 p0 c0 {1,S} {5,S} {11,S} {12,S}
4  C u0 p0 c0 {2,S} {6,S} {13,S} {14,S}
5  C u1 p0 c0 {3,S} {6,S} {15,S}
...
"""),
    E0 = (240.497,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,358.343,358.343],'cm^-1')),
        HinderedRotor(inertia=(0.16237,'amu*angstrom^2'), symmetry=1, barrier=(14.7956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16237,'amu*angstrom^2'), symmetry=1, barrier=(14.7956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16237,'amu*angstrom^2'), symmetry=1, barrier=(14.7956,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
"""),
    E0 = (335.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1233.89,1234.57,1234.63],'cm^-1')),
        HinderedRotor(inertia=(0.219307,'amu*angstrom^2'), symmetry=1, barrier=(5.0423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219351,'amu*angstrom^2'), symmetry=1, barrier=(5.04331,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219315,'amu*angstrom^2'), symmetry=1, barrier=(5.04247,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219034,'amu*angstrom^2'), symmetry=1, barrier=(5.03602,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79142,0.0492494,-2.42329e-05,5.42153e-09,-4.70612e-13,40444.5,26.8525], Tmin=(100,'K'), Tmax=(2628.39,'K')), NASAPolynomial(coeffs=[20.5878,0.0206453,-7.90938e-06,1.28136e-09,-7.68332e-14,30563.3,-81.9939], Tmin=(2628.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC[C]=C(1536)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {4,S} {9,S} {10,S}
...
"""),
    E0 = (379.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,313.791,1740.82,4000],'cm^-1')),
        HinderedRotor(inertia=(0.132324,'amu*angstrom^2'), symmetry=1, barrier=(9.21581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.363906,'amu*angstrom^2'), symmetry=1, barrier=(25.2707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.361978,'amu*angstrom^2'), symmetry=1, barrier=(25.2721,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132362,'amu*angstrom^2'), symmetry=1, barrier=(9.21661,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2946,0.0558943,-3.40837e-05,1.04874e-08,-1.33183e-12,45683.8,26.5422], Tmin=(100,'K'), Tmax=(1749.52,'K')), NASAPolynomial(coeffs=[12.424,0.0304487,-1.22672e-05,2.17408e-09,-1.43891e-13,41789.6,-33.3759], Tmin=(1749.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH]CCC=C(444)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {4,S} {9,S} {10,S}
...
"""),
    E0 = (335.61,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,1196.04,1199.05],'cm^-1')),
        HinderedRotor(inertia=(0.132075,'amu*angstrom^2'), symmetry=1, barrier=(3.03667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130695,'amu*angstrom^2'), symmetry=1, barrier=(3.00493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130601,'amu*angstrom^2'), symmetry=1, barrier=(3.00277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131121,'amu*angstrom^2'), symmetry=1, barrier=(3.01473,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19509,0.0523846,-9.07569e-06,-1.60276e-08,7.40992e-12,35511.7,25.311], Tmin=(100,'K'), Tmax=(1109.35,'K')), NASAPolynomial(coeffs=[9.92536,0.0391644,-1.58884e-05,2.90297e-09,-1.9973e-13,32451.2,-22.7773], Tmin=(1109.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C=CCC[CH2](1836)'],
    products = ['C2H4(29)', 'C=CC=C(61)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]C=CC[CH2](1193)'],
    products = ['[CH2]C=CCC[CH2](1836)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', '[CH2]C=CC[CH2](1193)'],
    products = ['[CH2]C=CCC[CH2](1836)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(17)', '[CH]=CCC[CH2](386)'],
    products = ['[CH2]C=CCC[CH2](1836)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', '[CH2]CCC=C=C(1159)'],
    products = ['[CH2]C=CCC[CH2](1836)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH2](39)', '[CH2]C=C[CH2](74)'],
    products = ['[CH2]C=CCC[CH2](1836)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C=C(1759)', '[CH2]C[CH2](51)'],
    products = ['[CH2]C=CCC[CH2](1836)'],
