...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', 'C[C]=C[C]=O(1286)'],
    products = ['C[C]=CC([O])=O(1173)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(803)', '[CH]=[C]C(212)'],
    products = ['C[C]=CC([O])=O(1173)'],
