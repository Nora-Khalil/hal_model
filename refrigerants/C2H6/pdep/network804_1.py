...
"""),
    E0 = (520.357,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,649.386,649.587,649.64],'cm^-1')),
        HinderedRotor(inertia=(0.823845,'amu*angstrom^2'), symmetry=1, barrier=(18.9418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171263,'amu*angstrom^2'), symmetry=1, barrier=(3.93767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.823839,'amu*angstrom^2'), symmetry=1, barrier=(18.9417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63014,'amu*angstrom^2'), symmetry=1, barrier=(37.4801,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.997899,0.0568976,-2.88423e-05,-1.965e-09,4.48869e-12,62700.5,23.3492], Tmin=(100,'K'), Tmax=(1050.07,'K')), NASAPolynomial(coeffs=[13.3638,0.0269202,-1.04869e-05,1.91482e-09,-1.33202e-13,59159.2,-41.4094], Tmin=(1050.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(520.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(=C)C[CH]C(2229)',
    structure = adjacencyList("""multiplicity 4
1  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4528,0.0539888,-2.77267e-05,6.78588e-09,-6.69261e-13,58517.8,26.0707], Tmin=(100,'K'), Tmax=(2198.34,'K')), NASAPolynomial(coeffs=[14.117,0.0309453,-1.20031e-05,2.01749e-09,-1.26983e-13,52949.9,-45.0021], Tmin=(2198.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(485.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJC) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C=C1CC(C)C1(2744)',
...
"""),
    E0 = (601.594,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1340.58,1343.07],'cm^-1')),
        HinderedRotor(inertia=(0.164988,'amu*angstrom^2'), symmetry=1, barrier=(3.79339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00304228,'amu*angstrom^2'), symmetry=1, barrier=(3.85216,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164374,'amu*angstrom^2'), symmetry=1, barrier=(3.77928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00305444,'amu*angstrom^2'), symmetry=1, barrier=(3.8608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166081,'amu*angstrom^2'), symmetry=1, barrier=(3.81852,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51849,0.0570924,-5.08667e-05,3.46635e-08,-1.09221e-11,72442,30.8849], Tmin=(100,'K'), Tmax=(846.249,'K')), NASAPolynomial(coeffs=[4.26791,0.0408431,-1.62976e-05,2.88726e-09,-1.92545e-13,72093.2,18.7679], Tmin=(846.249,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(601.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJC) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = 'C[CH]C[C]1CC1(2801)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (352.509,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,750.887],'cm^-1')),
        HinderedRotor(inertia=(0.0118447,'amu*angstrom^2'), symmetry=1, barrier=(4.74047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0715567,'amu*angstrom^2'), symmetry=1, barrier=(28.6407,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24567,'amu*angstrom^2'), symmetry=1, barrier=(28.6405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204005,'amu*angstrom^2'), symmetry=1, barrier=(81.6436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34396,0.045788,5.40262e-06,-3.82383e-08,1.74256e-11,42503.8,21.6292], Tmin=(100,'K'), Tmax=(994.057,'K')), NASAPolynomial(coeffs=[13.3829,0.0267031,-1.01004e-05,1.86964e-09,-1.33415e-13,38659.8,-43.676], Tmin=(994.057,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_P) + radical(Allyl_P)"""),
)

species(
    label = '[CH2][CH]CC([CH2])=C(2595)',
    structure = adjacencyList("""multiplicity 4
1  C u0 p0 c0 {2,S} {3,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {4,S} {5,D}
...
"""),
    E0 = (471.835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,180,1119.41],'cm^-1')),
        HinderedRotor(inertia=(0.160837,'amu*angstrom^2'), symmetry=1, barrier=(3.69795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00418087,'amu*angstrom^2'), symmetry=1, barrier=(3.71951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161498,'amu*angstrom^2'), symmetry=1, barrier=(3.71316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0641986,'amu*angstrom^2'), symmetry=1, barrier=(57.144,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)C[CH]C(2232)'],
    products = ['C=C=C(2022)', 'C=CC(74)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(=C)C([CH2])C(2190)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C(38)', '[CH2]C([CH2])=C(2698)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(18)', '[CH]CC([CH2])=C(2699)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(17)', 'C=[C]C[CH]C(802)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[CH2]C(=C)C[C]C(2799)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH]C(=C)C[CH]C(2229)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Hrad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([CH2])[CH][CH]C(2800)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C]=C(2373)', 'C=CC(74)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH2]C(=C)C=CC(2599)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[CH2]C(=C)CC=C(2688)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=C=C(2022)', '[CH2][CH]C(217)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][C]=C(2373)', '[CH2][CH]C(217)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(6)', '[CH2]C([CH2])=C[CH]C(2607)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(6)', '[CH2][CH]CC([CH2])=C(2595)'],
    products = ['[CH2]C(=C)C[CH]C(2232)'],
