...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(57)', '[CH]C(=C)C(1184)'],
    products = ['[CH]=C(C)C[C]=C(1443)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(18)', 'C#CC[C]=C(1474)'],
    products = ['[CH]=C(C)C[C]=C(1443)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[CH]=C(C)CC#C(1584)'],
    products = ['[CH]=C(C)C[C]=C(1443)'],
