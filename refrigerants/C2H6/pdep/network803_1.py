...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(17)', '[CH]C(C)=C=C(1215)'],
    products = ['[CH]=C(C)C([CH2])=C(1359)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(C)C([CH2])=C(1359)'],
    products = ['[CH2]C1=C(C)[CH]C1(1589)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(C)C([CH2])=C(1359)'],
    products = ['[CH2]C1([CH2])C=C1C(1590)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(18)', 'C#CC([CH2])=C(1482)'],
    products = ['[CH]=C(C)C([CH2])=C(1359)'],
