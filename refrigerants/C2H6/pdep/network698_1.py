...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25023,0.0422183,-2.96348e-05,1.21413e-08,-2.32494e-12,-855.642,18.4018], Tmin=(100,'K'), Tmax=(1109.91,'K')), NASAPolynomial(coeffs=[5.49728,0.0305164,-1.38201e-05,2.64226e-09,-1.85353e-13,-1576.43,2.39806], Tmin=(1109.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.61157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'C=C=CCC=O(1169)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.486857,'amu*angstrom^2'), symmetry=1, barrier=(11.1938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.485223,'amu*angstrom^2'), symmetry=1, barrier=(11.1562,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9314,0.0502943,-6.72327e-05,5.93436e-08,-2.17228e-11,27760.1,20.0137], Tmin=(100,'K'), Tmax=(801.953,'K')), NASAPolynomial(coeffs=[4.43789,0.0298094,-1.39853e-05,2.66603e-09,-1.84676e-13,27614.8,10.075], Tmin=(801.953,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.013174,'amu*angstrom^2'), symmetry=1, barrier=(5.16603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.793412,'amu*angstrom^2'), symmetry=1, barrier=(18.2421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0630722,'amu*angstrom^2'), symmetry=1, barrier=(23.8886,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23279,0.0308119,2.77667e-06,-2.38927e-08,1.086e-11,22263.3,21.1166], Tmin=(100,'K'), Tmax=(999.426,'K')), NASAPolynomial(coeffs=[9.84641,0.0188929,-7.17991e-06,1.3231e-09,-9.37789e-14,19814.8,-20.2459], Tmin=(999.426,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CtHH) + group(Cs-CtHHH) + group(Cds-OdCsH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCCJ=O)"""),
)

species(
    label = 'C[C]=CC=C[O](1299)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
2  C u0 p0 c0 {6,S} {7,S} {8,S} {9,S}
3  C u0 p0 c0 {4,S} {5,D} {10,S}
...
"""),
    E0 = (346.519,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,1670,1700,300,440,278.91],'cm^-1')),
        HinderedRotor(inertia=(0.230428,'amu*angstrom^2'), symmetry=1, barrier=(12.7215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00216683,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.230453,'amu*angstrom^2'), symmetry=1, barrier=(12.7214,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.39125,0.0395101,-2.08292e-05,4.14444e-09,-2.42873e-13,41730.7,20.209], Tmin=(100,'K'), Tmax=(2118.32,'K')), NASAPolynomial(coeffs=[19.5198,0.0137906,-7.3078e-06,1.36528e-09,-8.91046e-14,32987.7,-78.7918], Tmin=(2118.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C=C[C]=O(1303)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {6,D}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(152)', '[CH2]C=[C]C(1189)'],
    products = ['C[C]=CC[C]=O(1164)'],
    transitionState = 'TS3',
