...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32421,0.0226355,3.29293e-05,-6.37263e-08,2.7167e-11,13749,20.8764], Tmin=(100,'K'), Tmax=(951.765,'K')), NASAPolynomial(coeffs=[13.9375,0.00948744,-2.54902e-06,4.89881e-10,-4.08179e-14,9923.25,-43.0617], Tmin=(951.765,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclopropane) + radical(CCJCO) + radical((O)CJOCC2)"""),
)

species(
    label = 'O=[C]O[CH]C1CC1(2337)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (90.7367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3025,407.5,1350,352.5,1855,455,950,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12067,0.0486901,-3.80189e-06,-3.9228e-08,2.10398e-11,11030.1,24.8078], Tmin=(100,'K'), Tmax=(948.679,'K')), NASAPolynomial(coeffs=[18.3765,0.0121239,-3.209e-06,5.6813e-10,-4.44866e-14,6127.48,-66.1161], Tmin=(948.679,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.7367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Cyclopropane) + radical(CCsJOC(O)H) + radical((O)CJOCC)"""),
)
...
"""),
    E0 = (86.0648,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3100,440,815,1455,1000,1855,455,950,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.88602,0.00621909,8.18893e-05,-1.10736e-07,4.26786e-11,32730.5,17.8325], Tmin=(100,'K'), Tmax=(952.307,'K')), NASAPolynomial(coeffs=[12.0159,0.014373,-4.20099e-06,8.09161e-10,-6.53679e-14,28883,-36.8388], Tmin=(952.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(CCJCO)"""),
)
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72698,0.0344118,2.70919e-05,-5.96269e-08,2.46445e-11,-23675.8,21.4257], Tmin=(100,'K'), Tmax=(998.609,'K')), NASAPolynomial(coeffs=[14.5941,0.020423,-8.30094e-06,1.65712e-09,-1.24949e-13,-28118,-50.0075], Tmin=(998.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-197.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdOsH) + ring(Cyclobutene)"""),
)

species(
    label = 'O=COC1C=CC1(2317)',
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16594,0.020543,6.75355e-05,-1.0093e-07,3.90131e-11,-21491.4,22.1667], Tmin=(100,'K'), Tmax=(982.796,'K')), NASAPolynomial(coeffs=[14.3505,0.0205037,-8.03371e-06,1.63358e-09,-1.26589e-13,-26279.5,-48.58], Tmin=(982.796,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdOsH) + ring(Cyclobutene)"""),
)
...
"""),
    E0 = (48.8244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,1855,455,950,254.848,262.335,773.655],'cm^-1')),
        HinderedRotor(inertia=(0.423201,'amu*angstrom^2'), symmetry=1, barrier=(19.523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.408123,'amu*angstrom^2'), symmetry=1, barrier=(19.5145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417303,'amu*angstrom^2'), symmetry=1, barrier=(19.5343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.619432,'amu*angstrom^2'), symmetry=1, barrier=(28.0434,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583562,0.0657868,-6.04511e-05,2.76772e-08,-4.96717e-12,6003.07,26.5295], Tmin=(100,'K'), Tmax=(1356.34,'K')), NASAPolynomial(coeffs=[17.13,0.0169892,-6.48476e-06,1.15161e-09,-7.79586e-14,1514.56,-58.3408], Tmin=(1356.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.8244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(RCCJ) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-1.19858,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1855,455,950,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5152,0.0422121,-1.1793e-06,-3.10757e-08,1.51475e-11,-43.701,20.8127], Tmin=(100,'K'), Tmax=(1000.66,'K')), NASAPolynomial(coeffs=[14.8862,0.0174037,-6.92384e-06,1.3544e-09,-1.00768e-13,-4153.57,-50.8683], Tmin=(1000.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.19858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdOsH) + ring(Cyclobutene) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C]OC1C=CC1(2340)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {3,S} {7,S}
2  O u0 p2 c0 {7,D}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (97.0919,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8685,0.0301927,3.431e-05,-6.99791e-08,2.95953e-11,1999.64,22.619], Tmin=(100,'K'), Tmax=(968.186,'K')), NASAPolynomial(coeffs=[15.6924,0.0142876,-4.89099e-06,9.73781e-10,-7.69296e-14,-2608.56,-53.6007], Tmin=(968.186,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.8628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdOsH) + ring(Cyclobutene) + radical((O)CJOCC2)"""),
)

species(
    label = 'O=[C]O[C]1CCC1(2341)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {6,S} {7,S}
2  O u0 p2 c0 {7,D}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
4  C u0 p0 c0 {3,S} {6,S} {11,S} {12,S}
5  C u0 p0 c0 {3,S} {6,S} {10,S} {13,S}
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57171,0.0425097,-3.32063e-06,-2.65348e-08,1.31643e-11,10359,24.2816], Tmin=(100,'K'), Tmax=(998.222,'K')), NASAPolynomial(coeffs=[13.2436,0.0206313,-7.8495e-06,1.47094e-09,-1.06032e-13,6788.54,-38.2198], Tmin=(998.222,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.3223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclobutane) + radical(C2CsJOC(O)H) + radical((O)CJOCC2)"""),
)

species(
    label = 'O=[C]OC1C[CH]C1(2342)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {7,S}
2  O u0 p2 c0 {7,D}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85725,0.0350992,1.54386e-05,-4.18408e-08,1.72662e-11,8920.8,24.6642], Tmin=(100,'K'), Tmax=(1018.9,'K')), NASAPolynomial(coeffs=[11.8629,0.0240492,-9.85324e-06,1.89986e-09,-1.38046e-13,5416.47,-30.9857], Tmin=(1018.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclobutane) + radical(cyclobutane) + radical((O)CJOCC2)"""),
)

species(
    label = 'O=CO[C]1[CH]CC1(2343)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {5,S} {7,S}
2  O u0 p2 c0 {7,D}
3  C u0 p0 c0 {4,S} {5,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06769,0.0276062,3.86294e-05,-6.70296e-08,2.64127e-11,10904.3,26.3059], Tmin=(100,'K'), Tmax=(995.144,'K')), NASAPolynomial(coeffs=[12.3666,0.0227177,-9.03127e-06,1.76442e-09,-1.31049e-13,7046.82,-32.4127], Tmin=(995.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.9755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclobutane) + radical(C2CsJOC(O)H) + radical(CCJCO)"""),
)

species(
    label = 'O=COC1[CH]C[CH]1(2344)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {7,S}
2  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38033,0.0144636,8.38474e-05,-1.17329e-07,4.48201e-11,10921,26.045], Tmin=(100,'K'), Tmax=(974.345,'K')), NASAPolynomial(coeffs=[13.9343,0.0204589,-7.63431e-06,1.5431e-09,-1.2053e-13,6133.44,-42.4101], Tmin=(974.345,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.1598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclobutane) + radical(CCJCO) + radical(CCJCO)"""),
)

species(
    label = 'O=COC1[CH][CH]C1(2345)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {7,S}
2  O u0 p2 c0 {7,D}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35736,0.0201486,5.75442e-05,-8.25203e-08,3.05845e-11,9465.97,25.9804], Tmin=(100,'K'), Tmax=(1009.14,'K')), NASAPolynomial(coeffs=[10.9561,0.026185,-1.1063e-05,2.19987e-09,-1.63599e-13,5687.68,-25.7033], Tmin=(1009.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.0961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclobutane) + radical(CCJCO) + radical(cyclobutane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', 'O=[C]OC1[CH]C1(2336)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(152)', '[O]C1[CH]CC1(2225)'],
    products = ['O=[C]OC1[CH]CC1(1998)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['CO(14)', '[O]C1[CH]CC1(2225)'],
    products = ['O=[C]OC1[CH]CC1(1998)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.06778e+14,'m^3/(mol*s)'), n=-2.06969, Ea=(146.129,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.21909771748945858, var=15.050572460742625, Tref=1000.0, N=2985, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]OC1[CH]CC1(1998)'],
    products = ['O=COC1[CH]C[CH]1(2344)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O=[C]OC1[CH]CC1(1998)'],
    products = ['O=COC1[CH][CH]C1(2345)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(2.61952e+06,'s^-1'), n=1.75082, Ea=(81.3302,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_SSSS_OCC;Y_rad_out;XH_out] for rate rule [R5H_SSSS_OCC;CO_rad_out;XH_out]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
