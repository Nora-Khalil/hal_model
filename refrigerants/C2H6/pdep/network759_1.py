...
"""),
    E0 = (301.169,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.00481878,'amu*angstrom^2'), symmetry=1, barrier=(4.63032,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.90884,'amu*angstrom^2'), symmetry=1, barrier=(20.896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0274908,'amu*angstrom^2'), symmetry=1, barrier=(26.279,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84043,0.0385412,-1.57317e-06,-2.30793e-08,1.0955e-11,36307.8,19.9607], Tmin=(100,'K'), Tmax=(1006.87,'K')), NASAPolynomial(coeffs=[10.7549,0.0232795,-8.85963e-06,1.62371e-09,-1.14276e-13,33491.2,-28.1803], Tmin=(1006.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(Allyl_P)"""),
)
...
"""),
    E0 = (544.138,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,404.216,404.989,405.074,406.056],'cm^-1')),
        HinderedRotor(inertia=(0.00102053,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00103655,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00102633,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.109,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75539,0.0408163,-1.0515e-05,-1.57419e-08,9.01602e-12,65533,19.483], Tmin=(100,'K'), Tmax=(995.951,'K')), NASAPolynomial(coeffs=[11.7767,0.0196301,-7.31566e-06,1.33372e-09,-9.40665e-14,62591.5,-33.5694], Tmin=(995.951,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(544.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(=C)C[CH2](2093)',
    structure = adjacencyList("""multiplicity 4
1  C u0 p0 c0 {2,S} {3,S} {6,S} {7,S}
...
"""),
    E0 = (520.354,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,525.138,525.144,525.15,525.153],'cm^-1')),
        HinderedRotor(inertia=(0.266574,'amu*angstrom^2'), symmetry=1, barrier=(52.1676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266565,'amu*angstrom^2'), symmetry=1, barrier=(52.1677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266564,'amu*angstrom^2'), symmetry=1, barrier=(52.1677,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.109,'amu'),
...
"""),
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69524,0.0150131,5.93539e-05,-7.98929e-08,2.92892e-11,14012.3,14.2564], Tmin=(100,'K'), Tmax=(993.368,'K')), NASAPolynomial(coeffs=[8.42294,0.026567,-1.03656e-05,1.97845e-09,-1.44158e-13,11166.4,-21.9353], Tmin=(993.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83927,0.0369285,6.80717e-06,-3.55172e-08,1.64537e-11,6862.32,16.351], Tmin=(100,'K'), Tmax=(967.483,'K')), NASAPolynomial(coeffs=[12.0177,0.0203482,-7.02489e-06,1.25891e-09,-8.94191e-14,3699.33,-38.5855], Tmin=(967.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.3306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = '[CH2][CH]C([CH2])[CH2](2406)',
...
"""),
    E0 = (636.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,1200.83],'cm^-1')),
        HinderedRotor(inertia=(0.112437,'amu*angstrom^2'), symmetry=1, barrier=(2.58516,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00252347,'amu*angstrom^2'), symmetry=1, barrier=(2.58255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11241,'amu*angstrom^2'), symmetry=1, barrier=(2.58453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00252558,'amu*angstrom^2'), symmetry=1, barrier=(2.58533,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95305,0.0434598,-3.02543e-05,1.30344e-08,-2.49245e-12,76589.1,26.1277], Tmin=(100,'K'), Tmax=(1189.31,'K')), NASAPolynomial(coeffs=[6.71645,0.027439,-1.00484e-05,1.70807e-09,-1.11584e-13,75456,2.32119], Tmin=(1189.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(636.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[C]1CC1(2700)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40946,0.0278203,1.28886e-05,-2.76678e-08,1.02203e-11,45302.4,19.7557], Tmin=(100,'K'), Tmax=(1070.57,'K')), NASAPolynomial(coeffs=[6.70945,0.0284928,-1.15069e-05,2.12864e-09,-1.48344e-13,43422.5,-5.7625], Tmin=(1070.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2][C]1CCC1(2701)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {6,S} {7,S}
2  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {4,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69826,0.0195565,3.75735e-05,-5.34683e-08,1.95834e-11,44742.7,18.7255], Tmin=(100,'K'), Tmax=(992.887,'K')), NASAPolynomial(coeffs=[5.92219,0.0291191,-1.09418e-05,1.98194e-09,-1.38236e-13,42991,-2.40264], Tmin=(992.887,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1([CH2])CC1(2702)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19205,0.0245119,4.4159e-05,-7.4603e-08,3.01326e-11,46192,18.346], Tmin=(100,'K'), Tmax=(964.802,'K')), NASAPolynomial(coeffs=[12.6601,0.0191056,-6.50532e-06,1.22185e-09,-9.14905e-14,42403.8,-40.9455], Tmin=(964.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Neopentyl) + radical(Neopentyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.110133,'amu*angstrom^2'), symmetry=1, barrier=(31.0188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242427,'amu*angstrom^2'), symmetry=1, barrier=(68.3436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11004,'amu*angstrom^2'), symmetry=1, barrier=(31.0186,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.109,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82337,0.0363088,8.59726e-06,-3.90401e-08,1.80732e-11,46458.6,18.3828], Tmin=(100,'K'), Tmax=(965.961,'K')), NASAPolynomial(coeffs=[13.046,0.0178173,-6.13818e-06,1.1172e-09,-8.09249e-14,42985.1,-42.1283], Tmin=(965.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(385.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_P) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([CH2])=CC(2703)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (315.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,411.98,412.055,412.058,412.124],'cm^-1')),
        HinderedRotor(inertia=(0.427372,'amu*angstrom^2'), symmetry=1, barrier=(51.4789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427414,'amu*angstrom^2'), symmetry=1, barrier=(51.4798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427424,'amu*angstrom^2'), symmetry=1, barrier=(51.4791,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78354,0.0404359,1.12222e-07,-2.19975e-08,9.51831e-12,37985.6,19.9011], Tmin=(100,'K'), Tmax=(1047.51,'K')), NASAPolynomial(coeffs=[8.84378,0.0313359,-1.24319e-05,2.26278e-09,-1.56305e-13,35526.6,-19.1654], Tmin=(1047.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])=C(2095)'],
    products = ['C2H4(29)', 'C=C=C(2022)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC[C]=C(2631)'],
    products = ['[CH2]CC([CH2])=C(2095)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[CH2]C([CH2])=C(2698)'],
    products = ['[CH2]CC([CH2])=C(2095)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', '[CH2]C[C]=C(91)'],
    products = ['[CH2]CC([CH2])=C(2095)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(6)', '[CH]CC([CH2])=C(2699)'],
    products = ['[CH2]CC([CH2])=C(2095)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(6)', '[CH]C(=C)C[CH2](2093)'],
    products = ['[CH2]CC([CH2])=C(2095)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Hrad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]C([CH2])[CH2](2406)'],
    products = ['[CH2]CC([CH2])=C(2095)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH2]C=C([CH2])[CH2](2452)'],
    products = ['[CH2]CC([CH2])=C(2095)'],
