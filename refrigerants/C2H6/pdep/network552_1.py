...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(152)', '[O]C[C]=O(580)'],
    products = ['O=[C]CO[C]=O(891)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(152)', '[CH2]O[C]=O(587)'],
    products = ['O=[C]CO[C]=O(891)'],
    transitionState = 'TS3',
