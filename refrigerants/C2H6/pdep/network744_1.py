...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])=C(1187)'],
    products = ['C2H4(29)', 'C=C=C(430)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC[C]=C(1413)'],
    products = ['[CH2]CC([CH2])=C(1187)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[CH2]C([CH2])=C(1454)'],
    products = ['[CH2]CC([CH2])=C(1187)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', '[CH2]C[C]=C(72)'],
    products = ['[CH2]CC([CH2])=C(1187)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[CH2]C(=C)C=C(1458)'],
    products = ['[CH2]CC([CH2])=C(1187)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH2](39)', 'C=C=C(430)'],
    products = ['[CH2]CC([CH2])=C(1187)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH2](39)', '[CH2][C]=C(431)'],
    products = ['[CH2]CC([CH2])=C(1187)'],
