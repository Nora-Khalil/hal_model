...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'C=[C]C=[C]C(1233)'],
    products = ['[CH2]C(=C)C=[C]C(1366)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', '[CH2]C(=C)C#CC(1599)'],
    products = ['[CH2]C(=C)C=[C]C(1366)'],
