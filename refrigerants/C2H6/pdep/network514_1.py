...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH2]C([O])=O(586)'],
    products = ['[O]CC([O])=O(858)'],
    transitionState = 'TS2',
