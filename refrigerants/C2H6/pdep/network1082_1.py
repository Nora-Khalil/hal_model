...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24987,0.0231544,6.05073e-05,-9.92106e-08,4.24566e-11,-2817.41,17.7823], Tmin=(100,'K'), Tmax=(889.722,'K')), NASAPolynomial(coeffs=[11.994,0.0202138,-3.43344e-06,3.25341e-10,-1.76406e-14,-6168.85,-37.1789], Tmin=(889.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.0696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10109,0.0468567,-2.77558e-05,8.42005e-09,-1.12323e-12,1784.72,19.9164], Tmin=(100,'K'), Tmax=(1503.15,'K')), NASAPolynomial(coeffs=[6.83737,0.034253,-1.51785e-05,2.84181e-09,-1.95466e-13,360.861,-4.86368], Tmin=(1503.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.3125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = '[CH2]OCC1[CH]C1(1943)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.50486,0.0158403,8.11825e-05,-1.22387e-07,5.17857e-11,20949.4,19.1319], Tmin=(100,'K'), Tmax=(877.225,'K')), NASAPolynomial(coeffs=[11.927,0.018566,-1.60385e-06,-9.8258e-11,1.39096e-14,17538.4,-35.1104], Tmin=(877.225,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCJCO) + radical(Isobutyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.961438,'amu*angstrom^2'), symmetry=1, barrier=(22.1054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961931,'amu*angstrom^2'), symmetry=1, barrier=(22.1167,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21029,0.0427321,2.00899e-05,-7.07428e-08,3.4343e-11,11642.2,21.9879], Tmin=(100,'K'), Tmax=(924.269,'K')), NASAPolynomial(coeffs=[20.6599,0.00671361,3.94264e-07,-1.67505e-10,6.56367e-15,5990.03,-81.4405], Tmin=(924.269,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.8203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COCJ)"""),
)

species(
    label = '[CH2]OCC=C=C(1947)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.338884,'amu*angstrom^2'), symmetry=1, barrier=(7.79162,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00241432,'amu*angstrom^2'), symmetry=1, barrier=(16.7046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0505758,'amu*angstrom^2'), symmetry=1, barrier=(33.1707,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
...
"""),
    E0 = (212.624,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,211.832,211.834,211.835,2778.32],'cm^-1')),
        HinderedRotor(inertia=(0.0289194,'amu*angstrom^2'), symmetry=1, barrier=(19.6338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616551,'amu*angstrom^2'), symmetry=1, barrier=(19.6338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616543,'amu*angstrom^2'), symmetry=1, barrier=(19.6338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00358438,'amu*angstrom^2'), symmetry=1, barrier=(19.6338,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
"""),
    E0 = (270.01,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,332.067,334.211,334.797,336.445],'cm^-1')),
        HinderedRotor(inertia=(0.00149836,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120473,'amu*angstrom^2'), symmetry=1, barrier=(9.63761,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(7.97245e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.120081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121313,'amu*angstrom^2'), symmetry=1, barrier=(9.68562,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66972,0.0526928,-4.02129e-05,1.74989e-08,-3.32256e-12,32557.3,24.6469], Tmin=(100,'K'), Tmax=(1190.86,'K')), NASAPolynomial(coeffs=[8.00523,0.0314119,-1.34069e-05,2.492e-09,-1.72064e-13,31048.4,-7.0247], Tmin=(1190.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=C[CH]OC(1949)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01486,0.0449902,-2.26202e-05,4.96349e-09,-4.08298e-13,12114.9,22.4183], Tmin=(100,'K'), Tmax=(2344.72,'K')), NASAPolynomial(coeffs=[19.8252,0.0179227,-7.42577e-06,1.24653e-09,-7.63028e-14,2851.23,-80.6277], Tmin=(2344.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJ(O)C) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CCCO[CH2](1950)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (279.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,361.708,361.997,1371.71],'cm^-1')),
        HinderedRotor(inertia=(0.0575977,'amu*angstrom^2'), symmetry=1, barrier=(5.35941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0574994,'amu*angstrom^2'), symmetry=1, barrier=(5.3561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0578244,'amu*angstrom^2'), symmetry=1, barrier=(5.36085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178782,'amu*angstrom^2'), symmetry=1, barrier=(16.6399,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42395,0.0540345,-4.04881e-05,1.63475e-08,-2.7556e-12,33682.5,25.4572], Tmin=(100,'K'), Tmax=(1370.14,'K')), NASAPolynomial(coeffs=[10.6616,0.027066,-1.09636e-05,1.98185e-09,-1.34411e-13,31151.1,-22.0183], Tmin=(1370.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC) + radical(Cds_P)"""),
)

species(
    label = 'C=[C][CH]COC(1951)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {3,S}
2  C u0 p0 c0 {1,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {1,S} {9,S} {10,S} {11,S}
...
"""),
    E0 = (199.155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,180,321.63,473.072,2936.54],'cm^-1')),
        HinderedRotor(inertia=(0.09593,'amu*angstrom^2'), symmetry=1, barrier=(15.7402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.096589,'amu*angstrom^2'), symmetry=1, barrier=(15.7604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83387,'amu*angstrom^2'), symmetry=1, barrier=(42.1644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83396,'amu*angstrom^2'), symmetry=1, barrier=(42.1664,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56871,0.0576515,-4.78818e-05,2.32908e-08,-5.05743e-12,24036.9,20.5292], Tmin=(100,'K'), Tmax=(1040.48,'K')), NASAPolynomial(coeffs=[7.23362,0.0358731,-1.64846e-05,3.1734e-09,-2.23666e-13,22858,-7.02549], Tmin=(1040.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(199.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(Cds_S)"""),
)

species(
    label = '[CH]C=CCOC(1952)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {3,S}
2  C u0 p0 c0 {1,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {1,S} {9,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87288,0.0490796,-2.38982e-05,5.12451e-09,-4.18145e-13,25137.9,22.8109], Tmin=(100,'K'), Tmax=(2517.69,'K')), NASAPolynomial(coeffs=[22.4095,0.0190976,-7.6117e-06,1.22933e-09,-7.28091e-14,13958.5,-96.8938], Tmin=(2517.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18396,0.0305933,2.79487e-05,-5.72009e-08,2.52739e-11,29765.4,21.852], Tmin=(100,'K'), Tmax=(889.572,'K')), NASAPolynomial(coeffs=[8.76595,0.0262359,-7.26178e-06,1.08069e-09,-6.84699e-14,27595.8,-14.7451], Tmin=(889.572,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(246.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]OCC=[C]C(1954)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {5,S}
2  C u0 p0 c0 {1,S} {4,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83469,0.0511929,-4.29267e-05,2.44341e-08,-6.60568e-12,31745.1,24.0127], Tmin=(100,'K'), Tmax=(836.241,'K')), NASAPolynomial(coeffs=[4.96102,0.0362389,-1.61036e-05,3.0506e-09,-2.13035e-13,31222.2,9.489], Tmin=(836.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CsJOCC) + radical(Cds_S)"""),
)

species(
    label = '[CH2]OC[C]=CC(1955)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {5,S}
...
"""),
    E0 = (263.321,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,322.722,322.76,2148.64],'cm^-1')),
        HinderedRotor(inertia=(0.00161878,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104156,'amu*angstrom^2'), symmetry=1, barrier=(7.6975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104142,'amu*angstrom^2'), symmetry=1, barrier=(7.69734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104146,'amu*angstrom^2'), symmetry=1, barrier=(7.6974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
"""),
    E0 = (227.049,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,394.962,394.988,2579.25],'cm^-1')),
        HinderedRotor(inertia=(0.073288,'amu*angstrom^2'), symmetry=1, barrier=(8.12122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0732963,'amu*angstrom^2'), symmetry=1, barrier=(8.12215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0733962,'amu*angstrom^2'), symmetry=1, barrier=(8.11903,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.408251,'amu*angstrom^2'), symmetry=1, barrier=(45.24,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91024,0.050319,-3.6957e-05,1.70028e-08,-3.78571e-12,27379.3,22.333], Tmin=(100,'K'), Tmax=(965.236,'K')), NASAPolynomial(coeffs=[4.996,0.0375312,-1.7084e-05,3.27678e-09,-2.30546e-13,26783.6,7.55521], Tmin=(965.236,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]OC=C[CH]C(1957)',
    structure = adjacencyList("""multiplicity 3
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', 'C=C[CH]C[O](1223)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]O[CH2](115)', '[CH]C=C(1759)'],
    products = ['[CH2]OC[CH]C=C(1846)'],
    transitionState = 'TS3',
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(53.8722,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.60317e+11,'m^3/(mol*s)'), n=-1.23787, Ea=(37.3569,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.08456738906112354, var=37.926887421795335, Tref=1000.0, N=24, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(6)', '[CH2]OC=CC=C(1946)'],
    products = ['[CH2]OC[CH]C=C(1846)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(21820,'m^3/(mol*s)'), n=0.859, Ea=(2.24433,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_Ext-2CS-R_Sp-2CS=1CCOSS_N-5R!H-inRing_Sp-5R!H-2CS_4R!H->O',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_Ext-2CS-R_Sp-2CS=1CCOSS_N-5R!H-inRing_Sp-5R!H-2CS_4R!H->O"""),
)

reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[CH2]OCC=C=C(1947)'],
    products = ['[CH2]OC[CH]C=C(1846)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(1.35489,'m^3/(mol*s)'), n=2.14763, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.22132624170300447, var=0.24654008949797426, Tref=1000.0, N=22, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_Ext-2CS-R_Sp-2CS=1CCOSS_N-5R!H-inRing_Sp-5R!H-2CS_N-4R!H->O_Ext-5R!H-R',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_Ext-2CS-R_Sp-2CS=1CCOSS_N-5R!H-inRing_Sp-5R!H-2CS_N-4R!H->O_Ext-5R!H-R"""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(24)', '[CH2]C=CO[CH2](1204)'],
    products = ['[CH2]OC[CH]C=C(1846)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(155.259,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(17)', '[CH]=CCO[CH2](1461)'],
    products = ['[CH2]OC[CH]C=C(1846)'],
