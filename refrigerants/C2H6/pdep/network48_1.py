...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.67653,0.0205052,6.41397e-06,-2.72006e-08,1.27933e-11,108498,13.9857], Tmin=(100,'K'), Tmax=(970.777,'K')), NASAPolynomial(coeffs=[11.7163,0.00429481,-1.04382e-06,2.43505e-10,-2.28756e-14,105752,-34.4632], Tmin=(970.777,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(901.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_P) + radical(CdCdJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (52.0744,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.16892,0.0052474,5.47729e-05,-7.72911e-08,3.06591e-11,50980.1,7.66708], Tmin=(100,'K'), Tmax=(938.995,'K')), NASAPolynomial(coeffs=[10.542,0.00709255,-1.29542e-06,2.3094e-10,-2.16954e-14,48129.4,-35.2458], Tmin=(938.995,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(423.524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(cyclobutadiene_13)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.16975,'amu*angstrom^2'), symmetry=1, barrier=(49.8868,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (51.0665,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7651,0.0228082,1.46137e-07,-1.52252e-08,7.57267e-12,80722.9,14.3896], Tmin=(100,'K'), Tmax=(935.074,'K')), NASAPolynomial(coeffs=[7.15697,0.0149526,-4.78838e-06,7.95336e-10,-5.31776e-14,79423.6,-9.05922], Tmin=(935.074,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(670.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(AllylJ2_triplet) + radical(C=C=CJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(6)', '[C]=CC=[CH](95)'],
    products = ['[CH]=CC=[CH](81)'],
    transitionState = 'TS2',
