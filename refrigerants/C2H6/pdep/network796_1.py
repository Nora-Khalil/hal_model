...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(152)', 'C=[C]C[O](147)'],
    products = ['C=[C]CO[C]=O(1400)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(57)', '[CH2]O[C]=O(587)'],
    products = ['C=[C]CO[C]=O(1400)'],
    transitionState = 'TS3',
