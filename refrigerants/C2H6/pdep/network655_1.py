...
"""),
    E0 = (538.345,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.62775,'amu*angstrom^2'), symmetry=1, barrier=(14.4332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.626274,'amu*angstrom^2'), symmetry=1, barrier=(14.3993,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17293,0.0614928,-7.39975e-05,4.63567e-08,-1.14103e-11,64850.3,19.8665], Tmin=(100,'K'), Tmax=(998.388,'K')), NASAPolynomial(coeffs=[12.4392,0.0163553,-6.1823e-06,1.07384e-09,-7.13194e-14,62600.7,-34.4686], Tmin=(998.388,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'C=C1OC=C1C(2260)',
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73623,0.0339827,2.56675e-05,-6.49703e-08,2.94436e-11,7271.73,15.3509], Tmin=(100,'K'), Tmax=(939.11,'K')), NASAPolynomial(coeffs=[16.3484,0.0117194,-2.62277e-06,4.39758e-10,-3.56609e-14,2764.48,-63.6118], Tmin=(939.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.6624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)

species(
    label = '[CH]C(=C)C([CH2])[O](2274)',
...
"""),
    E0 = (584.251,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,453.909,453.914,453.915,453.916,453.916],'cm^-1')),
        HinderedRotor(inertia=(0.346492,'amu*angstrom^2'), symmetry=1, barrier=(50.6608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346492,'amu*angstrom^2'), symmetry=1, barrier=(50.6607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346493,'amu*angstrom^2'), symmetry=1, barrier=(50.6608,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07396,0.0564804,-3.76079e-05,8.30169e-09,8.97082e-13,70381.2,26.1566], Tmin=(100,'K'), Tmax=(1072.45,'K')), NASAPolynomial(coeffs=[13.2471,0.0236784,-9.35372e-06,1.69431e-09,-1.16697e-13,67045.5,-36.8017], Tmin=(1072.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(584.251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CJCO) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C([CH2])=C(C)[O](2275)',
    structure = adjacencyList("""multiplicity 5
1  O u1 p2 c0 {4,S}
...
"""),
    E0 = (376.473,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,428.996,428.997,428.998,428.998],'cm^-1')),
        HinderedRotor(inertia=(0.396145,'amu*angstrom^2'), symmetry=1, barrier=(51.735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.396139,'amu*angstrom^2'), symmetry=1, barrier=(51.7349,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48852,0.0415927,1.17465e-05,-4.93331e-08,2.32724e-11,38576.6,18.1581], Tmin=(100,'K'), Tmax=(945.484,'K')), NASAPolynomial(coeffs=[14.9065,0.0187489,-5.83014e-06,1.00773e-09,-7.23018e-14,34523.1,-53.8421], Tmin=(945.484,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + ring(methyleneoxirane) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'CC1=C([O])C[CH]1(2277)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12125,0.026044,3.9377e-05,-7.2815e-08,3.06575e-11,23318.4,17.2519], Tmin=(100,'K'), Tmax=(947.383,'K')), NASAPolynomial(coeffs=[13.7744,0.015262,-4.38174e-06,7.83273e-10,-5.97112e-14,19386.2,-47.4375], Tmin=(947.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + ring(Cyclobutene) + radical(C=C(C)OJ) + radical(cyclobutene-allyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.991338,'amu*angstrom^2'), symmetry=1, barrier=(22.7928,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.0659,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70341,0.0439503,-5.22681e-05,3.05498e-08,-6.5971e-12,46193.8,19.1341], Tmin=(100,'K'), Tmax=(1336.38,'K')), NASAPolynomial(coeffs=[11.9084,0.00523399,3.60311e-07,-2.7983e-10,2.62302e-14,44195.9,-30.328], Tmin=(1336.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C(C)OJ) + radical(C=C(O)CJ) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]C(=C)C(=C)[O](2279)',
    structure = adjacencyList("""multiplicity 4
1  O u1 p2 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.15821,'amu*angstrom^2'), symmetry=1, barrier=(49.6215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.16196,'amu*angstrom^2'), symmetry=1, barrier=(49.7078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1577,0.055669,-3.86782e-05,5.33013e-09,3.75373e-12,42315.3,20.6503], Tmin=(100,'K'), Tmax=(941.057,'K')), NASAPolynomial(coeffs=[13.7286,0.0187803,-6.25031e-06,1.03926e-09,-6.93381e-14,39216.8,-43.1255], Tmin=(941.057,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(350.927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C)C(=[CH])[O](2280)',
    structure = adjacencyList("""multiplicity 4
1  O u1 p2 c0 {4,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {4,S} {5,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.784604,'amu*angstrom^2'), symmetry=1, barrier=(18.0396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784414,'amu*angstrom^2'), symmetry=1, barrier=(18.0352,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0119,0.0627719,-7.23432e-05,4.06975e-08,-8.39184e-12,57171.6,20.8714], Tmin=(100,'K'), Tmax=(924.336,'K')), NASAPolynomial(coeffs=[14.3528,0.0128781,-4.0958e-06,6.48737e-10,-4.12948e-14,54370.5,-44.2525], Tmin=(924.336,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(474.435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P) + radical(Cds_P)"""),
)
...
"""),
    E0 = (336.63,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,3115,3125,620,680,785,800,1600,1700],'cm^-1')),
        HinderedRotor(inertia=(0.90397,'amu*angstrom^2'), symmetry=1, barrier=(20.784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.903079,'amu*angstrom^2'), symmetry=1, barrier=(20.7636,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.273859,0.0711488,-8.02972e-05,4.37504e-08,-8.98347e-12,40630.7,22.0172], Tmin=(100,'K'), Tmax=(1319.22,'K')), NASAPolynomial(coeffs=[18.9683,0.00800789,-1.16116e-06,4.84817e-11,1.48316e-15,36260.2,-71.2219], Tmin=(1319.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)C(=C)O(2283)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (264.221,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,540,610,2055,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.706683,'amu*angstrom^2'), symmetry=1, barrier=(16.248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.709875,'amu*angstrom^2'), symmetry=1, barrier=(16.3214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08428,'amu*angstrom^2'), symmetry=1, barrier=(24.9297,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.588339,0.0622392,-6.27346e-05,3.16934e-08,-6.05957e-12,31912.3,23.2801], Tmin=(100,'K'), Tmax=(1454.64,'K')), NASAPolynomial(coeffs=[16.3231,0.0111507,-1.98842e-06,1.57174e-10,-4.42974e-15,28162,-55.6837], Tmin=(1454.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C(O)CJ) + radical(C=C=CJ)"""),
)
...
"""),
    E0 = (267.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2120,512.5,787.5,402.449,402.451,402.455],'cm^-1')),
        HinderedRotor(inertia=(0.453263,'amu*angstrom^2'), symmetry=1, barrier=(52.0957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.453257,'amu*angstrom^2'), symmetry=1, barrier=(52.0958,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.60797,0.0336788,-1.93865e-05,5.97209e-09,-8.55154e-13,32210,15.5845], Tmin=(100,'K'), Tmax=(1346.14,'K')), NASAPolynomial(coeffs=[4.92928,0.0267811,-1.17004e-05,2.16562e-09,-1.4823e-13,31585.1,3.69559], Tmin=(1346.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + missing(Cdd-CdO2d) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'CC1=CCC1=O(2193)',
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.58257,0.0195901,3.99414e-05,-5.53157e-08,1.87409e-11,-456.737,15.7286], Tmin=(100,'K'), Tmax=(1107.3,'K')), NASAPolynomial(coeffs=[9.07817,0.0277214,-1.38753e-05,2.85491e-09,-2.1069e-13,-3832.26,-25.0175], Tmin=(1107.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.30197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)Cs) + ring(Cyclobutene)"""),
)

species(
    label = '[CH]C([CH2])=C([CH2])O(2286)',
    structure = adjacencyList("""multiplicity 5
1  O u0 p2 c0 {3,S} {12,S}
...
"""),
    E0 = (397.585,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,325,375,415,465,420,450,1700,1750,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,335.307,335.308,335.309],'cm^-1')),
        HinderedRotor(inertia=(0.630929,'amu*angstrom^2'), symmetry=1, barrier=(50.338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.630933,'amu*angstrom^2'), symmetry=1, barrier=(50.3379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.630938,'amu*angstrom^2'), symmetry=1, barrier=(50.3379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.630928,'amu*angstrom^2'), symmetry=1, barrier=(50.3379,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.793681,0.0604078,-3.35773e-05,-9.34763e-09,1.11266e-11,47943.2,23.374], Tmin=(100,'K'), Tmax=(920.928,'K')), NASAPolynomial(coeffs=[17.0734,0.0161005,-4.41483e-06,6.72975e-10,-4.47868e-14,43825.1,-59.9043], Tmin=(920.928,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(Allyl_P) + radical(C=C(O)CJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C=C1O[CH][C]1C(2287)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69788,0.0287374,5.65322e-05,-1.11839e-07,5.09652e-11,31315.5,16.2355], Tmin=(100,'K'), Tmax=(898.977,'K')), NASAPolynomial(coeffs=[20.9574,0.00143872,4.64322e-06,-1.10057e-09,7.46307e-14,25493.1,-87.7538], Tmin=(898.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(CCJ(C)CO) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH]C(=C)C(C)=O(2288)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,D}
2  C u0 p0 c0 {4,S} {7,S} {8,S} {9,S}
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CC(=C)[O](404)'],
    products = ['[CH]=C(C)C(=C)[O](2064)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=C(C)C(=C)[O](2064)'],
    products = ['[CH]=C=C([O])CC(2272)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3431.13,'s^-1'), n=2.77015, Ea=(376.922,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H-inRing_2R!H->C',), comment="""Estimated from node Root_N-1R!H-inRing_2R!H->C"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(7)', '[CH]C(C)=C=C(2153)'],
    products = ['[CH]=C(C)C(=C)[O](2064)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(6)', '[C]=C(C)C(=C)[O](2273)'],
    products = ['[CH]=C(C)C(=C)[O](2064)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(18)', '[CH]=C=C([CH2])[O](541)'],
    products = ['[CH]=C(C)C(=C)[O](2064)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', '[CH]C(=C)C(=C)[O](2279)'],
    products = ['[CH]=C(C)C(=C)[O](2064)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2.21037e+06,'m^3/(mol*s)'), n=0.349925, Ea=(3.22994,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[CH]=C(C)C(=[CH])[O](2280)'],
    products = ['[CH]=C(C)C(=C)[O](2064)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(C)C(=C)[O](2064)'],
    products = ['[CH]C(=C)C(=C)O(2283)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(2.3e+09,'s^-1','*|/',2.51189), n=0.75, Ea=(97.0688,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_SSS;O_rad_out;Cs_H_out_2H] for rate rule [R4H_S(Cd)SS;O_rad_out;Cs_H_out_2H]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 3.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C=C([CH2])OC(2284)'],
    products = ['[CH]=C(C)C(=C)[O](2064)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(7040,'s^-1'), n=2.66, Ea=(372.522,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H-inRing_N-2R!H->C',), comment="""Estimated from node Root_N-1R!H-inRing_N-2R!H->C"""),
)

reaction(
    label = 'reaction25',
    reactants = ['CH2(T)(17)', '[CH]C(C)=C=O(2285)'],
    products = ['[CH]=C(C)C(=C)[O](2064)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]C([CH2])=C([CH2])O(2286)'],
    products = ['[CH]=C(C)C(=C)[O](2064)'],
