...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(160)', 'CH2(T)(17)'],
    products = ['[CH2]OO[C]=O(861)'],
    transitionState = 'TS2',
