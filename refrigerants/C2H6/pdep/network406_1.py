...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(57)', '[CH2]C([O])=O(586)'],
    products = ['[CH2]C(=O)O[C]=C(546)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'C=[C]O[C]=O(681)'],
    products = ['[CH2]C(=O)O[C]=C(546)'],
    transitionState = 'TS3',
