...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(152)', '[CH2]C([CH2])=C(1454)'],
    products = ['[CH2]C(=C)C[C]=O(1279)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['CO(14)', '[CH2]C([CH2])=C(1454)'],
    products = ['[CH2]C(=C)C[C]=O(1279)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[CH2]C(=C)C=C=O(1510)'],
    products = ['[CH2]C(=C)C[C]=O(1279)'],
