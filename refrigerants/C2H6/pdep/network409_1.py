...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(57)', '[O]C[C]=O(580)'],
    products = ['C=[C]OC[C]=O(549)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(152)', '[CH2]O[C]=C(141)'],
    products = ['C=[C]OC[C]=O(549)'],
    transitionState = 'TS3',
