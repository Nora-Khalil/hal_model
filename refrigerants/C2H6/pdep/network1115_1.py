...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.834477,0.0641121,-5.93599e-05,2.78957e-08,-5.20866e-12,4448.98,27.9562], Tmin=(100,'K'), Tmax=(1292.33,'K')), NASAPolynomial(coeffs=[15.0734,0.0200401,-8.20598e-06,1.5073e-09,-1.03862e-13,768.689,-44.39], Tmin=(1292.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.0053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CJCC=O)"""),
)
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24431,0.0237125,5.22147e-05,-8.56621e-08,3.55018e-11,-26760.4,21.2712], Tmin=(100,'K'), Tmax=(923.422,'K')), NASAPolynomial(coeffs=[11.678,0.0210669,-5.56978e-06,8.75807e-10,-6.10638e-14,-30132.1,-32.3125], Tmin=(923.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + ring(Beta-Propiolactone)"""),
)
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.356,0.0437326,1.03436e-05,-5.62032e-08,2.88073e-11,47761.5,27.4508], Tmin=(100,'K'), Tmax=(902.082,'K')), NASAPolynomial(coeffs=[17.3276,0.011762,-1.09649e-06,-6.06762e-12,1.87162e-15,43299.2,-56.7187], Tmin=(902.082,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(dioxirane) + radical(Cs_P) + radical(Isobutyl)"""),
)
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22231,0.0234223,5.47372e-05,-9.04471e-08,3.78808e-11,6737.12,25.8272], Tmin=(100,'K'), Tmax=(917.457,'K')), NASAPolynomial(coeffs=[12.4838,0.0191567,-4.46055e-06,6.52217e-10,-4.53927e-14,3150.85,-32.0777], Tmin=(917.457,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.3625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(CCJCC=O) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1[CH]COC1=O(2011)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {6,S}
2  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19411,0.0235967,5.62203e-05,-9.27268e-08,3.88191e-11,-68.2467,24.1432], Tmin=(100,'K'), Tmax=(918.103,'K')), NASAPolynomial(coeffs=[12.7781,0.0190886,-4.38737e-06,6.40131e-10,-4.48337e-14,-3765.12,-35.5633], Tmin=(918.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.23237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(butyrolactone) + radical(CCJCO) + radical(CJC(C)C=O)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(C=C)C([O])=O(1879)'],
    products = ['[CH2][CH]C(=O)OC=C(2025)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.87873e+12,'s^-1'), n=0.324012, Ea=(158.712,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(17)', 'C=C[CH]C([O])=O(1292)'],
...
reaction(
    label = 'reaction6',
    reactants = ['O(7)', '[CH2]C([C]=O)C=C(2026)'],
    products = ['[CH2]C(C=C)C([O])=O(1879)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C=C)C([O])=O(1879)'],
    products = ['[CH2]C(C=C)[C]1OO1(2027)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C=C)C([O])=O(1879)'],
    products = ['[CH2]C1[CH]COC1=O(2011)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.34239e+09,'s^-1'), n=0.889391, Ea=(153.133,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs2H]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C](C=C)C(=O)O(2031)'],
    products = ['[CH2]C(C=C)C([O])=O(1879)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C2H3(28)', 'C=CC([O])=O(850)'],
    products = ['[CH2]C(C=C)C([O])=O(1879)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(306.062,'m^3/(mol*s)'), n=1.16366, Ea=(34.368,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H
Multiplied by reaction path degeneracy 2.0"""),
)
