...
reaction(
    label = 'reaction1',
    reactants = ['C=C=COC=O(2080)'],
    products = ['CO2(15)', 'C#CC(416)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(14)', 'C=C=CO(2552)'],
    products = ['C=C=COC=O(2080)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C1=CO[CH]O1(3088)'],
    products = ['C=C=COC=O(2080)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C=O(212)', '[CH]=C=C(2030)'],
    products = ['C=C=COC=O(2080)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH2]C#COC=O(3094)'],
    products = ['C=C=COC=O(2080)'],
