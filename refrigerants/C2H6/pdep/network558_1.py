...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[O]C([O])=C=O(932)'],
    products = ['[O]C(=O)C([O])=O(897)'],
    transitionState = 'TS2',
