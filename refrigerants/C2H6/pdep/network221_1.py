...
"""),
    ...
    molecularWeight = (70.1329,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77091,0.0406539,-7.4825e-07,-2.08233e-08,9.00676e-12,-6596.98,18.8383], Tmin=(100,'K'), Tmax=(1062.09,'K')), NASAPolynomial(coeffs=[9.11279,0.0308931,-1.22292e-05,2.24279e-09,-1.55785e-13,-9165.54,-21.7744], Tmin=(1062.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.5768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CC(C)C(293)',
    structure = adjacencyList("""1  C u0 p0 c0 {2,S} {3,S} {4,S} {6,S}
2  C u0 p0 c0 {1,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (70.1329,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95974,0.0329297,2.6236e-05,-5.22889e-08,2.09888e-11,-5721.98,18.7075], Tmin=(100,'K'), Tmax=(989.918,'K')), NASAPolynomial(coeffs=[10.2073,0.0284298,-1.06252e-05,1.95194e-09,-1.38485e-13,-8767.25,-28.1323], Tmin=(989.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.2739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (70.1329,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38036,0.0422226,-1.85277e-05,3.31324e-09,-1.89675e-13,26137.6,19.5923], Tmin=(100,'K'), Tmax=(2401.03,'K')), NASAPolynomial(coeffs=[19.9682,0.0185872,-7.30122e-06,1.17881e-09,-6.97539e-14,16058.8,-84.0648], Tmin=(2401.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(C)[CH]C(297)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {4,S} {5,S} {6,S}
2  C u0 p0 c0 {1,S} {7,S} {8,S} {9,S}
3  C u0 p0 c0 {4,S} {10,S} {11,S} {12,S}
...
"""),
    ...
    molecularWeight = (70.1329,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82818,0.0409721,-7.54584e-06,-1.01413e-08,4.45319e-12,27266.4,23.0232], Tmin=(100,'K'), Tmax=(1187.48,'K')), NASAPolynomial(coeffs=[8.34036,0.0322558,-1.32345e-05,2.42737e-09,-1.6659e-13,24787.7,-13.4379], Tmin=(1187.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(226.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2][C](C)CC(299)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {4,S} {6,S} {7,S}
2  C u0 p0 c0 {1,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {4,S} {11,S} {12,S} {13,S}
...
"""),
    ...
    molecularWeight = (70.1329,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94841,0.0477752,-3.58851e-05,2.30508e-08,-7.78941e-12,26137.5,21.8541], Tmin=(100,'K'), Tmax=(777.644,'K')), NASAPolynomial(coeffs=[3.02809,0.0400455,-1.6778e-05,3.07209e-09,-2.09742e-13,26035.4,17.3398], Tmin=(777.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])CC(300)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {4,S} {5,S} {6,S}
...
"""),
    E0 = (236.386,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1700.32],'cm^-1')),
        HinderedRotor(inertia=(0.336028,'amu*angstrom^2'), symmetry=1, barrier=(9.4849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00434785,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0338642,'amu*angstrom^2'), symmetry=1, barrier=(69.8408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271405,'amu*angstrom^2'), symmetry=1, barrier=(9.59104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.1329,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71503,0.044045,-8.69138e-06,-1.71182e-08,9.74659e-12,28518.6,22.6406], Tmin=(100,'K'), Tmax=(931.12,'K')), NASAPolynomial(coeffs=[8.79904,0.0291759,-9.80962e-06,1.63335e-09,-1.07804e-13,26524.7,-14.6529], Tmin=(931.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(17)', '[CH2]C([CH2])C(290)'],
    products = ['[CH2]CC([CH2])C(287)'],
    transitionState = 'TS6',
