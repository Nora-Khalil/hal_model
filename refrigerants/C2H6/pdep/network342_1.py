...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[CH2]O[C]=O(587)'],
    products = ['[CH2]OC([CH2])=O(487)'],
    transitionState = 'TS3',
