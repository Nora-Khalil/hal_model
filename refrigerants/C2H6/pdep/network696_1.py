...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(57)', 'C[C]=C[O](1200)'],
    products = ['C=[C]OC=[C]C(1162)'],
    transitionState = 'TS2',
