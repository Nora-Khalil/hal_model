...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CC[C]=O(476)'],
    products = ['[CH]=C(C)C[C]=O(1165)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(152)', '[CH]C(=C)C(1184)'],
    products = ['[CH]=C(C)C[C]=O(1165)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', '[CH]=C(C)C=C=O(1144)'],
    products = ['[CH]=C(C)C[C]=O(1165)'],
    transitionState = 'TS9',
