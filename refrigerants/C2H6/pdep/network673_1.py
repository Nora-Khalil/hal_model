...
species(
    label = 'C=C=C=[C-][OH2+](1353)',
    structure = adjacencyList("""1 O u0 p1 c+1 {3,S} {6,S} {9,S}
...
"""),
    E0 = (603.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,540,563.333,586.667,610,1970,2140,180,180,180,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.113876,'amu*angstrom^2'), symmetry=1, barrier=(2.61823,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13926,0.0495818,-9.2541e-05,9.31279e-08,-3.51247e-11,72670.6,15.2144], Tmin=(100,'K'), Tmax=(847.427,'K')), NASAPolynomial(coeffs=[3.23484,0.0244313,-1.26583e-05,2.46346e-09,-1.70181e-13,73202.3,14.343], Tmin=(847.427,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(603.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH) + group(Cdd-CdsCds) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C=C[C-]=[OH+](1139)'],
    products = ['CO(14)', 'C#CC(211)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(10.8771,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C=C=C=[C-][OH2+](1353)'],
    products = ['C=C=C[C-]=[OH+](1139)'],
    transitionState = 'TS2',
