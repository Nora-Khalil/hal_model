...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (56.0632,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3427.19,'J/mol'), sigma=(5.6872,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=535.32 K, Pc=42.28 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (96.8181,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2950,3150,900,1000,1100,655.33,655.842,656.152,656.588,656.9,657.616,657.7,3641.14],'cm^-1')),
        HinderedRotor(inertia=(0.0113833,'amu*angstrom^2'), symmetry=1, barrier=(3.49661,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (56.0632,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3486.84,'J/mol'), sigma=(5.68524,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=544.64 K, Pc=43.06 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (298.266,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2950,3150,900,1000,1100,628.924,628.925,628.925,628.927,628.927,628.929,628.93,628.931],'cm^-1')),
        HinderedRotor(inertia=(0.000426189,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.86294,0.0171342,1.84454e-05,-3.6039e-08,1.50189e-11,35921.2,22.6505], Tmin=(100,'K'), Tmax=(960.453,'K')), NASAPolynomial(coeffs=[8.74965,0.0121015,-4.12376e-06,7.47962e-10,-5.42248e-14,33891.7,-10.1902], Tmin=(960.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsJ2_singlet-CsH) + ring(Cyclopropane)"""),
)
...
"""),
    E0 = (260.655,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2950,3150,900,1000,1100,180,180,839.62,839.621,839.626,839.628,839.638,3922.09],'cm^-1')),
        HinderedRotor(inertia=(0.00917686,'amu*angstrom^2'), symmetry=1, barrier=(4.59087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.91312,0.0155292,1.9415e-05,-3.81397e-08,1.62956e-11,31396.3,15.202], Tmin=(100,'K'), Tmax=(948.755,'K')), NASAPolynomial(coeffs=[9.71699,0.00795556,-1.98919e-06,3.54559e-10,-2.79771e-14,29155.1,-22.2724], Tmin=(948.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(260.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C2CsJOH) + radical(CCJCO)"""),
)

species(
    label = '[O]C1[CH]C1(2858)',
    structure = adjacencyList("""multiplicity 3
1 O u1 p2 c0 {2,S}
2 C u0 p0 c0 {1,S} {3,S} {4,S} {5,S}
3 C u0 p0 c0 {2,S} {4,S} {6,S} {7,S}
...
"""),
    E0 = (314.389,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,558.286,876.987,876.992,876.996,876.997,877.002,877.004,877.007,877.013,3573.97],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.22493,0.00285134,6.22354e-05,-8.52877e-08,3.34914e-11,37853.1,13.7744], Tmin=(100,'K'), Tmax=(942.448,'K')), NASAPolynomial(coeffs=[11.0119,0.00611426,-7.53398e-07,1.52398e-10,-1.79742e-14,34772.7,-31.8873], Tmin=(942.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CC(C)OJ) + radical(CCJCO)"""),
)
...
"""),
    E0 = (327.179,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,739.554,739.57,739.628,739.635,739.655,739.684,739.687,739.704,3133.62],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0552,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.09129,0.00994037,3.2154e-05,-5.07305e-08,2.0429e-11,39392.3,12.2085], Tmin=(100,'K'), Tmax=(959.834,'K')), NASAPolynomial(coeffs=[9.9767,0.00651484,-1.98172e-06,4.06541e-10,-3.40742e-14,36906.6,-26.7908], Tmin=(959.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CC(C)OJ)"""),
)

species(
    label = 'OC1=C[CH]1(2860)',
    structure = adjacencyList("""multiplicity 2
1 O u0 p2 c0 {2,S} {7,S}
...
"""),
    E0 = (259.995,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,3150,900,1100,523.822,523.832,523.896,523.917,523.943,524.042,1412.15],'cm^-1')),
        HinderedRotor(inertia=(0.000614287,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0552,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.81257,0.0105378,4.65938e-05,-8.1204e-08,3.58595e-11,31327.5,12.8785], Tmin=(100,'K'), Tmax=(907.402,'K')), NASAPolynomial(coeffs=[15.7282,-0.00542267,5.24472e-06,-1.06177e-09,6.90494e-14,27296.7,-57.4718], Tmin=(907.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CCJCO)"""),
)
...
"""),
    E0 = (325.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,3150,900,1100,180,180,363.733,1029.1,1029.12,1029.15,4000],'cm^-1')),
        HinderedRotor(inertia=(0.024772,'amu*angstrom^2'), symmetry=1, barrier=(18.6189,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0552,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.89731,0.0185128,1.52943e-06,-1.65039e-08,7.88311e-12,39137.7,13.5703], Tmin=(100,'K'), Tmax=(982.181,'K')), NASAPolynomial(coeffs=[8.86939,0.00777865,-2.82831e-06,5.3902e-10,-4.00528e-14,37309.2,-18.4705], Tmin=(982.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(325.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(cyclopropenyl-vinyl)"""),
)
...
"""),
    ...
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.62575,0.0156651,3.82413e-05,-7.2008e-08,3.21024e-11,7290.56,11.7455], Tmin=(100,'K'), Tmax=(912.872,'K')), NASAPolynomial(coeffs=[15.149,-0.00110149,3.17443e-06,-6.69817e-10,4.22921e-14,3416.3,-56.2274], Tmin=(912.872,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.0927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]O(153)', '[CH]=[CH](58)'],
    products = ['[CH]C=CO(146)'],
...
reaction(
    label = 'reaction26',
    reactants = ['OH(8)', '[CH]1C=C1(2392)'],
    products = ['OC1C=C1(2830)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(2.31e+08,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_2R->C_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_2R->C_Ext-2C-R
Multiplied by reaction path degeneracy 3.0
...
reaction(
    label = 'reaction31',
    reactants = ['OC1[C]C1(2862)'],
    products = ['OC1=CC1(2863)'],
    transitionState = 'TS31',
    kinetics = Arrhenius(A=(2.22161e+17,'s^-1'), n=-1.50998, Ea=(29.0017,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.5018375041037424, var=16.310967916345923, Tref=1000.0, N=4, data_mean=0.0, correlation='CCH_Ext-3C-R_N-4R!H->Br_N-4CClFINOPSSi->F_1C-inRing',), comment="""Estimated from node CCH_Ext-3C-R_N-4R!H->Br_N-4CClFINOPSSi->F_1C-inRing"""),
)
