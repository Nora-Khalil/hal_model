...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.42358,'amu*angstrom^2'), symmetry=1, barrier=(32.7308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41894,'amu*angstrom^2'), symmetry=1, barrier=(32.6241,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0387,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10161,0.0405942,-5.28958e-05,3.21847e-08,-7.48652e-12,55436.9,14.9474], Tmin=(100,'K'), Tmax=(1064.82,'K')), NASAPolynomial(coeffs=[11.6852,0.00459259,-2.17963e-06,4.31383e-10,-3.12547e-14,53396,-31.8895], Tmin=(1064.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(460.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical((O)CJOC) + radical(CdCdJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.292,'amu*angstrom^2'), symmetry=1, barrier=(29.7057,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28897,'amu*angstrom^2'), symmetry=1, barrier=(29.636,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0387,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3273,0.038823,-5.66658e-05,4.13179e-08,-1.18076e-11,46855.1,17.2948], Tmin=(100,'K'), Tmax=(860.937,'K')), NASAPolynomial(coeffs=[8.78149,0.00883683,-4.42244e-06,8.64195e-10,-6.0828e-14,45743.7,-12.8766], Tmin=(860.937,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(389.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(C=CJO) + radical(Cds_P) + radical((O)CJOC)"""),
)

species(
    label = 'C=[C]O[C]=O(1216)',
    structure = adjacencyList("""multiplicity 3
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(179)', '[CH]=C[O](140)'],
    products = ['[CH]=CO[C]=O(1687)'],
    transitionState = 'TS2',
