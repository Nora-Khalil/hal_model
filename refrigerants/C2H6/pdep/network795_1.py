...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70784,0.0592725,-6.33705e-05,3.25424e-08,-6.23405e-12,21004.5,20.0551], Tmin=(100,'K'), Tmax=(1467.17,'K')), NASAPolynomial(coeffs=[16.9865,0.00626221,-3.51593e-07,-1.01564e-10,1.14316e-14,17156.6,-61.5548], Tmin=(1467.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(cyclopropanone) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)O[C]=O(1238)'],
    products = ['[CH2]C1([CH2])OC1=O(1488)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.62453e+10,'s^-1'), n=0.5217, Ea=(154.344,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_CO]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C]=O(803)', '[CH2][C]=C(431)'],
    products = ['[CH2]C(=C)O[C]=O(1238)'],
