...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31146,0.0489833,-6.84035e-06,-2.19035e-08,1.08078e-11,2735.96,20.5649], Tmin=(100,'K'), Tmax=(1025.19,'K')), NASAPolynomial(coeffs=[11.7197,0.0303321,-1.16796e-05,2.13616e-09,-1.49307e-13,-552.065,-35.5355], Tmin=(1025.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.644917,'amu*angstrom^2'), symmetry=1, barrier=(14.8279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.646658,'amu*angstrom^2'), symmetry=1, barrier=(14.8679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.644832,'amu*angstrom^2'), symmetry=1, barrier=(14.826,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09533,0.0554873,-3.71102e-05,1.28341e-08,-1.80947e-12,31347.7,22.5245], Tmin=(100,'K'), Tmax=(1645.46,'K')), NASAPolynomial(coeffs=[13.5855,0.0251243,-9.43101e-06,1.61957e-09,-1.05601e-13,27237.3,-43.9534], Tmin=(1645.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(Cds_S)"""),
)

species(
    label = 'C=CCC=[C]C(1157)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    E0 = (278.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2100,2250,500,550,2978.19,2978.26],'cm^-1')),
        HinderedRotor(inertia=(3.2787,'amu*angstrom^2'), symmetry=1, barrier=(75.3837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.27894,'amu*angstrom^2'), symmetry=1, barrier=(75.3892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24585,'amu*angstrom^2'), symmetry=1, barrier=(5.65259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.27826,'amu*angstrom^2'), symmetry=1, barrier=(75.3738,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75047,0.0471128,-2.64989e-05,8.96942e-09,-1.39327e-12,33526.5,24.3924], Tmin=(100,'K'), Tmax=(1371.37,'K')), NASAPolynomial(coeffs=[6.21104,0.0341023,-1.22681e-05,2.0514e-09,-1.32123e-13,32303,1.46404], Tmin=(1371.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJC)"""),
)

species(
    label = 'C[C]=C[CH]CC(1249)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (302.627,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,379.538,1829.82],'cm^-1')),
        HinderedRotor(inertia=(0.0829435,'amu*angstrom^2'), symmetry=1, barrier=(8.47808,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0829421,'amu*angstrom^2'), symmetry=1, barrier=(8.47827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0829613,'amu*angstrom^2'), symmetry=1, barrier=(8.4797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25703,'amu*angstrom^2'), symmetry=1, barrier=(26.2641,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
species(
    label = 'C[CH]C=C[CH]C(1313)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
2  C u0 p0 c0 {4,S} {10,S} {11,S} {12,S}
3  C u1 p0 c0 {1,S} {5,S} {14,S}
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70311,0.0378145,2.4042e-05,-5.09601e-08,2.0101e-11,24994,20.1362], Tmin=(100,'K'), Tmax=(1017.42,'K')), NASAPolynomial(coeffs=[10.6359,0.032828,-1.30317e-05,2.44209e-09,-1.73747e-13,21616.7,-30.7782], Tmin=(1017.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_S)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(C)C=[C]C(1150)'],
    products = ['C[C]=CC[CH]C(1148)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C(38)', '[CH2]C=[C]C(1189)'],
    products = ['C[C]=CC[CH]C(1148)'],
    transitionState = 'TS3',
