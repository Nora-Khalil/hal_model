...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00249443,'amu*angstrom^2'), symmetry=1, barrier=(8.11369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214964,'amu*angstrom^2'), symmetry=1, barrier=(8.11267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215532,'amu*angstrom^2'), symmetry=1, barrier=(8.11203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16614,0.0438281,-5.81074e-05,4.87553e-08,-1.67977e-11,41549.9,21.3657], Tmin=(100,'K'), Tmax=(814.628,'K')), NASAPolynomial(coeffs=[5.50425,0.0225223,-9.82633e-06,1.83722e-09,-1.26162e-13,41169.2,6.9466], Tmin=(814.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(344.945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(ROOJ) + radical(CCsJOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH]1COOC1(2546)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {2,S} {3,S}
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C=C(219)'],
    products = ['C=CCO[O](2376)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['C=CCO[O](2376)'],
    products = ['HO2(12)', 'C=C=C(2022)'],
    transitionState = 'TS4',
