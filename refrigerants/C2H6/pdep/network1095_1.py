...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.140925,'amu*angstrom^2'), symmetry=1, barrier=(3.24015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142236,'amu*angstrom^2'), symmetry=1, barrier=(3.27029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.816124,'amu*angstrom^2'), symmetry=1, barrier=(18.7643,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51673,0.0559433,-4.92709e-05,2.65106e-08,-6.1829e-12,59996.4,23.5842], Tmin=(100,'K'), Tmax=(1003.22,'K')), NASAPolynomial(coeffs=[7.61848,0.0316147,-1.28953e-05,2.33815e-09,-1.59195e-13,58772.1,-5.87285], Tmin=(1003.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(498.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = 'C=CC1COC1=C(1864)',
...
"""),
    E0 = (292.8,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,272.417],'cm^-1')),
        HinderedRotor(inertia=(0.276624,'amu*angstrom^2'), symmetry=1, barrier=(14.5585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276051,'amu*angstrom^2'), symmetry=1, barrier=(14.5591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276494,'amu*angstrom^2'), symmetry=1, barrier=(14.5608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275792,'amu*angstrom^2'), symmetry=1, barrier=(14.56,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.276185,0.0760106,-7.24693e-05,3.12035e-08,-3.55633e-12,35355.2,28.0184], Tmin=(100,'K'), Tmax=(930.066,'K')), NASAPolynomial(coeffs=[16.7214,0.020158,-6.37983e-06,1.02613e-09,-6.67448e-14,31652.8,-53.5863], Tmin=(930.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31179,0.0410874,3.32577e-05,-8.15879e-08,3.7467e-11,34874.5,23.1514], Tmin=(100,'K'), Tmax=(917.788,'K')), NASAPolynomial(coeffs=[17.77,0.0162752,-2.87061e-06,3.54724e-10,-2.59205e-14,29877.4,-65.603], Tmin=(917.788,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(Cs_S) + radical(RCCJ)"""),
)
...
"""),
    E0 = (272.739,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,270.495],'cm^-1')),
        HinderedRotor(inertia=(0.134107,'amu*angstrom^2'), symmetry=1, barrier=(6.96579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134092,'amu*angstrom^2'), symmetry=1, barrier=(6.96639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134091,'amu*angstrom^2'), symmetry=1, barrier=(6.96591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134082,'amu*angstrom^2'), symmetry=1, barrier=(6.96592,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799983,0.0755624,-9.41732e-05,7.20371e-08,-2.32512e-11,32913.4,27.3887], Tmin=(100,'K'), Tmax=(746.88,'K')), NASAPolynomial(coeffs=[7.95894,0.0372145,-1.71423e-05,3.26607e-09,-2.27332e-13,31844.2,-5.05847], Tmin=(746.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJC(C)C=O) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(17)', '[CH2]C=CC(=C)[O](1344)'],
...
reaction(
    label = 'reaction6',
    reactants = ['O(7)', '[CH2]C([C]=C)C=C(1924)'],
    products = ['[CH2]C(C=C)C(=C)[O](1859)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C=C)C(=C)[O](1859)'],
    products = ['[CH2]C(C=C)[C]1CO1(2136)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C=C)C(=C)[O](1859)'],
    products = ['[CH2]C1[CH]COC1=C(2116)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C2H3(28)', 'C=CC(=C)[O](473)'],
    products = ['[CH2]C(C=C)C(=C)[O](1859)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.00905,'m^3/(mol*s)'), n=2.41, Ea=(13.5688,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_2R!H->C_Ext-1R!H-R_N-5R!H-inRing_Sp-5R!H-1R!H_Ext-5R!H-R_Sp-6R!H=5R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_2R!H->C_Ext-1R!H-R_N-5R!H-inRing_Sp-5R!H-1R!H_Ext-5R!H-R_Sp-6R!H=5R!H"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0181,'m^3/(mol*s)'), n=2.41, Ea=(26.2881,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_2R!H->C_Ext-1R!H-R_N-5R!H-inRing_Sp-5R!H-1R!H_Ext-5R!H-R_Sp-6R!H=5R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_2R!H->C_Ext-1R!H-R_N-5R!H-inRing_Sp-5R!H-1R!H_Ext-5R!H-R_Sp-6R!H=5R!H
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(C=C)C(=C)[O](1859)'],
    products = ['C2H2(22)', '[CH2]C=C(C)[O](579)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(2.64576e+18,'s^-1'), n=-2.21337, Ea=(218.041,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0927421085454212, var=3.278681656229481, Tref=1000.0, N=7, data_mean=0.0, correlation='Root_1R!H->C_2R!H->C_N-5R!H->O',), comment="""Estimated from node Root_1R!H->C_2R!H->C_N-5R!H->O
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(C=C)C(=C)[O](1859)'],
    products = ['HCCO(20)', 'C=C[CH]C(1651)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(2.64576e+18,'s^-1'), n=-2.21337, Ea=(232.393,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0927421085454212, var=3.278681656229481, Tref=1000.0, N=7, data_mean=0.0, correlation='Root_1R!H->C_2R!H->C_N-5R!H->O',), comment="""Estimated from node Root_1R!H->C_2R!H->C_N-5R!H->O
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=C(O)C([CH2])C=C(2144)'],
    products = ['[CH2]C(C=C)C(=C)[O](1859)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C=C([CH2])OC=C(2107)'],
    products = ['[CH2]C(C=C)C(=C)[O](1859)'],
    transitionState = 'TS32',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(151.926,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction33',
    reactants = ['CH2(T)(17)', '[CH2]C([C]=O)C=C(2026)'],
    products = ['[CH2]C(C=C)C(=C)[O](1859)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]=CC([CH2])C(C)=O(2152)'],
    products = ['[CH2]C(C=C)C(=C)[O](1859)'],
...
network(
    ...
    isomers = [
        '[CH2]C(C=C)C(=C)[O](1859)',
    ],
    reactants = [
        ('CH2CO(27)', 'C=CC=C(61)'),
        ('[CH2][C]=O(167)', 'C=CC=C(61)'),
        ('HCCO(20)', 'C=C[CH]C(1651)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
