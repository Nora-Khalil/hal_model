...
"""),
    E0 = (-62.3345,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,180,180,180,739.838,739.865],'cm^-1')),
        HinderedRotor(inertia=(0.00594503,'amu*angstrom^2'), symmetry=1, barrier=(2.30761,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0059442,'amu*angstrom^2'), symmetry=1, barrier=(2.30943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00594204,'amu*angstrom^2'), symmetry=1, barrier=(2.30966,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83736,0.0532422,-6.76107e-05,6.27592e-08,-2.48161e-11,-7424.75,21.0857], Tmin=(100,'K'), Tmax=(773.397,'K')), NASAPolynomial(coeffs=[2.84203,0.0379818,-1.84938e-05,3.59459e-09,-2.52308e-13,-7279.16,18.4428], Tmin=(773.397,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.3345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CJC(C)C=O)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45968,0.0487831,-3.32284e-05,8.45918e-09,1.32089e-13,-11872.8,21.6665], Tmin=(100,'K'), Tmax=(1120.9,'K')), NASAPolynomial(coeffs=[12.4208,0.0197755,-7.93681e-06,1.46183e-09,-1.0159e-13,-14965,-35.2982], Tmin=(1120.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.5259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ)"""),
)
...
"""),
    E0 = (-48.1597,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,3000,3100,440,815,1455,1000,526.867,527.022,528.318],'cm^-1')),
        HinderedRotor(inertia=(0.093221,'amu*angstrom^2'), symmetry=1, barrier=(18.4071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.673435,'amu*angstrom^2'), symmetry=1, barrier=(18.4087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800524,'amu*angstrom^2'), symmetry=1, barrier=(18.4056,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21298,0.0527961,-3.45295e-05,2.46346e-09,4.01504e-12,-5684.42,20.1409], Tmin=(100,'K'), Tmax=(998.417,'K')), NASAPolynomial(coeffs=[14.7874,0.0160807,-5.91358e-06,1.08029e-09,-7.67239e-14,-9275.62,-49.7363], Tmin=(998.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.1597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(Allyl_P)"""),
)
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70986,0.0122373,7.36294e-05,-1.05697e-07,4.26284e-11,-39148,17.5501], Tmin=(100,'K'), Tmax=(914.147,'K')), NASAPolynomial(coeffs=[10.9579,0.0177613,-3.71941e-06,5.1037e-10,-3.57929e-14,-42394.8,-31.0122], Tmin=(914.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone)"""),
)

species(
    label = 'C=C(C)C(=O)O(866)',
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76727,0.0361371,1.63164e-05,-5.68998e-08,2.81822e-11,35108.1,23.2219], Tmin=(100,'K'), Tmax=(895.11,'K')), NASAPolynomial(coeffs=[15.2632,0.011112,-8.76349e-07,-5.62306e-11,6.30536e-15,31278.5,-48.2888], Tmin=(895.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(291.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(Cs_P) + radical(Isobutyl)"""),
)

species(
    label = 'CC1CO[C]1[O](954)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3962,0.0283742,1.68652e-05,-4.05969e-08,1.8342e-11,12281.4,19.9039], Tmin=(100,'K'), Tmax=(888.758,'K')), NASAPolynomial(coeffs=[7.60281,0.0237239,-6.98701e-06,1.07396e-09,-6.85175e-14,10614.1,-8.77427], Tmin=(888.758,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'CC1CC1([O])[O](955)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
2  O u1 p2 c0 {5,S}
3  C u0 p0 c0 {4,S} {5,S} {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22193,0.0311385,6.91385e-06,-2.38633e-08,9.14464e-12,10726.1,19.2983], Tmin=(100,'K'), Tmax=(1102.61,'K')), NASAPolynomial(coeffs=[8.54979,0.0263863,-1.13858e-05,2.1745e-09,-1.54033e-13,8224.07,-16.866], Tmin=(1102.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.5939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2][C](C)C(=O)O(956)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-135.466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
...
"""),
    E0 = (-120.271,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,638.298,638.304,638.32,638.348,638.366,638.408],'cm^-1')),
        HinderedRotor(inertia=(0.0110198,'amu*angstrom^2'), symmetry=1, barrier=(3.18638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0110212,'amu*angstrom^2'), symmetry=1, barrier=(3.18717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0110175,'amu*angstrom^2'), symmetry=1, barrier=(3.18603,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55151,0.0343151,-1.03977e-05,-1.59691e-09,8.41571e-13,-14415.4,19.0861], Tmin=(100,'K'), Tmax=(1779.59,'K')), NASAPolynomial(coeffs=[11.3411,0.025002,-1.13502e-05,2.0575e-09,-1.35057e-13,-19197.4,-33.0309], Tmin=(1779.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C([CH2])C(=O)O(959)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23761,0.0653408,-8.81965e-05,7.06176e-08,-2.34083e-11,-9229.43,22.7338], Tmin=(100,'K'), Tmax=(764.962,'K')), NASAPolynomial(coeffs=[7.81845,0.0291353,-1.36838e-05,2.61355e-09,-1.8159e-13,-10183.8,-6.90859], Tmin=(764.962,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-77.5289,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJC(C)C=O) + radical(CJC(C)C=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]CC([O])=O(847)'],
    products = ['[CH2]C(C)C([O])=O(873)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C=C([O])OC(952)'],
    products = ['[CH2]C(C)C([O])=O(873)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(7040,'s^-1'), n=2.66, Ea=(383.455,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H-inRing_N-2R!H->C',), comment="""Estimated from node Root_N-1R!H-inRing_N-2R!H->C"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(17)', 'CC=C([O])[O](905)'],
    products = ['[CH2]C(C)C([O])=O(873)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C)C([O])=O(873)'],
    products = ['CC1CC1([O])[O](955)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(1.34239e+09,'s^-1'), n=0.889391, Ea=(150.928,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs2H]
Euclidian distance = 1.4142135623730951
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(18)', 'C=CC([O])=O(850)'],
    products = ['[CH2]C(C)C([O])=O(873)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.000607818,'m^3/(mol*s)'), n=2.77033, Ea=(15.5974,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-1.134236632118343, var=4.055895237115788, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R-inRing_3R->C_Ext-1R!H-R_N-Sp-2R!H-=1R!H_Sp-2R!H=1R!H_N-2R!H->S_4R!H-u0_N-4R!H-inRing_2CO->C_Sp-4R!H-1R!H',), comment="""Estimated from node Root_N-3R-inRing_3R->C_Ext-1R!H-R_N-Sp-2R!H-=1R!H_Sp-2R!H=1R!H_N-2R!H->S_4R!H-u0_N-4R!H-inRing_2CO->C_Sp-4R!H-1R!H"""),
)
