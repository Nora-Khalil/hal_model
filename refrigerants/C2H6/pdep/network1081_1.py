...
"""),
    E0 = (80.514,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,2950,3100,1380,975,1025,1650,276.254],'cm^-1')),
        HinderedRotor(inertia=(0.138531,'amu*angstrom^2'), symmetry=1, barrier=(7.50226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138531,'amu*angstrom^2'), symmetry=1, barrier=(7.50226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234942,'amu*angstrom^2'), symmetry=1, barrier=(12.7235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68419,0.0548241,-5.37099e-05,3.28466e-08,-8.87793e-12,9763.62,22.2265], Tmin=(100,'K'), Tmax=(864.427,'K')), NASAPolynomial(coeffs=[6.53095,0.0323977,-1.47964e-05,2.83723e-09,-1.99414e-13,8925.64,-0.450466], Tmin=(864.427,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CJC(C)C=O)"""),
)
...
"""),
    E0 = (177.279,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,575.013,2631.21],'cm^-1')),
        HinderedRotor(inertia=(0.502293,'amu*angstrom^2'), symmetry=1, barrier=(11.5487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.50223,'amu*angstrom^2'), symmetry=1, barrier=(11.5473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0492243,'amu*angstrom^2'), symmetry=1, barrier=(11.5478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519553,'amu*angstrom^2'), symmetry=1, barrier=(76.5683,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04616,0.0623618,-6.0308e-05,3.25977e-08,-7.15047e-12,21430.3,26.7134], Tmin=(100,'K'), Tmax=(1101.89,'K')), NASAPolynomial(coeffs=[11.4386,0.0246348,-8.94887e-06,1.52348e-09,-1.00054e-13,19140.1,-24.4323], Tmin=(1101.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOH) + radical(Isobutyl)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10582,0.0587444,-5.1323e-05,2.48325e-08,-4.88552e-12,29464,27.3531], Tmin=(100,'K'), Tmax=(1221.52,'K')), NASAPolynomial(coeffs=[11.7783,0.0237959,-8.40677e-06,1.41003e-09,-9.17883e-14,26856.7,-26.2712], Tmin=(1221.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['O(7)', '[CH2]C([CH2])C=C(381)'],
    products = ['[CH2]C(C=C)C[O](1845)'],
    transitionState = 'TS5',
