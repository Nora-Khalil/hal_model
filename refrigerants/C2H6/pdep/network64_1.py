...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[CH2]C[O](92)'],
    products = ['[CH2]CC[O](103)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](117)', '[CH2][CH2](39)'],
    products = ['[CH2]CC[O](103)'],
