...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CO[C]=C(475)'],
    products = ['[CH]=C(C)O[C]=C(1163)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH]=C(C)OC#C(1140)'],
    products = ['[CH]=C(C)O[C]=C(1163)'],
    transitionState = 'TS8',
