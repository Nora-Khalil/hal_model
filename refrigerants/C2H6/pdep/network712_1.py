...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C1=CO[CH]O1(1396)'],
    products = ['C=C=COC=O(1177)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH2]C#COC=O(1405)'],
    products = ['C=C=COC=O(1177)'],
