...
"""),
    E0 = (536.406,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,359.641,359.648,359.649,359.673],'cm^-1')),
        HinderedRotor(inertia=(0.00130323,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0013032,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202003,'amu*angstrom^2'), symmetry=1, barrier=(18.5427,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
...
"""),
    E0 = (525.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,437.969,438.694,438.775,438.8,2066.63,2066.78],'cm^-1')),
        HinderedRotor(inertia=(0.00087678,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00087538,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.041839,'amu*angstrom^2'), symmetry=1, barrier=(5.71606,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
...
"""),
    ...
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3933,0.039776,2.64906e-05,-7.81581e-08,3.82025e-11,14404.7,15.9262], Tmin=(100,'K'), Tmax=(896.166,'K')), NASAPolynomial(coeffs=[19.4016,0.00695711,1.81658e-06,-5.8313e-10,4.13842e-14,9267.2,-79.6346], Tmin=(896.166,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C=CC(=C)O(2506)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2433,0.0466741,7.89963e-07,-4.47857e-08,2.38842e-11,-4451.11,20.4974], Tmin=(100,'K'), Tmax=(920.214,'K')), NASAPolynomial(coeffs=[17.5626,0.0120974,-2.11768e-06,2.59848e-10,-1.90758e-14,-8994.06,-65.242], Tmin=(920.214,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.9415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CC=CCJ)"""),
)

species(
    label = '[CH2][CH][CH]C([CH2])[O](2507)',
...
"""),
    E0 = (700.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3050,390,425,1340,1360,335,370,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1166.45,1166.48,1166.48],'cm^-1')),
        HinderedRotor(inertia=(0.135373,'amu*angstrom^2'), symmetry=1, barrier=(3.11249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00322403,'amu*angstrom^2'), symmetry=1, barrier=(3.11256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135307,'amu*angstrom^2'), symmetry=1, barrier=(3.11096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135329,'amu*angstrom^2'), symmetry=1, barrier=(3.11147,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61829,0.0547808,-5.28655e-05,3.06286e-08,-7.61424e-12,84393.3,30.224], Tmin=(100,'K'), Tmax=(948.634,'K')), NASAPolynomial(coeffs=[7.65214,0.029338,-1.2634e-05,2.35478e-09,-1.62902e-13,83248.6,1.4325], Tmin=(948.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(700.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(RCCJC) + radical(CJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C[C]1CO1(2508)',
    structure = adjacencyList("""multiplicity 4
...
"""),
    ...
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6481,0.053006,-5.67555e-05,4.01908e-08,-1.14277e-11,51657,25.3206], Tmin=(100,'K'), Tmax=(1038.24,'K')), NASAPolynomial(coeffs=[5.53729,0.0290672,-9.23214e-06,1.36805e-09,-7.91908e-14,51332,8.73597], Tmin=(1038.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1C[C]([O])C1(2509)',
    structure = adjacencyList("""multiplicity 4
1  O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4398,0.0248176,2.88574e-05,-4.73236e-08,1.78573e-11,39601,22.0569], Tmin=(100,'K'), Tmax=(1003.85,'K')), NASAPolynomial(coeffs=[7.38531,0.0282435,-1.08269e-05,1.98601e-09,-1.39529e-13,37442.6,-7.62663], Tmin=(1003.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopentane) + radical(CC(C)OJ) + radical(cyclopentane) + radical(C2CsJOH)"""),
)
...
"""),
    ...
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62808,0.0429829,-8.9448e-06,-1.64082e-08,8.46977e-12,51619,22.3048], Tmin=(100,'K'), Tmax=(1045.47,'K')), NASAPolynomial(coeffs=[11.6087,0.0241696,-9.74776e-06,1.82836e-09,-1.29537e-13,48473.4,-31.3533], Tmin=(1045.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CC(C)2OJ) + radical(cyclobutane) + radical(CJC(C)2O)"""),
)
...
"""),
    E0 = (375.975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,688.838,693.149],'cm^-1')),
        HinderedRotor(inertia=(0.00625308,'amu*angstrom^2'), symmetry=1, barrier=(2.10279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00274841,'amu*angstrom^2'), symmetry=1, barrier=(21.8913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.54233,'amu*angstrom^2'), symmetry=1, barrier=(82.4637,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53574,0.047062,-2.59973e-05,-3.4381e-09,5.97695e-12,45314.5,24.3495], Tmin=(100,'K'), Tmax=(952.504,'K')), NASAPolynomial(coeffs=[12.6541,0.0172657,-5.67957e-06,9.62713e-10,-6.55929e-14,42430,-32.772], Tmin=(952.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(375.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ) + radical(Allyl_S) + radical(RCCJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=C([O])C[CH][CH2](1029)',
    structure = adjacencyList("""multiplicity 5
1  O u1 p2 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u1 p0 c0 {2,S} {5,S} {9,S}
...
"""),
    E0 = (529.733,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,3182.32,3183.17],'cm^-1')),
        HinderedRotor(inertia=(0.148874,'amu*angstrom^2'), symmetry=1, barrier=(79.4294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197004,'amu*angstrom^2'), symmetry=1, barrier=(4.52951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.738281,'amu*angstrom^2'), symmetry=1, barrier=(16.9745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6408,0.0529514,-5.48756e-05,3.31422e-08,-8.30605e-12,63796.2,27.2785], Tmin=(100,'K'), Tmax=(958.366,'K')), NASAPolynomial(coeffs=[8.54686,0.0241268,-9.76e-06,1.7583e-09,-1.19153e-13,62472.5,-5.74555], Tmin=(958.366,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(529.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(RCCJC) + radical(RCCJ) + radical(Cds_P)"""),
)
...
"""),
    E0 = (170.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,350,440,435,1725,3000,3100,440,815,1455,1000,180,180.022],'cm^-1')),
        HinderedRotor(inertia=(0.0075196,'amu*angstrom^2'), symmetry=1, barrier=(1.95537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00783115,'amu*angstrom^2'), symmetry=1, barrier=(2.05883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0695467,'amu*angstrom^2'), symmetry=1, barrier=(18.3979,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49459,0.0463746,-1.5705e-05,-1.54902e-08,1.0332e-11,20632,22.0175], Tmin=(100,'K'), Tmax=(952.982,'K')), NASAPolynomial(coeffs=[12.8894,0.0195112,-6.42014e-06,1.0988e-09,-7.56647e-14,17508.2,-37.4018], Tmin=(952.982,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ) + radical(Allyl_S) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2][CH]C=C([CH2])O(2514)',
    structure = adjacencyList("""multiplicity 4
1  O u0 p2 c0 {2,S} {13,S}
...
"""),
    ...
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18297,0.0508659,-1.7818e-05,-2.15182e-08,1.45002e-11,28756.8,24.1152], Tmin=(100,'K'), Tmax=(933.565,'K')), NASAPolynomial(coeffs=[16.3362,0.0140026,-3.67835e-06,5.83893e-10,-4.12314e-14,24704.6,-54.4985], Tmin=(933.565,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(C=C(O)CJ) + radical(RCCJ)"""),
)

species(
    label = '[CH]=C(O)C[CH][CH2](1033)',
    structure = adjacencyList("""multiplicity 4
...
"""),
    E0 = (391.928,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,281.453],'cm^-1')),
        HinderedRotor(inertia=(0.00212205,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00212541,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00212582,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248427,'amu*angstrom^2'), symmetry=1, barrier=(14.0012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04317,0.0597058,-5.72712e-05,2.90689e-08,-5.86245e-12,47249,27.9179], Tmin=(100,'K'), Tmax=(1206.69,'K')), NASAPolynomial(coeffs=[13.3157,0.0190241,-6.70105e-06,1.13014e-09,-7.41406e-14,44287.2,-33.5958], Tmin=(1206.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([O])CC[CH2](1030)',
    structure = adjacencyList("""multiplicity 4
1  O u1 p2 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0887171,'amu*angstrom^2'), symmetry=1, barrier=(2.03978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0701819,'amu*angstrom^2'), symmetry=1, barrier=(18.417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800999,'amu*angstrom^2'), symmetry=1, barrier=(18.4165,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
...
"""),
    E0 = (324.487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,350,440,435,1725,3120,650,792.5,1650,180,2356.05],'cm^-1')),
        HinderedRotor(inertia=(0.00330298,'amu*angstrom^2'), symmetry=1, barrier=(12.9944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0414658,'amu*angstrom^2'), symmetry=1, barrier=(13.0916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.569344,'amu*angstrom^2'), symmetry=1, barrier=(13.0903,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57621,0.0525886,-4.5914e-05,2.30289e-08,-4.84488e-12,39114.6,25.7202], Tmin=(100,'K'), Tmax=(1122.89,'K')), NASAPolynomial(coeffs=[9.0831,0.0258472,-1.01918e-05,1.82039e-09,-1.23018e-13,37428.7,-11.3663], Tmin=(1122.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(RCCJC) + radical(Cds_P)"""),
)

species(
    label = '[CH2][CH]CC[C]=O(991)',
    structure = adjacencyList("""multiplicity 4
1  O u0 p2 c0 {6,D}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    E0 = (308.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1855,455,950,180,1902.63],'cm^-1')),
        HinderedRotor(inertia=(0.198222,'amu*angstrom^2'), symmetry=1, barrier=(4.55752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197768,'amu*angstrom^2'), symmetry=1, barrier=(4.54708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00177274,'amu*angstrom^2'), symmetry=1, barrier=(4.55428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198175,'amu*angstrom^2'), symmetry=1, barrier=(4.55644,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68037,0.0574378,-7.8538e-05,7.14527e-08,-2.62195e-11,37213.7,27.5467], Tmin=(100,'K'), Tmax=(841.123,'K')), NASAPolynomial(coeffs=[3.32792,0.0360822,-1.63422e-05,3.04617e-09,-2.07501e-13,37414.8,22.7264], Tmin=(841.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(RCCJ) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.39708,0.0233833,3.96739e-05,-6.31236e-08,2.4617e-11,6843.41,20.2644], Tmin=(100,'K'), Tmax=(970.548,'K')), NASAPolynomial(coeffs=[9.01303,0.0255461,-9.15275e-06,1.65825e-09,-1.17703e-13,4173.11,-18.5967], Tmin=(970.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.3311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutanone) + radical(Isobutyl)"""),
)

species(
    label = 'C=CC=C(C)[O](2515)',
    structure = adjacencyList("""multiplicity 2
1  O u1 p2 c0 {3,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {2,S} {4,D}
...
"""),
    ...
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37494,0.0475809,-1.44792e-05,-2.06113e-08,1.30872e-11,-2164.33,20.7811], Tmin=(100,'K'), Tmax=(943.58,'K')), NASAPolynomial(coeffs=[14.6224,0.0165059,-4.95386e-06,8.31258e-10,-5.82182e-14,-5780.96,-48.2777], Tmin=(943.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.8581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH2][C]1CC([CH2])O1(2516)',
    structure = adjacencyList("""multiplicity 4
1  O u0 p2 c0 {2,S} {4,S}
2  C u0 p0 c0 {1,S} {3,S} {5,S} {7,S}
3  C u0 p0 c0 {2,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.913941,0.0682596,-8.66426e-05,6.13005e-08,-1.65879e-11,52135.5,21.7911], Tmin=(100,'K'), Tmax=(1072.36,'K')), NASAPolynomial(coeffs=[9.93396,0.0226116,-6.00229e-06,7.30801e-10,-3.40576e-14,50891.1,-19.1377], Tmin=(1072.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(432.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C]1C[CH]CO1(2517)',
    structure = adjacencyList("""multiplicity 4
1  O u0 p2 c0 {3,S} {4,S}
2  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03615,0.0377511,1.32205e-06,-3.2546e-08,1.84001e-11,42908.7,19.3623], Tmin=(100,'K'), Tmax=(827.834,'K')), NASAPolynomial(coeffs=[9.17346,0.0223447,-5.33505e-06,6.56973e-10,-3.50224e-14,41073.2,-17.6714], Tmin=(827.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(C2CsJOCs) + radical(CCJCO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][CH]C=C(C)[O](2518)',
    structure = adjacencyList("""multiplicity 4
1  O u1 p2 c0 {3,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {2,S} {4,D}
...
"""),
    ...
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54579,0.0468081,-2.37049e-05,-1.60272e-09,3.78181e-12,26200.6,23.6247], Tmin=(100,'K'), Tmax=(1032.96,'K')), NASAPolynomial(coeffs=[11.365,0.0225754,-8.54211e-06,1.53625e-09,-1.0604e-13,23436.3,-27.6272], Tmin=(1032.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ) + radical(Allyl_S) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH2](261)', '[CH2]C(=C)[O](1103)'],
    products = ['[CH2][CH]CC(=C)[O](1034)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(7)', '[CH2][CH]C[C]=C(2461)'],
    products = ['[CH2][CH]CC(=C)[O](1034)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(6)', '[CH2][C]CC(=C)[O](2504)'],
    products = ['[CH2][CH]CC(=C)[O](1034)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[CH][CH]CC(=C)[O](2505)'],
    products = ['[CH2][CH]CC(=C)[O](1034)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Hrad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH][CH]C([CH2])[O](2507)'],
    products = ['[CH2][CH]CC(=C)[O](1034)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH]CC(=C)[O](1034)'],
    products = ['[CH2]C1C[C]([O])C1(2509)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(3.78932e+07,'s^-1'), n=1.19089, Ea=(138.015,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_Cs_HH_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 136.2 to 138.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]CC(=C)[O](1034)'],
    products = ['[O][C]1C[CH]CC1(2510)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]CC(=C)[O](1034)'],
    products = ['[CH2]C1([O])C[CH]C1(2511)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.36716e+08,'s^-1'), n=1.01412, Ea=(145.772,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 144.9 to 145.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['H(6)', '[CH2][CH]C=C([CH2])[O](2512)'],
    products = ['[CH2][CH]CC(=C)[O](1034)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(6)', '[CH]=C([O])C[CH][CH2](1029)'],
    products = ['[CH2][CH]CC(=C)[O](1034)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]CC(=C)[O](1034)'],
    products = ['[CH2][CH]C=C([CH2])O(2514)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=C(O)C[CH][CH2](1033)'],
    products = ['[CH2][CH]CC(=C)[O](1034)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(T)(17)', '[CH2][CH]C[C]=O(483)'],
    products = ['[CH2][CH]CC(=C)[O](1034)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2][CH]CC(=C)[O](1034)'],
    products = ['[CH2][C]1CC([CH2])O1(2516)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2][CH]CC(=C)[O](1034)'],
    products = ['[CH2][C]1C[CH]CO1(2517)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(1.19156e+09,'s^-1'), n=0.640131, Ea=(73.4939,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_linear;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_linear;carbonyl_intra;radadd_intra_cs2H]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic
Ea raised from 72.1 to 73.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction34',
    reactants = ['[CH2][CH]CC(=C)[O](1034)'],
    products = ['[CH2][CH]C=C(C)[O](2518)'],
