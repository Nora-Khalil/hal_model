...
"""),
    E0 = (350.356,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
"""),
    E0 = (416.63,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,211.318,829.991,906.114,1009.37,1110.31,1211.25,1312.18,1449.53,1556.23,1659.98],'cm^-1')),
        HinderedRotor(inertia=(0.142294,'amu*angstrom^2'), symmetry=1, barrier=(3.52153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142294,'amu*angstrom^2'), symmetry=1, barrier=(3.52153,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5083,0.0207967,4.19092e-05,-6.33871e-08,2.40808e-11,50173.3,20.6106], Tmin=(100,'K'), Tmax=(988.183,'K')), NASAPolynomial(coeffs=[8.89748,0.0247592,-9.37808e-06,1.75568e-09,-1.2654e-13,47454.4,-17.5057], Tmin=(988.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(416.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[CH]C1CC1(2209)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (361.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80099,0.034799,3.1345e-05,-5.88337e-08,2.30188e-11,43566.9,25.6036], Tmin=(100,'K'), Tmax=(1007.14,'K')), NASAPolynomial(coeffs=[10.8931,0.0314011,-1.23154e-05,2.31746e-09,-1.66117e-13,40076.4,-26.562], Tmin=(1007.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(361.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_S) + radical(RCCJ)"""),
)
...
"""),
    E0 = (362.978,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89247,0.0285667,5.75246e-05,-9.12229e-08,3.58046e-11,10046.4,20.5341], Tmin=(100,'K'), Tmax=(972.843,'K')), NASAPolynomial(coeffs=[12.74,0.0282096,-1.01442e-05,1.89807e-09,-1.39067e-13,5842.11,-42.2612], Tmin=(972.843,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99417,0.024787,6.9588e-05,-1.04681e-07,4.08369e-11,10786.1,20.0504], Tmin=(100,'K'), Tmax=(966.274,'K')), NASAPolynomial(coeffs=[13.0925,0.0272914,-9.50692e-06,1.77755e-09,-1.31528e-13,6379.54,-44.815], Tmin=(966.274,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.9351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
"""),
    E0 = (335.3,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,962.396],'cm^-1')),
        HinderedRotor(inertia=(0.00540088,'amu*angstrom^2'), symmetry=1, barrier=(3.54964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154398,'amu*angstrom^2'), symmetry=1, barrier=(3.54992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154399,'amu*angstrom^2'), symmetry=1, barrier=(3.54995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.621922,'amu*angstrom^2'), symmetry=1, barrier=(14.2992,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32874,0.0502837,-1.63578e-05,-7.97728e-09,4.90707e-12,40430.5,27.2701], Tmin=(100,'K'), Tmax=(1119.91,'K')), NASAPolynomial(coeffs=[10.7032,0.0322957,-1.30188e-05,2.38974e-09,-1.65157e-13,37359.1,-23.3564], Tmin=(1119.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(RCCJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93292,0.0292621,4.72061e-05,-7.91404e-08,3.14385e-11,34728.9,22.1755], Tmin=(100,'K'), Tmax=(974.831,'K')), NASAPolynomial(coeffs=[12.5098,0.0259555,-9.39874e-06,1.76084e-09,-1.28901e-13,30761.8,-38.3533], Tmin=(974.831,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(288.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC1C=CC1(2215)',
    structure = adjacencyList("""multiplicity 2
1  C u0 p0 c0 {2,S} {3,S} {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35109,0.0185838,7.29207e-05,-1.01186e-07,3.79813e-11,33025.1,22.1559], Tmin=(100,'K'), Tmax=(980.558,'K')), NASAPolynomial(coeffs=[10.7695,0.0287794,-1.08062e-05,2.05907e-09,-1.5157e-13,29233,-29.2108], Tmin=(980.558,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]C[C]1CCC1(2217)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22423,0.0255006,5.04548e-05,-7.16401e-08,2.56825e-11,40926.3,24.6616], Tmin=(100,'K'), Tmax=(1029.88,'K')), NASAPolynomial(coeffs=[8.21834,0.0363179,-1.49635e-05,2.85477e-09,-2.04623e-13,37883.3,-13.2122], Tmin=(1029.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Cs_S)"""),
)
...
"""),
    E0 = (357.06,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10329,0.0341884,1.55192e-05,-2.96717e-08,9.87434e-12,39828.2,24.3764], Tmin=(100,'K'), Tmax=(1167.39,'K')), NASAPolynomial(coeffs=[6.11116,0.0399462,-1.69228e-05,3.15704e-09,-2.18841e-13,37564.3,-1.26777], Tmin=(1167.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane)"""),
)

species(
    label = 'CCC1[CH]C[CH]1(2221)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {5,S} {6,S} {7,S}
2  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
...
"""),
    E0 = (332.948,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19547,0.027332,4.35256e-05,-6.34392e-08,2.26225e-11,40120,24.5563], Tmin=(100,'K'), Tmax=(1039.87,'K')), NASAPolynomial(coeffs=[7.6782,0.0371849,-1.53214e-05,2.90306e-09,-2.06562e-13,37306.7,-10.1532], Tmin=(1039.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = 'CCC1[CH][CH]C1(2222)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {5,S} {7,S}
2  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {6,S} {10,S} {11,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC1[CH]CC1(1891)'],
    products = ['C2H4(29)', 'C1=CCC1(69)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]CC1[CH]C1(2208)'],
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(17)', '[CH2]C1[CH]CC1(2210)'],
    products = ['[CH2]CC1[CH]CC1(1891)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['C2H4(29)', '[CH]1[CH]CC1(2183)'],
    products = ['[CH2]CC1[CH]CC1(1891)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00201083,'m^3/(mol*s)'), n=2.87982, Ea=(11.1025,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H',), comment="""Estimated from node Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction16',
    reactants = ['H(6)', 'C=CC1[CH]CC1(2216)'],
    products = ['[CH2]CC1[CH]CC1(1891)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH2](39)', '[CH]1[CH]CC1(2183)'],
    products = ['[CH2]CC1[CH]CC1(1891)'],
