...
"""),
    E0 = (230.359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,355.911,355.933,355.948,355.961],'cm^-1')),
        HinderedRotor(inertia=(0.00133055,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00133053,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197322,'amu*angstrom^2'), symmetry=1, barrier=(17.7412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197345,'amu*angstrom^2'), symmetry=1, barrier=(17.7411,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21692,0.0500506,-1.31889e-05,-2.25696e-08,1.34001e-11,27816,26.5424], Tmin=(100,'K'), Tmax=(965.3,'K')), NASAPolynomial(coeffs=[14.9904,0.0193721,-6.53427e-06,1.16223e-09,-8.26702e-14,23927.1,-45.7902], Tmin=(965.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23945,0.0441571,1.53125e-05,-5.96097e-08,2.83465e-11,-9019.9,21.6942], Tmin=(100,'K'), Tmax=(942.432,'K')), NASAPolynomial(coeffs=[18.0156,0.0145227,-3.68298e-06,6.29981e-10,-4.87506e-14,-14028,-68.0402], Tmin=(942.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (173.532,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1685,370,329.492,329.596,329.677],'cm^-1')),
        HinderedRotor(inertia=(0.181907,'amu*angstrom^2'), symmetry=1, barrier=(14.0439,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182097,'amu*angstrom^2'), symmetry=1, barrier=(14.0503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182289,'amu*angstrom^2'), symmetry=1, barrier=(14.0443,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.65424,0.0646709,-4.87239e-05,9.58119e-09,3.13206e-12,27115.7,25.539], Tmin=(100,'K'), Tmax=(969.077,'K')), NASAPolynomial(coeffs=[16.9401,0.0171675,-5.71706e-06,9.92424e-10,-6.90693e-14,23033.3,-57.2967], Tmin=(969.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(C=CJO)"""),
)

species(
    label = '[CH2]CCO[C]=C(732)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (235.703,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,180.001,181.626,503.978,506.446],'cm^-1')),
        HinderedRotor(inertia=(0.00776983,'amu*angstrom^2'), symmetry=1, barrier=(1.42506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0838794,'amu*angstrom^2'), symmetry=1, barrier=(15.3129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.085142,'amu*angstrom^2'), symmetry=1, barrier=(15.3114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0835056,'amu*angstrom^2'), symmetry=1, barrier=(15.3105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04866,0.0561204,-3.2655e-05,-3.98445e-10,4.97528e-12,28462.6,26.4366], Tmin=(100,'K'), Tmax=(997.471,'K')), NASAPolynomial(coeffs=[14.3448,0.0211638,-7.70159e-06,1.37997e-09,-9.62074e-14,24896.6,-42.2552], Tmin=(997.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC[CH]C(733)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {5,S}
2  C u0 p0 c0 {1,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {4,S} {9,S} {10,S} {11,S}
...
"""),
    E0 = (237.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,407.059,407.071,407.084],'cm^-1')),
        HinderedRotor(inertia=(0.146214,'amu*angstrom^2'), symmetry=1, barrier=(17.1936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146211,'amu*angstrom^2'), symmetry=1, barrier=(17.1934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146203,'amu*angstrom^2'), symmetry=1, barrier=(17.1936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146215,'amu*angstrom^2'), symmetry=1, barrier=(17.1934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.943719,0.0516911,-2.5235e-06,-4.45505e-08,2.39565e-11,28714.3,24.7977], Tmin=(100,'K'), Tmax=(935.951,'K')), NASAPolynomial(coeffs=[19.2935,0.0125441,-2.72826e-06,4.2937e-10,-3.35358e-14,23559.2,-71.7044], Tmin=(935.951,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(Cds_P)"""),
)

species(
    label = 'C=CO[CH][CH]C(734)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (277.553,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,383.772,383.772,383.772],'cm^-1')),
        HinderedRotor(inertia=(0.136082,'amu*angstrom^2'), symmetry=1, barrier=(14.2225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136082,'amu*angstrom^2'), symmetry=1, barrier=(14.2225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136082,'amu*angstrom^2'), symmetry=1, barrier=(14.2225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136082,'amu*angstrom^2'), symmetry=1, barrier=(14.2225,'kJ/mol'), semiclassical=False),
    ],
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05658,0.0488812,3.74757e-06,-4.9751e-08,2.54582e-11,23677.2,25.7759], Tmin=(100,'K'), Tmax=(938.13,'K')), NASAPolynomial(coeffs=[18.8197,0.0131282,-3.01985e-06,4.91605e-10,-3.82945e-14,18584.8,-68.1643], Tmin=(938.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(195.861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJ)"""),
)
...
reaction(
    ...
    products = ['C=[C]OC[CH]C(527)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(59.1928,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(2.76037,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction13',
    reactants = ['C=[C]OC[CH]C(527)'],
    products = ['C=[C]O[CH]CC(673)'],
