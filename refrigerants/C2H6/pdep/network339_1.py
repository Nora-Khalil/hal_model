...
reaction(
    label = 'reaction1',
    reactants = ['C=C([O])C[O](484)'],
    products = ['CH2O(19)', 'CH2CO(27)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH2]C(=C)[O](569)'],
    products = ['C=C([O])C[O](484)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](117)', '[CH2][C]=O(167)'],
    products = ['C=C([O])C[O](484)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(17)', '[O]C[C]=O(580)'],
    products = ['C=C([O])C[O](484)'],
