...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92609,0.0373485,-1.65522e-06,-2.65131e-08,1.39461e-11,34906,23.8828], Tmin=(100,'K'), Tmax=(927.476,'K')), NASAPolynomial(coeffs=[11.1309,0.0187513,-5.70426e-06,9.27191e-10,-6.23579e-14,32291,-24.7245], Tmin=(927.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(RCCJC) + radical(Cs_P)"""),
)

species(
    label = 'CC1C[C]([O])O1(976)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (-99.8758,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,350,440,435,1725,454.296,454.357],'cm^-1')),
        HinderedRotor(inertia=(0.118116,'amu*angstrom^2'), symmetry=1, barrier=(17.309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11816,'amu*angstrom^2'), symmetry=1, barrier=(17.31,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118043,'amu*angstrom^2'), symmetry=1, barrier=(17.3104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
"""),
    E0 = (-97.91,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,4000,4000,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.292718,'amu*angstrom^2'), symmetry=1, barrier=(6.73015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291564,'amu*angstrom^2'), symmetry=1, barrier=(6.70363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.81847,0.0333931,-5.41652e-05,6.38504e-08,-2.81737e-11,-11740.6,16.378], Tmin=(100,'K'), Tmax=(805.74,'K')), NASAPolynomial(coeffs=[-0.835682,0.0323826,-1.66315e-05,3.29631e-09,-2.32655e-13,-10530.1,37.0756], Tmin=(805.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C([O])=O(586)', '[CH]C(38)'],
    products = ['C[CH]CC([O])=O(871)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH]CC([O])=O(871)'],
    products = ['C[CH]C[C]1OO1(975)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(356.724,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_O]
