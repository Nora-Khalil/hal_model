...
"""),
    E0 = (422.964,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,345.374,350.49],'cm^-1')),
        HinderedRotor(inertia=(0.00138238,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1535,'amu*angstrom^2'), symmetry=1, barrier=(13.2434,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.978996,0.0575744,-6.39579e-05,3.4114e-08,-6.88427e-12,50987.1,26.592], Tmin=(100,'K'), Tmax=(1317.59,'K')), NASAPolynomial(coeffs=[16.5117,0.00647689,-1.29782e-06,1.38573e-10,-6.84618e-15,47236.2,-51.3297], Tmin=(1317.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(C=C(C)OJ) + radical(CJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]C([O])=C(C)[O](1230)',
    structure = adjacencyList("""multiplicity 5
1  O u1 p2 c0 {4,S}
2  O u1 p2 c0 {5,S}
...
"""),
    E0 = (187.275,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,423.981,423.981,423.983,424.007,424.028],'cm^-1')),
        HinderedRotor(inertia=(0.410735,'amu*angstrom^2'), symmetry=1, barrier=(52.3798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410649,'amu*angstrom^2'), symmetry=1, barrier=(52.3813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19532,0.0556512,-5.49768e-05,2.88003e-08,-5.9565e-12,22630.1,23.2626], Tmin=(100,'K'), Tmax=(1207.43,'K')), NASAPolynomial(coeffs=[12.8009,0.0164183,-5.26162e-06,8.11916e-10,-4.99109e-14,19884.8,-34.6783], Tmin=(1207.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.275,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(C)OJ) + radical(C=C(C)OJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C([O])=C1CO1(1231)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.747569,'amu*angstrom^2'), symmetry=1, barrier=(17.1881,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.0653,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26099,0.0578201,-6.9677e-05,3.5095e-08,-4.46425e-12,22813.5,19.7231], Tmin=(100,'K'), Tmax=(835.124,'K')), NASAPolynomial(coeffs=[15.2434,0.00498289,-1.61307e-07,-1.31994e-10,1.43244e-14,19985.2,-48.1656], Tmin=(835.124,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(O)C(=C)[O](1234)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (208.387,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,326.877,326.877,326.877,326.877],'cm^-1')),
        HinderedRotor(inertia=(0.666051,'amu*angstrom^2'), symmetry=1, barrier=(50.5014,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.666051,'amu*angstrom^2'), symmetry=1, barrier=(50.5014,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.666051,'amu*angstrom^2'), symmetry=1, barrier=(50.5014,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', 'C=[C]C(=C)[O](1172)'],
    products = ['C=C([O])C(=C)[O](1080)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2CO(27)', '[CH2][C]=O(189)'],
    products = ['C=C([O])C(=C)[O](1080)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]=O(189)', '[CH2][C]=O(189)'],
    products = ['C=C([O])C(=C)[O](1080)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[CH]=C([O])C(=C)[O](1233)'],
    products = ['C=C([O])C(=C)[O](1080)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(T)(17)', '[CH2]C([O])=C=O(1236)'],
    products = ['C=C([O])C(=C)[O](1080)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=C([O])C(=C)[O](1080)'],
    products = ['[CH2]C1=C([CH2])OO1(1238)'],
