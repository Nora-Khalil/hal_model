...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72609,0.0410097,-3.07877e-06,-1.75672e-08,7.0897e-12,-15810.1,20.6005], Tmin=(100,'K'), Tmax=(1186.34,'K')), NASAPolynomial(coeffs=[11.1846,0.0292481,-1.36593e-05,2.68136e-09,-1.91397e-13,-19470.8,-32.6175], Tmin=(1186.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC(C)C=C=O(653)',
    structure = adjacencyList("""1  O u0 p2 c0 {6,D}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35295,0.0509393,-3.1584e-05,8.68845e-09,-6.16136e-13,-16120.7,21.468], Tmin=(100,'K'), Tmax=(1273.5,'K')), NASAPolynomial(coeffs=[11.6652,0.025626,-1.01043e-05,1.80765e-09,-1.21996e-13,-19321.1,-33.0289], Tmin=(1273.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-134.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (27.7668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,1855,455,950,459.526],'cm^-1')),
        HinderedRotor(inertia=(0.0814038,'amu*angstrom^2'), symmetry=1, barrier=(12.4915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0853446,'amu*angstrom^2'), symmetry=1, barrier=(12.4648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0829681,'amu*angstrom^2'), symmetry=1, barrier=(12.4631,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64313,0.044088,-1.85055e-05,-2.79303e-09,2.62497e-12,3430.72,21.7175], Tmin=(100,'K'), Tmax=(1246.3,'K')), NASAPolynomial(coeffs=[12.1488,0.0241776,-1.11604e-05,2.16752e-09,-1.53287e-13,-260.26,-35.5816], Tmin=(1246.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.7668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (76.2087,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2120,512.5,787.5,295.041],'cm^-1')),
        HinderedRotor(inertia=(0.172407,'amu*angstrom^2'), symmetry=1, barrier=(10.6457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172432,'amu*angstrom^2'), symmetry=1, barrier=(10.6463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172463,'amu*angstrom^2'), symmetry=1, barrier=(10.6456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52872,0.0562704,-5.31313e-05,2.8874e-08,-6.64114e-12,9253.18,21.9338], Tmin=(100,'K'), Tmax=(1025.01,'K')), NASAPolynomial(coeffs=[8.68319,0.0283509,-1.22739e-05,2.30031e-09,-1.59833e-13,7786.5,-12.7591], Tmin=(1025.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.2087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(CJC(C)C=C=O)"""),
)

species(
    label = 'C[C](C)C[C]=O(655)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55898,0.061213,-8.4818e-05,7.94865e-08,-2.98895e-11,10358.8,23.6216], Tmin=(100,'K'), Tmax=(837.27,'K')), NASAPolynomial(coeffs=[2.44211,0.0406461,-1.86836e-05,3.50769e-09,-2.39923e-13,10784,22.9397], Tmin=(837.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.4581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Tertalkyl) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C(C)C=C[O](656)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {6,S}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37497,0.0431327,1.36107e-05,-5.6058e-08,2.7219e-11,10869.8,24.551], Tmin=(100,'K'), Tmax=(923.92,'K')), NASAPolynomial(coeffs=[16.3239,0.0160905,-3.65569e-06,5.3864e-10,-3.83413e-14,6499.35,-55.0885], Tmin=(923.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.4784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Isobutyl)"""),
)

species(
    label = 'CC(C)[CH][C]=O(657)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {6,D}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {7,S}
3  C u0 p0 c0 {2,S} {9,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44898,0.0496051,-2.77472e-05,3.64033e-09,1.58985e-12,8223.54,22.644], Tmin=(100,'K'), Tmax=(1071.66,'K')), NASAPolynomial(coeffs=[10.5363,0.0262688,-9.89532e-06,1.74919e-09,-1.1852e-13,5668.18,-24.6609], Tmin=(1071.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.5649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2][C](C)CC=O(658)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {5,D}
2  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
3  C u0 p0 c0 {4,S} {9,S} {10,S} {11,S}
...
"""),
    E0 = (130.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,2540.01],'cm^-1')),
        HinderedRotor(inertia=(0.145296,'amu*angstrom^2'), symmetry=1, barrier=(3.34064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145302,'amu*angstrom^2'), symmetry=1, barrier=(3.34077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14539,'amu*angstrom^2'), symmetry=1, barrier=(3.34281,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62102,0.0602556,-8.3278e-05,7.87312e-08,-2.95213e-11,15783.1,25.0557], Tmin=(100,'K'), Tmax=(855.386,'K')), NASAPolynomial(coeffs=[1.69631,0.0416613,-1.86815e-05,3.45438e-09,-2.33746e-13,16437.6,28.6052], Tmin=(855.386,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])CC=O(659)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {6,D}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {7,S}
3  C u0 p0 c0 {2,S} {6,S} {8,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.181404,'amu*angstrom^2'), symmetry=1, barrier=(4.17083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181471,'amu*angstrom^2'), symmetry=1, barrier=(4.17236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00894776,'amu*angstrom^2'), symmetry=1, barrier=(4.17297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00895575,'amu*angstrom^2'), symmetry=1, barrier=(4.17041,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55768,0.0543897,-4.79894e-05,2.71467e-08,-6.69965e-12,18157,25.2408], Tmin=(100,'K'), Tmax=(953.411,'K')), NASAPolynomial(coeffs=[6.97577,0.0316581,-1.22258e-05,2.13902e-09,-1.42185e-13,17123.8,-0.639864], Tmin=(953.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]CC[C]=O(469)'],
    products = ['[CH2]C(C)C[C]=O(531)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[C]=O(152)', '[CH2]C([CH2])C(290)'],
    products = ['[CH2]C(C)C[C]=O(531)'],
    transitionState = 'TS7',
