...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.74697,0.0125654,6.69251e-05,-1.02665e-07,4.37805e-11,-14905,12.7605], Tmin=(100,'K'), Tmax=(880.588,'K')), NASAPolynomial(coeffs=[11.7991,0.0116024,1.64182e-07,-3.37625e-10,2.7966e-14,-18056.1,-38.5999], Tmin=(880.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxolane)"""),
)
...
"""),
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84683,0.0510077,-6.5263e-05,5.25188e-08,-1.7789e-11,-8323.49,18.0258], Tmin=(100,'K'), Tmax=(775.669,'K')), NASAPolynomial(coeffs=[6.14846,0.0261421,-1.19895e-05,2.2727e-09,-1.57395e-13,-8910.12,-1.11412], Tmin=(775.669,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.8212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""CH2CHCH2OOH""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (204.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.124563,'amu*angstrom^2'), symmetry=1, barrier=(2.86395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00481618,'amu*angstrom^2'), symmetry=1, barrier=(2.86556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124321,'amu*angstrom^2'), symmetry=1, barrier=(2.8584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123968,'amu*angstrom^2'), symmetry=1, barrier=(2.85026,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12916,0.0440999,-4.2534e-05,2.4451e-08,-6.06466e-12,24693.7,22.9094], Tmin=(100,'K'), Tmax=(944.87,'K')), NASAPolynomial(coeffs=[6.84546,0.024134,-1.08377e-05,2.08721e-09,-1.47489e-13,23802.4,0.423385], Tmin=(944.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCJCOOH) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CCO[O](403)'],
    products = ['HO2(12)', '[CH2]C=C(214)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]CO[O](45)'],
    products = ['[CH2]CCO[O](403)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(60.9618,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(7)', '[CH2]CC[O](103)'],
    products = ['[CH2]CCO[O](403)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', '[CH2]CO[O](45)'],
    products = ['[CH2]CCO[O](403)'],
    transitionState = 'TS4',
