...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC[C]=C(1420)'],
    products = ['CH2O(19)', 'C=C=C(430)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', 'C=[C]C[O](147)'],
    products = ['[CH2]OC[C]=C(1420)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(57)', '[CH2]O[CH2](115)'],
    products = ['[CH2]OC[C]=C(1420)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](117)', '[CH2][C]=C(431)'],
    products = ['[CH2]OC[C]=C(1420)'],
