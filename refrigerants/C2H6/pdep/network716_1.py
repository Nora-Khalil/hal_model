...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CC(=[CH])C(1124)'],
    products = ['[CH]=C(C)C(=[CH])C(1181)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(18)', '[CH]=C(C)C#C(1214)'],
    products = ['[CH]=C(C)C(=[CH])C(1181)'],
    transitionState = 'TS4',
