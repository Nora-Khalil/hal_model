...
"""),
    E0 = (36.8592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1855,455,950,298.247,301.059],'cm^-1')),
        HinderedRotor(inertia=(0.108103,'amu*angstrom^2'), symmetry=1, barrier=(7.14959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10886,'amu*angstrom^2'), symmetry=1, barrier=(7.17391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109768,'amu*angstrom^2'), symmetry=1, barrier=(7.15292,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88306,0.0471705,-3.34342e-05,1.2911e-08,-2.14669e-12,4508.58,22.7686], Tmin=(100,'K'), Tmax=(1342.11,'K')), NASAPolynomial(coeffs=[8.35825,0.027872,-1.18654e-05,2.1972e-09,-1.50994e-13,2770.5,-10.3757], Tmin=(1342.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.8592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (562.538,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1855,455,950,279.551,279.56,2993.08],'cm^-1')),
        HinderedRotor(inertia=(0.190045,'amu*angstrom^2'), symmetry=1, barrier=(10.5399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00215729,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190067,'amu*angstrom^2'), symmetry=1, barrier=(10.5398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.806861,'amu*angstrom^2'), symmetry=1, barrier=(44.7423,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72838,0.0558436,-5.74801e-05,2.35118e-08,3.6039e-12,67734,24.5958], Tmin=(100,'K'), Tmax=(583.227,'K')), NASAPolynomial(coeffs=[7.21743,0.0283577,-1.29199e-05,2.44578e-09,-1.69607e-13,66920.9,-0.40753], Tmin=(583.227,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(562.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CCJ2_triplet) + radical(CCCJ=O)"""),
)

species(
    label = '[CH][CH]CC[C]=O(2472)',
    structure = adjacencyList("""multiplicity 5
1  O u0 p2 c0 {5,D}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    E0 = (551.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,1855,455,950,215.323,245.124,405.228,1989.84,3303.4],'cm^-1')),
        HinderedRotor(inertia=(0.0202118,'amu*angstrom^2'), symmetry=1, barrier=(0.55554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0202118,'amu*angstrom^2'), symmetry=1, barrier=(0.55554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0202118,'amu*angstrom^2'), symmetry=1, barrier=(0.55554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0202118,'amu*angstrom^2'), symmetry=1, barrier=(0.55554,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57778,0.0599082,-8.80844e-05,7.94053e-08,-2.83179e-11,66439.6,27.1326], Tmin=(100,'K'), Tmax=(852.6,'K')), NASAPolynomial(coeffs=[4.5063,0.0321672,-1.46454e-05,2.7201e-09,-1.84301e-13,66449.2,16.4556], Tmin=(852.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(551.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCCJ=O) + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (204.389,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1855,455,950,214.508,2237.95],'cm^-1')),
        HinderedRotor(inertia=(0.00375383,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.50588,'amu*angstrom^2'), symmetry=1, barrier=(16.4685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.817884,'amu*angstrom^2'), symmetry=1, barrier=(26.4294,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
...
"""),
    E0 = (508.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,1855,455,950,1691.69,1692.11],'cm^-1')),
        HinderedRotor(inertia=(0.00211528,'amu*angstrom^2'), symmetry=1, barrier=(4.30542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188277,'amu*angstrom^2'), symmetry=1, barrier=(4.32887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187987,'amu*angstrom^2'), symmetry=1, barrier=(4.32219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188077,'amu*angstrom^2'), symmetry=1, barrier=(4.32425,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86172,0.0523742,-7.03985e-05,6.25047e-08,-2.25481e-11,61250.9,29.3925], Tmin=(100,'K'), Tmax=(839.685,'K')), NASAPolynomial(coeffs=[3.94113,0.0317022,-1.42377e-05,2.64605e-09,-1.80064e-13,61281.2,21.984], Tmin=(839.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(508.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(RCCJC) + radical(RCCJ) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2][CH]C[CH][C]=O(987)',
    structure = adjacencyList("""multiplicity 5
1  O u0 p2 c0 {6,D}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u1 p0 c0 {2,S} {5,S} {9,S}
...
"""),
    E0 = (476.299,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,1855,455,950,1239.71,1239.87],'cm^-1')),
        HinderedRotor(inertia=(0.165152,'amu*angstrom^2'), symmetry=1, barrier=(3.79717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165212,'amu*angstrom^2'), symmetry=1, barrier=(3.79854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00348346,'amu*angstrom^2'), symmetry=1, barrier=(3.79813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165241,'amu*angstrom^2'), symmetry=1, barrier=(3.7992,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83461,0.0511754,-6.13256e-05,4.91025e-08,-1.6521e-11,57360.1,26.7553], Tmin=(100,'K'), Tmax=(839.044,'K')), NASAPolynomial(coeffs=[5.14517,0.0296716,-1.2654e-05,2.30337e-09,-1.55372e-13,57005.9,12.5649], Tmin=(839.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(476.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCJCHO) + radical(RCCJ) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (292.061,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,403.429,403.932,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00102164,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198053,'amu*angstrom^2'), symmetry=1, barrier=(23.1322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.422321,'amu*angstrom^2'), symmetry=1, barrier=(49.0599,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55838,0.0454768,-1.65485e-05,-1.12393e-08,7.76647e-12,35222,26.8773], Tmin=(100,'K'), Tmax=(990.005,'K')), NASAPolynomial(coeffs=[11.9568,0.0215968,-7.84203e-06,1.39949e-09,-9.72249e-14,32274.4,-27.6726], Tmin=(990.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.061,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC[CH][C]=O(989)',
    structure = adjacencyList("""multiplicity 4
1  O u0 p2 c0 {6,D}
...
"""),
    E0 = (281.853,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1855,455,950,2537.9,2548.12],'cm^-1')),
        HinderedRotor(inertia=(0.746327,'amu*angstrom^2'), symmetry=1, barrier=(17.1595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00702054,'amu*angstrom^2'), symmetry=1, barrier=(3.70916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.747968,'amu*angstrom^2'), symmetry=1, barrier=(17.1973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.42485,'amu*angstrom^2'), symmetry=1, barrier=(78.744,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6661,0.0506141,-4.05288e-05,1.83483e-08,-3.52332e-12,33983.6,24.6233], Tmin=(100,'K'), Tmax=(1208.74,'K')), NASAPolynomial(coeffs=[8.90297,0.0266656,-1.08096e-05,1.95699e-09,-1.33155e-13,32234.1,-11.6624], Tmin=(1208.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCHO) + radical(RCCJ) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2][CH][CH]CC=O(2478)',
    structure = adjacencyList("""multiplicity 4
1  O u0 p2 c0 {5,D}
2  C u0 p0 c0 {3,S} {5,S} {7,S} {8,S}
3  C u1 p0 c0 {2,S} {4,S} {9,S}
...
"""),
    E0 = (348.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,1545.02,1545.27],'cm^-1')),
        HinderedRotor(inertia=(0.00202141,'amu*angstrom^2'), symmetry=1, barrier=(3.43052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150006,'amu*angstrom^2'), symmetry=1, barrier=(3.44893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149216,'amu*angstrom^2'), symmetry=1, barrier=(3.43077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149975,'amu*angstrom^2'), symmetry=1, barrier=(3.44822,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97762,0.0489055,-5.36881e-05,4.64061e-08,-1.77929e-11,42008.8,28.1583], Tmin=(100,'K'), Tmax=(784.857,'K')), NASAPolynomial(coeffs=[2.86227,0.037029,-1.69089e-05,3.20473e-09,-2.22145e-13,42096.9,25.5503], Tmin=(784.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(RCCJC) + radical(RCCJ)"""),
)
...
"""),
    E0 = (271.053,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,1855,455,950,2191.69,2191.71],'cm^-1')),
        HinderedRotor(inertia=(0.00212959,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112383,'amu*angstrom^2'), symmetry=1, barrier=(6.31307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20279,'amu*angstrom^2'), symmetry=1, barrier=(67.5719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112357,'amu*angstrom^2'), symmetry=1, barrier=(6.31314,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23116,0.0440143,-2.01377e-05,-2.09629e-08,2.52147e-11,32658.9,23.6182], Tmin=(100,'K'), Tmax=(539.705,'K')), NASAPolynomial(coeffs=[4.9977,0.0326276,-1.38305e-05,2.54717e-09,-1.74683e-13,32227.5,10.7473], Tmin=(539.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[CH][CH2](261)', '[CH2]C[C]=O(191)'],
    products = ['[CH2][CH]CC[C]=O(991)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[C]=O(179)', '[CH2][CH]C[CH2](60)'],
    products = ['[CH2][CH]CC[C]=O(991)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[CH2][C]CC[C]=O(2471)'],
    products = ['[CH2][CH]CC[C]=O(991)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH][CH]CC[C]=O(2472)'],
    products = ['[CH2][CH]CC[C]=O(991)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Hrad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', '[CH2][CH]C[CH][C]=O(987)'],
    products = ['[CH2][CH]CC[C]=O(991)'],
