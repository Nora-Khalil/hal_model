...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(152)', 'C[C]=C[O](1200)'],
    products = ['C[C]=CO[C]=O(1175)'],
    transitionState = 'TS2',
