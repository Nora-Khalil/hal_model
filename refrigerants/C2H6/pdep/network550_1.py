...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.1023,'amu*angstrom^2'), symmetry=1, barrier=(45.0406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10164,'amu*angstrom^2'), symmetry=1, barrier=(45.0291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10857,'amu*angstrom^2'), symmetry=1, barrier=(45.0156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12438,'amu*angstrom^2'), symmetry=1, barrier=(45.0451,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41971,0.0488238,-3.82828e-05,9.08097e-09,1.18557e-12,21976.8,23.5547], Tmin=(100,'K'), Tmax=(1039.11,'K')), NASAPolynomial(coeffs=[14.9546,0.0111534,-4.73651e-06,9.24268e-10,-6.76892e-14,18384.9,-46.0115], Tmin=(1039.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOOC) + radical(CJCOOH) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (456.444,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3100,440,815,1455,1000,1855,455,950,180],'cm^-1')),
        HinderedRotor(inertia=(1.67547,'amu*angstrom^2'), symmetry=1, barrier=(38.5224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67537,'amu*angstrom^2'), symmetry=1, barrier=(38.52,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67485,'amu*angstrom^2'), symmetry=1, barrier=(38.5081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67502,'amu*angstrom^2'), symmetry=1, barrier=(38.5121,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20712,0.0528455,-4.90867e-05,1.49307e-08,5.39262e-13,55005.7,22.7537], Tmin=(100,'K'), Tmax=(1004.92,'K')), NASAPolynomial(coeffs=[17.7002,0.00418992,-1.826e-06,4.05197e-10,-3.33806e-14,50832.8,-61.1659], Tmin=(1004.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(456.444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJCOOH) + radical(CH2_triplet) + radical((O)CJOC)"""),
)

species(
    label = '[CH][CH]OO[C]=O(1895)',
    structure = adjacencyList("""multiplicity 5
1 O u0 p2 c0 {2,S} {4,S}
2 O u0 p2 c0 {1,S} {6,S}
3 O u0 p2 c0 {6,D}
...
"""),
    E0 = (416.149,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,1855,455,950,392.94,392.94,392.949],'cm^-1')),
        HinderedRotor(inertia=(0.00109177,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439849,'amu*angstrom^2'), symmetry=1, barrier=(48.1954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439824,'amu*angstrom^2'), symmetry=1, barrier=(48.1959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439903,'amu*angstrom^2'), symmetry=1, barrier=(48.1959,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43568,0.0491184,-4.44676e-05,1.59179e-08,-1.18109e-12,50149.7,22.5066], Tmin=(100,'K'), Tmax=(1058.75,'K')), NASAPolynomial(coeffs=[15.163,0.00888841,-3.95131e-06,7.83118e-10,-5.77013e-14,46591,-47.5822], Tmin=(1058.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(416.149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOOC) + radical(CCJ2_triplet) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C]=O(215)', '[CH][CH2](261)'],
    products = ['[CH2][CH]OO[C]=O(1700)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(179)', '[CH2][CH]O[O](327)'],
    products = ['[CH2][CH]OO[C]=O(1700)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction5',
    reactants = ['H(6)', '[CH2][C]OO[C]=O(1894)'],
    products = ['[CH2][CH]OO[C]=O(1700)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(6)', '[CH][CH]OO[C]=O(1895)'],
    products = ['[CH2][CH]OO[C]=O(1700)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Hrad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['CO(14)', '[CH2][CH]O[O](327)'],
    products = ['[CH2][CH]OO[C]=O(1700)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['[CH2][CH]OO[C]=O(1700)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(157.341,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(215.848,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.47663e+07,'m^3/(mol*s)'), n=1.31229e-07, Ea=(2.57731,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C
Multiplied by reaction path degeneracy 2.0"""),
)
