...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(160)', '[C]=C(57)'],
    products = ['C=[C]OO[C]=O(889)'],
    transitionState = 'TS2',
