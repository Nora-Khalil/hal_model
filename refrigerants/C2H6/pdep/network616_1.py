...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[O]C([O])=C=O(1827)'],
    products = ['[O]C(=O)C([O])=O(1764)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C]=O(1769)', '[O][C]=O(1769)'],
    products = ['[O]C(=O)C([O])=O(1764)'],
    transitionState = 'TS8',
