...
reaction(
    label = 'reaction3',
    reactants = ['O(7)', '[CH2]C([CH2])=C(1454)'],
    products = ['[CH2]C(=C)C[O](1210)'],
    transitionState = 'TS3',
