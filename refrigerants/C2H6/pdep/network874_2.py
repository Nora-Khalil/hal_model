...
reaction(
    label = 'reaction1',
    reactants = ['H(6)', '[C]#C[CH2](1687)'],
    products = ['[CH]=C=C(1111)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C=C(1111)'],
    products = ['[C]1=CC1(1688)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]1=CC1(1688)'],
    products = ['[CH]1C=C1(2392)'],
