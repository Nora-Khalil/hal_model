...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71733,0.0436492,-1.99314e-05,-1.67136e-09,2.87996e-12,91894.2,21.1431], Tmin=(100,'K'), Tmax=(1086.14,'K')), NASAPolynomial(coeffs=[9.80847,0.0251486,-9.98306e-06,1.79861e-09,-1.2291e-13,89470.3,-21.6281], Tmin=(1086.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(763.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.86569,0.060656,-4.06414e-05,1.40133e-08,-1.98135e-12,89066.1,25.3595], Tmin=(100,'K'), Tmax=(1629.27,'K')), NASAPolynomial(coeffs=[13.9418,0.0285525,-1.10846e-05,1.91905e-09,-1.25537e-13,84805.2,-44.1079], Tmin=(1629.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(739.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C([CH2])[CH][CH]C(3532)',
...
"""),
    E0 = (844.727,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,218.46,797.733,1696.91,2518.68,3498.26],'cm^-1')),
        HinderedRotor(inertia=(0.0925959,'amu*angstrom^2'), symmetry=1, barrier=(2.14385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0925959,'amu*angstrom^2'), symmetry=1, barrier=(2.14385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0925959,'amu*angstrom^2'), symmetry=1, barrier=(2.14385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0925959,'amu*angstrom^2'), symmetry=1, barrier=(2.14385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0925959,'amu*angstrom^2'), symmetry=1, barrier=(2.14385,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0655,0.0491394,-1.19918e-05,-4.79291e-08,4.70676e-11,101660,28.9486], Tmin=(100,'K'), Tmax=(506.809,'K')), NASAPolynomial(coeffs=[4.7835,0.039205,-1.66775e-05,3.0752e-09,-2.10959e-13,101237,16.2237], Tmin=(506.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(844.727,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJC) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]1CC(C)C1(3533)',
    structure = adjacencyList("""multiplicity 4
1  C u0 p0 c0 {2,S} {3,S} {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94481,0.0337536,2.48822e-05,-4.82064e-08,1.85461e-11,70066.4,22.6184], Tmin=(100,'K'), Tmax=(1023.86,'K')), NASAPolynomial(coeffs=[9.32937,0.0322043,-1.28448e-05,2.40198e-09,-1.70223e-13,67123.3,-20.1699], Tmin=(1023.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(581.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1([CH2])CC1C(3490)',
    structure = adjacencyList("""multiplicity 4
1  C u0 p0 c0 {2,S} {3,S} {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46394,0.0373778,3.80574e-05,-7.885e-08,3.34218e-11,71525.8,22.2136], Tmin=(100,'K'), Tmax=(963.376,'K')), NASAPolynomial(coeffs=[16.4153,0.0207893,-6.94384e-06,1.30646e-09,-9.87395e-14,66534.1,-60.3164], Tmin=(963.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(593.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Neopentyl) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.12935,'amu*angstrom^2'), symmetry=1, barrier=(48.9579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13034,'amu*angstrom^2'), symmetry=1, barrier=(48.9807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12865,'amu*angstrom^2'), symmetry=1, barrier=(48.9419,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
...
"""),
    ...
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.993049,0.0579346,-3.03744e-05,5.26155e-09,4.50305e-13,59839,26.7803], Tmin=(100,'K'), Tmax=(1269.59,'K')), NASAPolynomial(coeffs=[11.5449,0.0342587,-1.37075e-05,2.44644e-09,-1.64393e-13,56388.5,-29.6822], Tmin=(1269.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=[CH])CCC(3536)',
    structure = adjacencyList("""multiplicity 4
1  C u0 p0 c0 {2,S} {3,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {4,S} {9,S} {10,S}
3  C u0 p0 c0 {1,S} {11,S} {12,S} {13,S}
4  C u0 p0 c0 {2,S} {5,S} {6,D}
5  C u2 p0 c0 {4,S} {14,S}
...
"""),
    E0 = (538.424,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,442.477,442.479,442.479,442.483],'cm^-1')),
        HinderedRotor(inertia=(0.379295,'amu*angstrom^2'), symmetry=1, barrier=(52.6982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379302,'amu*angstrom^2'), symmetry=1, barrier=(52.6981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379293,'amu*angstrom^2'), symmetry=1, barrier=(52.6981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379302,'amu*angstrom^2'), symmetry=1, barrier=(52.6981,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.807913,0.0614692,-3.86347e-05,1.23668e-08,-1.62276e-12,64879.6,25.3773], Tmin=(100,'K'), Tmax=(1737.01,'K')), NASAPolynomial(coeffs=[14.4117,0.0301423,-1.15822e-05,1.98406e-09,-1.28409e-13,60153.6,-47.7644], Tmin=(1737.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
"""),
    E0 = (784.567,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,350,440,435,1725,2950,3100,1380,975,1025,1650,288.667,288.67,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00202306,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224414,'amu*angstrom^2'), symmetry=1, barrier=(13.2701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.685637,'amu*angstrom^2'), symmetry=1, barrier=(40.5434,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58649,0.0540843,-4.15394e-05,1.80816e-08,-3.40912e-12,94447.6,22.9313], Tmin=(100,'K'), Tmax=(1205.35,'K')), NASAPolynomial(coeffs=[8.42458,0.031392,-1.33001e-05,2.46289e-09,-1.69684e-13,92799.1,-11.3357], Tmin=(1205.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(784.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJC) + radical(CJ3)"""),
)

species(
    label = 'C[CH]CC1=CC1(3538)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59256,0.0448993,-9.29425e-06,-1.36613e-08,6.8629e-12,46231.9,24.0471], Tmin=(100,'K'), Tmax=(1068.7,'K')), NASAPolynomial(coeffs=[9.69049,0.0307289,-1.20572e-05,2.19287e-09,-1.5137e-13,43579.4,-19.8707], Tmin=(1068.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJC)"""),
)
...
"""),
    ...
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22076,0.0225185,6.28441e-05,-9.03905e-08,3.39511e-11,27056.4,17.5106], Tmin=(100,'K'), Tmax=(989.753,'K')), NASAPolynomial(coeffs=[10.6378,0.0300812,-1.16324e-05,2.21954e-09,-1.62202e-13,23353.7,-33.2986], Tmin=(989.753,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Allyl_S)"""),
)

species(
    label = '[CH]=C(C)C=CC(2226)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    E0 = (420.195,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,514.828,514.878,514.878,514.896],'cm^-1')),
        HinderedRotor(inertia=(0.279675,'amu*angstrom^2'), symmetry=1, barrier=(52.6119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.279639,'amu*angstrom^2'), symmetry=1, barrier=(52.6176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.279695,'amu*angstrom^2'), symmetry=1, barrier=(52.6162,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.279684,'amu*angstrom^2'), symmetry=1, barrier=(52.6152,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27461,0.0514161,-1.32731e-05,-1.04129e-08,5.34717e-12,50642.9,22.4326], Tmin=(100,'K'), Tmax=(1140.16,'K')), NASAPolynomial(coeffs=[9.81308,0.0371559,-1.51607e-05,2.76413e-09,-1.89414e-13,47675.7,-24.3543], Tmin=(1140.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(420.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)
...
"""),
    E0 = (567.432,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3120,650,792.5,1650,1575.32],'cm^-1')),
        HinderedRotor(inertia=(0.155401,'amu*angstrom^2'), symmetry=1, barrier=(3.57298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153779,'amu*angstrom^2'), symmetry=1, barrier=(3.53568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157322,'amu*angstrom^2'), symmetry=1, barrier=(3.61715,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157331,'amu*angstrom^2'), symmetry=1, barrier=(3.61736,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C(=C)C([CH2])C(2187)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C(38)', '[CH]C([CH2])=C(2970)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(18)', '[CH]CC([CH])=C(3230)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(6)', '[CH]C(=C)C[C]C(3531)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]C([CH2])[CH][CH]C(3532)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', '[CH]C(=C)C=CC(2362)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[CH]C(=C)CC=C(2876)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[CH]C([CH2])=C[CH]C(3534)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', '[CH]C(=C)C[CH][CH2](2592)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH]C(=[CH])C[CH]C(3535)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(6)', '[C]C(=C)C[CH]C(3537)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C(C)C[CH][CH2](2230)'],
    products = ['[CH]C(=C)C[CH]C(2229)'],
