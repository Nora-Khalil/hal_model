...
"""),
    E0 = (695.451,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2175,525,750,770,3400,2100,259.455,259.584],'cm^-1')),
        HinderedRotor(inertia=(0.232935,'amu*angstrom^2'), symmetry=1, barrier=(11.1183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.389938,'amu*angstrom^2'), symmetry=1, barrier=(18.6353,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.530702,'amu*angstrom^2'), symmetry=1, barrier=(25.3444,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0845,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54954,0.0579629,-8.00153e-05,6.11858e-08,-1.90163e-11,83727.9,19.6815], Tmin=(100,'K'), Tmax=(783.534,'K')), NASAPolynomial(coeffs=[8.66046,0.021658,-1.05072e-05,2.04009e-09,-1.43272e-13,82613.7,-12.8893], Tmin=(783.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(695.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'CC1=CC=[C]O1(1735)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.84103,0.0183817,2.40924e-05,-3.44145e-08,1.1485e-11,18179.1,19.294], Tmin=(100,'K'), Tmax=(1117.34,'K')), NASAPolynomial(coeffs=[6.14747,0.0257489,-1.15791e-05,2.2517e-09,-1.60727e-13,16241.5,-2.38884], Tmin=(1117.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + ring(Furan) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1C=C(C)O1(1736)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {3,S} {5,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {2,S} {4,D}
...
"""),
    ...
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87029,0.0363422,-6.85434e-08,-2.90203e-08,1.44741e-11,36475.4,17.3696], Tmin=(100,'K'), Tmax=(971.304,'K')), NASAPolynomial(coeffs=[13.2559,0.0145026,-5.02334e-06,9.30534e-10,-6.83972e-14,33082.1,-43.31], Tmin=(971.304,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Cds_P)"""),
)
...
"""),
    E0 = (508.033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,2175,525,750,770,3400,2100,252.153,253.401,260.364,260.611,261.565],'cm^-1')),
        HinderedRotor(inertia=(1.02616,'amu*angstrom^2'), symmetry=1, barrier=(49.3284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02235,'amu*angstrom^2'), symmetry=1, barrier=(49.49,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04285,'amu*angstrom^2'), symmetry=1, barrier=(49.4934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0845,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53727,0.0521665,-4.49545e-05,2.04353e-08,-3.81542e-12,61192.5,20.4493], Tmin=(100,'K'), Tmax=(1263.26,'K')), NASAPolynomial(coeffs=[10.944,0.0223812,-9.58736e-06,1.77086e-09,-1.21738e-13,58815.9,-27.1308], Tmin=(1263.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(508.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[C]#COC(=[CH])C(1738)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {5,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {2,S} {4,D}
...
"""),
    E0 = (721.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,2175,525,257.376,257.548],'cm^-1')),
        HinderedRotor(inertia=(0.221894,'amu*angstrom^2'), symmetry=1, barrier=(10.4398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22179,'amu*angstrom^2'), symmetry=1, barrier=(10.4387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.923047,'amu*angstrom^2'), symmetry=1, barrier=(43.498,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0845,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43234,0.059958,-8.70402e-05,6.90346e-08,-2.17445e-11,86876.2,20.8633], Tmin=(100,'K'), Tmax=(843.626,'K')), NASAPolynomial(coeffs=[9.03832,0.0199198,-8.78338e-06,1.60798e-09,-1.08214e-13,85734.3,-13.6995], Tmin=(843.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(721.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cds_P) + radical(Acetyl)"""),
)

species(
    label = 'C#COC([CH2])=C(1547)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {2,S} {5,S}
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(18)', '[CH]=[C]OC#C(1055)'],
    products = ['[CH]=C(C)OC#C(1140)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(3.05774e+10,'m^3/(mol*s)'), n=-0.421056, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.030895812897821735, var=3.1393582276389975, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[CH]C(=C)OC#C(1737)'],
    products = ['[CH]=C(C)OC#C(1140)'],
