...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(152)', '[CH2]C([O])=O(586)'],
    products = ['[O]C(=O)C[C]=O(890)'],
    transitionState = 'TS3',
