...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42342,0.0187403,6.75822e-05,-9.8514e-08,3.89598e-11,-14390.9,15.1185], Tmin=(100,'K'), Tmax=(935.201,'K')), NASAPolynomial(coeffs=[10.4349,0.024979,-7.3914e-06,1.24413e-09,-8.80996e-14,-17660.6,-32.4655], Tmin=(935.201,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(36dihydro2hpyran)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90699,0.0367833,6.16481e-06,-2.51769e-08,9.27797e-12,-15452,21], Tmin=(100,'K'), Tmax=(1169.12,'K')), NASAPolynomial(coeffs=[10.3102,0.0303688,-1.42625e-05,2.81253e-09,-2.0148e-13,-18943.4,-27.3818], Tmin=(1169.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40365,0.0542085,-4.03308e-05,1.60025e-08,-2.6403e-12,-4206.54,22.9601], Tmin=(100,'K'), Tmax=(1399.54,'K')), NASAPolynomial(coeffs=[11.0204,0.0267233,-1.08729e-05,1.97049e-09,-1.33771e-13,-6898.36,-26.6678], Tmin=(1399.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.7705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = '[O]CCC1[CH]C1(1982)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
2  C u0 p0 c0 {3,S} {4,S} {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04508,0.0375186,-5.51286e-06,-9.09821e-09,3.50072e-12,33421.5,24.0684], Tmin=(100,'K'), Tmax=(1297.62,'K')), NASAPolynomial(coeffs=[7.91198,0.0319791,-1.36116e-05,2.51328e-09,-1.71813e-13,30842.7,-9.8343], Tmin=(1297.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCOJ) + radical(cyclopropane)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12271,0.0275188,4.68766e-05,-8.48071e-08,3.72714e-11,29983.4,22.6409], Tmin=(100,'K'), Tmax=(887.174,'K')), NASAPolynomial(coeffs=[11.9371,0.0203721,-3.77312e-06,3.94443e-10,-2.18602e-14,26781.8,-31.7623], Tmin=(887.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJCO) + radical(RCCJ)"""),
)
...
"""),
    E0 = (22.3348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.0350432,'amu*angstrom^2'), symmetry=1, barrier=(20.6036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0348181,'amu*angstrom^2'), symmetry=1, barrier=(20.6528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339848,'amu*angstrom^2'), symmetry=1, barrier=(20.5885,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90907,0.0343719,1.38987e-05,-3.66949e-08,1.41585e-11,2771.34,21.2658], Tmin=(100,'K'), Tmax=(1086.76,'K')), NASAPolynomial(coeffs=[11.6938,0.0257614,-1.20408e-05,2.4205e-09,-1.77265e-13,-973.668,-34.1995], Tmin=(1086.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.3348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Allyl_P)"""),
)

species(
    label = 'C=C=CCC[O](1984)',
    structure = adjacencyList("""multiplicity 2
1  O u1 p2 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {1,S} {2,S} {9,S} {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.164161,'amu*angstrom^2'), symmetry=1, barrier=(3.77439,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165661,'amu*angstrom^2'), symmetry=1, barrier=(3.80888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47622,0.0404365,3.83027e-06,-7.56787e-08,7.03882e-11,22891.6,20.1146], Tmin=(100,'K'), Tmax=(447.357,'K')), NASAPolynomial(coeffs=[3.88282,0.0373271,-1.7489e-05,3.39973e-09,-2.41089e-13,22671,13.4012], Tmin=(447.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCOJ)"""),
)
...
"""),
    E0 = (119.422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,468.895],'cm^-1')),
        HinderedRotor(inertia=(0.431902,'amu*angstrom^2'), symmetry=1, barrier=(9.93029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.431967,'amu*angstrom^2'), symmetry=1, barrier=(9.93178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.021682,'amu*angstrom^2'), symmetry=1, barrier=(9.94321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0568903,'amu*angstrom^2'), symmetry=1, barrier=(26.2404,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14,0.0602796,-5.21399e-05,2.43253e-08,-4.6529e-12,14468.3,24.6829], Tmin=(100,'K'), Tmax=(1239.83,'K')), NASAPolynomial(coeffs=[11.8288,0.0257942,-1.04173e-05,1.89035e-09,-1.2903e-13,11817.9,-29.1822], Tmin=(1239.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOH) + radical(Allyl_P)"""),
)

species(
    label = 'C[C]=CCC[O](1986)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
2  C u0 p0 c0 {3,S} {5,S} {7,S} {8,S}
3  C u0 p0 c0 {1,S} {2,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.977368,0.0579851,-3.72791e-05,6.91037e-09,1.46978e-12,6856.24,22.9185], Tmin=(100,'K'), Tmax=(1076.86,'K')), NASAPolynomial(coeffs=[13.8504,0.0241086,-9.50959e-06,1.7404e-09,-1.20916e-13,3275.46,-43.8928], Tmin=(1076.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJCO) + radical(Allyl_P)"""),
)

species(
    label = 'CC=[C]CC[O](1988)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0317877,'amu*angstrom^2'), symmetry=1, barrier=(0.730863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.246844,'amu*angstrom^2'), symmetry=1, barrier=(5.67543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.583169,'amu*angstrom^2'), symmetry=1, barrier=(13.4082,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
"""),
    E0 = (176.966,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,289.728,289.737],'cm^-1')),
        HinderedRotor(inertia=(0.00135038,'amu*angstrom^2'), symmetry=1, barrier=(15.3323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107569,'amu*angstrom^2'), symmetry=1, barrier=(6.40733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328693,'amu*angstrom^2'), symmetry=1, barrier=(19.5794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.729489,'amu*angstrom^2'), symmetry=1, barrier=(43.454,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42644,0.0555684,-4.37994e-05,1.88895e-08,-3.42441e-12,21377.5,24.5781], Tmin=(100,'K'), Tmax=(1276.58,'K')), NASAPolynomial(coeffs=[10.1286,0.0283018,-1.17613e-05,2.15857e-09,-1.47954e-13,19155.7,-19.5298], Tmin=(1276.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'CC=C[CH]C[O](1990)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
...
"""),
    E0 = (143.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,2782.5,750,1395,475,1775,1000,1674.38,1675.19],'cm^-1')),
        HinderedRotor(inertia=(0.133783,'amu*angstrom^2'), symmetry=1, barrier=(3.07594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131222,'amu*angstrom^2'), symmetry=1, barrier=(3.01705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132035,'amu*angstrom^2'), symmetry=1, barrier=(3.03574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131754,'amu*angstrom^2'), symmetry=1, barrier=(3.02928,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.63677,0.0406294,-1.89001e-05,3.78118e-09,-2.83876e-13,17292.6,23.9473], Tmin=(100,'K'), Tmax=(3539.6,'K')), NASAPolynomial(coeffs=[10.8918,0.0248855,-9.50953e-06,1.50048e-09,-8.66264e-14,15467.4,-20.6361], Tmin=(3539.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(RCCJC)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42474,0.0477964,-1.65346e-05,-1.26714e-08,8.39784e-12,-11354.2,22.7988], Tmin=(100,'K'), Tmax=(994.343,'K')), NASAPolynomial(coeffs=[12.4251,0.0229668,-8.37719e-06,1.50302e-09,-1.0477e-13,-14502,-35.037], Tmin=(994.343,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.2402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70236,0.0468755,-2.6297e-05,7.00462e-09,-7.44426e-13,-14720.1,22.6202], Tmin=(100,'K'), Tmax=(2109.17,'K')), NASAPolynomial(coeffs=[14.4302,0.0227375,-9.13055e-06,1.57869e-09,-1.01293e-13,-20089.2,-48.2833], Tmin=(2109.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)

species(
    label = '[CH]1[CH]COCC1(1944)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.76308,0.0151025,6.78103e-05,-9.38348e-08,3.7142e-11,18120.5,19.0087], Tmin=(100,'K'), Tmax=(898.782,'K')), NASAPolynomial(coeffs=[6.6111,0.0292828,-8.10276e-06,1.22734e-09,-7.95684e-14,16164.3,-6.17938], Tmin=(898.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.198,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxane) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'C=CC=CC[O](1993)',
    structure = adjacencyList("""multiplicity 2
1  O u1 p2 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {4,D} {9,S}
...
"""),
    E0 = (130.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,324.687,324.694,324.725],'cm^-1')),
        HinderedRotor(inertia=(0.082575,'amu*angstrom^2'), symmetry=1, barrier=(6.17444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147896,'amu*angstrom^2'), symmetry=1, barrier=(11.0638,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80098,0.0446979,-2.65814e-05,7.81282e-09,-9.36112e-13,15773.2,22.3196], Tmin=(100,'K'), Tmax=(1862.46,'K')), NASAPolynomial(coeffs=[11.7734,0.0232803,-9.33195e-06,1.63843e-09,-1.07321e-13,12058.5,-31.9935], Tmin=(1862.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(CCOJ)"""),
)

species(
    label = 'C=CC[CH]C[O](1958)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
...
"""),
    E0 = (225.478,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,327.744,327.762,327.792,1465.12],'cm^-1')),
        HinderedRotor(inertia=(0.00156956,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00419377,'amu*angstrom^2'), symmetry=1, barrier=(6.39002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0838511,'amu*angstrom^2'), symmetry=1, barrier=(6.39299,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04242,0.044372,-2.29638e-05,5.39085e-09,-4.93256e-13,27187.2,25.4083], Tmin=(100,'K'), Tmax=(2453.77,'K')), NASAPolynomial(coeffs=[16.6826,0.020506,-8.37424e-06,1.42695e-09,-8.9392e-14,20002.6,-58.3635], Tmin=(2453.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'C=[C]CCC[O](1994)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    E0 = (263.417,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,1685,370,180,180,185.796,2090.23],'cm^-1')),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69944,0.0556098,-6.21756e-05,5.38174e-08,-2.07908e-11,31759.8,24.6184], Tmin=(100,'K'), Tmax=(764.192,'K')), NASAPolynomial(coeffs=[3.06613,0.0410807,-1.91804e-05,3.68e-09,-2.57134e-13,31766.3,19.8015], Tmin=(764.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH]CCC=O(729)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {5,D}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    E0 = (148.809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,1550.72,1552.48],'cm^-1')),
        HinderedRotor(inertia=(0.144812,'amu*angstrom^2'), symmetry=1, barrier=(3.32952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143913,'amu*angstrom^2'), symmetry=1, barrier=(3.30884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144464,'amu*angstrom^2'), symmetry=1, barrier=(3.32152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145388,'amu*angstrom^2'), symmetry=1, barrier=(3.34277,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.13066,0.0398929,-1.8153e-05,3.39907e-09,-2.30728e-13,17906.2,21.3822], Tmin=(100,'K'), Tmax=(3053.96,'K')), NASAPolynomial(coeffs=[39.1467,-0.00225842,8.37905e-08,-4.35488e-11,7.01247e-15,-6433.89,-196.418], Tmin=(3053.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH]=CCCC[O](1995)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {5,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23955,0.0455399,-8.46619e-06,-4.9984e-08,4.84662e-11,32851.4,22.7251], Tmin=(100,'K'), Tmax=(478.449,'K')), NASAPolynomial(coeffs=[4.03294,0.0396308,-1.84205e-05,3.57028e-09,-2.52887e-13,32575.8,14.3086], Tmin=(478.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]C=CCCO(1996)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25418,0.0556872,-3.45852e-05,1.10353e-08,-1.46604e-12,19142.7,25.5577], Tmin=(100,'K'), Tmax=(1679.68,'K')), NASAPolynomial(coeffs=[11.8124,0.030544,-1.21317e-05,2.12353e-09,-1.39636e-13,15595.8,-30.8551], Tmin=(1679.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', 'C=C[CH]C[O](1223)'],
    products = ['[CH2]C=CCC[O](1844)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(157.649,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['O(7)', '[CH2]C=CC[CH2](1193)'],
    products = ['[CH2]C=CCC[O](1844)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(17)', '[CH]=CCC[O](1468)'],
    products = ['[CH2]C=CCC[O](1844)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C[O](92)', '[CH]C=C(1759)'],
    products = ['[CH2]C=CCC[O](1844)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C=CCC[O](1844)'],
    products = ['[CH]1[CH]COCC1(1944)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(7.25216e+09,'s^-1'), n=0.38532, Ea=(59.7134,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_linear;doublebond_intra_pri_2H;radadd_intra] for rate rule [R6_linear;doublebond_intra_pri_2H;radadd_intra_O]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic"""),
)
