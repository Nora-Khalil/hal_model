...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(152)', '[CH2]C[C]=O(169)'],
    products = ['O=[C]CC[C]=O(550)'],
    transitionState = 'TS3',
