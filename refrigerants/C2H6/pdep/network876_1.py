...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH]=C=C(1111)'],
    products = ['C#CCO[O](1691)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['C#CCO[O](1691)'],
    products = ['[C]1=COOC1(1723)'],
    transitionState = 'TS4',
