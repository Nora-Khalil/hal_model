...
"""),
    ...
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.64796,0.00939724,8.17395e-05,-1.18408e-07,4.76393e-11,26494.1,12.6729], Tmin=(100,'K'), Tmax=(934.383,'K')), NASAPolynomial(coeffs=[14.9193,0.00887598,-9.19452e-07,1.40637e-10,-1.81648e-14,21930.4,-57.8463], Tmin=(934.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)

species(
    label = '[CH]=C[C]1CC1(1479)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.82073,0.00950697,7.06096e-05,-9.93126e-08,3.90955e-11,59399.7,14.5202], Tmin=(100,'K'), Tmax=(940.434,'K')), NASAPolynomial(coeffs=[11.5428,0.0142426,-3.66892e-06,6.43873e-10,-5.05887e-14,55909.3,-36.8586], Tmin=(940.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(493.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Allyl_T) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C1=C[CH]C1(1480)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.76866,0.00862667,7.87022e-05,-1.09159e-07,4.24988e-11,50750.4,13.6508], Tmin=(100,'K'), Tmax=(950.509,'K')), NASAPolynomial(coeffs=[12.5862,0.0141904,-4.05708e-06,7.74219e-10,-6.26672e-14,46766.4,-44.3545], Tmin=(950.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1([CH2])C=C1(1481)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8616,0.0421256,-2.62291e-05,3.06763e-09,2.46297e-12,49828.8,17.3639], Tmin=(100,'K'), Tmax=(963.098,'K')), NASAPolynomial(coeffs=[10.1781,0.0184851,-6.38627e-06,1.08359e-09,-7.24211e-14,47721.3,-25.0701], Tmin=(963.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_P) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]=CC(=[CH])C(1124)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {6,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {3,S} {4,D}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([CH2])=C(1216)'],
    products = ['C2H2(22)', 'C=C=C(430)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC[C]=C(1415)'],
    products = ['[CH]=CC([CH2])=C(1216)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[CH]C=C=C(85)'],
    products = ['[CH]=CC([CH2])=C(1216)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[CH](58)', '[CH2][C]=C(431)'],
    products = ['[CH]=CC([CH2])=C(1216)'],
