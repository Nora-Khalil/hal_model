...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', 'C#COC=C(1055)'],
    products = ['C#COC=CC(2070)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', 'C#CO[CH]C=C(3191)'],
    products = ['C#COC=CC(2070)'],
