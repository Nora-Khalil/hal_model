...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35881,0.0653287,-5.81414e-05,1.60001e-08,9.54258e-12,-5885.28,22.2014], Tmin=(100,'K'), Tmax=(566.756,'K')), NASAPolynomial(coeffs=[6.67583,0.038965,-1.7909e-05,3.42615e-09,-2.39795e-13,-6667.25,-2.01256], Tmin=(566.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.6667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CCO)) + group(Cds-CdsCsH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'CC1C[C]1C[C]=O(2574)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62948,0.0513778,-3.07462e-05,9.35781e-09,-1.19399e-12,25971.8,25.5748], Tmin=(100,'K'), Tmax=(1698.63,'K')), NASAPolynomial(coeffs=[10.3023,0.0309546,-1.27111e-05,2.2795e-09,-1.52215e-13,23025.4,-20.8617], Tmin=(1698.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (104.826,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2120,512.5,787.5,218.94,922.647],'cm^-1')),
        HinderedRotor(inertia=(0.231159,'amu*angstrom^2'), symmetry=1, barrier=(7.90498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439025,'amu*angstrom^2'), symmetry=1, barrier=(14.9701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524315,'amu*angstrom^2'), symmetry=1, barrier=(18.0939,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32624,0.0602416,-5.14e-05,2.42381e-08,-4.83976e-12,12702.7,22.2525], Tmin=(100,'K'), Tmax=(1161.94,'K')), NASAPolynomial(coeffs=[9.81952,0.0310032,-1.36548e-05,2.58159e-09,-1.80182e-13,10729,-19.9974], Tmin=(1161.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cd-CdCs(CCO)) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + missing(Cdd-CdO2d) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]C(C=C[O])=CC(2578)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {7,S}
2  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {4,D} {5,S} {6,S}
...
"""),
    E0 = (229.583,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,1685,370,1855,455,950,249.511],'cm^-1')),
        HinderedRotor(inertia=(0.00270796,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250621,'amu*angstrom^2'), symmetry=1, barrier=(11.0718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250615,'amu*angstrom^2'), symmetry=1, barrier=(11.0718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250582,'amu*angstrom^2'), symmetry=1, barrier=(11.0718,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7403,0.0556648,-3.59244e-05,1.10004e-08,-1.39267e-12,27687.4,23.6056], Tmin=(100,'K'), Tmax=(1682.9,'K')), NASAPolynomial(coeffs=[11.2111,0.0331542,-1.58603e-05,3.05219e-09,-2.11939e-13,24499.7,-27.0151], Tmin=(1682.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(229.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Cds_S) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C(=[C]C)CC=O(2581)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {5,D}
...
"""),
    E0 = (221.122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,1685,370,1457.47],'cm^-1')),
        HinderedRotor(inertia=(0.196429,'amu*angstrom^2'), symmetry=1, barrier=(4.5163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103374,'amu*angstrom^2'), symmetry=1, barrier=(20.6902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.899519,'amu*angstrom^2'), symmetry=1, barrier=(20.6817,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16174,0.0650063,-5.84973e-05,3.00529e-08,-6.59034e-12,-4264.22,23.9544], Tmin=(100,'K'), Tmax=(1063.83,'K')), NASAPolynomial(coeffs=[9.34636,0.0342317,-1.51046e-05,2.85982e-09,-1.99876e-13,-6005.6,-16.038], Tmin=(1063.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.2866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cd-CdCs(CCO)) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (210.368,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1855,455,950,180,1065.79],'cm^-1')),
        HinderedRotor(inertia=(0.0234667,'amu*angstrom^2'), symmetry=1, barrier=(18.9088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00166486,'amu*angstrom^2'), symmetry=1, barrier=(18.9029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.821981,'amu*angstrom^2'), symmetry=1, barrier=(18.899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.822077,'amu*angstrom^2'), symmetry=1, barrier=(18.9012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.975158,0.0572926,-3.31726e-05,5.76133e-09,6.04868e-13,25417.8,28.8182], Tmin=(100,'K'), Tmax=(1296.32,'K')), NASAPolynomial(coeffs=[15.012,0.026476,-1.19739e-05,2.29561e-09,-1.60858e-13,20728.6,-46.5944], Tmin=(1296.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C(=C[C]=O)CC(2586)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {7,D}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {10,S} {11,S} {12,S}
...
"""),
    E0 = (252.217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,1855,455,950,3120,650,792.5,1650,344.835],'cm^-1')),
        HinderedRotor(inertia=(0.164117,'amu*angstrom^2'), symmetry=1, barrier=(13.9228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00141332,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163727,'amu*angstrom^2'), symmetry=1, barrier=(13.9083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16259,'amu*angstrom^2'), symmetry=1, barrier=(13.9122,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.733974,0.0613619,-4.28169e-05,1.41308e-08,-1.83649e-12,30461.3,28.3194], Tmin=(100,'K'), Tmax=(1809.72,'K')), NASAPolynomial(coeffs=[19.2602,0.0204132,-8.87581e-06,1.6274e-09,-1.09211e-13,23755.9,-72.0476], Tmin=(1809.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=CC)CC=O(2588)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {6,D}
...
"""),
    E0 = (202.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,434.291,435.671,436.695,436.779],'cm^-1')),
        HinderedRotor(inertia=(0.367124,'amu*angstrom^2'), symmetry=1, barrier=(49.4329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.367566,'amu*angstrom^2'), symmetry=1, barrier=(49.4539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.366206,'amu*angstrom^2'), symmetry=1, barrier=(49.4559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.363724,'amu*angstrom^2'), symmetry=1, barrier=(49.4451,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05318,0.0565908,-2.24775e-05,-2.21471e-09,2.28496e-12,24463.6,25.946], Tmin=(100,'K'), Tmax=(1364.37,'K')), NASAPolynomial(coeffs=[13.5706,0.0354111,-1.62533e-05,3.08042e-09,-2.12802e-13,19603.5,-43.6258], Tmin=(1364.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]C(=C)C[C]=O(1279)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(152)', '[CH2]C([CH2])=CC(1459)'],
    products = ['[CH2]C(=CC)C[C]=O(2423)'],
    transitionState = 'TS5',
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(7.28348,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C(38)', 'C=[C]C[C]=O(624)'],
    products = ['[CH2]C(=CC)C[C]=O(2423)'],
