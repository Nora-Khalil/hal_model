...
"""),
    E0 = (288.545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2850,1437.5,1250,1305,750,350,1855,455,950,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11827,0.034813,-6.94446e-06,-1.08722e-08,5.30877e-12,34777.2,23.0777], Tmin=(100,'K'), Tmax=(1090.52,'K')), NASAPolynomial(coeffs=[8.78161,0.0235258,-9.51193e-06,1.75816e-09,-1.22377e-13,32541.7,-13.2326], Tmin=(1090.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(288.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(cyclopropane) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]C[CH]C1CC1(2773)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {7,D}
...
"""),
    E0 = (238.754,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1855,455,950,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44064,0.0445832,2.97941e-06,-3.40233e-08,1.57205e-11,28817.9,27.9003], Tmin=(100,'K'), Tmax=(995.654,'K')), NASAPolynomial(coeffs=[12.8088,0.0259724,-9.75033e-06,1.79739e-09,-1.27837e-13,25212.9,-33.6308], Tmin=(995.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CCJCC=O) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82585,0.0293274,5.30579e-05,-8.41202e-08,3.1768e-11,834.101,22.3649], Tmin=(100,'K'), Tmax=(1021.37,'K')), NASAPolynomial(coeffs=[13.8439,0.0280777,-1.23941e-05,2.52139e-09,-1.89458e-13,-4010.63,-47.568], Tmin=(1021.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.15006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'O=C=CC1CCC1(2776)',
    structure = adjacencyList("""1  O u0 p2 c0 {7,D}
2  C u0 p0 c0 {3,S} {4,S} {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69069,0.0348566,3.65984e-05,-6.9588e-08,2.8108e-11,39.5302,22.7513], Tmin=(100,'K'), Tmax=(986.305,'K')), NASAPolynomial(coeffs=[13.281,0.0267063,-1.00979e-05,1.91639e-09,-1.40244e-13,-4136.68,-42.5862], Tmin=(986.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.480456,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + ring(Cyclobutane)"""),
)

species(
    label = 'O=CCC1C=CC1(2769)',
    structure = adjacencyList("""1  O u0 p2 c0 {7,D}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72568,0.0364608,2.55852e-05,-5.42959e-08,2.1797e-11,831.749,23.0477], Tmin=(100,'K'), Tmax=(1006.96,'K')), NASAPolynomial(coeffs=[11.7922,0.028885,-1.14108e-05,2.16223e-09,-1.55875e-13,-2838.8,-33.7465], Tmin=(1006.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.13577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(Cyclobutene)"""),
)
...
"""),
    E0 = (213.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,1855,455,950,322.819,4000],'cm^-1')),
        HinderedRotor(inertia=(0.271645,'amu*angstrom^2'), symmetry=1, barrier=(20.0899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271662,'amu*angstrom^2'), symmetry=1, barrier=(20.0899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27167,'amu*angstrom^2'), symmetry=1, barrier=(20.0899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00161775,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17378,0.0528902,-2.3457e-05,-2.27754e-09,2.90822e-12,25775,29.1518], Tmin=(100,'K'), Tmax=(1235.73,'K')), NASAPolynomial(coeffs=[13.7421,0.0281988,-1.28968e-05,2.49778e-09,-1.76556e-13,21447.9,-39.0836], Tmin=(1235.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7636,0.0321889,3.82679e-05,-7.00127e-08,2.75276e-11,20073.9,23.4057], Tmin=(100,'K'), Tmax=(1014.31,'K')), NASAPolynomial(coeffs=[14.4464,0.0235669,-1.01963e-05,2.07507e-09,-1.5673e-13,15371.7,-48.4584], Tmin=(1014.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(Cyclobutene) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]CC1C=CC1(2779)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {7,D}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {8,S}
...
species(
    label = 'O=[C]C[C]1CCC1(2781)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {7,D}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {6,S} {11,S} {12,S}
4  C u0 p0 c0 {2,S} {6,S} {10,S} {13,S}
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62995,0.0476386,-2.2285e-05,3.73637e-09,-7.60774e-15,26531.5,25.9035], Tmin=(100,'K'), Tmax=(1674.42,'K')), NASAPolynomial(coeffs=[12.4255,0.0288999,-1.18145e-05,2.08236e-09,-1.36128e-13,21927.8,-34.6951], Tmin=(1674.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]CC1C[CH]C1(2782)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {7,D}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {8,S}
3  C u0 p0 c0 {2,S} {6,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72504,0.0273974,7.16391e-05,-1.1572e-07,4.69518e-11,24954.5,25.6714], Tmin=(100,'K'), Tmax=(953.776,'K')), NASAPolynomial(coeffs=[17.1331,0.0197465,-5.92234e-06,1.11747e-09,-8.79579e-14,19424.1,-61.5184], Tmin=(953.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclobutane) + radical(C=COJ) + radical(cyclobutane)"""),
)

species(
    label = 'O=[C][CH]C1CCC1(2784)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {7,D}
2  C u0 p0 c0 {3,S} {4,S} {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72014,0.0341734,3.88027e-05,-7.34657e-08,3.02284e-11,24386.8,24.1749], Tmin=(100,'K'), Tmax=(966.309,'K')), NASAPolynomial(coeffs=[13.3423,0.0254727,-8.86554e-06,1.62603e-09,-1.18134e-13,20300.8,-41.0173], Tmin=(966.309,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.962,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclobutane) + radical(CCJCHO) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC[C]1[CH]CC1(2785)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {7,D}
2  C u0 p0 c0 {3,S} {5,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {6,S} {10,S} {11,S}
...
"""),
    E0 = (247.733,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21084,0.0412174,-1.13499e-05,-2.60314e-09,1.16293e-12,29858,26.0401], Tmin=(100,'K'), Tmax=(1736.08,'K')), NASAPolynomial(coeffs=[11.5845,0.0319714,-1.40328e-05,2.52513e-09,-1.65679e-13,24742,-29.7137], Tmin=(1736.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane)"""),
)

species(
    label = 'O=CCC1[CH]C[CH]1(2786)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {7,D}
2  C u0 p0 c0 {3,S} {5,S} {6,S} {8,S}
3  C u0 p0 c0 {2,S} {7,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9343,0.0387097,1.57226e-06,-1.72138e-08,6.01791e-12,30165.6,27.541], Tmin=(100,'K'), Tmax=(1248.22,'K')), NASAPolynomial(coeffs=[7.98789,0.0362652,-1.58648e-05,2.98128e-09,-2.06399e-13,27333.6,-8.29695], Tmin=(1248.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(250.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = 'O=CCC1[CH][CH]C1(2787)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {7,D}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {8,S}
3  C u0 p0 c0 {2,S} {6,S} {9,S} {10,S}
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', 'O=[C]CC1[CH]C1(2772)'],
...
reaction(
    label = 'reaction6',
    reactants = ['[C]=O(152)', '[CH2]C1[CH]CC1(2210)'],
    products = ['O=[C]CC1[CH]CC1(2060)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['CO(14)', '[CH2]C1[CH]CC1(2210)'],
    products = ['O=[C]CC1[CH]CC1(2060)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00100541,'m^3/(mol*s)'), n=2.87982, Ea=(6.11176,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H',), comment="""Estimated from node Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction18',
    reactants = ['H(6)', 'O=C=CC1[CH]CC1(2780)'],
    products = ['O=[C]CC1[CH]CC1(2060)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=CC[C]1[CH]CC1(2785)'],
    products = ['O=[C]CC1[CH]CC1(2060)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O=CCC1[CH]C[CH]1(2786)'],
    products = ['O=[C]CC1[CH]CC1(2060)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(2.89171,'s^-1'), n=3.07722, Ea=(63.2598,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_SSS;C_rad_out_H/NonDeC;XH_out] for rate rule [R4H_SSS;C_rad_out_H/NonDeC;CO_H_out]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction26',
    reactants = ['O=CCC1[CH][CH]C1(2787)'],
    products = ['O=[C]CC1[CH]CC1(2060)'],
