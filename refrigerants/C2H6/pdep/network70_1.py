...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[CH]=C[O](94)'],
    products = ['[CH]=CO[CH2](107)'],
    transitionState = 'TS2',
