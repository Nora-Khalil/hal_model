...
reaction(
    label = 'reaction1',
    reactants = ['C=C=CC(=O)O(1178)'],
    products = ['CO2(15)', 'C#CC(211)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[CH2]C#CC(=O)O(1386)'],
    products = ['C=C=CC(=O)O(1178)'],
