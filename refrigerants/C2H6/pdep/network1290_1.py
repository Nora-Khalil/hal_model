...
reaction(
    label = 'reaction1',
    reactants = ['C=C[C-]=[O+]C=O(1407)'],
    products = ['CO2(15)', '[C]=CC-2(1113)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(14)', 'C=C[C-]=[OH+](2750)'],
    products = ['C=C[C-]=[O+]C=O(1407)'],
    transitionState = 'TS2',
