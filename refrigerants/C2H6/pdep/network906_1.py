...
reaction(
    label = 'reaction5',
    reactants = ['C#CC[C]=O(622)'],
    products = ['[CH]=C1CC1=O(1728)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.98513e+09,'s^-1'), n=0.768, Ea=(167.13,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_T;triplebond_intra_H;radadd_intra] for rate rule [R4_S_T;triplebond_intra_H;radadd_intra_CO]
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', '[CH]=C=C[C]=O(1729)'],
    products = ['C#CC[C]=O(622)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2.88633e+07,'m^3/(mol*s)'), n=0.213913, Ea=(3.60317,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=8.197906922440378e-05, var=0.01210657880115639, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(6)', '[C]#CC[C]=O(1730)'],
    products = ['C#CC[C]=O(622)'],
