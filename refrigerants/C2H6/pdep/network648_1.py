...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31003,0.0521865,-2.54526e-05,4.12025e-09,2.26618e-13,36500.1,23.1737], Tmin=(100,'K'), Tmax=(1437.15,'K')), NASAPolynomial(coeffs=[11.5598,0.0319204,-1.29233e-05,2.30825e-09,-1.54005e-13,32700.9,-32.9609], Tmin=(1437.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Cds_S)"""),
)

species(
    label = 'C[C]=CC[CH]C(2055)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25446,0.047533,-2.24802e-05,4.72441e-09,-3.81652e-13,42864.6,23.5426], Tmin=(100,'K'), Tmax=(2781.91,'K')), NASAPolynomial(coeffs=[19.6818,0.022475,-8.9691e-06,1.48656e-09,-9.06794e-14,33168.3,-78.3647], Tmin=(2781.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Cds_S)"""),
)
...
"""),
    E0 = (601.757,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,1685,370,320.843,320.906,320.98,2464.53],'cm^-1')),
        HinderedRotor(inertia=(0.00163722,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00163552,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131233,'amu*angstrom^2'), symmetry=1, barrier=(9.58511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.259331,'amu*angstrom^2'), symmetry=1, barrier=(18.9487,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21969,0.056163,-3.81043e-05,1.34806e-08,-1.97258e-12,72478.7,25.3457], Tmin=(100,'K'), Tmax=(1562.17,'K')), NASAPolynomial(coeffs=[12.1812,0.0280958,-1.11541e-05,1.97947e-09,-1.32014e-13,69053.9,-32.4267], Tmin=(1562.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(601.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC1=CC(C)C1(2208)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.651036,'amu*angstrom^2'), symmetry=1, barrier=(14.9686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.649159,'amu*angstrom^2'), symmetry=1, barrier=(14.9254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.648914,'amu*angstrom^2'), symmetry=1, barrier=(14.9198,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03499,0.0584484,-4.2595e-05,1.64042e-08,-2.58761e-12,31160.2,21.5251], Tmin=(100,'K'), Tmax=(1482.43,'K')), NASAPolynomial(coeffs=[12.9725,0.026238,-1.00031e-05,1.74743e-09,-1.15887e-13,27620.8,-40.7664], Tmin=(1482.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(258.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(C)C=C=C(2211)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    E0 = (297.387,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,540,610,2055,338.379],'cm^-1')),
        HinderedRotor(inertia=(0.113315,'amu*angstrom^2'), symmetry=1, barrier=(9.15938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111777,'amu*angstrom^2'), symmetry=1, barrier=(9.15232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362303,'amu*angstrom^2'), symmetry=1, barrier=(29.3265,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35133,0.0500662,-1.67042e-05,-1.18631e-08,7.8685e-12,35870,24.2252], Tmin=(100,'K'), Tmax=(992.292,'K')), NASAPolynomial(coeffs=[11.2641,0.0279034,-1.01035e-05,1.77617e-09,-1.21375e-13,33026.6,-27.9364], Tmin=(992.292,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Isobutyl)"""),
)
...
"""),
    E0 = (279.577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3100,440,815,1455,1000,2100,2250,500,550,239.111],'cm^-1')),
        HinderedRotor(inertia=(1.91959,'amu*angstrom^2'), symmetry=1, barrier=(77.866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92097,'amu*angstrom^2'), symmetry=1, barrier=(77.8652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129689,'amu*angstrom^2'), symmetry=1, barrier=(5.26038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0107498,'amu*angstrom^2'), symmetry=1, barrier=(77.8664,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66808,0.0449383,-4.92587e-06,-2.63281e-08,1.50163e-11,33715.4,23.4622], Tmin=(100,'K'), Tmax=(872.106,'K')), NASAPolynomial(coeffs=[9.57647,0.0277456,-8.17183e-06,1.2395e-09,-7.76103e-14,31610.4,-17.7689], Tmin=(872.106,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][CH]C=[C]C(2102)',
    structure = adjacencyList("""multiplicity 4
1  C u0 p0 c0 {5,S} {6,S} {7,S} {8,S}
...
"""),
    E0 = (531.653,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,280.698],'cm^-1')),
        HinderedRotor(inertia=(0.0052287,'amu*angstrom^2'), symmetry=1, barrier=(9.84478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00523745,'amu*angstrom^2'), symmetry=1, barrier=(9.84883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.632039,'amu*angstrom^2'), symmetry=1, barrier=(35.316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.109,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1192,0.0367178,-1.73814e-05,2.65733e-09,1.62903e-13,64014.7,20.4998], Tmin=(100,'K'), Tmax=(1486.6,'K')), NASAPolynomial(coeffs=[9.41185,0.022897,-9.28995e-06,1.65389e-09,-1.09828e-13,61205.3,-19.7306], Tmin=(1486.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(531.653,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C](C)C=[C]C(2213)',
    structure = adjacencyList("""multiplicity 4
1  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
2  C u0 p0 c0 {6,S} {10,S} {11,S} {12,S}
...
"""),
    E0 = (490.605,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,1696.18],'cm^-1')),
        HinderedRotor(inertia=(0.164173,'amu*angstrom^2'), symmetry=1, barrier=(3.77466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165322,'amu*angstrom^2'), symmetry=1, barrier=(3.80109,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164963,'amu*angstrom^2'), symmetry=1, barrier=(3.79282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.83653,'amu*angstrom^2'), symmetry=1, barrier=(65.2174,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44962,0.0507964,-3.05872e-05,1.0108e-08,-1.42325e-12,59102.3,24.2443], Tmin=(100,'K'), Tmax=(1584.72,'K')), NASAPolynomial(coeffs=[9.68151,0.0300187,-1.09208e-05,1.83488e-09,-1.18135e-13,56493.2,-19.2601], Tmin=(1584.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_T) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
"""),
    E0 = (596.466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3100,440,815,1455,1000,1670,1700,300,440,275.483],'cm^-1')),
        HinderedRotor(inertia=(0.00220873,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132409,'amu*angstrom^2'), symmetry=1, barrier=(7.12512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131945,'amu*angstrom^2'), symmetry=1, barrier=(7.12247,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132861,'amu*angstrom^2'), symmetry=1, barrier=(7.11933,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5003,0.0565514,-4.61953e-05,2.35749e-08,-5.35133e-12,71827,25.5902], Tmin=(100,'K'), Tmax=(1013.64,'K')), NASAPolynomial(coeffs=[6.96331,0.0349936,-1.42939e-05,2.59372e-09,-1.76655e-13,70719.5,-0.839714], Tmin=(1013.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(596.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C[C]=C[C](C)C(2217)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (285.523,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,360,370,350,3010,987.5,1337.5,450,1655,1685,370,283.449],'cm^-1')),
        HinderedRotor(inertia=(0.129755,'amu*angstrom^2'), symmetry=1, barrier=(7.18682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00109194,'amu*angstrom^2'), symmetry=1, barrier=(7.18253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343018,'amu*angstrom^2'), symmetry=1, barrier=(19.3925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59517,'amu*angstrom^2'), symmetry=1, barrier=(89.0014,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45429,0.0488103,-1.68961e-05,-4.10844e-09,2.99566e-12,34438,21.7553], Tmin=(100,'K'), Tmax=(1181.97,'K')), NASAPolynomial(coeffs=[9.13791,0.034529,-1.36474e-05,2.44933e-09,-1.65991e-13,31802.9,-20.0619], Tmin=(1181.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_T) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=CC([CH2])C(2218)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0051082,'amu*angstrom^2'), symmetry=1, barrier=(4.6049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.680067,'amu*angstrom^2'), symmetry=1, barrier=(15.6361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.017342,'amu*angstrom^2'), symmetry=1, barrier=(15.6363,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.30696,'amu*angstrom^2'), symmetry=1, barrier=(76.0336,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3227,0.0477995,1.34806e-06,-3.42458e-08,1.64567e-11,32854.3,25.5549], Tmin=(100,'K'), Tmax=(967.433,'K')), NASAPolynomial(coeffs=[12.2803,0.0288315,-1.00792e-05,1.77003e-09,-1.22477e-13,29501.6,-33.3167], Tmin=(967.433,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(C)[C]=CC(2219)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (391.384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,1670,1700,300,440,180],'cm^-1')),
        HinderedRotor(inertia=(0.598429,'amu*angstrom^2'), symmetry=1, barrier=(13.7591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.598295,'amu*angstrom^2'), symmetry=1, barrier=(13.756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00183706,'amu*angstrom^2'), symmetry=1, barrier=(13.7588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.598197,'amu*angstrom^2'), symmetry=1, barrier=(13.7537,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52863,0.0544877,-3.28656e-05,1.02564e-08,-1.3604e-12,47160.8,22.9985], Tmin=(100,'K'), Tmax=(1620.32,'K')), NASAPolynomial(coeffs=[9.72556,0.0342524,-1.41327e-05,2.54895e-09,-1.71202e-13,44504.4,-20.5029], Tmin=(1620.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(C)=C[CH]C(2221)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34177,0.051974,-1.97168e-05,-8.3301e-09,6.79494e-12,39294,26.2943], Tmin=(100,'K'), Tmax=(957.303,'K')), NASAPolynomial(coeffs=[9.84277,0.0314024,-1.09067e-05,1.84681e-09,-1.22715e-13,36981.4,-17.9249], Tmin=(957.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(325.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C]=CC(C)C(2223)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {4,S} {7,S}
2  C u0 p0 c0 {1,S} {9,S} {10,S} {11,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C)C=[C]C(2057)'],
    products = ['C#CC(416)', 'C=CC(74)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]CC=[C]C(2037)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(17)', 'C[C]=C[CH]C(2105)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(18)', '[C]=CC([CH2])C(779)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[CH]C(C)C=[C]C(2207)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', '[CH2]C(C)C=C=C(2211)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C#CC(416)', '[CH2][CH]C(217)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.0139091,'m^3/(mol*s)'), n=2.39627, Ea=(17.0419,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.2432695615676698, var=0.561256507104386, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R_2R!H->C_1R!H->C_4R!H->C_Ext-2C-R_N-Sp-2C=1C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-3C-R_2R!H->C_1R!H->C_4R!H->C_Ext-2C-R_N-Sp-2C=1C"""),
)

reaction(
    label = 'reaction16',
    reactants = ['H(6)', '[CH2]C(C)C#CC(2212)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2440,'m^3/(mol*s)'), n=1.64, Ea=(17.3786,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_Ext-2CS-R_N-Sp-2CS=1CCOSS_N-5R!H-inRing_Ext-4R!H-R_N-Sp-6R!H=4R!H',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_Ext-2CS-R_N-Sp-2CS=1CCOSS_N-5R!H-inRing_Ext-4R!H-R_N-Sp-6R!H=4R!H"""),
)

reaction(
    label = 'reaction17',
    reactants = ['CH3(18)', '[CH2][CH]C=[C]C(2102)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.52887e+10,'m^3/(mol*s)'), n=-0.421056, Ea=(1.97074,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.030895812897821735, var=3.1393582276389975, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[CH]=[C]C(417)', '[CH2][CH]C(217)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', '[CH2][C](C)C=[C]C(2213)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(2.88633e+07,'m^3/(mol*s)'), n=0.213913, Ea=(4.75765,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=8.197906922440378e-05, var=0.01210657880115639, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction20',
    reactants = ['H(6)', '[CH2]C([CH2])C=[C]C(2214)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(6)', '[CH2][C]=CC([CH2])C(2215)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(6)', '[CH2]C(C)[C]=[C]C(2216)'],
    products = ['[CH2]C(C)C=[C]C(2057)'],
