...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CC[CH2](65)'],
    products = ['[CH]=C(C)C[CH2](1119)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[CH]C(=C)C(1184)'],
    products = ['[CH]=C(C)C[CH2](1119)'],
    transitionState = 'TS3',
