...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.71526,0.0541806,5.61292e-06,-5.80701e-08,2.96761e-11,2731.05,25.4647], Tmin=(100,'K'), Tmax=(934.315,'K')), NASAPolynomial(coeffs=[20.9326,0.0134957,-2.71146e-06,4.15949e-10,-3.34136e-14,-3048.93,-81.4131], Tmin=(934.315,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.5857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C=CCOC=C(1870)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.83123,'amu*angstrom^2'), symmetry=1, barrier=(19.1116,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.830512,'amu*angstrom^2'), symmetry=1, barrier=(19.0951,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (304.375,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,540,610,2055,1685,370,228.55,228.623,228.843,229.454],'cm^-1')),
        HinderedRotor(inertia=(0.51653,'amu*angstrom^2'), symmetry=1, barrier=(19.2023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.513812,'amu*angstrom^2'), symmetry=1, barrier=(19.2036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516899,'amu*angstrom^2'), symmetry=1, barrier=(19.207,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.792614,0.0617029,-4.30819e-05,8.33679e-09,2.15828e-12,36731,27.2869], Tmin=(100,'K'), Tmax=(1019.48,'K')), NASAPolynomial(coeffs=[15.4354,0.0210061,-7.85568e-06,1.42231e-09,-9.93672e-14,32874.7,-47.9089], Tmin=(1019.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.375,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CJO)"""),
)

species(
    label = 'C#COC[CH]C=C(2119)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.46108,'amu*angstrom^2'), symmetry=1, barrier=(33.5932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.46182,'amu*angstrom^2'), symmetry=1, barrier=(33.6102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.46202,'amu*angstrom^2'), symmetry=1, barrier=(33.6146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.46134,'amu*angstrom^2'), symmetry=1, barrier=(33.599,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.185846,0.0709315,-4.60356e-05,-1.82521e-09,8.52409e-12,26724.1,21.9926], Tmin=(100,'K'), Tmax=(974.607,'K')), NASAPolynomial(coeffs=[20.8724,0.0152117,-5.19211e-06,9.59004e-10,-7.08716e-14,21305.9,-84.3862], Tmin=(974.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.958,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(C=CCJCO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.3028,'amu*angstrom^2'), symmetry=1, barrier=(29.954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.30448,'amu*angstrom^2'), symmetry=1, barrier=(29.9927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.30542,'amu*angstrom^2'), symmetry=1, barrier=(30.0141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.30599,'amu*angstrom^2'), symmetry=1, barrier=(30.0273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.127,'amu'),
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.770472,0.0552695,-3.00516e-06,-4.21705e-08,2.18046e-11,18227.2,26.3996], Tmin=(100,'K'), Tmax=(962.905,'K')), NASAPolynomial(coeffs=[18.5286,0.0194876,-6.44006e-06,1.1777e-09,-8.70434e-14,13046.3,-67.7463], Tmin=(962.905,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CCJ(O)C) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CCCO[C]=C(2123)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.519928,0.0668532,-4.65184e-05,7.7768e-09,3.13855e-12,46024.3,29.6696], Tmin=(100,'K'), Tmax=(1002.28,'K')), NASAPolynomial(coeffs=[16.7255,0.0216072,-7.88031e-06,1.41684e-09,-9.90953e-14,41799.9,-53.418], Tmin=(1002.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(381.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OCCC=C(2124)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {6,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {2,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (96.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.163175,0.0697764,-3.43534e-05,-1.66547e-08,1.44324e-11,30156.1,25.0907], Tmin=(100,'K'), Tmax=(957.581,'K')), NASAPolynomial(coeffs=[21.3321,0.0161866,-4.9777e-06,8.85557e-10,-6.55226e-14,24504.7,-84.4592], Tmin=(957.581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(Cds_S)"""),
)

species(
    label = '[CH]C=CCOC=C(2126)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {5,S}
2  C u0 p0 c0 {1,S} {3,S} {8,S} {9,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(57)', 'C=C[CH]C[O](1223)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C=C(1759)', '[CH2]O[C]=C(141)'],
    products = ['C=[C]OC[CH]C=C(1860)'],
    transitionState = 'TS3',
...
reaction(
    ...
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.25216e+09,'s^-1'), n=0.38532, Ea=(59.7134,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_linear;doublebond_intra_pri_2H;radadd_intra] for rate rule [R6_linear;doublebond_intra_pri_2H;radadd_intra_cddouble]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(77.0853,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', 'C=[C]OCC=C=C(2118)'],
    products = ['C=[C]OC[CH]C=C(1860)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'C#COC[CH]C=C(2119)'],
    products = ['C=[C]OC[CH]C=C(1860)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.47663e+07,'m^3/(mol*s)'), n=1.31229e-07, Ea=(5.55686,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction16',
    reactants = ['C=[C]O[CH]CC=C(2097)'],
    products = ['C=[C]OC[CH]C=C(1860)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(24)', 'C=[C]O[CH]C=C(1324)'],
    products = ['C=[C]OC[CH]C=C(1860)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(151.149,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(17)', '[CH]=CCO[C]=C(1514)'],
    products = ['C=[C]OC[CH]C=C(1860)'],
