...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(152)', '[CH2]C[CH2](51)'],
    products = ['[CH2]CC[C]=O(469)'],
    transitionState = 'TS4',
