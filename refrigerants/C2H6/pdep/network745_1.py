...
"""),
    E0 = (919.993,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,2523.22],'cm^-1')),
        HinderedRotor(inertia=(0.0027921,'amu*angstrom^2'), symmetry=1, barrier=(12.6041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.18937,'amu*angstrom^2'), symmetry=1, barrier=(73.33,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.19106,'amu*angstrom^2'), symmetry=1, barrier=(73.3687,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04586,0.0415729,-3.16595e-05,9.78675e-09,7.12409e-13,110721,22.3447], Tmin=(100,'K'), Tmax=(835.391,'K')), NASAPolynomial(coeffs=[8.28467,0.0196221,-6.46944e-06,1.03555e-09,-6.56742e-14,109403,-8.28629], Tmin=(835.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(919.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Isobutyl) + radical(CdCdJ2_triplet)"""),
)
...
"""),
    E0 = (806.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,265.425,265.44,265.441,2321.2],'cm^-1')),
        HinderedRotor(inertia=(0.00239281,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310451,'amu*angstrom^2'), symmetry=1, barrier=(15.5191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00239281,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0191828,'amu*angstrom^2'), symmetry=1, barrier=(73.3444,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34214,0.056717,-4.71991e-05,2.24524e-08,-4.48581e-12,97137.5,26.6825], Tmin=(100,'K'), Tmax=(1177.45,'K')), NASAPolynomial(coeffs=[9.71431,0.0282752,-1.0966e-05,1.93728e-09,-1.29973e-13,95166,-15.0759], Tmin=(1177.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(806.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[C]=CC1CC1(2598)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91001,0.0318823,3.52681e-05,-6.45938e-08,2.58788e-11,38110.5,21.4122], Tmin=(100,'K'), Tmax=(981.974,'K')), NASAPolynomial(coeffs=[11.5514,0.0270583,-9.98576e-06,1.85506e-09,-1.33745e-13,34556.1,-33.3834], Tmin=(981.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C1C=C(C)C1(2589)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    E0 = (502.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,540,610,2055,245.162],'cm^-1')),
        HinderedRotor(inertia=(1.81064,'amu*angstrom^2'), symmetry=1, barrier=(77.5874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.29692,'amu*angstrom^2'), symmetry=1, barrier=(12.7066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0121025,'amu*angstrom^2'), symmetry=1, barrier=(77.5894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41477,0.0511992,-2.71882e-05,-2.13121e-09,5.51936e-12,60531.4,25.0871], Tmin=(100,'K'), Tmax=(922.534,'K')), NASAPolynomial(coeffs=[10.8754,0.0248363,-8.15522e-06,1.33679e-09,-8.75163e-14,58162.1,-23.1725], Tmin=(922.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(502.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
"""),
    E0 = (484.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2100,2250,500,550,2035.15],'cm^-1')),
        HinderedRotor(inertia=(3.00418,'amu*angstrom^2'), symmetry=1, barrier=(69.0719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269904,'amu*angstrom^2'), symmetry=1, barrier=(6.20563,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.00456,'amu*angstrom^2'), symmetry=1, barrier=(69.0807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0234607,'amu*angstrom^2'), symmetry=1, barrier=(69.092,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09099,0.0537807,-4.31941e-05,2.08121e-08,-3.98684e-12,58404.5,26.6124], Tmin=(100,'K'), Tmax=(1478.49,'K')), NASAPolynomial(coeffs=[9.51164,0.0239116,-5.70004e-06,6.63385e-10,-3.16376e-14,56689.2,-14.6854], Tmin=(1478.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])=C[C]C(2602)',
    structure = adjacencyList("""multiplicity 5
1  C u0 p0 c0 {6,S} {7,S} {8,S} {9,S}
...
"""),
    E0 = (659.611,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,291.042],'cm^-1')),
        HinderedRotor(inertia=(0.0309668,'amu*angstrom^2'), symmetry=1, barrier=(20.6285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22238,'amu*angstrom^2'), symmetry=1, barrier=(28.1049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0309561,'amu*angstrom^2'), symmetry=1, barrier=(20.6276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.52352,'amu*angstrom^2'), symmetry=1, barrier=(81.0126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08386,0.0541824,-2.34752e-05,-9.5347e-09,7.84274e-12,79446.6,23.5747], Tmin=(100,'K'), Tmax=(1006.34,'K')), NASAPolynomial(coeffs=[14.2139,0.0231481,-8.7493e-06,1.59911e-09,-1.12607e-13,75732.8,-45.1751], Tmin=(1006.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(659.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.114301,'amu*angstrom^2'), symmetry=1, barrier=(2.62801,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114043,'amu*angstrom^2'), symmetry=1, barrier=(2.62207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113307,'amu*angstrom^2'), symmetry=1, barrier=(2.60514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113547,'amu*angstrom^2'), symmetry=1, barrier=(2.61068,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33149,0.0605009,-6.68879e-05,4.7059e-08,-1.37979e-11,96498.4,27.28], Tmin=(100,'K'), Tmax=(902.175,'K')), NASAPolynomial(coeffs=[7.2583,0.0307557,-1.16673e-05,1.99359e-09,-1.29432e-13,95570.1,0.0786973], Tmin=(902.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(801.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_S)"""),
)
...
"""),
    E0 = (477.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,248.171],'cm^-1')),
        HinderedRotor(inertia=(0.00264263,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.74481,'amu*angstrom^2'), symmetry=1, barrier=(73.9623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00287398,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0360815,'amu*angstrom^2'), symmetry=1, barrier=(73.8879,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36909,0.0491312,-9.81211e-06,-2.36814e-08,1.37794e-11,57516.4,26.478], Tmin=(100,'K'), Tmax=(924.212,'K')), NASAPolynomial(coeffs=[11.9923,0.0255946,-8.03356e-06,1.30775e-09,-8.6726e-14,54594.4,-29.1206], Tmin=(924.212,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(477.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Isobutyl) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([CH2])[C]=CC(2606)',
    structure = adjacencyList("""multiplicity 4
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[CH2][CH]C=[C]C(2102)'],
    products = ['[CH2]C([CH2])C=[C]C(2214)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(18)', '[C]=CC([CH2])[CH2](2444)'],
    products = ['[CH2]C([CH2])C=[C]C(2214)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(6)', '[CH]C([CH2])C=[C]C(2597)'],
    products = ['[CH2]C([CH2])C=[C]C(2214)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[CH2]C([CH2])=C[C]C(2602)'],
    products = ['[CH2]C([CH2])C=[C]C(2214)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2.88633e+07,'m^3/(mol*s)'), n=0.213913, Ea=(8.74468,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=8.197906922440378e-05, var=0.01210657880115639, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction19',
    reactants = ['H(6)', '[CH2][C]=CC([CH2])[CH2](2603)'],
    products = ['[CH2]C([CH2])C=[C]C(2214)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(6)', '[CH2]C([CH2])[C]=[C]C(2604)'],
    products = ['[CH2]C([CH2])C=[C]C(2214)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C=CC([CH2])[CH2](2605)'],
    products = ['[CH2]C([CH2])C=[C]C(2214)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C([CH2])C=[C]C(2214)'],
    products = ['[CH2]C([CH2])=C[CH]C(2607)'],
