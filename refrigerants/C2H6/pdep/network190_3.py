...
"""),
    ...
    molecularWeight = (41.0287,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.48414,0.00854463,-2.61856e-07,-6.00666e-09,2.80778e-12,59061.3,7.6362], Tmin=(100,'K'), Tmax=(1058.73,'K')), NASAPolynomial(coeffs=[6.70387,0.00277932,-1.15991e-06,2.67713e-10,-2.18518e-14,58020.9,-9.77464], Tmin=(1058.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo library: FFCM1(-) + radical(CJ3)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(6)', 'HCCO(20)'],
    products = ['[CH2][C]=O(189)'],
    transitionState = 'TS1',
