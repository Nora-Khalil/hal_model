...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)C([CH2])=C(1447)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[CH2]C(=C)[C]=C(1483)'],
    products = ['[CH2]C(=C)C([CH2])=C(1447)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=C)C([CH2])=C(1447)'],
    products = ['[CH2]C1=C([CH2])CC1(1602)'],
    transitionState = 'TS6',
