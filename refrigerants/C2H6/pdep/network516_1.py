...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(857)', 'CH2(T)(17)'],
    products = ['[CH2]OC([O])=O(860)'],
    transitionState = 'TS2',
