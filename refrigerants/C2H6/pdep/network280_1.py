...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C=C(214)'],
    products = ['C=CCO[O](432)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['C=CCO[O](432)'],
    products = ['HO2(12)', 'C=C=C(430)'],
    transitionState = 'TS4',
