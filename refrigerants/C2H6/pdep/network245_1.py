...
"""),
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71857,0.00907058,8.67818e-05,-1.17238e-07,4.4972e-11,13620,15.2058], Tmin=(100,'K'), Tmax=(953.256,'K')), NASAPolynomial(coeffs=[11.8046,0.019507,-6.05645e-06,1.13148e-09,-8.70652e-14,9681.34,-39.7672], Tmin=(953.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.867876,'amu*angstrom^2'), symmetry=1, barrier=(19.9542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.872424,'amu*angstrom^2'), symmetry=1, barrier=(20.0588,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.109,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93302,0.0363757,-1.10368e-06,-2.51393e-08,1.24817e-11,36764.6,17.623], Tmin=(100,'K'), Tmax=(973.632,'K')), NASAPolynomial(coeffs=[11.5283,0.0184064,-6.46807e-06,1.16265e-09,-8.23217e-14,33879.4,-33.6337], Tmin=(973.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (318.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,381.426,381.599,382.688,386.652],'cm^-1')),
        HinderedRotor(inertia=(0.498202,'amu*angstrom^2'), symmetry=1, barrier=(51.5116,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.495674,'amu*angstrom^2'), symmetry=1, barrier=(51.5328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.496312,'amu*angstrom^2'), symmetry=1, barrier=(51.4885,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[CH]C(369)'],
    products = ['C2H2(22)', 'C=CC(60)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=CC([CH2])C(370)'],
    products = ['[CH]=CC[CH]C(369)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[CH](58)', '[CH2][CH]C(195)'],
    products = ['[CH]=CC[CH]C(369)'],
