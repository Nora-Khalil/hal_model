...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)C=[C]C(1180)'],
    products = ['C#CC(211)', 'C#CC(211)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CC=[C]C(1123)'],
    products = ['[CH]=C(C)C=[C]C(1180)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(6)', '[CH]=C(C)C=C=C(1362)'],
    products = ['[CH]=C(C)C=[C]C(1180)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(18)', 'C#CC=[C]C(1230)'],
    products = ['[CH]=C(C)C=[C]C(1180)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH]=C(C)C#CC(1363)'],
    products = ['[CH]=C(C)C=[C]C(1180)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]C(212)', '[CH]=[C]C(212)'],
    products = ['[CH]=C(C)C=[C]C(1180)'],
    transitionState = 'TS9',
