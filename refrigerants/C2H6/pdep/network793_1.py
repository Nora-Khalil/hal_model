...
"""),
    E0 = (84.8686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,180,1343.72,1343.83,1344.24,1344.39],'cm^-1')),
        HinderedRotor(inertia=(0.135462,'amu*angstrom^2'), symmetry=1, barrier=(3.11453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135231,'amu*angstrom^2'), symmetry=1, barrier=(3.10923,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.85117,0.0172279,2.84405e-05,-3.99867e-08,1.36572e-11,5138.63,17.5461], Tmin=(100,'K'), Tmax=(1086.26,'K')), NASAPolynomial(coeffs=[6.50065,0.0248551,-1.11811e-05,2.18287e-09,-1.5673e-13,3102.92,-6.08326], Tmin=(1086.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.3251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdCsOs) + ring(Cyclopropane) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C(=C)[C]1OO1(1496)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83659,0.0350073,7.90908e-06,-4.58349e-08,2.34632e-11,43143.1,20.0686], Tmin=(100,'K'), Tmax=(912.44,'K')), NASAPolynomial(coeffs=[15.8739,0.00667346,-9.63698e-08,-1.03904e-10,6.11761e-15,39199.3,-53.9411], Tmin=(912.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(dioxirane) + radical(Cs_P) + radical(Allyl_P)"""),
)

species(
    label = '[CH2][C]1COC1=O(1497)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71895,0.0153183,5.0284e-05,-7.91773e-08,3.30719e-11,4517.7,19.4505], Tmin=(100,'K'), Tmax=(907.51,'K')), NASAPolynomial(coeffs=[10.6456,0.0138486,-2.6055e-06,3.13621e-10,-2.10102e-14,1700.82,-25.6148], Tmin=(907.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(CCJ(C)CO) + radical(CJC(C)C=O)"""),
)

species(
    label = 'C=C1CC1([O])[O](1490)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {4,S}
2  O u1 p2 c0 {4,S}
3  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
...
reaction(
    label = 'reaction2',
    reactants = ['C=[C]CC([O])=O(1381)'],
    products = ['[CH2]C(=C)C([O])=O(1273)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'C=C=C([O])[O](942)'],
    products = ['[CH2]C(=C)C([O])=O(1273)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(7)', '[CH2]C(=C)[C]=O(1494)'],
    products = ['[CH2]C(=C)C([O])=O(1273)'],
    transitionState = 'TS4',
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.24905e+10,'s^-1'), n=0.5217, Ea=(90.2282,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_(CO)_D;doublebond_intra_2H;radadd_intra_O]
