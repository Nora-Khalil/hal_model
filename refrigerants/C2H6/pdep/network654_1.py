...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC=[C]C(1123)'],
    products = ['C2H2(22)', 'C#CC(211)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['H(6)', '[CH]=CC=C=C(1228)'],
    products = ['[CH]=CC=[C]C(1123)'],
    transitionState = 'TS4',
