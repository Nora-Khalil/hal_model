...
"""),
    E0 = (587.331,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,920.864,920.96,920.998,921.114,921.115,921.123,921.13,3143.2],'cm^-1')),
        HinderedRotor(inertia=(0.123618,'amu*angstrom^2'), symmetry=1, barrier=(2.84221,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (66.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71107,0.0154563,4.69608e-05,-7.01811e-08,2.74004e-11,70697.7,19.0077], Tmin=(100,'K'), Tmax=(964.744,'K')), NASAPolynomial(coeffs=[10.1259,0.0170761,-5.87604e-06,1.10213e-09,-8.21256e-14,67761,-24.3037], Tmin=(964.744,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(587.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(Cds_P)"""),
)

species(
    label = '[CH]C=CC1CC1(2323)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95557,0.0270541,6.10133e-05,-9.52648e-08,3.75038e-11,54089.7,21.8837], Tmin=(100,'K'), Tmax=(964.171,'K')), NASAPolynomial(coeffs=[12.5142,0.0279349,-9.8751e-06,1.81802e-09,-1.32296e-13,49976.6,-39.4413], Tmin=(964.171,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(448.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=CC1CC1[CH2](1919)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8917,0.0292751,4.73643e-05,-8.63686e-08,3.6695e-11,64278.4,22.6547], Tmin=(100,'K'), Tmax=(932.959,'K')), NASAPolynomial(coeffs=[14.6882,0.0179693,-4.49112e-06,7.29385e-10,-5.41023e-14,59995,-48.3527], Tmin=(932.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(533.679,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = 'C1=CC2CCC12(2324)',
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.63905,0.00960803,9.43496e-05,-1.23748e-07,4.61453e-11,29579.9,14.164], Tmin=(100,'K'), Tmax=(973.061,'K')), NASAPolynomial(coeffs=[11.4494,0.0250862,-9.19978e-06,1.79351e-09,-1.35975e-13,25418,-40.6757], Tmin=(973.061,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(245.383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_4_ene_1)"""),
)

species(
    label = 'C=CC1=CCC1(2325)',
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92821,0.0251795,6.41495e-05,-1.05143e-07,4.3141e-11,23507.1,18.1665], Tmin=(100,'K'), Tmax=(946.193,'K')), NASAPolynomial(coeffs=[16.0543,0.0169919,-4.56137e-06,8.26409e-10,-6.552e-14,18527.2,-61.3917], Tmin=(946.193,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85583,0.0286854,4.75522e-05,-8.78405e-08,3.726e-11,53226.8,18.8295], Tmin=(100,'K'), Tmax=(943.802,'K')), NASAPolynomial(coeffs=[16.2934,0.014161,-3.52845e-06,6.27898e-10,-5.06735e-14,48423.2,-60.9987], Tmin=(943.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC1C=CC1(2328)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (79.1196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97988,0.0321771,2.16522e-05,-4.91652e-08,2.0481e-11,55801.6,18.5935], Tmin=(100,'K'), Tmax=(985.362,'K')), NASAPolynomial(coeffs=[11.6966,0.0222962,-8.31032e-06,1.55488e-09,-1.12619e-13,52451.5,-35.4237], Tmin=(985.362,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(463.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (79.1196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37217,0.021839,4.92843e-05,-7.68448e-08,3.04573e-11,52860.1,19.8873], Tmin=(100,'K'), Tmax=(954.468,'K')), NASAPolynomial(coeffs=[10.4437,0.0230382,-7.64487e-06,1.36537e-09,-9.81861e-14,49723.9,-27.0347], Tmin=(954.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(438.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Ct-CtCs) + group(Ct-CtH) + ring(Cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = '[CH]C=C1CCC1(2330)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02253,0.0307912,3.83724e-05,-6.12919e-08,2.26297e-11,54285.6,20.2806], Tmin=(100,'K'), Tmax=(1025.07,'K')), NASAPolynomial(coeffs=[8.63372,0.0360287,-1.47065e-05,2.76443e-09,-1.96103e-13,51299.7,-19.7317], Tmin=(1025.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(450.673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(methylenecyclobutane) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=CC1C[CH]C1(2331)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {5,S} {7,S}
2  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {4,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07748,0.0261537,4.95699e-05,-8.06104e-08,3.19183e-11,68766.4,21.6669], Tmin=(100,'K'), Tmax=(972.352,'K')), NASAPolynomial(coeffs=[12.4099,0.0237273,-8.51404e-06,1.60324e-09,-1.18338e-13,64862.5,-37.6339], Tmin=(972.352,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(571.061,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C=C1[CH]CC1(2334)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23492,0.0230041,5.58518e-05,-8.2784e-08,3.13259e-11,44891,18.2751], Tmin=(100,'K'), Tmax=(992.1,'K')), NASAPolynomial(coeffs=[10.8527,0.0276833,-1.08307e-05,2.0801e-09,-1.52551e-13,41240.9,-33.0106], Tmin=(992.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(372.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(methylenecyclobutane) + radical(Allyl_S) + radical(Allyl_P)"""),
)

species(
    label = 'C=CC1[CH]C[CH]1(2335)',
    structure = adjacencyList("""multiplicity 3
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC1[CH]CC1(1917)'],
    products = ['C2H2(22)', 'C1=CCC1(69)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH]=CC1[CH]C1(2322)'],
    products = ['[CH]=CC1[CH]CC1(1917)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[CH]=CC1=CCC1(2327)'],
    products = ['[CH]=CC1[CH]CC1(1917)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(2.97324,'m^3/(mol*s)'), n=2.12322, Ea=(8.97529,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0984061311673169, var=1.772613507237397, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_2CS-inRing_N-Sp-2CS-=1CCOSS_1COS-inRing_Ext-2CS-R_Ext-4R!H-R_Ext-1COS-R',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_2CS-inRing_N-Sp-2CS-=1CCOSS_1COS-inRing_Ext-2CS-R_Ext-4R!H-R_Ext-1COS-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(6)', '[CH]=CC1C=CC1(2328)'],
    products = ['[CH]=CC1[CH]CC1(1917)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C2H2(22)', '[CH]1[CH]CC1(2183)'],
    products = ['[CH]=CC1[CH]CC1(1917)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.1632,'m^3/(mol*s)'), n=2.24, Ea=(21.1513,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_N-Sp-2R!H=1R!H',), comment="""Estimated from node Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_N-Sp-2R!H=1R!H
Multiplied by reaction path degeneracy 4.0"""),
)

reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'C#CC1[CH]CC1(2329)'],
    products = ['[CH]=CC1[CH]CC1(1917)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[CH](58)', '[CH]1[CH]CC1(2183)'],
    products = ['[CH]=CC1[CH]CC1(1917)'],
