...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(O)OC#C(525)'],
    products = ['HCCO(20)', 'CH2CO(27)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(6)', '[C]=C(O)OC#C(1051)'],
    products = ['[CH]=C(O)OC#C(525)'],
    transitionState = 'TS2',
