...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.788214,0.0597582,-3.16933e-05,-1.09838e-08,1.14357e-11,-18824.7,19.3667], Tmin=(100,'K'), Tmax=(935.054,'K')), NASAPolynomial(coeffs=[17.603,0.0151964,-4.1133e-06,6.55674e-10,-4.56834e-14,-23165.8,-67.0238], Tmin=(935.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = '[CH2]C(C)[C]1CO1(702)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (13.206,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,245.13],'cm^-1')),
        HinderedRotor(inertia=(0.152643,'amu*angstrom^2'), symmetry=1, barrier=(6.50835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152638,'amu*angstrom^2'), symmetry=1, barrier=(6.50834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152642,'amu*angstrom^2'), symmetry=1, barrier=(6.50834,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08825,0.0598829,-5.32715e-05,2.6158e-08,-5.22491e-12,1696.64,22.4267], Tmin=(100,'K'), Tmax=(1202.41,'K')), NASAPolynomial(coeffs=[11.8016,0.0242426,-8.80958e-06,1.50599e-09,-9.92682e-14,-879.681,-31.2336], Tmin=(1202.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.206,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C(C)=C([CH2])O(707)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.450123,'amu*angstrom^2'), symmetry=1, barrier=(16.3454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.45147,'amu*angstrom^2'), symmetry=1, barrier=(16.3329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00331507,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.451836,'amu*angstrom^2'), symmetry=1, barrier=(16.3463,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.939288,0.0564191,-2.38091e-05,-2.0017e-08,1.5398e-11,22893.4,25.3068], Tmin=(100,'K'), Tmax=(908.961,'K')), NASAPolynomial(coeffs=[17.2078,0.0143072,-2.96261e-06,3.73857e-10,-2.38543e-14,18718.1,-58.3252], Tmin=(908.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C([CH2])C(=C)O(709)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (147.332,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,449.089],'cm^-1')),
        HinderedRotor(inertia=(0.0101886,'amu*angstrom^2'), symmetry=1, barrier=(1.46352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.077789,'amu*angstrom^2'), symmetry=1, barrier=(11.2157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0785705,'amu*angstrom^2'), symmetry=1, barrier=(11.2345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.574901,'amu*angstrom^2'), symmetry=1, barrier=(82.2983,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0327968,0.0669214,-6.20223e-05,2.92273e-08,-5.14484e-12,17883.9,29.4953], Tmin=(100,'K'), Tmax=(1658.35,'K')), NASAPolynomial(coeffs=[16.3298,0.0138202,-1.65958e-06,3.56616e-12,8.06982e-15,14331.7,-52.0691], Tmin=(1658.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=C([O])C(C)C(710)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {7,S}
3  C u0 p0 c0 {2,S} {9,S} {10,S} {11,S}
...
"""),
    E0 = (122.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3120,650,792.5,1650,245.906],'cm^-1')),
        HinderedRotor(inertia=(0.00299747,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269178,'amu*angstrom^2'), symmetry=1, barrier=(11.4432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271276,'amu*angstrom^2'), symmetry=1, barrier=(11.4591,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25055,0.0512361,-2.07221e-05,-1.25272e-08,9.50105e-12,14788.7,23.2136], Tmin=(100,'K'), Tmax=(963.766,'K')), NASAPolynomial(coeffs=[13.7471,0.0209185,-7.07299e-06,1.22984e-09,-8.51943e-14,11379.3,-41.8055], Tmin=(963.766,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(122.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(C)C[C]=O(531)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {6,D}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.154274,'amu*angstrom^2'), symmetry=1, barrier=(3.54707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154316,'amu*angstrom^2'), symmetry=1, barrier=(3.54804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154224,'amu*angstrom^2'), symmetry=1, barrier=(3.54591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154374,'amu*angstrom^2'), symmetry=1, barrier=(3.54935,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53641,0.0548492,-4.76698e-05,2.52245e-08,-5.75763e-12,12730.9,25.0475], Tmin=(100,'K'), Tmax=(1026.94,'K')), NASAPolynomial(coeffs=[7.77666,0.0305432,-1.21677e-05,2.1776e-09,-1.47107e-13,11449.2,-5.22411], Tmin=(1026.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Isobutyl) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0938994,'amu*angstrom^2'), symmetry=1, barrier=(8.49901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0938805,'amu*angstrom^2'), symmetry=1, barrier=(8.50097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0938426,'amu*angstrom^2'), symmetry=1, barrier=(8.49246,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1249,0.0431167,-3.86262e-05,2.0317e-08,-4.61448e-12,16463.3,19.7425], Tmin=(100,'K'), Tmax=(1025.02,'K')), NASAPolynomial(coeffs=[7.0684,0.0238253,-1.03952e-05,1.95561e-09,-1.36146e-13,15449.9,-4.22918], Tmin=(1025.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(C)C=O) + radical(CC(C)CJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32664,0.0227378,5.01975e-05,-7.46468e-08,2.82013e-11,-17423.3,18.8782], Tmin=(100,'K'), Tmax=(990.693,'K')), NASAPolynomial(coeffs=[9.69425,0.0279914,-1.07515e-05,2.02927e-09,-1.46927e-13,-20600.8,-25.2662], Tmin=(990.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutanone)"""),
)

species(
    label = 'C=C(C)C(C)=O(714)',
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13423,0.0568868,-5.00846e-05,2.67587e-08,-5.73917e-12,27247.8,21.3121], Tmin=(100,'K'), Tmax=(1288.24,'K')), NASAPolynomial(coeffs=[9.43752,0.0253786,-6.72936e-06,8.71675e-10,-4.5833e-14,25583.6,-19.0052], Tmin=(1288.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.65,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C(C)=C(C)[O](716)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
2  C u0 p0 c0 {4,S} {9,S} {10,S} {11,S}
3  C u0 p0 c0 {5,S} {7,S} {8,S} {12,S}
...
"""),
    E0 = (133.287,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,4000],'cm^-1')),
        HinderedRotor(inertia=(0.801182,'amu*angstrom^2'), symmetry=1, barrier=(32.2396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201124,'amu*angstrom^2'), symmetry=1, barrier=(8.09319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201123,'amu*angstrom^2'), symmetry=1, barrier=(8.09319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201124,'amu*angstrom^2'), symmetry=1, barrier=(8.09319,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.980574,0.0715264,-9.55768e-05,7.7772e-08,-2.61476e-11,16134.5,23.9389], Tmin=(100,'K'), Tmax=(797.109,'K')), NASAPolynomial(coeffs=[7.46661,0.0339745,-1.54946e-05,2.91901e-09,-2.01011e-13,15259.5,-4.8844], Tmin=(797.109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CJC(C)C=O) + radical(CJC(C)C=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]CC(=C)[O](467)'],
    products = ['[CH2]C(C)C(=C)[O](529)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(C)C(=C)[O](529)'],
    products = ['[CH2]C=C([O])CC(700)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3431.13,'s^-1'), n=2.77015, Ea=(361.73,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H-inRing_2R!H->C',), comment="""Estimated from node Root_N-1R!H-inRing_2R!H->C"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(17)', '[CH2]C([O])=CC(574)'],
    products = ['[CH2]C(C)C(=C)[O](529)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C=C([CH2])OC(711)'],
    products = ['[CH2]C(C)C(=C)[O](529)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(7040,'s^-1'), n=2.66, Ea=(387.945,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H-inRing_N-2R!H->C',), comment="""Estimated from node Root_N-1R!H-inRing_N-2R!H->C"""),
)

reaction(
    label = 'reaction25',
    reactants = ['CH2(T)(17)', '[CH2]C(C)[C]=O(712)'],
    products = ['[CH2]C(C)C(=C)[O](529)'],
