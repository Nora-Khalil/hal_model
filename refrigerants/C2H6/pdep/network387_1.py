...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01591,'amu*angstrom^2'), symmetry=1, barrier=(23.3577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01719,'amu*angstrom^2'), symmetry=1, barrier=(23.3871,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.814212,0.0569185,-1.99301e-05,-2.30523e-08,1.51447e-11,-1389.26,18.7811], Tmin=(100,'K'), Tmax=(958.2,'K')), NASAPolynomial(coeffs=[18.2221,0.0157975,-4.9447e-06,8.82499e-10,-6.49233e-14,-6173.61,-72.0161], Tmin=(958.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.6036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.13554,'amu*angstrom^2'), symmetry=1, barrier=(3.11633,'kJ/mol'), semiclassical=False),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(2218.31,'J/mol'), sigma=(4.982,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=1.0, comment="""GRI-Mech"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.23517,0.0111018,2.80207e-05,-3.5945e-08,1.23654e-11,9053.76,11.9814], Tmin=(100,'K'), Tmax=(1029.99,'K')), NASAPolynomial(coeffs=[4.3659,0.0214398,-8.48551e-06,1.568e-09,-1.09812e-13,8039.53,2.70013], Tmin=(1029.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.0074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""ipropyl""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47204,0.0275919,1.27874e-06,-1.70115e-08,7.40022e-12,-7309.35,14.2688], Tmin=(100,'K'), Tmax=(1031.38,'K')), NASAPolynomial(coeffs=[7.67896,0.020676,-7.97419e-06,1.45196e-09,-1.00894e-13,-9089.63,-14.4361], Tmin=(1031.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.2739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""ipropoxy""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.815057,'amu*angstrom^2'), symmetry=1, barrier=(18.7398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.815866,'amu*angstrom^2'), symmetry=1, barrier=(18.7584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.815017,'amu*angstrom^2'), symmetry=1, barrier=(18.7389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.813905,'amu*angstrom^2'), symmetry=1, barrier=(18.7133,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.736409,0.0673648,-6.96095e-05,3.69021e-08,-7.70787e-12,20339.1,19.0072], Tmin=(100,'K'), Tmax=(1168.92,'K')), NASAPolynomial(coeffs=[14.9667,0.0186689,-7.12082e-06,1.26293e-09,-8.55933e-14,17012.2,-51.8669], Tmin=(1168.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(C2CsJOCs)"""),
)

species(
    label = 'C#COC([CH2])C(689)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01468,'amu*angstrom^2'), symmetry=1, barrier=(23.3294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01425,'amu*angstrom^2'), symmetry=1, barrier=(23.3196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01445,'amu*angstrom^2'), symmetry=1, barrier=(23.3243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01384,'amu*angstrom^2'), symmetry=1, barrier=(23.3101,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0955543,0.0739414,-7.79913e-05,4.00692e-08,-7.85155e-12,23953.4,21.8096], Tmin=(100,'K'), Tmax=(1339.91,'K')), NASAPolynomial(coeffs=[19.8292,0.010929,-2.85816e-06,4.02189e-10,-2.41998e-14,19033.3,-77.7941], Tmin=(1339.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJC(C)OC)"""),
)

species(
    label = '[C]#COC(C)C(1509)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {2,S} {5,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
...
"""),
    E0 = (324.54,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2175,525,228.889,228.92,228.975],'cm^-1')),
        HinderedRotor(inertia=(0.563146,'amu*angstrom^2'), symmetry=1, barrier=(20.9491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.5634,'amu*angstrom^2'), symmetry=1, barrier=(20.949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.563399,'amu*angstrom^2'), symmetry=1, barrier=(20.9482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.563478,'amu*angstrom^2'), symmetry=1, barrier=(20.9488,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.857684,0.0602193,-4.16651e-05,2.76299e-09,5.79786e-12,39154.4,19.3674], Tmin=(100,'K'), Tmax=(944.869,'K')), NASAPolynomial(coeffs=[16.5234,0.0154159,-4.69569e-06,7.7856e-10,-5.36022e-14,35233.5,-60.4048], Tmin=(944.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)

species(
    label = '[C]=COC(C)C(1510)',
    structure = adjacencyList("""1  O u0 p2 c0 {2,S} {5,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
4  C u0 p0 c0 {2,S} {11,S} {12,S} {13,S}
...
"""),
    E0 = (164.026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,228.927,229.115,229.575],'cm^-1')),
        HinderedRotor(inertia=(0.411615,'amu*angstrom^2'), symmetry=1, barrier=(15.3406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.412423,'amu*angstrom^2'), symmetry=1, barrier=(15.3409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410431,'amu*angstrom^2'), symmetry=1, barrier=(15.3396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.411463,'amu*angstrom^2'), symmetry=1, barrier=(15.3407,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.816814,0.0672304,-6.42851e-05,3.22717e-08,-6.51779e-12,19844.8,19.866], Tmin=(100,'K'), Tmax=(1191.16,'K')), NASAPolynomial(coeffs=[13.686,0.0240141,-9.86299e-06,1.81234e-09,-1.24908e-13,16779,-44.4714], Tmin=(1191.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(18)', 'C#CO[CH]C(1322)'],
    products = ['C#COC(C)C(1078)'],
    transitionState = 'TS5',
