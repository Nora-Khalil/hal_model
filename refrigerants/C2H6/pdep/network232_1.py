...
"""),
    E0 = (123.939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,489.228],'cm^-1')),
        HinderedRotor(inertia=(0.492606,'amu*angstrom^2'), symmetry=1, barrier=(11.326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0175244,'amu*angstrom^2'), symmetry=1, barrier=(2.97509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0666862,'amu*angstrom^2'), symmetry=1, barrier=(11.3258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.492604,'amu*angstrom^2'), symmetry=1, barrier=(11.3259,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28928,0.0617633,-6.84365e-05,4.30502e-08,-1.11386e-11,15002.2,19.9619], Tmin=(100,'K'), Tmax=(931.795,'K')), NASAPolynomial(coeffs=[9.57866,0.0261785,-1.11518e-05,2.06464e-09,-1.42165e-13,13457.4,-19.4439], Tmin=(931.795,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)OC) + radical(CsJOCC2)"""),
)
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75626,0.0391685,-3.61342e-08,-2.85097e-08,1.39073e-11,-22731.9,16.9111], Tmin=(100,'K'), Tmax=(978.581,'K')), NASAPolynomial(coeffs=[12.3462,0.019822,-7.07782e-06,1.28747e-09,-9.17958e-14,-25950.8,-39.8069], Tmin=(978.581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4482,0.0609278,-8.04945e-05,6.71256e-08,-2.30585e-11,11408.8,18.8852], Tmin=(100,'K'), Tmax=(822.286,'K')), NASAPolynomial(coeffs=[5.91466,0.0319132,-1.42725e-05,2.65823e-09,-1.81568e-13,10920.6,-0.290736], Tmin=(822.286,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.1324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(CsJOCC2)"""),
)

species(
    label = '[CH2][C](C)OC(333)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  C u0 p0 c0 {4,S} {6,S} {7,S} {8,S}
3  C u0 p0 c0 {1,S} {9,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.372,0.0674901,-0.000109478,1.04181e-07,-3.79403e-11,14645.2,20.1852], Tmin=(100,'K'), Tmax=(867.254,'K')), NASAPolynomial(coeffs=[3.25934,0.0363508,-1.68169e-05,3.12369e-09,-2.10557e-13,15161.5,16.2128], Tmin=(867.254,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C([CH2])OC(334)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (150.864,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,214.117,214.118],'cm^-1')),
        HinderedRotor(inertia=(0.175685,'amu*angstrom^2'), symmetry=1, barrier=(5.71561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175682,'amu*angstrom^2'), symmetry=1, barrier=(5.7156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175682,'amu*angstrom^2'), symmetry=1, barrier=(5.71561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175686,'amu*angstrom^2'), symmetry=1, barrier=(5.71561,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10977,0.0696322,-0.000102456,8.7433e-08,-2.95709e-11,18243,20.2406], Tmin=(100,'K'), Tmax=(854.935,'K')), NASAPolynomial(coeffs=[7.06207,0.0303722,-1.35523e-05,2.49557e-09,-1.68258e-13,17642.2,-5.10397], Tmin=(854.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]CO[CH2](104)'],
    products = ['[CH2]OC([CH2])C(318)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', '[CH2]C(C)[O](200)'],
    products = ['[CH2]OC([CH2])C(318)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(17)', '[CH2]O[CH]C(119)'],
    products = ['[CH2]OC([CH2])C(318)'],
    transitionState = 'TS5',
