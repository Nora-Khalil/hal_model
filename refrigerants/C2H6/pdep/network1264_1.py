...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74376,0.0519157,-3.85637e-05,1.52376e-08,-2.58639e-12,-3347.9,24.0507], Tmin=(100,'K'), Tmax=(1312.96,'K')), NASAPolynomial(coeffs=[8.88757,0.030152,-1.36998e-05,2.61282e-09,-1.82539e-13,-5223.82,-12.3592], Tmin=(1312.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(C=CCJ(O)C) + radical((O)CJOCC)"""),
)
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36076,0.0575115,-4.627e-05,1.88465e-08,-3.15385e-12,-23407.5,21.4621], Tmin=(100,'K'), Tmax=(1381.87,'K')), NASAPolynomial(coeffs=[12.269,0.0259362,-1.19953e-05,2.31107e-09,-1.6234e-13,-26422.3,-34.6919], Tmin=(1381.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-195.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (1.03629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,540,610,2055,1855,455,950,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.996078,'amu*angstrom^2'), symmetry=1, barrier=(22.9018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.995978,'amu*angstrom^2'), symmetry=1, barrier=(22.8995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.997942,'amu*angstrom^2'), symmetry=1, barrier=(22.9446,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0919,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2284,0.0642107,-7.01253e-05,4.12293e-08,-9.9547e-12,221.76,20.5778], Tmin=(100,'K'), Tmax=(991.649,'K')), NASAPolynomial(coeffs=[10.6868,0.0260579,-1.24131e-05,2.42979e-09,-1.72968e-13,-1654.08,-24.9739], Tmin=(991.649,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.03629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + group(Cdd-CdsCds) + radical((O)CJOC)"""),
)

species(
    label = 'C#CC(C)O[C]=O(2623)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {3,S} {6,S}
2  O u0 p2 c0 {6,D}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    E0 = (20.8236,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,1855,455,950,750,770,3400,2100,472.201,477.245],'cm^-1')),
        HinderedRotor(inertia=(0.113188,'amu*angstrom^2'), symmetry=1, barrier=(18.2496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.455043,'amu*angstrom^2'), symmetry=1, barrier=(18.1923,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114316,'amu*angstrom^2'), symmetry=1, barrier=(18.2359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.44454,'amu*angstrom^2'), symmetry=1, barrier=(79.1966,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0919,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0937,0.0568514,-4.5077e-05,1.19108e-08,1.30741e-12,2615.47,24.4867], Tmin=(100,'K'), Tmax=(969.682,'K')), NASAPolynomial(coeffs=[14.7435,0.0158719,-5.39477e-06,9.28892e-10,-6.36878e-14,-752.287,-44.6608], Tmin=(969.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.8236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + group(Ct-CtCs) + group(Ct-CtH) + radical((O)CJOCC2)"""),
)
...
"""),
    ...
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3716,0.058984,-5.00259e-05,2.19955e-08,-4.01585e-12,2177.1,23.1251], Tmin=(100,'K'), Tmax=(1268.98,'K')), NASAPolynomial(coeffs=[11.3239,0.0276128,-1.29433e-05,2.51378e-09,-1.77769e-13,-348.742,-27.2598], Tmin=(1268.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.3244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdOsH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
"""),
    E0 = (144.563,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,1685,370,3120,650,792.5,1650,241.155,1510.83],'cm^-1')),
        HinderedRotor(inertia=(0.0089538,'amu*angstrom^2'), symmetry=1, barrier=(10.6608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.624184,'amu*angstrom^2'), symmetry=1, barrier=(25.7222,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.621866,'amu*angstrom^2'), symmetry=1, barrier=(25.713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.620827,'amu*angstrom^2'), symmetry=1, barrier=(25.7104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0998,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12677,0.054156,-3.82648e-05,1.29832e-08,-1.74545e-12,17497.9,28.2729], Tmin=(100,'K'), Tmax=(1747.85,'K')), NASAPolynomial(coeffs=[16.5,0.0189742,-8.07222e-06,1.46719e-09,-9.82955e-14,12123.9,-54.4783], Tmin=(1747.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(152)', 'C=[C]C(C)[O](2487)'],
    products = ['C=[C]C(C)O[C]=O(2005)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(57)', 'C[CH]O[C]=O(901)'],
    products = ['C=[C]C(C)O[C]=O(2005)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(14)', 'C=[C]C(C)[O](2487)'],
    products = ['C=[C]C(C)O[C]=O(2005)'],
    transitionState = 'TS8',
