...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71647,0.0552146,-4.30447e-05,2.04621e-08,-4.56987e-12,15378.8,19.8102], Tmin=(100,'K'), Tmax=(981.029,'K')), NASAPolynomial(coeffs=[5.72012,0.0388904,-1.8085e-05,3.50055e-09,-2.47502e-13,14593.2,0.571525], Tmin=(981.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CCJCO)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79382,0.0259982,7.19633e-05,-1.2448e-07,5.40785e-11,-10361.9,14.8353], Tmin=(100,'K'), Tmax=(906.543,'K')), NASAPolynomial(coeffs=[18.8977,0.00966457,1.14233e-06,-4.42366e-10,2.86424e-14,-15892.9,-79.4051], Tmin=(906.543,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.9896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane)"""),
)

species(
    label = 'C=C=C(C)CO(2515)',
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62099,0.0543339,-4.38924e-05,2.05857e-08,-4.21658e-12,-5387.05,21.0799], Tmin=(100,'K'), Tmax=(1115.06,'K')), NASAPolynomial(coeffs=[7.86326,0.0319412,-1.37692e-05,2.57564e-09,-1.78659e-13,-6779.14,-9.71529], Tmin=(1115.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.4884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=CC(C)C=O(1960)',
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7551,0.0474855,-2.7726e-05,7.94157e-09,-9.30244e-13,-15553.2,21.6078], Tmin=(100,'K'), Tmax=(1874.42,'K')), NASAPolynomial(coeffs=[11.6821,0.0263013,-1.07733e-05,1.91206e-09,-1.26057e-13,-19274.7,-32.5213], Tmin=(1874.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (180.217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,540,610,2055,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.157419,'amu*angstrom^2'), symmetry=1, barrier=(3.61937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157993,'amu*angstrom^2'), symmetry=1, barrier=(3.63257,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79046,0.0539424,-6.49983e-05,5.83939e-08,-2.25733e-11,21749.4,21.3279], Tmin=(100,'K'), Tmax=(783.785,'K')), NASAPolynomial(coeffs=[2.94588,0.038768,-1.82021e-05,3.48779e-09,-2.42976e-13,21853.3,17.8531], Tmin=(783.785,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCOJ)"""),
)
...
"""),
    E0 = (107.845,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,2950,3100,1380,975,1025,1650,1685,370,261.446],'cm^-1')),
        HinderedRotor(inertia=(0.162908,'amu*angstrom^2'), symmetry=1, barrier=(7.89875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162846,'amu*angstrom^2'), symmetry=1, barrier=(7.89622,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162944,'amu*angstrom^2'), symmetry=1, barrier=(7.89831,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92124,0.0495934,-4.34098e-05,2.53271e-08,-6.94479e-12,13042.2,21.4989], Tmin=(100,'K'), Tmax=(828.668,'K')), NASAPolynomial(coeffs=[5.09623,0.0342678,-1.56686e-05,3.00931e-09,-2.1182e-13,12516,6.77807], Tmin=(828.668,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(107.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = 'C#CC(C)C[O](2518)',
    structure = adjacencyList("""multiplicity 2
1  O u1 p2 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
...
"""),
    E0 = (182.554,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,2175,525,750,770,3400,2100,215.725,215.86],'cm^-1')),
        HinderedRotor(inertia=(0.174542,'amu*angstrom^2'), symmetry=1, barrier=(5.83077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0122092,'amu*angstrom^2'), symmetry=1, barrier=(73.3062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.22205,'amu*angstrom^2'), symmetry=1, barrier=(73.3074,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79326,0.0509807,-4.67764e-05,2.89164e-08,-8.07269e-12,22033.4,21.3783], Tmin=(100,'K'), Tmax=(835.69,'K')), NASAPolynomial(coeffs=[5.64673,0.0325358,-1.36682e-05,2.50387e-09,-1.71076e-13,21389.4,3.47936], Tmin=(835.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23098,0.0624086,-6.22034e-05,3.54676e-08,-8.42587e-12,25360.2,24.7488], Tmin=(100,'K'), Tmax=(1004.12,'K')), NASAPolynomial(coeffs=[9.6388,0.0289149,-1.21685e-05,2.24761e-09,-1.54856e-13,23671.8,-15.8486], Tmin=(1004.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOH) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(C)C[O](1970)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {7,S}
3  C u0 p0 c0 {1,S} {2,S} {8,S} {9,S}
...
"""),
    E0 = (264.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,313.681,1040.42],'cm^-1')),
        HinderedRotor(inertia=(0.09858,'amu*angstrom^2'), symmetry=1, barrier=(6.8898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.098608,'amu*angstrom^2'), symmetry=1, barrier=(6.88985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.098649,'amu*angstrom^2'), symmetry=1, barrier=(6.8898,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99461,0.0480248,-2.9502e-05,9.49116e-09,-1.34577e-12,31904.3,23.2306], Tmin=(100,'K'), Tmax=(1454,'K')), NASAPolynomial(coeffs=[7.15678,0.0338235,-1.48515e-05,2.77381e-09,-1.90792e-13,30403.2,-3.60615], Tmin=(1454,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = 'C=CC(C)[CH][O](1966)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
2  C u0 p0 c0 {3,S} {4,S} {5,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75412,0.0534288,-4.33984e-05,2.22139e-08,-5.28833e-12,23879.5,23.2663], Tmin=(100,'K'), Tmax=(940.289,'K')), NASAPolynomial(coeffs=[5.71515,0.036579,-1.65193e-05,3.157e-09,-2.21682e-13,23134.6,4.40047], Tmin=(940.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
"""),
    E0 = (234.823,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,294.454,3029.71],'cm^-1')),
        HinderedRotor(inertia=(0.18441,'amu*angstrom^2'), symmetry=1, barrier=(11.273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185078,'amu*angstrom^2'), symmetry=1, barrier=(11.276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00194969,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25873,'amu*angstrom^2'), symmetry=1, barrier=(76.8472,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32165,0.0577502,-5.22055e-05,2.736e-08,-5.97478e-12,28340.1,26.6501], Tmin=(100,'K'), Tmax=(1090.73,'K')), NASAPolynomial(coeffs=[9.6062,0.0273687,-1.04242e-05,1.82291e-09,-1.21579e-13,26532.8,-14.0376], Tmin=(1090.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]C(C)CO(2521)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (276.837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,272.923],'cm^-1')),
        HinderedRotor(inertia=(0.00239853,'amu*angstrom^2'), symmetry=1, barrier=(16.0857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.699742,'amu*angstrom^2'), symmetry=1, barrier=(16.0884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.699199,'amu*angstrom^2'), symmetry=1, barrier=(16.076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.393644,'amu*angstrom^2'), symmetry=1, barrier=(9.05065,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3596,0.0580455,-5.09034e-05,2.50647e-08,-5.17144e-12,33390.8,25.1364], Tmin=(100,'K'), Tmax=(1140.27,'K')), NASAPolynomial(coeffs=[9.85188,0.0282548,-1.17141e-05,2.15217e-09,-1.47914e-13,31454.1,-16.9487], Tmin=(1140.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(276.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', 'C=[C]CC[O](1419)'],
    products = ['C=[C]C(C)C[O](1967)'],
    transitionState = 'TS2',
