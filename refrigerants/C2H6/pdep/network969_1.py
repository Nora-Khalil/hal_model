...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.284283,'amu*angstrom^2'), symmetry=1, barrier=(6.53623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.28428,'amu*angstrom^2'), symmetry=1, barrier=(6.53615,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24639,0.044654,-6.59424e-05,6.39286e-08,-2.45476e-11,64317.9,20.8118], Tmin=(100,'K'), Tmax=(828.713,'K')), NASAPolynomial(coeffs=[2.63046,0.0293984,-1.40712e-05,2.68572e-09,-1.8529e-13,64714.5,21.8076], Tmin=(828.713,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(534.294,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_S) + radical(Cds_P)"""),
)
...
"""),
    E0 = (410.322,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,459.139,459.148,459.155,459.163,459.191],'cm^-1')),
        HinderedRotor(inertia=(0.000799551,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.349523,'amu*angstrom^2'), symmetry=1, barrier=(52.2926,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.98661,0.0319883,-1.23592e-05,1.27158e-09,7.6959e-14,49377.5,17.2569], Tmin=(100,'K'), Tmax=(2297.33,'K')), NASAPolynomial(coeffs=[16.7795,0.0157339,-6.81367e-06,1.13284e-09,-6.79717e-14,40992.1,-65.2156], Tmin=(2297.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.322,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(AllylJ2_triplet)"""),
)
...
"""),
    E0 = (845.3,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,180,180,2314.7],'cm^-1')),
        HinderedRotor(inertia=(0.168143,'amu*angstrom^2'), symmetry=1, barrier=(3.86595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168529,'amu*angstrom^2'), symmetry=1, barrier=(3.87482,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26354,0.0477534,-8.73737e-05,9.11741e-08,-3.53311e-11,101719,20.7243], Tmin=(100,'K'), Tmax=(854.488,'K')), NASAPolynomial(coeffs=[1.16949,0.0296736,-1.49076e-05,2.86046e-09,-1.96133e-13,102753,30.7867], Tmin=(854.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(845.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51056,0.0244664,1.05065e-05,-2.60454e-08,9.69706e-12,18577.3,17.4244], Tmin=(100,'K'), Tmax=(1119.61,'K')), NASAPolynomial(coeffs=[9.62679,0.0192069,-9.46246e-06,1.93135e-09,-1.41854e-13,15720,-23.3554], Tmin=(1119.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (373.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,540,610,2055,3120,650,792.5,1650,180],'cm^-1')),
    ...
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52908,0.0362943,-4.67921e-05,4.20125e-08,-1.53467e-11,45000.7,18.5473], Tmin=(100,'K'), Tmax=(852.448,'K')), NASAPolynomial(coeffs=[3.2339,0.0243897,-1.07161e-05,1.96772e-09,-1.32886e-13,45192.9,17.0916], Tmin=(852.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCOJ) + radical(C=C=CJ)"""),
)
...
"""),
    E0 = (395.757,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2175,525,750,770,3400,2100,180,3093.41],'cm^-1')),
        HinderedRotor(inertia=(3.19802,'amu*angstrom^2'), symmetry=1, barrier=(73.5287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.19537,'amu*angstrom^2'), symmetry=1, barrier=(73.4678,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0814,0.0484579,-7.81581e-05,7.12377e-08,-2.46775e-11,47661.7,17.9211], Tmin=(100,'K'), Tmax=(898.245,'K')), NASAPolynomial(coeffs=[4.47293,0.0226684,-9.80926e-06,1.74583e-09,-1.14027e-13,47842.9,10.0398], Tmin=(898.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH][C]=CC[O](3257)',
    structure = adjacencyList("""multiplicity 5
1 O u1 p2 c0 {2,S}
2 C u0 p0 c0 {1,S} {3,S} {6,S} {7,S}
3 C u0 p0 c0 {2,S} {4,D} {8,S}
...
"""),
    E0 = (651.194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1685,370,314.365,316.798,319.066,319.284,322.56],'cm^-1')),
        HinderedRotor(inertia=(0.00160716,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00152708,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49504,0.0396153,-5.25485e-05,5.49325e-08,-2.2789e-11,78368.3,20.5699], Tmin=(100,'K'), Tmax=(829.837,'K')), NASAPolynomial(coeffs=[-0.0727768,0.0360034,-1.71177e-05,3.24935e-09,-2.23648e-13,79345.1,35.7963], Tmin=(829.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(651.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=[C]C[CH][O](376)',
    structure = adjacencyList("""multiplicity 5
1 O u1 p2 c0 {3,S}
2 C u0 p0 c0 {3,S} {4,S} {6,S} {7,S}
3 C u1 p0 c0 {1,S} {2,S} {8,S}
...
"""),
    E0 = (714.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,180,1708.17],'cm^-1')),
        HinderedRotor(inertia=(0.311404,'amu*angstrom^2'), symmetry=1, barrier=(7.1598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310603,'amu*angstrom^2'), symmetry=1, barrier=(7.14136,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98958,0.053231,-9.64649e-05,9.50654e-08,-3.50692e-11,86009.3,21.2833], Tmin=(100,'K'), Tmax=(866.183,'K')), NASAPolynomial(coeffs=[3.24091,0.0262141,-1.28995e-05,2.44098e-09,-1.65535e-13,86589.2,20.0252], Tmin=(866.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(714.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
"""),
    E0 = (413.352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,552.517,552.521,552.524,552.529,552.538],'cm^-1')),
        HinderedRotor(inertia=(0.247454,'amu*angstrom^2'), symmetry=1, barrier=(53.6067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247456,'amu*angstrom^2'), symmetry=1, barrier=(53.6066,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97886,0.0296349,-8.31581e-06,-1.09011e-09,5.28773e-13,49745,18.3611], Tmin=(100,'K'), Tmax=(2009.07,'K')), NASAPolynomial(coeffs=[11.8128,0.0215574,-9.38594e-06,1.62126e-09,-1.01823e-13,44275.9,-35.1979], Tmin=(2009.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=[C]C[CH]O(382)',
    structure = adjacencyList("""multiplicity 4
...
"""),
    E0 = (488.887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,302.836],'cm^-1')),
        HinderedRotor(inertia=(0.134658,'amu*angstrom^2'), symmetry=1, barrier=(8.76329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134657,'amu*angstrom^2'), symmetry=1, barrier=(8.76332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134655,'amu*angstrom^2'), symmetry=1, barrier=(8.76331,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64933,0.0556988,-8.30915e-05,6.84023e-08,-2.21967e-11,58880.3,21.6453], Tmin=(100,'K'), Tmax=(859.548,'K')), NASAPolynomial(coeffs=[7.90052,0.0198527,-8.74751e-06,1.59748e-09,-1.07059e-13,58055.2,-6.11532], Tmin=(859.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(488.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC[CH][O](290)',
    structure = adjacencyList("""multiplicity 4
1  O u1 p2 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {6,S} {7,S}
3  C u0 p0 c0 {2,S} {5,D} {8,S}
...
"""),
    E0 = (476.75,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3120,650,792.5,1650,180,1380.62],'cm^-1')),
        HinderedRotor(inertia=(0.307391,'amu*angstrom^2'), symmetry=1, barrier=(7.06752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.307367,'amu*angstrom^2'), symmetry=1, barrier=(7.06698,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04476,0.0483641,-7.07353e-05,6.4615e-08,-2.36479e-11,57405,20.6121], Tmin=(100,'K'), Tmax=(826.206,'K')), NASAPolynomial(coeffs=[4.29475,0.0269514,-1.27617e-05,2.42552e-09,-1.67021e-13,57392.2,12.3595], Tmin=(826.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(476.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (425.489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1685,370,469.077,469.077,469.077,469.078],'cm^-1')),
        HinderedRotor(inertia=(0.345161,'amu*angstrom^2'), symmetry=1, barrier=(53.8936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.345161,'amu*angstrom^2'), symmetry=1, barrier=(53.8936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.345161,'amu*angstrom^2'), symmetry=1, barrier=(53.8936,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55501,0.0361551,-1.08477e-05,-2.49813e-08,2.44803e-11,51222.3,19.5625], Tmin=(100,'K'), Tmax=(524.426,'K')), NASAPolynomial(coeffs=[4.1829,0.0303987,-1.34328e-05,2.52174e-09,-1.75143e-13,50959.9,11.8864], Tmin=(524.426,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C=[C][CH]C[O](2139)',
    structure = adjacencyList("""multiplicity 4
1  O u1 p2 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {6,S} {7,S}
...
"""),
    E0 = (404.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,291.324,291.409,291.429],'cm^-1')),
        HinderedRotor(inertia=(0.717812,'amu*angstrom^2'), symmetry=1, barrier=(43.235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0141163,'amu*angstrom^2'), symmetry=1, barrier=(43.2372,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3490.98,'J/mol'), sigma=(5.93364,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=545.28 K, Pc=37.92 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16406,0.0443286,-5.43243e-05,4.6943e-08,-1.76796e-11,48666.1,17.9054], Tmin=(100,'K'), Tmax=(753.149,'K')), NASAPolynomial(coeffs=[4.18701,0.0287983,-1.38612e-05,2.68825e-09,-1.88816e-13,48497.1,9.62053], Tmin=(753.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(404.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CCJCO) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C[CH][O](378)',
    structure = adjacencyList("""multiplicity 4
1  O u1 p2 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.205435,'amu*angstrom^2'), symmetry=1, barrier=(4.72337,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07827,0.0495386,-7.92656e-05,7.71091e-08,-2.89949e-11,56288.9,20.5616], Tmin=(100,'K'), Tmax=(845.866,'K')), NASAPolynomial(coeffs=[2.88163,0.029252,-1.4053e-05,2.66817e-09,-1.82772e-13,56742.8,20.3069], Tmin=(845.866,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(467.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOH) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=[C]CC[O](379)'],
    products = ['CH2O(19)', '[CH]=C=C(2030)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](471)', '[CH2]C[O](119)'],
    products = ['[CH]=[C]CC[O](379)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', '[CH][C]=CC[O](3257)'],
    products = ['[CH]=[C]CC[O](379)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(2.21037e+06,'m^3/(mol*s)'), n=0.349925, Ea=(3.65058,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C"""),
)

reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH]=[C]C[CH][O](376)'],
    products = ['[CH]=[C]CC[O](379)'],
