...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[O]C([O])=C=O(932)'],
    products = ['[CH2]C(=O)C([O])=O(886)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C]=O(803)', '[CH2][C]=O(167)'],
    products = ['[CH2]C(=O)C([O])=O(886)'],
