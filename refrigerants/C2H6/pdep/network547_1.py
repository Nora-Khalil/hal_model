...
"""),
    E0 = (74.6188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,350,440,435,1725,402.923,402.926],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18883,0.0335239,-1.94151e-05,-2.53459e-09,4.26036e-12,9045.37,16.414], Tmin=(100,'K'), Tmax=(992.311,'K')), NASAPolynomial(coeffs=[11.6135,0.00923936,-3.42475e-06,6.42069e-10,-4.67976e-14,6500.12,-32.3821], Tmin=(992.311,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.6188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ) + radical(Allyl_P)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23479,0.0289404,-7.48834e-06,-2.38407e-08,1.47727e-11,-12938.9,15.4322], Tmin=(100,'K'), Tmax=(918.145,'K')), NASAPolynomial(coeffs=[15.6525,-0.00349633,2.99673e-06,-5.89022e-10,3.73251e-14,-16499.4,-54.1267], Tmin=(918.145,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=COJ) + radical(C=COJ)"""),
)

species(
    label = '[CH2]C([O])[C]=O(1479)',
    structure = adjacencyList("""multiplicity 4
1 O u1 p2 c0 {3,S}
2 O u0 p2 c0 {5,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0543725,'amu*angstrom^2'), symmetry=1, barrier=(13.8166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.055683,'amu*angstrom^2'), symmetry=1, barrier=(13.8353,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32664,0.0326764,-2.63446e-05,6.89746e-09,8.77116e-13,29179.2,22.4436], Tmin=(100,'K'), Tmax=(963.065,'K')), NASAPolynomial(coeffs=[10.424,0.00826419,-2.68165e-06,4.57449e-10,-3.1525e-14,27192,-18.5367], Tmin=(963.065,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CJCO) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.78613,0.0302735,-2.00599e-05,6.27756e-09,-8.16836e-13,33567.3,21.8088], Tmin=(100,'K'), Tmax=(1632.19,'K')), NASAPolynomial(coeffs=[7.72339,0.0181738,-8.9402e-06,1.73575e-09,-1.21175e-13,31955.6,-4.42953], Tmin=(1632.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[O]C(=O)C1CO1(1929)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.76075,0.0187761,2.8422e-05,-5.16996e-08,2.24712e-11,-26843,17.1718], Tmin=(100,'K'), Tmax=(893.77,'K')), NASAPolynomial(coeffs=[8.56867,0.0153475,-3.69307e-06,5.0197e-10,-3.13224e-14,-28782.4,-15.2376], Tmin=(893.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + ring(Ethylene_oxide) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C1OOC1=O(1701)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.76703,-0.00223839,0.000125494,-1.7122e-07,6.73622e-11,-10343.8,20.6258], Tmin=(100,'K'), Tmax=(945.694,'K')), NASAPolynomial(coeffs=[19.7727,0.000792217,1.79116e-06,-1.9963e-10,-5.13435e-15,-16912.2,-78.1896], Tmin=(945.694,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.5961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Cyclobutane) + radical(CJCOOH)"""),
)
...
"""),
    E0 = (416.935,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,360,370,350,3000,3100,440,815,1455,1000,180,180,1678.26,1678.43],'cm^-1')),
        HinderedRotor(inertia=(0.00281398,'amu*angstrom^2'), symmetry=1, barrier=(5.67015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247873,'amu*angstrom^2'), symmetry=1, barrier=(5.69908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55755,0.0686296,-0.000142931,1.48288e-07,-5.59737e-11,50219.4,25.2387], Tmin=(100,'K'), Tmax=(866.325,'K')), NASAPolynomial(coeffs=[1.60216,0.0322297,-1.72383e-05,3.33819e-09,-2.27991e-13,51569.9,32.8688], Tmin=(866.325,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(416.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])[C]1OO1(1933)',
    structure = adjacencyList("""multiplicity 4
...
"""),
    ...
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68991,0.0406842,-1.48894e-05,-2.30613e-08,1.59963e-11,46801,22.5521], Tmin=(100,'K'), Tmax=(898.651,'K')), NASAPolynomial(coeffs=[16.4791,0.00290178,1.36201e-06,-3.88576e-10,2.74201e-14,43010.4,-53.5179], Tmin=(898.651,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(388.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CC(C)OJ) + radical(Cs_P) + radical(CJCO)"""),
)

species(
    label = '[CH2]C1OO[C]1[O](1934)',
    structure = adjacencyList("""multiplicity 4
1 O u0 p2 c0 {2,S} {4,S}
2 O u0 p2 c0 {1,S} {5,S}
3 O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2211,0.0437967,-6.11648e-05,5.70188e-08,-2.22679e-11,47272.2,20.0653], Tmin=(100,'K'), Tmax=(758.161,'K')), NASAPolynomial(coeffs=[3.9964,0.0271522,-1.38347e-05,2.73875e-09,-1.94087e-13,47212.2,13.3715], Tmin=(758.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(392.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CCOJ) + radical(Cs_P) + radical(CJCOOH)"""),
)

species(
    label = '[O][C]1OCC1[O](1935)',
    structure = adjacencyList("""multiplicity 4
1 O u0 p2 c0 {5,S} {6,S}
2 O u1 p2 c0 {4,S}
3 O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01708,0.0349578,-2.64079e-05,1.16501e-08,-2.04362e-12,23206.1,21.4667], Tmin=(100,'K'), Tmax=(1609.09,'K')), NASAPolynomial(coeffs=[8.01121,0.0153642,-3.76796e-06,4.57524e-10,-2.30642e-14,21884.7,-8.41486], Tmin=(1609.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C1OC1([O])[O](1913)',
    structure = adjacencyList("""multiplicity 4
1 O u0 p2 c0 {4,S} {5,S}
2 O u1 p2 c0 {5,S}
3 O u1 p2 c0 {5,S}
...
"""),
    E0 = (-136.18,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,292.07,292.565],'cm^-1')),
        HinderedRotor(inertia=(0.242148,'amu*angstrom^2'), symmetry=1, barrier=(14.6609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241748,'amu*angstrom^2'), symmetry=1, barrier=(14.6488,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.740636,0.0627412,-8.09298e-05,4.78632e-08,-1.03889e-11,-16253.6,22.1604], Tmin=(100,'K'), Tmax=(1301.85,'K')), NASAPolynomial(coeffs=[17.7391,0.000545249,2.21714e-06,-5.96754e-10,4.64827e-14,-19834.8,-61.0874], Tmin=(1301.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=C(C)OJ) + radical(C=COJ) + radical(C=C(O)CJ)"""),
)
...
"""),
    E0 = (5.28246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,318.517,318.814,319.183],'cm^-1')),
    ...
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53264,0.051136,-6.05879e-05,3.09905e-08,-4.75656e-12,727.167,20.738], Tmin=(100,'K'), Tmax=(885.897,'K')), NASAPolynomial(coeffs=[14.2619,0.00472292,-7.31572e-07,4.18011e-11,-4.82595e-16,-1962.28,-41.581], Tmin=(885.897,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.28246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=C(C)OJ) + radical(C=COJ) + radical(C=COJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C(O)=C([O])[O](1938)',
    structure = adjacencyList("""multiplicity 4
1 O u0 p2 c0 {4,S} {9,S}
2 O u1 p2 c0 {6,S}
3 O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.698211,0.0606852,-7.28434e-05,3.99792e-08,-8.06462e-12,-15809.6,22.2276], Tmin=(100,'K'), Tmax=(1398.52,'K')), NASAPolynomial(coeffs=[18.3984,0.000558181,1.83765e-06,-4.78868e-10,3.60953e-14,-19831.2,-65.7804], Tmin=(1398.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ) + radical(C=C(O)CJ)"""),
)

species(
    label = 'CC([O])=C([O])[O](1939)',
    structure = adjacencyList("""multiplicity 4
1 O u1 p2 c0 {5,S}
2 O u1 p2 c0 {6,S}
3 O u1 p2 c0 {6,S}
...
reaction(
    label = 'reaction3',
    reactants = ['O(7)', '[CH2]C=C([O])[O](1776)'],
    products = ['[CH2]C([O])C([O])=O(1697)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', '[O]C=C([O])[O](1795)'],
    products = ['[CH2]C([O])C([O])=O(1697)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(7)', '[CH2]C([O])[C]=O(1479)'],
    products = ['[CH2]C([O])C([O])=O(1697)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(6)', '[CH]C([O])C([O])=O(1928)'],
    products = ['[CH2]C([O])C([O])=O(1697)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C([O])C([O])=O(1697)'],
    products = ['[CH2]C1OO[C]1[O](1934)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(3.006e+11,'s^-1'), n=0.221, Ea=(351.355,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_CO;carbonyl_intra;radadd_intra_O]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.34239e+09,'s^-1'), n=0.889391, Ea=(137.17,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs2H]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C([O])=C([O])O(1936)'],
    products = ['[CH2]C([O])C([O])=O(1697)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(205000,'s^-1'), n=2.37, Ea=(319.067,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R"""),
)

reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(17)', '[O]C(=O)C=O(1695)'],
    products = ['[CH2]C([O])C([O])=O(1697)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(8.04,'m^3/(mol*s)'), n=1.68, Ea=(20.3533,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_3R->C_Ext-1R!H-R_N-Sp-2R!H-=1R!H_Sp-2R!H=1R!H_N-2R!H->S_4R!H-u0_N-4R!H-inRing_N-2CO->C',), comment="""Estimated from node Root_N-3R-inRing_3R->C_Ext-1R!H-R_N-Sp-2R!H-=1R!H_Sp-2R!H=1R!H_N-2R!H->S_4R!H-u0_N-4R!H-inRing_N-2CO->C"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(520000,'m^3/(mol*s)'), n=-1.07934e-11, Ea=(101.035,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C"""),
)

reaction(
    label = 'reaction22',
    reactants = ['H(6)', '[CH2]C(=O)C([O])=O(1741)'],
    products = ['[CH2]C([O])C([O])=O(1697)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(6)', '[CH2]C([O])=C([O])[O](1937)'],
    products = ['[CH2]C([O])C([O])=O(1697)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(2.21037e+06,'m^3/(mol*s)'), n=0.349925, Ea=(23.5765,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_2BrCClFHNO->O_Ext-2O-R_N-3R!H->Cl_3BrCFINOPSSi->C"""),
)

reaction(
    label = 'reaction27',
    reactants = ['[CH2]C([O])C([O])=O(1697)'],
    products = ['[CH2]C(O)=C([O])[O](1938)'],
