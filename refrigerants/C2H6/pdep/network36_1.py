...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[CH2]C=C(219)'],
    products = ['[CH2]CC=C(59)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]CC=C(59)'],
    products = ['[CH]1CCC1(2026)'],
    transitionState = 'TS5',
