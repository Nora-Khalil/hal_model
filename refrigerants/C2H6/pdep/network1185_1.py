...
"""),
    E0 = (265.143,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180],'cm^-1')),
        HinderedRotor(inertia=(0.142292,'amu*angstrom^2'), symmetry=1, barrier=(3.27157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.96655,'amu*angstrom^2'), symmetry=1, barrier=(22.2229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142254,'amu*angstrom^2'), symmetry=1, barrier=(3.2707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0122434,'amu*angstrom^2'), symmetry=1, barrier=(22.2269,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1095,0.0550344,-2.49461e-05,-1.6487e-09,3.23199e-12,32000.5,25.0881], Tmin=(100,'K'), Tmax=(1122.92,'K')), NASAPolynomial(coeffs=[11.6972,0.031548,-1.25794e-05,2.29335e-09,-1.57861e-13,28725.7,-31.2132], Tmin=(1122.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(265.143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Allyl_P)"""),
)
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01283,0.0309784,3.76003e-05,-6.02018e-08,2.21398e-11,9702.91,19.2071], Tmin=(100,'K'), Tmax=(1032.43,'K')), NASAPolynomial(coeffs=[8.86587,0.0356456,-1.45369e-05,2.75207e-09,-1.96204e-13,6624.05,-22.1313], Tmin=(1032.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.9884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(methylenecyclobutane)"""),
)

species(
    label = 'C=CC(C)=CC(2469)',
    structure = adjacencyList("""1  C u0 p0 c0 {3,S} {7,S} {11,S} {12,S}
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65018,0.036128,3.44405e-05,-6.59543e-08,2.62478e-11,42093.8,24.0719], Tmin=(100,'K'), Tmax=(1000.91,'K')), NASAPolynomial(coeffs=[12.8299,0.029099,-1.14482e-05,2.1912e-09,-1.59734e-13,37970,-39.2947], Tmin=(1000.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(349.171,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_S) + radical(Neopentyl)"""),
)
...
"""),
    E0 = (351.486,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3000,3100,440,815,1455,1000,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.0327125,'amu*angstrom^2'), symmetry=1, barrier=(0.752125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254848,'amu*angstrom^2'), symmetry=1, barrier=(5.85946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256523,'amu*angstrom^2'), symmetry=1, barrier=(5.89796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255728,'amu*angstrom^2'), symmetry=1, barrier=(5.87969,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64191,0.0556137,-3.61428e-05,1.30611e-08,-2.13528e-12,42355.4,23.3607], Tmin=(100,'K'), Tmax=(1288.73,'K')), NASAPolynomial(coeffs=[6.92395,0.0392192,-1.7061e-05,3.19003e-09,-2.20412e-13,40994,-3.462], Tmin=(1288.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(351.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(=[C]C)CC(2476)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (297.739,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3000,3100,440,815,1455,1000,1685,370,376.925],'cm^-1')),
        HinderedRotor(inertia=(0.0752368,'amu*angstrom^2'), symmetry=1, barrier=(7.58513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0752316,'amu*angstrom^2'), symmetry=1, barrier=(7.58486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0752377,'amu*angstrom^2'), symmetry=1, barrier=(7.5848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244842,'amu*angstrom^2'), symmetry=1, barrier=(24.6844,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05977,0.0585588,-3.7571e-05,1.23592e-08,-1.67315e-12,35920.4,23.9597], Tmin=(100,'K'), Tmax=(1677.15,'K')), NASAPolynomial(coeffs=[13.2355,0.0295197,-1.15992e-05,2.03546e-09,-1.34262e-13,31836.2,-41.0773], Tmin=(1677.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C[C](C)C=C(1896)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {3,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (265.173,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.202166,'amu*angstrom^2'), symmetry=1, barrier=(4.64821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0181065,'amu*angstrom^2'), symmetry=1, barrier=(20.5124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00335573,'amu*angstrom^2'), symmetry=1, barrier=(20.5106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0726221,'amu*angstrom^2'), symmetry=1, barrier=(82.2416,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
"""),
    E0 = (371.034,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,180,924.029],'cm^-1')),
        HinderedRotor(inertia=(0.0216561,'amu*angstrom^2'), symmetry=1, barrier=(13.0229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145595,'amu*angstrom^2'), symmetry=1, barrier=(3.34751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145996,'amu*angstrom^2'), symmetry=1, barrier=(3.35674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.568956,'amu*angstrom^2'), symmetry=1, barrier=(13.0814,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14099,0.0550014,-2.90651e-05,4.40985e-09,8.41953e-13,44734.5,26.8529], Tmin=(100,'K'), Tmax=(1211.95,'K')), NASAPolynomial(coeffs=[11.4531,0.0312434,-1.23797e-05,2.22819e-09,-1.51275e-13,41480.2,-27.993], Tmin=(1211.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C1CCC1C(1527)',
    structure = adjacencyList("""1  C u0 p0 c0 {2,S} {4,S} {5,S} {7,S}
2  C u0 p0 c0 {1,S} {3,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {5,S} {10,S} {11,S}
4  C u0 p0 c0 {1,S} {12,S} {13,S} {14,S}
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01263,0.02758,5.4982e-05,-8.35899e-08,3.17391e-11,10220.2,18.7056], Tmin=(100,'K'), Tmax=(991.901,'K')), NASAPolynomial(coeffs=[10.824,0.032069,-1.23298e-05,2.32939e-09,-1.68724e-13,6503.37,-33.6569], Tmin=(991.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.2619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)

species(
    label = 'C=CC(=C)CC(1889)',
    structure = adjacencyList("""1  C u0 p0 c0 {2,S} {3,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {9,S} {10,S} {11,S}
3  C u0 p0 c0 {1,S} {4,S} {5,D}
4  C u0 p0 c0 {3,S} {6,D} {12,S}
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17118,0.0490262,3.59846e-06,-4.01031e-08,1.90751e-11,4165.04,21.6614], Tmin=(100,'K'), Tmax=(974.021,'K')), NASAPolynomial(coeffs=[14.4058,0.025999,-9.17757e-06,1.6579e-09,-1.17843e-13,101.037,-49.467], Tmin=(974.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.6851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C[CH][C]1CCC1(2477)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {5,S} {9,S} {10,S}
3  C u0 p0 c0 {1,S} {5,S} {11,S} {12,S}
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13247,0.0323816,2.22237e-05,-3.73836e-08,1.26431e-11,40634.4,23.7851], Tmin=(100,'K'), Tmax=(1127.67,'K')), NASAPolynomial(coeffs=[6.40424,0.0394635,-1.67723e-05,3.15536e-09,-2.20624e-13,38257.3,-3.60526], Tmin=(1127.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC(=C)C=C(1895)',
    structure = adjacencyList("""multiplicity 2
1  C u0 p0 c0 {2,S} {4,S} {7,S} {8,S}
...
"""),
    E0 = (238.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,414.778,415.179],'cm^-1')),
        HinderedRotor(inertia=(0.126803,'amu*angstrom^2'), symmetry=1, barrier=(15.493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126691,'amu*angstrom^2'), symmetry=1, barrier=(15.4804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12735,'amu*angstrom^2'), symmetry=1, barrier=(15.479,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
...
"""),
    E0 = (332.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,180,1034.69],'cm^-1')),
        HinderedRotor(inertia=(0.128355,'amu*angstrom^2'), symmetry=1, barrier=(2.95112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128275,'amu*angstrom^2'), symmetry=1, barrier=(2.9493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128029,'amu*angstrom^2'), symmetry=1, barrier=(2.94365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0231326,'amu*angstrom^2'), symmetry=1, barrier=(17.5574,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14192,0.0545826,-2.58649e-05,-1.62786e-11,2.56707e-12,40072.7,26.8915], Tmin=(100,'K'), Tmax=(1139.95,'K')), NASAPolynomial(coeffs=[11.5603,0.0311973,-1.24258e-05,2.2605e-09,-1.55208e-13,36841.6,-28.4894], Tmin=(1139.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJ)"""),
)

species(
    label = '[CH]=C(C[CH2])CC(2479)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (374.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,703.59],'cm^-1')),
        HinderedRotor(inertia=(0.251258,'amu*angstrom^2'), symmetry=1, barrier=(5.77691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04693,'amu*angstrom^2'), symmetry=1, barrier=(24.0709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00212075,'amu*angstrom^2'), symmetry=1, barrier=(24.0792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.468604,'amu*angstrom^2'), symmetry=1, barrier=(10.7741,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00473,0.0576637,-3.30104e-05,6.21261e-09,6.70234e-13,45110.9,26.6948], Tmin=(100,'K'), Tmax=(1174.78,'K')), NASAPolynomial(coeffs=[12.2539,0.0302617,-1.19404e-05,2.154e-09,-1.4687e-13,41715.7,-32.5894], Tmin=(1174.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=CC)CC(2480)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {4,S} {7,S} {8,S}
2  C u0 p0 c0 {1,S} {9,S} {10,S} {11,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])=CC(2400)'],
    products = ['C2H4(29)', 'C=C=CC(1692)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(24)', '[CH2]CC([CH2])=C(1187)'],
    products = ['[CH2]CC([CH2])=CC(2400)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', '[CH2]C([CH2])=CC(1459)'],
    products = ['[CH2]CC([CH2])=CC(2400)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(17)', '[CH2]C[C]=CC(1194)'],
    products = ['[CH2]CC([CH2])=CC(2400)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['C2H4(29)', '[CH2][C]=CC(1693)'],
    products = ['[CH2]CC([CH2])=CC(2400)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(8.08706e-06,'m^3/(mol*s)'), n=3.0961, Ea=(4.68809,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H(6)', '[CH2]C(C=C)=CC(2472)'],
    products = ['[CH2]CC([CH2])=CC(2400)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C(38)', '[CH2]C[C]=C(72)'],
    products = ['[CH2]CC([CH2])=CC(2400)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(6)', '[CH2]CC(=C)C=C(1895)'],
    products = ['[CH2]CC([CH2])=CC(2400)'],
