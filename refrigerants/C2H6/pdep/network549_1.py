...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(857)', '[C]=C(57)'],
    products = ['C=[C]OC([O])=O(888)'],
    transitionState = 'TS2',
