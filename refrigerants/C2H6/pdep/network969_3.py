...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.268317,'amu*angstrom^2'), symmetry=1, barrier=(6.16914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268258,'amu*angstrom^2'), symmetry=1, barrier=(6.16779,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.57912,0.0292324,-1.57098e-05,4.06839e-09,-4.19045e-13,65199.7,14.9851], Tmin=(100,'K'), Tmax=(2183.64,'K')), NASAPolynomial(coeffs=[10.778,0.0142137,-5.39307e-06,9.18679e-10,-5.84418e-14,61619,-30.9728], Tmin=(2183.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(541.662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CdCdJ2_triplet)"""),
)
...
"""),
    E0 = (431.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,180,799.448,800.528,3347.49],'cm^-1')),
        HinderedRotor(inertia=(0.116622,'amu*angstrom^2'), symmetry=1, barrier=(2.68137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.928162,'amu*angstrom^2'), symmetry=1, barrier=(21.3403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5247,0.0265379,-1.04213e-06,-1.46006e-08,6.71775e-12,51988.8,15.7953], Tmin=(100,'K'), Tmax=(1031.33,'K')), NASAPolynomial(coeffs=[8.27582,0.0172707,-6.52749e-06,1.20378e-09,-8.48715e-14,50109.1,-15.4897], Tmin=(1031.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(431.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CH2(S)(24)', '[CH]=CC(63)'],
    products = ['[CH]=CCC(64)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(150.773,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction24',
    reactants = ['H(6)', '[C]=CCC(1685)'],
    products = ['[CH]=CCC(64)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[CH2]C=C(214)'],
    products = ['[CH2]CC=C(54)'],
...
This reaction matched rate rule [Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_2R!H->C]
family: R_Addition_MultipleBond"""),
)
...
This reaction matched rate rule [Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_N-4R!H->N_Ext-4CClOS-R_N-Sp-5R!H-4CClOS_Sp-4CClOS-1CCClOOSS_Sp-2CS=1CCOSS_Sp-5R!H=4CClOS]
family: R_Addition_MultipleBond"""),
)

reaction(
    label = 'reaction7',
    reactants = ['C2H3(28)', '[CH2][CH2](39)'],
    products = ['[CH2]CC=C(54)'],
