...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', 'O=[C]O[C]=O(921)'],
    products = ['[CH2]C(=O)O[C]=O(887)'],
    transitionState = 'TS3',
