...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01003,0.0514089,-4.96557e-06,-3.88952e-08,2.10972e-11,14609.6,22.9138], Tmin=(100,'K'), Tmax=(943.147,'K')), NASAPolynomial(coeffs=[17.9977,0.0151168,-4.11069e-06,6.9561e-10,-5.15894e-14,9814.98,-66.478], Tmin=(943.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(C=COCJ)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11028,0.054829,-3.10989e-05,6.83848e-11,4.18899e-12,-5802.4,20.0901], Tmin=(100,'K'), Tmax=(1026.52,'K')), NASAPolynomial(coeffs=[13.8257,0.0223165,-8.48253e-06,1.54671e-09,-1.08233e-13,-9310.44,-45.9587], Tmin=(1026.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (142.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,540,610,2055,394.855,394.859],'cm^-1')),
        HinderedRotor(inertia=(0.128601,'amu*angstrom^2'), symmetry=1, barrier=(14.2265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128567,'amu*angstrom^2'), symmetry=1, barrier=(14.2269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128608,'amu*angstrom^2'), symmetry=1, barrier=(14.2267,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23054,0.052687,-3.26289e-05,2.60599e-09,3.29377e-12,17286,22.1438], Tmin=(100,'K'), Tmax=(1024.95,'K')), NASAPolynomial(coeffs=[13.7934,0.0195648,-7.43389e-06,1.35968e-09,-9.54959e-14,13875.3,-42.8503], Tmin=(1024.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=COCJ)"""),
)

species(
    label = 'C#CC(C)O[CH2](2490)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {2,S} {4,S}
...
"""),
    E0 = (180.952,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,364.418,364.464],'cm^-1')),
        HinderedRotor(inertia=(0.13909,'amu*angstrom^2'), symmetry=1, barrier=(13.104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26981,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26969,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139099,'amu*angstrom^2'), symmetry=1, barrier=(13.1043,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02084,0.0594086,-4.95881e-05,1.75498e-08,-9.7662e-13,21876.2,22.4086], Tmin=(100,'K'), Tmax=(977.664,'K')), NASAPolynomial(coeffs=[13.9046,0.0190318,-6.56555e-06,1.11869e-09,-7.5182e-14,18767.5,-42.4723], Tmin=(977.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CsJOCC2)"""),
)
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02251,0.0574644,-3.8859e-05,8.22389e-09,1.30091e-12,19786.4,22.106], Tmin=(100,'K'), Tmax=(1048.82,'K')), NASAPolynomial(coeffs=[13.8355,0.0224392,-8.56206e-06,1.54892e-09,-1.07316e-13,16337.4,-43.9494], Tmin=(1048.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
"""),
    E0 = (316.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1685,370,3120,650,792.5,1650,348.639,349.086],'cm^-1')),
        HinderedRotor(inertia=(0.00138469,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113528,'amu*angstrom^2'), symmetry=1, barrier=(9.79391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113447,'amu*angstrom^2'), symmetry=1, barrier=(9.78747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113154,'amu*angstrom^2'), symmetry=1, barrier=(9.79822,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64435,0.0533677,-3.95608e-05,1.5784e-08,-2.6989e-12,38132,24.0117], Tmin=(100,'K'), Tmax=(1311.81,'K')), NASAPolynomial(coeffs=[9.11098,0.0306003,-1.35274e-05,2.55377e-09,-1.77532e-13,36173,-14.037], Tmin=(1311.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(17)', 'C=[C]C(C)[O](2487)'],
    products = ['[CH2]OC(C)[C]=C(1938)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(57)', '[CH2]O[CH]C(119)'],
    products = ['[CH2]OC(C)[C]=C(1938)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['[CH2]OC(C)[C]=C(1938)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(67.8608,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)
