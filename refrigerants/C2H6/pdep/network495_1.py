...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([O])=O(847)'],
    products = ['CO2(15)', 'C2H4(29)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(17)', '[CH2]C([O])=O(586)'],
    products = ['[CH2]CC([O])=O(847)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(803)', '[CH2][CH2](39)'],
    products = ['[CH2]CC([O])=O(847)'],
