...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(152)', '[CH]=C[O](94)'],
    products = ['[CH]=CO[C]=O(852)'],
    transitionState = 'TS2',
