...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(179)', '[O]C([O])=O(1696)'],
    products = ['[O]C(=O)O[C]=O(1765)'],
    transitionState = 'TS2',
