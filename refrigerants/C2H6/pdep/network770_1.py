...
"""),
    E0 = (369.8,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,731.477,2713.61],'cm^-1')),
        HinderedRotor(inertia=(0.554566,'amu*angstrom^2'), symmetry=1, barrier=(12.7506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.55452,'amu*angstrom^2'), symmetry=1, barrier=(12.7495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0848353,'amu*angstrom^2'), symmetry=1, barrier=(1.95053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.4994,'amu*angstrom^2'), symmetry=1, barrier=(80.458,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.980639,0.0578249,-3.78769e-05,1.33248e-08,-1.94065e-12,44592.6,27.3941], Tmin=(100,'K'), Tmax=(1585.56,'K')), NASAPolynomial(coeffs=[12.5497,0.0286387,-1.02656e-05,1.71532e-09,-1.10141e-13,40923.9,-33.7527], Tmin=(1585.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(369.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
"""),
    E0 = (294.723,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,275.271,275.454],'cm^-1')),
        HinderedRotor(inertia=(0.171603,'amu*angstrom^2'), symmetry=1, barrier=(9.22825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171369,'amu*angstrom^2'), symmetry=1, barrier=(9.22705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00615467,'amu*angstrom^2'), symmetry=1, barrier=(36.6349,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71741,0.0490471,-2.67642e-05,7.13541e-09,-7.77862e-13,35529.4,24.1082], Tmin=(100,'K'), Tmax=(1979.86,'K')), NASAPolynomial(coeffs=[11.6659,0.0289482,-1.15369e-05,2.00808e-09,-1.30435e-13,31590,-30.6825], Tmin=(1979.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJC)"""),
)

species(
    label = 'C=[C]CCC=C(1534)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    E0 = (301.542,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,319.407,319.588,319.889],'cm^-1')),
        HinderedRotor(inertia=(0.00166269,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177497,'amu*angstrom^2'), symmetry=1, barrier=(12.7091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173006,'amu*angstrom^2'), symmetry=1, barrier=(12.6991,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40902,0.0492057,-2.05413e-05,-2.60506e-09,3.00396e-12,36366.8,24.8215], Tmin=(100,'K'), Tmax=(1152.25,'K')), NASAPolynomial(coeffs=[10.7419,0.0297341,-1.20218e-05,2.20254e-09,-1.51698e-13,33357.9,-25.2505], Tmin=(1152.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = 'C#CCC[CH]C(1535)',
    structure = adjacencyList("""multiplicity 2
1  C u0 p0 c0 {2,S} {4,S} {7,S} {8,S}
...
"""),
    E0 = (296.467,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2175,525,750,770,3400,2100,269.978,2397.56],'cm^-1')),
        HinderedRotor(inertia=(1.41991,'amu*angstrom^2'), symmetry=1, barrier=(73.4462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00281329,'amu*angstrom^2'), symmetry=1, barrier=(11.4757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221865,'amu*angstrom^2'), symmetry=1, barrier=(11.4758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41997,'amu*angstrom^2'), symmetry=1, barrier=(73.4462,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63098,0.0524062,-3.63394e-05,1.5468e-08,-2.9846e-12,35741.8,23.6487], Tmin=(100,'K'), Tmax=(1153.91,'K')), NASAPolynomial(coeffs=[6.63051,0.0350754,-1.38108e-05,2.45219e-09,-1.64674e-13,34588,-1.18692], Tmin=(1153.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC)"""),
)

species(
    label = 'C=[C]C[CH]CC(1518)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    E0 = (368.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,298.682,1740.65,1740.65],'cm^-1')),
        HinderedRotor(inertia=(0.00188964,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142564,'amu*angstrom^2'), symmetry=1, barrier=(9.02521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142564,'amu*angstrom^2'), symmetry=1, barrier=(9.02521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142562,'amu*angstrom^2'), symmetry=1, barrier=(9.02521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23913,0.0477776,-2.26994e-05,4.76184e-09,-3.82124e-13,44339.6,23.87], Tmin=(100,'K'), Tmax=(2850.15,'K')), NASAPolynomial(coeffs=[22.3301,0.0195805,-7.85911e-06,1.29052e-09,-7.76297e-14,32887.5,-94.0992], Tmin=(2850.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_S)"""),
)
...
"""),
    E0 = (377.46,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,274.826,1304.9],'cm^-1')),
        HinderedRotor(inertia=(0.0022359,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11977,'amu*angstrom^2'), symmetry=1, barrier=(6.40421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119468,'amu*angstrom^2'), symmetry=1, barrier=(6.40097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119627,'amu*angstrom^2'), symmetry=1, barrier=(6.40837,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58457,0.0524453,-2.90832e-05,8.01021e-09,-9.13717e-13,45484.6,26.3683], Tmin=(100,'K'), Tmax=(1875.65,'K')), NASAPolynomial(coeffs=[11.0482,0.0322632,-1.29432e-05,2.27354e-09,-1.49095e-13,41934.5,-25.2406], Tmin=(1875.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P)"""),
)
...
"""),
    E0 = (420.856,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,311.517,311.626],'cm^-1')),
        HinderedRotor(inertia=(0.0017365,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135188,'amu*angstrom^2'), symmetry=1, barrier=(9.30446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135063,'amu*angstrom^2'), symmetry=1, barrier=(9.3044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135157,'amu*angstrom^2'), symmetry=1, barrier=(9.30382,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C)C[C]=C(1428)'],
    products = ['C=[C]CC[CH]C(1427)'],
    transitionState = 'TS2',
