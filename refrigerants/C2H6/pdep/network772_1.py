...
"""),
    E0 = (287.537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,368.79,368.82],'cm^-1')),
        HinderedRotor(inertia=(0.108046,'amu*angstrom^2'), symmetry=1, barrier=(10.4361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10814,'amu*angstrom^2'), symmetry=1, barrier=(10.4368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108132,'amu*angstrom^2'), symmetry=1, barrier=(10.4359,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24555,0.05374,-3.39208e-05,1.08476e-08,-1.4157e-12,34687.4,23.9582], Tmin=(100,'K'), Tmax=(1747.76,'K')), NASAPolynomial(coeffs=[13.3868,0.025953,-1.00729e-05,1.75111e-09,-1.14531e-13,30443.4,-41.3954], Tmin=(1747.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(287.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (298.062,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,333.762],'cm^-1')),
        HinderedRotor(inertia=(0.149726,'amu*angstrom^2'), symmetry=1, barrier=(11.8361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149737,'amu*angstrom^2'), symmetry=1, barrier=(11.8361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.927669,'amu*angstrom^2'), symmetry=1, barrier=(73.3289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0210828,'amu*angstrom^2'), symmetry=1, barrier=(73.3289,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1356,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31627,0.0530694,-2.5159e-05,-5.62847e-09,7.00737e-12,35950.7,23.5452], Tmin=(100,'K'), Tmax=(915.06,'K')), NASAPolynomial(coeffs=[10.8279,0.0273275,-8.92155e-06,1.45457e-09,-9.48551e-14,33546.9,-25.1215], Tmin=(915.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl)"""),
)

species(
    label = 'C=[C]C[C](C)C(1522)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57845,0.0574746,-5.19382e-05,3.83984e-08,-1.40431e-11,42195.4,23.9004], Tmin=(100,'K'), Tmax=(728.972,'K')), NASAPolynomial(coeffs=[3.28819,0.0451028,-2.03282e-05,3.86316e-09,-2.6958e-13,42025.6,16.7374], Tmin=(728.972,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(350.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Tertalkyl) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=CC([CH2])C(1255)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.22141,'amu*angstrom^2'), symmetry=1, barrier=(16.6347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.724414,'amu*angstrom^2'), symmetry=1, barrier=(16.6557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000365144,'amu*angstrom^2'), symmetry=1, barrier=(2.83452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.58791,'amu*angstrom^2'), symmetry=1, barrier=(82.4931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16286,0.0543375,-2.23377e-05,-6.73031e-09,5.98792e-12,45698.9,26.6551], Tmin=(100,'K'), Tmax=(1011.17,'K')), NASAPolynomial(coeffs=[11.3723,0.0303768,-1.11603e-05,1.96526e-09,-1.33806e-13,42794.5,-26.8653], Tmin=(1011.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=CC(C)C(1260)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29624,0.0520096,-1.64677e-05,-1.38426e-08,9.25227e-12,40640.7,26.8619], Tmin=(100,'K'), Tmax=(947.414,'K')), NASAPolynomial(coeffs=[10.6915,0.0302258,-1.0292e-05,1.73515e-09,-1.15665e-13,38057.9,-22.193], Tmin=(947.414,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=[C]CC(C)C(1524)',
    structure = adjacencyList("""multiplicity 3
1  C u0 p0 c0 {2,S} {3,S} {4,S} {7,S}
2  C u0 p0 c0 {1,S} {5,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {10,S} {11,S} {12,S}
...
"""),
    E0 = (411.814,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1685,370,3120,650,792.5,1650,298.186],'cm^-1')),
        HinderedRotor(inertia=(0.176958,'amu*angstrom^2'), symmetry=1, barrier=(11.3451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0020193,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18086,'amu*angstrom^2'), symmetry=1, barrier=(11.375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183552,'amu*angstrom^2'), symmetry=1, barrier=(11.3355,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.972727,0.0586182,-3.81083e-05,1.27193e-08,-1.73566e-12,49645.3,25.3544], Tmin=(100,'K'), Tmax=(1683.71,'K')), NASAPolynomial(coeffs=[13.9542,0.0277781,-1.06333e-05,1.84059e-09,-1.20383e-13,45273.9,-44.0372], Tmin=(1683.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[C]=C(57)', '[CH2]C([CH2])C(290)'],
    products = ['[CH2]C(C)C[C]=C(1428)'],
    transitionState = 'TS7',
