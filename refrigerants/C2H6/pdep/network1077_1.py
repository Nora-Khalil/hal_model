...
"""),
    E0 = (47.1604,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,298.356,298.357],'cm^-1')),
        HinderedRotor(inertia=(0.140988,'amu*angstrom^2'), symmetry=1, barrier=(8.90554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140982,'amu*angstrom^2'), symmetry=1, barrier=(8.90558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14098,'amu*angstrom^2'), symmetry=1, barrier=(8.90552,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78921,0.0500882,-3.88302e-05,1.69695e-08,-3.21684e-12,5750.37,22.2383], Tmin=(100,'K'), Tmax=(1196.22,'K')), NASAPolynomial(coeffs=[8.04099,0.029183,-1.26159e-05,2.35986e-09,-1.6353e-13,4254.68,-9.043], Tmin=(1196.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.1604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19278,0.0236802,5.777e-05,-9.83344e-08,4.26378e-11,5367.32,18.096], Tmin=(100,'K'), Tmax=(892.279,'K')), NASAPolynomial(coeffs=[13.3655,0.0164067,-1.97429e-06,7.72822e-11,-1.75103e-15,1669.21,-44.0824], Tmin=(892.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.9595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C1CCOO1(2288)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {2,S} {4,S}
2  O u0 p2 c0 {1,S} {5,S}
3  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9563,0.0288112,4.75111e-05,-9.21298e-08,4.17167e-11,6477.61,19.4928], Tmin=(100,'K'), Tmax=(885.766,'K')), NASAPolynomial(coeffs=[15.0981,0.0132777,-3.79188e-07,-2.42582e-10,2.11803e-14,2430.74,-52.017], Tmin=(885.766,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CJCOOH)"""),
)
...
"""),
    E0 = (235.743,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.119386,'amu*angstrom^2'), symmetry=1, barrier=(2.74492,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73256,0.0533973,-5.70889e-05,3.82219e-08,-1.11029e-11,28431.8,22.6012], Tmin=(100,'K'), Tmax=(816.426,'K')), NASAPolynomial(coeffs=[6.58378,0.029626,-1.34084e-05,2.54892e-09,-1.77912e-13,27639.8,0.181474], Tmin=(816.426,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = 'C=[C]CCO[O](2290)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {4,S}
2  O u1 p2 c0 {1,S}
3  C u0 p0 c0 {4,S} {6,S} {7,S} {8,S}
...
"""),
    E0 = (285.002,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,230.348,230.538],'cm^-1')),
        HinderedRotor(inertia=(0.193351,'amu*angstrom^2'), symmetry=1, barrier=(7.28846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193313,'amu*angstrom^2'), symmetry=1, barrier=(7.28811,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19361,'amu*angstrom^2'), symmetry=1, barrier=(7.28788,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60865,0.0564134,-6.97471e-05,5.47057e-08,-1.82087e-11,34360.4,23.3624], Tmin=(100,'K'), Tmax=(769.881,'K')), NASAPolynomial(coeffs=[6.41489,0.0294553,-1.33526e-05,2.51983e-09,-1.74226e-13,33679.2,1.81434], Tmin=(769.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCCO[O](2291)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {4,S}
2  O u1 p2 c0 {1,S}
3  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (294.257,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,190.647],'cm^-1')),
        HinderedRotor(inertia=(0.362604,'amu*angstrom^2'), symmetry=1, barrier=(9.40262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.367416,'amu*angstrom^2'), symmetry=1, barrier=(9.40241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.364895,'amu*angstrom^2'), symmetry=1, barrier=(9.40297,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6839,0.0538551,-5.58309e-05,3.4255e-08,-8.92913e-12,35471.8,23.0289], Tmin=(100,'K'), Tmax=(910.985,'K')), NASAPolynomial(coeffs=[7.72314,0.0273379,-1.21687e-05,2.30285e-09,-1.60621e-13,34371.5,-5.54401], Tmin=(910.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P)"""),
)
...
"""),
    E0 = (132.998,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,242.734,242.759],'cm^-1')),
        HinderedRotor(inertia=(0.323146,'amu*angstrom^2'), symmetry=1, barrier=(13.5073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323026,'amu*angstrom^2'), symmetry=1, barrier=(13.5077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00286117,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08382,'amu*angstrom^2'), symmetry=1, barrier=(45.3194,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57383,0.0571543,-5.42947e-05,3.0143e-08,-7.24742e-12,16080.1,22.7382], Tmin=(100,'K'), Tmax=(969.436,'K')), NASAPolynomial(coeffs=[7.79988,0.031465,-1.45458e-05,2.8084e-09,-1.98323e-13,14872.9,-7.10566], Tmin=(969.436,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (142.252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,262.873],'cm^-1')),
        HinderedRotor(inertia=(0.259982,'amu*angstrom^2'), symmetry=1, barrier=(12.7357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394152,'amu*angstrom^2'), symmetry=1, barrier=(19.2849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151088,'amu*angstrom^2'), symmetry=1, barrier=(7.40071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.789223,'amu*angstrom^2'), symmetry=1, barrier=(38.6409,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46539,0.0570099,-4.99699e-05,2.37904e-08,-4.75102e-12,17199.1,23.0468], Tmin=(100,'K'), Tmax=(1167.93,'K')), NASAPolynomial(coeffs=[9.99586,0.0277941,-1.24472e-05,2.37196e-09,-1.66302e-13,15206.5,-19.432], Tmin=(1167.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
reaction(
    ...
    products = ['C=CCCO[O](1658)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(150.585,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(7)', 'C=CCC[O](355)'],
    products = ['C=CCCO[O](1658)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['O2(2)', '[CH2]CC=C(54)'],
    products = ['C=CCCO[O](1658)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.62995e+14,'m^3/(mol*s)'), n=-2.27223, Ea=(18.6846,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH2]O[O](37)', '[CH2]C=C(214)'],
    products = ['C=CCCO[O](1658)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'C=CC[CH]O[O](2289)'],
    products = ['C=CCCO[O](1658)'],
