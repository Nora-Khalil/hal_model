...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(152)', '[CH2]O[CH2](115)'],
    products = ['[CH2]OC[C]=O(489)'],
    transitionState = 'TS3',
