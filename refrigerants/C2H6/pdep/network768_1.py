...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.09367,'amu*angstrom^2'), symmetry=1, barrier=(48.1377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.1071,'amu*angstrom^2'), symmetry=1, barrier=(48.4465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (65.0931,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78075,0.0401881,-8.76074e-06,-1.97193e-08,1.12783e-11,81164.5,18.0732], Tmin=(100,'K'), Tmax=(955.832,'K')), NASAPolynomial(coeffs=[12.0562,0.0178509,-6.13458e-06,1.06669e-09,-7.39865e-14,78256.3,-35.9736], Tmin=(955.832,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(674.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=CC([CH2])=C(2728)',
    structure = adjacencyList("""multiplicity 4
1  C u0 p0 c0 {2,S} {3,D} {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.18223,'amu*angstrom^2'), symmetry=1, barrier=(27.1818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18258,'amu*angstrom^2'), symmetry=1, barrier=(27.1899,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (65.0931,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80667,0.0407525,-2.15733e-05,-5.89483e-09,6.53105e-12,92206,16.4336], Tmin=(100,'K'), Tmax=(963.661,'K')), NASAPolynomial(coeffs=[12.9302,0.0120126,-3.97212e-06,7.00242e-10,-4.97828e-14,89252.8,-41.0191], Tmin=(963.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(765.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'C=C1C=CC1(2710)',
...
"""),
    ...
    molecularWeight = (65.0931,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88522,0.0393289,-1.64966e-05,-1.20443e-08,9.33812e-12,68051.3,17.5608], Tmin=(100,'K'), Tmax=(921.907,'K')), NASAPolynomial(coeffs=[12.3381,0.012659,-3.50225e-06,5.4193e-10,-3.62144e-14,65330,-36.3247], Tmin=(921.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(565.122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_P) + radical(Allyl_P) + radical(C=C=CJ)"""),
)

species(
    label = '[CH2]C(=C)[C]=C(2734)',
    structure = adjacencyList("""multiplicity 3
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([CH2])=C(2154)'],
    products = ['C2H2(22)', 'C=C=C(2022)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC[C]=C(2635)'],
    products = ['[CH]=CC([CH2])=C(2154)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(17)', '[CH]C=C=C(99)'],
    products = ['[CH]=CC([CH2])=C(2154)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(6)', '[CH]C(=C)C=[CH](2151)'],
    products = ['[CH]=CC([CH2])=C(2154)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['C2H2(22)', '[CH2][C]=C(2373)'],
    products = ['[CH]=CC([CH2])=C(2154)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=[CH](70)', '[CH2][C]=C(2373)'],
    products = ['[CH]=CC([CH2])=C(2154)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH]=C=C([CH2])[CH2](2733)'],
    products = ['[CH]=CC([CH2])=C(2154)'],
