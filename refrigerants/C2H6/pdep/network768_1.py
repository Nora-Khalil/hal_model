...
reaction(
    label = 'reaction1',
    reactants = ['C#CC[C-]=[OH+](1426)'],
    products = ['CO(14)', 'C=C=C(430)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C#C[OH+][C-]=C(1564)'],
    products = ['C#CC[C-]=[OH+](1426)'],
    transitionState = 'TS2',
