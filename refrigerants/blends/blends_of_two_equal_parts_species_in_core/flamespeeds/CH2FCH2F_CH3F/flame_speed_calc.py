...
directory = '/work/westgroup/nora/Code/projects/halogens/refrigerants/blends/blends_of_two_equal_parts_species_in_core/CH2FCH2F_CH3F/chemkin/copies/copy_chem.cti'
...
for i in  range(len(vol_frac_list)):
    try:
        ...
        vol_frac_dict = {'C2H4F2(1)': (x/2/norm_ox), 'CH3F(38)': (x/2/norm_ox), 'O2(2)':((1-x)*.21)/norm_ox, 'N2':((1-x)*0.79)/norm_ox}
