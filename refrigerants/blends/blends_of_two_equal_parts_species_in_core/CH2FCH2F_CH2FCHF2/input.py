...
species(
    label = 'OC(F)=CF',
    reactive = True,
    structure = SMILES('OC(F)=CF')
)      
        
        

species(
    label = 'FC1=C(F)[CH][CH]1',
    reactive = True,
    structure = SMILES('FC1=C(F)[CH][CH]1')
)      
        
        

species(
    label = 'FC1=CC2(F)OOC12',
    reactive = True,
    structure = SMILES('FC1=CC2(F)OOC12')
)      
        
        

species(
    label = '[O]C1C(F)=CC1([O])F',
    reactive = True,
    structure = SMILES('[O]C1C(F)=CC1([O])F')
)      
        
        

species(
    label = '[CH]=C(F)C([O])C(=O)F',
    reactive = True,
    structure = SMILES('[CH]=C(F)C([O])C(=O)F')
)      
