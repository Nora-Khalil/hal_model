...
directory = '/work/westgroup/nora/Code/projects/halogens/refrigerants/blends/concatenate_equal_parts/CH2FCHF2_CH3F/concatenated/fixed_chem.cti'
gas = ct.Solution(directory)
blend_name = 'CH2FCHF2_CH3F'
...
for i in  range(len(vol_frac_list)):
    try:
        ...
        vol_frac_dict = {'C2H3F3(1)': (x/2/norm_ox), 'CH3F(139)': (x/2/norm_ox), 'O2(2)':((1-x)*.21)/norm_ox, 'N2':((1-x)*0.79)/norm_ox}
