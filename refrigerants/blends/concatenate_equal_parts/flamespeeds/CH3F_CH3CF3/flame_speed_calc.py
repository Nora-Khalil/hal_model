...
directory = '/work/westgroup/nora/Code/projects/halogens/refrigerants/blends/concatenate_equal_parts/CH3F_CH3CF3/concatenated/fixed_chem.cti'
...
for i in  range(len(vol_frac_list)):
    try:
        ...
        vol_frac_dict = {'CH3F(1)': (x/2/norm_ox), 'CH3CF3(80)': (x/2/norm_ox), 'O2(2)':((1-x)*.21)/norm_ox, 'N2':((1-x)*0.79)/norm_ox}
