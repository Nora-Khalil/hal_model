...
directory = '/work/westgroup/nora/Code/projects/halogens/refrigerants/blends/concatenate_equal_parts/CH3CF3_C2H5F/concatenated/fixed_chem.cti'
...
for i in  range(len(vol_frac_list)):
    try:
        ...
        vol_frac_dict = {'CH3CF3(1)': (x/2/norm_ox), 'C2H5F(187)': (x/2/norm_ox), 'O2(2)':((1-x)*.21)/norm_ox, 'N2':((1-x)*0.79)/norm_ox}
