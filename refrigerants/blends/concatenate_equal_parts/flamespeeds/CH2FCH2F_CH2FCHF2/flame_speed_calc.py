...
directory = '/work/westgroup/nora/Code/projects/halogens/refrigerants/blends/concatenate_equal_parts/CH2FCH2F_CH2FCHF2/concatenated/fixed_chem.cti'
gas = ct.Solution(directory)
blend_name = 'CH2FCH2F_CH2FCHF2'
...
for i in  range(len(vol_frac_list)):
    try:
        ...
        vol_frac_dict = {'C2H4F2(1)': (x/2/norm_ox), 'S(145)': (x/2/norm_ox), 'O2(2)':((1-x)*.21)/norm_ox, 'N2':((1-x)*0.79)/norm_ox}
...
with open('concatenated_blend.csv', 'w+') as g:
