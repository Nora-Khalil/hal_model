...
directory = '/work/westgroup/nora/Code/projects/halogens/refrigerants/blends/blends_of_two_equal_parts_species_in_core_redo/CH3CF3_CH2FCH2F/chemkin/copies/copy_chem.cti'
gas = ct.Solution(directory)
blend_name = 'CH3CF3_CH2FCH2F'
...
for i in  range(len(vol_frac_list)):
    try:
        ...
        vol_frac_dict = {'CH3CF3(1)': (x/2/norm_ox), 'S(188)': (x/2/norm_ox), 'O2(2)':((1-x)*.21)/norm_ox, 'N2':((1-x)*0.79)/norm_ox}
