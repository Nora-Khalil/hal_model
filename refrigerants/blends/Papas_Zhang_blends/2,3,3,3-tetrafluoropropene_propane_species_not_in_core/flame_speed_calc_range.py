...
To = 298
Po = ct.one_atm
directory = '/work/westgroup/nora/Code/projects/halogens/refrigerants/blends/Papas_Zhang_blends/2,3,3,3-tetrafluoropropene_propane_species_not_in_core/chemkin/copies/copy_chem_annotated.cti'
...
#   {'propane(1)': 0.19574468085106386,
#    'C3H2F4(2)': 0.00851063829787234,
#    'O2(4)': 1.0,
#    'N2': 3.76}),
#  (0.08333333333333333,
#   {'propane(1)': 0.19130434782608693,
#    'C3H2F4(2)': 0.017391304347826084,
#    'O2(4)': 1.0,
#    'N2': 3.76}),
#  (0.125,
#   {'propane(1)': 0.18666666666666668,
#    'C3H2F4(2)': 0.02666666666666667,
#    'O2(4)': 1.0,
#    'N2': 3.76}),
#  (0.16666666666666666,
#   {'propane(1)': 0.18181818181818185,
#    'C3H2F4(2)': 0.03636363636363636,
#    'O2(4)': 1.0,
#    'N2': 3.76}),
#  (0.20833333333333331,
#   {'propane(1)': 0.17674418604651163,
#    'C3H2F4(2)': 0.04651162790697674,
#    'O2(4)': 1.0,
#    'N2': 3.7600000000000002}),
#  (0.25,
#   {'propane(1)': 0.17142857142857143,
#    'C3H2F4(2)': 0.05714285714285714,
#    'O2(4)': 1.0,
#    'N2': 3.76}),
#  (0.29166666666666663,
#   {'propane(1)': 0.16585365853658535,
#    'C3H2F4(2)': 0.06829268292682925,
#    'O2(4)': 1.0,
#    'N2': 3.7599999999999993}),
#  (0.3333333333333333,
#   {'propane(1)': 0.16,
#    'C3H2F4(2)': 0.07999999999999999,
#    'O2(4)': 1.0,
#    'N2': 3.76}),
#  (0.375,
#   {'propane(1)': 0.15384615384615385,
#    'C3H2F4(2)': 0.09230769230769231,
#    'O2(4)': 1.0,
#    'N2': 3.76}),
#  (0.41666666666666663,
#   {'propane(1)': 0.1473684210526316,
#    'C3H2F4(2)': 0.10526315789473682,
#    'O2(4)': 1.0,
#    'N2': 3.76}),
#  (0.4583333333333333,
#   {'propane(1)': 0.14054054054054055,
#    'C3H2F4(2)': 0.11891891891891891,
#    'O2(4)': 1.0,
#    'N2': 3.76}),
#  (0.5,
#   {'propane(1)': 0.13333333333333333,
#    'C3H2F4(2)': 0.13333333333333333,
#    'O2(4)': 1.0,
#    'N2': 3.76}),
master_dictionary = [(0.5416666666666666,
  {'propane(1)': 0.12571428571428572,
   'C3H2F4(2)': 0.14857142857142855,
   'O2(4)': 1.0,
   'N2': 3.7600000000000002}),
 (0.5833333333333333,
  {'propane(1)': 0.11764705882352942,
   'C3H2F4(2)': 0.16470588235294115,
   'O2(4)': 1.0,
   'N2': 3.76}),
 (0.625,
  {'propane(1)': 0.10909090909090909,
   'C3H2F4(2)': 0.18181818181818182,
   'O2(4)': 1.0,
   'N2': 3.76}),
 (0.6666666666666666,
  {'propane(1)': 0.1,
   'C3H2F4(2)': 0.19999999999999998,
   'O2(4)': 1.0,
   'N2': 3.76}),
 (0.7083333333333333,
  {'propane(1)': 0.0903225806451613,
   'C3H2F4(2)': 0.21935483870967737,
   'O2(4)': 1.0,
   'N2': 3.76}),
 (0.75, {'propane(1)': 0.08, 'C3H2F4(2)': 0.24, 'O2(4)': 1.0, 'N2': 3.76}),
 (0.7916666666666666,
  {'propane(1)': 0.06896551724137932,
   'C3H2F4(2)': 0.26206896551724135,
   'O2(4)': 1.0,
   'N2': 3.7599999999999993}),
 (0.8333333333333333,
  {'propane(1)': 0.05714285714285716,
   'C3H2F4(2)': 0.28571428571428564,
   'O2(4)': 1.0,
   'N2': 3.76}),
 (0.875,
  {'propane(1)': 0.044444444444444446,
   'C3H2F4(2)': 0.3111111111111111,
   'O2(4)': 1.0,
   'N2': 3.76}),
 (0.9166666666666666,
  {'propane(1)': 0.03076923076923078,
   'C3H2F4(2)': 0.3384615384615384,
   'O2(4)': 1.0,
   'N2': 3.76}),
 (0.9583333333333333,
  {'propane(1)': 0.016000000000000028,
   'C3H2F4(2)': 0.36799999999999994,
   'O2(4)': 1.0,
   'N2': 3.7600000000000002}),
 (1.0,
  {'propane(1)': 0.0,
