...
list_of_blends = ['2,3,3,3-tetrafluoropropene_propane.inp']
fullpath = '/work/westgroup/nora/Code/projects/halogens/refrigerants/blends/Papas_Zhang_blends/concatenated/2,3,3,3-tetrafluoropropene_propane/'

file_name = '2,3,3,3-tetrafluoropropene_propane.inp'
