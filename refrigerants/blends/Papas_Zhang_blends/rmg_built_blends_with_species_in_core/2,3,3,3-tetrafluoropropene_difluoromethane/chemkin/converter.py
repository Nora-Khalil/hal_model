...
list_of_blends = ['chem0217.inp']  ### dont forget to change the _168_species in this script. control f it

fullpath = '/work/westgroup/nora/Code/projects/halogens/refrigerants/blends/Papas_Zhang_blends/rmg_built_blends_with_species_in_core/2,3,3,3-tetrafluoropropene_difluoromethane/chemkin/'

file_name = 'chem0217.inp'
