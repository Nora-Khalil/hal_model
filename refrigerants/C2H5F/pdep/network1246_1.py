...
"""),
    E0 = (-147.861,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,180,603.69],'cm^-1')),
        HinderedRotor(inertia=(0.0196157,'amu*angstrom^2'), symmetry=1, barrier=(13.5517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0193197,'amu*angstrom^2'), symmetry=1, barrier=(13.5035,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CCOF(542)'],
    products = ['CC(=O)COF(2842)'],
    transitionState = 'TS2',
