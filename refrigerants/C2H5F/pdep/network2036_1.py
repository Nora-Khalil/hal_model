...
"""),
    E0 = (-559.489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,528,1116,1182,1331,1402,1494,3075,3110,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    molecularWeight = (112.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.14264,0.0698097,-4.32412e-05,-1.30182e-08,1.53073e-11,-67138.2,24.5005], Tmin=(100,'K'), Tmax=(931.705,'K')), NASAPolynomial(coeffs=[24.326,0.00431709,4.86902e-07,-1.5011e-10,6.05855e-15,-73308.3,-99.3879], Tmin=(931.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-559.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsOs) + group(CsCsFHH) + group(Cs-CsHHH)"""),
)
...
"""),
    E0 = (-470.964,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,333,384,448,608,1254,1480,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.197297,'amu*angstrom^2'), symmetry=1, barrier=(4.53626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196669,'amu*angstrom^2'), symmetry=1, barrier=(4.5218,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.618701,'amu*angstrom^2'), symmetry=1, barrier=(14.2252,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0769,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47632,0.0610632,-8.40776e-05,7.35976e-08,-2.69211e-11,-56558.4,20.7358], Tmin=(100,'K'), Tmax=(767.214,'K')), NASAPolynomial(coeffs=[5.53026,0.0331544,-1.62704e-05,3.17041e-09,-2.22686e-13,-56981.1,3.55123], Tmin=(767.214,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-470.964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-328.211,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,286,334,437,422,648,895,1187,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,244.319,244.438],'cm^-1')),
        HinderedRotor(inertia=(0.178327,'amu*angstrom^2'), symmetry=1, barrier=(7.56667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178769,'amu*angstrom^2'), symmetry=1, barrier=(7.56656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178446,'amu*angstrom^2'), symmetry=1, barrier=(7.56615,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07309,0.0707597,-9.34329e-05,6.58308e-08,-1.72536e-11,-39375.2,22.6625], Tmin=(100,'K'), Tmax=(640.815,'K')), NASAPolynomial(coeffs=[9.03438,0.029,-1.42575e-05,2.78494e-09,-1.96274e-13,-40558.5,-13.4745], Tmin=(640.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(O)(F)COF(5726)'],
    products = ['HF(38)', 'CH2O(20)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(33.5984,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH3OH(26)', 'F[C]COF(1633)'],
    products = ['CC(O)(F)COF(5726)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['CC(O)(F)COF(5726)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.14358e+07,'m^3/(mol*s)'), n=-0.641018, Ea=(184.122,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17570294811609, var=29.477358162589667, Tref=1000.0, N=2, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    ...
    products = ['CC(O)(F)COF(5726)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(71.6447,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'C=C(F)COF(4865)'],
    products = ['CC(O)(F)COF(5726)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(1637)', 'C=C(C)O(2495)'],
    products = ['CC(O)(F)COF(5726)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(O)(F)C[O](5855)'],
    products = ['CC(O)(F)COF(5726)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(160)', '[CH2]C(C)(O)F(3314)'],
    products = ['CC(O)(F)COF(5726)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(396)', 'C[C](O)F(1910)'],
    products = ['CC(O)(F)COF(5726)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'O[C](F)COF(3106)'],
    products = ['CC(O)(F)COF(5726)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'CC(O)(F)[CH]OF(5818)'],
    products = ['CC(O)(F)COF(5726)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(O)(F)COF(5857)'],
    products = ['CC(O)(F)COF(5726)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'CC(=O)COF(2842)'],
    products = ['CC(O)(F)COF(5726)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(151.286,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'CC(O)(F)C=O(5228)'],
    products = ['CC(O)(F)COF(5726)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(252.309,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=C(O)COF(2840)'],
    products = ['CC(O)(F)COF(5726)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(210.557,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)

reaction(
    label = 'reaction23',
    reactants = ['CC(O)(F)COF(5726)'],
    products = ['HF(38)', 'CH2O(20)', 'C=C(O)F(498)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(62.6156,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
