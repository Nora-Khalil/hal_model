...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21863,0.0458754,-4.64998e-05,6.17513e-09,1.80053e-11,-8061.52,18.2952], Tmin=(100,'K'), Tmax=(512.851,'K')), NASAPolynomial(coeffs=[6.50201,0.0232707,-1.19838e-05,2.38303e-09,-1.6943e-13,-8642.94,-0.894492], Tmin=(512.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.5051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CdCddFO) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (84.4996,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,197,221,431,657,2950,3100,1380,975,1025,1650,540,610,2055,2685.38],'cm^-1')),
        HinderedRotor(inertia=(0.490541,'amu*angstrom^2'), symmetry=1, barrier=(11.2785,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07064,0.0485497,-8.23347e-05,7.70275e-08,-2.78789e-11,10226.5,19.5087], Tmin=(100,'K'), Tmax=(836.667,'K')), NASAPolynomial(coeffs=[5.20257,0.0210751,-1.06647e-05,2.06132e-09,-1.4236e-13,10140,7.57231], Tmin=(836.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.4996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CdCddFO) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)

species(
    label = 'C#CC(F)O[O](9193)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {3,S} {4,S}
3 O u1 p2 c0 {2,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.20731,'amu*angstrom^2'), symmetry=1, barrier=(27.7584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2048,'amu*angstrom^2'), symmetry=1, barrier=(27.7008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64229,0.0551853,-6.94593e-05,4.51532e-08,-1.17922e-11,21927.9,20.8597], Tmin=(100,'K'), Tmax=(929.069,'K')), NASAPolynomial(coeffs=[10.3294,0.0177827,-9.06952e-06,1.81787e-09,-1.30817e-13,20313.8,-20.4108], Tmin=(929.069,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sO2sH)(Cd-HH)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]C(F)O[O](8508)'],
    products = ['O=O(150)', 'C=C=CF(5941)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C=C(F)O[O](9192)'],
    products = ['C=[C]C(F)O[O](8508)'],
    transitionState = 'TS9',
