...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OC(F)OF(2928)'],
    products = ['OCC(F)OF(2853)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OF(169)', 'OC[C]F-2(1319)'],
    products = ['OCC(F)OF(2853)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', '[CH2]C(F)OF(1355)'],
    products = ['OCC(F)OF(2853)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(1980)', 'CH2OH(33)'],
    products = ['OCC(F)OF(2853)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O[CH]C(F)OF(3040)'],
    products = ['OCC(F)OF(2853)'],
