...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.03012,0.0203978,-8.68542e-06,3.48344e-10,3.45923e-13,-17234.1,11.8289], Tmin=(100,'K'), Tmax=(1632.75,'K')), NASAPolynomial(coeffs=[8.9366,0.0113604,-5.37374e-06,1.03402e-09,-7.10954e-14,-19886.9,-21.7797], Tmin=(1632.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + ring(Oxetene)"""),
)

species(
    label = 'C=C=CC(=O)O(6085)',
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96911,0.0380786,-1.70341e-05,-9.43438e-09,7.91991e-12,53881.6,20.8342], Tmin=(100,'K'), Tmax=(928.44,'K')), NASAPolynomial(coeffs=[11.6715,0.0130997,-3.85551e-06,6.17625e-10,-4.15371e-14,51355,-29.1583], Tmin=(928.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(dioxirane) + radical(Cs_P) + radical(Cds_S)"""),
)

species(
    label = 'C[C]1[CH]C(=O)O1(6420)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.80196,0.0152903,4.26159e-05,-6.73189e-08,2.78582e-11,8139.27,21.0065], Tmin=(100,'K'), Tmax=(914.424,'K')), NASAPolynomial(coeffs=[9.44291,0.0148306,-3.52868e-06,5.14804e-10,-3.51878e-14,5729.43,-16.9741], Tmin=(914.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.2297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(C2CsJOC(O)) + radical(CCJCO)"""),
)

species(
    label = 'CC1=CC1([O])[O](6416)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
2  O u1 p2 c0 {3,S}
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02169,0.0499857,-7.45173e-05,7.25491e-08,-2.83915e-11,37517.7,17.2778], Tmin=(100,'K'), Tmax=(799.86,'K')), NASAPolynomial(coeffs=[2.9422,0.0321174,-1.61323e-05,3.15262e-09,-2.20889e-13,37794.8,15.695], Tmin=(799.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = 'C[C]=[C]C(=O)O(6421)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (158.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1670,1700,300,440,180,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.26813,'amu*angstrom^2'), symmetry=1, barrier=(6.16483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268662,'amu*angstrom^2'), symmetry=1, barrier=(6.17707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000535726,'amu*angstrom^2'), symmetry=1, barrier=(6.08266,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2814,0.0456265,-8.61919e-05,8.72783e-08,-3.3234e-11,19079.9,19.3191], Tmin=(100,'K'), Tmax=(833.71,'K')), NASAPolynomial(coeffs=[3.59385,0.021738,-1.15614e-05,2.29184e-09,-1.60314e-13,19472.4,16.8926], Tmin=(833.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + missing(Cd-COCdH) + group(Cds-O2d(Cds-Cds)O2s) + radical(Cds_S) + radical(C=CJC=O)"""),
)
...
"""),
    E0 = (95.3122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2100,2250,500,550,180,180,180,1384.29,1385.73,1386.03],'cm^-1')),
        HinderedRotor(inertia=(0.124605,'amu*angstrom^2'), symmetry=1, barrier=(2.86491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124563,'amu*angstrom^2'), symmetry=1, barrier=(2.86396,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0653,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46309,0.0422426,-7.14717e-05,7.3465e-08,-2.79716e-11,11510.7,18.829], Tmin=(100,'K'), Tmax=(881.697,'K')), NASAPolynomial(coeffs=[0.722672,0.0291041,-1.33349e-05,2.44924e-09,-1.63455e-13,12635.2,31.6428], Tmin=(881.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.3122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CtHHH) + group(Cds-O2d(Cds-Cds)O2s) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCOJ)"""),
)
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80748,0.0485432,-4.79997e-05,2.50284e-08,-5.31155e-12,7739.83,18.3648], Tmin=(100,'K'), Tmax=(1125.98,'K')), NASAPolynomial(coeffs=[10.1616,0.0188651,-8.46296e-06,1.6194e-09,-1.14034e-13,5858.53,-22.9304], Tmin=(1125.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.6983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cdd-CdsCds) + radical(C=COJ) + radical(C=COJ)"""),
)

species(
    label = 'C=[C][CH]C(=O)O(6426)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {10,S}
2  O u0 p2 c0 {4,D}
3  C u1 p0 c0 {4,S} {6,S} {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C[C]=CC([O])=O(6080)'],
    products = ['CO2(14)', 'C#CC(4975)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C[C]=C[C]=O(6307)'],
    products = ['C[C]=CC([O])=O(6080)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['C[C]=CC([O])=O(6080)'],
    products = ['CC1=CC1([O])[O](6416)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(3.66e+11,'s^-1'), n=0.412, Ea=(174.3,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_D;multiplebond_intra;radadd_intra_cd_Cs] for rate rule [R4_D_CO;carbonylbond_intra;radadd_intra_cd_Cs]
