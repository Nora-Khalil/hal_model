...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CO[CH]C(428)'],
    products = ['[CH]=C(C)O[CH]C(6115)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C-2(137)', '[CH]=C(C)[O](1728)'],
    products = ['[CH]=C(C)O[CH]C(6115)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(C)OC=C(6353)'],
    products = ['[CH]=C(C)O[CH]C(6115)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', 'C#CO[CH]C(723)'],
    products = ['[CH]=C(C)O[CH]C(6115)'],
    transitionState = 'TS9',
