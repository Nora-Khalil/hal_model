...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([O])(F)F(7424)'],
    products = ['O=O(150)', 'CF2O(49)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])(F)F(7573)'],
    products = ['[O]OC([O])(F)F(7424)'],
    transitionState = 'TS2',
