...
reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'F[C]COF(1633)'],
    products = ['CC(F)COF(1630)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'CC(F)OF(1634)'],
    products = ['CC(F)COF(1630)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(160)', '[CH2]C(C)F(1044)'],
    products = ['CC(F)COF(1630)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]OF(396)', 'CH3-CHF(62)'],
    products = ['CC(F)COF(1630)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'F[CH]COF(1639)'],
    products = ['CC(F)COF(1630)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)COF(1642)'],
    products = ['CC(F)COF(1630)'],
