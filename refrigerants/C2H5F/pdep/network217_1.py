...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC([O])=O(254)'],
    products = ['CC([O])C([O])=O(318)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[O]C(=O)C=O(251)'],
    products = ['CC([O])C([O])=O(318)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O][C]=O(625)', 'C[CH][O](174)'],
    products = ['CC([O])C([O])=O(318)'],
