...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=C(CO)OF(549)'],
    products = ['CC(O)C(=O)OF(566)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(169)', 'CC(O)=C=O(1605)'],
    products = ['CC(O)C(=O)OF(566)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'C=CC(=O)OF(1606)'],
    products = ['CC(O)C(=O)OF(566)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'CC(O)C([O])=O(1615)'],
    products = ['CC(O)C(=O)OF(566)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'C[CH]C(=O)OF(651)'],
    products = ['CC(O)C(=O)OF(566)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC([O])C(=O)OF(1616)'],
    products = ['CC(O)C(=O)OF(566)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(160)', 'CC(O)[C]=O(1617)'],
    products = ['CC(O)C(=O)OF(566)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(19)', 'O=C([CH]O)OF(1437)'],
    products = ['CC(O)C(=O)OF(566)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]OF(331)', 'C[CH]O(148)'],
    products = ['CC(O)C(=O)OF(566)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'C[C](O)C(=O)OF(1618)'],
    products = ['CC(O)C(=O)OF(566)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH2]C(O)C(=O)OF(1619)'],
    products = ['CC(O)C(=O)OF(566)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CC(O)C(=O)OF(566)'],
    products = ['HF(38)', 'CO2(14)', 'C=CO(145)'],
