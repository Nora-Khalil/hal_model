...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#CO[O](1059)'],
    products = ['C#CCO[O](6902)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(129.402,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C#CC[O](687)'],
    products = ['C#CCO[O](6902)'],
    transitionState = 'TS3',
