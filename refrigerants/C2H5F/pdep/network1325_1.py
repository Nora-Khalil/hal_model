...
reaction(
    label = 'reaction1',
    reactants = ['CHF2(81)', 'C2H4(30)'],
    products = ['[CH2]CC(F)F(3446)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'CHF2-CH2(63)'],
    products = ['[CH2]CC(F)F(3446)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2][CH]C(F)F(3563)'],
    products = ['[CH2]CC(F)F(3446)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C[C](F)F(3564)'],
    products = ['[CH2]CC(F)F(3446)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC(F)F(3446)'],
    products = ['C[CH]C(F)F(3565)'],
