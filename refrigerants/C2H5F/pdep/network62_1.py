...
reaction(
    label = 'reaction1',
    reactants = ['OH(5)', 'CH2CHF(55)'],
    products = ['OC[CH]F(262)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction11',
    reactants = ['OC[CH]F(262)'],
    products = ['O[CH]CF(1520)'],
