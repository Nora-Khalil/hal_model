...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=C=C([O])[O](3711)'],
    products = ['[CH2]C(=C)C([O])=O(6614)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(7)', '[CH2]C(=C)[C]=O(7013)'],
    products = ['[CH2]C(=C)C([O])=O(6614)'],
    transitionState = 'TS4',
