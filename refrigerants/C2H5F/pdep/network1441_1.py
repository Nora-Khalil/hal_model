...
"""),
    E0 = (-422.495,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18249,0.0518195,-3.54697e-05,3.03068e-09,3.46652e-12,-50704.2,23.7414], Tmin=(100,'K'), Tmax=(1059.85,'K')), NASAPolynomial(coeffs=[16.8703,0.0116447,-5.54727e-06,1.15251e-09,-8.71173e-14,-55098.6,-57.8981], Tmin=(1059.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.000934837,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000933273,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.337743,'amu*angstrom^2'), symmetry=1, barrier=(43.4725,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339976,'amu*angstrom^2'), symmetry=1, barrier=(43.4631,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.814484,0.0612482,-5.90021e-05,2.61468e-08,-4.46688e-12,-80977.5,24.9925], Tmin=(100,'K'), Tmax=(1427.14,'K')), NASAPolynomial(coeffs=[19.01,0.0102501,-5.40104e-06,1.10817e-09,-8.07657e-14,-86171.1,-69.2624], Tmin=(1427.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-674.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsOs) + radical(CsCCl_triplet)"""),
)

species(
    label = 'O[C]1OC(F)C(F)O1(4317)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.806648,0.0550693,-5.92969e-05,3.17237e-08,-6.18726e-12,-88494.3,21.7448], Tmin=(100,'K'), Tmax=(1531.22,'K')), NASAPolynomial(coeffs=[13.8333,0.00717047,1.21195e-06,-5.36153e-10,4.55558e-14,-90857.7,-41.342], Tmin=(1531.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-736.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(CsCFHO) + group(Cs-OsOsOsH) + ring(1,3-Dioxolane) + radical(Cs_P) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = '[O]C1(O)OC(F)C1F(4318)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32573,0.0437029,-2.08816e-05,-3.3856e-08,4.22394e-11,-80907.2,22.7298], Tmin=(100,'K'), Tmax=(479.015,'K')), NASAPolynomial(coeffs=[4.97721,0.0317634,-1.54394e-05,3.02966e-09,-2.15178e-13,-81278.3,10.6679], Tmin=(479.015,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-673.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(CsCsCsFH) + group(CsCFHO) + ring(O2s-Cs-Cs-Cs(F)) + radical(CCOJ) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F))"""),
)

species(
    label = 'O=C(O)OC=CF(4319)',
...
"""),
    E0 = (-446.009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,334,575,1197,1424,3202,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.929112,0.0665143,-7.8928e-05,4.47883e-08,-9.88056e-12,-53531,24.8578], Tmin=(100,'K'), Tmax=(1110.65,'K')), NASAPolynomial(coeffs=[15.8171,0.0128953,-6.51258e-06,1.32109e-09,-9.64228e-14,-56838.1,-48.5309], Tmin=(1110.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-OdOsOs) + radical(CCsJOC(O)) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-412.401,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,334,575,1197,1424,3202,1855,455,950,292.154,292.155,292.156],'cm^-1')),
        HinderedRotor(inertia=(0.683014,'amu*angstrom^2'), symmetry=1, barrier=(41.3696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.683023,'amu*angstrom^2'), symmetry=1, barrier=(41.3696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.683017,'amu*angstrom^2'), symmetry=1, barrier=(41.3696,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64885,0.0552194,-6.45434e-05,3.91309e-08,-9.64339e-12,-49518.6,20.4353], Tmin=(100,'K'), Tmax=(975.65,'K')), NASAPolynomial(coeffs=[10.2506,0.019954,-1.03258e-05,2.08423e-09,-1.50697e-13,-51197.1,-20.8515], Tmin=(975.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-412.401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsH) + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical((O)CJOC)"""),
)

species(
    label = '[O]C(=O)OC(F)[CH]F(4323)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29455,0.0599395,-6.34362e-05,3.2989e-08,-6.83328e-12,-72365,24.4716], Tmin=(100,'K'), Tmax=(1161.79,'K')), NASAPolynomial(coeffs=[13.4971,0.0179262,-9.19205e-06,1.86204e-09,-1.35181e-13,-75200.4,-36.2286], Tmin=(1161.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-602.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = 'O=C(O)O[C](F)[CH]F(4324)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03168,0.0633384,-6.22772e-05,2.95886e-08,-5.5719e-12,-102161,25.3882], Tmin=(100,'K'), Tmax=(1274.51,'K')), NASAPolynomial(coeffs=[15.3762,0.0183188,-9.29264e-06,1.87356e-09,-1.35488e-13,-105818,-47.295], Tmin=(1274.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-850.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdOsOs) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O]C(=O)OC(F)CF(3963)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {6,S} {8,S}
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', 'O=C(O)O[CH]F(2381)'],
    products = ['O=C(O)OC(F)[CH]F(3767)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'O=C(O)OC(F)[C]F(4316)'],
    products = ['O=C(O)OC(F)[CH]F(3767)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O=C(O)OC(F)[CH]F(3767)'],
    products = ['O[C]1OC(F)C(F)O1(4317)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4.47116e+08,'s^-1'), n=0.669085, Ea=(109.385,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs] for rate rule [R5_SS_CO;carbonyl_intra_Nd;radadd_intra_cs]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Endocyclic
Ea raised from 106.1 to 109.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['O=C(O)OC(F)[CH]F(3767)'],
    products = ['[O]C1(O)OC(F)C1F(4318)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(902977,'s^-1'), n=1.63829, Ea=(173.089,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_cs]
Euclidian distance = 2.23606797749979
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)O(163)', 'F[CH][CH]F(4261)'],
    products = ['O=C(O)OC(F)[CH]F(3767)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]O(146)', '[O]C(F)[CH]F(1776)'],
    products = ['O=C(O)OC(F)[CH]F(3767)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'O=[C]OC(F)[CH]F(4322)'],
    products = ['O=C(O)OC(F)[CH]F(3767)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(=O)OC(F)[CH]F(4323)'],
    products = ['O=C(O)OC(F)[CH]F(3767)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=C(O)O[C](F)[CH]F(4324)'],
    products = ['O=C(O)OC(F)[CH]F(3767)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'O=C(O)O[CH]F(2381)'],
    products = ['O=C(O)OC(F)[CH]F(3767)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=C(O)OC(F)[C]F-2(4325)'],
    products = ['O=C(O)OC(F)[CH]F(3767)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=C(O)OC(F)[CH]F(3767)'],
    products = ['O=C(O)O[CH]C(F)F(4326)'],
...
network(
    ...
    isomers = [
        'O=C(O)OC(F)[CH]F(3767)',
    ],
    reactants = [
        ('HF(38)', 'CO2(14)', 'O=C[CH]F(414)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
