...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19264,0.0671018,-7.09627e-05,4.41788e-08,-1.18361e-11,-77289.3,22.4863], Tmin=(100,'K'), Tmax=(880.173,'K')), NASAPolynomial(coeffs=[8.1537,0.0354672,-1.70515e-05,3.34559e-09,-2.38171e-13,-78514.7,-10.2084], Tmin=(880.173,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-643.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
"""),
    E0 = (-281.377,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.129677,0.0916502,-0.00013717,1.12589e-07,-3.70773e-11,-33708.6,26.8757], Tmin=(100,'K'), Tmax=(788.418,'K')), NASAPolynomial(coeffs=[11.1188,0.0317649,-1.53741e-05,2.95342e-09,-2.04933e-13,-35313,-22.7138], Tmin=(788.418,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sO2s)(H)(H)) + radical(CJCO)"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3712.29,'J/mol'), sigma=(6.45764,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=579.85 K, Pc=31.28 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-180.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,337.542,337.542,337.542],'cm^-1')),
        HinderedRotor(inertia=(0.216509,'amu*angstrom^2'), symmetry=1, barrier=(17.5049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216509,'amu*angstrom^2'), symmetry=1, barrier=(17.5049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216509,'amu*angstrom^2'), symmetry=1, barrier=(17.5049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216509,'amu*angstrom^2'), symmetry=1, barrier=(17.5049,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.935164,0.0530301,-1.38137e-05,-3.20184e-08,1.9413e-11,-21584.6,23.5314], Tmin=(100,'K'), Tmax=(940.086,'K')), NASAPolynomial(coeffs=[19.6271,0.0095301,-1.89934e-06,3.04731e-10,-2.55018e-14,-26691.2,-73.9601], Tmin=(940.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cs_P)"""),
)
...
"""),
    E0 = (-405.1,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.00254,'amu*angstrom^2'), symmetry=1, barrier=(23.0505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00194,'amu*angstrom^2'), symmetry=1, barrier=(23.0366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0015,'amu*angstrom^2'), symmetry=1, barrier=(23.0264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0018,'amu*angstrom^2'), symmetry=1, barrier=(23.0333,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.417231,0.0826433,-9.06043e-05,4.68168e-08,-9.12462e-12,-48550.8,25.9059], Tmin=(100,'K'), Tmax=(1364.76,'K')), NASAPolynomial(coeffs=[23.2758,0.00739349,-1.51467e-06,1.79747e-10,-1.03715e-14,-54477,-93.7856], Tmin=(1364.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)
...
"""),
    E0 = (-372.574,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.978267,'amu*angstrom^2'), symmetry=1, barrier=(22.4923,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.978382,'amu*angstrom^2'), symmetry=1, barrier=(22.4949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.979378,'amu*angstrom^2'), symmetry=1, barrier=(22.5178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.978344,'amu*angstrom^2'), symmetry=1, barrier=(22.4941,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.470972,0.0811711,-8.7032e-05,4.37516e-08,-8.24149e-12,-44634.6,26.0579], Tmin=(100,'K'), Tmax=(1448.79,'K')), NASAPolynomial(coeffs=[23.5402,0.00639019,-8.19904e-07,3.69652e-11,-3.86917e-16,-50701.3,-95.6094], Tmin=(1448.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-372.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = 'C[C-]=[O+]C(C)(O)F(10456)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.428051,0.0871811,-0.000133083,1.18459e-07,-4.21701e-11,-31746,34.3956], Tmin=(100,'K'), Tmax=(813.725,'K')), NASAPolynomial(coeffs=[7.097,0.0400139,-1.96196e-05,3.77661e-09,-2.61784e-13,-32355.1,6.52278], Tmin=(813.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-264.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]COC(C)(O)F(10457)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {4,S} {14,S}
4  C u0 p0 c0 {1,S} {2,S} {3,S} {5,S}
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.389463,0.0868115,-0.000130965,1.12638e-07,-3.9125e-11,-30719.2,25.0008], Tmin=(100,'K'), Tmax=(787.632,'K')), NASAPolynomial(coeffs=[8.8534,0.0355733,-1.76656e-05,3.43451e-09,-2.39974e-13,-31796.5,-12.1869], Tmin=(787.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(Cs-CsOsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=COC(C)(O)F(5139)'],
    products = ['CC(=O)F(499)', 'CH3CHO(36)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.02942e+10,'s^-1'), n=0.375329, Ea=(148.85,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.06684469846581474, var=24.965000021544366, Tref=1000.0, N=36, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=COC(O)F(2182)'],
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]COC([CH2])(O)F(10452)'],
    products = ['C=COC(C)(O)F(5139)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.02844e+09,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=CO[C](C)O(10453)'],
    products = ['C=COC(C)(O)F(5139)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CHO(35)', 'C[C](O)F(1910)'],
    products = ['C=COC(C)(O)F(5139)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C2H3(29)', 'CC([O])(O)F(5101)'],
    products = ['C=COC(C)(O)F(5139)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'C=CO[C](C)F(5190)'],
    products = ['C=COC(C)(O)F(5139)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'C=CO[C](O)F(10454)'],
    products = ['C=COC(C)(O)F(5139)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]C(O)(F)OC=C(1678)'],
    products = ['C=COC(C)(O)F(5139)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C=[C]OC(C)(O)F(5478)'],
    products = ['C=COC(C)(O)F(5139)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH]=COC(C)(O)F(10455)'],
    products = ['C=COC(C)(O)F(5139)'],
