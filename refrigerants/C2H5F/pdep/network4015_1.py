...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75863,0.0423182,-2.89743e-05,9.72842e-09,-1.30429e-12,13036.5,18.2307], Tmin=(100,'K'), Tmax=(1743.83,'K')), NASAPolynomial(coeffs=[13.1022,0.0162983,-6.59252e-06,1.17187e-09,-7.75984e-14,9080.29,-42.8034], Tmin=(1743.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(107.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cd-Cs(F)-Cd)"""),
)

species(
    label = '[CH]=CC(F)=C[CH2](11001)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (227.956,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,518,736,852,873,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(2.85383,'amu*angstrom^2'), symmetry=1, barrier=(71.1261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.35157,'amu*angstrom^2'), symmetry=1, barrier=(34.475,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7885,0.0403145,-1.30528e-05,-1.2475e-08,7.72947e-12,27503.8,20.2707], Tmin=(100,'K'), Tmax=(1008.26,'K')), NASAPolynomial(coeffs=[11.9227,0.0181781,-7.00057e-06,1.29648e-09,-9.20871e-14,24541.8,-33.2589], Tmin=(1008.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCCF) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CC=CCJ) + radical(Cds_P)"""),
)
...
"""),
    E0 = (571.954,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,529.622,529.628,529.628,529.628,529.63,529.63,529.631,667.896],'cm^-1')),
        HinderedRotor(inertia=(0.000600975,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (65.0931,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09203,0.0290025,1.7539e-05,-5.13851e-08,2.4092e-11,68870.9,15.4363], Tmin=(100,'K'), Tmax=(930.947,'K')), NASAPolynomial(coeffs=[14.8464,0.00734919,-9.82679e-07,1.26945e-10,-1.25641e-14,65059.7,-52.8985], Tmin=(930.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(571.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Cds_P)"""),
)
...
"""),
    E0 = (354.768,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,3150,900,1100,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,316.5,317.001,320.061,320.813],'cm^-1')),
        HinderedRotor(inertia=(0.00167226,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0835,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0092,0.0423256,-3.4662e-05,1.45587e-08,-2.50023e-12,42741.5,17.7128], Tmin=(100,'K'), Tmax=(1361.11,'K')), NASAPolynomial(coeffs=[10.2257,0.0181792,-8.05173e-06,1.52511e-09,-1.06301e-13,40504.8,-24.4601], Tmin=(1361.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cd-Cs(F)-Cd) + radical(Cds_P)"""),
)

species(
    label = 'C#CC1(F)[CH]C1(12888)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {5,S}
3  C u0 p0 c0 {2,S} {4,S} {7,S} {8,S}
...
"""),
    E0 = (319.244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2950,3150,900,1000,1100,2175,525,750,770,3400,2100,543.071,543.234,543.425,544.95,547.734],'cm^-1')),
        HinderedRotor(inertia=(0.000564189,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0835,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46173,0.0361371,-2.54834e-05,1.04306e-08,-1.95291e-12,38449.6,17.4574], Tmin=(100,'K'), Tmax=(1155.8,'K')), NASAPolynomial(coeffs=[5.69103,0.0249612,-1.09794e-05,2.06473e-09,-1.43385e-13,37703.1,1.41032], Tmin=(1155.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Ct-CtCs) + group(Ct-CtH) + ring(Cs(F)-Cs-Cs) + radical(cyclopropane)"""),
)
...
"""),
    E0 = (568.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,540,610,2055,3120,650,792.5,1650,826.403,826.839,827.172,827.539,827.966,828.086,828.241,828.363],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (64.0851,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.82462,0.0106532,5.76208e-05,-8.79559e-08,3.63285e-11,68383.4,14.1037], Tmin=(100,'K'), Tmax=(921.983,'K')), NASAPolynomial(coeffs=[12.6698,0.00709164,-2.81777e-07,-2.97867e-11,-1.96117e-15,64903.9,-41.6183], Tmin=(921.983,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(568.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Cyclopropane) + radical(Allyl_S) + radical(C=C=CJ)"""),
)

species(
    label = 'C=[C]C1(F)[CH]C1(12890)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.86831,0.0331806,-1.55434e-05,2.68488e-09,-1.20935e-13,47075.5,18.8359], Tmin=(100,'K'), Tmax=(2331.13,'K')), NASAPolynomial(coeffs=[19.0827,0.0115541,-5.61432e-06,9.85482e-10,-6.09607e-14,37832.5,-76.7233], Tmin=(2331.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cs(F)-Cs-Cs) + radical(cyclopropane) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]C1(F)CC1(12891)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {5,S}
3  C u0 p0 c0 {2,S} {4,S} {7,S} {8,S}
...
"""),
    E0 = (412.319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1685,370,3120,650,792.5,1650,180,880.431,880.953,881.11,881.163,881.514],'cm^-1')),
        HinderedRotor(inertia=(0.265798,'amu*angstrom^2'), symmetry=1, barrier=(6.11123,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.36725,0.0391891,-2.46301e-05,7.55061e-09,-9.69525e-13,49645.7,18.6921], Tmin=(100,'K'), Tmax=(1650.02,'K')), NASAPolynomial(coeffs=[8.4762,0.0243797,-1.11672e-05,2.11108e-09,-1.45364e-13,47629.8,-13.8393], Tmin=(1650.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cs(F)-Cs-Cs) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=CC1(F)[CH][CH]1(12892)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.00159,0.0296387,-9.55181e-06,-7.67914e-10,5.24709e-13,45637.1,20.2539], Tmin=(100,'K'), Tmax=(1980.9,'K')), NASAPolynomial(coeffs=[13.5534,0.0185467,-8.8878e-06,1.61188e-09,-1.04178e-13,39452.5,-42.9239], Tmin=(1980.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cs(F)-Cs-Cs) + radical(cyclopropane) + radical(cyclopropane)"""),
)

species(
    label = '[CH]=C[C]1CC1F(8435)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.43433,0.0234301,2.83203e-05,-5.04747e-08,2.00313e-11,39124,17.8785], Tmin=(100,'K'), Tmax=(987.327,'K')), NASAPolynomial(coeffs=[9.86175,0.0202426,-7.7104e-06,1.45271e-09,-1.0539e-13,36346,-24.5004], Tmin=(987.327,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cs(F)-Cs-Cs) + radical(Allyl_T) + radical(Cds_P)"""),
)

species(
    label = 'F[CH]C=C1[CH]C1(12855)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC1(F)[CH]C1(12819)'],
    products = ['C2H2(23)', 'FC1=CC1(6278)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=CC(F)=C[CH2](11001)'],
    products = ['[CH]=CC1(F)[CH]C1(12819)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=CC1=CC1(12886)'],
    products = ['[CH]=CC1(F)[CH]C1(12819)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(46.5547,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH]=[CH](272)', 'FC1=CC1(6278)'],
    products = ['[CH]=CC1(F)[CH]C1(12819)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH]=CC1(F)C=C1(12887)'],
    products = ['[CH]=CC1(F)[CH]C1(12819)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H2(23)', 'F[C]1[CH]C1(6219)'],
    products = ['[CH]=CC1(F)[CH]C1(12819)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.0816,'m^3/(mol*s)'), n=2.24, Ea=(20.1606,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_N-Sp-2R!H=1R!H',), comment="""Estimated from node Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_N-Sp-2R!H=1R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'C#CC1(F)[CH]C1(12888)'],
    products = ['[CH]=CC1(F)[CH]C1(12819)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[CH](272)', 'F[C]1[CH]C1(6219)'],
    products = ['[CH]=CC1(F)[CH]C1(12819)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C[C]1C=C1(8434)'],
    products = ['[CH]=CC1(F)[CH]C1(12819)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(562.232,'m^3/(mol*s)'), n=1.03051, Ea=(238.974,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH]=C=C1[CH]C1(12889)'],
    products = ['[CH]=CC1(F)[CH]C1(12819)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(324.772,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC1(F)[CH]C1(12819)'],
    products = ['C=[C]C1(F)[CH]C1(12890)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C]C1(F)CC1(12891)'],
    products = ['[CH]=CC1(F)[CH]C1(12819)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(6.64e+09,'s^-1'), n=0.99, Ea=(141.419,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3H_SS;Cd_rad_out;Cs_H_out_H/NonDeC] for rate rule [R3H_SS_23cy3;Cd_rad_out;Cs_H_out_H/NonDeC]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=CC1(F)[CH]C1(12819)'],
    products = ['C=CC1(F)[CH][CH]1(12892)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=CC1(F)[CH]C1(12819)'],
    products = ['F[CH]C=C1[CH]C1(12855)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(158.18,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #4015',
    isomers = [
        '[CH]=CC1(F)[CH]C1(12819)',
    ],
    reactants = [
        ('C2H2(23)', 'FC1=CC1(6278)'),
        ('C2H2(23)', 'F[C]1[CH]C1(6219)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
