...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C=C(O)O(2702)'],
    products = ['C=C(O)OCF(2505)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C=C(O)OF(2527)'],
    products = ['C=C(O)OCF(2505)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]OC(=C)O(2719)'],
    products = ['C=C(O)OCF(2505)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[CH2]C(=O)OCF(2598)'],
    products = ['C=C(O)OCF(2505)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'C=C(O)O[CH]F(2708)'],
    products = ['C=C(O)OCF(2505)'],
