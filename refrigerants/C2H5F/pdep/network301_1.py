...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC[O](357)'],
    products = ['CC([O])C[O](389)'],
    transitionState = 'TS2',
