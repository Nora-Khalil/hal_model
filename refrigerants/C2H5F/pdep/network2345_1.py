...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH]C(F)=C=C(2639)'],
    products = ['[CH]=C(F)C([CH2])=C(6380)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(F)C([CH2])=C(6380)'],
    products = ['[CH2]C1=C(F)[CH]C1(6855)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C#CC([CH2])=C(6790)'],
    products = ['[CH]=C(F)C([CH2])=C(6380)'],
