...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(134)', '[CH2]C([CH2])=C(6712)'],
    products = ['[CH2]C(=C)C[C]=C(6699)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'C=[C]C[C]=C(6757)'],
    products = ['[CH2]C(=C)C[C]=C(6699)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#CCC([CH2])=C(7003)'],
    products = ['[CH2]C(=C)C[C]=C(6699)'],
