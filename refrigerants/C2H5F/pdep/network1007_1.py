...
reaction(
    label = 'reaction2',
    reactants = ['[O]C=C([O])OF(2278)'],
    products = ['[O]C(=O)C([O])F(2262)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]C(=O)C(=O)F(2283)'],
    products = ['[O]C(=O)C([O])F(2262)'],
