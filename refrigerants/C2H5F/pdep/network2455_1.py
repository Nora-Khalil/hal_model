...
"""),
    E0 = (-223.252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,2950,3100,1380,975,1025,1650,194,682,905,1196,1383,3221,223.145,223.438,223.482],'cm^-1')),
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31155,0.040066,-2.79469e-05,9.52995e-09,-1.35813e-12,-1536.83,16.3473], Tmin=(100,'K'), Tmax=(1531.52,'K')), NASAPolynomial(coeffs=[8.96615,0.0226857,-1.09244e-05,2.12011e-09,-1.48578e-13,-3575.17,-18.594], Tmin=(1531.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.2576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCFH) + group(Cds-CdsHH) + ring(12methylenecyclobutane)"""),
)

species(
    label = '[O]C([CH]F)=C1CO1(8222)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23237,0.0482164,-1.93308e-05,-2.35169e-08,1.64115e-11,-11197.5,20.4701], Tmin=(100,'K'), Tmax=(929.291,'K')), NASAPolynomial(coeffs=[19.1811,0.00343844,5.20129e-07,-1.4739e-10,6.48015e-15,-15935.9,-72.3516], Tmin=(929.291,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.0272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + ring(methyleneoxirane) + radical(C=C(C)OJ) + radical(Csj(Cd-O2sCd)(F1s)(H))"""),
)

species(
    label = 'C=C([O])[C]1OC1F(8223)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58924,0.0441315,-2.31805e-05,-9.50784e-09,9.09777e-12,-17049.2,21.6267], Tmin=(100,'K'), Tmax=(944.06,'K')), NASAPolynomial(coeffs=[14.9979,0.00920204,-2.45148e-06,4.07391e-10,-2.99935e-14,-20556.1,-47.4552], Tmin=(944.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-142.544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + ring(Cd-Cd-O2s-Cs(F)) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[O]C1=C([CH]F)OC1(8225)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42195,0.0409255,3.81842e-06,-4.79631e-08,2.49523e-11,-16610.5,21.0718], Tmin=(100,'K'), Tmax=(936.397,'K')), NASAPolynomial(coeffs=[19.713,0.0028094,7.72331e-07,-1.55934e-10,4.10116e-15,-21790.5,-75.3379], Tmin=(936.397,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(CsCFHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + ring(Cyclobutene) + radical(C=C(C)OJ) + radical(Csj(Cd-O2sCd)(F1s)(H))"""),
)

species(
    label = 'C=C1OC1([O])[CH]F(8175)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u1 p2 c0 {4,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.727705,0.0755787,-8.89231e-05,4.58017e-08,-8.40711e-12,1212.25,24.2405], Tmin=(100,'K'), Tmax=(1627.3,'K')), NASAPolynomial(coeffs=[23.4183,-0.00554772,5.92778e-06,-1.2791e-09,8.90889e-14,-3763.32,-95.1491], Tmin=(1627.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.46008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(methyleneoxirane) + radical(C=CC(C)(O)OJ) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (-104.481,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,325,375,415,465,420,450,1700,1750,2950,3100,1380,975,1025,1650,167,640,1190,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.765194,'amu*angstrom^2'), symmetry=1, barrier=(17.5933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.766468,'amu*angstrom^2'), symmetry=1, barrier=(17.6226,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.614636,0.0743445,-0.000106278,7.34593e-08,-1.94251e-11,-12444.1,22.2485], Tmin=(100,'K'), Tmax=(939.906,'K')), NASAPolynomial(coeffs=[15.7397,0.00996849,-3.52801e-06,5.70865e-10,-3.56378e-14,-15287,-49.782], Tmin=(939.906,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.481,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=C(C)OJ) + radical(CdCdF1s)"""),
)

species(
    label = '[CH]=C([O])C(O)=CF(8228)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {9,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (-126.344,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,375,552.5,462.5,1710,2950,3100,1380,975,1025,1650,163,1167,369.65,369.728],'cm^-1')),
        HinderedRotor(inertia=(0.163076,'amu*angstrom^2'), symmetry=1, barrier=(15.816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163071,'amu*angstrom^2'), symmetry=1, barrier=(15.8131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163044,'amu*angstrom^2'), symmetry=1, barrier=(15.8148,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20266,0.0636566,-7.99141e-05,4.98657e-08,-1.22692e-11,-15096.6,20.6078], Tmin=(100,'K'), Tmax=(992.499,'K')), NASAPolynomial(coeffs=[12.9947,0.0161324,-8.08944e-06,1.62105e-09,-1.16982e-13,-17437.3,-36.193], Tmin=(992.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3710.48,'J/mol'), sigma=(5.78903,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=579.57 K, Pc=43.4 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3886.33,'J/mol'), sigma=(6.09401,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=607.04 K, Pc=38.97 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26901,0.0383007,-2.33541e-05,6.34813e-09,-6.74423e-13,-44953.4,17.5012], Tmin=(100,'K'), Tmax=(2123.2,'K')), NASAPolynomial(coeffs=[14.0309,0.0161417,-7.69903e-06,1.43252e-09,-9.56201e-14,-49947.9,-48.0991], Tmin=(2123.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)Cs) + longDistanceInteraction_cyclic(Cs(F)-CO) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75462,0.0344401,1.38473e-05,-4.8458e-08,2.1943e-11,-42560.4,16.1142], Tmin=(100,'K'), Tmax=(982.922,'K')), NASAPolynomial(coeffs=[16.5691,0.0101283,-3.95271e-06,8.51587e-10,-6.94968e-14,-47210.6,-63.9422], Tmin=(982.922,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH) + longDistanceInteraction_cyclic(Cs(F)-CO) + ring(Cyclobutane)"""),
)

species(
    label = '[CH2]C1=C([CH]F)OO1(8230)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {3,S} {4,S}
3  O u0 p2 c0 {2,S} {5,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5016,0.0474335,-3.78054e-05,1.35116e-08,-1.65106e-12,23425.7,23.482], Tmin=(100,'K'), Tmax=(1251.54,'K')), NASAPolynomial(coeffs=[14.0581,0.0142697,-6.40854e-06,1.23539e-09,-8.74041e-14,19737,-42.0931], Tmin=(1251.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + ring(Cyclobutene) + radical(Csj(Cd-O2sCd)(F1s)(H)) + radical(C=C(O)CJ)"""),
)

species(
    label = '[O]C1=C([O])C(F)C1(8231)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u1 p2 c0 {6,S}
3  O u1 p2 c0 {7,S}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68677,0.040185,-9.70941e-06,-2.45883e-08,1.47112e-11,-26056,21.0899], Tmin=(100,'K'), Tmax=(938.901,'K')), NASAPolynomial(coeffs=[15.437,0.00844574,-1.8836e-06,3.02742e-10,-2.37539e-14,-29821.1,-50.6802], Tmin=(938.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCCFH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + ring(Cs(F)-Cs-Cd-Cd) + radical(C=C(C)OJ) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83487,0.0294657,3.26447e-05,-7.18016e-08,3.1225e-11,-38800.9,17.2031], Tmin=(100,'K'), Tmax=(964.447,'K')), NASAPolynomial(coeffs=[18.1609,0.00673405,-1.9578e-06,4.74373e-10,-4.50279e-14,-44042,-71.8149], Tmin=(964.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-323.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)Cs) + group(CdCFH) + ring(Cyclobutane)"""),
)

species(
    label = 'CC(=O)C(=O)[C]F(8233)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {5,D}
3  O u0 p2 c0 {6,D}
...
"""),
    E0 = (-142.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,365,385,505,600,445,480,1700,1720,163,1167,371.131,371.144],'cm^-1')),
        HinderedRotor(inertia=(0.0728749,'amu*angstrom^2'), symmetry=1, barrier=(7.12433,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00497137,'amu*angstrom^2'), symmetry=1, barrier=(7.12425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.384895,'amu*angstrom^2'), symmetry=1, barrier=(37.6206,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8811,0.0535286,-5.99766e-05,2.60055e-08,4.40771e-12,-17050.9,20.4682], Tmin=(100,'K'), Tmax=(542.436,'K')), NASAPolynomial(coeffs=[6.77777,0.0271829,-1.41201e-05,2.82732e-09,-2.02252e-13,-17725.7,-1.48412], Tmin=(542.436,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-142.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)Cs) + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['C=C([O])C([O])=CF(8005)'],
    products = ['C=C1OOC1=CF(8015)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.62e+12,'s^-1'), n=-0.305, Ea=(209.995,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_SSS;Y_rad_out;Ypri_rad_out] for rate rule [R4_SSS;O_rad;Opri_rad]
Euclidian distance = 1.4142135623730951
family: Birad_recombination
Ea raised from 206.9 to 210.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['C=C([O])C([O])=CF(8005)'],
    products = ['[O]C([CH]F)=C1CO1(8222)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C([O])C([O])=CF(8005)'],
    products = ['[CH2]C1=C([O])C(F)O1(8224)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['C=C([O])C([O])=CF(8005)'],
    products = ['C=C1OC1([O])[CH]F(8175)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.64245e+09,'s^-1'), n=0.690807, Ea=(231.712,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra] for rate rule [R4_S_(Cd)_D;doublebond_intra;radadd_intra_O]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 231.4 to 231.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.62453e+10,'s^-1'), n=0.5217, Ea=(313.554,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_(Cd)_D;doublebond_intra_2H;radadd_intra_O]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 312.4 to 313.6 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(6.3044,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(520000,'m^3/(mol*s)'), n=-1.07934e-11, Ea=(24.215,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['C=C(O)C(=O)[C]F-2(8229)'],
    products = ['C=C([O])C([O])=CF(8005)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(18)', 'O=[C]C(=O)[CH]F(7888)'],
    products = ['C=C([O])C([O])=CF(8005)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]F(181)', '[CH2]C([O])=C=O(1322)'],
    products = ['C=C([O])C([O])=CF(8005)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.34239e+09,'s^-1'), n=0.889391, Ea=(269.654,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs2H]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
Ea raised from 269.4 to 269.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.63856e+09,'s^-1'), n=0.755479, Ea=(315.697,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
Ea raised from 315.7 to 315.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction27',
    reactants = ['CHF(40)', '[CH2]C([O])=C=O(1322)'],
    products = ['C=C([O])C([O])=CF(8005)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C=C([O])C([O])=CF(8005)'],
    products = ['[CH2]C1=C([CH]F)OO1(8230)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(1.503e+11,'s^-1'), n=0.221, Ea=(417.225,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_CO;carbonyl_intra;radadd_intra_O]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 414.5 to 417.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction30',
    reactants = ['C=C([O])C([O])=CF(8005)'],
    products = ['[O]C1=C([O])C(F)C1(8231)'],
