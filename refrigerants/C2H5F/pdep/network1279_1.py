...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCOF(397)'],
    products = ['O=C(O)COF(3895)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(357)', '[CH2]C(=O)O(1341)'],
    products = ['O=C(O)COF(3895)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(178)', '[CH2]OF(278)'],
    products = ['O=C(O)COF(3895)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'O=C(O)[CH]OF(3977)'],
    products = ['O=C(O)COF(3895)'],
