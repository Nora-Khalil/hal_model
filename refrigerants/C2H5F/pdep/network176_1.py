...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(152)', '[C]=C(134)'],
    products = ['C=[C]OC([O])=O(278)'],
    transitionState = 'TS2',
