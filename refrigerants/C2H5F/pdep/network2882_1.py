...
"""),
    E0 = (-982.26,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,375,361,584,565,722,1474,2750,2800,2850,1350,1500,750,1050,1375,1000,519,593,830,1115,1166,1389,1413,3114,192.109,193.625,200.132,202.997],'cm^-1')),
        HinderedRotor(inertia=(0.329921,'amu*angstrom^2'), symmetry=1, barrier=(8.53778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471646,'amu*angstrom^2'), symmetry=1, barrier=(13.4864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.371558,'amu*angstrom^2'), symmetry=1, barrier=(8.54285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.30719,'amu*angstrom^2'), symmetry=1, barrier=(33.1989,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0443797,0.0946094,-0.000142965,1.16717e-07,-3.84656e-11,-118003,27.0047], Tmin=(100,'K'), Tmax=(741.268,'K')), NASAPolynomial(coeffs=[11.5852,0.0323324,-1.69427e-05,3.37536e-09,-2.39645e-13,-119714,-25.2177], Tmin=(741.268,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-982.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(Cs-CsHHH) + group(CsFFHO)"""),
)
...
"""),
    E0 = (-770.45,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,375,361,584,565,722,1474,2750,2800,2850,1350,1500,750,1050,1375,1000,493,600,700,1144,1293,196.251,196.426,196.499,196.635],'cm^-1')),
        HinderedRotor(inertia=(0.250382,'amu*angstrom^2'), symmetry=1, barrier=(6.85664,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250417,'amu*angstrom^2'), symmetry=1, barrier=(6.854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19696,'amu*angstrom^2'), symmetry=1, barrier=(32.8456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250248,'amu*angstrom^2'), symmetry=1, barrier=(6.85398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0294815,0.0980866,-0.000166406,1.47854e-07,-5.15436e-11,-92527.8,28.4194], Tmin=(100,'K'), Tmax=(803.852,'K')), NASAPolynomial(coeffs=[10.7625,0.0311593,-1.68389e-05,3.34295e-09,-2.34708e-13,-93835.5,-18.6313], Tmin=(803.852,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-770.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(Cs-CsHHH) + group(CsFFHO) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(OF)OC(F)F(7543)'],
    products = ['HF(38)', 'CF2O(49)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(17.9812,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'FOC(F)OC(F)F(7537)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['CC(F)(OF)OC(F)F(7543)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(82.0928,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'CC(F)(OF)OF(5750)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.27832e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(10.225,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['OC(F)F(1983)', 'C=C(F)OF(1352)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(169)', 'C=C(F)OC(F)F(3571)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C[C](OF)OC(F)F(8015)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'CC(F)(OF)O[CH]F(5753)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'CC([O])(F)OC(F)F(5898)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(F)F(1981)', 'C[C](F)OF(5141)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(81)', 'CC([O])(F)OF(3850)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(160)', 'C[C](F)OC(F)F(5174)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'FO[C](F)OC(F)F(7948)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(F)(OF)OC(F)F(8016)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'CC(F)(OF)O[C](F)F(8017)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(77)', 'CC(=O)OC(F)F(3283)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'C=C(OF)OC(F)F(4774)'],
    products = ['CC(F)(OF)OC(F)F(7543)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC(F)(OF)OC(F)F(7543)'],
    products = ['F2(77)', 'CHFO(47)', 'CC(=O)F(499)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(210.01,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

network(
    label = 'PDepNetwork #2882',
    isomers = [
        'CC(F)(OF)OC(F)F(7543)',
    ],
    reactants = [
