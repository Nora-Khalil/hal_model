...
"""),
    E0 = (-221.396,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,180,180,1745.68],'cm^-1')),
        HinderedRotor(inertia=(0.20853,'amu*angstrom^2'), symmetry=1, barrier=(4.79452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208529,'amu*angstrom^2'), symmetry=1, barrier=(4.79449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208483,'amu*angstrom^2'), symmetry=1, barrier=(4.79344,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38074,0.0689386,-0.000124483,1.22765e-07,-4.5604e-11,-26544.4,23.9451], Tmin=(100,'K'), Tmax=(855.279,'K')), NASAPolynomial(coeffs=[3.2941,0.0338356,-1.70491e-05,3.26843e-09,-2.23742e-13,-25915.1,20.6057], Tmin=(855.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(CCOJ) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-69.7798,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,273.07],'cm^-1')),
        HinderedRotor(inertia=(0.254638,'amu*angstrom^2'), symmetry=1, barrier=(13.4734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254565,'amu*angstrom^2'), symmetry=1, barrier=(13.4736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25461,'amu*angstrom^2'), symmetry=1, barrier=(13.4734,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44623,0.0584705,-7.67295e-05,5.17359e-08,-1.37496e-11,-8302.57,18.4131], Tmin=(100,'K'), Tmax=(922.522,'K')), NASAPolynomial(coeffs=[11.3358,0.0155901,-7.00688e-06,1.35029e-09,-9.53218e-14,-10127.2,-28.5006], Tmin=(922.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.7798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-O2sCsH)(F1s)(H)) + radical(CJCO)"""),
)
...
"""),
    E0 = (-135.966,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.188545,'amu*angstrom^2'), symmetry=1, barrier=(4.33502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187902,'amu*angstrom^2'), symmetry=1, barrier=(4.32023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18544,'amu*angstrom^2'), symmetry=1, barrier=(4.26362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662901,'amu*angstrom^2'), symmetry=1, barrier=(15.2414,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.373112,0.0929473,-0.000176453,1.6529e-07,-5.79064e-11,-16234.8,26.2972], Tmin=(100,'K'), Tmax=(872.55,'K')), NASAPolynomial(coeffs=[7.93863,0.0285943,-1.4817e-05,2.82156e-09,-1.90434e-13,-16425.6,-2.69832], Tmin=(872.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-135.966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(C2CsJOH) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]C(O)COF-2(3965)'],
    products = ['OC([CH]F)COF(3775)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(837)', 'O[CH]COF(1238)'],
    products = ['OC([CH]F)COF(3775)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['OH(7)', 'F[CH][CH]COF(3969)'],
    products = ['OC([CH]F)COF(3775)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(160)', '[CH2]C(O)[CH]F(3970)'],
    products = ['OC([CH]F)COF(3775)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OF(396)', 'O[CH][CH]F(1318)'],
    products = ['OC([CH]F)COF(3775)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O[C]([CH]F)COF(3971)'],
    products = ['OC([CH]F)COF(3775)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'OC([CH]F)[CH]OF(3972)'],
    products = ['OC([CH]F)COF(3775)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'O=CC(O)[CH]F(3973)'],
    products = ['OC([CH]F)COF(3775)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(463.366,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['CHF(40)', 'O[CH]COF(1238)'],
    products = ['OC([CH]F)COF(3775)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OC([C]F)COF-2(3974)'],
    products = ['OC([CH]F)COF(3775)'],
...
reaction(
    label = 'reaction23',
    reactants = ['OC([CH]F)COF(3775)'],
    products = ['[O]CC(O)C(F)F(3975)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(73.4208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
