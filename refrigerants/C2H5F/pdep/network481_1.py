...
"""),
    E0 = (-830.452,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,482,664,788,1296,1923,180,841.078,841.094],'cm^-1')),
        HinderedRotor(inertia=(0.136693,'amu*angstrom^2'), symmetry=1, barrier=(3.14285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136707,'amu*angstrom^2'), symmetry=1, barrier=(3.14316,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.91138,'amu*angstrom^2'), symmetry=1, barrier=(20.9544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.911374,'amu*angstrom^2'), symmetry=1, barrier=(20.9543,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40924,0.0533111,-4.36169e-05,1.77169e-08,-2.89567e-12,-99784.2,24.6757], Tmin=(100,'K'), Tmax=(1440.42,'K')), NASAPolynomial(coeffs=[13.3552,0.0201372,-9.07056e-06,1.72774e-09,-1.20555e-13,-103226,-37.3162], Tmin=(1440.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-830.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(COFOO)"""),
)
...
"""),
    E0 = (-403.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,451,553,637,1069,1180,1265,1301,3056,360,370,350,260.082,260.107,4000],'cm^-1')),
        HinderedRotor(inertia=(0.238218,'amu*angstrom^2'), symmetry=1, barrier=(11.4393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.560148,'amu*angstrom^2'), symmetry=1, barrier=(26.8806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00971664,'amu*angstrom^2'), symmetry=1, barrier=(26.8802,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238352,'amu*angstrom^2'), symmetry=1, barrier=(11.4396,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40001,0.0597278,-6.20419e-05,3.45333e-08,-7.9076e-12,-48386.7,26.3079], Tmin=(100,'K'), Tmax=(1041.07,'K')), NASAPolynomial(coeffs=[10.4978,0.0247718,-1.16755e-05,2.27968e-09,-1.62169e-13,-50281,-17.9495], Tmin=(1041.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-403.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Cs_P)"""),
)

species(
    label = 'C[C](O)O[C](O)F(2334)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0886,0.0647044,-7.03671e-05,3.91561e-08,-8.71711e-12,-54471.7,27.7581], Tmin=(100,'K'), Tmax=(1085.63,'K')), NASAPolynomial(coeffs=[13.0107,0.0207773,-9.67323e-06,1.88478e-09,-1.34175e-13,-57060.3,-30.7384], Tmin=(1085.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-453.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFHOO) + radical(Cs_P) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = 'CC([O])OC([O])F(2335)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.208066,'amu*angstrom^2'), symmetry=1, barrier=(4.78385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207999,'amu*angstrom^2'), symmetry=1, barrier=(4.7823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207972,'amu*angstrom^2'), symmetry=1, barrier=(4.7817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95674,0.0521642,-4.08835e-05,-2.15864e-09,2.01639e-11,-45951.2,24.5558], Tmin=(100,'K'), Tmax=(512.736,'K')), NASAPolynomial(coeffs=[5.4339,0.0345707,-1.73023e-05,3.44123e-09,-2.4636e-13,-46433,8.88123], Tmin=(512.736,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFHOO) + radical(CCOJ) + radical(O2sj(Cs-F1sO2sH))"""),
)

species(
    label = '[CH2]C(O)OC([O])F(2336)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {5,S} {12,S}
...
"""),
    E0 = (-396.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,451,553,637,1069,1180,1265,1301,3056,3000,3100,440,815,1455,1000,237.835,241.109,1102.68],'cm^-1')),
        HinderedRotor(inertia=(0.152991,'amu*angstrom^2'), symmetry=1, barrier=(6.16922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.364927,'amu*angstrom^2'), symmetry=1, barrier=(14.9761,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00714636,'amu*angstrom^2'), symmetry=1, barrier=(6.16585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.366832,'amu*angstrom^2'), symmetry=1, barrier=(14.9825,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17317,0.0646136,-7.28097e-05,4.33267e-08,-1.04363e-11,-47615.6,27.0687], Tmin=(100,'K'), Tmax=(1001.47,'K')), NASAPolynomial(coeffs=[11.5194,0.0232896,-1.09149e-05,2.12417e-09,-1.50825e-13,-49687.9,-22.8611], Tmin=(1001.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-396.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(CJCO)"""),
)

species(
    label = 'CC([O])O[C](O)F(2337)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u0 p2 c0 {7,S} {12,S}
...
"""),
    E0 = (-433.312,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,482,586,761,1411,318.014,318.014,318.015,2112.82],'cm^-1')),
        HinderedRotor(inertia=(0.00898782,'amu*angstrom^2'), symmetry=1, barrier=(28.4714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142712,'amu*angstrom^2'), symmetry=1, barrier=(10.2418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.396727,'amu*angstrom^2'), symmetry=1, barrier=(28.4714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142715,'amu*angstrom^2'), symmetry=1, barrier=(10.2418,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5392,0.0595213,-6.52507e-05,4.16336e-08,-1.14237e-11,-52031.5,26.3286], Tmin=(100,'K'), Tmax=(860.033,'K')), NASAPolynomial(coeffs=[7.66733,0.0310197,-1.55406e-05,3.10027e-09,-2.22649e-13,-53085.5,-2.31206], Tmin=(860.033,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFHOO) + radical(CCOJ) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)

species(
    label = '[CH2]C(O)O[C](O)F(2338)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-411.4,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,356.085,357.171],'cm^-1')),
        HinderedRotor(inertia=(0.00226216,'amu*angstrom^2'), symmetry=1, barrier=(10.3677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.293605,'amu*angstrom^2'), symmetry=1, barrier=(26.3848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.29211,'amu*angstrom^2'), symmetry=1, barrier=(26.3859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435002,'amu*angstrom^2'), symmetry=1, barrier=(39.0572,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87021,0.0458782,-3.63304e-05,1.47423e-08,-2.46523e-12,-49402.8,20.9566], Tmin=(100,'K'), Tmax=(1382.78,'K')), NASAPolynomial(coeffs=[10.4245,0.0211329,-9.48722e-06,1.80056e-09,-1.25423e-13,-51768.5,-23.0852], Tmin=(1382.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-411.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
"""),
    E0 = (-604.746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,482,664,788,1296,1923,324.843,324.871,1265.03,1265.03],'cm^-1')),
        HinderedRotor(inertia=(0.0730835,'amu*angstrom^2'), symmetry=1, barrier=(5.48258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0731297,'amu*angstrom^2'), symmetry=1, barrier=(5.48264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458449,'amu*angstrom^2'), symmetry=1, barrier=(34.4159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24125,0.0448829,-3.5505e-05,1.57624e-08,-3.25729e-12,-72676.1,22.5621], Tmin=(100,'K'), Tmax=(1036.61,'K')), NASAPolynomial(coeffs=[5.73441,0.031404,-1.60009e-05,3.21915e-09,-2.32262e-13,-73400.3,5.58394], Tmin=(1036.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-604.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(COFOO) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-618.863,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,482,664,788,1296,1923,180,180,902.425],'cm^-1')),
        HinderedRotor(inertia=(0.0915861,'amu*angstrom^2'), symmetry=1, barrier=(2.10575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00369908,'amu*angstrom^2'), symmetry=1, barrier=(2.13994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.953494,'amu*angstrom^2'), symmetry=1, barrier=(21.9227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.953725,'amu*angstrom^2'), symmetry=1, barrier=(21.928,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42586,0.0565434,-5.67793e-05,2.88426e-08,-5.88688e-12,-74339.2,25.2491], Tmin=(100,'K'), Tmax=(1174.11,'K')), NASAPolynomial(coeffs=[12.3687,0.0192629,-9.15109e-06,1.799e-09,-1.28579e-13,-76908.9,-29.3004], Tmin=(1174.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-618.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(COFOO) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=C(F)OCO(552)'],
    products = ['CC(O)OC(=O)F(569)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2O(3)', 'C=COC(=O)F(2122)'],
    products = ['CC(O)OC(=O)F(569)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)O[C](O)F(2338)'],
    products = ['CC(O)OC(=O)F(569)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(O)O[C]=O(2339)'],
    products = ['CC(O)OC(=O)F(569)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(=O)F(332)', 'C[CH]O(148)'],
    products = ['CC(O)OC(=O)F(569)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'C[CH]OC(=O)F(2196)'],
    products = ['CC(O)OC(=O)F(569)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'CC([O])OC(=O)F(2340)'],
    products = ['CC(O)OC(=O)F(569)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'O=C(F)O[CH]O(2246)'],
    products = ['CC(O)OC(=O)F(569)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C[C](O)OC(=O)F(2341)'],
    products = ['CC(O)OC(=O)F(569)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(O)OC(=O)F(2342)'],
    products = ['CC(O)OC(=O)F(569)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC(O)OC(=O)F(569)'],
    products = ['O=C(O)F(336)', 'CH3CHO(36)'],
