...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]O(178)', '[CH]=C=C(5584)'],
    products = ['C=C=CC(=O)O(6403)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[CH2]C#CC(=O)O(6739)'],
    products = ['C=C=CC(=O)O(6403)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', 'C#C[CH]C(=O)O(6740)'],
    products = ['C=C=CC(=O)O(6403)'],
