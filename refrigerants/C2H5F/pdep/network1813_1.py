...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=[C]OC(=O)O(1918)'],
    products = ['C=C(F)OC(=O)O(554)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C(=O)O(163)', 'CH2CF(69)'],
    products = ['C=C(F)OC(=O)O(554)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=C(F)O[C]=O(1293)'],
    products = ['C=C(F)OC(=O)O(554)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(F)OC(=O)O(1920)'],
    products = ['C=C(F)OC(=O)O(554)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(25)', 'O=C(O)[O+]=[C-]F(1924)'],
    products = ['C=C(F)OC(=O)O(554)'],
