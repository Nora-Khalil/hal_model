...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(271)', '[O]C(F)[CH]F(1552)'],
    products = ['C=[C]OC(F)[CH]F(5073)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'C=[C]OC(F)=CF(6075)'],
    products = ['C=[C]OC(F)[CH]F(5073)'],
    transitionState = 'TS9',
