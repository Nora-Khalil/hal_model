...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C(=O)[C](F)F(4591)'],
    products = ['C=C([O])C([O])(F)F(7402)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C([O])(F)F(7759)'],
    products = ['C=C([O])C([O])(F)F(7402)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(=O)C(=O)F(1451)'],
    products = ['C=C([O])C([O])(F)F(7402)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[O]C(F)(F)[C]=O(7161)'],
    products = ['C=C([O])C([O])(F)F(7402)'],
