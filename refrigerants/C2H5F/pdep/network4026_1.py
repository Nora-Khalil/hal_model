...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32066,0.040265,-2.74415e-05,8.50222e-09,-1.0596e-12,-23781.7,18.5174], Tmin=(100,'K'), Tmax=(1765.04,'K')), NASAPolynomial(coeffs=[11.2374,0.0200574,-1.02682e-05,2.01575e-09,-1.40851e-13,-26929.3,-29.5672], Tmin=(1765.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-198.203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCsCdF) + group(Cds-OdOsH) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(Cs-Cd(F)-Cd)"""),
)

species(
    label = 'O=COC1C=C1F(8576)',
...
"""),
    E0 = (-229.605,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,323,467,575,827,1418,2782.5,750,1395,475,1775,1000,638.702,638.707,638.713,638.722,638.723,638.727,638.729],'cm^-1')),
        HinderedRotor(inertia=(0.000413249,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000413231,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3613.6,'J/mol'), sigma=(5.59364,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=564.44 K, Pc=46.85 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-1.75407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,323,467,575,827,1418,1855,455,950,180,180,180,736.07,736.207,736.516,738.962],'cm^-1')),
        HinderedRotor(inertia=(0.0096407,'amu*angstrom^2'), symmetry=1, barrier=(3.72292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00968766,'amu*angstrom^2'), symmetry=1, barrier=(3.72895,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00515,0.0488836,-5.71704e-05,3.77611e-08,-1.06199e-11,-143.457,18.3102], Tmin=(100,'K'), Tmax=(842.786,'K')), NASAPolynomial(coeffs=[7.26938,0.0239003,-1.27078e-05,2.59225e-09,-1.88286e-13,-1030.84,-6.18661], Tmin=(842.786,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.75407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCsCdF) + group(Cds-OdOsH) + ring(Cs-Cd(F)-Cd) + radical((O)CJOC) + longDistanceInteraction_cyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'O=[C]OC1C=C1F(8653)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 O u0 p2 c0 {4,S} {7,S}
3 O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9282,0.0470312,-4.56818e-05,2.36808e-08,-5.06906e-12,-5845.05,21.7366], Tmin=(100,'K'), Tmax=(1105.93,'K')), NASAPolynomial(coeffs=[9.31679,0.0203076,-9.43554e-06,1.83106e-09,-1.29807e-13,-7479.29,-14.6529], Tmin=(1105.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.2087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cs(F)-Cs-Cs(O2)) + radical(C2CsJOC(O)H) + radical((O)CJOCC2)"""),
)

species(
    label = 'O=[C]OC1[CH]C1F(8574)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-21.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,212,367,445,1450,2782.5,750,1395,475,1775,1000,180,180,880.837,880.937,881.186,881.352,881.604,881.817],'cm^-1')),
        HinderedRotor(inertia=(0.00812333,'amu*angstrom^2'), symmetry=1, barrier=(4.4831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00812335,'amu*angstrom^2'), symmetry=1, barrier=(4.48099,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
...
"""),
    E0 = (12.6648,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,212,367,445,1450,2782.5,750,1395,475,1775,1000,598.42,598.657,598.783,599.034,599.091,601.407,601.864,601.928],'cm^-1')),
        HinderedRotor(inertia=(0.000469717,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00046374,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85484,0.0376101,-8.13224e-06,-1.63565e-08,8.40686e-12,1608.67,23.1916], Tmin=(100,'K'), Tmax=(1058.86,'K')), NASAPolynomial(coeffs=[12.7529,0.016847,-7.62606e-06,1.52512e-09,-1.12205e-13,-1843.15,-35.4101], Tmin=(1058.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.6648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-O2sCsH)(Cs-CsHH)(F1s)_ring) + radical(Csj(Cs-O2sCsH)(Cs-CsF1sH)(H)_ring)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(136)', '[O]C1C[C]1F(12879)'],
    products = ['O=[C]OC1C[C]1F(8656)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['C=C(F)[CH]O[C]=O(10498)'],
    products = ['O=[C]OC1C[C]1F(8656)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[O]C1C[C]1F(12879)'],
    products = ['O=[C]OC1C[C]1F(8656)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['O=[C]OC1C[C]1F(8656)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(5.33888e+13,'m^3/(mol*s)'), n=-2.06969, Ea=(149.345,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.21909771748945858, var=15.050572460742625, Tref=1000.0, N=2985, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    products = ['O=[C]OC1C[C]1F(8656)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(7.99722,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'O=[C]OC1=C(F)C1(12880)'],
    products = ['O=[C]OC1C[C]1F(8656)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', 'O=[C]OC1C=C1F(8653)'],
    products = ['O=[C]OC1C[C]1F(8656)'],
