...
species(
    label = '[CH2]C([CH2])(F)C(=O)OF(10683)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C)(F)C(=O)OF(10663)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[CH2]C(C)(F)OF(2912)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['FOF(1637)', 'C=C(C)[C]=O(6913)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C)=C(OF)OF(10675)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)=C(OC)OF(10676)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(T)(18)', 'C[C](F)C(=O)OF(2601)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]C(C)(F)C(=O)OF-2(10677)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=C(C)C(=O)OF(6702)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'C=C(F)C(=O)OF(3977)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OF(331)', 'C=C(C)F(1325)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2][C](C)C(=O)OF(10680)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[CH2]C(C)(F)C([O])=O(10681)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(160)', '[CH2]C(C)(F)[C]=O(10682)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(19)', '[CH2][C](F)C(=O)OF(3983)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]OF(331)', '[CH2][C](C)F(10566)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH2]C([CH2])(F)C(=O)OF(10683)'],
    products = ['[CH2]C(C)(F)C(=O)OF(10663)'],
...
network(
    label = 'PDepNetwork #3806',
    isomers = [
        '[CH2]C(C)(F)C(=O)OF(10663)',
    ],
    reactants = [
