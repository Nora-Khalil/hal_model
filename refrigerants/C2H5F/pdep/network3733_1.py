...
"""),
    ...
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.56818,0.0275729,-4.86541e-06,-6.21488e-09,2.422e-12,-16511.6,17.8294], Tmin=(100,'K'), Tmax=(1337.4,'K')), NASAPolynomial(coeffs=[7.70289,0.0221581,-9.94356e-06,1.87519e-09,-1.29367e-13,-18774.2,-11.7597], Tmin=(1337.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsCs) + ring(Cyclobutanone) + radical(CsCsCsF1s)"""),
)

species(
    label = '[CH2]C1(F)CC1=O(11707)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,D}
...
"""),
    ...
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82325,0.0507365,-5.66871e-05,3.50332e-08,-8.94456e-12,-1011.53,17.8818], Tmin=(100,'K'), Tmax=(938.936,'K')), NASAPolynomial(coeffs=[8.667,0.0215809,-1.0109e-05,1.96135e-09,-1.38817e-13,-2296.68,-14.7041], Tmin=(938.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(CO(O2d)-Cs-Cs(F)) + radical(CJC(C)C=O) + longDistanceInteraction_cyclic(Cs(F)-CO)"""),
)
...
"""),
    ...
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24328,0.0439967,-3.78304e-05,1.71827e-08,-3.4032e-12,-21582,17.2237], Tmin=(100,'K'), Tmax=(1128.56,'K')), NASAPolynomial(coeffs=[7.44629,0.0255556,-1.33199e-05,2.70386e-09,-1.95854e-13,-22756.4,-8.50708], Tmin=(1128.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)

species(
    label = '[CH]=C(F)CC=O(11708)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (-43.3766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,246,474,533,1155,2782.5,750,1395,475,1775,1000,3120,650,792.5,1650,648.526],'cm^-1')),
        HinderedRotor(inertia=(0.0109434,'amu*angstrom^2'), symmetry=1, barrier=(3.26541,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.927101,'amu*angstrom^2'), symmetry=1, barrier=(21.3159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02699,0.0376753,-2.10233e-05,2.87645e-09,5.09314e-13,-5141.34,19.4945], Tmin=(100,'K'), Tmax=(1411.6,'K')), NASAPolynomial(coeffs=[12.8421,0.0164619,-8.50509e-06,1.6983e-09,-1.20424e-13,-9134.48,-39.7393], Tmin=(1411.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.3766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]C(=C)F(2402)'],
    products = ['C=C(F)C[C]=O(1144)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C=C(F)C[C]=O(1144)'],
    products = ['[CH2]C1(F)CC1=O(11707)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.62453e+10,'s^-1'), n=0.5217, Ea=(134.798,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_CO]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction9',
    reactants = ['CH2CF(69)', '[CH2][C]=O(140)'],
    products = ['C=C(F)C[C]=O(1144)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)=C[C]=O(2664)'],
    products = ['C=C(F)C[C]=O(1144)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(2.88633e+07,'m^3/(mol*s)'), n=0.213913, Ea=(5.3251,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=8.197906922440378e-05, var=0.01210657880115639, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(F)C[C]=O(2546)'],
    products = ['C=C(F)C[C]=O(1144)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'C=C=C[C]=O(6565)'],
    products = ['C=C(F)C[C]=O(1144)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(229.901,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'C#CC[C]=O(698)'],
    products = ['C=C(F)C[C]=O(1144)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(1.56721e+32,'m^3/(mol*s)'), n=-7.40875, Ea=(307.02,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_3COCdCddCtO2d->Ct"""),
)

reaction(
    label = 'reaction14',
    reactants = ['C=C(F)C[C]=O(1144)'],
    products = ['[CH2]C(F)=CC=O(10567)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C]CC(=O)F(6812)'],
    products = ['C=C(F)C[C]=O(1144)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(211.94,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
