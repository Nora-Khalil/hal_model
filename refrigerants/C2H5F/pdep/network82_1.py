...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C[O](171)'],
    products = ['[CH2]CC[O](283)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](318)', '[CH2][CH2](132)'],
    products = ['[CH2]CC[O](283)'],
