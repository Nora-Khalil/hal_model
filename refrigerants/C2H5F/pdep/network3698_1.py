...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31848,0.0649019,-6.19718e-05,3.27475e-08,-7.46754e-12,-40651.9,25.0254], Tmin=(100,'K'), Tmax=(1013.17,'K')), NASAPolynomial(coeffs=[8.92056,0.0348882,-1.75356e-05,3.5078e-09,-2.52468e-13,-42192.3,-11.7495], Tmin=(1013.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-338.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJ)"""),
)
...
"""),
    E0 = (-185.928,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,3000,3100,440,815,1455,1000,180,1066.53],'cm^-1')),
        HinderedRotor(inertia=(0.193529,'amu*angstrom^2'), symmetry=1, barrier=(4.44961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193686,'amu*angstrom^2'), symmetry=1, barrier=(4.45322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6505,'amu*angstrom^2'), symmetry=1, barrier=(37.9482,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.818917,'amu*angstrom^2'), symmetry=1, barrier=(18.8285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33149,0.0334122,-2.09883e-05,6.59813e-09,-8.46826e-13,12195.8,19.2773], Tmin=(100,'K'), Tmax=(1761.91,'K')), NASAPolynomial(coeffs=[9.74216,0.0165879,-6.66488e-06,1.17845e-09,-7.78141e-14,9584.46,-20.6723], Tmin=(1761.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(CJCC=C=O)"""),
)
...
"""),
    E0 = (-49.0268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,145,326,398,834,1303,3000,3100,440,815,1455,1000,2120,512.5,787.5,463.909],'cm^-1')),
        HinderedRotor(inertia=(0.000619063,'amu*angstrom^2'), symmetry=1, barrier=(4.56449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17705,'amu*angstrom^2'), symmetry=1, barrier=(27.0627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11418,0.0433753,-4.0548e-05,2.09825e-08,-4.57654e-12,-5830.24,20.6073], Tmin=(100,'K'), Tmax=(1074.81,'K')), NASAPolynomial(coeffs=[8.04501,0.0213032,-9.74407e-06,1.87589e-09,-1.32341e-13,-7105.14,-8.4334], Tmin=(1074.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.0268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cd(Cdd-Od)CF) + missing(Cdd-CdO2d) + radical(CJCC=C=O)"""),
)

species(
    label = '[CH2]CC=C(OF)OF(10386)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.106581,'amu*angstrom^2'), symmetry=1, barrier=(2.45052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111218,'amu*angstrom^2'), symmetry=1, barrier=(2.55712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110606,'amu*angstrom^2'), symmetry=1, barrier=(2.54306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00613186,'amu*angstrom^2'), symmetry=1, barrier=(2.62051,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.491673,0.0862455,-0.000139723,1.25752e-07,-4.44425e-11,16764.1,29.0348], Tmin=(100,'K'), Tmax=(827.38,'K')), NASAPolynomial(coeffs=[7.64693,0.0352621,-1.75764e-05,3.38773e-09,-2.34164e-13,16141.2,-0.73887], Tmin=(827.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(RCCJ)"""),
)

species(
    label = '[CH2]COC(=CF)OF(10387)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-138.246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,287.858,287.859,287.866,1384.72],'cm^-1')),
        HinderedRotor(inertia=(0.161043,'amu*angstrom^2'), symmetry=1, barrier=(9.46924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161037,'amu*angstrom^2'), symmetry=1, barrier=(9.46924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00203457,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.59184,'amu*angstrom^2'), symmetry=1, barrier=(34.8005,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.157322,0.0917072,-0.000142642,1.20271e-07,-4.04637e-11,-16495.6,26.8257], Tmin=(100,'K'), Tmax=(792.432,'K')), NASAPolynomial(coeffs=[10.8822,0.0310747,-1.55739e-05,3.0255e-09,-2.10865e-13,-17991.4,-21.1337], Tmin=(792.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CJCO)"""),
)
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2798,0.0500846,-1.27295e-05,-2.4444e-08,1.51313e-11,-32525.7,21.1971], Tmin=(100,'K'), Tmax=(917.17,'K')), NASAPolynomial(coeffs=[13.9721,0.020289,-5.8005e-06,9.03132e-10,-5.96893e-14,-35928.9,-44.799], Tmin=(917.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-271.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Tetrahydrofuran) + radical(Cs_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0825741,'amu*angstrom^2'), symmetry=1, barrier=(1.89854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0825132,'amu*angstrom^2'), symmetry=1, barrier=(1.89714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.082374,'amu*angstrom^2'), symmetry=1, barrier=(1.89394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524243,'amu*angstrom^2'), symmetry=1, barrier=(12.0534,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.274487,0.0891824,-0.000139669,1.18765e-07,-4.00879e-11,-24060,28.0537], Tmin=(100,'K'), Tmax=(809.655,'K')), NASAPolynomial(coeffs=[10.338,0.0307247,-1.51754e-05,2.9246e-09,-2.02631e-13,-25403.1,-16.6029], Tmin=(809.655,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs) + radical(RCCJ)"""),
)

species(
    label = 'O=C([CH]F)OF(2600)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {3,S}
3 O u0 p2 c0 {2,S} {5,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53269,0.0600382,-5.6206e-05,2.86121e-08,-6.27844e-12,-50112.8,22.2736], Tmin=(100,'K'), Tmax=(1047.34,'K')), NASAPolynomial(coeffs=[8.79898,0.0322862,-1.64588e-05,3.31113e-09,-2.38972e-13,-51634.8,-13.1179], Tmin=(1047.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-417.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8564,0.0516533,-4.23887e-05,1.91366e-08,-3.7975e-12,5710.08,25.099], Tmin=(100,'K'), Tmax=(1128.41,'K')), NASAPolynomial(coeffs=[7.67364,0.0310321,-1.49764e-05,2.94111e-09,-2.09336e-13,4397.25,-3.6685], Tmin=(1128.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.8664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(F)C([O])=O(10392)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u1 p2 c0 {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-53.4786,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,255,365,576,1163,1267,1448,3060,3000,3100,440,815,1455,1000,1855,455,950,287.944],'cm^-1')),
        HinderedRotor(inertia=(0.123536,'amu*angstrom^2'), symmetry=1, barrier=(7.30829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00234567,'amu*angstrom^2'), symmetry=1, barrier=(7.28183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.445849,'amu*angstrom^2'), symmetry=1, barrier=(26.5672,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95179,0.0494431,-5.62815e-05,4.18703e-08,-1.38835e-11,-6362.27,21.4552], Tmin=(100,'K'), Tmax=(712.456,'K')), NASAPolynomial(coeffs=[5.47677,0.0296538,-1.46202e-05,2.88924e-09,-2.06038e-13,-6864.58,5.64399], Tmin=(712.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.4786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(COj(Cs-F1sCsH)(O2d))"""),
)
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37614,0.0622579,-6.08127e-05,3.21189e-08,-7.16838e-12,-21846,25.313], Tmin=(100,'K'), Tmax=(1046.86,'K')), NASAPolynomial(coeffs=[9.72676,0.0303508,-1.50948e-05,3.00474e-09,-2.15695e-13,-23594.4,-15.3564], Tmin=(1046.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.392,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CsCOCsF1s) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(F)C(=O)OF(10394)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {7,S}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45529,0.0604818,-5.65962e-05,2.80383e-08,-5.86471e-12,-16613.1,27.0226], Tmin=(100,'K'), Tmax=(1108.28,'K')), NASAPolynomial(coeffs=[9.97789,0.0297219,-1.4964e-05,2.99495e-09,-2.15527e-13,-18502.1,-14.9701], Tmin=(1108.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJCC=O) + radical(RCCJ)"""),
)

species(
    label = 'C=C[CH]C(=O)OF(6975)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {6,S}
3  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24967,0.0671298,-8.76944e-05,7.96034e-08,-3.15193e-11,-77079.5,24.4015], Tmin=(100,'K'), Tmax=(716.867,'K')), NASAPolynomial(coeffs=[4.21468,0.0432273,-2.22831e-05,4.45409e-09,-3.18348e-13,-77315.5,12.4027], Tmin=(716.867,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-641.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC(F)C(=O)OF(10369)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[CH2]CC(F)OF(2190)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C([C]F)OF(2591)', 'C2H5(32)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(1637)', '[CH2]CC=C=O(406)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(169)', '[CH2]CC(F)=C=O(10385)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]CC=C(OF)OF(10386)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(18)', '[CH2]C(F)C(=O)OF(2602)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]CC(F)C(=O)OF-2(10388)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC(F)=C(O)OF(10391)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C([CH]F)OF(2600)', 'C2H4(30)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=CC(F)C(=O)OF(9661)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C[CH]C(=O)OF(6967)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]CC(F)C([O])=O(10392)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(160)', '[CH2]CC(F)[C]=O(10393)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C([CH]F)OF(2600)', '[CH2][CH2](138)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH2]C[C](F)C(=O)OF(9854)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH2][CH]C(F)C(=O)OF(10394)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=C[CH]C(=O)OF(6975)'],
    products = ['[CH2]CC(F)C(=O)OF(10369)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC(F)C(=O)OF(10369)'],
    products = ['C[CH]C(F)C(=O)OF(10373)'],
...
network(
    label = 'PDepNetwork #3698',
    isomers = [
        '[CH2]CC(F)C(=O)OF(10369)',
    ],
    reactants = [
