...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.21318,'amu*angstrom^2'), symmetry=1, barrier=(27.8934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21321,'amu*angstrom^2'), symmetry=1, barrier=(27.8942,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-379.545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,318,348,354,414,366,530,521,695,1154,1354,1414,1546,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
...
"""),
    E0 = (-206.891,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,316,385,515,654,689,1295,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,259.668,260.872],'cm^-1')),
        HinderedRotor(inertia=(0.149598,'amu*angstrom^2'), symmetry=1, barrier=(7.07579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146714,'amu*angstrom^2'), symmetry=1, barrier=(7.06636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148334,'amu*angstrom^2'), symmetry=1, barrier=(7.07291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146854,'amu*angstrom^2'), symmetry=1, barrier=(7.07448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.526504,'amu*angstrom^2'), symmetry=1, barrier=(25.4217,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.20559,0.0942324,-0.000126386,7.14544e-08,-4.38593e-12,-24757,27.6414], Tmin=(100,'K'), Tmax=(580.251,'K')), NASAPolynomial(coeffs=[12.1512,0.0316561,-1.57311e-05,3.04308e-09,-2.11542e-13,-26476.1,-26.3553], Tmin=(580.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJO) + radical(CJCO)"""),
)
...
"""),
    E0 = (-361.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,316,385,515,654,689,1295,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,3000,3100,440,815,1455,1000,200.007],'cm^-1')),
        HinderedRotor(inertia=(0.209204,'amu*angstrom^2'), symmetry=1, barrier=(5.39494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192879,'amu*angstrom^2'), symmetry=1, barrier=(5.37113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188966,'amu*angstrom^2'), symmetry=1, barrier=(5.3808,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19826,'amu*angstrom^2'), symmetry=1, barrier=(27.9721,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH2]C(F)(OF)C(O)F(5847)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', '[CH2]C(F)(OF)C(=C)F(7619)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(18)', 'CC(O)(F)[C](F)OF(5821)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]C(F)(OF)C(C)(O)F(7620)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2][C](OF)C(C)(O)F(7621)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', '[CH2]C(F)(OF)[C](C)F(2920)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(160)', '[CH2][C](F)C(C)(O)F(5211)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C](F)OF(1348)', 'C[C](O)F(1910)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH3(19)', '[CH2]C(F)(OF)[C](O)F(7622)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', '[CH2]C(F)(OF)C(C)=O(5776)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(159.08,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(91.2797,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction24',
    reactants = ['F2(77)', '[CH2]C(OF)=C(C)O(3630)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', '[CH2]C(F)(OF)C(=C)O(5813)'],
    products = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(210.641,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)

reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(F)(OF)C(C)(O)F(5867)'],
    products = ['HF(38)', 'CH2CFO(78)', 'C=C(O)F(498)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(37.3828,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(217.617,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
