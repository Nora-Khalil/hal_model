...
reaction(
    label = 'reaction1',
    reactants = ['C=C(C)O[O](6634)'],
    products = ['HO2(11)', 'C=C=C(6556)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=CO[O](502)'],
    products = ['C=C(C)O[O](6634)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]C(=C)O[O](6342)'],
    products = ['C=C(C)O[O](6634)'],
    transitionState = 'TS8',
