...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(O)[CH]F(1572)'],
    products = ['HO2(11)', 'O=C[CH]F(1529)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['O(7)', '[O]C(O)[CH]F(1559)'],
    products = ['[O]OC(O)[CH]F(1572)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(181)', '[O]O[CH]O(391)'],
    products = ['[O]OC(O)[CH]F(1572)'],
    transitionState = 'TS4',
