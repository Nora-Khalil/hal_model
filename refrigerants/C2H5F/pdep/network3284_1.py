...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.726091,0.0681032,-6.64904e-05,3.3331e-08,-6.65161e-12,-63416.5,23.0639], Tmin=(100,'K'), Tmax=(1211.93,'K')), NASAPolynomial(coeffs=[14.8323,0.0215452,-8.86585e-06,1.63255e-09,-1.12768e-13,-66835.7,-47.702], Tmin=(1211.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-528.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(CdCFF)"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71466,0.0527081,-4.00937e-05,1.73853e-08,-3.32887e-12,-30853,24.5849], Tmin=(100,'K'), Tmax=(1168.73,'K')), NASAPolynomial(coeffs=[7.57528,0.03265,-1.43503e-05,2.70079e-09,-1.87732e-13,-32222.9,-4.60298], Tmin=(1168.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCsCsFF) + group(Cs-CsHHH) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(Tertalkyl) + radical(Isobutyl) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F))"""),
)

species(
    label = '[CH2]C1([CH]F)CC1(F)F(9207)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.840089,0.0644986,-5.51536e-05,2.33886e-08,-3.96663e-12,-23652.3,25.8181], Tmin=(100,'K'), Tmax=(1400.95,'K')), NASAPolynomial(coeffs=[15.6047,0.022342,-1.00159e-05,1.90877e-09,-1.33498e-13,-27789.2,-50.3904], Tmin=(1400.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-197.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-CsCsHH) + group(CsCsCsFF) + group(Cs-CsHHH) + group(CsCsFHH) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(Neopentyl) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (-376.783,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,182,240,577,636,1210,1413,340.542],'cm^-1')),
        HinderedRotor(inertia=(0.283798,'amu*angstrom^2'), symmetry=1, barrier=(23.3479,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.389954,'amu*angstrom^2'), symmetry=1, barrier=(32.0937,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437423,0.068946,-6.93073e-05,3.4292e-08,-6.57389e-12,-45180.3,24.3841], Tmin=(100,'K'), Tmax=(1282.66,'K')), NASAPolynomial(coeffs=[18.0749,0.0139431,-4.98425e-06,8.5983e-10,-5.7682e-14,-49704.9,-65.0971], Tmin=(1282.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-376.783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(CdCFF) + radical(Allyl_P)"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28408,0.0647908,-6.42102e-05,3.57172e-08,-8.49626e-12,-40068.3,25.2034], Tmin=(100,'K'), Tmax=(982.733,'K')), NASAPolynomial(coeffs=[8.99425,0.0334091,-1.6312e-05,3.225e-09,-2.30714e-13,-41583.7,-11.8597], Tmin=(982.733,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-333.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(CsCFFH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Csj(Cd-CsCd)(F1s)(H)) + radical(Csj(Cd-CdH)(F1s)(F1s))"""),
)

species(
    label = 'CC(=[C]F)C[C](F)F(9211)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-205.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,190,488,555,1236,1407,167,640,1190,310.587,310.606],'cm^-1')),
        HinderedRotor(inertia=(0.00174749,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15,'amu*angstrom^2'), symmetry=1, barrier=(10.2701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150019,'amu*angstrom^2'), symmetry=1, barrier=(10.2701,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.959593,0.0714659,-8.24221e-05,5.2556e-08,-1.3848e-11,-24669.3,26.7668], Tmin=(100,'K'), Tmax=(910.851,'K')), NASAPolynomial(coeffs=[10.3535,0.0302134,-1.44882e-05,2.83493e-09,-2.01428e-13,-26380.6,-17.6764], Tmin=(910.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-205.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Csj(Cs-CdHH)(F1s)(F1s)) + radical(Cdj(Cd-CsCs)(F1s))"""),
)

species(
    label = 'C=C([C]F)CC(F)F(9212)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-270.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,350,440,435,1725,2950,3100,1380,975,1025,1650,364.393,364.649,366.111,367.608,1506.28],'cm^-1')),
        HinderedRotor(inertia=(0.0995837,'amu*angstrom^2'), symmetry=1, barrier=(9.57519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217614,'amu*angstrom^2'), symmetry=1, barrier=(20.9545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102662,'amu*angstrom^2'), symmetry=1, barrier=(9.61549,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00529,0.0717951,-8.45174e-05,5.62031e-08,-1.56686e-11,-32472.3,24.5949], Tmin=(100,'K'), Tmax=(857.327,'K')), NASAPolynomial(coeffs=[9.34439,0.0328889,-1.64483e-05,3.27361e-09,-2.34593e-13,-33902.3,-14.353], Tmin=(857.327,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-270.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88463,0.05236,-4.18152e-05,2.18177e-08,-5.75737e-12,-32346,22.9651], Tmin=(100,'K'), Tmax=(814.771,'K')), NASAPolynomial(coeffs=[4.29527,0.040525,-2.00265e-05,3.98922e-09,-2.86857e-13,-32738.8,11.829], Tmin=(814.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-269.531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsCsFF) + group(CsCsFHH) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=CF)C[C](F)F(8555)'],
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(3442)', '[CH2]C([CH2])=CF(6739)'],
    products = ['[CH2]C(=CF)C[C](F)F(8555)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=CF)C[C](F)F(8555)'],
    products = ['[CH2][C]1CC(F)(F)C1F(9206)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(=CF)C[C](F)F(8555)'],
    products = ['[CH2]C1([CH]F)CC1(F)F(9207)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(C=C(F)F)=CF(9208)'],
    products = ['[CH2]C(=CF)C[C](F)F(8555)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C([CH2])=CF(6739)'],
    products = ['[CH2]C(=CF)C[C](F)F(8555)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]F(837)', 'C=[C]C[C](F)F(4530)'],
    products = ['[CH2]C(=CF)C[C](F)F(8555)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(=CF)C[C](F)F(8555)'],
    products = ['F[CH][C]1CC(F)(F)C1(9217)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CHF(40)', 'C=[C]C[C](F)F(4530)'],
    products = ['[CH2]C(=CF)C[C](F)F(8555)'],
