...
reaction(
    label = 'reaction2',
    reactants = ['H(5)', '[C]=COOC#C(2419)'],
    products = ['[CH]=COOC#C(1250)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['C#CO[O](1059)', '[CH]=[CH](135)'],
    products = ['[CH]=COOC#C(1250)'],
    transitionState = 'TS9',
