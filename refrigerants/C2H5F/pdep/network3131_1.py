...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.257481,'amu*angstrom^2'), symmetry=1, barrier=(5.92,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256662,'amu*angstrom^2'), symmetry=1, barrier=(5.90116,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94856,0.0498493,-7.07615e-05,6.26586e-08,-2.28053e-11,-10477.9,20.525], Tmin=(100,'K'), Tmax=(788.116,'K')), NASAPolynomial(coeffs=[5.21112,0.0263515,-1.28319e-05,2.48434e-09,-1.73528e-13,-10776.7,6.92911], Tmin=(788.116,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.6945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17951,0.0449206,-5.84155e-05,5.46957e-08,-2.17005e-11,-6475.55,15.2484], Tmin=(100,'K'), Tmax=(770.444,'K')), NASAPolynomial(coeffs=[3.09347,0.0315352,-1.55332e-05,3.03352e-09,-2.13453e-13,-6359.94,12.7416], Tmin=(770.444,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.3464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + ring(12dioxetane) + radical(C2CsJOO)"""),
)

species(
    label = '[CH2]C1(CF)OO1(10023)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    ...
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64173,0.0311223,3.72674e-05,-8.96698e-08,4.216e-11,-8245.43,20.7893], Tmin=(100,'K'), Tmax=(913.639,'K')), NASAPolynomial(coeffs=[22.063,-0.00383128,5.25397e-06,-1.07672e-09,6.83293e-14,-14249.6,-88.3247], Tmin=(913.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.4234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(CsCsFHH) + group(Cs-CsHHH) + ring(O2s-O2s-Cs(C-F)) + radical(CJCOOH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.312661,'amu*angstrom^2'), symmetry=1, barrier=(7.1887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588219,'amu*angstrom^2'), symmetry=1, barrier=(13.5243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72791,'amu*angstrom^2'), symmetry=1, barrier=(39.728,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95699,0.0517264,-5.70323e-05,2.11461e-08,7.86769e-12,956.59,20.2025], Tmin=(100,'K'), Tmax=(538.97,'K')), NASAPolynomial(coeffs=[6.90295,0.0254568,-1.2969e-05,2.57246e-09,-1.8285e-13,271.853,-2.0081], Tmin=(538.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.39699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(=C)OOF(10025)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (170.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,3429.33],'cm^-1')),
        HinderedRotor(inertia=(0.151784,'amu*angstrom^2'), symmetry=1, barrier=(20.4314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.888773,'amu*angstrom^2'), symmetry=1, barrier=(20.4346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0178564,'amu*angstrom^2'), symmetry=1, barrier=(44.8217,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79935,0.0503384,-5.57345e-05,3.3395e-08,-8.16663e-12,20557.3,20.5504], Tmin=(100,'K'), Tmax=(984.152,'K')), NASAPolynomial(coeffs=[9.34734,0.019661,-8.97827e-06,1.72293e-09,-1.21296e-13,19071.6,-15.7439], Tmin=(984.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C=C(F)O[O](1327)'],
    products = ['C=C(CF)O[O](8412)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]C(=C)O[O](6342)'],
    products = ['C=C(CF)O[O](8412)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(=CF)O[O](8510)'],
    products = ['C=C(CF)O[O](8412)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(CF)O[O](9365)'],
    products = ['C=C(CF)O[O](8412)'],
