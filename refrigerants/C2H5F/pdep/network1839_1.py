...
reaction(
    label = 'reaction4',
    reactants = ['O[C]1CC[C](F)O1(3223)'],
    products = ['C=C(O)OC(=C)F(2858)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(O)OC([CH2])F(3226)'],
    products = ['C=C(O)OC(=C)F(2858)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(F)OC([CH2])O(3227)'],
    products = ['C=C(O)OC(=C)F(2858)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=[C]OC(=C)O(3232)'],
    products = ['C=C(O)OC(=C)F(2858)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2CF(69)', '[CH2]C(=O)O(166)'],
    products = ['C=C(O)OC(=C)F(2858)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'C=[C]OC(=C)F(1160)'],
    products = ['C=C(O)OC(=C)F(2858)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH]=C(O)OC(=C)F(3233)'],
    products = ['C=C(O)OC(=C)F(2858)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH]=C(F)OC(=C)O(3234)'],
    products = ['C=C(O)OC(=C)F(2858)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(25)', 'C=C(O)[O+]=[C-]F(3238)'],
    products = ['C=C(O)OC(=C)F(2858)'],
