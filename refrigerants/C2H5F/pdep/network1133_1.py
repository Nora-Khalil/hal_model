...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', 'O=C[C]F(1763)'],
    products = ['O=[C]OC=[C]F(2533)'],
    transitionState = 'TS2',
