...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.827158,'amu*angstrom^2'), symmetry=1, barrier=(19.018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.827492,'amu*angstrom^2'), symmetry=1, barrier=(19.0257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.827265,'amu*angstrom^2'), symmetry=1, barrier=(19.0204,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2066,0.0537917,-4.29483e-05,9.01246e-09,2.72363e-12,4582.27,21.5102], Tmin=(100,'K'), Tmax=(959.447,'K')), NASAPolynomial(coeffs=[15.676,0.0109911,-3.42995e-06,5.89351e-10,-4.17402e-14,999.194,-51.9005], Tmin=(959.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.2054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFHHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Csj(F1s)(O2s-Cd)(H)) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.25543,'amu*angstrom^2'), symmetry=1, barrier=(28.8647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25108,'amu*angstrom^2'), symmetry=1, barrier=(28.7648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25505,'amu*angstrom^2'), symmetry=1, barrier=(28.8561,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.523,0.044866,-2.14724e-05,-1.46326e-08,1.19724e-11,1173.08,18.1267], Tmin=(100,'K'), Tmax=(922.413,'K')), NASAPolynomial(coeffs=[15.963,0.00730593,-1.14249e-06,1.25147e-10,-9.46428e-15,-2556.89,-56.1502], Tmin=(922.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.93791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CtHHH) + group(CsFHHO) + group(Ct-CtCs) + group(Ct-CtOs) + radical(Csj(F1s)(O2s-Ct)(H))"""),
)
...
"""),
    E0 = (79.2595,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,548,1085,1183,1302,1466,1520,3060,3119,1670,1700,300,440,280.798,280.801,280.802],'cm^-1')),
        HinderedRotor(inertia=(0.262363,'amu*angstrom^2'), symmetry=1, barrier=(14.6804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262374,'amu*angstrom^2'), symmetry=1, barrier=(14.6804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262374,'amu*angstrom^2'), symmetry=1, barrier=(14.6804,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(837)', 'C[C]=C[O](6236)'],
    products = ['C[C]=CO[CH]F(6132)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'C=C=CO[CH]F(6312)'],
    products = ['C[C]=CO[CH]F(6132)'],
    transitionState = 'TS6',
