...
"""),
    E0 = (141.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,122,584,932,1043,1247,1392,1461,2986,3039,3010,987.5,1337.5,450,1655,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.696038,'amu*angstrom^2'), symmetry=1, barrier=(16.0033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.696071,'amu*angstrom^2'), symmetry=1, barrier=(16.004,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06881,0.0421828,-4.10841e-05,2.06632e-08,-4.20165e-12,17139.1,21.7162], Tmin=(100,'K'), Tmax=(1175.67,'K')), NASAPolynomial(coeffs=[9.91308,0.0154941,-7.03281e-06,1.35429e-09,-9.57072e-14,15294.7,-17.3973], Tmin=(1175.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cdj(Cs-F1sHH)(Cd-O2sH))"""),
)
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76495,0.0474674,-5.02854e-05,2.68305e-08,-5.65416e-12,-8977.81,19.654], Tmin=(100,'K'), Tmax=(1154.02,'K')), NASAPolynomial(coeffs=[11.6584,0.0131753,-5.71225e-06,1.08099e-09,-7.59158e-14,-11261.2,-29.4932], Tmin=(1154.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cds-CdsOsH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (123.691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,319,1023,1071,1259,1317,1409,3054,3019,2100,2250,500,550,180],'cm^-1')),
        HinderedRotor(inertia=(0.939628,'amu*angstrom^2'), symmetry=1, barrier=(21.6039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.50781,'amu*angstrom^2'), symmetry=1, barrier=(57.6595,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06312,0.0457046,-6.65797e-05,5.41812e-08,-1.7506e-11,14943.4,19.6512], Tmin=(100,'K'), Tmax=(855.046,'K')), NASAPolynomial(coeffs=[7.15275,0.0169612,-7.50045e-06,1.36985e-09,-9.18992e-14,14253.4,-3.05164], Tmin=(855.046,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(ROOJ)"""),
)
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08182,0.0482312,-7.80601e-05,7.28758e-08,-2.64782e-11,16669.8,23.4877], Tmin=(100,'K'), Tmax=(841.274,'K')), NASAPolynomial(coeffs=[4.60937,0.023542,-1.14453e-05,2.18279e-09,-1.49862e-13,16692.9,14.3957], Tmin=(841.274,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C=CJO)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.83957,0.0165872,4.53751e-06,-1.80202e-08,8.43464e-12,-6917.92,9.97299], Tmin=(10,'K'), Tmax=(861.674,'K')), NASAPolynomial(coeffs=[4.88678,0.0185406,-1.07259e-05,2.96718e-09,-3.17421e-13,-7351.38,3.60868], Tmin=(861.674,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-57.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), label="""ODCD[C]CF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79596,0.0440972,-3.90397e-05,1.68101e-08,-2.86278e-12,45176.6,22.0511], Tmin=(100,'K'), Tmax=(1407.35,'K')), NASAPolynomial(coeffs=[12.7101,0.013077,-5.97766e-06,1.14859e-09,-8.07204e-14,42104.6,-34.333], Tmin=(1407.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sFO) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJO) + radical(Cds_S)"""),
)

species(
    label = 'C=C(F)[CH]O[O](9199)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {3,S} {5,S}
3 O u1 p2 c0 {2,S}
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C=[C]CF(11198)'],
    products = ['[O]OC=[C]CF(11099)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.30161e+09,'s^-1'), n=1.08, Ea=(148.641,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2OO;Y_rad_intra;OOJ] for rate rule [R2OO_D;Cd_rad_in/NonDeC;OOJ]
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C=CO[O](6364)'],
    products = ['[O]OC=[C]CF(11099)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(66.31,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]OC=C=CF(9143)'],
    products = ['[O]OC=[C]CF(11099)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C][CH]OOF(9198)'],
    products = ['[O]OC=[C]CF(11099)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(101.482,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction16',
    reactants = ['[O]OC=[C]CF(11099)'],
    products = ['C=C(F)[CH]O[O](9199)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(86.9209,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)
