...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', '[CH]C(O)OC#C-2(2350)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', 'C#CO[CH]O(2351)'],
    products = ['C#COC(O)[CH]F(1809)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', 'C#COC(O)[C]F(2352)'],
    products = ['C#COC(O)[CH]F(1809)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['HCCO(21)', 'O[CH][CH]F(1318)'],
    products = ['C#COC(O)[CH]F(1809)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H(22)', '[O]C(O)[CH]F(1790)'],
    products = ['C#COC(O)[CH]F(1809)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C#CO[CH][CH]F(2357)'],
    products = ['C#COC(O)[CH]F(1809)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#CO[C](O)[CH]F(2359)'],
    products = ['C#COC(O)[CH]F(1809)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[C]#COC(O)[CH]F(2360)'],
    products = ['C#COC(O)[CH]F(1809)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'C#CO[CH]O(2351)'],
    products = ['C#COC(O)[CH]F(1809)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C#COC(O)[C]F-2(2361)'],
    products = ['C#COC(O)[CH]F(1809)'],
