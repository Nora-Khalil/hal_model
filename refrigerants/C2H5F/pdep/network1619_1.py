...
reaction(
    label = 'reaction1',
    reactants = ['C=C(OF)C(C)(F)F(4747)'],
    products = ['HF(38)', 'CH2CF2(56)', 'CH2CO(28)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C=C(C)OF(663)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C(F)OF(1352)', 'C[C]F(124)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(OF)C([CH2])(F)F(4754)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(F)(F)[C](C)OF(4755)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(OF)[C](C)F(1949)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C=C([O])C(C)(F)F(4756)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(160)', 'C=[C]C(C)(F)F(4757)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'C=C(OF)[C](F)F(4758)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]OF(491)', 'CH3-CF2(64)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=C)OF(4759)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)C(C)(F)F(4760)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C(OF)C(C)(F)F(4761)'],
    products = ['C=C(OF)C(C)(F)F(4747)'],
...
network(
    label = 'PDepNetwork #1619',
    isomers = [
        'C=C(OF)C(C)(F)F(4747)',
    ],
    reactants = [
        ('HF(38)', 'CH2CF2(56)', 'CH2CO(28)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
