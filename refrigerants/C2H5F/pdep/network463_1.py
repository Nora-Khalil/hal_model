...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(332)', 'CH2OH(33)'],
    products = ['O=C(F)OCO(552)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH2]OC(=O)F(2073)'],
    products = ['O=C(F)OCO(552)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)O[CH]O(2246)'],
    products = ['O=C(F)OCO(552)'],
