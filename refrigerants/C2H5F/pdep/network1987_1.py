...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C[C]=C[O](6480)'],
    products = ['[CH2]OC=[C]C(6362)'],
    transitionState = 'TS2',
