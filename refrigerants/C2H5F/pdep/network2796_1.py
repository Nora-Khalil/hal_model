...
"""),
    E0 = (-643.276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([286,334,437,422,648,895,1187,351,323,533,609,664,892,1120,1201,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.266462,'amu*angstrom^2'), symmetry=1, barrier=(6.12648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266656,'amu*angstrom^2'), symmetry=1, barrier=(6.13096,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.888159,0.0736154,-0.000102511,7.56673e-08,-2.24421e-11,-77260.8,24.5756], Tmin=(100,'K'), Tmax=(822.453,'K')), NASAPolynomial(coeffs=[11.0804,0.0240473,-1.21118e-05,2.39347e-09,-1.69977e-13,-78937.3,-22.6041], Tmin=(822.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-643.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09945,0.0561328,-4.78293e-05,1.95996e-08,-3.15781e-12,-87689.5,20.9832], Tmin=(100,'K'), Tmax=(1489.71,'K')), NASAPolynomial(coeffs=[16.191,0.0156108,-7.0274e-06,1.34014e-09,-9.35549e-14,-92185.9,-57.8399], Tmin=(1489.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-730.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(CsCFFO) + group(Cs-CsHHH) + longDistanceInteraction_cyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + ring(O2s-Cs(F)(F)-Cs-O2s)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.37041,'amu*angstrom^2'), symmetry=1, barrier=(8.51646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.370622,'amu*angstrom^2'), symmetry=1, barrier=(8.52133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.741974,'amu*angstrom^2'), symmetry=1, barrier=(17.0594,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.499515,0.0848778,-0.000128253,9.38134e-08,-2.43532e-11,-80027.8,25.0975], Tmin=(100,'K'), Tmax=(640.403,'K')), NASAPolynomial(coeffs=[12.3071,0.0232127,-1.21246e-05,2.39147e-09,-1.68091e-13,-81787.9,-28.54], Tmin=(640.403,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-666.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)

species(
    label = '[CH2]C([O])(F)C(O)(F)F(7843)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-371.741,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,253,525,597,667,842,1178,1324,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,194.079,194.08,194.103],'cm^-1')),
        HinderedRotor(inertia=(0.302609,'amu*angstrom^2'), symmetry=1, barrier=(8.09218,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.832124,'amu*angstrom^2'), symmetry=1, barrier=(22.2738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301991,'amu*angstrom^2'), symmetry=1, barrier=(8.09255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.554653,0.0839774,-0.000124819,8.87864e-08,-2.13826e-11,-44593.8,24.6058], Tmin=(100,'K'), Tmax=(626.393,'K')), NASAPolynomial(coeffs=[11.9726,0.0240803,-1.2554e-05,2.47468e-09,-1.73913e-13,-46279.6,-27.1765], Tmin=(626.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFFO) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]C(F)C([O])(F)F(7452)'],
    products = ['CC([O])(F)C([O])(F)F(7468)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C[C](F)C([O])(F)F(7562)'],
    products = ['CC([O])(F)C([O])(F)F(7468)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'CC([O])(F)[C](F)F(5405)'],
    products = ['CC([O])(F)C([O])(F)F(7468)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1667.73,'m^3/(mol*s)'), n=1.126, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_ter_rad;O_birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'CC(=O)C([O])(F)F(7841)'],
    products = ['CC([O])(F)C([O])(F)F(7468)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(19.7182,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.4291e-06,'m^3/(mol*s)'), n=3.20779, Ea=(60.0989,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing_Ext-1R!H-R_N-2R!H->C_N-5R!H-u1',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing_Ext-1R!H-R_N-2R!H->C_N-5R!H-u1"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', 'CC([O])=C([O])F(2145)'],
    products = ['CC([O])(F)C([O])(F)F(7468)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(29.5712,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'C=C([O])C([O])(F)F(7402)'],
    products = ['CC([O])(F)C([O])(F)F(7468)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(267.067,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)

reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(O)(F)C([O])(F)F(7842)'],
    products = ['CC([O])(F)C([O])(F)F(7468)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C([O])(F)C(O)(F)F(7843)'],
    products = ['CC([O])(F)C([O])(F)F(7468)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[C]([O])C(F)(F)OF(7845)'],
    products = ['CC([O])(F)C([O])(F)F(7468)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(114.242,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction18',
    reactants = ['CC(F)(OF)[C]([O])F(7569)'],
    products = ['CC([O])(F)C([O])(F)F(7468)'],
