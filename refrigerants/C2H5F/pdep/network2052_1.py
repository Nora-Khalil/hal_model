...
"""),
    E0 = (-773.198,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,333,384,448,608,1254,1480,261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
...
"""),
    E0 = (-366.332,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,194,682,905,1196,1383,3221],'cm^-1')),
        HinderedRotor(inertia=(0.294627,'amu*angstrom^2'), symmetry=1, barrier=(14.4855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519307,'amu*angstrom^2'), symmetry=1, barrier=(25.4724,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.90012,0.0064096,0.000124779,-2.72116e-07,1.80411e-10,-44059.2,9.62022], Tmin=(10,'K'), Tmax=(493.964,'K')), NASAPolynomial(coeffs=[2.55752,0.0364198,-2.44682e-05,7.74676e-09,-9.27002e-13,-44160.1,12.7872], Tmin=(493.964,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-366.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""CC(O)DCF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-367.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,487,638,688,1119,1325,1387,3149,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,219.461,219.461],'cm^-1')),
        HinderedRotor(inertia=(0.273963,'amu*angstrom^2'), symmetry=1, barrier=(9.36335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273959,'amu*angstrom^2'), symmetry=1, barrier=(9.36336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273963,'amu*angstrom^2'), symmetry=1, barrier=(9.36336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.776635,'amu*angstrom^2'), symmetry=1, barrier=(26.5431,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.760804,0.0764714,-0.000107946,8.23824e-08,-2.5323e-11,-44075.6,23.8228], Tmin=(100,'K'), Tmax=(794.309,'K')), NASAPolynomial(coeffs=[10.7714,0.0260593,-1.27456e-05,2.47948e-09,-1.74194e-13,-45665.9,-22.1673], Tmin=(794.309,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-367.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(Cs-CsHHH) + radical(C2CsJOH)"""),
)
...
"""),
    E0 = (-681.132,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,333,384,448,608,1254,1480,2750,2800,2850,1350,1500,750,1050,1375,1000,391,562,707,872,1109,1210,1289,3137,180],'cm^-1')),
        HinderedRotor(inertia=(0.646155,'amu*angstrom^2'), symmetry=1, barrier=(14.8564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.645837,'amu*angstrom^2'), symmetry=1, barrier=(14.8491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.646019,'amu*angstrom^2'), symmetry=1, barrier=(14.8533,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18053,0.0628831,-6.51007e-05,3.50867e-08,-7.64902e-12,-81820.5,22.3848], Tmin=(100,'K'), Tmax=(1100.89,'K')), NASAPolynomial(coeffs=[12.2037,0.0228318,-1.05301e-05,2.04076e-09,-1.44747e-13,-84247.6,-31.8552], Tmin=(1100.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-681.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.257315,'amu*angstrom^2'), symmetry=1, barrier=(5.91617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.70183,'amu*angstrom^2'), symmetry=1, barrier=(16.1364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260036,'amu*angstrom^2'), symmetry=1, barrier=(5.97875,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03058,0.0753604,-0.000131207,1.25146e-07,-4.60529e-11,-45869.1,23.0685], Tmin=(100,'K'), Tmax=(827.891,'K')), NASAPolynomial(coeffs=[5.55958,0.0329496,-1.71708e-05,3.3667e-09,-2.345e-13,-45915.5,6.32303], Tmin=(827.891,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-HHH)(F1s))"""),
)
...
"""),
    E0 = (-578.644,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,316,385,515,654,689,1295,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,180,180],'cm^-1')),
...
"""),
    E0 = (-606.371,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000],'cm^-1')),
        HinderedRotor(inertia=(1.04296,'amu*angstrom^2'), symmetry=1, barrier=(23.9798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04322,'amu*angstrom^2'), symmetry=1, barrier=(23.9857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04338,'amu*angstrom^2'), symmetry=1, barrier=(23.9893,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77304,0.0501508,-4.6451e-05,2.28091e-08,-4.63264e-12,-72850.4,18.2722], Tmin=(100,'K'), Tmax=(1158.95,'K')), NASAPolynomial(coeffs=[9.87724,0.0221799,-1.02487e-05,1.98417e-09,-1.40421e-13,-74728.9,-22.0213], Tmin=(1158.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-606.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
"""),
    E0 = (-860.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,486,617,768,1157,1926,180],'cm^-1')),
        HinderedRotor(inertia=(1.0486,'amu*angstrom^2'), symmetry=1, barrier=(24.1095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04835,'amu*angstrom^2'), symmetry=1, barrier=(24.1037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04801,'amu*angstrom^2'), symmetry=1, barrier=(24.0958,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43432,0.0598753,-6.75012e-05,4.06352e-08,-1.00163e-11,-103388,20.4219], Tmin=(100,'K'), Tmax=(973.279,'K')), NASAPolynomial(coeffs=[10.2766,0.0235354,-1.14955e-05,2.27348e-09,-1.62704e-13,-105110,-21.9978], Tmin=(973.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-860.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(COCsFO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH3OH(26)', 'F[C]C(F)OF(2313)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.14358e+07,'m^3/(mol*s)'), n=-0.641018, Ea=(171.35,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17570294811609, var=29.477358162589667, Tref=1000.0, N=2, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['OF(169)', 'CC(O)(F)[C]F(5693)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H2O(3)', 'CC(F)=C(F)OF(4855)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(169)', 'CC(F)=COF(2323)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H2O(3)', 'C=C(F)C(F)OF(4856)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOF(1637)', 'CC(O)=CF(3215)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C[C](O)C(F)OF(3219)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'C[C](F)C(F)OF(2320)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'CC([O])(F)C(F)OF(5820)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(160)', 'CC(O)(F)[CH]F(5703)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]OF(1980)', 'C[C](O)F(1910)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH3(19)', 'O[C](F)C(F)OF(3044)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'CC(O)(F)[C](F)OF(5821)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[CH2]C(O)(F)C(F)OF(5822)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'CC(=O)C(F)OF(2870)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(159.21,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction24',
    reactants = ['F2(77)', 'CC(O)(F)C=O(5228)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'CC(O)(F)C(=O)F(5288)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'C=C(O)C(F)OF(2868)'],
    products = ['CC(O)(F)C(F)OF(5740)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(210.766,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)

reaction(
    label = 'reaction29',
    reactants = ['CC(O)(F)C(F)OF(5740)'],
    products = ['HF(38)', 'CHFO(47)', 'C=C(O)F(498)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(43.6346,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
