...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC=[C]C(6366)'],
    products = ['[CH]=C(C)C=[C]C(6763)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(6)', '[CH]=C(C)C=C=C(6788)'],
    products = ['[CH]=C(C)C=[C]C(6763)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(19)', 'C#CC=[C]C(6496)'],
    products = ['[CH]=C(C)C=[C]C(6763)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH]=C(C)C#CC(6789)'],
    products = ['[CH]=C(C)C=[C]C(6763)'],
    transitionState = 'TS8',
