...
"""),
    E0 = (-206.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([248,333,466,604,684,796,1061,1199,122,584,932,1043,1247,1392,1461,2986,3039,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.332107,'amu*angstrom^2'), symmetry=1, barrier=(7.6358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.330965,'amu*angstrom^2'), symmetry=1, barrier=(7.60953,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.584887,'amu*angstrom^2'), symmetry=1, barrier=(13.4477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-280.637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([190,359,486,598,681,1014,1151,319,1023,1071,1259,1317,1409,3054,3019,3000,3100,440,815,1455,1000,2100,2250,500,550,180,2008.67],'cm^-1')),
        HinderedRotor(inertia=(0.518282,'amu*angstrom^2'), symmetry=1, barrier=(11.9163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.86749,'amu*angstrom^2'), symmetry=1, barrier=(65.9293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.86596,'amu*angstrom^2'), symmetry=1, barrier=(65.8941,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938869,0.0707951,-9.1686e-05,6.63258e-08,-1.94384e-11,-33645.8,24.1145], Tmin=(100,'K'), Tmax=(831.647,'K')), NASAPolynomial(coeffs=[10.1623,0.0264275,-1.16529e-05,2.16193e-09,-1.47968e-13,-35179.7,-18.6819], Tmin=(831.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Csj(Cs-F1sF1sCt)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.309838,'amu*angstrom^2'), symmetry=1, barrier=(7.12379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.6418,'amu*angstrom^2'), symmetry=1, barrier=(60.7402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0272103,'amu*angstrom^2'), symmetry=1, barrier=(60.909,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (-206.404,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([136,307,446,511,682,757,1180,1185,212,931,1104,1251,1325,1474,3102,3155,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.323724,'amu*angstrom^2'), symmetry=1, barrier=(7.44305,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323704,'amu*angstrom^2'), symmetry=1, barrier=(7.4426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417891,'amu*angstrom^2'), symmetry=1, barrier=(9.60814,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.564815,0.0846397,-0.000136019,1.24729e-07,-4.55769e-11,-24709.8,27.4016], Tmin=(100,'K'), Tmax=(794.997,'K')), NASAPolynomial(coeffs=[7.00356,0.0375786,-1.95548e-05,3.86196e-09,-2.71591e-13,-25270.1,0.730123], Tmin=(794.997,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cds_S)"""),
)

species(
    label = 'CC(F)(F)[C]=[C]CF(11301)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-179.644,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([136,307,446,511,682,757,1180,1185,2750,2800,2850,1350,1500,750,1050,1375,1000,122,584,932,1043,1247,1392,1461,2986,3039,1670,1700,300,440],'cm^-1')),
        HinderedRotor(inertia=(0.391201,'amu*angstrom^2'), symmetry=1, barrier=(8.99448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.392608,'amu*angstrom^2'), symmetry=1, barrier=(9.02683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391911,'amu*angstrom^2'), symmetry=1, barrier=(9.01081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.847214,0.0764353,-0.0001119,9.88245e-08,-3.61079e-11,-21499.5,27.0159], Tmin=(100,'K'), Tmax=(750.682,'K')), NASAPolynomial(coeffs=[6.9124,0.0370351,-1.90206e-05,3.77246e-09,-2.67419e-13,-22210.6,0.823256], Tmin=(750.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.644,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.903907,0.0706192,-7.08314e-05,3.71683e-08,-7.99907e-12,-42161.5,24.8436], Tmin=(100,'K'), Tmax=(1103.39,'K')), NASAPolynomial(coeffs=[12.4722,0.0286821,-1.38204e-05,2.7224e-09,-1.94541e-13,-44714.4,-32.1049], Tmin=(1103.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-351.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCsCdF) + radical(CsCdCsF1s) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)

species(
    label = 'C=[C][CH]C(F)(F)CF(9241)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02074,0.07036,-7.69802e-05,4.63316e-08,-1.16189e-11,-32915.9,23.4611], Tmin=(100,'K'), Tmax=(949.538,'K')), NASAPolynomial(coeffs=[10.2899,0.0313124,-1.52954e-05,3.0225e-09,-2.16117e-13,-34676.2,-20.7774], Tmin=(949.538,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-274.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(F)(F)[CH]C(=C)F(9242)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.854627,0.0728702,-7.98316e-05,4.65034e-08,-1.10879e-11,-40766.3,23.9067], Tmin=(100,'K'), Tmax=(1004.57,'K')), NASAPolynomial(coeffs=[11.9453,0.0287072,-1.38854e-05,2.73717e-09,-1.95634e-13,-42994.4,-29.6495], Tmin=(1004.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-339.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C=[C]CF(11110)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'FC[C]=C[C](F)F(11298)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11110)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)C=[C]CF(11168)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11110)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(57.7896,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)(F)C=C=C(6472)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11110)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH2][C](F)C#CCF(11263)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11110)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(257.205,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)[C]=CCF(11300)'],
    products = ['[CH2]C(F)(F)C=[C]CF(11110)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)C=[C]CF(11110)'],
    products = ['[CH2]C(F)=C[C](F)CF(11303)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(161.554,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)C=[C]CF(11110)'],
    products = ['C=[C][CH]C(F)(F)CF(9241)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(165.627,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(F)(F)C=[C]CF(11110)'],
    products = ['[CH2]C(F)(F)[CH]C(=C)F(9242)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(95.3619,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)

network(
    label = 'PDepNetwork #4020',
    isomers = [
        '[CH2]C(F)(F)C=[C]CF(11110)',
    ],
    reactants = [
