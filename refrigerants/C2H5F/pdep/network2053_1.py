...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(=[CH])C(6367)'],
    products = ['[CH]=C(C)C(=[CH])C(6764)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(19)', '[CH]=C(C)C#C(6475)'],
    products = ['[CH]=C(C)C(=[CH])C(6764)'],
    transitionState = 'TS4',
