...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])=C=O(1083)'],
    products = ['[O]C(=O)C([O])=O(246)'],
    transitionState = 'TS2',
