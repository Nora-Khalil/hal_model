...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]CC[C]=C(7099)'],
    products = ['C=C=C(6729)', 'C=C=C(6729)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(271)', '[CH2]C[C]=C(435)'],
    products = ['C=[C]CC[C]=C(7099)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['C=C=C(6729)', '[CH2][C]=C(6819)'],
    products = ['C=[C]CC[C]=C(7099)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]=C(6819)', '[CH2][C]=C(6819)'],
    products = ['C=[C]CC[C]=C(7099)'],
    transitionState = 'TS9',
