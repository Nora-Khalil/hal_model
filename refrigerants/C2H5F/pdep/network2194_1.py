...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83207,0.0401026,-1.64932e-05,-7.92554e-09,6.03234e-12,21409,16.496], Tmin=(100,'K'), Tmax=(1012.59,'K')), NASAPolynomial(coeffs=[11.6321,0.0174209,-6.64129e-06,1.22309e-09,-8.64948e-14,18602.4,-34.9643], Tmin=(1012.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + ring(Cd-Cd-Cd-Cd(F))"""),
)

species(
    label = 'C=C=CC(=C)F(6141)',
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59561,0.0455922,-2.93235e-05,4.91877e-09,1.33415e-12,4832.53,18.0586], Tmin=(100,'K'), Tmax=(1098.47,'K')), NASAPolynomial(coeffs=[12.5482,0.0175766,-7.27298e-06,1.37154e-09,-9.69706e-14,1710.32,-39.0691], Tmin=(1098.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.4089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CdCCF) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.87871,'amu*angstrom^2'), symmetry=1, barrier=(20.2033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0709789,'amu*angstrom^2'), symmetry=1, barrier=(67.3984,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0835,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90096,0.043216,-3.82879e-05,1.86252e-08,-3.69168e-12,35951.6,19.0151], Tmin=(100,'K'), Tmax=(1209.31,'K')), NASAPolynomial(coeffs=[9.63679,0.0176286,-6.54997e-06,1.12892e-09,-7.46998e-14,34080.6,-19.776], Tmin=(1209.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtHHH) + group(CdCtCdF) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Cdj(Cd-F1sCt)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.08056,'amu*angstrom^2'), symmetry=1, barrier=(24.8441,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (64.0851,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09489,0.044078,-5.73637e-05,4.39018e-08,-1.35582e-11,81803.5,16.8239], Tmin=(100,'K'), Tmax=(876.799,'K')), NASAPolynomial(coeffs=[6.9134,0.0185108,-7.491e-06,1.31833e-09,-8.68238e-14,81096.3,-5.00327], Tmin=(876.799,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(679.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + group(Cdd-CdsCds) + radical(Cds_S) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]C(F)=CC=C(6398)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.13096,'amu*angstrom^2'), symmetry=1, barrier=(48.9949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13551,'amu*angstrom^2'), symmetry=1, barrier=(49.0996,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46534,0.0474914,-2.05379e-05,-7.79937e-09,6.57001e-12,26568.2,20.1052], Tmin=(100,'K'), Tmax=(1001.67,'K')), NASAPolynomial(coeffs=[12.282,0.0218029,-8.28438e-06,1.49267e-09,-1.03674e-13,23523,-36.481], Tmin=(1001.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(F)=C=CC(6399)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93745,0.0486963,-3.67727e-05,1.63378e-08,-3.32789e-12,34998.9,18.7051], Tmin=(100,'K'), Tmax=(1078.66,'K')), NASAPolynomial(coeffs=[6.17511,0.0329819,-1.49203e-05,2.83203e-09,-1.97689e-13,34084.7,-2.06007], Tmin=(1078.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCddCF) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2][C](F)C#CC(6400)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {5,S} {7,S} {8,S} {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C=[C]C(6136)'],
    products = ['C2HF(57)', 'C#CC(4975)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]=C(F)C=C=C(6395)'],
    products = ['[CH]=C(F)C=[C]C(6136)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=[C]F(1321)', 'C#CC(4975)'],
    products = ['[CH]=C(F)C=[C]C(6136)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[CH]=C(F)C#CC(6396)'],
    products = ['[CH]=C(F)C=[C]C(6136)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]F(1321)', '[CH]=[C]C(4976)'],
    products = ['[CH]=C(F)C=[C]C(6136)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[CH]=C=C=[C]C(6397)'],
    products = ['[CH]=C(F)C=[C]C(6136)'],
