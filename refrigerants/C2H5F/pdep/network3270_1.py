...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1334)', '[CH]C(=C)F(2580)'],
    products = ['[CH]=C(F)C[C]=CF(8541)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=C(F)CC#C(6849)'],
    products = ['[CH]=C(F)C[C]=CF(8541)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(F)CC#CF(9099)'],
    products = ['[CH]=C(F)C[C]=CF(8541)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH]=C=C[C]=CF(9100)'],
    products = ['[CH]=C(F)C[C]=CF(8541)'],
