...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(837)', '[O]C([O])F(2070)'],
    products = ['[O]C(F)O[CH]F(2065)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[CH]F(2009)'],
    products = ['[O]C(F)O[CH]F(2065)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=C(F)O[CH]F(2109)'],
    products = ['[O]C(F)O[CH]F(2065)'],
    transitionState = 'TS8',
