...
reaction(
    label = 'reaction8',
    reactants = ['CHFO(47)', 'C#CO[CH2](454)'],
    products = ['C#COCC([O])F(641)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH]=[C]OCC=O(1291)'],
    products = ['C#COCC([O])F(641)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HCCO(21)', '[CH2]C([O])F(338)'],
    products = ['C#COCC([O])F(641)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][CH]F(1395)', 'C#CO[CH2](454)'],
    products = ['C#COCC([O])F(641)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'C#CO[CH]C([O])F(1508)'],
    products = ['C#COCC([O])F(641)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', 'C#COC[C]([O])F(1509)'],
    products = ['C#COCC([O])F(641)'],
