...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C[O](144)'],
    products = ['[CH2]CC[O](377)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](131)', '[CH2][CH2](138)'],
    products = ['[CH2]CC[O](377)'],
