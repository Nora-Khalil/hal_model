...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(160)', 'CC[CH]F(1043)'],
    products = ['CCC(F)OF(2183)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F[CH]OF(1980)', 'C2H5(32)'],
    products = ['CCC(F)OF(2183)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[CH2]C(F)OF(1355)'],
    products = ['CCC(F)OF(2183)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C[CH]C(F)OF(2188)'],
    products = ['CCC(F)OF(2183)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]CC(F)OF(2190)'],
    products = ['CCC(F)OF(2183)'],
