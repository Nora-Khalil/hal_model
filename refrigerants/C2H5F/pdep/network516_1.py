...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C=CF(936)'],
    products = ['[CH]=CC([CH2])F(927)'],
    transitionState = 'TS3',
