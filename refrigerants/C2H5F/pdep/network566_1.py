...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', '[O]C[CH]F(973)'],
    products = ['O=[C]OC[CH]F(1282)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', '[CH2]O[C]=O(252)'],
    products = ['O=[C]OC[CH]F(1282)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]O[C]=O(252)'],
    products = ['O=[C]OC[CH]F(1282)'],
