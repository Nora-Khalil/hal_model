...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'F[CH]C[C](F)F(3551)'],
    products = ['[O]C(F)C[C](F)F(4463)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)C=C(F)F(4608)'],
    products = ['[O]C(F)C[C](F)F(4463)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=CC[C](F)F(3699)'],
    products = ['[O]C(F)C[C](F)F(4463)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=C(F)C[C](F)F(4609)'],
    products = ['[O]C(F)C[C](F)F(4463)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C=C[C](F)F(2719)'],
    products = ['[O]C(F)C[C](F)F(4463)'],
