...
"""),
    E0 = (-1013.91,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,206,363,518,1175,1317,1481,3059,261,493,600,1152,1365,1422,3097,486,617,768,1157,1926,292.131,292.344],'cm^-1')),
        HinderedRotor(inertia=(0.257949,'amu*angstrom^2'), symmetry=1, barrier=(15.6079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.526628,'amu*angstrom^2'), symmetry=1, barrier=(31.8326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0570092,'amu*angstrom^2'), symmetry=1, barrier=(3.4486,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32025,0.0634083,-7.25852e-05,4.3838e-08,-1.08564e-11,-121852,23.675], Tmin=(100,'K'), Tmax=(966.911,'K')), NASAPolynomial(coeffs=[10.6478,0.0248219,-1.27255e-05,2.56646e-09,-1.8556e-13,-123656,-21.0113], Tmin=(966.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1013.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(COCsFO)"""),
)

species(
    label = 'O[C](F)OC(F)[CH]F(4417)',
...
"""),
    E0 = (-663.777,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,551,1088,1226,1380,1420,1481,3057,3119,395,473,707,1436,482,586,761,1411,259.309,259.309,259.309,259.31],'cm^-1')),
        HinderedRotor(inertia=(0.373361,'amu*angstrom^2'), symmetry=1, barrier=(17.8153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277062,'amu*angstrom^2'), symmetry=1, barrier=(13.2203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.924183,'amu*angstrom^2'), symmetry=1, barrier=(44.0982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277062,'amu*angstrom^2'), symmetry=1, barrier=(13.2203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.837843,'amu*angstrom^2'), symmetry=1, barrier=(19.2637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.838466,'amu*angstrom^2'), symmetry=1, barrier=(19.278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.838119,'amu*angstrom^2'), symmetry=1, barrier=(19.27,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.823198,0.0676221,-8.40994e-05,5.01202e-08,-1.14939e-11,-59250.7,22.6816], Tmin=(100,'K'), Tmax=(1077.27,'K')), NASAPolynomial(coeffs=[16.2226,0.0104434,-4.48413e-06,8.50897e-10,-6.02213e-14,-62568.6,-52.7577], Tmin=(1077.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-493.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sH)(O2s-Cs))"""),
)

species(
    label = '[CH]=C(F)OC(O)F(2364)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-658.281,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,509,613,660,1171,1360,1414,3084,293,496,537,1218,167,640,1190,351.417,351.418,351.421,351.437],'cm^-1')),
        HinderedRotor(inertia=(0.111437,'amu*angstrom^2'), symmetry=1, barrier=(9.76586,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147664,'amu*angstrom^2'), symmetry=1, barrier=(12.9414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.340208,'amu*angstrom^2'), symmetry=1, barrier=(29.8156,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.715614,0.0761642,-0.000107222,7.44408e-08,-2.0258e-11,-79058,24.3013], Tmin=(100,'K'), Tmax=(902.354,'K')), NASAPolynomial(coeffs=[14.0614,0.0170041,-8.87895e-06,1.78388e-09,-1.28119e-13,-81466.5,-38.7133], Tmin=(902.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-658.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(CsFHOO) + group(CdCFO) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(Cdj(Cd-F1sO2s)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.313845,0.0886351,-0.000148156,1.28051e-07,-4.36208e-11,-80809.7,25.3331], Tmin=(100,'K'), Tmax=(787.395,'K')), NASAPolynomial(coeffs=[11.4154,0.0251369,-1.36615e-05,2.72377e-09,-1.91931e-13,-82337.8,-24.1738], Tmin=(787.395,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-672.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsFHOO) + group(CsCFFO) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'OC(F)OC(F)[C]F-2(5107)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {8,S}
4  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3708.61,'J/mol'), sigma=(5.69874,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=579.28 K, Pc=45.47 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)OC(F)=CF(5100)'],
    products = ['HF(38)', 'CHFO(47)', 'O=C=CF(1527)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['O[C](F)OC(F)[CH]F(4417)'],
    products = ['OC(F)OC(F)=CF(5100)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O[C](F)O[C](F)CF(20636)'],
    products = ['OC(F)OC(F)=CF(5100)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)OC(F)[CH]F(5104)'],
    products = ['OC(F)OC(F)=CF(5100)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)O[C](F)CF(20637)'],
    products = ['OC(F)OC(F)=CF(5100)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O[CH]OC(F)=CF(16606)'],
    products = ['OC(F)OC(F)=CF(5100)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'OC(F)O[C]=CF(20638)'],
    products = ['OC(F)OC(F)=CF(5100)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.52887e+10,'m^3/(mol*s)'), n=-0.421056, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.030895812897821735, var=3.1393582276389975, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_N-3R!H->F_N-3BrCClINOPSSi->Cl_Ext-1C-R_Ext-3BrCO-R_Ext-5R!H-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=C(F)OC(O)F(2364)'],
    products = ['OC(F)OC(F)=CF(5100)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O[CH]F(2090)', 'O=C(F)[CH]F(3147)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(O)F(2093)', 'CHFCF[Z](71)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(5)', 'F[CH]OC(F)=CF(6081)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[O]C(F)OC(F)=CF(20639)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'O[C](F)OC(F)=CF(12267)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', 'OC(F)OC(F)=[C]F(20640)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OC(F)[O+]=[C-]C(F)F(20641)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C(F)(F)OC(O)F-2(20642)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OC(F)OC(F)[C]F-2(5107)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=COC(F)=CF(6034)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(77)', 'C#COC(O)F(1930)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'OC(F)OC#CF(8043)'],
    products = ['OC(F)OC(F)=CF(5100)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', 'OC(F)[O+]=[C-]F(2368)'],
    products = ['OC(F)OC(F)=CF(5100)'],
