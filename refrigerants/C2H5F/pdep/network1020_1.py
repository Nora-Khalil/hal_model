...
"""),
    E0 = (-188.516,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,487,638,688,1119,1325,1387,3149,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.283374,'amu*angstrom^2'), symmetry=1, barrier=(6.51533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00390651,'amu*angstrom^2'), symmetry=1, barrier=(6.51452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77946,'amu*angstrom^2'), symmetry=1, barrier=(40.9133,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41137,0.0423025,-1.56594e-05,-4.69435e-08,5.45124e-11,-22623.6,18.8071], Tmin=(100,'K'), Tmax=(453.18,'K')), NASAPolynomial(coeffs=[4.66081,0.0325073,-1.65342e-05,3.32513e-09,-2.39748e-13,-22930.8,8.59553], Tmin=(453.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(Cs-HHH)(H))"""),
)
...
"""),
    E0 = (-485.349,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,391,562,707,872,1109,1210,1289,3137,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.495843,'amu*angstrom^2'), symmetry=1, barrier=(11.4004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386451,'amu*angstrom^2'), symmetry=1, barrier=(8.88527,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.068,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'F[C]C(F)OF(2313)'],
    products = ['CC(F)C(F)OF(2310)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(169)', 'CC(F)[C]F(2314)'],
    products = ['CC(F)C(F)OF(2310)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'FCC(F)OF(2315)'],
    products = ['CC(F)C(F)OF(2310)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[CH]C(F)OF(2188)'],
    products = ['CC(F)C(F)OF(2310)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(F)[CH]OF(1641)'],
    products = ['CC(F)C(F)OF(2310)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC(F)C([O])F(2048)'],
    products = ['CC(F)C(F)OF(2310)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(160)', 'CC(F)[CH]F(2318)'],
    products = ['CC(F)C(F)OF(2310)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(1980)', 'CH3-CHF(62)'],
    products = ['CC(F)C(F)OF(2310)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'F[CH]C(F)OF(2319)'],
    products = ['CC(F)C(F)OF(2310)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C[C](F)C(F)OF(2320)'],
    products = ['CC(F)C(F)OF(2310)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'CC(F)[C](F)OF(2321)'],
    products = ['CC(F)C(F)OF(2310)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(F)C(F)OF(2322)'],
    products = ['CC(F)C(F)OF(2310)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'CC(F)C(=O)F(2014)'],
    products = ['CC(F)C(F)OF(2310)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'CC=C(F)OF(2324)'],
    products = ['CC(F)C(F)OF(2310)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'C=CC(F)OF(2325)'],
    products = ['CC(F)C(F)OF(2310)'],
