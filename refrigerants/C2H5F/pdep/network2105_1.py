...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)O[O](846)'],
    products = ['O=O(150)', 'CH2CHF(55)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[CH]F(919)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)O[O](846)'],
    transitionState = 'TS3',
