...
"""),
    E0 = (-496.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,363.434,368.811],'cm^-1')),
...
reaction(
    label = 'reaction3',
    reactants = ['CH3F(39)', 'F[C]COF(1633)'],
    products = ['CC(F)(F)COF(4839)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'FOCC(F)F(4773)'],
    products = ['CC(F)(F)COF(4839)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['FOF(1637)', 'C=C(C)F(1325)'],
    products = ['CC(F)(F)COF(4839)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)(F)C[O](4820)'],
    products = ['CC(F)(F)COF(4839)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(160)', '[CH2]C(C)(F)F(4425)'],
    products = ['CC(F)(F)COF(4839)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OF(396)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)COF(4839)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', 'FOC[C](F)F(4863)'],
    products = ['CC(F)(F)COF(4839)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)(F)[CH]OF(4850)'],
    products = ['CC(F)(F)COF(4839)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(F)COF(4864)'],
    products = ['CC(F)(F)COF(4839)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC(F)(F)C=O(4542)'],
    products = ['CC(F)(F)COF(4839)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(F)COF(4865)'],
    products = ['CC(F)(F)COF(4839)'],
