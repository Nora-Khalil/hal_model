...
reaction(
    label = 'reaction1',
    reactants = ['H(5)', '[C]#C[CH2](8251)'],
    products = ['[CH]=C=C(4381)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C=C(4381)'],
    products = ['[C]1=CC1(8252)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]1=CC1(8252)'],
    products = ['[CH]1C=C1(7381)'],
