...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])=O(157)', '[CH]C-2(137)'],
    products = ['[CH2]C(=O)O[CH]C(477)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[C]=O(626)'],
    products = ['[CH2]C(=O)O[CH]C(477)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(=O)OC=C(473)'],
    products = ['[CH2]C(=O)O[CH]C(477)'],
