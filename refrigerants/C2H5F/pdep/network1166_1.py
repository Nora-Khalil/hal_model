...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(1763)', '[CH]C-2(137)'],
    products = ['C[CH]OC=[C]F(2558)'],
    transitionState = 'TS2',
