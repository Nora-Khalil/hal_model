...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C1=CO[CH]O1(6571)'],
    products = ['C=C=COC=O(6084)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C#COC=O(6579)'],
    products = ['C=C=COC=O(6084)'],
