...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(O)C[C]F(3383)'],
    products = ['O=C(O)CCF(328)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'O=C(O)CF(2476)'],
    products = ['O=C(O)CCF(328)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(146)', 'CH2F-CH2(61)'],
    products = ['O=C(O)CCF(328)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(O)[CH]CF(2798)'],
    products = ['O=C(O)CCF(328)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)C[CH]F(2435)'],
    products = ['O=C(O)CCF(328)'],
