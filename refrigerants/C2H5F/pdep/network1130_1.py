...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C=C([O])OF(2745)'],
    products = ['[CH]=C(F)C([O])=O(2530)'],
    transitionState = 'TS2',
