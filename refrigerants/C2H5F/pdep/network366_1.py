...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(126)', '[CH2]C[CH2](342)'],
    products = ['[CH2]CC[C]=O(455)'],
    transitionState = 'TS4',
