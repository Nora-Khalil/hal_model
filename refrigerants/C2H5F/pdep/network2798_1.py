...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.380553,0.0872053,-0.000145758,1.26384e-07,-4.30148e-11,-85778.3,28.2143], Tmin=(100,'K'), Tmax=(805.188,'K')), NASAPolynomial(coeffs=[10.9607,0.0254276,-1.34989e-05,2.66095e-09,-1.86085e-13,-87183.3,-18.6809], Tmin=(805.188,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-714.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFFOO) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)

species(
    label = 'C[C](F)O[C](F)OF(7832)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-354.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,482,586,761,1411,210.897,210.911,210.914,2086.13],'cm^-1')),
        HinderedRotor(inertia=(1.09242,'amu*angstrom^2'), symmetry=1, barrier=(34.4777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.355035,'amu*angstrom^2'), symmetry=1, barrier=(11.2079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.355153,'amu*angstrom^2'), symmetry=1, barrier=(11.208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09227,'amu*angstrom^2'), symmetry=1, barrier=(34.4773,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.837426,0.0769169,-0.000111691,8.48202e-08,-2.47006e-11,-42482.3,26.5979], Tmin=(100,'K'), Tmax=(639.157,'K')), NASAPolynomial(coeffs=[9.95108,0.0277458,-1.47504e-05,2.95846e-09,-2.11034e-13,-43807.9,-14.5476], Tmin=(639.157,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHOO) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(CsF1sO2sO2s)"""),
)

species(
    label = 'CC(F)(F)O[C]([O])F(7833)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12576,0.060095,-5.73352e-05,2.68022e-08,-4.97041e-12,-79715.2,25.6874], Tmin=(100,'K'), Tmax=(1295.08,'K')), NASAPolynomial(coeffs=[14.7728,0.0179447,-8.5155e-06,1.67137e-09,-1.1921e-13,-83250,-43.6803], Tmin=(1295.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-663.671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsHHH) + group(CsFHOO) + radical(O2sj(Cs-F1sO2sH)) + radical(Csj(F1s)(O2s-Cs)(O2s-H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(7573)', 'C[C]F-2(838)'],
    products = ['C[C](F)OC([O])(F)F(7470)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[C](F)OC(=O)F(5283)'],
    products = ['C[C](F)OC([O])(F)F(7470)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(42.7318,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C([O])(F)F(7573)', 'C[C]F(124)'],
    products = ['C[C](F)OC([O])(F)F(7470)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[C](F)OC([O])(F)F(7470)'],
    products = ['[CH2]C(F)OC([O])(F)F(7830)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[C](F)OC([O])(F)F(7470)'],
    products = ['[CH2][C](F)OC(O)(F)F(7831)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[C](F)OC([O])(F)F(7470)'],
    products = ['CC(F)(F)O[C]([O])F(7833)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(225.345,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
