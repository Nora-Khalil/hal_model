...
"""),
    E0 = (-628.454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,519,593,830,1115,1166,1389,1413,3114,180,180,180,875.7],'cm^-1')),
        HinderedRotor(inertia=(0.0932844,'amu*angstrom^2'), symmetry=1, barrier=(2.14479,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0940698,'amu*angstrom^2'), symmetry=1, barrier=(2.16285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.0408,'amu'),
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)F(1981)', '[CH2]OF(396)'],
    products = ['FOCOC(F)F(7505)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(160)', '[CH2]OC(F)F(3330)'],
    products = ['FOCOC(F)F(7505)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FO[CH]OC(F)F(7906)'],
    products = ['FOCOC(F)F(7505)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'O=COC(F)F(2267)'],
    products = ['FOCOC(F)F(7505)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOCOC(F)F(7505)'],
    products = ['F2(77)', 'CHFO(47)', 'CH2O(20)'],
