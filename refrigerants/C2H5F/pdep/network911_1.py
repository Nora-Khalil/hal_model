...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)C([O])F(2015)'],
    products = ['[CH2]C(F)C([O])F(1984)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(F)C=O(993)'],
    products = ['[CH2]C(F)C([O])F(1984)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(F)C(=O)F(2016)'],
    products = ['[CH2]C(F)C([O])F(1984)'],
