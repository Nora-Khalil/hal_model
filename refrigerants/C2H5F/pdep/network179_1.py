...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(151)', '[C]=C(134)'],
    products = ['C=[C]OO[C]=O(281)'],
    transitionState = 'TS2',
