...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C([CH2])=C(6712)'],
    products = ['[CH2]C(=C)C[O](6255)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(=C)C=O(6774)'],
    products = ['[CH2]C(=C)C[O](6255)'],
