...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', '[CH2]C[C]=C(587)'],
    products = ['C=[C]CC[C]=C(6700)'],
    transitionState = 'TS3',
