...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(2.26879,'amu*angstrom^2'), symmetry=1, barrier=(52.164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249253,'amu*angstrom^2'), symmetry=1, barrier=(5.73081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248737,'amu*angstrom^2'), symmetry=1, barrier=(5.71896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0435593,'amu*angstrom^2'), symmetry=1, barrier=(52.1438,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32347,0.0431343,-2.54365e-05,-1.97372e-08,2.9732e-11,25944.1,19.231], Tmin=(100,'K'), Tmax=(498.381,'K')), NASAPolynomial(coeffs=[5.06756,0.0303218,-1.45984e-05,2.85102e-09,-2.01973e-13,25556.2,6.7556], Tmin=(498.381,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]O[O](153)', '[CH]C-2(137)'],
    products = ['[CH2]OO[CH]C(392)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[O](158)'],
    products = ['[CH2]OO[CH]C(392)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](131)', 'C[CH][O](174)'],
    products = ['[CH2]OO[CH]C(392)'],
    transitionState = 'TS9',
