...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C([CH2])(F)F(4468)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C(F)=C(F)F(4652)'],
    products = ['[CH]=C(F)C([CH2])(F)F(4468)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=C(F)C(=C)F(2626)'],
    products = ['[CH]=C(F)C([CH2])(F)F(4468)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CC([CH2])(F)F(4531)'],
    products = ['[CH]=C(F)C([CH2])(F)F(4468)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(77)', '[CH]=C=C([CH2])F(2627)'],
    products = ['[CH]=C(F)C([CH2])(F)F(4468)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)C([CH2])(F)F(4468)'],
    products = ['[CH2]C(F)=C(F)[CH]F(4654)'],
