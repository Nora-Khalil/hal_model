...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'O=C[CH]F(1529)'],
    products = ['[O]OC(F)C=O(1557)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['HO2(11)', 'O=C[C]F-2(1547)'],
    products = ['[O]OC(F)C=O(1557)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)C=O(1557)'],
    products = ['HO2(11)', 'O=C=CF(1527)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]O[CH]C=O(1396)'],
    products = ['[O]OC(F)C=O(1557)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[O]O[C](F)C=O(1657)'],
    products = ['[O]OC(F)C=O(1557)'],
