...
reaction(
    label = 'reaction1',
    reactants = ['C=C(C)O[O](7075)'],
    products = ['HO2(11)', 'C=C=C(6729)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=CO[O](252)'],
    products = ['C=C(C)O[O](7075)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH2]C(=C)O[O](6842)'],
    products = ['C=C(C)O[O](7075)'],
    transitionState = 'TS8',
