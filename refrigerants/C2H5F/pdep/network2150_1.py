...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]=CC=C=C(6244)'],
    products = ['[CH]=CC=[C]C(6094)'],
    transitionState = 'TS4',
