...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(271)', 'C=[C]C[O](459)'],
    products = ['C=[C]CO[C]=C(6911)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(271)', '[CH2]O[C]=C(455)'],
    products = ['C=[C]CO[C]=C(6911)'],
    transitionState = 'TS3',
