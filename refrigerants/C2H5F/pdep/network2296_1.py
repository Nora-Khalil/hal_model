...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(134)', '[CH2]C(=C)[O](609)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C]=C(708)'],
    products = ['[CH2]C(=C)O[C]=C(6272)'],
    transitionState = 'TS3',
