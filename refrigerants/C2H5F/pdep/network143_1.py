...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', '[O]C([O])=O(152)'],
    products = ['[O]C(=O)O[C]=O(247)'],
    transitionState = 'TS2',
