...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)C[CH2](6110)'],
    products = ['C2H4(30)', 'C#CC(4975)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[CH2](423)'],
    products = ['[CH]=C(C)C[CH2](6110)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C(=C)C(6159)'],
    products = ['[CH]=C(C)C[CH2](6110)'],
    transitionState = 'TS3',
