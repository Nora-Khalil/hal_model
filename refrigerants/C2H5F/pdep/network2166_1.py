...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC[C]=C(7079)'],
    products = ['CH2O(20)', 'C=C=C(6729)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=[C]C[O](459)'],
    products = ['[CH2]OC[C]=C(7079)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(271)', '[CH2]O[CH2](316)'],
    products = ['[CH2]OC[C]=C(7079)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(20)', '[CH2][C]=C(6819)'],
    products = ['[CH2]OC[C]=C(7079)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](318)', 'C=C=C(6729)'],
    products = ['[CH2]OC[C]=C(7079)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](318)', '[CH2][C]=C(6819)'],
    products = ['[CH2]OC[C]=C(7079)'],
