...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65509,0.0451095,-2.4117e-05,3.05409e-09,6.10167e-13,-15102.8,22.4816], Tmin=(100,'K'), Tmax=(1433.99,'K')), NASAPolynomial(coeffs=[14.1103,0.0212833,-1.0613e-05,2.08481e-09,-1.46381e-13,-19797.3,-46.0105], Tmin=(1433.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'O=C=CCC=CF(8785)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {7,D}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56987,0.0565963,-5.87507e-05,3.50767e-08,-8.83213e-12,-22709.7,21.674], Tmin=(100,'K'), Tmax=(942.908,'K')), NASAPolynomial(coeffs=[8.41861,0.0275433,-1.25338e-05,2.4006e-09,-1.6871e-13,-24001.3,-10.9648], Tmin=(942.908,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-Cd(CCO)HH) + group(Cds-CdsCsH) + group(Cds-(Cdd-O2d)CsH) + group(CdCFH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.321332,'amu*angstrom^2'), symmetry=1, barrier=(7.38806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321195,'amu*angstrom^2'), symmetry=1, barrier=(7.3849,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32861,0.0638189,-9.35742e-05,7.87949e-08,-2.67045e-11,5902.51,23.0028], Tmin=(100,'K'), Tmax=(813.736,'K')), NASAPolynomial(coeffs=[7.60211,0.0263887,-1.24255e-05,2.35702e-09,-1.6227e-13,5099.78,-4.62907], Tmin=(813.736,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.3169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-Cd(CCO)HH) + group(Cds-CdsCsH) + group(Cds-(Cdd-O2d)CsH) + group(CdCFH) + missing(Cdd-CdO2d) + radical(Cds_S)"""),
)
...
"""),
    E0 = (103.197,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2175,525,1855,455,950,239,401,1367,275.695,1565.45],'cm^-1')),
        HinderedRotor(inertia=(0.126035,'amu*angstrom^2'), symmetry=1, barrier=(7.06296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129774,'amu*angstrom^2'), symmetry=1, barrier=(7.01029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126503,'amu*angstrom^2'), symmetry=1, barrier=(7.01458,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47311,0.0615629,-9.33146e-05,8.14013e-08,-2.78998e-11,12497,24.4082], Tmin=(100,'K'), Tmax=(860.463,'K')), NASAPolynomial(coeffs=[6.25517,0.0272131,-1.23069e-05,2.26932e-09,-1.52778e-13,12122.7,4.66334], Tmin=(860.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CtCsHH) + group(Cds-OdCsH) + group(Ct-CtCs) + group(CtCF) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14917,0.0529497,-2.9926e-05,-5.35017e-09,7.52018e-12,8226.23,25.6533], Tmin=(100,'K'), Tmax=(974.044,'K')), NASAPolynomial(coeffs=[15.8474,0.0146903,-5.04145e-06,9.11875e-10,-6.5684e-14,4314.49,-50.2523], Tmin=(974.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.4706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(CdCFH) + radical(C=COJ) + radical(Cds_S)"""),
)

species(
    label = 'O=[C]CCC=[C]F(8790)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {6,D}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.188941,'amu*angstrom^2'), symmetry=1, barrier=(4.34412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189745,'amu*angstrom^2'), symmetry=1, barrier=(4.36262,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57336,0.0591625,-6.59712e-05,3.52223e-08,-3.15691e-12,11530.2,25.2697], Tmin=(100,'K'), Tmax=(604.216,'K')), NASAPolynomial(coeffs=[7.59433,0.0286101,-1.32291e-05,2.52313e-09,-1.75766e-13,10632.7,-2.15041], Tmin=(604.216,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.1863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFH) + radical(CCCJ=O) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'O=[C][CH]CC=CF(8791)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {7,D}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63357,0.0446342,-1.99809e-05,-1.6776e-09,2.10647e-12,7877.26,25.0366], Tmin=(100,'K'), Tmax=(1339.44,'K')), NASAPolynomial(coeffs=[13.9362,0.0225425,-1.1645e-05,2.33805e-09,-1.66916e-13,3267.52,-42.8171], Tmin=(1339.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.7374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = 'O=CCC[C]=[C]F(8793)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (181.959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,1685,370,167,640,1190,346.688,1694.21],'cm^-1')),
        HinderedRotor(inertia=(0.099081,'amu*angstrom^2'), symmetry=1, barrier=(8.45134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.09908,'amu*angstrom^2'), symmetry=1, barrier=(8.44937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0990872,'amu*angstrom^2'), symmetry=1, barrier=(8.45021,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88372,0.0530249,-4.72951e-05,1.07511e-08,1.0517e-11,21954.6,25.3228], Tmin=(100,'K'), Tmax=(545.638,'K')), NASAPolynomial(coeffs=[5.99346,0.0321721,-1.54672e-05,3.01714e-09,-2.13456e-13,21368,6.72021], Tmin=(545.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(CdCFH) + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=C(F)CC[C]=O(8794)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {6,D}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41724,0.062473,-7.45448e-05,4.5766e-08,-8.59962e-12,10505.9,25.1986], Tmin=(100,'K'), Tmax=(626.171,'K')), NASAPolynomial(coeffs=[8.15341,0.0281313,-1.3094e-05,2.50231e-09,-1.74416e-13,9491.94,-5.5064], Tmin=(626.171,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.6213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(CdCsCdF) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = '[CH]=[C]CCC(=O)F(8795)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (107.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,486,617,768,1157,1926,1685,370,3120,650,792.5,1650,271.796,271.871],'cm^-1')),
        HinderedRotor(inertia=(0.129683,'amu*angstrom^2'), symmetry=1, barrier=(6.80114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129651,'amu*angstrom^2'), symmetry=1, barrier=(6.80091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1296,'amu*angstrom^2'), symmetry=1, barrier=(6.80127,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31272,0.0645,-9.02231e-05,7.68571e-08,-2.70144e-11,13062.2,25.8021], Tmin=(100,'K'), Tmax=(781.545,'K')), NASAPolynomial(coeffs=[6.60303,0.0313937,-1.51095e-05,2.91207e-09,-2.03031e-13,12419.4,2.76157], Tmin=(781.545,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(107.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(COCsFO) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=CF(1334)', '[CH2]C[C]=O(596)'],
    products = ['O=[C]CC[C]=CF(8486)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(126)', '[CH2]C[C]=CF(2578)'],
    products = ['O=[C]CC[C]=CF(8486)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction9',
    reactants = ['CO(13)', '[CH2]C[C]=CF(2578)'],
    products = ['O=[C]CC[C]=CF(8486)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]CC=C=CF(8786)'],
    products = ['O=[C]CC[C]=CF(8486)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=C=CC[C]=CF(8467)'],
    products = ['O=[C]CC[C]=CF(8486)'],
