...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[C-]=[O+]OF(11757)'],
    products = ['[C-]=[O+]OC(=O)F(11731)'],
    transitionState = 'TS2',
