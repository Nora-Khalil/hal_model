...
"""),
    E0 = (80.4753,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(0.504652,'amu*angstrom^2'), symmetry=1, barrier=(11.6029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.506104,'amu*angstrom^2'), symmetry=1, barrier=(11.6363,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10197,'amu*angstrom^2'), symmetry=1, barrier=(25.3365,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.793432,0.078876,-0.000126369,1.15625e-07,-4.22798e-11,9786.32,23.5729], Tmin=(100,'K'), Tmax=(790.334,'K')), NASAPolynomial(coeffs=[6.89516,0.0349687,-1.83147e-05,3.6251e-09,-2.55319e-13,9228.64,-1.85509], Tmin=(790.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.4753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COOC(C)F(5128)'],
    products = ['CH2CO(28)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(11.1368,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C#COO(1058)', 'C[C]F(124)'],
    products = ['C#COOC(C)F(5128)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'C#COOCF(2045)'],
    products = ['C#COOC(C)F(5128)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', 'C#COO[CH]F(1532)'],
    products = ['C#COOC(C)F(5128)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C#COOC([CH2])F(1513)'],
    products = ['C#COOC(C)F(5128)'],
