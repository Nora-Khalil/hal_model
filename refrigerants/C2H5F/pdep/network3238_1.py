...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11838,0.0547858,-3.69968e-05,1.07048e-08,-8.66404e-13,1646.05,23.773], Tmin=(100,'K'), Tmax=(1309.42,'K')), NASAPolynomial(coeffs=[14.5165,0.0224297,-9.7512e-06,1.83284e-09,-1.2709e-13,-2597.6,-47.2834], Tmin=(1309.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.7646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsHHH) + group(CsCsFHH) + ring(Cs(C)-Cs-Cs(F)) + radical(Neopentyl) + radical(CsCsF1sH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=CF)C([CH2])F(8511)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(=CF)C([CH2])F(8511)'],
    products = ['[CH2]C=C([CH2])C(F)F(8746)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', '[CH2]C([CH]F)=CF(8747)'],
    products = ['[CH2]C(=CF)C([CH2])F(8511)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', '[CH2]C(F)[C]=CF(2622)'],
    products = ['[CH2]C(=CF)C([CH2])F(8511)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(=CF)C([CH2])F(8511)'],
    products = ['[CH2]C1([CH]F)CC1F(8714)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(2.50867e+09,'s^-1'), n=0.788889, Ea=(101.919,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 100.0 to 101.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(C=C)=CF(8703)'],
    products = ['[CH2]C(=CF)C([CH2])F(8511)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(=CF)C(=C)F(8523)'],
    products = ['[CH2]C(=CF)C([CH2])F(8511)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)C(C)=[C]F(8752)'],
    products = ['[CH2]C(=CF)C([CH2])F(8511)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C(CF)C([CH2])F(8755)'],
    products = ['[CH2]C(=CF)C([CH2])F(8511)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]F(837)', '[CH2]C(F)[C]=C(941)'],
    products = ['[CH2]C(=CF)C([CH2])F(8511)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CHF(40)', '[CH2]C(F)[C]=C(941)'],
    products = ['[CH2]C(=CF)C([CH2])F(8511)'],
...
network(
    label = 'PDepNetwork #3238',
    isomers = [
        '[CH2]C(=CF)C([CH2])F(8511)',
    ],
    reactants = [
