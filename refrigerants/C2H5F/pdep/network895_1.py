...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C(F)O[O](846)'],
    products = ['[CH2]C(F)OO[O](1933)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OO[CH]F(1964)', 'CH2(T)(18)'],
    products = ['[CH2]C(F)OO[O](1933)'],
    transitionState = 'TS3',
