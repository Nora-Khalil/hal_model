...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'COC(F)(F)OF(7501)'],
    products = ['CCOC(F)(F)OF(10666)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)(F)OF(7899)', 'C2H4(30)'],
    products = ['CCOC(F)(F)OF(10666)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'CCO[C](F)OF(3189)'],
    products = ['CCOC(F)(F)OF(10666)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'CCOC([O])(F)F(10672)'],
    products = ['CCOC(F)(F)OF(10666)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)(F)OF(7901)', 'C2H5(32)'],
    products = ['CCOC(F)(F)OF(10666)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FO[C](F)F(7422)', 'CC[O](149)'],
    products = ['CCOC(F)(F)OF(10666)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(160)', 'CCO[C](F)F(7413)'],
    products = ['CCOC(F)(F)OF(10666)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', '[CH2]OC(F)(F)OF(7902)'],
    products = ['CCOC(F)(F)OF(10666)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C[CH]OC(F)(F)OF(8018)'],
    products = ['CCOC(F)(F)OF(10666)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]COC(F)(F)OF(10673)'],
    products = ['CCOC(F)(F)OF(10666)'],
