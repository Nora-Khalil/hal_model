...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C[C](F)F(3564)'],
    products = ['[O]CC[C](F)F(4427)'],
    transitionState = 'TS4',
