...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=CO[C](F)OF(3073)'],
    products = ['O=COC(F)(F)OF(7495)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[O]C(F)(F)OC=O(7929)'],
    products = ['O=COC(F)(F)OF(7495)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['FO[C](F)F(7422)', '[O]C=O(147)'],
    products = ['O=COC(F)(F)OF(7495)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(F)(F)OF(7901)', 'HCO(15)'],
    products = ['O=COC(F)(F)OF(7495)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(160)', 'O=CO[C](F)F(7647)'],
    products = ['O=COC(F)(F)OF(7495)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OC(F)(F)OF(7930)'],
    products = ['O=COC(F)(F)OF(7495)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(77)', 'O=COC(=O)F(2271)'],
    products = ['O=COC(F)(F)OF(7495)'],
