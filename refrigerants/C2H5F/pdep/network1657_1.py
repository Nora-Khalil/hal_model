...
reaction(
    label = 'reaction6',
    reactants = ['OF(169)', 'C=CC(F)F(3562)'],
    products = ['FOCCC(F)F(4838)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(160)', '[CH2]CC(F)F(3446)'],
    products = ['FOCCC(F)F(4838)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OF(396)', 'CHF2-CH2(63)'],
    products = ['FOCCC(F)F(4838)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FOC[CH]C(F)F(4867)'],
    products = ['FOCCC(F)F(4838)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'FO[CH]CC(F)F(4857)'],
    products = ['FOCCC(F)F(4838)'],
