...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C=[C]C(6144)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[C]C=C(F)F(6471)'],
    products = ['[CH2]C(F)(F)C=[C]C(6144)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)C=[C]C(6197)'],
    products = ['[CH2]C(F)(F)C=[C]C(6144)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C#CC(6473)'],
    products = ['[CH2]C(F)(F)C=[C]C(6144)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2][C](F)C#CC(6400)'],
    products = ['[CH2]C(F)(F)C=[C]C(6144)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(F)(F)[CH]C=C(6474)'],
    products = ['[CH2]C(F)(F)C=[C]C(6144)'],
...
network(
    label = 'PDepNetwork #2202',
    isomers = [
        '[CH2]C(F)(F)C=[C]C(6144)',
    ],
    reactants = [
        ('CH2CF2(56)', 'C#CC(4975)'),
    ],
