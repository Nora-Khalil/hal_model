...
"""),
    E0 = (-180.129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([528,1116,1182,1331,1402,1494,3075,3110,1380,1390,370,380,2900,435,462.181,466.947,470.404],'cm^-1')),
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COC([O])F(1401)'],
    products = ['C#COC([O])CF(1504)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2F(46)', 'C#COC=O(2297)'],
    products = ['C#COC([O])CF(1504)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C#COC([CH2])[O](1495)'],
    products = ['C#COC([O])CF(1504)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HCCO(21)', '[O][CH]CF(1554)'],
    products = ['C#COC([O])CF(1504)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C2H(22)', '[O]C([O])CF(1699)'],
    products = ['C#COC([O])CF(1504)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2F(46)', '[CH]=[C]OC=O(2301)'],
    products = ['C#COC([O])CF(1504)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH]=[C]OC(=O)CF(2302)'],
    products = ['C#COC([O])CF(1504)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', 'C#COC([O])[CH]F(1829)'],
    products = ['C#COC([O])CF(1504)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C#COC([CH2])=O(1311)'],
    products = ['C#COC([O])CF(1504)'],
