...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=COC#CF(9619)'],
    products = ['O=COCC#CF(8438)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C=O(147)', '[CH2]C#CF(8406)'],
    products = ['O=COCC#CF(8438)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[C]#CF(2523)', '[CH2]OC=O(233)'],
    products = ['O=COCC#CF(8438)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=COC=C=[C]F(9623)'],
    products = ['O=COCC#CF(8438)'],
