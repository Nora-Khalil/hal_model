...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', '[O]C([O])(O)F(11743)'],
    products = ['[O]C(O)(F)O[C]=O(11734)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C([O])(O)F(11743)'],
    products = ['[O]C(O)(F)O[C]=O(11734)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(=O)O(1740)'],
    products = ['[O]C(O)(F)O[C]=O(11734)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(7)', 'O=[C]OC(=O)F(1741)'],
    products = ['[O]C(O)(F)O[C]=O(11734)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[O]C(=O)O[C]=O(247)'],
    products = ['[O]C(O)(F)O[C]=O(11734)'],
