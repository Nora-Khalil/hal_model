...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC([O])F(2035)'],
    products = ['[CH]=C(C)C([O])F(6131)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(C)C=O(6253)'],
    products = ['[CH]=C(C)C([O])F(6131)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(C)C(=O)F(6319)'],
    products = ['[CH]=C(C)C([O])F(6131)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', 'C#CC([O])F(2078)'],
    products = ['[CH]=C(C)C([O])F(6131)'],
    transitionState = 'TS9',
