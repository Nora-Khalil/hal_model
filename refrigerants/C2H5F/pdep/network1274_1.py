...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CCOF(353)'],
    products = ['CCC(=O)OF(2528)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'CC(=O)OF(2549)'],
    products = ['CCC(=O)OF(2528)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[CH2]C(=O)OF(2532)'],
    products = ['CCC(=O)OF(2528)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'C[CH]C(=O)OF(3843)'],
    products = ['CCC(=O)OF(2528)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH2]CC(=O)OF(3855)'],
    products = ['CCC(=O)OF(2528)'],
