...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1334)', '[CH2]C([O])=O(157)'],
    products = ['[O]C(=O)C[C]=CF(8430)'],
    transitionState = 'TS3',
