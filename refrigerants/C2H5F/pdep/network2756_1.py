...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)O[C](F)F(7430)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3442)', '[CH2]C([O])F(527)'],
    products = ['[CH2]C(F)O[C](F)F(7430)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]O[C](F)F(4603)'],
    products = ['[CH2]C(F)O[C](F)F(7430)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=CO[C](F)F(7545)'],
    products = ['[CH2]C(F)O[C](F)F(7430)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(F)O[C](F)F(7158)'],
    products = ['[CH2]C(F)O[C](F)F(7430)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]C([O])F(527)'],
    products = ['[CH2]C(F)O[C](F)F(7430)'],
