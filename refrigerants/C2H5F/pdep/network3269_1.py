...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62541,0.0403403,-2.9668e-06,-2.90991e-08,1.48024e-11,-21093.2,16.1129], Tmin=(100,'K'), Tmax=(986.116,'K')), NASAPolynomial(coeffs=[14.9473,0.0140805,-5.27641e-06,1.02818e-09,-7.75093e-14,-25071.2,-54.8195], Tmin=(986.116,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCsCdF) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + longDistanceInteraction_cyclic(Cs(F)-Cds(F)) + ring(Cyclobutene)"""),
)

species(
    label = 'C=C=C(F)C(=C)F(9107)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.67326,'amu*angstrom^2'), symmetry=1, barrier=(38.4715,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6737,'amu*angstrom^2'), symmetry=1, barrier=(38.4816,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21555,0.0648419,-9.45007e-05,7.43901e-08,-2.32369e-11,13597.5,20.4906], Tmin=(100,'K'), Tmax=(837.204,'K')), NASAPolynomial(coeffs=[9.80513,0.0204931,-9.11226e-06,1.67345e-09,-1.12844e-13,12275.2,-18.7302], Tmin=(837.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    E0 = (402.216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([322,421,608,607,3000,3100,440,815,1455,1000,1685,370,2175,525,750,770,3400,2100,368.998],'cm^-1')),
        HinderedRotor(inertia=(0.0173086,'amu*angstrom^2'), symmetry=1, barrier=(65.0625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.83307,'amu*angstrom^2'), symmetry=1, barrier=(65.1379,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.0755,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91074,0.0489415,-6.75042e-05,5.3642e-08,-1.71453e-11,48447.8,17.0996], Tmin=(100,'K'), Tmax=(849.747,'K')), NASAPolynomial(coeffs=[7.21676,0.0197527,-8.54432e-06,1.55215e-09,-1.0412e-13,47698.1,-6.7402], Tmin=(849.747,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(402.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCtCdF) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(CTCC=CCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH]C(F)=C(F)C=C(9111)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {1,S} {4,S} {5,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.983321,'amu*angstrom^2'), symmetry=1, barrier=(22.6085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.980933,'amu*angstrom^2'), symmetry=1, barrier=(22.5536,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34509,0.0632406,-8.3687e-05,6.30375e-08,-1.96053e-11,23351.4,22.8218], Tmin=(100,'K'), Tmax=(778.343,'K')), NASAPolynomial(coeffs=[8.47305,0.0266081,-1.30878e-05,2.56615e-09,-1.81584e-13,22241.9,-9.78015], Tmin=(778.343,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = '[CH2]C(F)=C(F)[C]=C(9113)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {1,S} {4,D} {5,S}
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2109,0.0671688,-0.000101448,8.76372e-08,-3.05485e-11,20899.3,23.1413], Tmin=(100,'K'), Tmax=(791.231,'K')), NASAPolynomial(coeffs=[7.591,0.0279392,-1.38532e-05,2.69025e-09,-1.87801e-13,20108,-4.76516], Tmin=(791.231,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(F)=CC(=C)F(9115)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29392,0.0674178,-0.000109575,1.01823e-07,-3.72289e-11,20549,23.3244], Tmin=(100,'K'), Tmax=(817.735,'K')), NASAPolynomial(coeffs=[5.62947,0.0312727,-1.5872e-05,3.09204e-09,-2.15319e-13,20339.4,6.33398], Tmin=(817.735,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', '[CH]C(F)=CF(2625)'],
    products = ['[CH]=C(F)C(F)[C]=C(8540)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(F)C=C=C(6395)'],
    products = ['[CH]=C(F)C(F)[C]=C(8540)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C(F)=C=C(9108)'],
    products = ['[CH]=C(F)C(F)[C]=C(8540)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CC(F)[C]=C(8776)'],
    products = ['[CH]=C(F)C(F)[C]=C(8540)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(F)C(F)C#C(9109)'],
    products = ['[CH]=C(F)C(F)[C]=C(8540)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(77)', '[CH]=C=C[C]=C(6850)'],
    products = ['[CH]=C(F)C(F)[C]=C(8540)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C#CC(F)=[C][CH2](9110)'],
    products = ['[CH]=C(F)C(F)[C]=C(8540)'],
