...
"""),
    E0 = (-462.719,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,286,334,437,422,648,895,1187,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.233511,'amu*angstrom^2'), symmetry=1, barrier=(5.36888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.233635,'amu*angstrom^2'), symmetry=1, barrier=(5.37174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.233597,'amu*angstrom^2'), symmetry=1, barrier=(5.37085,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0769,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47211,0.059603,-7.2715e-05,5.22934e-08,-1.57121e-11,-55564.8,21.0427], Tmin=(100,'K'), Tmax=(801.902,'K')), NASAPolynomial(coeffs=[7.89885,0.0275459,-1.27514e-05,2.44286e-09,-1.70912e-13,-56595.5,-8.54384], Tmin=(801.902,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-462.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs))"""),
)
...
"""),
    E0 = (-290.531,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,180],'cm^-1')),
        HinderedRotor(inertia=(0.260985,'amu*angstrom^2'), symmetry=1, barrier=(6.00056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260448,'amu*angstrom^2'), symmetry=1, barrier=(5.98822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.259379,'amu*angstrom^2'), symmetry=1, barrier=(5.96364,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0775,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.31948,0.0472562,-6.53353e-05,5.59793e-08,-1.92401e-11,-34937,11.3024], Tmin=(10,'K'), Tmax=(871.329,'K')), NASAPolynomial(coeffs=[5.16286,0.0284536,-1.51656e-05,3.97407e-09,-4.111e-13,-34865.7,4.91556], Tmin=(871.329,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-290.531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""C[C](F)CO""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['COF(400)', 'OC[C]F-2(1319)'],
    products = ['CC(F)(CO)OF(5725)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3OH(26)', 'C=C(F)OF(1352)'],
    products = ['CC(F)(CO)OF(5725)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.79e-05,'cm^3/(mol*s)'), n=3.97, Ea=(329.281,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [Cd_Cd;CH3OH] for rate rule [Cd/disub_Cd/unsub;CH3OH]
Euclidian distance = 1.0
family: 1,3_Insertion_ROR"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(160)', 'C[C](F)CO(5869)'],
    products = ['CC(F)(CO)OF(5725)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', '[CH2]C(C)(F)OF(2912)'],
    products = ['CC(F)(CO)OF(5725)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'CC(F)(C[O])OF(5870)'],
    products = ['CC(F)(CO)OF(5725)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2OH(33)', 'C[C](F)OF(5141)'],
    products = ['CC(F)(CO)OF(5725)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(19)', 'OC[C](F)OF(3069)'],
    products = ['CC(F)(CO)OF(5725)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'CC(F)([CH]O)OF(5842)'],
    products = ['CC(F)(CO)OF(5725)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(F)(CO)OF(5871)'],
    products = ['CC(F)(CO)OF(5725)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(77)', 'CC(=O)CO(432)'],
    products = ['CC(F)(CO)OF(5725)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(70.8862,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=C(CO)OF(2841)'],
    products = ['CC(F)(CO)OF(5725)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(200.099,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)
