...
reaction(
    label = 'reaction2',
    reactants = ['C#CC=[C-][OH+]F(9137)'],
    products = ['C#CC(F)[C-]=[OH+](8423)'],
    transitionState = 'TS2',
