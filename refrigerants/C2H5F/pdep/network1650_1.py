...
reaction(
    label = 'reaction4',
    reactants = ['[O]OC(F)F(3447)', 'CH2(S)(25)'],
    products = ['CC(F)(F)O[O](4414)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]O[C](F)F(3454)', 'CH3(19)'],
    products = ['CC(F)(F)O[O](4414)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)O[O](4448)'],
    products = ['CC(F)(F)O[O](4414)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'C=C(F)O[O](1327)'],
    products = ['CC(F)(F)O[O](4414)'],
