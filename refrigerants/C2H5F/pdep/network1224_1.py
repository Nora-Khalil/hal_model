...
"""),
    ...
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16099,0.0678409,-8.17817e-05,5.81225e-08,-1.74566e-11,-40181.4,25.3087], Tmin=(100,'K'), Tmax=(797.612,'K')), NASAPolynomial(coeffs=[8.13637,0.0328599,-1.59967e-05,3.13811e-09,-2.22732e-13,-41294.2,-6.7662], Tmin=(797.612,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.897,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(CsCsFHH) + group(Cds-OdCsH) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)
...
"""),
    E0 = (368.443,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,547.974,548.008,548.048,548.05],'cm^-1')),
        HinderedRotor(inertia=(0.123389,'amu*angstrom^2'), symmetry=1, barrier=(2.83696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04417,'amu*angstrom^2'), symmetry=1, barrier=(24.0075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123393,'amu*angstrom^2'), symmetry=1, barrier=(2.83705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84944,'amu*angstrom^2'), symmetry=1, barrier=(42.5223,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17456,0.0574361,-5.09481e-05,2.29125e-08,-4.12054e-12,44419,24.4957], Tmin=(100,'K'), Tmax=(1331.47,'K')), NASAPolynomial(coeffs=[13.7928,0.0195287,-8.24307e-06,1.53029e-09,-1.05796e-13,41058.8,-39.9926], Tmin=(1331.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18724,0.0647207,-6.81471e-05,3.77077e-08,-8.53929e-12,12362.7,24.0076], Tmin=(100,'K'), Tmax=(1053.72,'K')), NASAPolynomial(coeffs=[11.498,0.0255804,-1.243e-05,2.45684e-09,-1.75903e-13,10189.7,-26.2756], Tmin=(1053.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)

species(
    label = 'FC1C[CH]OOC1(3241)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64093,0.038403,2.28116e-05,-6.4299e-08,3.06212e-11,-21827.9,17.2711], Tmin=(100,'K'), Tmax=(896.676,'K')), NASAPolynomial(coeffs=[14.4514,0.0176351,-3.30252e-06,3.61755e-10,-2.14135e-14,-25587.7,-51.2896], Tmin=(896.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]C1OOCC1F(3242)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4044,0.0439251,1.00291e-05,-5.51425e-08,2.85986e-11,-19037.2,20.6778], Tmin=(100,'K'), Tmax=(888.032,'K')), NASAPolynomial(coeffs=[16.1136,0.01426,-1.6685e-06,3.81058e-11,1.7952e-15,-23092.5,-56.6624], Tmin=(888.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CJCOOH)"""),
)
...
"""),
    E0 = (-28.8634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,2950,3100,1380,975,1025,1650,1685,370,244.953,244.988],'cm^-1')),
        HinderedRotor(inertia=(0.196237,'amu*angstrom^2'), symmetry=1, barrier=(8.33944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196432,'amu*angstrom^2'), symmetry=1, barrier=(8.33907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09707,'amu*angstrom^2'), symmetry=1, barrier=(46.6789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.533056,'amu*angstrom^2'), symmetry=1, barrier=(22.6718,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28969,0.0651553,-7.45019e-05,5.16585e-08,-1.5465e-11,-3378.82,27.1612], Tmin=(100,'K'), Tmax=(793.049,'K')), NASAPolynomial(coeffs=[7.31239,0.034778,-1.70458e-05,3.35906e-09,-2.3925e-13,-4334.08,-0.498468], Tmin=(793.049,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.8634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COOCCF(3249)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {3,S} {4,S}
3  O u0 p2 c0 {2,S} {6,S}
...
"""),
    E0 = (-21.5115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.989001,'amu*angstrom^2'), symmetry=1, barrier=(22.7391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.988704,'amu*angstrom^2'), symmetry=1, barrier=(22.7322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.988756,'amu*angstrom^2'), symmetry=1, barrier=(22.7334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.988733,'amu*angstrom^2'), symmetry=1, barrier=(22.7329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.974979,0.0674813,-6.70461e-05,3.4718e-08,-7.31614e-12,-2479.08,25.5514], Tmin=(100,'K'), Tmax=(1131.96,'K')), NASAPolynomial(coeffs=[12.7122,0.0260046,-1.20824e-05,2.34637e-09,-1.66492e-13,-5136.22,-32.5283], Tmin=(1131.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.5115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=COOC[CH]F(2820)'],
    products = ['O=C[CH]F(414)', 'CH3CHO(36)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(35.497,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]COOC=C-2(2248)'],
    products = ['C=COOC[CH]F(2820)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(837)', '[CH2]OOC=C(387)'],
    products = ['C=COOC[CH]F(2820)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C=COOC[CH]F(2820)'],
    products = ['CH2CHO(35)', 'FC1CO1(1534)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CHO(35)', '[O]C[CH]F(973)'],
    products = ['C=COOC[CH]F(2820)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(32.5413,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH]F(839)', 'C=CO[O](502)'],
    products = ['C=COOC[CH]F(2820)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C2H3(29)', '[O]OC[CH]F(845)'],
    products = ['C=COOC[CH]F(2820)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=COO[CH][CH]F(3244)'],
    products = ['C=COOC[CH]F(2820)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=[C]OOC[CH]F(3245)'],
    products = ['C=COOC[CH]F(2820)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=COOC[CH]F(3246)'],
    products = ['C=COOC[CH]F(2820)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', '[CH2]OOC=C(387)'],
    products = ['C=COOC[CH]F(2820)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C=COOC[C]F-2(3247)'],
    products = ['C=COOC[CH]F(2820)'],
...
network(
    ...
    reactants = [
        ('O=C[CH]F(414)', 'CH3CHO(36)'),
        ('CH2CHO(35)', 'FC1CO1(1534)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
