...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(136)', '[O]O[C]=O(145)'],
    products = ['O=[C]OO[C]=O(3665)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O][C]=O(3667)', '[O][C]=O(3667)'],
    products = ['O=[C]OO[C]=O(3665)'],
    transitionState = 'TS6',
