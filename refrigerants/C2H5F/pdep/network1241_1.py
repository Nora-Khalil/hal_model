...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FCCOF(364)'],
    products = ['O=C(CCF)OF(2595)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(C[C]F)OF(3849)'],
    products = ['O=C(CCF)OF(2595)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]CC(=O)OF(3855)'],
    products = ['O=C(CCF)OF(2595)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2F(46)', '[CH2]C(=O)OF(2532)'],
    products = ['O=C(CCF)OF(2595)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(3602)', 'CH2F-CH2(61)'],
    products = ['O=C(CCF)OF(2595)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', 'O=C([CH]CF)OF(3857)'],
    products = ['O=C(CCF)OF(2595)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', 'O=C(C[CH]F)OF(3858)'],
    products = ['O=C(CCF)OF(2595)'],
