...
"""),
    ...
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39225,0.0605809,-5.45827e-05,2.62121e-08,-5.29725e-12,-42361.4,24.4281], Tmin=(100,'K'), Tmax=(1147.95,'K')), NASAPolynomial(coeffs=[10.2441,0.029737,-1.42799e-05,2.80663e-09,-2.00067e-13,-44393.8,-19.4986], Tmin=(1147.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-352.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
"""),
    E0 = (142.734,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,261,493,600,1152,1365,1422,3097,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,304.048,304.059,723.067,2111.28],'cm^-1')),
        HinderedRotor(inertia=(0.374568,'amu*angstrom^2'), symmetry=1, barrier=(24.5752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.37458,'amu*angstrom^2'), symmetry=1, barrier=(24.5753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.521864,'amu*angstrom^2'), symmetry=1, barrier=(34.2333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.37455,'amu*angstrom^2'), symmetry=1, barrier=(24.5751,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.782452,0.0652634,-6.15693e-05,2.84022e-08,-5.16594e-12,17287.3,26.0746], Tmin=(100,'K'), Tmax=(1326.86,'K')), NASAPolynomial(coeffs=[16.4495,0.0180329,-8.17561e-06,1.57504e-09,-1.11296e-13,13129.7,-53.9404], Tmin=(1326.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76494,0.0315853,4.7769e-05,-9.28578e-08,4.11907e-11,-23443.2,17.0975], Tmin=(100,'K'), Tmax=(906.164,'K')), NASAPolynomial(coeffs=[15.8885,0.0154843,-2.12679e-06,1.67288e-10,-1.08887e-14,-27901.5,-60.125], Tmin=(906.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-195.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCFHO) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]C1CC(F)OO1(1689)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52645,0.0371351,3.48644e-05,-8.34981e-08,3.90569e-11,-20652.5,20.511], Tmin=(100,'K'), Tmax=(899.456,'K')), NASAPolynomial(coeffs=[17.5457,0.0121175,-4.97342e-07,-1.55316e-10,1.22353e-14,-25404,-65.4686], Tmin=(899.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.59,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsCFHO) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CJCOOH)"""),
)
...
"""),
    E0 = (320.631,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,266.54],'cm^-1')),
        HinderedRotor(inertia=(0.999688,'amu*angstrom^2'), symmetry=1, barrier=(22.9848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.999146,'amu*angstrom^2'), symmetry=1, barrier=(22.9723,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00714492,'amu*angstrom^2'), symmetry=1, barrier=(22.9458,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.57405,'amu*angstrom^2'), symmetry=1, barrier=(59.1826,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)OOC=C(1677)'],
    products = ['CH2CFO(78)', 'CH3CHO(36)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(24.9072,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)OOC=C(1677)'],
    products = ['[CH2]C(F)OCC=O(1685)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.62709e+20,'s^-1'), n=-1.9758, Ea=(121.236,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=COO[CH]F(1686)'],
    products = ['[CH2]C(F)OOC=C(1677)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]C(F)OOC=C(1687)'],
    products = ['[CH2]C(F)OOC=C(1677)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=COOC=C(487)'],
    products = ['[CH2]C(F)OOC=C(1677)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.15e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(51.4037,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2][CH]OOC=C(956)'],
    products = ['[CH2]C(F)OOC=C(1677)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2CHO(35)', '[CH2]C([O])F(527)'],
    products = ['[CH2]C(F)OOC=C(1677)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(38.2361,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['C2H3(29)', '[CH2]C(F)O[O](846)'],
    products = ['[CH2]C(F)OOC=C(1677)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]C(F)OO[C]=C(1692)'],
    products = ['[CH2]C(F)OOC=C(1677)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=COOC([CH2])F(1693)'],
    products = ['[CH2]C(F)OOC=C(1677)'],
