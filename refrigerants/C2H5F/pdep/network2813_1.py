...
"""),
    E0 = (-263.212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,493,600,700,1144,1293,180,779.489,779.526],'cm^-1')),
        HinderedRotor(inertia=(0.722156,'amu*angstrom^2'), symmetry=1, barrier=(16.6038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0384652,'amu*angstrom^2'), symmetry=1, barrier=(16.6021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.364374,'amu*angstrom^2'), symmetry=1, barrier=(16.6068,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11161,0.0540469,-3.75454e-05,1.1951e-09,5.7086e-12,-31544.5,24.0537], Tmin=(100,'K'), Tmax=(969.67,'K')), NASAPolynomial(coeffs=[16.8957,0.0104606,-3.41801e-06,6.24181e-10,-4.6305e-14,-35617.5,-56.8271], Tmin=(969.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76705,0.0534406,-6.36436e-05,4.66901e-08,-1.47196e-11,-19638.3,22.2985], Tmin=(100,'K'), Tmax=(757.376,'K')), NASAPolynomial(coeffs=[6.55052,0.0281802,-1.36206e-05,2.66339e-09,-1.88636e-13,-20363,0.549798], Tmin=(757.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-163.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsFFHO) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2][C]1CC(F)(F)O1(4588)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789521,0.0715537,-9.63279e-05,6.63126e-08,-1.78071e-11,-18304.2,22.3895], Tmin=(100,'K'), Tmax=(918.951,'K')), NASAPolynomial(coeffs=[13.4369,0.0165042,-6.47382e-06,1.12877e-09,-7.44262e-14,-20628.8,-37.5581], Tmin=(918.951,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cs(C)-Cs(F)(F)-O2s) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
"""),
    E0 = (-175.032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,493,600,700,1144,1293,3120,650,792.5,1650,375.434,375.768],'cm^-1')),
        HinderedRotor(inertia=(0.143622,'amu*angstrom^2'), symmetry=1, barrier=(14.3226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143093,'amu*angstrom^2'), symmetry=1, barrier=(14.3218,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143392,'amu*angstrom^2'), symmetry=1, barrier=(14.3212,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03922,0.0573982,-5.20974e-05,2.0491e-08,-2.35658e-12,-20938.3,24.7223], Tmin=(100,'K'), Tmax=(1070.92,'K')), NASAPolynomial(coeffs=[15.9917,0.0127024,-5.11555e-06,9.68792e-10,-6.94312e-14,-24780.4,-51.4254], Tmin=(1070.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(CsFFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-Cd)) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)OC(F)F(8065)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {4,S} {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)O[C](F)F(7485)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3442)', '[CH2]C(=C)[O](609)'],
    products = ['[CH2]C(=C)O[C](F)F(7485)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C](F)F(4573)'],
    products = ['[CH2]C(=C)O[C](F)F(7485)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=C)O[C](F)F(7485)'],
    products = ['[CH2][C]1CC(F)(F)O1(4588)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)O[C](F)F(7485)'],
    products = ['[CH2]C1([CH2])OC1(F)F(8102)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.17979e+10,'s^-1'), n=0.520585, Ea=(112.415,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH2]C(=C)O[C](F)F(7485)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(4.80006,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]C(=C)[O](609)'],
    products = ['[CH2]C(=C)O[C](F)F(7485)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(17.2408,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(C)O[C](F)F(7481)'],
    products = ['[CH2]C(=C)O[C](F)F(7485)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(=C)O[C](F)F(7485)'],
    products = ['[CH]C(=C)OC(F)F(8065)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(6.84141e+12,'s^-1'), n=1.11009, Ea=(419.408,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_RSD;Y_rad_out;Cd_H_out_singleH] for rate rule [R4H_SSD;C_rad_out_noH;Cd_H_out_singleH]
