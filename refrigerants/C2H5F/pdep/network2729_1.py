...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3442)', '[O]C[C]=O(156)'],
    products = ['O=[C]CO[C](F)F(7406)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]O[C](F)F(4535)'],
    products = ['O=[C]CO[C](F)F(7406)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[C](F)F(4535)'],
    products = ['O=[C]CO[C](F)F(7406)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[C](F)F(7729)'],
    products = ['O=[C]CO[C](F)F(7406)'],
    transitionState = 'TS9',
