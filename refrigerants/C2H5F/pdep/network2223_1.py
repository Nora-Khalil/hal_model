...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CO[C](C)F(5119)'],
    products = ['[CH]=C(C)O[C](C)F(6518)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C[C]F-2(838)', '[CH]=C(C)[O](1728)'],
    products = ['[CH]=C(C)O[C](C)F(6518)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(C)OC(=C)F(6524)'],
    products = ['[CH]=C(C)O[C](C)F(6518)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', 'C#CO[C](C)F(1554)'],
    products = ['[CH]=C(C)O[C](C)F(6518)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C[C]F(124)', '[CH]=C(C)[O](1728)'],
    products = ['[CH]=C(C)O[C](C)F(6518)'],
