...
"""),
    E0 = (-467.224,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,375,361,584,565,722,1474,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
        HinderedRotor(inertia=(0.588884,'amu*angstrom^2'), symmetry=1, barrier=(13.5396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589933,'amu*angstrom^2'), symmetry=1, barrier=(13.5637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.590753,'amu*angstrom^2'), symmetry=1, barrier=(13.5826,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0498,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59009,0.0588457,-7.7772e-05,4.86952e-08,-8.23922e-12,-56112.8,18.9391], Tmin=(100,'K'), Tmax=(611.275,'K')), NASAPolynomial(coeffs=[8.86857,0.0212739,-1.02526e-05,1.97119e-09,-1.37138e-13,-57190.5,-14.1296], Tmin=(611.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-467.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFOO) + group(Cs-CsHHH) + radical(ROOJ)"""),
)
...
"""),
    E0 = (-360.556,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,373,336,502,477,708,1220,1477,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
        HinderedRotor(inertia=(0.717094,'amu*angstrom^2'), symmetry=1, barrier=(16.4874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78506,'amu*angstrom^2'), symmetry=1, barrier=(41.042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717248,'amu*angstrom^2'), symmetry=1, barrier=(16.4909,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0498,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57943,0.0579935,-7.73519e-05,5.83827e-08,-1.82263e-11,-43282,19.0116], Tmin=(100,'K'), Tmax=(774.619,'K')), NASAPolynomial(coeffs=[8.07709,0.0244386,-1.2371e-05,2.45417e-09,-1.74815e-13,-44288.6,-10.676], Tmin=(774.619,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFOO) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sO2sCs))"""),
)

species(
    label = '[CH2]C(O)(F)OO(5448)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {5,S} {9,S}
...
"""),
    ...
    molecularWeight = (95.0498,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15488,0.0668661,-9.51436e-05,6.99336e-08,-2.04305e-11,-48643.7,21.7126], Tmin=(100,'K'), Tmax=(838.062,'K')), NASAPolynomial(coeffs=[11.1668,0.01908,-9.61411e-06,1.89601e-09,-1.34385e-13,-50321.8,-24.8203], Tmin=(838.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFOO) + group(Cs-CsHHH) + radical(CJCOOH)"""),
)

species(
    label = 'C[C](O)OOF(5449)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-84.75,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3615,1277.5,1000,277,555,632,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350],'cm^-1')),
        HinderedRotor(inertia=(0.810782,'amu*angstrom^2'), symmetry=1, barrier=(18.6415,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.0498,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68196,0.0550201,-6.76097e-05,4.50495e-08,-1.23091e-11,-10113.1,22.1431], Tmin=(100,'K'), Tmax=(882.164,'K')), NASAPolynomial(coeffs=[9.04255,0.0216446,-1.08589e-05,2.16155e-09,-1.54868e-13,-11411.7,-12.4446], Tmin=(882.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(O)(F)O[O](5102)'],
    products = ['HO2(11)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]OC(O)F(2026)'],
    products = ['CC(O)(F)O[O](5102)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'C=C(F)O[O](1327)'],
    products = ['CC(O)(F)O[O](5102)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[C](O)F(1564)', 'CH3(19)'],
    products = ['CC(O)(F)O[O](5102)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(O)(F)O[O](1488)'],
    products = ['CC(O)(F)O[O](5102)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'CC(=O)O[O](188)'],
    products = ['CC(O)(F)O[O](5102)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(163.111,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'C=C(O)O[O](187)'],
    products = ['CC(O)(F)O[O](5102)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(173.121,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)

reaction(
    label = 'reaction14',
    reactants = ['CC([O])(F)OO(5103)'],
    products = ['CC(O)(F)O[O](5102)'],
