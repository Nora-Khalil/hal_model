...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=[C]C([O])F(2181)'],
    products = ['[CH2]OC(F)[C]=C(10817)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(271)', '[CH2]O[CH]F(339)'],
    products = ['[CH2]OC(F)[C]=C(10817)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C=C(6482)'],
    products = ['[CH2]OC(F)[C]=C(10817)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', '[CH2]OC(F)=C=C(11013)'],
    products = ['[CH2]OC(F)[C]=C(10817)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'C#CC(F)O[CH2](11014)'],
    products = ['[CH2]OC(F)[C]=C(10817)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OC(F)[C]=C(10817)'],
    products = ['[CH2]C=C(F)O[CH2](11015)'],
