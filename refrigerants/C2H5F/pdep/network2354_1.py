...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49837,0.0589041,-5.29795e-05,2.61852e-08,-5.53151e-12,-36418.7,19.6966], Tmin=(100,'K'), Tmax=(1093.2,'K')), NASAPolynomial(coeffs=[9.10336,0.0310773,-1.47975e-05,2.90032e-09,-2.06528e-13,-38081.4,-17.6707], Tmin=(1093.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-303.524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (118.093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,344.98,344.981],'cm^-1')),
        HinderedRotor(inertia=(0.106698,'amu*angstrom^2'), symmetry=1, barrier=(9.01098,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106698,'amu*angstrom^2'), symmetry=1, barrier=(9.01098,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73336,0.0464931,-3.40191e-05,1.28865e-08,-2.00614e-12,14287.5,21.533], Tmin=(100,'K'), Tmax=(1484.75,'K')), NASAPolynomial(coeffs=[10.9449,0.0216766,-8.94753e-06,1.62902e-09,-1.10613e-13,11552.1,-26.5482], Tmin=(1484.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.747795,'amu*angstrom^2'), symmetry=1, barrier=(17.1933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.749064,'amu*angstrom^2'), symmetry=1, barrier=(17.2225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26694,0.0656489,-8.05206e-05,5.69012e-08,-1.6891e-11,-10988.6,21.8342], Tmin=(100,'K'), Tmax=(807.739,'K')), NASAPolynomial(coeffs=[8.36386,0.030503,-1.52508e-05,3.02878e-09,-2.16508e-13,-12135,-10.8888], Tmin=(807.739,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.1414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)
...
"""),
    E0 = (-131.368,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,903.615],'cm^-1')),
        HinderedRotor(inertia=(0.32005,'amu*angstrom^2'), symmetry=1, barrier=(7.35858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06336,'amu*angstrom^2'), symmetry=1, barrier=(24.4486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.018482,'amu*angstrom^2'), symmetry=1, barrier=(24.4459,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20143,0.0605974,-5.24083e-05,2.33722e-08,-4.26491e-12,-15698.5,22.5515], Tmin=(100,'K'), Tmax=(1287.3,'K')), NASAPolynomial(coeffs=[12.4864,0.0255314,-1.15479e-05,2.21118e-09,-1.55295e-13,-18603.9,-34.7419], Tmin=(1287.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = '[CH]=CCC([CH2])(F)F(6934)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (-25.3846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,215,315,519,588,595,1205,1248,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,511.569],'cm^-1')),
        HinderedRotor(inertia=(0.635031,'amu*angstrom^2'), symmetry=1, barrier=(14.6006,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.336534,'amu*angstrom^2'), symmetry=1, barrier=(7.73758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.635278,'amu*angstrom^2'), symmetry=1, barrier=(14.6063,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0468,0.0678371,-7.22997e-05,4.14333e-08,-9.74093e-12,-2949.08,24.6265], Tmin=(100,'K'), Tmax=(1017.68,'K')), NASAPolynomial(coeffs=[11.3043,0.0275199,-1.28744e-05,2.50449e-09,-1.77786e-13,-5036.83,-25.0396], Tmin=(1017.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.3846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-CsF1sF1s)(H)(H)) + radical(Cds_P)"""),
)

species(
    label = 'C=[C][CH]C(C)(F)F(6477)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {3,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {5,S}
...
"""),
    E0 = (0.391133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([222,329,445,522,589,1214,1475,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.465053,'amu*angstrom^2'), symmetry=1, barrier=(10.6925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.464487,'amu*angstrom^2'), symmetry=1, barrier=(10.6795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.464307,'amu*angstrom^2'), symmetry=1, barrier=(10.6753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03048,0.0705784,-8.82824e-05,6.38591e-08,-1.9244e-11,149.229,23.5275], Tmin=(100,'K'), Tmax=(799.654,'K')), NASAPolynomial(coeffs=[8.81518,0.0316404,-1.52467e-05,2.97345e-09,-2.10155e-13,-1095.86,-12.2892], Tmin=(799.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.391133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=[C]C[C](F)CF(6936)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6036,0.0620862,-5.0767e-05,-1.69183e-08,4.25465e-11,-7606.11,24.4629], Tmin=(100,'K'), Tmax=(501.594,'K')), NASAPolynomial(coeffs=[7.18891,0.0340783,-1.64504e-05,3.18225e-09,-2.22674e-13,-8374.39,-0.702527], Tmin=(501.594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.8795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(134)', '[CH2]C([CH2])(F)F(4485)'],
    products = ['[CH2]C(F)(F)C[C]=C(6686)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=[C]CC(=C)F(6673)'],
    products = ['[CH2]C(F)(F)C[C]=C(6686)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(52.1362,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(5.26262e-11,'m^3/(mol*s)'), n=4.71246, Ea=(6.80653,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(266.624,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C[C]=C(6686)'],
    products = ['[CH2]C(F)(F)[CH]C=C(6474)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)C[C]=C(6686)'],
    products = ['[CH2][C](F)CC(=C)F(6937)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(213.193,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
