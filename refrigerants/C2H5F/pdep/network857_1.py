...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(357)', '[CH2]C(=C)O(2353)'],
    products = ['C=C(O)COF(2506)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OF(278)', 'C=[C]O(606)'],
    products = ['C=C(O)COF(2506)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', 'C=C(O)[CH]OF(2639)'],
    products = ['C=C(O)COF(2506)'],
