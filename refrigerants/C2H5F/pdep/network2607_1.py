...
reaction(
    label = 'reaction1',
    reactants = ['C=CCC(=C)OF(7234)'],
    products = ['HF(38)', 'CH2CO(28)', 'C=C=C(6556)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=CC(=C)OF(1953)'],
    products = ['C=CCC(=C)OF(7234)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C([CH]C=C)OF(7256)'],
    products = ['C=CCC(=C)OF(7234)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]CC=C([CH2])OF(7257)'],
    products = ['C=CCC(=C)OF(7234)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(160)', 'C=[C]CC=C(6720)'],
    products = ['C=CCC(=C)OF(7234)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]OF(491)', '[CH2]C=C(2401)'],
    products = ['C=CCC(=C)OF(7234)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C2H3(29)', '[CH2]C(=C)OF(669)'],
    products = ['C=CCC(=C)OF(7234)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C=CC(=C)OF(7264)'],
    products = ['C=CCC(=C)OF(7234)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C=[C]CC(=C)OF(7265)'],
    products = ['C=CCC(=C)OF(7234)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH]=C(CC=C)OF(7266)'],
    products = ['C=CCC(=C)OF(7234)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH]=CCC(=C)OF(7267)'],
    products = ['C=CCC(=C)OF(7234)'],
