...
"""),
    E0 = (-162.8,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,528,1116,1182,1331,1402,1494,3075,3110,2175,525,239,401,1367,318.069,318.111,2500.7],'cm^-1')),
        HinderedRotor(inertia=(0.181019,'amu*angstrom^2'), symmetry=1, barrier=(12.9978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181027,'amu*angstrom^2'), symmetry=1, barrier=(12.9976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.951917,'amu*angstrom^2'), symmetry=1, barrier=(68.3442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53887,0.0574606,-5.5594e-05,3.23409e-08,-8.15397e-12,-19494.5,22.2716], Tmin=(100,'K'), Tmax=(930.256,'K')), NASAPolynomial(coeffs=[7.50387,0.0318119,-1.42369e-05,2.70255e-09,-1.88918e-13,-20604.3,-6.07488], Tmin=(930.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(CsCsFHH) + group(Ct-CtCs) + group(CtCF)"""),
)
...
"""),
    E0 = (-153.306,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,2175,525,239,401,1367,180,969.891],'cm^-1')),
        HinderedRotor(inertia=(0.348053,'amu*angstrom^2'), symmetry=1, barrier=(8.00243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.20843,'amu*angstrom^2'), symmetry=1, barrier=(27.7843,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (203.688,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2175,525,617,898,1187,239,401,1367,295.703,295.725],'cm^-1')),
        HinderedRotor(inertia=(0.00202574,'amu*angstrom^2'), symmetry=1, barrier=(7.44156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119937,'amu*angstrom^2'), symmetry=1, barrier=(7.44151,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07853,'amu*angstrom^2'), symmetry=1, barrier=(66.9235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77456,0.0537218,-5.86758e-05,3.15072e-08,-3.48219e-12,24573.8,22.7567], Tmin=(100,'K'), Tmax=(621.776,'K')), NASAPolynomial(coeffs=[7.3246,0.0261431,-1.17466e-05,2.20797e-09,-1.52558e-13,23726.5,-2.64492], Tmin=(621.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsHH) + group(Cs-CsCsHH) + group(Ct-CtCs) + group(CJ2_singlet-FCs) + group(CtCF)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00338057,'amu*angstrom^2'), symmetry=1, barrier=(11.3626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949809,'amu*angstrom^2'), symmetry=1, barrier=(21.838,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (31.7424,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,2175,525,239,401,1367,337.34,337.352,337.636],'cm^-1')),
        HinderedRotor(inertia=(0.0183351,'amu*angstrom^2'), symmetry=1, barrier=(48.0889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127586,'amu*angstrom^2'), symmetry=1, barrier=(10.3149,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00393336,'amu*angstrom^2'), symmetry=1, barrier=(10.3167,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25576,0.0469485,-1.24494e-05,-7.65548e-08,8.52239e-11,3871.54,22.4151], Tmin=(100,'K'), Tmax=(453.316,'K')), NASAPolynomial(coeffs=[5.67598,0.0322716,-1.51819e-05,2.90424e-09,-2.01953e-13,3402.17,6.86354], Tmin=(453.316,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.7424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(CsCsFHH) + group(Ct-CtCs) + group(CtCF) + radical(Cs_S)"""),
)
...
"""),
    E0 = (-30.7856,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,3010,987.5,1337.5,450,1655,540,610,2055,137,207,812,321.276,321.437],'cm^-1')),
        HinderedRotor(inertia=(0.110419,'amu*angstrom^2'), symmetry=1, barrier=(8.10797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.299507,'amu*angstrom^2'), symmetry=1, barrier=(21.9591,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62698,0.054629,-4.99948e-05,2.52665e-08,-5.39944e-12,-3619.24,22.5612], Tmin=(100,'K'), Tmax=(1092.36,'K')), NASAPolynomial(coeffs=[9.07116,0.0273694,-1.2562e-05,2.42083e-09,-1.70836e-13,-5245.55,-14.0101], Tmin=(1092.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.7856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cdj(Cdd-Cd)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.06729,'amu*angstrom^2'), symmetry=1, barrier=(24.5392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06759,'amu*angstrom^2'), symmetry=1, barrier=(24.546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07022,'amu*angstrom^2'), symmetry=1, barrier=(24.6064,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11486,0.0685663,-7.72668e-05,4.90357e-08,-1.30398e-11,-8736.49,21.7906], Tmin=(100,'K'), Tmax=(896.865,'K')), NASAPolynomial(coeffs=[9.4115,0.0315633,-1.53792e-05,3.03257e-09,-2.16419e-13,-10224.7,-17.3328], Tmin=(896.865,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.4669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CdCCF) + group(CdJ2_singlet-Cds)"""),
)
...
"""),
    E0 = (158.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2175,525,239,401,1367,180,408.668],'cm^-1')),
        HinderedRotor(inertia=(0.154501,'amu*angstrom^2'), symmetry=1, barrier=(3.55229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0191978,'amu*angstrom^2'), symmetry=1, barrier=(16.1705,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15258,0.0387409,-2.45365e-05,7.63125e-09,-9.68934e-13,19114.5,18.9459], Tmin=(100,'K'), Tmax=(1760.14,'K')), NASAPolynomial(coeffs=[10.4639,0.019853,-8.44003e-06,1.53453e-09,-1.02986e-13,16188.7,-25.8505], Tmin=(1760.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'FC#CCCF(11633)'],
    products = ['FC#CCCCF(8517)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'F[C]CCC#CF(11634)'],
    products = ['FC#CCCCF(8517)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]CCC#CF(8668)'],
    products = ['FC#CCCCF(8517)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2F-CH2(61)', '[CH2]C#CF(8406)'],
    products = ['FC#CCCCF(8517)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2F(46)', '[CH2]CC#CF(2576)'],
    products = ['FC#CCCCF(8517)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'FC#CC[CH]CF(11637)'],
    products = ['FC#CCCCF(8517)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]#CF(2523)', '[CH2]CCF(1648)'],
    products = ['FC#CCCCF(8517)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C]=C=CCCF(11638)'],
    products = ['FC#CCCCF(8517)'],
