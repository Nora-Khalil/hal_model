...
"""),
    E0 = (204.415,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,615,860,1140,1343,3152,1685,370,2175,525,239,401,1367,290.844,295.7,1359.96],'cm^-1')),
        HinderedRotor(inertia=(0.095309,'amu*angstrom^2'), symmetry=1, barrier=(5.69869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0915928,'amu*angstrom^2'), symmetry=1, barrier=(5.73306,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16321,0.0475748,-4.06601e-05,-9.80324e-09,3.05465e-11,24644.4,20.3286], Tmin=(100,'K'), Tmax=(502.705,'K')), NASAPolynomial(coeffs=[6.49305,0.0256379,-1.25479e-05,2.43997e-09,-1.71203e-13,24050.9,0.844613], Tmin=(502.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(Cds-CdsCsH) + group(CdCFH) + group(Ct-CtCs) + group(CtCF) + radical(Cds_S)"""),
)
...
"""),
    E0 = (216.691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2175,525,167,640,1190,239,401,1367,411.858,1334.93],'cm^-1')),
        HinderedRotor(inertia=(0.0740181,'amu*angstrom^2'), symmetry=1, barrier=(8.609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0724539,'amu*angstrom^2'), symmetry=1, barrier=(8.64622,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85028,0.0512912,-6.29617e-05,4.56489e-08,-1.39503e-11,26135.7,21.3849], Tmin=(100,'K'), Tmax=(785.568,'K')), NASAPolynomial(coeffs=[7.10084,0.0245569,-1.19158e-05,2.33054e-09,-1.65011e-13,25310.8,-2.67892], Tmin=(785.568,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtHH) + group(Cds-CdsCsH) + group(CdCFH) + group(Ct-CtCs) + group(CtCF) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (205.404,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,125,209,569,711,1121,1259,238.045,239.836],'cm^-1')),
        HinderedRotor(inertia=(0.0029679,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201665,'amu*angstrom^2'), symmetry=1, barrier=(8.2312,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6348,0.0532295,-5.32176e-05,2.87293e-08,-6.37463e-12,24788.6,23.3157], Tmin=(100,'K'), Tmax=(1074.54,'K')), NASAPolynomial(coeffs=[9.95449,0.022259,-9.98406e-06,1.90612e-09,-1.3396e-13,23000.6,-17.4201], Tmin=(1074.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(205.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(CdCFH) + radical(Cdj(Cd-CsH)(F1s)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'F[C]=[C]CC=CF(9022)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {6,S} {8,S} {9,S}
...
"""),
    E0 = (193.128,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,1685,370,167,640,1190,265.902,268.019],'cm^-1')),
        HinderedRotor(inertia=(0.0948309,'amu*angstrom^2'), symmetry=1, barrier=(4.76268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0937005,'amu*angstrom^2'), symmetry=1, barrier=(4.83082,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67211,0.0531387,-5.32843e-05,2.90433e-08,-6.55134e-12,21835.3,23.9242], Tmin=(100,'K'), Tmax=(1053.35,'K')), NASAPolynomial(coeffs=[9.55894,0.023189,-1.06349e-05,2.05019e-09,-1.44809e-13,20173.8,-14.5351], Tmin=(1053.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFF) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1334)', 'C=C[C]F(2573)'],
    products = ['F[C]=CC[C]=CF(8544)'],
    transitionState = 'TS3',
