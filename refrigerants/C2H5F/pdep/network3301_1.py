...
"""),
    E0 = (217.855,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,1685,370,204.533],'cm^-1')),
        HinderedRotor(inertia=(0.529019,'amu*angstrom^2'), symmetry=1, barrier=(15.3675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.56819,'amu*angstrom^2'), symmetry=1, barrier=(15.4058,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915446,'amu*angstrom^2'), symmetry=1, barrier=(25.2672,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.601006,'amu*angstrom^2'), symmetry=1, barrier=(13.8183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.602602,'amu*angstrom^2'), symmetry=1, barrier=(13.855,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75486,0.0512858,-5.55077e-05,3.48056e-08,-9.06705e-12,39490.1,20.4202], Tmin=(100,'K'), Tmax=(922.024,'K')), NASAPolynomial(coeffs=[8.21668,0.0232524,-9.90107e-06,1.82961e-09,-1.2578e-13,38298.5,-10.2296], Tmin=(922.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CdH)(Cd-F1sH))"""),
)

species(
    label = 'CC1=CC(=CF)C1(9379)',
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38867,0.0407397,2.38355e-05,-6.49882e-08,2.91343e-11,-1228.45,19.4967], Tmin=(100,'K'), Tmax=(953.997,'K')), NASAPolynomial(coeffs=[16.676,0.0180274,-5.52548e-06,1.003e-09,-7.55845e-14,-6028.55,-63.4064], Tmin=(953.997,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.1217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=C=CC(C)=CF(8578)',
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.624928,0.0656204,-5.69582e-05,2.54523e-08,-4.52098e-12,744.313,22.4306], Tmin=(100,'K'), Tmax=(1359.28,'K')), NASAPolynomial(coeffs=[15.7481,0.0211174,-7.84867e-06,1.36653e-09,-9.11603e-14,-3367.06,-55.1723], Tmin=(1359.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.11844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73058,0.0350483,3.08102e-05,-6.3119e-08,2.59806e-11,17987.2,19.1066], Tmin=(100,'K'), Tmax=(980.987,'K')), NASAPolynomial(coeffs=[13.0218,0.0251656,-9.36577e-06,1.75672e-09,-1.27833e-13,14032.1,-44.0176], Tmin=(980.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(CsCCFH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cs(F)-Cs-Cd-Cd) + radical(Allyl_T) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1([CH]F)C=C1C(9403)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
...
"""),
    E0 = (147.779,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,2100,2250,500,550,271.227],'cm^-1')),
        HinderedRotor(inertia=(0.315674,'amu*angstrom^2'), symmetry=1, barrier=(16.4957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40569,'amu*angstrom^2'), symmetry=1, barrier=(73.1489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0579693,'amu*angstrom^2'), symmetry=1, barrier=(73.1295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32503,0.052187,-3.15932e-05,3.0045e-09,3.11434e-12,17875.8,22.6191], Tmin=(100,'K'), Tmax=(985.42,'K')), NASAPolynomial(coeffs=[11.9224,0.0229965,-8.20577e-06,1.4205e-09,-9.60402e-14,15116,-31.7575], Tmin=(985.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-CtHHH) + group(Cds-CdsCtCs) + group(CdCFH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=CC([CH2])=CF(9445)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    E0 = (98.0691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,194,682,905,1196,1383,3221,438.687],'cm^-1')),
        HinderedRotor(inertia=(0.467876,'amu*angstrom^2'), symmetry=1, barrier=(63.9159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210199,'amu*angstrom^2'), symmetry=1, barrier=(28.714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.467774,'amu*angstrom^2'), symmetry=1, barrier=(63.9255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04036,0.0526284,-9.82818e-06,-2.95962e-08,1.65746e-11,11912.8,23.7175], Tmin=(100,'K'), Tmax=(956.081,'K')), NASAPolynomial(coeffs=[15.9002,0.0205597,-6.74096e-06,1.18104e-09,-8.37772e-14,7695.64,-54.4998], Tmin=(956.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.0691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(Allyl_P) + radical(C=CC=CCJ)"""),
)

species(
    label = '[CH2]C([C]=CC)=CF(9446)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.618704,0.068815,-6.47016e-05,3.23742e-08,-6.48144e-12,21656.2,23.2701], Tmin=(100,'K'), Tmax=(1209.78,'K')), NASAPolynomial(coeffs=[14.2915,0.0236075,-8.6491e-06,1.48565e-09,-9.83643e-14,18348,-45.2972], Tmin=(1209.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(Allyl_P) + radical(C=CJC=C)"""),
)

species(
    label = 'CC#C[C](C)[CH]F(9447)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.892598,0.0703897,-8.58655e-05,6.22307e-08,-1.80601e-11,26091.9,25.4913], Tmin=(100,'K'), Tmax=(951.464,'K')), NASAPolynomial(coeffs=[8.85158,0.0298331,-1.07394e-05,1.75255e-09,-1.09546e-13,24898.6,-10.8221], Tmin=(951.464,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsHHH) + group(CsCsFHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Tert_Propargyl) + radical(CsCsF1sH)"""),
)

species(
    label = 'C[C]=CC(C)=[C]F(9448)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {6,S} {11,S} {12,S} {13,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.557739,'amu*angstrom^2'), symmetry=1, barrier=(12.8235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.558523,'amu*angstrom^2'), symmetry=1, barrier=(12.8416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.558526,'amu*angstrom^2'), symmetry=1, barrier=(12.8416,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00376,0.0683177,-7.22418e-05,4.31707e-08,-1.0682e-11,38945.6,23.1471], Tmin=(100,'K'), Tmax=(968.356,'K')), NASAPolynomial(coeffs=[10.2462,0.0301392,-1.31021e-05,2.4554e-09,-1.7048e-13,37155.7,-21.1453], Tmin=(968.356,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(Cds_S) + radical(CdCdF1s)"""),
)

species(
    label = 'C=C([C]F)C=CC(9449)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {5,S} {6,D} {7,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0614,0.0627491,-5.35547e-05,2.3944e-08,-4.3849e-12,26011.3,22.2148], Tmin=(100,'K'), Tmax=(1285.58,'K')), NASAPolynomial(coeffs=[12.6263,0.0267655,-1.15693e-05,2.17147e-09,-1.50917e-13,23037.8,-36.4846], Tmin=(1285.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.379,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.702213,'amu*angstrom^2'), symmetry=1, barrier=(16.1453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.702225,'amu*angstrom^2'), symmetry=1, barrier=(16.1455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.702145,'amu*angstrom^2'), symmetry=1, barrier=(16.1437,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02428,0.067507,-6.76069e-05,3.72618e-08,-8.49988e-12,39764.3,23.6159], Tmin=(100,'K'), Tmax=(1043.66,'K')), NASAPolynomial(coeffs=[10.9002,0.0296565,-1.32073e-05,2.51309e-09,-1.76249e-13,37702.9,-24.4518], Tmin=(1043.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)C=C(C)F(9451)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {5,S} {6,D} {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.681682,'amu*angstrom^2'), symmetry=1, barrier=(15.6732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.684117,'amu*angstrom^2'), symmetry=1, barrier=(15.7292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.683616,'amu*angstrom^2'), symmetry=1, barrier=(15.7177,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8666,0.0304817,4.41682e-05,-7.76487e-08,3.13494e-11,21248.7,20.7678], Tmin=(100,'K'), Tmax=(971.62,'K')), NASAPolynomial(coeffs=[13.2914,0.0240714,-8.65043e-06,1.62347e-09,-1.19547e-13,17111.1,-43.8888], Tmin=(971.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Allyl_T) + radical(Csj(Cd-CsCd)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36137,0.0604508,-4.76487e-05,5.43748e-09,1.12701e-11,27258,25.6502], Tmin=(100,'K'), Tmax=(672.46,'K')), NASAPolynomial(coeffs=[9.59853,0.0271517,-8.38765e-06,1.22932e-09,-7.12667e-14,25795.3,-13.4599], Tmin=(672.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Tert_Propargyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH]C(C=CC)=CF(9454)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {5,S} {6,D} {7,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.650239,0.0651843,-4.52279e-05,1.37505e-08,-9.02539e-13,24085.8,24.3919], Tmin=(100,'K'), Tmax=(1128.77,'K')), NASAPolynomial(coeffs=[13.7833,0.0291797,-1.13812e-05,2.02827e-09,-1.37509e-13,20449.8,-43.5311], Tmin=(1128.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(199.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C(=C[C]=C)CF(9455)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {8,S} {9,S}
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[C]=C[C]=CF(6376)'],
    products = ['[CH2]C(C=[C]C)=CF(8569)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C=[C]C)=CF(8569)'],
    products = ['[CH2]C1=C[C](C)C1F(9443)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C=[C]C)=CF(8569)'],
    products = ['[CH2]C1([CH]F)C=C1C(9403)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(C=C=C)=CF(8625)'],
    products = ['[CH2]C(C=[C]C)=CF(8569)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(C#CC)=CF(9444)'],
    products = ['[CH2]C(C=[C]C)=CF(8569)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C=CC([CH2])=CF(9445)'],
    products = ['[CH2]C(C=[C]C)=CF(8569)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]F(837)', 'C=[C]C=[C]C(6249)'],
    products = ['[CH2]C(C=[C]C)=CF(8569)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(C=[C]C)=CF(8569)'],
    products = ['C[C]1C=C([CH]F)C1(9452)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CHF(40)', 'C=[C]C=[C]C(6249)'],
    products = ['[CH2]C(C=[C]C)=CF(8569)'],
