...
"""),
    E0 = (33.2611,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,255,533,799,832,1228,3000,3100,440,815,1455,1000,1685,370,2268.11],'cm^-1')),
        HinderedRotor(inertia=(0.585162,'amu*angstrom^2'), symmetry=1, barrier=(13.454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63667,'amu*angstrom^2'), symmetry=1, barrier=(37.6303,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24225,0.0413636,-4.17834e-05,2.36141e-08,-5.64281e-12,4061.44,18.6912], Tmin=(100,'K'), Tmax=(986.026,'K')), NASAPolynomial(coeffs=[7.44897,0.0202413,-9.65062e-06,1.8884e-09,-1.34349e-13,3034.66,-6.35484], Tmin=(986.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.2611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(COCFO) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-129.701,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,351,323,533,609,664,892,1120,1201,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.4038,'amu*angstrom^2'), symmetry=1, barrier=(9.28416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.40375,'amu*angstrom^2'), symmetry=1, barrier=(9.283,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47868,0.0572576,-6.04995e-05,3.36576e-08,-7.61978e-12,-15510.1,23.2079], Tmin=(100,'K'), Tmax=(1058.54,'K')), NASAPolynomial(coeffs=[10.8673,0.02178,-1.02261e-05,1.99551e-09,-1.41988e-13,-17497.8,-22.6208], Tmin=(1058.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(Cds_P)"""),
)
...
"""),
    E0 = (164.845,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,2950,3100,1380,975,1025,1650,1685,370,232.357,232.762,232.781],'cm^-1')),
        HinderedRotor(inertia=(0.192362,'amu*angstrom^2'), symmetry=1, barrier=(7.40628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193204,'amu*angstrom^2'), symmetry=1, barrier=(7.40602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.53887,'amu*angstrom^2'), symmetry=1, barrier=(20.7237,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01707,0.0718786,-0.000112317,9.72392e-08,-3.36153e-11,19927.7,25.1052], Tmin=(100,'K'), Tmax=(798.873,'K')), NASAPolynomial(coeffs=[8.39185,0.0271402,-1.36452e-05,2.6549e-09,-1.85157e-13,18998.7,-7.25753], Tmin=(798.873,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cds_S)"""),
)

species(
    label = 'C=C(F)C[C]([O])F(1734)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {6,S}
...
"""),
    E0 = (-189.429,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,395,473,707,1436,2950,3100,1380,975,1025,1650,180,180,3293.75],'cm^-1')),
        HinderedRotor(inertia=(0.377175,'amu*angstrom^2'), symmetry=1, barrier=(8.672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.377122,'amu*angstrom^2'), symmetry=1, barrier=(8.67077,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26083,0.0653592,-9.68032e-05,8.13212e-08,-2.74448e-11,-22689.3,24.5869], Tmin=(100,'K'), Tmax=(810.435,'K')), NASAPolynomial(coeffs=[7.99302,0.0259157,-1.22938e-05,2.3394e-09,-1.61328e-13,-23576.4,-5.21755], Tmin=(810.435,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(CdCsCdF) + group(Cds-CdsHH) + radical(O2sj(Cs-CsF1sH)) + radical(CsCsF1sO2s)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', '[CH2]C([O])(F)F(1349)'],
    products = ['C=[C]CC([O])(F)F(7486)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C[C](F)F(4530)'],
    products = ['C=[C]CC([O])(F)F(7486)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C](F)F(4247)', '[CH2][C]=C(6610)'],
    products = ['C=[C]CC([O])(F)F(7486)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH2][C]=CC(=O)F(8097)'],
    products = ['C=[C]CC([O])(F)F(7486)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(3027.76,'m^3/(mol*s)'), n=0.596786, Ea=(282.04,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.06681560721952781, var=6.699388179313154, Tref=1000.0, N=4, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F"""),
)

reaction(
    label = 'reaction14',
    reactants = ['C=[C]CC([O])(F)F(7486)'],
    products = ['C=C[CH]C([O])(F)F(8079)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=[C]CC([O])(F)F(7486)'],
    products = ['C=C(F)C[C]([O])F(1734)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(203.426,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
