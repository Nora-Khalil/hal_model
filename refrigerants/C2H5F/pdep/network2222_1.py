...
"""),
    E0 = (-14.8458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,395,473,707,1436,3010,987.5,1337.5,450,1655,1685,370,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.7714,'amu*angstrom^2'), symmetry=1, barrier=(17.736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.773315,'amu*angstrom^2'), symmetry=1, barrier=(17.78,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.77379,'amu*angstrom^2'), symmetry=1, barrier=(17.791,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.773819,'amu*angstrom^2'), symmetry=1, barrier=(17.7916,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.302738,0.0746349,-7.50933e-05,3.80653e-08,-7.56743e-12,-1646.77,25.2086], Tmin=(100,'K'), Tmax=(1228.53,'K')), NASAPolynomial(coeffs=[17.3345,0.01918,-7.38358e-06,1.32189e-09,-9.02126e-14,-5831.53,-60.4651], Tmin=(1228.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-14.8458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CsCsF1sO2s) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2881,0.0575293,-4.30202e-05,1.66728e-08,-2.67498e-12,-30139.5,23.9883], Tmin=(100,'K'), Tmax=(1431.99,'K')), NASAPolynomial(coeffs=[11.8921,0.027909,-1.19931e-05,2.22802e-09,-1.53183e-13,-33176.4,-30.9773], Tmin=(1431.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(CdCFO) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-13.5756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,326,540,652,719,1357,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,267.497,267.5,267.504],'cm^-1')),
        HinderedRotor(inertia=(0.143712,'amu*angstrom^2'), symmetry=1, barrier=(7.29726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143712,'amu*angstrom^2'), symmetry=1, barrier=(7.29727,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.384228,'amu*angstrom^2'), symmetry=1, barrier=(19.5094,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47373,0.0593912,-5.7694e-05,3.24244e-08,-7.82551e-12,-1545,23.8094], Tmin=(100,'K'), Tmax=(970.407,'K')), NASAPolynomial(coeffs=[8.23575,0.0315178,-1.4608e-05,2.82394e-09,-1.99566e-13,-2857.36,-8.61011], Tmin=(970.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.5756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-49.5166,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,395,473,707,1436,2100,2250,500,550,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.02171,'amu*angstrom^2'), symmetry=1, barrier=(23.4911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02128,'amu*angstrom^2'), symmetry=1, barrier=(23.4813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0223,'amu*angstrom^2'), symmetry=1, barrier=(23.5048,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02148,'amu*angstrom^2'), symmetry=1, barrier=(23.4859,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.456261,0.0695398,-6.95593e-05,3.51633e-08,-6.93412e-12,-5820.76,23.2557], Tmin=(100,'K'), Tmax=(1244.79,'K')), NASAPolynomial(coeffs=[16.9556,0.0165206,-5.66957e-06,9.46017e-10,-6.19755e-14,-9928.39,-59.9569], Tmin=(1244.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.5166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.263814,0.0725795,-6.20104e-05,2.04197e-08,-5.32754e-13,539.879,26.241], Tmin=(100,'K'), Tmax=(1011.09,'K')), NASAPolynomial(coeffs=[18.7611,0.0172303,-6.3466e-06,1.15705e-09,-8.19602e-14,-4111.91,-67.7083], Tmin=(1011.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.30024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Csj(Cs-F1sO2sH)(H)(H)) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.800456,0.0687862,-6.66639e-05,3.39023e-08,-6.96164e-12,-1440.19,26.0776], Tmin=(100,'K'), Tmax=(1168.7,'K')), NASAPolynomial(coeffs=[13.5267,0.0252295,-1.07599e-05,2.0128e-09,-1.40066e-13,-4414.82,-37.3029], Tmin=(1168.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.9434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CsCsF1sO2s) + radical(C=CJO)"""),
)

species(
    label = 'C[C]=[C]OC(C)F(6536)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {3,S} {7,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {8,S}
...
"""),
    E0 = (30.3442,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1670,1700,300,440,287.246,287.246,287.246],'cm^-1')),
        HinderedRotor(inertia=(0.282851,'amu*angstrom^2'), symmetry=1, barrier=(16.5613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282851,'amu*angstrom^2'), symmetry=1, barrier=(16.5613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282851,'amu*angstrom^2'), symmetry=1, barrier=(16.5613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282851,'amu*angstrom^2'), symmetry=1, barrier=(16.5613,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.638029,0.0679449,-6.17162e-05,2.85422e-08,-5.25623e-12,3775.57,26.3326], Tmin=(100,'K'), Tmax=(1307.55,'K')), NASAPolynomial(coeffs=[15.6725,0.0219523,-8.95461e-06,1.64132e-09,-1.12895e-13,-156.118,-50.2317], Tmin=(1307.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.3442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = '[CH2][C](F)OC=CC(6537)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {6,S}
3  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.132585,0.0768084,-7.83807e-05,3.9867e-08,-7.89548e-12,-4663.14,27.7367], Tmin=(100,'K'), Tmax=(1238.81,'K')), NASAPolynomial(coeffs=[18.5497,0.0173414,-6.3756e-06,1.11736e-09,-7.55459e-14,-9226.19,-65.0591], Tmin=(1238.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.9874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C[C]F-2(838)', 'C[C]=C[O](6236)'],
    products = ['C[C]=CO[C](C)F(6517)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['C[C]=CO[C](C)F(6517)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(35.1121,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C=C(F)OC=[C]C(6530)'],
    products = ['C[C]=CO[C](C)F(6517)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['C[C]=CO[C](C)F(6517)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(15.2395,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'CC#CO[C](C)F(6532)'],
    products = ['C[C]=CO[C](C)F(6517)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[C]F(124)', 'C[C]=C[O](6236)'],
    products = ['C[C]=CO[C](C)F(6517)'],
