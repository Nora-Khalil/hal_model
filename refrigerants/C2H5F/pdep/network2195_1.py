...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(=[CH])F(2540)'],
    products = ['[CH]=C(C)C(=[CH])F(6137)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(19)', '[CH]=C(F)C#C(2637)'],
    products = ['[CH]=C(C)C(=[CH])F(6137)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(C)C#C(6221)'],
    products = ['[CH]=C(C)C(=[CH])F(6137)'],
    transitionState = 'TS6',
