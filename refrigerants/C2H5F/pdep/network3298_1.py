...
"""),
    ...
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.6752,0.0181953,2.95379e-05,-4.86816e-08,1.86569e-11,-12081.2,17.7872], Tmin=(100,'K'), Tmax=(1015.53,'K')), NASAPolynomial(coeffs=[10.0754,0.0159855,-6.98741e-06,1.41686e-09,-1.06509e-13,-14973.3,-24.8674], Tmin=(1015.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-100.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(CdCFH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.142764,'amu*angstrom^2'), symmetry=1, barrier=(3.28243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143041,'amu*angstrom^2'), symmetry=1, barrier=(3.28878,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0451,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09403,0.0481495,-8.15838e-05,7.47036e-08,-2.59336e-11,17223.4,19.2211], Tmin=(100,'K'), Tmax=(886.357,'K')), NASAPolynomial(coeffs=[5.14692,0.0198338,-9.06093e-06,1.65056e-09,-1.09211e-13,17253.3,8.0825], Tmin=(886.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CtOsHH) + group(Ct-CtCs) + group(CtCF) + radical(ROOJ)"""),
)
...
"""),
    E0 = (234.204,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,1685,370,167,640,1190,309.733],'cm^-1')),
        HinderedRotor(inertia=(0.16912,'amu*angstrom^2'), symmetry=1, barrier=(11.5204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00702484,'amu*angstrom^2'), symmetry=1, barrier=(41.7925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.614512,'amu*angstrom^2'), symmetry=1, barrier=(41.8041,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12005,0.0449656,-5.20743e-05,3.46439e-08,-9.72804e-12,28232.8,22.0452], Tmin=(100,'K'), Tmax=(849.541,'K')), NASAPolynomial(coeffs=[7.1103,0.0214704,-1.05916e-05,2.09229e-09,-1.49275e-13,27384.9,-1.21641], Tmin=(849.541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-O2sHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=[C]COOF(9149)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (504.732,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,2750,2850,1437.5,1250,1305,750,350,1685,370,3120,650,792.5,1650,272.295,2848.92],'cm^-1')),
        HinderedRotor(inertia=(0.676407,'amu*angstrom^2'), symmetry=1, barrier=(36.082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141531,'amu*angstrom^2'), symmetry=1, barrier=(7.50673,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.676352,'amu*angstrom^2'), symmetry=1, barrier=(36.1145,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64828,0.057227,-9.14494e-05,8.09588e-08,-2.84125e-11,60784.6,22.3809], Tmin=(100,'K'), Tmax=(810.529,'K')), NASAPolynomial(coeffs=[6.9936,0.0223951,-1.13453e-05,2.20639e-09,-1.53559e-13,60195.7,-0.571587], Tmin=(810.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(504.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sFO) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)CO[O](9150)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {3,S} {4,S}
3 O u1 p2 c0 {2,S}
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[C]=CF(2647)'],
    products = ['[O]OC[C]=CF(8509)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]O[O](153)', '[C]=CF(1334)'],
    products = ['[O]OC[C]=CF(8509)'],
    transitionState = 'TS3',
