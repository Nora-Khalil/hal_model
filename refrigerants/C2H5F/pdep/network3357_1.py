...
"""),
    E0 = (-119.655,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,361,769,965,1078,1132,1246,3247,350,440,435,1725,3120,650,792.5,1650,180,180],'cm^-1')),
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64044,0.0410828,-8.24719e-06,-2.15634e-08,1.16012e-11,-47710.2,19.5973], Tmin=(100,'K'), Tmax=(1004.07,'K')), NASAPolynomial(coeffs=[14.2553,0.0152241,-6.06222e-06,1.18461e-09,-8.79908e-14,-51473.2,-47.437], Tmin=(1004.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-397.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cd-Cd-O2s-Cs(F))"""),
)

species(
    label = 'C=C(CF)C(=O)F(10428)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {6,D}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96381,0.0495424,-4.78909e-05,2.70929e-08,-6.76461e-12,-64745.1,20.1411], Tmin=(100,'K'), Tmax=(924.18,'K')), NASAPolynomial(coeffs=[6.74966,0.0288283,-1.42703e-05,2.84008e-09,-2.03921e-13,-65629.7,-2.57047], Tmin=(924.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-538.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cd-CdCs(CO)) + group(COCFO) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61298,0.0548123,-5.18237e-05,2.5727e-08,-5.29558e-12,-37136.4,21.1037], Tmin=(100,'K'), Tmax=(1140.66,'K')), NASAPolynomial(coeffs=[10.2962,0.0243619,-1.17798e-05,2.32275e-09,-1.65943e-13,-39117.3,-21.9305], Tmin=(1140.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFO) + radical(C=COJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH]C(=CF)C(O)F(10433)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28732,0.0628001,-6.40743e-05,3.6664e-08,-8.82118e-12,-28719.1,22.507], Tmin=(100,'K'), Tmax=(984.54,'K')), NASAPolynomial(coeffs=[9.40042,0.0298388,-1.3857e-05,2.66081e-09,-1.87082e-13,-30316.6,-16.5078], Tmin=(984.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-239.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=C)C(F)OF(10434)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (86.7243,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,236,527,855,1015,1182,1348,3236,350,440,435,1725,2950,3100,1380,975,1025,1650,247.678,247.864,247.975,248.562,249.241],'cm^-1')),
        HinderedRotor(inertia=(1.13906,'amu*angstrom^2'), symmetry=1, barrier=(50.2866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14897,'amu*angstrom^2'), symmetry=1, barrier=(50.245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14763,'amu*angstrom^2'), symmetry=1, barrier=(50.2585,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27101,0.0633136,-6.16889e-05,3.29306e-08,-7.40441e-12,10526.1,21.8813], Tmin=(100,'K'), Tmax=(1044.92,'K')), NASAPolynomial(coeffs=[9.85968,0.0304352,-1.44904e-05,2.81698e-09,-1.99491e-13,8731.21,-19.9313], Tmin=(1044.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.7243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=COF)CF(10435)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (111.266,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3010,987.5,1337.5,450,1655,314.993,314.994,314.995,315.001,315.003],'cm^-1')),
        HinderedRotor(inertia=(0.717231,'amu*angstrom^2'), symmetry=1, barrier=(50.4978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717203,'amu*angstrom^2'), symmetry=1, barrier=(50.4978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717194,'amu*angstrom^2'), symmetry=1, barrier=(50.4977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15617,0.0636273,-6.25261e-05,3.3131e-08,-7.24161e-12,13483.8,23.2185], Tmin=(100,'K'), Tmax=(1087.92,'K')), NASAPolynomial(coeffs=[11.0734,0.0271648,-1.22531e-05,2.32452e-09,-1.62485e-13,11325.9,-25.462], Tmin=(1087.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[O]C=C([CH]F)CF(10436)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {7,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10329,0.0554306,-4.45267e-05,1.33186e-08,-1.2462e-13,-36630.9,24.0403], Tmin=(100,'K'), Tmax=(1063.01,'K')), NASAPolynomial(coeffs=[15.567,0.01456,-5.98234e-06,1.14141e-09,-8.20298e-14,-40471.7,-50.225], Tmin=(1063.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Csj(Cd-CsCd)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(CF)C([O])F(10207)'],
    products = ['CHFO(47)', 'C#CCF(5582)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC([O])F(1124)'],
    products = ['[CH]=C(CF)C([O])F(10207)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.44768e+28,'m^3/(mol*s)'), n=-6.4458, Ea=(79.8983,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.6591608693425184, var=5.4995193120720405, Tref=1000.0, N=19, data_mean=0.0, correlation='CH',), comment="""Estimated from node CH"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C([O])F(5362)'],
    products = ['[CH]=C(CF)C([O])F(10207)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(145.397,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(7)', '[CH]C(=CF)CF(10290)'],
    products = ['[CH]=C(CF)C([O])F(10207)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(C=O)CF(10131)'],
    products = ['[CH]=C(CF)C([O])F(10207)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHFO(47)', '[CH]=[C]CF(5583)'],
    products = ['[CH]=C(CF)C([O])F(10207)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(29.5228,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(6)', '[CH]=C(CF)C(=O)F(10429)'],
    products = ['[CH]=C(CF)C([O])F(10207)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2F(46)', 'C#CC([O])F(2178)'],
    products = ['[CH]=C(CF)C([O])F(10207)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(14.946,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction11',
    reactants = ['[O][CH]F(1395)', 'C#CCF(5582)'],
    products = ['[CH]=C(CF)C([O])F(10207)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.310487,'m^3/(mol*s)'), n=1.79149, Ea=(19.2375,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.27712170538623165, var=2.20453978455454, Tref=1000.0, N=288, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_3R->C_Ext-1R!H-R_N-5R!H-inRing"""),
)

reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(1395)', '[CH]=[C]CF(5583)'],
    products = ['[CH]=C(CF)C([O])F(10207)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C(=C)C(F)OF(10434)'],
    products = ['[CH]=C(CF)C([O])F(10207)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(110.15,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[CH]C(=COF)CF(10435)'],
    products = ['[CH]=C(CF)C([O])F(10207)'],
