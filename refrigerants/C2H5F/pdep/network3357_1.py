...
"""),
    E0 = (-570.427,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,2175,525,239,401,1367,296.767,2677.17],'cm^-1')),
        HinderedRotor(inertia=(0.181992,'amu*angstrom^2'), symmetry=1, barrier=(11.1254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180916,'amu*angstrom^2'), symmetry=1, barrier=(11.1167,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.872635,'amu*angstrom^2'), symmetry=1, barrier=(52.8895,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07058,0.0701578,-9.62673e-05,6.73615e-08,-1.70334e-11,-68506.4,23.8627], Tmin=(100,'K'), Tmax=(659.511,'K')), NASAPolynomial(coeffs=[10.1896,0.0238341,-1.13414e-05,2.16898e-09,-1.50568e-13,-69904.6,-17.8166], Tmin=(659.511,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-570.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(CsCFFO) + group(Ct-CtCs) + group(CtCF)"""),
)
...
"""),
    E0 = (-133.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,223,363,546,575,694,1179,1410,2750,2850,1437.5,1250,1305,750,350,2175,525,262.658,264.491],'cm^-1')),
        HinderedRotor(inertia=(0.150322,'amu*angstrom^2'), symmetry=1, barrier=(7.48234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149274,'amu*angstrom^2'), symmetry=1, barrier=(7.4779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27606,'amu*angstrom^2'), symmetry=1, barrier=(63.7027,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06708,0.0680373,-0.000103437,8.13079e-08,-2.46276e-11,-15956.2,22.271], Tmin=(100,'K'), Tmax=(918.089,'K')), NASAPolynomial(coeffs=[10.7561,0.0173754,-6.86117e-06,1.15715e-09,-7.29091e-14,-17379.3,-21.7057], Tmin=(918.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(CsCFFO) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01947,'amu*angstrom^2'), symmetry=1, barrier=(23.4396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01588,'amu*angstrom^2'), symmetry=1, barrier=(23.3571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0195,'amu*angstrom^2'), symmetry=1, barrier=(23.4402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.485298,0.0835301,-0.00012799,1.01221e-07,-3.17972e-11,-57741.5,23.9393], Tmin=(100,'K'), Tmax=(780.835,'K')), NASAPolynomial(coeffs=[12.238,0.0233208,-1.23202e-05,2.45841e-09,-1.74577e-13,-59576.8,-29.8526], Tmin=(780.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-481.094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(CdCCF) + group(CdJ2_singlet-Cds)"""),
)
...
"""),
    E0 = (-287.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,2175,525,239,401,1367,1048.21,1053.22],'cm^-1')),
        HinderedRotor(inertia=(0.213508,'amu*angstrom^2'), symmetry=1, barrier=(4.90896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0861998,'amu*angstrom^2'), symmetry=1, barrier=(21.1837,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.36647,0.03602,-2.47103e-05,7.46052e-09,-8.8031e-13,-34462.3,19.6471], Tmin=(100,'K'), Tmax=(1931.41,'K')), NASAPolynomial(coeffs=[13.2449,0.0134904,-7.21296e-06,1.42093e-09,-9.85475e-14,-38664.4,-39.9957], Tmin=(1931.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CtHH) + group(COCsFO) + group(Ct-CtCs) + group(CtCF)"""),
)

species(
    label = 'OC(F)=CC#CF(10121)',
    structure = adjacencyList("""1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {7,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.06676,'amu*angstrom^2'), symmetry=1, barrier=(24.5269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06281,'amu*angstrom^2'), symmetry=1, barrier=(24.436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4366,0.054186,-6.00998e-05,3.22129e-08,-6.73181e-12,-26733.3,19.6832], Tmin=(100,'K'), Tmax=(1169.5,'K')), NASAPolynomial(coeffs=[13.8824,0.0116176,-5.50117e-06,1.08911e-09,-7.85329e-14,-29644.4,-42.3095], Tmin=(1169.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-CdsCtH) + group(CdCFO) + group(Ct-Ct(Cds-Cds)) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OC(F)(F)C#CF(10113)'],
    products = ['OC(F)(F)CC#CF(8621)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OF(169)', 'F[C]CC#CF(10114)'],
    products = ['OC(F)(F)CC#CF(8621)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'FC#CC=C(F)F(10115)'],
    products = ['OC(F)(F)CC#CF(8621)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O[C](F)CC#CF(10116)'],
    products = ['OC(F)(F)CC#CF(8621)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[C]#CCC(O)(F)F(10117)'],
    products = ['OC(F)(F)CC#CF(8621)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'FC#CC[C](F)F(4637)'],
    products = ['OC(F)(F)CC#CF(8621)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['O[C](F)F(4999)', '[CH2]C#CF(8406)'],
    products = ['OC(F)(F)CC#CF(8621)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[C]#CF(2523)', '[CH2]C(O)(F)F(1356)'],
    products = ['OC(F)(F)CC#CF(8621)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[C]=C(F)CC(O)(F)F(10119)'],
    products = ['OC(F)(F)CC#CF(8621)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=C(F)CC#CF(10120)'],
    products = ['OC(F)(F)CC#CF(8621)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'OC(F)=CC#CF(10121)'],
    products = ['OC(F)(F)CC#CF(8621)'],
