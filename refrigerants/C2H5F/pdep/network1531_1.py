...
reaction(
    label = 'reaction7',
    reactants = ['C2H(22)', 'CC([O])(F)F(1358)'],
    products = ['C#COC(C)(F)F(4443)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[C]#COC(C)(F)F(4722)'],
    products = ['C#COC(C)(F)F(4443)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'C#COC(=C)F(1587)'],
    products = ['C#COC(C)(F)F(4443)'],
