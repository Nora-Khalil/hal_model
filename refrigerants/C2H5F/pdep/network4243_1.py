...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(O)=C([O])OF(11751)'],
    products = ['[O]C(=O)C([O])(O)F(11733)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(=O)C([O])(O)F(11733)'],
    products = ['OH(7)', '[O]C(=O)C(=O)F(2283)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(=O)[C](O)F(2284)'],
    products = ['[O]C(=O)C([O])(O)F(11733)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[O]C(O)(F)[C]=O(11752)'],
    products = ['[O]C(=O)C([O])(O)F(11733)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[O]C(=O)C(=O)O(1574)'],
    products = ['[O]C(=O)C([O])(O)F(11733)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]C(=O)C([O])=O(246)'],
    products = ['[O]C(=O)C([O])(O)F(11733)'],
