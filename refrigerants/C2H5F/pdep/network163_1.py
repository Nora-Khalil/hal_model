...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', '[CH]=C[O](132)'],
    products = ['[CH]=CO[C]=O(265)'],
    transitionState = 'TS2',
