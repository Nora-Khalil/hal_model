...
"""),
    E0 = (480.583,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1685,370,2175,525,750,770,3400,2100],'cm^-1')),
        HinderedRotor(inertia=(1.5393,'amu*angstrom^2'), symmetry=1, barrier=(35.3914,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59158,0.0324211,-4.06219e-05,2.88909e-08,-8.35942e-12,57850.2,12.4991], Tmin=(100,'K'), Tmax=(841.003,'K')), NASAPolynomial(coeffs=[6.74047,0.0126892,-5.43046e-06,9.96211e-10,-6.78097e-14,57152.3,-6.79878], Tmin=(841.003,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(480.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), label="""CH2CCCH""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (452.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,518,736,852,873,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.30119,'amu*angstrom^2'), symmetry=1, barrier=(29.9169,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0649,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29752,0.0319336,-2.09503e-05,4.51897e-09,2.08251e-13,54437.7,15.3998], Tmin=(100,'K'), Tmax=(1250.89,'K')), NASAPolynomial(coeffs=[11.146,0.0112719,-5.32724e-06,1.07083e-09,-7.7559e-14,51626.8,-31.6567], Tmin=(1250.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(452.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'F[C]1C=CC1(17560)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (71.0728,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.94618,0.00315571,9.44241e-05,-1.72281e-07,9.75023e-11,13921.1,9.76313], Tmin=(10,'K'), Tmax=(551.573,'K')), NASAPolynomial(coeffs=[1.12989,0.0349819,-2.31361e-05,7.28879e-09,-8.75344e-13,14058.3,20.1021], Tmin=(551.573,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(115.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), label="""F[C]1CDCC1""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = '[CH2]C1(F)C=C1(17936)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {2,S}
...
"""),
    E0 = (202.044,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,3150,900,1100,3000,3100,440,815,1455,1000,394.824,395.289,395.366,395.818],'cm^-1')),
        HinderedRotor(inertia=(0.00107733,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0728,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.89511,0.0061862,0.000108678,-2.20922e-07,1.32787e-10,24306.2,9.35693], Tmin=(10,'K'), Tmax=(566.589,'K')), NASAPolynomial(coeffs=[3.77597,0.031125,-2.11421e-05,6.89399e-09,-8.55679e-13,23932.9,6.45066], Tmin=(566.589,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(202.044,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), label="""[CH2]C1(F)CDC1""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'C#CC(=C)F(17942)',
    structure = adjacencyList("""1 F u0 p3 c0 {2,S}
...
"""),
    E0 = (86.1094,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([179,423,629,811,888,2950,3100,1380,975,1025,1650,2175,525,750,770,3400,2100],'cm^-1')),
        HinderedRotor(inertia=(1.48399,'amu*angstrom^2'), symmetry=1, barrier=(34.1198,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (70.0649,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.90892,0.00547161,9.38898e-05,-1.96125e-07,1.21314e-10,10362,9.06693], Tmin=(10,'K'), Tmax=(551.072,'K')), NASAPolynomial(coeffs=[3.91175,0.0258724,-1.72266e-05,5.5452e-09,-6.83033e-13,10051.6,6.24154], Tmin=(551.072,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(86.1094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""C#CC(DC)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (114.541,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([86,203,488,582,605,741,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370],'cm^-1')),
        HinderedRotor(inertia=(1.61094,'amu*angstrom^2'), symmetry=1, barrier=(37.0387,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0728,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(2914.77,'J/mol'), sigma=(4.92022,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=455.28 K, Pc=55.53 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.89767,0.00661171,0.000118163,-2.65526e-07,1.7976e-10,13780.6,10.9385], Tmin=(10,'K'), Tmax=(490.831,'K')), NASAPolynomial(coeffs=[3.1208,0.032715,-2.20349e-05,6.9669e-09,-8.34239e-13,13618.7,11.7074], Tmin=(490.831,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(114.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), label="""CD[C]C(DC)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=CC(=C)F(446)'],
    products = ['F[C]1C=CC1(17560)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=CC(=C)F(446)'],
    products = ['[CH2]C1(F)C=C1(17936)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.54e+10,'s^-1'), n=0.69, Ea=(85.2532,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_D_D;doublebond_intra_2H;radadd_intra_cdsingleH]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH]=C=C([CH2])F(3296)'],
    products = ['[CH]=CC(=C)F(446)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'C#C[C]=C(14168)'],
    products = ['[CH]=CC(=C)F(446)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(236.838,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH]=CC#C(462)'],
    products = ['[CH]=CC(=C)F(446)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.56721e+32,'m^3/(mol*s)'), n=-7.40875, Ea=(302.356,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_3COCdCddCtO2d->Ct"""),
)

reaction(
    label = 'reaction125',
    reactants = ['[CH]=CC(=C)F(446)'],
    products = ['C=[C]C(=C)F(17659)'],
...
reaction(
    label = 'reaction95',
    reactants = ['[CH]=CC(=C)F(446)'],
    products = ['C=[C]C=CF(9031)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(210.804,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
