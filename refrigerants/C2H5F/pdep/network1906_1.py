...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C](C)F(5177)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])(F)F(1349)', 'C[C]F-2(838)'],
    products = ['[CH2]C(F)(F)O[C](C)F(5177)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[C](F)O[C](F)F(5401)'],
    products = ['[CH2]C(F)(F)O[C](C)F(5177)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)O[C](C)F(5204)'],
    products = ['[CH2]C(F)(F)O[C](C)F(5177)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)OC(=C)F(4460)'],
    products = ['[CH2]C(F)(F)O[C](C)F(5177)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([O])(F)F(1349)', 'C[C]F(124)'],
    products = ['[CH2]C(F)(F)O[C](C)F(5177)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(F)(F)O[C](C)F(5177)'],
    products = ['[CH2]C(F)OC([CH2])(F)F(5402)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(F)(F)O[C](C)F(5177)'],
    products = ['[CH2][C](F)OC(C)(F)F(5403)'],
