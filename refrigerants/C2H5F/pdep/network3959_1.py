...
reaction(
    label = 'reaction1',
    reactants = ['[OH+]=[C-]C=C=CF(11087)'],
    products = ['CO(13)', 'C#CCF(4379)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[OH2+][C-]=C=C=CF(11280)'],
    products = ['[OH+]=[C-]C=C=CF(11087)'],
    transitionState = 'TS2',
