...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43537,0.0615598,-7.05388e-05,5.19333e-08,-1.68182e-11,-83306.8,21.6775], Tmin=(100,'K'), Tmax=(732.336,'K')), NASAPolynomial(coeffs=[6.20424,0.0355124,-1.71878e-05,3.36642e-09,-2.3878e-13,-84005.3,0.156014], Tmin=(732.336,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-693.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(COCsFO)"""),
)

species(
    label = '[CH2]C(F)O[C](C)F(5143)',
...
"""),
    E0 = (-299.391,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([401,573,564,712,601,775,1078,1160,1259,1391,1337,1437,3048,3250,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,196.134,197.53,197.634],'cm^-1')),
        HinderedRotor(inertia=(0.00436945,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23534,'amu*angstrom^2'), symmetry=1, barrier=(6.46958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23473,'amu*angstrom^2'), symmetry=1, barrier=(33.742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24311,'amu*angstrom^2'), symmetry=1, barrier=(33.7371,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05117,0.070444,-7.91967e-05,4.94449e-08,-1.29285e-11,-35906.9,24.6321], Tmin=(100,'K'), Tmax=(910.529,'K')), NASAPolynomial(coeffs=[9.77942,0.0320998,-1.60278e-05,3.19354e-09,-2.29245e-13,-37496.4,-16.6584], Tmin=(910.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sH)(H)(H)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
"""),
    E0 = (-333.971,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,293,496,537,1218,3120,650,792.5,1650,286.007,286.098,286.105],'cm^-1')),
        HinderedRotor(inertia=(0.39487,'amu*angstrom^2'), symmetry=1, barrier=(22.9264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394818,'amu*angstrom^2'), symmetry=1, barrier=(22.9261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394818,'amu*angstrom^2'), symmetry=1, barrier=(22.9257,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.636157,0.0661649,-6.38067e-05,2.98637e-08,-5.45139e-12,-40039.8,22.456], Tmin=(100,'K'), Tmax=(1334.41,'K')), NASAPolynomial(coeffs=[17.6477,0.0151711,-6.48448e-06,1.22545e-09,-8.6015e-14,-44579.8,-64.5223], Tmin=(1334.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-333.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = 'CC(F)[O+]=[C-]CF(5484)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.73274,'amu*angstrom^2'), symmetry=1, barrier=(39.8391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73331,'amu*angstrom^2'), symmetry=1, barrier=(39.8521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7344,'amu*angstrom^2'), symmetry=1, barrier=(39.8772,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01173,0.0725942,-0.000100501,8.93498e-08,-3.34134e-11,-27801.9,33.2051], Tmin=(100,'K'), Tmax=(752.913,'K')), NASAPolynomial(coeffs=[5.48909,0.0406146,-2.0467e-05,4.03102e-09,-2.84932e-13,-28243.9,14.4173], Tmin=(752.913,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OC(C)F(5485)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {6,S}
4  C u0 p0 c0 {1,S} {3,S} {5,S} {8,S}
...
"""),
    E0 = (-273.691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35462,0.0643758,-6.3715e-05,3.49498e-08,-8.25071e-12,-32827.4,20.9824], Tmin=(100,'K'), Tmax=(983.433,'K')), NASAPolynomial(coeffs=[8.83627,0.0339448,-1.72992e-05,3.48432e-09,-2.51766e-13,-34298.9,-14.9872], Tmin=(983.433,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsCFHO) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (-201.89,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.31638,'amu*angstrom^2'), symmetry=1, barrier=(30.2661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31377,'amu*angstrom^2'), symmetry=1, barrier=(30.2062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31337,'amu*angstrom^2'), symmetry=1, barrier=(30.1969,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3084.75,'J/mol'), sigma=(5.29414,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=481.83 K, Pc=47.17 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11443,0.0516324,-2.58768e-05,-1.32263e-08,1.11762e-11,-24167.1,16.6677], Tmin=(100,'K'), Tmax=(967.457,'K')), NASAPolynomial(coeffs=[18.1252,0.00904321,-2.8581e-06,5.5231e-10,-4.37293e-14,-28756.9,-71.5469], Tmin=(967.457,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)

species(
    label = 'CC(F)[O+]=[C-]F(5486)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-464.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,422.848,422.897,422.903,422.936,422.939,422.964],'cm^-1')),
        HinderedRotor(inertia=(0.288379,'amu*angstrom^2'), symmetry=1, barrier=(36.5746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288329,'amu*angstrom^2'), symmetry=1, barrier=(36.5765,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88411,0.0420771,-3.03021e-05,1.03684e-08,-1.41228e-12,-55742.7,17.0282], Tmin=(100,'K'), Tmax=(1706.45,'K')), NASAPolynomial(coeffs=[13.0652,0.015868,-7.26385e-06,1.36792e-09,-9.36857e-14,-59558.7,-42.8893], Tmin=(1706.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-464.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(F)OC(C)F(1526)'],
    products = ['CH2CHF(55)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(9.99999e+07,'s^-1'), n=1.2, Ea=(161.574,'kJ/mol'), T0=(1,'K'), Tmin=(500,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C[C]F(124)', 'C=C(O)F(498)'],
    products = ['C=C(F)OC(C)F(1526)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(47.712,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C=C(F)OC(979)'],
    products = ['C=C(F)OC(C)F(1526)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(115.262,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'C=C(F)OCF(1896)'],
    products = ['C=C(F)OC(C)F(1526)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2CHF(55)', 'C=C(O)F(498)'],
    products = ['C=C(F)OC(C)F(1526)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)O[C](C)F(5143)'],
    products = ['C=C(F)OC(C)F(1526)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)OC([CH2])F(5206)'],
    products = ['C=C(F)OC(C)F(1526)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)O[CH]C(1202)'],
    products = ['C=C(F)OC(C)F(1526)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=[C]OC(C)F(1746)'],
    products = ['C=C(F)OC(C)F(1526)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2CFO(78)', 'CH3-CHF(62)'],
    products = ['C=C(F)OC(C)F(1526)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'C=C(F)O[CH]F(2010)'],
    products = ['C=C(F)OC(C)F(1526)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=C(F)O[C](C)F(5204)'],
    products = ['C=C(F)OC(C)F(1526)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]C(F)OC(=C)F(1364)'],
    products = ['C=C(F)OC(C)F(1526)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(F)OC(C)F(5483)'],
    products = ['C=C(F)OC(C)F(1526)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C=COC(=C)F(1159)'],
    products = ['C=C(F)OC(C)F(1526)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'C#COC(C)F(1122)'],
    products = ['C=C(F)OC(C)F(1526)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(25)', 'CC(F)[O+]=[C-]F(5486)'],
    products = ['C=C(F)OC(C)F(1526)'],
...
network(
    ...
    reactants = [
        ('CH2CHF(55)', 'CC(=O)F(499)'),
        ('CH2CFO(78)', 'CH3-CHF(62)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
