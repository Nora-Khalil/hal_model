...
"""),
    E0 = (456.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,234.461,234.463],'cm^-1')),
        HinderedRotor(inertia=(0.497149,'amu*angstrom^2'), symmetry=1, barrier=(19.3936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.497149,'amu*angstrom^2'), symmetry=1, barrier=(19.3936,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (82.1004,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09118,0.0321593,8.56269e-06,-3.26101e-08,1.42798e-11,8131.19,15.3081], Tmin=(100,'K'), Tmax=(995.86,'K')), NASAPolynomial(coeffs=[10.9371,0.0197136,-7.46265e-06,1.39528e-09,-1.00398e-13,5224.61,-33.0791], Tmin=(995.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.9629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Oxetene)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)O[C]=C(6100)'],
    products = ['CH2CO(28)', 'C#CC(4975)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CO[C]=C(419)'],
    products = ['[CH]=C(C)O[C]=C(6100)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', '[CH]=C(C)[O](1728)'],
    products = ['[CH]=C(C)O[C]=C(6100)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2CO(28)', '[CH]=[C]C(4976)'],
    products = ['[CH]=C(C)O[C]=C(6100)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][C]=O(140)', 'C#CC(4975)'],
    products = ['[CH]=C(C)O[C]=C(6100)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(C)OC#C(6270)'],
    products = ['[CH]=C(C)O[C]=C(6100)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]=O(140)', '[CH]=[C]C(4976)'],
    products = ['[CH]=C(C)O[C]=C(6100)'],
    transitionState = 'TS9',
