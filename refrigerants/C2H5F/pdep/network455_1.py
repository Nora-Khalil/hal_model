...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=C(O)OF(1242)'],
    products = ['O=COC(=O)OF(544)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(=O)OC=O(1477)'],
    products = ['O=COC(=O)OF(544)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]OF(331)', '[O]C=O(147)'],
    products = ['O=COC(=O)OF(544)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)OF(1245)', 'HCO(15)'],
    products = ['O=COC(=O)OF(544)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.47663e+07,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C
Multiplied by reaction path degeneracy 2.0"""),
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(160)', 'O=[C]OC=O(250)'],
    products = ['O=COC(=O)OF(544)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC(=O)OF(1478)'],
    products = ['O=COC(=O)OF(544)'],
