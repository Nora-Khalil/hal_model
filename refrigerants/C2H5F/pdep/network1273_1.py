...
"""),
    E0 = (-137.88,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,395,473,707,1436,3000,3100,440,815,1455,1000,274.188,274.336],'cm^-1')),
        HinderedRotor(inertia=(0.139071,'amu*angstrom^2'), symmetry=1, barrier=(7.4173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139081,'amu*angstrom^2'), symmetry=1, barrier=(7.41857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.432576,'amu*angstrom^2'), symmetry=1, barrier=(23.071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139124,'amu*angstrom^2'), symmetry=1, barrier=(7.41816,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.537153,0.0826693,-0.00013596,1.14908e-07,-3.78382e-11,-16464.6,26.628], Tmin=(100,'K'), Tmax=(834.139,'K')), NASAPolynomial(coeffs=[11.2554,0.0222445,-1.10678e-05,2.11729e-09,-1.4522e-13,-17938.7,-21.2552], Tmin=(834.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(Cs-CsHHH) + radical(CsCsF1sO2s) + radical(CJCO)"""),
)
...
"""),
    E0 = (-2.29212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,162,485,641,721,926,1292,1380,3063,2950,3100,1380,975,1025,1650,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.247199,'amu*angstrom^2'), symmetry=1, barrier=(12.2446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.76783,'amu*angstrom^2'), symmetry=1, barrier=(40.646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.5598,0.0456322,-0.000115594,2.54223e-07,-2.26667e-10,-275.603,11.4822], Tmin=(10,'K'), Tmax=(352.026,'K')), NASAPolynomial(coeffs=[3.92904,0.0326359,-2.27172e-05,7.31572e-09,-8.85873e-13,-247.07,10.8609], Tmin=(352.026,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-2.29212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""CD[C]C(F)OF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-192.626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,236,527,855,1015,1182,1348,3236,350,440,435,1725,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.08703,'amu*angstrom^2'), symmetry=1, barrier=(24.9931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08334,'amu*angstrom^2'), symmetry=1, barrier=(24.9081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08276,'amu*angstrom^2'), symmetry=1, barrier=(24.8949,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70069,0.0706324,-8.87581e-05,5.31209e-08,-1.22305e-11,-23047,22.0047], Tmin=(100,'K'), Tmax=(1072.72,'K')), NASAPolynomial(coeffs=[16.8077,0.0105715,-4.77333e-06,9.26138e-10,-6.62871e-14,-26502.7,-56.8326], Tmin=(1072.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(O)C(F)OF(3083)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.761096,'amu*angstrom^2'), symmetry=1, barrier=(17.4991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.7612,'amu*angstrom^2'), symmetry=1, barrier=(17.5015,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07813,0.0526257,-5.72872e-05,2.91619e-08,-5.52892e-12,-63221.6,18.9718], Tmin=(100,'K'), Tmax=(1462.6,'K')), NASAPolynomial(coeffs=[16.6012,0.00346013,1.93082e-08,-9.66242e-11,8.5241e-15,-67044.5,-59.3661], Tmin=(1462.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-526.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-O2d)O2s) + group(COCFO) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(O)C(F)OF(2868)'],
    products = ['HF(38)', 'CHFO(47)', 'CH2CO(28)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(32.6242,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['OF(169)', 'C=C(O)[C]F(2149)'],
    products = ['C=C(O)C(F)OF(2868)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(54.8071,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)
...
reaction(
    ...
    products = ['C=C(O)C(F)OF(2868)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(173.607,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OC(=COF)CF(3075)'],
    products = ['C=C(O)C(F)OF(2868)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(8.88952e+10,'s^-1'), n=0.725184, Ea=(296.423,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction5',
    reactants = ['OC(=CF)COF(3076)'],
    products = ['C=C(O)C(F)OF(2868)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(160)', 'C=C(O)[CH]F(2164)'],
    products = ['C=C(O)C(F)OF(2868)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=[C]C(F)OF(3080)'],
    products = ['C=C(O)C(F)OF(2868)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C([O])C(F)OF(3032)'],
    products = ['C=C(O)C(F)OF(2868)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[CH]OF(1980)', 'C=[C]O(142)'],
    products = ['C=C(O)C(F)OF(2868)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(O)=C(F)OF(3081)'],
    products = ['C=C(O)C(F)OF(2868)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(1.34608,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C"""),
)

reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)C(F)OF(3082)'],
    products = ['C=C(O)C(F)OF(2868)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F2(77)', 'C=C(O)C=O(756)'],
    products = ['C=C(O)C(F)OF(2868)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(81.1908,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=C(O)C(=O)F(2133)'],
    products = ['C=C(O)C(F)OF(2868)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(484.437,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)
