...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79394,0.0392507,-1.00084e-05,-1.53388e-08,8.39826e-12,-54252.4,18.777], Tmin=(100,'K'), Tmax=(1036.56,'K')), NASAPolynomial(coeffs=[12.5735,0.0175215,-7.31499e-06,1.41989e-09,-1.03313e-13,-57554.5,-38.7638], Tmin=(1036.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-451.807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(O2s-Cd-Cd-Cs(F)(F))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.314167,'amu*angstrom^2'), symmetry=1, barrier=(101.747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.44403,'amu*angstrom^2'), symmetry=1, barrier=(102.177,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33896,0.0511619,-5.04553e-05,2.57573e-08,-5.11313e-12,-28088.5,22.1908], Tmin=(100,'K'), Tmax=(1315.74,'K')), NASAPolynomial(coeffs=[13.1224,0.0127183,-3.64033e-06,5.23072e-10,-3.08104e-14,-30962.4,-37.0287], Tmin=(1315.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(O2sj(Cs-F1sF1sCt))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.258169,'amu*angstrom^2'), symmetry=1, barrier=(5.93581,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89573,0.0513759,-8.02937e-05,7.20285e-08,-2.59075e-11,15191.9,20.3488], Tmin=(100,'K'), Tmax=(793.265,'K')), NASAPolynomial(coeffs=[6.14006,0.0224707,-1.14481e-05,2.24619e-09,-1.57551e-13,14754.6,2.34338], Tmin=(793.265,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(COCFO) + radical(Cds_S) + radical(C=CJC=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.656142,'amu*angstrom^2'), symmetry=1, barrier=(15.086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.653362,'amu*angstrom^2'), symmetry=1, barrier=(15.0221,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02793,0.0736854,-0.000124336,1.13133e-07,-3.98954e-11,-20883.9,23.6656], Tmin=(100,'K'), Tmax=(839.103,'K')), NASAPolynomial(coeffs=[7.20281,0.028149,-1.41524e-05,2.72475e-09,-1.87628e-13,-21353.3,-1.66382], Tmin=(839.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C=[C][CH]C(O)(F)F(8082)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {4,S} {11,S}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10458,0.0660372,-7.66281e-05,4.5704e-08,-1.09309e-11,-33815.2,21.2337], Tmin=(100,'K'), Tmax=(1012.13,'K')), NASAPolynomial(coeffs=[12.4232,0.0213062,-1.0337e-05,2.04027e-09,-1.45997e-13,-36106.4,-33.5085], Tmin=(1012.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(Cds_S)"""),
)

species(
    label = 'C[C]=C[C](F)OF(8083)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.94613,'amu*angstrom^2'), symmetry=1, barrier=(21.7534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.944797,'amu*angstrom^2'), symmetry=1, barrier=(21.7227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.945344,'amu*angstrom^2'), symmetry=1, barrier=(21.7353,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16629,0.0680812,-0.000101609,8.69568e-08,-3.0382e-11,19599.6,23.3492], Tmin=(100,'K'), Tmax=(758.988,'K')), NASAPolynomial(coeffs=[7.89999,0.0282689,-1.43805e-05,2.83165e-09,-1.99643e-13,18702,-6.45944], Tmin=(758.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFHO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_P) + radical(Cds_S)"""),
)

species(
    label = 'C[C](F)[CH]C(=O)F(8084)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55868,0.0587323,-7.49961e-05,5.82286e-08,-1.92714e-11,-40902.8,23.6272], Tmin=(100,'K'), Tmax=(725.12,'K')), NASAPolynomial(coeffs=[6.82817,0.0296633,-1.4862e-05,2.94076e-09,-2.09314e-13,-41667,-0.101215], Tmin=(725.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-340.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(COCsFO) + radical(CsCsCsF1s) + radical(CCJC=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C[C]C=C(F)F(6471)'],
    products = ['C[C]=CC([O])(F)F(7478)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C[C]=CC(=O)F(6328)'],
    products = ['C[C]=CC([O])(F)F(7478)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'CC#CC([O])(F)F(8077)'],
    products = ['C[C]=CC([O])(F)F(7478)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'C[C]=[C]C(=O)F(8078)'],
    products = ['C[C]=CC([O])(F)F(7478)'],
