...
reaction(
    label = 'reaction2',
    reactants = ['C[C]F-2(838)', '[O]C[CH]F(973)'],
    products = ['C[C](F)OC[CH]F(5145)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', '[CH2]O[C](C)F(981)'],
    products = ['C[C](F)OC[CH]F(5145)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]F(839)', 'CC(=O)F(499)'],
    products = ['C[C](F)OC[CH]F(5145)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CHF(55)', 'C[C]([O])F(1344)'],
    products = ['C[C](F)OC[CH]F(5145)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C[C](F)OC=CF(5197)'],
    products = ['C[C](F)OC[CH]F(5145)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)OC[CH]F(1363)'],
    products = ['C[C](F)OC[CH]F(5145)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]F(839)', 'C[C]([O])F(1344)'],
    products = ['C[C](F)OC[CH]F(5145)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[C]F(124)', '[O]C[CH]F(973)'],
    products = ['C[C](F)OC[CH]F(5145)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', '[CH2]O[C](C)F(981)'],
    products = ['C[C](F)OC[CH]F(5145)'],
