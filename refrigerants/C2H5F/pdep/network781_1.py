...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(O)[CH]F(1794)'],
    products = ['HO2(11)', 'O=C[CH]F(414)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(O)[CH]F(1790)'],
    products = ['[O]OC(O)[CH]F(1794)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(837)', '[O]O[CH]O(1336)'],
    products = ['[O]OC(O)[CH]F(1794)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[O]O[CH]O(1336)'],
    products = ['[O]OC(O)[CH]F(1794)'],
