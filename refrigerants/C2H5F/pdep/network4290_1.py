...
"""),
    E0 = (-196.503,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,350,440,435,1725,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,369.467,369.565,369.579],'cm^-1')),
        HinderedRotor(inertia=(0.073613,'amu*angstrom^2'), symmetry=1, barrier=(7.13612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0739107,'amu*angstrom^2'), symmetry=1, barrier=(7.14894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.099,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)CC(=C)O(11792)'],
    products = ['HF(38)', 'CH2CO(28)', '[CH]=C=C(4381)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C(=C)O(12043)'],
    products = ['[CH]=C(F)CC(=C)O(11792)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[C]=C(F)CC(=C)O(12044)'],
    products = ['[CH]=C(F)CC(=C)O(11792)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=C(F)CC(=C)O(11792)'],
    products = ['[CH2]C1(O)C=C(F)C1(12046)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C2HF(57)', '[CH2]C(=C)O(1729)'],
    products = ['[CH]=C(F)CC(=C)O(11792)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=[C]CC(=C)O(6801)'],
    products = ['[CH]=C(F)CC(=C)O(11792)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', '[CH]=C(F)C[C]=C(6681)'],
    products = ['[CH]=C(F)CC(=C)O(11792)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=C(F)CC(=C)[O](8953)'],
    products = ['[CH]=C(F)CC(=C)O(11792)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=[C]O(142)', '[CH]C(=C)F(11631)'],
    products = ['[CH]=C(F)CC(=C)O(11792)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[C]F(1321)', '[CH2]C(=C)O(1729)'],
    products = ['[CH]=C(F)CC(=C)O(11792)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]C(F)=CC(=C)O(12048)'],
    products = ['[CH]=C(F)CC(=C)O(11792)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C(O)CC(=[CH])F(12049)'],
    products = ['[CH]=C(F)CC(=C)O(11792)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH]=C=CC(=C)O(12050)'],
    products = ['[CH]=C(F)CC(=C)O(11792)'],
