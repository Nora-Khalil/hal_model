...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'C=C(F)OC[C]F(5450)'],
    products = ['C=C(F)OCCF(1531)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['C=C(F)OF(1352)', 'C2H4(30)'],
    products = ['C=C(F)OCCF(1531)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)O[CH]CF(5451)'],
    products = ['C=C(F)OCCF(1531)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(F)OC[CH]F(5199)'],
    products = ['C=C(F)OCCF(1531)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]COC(=C)F(1347)'],
    products = ['C=C(F)OCCF(1531)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', '[CH2]OC(=C)F(980)'],
    products = ['C=C(F)OCCF(1531)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C=C(F)O[CH]CF(5452)'],
    products = ['C=C(F)OCCF(1531)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH]=C(F)OCCF(5453)'],
    products = ['C=C(F)OCCF(1531)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(25)', 'F[C-]=[O+]CCF(5456)'],
    products = ['C=C(F)OCCF(1531)'],
