...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]O[CH2](590)'],
    products = ['[CH2]OC[C]=O(370)'],
    transitionState = 'TS3',
