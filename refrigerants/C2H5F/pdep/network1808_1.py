...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75582,0.0526675,-6.1107e-05,3.9654e-08,-1.06564e-11,-5843.35,22.4488], Tmin=(100,'K'), Tmax=(893.709,'K')), NASAPolynomial(coeffs=[8.45999,0.0226615,-1.07449e-05,2.08611e-09,-1.47451e-13,-7041.66,-9.14158], Tmin=(893.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.2326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Cs_P)"""),
)

species(
    label = 'CC1(F)O[C]([O])O1(5337)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {5,S} {7,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[5.83388,0.0108005,1.60967e-05,-1.42976e-08,2.74134e-12,-34464.3,9.12735], Tmin=(100,'K'), Tmax=(2107.81,'K')), NASAPolynomial(coeffs=[21.2902,0.015891,-1.20222e-05,2.34372e-09,-1.5137e-13,-48626.7,-95.1044], Tmin=(2107.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + ring(O2s-Cs-O2s-Cs(F)) + radical(OCOJ) + radical(Cs_P)"""),
)
...
"""),
    E0 = (-463.456,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,395,473,707,1436,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4575,0.0574522,-6.1261e-05,3.2552e-08,-6.94334e-12,-55650.6,24.9455], Tmin=(100,'K'), Tmax=(1124.72,'K')), NASAPolynomial(coeffs=[12.3416,0.0187433,-9.63631e-06,1.95197e-09,-1.41648e-13,-58098.9,-28.8435], Tmin=(1124.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-463.456,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(152)', 'C[C]F-2(838)'],
    products = ['C[C](F)OC([O])=O(1917)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C[C](F)O[C]=O(1294)'],
    products = ['C[C](F)OC([O])=O(1917)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['C[C](F)OC([O])=O(1917)'],
    products = ['C[C](F)O[C]1OO1(5336)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(383.451,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_O]
...
reaction(
    ...
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.63856e+09,'s^-1'), n=0.755479, Ea=(177.062,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
Ea raised from 176.4 to 177.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['C[C](F)OC([O])=O(1917)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(153.031,'m^3/(mol*s)'), n=1.16366, Ea=(64.0801,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=C(F)OC([O])=O(1919)'],
    products = ['C[C](F)OC([O])=O(1917)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([O])=O(152)', 'C[C]F(124)'],
    products = ['C[C](F)OC([O])=O(1917)'],
