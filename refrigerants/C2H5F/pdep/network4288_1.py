...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(=C)OF(11854)'],
    products = ['[CH]=CCC(=C)OF(7267)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[C]=CCC(=C)OF(11877)'],
    products = ['[CH]=CCC(=C)OF(7267)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=CCC(=C)OF(7267)'],
    products = ['[CH2]C1(OF)C=CC1(11879)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H2(23)', '[CH2]C(=C)OF(669)'],
    products = ['[CH]=CCC(=C)OF(7267)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#CCC(=C)OF(10870)'],
    products = ['[CH]=CCC(=C)OF(7267)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=CCC(=C)[O](6798)'],
    products = ['[CH]=CCC(=C)OF(7267)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(160)', '[CH]=CC[C]=C(6647)'],
    products = ['[CH]=CCC(=C)OF(7267)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C=[C]OF(491)', '[CH]C=C(8365)'],
    products = ['[CH]=CCC(=C)OF(7267)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[CH](135)', '[CH2]C(=C)OF(669)'],
    products = ['[CH]=CCC(=C)OF(7267)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH]C=CC(=C)OF(11880)'],
    products = ['[CH]=CCC(=C)OF(7267)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=[C]CC(=C)OF(8952)'],
    products = ['[CH]=CCC(=C)OF(7267)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=CCC(=[CH])OF(11881)'],
    products = ['[CH]=CCC(=C)OF(7267)'],
