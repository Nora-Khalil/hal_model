...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71758,0.0470898,-3.90731e-05,1.68702e-08,-2.9606e-12,6227.77,18.0137], Tmin=(100,'K'), Tmax=(1346.84,'K')), NASAPolynomial(coeffs=[11.1291,0.0191383,-7.9428e-06,1.46098e-09,-1.00325e-13,3692.64,-30.1936], Tmin=(1346.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.0767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77963,0.049001,-5.012e-05,2.71345e-08,-5.94799e-12,35941.8,18.196], Tmin=(100,'K'), Tmax=(1096.53,'K')), NASAPolynomial(coeffs=[10.2263,0.018189,-7.97123e-06,1.5092e-09,-1.057e-13,34089.3,-23.3328], Tmin=(1096.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.51007,'amu*angstrom^2'), symmetry=1, barrier=(34.7194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49568,'amu*angstrom^2'), symmetry=1, barrier=(34.3886,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0835,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72363,0.0525823,-6.50147e-05,4.54307e-08,-1.29527e-11,36072.5,18.0091], Tmin=(100,'K'), Tmax=(851.734,'K')), NASAPolynomial(coeffs=[8.4777,0.0208619,-9.14917e-06,1.70207e-09,-1.16979e-13,34922,-13.4912], Tmin=(851.734,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.05305,'amu*angstrom^2'), symmetry=1, barrier=(24.2118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05001,'amu*angstrom^2'), symmetry=1, barrier=(24.1417,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89688,0.0504753,-5.24665e-05,3.18203e-08,-8.32105e-12,45824.6,19.4897], Tmin=(100,'K'), Tmax=(898.48,'K')), NASAPolynomial(coeffs=[7.19975,0.0268673,-1.30537e-05,2.57653e-09,-1.84112e-13,44871.7,-5.52599], Tmin=(898.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C(F)C=C(8781)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {5,S} {7,S}
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', '[CH]C=CF(936)'],
    products = ['[CH]=CC(F)[C]=C(8474)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=CC(F)=C=C(8775)'],
    products = ['[CH]=CC(F)[C]=C(8474)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]=CC(F)C#C(8777)'],
    products = ['[CH]=CC(F)[C]=C(8474)'],
