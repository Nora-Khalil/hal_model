...
reaction(
    label = 'reaction3',
    reactants = ['F[C]1[CH]C1(6219)'],
    products = ['FC1C=C1(6172)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction33',
    reactants = ['H(6)', 'F[C]1C=C1(6221)'],
    products = ['F[C]1[CH]C1(6219)'],
    transitionState = 'TS3',
