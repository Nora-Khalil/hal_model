...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)CF(471)'],
    products = ['F[CH]CCF(2072)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C([CH2])F(214)'],
    products = ['[CH2]C(F)CF(471)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', '[CH2][CH]F(183)'],
    products = ['[CH2]C(F)CF(471)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[CH2]C(F)[CH]F(241)'],
    products = ['[CH2]C(F)CF(471)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2]C(=C)F(2726)'],
    products = ['[CH2]C(F)CF(471)'],
