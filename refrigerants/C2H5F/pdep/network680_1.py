...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C#COO[CH]F(1532)'],
    products = ['C#COOC([CH2])F(1513)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[CH]C(F)OOC#C(1533)'],
    products = ['C#COOC([CH2])F(1513)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['C2H(22)', '[CH2]C(F)O[O](846)'],
    products = ['C#COOC([CH2])F(1513)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#COO[C]([CH2])F(1538)'],
    products = ['C#COOC([CH2])F(1513)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[C]#COOC([CH2])F(1539)'],
    products = ['C#COOC([CH2])F(1513)'],
