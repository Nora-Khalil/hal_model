...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CHFCH[Z](70)'],
    products = ['[O]OC=CF(1335)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC=CF(1335)'],
    products = ['FC1[CH]OO1(1755)'],
    transitionState = 'TS3',
