...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(271)', '[CH2]C(=C)[O](660)'],
    products = ['[CH2]C(=C)O[C]=C(6561)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C]=C(748)'],
    products = ['[CH2]C(=C)O[C]=C(6561)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'C#COC([CH2])=C(6998)'],
    products = ['[CH2]C(=C)O[C]=C(6561)'],
