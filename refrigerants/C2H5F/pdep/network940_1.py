...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)C=C=O(2098)'],
    products = ['[O]C(F)C[C]=O(2041)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[O]C=C[C]=O(2099)'],
    products = ['[O]C(F)C[C]=O(2041)'],
