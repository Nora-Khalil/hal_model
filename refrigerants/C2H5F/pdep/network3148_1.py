...
reaction(
    label = 'reaction4',
    reactants = ['[O]C([O])=CF(1304)', '[C]=C(134)'],
    products = ['C=[C]C(F)C([O])=O(8429)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'C=[C]C(F)[C]=O(8971)'],
    products = ['C=[C]C(F)C([O])=O(8429)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C=C(F)C([O])=O(9121)'],
    products = ['C=[C]C(F)C([O])=O(8429)'],
