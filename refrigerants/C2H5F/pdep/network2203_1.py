...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC([CH2])(F)F(4432)'],
    products = ['[CH]=C(C)C([CH2])(F)F(6145)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH]C(C)=C(F)F(6466)'],
    products = ['[CH]=C(C)C([CH2])(F)F(6145)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(C)C(=C)F(6188)'],
    products = ['[CH]=C(C)C([CH2])(F)F(6145)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CF2(56)', '[CH]=[C]C(4976)'],
    products = ['[CH]=C(C)C([CH2])(F)F(6145)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(C)C([CH2])(F)F(6145)'],
    products = ['[CH2]C(F)=C(C)[CH]F(6470)'],
...
network(
    label = 'PDepNetwork #2203',
    isomers = [
        '[CH]=C(C)C([CH2])(F)F(6145)',
    ],
    reactants = [
        ('CH2CF2(56)', 'C#CC(4975)'),
    ],
