...
"""),
    E0 = (-674.209,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,519,593,830,1115,1166,1389,1413,3114,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.307004,'amu*angstrom^2'), symmetry=1, barrier=(7.05864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.306945,'amu*angstrom^2'), symmetry=1, barrier=(7.05727,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.27466,'amu*angstrom^2'), symmetry=1, barrier=(52.2989,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10931,0.0706801,-0.000109307,9.92793e-08,-3.67559e-11,-80991.4,25.857], Tmin=(100,'K'), Tmax=(761.024,'K')), NASAPolynomial(coeffs=[6.5896,0.0329857,-1.74888e-05,3.49591e-09,-2.48327e-13,-81568.1,2.60563], Tmin=(761.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-674.209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsFFHO) + group(CdCFO) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43433,0.0615407,-7.34701e-05,4.87355e-08,-1.3472e-11,-120567,24.0742], Tmin=(100,'K'), Tmax=(866.121,'K')), NASAPolynomial(coeffs=[8.90487,0.0270398,-1.37197e-05,2.74501e-09,-1.97256e-13,-121862,-10.8931], Tmin=(866.121,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1003.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFFHO) + group(COCsFO)"""),
)

species(
    label = '[CH2]C(F)OO[C](F)F(7803)',
...
"""),
    E0 = (-425.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,3000,3100,440,815,1455,1000,493,600,700,1144,1293,180],'cm^-1')),
        HinderedRotor(inertia=(2.0036,'amu*angstrom^2'), symmetry=1, barrier=(46.0668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.329332,'amu*angstrom^2'), symmetry=1, barrier=(7.572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.00296,'amu*angstrom^2'), symmetry=1, barrier=(46.0521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28869,'amu*angstrom^2'), symmetry=1, barrier=(29.6295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00332,0.0704627,-8.3555e-05,5.11505e-08,-1.26942e-11,-51090.2,26.8283], Tmin=(100,'K'), Tmax=(970.312,'K')), NASAPolynomial(coeffs=[12.0883,0.0247667,-1.29145e-05,2.61634e-09,-1.8955e-13,-53241.4,-26.3162], Tmin=(970.312,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFFHO) + radical(CJCOOH) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)

species(
    label = 'C[C](F)OO[C](F)F(7471)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-445.063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,493,600,700,1144,1293,180],'cm^-1')),
        HinderedRotor(inertia=(2.12375,'amu*angstrom^2'), symmetry=1, barrier=(48.8293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12458,'amu*angstrom^2'), symmetry=1, barrier=(48.8483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.451451,'amu*angstrom^2'), symmetry=1, barrier=(10.3797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.451515,'amu*angstrom^2'), symmetry=1, barrier=(10.3812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.695125,0.0793289,-0.000122779,1.04684e-07,-3.61226e-11,-53416,26.7268], Tmin=(100,'K'), Tmax=(750.477,'K')), NASAPolynomial(coeffs=[9.48917,0.0289975,-1.5266e-05,3.03523e-09,-2.1484e-13,-54638.5,-12.526], Tmin=(750.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-445.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFFHO) + radical(CsCsF1sO2s) + radical(Csj(F1s)(F1s)(O2s-O2s))"""),
)
...
"""),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799102,0.0850278,-0.000160827,1.61013e-07,-6.04904e-11,-60036.4,37.3227], Tmin=(100,'K'), Tmax=(846.066,'K')), NASAPolynomial(coeffs=[3.25133,0.0398716,-2.12653e-05,4.15748e-09,-2.8753e-13,-59250.1,33.0011], Tmin=(846.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-500.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFFHO) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OOC(F)F(8013)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
4  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-406.531,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,519,593,830,1115,1166,1389,1413,3114,180,180,180,1565.94],'cm^-1')),
        HinderedRotor(inertia=(1.37108,'amu*angstrom^2'), symmetry=1, barrier=(31.5239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.394462,'amu*angstrom^2'), symmetry=1, barrier=(9.06945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37496,'amu*angstrom^2'), symmetry=1, barrier=(31.6131,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08948,0.0741637,-9.4125e-05,4.58171e-08,4.8432e-12,-48799.5,24.2353], Tmin=(100,'K'), Tmax=(535.941,'K')), NASAPolynomial(coeffs=[8.86109,0.0314457,-1.73462e-05,3.52666e-09,-2.53292e-13,-49852,-10.4588], Tmin=(535.941,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-406.531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(CsFFHO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(F)OOC(F)F(7473)'],
    products = ['CF2O(49)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(16.5587,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C=C(F)OO(1322)'],
    products = ['C=C(F)OOC(F)F(7473)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(78.0366,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C=C(F)OOF(5377)'],
    products = ['C=C(F)OOC(F)F(7473)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(13.7912,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['C=C(F)OOC(F)F(7473)'],
    products = ['O=C(F)COC(F)F(8009)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)OO[C](F)F(7803)'],
    products = ['C=C(F)OOC(F)F(7473)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)OO[CH]F(2054)'],
    products = ['C=C(F)OOC(F)F(7473)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=[C]OOC(F)F(8010)'],
    products = ['C=C(F)OOC(F)F(7473)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]OC(F)F(3447)', 'CH2CF(69)'],
    products = ['C=C(F)OOC(F)F(7473)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(F)OO[C](F)F(7441)'],
    products = ['C=C(F)OOC(F)F(7473)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH]=C(F)OOC(F)F(8011)'],
    products = ['C=C(F)OOC(F)F(7473)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C#COOC(F)F(7409)'],
    products = ['C=C(F)OOC(F)F(7473)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(25)', 'F[C-]=[O+]OC(F)F(8014)'],
    products = ['C=C(F)OOC(F)F(7473)'],
