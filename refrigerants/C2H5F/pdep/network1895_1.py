...
"""),
    E0 = (-154.468,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([277,555,632,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.154131,'amu*angstrom^2'), symmetry=1, barrier=(3.54378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15896,'amu*angstrom^2'), symmetry=1, barrier=(26.6467,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.0328,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.74378,0.0196167,0.000125664,-4.36357e-07,3.99421e-10,-18577.5,10.9589], Tmin=(10,'K'), Tmax=(404.878,'K')), NASAPolynomial(coeffs=[6.63766,0.0247349,-1.81809e-05,6.12519e-09,-7.68594e-13,-19088.1,-3.79769], Tmin=(404.878,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-154.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""CDC(F)OOF""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = 'O=C(F)COCF(5378)',
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93106,0.0491632,-4.38872e-05,2.11619e-08,-4.36117e-12,-92628.2,21.3269], Tmin=(100,'K'), Tmax=(1114.99,'K')), NASAPolynomial(coeffs=[8.39334,0.0259798,-1.26982e-05,2.51342e-09,-1.79823e-13,-94069.3,-10.5532], Tmin=(1114.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-770.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(CsFHHO) + group(COCsFO)"""),
)

species(
    label = '[CH2]C(F)OO[CH]F(5256)',
...
"""),
    E0 = (-212.167,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,3000,3100,440,815,1455,1000,580,1155,1237,1373,3147,180],'cm^-1')),
        HinderedRotor(inertia=(0.920407,'amu*angstrom^2'), symmetry=1, barrier=(21.162,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410837,'amu*angstrom^2'), symmetry=1, barrier=(9.44595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.87907,'amu*angstrom^2'), symmetry=1, barrier=(43.2035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.87963,'amu*angstrom^2'), symmetry=1, barrier=(43.2164,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21844,0.0671392,-8.48803e-05,5.88219e-08,-1.68784e-11,-25422.9,24.8476], Tmin=(100,'K'), Tmax=(837.869,'K')), NASAPolynomial(coeffs=[9.43149,0.0279306,-1.4688e-05,2.9729e-09,-2.14705e-13,-26799.2,-13.3229], Tmin=(837.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHHO) + radical(CJCOOH) + radical(CsF1sHO2s)"""),
)

species(
    label = 'C[C](F)OO[CH]F(5167)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-231.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,580,1155,1237,1373,3147,180],'cm^-1')),
        HinderedRotor(inertia=(1.45306,'amu*angstrom^2'), symmetry=1, barrier=(33.4086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.453964,'amu*angstrom^2'), symmetry=1, barrier=(10.4375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.453458,'amu*angstrom^2'), symmetry=1, barrier=(10.4259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.86643,'amu*angstrom^2'), symmetry=1, barrier=(42.913,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.9084,0.0761515,-0.000125178,1.14449e-07,-4.14485e-11,-27748.7,24.7445], Tmin=(100,'K'), Tmax=(799.179,'K')), NASAPolynomial(coeffs=[7.20792,0.0314656,-1.6613e-05,3.28648e-09,-2.30968e-13,-28335.5,-1.60636], Tmin=(799.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHHO) + radical(CsCsF1sO2s) + radical(CsF1sHO2s)"""),
)
...
"""),
    ...
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24727,0.0730667,-0.000132054,1.33785e-07,-5.13169e-11,-32094.8,34.7607], Tmin=(100,'K'), Tmax=(836.948,'K')), NASAPolynomial(coeffs=[2.16614,0.0398537,-2.08741e-05,4.08009e-09,-2.83226e-13,-31239.1,36.5218], Tmin=(836.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-267.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(CsFHHO) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OOCF(5381)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {5,S}
4  O u0 p2 c0 {3,S} {6,S}
...
"""),
    E0 = (-174.093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,548,1085,1183,1302,1466,1520,3060,3119,265.762,266.007,267.26,1477.04],'cm^-1')),
        HinderedRotor(inertia=(0.661872,'amu*angstrom^2'), symmetry=1, barrier=(33.7549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.66388,'amu*angstrom^2'), symmetry=1, barrier=(33.758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199859,'amu*angstrom^2'), symmetry=1, barrier=(10.1848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.663233,'amu*angstrom^2'), symmetry=1, barrier=(33.7594,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27205,0.066616,-8.94264e-05,7.01422e-08,-2.33023e-11,-20846.4,22.5591], Tmin=(100,'K'), Tmax=(722.828,'K')), NASAPolynomial(coeffs=[7.56375,0.0317984,-1.71724e-05,3.50122e-09,-2.53332e-13,-21755.9,-5.75248], Tmin=(722.828,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(CsFHHO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(F)OOCF(5169)'],
    products = ['CHFO(47)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(15.5459,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C=C(F)OO(1322)'],
    products = ['C=C(F)OOCF(5169)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.67448e-06,'m^3/(mol*s)'), n=3.15288, Ea=(2.86302,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_2Br1sCl1sF1sHI1s->H',), comment="""Estimated from node OH_2Br1sCl1sF1sHI1s->H"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C=C(F)OOF(5377)'],
    products = ['C=C(F)OOCF(5169)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(9.91245,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['C=C(F)OOCF(5169)'],
    products = ['O=C(F)COCF(5378)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)OO[CH]F(5256)'],
    products = ['C=C(F)OOCF(5169)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OOC(=C)F(1505)'],
    products = ['C=C(F)OOCF(5169)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(F)OO[CH]F(2054)'],
    products = ['C=C(F)OOCF(5169)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH]=C(F)OOCF(5379)'],
    products = ['C=C(F)OOCF(5169)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(25)', 'F[C-]=[O+]OCF(5382)'],
    products = ['C=C(F)OOCF(5169)'],
