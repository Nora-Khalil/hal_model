...
"""),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.567513,0.0819071,-0.000111967,8.60833e-08,-2.71937e-11,-81737.2,25.7556], Tmin=(100,'K'), Tmax=(767.91,'K')), NASAPolynomial(coeffs=[9.94292,0.0330709,-1.6572e-05,3.26531e-09,-2.31406e-13,-83177.1,-16.9994], Tmin=(767.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-680.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJC(C)C=O)"""),
)
...
"""),
    E0 = (-654.21,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,249,341,381,651,928,1217,1251,3000,3100,440,815,1455,1000,265.069,265.128,265.136,1703.89,1703.89],'cm^-1')),
        HinderedRotor(inertia=(0.815417,'amu*angstrom^2'), symmetry=1, barrier=(40.6535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00239879,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.814996,'amu*angstrom^2'), symmetry=1, barrier=(40.6535,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56888,0.058672,-7.51896e-05,5.4216e-08,-1.62901e-11,-78600.4,21.6442], Tmin=(100,'K'), Tmax=(800.505,'K')), NASAPolynomial(coeffs=[8.17732,0.0256483,-1.33047e-05,2.67404e-09,-1.92207e-13,-79658.3,-8.76667], Tmin=(800.505,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-654.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(Csj(Cs-F1sF1sCO)(H)(H))"""),
)

species(
    label = 'O=C(O)[C](F)CCF(10753)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32682,0.0624955,-5.6126e-05,2.70311e-08,-5.51124e-12,-85418.3,24.4646], Tmin=(100,'K'), Tmax=(1134.28,'K')), NASAPolynomial(coeffs=[10.0965,0.0315696,-1.5229e-05,2.99422e-09,-2.13419e-13,-87407.7,-18.949], Tmin=(1134.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-710.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CsCOCsF1s)"""),
)

species(
    label = 'O=C(O)C[C](F)CF(10739)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  O u0 p2 c0 {8,S} {13,S}
...
"""),
    E0 = (-591.236,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,271,519,563,612,1379,3000,3100,440,815,1455,1000,286.917,287.518,287.591],'cm^-1')),
        HinderedRotor(inertia=(0.312072,'amu*angstrom^2'), symmetry=1, barrier=(18.3165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.429328,'amu*angstrom^2'), symmetry=1, barrier=(25.1857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.312391,'amu*angstrom^2'), symmetry=1, barrier=(18.3037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.313461,'amu*angstrom^2'), symmetry=1, barrier=(18.3503,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.897786,0.0737296,-9.1079e-05,6.13077e-08,-1.69594e-11,-53158.7,25.2285], Tmin=(100,'K'), Tmax=(871.129,'K')), NASAPolynomial(coeffs=[10.5432,0.0294408,-1.48185e-05,2.94676e-09,-2.10875e-13,-54839.2,-19.9743], Tmin=(871.129,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-442.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)

species(
    label = 'O[C]1OCC1(F)CF(10756)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30725,0.0565482,-4.24464e-05,1.5481e-08,-2.28068e-12,-62014.6,26.2357], Tmin=(100,'K'), Tmax=(1565.71,'K')), NASAPolynomial(coeffs=[14.125,0.0238022,-1.10749e-05,2.1234e-09,-1.47849e-13,-66028.4,-41.3493], Tmin=(1565.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-516.439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCCCF) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(Cs-O2s-Cs-Cs(F)) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(O)CC1(F)CF(10757)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-472.688,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,191.261,887.271,888.358,2805.28],'cm^-1')),
        HinderedRotor(inertia=(0.170652,'amu*angstrom^2'), symmetry=1, barrier=(3.92363,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164449,'amu*angstrom^2'), symmetry=1, barrier=(3.781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164619,'amu*angstrom^2'), symmetry=1, barrier=(3.78493,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50825,0.0618209,-9.22215e-05,8.6647e-08,-3.30789e-11,-56768.4,23.9151], Tmin=(100,'K'), Tmax=(785.395,'K')), NASAPolynomial(coeffs=[4.30762,0.0352221,-1.78506e-05,3.51122e-09,-2.47207e-13,-56827.5,13.5093], Tmin=(785.395,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-472.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCFHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53482,0.0590306,-6.177e-05,3.78427e-08,-1.00032e-11,-38919.8,23.8498], Tmin=(100,'K'), Tmax=(889.66,'K')), NASAPolynomial(coeffs=[7.66839,0.0314547,-1.52782e-05,3.00569e-09,-2.14244e-13,-40011.2,-5.0243], Tmin=(889.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-324.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ(C)CO) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C([CH2])(F)C(=O)O(10759)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.547126,0.0837715,-0.000135379,1.18739e-07,-4.10195e-11,-35472.5,24.1646], Tmin=(100,'K'), Tmax=(820.414,'K')), NASAPolynomial(coeffs=[9.01938,0.0302524,-1.51999e-05,2.93866e-09,-2.03526e-13,-36451.7,-12.5274], Tmin=(820.414,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-295.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJC(C)C=O) + radical(CJC(C)C=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.0601,'amu*angstrom^2'), symmetry=1, barrier=(24.3738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05937,'amu*angstrom^2'), symmetry=1, barrier=(24.357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05959,'amu*angstrom^2'), symmetry=1, barrier=(24.362,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1597,0.0693946,-9.44304e-05,6.28803e-08,-1.32011e-11,-30718.6,23.5028], Tmin=(100,'K'), Tmax=(614.627,'K')), NASAPolynomial(coeffs=[9.61288,0.0251094,-1.25344e-05,2.44925e-09,-1.72076e-13,-31960.4,-14.8129], Tmin=(614.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(C)C=O) + radical(CC(C)CJ=O)"""),
)

species(
    label = '[CH2]C(F)(CF)C([O])=O(10761)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {8,S}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.731875,0.0817602,-0.000134733,1.27013e-07,-4.72191e-11,-54600.8,25.3161], Tmin=(100,'K'), Tmax=(806.334,'K')), NASAPolynomial(coeffs=[5.69674,0.0386803,-2.02693e-05,3.99764e-09,-2.80422e-13,-54801.6,6.15159], Tmin=(806.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-454.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2][C](F)C(=O)O(1307)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {5,S} {9,S}
3 O u0 p2 c0 {5,D}
...
"""),
    ...
    molecularWeight = (78.0606,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.073,0.0239244,-1.11068e-05,1.84826e-09,-9.13024e-14,-13055.8,13.285], Tmin=(100,'K'), Tmax=(2964.75,'K')), NASAPolynomial(coeffs=[36.605,-0.0122425,3.28334e-06,-5.08732e-10,3.33418e-14,-35740.6,-184.744], Tmin=(2964.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)([CH]F)C(=O)O(10762)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
...
"""),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.240549,0.0915182,-0.000152195,1.3455e-07,-4.65912e-11,-58245.3,27.5927], Tmin=(100,'K'), Tmax=(820.532,'K')), NASAPolynomial(coeffs=[9.78567,0.0310002,-1.59945e-05,3.1158e-09,-2.16367e-13,-59340.9,-13.6998], Tmin=(820.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-485.334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CJC(C)C=O) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (-140.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,337.85,337.85,337.85,337.851,1173.91],'cm^-1')),
        HinderedRotor(inertia=(0.0825024,'amu*angstrom^2'), symmetry=1, barrier=(6.68254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0029273,'amu*angstrom^2'), symmetry=1, barrier=(33.2367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00683355,'amu*angstrom^2'), symmetry=1, barrier=(6.68254,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04609,0.0465604,-4.62754e-05,2.74182e-08,-7.07559e-12,-16871.4,19.1591], Tmin=(100,'K'), Tmax=(906.109,'K')), NASAPolynomial(coeffs=[6.70182,0.026008,-1.22528e-05,2.38652e-09,-1.69316e-13,-17715.1,-2.84312], Tmin=(906.109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-140.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(C=C(C=O)CJ)"""),
)
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.663511,0.0797254,-0.000109462,8.66655e-08,-2.84099e-11,-83576.5,25.7346], Tmin=(100,'K'), Tmax=(739.412,'K')), NASAPolynomial(coeffs=[9.07771,0.0341978,-1.70836e-05,3.35883e-09,-2.37591e-13,-84820.6,-12.3171], Tmin=(739.412,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-695.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCCF) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CsCsF1sH)"""),
)

species(
    label = 'CC(F)(CF)C([O])=O(10684)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u1 p2 c0 {8,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45702,0.0609075,-5.35672e-05,2.5857e-08,-5.40606e-12,-86947.3,24.0156], Tmin=(100,'K'), Tmax=(1091.35,'K')), NASAPolynomial(coeffs=[8.79347,0.034018,-1.66091e-05,3.28049e-09,-2.34372e-13,-88548.6,-12.0199], Tmin=(1091.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-723.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(CsCsFHH) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCJ(C)CO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(CF)C(=O)O(10664)'],
    products = ['HF(38)', 'CO2(14)', '[CH2]C(=C)F(2402)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[CH2]C(O)(F)CF(3256)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[CH2]C(F)C(=O)O(2439)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', '[CH2]C(F)(F)C(=O)O(4725)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['CO2(14)', '[CH2]C(F)CF(1890)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OCF(401)', 'C=C(F)[C]=O(1324)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(F)=C(O)OCF(10754)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(T)(18)', 'O=C(O)[C](F)CF(2801)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH]C(F)(CF)C(=O)O-2(10755)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(CF)C(=O)O(10664)'],
    products = ['[O]C1(O)CC1(F)CF(10757)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'C=C(CF)C(=O)O(6703)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(46)', 'C=C(F)C(=O)O(1278)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=[C]O(146)', 'C=C(F)CF(1904)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', '[CH2][C](CF)C(=O)O(10758)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', '[CH2]C([CH2])(F)C(=O)O(10759)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OH(7)', '[CH2]C(F)([C]=O)CF(10760)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[CH2]C(F)(CF)C([O])=O(10761)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2F(46)', '[CH2][C](F)C(=O)O(1307)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=[C]O(146)', '[CH2][C](F)CF(2400)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(5)', '[CH2]C(F)([CH]F)C(=O)O(10762)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F2(77)', '[CH2]C(=C)C(=O)O(7065)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HF(38)', '[CH2]C(=CF)C(=O)O(7068)'],
    products = ['[CH2]C(F)(CF)C(=O)O(10664)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(F)(CF)C(=O)O(10664)'],
    products = ['CC(F)([CH]F)C(=O)O(10763)'],
...
network(
    label = 'PDepNetwork #3808',
    isomers = [
        '[CH2]C(F)(CF)C(=O)O(10664)',
    ],
    reactants = [
        ('HF(38)', 'CO2(14)', '[CH2]C(=C)F(2402)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
