...
"""),
    E0 = (-1356.16,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,435,565,619,662,854,1178,1396,250.593,250.593,250.594],'cm^-1')),
        HinderedRotor(inertia=(0.292692,'amu*angstrom^2'), symmetry=1, barrier=(13.043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184981,'amu*angstrom^2'), symmetry=1, barrier=(8.24317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184981,'amu*angstrom^2'), symmetry=1, barrier=(8.24317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.601765,'amu*angstrom^2'), symmetry=1, barrier=(26.8158,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.419215,0.0845103,-0.000106476,7.00632e-08,-1.86282e-11,-162984,25.4923], Tmin=(100,'K'), Tmax=(910.75,'K')), NASAPolynomial(coeffs=[13.0876,0.0288708,-1.48383e-05,2.98426e-09,-2.15085e-13,-165291,-34.441], Tmin=(910.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1356.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsHHH) + group(CsFFOO)"""),
)
...
"""),
    E0 = (-953.476,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,493,600,700,1144,1293,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.282649,'amu*angstrom^2'), symmetry=1, barrier=(6.49866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282655,'amu*angstrom^2'), symmetry=1, barrier=(6.49879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282951,'amu*angstrom^2'), symmetry=1, barrier=(6.50559,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.049,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.63478,0.0285901,0.000184341,-6.70048e-07,6.41708e-10,-114677,14.6894], Tmin=(10,'K'), Tmax=(388.141,'K')), NASAPolynomial(coeffs=[7.74552,0.0344,-2.42811e-05,8.03957e-09,-1.00153e-12,-115359,-5.92675], Tmin=(388.141,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-953.476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""CC(F)(F)O[C](F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-1089.64,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,375,486,586,623,710,938,1161,1294,180,180,1089.8],'cm^-1')),
        HinderedRotor(inertia=(0.342896,'amu*angstrom^2'), symmetry=1, barrier=(7.88386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.566554,'amu*angstrom^2'), symmetry=1, barrier=(13.0262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.966622,'amu*angstrom^2'), symmetry=1, barrier=(22.2245,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.729412,0.0752272,-8.56968e-05,4.94506e-08,-1.14685e-11,-130939,25.2695], Tmin=(100,'K'), Tmax=(1039.31,'K')), NASAPolynomial(coeffs=[13.8966,0.0245512,-1.25589e-05,2.53691e-09,-1.83819e-13,-133676,-38.7626], Tmin=(1039.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1089.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFFO) + group(Cs-CsHHH) + group(CsFFOO) + radical(O2sj(Cs-F1sF1sO2s))"""),
)
...
"""),
    E0 = (-1090.64,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,482,664,788,1296,1923,180,549.438,801.584],'cm^-1')),
        HinderedRotor(inertia=(1.09895,'amu*angstrom^2'), symmetry=1, barrier=(25.2669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198493,'amu*angstrom^2'), symmetry=1, barrier=(4.56373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09947,'amu*angstrom^2'), symmetry=1, barrier=(25.279,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36261,0.0578091,-5.37328e-05,2.46804e-08,-4.5712e-12,-131078,22.0591], Tmin=(100,'K'), Tmax=(1277.9,'K')), NASAPolynomial(coeffs=[13.1552,0.0208966,-1.04048e-05,2.07656e-09,-1.49129e-13,-134092,-37.7252], Tmin=(1277.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1090.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFFO) + group(Cs-CsHHH) + group(COFOO)"""),
)
...
reaction(
    ...
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(11.2441,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'OC(F)(F)OC(F)F(7535)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OC(O)(F)F(8112)', 'CH2CF2(56)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C[C](F)OC(O)(F)F(8113)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'CC(F)(F)O[C](O)F(5907)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(O)(F)F(4240)', 'CH3-CF2(64)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O[C](F)F(4999)', 'CC([O])(F)F(1358)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'CC(F)(F)O[C](F)F(8114)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC(F)(F)OC([O])(F)F(8115)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', 'OC(F)(F)O[C](F)F(8116)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(F)(F)OC(O)(F)F(8117)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'CC(F)(F)OC(=O)F(8118)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C=C(F)OC(O)(F)F(7474)'],
    products = ['CC(F)(F)OC(O)(F)F(7541)'],
