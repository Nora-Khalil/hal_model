...
"""),
    E0 = (30.5539,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,271,519,563,612,1379,3000,3100,440,815,1455,1000,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.296954,'amu*angstrom^2'), symmetry=1, barrier=(6.82755,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25304,0.0409142,-4.91915e-05,3.19105e-08,-8.39675e-12,3735.58,16.5688], Tmin=(100,'K'), Tmax=(919.301,'K')), NASAPolynomial(coeffs=[8.17817,0.0151328,-7.12414e-06,1.40327e-09,-1.00345e-13,2646.19,-11.5179], Tmin=(919.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.5539,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cd-F1sCd)(H)(H)) + radical(Cdj(Cd-CsF1s)(O2s-H))"""),
)
...
"""),
    E0 = (-18.3551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,525,764,1175,1295,1876,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.98857,'amu*angstrom^2'), symmetry=1, barrier=(45.7212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.98365,'amu*angstrom^2'), symmetry=1, barrier=(45.6081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.58748,0.0347574,-3.27977e-05,1.45267e-08,1.69593e-13,-2160.2,24.5382], Tmin=(100,'K'), Tmax=(579.602,'K')), NASAPolynomial(coeffs=[5.12514,0.0216837,-1.04524e-05,2.03983e-09,-1.4448e-13,-2528.94,13.0362], Tmin=(579.602,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.3551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsHHH) + group(COCFO) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)=C=O(3044)'],
    products = ['CO(13)', 'C[C]F(124)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(6.62099e+12,'s^-1'), n=0.640083, Ea=(178.688,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), Tmax=(2500,'K'), comment="""Fitted to 50 data points; dA = *|/ 1.18906, dn = +|- 0.0227498, dEa = +|- 0.123804 kJ/molMatched reaction 3 C3H3FO <=> C2H3F + CO in halocarbene_CO_dimerization/training
This reaction matched rate rule [RFC=C=O]
family: halocarbene_CO_dimerization
Ea raised from 177.8 to 178.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'O=C=CF(1527)'],
    products = ['CC(F)=C=O(3044)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'C=C(F)[C]=O(493)'],
    products = ['CC(F)=C=O(3044)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.7979e+07,'m^3/(mol*s)'), n=0.240345, Ea=(2.60001,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_N-3C-inRing_Ext-3C-R_4R!H->C_Sp-3C-2C_Sp-4C=3C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_N-3C-inRing_Ext-3C-R_4R!H->C_Sp-3C-2C_Sp-4C=3C"""),
)

reaction(
    label = 'reaction9',
    reactants = ['C[C]C(=O)F(10154)'],
    products = ['CC(F)=C=O(3044)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(132.977,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)

reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'C=C=C=O(7426)'],
    products = ['CC(F)=C=O(3044)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(7.15746e-06,'m^3/(mol*s)'), n=3.27904, Ea=(149.279,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-1.6829136876314708, var=127.63224188496864, Tref=1000.0, N=6, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct"""),
)
