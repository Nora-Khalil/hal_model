...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C#CO[C](O)F(1583)'],
    products = ['C#COC([CH2])(O)F(1514)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[CH]C(O)(F)OC#C(1584)'],
    products = ['C#COC([CH2])(O)F(1514)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CO[C]([CH2])O(836)'],
    products = ['C#COC([CH2])(O)F(1514)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HCCO(21)', '[CH2][C](O)F(1343)'],
    products = ['C#COC([CH2])(O)F(1514)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H(22)', '[CH2]C([O])(O)F(1448)'],
    products = ['C#COC([CH2])(O)F(1514)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C#CO[C]([CH2])F(1588)'],
    products = ['C#COC([CH2])(O)F(1514)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[C]#COC([CH2])(O)F(1589)'],
    products = ['C#COC([CH2])(O)F(1514)'],
