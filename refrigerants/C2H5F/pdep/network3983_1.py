...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20121,0.0301883,1.48346e-05,-3.16663e-08,1.08612e-11,-21552.9,18.7563], Tmin=(100,'K'), Tmax=(1194.6,'K')), NASAPolynomial(coeffs=[10.8178,0.0274374,-1.44848e-05,2.98566e-09,-2.18203e-13,-25474,-32.1408], Tmin=(1194.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CsCFHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)Cs) + ring(Cyclobutene)"""),
)

species(
    label = 'O=C=CC=CCF(11188)',
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73502,0.0544651,-6.09992e-05,4.50351e-08,-1.48466e-11,-21946,21.9062], Tmin=(100,'K'), Tmax=(716.25,'K')), NASAPolynomial(coeffs=[5.58457,0.0329679,-1.59811e-05,3.13559e-09,-2.22719e-13,-22497.5,4.61884], Tmin=(716.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.498194,'amu*angstrom^2'), symmetry=1, barrier=(11.4545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.50034,'amu*angstrom^2'), symmetry=1, barrier=(11.5038,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52758,0.0613461,-9.4885e-05,8.78225e-08,-3.23967e-11,6664.75,23.11], Tmin=(100,'K'), Tmax=(811.541,'K')), NASAPolynomial(coeffs=[4.96374,0.0314413,-1.56409e-05,3.03403e-09,-2.11265e-13,6534.08,9.88117], Tmin=(811.541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.7298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(Cds_S)"""),
)
...
"""),
    E0 = (9.01889,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,319,1023,1071,1259,1317,1409,3054,3019,2100,2250,500,550,1855,455,950,394.177,1179.61],'cm^-1')),
        HinderedRotor(inertia=(0.0731638,'amu*angstrom^2'), symmetry=1, barrier=(6.44538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276339,'amu*angstrom^2'), symmetry=1, barrier=(24.3083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.285024,'amu*angstrom^2'), symmetry=1, barrier=(24.3214,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76983,0.0424282,-2.61411e-05,5.03177e-09,6.00849e-13,1170.52,24.4331], Tmin=(100,'K'), Tmax=(1168.44,'K')), NASAPolynomial(coeffs=[11.3693,0.0189048,-7.93163e-06,1.48272e-09,-1.03402e-13,-1710.27,-26.1012], Tmin=(1168.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.01889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CtHH) + group(CsCFHH) + group(Cds-OdCsH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C=CC=[C]CF(11191)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u1 p2 c0 {6,S}
3  C u0 p0 c0 {1,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938281,0.0573409,-3.79981e-05,1.38618e-11,6.27233e-12,6482.46,24.1818], Tmin=(100,'K'), Tmax=(972.424,'K')), NASAPolynomial(coeffs=[17.2062,0.0129738,-4.34395e-06,7.8824e-10,-5.74935e-14,2252.44,-59.3283], Tmin=(972.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Cds_S)"""),
)
...
"""),
    E0 = (93.1377,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,212,931,1104,1251,1325,1474,3102,3155,3010,987.5,1337.5,450,1655,1685,370,1855,455,950,202.774,4000],'cm^-1')),
        HinderedRotor(inertia=(0.68064,'amu*angstrom^2'), symmetry=1, barrier=(20.027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.676978,'amu*angstrom^2'), symmetry=1, barrier=(20.0168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.6867,'amu*angstrom^2'), symmetry=1, barrier=(20.0195,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23016,0.0461285,-3.08922e-05,9.34408e-09,-1.14549e-12,11258,22.7361], Tmin=(100,'K'), Tmax=(1746.42,'K')), NASAPolynomial(coeffs=[11.1634,0.0256678,-1.33184e-05,2.63558e-09,-1.85164e-13,8137.79,-25.3423], Tmin=(1746.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.1377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Cds_S) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC[C]=[C]CF(11193)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {5,D}
...
"""),
    E0 = (171.32,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,122,584,932,1043,1247,1392,1461,2986,3039,2782.5,750,1395,475,1775,1000,1670,1700,300,440,767.744],'cm^-1')),
        HinderedRotor(inertia=(0.0421145,'amu*angstrom^2'), symmetry=1, barrier=(17.6845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235037,'amu*angstrom^2'), symmetry=1, barrier=(5.40395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.768924,'amu*angstrom^2'), symmetry=1, barrier=(17.6791,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09283,0.0442429,-2.60605e-05,6.20409e-09,-5.34012e-13,20671.5,24.3882], Tmin=(100,'K'), Tmax=(2192.55,'K')), NASAPolynomial(coeffs=[22.8555,0.0110946,-6.61876e-06,1.2766e-09,-8.43629e-14,10429.9,-94.6725], Tmin=(2192.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Cds_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = 'O=[C]C=C[CH]CF(11194)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {7,D}
3  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53236,0.0604686,-6.3656e-05,3.76347e-08,-9.57479e-12,-3177.08,21.3911], Tmin=(100,'K'), Tmax=(919.187,'K')), NASAPolynomial(coeffs=[8.1958,0.0314715,-1.63362e-05,3.31464e-09,-2.40423e-13,-4402.06,-10.1946], Tmin=(919.187,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.1112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Allyl_S) + radical(C=CCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]C=[C]CF(11147)'],
    products = ['O=[C]CC=[C]CF(11096)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[CH2]C=[C]CF(11147)'],
    products = ['O=[C]CC=[C]CF(11096)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CC=[C]CF(11189)'],
    products = ['O=[C]CC=[C]CF(11096)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'O=[C]CC#CCF(11190)'],
    products = ['O=[C]CC=[C]CF(11096)'],
