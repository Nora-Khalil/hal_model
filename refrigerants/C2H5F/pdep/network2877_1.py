...
"""),
    E0 = (-76.0467,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,246,474,533,1155,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,377.05,383.409],'cm^-1')),
        HinderedRotor(inertia=(0.135847,'amu*angstrom^2'), symmetry=1, barrier=(13.8362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140302,'amu*angstrom^2'), symmetry=1, barrier=(13.8366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138274,'amu*angstrom^2'), symmetry=1, barrier=(13.8408,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.670272,0.0638569,-4.91546e-05,8.82745e-09,3.78991e-12,-9017.96,25.5537], Tmin=(100,'K'), Tmax=(963.857,'K')), NASAPolynomial(coeffs=[17.8396,0.0138601,-4.42649e-06,7.70399e-10,-5.47333e-14,-13315.1,-61.7681], Tmin=(963.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.0467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    E0 = (-51.9215,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,250,446,589,854,899,2950,3100,1380,975,1025,1650,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.99913,'amu*angstrom^2'), symmetry=1, barrier=(22.972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.988393,'amu*angstrom^2'), symmetry=1, barrier=(22.7251,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.822757,0.0608532,-6.86637e-05,3.68474e-08,-7.47906e-12,-6122.6,19.5162], Tmin=(100,'K'), Tmax=(1296.77,'K')), NASAPolynomial(coeffs=[17.4718,0.0060449,-1.27183e-06,1.48084e-10,-8.07179e-15,-10150.3,-64.0131], Tmin=(1296.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.9215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cd-CdF1s)(H))"""),
)
...
"""),
    E0 = (223.795,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,323,467,575,827,1418,2950,3100,1380,975,1025,1650,275.962,276.418],'cm^-1')),
        HinderedRotor(inertia=(0.24643,'amu*angstrom^2'), symmetry=1, barrier=(13.1443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242582,'amu*angstrom^2'), symmetry=1, barrier=(13.1446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236681,'amu*angstrom^2'), symmetry=1, barrier=(13.127,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583096,0.0687572,-7.54059e-05,4.06706e-08,-8.47281e-12,27044.8,25.6214], Tmin=(100,'K'), Tmax=(1184.11,'K')), NASAPolynomial(coeffs=[17.1345,0.0128454,-4.57799e-06,7.93537e-10,-5.35867e-14,23125.1,-57.0265], Tmin=(1184.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'O[C]1CC=C(F)C1(9335)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.513,0.0444749,-8.88437e-06,-2.00031e-08,1.05937e-11,-21832.4,21.4725], Tmin=(100,'K'), Tmax=(1014.67,'K')), NASAPolynomial(coeffs=[13.0047,0.0216842,-8.4716e-06,1.59082e-09,-1.13953e-13,-25323.4,-39.8464], Tmin=(1014.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(CdCsCdF) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1(O)C=C(F)C1(9336)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29461,0.0488026,-1.53165e-05,-1.83812e-08,1.14037e-11,-9005.01,22.9765], Tmin=(100,'K'), Tmax=(980.818,'K')), NASAPolynomial(coeffs=[14.7052,0.0186264,-6.65891e-06,1.21773e-09,-8.7375e-14,-12814.9,-47.4734], Tmin=(980.818,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.7611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCsCdF) + ring(Cd(F)-Cd-Cs-Cs) + radical(C=CC(C)(O)CJ)"""),
)

species(
    label = '[CH]=C(F)CC(C)=O(9337)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,D}
3  C u0 p0 c0 {5,S} {6,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43672,0.0521881,-3.47381e-05,1.04138e-08,-1.21912e-12,-11721,23.2044], Tmin=(100,'K'), Tmax=(1973.39,'K')), NASAPolynomial(coeffs=[18.1708,0.0182688,-8.95562e-06,1.70375e-09,-1.15684e-13,-18325.6,-68.9028], Tmin=(1973.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.2474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.681467,'amu*angstrom^2'), symmetry=1, barrier=(15.6683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.687788,'amu*angstrom^2'), symmetry=1, barrier=(15.8136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.683776,'amu*angstrom^2'), symmetry=1, barrier=(15.7214,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1004,'amu'),
...
"""),
    E0 = (6.18866,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,323,467,575,827,1418,2950,3100,1380,975,1025,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.05872,'amu*angstrom^2'), symmetry=1, barrier=(47.3341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.05663,'amu*angstrom^2'), symmetry=1, barrier=(47.2859,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.000958893,0.0751497,-7.56112e-05,3.77962e-08,-7.25874e-12,899.312,24.6152], Tmin=(100,'K'), Tmax=(1374.98,'K')), NASAPolynomial(coeffs=[19.283,0.014295,-4.03617e-06,5.77614e-10,-3.43255e-14,-3954.23,-72.9252], Tmin=(1374.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.18866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCsCdF) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(O)CC(=[CH])F(9340)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
...
"""),
    E0 = (171.049,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,246,474,533,1155,3115,3125,620,680,785,800,1600,1700,297.313],'cm^-1')),
        HinderedRotor(inertia=(0.228916,'amu*angstrom^2'), symmetry=1, barrier=(14.3325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229015,'amu*angstrom^2'), symmetry=1, barrier=(14.3359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229276,'amu*angstrom^2'), symmetry=1, barrier=(14.3329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.307112,0.0707475,-7.73624e-05,4.08331e-08,-8.20059e-12,20714.4,27.2626], Tmin=(100,'K'), Tmax=(1298.79,'K')), NASAPolynomial(coeffs=[19.2262,0.00912299,-2.31314e-06,3.19964e-10,-1.91985e-14,16083.2,-67.867], Tmin=(1298.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    E0 = (-196.503,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,323,467,575,827,1418,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,267.628,268.679,272.396],'cm^-1')),
        HinderedRotor(inertia=(0.00230307,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161193,'amu*angstrom^2'), symmetry=1, barrier=(8.31649,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02505,0.0579641,-4.42987e-05,1.26981e-08,2.60945e-13,-23520.2,25.1574], Tmin=(100,'K'), Tmax=(1021.88,'K')), NASAPolynomial(coeffs=[14.3691,0.0191605,-7.05288e-06,1.26005e-09,-8.71574e-14,-26948.6,-42.9395], Tmin=(1021.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH]=C(O)CC(=C)F(9344)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.623557,0.0650124,-5.19032e-05,1.10509e-08,3.17494e-12,-10359.2,25.5003], Tmin=(100,'K'), Tmax=(961.776,'K')), NASAPolynomial(coeffs=[18.0908,0.0133986,-4.20733e-06,7.26764e-10,-5.1571e-14,-14691.8,-63.1452], Tmin=(961.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.2112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = 'C=C(O)C[C]=CF(9345)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {13,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.768078,0.062957,-5.16284e-05,1.46703e-08,9.62511e-13,-9469.04,25.8089], Tmin=(100,'K'), Tmax=(979.643,'K')), NASAPolynomial(coeffs=[16.5185,0.0156904,-5.35271e-06,9.38644e-10,-6.54535e-14,-13372.9,-54.028], Tmin=(979.643,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.7579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)CC(=C)O(9313)'],
    products = ['HF(38)', 'CH2CO(28)', '[CH]=C=C(5584)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.52349e+10,'s^-1'), n=1.11612, Ea=(220.588,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_N-Sp-7BrCClFINPSSi-2C',), comment="""Estimated from node Root_1R!H->C_N-5Br1sCl1sF1sH->H_5Br1sCl1sF1s->F1s_Ext-2C-R_N-7R!H->O_N-Sp-7BrCClFINPSSi-2C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C(=C)O(9333)'],
    products = ['[CH]=C(F)CC(=C)O(9313)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(150.001,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(6)', '[C]=C(F)CC(=C)O(9334)'],
    products = ['[CH]=C(F)CC(=C)O(9313)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=C(F)CC(=C)O(9313)'],
    products = ['[CH2]C1(O)C=C(F)C1(9336)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=C(F)CC(=C)O(9313)'],
    products = ['[CH]=C(F)CC(C)=O(9337)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(205000,'s^-1'), n=2.37, Ea=(209.666,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R"""),
)

reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CCC(=C)O(6918)'],
    products = ['[CH]=C(F)CC(=C)O(9313)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(5)', '[CH]=C(F)C[C]=C(6931)'],
    products = ['[CH]=C(F)CC(=C)O(9313)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[CH]=C(F)CC(=C)[O](9338)'],
    products = ['[CH]=C(F)CC(=C)O(9313)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=[C]O(606)', '[CH]C(=C)F(5373)'],
    products = ['[CH]=C(F)CC(=C)O(9313)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[C]F(488)', '[CH2]C(=C)O(2353)'],
    products = ['[CH]=C(F)CC(=C)O(9313)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH]=C=CC(=C)O(9341)'],
    products = ['[CH]=C(F)CC(=C)O(9313)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(278.622,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(F)CC(=C)O(9313)'],
    products = ['[CH2]C(F)=CC(=C)O(9342)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C([O])CC(=C)F(9343)'],
    products = ['[CH]=C(F)CC(=C)O(9313)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2.468e+06,'s^-1','*|/',3), n=1.554, Ea=(121.469,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(2000,'K'), comment="""From training reaction 290 used for R5H_SSSD;O_rad_out;Cd_H_out_singleH
