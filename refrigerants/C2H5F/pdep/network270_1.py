...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COCF(1521)'],
    products = ['C#COCCF(622)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2F(46)', 'C#CO[CH2](454)'],
    products = ['C#COCCF(622)'],
    transitionState = 'TS8',
