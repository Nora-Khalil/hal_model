...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12336,0.0303083,2.15396e-05,-4.30072e-08,1.64939e-11,-11501.6,16.2094], Tmin=(100,'K'), Tmax=(1041.06,'K')), NASAPolynomial(coeffs=[9.81692,0.026925,-1.13027e-05,2.17727e-09,-1.56835e-13,-14522.1,-28.0301], Tmin=(1041.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.2702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)

species(
    label = 'C=CCC(=C)F(6888)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66705,0.0430777,-1.35128e-05,-1.051e-08,6.28102e-12,-14311.4,21.2973], Tmin=(100,'K'), Tmax=(1057.31,'K')), NASAPolynomial(coeffs=[11.1741,0.0236732,-9.48039e-06,1.76281e-09,-1.23926e-13,-17247.5,-29.4763], Tmin=(1057.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-119.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0915374,'amu*angstrom^2'), symmetry=1, barrier=(2.10463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.876989,'amu*angstrom^2'), symmetry=1, barrier=(20.1637,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54738,0.0548287,-4.59647e-05,2.08738e-08,-3.98702e-12,24291.2,22.8329], Tmin=(100,'K'), Tmax=(1213.07,'K')), NASAPolynomial(coeffs=[9.83195,0.0275115,-1.21868e-05,2.31081e-09,-1.61477e-13,22281.2,-18.7357], Tmin=(1213.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sCsH)(H)(H)) + radical(Cds_P)"""),
)

species(
    label = 'C=[C][CH]C(C)F(6466)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72459,0.0544474,-5.35913e-05,3.4042e-08,-9.76594e-12,17471.7,23.8194], Tmin=(100,'K'), Tmax=(810.31,'K')), NASAPolynomial(coeffs=[5.84024,0.0341307,-1.59816e-05,3.099e-09,-2.19144e-13,16804.7,4.82944], Tmin=(810.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = '[CH]=[C]CC(C)F(6895)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (232.352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,286.132],'cm^-1')),
        HinderedRotor(inertia=(0.188175,'amu*angstrom^2'), symmetry=1, barrier=(10.9299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188138,'amu*angstrom^2'), symmetry=1, barrier=(10.9299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188158,'amu*angstrom^2'), symmetry=1, barrier=(10.9298,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65925,0.0544908,-4.81292e-05,2.43015e-08,-5.30097e-12,28027.2,21.507], Tmin=(100,'K'), Tmax=(1059.2,'K')), NASAPolynomial(coeffs=[8.09875,0.0301723,-1.36901e-05,2.62522e-09,-1.84741e-13,26663.1,-9.93023], Tmin=(1059.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(232.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCsCsFH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'C=[C]C[CH]F(442)'],
    products = ['[CH2]C(F)C[C]=C(6843)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(271)', '[CH2]C([CH2])F(214)'],
    products = ['[CH2]C(F)C[C]=C(6843)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C=C[C]=C(6501)'],
    products = ['[CH2]C(F)C[C]=C(6843)'],
