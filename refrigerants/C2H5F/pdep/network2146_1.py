...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC=[C]C(6090)'],
    products = ['CH2O(20)', 'C#CC(4975)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C[C]=C[O](6236)'],
    products = ['[CH2]OC=[C]C(6090)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](131)', '[CH]=[C]C(4976)'],
    products = ['[CH2]OC=[C]C(6090)'],
    transitionState = 'TS9',
