...
"""),
    E0 = (-327.378,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,113,247,382,1207,3490,2782.5,750,1395,475,1775,1000,540,610,2055,487.188,487.465,487.837],'cm^-1')),
        HinderedRotor(inertia=(0.172712,'amu*angstrom^2'), symmetry=1, barrier=(29.1132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172532,'amu*angstrom^2'), symmetry=1, barrier=(29.1112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80952,0.054985,-7.08756e-05,5.59135e-08,-1.95681e-11,-48070.1,19.4733], Tmin=(100,'K'), Tmax=(675.287,'K')), NASAPolynomial(coeffs=[5.82022,0.0312283,-1.81063e-05,3.81854e-09,-2.82116e-13,-48611.8,1.6986], Tmin=(675.287,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-400.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-CdsCsCs) + group(Cds-O2d(Cds-Cds)H) + group(CdCFH) + group(Cds-O2d(Cds-Cds)H)"""),
)

species(
    label = 'F[CH]C1=CO[CH]O1(11431)',
...
"""),
    E0 = (-10.1769,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,615,860,1140,1343,3152,1685,370,180],'cm^-1')),
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OC=C=CF(11416)'],
    products = ['O=COC=C=CF(8425)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]C1=CO[CH]O1(11431)'],
    products = ['O=COC=C=CF(8425)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['O[CH]OC#C[CH]F(11435)'],
    products = ['O=COC=C=CF(8425)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH]=C=COC=O(6580)'],
    products = ['O=COC=C=CF(8425)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C=O(147)', 'C#C[CH]F(4374)'],
    products = ['O=COC=C=CF(8425)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HCO(15)', 'O=C[C]=CF(9147)'],
    products = ['O=COC=C=CF(8425)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=COC#C[CH]F(11436)'],
    products = ['O=COC=C=CF(8425)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=[C]OC=C=CF(8993)'],
    products = ['O=COC=C=CF(8425)'],
