...
reaction(
    label = 'reaction2',
    reactants = ['[O]CC[C](F)F(4427)'],
    products = ['[CH2]C(F)(F)C[O](4426)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C[C](F)F(4520)'],
    products = ['[CH2]C(F)(F)C[O](4426)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([CH2])(F)F(4485)'],
    products = ['[CH2]C(F)(F)C[O](4426)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2O(20)', '[CH2][C](F)F(4220)'],
    products = ['[CH2]C(F)(F)C[O](4426)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)(F)C=O(4408)'],
    products = ['[CH2]C(F)(F)C[O](4426)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](131)', '[CH2][C](F)F(4220)'],
    products = ['[CH2]C(F)(F)C[O](4426)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(F)=C[O](2017)'],
    products = ['[CH2]C(F)(F)C[O](4426)'],
