...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COOC(373)'],
    products = ['C#COOCC(485)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(19)', 'C#COO[CH2](703)'],
    products = ['C#COOCC(485)'],
    transitionState = 'TS6',
