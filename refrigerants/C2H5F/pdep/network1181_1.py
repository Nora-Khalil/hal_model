...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(C[C]F)OF(2603)'],
    products = ['O=C(CCF)OF(2569)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]CC(=O)OF(652)'],
    products = ['O=C(CCF)OF(2569)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(160)', 'O=[C]CCF(1497)'],
    products = ['O=C(CCF)OF(2569)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(331)', 'CH2F-CH2(61)'],
    products = ['O=C(CCF)OF(2569)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'O=C([CH]CF)OF(2609)'],
    products = ['O=C(CCF)OF(2569)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(C[CH]F)OF(2610)'],
    products = ['O=C(CCF)OF(2569)'],
