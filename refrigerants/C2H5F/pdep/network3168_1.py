...
"""),
    E0 = (71.6522,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([162,485,641,721,926,1292,1380,3063,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,245.698,1370.88],'cm^-1')),
        HinderedRotor(inertia=(0.178159,'amu*angstrom^2'), symmetry=1, barrier=(7.49595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.51152,'amu*angstrom^2'), symmetry=1, barrier=(21.243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.498426,'amu*angstrom^2'), symmetry=1, barrier=(21.2386,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76046,0.0505254,-4.70156e-05,2.3152e-08,-4.71366e-12,8697.32,21.3893], Tmin=(100,'K'), Tmax=(1156.44,'K')), NASAPolynomial(coeffs=[9.93616,0.022246,-1.03342e-05,2.00554e-09,-1.4212e-13,6806.41,-19.2419], Tmin=(1156.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.6522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCH3) + radical(Cdj(Cs-F1sO2sH)(Cd-HH))"""),
)
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42674,0.0502134,-4.30494e-05,1.84986e-08,-3.15229e-12,-20747.1,18.6614], Tmin=(100,'K'), Tmax=(1410.62,'K')), NASAPolynomial(coeffs=[13.5952,0.0157084,-6.35856e-06,1.15847e-09,-7.91843e-14,-24180.2,-44.2309], Tmin=(1410.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-173.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(CdCddFO) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (18.6917,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([197,221,431,657,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,540,610,2055,965.033,1160.64,1164.48],'cm^-1')),
        HinderedRotor(inertia=(0.792379,'amu*angstrom^2'), symmetry=1, barrier=(18.2184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.792438,'amu*angstrom^2'), symmetry=1, barrier=(18.2197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58742,0.0476275,-4.31789e-05,1.94292e-08,-3.44802e-12,2339.46,20.5678], Tmin=(100,'K'), Tmax=(1361.6,'K')), NASAPolynomial(coeffs=[13.1906,0.0135407,-5.62723e-06,1.04314e-09,-7.21972e-14,-820.308,-38.9921], Tmin=(1361.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.6917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(CdCddFO) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=COCJ)"""),
)

species(
    label = 'C#CC(F)O[CH2](8811)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (-4.84608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([242,464,653,889,1056,1342,3790,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,183.009,1644.47],'cm^-1')),
        HinderedRotor(inertia=(3.05656,'amu*angstrom^2'), symmetry=1, barrier=(70.5363,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0188,'amu*angstrom^2'), symmetry=1, barrier=(23.4464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.96574,'amu*angstrom^2'), symmetry=1, barrier=(70.5364,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63043,0.0532453,-6.15079e-05,3.83522e-08,-9.63087e-12,-498.457,18.2936], Tmin=(100,'K'), Tmax=(967.34,'K')), NASAPolynomial(coeffs=[9.97487,0.0187413,-8.00564e-06,1.48052e-09,-1.01916e-13,-2112.87,-21.6866], Tmin=(967.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.84608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-OsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CsJOCH3)"""),
)

species(
    label = '[CH2]C=C(F)O[CH2](8812)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55151,0.0463015,-2.95584e-05,3.38471e-09,2.33774e-12,-2994.38,21.6254], Tmin=(100,'K'), Tmax=(1053.49,'K')), NASAPolynomial(coeffs=[13.0143,0.0164961,-6.6524e-06,1.24964e-09,-8.87751e-14,-6170.8,-37.8863], Tmin=(1053.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.6837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(CdCFO) + radical(Allyl_P) + radical(C=COCJ)"""),
)

species(
    label = '[CH]=CC(F)O[CH2](8813)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (76.3,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([236,527,855,1015,1182,1348,3236,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,1785.54],'cm^-1')),
        HinderedRotor(inertia=(0.856497,'amu*angstrom^2'), symmetry=1, barrier=(19.6925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.436372,'amu*angstrom^2'), symmetry=1, barrier=(10.033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17628,'amu*angstrom^2'), symmetry=1, barrier=(27.045,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80282,0.051236,-4.96812e-05,2.61431e-08,-5.77005e-12,9253.48,20.4642], Tmin=(100,'K'), Tmax=(1064,'K')), NASAPolynomial(coeffs=[8.98958,0.024218,-1.15916e-05,2.27731e-09,-1.6245e-13,7724.15,-14.6535], Tmin=(1064,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCH3) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=C(F)OC(8814)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {4,S}
3  C u0 p0 c0 {2,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55854,0.0508119,-4.49174e-05,2.03968e-08,-3.73673e-12,3945.1,19.9296], Tmin=(100,'K'), Tmax=(1299.9,'K')), NASAPolynomial(coeffs=[11.9276,0.0189044,-8.09801e-06,1.51346e-09,-1.05007e-13,1249.37,-32.8147], Tmin=(1299.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(32.0512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(CdCFO) + radical(Allyl_P) + radical(Cdj(Cs-HHH)(Cd-F1sO2s))"""),
)

species(
    label = '[CH]=[C]C(F)OC(8815)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {3,S} {4,S}
3  C u0 p0 c0 {1,S} {2,S} {5,S} {7,S}
...
"""),
    E0 = (130.877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([162,485,641,721,926,1292,1380,3063,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,218.91],'cm^-1')),
        HinderedRotor(inertia=(0.228994,'amu*angstrom^2'), symmetry=1, barrier=(7.78656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22894,'amu*angstrom^2'), symmetry=1, barrier=(7.78648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.668079,'amu*angstrom^2'), symmetry=1, barrier=(22.7182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81676,0.0521145,-5.63575e-05,3.55048e-08,-9.55304e-12,15816,20.8119], Tmin=(100,'K'), Tmax=(879.724,'K')), NASAPolynomial(coeffs=[7.43116,0.0265867,-1.28308e-05,2.51992e-09,-1.79447e-13,14828.2,-5.55495], Tmin=(879.724,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sO2sH)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=COCF(6317)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {3,S} {4,S}
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=[C]C([O])F(2081)'],
    products = ['[CH2]OC(F)[C]=C(8447)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', '[CH2]O[CH]F(978)'],
    products = ['[CH2]OC(F)[C]=C(8447)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH2]OC=C=C(6238)'],
    products = ['[CH2]OC(F)[C]=C(8447)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=C=C(8810)'],
    products = ['[CH2]OC(F)[C]=C(8447)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC(F)O[CH2](8811)'],
    products = ['[CH2]OC(F)[C]=C(8447)'],
