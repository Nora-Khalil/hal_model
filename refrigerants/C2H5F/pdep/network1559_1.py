...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3442)', '[CH]C(=C)F(2580)'],
    products = ['[CH]=C(F)C[C](F)F(4469)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)C=C(F)F(4649)'],
    products = ['[CH]=C(F)C[C](F)F(4469)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CC[C](F)F(4528)'],
    products = ['[CH]=C(F)C[C](F)F(4469)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH]=C=C[C](F)F(2769)'],
    products = ['[CH]=C(F)C[C](F)F(4469)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH]C(=C)F(2580)'],
    products = ['[CH]=C(F)C[C](F)F(4469)'],
