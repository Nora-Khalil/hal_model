...
"""),
    E0 = (0.91977,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,548,1085,1183,1302,1466,1520,3060,3119,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,241.355],'cm^-1')),
        HinderedRotor(inertia=(0.0134022,'amu*angstrom^2'), symmetry=1, barrier=(40.8032,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206012,'amu*angstrom^2'), symmetry=1, barrier=(8.50762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.987329,'amu*angstrom^2'), symmetry=1, barrier=(40.8027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.987414,'amu*angstrom^2'), symmetry=1, barrier=(40.8023,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.654,0.0564933,-6.73196e-05,4.85454e-08,-1.50485e-11,190.682,23.1659], Tmin=(100,'K'), Tmax=(768.78,'K')), NASAPolynomial(coeffs=[6.83853,0.0295184,-1.46885e-05,2.90582e-09,-2.07197e-13,-606.483,-0.483266], Tmin=(768.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.91977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsFHHO) + radical(CCsJOOC) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[CH]F(919)', '[CH]C-2(137)'],
    products = ['C[CH]OO[CH]F(2179)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', 'C[CH]O[O](158)'],
    products = ['C[CH]OO[CH]F(2179)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['C[CH]OO[CH]F(2179)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(187.418,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    products = ['C[CH]OO[CH]F(2179)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(222.714,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 222.7 to 222.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=COO[CH]F(1686)'],
    products = ['C[CH]OO[CH]F(2179)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['C[CH]OO[CH]F(2179)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(9.74284,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', 'C[CH]O[O](158)'],
    products = ['C[CH]OO[CH]F(2179)'],
