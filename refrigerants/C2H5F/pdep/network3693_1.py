...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3446.15,'J/mol'), sigma=(5.34644,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=538.28 K, Pc=51.17 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction1',
    reactants = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=C(C[CH]F)OF(2610)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C[CH]C(F)C(=O)OF(10373)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(169)', 'CC([C]=O)=CF(9792)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH]C(C)C(=O)OF-2(10375)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]F(837)', 'C[CH]C(=O)OF(651)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'CC([C]F)C(=O)OF-2(10376)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC([CH]F)=C(O)OF(10379)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'O=C(C=CF)OF(4178)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OF(331)', 'CC=CF(2186)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC(=CF)C(=O)OF(9664)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', 'CC([CH]F)C([O])=O(10380)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(160)', 'CC([C]=O)[CH]F(10381)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(19)', 'O=C([CH][CH]F)OF(4186)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]OF(331)', 'C[CH][CH]F(2782)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'C[C]([CH]F)C(=O)OF(10382)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', 'C[CH]C(=O)OF(651)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(5)', 'CC([C]F)C(=O)OF(9797)'],
    products = ['CC([CH]F)C(=O)OF(10366)'],
...
network(
    label = 'PDepNetwork #3693',
    isomers = [
        'CC([CH]F)C(=O)OF(10366)',
    ],
    reactants = [
