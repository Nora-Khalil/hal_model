...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.743933,0.0588833,-3.23814e-05,-1.23181e-08,1.21392e-11,-52614.5,21.2041], Tmin=(100,'K'), Tmax=(953.87,'K')), NASAPolynomial(coeffs=[19.9106,0.00916827,-2.4156e-06,4.35103e-10,-3.4786e-14,-57665.8,-77.67], Tmin=(953.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-438.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-243.979,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,3010,987.5,1337.5,450,1655,2120,512.5,787.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.939648,'amu*angstrom^2'), symmetry=1, barrier=(21.6043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.940368,'amu*angstrom^2'), symmetry=1, barrier=(21.6209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.939841,'amu*angstrom^2'), symmetry=1, barrier=(21.6088,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.646685,0.0669706,-7.12089e-05,3.38154e-08,-5.30121e-12,-29217.1,22.3557], Tmin=(100,'K'), Tmax=(993.263,'K')), NASAPolynomial(coeffs=[17.8533,0.00984574,-3.31722e-06,5.81577e-10,-4.08685e-14,-33235.5,-63.5618], Tmin=(993.263,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.979,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(CsCsF1sO2s)"""),
)
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.704832,0.0564679,-1.74973e-05,-3.34151e-08,2.1073e-11,-28587.9,25.0794], Tmin=(100,'K'), Tmax=(938.567,'K')), NASAPolynomial(coeffs=[22.1436,0.00537013,-1.93172e-07,8.38486e-12,-6.57682e-15,-34386,-86.4402], Tmin=(938.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[C]=O(156)', 'C[C]F-2(838)'],
    products = ['C[C](F)OC[C]=O(5124)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]O[C](C)F(981)'],
    products = ['C[C](F)OC[C]=O(5124)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['C[C](F)OC[C]=O(5124)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(102.122,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C[C]=O(156)', 'C[C]F(124)'],
    products = ['C[C](F)OC[C]=O(5124)'],
