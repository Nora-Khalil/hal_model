...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(181)', 'F[C]C=CF(5389)'],
    products = ['F[C]=CC(F)[CH]F(6038)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', 'F[C]=CC(F)=CF(5722)'],
    products = ['F[C]=CC(F)[CH]F(6038)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'FC#CC(F)[CH]F(6096)'],
    products = ['F[C]=CC(F)[CH]F(6038)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'F[C]=C=C[CH]F(5537)'],
    products = ['F[C]=CC(F)[CH]F(6038)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', 'F[C]C=CF(5389)'],
    products = ['F[C]=CC(F)[CH]F(6038)'],
