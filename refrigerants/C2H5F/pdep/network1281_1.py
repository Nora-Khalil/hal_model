...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(3603)', 'CH2OH(33)'],
    products = ['O=C(F)OCO(3897)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(5)', '[CH2]OC(=O)F(1098)'],
    products = ['O=C(F)OCO(3897)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', 'O=C(F)O[CH]O(4111)'],
    products = ['O=C(F)OCO(3897)'],
