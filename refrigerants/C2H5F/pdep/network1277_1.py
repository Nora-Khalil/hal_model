...
reaction(
    label = 'reaction10',
    reactants = ['OH(5)', '[CH2]C(=O)OF(2532)'],
    products = ['O=C(CO)OF(3893)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]OF(3602)', 'CH2OH(33)'],
    products = ['O=C(CO)OF(3893)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'O=C([CH]O)OF(3993)'],
    products = ['O=C(CO)OF(3893)'],
