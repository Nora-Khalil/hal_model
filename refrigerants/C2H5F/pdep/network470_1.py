...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(160)', 'CC(=O)[C]=O(1391)'],
    products = ['CC(=O)C(=O)OF(559)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'O=[C]C(=O)OF(1392)'],
    products = ['CC(=O)C(=O)OF(559)'],
