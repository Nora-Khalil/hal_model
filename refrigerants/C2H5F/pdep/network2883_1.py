...
"""),
    E0 = (-1350.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,2750,2800,2850,1350,1500,750,1050,1375,1000,431,527,613,668,835,1199,1245,1322,207.796,207.797,207.797],'cm^-1')),
        HinderedRotor(inertia=(0.212386,'amu*angstrom^2'), symmetry=1, barrier=(6.50775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212387,'amu*angstrom^2'), symmetry=1, barrier=(6.50775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212387,'amu*angstrom^2'), symmetry=1, barrier=(6.50775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.540675,'amu*angstrom^2'), symmetry=1, barrier=(16.5667,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.405293,0.0852403,-0.00011515,8.31543e-08,-2.42779e-11,-162258,26.1813], Tmin=(100,'K'), Tmax=(832.953,'K')), NASAPolynomial(coeffs=[11.9907,0.0296054,-1.49629e-05,2.96903e-09,-2.11648e-13,-164188,-27.5944], Tmin=(832.953,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1350.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(CsFFFO)"""),
)
...
"""),
    E0 = (-967.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,431,527,613,668,835,1199,1245,1322,395,473,707,1436,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.205699,'amu*angstrom^2'), symmetry=1, barrier=(4.72943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20575,'amu*angstrom^2'), symmetry=1, barrier=(4.7306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205676,'amu*angstrom^2'), symmetry=1, barrier=(4.72891,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1091.45,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([373,336,502,477,708,1220,1477,2750,2800,2850,1350,1500,750,1050,1375,1000,431,527,613,668,835,1199,1245,1322,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.21809,'amu*angstrom^2'), symmetry=1, barrier=(5.01431,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21812,'amu*angstrom^2'), symmetry=1, barrier=(5.015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357632,'amu*angstrom^2'), symmetry=1, barrier=(8.22265,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.61626,0.0809877,-0.000117937,9.50445e-08,-3.12185e-11,-131155,26.2322], Tmin=(100,'K'), Tmax=(741.483,'K')), NASAPolynomial(coeffs=[9.98193,0.0304583,-1.57064e-05,3.11923e-09,-2.21476e-13,-132544,-16.1494], Tmin=(741.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1091.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(CsFFFO) + radical(O2sj(Cs-F1sO2sCs))"""),
)
...
"""),
    E0 = (-1099.47,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,431,527,613,668,835,1199,1245,1322,200,800,960,1120,1280,1440,1600],'cm^-1')),
...
reaction(
    ...
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(23.1798,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)F(4942)', 'C=C(O)F(498)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'C=C(F)OC(F)(F)F(8133)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C[C](O)OC(F)(F)F(8134)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'CC(O)(F)O[C](F)F(5900)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CF3O(48)', 'C[C](O)F(1910)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF3(45)', 'CC([O])(O)F(5101)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['OH(7)', 'C[C](F)OC(F)(F)F(8135)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC([O])(F)OC(F)(F)F(8136)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', 'O[C](F)OC(F)(F)F(8137)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(O)(F)OC(F)(F)F(8138)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'CC(=O)OC(F)(F)F(8123)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(185.547,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C=C(O)OC(F)(F)F(4943)'],
    products = ['CC(O)(F)OC(F)(F)F(7544)'],
