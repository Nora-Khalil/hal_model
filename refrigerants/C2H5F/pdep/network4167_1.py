...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97961,0.0331886,1.73321e-05,-4.33847e-08,1.81567e-11,3423.73,20.898], Tmin=(100,'K'), Tmax=(990.505,'K')), NASAPolynomial(coeffs=[10.9826,0.0236804,-8.92816e-06,1.65591e-09,-1.18474e-13,323.168,-29.0987], Tmin=(990.505,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.7789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + ring(Cs-Cd(C)-Cd(F))"""),
)
...
"""),
    E0 = (90.1325,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,271,519,563,612,1379,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180],'cm^-1')),
        HinderedRotor(inertia=(0.161356,'amu*angstrom^2'), symmetry=1, barrier=(3.7099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161363,'amu*angstrom^2'), symmetry=1, barrier=(3.71005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0448797,'amu*angstrom^2'), symmetry=1, barrier=(36.9418,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
...
"""),
    E0 = (233.025,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,3000,3100,440,815,1455,1000,180,1023.16,1023.93,1024.46,1024.47,1024.64],'cm^-1')),
        HinderedRotor(inertia=(0.18572,'amu*angstrom^2'), symmetry=1, barrier=(4.27007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00570631,'amu*angstrom^2'), symmetry=1, barrier=(4.25048,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01804,0.0339065,6.94234e-06,-3.12235e-08,1.37643e-11,28106.4,22.5466], Tmin=(100,'K'), Tmax=(998.132,'K')), NASAPolynomial(coeffs=[10.7694,0.021398,-8.16663e-06,1.51493e-09,-1.08e-13,25235.4,-25.2874], Tmin=(998.132,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(233.025,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + ring(Cs-Cd(C)-Cd(F)) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18002,0.0295035,2.16002e-05,-4.25751e-08,1.63937e-11,28659,22.2716], Tmin=(100,'K'), Tmax=(1031.6,'K')), NASAPolynomial(coeffs=[9.34842,0.0268196,-1.101e-05,2.09519e-09,-1.50014e-13,25843.9,-19.0111], Tmin=(1031.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cs(C)-Cs-Cs(F)) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring) + radical(Cs_S)"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05126,0.0381677,-1.27521e-05,-1.99477e-09,1.40774e-12,27561.5,22.0226], Tmin=(100,'K'), Tmax=(1405.21,'K')), NASAPolynomial(coeffs=[8.73206,0.0282102,-1.17938e-05,2.13866e-09,-1.43904e-13,24789.4,-15.6638], Tmin=(1405.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cs(C)-Cs-Cs(F)) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C1C[C]1F(11548)'],
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]CC1=C(F)C1(11593)'],
    products = ['[CH2]CC1C[C]1F(9982)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(2.97324,'m^3/(mol*s)'), n=2.12322, Ea=(1.75323,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0984061311673169, var=1.772613507237397, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_2CS-inRing_N-Sp-2CS-=1CCOSS_1COS-inRing_Ext-2CS-R_Ext-4R!H-R_Ext-1COS-R',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_2CS-inRing_N-Sp-2CS-=1CCOSS_1COS-inRing_Ext-2CS-R_Ext-4R!H-R_Ext-1COS-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00100541,'m^3/(mol*s)'), n=2.87982, Ea=(14.4886,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H',), comment="""Estimated from node Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=CC1C[C]1F(11572)'],
    products = ['[CH2]CC1C[C]1F(9982)'],
