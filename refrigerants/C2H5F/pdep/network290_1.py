...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'C#COC(=O)F(1404)'],
    products = ['C#COC(C)([O])F(642)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=[C]OC(C)=O(1313)'],
    products = ['C#COC(C)([O])F(642)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', '[CH]=[C]OC(=O)F(1405)'],
    products = ['C#COC(C)([O])F(642)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', 'C#COC([CH2])([O])F(1406)'],
    products = ['C#COC(C)([O])F(642)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', '[C]#COC(C)([O])F(1407)'],
    products = ['C#COC(C)([O])F(642)'],
