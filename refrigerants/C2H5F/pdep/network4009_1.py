...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CO[CH]F(2036)'],
    products = ['[CH]=C(CF)O[CH]F(8916)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)O[CH]F(2567)'],
    products = ['[CH]=C(CF)O[CH]F(8916)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(837)', '[CH]=C([O])CF(2478)'],
    products = ['[CH]=C(CF)O[CH]F(8916)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2F(46)', 'C#CO[CH]F(1743)'],
    products = ['[CH]=C(CF)O[CH]F(8916)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[CH]=C([O])CF(2478)'],
    products = ['[CH]=C(CF)O[CH]F(8916)'],
