...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6864,0.0559829,-6.47432e-05,5.62822e-08,-2.19669e-11,741.122,24.6113], Tmin=(100,'K'), Tmax=(734.531,'K')), NASAPolynomial(coeffs=[3.54995,0.0397713,-1.92552e-05,3.75887e-09,-2.65466e-13,630.924,17.3092], Tmin=(734.531,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.50986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFHH) + ring(Cs(F)-Cs-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = 'FC(F)C[C]1[CH]C1(12859)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['F[CH]CC1(F)[CH]C1(12816)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(181)', '[CH2]C1(F)[CH]C1(12840)'],
    products = ['F[CH]CC1(F)[CH]C1(12816)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C=C(F)C[CH]F(10939)'],
    products = ['F[CH]CC1(F)[CH]C1(12816)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]CC1=CC1(12852)'],
    products = ['F[CH]CC1(F)[CH]C1(12816)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', 'F[CH]CC1(F)C=C1(12853)'],
    products = ['F[CH]CC1(F)[CH]C1(12816)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', 'FC=CC1(F)[CH]C1(12854)'],
    products = ['F[CH]CC1(F)[CH]C1(12816)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'F[CH]C[C]1C=C1(8385)'],
    products = ['F[CH]CC1(F)[CH]C1(12816)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'F[CH]C=C1[CH]C1(12855)'],
    products = ['F[CH]CC1(F)[CH]C1(12816)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF(40)', '[CH2]C1(F)[CH]C1(12840)'],
    products = ['F[CH]CC1(F)[CH]C1(12816)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH]CC1(F)[CH]C1(12816)'],
    products = ['F[CH][CH]C1(F)CC1(12857)'],
...
reaction(
    label = 'reaction20',
    reactants = ['FCCC1(F)[CH][CH]1(12858)'],
    products = ['F[CH]CC1(F)[CH]C1(12816)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[CH]CC1(F)[CH]C1(12816)'],
    products = ['FC(F)C[C]1[CH]C1(12859)'],
...
network(
    label = 'PDepNetwork #4009',
    isomers = [
        'F[CH]CC1(F)[CH]C1(12816)',
    ],
    reactants = [
