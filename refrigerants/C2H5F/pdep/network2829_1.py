...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=C(O)O[C](F)F(3295)'],
    products = ['O=C(O)OC(F)(F)F(7500)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'O=[C]OC(F)(F)F(8094)'],
    products = ['O=C(O)OC(F)(F)F(7500)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(=O)OC(F)(F)F(8095)'],
    products = ['O=C(O)OC(F)(F)F(7500)'],
    transitionState = 'TS8',
