...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', 'C=[C]C[CH]F(934)'],
    products = ['C=[C]CC(F)[CH]F(6690)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=[C]CC(F)=CF(6945)'],
    products = ['C=[C]CC(F)[CH]F(6690)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#CCC(F)[CH]F(6946)'],
    products = ['C=[C]CC(F)[CH]F(6690)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C=[C]C=C[CH]F(6379)'],
    products = ['C=[C]CC(F)[CH]F(6690)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'C=[C]C[CH]F(934)'],
    products = ['C=[C]CC(F)[CH]F(6690)'],
