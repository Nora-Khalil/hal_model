...
"""),
    E0 = (-350.522,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,261,493,600,1152,1365,1422,3097,375,361,584,565,722,1474,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-147.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.48029,0.0834319,-0.00010009,6.43291e-08,-1.69366e-11,-17675,28.4629], Tmin=(100,'K'), Tmax=(913.783,'K')), NASAPolynomial(coeffs=[12.1257,0.0324571,-1.64161e-05,3.2855e-09,-2.36323e-13,-19803.3,-26.6697], Tmin=(913.783,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(F)(OF)O[CH]C(5798)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-389.642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,364,474,579,619,655,1345,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.681347,0.113034,-0.000187053,1.63202e-07,-5.62114e-11,-46704.3,30.605], Tmin=(100,'K'), Tmax=(795.773,'K')), NASAPolynomial(coeffs=[12.361,0.0356724,-1.89789e-05,3.7559e-09,-2.63679e-13,-48406.2,-26.9889], Tmin=(795.773,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.12994,'amu*angstrom^2'), symmetry=1, barrier=(25.9796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13146,'amu*angstrom^2'), symmetry=1, barrier=(26.0144,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.637033,0.0920263,-0.000107045,5.8487e-08,-1.21634e-11,-32369.2,26.8626], Tmin=(100,'K'), Tmax=(1193.81,'K')), NASAPolynomial(coeffs=[23.981,0.00954003,-3.40176e-06,6.08416e-10,-4.26917e-14,-38247,-96.2661], Tmin=(1193.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-270.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(CsCFOO) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)
...
7  C u0 p0 c0 {2,S} {4,S} {8,S} {10,S}
8  C u0 p0 c0 {7,S} {11,S} {12,S} {13,S}
9  C u0 p0 c0 {3,S} {6,S} {14,S} {15,S}
10 H u0 p0 c0 {7,S}
11 H u0 p0 c0 {8,S}
12 H u0 p0 c0 {8,S}
13 H u0 p0 c0 {8,S}
...
"""),
    ...
    molecularWeight = (143.084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.379288,0.0868001,-9.94343e-05,6.29115e-08,-1.66365e-11,-101955,27.2174], Tmin=(100,'K'), Tmax=(901.46,'K')), NASAPolynomial(coeffs=[11.1774,0.0388858,-1.97057e-05,3.94838e-09,-2.84222e-13,-103902,-23.7568], Tmin=(901.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-848.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sO2sCs))"""),
)
...
"""),
    E0 = (-566.735,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,375,361,584,565,722,1474,528,1116,1182,1331,1402,1494,3075,3110,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.552605,0.106778,-0.000147553,1.06075e-07,-3.04088e-11,-68004.4,29.1844], Tmin=(100,'K'), Tmax=(852.575,'K')), NASAPolynomial(coeffs=[15.3977,0.0319454,-1.58955e-05,3.12678e-09,-2.21652e-13,-70724.2,-45.2227], Tmin=(852.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-566.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsHHH) + radical(CCsJOCs)"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(12.1725,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C[C]F(124)', '[CH2]C(O)(F)OF(3863)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.76395e-12,'m^3/(mol*s)'), n=5.02686, Ea=(53.1403,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[CH2]C(F)(OC)OF(5748)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', '[CH2]C(F)(OF)OCF(5752)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2CHF(55)', '[CH2]C(O)(F)OF(3863)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', 'CC(F)O[C](F)OF(5768)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]C(F)(OF)OC(C)F(7576)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(OF)OC(C)F(5735)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(46.6372,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction9',
    reactants = ['C=C(F)OF(1352)', 'CC([O])F(533)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)(OF)O[CH]C(5798)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C([O])(F)OC(C)F(5306)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C](F)OF(1348)', 'CC([O])F(533)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C([O])(F)OF(3869)', 'CH3-CHF(62)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(160)', '[CH2][C](F)OC(C)F(1522)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(19)', '[CH2]C(F)(OF)O[CH]F(7578)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(F)(OF)O[C](C)F(7579)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(77)', '[CH2]C(=O)OC(C)F(3670)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(99.6817,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction21',
    reactants = ['HF(38)', '[CH2]C(F)(OF)OC=C(5799)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    products = ['F2(77)', 'CH2CFO(78)', 'CH3CHO(36)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(216.041,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    products = ['C[C](F)OC(C)(F)OF(5794)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C[CH]OC(F)(CF)OF(7583)'],
    products = ['[CH2]C(F)(OF)OC(C)F(5795)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(189.424,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #2856',
    isomers = [
        '[CH2]C(F)(OF)OC(C)F(5795)',
    ],
    reactants = [
