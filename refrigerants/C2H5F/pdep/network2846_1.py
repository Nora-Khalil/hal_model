...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CC(F)(F)OF(4763)'],
    products = ['CCC(F)(F)OF(7514)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(1637)', 'CC[C]F(2185)'],
    products = ['CCC(F)(F)OF(7514)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(169)', 'CC=C(F)F(4986)'],
    products = ['CCC(F)(F)OF(7514)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(160)', 'CC[C](F)F(3566)'],
    products = ['CCC(F)(F)OF(7514)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['FO[C](F)F(7422)', 'C2H5(32)'],
    products = ['CCC(F)(F)OF(7514)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[CH2]C(F)(F)OF(7848)'],
    products = ['CCC(F)(F)OF(7514)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C[CH]C(F)(F)OF(7813)'],
    products = ['CCC(F)(F)OF(7514)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]CC(F)(F)OF(7847)'],
    products = ['CCC(F)(F)OF(7514)'],
