...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH2]C(=C)[O](660)'],
    products = ['C=C([O])C[O](790)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](318)', '[CH2][C]=O(504)'],
    products = ['C=C([O])C[O](790)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[O]C[C]=O(855)'],
    products = ['C=C([O])C[O](790)'],
