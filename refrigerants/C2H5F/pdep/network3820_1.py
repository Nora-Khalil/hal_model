...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01527,0.0355172,-6.21774e-06,-1.49432e-08,7.34449e-12,-12413.8,17.5816], Tmin=(100,'K'), Tmax=(1063.51,'K')), NASAPolynomial(coeffs=[10.7288,0.0199114,-8.41931e-06,1.61454e-09,-1.1559e-13,-15238,-29.5567], Tmin=(1063.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-103.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCCFH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cs(F)-Cd-Cd(O2))"""),
)

species(
    label = 'COC1C=C1F(10767)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
...
"""),
    E0 = (88.1419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,3000,3100,440,815,1455,1000,522.823,522.873,522.937,522.965,522.995,523.071,523.107],'cm^-1')),
        HinderedRotor(inertia=(0.000616476,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000616153,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13543,0.0333765,-7.75281e-06,-1.23986e-08,6.446e-12,10674.7,19.6356], Tmin=(100,'K'), Tmax=(1064.75,'K')), NASAPolynomial(coeffs=[10.6967,0.0171594,-7.37047e-06,1.42746e-09,-1.0285e-13,7947.68,-26.4493], Tmin=(1064.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.1419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCCFH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cs(F)-Cd-Cd(O2)) + radical(C=COCJ)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01607,0.0356392,-1.22489e-05,-1.1452e-08,7.2167e-12,36298.3,17.015], Tmin=(100,'K'), Tmax=(1011.58,'K')), NASAPolynomial(coeffs=[12.0094,0.0135499,-5.33449e-06,1.02072e-09,-7.4402e-14,33384.9,-35.7191], Tmin=(1011.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CsJOCC2)"""),
)

species(
    label = '[CH2]OC1C=C1F(10780)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {6,S}
3  C u0 p0 c0 {2,S} {4,S} {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91359,0.0505039,-6.53547e-05,5.71464e-08,-2.11953e-11,16491.3,20.6633], Tmin=(100,'K'), Tmax=(773.913,'K')), NASAPolynomial(coeffs=[4.4886,0.0307896,-1.47297e-05,2.84255e-09,-1.98737e-13,16284.5,10.1396], Tmin=(773.913,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cs(F)-Cs-Cs) + radical(C2CsJOCs) + radical(Csj(Cs-O2sCsH)(Cs-CsF1sH)(H)_ring)"""),
)

species(
    label = 'COC1[CH][C]1F(10784)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {3,S} {4,S}
3  C u0 p0 c0 {2,S} {5,S} {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.36142,0.0220798,3.6853e-05,-6.47262e-08,2.63832e-11,9189.47,23.0873], Tmin=(100,'K'), Tmax=(969.353,'K')), NASAPolynomial(coeffs=[12.5903,0.0145232,-5.0762e-06,9.88864e-10,-7.60583e-14,5578.32,-34.3406], Tmin=(969.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.8106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsFHHO) + ring(Cyclopropane) + radical(CCJCO) + radical(CCJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC1[CH]C1F(10765)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C1[CH]C1F(10000)'],
    products = ['[CH2]OC1[CH]C1F(10765)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC1=CC1F(10778)'],
    products = ['[CH2]OC1[CH]C1F(10765)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]OC1C=C1(10779)'],
    products = ['[CH2]OC1[CH]C1F(10765)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]OC1C=C1F(10780)'],
    products = ['[CH2]OC1[CH]C1F(10765)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH2]OC1=C[CH]1(10781)'],
    products = ['[CH2]OC1[CH]C1F(10765)'],
