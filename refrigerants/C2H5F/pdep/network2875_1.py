...
"""),
    E0 = (284.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.900917,'amu*angstrom^2'), symmetry=1, barrier=(20.7139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.900616,'amu*angstrom^2'), symmetry=1, barrier=(20.7069,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48432,0.0543709,-6.07821e-05,3.48406e-08,-7.89246e-12,34360.7,19.1398], Tmin=(100,'K'), Tmax=(1077.31,'K')), NASAPolynomial(coeffs=[12.0044,0.01531,-6.3948e-06,1.18407e-09,-8.20592e-14,32094,-32.3968], Tmin=(1077.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CCC(=O)CF(9324)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {5,D}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48485,0.0529484,-3.57662e-05,1.08565e-08,-1.29137e-12,-7699.37,23.567], Tmin=(100,'K'), Tmax=(1928.04,'K')), NASAPolynomial(coeffs=[17.5246,0.0196724,-9.87825e-06,1.90529e-09,-1.30738e-13,-13884.6,-64.346], Tmin=(1928.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-64.7802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (590.099,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,338.278,338.28,4000],'cm^-1')),
        HinderedRotor(inertia=(0.353027,'amu*angstrom^2'), symmetry=1, barrier=(28.6677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140903,'amu*angstrom^2'), symmetry=1, barrier=(11.442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.230734,'amu*angstrom^2'), symmetry=1, barrier=(18.7369,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39431,0.0609407,-6.66219e-05,4.02726e-08,-1.01041e-11,71063.4,25.0915], Tmin=(100,'K'), Tmax=(951.93,'K')), NASAPolynomial(coeffs=[9.54707,0.0266825,-1.26391e-05,2.46635e-09,-1.75173e-13,69511.2,-13.8392], Tmin=(951.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(590.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'FO[C]1CC=CC1(9326)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69944,0.0397809,2.51958e-06,-2.89338e-08,1.28606e-11,19833.6,21.182], Tmin=(100,'K'), Tmax=(1032.11,'K')), NASAPolynomial(coeffs=[12.0622,0.0239479,-9.82787e-06,1.88061e-09,-1.35446e-13,16398.7,-35.4176], Tmin=(1032.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(C2CsJO)"""),
)

species(
    label = '[CH2]C1(OF)C=CC1(9327)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {3,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1953,0.0483698,-5.61497e-06,-3.34311e-08,1.78701e-11,32681.8,23.5154], Tmin=(100,'K'), Tmax=(962.058,'K')), NASAPolynomial(coeffs=[16.6855,0.0160417,-5.22205e-06,9.52718e-10,-7.05906e-14,28216.9,-58.3313], Tmin=(962.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(C=CC(C)(O)CJ)"""),
)
...
"""),
    E0 = (573.688,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,260.969],'cm^-1')),
        HinderedRotor(inertia=(0.2644,'amu*angstrom^2'), symmetry=1, barrier=(12.7891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26239,'amu*angstrom^2'), symmetry=1, barrier=(12.842,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (372.493,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,241.181,241.181,241.181,241.181,241.181],'cm^-1')),
        HinderedRotor(inertia=(1.2164,'amu*angstrom^2'), symmetry=1, barrier=(50.2099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2164,'amu*angstrom^2'), symmetry=1, barrier=(50.2099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2164,'amu*angstrom^2'), symmetry=1, barrier=(50.2099,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.997844,0.0653259,-6.06695e-05,3.04403e-08,-6.28877e-12,44909.3,23.3976], Tmin=(100,'K'), Tmax=(1149.73,'K')), NASAPolynomial(coeffs=[11.7188,0.028027,-1.20075e-05,2.22395e-09,-1.53378e-13,42444,-29.821], Tmin=(1149.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(372.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=[C]CC(=C)OF(9330)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {4,S}
3  C u0 p0 c0 {4,S} {6,S} {8,S} {9,S}
...
"""),
    E0 = (526.19,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,3115,3125,620,680,785,800,1600,1700,568.482],'cm^-1')),
        HinderedRotor(inertia=(0.545706,'amu*angstrom^2'), symmetry=1, barrier=(12.5469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.545572,'amu*angstrom^2'), symmetry=1, barrier=(12.5438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0385832,'amu*angstrom^2'), symmetry=1, barrier=(12.552,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19553,0.0627439,-6.71411e-05,3.78498e-08,-8.62126e-12,63386.2,26.2263], Tmin=(100,'K'), Tmax=(1057.9,'K')), NASAPolynomial(coeffs=[11.8217,0.0225657,-1.01725e-05,1.94945e-09,-1.37406e-13,61137.9,-25.6369], Tmin=(1057.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(526.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CCC(=C)OF(7314)'],
    products = ['HF(38)', 'CH2CO(28)', '[CH]=C=C(5584)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(36.7552,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(=C)OF(9315)'],
    products = ['[CH]=CCC(=C)OF(7314)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=CCC(=C)[O](7003)'],
    products = ['[CH]=CCC(=C)OF(7314)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(357)', '[CH]=CC[C]=C(6908)'],
    products = ['[CH]=CCC(=C)OF(7314)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C=[C]OF(507)', '[CH]C=C(9020)'],
    products = ['[CH]=CCC(=C)OF(7314)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[CH](272)', '[CH2]C(=C)OF(1480)'],
    products = ['[CH]=CCC(=C)OF(7314)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[CH]C=CC(=C)OF(9329)'],
    products = ['[CH]=CCC(=C)OF(7314)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2.88633e+07,'m^3/(mol*s)'), n=0.213913, Ea=(8.90035,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=8.197906922440378e-05, var=0.01210657880115639, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_N-3R!H->F_3BrCClINOPSSi->C_Ext-2C-R_N-3C-inRing_Ext-3C-R_Ext-5R!H-R"""),
)

reaction(
    label = 'reaction14',
    reactants = ['H(6)', '[CH]=[C]CC(=C)OF(9330)'],
    products = ['[CH]=CCC(=C)OF(7314)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH]=CCC(=[CH])OF(9331)'],
    products = ['[CH]=CCC(=C)OF(7314)'],
