...
"""),
    E0 = (-117.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([347,453,1141,1468,353,444,1253,3145,624.031,624.058,624.084,624.153,624.159,624.17,624.269],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0351,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45905,0.033546,-2.6896e-05,1.0165e-08,-1.54552e-12,-14073.2,23.5173], Tmin=(100,'K'), Tmax=(1518.56,'K')), NASAPolynomial(coeffs=[10.1601,0.0132606,-6.85843e-06,1.36821e-09,-9.73023e-14,-16412.1,-16.8532], Tmin=(1518.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(CsCCFH) + group(CsJ2_singlet-CsH) + longDistanceInteraction_cyclic(Cs(F)-Cs(F)) + longDistanceInteraction_cyclic(3ring-Cs(F)2-Cs(F)) + ring(Cyclopropane)"""),
)

species(
    label = 'FC=C=C(F)F(5934)',
    structure = adjacencyList("""1 F u0 p3 c0 {4,S}
2 F u0 p3 c0 {5,S}
3 F u0 p3 c0 {5,S}
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61234,0.0331059,-5.55073e-05,4.66086e-08,-1.50369e-11,16954.8,9.14291], Tmin=(100,'K'), Tmax=(869.141,'K')), NASAPolynomial(coeffs=[7.09744,0.00778248,-3.72295e-06,6.90142e-10,-4.61168e-14,16352,-10.8488], Tmin=(869.141,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CdCddCF) + group(CdCddCF) + group(Cdd-CdsCds) + longDistanceInteraction_cyclic(Cds(F)-Cds(F)) + longDistanceInteraction_cyclic(Cds(F)-Cds(F)) + ring(Cyclopropadiene)"""),
)

species(
    label = 'FC1(F)C#C1(7187)',
    structure = adjacencyList("""1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {3,S}
3 C u0 p0 c0 {1,S} {2,S} {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (74.0287,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2577,0.0452444,-9.08852e-05,8.39506e-08,-2.82542e-11,28549.9,10.0218], Tmin=(100,'K'), Tmax=(920.162,'K')), NASAPolynomial(coeffs=[6.3751,0.00984634,-4.65435e-06,8.07617e-10,-4.96969e-14,28533,-5.47405], Tmin=(920.162,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Ct-CtCs) + group(Ct-CtCs) + ring(Cyclopropyne)"""),
)
...
"""),
    E0 = (371.616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3120,650,792.5,1650,497.754,497.759],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0383,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.03295,0.0187405,-1.85243e-05,9.87119e-09,-2.02821e-12,44732,12.4511], Tmin=(100,'K'), Tmax=(1315.83,'K')), NASAPolynomial(coeffs=[7.06896,0.00493066,-1.02525e-06,1.15427e-10,-5.60602e-15,43803.2,-7.62127], Tmin=(1315.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(C=C=CJ) + radical(Cdj(Cdd-Cd)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (94.0351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2347,0.0427922,-6.84109e-05,6.04733e-08,-2.13414e-11,-11928.1,17.5356], Tmin=(100,'K'), Tmax=(778.849,'K')), NASAPolynomial(coeffs=[6.60784,0.0159188,-8.15428e-06,1.61945e-09,-1.14522e-13,-12475.5,-1.60986], Tmin=(778.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'FC#C[CH]F(4386)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {3,S}
2 F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['CF2(43)', 'C2HF(57)'],
    products = ['FC1=CC1(F)F(7118)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'FC1=C(F)[CH]1(7183)'],
    products = ['FC1=CC1(F)F(7118)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'FC1(F)[C]=C1(7134)'],
    products = ['FC1=CC1(F)F(7118)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC1=[C]C1(F)F(7184)'],
    products = ['FC1=CC1(F)F(7118)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'FC1=C=C1F(7186)'],
    products = ['FC1=CC1(F)F(7118)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', 'FC1(F)C#C1(7187)'],
    products = ['FC1=CC1(F)F(7118)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', '[CH]=C=[C]F(7193)'],
    products = ['[CH]C(F)=C(F)F(4652)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[C]F(3442)', '[CH]=[C]F(1321)'],
    products = ['[CH]C(F)=C(F)F(4652)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'F[C]=C=[C]F(7204)'],
    products = ['F[C]C=C(F)F(4384)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'F[C]=C=C(F)F(7205)'],
    products = ['F[C]C=C(F)F(4384)'],
...
reaction(
    label = 'reaction27',
    reactants = ['FC1[C]C1(F)F(7185)'],
    products = ['FC1=C(F)C1F(7182)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(3.82066e+10,'s^-1'), n=0.827, Ea=(149.436,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction28',
    reactants = ['F2(77)', 'FC1=C=C1(7136)'],
    products = ['FC1[C]C1(F)F(7185)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(16.8161,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(8.28222,'m^3/(mol*s)'), n=1.29695, Ea=(237.185,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R
Multiplied by reaction path degeneracy 2.0"""),
)
