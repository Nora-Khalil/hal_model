...
"""),
    E0 = (-22.7001,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.747663,'amu*angstrom^2'), symmetry=1, barrier=(17.1902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.34209,'amu*angstrom^2'), symmetry=1, barrier=(53.8492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.34647,'amu*angstrom^2'), symmetry=1, barrier=(53.95,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188335,'amu*angstrom^2'), symmetry=1, barrier=(4.3302,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70388,0.0571833,-6.33105e-05,3.25978e-08,-1.39977e-12,-2653.87,19.7951], Tmin=(100,'K'), Tmax=(565.68,'K')), NASAPolynomial(coeffs=[6.68544,0.0305506,-1.54743e-05,3.07425e-09,-2.19344e-13,-3354.94,-2.61506], Tmin=(565.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.7001,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsCsF1sO2s) + radical(CsJOOC)"""),
)
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0088,0.0368886,-1.31075e-05,-5.85658e-09,3.7442e-12,-35170.4,17.3669], Tmin=(100,'K'), Tmax=(1135.26,'K')), NASAPolynomial(coeffs=[10.1969,0.0209058,-8.99115e-06,1.71e-09,-1.2064e-13,-37858.7,-26.8268], Tmin=(1135.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-293.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cs-Cs(F)-O2s-O2s)"""),
)
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65624,0.0535533,-4.84174e-05,2.2556e-08,-4.35291e-12,-313.278,21.1121], Tmin=(100,'K'), Tmax=(1208.06,'K')), NASAPolynomial(coeffs=[10.573,0.0240286,-1.17572e-05,2.32479e-09,-1.66119e-13,-2467.63,-23.5913], Tmin=(1208.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.29164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH) + radical(CsJOOC)"""),
)

species(
    label = '[CH2][C](F)OOC(5216)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {3,S} {4,S}
3  O u0 p2 c0 {2,S} {5,S}
...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,395,473,707,1436,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.256905,'amu*angstrom^2'), symmetry=1, barrier=(5.90675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38005,'amu*angstrom^2'), symmetry=1, barrier=(31.7301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256717,'amu*angstrom^2'), symmetry=1, barrier=(5.90243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3513,0.0644701,-9.7027e-05,8.65628e-08,-3.14171e-11,-191.378,23.3092], Tmin=(100,'K'), Tmax=(779.855,'K')), NASAPolynomial(coeffs=[6.34061,0.0304776,-1.54847e-05,3.04109e-09,-2.1383e-13,-714.085,2.11722], Tmin=(779.855,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-2.33433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsCsF1sO2s) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]O[O](153)', 'C[C]F-2(838)'],
    products = ['[CH2]OO[C](C)F(5115)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[C](F)O[O](920)'],
    products = ['[CH2]OO[C](C)F(5115)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH2]OO[C](C)F(5115)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(19.2264,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['[CH2]O[O](153)', 'C[C]F(124)'],
    products = ['[CH2]OO[C](C)F(5115)'],
