...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(181)', 'F[CH]O[CH]F(2154)'],
    products = ['F[CH]OC(F)[CH]F(5103)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[CH]OC=CF(2144)'],
    products = ['F[CH]OC(F)[CH]F(5103)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'F[CH]OC(F)=CF(6081)'],
    products = ['F[CH]OC(F)[CH]F(5103)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', 'F[CH]O[CH]F(2154)'],
    products = ['F[CH]OC(F)[CH]F(5103)'],
