...
reaction(
    label = 'reaction21',
    reactants = ['O(6)', '[CH2][CH]F(839)'],
    products = ['[CH2]C([O])F(527)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O][CH]F(1657)', 'CH2(T)(18)'],
    products = ['[CH2]C([O])F(527)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[OH+]=[C-]F(1907)', 'CH2(S)(25)'],
    products = ['C=C(O)F(498)'],
