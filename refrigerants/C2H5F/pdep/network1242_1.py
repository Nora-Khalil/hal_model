...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'O=CCOF(1438)'],
    products = ['O=CCCOF(2838)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(160)', '[CH2]CC=O(231)'],
    products = ['O=CCCOF(2838)'],
