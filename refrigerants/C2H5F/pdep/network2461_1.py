...
"""),
    E0 = (113.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,326,540,652,719,1357,180,2150.16,2150.4,2150.44],'cm^-1')),
        HinderedRotor(inertia=(0.358203,'amu*angstrom^2'), symmetry=1, barrier=(8.23578,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15251,0.0664976,-0.000184047,2.13836e-07,-8.47952e-11,13641.1,16.1514], Tmin=(100,'K'), Tmax=(875.303,'K')), NASAPolynomial(coeffs=[-6.2243,0.0385473,-2.26492e-05,4.46267e-09,-3.04704e-13,17644.7,69.9421], Tmin=(875.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2sCF) + group(Cds-CdsCsCs) + group(CdCFO) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(oxirene)"""),
)

species(
    label = 'FC(F)=C1OO1(7160)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=C1O[C]1F(7162)'],
    products = ['O=C1OC1(F)F(7101)'],
    transitionState = 'TS8',
