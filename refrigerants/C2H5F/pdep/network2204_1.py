...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3442)', 'C=C[C]C(6174)'],
    products = ['C[C]=CC[C](F)F(6146)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C[C]=CC=C(F)F(6445)'],
    products = ['C[C]=CC[C](F)F(6146)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C=CC[C](F)F(6446)'],
    products = ['C[C]=CC[C](F)F(6146)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC#CC[C](F)F(6447)'],
    products = ['C[C]=CC[C](F)F(6146)'],
