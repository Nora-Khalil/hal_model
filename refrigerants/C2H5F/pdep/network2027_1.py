...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CO[C]=O(3621)'],
    products = ['[CH]=C(C)O[C]=O(6401)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(136)', '[CH]=C(C)[O](2352)'],
    products = ['[CH]=C(C)O[C]=O(6401)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'C#CO[C]=O(2442)'],
    products = ['[CH]=C(C)O[C]=O(6401)'],
    transitionState = 'TS8',
