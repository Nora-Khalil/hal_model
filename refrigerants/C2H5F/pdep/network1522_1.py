...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(=O)[C](F)F(4591)'],
    products = ['[CH2]C(F)(F)C(=C)[O](4434)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=C(4532)'],
    products = ['[CH2]C(F)(F)C(=C)[O](4434)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C(=C)[O](4434)'],
    products = ['[CH2]C(F)(F)[C]1CO1(4592)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(F)C(=C)[O](4434)'],
    products = ['[CH2]C1([O])CC1(F)F(4581)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C([O])C(=C)F(1183)'],
    products = ['[CH2]C(F)(F)C(=C)[O](4434)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(O)C([CH2])(F)F(4594)'],
    products = ['[CH2]C(F)(F)C(=C)[O](4434)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)=C([CH2])OF(4596)'],
    products = ['[CH2]C(F)(F)C(=C)[O](4434)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', '[CH2]C(F)(F)[C]=O(4598)'],
    products = ['[CH2]C(F)(F)C(=C)[O](4434)'],
...
network(
    label = 'PDepNetwork #1522',
    isomers = [
        '[CH2]C(F)(F)C(=C)[O](4434)',
    ],
    reactants = [
        ('CH2CF2(56)', 'CH2CO(28)'),
    ],
