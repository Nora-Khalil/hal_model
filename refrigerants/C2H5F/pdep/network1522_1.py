...
reaction(
    label = 'reaction2',
    reactants = ['O=C[C]F(1545)', '[C]=C(271)'],
    products = ['C=[C]OC=[C]F(5459)'],
    transitionState = 'TS2',
