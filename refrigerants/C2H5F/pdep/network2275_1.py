...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)O[C]=O(6404)'],
    products = ['[CH2]C1([CH2])OC1=O(6875)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(625)', 'C=C=C(6556)'],
    products = ['[CH2]C(=C)O[C]=O(6404)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C]=O(625)', '[CH2][C]=C(6610)'],
    products = ['[CH2]C(=C)O[C]=O(6404)'],
