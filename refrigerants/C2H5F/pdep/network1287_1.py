...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'O=C=CC(=O)F(5632)'],
    products = ['O=C(O)CC(=O)F(3794)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=[C]CC(=O)O(5640)'],
    products = ['O=C(O)CC(=O)F(3794)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[O]C(=O)CC(=O)F(3625)'],
    products = ['O=C(O)CC(=O)F(3794)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(6)', 'O=C(O)[CH]C(=O)F(3627)'],
    products = ['O=C(O)CC(=O)F(3794)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C=CC(=O)O(3633)'],
    products = ['O=C(O)CC(=O)F(3794)'],
