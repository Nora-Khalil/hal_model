...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(=C)[O](418)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', '[CH]C(C)=C=O(6294)'],
    products = ['[CH]=C(C)C(=C)[O](6098)'],
