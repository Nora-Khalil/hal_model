...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(271)', '[CH]C(=C)F(5373)'],
    products = ['[CH]=C(F)C[C]=C(6931)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', '[CH]=C(F)CC#C(7043)'],
    products = ['[CH]=C(F)C[C]=C(6931)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C[C]=C(7044)'],
    products = ['[CH]=C(F)C[C]=C(6931)'],
