...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C([O])F(4462)'],
    products = ['CHFO(47)', 'CH2CF2(56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)C[C](F)F(4463)'],
    products = ['[CH2]C(F)(F)C([O])F(4462)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C(F)[C](F)F(4615)'],
    products = ['[CH2]C(F)(F)C([O])F(4462)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[CH]F(4513)'],
    products = ['[CH2]C(F)(F)C([O])F(4462)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)C([O])F(2015)'],
    products = ['[CH2]C(F)(F)C([O])F(4462)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]F(1657)', 'CH2CF2(56)'],
    products = ['[CH2]C(F)(F)C([O])F(4462)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]C(F)(F)C=O(4408)'],
    products = ['[CH2]C(F)(F)C([O])F(4462)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CHFO(47)', '[CH2][C](F)F(4220)'],
    products = ['[CH2]C(F)(F)C([O])F(4462)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)(F)C(=O)F(4617)'],
    products = ['[CH2]C(F)(F)C([O])F(4462)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(1657)', '[CH2][C](F)F(4220)'],
    products = ['[CH2]C(F)(F)C([O])F(4462)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F2(77)', '[CH2]C(F)=C[O](2017)'],
    products = ['[CH2]C(F)(F)C([O])F(4462)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(F)(F)[CH]OF(4622)'],
    products = ['[CH2]C(F)(F)C([O])F(4462)'],
