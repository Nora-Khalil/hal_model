...
reaction(
    label = 'reaction3',
    reactants = ['C2H2(23)', '[CH]=[CH](135)'],
    products = ['[CH]=CC=[CH](417)'],
    transitionState = 'TS3',
