...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3442)', '[O]C[CH]F(973)'],
    products = ['F[CH]CO[C](F)F(7432)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', '[CH2]O[C](F)F(4535)'],
    products = ['F[CH]CO[C](F)F(7432)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC=CO[C](F)F(7178)'],
    products = ['F[CH]CO[C](F)F(7432)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CHF(40)', '[CH2]O[C](F)F(4535)'],
    products = ['F[CH]CO[C](F)F(7432)'],
