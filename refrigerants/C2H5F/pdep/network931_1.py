...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(2070)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])F(2033)'],
    transitionState = 'TS2',
