...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56958,0.054151,-7.3019e-05,5.2502e-08,-1.44788e-11,-33134.2,23.1749], Tmin=(100,'K'), Tmax=(1023.63,'K')), NASAPolynomial(coeffs=[9.6381,0.0150097,-4.50751e-06,6.17268e-10,-3.27249e-14,-34387.3,-13.9915], Tmin=(1023.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(CsFFHO) + ring(Ethylene_oxide) + radical(Cs_P) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2][C]1OC(F)(F)O1(7777)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32252,0.0377913,-2.85275e-05,1.0406e-08,-1.55378e-12,-43210.2,19.592], Tmin=(100,'K'), Tmax=(1515.14,'K')), NASAPolynomial(coeffs=[9.86862,0.0178697,-8.80518e-06,1.72825e-09,-1.21945e-13,-45496.9,-19.9491], Tmin=(1515.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-359.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CsFFOO) + ring(Cs-O2s-Cs(F)(F)-O2s) + radical(Cs_P) + radical(CJCO)"""),
)

species(
    label = '[CH2]C1([O])OC1(F)F(7778)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.60455,0.0327412,-1.92513e-05,4.80939e-09,-4.56855e-13,-41808.9,20.592], Tmin=(100,'K'), Tmax=(2437.5,'K')), NASAPolynomial(coeffs=[16.4705,0.00998726,-5.24913e-06,9.79807e-10,-6.40847e-14,-48568.6,-58.6575], Tmin=(2437.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-348.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCFFO) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH]=C(O)O[C](F)F(7779)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
2 F u0 p3 c0 {6,S}
3 O u0 p2 c0 {5,S} {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[C](F)F(7403)'],
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3442)', '[CH2]C([O])=O(157)'],
    products = ['[CH2]C(=O)O[C](F)F(7403)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[C](F)F(7403)'],
    products = ['[CH2][C]1OC(F)(F)O1(7777)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=O)O[C](F)F(7403)'],
    products = ['[CH2]C1([O])OC1(F)F(7778)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[CH2]C([O])=O(157)'],
    products = ['[CH2]C(=O)O[C](F)F(7403)'],
...
network(
    label = 'PDepNetwork #2725',
    isomers = [
        '[CH2]C(=O)O[C](F)F(7403)',
    ],
    reactants = [
        ('CF2O(49)', 'CH2CO(28)'),
    ],
