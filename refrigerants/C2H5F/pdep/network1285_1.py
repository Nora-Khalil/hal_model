...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'CC(=O)C([O])=O(3819)'],
    products = ['CC(=O)C(=O)OF(3901)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(357)', 'CC(=O)[C]=O(3967)'],
    products = ['CC(=O)C(=O)OF(3901)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'O=[C]C(=O)OF(3968)'],
    products = ['CC(=O)C(=O)OF(3901)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]OF(3602)', 'CH3CO(34)'],
    products = ['CC(=O)C(=O)OF(3901)'],
