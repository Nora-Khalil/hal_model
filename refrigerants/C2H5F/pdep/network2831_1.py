...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'OC(O)(F)F(8112)'],
    products = ['OC(F)(F)OCF(7502)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(O)(F)F(8164)'],
    products = ['OC(F)(F)OCF(7502)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O[C](F)F(4999)', '[O]CF(397)'],
    products = ['OC(F)(F)OCF(7502)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(O)(F)F(4240)', 'CH2F(46)'],
    products = ['OC(F)(F)OCF(7502)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)OCF(7904)'],
    products = ['OC(F)(F)OCF(7502)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'OC(F)(F)O[CH]F(8119)'],
    products = ['OC(F)(F)OCF(7502)'],
