...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C(=C)F(2580)'],
    products = ['[CH]=C(F)C[CH2](2548)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[CH]=C=C[CH2](662)'],
    products = ['[CH]=C(F)C[CH2](2548)'],
