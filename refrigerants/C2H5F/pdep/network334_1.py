...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C[O](132)', '[CH]C-2(137)'],
    products = ['[CH]=CO[CH]C(428)'],
    transitionState = 'TS2',
