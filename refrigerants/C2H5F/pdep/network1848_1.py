...
"""),
    E0 = (-47.9955,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2866.16],'cm^-1')),
        HinderedRotor(inertia=(0.553199,'amu*angstrom^2'), symmetry=1, barrier=(12.7191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57371,'amu*angstrom^2'), symmetry=1, barrier=(36.1826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57197,'amu*angstrom^2'), symmetry=1, barrier=(36.1427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57113,'amu*angstrom^2'), symmetry=1, barrier=(36.1235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189349,'amu*angstrom^2'), symmetry=1, barrier=(36.0536,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['C[C]F-2(838)', 'C[CH]O[O](158)'],
    products = ['C[CH]OO[C](C)F(5136)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C[C](F)O[O](920)', '[CH]C-2(137)'],
    products = ['C[CH]OO[C](C)F(5136)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['C[CH]OO[C](C)F(5136)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(228.649,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Ea raised from 228.4 to 228.6 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['C[CH]OO[C](C)F(5136)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(182.629,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(17.3051,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['C[C]F(124)', 'C[CH]O[O](158)'],
    products = ['C[CH]OO[C](C)F(5136)'],
