...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=[CH](135)', '[CH]=[C]C(4976)'],
    products = ['[CH]=CC(=[CH])C(6095)'],
    transitionState = 'TS8',
