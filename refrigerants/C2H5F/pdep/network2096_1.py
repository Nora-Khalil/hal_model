...
"""),
    E0 = (-63.0342,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,528,1116,1182,1331,1402,1494,3075,3110,2175,525,750,770,3400,2100,226.716,227.266],'cm^-1')),
        HinderedRotor(inertia=(0.604225,'amu*angstrom^2'), symmetry=1, barrier=(22.1359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334223,'amu*angstrom^2'), symmetry=1, barrier=(12.2629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.98106,'amu*angstrom^2'), symmetry=1, barrier=(72.6258,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40661,0.0527915,-4.20419e-05,1.83926e-08,-3.31956e-12,-7484.41,20.4127], Tmin=(100,'K'), Tmax=(1308.01,'K')), NASAPolynomial(coeffs=[10.8188,0.0240085,-9.03422e-06,1.56936e-09,-1.04153e-13,-9946.67,-27.5229], Tmin=(1308.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.0342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(CsCsFHH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (131.508,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,2175,525,750,770,3400,2100,186.959,3928.34],'cm^-1')),
        HinderedRotor(inertia=(0.841852,'amu*angstrom^2'), symmetry=1, barrier=(20.8932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.11053,'amu*angstrom^2'), symmetry=1, barrier=(52.2733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.77946,'amu*angstrom^2'), symmetry=1, barrier=(68.9141,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (129.159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,528,1116,1182,1331,1402,1494,3075,3110,3010,987.5,1337.5,450,1655,245.295,245.298,245.298],'cm^-1')),
        HinderedRotor(inertia=(0.291585,'amu*angstrom^2'), symmetry=1, barrier=(12.4505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291584,'amu*angstrom^2'), symmetry=1, barrier=(12.4504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291592,'amu*angstrom^2'), symmetry=1, barrier=(12.4505,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5399,0.0581179,-5.81186e-05,3.44611e-08,-8.82408e-12,15619.4,20.3016], Tmin=(100,'K'), Tmax=(917.28,'K')), NASAPolynomial(coeffs=[7.64462,0.0314951,-1.45804e-05,2.81605e-09,-1.98834e-13,14499.6,-8.62269], Tmin=(917.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#CCCCF(6845)'],
    products = ['CH2CHF(55)', 'C=C=C(6729)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.64576e+18,'s^-1'), n=-2.21337, Ea=(220.938,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0927421085454212, var=3.278681656229481, Tref=1000.0, N=7, data_mean=0.0, correlation='Root_1R!H->C_2R!H->C_N-5R!H->O',), comment="""Estimated from node Root_1R!H->C_2R!H->C_N-5R!H->O
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'C#CC[CH]CF(12985)'],
    products = ['C#CCCCF(6845)'],
    transitionState = 'TS8',
