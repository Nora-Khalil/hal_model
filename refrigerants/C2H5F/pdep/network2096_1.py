...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[O](495)'],
    products = ['O=O(150)', 'CH2CO(28)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])=O(157)'],
    products = ['[CH2]C(=O)O[O](495)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C]=O(151)', 'CH2(T)(18)'],
    products = ['[CH2]C(=O)O[O](495)'],
    transitionState = 'TS3',
