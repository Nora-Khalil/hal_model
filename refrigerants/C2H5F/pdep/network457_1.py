...
reaction(
    label = 'reaction2',
    reactants = ['O=C=C(O)OOF(1569)'],
    products = ['O=C(O)C(=O)OF(546)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'O=[C]C(=O)OF(1392)'],
    products = ['O=C(O)C(=O)OF(546)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(=O)C(=O)OF(1575)'],
    products = ['O=C(O)C(=O)OF(546)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(160)', 'O=[C]C(=O)O(1576)'],
    products = ['O=C(O)C(=O)OF(546)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]OF(331)', 'O=[C]O(146)'],
    products = ['O=C(O)C(=O)OF(546)'],
