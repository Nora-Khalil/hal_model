...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.78771,'amu*angstrom^2'), symmetry=1, barrier=(41.1029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78338,'amu*angstrom^2'), symmetry=1, barrier=(41.0033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78826,'amu*angstrom^2'), symmetry=1, barrier=(41.1156,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90251,0.0297671,1.48031e-05,-5.44008e-08,2.6125e-11,-62380.7,19.1226], Tmin=(100,'K'), Tmax=(950.742,'K')), NASAPolynomial(coeffs=[19.4232,-0.00307551,2.13586e-06,-3.02229e-10,9.89142e-15,-67559.4,-74.2343], Tmin=(950.742,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-519.415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(O2sFO) + group(Cds-OdOsOs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(4.92265e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7313,0.0558199,-0.000164079,2.12453e-07,-9.12391e-11,2532.06,18.6361], Tmin=(100,'K'), Tmax=(850.812,'K')), NASAPolynomial(coeffs=[-13.2092,0.0561194,-3.30094e-05,6.63677e-09,-4.63729e-13,7946.18,108.841], Tmin=(850.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.8977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2sFO) + group(Cs-OsOsOsH) + radical(OCOJ) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=C(O)OOF(6029)'],
    products = ['O=O(150)', 'HF(38)', 'CO2(14)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])OOF(6063)'],
    products = ['O=C(O)OOF(6029)'],
    transitionState = 'TS2',
