...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.023049,'amu*angstrom^2'), symmetry=1, barrier=(67.7759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.543993,'amu*angstrom^2'), symmetry=1, barrier=(12.5075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.95316,'amu*angstrom^2'), symmetry=1, barrier=(67.899,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79817,0.049398,-4.52894e-05,2.55051e-08,-6.17853e-12,14295.6,20.032], Tmin=(100,'K'), Tmax=(973.859,'K')), NASAPolynomial(coeffs=[7.23734,0.0270576,-1.08795e-05,1.9496e-09,-1.31647e-13,13236.2,-6.06482], Tmin=(973.859,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Csj(Cs-F1sCtH)(H)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.332872,'amu*angstrom^2'), symmetry=1, barrier=(7.65337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331661,'amu*angstrom^2'), symmetry=1, barrier=(7.62554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331562,'amu*angstrom^2'), symmetry=1, barrier=(7.62327,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55612,0.0598655,-8.0412e-05,7.29916e-08,-2.76356e-11,26903.5,21.2851], Tmin=(100,'K'), Tmax=(786.01,'K')), NASAPolynomial(coeffs=[3.9394,0.0374677,-1.8071e-05,3.49405e-09,-2.44204e-13,26846,12.379], Tmin=(786.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(F)=C[CH]C(6205)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51367,0.0466418,-2.01541e-05,-4.268e-09,4.09155e-12,3223.24,20.3731], Tmin=(100,'K'), Tmax=(1091.99,'K')), NASAPolynomial(coeffs=[11.5353,0.024607,-1.00445e-05,1.86689e-09,-1.30511e-13,159.58,-32.8637], Tmin=(1091.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.9988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCsCdF) + radical(Allyl_S) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)

species(
    label = 'C=[C][CH]C(C)F(6206)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[C]=C[CH]F(6194)'],
    products = ['[CH2]C(F)C=[C]C(6122)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(F)C=[C]C(6197)'],
    products = ['[CH2]C(F)C=[C]C(6122)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)C=C=C(6198)'],
    products = ['[CH2]C(F)C=[C]C(6122)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(F)C#CC(6199)'],
    products = ['[CH2]C(F)C=[C]C(6122)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2][CH]C#CC(6200)'],
    products = ['[CH2]C(F)C=[C]C(6122)'],
