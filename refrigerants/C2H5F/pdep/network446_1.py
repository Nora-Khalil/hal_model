...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C[CH]OC[O](390)'],
    products = ['C[CH]OC(C)[O](535)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C-2(137)', 'CC([O])[O](159)'],
    products = ['C[CH]OC(C)[O](535)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3CHO(36)', 'C[CH][O](174)'],
    products = ['C[CH]OC(C)[O](535)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', 'C[CH]OC=O(338)'],
    products = ['C[CH]OC(C)[O](535)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C[CH]OC(C)=O(1030)'],
    products = ['C[CH]OC(C)[O](535)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH][O](174)', 'C[CH][O](174)'],
    products = ['C[CH]OC(C)[O](535)'],
