...
reaction(
    label = 'reaction8',
    reactants = ['CHFO(47)', 'C#CO[CH2](683)'],
    products = ['C#COCC([O])F(1520)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['HCCO(21)', '[CH2]C([O])F(527)'],
    products = ['C#COCC([O])F(1520)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][CH]F(1657)', 'C#CO[CH2](683)'],
    products = ['C#COCC([O])F(1520)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#CO[CH]C([O])F(1658)'],
    products = ['C#COCC([O])F(1520)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C#COC[C]([O])F(1659)'],
    products = ['C#COCC([O])F(1520)'],
