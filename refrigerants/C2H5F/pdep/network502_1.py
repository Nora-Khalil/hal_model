...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', '[CH2]C[CH]F(848)'],
    products = ['F[CH]CC[CH]F(872)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[CH2]C[CH]F(848)'],
    products = ['F[CH]CC[CH]F(872)'],
    transitionState = 'TS9',
