...
"""),
    E0 = (-836.456,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,333,384,448,608,1254,1480,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,235,523,627,1123,1142,1372,1406,3097,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.774941,'amu*angstrom^2'), symmetry=1, barrier=(17.8174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.774953,'amu*angstrom^2'), symmetry=1, barrier=(17.8177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.77497,'amu*angstrom^2'), symmetry=1, barrier=(17.8181,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.138189,0.0913399,-0.000107379,6.74491e-08,-1.73681e-11,-100469,26.1386], Tmin=(100,'K'), Tmax=(932.867,'K')), NASAPolynomial(coeffs=[13.0924,0.0357919,-1.80575e-05,3.61336e-09,-2.60001e-13,-102885,-35.4572], Tmin=(932.867,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-836.456,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH)"""),
)
...
"""),
    E0 = (-636.554,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,316,385,515,654,689,1295,2750,2800,2850,1350,1500,750,1050,1375,1000,522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,241.038,241.039,241.041],'cm^-1')),
        HinderedRotor(inertia=(0.153747,'amu*angstrom^2'), symmetry=1, barrier=(6.33882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.538874,'amu*angstrom^2'), symmetry=1, barrier=(22.2175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.28045,'amu*angstrom^2'), symmetry=1, barrier=(11.5629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.538878,'amu*angstrom^2'), symmetry=1, barrier=(22.2175,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.292931,0.0866627,-0.000100929,6.11628e-08,-1.50365e-11,-76430.4,28.0751], Tmin=(100,'K'), Tmax=(979.245,'K')), NASAPolynomial(coeffs=[13.9091,0.0310429,-1.57301e-05,3.15882e-09,-2.27935e-13,-79097.1,-37.3293], Tmin=(979.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(F)(CC(F)F)OF(6595)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-635.914,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,333,384,448,608,1254,1480,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,213.133,217.841,222.284],'cm^-1')),
        HinderedRotor(inertia=(0.325458,'amu*angstrom^2'), symmetry=1, barrier=(10.6841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339212,'amu*angstrom^2'), symmetry=1, barrier=(10.6834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.820952,'amu*angstrom^2'), symmetry=1, barrier=(29.753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.456598,'amu*angstrom^2'), symmetry=1, barrier=(15.6316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (145.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0523572,0.0971187,-0.000141143,1.12844e-07,-3.67434e-11,-76344.3,28.1736], Tmin=(100,'K'), Tmax=(747.691,'K')), NASAPolynomial(coeffs=[11.3497,0.0361228,-1.87802e-05,3.74527e-09,-2.66664e-13,-78049.4,-23.5197], Tmin=(747.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-635.914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-480.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,171,205,598,1104,1143,1317,1411,3153,350,440,435,1725,3010,987.5,1337.5,450,1655,303.34,303.342],'cm^-1')),
        HinderedRotor(inertia=(0.00183199,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122683,'amu*angstrom^2'), symmetry=1, barrier=(8.01055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122673,'amu*angstrom^2'), symmetry=1, barrier=(8.01049,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00921,0.0718119,-9.22468e-05,7.04599e-08,-2.27097e-11,-57703.1,25.0074], Tmin=(100,'K'), Tmax=(746.156,'K')), NASAPolynomial(coeffs=[7.97643,0.0344657,-1.71768e-05,3.39381e-09,-2.41396e-13,-58742.9,-6.56595], Tmin=(746.156,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-480.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(CsCFFH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(CC(F)F)OF(6583)'],
    products = ['HF(38)', 'CH2CF2(56)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(40.8753,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['COF(400)', 'F[C]CC(F)F(2510)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C[C]F(124)', 'FOCC(F)F(4773)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.14358e+07,'m^3/(mol*s)'), n=-0.641018, Ea=(175.05,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17570294811609, var=29.477358162589667, Tref=1000.0, N=2, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FOC(F)CC(F)F(4842)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['CC(F)(CC(F)F)OF(6583)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(4.00811e-10,'m^3/(mol*s)'), n=4.72997, Ea=(133.049,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 6.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['HF(38)', 'CC(F)(C[C]F)OF(5443)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHF(40)', 'CC(F)(CF)OF(4862)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.96165e-06,'m^3/(mol*s)'), n=3.30609, Ea=(138.885,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s',), comment="""Estimated from node CY_2Br1sCl1sF1sHI1s->H_N-5Br1sCl1sF1sI1s->Br1s_5Cl1sF1s->F1s"""),
)

reaction(
    label = 'reaction9',
    reactants = ['OF(169)', 'CC(F)=CC(F)F(6592)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(169)', 'C=C(F)CC(F)F(3317)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C[C](CC(F)F)OF(5079)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC(F)(C[CH]F)OF(2940)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'CC([O])(F)CC(F)F(3325)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(160)', 'C[C](F)CC(F)F(6593)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF2-CH2(63)', 'C[C](F)OF(5141)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'FO[C](F)CC(F)F(4859)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHF2(81)', '[CH2]C(C)(F)OF(2912)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'CC(F)([CH]C(F)F)OF(6594)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(F)(CC(F)F)OF(6595)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'CC(F)(C[C](F)F)OF(6596)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(77)', 'CC(=O)CC(F)F(2501)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'CC(=CC(F)F)OF(6597)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(227.634,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'CC(F)(C=CF)OF(6598)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'C=C(CC(F)F)OF(4746)'],
    products = ['CC(F)(CC(F)F)OF(6583)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC(F)(CC(F)F)OF(6583)'],
    products = ['F2(77)', 'CH2CHF(55)', 'CC(=O)F(499)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(274.571,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)
