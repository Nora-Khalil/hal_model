...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C([O])F(527)'],
    products = ['[CH2]CC([O])F(1978)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(1657)', '[CH2][CH2](138)'],
    products = ['[CH2]CC([O])F(1978)'],
