...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C([O])=C=CF(2737)'],
    products = ['[CH2]C(=CF)C([O])=O(8428)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([C]=O)=CF(8989)'],
    products = ['[CH2]C(=CF)C([O])=O(8428)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction16',
    reactants = ['C=C([C]F)C(=O)O-2(9132)'],
    products = ['[CH2]C(=CF)C([O])=O(8428)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]F(837)', 'C=C=C([O])[O](738)'],
    products = ['[CH2]C(=CF)C([O])=O(8428)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHF(40)', 'C=C=C([O])[O](738)'],
    products = ['[CH2]C(=CF)C([O])=O(8428)'],
