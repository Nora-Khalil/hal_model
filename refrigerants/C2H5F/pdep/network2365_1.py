...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.850422,'amu*angstrom^2'), symmetry=1, barrier=(19.5529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.850504,'amu*angstrom^2'), symmetry=1, barrier=(19.5548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.85027,'amu*angstrom^2'), symmetry=1, barrier=(19.5494,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81417,0.0292896,5.15283e-05,-9.16894e-08,3.8332e-11,21825.3,16.422], Tmin=(100,'K'), Tmax=(946.607,'K')), NASAPolynomial(coeffs=[15.7958,0.0175501,-4.88724e-06,8.75236e-10,-6.76328e-14,17057.2,-61.4678], Tmin=(946.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19124,0.0264449,4.0876e-05,-6.7557e-08,2.66288e-11,53973.4,18.656], Tmin=(100,'K'), Tmax=(972.966,'K')), NASAPolynomial(coeffs=[10.3067,0.0260625,-9.38102e-06,1.71831e-09,-1.23162e-13,50833.1,-28.2964], Tmin=(972.966,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(448.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Allyl_T) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C1=C[C](C)C1(6990)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (80.1276,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16727,0.0209976,7.09526e-05,-1.07336e-07,4.27509e-11,43037.6,17.1684], Tmin=(100,'K'), Tmax=(949.178,'K')), NASAPolynomial(coeffs=[13.6984,0.0211853,-6.43513e-06,1.16393e-09,-8.77734e-14,38651.1,-49.4371], Tmin=(949.178,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Allyl_T) + radical(Allyl_P)"""),
)
...
"""),
    E0 = (339.57,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2100,2250,500,550,492.757],'cm^-1')),
        HinderedRotor(inertia=(0.098439,'amu*angstrom^2'), symmetry=1, barrier=(16.3954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.98252,'amu*angstrom^2'), symmetry=1, barrier=(81.4592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458816,'amu*angstrom^2'), symmetry=1, barrier=(81.4757,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76828,0.0405258,-3.1596e-06,-2.46495e-08,1.27102e-11,40928.9,19.4808], Tmin=(100,'K'), Tmax=(952.764,'K')), NASAPolynomial(coeffs=[10.9567,0.0226643,-7.65109e-06,1.31245e-09,-8.97227e-14,38237.8,-29.3374], Tmin=(952.764,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.57,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-CtHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([CH2])=CC=C(6993)',
    structure = adjacencyList("""multiplicity 3
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]C=[C]C(6249)'],
    products = ['[CH2]C(=C)C=[C]C(6505)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(=C)C=C=C(6991)'],
    products = ['[CH2]C(=C)C=[C]C(6505)'],
    transitionState = 'TS9',
