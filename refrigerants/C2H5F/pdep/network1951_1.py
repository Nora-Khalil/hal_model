...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC(F)[CH]F(5521)'],
    products = ['CHFCHF[Z](58)', 'C2H4(30)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction8',
    reactants = ['CHFCHF[Z](58)', '[CH2][CH2](138)'],
    products = ['[CH2]CC(F)[CH]F(5521)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]CC(F)=CF(5030)'],
    products = ['[CH2]CC(F)[CH]F(5521)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F[CH][CH]F(4261)', 'C2H4(30)'],
    products = ['[CH2]CC(F)[CH]F(5521)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=CC(F)[CH]F(5530)'],
    products = ['[CH2]CC(F)[CH]F(5521)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH][CH]F(4261)', '[CH2][CH2](138)'],
    products = ['[CH2]CC(F)[CH]F(5521)'],
