...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C([O])(F)F(1349)'],
    products = ['[CH2]OC([CH2])(F)F(4428)'],
    transitionState = 'TS2',
