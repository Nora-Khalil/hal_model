...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=C=C([O])[O](738)'],
    products = ['[CH2]C(=C)C([O])=O(6417)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(=C)[C]=O(6810)'],
    products = ['[CH2]C(=C)C([O])=O(6417)'],
    transitionState = 'TS4',
