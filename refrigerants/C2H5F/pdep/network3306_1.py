...
"""),
    E0 = (355.118,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,167,640,1190,318.65],'cm^-1')),
        HinderedRotor(inertia=(0.137974,'amu*angstrom^2'), symmetry=1, barrier=(9.8895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138268,'amu*angstrom^2'), symmetry=1, barrier=(9.8969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138072,'amu*angstrom^2'), symmetry=1, barrier=(9.89079,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17837,0.0622862,-5.52685e-05,2.67477e-08,-5.38553e-12,42812.2,25.4587], Tmin=(100,'K'), Tmax=(1168.13,'K')), NASAPolynomial(coeffs=[10.9019,0.02899,-1.25124e-05,2.34609e-09,-1.63117e-13,40540.6,-22.9625], Tmin=(1168.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_P) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (346.553,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,246,474,533,1155,3115,3125,620,680,785,800,1600,1700,180],'cm^-1')),
        HinderedRotor(inertia=(0.00263157,'amu*angstrom^2'), symmetry=1, barrier=(16.0711,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.698014,'amu*angstrom^2'), symmetry=1, barrier=(16.0487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.698323,'amu*angstrom^2'), symmetry=1, barrier=(16.0558,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07431,0.0648194,-6.01102e-05,3.02648e-08,-6.30001e-12,41785.7,25.2099], Tmin=(100,'K'), Tmax=(1137.18,'K')), NASAPolynomial(coeffs=[11.3346,0.0287287,-1.2504e-05,2.35547e-09,-1.64289e-13,39452.1,-25.6088], Tmin=(1137.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = '[CH]=[C]CC(C)=CF(9388)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  C u0 p0 c0 {4,S} {6,S} {8,S} {9,S}
3  C u0 p0 c0 {4,S} {10,S} {11,S} {12,S}
...
"""),
    E0 = (342.842,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,194,682,905,1196,1383,3221,1685,370,3120,650,792.5,1650,309.261],'cm^-1')),
        HinderedRotor(inertia=(0.138085,'amu*angstrom^2'), symmetry=1, barrier=(9.22348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136933,'amu*angstrom^2'), symmetry=1, barrier=(9.22085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136626,'amu*angstrom^2'), symmetry=1, barrier=(9.22303,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24377,0.0630149,-5.91844e-05,3.14448e-08,-7.0587e-12,41331.6,25.2125], Tmin=(100,'K'), Tmax=(1047.58,'K')), NASAPolynomial(coeffs=[9.52231,0.0314048,-1.39227e-05,2.6409e-09,-1.84782e-13,39597.1,-15.1115], Tmin=(1047.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(342.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[C]=CF(8475)'],
    products = ['[CH]=C(C)C[C]=CF(8574)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=CF(1334)', '[CH]C(=C)C(6159)'],
    products = ['[CH]=C(C)C[C]=CF(8574)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'C#CC[C]=CF(8762)'],
    products = ['[CH]=C(C)C[C]=CF(8574)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=C(C)CC#C(6952)'],
    products = ['[CH]=C(C)C[C]=CF(8574)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH]=C(C)CC#CF(8628)'],
    products = ['[CH]=C(C)C[C]=CF(8574)'],
