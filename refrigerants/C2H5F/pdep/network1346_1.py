...
reaction(
    label = 'reaction1',
    reactants = ['COOC=C(F)O[O](3464)'],
    products = ['CH2O(20)', '[O]OC(F)C=O(1780)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]OC(F)=COO(3484)'],
    products = ['COOC=C(F)O[O](3464)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'COO[CH]C(=O)F(3486)'],
    products = ['COOC=C(F)O[O](3464)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['COOC=C(F)O[O](3464)'],
    products = ['CH3O(27)', 'FC1=COOO1(3487)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'COOC=[C]O[O](3490)'],
    products = ['COOC=C(F)O[O](3464)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3O(27)', '[O]O[C](F)C=O(1865)'],
    products = ['COOC=C(F)O[O](3464)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[O]OC=C(F)O[O](3491)'],
    products = ['COOC=C(F)O[O](3464)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CO[O](356)', '[CH]=C(F)O[O](1331)'],
    products = ['COOC=C(F)O[O](3464)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]OOC=C(F)O[O](3493)'],
    products = ['COOC=C(F)O[O](3464)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'COO[C]=C(F)O[O](3494)'],
    products = ['COOC=C(F)O[O](3464)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'COOC#CO[O](3495)'],
    products = ['COOC=C(F)O[O](3464)'],
