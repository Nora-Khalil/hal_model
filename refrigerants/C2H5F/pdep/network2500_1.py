...
reaction(
    label = 'reaction2',
    reactants = ['HF(38)', 'C=C(F)[C]F(11709)'],
    products = ['C=C(F)C(F)F(3701)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)[CH]F(3704)'],
    products = ['C=C(F)C(F)F(3701)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(F)[C](F)F(4969)'],
    products = ['C=C(F)C(F)F(3701)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]=C(F)C(F)F(3451)'],
    products = ['C=C(F)C(F)F(3701)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(25)', 'F[C]C(F)F(4985)'],
    products = ['C=C(F)C(F)F(3701)'],
