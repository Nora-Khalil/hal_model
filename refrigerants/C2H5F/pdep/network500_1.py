...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C(F)[CH]F(890)'],
    products = ['[CH2]C(F)C([CH2])F(870)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]C(F)C=C(862)'],
    products = ['[CH2]C(F)C([CH2])F(870)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH2]C(F)C(=C)F(892)'],
    products = ['[CH2]C(F)C([CH2])F(870)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(77)', '[CH2]C=C[CH2](589)'],
    products = ['[CH2]C(F)C([CH2])F(870)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH2]C=C([CH2])F(893)'],
    products = ['[CH2]C(F)C([CH2])F(870)'],
