...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC=[C]CF(10185)'],
    products = ['[CH]=C(C)C=[C]CF(10237)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=C(C)C=C=C(6788)'],
    products = ['[CH]=C(C)C=[C]CF(10237)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(6)', '[CH]=C(C)C=C=CF(10253)'],
    products = ['[CH]=C(C)C=[C]CF(10237)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(19)', 'C#CC=[C]CF(10339)'],
    products = ['[CH]=C(C)C=[C]CF(10237)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', '[CH]=C(C)C#CCF(10607)'],
    products = ['[CH]=C(C)C=[C]CF(10237)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(C)C=[C]CF(10237)'],
    products = ['[CH]=C(C)C=C([CH2])F(10612)'],
