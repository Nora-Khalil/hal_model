...
reaction(
    label = 'reaction2',
    reactants = ['[O][C](F)C(=O)OF(3859)'],
    products = ['[O]C(=O)C([O])(F)F(7390)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(=O)[C](F)F(4630)'],
    products = ['[O]C(=O)C([O])(F)F(7390)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[O]C(F)(F)[C]=O(7161)'],
    products = ['[O]C(=O)C([O])(F)F(7390)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]C(=O)C(=O)F(2283)'],
    products = ['[O]C(=O)C([O])(F)F(7390)'],
    transitionState = 'TS9',
