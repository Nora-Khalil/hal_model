...
"""),
    E0 = (545.174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,2175,525,750,770,3400,2100,180,180,180,2878.79],'cm^-1')),
        HinderedRotor(inertia=(0.405969,'amu*angstrom^2'), symmetry=1, barrier=(9.33403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.70599,'amu*angstrom^2'), symmetry=1, barrier=(62.2161,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.0738,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09967,0.0505479,-9.113e-05,8.87817e-08,-3.20508e-11,65629.3,24.7081], Tmin=(100,'K'), Tmax=(890.504,'K')), NASAPolynomial(coeffs=[3.1283,0.0245457,-1.13147e-05,2.06569e-09,-1.36503e-13,66293.9,24.6249], Tmin=(890.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(545.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC=[C-][OH2+](6886)',
...
reaction(
    label = 'reaction2',
    reactants = ['C#C[OH+][C-]=C(6885)'],
    products = ['C#CC[C-]=[OH+](6639)'],
    transitionState = 'TS2',
