...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC[C]=C(6643)'],
    products = ['CH2O(20)', 'C=C=C(6556)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=[C]C[O](689)'],
    products = ['[CH2]OC[C]=C(6643)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', '[CH2]O[CH2](590)'],
    products = ['[CH2]OC[C]=C(6643)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(20)', '[CH2][C]=C(6610)'],
    products = ['[CH2]OC[C]=C(6643)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](131)', 'C=C=C(6556)'],
    products = ['[CH2]OC[C]=C(6643)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](131)', '[CH2][C]=C(6610)'],
    products = ['[CH2]OC[C]=C(6643)'],
