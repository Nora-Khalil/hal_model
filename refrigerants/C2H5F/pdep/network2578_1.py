...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(2933)', '[CH2]C1[CH]C1F(8376)'],
    products = ['F[C](F)CC1[CH]C1F(8566)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]C=CC[C](F)F(8690)'],
    products = ['F[C](F)CC1[CH]C1F(8566)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'F[C](F)CC1=CC1F(8691)'],
    products = ['F[C](F)CC1[CH]C1F(8566)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'F[C](F)CC1C=C1(8692)'],
    products = ['F[C](F)CC1[CH]C1F(8566)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'FC(F)=CC1[CH]C1F(8694)'],
    products = ['F[C](F)CC1[CH]C1F(8566)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', '[CH2]C1[CH]C1F(8376)'],
    products = ['F[C](F)CC1[CH]C1F(8566)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F[C](F)CC1[CH]C1F(8566)'],
    products = ['FC(F)[CH]C1[CH]C1F(8698)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F[C](F)CC1[CH]C1F(8566)'],
    products = ['FC(F)C[C]1[CH]C1F(8700)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[C](F)CC1[CH]C1F(8566)'],
    products = ['FC(F)(F)CC1[CH][CH]1(8702)'],
