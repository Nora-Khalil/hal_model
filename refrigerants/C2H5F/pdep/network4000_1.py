...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.976959,0.0574496,-4.57749e-05,1.83357e-08,-2.92112e-12,-37095.3,23.1696], Tmin=(100,'K'), Tmax=(1501.18,'K')), NASAPolynomial(coeffs=[15.3577,0.0191312,-7.48674e-06,1.3322e-09,-8.94343e-14,-41412.9,-52.0514], Tmin=(1501.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH)"""),
)
...
"""),
    E0 = (-58.7499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,319,1023,1071,1259,1317,1409,3054,3019,334,575,1197,1424,3202,2100,2250,500,550,259.306,261.124,1847.92],'cm^-1')),
        HinderedRotor(inertia=(1.39413,'amu*angstrom^2'), symmetry=1, barrier=(67.5234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221339,'amu*angstrom^2'), symmetry=1, barrier=(10.6262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41366,'amu*angstrom^2'), symmetry=1, barrier=(67.5225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.09,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45094,0.057792,-6.41458e-05,4.24358e-08,-1.16555e-11,-6975.77,24.1451], Tmin=(100,'K'), Tmax=(878.807,'K')), NASAPolynomial(coeffs=[8.32629,0.026498,-1.07315e-05,1.91552e-09,-1.285e-13,-8184.19,-8.13624], Tmin=(878.807,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.7499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsHH) + group(CsCsFHH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Csj(Cs-CtHH)(F1s)(H))"""),
)
...
"""),
    E0 = (14.6903,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,212,931,1104,1251,1325,1474,3102,3155,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,1685,370,297.789,297.804,297.804],'cm^-1')),
        HinderedRotor(inertia=(0.41322,'amu*angstrom^2'), symmetry=1, barrier=(26.0025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00327914,'amu*angstrom^2'), symmetry=1, barrier=(11.779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187187,'amu*angstrom^2'), symmetry=1, barrier=(11.779,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53146,0.0596009,-6.19324e-05,3.97209e-08,-1.12767e-11,1851.09,25.0983], Tmin=(100,'K'), Tmax=(823.782,'K')), NASAPolynomial(coeffs=[6.61491,0.0349179,-1.69887e-05,3.34978e-09,-2.39074e-13,1013.54,1.55895], Tmin=(823.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.6903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cs-CdHH)(F1s)(H)) + radical(Cds_S)"""),
)

species(
    label = 'FC[C]=[C]CCF(11161)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {4,S} {6,S} {8,S} {9,S}
...
"""),
    E0 = (59.1013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,122,584,932,1043,1247,1392,1461,2986,3039,1670,1700,300,440,323.636,323.668],'cm^-1')),
        HinderedRotor(inertia=(0.132688,'amu*angstrom^2'), symmetry=1, barrier=(9.86616,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132755,'amu*angstrom^2'), symmetry=1, barrier=(9.86651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234749,'amu*angstrom^2'), symmetry=1, barrier=(17.4465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6542,0.0569531,-5.43924e-05,3.16376e-08,-8.26715e-12,7188.15,25.3084], Tmin=(100,'K'), Tmax=(880.444,'K')), NASAPolynomial(coeffs=[6.47688,0.0350427,-1.70636e-05,3.37227e-09,-2.41206e-13,6338.94,2.65591], Tmin=(880.444,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.1013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = 'F[CH]C=C[CH]CF(11162)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27604,0.0543151,-3.82391e-05,1.30555e-08,-1.78903e-12,-17278.3,22.6258], Tmin=(100,'K'), Tmax=(1687.78,'K')), NASAPolynomial(coeffs=[14.7977,0.0222687,-9.75791e-06,1.80541e-09,-1.22618e-13,-21842.5,-49.686], Tmin=(1687.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', '[CH2]C=[C]CF(11147)'],
    products = ['F[CH]CC=[C]CF(11101)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'FC=CC=[C]CF(11157)'],
    products = ['F[CH]CC=[C]CF(11101)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH]CC#CCF(11158)'],
    products = ['F[CH]CC=[C]CF(11101)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C=[C]CF(11147)'],
    products = ['F[CH]CC=[C]CF(11101)'],
