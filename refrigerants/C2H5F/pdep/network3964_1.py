...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', '[O]C=[C]CF(11198)'],
    products = ['O=[C]OC=[C]CF(11089)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C=[C]CF(11198)'],
    products = ['O=[C]OC=[C]CF(11089)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C]OC#CCF(11242)'],
    products = ['O=[C]OC=[C]CF(11089)'],
