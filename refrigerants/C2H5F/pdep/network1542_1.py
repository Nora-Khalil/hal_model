...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[CH]F(4453)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(837)', '[CH2]C([CH2])(F)F(4485)'],
    products = ['[CH2]C(F)(F)C[CH]F(4453)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)C[CH]F(883)'],
    products = ['[CH2]C(F)(F)C[CH]F(4453)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)(F)C=CF(4502)'],
    products = ['[CH2]C(F)(F)C[CH]F(4453)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C([CH2])(F)F(4485)'],
    products = ['[CH2]C(F)(F)C[CH]F(4453)'],
