...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', 'O=C=C[C]F(5524)'],
    products = ['[O]C(=O)C=[C]F(5477)'],
    transitionState = 'TS2',
