...
reaction(
    label = 'reaction5',
    reactants = ['[CH]=CC(F)=C[CH2](8778)'],
    products = ['[CH]=CC1(F)[CH]C1(11671)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=CC1=CC1(11678)'],
    products = ['[CH]=CC1(F)[CH]C1(11671)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=CC1(F)C=C1(11679)'],
    products = ['[CH]=CC1(F)[CH]C1(11671)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#CC1(F)[CH]C1(11680)'],
    products = ['[CH]=CC1(F)[CH]C1(11671)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH]=C=C1[CH]C1(11681)'],
    products = ['[CH]=CC1(F)[CH]C1(11671)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=CC1(F)[CH]C1(11671)'],
    products = ['C=CC1(F)[CH][CH]1(11684)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=CC1(F)[CH]C1(11671)'],
    products = ['F[CH]C=C1[CH]C1(11561)'],
