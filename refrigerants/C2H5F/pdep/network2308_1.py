...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])=C(6172)'],
    products = ['C2H4(30)', 'C=C=C(6556)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C([CH2])=C(6712)'],
    products = ['[CH2]CC([CH2])=C(6172)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C[C]=C(587)'],
    products = ['[CH2]CC([CH2])=C(6172)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H4(30)', '[CH2][C]=C(6610)'],
    products = ['[CH2]CC([CH2])=C(6172)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(=C)C=C(6736)'],
    products = ['[CH2]CC([CH2])=C(6172)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH2](138)', 'C=C=C(6556)'],
    products = ['[CH2]CC([CH2])=C(6172)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH2](138)', '[CH2][C]=C(6610)'],
    products = ['[CH2]CC([CH2])=C(6172)'],
