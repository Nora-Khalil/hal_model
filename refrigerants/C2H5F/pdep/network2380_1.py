...
"""),
    E0 = (-567.324,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,323,467,575,827,1418,2950,3100,1380,975,1025,1650,180,180,180,180,909.01,909.258],'cm^-1')),
        HinderedRotor(inertia=(0.0503809,'amu*angstrom^2'), symmetry=1, barrier=(29.5757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0504299,'amu*angstrom^2'), symmetry=1, barrier=(29.585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00409118,'amu*angstrom^2'), symmetry=1, barrier=(2.40155,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-174.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([280,518,736,852,873,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2120,512.5,787.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.711425,'amu*angstrom^2'), symmetry=1, barrier=(16.357,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-215.357,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,212,367,445,1450,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8802,0.0408091,-1.08835e-05,-1.72185e-08,1.12246e-11,-25819.6,21.5762], Tmin=(100,'K'), Tmax=(883.776,'K')), NASAPolynomial(coeffs=[10.0064,0.0210128,-6.10889e-06,9.2353e-10,-5.80833e-14,-27919.2,-20.3762], Tmin=(883.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Tetrahydrofuran) + radical(CsCsCsF1s) + radical(Cs_P)"""),
)

species(
    label = 'C=C(F)CC([O])[O](7072)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u1 p2 c0 {5,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (-133.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,323,467,575,827,1418,2950,3100,1380,975,1025,1650,180,180,1990.76,1990.9],'cm^-1')),
        HinderedRotor(inertia=(0.138041,'amu*angstrom^2'), symmetry=1, barrier=(3.17384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1389,'amu*angstrom^2'), symmetry=1, barrier=(3.1936,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55334,0.0628569,-9.88185e-05,9.86554e-08,-3.88541e-11,-15997.3,25.8441], Tmin=(100,'K'), Tmax=(807.83,'K')), NASAPolynomial(coeffs=[2.16348,0.0402563,-2.04974e-05,4.0177e-09,-2.81467e-13,-15457,26.985], Tmin=(807.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-242.457,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,271,519,563,612,1379,2950,3100,1380,975,1025,1650,383.635,383.769,2192.81],'cm^-1')),
        HinderedRotor(inertia=(0.0672006,'amu*angstrom^2'), symmetry=1, barrier=(7.02419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.344804,'amu*angstrom^2'), symmetry=1, barrier=(35.9855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.344522,'amu*angstrom^2'), symmetry=1, barrier=(35.9871,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24917,0.0659524,-7.98621e-05,5.57555e-08,-1.63706e-11,-29066.6,23.9897], Tmin=(100,'K'), Tmax=(815.878,'K')), NASAPolynomial(coeffs=[8.40605,0.0308634,-1.53489e-05,3.03927e-09,-2.16916e-13,-30234.4,-9.08158], Tmin=(815.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-242.457,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CCJCO)"""),
)

species(
    label = '[CH]=C(F)CC([O])O(7075)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-101.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,246,474,533,1155,3120,650,792.5,1650,293.706,1611.91,1612.89],'cm^-1')),
        HinderedRotor(inertia=(0.117631,'amu*angstrom^2'), symmetry=1, barrier=(7.28647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116106,'amu*angstrom^2'), symmetry=1, barrier=(7.31779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115545,'amu*angstrom^2'), symmetry=1, barrier=(7.30941,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90415,0.0559794,-3.58084e-05,-5.1387e-08,7.33384e-11,-12095.9,25.2141], Tmin=(100,'K'), Tmax=(468.391,'K')), NASAPolynomial(coeffs=[6.93642,0.0313058,-1.54021e-05,2.98821e-09,-2.08695e-13,-12768.1,2.60995], Tmin=(468.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = '[CH2]C(F)CC([O])=O(7076)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u1 p2 c0 {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-121.572,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,2750,2850,1437.5,1250,1305,750,350,360,370,350,246,474,533,1155,3120,650,792.5,1650,303.512,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00300594,'amu*angstrom^2'), symmetry=1, barrier=(9.4235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339767,'amu*angstrom^2'), symmetry=1, barrier=(22.2103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339774,'amu*angstrom^2'), symmetry=1, barrier=(22.2103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144162,'amu*angstrom^2'), symmetry=1, barrier=(9.42345,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02364,0.0690413,-8.89049e-05,6.11296e-08,-1.68801e-11,-14517.7,27.351], Tmin=(100,'K'), Tmax=(882.366,'K')), NASAPolynomial(coeffs=[11.1693,0.0230497,-1.07223e-05,2.06076e-09,-1.4459e-13,-16308.1,-20.3263], Tmin=(882.366,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cdj(Cd-CsF1s)(H))"""),
)

species(
    label = 'C[C](F)CC([O])=O(7078)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u1 p2 c0 {7,S}
3  O u0 p2 c0 {7,D}
...
"""),
    E0 = (-288.895,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.36597,0.034904,-1.48426e-05,1.64871e-09,4.1716e-14,-34803.8,13.4563], Tmin=(100,'K'), Tmax=(2758.42,'K')), NASAPolynomial(coeffs=[48.6623,-0.0129035,2.22183e-06,-3.16589e-10,2.41678e-14,-65490.8,-256.521], Tmin=(2758.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CsCsCsF1s)"""),
)

species(
    label = 'C=C(F)C=C(O)O(7079)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {6,S} {12,S}
...
"""),
    E0 = (-467.099,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,3010,987.5,1337.5,450,1655,280,518,736,852,873,350,440,435,1725,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.933967,'amu*angstrom^2'), symmetry=1, barrier=(21.4738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.938202,'amu*angstrom^2'), symmetry=1, barrier=(21.5711,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.939036,'amu*angstrom^2'), symmetry=1, barrier=(21.5903,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.210339,0.0776295,-8.79942e-05,4.64722e-08,-9.1401e-12,-56014.6,23.3252], Tmin=(100,'K'), Tmax=(1400.08,'K')), NASAPolynomial(coeffs=[22.3296,0.00420141,3.50675e-07,-2.01935e-10,1.68364e-14,-61441,-89.8413], Tmin=(1400.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-467.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-237.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,249,734,1109,1255,1358,2983,3011,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70528,0.0559254,-5.42233e-05,3.38564e-08,-9.80225e-12,-28527.2,33.0279], Tmin=(100,'K'), Tmax=(791.745,'K')), NASAPolynomial(coeffs=[5.455,0.0369817,-1.8334e-05,3.6373e-09,-2.6049e-13,-29121,15.8132], Tmin=(791.745,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(CsCFHH) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)CC(=O)O(7085)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {6,S} {12,S}
3  O u0 p2 c0 {6,D}
4  C u0 p0 c0 {5,S} {6,S} {8,S} {9,S}
...
"""),
    E0 = (-240.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,353,444,1253,3145,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25294,0.0675393,-0.000100311,9.25717e-08,-3.50831e-11,-28855.8,23.2933], Tmin=(100,'K'), Tmax=(767.876,'K')), NASAPolynomial(coeffs=[5.15837,0.0365165,-1.88502e-05,3.73681e-09,-2.64477e-13,-29140.7,7.53332], Tmin=(767.876,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-240.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(CsCCFH) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H2O(3)', 'C=C(F)C=C=O(2660)'],
    products = ['C=C(F)CC(=O)O(3222)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)[CH]C(=O)O(7073)'],
    products = ['C=C(F)CC(=O)O(3222)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'C=[C]CC(=O)O(7080)'],
    products = ['C=C(F)CC(=O)O(3222)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'C=C(F)C[C]=O(1144)'],
    products = ['C=C(F)CC(=O)O(3222)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C=C(F)CC([O])=O(7081)'],
    products = ['C=C(F)CC(=O)O(3222)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]O(146)', '[CH2]C(=C)F(2402)'],
    products = ['C=C(F)CC(=O)O(3222)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'C=C(F)[CH]C(=O)O(7082)'],
    products = ['C=C(F)CC(=O)O(3222)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[CH]=C(F)CC(=O)O(7083)'],
    products = ['C=C(F)CC(=O)O(3222)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C(F)CC(=O)O(3222)'],
    products = ['C2HF(57)', 'C=C(O)O(3279)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(7.56726e+11,'s^-1'), n=0.169307, Ea=(387.356,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R!H->C_2R!H->C_5R!H->O_Ext-2C-R_N-7R!H->C',), comment="""Estimated from node Root_1R!H->C_2R!H->C_5R!H->O_Ext-2C-R_N-7R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction24',
    reactants = ['O=C(O)C[C]CF(7084)'],
    products = ['C=C(F)CC(=O)O(3222)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(1.91033e+10,'s^-1'), n=0.827, Ea=(89.7138,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CCY',), comment="""Estimated from node CCY"""),
)

reaction(
    label = 'reaction25',
    reactants = ['[CH]C(F)CC(=O)O(7085)'],
    products = ['C=C(F)CC(=O)O(3222)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(1.20443e+17,'s^-1'), n=-1.43042, Ea=(13.1871,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH"""),
)

reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'C=C=CC(=O)O(6085)'],
    products = ['C=C(F)CC(=O)O(3222)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(185.549,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'C#CCC(=O)O(1698)'],
    products = ['C=C(F)CC(=O)O(3222)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(1.56721e+32,'m^3/(mol*s)'), n=-7.40875, Ea=(310.301,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_3COCdCddCtO2d->Ct',), comment="""Estimated from node HF_3COCdCddCtO2d->Ct"""),
)

reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(25)', 'O=C(O)C[C]F(3383)'],
    products = ['C=C(F)CC(=O)O(3222)'],
