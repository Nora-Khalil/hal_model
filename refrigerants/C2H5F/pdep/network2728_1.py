...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C=C=O(4239)'],
    products = ['[O]C(F)(F)C[C]=O(4245)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'O=[C]CC(=O)F(1452)'],
    products = ['[O]C(F)(F)C[C]=O(4245)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'O=[C][CH]C(=O)F(7733)'],
    products = ['[O]C(F)(F)C[C]=O(4245)'],
