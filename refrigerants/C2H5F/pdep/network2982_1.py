...
"""),
    ...
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36909,0.0461139,-1.51683e-05,-2.30874e-08,1.48416e-11,39879.1,16.9825], Tmin=(100,'K'), Tmax=(944.006,'K')), NASAPolynomial(coeffs=[17.0855,0.00867613,-2.01028e-06,3.3863e-10,-2.71106e-14,35612.7,-64.8156], Tmin=(944.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Ct-CtOs) + group(Ct-CtH) + ring(Cyclopropane) + radical(C2CsJOCs)"""),
)

species(
    label = 'C=C1CC=[C]O1(8347)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.06161,0.00107247,9.6273e-05,-1.26106e-07,4.84911e-11,28372.3,20.2261], Tmin=(100,'K'), Tmax=(942.35,'K')), NASAPolynomial(coeffs=[11.8627,0.013675,-3.31321e-06,6.06825e-10,-5.07186e-14,24495.3,-33.4819], Tmin=(942.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1CC(=C)O1(8263)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {3,S} {4,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {1,S} {2,S} {5,D}
...
"""),
    E0 = (633.409,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2175,525,205.382,208.206,1852.83],'cm^-1')),
        HinderedRotor(inertia=(3.83138,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.525878,'amu*angstrom^2'), symmetry=1, barrier=(15.5403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.98641,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0845,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44474,0.0572598,-7.44543e-05,5.16949e-08,-1.41888e-11,76272.5,20.4129], Tmin=(100,'K'), Tmax=(895.598,'K')), NASAPolynomial(coeffs=[10.5231,0.0167107,-6.53618e-06,1.13494e-09,-7.45214e-14,74646.5,-22.3836], Tmin=(895.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(633.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(C=C(O)CJ) + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C#COC([CH2])=C(6785)'],
    products = ['C#CCC(=C)[O](6797)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.87873e+12,'s^-1'), n=0.324012, Ea=(108.95,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C#CO[C]=C(707)'],
...
reaction(
    label = 'reaction7',
    reactants = ['C#COC([CH2])=C(6785)'],
    products = ['[CH]=C1CC(=C)O1(8263)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.92319e+06,'s^-1'), n=1.55572, Ea=(65.0129,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_SS_T;triplebond_intra_H;radadd_intra_cs2H]
...
reaction(
    label = 'reaction8',
    reactants = ['HCCO(21)', 'C=C=C(6556)'],
    products = ['C#COC([CH2])=C(6785)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.0603e-20,'m^3/(mol*s)'), n=7.37188, Ea=(1.68091,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.4161614592809219, var=2.5944177025948685, Tref=1000.0, N=250, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_N-Sp-2R!H#1R!H_Sp-4R!H-3R_Ext-1R!H-R_N-6R!H-inRing',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_N-Sp-2R!H#1R!H_Sp-4R!H-3R_Ext-1R!H-R_N-6R!H-inRing"""),
)

reaction(
    label = 'reaction9',
    reactants = ['HCCO(21)', '[CH2][C]=C(6610)'],
    products = ['C#COC([CH2])=C(6785)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H(22)', '[CH2]C(=C)[O](609)'],
    products = ['C#COC([CH2])=C(6785)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[C]#COC([CH2])=C(8348)'],
    products = ['C#COC([CH2])=C(6785)'],
