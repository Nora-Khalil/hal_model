...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'O=CO[CH]OF(1259)'],
    products = ['O=COC(F)OF(2830)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[O]C(F)OC=O(3072)'],
    products = ['O=COC(F)OF(2830)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F[CH]OF(1980)', '[O]C=O(147)'],
    products = ['O=COC(F)OF(2830)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HCO(15)', '[O]C(F)OF(2929)'],
    products = ['O=COC(F)OF(2830)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(160)', 'O=CO[CH]F(2085)'],
    products = ['O=COC(F)OF(2830)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=CO[C](F)OF(3073)'],
    products = ['O=COC(F)OF(2830)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'O=[C]OC(F)OF(3074)'],
    products = ['O=COC(F)OF(2830)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'O=COC(=O)F(2271)'],
    products = ['O=COC(F)OF(2830)'],
