...
reaction(
    label = 'reaction1',
    reactants = ['C2H2(23)', 'C2H3(29)'],
    products = ['[CH]=CC=C(422)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=CC=C(422)'],
    products = ['[CH]1C=CC1(6625)'],
    transitionState = 'TS3',
