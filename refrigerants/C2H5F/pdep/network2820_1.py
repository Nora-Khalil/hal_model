...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(F)(F)C([O])(F)F(7491)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)(F)[C](F)F(7878)'],
    products = ['[O]C(F)(F)C([O])(F)F(7491)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[O]C(F)(F)C(=O)F(7795)'],
    products = ['[O]C(F)(F)C([O])(F)F(7491)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F2(77)', '[O][C](F)C(=O)F(7796)'],
    products = ['[O]C(F)(F)C([O])(F)F(7491)'],
    transitionState = 'TS7',
