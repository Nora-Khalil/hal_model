...
"""),
    E0 = (-538.959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([286,334,437,422,648,895,1187,215,315,519,588,595,1205,1248,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,274.97],'cm^-1')),
        HinderedRotor(inertia=(0.156867,'amu*angstrom^2'), symmetry=1, barrier=(8.41644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156868,'amu*angstrom^2'), symmetry=1, barrier=(8.41646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156866,'amu*angstrom^2'), symmetry=1, barrier=(8.41644,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.422238,0.0846232,-0.00011593,8.57114e-08,-2.56078e-11,-64698.3,26.1144], Tmin=(100,'K'), Tmax=(815.23,'K')), NASAPolynomial(coeffs=[11.6414,0.0295729,-1.46352e-05,2.87271e-09,-2.03294e-13,-66527.5,-25.7194], Tmin=(815.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-538.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)
...
"""),
    E0 = (-536.471,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([286,334,437,422,648,895,1187,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.200798,'amu*angstrom^2'), symmetry=1, barrier=(4.61675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199714,'amu*angstrom^2'), symmetry=1, barrier=(4.59181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200152,'amu*angstrom^2'), symmetry=1, barrier=(4.60189,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.529417,0.0839051,-0.000129077,1.12794e-07,-3.96375e-11,-64404.9,27.043], Tmin=(100,'K'), Tmax=(791.335,'K')), NASAPolynomial(coeffs=[8.38928,0.0345835,-1.74046e-05,3.39706e-09,-2.37663e-13,-65348.5,-7.13923], Tmin=(791.335,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-536.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFFH) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    E0 = (-498.778,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([316,385,515,654,689,1295,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.333214,'amu*angstrom^2'), symmetry=1, barrier=(7.66125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331663,'amu*angstrom^2'), symmetry=1, barrier=(7.62559,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.905354,0.0788405,-0.000145627,1.37908e-07,-4.95505e-11,-59888.1,21.4637], Tmin=(100,'K'), Tmax=(844.169,'K')), NASAPolynomial(coeffs=[6.95172,0.0276644,-1.46661e-05,2.87427e-09,-1.99019e-13,-60106.3,-1.92829], Tmin=(844.169,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-F1sO2sCs)(F1s)(F1s))"""),
)

species(
    label = 'CC1(F)OCC1(F)F(5180)',
...
species(
    label = '[CH2]C(O)(F)C([CH2])(F)F(5406)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.318728,'amu*angstrom^2'), symmetry=1, barrier=(7.32819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.317344,'amu*angstrom^2'), symmetry=1, barrier=(7.29637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589532,'amu*angstrom^2'), symmetry=1, barrier=(13.5545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.56392,'amu*angstrom^2'), symmetry=1, barrier=(35.9575,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0638708,0.095443,-0.000139604,1.00109e-07,-2.52215e-11,-67466.6,26.5325], Tmin=(100,'K'), Tmax=(637.37,'K')), NASAPolynomial(coeffs=[12.853,0.0287681,-1.46671e-05,2.87556e-09,-2.01831e-13,-69372.9,-31.5726], Tmin=(637.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-562.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sCs)(H)(H)) + radical(Csj(Cs-CsF1sF1s)(H)(H))"""),
)

species(
    label = '[CH2]C([O])(F)C(C)(F)F(5407)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.302158,'amu*angstrom^2'), symmetry=1, barrier=(6.9472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301332,'amu*angstrom^2'), symmetry=1, barrier=(6.92822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301672,'amu*angstrom^2'), symmetry=1, barrier=(6.93604,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.125424,0.0939713,-0.000152901,1.34112e-07,-4.62845e-11,-64836.8,25.7794], Tmin=(100,'K'), Tmax=(818.658,'K')), NASAPolynomial(coeffs=[9.86619,0.0330044,-1.66905e-05,3.23636e-09,-2.24488e-13,-65983.6,-16.5282], Tmin=(818.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-540.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)
...
"""),
    E0 = (-522.975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,528,1116,1182,1331,1402,1494,3075,3110,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,234.904,234.904,234.904],'cm^-1')),
        HinderedRotor(inertia=(0.228485,'amu*angstrom^2'), symmetry=1, barrier=(8.94671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.228484,'amu*angstrom^2'), symmetry=1, barrier=(8.94671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.451052,'amu*angstrom^2'), symmetry=1, barrier=(17.6617,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C(C)([O])F(5176)'],
    products = ['CH2CF2(56)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]C(F)(F)C([O])F(4462)'],
    products = ['[CH2]C(F)(F)C(C)([O])F(5176)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[C](C)F(4516)'],
    products = ['[CH2]C(F)(F)C(C)([O])F(5176)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'CC([O])(F)[C](F)F(5405)'],
    products = ['[CH2]C(F)(F)C(C)([O])F(5176)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['F2(77)', '[CH2]C(F)=C(C)[O](1192)'],
    products = ['[CH2]C(F)(F)C(C)([O])F(5176)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(21.4071,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)(F)C(=C)[O](4434)'],
    products = ['[CH2]C(F)(F)C(C)([O])F(5176)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(251.457,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(O)(F)C([CH2])(F)F(5406)'],
    products = ['[CH2]C(F)(F)C(C)([O])F(5176)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([O])(F)C(C)(F)F(5407)'],
    products = ['[CH2]C(F)(F)C(C)([O])F(5176)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(79.6933,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction18',
    reactants = ['C[C]([O])C(F)(F)CF(5408)'],
    products = ['[CH2]C(F)(F)C(C)([O])F(5176)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(219.558,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction19',
    reactants = ['[CH2][C](F)C(C)(F)OF(5409)'],
    products = ['[CH2]C(F)(F)C(C)([O])F(5176)'],
...
network(
    ...
    isomers = [
        '[CH2]C(F)(F)C(C)([O])F(5176)',
    ],
    reactants = [
        ('CH2CF2(56)', 'CC(=O)F(499)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
