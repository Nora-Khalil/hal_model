...
"""),
    E0 = (264.572,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,2782.5,750,1395,475,1775,1000,224.595,224.798,2178.28],'cm^-1')),
        HinderedRotor(inertia=(0.188239,'amu*angstrom^2'), symmetry=1, barrier=(6.73409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.868228,'amu*angstrom^2'), symmetry=1, barrier=(31.0052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.864752,'amu*angstrom^2'), symmetry=1, barrier=(31.0046,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22585,0.0712245,-0.000137513,1.32006e-07,-4.79435e-11,31910.7,21.7117], Tmin=(100,'K'), Tmax=(835.86,'K')), NASAPolynomial(coeffs=[6.81274,0.0232841,-1.34282e-05,2.6887e-09,-1.87967e-13,31717.5,0.19093], Tmin=(835.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2sCF) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'FOC1=CO[CH]O1(7558)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (105.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24688,0.0359683,3.6338e-05,-1.00417e-07,4.89849e-11,-11200.7,17.2772], Tmin=(100,'K'), Tmax=(908.314,'K')), NASAPolynomial(coeffs=[27.2254,-0.0132207,9.87349e-06,-1.94872e-09,1.27148e-13,-18610.2,-120.365], Tmin=(908.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.1436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-OsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopentane) + radical(OCJO)"""),
)

species(
    label = '[O]C1C=C(OF)O1(7559)',
    structure = adjacencyList("""multiplicity 2
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {5,S} {7,S}
...
"""),
    ...
    molecularWeight = (105.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95298,0.0476327,-4.8141e-05,2.48015e-08,-5.23626e-12,2990.71,17.9282], Tmin=(100,'K'), Tmax=(1119.91,'K')), NASAPolynomial(coeffs=[9.9625,0.0190251,-9.82428e-06,1.99217e-09,-1.44496e-13,1196.71,-21.6202], Tmin=(1119.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.2714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + ring(Cyclobutene) + radical(CCOJ)"""),
)
...
"""),
    E0 = (150.015,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,3120,650,792.5,1650,1855,455,950,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.309586,'amu*angstrom^2'), symmetry=1, barrier=(7.118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.82298,'amu*angstrom^2'), symmetry=1, barrier=(41.9139,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.972213,0.0761781,-0.00014498,1.33576e-07,-4.64282e-11,18142.4,21.2768], Tmin=(100,'K'), Tmax=(855.831,'K')), NASAPolynomial(coeffs=[8.87733,0.0194563,-1.09055e-05,2.13793e-09,-1.46843e-13,17513.6,-11.3991], Tmin=(855.831,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.015,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2sCF) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(OF)OC=O(3940)'],
    products = ['HF(38)', 'CO2(14)', 'HCCO(21)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(6.00008,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[CH]=C(O)OF(7556)'],
    products = ['[CH]=C(OF)OC=O(3940)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(6)', '[C]=C(OF)OC=O(7557)'],
    products = ['[CH]=C(OF)OC=O(3940)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=C(OF)OC=O(3940)'],
    products = ['[O]C1C=C(OF)O1(7559)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(5.41e+10,'s^-1'), n=0.21, Ea=(70.7052,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_DS;multiplebond_intra;radadd_intra_cdsingleH] for rate rule [R5_DS_CO;carbonylbond_intra_H;radadd_intra_cdsingleH]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 68.6 to 70.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[O]C=O(142)', 'C#COF(2548)'],
    products = ['[CH]=C(OF)OC=O(3940)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(12.9594,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['[O]F(357)', 'C#COC=O(2297)'],
    products = ['[CH]=C(OF)OC=O(3940)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(8.20421e+10,'m^3/(mol*s)'), n=-1.2407, Ea=(55.7678,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.08524545916686703, var=37.982834433071, Tref=1000.0, N=20, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_4R!H-u0',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_4R!H-u0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]C(=O)OC=O(3752)'],
    products = ['[CH]=C(OF)OC=O(3940)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.21e+07,'m^3/(mol*s)'), n=-8.5357e-08, Ea=(58.1581,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_3BrCClFINPSSi->C_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_3BrCClFINPSSi->C_2R->C"""),
)

reaction(
    label = 'reaction10',
    reactants = ['[O]C=O(142)', '[CH]=[C]OF(5901)'],
    products = ['[CH]=C(OF)OC=O(3940)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HCO(15)', '[CH]C(=O)OF(7560)'],
    products = ['[CH]=C(OF)OC=O(3940)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(357)', '[CH]=[C]OC=O(2301)'],
    products = ['[CH]=C(OF)OC=O(3940)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[CH]=C(OF)O[C]=O(7561)'],
    products = ['[CH]=C(OF)OC=O(3940)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(OF)OC=O(3940)'],
    products = ['O=COC(=O)[CH]F(3882)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(54.8959,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
