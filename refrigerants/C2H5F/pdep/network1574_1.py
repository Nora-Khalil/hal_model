...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[C](F)F(4520)', '[CH]C-2(137)'],
    products = ['C[CH]OC[C](F)F(4683)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3442)', '[CH2]O[CH]C(591)'],
    products = ['C[CH]OC[C](F)F(4683)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C[CH]OC=C(F)F(4689)'],
    products = ['C[CH]OC[C](F)F(4683)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=COC[C](F)F(4690)'],
    products = ['C[CH]OC[C](F)F(4683)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH2]O[CH]C(591)'],
    products = ['C[CH]OC[C](F)F(4683)'],
