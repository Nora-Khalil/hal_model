...
species(
    label = 'O=C(O)C1(F)[CH][CH]1(11624)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {7,S} {10,S}
3  O u0 p2 c0 {7,D}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(=O)C1(F)[CH]C1(11536)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(OF)[C]1[CH]C1(11617)'],
    products = ['[O]C(=O)C1(F)[CH]C1(11536)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', 'O=[C]C1(F)[CH]C1(11619)'],
    products = ['[O]C(=O)C1(F)[CH]C1(11536)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)C1(F)[CH]C1(11536)'],
    products = ['FC1([C]2OO2)[CH]C1(11620)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C(=O)C1=CC1(11622)'],
    products = ['[O]C(=O)C1(F)[CH]C1(11536)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[O]C(=O)C1(F)C=C1(11623)'],
    products = ['[O]C(=O)C1(F)[CH]C1(11536)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[O]C(=O)[C]1C=C1(10018)'],
    products = ['[O]C(=O)C1(F)[CH]C1(11536)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(=O)C1(F)[CH]C1(11536)'],
    products = ['O=C(O)C1(F)[CH][CH]1(11624)'],
