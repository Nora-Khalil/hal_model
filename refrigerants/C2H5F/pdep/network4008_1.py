...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.07825,'amu*angstrom^2'), symmetry=1, barrier=(24.7912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07397,'amu*angstrom^2'), symmetry=1, barrier=(24.6926,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.902511,0.0574987,-4.12506e-05,2.31709e-09,5.62645e-12,-15820.4,25.085], Tmin=(100,'K'), Tmax=(984.492,'K')), NASAPolynomial(coeffs=[18.4915,0.00931694,-3.31346e-06,6.49195e-10,-5.00881e-14,-20411.9,-65.2273], Tmin=(984.492,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(CsFHHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Csj(F1s)(O2s-Cd)(H)) + radical(Cdj(Cs-F1sHH)(Cd-O2sH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.3409,'amu*angstrom^2'), symmetry=1, barrier=(30.83,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3423,'amu*angstrom^2'), symmetry=1, barrier=(30.8621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34281,'amu*angstrom^2'), symmetry=1, barrier=(30.8739,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.732826,0.0603602,-6.4094e-05,3.23694e-08,-6.17585e-12,-19905.4,22.6163], Tmin=(100,'K'), Tmax=(1406.84,'K')), NASAPolynomial(coeffs=[17.9119,0.00655865,-1.44427e-06,1.76638e-10,-1.00145e-14,-24248.5,-64.3832], Tmin=(1406.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-166.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(CsFHHO) + group(Ct-CtCs) + group(Ct-CtOs) + radical(Csj(F1s)(O2s-Ct)(H))"""),
)
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24353,0.059583,-6.37606e-05,3.45601e-08,-7.43161e-12,-16304,25.6848], Tmin=(100,'K'), Tmax=(1128.41,'K')), NASAPolynomial(coeffs=[13.1215,0.0174778,-7.78994e-06,1.49243e-09,-1.05435e-13,-18984.7,-33.0543], Tmin=(1128.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(CsFHHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Csj(F1s)(O2s-Cd)(H)) + radical(C=CJO)"""),
)

species(
    label = 'FC[C]=[C]OCF(11240)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,S} {7,S}
...
"""),
    E0 = (-90.4902,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([122,584,932,1043,1247,1392,1461,2986,3039,548,1085,1183,1302,1466,1520,3060,3119,1670,1700,300,440,302.987,302.988,302.988],'cm^-1')),
        HinderedRotor(inertia=(0.328984,'amu*angstrom^2'), symmetry=1, barrier=(21.4314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328983,'amu*angstrom^2'), symmetry=1, barrier=(21.4314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328984,'amu*angstrom^2'), symmetry=1, barrier=(21.4314,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08913,0.0561561,-5.1667e-05,2.30686e-08,-4.02174e-12,-10772.1,26.8062], Tmin=(100,'K'), Tmax=(1393.79,'K')), NASAPolynomial(coeffs=[15.9874,0.0133991,-5.65078e-06,1.05798e-09,-7.36806e-14,-14925,-50.0156], Tmin=(1393.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.4902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(CsFHHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cdj(Cs-F1sHH)(Cd-O2sH)) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(837)', '[O]C=[C]CF(11198)'],
    products = ['F[CH]OC=[C]CF(11105)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[CH]OC#CCF(11238)'],
    products = ['F[CH]OC=[C]CF(11105)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[O]C=[C]CF(11198)'],
    products = ['F[CH]OC=[C]CF(11105)'],
