...
"""),
    E0 = (40.9699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,259,529,569,1128,1321,1390,3140,212,367,445,1450,3000,3100,440,815,1455,1000,180,180,900.933,900.958,900.972,900.974,900.984,900.989],'cm^-1')),
        HinderedRotor(inertia=(0.00808634,'amu*angstrom^2'), symmetry=1, barrier=(4.65813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00808681,'amu*angstrom^2'), symmetry=1, barrier=(4.65827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21201,0.0530562,-3.33948e-05,7.32881e-09,3.16464e-13,5034.75,24.817], Tmin=(100,'K'), Tmax=(1197.22,'K')), NASAPolynomial(coeffs=[13.3544,0.0233943,-9.89652e-06,1.85328e-09,-1.29119e-13,1345.68,-39.213], Tmin=(1197.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.9699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCsCsFH) + group(Cs-CsHHH) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)
...
species(
    label = '[CH2]C(F)C1(F)[CH]C1(12815)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-262.83,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,250,417,511,1155,1315,1456,3119,323,467,575,827,1418,2950,3100,1380,975,1025,1650,180,180,1111.74,1111.75,1111.77,1111.79,1111.79,1111.79],'cm^-1')),
        HinderedRotor(inertia=(0.117574,'amu*angstrom^2'), symmetry=1, barrier=(2.70326,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
...
"""),
    E0 = (46.2896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,207,311,436,622,447,691,1074,1182,1276,1366,1311,1469,3045,3235,3000,3100,440,815,1455,1000,180,695.084,695.649,697.032,698.954,699.578,700.042],'cm^-1')),
        HinderedRotor(inertia=(0.0086897,'amu*angstrom^2'), symmetry=1, barrier=(3.01785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132506,'amu*angstrom^2'), symmetry=1, barrier=(3.04657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00027,0.0567464,-4.24558e-05,1.56897e-08,-2.30884e-12,5683.05,25.5907], Tmin=(100,'K'), Tmax=(1609.24,'K')), NASAPolynomial(coeffs=[15.8268,0.0198925,-8.10314e-06,1.45805e-09,-9.78932e-14,911.224,-52.9924], Tmin=(1609.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.2896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsHHH) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-CsCsH)(Cs-CsF1sH)(H)_ring) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'C[C](F)C1C[C]1F(12865)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {4,S} {6,S} {7,S} {8,S}
...
"""),
    E0 = (24.7129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,165,259,333,401,397,493,1395,1505,443.831,444.65,445.84,1561.38,1561.4,1561.52,1561.53,1561.65],'cm^-1')),
        HinderedRotor(inertia=(0.167427,'amu*angstrom^2'), symmetry=1, barrier=(23.6943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0398002,'amu*angstrom^2'), symmetry=1, barrier=(5.51646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56358,0.0503685,-3.31348e-05,1.06387e-08,-1.38618e-12,3062.19,24.1569], Tmin=(100,'K'), Tmax=(1735.93,'K')), NASAPolynomial(coeffs=[12.9827,0.024056,-1.03984e-05,1.90699e-09,-1.28681e-13,-902.367,-37.2319], Tmin=(1735.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.7129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCsCsFH) + group(Cs-CsHHH) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring) + radical(CsCsCsF1s)"""),
)

species(
    label = '[CH2][C](F)C1CC1F(8407)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {4,S} {5,S} {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92241,0.0498352,-3.33066e-05,1.12416e-08,-1.62368e-12,279.607,23.1577], Tmin=(100,'K'), Tmax=(1479.04,'K')), NASAPolynomial(coeffs=[8.76453,0.0313309,-1.45399e-05,2.78258e-09,-1.93847e-13,-1744.33,-12.5294], Tmin=(1479.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.7376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsHHH) + ring(Cs(F)-Cs-Cs) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'CC(F)[C]1C[C]1F(12866)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {1,S} {5,S} {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06136,0.0484057,-3.34007e-05,1.29299e-08,-2.35197e-12,2429.6,22.1884], Tmin=(100,'K'), Tmax=(1135.33,'K')), NASAPolynomial(coeffs=[5.57916,0.0360117,-1.70258e-05,3.31451e-09,-2.34662e-13,1630.82,4.77054], Tmin=(1135.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.6614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCsCsFH) + group(Cs-CsHHH) + ring(Cs(F)-Cs-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring)"""),
)

species(
    label = 'CC(F)C1[CH][C]1F(8409)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {4,S} {6,S} {7,S} {8,S}
...
"""),
    E0 = (69.2648,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,250,417,511,1155,1315,1456,3119,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,571.242,571.665,572.089,572.102,572.698,572.963,573.341],'cm^-1')),
        HinderedRotor(inertia=(0.00457059,'amu*angstrom^2'), symmetry=1, barrier=(1.05954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00441881,'amu*angstrom^2'), symmetry=1, barrier=(1.02976,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24633,0.0507049,-2.17727e-05,-8.22741e-09,6.57506e-12,8438.28,24.381], Tmin=(100,'K'), Tmax=(1045.89,'K')), NASAPolynomial(coeffs=[13.9278,0.0219911,-8.96922e-06,1.69965e-09,-1.21431e-13,4703.38,-42.5425], Tmin=(1045.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(69.2648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsHHH) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring) + radical(Csj(Cs-CsCsH)(Cs-CsF1sH)(H)_ring)"""),
)

species(
    label = '[CH2][CH]C1CC1(F)F(12867)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {4,S} {5,S} {6,S} {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C1C[C]1F(8405)'],
    products = ['CH2CHF(55)', 'FC1=CC1(6278)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C1C[C]1F(8405)'],
    products = ['[CH2]C(F)C1(F)[CH]C1(12815)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[CH]CC1C[C]1F(8387)'],
    products = ['[CH2]C(F)C1C[C]1F(8405)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[CH]C1C[C]1F(12860)'],
    products = ['[CH2]C(F)C1C[C]1F(8405)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)[CH]C(=C)F(10309)'],
    products = ['[CH2]C(F)C1C[C]1F(8405)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH]F(183)', 'FC1=CC1(6278)'],
    products = ['[CH2]C(F)C1C[C]1F(8405)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'C=C[C]1C[C]1F(12864)'],
    products = ['[CH2]C(F)C1C[C]1F(8405)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(291.205,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)C1C[C]1F(8405)'],
    products = ['[CH2]C(F)[C]1CC1F(8404)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)C1[CH]C1F(8370)'],
    products = ['[CH2]C(F)C1C[C]1F(8405)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[C](F)C1C[C]1F(12865)'],
    products = ['[CH2]C(F)C1C[C]1F(8405)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC(F)C1[CH][C]1F(8409)'],
    products = ['[CH2]C(F)C1C[C]1F(8405)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(F)C1C[C]1F(8405)'],
    products = ['[CH2][CH]C1CC1(F)F(12867)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(208.344,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction25',
    reactants = ['FC[CH]C1C[C]1F(12838)'],
    products = ['[CH2]C(F)C1C[C]1F(8405)'],
...
network(
    label = 'PDepNetwork #4008',
    isomers = [
        '[CH2]C(F)C1C[C]1F(8405)',
    ],
    reactants = [
        ('CH2CHF(55)', 'FC1=CC1(6278)'),
        ('CH2CHF(55)', 'F[C]1[CH]C1(6219)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
