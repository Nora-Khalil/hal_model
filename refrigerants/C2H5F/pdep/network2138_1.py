...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(271)', '[CH2]C([CH2])(F)F(3239)'],
    products = ['[CH2]C(F)(F)C[C]=C(6926)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=[C]CC(=C)F(6890)'],
    products = ['[CH2]C(F)(F)C[C]=C(6926)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', 'C#CCC([CH2])(F)F(7064)'],
    products = ['[CH2]C(F)(F)C[C]=C(6926)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C(F)=C[C]=C(6650)'],
    products = ['[CH2]C(F)(F)C[C]=C(6926)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C[C]=C(6926)'],
    products = ['[CH2]C(F)(F)[CH]C=C(6678)'],
