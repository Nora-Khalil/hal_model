...
"""),
    E0 = (89.0296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2100,2250,500,550,1855,455,950,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.92976,'amu*angstrom^2'), symmetry=1, barrier=(44.3691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.93012,'amu*angstrom^2'), symmetry=1, barrier=(44.3772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.93045,'amu*angstrom^2'), symmetry=1, barrier=(44.3849,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0653,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89615,0.0408888,-3.20128e-05,1.12552e-08,-1.12602e-12,10788.1,17.641], Tmin=(100,'K'), Tmax=(1111.05,'K')), NASAPolynomial(coeffs=[11.0724,0.0146666,-5.81021e-06,1.0528e-09,-7.24081e-14,8328.48,-29.4878], Tmin=(1111.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.0296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CtHHH) + group(Cds-OdOsH) + group(Ct-CtCs) + group(Ct-CtOs) + radical((O)CJOC)"""),
)

species(
    label = 'C=C[CH]O[C]=O(6409)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {4,S} {6,S}
2  O u0 p2 c0 {6,D}
...
"""),
    E0 = (147.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,1670,1700,300,440,343.648,344.097],'cm^-1')),
        HinderedRotor(inertia=(0.113128,'amu*angstrom^2'), symmetry=1, barrier=(9.53594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113292,'amu*angstrom^2'), symmetry=1, barrier=(9.54317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.30661,'amu*angstrom^2'), symmetry=1, barrier=(25.7575,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12706,0.0452618,-4.80895e-05,3.07226e-08,-8.57886e-12,17787.3,21.2727], Tmin=(100,'K'), Tmax=(840.677,'K')), NASAPolynomial(coeffs=[6.32376,0.0252936,-1.24605e-05,2.46831e-09,-1.76587e-13,17081.7,1.7544], Tmin=(840.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = 'C=[C][CH]OC=O(6412)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70526,0.0306757,-1.26679e-05,8.6209e-10,2.82727e-13,6145.05,20.7052], Tmin=(100,'K'), Tmax=(1873.03,'K')), NASAPolynomial(coeffs=[12.4436,0.017598,-8.37669e-06,1.53507e-09,-1.00783e-13,1142.92,-36.0028], Tmin=(1873.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.7219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(C=CCJ(O)C) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', 'C[C]=C[O](6236)'],
    products = ['C[C]=CO[C]=O(6082)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', 'C[C]=C[O](6236)'],
    products = ['C[C]=CO[C]=O(6082)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(34.1,'m^3/(mol*s)'), n=8.73864e-09, Ea=(41.6388,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->O',), comment="""Estimated from node Root_3R->O"""),
)
...
reaction(
    ...
    products = ['C[C]=CO[C]=O(6082)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(65.9689,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C=C=CO[C]=O(6407)'],
    products = ['C[C]=CO[C]=O(6082)'],
    transitionState = 'TS7',
