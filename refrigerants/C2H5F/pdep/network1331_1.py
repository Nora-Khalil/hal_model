...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[C]=C(F)C(F)F(4967)'],
    products = ['[CH]=C(F)C(F)F(3451)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=[C]C(F)F(4373)'],
    products = ['[CH]=C(F)C(F)F(3451)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]C(F)=C(F)F(4652)'],
    products = ['[CH]=C(F)C(F)F(3451)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)C(F)F(3451)'],
    products = ['C=C(F)[C](F)F(4969)'],
