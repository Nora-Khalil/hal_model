...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=O)O[C](O)F(1718)'],
    products = ['C=C(O)OC(=O)F(562)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)O[C]=O(1721)'],
    products = ['C=C(O)OC(=O)F(562)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(=O)F(332)', 'C=[C]O(142)'],
    products = ['C=C(O)OC(=O)F(562)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'C=[C]OC(=O)F(1722)'],
    products = ['C=C(O)OC(=O)F(562)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(=O)OC(=O)F(1723)'],
    products = ['C=C(O)OC(=O)F(562)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)OC(=O)F(1724)'],
    products = ['C=C(O)OC(=O)F(562)'],
