...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C(F)[C](F)F(4615)'],
    products = ['[O]C(F)C([O])(F)F(7452)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[O]C(F)(F)[CH]F(7559)'],
    products = ['[O]C(F)C([O])(F)F(7452)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)C(=O)F(2115)'],
    products = ['[O]C(F)C([O])(F)F(7452)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[O]C(F)(F)C=O(7723)'],
    products = ['[O]C(F)C([O])(F)F(7452)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[O]C(F)(F)C(=O)F(7795)'],
    products = ['[O]C(F)C([O])(F)F(7452)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F2(77)', '[O][CH]C(=O)F(2116)'],
    products = ['[O]C(F)C([O])(F)F(7452)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[O][C](F)C(=O)F(7796)'],
    products = ['[O]C(F)C([O])(F)F(7452)'],
