...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(F)[CH]F(1776)', '[CH]C-2(137)'],
    products = ['C[CH]OC(F)[CH]F(5660)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', 'C[CH]O[CH]F(1200)'],
    products = ['C[CH]OC(F)[CH]F(5660)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C[CH]OC=CF(1194)'],
    products = ['C[CH]OC(F)[CH]F(5660)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C[CH]OC(F)=CF(5667)'],
    products = ['C[CH]OC(F)[CH]F(5660)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=COC(F)[CH]F(5668)'],
    products = ['C[CH]OC(F)[CH]F(5660)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CHF(40)', 'C[CH]O[CH]F(1200)'],
    products = ['C[CH]OC(F)[CH]F(5660)'],
