...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CO[CH]F(2108)'],
    products = ['[CH]=C(C)O[CH]F(6386)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(181)', '[CH]=C(C)[O](2352)'],
    products = ['[CH]=C(C)O[CH]F(6386)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(19)', 'C#CO[CH]F(1536)'],
    products = ['[CH]=C(C)O[CH]F(6386)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[CH]=C(C)[O](2352)'],
    products = ['[CH]=C(C)O[CH]F(6386)'],
    transitionState = 'TS9',
