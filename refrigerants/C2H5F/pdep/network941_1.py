...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(837)', '[O]C[C]=O(156)'],
    products = ['O=[C]CO[CH]F(2042)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]O[CH]F(978)'],
    products = ['O=[C]CO[CH]F(2042)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH2]O[CH]F(978)'],
    products = ['O=[C]CO[CH]F(2042)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C=CO[CH]F(2093)'],
    products = ['O=[C]CO[CH]F(2042)'],
    transitionState = 'TS9',
