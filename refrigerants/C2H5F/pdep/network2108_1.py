...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC[C]=C(6908)'],
    products = ['[CH]=CC([CH2])=C(6477)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C=C=C(463)'],
    products = ['[CH]=CC([CH2])=C(6477)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=[CH](272)', 'C=C=C(6729)'],
    products = ['[CH]=CC([CH2])=C(6477)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H2(23)', '[CH2][C]=C(6819)'],
    products = ['[CH]=CC([CH2])=C(6477)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[CH](272)', '[CH2][C]=C(6819)'],
    products = ['[CH]=CC([CH2])=C(6477)'],
