...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=C(455)'],
    products = ['[CH2]OC([CH2])=C(6469)'],
    transitionState = 'TS3',
