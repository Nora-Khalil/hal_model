...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=C[C]C(6174)'],
    products = ['[CH2]CC=[C]C(6109)'],
    transitionState = 'TS2',
