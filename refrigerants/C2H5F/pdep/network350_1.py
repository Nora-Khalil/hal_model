...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(134)', '[O]C[C]=O(156)'],
    products = ['C=[C]OC[C]=O(441)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]O[C]=C(604)'],
    products = ['C=[C]OC[C]=O(441)'],
    transitionState = 'TS3',
