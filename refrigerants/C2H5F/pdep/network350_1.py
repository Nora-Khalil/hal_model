...
reaction(
    label = 'reaction2',
    reactants = ['C[C]F(124)', 'C=C(O)F(491)'],
    products = ['C=C(F)OC(C)F(560)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)OC([CH2])F(959)'],
    products = ['C=C(F)OC(C)F(560)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)O[CH]C(1259)'],
    products = ['C=C(F)OC(C)F(560)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=[C]OC(C)F(1502)'],
    products = ['C=C(F)OC(C)F(560)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'C=C(F)O[CH]F(2039)'],
    products = ['C=C(F)OC(C)F(560)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', 'C=C(F)O[C](C)F(957)'],
    products = ['C=C(F)OC(C)F(560)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', '[CH2]C(F)OC(=C)F(532)'],
    products = ['C=C(F)OC(C)F(560)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH]=C(F)OC(C)F(2040)'],
    products = ['C=C(F)OC(C)F(560)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(25)', 'CC(F)[O+]=[C-]F(2043)'],
    products = ['C=C(F)OC(C)F(560)'],
