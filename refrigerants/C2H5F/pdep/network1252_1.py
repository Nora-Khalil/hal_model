...
"""),
    E0 = (-227.117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,306.829,2126.71],'cm^-1')),
        HinderedRotor(inertia=(0.101867,'amu*angstrom^2'), symmetry=1, barrier=(6.89849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103398,'amu*angstrom^2'), symmetry=1, barrier=(6.92447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103332,'amu*angstrom^2'), symmetry=1, barrier=(6.91752,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0921,0.0455204,-4.88352e-05,3.94829e-08,-1.44695e-11,-27250.5,20.1322], Tmin=(100,'K'), Tmax=(758.727,'K')), NASAPolynomial(coeffs=[3.93243,0.0320082,-1.4589e-05,2.77351e-09,-1.9301e-13,-27420.1,12.4845], Tmin=(758.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-227.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-87.9531,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,630.197],'cm^-1')),
        HinderedRotor(inertia=(0.653146,'amu*angstrom^2'), symmetry=1, barrier=(15.0171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.727448,'amu*angstrom^2'), symmetry=1, barrier=(16.7255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00544115,'amu*angstrom^2'), symmetry=1, barrier=(15.113,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0769,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52925,0.0552697,-5.22435e-05,2.67872e-08,-5.68365e-12,-10490.1,21.2723], Tmin=(100,'K'), Tmax=(1115.94,'K')), NASAPolynomial(coeffs=[10.1192,0.0244795,-1.08561e-05,2.06195e-09,-1.44462e-13,-12407.3,-21.1112], Tmin=(1115.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.9531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
"""),
    E0 = (-79.718,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.130981,'amu*angstrom^2'), symmetry=1, barrier=(6.70877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138933,'amu*angstrom^2'), symmetry=1, barrier=(6.77232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131654,'amu*angstrom^2'), symmetry=1, barrier=(6.72462,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (59.0871,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18968,0.0381965,-2.88367e-05,1.21306e-08,-2.15071e-12,-9521.42,16.5386], Tmin=(100,'K'), Tmax=(1304.97,'K')), NASAPolynomial(coeffs=[8.15444,0.0199135,-7.82138e-06,1.39467e-09,-9.39842e-14,-11078.2,-13.8256], Tmin=(1304.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""CH3CHOHCH2""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-141.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,333.682,333.707],'cm^-1')),
        HinderedRotor(inertia=(0.105433,'amu*angstrom^2'), symmetry=1, barrier=(8.33198,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105438,'amu*angstrom^2'), symmetry=1, barrier=(8.33206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105459,'amu*angstrom^2'), symmetry=1, barrier=(8.33225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105456,'amu*angstrom^2'), symmetry=1, barrier=(8.33225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0769,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04356,0.0700412,-0.000102711,8.45733e-08,-2.78606e-11,-16939.2,22.6289], Tmin=(100,'K'), Tmax=(824.658,'K')), NASAPolynomial(coeffs=[8.75593,0.0264473,-1.2166e-05,2.28037e-09,-1.5579e-13,-18000.9,-11.8168], Tmin=(824.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-141.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH)"""),
)
...
"""),
    E0 = (-106.725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,316.499,316.499],'cm^-1')),
        HinderedRotor(inertia=(0.121263,'amu*angstrom^2'), symmetry=1, barrier=(8.619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00168296,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121245,'amu*angstrom^2'), symmetry=1, barrier=(8.61901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247502,'amu*angstrom^2'), symmetry=1, barrier=(17.5929,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0769,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16863,0.0649214,-7.92687e-05,5.2488e-08,-1.40184e-11,-12736.4,23.3972], Tmin=(100,'K'), Tmax=(910.429,'K')), NASAPolynomial(coeffs=[10.7069,0.0230135,-1.02203e-05,1.92548e-09,-1.33748e-13,-14473.1,-21.7241], Tmin=(910.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(160)', '[CH2]C(C)O(3210)'],
    products = ['CC(O)COF(2847)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]OF(396)', 'C[CH]O(148)'],
    products = ['CC(O)COF(2847)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', 'O[CH]COF(1238)'],
    products = ['CC(O)COF(2847)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(O)COF(3213)'],
    products = ['CC(O)COF(2847)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC(O)COF(2847)'],
    products = ['HF(38)', 'CH2O(20)', 'C=CO(145)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(52.7186,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
