...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COC(O)F(1930)'],
    products = ['C#COC(C)(O)F(1045)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'C#COC(=C)F(1456)'],
    products = ['C#COC(C)(O)F(1045)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C#CO[C](C)O(1931)'],
    products = ['C#COC(C)(O)F(1045)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H(22)', 'CC([O])(O)F(1252)'],
    products = ['C#COC(C)(O)F(1045)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'C#CO[C](C)F(1123)'],
    products = ['C#COC(C)(O)F(1045)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', 'C#CO[C](O)F(1452)'],
    products = ['C#COC(C)(O)F(1045)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'C#COC([CH2])(O)F(635)'],
    products = ['C#COC(C)(O)F(1045)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[C]#COC(C)(O)F(1408)'],
    products = ['C#COC(C)(O)F(1045)'],
