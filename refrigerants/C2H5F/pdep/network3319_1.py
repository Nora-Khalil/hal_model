...
"""),
    E0 = (337.422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([164,312,561,654,898,1207,1299,3167,2750,2850,1437.5,1250,1305,750,350,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1670,1700,300,440,309.691,309.867],'cm^-1')),
        HinderedRotor(inertia=(0.141732,'amu*angstrom^2'), symmetry=1, barrier=(9.64409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14157,'amu*angstrom^2'), symmetry=1, barrier=(9.64688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142001,'amu*angstrom^2'), symmetry=1, barrier=(9.64697,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20387,0.0668867,-7.60022e-05,5.38334e-08,-1.65532e-11,40678.3,26.153], Tmin=(100,'K'), Tmax=(772.567,'K')), NASAPolynomial(coeffs=[7.01371,0.0368054,-1.75954e-05,3.43159e-09,-2.42945e-13,39780.6,-0.376858], Tmin=(772.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10101,0.0577632,-4.28581e-05,1.62155e-08,-2.4902e-12,4724.06,24.4515], Tmin=(100,'K'), Tmax=(1521.06,'K')), NASAPolynomial(coeffs=[13.7761,0.0244312,-9.98791e-06,1.80896e-09,-1.22368e-13,868.102,-42.0147], Tmin=(1521.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.3704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=C=CC(F)C=C(8575)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {8,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60334,0.0568989,-4.34538e-05,1.78423e-08,-3.18659e-12,3305.08,21.2742], Tmin=(100,'K'), Tmax=(1241.69,'K')), NASAPolynomial(coeffs=[8.65748,0.0341748,-1.60024e-05,3.1037e-09,-2.19158e-13,1553.26,-14.285], Tmin=(1241.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.7936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.748123,'amu*angstrom^2'), symmetry=1, barrier=(17.2008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.748415,'amu*angstrom^2'), symmetry=1, barrier=(17.2075,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48155,0.0490227,-3.34776e-05,1.16344e-08,-1.64344e-12,56283.5,23.2098], Tmin=(100,'K'), Tmax=(1639.4,'K')), NASAPolynomial(coeffs=[12.6264,0.02183,-8.597e-06,1.51655e-09,-1.00521e-13,52629.3,-36.0669], Tmin=(1639.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(467.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)
...
"""),
    E0 = (276.212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,145,326,398,834,1303,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,540,610,2055,308.387,308.395],'cm^-1')),
        HinderedRotor(inertia=(0.166988,'amu*angstrom^2'), symmetry=1, barrier=(11.2695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166986,'amu*angstrom^2'), symmetry=1, barrier=(11.2696,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47202,0.0576761,-5.1712e-05,2.56149e-08,-5.35813e-12,33309.9,23.5905], Tmin=(100,'K'), Tmax=(1115.33,'K')), NASAPolynomial(coeffs=[9.49236,0.0289121,-1.30275e-05,2.49196e-09,-1.7516e-13,31520.9,-15.9784], Tmin=(1115.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(276.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)
...
"""),
    E0 = (267.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,233,378,609,1068,1270,1314,3037,2950,3100,1380,975,1025,1650,1685,370,2175,525,750,770,3400,2100,260.096,260.364],'cm^-1')),
        HinderedRotor(inertia=(0.317718,'amu*angstrom^2'), symmetry=1, barrier=(15.1754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25,'amu*angstrom^2'), symmetry=1, barrier=(11.8683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36543,'amu*angstrom^2'), symmetry=1, barrier=(65.163,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21913,0.0642537,-7.08512e-05,4.52692e-08,-1.20612e-11,32253.6,22.8069], Tmin=(100,'K'), Tmax=(900.294,'K')), NASAPolynomial(coeffs=[9.03155,0.0295434,-1.302e-05,2.44554e-09,-1.69664e-13,30846.9,-14.063], Tmin=(900.294,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cds_S)"""),
)

species(
    label = 'C#CCC(F)[C]=C(8630)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.62862,'amu*angstrom^2'), symmetry=1, barrier=(37.4452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63149,'amu*angstrom^2'), symmetry=1, barrier=(37.5113,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.1117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.759225,0.0600512,-5.80613e-05,2.91517e-08,-5.61572e-12,65516.4,20.7626], Tmin=(100,'K'), Tmax=(1428.68,'K')), NASAPolynomial(coeffs=[14.7312,0.0143871,-3.24523e-06,3.65951e-10,-1.74459e-14,62192.1,-49.2907], Tmin=(1428.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJC=C) + radical(C=CJC=C)"""),
)

species(
    label = '[CH2]C=C(F)C[C]=C(9559)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0579,0.0598951,-4.70599e-05,1.91353e-08,-3.16905e-12,28201.3,26.045], Tmin=(100,'K'), Tmax=(1417.56,'K')), NASAPolynomial(coeffs=[13.3309,0.0252638,-1.04145e-05,1.9012e-09,-1.29652e-13,24721.8,-37.4475], Tmin=(1417.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(233.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=CC(F)[C]=C(9433)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {7,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.969113,'amu*angstrom^2'), symmetry=1, barrier=(22.2818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.969518,'amu*angstrom^2'), symmetry=1, barrier=(22.2911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.968754,'amu*angstrom^2'), symmetry=1, barrier=(22.2736,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52435,0.0592969,-4.98826e-05,2.37882e-08,-5.00642e-12,28893.9,23.2692], Tmin=(100,'K'), Tmax=(1073.38,'K')), NASAPolynomial(coeffs=[7.8589,0.0356909,-1.68942e-05,3.29939e-09,-2.34393e-13,27534,-7.73992], Tmin=(1073.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(239.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(F)C[C]=C(9560)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {8,S}
3  C u0 p0 c0 {2,S} {6,S} {9,S} {10,S}
...
"""),
    E0 = (348.507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,275.852,275.926],'cm^-1')),
        HinderedRotor(inertia=(0.204206,'amu*angstrom^2'), symmetry=1, barrier=(11.0267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204074,'amu*angstrom^2'), symmetry=1, barrier=(11.0274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204291,'amu*angstrom^2'), symmetry=1, barrier=(11.0276,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40354,0.0620622,-5.82195e-05,3.18214e-08,-7.60369e-12,42005.1,24.9374], Tmin=(100,'K'), Tmax=(968.026,'K')), NASAPolynomial(coeffs=[7.87404,0.0353242,-1.67863e-05,3.28579e-09,-2.33857e-13,40752.4,-6.06848], Tmin=(968.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CCC(F)[C]=C(9561)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {2,S} {6,S} {10,S}
...
"""),
    E0 = (346.676,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,164,312,561,654,898,1207,1299,3167,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,237.901],'cm^-1')),
        HinderedRotor(inertia=(0.289452,'amu*angstrom^2'), symmetry=1, barrier=(11.4444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290964,'amu*angstrom^2'), symmetry=1, barrier=(11.4585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311111,'amu*angstrom^2'), symmetry=1, barrier=(11.4514,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27696,0.0644748,-6.31909e-05,3.56914e-08,-8.66396e-12,41789.8,25.8196], Tmin=(100,'K'), Tmax=(963.993,'K')), NASAPolynomial(coeffs=[8.56633,0.0342285,-1.61273e-05,3.14394e-09,-2.23253e-13,40384.4,-9.08016], Tmin=(963.993,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=CC(F)C=C(9439)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {8,S}
3  C u0 p0 c0 {2,S} {5,D} {9,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03633,0.0564182,-3.43855e-05,5.47937e-09,1.48802e-12,28661,27.2767], Tmin=(100,'K'), Tmax=(1119.91,'K')), NASAPolynomial(coeffs=[13.7339,0.0246787,-1.01064e-05,1.87991e-09,-1.31325e-13,24963.4,-39.2308], Tmin=(1119.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cdj(Cs-HHH)(Cd-CsF1s))"""),
)

species(
    label = '[CH]=[C]C(F)CC=C(9563)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {1,S} {2,S} {6,S} {10,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14352,0.0610679,-4.99535e-05,2.15648e-08,-3.84374e-12,27526.1,26.0234], Tmin=(100,'K'), Tmax=(1310.12,'K')), NASAPolynomial(coeffs=[12.0134,0.0278807,-1.19566e-05,2.22982e-09,-1.54222e-13,24677.9,-29.3536], Tmin=(1310.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cd-F1sCd)(H)(H)) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=CCC(=C)F(9566)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0579,0.0598951,-4.70599e-05,1.91353e-08,-3.16905e-12,28201.3,26.045], Tmin=(100,'K'), Tmax=(1417.57,'K')), NASAPolynomial(coeffs=[13.3309,0.0252638,-1.04145e-05,1.90119e-09,-1.29652e-13,24721.8,-37.4475], Tmin=(1417.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(233.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(134)', 'C=[C]C[CH]F(934)'],
    products = ['C=[C]CC(F)[C]=C(8587)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(134)', '[CH2]C(F)[C]=C(941)'],
    products = ['C=[C]CC(F)[C]=C(8587)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=[C]CC=C=C(6980)'],
    products = ['C=[C]CC(F)[C]=C(8587)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(58.4031,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=[C]CC(F)=C=C(9557)'],
    products = ['C=[C]CC(F)[C]=C(8587)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C#CCC(F)[C]=C(8630)'],
    products = ['C=[C]CC(F)[C]=C(8587)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(5.26262e-11,'m^3/(mol*s)'), n=4.71246, Ea=(28.7576,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[CH2][C]=CC=C=C(8287)'],
    products = ['C=[C]CC(F)[C]=C(8587)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(562.232,'m^3/(mol*s)'), n=1.03051, Ea=(301.103,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction26',
    reactants = ['C=[C]CC(F)[C]=C(8587)'],
    products = ['[CH2]C(F)=CC[C]=C(9565)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(132.035,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

reaction(
    label = 'reaction27',
    reactants = ['C=[C]CC(F)[C]=C(8587)'],
    products = ['[CH2][C]=CCC(=C)F(9566)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(178.566,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #3319',
    isomers = [
        'C=[C]CC(F)[C]=C(8587)',
    ],
    reactants = [
