...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(181)', 'CHF2-CH2(63)'],
    products = ['F[CH]CC(F)F(2374)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', 'F[C]CC(F)F-2(3022)'],
    products = ['F[CH]CC(F)F(2374)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C[CH]F(229)'],
    products = ['F[CH]CC(F)F(2374)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', 'F[CH][CH]C(F)F(3023)'],
    products = ['F[CH]CC(F)F(2374)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', 'F[CH]C[C](F)F(3024)'],
    products = ['F[CH]CC(F)F(2374)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[CH]C=CF(3025)'],
    products = ['F[CH]CC(F)F(2374)'],
