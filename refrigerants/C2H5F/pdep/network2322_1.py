...
reaction(
    label = 'reaction9',
    reactants = ['O2(2)', 'C=C=C(6556)'],
    products = ['[CH2]C(=C)O[O](6342)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)O[O](6342)'],
    products = ['O=O(150)', 'C=C=C(6556)'],
    transitionState = 'TS2',
