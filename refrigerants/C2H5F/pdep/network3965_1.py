...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CO[C]=O(265)'],
    products = ['[CH]=C(CF)O[C]=O(9084)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)O[C]=O(2532)'],
    products = ['[CH]=C(CF)O[C]=O(9084)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(126)', '[CH]=C([O])CF(2478)'],
    products = ['[CH]=C(CF)O[C]=O(9084)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[CH]=C([O])CF(2478)'],
    products = ['[CH]=C(CF)O[C]=O(9084)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2F(46)', 'C#CO[C]=O(212)'],
    products = ['[CH]=C(CF)O[C]=O(9084)'],
    transitionState = 'TS9',
