...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(136)', '[CH2]C([O])F(338)'],
    products = ['[CH2]C(F)O[C]=O(3612)'],
    transitionState = 'TS2',
