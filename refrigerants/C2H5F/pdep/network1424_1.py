...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4503.91,'J/mol'), sigma=(6.74804,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=703.50 K, Pc=33.26 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC([O])(F)OF(2765)'],
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(367)', 'CC(=O)[C]=O(3967)'],
    products = ['CC([O])(F)C(=O)OF(4053)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['O(7)', 'C[C](F)C(=O)OF(3846)'],
    products = ['CC([O])(F)C(=O)OF(4053)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(=O)C(=O)OF(3901)'],
    products = ['CC([O])(F)C(=O)OF(4053)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'O=C(F)C(=O)OF(4835)'],
    products = ['CC([O])(F)C(=O)OF(4053)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OF(3602)', 'CC(=O)F(253)'],
    products = ['CC([O])(F)C(=O)OF(4053)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'CC([O])=C([O])OF(3815)'],
    products = ['CC([O])(F)C(=O)OF(4053)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'CC([O])(F)C([O])=O(3795)'],
    products = ['CC([O])(F)C(=O)OF(4053)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(357)', 'CC([O])(F)[C]=O(1215)'],
    products = ['CC([O])(F)C(=O)OF(4053)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', '[O][C](F)C(=O)OF(4836)'],
    products = ['CC([O])(F)C(=O)OF(4053)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OF(3602)', 'C[C]([O])F(512)'],
    products = ['CC([O])(F)C(=O)OF(4053)'],
