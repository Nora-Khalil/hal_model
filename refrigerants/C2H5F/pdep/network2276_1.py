...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', 'C=[C]C[O](689)'],
    products = ['C=[C]CO[C]=O(6575)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', '[CH2]O[C]=O(252)'],
    products = ['C=[C]CO[C]=O(6575)'],
    transitionState = 'TS3',
