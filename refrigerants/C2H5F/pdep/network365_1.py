...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(134)', '[CH2]C[O](144)'],
    products = ['[CH2]CO[C]=C(454)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=C(604)'],
    products = ['[CH2]CO[C]=C(454)'],
    transitionState = 'TS3',
