...
"""),
    ...
    molecularWeight = (121.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.652615,0.0790788,-9.12614e-05,6.05819e-08,-1.68399e-11,-17986.8,26.8145], Tmin=(100,'K'), Tmax=(861.666,'K')), NASAPolynomial(coeffs=[9.80454,0.0365937,-1.7302e-05,3.35932e-09,-2.37418e-13,-19564,-15.9755], Tmin=(861.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(O)CJ)"""),
)
...
"""),
    E0 = (-82.9016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,174,267,591,721,1107,1278,1348,3273,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,350,440,435,1725,2950,3100,1380,975,1025,1650,204.111,204.168],'cm^-1')),
        HinderedRotor(inertia=(0.124791,'amu*angstrom^2'), symmetry=1, barrier=(3.69988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124949,'amu*angstrom^2'), symmetry=1, barrier=(3.70081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00132665,'amu*angstrom^2'), symmetry=1, barrier=(3.70041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.931179,'amu*angstrom^2'), symmetry=1, barrier=(27.5519,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.105,'amu'),
...
"""),
    ...
    molecularWeight = (121.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.346035,0.0877249,-0.000126384,1.07937e-07,-3.76604e-11,-53419.6,28.6867], Tmin=(100,'K'), Tmax=(787.261,'K')), NASAPolynomial(coeffs=[8.09005,0.0399663,-1.93596e-05,3.73432e-09,-2.60178e-13,-54378.2,-5.16571], Tmin=(787.261,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-445.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(CsCsFHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsCs) + radical(CsCsF1sH)"""),
)

species(
    label = 'CCC(=C[CH]F)OF(11884)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {6,S}
...
"""),
    ...
    molecularWeight = (121.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.905338,0.0714041,-6.53807e-05,3.24083e-08,-6.75835e-12,-18358.1,26.6421], Tmin=(100,'K'), Tmax=(1118.45,'K')), NASAPolynomial(coeffs=[11.1279,0.0348445,-1.63495e-05,3.18282e-09,-2.25831e-13,-20644.8,-23.8205], Tmin=(1118.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.841628,0.0657111,-5.84856e-05,2.71182e-08,-5.08101e-12,41392.9,26.943], Tmin=(100,'K'), Tmax=(1273.61,'K')), NASAPolynomial(coeffs=[13.8662,0.0248052,-1.03086e-05,1.90016e-09,-1.30924e-13,38075.2,-39.0433], Tmin=(1273.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799671,0.0735878,-7.75213e-05,4.39926e-08,-1.02699e-11,9338.95,26.6545], Tmin=(100,'K'), Tmax=(1022.85,'K')), NASAPolynomial(coeffs=[11.8255,0.0304705,-1.42913e-05,2.78165e-09,-1.97492e-13,7083.37,-26.7878], Tmin=(1022.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)

species(
    label = 'CC1[C](OF)CC1F(11887)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (121.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.195163,0.0765272,-6.92471e-05,3.18277e-08,-5.82075e-12,-3527.13,25.1859], Tmin=(100,'K'), Tmax=(1316.95,'K')), NASAPolynomial(coeffs=[17.3264,0.0244937,-9.98098e-06,1.82586e-09,-1.25398e-13,-8039.32,-62.1792], Tmin=(1316.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.5145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(CsCsCsFH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cs(C)-Cs-Cs(F)) + radical(CJC(C)2O)"""),
)
...
"""),
    E0 = (-118.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,339.743,339.766,340.38],'cm^-1')),
        HinderedRotor(inertia=(0.00145499,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137189,'amu*angstrom^2'), symmetry=1, barrier=(11.2937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137355,'amu*angstrom^2'), symmetry=1, barrier=(11.2861,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.728309,0.0677335,-6.48676e-05,3.26237e-08,-6.56065e-12,-14145,26.9958], Tmin=(100,'K'), Tmax=(1202.34,'K')), NASAPolynomial(coeffs=[14.2123,0.0228737,-8.90117e-06,1.59132e-09,-1.08049e-13,-17387.4,-40.5411], Tmin=(1202.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (195.979,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,334,575,1197,1424,3202,2950,3100,1380,975,1025,1650,1685,370,277.283,277.383],'cm^-1')),
        HinderedRotor(inertia=(0.00217723,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241271,'amu*angstrom^2'), symmetry=1, barrier=(13.2332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242349,'amu*angstrom^2'), symmetry=1, barrier=(13.2364,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64319,0.0538347,-4.62642e-05,2.24654e-08,-4.67264e-12,23654,22.6315], Tmin=(100,'K'), Tmax=(1112.35,'K')), NASAPolynomial(coeffs=[8.53608,0.0290473,-1.28377e-05,2.43139e-09,-1.69897e-13,22120.5,-11.3565], Tmin=(1112.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(195.979,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsF1sH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (3.4764,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,234,589,736,816,1240,3237,3000,3100,440,815,1455,1000,325.777],'cm^-1')),
        HinderedRotor(inertia=(0.0738409,'amu*angstrom^2'), symmetry=1, barrier=(5.58484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0722652,'amu*angstrom^2'), symmetry=1, barrier=(5.57916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0756726,'amu*angstrom^2'), symmetry=1, barrier=(5.58522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0786299,'amu*angstrom^2'), symmetry=1, barrier=(59.6111,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.646329,0.0782335,-9.32305e-05,6.21119e-08,-1.7011e-11,534.994,27.7947], Tmin=(100,'K'), Tmax=(881.176,'K')), NASAPolynomial(coeffs=[10.7803,0.0322305,-1.49189e-05,2.86267e-09,-2.00861e-13,-1250.92,-19.8136], Tmin=(881.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.4764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(Csj(Cd-CsCd)(F1s)(H)) + radical(C=C(O)CJ)"""),
)
...
6  C u0 p0 c0 {4,S} {10,S} {11,S} {13,S}
7  C u0 p0 c0 {3,S} {4,S} {8,D}
8  C u0 p0 c0 {7,D} {14,S} {15,S}
9  H u0 p0 c0 {4,S}
10 H u0 p0 c0 {6,S}
...
"""),
    ...
    molecularWeight = (121.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.230828,0.0741523,-6.77563e-05,3.16054e-08,-5.82948e-12,-64247,28.8943], Tmin=(100,'K'), Tmax=(1314.92,'K')), NASAPolynomial(coeffs=[17.363,0.0220355,-8.30337e-06,1.46235e-09,-9.84674e-14,-68752.4,-58.449], Tmin=(1314.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-535.369,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(CsCsFFH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C(C[CH]F)OF(1961)'],
...
reaction(
    label = 'reaction3',
    reactants = ['C=C(OF)C(C)[CH]F(11794)'],
    products = ['[CH2]C(=CC(C)F)OF(11882)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C(OF)C(F)[CH]C(11834)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]C(C)C(=C)OF-2(11885)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]F(837)', '[CH2]C(=CC)OF(670)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(OF)C(C)[C]F-2(11886)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C=C(OF)C(C)[CH]F(11794)'],
    products = ['[CH2]C1(OF)C(C)C1F(11888)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', 'C=C(C=CF)OF(4063)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]OF(491)', 'CC=CF(2186)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C(OF)C(C)=CF(10772)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'C=C([O])C(C)[CH]F(11889)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(160)', 'C=[C]C(C)[CH]F(11890)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(19)', '[CH2]C(=C[CH]F)OF(4066)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OF(491)', 'C[CH][CH]F(2782)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(OF)=C(C)[CH]F(11891)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH]=C(OF)C(C)[CH]F(10806)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CHF(40)', '[CH2]C(=CC)OF(670)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'C=C(OF)C(C)[C]F(10816)'],
    products = ['C=C(OF)C(C)[CH]F(11794)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C(OF)C(C)[CH]F(11794)'],
    products = ['C=C([O])C(C)C(F)F(11894)'],
