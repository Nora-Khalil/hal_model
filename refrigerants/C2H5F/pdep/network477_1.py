...
reaction(
    label = 'reaction2',
    reactants = ['O=C(O)O(1921)', 'C[C]F(124)'],
    products = ['CC(F)OC(=O)O(565)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'O=C(O)OCF(548)'],
    products = ['CC(F)OC(=O)O(565)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)O[C](O)O(2490)'],
    products = ['CC(F)OC(=O)O(565)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[CH]OC(=O)O(2491)'],
    products = ['CC(F)OC(=O)O(565)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)O(163)', 'CH3-CHF(62)'],
    products = ['CC(F)OC(=O)O(565)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]O(146)', 'CC([O])F(533)'],
    products = ['CC(F)OC(=O)O(565)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'CC(F)O[C]=O(2436)'],
    products = ['CC(F)OC(=O)O(565)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)OC([O])=O(2492)'],
    products = ['CC(F)OC(=O)O(565)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'O=C(O)O[CH]F(2381)'],
    products = ['CC(F)OC(=O)O(565)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C[C](F)OC(=O)O(2493)'],
    products = ['CC(F)OC(=O)O(565)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(F)OC(=O)O(2494)'],
    products = ['CC(F)OC(=O)O(565)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC(F)OC(=O)O(565)'],
    products = ['O=C(O)O(1921)', 'CH2CHF(55)'],
