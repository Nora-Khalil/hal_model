...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'F[C]C=C(F)F(4384)'],
    products = ['[O]C(F)(F)C=[C]F(7459)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O=C(F)C=[C]F(2711)'],
    products = ['[O]C(F)(F)C=[C]F(7459)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[O]C(F)(F)C#CF(7822)'],
    products = ['[O]C(F)(F)C=[C]F(7459)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['HF(38)', 'O=C(F)[C]=[C]F(7823)'],
    products = ['[O]C(F)(F)C=[C]F(7459)'],
    transitionState = 'TS9',
