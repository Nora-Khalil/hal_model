...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.616495,'amu*angstrom^2'), symmetry=1, barrier=(14.1744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616287,'amu*angstrom^2'), symmetry=1, barrier=(14.1697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.617686,'amu*angstrom^2'), symmetry=1, barrier=(14.2018,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28885,0.0637511,-6.39413e-05,3.77114e-08,-9.5446e-12,38828.2,23.9489], Tmin=(100,'K'), Tmax=(930.186,'K')), NASAPolynomial(coeffs=[8.27643,0.0337023,-1.5484e-05,2.9811e-09,-2.10141e-13,37528.3,-9.25628], Tmin=(930.186,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(Cds_S) + radical(Cds_S)"""),
)
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.778423,0.061404,-4.8275e-05,1.9148e-08,-3.02855e-12,2886.98,23.8882], Tmin=(100,'K'), Tmax=(1508.21,'K')), NASAPolynomial(coeffs=[15.9359,0.0212031,-8.29193e-06,1.47399e-09,-9.8844e-14,-1685.02,-55.466], Tmin=(1508.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.949803,'amu*angstrom^2'), symmetry=1, barrier=(21.8378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.947787,'amu*angstrom^2'), symmetry=1, barrier=(21.7915,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25147,0.0539216,-4.26579e-05,1.76652e-08,-2.95699e-12,52581,21.0058], Tmin=(100,'K'), Tmax=(1419.27,'K')), NASAPolynomial(coeffs=[12.867,0.021185,-8.05923e-06,1.41329e-09,-9.42633e-14,49283.9,-39.0994], Tmin=(1419.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.48453,'amu*angstrom^2'), symmetry=1, barrier=(57.1241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.837142,'amu*angstrom^2'), symmetry=1, barrier=(19.2475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.83822,'amu*angstrom^2'), symmetry=1, barrier=(19.2723,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53247,0.0534885,-4.16651e-05,1.76066e-08,-3.13225e-12,30739.7,23.094], Tmin=(100,'K'), Tmax=(1294.79,'K')), NASAPolynomial(coeffs=[9.92096,0.0275738,-1.16432e-05,2.14878e-09,-1.47616e-13,28567.5,-19.5428], Tmin=(1294.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.95313,'amu*angstrom^2'), symmetry=1, barrier=(44.9063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844829,'amu*angstrom^2'), symmetry=1, barrier=(19.4243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.845247,'amu*angstrom^2'), symmetry=1, barrier=(19.4339,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
...
"""),
    E0 = (202.267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([122,584,932,1043,1247,1392,1461,2986,3039,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,1685,370,249.591],'cm^-1')),
        HinderedRotor(inertia=(0.301958,'amu*angstrom^2'), symmetry=1, barrier=(13.3553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.608531,'amu*angstrom^2'), symmetry=1, barrier=(26.8863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.87408,'amu*angstrom^2'), symmetry=1, barrier=(82.8982,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06367,0.0566662,-3.85497e-05,1.19238e-08,-1.05697e-12,24439.4,25.8342], Tmin=(100,'K'), Tmax=(1207.75,'K')), NASAPolynomial(coeffs=[12.9159,0.0255807,-1.00872e-05,1.8127e-09,-1.23168e-13,20980.8,-36.0494], Tmin=(1207.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(C=CC=CCJ) + radical(Cds_S)"""),
)

species(
    label = 'C[C]=C[C]=CCF(11332)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10906,0.0673225,-7.41128e-05,4.91791e-08,-1.38178e-11,34162.7,23.7143], Tmin=(100,'K'), Tmax=(851.116,'K')), NASAPolynomial(coeffs=[8.25776,0.0337251,-1.49e-05,2.79777e-09,-1.93851e-13,32945.9,-9.62155], Tmin=(851.116,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(Cds_S) + radical(C=CJC=C)"""),
)

species(
    label = 'CC=[C]C=[C]CF(11333)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32177,0.0589122,-5.55689e-05,3.28373e-08,-8.2442e-12,28424.9,26.533], Tmin=(100,'K'), Tmax=(951.021,'K')), NASAPolynomial(coeffs=[7.96059,0.030989,-1.15265e-05,1.96319e-09,-1.28061e-13,27162.2,-5.16198], Tmin=(951.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(CsCsFHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Cs_S) + radical(Sec_Propargyl)"""),
)

species(
    label = 'C[CH][CH]C#CCF(11335)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {1,S} {6,S} {11,S} {12,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42409,0.058017,-5.89636e-05,4.01537e-08,-1.15948e-11,30012.3,27.0541], Tmin=(100,'K'), Tmax=(932.936,'K')), NASAPolynomial(coeffs=[6.3232,0.0329539,-1.21418e-05,2.03297e-09,-1.30183e-13,29274.8,4.70522], Tmin=(932.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJC) + radical(Sec_Propargyl)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[C]=CC=[C]CF(11113)'],
    products = ['C#CCF(4379)', 'C#CC(4975)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C=C=CC=[C]C(6509)'],
    products = ['C[C]=CC=[C]CF(11113)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C=C=CC=[C]CF(11127)'],
    products = ['C[C]=CC=[C]CF(11113)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C#CCF(4379)', '[CH]=[C]C(4976)'],
    products = ['C[C]=CC=[C]CF(11113)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C[C]=CC#CCF(11329)'],
    products = ['C[C]=CC=[C]CF(11113)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[C]CF(4380)', 'C#CC(4975)'],
    products = ['C[C]=CC=[C]CF(11113)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'CC#CC=[C]CF(11330)'],
    products = ['C[C]=CC=[C]CF(11113)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[C]CF(4380)', '[CH]=[C]C(4976)'],
    products = ['C[C]=CC=[C]CF(11113)'],
...
network(
    label = 'PDepNetwork #4029',
    isomers = [
        'C[C]=CC=[C]CF(11113)',
    ],
    reactants = [
        ('C#CCF(4379)', 'C#CC(4975)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
