...
reaction(
    label = 'reaction2',
    reactants = ['C[C]F(124)', 'C=C(O)OF(2527)'],
    products = ['C=C(OF)OC(C)F(2752)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'C=C(OC)OF(2503)'],
    products = ['C=C(OF)OC(C)F(2752)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'C=C(OF)OCF(2522)'],
    products = ['C=C(OF)OC(C)F(2752)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2CHF(55)', 'C=C(O)OF(2527)'],
    products = ['C=C(OF)OC(C)F(2752)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(OF)O[C](C)F(2792)'],
    products = ['C=C(OF)OC(C)F(2752)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(F)OC([CH2])OF(2793)'],
    products = ['C=C(OF)OC(C)F(2752)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(F)O[C](C)OF(2794)'],
    products = ['C=C(OF)OC(C)F(2752)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C=C(OF)O[CH]C(2795)'],
    products = ['C=C(OF)OC(C)F(2752)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH2]C(=O)OC(C)F(2796)'],
    products = ['C=C(OF)OC(C)F(2752)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(=O)OF(2532)', 'CH3-CHF(62)'],
    products = ['C=C(OF)OC(C)F(2752)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]OF(507)', 'CC([O])F(249)'],
    products = ['C=C(OF)OC(C)F(2752)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(357)', 'C=[C]OC(C)F(1502)'],
    products = ['C=C(OF)OC(C)F(2752)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(19)', 'C=C(OF)O[CH]F(2599)'],
    products = ['C=C(OF)OC(C)F(2752)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', 'C=C(OF)O[C](C)F(2797)'],
    products = ['C=C(OF)OC(C)F(2752)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', '[CH2]C(F)OC(=C)OF(2798)'],
    products = ['C=C(OF)OC(C)F(2752)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(6)', '[CH]=C(OF)OC(C)F(2799)'],
    products = ['C=C(OF)OC(C)F(2752)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=C(OF)OC(C)F(2752)'],
    products = ['CH2CHF(55)', 'CC(=O)OF(2549)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'C=COC(=C)OF(2511)'],
    products = ['C=C(OF)OC(C)F(2752)'],
