...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CO[C]=O(256)'],
    products = ['CC([O])O[C]=O(320)'],
    transitionState = 'TS2',
