...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.164756,0.0702807,-7.94667e-05,4.48468e-08,-9.28364e-12,-76452.1,21.1036], Tmin=(100,'K'), Tmax=(1424.38,'K')), NASAPolynomial(coeffs=[16.1875,0.00955115,1.05607e-06,-5.96034e-10,5.33681e-14,-79420.5,-56.2619], Tmin=(1424.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-636.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(CsCFOO) + group(Cs-CsOsHH) + group(CsCFHO) + group(Cs-CsHHH) + ring(1,3-Dioxolane) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C1(F)OC(C)(F)O1(5458)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99282,0.0543702,-1.35492e-05,-8.63588e-08,9.62957e-11,-71346.2,18.8604], Tmin=(100,'K'), Tmax=(438.175,'K')), NASAPolynomial(coeffs=[5.04841,0.0415772,-2.14493e-05,4.31166e-09,-3.10088e-13,-71758.9,4.98603], Tmin=(438.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-593.718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(CsCFOO) + group(CsCFOO) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(O2s-Cs-O2s-Cs(F)) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3713.87,'J/mol'), sigma=(6.24976,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=580.10 K, Pc=34.52 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-231.189,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,326,540,652,719,1357,2950,3100,1380,975,1025,1650,498.18,500.362,500.426,511.457],'cm^-1')),
        HinderedRotor(inertia=(0.148177,'amu*angstrom^2'), symmetry=1, barrier=(3.40688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.823725,'amu*angstrom^2'), symmetry=1, barrier=(18.9391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.823413,'amu*angstrom^2'), symmetry=1, barrier=(18.9319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.825063,'amu*angstrom^2'), symmetry=1, barrier=(18.9698,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.49755,0.076232,-8.12751e-05,4.31627e-08,-9.09319e-12,-27678.8,26.6875], Tmin=(100,'K'), Tmax=(1148.7,'K')), NASAPolynomial(coeffs=[16.0729,0.0219957,-1.04522e-05,2.05951e-09,-1.47623e-13,-31257.1,-50.6137], Tmin=(1148.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['C=C(F)OC(C)([O])F(5154)'],
    products = ['CC([O])(F)CC(=O)F(5150)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(108.389,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=C(F)O[C](C)F(5204)'],
    products = ['C=C(F)OC(C)([O])F(5154)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C=C(F)OC(C)([O])F(5154)'],
    products = ['[CH2]C1(F)OC(C)(F)O1(5458)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(F)OC(C)=O(3231)'],
    products = ['C=C(F)OC(C)([O])F(5154)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', 'C=C(F)OC(=O)F(4075)'],
    products = ['C=C(F)OC(C)([O])F(5154)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2][C](F)OC(C)=O(5255)'],
    products = ['C=C(F)OC(C)([O])F(5154)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=[C]OC(C)([O])F(5121)'],
    products = ['C=C(F)OC(C)([O])F(5154)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CFO(78)', 'C[C]([O])F(1344)'],
    products = ['C=C(F)OC(C)([O])F(5154)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(7.69999,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['CH2CF(69)', 'CC([O])([O])F(1558)'],
    products = ['C=C(F)OC(C)([O])F(5154)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C(F)OC(C)([O])F(5459)'],
    products = ['C=C(F)OC(C)([O])F(5154)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'C#COC(C)([O])F(1521)'],
    products = ['C=C(F)OC(C)([O])F(5154)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=[C]OC(C)(F)OF(5462)'],
    products = ['C=C(F)OC(C)([O])F(5154)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(80.8089,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)
