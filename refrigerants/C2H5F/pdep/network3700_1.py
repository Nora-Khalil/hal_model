...
"""),
    E0 = (-217.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,174,267,591,721,1107,1278,1348,3273,3010,987.5,1337.5,450,1655,350,440,435,1725,3000,3100,440,815,1455,1000,286.301],'cm^-1')),
        HinderedRotor(inertia=(0.162645,'amu*angstrom^2'), symmetry=1, barrier=(9.97361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.371919,'amu*angstrom^2'), symmetry=1, barrier=(20.9386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180937,'amu*angstrom^2'), symmetry=1, barrier=(10.0117,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177113,'amu*angstrom^2'), symmetry=1, barrier=(10.0058,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.214273,0.0903159,-0.000132238,9.98244e-08,-2.89982e-11,-26081.3,27.2607], Tmin=(100,'K'), Tmax=(684.634,'K')), NASAPolynomial(coeffs=[12.4022,0.0276642,-1.3718e-05,2.66897e-09,-1.86895e-13,-27950.7,-28.3856], Tmin=(684.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(Csj(Cs-F1sCdH)(H)(H))"""),
)

species(
    label = '[CH2]C(F)OC(O)=CF(10470)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[CH2]C(F)C(O)F(2451)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=C(O)[C]F(2789)', 'CH2F-CH2(61)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)C(F)C(=O)O(10371)'],
    products = ['O=C(O)C(F)C[CH]F(10467)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(169)', '[CH2]C(F)C=C=O(1145)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', '[CH2]C(F)C(F)=C=O(10468)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C=CF(411)', '[CH2]C(O)F(531)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)C=C(O)OF(10469)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(F)OC(O)=CF(10470)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(T)(18)', 'O=C(O)C(F)[CH]F(2802)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH]C(F)C(F)C(=O)O(10471)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)C(F)C(=O)O(10371)'],
    products = ['[O]C1(O)CC(F)C1F(10473)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)C(F)=C(O)O(10474)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'C=CC(F)C(=O)O(10475)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=C(O)[CH]F(1883)', 'CH2CHF(55)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C=C(F)C(F)C(=O)O(9665)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F(37)', '[CH2]C(F)[CH]C(=O)O(7073)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F(37)', '[CH2][CH]C(F)C(=O)O(10476)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OH(7)', '[CH2]C(F)C(F)[C]=O(10477)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[CH2]C(F)C(F)C([O])=O(10478)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O=C(O)[CH]F(1883)', '[CH2][CH]F(839)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O=[C]O(146)', '[CH2]C(F)[CH]F(890)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(5)', '[CH2]C(F)[C](F)C(=O)O(10479)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(5)', '[CH2][C](F)C(F)C(=O)O(10480)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction27',
    reactants = ['F2(77)', 'C=C[CH]C(=O)O(10481)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HF(38)', 'C=C[C](F)C(=O)O(10235)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction29',
    reactants = ['HF(38)', 'C=C(F)[CH]C(=O)O(7082)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C[C](F)C(F)C(=O)O(10482)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CC(F)C(F)C([O])=O(10484)'],
    products = ['[CH2]C(F)C(F)C(=O)O(10371)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(F)C(F)C(=O)O(10371)'],
    products = ['O=C(O)[CH]C(F)CF(10485)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(F)C(F)C(=O)O(10371)'],
    products = ['O=C(O)C(F)[CH]CF(10486)'],
...
network(
    label = 'PDepNetwork #3700',
    isomers = [
        '[CH2]C(F)C(F)C(=O)O(10371)',
    ],
    reactants = [
