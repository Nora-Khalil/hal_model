...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C([O])=O(863)'],
    products = ['[CH2]CC([O])=O(3600)'],
    transitionState = 'TS2',
