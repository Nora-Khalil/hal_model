...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH]C(=C)F(2580)'],
    products = ['[CH]=C(F)C[C]=O(2546)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(F)C=C=O(2661)'],
    products = ['[CH]=C(F)C[C]=O(2546)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C[C]=O(2662)'],
    products = ['[CH]=C(F)C[C]=O(2546)'],
