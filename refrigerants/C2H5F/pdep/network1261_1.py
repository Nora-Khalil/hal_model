...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OCO(2771)'],
    products = ['OCOC(F)F(2856)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(1981)', 'CH2OH(33)'],
    products = ['OCOC(F)F(2856)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', '[CH2]OC(F)F(3330)'],
    products = ['OCOC(F)F(2856)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O[CH]OC(F)F(3297)'],
    products = ['OCOC(F)F(2856)'],
    transitionState = 'TS9',
