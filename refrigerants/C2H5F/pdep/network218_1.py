...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(152)', '[CH]C-2(137)'],
    products = ['C[CH]OC([O])=O(319)'],
    transitionState = 'TS2',
