...
"""),
    E0 = (241.624,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([122,584,932,1043,1247,1392,1461,2986,3039,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1670,1700,300,440,256.92,554.962,618.531],'cm^-1')),
        HinderedRotor(inertia=(0.423987,'amu*angstrom^2'), symmetry=1, barrier=(19.9581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.791062,'amu*angstrom^2'), symmetry=1, barrier=(19.9543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417122,'amu*angstrom^2'), symmetry=1, barrier=(19.9504,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21755,0.0554783,-4.708e-05,2.00431e-08,-3.40533e-12,29165.6,28.9235], Tmin=(100,'K'), Tmax=(1405.39,'K')), NASAPolynomial(coeffs=[14.1065,0.0187937,-7.92557e-06,1.46946e-09,-1.01308e-13,25542.8,-37.6446], Tmin=(1405.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sHH)(Cd-O2sH)) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47057,0.0444547,-1.01391e-05,-2.28338e-08,1.28931e-11,-12447.7,17.7802], Tmin=(100,'K'), Tmax=(980.581,'K')), NASAPolynomial(coeffs=[14.9329,0.0154968,-5.54976e-06,1.04214e-09,-7.67651e-14,-16335.9,-53.267], Tmin=(980.581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Oxetene)"""),
)
...
"""),
    E0 = (201.203,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([319,1023,1071,1259,1317,1409,3054,3019,2950,3100,1380,975,1025,1650,2100,2250,500,550,1685,370,370.759,370.759,370.76,370.761],'cm^-1')),
        HinderedRotor(inertia=(0.328918,'amu*angstrom^2'), symmetry=1, barrier=(32.0855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103806,'amu*angstrom^2'), symmetry=1, barrier=(10.1255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.874809,'amu*angstrom^2'), symmetry=1, barrier=(85.3362,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64562,0.0532951,-5.53411e-05,3.21054e-08,-7.69559e-12,24282.7,25.1514], Tmin=(100,'K'), Tmax=(998.74,'K')), NASAPolynomial(coeffs=[9.17229,0.0231503,-1.00667e-05,1.88434e-09,-1.30762e-13,22779.2,-11.1509], Tmin=(998.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCFHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(C=CJO)"""),
)

species(
    label = 'C#COC=[C]CF(11207)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60458,0.057041,-6.80746e-05,5.1234e-08,-1.6624e-11,28680.1,29.3589], Tmin=(100,'K'), Tmax=(736.791,'K')), NASAPolynomial(coeffs=[6.44879,0.0307468,-1.4553e-05,2.81509e-09,-1.97994e-13,27966.1,7.46713], Tmin=(736.791,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC=[C]CF(11209)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.10916,'amu*angstrom^2'), symmetry=1, barrier=(25.5017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1092,'amu*angstrom^2'), symmetry=1, barrier=(25.5027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10915,'amu*angstrom^2'), symmetry=1, barrier=(25.5014,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.924036,0.0574612,-3.81798e-05,1.31671e-09,5.28883e-12,30064.7,27.2458], Tmin=(100,'K'), Tmax=(996.946,'K')), NASAPolynomial(coeffs=[17.1374,0.0139844,-5.22701e-06,9.8873e-10,-7.25103e-14,25759.8,-56.3023], Tmin=(996.946,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sHH)(Cd-O2sH)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][CH]OC#CCF(11210)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {7,S}
3  C u0 p0 c0 {1,S} {6,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0264084,0.0782579,-9.1555e-05,5.12155e-08,-1.08098e-11,23989.8,26.4316], Tmin=(100,'K'), Tmax=(1264.06,'K')), NASAPolynomial(coeffs=[20.4738,0.00777238,-1.25074e-06,7.50801e-11,-5.91424e-16,19255.6,-75.4997], Tmin=(1264.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = 'C#CO[CH][CH]CF(11211)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {5,S} {6,S}
3  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.166961,0.0783503,-9.0808e-05,4.80972e-08,-8.92519e-12,23109.7,25.3131], Tmin=(100,'K'), Tmax=(957.48,'K')), NASAPolynomial(coeffs=[19.5546,0.00979709,-2.90207e-06,4.61482e-10,-3.07368e-14,18826.8,-70.3567], Tmin=(957.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Csj(Cs-O2sHH)(Cs-F1sHH)(H)) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(134)', '[O]C=[C]CF(11198)'],
    products = ['C=[C]OC=[C]CF(11095)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=[C]OC#CCF(11206)'],
    products = ['C=[C]OC=[C]CF(11095)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#COC=[C]CF(11207)'],
    products = ['C=[C]OC=[C]CF(11095)'],
