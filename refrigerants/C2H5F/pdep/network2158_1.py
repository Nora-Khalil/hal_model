...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[C]=O(420)'],
    products = ['[CH]=C(C)C[C]=O(6102)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(126)', '[CH]C(=C)C(6159)'],
    products = ['[CH]=C(C)C[C]=O(6102)'],
    transitionState = 'TS4',
