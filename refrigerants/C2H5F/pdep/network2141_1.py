...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'C=C=C[C]=O(6565)'],
    products = ['C=C=CC(=O)O(6085)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(7.7e+07,'m^3/(mol*s)'), n=0, Ea=(0.0523696,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_2R->C_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_2R->C_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]O(146)', '[CH]=C=C(4381)'],
    products = ['C=C=CC(=O)O(6085)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C#CC(=O)O(6566)'],
    products = ['C=C=CC(=O)O(6085)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'C#C[CH]C(=O)O(6567)'],
    products = ['C=C=CC(=O)O(6085)'],
