...
reaction(
    label = 'reaction3',
    reactants = ['HO2(11)', 'O=C[C]F-2(1764)'],
    products = ['[O]OC(F)C=O(1780)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[O]O[CH]C=O(1864)'],
    products = ['[O]OC(F)C=O(1780)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]O[C](F)C=O(1865)'],
    products = ['[O]OC(F)C=O(1780)'],
