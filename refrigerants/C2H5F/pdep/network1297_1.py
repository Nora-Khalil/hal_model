...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(O)F(3296)'],
    products = ['OC(F)OC(F)F(2891)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'O[CH]OC(F)F(3297)'],
    products = ['OC(F)OC(F)F(2891)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'OC(F)O[CH]F(3298)'],
    products = ['OC(F)OC(F)F(2891)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)F(1981)', 'O[CH]F(1908)'],
    products = ['OC(F)OC(F)F(2891)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF2(81)', '[O]C(O)F(2025)'],
    products = ['OC(F)OC(F)F(2891)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['OH(7)', 'F[CH]OC(F)F(3299)'],
    products = ['OC(F)OC(F)F(2891)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)OC(F)F(3300)'],
    products = ['OC(F)OC(F)F(2891)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O[C](F)OC(F)F(3301)'],
    products = ['OC(F)OC(F)F(2891)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'OC(F)O[C](F)F(3302)'],
    products = ['OC(F)OC(F)F(2891)'],
