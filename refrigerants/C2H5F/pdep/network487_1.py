...
"""),
    ...
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05367,0.0457541,-4.65801e-05,2.49022e-08,-5.52088e-12,-57699.6,17.9068], Tmin=(100,'K'), Tmax=(1064.41,'K')), NASAPolynomial(coeffs=[8.95332,0.0198251,-1.00397e-05,2.01568e-09,-1.45411e-13,-59168.4,-15.8106], Tmin=(1064.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-480.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsH)"""),
)
...
"""),
    E0 = (-237.76,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,487,638,688,1119,1325,1387,3149,3025,407.5,1350,352.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.429441,'amu*angstrom^2'), symmetry=1, barrier=(9.87369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427839,'amu*angstrom^2'), symmetry=1, barrier=(9.83686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.428376,'amu*angstrom^2'), symmetry=1, barrier=(9.84921,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18932,0.0694517,-0.000125,1.10489e-07,-3.67281e-11,-28502,22.0736], Tmin=(100,'K'), Tmax=(892.014,'K')), NASAPolynomial(coeffs=[8.97415,0.0172712,-8.21028e-06,1.4977e-09,-9.80912e-14,-29203.7,-10.7425], Tmin=(892.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFHO) + group(Cs-CsOsHH) + radical(ROOJ) + radical(Csj(Cs-F1sO2sH)(O2s-H)(H))"""),
)
...
"""),
    E0 = (-224.044,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,180],'cm^-1')),
        HinderedRotor(inertia=(0.353988,'amu*angstrom^2'), symmetry=1, barrier=(8.13887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353949,'amu*angstrom^2'), symmetry=1, barrier=(8.13797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353838,'amu*angstrom^2'), symmetry=1, barrier=(8.13544,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44431,0.0653576,-0.000120688,1.12735e-07,-3.95078e-11,-26862.9,22.1875], Tmin=(100,'K'), Tmax=(874.956,'K')), NASAPolynomial(coeffs=[6.34365,0.0221898,-1.10748e-05,2.08544e-09,-1.40159e-13,-26925.3,3.74866], Tmin=(874.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-224.044,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFHO) + group(Cs-CsOsHH) + radical(ROOJ) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[O][CH]C(F)OO(1577)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 O u0 p2 c0 {3,S} {5,S}
3 O u0 p2 c0 {2,S} {9,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.257626,'amu*angstrom^2'), symmetry=1, barrier=(5.92333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257885,'amu*angstrom^2'), symmetry=1, barrier=(5.92928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.33964,'amu*angstrom^2'), symmetry=1, barrier=(53.7929,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27587,0.070454,-0.00013326,1.27405e-07,-4.57295e-11,-19643.8,21.8635], Tmin=(100,'K'), Tmax=(859.702,'K')), NASAPolynomial(coeffs=[5.94269,0.0252242,-1.33131e-05,2.57233e-09,-1.75891e-13,-19577.2,5.10848], Tmin=(859.702,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-164.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(CsCFHO) + group(Cs-CsOsHH) + radical(CCOJ) + radical(Csj(Cs-F1sO2sH)(O2s-H)(H))"""),
)

species(
    label = '[O]O[CH]COF(1709)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {2,S}
...
"""),
    E0 = (130.201,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.181562,'amu*angstrom^2'), symmetry=1, barrier=(4.17447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181652,'amu*angstrom^2'), symmetry=1, barrier=(4.17653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.61754,'amu*angstrom^2'), symmetry=1, barrier=(106.166,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43271,0.0648483,-0.00011565,1.0675e-07,-3.73441e-11,15744,21.5769], Tmin=(100,'K'), Tmax=(867.633,'K')), NASAPolynomial(coeffs=[6.50776,0.0230044,-1.14174e-05,2.15558e-09,-1.45632e-13,15557.7,1.81451], Tmin=(867.633,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2sCF) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = '[O]C[CH]OOF(1710)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(3.82648,'amu*angstrom^2'), symmetry=1, barrier=(87.9783,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66467,0.0624118,-0.00011764,1.1851e-07,-4.47036e-11,19745.1,22.1283], Tmin=(100,'K'), Tmax=(848.631,'K')), NASAPolynomial(coeffs=[2.95091,0.0306765,-1.61685e-05,3.1474e-09,-2.17166e-13,20451.2,21.5807], Tmin=(848.631,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOO)"""),
)
...
reaction(
    ...
    products = ['[O]CC(F)O[O](1576)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(122.327,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(7)', '[O]CC([O])F(1109)'],
    products = ['[O]CC(F)O[O](1576)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]CC(F)O[O](1576)'],
    products = ['O(7)', 'FC1COO1(1394)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(3.11355e+11,'s^-1'), n=0, Ea=(204.772,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3OO_SS;Y_rad_intra;OO] for rate rule [R3OO_SS;Y_rad_intra;OOJ]
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[CH]F(250)', '[CH2][O](318)'],
    products = ['[O]CC(F)O[O](1576)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[O]O[CH]C=O(1396)'],
    products = ['[O]CC(F)O[O](1576)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(287.918,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['[O]OC(F)[CH]O(1707)'],
    products = ['[O]CC(F)O[O](1576)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]O[CH]COF(1709)'],
    products = ['[O]CC(F)O[O](1576)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(97.9511,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[O]C[CH]OOF(1710)'],
    products = ['[O]CC(F)O[O](1576)'],
