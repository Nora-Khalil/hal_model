...
"""),
    E0 = (-239.79,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,225.87,2731.82],'cm^-1')),
        HinderedRotor(inertia=(0.00330416,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.318341,'amu*angstrom^2'), symmetry=1, barrier=(11.5244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.318351,'amu*angstrom^2'), symmetry=1, barrier=(11.5244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.318336,'amu*angstrom^2'), symmetry=1, barrier=(11.5244,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19428,0.0662629,-7.56491e-05,5.26953e-08,-1.56531e-11,-28743.2,25.3342], Tmin=(100,'K'), Tmax=(804.493,'K')), NASAPolynomial(coeffs=[7.6618,0.0341045,-1.56861e-05,3.00292e-09,-2.1029e-13,-29783.7,-4.46056], Tmin=(804.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-239.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCC(=CO)OF(3624)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (-266.082,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,321.068,321.787],'cm^-1')),
        HinderedRotor(inertia=(0.00167326,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143398,'amu*angstrom^2'), symmetry=1, barrier=(10.3154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141721,'amu*angstrom^2'), symmetry=1, barrier=(10.3078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31084,0.0497093,-2.25522e-05,-1.13827e-08,9.48408e-12,-31897,24.5551], Tmin=(100,'K'), Tmax=(958.69,'K')), NASAPolynomial(coeffs=[14.6722,0.0163116,-5.26761e-06,9.15946e-10,-6.45987e-14,-35485.9,-44.6988], Tmin=(958.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-266.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
"""),
    E0 = (-15.7201,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,180,446.604,612.818],'cm^-1')),
        HinderedRotor(inertia=(0.0740362,'amu*angstrom^2'), symmetry=1, barrier=(19.7189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.857706,'amu*angstrom^2'), symmetry=1, barrier=(19.7203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00173665,'amu*angstrom^2'), symmetry=1, barrier=(19.7181,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (48.5133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,407.47],'cm^-1')),
        HinderedRotor(inertia=(0.0877144,'amu*angstrom^2'), symmetry=1, barrier=(10.3365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0877841,'amu*angstrom^2'), symmetry=1, barrier=(10.3346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0877153,'amu*angstrom^2'), symmetry=1, barrier=(10.3332,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88874,0.0397975,-1.79004e-05,-3.5279e-09,3.75349e-12,5916.5,21.3981], Tmin=(100,'K'), Tmax=(1056.12,'K')), NASAPolynomial(coeffs=[10.4238,0.0200922,-7.83858e-06,1.43597e-09,-1.00059e-13,3409.82,-23.5771], Tmin=(1056.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.5133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-142.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,264.17],'cm^-1')),
...
"""),
    E0 = (-34.4918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,1380,1390,370,380,2900,435,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,567.959,567.959],'cm^-1')),
        HinderedRotor(inertia=(0.046191,'amu*angstrom^2'), symmetry=1, barrier=(10.5735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.046191,'amu*angstrom^2'), symmetry=1, barrier=(10.5735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.046191,'amu*angstrom^2'), symmetry=1, barrier=(10.5735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.046191,'amu*angstrom^2'), symmetry=1, barrier=(10.5735,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.826083,0.0686774,-7.31549e-05,4.00045e-08,-8.70269e-12,-4033.11,27.8981], Tmin=(100,'K'), Tmax=(1115.17,'K')), NASAPolynomial(coeffs=[14.0982,0.0210715,-9.12077e-06,1.72376e-09,-1.2086e-13,-6993.23,-37.579], Tmin=(1115.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.4918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJCO)"""),
)

species(
    label = '[CH]=C(OF)C(C)O(3632)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (1.01524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,374.354],'cm^-1')),
        HinderedRotor(inertia=(0.00120296,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117232,'amu*angstrom^2'), symmetry=1, barrier=(11.6579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117231,'amu*angstrom^2'), symmetry=1, barrier=(11.6578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117227,'amu*angstrom^2'), symmetry=1, barrier=(11.6579,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.924171,0.0667773,-6.92254e-05,3.70979e-08,-7.95538e-12,233.642,27.3155], Tmin=(100,'K'), Tmax=(1126.67,'K')), NASAPolynomial(coeffs=[13.5365,0.0219997,-9.60996e-06,1.82234e-09,-1.27918e-13,-2608.32,-35.0357], Tmin=(1126.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.01524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(OF)C(C)O(3633)',
    structure = adjacencyList("""1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {14,S}
3  O u0 p2 c0 {1,S} {5,S}
4  C u0 p0 c0 {2,S} {5,S} {6,S} {8,S}
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C(CO)OF(2841)'],
    products = ['C=C(OF)C(C)O(3593)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'C=CC(=C)OF(1953)'],
    products = ['C=C(OF)C(C)O(3593)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C=C([O])C(C)O(3627)'],
    products = ['C=C(OF)C(C)O(3593)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', '[CH2]C(=CC)OF(670)'],
    products = ['C=C(OF)C(C)O(3593)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C(OF)C(C)[O](3628)'],
    products = ['C=C(OF)C(C)O(3593)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(160)', 'C=[C]C(C)O(3629)'],
    products = ['C=C(OF)C(C)O(3593)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', '[CH2]C(=CO)OF(3011)'],
    products = ['C=C(OF)C(C)O(3593)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]OF(491)', 'C[CH]O(148)'],
    products = ['C=C(OF)C(C)O(3593)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(OF)=C(C)O(3630)'],
    products = ['C=C(OF)C(C)O(3593)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(O)C(=C)OF(3631)'],
    products = ['C=C(OF)C(C)O(3593)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH]=C(OF)C(C)O(3632)'],
    products = ['C=C(OF)C(C)O(3593)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C(OF)C(C)O(3593)'],
    products = ['HF(38)', 'CH2CO(28)', 'C=CO(145)'],
