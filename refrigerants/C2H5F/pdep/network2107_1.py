...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC([O])F(1666)'],
    products = ['O=O(150)', 'CHFO(47)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C([O])F(2070)'],
    products = ['[O]OC([O])F(1666)'],
    transitionState = 'TS2',
