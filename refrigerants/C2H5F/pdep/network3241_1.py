...
"""),
    E0 = (7.97617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,334,575,1197,1424,3202,167,640,1190,189.571,189.655],'cm^-1')),
        HinderedRotor(inertia=(0.00468858,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00469044,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.547957,'amu*angstrom^2'), symmetry=1, barrier=(13.977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26613,0.0642015,-6.90488e-05,4.265e-08,-1.11003e-11,1054.29,24.2175], Tmin=(100,'K'), Tmax=(914.093,'K')), NASAPolynomial(coeffs=[8.87997,0.030885,-1.43791e-05,2.77959e-09,-1.9625e-13,-337.701,-11.8312], Tmin=(914.093,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.97617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Csj(Cs-CdHH)(F1s)(H)) + radical(Cdj(Cd-CsCs)(F1s))"""),
)

species(
    label = 'C=C([C]F)CCF(8718)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (-49.3388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,350,440,435,1725,2950,3100,1380,975,1025,1650,341.239,341.587,341.635,341.644,1397.74],'cm^-1')),
        HinderedRotor(inertia=(0.0928211,'amu*angstrom^2'), symmetry=1, barrier=(7.68335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209088,'amu*angstrom^2'), symmetry=1, barrier=(17.2905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208781,'amu*angstrom^2'), symmetry=1, barrier=(17.2914,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48836,0.0600289,-5.74465e-05,3.11882e-08,-7.30819e-12,-5847.63,22.0685], Tmin=(100,'K'), Tmax=(991.146,'K')), NASAPolynomial(coeffs=[8.32811,0.0324255,-1.56714e-05,3.08926e-09,-2.20705e-13,-7203.47,-10.8685], Tmin=(991.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.3388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (20.9153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,334,575,1197,1424,3202,3120,650,792.5,1650,308.521,315.182],'cm^-1')),
        HinderedRotor(inertia=(0.00170623,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13907,'amu*angstrom^2'), symmetry=1, barrier=(9.94522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.352902,'amu*angstrom^2'), symmetry=1, barrier=(24.4294,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35705,0.0622928,-6.1872e-05,3.43929e-08,-8.10546e-12,2607.24,24.5982], Tmin=(100,'K'), Tmax=(996.892,'K')), NASAPolynomial(coeffs=[9.15803,0.030991,-1.4772e-05,2.8944e-09,-2.06129e-13,1051.92,-13.0126], Tmin=(996.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.9153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-CdHH)(F1s)(H)) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.8937,0.0606342,-5.18555e-05,2.24692e-08,-3.86995e-12,-37281.7,22.256], Tmin=(100,'K'), Tmax=(1395.95,'K')), NASAPolynomial(coeffs=[15.2326,0.0195472,-7.70609e-06,1.38475e-09,-9.39499e-14,-41285,-51.7039], Tmin=(1395.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFH)"""),
)

species(
    label = 'F[CH][C]1CC(F)C1(8721)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3346,0.0408259,-1.81413e-05,2.52292e-09,3.59928e-14,-5821.96,21.1859], Tmin=(100,'K'), Tmax=(2032.56,'K')), NASAPolynomial(coeffs=[16.7251,0.0207965,-9.47819e-06,1.68824e-09,-1.08171e-13,-13384.4,-62.6599], Tmin=(2032.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.8729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCsFHH) + ring(Cs(F)-Cs-Cs-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-65.5188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,350,440,435,1725,194,682,905,1196,1383,3221,356.076,356.076,356.076,356.076,356.076],'cm^-1')),
    ...
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18124,0.0615028,-4.67683e-05,1.89618e-08,-3.24801e-12,-7778.46,23.8518], Tmin=(100,'K'), Tmax=(1331.11,'K')), NASAPolynomial(coeffs=[10.8097,0.0325693,-1.41638e-05,2.63231e-09,-1.81131e-13,-10341.8,-25.3539], Tmin=(1331.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.5188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=CF)C[CH]F(8514)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(5.86885e+09,'s^-1'), n=0.611527, Ea=(103.737,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 102.6 to 103.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(C=CF)=CF(8715)'],
    products = ['[CH2]C(=CF)C[CH]F(8514)'],
...
network(
    label = 'PDepNetwork #3241',
    isomers = [
        '[CH2]C(=CF)C[CH]F(8514)',
    ],
    reactants = [
