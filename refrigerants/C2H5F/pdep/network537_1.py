...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(134)', '[CH2]C([O])F(527)'],
    products = ['[CH2]C(F)O[C]=C(1115)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C#COC([CH2])F(1161)'],
    products = ['[CH2]C(F)O[C]=C(1115)'],
