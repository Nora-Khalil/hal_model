...
"""),
    E0 = (-101.852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2995,3025,975,1000,1300,1375,400,500,1630,1680,194,682,905,1196,1383,3221,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.643003,'amu*angstrom^2'), symmetry=1, barrier=(14.7839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13054,'amu*angstrom^2'), symmetry=1, barrier=(25.9934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13108,'amu*angstrom^2'), symmetry=1, barrier=(26.0058,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18909,0.0568384,-4.83777e-05,2.04628e-08,-3.45742e-12,-12144.8,25.5842], Tmin=(100,'K'), Tmax=(1408.41,'K')), NASAPolynomial(coeffs=[14.3504,0.0194599,-8.56943e-06,1.62012e-09,-1.12823e-13,-15852.2,-42.4193], Tmin=(1408.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (155.634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,180],'cm^-1')),
        HinderedRotor(inertia=(2.1568,'amu*angstrom^2'), symmetry=1, barrier=(49.589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109754,'amu*angstrom^2'), symmetry=1, barrier=(2.52345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.16094,'amu*angstrom^2'), symmetry=1, barrier=(49.6843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00983804,'amu*angstrom^2'), symmetry=1, barrier=(2.43327,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20843,0.0670503,-8.31004e-05,5.99971e-08,-1.82564e-11,18813.9,27.1359], Tmin=(100,'K'), Tmax=(788.191,'K')), NASAPolynomial(coeffs=[8.1668,0.031736,-1.5892e-05,3.14919e-09,-2.24641e-13,17717,-4.77785], Tmin=(788.191,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(CCsJOOC) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)OOC=CF(3078)'],
    products = ['O=C[CH]F(1529)', 'FC1CO1(767)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)OOC=CF(3078)'],
    products = ['[CH2]C(F)OC(F)C=O(3148)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]OOC=CF(2127)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(6)', '[CH]C(F)OOC=CF(3149)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]OC=CF(1438)', 'CH2CHF(55)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'C=C(F)OOC=CF(1603)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2][CH]OOC=CF(3153)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=COOC([CH2])F(1240)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=C[CH]F(1529)', '[CH2]C([O])F(338)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC=CF(1438)', '[CH2][CH]F(183)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHFCH[Z](70)', '[CH2]C(F)O[O](193)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH2][C](F)OOC=CF(1596)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', '[CH2]C(F)OO[C]=CF(3154)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH2]C(F)OOC=[C]F(3155)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C#COOC([CH2])F(634)'],
    products = ['[CH2]C(F)OOC=CF(3078)'],
