...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', '[O]C[C]=CF(2647)'],
    products = ['O=[C]OC[C]=CF(8433)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1334)', '[CH2]O[C]=O(252)'],
    products = ['O=[C]OC[C]=CF(8433)'],
    transitionState = 'TS3',
