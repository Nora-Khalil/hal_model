...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'C=C=CC=[C]C(6796)'],
    products = ['C[C]=CC=[C]CF(10235)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(6)', 'C[C]=CC=C=CF(10620)'],
    products = ['C[C]=CC=[C]CF(10235)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', 'C=C=CC=[C]CF(10251)'],
    products = ['C[C]=CC=[C]CF(10235)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'C[C]=CC#CCF(10621)'],
    products = ['C[C]=CC=[C]CF(10235)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', 'CC#CC=[C]CF(10622)'],
    products = ['C[C]=CC=[C]CF(10235)'],
