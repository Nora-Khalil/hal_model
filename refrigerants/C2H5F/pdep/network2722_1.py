...
"""),
    E0 = (121.543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,326,540,652,719,1357,3010,987.5,1337.5,450,1655,401.781,401.794,401.796,401.808],'cm^-1')),
        HinderedRotor(inertia=(0.446802,'amu*angstrom^2'), symmetry=1, barrier=(51.1831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.446768,'amu*angstrom^2'), symmetry=1, barrier=(51.1833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=C(F)F(7152)'],
    products = ['[CH]=CC([O])(F)F(7400)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O][C](F)F(4247)', 'C2H2(23)'],
    products = ['[CH]=CC([O])(F)F(7400)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(4247)', '[CH]=[CH](135)'],
    products = ['[CH]=CC([O])(F)F(7400)'],
    transitionState = 'TS8',
