...
reaction(
    label = 'reaction8',
    reactants = ['[O]F(160)', '[CH2]CCF(1648)'],
    products = ['FCCCOF(1629)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]OF(396)', 'CH2F-CH2(61)'],
    products = ['FCCCOF(1629)'],
    transitionState = 'TS9',
