...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]C(4682)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])(F)F(1349)', '[CH]C-2(137)'],
    products = ['[CH2]C(F)(F)O[CH]C(4682)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[C](F)F(4695)'],
    products = ['[CH2]C(F)(F)O[CH]C(4682)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]C(F)(F)OC=C(4696)'],
    products = ['[CH2]C(F)(F)O[CH]C(4682)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]COC([CH2])(F)F(4697)'],
    products = ['[CH2]C(F)(F)O[CH]C(4682)'],
