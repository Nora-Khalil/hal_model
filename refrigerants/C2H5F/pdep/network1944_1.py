...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C(F)[CH]F(1776)'],
    products = ['[CH2]OC(F)[CH]F(4805)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', '[CH2]O[CH]F(978)'],
    products = ['[CH2]OC(F)[CH]F(4805)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(20)', 'F[CH][CH]F(4261)'],
    products = ['[CH2]OC(F)[CH]F(4805)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](131)', 'CHFCHF[Z](58)'],
    products = ['[CH2]OC(F)[CH]F(4805)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)=CF(5547)'],
    products = ['[CH2]OC(F)[CH]F(4805)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](131)', 'F[CH][CH]F(4261)'],
    products = ['[CH2]OC(F)[CH]F(4805)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]O[CH]F(978)'],
    products = ['[CH2]OC(F)[CH]F(4805)'],
