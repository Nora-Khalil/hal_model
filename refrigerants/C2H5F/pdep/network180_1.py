...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', '[O]C[C]=O(156)'],
    products = ['O=[C]CO[C]=O(282)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]O[C]=O(252)'],
    products = ['O=[C]CO[C]=O(282)'],
    transitionState = 'TS3',
