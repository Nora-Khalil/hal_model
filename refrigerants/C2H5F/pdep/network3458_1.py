...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59846,0.0452207,-2.31099e-05,6.15867e-10,2.01169e-12,1765.41,23.2691], Tmin=(100,'K'), Tmax=(1173.3,'K')), NASAPolynomial(coeffs=[11.7862,0.0226301,-9.75101e-06,1.84486e-09,-1.29376e-13,-1460.97,-31.0705], Tmin=(1173.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.9073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cs(F)-Cd-Cd(O2))"""),
)

species(
    label = 'C=COC1C=C1F(10031)',
...
"""),
    E0 = (82.9445,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,194,682,905,1196,1383,3221,2950,3100,1380,975,1025,1650,1685,370,180.019,599.749,602.214,606.071],'cm^-1')),
        HinderedRotor(inertia=(0.0682046,'amu*angstrom^2'), symmetry=1, barrier=(1.56816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.965977,'amu*angstrom^2'), symmetry=1, barrier=(22.2097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178986,'amu*angstrom^2'), symmetry=1, barrier=(46.0952,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
...
"""),
    E0 = (253.652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,2950,3100,1380,975,1025,1650,1685,370,517.492,517.899,517.905,517.932,517.976,518.005,518.049,518.069],'cm^-1')),
        HinderedRotor(inertia=(0.0100339,'amu*angstrom^2'), symmetry=1, barrier=(1.9092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0100509,'amu*angstrom^2'), symmetry=1, barrier=(1.90728,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53281,0.0388878,-2.33941e-05,6.67982e-09,-8.04447e-13,30553.3,23.0092], Tmin=(100,'K'), Tmax=(1664.81,'K')), NASAPolynomial(coeffs=[7.40838,0.0271734,-1.28394e-05,2.45324e-09,-1.69754e-13,28930,-2.99772], Tmin=(1664.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCCFH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cs(F)-Cd-Cd(O2)) + radical(C=CJO)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63528,0.0367922,1.25045e-05,-5.19397e-08,2.49291e-11,49125.2,21.6207], Tmin=(100,'K'), Tmax=(947.443,'K')), NASAPolynomial(coeffs=[17.5408,0.00765339,-1.54426e-06,2.92378e-10,-2.71873e-14,44405.2,-63.2591], Tmin=(947.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]OC1C=C1F(10056)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {7,S}
3  C u0 p0 c0 {2,S} {4,S} {5,S} {8,S}
...
"""),
    E0 = (215.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,259,529,569,1128,1321,1390,3140,2175,525,750,770,3400,2100,441.264,441.278,441.281,441.29,441.297,441.298,441.311,441.367],'cm^-1')),
        HinderedRotor(inertia=(0.238578,'amu*angstrom^2'), symmetry=1, barrier=(32.9683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238494,'amu*angstrom^2'), symmetry=1, barrier=(32.968,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0829,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938017,0.0534699,-2.19011e-05,-2.23703e-08,1.5543e-11,26037.8,20.5106], Tmin=(100,'K'), Tmax=(955.479,'K')), NASAPolynomial(coeffs=[20.0768,0.00696167,-1.65827e-06,3.25028e-10,-2.8945e-14,20846.1,-78.9805], Tmin=(955.479,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Ct-CtOs) + group(Ct-CtH) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-O2sCsH)(Cs-CsF1sH)(H)_ring)"""),
)
...
"""),
    E0 = (253.239,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,259,529,569,1128,1321,1390,3140,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,467.686,467.808,467.829,467.872,467.982,468.02,468.074,468.266],'cm^-1')),
        HinderedRotor(inertia=(0.163375,'amu*angstrom^2'), symmetry=1, barrier=(25.3914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162933,'amu*angstrom^2'), symmetry=1, barrier=(25.3831,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.867328,0.0513151,-2.30834e-06,-4.8901e-08,2.64778e-11,30586.6,23.7109], Tmin=(100,'K'), Tmax=(938.013,'K')), NASAPolynomial(coeffs=[22.0252,0.00550498,-7.60591e-08,-9.32251e-12,-6.31961e-15,24663.3,-87.4251], Tmin=(938.013,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-O2sCsH)(Cs-CsF1sH)(H)_ring) + radical(Cds_P)"""),
)

species(
    label = 'C=CO[C]1[CH]C1F(10061)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {6,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.837902,0.0563246,-2.65974e-05,-1.72041e-08,1.35224e-11,24945,24.911], Tmin=(100,'K'), Tmax=(959.414,'K')), NASAPolynomial(coeffs=[19.6789,0.00938774,-2.64293e-06,4.97562e-10,-4.01046e-14,19874.7,-72.7885], Tmin=(959.414,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cs(F)-Cs-Cs) + radical(C2CsJOC(O)) + radical(Csj(Cs-O2sCsH)(Cs-CsF1sH)(H)_ring)"""),
)

species(
    label = 'C=COC1[CH][C]1F(10062)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {6,S}
3  C u0 p0 c0 {2,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58683,0.0338948,3.47043e-05,-7.87644e-08,3.49067e-11,18778.4,25.2008], Tmin=(100,'K'), Tmax=(948.709,'K')), NASAPolynomial(coeffs=[18.938,0.00886317,-1.80883e-06,3.63238e-10,-3.4771e-14,13320.5,-69.0089], Tmin=(948.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CdCFO) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]OC1[CH]C1F(10027)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(134)', '[O]C1[CH]C1F(10000)'],
    products = ['C=[C]OC1[CH]C1F(10027)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=[C]OC1=CC1F(10054)'],
    products = ['C=[C]OC1[CH]C1F(10027)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=[C]OC1C=C1(10055)'],
    products = ['C=[C]OC1[CH]C1F(10027)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=[C]OC1C=C1F(10056)'],
    products = ['C=[C]OC1[CH]C1F(10027)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C#COC1[CH]C1F(10057)'],
    products = ['C=[C]OC1[CH]C1F(10027)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C=[C]O[C]1C=C1(10058)'],
    products = ['C=[C]OC1[CH]C1F(10027)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=COC1[CH]C1F(10060)'],
    products = ['C=[C]OC1[CH]C1F(10027)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OC1[CH]C1F(10027)'],
    products = ['C=CO[C]1[CH]C1F(10061)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=[C]OC1[CH]C1F(10027)'],
    products = ['C=C(F)OC1[CH][CH]1(10064)'],
