...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'C=[C]C(F)C=C(10907)'],
    products = ['[CH2]CC(F)[C]=C(10793)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', '[CH2]CC(F)=C=C(10908)'],
    products = ['[CH2]CC(F)[C]=C(10793)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', 'C#CC(F)C[CH2](10909)'],
    products = ['[CH2]CC(F)[C]=C(10793)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(F)[C]=C(10793)'],
    products = ['[CH2]C=C(F)C[CH2](10911)'],
