...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.630649,0.0649162,-6.39338e-05,2.88958e-08,-5.02546e-12,-34507.9,25.9026], Tmin=(100,'K'), Tmax=(1404.94,'K')), NASAPolynomial(coeffs=[19.8948,0.0100703,-5.3779e-06,1.11053e-09,-8.13309e-14,-39921,-73.5857], Tmin=(1404.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (-104.977,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.717757,0.0668439,-7.48715e-05,3.92704e-08,-7.92129e-12,-12503.1,25.2062], Tmin=(100,'K'), Tmax=(1219.74,'K')), NASAPolynomial(coeffs=[18.0937,0.00986118,-4.79549e-06,9.69157e-10,-7.09783e-14,-16741.9,-62.0743], Tmin=(1219.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(CCsJOC(O)) + radical(CJCO)"""),
)
...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3303.12,'J/mol'), sigma=(5.47065,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=515.94 K, Pc=45.78 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    molecularWeight = (124.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08642,0.0684371,-8.25436e-05,4.96027e-08,-1.19586e-11,-39462,26.4582], Tmin=(100,'K'), Tmax=(1001.18,'K')), NASAPolynomial(coeffs=[12.9223,0.0211488,-1.1694e-05,2.42484e-09,-1.77888e-13,-41831.9,-30.657], Tmin=(1001.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2sCF) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(CsCsF1sO2s) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)OC(=O)OF(3756)'],
    products = ['HF(38)', 'CO2(14)', 'CH2CFO(78)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(11.2294,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'O=C(OF)O[CH]F(3065)'],
    products = ['[CH2]C(F)OC(=O)OF(3756)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[CH]C(F)OC(=O)OF(3957)'],
    products = ['[CH2]C(F)OC(=O)OF(3756)'],
    transitionState = 'TS3',
...
reaction(
    ...
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.64784e+07,'s^-1'), n=0.990488, Ea=(121.824,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_SS_CO;carbonyl_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Endocyclic
Ea raised from 119.3 to 121.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.46159e+06,'s^-1'), n=1.55572, Ea=(172.103,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 169.6 to 172.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=COC(=O)OF(553)'],
    products = ['[CH2]C(F)OC(=O)OF(3756)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)OC([O])=O(1915)'],
    products = ['[CH2]C(F)OC(=O)OF(3756)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(160)', '[CH2]C(F)O[C]=O(1281)'],
    products = ['[CH2]C(F)OC(=O)OF(3756)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2][C](F)OC(=O)OF(3961)'],
    products = ['[CH2]C(F)OC(=O)OF(3756)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(202.939,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction16',
    reactants = ['C[C](F)OC(=O)OF(3962)'],
    products = ['[CH2]C(F)OC(=O)OF(3756)'],
