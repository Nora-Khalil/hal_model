...
"""),
    E0 = (-285.517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,180,233,1109,1254,1325,1339,3290,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,3025,407.5,1350,352.5,196.367,196.381,196.382],'cm^-1')),
        HinderedRotor(inertia=(0.00437141,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0043713,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.667315,'amu*angstrom^2'), symmetry=1, barrier=(18.2624,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.66735,'amu*angstrom^2'), symmetry=1, barrier=(18.2626,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.608193,0.080442,-0.000104985,7.40941e-08,-2.12749e-11,-34222.7,26.7338], Tmin=(100,'K'), Tmax=(844.39,'K')), NASAPolynomial(coeffs=[11.3167,0.029714,-1.48705e-05,2.94644e-09,-2.1014e-13,-36031.2,-23.1175], Tmin=(844.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCsJO)"""),
)

species(
    label = 'CC(=C[CH]F)OOF(4818)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-68.9061,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,234,589,736,816,1240,3237],'cm^-1')),
        HinderedRotor(inertia=(0.797099,'amu*angstrom^2'), symmetry=1, barrier=(18.3269,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.949797,0.0735267,-9.12632e-05,6.52298e-08,-1.96121e-11,-8183.39,26.5409], Tmin=(100,'K'), Tmax=(797.271,'K')), NASAPolynomial(coeffs=[8.77547,0.0342672,-1.74049e-05,3.47504e-09,-2.49044e-13,-9431.32,-9.44108], Tmin=(797.271,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.9061,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03241,0.059148,-5.33132e-05,2.37843e-08,-4.19566e-12,18711.7,27.6291], Tmin=(100,'K'), Tmax=(1365.31,'K')), NASAPolynomial(coeffs=[15.2719,0.0174302,-7.48023e-06,1.40466e-09,-9.77928e-14,14823.4,-45.5023], Tmin=(1365.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (-111.829,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10614,0.0657856,-6.85624e-05,3.64384e-08,-7.84427e-12,-13347.5,26.9168], Tmin=(100,'K'), Tmax=(1110.04,'K')), NASAPolynomial(coeffs=[12.7571,0.0238017,-1.18295e-05,2.36575e-09,-1.70531e-13,-15934.1,-30.5086], Tmin=(1110.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.829,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CsCCl_triplet)"""),
)

species(
    label = 'C[C]1OC(F)C1OF(4821)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48106,0.0595703,-5.37967e-05,2.71404e-08,-5.89924e-12,-26936.2,23.6499], Tmin=(100,'K'), Tmax=(1061.12,'K')), NASAPolynomial(coeffs=[8.6888,0.0324,-1.53887e-05,3.00991e-09,-2.14076e-13,-28465.8,-11.5509], Tmin=(1061.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-224.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(Cs-CsHHH) + ring(O2s-Cs-Cs-Cs(F)) + radical(C2CsJOCs)"""),
)

species(
    label = 'CC1([O])C(F)C1OF(4822)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.807213,0.0677253,-6.27589e-05,2.95087e-08,-5.57939e-12,-17194.9,22.9379], Tmin=(100,'K'), Tmax=(1262.53,'K')), NASAPolynomial(coeffs=[14.6141,0.0239822,-1.07885e-05,2.06649e-09,-1.45461e-13,-20681.3,-46.8909], Tmin=(1262.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsHHH) + ring(Cs(F)-Cs-Cs(O2)) + radical(CC(C)2OJ)"""),
)

species(
    label = 'CC(O)=C([CH]F)OF(4382)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-306.746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,234,589,736,816,1240,3237,180],'cm^-1')),
...
"""),
    E0 = (-340.242,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,375,552.5,462.5,1710,194,682,905,1196,1383,3221,180,1297],'cm^-1')),
        HinderedRotor(inertia=(0.148764,'amu*angstrom^2'), symmetry=1, barrier=(3.42037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148464,'amu*angstrom^2'), symmetry=1, barrier=(3.41348,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06088,0.0731946,-0.000116219,1.10118e-07,-4.18976e-11,-40824.1,24.5492], Tmin=(100,'K'), Tmax=(782.39,'K')), NASAPolynomial(coeffs=[5.11677,0.0377114,-1.99161e-05,3.96767e-09,-2.80844e-13,-41007.4,8.86179], Tmin=(782.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-340.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)HHH) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)Cs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'CC(=O)C([O])[CH]F(4824)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  O u1 p2 c0 {4,S}
3  O u0 p2 c0 {6,D}
...
"""),
    E0 = (-177.932,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,334,575,1197,1424,3202,180,903.406,4000],'cm^-1')),
        HinderedRotor(inertia=(0.155837,'amu*angstrom^2'), symmetry=1, barrier=(3.583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0249376,'amu*angstrom^2'), symmetry=1, barrier=(14.4432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.628189,'amu*angstrom^2'), symmetry=1, barrier=(14.4433,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55185,0.0567478,-5.76168e-05,3.22338e-08,-7.52211e-12,-21314.5,26.9906], Tmin=(100,'K'), Tmax=(1015.79,'K')), NASAPolynomial(coeffs=[9.38399,0.0259068,-1.20754e-05,2.34547e-09,-1.66318e-13,-22905.7,-10.9178], Tmin=(1015.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(C=OCOJ) + radical(CsCsF1sH)"""),
)

species(
    label = 'CC([O])=C[CH]F(702)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u1 p2 c0 {4,S}
3  C u0 p0 c0 {4,S} {7,S} {8,S} {9,S}
...
"""),
    E0 = (-72.3256,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,334,575,1197,1424,3202,1855,455,950,180,376.436],'cm^-1')),
        HinderedRotor(inertia=(0.0382055,'amu*angstrom^2'), symmetry=1, barrier=(13.6844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.595165,'amu*angstrom^2'), symmetry=1, barrier=(13.684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0382267,'amu*angstrom^2'), symmetry=1, barrier=(13.6843,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.043,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38931,0.0600299,-8.00778e-05,5.30389e-08,-1.38136e-11,-8606.92,26.1919], Tmin=(100,'K'), Tmax=(940.618,'K')), NASAPolynomial(coeffs=[12.1201,0.0143965,-7.30599e-06,1.4612e-09,-1.05028e-13,-10625.6,-24.921], Tmin=(940.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.3256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFHH) + group(Cds-OdCsH) + radical(CsCsF1sH) + radical(CCCJ=O)"""),
)
...
"""),
    E0 = (-353.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,365,385,505,600,445,480,1700,1720,235,1215,1347,1486,3221,251.784,1152.07],'cm^-1')),
        HinderedRotor(inertia=(0.00262369,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.387962,'amu*angstrom^2'), symmetry=1, barrier=(18.083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.991596,'amu*angstrom^2'), symmetry=1, barrier=(45.0996,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89502,0.0498744,-4.44169e-05,2.14947e-08,-4.45385e-12,-42495.3,20.56], Tmin=(100,'K'), Tmax=(1109.13,'K')), NASAPolynomial(coeffs=[8.3608,0.026556,-1.28808e-05,2.53922e-09,-1.81258e-13,-43929.6,-11.3034], Tmin=(1109.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-353.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)Cs) + radical(CsCOF1sH)"""),
)
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.651254,0.0790611,-0.000108237,8.28035e-08,-2.57945e-11,-38271.4,26.221], Tmin=(100,'K'), Tmax=(781.553,'K')), NASAPolynomial(coeffs=[10.1962,0.0302019,-1.44477e-05,2.78786e-09,-1.95087e-13,-39763.1,-17.4735], Tmin=(781.553,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-319.167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(=O)C([CH]F)OF(4381)'],
    products = ['HF(38)', 'CH2CO(28)', 'O=C[CH]F(1529)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(45.3693,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC([CH]F)OF(1719)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000538,'m^3/(mol*s)'), n=3.29, Ea=(442.282,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->Cs',), comment="""Estimated from node Root_1COCbCdCsCtHNOSSidSis->Cs_2Br1sCbCdCl1sCsCtF1sHI1sNSSidSis->Cs"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CC(=O)C(F)[CH]OF(4817)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CC(=C[CH]F)OOF(4818)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.62709e+20,'s^-1'), n=-1.9758, Ea=(136.292,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]C(OF)C(C)=O-2(4819)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(181)', 'CC([O])=COF(2591)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', 'CC(=O)C([C]F)OF(4820)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CC(=O)C([CH]F)OF(4381)'],
    products = ['CC1([O])C(F)C1OF(4822)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2.63856e+09,'s^-1'), n=0.755479, Ea=(143.218,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 142.6 to 143.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction10',
    reactants = ['CC(O)=C([CH]F)OF(4382)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(205000,'s^-1'), n=2.37, Ea=(230.587,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(357)', 'CC([O])=C[CH]F(702)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F[CH][CH]OF(1551)', 'CH3CO(34)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(3.45027,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['H(6)', 'CC([O])=C([CH]F)OF(4825)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(9.69248,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C"""),
)

reaction(
    label = 'reaction19',
    reactants = ['CH3(19)', 'O=[C]C([CH]F)OF(4826)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(3.45844,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C"""),
)

reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'CC(=O)C(=O)[CH]F(4828)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(470.569,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction22',
    reactants = ['CHF(40)', 'CC([O])=COF(2591)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(6)', 'CC(=O)C([C]F)OF-2(4829)'],
    products = ['CC(=O)C([CH]F)OF(4381)'],
