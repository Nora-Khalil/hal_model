...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(160)', '[CH2]C(=C)O(1729)'],
    products = ['C=C(O)COF(2840)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OF(396)', 'C=[C]O(142)'],
    products = ['C=C(O)COF(2840)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C=C(O)[CH]OF(3078)'],
    products = ['C=C(O)COF(2840)'],
