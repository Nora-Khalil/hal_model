...
"""),
    ...
    molecularWeight = (86.0461,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28259,0.0502704,-5.59696e-05,2.93815e-08,-5.77239e-12,1385.04,19.3295], Tmin=(100,'K'), Tmax=(1395.92,'K')), NASAPolynomial(coeffs=[15.5041,0.00399053,-2.98809e-07,-4.29143e-11,5.40032e-15,-2046.77,-52.0954], Tmin=(1395.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.6348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(2(co)oxirane) + radical(C=OCOJ) + radical(CJC(O)2C)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C([O])=C=O(1083)'],
    products = ['[CH2]C(=O)C([O])=O(277)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['[O][C]=O(625)', '[CH2][C]=O(140)'],
    products = ['[CH2]C(=O)C([O])=O(277)'],
