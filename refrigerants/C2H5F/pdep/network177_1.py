...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]C([O])=O(157)'],
    products = ['[O]C(=O)C[C]=O(279)'],
    transitionState = 'TS3',
