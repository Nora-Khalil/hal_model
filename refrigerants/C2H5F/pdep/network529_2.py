...
"""),
    E0 = (-112.574,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,334,575,1197,1424,3202,2367.11],'cm^-1')),
        HinderedRotor(inertia=(0.561237,'amu*angstrom^2'), symmetry=1, barrier=(12.9039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116148,'amu*angstrom^2'), symmetry=1, barrier=(2.67047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0782,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(2735.69,'J/mol'), sigma=(4.98576,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=427.31 K, Pc=50.09 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.69871,0.0328158,-0.000109137,2.91804e-07,-2.56755e-10,-13538.8,10.0943], Tmin=(10,'K'), Tmax=(418.487,'K')), NASAPolynomial(coeffs=[1.14027,0.0323784,-1.83493e-05,5.04474e-09,-5.40209e-13,-13106.7,22.8128], Tmin=(418.487,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-112.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""CC[CH]F""", comment="""Thermo library: CHOF_G4"""),
)

species(
    label = '[CH2]C(C)F(1044)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (328.221,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,329.658,329.669,2894.73],'cm^-1')),
        HinderedRotor(inertia=(0.00155174,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00155291,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (42.0797,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.0037,0.0161454,1.44265e-05,-2.62508e-08,1.01941e-11,39516.8,12.6846], Tmin=(100,'K'), Tmax=(1003.27,'K')), NASAPolynomial(coeffs=[6.63828,0.0156477,-5.75064e-06,1.05873e-09,-7.51284e-14,38083.3,-8.37178], Tmin=(1003.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (63.5278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,272.11,277.311,1776.08],'cm^-1')),
        HinderedRotor(inertia=(0.00191671,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0878108,'amu*angstrom^2'), symmetry=1, barrier=(4.82986,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.0702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.92368,0.0228291,-7.50379e-06,-8.76687e-10,6.14089e-13,7680,13.0981], Tmin=(100,'K'), Tmax=(1619.67,'K')), NASAPolynomial(coeffs=[8.18419,0.0160628,-7.00277e-06,1.29015e-09,-8.66538e-14,5159.39,-17.3383], Tmin=(1619.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.5278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-112.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,1359.95],'cm^-1')),
        HinderedRotor(inertia=(0.0950259,'amu*angstrom^2'), symmetry=1, barrier=(4.95294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0950262,'amu*angstrom^2'), symmetry=1, barrier=(4.95295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0782,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.53402,0.0548968,-0.000309337,8.51405e-07,-7.63221e-10,-13515.8,10.2769], Tmin=(10,'K'), Tmax=(393.301,'K')), NASAPolynomial(coeffs=[0.285103,0.033276,-1.83994e-05,4.86729e-09,-4.98105e-13,-12837.4,28.294], Tmin=(393.301,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-112.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""C[CH]CF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (-104.916,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,2420.04],'cm^-1')),
        HinderedRotor(inertia=(0.397074,'amu*angstrom^2'), symmetry=1, barrier=(9.12951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08584,'amu*angstrom^2'), symmetry=1, barrier=(24.9655,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0782,'amu'),
...
"""),
    E0 = (119.574,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2800,2850,1350,1500,750,1050,1375,1000,279.573,941.567,2412.18],'cm^-1')),
        HinderedRotor(inertia=(0.00215397,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151728,'amu*angstrom^2'), symmetry=1, barrier=(8.3939,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.0702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5513,0.0292069,-1.86638e-05,6.08297e-09,-8.08452e-13,14435.6,14.8843], Tmin=(100,'K'), Tmax=(1714.26,'K')), NASAPolynomial(coeffs=[8.96035,0.0142523,-5.57841e-06,9.94156e-10,-6.6327e-14,12238.2,-19.4901], Tmin=(1714.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (-140.599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,212,367,445,1450],'cm^-1')),
        HinderedRotor(inertia=(0.146677,'amu*angstrom^2'), symmetry=1, barrier=(3.3724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146775,'amu*angstrom^2'), symmetry=1, barrier=(3.37464,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0782,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.6965,0.025104,-2.24381e-05,3.19104e-08,-2.03981e-11,-16909.3,9.4717], Tmin=(10,'K'), Tmax=(611.656,'K')), NASAPolynomial(coeffs=[1.59946,0.0308297,-1.68899e-05,4.51172e-09,-4.72621e-13,-16503.3,19.7793], Tmin=(611.656,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-140.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""C[C](C)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CC[CH]F(1043)'],
    products = ['[CH2]C(C)F(1044)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.53e+06,'s^-1'), n=1.73, Ea=(245.601,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [cCs(-HH)CJ;CsJ;CH3]
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C[CH][CH]F(2782)'],
    products = ['CC[CH]F(1043)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0.25075,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C',), comment="""Estimated from node Root_1R->H_N-2R->S_N-2BrCClFHNO-inRing_N-2BrCClFHNO->O_N-2CHN->N_2CH->C_Ext-2C-R_3R!H->F_Ext-2C-R_4R!H->C_Ext-4C-R_N-5R!H->Cl_N-5BrCFINOPSSi->Br_5CF->C"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C[CH]F(848)'],
    products = ['CC[CH]F(1043)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'CC[C]F(2185)'],
    products = ['CC[CH]F(1043)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(2.75,'m^3/(mol*s)'), n=-0.32, Ea=(7.65728,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R->H_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_3R->H_2Br1sCl1sF1s->F1s"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CC[CH]F(1043)'],
    products = ['C[CH]CF(2783)'],
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=CC(347)'],
    products = ['[CH2]C(C)F(1044)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(59.4825,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C=C(C)F(1325)'],
    products = ['[CH2]C(C)F(1044)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(6.34237,'m^3/(mol*s)'), n=2.05558, Ea=(13.4401,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.23022016116873564, var=0.46222678179127447, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_N-4R!H->N_4CClOS->C_2CS->C_Sp-2C=1COS_Sp-4C-1COS_Ext-1COS-R',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_N-2CS-inRing_Ext-1COS-R_N-4R!H-inRing_4R!H-u0_N-4R!H->N_4CClOS->C_2CS->C_Sp-2C=1COS_Sp-4C-1COS_Ext-1COS-R"""),
)

reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2][CH]C(5035)'],
    products = ['[CH2]C(C)F(1044)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C=C(2401)'],
    products = ['[CH2]C(C)F(1044)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(413.898,'m^3/(mol*s)'), n=0.980812, Ea=(235.536,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.7409598738204388, var=13.196736814099648, Tref=1000.0, N=3, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['C[C](C)F(10728)'],
    products = ['[CH2]C(C)F(1044)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(1.293e+12,'s^-1'), n=0, Ea=(184.64,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 440 used for R2H_S;C_rad_out_noH;Cs_H_out_2H
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]CF(2783)'],
    products = ['[CH2]C(C)F(1044)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(149.521,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)
