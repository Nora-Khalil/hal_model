...
"""),
    ...
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09148,0.0591769,-5.78009e-05,2.78534e-08,-5.28093e-12,-31984.7,23.1482], Tmin=(100,'K'), Tmax=(1279.11,'K')), NASAPolynomial(coeffs=[14.9825,0.0157369,-6.85894e-06,1.30253e-09,-9.1567e-14,-35538.3,-47.2876], Tmin=(1279.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-266.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (528.585,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,327.199,327.469,327.937,329.894],'cm^-1')),
        HinderedRotor(inertia=(0.0802046,'amu*angstrom^2'), symmetry=1, barrier=(6.14566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.081519,'amu*angstrom^2'), symmetry=1, barrier=(6.16238,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.381622,'amu*angstrom^2'), symmetry=1, barrier=(28.7208,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.179137,0.0546999,2.14615e-05,-1.04344e-07,5.46483e-11,11537.5,19.6684], Tmin=(100,'K'), Tmax=(906.039,'K')), NASAPolynomial(coeffs=[34.6463,-0.0189069,1.32617e-05,-2.61231e-09,1.71983e-13,2067.29,-161.009], Tmin=(906.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.5554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2sCF) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(CJC(C)OC)"""),
)
...
"""),
    E0 = (179.81,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,2950,3100,1380,975,1025,1650,2175,525,750,770,3400,2100,272.26,273.202,278.24],'cm^-1')),
        HinderedRotor(inertia=(0.104511,'amu*angstrom^2'), symmetry=1, barrier=(5.64352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471814,'amu*angstrom^2'), symmetry=1, barrier=(25.4102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.694345,'amu*angstrom^2'), symmetry=1, barrier=(37.6943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01562,0.0726006,-0.000121034,1.06582e-07,-3.6629e-11,21726.9,21.4608], Tmin=(100,'K'), Tmax=(828.787,'K')), NASAPolynomial(coeffs=[8.73278,0.0239069,-1.21847e-05,2.35842e-09,-1.63006e-13,20840.9,-11.9488], Tmin=(828.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2sCF) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
reaction(
    ...
    products = ['[CH]=COC(=C)OF(2547)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(115.792,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'C#COC(=C)OF(7566)'],
    products = ['[CH]=COC(=C)OF(2547)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH]=COC([CH2])=O(1312)'],
    products = ['[CH]=COC(=C)OF(2547)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(76.8107,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction10',
    reactants = ['[CH]=C[O](452)', 'C=[C]OF(507)'],
    products = ['[CH]=COC(=C)OF(2547)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(7.34997,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(357)', '[CH]=CO[C]=C(625)'],
    products = ['[CH]=COC(=C)OF(2547)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=COC(=C)OF(2547)'],
    products = ['[CH2]C(=O)OC=CF(1616)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(32.0331,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
