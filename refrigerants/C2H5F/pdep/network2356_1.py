...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(3442)', '[CH2]C[C]=C(587)'],
    products = ['C=[C]CC[C](F)F(6687)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(134)', '[CH2]C[C](F)F(3564)'],
    products = ['C=[C]CC[C](F)F(6687)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=[C]CC=C(F)F(6919)'],
    products = ['C=[C]CC[C](F)F(6687)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#CCC[C](F)F(6920)'],
    products = ['C=[C]CC[C](F)F(6687)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH2]C[C]=C(587)'],
    products = ['C=[C]CC[C](F)F(6687)'],
