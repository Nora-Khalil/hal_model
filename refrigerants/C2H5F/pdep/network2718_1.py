...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[CH]=CCOF(8910)'],
    products = ['[CH]=CCC(=O)OF(7220)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OF(174)', '[CH]=CC=C=O(740)'],
    products = ['[CH]=CCC(=O)OF(7220)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H2(23)', '[CH2]C(=O)OF(2532)'],
    products = ['[CH]=CCC(=O)OF(7220)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=CCC([O])=O(7029)'],
    products = ['[CH]=CCC(=O)OF(7220)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(357)', '[CH]=CC[C]=O(626)'],
    products = ['[CH]=CCC(=O)OF(7220)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[CH](272)', '[CH2]C(=O)OF(2532)'],
    products = ['[CH]=CCC(=O)OF(7220)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OF(3602)', '[CH]C=C(7430)'],
    products = ['[CH]=CCC(=O)OF(7220)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH]=C[CH]C(=O)OF(8915)'],
    products = ['[CH]=CCC(=O)OF(7220)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', '[CH]=[C]CC(=O)OF(8916)'],
    products = ['[CH]=CCC(=O)OF(7220)'],
