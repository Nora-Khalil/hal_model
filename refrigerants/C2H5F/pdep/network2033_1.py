...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC=[C]F(5455)'],
    products = ['[CH]=C(C)C=[C]F(6407)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(19)', 'C#CC=[C]F(5487)'],
    products = ['[CH]=C(C)C=[C]F(6407)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[CH]=C(C)C#CF(6625)'],
    products = ['[CH]=C(C)C=[C]F(6407)'],
    transitionState = 'TS7',
