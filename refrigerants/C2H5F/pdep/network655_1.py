...
reaction(
    label = 'reaction13',
    reactants = ['[O][CH]F(1657)', '[CH2]O[O](153)'],
    products = ['[O]OCC([O])F(1492)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[O]O[CH]C=O(1864)'],
    products = ['[O]OCC([O])F(1492)'],
