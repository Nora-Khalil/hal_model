...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C=CF(936)'],
    products = ['[CH]=CC([O])F(2035)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]F(1657)', '[CH]=[CH](135)'],
    products = ['[CH]=CC([O])F(2035)'],
