...
"""),
    ...
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22972,0.0383854,-3.32338e-05,1.49074e-08,-2.7389e-12,-53692.7,17.1865], Tmin=(100,'K'), Tmax=(1278.79,'K')), NASAPolynomial(coeffs=[9.29167,0.0162962,-7.32384e-06,1.39995e-09,-9.82673e-14,-55498.8,-18.62], Tmin=(1278.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-446.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsOsHH) + ring(Cs-Cs(F)-O2s-O2s)"""),
)

species(
    label = 'OC1(F)CO1(1566)',
...
"""),
    ...
    molecularWeight = (78.0424,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.93829,0.0035215,8.43142e-05,-1.54755e-07,8.60104e-11,-58279.2,9.61659], Tmin=(10,'K'), Tmax=(585.624,'K')), NASAPolynomial(coeffs=[2.14701,0.0301384,-2.06988e-05,6.72492e-09,-8.26598e-13,-58316,15.1944], Tmin=(585.624,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-484.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""OC1(F)CO1""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    E0 = (129.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3615,1277.5,1000,277,555,632,360,370,350,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.752316,'amu*angstrom^2'), symmetry=1, barrier=(17.2972,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50206,0.0591529,-8.60137e-05,6.48928e-08,-1.95136e-11,15626.8,24.7796], Tmin=(100,'K'), Tmax=(813.804,'K')), NASAPolynomial(coeffs=[10.0042,0.0173621,-8.98308e-06,1.78769e-09,-1.27199e-13,14243,-14.4863], Tmin=(813.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2sFO) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCOOH)"""),
)

species(
    label = '[O]O[C](O)CF(1568)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
...
"""),
    E0 = (-216.882,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,551,1088,1226,1380,1420,1481,3057,3119,360,370,350,202.299],'cm^-1')),
        HinderedRotor(inertia=(0.261847,'amu*angstrom^2'), symmetry=1, barrier=(7.61134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262248,'amu*angstrom^2'), symmetry=1, barrier=(7.6108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.484115,'amu*angstrom^2'), symmetry=1, barrier=(14.0457,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.0418,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58468,0.0579731,-9.28446e-05,7.94908e-08,-2.68293e-11,-26002.5,22.7936], Tmin=(100,'K'), Tmax=(817.835,'K')), NASAPolynomial(coeffs=[8.2328,0.0189793,-9.4439e-06,1.82044e-09,-1.25917e-13,-26873.3,-6.6183], Tmin=(817.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(ROOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C([O])(O)F(1448)'],
    products = ['[CH2]C(O)(F)O[O](1488)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[O]O[C](O)F(1564)', 'CH2(T)(18)'],
    products = ['[CH2]C(O)(F)O[O](1488)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C=C(O)O[O](187)'],
    products = ['[CH2]C(O)(F)O[O](1488)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(38.8475,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)

reaction(
    label = 'reaction8',
    reactants = ['O2(2)', 'C=C(O)F(498)'],
    products = ['[CH2]C(O)(F)O[O](1488)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(10834.1,'m^3/(mol*s)'), n=0.762578, Ea=(103.942,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_N-4R!H-u0_Ext-1R!H-R
Multiplied by reaction path degeneracy 2.0
Ea raised from 102.4 to 103.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['OH(7)', 'C=C(F)O[O](1327)'],
    products = ['[CH2]C(O)(F)O[O](1488)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O2(2)', '[CH2][C](O)F(1343)'],
    products = ['[CH2]C(O)(F)O[O](1488)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.62995e+14,'m^3/(mol*s)'), n=-2.27223, Ea=(13.3979,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.03642541003782715, var=3.51219038874387, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_3R!H->O_2R->C_N-2C-inRing_Ext-2C-R_Ext-4R!H-R_Sp-5R!H-4R!H
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(163.779,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C](O)OOF(1567)'],
    products = ['[CH2]C(O)(F)O[O](1488)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(81.5084,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[O]O[C](O)CF(1568)'],
    products = ['[CH2]C(O)(F)O[O](1488)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(136.582,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)
