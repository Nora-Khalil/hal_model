...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.12615,0.0417416,-1.85672e-05,2.86556e-09,-9.55876e-14,37501.5,19.1719], Tmin=(100,'K'), Tmax=(2572.29,'K')), NASAPolynomial(coeffs=[32.3684,0.00672935,-4.25012e-06,7.35901e-10,-4.22558e-14,18996.9,-156.26], Tmin=(2572.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cs(C-F)-Cs-Cs) + radical(Tertalkyl) + radical(Cdj(Cs-F1sCsH)(Cd-HH))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.46,'amu*angstrom^2'), symmetry=1, barrier=(33.5684,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.909718,0.0641726,-5.95867e-05,2.86511e-08,-5.52604e-12,19957.6,21.1014], Tmin=(100,'K'), Tmax=(1245.81,'K')), NASAPolynomial(coeffs=[13.9393,0.0223379,-9.21613e-06,1.69648e-09,-1.16981e-13,16711.1,-44.6223], Tmin=(1245.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCddCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.55629,'amu*angstrom^2'), symmetry=1, barrier=(35.7821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55333,'amu*angstrom^2'), symmetry=1, barrier=(35.7142,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55576,'amu*angstrom^2'), symmetry=1, barrier=(35.77,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03849,0.065586,-6.69832e-05,3.73754e-08,-8.51641e-12,19904.2,20.4075], Tmin=(100,'K'), Tmax=(1054.22,'K')), NASAPolynomial(coeffs=[11.3831,0.0263369,-1.11392e-05,2.06195e-09,-1.42362e-13,17723,-30.0458], Tmin=(1054.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([CH2])=C(F)C=C(9589)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31175,0.0477408,-3.17473e-06,-2.94122e-08,1.45537e-11,7306.51,23.893], Tmin=(100,'K'), Tmax=(987.829,'K')), NASAPolynomial(coeffs=[13.2079,0.0257595,-9.56513e-06,1.73964e-09,-1.22701e-13,3678.42,-39.8214], Tmin=(987.829,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.8611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCCF) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CC=CCJ) + radical(C=CC=CCJ)"""),
)

species(
    label = '[CH]=CC(F)C([CH2])=C(9590)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.09014,'amu*angstrom^2'), symmetry=1, barrier=(25.0644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09078,'amu*angstrom^2'), symmetry=1, barrier=(25.0793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09109,'amu*angstrom^2'), symmetry=1, barrier=(25.0864,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19883,0.0637686,-5.60102e-05,2.64438e-08,-5.24196e-12,29656.5,22.6174], Tmin=(100,'K'), Tmax=(1172.54,'K')), NASAPolynomial(coeffs=[10.7362,0.0312326,-1.43876e-05,2.77852e-09,-1.96211e-13,27419.9,-24.913], Tmin=(1172.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(245.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', 'C=[C]C(F)[C]=C(8779)'],
    products = ['[CH2]C(=C)C(F)[C]=C(8584)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(=C)C(F)=C=C(9588)'],
    products = ['[CH2]C(=C)C(F)[C]=C(8584)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C#CC(F)C([CH2])=C(8634)'],
    products = ['[CH2]C(=C)C(F)[C]=C(8584)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(=C)C(F)[C]=C(8584)'],
    products = ['[CH2]C([CH2])=C(F)C=C(9589)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=CC(F)C([CH2])=C(9590)'],
    products = ['[CH2]C(=C)C(F)[C]=C(8584)'],
