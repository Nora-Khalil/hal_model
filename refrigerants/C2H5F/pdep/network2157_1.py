...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', 'C=C[C]C(6174)'],
    products = ['C[C]=CC[C]=O(6101)'],
    transitionState = 'TS3',
