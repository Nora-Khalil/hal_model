...
reaction(
    label = 'reaction2',
    reactants = ['F(37)', 'F[C]C(F)F-2(4996)'],
    products = ['CHF2-CF2(68)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH][C](F)F(7168)'],
    products = ['CHF2-CF2(68)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', 'F[C](F)[C](F)F(7197)'],
    products = ['CHF2-CF2(68)'],
    transitionState = 'TS6',
