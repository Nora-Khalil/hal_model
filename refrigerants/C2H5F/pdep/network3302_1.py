...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32111,0.0597376,-4.95092e-05,2.23317e-08,-4.24507e-12,1905.89,21.2421], Tmin=(100,'K'), Tmax=(1217.27,'K')), NASAPolynomial(coeffs=[10.2572,0.0303738,-1.33258e-05,2.51531e-09,-1.75312e-13,-269.67,-23.6263], Tmin=(1217.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.0511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1685,370,540,610,2055,180],'cm^-1')),
        HinderedRotor(inertia=(1.10848,'amu*angstrom^2'), symmetry=1, barrier=(25.4861,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27264,0.064347,-7.36555e-05,5.0105e-08,-1.44067e-11,30510.3,21.9027], Tmin=(100,'K'), Tmax=(832.084,'K')), NASAPolynomial(coeffs=[8.08514,0.0315991,-1.46228e-05,2.80958e-09,-1.97272e-13,29376.6,-9.71164], Tmin=(832.084,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.08837,'amu*angstrom^2'), symmetry=1, barrier=(25.0239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.07643,'amu*angstrom^2'), symmetry=1, barrier=(47.7413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10268,'amu*angstrom^2'), symmetry=1, barrier=(25.3527,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31224,0.0623055,-7.44583e-05,5.58947e-08,-1.75505e-11,29900.3,22.9729], Tmin=(100,'K'), Tmax=(833.293,'K')), NASAPolynomial(coeffs=[7.1297,0.0312985,-1.30953e-05,2.36356e-09,-1.58857e-13,29037.8,-3.39], Tmin=(833.293,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-CtHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Cds_S)"""),
)

species(
    label = 'C#CC(F)C=[C]C(9430)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.10841,'amu*angstrom^2'), symmetry=1, barrier=(25.4846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10732,'amu*angstrom^2'), symmetry=1, barrier=(25.4594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10873,'amu*angstrom^2'), symmetry=1, barrier=(25.4919,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06777,0.0699247,-9.66812e-05,8.06214e-08,-2.73937e-11,30647.2,22.2341], Tmin=(100,'K'), Tmax=(820.158,'K')), NASAPolynomial(coeffs=[7.07082,0.03296,-1.50167e-05,2.81232e-09,-1.92468e-13,29921.1,-3.96085], Tmin=(820.158,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.659984,'amu*angstrom^2'), symmetry=1, barrier=(15.1743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19023,'amu*angstrom^2'), symmetry=1, barrier=(66.6339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.89941,'amu*angstrom^2'), symmetry=1, barrier=(66.6631,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.1117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82478,0.0435475,-2.68109e-05,6.07074e-09,6.15345e-13,66443.3,20.0465], Tmin=(100,'K'), Tmax=(1008.57,'K')), NASAPolynomial(coeffs=[8.7772,0.0235967,-8.47609e-06,1.44515e-09,-9.5627e-14,64653.2,-15.4762], Tmin=(1008.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(551.759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-CtHHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(CTCC=CCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=C(F)C=[C]C(9432)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {7,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.764461,'amu*angstrom^2'), symmetry=1, barrier=(17.5765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.764267,'amu*angstrom^2'), symmetry=1, barrier=(17.572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.763535,'amu*angstrom^2'), symmetry=1, barrier=(17.5552,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10804,0.0695261,-9.0892e-05,7.72351e-08,-2.79691e-11,40405,24.8765], Tmin=(100,'K'), Tmax=(748.429,'K')), NASAPolynomial(coeffs=[5.86464,0.0388426,-1.88503e-05,3.67009e-09,-2.5822e-13,39840.4,4.29148], Tmin=(748.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=CC(F)[C]=[C]C(9436)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {4,S} {6,S} {8,S}
3  C u0 p0 c0 {7,S} {9,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20831,0.0565741,-3.98325e-05,1.44096e-08,-2.14153e-12,22075.1,24.2345], Tmin=(100,'K'), Tmax=(1547.32,'K')), NASAPolynomial(coeffs=[12.72,0.0268152,-1.09839e-05,1.98018e-09,-1.33316e-13,18512.7,-36.3279], Tmin=(1547.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + radical(C=CC=CCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]C(F)C=CC(9438)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {4,S} {6,S} {8,S}
3  C u0 p0 c0 {5,S} {9,S} {10,S} {11,S}
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', 'C[C]=C[CH]F(6194)'],
    products = ['C=[C]C(F)C=[C]C(8570)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C=C(F)C=[C]C(9428)'],
    products = ['C=[C]C(F)C=[C]C(8570)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=[C]C(F)C#CC(9429)'],
    products = ['C=[C]C(F)C=[C]C(8570)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#CC(F)C=[C]C(9430)'],
    products = ['C=[C]C(F)C=[C]C(8570)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2][C]=CC#CC(9431)'],
    products = ['C=[C]C(F)C=[C]C(8570)'],
