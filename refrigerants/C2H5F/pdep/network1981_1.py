...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC(F)[CH]F(5593)'],
    products = ['C2H2(23)', 'CHFCHF[Z](58)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(837)', '[CH]C=CF(936)'],
    products = ['[CH]=CC(F)[CH]F(5593)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[CH](135)', 'CHFCHF[Z](58)'],
    products = ['[CH]=CC(F)[CH]F(5593)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H2(23)', 'F[CH][CH]F(4261)'],
    products = ['[CH]=CC(F)[CH]F(5593)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C#CC(F)[CH]F(5601)'],
    products = ['[CH]=CC(F)[CH]F(5593)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](135)', 'F[CH][CH]F(4261)'],
    products = ['[CH]=CC(F)[CH]F(5593)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH]=C=C[CH]F(2613)'],
    products = ['[CH]=CC(F)[CH]F(5593)'],
