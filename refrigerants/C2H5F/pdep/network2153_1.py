...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'C=[C]C=[C]C(6249)'],
    products = ['C=C([O])C=[C]C(6097)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(18)', 'C[C]=C[C]=O(6307)'],
    products = ['C=C([O])C=[C]C(6097)'],
