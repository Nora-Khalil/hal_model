...
reaction(
    label = 'reaction1',
    reactants = ['C[C]=CO[CH]F(6385)'],
    products = ['CHFO(47)', 'C#CC(3594)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(181)', 'C[C]=C[O](6480)'],
    products = ['C[C]=CO[CH]F(6385)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(6)', 'C=C=CO[CH]F(6513)'],
    products = ['C[C]=CO[CH]F(6385)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][CH]F(1395)', 'C#CC(3594)'],
    products = ['C[C]=CO[CH]F(6385)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][CH]F(1395)', '[CH]=[C]C(3595)'],
    products = ['C[C]=CO[CH]F(6385)'],
    transitionState = 'TS9',
