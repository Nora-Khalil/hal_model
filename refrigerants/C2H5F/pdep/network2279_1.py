...
"""),
    E0 = (-132.109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2175,525,750,770,3400,2100,180,995.225],'cm^-1')),
        HinderedRotor(inertia=(2.19685,'amu*angstrom^2'), symmetry=1, barrier=(50.51,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107711,'amu*angstrom^2'), symmetry=1, barrier=(76.3442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36953,'amu*angstrom^2'), symmetry=1, barrier=(76.2596,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12543,0.0360047,-1.94593e-05,2.24781e-09,1.05129e-12,-15817.2,18.9767], Tmin=(100,'K'), Tmax=(1134.38,'K')), NASAPolynomial(coeffs=[9.07141,0.0193085,-7.69125e-06,1.39057e-09,-9.50501e-14,-17894.7,-17.6205], Tmin=(1134.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CtOsHH) + group(Cds-OdOsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96356,0.0229098,5.96152e-05,-1.15451e-07,5.3237e-11,18229.4,14.2765], Tmin=(100,'K'), Tmax=(888.338,'K')), NASAPolynomial(coeffs=[21.5238,-0.00591378,8.23564e-06,-1.80865e-09,1.24974e-13,12416.3,-90.933], Tmin=(888.338,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(24dihydro13dioxin) + radical(OCJO) + radical(Cds_S)"""),
)

species(
    label = '[CH]=C=COC[O](6577)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
2  O u1 p2 c0 {3,S}
...
"""),
    E0 = (412.269,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2175,525,352.929,354.532,354.872,355.46,1593.58],'cm^-1')),
        HinderedRotor(inertia=(0.00133956,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.754838,'amu*angstrom^2'), symmetry=1, barrier=(66.9963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.749634,'amu*angstrom^2'), symmetry=1, barrier=(67,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78563,0.0488115,-5.31929e-05,3.27836e-08,-8.21319e-12,49664.1,20.9525], Tmin=(100,'K'), Tmax=(968.494,'K')), NASAPolynomial(coeffs=[8.93618,0.0192792,-7.45371e-06,1.29912e-09,-8.60986e-14,48279.1,-13.3159], Tmin=(968.494,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CtOsHH) + group(Cs-OsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(OCOJ) + radical(Acetyl)"""),
)

species(
    label = '[C]#CCO[CH]O(7043)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {3,S} {4,S}
...
"""),
    E0 = (373.831,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2175,525,312.335,312.336,312.338,312.338],'cm^-1')),
        HinderedRotor(inertia=(0.00172805,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0877863,'amu*angstrom^2'), symmetry=1, barrier=(6.07713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0877868,'amu*angstrom^2'), symmetry=1, barrier=(6.07717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.934102,'amu*angstrom^2'), symmetry=1, barrier=(64.6642,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10814,0.0689625,-0.000113077,9.2958e-08,-2.86285e-11,45060.7,22.6956], Tmin=(100,'K'), Tmax=(958.419,'K')), NASAPolynomial(coeffs=[9.82445,0.0165194,-5.85652e-06,8.868e-10,-5.00097e-14,44127.8,-15.1361], Tmin=(958.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CtOsHH) + group(Cs-OsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(OCJO) + radical(Acetyl)"""),
)
...
"""),
    E0 = (205.035,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2175,525,779.591,779.638,779.706],'cm^-1')),
        HinderedRotor(inertia=(0.11985,'amu*angstrom^2'), symmetry=1, barrier=(2.75558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.56526,'amu*angstrom^2'), symmetry=1, barrier=(58.9804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.56529,'amu*angstrom^2'), symmetry=1, barrier=(58.981,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0653,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33938,0.0373053,-3.42917e-05,1.93318e-08,-4.69939e-12,24719.1,18.9512], Tmin=(100,'K'), Tmax=(969.421,'K')), NASAPolynomial(coeffs=[6.40026,0.0205495,-8.36547e-06,1.5026e-09,-1.01512e-13,23931.8,-0.514092], Tmin=(969.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(205.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CtOsHH) + group(Cds-OdOsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    E0 = (60.663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,180,180,1583.57],'cm^-1')),
        HinderedRotor(inertia=(0.918911,'amu*angstrom^2'), symmetry=1, barrier=(21.1276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.507805,'amu*angstrom^2'), symmetry=1, barrier=(11.6754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.22422,'amu*angstrom^2'), symmetry=1, barrier=(51.1392,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0732,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07299,0.0485021,-4.91054e-05,1.61162e-08,7.66073e-12,7359.53,17.865], Tmin=(100,'K'), Tmax=(543.808,'K')), NASAPolynomial(coeffs=[6.30796,0.0264007,-1.31026e-05,2.5786e-09,-1.82891e-13,6765.13,-1.21672], Tmin=(543.808,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cd)OsHH) + group(Cds-CdsCsH) + group(Cds-OdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#CCOC=O(6079)'],
    products = ['CO2(14)', 'C=C=C(6556)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.66316e+09,'s^-1'), n=1.02661, Ea=(178.457,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=3.6261064499336317, var=38.37240951049941, Tref=1000.0, N=4, data_mean=0.0, correlation='Root_1R!H->C_N-2R!H->C',), comment="""Estimated from node Root_1R!H->C_N-2R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C#CCO(7040)'],
    products = ['C#CCOC=O(6079)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COC=O(2373)'],
    products = ['C#CCOC=O(6079)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C=O(147)', '[CH]=C=C(4381)'],
    products = ['C#CCOC=O(6079)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[C]=CCOC=O(7045)'],
    products = ['C#CCOC=O(6079)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(1.20443e+17,'s^-1'), n=-1.43042, Ea=(39.1923,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.514991623114097, var=15.884634944160005, Tref=1000.0, N=7, data_mean=0.0, correlation='CCH',), comment="""Estimated from node CCH"""),
)
