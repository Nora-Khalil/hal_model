...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C](F)F(3454)', '[CH]C-2(137)'],
    products = ['C[CH]OO[C](F)F(7418)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3442)', 'C[CH]O[O](158)'],
    products = ['C[CH]OO[C](F)F(7418)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['[O][C](F)F(4247)', 'CH3CHO(36)'],
    products = ['C[CH]OO[C](F)F(7418)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][C](F)F(4247)', 'C[CH][O](174)'],
    products = ['C[CH]OO[C](F)F(7418)'],
    transitionState = 'TS9',
