...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.398547,'amu*angstrom^2'), symmetry=1, barrier=(9.16339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.398467,'amu*angstrom^2'), symmetry=1, barrier=(9.16153,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09546,0.0694625,-7.33771e-05,4.53622e-08,-1.20503e-11,-18403,23.8164], Tmin=(100,'K'), Tmax=(887.551,'K')), NASAPolynomial(coeffs=[8.41923,0.0364547,-1.75904e-05,3.45764e-09,-2.46422e-13,-19703,-10.6427], Tmin=(887.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cds-CdsCsH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (84.0009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,145,326,398,834,1303,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,540,610,2055,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.980739,'amu*angstrom^2'), symmetry=1, barrier=(22.5491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.982494,'amu*angstrom^2'), symmetry=1, barrier=(22.5895,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.754391,0.0780122,-0.000113629,9.74491e-08,-3.42006e-11,10213.5,25.4939], Tmin=(100,'K'), Tmax=(774.748,'K')), NASAPolynomial(coeffs=[7.79682,0.0349475,-1.72693e-05,3.36206e-09,-2.35562e-13,9323.49,-5.38572], Tmin=(774.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.0009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cds-CdsCsH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)

species(
    label = 'C#CC(F)C(F)[C]=C(9501)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (80.0723,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([164,312,561,654,898,1207,1299,3167,233,378,609,1068,1270,1314,3037,2950,3100,1380,975,1025,1650,1685,370,2175,525,750,770,3400,2100,180],'cm^-1')),
        HinderedRotor(inertia=(0.634751,'amu*angstrom^2'), symmetry=1, barrier=(14.5942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.38059,'amu*angstrom^2'), symmetry=1, barrier=(54.7345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.830939,'amu*angstrom^2'), symmetry=1, barrier=(19.1049,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.83632,0.0770237,-9.62182e-05,5.85988e-08,-9.65253e-12,9737.43,24.6985], Tmin=(100,'K'), Tmax=(614.006,'K')), NASAPolynomial(coeffs=[9.70736,0.031492,-1.49354e-05,2.86317e-09,-1.99406e-13,8416.96,-15.6541], Tmin=(614.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.0723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cdj(Cs-F1sCsH)(Cd-HH))"""),
)
...
"""),
    E0 = (359.281,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,250,446,589,854,899,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,540,610,2055,180],'cm^-1')),
        HinderedRotor(inertia=(1.77911,'amu*angstrom^2'), symmetry=1, barrier=(40.9053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77886,'amu*angstrom^2'), symmetry=1, barrier=(40.8994,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1021,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32066,0.0554232,-4.64474e-05,2.02179e-08,-3.57828e-12,43310.8,22.881], Tmin=(100,'K'), Tmax=(1335.87,'K')), NASAPolynomial(coeffs=[12.3367,0.0224379,-9.4094e-06,1.73409e-09,-1.19155e-13,40367.6,-33.4552], Tmin=(1335.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCCF) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CC=CCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=C(F)C(F)[C]=C(9503)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938328,0.0728783,-8.17925e-05,5.33814e-08,-1.4766e-11,5079.34,25.823], Tmin=(100,'K'), Tmax=(860.626,'K')), NASAPolynomial(coeffs=[8.90758,0.0358391,-1.72364e-05,3.37457e-09,-2.39716e-13,3707.63,-11.4279], Tmin=(860.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.3553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(F)C(F)[C]=C(9504)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {9,S}
...
"""),
    E0 = (161.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,164,312,561,654,898,1207,1299,3167,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.563643,'amu*angstrom^2'), symmetry=1, barrier=(12.9593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562071,'amu*angstrom^2'), symmetry=1, barrier=(12.9231,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562627,'amu*angstrom^2'), symmetry=1, barrier=(12.9359,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.704166,0.0792306,-0.000103115,7.92745e-08,-2.56444e-11,19502.6,27.9282], Tmin=(100,'K'), Tmax=(744.251,'K')), NASAPolynomial(coeffs=[8.49119,0.0373792,-1.87662e-05,3.71922e-09,-2.64949e-13,18343.5,-7.33966], Tmin=(744.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=C(F)C(F)C=C(9505)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {9,S}
...
"""),
    ...
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11899,0.0671865,-6.20313e-05,3.1177e-08,-6.62668e-12,5529.83,26.3164], Tmin=(100,'K'), Tmax=(1095.19,'K')), NASAPolynomial(coeffs=[10.3332,0.0335331,-1.59387e-05,3.11946e-09,-2.21968e-13,3511.57,-18.9747], Tmin=(1095.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.1417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cdj(Cs-HHH)(Cd-CsF1s))"""),
)

species(
    label = '[CH]=[C]C(F)C(F)C=C(9506)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]C(F)C(F)[C]=C(8640)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=[C]C(F)C(F)[C]=C(8640)'],
    products = ['[CH2]C(=CF)C(F)[C]=C(8638)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', 'C=[C]C(F)[CH]F(5567)'],
    products = ['C=[C]C(F)C(F)[C]=C(8640)'],
    transitionState = 'TS3',
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.31566e-11,'m^3/(mol*s)'), n=4.71246, Ea=(32.9284,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction11',
    reactants = ['F2(77)', '[CH2][C]=CC=C=C(8287)'],
    products = ['C=[C]C(F)C(F)[C]=C(8640)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(21.7255,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2][C]=C(F)C=C=C(9502)'],
    products = ['C=[C]C(F)C(F)[C]=C(8640)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(300.648,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['C=[C]C(F)C(F)[C]=C(8640)'],
    products = ['[CH2]C=C(F)C(F)[C]=C(9503)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC(F)C(F)[C]=C(9504)'],
    products = ['C=[C]C(F)C(F)[C]=C(8640)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]C(F)C(F)[C]=C(8640)'],
    products = ['[CH2][C]=C(F)C(F)C=C(9505)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]C(F)C(F)C=C(9506)'],
    products = ['C=[C]C(F)C(F)[C]=C(8640)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.01526e+12,'s^-1'), n=0.18834, Ea=(126.043,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(176.53,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)
