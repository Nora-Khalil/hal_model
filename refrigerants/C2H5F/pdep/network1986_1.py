...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)C[O](6361)'],
    products = ['CH2O(20)', 'C#CC(3594)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[O](426)'],
    products = ['[CH]=C(C)C[O](6361)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](318)', '[CH]=[C]C(3595)'],
    products = ['[CH]=C(C)C[O](6361)'],
