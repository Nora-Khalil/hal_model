...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(2070)', '[C]=C(134)'],
    products = ['C=[C]OC([O])F(2039)'],
    transitionState = 'TS2',
