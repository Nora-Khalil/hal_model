...
reaction(
    label = 'reaction5',
    reactants = ['H2(8)', 'F[C]CC(F)OF(2327)'],
    products = ['FCCC(F)OF(2309)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]CC(F)OF(2190)'],
    products = ['FCCC(F)OF(2309)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(160)', 'F[CH]CCF(1889)'],
    products = ['FCCC(F)OF(2309)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[CH]OF(1980)', 'CH2F-CH2(61)'],
    products = ['FCCC(F)OF(2309)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2F(46)', '[CH2]C(F)OF(1355)'],
    products = ['FCCC(F)OF(2309)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'FC[CH]C(F)OF(2329)'],
    products = ['FCCC(F)OF(2309)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'F[CH]CC(F)OF(2331)'],
    products = ['FCCC(F)OF(2309)'],
...
reaction(
    label = 'reaction21',
    reactants = ['FCCC(F)OF(2309)'],
    products = ['F2(77)', 'CHFO(47)', 'C2H4(30)'],
