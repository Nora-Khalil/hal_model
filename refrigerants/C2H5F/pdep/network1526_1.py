...
reaction(
    label = 'reaction3',
    reactants = ['F[C]1CC=[C]O1(5600)'],
    products = ['C#COC(=C)F(1456)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(25)', 'C#C[O+]=[C-]F(5608)'],
    products = ['C#COC(=C)F(1456)'],
