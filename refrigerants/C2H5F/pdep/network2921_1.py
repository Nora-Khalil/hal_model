...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)(F)CF(8194)'],
    products = ['HF(38)', 'CF2O(49)', 'CH2CF2(56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(F)(F)CF(4885)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(41)', 'OC(F)(F)[C]F(7978)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OC(F)(F)F(4942)', 'F[C]CF(1082)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OF(169)', 'F[C]C(F)(F)CF(5084)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'OC(F)(F)C(F)(F)[C]F(8223)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'OC(F)(F)C(F)F(8170)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'OC(F)(F)C(F)(F)F(8224)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'OC(F)(F)[C](F)CF(8177)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O[C](F)C(F)(F)CF(5093)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(F)(F)C(O)(F)F(8226)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'FCC(F)(F)[C](F)F(8227)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(F)(F)C(F)(F)CF(8228)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O[C](F)F(4999)', 'CH2F-CF2(67)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2F(46)', 'OC(F)(F)[C](F)F(8212)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OC(F)(F)C(F)(F)[CH]F(8229)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C(F)C(F)(F)CF(8230)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
reaction(
    label = 'reaction21',
    reactants = ['F2(77)', 'OC(F)=C(F)CF(5096)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(77)', 'C=C(F)C(O)(F)F(7560)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'OC(F)(F)C(F)=CF(7887)'],
    products = ['OC(F)(F)C(F)(F)CF(8194)'],
...
network(
    ...
    isomers = [
        'OC(F)(F)C(F)(F)CF(8194)',
    ],
    reactants = [
        ('HF(38)', 'CF2O(49)', 'CH2CF2(56)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
