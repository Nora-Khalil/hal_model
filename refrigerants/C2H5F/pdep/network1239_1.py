...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C=C(F)OO(494)'],
    products = ['C=C(F)OOC=O(3800)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['HCO(15)', 'C=C(F)O[O](490)'],
    products = ['C=C(F)OOC=O(3800)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[CH]=C(F)OOC=O(3827)'],
    products = ['C=C(F)OOC=O(3800)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'C=C(F)OO[C]=O(3630)'],
    products = ['C=C(F)OOC=O(3800)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(25)', 'O=CO[O+]=[C-]F(3830)'],
    products = ['C=C(F)OOC=O(3800)'],
