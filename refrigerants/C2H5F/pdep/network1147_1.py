...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(136)', '[CH2]C[O](171)'],
    products = ['[CH2]CO[C]=O(3601)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=O(864)'],
    products = ['[CH2]CO[C]=O(3601)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(3667)', '[CH2][CH2](132)'],
    products = ['[CH2]CO[C]=O(3601)'],
