...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', 'C=C[C]F(2573)'],
    products = ['O=[C]CC=[C]F(2547)'],
    transitionState = 'TS3',
