...
"""),
    E0 = (-213.087,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([615,860,1140,1343,3152,1685,370,180,180,180,358.445,795.085,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.150908,'amu*angstrom^2'), symmetry=1, barrier=(3.46967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150908,'amu*angstrom^2'), symmetry=1, barrier=(3.46967,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95721,0.0495911,-6.81197e-05,5.05638e-08,-1.5399e-11,-25559.1,22.4631], Tmin=(100,'K'), Tmax=(794.197,'K')), NASAPolynomial(coeffs=[8.02192,0.019046,-1.04292e-05,2.13707e-09,-1.55039e-13,-26522.4,-5.39816], Tmin=(794.197,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-213.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(OC=OOJ) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79559,0.0358382,-4.84992e-06,-2.71492e-08,1.42354e-11,-61410.5,15.65], Tmin=(100,'K'), Tmax=(999.3,'K')), NASAPolynomial(coeffs=[16.8354,0.00494609,-2.47415e-06,6.16283e-10,-5.36027e-14,-65879.8,-64.2202], Tmin=(999.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-511.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsCsCs) + group(Cds-OdOsOs) + group(CdCFH) + ring(Cyclobutane)"""),
)

species(
    label = 'FC=[C]O[C]1OO1(7883)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30119,0.0519993,-6.02284e-05,3.28573e-08,-6.76793e-12,18380.4,22.4773], Tmin=(100,'K'), Tmax=(1275.68,'K')), NASAPolynomial(coeffs=[15.5877,0.00436141,-8.72697e-07,9.22226e-11,-4.65357e-15,14966.6,-49.0192], Tmin=(1275.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsOsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + ring(dioxirane) + radical(Cs_P) + radical(Cdj(Cd-F1sH)(O2s-Cs))"""),
)

species(
    label = 'O=C1O[C]([CH]F)O1(7824)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {7,S}
2 O u0 p2 c0 {5,S} {6,S}
3 O u0 p2 c0 {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09313,0.0300326,5.23456e-06,-3.15141e-08,1.41525e-11,-34174.3,20.7478], Tmin=(100,'K'), Tmax=(1029.43,'K')), NASAPolynomial(coeffs=[14.4712,0.00949674,-5.00144e-06,1.12214e-09,-8.91828e-14,-38183.2,-46.421], Tmin=(1029.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(Cds-OdOsOs) + ring(Cyclobutane) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-158.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,239,401,1367,487.177,487.193,487.194,487.196,487.196,487.219,487.223,487.226],'cm^-1')),
        HinderedRotor(inertia=(0.000710198,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000710231,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.029,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14376,0.0415211,-4.31694e-05,2.10492e-08,-4.06768e-12,-19013.6,18.4271], Tmin=(100,'K'), Tmax=(1238.09,'K')), NASAPolynomial(coeffs=[11.4524,0.0114469,-6.73305e-06,1.42953e-09,-1.05985e-13,-21318.6,-28.4697], Tmin=(1238.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-OdOsOs) + group(Ct-CtOs) + group(CtCF) + radical(OC=OOJ)"""),
)
...
"""),
    E0 = (-197.873,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1685,370,167,640,1190,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    molecularWeight = (104.036,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52114,0.0595519,-8.85526e-05,6.66978e-08,-2.00221e-11,-23713.9,23.9149], Tmin=(100,'K'), Tmax=(814.103,'K')), NASAPolynomial(coeffs=[10.252,0.0166523,-9.50644e-06,1.96486e-09,-1.42776e-13,-25135.4,-16.4105], Tmin=(814.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-197.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=CJO) + radical(Cdj(Cd-O2sH)(F1s))"""),
)

species(
    label = '[CH]=[C]OC(=O)OF(7602)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {5,S} {6,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(3622)', '[C]=CF(1436)'],
    products = ['[O]C(=O)O[C]=CF(7775)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(=O)O[C]=CF(7775)'],
    products = ['FC=[C]O[C]1OO1(7883)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(365.05,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_O]
Euclidian distance = 2.449489742783178
family: Intra_R_Add_Endocyclic
Ea raised from 364.9 to 365.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)O[C]=CF(7775)'],
    products = ['O=C1O[C]([CH]F)O1(7824)'],
    transitionState = 'TS6',
...
reaction(
    ...
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.241e+10,'s^-1'), n=0.754, Ea=(176.205,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cddouble] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cddouble]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
Ea raised from 175.5 to 176.2 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['[O]C(=O)O[C]=CF(7775)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(153.031,'m^3/(mol*s)'), n=1.16366, Ea=(38.8116,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.022037706214473284, var=2.3701416358838845, Tref=1000.0, N=230, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#COC([O])=O(3745)'],
    products = ['[O]C(=O)O[C]=CF(7775)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', '[O]C(=O)OC#CF(7885)'],
    products = ['[O]C(=O)O[C]=CF(7775)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(3.18968,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction13',
    reactants = ['[O]C(=O)OC=[C]F(7886)'],
    products = ['[O]C(=O)O[C]=CF(7775)'],
