...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]OO[O](541)'],
    products = ['O=O(150)', 'CH3CHO(36)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](161)', '[CH]C-2(137)'],
    products = ['C[CH]OO[O](541)'],
    transitionState = 'TS2',
