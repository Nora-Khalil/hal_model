...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)(F)OF(7903)', 'CH2(S)(25)'],
    products = ['FCOC(F)(F)OF(7533)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'FCO[C](F)OF(2978)'],
    products = ['FCOC(F)(F)OF(7533)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OC(F)(F)OF(7902)'],
    products = ['FCOC(F)(F)OF(7533)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)OCF(7904)'],
    products = ['FCOC(F)(F)OF(7533)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FO[C](F)F(7422)', '[O]CF(397)'],
    products = ['FCOC(F)(F)OF(7533)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)OF(7901)', 'CH2F(46)'],
    products = ['FCOC(F)(F)OF(7533)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(160)', 'FCO[C](F)F(7450)'],
    products = ['FCOC(F)(F)OF(7533)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]OC(F)(F)OF(7905)'],
    products = ['FCOC(F)(F)OF(7533)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F2(77)', 'O=C(F)OCF(2108)'],
    products = ['FCOC(F)(F)OF(7533)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FCOC(F)(F)OF(7533)'],
    products = ['F2(77)', 'CF2O(49)', 'CH2O(20)'],
