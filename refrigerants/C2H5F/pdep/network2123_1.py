...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC(F)[CH]F(5523)'],
    products = ['O=O(150)', 'CHFCHF[Z](58)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', '[O]O[CH]F(919)'],
    products = ['[O]OC(F)[CH]F(5523)'],
    transitionState = 'TS3',
