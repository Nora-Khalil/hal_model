...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COC=C(421)'],
    products = ['C#COC(=C)C(6103)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C#COC([CH2])=C(6785)'],
    products = ['C#COC(=C)C(6103)'],
