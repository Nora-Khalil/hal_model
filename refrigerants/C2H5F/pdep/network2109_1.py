...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(271)', '[CH]C=C(429)'],
    products = ['[CH]=CC[C]=C(6908)'],
    transitionState = 'TS3',
