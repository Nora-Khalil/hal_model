...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CO[CH2](362)'],
    products = ['[CH]=C(C)O[CH2](6091)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]=C(C)[O](1728)'],
    products = ['[CH]=C(C)O[CH2](6091)'],
    transitionState = 'TS3',
