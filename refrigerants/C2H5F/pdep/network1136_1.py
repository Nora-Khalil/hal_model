...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(=C)F(2580)'],
    products = ['[CH]=C(F)C[O](2536)'],
    transitionState = 'TS2',
