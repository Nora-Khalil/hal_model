...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(136)', '[CH]C(=O)F(502)'],
    products = ['[CH]=C(F)O[C]=O(5478)'],
    transitionState = 'TS2',
