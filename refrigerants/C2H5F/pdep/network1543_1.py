...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]CC[C](F)F(4454)'],
    products = ['[CH2]C(F)(F)C[CH]F(4453)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(3442)', '[CH2]C[CH]F(848)'],
    products = ['F[CH]CC[C](F)F(4454)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(837)', '[CH2]C[C](F)F(3564)'],
    products = ['F[CH]CC[C](F)F(4454)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.04495e+06,'m^3/(mol*s)'), n=0.382229, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]CC=C(F)F(4494)'],
    products = ['F[CH]CC[C](F)F(4454)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'FC=CC[C](F)F(4495)'],
    products = ['F[CH]CC[C](F)F(4454)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CF2(43)', '[CH2]C[CH]F(848)'],
    products = ['F[CH]CC[C](F)F(4454)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C[C](F)F(3564)'],
    products = ['F[CH]CC[C](F)F(4454)'],
