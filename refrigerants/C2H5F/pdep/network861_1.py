...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(F)O[CH]O(2497)'],
    products = ['C=C(F)OCO(1032)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', 'C=C(F)O[CH]O(2059)'],
    products = ['C=C(F)OCO(1032)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(25)', 'OC[O+]=[C-]F(2502)'],
    products = ['C=C(F)OCO(1032)'],
