...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CO[O](430)'],
    products = ['O=O(150)', 'C2H2(23)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]=C[O](132)'],
    products = ['[CH]=CO[O](430)'],
    transitionState = 'TS2',
