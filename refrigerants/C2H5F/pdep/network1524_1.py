...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(136)', 'C=C[C]F(5366)'],
    products = ['O=[C]CC=[C]F(5461)'],
    transitionState = 'TS3',
