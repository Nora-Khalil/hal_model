...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[C]=C(4436)'],
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=[C]OC(=C)F(1160)'],
    products = ['[CH2]C(F)(F)O[C]=C(4436)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C#COC([CH2])(F)F(4574)'],
    products = ['[CH2]C(F)(F)O[C]=C(4436)'],
    transitionState = 'TS8',
