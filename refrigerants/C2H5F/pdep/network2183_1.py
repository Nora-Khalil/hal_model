...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)C[CH]F(6125)'],
    products = ['CH2CHF(55)', 'C#CC(4975)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[CH]F(928)'],
    products = ['[CH]=C(C)C[CH]F(6125)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(837)', '[CH]C(=C)C(6159)'],
    products = ['[CH]=C(C)C[CH]F(6125)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CHF(55)', '[CH]=[C]C(4976)'],
    products = ['[CH]=C(C)C[CH]F(6125)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(C)C=CF(6162)'],
    products = ['[CH]=C(C)C[CH]F(6125)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]F(839)', 'C#CC(4975)'],
    products = ['[CH]=C(C)C[CH]F(6125)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'C#CC[CH]F(932)'],
    products = ['[CH]=C(C)C[CH]F(6125)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]F(839)', '[CH]=[C]C(4976)'],
    products = ['[CH]=C(C)C[CH]F(6125)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[CH]C(=C)C(6159)'],
    products = ['[CH]=C(C)C[CH]F(6125)'],
