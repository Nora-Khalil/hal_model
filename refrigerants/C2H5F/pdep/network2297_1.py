...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(134)', 'C=[C]C[O](689)'],
    products = ['C=[C]CO[C]=C(6650)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', '[CH2]O[C]=C(604)'],
    products = ['C=[C]CO[C]=C(6650)'],
    transitionState = 'TS3',
