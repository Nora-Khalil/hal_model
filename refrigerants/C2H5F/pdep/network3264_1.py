...
"""),
    E0 = (-274.423,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,548,1085,1183,1302,1466,1520,3060,3119,2175,525,239,401,1367,263.631,264.621,265.752,267.051],'cm^-1')),
        HinderedRotor(inertia=(0.259251,'amu*angstrom^2'), symmetry=1, barrier=(13.2486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00846351,'amu*angstrom^2'), symmetry=1, barrier=(45.8395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00845981,'amu*angstrom^2'), symmetry=1, barrier=(45.8291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62537,0.0572793,-7.99922e-05,6.90094e-08,-2.43647e-11,-32924.9,22.3244], Tmin=(100,'K'), Tmax=(807.709,'K')), NASAPolynomial(coeffs=[5.72886,0.0292946,-1.37907e-05,2.62214e-09,-1.81077e-13,-33337.8,4.9511], Tmin=(807.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-274.423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CtOsHH) + group(CsFHHO) + group(Ct-CtCs) + group(CtCF)"""),
)
...
"""),
    E0 = (-213.373,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,2175,525,239,401,1367,241.606,241.63,2051.77],'cm^-1')),
        HinderedRotor(inertia=(0.352607,'amu*angstrom^2'), symmetry=1, barrier=(14.6101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.856303,'amu*angstrom^2'), symmetry=1, barrier=(35.4817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (162.486,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,548,1085,1183,1302,1466,1520,3060,3119,2175,525,180,180,760.978,4000],'cm^-1')),
        HinderedRotor(inertia=(4.39263,'amu*angstrom^2'), symmetry=1, barrier=(100.995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.39446,'amu*angstrom^2'), symmetry=1, barrier=(101.037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.39923,'amu*angstrom^2'), symmetry=1, barrier=(101.147,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81488,0.052464,-7.53283e-05,6.29986e-08,-2.06398e-11,19617,20.0645], Tmin=(100,'K'), Tmax=(900.723,'K')), NASAPolynomial(coeffs=[6.08994,0.0232218,-9.54896e-06,1.66949e-09,-1.08509e-13,19263,2.19647], Tmin=(900.723,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CtOsHH) + group(CsFHHO) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.22495,'amu*angstrom^2'), symmetry=1, barrier=(28.164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22896,'amu*angstrom^2'), symmetry=1, barrier=(28.2563,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.519159,0.0612095,-6.40673e-05,3.13076e-08,-5.70166e-12,-22440.1,23.9838], Tmin=(100,'K'), Tmax=(1528.01,'K')), NASAPolynomial(coeffs=[19.0331,0.00450357,-3.11628e-07,-3.81517e-11,4.30034e-15,-27136.1,-70.0369], Tmin=(1528.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsFHHO) + group(Cds-CdsOsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cdj(Cdd-Cd)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01859,'amu*angstrom^2'), symmetry=1, barrier=(23.4194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01965,'amu*angstrom^2'), symmetry=1, barrier=(23.4438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01856,'amu*angstrom^2'), symmetry=1, barrier=(23.4187,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.77925,0.0792374,-0.00013389,1.20619e-07,-4.23033e-11,-22083.8,21.643], Tmin=(100,'K'), Tmax=(828.536,'K')), NASAPolynomial(coeffs=[8.24706,0.0282484,-1.45381e-05,2.82712e-09,-1.95917e-13,-22808.6,-9.88647], Tmin=(828.536,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cd)OsHH) + group(CsFHHO) + group(CdCCF) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'FC#COCF(9940)'],
    products = ['FC#CCOCF(8535)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'FC#CCOF(9941)'],
    products = ['FC#CCOCF(8535)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH2]OCC#CF(8767)'],
    products = ['FC#CCOCF(8535)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]CF(397)', '[CH2]C#CF(8406)'],
    products = ['FC#CCOCF(8535)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2F(46)', '[O]CC#CF(2645)'],
    products = ['FC#CCOCF(8535)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[C]#CF(2523)', '[CH2]OCF(1885)'],
    products = ['FC#CCOCF(8535)'],
    transitionState = 'TS9',
