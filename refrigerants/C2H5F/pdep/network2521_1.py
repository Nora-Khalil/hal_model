...
reaction(
    label = 'reaction1',
    reactants = ['CF2(43)', 'CH2CF2(56)'],
    products = ['FC(F)=CC(F)F(4907)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['HF(38)', 'F[C]C=C(F)F-2(5936)'],
    products = ['FC(F)=CC(F)F(4907)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['FC(F)=CC(F)F(4907)'],
    products = ['FC=CC(F)(F)F(7124)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'F[CH]C=C(F)F(4388)'],
    products = ['FC(F)=CC(F)F(4907)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'F[C]=CC(F)F(3450)'],
    products = ['FC(F)=CC(F)F(4907)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C](F)C=C(F)F(7137)'],
    products = ['FC(F)=CC(F)F(4907)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FC(F)=[C]C(F)F(7201)'],
    products = ['FC(F)=CC(F)F(4907)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'FC=C=C(F)F(5934)'],
    products = ['FC(F)=CC(F)F(4907)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'FC#CC(F)F(4383)'],
    products = ['FC(F)=CC(F)F(4907)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CF2(43)', '[CH]C(F)F-2(4412)'],
    products = ['FC(F)=CC(F)F(4907)'],
