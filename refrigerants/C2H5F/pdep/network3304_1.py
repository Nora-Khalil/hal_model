...
"""),
    E0 = (304.575,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,113,247,382,1207,3490,540,610,2055,542.687,542.906,543.111,543.82],'cm^-1')),
        HinderedRotor(inertia=(0.249784,'amu*angstrom^2'), symmetry=1, barrier=(52.1451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24884,'amu*angstrom^2'), symmetry=1, barrier=(52.1402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57025,0.0436431,-2.80858e-06,-2.29262e-08,1.05572e-11,34456.5,21.7383], Tmin=(100,'K'), Tmax=(1041.63,'K')), NASAPolynomial(coeffs=[11.0813,0.0283497,-1.13578e-05,2.11277e-09,-1.48746e-13,31323.4,-30.0631], Tmin=(1041.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cs(F)-Cs-Cs) + radical(Allyl_T) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C1=C(C)[CH]C1F(9402)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.650961,'amu*angstrom^2'), symmetry=1, barrier=(14.9669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.651509,'amu*angstrom^2'), symmetry=1, barrier=(14.9795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.651913,'amu*angstrom^2'), symmetry=1, barrier=(14.9888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.806406,'amu*angstrom^2'), symmetry=1, barrier=(18.5409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800213,'amu*angstrom^2'), symmetry=1, barrier=(18.3985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.79971,'amu*angstrom^2'), symmetry=1, barrier=(18.3869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.693204,0.0720101,-7.3717e-05,3.97705e-08,-8.63962e-12,40703.4,23.524], Tmin=(100,'K'), Tmax=(1110.11,'K')), NASAPolynomial(coeffs=[13.5999,0.025505,-1.08798e-05,2.03493e-09,-1.41636e-13,37837.8,-40.0919], Tmin=(1110.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6241,0.0380989,2.15031e-05,-5.27226e-08,2.19004e-11,24293.1,21.0368], Tmin=(100,'K'), Tmax=(1001.28,'K')), NASAPolynomial(coeffs=[13.2225,0.0254742,-1.00839e-05,1.93196e-09,-1.40922e-13,20280.7,-43.372], Tmin=(1001.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(Csj(Cd-CsCd)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC([CH2])=CF(8473)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(C)C([CH2])=CF(8572)'],
    products = ['[CH]=C=C([CH2])C(C)F(9399)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', '[CH]C(C)=C=CF(6360)'],
    products = ['[CH]=C(C)C([CH2])=CF(8572)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(C)C([CH2])=CF(8572)'],
    products = ['[CH2]C1=C(C)[CH]C1F(9402)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'C#CC([CH2])=CF(8827)'],
    products = ['[CH]=C(C)C([CH2])=CF(8572)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]F(837)', '[CH]C(C)=C=C(6222)'],
    products = ['[CH]=C(C)C([CH2])=CF(8572)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C(C)C([CH2])=CF(8572)'],
    products = ['CC1=C([CH]F)C[CH]1(9410)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CHF(40)', '[CH]C(C)=C=C(6222)'],
    products = ['[CH]=C(C)C([CH2])=CF(8572)'],
...
network(
    label = 'PDepNetwork #3304',
    isomers = [
        '[CH]=C(C)C([CH2])=CF(8572)',
    ],
    reactants = [
