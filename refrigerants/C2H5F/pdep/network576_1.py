...
"""),
    ...
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.80212,0.0232241,-1.45862e-05,5.09515e-09,-7.41945e-13,14857.5,14.5102], Tmin=(100,'K'), Tmax=(1579.92,'K')), NASAPolynomial(coeffs=[7.15126,0.0122129,-4.13185e-06,6.83752e-10,-4.38947e-14,13483.3,-8.46106], Tmin=(1579.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.50792,'amu*angstrom^2'), symmetry=1, barrier=(11.6781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.731573,'amu*angstrom^2'), symmetry=1, barrier=(16.8203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.64816,0.0326917,-3.36941e-05,2.11586e-08,-5.80964e-12,-9905.22,14.9934], Tmin=(100,'K'), Tmax=(853.669,'K')), NASAPolynomial(coeffs=[5.66686,0.018547,-8.83992e-06,1.74872e-09,-1.2534e-13,-10420.6,0.907477], Tmin=(853.669,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.7402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCOCsF1s) + radical(COj(Cs-F1sCsH)(O2d))"""),
)

species(
    label = '[CH2]C(F)[C]=O(1189)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {3,S}
2 O u0 p2 c0 {5,D}
3 C u0 p0 c0 {1,S} {4,S} {5,S} {6,S}
...
"""),
    ...
    molecularWeight = (75.0616,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.84694,0.0140319,7.76413e-05,-2.84923e-07,3.36425e-10,-30558,10.1938], Tmin=(10,'K'), Tmax=(214.51,'K')), NASAPolynomial(coeffs=[3.13372,0.0273313,-1.53575e-05,4.10489e-09,-4.22695e-13,-30527.4,12.5367], Tmin=(214.51,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-254.078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), label="""C[C](F)CDO""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    molecularWeight = (75.0616,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.66386,0.0370387,-0.000134045,3.66097e-07,-3.41603e-10,-37217.8,10.4039], Tmin=(10,'K'), Tmax=(381.493,'K')), NASAPolynomial(coeffs=[2.00803,0.0311295,-1.93117e-05,5.70165e-09,-6.46435e-13,-36922.1,19.016], Tmin=(381.493,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-309.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""C[CH]C(DO)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CC(F)[C]=O(1310)'],
    products = ['CC(=O)[CH]F(3029)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['CC(F)[C]=O(1310)'],
    products = ['C[CH]C(=O)F(4966)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(149.23,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)
