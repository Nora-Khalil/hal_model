...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00256,0.042735,-2.35974e-05,6.15003e-09,-6.40673e-13,21019.4,21.5096], Tmin=(100,'K'), Tmax=(2119.12,'K')), NASAPolynomial(coeffs=[12.8456,0.0222674,-9.10913e-06,1.59197e-09,-1.02927e-13,16424,-38.9446], Tmin=(2119.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsFHH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)

species(
    label = '[CH2][C]1CC(F)C1(6884)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28729,0.0324049,2.28295e-08,-1.26854e-08,4.61371e-12,18364.7,21.4702], Tmin=(100,'K'), Tmax=(1202.6,'K')), NASAPolynomial(coeffs=[6.1647,0.0310284,-1.26294e-05,2.29392e-09,-1.56144e-13,16599,-1.41495], Tmin=(1202.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-CsHHH) + ring(Cs(F)-Cs-Cs-Cs) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.18962,'amu*angstrom^2'), symmetry=1, barrier=(27.3517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19037,'amu*angstrom^2'), symmetry=1, barrier=(27.369,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42482,0.0457437,-1.17886e-05,-2.29915e-08,1.3676e-11,2031.62,18.2806], Tmin=(100,'K'), Tmax=(956.564,'K')), NASAPolynomial(coeffs=[15.0677,0.0149799,-4.76669e-06,8.41886e-10,-6.08918e-14,-1781.04,-53.2188], Tmin=(956.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.0389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFH) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(181)', '[CH2]C([CH2])=C(6881)'],
    products = ['[CH2]C(=C)C[CH]F(6416)'],
    transitionState = 'TS4',
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.17979e+10,'s^-1'), n=0.520585, Ea=(110.533,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', '[CH2]C(=C)C=CF(6886)'],
    products = ['[CH2]C(=C)C[CH]F(6416)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(4.02547,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C([CH2])=C(6881)'],
    products = ['[CH2]C(=C)C[CH]F(6416)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(0.0292856,'m^3/(mol*s)'), n=2.64543, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.24524072153041726, var=3.368891203868511, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R_3BrCClFINOPSSi->C_2Br1sCl1sF1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)
