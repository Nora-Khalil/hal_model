...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C#COC([CH2])F(1161)'],
    products = ['C#COC(F)C[O](1815)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(20)', 'C#CO[CH]F(1743)'],
    products = ['C#COC(F)C[O](1815)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'C#COC(F)C=O(2383)'],
    products = ['C#COC(F)C[O](1815)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CO[CH]C[O](2344)'],
    products = ['C#COC(F)C[O](1815)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H(22)', '[O]CC([O])F(1656)'],
    products = ['C#COC(F)C[O](1815)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][O](131)', 'C#CO[CH]F(1743)'],
    products = ['C#COC(F)C[O](1815)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C#CO[C](F)C[O](2384)'],
    products = ['C#COC(F)C[O](1815)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#COC(F)[CH][O](2385)'],
    products = ['C#COC(F)C[O](1815)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[C]#COC(F)C[O](2386)'],
    products = ['C#COC(F)C[O](1815)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C#COC=C[O](1661)'],
    products = ['C#COC(F)C[O](1815)'],
