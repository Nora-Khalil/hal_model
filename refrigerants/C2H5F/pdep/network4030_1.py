...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC=[C]C(6094)'],
    products = ['[CH]=C(C=[C]C)CF(9450)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C=[C]C(6136)'],
    products = ['[CH]=C(C=[C]C)CF(9450)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[CH]=C(C=C=C)CF(11126)'],
    products = ['[CH]=C(C=[C]C)CF(9450)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2F(46)', 'C#CC=[C]C(6246)'],
    products = ['[CH]=C(C=[C]C)CF(9450)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]=C(C#CC)CF(11326)'],
    products = ['[CH]=C(C=[C]C)CF(9450)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(C=C[CH2])CF(11327)'],
    products = ['[CH]=C(C=[C]C)CF(9450)'],
