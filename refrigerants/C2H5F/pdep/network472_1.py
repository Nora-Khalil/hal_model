...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(=O)OC=O(309)'],
    products = ['C=C(OF)OC=O(561)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C=O(147)', 'C=[C]OF(491)'],
    products = ['C=C(OF)OC=O(561)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(160)', 'C=[C]OC=O(337)'],
    products = ['C=C(OF)OC=O(561)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C(OF)OC=O(1272)'],
    products = ['C=C(OF)OC=O(561)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=C(OF)O[C]=O(1273)'],
    products = ['C=C(OF)OC=O(561)'],
