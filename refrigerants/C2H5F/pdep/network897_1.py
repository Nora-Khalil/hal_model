...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'C=C(C[C]F)OF(1954)'],
    products = ['C=C(CCF)OF(1935)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C[CH]F)OF(1957)'],
    products = ['C=C(CCF)OF(1935)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]CC(=C)OF(671)'],
    products = ['C=C(CCF)OF(1935)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(160)', 'C=[C]CCF(1959)'],
    products = ['C=C(CCF)OF(1935)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2F(46)', '[CH2]C(=C)OF(669)'],
    products = ['C=C(CCF)OF(1935)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]OF(491)', 'CH2F-CH2(61)'],
    products = ['C=C(CCF)OF(1935)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]C(=CCF)OF(1960)'],
    products = ['C=C(CCF)OF(1935)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=C(C[CH]F)OF(1961)'],
    products = ['C=C(CCF)OF(1935)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(CCF)OF(1962)'],
    products = ['C=C(CCF)OF(1935)'],
