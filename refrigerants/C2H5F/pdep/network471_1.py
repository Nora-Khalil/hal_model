...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'O=C(O)C(=O)[C]F(3424)'],
    products = ['O=C(O)C(=O)CF(560)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'O=[C]C(=O)CF(3434)'],
    products = ['O=C(O)C(=O)CF(560)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[O]C(=O)C(=O)CF(3435)'],
    products = ['O=C(O)C(=O)CF(560)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(46)', 'O=[C]C(=O)O(1576)'],
    products = ['O=C(O)C(=O)CF(560)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O=C(O)C(=O)[CH]F(2257)'],
    products = ['O=C(O)C(=O)CF(560)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O=[C]O(146)', 'O=[C]CF(492)'],
    products = ['O=C(O)C(=O)CF(560)'],
