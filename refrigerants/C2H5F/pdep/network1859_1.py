...
reaction(
    label = 'reaction2',
    reactants = ['C[C]F-2(838)', '[CH2]C([O])F(527)'],
    products = ['[CH2]C(F)O[C](C)F(5143)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[C](F)O[CH]F(2011)'],
    products = ['[CH2]C(F)O[C](C)F(5143)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['C[C]F(124)', '[CH2]C([O])F(527)'],
    products = ['[CH2]C(F)O[C](C)F(5143)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)O[C](C)F(5143)'],
    products = ['[CH2]C(F)OC([CH2])F(5206)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(F)O[C](C)F(5143)'],
    products = ['[CH2][CH]OC(C)(F)F(4698)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(216.201,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
