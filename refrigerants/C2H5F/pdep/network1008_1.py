...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(152)', '[CH]F(837)'],
    products = ['[O]C(=O)O[CH]F(2263)'],
    transitionState = 'TS2',
