...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'F[C]C=C(F)F(5570)'],
    products = ['F[C]=CC(F)F(5470)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', 'F[C]=[C]C(F)F(5588)'],
    products = ['F[C]=CC(F)F(5470)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'FC#C[CH]F(5589)'],
    products = ['F[C]=CC(F)F(5470)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]=CC(F)F(5470)'],
    products = ['F[CH]C=C(F)F(3461)'],
