...
"""),
    E0 = (-1002.69,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,333,384,448,608,1254,1480,223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
...
"""),
    E0 = (-903.243,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,286,334,437,422,648,895,1187,223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,231.457],'cm^-1')),
        HinderedRotor(inertia=(0.225327,'amu*angstrom^2'), symmetry=1, barrier=(8.61327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22593,'amu*angstrom^2'), symmetry=1, barrier=(8.61142,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226874,'amu*angstrom^2'), symmetry=1, barrier=(8.61271,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.710843,0.077146,-0.000102019,7.09687e-08,-1.98163e-11,-108521,24.6246], Tmin=(100,'K'), Tmax=(872.267,'K')), NASAPolynomial(coeffs=[12.0815,0.0250023,-1.23486e-05,2.43306e-09,-1.73019e-13,-110504,-28.6781], Tmin=(872.267,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-903.243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs))"""),
)
...
"""),
    E0 = (-760.023,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,253,525,597,667,842,1178,1324,2750,2800,2850,1350,1500,750,1050,1375,1000,212,367,445,1450,180],'cm^-1')),
        HinderedRotor(inertia=(0.353548,'amu*angstrom^2'), symmetry=1, barrier=(8.12877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.354595,'amu*angstrom^2'), symmetry=1, barrier=(8.15284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.354081,'amu*angstrom^2'), symmetry=1, barrier=(8.14103,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.33741,0.0587607,-9.05882e-05,8.65018e-08,-3.49875e-11,-91406.9,12.527], Tmin=(10,'K'), Tmax=(587.174,'K')), NASAPolynomial(coeffs=[7.41423,0.0309881,-1.96398e-05,5.94799e-09,-6.9015e-13,-91885.7,-4.97068], Tmin=(587.174,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-760.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""C[C](F)C(O)(F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction2',
    reactants = ['COF(400)', 'OC(F)(F)[C]F(7978)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.14358e+07,'m^3/(mol*s)'), n=-0.641018, Ea=(182.448,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17570294811609, var=29.477358162589667, Tref=1000.0, N=2, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['OF(169)', 'CC(F)([C]F)OF(5437)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'OC(F)(F)C(F)OF(7536)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['FOF(1637)', 'CC(F)=C(O)F(5840)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OF(169)', 'C=C(F)C(O)(F)F(7560)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OF(169)', 'CC(OF)=C(F)F(8027)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3OH(26)', 'FOC(F)=C(F)F(7979)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C[C](OF)C(O)(F)F(8028)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'CC(F)(OF)[C](O)F(5846)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'CC([O])(F)C(O)(F)F(8029)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]F(160)', 'C[C](F)C(O)(F)F(8030)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'CC(F)(OF)[C](F)F(6589)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'CC(F)(OF)C([O])(F)F(8031)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O[C](F)F(4999)', 'C[C](F)OF(5141)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH3(19)', 'OC(F)(F)[C](F)OF(7985)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH2]C(F)(OF)C(O)(F)F(8032)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(77)', 'CC(=O)C(O)(F)F(7893)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(74.252,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'CC(F)(OF)C(=O)F(7567)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F2(77)', 'CC(OF)=C(O)F(5849)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'C=C(OF)C(O)(F)F(7511)'],
    products = ['CC(F)(OF)C(O)(F)F(7542)'],
