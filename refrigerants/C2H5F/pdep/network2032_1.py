...
"""),
    E0 = (359.657,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(0.628672,'amu*angstrom^2'), symmetry=1, barrier=(14.4544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.626404,'amu*angstrom^2'), symmetry=1, barrier=(14.4023,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65544,0.0540669,-6.23779e-05,4.09952e-08,-1.10973e-11,43339,19.4816], Tmin=(100,'K'), Tmax=(891.482,'K')), NASAPolynomial(coeffs=[8.58213,0.0229876,-1.00843e-05,1.88927e-09,-1.30804e-13,42104,-13.14], Tmin=(891.482,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CdH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83207,0.0401026,-1.64932e-05,-7.92555e-09,6.03235e-12,21409,17.1892], Tmin=(100,'K'), Tmax=(1012.59,'K')), NASAPolynomial(coeffs=[11.6321,0.0174209,-6.64129e-06,1.22309e-09,-8.64948e-14,18602.4,-34.2712], Tmin=(1012.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + group(Cds-Cds(Cds-Cds)H) + ring(Cd-Cd-Cd-Cd(F))"""),
)

species(
    label = 'C=C=CC=CF(6408)',
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62799,0.0438527,-2.08114e-05,-7.96757e-09,7.17481e-12,5229.54,18.2229], Tmin=(100,'K'), Tmax=(980.194,'K')), NASAPolynomial(coeffs=[13.2786,0.0150159,-5.31008e-06,9.60378e-10,-6.83738e-14,2046.89,-42.3357], Tmin=(980.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.7091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (293.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2100,2250,500,550,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(1.58279,'amu*angstrom^2'), symmetry=1, barrier=(36.3916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58308,'amu*angstrom^2'), symmetry=1, barrier=(36.3981,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0835,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00009,0.0374335,-1.60843e-05,-7.83181e-09,6.3876e-12,35367,19.0739], Tmin=(100,'K'), Tmax=(966.484,'K')), NASAPolynomial(coeffs=[10.9786,0.0153885,-5.32794e-06,9.29559e-10,-6.42226e-14,32925.6,-27.5882], Tmin=(966.484,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtHHH) + group(Cds-CdsCtH) + group(CdCFH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Cdj(Cd-CtH)(F1s))"""),
)
...
"""),
    E0 = (372.758,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,2175,525,239,401,1367,212.206],'cm^-1')),
        HinderedRotor(inertia=(0.678162,'amu*angstrom^2'), symmetry=1, barrier=(15.5923,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109293,'amu*angstrom^2'), symmetry=1, barrier=(15.5907,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0835,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31243,0.0410111,-3.57167e-05,1.77374e-08,-3.91029e-12,44889.9,17.5588], Tmin=(100,'K'), Tmax=(1025.97,'K')), NASAPolynomial(coeffs=[6.45537,0.0248588,-1.21014e-05,2.39239e-09,-1.71127e-13,44039.8,-2.53469], Tmin=(1025.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(372.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(CtCF) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=CC=[C]F(6634)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    E0 = (239.871,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,167,640,1190,217.2],'cm^-1')),
        HinderedRotor(inertia=(0.72833,'amu*angstrom^2'), symmetry=1, barrier=(23.9177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.29819,'amu*angstrom^2'), symmetry=1, barrier=(74.511,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7414,0.0433524,-2.45475e-05,-4.31831e-10,3.80599e-12,28936.7,20.2489], Tmin=(100,'K'), Tmax=(987.36,'K')), NASAPolynomial(coeffs=[11.3048,0.0180336,-6.47742e-06,1.13751e-09,-7.8008e-14,26393.9,-29.0809], Tmin=(987.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(239.871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(C=CC=CCJ) + radical(Cdj(Cd-CdH)(F1s))"""),
)

species(
    label = 'CC=C=C[C]F(6635)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {3,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00417,0.048207,-5.17161e-05,3.61339e-08,-1.13607e-11,36841.2,18.2744], Tmin=(100,'K'), Tmax=(745.604,'K')), NASAPolynomial(coeffs=[5.45224,0.0297089,-1.45019e-05,2.85958e-09,-2.03913e-13,36327.1,2.65165], Tmin=(745.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(305.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(CsCCl_triplet)"""),
)

species(
    label = 'C[C]=C[C]=CF(6636)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {5,S} {7,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (84.0915,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82788,0.041733,-2.80344e-05,9.44914e-09,-1.28836e-12,36064.1,19.8044], Tmin=(100,'K'), Tmax=(1698.51,'K')), NASAPolynomial(coeffs=[11.8595,0.0181086,-7.17112e-06,1.26033e-09,-8.30728e-14,32656.4,-33.9067], Tmin=(1698.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Allyl_S) + radical(Cdj(Cdd-Cd)(F1s))"""),
)

species(
    label = 'CC#C[CH][CH]F(6638)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {5,S} {7,S} {8,S} {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['C[C]=CC=[C]F(6406)'],
    products = ['C2HF(57)', 'C#CC(3594)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['H(6)', 'C=C=CC=[C]F(6631)'],
    products = ['C[C]=CC=[C]F(6406)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]F(488)', '[CH]=[C]C(3595)'],
    products = ['C[C]=CC=[C]F(6406)'],
    transitionState = 'TS9',
