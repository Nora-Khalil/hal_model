...
"""),
    E0 = (-182.267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,208.011,4000],'cm^-1')),
        HinderedRotor(inertia=(0.822954,'amu*angstrom^2'), symmetry=1, barrier=(25.2649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.822801,'amu*angstrom^2'), symmetry=1, barrier=(25.2649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309968,'amu*angstrom^2'), symmetry=1, barrier=(9.51627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.501098,'amu*angstrom^2'), symmetry=1, barrier=(15.383,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.1121,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06351,0.0587258,-4.16124e-05,1.51514e-08,-2.2561e-12,-21811.3,22.6813], Tmin=(100,'K'), Tmax=(1553.58,'K')), NASAPolynomial(coeffs=[13.4457,0.0268445,-1.08298e-05,1.94177e-09,-1.30368e-13,-25658.5,-42.5105], Tmin=(1553.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
"""),
    E0 = (-16.4325,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,252.051],'cm^-1')),
        HinderedRotor(inertia=(0.181023,'amu*angstrom^2'), symmetry=1, barrier=(7.71978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182373,'amu*angstrom^2'), symmetry=1, barrier=(7.72845,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
...
"""),
    E0 = (-86.4136,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,469.621,469.687],'cm^-1')),
        HinderedRotor(inertia=(0.0577938,'amu*angstrom^2'), symmetry=1, barrier=(9.01207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0579961,'amu*angstrom^2'), symmetry=1, barrier=(9.01128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0574806,'amu*angstrom^2'), symmetry=1, barrier=(9.01438,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.1137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71807,0.0423021,-9.4145e-06,-1.31097e-08,6.78052e-12,-10304.3,19.9628], Tmin=(100,'K'), Tmax=(1059.96,'K')), NASAPolynomial(coeffs=[9.96279,0.027204,-1.07127e-05,1.96149e-09,-1.36257e-13,-12951.8,-24.5372], Tmin=(1059.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.4136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
"""),
    E0 = (29.3224,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,1274.87],'cm^-1')),
        HinderedRotor(inertia=(0.641955,'amu*angstrom^2'), symmetry=1, barrier=(14.7598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105233,'amu*angstrom^2'), symmetry=1, barrier=(14.7878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165777,'amu*angstrom^2'), symmetry=1, barrier=(3.81154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.642569,'amu*angstrom^2'), symmetry=1, barrier=(14.7739,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.1041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14129,0.0613336,-5.29949e-05,2.44557e-08,-4.64378e-12,3630.8,23.0282], Tmin=(100,'K'), Tmax=(1241.93,'K')), NASAPolynomial(coeffs=[11.8404,0.0268733,-1.13732e-05,2.11277e-09,-1.46087e-13,973.336,-30.9068], Tmin=(1241.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.3224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'CC(C)OF(674)'],
    products = ['CCC(C)OF(577)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', '[CH2]C(C)OF(678)'],
    products = ['CCC(C)OF(577)'],
