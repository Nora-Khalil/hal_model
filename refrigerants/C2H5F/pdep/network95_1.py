...
reaction(
    label = 'reaction1',
    reactants = ['CO(13)', 'C2H3(29)'],
    products = ['C=C[C]=O(294)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C[C]=O(294)'],
    products = ['O=C1[CH]C1(7425)'],
    transitionState = 'TS3',
