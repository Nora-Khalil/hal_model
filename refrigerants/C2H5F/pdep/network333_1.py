...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[O](361)'],
    products = ['[CH]=CC(C)[O](427)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[CH](135)', 'C[CH][O](174)'],
    products = ['[CH]=CC(C)[O](427)'],
