...
"""),
    E0 = (-132.295,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,334,575,1197,1424,3202,188.98,189.271,189.374],'cm^-1')),
        HinderedRotor(inertia=(0.279048,'amu*angstrom^2'), symmetry=1, barrier=(7.08542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00470096,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.279085,'amu*angstrom^2'), symmetry=1, barrier=(7.08888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13106,'amu*angstrom^2'), symmetry=1, barrier=(28.7335,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.292675,0.0925284,-0.000169039,1.53165e-07,-5.24727e-11,-15788.5,26.7114], Tmin=(100,'K'), Tmax=(868.049,'K')), NASAPolynomial(coeffs=[9.74681,0.0256439,-1.31648e-05,2.50486e-09,-1.69324e-13,-16551.2,-12.5009], Tmin=(868.049,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(CCsJOH) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-303.034,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,487,638,688,1119,1325,1387,3149,3025,407.5,1350,352.5,334,575,1197,1424,3202,180,2056.22],'cm^-1')),
        HinderedRotor(inertia=(0.519581,'amu*angstrom^2'), symmetry=1, barrier=(11.9462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.520084,'amu*angstrom^2'), symmetry=1, barrier=(11.9578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19481,'amu*angstrom^2'), symmetry=1, barrier=(27.471,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
...
"""),
    E0 = (-311.729,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,391,562,707,872,1109,1210,1289,3137,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.215832,'amu*angstrom^2'), symmetry=1, barrier=(4.96241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21681,'amu*angstrom^2'), symmetry=1, barrier=(4.98489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.906782,'amu*angstrom^2'), symmetry=1, barrier=(20.8487,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.391178,0.0880371,-0.00015069,1.33507e-07,-4.59312e-11,-37370.7,27.881], Tmin=(100,'K'), Tmax=(828.71,'K')), NASAPolynomial(coeffs=[10.0899,0.0268947,-1.40842e-05,2.74789e-09,-1.9046e-13,-38486.2,-14.1189], Tmin=(828.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFHH) + radical(O2sj(Cs-CsF1sH)) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-358.198,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,487,638,688,1119,1325,1387,3149,360,370,350,334,575,1197,1424,3202,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.235533,'amu*angstrom^2'), symmetry=1, barrier=(5.41537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235965,'amu*angstrom^2'), symmetry=1, barrier=(5.4253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235483,'amu*angstrom^2'), symmetry=1, barrier=(5.41423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47617,'amu*angstrom^2'), symmetry=1, barrier=(33.9401,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.131699,0.0981795,-0.000185126,1.72949e-07,-6.09857e-11,-42954.5,28.3293], Tmin=(100,'K'), Tmax=(854.662,'K')), NASAPolynomial(coeffs=[8.8727,0.029559,-1.60576e-05,3.13218e-09,-2.15163e-13,-43436.6,-6.54745], Tmin=(854.662,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-358.198,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(CsCsFHH) + radical(C2CsJO) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-232.286,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,334,575,1197,1424,3202,2782.5,750,1395,475,1775,1000,180,582.452],'cm^-1')),
        HinderedRotor(inertia=(0.12946,'amu*angstrom^2'), symmetry=1, barrier=(2.97655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.850259,'amu*angstrom^2'), symmetry=1, barrier=(19.5491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0811912,'amu*angstrom^2'), symmetry=1, barrier=(19.549,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54796,0.0560814,-6.1703e-05,3.45451e-08,-7.79589e-12,-27851,24.8019], Tmin=(100,'K'), Tmax=(1065.03,'K')), NASAPolynomial(coeffs=[11.3994,0.019082,-9.59301e-06,1.92653e-09,-1.392e-13,-29949.4,-23.3463], Tmin=(1065.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-232.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(CsCsFHH) + group(Cds-OdCsH) + radical(CsCsF1sH)"""),
)
...
"""),
    E0 = (-264.954,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,234,589,736,816,1240,3237,180],'cm^-1')),
        HinderedRotor(inertia=(1.19971,'amu*angstrom^2'), symmetry=1, barrier=(27.5838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2025,'amu*angstrom^2'), symmetry=1, barrier=(27.6478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2003,'amu*angstrom^2'), symmetry=1, barrier=(27.5973,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.374186,0.0699017,-8.23897e-05,4.51398e-08,-9.31211e-12,-31727.6,24.2633], Tmin=(100,'K'), Tmax=(1267.29,'K')), NASAPolynomial(coeffs=[20.084,0.00429699,-7.21303e-07,6.43998e-11,-3.17139e-15,-36450.7,-74.419], Tmin=(1267.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-264.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(Csj(Cd-O2sCd)(F1s)(H))"""),
)

species(
    label = 'OC(F)C([C]F)OF-2(4115)',
...
"""),
    E0 = (-366.37,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,261,493,600,1152,1365,1422,3097,617,898,1187,299.97,299.975],'cm^-1')),
...
"""),
    E0 = (-506.285,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,391,562,707,872,1109,1210,1289,3137,528,1116,1182,1331,1402,1494,3075,3110,198.192,199.31,200.314],'cm^-1')),
        HinderedRotor(inertia=(0.350169,'amu*angstrom^2'), symmetry=1, barrier=(10.0075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362022,'amu*angstrom^2'), symmetry=1, barrier=(10.008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.858039,'amu*angstrom^2'), symmetry=1, barrier=(24.4437,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (129.058,'amu'),
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]C(OF)C(O)F-2(4107)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(837)', 'OC(F)[CH]OF(3041)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'OC(F)C([C]F)OF(4108)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'O[CH]C([CH]F)OF(4026)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[O]C([CH]F)C(O)F(3398)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(160)', 'OC(F)[CH][CH]F(2006)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'F[CH]C([CH]F)OF(2964)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[O]C(F)C([CH]F)OF(4110)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O[CH]F(1908)', 'F[CH][CH]OF(1775)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'OC(F)[C]([CH]F)OF(4111)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'O[C](F)C([CH]F)OF(4112)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'O=CC([CH]F)OF(4113)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(157.399,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'O=C([CH]F)C(O)F(3407)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'OC=C([CH]F)OF(4114)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(266.943,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction22',
    reactants = ['CHF(40)', 'OC(F)[CH]OF(3041)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', 'OC(F)C([C]F)OF-2(4115)'],
    products = ['OC(F)C([CH]F)OF(3799)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OC(F)C([CH]F)OF(3799)'],
    products = ['O[CH]C(OF)C(F)F(4118)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(222.814,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #1473',
    isomers = [
        'OC(F)C([CH]F)OF(3799)',
    ],
    reactants = [
