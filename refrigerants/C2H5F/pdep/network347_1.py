...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(134)', '[CH2]C([O])=O(157)'],
    products = ['[CH2]C(=O)O[C]=C(438)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[C]=O(725)'],
    products = ['[CH2]C(=O)O[C]=C(438)'],
    transitionState = 'TS3',
