...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C#CC(O)F(9949)'],
    products = ['C#CC(F)OC=O(8439)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=CO(170)', 'C#C[C]F(9200)'],
    products = ['C#CC(F)OC=O(8439)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['FC1[C]=CO[CH]O1(10745)'],
    products = ['C#CC(F)OC=O(8439)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C=C(F)O[CH]O(10747)'],
    products = ['C#CC(F)OC=O(8439)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(15)', 'C#CC([O])F(2078)'],
    products = ['C#CC(F)OC=O(8439)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C2H(22)', 'O=CO[CH]F(2085)'],
    products = ['C#CC(F)OC=O(8439)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C=C(F)OC=O(10750)'],
    products = ['C#CC(F)OC=O(8439)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[C]#CC(F)OC=O(10751)'],
    products = ['C#CC(F)OC=O(8439)'],
