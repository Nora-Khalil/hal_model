...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][CH]C(=O)OF(1303)'],
    products = ['[CH2]C(F)C([O])=O(1279)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C([O])=CF(1304)'],
    products = ['[CH2]C(F)C([O])=O(1279)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)[C]=O(1189)'],
    products = ['[CH2]C(F)C([O])=O(1279)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C(F)C([O])=O(1308)'],
    products = ['[CH2]C(F)C([O])=O(1279)'],
