...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.6793,'amu*angstrom^2'), symmetry=1, barrier=(38.6104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6797,'amu*angstrom^2'), symmetry=1, barrier=(38.6196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.67939,'amu*angstrom^2'), symmetry=1, barrier=(38.6125,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-742.719,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,259,529,569,1128,1321,1390,3140,223,363,546,575,694,1179,1410,3000,3100,440,815,1455,1000,210.717],'cm^-1')),
        HinderedRotor(inertia=(0.407091,'amu*angstrom^2'), symmetry=1, barrier=(12.8828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.409295,'amu*angstrom^2'), symmetry=1, barrier=(12.8864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.787119,'amu*angstrom^2'), symmetry=1, barrier=(24.889,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['OC(F)(F)C(F)CF(7519)'],
    products = ['HF(38)', 'CF2O(49)', 'CH2CHF(55)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH3F(39)', 'OC(F)(F)[C]F(7978)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OC(F)F(1983)', 'F[C]CF(1082)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'OC(F)(F)CF(4885)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OF(169)', 'F[C]C(F)CF(2444)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2(8)', 'OC(F)(F)C(F)[C]F(8169)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(25)', 'OC(F)(F)C(F)F(8170)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H2O(3)', 'FCC(F)=C(F)F(8172)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OF(169)', 'FCC=C(F)F(4984)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'OC(F)(F)[CH]CF(8173)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'O[C](F)C(F)CF(2455)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C(F)C(O)(F)F(8174)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'FCC(F)[C](F)F(8175)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[O]C(F)(F)C(F)CF(8176)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O[C](F)F(4999)', 'CH2F-CHF(65)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(46)', 'OC(F)(F)[CH]F(7983)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'OC(F)(F)[C](F)CF(8177)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'OC(F)(F)C(F)[CH]F(8178)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=C(F)C(F)CF(5581)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'OC(F)=C(F)CF(5096)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction25',
    reactants = ['F2(77)', 'C=CC(O)(F)F(7547)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HF(38)', 'C=C(F)C(O)(F)F(7560)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HF(38)', 'OC(F)(F)C=CF(7552)'],
    products = ['OC(F)(F)C(F)CF(7519)'],
