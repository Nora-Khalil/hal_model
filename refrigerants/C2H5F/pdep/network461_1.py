...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OCOF(1054)'],
    products = ['O=C(O)COF(550)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(160)', '[CH2]C(=O)O(166)'],
    products = ['O=C(O)COF(550)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=[C]O(146)', '[CH2]OF(396)'],
    products = ['O=C(O)COF(550)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'O=C(O)[CH]OF(1429)'],
    products = ['O=C(O)COF(550)'],
