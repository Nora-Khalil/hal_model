...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.299432,'amu*angstrom^2'), symmetry=1, barrier=(6.88453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.29943,'amu*angstrom^2'), symmetry=1, barrier=(6.88448,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01219,0.050186,-5.47876e-05,2.0923e-08,6.82117e-12,6105.95,19.7303], Tmin=(100,'K'), Tmax=(543.507,'K')), NASAPolynomial(coeffs=[6.81499,0.0247986,-1.22082e-05,2.40968e-09,-1.71125e-13,5436.79,-1.86537], Tmin=(543.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.2249,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sCdH)(H)(H)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (48.0209,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,334,575,1197,1424,3202,167,640,1190,180,1258.91],'cm^-1')),
        HinderedRotor(inertia=(0.292434,'amu*angstrom^2'), symmetry=1, barrier=(6.72362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292387,'amu*angstrom^2'), symmetry=1, barrier=(6.72255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0713,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85088,0.0524516,-7.65946e-05,6.89121e-08,-2.5314e-11,5847.95,20.557], Tmin=(100,'K'), Tmax=(781.981,'K')), NASAPolynomial(coeffs=[5.37689,0.0269064,-1.31901e-05,2.57805e-09,-1.81189e-13,5526.08,5.88108], Tmin=(781.981,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.0209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CdHH)(F1s)(H)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.112234,'amu*angstrom^2'), symmetry=1, barrier=(76.1544,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.207101,'amu*angstrom^2'), symmetry=1, barrier=(4.76166,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8435,0.0532845,-8.09622e-05,7.50719e-08,-2.80476e-11,11716.7,19.8734], Tmin=(100,'K'), Tmax=(790.942,'K')), NASAPolynomial(coeffs=[4.9399,0.0277564,-1.38329e-05,2.71499e-09,-1.90934e-13,11535.6,7.61271], Tmin=(790.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Cdj(Cs-F1sCsH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH2]C(F)=C[CH]F(2615)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56363,0.0604962,-9.89549e-05,9.08907e-08,-3.2602e-11,-2255.51,18.4027], Tmin=(100,'K'), Tmax=(828.983,'K')), NASAPolynomial(coeffs=[5.9905,0.0260002,-1.27681e-05,2.46516e-09,-1.70725e-13,-2538.13,0.59819], Tmin=(828.983,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.4273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)

species(
    label = '[CH2]C=C[C](F)F(2624)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C=[C]F(2560)'],
    products = ['C2HF(57)', 'CH2CHF(55)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[C]C=CF(2617)'],
    products = ['[CH2]C(F)C=[C]F(2560)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]F(1321)', 'CH2CHF(55)'],
    products = ['[CH2]C(F)C=[C]F(2560)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=C(F)C=[C]F(2618)'],
    products = ['[CH2]C(F)C=[C]F(2560)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2HF(57)', '[CH2][CH]F(839)'],
    products = ['[CH2]C(F)C=[C]F(2560)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)C#CF(2619)'],
    products = ['[CH2]C(F)C=[C]F(2560)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]F(1321)', '[CH2][CH]F(839)'],
    products = ['[CH2]C(F)C=[C]F(2560)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C=C=[C]F(2620)'],
    products = ['[CH2]C(F)C=[C]F(2560)'],
