...
reaction(
    label = 'reaction2',
    reactants = ['H(6)', '[C]=C(F)OC(=O)O(7650)'],
    products = ['[CH]=C(F)OC(=O)O(3864)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)O(3598)', 'C2HF(57)'],
    products = ['[CH]=C(F)OC(=O)O(3864)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=[C]OC(=O)O(3747)'],
    products = ['[CH]=C(F)OC(=O)O(3864)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]O(178)', '[CH]C(=O)F(502)'],
    products = ['[CH]=C(F)OC(=O)O(3864)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(=O)O(3598)', '[CH]=[C]F(488)'],
    products = ['[CH]=C(F)OC(=O)O(3864)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(5)', '[CH]=C(F)O[C]=O(5478)'],
    products = ['[CH]=C(F)OC(=O)O(3864)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[CH]=C(F)OC([O])=O(7653)'],
    products = ['[CH]=C(F)OC(=O)O(3864)'],
