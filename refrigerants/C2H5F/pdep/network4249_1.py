...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(332)', 'O=[C]O(146)'],
    products = ['O=C(O)OC(=O)F(545)'],
    transitionState = 'TS8',
...
network(
    label = 'PDepNetwork #4249',
    isomers = [
        'O=C(O)OC(=O)F(545)',
    ],
    reactants = [
        ('CO2(14)', 'O=C(O)F(336)'),
        ('[O]C(=O)F(332)', 'O=[C]O(146)'),
        ('HF(38)', 'CO2(14)', 'CO2(14)'),
    ],
    bathGas = {
        'N2': 0.5,
