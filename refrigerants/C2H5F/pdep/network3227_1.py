...
"""),
    E0 = (200.825,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,164,312,561,654,898,1207,1299,3167,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,367.602],'cm^-1')),
        HinderedRotor(inertia=(0.0671448,'amu*angstrom^2'), symmetry=1, barrier=(6.33615,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0664305,'amu*angstrom^2'), symmetry=1, barrier=(6.34727,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.066022,'amu*angstrom^2'), symmetry=1, barrier=(6.33119,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72153,0.0547027,-5.25471e-05,3.15394e-08,-8.50223e-12,24231.7,22.8906], Tmin=(100,'K'), Tmax=(858.233,'K')), NASAPolynomial(coeffs=[6.21503,0.0337603,-1.59453e-05,3.10835e-09,-2.20603e-13,23460.4,1.89887], Tmin=(858.233,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cdj(Cs-F1sCsH)(Cd-HH))"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56723,0.0494029,-3.40408e-05,1.20002e-08,-1.73712e-12,-7955.63,20.0295], Tmin=(100,'K'), Tmax=(1582.04,'K')), NASAPolynomial(coeffs=[11.7094,0.0237596,-9.72722e-06,1.75445e-09,-1.18052e-13,-11164.7,-33.5529], Tmin=(1582.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.9011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (138.345,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,145,326,398,834,1303,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,540,610,2055,180],'cm^-1')),
        HinderedRotor(inertia=(0.00743018,'amu*angstrom^2'), symmetry=1, barrier=(4.15524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.50254,'amu*angstrom^2'), symmetry=1, barrier=(11.5544,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81104,0.0478097,-3.68854e-05,1.51507e-08,-2.61105e-12,16718,20.9343], Tmin=(100,'K'), Tmax=(1330.68,'K')), NASAPolynomial(coeffs=[9.56754,0.0244938,-1.06026e-05,1.98308e-09,-1.372e-13,14653.7,-18.7023], Tmin=(1330.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJ)"""),
)

species(
    label = 'C#CC(F)C[CH2](8679)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
...
"""),
    E0 = (130.764,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,233,378,609,1068,1270,1314,3037,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,180],'cm^-1')),
        HinderedRotor(inertia=(1.04175,'amu*angstrom^2'), symmetry=1, barrier=(23.9519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00438663,'amu*angstrom^2'), symmetry=1, barrier=(12.2631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.9551,'amu*angstrom^2'), symmetry=1, barrier=(67.9436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65883,0.0530724,-5.1308e-05,2.86791e-08,-6.7562e-12,15810.2,19.8187], Tmin=(100,'K'), Tmax=(1005.78,'K')), NASAPolynomial(coeffs=[8.42641,0.0261581,-1.11691e-05,2.07409e-09,-1.43275e-13,14448.9,-12.8701], Tmin=(1005.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ)"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49585,0.0416434,1.32498e-05,-1.23697e-07,1.22641e-10,22911.3,21.0756], Tmin=(100,'K'), Tmax=(416.047,'K')), NASAPolynomial(coeffs=[4.38105,0.0368997,-1.78919e-05,3.50967e-09,-2.49103e-13,22638.6,12.2421], Tmin=(416.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cdj(Cs-F1sCsH)(Cd-HH))"""),
)
...
"""),
    E0 = (211.91,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([284,328,853,1146,1135,1297,3239,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.13282,'amu*angstrom^2'), symmetry=1, barrier=(3.0538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126423,'amu*angstrom^2'), symmetry=1, barrier=(2.90671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.581977,'amu*angstrom^2'), symmetry=1, barrier=(13.3808,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84981,0.0509354,-3.93877e-05,1.6713e-08,-3.10585e-12,25561.1,21.9156], Tmin=(100,'K'), Tmax=(1197.44,'K')), NASAPolynomial(coeffs=[7.83319,0.0309482,-1.43505e-05,2.77372e-09,-1.95648e-13,24128.2,-8.02891], Tmin=(1197.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=C(F)CC(8683)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {9,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44575,0.0486779,-2.75235e-05,3.52304e-09,1.38786e-12,15983.9,23.0621], Tmin=(100,'K'), Tmax=(1144.29,'K')), NASAPolynomial(coeffs=[11.8185,0.0237488,-9.69733e-06,1.79054e-09,-1.24135e-13,12868.3,-31.6198], Tmin=(1144.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.081,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cdj(Cs-HHH)(Cd-CsF1s))"""),
)

species(
    label = '[CH2][CH]C(F)C=C(8684)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4606,0.0427082,-2.39239e-05,6.02459e-09,-6.06545e-13,19211.8,21.8251], Tmin=(100,'K'), Tmax=(2044.02,'K')), NASAPolynomial(coeffs=[10.2473,0.0274702,-1.27415e-05,2.37739e-09,-1.60463e-13,16028.6,-21.308], Tmin=(2044.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH]=[C]C(F)CC(8685)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {3,S} {4,S} {7,S} {8,S}
3  C u0 p0 c0 {1,S} {2,S} {5,S} {9,S}
...
"""),
    E0 = (242.674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,164,312,561,654,898,1207,1299,3167,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.417037,'amu*angstrom^2'), symmetry=1, barrier=(9.5885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417312,'amu*angstrom^2'), symmetry=1, barrier=(9.59483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.416849,'amu*angstrom^2'), symmetry=1, barrier=(9.58418,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57402,0.0579355,-6.0367e-05,3.88611e-08,-1.09661e-11,29270.3,22.0356], Tmin=(100,'K'), Tmax=(833.114,'K')), NASAPolynomial(coeffs=[6.75409,0.0330653,-1.55901e-05,3.03113e-09,-2.14606e-13,28407.2,-2.00949], Tmin=(833.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC(F)[C]=C(8504)'],
    products = ['C2H4(30)', 'C=C=CF(5941)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C(F)[C]=C(941)'],
    products = ['[CH2]CC(F)[C]=C(8504)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C#CC(F)C[CH2](8679)'],
    products = ['[CH2]CC(F)[C]=C(8504)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(201.663,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(131.52,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

network(
    label = 'PDepNetwork #3227',
    isomers = [
        '[CH2]CC(F)[C]=C(8504)',
    ],
    reactants = [
