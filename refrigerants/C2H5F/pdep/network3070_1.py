...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[CH]=CCOF(8322)'],
    products = ['[CH]=CCC(=O)OF(6977)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OF(169)', '[CH]=CC=C=O(403)'],
    products = ['[CH]=CCC(=O)OF(6977)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H2(23)', '[CH2]C(=O)OF(650)'],
    products = ['[CH]=CCC(=O)OF(6977)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH]=CCC([O])=O(6879)'],
    products = ['[CH]=CCC(=O)OF(6977)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(160)', '[CH]=CC[C]=O(420)'],
    products = ['[CH]=CCC(=O)OF(6977)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[CH](135)', '[CH2]C(=O)OF(650)'],
    products = ['[CH]=CCC(=O)OF(6977)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]OF(331)', '[CH]C=C(8253)'],
    products = ['[CH]=CCC(=O)OF(6977)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH]=C[CH]C(=O)OF(8328)'],
    products = ['[CH]=CCC(=O)OF(6977)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=[C]CC(=O)OF(8329)'],
    products = ['[CH]=CCC(=O)OF(6977)'],
