...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29833,0.0408619,-2.95017e-05,1.13528e-08,-1.91707e-12,-66862.1,18.3951], Tmin=(100,'K'), Tmax=(1285.49,'K')), NASAPolynomial(coeffs=[7.08297,0.0259737,-1.21289e-05,2.3431e-09,-1.64864e-13,-68092.3,-5.88966], Tmin=(1285.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-556.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsHHH) + group(COCsFO)"""),
)
...
"""),
    E0 = (-3.29164,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,487,638,688,1119,1325,1387,3149,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100],'cm^-1')),
        HinderedRotor(inertia=(0.482979,'amu*angstrom^2'), symmetry=1, barrier=(11.1046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77283,'amu*angstrom^2'), symmetry=1, barrier=(40.7609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0759811,'amu*angstrom^2'), symmetry=1, barrier=(40.8035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.77249,'amu*angstrom^2'), symmetry=1, barrier=(40.753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
...
"""),
    E0 = (-53.2328,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,180,180,180,180,1461.11],'cm^-1')),
        HinderedRotor(inertia=(0.224548,'amu*angstrom^2'), symmetry=1, barrier=(5.16281,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.31906,'amu*angstrom^2'), symmetry=1, barrier=(53.3196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.31186,'amu*angstrom^2'), symmetry=1, barrier=(53.1543,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63657,0.064376,-0.000115768,1.20842e-07,-4.72655e-11,-6329.33,31.7595], Tmin=(100,'K'), Tmax=(843.921,'K')), NASAPolynomial(coeffs=[0.344738,0.040727,-2.08167e-05,4.03155e-09,-2.78425e-13,-5051.1,44.0539], Tmin=(843.921,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.2328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(Cs-OsHHH) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OOC(5363)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {4,S}
3  O u0 p2 c0 {2,S} {5,S}
...
"""),
    E0 = (40.2488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,223.623,223.629,223.633],'cm^-1')),
        HinderedRotor(inertia=(0.925236,'amu*angstrom^2'), symmetry=1, barrier=(32.8404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.008215,'amu*angstrom^2'), symmetry=1, barrier=(32.8404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155996,'amu*angstrom^2'), symmetry=1, barrier=(5.53705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.925408,'amu*angstrom^2'), symmetry=1, barrier=(32.8405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99352,0.0523221,-4.18753e-05,-1.19051e-08,3.28831e-11,4904.83,18.4538], Tmin=(100,'K'), Tmax=(487.758,'K')), NASAPolynomial(coeffs=[5.8392,0.0325133,-1.70272e-05,3.43264e-09,-2.46917e-13,4390.16,1.23137], Tmin=(487.758,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.2488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCFHO) + group(Cs-OsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(F)OOC(5117)'],
    products = ['CH2O(20)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1054.45,'s^-1'), n=2.72887, Ea=(25.6264,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C(F)OO(1322)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(25)', 'CO[O+]=[C-]F(5364)'],
    products = ['C=C(F)OOC(5117)'],
