...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C(OC)OF(645)'],
    products = ['C=C(OF)OCC(3591)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C(O)OF(1265)', 'C2H4(30)'],
    products = ['C=C(OF)OCC(3591)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=O)OCC(3607)'],
    products = ['C=C(OF)OCC(3591)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(=O)OF(650)', 'C2H5(32)'],
    products = ['C=C(OF)OCC(3591)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', '[CH2]OC(=C)OF(2895)'],
    products = ['C=C(OF)OCC(3591)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=C(OF)O[CH]C(3608)'],
    products = ['C=C(OF)OCC(3591)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]COC(=C)OF(3609)'],
    products = ['C=C(OF)OCC(3591)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)OCC(3610)'],
    products = ['C=C(OF)OCC(3591)'],
