...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.483313,0.0870671,-0.000143404,1.31168e-07,-4.70183e-11,-37728.7,27.4506], Tmin=(100,'K'), Tmax=(823.181,'K')), NASAPolynomial(coeffs=[7.21857,0.0364332,-1.85111e-05,3.59659e-09,-2.49711e-13,-38230.9,-0.0475916], Tmin=(823.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsHH) + group(CsCFHO) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C(OF)=C(C)OF(4491)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (15.5099,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,305.044,2942.87],'cm^-1')),
        HinderedRotor(inertia=(0.00181061,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156179,'amu*angstrom^2'), symmetry=1, barrier=(10.3294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156361,'amu*angstrom^2'), symmetry=1, barrier=(10.3277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.610683,'amu*angstrom^2'), symmetry=1, barrier=(40.4014,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.659794,0.0811675,-0.000106771,6.70158e-08,-1.17658e-11,1978.48,26.7452], Tmin=(100,'K'), Tmax=(619.883,'K')), NASAPolynomial(coeffs=[10.8685,0.0290018,-1.37137e-05,2.61284e-09,-1.80822e-13,449.444,-19.7485], Tmin=(619.883,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.5099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C(F)=C(C)OOF(4626)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-60.4379,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,277,555,632,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,271,519,563,612,1379,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.653262,'amu*angstrom^2'), symmetry=1, barrier=(15.0198,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.617574,0.0825776,-0.000127268,1.14588e-07,-4.17617e-11,-7155.11,27.8657], Tmin=(100,'K'), Tmax=(779.037,'K')), NASAPolynomial(coeffs=[7.12157,0.0379154,-1.95789e-05,3.86718e-09,-2.72609e-13,-7826.58,0.306097], Tmin=(779.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.4379,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2sFO) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.591862,0.0806079,-0.000107399,7.5295e-08,-2.12699e-11,-9325.87,25.2936], Tmin=(100,'K'), Tmax=(860.744,'K')), NASAPolynomial(coeffs=[12.1604,0.0268482,-1.37148e-05,2.73612e-09,-1.95825e-13,-11317.4,-28.7836], Tmin=(860.744,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.5192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[C]1OCC1(F)OF(4628)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45471,0.0601933,-5.10758e-05,2.29745e-08,-4.40644e-12,-25926.5,22.575], Tmin=(100,'K'), Tmax=(1187.6,'K')), NASAPolynomial(coeffs=[9.78135,0.0321479,-1.56529e-05,3.08954e-09,-2.20471e-13,-27904.2,-19.0279], Tmin=(1187.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cs-O2s-Cs-Cs(F)) + radical(C2CsJOCs)"""),
)

species(
    label = 'CC1([O])CC1(F)OF(4629)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.511897,0.0682045,-5.98453e-05,2.57082e-08,-4.35423e-12,-22097,23.8629], Tmin=(100,'K'), Tmax=(1421.24,'K')), NASAPolynomial(coeffs=[17.8308,0.0194616,-8.40144e-06,1.57735e-09,-1.09565e-13,-27019.8,-65.7789], Tmin=(1421.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsCsOs) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cs(C)-Cs-Cs(F)) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH2]C(F)(OF)C(=C)O(2853)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {5,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(OF)C(C)=O(2818)'],
    products = ['HF(38)', 'CH2CO(28)', 'CH2CFO(78)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(34.5876,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(OF)=C(C)OF(4491)'],
    products = ['[CH2]C(F)(OF)C(C)=O(2818)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(8.88952e+10,'s^-1'), n=0.725184, Ea=(168.904,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(F)=C(C)OOF(4626)'],
    products = ['[CH2]C(F)(OF)C(C)=O(2818)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4.62709e+20,'s^-1'), n=-1.9758, Ea=(123.813,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', 'CC(=O)[C](F)OF(2657)'],
    products = ['[CH2]C(F)(OF)C(C)=O(2818)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[CH]C(F)(OF)C(C)=O(4627)'],
    products = ['[CH2]C(F)(OF)C(C)=O(2818)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(F)(OF)C(C)=O(2818)'],
    products = ['CC1([O])CC1(F)OF(4629)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.34239e+09,'s^-1'), n=0.889391, Ea=(130.318,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 127.9 to 130.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(F)(OF)C(=C)O(2853)'],
    products = ['[CH2]C(F)(OF)C(C)=O(2818)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', '[CH2]C([O])(F)C(C)=O(1217)'],
    products = ['[CH2]C(F)(OF)C(C)=O(2818)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', '[CH2]C(F)(OF)C(=C)[O](4631)'],
    products = ['[CH2]C(F)(OF)C(C)=O(2818)'],
...
reaction(
    label = 'reaction20',
    reactants = ['F2(77)', '[CH2]C(=O)C(C)=O(1206)'],
    products = ['[CH2]C(F)(OF)C(C)=O(2818)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.000118654,'m^3/(mol*s)'), n=2.63647, Ea=(72.9003,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='YY',), comment="""Estimated from node YY
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(179.766,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)

network(
    label = 'PDepNetwork #1389',
    isomers = [
        '[CH2]C(F)(OF)C(C)=O(2818)',
    ],
    reactants = [
