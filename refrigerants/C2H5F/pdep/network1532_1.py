...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.245063,'amu*angstrom^2'), symmetry=1, barrier=(5.63447,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0447,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4007,0.0400183,-6.70839e-05,6.33541e-08,-2.34491e-11,22392.7,15.1622], Tmin=(100,'K'), Tmax=(805.332,'K')), NASAPolynomial(coeffs=[5.11371,0.0177311,-9.15907e-06,1.81596e-09,-1.27909e-13,22241.4,4.43506], Tmin=(805.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CH2F(46)', 'C2HF(57)'],
    products = ['[CH]=C(F)CF(5467)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(F)CF(5467)'],
    products = ['C=C(F)[CH]F(5585)'],
