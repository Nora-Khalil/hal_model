...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'O=[C]C[C](F)F(3697)'],
    products = ['[O]C(=O)C[C](F)F(4421)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(=O)C=C(F)F(4628)'],
    products = ['[O]C(=O)C[C](F)F(4421)'],
