...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(271)', '[CH]=C[O](452)'],
    products = ['[CH]=CO[C]=C(625)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=[CH](272)', '[CH2][C]=O(504)'],
    products = ['[CH]=CO[C]=C(625)'],
    transitionState = 'TS8',
