...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.25136,'amu*angstrom^2'), symmetry=1, barrier=(28.7713,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11342,0.0322143,7.09113e-06,-3.0528e-08,1.34866e-11,-30461.3,21.5844], Tmin=(100,'K'), Tmax=(993.042,'K')), NASAPolynomial(coeffs=[10.4677,0.0202818,-7.69126e-06,1.42021e-09,-1.01067e-13,-33191.4,-24.0537], Tmin=(993.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-253.903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(CsCFFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cs-Cs(F)(F)-O2s-Cs) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)
...
"""),
    E0 = (33.8749,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,350,440,435,1725,326,540,652,719,1357,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,934.869],'cm^-1')),
        HinderedRotor(inertia=(0.00589234,'amu*angstrom^2'), symmetry=1, barrier=(44.3288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.92804,'amu*angstrom^2'), symmetry=1, barrier=(44.3294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.928,'amu*angstrom^2'), symmetry=1, barrier=(44.3284,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38261,0.0610437,-6.79319e-05,4.10145e-08,-1.02028e-11,4165.57,21.6264], Tmin=(100,'K'), Tmax=(962.648,'K')), NASAPolynomial(coeffs=[9.99865,0.0252421,-1.21456e-05,2.38033e-09,-1.69404e-13,2506.74,-19.6129], Tmin=(962.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.8749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFO) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)C([O])(F)F(7484)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C([CH2])=C(F)F(6939)'],
    products = ['[CH2]C(=C)C([O])(F)F(7484)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'C=[C]C([O])(F)F(7759)'],
    products = ['[CH2]C(=C)C([O])(F)F(7484)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=C)C(=O)F(6822)'],
    products = ['[CH2]C(=C)C([O])(F)F(7484)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH2])=C(F)OF(8106)'],
    products = ['[CH2]C(=C)C([O])(F)F(7484)'],
