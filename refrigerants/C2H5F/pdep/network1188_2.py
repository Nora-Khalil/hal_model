...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.94638,0.0252443,-3.64305e-05,2.70906e-08,-8.00057e-12,25225.4,12.0644], Tmin=(100,'K'), Tmax=(828.36,'K')), NASAPolynomial(coeffs=[6.68719,0.00718076,-3.72124e-06,7.66299e-10,-5.59274e-14,24605.7,-5.27847], Tmin=(828.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(7)', 'C2HF(57)'],
    products = ['[CH]=C(O)F(416)'],
    transitionState = 'TS1',
