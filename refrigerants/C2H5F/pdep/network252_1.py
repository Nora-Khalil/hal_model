...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(136)', '[CH2]C[CH2](129)'],
    products = ['[CH2]CC[C]=O(611)'],
    transitionState = 'TS4',
