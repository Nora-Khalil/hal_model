...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(F)[CH]F(5593)'],
    products = ['[CH]=C(C)C(F)[CH]F(6151)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', '[CH]C(C)=CF(6186)'],
    products = ['[CH]=C(C)C(F)[CH]F(6151)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH]=C(C)C=CF(6162)'],
    products = ['[CH]=C(C)C(F)[CH]F(6151)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(C)C(F)=CF(6482)'],
    products = ['[CH]=C(C)C(F)[CH]F(6151)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'C#CC(F)[CH]F(5601)'],
    products = ['[CH]=C(C)C(F)[CH]F(6151)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHF(40)', '[CH]C(C)=CF(6186)'],
    products = ['[CH]=C(C)C(F)[CH]F(6151)'],
