...
"""),
    E0 = (138.526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,615,860,1140,1343,3152,1685,370,167,640,1190,180,180,180,1007.04],'cm^-1')),
        HinderedRotor(inertia=(0.186473,'amu*angstrom^2'), symmetry=1, barrier=(4.28738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.186443,'amu*angstrom^2'), symmetry=1, barrier=(4.2867,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56464,0.0627931,-0.000113167,1.0939e-07,-4.02569e-11,16739.6,26.1926], Tmin=(100,'K'), Tmax=(842.257,'K')), NASAPolynomial(coeffs=[4.76997,0.0274383,-1.43478e-05,2.79303e-09,-1.9306e-13,16913.8,15.5181], Tmin=(842.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(C=CJO) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79733,0.0412783,-2.77249e-05,4.84141e-09,1.16267e-12,-30185,16.8871], Tmin=(100,'K'), Tmax=(1118.74,'K')), NASAPolynomial(coeffs=[12.7593,0.0136331,-6.14284e-06,1.20777e-09,-8.73176e-14,-33360.4,-40.4579], Tmin=(1118.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-Cds(Cds-Cds)O2s) + group(CdCCF) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_cyclic(Cd(F)=CdOs) + ring(Cyclobutene)"""),
)
...
"""),
    E0 = (154.122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([615,860,1140,1343,3152,1685,370,2175,525,239,401,1367,180,180,180,1599.3],'cm^-1')),
        HinderedRotor(inertia=(1.56733,'amu*angstrom^2'), symmetry=1, barrier=(36.036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00415888,'amu*angstrom^2'), symmetry=1, barrier=(7.54617,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77423,0.0575674,-0.000106249,1.04393e-07,-3.91781e-11,18608.3,23.3934], Tmin=(100,'K'), Tmax=(824.108,'K')), NASAPolynomial(coeffs=[4.71458,0.0250439,-1.3831e-05,2.75644e-09,-1.93339e-13,18743.5,13.537], Tmin=(824.108,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Ct-CtOs) + group(CtCF) + radical(C=CJO)"""),
)
...
"""),
    E0 = (173.34,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2175,525,167,640,1190,239,401,1367,302.485,302.63,302.982],'cm^-1')),
        HinderedRotor(inertia=(0.0630063,'amu*angstrom^2'), symmetry=1, barrier=(4.09075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.475318,'amu*angstrom^2'), symmetry=1, barrier=(30.9788,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.047,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43206,0.0633845,-0.000111961,1.01845e-07,-3.58976e-11,20933.8,21.8578], Tmin=(100,'K'), Tmax=(819.604,'K')), NASAPolynomial(coeffs=[7.9153,0.0199737,-1.09721e-05,2.1791e-09,-1.52513e-13,20266.4,-5.7187], Tmin=(819.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Ct-CtOs) + group(CtCF) + radical(Cdj(Cd-O2sH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.550564,0.0771166,-0.000113939,7.83257e-08,-2.05513e-11,13302,22.2023], Tmin=(100,'K'), Tmax=(946.006,'K')), NASAPolynomial(coeffs=[16.9659,0.00770696,-3.88137e-06,7.65826e-10,-5.45015e-14,10196.2,-56.0811], Tmin=(946.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Ct-CtOs) + group(CtCF) + radical(CCsJOCs) + radical(Csj(Cs-O2sHH)(F1s)(H))"""),
)

species(
    label = '[CH]=C(F)OC=[C]F(7881)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {7,S}
3 O u0 p2 c0 {4,S} {5,S}
...
"""),
    E0 = (141.025,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,293,496,537,1218,3120,650,792.5,1650,167,640,1190,180,180,1943.17],'cm^-1')),
        HinderedRotor(inertia=(0.488007,'amu*angstrom^2'), symmetry=1, barrier=(11.2203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.90529,'amu*angstrom^2'), symmetry=1, barrier=(43.8063,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2518,0.0681378,-0.000118453,1.08055e-07,-3.8114e-11,17052.9,24.2479], Tmin=(100,'K'), Tmax=(832.418,'K')), NASAPolynomial(coeffs=[7.51965,0.0236617,-1.24367e-05,2.42869e-09,-1.68368e-13,16506.8,-1.85338], Tmin=(832.418,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.025,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(CdCFO) + group(Cds-CdsHH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + radical(Cdj(Cd-F1sO2s)(H)) + radical(Cdj(Cd-O2sH)(F1s))"""),
)

species(
    label = 'C#CO[CH][C](F)F(7882)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {5,S}
2 F u0 p3 c0 {5,S}
3 O u0 p2 c0 {4,S} {6,S}
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=CF(1436)', 'O=C[C]F(1545)'],
    products = ['F[C]=CO[C]=CF(7789)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['F[C]=CO[C]=CF(7789)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(39.621,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    ...
    products = ['F[C]=CO[C]=CF(7789)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(102.662,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction6',
    reactants = ['H(6)', 'FC#CO[C]=CF(7876)'],
    products = ['F[C]=CO[C]=CF(7789)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['F[C]=CO[C]=CF(7789)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(6.2595,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction10',
    reactants = ['F[C]=CO[C]=CF(7789)'],
    products = ['FC=[C]O[C]=CF(7878)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F[C]=CO[C]=CF(7789)'],
    products = ['C#CO[CH][C](F)F(7882)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(135.691,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
