...
reaction(
    label = 'reaction1',
    reactants = ['CHF2(81)', 'CH2CHF(55)'],
    products = ['[CH2]C(F)C(F)F(3448)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)C(F)F(3448)'],
    products = ['F[CH]CC(F)F(2516)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'CHF2-CHF(66)'],
    products = ['[CH2]C(F)C(F)F(3448)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[CH]C(F)C(F)F(3700)'],
    products = ['[CH2]C(F)C(F)F(3448)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'C=C(F)C(F)F(3701)'],
    products = ['[CH2]C(F)C(F)F(3448)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2][CH]C(F)F(3563)'],
    products = ['[CH2]C(F)C(F)F(3448)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(F)[CH]F(890)'],
    products = ['[CH2]C(F)C(F)F(3448)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF2(81)', '[CH2][CH]F(839)'],
    products = ['[CH2]C(F)C(F)F(3448)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2][C](F)C(F)F(3702)'],
    products = ['[CH2]C(F)C(F)F(3448)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(F)[C](F)F(3703)'],
    products = ['[CH2]C(F)C(F)F(3448)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C=C(F)[CH]F(3704)'],
    products = ['[CH2]C(F)C(F)F(3448)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2]C=C(F)F(3705)'],
    products = ['[CH2]C(F)C(F)F(3448)'],
