...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C([O])=O(4420)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][C](F)C(=O)OF(3983)'],
    products = ['[CH2]C(F)(F)C([O])=O(4420)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[O]C(=O)[C](F)F(4630)'],
    products = ['[CH2]C(F)(F)C([O])=O(4420)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH2]C(F)(F)[C]=O(4598)'],
    products = ['[CH2]C(F)(F)C([O])=O(4420)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)(F)C([O])=O(4420)'],
    products = ['[CH2]C(F)(F)[C]1OO1(4631)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=C(F)C([O])=O(1308)'],
    products = ['[CH2]C(F)(F)C([O])=O(4420)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CO2(14)', '[CH2][C](F)F(4220)'],
    products = ['[CH2]C(F)(F)C([O])=O(4420)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(625)', '[CH2][C](F)F(4220)'],
    products = ['[CH2]C(F)(F)C([O])=O(4420)'],
