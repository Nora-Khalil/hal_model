...
"""),
    E0 = (-384.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([451,553,637,1069,1180,1265,1301,3056,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1769.12],'cm^-1')),
        HinderedRotor(inertia=(0.300758,'amu*angstrom^2'), symmetry=1, barrier=(6.91502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3008,'amu*angstrom^2'), symmetry=1, barrier=(6.91599,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.0504,'amu'),
...
reaction(
    label = 'reaction5',
    reactants = ['F[CH]OF(1980)', 'CH3O(27)'],
    products = ['COC(F)OF(2851)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(F)OF(2929)', 'CH3(19)'],
    products = ['COC(F)OF(2851)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]F(160)', 'CO[CH]F(2031)'],
    products = ['COC(F)OF(2851)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(F)OF(2931)'],
    products = ['COC(F)OF(2851)'],
    transitionState = 'TS9',
