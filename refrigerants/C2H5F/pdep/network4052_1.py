...
"""),
    E0 = (-348.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([122,584,932,1043,1247,1392,1461,2986,3039,3010,987.5,1337.5,450,1655,493,600,700,1144,1293,1685,370,228.973,229.069,231.876],'cm^-1')),
        HinderedRotor(inertia=(0.628185,'amu*angstrom^2'), symmetry=1, barrier=(24.1965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.632559,'amu*angstrom^2'), symmetry=1, barrier=(24.1452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.627498,'amu*angstrom^2'), symmetry=1, barrier=(24.1578,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.779978,0.0587779,-3.91633e-05,-1.56647e-09,7.04079e-12,-41760.6,28.0067], Tmin=(100,'K'), Tmax=(998.281,'K')), NASAPolynomial(coeffs=[19.615,0.00924056,-3.69471e-06,7.68782e-10,-6.06521e-14,-46813.3,-69.3007], Tmin=(998.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-348.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Csj(F1s)(F1s)(O2s-Cd)) + radical(Cdj(Cs-F1sHH)(Cd-O2sH))"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17236,0.0515677,-2.88374e-05,-5.31464e-09,6.866e-12,-75007.4,21.408], Tmin=(100,'K'), Tmax=(1013.69,'K')), NASAPolynomial(coeffs=[16.5191,0.0133851,-5.44639e-06,1.07687e-09,-8.04974e-14,-79268.4,-58.5099], Tmin=(1013.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-624.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFFO) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(O2s-Cd-Cd-Cs(F)(F))"""),
)

species(
    label = 'FC=C=COC(F)F(9255)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.197418,0.0703813,-7.58827e-05,3.84193e-08,-7.33449e-12,-75372.8,25.4351], Tmin=(100,'K'), Tmax=(1396.57,'K')), NASAPolynomial(coeffs=[20.7879,0.00620166,-1.35912e-06,1.75935e-10,-1.08024e-14,-80616.3,-78.9622], Tmin=(1396.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-627.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsFFHO) + group(Cds-CdsOsH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (-413.515,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,493,600,700,1144,1293,113,247,382,1207,3490,540,610,2055,490.606,490.622,490.695,490.697],'cm^-1')),
        HinderedRotor(inertia=(0.132374,'amu*angstrom^2'), symmetry=1, barrier=(22.6077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132279,'amu*angstrom^2'), symmetry=1, barrier=(22.6064,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.84547,0.0592454,-4.88783e-05,8.62317e-09,4.01387e-12,-49611.7,25.3768], Tmin=(100,'K'), Tmax=(972.184,'K')), NASAPolynomial(coeffs=[19.2661,0.00611852,-1.87617e-06,3.70992e-10,-3.03599e-14,-54264.4,-68.4806], Tmin=(972.184,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-413.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsFFHO) + group(Cds-CdsOsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Csj(F1s)(F1s)(O2s-Cd))"""),
)
...
"""),
    E0 = (-386.32,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([319,1023,1071,1259,1317,1409,3054,3019,493,600,700,1144,1293,2100,2250,500,550,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.21811,'amu*angstrom^2'), symmetry=1, barrier=(28.0069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22004,'amu*angstrom^2'), symmetry=1, barrier=(28.0512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22028,'amu*angstrom^2'), symmetry=1, barrier=(28.0567,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.588898,0.0718805,-9.05377e-05,5.45864e-08,-1.26142e-11,-46337.9,23.747], Tmin=(100,'K'), Tmax=(1072.13,'K')), NASAPolynomial(coeffs=[17.1921,0.00993551,-3.87082e-06,6.952e-10,-4.77737e-14,-49898,-57.5099], Tmin=(1072.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-386.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(CsFFHO) + group(Ct-CtCs) + group(Ct-CtOs) + radical(Csj(F1s)(F1s)(O2s-Ct))"""),
)
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11359,0.0609612,-6.20377e-05,3.11089e-08,-6.16134e-12,-42244,28.6318], Tmin=(100,'K'), Tmax=(1221.73,'K')), NASAPolynomial(coeffs=[14.5964,0.016818,-7.84013e-06,1.5347e-09,-1.0964e-13,-45538.5,-39.1151], Tmin=(1221.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-352.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Csj(F1s)(F1s)(O2s-Cd)) + radical(C=CJO)"""),
)

species(
    label = 'FC[C]=[C]OC(F)F(11297)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-322.928,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([122,584,932,1043,1247,1392,1461,2986,3039,519,593,830,1115,1166,1389,1413,3114,1670,1700,300,440,257.89,257.892,257.893],'cm^-1')),
        HinderedRotor(inertia=(0.407589,'amu*angstrom^2'), symmetry=1, barrier=(19.2364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.407578,'amu*angstrom^2'), symmetry=1, barrier=(19.2364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.407588,'amu*angstrom^2'), symmetry=1, barrier=(19.2363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.952621,0.0645543,-6.8518e-05,3.56199e-08,-7.27628e-12,-38727.4,28.2428], Tmin=(100,'K'), Tmax=(1190.04,'K')), NASAPolynomial(coeffs=[15.3319,0.0162226,-7.59818e-06,1.49253e-09,-1.06969e-13,-42149.8,-43.6309], Tmin=(1190.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-322.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cdj(Cs-F1sHH)(Cd-O2sH)) + radical(C=CJO)"""),
)

species(
    label = 'F[CH][C]=COC(F)F(9260)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.518044,0.064745,-5.0293e-05,6.15863e-09,5.2799e-12,-51751,26.1415], Tmin=(100,'K'), Tmax=(984.872,'K')), NASAPolynomial(coeffs=[20.8872,0.00778674,-2.7918e-06,5.72286e-10,-4.59793e-14,-57013,-78.1623], Tmin=(984.872,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-431.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-O2sH))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3442)', '[O]C=[C]CF(11198)'],
    products = ['FC[C]=CO[C](F)F(11125)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['FC[C]=CO[C](F)F(11125)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(38.2438,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC=C=CO[C](F)F(9256)'],
    products = ['FC[C]=CO[C](F)F(11125)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', '[O]C=[C]CF(11198)'],
    products = ['FC[C]=CO[C](F)F(11125)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(15.5969,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['FC[C]=CO[C](F)F(11125)'],
    products = ['F[CH]C=CO[C](F)F(9258)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(141.182,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.36622e+11,'s^-1'), n=0.48217, Ea=(104.695,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-2R!H-R',), comment="""Estimated from node R2F_Ext-2R!H-R"""),
)
