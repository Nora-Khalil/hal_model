...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])(F)F(7573)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])(F)F(7398)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]OC(=O)F(2073)'],
    products = ['[CH2]OC([O])(F)F(7398)'],
    transitionState = 'TS6',
