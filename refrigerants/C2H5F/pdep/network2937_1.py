...
reaction(
    label = 'reaction1',
    reactants = ['[C-]=[O+]OC(=O)F(9449)'],
    products = ['CO(13)', 'O=C(O)F(2293)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', '[C-]=[O+]OF(9510)'],
    products = ['[C-]=[O+]OC(=O)F(9449)'],
    transitionState = 'TS2',
