...
"""),
    ...
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.97423,0.00160452,8.35186e-05,-1.52693e-07,8.98612e-11,34800.6,10.9445], Tmin=(10,'K'), Tmax=(438.869,'K')), NASAPolynomial(coeffs=[0.579353,0.0324763,-2.17571e-05,6.86215e-09,-8.2079e-13,35099.2,24.5347], Tmin=(438.869,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(289.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""[C]1DCOOC1""", comment="""Thermo library: 2-BTP_G4"""),
)

species(
    label = 'C=[C]C1OO1(8380)',
    structure = adjacencyList("""multiplicity 2
1 O u0 p2 c0 {2,S} {3,S}
...
"""),
    ...
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.85796,0.0129864,4.04035e-05,-8.20453e-08,4.45545e-11,34431.8,10.0398], Tmin=(10,'K'), Tmax=(630.79,'K')), NASAPolynomial(coeffs=[3.46732,0.0261664,-1.6389e-05,4.87579e-09,-5.55447e-13,34268.1,10.0566], Tmin=(630.79,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(286.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""CD[C]C1OO1""", comment="""Thermo library: 2-BTP_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH]=C=C(4381)'],
    products = ['C=C=CO[O](6364)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C=CO[O](6364)'],
    products = ['C=C1[CH]OO1(8379)'],
    transitionState = 'TS3',
