...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH2]C([O])F(527)'],
    products = ['[O]CC([O])F(1656)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]F(1657)', '[CH2][O](131)'],
    products = ['[O]CC([O])F(1656)'],
