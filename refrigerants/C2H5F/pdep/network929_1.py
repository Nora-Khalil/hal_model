...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)OCOF(2947)'],
    products = ['HF(38)', 'CH2O(20)', 'CC(=O)F(253)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['OCOF(397)', 'C[C]F(124)'],
    products = ['CC(F)OCOF(2947)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'FCOCOF(2384)'],
    products = ['CC(F)OCOF(2947)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]COF(399)', 'CH3-CHF(62)'],
    products = ['CC(F)OCOF(2947)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]OF(278)', 'CC([O])F(249)'],
    products = ['CC(F)OCOF(2947)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(357)', '[CH2]OC(C)F(392)'],
    products = ['CC(F)OCOF(2947)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'F[CH]OCOF(2393)'],
    products = ['CC(F)OCOF(2947)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[CH2]C(F)OCOF(2966)'],
    products = ['CC(F)OCOF(2947)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'CC(F)O[CH]OF(2769)'],
    products = ['CC(F)OCOF(2947)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC(F)OC=O(1103)'],
    products = ['CC(F)OCOF(2947)'],
