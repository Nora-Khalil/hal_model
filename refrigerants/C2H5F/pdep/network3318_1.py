...
"""),
    E0 = (322.818,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,113,247,382,1207,3490,540,610,2055,180,180,180,2020.81,2021.82,2023.66,2025.42],'cm^-1')),
        HinderedRotor(inertia=(0.0105377,'amu*angstrom^2'), symmetry=1, barrier=(9.07517,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89127,0.0568516,-0.000107093,1.09177e-07,-4.15606e-11,38891.9,19.3794], Tmin=(100,'K'), Tmax=(848.451,'K')), NASAPolynomial(coeffs=[2.44671,0.0296304,-1.54718e-05,3.00943e-09,-2.07715e-13,39683.1,22.0095], Tmin=(848.451,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (429.973,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,113,247,382,1207,3490,540,563.333,586.667,610,1970,2140,180,841.645,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.675135,'amu*angstrom^2'), symmetry=1, barrier=(15.5227,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82694,0.0587363,-0.000116437,1.17761e-07,-4.40917e-11,51781.5,18.5371], Tmin=(100,'K'), Tmax=(854.501,'K')), NASAPolynomial(coeffs=[3.38868,0.0258594,-1.38454e-05,2.70678e-09,-1.86625e-13,52448,16.7097], Tmin=(854.501,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CdCddFH) + group(CsJ2_singlet-CsH) + group(Cdd-CdsCds) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[OH+]=[C-]C=C=CF(10170)'],
    products = ['CO(13)', 'C#CCF(5582)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[OH2+][C-]=C=C=CF(10546)'],
    products = ['[OH+]=[C-]C=C=CF(10170)'],
    transitionState = 'TS2',
