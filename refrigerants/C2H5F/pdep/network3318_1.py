...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41657,0.0441628,-2.13724e-05,4.43493e-09,-3.45698e-13,32949.7,19.7795], Tmin=(100,'K'), Tmax=(3340.94,'K')), NASAPolynomial(coeffs=[20.6508,0.0174331,-7.17213e-06,1.16249e-09,-6.79856e-14,23499.7,-86.0937], Tmin=(3340.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCCFH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
"""),
    E0 = (256.499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,3120,650,792.5,1650,220.652],'cm^-1')),
        HinderedRotor(inertia=(0.00629427,'amu*angstrom^2'), symmetry=1, barrier=(21.9814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.999831,'amu*angstrom^2'), symmetry=1, barrier=(22.9881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.960189,'amu*angstrom^2'), symmetry=1, barrier=(22.0766,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.835828,0.0611635,-4.43205e-05,1.28516e-08,-3.25199e-13,30970.8,26.4786], Tmin=(100,'K'), Tmax=(1093.8,'K')), NASAPolynomial(coeffs=[14.5771,0.0232001,-9.11017e-06,1.66186e-09,-1.15137e-13,27229.7,-44.4074], Tmin=(1093.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_P)"""),
)
...
"""),
    E0 = (346.193,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,1685,370,167,640,1190,322.919,324.169],'cm^-1')),
        HinderedRotor(inertia=(0.110045,'amu*angstrom^2'), symmetry=1, barrier=(8.14085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109238,'amu*angstrom^2'), symmetry=1, barrier=(8.13362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109946,'amu*angstrom^2'), symmetry=1, barrier=(8.13548,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27396,0.0632862,-6.16442e-05,3.48387e-08,-8.39462e-12,41732.8,25.1941], Tmin=(100,'K'), Tmax=(976.97,'K')), NASAPolynomial(coeffs=[8.74242,0.032708,-1.46954e-05,2.80154e-09,-1.96473e-13,40273.5,-10.6628], Tmin=(976.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cdj(Cd-CsCs)(F1s))"""),
)

species(
    label = 'C=CCC(=C)[C]F(9573)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {7,S}
2  C u0 p0 c0 {3,S} {4,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74562,0.0346078,2.96958e-05,-6.01148e-08,2.41421e-11,-675.252,18.026], Tmin=(100,'K'), Tmax=(1006.17,'K')), NASAPolynomial(coeffs=[13.1575,0.0253246,-1.0259e-05,2.00105e-09,-1.47508e-13,-4798.27,-46.1766], Tmin=(1006.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.39875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(CsCCFH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.848692,0.0606697,-3.74241e-05,9.51058e-09,-3.36134e-13,27613.4,26.8645], Tmin=(100,'K'), Tmax=(1223.41,'K')), NASAPolynomial(coeffs=[12.9575,0.0306363,-1.2318e-05,2.21465e-09,-1.50003e-13,23935.4,-36.9179], Tmin=(1223.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(134)', '[CH2]C([CH2])=CF(6739)'],
    products = ['[CH2]C(=CF)C[C]=C(8586)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#CCC([CH2])=CF(8632)'],
    products = ['[CH2]C(=CF)C[C]=C(8586)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]F(837)', 'C=[C]C[C]=C(6757)'],
    products = ['[CH2]C(=CF)C[C]=C(8586)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CHF(40)', 'C=[C]C[C]=C(6757)'],
    products = ['[CH2]C(=CF)C[C]=C(8586)'],
