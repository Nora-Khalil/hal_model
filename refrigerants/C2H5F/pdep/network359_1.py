...
reaction(
    label = 'reaction2',
    reactants = ['C=C(F)[C-][O+]=O(1162)'],
    products = ['[C-]=[O+]OC(=C)F(1018)'],
    transitionState = 'TS2',
