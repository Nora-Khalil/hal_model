...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH]C(=O)F(502)'],
    products = ['[CH]=C(F)O[CH2](5356)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](318)', '[CH]=[C]F(488)'],
    products = ['[CH]=C(F)O[CH2](5356)'],
    transitionState = 'TS7',
