...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C[C](F)F(4452)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C[C](F)F(4452)'],
    products = ['[CH2]C(F)C([CH2])(F)F(4451)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[CH]CC[C](F)F(4454)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.53e+06,'s^-1'), n=1.73, Ea=(245.601,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [cCs(-HH)CJ;CsJ;C]
Euclidian distance = 0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(3442)', '[CH2]C([CH2])F(858)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[CH]C[C](F)F(3551)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2CF2(56)', '[CH2][CH]F(839)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)C=C(F)F(4507)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=CC[C](F)F(4481)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C](F)F(4220)', 'CH2CHF(55)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C(F)C[C](F)F(4508)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C](F)F(4220)', '[CH2][CH]F(839)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2]C=C[C](F)F(2624)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CF2(43)', '[CH2]C([CH2])F(858)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(F)[CH]C(F)F(4509)'],
    products = ['[CH2]C(F)C[C](F)F(4452)'],
