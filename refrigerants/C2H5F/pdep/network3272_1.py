...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.817299,'amu*angstrom^2'), symmetry=1, barrier=(18.7913,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32069,0.0655186,-0.000101237,9.10535e-08,-3.28747e-11,22025.8,23.2462], Tmin=(100,'K'), Tmax=(797.326,'K')), NASAPolynomial(coeffs=[6.36979,0.0299619,-1.51059e-05,2.95076e-09,-2.06474e-13,21545.7,2.06924], Tmin=(797.326,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50959,0.0559344,-5.75418e-05,3.15784e-08,-7.06886e-12,-16835.3,19.6187], Tmin=(100,'K'), Tmax=(1069.89,'K')), NASAPolynomial(coeffs=[10.5964,0.0219616,-9.91161e-06,1.89931e-09,-1.33808e-13,-18779.6,-24.8339], Tmin=(1069.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-140.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(CdCFH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,540,610,2055,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(1.34246,'amu*angstrom^2'), symmetry=1, barrier=(30.8657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54808,0.0610422,-7.70768e-05,3.84595e-08,1.78337e-12,13912.3,19.4632], Tmin=(100,'K'), Tmax=(572.341,'K')), NASAPolynomial(coeffs=[8.99093,0.0223908,-1.08069e-05,2.06889e-09,-1.43134e-13,12841.4,-14.2033], Tmin=(572.341,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(CdCddCF) + group(CdCFH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cdj(Cd-CdH)(F1s))"""),
)
...
"""),
    E0 = (190.241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,2175,525,239,401,1367,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.738805,'amu*angstrom^2'), symmetry=1, barrier=(16.9866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48905,'amu*angstrom^2'), symmetry=1, barrier=(34.2361,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46332,0.0637165,-0.000106854,9.93411e-08,-3.57248e-11,22964.4,21.3281], Tmin=(100,'K'), Tmax=(842.708,'K')), NASAPolynomial(coeffs=[5.54912,0.0279008,-1.38721e-05,2.65883e-09,-1.82684e-13,22858.9,5.77547], Tmin=(842.708,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(CtCF) + radical(Cds_S)"""),
)

species(
    label = 'C#CC(F)C=[C]F(9061)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {6,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.5066,'amu*angstrom^2'), symmetry=1, barrier=(34.6397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50532,'amu*angstrom^2'), symmetry=1, barrier=(34.6102,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28272,0.0642867,-9.67592e-05,7.95462e-08,-2.59045e-11,13382.6,20.5282], Tmin=(100,'K'), Tmax=(838.037,'K')), NASAPolynomial(coeffs=[8.84793,0.0220339,-1.01346e-05,1.8878e-09,-1.28151e-13,12330.4,-13.3458], Tmin=(838.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(CdCFH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (467.488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,540,610,2055,137,207,812,180],'cm^-1')),
        HinderedRotor(inertia=(1.82931,'amu*angstrom^2'), symmetry=1, barrier=(42.0594,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.0755,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72037,0.0487787,-5.5891e-05,3.38718e-08,-8.09861e-12,56309.1,18.7951], Tmin=(100,'K'), Tmax=(1026.38,'K')), NASAPolynomial(coeffs=[10.648,0.0139873,-5.04676e-06,8.47937e-10,-5.51056e-14,54476.5,-24.5082], Tmin=(1026.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(467.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(C=CJC=C) + radical(Cdj(Cdd-Cd)(F1s))"""),
)

species(
    label = '[CH2]C=C(F)C=[C]F(9063)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57625,0.0531204,-4.89249e-05,2.40015e-08,-4.83925e-12,5473.19,21.4142], Tmin=(100,'K'), Tmax=(1174.78,'K')), NASAPolynomial(coeffs=[10.5445,0.0225849,-9.93652e-06,1.87651e-09,-1.30986e-13,3366.03,-23.297], Tmin=(1174.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.7799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCCF) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(C=CC=CCJ) + radical(Cdj(Cd-CdH)(F1s))"""),
)
...
"""),
    E0 = (191.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3120,650,792.5,1650,167,640,1190,180],'cm^-1')),
        HinderedRotor(inertia=(0.927497,'amu*angstrom^2'), symmetry=1, barrier=(21.325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.928814,'amu*angstrom^2'), symmetry=1, barrier=(21.3553,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62504,0.0593389,-6.88493e-05,3.40384e-08,8.38748e-13,23127.4,22.1409], Tmin=(100,'K'), Tmax=(562.533,'K')), NASAPolynomial(coeffs=[7.49872,0.028199,-1.41487e-05,2.79136e-09,-1.97908e-13,22298.5,-4.31145], Tmin=(562.533,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdCFH) + radical(Cds_P) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = 'C=CC(F)[C]=[C]F(9066)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {1,S} {4,S} {6,S} {8,S}
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27475,0.0660642,-0.00010038,8.84408e-08,-3.15104e-11,21664.5,23.3241], Tmin=(100,'K'), Tmax=(785.887,'K')), NASAPolynomial(coeffs=[6.98207,0.0290805,-1.46456e-05,2.86514e-09,-2.009e-13,21012.5,-1.27632], Tmin=(785.887,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', 'F[C]C=CF(2617)'],
    products = ['C=[C]C(F)C=[C]F(8543)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['C=[C]C(F)C=[C]F(8543)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(21.7207,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=[C]C(F)C#CF(9060)'],
    products = ['C=[C]C(F)C=[C]F(8543)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C#CC(F)C=[C]F(9061)'],
    products = ['C=[C]C(F)C=[C]F(8543)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'C=[C]C=C=[C]F(9062)'],
    products = ['C=[C]C(F)C=[C]F(8543)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.00763e+12,'s^-1'), n=0.18834, Ea=(115.608,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R2F_Ext-1R!H-R_4R!H->C',), comment="""Estimated from node R2F_Ext-1R!H-R_4R!H->C"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(154.322,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

network(
    label = 'PDepNetwork #3272',
    isomers = [
        'C=[C]C(F)C=[C]F(8543)',
    ],
    reactants = [
