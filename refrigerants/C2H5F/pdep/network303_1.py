...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]OC[O](358)'],
    products = ['[CH2]OC(C)[O](391)'],
    transitionState = 'TS2',
