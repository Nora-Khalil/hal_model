...
"""),
    E0 = (-156.332,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([286,334,437,422,648,895,1187,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,239,401,1367,256.116,1407.13],'cm^-1')),
        HinderedRotor(inertia=(0.159338,'amu*angstrom^2'), symmetry=1, barrier=(7.05363,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162871,'amu*angstrom^2'), symmetry=1, barrier=(7.05113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150627,'amu*angstrom^2'), symmetry=1, barrier=(7.00138,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.765712,0.0766493,-0.000108259,8.87197e-08,-2.96002e-11,-18691.1,25.9945], Tmin=(100,'K'), Tmax=(797.185,'K')), NASAPolynomial(coeffs=[8.64512,0.0321008,-1.50043e-05,2.84576e-09,-1.96351e-13,-19788.1,-9.23409], Tmin=(797.185,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(CtCF) + radical(O2sj(Cs-F1sCsCs))"""),
)
...
"""),
    E0 = (-164.342,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([286,334,437,422,648,895,1187,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,167,640,1190,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.21307,'amu*angstrom^2'), symmetry=1, barrier=(4.89891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213112,'amu*angstrom^2'), symmetry=1, barrier=(4.89986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213042,'amu*angstrom^2'), symmetry=1, barrier=(4.89825,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.803907,0.0754516,-8.81237e-05,5.84017e-08,-1.61123e-11,-19655.2,27.0535], Tmin=(100,'K'), Tmax=(869.733,'K')), NASAPolynomial(coeffs=[9.89791,0.0336281,-1.59938e-05,3.11396e-09,-2.20434e-13,-21237.1,-15.5508], Tmin=(869.733,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-164.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(O2sj(Cs-F1sCsCs)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (-190.827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,615,860,1140,1343,3152,1685,370,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.219946,'amu*angstrom^2'), symmetry=1, barrier=(5.05698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00520297,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221661,'amu*angstrom^2'), symmetry=1, barrier=(5.09641,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08803,'amu*angstrom^2'), symmetry=1, barrier=(25.0159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.464431,0.0838936,-0.000109412,7.93336e-08,-2.35784e-11,-22829.4,28.8523], Tmin=(100,'K'), Tmax=(815.017,'K')), NASAPolynomial(coeffs=[10.7683,0.0333241,-1.63421e-05,3.20583e-09,-2.27169e-13,-24509,-18.7506], Tmin=(815.017,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-190.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(Cs-F1sO2sCs)(H)(H)) + radical(Cdj(Cs-CsHH)(Cd-F1sH))"""),
)

species(
    label = '[CH2]C([O])(F)CC=CF(9748)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {8,S}
3  O u1 p2 c0 {5,S}
...
"""),
    ...
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.784077,0.079404,-9.45392e-05,5.11725e-08,-3.4197e-12,-24381,26.9299], Tmin=(100,'K'), Tmax=(584.399,'K')), NASAPolynomial(coeffs=[9.21624,0.035482,-1.72058e-05,3.33965e-09,-2.34453e-13,-25602,-11.236], Tmin=(584.399,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)

species(
    label = 'CC(O)(F)C[C]=[C]F(9749)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {8,S}
3  O u0 p2 c0 {4,S} {14,S}
...
"""),
    E0 = (-151.56,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,333,384,448,608,1254,1480,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,167,640,1190,180,638.415],'cm^-1')),
        HinderedRotor(inertia=(0.553893,'amu*angstrom^2'), symmetry=1, barrier=(12.7351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.55392,'amu*angstrom^2'), symmetry=1, barrier=(12.7357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0440343,'amu*angstrom^2'), symmetry=1, barrier=(12.7356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.553907,'amu*angstrom^2'), symmetry=1, barrier=(12.7354,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.724947,0.0762814,-8.48313e-05,5.0991e-08,-1.25955e-11,-18114.1,28.1557], Tmin=(100,'K'), Tmax=(970.202,'K')), NASAPolynomial(coeffs=[11.6995,0.0310338,-1.48735e-05,2.91869e-09,-2.08003e-13,-20243.5,-24.4578], Tmin=(970.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-151.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.47296,0.0831537,-0.000110942,8.37581e-08,-2.58759e-11,-21665.8,27.4517], Tmin=(100,'K'), Tmax=(786.55,'K')), NASAPolynomial(coeffs=[10.2945,0.0332042,-1.56814e-05,3.01325e-09,-2.10538e-13,-23210.8,-17.5729], Tmin=(786.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + group(CdCFH) + longDistanceInteraction_noncyclic(Cds(F)=Cds(F)) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH]=[C]CC(C)(F)OF(9752)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.687207,0.0781467,-9.35785e-05,6.27579e-08,-1.73961e-11,-20681.2,26.849], Tmin=(100,'K'), Tmax=(868.364,'K')), NASAPolynomial(coeffs=[10.4539,0.0331575,-1.58648e-05,3.09487e-09,-2.19245e-13,-22377.5,-18.8913], Tmin=(868.364,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sCsCs)) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]C(F)C[C]=CF(8528)'],
    products = ['CC([O])(F)C[C]=CF(9645)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C[C](F)C[C]=CF(8728)'],
    products = ['CC([O])(F)C[C]=CF(9645)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=CF(1334)', '[CH2]C(C)([O])F(1498)'],
    products = ['CC([O])(F)C[C]=CF(9645)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'CC(=O)C[C]=CF(9741)'],
    products = ['CC([O])(F)C[C]=CF(9645)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(22.9637,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC([O])(F)CC#CF(9743)'],
    products = ['CC([O])(F)C[C]=CF(9645)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'CC([O])=C[C]=CF(8955)'],
    products = ['CC([O])(F)C[C]=CF(9645)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(314.885,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'C=C([O])C[C]=CF(8480)'],
    products = ['CC([O])(F)C[C]=CF(9645)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(264.513,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(O)(F)C[C]=CF(9747)'],
    products = ['CC([O])(F)C[C]=CF(9645)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC([O])(F)C[C]=CF(9645)'],
    products = ['C[C]([O])CC(F)=CF(9751)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(221.665,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)

reaction(
    label = 'reaction26',
    reactants = ['[CH]=[C]CC(C)(F)OF(9752)'],
    products = ['CC([O])(F)C[C]=CF(9645)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(71.8583,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction27',
    reactants = ['CC([O])(F)C[C]=CF(9645)'],
    products = ['[CH]=C(F)CC(C)([O])F(9753)'],
