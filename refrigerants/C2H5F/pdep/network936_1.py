...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', '[CH2]C(=O)[CH]F(1179)'],
    products = ['C=C([O])C([O])F(2037)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=O)C=O(234)'],
    products = ['C=C([O])C([O])F(2037)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)F(1451)'],
    products = ['C=C([O])C([O])F(2037)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][CH]F(1657)', 'CH2CO(28)'],
    products = ['C=C([O])C([O])F(2037)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O][CH]F(1657)', '[CH2][C]=O(140)'],
    products = ['C=C([O])C([O])F(2037)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(18)', '[O]C(F)[C]=O(2142)'],
    products = ['C=C([O])C([O])F(2037)'],
