...
"""),
    E0 = (-268.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,258.643,265.393,1483.13,1484.88],'cm^-1')),
        HinderedRotor(inertia=(0.17739,'amu*angstrom^2'), symmetry=1, barrier=(8.57748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.341789,'amu*angstrom^2'), symmetry=1, barrier=(8.5306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00257543,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.625165,'amu*angstrom^2'), symmetry=1, barrier=(30.9323,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
...
"""),
    ...
    molecularWeight = (106.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.870001,0.0766359,-9.43031e-05,5.90231e-08,-1.10642e-11,-35024.7,28.4067], Tmin=(100,'K'), Tmax=(604.829,'K')), NASAPolynomial(coeffs=[8.84528,0.0346819,-1.70149e-05,3.32839e-09,-2.35012e-13,-36186.8,-7.69085], Tmin=(604.829,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C[C](F)OC[O](3339)'],
    products = ['C[C](F)OC(C)[O](3676)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C[C]F-2(838)', 'CC([O])[O](159)'],
    products = ['C[C](F)OC(C)[O](3676)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['C[C]F(124)', 'CC([O])[O](159)'],
    products = ['C[C](F)OC(C)[O](3676)'],
