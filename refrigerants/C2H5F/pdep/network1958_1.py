...
reaction(
    label = 'reaction2',
    reactants = ['F[CH]CC(F)[CH]F(5525)'],
    products = ['[CH2]C(F)C(F)[CH]F(5524)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', 'F[CH]C[CH]F(878)'],
    products = ['F[CH]CC(F)[CH]F(5525)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(837)', '[CH2]C(F)[CH]F(890)'],
    products = ['F[CH]CC(F)[CH]F(5525)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['CHFCHF[Z](58)', '[CH2][CH]F(839)'],
    products = ['F[CH]CC(F)[CH]F(5525)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[CH]CC(F)=CF(4997)'],
    products = ['F[CH]CC(F)[CH]F(5525)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F[CH][CH]F(4261)', 'CH2CHF(55)'],
    products = ['F[CH]CC(F)[CH]F(5525)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH]C(F)C=CF(5536)'],
    products = ['F[CH]CC(F)[CH]F(5525)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH][CH]F(4261)', '[CH2][CH]F(839)'],
    products = ['F[CH]CC(F)[CH]F(5525)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'F[CH]C=C[CH]F(2590)'],
    products = ['F[CH]CC(F)[CH]F(5525)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', 'F[CH]C[CH]F(878)'],
    products = ['F[CH]CC(F)[CH]F(5525)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', '[CH2]C(F)[CH]F(890)'],
    products = ['F[CH]CC(F)[CH]F(5525)'],
