...
"""),
    E0 = (61.5892,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.935925,'amu*angstrom^2'), symmetry=1, barrier=(21.5187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.939633,'amu*angstrom^2'), symmetry=1, barrier=(21.604,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47535,0.0411584,6.19997e-06,-4.79068e-08,2.44146e-11,7511.63,18.149], Tmin=(100,'K'), Tmax=(928.916,'K')), NASAPolynomial(coeffs=[17.5185,0.00892681,-1.26032e-06,1.54703e-10,-1.41365e-14,2941.16,-66.6248], Tmin=(928.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.5892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = 'C[C-]=[O+]CC(10896)',
...
"""),
    E0 = (206.903,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,273.929,276.506,278.499,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.219334,'amu*angstrom^2'), symmetry=1, barrier=(11.5755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214945,'amu*angstrom^2'), symmetry=1, barrier=(11.5973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209089,'amu*angstrom^2'), symmetry=1, barrier=(11.601,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2209,0.0423901,-2.57052e-05,7.24554e-09,-8.22847e-13,24944.8,6.12095], Tmin=(100,'K'), Tmax=(1904.7,'K')), NASAPolynomial(coeffs=[11.2375,0.0234548,-1.07932e-05,2.0262e-09,-1.37791e-13,21510,-43.1886], Tmin=(1904.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51116,0.0408255,1.07306e-05,-1.12483e-07,1.10461e-10,21420.7,16.6677], Tmin=(100,'K'), Tmax=(426.31,'K')), NASAPolynomial(coeffs=[4.51764,0.0352811,-1.64951e-05,3.17581e-09,-2.22781e-13,21128.9,7.28274], Tmin=(426.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.727,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsOsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['C2H4(30)', 'C=CO(145)'],
    products = ['C=COCC(511)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.000166771,'m^3/(mol*s)'), n=2.97, Ea=(209.409,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd/unsub_Cd/unsub;H_OR] for rate rule [Cd/unsub_Cd/unsub;H_OCdpri]
...
reaction(
    label = 'reaction4',
    reactants = ['C=COCC(511)'],
    products = ['CCCC=O(10894)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(9.39365e+11,'s^-1'), n=0.324012, Ea=(140.718,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.014478493324023197, var=15.997960675483611, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_N-1R!H-inRing_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R!H-inRing_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['C[C-]=[O+]CC(10896)'],
    products = ['C=COCC(511)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(3.54807e+17,'s^-1'), n=-1.42952, Ea=(6.38192,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.5517143818398826, var=16.398565006535087, Tref=1000.0, N=6, data_mean=0.0, correlation='CCH_Ext-3C-R_N-4R!H->Br',), comment="""Estimated from node CCH_Ext-3C-R_N-4R!H->Br
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction16',
    reactants = ['[CH]COCC(10897)'],
    products = ['C=COCC(511)'],
