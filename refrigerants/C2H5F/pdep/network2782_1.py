...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.12279,'amu*angstrom^2'), symmetry=1, barrier=(48.8071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.473976,'amu*angstrom^2'), symmetry=1, barrier=(10.8976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12631,'amu*angstrom^2'), symmetry=1, barrier=(48.888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.023,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73993,0.0546011,-7.40074e-05,5.20941e-08,-1.48106e-11,-45744.5,21.2016], Tmin=(100,'K'), Tmax=(853.081,'K')), NASAPolynomial(coeffs=[9.5043,0.0181957,-9.99601e-06,2.07156e-09,-1.51585e-13,-47069.3,-15.0234], Tmin=(853.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-380.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(F1s)(O2s-O2s)) + radical(CsF1sHO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3442)', '[O]O[CH]F(919)'],
    products = ['F[CH]OO[C](F)F(7455)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]O[C](F)F(3454)', '[CH]F(837)'],
    products = ['F[CH]OO[C](F)F(7455)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['[O]O[C](F)F(3454)', 'CHF(40)'],
    products = ['F[CH]OO[C](F)F(7455)'],
    transitionState = 'TS9',
