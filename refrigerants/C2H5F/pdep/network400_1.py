...
"""),
    E0 = (-582.761,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,333,384,448,608,1254,1480,2750,2800,2850,1350,1500,750,1050,1375,1000,528,1116,1182,1331,1402,1494,3075,3110,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.655561,'amu*angstrom^2'), symmetry=1, barrier=(15.0726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.655362,'amu*angstrom^2'), symmetry=1, barrier=(15.0681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34883,'amu*angstrom^2'), symmetry=1, barrier=(31.0122,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)(CCF)OF(1058)'],
    products = ['HF(38)', 'CH2CHF(55)', 'CC(=O)F(253)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['COF(286)', 'F[C]CCF(1086)'],
    products = ['CC(F)(CCF)OF(1058)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'CC(F)(CF)OF(1076)'],
    products = ['CC(F)(CCF)OF(1058)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FCCC(F)OF(1087)'],
    products = ['CC(F)(CCF)OF(1058)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'CC(F)(C[C]F)OF(1088)'],
    products = ['CC(F)(CCF)OF(1058)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'CC(C)(F)OF(1065)'],
    products = ['CC(F)(CCF)OF(1058)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(174)', 'CC(F)=CCF(1089)'],
    products = ['CC(F)(CCF)OF(1058)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(174)', 'C=C(F)CCF(232)'],
    products = ['CC(F)(CCF)OF(1058)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[C](CCF)OF(1090)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]CC(C)(F)OF(820)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'CC([O])(F)CCF(1091)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(357)', 'C[C](F)CCF(1092)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[C](F)OF(912)', 'CH2F-CH2(61)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'FCC[C](F)OF(842)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', '[CH2]C(C)(F)OF(807)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', 'CC(F)([CH]CF)OF(850)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[CH2]C(F)(CCF)OF(803)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', 'CC(F)(C[CH]F)OF(851)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'CC(=CCF)OF(1094)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=CC(C)(F)OF(1085)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'C=C(CCF)OF(844)'],
    products = ['CC(F)(CCF)OF(1058)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC(F)(CCF)OF(1058)'],
    products = ['F2(77)', 'CC(=O)F(253)', 'C2H4(30)'],
