...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06095,0.0289318,3.50131e-05,-7.66633e-08,3.60745e-11,-1491.54,18.4675], Tmin=(100,'K'), Tmax=(875.284,'K')), NASAPolynomial(coeffs=[14.3808,0.0108745,4.19115e-07,-3.95997e-10,3.30855e-14,-5113.18,-47.696], Tmin=(875.284,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.0907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Tetrahydrofuran) + radical(Cs_P) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C([O])OC=C(964)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (51.5562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,421.175,421.184,421.209,421.224],'cm^-1')),
        HinderedRotor(inertia=(0.149845,'amu*angstrom^2'), symmetry=1, barrier=(18.8665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149884,'amu*angstrom^2'), symmetry=1, barrier=(18.8664,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149878,'amu*angstrom^2'), symmetry=1, barrier=(18.8664,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
"""),
    E0 = (59.2526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2950,3100,1380,975,1025,1650,1685,370,361.051,361.055,361.061],'cm^-1')),
        HinderedRotor(inertia=(0.00129312,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167832,'amu*angstrom^2'), symmetry=1, barrier=(15.5258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167832,'amu*angstrom^2'), symmetry=1, barrier=(15.5257,'kJ/mol'), semiclassical=False),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.764725,'amu*angstrom^2'), symmetry=1, barrier=(17.5825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.764746,'amu*angstrom^2'), symmetry=1, barrier=(17.583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.764126,'amu*angstrom^2'), symmetry=1, barrier=(17.5688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.764518,'amu*angstrom^2'), symmetry=1, barrier=(17.5778,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.420877,0.0722259,-7.74898e-05,3.47192e-08,-3.91956e-12,14091.5,22.3545], Tmin=(100,'K'), Tmax=(924.202,'K')), NASAPolynomial(coeffs=[19.0782,0.00858272,-1.96006e-06,2.64015e-10,-1.68853e-14,9912.25,-70.1379], Tmin=(924.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COC([CH2])O(3417)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (72.9472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,215.876,221.559],'cm^-1')),
        HinderedRotor(inertia=(0.576146,'amu*angstrom^2'), symmetry=1, barrier=(19.3539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.584094,'amu*angstrom^2'), symmetry=1, barrier=(19.2978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.563921,'amu*angstrom^2'), symmetry=1, barrier=(19.3255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600606,'amu*angstrom^2'), symmetry=1, barrier=(19.3296,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.228343,0.0713606,-7.48569e-05,3.638e-08,-6.50743e-12,8944.37,28.074], Tmin=(100,'K'), Tmax=(1601.7,'K')), NASAPolynomial(coeffs=[21.5852,0.00366793,9.15171e-07,-3.10015e-10,2.34191e-14,3651.92,-82.1473], Tmin=(1601.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.9472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)
...
"""),
    E0 = (66.6045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,268.945,270.103],'cm^-1')),
        HinderedRotor(inertia=(0.348257,'amu*angstrom^2'), symmetry=1, barrier=(17.8723,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346966,'amu*angstrom^2'), symmetry=1, barrier=(17.8647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348013,'amu*angstrom^2'), symmetry=1, barrier=(17.8667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348557,'amu*angstrom^2'), symmetry=1, barrier=(17.863,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.864181,0.056518,-3.03404e-05,-1.48199e-08,1.35826e-11,8135.03,24.1894], Tmin=(100,'K'), Tmax=(935.371,'K')), NASAPolynomial(coeffs=[19.865,0.00670153,-8.67893e-07,1.06587e-10,-1.06871e-14,3205.19,-73.5605], Tmin=(935.371,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.6045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.867496,'amu*angstrom^2'), symmetry=1, barrier=(19.9454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.867923,'amu*angstrom^2'), symmetry=1, barrier=(19.9553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.870355,'amu*angstrom^2'), symmetry=1, barrier=(20.0112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.753355,0.0624088,-6.86565e-05,3.67485e-08,-7.48013e-12,7313.64,22.8827], Tmin=(100,'K'), Tmax=(1295.17,'K')), NASAPolynomial(coeffs=[17.0278,0.00849034,-1.97611e-06,2.46081e-10,-1.35071e-14,3404.69,-58.6574], Tmin=(1295.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.7732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COC(=C)O(3420)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {3,S} {5,S}
2  O u0 p2 c0 {3,S} {10,S}
3  C u0 p0 c0 {1,S} {2,S} {4,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.869082,'amu*angstrom^2'), symmetry=1, barrier=(19.9819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.868253,'amu*angstrom^2'), symmetry=1, barrier=(19.9628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.868122,'amu*angstrom^2'), symmetry=1, barrier=(19.9598,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
...
"""),
    E0 = (125.301,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,230.988,230.994,230.996,231.035,231.055],'cm^-1')),
        HinderedRotor(inertia=(1.59726,'amu*angstrom^2'), symmetry=1, barrier=(60.4766,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199691,'amu*angstrom^2'), symmetry=1, barrier=(7.56192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13645,'amu*angstrom^2'), symmetry=1, barrier=(80.9016,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01723,0.0721123,-0.000108699,9.38082e-08,-3.20847e-11,15171.4,30.851], Tmin=(100,'K'), Tmax=(843.193,'K')), NASAPolynomial(coeffs=[7.27831,0.0307101,-1.4232e-05,2.66137e-09,-1.81017e-13,14531.4,4.17919], Tmin=(843.193,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(O)OC=C(3422)',
    structure = adjacencyList("""1  O u0 p2 c0 {3,S} {4,S}
2  O u0 p2 c0 {3,S} {12,S}
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.530261,0.0711742,-8.2467e-05,4.68717e-08,-1.02632e-11,13173.6,21.0657], Tmin=(100,'K'), Tmax=(1129.15,'K')), NASAPolynomial(coeffs=[17.1327,0.0123599,-4.33578e-06,7.41585e-10,-4.96607e-14,9424.32,-61.0481], Tmin=(1129.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.456,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['C2H3(29)', '[CH2]C(=O)O(166)'],
    products = ['C=COC(=C)O(489)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH]=C(O)OC=C(3419)'],
    products = ['C=COC(=C)O(489)'],
