...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(837)', '[O]C[C](F)F(4520)'],
    products = ['F[CH]OC[C](F)F(4465)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['F[C]F(3442)', '[CH2]O[CH]F(978)'],
    products = ['F[CH]OC[C](F)F(4465)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[CH]OC=C(F)F(4563)'],
    products = ['F[CH]OC[C](F)F(4465)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH2]O[CH]F(978)'],
    products = ['F[CH]OC[C](F)F(4465)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[O]C[C](F)F(4520)'],
    products = ['F[CH]OC[C](F)F(4465)'],
