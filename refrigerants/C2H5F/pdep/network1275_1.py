...
reaction(
    label = 'reaction3',
    reactants = ['OF(169)', 'CC(=O)[C]F(3022)'],
    products = ['CC(=O)C(F)OF(2870)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(160)', 'CC(=O)[CH]F(3029)'],
    products = ['CC(=O)C(F)OF(2870)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F[CH]OF(1980)', 'CH3CO(34)'],
    products = ['CC(=O)C(F)OF(2870)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(=O)[C](F)OF(3030)'],
    products = ['CC(=O)C(F)OF(2870)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'O=[C]C(F)OF(3031)'],
    products = ['CC(=O)C(F)OF(2870)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'CC(=O)C(=O)F(2143)'],
    products = ['CC(=O)C(F)OF(2870)'],
