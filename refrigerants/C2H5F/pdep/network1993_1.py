...
"""),
    ...
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29805,0.0632239,-6.47798e-05,3.70479e-08,-8.90319e-12,-45893.8,24.4647], Tmin=(100,'K'), Tmax=(984.618,'K')), NASAPolynomial(coeffs=[9.48209,0.0299761,-1.41287e-05,2.75279e-09,-1.95421e-13,-47505.4,-14.8917], Tmin=(984.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(COCsFO) + radical(CJCO)"""),
)
...
"""),
    ...
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67132,0.0376879,2.35881e-05,-6.46314e-08,3.06055e-11,-22467.8,18.6348], Tmin=(100,'K'), Tmax=(898.368,'K')), NASAPolynomial(coeffs=[14.3946,0.017406,-3.27194e-06,3.64194e-10,-2.19311e-14,-26221.4,-49.5524], Tmin=(898.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCFHO) + ring(12dioxane) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C1(F)CCOO1(5641)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (105.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33028,0.0444573,1.20259e-05,-5.79615e-08,2.94111e-11,-22829.9,20.134], Tmin=(100,'K'), Tmax=(899.259,'K')), NASAPolynomial(coeffs=[16.7984,0.0142468,-1.95718e-06,1.29696e-10,-6.43949e-15,-27172.3,-61.5247], Tmin=(899.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-190.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]COOC(=C)F(5385)'],
    products = ['CH2CHO(35)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(702.966,'s^-1'), n=2.72887, Ea=(16.0703,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]COOC(=C)F(5385)'],
    products = ['[CH2]COCC(=O)F(5639)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.62709e+20,'s^-1'), n=-1.9758, Ea=(99.1469,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.1791595854394145, var=100.97114496904264, Tref=1000.0, N=30, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]OOC(=C)F(1505)'],
    products = ['[CH2]COOC(=C)F(5385)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]COOC(=C)F(4899)'],
    products = ['[CH2]COOC(=C)F(5385)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]COO[C]=C(954)'],
    products = ['[CH2]COOC(=C)F(5385)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CFO(78)', '[CH2]C[O](144)'],
    products = ['[CH2]COOC(=C)F(5385)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(68.4503,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction12',
    reactants = ['C=C(F)O[O](1327)', '[CH2][CH2](138)'],
    products = ['[CH2]COOC(=C)F(5385)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2CF(69)', '[CH2]CO[O](512)'],
    products = ['[CH2]COOC(=C)F(5385)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C#COOC[CH2](467)'],
    products = ['[CH2]COOC(=C)F(5385)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(187.443,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
