...
"""),
    E0 = (266.455,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3010,987.5,1337.5,450,1655,3115,3125,620,680,785,800,1600,1700,243.095,243.347],'cm^-1')),
        HinderedRotor(inertia=(0.44893,'amu*angstrom^2'), symmetry=1, barrier=(18.9473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.499702,'amu*angstrom^2'), symmetry=1, barrier=(21.002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.452996,'amu*angstrom^2'), symmetry=1, barrier=(18.9521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11769,0.0639549,-6.73191e-05,3.682e-08,-8.11109e-12,32150.6,25.3383], Tmin=(100,'K'), Tmax=(1093.28,'K')), NASAPolynomial(coeffs=[12.5073,0.0222829,-1.01433e-05,1.9544e-09,-1.38224e-13,29660.2,-30.6254], Tmin=(1093.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CO[C]=C(419)'],
    products = ['[CH]=C(CF)O[C]=C(8937)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)O[C]=C(2544)'],
    products = ['[CH]=C(CF)O[C]=C(8937)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C(134)', '[CH]=C([O])CF(2478)'],
    products = ['[CH]=C(CF)O[C]=C(8937)'],
    transitionState = 'TS4',
