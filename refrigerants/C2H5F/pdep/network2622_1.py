...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)O[O](6345)'],
    products = ['HO2(11)', '[CH]=C=C(5584)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CO[O](276)'],
    products = ['[CH]=C(C)O[O](6345)'],
    transitionState = 'TS2',
