...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)C([O])=O(6399)'],
    products = ['CO2(14)', 'C#CC(3594)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC([O])=O(3620)'],
    products = ['[CH]=C(C)C([O])=O(6399)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(19)', 'C#CC([O])=O(3710)'],
    products = ['[CH]=C(C)C([O])=O(6399)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C]=O(3667)', 'C#CC(3594)'],
    products = ['[CH]=C(C)C([O])=O(6399)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][C]=O(3667)', '[CH]=[C]C(3595)'],
    products = ['[CH]=C(C)C([O])=O(6399)'],
