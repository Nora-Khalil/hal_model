...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C([O])=O(157)'],
    products = ['[CH2]CC([O])=O(293)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C]=O(625)', '[CH2][CH2](138)'],
    products = ['[CH2]CC([O])=O(293)'],
