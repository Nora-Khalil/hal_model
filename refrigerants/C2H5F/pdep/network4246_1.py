...
"""),
    E0 = (-343.483,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,482,586,761,1411,2782.5,750,1395,475,1775,1000,425.76],'cm^-1')),
        HinderedRotor(inertia=(0.363338,'amu*angstrom^2'), symmetry=1, barrier=(46.2646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.361923,'amu*angstrom^2'), symmetry=1, barrier=(46.3382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3569,'amu*angstrom^2'), symmetry=1, barrier=(46.367,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.025,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01369,0.0298647,1.3472e-05,-4.44722e-08,1.99039e-11,-41227.6,24.8209], Tmin=(100,'K'), Tmax=(989.965,'K')), NASAPolynomial(coeffs=[15.6293,0.00797916,-3.56376e-06,8.03912e-10,-6.64645e-14,-45546.7,-48.9281], Tmin=(989.965,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-343.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(CsFHOO) + group(Cds-OdOsH) + radical(O2sj(Cs-F1sO2sH)) + radical(CsF1sO2sO2s)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[C]=O(151)', 'O[C]F(7301)'],
    products = ['O=[C]OO[C](O)F(11735)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[O]O[C](O)F(1564)'],
    products = ['O=[C]OO[C](O)F(11735)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(43772.1,'m^3/(mol*s)'), n=0.920148, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', '[O]O[C](O)F(1564)'],
    products = ['O=[C]OO[C](O)F(11735)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OOC(=O)F(11739)'],
    products = ['O=[C]OO[C](O)F(11735)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C]=O(151)', '[OH+]=[C-]F(1907)'],
    products = ['O=[C]OO[C](O)F(11735)'],
