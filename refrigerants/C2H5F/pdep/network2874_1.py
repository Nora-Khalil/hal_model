...
"""),
    ...
    molecularWeight = (73.0274,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.23658,0.00348625,5.23333e-05,-7.52093e-08,3.01614e-11,-20756.6,15.3075], Tmin=(100,'K'), Tmax=(940.753,'K')), NASAPolynomial(coeffs=[11.5354,0.00213744,3.72543e-07,-4.10472e-11,-4.45142e-15,-23819.7,-32.2041], Tmin=(940.753,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-OdCsOs) + ring(cyclopropanone) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]C(=O)O(4104)'],
    products = ['O=C1O[C]1O(17944)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C(=O)C=O(3702)'],
    products = ['O=[C]C(=O)O(4104)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5.99823e+07,'s^-1'), n=1.57622, Ea=(111.045,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3H_SS;O_rad_out;XH_out] for rate rule [R3H_SS;O_rad_out;CO_H_out]
