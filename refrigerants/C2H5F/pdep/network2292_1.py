...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', '[CH]C=C(341)'],
    products = ['[CH]=CC[C]=C(6647)'],
    transitionState = 'TS3',
