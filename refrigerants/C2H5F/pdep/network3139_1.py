...
"""),
    E0 = (422.171,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,239,401,1367,198.739,199.185,4000,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.624432,'amu*angstrom^2'), symmetry=1, barrier=(17.5503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.625638,'amu*angstrom^2'), symmetry=1, barrier=(17.5483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86667,0.053318,-9.40201e-05,8.83101e-08,-3.22646e-11,50846.1,-2.00528], Tmin=(100,'K'), Tmax=(805.573,'K')), NASAPolynomial(coeffs=[6.31904,0.0199511,-1.0925e-05,2.19336e-09,-1.5502e-13,50494.1,-20.2553], Tmin=(805.573,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.171,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(Ct-CtCs) + group(CsJ2_singlet-CsH) + group(CtCF)"""),
)
...
"""),
    E0 = (422.181,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,239,401,1367,180,180,1869.26,1871.14,1872.26,1874.36],'cm^-1')),
        HinderedRotor(inertia=(0.333175,'amu*angstrom^2'), symmetry=1, barrier=(7.66034,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0377,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5311,0.0447107,-0.000102913,1.10564e-07,-4.18975e-11,50817.8,14.6549], Tmin=(100,'K'), Tmax=(886.328,'K')), NASAPolynomial(coeffs=[0.691559,0.0218668,-1.15421e-05,2.19109e-09,-1.46596e-13,52367.2,30.209], Tmin=(886.328,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Ct-CtCs) + group(CsJ2_singlet-CsH) + group(CtCF)"""),
)

species(
    label = 'C=[O+][C-]C#CF(9134)',
    structure = adjacencyList("""1 F u0 p3 c0 {6,S}
2 O u0 p1 c+1 {3,S} {4,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.195749,'amu*angstrom^2'), symmetry=1, barrier=(4.50066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195863,'amu*angstrom^2'), symmetry=1, barrier=(4.50327,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90381,0.0610922,-0.000136594,1.43538e-07,-5.38858e-11,55718.3,7.49121], Tmin=(100,'K'), Tmax=(878.444,'K')), NASAPolynomial(coeffs=[1.42541,0.0263236,-1.41351e-05,2.72164e-09,-1.84024e-13,57227.9,17.8512], Tmin=(878.444,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsJ2_singlet-CsH) + group(Cds-CdsCsCs) + group(Ct-CtCs) + group(CtCF)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[C-]=[O+]C#CF(9133)'],
    products = ['[C-]=[O+]CC#CF(8420)'],
    transitionState = 'TS2',
