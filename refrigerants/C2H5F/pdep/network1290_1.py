...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(=O)OC=O(3939)'],
    products = ['C=C(OF)OC=O(3904)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C=O(142)', 'C=[C]OF(507)'],
    products = ['C=C(OF)OC=O(3904)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(357)', 'C=[C]OC=O(881)'],
    products = ['C=C(OF)OC=O(3904)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH]=C(OF)OC=O(3940)'],
    products = ['C=C(OF)OC=O(3904)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', 'C=C(OF)O[C]=O(3941)'],
    products = ['C=C(OF)OC=O(3904)'],
