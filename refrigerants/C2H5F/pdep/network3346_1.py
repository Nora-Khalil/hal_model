...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.773589,0.0760436,-0.00011075,8.52011e-08,-2.61634e-11,-77808.4,23.0817], Tmin=(100,'K'), Tmax=(797.488,'K')), NASAPolynomial(coeffs=[11.2924,0.0232839,-1.15137e-05,2.24362e-09,-1.57529e-13,-79486.1,-25.285], Tmin=(797.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-647.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20753,0.0620521,-7.11065e-05,4.10403e-08,-9.39306e-12,-47990.6,23.0309], Tmin=(100,'K'), Tmax=(1062.11,'K')), NASAPolynomial(coeffs=[13.0127,0.0175926,-8.31685e-06,1.62832e-09,-1.16222e-13,-50498.3,-34.6337], Tmin=(1062.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-399.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(O2sj(Cs-F1sF1sCd))"""),
)

species(
    label = 'C=[C]C(F)C(=O)F(9029)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {5,D}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.969016,'amu*angstrom^2'), symmetry=1, barrier=(22.2796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.968779,'amu*angstrom^2'), symmetry=1, barrier=(22.2741,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21452,0.048166,-3.04222e-05,-5.00871e-08,7.05506e-11,-36307.2,19.8861], Tmin=(100,'K'), Tmax=(458.879,'K')), NASAPolynomial(coeffs=[6.52354,0.0268305,-1.37194e-05,2.70307e-09,-1.90379e-13,-36873.5,0.592721], Tmin=(458.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(COCsFO) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.37436,'amu*angstrom^2'), symmetry=1, barrier=(54.5911,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.895519,0.0720843,-0.000105031,7.90518e-08,-2.34739e-11,-46928.6,22.6647], Tmin=(100,'K'), Tmax=(827.911,'K')), NASAPolynomial(coeffs=[11.8701,0.0190625,-8.96909e-06,1.70136e-09,-1.1744e-13,-48745.8,-28.2092], Tmin=(827.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-391.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Ct-CtCs) + group(Ct-CtH) + radical(O2sj(Cs-CsF1sF1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.000823333,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000826355,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88907,0.0461964,-4.62654e-05,2.40615e-08,-5.05564e-12,-19661.4,20.5772], Tmin=(100,'K'), Tmax=(1141.53,'K')), NASAPolynomial(coeffs=[10.3019,0.0167174,-7.52924e-06,1.43914e-09,-1.01254e-13,-21582.1,-21.1233], Tmin=(1141.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-164.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCCF) + longDistanceInteraction_noncyclic(Cd(F)-CO) + group(COCFO) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=C(F)C([O])(F)F(9352)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.856503,0.0635584,-6.41434e-05,3.18673e-08,-6.1946e-12,-53102,25.2576], Tmin=(100,'K'), Tmax=(1254.44,'K')), NASAPolynomial(coeffs=[15.9878,0.0153103,-6.45125e-06,1.20738e-09,-8.43879e-14,-56898.3,-51.1722], Tmin=(1254.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-442.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(O2sj(Cs-F1sF1sCd)) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CC(F)C([O])(F)F(9353)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.484884,'amu*angstrom^2'), symmetry=1, barrier=(11.1484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.484632,'amu*angstrom^2'), symmetry=1, barrier=(11.1426,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05867,0.0700717,-9.2696e-05,6.5561e-08,-1.88291e-11,-37176,24.8762], Tmin=(100,'K'), Tmax=(844.411,'K')), NASAPolynomial(coeffs=[10.5362,0.0251752,-1.29409e-05,2.59269e-09,-1.86034e-13,-38776.6,-19.2446], Tmin=(844.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(O2sj(Cs-CsF1sF1s)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=C(F)C(O)(F)F(9354)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.86411,0.0727532,-9.48472e-05,6.37591e-08,-1.7081e-11,-53878.1,25.3568], Tmin=(100,'K'), Tmax=(910.554,'K')), NASAPolynomial(coeffs=[12.5028,0.0216244,-1.06183e-05,2.08918e-09,-1.48639e-13,-55997.6,-29.7021], Tmin=(910.554,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-448.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cds(F)) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cdj(Cs-HHH)(Cd-CsF1s))"""),
)

species(
    label = '[CH]=[C]C(F)C(O)(F)F(9355)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.519201,'amu*angstrom^2'), symmetry=1, barrier=(11.9374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519174,'amu*angstrom^2'), symmetry=1, barrier=(11.9368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19384,'amu*angstrom^2'), symmetry=1, barrier=(27.4487,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.446997,0.0875291,-0.000151863,1.37449e-07,-4.82904e-11,-2580.47,27.6314], Tmin=(100,'K'), Tmax=(823.314,'K')), NASAPolynomial(coeffs=[9.18935,0.0288416,-1.54e-05,3.03132e-09,-2.11268e-13,-3470.5,-9.50852], Tmin=(823.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.4437,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cdj(Cs-F1sCsH)(Cd-HH))"""),
)

species(
    label = 'C=C(F)C(F)[C]([O])F(9359)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C(F)(F)[CH]F(7559)', '[C]=C(134)'],
    products = ['C=[C]C(F)C([O])(F)F(8610)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=[C]C(F)[C](F)F(9231)'],
    products = ['C=[C]C(F)C([O])(F)F(8610)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C=C(F)C([O])(F)F(9349)'],
    products = ['C=[C]C(F)C([O])(F)F(8610)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=[C]C(F)C(=O)F(9029)'],
    products = ['C=[C]C(F)C([O])(F)F(8610)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C#CC(F)C([O])(F)F(9350)'],
    products = ['C=[C]C(F)C([O])(F)F(8610)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F2(77)', '[CH2][C]=CC(=O)F(8097)'],
    products = ['C=[C]C(F)C([O])(F)F(8610)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH2][C]=C(F)C(=O)F(9351)'],
    products = ['C=[C]C(F)C([O])(F)F(8610)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C]C(F)C([O])(F)F(8610)'],
    products = ['[CH2]C=C(F)C([O])(F)F(9352)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC(F)C([O])(F)F(9353)'],
    products = ['C=[C]C(F)C([O])(F)F(8610)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]C(F)C([O])(F)F(8610)'],
    products = ['[CH2][C]=C(F)C(O)(F)F(9354)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=[C]C(F)C([O])(F)F(8610)'],
    products = ['[CH]=[C]C(F)C(O)(F)F(9355)'],
...
network(
    label = 'PDepNetwork #3346',
    isomers = [
        'C=[C]C(F)C([O])(F)F(8610)',
    ],
    reactants = [
        ('CF2O(49)', 'C=C=CF(5941)'),
    ],
