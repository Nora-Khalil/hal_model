...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([CH2])=C(6223)'],
    products = ['C2H2(23)', 'C=C=C(6556)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC[C]=C(6647)'],
    products = ['[CH]=CC([CH2])=C(6223)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH]C=C=C(661)'],
    products = ['[CH]=CC([CH2])=C(6223)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=[CH](135)', 'C=C=C(6556)'],
    products = ['[CH]=CC([CH2])=C(6223)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H2(23)', '[CH2][C]=C(6610)'],
    products = ['[CH]=CC([CH2])=C(6223)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[CH](135)', '[CH2][C]=C(6610)'],
    products = ['[CH]=CC([CH2])=C(6223)'],
