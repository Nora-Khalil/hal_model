...
"""),
    E0 = (89.0194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,540,610,2055,183.712,184.583],'cm^-1')),
        HinderedRotor(inertia=(0.763833,'amu*angstrom^2'), symmetry=1, barrier=(18.2409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.44619,'amu*angstrom^2'), symmetry=1, barrier=(10.7051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.446928,'amu*angstrom^2'), symmetry=1, barrier=(10.7054,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1938,0.0659544,-6.72779e-05,4.02131e-08,-1.02767e-11,10804,22.7955], Tmin=(100,'K'), Tmax=(923.625,'K')), NASAPolynomial(coeffs=[8.5164,0.0342414,-1.57742e-05,3.03751e-09,-2.14077e-13,9451.37,-11.9499], Tmin=(923.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.0194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=C(C)C(=O)CF(7239)',
...
"""),
    ...
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13991,0.0489955,-1.02897e-05,-5.85293e-08,5.97875e-11,-40076.6,20.4437], Tmin=(100,'K'), Tmax=(456.476,'K')), NASAPolynomial(coeffs=[3.99985,0.0424874,-2.10745e-05,4.20562e-09,-3.02759e-13,-40348.4,11.8119], Tmin=(456.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-333.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C=C(CC)OF(7240)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (67.3045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,540,610,2055,614.177,614.594],'cm^-1')),
        HinderedRotor(inertia=(0.552741,'amu*angstrom^2'), symmetry=1, barrier=(12.7086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.552671,'amu*angstrom^2'), symmetry=1, barrier=(12.707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.55262,'amu*angstrom^2'), symmetry=1, barrier=(12.7058,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19032,0.0626974,-5.5073e-05,2.6168e-08,-5.19027e-12,8195.21,23.5491], Tmin=(100,'K'), Tmax=(1179.43,'K')), NASAPolynomial(coeffs=[10.8929,0.0297908,-1.32219e-05,2.5115e-09,-1.75815e-13,5906.53,-24.8615], Tmin=(1179.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.3045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'CC1=C(OF)CC1(7241)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33733,0.0480405,-1.09151e-05,-1.84883e-08,9.84335e-12,5957.43,22.1403], Tmin=(100,'K'), Tmax=(1035.25,'K')), NASAPolynomial(coeffs=[13.1071,0.0250046,-1.00518e-05,1.89382e-09,-1.34979e-13,2318,-40.8575], Tmin=(1035.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.6601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + ring(Cyclobutene)"""),
)
...
"""),
    E0 = (269.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,575.22,575.253],'cm^-1')),
        HinderedRotor(inertia=(0.00970604,'amu*angstrom^2'), symmetry=1, barrier=(2.27911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.982443,'amu*angstrom^2'), symmetry=1, barrier=(22.5883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.982425,'amu*angstrom^2'), symmetry=1, barrier=(22.5879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.982423,'amu*angstrom^2'), symmetry=1, barrier=(22.5878,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.289964,0.0720215,-6.71269e-05,3.11488e-08,-5.66392e-12,32520.4,27.8181], Tmin=(100,'K'), Tmax=(1339.15,'K')), NASAPolynomial(coeffs=[18.2261,0.0184468,-7.11708e-06,1.2742e-09,-8.67451e-14,27716.6,-63.9513], Tmin=(1339.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJCO) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=C(C)C([CH2])OF(7244)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {3,S}
...
"""),
    E0 = (364.81,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,212.435],'cm^-1')),
        HinderedRotor(inertia=(0.00374523,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.486008,'amu*angstrom^2'), symmetry=1, barrier=(15.5918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.486572,'amu*angstrom^2'), symmetry=1, barrier=(15.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.485904,'amu*angstrom^2'), symmetry=1, barrier=(15.5879,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.655696,0.0729414,-7.49492e-05,4.00449e-08,-8.59472e-12,43997.4,27.3172], Tmin=(100,'K'), Tmax=(1123.27,'K')), NASAPolynomial(coeffs=[14.1044,0.0250494,-1.09941e-05,2.08663e-09,-1.46459e-13,40976.2,-39.1283], Tmin=(1123.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(OF)C([CH2])C(7245)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {5,S}
3  C u0 p0 c0 {4,S} {5,S} {6,S} {8,S}
...
"""),
    E0 = (347.152,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,2617.39],'cm^-1')),
        HinderedRotor(inertia=(0.621789,'amu*angstrom^2'), symmetry=1, barrier=(14.2962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214701,'amu*angstrom^2'), symmetry=1, barrier=(76.6341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.615511,'amu*angstrom^2'), symmetry=1, barrier=(14.1518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100292,'amu*angstrom^2'), symmetry=1, barrier=(2.3059,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.85421,0.0676779,-6.75473e-05,3.67586e-08,-8.10269e-12,41867.3,28.0792], Tmin=(100,'K'), Tmax=(1094.64,'K')), NASAPolynomial(coeffs=[12.3124,0.0258089,-1.01754e-05,1.81861e-09,-1.23132e-13,39358.7,-28.2367], Tmin=(1094.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(347.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.14252,'amu*angstrom^2'), symmetry=1, barrier=(26.2689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14225,'amu*angstrom^2'), symmetry=1, barrier=(26.2625,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04673,0.0701673,-8.08737e-05,5.52774e-08,-1.60238e-11,41459.6,24.6573], Tmin=(100,'K'), Tmax=(824.061,'K')), NASAPolynomial(coeffs=[8.32981,0.0348132,-1.65167e-05,3.2096e-09,-2.2682e-13,40259.4,-9.06962], Tmin=(824.061,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(OF)C(=C)C(7253)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {3,S}
...
"""),
    ...
    molecularWeight = (102.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.71895,0.0779643,-0.00010353,8.10501e-08,-2.64015e-11,42980.8,24.6227], Tmin=(100,'K'), Tmax=(743.279,'K')), NASAPolynomial(coeffs=[8.6968,0.035017,-1.68308e-05,3.26151e-09,-2.28971e-13,41795.3,-11.4963], Tmin=(743.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([CH2])C(=C)OF(7242)'],
    products = ['C=C(C)C(=C)OF(7235)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=C)C([CH2])OF(7243)'],
    products = ['C=C(C)C(=C)OF(7235)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(C)C([CH2])OF(7244)'],
    products = ['C=C(C)C(=C)OF(7235)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(OF)C([CH2])C(7245)'],
    products = ['C=C(C)C(=C)OF(7235)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'C=C(C)C(=C)[O](7247)'],
    products = ['C=C(C)C(=C)OF(7235)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(160)', 'C=[C]C(=C)C(7248)'],
    products = ['C=C(C)C(=C)OF(7235)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'C=[C]C(=C)OF(3164)'],
    products = ['C=C(C)C(=C)OF(7235)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C(=C)C(=C)OF(7249)'],
    products = ['C=C(C)C(=C)OF(7235)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OF(491)', 'C=[C]C(1726)'],
    products = ['C=C(C)C(=C)OF(7235)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH]=C(C)C(=C)OF(7250)'],
    products = ['C=C(C)C(=C)OF(7235)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH]=C(OF)C(=C)C(7251)'],
    products = ['C=C(C)C(=C)OF(7235)'],
