...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC([CH2])F(927)'],
    products = ['[CH]=C(C)C([CH2])F(6123)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH]C(C)=CF(6186)'],
    products = ['[CH]=C(C)C([CH2])F(6123)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(C)C=C(6169)'],
    products = ['[CH]=C(C)C([CH2])F(6123)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH]=C(C)C(=C)F(6188)'],
    products = ['[CH]=C(C)C([CH2])F(6123)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'C#CC([CH2])F(939)'],
    products = ['[CH]=C(C)C([CH2])F(6123)'],
