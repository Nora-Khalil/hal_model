...
"""),
    E0 = (-749.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,333,384,448,608,1254,1480,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,528,1116,1182,1331,1402,1494,3075,3110,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.695603,'amu*angstrom^2'), symmetry=1, barrier=(15.9933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.695553,'amu*angstrom^2'), symmetry=1, barrier=(15.9921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.695593,'amu*angstrom^2'), symmetry=1, barrier=(15.993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.695833,'amu*angstrom^2'), symmetry=1, barrier=(15.9986,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.103,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.926445,0.0694161,-6.21131e-05,2.96084e-08,-5.87707e-12,-90029.9,22.3318], Tmin=(100,'K'), Tmax=(1177.91,'K')), NASAPolynomial(coeffs=[11.8489,0.032325,-1.48794e-05,2.87526e-09,-2.03183e-13,-92603,-32.1511], Tmin=(1177.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-749.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFHH)"""),
)
...
"""),
    E0 = (-328.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,321.763,321.827],'cm^-1')),
        HinderedRotor(inertia=(0.127568,'amu*angstrom^2'), symmetry=1, barrier=(9.37271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127552,'amu*angstrom^2'), symmetry=1, barrier=(9.37282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127542,'amu*angstrom^2'), symmetry=1, barrier=(9.37284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127549,'amu*angstrom^2'), symmetry=1, barrier=(9.37256,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.1041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.266,0.0639677,-6.84993e-05,4.38438e-08,-1.19339e-11,-39472.3,22.151], Tmin=(100,'K'), Tmax=(874.44,'K')), NASAPolynomial(coeffs=[8.1296,0.0325708,-1.46411e-05,2.78217e-09,-1.94386e-13,-40672.6,-10.041], Tmin=(874.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFHH) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CC(C)(O)F(10420)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-355.376,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,333,384,448,608,1254,1480,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1187.67],'cm^-1')),
        HinderedRotor(inertia=(0.326078,'amu*angstrom^2'), symmetry=1, barrier=(7.49718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.704213,'amu*angstrom^2'), symmetry=1, barrier=(16.1912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.704229,'amu*angstrom^2'), symmetry=1, barrier=(16.1916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.565333,'amu*angstrom^2'), symmetry=1, barrier=(12.9981,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.1041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29067,0.0588541,-4.77696e-05,2.042e-08,-3.62102e-12,-42643.9,21.8685], Tmin=(100,'K'), Tmax=(1308.96,'K')), NASAPolynomial(coeffs=[11.4515,0.0278041,-1.2188e-05,2.29794e-09,-1.59871e-13,-45303.9,-29.8872], Tmin=(1308.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-355.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ)"""),
)
...
"""),
    E0 = (-538.607,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,205.924,205.944],'cm^-1')),
        HinderedRotor(inertia=(0.325035,'amu*angstrom^2'), symmetry=1, barrier=(9.78427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.382354,'amu*angstrom^2'), symmetry=1, barrier=(11.5068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.986501,'amu*angstrom^2'), symmetry=1, barrier=(29.6904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.32502,'amu*angstrom^2'), symmetry=1, barrier=(9.78453,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.095,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.647741,0.0797425,-0.000102709,7.54317e-08,-2.29255e-11,-64664.2,23.595], Tmin=(100,'K'), Tmax=(795.092,'K')), NASAPolynomial(coeffs=[9.71626,0.0341183,-1.66326e-05,3.25555e-09,-2.30394e-13,-66106.2,-18.0756], Tmin=(795.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-538.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsCsFHH) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['C[C]F(124)', 'OCCF(900)'],
    products = ['CC(O)(F)CCF(5427)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.14358e+07,'m^3/(mol*s)'), n=-0.641018, Ea=(170.355,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17570294811609, var=29.477358162589667, Tref=1000.0, N=2, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'CC(O)(F)CF(5694)'],
    products = ['CC(O)(F)CCF(5427)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.000166864,'m^3/(mol*s)'), n=2.82973, Ea=(152.296,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CC_2Br1sCl1sF1sHI1s->H_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'OC(F)CCF(2184)'],
    products = ['CC(O)(F)CCF(5427)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'CC(O)(F)C[C]F(8372)'],
    products = ['CC(O)(F)CCF(5427)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHF(40)', 'CC(C)(O)F(8371)'],
    products = ['CC(O)(F)CCF(5427)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(0.000167974,'m^3/(mol*s)'), n=3.10993, Ea=(24.9987,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 6.0"""),
)

reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'CC(F)=CCF(5444)'],
    products = ['CC(O)(F)CCF(5427)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OCF(401)', 'C=C(C)F(1325)'],
    products = ['CC(O)(F)CCF(5427)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C[C](O)CCF(10419)'],
    products = ['CC(O)(F)CCF(5427)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]CC(C)(O)F(10420)'],
    products = ['CC(O)(F)CCF(5427)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2F-CH2(61)', 'C[C](O)F(1910)'],
    products = ['CC(O)(F)CCF(5427)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'O[C](F)CCF(3438)'],
    products = ['CC(O)(F)CCF(5427)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2F(46)', '[CH2]C(C)(O)F(3314)'],
    products = ['CC(O)(F)CCF(5427)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'CC(O)(F)[CH]CF(5700)'],
    products = ['CC(O)(F)CCF(5427)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(O)(F)CCF(10421)'],
    products = ['CC(O)(F)CCF(5427)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'CC(O)(F)C[CH]F(8374)'],
    products = ['CC(O)(F)CCF(5427)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'CC(O)=CCF(5704)'],
    products = ['CC(O)(F)CCF(5427)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(239.532,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'C=CC(C)(O)F(5191)'],
    products = ['CC(O)(F)CCF(5427)'],
