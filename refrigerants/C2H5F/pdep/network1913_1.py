...
reaction(
    label = 'reaction1',
    reactants = ['FCC(F)COF(6246)'],
    products = ['HF(38)', 'CH2O(20)', 'CHFCHF[Z](58)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH3F(39)', 'F[C]COF(362)'],
    products = ['FCC(F)COF(6246)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'FCC(F)OF(2313)'],
    products = ['FCC(F)COF(6246)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2(8)', 'F[C]C(F)COF(6248)'],
    products = ['FCC(F)COF(6246)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(25)', 'FOCC(F)F(3507)'],
    products = ['FCC(F)COF(6246)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(F)COF(373)'],
    products = ['FCC(F)COF(6246)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(357)', '[CH2]C(F)CF(471)'],
    products = ['FCC(F)COF(6246)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OF(278)', 'CH2F-CHF(65)'],
    products = ['FCC(F)COF(6246)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'F[CH]COF(370)'],
    products = ['FCC(F)COF(6246)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', 'FCC(F)[CH]OF(6251)'],
    products = ['FCC(F)COF(6246)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', 'F[CH]C(F)COF(6252)'],
    products = ['FCC(F)COF(6246)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'C=C(F)COF(2980)'],
    products = ['FCC(F)COF(6246)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'O=CC(F)CF(2086)'],
    products = ['FCC(F)COF(6246)'],
