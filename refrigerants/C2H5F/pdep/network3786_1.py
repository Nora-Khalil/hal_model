...
"""),
    E0 = (-518.667,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,275,321,533,585,746,850,1103,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,200.086,202.346],'cm^-1')),
        HinderedRotor(inertia=(0.706196,'amu*angstrom^2'), symmetry=1, barrier=(20.2538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291796,'amu*angstrom^2'), symmetry=1, barrier=(8.80084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302191,'amu*angstrom^2'), symmetry=1, barrier=(8.78646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.753076,0.0770287,-9.49692e-05,6.4147e-08,-1.78019e-11,-62269.2,22.8475], Tmin=(100,'K'), Tmax=(868.805,'K')), NASAPolynomial(coeffs=[10.7719,0.0309013,-1.53289e-05,3.0353e-09,-2.16763e-13,-64010,-24.0784], Tmin=(868.805,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-518.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(CsCFFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-444.624,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,326,540,652,719,1357,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.147869,'amu*angstrom^2'), symmetry=1, barrier=(3.39981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136525,'amu*angstrom^2'), symmetry=1, barrier=(3.13897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284568,'amu*angstrom^2'), symmetry=1, barrier=(6.54278,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.749493,0.0800296,-0.000124313,1.13702e-07,-4.17005e-11,-53367.1,24.9707], Tmin=(100,'K'), Tmax=(797.818,'K')), NASAPolynomial(coeffs=[6.18431,0.0385533,-1.95823e-05,3.83434e-09,-2.68608e-13,-53781.5,2.81628], Tmin=(797.818,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-444.624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCFO)"""),
)

species(
    label = 'CC(COF)=C(F)F(10610)',
...
"""),
    E0 = (-444.381,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,182,240,577,636,1210,1413,245.797,3414.36],'cm^-1')),
        HinderedRotor(inertia=(0.246963,'amu*angstrom^2'), symmetry=1, barrier=(10.4954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243552,'amu*angstrom^2'), symmetry=1, barrier=(10.4914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0465,'amu*angstrom^2'), symmetry=1, barrier=(44.256,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.946249,0.0724752,-9.06181e-05,6.56669e-08,-1.98303e-11,-53341.6,24.6848], Tmin=(100,'K'), Tmax=(798.165,'K')), NASAPolynomial(coeffs=[8.90726,0.0325785,-1.56393e-05,3.04062e-09,-2.14453e-13,-54612.4,-11.9277], Tmin=(798.165,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-444.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFF)"""),
)

species(
    label = '[CH2]C([CH2])C(F)(F)OF(10611)',
...
"""),
    E0 = (-228.916,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,223,363,546,575,694,1179,1410,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,330.076,330.318],'cm^-1')),
        HinderedRotor(inertia=(0.0852333,'amu*angstrom^2'), symmetry=1, barrier=(6.59008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0854016,'amu*angstrom^2'), symmetry=1, barrier=(6.59105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.894562,'amu*angstrom^2'), symmetry=1, barrier=(69.1428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0197248,'amu*angstrom^2'), symmetry=1, barrier=(69.1435,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.400214,0.0811079,-0.000104574,7.16661e-08,-1.94702e-11,-27404.4,28.3727], Tmin=(100,'K'), Tmax=(902.923,'K')), NASAPolynomial(coeffs=[13.2625,0.0241278,-9.91486e-06,1.77597e-09,-1.19201e-13,-29727.1,-32.3668], Tmin=(902.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFFO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
"""),
    E0 = (-405.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([526,555,698,907,1200,1145,1227,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.752782,'amu*angstrom^2'), symmetry=1, barrier=(17.3079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.75282,'amu*angstrom^2'), symmetry=1, barrier=(17.3088,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23833,0.0558431,-4.73672e-05,2.03047e-08,-3.49027e-12,-48626.3,22.4293], Tmin=(100,'K'), Tmax=(1384.84,'K')), NASAPolynomial(coeffs=[13.6756,0.0199189,-8.45557e-06,1.57242e-09,-1.08606e-13,-52071,-41.6227], Tmin=(1384.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFFO) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sF1sCd))"""),
)
...
"""),
    E0 = (-277.08,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,161,297,490,584,780,1358,2950,3100,1380,975,1025,1650],'cm^-1')),
        HinderedRotor(inertia=(0.500244,'amu*angstrom^2'), symmetry=1, barrier=(11.5016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00981893,'amu*angstrom^2'), symmetry=1, barrier=(28.0167,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.0792,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.87878,0.0120464,0.000171848,-6.12977e-07,7.30135e-10,-33326.6,11.6692], Tmin=(10,'K'), Tmax=(212.379,'K')), NASAPolynomial(coeffs=[2.39145,0.0400594,-2.60056e-05,8.09856e-09,-9.65251e-13,-33263.5,16.5402], Tmin=(212.379,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-277.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), label="""CDC(C)[C](F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    molecularWeight = (126.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.590937,0.081159,-0.00010534,7.42176e-08,-2.13544e-11,-22491.6,24.9729], Tmin=(100,'K'), Tmax=(841.279,'K')), NASAPolynomial(coeffs=[11.1753,0.0308329,-1.56061e-05,3.10704e-09,-2.22211e-13,-24272.4,-24.2608], Tmin=(841.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsCsH) + group(CsCFFO) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (-363.398,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,255,533,799,832,1228,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.14096,'amu*angstrom^2'), symmetry=1, barrier=(3.24094,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(C)C(F)(F)OF(10605)'],
    products = ['HF(38)', 'CF2O(49)', 'C=C=C(6556)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(56.3964,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    ...
    products = ['C=C(C)C(F)(F)OF(10605)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(217.708,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['FOF(1637)', 'C=C(C)[C]F(10608)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CC(CF)=C(F)OF(10609)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(8.88952e+10,'s^-1'), n=0.725184, Ea=(272.912,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CC(COF)=C(F)F(10610)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([CH2])C(F)(F)OF(10611)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(C)=C(F)OF(10612)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0.519206,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)

reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C=C(C)C([O])(F)F(10613)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(160)', 'C=C(C)[C](F)F(10614)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FO[C](F)F(7422)', 'C=[C]C(1726)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', 'C=[C]C(F)(F)OF(7934)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=C)C(F)(F)OF(10615)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH]=C(C)C(F)(F)OF(10616)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]C(C)C(F)(F)OF(10617)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F2(77)', 'C=C(C)C(=O)F(6318)'],
    products = ['C=C(C)C(F)(F)OF(10605)'],
