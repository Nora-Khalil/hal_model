...
"""),
    E0 = (-120.947,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,310.289,311.057,2151.55],'cm^-1')),
        HinderedRotor(inertia=(0.125149,'amu*angstrom^2'), symmetry=1, barrier=(8.56332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126264,'amu*angstrom^2'), symmetry=1, barrier=(8.57473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126053,'amu*angstrom^2'), symmetry=1, barrier=(8.57172,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.420224,0.0889432,-0.000158667,1.42785e-07,-4.87731e-11,-14427.4,26.1516], Tmin=(100,'K'), Tmax=(868.942,'K')), NASAPolynomial(coeffs=[9.34548,0.0262382,-1.31029e-05,2.473e-09,-1.66719e-13,-15162.3,-10.9573], Tmin=(868.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(O2sCF) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=C(C)OJ)"""),
)

species(
    label = 'CO[C](OF)C(=O)F(3852)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-431.304,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,611,648,830,1210,1753,270.822,270.822,270.823,1621.99],'cm^-1')),
        HinderedRotor(inertia=(0.0161715,'amu*angstrom^2'), symmetry=1, barrier=(30.191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160669,'amu*angstrom^2'), symmetry=1, barrier=(8.36232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160663,'amu*angstrom^2'), symmetry=1, barrier=(8.36224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160663,'amu*angstrom^2'), symmetry=1, barrier=(8.36227,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51289,0.0642689,-7.0852e-05,1.40935e-08,2.41993e-11,-51793.9,26.0412], Tmin=(100,'K'), Tmax=(512.237,'K')), NASAPolynomial(coeffs=[8.03398,0.0293592,-1.55153e-05,3.10116e-09,-2.20484e-13,-52672,-3.10747], Tmin=(512.237,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-431.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-OsHHH) + group(COCsFO) + radical(Cs_P)"""),
)
...
"""),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37326,0.0593241,-5.8014e-05,2.84205e-08,-5.64673e-12,-18373.9,23.6634], Tmin=(100,'K'), Tmax=(1192.84,'K')), NASAPolynomial(coeffs=[12.4756,0.0220943,-1.11978e-05,2.25554e-09,-1.62999e-13,-21022.5,-31.8568], Tmin=(1192.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2sCF) + group(CsCCFO) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cs-Cs(F)-O2s-O2s) + radical(Cs_P)"""),
)

species(
    label = 'CC1(F)OC1([O])OF(3854)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32464,0.0646712,-9.17645e-05,8.00888e-08,-2.91169e-11,-41588.7,21.9996], Tmin=(100,'K'), Tmax=(754.75,'K')), NASAPolynomial(coeffs=[6.23948,0.0327156,-1.65136e-05,3.24851e-09,-2.29288e-13,-42162.4,0.786043], Tmin=(754.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-346.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + ring(Cs(O2)-O2s-Cs(F)) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-410.457,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([990,1113,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,340.911,340.911,340.911,340.911,1149.32,2185.06],'cm^-1')),
        HinderedRotor(inertia=(0.414091,'amu*angstrom^2'), symmetry=1, barrier=(34.1508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.414091,'amu*angstrom^2'), symmetry=1, barrier=(34.1509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.41409,'amu*angstrom^2'), symmetry=1, barrier=(34.1509,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04345,0.0482034,-4.2582e-05,1.96555e-08,-3.90116e-12,-49300.5,18.5361], Tmin=(100,'K'), Tmax=(1140.07,'K')), NASAPolynomial(coeffs=[8.2937,0.0262741,-1.37295e-05,2.78372e-09,-2.01445e-13,-50725.7,-12.4371], Tmin=(1140.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-410.457,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)O2s)"""),
)
...
"""),
    E0 = (-137.291,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,280.35,280.868,3214.81],'cm^-1')),
        HinderedRotor(inertia=(0.271125,'amu*angstrom^2'), symmetry=1, barrier=(14.9936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.270521,'amu*angstrom^2'), symmetry=1, barrier=(15.0078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03855,0.0692367,-0.000106136,8.48647e-08,-2.66876e-11,-16409.5,22.8781], Tmin=(100,'K'), Tmax=(827.443,'K')), NASAPolynomial(coeffs=[10.8213,0.0187116,-8.68154e-06,1.62298e-09,-1.10371e-13,-17917.7,-21.7961], Tmin=(827.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)

species(
    label = 'CC([O])(F)C([O])=O(3857)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u1 p2 c0 {5,S}
3  O u1 p2 c0 {7,S}
...
"""),
    E0 = (-402.619,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,180,1111.39,1111.45,1111.47],'cm^-1')),
        HinderedRotor(inertia=(2.19528,'amu*angstrom^2'), symmetry=1, barrier=(50.4737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234912,'amu*angstrom^2'), symmetry=1, barrier=(50.5164,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68899,0.0571303,-8.50625e-05,7.9706e-08,-3.06293e-11,-48346.8,20.8235], Tmin=(100,'K'), Tmax=(770.189,'K')), NASAPolynomial(coeffs=[4.50083,0.0322917,-1.67534e-05,3.32392e-09,-2.35288e-13,-48476.4,9.96296], Tmin=(770.189,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-402.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-189.771,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,990,1113,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36819,0.0623188,-6.63798e-05,3.70895e-08,-8.57017e-12,-22733,25.7365], Tmin=(100,'K'), Tmax=(1025.97,'K')), NASAPolynomial(coeffs=[10.6447,0.0261519,-1.35023e-05,2.7299e-09,-1.97647e-13,-24636.5,-19.255], Tmin=(1025.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(C2CsJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC([O])(F)C(=O)OF(3759)'],
    products = ['HF(38)', 'CO2(14)', 'CH2CFO(78)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(7.85545,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'CC([O])(F)OF(3850)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.000742267,'m^3/(mol*s)'), n=2.83796, Ea=(211.441,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.2632766423807829, var=145.9379134136138, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-1COCbCdCsCtHNOSSidSis->Cs',), comment="""Estimated from node Root_N-1COCbCdCsCtHNOSSidSis->Cs"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[O]C(F)C(=O)OF(3144)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['FOF(1637)', 'CC(=O)[C]=O(1391)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CC([O])=C(OF)OF(3851)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.7779e+11,'s^-1'), n=0.725184, Ea=(154.008,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction6',
    reactants = ['CO[C](OF)C(=O)F(3852)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(7040,'s^-1'), n=2.66, Ea=(360.145,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H-inRing_N-2R!H->C',), comment="""Estimated from node Root_N-1R!H-inRing_N-2R!H->C"""),
)

reaction(
    label = 'reaction7',
    reactants = ['O(6)', 'C[C](F)C(=O)OF(2601)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CC([O])(F)C(=O)OF(3759)'],
    products = ['CC1(F)OC1([O])OF(3854)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.785e+11,'s^-1'), n=0.342, Ea=(147.274,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_O] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_O]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 146.1 to 147.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(=O)C(=O)OF(559)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4.08261e+20,'m^3/(mol*s)'), n=-5.07836, Ea=(18.7878,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_2R!H->O"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', 'O=C(F)C(=O)OF(3855)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.000120113,'m^3/(mol*s)'), n=2.79634, Ea=(16.6907,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_3R->C_Ext-1R!H-R_Ext-1R!H-R_4R!H->F_3C-u1',), comment="""Estimated from node Root_N-3R-inRing_3R->C_Ext-1R!H-R_Ext-1R!H-R_4R!H->F_3C-u1"""),
)

reaction(
    label = 'reaction12',
    reactants = ['O=[C]OF(331)', 'CC(=O)F(499)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(520000,'m^3/(mol*s)'), n=-1.07934e-11, Ea=(94.1842,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Sp-4R!H=3R_Sp-2R!H=1R!H_N-2R!H->C"""),
)

reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'CC([O])=C([O])OF(3856)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'CC([O])(F)C([O])=O(3857)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(160)', 'CC([O])(F)[C]=O(3858)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', '[O][C](F)C(=O)OF(3859)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]OF(331)', 'C[C]([O])F(1344)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C([O])(F)C(=O)OF(3860)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', '[CH2]C(=O)C(=O)OF(1393)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(229.084,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)

reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(O)(F)C(=O)OF(3755)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C[C](OF)C(=O)OF(3862)'],
    products = ['CC([O])(F)C(=O)OF(3759)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(80.3674,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)
