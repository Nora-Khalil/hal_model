...
reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'C=C(O)C(=O)[C]F(3708)'],
    products = ['C=C(O)C(=O)CF(2863)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(O)C(=O)[CH]F(3713)'],
    products = ['C=C(O)C(=O)CF(2863)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction18',
    reactants = ['OH(7)', 'C=C=C([O])CF(3720)'],
    products = ['C=C(O)C(=O)CF(2863)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)CF(3721)'],
    products = ['C=C(O)C(=O)CF(2863)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2F(46)', 'C=C(O)[C]=O(1400)'],
    products = ['C=C(O)C(=O)CF(2863)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'C=C(O)C([O])=CF(3722)'],
    products = ['C=C(O)C(=O)CF(2863)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O=[C]CF(492)', 'C=[C]O(142)'],
    products = ['C=C(O)C(=O)CF(2863)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(5)', '[CH]=C(O)C(=O)CF(3723)'],
    products = ['C=C(O)C(=O)CF(2863)'],
