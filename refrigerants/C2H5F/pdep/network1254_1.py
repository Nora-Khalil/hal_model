...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0389368,'amu*angstrom^2'), symmetry=1, barrier=(12.3288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137772,'amu*angstrom^2'), symmetry=1, barrier=(3.16764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.537913,'amu*angstrom^2'), symmetry=1, barrier=(12.3677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00959931,'amu*angstrom^2'), symmetry=1, barrier=(3.12155,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0849,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80644,0.0527714,-4.43658e-05,2.14084e-08,-4.59742e-12,-36192.7,20.3706], Tmin=(100,'K'), Tmax=(1049.22,'K')), NASAPolynomial(coeffs=[7.11838,0.0325203,-1.54138e-05,3.01233e-09,-2.14108e-13,-37307.4,-5.51156], Tmin=(1049.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-301.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.964668,'amu*angstrom^2'), symmetry=1, barrier=(22.1796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961658,'amu*angstrom^2'), symmetry=1, barrier=(22.1104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38886,0.0203567,3.95643e-05,-7.42332e-08,3.24722e-11,-17723.4,12.6368], Tmin=(100,'K'), Tmax=(922.783,'K')), NASAPolynomial(coeffs=[14.7892,0.00555492,3.11179e-07,-1.3349e-10,5.01047e-15,-21670.3,-55.1765], Tmin=(922.783,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
"""),
    E0 = (-210.351,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,198.387,200.274,1749.3],'cm^-1')),
        HinderedRotor(inertia=(0.296559,'amu*angstrom^2'), symmetry=1, barrier=(9.69753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322522,'amu*angstrom^2'), symmetry=1, barrier=(9.67736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.54908e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.17808,0.0319981,-1.23887e-05,1.02088e-09,1.41141e-13,-25283.1,16.0868], Tmin=(100,'K'), Tmax=(2297.71,'K')), NASAPolynomial(coeffs=[19.5463,0.0131677,-6.40492e-06,1.11529e-09,-6.83016e-14,-35356.2,-82.0487], Tmin=(2297.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-210.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (-53.4518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,353.927,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0859165,'amu*angstrom^2'), symmetry=1, barrier=(7.63372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26153,'amu*angstrom^2'), symmetry=1, barrier=(23.2368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0859131,'amu*angstrom^2'), symmetry=1, barrier=(7.63377,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (59.0871,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26133,0.0338985,-1.99857e-05,6.03485e-09,-7.49474e-13,-6362.6,15.8646], Tmin=(100,'K'), Tmax=(1812.05,'K')), NASAPolynomial(coeffs=[9.55959,0.0177881,-6.64971e-06,1.12847e-09,-7.25676e-14,-9007.58,-23.6839], Tmin=(1812.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.4518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""CH3CHOCH3""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-96.302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,244.949,244.958,4000],'cm^-1')),
        HinderedRotor(inertia=(0.265178,'amu*angstrom^2'), symmetry=1, barrier=(11.2914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26519,'amu*angstrom^2'), symmetry=1, barrier=(11.2914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00918011,'amu*angstrom^2'), symmetry=1, barrier=(28.4332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.667787,'amu*angstrom^2'), symmetry=1, barrier=(28.4332,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0769,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72197,0.0548489,-5.91385e-05,3.88787e-08,-1.1165e-11,-11504.6,21.3678], Tmin=(100,'K'), Tmax=(820.067,'K')), NASAPolynomial(coeffs=[6.67712,0.0306799,-1.49314e-05,2.94167e-09,-2.09751e-13,-12317.3,-1.55506], Tmin=(820.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(OC)OF(2982)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {1,S} {4,S}
...
"""),
    E0 = (-89.9593,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,212.615,213.304,1782.07],'cm^-1')),
        HinderedRotor(inertia=(0.382816,'amu*angstrom^2'), symmetry=1, barrier=(12.3043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.381432,'amu*angstrom^2'), symmetry=1, barrier=(12.2985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00252769,'amu*angstrom^2'), symmetry=1, barrier=(28.6995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.891081,'amu*angstrom^2'), symmetry=1, barrier=(28.6993,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0769,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49552,0.0597692,-7.0197e-05,4.82568e-08,-1.40195e-11,-10733.6,22.1245], Tmin=(100,'K'), Tmax=(822.979,'K')), NASAPolynomial(coeffs=[7.83661,0.0289484,-1.40206e-05,2.74948e-09,-1.9529e-13,-11777.3,-7.23209], Tmin=(822.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.9593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCO)"""),
)

species(
    label = '[CH2]OC(C)OF(2983)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {1,S} {4,S}
...
"""),
    E0 = (-113.677,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,243.386,243.445,243.506],'cm^-1')),
        HinderedRotor(inertia=(0.288679,'amu*angstrom^2'), symmetry=1, barrier=(12.1267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588203,'amu*angstrom^2'), symmetry=1, barrier=(24.7101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.009671,'amu*angstrom^2'), symmetry=1, barrier=(24.7097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00217634,'amu*angstrom^2'), symmetry=1, barrier=(24.7103,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0769,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61914,0.0552605,-5.3137e-05,2.78028e-08,-6.10025e-12,-13588.9,21.83], Tmin=(100,'K'), Tmax=(1070.45,'K')), NASAPolynomial(coeffs=[9.40183,0.0261779,-1.23829e-05,2.42091e-09,-1.72249e-13,-15255.1,-16.2467], Tmin=(1070.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCH3)"""),
)
...
"""),
    E0 = (-425.94,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,871.044,871.091,871.16,871.435,874.258],'cm^-1')),
        HinderedRotor(inertia=(0.103236,'amu*angstrom^2'), symmetry=1, barrier=(2.37359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104136,'amu*angstrom^2'), symmetry=1, barrier=(2.3943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105986,'amu*angstrom^2'), symmetry=1, barrier=(2.43683,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.75061,0.0220814,1.21738e-05,-2.1921e-08,7.33604e-12,-51179.4,16.5003], Tmin=(100,'K'), Tmax=(1154.02,'K')), NASAPolynomial(coeffs=[5.62534,0.0261099,-1.125e-05,2.11764e-09,-1.47682e-13,-52774.6,-1.8174], Tmin=(1154.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(Cs-OsHHH) + group(Cds-OdCsOs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['COC(C)OF(2849)'],
    products = ['HF(38)', 'CH2O(20)', 'CH3CHO(36)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(37.3229,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'COCOF(570)'],
    products = ['COC(C)OF(2849)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3OH(26)', 'C=COF(496)'],
    products = ['COC(C)OF(2849)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(24.8,'cm^3/(mol*s)'), n=2.93, Ea=(183.678,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2 used for Cd/H2_Cd/H/Nd;H_OCmethyl
Exact match found for rate rule [Cd/H2_Cd/H/Nd;H_OCmethyl]
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'CO[CH]OF(1056)'],
    products = ['COC(C)OF(2849)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(OC)OF(2982)'],
    products = ['COC(C)OF(2849)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]OC(C)OF(2983)'],
    products = ['COC(C)OF(2849)'],
