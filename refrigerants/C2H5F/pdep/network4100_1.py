...
"""),
    E0 = (-119.655,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([361,769,965,1078,1132,1246,3247,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.299142,'amu*angstrom^2'), symmetry=1, barrier=(6.87785,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52704,0.0586174,-6.62846e-05,4.12128e-08,-1.06447e-11,-14305.7,22.5816], Tmin=(100,'K'), Tmax=(924.934,'K')), NASAPolynomial(coeffs=[9.18623,0.0254932,-1.25645e-05,2.49169e-09,-1.78449e-13,-15722.5,-13.7716], Tmin=(924.934,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-119.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCFHO) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(O2sj(Cs-F1sCdH)) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-143.528,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,246,474,533,1155,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.30838,'amu*angstrom^2'), symmetry=1, barrier=(30.0823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.30938,'amu*angstrom^2'), symmetry=1, barrier=(30.1052,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3583.14,'J/mol'), sigma=(5.96327,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=559.68 K, Pc=38.34 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25503,0.0635205,-7.3263e-05,4.46889e-08,-1.10663e-11,-17166.2,20.9025], Tmin=(100,'K'), Tmax=(973.559,'K')), NASAPolynomial(coeffs=[11.0553,0.023255,-1.12247e-05,2.20699e-09,-1.57435e-13,-19074.5,-26.1156], Tmin=(973.559,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(Cs-CsHHH) + group(CdCsCdF) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cdj(Cd-CsF1s)(H))"""),
)
...
"""),
    E0 = (-82.2714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,323,467,575,827,1418,388.77,388.77,388.77,388.771],'cm^-1')),
        HinderedRotor(inertia=(0.491492,'amu*angstrom^2'), symmetry=1, barrier=(52.7144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.491491,'amu*angstrom^2'), symmetry=1, barrier=(52.7144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.491486,'amu*angstrom^2'), symmetry=1, barrier=(52.7144,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.098,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31645,0.0640423,-6.05504e-05,3.63822e-08,-9.93065e-12,-9802.69,22.235], Tmin=(100,'K'), Tmax=(845.148,'K')), NASAPolynomial(coeffs=[6.24952,0.0406939,-1.91094e-05,3.69185e-09,-2.60361e-13,-10636.5,-0.73407], Tmin=(845.148,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.2714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'CC1(F)OC=C1CF(11459)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-98.2413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,375,552.5,462.5,1710,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.133704,'amu*angstrom^2'), symmetry=1, barrier=(3.07411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133596,'amu*angstrom^2'), symmetry=1, barrier=(3.07163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133788,'amu*angstrom^2'), symmetry=1, barrier=(3.07606,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.43449,0.0436723,1.42179e-05,-1.34277e-07,1.35127e-10,-11769.1,20.6644], Tmin=(100,'K'), Tmax=(407.792,'K')), NASAPolynomial(coeffs=[4.29438,0.0391723,-1.97832e-05,3.95392e-09,-2.83799e-13,-12035.1,11.9586], Tmin=(407.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.2413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-O2d)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.779628,'amu*angstrom^2'), symmetry=1, barrier=(17.9252,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3669.97,'J/mol'), sigma=(5.97129,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=573.24 K, Pc=39.11 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.751513,0.0694296,-8.00066e-05,4.69509e-08,-1.07943e-11,6353.47,23.0528], Tmin=(100,'K'), Tmax=(1067.5,'K')), NASAPolynomial(coeffs=[14.6618,0.0173065,-6.76571e-06,1.21102e-09,-8.23897e-14,3383.61,-44.9651], Tmin=(1067.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.8383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(CF)C([CH2])(O)F(11467)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-189.845,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.927596,'amu*angstrom^2'), symmetry=1, barrier=(21.3273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.92769,'amu*angstrom^2'), symmetry=1, barrier=(21.3294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.928242,'amu*angstrom^2'), symmetry=1, barrier=(21.3421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.928075,'amu*angstrom^2'), symmetry=1, barrier=(21.3383,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0830614,0.0929233,-0.000132874,1.02808e-07,-3.20892e-11,-22698.3,27.6779], Tmin=(100,'K'), Tmax=(781.945,'K')), NASAPolynomial(coeffs=[11.9959,0.0319823,-1.5968e-05,3.1347e-09,-2.21317e-13,-24561.3,-26.8642], Tmin=(781.945,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)
...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (120.097,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3804.4,'J/mol'), sigma=(6.34694,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=594.24 K, Pc=33.76 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=C(CF)C([O])F(9053)'],
    products = ['[CH]=C(CF)C(C)([O])F(9780)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[CH]=CC(C)([O])F(5118)'],
    products = ['[CH]=C(CF)C(C)([O])F(9780)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C(C)([O])F(5170)'],
    products = ['[CH]=C(CF)C(C)([O])F(9780)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(6)', '[CH]C(CF)=C(C)F(11165)'],
    products = ['[CH]=C(CF)C(C)([O])F(9780)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]=C(CF)C(C)=O(11466)'],
    products = ['[CH]=C(CF)C(C)([O])F(9780)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', '[CH]=C(CF)C(=O)F(11073)'],
    products = ['[CH]=C(CF)C(C)([O])F(9780)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['[CH]=C(CF)C(C)([O])F(9780)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.04353e-06,'m^3/(mol*s)'), n=3.0961, Ea=(32.9905,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.25403387200380967, var=0.12219132316784118, Tref=1000.0, N=5, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R_N-Sp-5R!H=4R!H"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH]=C(CF)C(=C)[O](8984)'],
    products = ['[CH]=C(CF)C(C)([O])F(9780)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(CF)C([CH2])(O)F(11467)'],
    products = ['[CH]=C(CF)C(C)([O])F(9780)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(CF)C(C)([O])F(9780)'],
    products = ['[CH2]C([O])(F)C(=C)CF(9783)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(111.414,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #4100',
    isomers = [
        '[CH]=C(CF)C(C)([O])F(9780)',
    ],
    reactants = [
