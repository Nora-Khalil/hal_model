...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C=C(O)O(3279)'],
    products = ['C=C(O)OCF(2844)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[CH2]OC(=C)O(3333)'],
    products = ['C=C(O)OCF(2844)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2F(46)', '[CH2]C(=O)O(166)'],
    products = ['C=C(O)OCF(2844)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=O)OCF(3018)'],
    products = ['C=C(O)OCF(2844)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C=C(O)O[CH]F(3284)'],
    products = ['C=C(O)OCF(2844)'],
