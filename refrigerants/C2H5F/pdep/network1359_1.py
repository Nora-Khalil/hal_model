...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', 'C=COO[CH]C(=O)F(3532)'],
    products = ['C=COOC=C(F)O[O](3475)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=COOC=C(F)O[O](3475)'],
    products = ['FC1=COOO1(3487)', 'CH2CHO(35)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C=COOC=C(F)O[O](3475)'],
    products = ['C=COO[CH]C1(F)OO1(3535)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C=COOC=C(F)O[O](3475)'],
    products = ['[CH2]C1OOC=C(F)OO1(3536)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C=COOC=[C]O[O](3537)'],
    products = ['C=COOC=C(F)O[O](3475)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[C](F)C=O(1865)', 'CH2CHO(35)'],
    products = ['C=COOC=C(F)O[O](3475)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]OC=C(F)O[O](3491)', 'C2H3(29)'],
    products = ['C=COOC=C(F)O[O](3475)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(F)O[O](1331)', 'C=CO[O](502)'],
    products = ['C=COOC=C(F)O[O](3475)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O2(2)', 'C=COOC=[C]F(3538)'],
    products = ['C=COOC=C(F)O[O](3475)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=COO[C]=C(F)O[O](3539)'],
    products = ['C=COOC=C(F)O[O](3475)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C=[C]OOC=C(F)O[O](3540)'],
    products = ['C=COOC=C(F)O[O](3475)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=COOC=C(F)O[O](3541)'],
    products = ['C=COOC=C(F)O[O](3475)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=COOC=C(F)O[O](3475)'],
    products = ['[O]OC(F)=C=O(3542)', 'CH3CHO(36)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HF(38)', 'C=COOC#CO[O](3543)'],
    products = ['C=COOC=C(F)O[O](3475)'],
