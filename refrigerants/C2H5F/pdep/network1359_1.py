...
"""),
    E0 = (-1039.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,348,427,405,1245,1236,1280,528,1116,1182,1331,1402,1494,3075,3110,419.953,419.954,419.97,419.97,419.979,419.98],'cm^-1')),
        HinderedRotor(inertia=(0.08099,'amu*angstrom^2'), symmetry=1, barrier=(10.1369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342632,'amu*angstrom^2'), symmetry=1, barrier=(42.8815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0226136,'amu*angstrom^2'), symmetry=1, barrier=(42.8817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43453,0.0603449,-6.32695e-05,3.51633e-08,-8.09644e-12,-124903,22.2959], Tmin=(100,'K'), Tmax=(1029.27,'K')), NASAPolynomial(coeffs=[10.3108,0.0258493,-1.29971e-05,2.60127e-09,-1.87361e-13,-126731,-20.7829], Tmin=(1029.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1039.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + group(CsCsFHH) + group(Cds-OdCsOs)"""),
)
...
"""),
    E0 = (-876.834,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,548,1085,1183,1302,1466,1520,3060,3119,350,440,435,1725,182,240,577,636,1210,1413,280.219,280.219,280.219],'cm^-1')),
        HinderedRotor(inertia=(0.326751,'amu*angstrom^2'), symmetry=1, barrier=(18.2068,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694445,0.0745053,-9.49496e-05,6.008e-08,-1.49168e-11,-105341,22.6569], Tmin=(100,'K'), Tmax=(986.844,'K')), NASAPolynomial(coeffs=[14.7288,0.0176197,-8.48372e-06,1.66764e-09,-1.19074e-13,-108111,-44.8648], Tmin=(986.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-876.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsFHHO) + group(Cds-CdsCsCs) + group(CdCFF) + longDistanceInteraction_noncyclic(Cd(F)2=CdOs)"""),
)

species(
    label = '[O]C([O])C(F)(F)CF(5283)',
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.141502,'amu*angstrom^2'), symmetry=1, barrier=(3.2534,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.906437,0.0817377,-0.000153387,1.54367e-07,-5.87208e-11,-77160.1,26.4098], Tmin=(100,'K'), Tmax=(832.359,'K')), NASAPolynomial(coeffs=[3.35438,0.0392222,-2.13517e-05,4.22898e-09,-2.95363e-13,-76502.3,21.4481], Tmin=(832.359,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-642.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(O)C(F)(F)[CH]F(5284)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.2217,'amu*angstrom^2'), symmetry=1, barrier=(5.09732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221766,'amu*angstrom^2'), symmetry=1, barrier=(5.09883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221728,'amu*angstrom^2'), symmetry=1, barrier=(5.09795,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.519426,0.0907342,-0.000174041,1.68898e-07,-6.14998e-11,-80329.4,28.7683], Tmin=(100,'K'), Tmax=(852.149,'K')), NASAPolynomial(coeffs=[5.92306,0.0338073,-1.82775e-05,3.57392e-09,-2.4635e-13,-80104.4,10.2873], Tmin=(852.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-668.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(CCOJ) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)

species(
    label = 'O[C](O)C(F)(F)[CH]F(5285)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-689.284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,215,315,519,588,595,1205,1248,360,370,350,334,575,1197,1424,3202,303.255,1941.03],'cm^-1')),
        HinderedRotor(inertia=(0.135113,'amu*angstrom^2'), symmetry=1, barrier=(8.83143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135114,'amu*angstrom^2'), symmetry=1, barrier=(8.82905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13551,'amu*angstrom^2'), symmetry=1, barrier=(8.83056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135387,'amu*angstrom^2'), symmetry=1, barrier=(8.83403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.209746,0.0940102,-0.000171348,1.54705e-07,-5.3104e-11,-82775.4,29.0154], Tmin=(100,'K'), Tmax=(855.257,'K')), NASAPolynomial(coeffs=[10.4251,0.0250667,-1.3307e-05,2.5758e-09,-1.76257e-13,-83748.6,-14.1446], Tmin=(855.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-689.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + radical(Cs_P) + radical(Csj(Cs-CsF1sF1s)(F1s)(H))"""),
)
...
"""),
    E0 = (-813.542,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,348,427,405,1245,1236,1280,528,1116,1182,1331,1402,1494,3075,3110,180,180,180,180,180,788.197,1359.66],'cm^-1')),
        HinderedRotor(inertia=(0.038888,'amu*angstrom^2'), symmetry=1, barrier=(50.9938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0388752,'amu*angstrom^2'), symmetry=1, barrier=(51.0204,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (127.042,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48304,0.0615404,-9.07885e-05,8.28378e-08,-3.15495e-11,-97761.8,22.2747], Tmin=(100,'K'), Tmax=(734.842,'K')), NASAPolynomial(coeffs=[5.59682,0.032325,-1.72255e-05,3.46478e-09,-2.47624e-13,-98182.2,4.94894], Tmin=(734.842,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-813.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFF) + longDistanceInteraction_noncyclic(Cs(F)2-CO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OC(F)(F)CF(3545)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2F2(41)', 'O=C(O)[C]F(4026)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'O=C(O)C(F)(F)[C]F(5279)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'O=C(O)C(F)F(3651)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'O=C(O)C(F)(F)F(5280)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(174)', 'O=C=C(F)CF(4151)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C(O)C(F)(F)[CH]F(5284)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C](O)C(F)(F)[CH]F(5285)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C(O)[C](F)CF(4161)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)O(4242)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(5)', 'O=[C]C(F)(F)CF(5286)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[O]C(=O)C(F)(F)CF(5287)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(46)', 'O=C(O)[C](F)F(5288)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]O(178)', 'CH2F-CF2(67)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(6)', 'O=C(O)C(F)(F)[CH]F(5289)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
...
reaction(
    label = 'reaction22',
    reactants = ['F2(77)', 'C=C(F)C(=O)O(3610)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(O)C(F)=CF(5290)'],
    products = ['O=C(O)C(F)(F)CF(4248)'],
