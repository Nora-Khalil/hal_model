...
reaction(
    label = 'reaction4',
    reactants = ['F[C]1OO[CH]OO1(11763)'],
    products = ['O=COOC(=O)F(11737)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OOC=O(11720)'],
    products = ['O=COOC(=O)F(11737)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(=O)F(332)', '[O]C=O(147)'],
    products = ['O=COOC(=O)F(11737)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]OC(=O)F(1669)', 'HCO(15)'],
    products = ['O=COOC(=O)F(11737)'],
    transitionState = 'TS9',
...
network(
    label = 'PDepNetwork #4248',
    isomers = [
        'O=COOC(=O)F(11737)',
    ],
    reactants = [
        ('CO2(14)', 'O=C(O)F(336)'),
        ('[O]C(=O)F(332)', '[O]C=O(147)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
