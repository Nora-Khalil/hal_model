...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]C(F)O[C]=O(2264)'],
    products = ['CC([O])(F)O[C]=O(5107)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', 'CC([O])([O])F(1558)'],
    products = ['CC([O])(F)O[C]=O(5107)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'CC(=O)O[C]=O(1094)'],
    products = ['CC([O])(F)O[C]=O(5107)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'O=[C]OC(=O)F(1741)'],
    products = ['CC([O])(F)O[C]=O(5107)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH2]C(=O)O[C]=O(280)'],
    products = ['CC([O])(F)O[C]=O(5107)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(O)(F)O[C]=O(4077)'],
    products = ['CC([O])(F)O[C]=O(5107)'],
