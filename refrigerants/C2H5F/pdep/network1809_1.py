...
"""),
    E0 = (-258.786,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,334,575,1197,1424,3202,3000,3100,440,815,1455,1000,280.855,280.927,1650.26],'cm^-1')),
        HinderedRotor(inertia=(0.162227,'amu*angstrom^2'), symmetry=1, barrier=(9.13957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163445,'amu*angstrom^2'), symmetry=1, barrier=(9.13861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.574721,'amu*angstrom^2'), symmetry=1, barrier=(32.0522,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6267,0.0568622,-7.5765e-05,5.62579e-08,-1.71265e-11,-31043.5,20.6863], Tmin=(100,'K'), Tmax=(795.849,'K')), NASAPolynomial(coeffs=[8.43249,0.0226556,-1.12928e-05,2.25067e-09,-1.61098e-13,-32126.7,-10.5937], Tmin=(795.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sO2sH)(F1s)(H)) + radical(CsJOCH3)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.211288,'amu*angstrom^2'), symmetry=1, barrier=(4.85793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210564,'amu*angstrom^2'), symmetry=1, barrier=(4.84129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210756,'amu*angstrom^2'), symmetry=1, barrier=(4.84569,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29495,0.069209,-0.000125582,1.18597e-07,-4.22836e-11,-30193.4,21.0484], Tmin=(100,'K'), Tmax=(860.715,'K')), NASAPolynomial(coeffs=[6.00079,0.0259524,-1.29252e-05,2.46969e-09,-1.6838e-13,-30211.3,3.65329], Tmin=(860.715,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sHH)(F1s)(O2s-Cs)) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2]O[CH]C(F)F(3274)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {6,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(F)[CH]F(5173)'],
    products = ['CH2O(20)', 'CHFCHF[Z](58)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[O]C(F)[CH]F(1552)'],
    products = ['[CH2]OC(F)[CH]F(5173)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(181)', '[CH2]O[CH]F(339)'],
    products = ['[CH2]OC(F)[CH]F(5173)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(20)', 'F[CH][CH]F(4414)'],
    products = ['[CH2]OC(F)[CH]F(5173)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](318)', 'CHFCHF[Z](58)'],
    products = ['[CH2]OC(F)[CH]F(5173)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', '[CH2]OC(F)=CF(6061)'],
    products = ['[CH2]OC(F)[CH]F(5173)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](318)', 'F[CH][CH]F(4414)'],
    products = ['[CH2]OC(F)[CH]F(5173)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CHF(40)', '[CH2]O[CH]F(339)'],
    products = ['[CH2]OC(F)[CH]F(5173)'],
