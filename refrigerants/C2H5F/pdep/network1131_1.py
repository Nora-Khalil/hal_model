...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', 'O=C=C[C]F(2683)'],
    products = ['[O]C(=O)C=[C]F(2531)'],
    transitionState = 'TS2',
