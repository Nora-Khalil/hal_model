...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C(F)[CH]F(241)'],
    products = ['[CH2]C(F)C([CH2])F(201)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[CH2]C(F)C=C(218)'],
    products = ['[CH2]C(F)C([CH2])F(201)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CHF(55)', '[CH2][CH]F(183)'],
    products = ['[CH2]C(F)C([CH2])F(201)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', '[CH2]C(F)C(=C)F(243)'],
    products = ['[CH2]C(F)C([CH2])F(201)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]F(183)', '[CH2][CH]F(183)'],
    products = ['[CH2]C(F)C([CH2])F(201)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F2(77)', '[CH2]C=C[CH2](219)'],
    products = ['[CH2]C(F)C([CH2])F(201)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH2]C=C([CH2])F(244)'],
    products = ['[CH2]C(F)C([CH2])F(201)'],
