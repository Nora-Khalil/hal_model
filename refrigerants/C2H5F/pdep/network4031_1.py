...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.705743,'amu*angstrom^2'), symmetry=1, barrier=(16.2264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.705672,'amu*angstrom^2'), symmetry=1, barrier=(16.2248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.704798,'amu*angstrom^2'), symmetry=1, barrier=(16.2047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (270.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,113,247,382,1207,3490,540,610,2055,3120,650,792.5,1650,345.466],'cm^-1')),
        HinderedRotor(inertia=(0.190656,'amu*angstrom^2'), symmetry=1, barrier=(16.1944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191243,'amu*angstrom^2'), symmetry=1, barrier=(16.1879,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.883023,0.0643531,-6.1483e-05,3.04832e-08,-6.03003e-12,32619.1,22.5562], Tmin=(100,'K'), Tmax=(1221.79,'K')), NASAPolynomial(coeffs=[14.0888,0.0211195,-8.40549e-06,1.52192e-09,-1.04112e-13,29392.1,-43.7994], Tmin=(1221.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(Cds_P)"""),
)
...
"""),
    E0 = (259.666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,319,1023,1071,1259,1317,1409,3054,3019,350,440,435,1725,2100,2250,500,550,3120,650,792.5,1650,240.638],'cm^-1')),
        HinderedRotor(inertia=(0.205438,'amu*angstrom^2'), symmetry=1, barrier=(8.17705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.440896,'amu*angstrom^2'), symmetry=1, barrier=(17.7101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.68938,'amu*angstrom^2'), symmetry=1, barrier=(69.1223,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
...
"""),
    E0 = (197.734,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,194,682,905,1196,1383,3221,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.17413,'amu*angstrom^2'), symmetry=1, barrier=(49.9875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17417,'amu*angstrom^2'), symmetry=1, barrier=(49.9884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17419,'amu*angstrom^2'), symmetry=1, barrier=(49.9888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.650244,0.0651843,-4.52277e-05,1.37502e-08,-9.02451e-13,23909.7,24.5479], Tmin=(100,'K'), Tmax=(1128.77,'K')), NASAPolynomial(coeffs=[13.7833,0.0291797,-1.13812e-05,2.02828e-09,-1.37509e-13,20273.7,-43.3749], Tmin=(1128.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(C)=C=CCF(11323)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3354,0.0636087,-5.06289e-05,2.41515e-08,-5.30153e-12,32181.1,22.9243], Tmin=(100,'K'), Tmax=(1010.74,'K')), NASAPolynomial(coeffs=[6.5897,0.0428148,-1.97698e-05,3.79743e-09,-2.67091e-13,31118.9,-2.48087], Tmin=(1010.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C(=C)C=[C]CF(11116)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.740882,0.0657304,-5.726e-05,2.5646e-08,-4.60388e-12,28283.4,23.813], Tmin=(100,'K'), Tmax=(1334,'K')), NASAPolynomial(coeffs=[14.9525,0.0231168,-9.34367e-06,1.69986e-09,-1.16224e-13,24491.8,-48.8455], Tmin=(1334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.146,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C](C)C#CCF(11324)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {1,S} {6,S} {11,S} {12,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44563,0.0583124,-4.40545e-05,4.71966e-09,1.01012e-11,28859.1,26.0536], Tmin=(100,'K'), Tmax=(679.696,'K')), NASAPolynomial(coeffs=[9.01885,0.0280837,-8.98958e-06,1.36607e-09,-8.19134e-14,27498.4,-9.99537], Tmin=(679.696,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(239.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Tert_Propargyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH]C(=C)C=CCF(11325)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.5403,0.0660974,-4.86169e-05,1.82587e-08,-2.77135e-12,26050.2,25.5947], Tmin=(100,'K'), Tmax=(1550.75,'K')), NASAPolynomial(coeffs=[15.8778,0.0265365,-1.03513e-05,1.80856e-09,-1.19428e-13,21293.2,-55.1293], Tmin=(1550.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC=[C]CF(11093)'],
    products = ['[CH]=C(C)C=[C]CF(11114)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[CH]=C(C)C=C=CF(9381)'],
    products = ['[CH]=C(C)C=[C]CF(11114)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH]=C(C)C#CCF(11322)'],
    products = ['[CH]=C(C)C=[C]CF(11114)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(132.772,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

network(
    label = 'PDepNetwork #4031',
    isomers = [
        '[CH]=C(C)C=[C]CF(11114)',
    ],
    reactants = [
