...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53825,0.0233302,2.13822e-05,-3.75604e-08,1.39227e-11,519.482,18.6756], Tmin=(100,'K'), Tmax=(1048.27,'K')), NASAPolynomial(coeffs=[7.97163,0.0239788,-1.01412e-05,1.94517e-09,-1.39312e-13,-1794.41,-13.3968], Tmin=(1048.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.81884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsCFHO) + ring(Cs(C-F)-Cs-Cs) + radical(O2sj(Cs-CsF1sH)) + radical(CCJ(C)CO)"""),
)
...
"""),
    E0 = (217.235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,350,440,435,1725,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,400.873,401.011],'cm^-1')),
        HinderedRotor(inertia=(0.00104814,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362588,'amu*angstrom^2'), symmetry=1, barrier=(41.3019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.362083,'amu*angstrom^2'), symmetry=1, barrier=(41.3059,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54427,0.0428555,-9.80188e-06,-2.27286e-08,1.28219e-11,26225.7,21.541], Tmin=(100,'K'), Tmax=(981.179,'K')), NASAPolynomial(coeffs=[15.0124,0.0138557,-5.07189e-06,9.66896e-10,-7.20056e-14,22335.8,-49.5334], Tmin=(981.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=CCJO) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(=C)C=O(6774)'],
    products = ['[CH2]C(=C)C([O])F(6321)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=C)C(=O)F(6822)'],
    products = ['[CH2]C(=C)C([O])F(6321)'],
