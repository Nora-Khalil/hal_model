...
"""),
    E0 = (215.341,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,122,584,932,1043,1247,1392,1461,2986,3039,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,301.518],'cm^-1')),
        HinderedRotor(inertia=(0.094841,'amu*angstrom^2'), symmetry=1, barrier=(6.11235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0944069,'amu*angstrom^2'), symmetry=1, barrier=(6.11415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0134104,'amu*angstrom^2'), symmetry=1, barrier=(21.2828,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75355,0.0452342,-2.69131e-05,7.59206e-09,-8.53632e-13,25983.8,25.3257], Tmin=(100,'K'), Tmax=(2013.23,'K')), NASAPolynomial(coeffs=[14.1563,0.0205918,-8.55302e-06,1.51229e-09,-9.86625e-14,20989.8,-43.1894], Tmin=(2013.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.341,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14473,0.0276095,3.30746e-05,-5.87108e-08,2.30551e-11,-8351.18,18.3662], Tmin=(100,'K'), Tmax=(999.678,'K')), NASAPolynomial(coeffs=[11.1596,0.023721,-9.38014e-06,1.80468e-09,-1.32098e-13,-11761.7,-33.1653], Tmin=(999.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-70.0879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=CC=CCF(11148)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57665,0.0441516,-1.25978e-05,-1.40615e-08,8.09552e-12,-14049.4,20.1494], Tmin=(100,'K'), Tmax=(1031.25,'K')), NASAPolynomial(coeffs=[12.2193,0.0221974,-8.77557e-06,1.64023e-09,-1.1645e-13,-17272.1,-36.5054], Tmin=(1031.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.606,0.0459217,-2.60873e-05,5.56098e-09,4.40769e-14,-5885.86,21.0515], Tmin=(100,'K'), Tmax=(1286.93,'K')), NASAPolynomial(coeffs=[10.9953,0.0243883,-9.90567e-06,1.79758e-09,-1.22166e-13,-8936.05,-29.0763], Tmin=(1286.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.7003,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (155.546,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,113,247,382,1207,3490,540,610,2055,863.188,863.209],'cm^-1')),
        HinderedRotor(inertia=(0.00729754,'amu*angstrom^2'), symmetry=1, barrier=(3.8576,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167949,'amu*angstrom^2'), symmetry=1, barrier=(3.86149,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80549,0.0448485,-3.0645e-05,1.06659e-08,-1.52529e-12,18789.4,22.114], Tmin=(100,'K'), Tmax=(1595.45,'K')), NASAPolynomial(coeffs=[10.9744,0.0218607,-9.0323e-06,1.63481e-09,-1.10152e-13,15863.7,-26.4039], Tmin=(1595.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(RCCJ)"""),
)
...
"""),
    E0 = (137.146,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,319,1023,1071,1259,1317,1409,3054,3019,3000,3100,440,815,1455,1000,2100,2250,500,550,299.481,299.687],'cm^-1')),
        HinderedRotor(inertia=(0.0832979,'amu*angstrom^2'), symmetry=1, barrier=(5.31122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08645,'amu*angstrom^2'), symmetry=1, barrier=(69.1259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0256436,'amu*angstrom^2'), symmetry=1, barrier=(69.1289,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0994,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78235,0.0443865,-3.24584e-05,1.3684e-08,-2.42932e-12,16578.4,22.7369], Tmin=(100,'K'), Tmax=(1317.83,'K')), NASAPolynomial(coeffs=[8.85257,0.0229262,-8.03152e-06,1.32684e-09,-8.50849e-14,14714.9,-13.3241], Tmin=(1317.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.146,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C=[C]CF(11151)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (151.208,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,122,584,932,1043,1247,1392,1461,2986,3039,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.0107286,'amu*angstrom^2'), symmetry=1, barrier=(8.23398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04569,'amu*angstrom^2'), symmetry=1, barrier=(24.0424,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0106171,'amu*angstrom^2'), symmetry=1, barrier=(24.0764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84892,0.040175,-1.12213e-05,-7.58286e-09,3.90356e-12,18269.4,22.0816], Tmin=(100,'K'), Tmax=(1190.88,'K')), NASAPolynomial(coeffs=[9.82234,0.0269392,-1.16117e-05,2.18703e-09,-1.52503e-13,15409.7,-21.8113], Tmin=(1190.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = '[CH2]CC=C[CH]F(8670)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {3,S} {5,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {4,D} {9,S}
...
"""),
    E0 = (108.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,234,589,736,816,1240,3237,953.956],'cm^-1')),
        HinderedRotor(inertia=(0.183786,'amu*angstrom^2'), symmetry=1, barrier=(4.22559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185638,'amu*angstrom^2'), symmetry=1, barrier=(4.26819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59444,'amu*angstrom^2'), symmetry=1, barrier=(36.6593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43311,0.0488627,-3.16365e-05,9.97279e-09,-1.25731e-12,13143.3,24.0305], Tmin=(100,'K'), Tmax=(1835.23,'K')), NASAPolynomial(coeffs=[14.6292,0.0201008,-8.12821e-06,1.43313e-09,-9.40081e-14,8299.75,-47.6453], Tmin=(1835.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Csj(Cd-CdH)(F1s)(H))"""),
)

species(
    label = '[CH2]C[C]=CCF(11152)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
...
"""),
    E0 = (215.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,212,931,1104,1251,1325,1474,3102,3155,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,352.658,352.798],'cm^-1')),
        HinderedRotor(inertia=(0.0013551,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0826587,'amu*angstrom^2'), symmetry=1, barrier=(7.29839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0825924,'amu*angstrom^2'), symmetry=1, barrier=(7.29813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09944,0.0463691,-3.1814e-05,1.20121e-08,-2.06078e-12,25927.8,22.6147], Tmin=(100,'K'), Tmax=(1228.43,'K')), NASAPolynomial(coeffs=[6.33185,0.0325876,-1.49858e-05,2.87947e-09,-2.02187e-13,24887.9,1.32497], Tmin=(1228.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = 'CC[C]=[C]CF(11153)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  C u0 p0 c0 {3,S} {5,S} {7,S} {8,S}
3  C u0 p0 c0 {2,S} {9,S} {10,S} {11,S}
...
"""),
    E0 = (247.937,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,122,584,932,1043,1247,1392,1461,2986,3039,1670,1700,300,440,279.448],'cm^-1')),
        HinderedRotor(inertia=(0.00217706,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190524,'amu*angstrom^2'), symmetry=1, barrier=(10.5144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189424,'amu*angstrom^2'), symmetry=1, barrier=(10.515,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13502,0.0442821,-2.64005e-05,7.62324e-09,-9.1423e-13,29883.2,22.6052], Tmin=(100,'K'), Tmax=(1757.74,'K')), NASAPolynomial(coeffs=[9.37859,0.0277982,-1.23336e-05,2.28802e-09,-1.55409e-13,27336.8,-16.4264], Tmin=(1757.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)

species(
    label = '[CH2]C=C[CH]CF(11154)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {7,S} {8,S}
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61319,0.0451072,-2.07844e-05,-6.18871e-10,2.11598e-12,17093,23.5038], Tmin=(100,'K'), Tmax=(1200.83,'K')), NASAPolynomial(coeffs=[11.1298,0.0252385,-1.07447e-05,2.01214e-09,-1.39899e-13,13954.4,-27.7018], Tmin=(1200.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Csj(Cd-CdH)(F1s)(H)) + radical(Cdj(Cs-F1sHH)(Cd-CsH))"""),
)
...
"""),
    ...
    molecularWeight = (86.1074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36602,0.0523821,-3.84623e-05,1.45001e-08,-2.22563e-12,10939.7,23.7996], Tmin=(100,'K'), Tmax=(1519.43,'K')), NASAPolynomial(coeffs=[12.6383,0.0227074,-9.16744e-06,1.64678e-09,-1.10836e-13,7514.18,-35.2985], Tmin=(1519.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.1325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(CdCsCdF) + radical(RCCJ) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC=[C]CF(11098)'],
    products = ['C2H4(30)', 'C#CCF(4379)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C=[C]CF(11147)'],
    products = ['[CH2]CC=[C]CF(11098)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H4(30)', '[CH]=[C]CF(4380)'],
    products = ['[CH2]CC=[C]CF(11098)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]CC=C=C(6209)'],
    products = ['[CH2]CC=[C]CF(11098)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]CC=C=CF(8667)'],
    products = ['[CH2]CC=[C]CF(11098)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(166.635,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)

reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC=[C]CF(11098)'],
    products = ['[CH2]CC=C([CH2])F(8686)'],
