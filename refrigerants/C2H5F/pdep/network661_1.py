...
reaction(
    label = 'reaction1',
    reactants = ['CO(13)', 'CH2F-CH2(61)'],
    products = ['O=[C]CCF(1497)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]CCF(1497)'],
    products = ['[CH2]CC(=O)F(1496)'],
