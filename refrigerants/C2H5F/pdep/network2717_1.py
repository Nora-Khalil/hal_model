...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[O]C[C](F)F(4520)'],
    products = ['[O]CC([O])(F)F(7396)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[O]C(F)(F)C=O(7723)'],
    products = ['[O]CC([O])(F)F(7396)'],
    transitionState = 'TS9',
