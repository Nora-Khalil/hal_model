...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', '[O]C([O])(F)F(7573)'],
    products = ['[O]C(F)(F)O[C]=O(7392)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CO(13)', '[O]C([O])(F)F(7573)'],
    products = ['[O]C(F)(F)O[C]=O(7392)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=[C]OC(=O)F(1741)'],
    products = ['[O]C(F)(F)O[C]=O(7392)'],
    transitionState = 'TS7',
