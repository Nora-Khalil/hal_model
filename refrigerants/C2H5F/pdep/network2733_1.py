...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'C#COO(1058)'],
    products = ['C#COOC(F)F(7409)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'C#COO[CH]F(1532)'],
    products = ['C#COOC(F)F(7409)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C(F)F(1981)', 'HCCO(21)'],
    products = ['C#COOC(F)F(7409)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]OC(F)F(3447)', 'C2H(22)'],
    products = ['C#COOC(F)F(7409)'],
    transitionState = 'TS7',
