...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])F(527)', '[CH]C-2(137)'],
    products = ['[CH2]C(F)O[CH]C(1125)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C[CH]O[CH]F(1200)'],
    products = ['[CH2]C(F)O[CH]C(1125)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH2]C(F)OC=C(1203)'],
    products = ['[CH2]C(F)O[CH]C(1125)'],
