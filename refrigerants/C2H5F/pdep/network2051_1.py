...
reaction(
    label = 'reaction1',
    reactants = ['C[C]=CC=[C]C(6762)'],
    products = ['C#CC(3594)', 'C#CC(3594)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['H(6)', 'C=C=CC=[C]C(6796)'],
    products = ['C[C]=CC=[C]C(6762)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C#CC(3594)', '[CH]=[C]C(3595)'],
    products = ['C[C]=CC=[C]C(6762)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]C(3595)', '[CH]=[C]C(3595)'],
    products = ['C[C]=CC=[C]C(6762)'],
    transitionState = 'TS7',
