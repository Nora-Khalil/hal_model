...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]O[C]=CF(2642)'],
    products = ['[CH2]OC([CH2])=CF(8446)'],
    transitionState = 'TS3',
