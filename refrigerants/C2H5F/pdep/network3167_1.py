...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.327302,0.0705258,-6.30067e-05,1.95373e-08,4.4936e-13,26907.4,22.7415], Tmin=(100,'K'), Tmax=(995.161,'K')), NASAPolynomial(coeffs=[20.3365,0.010704,-3.89368e-06,7.41789e-10,-5.53968e-14,21904.6,-78.8201], Tmin=(995.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(CsCFHO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'FC1CCC=[C]O1(12388)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07662,0.0233387,6.26134e-05,-1.01972e-07,4.21231e-11,-16793.7,17.7021], Tmin=(100,'K'), Tmax=(935.454,'K')), NASAPolynomial(coeffs=[14.9485,0.016582,-3.97509e-06,6.60277e-10,-5.12457e-14,-21314.5,-54.8305], Tmin=(935.454,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-140.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(3,4-Dihydro-2H-pyran) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1CCC(F)O1(12389)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77157,0.0227282,8.30971e-05,-1.34716e-07,5.5895e-11,-15334.6,19.6879], Tmin=(100,'K'), Tmax=(940.675,'K')), NASAPolynomial(coeffs=[20.8838,0.00831908,-5.42337e-07,1.2007e-10,-2.12777e-14,-21888.4,-87.0721], Tmin=(940.675,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.34162,'amu*angstrom^2'), symmetry=1, barrier=(30.8464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33738,'amu*angstrom^2'), symmetry=1, barrier=(30.7489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34205,'amu*angstrom^2'), symmetry=1, barrier=(30.8565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.631792,0.0632903,-4.78191e-05,7.28572e-09,3.95915e-12,-11778.8,20.4511], Tmin=(100,'K'), Tmax=(998.616,'K')), NASAPolynomial(coeffs=[19.0203,0.0120567,-4.54217e-06,8.78837e-10,-6.5796e-14,-16569.4,-73.8349], Tmin=(998.616,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.0224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (174.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,395,473,707,1436,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,253.18,253.193,253.335],'cm^-1')),
        HinderedRotor(inertia=(0.490602,'amu*angstrom^2'), symmetry=1, barrier=(22.336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.490748,'amu*angstrom^2'), symmetry=1, barrier=(22.3355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.490988,'amu*angstrom^2'), symmetry=1, barrier=(22.3358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.490267,'amu*angstrom^2'), symmetry=1, barrier=(22.3363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.500649,0.0741238,-8.5022e-05,4.793e-08,-1.05197e-11,21071.6,23.7068], Tmin=(100,'K'), Tmax=(1118.17,'K')), NASAPolynomial(coeffs=[16.8049,0.0157995,-6.78187e-06,1.28262e-09,-9.03322e-14,17425.4,-56.7728], Tmin=(1118.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(CsCFHO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CsCsF1sO2s) + radical(RCCJ)"""),
)

species(
    label = '[C]#COC(F)C[CH2](12391)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {6,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (316.72,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,3000,3100,440,815,1455,1000,2175,525,359.464,359.464,359.464,359.464],'cm^-1')),
        HinderedRotor(inertia=(0.242128,'amu*angstrom^2'), symmetry=1, barrier=(22.2015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242128,'amu*angstrom^2'), symmetry=1, barrier=(22.2015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353914,'amu*angstrom^2'), symmetry=1, barrier=(32.4516,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242128,'amu*angstrom^2'), symmetry=1, barrier=(22.2015,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.43767,0.0683258,-5.74285e-05,1.88607e-08,-8.79918e-13,-3291.74,23.2259], Tmin=(100,'K'), Tmax=(1063.14,'K')), NASAPolynomial(coeffs=[18.5356,0.0163113,-6.72498e-06,1.29064e-09,-9.32256e-14,-8048.5,-69.4677], Tmin=(1063.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.5073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(CsCFHO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Csj(Cs-F1sO2sH)(Cs-HHH)(H))"""),
)

species(
    label = 'C#CO[C](F)CC(12393)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {5,S} {6,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.355099,0.0746672,-7.90058e-05,4.13348e-08,-8.43798e-12,-3606.45,22.4421], Tmin=(100,'K'), Tmax=(1199.22,'K')), NASAPolynomial(coeffs=[17.6191,0.0170818,-6.97547e-06,1.29096e-09,-8.98982e-14,-7747.02,-63.9827], Tmin=(1199.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.1158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(CsCFHO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[C]#COC(F)CC(12394)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {6,S}
3  C u0 p0 c0 {4,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (111.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,222.883,222.908,222.922,222.949],'cm^-1')),
        HinderedRotor(inertia=(0.683084,'amu*angstrom^2'), symmetry=1, barrier=(24.0867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.683186,'amu*angstrom^2'), symmetry=1, barrier=(24.0865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.683075,'amu*angstrom^2'), symmetry=1, barrier=(24.0866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.683041,'amu*angstrom^2'), symmetry=1, barrier=(24.0862,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.393892,0.0711188,-6.64445e-05,2.72455e-08,-3.18117e-12,13544.2,22.2404], Tmin=(100,'K'), Tmax=(1015.52,'K')), NASAPolynomial(coeffs=[17.912,0.0161124,-5.86814e-06,1.04939e-09,-7.31445e-14,9264.57,-66.0974], Tmin=(1015.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(CsCFHO) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.11366,'amu*angstrom^2'), symmetry=1, barrier=(25.6051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11348,'amu*angstrom^2'), symmetry=1, barrier=(25.6011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11345,'amu*angstrom^2'), symmetry=1, barrier=(25.6005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11347,'amu*angstrom^2'), symmetry=1, barrier=(25.6009,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.099,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C#COC([CH2])F(718)'],
    products = ['C#COC(F)C[CH2](9900)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(6)', '[CH]CC(F)OC#C(12387)'],
    products = ['C#COC(F)C[CH2](9900)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H4(30)', 'C#CO[CH]F(1536)'],
    products = ['C#COC(F)C[CH2](9900)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'C#COC(F)C=C(10838)'],
    products = ['C#COC(F)C[CH2](9900)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CO[CH]C[CH2](7403)'],
    products = ['C#COC(F)C[CH2](9900)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HCCO(21)', '[CH2]C[CH]F(204)'],
    products = ['C#COC(F)C[CH2](9900)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H(22)', '[CH2]CC([O])F(931)'],
    products = ['C#COC(F)C[CH2](9900)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH2](132)', 'C#CO[CH]F(1536)'],
    products = ['C#COC(F)C[CH2](9900)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', '[CH]=[C]OC(F)C=C(11073)'],
    products = ['C#COC(F)C[CH2](9900)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', 'C#CO[C](F)C[CH2](12390)'],
    products = ['C#COC(F)C[CH2](9900)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[C]#COC(F)C[CH2](12391)'],
    products = ['C#COC(F)C[CH2](9900)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'C#CO[CH]C=C(7406)'],
    products = ['C#COC(F)C[CH2](9900)'],
