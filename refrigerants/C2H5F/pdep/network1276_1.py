...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)OF(3932)', 'CH3(19)'],
    products = ['COC(=O)OF(3892)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(6)', '[CH2]OC(=O)OF(3930)'],
    products = ['COC(=O)OF(3892)'],
    transitionState = 'TS9',
