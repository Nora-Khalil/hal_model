...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'OC(F)CF(2443)'],
    products = ['O=C(CF)C(O)F(2871)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2O(3)', 'O=C([C]F)CF(3394)'],
    products = ['O=C(CF)C(O)F(2871)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'O=C([C]F)C(O)F(3395)'],
    products = ['O=C(CF)C(O)F(2871)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'C=C([O])C(O)F(3055)'],
    products = ['O=C(CF)C(O)F(2871)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'O=C([CH]F)CF(3404)'],
    products = ['O=C(CF)C(O)F(2871)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(F)C(=O)CF(3405)'],
    products = ['O=C(CF)C(O)F(2871)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O[CH]F(1908)', 'O=[C]CF(492)'],
    products = ['O=C(CF)C(O)F(2871)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', 'O=C(CF)[C](O)F(3406)'],
    products = ['O=C(CF)C(O)F(2871)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2F(46)', 'O=[C]C(O)F(3145)'],
    products = ['O=C(CF)C(O)F(2871)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=C([CH]F)C(O)F(3407)'],
    products = ['O=C(CF)C(O)F(2871)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=CC(=O)CF(3408)'],
    products = ['O=C(CF)C(O)F(2871)'],
