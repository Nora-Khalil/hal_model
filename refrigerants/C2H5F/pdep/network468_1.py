...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)C([O])=O(1398)'],
    products = ['C=C(O)C(=O)OF(557)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C=[C]C(=O)OF(1399)'],
    products = ['C=C(O)C(=O)OF(557)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH2]C(=O)C(=O)OF(1393)'],
    products = ['C=C(O)C(=O)OF(557)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(160)', 'C=C(O)[C]=O(1400)'],
    products = ['C=C(O)C(=O)OF(557)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]OF(331)', 'C=[C]O(142)'],
    products = ['C=C(O)C(=O)OF(557)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH]=C(O)C(=O)OF(1401)'],
    products = ['C=C(O)C(=O)OF(557)'],
