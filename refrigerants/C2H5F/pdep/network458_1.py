...
reaction(
    label = 'reaction6',
    reactants = ['[O]C(=O)OF(1245)', 'CH3(19)'],
    products = ['COC(=O)OF(547)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', '[CH2]OC(=O)OF(1246)'],
    products = ['COC(=O)OF(547)'],
    transitionState = 'TS9',
