...
"""),
    E0 = (193.128,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,615,860,1140,1343,3152,1685,370,167,640,1190,246.678,246.757,2286.16],'cm^-1')),
        HinderedRotor(inertia=(0.296341,'amu*angstrom^2'), symmetry=1, barrier=(12.8139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.297708,'amu*angstrom^2'), symmetry=1, barrier=(12.8182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65294,0.0545151,-5.90567e-05,3.58584e-08,-9.0507e-12,23310,23.9319], Tmin=(100,'K'), Tmax=(946.916,'K')), NASAPolynomial(coeffs=[8.80803,0.0242907,-1.11791e-05,2.15107e-09,-1.51554e-13,21954.9,-10.1971], Tmin=(946.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CdCFH) + group(CdCFH) + radical(Cds_S) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04976,0.0343597,-1.41627e-07,-2.15592e-08,9.77541e-12,16431.8,20.2023], Tmin=(100,'K'), Tmax=(1033.4,'K')), NASAPolynomial(coeffs=[10.2993,0.021327,-8.65657e-06,1.63111e-09,-1.16076e-13,13717.6,-24.7505], Tmin=(1033.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cds-CdsCsH) + group(CdCFH) + ring(Cs(F)-Cs-Cs) + radical(Allyl_T) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH2][C]1C=C(F)C1F(9274)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {5,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {8,S}
...
"""),
    E0 = (90.1942,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,2175,525,239,401,1367,180],'cm^-1')),
        HinderedRotor(inertia=(0.00852166,'amu*angstrom^2'), symmetry=1, barrier=(21.8156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223069,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80774,0.0495434,-4.90509e-05,2.57899e-08,-5.57172e-12,10925.7,19.7935], Tmin=(100,'K'), Tmax=(1100.02,'K')), NASAPolynomial(coeffs=[9.77451,0.0205743,-9.54897e-06,1.85016e-09,-1.31048e-13,9172.96,-19.4011], Tmin=(1100.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.1942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCtCs) + group(CdCFH) + group(Ct-Ct(Cds-Cds)) + group(CtCF) + radical(Allyl_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0789782,'amu*angstrom^2'), symmetry=1, barrier=(1.81586,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42396,0.0612323,-7.74015e-05,5.67918e-08,-1.73724e-11,12910.1,21.6532], Tmin=(100,'K'), Tmax=(788.258,'K')), NASAPolynomial(coeffs=[8.05949,0.0275594,-1.33222e-05,2.59527e-09,-1.83164e-13,11864,-8.78045], Tmin=(788.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(CdCddFH) + group(Cdd-CdsCds) + radical(CsCdF1sH) + radical(Cdj(Cdd-Cd)(F1s))"""),
)

species(
    label = 'CC(=[C]F)C=[C]F(9277)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.57482,'amu*angstrom^2'), symmetry=1, barrier=(13.2162,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.573669,'amu*angstrom^2'), symmetry=1, barrier=(13.1898,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01498,0.0690418,-9.57262e-05,7.10191e-08,-2.09839e-11,22359,21.6071], Tmin=(100,'K'), Tmax=(829.728,'K')), NASAPolynomial(coeffs=[10.9037,0.0213705,-9.54696e-06,1.7776e-09,-1.2164e-13,20718,-24.2548], Tmin=(829.728,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(CdCFH) + group(CdCFH) + radical(CdCdF1s) + radical(Cdj(Cd-CdH)(F1s))"""),
)

species(
    label = 'C=C([C]F)C=CF(9278)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {5,D} {7,S}
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2915,0.0584943,-6.01861e-05,3.161e-08,-6.62736e-12,7268.28,20.4395], Tmin=(100,'K'), Tmax=(1151.84,'K')), NASAPolynomial(coeffs=[12.7602,0.0186676,-8.3221e-06,1.59245e-09,-1.12328e-13,4626.22,-36.5117], Tmin=(1151.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.6133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(CdCFH) + radical(CsCCl_triplet)"""),
)
...
"""),
    ...
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9217,0.0376418,-8.76298e-06,-1.29882e-08,6.74695e-12,4779.74,18.6213], Tmin=(100,'K'), Tmax=(1066.65,'K')), NASAPolynomial(coeffs=[10.7906,0.0210298,-8.81255e-06,1.67459e-09,-1.19089e-13,1940.72,-29.1777], Tmin=(1066.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.0617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(CdCsCdF) + ring(Cd(F)-Cd-Cs-Cs) + radical(Allyl_T) + radical(CsCsF1sH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[C]C=C=CF(2762)'],
    products = ['[CH2]C(C=[C]F)=CF(8542)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(C=[C]F)=CF(8542)'],
    products = ['[CH2][C]1C=C(F)C1F(9274)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(C#CF)=CF(9275)'],
    products = ['[CH2]C(C=[C]F)=CF(8542)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]F(837)', 'C=C=C[C]F(2636)'],
    products = ['[CH2]C(C=[C]F)=CF(8542)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(C=[C]F)=CF(8542)'],
    products = ['F[CH][C]1C=C(F)C1(9281)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CHF(40)', 'C=C=C[C]F(2636)'],
    products = ['[CH2]C(C=[C]F)=CF(8542)'],
