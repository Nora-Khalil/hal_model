...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(F)(F)C(F)F(4473)'],
    products = ['F[C](F)CC(F)F(4472)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[C]CC(F)F-2(3549)'],
    products = ['F[C](F)CC(F)F(4472)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F[C]F(3442)', 'CHF2-CH2(63)'],
    products = ['F[C](F)CC(F)F(4472)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'FC(F)=CC(F)F(4907)'],
    products = ['F[C](F)CC(F)F(4472)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'F[CH]C[C](F)F(3551)'],
    products = ['F[C](F)CC(F)F(4472)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF2(81)', '[CH2][C](F)F(4220)'],
    products = ['F[C](F)CC(F)F(4472)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'F[C](F)[CH]C(F)F(4908)'],
    products = ['F[C](F)CC(F)F(4472)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[C](F)C[C](F)F(4661)'],
    products = ['F[C](F)CC(F)F(4472)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', 'F[CH]C=C(F)F(4388)'],
    products = ['F[C](F)CC(F)F(4472)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'F[C]CC(F)F(2510)'],
    products = ['F[C](F)CC(F)F(4472)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C](F)CC(F)F(4472)'],
    products = ['F[CH]CC(F)(F)F(4910)'],
