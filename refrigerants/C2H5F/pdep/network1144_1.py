...
"""),
    E0 = (286.803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([293,496,537,1218,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,288.707,288.871,2274.12],'cm^-1')),
        HinderedRotor(inertia=(0.151429,'amu*angstrom^2'), symmetry=1, barrier=(8.96238,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633019,'amu*angstrom^2'), symmetry=1, barrier=(37.4341,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92819,0.0495567,-7.09828e-05,5.97905e-08,-2.06731e-11,34565.3,23.1271], Tmin=(100,'K'), Tmax=(771.71,'K')), NASAPolynomial(coeffs=[6.61017,0.0219215,-1.07224e-05,2.07861e-09,-1.4536e-13,33942.9,2.4022], Tmin=(771.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4481,0.0279316,-5.92261e-06,-1.02737e-08,5.17333e-12,-9133.81,13.4351], Tmin=(100,'K'), Tmax=(1075.99,'K')), NASAPolynomial(coeffs=[9.2324,0.0155742,-6.62789e-06,1.27385e-09,-9.11689e-14,-11338.4,-23.2522], Tmin=(1075.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.4511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(CdCFO) + group(Cds-CdsHH) + ring(Oxetene)"""),
)
...
"""),
    E0 = (294.155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([293,496,537,1218,3010,987.5,1337.5,450,1655,3115,3125,620,680,785,800,1600,1700,273.668,274.476],'cm^-1')),
        HinderedRotor(inertia=(0.284989,'amu*angstrom^2'), symmetry=1, barrier=(15.0152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.552493,'amu*angstrom^2'), symmetry=1, barrier=(29.2489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7112,0.0504797,-5.74283e-05,3.32125e-08,-7.61547e-12,35461.1,21.1834], Tmin=(100,'K'), Tmax=(1061.36,'K')), NASAPolynomial(coeffs=[11.2609,0.0144882,-6.56092e-06,1.26061e-09,-8.90851e-14,33434,-25.4569], Tmin=(1061.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(408)', '[C]=C(134)'],
    products = ['[CH]=C(F)O[C]=C(2544)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)OC#C(2673)'],
    products = ['[CH]=C(F)O[C]=C(2544)'],
    transitionState = 'TS7',
