...
"""),
    ...
    molecularWeight = (110.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.911597,0.0727516,-9.70879e-05,7.00033e-08,-2.03472e-11,-46102,24.2326], Tmin=(100,'K'), Tmax=(838.059,'K')), NASAPolynomial(coeffs=[10.8651,0.025243,-1.20521e-05,2.35623e-09,-1.66867e-13,-47770.3,-22.0284], Tmin=(838.059,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-384.203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-F1sF1sCs)(Cs-F1sHH)(H)) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C[CH]F(3187)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[CH]C[C](F)F(3024)'],
    products = ['[CH2]C(F)(F)C[CH]F(3187)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(181)', '[CH2]C([CH2])(F)F(3239)'],
    products = ['[CH2]C(F)(F)C[CH]F(3187)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C=C(F)C[CH]F(234)'],
    products = ['[CH2]C(F)(F)C[CH]F(3187)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(6)', '[CH2]C(F)(F)C=CF(3217)'],
    products = ['[CH2]C(F)(F)C[CH]F(3187)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', '[CH2]C(F)=C[CH]F(3253)'],
    products = ['[CH2]C(F)(F)C[CH]F(3187)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHF(40)', '[CH2]C([CH2])(F)F(3239)'],
    products = ['[CH2]C(F)(F)C[CH]F(3187)'],
...
network(
    label = 'PDepNetwork #1023',
    isomers = [
        '[CH2]C(F)(F)C[CH]F(3187)',
    ],
    reactants = [
        ('CH2CF2(56)', 'CH2CHF(55)'),
    ],
