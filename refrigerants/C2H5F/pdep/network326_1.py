...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH]C=C(341)'],
    products = ['[CH]=CC[C]=O(420)'],
    transitionState = 'TS3',
