...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]C[O](144)'],
    products = ['[O]CC[C]=O(367)'],
    transitionState = 'TS3',
