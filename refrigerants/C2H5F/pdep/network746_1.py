...
reaction(
    label = 'reaction3',
    reactants = ['O(7)', '[CH2]C(=O)[CH]F(724)'],
    products = ['C=C([O])C([O])F(1201)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', '[CH2]C(=O)C=O(890)'],
    products = ['C=C([O])C([O])F(1201)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', '[CH2]C(=O)C(=O)F(544)'],
    products = ['C=C([O])C([O])F(1201)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(18)', '[O]C(F)[C]=O(2268)'],
    products = ['C=C([O])C([O])F(1201)'],
