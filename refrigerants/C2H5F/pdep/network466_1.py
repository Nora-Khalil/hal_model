...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=CCOF(1438)'],
    products = ['O=CCC(=O)OF(555)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(160)', 'O=[C]CC=O(235)'],
    products = ['O=CCC(=O)OF(555)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(331)', 'CH2CHO(35)'],
    products = ['O=CCC(=O)OF(555)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HCO(15)', '[CH2]C(=O)OF(650)'],
    products = ['O=CCC(=O)OF(555)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C=CC(=O)OF(1446)'],
    products = ['O=CCC(=O)OF(555)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'O=[C]CC(=O)OF(1447)'],
    products = ['O=CCC(=O)OF(555)'],
