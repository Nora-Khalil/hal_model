...
"""),
    E0 = (-301.642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,493,600,700,1144,1293,615,860,1140,1343,3152,1685,370,180,180,2030.84,2031.98,2037.3],'cm^-1')),
        HinderedRotor(inertia=(0.468971,'amu*angstrom^2'), symmetry=1, barrier=(10.7826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59094,'amu*angstrom^2'), symmetry=1, barrier=(36.5789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.469477,'amu*angstrom^2'), symmetry=1, barrier=(10.7942,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01325,0.0530796,-3.49725e-05,-4.55142e-08,6.68083e-11,-36217.4,26.3735], Tmin=(100,'K'), Tmax=(466.749,'K')), NASAPolynomial(coeffs=[6.62151,0.0302751,-1.5316e-05,3.01155e-09,-2.12244e-13,-36829.4,5.70538], Tmin=(466.749,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-301.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(F1s)(F1s)(O2s-Cs)) + radical(Cdj(Cs-O2sHH)(Cd-F1sH))"""),
)
...
"""),
    E0 = (-195.286,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,493,600,700,1144,1293,2175,525,750,770,3400,2100,180,180,2926.52],'cm^-1')),
        HinderedRotor(inertia=(2.91667,'amu*angstrom^2'), symmetry=1, barrier=(67.0599,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343166,'amu*angstrom^2'), symmetry=1, barrier=(7.89006,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.92293,'amu*angstrom^2'), symmetry=1, barrier=(67.2039,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41782,0.0624656,-9.76336e-05,8.39608e-08,-2.81765e-11,-23399.9,22.8604], Tmin=(100,'K'), Tmax=(864.373,'K')), NASAPolynomial(coeffs=[7.39599,0.0236064,-1.07724e-05,1.9841e-09,-1.33158e-13,-24015.2,-2.69039], Tmin=(864.373,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-195.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CtOsHH) + group(CsFFHO) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(F1s)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-302.909,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,493,600,700,1144,1293,167,640,1190,180,180,180,1959.71],'cm^-1')),
        HinderedRotor(inertia=(0.196993,'amu*angstrom^2'), symmetry=1, barrier=(4.52926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197045,'amu*angstrom^2'), symmetry=1, barrier=(4.53046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197029,'amu*angstrom^2'), symmetry=1, barrier=(4.53009,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04367,0.0734075,-0.000122,1.11974e-07,-4.01293e-11,-36333.2,27.9297], Tmin=(100,'K'), Tmax=(827.6,'K')), NASAPolynomial(coeffs=[6.62619,0.0305425,-1.55205e-05,3.01035e-09,-2.08619e-13,-36713.2,5.33987], Tmin=(827.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(Csj(F1s)(F1s)(O2s-Cs)) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (-263.334,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,519,593,830,1115,1166,1389,1413,3114,1685,370,167,640,1190,180,180,1055.48,1055.6],'cm^-1')),
        HinderedRotor(inertia=(0.242404,'amu*angstrom^2'), symmetry=1, barrier=(5.57334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241583,'amu*angstrom^2'), symmetry=1, barrier=(5.55446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241402,'amu*angstrom^2'), symmetry=1, barrier=(5.55032,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70073,0.0584471,-6.14525e-05,1.65794e-08,1.45197e-11,-31596.7,26.7505], Tmin=(100,'K'), Tmax=(531.626,'K')), NASAPolynomial(coeffs=[7.28696,0.0291358,-1.46401e-05,2.88261e-09,-2.0392e-13,-32370.4,1.63902], Tmin=(531.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-O2sHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=[C]COC(F)(F)F(9262)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (124.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08716,0.069997,-0.000107021,9.19122e-08,-3.16993e-11,-38563.4,26.7806], Tmin=(100,'K'), Tmax=(795.208,'K')), NASAPolynomial(coeffs=[8.16995,0.027429,-1.36328e-05,2.64399e-09,-1.84262e-13,-39470.4,-4.38691], Tmin=(795.208,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-321.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFFFO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)CO[C](F)F(9263)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3442)', '[O]C[C]=CF(2647)'],
    products = ['FC=[C]CO[C](F)F(8614)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1334)', '[CH2]O[C](F)F(4535)'],
    products = ['FC=[C]CO[C](F)F(8614)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C#CCO[C](F)F(8090)'],
    products = ['FC=[C]CO[C](F)F(8614)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[O]C[C]=CF(2647)'],
    products = ['FC=[C]CO[C](F)F(8614)'],
