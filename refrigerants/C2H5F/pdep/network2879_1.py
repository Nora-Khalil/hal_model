...
"""),
    E0 = (-1002.69,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,333,384,448,608,1254,1480,223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.820333,'amu*angstrom^2'), symmetry=1, barrier=(18.8611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.820359,'amu*angstrom^2'), symmetry=1, barrier=(18.8617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.820505,'amu*angstrom^2'), symmetry=1, barrier=(18.865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.820521,'amu*angstrom^2'), symmetry=1, barrier=(18.8654,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0832886,0.0910648,-0.00011737,7.65045e-08,-1.98352e-11,-120458,25.9091], Tmin=(100,'K'), Tmax=(939.611,'K')), NASAPolynomial(coeffs=[15.3932,0.0258892,-1.33238e-05,2.68236e-09,-1.93537e-13,-123335,-46.999], Tmin=(939.611,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1002.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH)"""),
)
...
"""),
    ...
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.320046,0.102409,-0.00015775,1.25319e-07,-3.9475e-11,-120648,26.7866], Tmin=(100,'K'), Tmax=(779.334,'K')), NASAPolynomial(coeffs=[14.1656,0.0280599,-1.46465e-05,2.90296e-09,-2.05174e-13,-122906,-39.4864], Tmin=(779.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1004.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFF) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(CsCFOO) + group(Cs-CsHHH)"""),
)

species(
    label = 'CC(O)(OF)C(F)(F)F(8026)',
...
"""),
    ...
    molecularWeight = (148.056,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.29129,0.0967077,-0.000111906,5.87216e-08,-1.14204e-11,-121992,30.243], Tmin=(100,'K'), Tmax=(1413,'K')), NASAPolynomial(coeffs=[28.5403,0.00107642,1.48445e-06,-3.77839e-10,2.69433e-14,-129306,-120.04], Tmin=(1413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1016.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(CsCsFFF) + longDistanceInteraction_noncyclic(Cs(F)3-CsOs) + group(Cs-CsHHH)"""),
)
...
"""),
    E0 = (-768.736,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,286,334,437,422,648,895,1187,223,363,546,575,694,1179,1410,2750,2800,2850,1350,1500,750,1050,1375,1000,207.345,207.345],'cm^-1')),
        HinderedRotor(inertia=(0.273976,'amu*angstrom^2'), symmetry=1, barrier=(8.35847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.6714,'amu*angstrom^2'), symmetry=1, barrier=(20.4831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273975,'amu*angstrom^2'), symmetry=1, barrier=(8.35847,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (147.048,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.219204,0.0896623,-0.000129138,9.62272e-08,-2.8606e-11,-92327.2,26.5619], Tmin=(100,'K'), Tmax=(822.429,'K')), NASAPolynomial(coeffs=[13.2162,0.0264498,-1.38473e-05,2.77275e-09,-1.98141e-13,-94465.1,-33.6005], Tmin=(822.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-768.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + group(CsCFFO) + longDistanceInteraction_noncyclic(Cs(F)2-Cs(F)) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs))"""),
)
...
"""),
    E0 = (-730.713,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,316,385,515,654,689,1295,2750,2800,2850,1350,1500,750,1050,1375,1000,190,488,555,1236,1407,180],'cm^-1')),
        HinderedRotor(inertia=(0.511267,'amu*angstrom^2'), symmetry=1, barrier=(11.755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.511293,'amu*angstrom^2'), symmetry=1, barrier=(11.7556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.510762,'amu*angstrom^2'), symmetry=1, barrier=(11.7434,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.058,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.67625,0.0244172,0.000171012,-5.60555e-07,4.95085e-10,-87884,12.8505], Tmin=(10,'K'), Tmax=(414.792,'K')), NASAPolynomial(coeffs=[7.14624,0.0347252,-2.455e-05,8.16039e-09,-1.01869e-12,-88548.4,-5.3756], Tmin=(414.792,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-730.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""CC(O)(F)[C](F)F""", comment="""Thermo library: CHOF_G4"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(O)(F)C(F)(F)OF(7540)'],
    products = ['HF(38)', 'CF2O(49)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(21.3838,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH3OH(26)', 'F[C]C(F)(F)OF(7809)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.14358e+07,'m^3/(mol*s)'), n=-0.641018, Ea=(173.249,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17570294811609, var=29.477358162589667, Tref=1000.0, N=2, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    ...
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.14358e+07,'m^3/(mol*s)'), n=-0.641018, Ea=(190.937,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17570294811609, var=29.477358162589667, Tref=1000.0, N=2, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CF2(43)', 'CC(O)(F)OF(5746)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(217.282,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction5',
    reactants = ['FOF(1637)', 'CC(O)(F)[C]F(5693)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(S)(25)', 'OC(F)C(F)(F)OF(7534)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['OF(169)', 'CC(F)=C(F)OF(4855)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H2O(3)', 'C=C(F)C(F)(F)OF(8033)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction11',
    reactants = ['FOF(1637)', 'CC(O)=C(F)F(8034)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C[C](O)C(F)(F)OF(8035)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'CC(O)(F)[C](F)OF(5821)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', 'CC(O)(F)C([O])(F)F(8036)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OH(7)', 'C[C](F)C(F)(F)OF(7815)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'CC([O])(F)C(F)(F)OF(8037)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]F(160)', 'CC(O)(F)[C](F)F(8038)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction18',
    reactants = ['FO[C](F)F(7422)', 'C[C](O)F(1910)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(19)', 'O[C](F)C(F)(F)OF(7956)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(5)', '[CH2]C(O)(F)C(F)(F)OF(8039)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'CC(=O)C(F)(F)OF(7512)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(156.095,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)

reaction(
    label = 'reaction22',
    reactants = ['F2(77)', 'CC(O)(F)C(=O)F(5288)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(77)', 'CC(O)=C(F)OF(3027)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HF(38)', 'C=C(O)C(F)(F)OF(7510)'],
    products = ['CC(O)(F)C(F)(F)OF(7540)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC(O)(F)C(F)(F)OF(7540)'],
    products = ['HF(38)', 'CF2O(49)', 'C=C(O)F(498)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(44.6748,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

network(
    label = 'PDepNetwork #2879',
    isomers = [
        'CC(O)(F)C(F)(F)OF(7540)',
    ],
    reactants = [
