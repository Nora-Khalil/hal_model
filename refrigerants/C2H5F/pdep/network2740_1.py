...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CC([O])(F)F(7396)'],
    products = ['CC([O])C([O])(F)F(7415)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C[CH]C([O])(F)F(7549)'],
    products = ['CC([O])C([O])(F)F(7415)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', '[O]C(F)(F)C=O(7723)'],
    products = ['CC([O])C([O])(F)F(7415)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'CC(=O)C([O])(F)F(7841)'],
    products = ['CC([O])C([O])(F)F(7415)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC([O])C(=O)F(2211)'],
    products = ['CC([O])C([O])(F)F(7415)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'CC([O])=C([O])F(2145)'],
    products = ['CC([O])C([O])(F)F(7415)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(O)C([O])(F)F(7895)'],
    products = ['CC([O])C([O])(F)F(7415)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([O])C(O)(F)F(7897)'],
    products = ['CC([O])C([O])(F)F(7415)'],
