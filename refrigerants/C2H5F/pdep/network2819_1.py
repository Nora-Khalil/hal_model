...
"""),
    E0 = (-278.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,223,363,546,575,694,1179,1410,3010,987.5,1337.5,450,1655,201.129,201.26],'cm^-1')),
        HinderedRotor(inertia=(0.396058,'amu*angstrom^2'), symmetry=1, barrier=(11.1891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.389209,'amu*angstrom^2'), symmetry=1, barrier=(11.1845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.390258,'amu*angstrom^2'), symmetry=1, barrier=(11.1946,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.979589,0.0721041,-0.000104498,7.92474e-08,-2.33547e-11,-33388.5,22.2111], Tmin=(100,'K'), Tmax=(684.863,'K')), NASAPolynomial(coeffs=[10.4001,0.0233871,-1.16049e-05,2.26267e-09,-1.58784e-13,-34826.7,-20.7506], Tmin=(684.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCFFO) + group(Cds-CdsCsH) + group(CdJ2_singlet-Cds)"""),
)
...
"""),
    E0 = (-187.253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,486,617,768,1157,1926,2175,525,750,770,3400,2100,180],'cm^-1')),
        HinderedRotor(inertia=(0.0837638,'amu*angstrom^2'), symmetry=1, barrier=(24.1578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0803124,'amu*angstrom^2'), symmetry=1, barrier=(24.1823,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-123.291,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3010,987.5,1337.5,450,1655,326,540,652,719,1357,2175,525,750,770,3400,2100],'cm^-1')),
        HinderedRotor(inertia=(1.40356,'amu*angstrom^2'), symmetry=1, barrier=(32.2706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41413,'amu*angstrom^2'), symmetry=1, barrier=(32.5136,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52013,0.0468656,-3.69031e-05,5.47697e-09,3.58714e-12,-14732.3,17.0587], Tmin=(100,'K'), Tmax=(962.63,'K')), NASAPolynomial(coeffs=[15.3892,0.00686809,-2.05278e-06,3.69315e-10,-2.80035e-14,-18219.4,-53.5666], Tmin=(962.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-CdsCtH) + group(CdCFO) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#CCC(O)(F)F(7490)'],
    products = ['CF2O(49)', 'C=C=C(6556)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(156.258,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#CC(O)(F)F(10740)'],
    products = ['C#CCC(O)(F)F(7490)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(141.392,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)
...
reaction(
    ...
    products = ['C#CCC(O)(F)F(7490)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.40908e-07,'m^3/(mol*s)'), n=3.45227, Ea=(192.6,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['OF(169)', 'C#CC[C]F(8282)'],
    products = ['C#CCC(O)(F)F(7490)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'C#CC=C(F)F(10741)'],
    products = ['C#CCC(O)(F)F(7490)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C#CC[C](O)F(10742)'],
    products = ['C#CCC(O)(F)F(7490)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(7)', 'C#CC[C](F)F(4528)'],
    products = ['C#CCC(O)(F)F(7490)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['C#CCC(O)(F)F(7490)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2.63131e-11,'m^3/(mol*s)'), n=4.71246, Ea=(0.693249,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_Ext-2CF-R_Ext-4R!H-R"""),
)

reaction(
    label = 'reaction10',
    reactants = ['C2H(22)', '[CH2]C(O)(F)F(1356)'],
    products = ['C#CCC(O)(F)F(7490)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[C]#CCC(O)(F)F(10117)'],
    products = ['C#CCC(O)(F)F(7490)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', 'C#CCC(=O)F(4878)'],
    products = ['C#CCC(O)(F)F(7490)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C#CC=C(O)F(10744)'],
    products = ['C#CCC(O)(F)F(7490)'],
