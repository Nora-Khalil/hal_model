...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C([O])=O(1279)'],
    products = ['[O]C(=O)C[CH]F(1280)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', '[CH2]C([O])=O(157)'],
    products = ['[O]C(=O)C[CH]F(1280)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C([O])=O(157)'],
    products = ['[O]C(=O)C[CH]F(1280)'],
