...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH]C=C=O(759)'],
    products = ['[CH]=CC([O])=O(3620)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C]=O(3667)', '[CH]=[CH](272)'],
    products = ['[CH]=CC([O])=O(3620)'],
