...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(3622)', 'C[C]F-2(182)'],
    products = ['C[C](F)OC([O])=O(3797)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([O])=O(3622)', 'C[C]F(124)'],
    products = ['C[C](F)OC([O])=O(3797)'],
