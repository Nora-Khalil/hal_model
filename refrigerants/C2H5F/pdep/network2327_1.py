...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(837)', '[CH2]C([CH2])=C(6712)'],
    products = ['[CH2]C(=C)C[CH]F(6165)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[CH2]C(=C)C=CF(6717)'],
    products = ['[CH2]C(=C)C[CH]F(6165)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C([CH2])=C(6712)'],
    products = ['[CH2]C(=C)C[CH]F(6165)'],
