...
"""),
    E0 = (121.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,323,467,575,827,1418,3010,987.5,1337.5,450,1655,388.609,388.632,388.636,388.651],'cm^-1')),
        HinderedRotor(inertia=(0.476599,'amu*angstrom^2'), symmetry=1, barrier=(51.0843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.476638,'amu*angstrom^2'), symmetry=1, barrier=(51.0845,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(F)C([O])F(2565)'],
    products = ['CHFO(47)', 'C2HF(57)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(F)=CF(2625)'],
    products = ['[CH]=C(F)C([O])F(2565)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', '[CH]=C(F)C=O(1338)'],
    products = ['[CH]=C(F)C([O])F(2565)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)C(=O)F(2724)'],
    products = ['[CH]=C(F)C([O])F(2565)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]F(1657)', '[CH]=[C]F(1321)'],
    products = ['[CH]=C(F)C([O])F(2565)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HF(38)', '[CH]=C=C([O])F(2725)'],
    products = ['[CH]=C(F)C([O])F(2565)'],
