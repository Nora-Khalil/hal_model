...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC[C](F)F(4433)'],
    products = ['[CH]=C(C)C[C](F)F(6147)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(3442)', '[CH]C(=C)C(6159)'],
    products = ['[CH]=C(C)C[C](F)F(6147)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[CH]=C(C)C=C(F)F(6430)'],
    products = ['[CH]=C(C)C[C](F)F(6147)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'C#CC[C](F)F(4528)'],
    products = ['[CH]=C(C)C[C](F)F(6147)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CF2(43)', '[CH]C(=C)C(6159)'],
    products = ['[CH]=C(C)C[C](F)F(6147)'],
