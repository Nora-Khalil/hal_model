...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC([O])=O(3620)'],
    products = ['[CH]=C(CF)C([O])=O(8949)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C([O])=O(5476)'],
    products = ['[CH]=C(CF)C([O])=O(8949)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(7)', '[CH]C(=C=O)CF(8948)'],
    products = ['[CH]=C(CF)C([O])=O(8949)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2F(46)', 'C#CC([O])=O(3710)'],
    products = ['[CH]=C(CF)C([O])=O(8949)'],
