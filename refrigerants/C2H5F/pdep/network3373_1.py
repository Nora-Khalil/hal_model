...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.17637,'amu*angstrom^2'), symmetry=1, barrier=(50.039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.1673,'amu*angstrom^2'), symmetry=1, barrier=(49.8305,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23512,0.0488876,-4.67059e-06,-2.77303e-08,1.35981e-11,-94.1769,23.6722], Tmin=(100,'K'), Tmax=(1012.54,'K')), NASAPolynomial(coeffs=[13.7667,0.026017,-1.02471e-05,1.92069e-09,-1.3722e-13,-3997.25,-43.6836], Tmin=(1012.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.6975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + ring(Cs(F)-Cs-Cs) + radical(Allyl_T) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1=C([CH]F)CC1F(9599)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
3  C u0 p0 c0 {4,S} {5,S} {9,S} {10,S}
...
"""),
    ...
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.970292,0.0550526,-1.93729e-05,-1.34246e-08,8.43202e-12,-2316.57,25.144], Tmin=(100,'K'), Tmax=(1060.16,'K')), NASAPolynomial(coeffs=[15.0147,0.0255356,-1.08212e-05,2.08246e-09,-1.49659e-13,-6613.53,-49.654], Tmin=(1060.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.2505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCCFH) + group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + ring(Cs(F)-Cs-Cd-Cd) + radical(Allyl_P) + radical(Csj(Cd-CsCd)(F1s)(H))"""),
)
...
"""),
    E0 = (43.2336,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,194,682,905,1196,1383,3221,167,640,1190,320.983],'cm^-1')),
        HinderedRotor(inertia=(0.184667,'amu*angstrom^2'), symmetry=1, barrier=(13.4556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184336,'amu*angstrom^2'), symmetry=1, barrier=(13.44,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.467035,'amu*angstrom^2'), symmetry=1, barrier=(34.1319,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.108,'amu'),
...
"""),
    E0 = (22.0227,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,194,682,905,1196,1383,3221,2950,3100,1380,975,1025,1650,297.402,297.409,297.414,297.42],'cm^-1')),
        HinderedRotor(inertia=(0.00190584,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256323,'amu*angstrom^2'), symmetry=1, barrier=(16.0885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256323,'amu*angstrom^2'), symmetry=1, barrier=(16.0884,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.108,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.633043,0.0762241,-8.24308e-05,4.74946e-08,-1.11173e-11,2768.21,23.4104], Tmin=(100,'K'), Tmax=(1027.9,'K')), NASAPolynomial(coeffs=[12.8456,0.0286996,-1.30784e-05,2.51429e-09,-1.77387e-13,257.576,-35.8439], Tmin=(1027.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.0227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(CdCFH) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)
...
species(
    label = '[CH2]C1=C([CH2])C(F)C1F(9604)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  F u0 p3 c0 {4,S}
3  C u0 p0 c0 {1,S} {4,S} {5,S} {9,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=CF)C([CH2])=CF(8637)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[CH2]C([C]=CF)=CF(9158)'],
    products = ['[CH2]C(=CF)C([CH2])=CF(8637)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(=CF)C([CH2])=CF(8637)'],
    products = ['[CH2]C(=CF)[C]1CC1F(9598)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=CF)C([CH2])=CF(8637)'],
    products = ['[CH2]C1=C([CH]F)CC1F(9599)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(=CF)C(C)=[C]F(9600)'],
    products = ['[CH2]C(=CF)C([CH2])=CF(8637)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]F(837)', '[CH2]C([C]=C)=CF(8828)'],
    products = ['[CH2]C(=CF)C([CH2])=CF(8637)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(=CF)C([CH2])=CF(8637)'],
    products = ['[CH2]C1=C([CH2])C(F)C1F(9604)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(=CF)C([CH2])=CF(8637)'],
    products = ['F[CH]C1=C([CH]F)CC1(9605)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHF(40)', '[CH2]C([C]=C)=CF(8828)'],
    products = ['[CH2]C(=CF)C([CH2])=CF(8637)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C(=C)C(=C)C(F)F(9608)'],
    products = ['[CH2]C(=CF)C([CH2])=CF(8637)'],
