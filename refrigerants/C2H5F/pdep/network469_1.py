...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'C=C(O)OF(1265)'],
    products = ['C=C(OF)C(=O)O(558)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(=O)C(=O)O(311)'],
    products = ['C=C(OF)C(=O)O(558)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(160)', 'C=[C]C(=O)O(1372)'],
    products = ['C=C(OF)C(=O)O(558)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(7)', 'C=C([C]=O)OF(1373)'],
    products = ['C=C(OF)C(=O)O(558)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C=C(OF)C([O])=O(1374)'],
    products = ['C=C(OF)C(=O)O(558)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]O(146)', 'C=[C]OF(491)'],
    products = ['C=C(OF)C(=O)O(558)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH]=C(OF)C(=O)O(1375)'],
    products = ['C=C(OF)C(=O)O(558)'],
