...
"""),
    E0 = (-686.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,259,529,569,1128,1321,1390,3140,334,575,1197,1424,3202,200,800,960,1120,1280,1440,1600],'cm^-1')),
...
"""),
    E0 = (-256.859,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,250,417,511,1155,1315,1456,3119,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35673,0.0634483,-7.55755e-05,5.37891e-08,-1.63443e-11,-30802.6,23.3498], Tmin=(100,'K'), Tmax=(785.574,'K')), NASAPolynomial(coeffs=[7.49632,0.0321863,-1.58825e-05,3.13098e-09,-2.2283e-13,-31767.2,-4.78839], Tmin=(785.574,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCsCsFH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (-508.663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,250,417,511,1155,1315,1456,3119,90,150,250,247,323,377,431,433,1065,1274],'cm^-1')),
        HinderedRotor(inertia=(0.00154928,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00153373,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00154707,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27195,0.0686595,-7.83466e-05,3.56965e-08,4.09535e-12,-61088.2,23.6298], Tmin=(100,'K'), Tmax=(549.444,'K')), NASAPolynomial(coeffs=[7.80762,0.0336944,-1.73305e-05,3.45015e-09,-2.45842e-13,-61996.8,-5.71997], Tmin=(549.444,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-508.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CsCCl_triplet)"""),
)

species(
    label = 'O[C]1CC(F)C(F)O1(4255)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-562.761,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,174,267,591,721,1107,1278,1348,3273,3010,987.5,1337.5,450,1655,350,440,435,1725,334,575,1197,1424,3202,180],'cm^-1')),
        HinderedRotor(inertia=(0.812023,'amu*angstrom^2'), symmetry=1, barrier=(18.67,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.809091,'amu*angstrom^2'), symmetry=1, barrier=(18.6026,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.812232,'amu*angstrom^2'), symmetry=1, barrier=(18.6748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.813014,'amu*angstrom^2'), symmetry=1, barrier=(18.6928,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.334055,0.094284,-0.000126549,8.21369e-08,-2.04749e-11,-67527.4,27.2032], Tmin=(100,'K'), Tmax=(994.083,'K')), NASAPolynomial(coeffs=[19.5937,0.0140973,-5.55121e-06,9.89841e-10,-6.70242e-14,-71489.3,-68.8179], Tmin=(994.083,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-562.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(Csj(Cs-F1sCdH)(F1s)(H))"""),
)

species(
    label = 'O=C(O)CC=CF(10733)',
...
"""),
    E0 = (-550.616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,396.552,396.573,396.587,396.606,396.619,396.63],'cm^-1')),
        HinderedRotor(inertia=(0.00107173,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00107201,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00107183,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66323,0.0425196,-1.26436e-05,-9.56166e-09,4.85333e-12,-66132.5,22.2338], Tmin=(100,'K'), Tmax=(1211.42,'K')), NASAPolynomial(coeffs=[12.9252,0.0235611,-1.17388e-05,2.36109e-09,-1.70427e-13,-70198.5,-39.7792], Tmin=(1211.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-550.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(CdCFH)"""),
)
...
"""),
    E0 = (-289.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,334,575,1197,1424,3202,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57374,0.0582991,-6.65201e-05,4.73216e-08,-1.46846e-11,-34750,26.2429], Tmin=(100,'K'), Tmax=(764.149,'K')), NASAPolynomial(coeffs=[6.50523,0.0324848,-1.58473e-05,3.11312e-09,-2.21244e-13,-35503.7,3.77783], Tmin=(764.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(Cds-OdCsOs) + radical(CCJCC=O) + radical(Csj(Cs-CsHH)(F1s)(H))"""),
)
...
"""),
    E0 = (-496.506,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,212,367,445,1450,334,575,1197,1424,3202,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.638806,0.085132,-0.000147587,1.39953e-07,-5.12324e-11,-59605.7,28.7471], Tmin=(100,'K'), Tmax=(831.212,'K')), NASAPolynomial(coeffs=[5.85661,0.0370275,-1.92808e-05,3.76435e-09,-2.61365e-13,-59678.7,9.31728], Tmin=(831.212,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-496.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'O=C(O)[CH]C=CF(10231)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-433.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,477.99,478.019,478.019,478.021,478.022,478.023],'cm^-1')),
        HinderedRotor(inertia=(0.000737804,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275192,'amu*angstrom^2'), symmetry=1, barrier=(44.6252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275224,'amu*angstrom^2'), symmetry=1, barrier=(44.6253,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43701,0.0465942,-2.09336e-05,-4.84533e-09,4.01679e-12,-52061.7,20.2431], Tmin=(100,'K'), Tmax=(1190.77,'K')), NASAPolynomial(coeffs=[14.8382,0.0198758,-1.03269e-05,2.12137e-09,-1.55243e-13,-56550.5,-52.197], Tmin=(1190.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(CdCFH) + radical(C=CCJCO)"""),
)
...
"""),
    E0 = (-679.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,259,529,569,1128,1321,1390,3140,528,1116,1182,1331,1402,1494,3075,3110,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
"""),
    E0 = (-653.532,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
reaction(
    label = 'reaction4',
    reactants = ['H2O(3)', 'O=C=CC(F)[CH]F(5556)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2CO(28)', 'OC(F)[CH]F(1782)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction2',
    reactants = ['C=C(O)OC(F)[CH]F(3791)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', '[CH]C(F)CC(=O)O-2(10730)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]F(837)', 'O=C(O)C[CH]F(2435)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(O)CC(F)[C]F(10731)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C(O)CC(F)[CH]F(4252)'],
    products = ['O[C]1CC(F)C(F)O1(4255)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4.47116e+08,'s^-1'), n=0.669085, Ea=(80.4873,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs] for rate rule [R5_SS_CO;carbonyl_intra_Nd;radadd_intra_cs]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Endocyclic
Ea raised from 75.7 to 80.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(902977,'s^-1'), n=1.63829, Ea=(141.558,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_cs]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Exocyclic
Ea raised from 137.9 to 141.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction12',
    reactants = ['OC(O)=CC(F)[CH]F(10732)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(410000,'s^-1'), n=2.37, Ea=(163.531,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_Ext-1R!H-R',), comment="""Estimated from node Root_3R!H->C_Ext-1R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'O=C(O)CC=CF(10733)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CHFCHF[Z](58)', '[CH2]C(=O)O(166)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(13.5582,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=C(O)CC(F)=CF(9666)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', 'O=C(O)C[CH][CH]F(10734)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(7)', 'O=[C]CC(F)[CH]F(5519)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[O]C(=O)CC(F)[CH]F(10735)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
...
reaction(
    label = 'reaction19',
    reactants = ['F[CH][CH]F(4261)', '[CH2]C(=O)O(166)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(O)[CH]C(F)[CH]F(10736)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=C(O)C[C](F)[CH]F(10737)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HF(38)', 'O=C(O)[CH]C=CF(10231)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(277.83,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction24',
    reactants = ['CHF(40)', 'O=C(O)C[CH]F(2435)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(5)', 'O=C(O)CC(F)[C]F-2(10738)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O=C(O)[CH]C(F)CF(10485)'],
    products = ['O=C(O)CC(F)[CH]F(4252)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O=C(O)CC(F)[CH]F(4252)'],
    products = ['O=C(O)C[CH]C(F)F(10505)'],
