...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85681,0.0525163,-3.41392e-05,1.01365e-08,-1.21389e-12,-61471.9,16.695], Tmin=(100,'K'), Tmax=(1810.54,'K')), NASAPolynomial(coeffs=[12.8885,0.028144,-1.39471e-05,2.70144e-09,-1.87248e-13,-65466.6,-43.0749], Tmin=(1810.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-511.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCCFF) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)

species(
    label = 'C=CC(F)C=C(F)F(9178)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05349,0.0690046,-7.40487e-05,4.35216e-08,-1.06258e-11,-57296.4,23.6081], Tmin=(100,'K'), Tmax=(975.401,'K')), NASAPolynomial(coeffs=[10.4879,0.0303161,-1.45535e-05,2.85858e-09,-2.0383e-13,-59136.8,-21.6724], Tmin=(975.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.831015,'amu*angstrom^2'), symmetry=1, barrier=(19.1067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.831126,'amu*angstrom^2'), symmetry=1, barrier=(19.1092,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-275.971,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,145,326,398,834,1303,190,488,555,1236,1407,2950,3100,1380,975,1025,1650,540,610,2055,180,559.061],'cm^-1')),
        HinderedRotor(inertia=(0.226099,'amu*angstrom^2'), symmetry=1, barrier=(12.7948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0593465,'amu*angstrom^2'), symmetry=1, barrier=(12.7777,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19349,0.0653981,-7.07567e-05,4.09463e-08,-9.7511e-12,-33093.6,25.0374], Tmin=(100,'K'), Tmax=(1002.59,'K')), NASAPolynomial(coeffs=[10.8586,0.026837,-1.30635e-05,2.58302e-09,-1.84912e-13,-35031.6,-21.6161], Tmin=(1002.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-275.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(CdCddCF) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Csj(Cs-CdHH)(F1s)(F1s))"""),
)

species(
    label = 'C#CC(F)C[C](F)F(9182)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.1766,'amu*angstrom^2'), symmetry=1, barrier=(4.06039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.50689,'amu*angstrom^2'), symmetry=1, barrier=(57.6383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.669261,'amu*angstrom^2'), symmetry=1, barrier=(15.3876,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.625159,0.0812066,-0.00012685,1.08888e-07,-3.69501e-11,-34076.4,24.8227], Tmin=(100,'K'), Tmax=(828.307,'K')), NASAPolynomial(coeffs=[9.03222,0.0298661,-1.44237e-05,2.74452e-09,-1.88493e-13,-35100.7,-11.9285], Tmin=(828.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCsFFH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.576424,'amu*angstrom^2'), symmetry=1, barrier=(13.2531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266582,'amu*angstrom^2'), symmetry=1, barrier=(6.12924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.266281,'amu*angstrom^2'), symmetry=1, barrier=(6.12232,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37916,0.0692077,-5.85531e-05,-2.92539e-08,6.2694e-11,-24349.1,25.0714], Tmin=(100,'K'), Tmax=(482.477,'K')), NASAPolynomial(coeffs=[7.9245,0.035579,-1.81588e-05,3.57893e-09,-2.52304e-13,-25220.9,-4.22476], Tmin=(482.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(Cs-CsHH)(F1s)(F1s)) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=C(F)CC(F)F(9186)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.981552,0.0678208,-6.63635e-05,3.38863e-08,-7.07501e-12,-33359.4,26.4527], Tmin=(100,'K'), Tmax=(1137.68,'K')), NASAPolynomial(coeffs=[12.5363,0.0271953,-1.27999e-05,2.49865e-09,-1.77723e-13,-35988.5,-30.7826], Tmin=(1137.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(CsCsFFH) + group(Cs-(Cds-Cds)HHH) + group(CdCsCdF) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cdj(Cs-HHH)(Cd-CsF1s))"""),
)

species(
    label = 'C=CC(F)[CH][C](F)F(9187)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {7,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.904913,0.076442,-0.000117551,1.09375e-07,-4.12474e-11,-30649.1,28.7539], Tmin=(100,'K'), Tmax=(777.943,'K')), NASAPolynomial(coeffs=[5.4779,0.039523,-2.05162e-05,4.06911e-09,-2.87668e-13,-30954.9,10.4474], Tmin=(777.943,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-255.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Csj(Cs-CsHH)(F1s)(F1s))"""),
)

species(
    label = '[CH]=[C]C(F)CC(F)F(9188)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.50671,'amu*angstrom^2'), symmetry=1, barrier=(11.6503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.504782,'amu*angstrom^2'), symmetry=1, barrier=(11.6059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.504907,'amu*angstrom^2'), symmetry=1, barrier=(11.6088,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.450906,0.0850774,-0.000128411,1.09261e-07,-3.77037e-11,-20044.6,27.7762], Tmin=(100,'K'), Tmax=(766.598,'K')), NASAPolynomial(coeffs=[9.35917,0.0333349,-1.6874e-05,3.31195e-09,-2.32898e-13,-21255.8,-11.8252], Tmin=(766.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(CsCCFH) + group(CsCsFFH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cdj(Cs-F1sCsH)(Cd-HH)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]C(F)C[C](F)F(8556)'],
...
reaction(
    label = 'reaction4',
    reactants = ['F[C]F(3442)', '[CH2]C(F)[C]=C(941)'],
    products = ['C=[C]C(F)C[C](F)F(8556)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(134)', 'F[CH]C[C](F)F(3551)'],
    products = ['C=[C]C(F)C[C](F)F(8556)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'C=[C]C(F)C=C(F)F(9180)'],
    products = ['C=[C]C(F)C[C](F)F(8556)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'C=C=C(F)C[C](F)F(9181)'],
    products = ['C=[C]C(F)C[C](F)F(8556)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C#CC(F)C[C](F)F(9182)'],
    products = ['C=[C]C(F)C[C](F)F(8556)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', '[CH2][C]=CC=C(F)F(9070)'],
    products = ['C=[C]C(F)C[C](F)F(8556)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CF2(43)', '[CH2]C(F)[C]=C(941)'],
    products = ['C=[C]C(F)C[C](F)F(8556)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=[C]C(F)C[C](F)F(8556)'],
    products = ['[CH2]C=C(F)C[C](F)F(9184)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=CC(F)C[C](F)F(9185)'],
    products = ['C=[C]C(F)C[C](F)F(8556)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=[C]C(F)C[C](F)F(8556)'],
    products = ['[CH2][C]=C(F)CC(F)F(9186)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=[C]C(F)CC(F)F(9188)'],
    products = ['C=[C]C(F)C[C](F)F(8556)'],
