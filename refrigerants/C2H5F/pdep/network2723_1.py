...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3442)', '[CH]=C[O](132)'],
    products = ['[CH]=CO[C](F)F(7401)'],
    transitionState = 'TS2',
