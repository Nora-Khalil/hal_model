...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'O=CCOF(2404)'],
    products = ['O=CCC(=O)OF(3899)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[O]C(=O)CC=O(4016)'],
    products = ['O=CCC(=O)OF(3899)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]F(357)', 'O=[C]CC=O(875)'],
    products = ['O=CCC(=O)OF(3899)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(3602)', 'CH2CHO(35)'],
    products = ['O=CCC(=O)OF(3899)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HCO(15)', '[CH2]C(=O)OF(2532)'],
    products = ['O=CCC(=O)OF(3899)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[O]C=CC(=O)OF(4017)'],
    products = ['O=CCC(=O)OF(3899)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', 'O=[C]CC(=O)OF(4018)'],
    products = ['O=CCC(=O)OF(3899)'],
