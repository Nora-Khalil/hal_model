...
"""),
    ...
    molecularWeight = (112.075,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04249,0.069499,-7.96372e-05,4.98664e-08,-1.28676e-11,-67052.3,23.9222], Tmin=(100,'K'), Tmax=(929.789,'K')), NASAPolynomial(coeffs=[10.5124,0.0287577,-1.39086e-05,2.73699e-09,-1.95205e-13,-68813.2,-21.075], Tmin=(929.789,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-558.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + group(Cs-CsOsOsH) + group(Cs-CsHHH)"""),
)
...
"""),
    E0 = (-451.957,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,391,562,707,872,1109,1210,1289,3137,180],'cm^-1')),
        HinderedRotor(inertia=(0.285282,'amu*angstrom^2'), symmetry=1, barrier=(6.5592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.285226,'amu*angstrom^2'), symmetry=1, barrier=(6.55791,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.285474,'amu*angstrom^2'), symmetry=1, barrier=(6.56362,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0769,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60737,0.0519307,-4.70738e-05,2.31035e-08,-4.66508e-12,-54271.2,22.0829], Tmin=(100,'K'), Tmax=(1174.67,'K')), NASAPolynomial(coeffs=[10.2591,0.0224701,-9.45422e-06,1.75324e-09,-1.21235e-13,-56303.8,-21.0495], Tmin=(1174.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-451.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCFHO) + group(Cs-CsHHH) + radical(O2sj(Cs-CsF1sH))"""),
)
...
"""),
    E0 = (-313.662,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,231.046,231.096,231.104],'cm^-1')),
        HinderedRotor(inertia=(0.52946,'amu*angstrom^2'), symmetry=1, barrier=(20.0738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.449772,'amu*angstrom^2'), symmetry=1, barrier=(17.0405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0184299,'amu*angstrom^2'), symmetry=1, barrier=(20.0737,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15625,0.0628971,-6.22731e-05,3.164e-08,-6.50448e-12,-37622.8,22.7808], Tmin=(100,'K'), Tmax=(1161.77,'K')), NASAPolynomial(coeffs=[12.731,0.0230445,-1.08173e-05,2.11238e-09,-1.50366e-13,-40312.2,-34.796], Tmin=(1161.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
"""),
    E0 = (-332.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,1380,1390,370,380,2900,435,261,493,600,1152,1365,1422,3097,3000,3100,440,815,1455,1000,275.942,277.16],'cm^-1')),
        HinderedRotor(inertia=(0.00219301,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208422,'amu*angstrom^2'), symmetry=1, barrier=(11.3635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342861,'amu*angstrom^2'), symmetry=1, barrier=(18.5847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.464791,'amu*angstrom^2'), symmetry=1, barrier=(25.3515,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.848343,0.0719046,-8.69675e-05,5.42523e-08,-1.35079e-11,-39871.2,24.7186], Tmin=(100,'K'), Tmax=(976.732,'K')), NASAPolynomial(coeffs=[13.0099,0.0220996,-1.04803e-05,2.04621e-09,-1.45464e-13,-42246.9,-33.6675], Tmin=(976.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(CsCFHO) + group(Cs-CsHHH) + radical(CJCO)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00167157,'amu*angstrom^2'), symmetry=1, barrier=(18.9791,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.825385,'amu*angstrom^2'), symmetry=1, barrier=(18.9772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108684,'amu*angstrom^2'), symmetry=1, barrier=(18.977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['CC(O)C(F)OF(2877)'],
    products = ['HF(38)', 'CHFO(47)', 'CH3CHO(36)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(29.5915,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['OF(169)', 'CC(O)[C]F(3214)'],
    products = ['CC(O)C(F)OF(2877)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'CC(O)OF(1543)'],
    products = ['CC(O)C(F)OF(2877)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.12553e-07,'m^3/(mol*s)'), n=3.34134, Ea=(132.595,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s_N-3Br1sCCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'OCC(F)OF(2853)'],
    products = ['CC(O)C(F)OF(2877)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H2O(3)', 'CC=C(F)OF(2324)'],
    products = ['CC(O)C(F)OF(2877)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H2O(3)', 'C=CC(F)OF(2325)'],
    products = ['CC(O)C(F)OF(2877)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(O)[CH]OF(3212)'],
    products = ['CC(O)C(F)OF(2877)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC(O)C([O])F(3216)'],
    products = ['CC(O)C(F)OF(2877)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', 'C[CH]C(F)OF(2188)'],
    products = ['CC(O)C(F)OF(2877)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'CC([O])C(F)OF(3217)'],
    products = ['CC(O)C(F)OF(2877)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(160)', 'CC(O)[CH]F(3218)'],
    products = ['CC(O)C(F)OF(2877)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F[CH]OF(1980)', 'C[CH]O(148)'],
    products = ['CC(O)C(F)OF(2877)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'O[CH]C(F)OF(3040)'],
    products = ['CC(O)C(F)OF(2877)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C[C](O)C(F)OF(3219)'],
    products = ['CC(O)C(F)OF(2877)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'CC(O)[C](F)OF(3220)'],
    products = ['CC(O)C(F)OF(2877)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(O)C(F)OF(3221)'],
    products = ['CC(O)C(F)OF(2877)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'CC(O)=COF(3035)'],
    products = ['CC(O)C(F)OF(2877)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(260.725,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'CC(O)C(=O)F(2209)'],
    products = ['CC(O)C(F)OF(2877)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC(O)C(F)OF(2877)'],
    products = ['HF(38)', 'CHFO(47)', 'C=CO(145)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(39.1023,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
