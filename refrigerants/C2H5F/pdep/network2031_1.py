...
"""),
    ...
    opticalIsomers = 1,
    molecularWeight = (125.051,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3216.95,'J/mol'), sigma=(5.26248,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=502.48 K, Pc=50.09 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'O=C(OF)OCF(2834)'],
    products = ['CC(F)OC(=O)OF(5721)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(F)OC([O])OF(5852)'],
    products = ['CC(F)OC(=O)OF(5721)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)O[C](O)OF(5853)'],
    products = ['CC(F)OC(=O)OF(5721)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C[CH]OC(=O)OF(1484)'],
    products = ['CC(F)OC(=O)OF(5721)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'CC(F)OC([O])=O(2492)'],
    products = ['CC(F)OC(=O)OF(5721)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)OF(1245)', 'CH3-CHF(62)'],
    products = ['CC(F)OC(=O)OF(5721)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C]OF(331)', 'CC([O])F(533)'],
    products = ['CC(F)OC(=O)OF(5721)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(160)', 'CC(F)O[C]=O(2436)'],
    products = ['CC(F)OC(=O)OF(5721)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'O=C(OF)O[CH]F(3065)'],
    products = ['CC(F)OC(=O)OF(5721)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C[C](F)OC(=O)OF(3962)'],
    products = ['CC(F)OC(=O)OF(5721)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]C(F)OC(=O)OF(3756)'],
    products = ['CC(F)OC(=O)OF(5721)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC(F)OC(=O)OF(5721)'],
    products = ['O=C(O)OF(1242)', 'CH2CHF(55)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=COC(=O)OF(553)'],
    products = ['CC(F)OC(=O)OF(5721)'],
