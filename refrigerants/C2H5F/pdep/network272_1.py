...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH]C=C=C(463)'],
    products = ['[CH]=CC(=C)[O](624)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(18)', '[CH]C=C=O(759)'],
    products = ['[CH]=CC(=C)[O](624)'],
