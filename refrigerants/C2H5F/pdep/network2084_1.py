...
"""),
    E0 = (-573.028,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,375,361,584,565,722,1474,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.30415,0.0879132,-0.000101792,6.68674e-08,-1.83925e-11,-68792,25.3605], Tmin=(100,'K'), Tmax=(869.382,'K')), NASAPolynomial(coeffs=[10.6544,0.0402926,-1.96298e-05,3.86355e-09,-2.75219e-13,-70591.7,-23.1247], Tmin=(869.382,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-573.028,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
"""),
    E0 = (-448.862,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([373,336,502,477,708,1220,1477,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,215.226,215.226,2764.98],'cm^-1')),
        HinderedRotor(inertia=(0.342573,'amu*angstrom^2'), symmetry=1, barrier=(11.2608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342574,'amu*angstrom^2'), symmetry=1, barrier=(11.2608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342574,'amu*angstrom^2'), symmetry=1, barrier=(11.2608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.894312,'amu*angstrom^2'), symmetry=1, barrier=(29.397,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05989,0.0703908,-7.41646e-05,4.81373e-08,-1.36912e-11,-53884.8,23.2912], Tmin=(100,'K'), Tmax=(826.935,'K')), NASAPolynomial(coeffs=[7.33937,0.040017,-1.90706e-05,3.72254e-09,-2.64086e-13,-54923.4,-5.81057], Tmin=(826.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-448.862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sO2sCs))"""),
)
...
"""),
    E0 = (-304.557,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,395,473,707,1436,268.089,268.091,268.137],'cm^-1')),
        HinderedRotor(inertia=(0.142661,'amu*angstrom^2'), symmetry=1, barrier=(7.27617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00234468,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142646,'amu*angstrom^2'), symmetry=1, barrier=(7.27542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321826,'amu*angstrom^2'), symmetry=1, barrier=(16.4172,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.1041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64153,0.0567083,-4.86092e-05,2.51935e-08,-5.93064e-12,-36548.9,20.7521], Tmin=(100,'K'), Tmax=(959.82,'K')), NASAPolynomial(coeffs=[6.47444,0.0365673,-1.71329e-05,3.33078e-09,-2.36139e-13,-37476.7,-2.36571], Tmin=(959.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-304.557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs))"""),
)
...
"""),
    E0 = (-358.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,364,474,579,619,655,1345,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.094,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0302988,0.0957258,-0.00013078,9.63557e-08,-2.74808e-11,-42977.4,26.7964], Tmin=(100,'K'), Tmax=(653.539,'K')), NASAPolynomial(coeffs=[10.9945,0.037798,-1.88922e-05,3.71134e-09,-2.62244e-13,-44606.5,-22.9357], Tmin=(653.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-358.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)

species(
    label = '[CH2]COC(C)(F)OF(5988)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-361.439,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,375,361,584,565,722,1474,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.094,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00470045,0.0950489,-0.000128846,9.62932e-08,-2.93266e-11,-43333.2,27.096], Tmin=(100,'K'), Tmax=(797.836,'K')), NASAPolynomial(coeffs=[11.7785,0.0359738,-1.77809e-05,3.48861e-09,-2.46817e-13,-45213.4,-27.09], Tmin=(797.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-361.439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO)"""),
)
...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3225.81,'J/mol'), sigma=(5.53482,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=503.86 K, Pc=43.17 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction1',
    reactants = ['CCOC(C)(F)OF(5980)'],
    products = ['HF(38)', 'CC(=O)F(499)', 'CH3CHO(36)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(23.4335,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'COC(C)(F)OF(5723)'],
    products = ['CCOC(C)(F)OF(5980)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'CCOC(F)OF(2875)'],
    products = ['CCOC(C)(F)OF(5980)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C(F)OF(1352)', 'CCO(513)'],
    products = ['CCOC(C)(F)OF(5980)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(9.36e-05,'m^3/(mol*s)'), n=2.85, Ea=(175.31,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd/unsub_Cd/disub;H_OCs] for rate rule [Cd/unsub_Cd/disub;H_OCpri]
...
reaction(
    label = 'reaction5',
    reactants = ['OF(169)', 'C=C(F)OCC(1201)'],
    products = ['CCOC(C)(F)OF(5980)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H4(30)', 'CC(O)(F)OF(5746)'],
    products = ['CCOC(C)(F)OF(5980)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'CCO[C](C)OF(5057)'],
    products = ['CCOC(C)(F)OF(5980)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'CCOC(C)([O])F(5986)'],
    products = ['CCOC(C)(F)OF(5980)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[C](F)OF(5141)', 'CC[O](149)'],
    products = ['CCOC(C)(F)OF(5980)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC([O])(F)OF(3850)', 'C2H5(32)'],
    products = ['CCOC(C)(F)OF(5980)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(160)', 'CCO[C](C)F(5522)'],
    products = ['CCOC(C)(F)OF(5980)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(19)', 'CCO[C](F)OF(3189)'],
    products = ['CCOC(C)(F)OF(5980)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(19)', '[CH2]OC(C)(F)OF(5749)'],
    products = ['CCOC(C)(F)OF(5980)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'C[CH]OC(C)(F)OF(5792)'],
    products = ['CCOC(C)(F)OF(5980)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', '[CH2]C(F)(OF)OCC(5987)'],
    products = ['CCOC(C)(F)OF(5980)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', '[CH2]COC(C)(F)OF(5988)'],
    products = ['CCOC(C)(F)OF(5980)'],
...
reaction(
    label = 'reaction18',
    reactants = ['HF(38)', 'C=C(OF)OCC(3591)'],
    products = ['CCOC(C)(F)OF(5980)'],
