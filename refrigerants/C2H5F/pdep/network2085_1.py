...
"""),
    E0 = (-933.245,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,261,493,600,1152,1365,1422,3097,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.461503,0.0826676,-8.39299e-05,4.61214e-08,-1.05629e-11,-112120,24.7864], Tmin=(100,'K'), Tmax=(1032.37,'K')), NASAPolynomial(coeffs=[12.1711,0.0372973,-1.80077e-05,3.55079e-09,-2.53827e-13,-114538,-32.0786], Tmin=(1032.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-933.245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
"""),
    E0 = (-669.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,291.746,298.049],'cm^-1')),
        HinderedRotor(inertia=(0.127125,'amu*angstrom^2'), symmetry=1, barrier=(7.65563,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128611,'amu*angstrom^2'), symmetry=1, barrier=(8.16854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210668,'amu*angstrom^2'), symmetry=1, barrier=(13.0628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12523,'amu*angstrom^2'), symmetry=1, barrier=(7.67468,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.0849,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48192,0.0600108,-6.49843e-05,4.23922e-08,-1.19216e-11,-80494.3,19.1245], Tmin=(100,'K'), Tmax=(841.752,'K')), NASAPolynomial(coeffs=[7.36143,0.032071,-1.51948e-05,2.9584e-09,-2.09551e-13,-81484.1,-8.22771], Tmin=(841.752,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-669.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsHHH) + group(Cs-OsHHH)"""),
)
...
"""),
    E0 = (-889.327,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,509,613,660,1171,1360,1414,3084,228.464,228.467,228.469],'cm^-1')),
        HinderedRotor(inertia=(0.089114,'amu*angstrom^2'), symmetry=1, barrier=(3.30089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353853,'amu*angstrom^2'), symmetry=1, barrier=(13.1066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.570581,'amu*angstrom^2'), symmetry=1, barrier=(21.1348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.570603,'amu*angstrom^2'), symmetry=1, barrier=(21.1348,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15531,0.0646517,-6.31561e-05,3.24662e-08,-6.86452e-12,-106861,21.9712], Tmin=(100,'K'), Tmax=(1120.07,'K')), NASAPolynomial(coeffs=[11.6773,0.0270753,-1.28335e-05,2.51395e-09,-1.79136e-13,-109218,-29.9843], Tmin=(1120.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-889.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFHO) + group(Cs-CsHHH) + group(CsFHOO)"""),
)
...
"""),
    E0 = (-527.08,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.338582,0.0843758,-0.000101273,6.57599e-08,-1.72908e-11,-63264.5,24.5014], Tmin=(100,'K'), Tmax=(922.008,'K')), NASAPolynomial(coeffs=[12.6975,0.0307578,-1.40422e-05,2.68606e-09,-1.88397e-13,-65543.5,-34.1197], Tmin=(922.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-527.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs)"""),
)
...
"""),
    E0 = (-738.72,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,395,473,707,1436,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.094,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.180353,0.0911545,-0.000123152,9.39133e-08,-2.94726e-11,-88716.5,26.9104], Tmin=(100,'K'), Tmax=(772.356,'K')), NASAPolynomial(coeffs=[10.5755,0.0373181,-1.85945e-05,3.66311e-09,-2.59756e-13,-90322.3,-20.5549], Tmin=(772.356,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-738.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-HHH)(F1s)(O2s-Cs))"""),
)

species(
    label = '[CH2]C(O)(F)OC(C)F(6016)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-718.675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,364,474,579,619,655,1345,261,493,600,1152,1365,1422,3097,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.094,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.196008,0.0903959,-0.000113042,7.73251e-08,-2.17065e-11,-86305.5,26.1943], Tmin=(100,'K'), Tmax=(859.696,'K')), NASAPolynomial(coeffs=[11.9144,0.0358729,-1.79109e-05,3.55418e-09,-2.54024e-13,-88320.4,-28.5685], Tmin=(859.696,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-718.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sO2s)(H)(H))"""),
)

species(
    label = '[CH2]C(F)OC(C)(O)F(6017)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {6,S}
...
"""),
    E0 = (-720.545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,487,638,688,1119,1325,1387,3149,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.094,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.219625,0.0898127,-0.000112958,7.80907e-08,-2.21654e-11,-86531.2,27.3584], Tmin=(100,'K'), Tmax=(850.661,'K')), NASAPolynomial(coeffs=[11.6945,0.0358553,-1.78137e-05,3.5255e-09,-2.51521e-13,-88483.5,-26.1454], Tmin=(850.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-720.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(CsCFOO) + group(CsCFHO) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
"""),
    E0 = (-619.67,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,375,361,584,565,722,1474,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.945639,'amu*angstrom^2'), symmetry=1, barrier=(21.7421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.947093,'amu*angstrom^2'), symmetry=1, barrier=(21.7755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.945972,'amu*angstrom^2'), symmetry=1, barrier=(21.7498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.945522,'amu*angstrom^2'), symmetry=1, barrier=(21.7394,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.096,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['CC(F)OC(C)(O)F(5981)'],
    products = ['HF(38)', 'CC(=O)F(499)', 'CH3CHO(36)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5.29418e+10,'s^-1'), n=0.745914, Ea=(123.133,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_7R!H->C',), comment="""Estimated from node Root_N-1R!H->C_5Br1sCl1sF1sH->F1s_Ext-2C-R_7R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C[C]F(124)', 'CC(O)(O)F(5896)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.5279e-12,'m^3/(mol*s)'), n=5.02686, Ea=(53.3904,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s',), comment="""Estimated from node OH_N-2Br1sCl1sF1sHI1s->H_2Br1sCl1sF1sI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', 'COC(C)(O)F(5909)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'CC(F)OC(O)F(2876)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'CC(O)(F)OCF(5724)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=C(O)F(498)', 'CC(O)F(543)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'C=C(F)OC(C)F(1526)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CHF(55)', 'CC(O)(O)F(5896)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'C[C](O)OC(C)F(6014)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[CH]OC(C)(O)F(6015)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC([O])F(533)', 'C[C](O)F(1910)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3-CHF(62)', 'CC([O])(O)F(5101)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(7)', 'C[C](F)OC(C)F(5468)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'CC(F)OC(C)([O])F(5793)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(19)', 'CC(F)O[C](O)F(3382)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'CC(O)(F)O[CH]F(5897)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C[C](F)OC(C)(O)F(5911)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(O)(F)OC(C)F(6016)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(F)OC(C)(O)F(6017)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HF(38)', 'C=C(O)OC(C)F(3592)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HF(38)', 'C=COC(C)(O)F(5139)'],
    products = ['CC(F)OC(C)(O)F(5981)'],
