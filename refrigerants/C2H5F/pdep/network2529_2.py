...
"""),
    ...
    molecularWeight = (90.0713,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20541,0.0434626,-3.04691e-05,1.18527e-08,-2.08986e-12,-8511.06,18.2488], Tmin=(100,'K'), Tmax=(1208.94,'K')), NASAPolynomial(coeffs=[6.2728,0.0300049,-1.37714e-05,2.64486e-09,-1.85741e-13,-9494.51,-2.14572], Tmin=(1208.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.2731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(25)', '[CH]C=C(F)F(7152)'],
    products = ['[CH]C(C)=C(F)F(6466)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[C]F(3442)', '[CH]=[C]C(4976)'],
    products = ['[CH]C(C)=C(F)F(6466)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(19)', 'C#C[C](F)F(4968)'],
    products = ['[CH]C(C)=C(F)F(6466)'],
...
reaction(
    label = 'reaction18',
    reactants = ['F[C]F(3442)', 'C#CC(4975)'],
    products = ['[CH]C(C)=C(F)F(6466)'],
