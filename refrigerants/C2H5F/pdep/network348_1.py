...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]C(=C)[O](609)'],
    products = ['C=C([O])C[C]=O(439)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CO(28)', '[CH2][C]=O(140)'],
    products = ['C=C([O])C[C]=O(439)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]=O(140)', '[CH2][C]=O(140)'],
    products = ['C=C([O])C[C]=O(439)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(18)', 'O=[C]C[C]=O(822)'],
    products = ['C=C([O])C[C]=O(439)'],
