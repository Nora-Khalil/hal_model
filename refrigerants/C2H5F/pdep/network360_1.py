...
reaction(
    label = 'reaction1',
    reactants = ['C=C(F)[O+]=[C-]O(1019)'],
    products = ['CO(13)', 'CC(=O)F(253)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['HF(38)', 'C#C[O+]=[C-]O(785)'],
    products = ['C=C(F)[O+]=[C-]O(1019)'],
    transitionState = 'TS4',
