...
"""),
    E0 = (-200.384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,1017.56],'cm^-1')),
        HinderedRotor(inertia=(0.00724938,'amu*angstrom^2'), symmetry=1, barrier=(5.37763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.846939,'amu*angstrom^2'), symmetry=1, barrier=(19.4728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0263302,'amu*angstrom^2'), symmetry=1, barrier=(19.4483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9598,0.0374314,-9.22382e-06,-1.06192e-08,5.45801e-12,-24020.9,18.8694], Tmin=(100,'K'), Tmax=(1101.97,'K')), NASAPolynomial(coeffs=[10.0241,0.0229527,-9.65252e-06,1.82262e-09,-1.28438e-13,-26696.5,-24.8947], Tmin=(1101.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ)"""),
)
...
"""),
    E0 = (-47.742,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,3727.98],'cm^-1')),
        HinderedRotor(inertia=(0.0105984,'amu*angstrom^2'), symmetry=1, barrier=(13.2886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348636,'amu*angstrom^2'), symmetry=1, barrier=(8.01583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40158,'amu*angstrom^2'), symmetry=1, barrier=(32.225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (59.0871,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31053,0.0331583,-1.80389e-05,4.71443e-09,-4.91777e-13,-5677.73,15.9897], Tmin=(100,'K'), Tmax=(2164.27,'K')), NASAPolynomial(coeffs=[11.7279,0.0157525,-5.975e-06,9.9821e-10,-6.24928e-14,-9753.94,-36.7144], Tmin=(2164.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""CH3CH2OCH2""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-81.6849,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,291.957,292.05,292.158,292.227],'cm^-1')),
        HinderedRotor(inertia=(0.331639,'amu*angstrom^2'), symmetry=1, barrier=(20.1111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00197537,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.332081,'amu*angstrom^2'), symmetry=1, barrier=(20.1114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.332021,'amu*angstrom^2'), symmetry=1, barrier=(20.1107,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.0769,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.806741,0.0576028,-3.11649e-05,-1.47009e-08,1.36524e-11,-9697.84,23.332], Tmin=(100,'K'), Tmax=(935.994,'K')), NASAPolynomial(coeffs=[20.1115,0.00693315,-9.72808e-07,1.26597e-10,-1.21323e-14,-14705.9,-75.9735], Tmin=(935.994,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.6849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCOCOF(2845)'],
    products = ['HF(38)', 'CH2O(20)', 'CH3CHO(36)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00570902,'s^-1'), n=4.62568, Ea=(35.4133,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    ...
    products = ['CCOCOF(2845)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(62.6354,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['OCOF(1054)', 'C2H4(30)'],
    products = ['CCOCOF(2845)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', '[CH2]OCOF(1057)'],
    products = ['CCOCOF(2845)'],
    transitionState = 'TS8',
