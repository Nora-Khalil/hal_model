...
"""),
    E0 = (-71.0139,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,326,540,652,719,1357,323,467,575,827,1418,462.176,462.739,462.955,463.522],'cm^-1')),
        HinderedRotor(inertia=(0.345406,'amu*angstrom^2'), symmetry=1, barrier=(52.6019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.345151,'amu*angstrom^2'), symmetry=1, barrier=(52.6112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.035,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['O(6)', '[CH]C(F)=C(F)F(4652)'],
    products = ['[CH]=C(F)C([O])(F)F(7457)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]=C(F)C(=O)F(2724)'],
    products = ['[CH]=C(F)C([O])(F)F(7457)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C#CC([O])(F)F(7758)'],
    products = ['[CH]=C(F)C([O])(F)F(7457)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['F2(77)', '[CH]=C=C([O])F(2725)'],
    products = ['[CH]=C(F)C([O])(F)F(7457)'],
    transitionState = 'TS9',
