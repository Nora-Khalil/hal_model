...
"""),
    ...
    molecularWeight = (81.0925,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01343,0.035729,-8.2584e-06,-1.50184e-08,8.27662e-12,37851.1,16.6835], Tmin=(100,'K'), Tmax=(1005.99,'K')), NASAPolynomial(coeffs=[11.2029,0.0168377,-6.40397e-06,1.19072e-09,-8.50515e-14,35109.2,-32.1438], Tmin=(1005.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Oxetene) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['C2H(22)', '[CH]=C(C)[O](1728)'],
    products = ['[CH]=C(C)OC#C(6270)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', '[CH]=[C]OC#C(2465)'],
    products = ['[CH]=C(C)OC#C(6270)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', '[CH]C(=C)OC#C(8295)'],
    products = ['[CH]=C(C)OC#C(6270)'],
