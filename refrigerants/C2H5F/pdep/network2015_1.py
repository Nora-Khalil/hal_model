...
"""),
    E0 = (129.893,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2100,2250,500,550],'cm^-1')),
        HinderedRotor(inertia=(0.686726,'amu*angstrom^2'), symmetry=1, barrier=(15.7892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.89264,'amu*angstrom^2'), symmetry=1, barrier=(66.5075,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.921,0.0186665,1.79226e-05,-3.50243e-08,1.53717e-11,15666.1,11.3853], Tmin=(100,'K'), Tmax=(875.915,'K')), NASAPolynomial(coeffs=[6.09718,0.0181507,-5.14962e-06,7.68964e-10,-4.81579e-14,14573.1,-6.58038], Tmin=(875.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs)"""),
)
...
"""),
    E0 = (447.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1670,1700,300,440],'cm^-1')),
        HinderedRotor(inertia=(0.387907,'amu*angstrom^2'), symmetry=1, barrier=(8.91875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.388878,'amu*angstrom^2'), symmetry=1, barrier=(8.94107,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.63327,0.0244236,-1.02421e-05,1.66406e-09,-8.25241e-14,53805.4,9.85061], Tmin=(100,'K'), Tmax=(2875.86,'K')), NASAPolynomial(coeffs=[26.0792,-0.0010996,9.90617e-08,-4.43953e-11,6.11637e-15,38539.4,-126.245], Tmin=(2875.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_S) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CH3(19)', 'C#CC(3594)'],
    products = ['C[C]=CC(6390)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(178000,'cm^3/(mol*s)'), n=2.41, Ea=(30.1248,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 2271 C3H4-2 + CH3 <=> C4H7-7 in R_Addition_MultipleBond/training
This reaction matched rate rule [Root_N-3R-inRing_3R->C_3C-u1_N-1R!H->S_N-2R!H->S_Ext-2CNO-R_Sp-4R!H-2CNO_N-2CNO-inRing_4R!H->C_N-Sp-2CNO=1CCNNO]
family: R_Addition_MultipleBond"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=[C]C(2350)'],
    products = ['C[C]=CC(6390)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['C[C]=CC(6390)'],
    products = ['C=C[CH]C(7420)'],
...
This reaction matched rate rule [R2H_S;Cd_rad_out_Cd;Cs_H_out_2H]
