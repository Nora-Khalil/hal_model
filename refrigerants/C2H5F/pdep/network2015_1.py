...
"""),
    E0 = (-219.694,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([175,287,726,856,212,931,1104,1251,1325,1474,3102,3155,3010,987.5,1337.5,450,1655,350,440,435,1725,180,180,2253.3],'cm^-1')),
        HinderedRotor(inertia=(0.254178,'amu*angstrom^2'), symmetry=1, barrier=(5.84406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63986,'amu*angstrom^2'), symmetry=1, barrier=(37.7036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254271,'amu*angstrom^2'), symmetry=1, barrier=(5.84619,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.685111,0.0848543,-0.000155001,1.48044e-07,-5.38054e-11,-26315.2,25.2887], Tmin=(100,'K'), Tmax=(842.133,'K')), NASAPolynomial(coeffs=[6.21981,0.0331458,-1.76208e-05,3.44557e-09,-2.38466e-13,-26346,4.88958], Tmin=(842.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.694,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2sCF) + group(CsCFHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'FC=C(OF)OCF(3934)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {5,S}
...
"""),
    E0 = (-316.342,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,551,1088,1226,1380,1420,1481,3057,3119,212,367,445,1450,180,189.137,189.837,198.818],'cm^-1')),
        HinderedRotor(inertia=(0.173373,'amu*angstrom^2'), symmetry=1, barrier=(5.00551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167442,'amu*angstrom^2'), symmetry=1, barrier=(4.96539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0153493,'amu*angstrom^2'), symmetry=1, barrier=(36.4775,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.695213,0.085225,-0.000157123,1.52708e-07,-5.6536e-11,-37940.3,29.3277], Tmin=(100,'K'), Tmax=(832.62,'K')), NASAPolynomial(coeffs=[5.51339,0.0353842,-1.92427e-05,3.80494e-09,-2.65365e-13,-37817.4,12.5218], Tmin=(832.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CCOJ) + radical(CsCsCsF1s)"""),
)

species(
    label = '[O]C(OF)C(F)[CH]F(5684)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-314.56,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,259,529,569,1128,1321,1390,3140,1380,1390,370,380,2900,435,334,575,1197,1424,3202,210.699,210.699,210.716,1520.62],'cm^-1')),
        HinderedRotor(inertia=(0.190062,'amu*angstrom^2'), symmetry=1, barrier=(5.98939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190169,'amu*angstrom^2'), symmetry=1, barrier=(5.98949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11331,'amu*angstrom^2'), symmetry=1, barrier=(35.06,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.472768,0.0888105,-0.000159869,1.50211e-07,-5.42938e-11,-37716.6,28.6426], Tmin=(100,'K'), Tmax=(826.566,'K')), NASAPolynomial(coeffs=[7.64192,0.0322671,-1.76057e-05,3.48821e-09,-2.43709e-13,-38155.4,-0.0637942], Tmin=(826.566,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(CCOJ) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'O[C](OF)C(F)[CH]F(5685)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-335.018,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,259,529,569,1128,1321,1390,3140,360,370,350,334,575,1197,1424,3202,360.397,360.397,360.504],'cm^-1')),
        HinderedRotor(inertia=(0.0855841,'amu*angstrom^2'), symmetry=1, barrier=(7.88755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0855885,'amu*angstrom^2'), symmetry=1, barrier=(7.88697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0855858,'amu*angstrom^2'), symmetry=1, barrier=(7.8919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289295,'amu*angstrom^2'), symmetry=1, barrier=(26.6598,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.177628,0.0918987,-0.000156437,1.34933e-07,-4.53727e-11,-40163.3,29.5318], Tmin=(100,'K'), Tmax=(812.87,'K')), NASAPolynomial(coeffs=[12.1083,0.0235905,-1.26736e-05,2.49941e-09,-1.74407e-13,-41785.7,-23.6044], Tmin=(812.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cs-CsOsOsH) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + radical(Cs_P) + radical(Csj(Cs-F1sCsH)(F1s)(H))"""),
)

species(
    label = 'OC(OF)=C(F)CF(4888)',
    structure = adjacencyList("""1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {7,S}
3  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.194139,'amu*angstrom^2'), symmetry=1, barrier=(4.46364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194976,'amu*angstrom^2'), symmetry=1, barrier=(4.48288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.936817,'amu*angstrom^2'), symmetry=1, barrier=(21.5393,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.05,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.506208,0.0857944,-0.000147784,1.32332e-07,-4.58667e-11,-65898,24.5142], Tmin=(100,'K'), Tmax=(834.493,'K')), NASAPolynomial(coeffs=[9.34349,0.0274819,-1.42928e-05,2.77904e-09,-1.92127e-13,-66817.5,-13.1935], Tmin=(834.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-548.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2sCF) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cds(F)) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsCsCs)"""),
)
...
"""),
    E0 = (-603.193,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([206,363,518,1175,1317,1481,3059,528,1116,1182,1331,1402,1494,3075,3110,180,180,180,571.315,1161.76,1161.99,1162.2],'cm^-1')),
        HinderedRotor(inertia=(2.27136,'amu*angstrom^2'), symmetry=1, barrier=(52.223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0544774,'amu*angstrom^2'), symmetry=1, barrier=(52.2163,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00474,0.0487618,-6.04274e-05,5.47938e-08,-2.24867e-11,-72480.1,19.8181], Tmin=(100,'K'), Tmax=(683.247,'K')), NASAPolynomial(coeffs=[3.80797,0.033754,-1.77076e-05,3.57629e-09,-2.57599e-13,-72622.6,12.5656], Tmin=(683.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-603.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CO(13)', 'FCC(F)OF(2315)'],
    products = ['O=C(OF)C(F)CF(5664)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2(8)', 'O=C(OF)C(F)[C]F(5681)'],
    products = ['O=C(OF)C(F)CF(5664)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHF(40)', 'O=C(CF)OF(2592)'],
    products = ['O=C(OF)C(F)CF(5664)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['FOF(1637)', 'O=C=CCF(2479)'],
    products = ['O=C(OF)C(F)CF(5664)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OF(169)', 'O=C=C(F)CF(2791)'],
    products = ['O=C(OF)C(F)CF(5664)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(OF)C(F)[CH]F(5684)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](OF)C(F)[CH]F(5685)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction15',
    reactants = ['F(37)', 'O=C([CH]CF)OF(2609)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F(37)', '[CH2]C(F)C(=O)OF(2602)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction17',
    reactants = ['F(37)', '[O]C(=O)C(F)CF(2800)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(160)', 'O=[C]C(F)CF(2799)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2F(46)', 'O=C([CH]F)OF(2600)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O=[C]OF(331)', 'CH2F-CHF(65)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', 'O=C(OF)[C](F)CF(5686)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'O=C(OF)C(F)[CH]F(5687)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction23',
    reactants = ['F2(77)', 'C=CC(=O)OF(1606)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'O=C(C=CF)OF(4178)'],
    products = ['O=C(OF)C(F)CF(5664)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=C(OF)C(F)CF(5664)'],
    products = ['F2(77)', 'CO2(14)', 'CH2CHF(55)'],
