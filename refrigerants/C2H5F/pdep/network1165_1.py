...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=O)F(408)', '[CH]C-2(137)'],
    products = ['[CH]=C(F)O[CH]C(2557)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(5)', '[CH]=C(F)OC=C(2721)'],
    products = ['[CH]=C(F)O[CH]C(2557)'],
    transitionState = 'TS6',
