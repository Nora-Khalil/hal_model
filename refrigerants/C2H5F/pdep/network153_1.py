...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])=O(152)', 'CH2(T)(18)'],
    products = ['[CH2]OC([O])=O(255)'],
    transitionState = 'TS2',
