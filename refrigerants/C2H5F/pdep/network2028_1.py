...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C1=CO[CH]O1(6744)'],
    products = ['C=C=COC=O(6402)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C=O(142)', '[CH]=C=C(5584)'],
    products = ['C=C=COC=O(6402)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH2]C#COC=O(6753)'],
    products = ['C=C=COC=O(6402)'],
