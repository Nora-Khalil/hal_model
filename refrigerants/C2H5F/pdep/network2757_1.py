...
"""),
    E0 = (356.082,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2175,525,180],'cm^-1')),
        HinderedRotor(inertia=(2.95383,'amu*angstrom^2'), symmetry=1, barrier=(67.9143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00500402,'amu*angstrom^2'), symmetry=1, barrier=(12.0936,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0552,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71235,0.0298621,-4.09816e-05,3.16797e-08,-9.19702e-12,42871.7,13.8977], Tmin=(100,'K'), Tmax=(1048.4,'K')), NASAPolynomial(coeffs=[5.52165,0.011244,-3.04144e-06,3.66918e-10,-1.64283e-14,42716.8,2.28217], Tmin=(1048.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
"""),
    E0 = (211.71,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(0.496951,'amu*angstrom^2'), symmetry=1, barrier=(11.4259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.496057,'amu*angstrom^2'), symmetry=1, barrier=(11.4053,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (56.0632,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17968,0.0451161,-7.58254e-05,6.73589e-08,-2.2729e-11,25523.6,13.7168], Tmin=(100,'K'), Tmax=(891.929,'K')), NASAPolynomial(coeffs=[6.07344,0.0159513,-7.09674e-06,1.2778e-09,-8.3849e-14,25294.5,-2.01348], Tmin=(891.929,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cd)OsHH) + group(Cds-CdsCsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(5)', '[CH]=C=C(5584)'],
    products = ['C#CCO(7189)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(7.7e+07,'m^3/(mol*s)'), n=0, Ea=(0.276519,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_2R->C_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_2R->C_Ext-2C-R"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#CO(1368)'],
    products = ['C#CCO(7189)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(138.27,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(6)', 'C#CC[O](457)'],
    products = ['C#CCO(7189)'],
    transitionState = 'TS3',
