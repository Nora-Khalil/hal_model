...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', '[O]C(F)(F)C=CF(7553)'],
    products = ['[O]C(F)(F)C[CH]F(7431)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'O=C(F)C[CH]F(2002)'],
    products = ['[O]C(F)(F)C[CH]F(7431)'],
    transitionState = 'TS9',
