...
"""),
    E0 = (-164.758,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,212,367,445,1450,190,488,555,1236,1407,180,897.218,897.452,897.715,898.404,898.511,898.671,898.858],'cm^-1')),
        HinderedRotor(inertia=(0.0106894,'amu*angstrom^2'), symmetry=1, barrier=(6.12293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.062,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65129,0.0442214,-2.90902e-05,4.79206e-09,1.42674e-12,-19724.9,21.7203], Tmin=(100,'K'), Tmax=(1100.03,'K')), NASAPolynomial(coeffs=[13.0589,0.015127,-6.30763e-06,1.22121e-09,-8.80926e-14,-22984.1,-37.809], Tmin=(1100.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-164.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring) + radical(Csj(Cs-CsCsH)(F1s)(F1s)_1959_ring)"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17208,0.0597844,-4.83198e-05,1.97497e-08,-3.28974e-12,-47981.6,23.5678], Tmin=(100,'K'), Tmax=(1400.88,'K')), NASAPolynomial(coeffs=[13.2616,0.0252646,-1.13574e-05,2.15962e-09,-1.50618e-13,-51368.8,-38.8324], Tmin=(1400.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-399.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + ring(Cs-Cd(C)-Cd(F))"""),
)
...
species(
    label = '[CH2]C(F)(F)[CH]C(=C)F(10574)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-339.867,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([215,315,519,588,595,1205,1248,3025,407.5,1350,352.5,271,519,563,612,1379,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,205.405,231.056],'cm^-1')),
        HinderedRotor(inertia=(0.131316,'amu*angstrom^2'), symmetry=1, barrier=(3.51933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0201546,'amu*angstrom^2'), symmetry=1, barrier=(0.534917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0462542,'amu*angstrom^2'), symmetry=1, barrier=(32.6452,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
...
species(
    label = '[CH2]C(F)(F)C1=C(F)C1(12944)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {5,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-188.419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,248,333,466,604,684,796,1061,1199,323,467,575,827,1418,3000,3100,440,815,1455,1000,180,1109.2,1109.46,1109.53,1109.58],'cm^-1')),
        HinderedRotor(inertia=(0.232259,'amu*angstrom^2'), symmetry=1, barrier=(5.34008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232232,'amu*angstrom^2'), symmetry=1, barrier=(5.33946,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (121.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31161,0.0622097,-6.10818e-05,3.17828e-08,-6.85989e-12,-22567.4,24.3724], Tmin=(100,'K'), Tmax=(1092.39,'K')), NASAPolynomial(coeffs=[10.8122,0.0274215,-1.3313e-05,2.63036e-09,-1.88201e-13,-24643,-22.302], Tmin=(1092.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + ring(Cs-Cd(C)-Cd(F)) + radical(Csj(Cs-F1sF1sCd)(H)(H))"""),
)
...
"""),
    E0 = (59.6248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,212,367,445,1450,271,519,563,612,1379,2950,3100,1380,975,1025,1650,180,1138.45,1138.79,1138.97,1139.23,1139.29,1139.74],'cm^-1')),
        HinderedRotor(inertia=(0.00663679,'amu*angstrom^2'), symmetry=1, barrier=(6.11857,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.082,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96749,0.0389749,-1.98909e-05,2.80678e-09,4.57585e-13,7249.04,21.9663], Tmin=(100,'K'), Tmax=(1337.4,'K')), NASAPolynomial(coeffs=[10.0865,0.0221373,-9.35681e-06,1.71839e-09,-1.17081e-13,4411.5,-22.0532], Tmin=(1337.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.6248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CdCsCdF) + group(Cds-CdsHH) + ring(Cs(F)-Cs-Cs) + radical(Allyl_T) + radical(CsCsCsF1s)"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60532,0.0609991,-5.18045e-05,2.4496e-09,2.13542e-11,-25455.6,23.6676], Tmin=(100,'K'), Tmax=(519.326,'K')), NASAPolynomial(coeffs=[6.14512,0.037802,-1.87983e-05,3.71926e-09,-2.65123e-13,-26085.9,3.21221], Tmin=(519.326,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCsCsFF) + group(Cs-CsHHH) + ring(Cs(F)-Cs-Cs) + radical(Tertalkyl) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring)"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42989,0.0601129,-5.25701e-05,2.51668e-08,-5.1538e-12,-25415.8,25.6864], Tmin=(100,'K'), Tmax=(1123.36,'K')), NASAPolynomial(coeffs=[9.30473,0.032073,-1.51295e-05,2.94778e-09,-2.09106e-13,-27185.1,-13.2213], Tmin=(1123.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFF) + group(CsCsCsFH) + group(Cs-CsHHH) + ring(Cs(F)(F)-Cs(C)-Cs) + radical(CsCsCsF1s) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'FC[C](F)C1C[C]1F(12948)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {8,S}
3  F u0 p3 c0 {7,S}
...
"""),
    E0 = (-149.45,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,551,1088,1226,1380,1420,1481,3057,3119,165,259,333,401,397,493,1395,1505,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36718,0.0580542,-4.55104e-05,1.81372e-08,-2.99197e-12,-17880.4,26.161], Tmin=(100,'K'), Tmax=(1389.24,'K')), NASAPolynomial(coeffs=[11.8654,0.0278269,-1.28731e-05,2.47527e-09,-1.7355e-13,-20797.3,-27.9384], Tmin=(1389.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(CsCsCsFH) + group(CsCsCsFH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + ring(Cs(F)-Cs-Cs) + radical(Csj(Cs-CsCsH)(Cs-CsHH)(F1s)_ring) + radical(CsCsCsF1s)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C1C[C]1F(8711)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', 'F[C](F)C1C[C]1F(12942)'],
    products = ['[CH2]C(F)(F)C1C[C]1F(8711)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(F)(F)C1C[C]1F(8711)'],
    products = ['CC(F)(F)C1=C(F)C1(12943)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)(F)[CH]C(=C)F(10574)'],
    products = ['[CH2]C(F)(F)C1C[C]1F(8711)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', '[CH2]C(F)(F)C1=C(F)C1(12944)'],
    products = ['[CH2]C(F)(F)C1C[C]1F(8711)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(2.97324,'m^3/(mol*s)'), n=2.12322, Ea=(1.05228,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0984061311673169, var=1.772613507237397, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_2CS-inRing_N-Sp-2CS-=1CCOSS_1COS-inRing_Ext-2CS-R_Ext-4R!H-R_Ext-1COS-R',), comment="""Estimated from node Root_3R->H_N-2R!H->N_N-1R!H->N_N-2COS->O_2CS-inRing_N-Sp-2CS-=1CCOSS_1COS-inRing_Ext-2CS-R_Ext-4R!H-R_Ext-1COS-R"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', 'C=C(F)C1C[C]1F(12863)'],
    products = ['[CH2]C(F)(F)C1C[C]1F(8711)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(1.575e+07,'m^3/(mol*s)'), n=3.11585e-09, Ea=(63.3944,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F',), comment="""Estimated from node Root_N-3R-inRing_N-3R->C_N-1R!H->N_N-2R!H->O_N-3BrClFNOS->Cl_N-2CNS->N_N-3BrFNOS->N_3BrFOS->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.000502707,'m^3/(mol*s)'), n=2.87982, Ea=(8.23252,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H',), comment="""Estimated from node Root_3R-inRing_Ext-3R-R_Sp-4R!H-3R_N-4R!H->O_N-1R!H-inRing_Sp-2R!H=1R!H"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'C=C(F)[C]1C[C]1F(12945)'],
    products = ['[CH2]C(F)(F)C1C[C]1F(8711)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(4.14111,'m^3/(mol*s)'), n=1.29695, Ea=(245.481,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R_6R!H->F_Ext-3COCdCddCtO2d-R"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(F)(F)C1C[C]1F(8711)'],
    products = ['CC(F)(F)[C]1C[C]1F(12946)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(F)(F)C1C[C]1F(8711)'],
    products = ['[CH2][C](F)C1CC1(F)F(12947)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.0186161,'s^-1'), n=4.16824, Ea=(214.546,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction21',
    reactants = ['FC[C](F)C1C[C]1F(12948)'],
    products = ['[CH2]C(F)(F)C1C[C]1F(8711)'],
