...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](154)', '[CH]C-2(137)'],
    products = ['C[CH]OC[O](390)'],
    transitionState = 'TS2',
