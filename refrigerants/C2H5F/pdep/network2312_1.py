...
"""),
    E0 = (287.198,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,248.389,252.247,2079.65],'cm^-1')),
        HinderedRotor(inertia=(0.00304851,'amu*angstrom^2'), symmetry=1, barrier=(0.140374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199477,'amu*angstrom^2'), symmetry=1, barrier=(8.72737,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29806,0.0506067,-2.33591e-05,-5.16924e-09,5.35174e-12,-5758.36,23.9043], Tmin=(100,'K'), Tmax=(1042.24,'K')), NASAPolynomial(coeffs=[12.8988,0.0234086,-9.14813e-06,1.68877e-09,-1.18664e-13,-9117.43,-37.0563], Tmin=(1042.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.7498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (181.611,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,192.695,192.755],'cm^-1')),
        HinderedRotor(inertia=(0.654663,'amu*angstrom^2'), symmetry=1, barrier=(17.2575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.654513,'amu*angstrom^2'), symmetry=1, barrier=(17.2581,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46721,0.0465386,-1.71976e-05,-1.05242e-08,7.08686e-12,21941.9,23.1054], Tmin=(100,'K'), Tmax=(1034.79,'K')), NASAPolynomial(coeffs=[12.7919,0.0216858,-8.6024e-06,1.61071e-09,-1.14458e-13,18585,-36.8125], Tmin=(1034.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CC(C)OJ)"""),
)

species(
    label = 'C#CCC(C)[O](6861)',
    structure = adjacencyList("""multiplicity 2
1  O u1 p2 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (183.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,180,612.597],'cm^-1')),
        HinderedRotor(inertia=(0.597765,'amu*angstrom^2'), symmetry=1, barrier=(13.7438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.23266,'amu*angstrom^2'), symmetry=1, barrier=(74.3252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0355453,'amu*angstrom^2'), symmetry=1, barrier=(13.6676,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3425,0.0530071,-3.86526e-05,1.16696e-08,-1.13269e-13,22193.5,21.8691], Tmin=(100,'K'), Tmax=(996.626,'K')), NASAPolynomial(coeffs=[11.4779,0.0224761,-7.97424e-06,1.3647e-09,-9.11129e-14,19669.3,-29.5223], Tmin=(996.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ)"""),
)

species(
    label = 'C=[C]C[C](C)O(6862)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2723,0.0636711,-7.07614e-05,4.78542e-08,-1.37278e-11,24353.5,24.38], Tmin=(100,'K'), Tmax=(834.006,'K')), NASAPolynomial(coeffs=[7.82442,0.0322466,-1.42432e-05,2.67652e-09,-1.85503e-13,23260.6,-6.04098], Tmin=(834.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(Cds_S)"""),
)

species(
    label = 'C=C[CH]C(C)[O](6459)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
...
"""),
    E0 = (134.505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,384.83,384.949,385.035],'cm^-1')),
        HinderedRotor(inertia=(0.25303,'amu*angstrom^2'), symmetry=1, barrier=(26.604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252828,'amu*angstrom^2'), symmetry=1, barrier=(26.6065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253161,'amu*angstrom^2'), symmetry=1, barrier=(26.6038,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09655,0.0540352,-2.42724e-05,-6.88284e-09,6.28837e-12,16290.2,22.111], Tmin=(100,'K'), Tmax=(1040.9,'K')), NASAPolynomial(coeffs=[13.895,0.0243842,-9.68902e-06,1.80337e-09,-1.27382e-13,12567.8,-45.2296], Tmin=(1040.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(C=CCJCO)"""),
)

species(
    label = '[CH]=CCC(C)[O](6863)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (264.685,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,294.044,294.281],'cm^-1')),
        HinderedRotor(inertia=(0.0019493,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22619,'amu*angstrom^2'), symmetry=1, barrier=(13.8896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22631,'amu*angstrom^2'), symmetry=1, barrier=(13.8898,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18839,0.0541771,-3.49497e-05,8.57687e-09,1.18195e-13,31941.8,24.9883], Tmin=(100,'K'), Tmax=(1142.13,'K')), NASAPolynomial(coeffs=[12.5533,0.0246827,-9.75128e-06,1.77047e-09,-1.21617e-13,28673.5,-34.2942], Tmin=(1142.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cds_P)"""),
)

species(
    label = 'C=[C][CH]C(C)O(6465)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.987949,0.0615872,-5.1203e-05,2.22671e-08,-3.9324e-12,17189.2,23.1667], Tmin=(100,'K'), Tmax=(1341.99,'K')), NASAPolynomial(coeffs=[13.3381,0.0247756,-1.00571e-05,1.82688e-09,-1.24566e-13,13874.4,-40.0487], Tmin=(1341.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(O)C[C]=C(6864)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {14,S}
2  C u0 p0 c0 {1,S} {3,S} {4,S} {7,S}
3  C u0 p0 c0 {2,S} {6,S} {8,S} {9,S}
...
"""),
    E0 = (236.658,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,372.17,372.186],'cm^-1')),
        HinderedRotor(inertia=(0.00121717,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105213,'amu*angstrom^2'), symmetry=1, barrier=(10.3434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105262,'amu*angstrom^2'), symmetry=1, barrier=(10.3421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105242,'amu*angstrom^2'), symmetry=1, barrier=(10.3426,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23604,0.0606913,-5.59104e-05,2.8476e-08,-6.00417e-12,28563,25.7111], Tmin=(100,'K'), Tmax=(1125.24,'K')), NASAPolynomial(coeffs=[10.6291,0.0273011,-1.13996e-05,2.10489e-09,-1.45187e-13,26449.2,-20.7131], Tmin=(1125.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_S)"""),
)

species(
    label = 'C=CC[C](C)[O](6865)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {4,S}
2  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
3  C u0 p0 c0 {4,S} {9,S} {10,S} {11,S}
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4185,0.0558159,-4.32123e-05,1.81136e-08,-3.19048e-12,23452.4,23.1776], Tmin=(100,'K'), Tmax=(1307.98,'K')), NASAPolynomial(coeffs=[10.3103,0.0286232,-1.20275e-05,2.21891e-09,-1.52441e-13,21126.3,-22.1077], Tmin=(1307.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C([O])CC=C(6866)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {3,S}
...
"""),
    E0 = (272.166,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,244.108],'cm^-1')),
        HinderedRotor(inertia=(0.00283156,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253093,'amu*angstrom^2'), symmetry=1, barrier=(10.7351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253639,'amu*angstrom^2'), symmetry=1, barrier=(10.7346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250372,'amu*angstrom^2'), symmetry=1, barrier=(10.7392,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33542,0.0587799,-5.19559e-05,2.55521e-08,-5.25386e-12,32829.7,25.1236], Tmin=(100,'K'), Tmax=(1144.29,'K')), NASAPolynomial(coeffs=[10.083,0.0282019,-1.18727e-05,2.1996e-09,-1.51921e-13,30827.8,-18.2574], Tmin=(1144.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=[C]CC[O](6642)'],
    products = ['C=[C]CC(C)[O](6661)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(134)', '[CH2]C(C)[O](351)'],
    products = ['C=[C]CC(C)[O](6661)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(19)', 'C=[C]CC=O(3116)'],
    products = ['C=[C]CC(C)[O](6661)'],
