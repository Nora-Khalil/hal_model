...
"""),
    ...
    molecularWeight = (78.0242,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.43502,-0.0293579,0.000203169,-2.69527e-07,1.0882e-10,-2507.93,15.5728], Tmin=(100,'K'), Tmax=(912.268,'K')), NASAPolynomial(coeffs=[26.8967,-0.0240463,1.65547e-05,-3.16137e-09,2.00851e-13,-11290.3,-120.135], Tmin=(912.268,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsOs) + group(Cs-OsOsHH) + ring(Cyclopentane)"""),
)
...
"""),
    ...
    molecularWeight = (62.0248,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.46874,-0.0219087,0.000160131,-2.12637e-07,8.54413e-11,2990.31,11.1439], Tmin=(100,'K'), Tmax=(918.182,'K')), NASAPolynomial(coeffs=[22.5078,-0.0180857,1.21399e-05,-2.26683e-09,1.40363e-13,-4163.38,-99.0001], Tmin=(918.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.4436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OOO[O](6280)'],
    products = ['O2(2)', 'C1OO1(6270)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.65704e+13,'s^-1'), n=-0.0395312, Ea=(90.2345,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO;C_pri_rad_intra;OO_intra]
...
reaction(
    label = 'reaction2',
    reactants = ['O(7)', '[CH2]OO[O](280)'],
    products = ['[CH2]OOO[O](6280)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]OOO[O](6280)'],
    products = ['[O-][O+]=O(2047)', '[CH2][O](318)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.60331e+13,'s^-1'), n=-0.0568549, Ea=(143.812,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO;Y_rad_intra;OO_intra]
Euclidian distance = 0
family: Cyclic_Ether_Formation"""),
)
