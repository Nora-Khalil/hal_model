...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[O]CO[O](399)'],
    products = ['CC([O])O[O](201)'],
    transitionState = 'TS2',
