...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)C([O])(F)F(7461)'],
    products = ['CF2O(49)', 'CH2CF2(56)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', '[O]C(F)(F)[C](F)F(7878)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(7461)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(F)(F)[C](F)F(4669)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(7461)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)C([O])(F)F(7561)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(7461)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][C](F)F(4247)', 'CH2CF2(56)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(7461)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', '[CH2]C(F)(F)C(=O)F(4617)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(7461)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CF2O(49)', '[CH2][C](F)F(4220)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(7461)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C](F)F(4247)', '[CH2][C](F)F(4220)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(7461)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F2(77)', '[CH2][C](F)C(=O)F(2727)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(7461)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C](F)C(F)(F)OF(7879)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(7461)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(F)(F)[C](F)OF(7881)'],
    products = ['[CH2]C(F)(F)C([O])(F)F(7461)'],
