...
"""),
    E0 = (-559.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,326,540,652,719,1357,2950,3100,1380,975,1025,1650,180,180,404.105,560.806],'cm^-1')),
        HinderedRotor(inertia=(0.836873,'amu*angstrom^2'), symmetry=1, barrier=(19.2414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.836813,'amu*angstrom^2'), symmetry=1, barrier=(19.24,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.836873,'amu*angstrom^2'), symmetry=1, barrier=(19.2414,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
"""),
    E0 = (-193.06,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,326,540,652,719,1357,2950,3100,1380,975,1025,1650,617,898,1187,180,241.636,888.642],'cm^-1')),
        HinderedRotor(inertia=(0.556863,'amu*angstrom^2'), symmetry=1, barrier=(12.8034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.555813,'amu*angstrom^2'), symmetry=1, barrier=(12.7792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25547,'amu*angstrom^2'), symmetry=1, barrier=(28.8657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21237,0.0598661,-6.20677e-05,3.25852e-08,-6.80407e-12,-23118.1,22.3497], Tmin=(100,'K'), Tmax=(1158.7,'K')), NASAPolynomial(coeffs=[13.2784,0.0182124,-8.1446e-06,1.56014e-09,-1.10137e-13,-25914.3,-37.6394], Tmin=(1158.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CdCFO) + group(Cds-CdsHH) + group(CJ2_singlet-FCs)"""),
)
...
"""),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54335,0.0591143,-6.25533e-05,4.22084e-08,-1.2695e-11,-80490.3,22.3345], Tmin=(100,'K'), Tmax=(779.809,'K')), NASAPolynomial(coeffs=[6.1494,0.0354874,-1.71053e-05,3.35397e-09,-2.38456e-13,-81208.6,1.2586], Tmin=(779.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-669.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(CsCsFHH) + group(COCsFO)"""),
)

species(
    label = '[CH2]C(F)O[CH]CF(1347)',
...
"""),
    E0 = (-294.471,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,260.728,260.728,260.728,260.729],'cm^-1')),
        HinderedRotor(inertia=(0.447085,'amu*angstrom^2'), symmetry=1, barrier=(21.5671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19446,'amu*angstrom^2'), symmetry=1, barrier=(9.38067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194461,'amu*angstrom^2'), symmetry=1, barrier=(9.38067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.682233,'amu*angstrom^2'), symmetry=1, barrier=(32.9105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.46349,0.0838948,-0.000120858,9.59683e-08,-3.08727e-11,-35295.1,25.9938], Tmin=(100,'K'), Tmax=(758.486,'K')), NASAPolynomial(coeffs=[10.6142,0.0303642,-1.49964e-05,2.92356e-09,-2.05341e-13,-36835,-20.1719], Tmin=(758.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-294.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(CsCFHO) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cs-CsHHH) + radical(Csj(Cs-F1sHH)(O2s-Cs)(H)) + radical(Csj(Cs-F1sO2sH)(H)(H))"""),
)
...
"""),
    E0 = (-312.647,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,551,1088,1226,1380,1420,1481,3057,3119,3025,407.5,1350,352.5,395,473,707,1436,265.901,266.061,266.189,266.435],'cm^-1')),
        HinderedRotor(inertia=(0.215384,'amu*angstrom^2'), symmetry=1, barrier=(10.8358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.5079,'amu*angstrom^2'), symmetry=1, barrier=(25.5267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216024,'amu*angstrom^2'), symmetry=1, barrier=(10.8492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216107,'amu*angstrom^2'), symmetry=1, barrier=(10.8548,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
...
"""),
    E0 = (-281.317,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,487,638,688,1119,1325,1387,3149,3000,3100,440,815,1455,1000,334,575,1197,1424,3202,246.551,246.569,246.677,2376.16],'cm^-1')),
        HinderedRotor(inertia=(0.196729,'amu*angstrom^2'), symmetry=1, barrier=(8.48777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196615,'amu*angstrom^2'), symmetry=1, barrier=(8.48769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.695088,'amu*angstrom^2'), symmetry=1, barrier=(29.9819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.695292,'amu*angstrom^2'), symmetry=1, barrier=(29.9839,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
...
"""),
    E0 = (-134.598,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,2950,3100,1380,975,1025,1650,1685,370,253.404,253.405,253.422,253.427],'cm^-1')),
        HinderedRotor(inertia=(0.426822,'amu*angstrom^2'), symmetry=1, barrier=(19.449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426863,'amu*angstrom^2'), symmetry=1, barrier=(19.4489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426805,'amu*angstrom^2'), symmetry=1, barrier=(19.449,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0882,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22249,0.0532038,-3.77623e-05,6.65355e-09,2.39026e-12,-16081.5,22.7203], Tmin=(100,'K'), Tmax=(1006.01,'K')), NASAPolynomial(coeffs=[14.4703,0.0162095,-5.9823e-06,1.08691e-09,-7.66075e-14,-19540.5,-45.2158], Tmin=(1006.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-134.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-297.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,293,496,537,1218,3120,650,792.5,1650,284.171,284.171,284.172,284.173],'cm^-1')),
        HinderedRotor(inertia=(0.353226,'amu*angstrom^2'), symmetry=1, barrier=(20.2416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353232,'amu*angstrom^2'), symmetry=1, barrier=(20.2416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353226,'amu*angstrom^2'), symmetry=1, barrier=(20.2416,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.865255,0.0677899,-7.19286e-05,3.84796e-08,-8.17219e-12,-35618.6,22.3986], Tmin=(100,'K'), Tmax=(1140.87,'K')), NASAPolynomial(coeffs=[14.4997,0.0199865,-9.07787e-06,1.75316e-09,-1.24355e-13,-38729.7,-45.177], Tmin=(1140.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CdCFO) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = 'FC[C-]=[O+]CCF(1351)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p1 c+1 {4,S} {7,D}
4  C u0 p0 c0 {3,S} {5,S} {8,S} {9,S}
5  C u0 p0 c0 {1,S} {4,S} {10,S} {11,S}
...
"""),
    E0 = (-157.433,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,2750,2800,2850,1350,1500,750,1050,1375,1000,215.74,215.749,215.768,215.771,215.778,215.782],'cm^-1')),
        HinderedRotor(inertia=(0.205466,'amu*angstrom^2'), symmetry=1, barrier=(6.78773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205456,'amu*angstrom^2'), symmetry=1, barrier=(6.78766,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2055,'amu*angstrom^2'), symmetry=1, barrier=(6.78776,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27885,0.0667864,-8.37797e-05,6.32294e-08,-2.06016e-11,-18843.1,12.1276], Tmin=(100,'K'), Tmax=(730.962,'K')), NASAPolynomial(coeffs=[7.08128,0.0350338,-1.86199e-05,3.80042e-09,-2.75817e-13,-19691.4,-14.0473], Tmin=(730.962,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(CsCsFHH) + group(CsCFHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OCCF(1352)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {4,S} {6,S}
4  C u0 p0 c0 {3,S} {5,S} {8,S} {9,S}
...
"""),
    E0 = (-236.818,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,528,1116,1182,1331,1402,1494,3075,3110,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    molecularWeight = (108.087,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18567,0.0699747,-8.11764e-05,4.58451e-08,-5.09064e-12,-28388.9,22.3914], Tmin=(100,'K'), Tmax=(571.644,'K')), NASAPolynomial(coeffs=[7.52171,0.0358207,-1.82727e-05,3.64262e-09,-2.60302e-13,-29279.7,-6.088], Tmin=(571.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-236.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsCsFHH) + group(CsCFHO) + group(CsJ2_singlet-CsH)"""),
)
...
"""),
    E0 = (-165.016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,2175,525,750,770,3400,2100,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.25842,'amu*angstrom^2'), symmetry=1, barrier=(28.9336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26037,'amu*angstrom^2'), symmetry=1, barrier=(28.9784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25839,'amu*angstrom^2'), symmetry=1, barrier=(28.9328,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02324,0.056968,-4.66203e-05,1.11815e-08,1.98626e-12,-19732.1,17.7631], Tmin=(100,'K'), Tmax=(984.655,'K')), NASAPolynomial(coeffs=[16.7757,0.010919,-3.804e-06,6.98955e-10,-5.09616e-14,-23704.1,-62.4068], Tmin=(984.655,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)

species(
    label = 'F[C-]=[O+]CCF(1353)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-389.568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,528,1116,1182,1331,1402,1494,3075,3110,267.069,267.389,267.827,268.363,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.371488,'amu*angstrom^2'), symmetry=1, barrier=(18.8641,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.370072,'amu*angstrom^2'), symmetry=1, barrier=(18.8616,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.06,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84619,0.0402171,-2.92419e-05,7.62506e-09,-1.47919e-13,-46770.8,-2.97604], Tmin=(100,'K'), Tmax=(1243.68,'K')), NASAPolynomial(coeffs=[13.7514,0.0113873,-5.88065e-06,1.21876e-09,-8.9628e-14,-50463.7,-65.9495], Tmin=(1243.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(CsCsFHH) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(F)OCCF(565)'],
    products = ['CH2CHF(55)', 'CC(=O)F(253)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(6.66666e+07,'s^-1'), n=1.2, Ea=(143.683,'kJ/mol'), T0=(1,'K'), Tmin=(500,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=C(F)OCF(1345)'],
    products = ['C=C(F)OCCF(565)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(63.6433,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction3',
    reactants = ['H2(8)', 'C=C(F)OC[C]F(1346)'],
    products = ['C=C(F)OCCF(565)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'C=C(F)OC(340)'],
    products = ['C=C(F)OCCF(565)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(8.39871e-05,'m^3/(mol*s)'), n=3.10993, Ea=(22.4498,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 3.0"""),
)

reaction(
    label = 'reaction5',
    reactants = ['CH2CHF(55)', 'C=C(O)F(491)'],
    products = ['C=C(F)OCCF(565)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(7.88657e-08,'m^3/(mol*s)'), n=3.735, Ea=(228.447,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd/monosub_Cd/unsub;H_OR] for rate rule [Cd/monosub_Cd/unsub;H_OCd]
...
reaction(
    label = 'reaction6',
    reactants = ['C=C(F)OF(514)', 'C2H4(30)'],
    products = ['C=C(F)OCCF(565)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(F)O[CH]CF(1347)'],
    products = ['C=C(F)OCCF(565)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]COC(=C)F(522)'],
    products = ['C=C(F)OCCF(565)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2CFO(78)', 'CH2F-CH2(61)'],
    products = ['C=C(F)OCCF(565)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(2.39138,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C"""),
)

reaction(
    label = 'reaction15',
    reactants = ['CH2CF(69)', '[O]CCF(258)'],
    products = ['C=C(F)OCCF(565)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', '[CH2]OC(=C)F(341)'],
    products = ['C=C(F)OCCF(565)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', 'C=C(F)O[CH]CF(1349)'],
    products = ['C=C(F)OCCF(565)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', '[CH]=C(F)OCCF(1350)'],
    products = ['C=C(F)OCCF(565)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(25)', 'F[C-]=[O+]CCF(1353)'],
    products = ['C=C(F)OCCF(565)'],
