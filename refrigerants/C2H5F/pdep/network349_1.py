...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(134)', 'C=[C]O[O](155)'],
    products = ['C=[C]OO[C]=C(440)'],
    transitionState = 'TS2',
