...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', 'C=[C]O[O](155)'],
    products = ['[CH2]OO[C]=C(369)'],
    transitionState = 'TS2',
