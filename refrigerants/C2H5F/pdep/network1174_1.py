...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(136)', '[CH]=C[O](452)'],
    products = ['[CH]=CO[C]=O(3621)'],
    transitionState = 'TS2',
