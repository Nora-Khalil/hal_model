...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', 'C=C[C]F(2573)'],
    products = ['F[C]=CC[CH]F(2562)'],
    transitionState = 'TS3',
