...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C#COO(1058)'],
    products = ['C#COOCF(2045)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COOF(2146)'],
    products = ['C#COOCF(2045)'],
    transitionState = 'TS3',
