...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54912,0.0457072,-2.09378e-05,-1.85264e-09,2.42012e-12,-68138.4,21.8912], Tmin=(100,'K'), Tmax=(1282.04,'K')), NASAPolynomial(coeffs=[13.8082,0.0224613,-1.12933e-05,2.26013e-09,-1.61852e-13,-72514.7,-45.106], Tmin=(1282.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-567.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(CdCsCdF) + group(Cds-OdCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C(O)CC(=O)F(1359)',
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86035,0.0380479,3.54483e-06,-3.64048e-08,1.90188e-11,-26939.9,20.7118], Tmin=(100,'K'), Tmax=(893.488,'K')), NASAPolynomial(coeffs=[11.9024,0.0179227,-4.35582e-06,5.94465e-10,-3.67754e-14,-29725.5,-32.1507], Tmin=(893.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-224.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(CsCFHO) + ring(Tetrahydrofuran) + radical(Cs_P) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C([O])OC(=C)F(1361)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u1 p2 c0 {4,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.948924,'amu*angstrom^2'), symmetry=1, barrier=(21.8176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.94782,'amu*angstrom^2'), symmetry=1, barrier=(21.7922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949373,'amu*angstrom^2'), symmetry=1, barrier=(21.8279,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0277306,0.0817526,-9.7079e-05,5.33156e-08,-1.07787e-11,-12905.3,25.1972], Tmin=(100,'K'), Tmax=(1008.02,'K')), NASAPolynomial(coeffs=[20.8097,0.00873112,-2.80078e-06,4.75699e-10,-3.29239e-14,-17597.2,-77.9335], Tmin=(1008.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Csj(Cs-F1sO2sH)(H)(H)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)OC([CH2])O(1363)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
...
"""),
    E0 = (-96.9035,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,293,496,537,1218,3120,650,792.5,1650,357.181,357.186,357.211],'cm^-1')),
        HinderedRotor(inertia=(0.00132141,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194159,'amu*angstrom^2'), symmetry=1, barrier=(17.5838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19415,'amu*angstrom^2'), symmetry=1, barrier=(17.5836,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194125,'amu*angstrom^2'), symmetry=1, barrier=(17.5839,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.497435,0.0750168,-8.83126e-05,5.09039e-08,-1.14134e-11,-11526.9,26.5731], Tmin=(100,'K'), Tmax=(1095.22,'K')), NASAPolynomial(coeffs=[16.7867,0.0155254,-6.83511e-06,1.30888e-09,-9.27844e-14,-15095,-53.4952], Tmin=(1095.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.9035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(CdCFO) + group(Cds-CdsHH) + radical(CJCO) + radical(Cdj(Cd-F1sO2s)(H))"""),
)

species(
    label = '[CH2]C(=O)O[C](C)F(1036)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.811773,'amu*angstrom^2'), symmetry=1, barrier=(18.6642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.810283,'amu*angstrom^2'), symmetry=1, barrier=(18.63,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.812888,'amu*angstrom^2'), symmetry=1, barrier=(18.6899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.811965,'amu*angstrom^2'), symmetry=1, barrier=(18.6687,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.128772,0.0824276,-0.000105408,6.49828e-08,-1.53722e-11,-15097,23.7431], Tmin=(100,'K'), Tmax=(1047.27,'K')), NASAPolynomial(coeffs=[18.5529,0.0120576,-4.61782e-06,8.22453e-10,-5.61212e-14,-18956,-65.9939], Tmin=(1047.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CsCsF1sO2s) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)O[C](C)O(1364)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {5,S} {6,S}
3  O u0 p2 c0 {5,S} {12,S}
...
"""),
    E0 = (52.4213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,344.001,344.042,344.048],'cm^-1')),
        HinderedRotor(inertia=(0.159694,'amu*angstrom^2'), symmetry=1, barrier=(13.4106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159658,'amu*angstrom^2'), symmetry=1, barrier=(13.4105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159641,'amu*angstrom^2'), symmetry=1, barrier=(13.4105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.427,0.056019,-6.25959e-05,3.68784e-08,-8.64128e-12,6398.01,23.1929], Tmin=(100,'K'), Tmax=(1040.71,'K')), NASAPolynomial(coeffs=[11.4621,0.0174483,-7.0027e-06,1.26584e-09,-8.63453e-14,4309.29,-25.6212], Tmin=(1040.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.4213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (24.3524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([326,540,652,719,1357,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,259.351,259.901,2655.85],'cm^-1')),
        HinderedRotor(inertia=(0.8537,'amu*angstrom^2'), symmetry=1, barrier=(40.8298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167016,'amu*angstrom^2'), symmetry=1, barrier=(8.01893,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2262,0.0425939,-4.4927e-05,3.1032e-08,-9.64567e-12,2989.55,21.9565], Tmin=(100,'K'), Tmax=(754.11,'K')), NASAPolynomial(coeffs=[5.28922,0.026347,-1.26105e-05,2.46297e-09,-1.74662e-13,2527.58,8.04362], Tmin=(754.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.3524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    E0 = (-125.432,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,326,540,652,719,1357,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,212.112,212.121],'cm^-1')),
        HinderedRotor(inertia=(0.271838,'amu*angstrom^2'), symmetry=1, barrier=(8.67961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.685297,'amu*angstrom^2'), symmetry=1, barrier=(21.8823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27185,'amu*angstrom^2'), symmetry=1, barrier=(8.67926,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.960138,0.0712589,-0.000102564,7.86456e-08,-2.4072e-11,-14980.6,23.5572], Tmin=(100,'K'), Tmax=(800.406,'K')), NASAPolynomial(coeffs=[10.7818,0.0221751,-1.05773e-05,2.02839e-09,-1.41083e-13,-16552.9,-21.6399], Tmin=(800.406,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)OC(=C)O(1367)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  O u0 p2 c0 {4,S} {6,S}
3  O u0 p2 c0 {4,S} {10,S}
...
"""),
    E0 = (-110.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,293,496,537,1218,3120,650,792.5,1650,322.036,322.074,322.084],'cm^-1')),
        HinderedRotor(inertia=(0.126053,'amu*angstrom^2'), symmetry=1, barrier=(9.27726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126055,'amu*angstrom^2'), symmetry=1, barrier=(9.27761,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.314212,'amu*angstrom^2'), symmetry=1, barrier=(23.1247,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.888383,0.0727107,-0.000104042,7.82067e-08,-2.33691e-11,-13131.1,23.5247], Tmin=(100,'K'), Tmax=(820.448,'K')), NASAPolynomial(coeffs=[11.4171,0.0213814,-1.02018e-05,1.95907e-09,-1.36495e-13,-14858.8,-25.1868], Tmin=(820.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(CdCFO) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.52173,'amu*angstrom^2'), symmetry=1, barrier=(34.9875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52176,'amu*angstrom^2'), symmetry=1, barrier=(34.9883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52129,'amu*angstrom^2'), symmetry=1, barrier=(34.9774,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.621583,0.0830579,-0.00013593,1.21663e-07,-4.24539e-11,-5924.37,33.9186], Tmin=(100,'K'), Tmax=(840.995,'K')), NASAPolynomial(coeffs=[7.78474,0.0323771,-1.59088e-05,3.03451e-09,-2.08042e-13,-6541.78,4.09341], Tmin=(840.995,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.1994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(O)OC(=C)F(1370)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {4,S} {12,S}
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.965139,0.0690222,-7.9113e-05,4.63864e-08,-1.08942e-11,-14306.4,24.2967], Tmin=(100,'K'), Tmax=(1030.13,'K')), NASAPolynomial(coeffs=[13.0624,0.0220494,-1.07163e-05,2.12336e-09,-1.52383e-13,-16798.8,-34.4252], Tmin=(1030.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-119.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CdCFO) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C(F)OC(=C)O(1371)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {5,S}
3  O u0 p2 c0 {5,S} {12,S}
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.146062,0.0789109,-9.27886e-05,5.20052e-08,-1.11727e-11,-13958.5,22.6161], Tmin=(100,'K'), Tmax=(1151.47,'K')), NASAPolynomial(coeffs=[19.6868,0.0110295,-4.36013e-06,8.07423e-10,-5.68728e-14,-18458.5,-74.4125], Tmin=(1151.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(CsCFHO) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'C#COC(=C)O(1278)',
...
"""),
    E0 = (-282.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,408.877,408.881,408.884,408.887,408.889,1377.64],'cm^-1')),
        HinderedRotor(inertia=(0.102402,'amu*angstrom^2'), symmetry=1, barrier=(12.1491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260282,'amu*angstrom^2'), symmetry=1, barrier=(30.8786,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.053,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76244,0.0495626,-5.64888e-05,3.30219e-08,-7.6736e-12,-33876.7,16.769], Tmin=(100,'K'), Tmax=(1046.67,'K')), NASAPolynomial(coeffs=[10.8652,0.0147755,-6.63548e-06,1.26863e-09,-8.93566e-14,-35782.3,-27.562], Tmin=(1046.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(CJ2_singlet-FO)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['O[C]1CC[C](F)O1(1360)'],
    products = ['C=C(O)OC(=C)F(1048)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)OC([CH2])F(1196)'],
    products = ['C=C(O)OC(=C)F(1048)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(O)OC([CH2])F(1362)'],
    products = ['C=C(O)OC(=C)F(1048)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(F)OC([CH2])O(1363)'],
    products = ['C=C(O)OC(=C)F(1048)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(5.14222e+08,'s^-1'), n=0.311, Ea=(24.9733,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad;XH_Rrad] for rate rule [R4radExo;Y_rad;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(=O)O[C](C)F(1036)'],
    products = ['C=C(O)OC(=C)F(1048)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C=[C]OC(=C)O(1365)'],
    products = ['C=C(O)OC(=C)F(1048)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2CF(69)', '[CH2]C(=O)O(1341)'],
    products = ['C=C(O)OC(=C)F(1048)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH2]C(=O)OC(=C)F(640)'],
    products = ['C=C(O)OC(=C)F(1048)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(6)', '[CH]=C(O)OC(=C)F(1366)'],
    products = ['C=C(O)OC(=C)F(1048)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', '[CH]=C(F)OC(=C)O(1367)'],
    products = ['C=C(O)OC(=C)F(1048)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'C#COC(=C)O(1278)'],
    products = ['C=C(O)OC(=C)F(1048)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(25)', 'C=C(O)[O+]=[C-]F(1372)'],
    products = ['C=C(O)OC(=C)F(1048)'],
