...
reaction(
    label = 'reaction12',
    reactants = ['F(37)', '[CH2]C(=O)C(=O)O(3952)'],
    products = ['C=C(OF)C(=O)O(3902)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]F(357)', 'C=[C]C(=O)O(3953)'],
    products = ['C=C(OF)C(=O)O(3902)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(5)', 'C=C([C]=O)OF(2561)'],
    products = ['C=C(OF)C(=O)O(3902)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', 'C=C(OF)C([O])=O(3954)'],
    products = ['C=C(OF)C(=O)O(3902)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]O(178)', 'C=[C]OF(507)'],
    products = ['C=C(OF)C(=O)O(3902)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', '[CH]=C(OF)C(=O)O(3955)'],
    products = ['C=C(OF)C(=O)O(3902)'],
