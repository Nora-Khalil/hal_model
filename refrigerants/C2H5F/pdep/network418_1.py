...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C(271)', 'C=[C]O[O](275)'],
    products = ['C=[C]OO[C]=C(1271)'],
    transitionState = 'TS2',
