...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]CC[O](377)'],
    products = ['[CH2]CC(C)[O](508)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(18)', '[CH2]C(C)[O](351)'],
    products = ['[CH2]CC(C)[O](508)'],
    transitionState = 'TS4',
