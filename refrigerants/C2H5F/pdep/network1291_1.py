...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=O)O[C](O)F(4085)'],
    products = ['C=C(O)OC(=O)F(3905)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'C=C(O)O[C]=O(4088)'],
    products = ['C=C(O)OC(=O)F(3905)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(=O)F(3603)', 'C=[C]O(606)'],
    products = ['C=C(O)OC(=O)F(3905)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CFO(51)', '[CH2]C(=O)O(1341)'],
    products = ['C=C(O)OC(=O)F(3905)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(5)', 'C=[C]OC(=O)F(1184)'],
    products = ['C=C(O)OC(=O)F(3905)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(6)', '[CH2]C(=O)OC(=O)F(4089)'],
    products = ['C=C(O)OC(=O)F(3905)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(6)', '[CH]=C(O)OC(=O)F(4090)'],
    products = ['C=C(O)OC(=O)F(3905)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=C(O)OC(=O)F(3905)'],
    products = ['O=C(O)F(2293)', 'CH2CO(28)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C(O)OC(=O)F(3905)'],
    products = ['O=C(O)F(2293)', 'C#CO(1368)'],
