...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.770115,0.0630831,-4.15555e-05,8.41772e-09,1.64815e-12,10607.2,22.4873], Tmin=(100,'K'), Tmax=(1021.34,'K')), NASAPolynomial(coeffs=[13.608,0.0272599,-1.01732e-05,1.79066e-09,-1.21628e-13,7230.89,-43.4099], Tmin=(1021.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C)C([CH2])O(6438)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0881763,'amu*angstrom^2'), symmetry=1, barrier=(10.8664,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.086114,'amu*angstrom^2'), symmetry=1, barrier=(10.862,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0877392,'amu*angstrom^2'), symmetry=1, barrier=(10.864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.086422,'amu*angstrom^2'), symmetry=1, barrier=(10.8647,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.912941,0.0631934,-5.75259e-05,2.74059e-08,-5.23636e-12,27814,26.2202], Tmin=(100,'K'), Tmax=(1259.25,'K')), NASAPolynomial(coeffs=[13.8119,0.0222204,-8.71992e-06,1.56748e-09,-1.06685e-13,24565.3,-38.9833], Tmin=(1259.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=C(C)C[O](6089)'],
    products = ['[CH]=C(C)C(C)[O](6113)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=CC(C)[O](427)'],
    products = ['[CH]=C(C)C(C)[O](6113)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH][O](174)', '[CH]=[C]C(4976)'],
    products = ['[CH]=C(C)C(C)[O](6113)'],
