...
"""),
    E0 = (-281.224,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([522,611,926,1093,1137,1374,1416,3112,3025,407.5,1350,352.5,1855,455,950,726.32],'cm^-1')),
        HinderedRotor(inertia=(0.265998,'amu*angstrom^2'), symmetry=1, barrier=(6.11582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.86955,'amu*angstrom^2'), symmetry=1, barrier=(19.9927,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.0441,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25033,0.0392346,-4.29058e-05,2.49921e-08,-5.85528e-12,-33761,18.9941], Tmin=(100,'K'), Tmax=(1032.86,'K')), NASAPolynomial(coeffs=[8.82385,0.0137774,-5.93543e-06,1.12973e-09,-7.95594e-14,-35118.9,-12.9319], Tmin=(1032.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.841402,'amu*angstrom^2'), symmetry=1, barrier=(19.3455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137028,'amu*angstrom^2'), symmetry=1, barrier=(42.1025,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.052,'amu'),
...
reaction(
    label = 'reaction6',
    reactants = ['CO(13)', 'CHF2-CH2(63)'],
    products = ['O=[C]CC(F)F(3390)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'O=[C]C[CH]F(1140)'],
    products = ['O=[C]CC(F)F(3390)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'O=[C][CH]C(F)F(3696)'],
    products = ['O=[C]CC(F)F(3390)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'O=[C]C[C](F)F(3697)'],
    products = ['O=[C]CC(F)F(3390)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]CC(F)F(3390)'],
    products = ['O=C(F)C[CH]F(2002)'],
