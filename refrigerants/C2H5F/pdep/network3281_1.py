...
species(
    label = '[CH2]C(F)=C([CH2])C(F)F(9243)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.870567,0.071818,-7.5386e-05,4.19875e-08,-9.58798e-12,-44870.3,24.6826], Tmin=(100,'K'), Tmax=(1045.33,'K')), NASAPolynomial(coeffs=[12.0889,0.0288907,-1.37873e-05,2.70252e-09,-1.92609e-13,-47215.7,-29.9365], Tmin=(1045.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFFH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCsCdF) + radical(Allyl_P) + radical(Csj(Cd-F1sCd)(H)(H))"""),
)
...
"""),
    ...
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7516,0.0536801,-4.27913e-05,2.0118e-08,-4.29341e-12,-33694.7,23.4458], Tmin=(100,'K'), Tmax=(1043.4,'K')), NASAPolynomial(coeffs=[6.58011,0.0351694,-1.61803e-05,3.1153e-09,-2.19546e-13,-34702.3,-0.0541296], Tmin=(1043.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(CsCsCsFF) + group(CsCsCsFH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cs-Cs-Cs(F)(F)-Cs) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.35748,'amu*angstrom^2'), symmetry=1, barrier=(8.21918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357808,'amu*angstrom^2'), symmetry=1, barrier=(8.22672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357929,'amu*angstrom^2'), symmetry=1, barrier=(8.2295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.339836,0.0886409,-0.000140409,1.2312e-07,-4.29634e-11,-25508.3,26.3836], Tmin=(100,'K'), Tmax=(802.624,'K')), NASAPolynomial(coeffs=[9.06984,0.0339168,-1.71737e-05,3.34837e-09,-2.33629e-13,-26548.4,-11.5634], Tmin=(802.624,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-213.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(CdCFH) + radical(Csj(Cs-F1sF1sCd)(H)(H)) + radical(Cdj(Cd-CsCs)(F1s))"""),
)

species(
    label = 'C=C([C]F)C(C)(F)F(9248)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {4,S}
3  F u0 p3 c0 {8,S}
...
"""),
    E0 = (-288.084,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([274,345,380,539,705,1166,1213,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,380.02,380.175,380.679,380.752],'cm^-1')),
        HinderedRotor(inertia=(0.0650817,'amu*angstrom^2'), symmetry=1, barrier=(6.67498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0652411,'amu*angstrom^2'), symmetry=1, barrier=(6.66918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0645825,'amu*angstrom^2'), symmetry=1, barrier=(6.67676,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01807,0.0743624,-8.98069e-05,5.09739e-08,-4.9835e-12,-34549.6,22.6341], Tmin=(100,'K'), Tmax=(568.441,'K')), NASAPolynomial(coeffs=[8.23191,0.0354232,-1.82529e-05,3.64507e-09,-2.60347e-13,-35560.7,-9.7739], Tmin=(568.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFF) + group(Cs-CsHHH) + group(CsCFHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
    products = ['[CH2]C(F)=C([CH2])C(F)F(9243)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', '[CH2]C([CH]F)=C(F)F(9244)'],
    products = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', '[CH2]C(F)(F)[C]=CF(4644)'],
    products = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
    products = ['[CH2][C]1C(F)CC1(F)F(9246)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', '[CH2]C(=CF)C(=C)F(8523)'],
    products = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(F)(F)C(C)=[C]F(9247)'],
    products = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C([C]F)C(C)(F)F(9248)'],
    products = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]C(=C)C(F)(F)CF(9251)'],
    products = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]F(837)', '[CH2]C(F)(F)[C]=C(4532)'],
    products = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
    products = ['F[CH][C]1CCC1(F)F(9253)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CHF(40)', '[CH2]C(F)(F)[C]=C(4532)'],
    products = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]C(=CF)C(C)(F)F(9254)'],
    products = ['[CH2]C(=CF)C([CH2])(F)F(8552)'],
