...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)(F)O[CH]F(4464)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(837)', '[CH2]C([O])(F)F(1349)'],
    products = ['[CH2]C(F)(F)O[CH]F(4464)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', 'C=C(F)O[CH]F(2010)'],
    products = ['[CH2]C(F)(F)O[CH]F(4464)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[CH2]C([O])(F)F(1349)'],
    products = ['[CH2]C(F)(F)O[CH]F(4464)'],
    transitionState = 'TS9',
