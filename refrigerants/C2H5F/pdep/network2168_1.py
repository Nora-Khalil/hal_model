...
"""),
    E0 = (242.848,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,1685,370,242.3,242.302],'cm^-1')),
        HinderedRotor(inertia=(0.00287172,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262272,'amu*angstrom^2'), symmetry=1, barrier=(10.9271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262285,'amu*angstrom^2'), symmetry=1, barrier=(10.9271,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28711,0.0525351,-3.54933e-05,1.20898e-08,-1.668e-12,29311.4,25.1871], Tmin=(100,'K'), Tmax=(1678.09,'K')), NASAPolynomial(coeffs=[13.6691,0.0230202,-9.11044e-06,1.60834e-09,-1.06474e-13,25155.9,-40.9583], Tmin=(1678.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(Cds_S)"""),
)
...
"""),
    E0 = (164.801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2100,2250,500,550,257.806,266.358],'cm^-1')),
        HinderedRotor(inertia=(0.00251963,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.470373,'amu*angstrom^2'), symmetry=1, barrier=(23.4853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54778,'amu*angstrom^2'), symmetry=1, barrier=(72.9807,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7111,0.0414674,-2.89512e-06,-2.86334e-08,1.54325e-11,19911.6,22.4066], Tmin=(100,'K'), Tmax=(918.809,'K')), NASAPolynomial(coeffs=[11.9034,0.0202073,-5.91791e-06,9.36494e-10,-6.215e-14,17063.1,-31.2111], Tmin=(918.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CC(C)OJ)"""),
)

species(
    label = 'C[C]C=C(C)O(6458)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.923527,0.0579684,-3.30222e-05,-4.1952e-09,7.44257e-12,21901.9,22.8886], Tmin=(100,'K'), Tmax=(966.49,'K')), NASAPolynomial(coeffs=[15.8387,0.0184591,-6.18909e-06,1.08334e-09,-7.58996e-14,17981,-53.929], Tmin=(966.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (224.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,256.354],'cm^-1')),
        HinderedRotor(inertia=(0.00256518,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        ...
        HinderedRotor(inertia=(0.215069,'amu*angstrom^2'), symmetry=1, barrier=(10.0296,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30411,0.0580584,-4.95282e-05,2.28341e-08,-4.35384e-12,27048.2,25.935], Tmin=(100,'K'), Tmax=(1233.67,'K')), NASAPolynomial(coeffs=[11.0619,0.02642,-1.10594e-05,2.04574e-09,-1.41136e-13,24640.6,-23.1899], Tmin=(1233.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CJCO) + radical(Cds_S)"""),
)

species(
    label = 'C[C]=[C]C(C)O(6462)',
    structure = adjacencyList("""multiplicity 3
1  O u0 p2 c0 {2,S} {14,S}
2  C u0 p0 c0 {1,S} {3,S} {5,S} {7,S}
3  C u0 p0 c0 {2,S} {8,S} {9,S} {10,S}
...
"""),
    E0 = (250.329,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1670,1700,300,440,278.587],'cm^-1')),
        HinderedRotor(inertia=(0.147718,'amu*angstrom^2'), symmetry=1, barrier=(8.1296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147668,'amu*angstrom^2'), symmetry=1, barrier=(8.12989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147677,'amu*angstrom^2'), symmetry=1, barrier=(8.12941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147616,'amu*angstrom^2'), symmetry=1, barrier=(8.12909,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58992,0.0554367,-4.72025e-05,2.31413e-08,-4.91026e-12,30192.4,24.7548], Tmin=(100,'K'), Tmax=(1086.05,'K')), NASAPolynomial(coeffs=[8.16845,0.0312072,-1.37377e-05,2.59891e-09,-1.81517e-13,28763.5,-7.52577], Tmin=(1086.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(250.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C=C(C)[O](6463)',
    structure = adjacencyList("""multiplicity 3
1  O u1 p2 c0 {5,S}
2  C u0 p0 c0 {4,S} {7,S} {8,S} {9,S}
3  C u0 p0 c0 {5,S} {10,S} {11,S} {12,S}
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C[C]=CC[O](6088)'],
    products = ['C[C]=CC(C)[O](6112)'],
    transitionState = 'TS2',
