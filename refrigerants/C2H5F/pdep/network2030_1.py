...
reaction(
    label = 'reaction4',
    reactants = ['H(6)', '[CH]=C(F)C=C=C(6644)'],
    products = ['[CH]=C(F)C=[C]C(6404)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(6)', '[CH]=C(F)C#CC(6645)'],
    products = ['[CH]=C(F)C=[C]C(6404)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', '[CH]=C=C=[C]C(6646)'],
    products = ['[CH]=C(F)C=[C]C(6404)'],
