...
reaction(
    label = 'reaction5',
    reactants = ['H(5)', '[CH]=C(F)C=C=CF(9098)'],
    products = ['[CH]=C(F)C=[C]CF(11106)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]=C(F)C#CCF(11260)'],
    products = ['[CH]=C(F)C=[C]CF(11106)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#CC=[C]CF(11180)'],
    products = ['[CH]=C(F)C=[C]CF(11106)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['HF(38)', '[CH]=C=C=[C]CF(11261)'],
    products = ['[CH]=C(F)C=[C]CF(11106)'],
