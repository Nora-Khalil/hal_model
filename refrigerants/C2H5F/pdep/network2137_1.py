...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC([O])=O(264)'],
    products = ['[CH]=C(C)C([O])=O(6081)'],
    transitionState = 'TS2',
