...
reaction(
    label = 'reaction2',
    reactants = ['[C]=O(126)', '[O]C([O])F(2070)'],
    products = ['[O]C(F)O[C]=O(2264)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[O][C]=O(625)', '[O][CH]F(1657)'],
    products = ['[O]C(F)O[C]=O(2264)'],
