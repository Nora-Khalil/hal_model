...
reaction(
    label = 'reaction2',
    reactants = ['C[C]F-2(182)', 'C[C]=C[O](6480)'],
    products = ['C[C]=CO[C](C)F(6688)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', 'C=C(F)OC=[C]C(6701)'],
    products = ['C[C]=CO[C](C)F(6688)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(6)', 'C=C=CO[C](C)F(6702)'],
    products = ['C[C]=CO[C](C)F(6688)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(6)', 'CC#CO[C](C)F(6703)'],
    products = ['C[C]=CO[C](C)F(6688)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[C]F(124)', 'C[C]=C[O](6480)'],
    products = ['C[C]=CO[C](C)F(6688)'],
