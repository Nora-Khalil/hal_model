...
"""),
    ...
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.8309,0.0271461,-1.10384e-05,2.41946e-10,4.1579e-13,-17807.6,13.7982], Tmin=(100,'K'), Tmax=(1786.57,'K')), NASAPolynomial(coeffs=[11.5526,0.0154344,-7.7671e-06,1.46985e-09,-9.86709e-14,-22171.2,-36.8308], Tmin=(1786.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-148.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + longDistanceInteraction_cyclic(Cs(F)-CO) + ring(Cyclobutene)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01064,'amu*angstrom^2'), symmetry=1, barrier=(23.2367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00827,'amu*angstrom^2'), symmetry=1, barrier=(23.182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0643,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88664,0.0518179,-8.10146e-05,7.33546e-08,-2.65967e-11,23975.8,20.3844], Tmin=(100,'K'), Tmax=(797.459,'K')), NASAPolynomial(coeffs=[5.82621,0.0235927,-1.20024e-05,2.35098e-09,-1.64687e-13,23616.6,3.95739], Tmin=(797.459,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCCFH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C=C(F)[C]=O(7733)',
    structure = adjacencyList("""multiplicity 3
1 F u0 p3 c0 {4,S}
2 O u0 p2 c0 {6,D}
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(136)', '[CH]C=CF(444)'],
    products = ['[CH]=CC(F)[C]=O(7760)'],
    transitionState = 'TS3',
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.81516e-05,'m^3/(mol*s)'), n=3.04336, Ea=(36.0338,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(6)', 'C#CC(F)[C]=O(7796)'],
    products = ['[CH]=CC(F)[C]=O(7760)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(281.03,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC(F)[C]=O(7760)'],
    products = ['[CH]C=C(F)C=O(7797)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=CC(F)[C]=O(7760)'],
    products = ['O=[C]C=C[CH]F(5500)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(171.783,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
