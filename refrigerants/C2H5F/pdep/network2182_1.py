...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C=[C]C(6122)'],
    products = ['C[C]=CC[CH]F(6124)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', 'C=C[C]C(6174)'],
    products = ['C[C]=CC[CH]F(6124)'],
    transitionState = 'TS3',
