...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.822659,'amu*angstrom^2'), symmetry=1, barrier=(18.9146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.821535,'amu*angstrom^2'), symmetry=1, barrier=(18.8887,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87403,0.0412736,-2.68865e-05,5.33548e-09,1.04542e-12,65369.1,18.3088], Tmin=(100,'K'), Tmax=(1040.75,'K')), NASAPolynomial(coeffs=[10.5329,0.0175829,-6.56175e-06,1.16864e-09,-8.01102e-14,63047.4,-26.306], Tmin=(1040.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(542.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.661414,'amu*angstrom^2'), symmetry=1, barrier=(15.2072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.661645,'amu*angstrom^2'), symmetry=1, barrier=(15.2125,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7638,0.0514069,-5.14455e-05,2.84059e-08,-6.53513e-12,43832.2,19.1819], Tmin=(100,'K'), Tmax=(1030.63,'K')), NASAPolynomial(coeffs=[8.97262,0.0234286,-1.07252e-05,2.06584e-09,-1.45821e-13,42346.3,-15.8139], Tmin=(1030.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(CdCCF) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cdj(Cd-CdF1s)(H))"""),
)

species(
    label = 'CC1=CC(CF)=C1(10606)',
...
"""),
    E0 = (268.505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.11063,'amu*angstrom^2'), symmetry=1, barrier=(25.5356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11121,'amu*angstrom^2'), symmetry=1, barrier=(25.5489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.841187,0.0656319,-6.28777e-05,3.08828e-08,-6.04786e-12,32410.6,22.8467], Tmin=(100,'K'), Tmax=(1232.11,'K')), NASAPolynomial(coeffs=[14.5181,0.0212304,-8.82218e-06,1.63461e-09,-1.13278e-13,29040.4,-45.9912], Tmin=(1232.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_P)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.22966,'amu*angstrom^2'), symmetry=1, barrier=(28.2724,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (65.0931,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00601,0.0382317,-2.80502e-05,1.04946e-08,-1.58305e-12,56907.9,16.3361], Tmin=(100,'K'), Tmax=(1561.19,'K')), NASAPolynomial(coeffs=[10.9988,0.0151905,-5.91187e-06,1.04088e-09,-6.91573e-14,54100,-31.0547], Tmin=(1561.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(472.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (259.666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2100,2250,500,550,3120,650,792.5,1650,255.981],'cm^-1')),
        HinderedRotor(inertia=(0.42972,'amu*angstrom^2'), symmetry=1, barrier=(20.0003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161295,'amu*angstrom^2'), symmetry=1, barrier=(7.52094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50529,'amu*angstrom^2'), symmetry=1, barrier=(69.9768,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1101,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47493,0.0553689,-4.79255e-05,2.34998e-08,-4.85054e-12,31321.7,23.0002], Tmin=(100,'K'), Tmax=(1137.7,'K')), NASAPolynomial(coeffs=[9.36378,0.0276324,-1.13558e-05,2.07053e-09,-1.41573e-13,29526.7,-16.0766], Tmin=(1137.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-CtHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(C=C[CH2])CF(10595)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {3,S} {8,S} {9,S}
3  C u0 p0 c0 {2,S} {4,S} {7,D}
...
"""),
    E0 = (209.957,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,3120,650,792.5,1650,258.956],'cm^-1')),
        HinderedRotor(inertia=(0.501533,'amu*angstrom^2'), symmetry=1, barrier=(23.8744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.501833,'amu*angstrom^2'), symmetry=1, barrier=(23.8737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.58921,'amu*angstrom^2'), symmetry=1, barrier=(75.6582,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.931271,0.0588735,-3.69126e-05,4.90075e-09,2.60851e-12,25369.9,25.0271], Tmin=(100,'K'), Tmax=(1039.11,'K')), NASAPolynomial(coeffs=[14.0926,0.0239318,-9.16819e-06,1.66143e-09,-1.15309e-13,21785.8,-43.0581], Tmin=(1039.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CC=CCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C=CC)CF(10615)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  C u0 p0 c0 {1,S} {4,S} {8,S} {9,S}
3  C u0 p0 c0 {5,S} {10,S} {11,S} {12,S}
...
"""),
    ...
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3354,0.0636087,-5.0629e-05,2.41516e-08,-5.30156e-12,32181.1,22.9243], Tmin=(100,'K'), Tmax=(1010.74,'K')), NASAPolynomial(coeffs=[6.58969,0.0428149,-1.97698e-05,3.79743e-09,-2.67092e-13,31118.9,-2.48082], Tmin=(1010.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C(C=[C]C)=CF(10616)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {7,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {4,S} {5,S} {6,D}
4  C u0 p0 c0 {3,S} {7,D} {11,S}
5  C u1 p0 c0 {3,S} {12,S} {14,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C=[C]C)CF(10236)'],
    products = ['C#CCF(5582)', 'C#CC(3594)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC=[C]C(6366)'],
    products = ['[CH]=C(C=[C]C)CF(10236)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)C=[C]C(6404)'],
    products = ['[CH]=C(C=[C]C)CF(10236)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(6)', '[CH]=C(C=C=C)CF(10250)'],
    products = ['[CH]=C(C=[C]C)CF(10236)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2F(46)', 'C#CC=[C]C(6496)'],
    products = ['[CH]=C(C=[C]C)CF(10236)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]CF(5583)', '[CH]=[C]C(3595)'],
    products = ['[CH]=C(C=[C]C)CF(10236)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(C=C[CH2])CF(10595)'],
    products = ['[CH]=C(C=[C]C)CF(10236)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(C=[C]C)CF(10236)'],
    products = ['[CH]C(C=CC)=CF(10618)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(74200,'s^-1'), n=2.23, Ea=(44.3086,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_DSS;Cd_rad_out_single;Cs_H_out_1H] for rate rule [R4H_DSS;Cd_rad_out_Cs;Cs_H_out_1H]
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(C=[C]C)CF(10236)'],
    products = ['[CH]C(=C)C=C(C)F(10619)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(0.000550858,'s^-1'), n=4.50663, Ea=(174.75,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R4F_Ext-4R!H-R',), comment="""Estimated from node R4F_Ext-4R!H-R"""),
)

network(
    label = 'PDepNetwork #3388',
    isomers = [
        '[CH]=C(C=[C]C)CF(10236)',
    ],
    reactants = [
        ('C#CCF(5582)', 'C#CC(3594)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
