...
"""),
    E0 = (337.432,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([212,931,1104,1251,1325,1474,3102,3155,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,3115,3125,620,680,785,800,1600,1700],'cm^-1')),
        HinderedRotor(inertia=(0.801564,'amu*angstrom^2'), symmetry=1, barrier=(18.4295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.801414,'amu*angstrom^2'), symmetry=1, barrier=(18.4261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.802118,'amu*angstrom^2'), symmetry=1, barrier=(18.4423,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.693204,0.0720101,-7.3717e-05,3.97705e-08,-8.63962e-12,40703.4,23.524], Tmin=(100,'K'), Tmax=(1110.11,'K')), NASAPolynomial(coeffs=[13.5999,0.025505,-1.08798e-05,2.03493e-09,-1.41636e-13,37837.8,-40.0919], Tmin=(1110.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(CsCFHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C)C([CH2])=CF(10602)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  C u0 p0 c0 {4,S} {8,S} {9,S} {10,S}
3  C u0 p0 c0 {4,S} {5,S} {6,D}
4  C u0 p0 c0 {2,S} {3,S} {7,D}
5  C u1 p0 c0 {3,S} {11,S} {13,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C)C(=[CH])CF(10238)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CC(=[CH])C(6367)'],
    products = ['[CH]=C(C)C(=[CH])CF(10238)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(C)C(=[CH])F(6405)'],
    products = ['[CH]=C(C)C(=[CH])CF(10238)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', '[CH]=CC(=[CH])CF(10186)'],
    products = ['[CH]=C(C)C(=[CH])CF(10238)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2F(46)', '[CH]=C(C)C#C(6475)'],
    products = ['[CH]=C(C)C(=[CH])CF(10238)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', '[CH]=C(C#C)CF(10334)'],
    products = ['[CH]=C(C)C(=[CH])CF(10238)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(C)C(=[CH])CF(10238)'],
    products = ['[CH]=C(C)C([CH2])=CF(10602)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(C)C(=[CH])CF(10238)'],
    products = ['[CH]=C(CF)C([CH2])=C(10244)'],
