...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'F[CH]O[CH]F(2009)'],
    products = ['[CH2]C(F)O[CH]F(1985)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'C=C(F)O[CH]F(2010)'],
    products = ['[CH2]C(F)O[CH]F(1985)'],
    transitionState = 'TS9',
