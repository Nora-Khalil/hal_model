...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04755,0.024917,4.85444e-05,-9.40064e-08,4.24283e-11,-29623.4,14.1665], Tmin=(100,'K'), Tmax=(899.873,'K')), NASAPolynomial(coeffs=[17.4108,0.00458265,2.50107e-06,-6.73247e-10,4.5894e-14,-34330.1,-69.1203], Tmin=(899.873,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.028,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(CdCFH) + ring(2methyleneoxetane)"""),
)
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10402,0.0440109,-3.8876e-05,2.00235e-08,-4.47834e-12,-21605.6,20.101], Tmin=(100,'K'), Tmax=(1034.25,'K')), NASAPolynomial(coeffs=[7.05909,0.0248468,-1.10816e-05,2.10742e-09,-1.47614e-13,-22630.5,-3.97115], Tmin=(1034.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds)"""),
)
...
"""),
    E0 = (45.5146,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,113,247,382,1207,3490,540,610,2055,180,1479.57,1482.01],'cm^-1')),
        HinderedRotor(inertia=(0.00322053,'amu*angstrom^2'), symmetry=1, barrier=(5.01077,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.68623,0.0286813,-1.3523e-05,2.45525e-09,-1.52839e-13,5461.89,15.133], Tmin=(100,'K'), Tmax=(3008.43,'K')), NASAPolynomial(coeffs=[35.7672,-0.00801587,1.80367e-06,-2.82876e-10,1.99978e-14,-16536.8,-179.455], Tmin=(3008.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.5146,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(CdCddFH) + group(Cdd-CdsCds) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00283751,'amu*angstrom^2'), symmetry=1, barrier=(5.92653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.72897,'amu*angstrom^2'), symmetry=1, barrier=(62.7445,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33992,0.0398444,-4.7406e-05,3.95963e-08,-1.38142e-11,25970.3,17.4444], Tmin=(100,'K'), Tmax=(855.13,'K')), NASAPolynomial(coeffs=[3.91576,0.0257608,-1.09273e-05,1.97782e-09,-1.32718e-13,25946.2,11.5235], Tmin=(855.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCOJ)"""),
)
...
"""),
    E0 = (115.694,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2175,525,239,401,1367,180,1509.34,1509.43],'cm^-1')),
        HinderedRotor(inertia=(0.18966,'amu*angstrom^2'), symmetry=1, barrier=(4.36066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189666,'amu*angstrom^2'), symmetry=1, barrier=(4.36079,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0722,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11846,0.0488652,-7.69878e-05,7.54465e-08,-2.84859e-11,13975.3,20.5597], Tmin=(100,'K'), Tmax=(853.818,'K')), NASAPolynomial(coeffs=[2.26069,0.0307504,-1.45098e-05,2.72858e-09,-1.85776e-13,14587,23.6204], Tmin=(853.818,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(115.694,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Ct-CtCs) + group(CtCF) + radical(CCOJ)"""),
)
...
"""),
    E0 = (58.891,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,615,860,1140,1343,3152,1685,370,335.97,335.973,4000],'cm^-1')),
        HinderedRotor(inertia=(0.118947,'amu*angstrom^2'), symmetry=1, barrier=(9.52739,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118944,'amu*angstrom^2'), symmetry=1, barrier=(9.5274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.448931,'amu*angstrom^2'), symmetry=1, barrier=(35.9597,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59588,0.0558195,-6.77393e-05,4.63951e-08,-1.30197e-11,7166.91,23.7862], Tmin=(100,'K'), Tmax=(862.773,'K')), NASAPolynomial(coeffs=[8.73579,0.0227171,-1.01878e-05,1.92454e-09,-1.33697e-13,5934.9,-9.60579], Tmin=(862.773,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(CCsJOH) + radical(Cdj(Cs-CsHH)(Cd-F1sH))"""),
)

species(
    label = '[O]CCC=[C]F(8840)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  O u1 p2 c0 {4,S}
3  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
...
"""),
    E0 = (107.683,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,167,640,1190,180,180,2235.3],'cm^-1')),
        HinderedRotor(inertia=(0.137959,'amu*angstrom^2'), symmetry=1, barrier=(3.17196,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94462,0.050415,-6.77643e-05,6.14981e-08,-2.31643e-11,13020.2,22.364], Tmin=(100,'K'), Tmax=(795.875,'K')), NASAPolynomial(coeffs=[3.84164,0.0316888,-1.51466e-05,2.91123e-09,-2.02621e-13,13009.4,15.474], Tmin=(795.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(107.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(CCOJ) + radical(Cdj(Cd-CsH)(F1s))"""),
)
...
"""),
    E0 = (128.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,167,640,1190,180,2502.13],'cm^-1')),
        HinderedRotor(inertia=(0.0569619,'amu*angstrom^2'), symmetry=1, barrier=(11.2466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0569627,'amu*angstrom^2'), symmetry=1, barrier=(11.2466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123117,'amu*angstrom^2'), symmetry=1, barrier=(11.2466,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85657,0.0498138,-5.3121e-05,3.2786e-08,-8.50142e-12,15555.3,23.7928], Tmin=(100,'K'), Tmax=(919.627,'K')), NASAPolynomial(coeffs=[7.83662,0.0238046,-1.07e-05,2.03556e-09,-1.4243e-13,14455.3,-4.55677], Tmin=(919.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(CdCFH) + radical(Cdj(Cs-CsHH)(Cd-F1sH)) + radical(Cdj(Cd-CsH)(F1s))"""),
)

species(
    label = '[CH]=[C]CCOF(8843)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (443.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,3120,650,792.5,1650,299.17,299.175],'cm^-1')),
        HinderedRotor(inertia=(0.129456,'amu*angstrom^2'), symmetry=1, barrier=(8.22246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129459,'amu*angstrom^2'), symmetry=1, barrier=(8.22246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267596,'amu*angstrom^2'), symmetry=1, barrier=(16.9964,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53453,0.0581022,-7.36926e-05,5.37185e-08,-1.61746e-11,53377.5,22.6881], Tmin=(100,'K'), Tmax=(803.481,'K')), NASAPolynomial(coeffs=[8.21092,0.0248654,-1.16446e-05,2.23669e-09,-1.56557e-13,52304.6,-8.06094], Tmin=(803.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(F)CC[O](8844)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  O u1 p2 c0 {4,S}
3  C u0 p0 c0 {4,S} {5,S} {7,S} {8,S}
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC[C]=CF(8445)'],
    products = ['CH2O(20)', 'C=C=CF(5941)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=CF(1334)', '[CH2]C[O](144)'],
    products = ['[O]CC[C]=CF(8445)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](131)', 'C=C=CF(5941)'],
    products = ['[O]CC[C]=CF(8445)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2O(20)', 'C=[C][CH]F(5942)'],
    products = ['[O]CC[C]=CF(8445)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][O](131)', 'C=[C][CH]F(5942)'],
    products = ['[O]CC[C]=CF(8445)'],
