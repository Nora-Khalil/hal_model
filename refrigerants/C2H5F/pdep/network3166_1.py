...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.1732,'amu*angstrom^2'), symmetry=1, barrier=(26.9743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17327,'amu*angstrom^2'), symmetry=1, barrier=(26.9758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17367,'amu*angstrom^2'), symmetry=1, barrier=(26.9851,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0818,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789007,0.0554533,-5.66782e-05,2.73258e-08,-4.90151e-12,28441.7,18.3114], Tmin=(100,'K'), Tmax=(1571.18,'K')), NASAPolynomial(coeffs=[17.2645,0.0049612,-3.1306e-07,-5.30531e-11,5.8493e-15,24319.6,-65.2599], Tmin=(1571.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJCO)"""),
)
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238564,0.0776191,-8.50323e-05,4.59169e-08,-9.64582e-12,-523.34,23.1901], Tmin=(100,'K'), Tmax=(1168.32,'K')), NASAPolynomial(coeffs=[18.0491,0.0166409,-6.7428e-06,1.24344e-09,-8.65036e-14,-4685.03,-65.5062], Tmin=(1168.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.5138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCsCsFH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Csj(Cs-F1sCsH)(H)(H))"""),
)

species(
    label = 'C#CO[CH]CCF(10119)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.24915,0.0825816,-9.28907e-05,5.00183e-08,-1.02551e-11,-840.821,24.0216], Tmin=(100,'K'), Tmax=(1243.18,'K')), NASAPolynomial(coeffs=[21.7691,0.00979428,-2.72289e-06,4.08075e-10,-2.58398e-14,-6165.23,-86.3926], Tmin=(1243.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-8.34025,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(CsCsFHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOCs)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0645004,0.0771114,-8.43779e-05,4.36408e-08,-8.56601e-12,29837.1,24.5759], Tmin=(100,'K'), Tmax=(1318.47,'K')), NASAPolynomial(coeffs=[21.7171,0.00796872,-2.23287e-06,3.44356e-10,-2.25151e-14,24359.5,-85.5209], Tmin=(1318.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(246.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(CsCsFHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'FCC1CC=[C]O1(10121)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83507,0.0306603,4.22325e-05,-8.46052e-08,3.75077e-11,-13621.9,19.3838], Tmin=(100,'K'), Tmax=(915.675,'K')), NASAPolynomial(coeffs=[15.8635,0.0135081,-1.95888e-06,1.99603e-10,-1.53371e-14,-18041,-57.1612], Tmin=(915.675,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1CC(CF)O1(10122)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  O u0 p2 c0 {3,S} {6,S}
3  C u0 p0 c0 {2,S} {4,S} {5,S} {8,S}
...
"""),
    ...
    molecularWeight = (101.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17019,0.0439534,2.08118e-05,-7.36429e-08,3.63344e-11,-3898.1,19.0081], Tmin=(100,'K'), Tmax=(908.832,'K')), NASAPolynomial(coeffs=[20.4777,0.00747795,9.62426e-07,-3.61704e-10,2.34755e-14,-9410.63,-83.314], Tmin=(908.832,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(CsCsFHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(Cds_P)"""),
)
...
"""),
    E0 = (-33.9745,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,528,1116,1182,1331,1402,1494,3075,3110,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.904091,'amu*angstrom^2'), symmetry=1, barrier=(20.7868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.903842,'amu*angstrom^2'), symmetry=1, barrier=(20.7811,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50252,0.0483502,-4.18345e-05,1.43077e-08,-6.6351e-13,-3990.53,17.6866], Tmin=(100,'K'), Tmax=(1026.85,'K')), NASAPolynomial(coeffs=[14.1798,0.0106504,-3.83032e-06,7.143e-10,-5.16543e-14,-7210.04,-46.8093], Tmin=(1026.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.9745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(6.66666e+07,'s^-1'), n=1.2, Ea=(116.318,'kJ/mol'), T0=(1,'K'), Tmin=(500,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O',), comment="""Estimated from node Root_N-1R!H->C_N-5R!H->N_1BrClFINOPSSi->O_N-3R!H-inRing_N-5CO->O
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', 'C#COC[CH2](655)'],
    products = ['C#COC([CH2])CF(9899)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5.59914e-05,'m^3/(mol*s)'), n=3.10993, Ea=(22.4903,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CH_3Br1sCCl1sF1sHI1s->F1s_N-2Br1sCl1sF1sHI1s->F1s
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COC([CH2])F(718)'],
    products = ['C#COC([CH2])CF(9899)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(158.336,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['C#COC([CH2])CF(9899)'],
    products = ['C#COCC([CH2])F(9557)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', 'C#CO[CH]CF(1524)'],
    products = ['C#COC([CH2])CF(9899)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(6)', '[CH]C(CF)OC#C(10120)'],
    products = ['C#COC([CH2])CF(9899)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['HCCO(21)', '[CH2][CH]CF(2723)'],
    products = ['C#COC([CH2])CF(9899)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C2H(22)', '[CH2]C([O])CF(4494)'],
    products = ['C#COC([CH2])CF(9899)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'C#CO[CH][CH2](750)'],
    products = ['C#COC([CH2])CF(9899)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(6)', 'C#CO[C]([CH2])CF(10124)'],
    products = ['C#COC([CH2])CF(9899)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(6)', '[C]#COC([CH2])CF(10126)'],
    products = ['C#COC([CH2])CF(9899)'],
