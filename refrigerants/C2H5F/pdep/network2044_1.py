...
"""),
    E0 = (-421.495,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,323,467,575,827,1418,180,2376.86],'cm^-1')),
        HinderedRotor(inertia=(0.244656,'amu*angstrom^2'), symmetry=1, barrier=(5.62512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244674,'amu*angstrom^2'), symmetry=1, barrier=(5.62554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244532,'amu*angstrom^2'), symmetry=1, barrier=(5.62227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244519,'amu*angstrom^2'), symmetry=1, barrier=(5.62197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.620063,0.08395,-0.000133042,1.22778e-07,-4.47648e-11,-50581.7,28.0837], Tmin=(100,'K'), Tmax=(820.301,'K')), NASAPolynomial(coeffs=[5.80354,0.0404329,-2.01113e-05,3.88972e-09,-2.69949e-13,-50818.4,7.84399], Tmin=(820.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(CdCsCdF) + longDistanceInteraction_noncyclic(Cd(F)=CdOs)"""),
)

species(
    label = 'CCC(OF)=C(O)F(5781)',
    structure = adjacencyList("""1  F u0 p3 c0 {8,S}
2  F u0 p3 c0 {3,S}
...
"""),
    E0 = (-440.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,326,540,652,719,1357,338.782,339.279],'cm^-1')),
        HinderedRotor(inertia=(0.075788,'amu*angstrom^2'), symmetry=1, barrier=(6.2139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.07581,'amu*angstrom^2'), symmetry=1, barrier=(6.21394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0762011,'amu*angstrom^2'), symmetry=1, barrier=(6.21377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226119,'amu*angstrom^2'), symmetry=1, barrier=(18.3539,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
...
"""),
    E0 = (-153.045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,286,334,437,422,648,895,1187,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,243.623,243.623],'cm^-1')),
        HinderedRotor(inertia=(0.303761,'amu*angstrom^2'), symmetry=1, barrier=(12.7951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.300452,'amu*angstrom^2'), symmetry=1, barrier=(12.6542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00284031,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149535,'amu*angstrom^2'), symmetry=1, barrier=(6.29814,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.086,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.180754,0.0898742,-0.000122262,8.96647e-08,-2.65108e-11,-18274.8,28.3863], Tmin=(100,'K'), Tmax=(824.427,'K')), NASAPolynomial(coeffs=[12.3344,0.0309083,-1.49802e-05,2.91431e-09,-2.05223e-13,-20278.8,-27.9017], Tmin=(824.427,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(OF)C([CH2])(O)F(5783)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {14,S}
...
"""),
    E0 = (-176.145,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,316,385,515,654,689,1295,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,256.92,256.92],'cm^-1')),
...
"""),
    E0 = (-196.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.96947,'amu*angstrom^2'), symmetry=1, barrier=(22.29,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.96945,'amu*angstrom^2'), symmetry=1, barrier=(22.2896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.967052,'amu*angstrom^2'), symmetry=1, barrier=(22.2344,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0882,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58424,0.0570429,-6.05278e-05,3.65795e-08,-9.33519e-12,-23505.7,19.3228], Tmin=(100,'K'), Tmax=(929.166,'K')), NASAPolynomial(coeffs=[8.40659,0.0276728,-1.31136e-05,2.55993e-09,-1.81832e-13,-24773.5,-13.0898], Tmin=(929.166,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
"""),
    E0 = (-223.89,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,231,791,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.974916,'amu*angstrom^2'), symmetry=1, barrier=(22.4152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.974594,'amu*angstrom^2'), symmetry=1, barrier=(22.4078,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (123.078,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.224037,0.0896769,-0.000132251,1.05177e-07,-3.36623e-11,-26797.9,26.1423], Tmin=(100,'K'), Tmax=(763.74,'K')), NASAPolynomial(coeffs=[11.6068,0.0300623,-1.51697e-05,2.97946e-09,-2.0999e-13,-28536.7,-25.7054], Tmin=(763.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(CsCCFO) + longDistanceInteraction_noncyclic(Cs(F)-CdOs) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(OF)C(C)(O)F(5790)',
    structure = adjacencyList("""1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {4,S}
3  O u0 p2 c0 {5,S} {14,S}
4  O u0 p2 c0 {2,S} {6,S}
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(26.6826,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C[C]F(124)', 'C=C(O)OF(1265)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(183.565,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH3OH(26)', 'C=C([C]F)OF(1939)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.14358e+07,'m^3/(mol*s)'), n=-0.641018, Ea=(178.889,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.17570294811609, var=29.477358162589667, Tref=1000.0, N=2, data_mean=0.0, correlation='CO_2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_2Br1sCl1sF1sHI1s->F1s"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', 'C=C(OF)C(O)F(2869)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2O(3)', 'C=C(F)C(=C)OF(4762)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['C=C(OF)C(C)(O)F(5732)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(8.88952e+10,'s^-1'), n=0.725184, Ea=(301.694,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.005830439029566195, var=4.831276094152293, Tref=1000.0, N=2, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

reaction(
    label = 'reaction8',
    reactants = ['CC(F)=C(CO)OF(5780)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC(OF)=C(O)F(5781)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(3431.13,'s^-1'), n=2.77015, Ea=(375.502,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R!H-inRing_2R!H->C',), comment="""Estimated from node Root_N-1R!H-inRing_2R!H->C"""),
)

reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(OF)C(C)([O])F(5782)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(OF)C([CH2])(O)F(5783)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(O)(F)[C](C)OF(5784)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    label = 'reaction14',
    reactants = ['F(37)', '[CH2]C(OF)=C(C)O(3630)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(7)', 'C=C(OF)[C](C)F(1949)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C=C(OF)C(C)([O])F(5786)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]F(160)', 'C=[C]C(C)(O)F(5787)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(19)', '[CH2]C(OF)=C(O)F(3058)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=[C]OF(491)', 'C[C](O)F(1910)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(5)', '[CH2]C(O)(F)C(=C)OF(5788)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', '[CH]=C(OF)C(C)(O)F(5789)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C(OF)C(C)(O)F(5790)'],
    products = ['C=C(OF)C(C)(O)F(5732)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.109156,'m^3/(mol*s)'), n=1.86531, Ea=(162.065,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_N-3CdO2d->Cd_N-4COCdCddCtO2d->Cdd"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(228.971,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)

reaction(
    label = 'reaction26',
    reactants = ['C=C(OF)C(C)(O)F(5732)'],
    products = ['HF(38)', 'CH2CO(28)', 'C=C(O)F(498)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(52.5991,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 3.0"""),
)

network(
    label = 'PDepNetwork #2044',
    isomers = [
        'C=C(OF)C(C)(O)F(5732)',
    ],
    reactants = [
