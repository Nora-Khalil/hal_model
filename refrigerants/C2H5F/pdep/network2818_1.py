...
"""),
    E0 = (-407.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,519,593,830,1115,1166,1389,1413,3114,2175,525,750,770,3400,2100,180,180,2825.63],'cm^-1')),
        HinderedRotor(inertia=(0.655583,'amu*angstrom^2'), symmetry=1, barrier=(15.0731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.39511,'amu*angstrom^2'), symmetry=1, barrier=(55.0683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.39417,'amu*angstrom^2'), symmetry=1, barrier=(55.0466,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5904,0.0575057,-6.7046e-05,3.94751e-08,-6.73225e-12,-48879.6,21.1091], Tmin=(100,'K'), Tmax=(648.202,'K')), NASAPolynomial(coeffs=[8.3043,0.0246361,-1.07946e-05,1.99743e-09,-1.36526e-13,-49929.9,-9.75808], Tmin=(648.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-407.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CtOsHH) + group(CsFFHO) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (154.905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2175,525,750,770,3400,2100,180],'cm^-1')),
        HinderedRotor(inertia=(0.650471,'amu*angstrom^2'), symmetry=1, barrier=(14.9556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.364162,'amu*angstrom^2'), symmetry=1, barrier=(38.4389,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.86326,0.010159,0.000104994,-2.97179e-07,2.4515e-10,18630.7,10.351], Tmin=(10,'K'), Tmax=(417.614,'K')), NASAPolynomial(coeffs=[4.25773,0.0252273,-1.68225e-05,5.34976e-09,-6.46998e-13,18433.4,6.82468], Tmin=(417.614,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(154.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), label="""C#CCOF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.400072,'amu*angstrom^2'), symmetry=1, barrier=(9.19843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.400331,'amu*angstrom^2'), symmetry=1, barrier=(9.2044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.400709,'amu*angstrom^2'), symmetry=1, barrier=(9.21309,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.804803,0.0801114,-0.000140953,1.29423e-07,-4.53529e-11,-25671.5,22.5454], Tmin=(100,'K'), Tmax=(857.251,'K')), NASAPolynomial(coeffs=[7.44707,0.0284119,-1.42592e-05,2.71933e-09,-1.85296e-13,-26049.5,-4.039], Tmin=(857.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cd)OsHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#CCOC(F)F(7489)'],
    products = ['CF2O(49)', 'C=C=C(6556)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.66316e+09,'s^-1'), n=1.02661, Ea=(204.728,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=3.6261064499336317, var=38.37240951049941, Tref=1000.0, N=4, data_mean=0.0, correlation='Root_1R!H->C_N-2R!H->C',), comment="""Estimated from node Root_1R!H->C_N-2R!H->C"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COC(F)F(4377)'],
    products = ['C#CCOC(F)F(7489)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(137.271,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CF2(43)', 'C#CCO(7040)'],
    products = ['C#CCOC(F)F(7489)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHF(40)', 'C#CCOF(8240)'],
    products = ['C#CCOC(F)F(7489)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.13916e+09,'m^3/(mol*s)'), n=-1.00842, Ea=(10.5426,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17406617270594374, var=16.167420070870673, Tref=1000.0, N=4, data_mean=0.0, correlation='OHOY',), comment="""Estimated from node OHOY"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['C2H(22)', '[CH2]OC(F)F(3330)'],
    products = ['C#CCOC(F)F(7489)'],
    transitionState = 'TS8',
