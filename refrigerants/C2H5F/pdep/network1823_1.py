...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96682,0.0309123,2.05224e-05,-5.2789e-08,2.32888e-11,-28476.3,16.1448], Tmin=(100,'K'), Tmax=(964.472,'K')), NASAPolynomial(coeffs=[14.4907,0.0129074,-4.25462e-06,8.19847e-10,-6.36592e-14,-32470.4,-52.0054], Tmin=(964.472,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCCFO) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cd-Cd-O2s-Cs(F))"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.05999,'amu*angstrom^2'), symmetry=1, barrier=(24.3713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05795,'amu*angstrom^2'), symmetry=1, barrier=(24.3244,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31135,0.0621395,-7.57809e-05,4.88151e-08,-1.26601e-11,3066.26,20.8624], Tmin=(100,'K'), Tmax=(935.722,'K')), NASAPolynomial(coeffs=[10.9097,0.0211074,-1.00025e-05,1.94881e-09,-1.38189e-13,1270.06,-24.8058], Tmin=(935.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.7104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C(C)(O)F(5225)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u0 p2 c0 {3,S} {10,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {5,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.999227,'amu*angstrom^2'), symmetry=1, barrier=(22.9742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00092,'amu*angstrom^2'), symmetry=1, barrier=(23.0132,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37353,0.0622358,-8.33112e-05,6.23992e-08,-1.91164e-11,6219.95,20.4784], Tmin=(100,'K'), Tmax=(792.519,'K')), NASAPolynomial(coeffs=[8.85075,0.0244972,-1.18842e-05,2.31545e-09,-1.63205e-13,5034.77,-13.8562], Tmin=(792.519,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.9631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C([O])(F)C=C(5226)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {3,S}
2  O u1 p2 c0 {3,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {5,S}
...
"""),
    ...
    molecularWeight = (88.0802,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5538,0.0546519,-5.37134e-05,2.74625e-08,-5.71975e-12,1046.55,19.3899], Tmin=(100,'K'), Tmax=(1143.14,'K')), NASAPolynomial(coeffs=[11.0862,0.0212972,-9.94677e-06,1.93858e-09,-1.37834e-13,-1132.85,-27.8736], Tmin=(1143.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(CsCCFO) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH]C=C(C)OF(5227)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (284.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([231,791,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,435.307,435.307,435.308,435.309],'cm^-1')),
        HinderedRotor(inertia=(0.389713,'amu*angstrom^2'), symmetry=1, barrier=(52.4043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.389715,'amu*angstrom^2'), symmetry=1, barrier=(52.4045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.389713,'amu*angstrom^2'), symmetry=1, barrier=(52.4044,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0802,'amu'),
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](135)', 'C[C]([O])F(1344)'],
    products = ['[CH]=CC(C)([O])F(5118)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(316.801,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction13',
    reactants = ['[CH]=CC(C)([O])F(5118)'],
    products = ['C=[C]C(C)([O])F(5223)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(141.867,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
