...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[C]=O(156)', '[CH]C-2(137)'],
    products = ['C[CH]OC[C]=O(481)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(126)', '[CH2]O[CH]C(591)'],
    products = ['C[CH]OC[C]=O(481)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(13)', '[CH2]O[CH]C(591)'],
    products = ['C[CH]OC[C]=O(481)'],
    transitionState = 'TS7',
