...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]=C(F)C#C(2637)'],
    products = ['[CH]=C(F)C(=[CH])F(2757)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['F2(77)', '[CH]=C=C=[CH](2638)'],
    products = ['[CH]=C(F)C(=[CH])F(2757)'],
    transitionState = 'TS6',
