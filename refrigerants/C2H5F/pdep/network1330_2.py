...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'F[C]C=C(F)F(4384)'],
    products = ['F[C]=CC(F)F(3450)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'F[C]=[C]C(F)F(4385)'],
    products = ['F[C]=CC(F)F(3450)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HF(38)', 'FC#C[CH]F(4386)'],
    products = ['F[C]=CC(F)F(3450)'],
...
reaction(
    label = 'reaction12',
    reactants = ['F[C]=CC(F)F(3450)'],
    products = ['F[CH]C=C(F)F(4388)'],
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', '[CH]C=C(F)F(4372)'],
    products = ['F[CH]C=C(F)F(4388)'],
...
reaction(
    label = 'reaction16',
    reactants = ['F[CH]C=C(F)F(4388)'],
    products = ['FC1[CH]C1(F)F(5933)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'F[CH][C]=C(F)F(5935)'],
    products = ['F[CH]C=C(F)F(4388)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(5)', 'F[C]C=C(F)F-2(5936)'],
    products = ['F[CH]C=C(F)F(4388)'],
...
reaction(
    label = 'reaction24',
    reactants = ['F[C]F(3442)', 'CHFCH[Z](70)'],
    products = ['F[CH]C=C(F)F(4388)'],
...
reaction(
    label = 'reaction25',
    reactants = ['HF(38)', 'C#C[C](F)F(4968)'],
    products = ['F[CH]C=C(F)F(4388)'],
...
reaction(
    label = 'reaction26',
    reactants = ['F(37)', 'F[C]C=CF-2(5938)'],
    products = ['F[CH]C=C(F)F(4388)'],
