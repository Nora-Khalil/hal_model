...
"""),
    E0 = (-312.593,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,237.277,239.081,245.443],'cm^-1')),
        HinderedRotor(inertia=(0.124306,'amu*angstrom^2'), symmetry=1, barrier=(5.36266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129602,'amu*angstrom^2'), symmetry=1, barrier=(5.34252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12929,'amu*angstrom^2'), symmetry=1, barrier=(5.32498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588135,'amu*angstrom^2'), symmetry=1, barrier=(23.1217,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.553585,0.0838961,-0.000138283,1.21654e-07,-4.17508e-11,-37480,26.2257], Tmin=(100,'K'), Tmax=(835.689,'K')), NASAPolynomial(coeffs=[9.13642,0.0288286,-1.43368e-05,2.74973e-09,-1.89092e-13,-38426.1,-10.7189], Tmin=(835.689,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-312.593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26318,0.0628522,-7.92675e-05,5.33172e-08,-1.43758e-11,15719.8,23.428], Tmin=(100,'K'), Tmax=(904.079,'K')), NASAPolynomial(coeffs=[10.7857,0.0207221,-9.36936e-06,1.77582e-09,-1.23671e-13,13997.9,-21.5524], Tmin=(904.079,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.000743342,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.80792e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0754894,'amu*angstrom^2'), symmetry=1, barrier=(12.357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000731211,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.790351,0.076051,-0.000118038,9.7437e-08,-3.198e-11,-16315.9,24.6687], Tmin=(100,'K'), Tmax=(790.312,'K')), NASAPolynomial(coeffs=[10.5339,0.0233557,-1.16074e-05,2.24571e-09,-1.5613e-13,-17750.4,-19.3775], Tmin=(790.312,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-68.9161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,334,575,1197,1424,3202,572.548,574.483],'cm^-1')),
        HinderedRotor(inertia=(0.0854813,'amu*angstrom^2'), symmetry=1, barrier=(19.8155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0855359,'amu*angstrom^2'), symmetry=1, barrier=(19.8199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0858294,'amu*angstrom^2'), symmetry=1, barrier=(19.8136,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
...
"""),
    E0 = (-86.8882,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,334,575,1197,1424,3202,180,180,180,799.024],'cm^-1')),
        HinderedRotor(inertia=(0.167888,'amu*angstrom^2'), symmetry=1, barrier=(3.86007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16897,'amu*angstrom^2'), symmetry=1, barrier=(3.88495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168971,'amu*angstrom^2'), symmetry=1, barrier=(3.88497,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.88422,0.0815491,-0.000152112,1.48952e-07,-5.49105e-11,-10350.6,25.8977], Tmin=(100,'K'), Tmax=(850.492,'K')), NASAPolynomial(coeffs=[4.50994,0.0351311,-1.8454e-05,3.58482e-09,-2.46858e-13,-9905.25,15.2366], Tmin=(850.492,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.8882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(CCOJ) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-132.489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,557,1111,2750,2850,1437.5,1250,1305,750,350,360,370,350,334,575,1197,1424,3202,180,180,1182.68],'cm^-1')),
        HinderedRotor(inertia=(0.288113,'amu*angstrom^2'), symmetry=1, barrier=(6.62428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288062,'amu*angstrom^2'), symmetry=1, barrier=(6.62312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288063,'amu*angstrom^2'), symmetry=1, barrier=(6.62315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288109,'amu*angstrom^2'), symmetry=1, barrier=(6.62418,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.535919,0.090167,-0.000173599,1.65778e-07,-5.89347e-11,-15823.3,26.7091], Tmin=(100,'K'), Tmax=(872.453,'K')), NASAPolynomial(coeffs=[6.53999,0.030519,-1.58218e-05,3.01676e-09,-2.0386e-13,-15648.5,5.56814], Tmin=(872.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(C2CsJO) + radical(Csj(Cs-O2sCsH)(F1s)(H))"""),
)
...
"""),
    E0 = (-140.661,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,617,898,1187,256.653,263.31],'cm^-1')),
        HinderedRotor(inertia=(0.146323,'amu*angstrom^2'), symmetry=1, barrier=(6.59242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151771,'amu*angstrom^2'), symmetry=1, barrier=(6.6015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13534,'amu*angstrom^2'), symmetry=1, barrier=(6.62242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519321,'amu*angstrom^2'), symmetry=1, barrier=(23.544,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
...
"""),
    ...
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.482561,0.0827715,-0.000126741,1.02722e-07,-3.29839e-11,-39189.6,25.7069], Tmin=(100,'K'), Tmax=(805.344,'K')), NASAPolynomial(coeffs=[11.543,0.0244218,-1.17015e-05,2.22729e-09,-1.53353e-13,-40860.4,-24.5714], Tmin=(805.344,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFHH) + radical(CCsJOH)"""),
)
...
"""),
    ...
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11765,0.0669141,-8.08331e-05,5.29914e-08,-1.41162e-11,-76007.7,24.3117], Tmin=(100,'K'), Tmax=(908.844,'K')), NASAPolynomial(coeffs=[10.6404,0.0250023,-1.16598e-05,2.25041e-09,-1.58578e-13,-77738.7,-20.72], Tmin=(908.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-632.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(CsCsFFH) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OCC([CH]F)OF(3774)'],
    products = ['HF(38)', 'CH2O(20)', 'O=C[CH]F(414)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00285451,'s^-1'), n=4.62568, Ea=(36.3275,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'OC([CH]F)OF(3806)'],
    products = ['OCC([CH]F)OF(3774)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.26474e-05,'m^3/(mol*s)'), n=2.95311, Ea=(66.3276,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='CO_N-2Br1sCl1sF1sHI1s->F1s',), comment="""Estimated from node CO_N-2Br1sCl1sF1sHI1s->F1s"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', '[CH]C(CO)OF-2(4021)'],
    products = ['OCC([CH]F)OF(3774)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]F(837)', 'OC[CH]OF(1239)'],
    products = ['OCC([CH]F)OF(3774)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]F(160)', 'OC[CH][CH]F(990)'],
    products = ['OCC([CH]F)OF(3774)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(7)', '[CH2]C([CH]F)OF(2902)'],
    products = ['OCC([CH]F)OF(3774)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[O]CC([CH]F)OF(4024)'],
    products = ['OCC([CH]F)OF(3774)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2OH(33)', 'F[CH][CH]OF(1775)'],
    products = ['OCC([CH]F)OF(3774)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'OC[C]([CH]F)OF(4025)'],
    products = ['OCC([CH]F)OF(3774)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'O[CH]C([CH]F)OF(4026)'],
    products = ['OCC([CH]F)OF(3774)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', '[O]C(=CF)CO(4027)'],
    products = ['OCC([CH]F)OF(3774)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(2676.63,'m^3/(mol*s)'), n=0.732206, Ea=(478.31,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.13214706218215122, var=14.38614219007748, Tref=1000.0, N=10, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction18',
    reactants = ['CHF(40)', 'OC[CH]OF(1239)'],
    products = ['OCC([CH]F)OF(3774)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', 'OCC([C]F)OF-2(4028)'],
    products = ['OCC([CH]F)OF(3774)'],
