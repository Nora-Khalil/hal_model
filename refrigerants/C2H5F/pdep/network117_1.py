...
reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'F[C]COF(362)'],
    products = ['CC(F)COF(313)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'CC(F)OF(363)'],
    products = ['CC(F)COF(313)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(357)', '[CH2]C(C)F(369)'],
    products = ['CC(F)COF(313)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]OF(278)', 'CH3-CHF(62)'],
    products = ['CC(F)COF(313)'],
