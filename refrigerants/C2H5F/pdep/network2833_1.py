...
reaction(
    label = 'reaction6',
    reactants = ['FOF(1637)', 'C=C(O)F(498)'],
    products = ['OC(F)(F)COF(7504)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2O(3)', 'FOC=C(F)F(7980)'],
    products = ['OC(F)(F)COF(7504)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', '[O]CC(O)(F)F(8022)'],
    products = ['OC(F)(F)COF(7504)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]F(160)', '[CH2]C(O)(F)F(1356)'],
    products = ['OC(F)(F)COF(7504)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(F)(F)COF(8023)'],
    products = ['OC(F)(F)COF(7504)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O[C](F)F(4999)', '[CH2]OF(396)'],
    products = ['OC(F)(F)COF(7504)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', 'OC(F)(F)[CH]OF(7981)'],
    products = ['OC(F)(F)COF(7504)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'O=C(F)COF(8024)'],
    products = ['OC(F)(F)COF(7504)'],
...
reaction(
    label = 'reaction16',
    reactants = ['HF(38)', 'O=CC(O)(F)F(7722)'],
    products = ['OC(F)(F)COF(7504)'],
