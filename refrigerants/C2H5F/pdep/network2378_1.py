...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02874,0.0297181,3.35638e-05,-7.1247e-08,3.22793e-11,17025.7,21.802], Tmin=(100,'K'), Tmax=(900.177,'K')), NASAPolynomial(coeffs=[13.4977,0.0150517,-2.47965e-06,2.39744e-10,-1.43214e-14,13490.3,-40.4915], Tmin=(900.177,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Tetrahydrofuran) + radical(CCJCO) + radical(Cs_P)"""),
)
...
"""),
    E0 = (100.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,334.487,334.488,334.492,1463.26],'cm^-1')),
        HinderedRotor(inertia=(0.488536,'amu*angstrom^2'), symmetry=1, barrier=(38.7878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.488532,'amu*angstrom^2'), symmetry=1, barrier=(38.7878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24781,'amu*angstrom^2'), symmetry=1, barrier=(19.675,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42073,0.0622976,-6.5246e-05,3.84774e-08,-9.70584e-12,12181.5,23.4497], Tmin=(100,'K'), Tmax=(930.703,'K')), NASAPolynomial(coeffs=[8.53004,0.0317429,-1.60012e-05,3.20292e-09,-2.30585e-13,10858.2,-10.338], Tmin=(930.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CCJCO)"""),
)

species(
    label = 'C=[C]CC([O])OF(6969)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
...
"""),
    E0 = (221.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2950,3100,1380,975,1025,1650,1685,370,310.406,310.41,310.419,2315.41],'cm^-1')),
        HinderedRotor(inertia=(0.0870754,'amu*angstrom^2'), symmetry=1, barrier=(5.95581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.087125,'amu*angstrom^2'), symmetry=1, barrier=(5.95568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.388549,'amu*angstrom^2'), symmetry=1, barrier=(26.5678,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22976,0.0677254,-0.000100829,9.10419e-08,-3.34958e-11,26730.4,27.3876], Tmin=(100,'K'), Tmax=(782.69,'K')), NASAPolynomial(coeffs=[5.81815,0.0341918,-1.72369e-05,3.37952e-09,-2.37493e-13,26321,8.34877], Tmin=(782.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C[C](O)OF(6970)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (201.016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,2950,3100,1380,975,1025,1650,1685,370,180,426.525,426.667],'cm^-1')),
        HinderedRotor(inertia=(0.0818227,'amu*angstrom^2'), symmetry=1, barrier=(10.5648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0818054,'amu*angstrom^2'), symmetry=1, barrier=(10.5649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0818069,'amu*angstrom^2'), symmetry=1, barrier=(10.5646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0113296,'amu*angstrom^2'), symmetry=1, barrier=(1.46285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07857,0.0689197,-8.97278e-05,6.40143e-08,-1.85886e-11,24277.7,27.7724], Tmin=(100,'K'), Tmax=(835.81,'K')), NASAPolynomial(coeffs=[10.064,0.0259156,-1.25465e-05,2.44973e-09,-1.73206e-13,22775.7,-13.9652], Tmin=(835.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCC([O])OF(6971)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {5,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (230.729,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,286.868,290.133,2002.3],'cm^-1')),
        HinderedRotor(inertia=(0.133139,'amu*angstrom^2'), symmetry=1, barrier=(8.01558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135538,'amu*angstrom^2'), symmetry=1, barrier=(8.0855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.421897,'amu*angstrom^2'), symmetry=1, barrier=(26.2186,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60702,0.060387,-6.23937e-05,2.15058e-08,9.12978e-12,27828.9,26.0366], Tmin=(100,'K'), Tmax=(540.666,'K')), NASAPolynomial(coeffs=[6.89398,0.0325306,-1.63434e-05,3.23612e-09,-2.30315e-13,27092.7,2.25959], Tmin=(540.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC[C](O)OF(6972)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {5,S}
...
"""),
    E0 = (210.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,630.919],'cm^-1')),
        HinderedRotor(inertia=(0.549341,'amu*angstrom^2'), symmetry=1, barrier=(12.6304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0447109,'amu*angstrom^2'), symmetry=1, barrier=(12.6139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0352336,'amu*angstrom^2'), symmetry=1, barrier=(2.89816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.549001,'amu*angstrom^2'), symmetry=1, barrier=(12.6226,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07775,0.0673944,-8.01123e-05,5.02397e-08,-1.27103e-11,25392.3,27.7032], Tmin=(100,'K'), Tmax=(957.141,'K')), NASAPolynomial(coeffs=[11.616,0.023354,-1.10937e-05,2.16691e-09,-1.53994e-13,23375,-22.6759], Tmin=(957.141,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cds_P)"""),
)

species(
    label = 'C=CC=C(O)OF(6973)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {6,S}
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.854728,'amu*angstrom^2'), symmetry=1, barrier=(19.6519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.854693,'amu*angstrom^2'), symmetry=1, barrier=(19.6511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.854287,'amu*angstrom^2'), symmetry=1, barrier=(19.6417,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.463823,0.0721262,-8.28725e-05,4.68713e-08,-1.02137e-11,-13603.1,22.7995], Tmin=(100,'K'), Tmax=(1134.93,'K')), NASAPolynomial(coeffs=[17.331,0.012679,-4.30332e-06,7.19334e-10,-4.7492e-14,-17431.8,-60.7097], Tmin=(1134.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67037,0.056832,-5.20511e-05,2.8908e-08,-7.32587e-12,8759.46,31.675], Tmin=(100,'K'), Tmax=(896.284,'K')), NASAPolynomial(coeffs=[6.23372,0.0364663,-1.79673e-05,3.55597e-09,-2.54402e-13,7941.45,10.1591], Tmin=(896.284,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.1722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]CCC(=O)OF(6979)',
    structure = adjacencyList("""1  F u0 p3 c0 {2,S}
2  O u0 p2 c0 {1,S} {6,S}
3  O u0 p2 c0 {6,D}
4  C u0 p0 c0 {5,S} {6,S} {8,S} {9,S}
...
"""),
    ...
    molecularWeight = (104.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23268,0.0671886,-9.48629e-05,8.41683e-08,-3.12664e-11,11257,23.1881], Tmin=(100,'K'), Tmax=(750.095,'K')), NASAPolynomial(coeffs=[5.77958,0.0359157,-1.82751e-05,3.61167e-09,-2.55699e-13,10772.5,3.87689], Tmin=(750.095,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.8178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsCsHH) + group(Cds-OdCsOs) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=CCC(=O)OF(2988)'],
    products = ['HF(38)', 'CO2(14)', 'C=C=C(6556)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C[CH]C(=O)OF(6967)'],
    products = ['C=CCC(=O)OF(2988)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction14',
    reactants = ['[O]F(160)', 'C=CC[C]=O(451)'],
    products = ['C=CCC(=O)OF(2988)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C]OF(331)', '[CH2]C=C(2401)'],
    products = ['C=CCC(=O)OF(2988)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C=C[CH]C(=O)OF(6975)'],
    products = ['C=CCC(=O)OF(2988)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', 'C=[C]CC(=O)OF(6976)'],
    products = ['C=CCC(=O)OF(2988)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH]=CCC(=O)OF(6977)'],
    products = ['C=CCC(=O)OF(2988)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=CCC(=O)OF(2988)'],
    products = ['C2H2(23)', 'C=C(O)OF(1265)'],
...
network(
    label = 'PDepNetwork #2378',
    isomers = [
        'C=CCC(=O)OF(2988)',
    ],
    reactants = [
        ('HF(38)', 'CO2(14)', 'C=C=C(6556)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
