...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.258049,'amu*angstrom^2'), symmetry=1, barrier=(5.93304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.258021,'amu*angstrom^2'), symmetry=1, barrier=(5.93241,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['HO2(11)', 'C2H4(30)'],
    products = ['[CH2]COO(154)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(71.2,'cm^3/(mol*s)'), n=3.22, Ea=(46.4424,'kJ/mol'), T0=(1,'K'), Tmin=(400,'K'), Tmax=(1100,'K'), comment="""Matched reaction 2769 HO2 + C2H4 <=> C2H5O2 in R_Addition_MultipleBond/training
This reaction matched rate rule [Root_N-3R-inRing_Ext-3R-R_N-Sp-4R!H=3R_N-3R->C_N-2R!H->O_4R!H-u0_N-4R!H->S_3OS->O_Sp-2CNS=1R!H_N-4CO->C]
family: R_Addition_MultipleBond"""),
)

reaction(
    label = 'reaction2',
    reactants = ['H(6)', '[CH]COO(168)'],
    products = ['[CH2]COO(154)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]COO(154)'],
    products = ['OH(5)', 'C1CO1(169)'],
    transitionState = 'TS3',
...
reaction(
    ...
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(619935,'s^-1'), n=2.08546, Ea=(132.285,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2H_S;C_rad_out_2H;Cs_H_out] for rate rule [R2H_S;C_rad_out_2H;Cs_H_out_OOH/H]
