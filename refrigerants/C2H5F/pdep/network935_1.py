...
reaction(
    label = 'reaction2',
    reactants = ['[CH]F(837)', '[CH]=C[O](132)'],
    products = ['[CH]=CO[CH]F(2036)'],
    transitionState = 'TS2',
