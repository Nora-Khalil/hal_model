...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08683,0.0698584,-0.000109944,9.34767e-08,-3.12004e-11,-33868,21.9648], Tmin=(100,'K'), Tmax=(841.282,'K')), NASAPolynomial(coeffs=[8.81453,0.02381,-1.12477e-05,2.11721e-09,-1.44288e-13,-34838.9,-12.0241], Tmin=(841.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C(O)(F)C[O](5231)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {11,S}
3  O u1 p2 c0 {5,S}
...
"""),
    E0 = (-260.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.92936,'amu*angstrom^2'), symmetry=1, barrier=(44.3598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.324807,'amu*angstrom^2'), symmetry=1, barrier=(7.46796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00135232,'amu*angstrom^2'), symmetry=1, barrier=(7.47409,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22438,0.0712635,-0.000124906,1.20145e-07,-4.41919e-11,-31194.3,21.8886], Tmin=(100,'K'), Tmax=(842.825,'K')), NASAPolynomial(coeffs=[4.66225,0.032702,-1.66862e-05,3.22714e-09,-2.22567e-13,-30983.7,10.578], Tmin=(842.825,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)

species(
    label = 'CC(O)(F)[CH][O](5232)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {4,S} {11,S}
3  O u1 p2 c0 {6,S}
...
"""),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18264,0.0700966,-0.000116268,1.0691e-07,-3.83183e-11,-34865.5,21.3379], Tmin=(100,'K'), Tmax=(831.748,'K')), NASAPolynomial(coeffs=[6.3106,0.0296667,-1.49176e-05,2.88179e-09,-1.9922e-13,-35173.1,0.822086], Tmin=(831.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-290.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C([O])(F)CO(5233)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {4,S}
...
"""),
    ...
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,316,385,515,654,689,1295,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.171771,'amu*angstrom^2'), symmetry=1, barrier=(3.94936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172801,'amu*angstrom^2'), symmetry=1, barrier=(3.97303,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12805,0.0710338,-0.000118626,1.06797e-07,-3.71285e-11,-30196.8,22.5172], Tmin=(100,'K'), Tmax=(853.392,'K')), NASAPolynomial(coeffs=[7.16102,0.0268542,-1.30215e-05,2.46382e-09,-1.67739e-13,-30647.5,-2.23932], Tmin=(853.392,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(CsCCFO) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(O2sj(Cs-F1sCsCs)) + radical(Csj(Cs-F1sO2sCs)(H)(H))"""),
)
...
"""),
    E0 = (88.6747,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,293.377,294.18,294.241],'cm^-1')),
        HinderedRotor(inertia=(0.0764312,'amu*angstrom^2'), symmetry=1, barrier=(4.69729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0765001,'amu*angstrom^2'), symmetry=1, barrier=(4.69777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209294,'amu*angstrom^2'), symmetry=1, barrier=(12.8498,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5522,0.0608713,-7.17875e-05,3.21022e-08,4.41911e-12,10746.5,20.6721], Tmin=(100,'K'), Tmax=(570.389,'K')), NASAPolynomial(coeffs=[8.5468,0.0249314,-1.17543e-05,2.2366e-09,-1.54599e-13,9735.26,-11.0154], Tmin=(570.389,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.6747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2sCF) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['O(6)', '[CH2]C(C)([O])F(1498)'],
    products = ['CC([O])(F)C[O](5113)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'C=C([O])C[O](365)'],
    products = ['CC([O])(F)C[O](5113)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(25.0352,'m^3/(mol*s)'), n=1.25316, Ea=(258.09,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F',), comment="""Estimated from node HF_N-3COCdCddCtO2d->Ct_3CdO2d->Cd_Ext-4COCdCddCtO2d-R_N-5R!H->F"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(281.116,'m^3/(mol*s)'), n=1.03051, Ea=(362.848,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.17160344105964337, var=17.74244203879562, Tref=1000.0, N=7, data_mean=0.0, correlation='HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R',), comment="""Estimated from node HF_Ext-3COCdCddCtO2d-R_Ext-4COCdCddCtO2d-R"""),
)

reaction(
    label = 'reaction15',
    reactants = ['CC([O])(F)C[O](5113)'],
    products = ['CC([O])(F)[CH]O(5230)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[C]([O])COF(5234)'],
    products = ['CC([O])(F)C[O](5113)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(0.00930803,'s^-1'), n=4.16824, Ea=(97.2309,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R3F',), comment="""Estimated from node R3F"""),
)
