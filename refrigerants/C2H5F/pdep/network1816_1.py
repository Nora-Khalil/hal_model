...
"""),
    E0 = (-376.053,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,2175,525,750,770,3400,2100,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.46124,'amu*angstrom^2'), symmetry=1, barrier=(33.5968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45915,'amu*angstrom^2'), symmetry=1, barrier=(33.5486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.46141,'amu*angstrom^2'), symmetry=1, barrier=(33.6007,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.659993,0.0622126,-4.76801e-05,5.54967e-09,5.13491e-12,-45098.4,19.6071], Tmin=(100,'K'), Tmax=(983.853,'K')), NASAPolynomial(coeffs=[19.9476,0.0083345,-2.94873e-06,5.90101e-10,-4.65598e-14,-50081.2,-79.1663], Tmin=(983.853,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-376.053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (-108.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([548,1085,1183,1302,1466,1520,3060,3119,2175,525,750,770,3400,2100,255.585,255.588],'cm^-1')),
        HinderedRotor(inertia=(0.319966,'amu*angstrom^2'), symmetry=1, barrier=(14.8327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.837062,'amu*angstrom^2'), symmetry=1, barrier=(38.8032,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (74.0536,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.88224,0.00836994,0.000108694,-2.97808e-07,2.39942e-10,-13074.6,10.9506], Tmin=(10,'K'), Tmax=(429.392,'K')), NASAPolynomial(coeffs=[4.47055,0.0232987,-1.47529e-05,4.54652e-09,-5.41235e-13,-13313.3,6.41876], Tmin=(429.392,'K'), Tmax=(3000,'K'))], Tmin=(10,'K'), Tmax=(3000,'K'), E0=(-108.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), label="""C#COCF""", comment="""Thermo library: CHOF_G4"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.49644,'amu*angstrom^2'), symmetry=1, barrier=(34.4061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49695,'amu*angstrom^2'), symmetry=1, barrier=(34.4178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49655,'amu*angstrom^2'), symmetry=1, barrier=(34.4087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.055,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.596362,0.0645868,-7.48926e-05,3.9609e-08,-7.87515e-12,-2783.72,20.7797], Tmin=(100,'K'), Tmax=(1302.63,'K')), NASAPolynomial(coeffs=[19.9861,0.00253978,-5.58147e-07,8.85757e-11,-6.90526e-15,-7622.61,-77.0749], Tmin=(1302.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + group(CJ2_singlet-FCs) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (-386.522,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,2175,525,750,770,3400,2100,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.23818,'amu*angstrom^2'), symmetry=1, barrier=(28.4681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23302,'amu*angstrom^2'), symmetry=1, barrier=(28.3495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23062,'amu*angstrom^2'), symmetry=1, barrier=(28.2945,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3077.95,'J/mol'), sigma=(5.18068,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=480.77 K, Pc=50.23 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.460498,0.0697097,-7.72046e-05,4.07283e-08,-8.22476e-12,-46353.4,20.5724], Tmin=(100,'K'), Tmax=(1225.46,'K')), NASAPolynomial(coeffs=[18.9112,0.00948483,-3.48708e-06,6.24797e-10,-4.33911e-14,-50875.5,-72.1927], Tmin=(1225.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-386.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsCsFFH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    E0 = (-177.412,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([487,638,688,1119,1325,1387,3149,334,575,1197,1424,3202,2175,525,750,770,3400,2100,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.43833,'amu*angstrom^2'), symmetry=1, barrier=(33.07,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43423,'amu*angstrom^2'), symmetry=1, barrier=(32.9757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.43908,'amu*angstrom^2'), symmetry=1, barrier=(33.0872,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.285481,0.0719987,-8.45113e-05,4.57499e-08,-9.35483e-12,-21195.7,21.3056], Tmin=(100,'K'), Tmax=(1231.04,'K')), NASAPolynomial(coeffs=[20.8939,0.00435236,-1.25256e-06,2.10267e-10,-1.50403e-14,-26217.9,-82.1916], Tmin=(1231.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(Ct-CtH) + radical(Csj(Cs-F1sO2sH)(F1s)(H))"""),
)

species(
    label = '[C]#COC(F)CF(22062)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {6,S}
...
"""),
    E0 = (-38.9089,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,2175,525,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.495,'amu*angstrom^2'), symmetry=1, barrier=(34.373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49646,'amu*angstrom^2'), symmetry=1, barrier=(34.4066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49596,'amu*angstrom^2'), symmetry=1, barrier=(34.3951,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (105.063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.493659,0.0679534,-7.77667e-05,4.18992e-08,-8.56589e-12,-4545.59,20.948], Tmin=(100,'K'), Tmax=(1244.44,'K')), NASAPolynomial(coeffs=[19.2065,0.00636883,-1.80437e-06,2.77791e-10,-1.815e-14,-9091.82,-72.9763], Tmin=(1244.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-38.9089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)

species(
    label = '[C]=COC(F)CF(22063)',
    structure = adjacencyList("""1  F u0 p3 c0 {4,S}
2  F u0 p3 c0 {5,S}
3  O u0 p2 c0 {4,S} {6,S}
4  C u0 p0 c0 {1,S} {3,S} {5,S} {8,S}
...
"""),
    E0 = (-199.423,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([261,493,600,1152,1365,1422,3097,528,1116,1182,1331,1402,1494,3075,3110,3010,987.5,1337.5,450,1655,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.1586,'amu*angstrom^2'), symmetry=1, barrier=(26.6385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15808,'amu*angstrom^2'), symmetry=1, barrier=(26.6266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1601,'amu*angstrom^2'), symmetry=1, barrier=(26.6729,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.861833,0.0701045,-8.33035e-05,4.92802e-08,-1.15044e-11,-23872.8,19.9827], Tmin=(100,'K'), Tmax=(1044.18,'K')), NASAPolynomial(coeffs=[14.3881,0.0182886,-8.86822e-06,1.75634e-09,-1.26147e-13,-26697.6,-45.8587], Tmin=(1044.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(CsCFHO) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(CsCsFHH) + longDistanceInteraction_noncyclic(Cs(F)-Cs(F)) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'C#COC(F)F(3436)'],
    products = ['C#COC(F)CF(3437)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(7.00938e+53,'m^3/(mol*s)'), n=-13.541, Ea=(147.42,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'C#CO[CH]CF(1524)'],
    products = ['C#COC(F)CF(3437)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['F(37)', 'C#COC([CH2])F(718)'],
    products = ['C#COC(F)CF(3437)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2F(46)', 'C#CO[CH]F(1536)'],
    products = ['C#COC(F)CF(3437)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(6)', 'C#CO[C](F)CF(22061)'],
    products = ['C#COC(F)CF(3437)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(6)', 'C#COC(F)[CH]F(6076)'],
    products = ['C#COC(F)CF(3437)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(6)', '[C]#COC(F)CF(22062)'],
    products = ['C#COC(F)CF(3437)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HF(38)', 'C#COC(=C)F(1456)'],
    products = ['C#COC(F)CF(3437)'],
