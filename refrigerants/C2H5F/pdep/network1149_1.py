...
reaction(
    label = 'reaction3',
    reactants = ['F[C]1CC=[C]O1(4879)'],
    products = ['C#COC(=C)F(1587)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(25)', 'C#C[O+]=[C-]F(4884)'],
    products = ['C#COC(=C)F(1587)'],
