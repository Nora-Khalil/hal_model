...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.144772,'amu*angstrom^2'), symmetry=1, barrier=(3.32859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.30123,'amu*angstrom^2'), symmetry=1, barrier=(29.9179,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83691,0.0528114,-7.51493e-05,5.70726e-08,-1.76553e-11,-35414.2,21.0333], Tmin=(100,'K'), Tmax=(784.05,'K')), NASAPolynomial(coeffs=[8.44806,0.0190835,-1.06239e-05,2.20823e-09,-1.61542e-13,-36450.9,-9.25338], Tmin=(784.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-295.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(F1s)(O2s-Cd)) + radical(Cdj(Cd-F1sO2s)(H))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHF(40)', '[CH]=CO[C](F)F(7401)'],
    products = ['[CH]=C(CF)O[C](F)F(9302)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.44768e+28,'m^3/(mol*s)'), n=-6.4458, Ea=(80.4062,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.6591608693425184, var=5.4995193120720405, Tref=1000.0, N=19, data_mean=0.0, correlation='CH',), comment="""Estimated from node CH"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH]=C(F)O[C](F)F(7458)'],
    products = ['[CH]=C(CF)O[C](F)F(9302)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.50469e+53,'m^3/(mol*s)'), n=-13.541, Ea=(146.587,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.513119107657762, var=99.27123869380007, Tref=1000.0, N=63, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction4',
    reactants = ['F[C]F(3442)', '[CH]=C([O])CF(2478)'],
    products = ['[CH]=C(CF)O[C](F)F(9302)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH]=C(CF)O[C](F)F(9302)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.07578e-06,'m^3/(mol*s)'), n=3.04336, Ea=(51.2262,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.3757377757886876, var=2.242054186761003, Tref=1000.0, N=1042, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R_Ext-3R-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CF2(43)', '[CH]=C([O])CF(2478)'],
    products = ['[CH]=C(CF)O[C](F)F(9302)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(20.45,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.69879e+07,'s^-1'), n=1.42748, Ea=(125.006,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.05505882546177618, var=61.63242994454046, Tref=1000.0, N=11, data_mean=0.0, correlation='F',), comment="""Estimated from node F"""),
)

network(
    label = 'PDepNetwork #4053',
    isomers = [
        '[CH]=C(CF)O[C](F)F(9302)',
    ],
    reactants = [
        ('CF2O(49)', 'C#CCF(4379)'),
    ],
