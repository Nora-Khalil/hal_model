...
reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[CH]=C(F)C#CF(2765)'],
    products = ['[CH]=C(F)C=[C]F(2758)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['HF(38)', '[CH]=C=C=[C]F(2766)'],
    products = ['[CH]=C(F)C=[C]F(2758)'],
    transitionState = 'TS7',
