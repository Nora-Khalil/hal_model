...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', 'C=C[C]C(6174)'],
    products = ['C=[C]CC=[C]C(6693)'],
    transitionState = 'TS3',
