...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C=[C]OC[O](366)'],
    products = ['C=[C]OC(C)[O](478)'],
    transitionState = 'TS2',
