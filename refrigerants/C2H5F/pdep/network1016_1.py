...
"""),
    E0 = (-394.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,250,417,511,1155,1315,1456,3119,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,228.471,228.859],'cm^-1')),
        HinderedRotor(inertia=(0.399384,'amu*angstrom^2'), symmetry=1, barrier=(14.7643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.392862,'amu*angstrom^2'), symmetry=1, barrier=(14.7587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00322666,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399647,'amu*angstrom^2'), symmetry=1, barrier=(14.7601,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.103,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.963033,0.0685921,-6.11406e-05,2.94519e-08,-5.93578e-12,-47345.7,22.9358], Tmin=(100,'K'), Tmax=(1159.47,'K')), NASAPolynomial(coeffs=[11.3283,0.0328338,-1.48806e-05,2.85376e-09,-2.00837e-13,-49749.4,-28.6043], Tmin=(1159.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-394.551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.463948,'amu*angstrom^2'), symmetry=1, barrier=(10.6671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.461116,'amu*angstrom^2'), symmetry=1, barrier=(10.602,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52,0.0276811,9.44242e-07,-1.25014e-08,4.67165e-12,-3343.75,13.0195], Tmin=(100,'K'), Tmax=(1157.78,'K')), NASAPolynomial(coeffs=[6.04216,0.0260074,-1.04844e-05,1.90883e-09,-1.30602e-13,-4862.72,-7.5266], Tmin=(1157.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.2774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), label="""butene2t""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-298.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([250,417,511,1155,1315,1456,3119,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,289.27,289.37],'cm^-1')),
        HinderedRotor(inertia=(0.00201518,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219102,'amu*angstrom^2'), symmetry=1, barrier=(13.0248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219055,'amu*angstrom^2'), symmetry=1, barrier=(13.0241,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (91.1041,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30077,0.0557994,-4.09693e-05,1.55625e-08,-2.43315e-12,-35825.2,21.3583], Tmin=(100,'K'), Tmax=(1475.83,'K')), NASAPolynomial(coeffs=[12.1957,0.0262703,-1.09565e-05,2.00501e-09,-1.36559e-13,-39041,-35.4441], Tmin=(1475.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-298.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.17178,'amu*angstrom^2'), symmetry=1, barrier=(3.94956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.57112,'amu*angstrom^2'), symmetry=1, barrier=(13.1312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000851098,'amu*angstrom^2'), symmetry=1, barrier=(3.95052,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-214.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,259,529,569,1128,1321,1390,3140,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,304.522,304.659],'cm^-1')),
        HinderedRotor(inertia=(0.114555,'amu*angstrom^2'), symmetry=1, barrier=(7.56326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114516,'amu*angstrom^2'), symmetry=1, barrier=(7.54146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151578,'amu*angstrom^2'), symmetry=1, barrier=(10.0013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114181,'amu*angstrom^2'), symmetry=1, barrier=(7.5406,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.095,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.757946,0.0770955,-0.000104621,8.529e-08,-2.89311e-11,-25680.6,24.0923], Tmin=(100,'K'), Tmax=(756.002,'K')), NASAPolynomial(coeffs=[8.06221,0.0357091,-1.70699e-05,3.29101e-09,-2.29975e-13,-26706.8,-8.58563], Tmin=(756.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJO)"""),
)
...
"""),
    E0 = (-182.962,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,250,417,511,1155,1315,1456,3119,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,245.049,252.833],'cm^-1')),
        HinderedRotor(inertia=(0.256755,'amu*angstrom^2'), symmetry=1, barrier=(10.7427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0116349,'amu*angstrom^2'), symmetry=1, barrier=(8.42358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.388697,'amu*angstrom^2'), symmetry=1, barrier=(17.5122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404542,'amu*angstrom^2'), symmetry=1, barrier=(17.5101,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.095,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.794547,0.0738611,-8.07365e-05,4.79747e-08,-1.17009e-11,-21892.6,24.1827], Tmin=(100,'K'), Tmax=(983.43,'K')), NASAPolynomial(coeffs=[11.5592,0.0300758,-1.395e-05,2.69894e-09,-1.90897e-13,-24009.8,-27.5704], Tmin=(983.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.962,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2sCF) + group(Cs-CsCsOsH) + group(CsCsCsFH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(F)C(C)OF(2307)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {5,S}
2  F u0 p3 c0 {3,S}
3  O u0 p2 c0 {2,S} {4,S}
...
"""),
    E0 = (-187.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,1380,1390,370,380,2900,435,259,529,569,1128,1321,1390,3140,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,255.878,255.882],'cm^-1')),
        HinderedRotor(inertia=(0.226135,'amu*angstrom^2'), symmetry=1, barrier=(10.5077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226135,'amu*angstrom^2'), symmetry=1, barrier=(10.5078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00257476,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.60418,'amu*angstrom^2'), symmetry=1, barrier=(28.0745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.095,'amu'),
...
"""),
    E0 = (-443.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([206,363,518,1175,1317,1481,3059,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,375,552.5,462.5,1710,320.329],'cm^-1')),
        HinderedRotor(inertia=(0.00164256,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111659,'amu*angstrom^2'), symmetry=1, barrier=(8.12975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111653,'amu*angstrom^2'), symmetry=1, barrier=(8.13007,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['CH4(4)', 'CC([C]F)OF(2299)'],
    products = ['CC(F)C(C)OF(2287)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(S)(25)', 'CC(F)COF(1630)'],
    products = ['CC(F)C(C)OF(2287)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['F(37)', 'C[CH]C(C)OF(679)'],
    products = ['CC(F)C(C)OF(2287)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F(37)', 'CC([O])C(C)F(2301)'],
    products = ['CC(F)C(C)OF(2287)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(160)', 'C[CH]C(C)F(2302)'],
    products = ['CC(F)C(C)OF(2287)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3-CHF(62)', 'C[CH]OF(540)'],
    products = ['CC(F)C(C)OF(2287)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(19)', 'CC(F)[CH]OF(1641)'],
    products = ['CC(F)C(C)OF(2287)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'C[C](OF)C(C)F(2303)'],
    products = ['CC(F)C(C)OF(2287)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(19)', 'CC([CH]F)OF(2304)'],
    products = ['CC(F)C(C)OF(2287)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C[C](F)C(C)OF(2305)'],
    products = ['CC(F)C(C)OF(2287)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(5)', '[CH2]C(OF)C(C)F(2306)'],
    products = ['CC(F)C(C)OF(2287)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[CH2]C(F)C(C)OF(2307)'],
    products = ['CC(F)C(C)OF(2287)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'CC(=O)C(C)F(1219)'],
    products = ['CC(F)C(C)OF(2287)'],
