...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3442)', '[O]C([O])F(2070)'],
    products = ['[O]C(F)O[C](F)F(7453)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'F[CH]O[C](F)F(4603)'],
    products = ['[O]C(F)O[C](F)F(7453)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['F(37)', 'O=CO[C](F)F(7647)'],
    products = ['[O]C(F)O[C](F)F(7453)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C](F)F(4247)', 'CHFO(47)'],
    products = ['[O]C(F)O[C](F)F(7453)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=C(F)O[C](F)F(7790)'],
    products = ['[O]C(F)O[C](F)F(7453)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][C](F)F(4247)', '[O][CH]F(1657)'],
    products = ['[O]C(F)O[C](F)F(7453)'],
