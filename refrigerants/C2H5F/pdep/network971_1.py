...
reaction(
    label = 'reaction2',
    reactants = ['[O]C([O])F(2070)', '[CH]C-2(137)'],
    products = ['C[CH]OC([O])F(2178)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(6)', 'C[CH]O[CH]F(1200)'],
    products = ['C[CH]OC([O])F(2178)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'C[CH]OC(=O)F(2196)'],
    products = ['C[CH]OC([O])F(2178)'],
