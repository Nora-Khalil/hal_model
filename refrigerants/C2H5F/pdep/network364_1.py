...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(18)', '[CH2]C(=C)[O](609)'],
    products = ['[CH2]CC(=C)[O](453)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2CO(28)', '[CH2][CH2](138)'],
    products = ['[CH2]CC(=C)[O](453)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]=O(140)', '[CH2][CH2](138)'],
    products = ['[CH2]CC(=C)[O](453)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(18)', '[CH2]C[C]=O(596)'],
    products = ['[CH2]CC(=C)[O](453)'],
