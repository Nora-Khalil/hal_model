...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.757242,'amu*angstrom^2'), symmetry=1, barrier=(17.4105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.755884,'amu*angstrom^2'), symmetry=1, barrier=(17.3793,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02815,0.0473248,-7.31761e-05,6.26774e-08,-2.15752e-11,13613.3,17.2572], Tmin=(100,'K'), Tmax=(766.774,'K')), NASAPolynomial(coeffs=[7.27067,0.0171409,-8.58206e-06,1.6938e-09,-1.19585e-13,12892.7,-6.09915], Tmin=(766.774,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(Csj(F1s)(O2s-Cd)(H)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CO[CH]F(2036)'],
    products = ['[CH]=C(C)O[CH]F(6133)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]F(837)', '[CH]=C(C)[O](1728)'],
    products = ['[CH]=C(C)O[CH]F(6133)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH]=C(C)O[CH]F(6133)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.10216e-08,'m^3/(mol*s)'), n=3.71185, Ea=(16.9489,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CHF(40)', '[CH]=C(C)[O](1728)'],
    products = ['[CH]=C(C)O[CH]F(6133)'],
    transitionState = 'TS9',
