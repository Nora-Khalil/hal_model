...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH]=CC(=[CH])CF(8831)'],
    products = ['[CH]=C(C)C(=[CH])CF(9407)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHF(40)', '[CH]=CC(=[CH])C(6095)'],
    products = ['[CH]=C(C)C(=[CH])CF(9407)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(25)', '[CH]=C(C)C(=[CH])F(6137)'],
    products = ['[CH]=C(C)C(=[CH])CF(9407)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2F(46)', '[CH]=C(C)C#C(6221)'],
    products = ['[CH]=C(C)C(=[CH])CF(9407)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(19)', '[CH]=C(C#C)CF(11177)'],
    products = ['[CH]=C(C)C(=[CH])CF(9407)'],
    transitionState = 'TS8',
