...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COCF(1620)'],
    products = ['C#COCCF(1121)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2F(46)', 'C#CO[CH2](683)'],
    products = ['C#COCCF(1121)'],
    transitionState = 'TS8',
