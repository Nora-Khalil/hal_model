...
"""),
    E0 = (-114.14,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,493,600,700,1144,1293,3120,650,792.5,1650,180,180,3842.41],'cm^-1')),
        HinderedRotor(inertia=(0.28622,'amu*angstrom^2'), symmetry=1, barrier=(6.58076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.85556,'amu*angstrom^2'), symmetry=1, barrier=(42.663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286088,'amu*angstrom^2'), symmetry=1, barrier=(6.57773,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.071,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42947,0.0624252,-9.31669e-05,8.23039e-08,-2.94382e-11,-13641,25.6039], Tmin=(100,'K'), Tmax=(794.994,'K')), NASAPolynomial(coeffs=[6.33161,0.0292336,-1.44526e-05,2.80453e-09,-1.95743e-13,-14151,4.77323], Tmin=(794.994,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(CsFFHO) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Csj(F1s)(F1s)(O2s-Cs)) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['F[C]F(3442)', 'C=[C]C[O](689)'],
    products = ['C=[C]CO[C](F)F(7487)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C(134)', '[CH2]O[C](F)F(4535)'],
    products = ['C=[C]CO[C](F)F(7487)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['C=[C]CO[C](F)F(7487)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(119.093,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    ...
    products = ['C=[C]CO[C](F)F(7487)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.82043e-07,'m^3/(mol*s)'), n=3.71185, Ea=(37.8257,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.339286171633947, var=3.7349511333863634, Tref=1000.0, N=1489, data_mean=0.0, correlation='Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R',), comment="""Estimated from node Root_N-3R-inRing_Ext-3R-R_Ext-4R!H-R
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['CF2(43)', 'C=[C]C[O](689)'],
    products = ['C=[C]CO[C](F)F(7487)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(128827,'m^3/(mol*s)'), n=0.469398, Ea=(6.5199,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.009898522871762284, var=0.3372166703721302, Tref=1000.0, N=6, data_mean=0.0, correlation='Root_N-3R->H_Ext-3BrCClFINOPSSi-R',), comment="""Estimated from node Root_N-3R->H_Ext-3BrCClFINOPSSi-R"""),
)

reaction(
    label = 'reaction12',
    reactants = ['C=[C]CO[C](F)F(7487)'],
    products = ['[CH2]C=CO[C](F)F(8072)'],
