...
"""),
    E0 = (-1055.44,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,486,586,623,710,938,1161,1294,519,593,830,1115,1166,1389,1413,3114,180,180,180],'cm^-1')),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.245305,'amu*angstrom^2'), symmetry=1, barrier=(5.64004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244678,'amu*angstrom^2'), symmetry=1, barrier=(5.62563,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.900521,'amu*angstrom^2'), symmetry=1, barrier=(20.7047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
"""),
    E0 = (-1039.07,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([519,593,830,1115,1166,1389,1413,3114,482,664,788,1296,1923,262.427,263.628,898.527],'cm^-1')),
        HinderedRotor(inertia=(0.626383,'amu*angstrom^2'), symmetry=1, barrier=(30.8553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.770541,'amu*angstrom^2'), symmetry=1, barrier=(37.7348,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['FOC(F)(F)OC(F)F(8195)'],
    products = ['HF(38)', 'CF2O(49)', 'CF2O(49)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CF2(43)', 'OC(F)(F)OF(7899)'],
    products = ['FOC(F)(F)OC(F)F(8195)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['FOC(F)(F)OF(7903)', 'CHF(40)'],
    products = ['FOC(F)(F)OC(F)F(8195)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['F(37)', 'FO[C](F)OC(F)F(7948)'],
    products = ['FOC(F)(F)OC(F)F(8195)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['F(37)', 'F[CH]OC(F)(F)OF(7905)'],
    products = ['FOC(F)(F)OC(F)F(8195)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+06,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_N-1BrCFOS->O_N-1BrCFS-inRing_1BrCFS->C_N-2R->S_N-2BrCF->Br_Ext-1C-R_3R!H->F_N-2CF->C"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['F(37)', '[O]C(F)(F)OC(F)F(8121)'],
    products = ['FOC(F)(F)OC(F)F(8195)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['FO[C](F)F(7422)', '[O]C(F)F(1981)'],
    products = ['FOC(F)(F)OC(F)F(8195)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C(F)(F)OF(7901)', 'CHF2(81)'],
    products = ['FOC(F)(F)OC(F)F(8195)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]F(160)', 'F[C](F)OC(F)F(8120)'],
    products = ['FOC(F)(F)OC(F)F(8195)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(9.04e+06,'m^3/(mol*s)'), n=2.17087e-08, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C_Ext-2C-R_Ext-2C-R"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', 'FOC(F)(F)O[C](F)F(8198)'],
    products = ['FOC(F)(F)OC(F)F(8195)'],
...
reaction(
    label = 'reaction11',
    reactants = ['F2(77)', 'O=C(F)OC(F)F(7789)'],
    products = ['FOC(F)(F)OC(F)F(8195)'],
...
reaction(
    label = 'reaction12',
    reactants = ['FOC(F)(F)OC(F)F(8195)'],
    products = ['F2(77)', 'CF2O(49)', 'CHFO(47)'],
