...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', 'C#COC([CH2])F(1161)'],
    products = ['C#COC([CH2])CF(10260)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(18)', 'C#CO[CH]CF(1623)'],
    products = ['C#COC([CH2])CF(10260)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', '[CH]C(CF)OC#C(10437)'],
    products = ['C#COC([CH2])CF(10260)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['F(37)', 'C#COC([CH2])[CH2](10440)'],
    products = ['C#COC([CH2])CF(10260)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HCCO(21)', '[CH2][CH]CF(2399)'],
    products = ['C#COC([CH2])CF(10260)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C2H(22)', '[CH2]C([O])CF(3821)'],
    products = ['C#COC([CH2])CF(10260)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2F(46)', 'C#CO[CH][CH2](710)'],
    products = ['C#COC([CH2])CF(10260)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'C#CO[C]([CH2])CF(8941)'],
    products = ['C#COC([CH2])CF(10260)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(5)', '[C]#COC([CH2])CF(10441)'],
    products = ['C#COC([CH2])CF(10260)'],
...
reaction(
    label = 'reaction20',
    reactants = ['HF(38)', 'C#COC([CH2])=C(6785)'],
    products = ['C#COC([CH2])CF(10260)'],
