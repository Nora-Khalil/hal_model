...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(F)C[CH]F(871)'],
    products = ['CH2CHF(55)', 'CH2CHF(55)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(F)C([CH2])F(870)'],
    products = ['[CH2]C(F)C[CH]F(871)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(837)', '[CH2]C([CH2])F(858)'],
    products = ['[CH2]C(F)C[CH]F(871)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(18)', 'F[CH]C[CH]F(878)'],
    products = ['[CH2]C(F)C[CH]F(871)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2CHF(55)', '[CH2][CH]F(839)'],
    products = ['[CH2]C(F)C[CH]F(871)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(F)C=CF(882)'],
    products = ['[CH2]C(F)C[CH]F(871)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'C=C(F)C[CH]F(883)'],
    products = ['[CH2]C(F)C[CH]F(871)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]F(839)', '[CH2][CH]F(839)'],
    products = ['[CH2]C(F)C[CH]F(871)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HF(38)', '[CH2]C=C[CH]F(884)'],
    products = ['[CH2]C(F)C[CH]F(871)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHF(40)', '[CH2]C([CH2])F(858)'],
    products = ['[CH2]C(F)C[CH]F(871)'],
