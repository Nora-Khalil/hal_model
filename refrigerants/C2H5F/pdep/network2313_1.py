...
"""),
    E0 = (125.546,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,364.514,365.421,366.682],'cm^-1')),
        HinderedRotor(inertia=(0.166406,'amu*angstrom^2'), symmetry=1, barrier=(15.7949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165945,'amu*angstrom^2'), symmetry=1, barrier=(15.7969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16641,'amu*angstrom^2'), symmetry=1, barrier=(15.7986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165788,'amu*angstrom^2'), symmetry=1, barrier=(15.7951,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
"""),
    E0 = (86.9389,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,180,180,647.773],'cm^-1')),
        HinderedRotor(inertia=(0.0563822,'amu*angstrom^2'), symmetry=1, barrier=(16.7592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0565359,'amu*angstrom^2'), symmetry=1, barrier=(16.8008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286043,'amu*angstrom^2'), symmetry=1, barrier=(16.7642,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1084,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33555,0.0491297,-1.96037e-05,-1.37389e-08,1.00794e-11,10560.8,22.6033], Tmin=(100,'K'), Tmax=(960.658,'K')), NASAPolynomial(coeffs=[14.1687,0.0180546,-5.99491e-06,1.04551e-09,-7.32542e-14,7063.42,-44.164], Tmin=(960.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.9389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(O)CJ)"""),
)
...
"""),
    E0 = (143.207,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,373.024,373.024,373.03],'cm^-1')),
        HinderedRotor(inertia=(0.00121151,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179259,'amu*angstrom^2'), symmetry=1, barrier=(17.7005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179268,'amu*angstrom^2'), symmetry=1, barrier=(17.7006,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179279,'amu*angstrom^2'), symmetry=1, barrier=(17.7006,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.722683,0.0622472,-3.99426e-05,-9.10517e-10,7.32949e-12,17350.8,23.0811], Tmin=(100,'K'), Tmax=(948.441,'K')), NASAPolynomial(coeffs=[17.1544,0.0165759,-5.08153e-06,8.53032e-10,-5.92804e-14,13171.1,-60.9254], Tmin=(948.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJCO) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=C(C)O[CH]C(6115)',
    structure = adjacencyList("""multiplicity 3
...
"""),
    E0 = (178.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,329.763,329.777,329.792],'cm^-1')),
        HinderedRotor(inertia=(0.191638,'amu*angstrom^2'), symmetry=1, barrier=(14.7922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191675,'amu*angstrom^2'), symmetry=1, barrier=(14.7924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19166,'amu*angstrom^2'), symmetry=1, barrier=(14.7922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191623,'amu*angstrom^2'), symmetry=1, barrier=(14.7923,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C-2(137)', '[CH2]C(=C)[O](609)'],
    products = ['[CH2]C(=C)O[CH]C(6355)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(18)', 'C=[C]O[CH]C(605)'],
    products = ['[CH2]C(=C)O[CH]C(6355)'],
    transitionState = 'TS3',
