...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58477,0.0577684,-7.04644e-05,4.94813e-08,-1.45691e-11,17722.8,22.1739], Tmin=(100,'K'), Tmax=(814.88,'K')), NASAPolynomial(coeffs=[7.92677,0.0266368,-1.31577e-05,2.59692e-09,-1.84968e-13,16689.2,-7.12416], Tmin=(814.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJ2_triplet)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03074,0.0720756,-0.000113903,1.00976e-07,-3.60144e-11,-14309.4,23.6966], Tmin=(100,'K'), Tmax=(775.376,'K')), NASAPolynomial(coeffs=[7.87679,0.0288982,-1.51683e-05,3.01085e-09,-2.12641e-13,-15134.8,-6.06631], Tmin=(775.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-119.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(Cs-OsHHH) + radical(CsCCl_triplet)"""),
)
...
"""),
    E0 = (-200.834,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,334,575,1197,1424,3202,180,180,180,2325.02],'cm^-1')),
        HinderedRotor(inertia=(0.148963,'amu*angstrom^2'), symmetry=1, barrier=(3.42496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148784,'amu*angstrom^2'), symmetry=1, barrier=(3.42083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148957,'amu*angstrom^2'), symmetry=1, barrier=(3.42481,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46503,0.0696901,-0.000133758,1.39102e-07,-5.35801e-11,-24077,23.0282], Tmin=(100,'K'), Tmax=(850.509,'K')), NASAPolynomial(coeffs=[0.939678,0.0387464,-2.0252e-05,3.9377e-09,-2.71595e-13,-22779.1,32.5825], Tmin=(850.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(Csj(Cs-O2sO2sH)(F1s)(H))"""),
)
...
"""),
    E0 = (-40.2174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,334,575,1197,1424,3202,195.369,197.338,2254.94],'cm^-1')),
        HinderedRotor(inertia=(0.249535,'amu*angstrom^2'), symmetry=1, barrier=(6.99562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261999,'amu*angstrom^2'), symmetry=1, barrier=(7.00434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255557,'amu*angstrom^2'), symmetry=1, barrier=(7.01749,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0696,'amu'),
...
"""),
    E0 = (-86.7853,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([557,1111,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,334,575,1197,1424,3202,257.169,257.179,257.195,2371.91],'cm^-1')),
        HinderedRotor(inertia=(0.141753,'amu*angstrom^2'), symmetry=1, barrier=(6.65358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141763,'amu*angstrom^2'), symmetry=1, barrier=(6.65372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141764,'amu*angstrom^2'), symmetry=1, barrier=(6.65352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.595853,'amu*angstrom^2'), symmetry=1, barrier=(27.967,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.059,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.660153,0.0855597,-0.000158628,1.51001e-07,-5.44455e-11,-10329.2,25.9164], Tmin=(100,'K'), Tmax=(847.82,'K')), NASAPolynomial(coeffs=[6.65413,0.0313073,-1.669e-05,3.25685e-09,-2.24693e-13,-10412.1,3.49355], Tmin=(847.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.7853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(Cs-OsHHH) + radical(Cs_P) + radical(Csj(Cs-O2sO2sH)(F1s)(H))"""),
)

species(
    label = '[CH2]OC([CH]F)OF(3812)',
    structure = adjacencyList("""multiplicity 3
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {4,S}
...
"""),
    E0 = (-422.207,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,235,1215,1347,1486,3221,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55564,0.0366184,-2.41285e-05,8.00943e-09,-1.1641e-12,-50732.3,17.1647], Tmin=(100,'K'), Tmax=(1417.43,'K')), NASAPolynomial(coeffs=[6.59107,0.0252304,-1.20771e-05,2.34126e-09,-1.64375e-13,-51876.3,-3.71168], Tmin=(1417.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(CsCFHH) + longDistanceInteraction_noncyclic(Cs(F)-CO) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(Csj(CO-O2sO2d)(F1s)(H))"""),
)
...
"""),
    ...
    molecularWeight = (111.067,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1341,0.0683204,-8.36387e-05,5.60551e-08,-1.54845e-11,-36285.3,24.5194], Tmin=(100,'K'), Tmax=(871.014,'K')), NASAPolynomial(coeffs=[9.93191,0.0279191,-1.40647e-05,2.80543e-09,-2.01219e-13,-37817.9,-16.7103], Tmin=(871.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2sCF) + group(Cs-CsOsOsH) + group(CsCsFHH) + group(Cs-OsHHH) + radical(CsJOCH3)"""),
)

species(
    label = 'COC([O])C(F)F(3817)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
2  F u0 p3 c0 {6,S}
3  O u0 p2 c0 {5,S} {7,S}
...
reaction(
    label = 'reaction1',
    reactants = ['COC([CH]F)OF(3772)'],
    products = ['HF(38)', 'CH2O(20)', 'O=C[CH]F(414)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(0.00856353,'s^-1'), n=4.62568, Ea=(31.6353,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.3917696014098424, var=52.52930589142705, Tref=1000.0, N=14, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root
...
reaction(
    label = 'reaction3',
    reactants = ['F(37)', '[CH]C(OC)OF-2(3807)'],
    products = ['COC([CH]F)OF(3772)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]F(837)', 'CO[CH]OF(1056)'],
    products = ['COC([CH]F)OF(3772)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'COC([O])[CH]F(3809)'],
    products = ['COC([CH]F)OF(3772)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3O(27)', 'F[CH][CH]OF(1775)'],
    products = ['COC([CH]F)OF(3772)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(19)', '[O]C([CH]F)OF(3810)'],
    products = ['COC([CH]F)OF(3772)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]F(160)', 'CO[CH][CH]F(977)'],
    products = ['COC([CH]F)OF(3772)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', 'CO[C]([CH]F)OF(3811)'],
    products = ['COC([CH]F)OF(3772)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(5)', '[CH2]OC([CH]F)OF(3812)'],
    products = ['COC([CH]F)OF(3772)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', 'COC(=O)[CH]F(3813)'],
    products = ['COC([CH]F)OF(3772)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CHF(40)', 'CO[CH]OF(1056)'],
    products = ['COC([CH]F)OF(3772)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', 'COC([C]F)OF-2(3814)'],
    products = ['COC([CH]F)OF(3772)'],
