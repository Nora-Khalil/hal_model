...
"""),
    ...
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.866849,0.0557685,-2.9342e-05,-1.62346e-08,1.40471e-11,-31024.8,23.4665], Tmin=(100,'K'), Tmax=(942.778,'K')), NASAPolynomial(coeffs=[20.5161,0.00502239,-5.04885e-07,7.53443e-11,-1.01513e-14,-36179.5,-77.8608], Tmin=(942.778,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(COCsFO) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
"""),
    E0 = (436.042,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,326,540,652,719,1357,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(0.320711,'amu*angstrom^2'), symmetry=1, barrier=(7.37377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.39793,'amu*angstrom^2'), symmetry=1, barrier=(9.1492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.74357,'amu*angstrom^2'), symmetry=1, barrier=(40.0881,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5452,0.0606851,-8.02694e-05,5.3219e-08,-1.10725e-11,52525.8,24.6639], Tmin=(100,'K'), Tmax=(591.47,'K')), NASAPolynomial(coeffs=[8.00483,0.0256699,-1.34568e-05,2.69521e-09,-1.92482e-13,51610,-4.38986], Tmin=(591.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(CdCFO) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'F[C]1CC=COO1(6011)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {6,S}
...
"""),
    ...
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83304,0.0366691,5.33847e-06,-3.75378e-08,1.85015e-11,-8202.99,17.7915], Tmin=(100,'K'), Tmax=(938.329,'K')), NASAPolynomial(coeffs=[13.3674,0.0151196,-4.36664e-06,7.28013e-10,-5.17514e-14,-11583.5,-43.6004], Tmin=(938.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.9359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(CsCFHO) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(34dihydro12dioxin) + radical(CsCsF1sO2s)"""),
)

species(
    label = '[CH2]C1(F)C=COO1(6012)',
    structure = adjacencyList("""multiplicity 2
1  F u0 p3 c0 {4,S}
2  O u0 p2 c0 {3,S} {4,S}
3  O u0 p2 c0 {2,S} {6,S}
...
"""),
    ...
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36991,0.0456793,-1.29279e-05,-2.11024e-08,1.22196e-11,-7994.78,21.4911], Tmin=(100,'K'), Tmax=(1003.4,'K')), NASAPolynomial(coeffs=[16.3565,0.0133016,-5.43468e-06,1.09895e-09,-8.38315e-14,-12379.9,-57.7259], Tmin=(1003.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.3491,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(CsCCFO) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(12dioxolene) + radical(CJCOOH)"""),
)
...
"""),
    E0 = (137.892,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,194,682,905,1196,1383,3221,2950,3100,1380,975,1025,1650,1685,370,292.57],'cm^-1')),
        HinderedRotor(inertia=(0.118375,'amu*angstrom^2'), symmetry=1, barrier=(7.20754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118642,'amu*angstrom^2'), symmetry=1, barrier=(7.20854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.670287,'amu*angstrom^2'), symmetry=1, barrier=(40.6913,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75813,0.0541961,-5.92668e-05,3.79744e-08,-1.04905e-11,16661.1,26.6838], Tmin=(100,'K'), Tmax=(853.881,'K')), NASAPolynomial(coeffs=[7.22581,0.0285819,-1.42692e-05,2.84132e-09,-2.03822e-13,15727.4,1.16932], Tmin=(853.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(CdCFH) + longDistanceInteraction_noncyclic(Cd(F)=CdOs) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=COOC(=C)F(5370)'],
    products = ['HCCO(21)', 'CC(=O)F(499)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(351.483,'s^-1'), n=2.72887, Ea=(14.8423,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.13055717705123002, var=19.959654271360805, Tref=1000.0, N=68, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[CH]=COOC(=C)F(5370)'],
    products = ['[CH]=COCC(=O)F(6009)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(5)', '[C]=COOC(=C)F(6010)'],
    products = ['[CH]=COOC(=C)F(5370)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=COOC(=C)F(5370)'],
    products = ['C1=CO1(1754)', 'CH2CFO(78)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=COOC(=C)F(5370)'],
    products = ['[CH2]C1(F)C=COO1(6012)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(8.73e+09,'s^-1'), n=0.21, Ea=(16.736,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [R6_DSS_D;doublebond_intra_2H;radadd_intra_cdsingleH]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C[O](132)', 'CH2CFO(78)'],
    products = ['[CH]=COOC(=C)F(5370)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(7.38316e+06,'m^3/(mol*s)'), n=1.31229e-07, Ea=(235.512,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.016021952005170214, var=0.3543710496450803, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C',), comment="""Estimated from node Root_N-1R->H_N-1BrCClFINOPSSi->N_N-1BrCClFOS->Cl_1BrCFOS->O_Ext-1O-R_N-3R!H->O_Ext-2R-R_2R->C
Ea raised from 233.5 to 235.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction11',
    reactants = ['CH2CF(69)', '[CH]=CO[O](430)'],
    products = ['[CH]=COOC(=C)F(5370)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[CH](135)', 'C=C(F)O[O](1327)'],
    products = ['[CH]=COOC(=C)F(5370)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(5)', '[CH]=COOC(=[CH])F(6013)'],
    products = ['[CH]=COOC(=C)F(5370)'],
...
reaction(
    label = 'reaction15',
    reactants = ['HF(38)', '[CH]=COOC#C(1250)'],
    products = ['[CH]=COOC(=C)F(5370)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(F)OOC=C(5371)'],
    products = ['[CH]=COOC(=C)F(5370)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.5092e+10,'s^-1'), n=0.732, Ea=(25.1375,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H;Cd_rad_out_singleH;XH_out] for rate rule [R6H_DSSSD;Cd_rad_out_singleH;Cd_H_out_singleH]
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OOC=CF(1812)'],
    products = ['[CH]=COOC(=C)F(5370)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.64853e+07,'s^-1'), n=1.15307, Ea=(192.165,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='R5nF',), comment="""Estimated from node R5nF"""),
)
...
network(
    ...
    reactants = [
        ('HCCO(21)', 'CC(=O)F(499)'),
        ('C1=CO1(1754)', 'CH2CFO(78)'),
        ('[CH]=C[O](132)', 'CH2CFO(78)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
