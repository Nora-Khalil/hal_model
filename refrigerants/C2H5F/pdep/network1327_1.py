...
"""),
    E0 = (-91.2657,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,235,523,627,1123,1142,1372,1406,3097,378.682,379.269,1656.61,1657.03],'cm^-1')),
        HinderedRotor(inertia=(0.00117351,'amu*angstrom^2'), symmetry=1, barrier=(0.119857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0831683,'amu*angstrom^2'), symmetry=1, barrier=(8.47896,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (78.0606,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.334,0.0336806,-2.44352e-05,8.92528e-09,-1.31603e-12,-10914.5,16.5144], Tmin=(100,'K'), Tmax=(1578,'K')), NASAPolynomial(coeffs=[10.0323,0.0141671,-5.88693e-06,1.08936e-09,-7.46424e-14,-13344.2,-24.1376], Tmin=(1578,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.2657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CCJ2_triplet)"""),
)
...
"""),
    E0 = (-354.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,90,150,250,247,323,377,431,433,1065,1274,2055.35,2742.09],'cm^-1')),
        HinderedRotor(inertia=(0.0025432,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000268336,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62083,0.0578463,-9.3451e-05,8.2933e-08,-2.91507e-11,-42516.5,17.6153], Tmin=(100,'K'), Tmax=(799.067,'K')), NASAPolynomial(coeffs=[7.37351,0.0214521,-1.08709e-05,2.1374e-09,-1.4997e-13,-43193.3,-7.33002], Tmin=(799.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: CHOF_G4 + radical(CsCCl_triplet)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]F(837)', 'CHF2-CH2(63)'],
    products = ['F[CH]CC(F)F(2516)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'F[C]CC(F)F-2(3549)'],
    products = ['F[CH]CC(F)F(2516)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['F(37)', 'F[CH]C[CH]F(878)'],
    products = ['F[CH]CC(F)F(2516)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(5)', 'F[CH][CH]C(F)F(3550)'],
    products = ['F[CH]CC(F)F(2516)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', 'F[CH]C[C](F)F(3551)'],
    products = ['F[CH]CC(F)F(2516)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HF(38)', 'F[CH]C=CF(3552)'],
    products = ['F[CH]CC(F)F(2516)'],
