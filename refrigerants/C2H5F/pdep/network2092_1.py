...
reaction(
    label = 'reaction1',
    reactants = ['[O]OO[C]=O(333)'],
    products = ['O=O(150)', 'CO2(14)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]O[O](161)', '[C]=O(126)'],
    products = ['[O]OO[C]=O(333)'],
    transitionState = 'TS2',
